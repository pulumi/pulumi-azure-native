...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210513Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20210513preview:HostPool")]
    public partial class HostPool : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("sessionHostComponentUpdateConfiguration")]
        public Output<Outputs.SessionHostComponentUpdateConfigurationPropertiesResponse?> SessionHostComponentUpdateConfiguration { get; private set; } = null!;
        ...
        public HostPool(string name, HostPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210513preview:HostPool", name, args ?? new HostPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HostPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210513preview:HostPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HostPoolArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210513Preview.HostPoolType> HostPoolType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210513Preview.LoadBalancerType> LoadBalancerType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210513Preview.PersonalDesktopAssignmentType>? PersonalDesktopAssignmentType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210513Preview.PreferredAppGroupType> PreferredAppGroupType { get; set; } = null!;
        ...
        /// The session host configuration for updating agent, monitoring agent, and stack component.
        /// </summary>
        [Input("sessionHostComponentUpdateConfiguration")]
        public Input<Inputs.SessionHostComponentUpdateConfigurationPropertiesArgs>? SessionHostComponentUpdateConfiguration { get; set; }
        ...
        /// </summary>
        [Input("ssoSecretType")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210513Preview.SSOSecretType>? SsoSecretType { get; set; }
