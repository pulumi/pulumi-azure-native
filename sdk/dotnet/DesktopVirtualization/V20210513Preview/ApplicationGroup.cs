...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210513Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20210513preview:ApplicationGroup")]
    public partial class ApplicationGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210513preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210513preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210513preview:ApplicationGroup"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210309preview:ApplicationGroup"},
                    new Pulumi.Alias { Type = "azure-native:desktopvirtualization/v20210401preview:ApplicationGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210401preview:ApplicationGroup"},
                    new Pulumi.Alias { Type = "azure-native:desktopvirtualization/v20210712:ApplicationGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210712:ApplicationGroup"},
                },
            };
    ...
    public sealed class ApplicationGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210513Preview.ApplicationGroupType> ApplicationGroupType { get; set; } = null!;
