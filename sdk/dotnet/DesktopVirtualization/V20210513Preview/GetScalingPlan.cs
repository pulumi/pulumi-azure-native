...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210513Preview
{
    public static class GetScalingPlan
    {
        ...
        public static Task<GetScalingPlanResult> InvokeAsync(GetScalingPlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScalingPlanResult>("azure-native:desktopvirtualization/v20210513preview:getScalingPlan", args ?? new GetScalingPlanArgs(), options.WithVersion());
    }
