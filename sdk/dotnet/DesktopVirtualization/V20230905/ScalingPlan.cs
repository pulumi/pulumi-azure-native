...
namespace Pulumi.AzureNative.DesktopVirtualization.V20230905
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20230905:ScalingPlan")]
    public partial class ScalingPlan : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlan(string name, ScalingPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20230905:ScalingPlan", name, args ?? new ScalingPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20230905:ScalingPlan", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScalingPlanArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostPoolType")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20230905.ScalingHostPoolType>? HostPoolType { get; set; }
