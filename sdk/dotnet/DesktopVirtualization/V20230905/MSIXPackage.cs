...
namespace Pulumi.AzureNative.DesktopVirtualization.V20230905
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20230905:MSIXPackage")]
    public partial class MSIXPackage : global::Pulumi.CustomResource
    {
        ...
        public MSIXPackage(string name, MSIXPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20230905:MSIXPackage", name, args ?? new MSIXPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MSIXPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20230905:MSIXPackage", name, null, MakeResourceOptions(options, id))
        {
        }
