...
namespace Pulumi.AzureRM.DesktopVirtualization.Latest
{
    public static class GetHostPool
    {
        public static Task<GetHostPoolResult> InvokeAsync(GetHostPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHostPoolResult>("azurerm:desktopvirtualization/latest:getHostPool", args ?? new GetHostPoolArgs(), options.WithVersion());
    }
