...
namespace Pulumi.AzureRM.DesktopVirtualization.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var hostPool = new AzureRM.DesktopVirtualization.Latest.HostPool("hostPool", new AzureRM.DesktopVirtualization.Latest.HostPoolArgs
    ///         {
    ///             Description = "des1",
    ...
    ///             RegistrationInfo = new AzureRM.DesktopVirtualization.Latest.Inputs.RegistrationInfoArgs
    ///             {
    ...
    public partial class HostPool : Pulumi.CustomResource
    {
        ...
        public HostPool(string name, HostPoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/latest:HostPool", name, args ?? new HostPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HostPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/latest:HostPool", name, null, MakeResourceOptions(options, id))
        {
        }
