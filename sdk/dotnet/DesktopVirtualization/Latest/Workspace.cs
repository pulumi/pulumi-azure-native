...
namespace Pulumi.AzureRM.DesktopVirtualization.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workspace = new AzureRM.DesktopVirtualization.Latest.Workspace("workspace", new AzureRM.DesktopVirtualization.Latest.WorkspaceArgs
    ///         {
    ///             Description = "des1",
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/latest:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/latest:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:desktopvirtualization/v20190123preview:Workspace"},
