...
namespace Pulumi.AzureRM.DesktopVirtualization.Latest
{
    public static class GetApplicationGroup
    {
        public static Task<GetApplicationGroupResult> InvokeAsync(GetApplicationGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationGroupResult>("azurerm:desktopvirtualization/latest:getApplicationGroup", args ?? new GetApplicationGroupArgs(), options.WithVersion());
    }
