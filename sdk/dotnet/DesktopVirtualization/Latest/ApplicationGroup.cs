...
namespace Pulumi.AzureRM.DesktopVirtualization.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationGroup = new AzureRM.DesktopVirtualization.Latest.ApplicationGroup("applicationGroup", new AzureRM.DesktopVirtualization.Latest.ApplicationGroupArgs
    ///         {
    ...
    public partial class ApplicationGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/latest:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/latest:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
