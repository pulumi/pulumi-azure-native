...
namespace Pulumi.AzureRM.DesktopVirtualization.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var application = new AzureRM.DesktopVirtualization.Latest.Application("application", new AzureRM.DesktopVirtualization.Latest.ApplicationArgs
    ///         {
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/latest:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/latest:Application", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:desktopvirtualization/v20190924preview:Application"},
