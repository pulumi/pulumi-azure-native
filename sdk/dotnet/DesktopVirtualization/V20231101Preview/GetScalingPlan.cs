...
namespace Pulumi.AzureNative.DesktopVirtualization.V20231101Preview
{
    public static class GetScalingPlan
    {
        ...
        public static Task<GetScalingPlanResult> InvokeAsync(GetScalingPlanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScalingPlanResult>("azure-native:desktopvirtualization/v20231101preview:getScalingPlan", args ?? new GetScalingPlanArgs(), options.WithDefaults());
