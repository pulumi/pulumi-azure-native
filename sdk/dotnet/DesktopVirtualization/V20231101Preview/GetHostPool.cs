...
namespace Pulumi.AzureNative.DesktopVirtualization.V20231101Preview
{
    public static class GetHostPool
    {
        ...
        public static Task<GetHostPoolResult> InvokeAsync(GetHostPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHostPoolResult>("azure-native:desktopvirtualization/v20231101preview:getHostPool", args ?? new GetHostPoolArgs(), options.WithDefaults());
