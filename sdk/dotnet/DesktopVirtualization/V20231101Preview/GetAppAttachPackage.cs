...
namespace Pulumi.AzureNative.DesktopVirtualization.V20231101Preview
{
    public static class GetAppAttachPackage
    {
        ...
        public static Task<GetAppAttachPackageResult> InvokeAsync(GetAppAttachPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppAttachPackageResult>("azure-native:desktopvirtualization/v20231101preview:getAppAttachPackage", args ?? new GetAppAttachPackageArgs(), options.WithDefaults());
