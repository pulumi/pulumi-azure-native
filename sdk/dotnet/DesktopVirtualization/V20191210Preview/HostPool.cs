...
namespace Pulumi.AzureRM.DesktopVirtualization.V20191210Preview
{
    ...
    public partial class HostPool : Pulumi.CustomResource
    {
        ...
        public HostPool(string name, HostPoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20191210preview:HostPool", name, args ?? new HostPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HostPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20191210preview:HostPool", name, null, MakeResourceOptions(options, id))
        {
        }
