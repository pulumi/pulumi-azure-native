...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20191210Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:desktopvirtualization/v20191210preview:Application")]
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20191210preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20191210preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20191210Preview.CommandLineSetting> CommandLineSetting { get; set; } = null!;
