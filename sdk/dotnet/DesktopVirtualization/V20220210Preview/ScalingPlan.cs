...
namespace Pulumi.AzureNative.DesktopVirtualization.V20220210Preview
{
    ...
    /// {
    ///     var scalingPlan = new AzureNative.DesktopVirtualization.V20220210Preview.ScalingPlan("scalingPlan", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.DesktopVirtualization.V20220210Preview.Inputs.ScalingHostPoolReferenceArgs
    ///             {
    ...
    ///         Schedules = new[]
    ///         {
    ///             new AzureNative.DesktopVirtualization.V20220210Preview.Inputs.ScalingScheduleArgs
    ///             {
    ///                 DaysOfWeek = new[]
    ///                 {
    ///                     "Monday",
    ...
    ///                 OffPeakStartTime = new AzureNative.DesktopVirtualization.V20220210Preview.Inputs.TimeArgs
    ///                 {
    ///                     Hour = 20,
    ///                     Minute = 0,
    ///                 },
    ///                 PeakLoadBalancingAlgorithm = "BreadthFirst",
    ///                 PeakStartTime = new AzureNative.DesktopVirtualization.V20220210Preview.Inputs.TimeArgs
    ///                 {
    ///                     Hour = 8,
    ///                     Minute = 0,
    ///                 },
    ...
    ///                 RampDownStartTime = new AzureNative.DesktopVirtualization.V20220210Preview.Inputs.TimeArgs
    ///                 {
    ///                     Hour = 18,
    ///                     Minute = 0,
    ///                 },
    ...
    ///                 RampUpStartTime = new AzureNative.DesktopVirtualization.V20220210Preview.Inputs.TimeArgs
    ///                 {
    ///                     Hour = 6,
    ///                     Minute = 0,
    ///                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20220210preview:ScalingPlan")]
    public partial class ScalingPlan : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlan(string name, ScalingPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220210preview:ScalingPlan", name, args ?? new ScalingPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220210preview:ScalingPlan", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScalingPlanArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostPoolType")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20220210Preview.ScalingHostPoolType>? HostPoolType { get; set; }
