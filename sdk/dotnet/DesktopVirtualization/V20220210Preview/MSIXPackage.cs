...
namespace Pulumi.AzureNative.DesktopVirtualization.V20220210Preview
{
    ...
    public partial class MSIXPackage : global::Pulumi.CustomResource
    {
        ...
        public MSIXPackage(string name, MSIXPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220210preview:MSIXPackage", name, args ?? new MSIXPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MSIXPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20220210preview:MSIXPackage", name, null, MakeResourceOptions(options, id))
        {
        }
