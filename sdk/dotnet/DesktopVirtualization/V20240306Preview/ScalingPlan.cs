...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240306Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20240306preview:ScalingPlan")]
    public partial class ScalingPlan : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlan(string name, ScalingPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240306preview:ScalingPlan", name, args ?? new ScalingPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240306preview:ScalingPlan", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScalingPlanArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostPoolType")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20240306Preview.ScalingHostPoolType>? HostPoolType { get; set; }
