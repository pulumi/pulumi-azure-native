...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240306Preview
{
    public static class GetMSIXPackage
    {
        ...
        public static Task<GetMSIXPackageResult> InvokeAsync(GetMSIXPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMSIXPackageResult>("azure-native:desktopvirtualization/v20240306preview:getMSIXPackage", args ?? new GetMSIXPackageArgs(), options.WithDefaults());

        /// <summary>
        /// Get a msixpackage.
        /// </summary>
        public static Output<GetMSIXPackageResult> Invoke(GetMSIXPackageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMSIXPackageResult>("azure-native:desktopvirtualization/v20240306preview:getMSIXPackage", args ?? new GetMSIXPackageInvokeArgs(), options.WithDefaults());
