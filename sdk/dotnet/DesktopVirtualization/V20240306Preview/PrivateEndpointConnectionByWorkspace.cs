...
namespace Pulumi.AzureNative.DesktopVirtualization.V20240306Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20240306preview:PrivateEndpointConnectionByWorkspace")]
    public partial class PrivateEndpointConnectionByWorkspace : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionByWorkspace(string name, PrivateEndpointConnectionByWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240306preview:PrivateEndpointConnectionByWorkspace", name, args ?? new PrivateEndpointConnectionByWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionByWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20240306preview:PrivateEndpointConnectionByWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
