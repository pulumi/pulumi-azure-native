...
namespace Pulumi.AzureNative.DesktopVirtualization.V20221014Preview
{
    ...
    /// {
    ///     var hostPool = new AzureNative.DesktopVirtualization.V20221014Preview.HostPool("hostPool", new()
    ///     {
    ///         AgentUpdate = new AzureNative.DesktopVirtualization.V20221014Preview.Inputs.AgentUpdatePropertiesArgs
    ///         {
    ///             MaintenanceWindowTimeZone = "Alaskan Standard Time",
    ///             MaintenanceWindows = new[]
    ///             {
    ///                 new AzureNative.DesktopVirtualization.V20221014Preview.Inputs.MaintenanceWindowPropertiesArgs
    ///                 {
    ///                     DayOfWeek = AzureNative.DesktopVirtualization.V20221014Preview.DayOfWeek.Friday,
    ///                     Hour = 7,
    ///                 },
    ///                 new AzureNative.DesktopVirtualization.V20221014Preview.Inputs.MaintenanceWindowPropertiesArgs
    ///                 {
    ///                     DayOfWeek = AzureNative.DesktopVirtualization.V20221014Preview.DayOfWeek.Saturday,
    ///                     Hour = 8,
    ///                 },
    ///             },
    ///             Type = "Scheduled",
    ...
    ///         RegistrationInfo = new AzureNative.DesktopVirtualization.V20221014Preview.Inputs.RegistrationInfoArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20221014preview:HostPool")]
    public partial class HostPool : global::Pulumi.CustomResource
    {
        ...
        public HostPool(string name, HostPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20221014preview:HostPool", name, args ?? new HostPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HostPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20221014preview:HostPool", name, null, MakeResourceOptions(options, id))
        {
        }
