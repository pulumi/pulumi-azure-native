...
namespace Pulumi.AzureNative.DesktopVirtualization.V20221014Preview
{
    ...
    /// {
    ///     var applicationGroup = new AzureNative.DesktopVirtualization.V20221014Preview.ApplicationGroup("applicationGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20221014preview:ApplicationGroup")]
    public partial class ApplicationGroup : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20221014preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20221014preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
