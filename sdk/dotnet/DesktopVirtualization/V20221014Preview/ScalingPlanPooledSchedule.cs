...
namespace Pulumi.AzureNative.DesktopVirtualization.V20221014Preview
{
    ...
    /// {
    ///     var scalingPlanPooledSchedule = new AzureNative.DesktopVirtualization.V20221014Preview.ScalingPlanPooledSchedule("scalingPlanPooledSchedule", new()
    ///     {
    ///         DaysOfWeek = new[]
    ///         {
    ///             "Monday",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule")]
    public partial class ScalingPlanPooledSchedule : global::Pulumi.CustomResource
    {
        ...
        public ScalingPlanPooledSchedule(string name, ScalingPlanPooledScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule", name, args ?? new ScalingPlanPooledScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlanPooledSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("daysOfWeek")]
        private InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20221014Preview.DayOfWeek>>? _daysOfWeek;

        /// <summary>
        /// Set of days of the week on which this schedule is active.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20221014Preview.DayOfWeek>> DaysOfWeek
        {
            get => _daysOfWeek ?? (_daysOfWeek = new InputList<Union<string, Pulumi.AzureNative.DesktopVirtualization.V20221014Preview.DayOfWeek>>());
