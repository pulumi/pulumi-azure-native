...
namespace Pulumi.AzureRM.DesktopVirtualization.V20190924Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationGroup = new AzureRM.DesktopVirtualization.V20190924Preview.ApplicationGroup("applicationGroup", new AzureRM.DesktopVirtualization.V20190924Preview.ApplicationGroupArgs
    ///         {
    ...
    public partial class ApplicationGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20190924preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20190924preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
