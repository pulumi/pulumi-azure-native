...
namespace Pulumi.AzureNative.DesktopVirtualization.V20190924Preview
{
    public static class GetApplication
    {
        ...
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("azure-native:desktopvirtualization/v20190924preview:getApplication", args ?? new GetApplicationArgs(), options.WithVersion());

        /// <summary>
        /// Schema for Application properties.
        /// </summary>
        public static Output<GetApplicationResult> Invoke(GetApplicationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationResult>("azure-native:desktopvirtualization/v20190924preview:getApplication", args ?? new GetApplicationInvokeArgs(), options.WithVersion());
    }
