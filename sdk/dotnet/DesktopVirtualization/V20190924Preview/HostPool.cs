...
namespace Pulumi.AzureRM.DesktopVirtualization.V20190924Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var hostPool = new AzureRM.DesktopVirtualization.V20190924Preview.HostPool("hostPool", new AzureRM.DesktopVirtualization.V20190924Preview.HostPoolArgs
    ///         {
    ///             Description = "des1",
    ...
    ///             RegistrationInfo = new AzureRM.DesktopVirtualization.V20190924Preview.Inputs.RegistrationInfoArgs
    ///             {
    ...
    public partial class HostPool : Pulumi.CustomResource
    {
        ...
        public HostPool(string name, HostPoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20190924preview:HostPool", name, args ?? new HostPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HostPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20190924preview:HostPool", name, null, MakeResourceOptions(options, id))
        {
        }
