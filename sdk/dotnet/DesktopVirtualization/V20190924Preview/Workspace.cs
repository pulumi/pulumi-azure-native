...
namespace Pulumi.AzureRM.DesktopVirtualization.V20190924Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workspace = new AzureRM.DesktopVirtualization.V20190924Preview.Workspace("workspace", new AzureRM.DesktopVirtualization.V20190924Preview.WorkspaceArgs
    ///         {
    ///             Description = "des1",
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20190924preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20190924preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
