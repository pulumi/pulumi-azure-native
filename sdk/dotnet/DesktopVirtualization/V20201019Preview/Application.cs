...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview
{
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20201019preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:desktopvirtualization/v20201019preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview.RemoteApplicationType>? ApplicationType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview.CommandLineSetting> CommandLineSetting { get; set; } = null!;
