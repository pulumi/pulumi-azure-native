...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:desktopvirtualization/v20201019preview:HostPool")]
    ...
    public sealed class HostPoolArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview.HostPoolType> HostPoolType { get; set; } = null!;

        /// <summary>
        /// The type of the load balancer.
        /// </summary>
        [Input("loadBalancerType", required: true)]
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview.LoadBalancerType> LoadBalancerType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview.PersonalDesktopAssignmentType>? PersonalDesktopAssignmentType { get; set; }

        /// <summary>
        /// The type of preferred application group type, default to Desktop Application Group
        /// </summary>
        [Input("preferredAppGroupType", required: true)]
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview.PreferredAppGroupType> PreferredAppGroupType { get; set; } = null!;
        ...
        /// </summary>
        [Input("ssoSecretType")]
        public InputUnion<string, Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview.SSOSecretType>? SsoSecretType { get; set; }
