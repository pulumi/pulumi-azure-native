...
namespace Pulumi.AzureNative.DesktopVirtualization.V20201019Preview
{
    ...
    /// </summary>
    [Obsolete(@"Version 2020-10-19-preview will be removed in v2 of the provider.
azure-native:desktopvirtualization/v20201019preview:HostPool is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20201102preview:HostPool to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20201019preview:HostPool")]
    public partial class HostPool : global::Pulumi.CustomResource
    {
        ...
        public HostPool(string name, HostPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20201019preview:HostPool", name, args ?? new HostPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HostPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20201019preview:HostPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HostPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20201019Preview.HostPoolType> HostPoolType { get; set; } = null!;

        /// <summary>
        /// The type of the load balancer.
        /// </summary>
        [Input("loadBalancerType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20201019Preview.LoadBalancerType> LoadBalancerType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20201019Preview.PersonalDesktopAssignmentType>? PersonalDesktopAssignmentType { get; set; }

        /// <summary>
        /// The type of preferred application group type, default to Desktop Application Group
        /// </summary>
        [Input("preferredAppGroupType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20201019Preview.PreferredAppGroupType> PreferredAppGroupType { get; set; } = null!;
        ...
        /// </summary>
        [Input("ssoSecretType")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20201019Preview.SSOSecretType>? SsoSecretType { get; set; }
