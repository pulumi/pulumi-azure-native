...
namespace Pulumi.AzureNextGen.DesktopVirtualization.V20201019Preview
{
    public static class GetWorkspace
    {
        public static Task<GetWorkspaceResult> InvokeAsync(GetWorkspaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceResult>("azure-nextgen:desktopvirtualization/v20201019preview:getWorkspace", args ?? new GetWorkspaceArgs(), options.WithVersion());
    }
