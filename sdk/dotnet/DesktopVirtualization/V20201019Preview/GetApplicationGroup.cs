...
namespace Pulumi.AzureNative.DesktopVirtualization.V20201019Preview
{
    public static class GetApplicationGroup
    {
        ...
        public static Task<GetApplicationGroupResult> InvokeAsync(GetApplicationGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationGroupResult>("azure-native:desktopvirtualization/v20201019preview:getApplicationGroup", args ?? new GetApplicationGroupArgs(), options.WithVersion());

        /// <summary>
        /// Represents a ApplicationGroup definition.
        /// </summary>
        public static Output<GetApplicationGroupResult> Invoke(GetApplicationGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationGroupResult>("azure-native:desktopvirtualization/v20201019preview:getApplicationGroup", args ?? new GetApplicationGroupInvokeArgs(), options.WithVersion());
    }
