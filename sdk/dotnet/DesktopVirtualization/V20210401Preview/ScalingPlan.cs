...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20210401preview:ScalingPlan")]
    public partial class ScalingPlan : Pulumi.CustomResource
    {
        ...
        public ScalingPlan(string name, ScalingPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210401preview:ScalingPlan", name, args ?? new ScalingPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210401preview:ScalingPlan", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210401preview:ScalingPlan"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:desktopvirtualization/v20210309preview:ScalingPlan"},
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210309preview:ScalingPlan"},
                    new Pulumi.Alias { Type = "azure-native:desktopvirtualization/v20210513preview:ScalingPlan"},
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210513preview:ScalingPlan"},
                    new Pulumi.Alias { Type = "azure-native:desktopvirtualization/v20210712:ScalingPlan"},
                    new Pulumi.Alias { Type = "azure-nextgen:desktopvirtualization/v20210712:ScalingPlan"},
                },
            };
    ...
    public sealed class ScalingPlanArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostPoolType")]
        public InputUnion<string, Pulumi.AzureNative.DesktopVirtualization.V20210401Preview.HostPoolType>? HostPoolType { get; set; }
