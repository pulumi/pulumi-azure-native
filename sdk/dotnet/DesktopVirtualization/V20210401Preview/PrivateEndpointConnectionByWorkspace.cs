...
namespace Pulumi.AzureNative.DesktopVirtualization.V20210401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:PrivateEndpointConnectionByWorkspace to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace")]
    public partial class PrivateEndpointConnectionByWorkspace : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionByWorkspace(string name, PrivateEndpointConnectionByWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace", name, args ?? new PrivateEndpointConnectionByWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionByWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
