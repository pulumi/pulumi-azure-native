...
namespace Pulumi.AzureRM.OperationsManagement.V20151101Preview
{
    public static class GetManagementAssociation
    {
        public static Task<GetManagementAssociationResult> InvokeAsync(GetManagementAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementAssociationResult>("azurerm:operationsmanagement/v20151101preview:getManagementAssociation", args ?? new GetManagementAssociationArgs(), options.WithVersion());
    }
