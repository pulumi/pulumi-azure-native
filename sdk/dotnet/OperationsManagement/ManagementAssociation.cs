...
namespace Pulumi.AzureNextGen.OperationsManagement
{
    ...
    public partial class ManagementAssociation : Pulumi.CustomResource
    {
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ManagementAssociation Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class ManagementAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.ManagementAssociationPropertiesArgs>? Properties { get; set; }
