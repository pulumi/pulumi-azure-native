...
namespace Pulumi.AzureRM.OperationsManagement.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var solution = new AzureRM.OperationsManagement.Latest.Solution("solution", new AzureRM.OperationsManagement.Latest.SolutionArgs
    ///         {
    ///             Location = "East US",
    ///             Plan = new AzureRM.OperationsManagement.Latest.Inputs.SolutionPlanArgs
    ///             {
    ///                 Name = "name1",
    ///                 Product = "product1",
    ...
    public partial class Solution : Pulumi.CustomResource
    {
        ...
        public Solution(string name, SolutionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationsmanagement/latest:Solution", name, args ?? new SolutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Solution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationsmanagement/latest:Solution", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:operationsmanagement/v20151101preview:Solution"},
                },
            };
