...
namespace Pulumi.AzureRM.OperationsManagement.Preview
{
    /// <summary>
    ...
    public partial class Solution : Pulumi.CustomResource
    {
        ...
        public Solution(string name, SolutionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationsmanagement/preview:Solution", name, args ?? new SolutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Solution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationsmanagement/preview:Solution", name, null, MakeResourceOptions(options, id))
        {
        }
