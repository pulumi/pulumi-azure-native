...
namespace Pulumi.AzureRM.OperationsManagement.Preview
{
    ...
    public partial class ManagementAssociation : Pulumi.CustomResource
    {
        ...
        public ManagementAssociation(string name, ManagementAssociationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationsmanagement/preview:ManagementAssociation", name, args ?? new ManagementAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationsmanagement/preview:ManagementAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
