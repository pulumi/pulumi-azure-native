...
namespace Pulumi.AzureRM.Notebooks.Preview
{
    public static class ListNotebookProxyCredentials
    {
        public static Task<ListNotebookProxyCredentialsResult> InvokeAsync(ListNotebookProxyCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNotebookProxyCredentialsResult>("azurerm:notebooks/preview:listNotebookProxyCredentials", args ?? new ListNotebookProxyCredentialsArgs(), options.WithVersion());
    }
