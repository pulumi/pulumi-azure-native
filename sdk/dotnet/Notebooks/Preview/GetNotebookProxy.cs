...
namespace Pulumi.AzureRM.Notebooks.Preview
{
    public static class GetNotebookProxy
    {
        public static Task<GetNotebookProxyResult> InvokeAsync(GetNotebookProxyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNotebookProxyResult>("azurerm:notebooks/preview:getNotebookProxy", args ?? new GetNotebookProxyArgs(), options.WithVersion());
    }
