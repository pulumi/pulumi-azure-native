...
namespace Pulumi.AzureRM.Notebooks.Preview
{
    /// <summary>
    ...
    public partial class NotebookProxy : Pulumi.CustomResource
    {
        ...
        public NotebookProxy(string name, NotebookProxyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:notebooks/preview:NotebookProxy", name, args ?? new NotebookProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:notebooks/preview:NotebookProxy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:notebooks/v20191011preview:NotebookProxy"},
                },
            };
