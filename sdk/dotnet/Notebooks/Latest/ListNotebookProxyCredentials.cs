...
namespace Pulumi.AzureRM.Notebooks.Latest
{
    public static class ListNotebookProxyCredentials
    {
        public static Task<ListNotebookProxyCredentialsResult> InvokeAsync(ListNotebookProxyCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNotebookProxyCredentialsResult>("azurerm:notebooks/latest:listNotebookProxyCredentials", args ?? new ListNotebookProxyCredentialsArgs(), options.WithVersion());
    }
