...
namespace Pulumi.AzureRM.Notebooks.Latest
{
    public static class GetNotebookProxy
    {
        public static Task<GetNotebookProxyResult> InvokeAsync(GetNotebookProxyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNotebookProxyResult>("azurerm:notebooks/latest:getNotebookProxy", args ?? new GetNotebookProxyArgs(), options.WithVersion());
    }
