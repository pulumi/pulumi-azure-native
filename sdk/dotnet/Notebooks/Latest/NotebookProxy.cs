...
namespace Pulumi.AzureRM.Notebooks.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var notebookProxy = new AzureRM.Notebooks.Latest.NotebookProxy("notebookProxy", new AzureRM.Notebooks.Latest.NotebookProxyArgs
    ///         {
    ...
    public partial class NotebookProxy : Pulumi.CustomResource
    {
        ...
        public NotebookProxy(string name, NotebookProxyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:notebooks/latest:NotebookProxy", name, args ?? new NotebookProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:notebooks/latest:NotebookProxy", name, null, MakeResourceOptions(options, id))
        {
        }
