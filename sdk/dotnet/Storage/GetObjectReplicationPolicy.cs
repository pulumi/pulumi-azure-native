...
namespace Pulumi.AzureRM.Storage
{
    public static class GetObjectReplicationPolicy
    {
        public static Task<GetObjectReplicationPolicyResult> InvokeAsync(GetObjectReplicationPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetObjectReplicationPolicyResult>("azurerm:storage:getObjectReplicationPolicy", args ?? new GetObjectReplicationPolicyArgs(), options.WithVersion());
    }
