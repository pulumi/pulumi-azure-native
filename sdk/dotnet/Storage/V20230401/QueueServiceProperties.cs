...
namespace Pulumi.AzureNative.Storage.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20230401:QueueServiceProperties")]
    public partial class QueueServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public QueueServiceProperties(string name, QueueServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:QueueServiceProperties", name, args ?? new QueueServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:QueueServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
