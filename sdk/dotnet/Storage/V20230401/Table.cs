...
namespace Pulumi.AzureNative.Storage.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20230401:Table")]
    public partial class Table : global::Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:Table", name, null, MakeResourceOptions(options, id))
        {
        }
