...
namespace Pulumi.AzureNative.Storage.V20230401
{
    ...
    /// The storage account.
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20230401:StorageAccount")]
    public partial class StorageAccount : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("allowSharedKeyAccess")]
        public Output<bool?> AllowSharedKeyAccess { get; private set; } = null!;
        ...
        public Output<Outputs.ImmutableStorageAccountResponse?> ImmutableStorageWithVersioning { get; private set; } = null!;
        ...
        /// </summary>
        [Output("isLocalUserEnabled")]
        public Output<bool?> IsLocalUserEnabled { get; private set; } = null!;
        ...
        public Output<Outputs.KeyCreationTimeResponse> KeyCreationTime { get; private set; } = null!;
        ...
        /// </summary>
        [Output("storageAccountSkuConversionStatus")]
        public Output<Outputs.StorageAccountSkuConversionStatusResponse?> StorageAccountSkuConversionStatus { get; private set; } = null!;
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessTier")]
        public Input<Pulumi.AzureNative.Storage.V20230401.AccessTier>? AccessTier { get; set; }
        ...
        /// Indicates whether the storage account permits requests to be authorized with the account access key via Shared Key. If false, then all requests, including shared access signatures, must be authorized with Azure Active Directory (Azure AD). The default value is null, which is equivalent to true.
        /// </summary>
        [Input("allowSharedKeyAccess")]
        public Input<bool>? AllowSharedKeyAccess { get; set; }

        /// <summary>
        /// Restrict copy to and from Storage Accounts within an AAD tenant or with Private Links to the same VNet.
        /// </summary>
        [Input("allowedCopyScope")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230401.AllowedCopyScope>? AllowedCopyScope { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230401.DnsEndpointType>? DnsEndpointType { get; set; }
        ...
        public Input<Inputs.ImmutableStorageAccountArgs>? ImmutableStorageWithVersioning { get; set; }
        ...
        /// Enables local users feature, if set to true
        /// </summary>
        [Input("isLocalUserEnabled")]
        public Input<bool>? IsLocalUserEnabled { get; set; }

        /// <summary>
        /// Enables Secure File Transfer Protocol, if set to true
        /// </summary>
        [Input("isSftpEnabled")]
        public Input<bool>? IsSftpEnabled { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230401.Kind> Kind { get; set; } = null!;

        /// <summary>
        /// Allow large file shares if sets to Enabled. It cannot be disabled once it is enabled.
        /// </summary>
        [Input("largeFileSharesState")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230401.LargeFileSharesState>? LargeFileSharesState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230401.MinimumTlsVersion>? MinimumTlsVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230401.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
