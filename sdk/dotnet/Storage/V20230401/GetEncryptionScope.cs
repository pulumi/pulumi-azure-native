...
namespace Pulumi.AzureNative.Storage.V20230401
{
    public static class GetEncryptionScope
    {
        ...
        public static Task<GetEncryptionScopeResult> InvokeAsync(GetEncryptionScopeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEncryptionScopeResult>("azure-native:storage/v20230401:getEncryptionScope", args ?? new GetEncryptionScopeArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the properties for the specified encryption scope.
        /// </summary>
        public static Output<GetEncryptionScopeResult> Invoke(GetEncryptionScopeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEncryptionScopeResult>("azure-native:storage/v20230401:getEncryptionScope", args ?? new GetEncryptionScopeInvokeArgs(), options.WithDefaults());
