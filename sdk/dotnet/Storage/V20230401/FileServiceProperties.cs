...
namespace Pulumi.AzureNative.Storage.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20230401:FileServiceProperties")]
    public partial class FileServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public FileServiceProperties(string name, FileServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:FileServiceProperties", name, args ?? new FileServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:FileServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
