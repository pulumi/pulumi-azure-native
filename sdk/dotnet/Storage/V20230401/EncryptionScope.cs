...
namespace Pulumi.AzureNative.Storage.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20230401:EncryptionScope")]
    public partial class EncryptionScope : global::Pulumi.CustomResource
    {
        ...
        public EncryptionScope(string name, EncryptionScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:EncryptionScope", name, args ?? new EncryptionScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EncryptionScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230401:EncryptionScope", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EncryptionScopeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("source")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230401.EncryptionScopeSource>? Source { get; set; }

        /// <summary>
        /// The state of the encryption scope. Possible values (case-insensitive):  Enabled, Disabled.
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230401.EncryptionScopeState>? State { get; set; }
