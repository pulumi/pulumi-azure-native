...
namespace Pulumi.AzureNative.Storage.V20180201
{
    public static class GetBlobContainer
    {
        ...
        public static Task<GetBlobContainerResult> InvokeAsync(GetBlobContainerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlobContainerResult>("azure-native:storage/v20180201:getBlobContainer", args ?? new GetBlobContainerArgs(), options.WithVersion());

        /// <summary>
        /// Properties of the blob container, including Id, resource name, resource type, Etag.
        /// </summary>
        public static Output<GetBlobContainerResult> Invoke(GetBlobContainerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBlobContainerResult>("azure-native:storage/v20180201:getBlobContainer", args ?? new GetBlobContainerInvokeArgs(), options.WithVersion());
    }
