...
namespace Pulumi.AzureNative.Storage
{
    public static class ListStorageAccountSAS
    {
        ...
        public static Task<ListStorageAccountSASResult> InvokeAsync(ListStorageAccountSASArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountSASResult>("azure-native:storage:listStorageAccountSAS", args ?? new ListStorageAccountSASArgs(), options.WithDefaults());
        ...
        public static Output<ListStorageAccountSASResult> Invoke(ListStorageAccountSASInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListStorageAccountSASResult>("azure-native:storage:listStorageAccountSAS", args ?? new ListStorageAccountSASInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class ListStorageAccountSASArgs : Pulumi.InvokeArgs
    {
        ...
        public Union<string, Pulumi.AzureNative.Storage.Permissions> Permissions { get; set; } = null!;
        ...
        public Union<string, Pulumi.AzureNative.Storage.SignedResourceTypes> ResourceTypes { get; set; } = null!;

        /// <summary>
        /// The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
        /// </summary>
        [Input("services", required: true)]
        public Union<string, Pulumi.AzureNative.Storage.Services> Services { get; set; } = null!;
    ...
    public sealed class ListStorageAccountSASInvokeArgs : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Storage.Permissions> Permissions { get; set; } = null!;

        /// <summary>
        /// The protocol permitted for a request made with the account SAS.
        /// </summary>
        [Input("protocols")]
        public Input<Pulumi.AzureNative.Storage.HttpProtocol>? Protocols { get; set; }
        ...
        /// </summary>
        [Input("resourceTypes", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Storage.SignedResourceTypes> ResourceTypes { get; set; } = null!;

        /// <summary>
        /// The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
        /// </summary>
        [Input("services", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Storage.Services> Services { get; set; } = null!;
