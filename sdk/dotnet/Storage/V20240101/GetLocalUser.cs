...
namespace Pulumi.AzureNative.Storage.V20240101
{
    public static class GetLocalUser
    {
        ...
        public static Task<GetLocalUserResult> InvokeAsync(GetLocalUserArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLocalUserResult>("azure-native:storage/v20240101:getLocalUser", args ?? new GetLocalUserArgs(), options.WithDefaults());

        /// <summary>
        /// Get the local user of the storage account by username.
        /// </summary>
        public static Output<GetLocalUserResult> Invoke(GetLocalUserInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLocalUserResult>("azure-native:storage/v20240101:getLocalUser", args ?? new GetLocalUserInvokeArgs(), options.WithDefaults());
