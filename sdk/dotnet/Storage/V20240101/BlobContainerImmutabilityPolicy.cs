...
namespace Pulumi.AzureNative.Storage.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20240101:BlobContainerImmutabilityPolicy")]
    public partial class BlobContainerImmutabilityPolicy : global::Pulumi.CustomResource
    {
        ...
        public BlobContainerImmutabilityPolicy(string name, BlobContainerImmutabilityPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20240101:BlobContainerImmutabilityPolicy", name, args ?? new BlobContainerImmutabilityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerImmutabilityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20240101:BlobContainerImmutabilityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
