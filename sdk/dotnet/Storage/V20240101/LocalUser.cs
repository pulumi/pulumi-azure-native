...
namespace Pulumi.AzureNative.Storage.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20240101:LocalUser")]
    public partial class LocalUser : global::Pulumi.CustomResource
    {
        ...
        public LocalUser(string name, LocalUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20240101:LocalUser", name, args ?? new LocalUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20240101:LocalUser", name, null, MakeResourceOptions(options, id))
        {
        }
