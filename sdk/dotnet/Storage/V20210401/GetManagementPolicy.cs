...
namespace Pulumi.AzureNative.Storage.V20210401
{
    public static class GetManagementPolicy
    {
        ...
        public static Task<GetManagementPolicyResult> InvokeAsync(GetManagementPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementPolicyResult>("azure-native:storage/v20210401:getManagementPolicy", args ?? new GetManagementPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// The Get Storage Account ManagementPolicies operation response.
        /// </summary>
        public static Output<GetManagementPolicyResult> Invoke(GetManagementPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetManagementPolicyResult>("azure-native:storage/v20210401:getManagementPolicy", args ?? new GetManagementPolicyInvokeArgs(), options.WithDefaults());
    }
