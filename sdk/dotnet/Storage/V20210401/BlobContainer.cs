...
namespace Pulumi.AzureNative.Storage.V20210401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storage/v20210401:BlobContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobContainer to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20210401:BlobContainer")]
    public partial class BlobContainer : global::Pulumi.CustomResource
    {
        ...
        public BlobContainer(string name, BlobContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210401:BlobContainer", name, args ?? new BlobContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210401:BlobContainer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BlobContainerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("publicAccess")]
        public Input<Pulumi.AzureNative.Storage.V20210401.PublicAccess>? PublicAccess { get; set; }
