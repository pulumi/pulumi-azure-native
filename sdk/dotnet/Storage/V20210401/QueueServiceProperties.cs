...
namespace Pulumi.AzureNative.Storage.V20210401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storage/v20210401:QueueServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:QueueServiceProperties to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20210401:QueueServiceProperties")]
    public partial class QueueServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public QueueServiceProperties(string name, QueueServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210401:QueueServiceProperties", name, args ?? new QueueServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210401:QueueServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
