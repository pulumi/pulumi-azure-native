...
namespace Pulumi.AzureNative.Storage.V20210401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storage/v20210401:ManagementPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:ManagementPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20210401:ManagementPolicy")]
    public partial class ManagementPolicy : global::Pulumi.CustomResource
    {
        ...
        public ManagementPolicy(string name, ManagementPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210401:ManagementPolicy", name, args ?? new ManagementPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210401:ManagementPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
