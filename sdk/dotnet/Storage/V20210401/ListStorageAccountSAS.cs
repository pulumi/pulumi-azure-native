...
namespace Pulumi.AzureNative.Storage.V20210401
{
    public static class ListStorageAccountSAS
    {
        ...
        public static Task<ListStorageAccountSASResult> InvokeAsync(ListStorageAccountSASArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountSASResult>("azure-native:storage/v20210401:listStorageAccountSAS", args ?? new ListStorageAccountSASArgs(), options.WithVersion());

        /// <summary>
        /// The List SAS credentials operation response.
        /// </summary>
        public static Output<ListStorageAccountSASResult> Invoke(ListStorageAccountSASInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListStorageAccountSASResult>("azure-native:storage/v20210401:listStorageAccountSAS", args ?? new ListStorageAccountSASInvokeArgs(), options.WithVersion());
    }
