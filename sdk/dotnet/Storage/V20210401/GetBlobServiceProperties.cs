...
namespace Pulumi.AzureNative.Storage.V20210401
{
    public static class GetBlobServiceProperties
    {
        ...
        public static Task<GetBlobServicePropertiesResult> InvokeAsync(GetBlobServicePropertiesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlobServicePropertiesResult>("azure-native:storage/v20210401:getBlobServiceProperties", args ?? new GetBlobServicePropertiesArgs(), options.WithVersion());
        ...
        public static Output<GetBlobServicePropertiesResult> Invoke(GetBlobServicePropertiesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBlobServicePropertiesResult>("azure-native:storage/v20210401:getBlobServiceProperties", args ?? new GetBlobServicePropertiesInvokeArgs(), options.WithVersion());
    }
