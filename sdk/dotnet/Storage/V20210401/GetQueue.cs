...
namespace Pulumi.AzureNative.Storage.V20210401
{
    public static class GetQueue
    {
        public static Task<GetQueueResult> InvokeAsync(GetQueueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetQueueResult>("azure-native:storage/v20210401:getQueue", args ?? new GetQueueArgs(), options.WithVersion());

        public static Output<GetQueueResult> Invoke(GetQueueInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetQueueResult>("azure-native:storage/v20210401:getQueue", args ?? new GetQueueInvokeArgs(), options.WithVersion());
    }
