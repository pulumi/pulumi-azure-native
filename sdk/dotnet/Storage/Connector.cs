...
namespace Pulumi.AzureNative.Storage
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage:Connector")]
    public partial class Connector : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.StorageConnectorPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20250801:Connector" },
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20260401:Connector" },
                },
            };
    ...
    public sealed class ConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.StorageConnectorPropertiesArgs> Properties { get; set; } = null!;
