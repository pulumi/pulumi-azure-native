...
namespace Pulumi.AzureRM.Storage.V20180301Preview
{
    public static class GetManagementPolicy
    {
        public static Task<GetManagementPolicyResult> InvokeAsync(GetManagementPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementPolicyResult>("azurerm:storage/v20180301preview:getManagementPolicy", args ?? new GetManagementPolicyArgs(), options.WithVersion());
    }
