...
namespace Pulumi.AzureNative.Storage.V20180301Preview
{
    ...
    /// {
    ///     var managementPolicy = new AzureNative.Storage.V20180301Preview.ManagementPolicy("managementPolicy", new()
    ///     {
    ///         AccountName = "sto9699",
    ...
    public partial class ManagementPolicy : global::Pulumi.CustomResource
    {
        ...
        public ManagementPolicy(string name, ManagementPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20180301preview:ManagementPolicy", name, args ?? new ManagementPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20180301preview:ManagementPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
