...
namespace Pulumi.AzureRM.Storage.V20180301Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managementPolicy = new AzureRM.Storage.V20180301Preview.ManagementPolicy("managementPolicy", new AzureRM.Storage.V20180301Preview.ManagementPolicyArgs
    ///         {
    ///             AccountName = "sto9699",
    ...
    public partial class ManagementPolicy : Pulumi.CustomResource
    {
        ...
        public ManagementPolicy(string name, ManagementPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20180301preview:ManagementPolicy", name, args ?? new ManagementPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20180301preview:ManagementPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
