...
namespace Pulumi.AzureRM.Storage.V20180301Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var storageAccount = new AzureRM.Storage.V20180301Preview.StorageAccount("storageAccount", new AzureRM.Storage.V20180301Preview.StorageAccountArgs
    ///         {
    ///             AccountName = "sto4445",
    ///             IsHnsEnabled = true,
    ///             Kind = "Storage",
    ...
    ///             Sku = new AzureRM.Storage.V20180301Preview.Inputs.SkuArgs
    ///             {
    ///                 Name = "Standard_GRS",
    ///             },
    ///             Tags = 
    ...
    public partial class StorageAccount : Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20180301preview:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20180301preview:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
