...
namespace Pulumi.AzureNative.Storage.V20180301Preview
{
    public static class ListStorageAccountKeys
    {
        ...
        public static Task<ListStorageAccountKeysResult> InvokeAsync(ListStorageAccountKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountKeysResult>("azure-native:storage/v20180301preview:listStorageAccountKeys", args ?? new ListStorageAccountKeysArgs(), options.WithVersion());
        ...
        public static Output<ListStorageAccountKeysResult> Invoke(ListStorageAccountKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListStorageAccountKeysResult>("azure-native:storage/v20180301preview:listStorageAccountKeys", args ?? new ListStorageAccountKeysInvokeArgs(), options.WithVersion());
    }
