...
namespace Pulumi.AzureNextGen.Storage.V20180301Preview
{
    public static class ListStorageAccountServiceSAS
    {
        public static Task<ListStorageAccountServiceSASResult> InvokeAsync(ListStorageAccountServiceSASArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountServiceSASResult>("azure-nextgen:storage/v20180301preview:listStorageAccountServiceSAS", args ?? new ListStorageAccountServiceSASArgs(), options.WithVersion());
    }
    ...
    public sealed class ListStorageAccountServiceSASArgs : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public Union<string, Pulumi.AzureNextGen.Storage.V20180301Preview.Permissions>? Permissions { get; set; }
        ...
        /// </summary>
        [Input("resource")]
        public Union<string, Pulumi.AzureNextGen.Storage.V20180301Preview.SignedResource>? Resource { get; set; }
