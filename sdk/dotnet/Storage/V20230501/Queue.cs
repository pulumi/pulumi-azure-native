...
{
    [AzureNativeResourceType("azure-native:storage/v20230501:Queue")]
    public partial class Queue : global::Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230501:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230501:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
