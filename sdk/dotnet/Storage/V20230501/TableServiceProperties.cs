...
namespace Pulumi.AzureNative.Storage.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20230501:TableServiceProperties")]
    public partial class TableServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public TableServiceProperties(string name, TableServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230501:TableServiceProperties", name, args ?? new TableServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230501:TableServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
