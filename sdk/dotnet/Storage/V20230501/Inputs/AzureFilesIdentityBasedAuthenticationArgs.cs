...
namespace Pulumi.AzureNative.Storage.V20230501.Inputs
{
    ...
    public sealed class AzureFilesIdentityBasedAuthenticationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230501.DefaultSharePermission>? DefaultSharePermission { get; set; }

        /// <summary>
        /// Indicates the directory service used. Note that this enum may be extended in the future.
        /// </summary>
        [Input("directoryServiceOptions", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230501.DirectoryServiceOptions> DirectoryServiceOptions { get; set; } = null!;
