...
namespace Pulumi.AzureNative.Storage.V20230501
{
    public static class ListLocalUserKeys
    {
        ...
        public static Task<ListLocalUserKeysResult> InvokeAsync(ListLocalUserKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListLocalUserKeysResult>("azure-native:storage/v20230501:listLocalUserKeys", args ?? new ListLocalUserKeysArgs(), options.WithDefaults());
