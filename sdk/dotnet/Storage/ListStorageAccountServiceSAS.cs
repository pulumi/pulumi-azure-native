...
namespace Pulumi.AzureNative.Storage
{
    public static class ListStorageAccountServiceSAS
    {
        ...
        public static Output<ListStorageAccountServiceSASResult> Invoke(ListStorageAccountServiceSASInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListStorageAccountServiceSASResult>("azure-native:storage:listStorageAccountServiceSAS", args ?? new ListStorageAccountServiceSASInvokeArgs(), options.WithVersion());
    }
    ...
    public sealed class ListStorageAccountServiceSASInvokeArgs : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public InputUnion<string, Pulumi.AzureNative.Storage.Permissions>? Permissions { get; set; }
        ...
        /// </summary>
        [Input("resource")]
        public InputUnion<string, Pulumi.AzureNative.Storage.SignedResource>? Resource { get; set; }
