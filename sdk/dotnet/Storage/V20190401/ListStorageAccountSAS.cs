...
namespace Pulumi.AzureNextGen.Storage.V20190401
{
    public static class ListStorageAccountSAS
    {
        ...
        public static Task<ListStorageAccountSASResult> InvokeAsync(ListStorageAccountSASArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountSASResult>("azure-nextgen:storage/v20190401:listStorageAccountSAS", args ?? new ListStorageAccountSASArgs(), options.WithVersion());
    }
    ...
    public sealed class ListStorageAccountSASArgs : Pulumi.InvokeArgs
    {
        ...
        public Union<string, Pulumi.AzureNextGen.Storage.V20190401.Permissions> Permissions { get; set; } = null!;

        /// <summary>
        /// The protocol permitted for a request made with the account SAS.
        /// </summary>
        [Input("protocols")]
        public Pulumi.AzureNextGen.Storage.V20190401.HttpProtocol? Protocols { get; set; }
        ...
        public Union<string, Pulumi.AzureNextGen.Storage.V20190401.SignedResourceTypes> ResourceTypes { get; set; } = null!;

        /// <summary>
        /// The signed services accessible with the account SAS. Possible values include: Blob (b), Queue (q), Table (t), File (f).
        /// </summary>
        [Input("services", required: true)]
        public Union<string, Pulumi.AzureNextGen.Storage.V20190401.Services> Services { get; set; } = null!;
