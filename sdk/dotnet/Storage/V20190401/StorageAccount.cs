...
namespace Pulumi.AzureRM.Storage.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var storageAccount = new AzureRM.Storage.V20190401.StorageAccount("storageAccount", new AzureRM.Storage.V20190401.StorageAccountArgs
    ///         {
    ///             AccountName = "sto4445",
    ...
    ///             Sku = new AzureRM.Storage.V20190401.Inputs.SkuArgs
    ///             {
    ///                 Name = "Standard_GRS",
    ///             },
    ///             Tags = 
    ...
    public partial class StorageAccount : Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20190401:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20190401:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
