...
namespace Pulumi.AzureNative.Storage.V20190401
{
    ...
    public partial class BlobServiceProperties : Pulumi.CustomResource
    {
        ...
        public BlobServiceProperties(string name, BlobServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190401:BlobServiceProperties", name, args ?? new BlobServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190401:BlobServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
