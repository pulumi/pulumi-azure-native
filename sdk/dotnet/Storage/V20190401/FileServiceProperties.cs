...
namespace Pulumi.AzureNextGen.Storage.V20190401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storage/v20190401:FileServiceProperties")]
    public partial class FileServiceProperties : Pulumi.CustomResource
    {
        ...
        public FileServiceProperties(string name, FileServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20190401:FileServiceProperties", name, args ?? new FileServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20190401:FileServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
