...
namespace Pulumi.AzureNative.Storage.V20190401
{
    ...
    /// {
    ///     var blobContainerImmutabilityPolicy = new AzureNative.Storage.V20190401.BlobContainerImmutabilityPolicy("blobContainerImmutabilityPolicy", new()
    ///     {
    ///         AccountName = "sto7069",
    ...
    [AzureNativeResourceType("azure-native:storage/v20190401:BlobContainerImmutabilityPolicy")]
    public partial class BlobContainerImmutabilityPolicy : global::Pulumi.CustomResource
    {
        ...
        public BlobContainerImmutabilityPolicy(string name, BlobContainerImmutabilityPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190401:BlobContainerImmutabilityPolicy", name, args ?? new BlobContainerImmutabilityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerImmutabilityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190401:BlobContainerImmutabilityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
