...
namespace Pulumi.AzureRM.Storage.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var blobContainerImmutabilityPolicy = new AzureRM.Storage.V20190401.BlobContainerImmutabilityPolicy("blobContainerImmutabilityPolicy", new AzureRM.Storage.V20190401.BlobContainerImmutabilityPolicyArgs
    ///         {
    ///             AccountName = "sto7069",
    ...
    public partial class BlobContainerImmutabilityPolicy : Pulumi.CustomResource
    {
        ...
        public BlobContainerImmutabilityPolicy(string name, BlobContainerImmutabilityPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20190401:BlobContainerImmutabilityPolicy", name, args ?? new BlobContainerImmutabilityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerImmutabilityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20190401:BlobContainerImmutabilityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
