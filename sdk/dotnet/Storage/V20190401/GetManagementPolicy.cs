...
namespace Pulumi.AzureRM.Storage.V20190401
{
    public static class GetManagementPolicy
    {
        public static Task<GetManagementPolicyResult> InvokeAsync(GetManagementPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementPolicyResult>("azurerm:storage/v20190401:getManagementPolicy", args ?? new GetManagementPolicyArgs(), options.WithVersion());
    }
