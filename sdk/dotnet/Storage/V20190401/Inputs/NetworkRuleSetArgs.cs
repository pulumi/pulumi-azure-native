...
namespace Pulumi.AzureNextGen.Storage.V20190401.Inputs
{
    ...
    public sealed class NetworkRuleSetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bypass")]
        public InputUnion<string, Pulumi.AzureNextGen.Storage.V20190401.Bypass>? Bypass { get; set; }

        /// <summary>
        /// Specifies the default action of allow or deny when no other rules match.
        /// </summary>
        [Input("defaultAction", required: true)]
        public Input<Pulumi.AzureNextGen.Storage.V20190401.DefaultAction> DefaultAction { get; set; } = null!;
        ...
        public NetworkRuleSetArgs()
        {
            ...
            DefaultAction = Pulumi.AzureNextGen.Storage.V20190401.DefaultAction.Allow;
        }
    }
}
