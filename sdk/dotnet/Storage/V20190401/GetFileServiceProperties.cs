...
namespace Pulumi.AzureNative.Storage.V20190401
{
    public static class GetFileServiceProperties
    {
        ...
        public static Task<GetFileServicePropertiesResult> InvokeAsync(GetFileServicePropertiesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFileServicePropertiesResult>("azure-native:storage/v20190401:getFileServiceProperties", args ?? new GetFileServicePropertiesArgs(), options.WithVersion());
        ...
        public static Output<GetFileServicePropertiesResult> Invoke(GetFileServicePropertiesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFileServicePropertiesResult>("azure-native:storage/v20190401:getFileServiceProperties", args ?? new GetFileServicePropertiesInvokeArgs(), options.WithVersion());
    }
