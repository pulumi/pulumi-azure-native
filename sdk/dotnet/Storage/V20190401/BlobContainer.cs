...
namespace Pulumi.AzureNextGen.Storage.V20190401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storage/v20190401:BlobContainer")]
    public partial class BlobContainer : Pulumi.CustomResource
    {
        ...
        public BlobContainer(string name, BlobContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20190401:BlobContainer", name, args ?? new BlobContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20190401:BlobContainer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BlobContainerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("publicAccess")]
        public Input<Pulumi.AzureNextGen.Storage.V20190401.PublicAccess>? PublicAccess { get; set; }
