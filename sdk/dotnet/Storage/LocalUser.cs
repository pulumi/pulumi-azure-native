...
namespace Pulumi.AzureNative.Storage
{
    ...
    public partial class LocalUser : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("allowAclAuthorization")]
        public Output<bool?> AllowAclAuthorization { get; private set; } = null!;
        ...
        /// </summary>
        [Output("extendedGroups")]
        public Output<ImmutableArray<int>> ExtendedGroups { get; private set; } = null!;
        ...
        /// </summary>
        [Output("isNFSv3Enabled")]
        public Output<bool?> IsNFSv3Enabled { get; private set; } = null!;
        ...
        public LocalUser(string name, LocalUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage:LocalUser", name, args ?? new LocalUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage:LocalUser", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20250101:LocalUser" },
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20250601:LocalUser" },
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20250801:LocalUser" },
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20260401:LocalUser" },
                },
            };
    ...
    public sealed class LocalUserArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// Indicates whether ACL authorization is allowed for this user. Set it to false to disallow using ACL authorization.
        /// </summary>
        [Input("allowAclAuthorization")]
        public Input<bool>? AllowAclAuthorization { get; set; }

        [Input("extendedGroups")]
        private InputList<int>? _extendedGroups;

        /// <summary>
        /// Supplementary group membership. Only applicable for local users enabled for NFSv3 access.
        /// </summary>
        public InputList<int> ExtendedGroups
        {
            get => _extendedGroups ?? (_extendedGroups = new InputList<int>());
            set => _extendedGroups = value;
        }
        ...
        /// Indicates if the local user is enabled for access with NFSv3 protocol.
        /// </summary>
        [Input("isNFSv3Enabled")]
        public Input<bool>? IsNFSv3Enabled { get; set; }
