...
namespace Pulumi.AzureNative.Storage.V20210801.Inputs
{
    ...
    public sealed class VirtualNetworkRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public Input<Pulumi.AzureNative.Storage.V20210801.Action>? Action { get; set; }

        /// <summary>
        /// Gets the state of virtual network rule.
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210801.State>? State { get; set; }
        ...
        {
            Action = Pulumi.AzureNative.Storage.V20210801.Action.Allow;
        }
