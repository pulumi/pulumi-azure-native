...
namespace Pulumi.AzureNative.Storage.V20210801.Inputs
{
    ...
    public sealed class AzureFilesIdentityBasedAuthenticationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210801.DefaultSharePermission>? DefaultSharePermission { get; set; }

        /// <summary>
        /// Indicates the directory service used.
        /// </summary>
        [Input("directoryServiceOptions", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210801.DirectoryServiceOptions> DirectoryServiceOptions { get; set; } = null!;
