...
namespace Pulumi.AzureNative.Storage.V20210801
{
    ...
    /// {
    ///     var localUser = new AzureNative.Storage.V20210801.LocalUser("localUser", new()
    ///     {
    ///         AccountName = "sto2527",
    ///         HasSshPassword = true,
    ...
    ///         {
    ///             new AzureNative.Storage.V20210801.Inputs.PermissionScopeArgs
    ///             {
    ///                 Permissions = "rwd",
    ///                 ResourceName = "share1",
    ///                 Service = "file",
    ...
    ///         {
    ///             new AzureNative.Storage.V20210801.Inputs.SshPublicKeyArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:storage/v20210801:LocalUser user1 /subscriptions/{subscription-id}/resourceGroups/res6977/providers/Microsoft.Storage/storageAccounts/sto2527/loalUsers/user1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20210801:LocalUser")]
    public partial class LocalUser : global::Pulumi.CustomResource
    {
        ...
        public LocalUser(string name, LocalUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:LocalUser", name, args ?? new LocalUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:LocalUser", name, null, MakeResourceOptions(options, id))
        {
        }
