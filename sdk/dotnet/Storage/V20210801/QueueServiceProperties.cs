...
namespace Pulumi.AzureNative.Storage.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20210801:QueueServiceProperties")]
    public partial class QueueServiceProperties : Pulumi.CustomResource
    {
        ...
        public QueueServiceProperties(string name, QueueServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:QueueServiceProperties", name, args ?? new QueueServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:QueueServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
