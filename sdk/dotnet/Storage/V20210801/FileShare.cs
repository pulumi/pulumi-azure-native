...
namespace Pulumi.AzureNative.Storage.V20210801
{
    ...
    public partial class FileShare : Pulumi.CustomResource
    {
        ...
        public FileShare(string name, FileShareArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:FileShare", name, args ?? new FileShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileShare(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:FileShare", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FileShareArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessTier")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210801.ShareAccessTier>? AccessTier { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210801.EnabledProtocols>? EnabledProtocols { get; set; }
        ...
        /// </summary>
        [Input("rootSquash")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210801.RootSquashType>? RootSquash { get; set; }
