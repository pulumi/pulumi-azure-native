...
namespace Pulumi.AzureNative.Storage.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20210801:TableServiceProperties")]
    public partial class TableServiceProperties : Pulumi.CustomResource
    {
        ...
        public TableServiceProperties(string name, TableServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:TableServiceProperties", name, args ?? new TableServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:TableServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
