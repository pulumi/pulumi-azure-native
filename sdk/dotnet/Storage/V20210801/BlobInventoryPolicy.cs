...
namespace Pulumi.AzureNative.Storage.V20210801
{
    ...
    [AzureNativeResourceType("azure-native:storage/v20210801:BlobInventoryPolicy")]
    public partial class BlobInventoryPolicy : global::Pulumi.CustomResource
    {
        ...
        public BlobInventoryPolicy(string name, BlobInventoryPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:BlobInventoryPolicy", name, args ?? new BlobInventoryPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobInventoryPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210801:BlobInventoryPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
