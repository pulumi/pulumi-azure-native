...
namespace Pulumi.AzureNative.Storage.V20210901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storage/v20210901:LocalUser is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:LocalUser to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20210901:LocalUser")]
    public partial class LocalUser : global::Pulumi.CustomResource
    {
        ...
        public LocalUser(string name, LocalUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210901:LocalUser", name, args ?? new LocalUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210901:LocalUser", name, null, MakeResourceOptions(options, id))
        {
        }
