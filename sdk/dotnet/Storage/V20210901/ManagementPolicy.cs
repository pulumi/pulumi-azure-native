...
namespace Pulumi.AzureNative.Storage.V20210901
{
    ...
    [AzureNativeResourceType("azure-native:storage/v20210901:ManagementPolicy")]
    public partial class ManagementPolicy : global::Pulumi.CustomResource
    {
        ...
        public ManagementPolicy(string name, ManagementPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210901:ManagementPolicy", name, args ?? new ManagementPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210901:ManagementPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
