...
namespace Pulumi.AzureNative.Storage.V20210901.Inputs
{
    ...
    public sealed class AzureFilesIdentityBasedAuthenticationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210901.DefaultSharePermission>? DefaultSharePermission { get; set; }

        /// <summary>
        /// Indicates the directory service used.
        /// </summary>
        [Input("directoryServiceOptions", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210901.DirectoryServiceOptions> DirectoryServiceOptions { get; set; } = null!;
