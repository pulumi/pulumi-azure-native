...
namespace Pulumi.AzureNative.Storage.V20210901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20210901:Table")]
    public partial class Table : Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210901:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210901:Table", name, null, MakeResourceOptions(options, id))
        {
        }
