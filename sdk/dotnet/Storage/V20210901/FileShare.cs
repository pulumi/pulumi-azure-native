...
namespace Pulumi.AzureNative.Storage.V20210901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20210901:FileShare")]
    public partial class FileShare : global::Pulumi.CustomResource
    {
        ...
        public FileShare(string name, FileShareArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210901:FileShare", name, args ?? new FileShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileShare(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210901:FileShare", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FileShareArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessTier")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210901.ShareAccessTier>? AccessTier { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210901.EnabledProtocols>? EnabledProtocols { get; set; }
        ...
        /// </summary>
        [Input("rootSquash")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210901.RootSquashType>? RootSquash { get; set; }
