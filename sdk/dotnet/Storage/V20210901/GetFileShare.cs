...
namespace Pulumi.AzureNative.Storage.V20210901
{
    public static class GetFileShare
    {
        ...
        public static Task<GetFileShareResult> InvokeAsync(GetFileShareArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFileShareResult>("azure-native:storage/v20210901:getFileShare", args ?? new GetFileShareArgs(), options.WithDefaults());

        /// <summary>
        /// Properties of the file share, including Id, resource name, resource type, Etag.
        /// </summary>
        public static Output<GetFileShareResult> Invoke(GetFileShareInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFileShareResult>("azure-native:storage/v20210901:getFileShare", args ?? new GetFileShareInvokeArgs(), options.WithDefaults());
    }
