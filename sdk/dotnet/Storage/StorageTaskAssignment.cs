...
namespace Pulumi.AzureNative.Storage
{
    ...
    public partial class StorageTaskAssignment : global::Pulumi.CustomResource
    {
        ...
        public StorageTaskAssignment(string name, StorageTaskAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage:StorageTaskAssignment", name, args ?? new StorageTaskAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTaskAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage:StorageTaskAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20250101:StorageTaskAssignment" },
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20250601:StorageTaskAssignment" },
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20250801:StorageTaskAssignment" },
                    new global::Pulumi.Alias { Type = "azure-native:storage/v20260401:StorageTaskAssignment" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static StorageTaskAssignment Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new StorageTaskAssignment(name, id, options);
        }
    }

    public sealed class StorageTaskAssignmentArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("storageTaskAssignmentName")]
        public Input<string>? StorageTaskAssignmentName { get; set; }

        public StorageTaskAssignmentArgs()
        {
        }
        public static new StorageTaskAssignmentArgs Empty => new StorageTaskAssignmentArgs();
    }
}
