...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getEncryptionScope'.")]
    public static class GetEncryptionScope
    {
        ...
        public static Task<GetEncryptionScopeResult> InvokeAsync(GetEncryptionScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEncryptionScopeResult>("azure-native:storage/latest:getEncryptionScope", args ?? new GetEncryptionScopeArgs(), options.WithVersion());
    }
