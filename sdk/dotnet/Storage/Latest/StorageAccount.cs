...
namespace Pulumi.AzureNextGen.Storage.Latest
{
    ...
    public sealed class StorageAccountArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Storage.Latest.Kind> Kind { get; set; } = null!;

        /// <summary>
        /// Allow large file shares if sets to Enabled. It cannot be disabled once it is enabled.
        /// </summary>
        [Input("largeFileSharesState")]
        public InputUnion<string, Pulumi.AzureNextGen.Storage.Latest.LargeFileSharesState>? LargeFileSharesState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Storage.Latest.MinimumTlsVersion>? MinimumTlsVersion { get; set; }
