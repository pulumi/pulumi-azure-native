...
{
    public partial class StorageAccountQueueServiceQueue : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.QueuePropertiesResponse> Properties { get; private set; } = null!;
        ...
        public StorageAccountQueueServiceQueue(string name, StorageAccountQueueServiceQueueArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage:StorageAccountQueueServiceQueue", name, args ?? new StorageAccountQueueServiceQueueArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class StorageAccountQueueServiceQueueArgs : Pulumi.ResourceArgs
    {
        /// <summary>
