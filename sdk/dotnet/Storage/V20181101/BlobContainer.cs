...
namespace Pulumi.AzureRM.Storage.V20181101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var blobContainer = new AzureRM.Storage.V20181101.BlobContainer("blobContainer", new AzureRM.Storage.V20181101.BlobContainerArgs
    ///         {
    ///             AccountName = "sto328",
    ...
    public partial class BlobContainer : Pulumi.CustomResource
    {
        ...
        public BlobContainer(string name, BlobContainerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20181101:BlobContainer", name, args ?? new BlobContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20181101:BlobContainer", name, null, MakeResourceOptions(options, id))
        {
        }
