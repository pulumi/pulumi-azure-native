...
namespace Pulumi.AzureNative.Storage.V20181101
{
    public static class GetStorageAccount
    {
        ...
        public static Task<GetStorageAccountResult> InvokeAsync(GetStorageAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageAccountResult>("azure-native:storage/v20181101:getStorageAccount", args ?? new GetStorageAccountArgs(), options.WithDefaults());

        /// <summary>
        /// The storage account.
        /// </summary>
        public static Output<GetStorageAccountResult> Invoke(GetStorageAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStorageAccountResult>("azure-native:storage/v20181101:getStorageAccount", args ?? new GetStorageAccountInvokeArgs(), options.WithDefaults());
    }
