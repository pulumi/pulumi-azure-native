...
namespace Pulumi.AzureNative.Storage.V20181101
{
    public static class GetManagementPolicy
    {
        ...
        public static Output<GetManagementPolicyResult> Invoke(GetManagementPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetManagementPolicyResult>("azure-native:storage/v20181101:getManagementPolicy", args ?? new GetManagementPolicyInvokeArgs(), options.WithVersion());
    }
