...
namespace Pulumi.AzureRM.Storage.Inputs
{
    ...
    public sealed class StorageAccountPropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AzureFilesIdentityBasedAuthenticationResponseGetArgs>? AzureFilesIdentityBasedAuthentication { get; set; }

        /// <summary>
        /// Blob restore status
        /// </summary>
        [Input("blobRestoreStatus", required: true)]
        public Input<Inputs.BlobRestoreStatusResponseGetArgs> BlobRestoreStatus { get; set; } = null!;
        ...
        public Input<Inputs.CustomDomainResponseGetArgs> CustomDomain { get; set; } = null!;

        /// <summary>
        /// Gets the encryption settings on the account. If unspecified, the account is unencrypted.
        /// </summary>
        [Input("encryption", required: true)]
        public Input<Inputs.EncryptionResponseGetArgs> Encryption { get; set; } = null!;
        ...
        public Input<Inputs.GeoReplicationStatsResponseGetArgs> GeoReplicationStats { get; set; } = null!;
        ...
        public Input<Inputs.NetworkRuleSetResponseGetArgs> NetworkAcls { get; set; } = null!;

        /// <summary>
        /// Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object. Note that Standard_ZRS and Premium_LRS accounts only return the blob endpoint.
        /// </summary>
        [Input("primaryEndpoints", required: true)]
        public Input<Inputs.EndpointsResponseGetArgs> PrimaryEndpoints { get; set; } = null!;
        ...
        public Input<Inputs.RoutingPreferenceResponseGetArgs>? RoutingPreference { get; set; }

        /// <summary>
        /// Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object from the secondary location of the storage account. Only available if the SKU name is Standard_RAGRS.
        /// </summary>
        [Input("secondaryEndpoints", required: true)]
        public Input<Inputs.EndpointsResponseGetArgs> SecondaryEndpoints { get; set; } = null!;
