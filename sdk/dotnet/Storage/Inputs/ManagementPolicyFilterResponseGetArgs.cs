...
namespace Pulumi.AzureRM.Storage.Inputs
{
    ...
    /// </summary>
    public sealed class ManagementPolicyFilterResponseGetArgs : Pulumi.ResourceArgs
    {
        [Input("blobIndexMatch")]
        private InputList<Inputs.TagFilterResponseGetArgs>? _blobIndexMatch;

        /// <summary>
        /// An array of blob index tag based filters, there can be at most 10 tag filters
        /// </summary>
        public InputList<Inputs.TagFilterResponseGetArgs> BlobIndexMatch
        {
            get => _blobIndexMatch ?? (_blobIndexMatch = new InputList<Inputs.TagFilterResponseGetArgs>());
        ...
        public ManagementPolicyFilterResponseGetArgs()
        {
        }
    }
}
