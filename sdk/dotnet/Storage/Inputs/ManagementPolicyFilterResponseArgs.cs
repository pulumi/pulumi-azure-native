...
namespace Pulumi.AzureRM.Storage.Inputs
{
    ...
    /// </summary>
    public sealed class ManagementPolicyFilterResponseArgs : Pulumi.ResourceArgs
    {
        [Input("blobIndexMatch")]
        private InputList<Inputs.TagFilterResponseArgs>? _blobIndexMatch;

        /// <summary>
        /// An array of blob index tag based filters, there can be at most 10 tag filters
        /// </summary>
        public InputList<Inputs.TagFilterResponseArgs> BlobIndexMatch
        {
            get => _blobIndexMatch ?? (_blobIndexMatch = new InputList<Inputs.TagFilterResponseArgs>());
        ...
        public ManagementPolicyFilterResponseArgs()
        {
        }
    }
}
