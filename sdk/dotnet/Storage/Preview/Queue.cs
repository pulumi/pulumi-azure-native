...
namespace Pulumi.AzureRM.Storage.Preview
{
    public partial class Queue : Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/preview:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/preview:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
