...
namespace Pulumi.AzureRM.Storage.Preview
{
    public static class GetStorageAccount
    {
        public static Task<GetStorageAccountResult> InvokeAsync(GetStorageAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageAccountResult>("azurerm:storage/preview:getStorageAccount", args ?? new GetStorageAccountArgs(), options.WithVersion());
    }
