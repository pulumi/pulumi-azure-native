...
namespace Pulumi.AzureRM.Storage.Preview
{
    public static class GetBlobContainer
    {
        public static Task<GetBlobContainerResult> InvokeAsync(GetBlobContainerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlobContainerResult>("azurerm:storage/preview:getBlobContainer", args ?? new GetBlobContainerArgs(), options.WithVersion());
    }
