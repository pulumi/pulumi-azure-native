...
namespace Pulumi.AzureRM.Storage.Preview
{
    public static class GetManagementPolicy
    {
        public static Task<GetManagementPolicyResult> InvokeAsync(GetManagementPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementPolicyResult>("azurerm:storage/preview:getManagementPolicy", args ?? new GetManagementPolicyArgs(), options.WithVersion());
    }
