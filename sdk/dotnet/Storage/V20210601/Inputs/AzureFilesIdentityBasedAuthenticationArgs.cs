...
namespace Pulumi.AzureNative.Storage.V20210601.Inputs
{
    ...
    public sealed class AzureFilesIdentityBasedAuthenticationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210601.DefaultSharePermission>? DefaultSharePermission { get; set; }

        /// <summary>
        /// Indicates the directory service used.
        /// </summary>
        [Input("directoryServiceOptions", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210601.DirectoryServiceOptions> DirectoryServiceOptions { get; set; } = null!;
