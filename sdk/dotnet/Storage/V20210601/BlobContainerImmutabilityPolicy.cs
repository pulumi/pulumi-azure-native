...
namespace Pulumi.AzureNative.Storage.V20210601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storage/v20210601:BlobContainerImmutabilityPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobContainerImmutabilityPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20210601:BlobContainerImmutabilityPolicy")]
    public partial class BlobContainerImmutabilityPolicy : global::Pulumi.CustomResource
    {
        ...
        public BlobContainerImmutabilityPolicy(string name, BlobContainerImmutabilityPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210601:BlobContainerImmutabilityPolicy", name, args ?? new BlobContainerImmutabilityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerImmutabilityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210601:BlobContainerImmutabilityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
