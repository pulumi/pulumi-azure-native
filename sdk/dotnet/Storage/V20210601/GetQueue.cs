...
{
    [Obsolete(@"azure-native:storage/v20210601:Queue is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:Queue to guarantee forwards compatibility.")]
    public static class GetQueue
    {
        ...
        public static Task<GetQueueResult> InvokeAsync(GetQueueArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetQueueResult>("azure-native:storage/v20210601:getQueue", args ?? new GetQueueArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the queue with the specified queue name, under the specified account if it exists.
        /// </summary>
        public static Output<GetQueueResult> Invoke(GetQueueInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetQueueResult>("azure-native:storage/v20210601:getQueue", args ?? new GetQueueInvokeArgs(), options.WithDefaults());
    }
