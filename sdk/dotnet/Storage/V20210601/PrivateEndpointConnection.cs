...
namespace Pulumi.AzureNative.Storage.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20210601:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210601:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210601:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:storage/v20210601:PrivateEndpointConnection"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:storage/v20210201:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:storage/v20210401:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:storage/v20210401:PrivateEndpointConnection"},
                },
            };
