...
namespace Pulumi.AzureNative.Storage.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20210601:Table")]
    public partial class Table : Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210601:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210601:Table", name, null, MakeResourceOptions(options, id))
        {
        }
