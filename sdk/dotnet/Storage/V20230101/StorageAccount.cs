...
namespace Pulumi.AzureNative.Storage.V20230101
{
    ...
    /// The storage account.
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20230101:StorageAccount")]
    public partial class StorageAccount : global::Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230101:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230101:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessTier")]
        public Input<Pulumi.AzureNative.Storage.V20230101.AccessTier>? AccessTier { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230101.AllowedCopyScope>? AllowedCopyScope { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230101.DnsEndpointType>? DnsEndpointType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230101.Kind> Kind { get; set; } = null!;

        /// <summary>
        /// Allow large file shares if sets to Enabled. It cannot be disabled once it is enabled.
        /// </summary>
        [Input("largeFileSharesState")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230101.LargeFileSharesState>? LargeFileSharesState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230101.MinimumTlsVersion>? MinimumTlsVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230101.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
