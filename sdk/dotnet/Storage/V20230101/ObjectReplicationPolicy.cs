...
namespace Pulumi.AzureNative.Storage.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20230101:ObjectReplicationPolicy")]
    public partial class ObjectReplicationPolicy : global::Pulumi.CustomResource
    {
        ...
        public ObjectReplicationPolicy(string name, ObjectReplicationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230101:ObjectReplicationPolicy", name, args ?? new ObjectReplicationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ObjectReplicationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20230101:ObjectReplicationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
