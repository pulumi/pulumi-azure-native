...
namespace Pulumi.AzureNative.Storage.V20230101
{
    public static class GetFileShare
    {
        ...
        public static Task<GetFileShareResult> InvokeAsync(GetFileShareArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFileShareResult>("azure-native:storage/v20230101:getFileShare", args ?? new GetFileShareArgs(), options.WithDefaults());

        /// <summary>
        /// Gets properties of a specified share.
        /// </summary>
        public static Output<GetFileShareResult> Invoke(GetFileShareInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFileShareResult>("azure-native:storage/v20230101:getFileShare", args ?? new GetFileShareInvokeArgs(), options.WithDefaults());
    }
