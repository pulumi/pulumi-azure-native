...
namespace Pulumi.AzureNative.Storage.V20230101
{
    public static class ListStorageAccountServiceSAS
    {
        ...
        public static Task<ListStorageAccountServiceSASResult> InvokeAsync(ListStorageAccountServiceSASArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountServiceSASResult>("azure-native:storage/v20230101:listStorageAccountServiceSAS", args ?? new ListStorageAccountServiceSASArgs(), options.WithDefaults());
        ...
        public static Output<ListStorageAccountServiceSASResult> Invoke(ListStorageAccountServiceSASInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListStorageAccountServiceSASResult>("azure-native:storage/v20230101:listStorageAccountServiceSAS", args ?? new ListStorageAccountServiceSASInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class ListStorageAccountServiceSASArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public Union<string, Pulumi.AzureNative.Storage.V20230101.Permissions>? Permissions { get; set; }

        /// <summary>
        /// The protocol permitted for a request made with the account SAS.
        /// </summary>
        [Input("protocols")]
        public Pulumi.AzureNative.Storage.V20230101.HttpProtocol? Protocols { get; set; }

        /// <summary>
        /// The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s).
        /// </summary>
        [Input("resource")]
        public Union<string, Pulumi.AzureNative.Storage.V20230101.SignedResource>? Resource { get; set; }
    ...
    public sealed class ListStorageAccountServiceSASInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230101.Permissions>? Permissions { get; set; }

        /// <summary>
        /// The protocol permitted for a request made with the account SAS.
        /// </summary>
        [Input("protocols")]
        public Input<Pulumi.AzureNative.Storage.V20230101.HttpProtocol>? Protocols { get; set; }

        /// <summary>
        /// The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s).
        /// </summary>
        [Input("resource")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20230101.SignedResource>? Resource { get; set; }
