...
namespace Pulumi.AzureNative.Storage.V20220901
{
    ...
    /// {
    ///     var blobServiceProperties = new AzureNative.Storage.V20220901.BlobServiceProperties("blobServiceProperties", new()
    ///     {
    ///         AccountName = "sto8607",
    ...
    ///         AccountName = "sto8607",
    ///         BlobServicesName = "default",
    ///         LastAccessTimeTrackingPolicy = new AzureNative.Storage.V20220901.Inputs.LastAccessTimeTrackingPolicyArgs
    ///         {
    ///             BlobType = new[]
    ///             {
    ///                 "blockBlob",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20220901:BlobServiceProperties")]
    public partial class BlobServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public BlobServiceProperties(string name, BlobServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:BlobServiceProperties", name, args ?? new BlobServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:BlobServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
