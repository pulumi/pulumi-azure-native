...
namespace Pulumi.AzureNative.Storage.V20220901
{
    ...
    /// {
    ///     var fileServiceProperties = new AzureNative.Storage.V20220901.FileServiceProperties("fileServiceProperties", new()
    ///     {
    ///         AccountName = "sto8607",
    ...
    ///         {
    ///             Smb = new AzureNative.Storage.V20220901.Inputs.SmbSettingArgs
    ///             {
    ///                 Multichannel = new AzureNative.Storage.V20220901.Inputs.MultichannelArgs
    ///                 {
    ///                     Enabled = true,
    ///                 },
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20220901:FileServiceProperties")]
    public partial class FileServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public FileServiceProperties(string name, FileServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:FileServiceProperties", name, args ?? new FileServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:FileServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
