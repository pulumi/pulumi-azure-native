...
namespace Pulumi.AzureNative.Storage.V20220901
{
    ...
    /// {
    ///     var blobContainerImmutabilityPolicy = new AzureNative.Storage.V20220901.BlobContainerImmutabilityPolicy("blobContainerImmutabilityPolicy", new()
    ///     {
    ///         AccountName = "sto7069",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20220901:BlobContainerImmutabilityPolicy")]
    public partial class BlobContainerImmutabilityPolicy : global::Pulumi.CustomResource
    {
        ...
        public BlobContainerImmutabilityPolicy(string name, BlobContainerImmutabilityPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:BlobContainerImmutabilityPolicy", name, args ?? new BlobContainerImmutabilityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerImmutabilityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:BlobContainerImmutabilityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
