...
namespace Pulumi.AzureNative.Storage.V20220901
{
    ...
    /// {
    ///     var blobContainer = new AzureNative.Storage.V20220901.BlobContainer("blobContainer", new()
    ///     {
    ///         AccountName = "sto328",
    ...
    ///         AccountName = "sto328",
    ///         ContainerName = "container6185",
    ///         ImmutableStorageWithVersioning = new AzureNative.Storage.V20220901.Inputs.ImmutableStorageWithVersioningArgs
    ///         {
    ///             Enabled = true,
    ///         },
    ///         ResourceGroupName = "res3376",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20220901:BlobContainer")]
    public partial class BlobContainer : global::Pulumi.CustomResource
    {
        ...
        public BlobContainer(string name, BlobContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:BlobContainer", name, args ?? new BlobContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:BlobContainer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BlobContainerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("publicAccess")]
        public Input<Pulumi.AzureNative.Storage.V20220901.PublicAccess>? PublicAccess { get; set; }
