...
namespace Pulumi.AzureNative.Storage.V20220901
{
    ...
    /// {
    ///     var tableServiceProperties = new AzureNative.Storage.V20220901.TableServiceProperties("tableServiceProperties", new()
    ///     {
    ///         AccountName = "sto8607",
    ...
    ///             CorsRules = new[]
    ///             {
    ///                 new AzureNative.Storage.V20220901.Inputs.CorsRuleArgs
    ///                 {
    ///                     AllowedHeaders = new[]
    ///                     {
    ///                         "x-ms-meta-abc",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20220901:TableServiceProperties")]
    public partial class TableServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public TableServiceProperties(string name, TableServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:TableServiceProperties", name, args ?? new TableServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:TableServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
