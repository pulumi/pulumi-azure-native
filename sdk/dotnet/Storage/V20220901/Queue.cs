...
namespace Pulumi.AzureNative.Storage.V20220901
{
    ...
    /// {
    ///     var queue = new AzureNative.Storage.V20220901.Queue("queue", new()
    ///     {
    ///         AccountName = "sto328",
    ///         QueueName = "queue6185",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20220901:Queue")]
    public partial class Queue : global::Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
