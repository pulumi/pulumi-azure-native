...
namespace Pulumi.AzureNative.Storage.V20220901
{
    ...
    /// {
    ///     var table = new AzureNative.Storage.V20220901.Table("table", new()
    ///     {
    ///         AccountName = "sto328",
    ...
    ///         {
    ///             new AzureNative.Storage.V20220901.Inputs.TableSignedIdentifierArgs
    ///             {
    ///                 AccessPolicy = new AzureNative.Storage.V20220901.Inputs.TableAccessPolicyArgs
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:storage/v20220901:Table table6185 /subscriptions/{subscription-id}/resourceGroups/res3376/providers/Microsoft.Storage/storageAccounts/sto328/tableServices/default/tables/table6185 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20220901:Table")]
    public partial class Table : global::Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220901:Table", name, null, MakeResourceOptions(options, id))
        {
        }
