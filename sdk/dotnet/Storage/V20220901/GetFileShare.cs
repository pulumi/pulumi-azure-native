...
namespace Pulumi.AzureNative.Storage.V20220901
{
    public static class GetFileShare
    {
        ...
        public static Task<GetFileShareResult> InvokeAsync(GetFileShareArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFileShareResult>("azure-native:storage/v20220901:getFileShare", args ?? new GetFileShareArgs(), options.WithDefaults());
