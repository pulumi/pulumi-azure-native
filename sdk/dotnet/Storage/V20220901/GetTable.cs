...
namespace Pulumi.AzureNative.Storage.V20220901
{
    public static class GetTable
    {
        ...
        public static Task<GetTableResult> InvokeAsync(GetTableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTableResult>("azure-native:storage/v20220901:getTable", args ?? new GetTableArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the table with the specified table name, under the specified account if it exists.
        /// </summary>
        public static Output<GetTableResult> Invoke(GetTableInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTableResult>("azure-native:storage/v20220901:getTable", args ?? new GetTableInvokeArgs(), options.WithDefaults());
