...
namespace Pulumi.AzureRM.Storage.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var blobContainer = new AzureRM.Storage.V20190601.BlobContainer("blobContainer", new AzureRM.Storage.V20190601.BlobContainerArgs
    ///         {
    ///             AccountName = "sto328",
    ...
    public partial class BlobContainer : Pulumi.CustomResource
    {
        ...
        public BlobContainer(string name, BlobContainerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20190601:BlobContainer", name, args ?? new BlobContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20190601:BlobContainer", name, null, MakeResourceOptions(options, id))
        {
        }
