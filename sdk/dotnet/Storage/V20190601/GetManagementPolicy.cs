...
namespace Pulumi.AzureRM.Storage.V20190601
{
    public static class GetManagementPolicy
    {
        public static Task<GetManagementPolicyResult> InvokeAsync(GetManagementPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementPolicyResult>("azurerm:storage/v20190601:getManagementPolicy", args ?? new GetManagementPolicyArgs(), options.WithVersion());
    }
