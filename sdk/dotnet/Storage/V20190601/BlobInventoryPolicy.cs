...
namespace Pulumi.AzureNative.Storage.V20190601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20190601:BlobInventoryPolicy")]
    public partial class BlobInventoryPolicy : Pulumi.CustomResource
    {
        ...
        public BlobInventoryPolicy(string name, BlobInventoryPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190601:BlobInventoryPolicy", name, args ?? new BlobInventoryPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobInventoryPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190601:BlobInventoryPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
