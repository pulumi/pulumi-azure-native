...
namespace Pulumi.AzureNative.Storage.V20190601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20190601:TableServiceProperties")]
    public partial class TableServiceProperties : Pulumi.CustomResource
    {
        ...
        public TableServiceProperties(string name, TableServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190601:TableServiceProperties", name, args ?? new TableServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190601:TableServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:storage/v20210201:TableServiceProperties"},
                    new Pulumi.Alias { Type = "azure-native:storage/v20210401:TableServiceProperties"},
                    new Pulumi.Alias { Type = "azure-nextgen:storage/v20210401:TableServiceProperties"},
                    new Pulumi.Alias { Type = "azure-native:storage/v20210601:TableServiceProperties"},
                    new Pulumi.Alias { Type = "azure-nextgen:storage/v20210601:TableServiceProperties"},
                },
            };
