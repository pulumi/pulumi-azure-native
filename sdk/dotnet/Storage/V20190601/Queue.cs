...
namespace Pulumi.AzureRM.Storage.V20190601
{
    public partial class Queue : Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20190601:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20190601:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
