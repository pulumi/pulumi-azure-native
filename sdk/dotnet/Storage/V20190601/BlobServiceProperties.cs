...
namespace Pulumi.AzureNative.Storage.V20190601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20190601:BlobServiceProperties")]
    public partial class BlobServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public BlobServiceProperties(string name, BlobServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190601:BlobServiceProperties", name, args ?? new BlobServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20190601:BlobServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
