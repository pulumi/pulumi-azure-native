...
azure-native:storage/v20190601:FileShare is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileShare to guarantee forwards compatibility.")]
    public static class GetFileShare
    {
        ...
        public static Task<GetFileShareResult> InvokeAsync(GetFileShareArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFileShareResult>("azure-native:storage/v20190601:getFileShare", args ?? new GetFileShareArgs(), options.WithDefaults());

        /// <summary>
        /// Gets properties of a specified share.
        /// </summary>
        public static Output<GetFileShareResult> Invoke(GetFileShareInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFileShareResult>("azure-native:storage/v20190601:getFileShare", args ?? new GetFileShareInvokeArgs(), options.WithDefaults());
    }
