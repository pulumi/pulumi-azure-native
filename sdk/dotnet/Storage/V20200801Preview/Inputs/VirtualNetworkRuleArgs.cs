...
namespace Pulumi.AzureNative.Storage.V20200801Preview.Inputs
{
    ...
    public sealed class VirtualNetworkRuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public Input<Pulumi.AzureNative.Storage.V20200801Preview.Action>? Action { get; set; }

        /// <summary>
        /// Gets the state of virtual network rule.
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.Storage.V20200801Preview.State>? State { get; set; }
        ...
        {
            Action = Pulumi.AzureNative.Storage.V20200801Preview.Action.Allow;
        }
    }
}
