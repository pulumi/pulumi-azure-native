...
namespace Pulumi.AzureRM.Storage.V20200801Preview
{
    ...
    public partial class FileShare : Pulumi.CustomResource
    {
        ...
        public FileShare(string name, FileShareArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20200801preview:FileShare", name, args ?? new FileShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileShare(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20200801preview:FileShare", name, null, MakeResourceOptions(options, id))
        {
        }
