...
azure-native:storage/v20200801preview:FileServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:FileServiceProperties to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20200801preview:FileServiceProperties")]
    public partial class FileServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public FileServiceProperties(string name, FileServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:FileServiceProperties", name, args ?? new FileServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:FileServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
