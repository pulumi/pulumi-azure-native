...
namespace Pulumi.AzureNative.Storage.V20200801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20200801preview:BlobInventoryPolicy")]
    public partial class BlobInventoryPolicy : Pulumi.CustomResource
    {
        ...
        public BlobInventoryPolicy(string name, BlobInventoryPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:BlobInventoryPolicy", name, args ?? new BlobInventoryPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobInventoryPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:BlobInventoryPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:storage/v20210401:BlobInventoryPolicy"},
                    new Pulumi.Alias { Type = "azure-native:storage/v20210601:BlobInventoryPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:storage/v20210601:BlobInventoryPolicy"},
                },
            };
