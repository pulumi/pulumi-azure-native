...
namespace Pulumi.AzureRM.Storage.V20200801Preview
{
    ...
    public partial class ManagementPolicy : Pulumi.CustomResource
    {
        ...
        public ManagementPolicy(string name, ManagementPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20200801preview:ManagementPolicy", name, args ?? new ManagementPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20200801preview:ManagementPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
