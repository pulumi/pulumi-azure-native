...
namespace Pulumi.AzureRM.Storage.V20200801Preview
{
    public static class ListStorageAccountKeys
    {
        public static Task<ListStorageAccountKeysResult> InvokeAsync(ListStorageAccountKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountKeysResult>("azurerm:storage/v20200801preview:listStorageAccountKeys", args ?? new ListStorageAccountKeysArgs(), options.WithVersion());
    }
