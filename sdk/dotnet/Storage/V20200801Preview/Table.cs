...
namespace Pulumi.AzureNative.Storage.V20200801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20200801preview:Table")]
    public partial class Table : Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:Table", name, null, MakeResourceOptions(options, id))
        {
        }
