...
namespace Pulumi.AzureNextGen.Storage.V20200801Preview
{
    public static class GetBlobServiceProperties
    {
        public static Task<GetBlobServicePropertiesResult> InvokeAsync(GetBlobServicePropertiesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlobServicePropertiesResult>("azure-nextgen:storage/v20200801preview:getBlobServiceProperties", args ?? new GetBlobServicePropertiesArgs(), options.WithVersion());
    }
    ...
    public sealed class GetBlobServicePropertiesResult
    {
        ...
        /// </summary>
        public readonly Outputs.LastAccessTimeTrackingPolicyInvokeResponseResult? LastAccessTimeTrackingPolicy;
        /// <summary>
        ...
        private GetBlobServicePropertiesResult(
            ...
            Outputs.LastAccessTimeTrackingPolicyInvokeResponseResult? lastAccessTimeTrackingPolicy,
