...
namespace Pulumi.AzureRM.Storage.V20200801Preview
{
    ...
    public partial class BlobContainerImmutabilityPolicy : Pulumi.CustomResource
    {
        ...
        public BlobContainerImmutabilityPolicy(string name, BlobContainerImmutabilityPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20200801preview:BlobContainerImmutabilityPolicy", name, args ?? new BlobContainerImmutabilityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerImmutabilityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20200801preview:BlobContainerImmutabilityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
