...
namespace Pulumi.AzureNative.Storage.V20200801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20200801preview:BlobContainer")]
    public partial class BlobContainer : Pulumi.CustomResource
    {
        ...
        public BlobContainer(string name, BlobContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:BlobContainer", name, args ?? new BlobContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:BlobContainer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BlobContainerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("publicAccess")]
        public Input<Pulumi.AzureNative.Storage.V20200801Preview.PublicAccess>? PublicAccess { get; set; }
