...
azure-native:storage/v20200801preview:QueueServiceProperties is being removed in the next major version of this provider. Please upgrade to azure-native:storage/v20220901:QueueServiceProperties to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20200801preview:QueueServiceProperties")]
    public partial class QueueServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public QueueServiceProperties(string name, QueueServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:QueueServiceProperties", name, args ?? new QueueServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:QueueServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
