...
namespace Pulumi.AzureNative.Storage.V20200801Preview
{
    ...
    [AzureNativeResourceType("azure-native:storage/v20200801preview:Queue")]
    public partial class Queue : global::Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20200801preview:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
