...
namespace Pulumi.AzureNative.Storage.V20210201
{
    ...
    /// {
    ///     var blobContainer = new AzureNative.Storage.V20210201.BlobContainer("blobContainer", new()
    ///     {
    ///         AccountName = "sto328",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20210201:BlobContainer")]
    public partial class BlobContainer : global::Pulumi.CustomResource
    {
        ...
        public BlobContainer(string name, BlobContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210201:BlobContainer", name, args ?? new BlobContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210201:BlobContainer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BlobContainerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("publicAccess")]
        public Input<Pulumi.AzureNative.Storage.V20210201.PublicAccess>? PublicAccess { get; set; }
