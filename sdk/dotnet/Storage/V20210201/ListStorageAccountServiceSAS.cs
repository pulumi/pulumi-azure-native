...
namespace Pulumi.AzureNative.Storage.V20210201
{
    public static class ListStorageAccountServiceSAS
    {
        ...
        public static Task<ListStorageAccountServiceSASResult> InvokeAsync(ListStorageAccountServiceSASArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountServiceSASResult>("azure-native:storage/v20210201:listStorageAccountServiceSAS", args ?? new ListStorageAccountServiceSASArgs(), options.WithDefaults());
        ...
        public static Output<ListStorageAccountServiceSASResult> Invoke(ListStorageAccountServiceSASInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListStorageAccountServiceSASResult>("azure-native:storage/v20210201:listStorageAccountServiceSAS", args ?? new ListStorageAccountServiceSASInvokeArgs(), options.WithDefaults());
    }


    public sealed class ListStorageAccountServiceSASArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("permissions")]
        public Union<string, Pulumi.AzureNative.Storage.V20210201.Permissions>? Permissions { get; set; }

        /// <summary>
        /// The protocol permitted for a request made with the account SAS.
        /// </summary>
        [Input("protocols")]
        public Pulumi.AzureNative.Storage.V20210201.HttpProtocol? Protocols { get; set; }

        /// <summary>
        /// The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s).
        /// </summary>
        [Input("resource")]
        public Union<string, Pulumi.AzureNative.Storage.V20210201.SignedResource>? Resource { get; set; }
        ...
        public static new ListStorageAccountServiceSASArgs Empty => new ListStorageAccountServiceSASArgs();
    }

    public sealed class ListStorageAccountServiceSASInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only.
        /// </summary>
        ...
        /// </summary>
        [Input("permissions")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210201.Permissions>? Permissions { get; set; }

        /// <summary>
        /// The protocol permitted for a request made with the account SAS.
        /// </summary>
        [Input("protocols")]
        public Input<Pulumi.AzureNative.Storage.V20210201.HttpProtocol>? Protocols { get; set; }

        /// <summary>
        /// The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s).
        /// </summary>
        [Input("resource")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210201.SignedResource>? Resource { get; set; }
        ...
        public static new ListStorageAccountServiceSASInvokeArgs Empty => new ListStorageAccountServiceSASInvokeArgs();
    }
