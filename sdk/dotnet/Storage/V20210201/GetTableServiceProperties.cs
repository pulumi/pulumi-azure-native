...
namespace Pulumi.AzureNative.Storage.V20210201
{
    public static class GetTableServiceProperties
    {
        ...
        public static Task<GetTableServicePropertiesResult> InvokeAsync(GetTableServicePropertiesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTableServicePropertiesResult>("azure-native:storage/v20210201:getTableServiceProperties", args ?? new GetTableServicePropertiesArgs(), options.WithDefaults());
        ...
        public static Output<GetTableServicePropertiesResult> Invoke(GetTableServicePropertiesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTableServicePropertiesResult>("azure-native:storage/v20210201:getTableServiceProperties", args ?? new GetTableServicePropertiesInvokeArgs(), options.WithDefaults());
    }
