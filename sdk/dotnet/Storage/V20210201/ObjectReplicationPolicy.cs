...
namespace Pulumi.AzureNative.Storage.V20210201
{
    ...
    /// {
    ///     var objectReplicationPolicy = new AzureNative.Storage.V20210201.ObjectReplicationPolicy("objectReplicationPolicy", new()
    ///     {
    ///         AccountName = "dst112",
    ...
    ///         Rules = new[]
    ///         {
    ///             new AzureNative.Storage.V20210201.Inputs.ObjectReplicationPolicyRuleArgs
    ///             {
    ///                 DestinationContainer = "dcont139",
    ///                 Filters = new AzureNative.Storage.V20210201.Inputs.ObjectReplicationPolicyFilterArgs
    ///                 {
    ///                     PrefixMatch = new[]
    ///                     {
    ///                         "blobA",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storage/v20210201:ObjectReplicationPolicy")]
    public partial class ObjectReplicationPolicy : global::Pulumi.CustomResource
    {
        ...
        public ObjectReplicationPolicy(string name, ObjectReplicationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210201:ObjectReplicationPolicy", name, args ?? new ObjectReplicationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ObjectReplicationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210201:ObjectReplicationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
