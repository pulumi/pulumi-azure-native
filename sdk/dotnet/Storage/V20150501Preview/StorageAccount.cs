...
namespace Pulumi.AzureRM.Storage.V20150501Preview
{
    ...
    public partial class StorageAccount : Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20150501preview:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20150501preview:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
