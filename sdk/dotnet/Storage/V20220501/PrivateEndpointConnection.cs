...
namespace Pulumi.AzureNative.Storage.V20220501
{
    ...
    [AzureNativeResourceType("azure-native:storage/v20220501:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220501:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220501:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
