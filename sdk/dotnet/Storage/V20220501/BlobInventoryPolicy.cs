...
namespace Pulumi.AzureNative.Storage.V20220501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storage/v20220501:BlobInventoryPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobInventoryPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20220501:BlobInventoryPolicy")]
    public partial class BlobInventoryPolicy : global::Pulumi.CustomResource
    {
        ...
        public BlobInventoryPolicy(string name, BlobInventoryPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220501:BlobInventoryPolicy", name, args ?? new BlobInventoryPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobInventoryPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220501:BlobInventoryPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
