...
namespace Pulumi.AzureNative.Storage.V20220501.Inputs
{
    ...
    public sealed class VirtualNetworkRuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public Input<Pulumi.AzureNative.Storage.V20220501.Action>? Action { get; set; }

        /// <summary>
        /// Gets the state of virtual network rule.
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20220501.State>? State { get; set; }
        ...
        {
            Action = Pulumi.AzureNative.Storage.V20220501.Action.Allow;
        }
    }
}
