...
namespace Pulumi.AzureNative.Storage.V20220501.Inputs
{
    ...
    public sealed class CorsRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Storage.V20220501.AllowedMethods>>? _allowedMethods;

        /// <summary>
        /// Required if CorsRule element is present. A list of HTTP methods that are allowed to be executed by the origin.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Storage.V20220501.AllowedMethods>> AllowedMethods
        {
            get => _allowedMethods ?? (_allowedMethods = new InputList<Union<string, Pulumi.AzureNative.Storage.V20220501.AllowedMethods>>());
