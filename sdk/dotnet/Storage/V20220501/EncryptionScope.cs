...
namespace Pulumi.AzureNative.Storage.V20220501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storage/v20220501:EncryptionScope is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:EncryptionScope to guarantee forwards compatibility.")]
    ...
    public partial class EncryptionScope : global::Pulumi.CustomResource
    {
        ...
        public EncryptionScope(string name, EncryptionScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220501:EncryptionScope", name, args ?? new EncryptionScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EncryptionScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220501:EncryptionScope", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EncryptionScopeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("source")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20220501.EncryptionScopeSource>? Source { get; set; }

        /// <summary>
        /// The state of the encryption scope. Possible values (case-insensitive):  Enabled, Disabled.
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20220501.EncryptionScopeState>? State { get; set; }
