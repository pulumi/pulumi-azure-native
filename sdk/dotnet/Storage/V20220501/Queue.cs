...
{
    [Obsolete(@"azure-native:storage/v20220501:Queue is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:Queue to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20220501:Queue")]
    public partial class Queue : global::Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220501:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20220501:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
