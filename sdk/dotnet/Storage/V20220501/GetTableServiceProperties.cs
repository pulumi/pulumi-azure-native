...
namespace Pulumi.AzureNative.Storage.V20220501
{
    public static class GetTableServiceProperties
    {
        ...
        public static Task<GetTableServicePropertiesResult> InvokeAsync(GetTableServicePropertiesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTableServicePropertiesResult>("azure-native:storage/v20220501:getTableServiceProperties", args ?? new GetTableServicePropertiesArgs(), options.WithDefaults());
        ...
        public static Output<GetTableServicePropertiesResult> Invoke(GetTableServicePropertiesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTableServicePropertiesResult>("azure-native:storage/v20220501:getTableServiceProperties", args ?? new GetTableServicePropertiesInvokeArgs(), options.WithDefaults());
    }
