...
namespace Pulumi.AzureRM.Storage
{
    ...
    public partial class StorageAccountManagementPolicy : Pulumi.CustomResource
    {
        ...
        private StorageAccountManagementPolicy(string name, Input<string> id, StorageAccountManagementPolicyState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:storage:StorageAccountManagementPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static StorageAccountManagementPolicy Get(string name, Input<string> id, StorageAccountManagementPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new StorageAccountManagementPolicy(name, id, state, options);
        }
    }
    ...
    public sealed class StorageAccountManagementPolicyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the resource
        /// </summary>
        ...
        public Input<Inputs.ManagementPolicyPropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public StorageAccountManagementPolicyState()
        {
        }
    }
}
