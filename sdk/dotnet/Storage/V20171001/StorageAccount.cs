...
namespace Pulumi.AzureRM.Storage.V20171001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var storageAccount = new AzureRM.Storage.V20171001.StorageAccount("storageAccount", new AzureRM.Storage.V20171001.StorageAccountArgs
    ///         {
    ///             AccountName = "sto4445",
    ///             Kind = "Storage",
    ///             Location = "eastus2euap",
    ///             ResourceGroupName = "res9101",
    ///             Sku = new AzureRM.Storage.V20171001.Inputs.SkuArgs
    ///             {
    ///                 Name = "Standard_GRS",
    ///             },
    ///             Tags = 
    ...
    public partial class StorageAccount : Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20171001:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20171001:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
