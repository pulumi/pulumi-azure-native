...
namespace Pulumi.AzureNextGen.Storage.V20180701
{
    ...
    public partial class StorageAccount : Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20180701:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20180701:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessTier")]
        public Input<Pulumi.AzureNextGen.Storage.V20180701.AccessTier>? AccessTier { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Storage.V20180701.Kind> Kind { get; set; } = null!;
