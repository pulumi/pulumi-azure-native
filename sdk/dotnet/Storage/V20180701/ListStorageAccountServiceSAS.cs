...
namespace Pulumi.AzureNextGen.Storage.V20180701
{
    public static class ListStorageAccountServiceSAS
    {
        ...
        public static Task<ListStorageAccountServiceSASResult> InvokeAsync(ListStorageAccountServiceSASArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountServiceSASResult>("azure-nextgen:storage/v20180701:listStorageAccountServiceSAS", args ?? new ListStorageAccountServiceSASArgs(), options.WithVersion());
    }
    ...
    public sealed class ListStorageAccountServiceSASArgs : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public Union<string, Pulumi.AzureNextGen.Storage.V20180701.Permissions>? Permissions { get; set; }
        ...
        /// </summary>
        [Input("resource")]
        public Union<string, Pulumi.AzureNextGen.Storage.V20180701.SignedResource>? Resource { get; set; }
