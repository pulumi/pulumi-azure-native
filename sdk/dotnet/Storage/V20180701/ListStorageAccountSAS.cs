...
namespace Pulumi.AzureNative.Storage.V20180701
{
    public static class ListStorageAccountSAS
    {
        ...
        public static Task<ListStorageAccountSASResult> InvokeAsync(ListStorageAccountSASArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountSASResult>("azure-native:storage/v20180701:listStorageAccountSAS", args ?? new ListStorageAccountSASArgs(), options.WithDefaults());

        /// <summary>
        /// The List SAS credentials operation response.
        /// </summary>
        public static Output<ListStorageAccountSASResult> Invoke(ListStorageAccountSASInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListStorageAccountSASResult>("azure-native:storage/v20180701:listStorageAccountSAS", args ?? new ListStorageAccountSASInvokeArgs(), options.WithDefaults());
    }
