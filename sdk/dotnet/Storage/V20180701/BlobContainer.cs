...
namespace Pulumi.AzureRM.Storage.V20180701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var blobContainer = new AzureRM.Storage.V20180701.BlobContainer("blobContainer", new AzureRM.Storage.V20180701.BlobContainerArgs
    ///         {
    ///             AccountName = "sto328",
    ...
    public partial class BlobContainer : Pulumi.CustomResource
    {
        ...
        public BlobContainer(string name, BlobContainerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20180701:BlobContainer", name, args ?? new BlobContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20180701:BlobContainer", name, null, MakeResourceOptions(options, id))
        {
        }
