...
namespace Pulumi.AzureNextGen.Storage.V20180701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storage/v20180701:BlobServiceProperties")]
    public partial class BlobServiceProperties : Pulumi.CustomResource
    {
        ...
        public BlobServiceProperties(string name, BlobServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20180701:BlobServiceProperties", name, args ?? new BlobServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20180701:BlobServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
