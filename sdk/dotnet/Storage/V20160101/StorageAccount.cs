...
namespace Pulumi.AzureRM.Storage.V20160101
{
    /// <summary>
    /// The storage account.
    /// </summary>
    public partial class StorageAccount : Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20160101:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storage/v20160101:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
