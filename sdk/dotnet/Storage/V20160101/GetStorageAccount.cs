...
namespace Pulumi.AzureNative.Storage.V20160101
{
    public static class GetStorageAccount
    {
        ...
        public static Task<GetStorageAccountResult> InvokeAsync(GetStorageAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageAccountResult>("azure-native:storage/v20160101:getStorageAccount", args ?? new GetStorageAccountArgs(), options.WithVersion());

        /// <summary>
        /// The storage account.
        /// </summary>
        public static Output<GetStorageAccountResult> Invoke(GetStorageAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStorageAccountResult>("azure-native:storage/v20160101:getStorageAccount", args ?? new GetStorageAccountInvokeArgs(), options.WithVersion());
    }
