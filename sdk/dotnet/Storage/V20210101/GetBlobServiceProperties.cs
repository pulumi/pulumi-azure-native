...
namespace Pulumi.AzureNative.Storage.V20210101
{
    public static class GetBlobServiceProperties
    {
        ...
        public static Task<GetBlobServicePropertiesResult> InvokeAsync(GetBlobServicePropertiesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlobServicePropertiesResult>("azure-native:storage/v20210101:getBlobServiceProperties", args ?? new GetBlobServicePropertiesArgs(), options.WithDefaults());
        ...
        public static Output<GetBlobServicePropertiesResult> Invoke(GetBlobServicePropertiesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBlobServicePropertiesResult>("azure-native:storage/v20210101:getBlobServiceProperties", args ?? new GetBlobServicePropertiesInvokeArgs(), options.WithDefaults());
    }
