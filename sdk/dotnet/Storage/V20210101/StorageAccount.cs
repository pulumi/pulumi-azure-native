...
namespace Pulumi.AzureNative.Storage.V20210101
{
    ...
    /// The storage account.
    /// </summary>
    [Obsolete(@"azure-native:storage/v20210101:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:StorageAccount to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20210101:StorageAccount")]
    public partial class StorageAccount : global::Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210101:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210101:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessTier")]
        public Input<Pulumi.AzureNative.Storage.V20210101.AccessTier>? AccessTier { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210101.Kind> Kind { get; set; } = null!;

        /// <summary>
        /// Allow large file shares if sets to Enabled. It cannot be disabled once it is enabled.
        /// </summary>
        [Input("largeFileSharesState")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210101.LargeFileSharesState>? LargeFileSharesState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Storage.V20210101.MinimumTlsVersion>? MinimumTlsVersion { get; set; }
