...
namespace Pulumi.AzureNextGen.Storage.V20210101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storage/v20210101:Table")]
    public partial class Table : Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20210101:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20210101:Table", name, null, MakeResourceOptions(options, id))
        {
        }
