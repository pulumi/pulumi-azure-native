...
namespace Pulumi.AzureNextGen.Storage.V20210101
{
    public static class ListStorageAccountServiceSAS
    {
        ...
        public static Task<ListStorageAccountServiceSASResult> InvokeAsync(ListStorageAccountServiceSASArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountServiceSASResult>("azure-nextgen:storage/v20210101:listStorageAccountServiceSAS", args ?? new ListStorageAccountServiceSASArgs(), options.WithVersion());
    }
    ...
    public sealed class ListStorageAccountServiceSASArgs : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public Union<string, Pulumi.AzureNextGen.Storage.V20210101.Permissions>? Permissions { get; set; }

        /// <summary>
        /// The protocol permitted for a request made with the account SAS.
        /// </summary>
        [Input("protocols")]
        public Pulumi.AzureNextGen.Storage.V20210101.HttpProtocol? Protocols { get; set; }

        /// <summary>
        /// The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s).
        /// </summary>
        [Input("resource")]
        public Union<string, Pulumi.AzureNextGen.Storage.V20210101.SignedResource>? Resource { get; set; }
