...
namespace Pulumi.AzureNative.Storage.V20210101
{
    public static class GetBlobContainer
    {
        ...
        public static Task<GetBlobContainerResult> InvokeAsync(GetBlobContainerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlobContainerResult>("azure-native:storage/v20210101:getBlobContainer", args ?? new GetBlobContainerArgs(), options.WithDefaults());

        /// <summary>
        /// Properties of the blob container, including Id, resource name, resource type, Etag.
        /// </summary>
        public static Output<GetBlobContainerResult> Invoke(GetBlobContainerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBlobContainerResult>("azure-native:storage/v20210101:getBlobContainer", args ?? new GetBlobContainerInvokeArgs(), options.WithDefaults());
    }
