...
{
    [Obsolete(@"azure-native:storage/v20210101:ManagementPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:ManagementPolicy to guarantee forwards compatibility.")]
    public static class GetManagementPolicy
    {
        ...
        public static Task<GetManagementPolicyResult> InvokeAsync(GetManagementPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagementPolicyResult>("azure-native:storage/v20210101:getManagementPolicy", args ?? new GetManagementPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the managementpolicy associated with the specified storage account.
        /// </summary>
        public static Output<GetManagementPolicyResult> Invoke(GetManagementPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagementPolicyResult>("azure-native:storage/v20210101:getManagementPolicy", args ?? new GetManagementPolicyInvokeArgs(), options.WithDefaults());
    }
