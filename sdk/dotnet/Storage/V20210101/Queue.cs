...
{
    [AzureNextGenResourceType("azure-nextgen:storage/v20210101:Queue")]
    public partial class Queue : Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20210101:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20210101:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
