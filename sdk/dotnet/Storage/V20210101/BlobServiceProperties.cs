...
namespace Pulumi.AzureNative.Storage.V20210101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storage/v20210101:BlobServiceProperties is being removed in the next major version of this provider. Upgrade to at least azure-native:storage/v20220901:BlobServiceProperties to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storage/v20210101:BlobServiceProperties")]
    public partial class BlobServiceProperties : global::Pulumi.CustomResource
    {
        ...
        public BlobServiceProperties(string name, BlobServicePropertiesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210101:BlobServiceProperties", name, args ?? new BlobServicePropertiesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlobServiceProperties(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20210101:BlobServiceProperties", name, null, MakeResourceOptions(options, id))
        {
        }
