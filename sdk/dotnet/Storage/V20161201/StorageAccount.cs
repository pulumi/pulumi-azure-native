...
namespace Pulumi.AzureNative.Storage.V20161201
{
    ...
    /// The storage account.
    /// </summary>
    [Obsolete(@"Version v20161201 will be removed in the next major version of the provider. Upgrade to version v20210201 or later.")]
    [AzureNativeResourceType("azure-native:storage/v20161201:StorageAccount")]
    public partial class StorageAccount : Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20161201:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storage/v20161201:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessTier")]
        public Input<Pulumi.AzureNative.Storage.V20161201.AccessTier>? AccessTier { get; set; }
        ...
        public Input<Pulumi.AzureNative.Storage.V20161201.Kind> Kind { get; set; } = null!;
