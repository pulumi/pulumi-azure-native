...
namespace Pulumi.AzureNextGen.Storage.V20161201
{
    ...
    /// The storage account.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storage/v20161201:StorageAccount")]
    ...
    public sealed class StorageAccountArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessTier")]
        public Input<Pulumi.AzureNextGen.Storage.V20161201.AccessTier>? AccessTier { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Storage.V20161201.Kind> Kind { get; set; } = null!;
