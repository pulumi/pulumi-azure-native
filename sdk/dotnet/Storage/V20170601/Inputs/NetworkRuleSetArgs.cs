...
namespace Pulumi.AzureNative.Storage.V20170601.Inputs
{
    ...
    public sealed class NetworkRuleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bypass")]
        public InputUnion<string, Pulumi.AzureNative.Storage.V20170601.Bypass>? Bypass { get; set; }

        /// <summary>
        /// Specifies the default action of allow or deny when no other rules match.
        /// </summary>
        [Input("defaultAction", required: true)]
        public Input<Pulumi.AzureNative.Storage.V20170601.DefaultAction> DefaultAction { get; set; } = null!;
        ...
        public NetworkRuleSetArgs()
        {
            ...
            DefaultAction = Pulumi.AzureNative.Storage.V20170601.DefaultAction.Allow;
        }
