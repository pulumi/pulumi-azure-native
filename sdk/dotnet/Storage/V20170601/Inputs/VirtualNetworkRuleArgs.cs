...
namespace Pulumi.AzureNative.Storage.V20170601.Inputs
{
    ...
    public sealed class VirtualNetworkRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public Input<Pulumi.AzureNative.Storage.V20170601.Action>? Action { get; set; }

        /// <summary>
        /// Gets the state of virtual network rule.
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.Storage.V20170601.State>? State { get; set; }
        ...
        {
            Action = Pulumi.AzureNative.Storage.V20170601.Action.Allow;
        }
