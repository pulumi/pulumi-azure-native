...
namespace Pulumi.AzureNextGen.Storage.V20170601
{
    ...
    /// The storage account.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storage/v20170601:StorageAccount")]
    public partial class StorageAccount : Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20170601:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storage/v20170601:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessTier")]
        public Input<Pulumi.AzureNextGen.Storage.V20170601.AccessTier>? AccessTier { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Storage.V20170601.Kind> Kind { get; set; } = null!;
