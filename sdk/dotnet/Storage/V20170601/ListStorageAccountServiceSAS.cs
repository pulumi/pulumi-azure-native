...
namespace Pulumi.AzureNextGen.Storage.V20170601
{
    public static class ListStorageAccountServiceSAS
    {
        public static Task<ListStorageAccountServiceSASResult> InvokeAsync(ListStorageAccountServiceSASArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStorageAccountServiceSASResult>("azure-nextgen:storage/v20170601:listStorageAccountServiceSAS", args ?? new ListStorageAccountServiceSASArgs(), options.WithVersion());
    }
    ...
    public sealed class ListStorageAccountServiceSASArgs : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("permissions")]
        public Union<string, Pulumi.AzureNextGen.Storage.V20170601.Permissions>? Permissions { get; set; }
        ...
        public Union<string, Pulumi.AzureNextGen.Storage.V20170601.SignedResource> Resource { get; set; } = null!;
