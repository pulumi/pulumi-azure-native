...
namespace Pulumi.AzureNative.EdgeOrder
{
    ...
    public partial class OrderItemByName : Pulumi.CustomResource
    {
        ...
        public OrderItemByName(string name, OrderItemByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder:OrderItemByName", name, args ?? new OrderItemByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrderItemByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder:OrderItemByName", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:edgeorder:OrderItemByName"},
                    new Pulumi.Alias { Type = "azure-native:edgeorder/v20201201preview:OrderItemByName"},
                    new Pulumi.Alias { Type = "azure-nextgen:edgeorder/v20201201preview:OrderItemByName"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrderItemByName Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
