...
namespace Pulumi.AzureNative.EdgeOrder.V20240201.Inputs
{
    ...
    public sealed class ChildConfigurationFilterArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.EdgeOrder.V20240201.ChildConfigurationType>>? _childConfigurationTypes;

        /// <summary>
        /// Filter to fetch all child configurations belonging to the given list of configuration types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.EdgeOrder.V20240201.ChildConfigurationType>> ChildConfigurationTypes
        {
            get => _childConfigurationTypes ?? (_childConfigurationTypes = new InputList<Union<string, Pulumi.AzureNative.EdgeOrder.V20240201.ChildConfigurationType>>());
