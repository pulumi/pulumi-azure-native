...
namespace Pulumi.AzureNative.EdgeOrder.V20240201
{
    public static class GetAddress
    {
        ...
        public static Task<GetAddressResult> InvokeAsync(GetAddressArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAddressResult>("azure-native:edgeorder/v20240201:getAddress", args ?? new GetAddressArgs(), options.WithDefaults());
