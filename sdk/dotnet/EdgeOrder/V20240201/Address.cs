...
namespace Pulumi.AzureNative.EdgeOrder.V20240201
{
    ...
    /// Address Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:edgeorder/v20240201:Address")]
    public partial class Address : global::Pulumi.CustomResource
    {
        ...
        public Address(string name, AddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20240201:Address", name, args ?? new AddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Address(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20240201:Address", name, null, MakeResourceOptions(options, id))
        {
        }
