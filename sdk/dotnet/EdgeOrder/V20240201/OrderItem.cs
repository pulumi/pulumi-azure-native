...
namespace Pulumi.AzureNative.EdgeOrder.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:edgeorder/v20240201:OrderItem")]
    public partial class OrderItem : global::Pulumi.CustomResource
    {
        ...
        public OrderItem(string name, OrderItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20240201:OrderItem", name, args ?? new OrderItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrderItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20240201:OrderItem", name, null, MakeResourceOptions(options, id))
        {
        }
