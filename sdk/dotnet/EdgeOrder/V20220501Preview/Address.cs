...
namespace Pulumi.AzureNative.EdgeOrder.V20220501Preview
{
    ...
    /// {
    ///     var address = new AzureNative.EdgeOrder.V20220501Preview.Address("address", new()
    ///     {
    ///         AddressName = "TestAddressName2",
    ///         ContactDetails = new AzureNative.EdgeOrder.V20220501Preview.Inputs.ContactDetailsArgs
    ///         {
    ...
    ///         ShippingAddress = new AzureNative.EdgeOrder.V20220501Preview.Inputs.ShippingAddressArgs
    ///         {
    ///             AddressType = "None",
    ///             City = "San Francisco",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:edgeorder/v20220501preview:Address")]
    public partial class Address : global::Pulumi.CustomResource
    {
        ...
        public Address(string name, AddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20220501preview:Address", name, args ?? new AddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Address(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20220501preview:Address", name, null, MakeResourceOptions(options, id))
        {
        }
