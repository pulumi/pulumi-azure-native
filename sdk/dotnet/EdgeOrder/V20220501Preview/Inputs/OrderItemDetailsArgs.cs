...
namespace Pulumi.AzureNative.EdgeOrder.V20220501Preview.Inputs
{
    ...
    public sealed class OrderItemDetailsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("orderItemMode")]
        public InputUnion<string, Pulumi.AzureNative.EdgeOrder.V20220501Preview.OrderMode>? OrderItemMode { get; set; }

        /// <summary>
        /// Order item type.
        /// </summary>
        [Input("orderItemType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.EdgeOrder.V20220501Preview.OrderItemType> OrderItemType { get; set; } = null!;
