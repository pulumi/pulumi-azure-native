...
namespace Pulumi.AzureNative.EdgeOrder.V20211201
{
    public static class GetOrderItemByName
    {
        ...
        public static Task<GetOrderItemByNameResult> InvokeAsync(GetOrderItemByNameArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOrderItemByNameResult>("azure-native:edgeorder/v20211201:getOrderItemByName", args ?? new GetOrderItemByNameArgs(), options.WithVersion());

        /// <summary>
        /// Represents order item contract
        /// </summary>
        public static Output<GetOrderItemByNameResult> Invoke(GetOrderItemByNameInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOrderItemByNameResult>("azure-native:edgeorder/v20211201:getOrderItemByName", args ?? new GetOrderItemByNameInvokeArgs(), options.WithVersion());
    }
