...
namespace Pulumi.AzureNative.EdgeOrder.V20211201
{
    ...
    public partial class AddressByName : global::Pulumi.CustomResource
    {
        ...
        public AddressByName(string name, AddressByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20211201:AddressByName", name, args ?? new AddressByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AddressByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20211201:AddressByName", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:edgeorder:Address" },
