...
namespace Pulumi.AzureNative.EdgeOrder.V20211201
{
    ...
    public partial class OrderItemByName : Pulumi.CustomResource
    {
        ...
        public OrderItemByName(string name, OrderItemByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20211201:OrderItemByName", name, args ?? new OrderItemByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrderItemByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20211201:OrderItemByName", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:edgeorder:OrderItemByName"},
                },
            };
