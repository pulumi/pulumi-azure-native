...
namespace Pulumi.AzureNative.EdgeOrder.V20201201Preview
{
    public static class ListProductFamilies
    {
        ...
        public static Task<ListProductFamiliesResult> InvokeAsync(ListProductFamiliesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListProductFamiliesResult>("azure-native:edgeorder/v20201201preview:listProductFamilies", args ?? new ListProductFamiliesArgs(), options.WithDefaults());

        /// <summary>
        /// The list of product families.
        /// </summary>
        public static Output<ListProductFamiliesResult> Invoke(ListProductFamiliesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListProductFamiliesResult>("azure-native:edgeorder/v20201201preview:listProductFamilies", args ?? new ListProductFamiliesInvokeArgs(), options.WithDefaults());
    }
