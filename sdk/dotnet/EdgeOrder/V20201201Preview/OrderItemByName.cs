...
namespace Pulumi.AzureNative.EdgeOrder.V20201201Preview
{
    ...
    public partial class OrderItemByName : Pulumi.CustomResource
    {
        ...
        public OrderItemByName(string name, OrderItemByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20201201preview:OrderItemByName", name, args ?? new OrderItemByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrderItemByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edgeorder/v20201201preview:OrderItemByName", name, null, MakeResourceOptions(options, id))
        {
        }
