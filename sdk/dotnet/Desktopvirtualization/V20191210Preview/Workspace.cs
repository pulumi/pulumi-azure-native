...
namespace Pulumi.AzureRM.DesktopVirtualization.V20191210Preview
{
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20191210preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/v20191210preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
