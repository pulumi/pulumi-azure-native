...
namespace Pulumi.AzureRM.DesktopVirtualization.V20190123Preview
{
    public static class GetApplication
    {
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("azurerm:desktopvirtualization/v20190123preview:getApplication", args ?? new GetApplicationArgs(), options.WithVersion());
    }
