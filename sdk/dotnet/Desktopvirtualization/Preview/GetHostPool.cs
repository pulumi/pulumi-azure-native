...
namespace Pulumi.AzureRM.DesktopVirtualization.Preview
{
    public static class GetHostPool
    {
        public static Task<GetHostPoolResult> InvokeAsync(GetHostPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHostPoolResult>("azurerm:desktopvirtualization/preview:getHostPool", args ?? new GetHostPoolArgs(), options.WithVersion());
    }
