...
namespace Pulumi.AzureRM.DesktopVirtualization.Preview
{
    ...
    public partial class ApplicationGroup : Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:desktopvirtualization/preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
