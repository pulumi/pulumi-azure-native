...
namespace Pulumi.AzureNative.Migrate
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate:AssessmentProjectsSqlAssessmentV2Operation")]
    public partial class AssessmentProjectsSqlAssessmentV2Operation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsSqlAssessmentV2Operation(string name, AssessmentProjectsSqlAssessmentV2OperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate:AssessmentProjectsSqlAssessmentV2Operation", name, args ?? new AssessmentProjectsSqlAssessmentV2OperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsSqlAssessmentV2Operation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate:AssessmentProjectsSqlAssessmentV2Operation", name, null, MakeResourceOptions(options, id))
        {
        }
