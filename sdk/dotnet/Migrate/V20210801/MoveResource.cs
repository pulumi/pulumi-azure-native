...
namespace Pulumi.AzureNative.Migrate.V20210801
{
    ...
    [AzureNativeResourceType("azure-native:migrate/v20210801:MoveResource")]
    public partial class MoveResource : global::Pulumi.CustomResource
    {
        ...
        public MoveResource(string name, MoveResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20210801:MoveResource", name, args ?? new MoveResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20210801:MoveResource", name, null, MakeResourceOptions(options, id))
        {
        }
