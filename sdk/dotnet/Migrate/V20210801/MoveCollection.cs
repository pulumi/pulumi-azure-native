...
namespace Pulumi.AzureNative.Migrate.V20210801
{
    /// <summary>
    /// Define the move collection.
    /// </summary>
    [Obsolete(@"azure-native:migrate/v20210801:MoveCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:migrate/v20220801:MoveCollection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:migrate/v20210801:MoveCollection")]
    public partial class MoveCollection : global::Pulumi.CustomResource
    {
        ...
        public MoveCollection(string name, MoveCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20210801:MoveCollection", name, args ?? new MoveCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20210801:MoveCollection", name, null, MakeResourceOptions(options, id))
        {
        }
