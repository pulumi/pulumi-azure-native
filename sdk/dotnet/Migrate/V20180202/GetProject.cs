...
namespace Pulumi.AzureNative.Migrate.V20180202
{
    public static class GetProject
    {
        ...
        public static Task<GetProjectResult> InvokeAsync(GetProjectArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectResult>("azure-native:migrate/v20180202:getProject", args ?? new GetProjectArgs(), options.WithDefaults());

        /// <summary>
        /// Get the project with the specified name.
        /// </summary>
        public static Output<GetProjectResult> Invoke(GetProjectInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProjectResult>("azure-native:migrate/v20180202:getProject", args ?? new GetProjectInvokeArgs(), options.WithDefaults());
    }
