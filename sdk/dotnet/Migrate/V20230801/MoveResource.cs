...
namespace Pulumi.AzureNative.Migrate.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230801:MoveResource")]
    public partial class MoveResource : global::Pulumi.CustomResource
    {
        ...
        public MoveResource(string name, MoveResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230801:MoveResource", name, args ?? new MoveResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230801:MoveResource", name, null, MakeResourceOptions(options, id))
        {
        }
