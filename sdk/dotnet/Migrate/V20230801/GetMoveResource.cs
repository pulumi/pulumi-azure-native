...
namespace Pulumi.AzureNative.Migrate.V20230801
{
    public static class GetMoveResource
    {
        ...
        public static Task<GetMoveResourceResult> InvokeAsync(GetMoveResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMoveResourceResult>("azure-native:migrate/v20230801:getMoveResource", args ?? new GetMoveResourceArgs(), options.WithDefaults());
