...
namespace Pulumi.AzureNative.Migrate.V20230801
{
    public static class GetMoveCollection
    {
        ...
        public static Task<GetMoveCollectionResult> InvokeAsync(GetMoveCollectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMoveCollectionResult>("azure-native:migrate/v20230801:getMoveCollection", args ?? new GetMoveCollectionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the move collection.
        /// </summary>
        public static Output<GetMoveCollectionResult> Invoke(GetMoveCollectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMoveCollectionResult>("azure-native:migrate/v20230801:getMoveCollection", args ?? new GetMoveCollectionInvokeArgs(), options.WithDefaults());
    }
