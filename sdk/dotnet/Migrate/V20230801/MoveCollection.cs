...
namespace Pulumi.AzureNative.Migrate.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230801:MoveCollection")]
    public partial class MoveCollection : global::Pulumi.CustomResource
    {
        ...
        public MoveCollection(string name, MoveCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230801:MoveCollection", name, args ?? new MoveCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230801:MoveCollection", name, null, MakeResourceOptions(options, id))
        {
        }
