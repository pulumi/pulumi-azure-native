...
namespace Pulumi.AzureNative.Migrate.V20230401Preview
{
    public static class GetWebAppCollectorOperation
    {
        ...
        public static Task<GetWebAppCollectorOperationResult> InvokeAsync(GetWebAppCollectorOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppCollectorOperationResult>("azure-native:migrate/v20230401preview:getWebAppCollectorOperation", args ?? new GetWebAppCollectorOperationArgs(), options.WithDefaults());
        ...
        public static Output<GetWebAppCollectorOperationResult> Invoke(GetWebAppCollectorOperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebAppCollectorOperationResult>("azure-native:migrate/v20230401preview:getWebAppCollectorOperation", args ?? new GetWebAppCollectorOperationInvokeArgs(), options.WithDefaults());
