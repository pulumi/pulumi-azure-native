...
namespace Pulumi.AzureNative.Migrate.V20230401Preview
{
    public static class GetAssessmentsOperation
    {
        ...
        public static Task<GetAssessmentsOperationResult> InvokeAsync(GetAssessmentsOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentsOperationResult>("azure-native:migrate/v20230401preview:getAssessmentsOperation", args ?? new GetAssessmentsOperationArgs(), options.WithDefaults());
