...
namespace Pulumi.AzureNative.Migrate.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230401preview:AssessmentsOperation")]
    public partial class AssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentsOperation(string name, AssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:AssessmentsOperation", name, args ?? new AssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:AssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
