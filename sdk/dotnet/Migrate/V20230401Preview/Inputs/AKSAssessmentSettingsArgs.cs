...
namespace Pulumi.AzureNative.Migrate.V20230401Preview.Inputs
{
    ...
    public sealed class AKSAssessmentSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.AzureVmCategory> Category { get; set; } = null!;

        /// <summary>
        /// Gets or sets consolidation type.
        /// </summary>
        [Input("consolidation", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.ConsolidationType> Consolidation { get; set; } = null!;

        /// <summary>
        /// Gets or sets currency.
        /// </summary>
        [Input("currency", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.AzureCurrency> Currency { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.AzureEnvironmentType> EnvironmentType { get; set; } = null!;

        /// <summary>
        /// Gets or sets licensing program.
        /// </summary>
        [Input("licensingProgram", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.LicensingProgram> LicensingProgram { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.PricingTier> PricingTier { get; set; } = null!;

        /// <summary>
        /// Gets or sets savings options.
        /// </summary>
        [Input("savingsOptions", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.SavingsOptions> SavingsOptions { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.AssessmentSizingCriterion> SizingCriteria { get; set; } = null!;
