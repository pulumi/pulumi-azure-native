...
namespace Pulumi.AzureNative.Migrate.V20230401Preview.Inputs
{
    ...
    public sealed class PerfDataSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.Percentile> Percentile { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230401Preview.TimeRange> TimeRange { get; set; } = null!;
