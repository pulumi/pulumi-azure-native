...
namespace Pulumi.AzureNative.Migrate.V20230401Preview
{
    public static class GetAssessmentProjectsWebAppAssessmentV2Operation
    {
        ...
        public static Task<GetAssessmentProjectsWebAppAssessmentV2OperationResult> InvokeAsync(GetAssessmentProjectsWebAppAssessmentV2OperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentProjectsWebAppAssessmentV2OperationResult>("azure-native:migrate/v20230401preview:getAssessmentProjectsWebAppAssessmentV2Operation", args ?? new GetAssessmentProjectsWebAppAssessmentV2OperationArgs(), options.WithDefaults());
        ...
        public static Output<GetAssessmentProjectsWebAppAssessmentV2OperationResult> Invoke(GetAssessmentProjectsWebAppAssessmentV2OperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentProjectsWebAppAssessmentV2OperationResult>("azure-native:migrate/v20230401preview:getAssessmentProjectsWebAppAssessmentV2Operation", args ?? new GetAssessmentProjectsWebAppAssessmentV2OperationInvokeArgs(), options.WithDefaults());
