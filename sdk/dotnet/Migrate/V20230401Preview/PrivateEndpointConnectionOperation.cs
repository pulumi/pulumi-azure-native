...
namespace Pulumi.AzureNative.Migrate.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230401preview:PrivateEndpointConnectionOperation")]
    public partial class PrivateEndpointConnectionOperation : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionOperation(string name, PrivateEndpointConnectionOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:PrivateEndpointConnectionOperation", name, args ?? new PrivateEndpointConnectionOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:PrivateEndpointConnectionOperation", name, null, MakeResourceOptions(options, id))
        {
        }
