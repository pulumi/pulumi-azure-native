...
namespace Pulumi.AzureNative.Migrate.V20230401Preview
{
    public static class GetAvsAssessmentsOperation
    {
        ...
        public static Task<GetAvsAssessmentsOperationResult> InvokeAsync(GetAvsAssessmentsOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAvsAssessmentsOperationResult>("azure-native:migrate/v20230401preview:getAvsAssessmentsOperation", args ?? new GetAvsAssessmentsOperationArgs(), options.WithDefaults());
