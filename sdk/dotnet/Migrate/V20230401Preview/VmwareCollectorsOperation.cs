...
namespace Pulumi.AzureNative.Migrate.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230401preview:VmwareCollectorsOperation")]
    public partial class VmwareCollectorsOperation : global::Pulumi.CustomResource
    {
        ...
        public VmwareCollectorsOperation(string name, VmwareCollectorsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:VmwareCollectorsOperation", name, args ?? new VmwareCollectorsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VmwareCollectorsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:VmwareCollectorsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
