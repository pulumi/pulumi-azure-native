...
namespace Pulumi.AzureNative.Migrate.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230401preview:WebAppAssessmentV2Operation")]
    public partial class WebAppAssessmentV2Operation : global::Pulumi.CustomResource
    {
        ...
        public WebAppAssessmentV2Operation(string name, WebAppAssessmentV2OperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:WebAppAssessmentV2Operation", name, args ?? new WebAppAssessmentV2OperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAssessmentV2Operation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:WebAppAssessmentV2Operation", name, null, MakeResourceOptions(options, id))
        {
        }
