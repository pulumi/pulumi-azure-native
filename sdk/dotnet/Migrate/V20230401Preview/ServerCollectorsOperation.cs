...
namespace Pulumi.AzureNative.Migrate.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230401preview:ServerCollectorsOperation")]
    public partial class ServerCollectorsOperation : global::Pulumi.CustomResource
    {
        ...
        public ServerCollectorsOperation(string name, ServerCollectorsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:ServerCollectorsOperation", name, args ?? new ServerCollectorsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerCollectorsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230401preview:ServerCollectorsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
