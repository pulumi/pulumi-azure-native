...
namespace Pulumi.AzureNative.Migrate.V20230315
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230315:SqlAssessmentV2Operation")]
    public partial class SqlAssessmentV2Operation : global::Pulumi.CustomResource
    {
        ...
        public SqlAssessmentV2Operation(string name, SqlAssessmentV2OperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230315:SqlAssessmentV2Operation", name, args ?? new SqlAssessmentV2OperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlAssessmentV2Operation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230315:SqlAssessmentV2Operation", name, null, MakeResourceOptions(options, id))
        {
        }
