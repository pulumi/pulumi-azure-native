...
namespace Pulumi.AzureNative.Migrate.V20230315
{
    public static class GetAssessmentProjectsAvsAssessmentsOperation
    {
        ...
        public static Task<GetAssessmentProjectsAvsAssessmentsOperationResult> InvokeAsync(GetAssessmentProjectsAvsAssessmentsOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentProjectsAvsAssessmentsOperationResult>("azure-native:migrate/v20230315:getAssessmentProjectsAvsAssessmentsOperation", args ?? new GetAssessmentProjectsAvsAssessmentsOperationArgs(), options.WithDefaults());
        ...
        public static Output<GetAssessmentProjectsAvsAssessmentsOperationResult> Invoke(GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentProjectsAvsAssessmentsOperationResult>("azure-native:migrate/v20230315:getAssessmentProjectsAvsAssessmentsOperation", args ?? new GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs(), options.WithDefaults());
