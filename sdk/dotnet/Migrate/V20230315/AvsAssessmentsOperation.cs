...
namespace Pulumi.AzureNative.Migrate.V20230315
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230315:AvsAssessmentsOperation")]
    public partial class AvsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AvsAssessmentsOperation(string name, AvsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230315:AvsAssessmentsOperation", name, args ?? new AvsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230315:AvsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
