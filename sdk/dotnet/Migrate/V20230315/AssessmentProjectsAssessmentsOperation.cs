...
namespace Pulumi.AzureNative.Migrate.V20230315
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230315:AssessmentProjectsAssessmentsOperation")]
    public partial class AssessmentProjectsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsAssessmentsOperation(string name, AssessmentProjectsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230315:AssessmentProjectsAssessmentsOperation", name, args ?? new AssessmentProjectsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230315:AssessmentProjectsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
