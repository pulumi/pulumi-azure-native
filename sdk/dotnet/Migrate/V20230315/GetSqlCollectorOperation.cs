...
namespace Pulumi.AzureNative.Migrate.V20230315
{
    public static class GetSqlCollectorOperation
    {
        ...
        public static Task<GetSqlCollectorOperationResult> InvokeAsync(GetSqlCollectorOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlCollectorOperationResult>("azure-native:migrate/v20230315:getSqlCollectorOperation", args ?? new GetSqlCollectorOperationArgs(), options.WithDefaults());
