...
namespace Pulumi.AzureNative.Migrate.V20230101
{
    public static class GetSolutionsControllerSolution
    {
        ...
        public static Task<GetSolutionsControllerSolutionResult> InvokeAsync(GetSolutionsControllerSolutionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSolutionsControllerSolutionResult>("azure-native:migrate/v20230101:getSolutionsControllerSolution", args ?? new GetSolutionsControllerSolutionArgs(), options.WithDefaults());
