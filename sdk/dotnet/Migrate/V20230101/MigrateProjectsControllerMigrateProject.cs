...
namespace Pulumi.AzureNative.Migrate.V20230101
{
    ...
    /// Migrate project.
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230101:MigrateProjectsControllerMigrateProject")]
    public partial class MigrateProjectsControllerMigrateProject : global::Pulumi.CustomResource
    {
        ...
        public MigrateProjectsControllerMigrateProject(string name, MigrateProjectsControllerMigrateProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230101:MigrateProjectsControllerMigrateProject", name, args ?? new MigrateProjectsControllerMigrateProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MigrateProjectsControllerMigrateProject(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230101:MigrateProjectsControllerMigrateProject", name, null, MakeResourceOptions(options, id))
        {
        }
