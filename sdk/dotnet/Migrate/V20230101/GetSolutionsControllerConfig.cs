...
namespace Pulumi.AzureNative.Migrate.V20230101
{
    public static class GetSolutionsControllerConfig
    {
        ...
        public static Task<GetSolutionsControllerConfigResult> InvokeAsync(GetSolutionsControllerConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSolutionsControllerConfigResult>("azure-native:migrate/v20230101:getSolutionsControllerConfig", args ?? new GetSolutionsControllerConfigArgs(), options.WithDefaults());
