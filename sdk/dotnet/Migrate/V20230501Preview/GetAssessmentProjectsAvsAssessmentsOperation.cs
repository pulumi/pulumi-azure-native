...
{
    public static class GetAssessmentProjectsAvsAssessmentsOperation
    {
        /// <summary>
        /// Get a AvsAssessment
        /// </summary>
        public static Task<GetAssessmentProjectsAvsAssessmentsOperationResult> InvokeAsync(GetAssessmentProjectsAvsAssessmentsOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentProjectsAvsAssessmentsOperationResult>("azure-native:migrate/v20230501preview:getAssessmentProjectsAvsAssessmentsOperation", args ?? new GetAssessmentProjectsAvsAssessmentsOperationArgs(), options.WithDefaults());

        /// <summary>
        /// Get a AvsAssessment
        /// </summary>
        public static Output<GetAssessmentProjectsAvsAssessmentsOperationResult> Invoke(GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentProjectsAvsAssessmentsOperationResult>("azure-native:migrate/v20230501preview:getAssessmentProjectsAvsAssessmentsOperation", args ?? new GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs(), options.WithDefaults());

        /// <summary>
        /// Get a AvsAssessment
        /// </summary>
        public static Output<GetAssessmentProjectsAvsAssessmentsOperationResult> Invoke(GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentProjectsAvsAssessmentsOperationResult>("azure-native:migrate/v20230501preview:getAssessmentProjectsAvsAssessmentsOperation", args ?? new GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetAssessmentProjectsAvsAssessmentsOperationArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetAssessmentProjectsAvsAssessmentsOperationArgs()
        {
        }
        public static new GetAssessmentProjectsAvsAssessmentsOperationArgs Empty => new GetAssessmentProjectsAvsAssessmentsOperationArgs();
    }

    public sealed class GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// AVS Assessment ARM name
        /// </summary>
        ...
        public GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs()
        {
        }
        public static new GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs Empty => new GetAssessmentProjectsAvsAssessmentsOperationInvokeArgs();
    }


    [OutputType]
    public sealed class GetAssessmentProjectsAvsAssessmentsOperationResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAssessmentProjectsAvsAssessmentsOperationResult(
