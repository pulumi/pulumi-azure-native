...
namespace Pulumi.AzureNative.Migrate.V20230501Preview
{
    public static class GetGroupsOperation
    {
        ...
        public static Task<GetGroupsOperationResult> InvokeAsync(GetGroupsOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupsOperationResult>("azure-native:migrate/v20230501preview:getGroupsOperation", args ?? new GetGroupsOperationArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Group
        /// </summary>
        public static Output<GetGroupsOperationResult> Invoke(GetGroupsOperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGroupsOperationResult>("azure-native:migrate/v20230501preview:getGroupsOperation", args ?? new GetGroupsOperationInvokeArgs(), options.WithDefaults());
    }
