...
namespace Pulumi.AzureNative.Migrate.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230501preview:AssessmentProjectsAssessmentsOperation")]
    public partial class AssessmentProjectsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsAssessmentsOperation(string name, AssessmentProjectsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230501preview:AssessmentProjectsAssessmentsOperation", name, args ?? new AssessmentProjectsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230501preview:AssessmentProjectsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:migrate:AssessmentProjectsAssessmentsOperation" },
    ...
    public sealed class AssessmentProjectsAssessmentsOperationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureDiskType>>? _azureDiskTypes;

        /// <summary>
        /// Gets or sets the azure storage type. Premium, Standard etc.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureDiskType>> AzureDiskTypes
        {
            get => _azureDiskTypes ?? (_azureDiskTypes = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureDiskType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureHybridUseBenefit>? AzureHybridUseBenefit { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureOfferCode>? AzureOfferCode { get; set; }

        /// <summary>
        /// Gets or sets Azure Pricing Tier - Free, Basic, etc.
        /// </summary>
        [Input("azurePricingTier")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzurePricingTier>? AzurePricingTier { get; set; }

        /// <summary>
        /// Gets or sets the Azure Storage Redundancy. Example: Locally Redundant Storage.
        /// </summary>
        [Input("azureStorageRedundancy")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureStorageRedundancy>? AzureStorageRedundancy { get; set; }

        [Input("azureVmFamilies")]
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureVmFamily>>? _azureVmFamilies;

        /// <summary>
        /// Gets or sets the Azure VM families.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureVmFamily>> AzureVmFamilies
        {
            get => _azureVmFamilies ?? (_azureVmFamilies = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureVmFamily>>());
        ...
        /// </summary>
        [Input("currency")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureCurrency>? Currency { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureHybridUseBenefit>? LinuxAzureHybridUseBenefit { get; set; }
        ...
        /// </summary>
        [Input("percentile")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.Percentile>? Percentile { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureReservedInstance>? ReservedInstance { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AssessmentSizingCriterion>? SizingCriterion { get; set; }
        ...
        /// </summary>
        [Input("timeRange")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.TimeRange>? TimeRange { get; set; }
