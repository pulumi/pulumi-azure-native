...
namespace Pulumi.AzureNative.Migrate.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230501preview:AssessmentProjectsAvsAssessmentsOperation")]
    public partial class AssessmentProjectsAvsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsAvsAssessmentsOperation(string name, AssessmentProjectsAvsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230501preview:AssessmentProjectsAvsAssessmentsOperation", name, args ?? new AssessmentProjectsAvsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsAvsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230501preview:AssessmentProjectsAvsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
