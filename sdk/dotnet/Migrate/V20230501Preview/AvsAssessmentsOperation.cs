...
namespace Pulumi.AzureNative.Migrate.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230501preview:AvsAssessmentsOperation")]
    public partial class AvsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AvsAssessmentsOperation(string name, AvsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230501preview:AvsAssessmentsOperation", name, args ?? new AvsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230501preview:AvsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AvsAssessmentsOperationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AvsAssessmentScenario>? AvsAssessmentScenario { get; set; }

        /// <summary>
        /// Azure Location or Azure region where to which the machines will be migrated.
        /// </summary>
        [Input("azureLocation")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureLocation>? AzureLocation { get; set; }
        ...
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.ExternalStorageType>>? _externalStorageTypes;

        /// <summary>
        /// List of AVS external storage types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.ExternalStorageType>> ExternalStorageTypes
        {
            get => _externalStorageTypes ?? (_externalStorageTypes = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.ExternalStorageType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.FttAndRaidLevel>? FailuresToTolerateAndRaidLevel { get; set; }

        [Input("failuresToTolerateAndRaidLevelList")]
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.FttAndRaidLevel>>? _failuresToTolerateAndRaidLevelList;

        /// <summary>
        /// List of Failures to tolerate and RAID levels in a common property.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.FttAndRaidLevel>> FailuresToTolerateAndRaidLevelList
        {
            get => _failuresToTolerateAndRaidLevelList ?? (_failuresToTolerateAndRaidLevelList = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.FttAndRaidLevel>>());
        ...
        /// </summary>
        [Input("nodeType")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureAvsNodeType>? NodeType { get; set; }

        [Input("nodeTypes")]
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureAvsNodeType>>? _nodeTypes;

        /// <summary>
        /// AVS node types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureAvsNodeType>> NodeTypes
        {
            get => _nodeTypes ?? (_nodeTypes = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20230501Preview.AzureAvsNodeType>>());
