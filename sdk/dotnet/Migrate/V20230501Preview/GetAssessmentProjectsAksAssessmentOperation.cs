...
namespace Pulumi.AzureNative.Migrate.V20230501Preview
{
    public static class GetAssessmentProjectsAksAssessmentOperation
    {
        ...
        public static Task<GetAssessmentProjectsAksAssessmentOperationResult> InvokeAsync(GetAssessmentProjectsAksAssessmentOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentProjectsAksAssessmentOperationResult>("azure-native:migrate/v20230501preview:getAssessmentProjectsAksAssessmentOperation", args ?? new GetAssessmentProjectsAksAssessmentOperationArgs(), options.WithDefaults());
        ...
        public static Output<GetAssessmentProjectsAksAssessmentOperationResult> Invoke(GetAssessmentProjectsAksAssessmentOperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentProjectsAksAssessmentOperationResult>("azure-native:migrate/v20230501preview:getAssessmentProjectsAksAssessmentOperation", args ?? new GetAssessmentProjectsAksAssessmentOperationInvokeArgs(), options.WithDefaults());
