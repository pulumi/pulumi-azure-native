...
namespace Pulumi.AzureNative.Migrate.V20230501Preview
{
    public static class GetWebAppAssessmentV2Operation
    {
        ...
        public static Task<GetWebAppAssessmentV2OperationResult> InvokeAsync(GetWebAppAssessmentV2OperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppAssessmentV2OperationResult>("azure-native:migrate/v20230501preview:getWebAppAssessmentV2Operation", args ?? new GetWebAppAssessmentV2OperationArgs(), options.WithDefaults());
