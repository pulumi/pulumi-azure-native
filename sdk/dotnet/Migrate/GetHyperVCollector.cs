...
namespace Pulumi.AzureRM.Migrate
{
    public static class GetHyperVCollector
    {
        public static Task<GetHyperVCollectorResult> InvokeAsync(GetHyperVCollectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHyperVCollectorResult>("azurerm:migrate:getHyperVCollector", args ?? new GetHyperVCollectorArgs(), options.WithVersion());
    }
