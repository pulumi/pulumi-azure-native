...
namespace Pulumi.AzureNative.Migrate.V20171111Preview
{
    ...
    public static class GetAssessment
    {
        ...
        public static Task<GetAssessmentResult> InvokeAsync(GetAssessmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentResult>("azure-native:migrate/v20171111preview:getAssessment", args ?? new GetAssessmentArgs(), options.WithDefaults());

        /// <summary>
        /// An assessment created for a group in the Migration project.
        /// </summary>
        public static Output<GetAssessmentResult> Invoke(GetAssessmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentResult>("azure-native:migrate/v20171111preview:getAssessment", args ?? new GetAssessmentInvokeArgs(), options.WithDefaults());
    }
