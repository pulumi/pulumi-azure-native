...
namespace Pulumi.AzureRM.Migrate.V20171111Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var assessment = new AzureRM.Migrate.V20171111Preview.Assessment("assessment", new AzureRM.Migrate.V20171111Preview.AssessmentArgs
    ///         {
    ...
    public partial class Assessment : Pulumi.CustomResource
    {
        ...
        public Assessment(string name, AssessmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:migrate/v20171111preview:Assessment", name, args ?? new AssessmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Assessment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:migrate/v20171111preview:Assessment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:migrate/v20180202:Assessment"},
                },
            };
