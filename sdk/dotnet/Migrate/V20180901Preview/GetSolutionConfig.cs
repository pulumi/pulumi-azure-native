...
namespace Pulumi.AzureNative.Migrate.V20180901Preview
{
    public static class GetSolutionConfig
    {
        ...
        public static Output<GetSolutionConfigResult> Invoke(GetSolutionConfigInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSolutionConfigResult>("azure-native:migrate/v20180901preview:getSolutionConfig", args ?? new GetSolutionConfigInvokeArgs(), options.WithVersion());
    }
