...
namespace Pulumi.AzureNative.Migrate
{
    ...
    public partial class AvsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AvsAssessmentsOperation(string name, AvsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate:AvsAssessmentsOperation", name, args ?? new AvsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate:AvsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_migrate_v20230315:migrate:AvsAssessmentsOperation" },
                    new global::Pulumi.Alias { Type = "azure-native_migrate_v20230401preview:migrate:AvsAssessmentsOperation" },
                    new global::Pulumi.Alias { Type = "azure-native_migrate_v20230501preview:migrate:AvsAssessmentsOperation" },
                    new global::Pulumi.Alias { Type = "azure-native_migrate_v20230909preview:migrate:AvsAssessmentsOperation" },
                    new global::Pulumi.Alias { Type = "azure-native_migrate_v20240101preview:migrate:AvsAssessmentsOperation" },
                },
            };
