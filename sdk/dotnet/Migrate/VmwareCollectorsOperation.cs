...
namespace Pulumi.AzureNative.Migrate
{
    ...
    public partial class VmwareCollectorsOperation : global::Pulumi.CustomResource
    {
        ...
        public VmwareCollectorsOperation(string name, VmwareCollectorsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate:VmwareCollectorsOperation", name, args ?? new VmwareCollectorsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VmwareCollectorsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate:VmwareCollectorsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:migrate/v20240115:VmwareCollectorsOperation" },
                    new global::Pulumi.Alias { Type = "azure-native:migrate/v20240303preview:VmwareCollectorsOperation" },
