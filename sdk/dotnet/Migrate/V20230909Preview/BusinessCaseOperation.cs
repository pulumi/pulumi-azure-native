...
namespace Pulumi.AzureNative.Migrate.V20230909Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230909preview:BusinessCaseOperation")]
    public partial class BusinessCaseOperation : global::Pulumi.CustomResource
    {
        ...
        public BusinessCaseOperation(string name, BusinessCaseOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:BusinessCaseOperation", name, args ?? new BusinessCaseOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BusinessCaseOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:BusinessCaseOperation", name, null, MakeResourceOptions(options, id))
        {
        }
