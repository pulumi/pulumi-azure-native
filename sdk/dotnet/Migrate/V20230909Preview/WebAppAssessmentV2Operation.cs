...
namespace Pulumi.AzureNative.Migrate.V20230909Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230909preview:WebAppAssessmentV2Operation")]
    public partial class WebAppAssessmentV2Operation : global::Pulumi.CustomResource
    {
        ...
        public WebAppAssessmentV2Operation(string name, WebAppAssessmentV2OperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:WebAppAssessmentV2Operation", name, args ?? new WebAppAssessmentV2OperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAssessmentV2Operation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:WebAppAssessmentV2Operation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppAssessmentV2OperationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230909Preview.AssessmentType>? AssessmentType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureSecurityOfferingType>? AzureSecurityOfferingType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230909Preview.EnvironmentType>? EnvironmentType { get; set; }
