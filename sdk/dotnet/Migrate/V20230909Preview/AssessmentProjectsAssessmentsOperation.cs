...
namespace Pulumi.AzureNative.Migrate.V20230909Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230909preview:AssessmentProjectsAssessmentsOperation")]
    public partial class AssessmentProjectsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsAssessmentsOperation(string name, AssessmentProjectsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:AssessmentProjectsAssessmentsOperation", name, args ?? new AssessmentProjectsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:AssessmentProjectsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
