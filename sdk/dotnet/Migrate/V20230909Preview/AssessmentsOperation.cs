...
namespace Pulumi.AzureNative.Migrate.V20230909Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230909preview:AssessmentsOperation")]
    public partial class AssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentsOperation(string name, AssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:AssessmentsOperation", name, args ?? new AssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:AssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AssessmentsOperationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureDiskType>>? _azureDiskTypes;

        /// <summary>
        /// Gets or sets the azure storage type. Premium, Standard etc.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureDiskType>> AzureDiskTypes
        {
            get => _azureDiskTypes ?? (_azureDiskTypes = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureDiskType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureHybridUseBenefit>? AzureHybridUseBenefit { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzurePricingTier>? AzurePricingTier { get; set; }

        /// <summary>
        /// Gets or sets the Azure Storage Redundancy. Example: Locally Redundant Storage.
        /// </summary>
        [Input("azureStorageRedundancy")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureStorageRedundancy>? AzureStorageRedundancy { get; set; }

        [Input("azureVmFamilies")]
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureVmFamily>>? _azureVmFamilies;

        /// <summary>
        /// Gets or sets the Azure VM families.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureVmFamily>> AzureVmFamilies
        {
            get => _azureVmFamilies ?? (_azureVmFamilies = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureVmFamily>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureHybridUseBenefit>? LinuxAzureHybridUseBenefit { get; set; }
