...
namespace Pulumi.AzureNative.Migrate.V20230909Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20230909preview:AssessmentProjectsAvsAssessmentsOperation")]
    public partial class AssessmentProjectsAvsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsAvsAssessmentsOperation(string name, AssessmentProjectsAvsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:AssessmentProjectsAvsAssessmentsOperation", name, args ?? new AssessmentProjectsAvsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsAvsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20230909preview:AssessmentProjectsAvsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
