...
namespace Pulumi.AzureNative.Migrate.V20230909Preview.Inputs
{
    ...
    public sealed class SqlVmSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureVmFamily>>? _instanceSeries;

        /// <summary>
        /// Gets or sets the Azure VM families (calling instance series to keep it
        /// consistent with other targets).
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureVmFamily>> InstanceSeries
        {
            get => _instanceSeries ?? (_instanceSeries = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20230909Preview.AzureVmFamily>>());
