...
namespace Pulumi.AzureNative.Migrate
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate:AssessmentProjectsWebAppAssessmentV2Operation")]
    public partial class AssessmentProjectsWebAppAssessmentV2Operation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsWebAppAssessmentV2Operation(string name, AssessmentProjectsWebAppAssessmentV2OperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate:AssessmentProjectsWebAppAssessmentV2Operation", name, args ?? new AssessmentProjectsWebAppAssessmentV2OperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsWebAppAssessmentV2Operation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate:AssessmentProjectsWebAppAssessmentV2Operation", name, null, MakeResourceOptions(options, id))
        {
        }
