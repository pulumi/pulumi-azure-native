...
namespace Pulumi.AzureNative.Migrate
{
    ...
    public partial class AssessmentProjectsAvsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsAvsAssessmentsOperation(string name, AssessmentProjectsAvsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate:AssessmentProjectsAvsAssessmentsOperation", name, args ?? new AssessmentProjectsAvsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsAvsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate:AssessmentProjectsAvsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AssessmentProjectsAvsAssessmentsOperationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("azureLocation")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.AzureLocation>? AzureLocation { get; set; }
