...
namespace Pulumi.AzureRM.Migrate.Preview
{
    ...
    public partial class Project : Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azurerm:migrate/preview:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:migrate/preview:Project", name, null, MakeResourceOptions(options, id))
        {
        }
