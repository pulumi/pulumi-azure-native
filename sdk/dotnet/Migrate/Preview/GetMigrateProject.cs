...
namespace Pulumi.AzureRM.Migrate.Preview
{
    public static class GetMigrateProject
    {
        public static Task<GetMigrateProjectResult> InvokeAsync(GetMigrateProjectArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMigrateProjectResult>("azurerm:migrate/preview:getMigrateProject", args ?? new GetMigrateProjectArgs(), options.WithVersion());
    }
