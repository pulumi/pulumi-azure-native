...
namespace Pulumi.AzureRM.Migrate.Preview
{
    public static class GetVMwareCollector
    {
        public static Task<GetVMwareCollectorResult> InvokeAsync(GetVMwareCollectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVMwareCollectorResult>("azurerm:migrate/preview:getVMwareCollector", args ?? new GetVMwareCollectorArgs(), options.WithVersion());
    }
