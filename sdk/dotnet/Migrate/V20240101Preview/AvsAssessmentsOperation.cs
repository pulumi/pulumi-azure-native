...
namespace Pulumi.AzureNative.Migrate.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20240101preview:AvsAssessmentsOperation")]
    public partial class AvsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AvsAssessmentsOperation(string name, AvsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AvsAssessmentsOperation", name, args ?? new AvsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AvsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
