...
namespace Pulumi.AzureNative.Migrate.V20240101Preview
{
    public static class GetAssessmentsOperation
    {
        ...
        public static Task<GetAssessmentsOperationResult> InvokeAsync(GetAssessmentsOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentsOperationResult>("azure-native:migrate/v20240101preview:getAssessmentsOperation", args ?? new GetAssessmentsOperationArgs(), options.WithDefaults());
        ...
        public static Output<GetAssessmentsOperationResult> Invoke(GetAssessmentsOperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentsOperationResult>("azure-native:migrate/v20240101preview:getAssessmentsOperation", args ?? new GetAssessmentsOperationInvokeArgs(), options.WithDefaults());
