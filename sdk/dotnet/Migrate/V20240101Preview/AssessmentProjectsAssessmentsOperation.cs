...
namespace Pulumi.AzureNative.Migrate.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20240101preview:AssessmentProjectsAssessmentsOperation")]
    public partial class AssessmentProjectsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsAssessmentsOperation(string name, AssessmentProjectsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AssessmentProjectsAssessmentsOperation", name, args ?? new AssessmentProjectsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AssessmentProjectsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AssessmentProjectsAssessmentsOperationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureDiskType>>? _azureDiskTypes;

        /// <summary>
        /// Gets or sets the azure storage type. Premium, Standard etc.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureDiskType>> AzureDiskTypes
        {
            get => _azureDiskTypes ?? (_azureDiskTypes = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureDiskType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureHybridUseBenefit>? AzureHybridUseBenefit { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzurePricingTier>? AzurePricingTier { get; set; }

        /// <summary>
        /// Gets or sets the Azure Storage Redundancy. Example: Locally Redundant Storage.
        /// </summary>
        [Input("azureStorageRedundancy")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureStorageRedundancy>? AzureStorageRedundancy { get; set; }

        [Input("azureVmFamilies")]
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureVmFamily>>? _azureVmFamilies;

        /// <summary>
        /// Gets or sets the Azure VM families.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureVmFamily>> AzureVmFamilies
        {
            get => _azureVmFamilies ?? (_azureVmFamilies = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureVmFamily>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureHybridUseBenefit>? LinuxAzureHybridUseBenefit { get; set; }
