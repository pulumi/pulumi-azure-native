...
namespace Pulumi.AzureNative.Migrate.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20240101preview:AssessmentProjectsPrivateEndpointConnectionOperation")]
    public partial class AssessmentProjectsPrivateEndpointConnectionOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsPrivateEndpointConnectionOperation(string name, AssessmentProjectsPrivateEndpointConnectionOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AssessmentProjectsPrivateEndpointConnectionOperation", name, args ?? new AssessmentProjectsPrivateEndpointConnectionOperationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AssessmentProjectsPrivateEndpointConnectionOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AssessmentProjectsPrivateEndpointConnectionOperation", name, null, MakeResourceOptions(options, id))
        {
        }
