...
namespace Pulumi.AzureNative.Migrate.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20240101preview:AssessmentProjectsAvsAssessmentsOperation")]
    public partial class AssessmentProjectsAvsAssessmentsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsAvsAssessmentsOperation(string name, AssessmentProjectsAvsAssessmentsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AssessmentProjectsAvsAssessmentsOperation", name, args ?? new AssessmentProjectsAvsAssessmentsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsAvsAssessmentsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AssessmentProjectsAvsAssessmentsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AssessmentProjectsAvsAssessmentsOperationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AvsAssessmentScenario>? AvsAssessmentScenario { get; set; }

        /// <summary>
        /// Azure Location or Azure region where to which the machines will be migrated.
        /// </summary>
        [Input("azureLocation")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureLocation>? AzureLocation { get; set; }

        /// <summary>
        /// Azure Offer code according to which cost estimation is done.
        /// </summary>
        [Input("azureOfferCode")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureOfferCode>? AzureOfferCode { get; set; }
        ...
        /// </summary>
        [Input("currency")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureCurrency>? Currency { get; set; }
        ...
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.ExternalStorageType>>? _externalStorageTypes;

        /// <summary>
        /// List of AVS external storage types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.ExternalStorageType>> ExternalStorageTypes
        {
            get => _externalStorageTypes ?? (_externalStorageTypes = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.ExternalStorageType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.FttAndRaidLevel>? FailuresToTolerateAndRaidLevel { get; set; }

        [Input("failuresToTolerateAndRaidLevelList")]
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.FttAndRaidLevel>>? _failuresToTolerateAndRaidLevelList;

        /// <summary>
        /// List of Failures to tolerate and RAID levels in a common property.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.FttAndRaidLevel>> FailuresToTolerateAndRaidLevelList
        {
            get => _failuresToTolerateAndRaidLevelList ?? (_failuresToTolerateAndRaidLevelList = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.FttAndRaidLevel>>());
        ...
        /// </summary>
        [Input("nodeType")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureAvsNodeType>? NodeType { get; set; }

        [Input("nodeTypes")]
        private InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureAvsNodeType>>? _nodeTypes;

        /// <summary>
        /// AVS node types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureAvsNodeType>> NodeTypes
        {
            get => _nodeTypes ?? (_nodeTypes = new InputList<Union<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureAvsNodeType>>());
        ...
        /// </summary>
        [Input("percentile")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.Percentile>? Percentile { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AzureReservedInstance>? ReservedInstance { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.AssessmentSizingCriterion>? SizingCriterion { get; set; }
        ...
        /// </summary>
        [Input("timeRange")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.TimeRange>? TimeRange { get; set; }
