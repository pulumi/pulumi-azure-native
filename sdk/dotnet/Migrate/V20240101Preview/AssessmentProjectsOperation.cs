...
namespace Pulumi.AzureNative.Migrate.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20240101preview:AssessmentProjectsOperation")]
    public partial class AssessmentProjectsOperation : global::Pulumi.CustomResource
    {
        ...
        public AssessmentProjectsOperation(string name, AssessmentProjectsOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AssessmentProjectsOperation", name, args ?? new AssessmentProjectsOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentProjectsOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20240101preview:AssessmentProjectsOperation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AssessmentProjectsOperationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("projectStatus")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20240101Preview.ProjectStatus>? ProjectStatus { get; set; }
