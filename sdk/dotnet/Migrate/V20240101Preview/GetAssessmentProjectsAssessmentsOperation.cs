...
namespace Pulumi.AzureNative.Migrate.V20240101Preview
{
    public static class GetAssessmentProjectsAssessmentsOperation
    {
        ...
        public static Task<GetAssessmentProjectsAssessmentsOperationResult> InvokeAsync(GetAssessmentProjectsAssessmentsOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentProjectsAssessmentsOperationResult>("azure-native:migrate/v20240101preview:getAssessmentProjectsAssessmentsOperation", args ?? new GetAssessmentProjectsAssessmentsOperationArgs(), options.WithDefaults());
        ...
        public static Output<GetAssessmentProjectsAssessmentsOperationResult> Invoke(GetAssessmentProjectsAssessmentsOperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentProjectsAssessmentsOperationResult>("azure-native:migrate/v20240101preview:getAssessmentProjectsAssessmentsOperation", args ?? new GetAssessmentProjectsAssessmentsOperationInvokeArgs(), options.WithDefaults());
