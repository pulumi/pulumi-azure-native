...
namespace Pulumi.AzureNative.Migrate.V20240101Preview
{
    public static class GetAssessmentProjectsOperation
    {
        ...
        public static Task<GetAssessmentProjectsOperationResult> InvokeAsync(GetAssessmentProjectsOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentProjectsOperationResult>("azure-native:migrate/v20240101preview:getAssessmentProjectsOperation", args ?? new GetAssessmentProjectsOperationArgs(), options.WithDefaults());
        ...
        public static Output<GetAssessmentProjectsOperationResult> Invoke(GetAssessmentProjectsOperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentProjectsOperationResult>("azure-native:migrate/v20240101preview:getAssessmentProjectsOperation", args ?? new GetAssessmentProjectsOperationInvokeArgs(), options.WithDefaults());
