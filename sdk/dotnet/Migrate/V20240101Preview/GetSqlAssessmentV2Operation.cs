...
namespace Pulumi.AzureNative.Migrate.V20240101Preview
{
    public static class GetSqlAssessmentV2Operation
    {
        ...
        public static Task<GetSqlAssessmentV2OperationResult> InvokeAsync(GetSqlAssessmentV2OperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlAssessmentV2OperationResult>("azure-native:migrate/v20240101preview:getSqlAssessmentV2Operation", args ?? new GetSqlAssessmentV2OperationArgs(), options.WithDefaults());
        ...
        public static Output<GetSqlAssessmentV2OperationResult> Invoke(GetSqlAssessmentV2OperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSqlAssessmentV2OperationResult>("azure-native:migrate/v20240101preview:getSqlAssessmentV2Operation", args ?? new GetSqlAssessmentV2OperationInvokeArgs(), options.WithDefaults());
