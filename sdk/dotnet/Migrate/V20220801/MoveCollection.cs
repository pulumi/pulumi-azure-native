...
namespace Pulumi.AzureNative.Migrate.V20220801
{
    ...
    /// {
    ///     var moveCollection = new AzureNative.Migrate.V20220801.MoveCollection("moveCollection", new()
    ///     {
    ///         Identity = new AzureNative.Migrate.V20220801.Inputs.IdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Location = "eastus2",
    ///         MoveCollectionName = "movecollection1",
    ///         Properties = new AzureNative.Migrate.V20220801.Inputs.MoveCollectionPropertiesArgs
    ///         {
    ///             SourceRegion = "eastus",
    ///             TargetRegion = "westus",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20220801:MoveCollection")]
    public partial class MoveCollection : global::Pulumi.CustomResource
    {
        ...
        public MoveCollection(string name, MoveCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20220801:MoveCollection", name, args ?? new MoveCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20220801:MoveCollection", name, null, MakeResourceOptions(options, id))
        {
        }
