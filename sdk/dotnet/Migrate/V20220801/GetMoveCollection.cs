...
namespace Pulumi.AzureNative.Migrate.V20220801
{
    public static class GetMoveCollection
    {
        ...
        public static Task<GetMoveCollectionResult> InvokeAsync(GetMoveCollectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMoveCollectionResult>("azure-native:migrate/v20220801:getMoveCollection", args ?? new GetMoveCollectionArgs(), options.WithDefaults());
