...
namespace Pulumi.AzureNative.Migrate.V20210101
{
    ...
    public partial class MoveCollection : Pulumi.CustomResource
    {
        ...
        public MoveCollection(string name, MoveCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20210101:MoveCollection", name, args ?? new MoveCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20210101:MoveCollection", name, null, MakeResourceOptions(options, id))
        {
        }
