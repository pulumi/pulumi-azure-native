...
namespace Pulumi.AzureNextGen.Migrate.V20210101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:migrate/v20210101:MoveCollection")]
    public partial class MoveCollection : Pulumi.CustomResource
    {
        ...
        public MoveCollection(string name, MoveCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:migrate/v20210101:MoveCollection", name, args ?? new MoveCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:migrate/v20210101:MoveCollection", name, null, MakeResourceOptions(options, id))
        {
        }
