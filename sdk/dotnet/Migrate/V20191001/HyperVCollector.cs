...
namespace Pulumi.AzureNative.Migrate.V20191001
{
    ...
    public partial class HyperVCollector : Pulumi.CustomResource
    {
        ...
        public HyperVCollector(string name, HyperVCollectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20191001:HyperVCollector", name, args ?? new HyperVCollectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HyperVCollector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20191001:HyperVCollector", name, null, MakeResourceOptions(options, id))
        {
        }
