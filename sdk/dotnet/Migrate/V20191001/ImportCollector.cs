...
namespace Pulumi.AzureNative.Migrate.V20191001
{
    ...
    /// {
    ///     var importCollector = new AzureNative.Migrate.V20191001.ImportCollector("importCollector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20191001:ImportCollector")]
    public partial class ImportCollector : global::Pulumi.CustomResource
    {
        ...
        public ImportCollector(string name, ImportCollectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20191001:ImportCollector", name, args ?? new ImportCollectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImportCollector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20191001:ImportCollector", name, null, MakeResourceOptions(options, id))
        {
        }
