...
namespace Pulumi.AzureNative.Migrate.V20191001
{
    public static class GetAssessmentProjectsVMwareCollector
    {
        ...
        public static Task<GetAssessmentProjectsVMwareCollectorResult> InvokeAsync(GetAssessmentProjectsVMwareCollectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssessmentProjectsVMwareCollectorResult>("azure-native:migrate/v20191001:getAssessmentProjectsVMwareCollector", args ?? new GetAssessmentProjectsVMwareCollectorArgs(), options.WithDefaults());
        ...
        public static Output<GetAssessmentProjectsVMwareCollectorResult> Invoke(GetAssessmentProjectsVMwareCollectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssessmentProjectsVMwareCollectorResult>("azure-native:migrate/v20191001:getAssessmentProjectsVMwareCollector", args ?? new GetAssessmentProjectsVMwareCollectorInvokeArgs(), options.WithDefaults());
