...
namespace Pulumi.AzureRM.Migrate.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var solution = new AzureRM.Migrate.Latest.Solution("solution", new AzureRM.Migrate.Latest.SolutionArgs
    ///         {
    ...
    public partial class Solution : Pulumi.CustomResource
    {
        ...
        public Solution(string name, SolutionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:migrate/latest:Solution", name, args ?? new SolutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Solution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:migrate/latest:Solution", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:migrate/v20180901preview:Solution"},
                },
            };
