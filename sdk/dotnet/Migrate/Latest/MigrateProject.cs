...
namespace Pulumi.AzureRM.Migrate.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var migrateProject = new AzureRM.Migrate.Latest.MigrateProject("migrateProject", new AzureRM.Migrate.Latest.MigrateProjectArgs
    ///         {
    ...
    public partial class MigrateProject : Pulumi.CustomResource
    {
        ...
        public MigrateProject(string name, MigrateProjectArgs args, CustomResourceOptions? options = null)
            : base("azurerm:migrate/latest:MigrateProject", name, args ?? new MigrateProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MigrateProject(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:migrate/latest:MigrateProject", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:migrate/v20180901preview:MigrateProject"},
                },
            };
