...
namespace Pulumi.AzureRM.Migrate.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var moveCollection = new AzureRM.Migrate.Latest.MoveCollection("moveCollection", new AzureRM.Migrate.Latest.MoveCollectionArgs
    ///         {
    ...
    public partial class MoveCollection : Pulumi.CustomResource
    {
        ...
        public MoveCollection(string name, MoveCollectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:migrate/latest:MoveCollection", name, args ?? new MoveCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:migrate/latest:MoveCollection", name, null, MakeResourceOptions(options, id))
        {
        }
