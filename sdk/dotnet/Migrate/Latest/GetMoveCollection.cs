...
namespace Pulumi.AzureRM.Migrate.Latest
{
    public static class GetMoveCollection
    {
        public static Task<GetMoveCollectionResult> InvokeAsync(GetMoveCollectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMoveCollectionResult>("azurerm:migrate/latest:getMoveCollection", args ?? new GetMoveCollectionArgs(), options.WithVersion());
    }
