...
namespace Pulumi.AzureRM.Migrate.Latest
{
    ...
    public partial class MoveResource : Pulumi.CustomResource
    {
        ...
        public MoveResource(string name, MoveResourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:migrate/latest:MoveResource", name, args ?? new MoveResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:migrate/latest:MoveResource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:migrate/v20191001preview:MoveResource"},
                },
            };
