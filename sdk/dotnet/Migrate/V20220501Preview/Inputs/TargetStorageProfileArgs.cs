...
namespace Pulumi.AzureNative.Migrate.V20220501Preview.Inputs
{
    ...
    public sealed class TargetStorageProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20220501Preview.TargetHydrationStorageProviderType>? HydrationStorageProviderType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20220501Preview.TargetStorageAccessType>? StorageAccessType { get; set; }

        /// <summary>
        /// Gets or sets the target projection type.
        /// </summary>
        [Input("storageProjectionType")]
        public InputUnion<string, Pulumi.AzureNative.Migrate.V20220501Preview.TargetStorageProjectionType>? StorageProjectionType { get; set; }
