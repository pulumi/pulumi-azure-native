...
namespace Pulumi.AzureNative.Migrate.V20220501Preview
{
    ...
    /// {
    ///     var workloadDeployment = new AzureNative.Migrate.V20220501Preview.WorkloadDeployment("workloadDeployment", new()
    ///     {
    ///         ModernizeProjectName = "l6r8",
    ///         Properties = new AzureNative.Migrate.V20220501Preview.Inputs.WorkloadDeploymentModelPropertiesArgs
    ///         {
    ///             CustomProperties = 
    ///             {
    ...
    ///             WorkloadInstanceProperties = new AzureNative.Migrate.V20220501Preview.Inputs.WorkloadInstanceModelPropertiesArgs
    ///             {
    ///                 CustomProperties = 
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:migrate/v20220501preview:WorkloadDeployment")]
    public partial class WorkloadDeployment : global::Pulumi.CustomResource
    {
        ...
        public WorkloadDeployment(string name, WorkloadDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20220501preview:WorkloadDeployment", name, args ?? new WorkloadDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20220501preview:WorkloadDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
