...
namespace Pulumi.AzureNative.Migrate.V20220501Preview
{
    ...
    public partial class ModernizeProject : global::Pulumi.CustomResource
    {
        ...
        public ModernizeProject(string name, ModernizeProjectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20220501preview:ModernizeProject", name, args ?? new ModernizeProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ModernizeProject(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20220501preview:ModernizeProject", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:migrate:ModernizeProject" },
                },
            };
