...
namespace Pulumi.AzureNextGen.Migrate
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:migrate:MoveResource")]
    public partial class MoveResource : Pulumi.CustomResource
    {
        ...
        public MoveResource(string name, MoveResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:migrate:MoveResource", name, args ?? new MoveResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:migrate:MoveResource", name, null, MakeResourceOptions(options, id))
        {
        }
