...
namespace Pulumi.AzureRM.Migrate.V20191001Preview
{
    public static class GetMoveCollection
    {
        public static Task<GetMoveCollectionResult> InvokeAsync(GetMoveCollectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMoveCollectionResult>("azurerm:migrate/v20191001preview:getMoveCollection", args ?? new GetMoveCollectionArgs(), options.WithVersion());
    }
