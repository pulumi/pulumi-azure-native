...
namespace Pulumi.AzureNative.Migrate.V20191001Preview
{
    ...
    public partial class MoveResource : Pulumi.CustomResource
    {
        ...
        public MoveResource(string name, MoveResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20191001preview:MoveResource", name, args ?? new MoveResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MoveResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:migrate/v20191001preview:MoveResource", name, null, MakeResourceOptions(options, id))
        {
        }
