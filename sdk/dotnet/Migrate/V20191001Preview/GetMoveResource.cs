...
namespace Pulumi.AzureNative.Migrate.V20191001Preview
{
    ...
    public static class GetMoveResource
    {
        ...
        public static Task<GetMoveResourceResult> InvokeAsync(GetMoveResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMoveResourceResult>("azure-native:migrate/v20191001preview:getMoveResource", args ?? new GetMoveResourceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the Move Resource.
        /// </summary>
        public static Output<GetMoveResourceResult> Invoke(GetMoveResourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMoveResourceResult>("azure-native:migrate/v20191001preview:getMoveResource", args ?? new GetMoveResourceInvokeArgs(), options.WithDefaults());
    }
