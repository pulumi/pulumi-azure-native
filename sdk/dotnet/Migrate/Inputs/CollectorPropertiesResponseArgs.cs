...
namespace Pulumi.AzureRM.Migrate.Inputs
{
    ...
    public sealed class CollectorPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        [Input("agentProperties")]
        public Input<Inputs.CollectorAgentPropertiesResponseArgs>? AgentProperties { get; set; }
        ...
        public CollectorPropertiesResponseArgs()
        {
        }
    }
}
