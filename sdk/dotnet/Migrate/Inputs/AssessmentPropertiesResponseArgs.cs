...
namespace Pulumi.AzureRM.Migrate.Inputs
{
    ...
    /// </summary>
    public sealed class AssessmentPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.VmUptimeResponseArgs> VmUptime { get; set; } = null!;

        public AssessmentPropertiesResponseArgs()
        {
        }
    }
}
