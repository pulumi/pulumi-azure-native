...
namespace Pulumi.AzureNative.Dns.V20160401
{
    /// <summary>
    /// Describes a DNS zone.
    /// </summary>
    [AzureNativeResourceType("azure-native:dns/v20160401:Zone")]
    public partial class Zone : global::Pulumi.CustomResource
    {
        ...
        public Zone(string name, ZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20160401:Zone", name, args ?? new ZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Zone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20160401:Zone", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ZoneArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("zoneType")]
        public Input<Pulumi.AzureNative.Dns.V20160401.ZoneType>? ZoneType { get; set; }

        public ZoneArgs()
        {
            ZoneType = Pulumi.AzureNative.Dns.V20160401.ZoneType.Public;
        }
