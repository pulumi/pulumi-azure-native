...
namespace Pulumi.AzureNative.Dns
{
    public static class GetDnssecConfig
    {
        ...
        public static Task<GetDnssecConfigResult> InvokeAsync(GetDnssecConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnssecConfigResult>("azure-native:dns:getDnssecConfig", args ?? new GetDnssecConfigArgs(), options.WithDefaults());
        ...
        public static Output<GetDnssecConfigResult> Invoke(GetDnssecConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDnssecConfigResult>("azure-native:dns:getDnssecConfig", args ?? new GetDnssecConfigInvokeArgs(), options.WithDefaults());
