...
namespace Pulumi.AzureNative.Dns.V20230701Preview
{
    public static class GetDnssecConfig
    {
        ...
        public static Task<GetDnssecConfigResult> InvokeAsync(GetDnssecConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnssecConfigResult>("azure-native:dns/v20230701preview:getDnssecConfig", args ?? new GetDnssecConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the DNSSEC configuration.
        /// </summary>
        public static Output<GetDnssecConfigResult> Invoke(GetDnssecConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDnssecConfigResult>("azure-native:dns/v20230701preview:getDnssecConfig", args ?? new GetDnssecConfigInvokeArgs(), options.WithDefaults());
