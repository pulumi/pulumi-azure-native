...
namespace Pulumi.AzureNative.Dns.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dns/v20230701preview:DnssecConfig")]
    public partial class DnssecConfig : global::Pulumi.CustomResource
    {
        ...
        public DnssecConfig(string name, DnssecConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20230701preview:DnssecConfig", name, args ?? new DnssecConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnssecConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20230701preview:DnssecConfig", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dns:DnssecConfig" },
