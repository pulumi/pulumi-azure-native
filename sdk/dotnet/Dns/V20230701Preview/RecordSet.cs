...
namespace Pulumi.AzureNative.Dns.V20230701Preview
{
    /// <summary>
    /// Describes a DNS record set (a collection of DNS records with the same name and type).
    /// </summary>
    [AzureNativeResourceType("azure-native:dns/v20230701preview:RecordSet")]
    public partial class RecordSet : global::Pulumi.CustomResource
    {
        ...
        public RecordSet(string name, RecordSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20230701preview:RecordSet", name, args ?? new RecordSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RecordSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20230701preview:RecordSet", name, null, MakeResourceOptions(options, id))
        {
        }
