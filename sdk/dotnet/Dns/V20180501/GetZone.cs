...
namespace Pulumi.AzureNative.Dns.V20180501
{
    public static class GetZone
    {
        ...
        public static Task<GetZoneResult> InvokeAsync(GetZoneArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetZoneResult>("azure-native:dns/v20180501:getZone", args ?? new GetZoneArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a DNS zone. Retrieves the zone properties, but not the record sets within the zone.
        /// </summary>
        public static Output<GetZoneResult> Invoke(GetZoneInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetZoneResult>("azure-native:dns/v20180501:getZone", args ?? new GetZoneInvokeArgs(), options.WithDefaults());
