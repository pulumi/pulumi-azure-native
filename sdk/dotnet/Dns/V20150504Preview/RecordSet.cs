...
namespace Pulumi.AzureNative.Dns.V20150504Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dns/v20150504preview:RecordSet")]
    public partial class RecordSet : global::Pulumi.CustomResource
    {
        ...
        public RecordSet(string name, RecordSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20150504preview:RecordSet", name, args ?? new RecordSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RecordSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20150504preview:RecordSet", name, null, MakeResourceOptions(options, id))
        {
        }
