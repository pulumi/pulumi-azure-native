...
namespace Pulumi.AzureNative.Dns.V20150504Preview
{
    public static class GetZone
    {
        ...
        public static Task<GetZoneResult> InvokeAsync(GetZoneArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetZoneResult>("azure-native:dns/v20150504preview:getZone", args ?? new GetZoneArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a DNS zone.
        /// </summary>
        public static Output<GetZoneResult> Invoke(GetZoneInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetZoneResult>("azure-native:dns/v20150504preview:getZone", args ?? new GetZoneInvokeArgs(), options.WithDefaults());
