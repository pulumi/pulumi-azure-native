...
namespace Pulumi.AzureNative.Dns.V20150504Preview
{
    /// <summary>
    /// Describes a DNS zone.
    /// </summary>
    [AzureNativeResourceType("azure-native:dns/v20150504preview:Zone")]
    public partial class Zone : global::Pulumi.CustomResource
    {
        ...
        public Zone(string name, ZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20150504preview:Zone", name, args ?? new ZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Zone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dns/v20150504preview:Zone", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dns:Zone" },
