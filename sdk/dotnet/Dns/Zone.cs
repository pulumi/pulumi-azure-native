...
namespace Pulumi.AzureNative.Dns
{
    ...
    public partial class Zone : global::Pulumi.CustomResource
    {
        ...
        public Zone(string name, ZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dns:Zone", name, args ?? new ZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Zone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dns:Zone", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ZoneArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("zoneType")]
        public Input<Pulumi.AzureNative.Dns.ZoneType>? ZoneType { get; set; }

        public ZoneArgs()
        {
            ZoneType = Pulumi.AzureNative.Dns.ZoneType.Public;
        }
