...
namespace Pulumi.AzureRM.EngagementFabric.Latest
{
    public static class ListAccountChannelTypes
    {
        public static Task<ListAccountChannelTypesResult> InvokeAsync(ListAccountChannelTypesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAccountChannelTypesResult>("azurerm:engagementfabric/latest:listAccountChannelTypes", args ?? new ListAccountChannelTypesArgs(), options.WithVersion());
    }
