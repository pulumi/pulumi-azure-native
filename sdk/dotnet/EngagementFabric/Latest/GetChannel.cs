...
namespace Pulumi.AzureRM.EngagementFabric.Latest
{
    public static class GetChannel
    {
        public static Task<GetChannelResult> InvokeAsync(GetChannelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetChannelResult>("azurerm:engagementfabric/latest:getChannel", args ?? new GetChannelArgs(), options.WithVersion());
    }
