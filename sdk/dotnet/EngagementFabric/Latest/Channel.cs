...
namespace Pulumi.AzureRM.EngagementFabric.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var channel = new AzureRM.EngagementFabric.Latest.Channel("channel", new AzureRM.EngagementFabric.Latest.ChannelArgs
    ///         {
    ...
    public partial class Channel : Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azurerm:engagementfabric/latest:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:engagementfabric/latest:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
