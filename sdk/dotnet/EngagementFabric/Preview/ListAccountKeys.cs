...
namespace Pulumi.AzureRM.EngagementFabric.Preview
{
    public static class ListAccountKeys
    {
        public static Task<ListAccountKeysResult> InvokeAsync(ListAccountKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAccountKeysResult>("azurerm:engagementfabric/preview:listAccountKeys", args ?? new ListAccountKeysArgs(), options.WithVersion());
    }
