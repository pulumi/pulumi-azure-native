...
namespace Pulumi.AzureRM.EngagementFabric.Preview
{
    public static class ListAccountChannelTypes
    {
        public static Task<ListAccountChannelTypesResult> InvokeAsync(ListAccountChannelTypesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListAccountChannelTypesResult>("azurerm:engagementfabric/preview:listAccountChannelTypes", args ?? new ListAccountChannelTypesArgs(), options.WithVersion());
    }
