...
namespace Pulumi.AzureRM.DelegatedNetwork.Preview
{
    ...
    public partial class ControllerDetails : Pulumi.CustomResource
    {
        ...
        public ControllerDetails(string name, ControllerDetailsArgs args, CustomResourceOptions? options = null)
            : base("azurerm:delegatednetwork/preview:ControllerDetails", name, args ?? new ControllerDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ControllerDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:delegatednetwork/preview:ControllerDetails", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:delegatednetwork/v20200808preview:ControllerDetails"},
                },
            };
    ...
    public sealed class ControllerDetailsArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("kubernetesProperties")]
        private InputList<Inputs.KubernetesPropertiesArgs>? _kubernetesProperties;

        /// <summary>
        /// properties of kubernetes clusters
        /// </summary>
        public InputList<Inputs.KubernetesPropertiesArgs> KubernetesProperties
        {
            get => _kubernetesProperties ?? (_kubernetesProperties = new InputList<Inputs.KubernetesPropertiesArgs>());
            set => _kubernetesProperties = value;
        }
