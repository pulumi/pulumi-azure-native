...
namespace Pulumi.AzureNative.DelegatedNetwork.V20230627Preview
{
    public static class GetControllerDetails
    {
        ...
        public static Task<GetControllerDetailsResult> InvokeAsync(GetControllerDetailsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetControllerDetailsResult>("azure-native:delegatednetwork/v20230627preview:getControllerDetails", args ?? new GetControllerDetailsArgs(), options.WithDefaults());
