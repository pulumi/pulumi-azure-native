...
namespace Pulumi.AzureNative.DelegatedNetwork.V20210315
{
    ...
    public partial class ControllerDetails : Pulumi.CustomResource
    {
        ...
        public ControllerDetails(string name, ControllerDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20210315:ControllerDetails", name, args ?? new ControllerDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ControllerDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20210315:ControllerDetails", name, null, MakeResourceOptions(options, id))
        {
        }
