...
namespace Pulumi.AzureNative.DelegatedNetwork.V20210315
{
    ...
    public partial class DelegatedSubnetServiceDetails : Pulumi.CustomResource
    {
        ...
        public DelegatedSubnetServiceDetails(string name, DelegatedSubnetServiceDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20210315:DelegatedSubnetServiceDetails", name, args ?? new DelegatedSubnetServiceDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DelegatedSubnetServiceDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20210315:DelegatedSubnetServiceDetails", name, null, MakeResourceOptions(options, id))
        {
        }
