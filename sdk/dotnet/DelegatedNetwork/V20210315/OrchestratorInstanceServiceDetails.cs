...
namespace Pulumi.AzureNative.DelegatedNetwork.V20210315
{
    ...
    public partial class OrchestratorInstanceServiceDetails : Pulumi.CustomResource
    {
        ...
        public OrchestratorInstanceServiceDetails(string name, OrchestratorInstanceServiceDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20210315:OrchestratorInstanceServiceDetails", name, args ?? new OrchestratorInstanceServiceDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrchestratorInstanceServiceDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20210315:OrchestratorInstanceServiceDetails", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrchestratorInstanceServiceDetailsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DelegatedNetwork.V20210315.OrchestratorKind> Kind { get; set; } = null!;
