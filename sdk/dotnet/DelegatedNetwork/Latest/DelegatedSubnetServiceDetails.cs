...
namespace Pulumi.AzureNative.DelegatedNetwork.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:delegatednetwork:DelegatedSubnetServiceDetails'.")]
    [AzureNativeResourceType("azure-native:delegatednetwork/latest:DelegatedSubnetServiceDetails")]
    public partial class DelegatedSubnetServiceDetails : Pulumi.CustomResource
    {
        ...
        public DelegatedSubnetServiceDetails(string name, DelegatedSubnetServiceDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/latest:DelegatedSubnetServiceDetails", name, args ?? new DelegatedSubnetServiceDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DelegatedSubnetServiceDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/latest:DelegatedSubnetServiceDetails", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:delegatednetwork/latest:DelegatedSubnetServiceDetails"},
                    new Pulumi.Alias { Type = "azure-native:delegatednetwork:DelegatedSubnetServiceDetails"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:delegatednetwork/v20210315:DelegatedSubnetServiceDetails"},
                },
            };
