...
namespace Pulumi.AzureNative.DelegatedNetwork.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:delegatednetwork:ControllerDetails'.")]
    [AzureNativeResourceType("azure-native:delegatednetwork/latest:ControllerDetails")]
    public partial class ControllerDetails : Pulumi.CustomResource
    {
        ...
        public ControllerDetails(string name, ControllerDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/latest:ControllerDetails", name, args ?? new ControllerDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ControllerDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/latest:ControllerDetails", name, null, MakeResourceOptions(options, id))
        {
        }
