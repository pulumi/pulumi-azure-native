...
namespace Pulumi.AzureNative.DelegatedNetwork.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:delegatednetwork:OrchestratorInstanceServiceDetails'.")]
    [AzureNativeResourceType("azure-native:delegatednetwork/latest:OrchestratorInstanceServiceDetails")]
    public partial class OrchestratorInstanceServiceDetails : Pulumi.CustomResource
    {
        ...
        public OrchestratorInstanceServiceDetails(string name, OrchestratorInstanceServiceDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/latest:OrchestratorInstanceServiceDetails", name, args ?? new OrchestratorInstanceServiceDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrchestratorInstanceServiceDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/latest:OrchestratorInstanceServiceDetails", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrchestratorInstanceServiceDetailsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DelegatedNetwork.Latest.OrchestratorKind> Kind { get; set; } = null!;
