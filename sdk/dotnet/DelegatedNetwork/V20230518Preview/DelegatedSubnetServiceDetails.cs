...
namespace Pulumi.AzureNative.DelegatedNetwork.V20230518Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:delegatednetwork/v20230518preview:DelegatedSubnetServiceDetails")]
    public partial class DelegatedSubnetServiceDetails : global::Pulumi.CustomResource
    {
        ...
        public DelegatedSubnetServiceDetails(string name, DelegatedSubnetServiceDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20230518preview:DelegatedSubnetServiceDetails", name, args ?? new DelegatedSubnetServiceDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DelegatedSubnetServiceDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20230518preview:DelegatedSubnetServiceDetails", name, null, MakeResourceOptions(options, id))
        {
        }
