...
namespace Pulumi.AzureNative.DelegatedNetwork.V20230518Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:delegatednetwork/v20230518preview:OrchestratorInstanceServiceDetails")]
    public partial class OrchestratorInstanceServiceDetails : global::Pulumi.CustomResource
    {
        ...
        public OrchestratorInstanceServiceDetails(string name, OrchestratorInstanceServiceDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20230518preview:OrchestratorInstanceServiceDetails", name, args ?? new OrchestratorInstanceServiceDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrchestratorInstanceServiceDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:delegatednetwork/v20230518preview:OrchestratorInstanceServiceDetails", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrchestratorInstanceServiceDetailsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DelegatedNetwork.V20230518Preview.OrchestratorKind> Kind { get; set; } = null!;
