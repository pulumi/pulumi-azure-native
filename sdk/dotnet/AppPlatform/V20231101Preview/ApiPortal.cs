...
namespace Pulumi.AzureNative.AppPlatform.V20231101Preview
{
    ...
    /// API portal resource
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20231101preview:ApiPortal")]
    public partial class ApiPortal : global::Pulumi.CustomResource
    {
        ...
        public ApiPortal(string name, ApiPortalArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231101preview:ApiPortal", name, args ?? new ApiPortalArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiPortal(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231101preview:ApiPortal", name, null, MakeResourceOptions(options, id))
        {
        }
