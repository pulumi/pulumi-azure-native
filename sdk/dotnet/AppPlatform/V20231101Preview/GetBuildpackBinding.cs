...
namespace Pulumi.AzureNative.AppPlatform.V20231101Preview
{
    public static class GetBuildpackBinding
    {
        ...
        public static Task<GetBuildpackBindingResult> InvokeAsync(GetBuildpackBindingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBuildpackBindingResult>("azure-native:appplatform/v20231101preview:getBuildpackBinding", args ?? new GetBuildpackBindingArgs(), options.WithDefaults());

        /// <summary>
        /// Get a buildpack binding by name.
        /// </summary>
        public static Output<GetBuildpackBindingResult> Invoke(GetBuildpackBindingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBuildpackBindingResult>("azure-native:appplatform/v20231101preview:getBuildpackBinding", args ?? new GetBuildpackBindingInvokeArgs(), options.WithDefaults());
    }
