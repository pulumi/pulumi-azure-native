...
namespace Pulumi.AzureNative.AppPlatform.V20231101Preview
{
    public static class ListServiceGloballyEnabledApms
    {
        ...
        public static Task<ListServiceGloballyEnabledApmsResult> InvokeAsync(ListServiceGloballyEnabledApmsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListServiceGloballyEnabledApmsResult>("azure-native:appplatform/v20231101preview:listServiceGloballyEnabledApms", args ?? new ListServiceGloballyEnabledApmsArgs(), options.WithDefaults());
        ...
        public static Output<ListServiceGloballyEnabledApmsResult> Invoke(ListServiceGloballyEnabledApmsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListServiceGloballyEnabledApmsResult>("azure-native:appplatform/v20231101preview:listServiceGloballyEnabledApms", args ?? new ListServiceGloballyEnabledApmsInvokeArgs(), options.WithDefaults());
    }
