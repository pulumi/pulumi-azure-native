...
namespace Pulumi.AzureNative.AppPlatform.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20231101preview:GatewayCustomDomain")]
    public partial class GatewayCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public GatewayCustomDomain(string name, GatewayCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231101preview:GatewayCustomDomain", name, args ?? new GatewayCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231101preview:GatewayCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
