...
namespace Pulumi.AzureNative.AppPlatform.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20231101preview:BuildServiceBuilder")]
    public partial class BuildServiceBuilder : global::Pulumi.CustomResource
    {
        ...
        public BuildServiceBuilder(string name, BuildServiceBuilderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231101preview:BuildServiceBuilder", name, args ?? new BuildServiceBuilderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildServiceBuilder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231101preview:BuildServiceBuilder", name, null, MakeResourceOptions(options, id))
        {
        }
