...
namespace Pulumi.AzureNative.AppPlatform.V20231101Preview
{
    public static class GetBuildServiceBuild
    {
        ...
        public static Task<GetBuildServiceBuildResult> InvokeAsync(GetBuildServiceBuildArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBuildServiceBuildResult>("azure-native:appplatform/v20231101preview:getBuildServiceBuild", args ?? new GetBuildServiceBuildArgs(), options.WithDefaults());
