...
namespace Pulumi.AzureNative.AppPlatform.V20231101Preview
{
    public static class GetMonitoringSetting
    {
        ...
        public static Task<GetMonitoringSettingResult> InvokeAsync(GetMonitoringSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMonitoringSettingResult>("azure-native:appplatform/v20231101preview:getMonitoringSetting", args ?? new GetMonitoringSettingArgs(), options.WithDefaults());

        /// <summary>
        /// Get the Monitoring Setting and its properties.
        /// </summary>
        public static Output<GetMonitoringSettingResult> Invoke(GetMonitoringSettingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMonitoringSettingResult>("azure-native:appplatform/v20231101preview:getMonitoringSetting", args ?? new GetMonitoringSettingInvokeArgs(), options.WithDefaults());
    }
