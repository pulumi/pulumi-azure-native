...
namespace Pulumi.AzureNative.AppPlatform.V20230701Preview
{
    public static class GetBuildServiceAgentPool
    {
        ...
        public static Task<GetBuildServiceAgentPoolResult> InvokeAsync(GetBuildServiceAgentPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBuildServiceAgentPoolResult>("azure-native:appplatform/v20230701preview:getBuildServiceAgentPool", args ?? new GetBuildServiceAgentPoolArgs(), options.WithDefaults());
        ...
        public static Output<GetBuildServiceAgentPoolResult> Invoke(GetBuildServiceAgentPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBuildServiceAgentPoolResult>("azure-native:appplatform/v20230701preview:getBuildServiceAgentPool", args ?? new GetBuildServiceAgentPoolInvokeArgs(), options.WithDefaults());
    }
