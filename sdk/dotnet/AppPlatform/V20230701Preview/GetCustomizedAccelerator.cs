...
namespace Pulumi.AzureNative.AppPlatform.V20230701Preview
{
    public static class GetCustomizedAccelerator
    {
        ...
        public static Task<GetCustomizedAcceleratorResult> InvokeAsync(GetCustomizedAcceleratorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomizedAcceleratorResult>("azure-native:appplatform/v20230701preview:getCustomizedAccelerator", args ?? new GetCustomizedAcceleratorArgs(), options.WithDefaults());
