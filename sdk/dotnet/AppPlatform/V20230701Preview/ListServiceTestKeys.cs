...
namespace Pulumi.AzureNative.AppPlatform.V20230701Preview
{
    public static class ListServiceTestKeys
    {
        ...
        public static Task<ListServiceTestKeysResult> InvokeAsync(ListServiceTestKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListServiceTestKeysResult>("azure-native:appplatform/v20230701preview:listServiceTestKeys", args ?? new ListServiceTestKeysArgs(), options.WithDefaults());

        /// <summary>
        /// List test keys for a Service.
        /// </summary>
        public static Output<ListServiceTestKeysResult> Invoke(ListServiceTestKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListServiceTestKeysResult>("azure-native:appplatform/v20230701preview:listServiceTestKeys", args ?? new ListServiceTestKeysInvokeArgs(), options.WithDefaults());
    }
