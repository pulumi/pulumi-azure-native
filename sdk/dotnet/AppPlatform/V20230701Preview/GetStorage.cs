...
namespace Pulumi.AzureNative.AppPlatform.V20230701Preview
{
    public static class GetStorage
    {
        ...
        public static Task<GetStorageResult> InvokeAsync(GetStorageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageResult>("azure-native:appplatform/v20230701preview:getStorage", args ?? new GetStorageArgs(), options.WithDefaults());

        /// <summary>
        /// Get the storage resource.
        /// </summary>
        public static Output<GetStorageResult> Invoke(GetStorageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageResult>("azure-native:appplatform/v20230701preview:getStorage", args ?? new GetStorageInvokeArgs(), options.WithDefaults());
    }
