...
namespace Pulumi.AzureNative.AppPlatform.V20230701Preview
{
    public static class GetApiPortal
    {
        ...
        public static Task<GetApiPortalResult> InvokeAsync(GetApiPortalArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiPortalResult>("azure-native:appplatform/v20230701preview:getApiPortal", args ?? new GetApiPortalArgs(), options.WithDefaults());
