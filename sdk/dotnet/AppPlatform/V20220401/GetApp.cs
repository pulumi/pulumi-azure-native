...
namespace Pulumi.AzureNative.AppPlatform.V20220401
{
    public static class GetApp
    {
        ...
        public static Task<GetAppResult> InvokeAsync(GetAppArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAppResult>("azure-native:appplatform/v20220401:getApp", args ?? new GetAppArgs(), options.WithDefaults());

        /// <summary>
        /// App resource payload
        /// </summary>
        public static Output<GetAppResult> Invoke(GetAppInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAppResult>("azure-native:appplatform/v20220401:getApp", args ?? new GetAppInvokeArgs(), options.WithDefaults());
    }
