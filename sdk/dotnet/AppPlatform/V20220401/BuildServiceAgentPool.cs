...
namespace Pulumi.AzureNative.AppPlatform.V20220401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:appplatform/v20220401:BuildServiceAgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:BuildServiceAgentPool to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:appplatform/v20220401:BuildServiceAgentPool")]
    public partial class BuildServiceAgentPool : global::Pulumi.CustomResource
    {
        ...
        public BuildServiceAgentPool(string name, BuildServiceAgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220401:BuildServiceAgentPool", name, args ?? new BuildServiceAgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildServiceAgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220401:BuildServiceAgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
