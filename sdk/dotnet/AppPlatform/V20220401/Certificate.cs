...
namespace Pulumi.AzureNative.AppPlatform.V20220401
{
    ...
    [AzureNativeResourceType("azure-native:appplatform/v20220401:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220401:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220401:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
