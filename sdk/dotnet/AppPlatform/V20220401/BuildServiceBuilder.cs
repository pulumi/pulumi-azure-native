...
namespace Pulumi.AzureNative.AppPlatform.V20220401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:appplatform/v20220401:BuildServiceBuilder is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:BuildServiceBuilder to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:appplatform/v20220401:BuildServiceBuilder")]
    public partial class BuildServiceBuilder : global::Pulumi.CustomResource
    {
        ...
        public BuildServiceBuilder(string name, BuildServiceBuilderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220401:BuildServiceBuilder", name, args ?? new BuildServiceBuilderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildServiceBuilder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220401:BuildServiceBuilder", name, null, MakeResourceOptions(options, id))
        {
        }
