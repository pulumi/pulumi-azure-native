...
namespace Pulumi.AzureNative.AppPlatform.V20220401
{
    ...
    public static class GetBinding
    {
        ...
        public static Task<GetBindingResult> InvokeAsync(GetBindingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBindingResult>("azure-native:appplatform/v20220401:getBinding", args ?? new GetBindingArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Binding and its properties.
        /// </summary>
        public static Output<GetBindingResult> Invoke(GetBindingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBindingResult>("azure-native:appplatform/v20220401:getBinding", args ?? new GetBindingInvokeArgs(), options.WithDefaults());
    }
