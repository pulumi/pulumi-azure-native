...
namespace Pulumi.AzureNative.AppPlatform.V20220301Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:appplatform/v20220301preview:Storage is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:Storage to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:appplatform/v20220301preview:Storage")]
    public partial class Storage : global::Pulumi.CustomResource
    {
        ...
        public Storage(string name, StorageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220301preview:Storage", name, args ?? new StorageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Storage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220301preview:Storage", name, null, MakeResourceOptions(options, id))
        {
        }
