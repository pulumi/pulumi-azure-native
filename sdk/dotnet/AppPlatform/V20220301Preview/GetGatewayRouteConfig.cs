...
namespace Pulumi.AzureNative.AppPlatform.V20220301Preview
{
    public static class GetGatewayRouteConfig
    {
        ...
        public static Task<GetGatewayRouteConfigResult> InvokeAsync(GetGatewayRouteConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGatewayRouteConfigResult>("azure-native:appplatform/v20220301preview:getGatewayRouteConfig", args ?? new GetGatewayRouteConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Spring Cloud Gateway route config resource
        /// </summary>
        public static Output<GetGatewayRouteConfigResult> Invoke(GetGatewayRouteConfigInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGatewayRouteConfigResult>("azure-native:appplatform/v20220301preview:getGatewayRouteConfig", args ?? new GetGatewayRouteConfigInvokeArgs(), options.WithDefaults());
    }
