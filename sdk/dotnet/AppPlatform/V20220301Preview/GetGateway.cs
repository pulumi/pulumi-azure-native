...
namespace Pulumi.AzureNative.AppPlatform.V20220301Preview
{
    public static class GetGateway
    {
        ...
        public static Task<GetGatewayResult> InvokeAsync(GetGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGatewayResult>("azure-native:appplatform/v20220301preview:getGateway", args ?? new GetGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Spring Cloud Gateway resource
        /// </summary>
        public static Output<GetGatewayResult> Invoke(GetGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGatewayResult>("azure-native:appplatform/v20220301preview:getGateway", args ?? new GetGatewayInvokeArgs(), options.WithDefaults());
    }
