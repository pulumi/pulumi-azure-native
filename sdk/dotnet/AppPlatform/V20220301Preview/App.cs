...
namespace Pulumi.AzureNative.AppPlatform.V20220301Preview
{
    ...
    [AzureNativeResourceType("azure-native:appplatform/v20220301preview:App")]
    public partial class App : global::Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220301preview:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220301preview:App", name, null, MakeResourceOptions(options, id))
        {
        }
