...
namespace Pulumi.AzureNative.AppPlatform.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20231201:ServiceRegistry")]
    public partial class ServiceRegistry : global::Pulumi.CustomResource
    {
        ...
        public ServiceRegistry(string name, ServiceRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231201:ServiceRegistry", name, args ?? new ServiceRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231201:ServiceRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
