...
namespace Pulumi.AzureNative.AppPlatform.V20231201
{
    public static class GetApp
    {
        ...
        public static Task<GetAppResult> InvokeAsync(GetAppArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppResult>("azure-native:appplatform/v20231201:getApp", args ?? new GetAppArgs(), options.WithDefaults());

        /// <summary>
        /// Get an App and its properties.
        /// </summary>
        public static Output<GetAppResult> Invoke(GetAppInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppResult>("azure-native:appplatform/v20231201:getApp", args ?? new GetAppInvokeArgs(), options.WithDefaults());
