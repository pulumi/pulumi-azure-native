...
namespace Pulumi.AzureNative.AppPlatform.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20231201:DevToolPortal")]
    public partial class DevToolPortal : global::Pulumi.CustomResource
    {
        ...
        public DevToolPortal(string name, DevToolPortalArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231201:DevToolPortal", name, args ?? new DevToolPortalArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevToolPortal(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231201:DevToolPortal", name, null, MakeResourceOptions(options, id))
        {
        }
