...
namespace Pulumi.AzureNative.AppPlatform.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20231201:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231201:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231201:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20230701preview:Certificate" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20230901preview:Certificate" },
