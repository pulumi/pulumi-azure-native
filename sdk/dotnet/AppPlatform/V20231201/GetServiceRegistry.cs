...
namespace Pulumi.AzureNative.AppPlatform.V20231201
{
    public static class GetServiceRegistry
    {
        ...
        public static Task<GetServiceRegistryResult> InvokeAsync(GetServiceRegistryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServiceRegistryResult>("azure-native:appplatform/v20231201:getServiceRegistry", args ?? new GetServiceRegistryArgs(), options.WithDefaults());

        /// <summary>
        /// Get the Service Registry and its properties.
        /// </summary>
        public static Output<GetServiceRegistryResult> Invoke(GetServiceRegistryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServiceRegistryResult>("azure-native:appplatform/v20231201:getServiceRegistry", args ?? new GetServiceRegistryInvokeArgs(), options.WithDefaults());
