...
namespace Pulumi.AzureNative.AppPlatform.V20231201
{
    public static class GetDeploymentRemoteDebuggingConfig
    {
        ...
        public static Task<GetDeploymentRemoteDebuggingConfigResult> InvokeAsync(GetDeploymentRemoteDebuggingConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentRemoteDebuggingConfigResult>("azure-native:appplatform/v20231201:getDeploymentRemoteDebuggingConfig", args ?? new GetDeploymentRemoteDebuggingConfigArgs(), options.WithDefaults());
        ...
        public static Output<GetDeploymentRemoteDebuggingConfigResult> Invoke(GetDeploymentRemoteDebuggingConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDeploymentRemoteDebuggingConfigResult>("azure-native:appplatform/v20231201:getDeploymentRemoteDebuggingConfig", args ?? new GetDeploymentRemoteDebuggingConfigInvokeArgs(), options.WithDefaults());
