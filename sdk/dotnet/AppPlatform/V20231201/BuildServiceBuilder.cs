...
namespace Pulumi.AzureNative.AppPlatform.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20231201:BuildServiceBuilder")]
    public partial class BuildServiceBuilder : global::Pulumi.CustomResource
    {
        ...
        public BuildServiceBuilder(string name, BuildServiceBuilderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231201:BuildServiceBuilder", name, args ?? new BuildServiceBuilderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildServiceBuilder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20231201:BuildServiceBuilder", name, null, MakeResourceOptions(options, id))
        {
        }
