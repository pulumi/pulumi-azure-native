...
namespace Pulumi.AzureNative.AppPlatform.V20230101Preview
{
    public static class GetCustomDomain
    {
        ...
        public static Task<GetCustomDomainResult> InvokeAsync(GetCustomDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomDomainResult>("azure-native:appplatform/v20230101preview:getCustomDomain", args ?? new GetCustomDomainArgs(), options.WithDefaults());

        /// <summary>
        /// Custom domain resource payload.
        /// </summary>
        public static Output<GetCustomDomainResult> Invoke(GetCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomDomainResult>("azure-native:appplatform/v20230101preview:getCustomDomain", args ?? new GetCustomDomainInvokeArgs(), options.WithDefaults());
    }
