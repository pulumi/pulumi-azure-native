...
namespace Pulumi.AzureNative.AppPlatform.V20230101Preview
{
    ...
    /// {
    ///     var gatewayRouteConfig = new AzureNative.AppPlatform.V20230101Preview.GatewayRouteConfig("gatewayRouteConfig", new()
    ///     {
    ///         GatewayName = "default",
    ///         Properties = new AzureNative.AppPlatform.V20230101Preview.Inputs.GatewayRouteConfigPropertiesArgs
    ///         {
    ...
    ///             OpenApi = new AzureNative.AppPlatform.V20230101Preview.Inputs.GatewayRouteConfigOpenApiPropertiesArgs
    ///             {
    ...
    ///             Routes = new[]
    ///             {
    ///                 new AzureNative.AppPlatform.V20230101Preview.Inputs.GatewayApiRouteArgs
    ///                 {
    ///                     Filters = new[]
    ///                     {
    ///                         "StripPrefix=2",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:appplatform/v20230101preview:GatewayRouteConfig myRouteConfig /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.AppPlatform/Spring/myservice/gateways/default/routeConfigs/myRouteConfig 
    /// ```
    /// </summary>
