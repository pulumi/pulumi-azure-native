...
namespace Pulumi.AzureNative.AppPlatform.V20230101Preview
{
    ...
    /// {
    ///     var configServer = new AzureNative.AppPlatform.V20230101Preview.ConfigServer("configServer", new()
    ///     {
    ///         Properties = new AzureNative.AppPlatform.V20230101Preview.Inputs.ConfigServerPropertiesArgs
    ///         {
    ///             ConfigServer = new AzureNative.AppPlatform.V20230101Preview.Inputs.ConfigServerSettingsArgs
    ///             {
    ///                 GitProperty = new AzureNative.AppPlatform.V20230101Preview.Inputs.ConfigServerGitPropertyArgs
    ///                 {
    ///                     Label = "master",
    ///                     SearchPaths = new[]
    ///                     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230101preview:ConfigServer")]
    public partial class ConfigServer : global::Pulumi.CustomResource
    {
        ...
        public ConfigServer(string name, ConfigServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:ConfigServer", name, args ?? new ConfigServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:ConfigServer", name, null, MakeResourceOptions(options, id))
        {
        }
