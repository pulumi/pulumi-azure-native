...
namespace Pulumi.AzureNative.AppPlatform.V20230101Preview
{
    ...
    /// {
    ///     var certificate = new AzureNative.AppPlatform.V20230101Preview.Certificate("certificate", new()
    ///     {
    ///         CertificateName = "mycertificate",
    ///         Properties = new AzureNative.AppPlatform.V20230101Preview.Inputs.KeyVaultCertificatePropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230101preview:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
