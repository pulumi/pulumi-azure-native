...
namespace Pulumi.AzureNative.AppPlatform.V20230101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:appplatform/v20230101preview:MonitoringSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:MonitoringSetting to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:appplatform/v20230101preview:MonitoringSetting")]
    public partial class MonitoringSetting : global::Pulumi.CustomResource
    {
        ...
        public MonitoringSetting(string name, MonitoringSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:MonitoringSetting", name, args ?? new MonitoringSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:MonitoringSetting", name, null, MakeResourceOptions(options, id))
        {
        }
