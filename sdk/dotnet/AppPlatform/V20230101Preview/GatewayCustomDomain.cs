...
namespace Pulumi.AzureNative.AppPlatform.V20230101Preview
{
    ...
    /// {
    ///     var gatewayCustomDomain = new AzureNative.AppPlatform.V20230101Preview.GatewayCustomDomain("gatewayCustomDomain", new()
    ///     {
    ///         DomainName = "myDomainName",
    ///         GatewayName = "default",
    ///         Properties = new AzureNative.AppPlatform.V20230101Preview.Inputs.GatewayCustomDomainPropertiesArgs
    ///         {
    ///             Thumbprint = "*",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230101preview:GatewayCustomDomain")]
    public partial class GatewayCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public GatewayCustomDomain(string name, GatewayCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:GatewayCustomDomain", name, args ?? new GatewayCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:GatewayCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
