...
namespace Pulumi.AzureNative.AppPlatform.V20230101Preview
{
    ...
    /// {
    ///     var customDomain = new AzureNative.AppPlatform.V20230101Preview.CustomDomain("customDomain", new()
    ///     {
    ///         AppName = "myapp",
    ///         DomainName = "mydomain.com",
    ///         Properties = new AzureNative.AppPlatform.V20230101Preview.Inputs.CustomDomainPropertiesArgs
    ///         {
    ///             CertName = "mycert",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:appplatform/v20230101preview:CustomDomain mydomain.com /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.AppPlatform/Spring/myservice/apps/myapp/domains/mydomain.com 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230101preview:CustomDomain")]
    public partial class CustomDomain : global::Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230101preview:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
