...
namespace Pulumi.AzureRM.AppPlatform.V20190501Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var app = new AzureRM.AppPlatform.V20190501Preview.App("app", new AzureRM.AppPlatform.V20190501Preview.AppArgs
    ///         {
    ///             AppName = "myapp",
    ///             Location = "eastus",
    ...
    public partial class App : Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azurerm:appplatform/v20190501preview:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:appplatform/v20190501preview:App", name, null, MakeResourceOptions(options, id))
        {
        }
