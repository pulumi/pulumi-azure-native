...
namespace Pulumi.AzureNative.AppPlatform.V20190501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20190501preview:Binding")]
    public partial class Binding : Pulumi.CustomResource
    {
        ...
        public Binding(string name, BindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20190501preview:Binding", name, args ?? new BindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20190501preview:Binding", name, null, MakeResourceOptions(options, id))
        {
        }
