...
namespace Pulumi.AzureRM.AppPlatform.V20190501Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var certificate = new AzureRM.AppPlatform.V20190501Preview.Certificate("certificate", new AzureRM.AppPlatform.V20190501Preview.CertificateArgs
    ///         {
    ...
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:appplatform/v20190501preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:appplatform/v20190501preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
