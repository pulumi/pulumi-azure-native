...
namespace Pulumi.AzureNative.AppPlatform.V20230901Preview
{
    public static class GetGateway
    {
        ...
        public static Task<GetGatewayResult> InvokeAsync(GetGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewayResult>("azure-native:appplatform/v20230901preview:getGateway", args ?? new GetGatewayArgs(), options.WithDefaults());
