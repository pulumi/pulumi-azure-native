...
namespace Pulumi.AzureNative.AppPlatform.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230901preview:BuildpackBinding")]
    public partial class BuildpackBinding : global::Pulumi.CustomResource
    {
        ...
        public BuildpackBinding(string name, BuildpackBindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:BuildpackBinding", name, args ?? new BuildpackBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildpackBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:BuildpackBinding", name, null, MakeResourceOptions(options, id))
        {
        }
