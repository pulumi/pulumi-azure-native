...
namespace Pulumi.AzureNative.AppPlatform.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230901preview:Binding")]
    public partial class Binding : global::Pulumi.CustomResource
    {
        ...
        public Binding(string name, BindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:Binding", name, args ?? new BindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:Binding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20240101preview:Binding" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20240501preview:Binding" },
                },
            };
