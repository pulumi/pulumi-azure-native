...
namespace Pulumi.AzureNative.AppPlatform.V20230901Preview
{
    public static class GetCustomDomain
    {
        ...
        public static Task<GetCustomDomainResult> InvokeAsync(GetCustomDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomDomainResult>("azure-native:appplatform/v20230901preview:getCustomDomain", args ?? new GetCustomDomainArgs(), options.WithDefaults());

        /// <summary>
        /// Get the custom domain of one lifecycle application.
        /// </summary>
        public static Output<GetCustomDomainResult> Invoke(GetCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomDomainResult>("azure-native:appplatform/v20230901preview:getCustomDomain", args ?? new GetCustomDomainInvokeArgs(), options.WithDefaults());
    }
