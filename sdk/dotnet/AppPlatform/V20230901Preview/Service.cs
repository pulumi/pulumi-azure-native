...
namespace Pulumi.AzureNative.AppPlatform.V20230901Preview
{
    ...
    /// Service resource
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230901preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20230701preview:Service" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20231101preview:Service" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20231201:Service" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20240101preview:Service" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20240501preview:Service" },
