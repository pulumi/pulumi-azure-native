...
namespace Pulumi.AzureNative.AppPlatform.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230901preview:BuildServiceAgentPool")]
    public partial class BuildServiceAgentPool : global::Pulumi.CustomResource
    {
        ...
        public BuildServiceAgentPool(string name, BuildServiceAgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:BuildServiceAgentPool", name, args ?? new BuildServiceAgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildServiceAgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:BuildServiceAgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
