...
namespace Pulumi.AzureNative.AppPlatform.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230901preview:MonitoringSetting")]
    public partial class MonitoringSetting : global::Pulumi.CustomResource
    {
        ...
        public MonitoringSetting(string name, MonitoringSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:MonitoringSetting", name, args ?? new MonitoringSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:MonitoringSetting", name, null, MakeResourceOptions(options, id))
        {
        }
