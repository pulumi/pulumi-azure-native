...
namespace Pulumi.AzureNative.AppPlatform.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230901preview:ConfigServer")]
    public partial class ConfigServer : global::Pulumi.CustomResource
    {
        ...
        public ConfigServer(string name, ConfigServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:ConfigServer", name, args ?? new ConfigServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230901preview:ConfigServer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20230501preview:ConfigServer" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20230701preview:ConfigServer" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20231101preview:ConfigServer" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20231201:ConfigServer" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20240101preview:ConfigServer" },
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20240501preview:ConfigServer" },
                },
            };
