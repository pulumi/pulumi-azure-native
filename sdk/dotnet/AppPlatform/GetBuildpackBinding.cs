...
namespace Pulumi.AzureNative.AppPlatform
{
    public static class GetBuildpackBinding
    {
        ...
        public static Task<GetBuildpackBindingResult> InvokeAsync(GetBuildpackBindingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBuildpackBindingResult>("azure-native:appplatform:getBuildpackBinding", args ?? new GetBuildpackBindingArgs(), options.WithVersion());
        ...
        public static Output<GetBuildpackBindingResult> Invoke(GetBuildpackBindingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBuildpackBindingResult>("azure-native:appplatform:getBuildpackBinding", args ?? new GetBuildpackBindingInvokeArgs(), options.WithVersion());
    }
