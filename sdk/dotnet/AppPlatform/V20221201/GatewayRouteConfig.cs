...
namespace Pulumi.AzureNative.AppPlatform.V20221201
{
    ...
    [AzureNativeResourceType("azure-native:appplatform/v20221201:GatewayRouteConfig")]
    public partial class GatewayRouteConfig : global::Pulumi.CustomResource
    {
        ...
        public GatewayRouteConfig(string name, GatewayRouteConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20221201:GatewayRouteConfig", name, args ?? new GatewayRouteConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayRouteConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20221201:GatewayRouteConfig", name, null, MakeResourceOptions(options, id))
        {
        }
