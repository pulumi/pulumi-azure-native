...
{
    [Obsolete(@"azure-native:appplatform/v20221201:GatewayCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:GatewayCustomDomain to guarantee forwards compatibility.")]
    public static class GetGatewayCustomDomain
    {
        ...
        public static Task<GetGatewayCustomDomainResult> InvokeAsync(GetGatewayCustomDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewayCustomDomainResult>("azure-native:appplatform/v20221201:getGatewayCustomDomain", args ?? new GetGatewayCustomDomainArgs(), options.WithDefaults());
        ...
        public static Output<GetGatewayCustomDomainResult> Invoke(GetGatewayCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGatewayCustomDomainResult>("azure-native:appplatform/v20221201:getGatewayCustomDomain", args ?? new GetGatewayCustomDomainInvokeArgs(), options.WithDefaults());
    }
