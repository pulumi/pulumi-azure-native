...
namespace Pulumi.AzureNative.AppPlatform.V20221201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20221201:Binding")]
    public partial class Binding : global::Pulumi.CustomResource
    {
        ...
        public Binding(string name, BindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20221201:Binding", name, args ?? new BindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20221201:Binding", name, null, MakeResourceOptions(options, id))
        {
        }
