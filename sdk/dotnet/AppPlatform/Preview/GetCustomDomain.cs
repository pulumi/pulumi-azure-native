...
namespace Pulumi.AzureRM.AppPlatform.Preview
{
    public static class GetCustomDomain
    {
        public static Task<GetCustomDomainResult> InvokeAsync(GetCustomDomainArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCustomDomainResult>("azurerm:appplatform/preview:getCustomDomain", args ?? new GetCustomDomainArgs(), options.WithVersion());
    }
