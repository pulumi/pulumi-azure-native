...
namespace Pulumi.AzureRM.AppPlatform.Preview
{
    public static class ListServiceTestKeys
    {
        public static Task<ListServiceTestKeysResult> InvokeAsync(ListServiceTestKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListServiceTestKeysResult>("azurerm:appplatform/preview:listServiceTestKeys", args ?? new ListServiceTestKeysArgs(), options.WithVersion());
    }
