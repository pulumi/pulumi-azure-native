...
namespace Pulumi.AzureRM.AppPlatform.Preview
{
    public static class GetBinding
    {
        public static Task<GetBindingResult> InvokeAsync(GetBindingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBindingResult>("azurerm:appplatform/preview:getBinding", args ?? new GetBindingArgs(), options.WithVersion());
    }
