...
namespace Pulumi.AzureNative.AppPlatform.V20210303Preview
{
    public static class GetDeployment
    {
        ...
        public static Task<GetDeploymentResult> InvokeAsync(GetDeploymentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentResult>("azure-native:appplatform/v20210303preview:getDeployment", args ?? new GetDeploymentArgs(), options.WithVersion());
    }
