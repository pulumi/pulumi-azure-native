...
namespace Pulumi.AzureNative.AppPlatform.V20210303Preview
{
    /// <summary>
    /// App resource payload
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20210303preview:App")]
    public partial class App : Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210303preview:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210303preview:App", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:appplatform/v20210303preview:App"},
