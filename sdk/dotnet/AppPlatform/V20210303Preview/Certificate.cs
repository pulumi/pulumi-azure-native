...
namespace Pulumi.AzureNative.AppPlatform.V20210303Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20210303preview:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210303preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210303preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
