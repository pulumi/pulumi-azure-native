...
namespace Pulumi.AzureNative.AppPlatform.V20210303Preview
{
    public static class GetBinding
    {
        ...
        public static Task<GetBindingResult> InvokeAsync(GetBindingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBindingResult>("azure-native:appplatform/v20210303preview:getBinding", args ?? new GetBindingArgs(), options.WithVersion());
    }
