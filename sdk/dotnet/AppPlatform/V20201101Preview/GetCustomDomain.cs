...
namespace Pulumi.AzureNative.AppPlatform.V20201101Preview
{
    public static class GetCustomDomain
    {
        ...
        public static Output<GetCustomDomainResult> Invoke(GetCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCustomDomainResult>("azure-native:appplatform/v20201101preview:getCustomDomain", args ?? new GetCustomDomainInvokeArgs(), options.WithVersion());
    }
