...
namespace Pulumi.AzureNextGen.AppPlatform.V20201101Preview
{
    public static class GetAppResourceUploadUrl
    {
        public static Task<GetAppResourceUploadUrlResult> InvokeAsync(GetAppResourceUploadUrlArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAppResourceUploadUrlResult>("azure-nextgen:appplatform/v20201101preview:getAppResourceUploadUrl", args ?? new GetAppResourceUploadUrlArgs(), options.WithVersion());
    }
