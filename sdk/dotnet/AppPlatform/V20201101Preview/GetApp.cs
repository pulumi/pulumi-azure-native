...
{
    [Obsolete(@"azure-native:appplatform/v20201101preview:App is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:App to guarantee forwards compatibility.")]
    public static class GetApp
    {
        ...
        public static Task<GetAppResult> InvokeAsync(GetAppArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppResult>("azure-native:appplatform/v20201101preview:getApp", args ?? new GetAppArgs(), options.WithDefaults());

        /// <summary>
        /// Get an App and its properties.
        /// </summary>
        public static Output<GetAppResult> Invoke(GetAppInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppResult>("azure-native:appplatform/v20201101preview:getApp", args ?? new GetAppInvokeArgs(), options.WithDefaults());
    }
