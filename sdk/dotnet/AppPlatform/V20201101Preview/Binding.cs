...
namespace Pulumi.AzureNextGen.AppPlatform.V20201101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:appplatform/v20201101preview:Binding")]
    public partial class Binding : Pulumi.CustomResource
    {
        ...
        public Binding(string name, BindingArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:appplatform/v20201101preview:Binding", name, args ?? new BindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:appplatform/v20201101preview:Binding", name, null, MakeResourceOptions(options, id))
        {
        }
