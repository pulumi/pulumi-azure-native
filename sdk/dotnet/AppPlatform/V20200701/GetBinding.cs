...
namespace Pulumi.AzureNative.AppPlatform.V20200701
{
    public static class GetBinding
    {
        ...
        public static Task<GetBindingResult> InvokeAsync(GetBindingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBindingResult>("azure-native:appplatform/v20200701:getBinding", args ?? new GetBindingArgs(), options.WithVersion());

        /// <summary>
        /// Binding resource payload
        /// </summary>
        public static Output<GetBindingResult> Invoke(GetBindingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBindingResult>("azure-native:appplatform/v20200701:getBinding", args ?? new GetBindingInvokeArgs(), options.WithVersion());
    }
