...
namespace Pulumi.AzureNative.AppPlatform.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20240501preview:ApplicationLiveView")]
    public partial class ApplicationLiveView : global::Pulumi.CustomResource
    {
        ...
        public ApplicationLiveView(string name, ApplicationLiveViewArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240501preview:ApplicationLiveView", name, args ?? new ApplicationLiveViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationLiveView(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240501preview:ApplicationLiveView", name, null, MakeResourceOptions(options, id))
        {
        }
