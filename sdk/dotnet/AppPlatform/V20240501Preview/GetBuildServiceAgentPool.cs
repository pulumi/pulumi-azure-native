...
namespace Pulumi.AzureNative.AppPlatform.V20240501Preview
{
    public static class GetBuildServiceAgentPool
    {
        ...
        public static Task<GetBuildServiceAgentPoolResult> InvokeAsync(GetBuildServiceAgentPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBuildServiceAgentPoolResult>("azure-native:appplatform/v20240501preview:getBuildServiceAgentPool", args ?? new GetBuildServiceAgentPoolArgs(), options.WithDefaults());
