...
namespace Pulumi.AzureNative.AppPlatform.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20240501preview:ContainerRegistry")]
    public partial class ContainerRegistry : global::Pulumi.CustomResource
    {
        ...
        public ContainerRegistry(string name, ContainerRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240501preview:ContainerRegistry", name, args ?? new ContainerRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240501preview:ContainerRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
