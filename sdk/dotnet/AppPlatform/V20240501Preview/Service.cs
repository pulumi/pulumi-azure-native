...
namespace Pulumi.AzureNative.AppPlatform.V20240501Preview
{
    ...
    /// Service resource
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20240501preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240501preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240501preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
