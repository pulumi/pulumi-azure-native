...
namespace Pulumi.AzureNative.AppPlatform.V20240501Preview
{
    public static class GetApplicationAccelerator
    {
        ...
        public static Task<GetApplicationAcceleratorResult> InvokeAsync(GetApplicationAcceleratorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApplicationAcceleratorResult>("azure-native:appplatform/v20240501preview:getApplicationAccelerator", args ?? new GetApplicationAcceleratorArgs(), options.WithDefaults());
        ...
        public static Output<GetApplicationAcceleratorResult> Invoke(GetApplicationAcceleratorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApplicationAcceleratorResult>("azure-native:appplatform/v20240501preview:getApplicationAccelerator", args ?? new GetApplicationAcceleratorInvokeArgs(), options.WithDefaults());
