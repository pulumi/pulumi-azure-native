...
namespace Pulumi.AzureNative.AppPlatform.V20240501Preview
{
    public static class ListServiceGloballyEnabledApms
    {
        ...
        public static Task<ListServiceGloballyEnabledApmsResult> InvokeAsync(ListServiceGloballyEnabledApmsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListServiceGloballyEnabledApmsResult>("azure-native:appplatform/v20240501preview:listServiceGloballyEnabledApms", args ?? new ListServiceGloballyEnabledApmsArgs(), options.WithDefaults());
