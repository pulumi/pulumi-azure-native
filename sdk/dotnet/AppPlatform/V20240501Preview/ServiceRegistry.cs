...
namespace Pulumi.AzureNative.AppPlatform.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20240501preview:ServiceRegistry")]
    public partial class ServiceRegistry : global::Pulumi.CustomResource
    {
        ...
        public ServiceRegistry(string name, ServiceRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240501preview:ServiceRegistry", name, args ?? new ServiceRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240501preview:ServiceRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
