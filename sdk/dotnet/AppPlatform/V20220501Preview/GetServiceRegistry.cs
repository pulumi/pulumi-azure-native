...
namespace Pulumi.AzureNative.AppPlatform.V20220501Preview
{
    public static class GetServiceRegistry
    {
        ...
        public static Task<GetServiceRegistryResult> InvokeAsync(GetServiceRegistryArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceRegistryResult>("azure-native:appplatform/v20220501preview:getServiceRegistry", args ?? new GetServiceRegistryArgs(), options.WithDefaults());

        /// <summary>
        /// Service Registry resource
        /// </summary>
        public static Output<GetServiceRegistryResult> Invoke(GetServiceRegistryInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceRegistryResult>("azure-native:appplatform/v20220501preview:getServiceRegistry", args ?? new GetServiceRegistryInvokeArgs(), options.WithDefaults());
    }
