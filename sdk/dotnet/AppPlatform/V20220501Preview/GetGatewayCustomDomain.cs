...
namespace Pulumi.AzureNative.AppPlatform.V20220501Preview
{
    public static class GetGatewayCustomDomain
    {
        ...
        public static Task<GetGatewayCustomDomainResult> InvokeAsync(GetGatewayCustomDomainArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGatewayCustomDomainResult>("azure-native:appplatform/v20220501preview:getGatewayCustomDomain", args ?? new GetGatewayCustomDomainArgs(), options.WithDefaults());
        ...
        public static Output<GetGatewayCustomDomainResult> Invoke(GetGatewayCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGatewayCustomDomainResult>("azure-native:appplatform/v20220501preview:getGatewayCustomDomain", args ?? new GetGatewayCustomDomainInvokeArgs(), options.WithDefaults());
    }
