...
namespace Pulumi.AzureNative.AppPlatform.V20220501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20220501preview:CustomDomain")]
    public partial class CustomDomain : global::Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220501preview:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220501preview:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
