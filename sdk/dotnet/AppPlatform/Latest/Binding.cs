...
namespace Pulumi.AzureRM.AppPlatform.Latest
{
    ...
    public partial class Binding : Pulumi.CustomResource
    {
        ...
        public Binding(string name, BindingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:appplatform/latest:Binding", name, args ?? new BindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:appplatform/latest:Binding", name, null, MakeResourceOptions(options, id))
        {
        }
