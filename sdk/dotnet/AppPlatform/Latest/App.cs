...
namespace Pulumi.AzureRM.AppPlatform.Latest
{
    ...
    public partial class App : Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azurerm:appplatform/latest:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:appplatform/latest:App", name, null, MakeResourceOptions(options, id))
        {
        }
