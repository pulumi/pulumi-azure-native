...
namespace Pulumi.AzureNative.AppPlatform.V20210901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20210901preview:CustomDomain")]
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210901preview:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210901preview:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
