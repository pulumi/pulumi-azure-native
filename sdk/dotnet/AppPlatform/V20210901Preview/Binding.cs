...
namespace Pulumi.AzureNative.AppPlatform.V20210901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:appplatform/v20210901preview:Binding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Binding to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:appplatform/v20210901preview:Binding")]
    public partial class Binding : global::Pulumi.CustomResource
    {
        ...
        public Binding(string name, BindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210901preview:Binding", name, args ?? new BindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210901preview:Binding", name, null, MakeResourceOptions(options, id))
        {
        }
