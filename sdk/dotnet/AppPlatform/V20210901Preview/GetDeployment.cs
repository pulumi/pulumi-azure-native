...
namespace Pulumi.AzureNative.AppPlatform.V20210901Preview
{
    public static class GetDeployment
    {
        ...
        public static Task<GetDeploymentResult> InvokeAsync(GetDeploymentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentResult>("azure-native:appplatform/v20210901preview:getDeployment", args ?? new GetDeploymentArgs(), options.WithVersion());

        /// <summary>
        /// Deployment resource payload
        /// </summary>
        public static Output<GetDeploymentResult> Invoke(GetDeploymentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDeploymentResult>("azure-native:appplatform/v20210901preview:getDeployment", args ?? new GetDeploymentInvokeArgs(), options.WithVersion());
    }
