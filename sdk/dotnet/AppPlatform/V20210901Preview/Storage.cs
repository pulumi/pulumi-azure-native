...
namespace Pulumi.AzureNative.AppPlatform.V20210901Preview
{
    ...
    /// {
    ///     var storage = new AzureNative.AppPlatform.V20210901Preview.Storage("storage", new()
    ///     {
    ///         Properties = new AzureNative.AppPlatform.V20210901Preview.Inputs.StorageAccountArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20210901preview:Storage")]
    public partial class Storage : global::Pulumi.CustomResource
    {
        ...
        public Storage(string name, StorageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210901preview:Storage", name, args ?? new StorageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Storage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210901preview:Storage", name, null, MakeResourceOptions(options, id))
        {
        }
