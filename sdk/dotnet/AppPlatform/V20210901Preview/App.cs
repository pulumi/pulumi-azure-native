...
namespace Pulumi.AzureNative.AppPlatform.V20210901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:appplatform/v20210901preview:App is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:App to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:appplatform/v20210901preview:App")]
    public partial class App : global::Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210901preview:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210901preview:App", name, null, MakeResourceOptions(options, id))
        {
        }
