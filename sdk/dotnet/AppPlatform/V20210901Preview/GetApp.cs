...
namespace Pulumi.AzureNative.AppPlatform.V20210901Preview
{
    public static class GetApp
    {
        ...
        public static Task<GetAppResult> InvokeAsync(GetAppArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppResult>("azure-native:appplatform/v20210901preview:getApp", args ?? new GetAppArgs(), options.WithDefaults());

        /// <summary>
        /// Get an App and its properties.
        /// </summary>
        public static Output<GetAppResult> Invoke(GetAppInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppResult>("azure-native:appplatform/v20210901preview:getApp", args ?? new GetAppInvokeArgs(), options.WithDefaults());
