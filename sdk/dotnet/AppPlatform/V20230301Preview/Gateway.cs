...
namespace Pulumi.AzureNative.AppPlatform.V20230301Preview
{
    ...
    /// {
    ///     var gateway = new AzureNative.AppPlatform.V20230301Preview.Gateway("gateway", new()
    ///     {
    ///         GatewayName = "default",
    ///         Properties = new AzureNative.AppPlatform.V20230301Preview.Inputs.GatewayPropertiesArgs
    ///         {
    ///             Public = true,
    ///             ResourceRequests = new AzureNative.AppPlatform.V20230301Preview.Inputs.GatewayResourceRequestsArgs
    ///             {
    ///                 Cpu = "1",
    ///                 Memory = "1G",
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230301preview:Gateway")]
    public partial class Gateway : global::Pulumi.CustomResource
    {
        ...
        public Gateway(string name, GatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:Gateway", name, args ?? new GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:Gateway", name, null, MakeResourceOptions(options, id))
        {
        }
