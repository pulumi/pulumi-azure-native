...
namespace Pulumi.AzureNative.AppPlatform.V20230301Preview
{
    ...
    /// {
    ///     var certificate = new AzureNative.AppPlatform.V20230301Preview.Certificate("certificate", new()
    ///     {
    ///         CertificateName = "mycertificate",
    ///         Properties = new AzureNative.AppPlatform.V20230301Preview.Inputs.KeyVaultCertificatePropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230301preview:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
