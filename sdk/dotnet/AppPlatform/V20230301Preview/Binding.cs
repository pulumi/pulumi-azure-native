...
namespace Pulumi.AzureNative.AppPlatform.V20230301Preview
{
    ...
    /// {
    ///     var binding = new AzureNative.AppPlatform.V20230301Preview.Binding("binding", new()
    ///     {
    ///         AppName = "myapp",
    ///         BindingName = "mybinding",
    ///         Properties = new AzureNative.AppPlatform.V20230301Preview.Inputs.BindingResourcePropertiesArgs
    ///         {
    ///             BindingParameters = 
    ///             {
    ///                 { "apiType", "SQL" },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:appplatform/v20230301preview:Binding mybinding /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.AppPlatform/Spring/myservice/apps/myapp/bindings/mybinding 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230301preview:Binding")]
    public partial class Binding : global::Pulumi.CustomResource
    {
        ...
        public Binding(string name, BindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:Binding", name, args ?? new BindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:Binding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20220901preview:Binding"},
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20221101preview:Binding"},
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20221201:Binding"},
                    new global::Pulumi.Alias { Type = "azure-native:appplatform/v20230101preview:Binding"},
                },
            };
