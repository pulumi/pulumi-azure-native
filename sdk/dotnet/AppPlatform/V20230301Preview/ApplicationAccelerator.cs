...
namespace Pulumi.AzureNative.AppPlatform.V20230301Preview
{
    ...
    public partial class ApplicationAccelerator : global::Pulumi.CustomResource
    {
        ...
        public ApplicationAccelerator(string name, ApplicationAcceleratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:ApplicationAccelerator", name, args ?? new ApplicationAcceleratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationAccelerator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:ApplicationAccelerator", name, null, MakeResourceOptions(options, id))
        {
        }
