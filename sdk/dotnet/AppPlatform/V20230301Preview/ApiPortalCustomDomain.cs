...
namespace Pulumi.AzureNative.AppPlatform.V20230301Preview
{
    ...
    /// {
    ///     var apiPortalCustomDomain = new AzureNative.AppPlatform.V20230301Preview.ApiPortalCustomDomain("apiPortalCustomDomain", new()
    ///     {
    ///         ApiPortalName = "default",
    ///         DomainName = "myDomainName",
    ///         Properties = new AzureNative.AppPlatform.V20230301Preview.Inputs.ApiPortalCustomDomainPropertiesArgs
    ///         {
    ///             Thumbprint = "*",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230301preview:ApiPortalCustomDomain")]
    public partial class ApiPortalCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public ApiPortalCustomDomain(string name, ApiPortalCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:ApiPortalCustomDomain", name, args ?? new ApiPortalCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiPortalCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:ApiPortalCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
