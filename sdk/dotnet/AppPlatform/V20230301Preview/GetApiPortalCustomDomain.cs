...
namespace Pulumi.AzureNative.AppPlatform.V20230301Preview
{
    public static class GetApiPortalCustomDomain
    {
        ...
        public static Task<GetApiPortalCustomDomainResult> InvokeAsync(GetApiPortalCustomDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiPortalCustomDomainResult>("azure-native:appplatform/v20230301preview:getApiPortalCustomDomain", args ?? new GetApiPortalCustomDomainArgs(), options.WithDefaults());
        ...
        public static Output<GetApiPortalCustomDomainResult> Invoke(GetApiPortalCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiPortalCustomDomainResult>("azure-native:appplatform/v20230301preview:getApiPortalCustomDomain", args ?? new GetApiPortalCustomDomainInvokeArgs(), options.WithDefaults());
    }
