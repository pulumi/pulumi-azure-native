...
namespace Pulumi.AzureNative.AppPlatform.V20230301Preview
{
    ...
    /// {
    ///     var monitoringSetting = new AzureNative.AppPlatform.V20230301Preview.MonitoringSetting("monitoringSetting", new()
    ///     {
    ///         Properties = new AzureNative.AppPlatform.V20230301Preview.Inputs.MonitoringSettingPropertiesArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:appplatform/v20230301preview:MonitoringSetting default /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.AppPlatform/Spring/myservice/monitoringSettings/default 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230301preview:MonitoringSetting")]
    public partial class MonitoringSetting : global::Pulumi.CustomResource
    {
        ...
        public MonitoringSetting(string name, MonitoringSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:MonitoringSetting", name, args ?? new MonitoringSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:MonitoringSetting", name, null, MakeResourceOptions(options, id))
        {
        }
