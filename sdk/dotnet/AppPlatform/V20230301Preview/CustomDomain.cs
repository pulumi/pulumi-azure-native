...
namespace Pulumi.AzureNative.AppPlatform.V20230301Preview
{
    ...
    /// {
    ///     var customDomain = new AzureNative.AppPlatform.V20230301Preview.CustomDomain("customDomain", new()
    ///     {
    ///         AppName = "myapp",
    ///         DomainName = "mydomain.com",
    ///         Properties = new AzureNative.AppPlatform.V20230301Preview.Inputs.CustomDomainPropertiesArgs
    ///         {
    ///             CertName = "mycert",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230301preview:CustomDomain")]
    public partial class CustomDomain : global::Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230301preview:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
