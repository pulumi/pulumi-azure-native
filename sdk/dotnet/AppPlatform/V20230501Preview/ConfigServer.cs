...
namespace Pulumi.AzureNative.AppPlatform.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230501preview:ConfigServer")]
    public partial class ConfigServer : global::Pulumi.CustomResource
    {
        ...
        public ConfigServer(string name, ConfigServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:ConfigServer", name, args ?? new ConfigServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:ConfigServer", name, null, MakeResourceOptions(options, id))
        {
        }
