...
namespace Pulumi.AzureNative.AppPlatform.V20230501Preview
{
    public static class GetApiPortal
    {
        ...
        public static Task<GetApiPortalResult> InvokeAsync(GetApiPortalArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiPortalResult>("azure-native:appplatform/v20230501preview:getApiPortal", args ?? new GetApiPortalArgs(), options.WithDefaults());

        /// <summary>
        /// Get the API portal and its properties.
        /// </summary>
        public static Output<GetApiPortalResult> Invoke(GetApiPortalInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiPortalResult>("azure-native:appplatform/v20230501preview:getApiPortal", args ?? new GetApiPortalInvokeArgs(), options.WithDefaults());
