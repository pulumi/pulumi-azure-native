...
namespace Pulumi.AzureNative.AppPlatform.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230501preview:Storage")]
    public partial class Storage : global::Pulumi.CustomResource
    {
        ...
        public Storage(string name, StorageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:Storage", name, args ?? new StorageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Storage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:Storage", name, null, MakeResourceOptions(options, id))
        {
        }
