...
namespace Pulumi.AzureNative.AppPlatform.V20230501Preview
{
    public static class GetContainerRegistry
    {
        ...
        public static Task<GetContainerRegistryResult> InvokeAsync(GetContainerRegistryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContainerRegistryResult>("azure-native:appplatform/v20230501preview:getContainerRegistry", args ?? new GetContainerRegistryArgs(), options.WithDefaults());

        /// <summary>
        /// Get the container registries resource.
        /// </summary>
        public static Output<GetContainerRegistryResult> Invoke(GetContainerRegistryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContainerRegistryResult>("azure-native:appplatform/v20230501preview:getContainerRegistry", args ?? new GetContainerRegistryInvokeArgs(), options.WithDefaults());
