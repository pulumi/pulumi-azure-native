...
namespace Pulumi.AzureNative.AppPlatform.V20230501Preview
{
    ...
    /// API portal resource
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230501preview:ApiPortal")]
    public partial class ApiPortal : global::Pulumi.CustomResource
    {
        ...
        public ApiPortal(string name, ApiPortalArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:ApiPortal", name, args ?? new ApiPortalArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiPortal(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:ApiPortal", name, null, MakeResourceOptions(options, id))
        {
        }
