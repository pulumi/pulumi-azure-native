...
namespace Pulumi.AzureNative.AppPlatform.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230501preview:ApiPortalCustomDomain")]
    public partial class ApiPortalCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public ApiPortalCustomDomain(string name, ApiPortalCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:ApiPortalCustomDomain", name, args ?? new ApiPortalCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiPortalCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:ApiPortalCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
