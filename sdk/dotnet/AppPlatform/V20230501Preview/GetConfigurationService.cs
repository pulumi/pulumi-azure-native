...
namespace Pulumi.AzureNative.AppPlatform.V20230501Preview
{
    public static class GetConfigurationService
    {
        ...
        public static Task<GetConfigurationServiceResult> InvokeAsync(GetConfigurationServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationServiceResult>("azure-native:appplatform/v20230501preview:getConfigurationService", args ?? new GetConfigurationServiceArgs(), options.WithDefaults());
        ...
        public static Output<GetConfigurationServiceResult> Invoke(GetConfigurationServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConfigurationServiceResult>("azure-native:appplatform/v20230501preview:getConfigurationService", args ?? new GetConfigurationServiceInvokeArgs(), options.WithDefaults());
    }
