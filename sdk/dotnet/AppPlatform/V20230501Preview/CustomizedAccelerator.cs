...
namespace Pulumi.AzureNative.AppPlatform.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20230501preview:CustomizedAccelerator")]
    public partial class CustomizedAccelerator : global::Pulumi.CustomResource
    {
        ...
        public CustomizedAccelerator(string name, CustomizedAcceleratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:CustomizedAccelerator", name, args ?? new CustomizedAcceleratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomizedAccelerator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20230501preview:CustomizedAccelerator", name, null, MakeResourceOptions(options, id))
        {
        }
