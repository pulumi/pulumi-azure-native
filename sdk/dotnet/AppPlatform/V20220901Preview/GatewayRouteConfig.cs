...
namespace Pulumi.AzureNative.AppPlatform.V20220901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20220901preview:GatewayRouteConfig")]
    public partial class GatewayRouteConfig : global::Pulumi.CustomResource
    {
        ...
        public GatewayRouteConfig(string name, GatewayRouteConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220901preview:GatewayRouteConfig", name, args ?? new GatewayRouteConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayRouteConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220901preview:GatewayRouteConfig", name, null, MakeResourceOptions(options, id))
        {
        }
