...
namespace Pulumi.AzureNative.AppPlatform.V20220901Preview
{
    ...
    [AzureNativeResourceType("azure-native:appplatform/v20220901preview:Binding")]
    public partial class Binding : global::Pulumi.CustomResource
    {
        ...
        public Binding(string name, BindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220901preview:Binding", name, args ?? new BindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Binding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220901preview:Binding", name, null, MakeResourceOptions(options, id))
        {
        }
