...
{
    [Obsolete(@"azure-native:appplatform/v20220901preview:BuildpackBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:BuildpackBinding to guarantee forwards compatibility.")]
    public static class GetBuildpackBinding
    {
        ...
        public static Task<GetBuildpackBindingResult> InvokeAsync(GetBuildpackBindingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBuildpackBindingResult>("azure-native:appplatform/v20220901preview:getBuildpackBinding", args ?? new GetBuildpackBindingArgs(), options.WithDefaults());

        /// <summary>
        /// Get a buildpack binding by name.
        /// </summary>
        public static Output<GetBuildpackBindingResult> Invoke(GetBuildpackBindingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBuildpackBindingResult>("azure-native:appplatform/v20220901preview:getBuildpackBinding", args ?? new GetBuildpackBindingInvokeArgs(), options.WithDefaults());
    }
