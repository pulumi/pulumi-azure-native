...
{
    [Obsolete(@"azure-native:appplatform/v20220901preview:Binding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Binding to guarantee forwards compatibility.")]
    public static class GetBinding
    {
        ...
        public static Task<GetBindingResult> InvokeAsync(GetBindingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBindingResult>("azure-native:appplatform/v20220901preview:getBinding", args ?? new GetBindingArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Binding and its properties.
        /// </summary>
        public static Output<GetBindingResult> Invoke(GetBindingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBindingResult>("azure-native:appplatform/v20220901preview:getBinding", args ?? new GetBindingInvokeArgs(), options.WithDefaults());
    }
