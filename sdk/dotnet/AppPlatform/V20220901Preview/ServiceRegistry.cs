...
namespace Pulumi.AzureNative.AppPlatform.V20220901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:appplatform/v20220901preview:ServiceRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ServiceRegistry to guarantee forwards compatibility.")]
    ...
    public partial class ServiceRegistry : global::Pulumi.CustomResource
    {
        ...
        public ServiceRegistry(string name, ServiceRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220901preview:ServiceRegistry", name, args ?? new ServiceRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220901preview:ServiceRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
