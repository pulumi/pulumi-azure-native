...
{
    [Obsolete(@"azure-native:appplatform/v20220901preview:GatewayRouteConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:GatewayRouteConfig to guarantee forwards compatibility.")]
    public static class GetGatewayRouteConfig
    {
        ...
        public static Task<GetGatewayRouteConfigResult> InvokeAsync(GetGatewayRouteConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewayRouteConfigResult>("azure-native:appplatform/v20220901preview:getGatewayRouteConfig", args ?? new GetGatewayRouteConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Get the Spring Cloud Gateway route configs.
        /// </summary>
        public static Output<GetGatewayRouteConfigResult> Invoke(GetGatewayRouteConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGatewayRouteConfigResult>("azure-native:appplatform/v20220901preview:getGatewayRouteConfig", args ?? new GetGatewayRouteConfigInvokeArgs(), options.WithDefaults());
    }
