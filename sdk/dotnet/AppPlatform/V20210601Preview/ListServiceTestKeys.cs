...
namespace Pulumi.AzureNative.AppPlatform.V20210601Preview
{
    public static class ListServiceTestKeys
    {
        ...
        public static Task<ListServiceTestKeysResult> InvokeAsync(ListServiceTestKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListServiceTestKeysResult>("azure-native:appplatform/v20210601preview:listServiceTestKeys", args ?? new ListServiceTestKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Test keys payload
        /// </summary>
        public static Output<ListServiceTestKeysResult> Invoke(ListServiceTestKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListServiceTestKeysResult>("azure-native:appplatform/v20210601preview:listServiceTestKeys", args ?? new ListServiceTestKeysInvokeArgs(), options.WithDefaults());
    }
