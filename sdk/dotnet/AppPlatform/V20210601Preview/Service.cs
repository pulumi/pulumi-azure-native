...
namespace Pulumi.AzureNative.AppPlatform.V20210601Preview
{
    ...
    /// Service resource
    /// </summary>
    [Obsolete(@"azure-native:appplatform/v20210601preview:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Service to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:appplatform/v20210601preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210601preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20210601preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
