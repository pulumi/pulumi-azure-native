...
namespace Pulumi.AzureNative.AppPlatform.V20210601Preview
{
    public static class GetCustomDomain
    {
        ...
        public static Task<GetCustomDomainResult> InvokeAsync(GetCustomDomainArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCustomDomainResult>("azure-native:appplatform/v20210601preview:getCustomDomain", args ?? new GetCustomDomainArgs(), options.WithVersion());

        /// <summary>
        /// Custom domain resource payload.
        /// </summary>
        public static Output<GetCustomDomainResult> Invoke(GetCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCustomDomainResult>("azure-native:appplatform/v20210601preview:getCustomDomain", args ?? new GetCustomDomainInvokeArgs(), options.WithVersion());
    }
