...
namespace Pulumi.AzureNative.AppPlatform.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20240101preview:ConfigurationService")]
    public partial class ConfigurationService : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationService(string name, ConfigurationServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240101preview:ConfigurationService", name, args ?? new ConfigurationServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240101preview:ConfigurationService", name, null, MakeResourceOptions(options, id))
        {
        }
