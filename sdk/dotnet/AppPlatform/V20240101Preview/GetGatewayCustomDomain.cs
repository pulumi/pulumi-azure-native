...
namespace Pulumi.AzureNative.AppPlatform.V20240101Preview
{
    public static class GetGatewayCustomDomain
    {
        ...
        public static Task<GetGatewayCustomDomainResult> InvokeAsync(GetGatewayCustomDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewayCustomDomainResult>("azure-native:appplatform/v20240101preview:getGatewayCustomDomain", args ?? new GetGatewayCustomDomainArgs(), options.WithDefaults());
        ...
        public static Output<GetGatewayCustomDomainResult> Invoke(GetGatewayCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGatewayCustomDomainResult>("azure-native:appplatform/v20240101preview:getGatewayCustomDomain", args ?? new GetGatewayCustomDomainInvokeArgs(), options.WithDefaults());
    }
