...
namespace Pulumi.AzureNative.AppPlatform.V20240101Preview.Inputs
{
    ...
    public sealed class GatewayPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("apmTypes")]
        private InputList<Union<string, Pulumi.AzureNative.AppPlatform.V20240101Preview.ApmType>>? _apmTypes;

        /// <summary>
        /// Collection of APM type used in Spring Cloud Gateway
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AppPlatform.V20240101Preview.ApmType>> ApmTypes
        {
            get => _apmTypes ?? (_apmTypes = new InputList<Union<string, Pulumi.AzureNative.AppPlatform.V20240101Preview.ApmType>>());
            set => _apmTypes = value;
        }
