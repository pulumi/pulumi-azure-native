...
namespace Pulumi.AzureNative.AppPlatform.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20240101preview:BuildServiceBuild")]
    public partial class BuildServiceBuild : global::Pulumi.CustomResource
    {
        ...
        public BuildServiceBuild(string name, BuildServiceBuildArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240101preview:BuildServiceBuild", name, args ?? new BuildServiceBuildArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BuildServiceBuild(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20240101preview:BuildServiceBuild", name, null, MakeResourceOptions(options, id))
        {
        }
