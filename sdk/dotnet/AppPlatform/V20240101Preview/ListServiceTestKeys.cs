...
namespace Pulumi.AzureNative.AppPlatform.V20240101Preview
{
    public static class ListServiceTestKeys
    {
        ...
        public static Task<ListServiceTestKeysResult> InvokeAsync(ListServiceTestKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListServiceTestKeysResult>("azure-native:appplatform/v20240101preview:listServiceTestKeys", args ?? new ListServiceTestKeysArgs(), options.WithDefaults());
