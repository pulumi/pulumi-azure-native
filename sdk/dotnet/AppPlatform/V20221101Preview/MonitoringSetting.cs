...
namespace Pulumi.AzureNative.AppPlatform.V20221101Preview
{
    ...
    [AzureNativeResourceType("azure-native:appplatform/v20221101preview:MonitoringSetting")]
    public partial class MonitoringSetting : global::Pulumi.CustomResource
    {
        ...
        public MonitoringSetting(string name, MonitoringSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20221101preview:MonitoringSetting", name, args ?? new MonitoringSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20221101preview:MonitoringSetting", name, null, MakeResourceOptions(options, id))
        {
        }
