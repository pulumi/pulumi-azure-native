...
namespace Pulumi.AzureNative.AppPlatform.V20221101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:appplatform/v20221101preview:Deployment is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:Deployment to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:appplatform/v20221101preview:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20221101preview:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20221101preview:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
