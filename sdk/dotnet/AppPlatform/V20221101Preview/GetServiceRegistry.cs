...
{
    [Obsolete(@"azure-native:appplatform/v20221101preview:ServiceRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ServiceRegistry to guarantee forwards compatibility.")]
    public static class GetServiceRegistry
    {
        ...
        public static Task<GetServiceRegistryResult> InvokeAsync(GetServiceRegistryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServiceRegistryResult>("azure-native:appplatform/v20221101preview:getServiceRegistry", args ?? new GetServiceRegistryArgs(), options.WithDefaults());

        /// <summary>
        /// Get the Service Registry and its properties.
        /// </summary>
        public static Output<GetServiceRegistryResult> Invoke(GetServiceRegistryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServiceRegistryResult>("azure-native:appplatform/v20221101preview:getServiceRegistry", args ?? new GetServiceRegistryInvokeArgs(), options.WithDefaults());
    }
