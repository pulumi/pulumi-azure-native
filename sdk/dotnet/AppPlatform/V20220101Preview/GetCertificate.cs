...
namespace Pulumi.AzureNative.AppPlatform.V20220101Preview
{
    public static class GetCertificate
    {
        ...
        public static Task<GetCertificateResult> InvokeAsync(GetCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCertificateResult>("azure-native:appplatform/v20220101preview:getCertificate", args ?? new GetCertificateArgs(), options.WithVersion());

        /// <summary>
        /// Certificate resource payload.
        /// </summary>
        public static Output<GetCertificateResult> Invoke(GetCertificateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCertificateResult>("azure-native:appplatform/v20220101preview:getCertificate", args ?? new GetCertificateInvokeArgs(), options.WithVersion());
    }
