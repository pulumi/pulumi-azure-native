...
namespace Pulumi.AzureNative.AppPlatform.V20220101Preview
{
    ...
    /// {
    ///     var gateway = new AzureNative.AppPlatform.V20220101Preview.Gateway("gateway", new()
    ///     {
    ///         GatewayName = "default",
    ///         Properties = new AzureNative.AppPlatform.V20220101Preview.Inputs.GatewayPropertiesArgs
    ///         {
    ///             Public = true,
    ///             ResourceRequests = new AzureNative.AppPlatform.V20220101Preview.Inputs.GatewayResourceRequestsArgs
    ///             {
    ///                 Cpu = "1",
    ///                 Memory = "1G",
    ///             },
    ...
    ///         Sku = new AzureNative.AppPlatform.V20220101Preview.Inputs.SkuArgs
    ///         {
    ///             Capacity = 2,
    ///             Name = "E0",
    ///             Tier = "Enterprise",
