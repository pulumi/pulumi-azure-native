...
namespace Pulumi.AzureNative.AppPlatform.V20220101Preview
{
    public static class GetStorage
    {
        ...
        public static Task<GetStorageResult> InvokeAsync(GetStorageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageResult>("azure-native:appplatform/v20220101preview:getStorage", args ?? new GetStorageArgs(), options.WithDefaults());

        /// <summary>
        /// Storage resource payload.
        /// </summary>
        public static Output<GetStorageResult> Invoke(GetStorageInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStorageResult>("azure-native:appplatform/v20220101preview:getStorage", args ?? new GetStorageInvokeArgs(), options.WithDefaults());
    }
