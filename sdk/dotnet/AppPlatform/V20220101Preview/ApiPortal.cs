...
namespace Pulumi.AzureNative.AppPlatform.V20220101Preview
{
    ...
    /// {
    ///     var apiPortal = new AzureNative.AppPlatform.V20220101Preview.ApiPortal("apiPortal", new()
    ///     {
    ///         ApiPortalName = "default",
    ///         Properties = new AzureNative.AppPlatform.V20220101Preview.Inputs.ApiPortalPropertiesArgs
    ///         {
    ///             GatewayIds = new[]
    ///             {
    ...
    public partial class ApiPortal : global::Pulumi.CustomResource
    {
        ...
        public ApiPortal(string name, ApiPortalArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:ApiPortal", name, args ?? new ApiPortalArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiPortal(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:ApiPortal", name, null, MakeResourceOptions(options, id))
        {
        }
