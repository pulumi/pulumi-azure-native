...
namespace Pulumi.AzureNative.AppPlatform.V20220101Preview
{
    ...
    /// {
    ///     var apiPortalCustomDomain = new AzureNative.AppPlatform.V20220101Preview.ApiPortalCustomDomain("apiPortalCustomDomain", new()
    ///     {
    ///         ApiPortalName = "default",
    ///         DomainName = "myDomainName",
    ///         Properties = new AzureNative.AppPlatform.V20220101Preview.Inputs.ApiPortalCustomDomainPropertiesArgs
    ///         {
    ///             Thumbprint = "*",
    ///         },
    ...
    public partial class ApiPortalCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public ApiPortalCustomDomain(string name, ApiPortalCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:ApiPortalCustomDomain", name, args ?? new ApiPortalCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiPortalCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:ApiPortalCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
