...
namespace Pulumi.AzureNative.AppPlatform.V20220101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20220101preview:App")]
    public partial class App : Pulumi.CustomResource
    {
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:App", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:appplatform/v20210601preview:App"},
                    new Pulumi.Alias { Type = "azure-native:appplatform/v20210901preview:App"},
                    new Pulumi.Alias { Type = "azure-native:appplatform/v20220301preview:App"},
                    new Pulumi.Alias { Type = "azure-native:appplatform/v20220401:App"},
                    new Pulumi.Alias { Type = "azure-native:appplatform/v20220501preview:App"},
                },
            };
