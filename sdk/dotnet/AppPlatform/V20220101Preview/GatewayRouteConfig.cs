...
namespace Pulumi.AzureNative.AppPlatform.V20220101Preview
{
    ...
    /// {
    ///     var gatewayRouteConfig = new AzureNative.AppPlatform.V20220101Preview.GatewayRouteConfig("gatewayRouteConfig", new()
    ///     {
    ///         GatewayName = "default",
    ///         Properties = new AzureNative.AppPlatform.V20220101Preview.Inputs.GatewayRouteConfigPropertiesArgs
    ///         {
    ...
    ///             Routes = new[]
    ///             {
    ///                 new AzureNative.AppPlatform.V20220101Preview.Inputs.GatewayApiRouteArgs
    ///                 {
    ///                     Filters = new[]
    ///                     {
    ///                         "StripPrefix=2",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20220101preview:GatewayRouteConfig")]
    public partial class GatewayRouteConfig : global::Pulumi.CustomResource
    {
        ...
        public GatewayRouteConfig(string name, GatewayRouteConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:GatewayRouteConfig", name, args ?? new GatewayRouteConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayRouteConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:GatewayRouteConfig", name, null, MakeResourceOptions(options, id))
        {
        }
