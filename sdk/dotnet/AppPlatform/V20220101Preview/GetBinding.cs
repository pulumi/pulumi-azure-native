...
namespace Pulumi.AzureNative.AppPlatform.V20220101Preview
{
    public static class GetBinding
    {
        ...
        public static Task<GetBindingResult> InvokeAsync(GetBindingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBindingResult>("azure-native:appplatform/v20220101preview:getBinding", args ?? new GetBindingArgs(), options.WithDefaults());

        /// <summary>
        /// Binding resource payload
        /// </summary>
        public static Output<GetBindingResult> Invoke(GetBindingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBindingResult>("azure-native:appplatform/v20220101preview:getBinding", args ?? new GetBindingInvokeArgs(), options.WithDefaults());
    }
