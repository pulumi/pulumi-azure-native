...
namespace Pulumi.AzureNative.AppPlatform.V20220101Preview
{
    ...
    /// {
    ///     var configurationService = new AzureNative.AppPlatform.V20220101Preview.ConfigurationService("configurationService", new()
    ///     {
    ///         ConfigurationServiceName = "default",
    ///         Properties = new AzureNative.AppPlatform.V20220101Preview.Inputs.ConfigurationServicePropertiesArgs
    ///         {
    ///             Settings = new AzureNative.AppPlatform.V20220101Preview.Inputs.ConfigurationServiceSettingsArgs
    ///             {
    ///                 GitProperty = new AzureNative.AppPlatform.V20220101Preview.Inputs.ConfigurationServiceGitPropertyArgs
    ///                 {
    ///                     Repositories = new[]
    ///                     {
    ///                         new AzureNative.AppPlatform.V20220101Preview.Inputs.ConfigurationServiceGitRepositoryArgs
    ///                         {
    ///                             Label = "master",
    ///                             Name = "fake",
    ///                             Patterns = new[]
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:appplatform/v20220101preview:ConfigurationService default /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.AppPlatform/Spring/myservice/configurationServices/default 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appplatform/v20220101preview:ConfigurationService")]
    public partial class ConfigurationService : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationService(string name, ConfigurationServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:ConfigurationService", name, args ?? new ConfigurationServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appplatform/v20220101preview:ConfigurationService", name, null, MakeResourceOptions(options, id))
        {
        }
