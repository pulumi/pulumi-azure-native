...
namespace Pulumi.AzureNative.ServiceFabric.V20210501
{
    public static class GetManagedCluster
    {
        ...
        public static Task<GetManagedClusterResult> InvokeAsync(GetManagedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedClusterResult>("azure-native:servicefabric/v20210501:getManagedCluster", args ?? new GetManagedClusterArgs(), options.WithVersion());

        /// <summary>
        /// The manged cluster resource
        /// </summary>
        public static Output<GetManagedClusterResult> Invoke(GetManagedClusterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetManagedClusterResult>("azure-native:servicefabric/v20210501:getManagedCluster", args ?? new GetManagedClusterInvokeArgs(), options.WithVersion());
    }
