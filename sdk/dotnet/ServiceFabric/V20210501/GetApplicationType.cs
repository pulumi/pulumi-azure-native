...
namespace Pulumi.AzureNative.ServiceFabric.V20210501
{
    public static class GetApplicationType
    {
        ...
        public static Task<GetApplicationTypeResult> InvokeAsync(GetApplicationTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationTypeResult>("azure-native:servicefabric/v20210501:getApplicationType", args ?? new GetApplicationTypeArgs(), options.WithVersion());

        /// <summary>
        /// The application type name resource
        /// </summary>
        public static Output<GetApplicationTypeResult> Invoke(GetApplicationTypeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationTypeResult>("azure-native:servicefabric/v20210501:getApplicationType", args ?? new GetApplicationTypeInvokeArgs(), options.WithVersion());
    }
