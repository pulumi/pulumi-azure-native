...
namespace Pulumi.AzureNative.ServiceFabric.V20210501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20210501:ManagedClusterApplicationType")]
    public partial class ManagedClusterApplicationType : global::Pulumi.CustomResource
    {
        ...
        public ManagedClusterApplicationType(string name, ManagedClusterApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210501:ManagedClusterApplicationType", name, args ?? new ManagedClusterApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedClusterApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210501:ManagedClusterApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
