...
namespace Pulumi.AzureNative.ServiceFabric.V20210501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20210501:NodeType")]
    public partial class NodeType : global::Pulumi.CustomResource
    {
        ...
        public NodeType(string name, NodeTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210501:NodeType", name, args ?? new NodeTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210501:NodeType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NodeTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210501.DiskType>? DataDiskType { get; set; }
