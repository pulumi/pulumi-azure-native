...
namespace Pulumi.AzureNative.ServiceFabric.V20210501
{
    ...
    [AzureNativeResourceType("azure-native:servicefabric/v20210501:ApplicationType")]
    public partial class ApplicationType : global::Pulumi.CustomResource
    {
        ...
        public ApplicationType(string name, ApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210501:ApplicationType", name, args ?? new ApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210501:ApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
