...
namespace Pulumi.AzureNative.ServiceFabric.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20231201preview:NodeType")]
    public partial class NodeType : global::Pulumi.CustomResource
    {
        ...
        public NodeType(string name, NodeTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20231201preview:NodeType", name, args ?? new NodeTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20231201preview:NodeType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NodeTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20231201Preview.DiskType>? DataDiskType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20231201Preview.EvictionPolicyType>? EvictionPolicy { get; set; }
        ...
        /// </summary>
        [Input("securityType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20231201Preview.SecurityType>? SecurityType { get; set; }
        ...
        private InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20231201Preview.VmSetupAction>>? _vmSetupActions;

        /// <summary>
        /// Specifies the actions to be performed on the vms before bootstrapping the service fabric runtime.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20231201Preview.VmSetupAction>> VmSetupActions
        {
            get => _vmSetupActions ?? (_vmSetupActions = new InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20231201Preview.VmSetupAction>>());
