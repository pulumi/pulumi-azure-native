...
namespace Pulumi.AzureNative.ServiceFabric.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20220101:Service")]
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220101:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220101:Service", name, null, MakeResourceOptions(options, id))
        {
        }
