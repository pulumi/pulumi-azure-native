...
namespace Pulumi.AzureNative.ServiceFabric.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20220101:Application")]
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220101:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220101:Application", name, null, MakeResourceOptions(options, id))
        {
        }
