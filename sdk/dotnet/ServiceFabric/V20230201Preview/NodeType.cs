...
namespace Pulumi.AzureNative.ServiceFabric.V20230201Preview
{
    ...
    /// {
    ///     var nodeType = new AzureNative.ServiceFabric.V20230201Preview.NodeType("nodeType", new()
    ///     {
    ///         Capacities = 
    ///         {
    ...
    ///         VmExtensions = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20230201Preview.Inputs.VMSSExtensionArgs
    ///             {
    ...
    ///         VmInstanceCount = -1,
    ///         VmManagedIdentity = new AzureNative.ServiceFabric.V20230201Preview.Inputs.VmManagedIdentityArgs
    ///         {
    ...
    ///         VmSecrets = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20230201Preview.Inputs.VaultSecretGroupArgs
    ///             {
    ///                 SourceVault = new AzureNative.ServiceFabric.V20230201Preview.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resRg/providers/Microsoft.KeyVault/vaults/myVault",
    ///                 },
    ///                 VaultCertificates = new[]
    ///                 {
    ///                     new AzureNative.ServiceFabric.V20230201Preview.Inputs.VaultCertificateArgs
    ///                     {
    ///                         CertificateStore = "My",
    ...
    ///         {
    ///             new AzureNative.ServiceFabric.V20230201Preview.Inputs.VmssDataDiskArgs
    ///             {
    ///                 DiskLetter = "F",
    ///                 DiskSizeGB = 256,
    ...
    ///         {
    ///             new AzureNative.ServiceFabric.V20230201Preview.Inputs.FrontendConfigurationArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:servicefabric/v20230201preview:NodeType BE /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/resRg/providers/Microsoft.ServiceFabric/managedClusters/myCluster/nodeTypes/BE 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20230201preview:NodeType")]
    public partial class NodeType : global::Pulumi.CustomResource
    {
        ...
        public NodeType(string name, NodeTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20230201preview:NodeType", name, args ?? new NodeTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20230201preview:NodeType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NodeTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20230201Preview.DiskType>? DataDiskType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20230201Preview.EvictionPolicyType>? EvictionPolicy { get; set; }
        ...
        /// </summary>
        [Input("securityType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20230201Preview.SecurityType>? SecurityType { get; set; }
        ...
        private InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20230201Preview.VmSetupAction>>? _vmSetupActions;

        /// <summary>
        /// Specifies the actions to be performed on the vms before bootstrapping the service fabric runtime.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20230201Preview.VmSetupAction>> VmSetupActions
        {
            get => _vmSetupActions ?? (_vmSetupActions = new InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20230201Preview.VmSetupAction>>());
