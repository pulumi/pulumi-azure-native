...
namespace Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview
{
    public static class GetNodeType
    {
        ...
        public static Task<GetNodeTypeResult> InvokeAsync(GetNodeTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNodeTypeResult>("azure-native:servicefabric/v20210901privatepreview:getNodeType", args ?? new GetNodeTypeArgs(), options.WithVersion());

        /// <summary>
        /// Describes a node type in the cluster, each node type represents sub set of nodes in the cluster.
        /// </summary>
        public static Output<GetNodeTypeResult> Invoke(GetNodeTypeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNodeTypeResult>("azure-native:servicefabric/v20210901privatepreview:getNodeType", args ?? new GetNodeTypeInvokeArgs(), options.WithVersion());
    }
