...
namespace Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview
{
    ...
    /// {
    ///     var nodeType = new AzureNative.ServiceFabric.V20210901PrivatePreview.NodeType("nodeType", new()
    ///     {
    ///         Capacities = 
    ///         {
    ...
    ///         VmExtensions = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20210901PrivatePreview.Inputs.VMSSExtensionArgs
    ///             {
    ...
    ///         VmInstanceCount = -1,
    ///         VmManagedIdentity = new AzureNative.ServiceFabric.V20210901PrivatePreview.Inputs.VmManagedIdentityArgs
    ///         {
    ...
    ///         VmSecrets = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20210901PrivatePreview.Inputs.VaultSecretGroupArgs
    ///             {
    ///                 SourceVault = new AzureNative.ServiceFabric.V20210901PrivatePreview.Inputs.SubResourceArgs
    ///                 {
    ///                     Id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resRg/providers/Microsoft.KeyVault/vaults/myVault",
    ///                 },
    ///                 VaultCertificates = new[]
    ///                 {
    ///                     new AzureNative.ServiceFabric.V20210901PrivatePreview.Inputs.VaultCertificateArgs
    ///                     {
    ///                         CertificateStore = "My",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20210901privatepreview:NodeType")]
    public partial class NodeType : global::Pulumi.CustomResource
    {
        ...
        public NodeType(string name, NodeTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210901privatepreview:NodeType", name, args ?? new NodeTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210901privatepreview:NodeType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NodeTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview.DiskType>? DataDiskType { get; set; }
