...
namespace Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview.Inputs
{
    ...
    /// </summary>
    public sealed class ServiceLoadMetricArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("weight")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview.ServiceLoadMetricWeight>? Weight { get; set; }
