...
namespace Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview.Inputs
{
    ...
    public sealed class StatefulServicePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview.MoveCost>? DefaultMoveCost { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview.ServicePackageActivationMode>? ServicePackageActivationMode { get; set; }
