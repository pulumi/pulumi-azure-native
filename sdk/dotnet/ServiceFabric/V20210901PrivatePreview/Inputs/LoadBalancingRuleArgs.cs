...
namespace Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview.ProbeProtocol> ProbeProtocol { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210901PrivatePreview.Protocol> Protocol { get; set; } = null!;
