...
namespace Pulumi.AzureNative.ServiceFabric.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:servicefabric/v20220801preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:NodeType to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:servicefabric/v20220801preview:NodeType")]
    public partial class NodeType : global::Pulumi.CustomResource
    {
        ...
        public NodeType(string name, NodeTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220801preview:NodeType", name, args ?? new NodeTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220801preview:NodeType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NodeTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20220801Preview.DiskType>? DataDiskType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20220801Preview.EvictionPolicyType>? EvictionPolicy { get; set; }
