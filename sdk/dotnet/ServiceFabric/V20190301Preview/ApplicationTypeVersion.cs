...
namespace Pulumi.AzureRM.ServiceFabric.V20190301Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationTypeVersion = new AzureRM.ServiceFabric.V20190301Preview.ApplicationTypeVersion("applicationTypeVersion", new AzureRM.ServiceFabric.V20190301Preview.ApplicationTypeVersionArgs
    ///         {
    ...
    public partial class ApplicationTypeVersion : Pulumi.CustomResource
    {
        ...
        public ApplicationTypeVersion(string name, ApplicationTypeVersionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190301preview:ApplicationTypeVersion", name, args ?? new ApplicationTypeVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationTypeVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190301preview:ApplicationTypeVersion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicefabric/latest:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20170701preview:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20190301:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20190601preview:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20191101preview:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20200301:ApplicationTypeVersion"},
                },
            };
