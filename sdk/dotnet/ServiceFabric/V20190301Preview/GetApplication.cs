...
namespace Pulumi.AzureRM.ServiceFabric.V20190301Preview
{
    public static class GetApplication
    {
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("azurerm:servicefabric/v20190301preview:getApplication", args ?? new GetApplicationArgs(), options.WithVersion());
    }
