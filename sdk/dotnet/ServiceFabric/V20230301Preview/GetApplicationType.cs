...
namespace Pulumi.AzureNative.ServiceFabric.V20230301Preview
{
    public static class GetApplicationType
    {
        ...
        public static Task<GetApplicationTypeResult> InvokeAsync(GetApplicationTypeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApplicationTypeResult>("azure-native:servicefabric/v20230301preview:getApplicationType", args ?? new GetApplicationTypeArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Service Fabric application type name resource created or in the process of being created in the Service Fabric managed cluster resource.
        /// </summary>
        public static Output<GetApplicationTypeResult> Invoke(GetApplicationTypeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApplicationTypeResult>("azure-native:servicefabric/v20230301preview:getApplicationType", args ?? new GetApplicationTypeInvokeArgs(), options.WithDefaults());
    }
