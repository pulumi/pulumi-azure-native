...
namespace Pulumi.AzureNative.ServiceFabric.V20190301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20190301:ApplicationType")]
    public partial class ApplicationType : Pulumi.CustomResource
    {
        ...
        public ApplicationType(string name, ApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20190301:ApplicationType", name, args ?? new ApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20190301:ApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
