...
namespace Pulumi.AzureRM.ServiceFabric.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var service = new AzureRM.ServiceFabric.V20190301.Service("service", new AzureRM.ServiceFabric.V20190301.ServiceArgs
    ///         {
    ///             ApplicationName = "myApp",
    ///             ClusterName = "myCluster",
    ///             CorrelationScheme = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20190301.Inputs.ServiceCorrelationDescriptionArgs
    ///                 {
    ///                     Scheme = "Affinity",
    ...
    ///             Location = "eastus",
    ///             PartitionDescription = new AzureRM.ServiceFabric.V20190301.Inputs.PartitionSchemeDescriptionArgs
    ///             {
    ...
    ///             ServiceLoadMetrics = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20190301.Inputs.ServiceLoadMetricDescriptionArgs
    ///                 {
    ///                     Name = "metric1",
    ///                     Weight = "Low",
    ///                 },
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190301:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190301:Service", name, null, MakeResourceOptions(options, id))
        {
        }
