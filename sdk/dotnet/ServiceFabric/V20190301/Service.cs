...
namespace Pulumi.AzureNextGen.ServiceFabric.V20190301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicefabric/v20190301:Service")]
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicefabric/v20190301:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicefabric/v20190301:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ServiceFabric.V20190301.MoveCost>? DefaultMoveCost { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ServiceFabric.V20190301.ServiceKind> ServiceKind { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ServiceFabric.V20190301.ArmServicePackageActivationMode>? ServicePackageActivationMode { get; set; }
