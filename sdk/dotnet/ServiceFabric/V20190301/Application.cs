...
namespace Pulumi.AzureRM.ServiceFabric.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var application = new AzureRM.ServiceFabric.V20190301.Application("application", new AzureRM.ServiceFabric.V20190301.ApplicationArgs
    ///         {
    ...
    ///             Metrics = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20190301.Inputs.ApplicationMetricDescriptionArgs
    ///                 {
    ///                     MaximumCapacity = 3,
    ///                     Name = "metric1",
    ...
    ///             TypeName = "myAppType",
    ///             TypeVersion = "1.0",
    ///             UpgradePolicy = new AzureRM.ServiceFabric.V20190301.Inputs.ApplicationUpgradePolicyArgs
    ///             {
    ///                 ApplicationHealthPolicy = new AzureRM.ServiceFabric.V20190301.Inputs.ArmApplicationHealthPolicyArgs
    ///                 {
    ///                     ConsiderWarningAsError = true,
    ///                     DefaultServiceTypeHealthPolicy = new AzureRM.ServiceFabric.V20190301.Inputs.ArmServiceTypeHealthPolicyArgs
    ///                     {
    ...
    ///                 },
    ///                 ForceRestart = false,
    ///                 RollingUpgradeMonitoringPolicy = new AzureRM.ServiceFabric.V20190301.Inputs.ArmRollingUpgradeMonitoringPolicyArgs
    ///                 {
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190301:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190301:Application", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20191101preview:Application"},
