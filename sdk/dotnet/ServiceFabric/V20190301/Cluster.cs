...
namespace Pulumi.AzureNative.ServiceFabric.V20190301
{
    ...
    [AzureNativeResourceType("azure-native:servicefabric/v20190301:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20190301:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20190301:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
