...
namespace Pulumi.AzureNative.ServiceFabric.V20190301
{
    ...
    public static class GetApplication
    {
        ...
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("azure-native:servicefabric/v20190301:getApplication", args ?? new GetApplicationArgs(), options.WithDefaults());

        /// <summary>
        /// The application resource.
        /// </summary>
        public static Output<GetApplicationResult> Invoke(GetApplicationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationResult>("azure-native:servicefabric/v20190301:getApplication", args ?? new GetApplicationInvokeArgs(), options.WithDefaults());
    }
