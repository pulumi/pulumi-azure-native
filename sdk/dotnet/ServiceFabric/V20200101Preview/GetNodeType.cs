...
namespace Pulumi.AzureNative.ServiceFabric.V20200101Preview
{
    public static class GetNodeType
    {
        ...
        public static Output<GetNodeTypeResult> Invoke(GetNodeTypeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNodeTypeResult>("azure-native:servicefabric/v20200101preview:getNodeType", args ?? new GetNodeTypeInvokeArgs(), options.WithVersion());
    }
