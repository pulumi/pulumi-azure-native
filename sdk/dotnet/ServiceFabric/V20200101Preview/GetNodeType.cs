...
namespace Pulumi.AzureNative.ServiceFabric.V20200101Preview
{
    public static class GetNodeType
    {
        ...
        public static Task<GetNodeTypeResult> InvokeAsync(GetNodeTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNodeTypeResult>("azure-native:servicefabric/v20200101preview:getNodeType", args ?? new GetNodeTypeArgs(), options.WithDefaults());

        /// <summary>
        /// Describes a node type in the cluster, each node type represents sub set of nodes in the cluster.
        /// </summary>
        public static Output<GetNodeTypeResult> Invoke(GetNodeTypeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNodeTypeResult>("azure-native:servicefabric/v20200101preview:getNodeType", args ?? new GetNodeTypeInvokeArgs(), options.WithDefaults());
    }
