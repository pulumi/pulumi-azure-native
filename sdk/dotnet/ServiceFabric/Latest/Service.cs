...
namespace Pulumi.AzureRM.ServiceFabric.Latest
{
    ...
    ///             PartitionDescription = new AzureRM.ServiceFabric.Latest.Inputs.PartitionSchemeDescriptionArgs
    ///             {
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/latest:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/latest:Service", name, null, MakeResourceOptions(options, id))
        {
        }
