...
namespace Pulumi.AzureRM.ServiceFabric.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedCluster = new AzureRM.ServiceFabric.Latest.ManagedCluster("managedCluster", new AzureRM.ServiceFabric.Latest.ManagedClusterArgs
    ///         {
    ...
    ///             ClusterUpgradeDescription = new AzureRM.ServiceFabric.Latest.Inputs.ClusterUpgradePolicyArgs
    ///             {
    ...
    ///             LoadBalancingRules = 
    ///             {
    ///                 new AzureRM.ServiceFabric.Latest.Inputs.LoadBalancingRuleArgs
    ///                 {
    ///                     BackendPort = 80,
    ///                     FrontendPort = 80,
    ///                     ProbeProtocol = "http",
    ...
    ///             Sku = new AzureRM.ServiceFabric.Latest.Inputs.SkuArgs
    ///             {
    ///                 Name = "Basic",
    ///             },
    ///             Tags = ,
    ...
    public partial class ManagedCluster : Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/latest:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/latest:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20200101preview:ManagedCluster"},
                },
            };
