...
namespace Pulumi.AzureNative.ServiceFabric.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:servicefabric:ApplicationTypeVersion'.")]
    [AzureNativeResourceType("azure-native:servicefabric/latest:ApplicationTypeVersion")]
    public partial class ApplicationTypeVersion : Pulumi.CustomResource
    {
        ...
        public ApplicationTypeVersion(string name, ApplicationTypeVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/latest:ApplicationTypeVersion", name, args ?? new ApplicationTypeVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationTypeVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/latest:ApplicationTypeVersion", name, null, MakeResourceOptions(options, id))
        {
        }
