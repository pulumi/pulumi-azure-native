...
namespace Pulumi.AzureRM.ServiceFabric.Latest
{
    ...
    public partial class ApplicationTypeVersion : Pulumi.CustomResource
    {
        ...
        public ApplicationTypeVersion(string name, ApplicationTypeVersionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/latest:ApplicationTypeVersion", name, args ?? new ApplicationTypeVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationTypeVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/latest:ApplicationTypeVersion", name, null, MakeResourceOptions(options, id))
        {
        }
