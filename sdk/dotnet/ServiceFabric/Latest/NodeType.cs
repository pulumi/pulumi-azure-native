...
namespace Pulumi.AzureRM.ServiceFabric.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var nodeType = new AzureRM.ServiceFabric.Latest.NodeType("nodeType", new AzureRM.ServiceFabric.Latest.NodeTypeArgs
    ///         {
    ///             Capacities = 
    ///             {
    ...
    ///             VmExtensions = 
    ///             {
    ///                 new AzureRM.ServiceFabric.Latest.Inputs.VMSSExtensionArgs
    ///                 {
    ...
    ///             VmSecrets = 
    ///             {
    ///                 new AzureRM.ServiceFabric.Latest.Inputs.VaultSecretGroupArgs
    ///                 {
    ///                     SourceVault = new AzureRM.ServiceFabric.Latest.Inputs.SubResourceArgs
    ///                     {
    ///                         Id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resRg/providers/Microsoft.KeyVault/vaults/myVault",
    ///                     },
    ///                     VaultCertificates = 
    ///                     {
    ///                         new AzureRM.ServiceFabric.Latest.Inputs.VaultCertificateArgs
    ///                         {
    ///                             CertificateStore = "My",
    ...
    public partial class NodeType : Pulumi.CustomResource
    {
        ...
        public NodeType(string name, NodeTypeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/latest:NodeType", name, args ?? new NodeTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/latest:NodeType", name, null, MakeResourceOptions(options, id))
        {
        }
