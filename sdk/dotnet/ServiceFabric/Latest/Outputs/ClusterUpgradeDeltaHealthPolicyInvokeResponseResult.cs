...
namespace Pulumi.AzureNextGen.ServiceFabric.Latest.Outputs
{
    ...
    [OutputType]
    public sealed class ClusterUpgradeDeltaHealthPolicyInvokeResponseResult
    {
        /// <summary>
        /// Defines the application delta health policy map used to evaluate the health of an application or one of its child entities when upgrading the cluster.
        /// </summary>
        public readonly ImmutableDictionary<string, Outputs.ApplicationDeltaHealthPolicyInvokeResponseResult>? ApplicationDeltaHealthPolicies;
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterUpgradeDeltaHealthPolicyInvokeResponseResult(
            ImmutableDictionary<string, Outputs.ApplicationDeltaHealthPolicyInvokeResponseResult>? applicationDeltaHealthPolicies,
