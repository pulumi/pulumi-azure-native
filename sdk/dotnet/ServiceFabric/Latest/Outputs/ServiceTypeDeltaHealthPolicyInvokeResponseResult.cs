...
namespace Pulumi.AzureNextGen.ServiceFabric.Latest.Outputs
{
    ...
    [OutputType]
    public sealed class ServiceTypeDeltaHealthPolicyInvokeResponseResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServiceTypeDeltaHealthPolicyInvokeResponseResult(int? maxPercentDeltaUnhealthyServices)
        {
