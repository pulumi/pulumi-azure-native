...
namespace Pulumi.AzureRM.ServiceFabric.Latest
{
    public static class GetManagedCluster
    {
        public static Task<GetManagedClusterResult> InvokeAsync(GetManagedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedClusterResult>("azurerm:servicefabric/latest:getManagedCluster", args ?? new GetManagedClusterArgs(), options.WithVersion());
    }
