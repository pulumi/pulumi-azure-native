...
namespace Pulumi.AzureRM.ServiceFabric.V20200301
{
    public static class GetApplication
    {
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("azurerm:servicefabric/v20200301:getApplication", args ?? new GetApplicationArgs(), options.WithVersion());
    }
