...
namespace Pulumi.AzureNative.ServiceFabric.V20200301
{
    ...
    /// {
    ///     var service = new AzureNative.ServiceFabric.V20200301.Service("service", new()
    ///     {
    ///         ApplicationName = "myApp",
    ///         ClusterName = "myCluster",
    ///         CorrelationScheme = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20200301.Inputs.ServiceCorrelationDescriptionArgs
    ///             {
    ///                 Scheme = "Affinity",
    ...
    ///         PartitionDescription = new AzureNative.ServiceFabric.V20200301.Inputs.SingletonPartitionSchemeDescriptionArgs
    ///         {
    ...
    ///         {
    ///             new AzureNative.ServiceFabric.V20200301.Inputs.ServiceLoadMetricDescriptionArgs
    ///             {
    ///                 Name = "metric1",
    ///                 Weight = "Low",
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20200301:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20200301:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20200301:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20200301.MoveCost>? DefaultMoveCost { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20200301.ServiceKind> ServiceKind { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20200301.ArmServicePackageActivationMode>? ServicePackageActivationMode { get; set; }
