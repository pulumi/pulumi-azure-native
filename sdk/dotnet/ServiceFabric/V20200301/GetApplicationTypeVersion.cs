...
namespace Pulumi.AzureNative.ServiceFabric.V20200301
{
    public static class GetApplicationTypeVersion
    {
        ...
        public static Task<GetApplicationTypeVersionResult> InvokeAsync(GetApplicationTypeVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationTypeVersionResult>("azure-native:servicefabric/v20200301:getApplicationTypeVersion", args ?? new GetApplicationTypeVersionArgs(), options.WithVersion());
        ...
        public static Output<GetApplicationTypeVersionResult> Invoke(GetApplicationTypeVersionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationTypeVersionResult>("azure-native:servicefabric/v20200301:getApplicationTypeVersion", args ?? new GetApplicationTypeVersionInvokeArgs(), options.WithVersion());
    }
