...
namespace Pulumi.AzureRM.ServiceFabric.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var application = new AzureRM.ServiceFabric.V20200301.Application("application", new AzureRM.ServiceFabric.V20200301.ApplicationArgs
    ///         {
    ...
    ///             Metrics = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20200301.Inputs.ApplicationMetricDescriptionArgs
    ///                 {
    ///                     MaximumCapacity = 3,
    ///                     Name = "metric1",
    ...
    ///             TypeName = "myAppType",
    ///             TypeVersion = "1.0",
    ///             UpgradePolicy = new AzureRM.ServiceFabric.V20200301.Inputs.ApplicationUpgradePolicyArgs
    ///             {
    ///                 ApplicationHealthPolicy = new AzureRM.ServiceFabric.V20200301.Inputs.ArmApplicationHealthPolicyArgs
    ///                 {
    ///                     ConsiderWarningAsError = true,
    ///                     DefaultServiceTypeHealthPolicy = new AzureRM.ServiceFabric.V20200301.Inputs.ArmServiceTypeHealthPolicyArgs
    ///                     {
    ...
    ///                 },
    ///                 ForceRestart = false,
    ///                 RollingUpgradeMonitoringPolicy = new AzureRM.ServiceFabric.V20200301.Inputs.ArmRollingUpgradeMonitoringPolicyArgs
    ///                 {
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20200301:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20200301:Application", name, null, MakeResourceOptions(options, id))
        {
        }
