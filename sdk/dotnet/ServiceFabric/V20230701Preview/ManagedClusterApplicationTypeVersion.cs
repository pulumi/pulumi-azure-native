...
namespace Pulumi.AzureNative.ServiceFabric.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20230701preview:ManagedClusterApplicationTypeVersion")]
    public partial class ManagedClusterApplicationTypeVersion : global::Pulumi.CustomResource
    {
        ...
        public ManagedClusterApplicationTypeVersion(string name, ManagedClusterApplicationTypeVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20230701preview:ManagedClusterApplicationTypeVersion", name, args ?? new ManagedClusterApplicationTypeVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedClusterApplicationTypeVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20230701preview:ManagedClusterApplicationTypeVersion", name, null, MakeResourceOptions(options, id))
        {
        }
