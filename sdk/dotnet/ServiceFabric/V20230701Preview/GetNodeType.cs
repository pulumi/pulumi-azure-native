...
namespace Pulumi.AzureNative.ServiceFabric.V20230701Preview
{
    public static class GetNodeType
    {
        ...
        public static Task<GetNodeTypeResult> InvokeAsync(GetNodeTypeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNodeTypeResult>("azure-native:servicefabric/v20230701preview:getNodeType", args ?? new GetNodeTypeArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Service Fabric node type of a given managed cluster.
        /// </summary>
        public static Output<GetNodeTypeResult> Invoke(GetNodeTypeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNodeTypeResult>("azure-native:servicefabric/v20230701preview:getNodeType", args ?? new GetNodeTypeInvokeArgs(), options.WithDefaults());
    }
