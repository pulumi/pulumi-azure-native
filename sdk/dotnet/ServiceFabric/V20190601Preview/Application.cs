...
namespace Pulumi.AzureRM.ServiceFabric.V20190601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var application = new AzureRM.ServiceFabric.V20190601Preview.Application("application", new AzureRM.ServiceFabric.V20190601Preview.ApplicationArgs
    ///         {
    ...
    ///             Metrics = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20190601Preview.Inputs.ApplicationMetricDescriptionArgs
    ///                 {
    ///                     MaximumCapacity = 3,
    ///                     Name = "metric1",
    ...
    ///             TypeName = "myAppType",
    ///             TypeVersion = "1.0",
    ///             UpgradePolicy = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ApplicationUpgradePolicyArgs
    ///             {
    ///                 ApplicationHealthPolicy = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ArmApplicationHealthPolicyArgs
    ///                 {
    ///                     ConsiderWarningAsError = true,
    ///                     DefaultServiceTypeHealthPolicy = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ArmServiceTypeHealthPolicyArgs
    ///                     {
    ...
    ///                 },
    ///                 ForceRestart = false,
    ///                 RollingUpgradeMonitoringPolicy = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ArmRollingUpgradeMonitoringPolicyArgs
    ///                 {
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190601preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190601preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
