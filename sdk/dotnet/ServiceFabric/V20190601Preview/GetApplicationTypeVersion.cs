...
namespace Pulumi.AzureRM.ServiceFabric.V20190601Preview
{
    public static class GetApplicationTypeVersion
    {
        public static Task<GetApplicationTypeVersionResult> InvokeAsync(GetApplicationTypeVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationTypeVersionResult>("azurerm:servicefabric/v20190601preview:getApplicationTypeVersion", args ?? new GetApplicationTypeVersionArgs(), options.WithVersion());
    }
