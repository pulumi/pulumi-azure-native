...
namespace Pulumi.AzureRM.ServiceFabric.V20190601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationTypeVersion = new AzureRM.ServiceFabric.V20190601Preview.ApplicationTypeVersion("applicationTypeVersion", new AzureRM.ServiceFabric.V20190601Preview.ApplicationTypeVersionArgs
    ///         {
    ...
    public partial class ApplicationTypeVersion : Pulumi.CustomResource
    {
        ...
        public ApplicationTypeVersion(string name, ApplicationTypeVersionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190601preview:ApplicationTypeVersion", name, args ?? new ApplicationTypeVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationTypeVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190601preview:ApplicationTypeVersion", name, null, MakeResourceOptions(options, id))
        {
        }
