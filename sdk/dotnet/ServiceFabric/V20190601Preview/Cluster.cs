...
namespace Pulumi.AzureRM.ServiceFabric.V20190601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cluster = new AzureRM.ServiceFabric.V20190601Preview.Cluster("cluster", new AzureRM.ServiceFabric.V20190601Preview.ClusterArgs
    ///         {
    ///             AddOnFeatures = 
    ///             {
    ///                 "RepairManager",
    ...
    ///             },
    ///             AzureActiveDirectory = new AzureRM.ServiceFabric.V20190601Preview.Inputs.AzureActiveDirectoryArgs
    ///             {
    ...
    ///             },
    ///             CertificateCommonNames = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ServerCertificateCommonNamesArgs
    ///             {
    ///                 CommonNames = 
    ///                 {
    ///                     new AzureRM.ServiceFabric.V20190601Preview.Inputs.ServerCertificateCommonNameArgs
    ///                     {
    ...
    ///             {
    ///                 new AzureRM.ServiceFabric.V20190601Preview.Inputs.ClientCertificateCommonNameArgs
    ///                 {
    ///                     CertificateCommonName = "abc.com",
    ...
    ///             {
    ///                 new AzureRM.ServiceFabric.V20190601Preview.Inputs.ClientCertificateThumbprintArgs
    ///                 {
    ...
    ///             DiagnosticsStorageAccountConfig = new AzureRM.ServiceFabric.V20190601Preview.Inputs.DiagnosticsStorageAccountConfigArgs
    ///             {
    ...
    ///             FabricSettings = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20190601Preview.Inputs.SettingsSectionDescriptionArgs
    ///                 {
    ///                     Name = "UpgradeService",
    ///                     Parameters = 
    ///                     {
    ///                         new AzureRM.ServiceFabric.V20190601Preview.Inputs.SettingsParameterDescriptionArgs
    ///                         {
    ...
    ///             NodeTypes = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20190601Preview.Inputs.NodeTypeDescriptionArgs
    ///                 {
    ///                     ApplicationPorts = new AzureRM.ServiceFabric.V20190601Preview.Inputs.EndpointRangeDescriptionArgs
    ///                     {
    ///                         EndPort = 30000,
    ///                         StartPort = 20000,
    ///                     },
    ...
    ///                     EphemeralPorts = new AzureRM.ServiceFabric.V20190601Preview.Inputs.EndpointRangeDescriptionArgs
    ///                     {
    ///                         EndPort = 64000,
    ///                         StartPort = 49000,
    ///                     },
    ...
    ///             ReverseProxyCertificateCommonNames = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ServerCertificateCommonNamesArgs
    ///             {
    ///                 CommonNames = 
    ///                 {
    ///                     new AzureRM.ServiceFabric.V20190601Preview.Inputs.ServerCertificateCommonNameArgs
    ...
    ///             },
    ///             Tags = ,
    ///             UpgradeDescription = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ClusterUpgradePolicyArgs
    ///             {
    ///                 DeltaHealthPolicy = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ClusterUpgradeDeltaHealthPolicyArgs
    ///                 {
    ///                     ApplicationDeltaHealthPolicies = 
    ///                     {
    ///                         { "fabric:/myApp1", new AzureRM.ServiceFabric.V20190601Preview.Inputs.ApplicationDeltaHealthPolicyArgs
    ///                         {
    ///                             DefaultServiceTypeDeltaHealthPolicy = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ServiceTypeDeltaHealthPolicyArgs
    ///                             {
    ///                                 MaxPercentDeltaUnhealthyServices = 0,
    ///                             },
    ///                             ServiceTypeDeltaHealthPolicies = 
    ///                             {
    ///                                 { "myServiceType1", new AzureRM.ServiceFabric.V20190601Preview.Inputs.ServiceTypeDeltaHealthPolicyArgs
    ///                                 {
    ///                                     MaxPercentDeltaUnhealthyServices = 0,
    ///                                 } },
    ///                             },
    ...
    ///                 HealthPolicy = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ClusterHealthPolicyArgs
    ///                 {
    ///                     ApplicationHealthPolicies = 
    ///                     {
    ///                         { "fabric:/myApp1", new AzureRM.ServiceFabric.V20190601Preview.Inputs.ApplicationHealthPolicyArgs
    ///                         {
    ///                             DefaultServiceTypeHealthPolicy = new AzureRM.ServiceFabric.V20190601Preview.Inputs.ServiceTypeHealthPolicyArgs
    ///                             {
    ///                                 MaxPercentUnhealthyServices = 0,
    ///                             },
    ///                             ServiceTypeHealthPolicies = 
    ///                             {
    ///                                 { "myServiceType1", new AzureRM.ServiceFabric.V20190601Preview.Inputs.ServiceTypeHealthPolicyArgs
    ///                                 {
    ...
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190601preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20190601preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
