...
namespace Pulumi.AzureNative.ServiceFabric.V20220601Preview.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20220601Preview.ProbeProtocol> ProbeProtocol { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20220601Preview.Protocol> Protocol { get; set; } = null!;
