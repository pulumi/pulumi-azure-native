...
namespace Pulumi.AzureNative.ServiceFabric.V20220601Preview
{
    ...
    [AzureNativeResourceType("azure-native:servicefabric/v20220601preview:ApplicationType")]
    public partial class ApplicationType : global::Pulumi.CustomResource
    {
        ...
        public ApplicationType(string name, ApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220601preview:ApplicationType", name, args ?? new ApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220601preview:ApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
