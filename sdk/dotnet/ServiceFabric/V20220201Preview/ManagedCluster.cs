...
namespace Pulumi.AzureNative.ServiceFabric.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:servicefabric/v20220201preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20221001preview:ManagedCluster to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:servicefabric/v20220201preview:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220201preview:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20220201preview:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("addonFeatures")]
        private InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20220201Preview.ManagedClusterAddOnFeature>>? _addonFeatures;

        /// <summary>
        /// List of add-on features to enable on the cluster.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20220201Preview.ManagedClusterAddOnFeature>> AddonFeatures
        {
            get => _addonFeatures ?? (_addonFeatures = new InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20220201Preview.ManagedClusterAddOnFeature>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20220201Preview.ClusterUpgradeCadence>? ClusterUpgradeCadence { get; set; }

        /// <summary>
        /// The upgrade mode of the cluster when new Service Fabric runtime version is available.
        /// </summary>
        [Input("clusterUpgradeMode")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20220201Preview.ClusterUpgradeMode>? ClusterUpgradeMode { get; set; }
