...
namespace Pulumi.AzureRM.ServiceFabric.V20191101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationType = new AzureRM.ServiceFabric.V20191101Preview.ApplicationType("applicationType", new AzureRM.ServiceFabric.V20191101Preview.ApplicationTypeArgs
    ///         {
    ...
    public partial class ApplicationType : Pulumi.CustomResource
    {
        ...
        public ApplicationType(string name, ApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20191101preview:ApplicationType", name, args ?? new ApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20191101preview:ApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
