...
namespace Pulumi.AzureNative.ServiceFabric.V20191101Preview
{
    ...
    [AzureNativeResourceType("azure-native:servicefabric/v20191101preview:ApplicationType")]
    public partial class ApplicationType : Pulumi.CustomResource
    {
        ...
        public ApplicationType(string name, ApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20191101preview:ApplicationType", name, args ?? new ApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20191101preview:ApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
