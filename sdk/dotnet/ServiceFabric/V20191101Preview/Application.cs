...
namespace Pulumi.AzureRM.ServiceFabric.V20191101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var application = new AzureRM.ServiceFabric.V20191101Preview.Application("application", new AzureRM.ServiceFabric.V20191101Preview.ApplicationArgs
    ///         {
    ...
    ///             Metrics = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20191101Preview.Inputs.ApplicationMetricDescriptionArgs
    ///                 {
    ///                     MaximumCapacity = 3,
    ///                     Name = "metric1",
    ...
    ///             TypeName = "myAppType",
    ///             TypeVersion = "1.0",
    ///             UpgradePolicy = new AzureRM.ServiceFabric.V20191101Preview.Inputs.ApplicationUpgradePolicyArgs
    ///             {
    ///                 ApplicationHealthPolicy = new AzureRM.ServiceFabric.V20191101Preview.Inputs.ArmApplicationHealthPolicyArgs
    ///                 {
    ///                     ConsiderWarningAsError = true,
    ///                     DefaultServiceTypeHealthPolicy = new AzureRM.ServiceFabric.V20191101Preview.Inputs.ArmServiceTypeHealthPolicyArgs
    ///                     {
    ...
    ///                 },
    ///                 ForceRestart = false,
    ///                 RollingUpgradeMonitoringPolicy = new AzureRM.ServiceFabric.V20191101Preview.Inputs.ArmRollingUpgradeMonitoringPolicyArgs
    ///                 {
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20191101preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20191101preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicefabric/latest:Application"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20170701preview:Application"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20190301:Application"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20190301preview:Application"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20190601preview:Application"},
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20200301:Application"},
                },
            };
