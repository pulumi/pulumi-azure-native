...
namespace Pulumi.AzureNative.ServiceFabric.V20191101Preview
{
    public static class GetApplication
    {
        ...
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("azure-native:servicefabric/v20191101preview:getApplication", args ?? new GetApplicationArgs(), options.WithVersion());

        /// <summary>
        /// The application resource.
        /// </summary>
        public static Output<GetApplicationResult> Invoke(GetApplicationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationResult>("azure-native:servicefabric/v20191101preview:getApplication", args ?? new GetApplicationInvokeArgs(), options.WithVersion());
    }
