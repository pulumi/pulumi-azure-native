...
namespace Pulumi.AzureNative.ServiceFabric.V20210101Preview
{
    public static class GetApplicationTypeVersion
    {
        ...
        public static Task<GetApplicationTypeVersionResult> InvokeAsync(GetApplicationTypeVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationTypeVersionResult>("azure-native:servicefabric/v20210101preview:getApplicationTypeVersion", args ?? new GetApplicationTypeVersionArgs(), options.WithVersion());
        ...
        public static Output<GetApplicationTypeVersionResult> Invoke(GetApplicationTypeVersionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationTypeVersionResult>("azure-native:servicefabric/v20210101preview:getApplicationTypeVersion", args ?? new GetApplicationTypeVersionInvokeArgs(), options.WithVersion());
    }
