...
namespace Pulumi.AzureNative.ServiceFabric.V20210101Preview
{
    public static class GetApplicationType
    {
        ...
        public static Task<GetApplicationTypeResult> InvokeAsync(GetApplicationTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationTypeResult>("azure-native:servicefabric/v20210101preview:getApplicationType", args ?? new GetApplicationTypeArgs(), options.WithVersion());

        /// <summary>
        /// The application type name resource
        /// </summary>
        public static Output<GetApplicationTypeResult> Invoke(GetApplicationTypeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationTypeResult>("azure-native:servicefabric/v20210101preview:getApplicationType", args ?? new GetApplicationTypeInvokeArgs(), options.WithVersion());
    }
