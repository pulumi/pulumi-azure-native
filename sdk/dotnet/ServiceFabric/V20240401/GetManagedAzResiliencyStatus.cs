...
namespace Pulumi.AzureNative.ServiceFabric.V20240401
{
    public static class GetManagedAzResiliencyStatus
    {
        ...
        public static Task<GetManagedAzResiliencyStatusResult> InvokeAsync(GetManagedAzResiliencyStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedAzResiliencyStatusResult>("azure-native:servicefabric/v20240401:getManagedAzResiliencyStatus", args ?? new GetManagedAzResiliencyStatusArgs(), options.WithDefaults());
        ...
        public static Output<GetManagedAzResiliencyStatusResult> Invoke(GetManagedAzResiliencyStatusInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagedAzResiliencyStatusResult>("azure-native:servicefabric/v20240401:getManagedAzResiliencyStatus", args ?? new GetManagedAzResiliencyStatusInvokeArgs(), options.WithDefaults());
