...
namespace Pulumi.AzureNative.ServiceFabric.V20240401.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240401.ProbeProtocol> ProbeProtocol { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240401.Protocol> Protocol { get; set; } = null!;
