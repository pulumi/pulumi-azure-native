...
namespace Pulumi.AzureNative.ServiceFabric.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20240401:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20240401:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20240401:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("addonFeatures")]
        private InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240401.ManagedClusterAddOnFeature>>? _addonFeatures;

        /// <summary>
        /// List of add-on features to enable on the cluster.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240401.ManagedClusterAddOnFeature>> AddonFeatures
        {
            get => _addonFeatures ?? (_addonFeatures = new InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240401.ManagedClusterAddOnFeature>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240401.ClusterUpgradeCadence>? ClusterUpgradeCadence { get; set; }

        /// <summary>
        /// The upgrade mode of the cluster when new Service Fabric runtime version is available.
        /// </summary>
        [Input("clusterUpgradeMode")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240401.ClusterUpgradeMode>? ClusterUpgradeMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240401.ZonalUpdateMode>? ZonalUpdateMode { get; set; }
