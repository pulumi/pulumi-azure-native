...
namespace Pulumi.AzureNative.ServiceFabric.V20240401
{
    public static class GetManagedMaintenanceWindowStatus
    {
        ...
        public static Task<GetManagedMaintenanceWindowStatusResult> InvokeAsync(GetManagedMaintenanceWindowStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedMaintenanceWindowStatusResult>("azure-native:servicefabric/v20240401:getManagedMaintenanceWindowStatus", args ?? new GetManagedMaintenanceWindowStatusArgs(), options.WithDefaults());
        ...
        public static Output<GetManagedMaintenanceWindowStatusResult> Invoke(GetManagedMaintenanceWindowStatusInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagedMaintenanceWindowStatusResult>("azure-native:servicefabric/v20240401:getManagedMaintenanceWindowStatus", args ?? new GetManagedMaintenanceWindowStatusInvokeArgs(), options.WithDefaults());
