...
namespace Pulumi.AzureNative.ServiceFabric.V20221001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20221001preview:ManagedClusterApplicationType")]
    public partial class ManagedClusterApplicationType : global::Pulumi.CustomResource
    {
        ...
        public ManagedClusterApplicationType(string name, ManagedClusterApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20221001preview:ManagedClusterApplicationType", name, args ?? new ManagedClusterApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedClusterApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20221001preview:ManagedClusterApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
