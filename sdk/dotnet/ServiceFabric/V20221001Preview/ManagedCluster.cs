...
namespace Pulumi.AzureNative.ServiceFabric.V20221001Preview
{
    ...
    /// {
    ///     var managedCluster = new AzureNative.ServiceFabric.V20221001Preview.ManagedCluster("managedCluster", new()
    ///     {
    ///         AddonFeatures = new[]
    ///         {
    ///             "DnsService",
    ...
    ///         AllowRdpAccess = true,
    ///         ApplicationTypeVersionsCleanupPolicy = new AzureNative.ServiceFabric.V20221001Preview.Inputs.ApplicationTypeVersionsCleanupPolicyArgs
    ///         {
    ///             MaxUnusedVersionsToKeep = 3,
    ///         },
    ///         AuxiliarySubnets = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20221001Preview.Inputs.SubnetArgs
    ///             {
    ///                 EnableIpv6 = true,
    ///                 Name = "testSubnet1",
    ...
    ///         FabricSettings = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20221001Preview.Inputs.SettingsSectionDescriptionArgs
    ///             {
    ///                 Name = "ManagedIdentityTokenService",
    ///                 Parameters = new[]
    ///                 {
    ///                     new AzureNative.ServiceFabric.V20221001Preview.Inputs.SettingsParameterDescriptionArgs
    ///                     {
    ///                         Name = "IsEnabled",
    ///                         Value = "true",
    ///                     },
    ...
    ///         IpTags = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20221001Preview.Inputs.IPTagArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.ServiceFabric.V20221001Preview.Inputs.LoadBalancingRuleArgs
    ///             {
    ///                 BackendPort = 80,
    ///                 FrontendPort = 80,
    ///                 ProbePort = 80,
    ...
    ///         {
    ///             new AzureNative.ServiceFabric.V20221001Preview.Inputs.NetworkSecurityRuleArgs
    ///             {
    ///                 Access = "allow",
    ...
    ///         {
    ///             new AzureNative.ServiceFabric.V20221001Preview.Inputs.ServiceEndpointArgs
    ///             {
    ///                 Locations = new[]
    ///                 {
    ///                     "eastus2",
    ...
    ///             },
    ///         },
    ///         Sku = new AzureNative.ServiceFabric.V20221001Preview.Inputs.SkuArgs
    ///         {
    ///             Name = "Basic",
    ///         },
    ///         Tags = null,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20221001preview:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20221001preview:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20221001preview:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("addonFeatures")]
        private InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20221001Preview.ManagedClusterAddOnFeature>>? _addonFeatures;

        /// <summary>
        /// List of add-on features to enable on the cluster.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20221001Preview.ManagedClusterAddOnFeature>> AddonFeatures
        {
            get => _addonFeatures ?? (_addonFeatures = new InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20221001Preview.ManagedClusterAddOnFeature>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20221001Preview.ClusterUpgradeCadence>? ClusterUpgradeCadence { get; set; }

        /// <summary>
        /// The upgrade mode of the cluster when new Service Fabric runtime version is available.
        /// </summary>
        [Input("clusterUpgradeMode")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20221001Preview.ClusterUpgradeMode>? ClusterUpgradeMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20221001Preview.ZonalUpdateMode>? ZonalUpdateMode { get; set; }
