...
namespace Pulumi.AzureNative.ServiceFabric.V20221001Preview
{
    ...
    [AzureNativeResourceType("azure-native:servicefabric/v20221001preview:ApplicationType")]
    public partial class ApplicationType : global::Pulumi.CustomResource
    {
        ...
        public ApplicationType(string name, ApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20221001preview:ApplicationType", name, args ?? new ApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20221001preview:ApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
