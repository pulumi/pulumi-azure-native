...
namespace Pulumi.AzureNative.ServiceFabric.V20240201Preview
{
    public static class GetManagedMaintenanceWindowStatus
    {
        ...
        public static Task<GetManagedMaintenanceWindowStatusResult> InvokeAsync(GetManagedMaintenanceWindowStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedMaintenanceWindowStatusResult>("azure-native:servicefabric/v20240201preview:getManagedMaintenanceWindowStatus", args ?? new GetManagedMaintenanceWindowStatusArgs(), options.WithDefaults());
        ...
        public static Output<GetManagedMaintenanceWindowStatusResult> Invoke(GetManagedMaintenanceWindowStatusInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagedMaintenanceWindowStatusResult>("azure-native:servicefabric/v20240201preview:getManagedMaintenanceWindowStatus", args ?? new GetManagedMaintenanceWindowStatusInvokeArgs(), options.WithDefaults());
