...
namespace Pulumi.AzureNative.ServiceFabric.V20240201Preview
{
    public static class GetManagedClusterApplicationType
    {
        ...
        public static Task<GetManagedClusterApplicationTypeResult> InvokeAsync(GetManagedClusterApplicationTypeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedClusterApplicationTypeResult>("azure-native:servicefabric/v20240201preview:getManagedClusterApplicationType", args ?? new GetManagedClusterApplicationTypeArgs(), options.WithDefaults());
