...
namespace Pulumi.AzureNative.ServiceFabric.V20240201Preview
{
    public static class GetManagedAzResiliencyStatus
    {
        ...
        public static Task<GetManagedAzResiliencyStatusResult> InvokeAsync(GetManagedAzResiliencyStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedAzResiliencyStatusResult>("azure-native:servicefabric/v20240201preview:getManagedAzResiliencyStatus", args ?? new GetManagedAzResiliencyStatusArgs(), options.WithDefaults());
