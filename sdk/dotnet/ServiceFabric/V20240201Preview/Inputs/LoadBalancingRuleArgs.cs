...
namespace Pulumi.AzureNative.ServiceFabric.V20240201Preview.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240201Preview.ProbeProtocol> ProbeProtocol { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240201Preview.Protocol> Protocol { get; set; } = null!;
