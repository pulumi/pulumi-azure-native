...
namespace Pulumi.AzureRM.ServiceFabric.Preview
{
    public static class GetApplicationTypeVersion
    {
        public static Task<GetApplicationTypeVersionResult> InvokeAsync(GetApplicationTypeVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationTypeVersionResult>("azurerm:servicefabric/preview:getApplicationTypeVersion", args ?? new GetApplicationTypeVersionArgs(), options.WithVersion());
    }
