...
namespace Pulumi.AzureRM.ServiceFabric.Preview
{
    public static class GetNodeType
    {
        public static Task<GetNodeTypeResult> InvokeAsync(GetNodeTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNodeTypeResult>("azurerm:servicefabric/preview:getNodeType", args ?? new GetNodeTypeArgs(), options.WithVersion());
    }
