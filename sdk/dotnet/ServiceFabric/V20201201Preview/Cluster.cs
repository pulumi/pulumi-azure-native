...
namespace Pulumi.AzureNative.ServiceFabric.V20201201Preview
{
    ...
    /// {
    ///     var cluster = new AzureNative.ServiceFabric.V20201201Preview.Cluster("cluster", new()
    ///     {
    ///         AddOnFeatures = new[]
    ///         {
    ///             "RepairManager",
    ...
    ///         },
    ///         ApplicationTypeVersionsCleanupPolicy = new AzureNative.ServiceFabric.V20201201Preview.Inputs.ApplicationTypeVersionsCleanupPolicyArgs
    ///         {
    ///             MaxUnusedVersionsToKeep = 2,
    ///         },
    ///         AzureActiveDirectory = new AzureNative.ServiceFabric.V20201201Preview.Inputs.AzureActiveDirectoryArgs
    ///         {
    ...
    ///         },
    ///         CertificateCommonNames = new AzureNative.ServiceFabric.V20201201Preview.Inputs.ServerCertificateCommonNamesArgs
    ///         {
    ///             CommonNames = new[]
    ///             {
    ///                 new AzureNative.ServiceFabric.V20201201Preview.Inputs.ServerCertificateCommonNameArgs
    ///                 {
    ...
    ///         {
    ///             new AzureNative.ServiceFabric.V20201201Preview.Inputs.ClientCertificateCommonNameArgs
    ///             {
    ///                 CertificateCommonName = "abc.com",
    ...
    ///         {
    ///             new AzureNative.ServiceFabric.V20201201Preview.Inputs.ClientCertificateThumbprintArgs
    ///             {
    ...
    ///         DiagnosticsStorageAccountConfig = new AzureNative.ServiceFabric.V20201201Preview.Inputs.DiagnosticsStorageAccountConfigArgs
    ///         {
    ...
    ///         FabricSettings = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20201201Preview.Inputs.SettingsSectionDescriptionArgs
    ///             {
    ///                 Name = "UpgradeService",
    ///                 Parameters = new[]
    ///                 {
    ///                     new AzureNative.ServiceFabric.V20201201Preview.Inputs.SettingsParameterDescriptionArgs
    ///                     {
    ...
    ///         NodeTypes = new[]
    ///         {
    ///             new AzureNative.ServiceFabric.V20201201Preview.Inputs.NodeTypeDescriptionArgs
    ///             {
    ///                 ApplicationPorts = new AzureNative.ServiceFabric.V20201201Preview.Inputs.EndpointRangeDescriptionArgs
    ///                 {
    ///                     EndPort = 30000,
    ///                     StartPort = 20000,
    ///                 },
    ...
    ///                 EphemeralPorts = new AzureNative.ServiceFabric.V20201201Preview.Inputs.EndpointRangeDescriptionArgs
    ///                 {
    ///                     EndPort = 64000,
    ///                     StartPort = 49000,
    ///                 },
    ...
    ///         ReverseProxyCertificateCommonNames = new AzureNative.ServiceFabric.V20201201Preview.Inputs.ServerCertificateCommonNamesArgs
    ///         {
    ///             CommonNames = new[]
    ///             {
    ///                 new AzureNative.ServiceFabric.V20201201Preview.Inputs.ServerCertificateCommonNameArgs
    ...
    ///         },
    ///         Tags = null,
    ///         UpgradeDescription = new AzureNative.ServiceFabric.V20201201Preview.Inputs.ClusterUpgradePolicyArgs
    ///         {
    ///             DeltaHealthPolicy = new AzureNative.ServiceFabric.V20201201Preview.Inputs.ClusterUpgradeDeltaHealthPolicyArgs
    ///             {
    ///                 ApplicationDeltaHealthPolicies = 
    ///                 {
    ///                     { "fabric:/myApp1", new AzureNative.ServiceFabric.V20201201Preview.Inputs.ApplicationDeltaHealthPolicyArgs
    ///                     {
    ///                         DefaultServiceTypeDeltaHealthPolicy = new AzureNative.ServiceFabric.V20201201Preview.Inputs.ServiceTypeDeltaHealthPolicyArgs
    ///                         {
    ///                             MaxPercentDeltaUnhealthyServices = 0,
    ///                         },
    ///                         ServiceTypeDeltaHealthPolicies = 
    ///                         {
    ///                             { "myServiceType1", new AzureNative.ServiceFabric.V20201201Preview.Inputs.ServiceTypeDeltaHealthPolicyArgs
    ///                             {
    ///                                 MaxPercentDeltaUnhealthyServices = 0,
    ///                             } },
    ///                         },
    ...
    ///             HealthPolicy = new AzureNative.ServiceFabric.V20201201Preview.Inputs.ClusterHealthPolicyArgs
    ///             {
    ///                 ApplicationHealthPolicies = 
    ///                 {
    ///                     { "fabric:/myApp1", new AzureNative.ServiceFabric.V20201201Preview.Inputs.ApplicationHealthPolicyArgs
    ///                     {
    ///                         DefaultServiceTypeHealthPolicy = new AzureNative.ServiceFabric.V20201201Preview.Inputs.ServiceTypeHealthPolicyArgs
    ///                         {
    ///                             MaxPercentUnhealthyServices = 0,
    ///                         },
    ///                         ServiceTypeHealthPolicies = 
    ///                         {
    ///                             { "myServiceType1", new AzureNative.ServiceFabric.V20201201Preview.Inputs.ServiceTypeHealthPolicyArgs
    ///                             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20201201preview:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20201201preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20201201preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
