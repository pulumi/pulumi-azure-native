...
namespace Pulumi.AzureNative.ServiceFabric.V20201201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:servicefabric/v20201201preview:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20210601:Application to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:servicefabric/v20201201preview:Application")]
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20201201preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20201201preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
