...
namespace Pulumi.AzureNative.ServiceFabric.V20201201Preview
{
    public static class GetCluster
    {
        ...
        public static Task<GetClusterResult> InvokeAsync(GetClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetClusterResult>("azure-native:servicefabric/v20201201preview:getCluster", args ?? new GetClusterArgs(), options.WithVersion());

        /// <summary>
        /// The cluster resource
        /// </summary>
        public static Output<GetClusterResult> Invoke(GetClusterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetClusterResult>("azure-native:servicefabric/v20201201preview:getCluster", args ?? new GetClusterInvokeArgs(), options.WithVersion());
    }
