...
namespace Pulumi.AzureNative.ServiceFabric.V20210701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20210701preview:ApplicationTypeVersion")]
    public partial class ApplicationTypeVersion : Pulumi.CustomResource
    {
        ...
        public ApplicationTypeVersion(string name, ApplicationTypeVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210701preview:ApplicationTypeVersion", name, args ?? new ApplicationTypeVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationTypeVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210701preview:ApplicationTypeVersion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:servicefabric/v20210701preview:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azure-native:servicefabric/v20210101preview:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azure-nextgen:servicefabric/v20210101preview:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azure-native:servicefabric/v20210501:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azure-nextgen:servicefabric/v20210501:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azure-native:servicefabric/v20210901privatepreview:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azure-nextgen:servicefabric/v20210901privatepreview:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azure-native:servicefabric/v20211101preview:ApplicationTypeVersion"},
                    new Pulumi.Alias { Type = "azure-nextgen:servicefabric/v20211101preview:ApplicationTypeVersion"},
                },
            };
