...
namespace Pulumi.AzureNative.ServiceFabric.V20210701Preview.Inputs
{
    ...
    public sealed class NetworkSecurityRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210701Preview.Access> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210701Preview.Direction> Direction { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20210701Preview.NsgProtocol> Protocol { get; set; } = null!;
