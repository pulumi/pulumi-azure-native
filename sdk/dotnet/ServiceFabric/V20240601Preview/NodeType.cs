...
namespace Pulumi.AzureNative.ServiceFabric.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20240601preview:NodeType")]
    public partial class NodeType : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("vmApplications")]
        public Output<ImmutableArray<Outputs.VmApplicationResponse>> VmApplications { get; private set; } = null!;
        ...
        public NodeType(string name, NodeTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20240601preview:NodeType", name, args ?? new NodeTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20240601preview:NodeType", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NodeTypeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.DiskType>? DataDiskType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.EvictionPolicyType>? EvictionPolicy { get; set; }
        ...
        /// </summary>
        [Input("securityType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.SecurityType>? SecurityType { get; set; }
        ...
        [Input("vmApplications")]
        private InputList<Inputs.VmApplicationArgs>? _vmApplications;

        /// <summary>
        /// Specifies the gallery applications that should be made available to the underlying VMSS.
        /// </summary>
        public InputList<Inputs.VmApplicationArgs> VmApplications
        {
            get => _vmApplications ?? (_vmApplications = new InputList<Inputs.VmApplicationArgs>());
            set => _vmApplications = value;
        }
        ...
        private InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.VmSetupAction>>? _vmSetupActions;

        /// <summary>
        /// Specifies the actions to be performed on the vms before bootstrapping the service fabric runtime.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.VmSetupAction>> VmSetupActions
        {
            get => _vmSetupActions ?? (_vmSetupActions = new InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.VmSetupAction>>());
