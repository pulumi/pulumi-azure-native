...
namespace Pulumi.AzureNative.ServiceFabric.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20240601preview:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("customFqdn")]
        public Output<string?> CustomFqdn { get; private set; } = null!;
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20240601preview:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20240601preview:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("addonFeatures")]
        private InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.ManagedClusterAddOnFeature>>? _addonFeatures;

        /// <summary>
        /// List of add-on features to enable on the cluster.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.ManagedClusterAddOnFeature>> AddonFeatures
        {
            get => _addonFeatures ?? (_addonFeatures = new InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.ManagedClusterAddOnFeature>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.AutoGeneratedDomainNameLabelScope>? AutoGeneratedDomainNameLabelScope { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.ClusterUpgradeCadence>? ClusterUpgradeCadence { get; set; }

        /// <summary>
        /// The upgrade mode of the cluster when new Service Fabric runtime version is available.
        /// </summary>
        [Input("clusterUpgradeMode")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.ClusterUpgradeMode>? ClusterUpgradeMode { get; set; }

        /// <summary>
        /// If using autoGeneratedDomainNameLabelScope, this is the fully qualified domain name using SFMC's domain, pointing to the public load balancer of the cluster.
        /// </summary>
        [Input("customFqdn")]
        public Input<string>? CustomFqdn { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.ZonalUpdateMode>? ZonalUpdateMode { get; set; }
