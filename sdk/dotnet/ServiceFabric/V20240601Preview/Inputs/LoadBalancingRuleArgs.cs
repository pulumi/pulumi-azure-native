...
namespace Pulumi.AzureNative.ServiceFabric.V20240601Preview.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.ProbeProtocol> ProbeProtocol { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.Protocol> Protocol { get; set; } = null!;
