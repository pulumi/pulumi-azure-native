...
namespace Pulumi.AzureNative.ServiceFabric.V20240601Preview.Inputs
{
    ...
    public sealed class VMSSExtensionArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("setupOrder")]
        private InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.VmssExtensionSetupOrder>>? _setupOrder;

        /// <summary>
        /// Indicates the setup order for the extension.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.VmssExtensionSetupOrder>> SetupOrder
        {
            get => _setupOrder ?? (_setupOrder = new InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20240601Preview.VmssExtensionSetupOrder>>());
