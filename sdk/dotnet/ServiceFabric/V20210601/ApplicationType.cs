...
namespace Pulumi.AzureNative.ServiceFabric.V20210601
{
    ...
    /// {
    ///     var applicationType = new AzureNative.ServiceFabric.V20210601.ApplicationType("applicationType", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:servicefabric/v20210601:ApplicationType myCluster /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/resRg/providers/Microsoft.ServiceFabric/clusters/myCluster/applicationTypes/myAppType 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20210601:ApplicationType")]
    public partial class ApplicationType : global::Pulumi.CustomResource
    {
        ...
        public ApplicationType(string name, ApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210601:ApplicationType", name, args ?? new ApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20210601:ApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
