...
namespace Pulumi.AzureNative.ServiceFabric.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20240901preview:ManagedClusterApplicationTypeVersion")]
    public partial class ManagedClusterApplicationTypeVersion : global::Pulumi.CustomResource
    {
        ...
        public ManagedClusterApplicationTypeVersion(string name, ManagedClusterApplicationTypeVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20240901preview:ManagedClusterApplicationTypeVersion", name, args ?? new ManagedClusterApplicationTypeVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedClusterApplicationTypeVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20240901preview:ManagedClusterApplicationTypeVersion", name, null, MakeResourceOptions(options, id))
        {
        }
