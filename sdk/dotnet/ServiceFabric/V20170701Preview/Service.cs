...
namespace Pulumi.AzureRM.ServiceFabric.V20170701Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var service = new AzureRM.ServiceFabric.V20170701Preview.Service("service", new AzureRM.ServiceFabric.V20170701Preview.ServiceArgs
    ///         {
    ///             ApplicationName = "myApp",
    ///             ClusterName = "myCluster",
    ///             CorrelationScheme = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20170701Preview.Inputs.ServiceCorrelationDescriptionArgs
    ///                 {
    ///                     Scheme = "Affinity",
    ...
    ///             Location = "eastus",
    ///             PartitionDescription = new AzureRM.ServiceFabric.V20170701Preview.Inputs.PartitionSchemeDescriptionArgs
    ///             {
    ...
    ///             ServiceLoadMetrics = 
    ///             {
    ///                 new AzureRM.ServiceFabric.V20170701Preview.Inputs.ServiceLoadMetricDescriptionArgs
    ///                 {
    ///                     Name = "metric1",
    ///                     Weight = "Low",
    ///                 },
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20170701preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20170701preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
