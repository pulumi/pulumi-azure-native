...
namespace Pulumi.AzureNextGen.ServiceFabric.V20170701Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicefabric/v20170701preview:Application")]
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicefabric/v20170701preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicefabric/v20170701preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
