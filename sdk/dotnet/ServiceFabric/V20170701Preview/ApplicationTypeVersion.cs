...
namespace Pulumi.AzureRM.ServiceFabric.V20170701Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var applicationTypeVersion = new AzureRM.ServiceFabric.V20170701Preview.ApplicationTypeVersion("applicationTypeVersion", new AzureRM.ServiceFabric.V20170701Preview.ApplicationTypeVersionArgs
    ///         {
    ...
    public partial class ApplicationTypeVersion : Pulumi.CustomResource
    {
        ...
        public ApplicationTypeVersion(string name, ApplicationTypeVersionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20170701preview:ApplicationTypeVersion", name, args ?? new ApplicationTypeVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationTypeVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabric/v20170701preview:ApplicationTypeVersion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:servicefabric/v20190301preview:ApplicationTypeVersion"},
