...
namespace Pulumi.AzureNative.ServiceFabric.V20241101Preview.Inputs
{
    ...
    public sealed class LoadBalancingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20241101Preview.ProbeProtocol> ProbeProtocol { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20241101Preview.Protocol> Protocol { get; set; } = null!;
