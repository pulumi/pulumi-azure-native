...
namespace Pulumi.AzureNative.ServiceFabric.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20241101preview:ManagedClusterApplicationType")]
    public partial class ManagedClusterApplicationType : global::Pulumi.CustomResource
    {
        ...
        public ManagedClusterApplicationType(string name, ManagedClusterApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20241101preview:ManagedClusterApplicationType", name, args ?? new ManagedClusterApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedClusterApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20241101preview:ManagedClusterApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
