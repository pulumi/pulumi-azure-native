...
namespace Pulumi.AzureNative.ServiceFabric.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20241101preview:ApplicationType")]
    public partial class ApplicationType : global::Pulumi.CustomResource
    {
        ...
        public ApplicationType(string name, ApplicationTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20241101preview:ApplicationType", name, args ?? new ApplicationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20241101preview:ApplicationType", name, null, MakeResourceOptions(options, id))
        {
        }
