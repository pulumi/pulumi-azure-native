...
namespace Pulumi.AzureNative.ServiceFabric.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicefabric/v20241101preview:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20241101preview:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabric/v20241101preview:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("addonFeatures")]
        private InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20241101Preview.ManagedClusterAddOnFeature>>? _addonFeatures;

        /// <summary>
        /// List of add-on features to enable on the cluster.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20241101Preview.ManagedClusterAddOnFeature>> AddonFeatures
        {
            get => _addonFeatures ?? (_addonFeatures = new InputList<Union<string, Pulumi.AzureNative.ServiceFabric.V20241101Preview.ManagedClusterAddOnFeature>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20241101Preview.AutoGeneratedDomainNameLabelScope>? AutoGeneratedDomainNameLabelScope { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20241101Preview.ClusterUpgradeCadence>? ClusterUpgradeCadence { get; set; }

        /// <summary>
        /// The upgrade mode of the cluster when new Service Fabric runtime version is available.
        /// </summary>
        [Input("clusterUpgradeMode")]
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20241101Preview.ClusterUpgradeMode>? ClusterUpgradeMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceFabric.V20241101Preview.ZonalUpdateMode>? ZonalUpdateMode { get; set; }
