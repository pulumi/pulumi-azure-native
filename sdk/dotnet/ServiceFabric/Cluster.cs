...
namespace Pulumi.AzureNextGen.ServiceFabric
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicefabric:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicefabric:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicefabric:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
