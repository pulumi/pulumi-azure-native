...
namespace Pulumi.AzureNative.MixedReality.V20191202Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mixedreality/v20191202preview:SpatialAnchorsAccount")]
    public partial class SpatialAnchorsAccount : Pulumi.CustomResource
    {
        ...
        public SpatialAnchorsAccount(string name, SpatialAnchorsAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mixedreality/v20191202preview:SpatialAnchorsAccount", name, args ?? new SpatialAnchorsAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SpatialAnchorsAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mixedreality/v20191202preview:SpatialAnchorsAccount", name, null, MakeResourceOptions(options, id))
        {
        }
