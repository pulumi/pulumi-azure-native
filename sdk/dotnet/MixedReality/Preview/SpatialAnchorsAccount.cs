...
namespace Pulumi.AzureRM.MixedReality.Preview
{
    ...
    public partial class SpatialAnchorsAccount : Pulumi.CustomResource
    {
        ...
        public SpatialAnchorsAccount(string name, SpatialAnchorsAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/preview:SpatialAnchorsAccount", name, args ?? new SpatialAnchorsAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SpatialAnchorsAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/preview:SpatialAnchorsAccount", name, null, MakeResourceOptions(options, id))
        {
        }
