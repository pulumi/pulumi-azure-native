...
namespace Pulumi.AzureRM.MixedReality.Preview
{
    ...
    public partial class RemoteRenderingAccount : Pulumi.CustomResource
    {
        ...
        public RemoteRenderingAccount(string name, RemoteRenderingAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/preview:RemoteRenderingAccount", name, args ?? new RemoteRenderingAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteRenderingAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/preview:RemoteRenderingAccount", name, null, MakeResourceOptions(options, id))
        {
        }
