...
namespace Pulumi.AzureNative.MixedReality.V20250101
{
    /// <summary>
    /// RemoteRenderingAccount Response.
    /// </summary>
    [AzureNativeResourceType("azure-native:mixedreality/v20250101:RemoteRenderingAccount")]
    public partial class RemoteRenderingAccount : global::Pulumi.CustomResource
    {
        ...
        public RemoteRenderingAccount(string name, RemoteRenderingAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mixedreality/v20250101:RemoteRenderingAccount", name, args ?? new RemoteRenderingAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteRenderingAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mixedreality/v20250101:RemoteRenderingAccount", name, null, MakeResourceOptions(options, id))
        {
        }
