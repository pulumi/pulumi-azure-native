...
namespace Pulumi.AzureRM.MixedReality.V20190228Preview
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var spatialAnchorsAccount = new AzureRM.MixedReality.V20190228Preview.SpatialAnchorsAccount("spatialAnchorsAccount", new AzureRM.MixedReality.V20190228Preview.SpatialAnchorsAccountArgs
    ///         {
    ...
    public partial class SpatialAnchorsAccount : Pulumi.CustomResource
    {
        ...
        public SpatialAnchorsAccount(string name, SpatialAnchorsAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/v20190228preview:SpatialAnchorsAccount", name, args ?? new SpatialAnchorsAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SpatialAnchorsAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/v20190228preview:SpatialAnchorsAccount", name, null, MakeResourceOptions(options, id))
        {
        }
