...
namespace Pulumi.AzureRM.MixedReality.V20200501
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var spatialAnchorsAccount = new AzureRM.MixedReality.V20200501.SpatialAnchorsAccount("spatialAnchorsAccount", new AzureRM.MixedReality.V20200501.SpatialAnchorsAccountArgs
    ///         {
    ...
    public partial class SpatialAnchorsAccount : Pulumi.CustomResource
    {
        ...
        public SpatialAnchorsAccount(string name, SpatialAnchorsAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/v20200501:SpatialAnchorsAccount", name, args ?? new SpatialAnchorsAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SpatialAnchorsAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/v20200501:SpatialAnchorsAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:mixedreality/v20190228preview:SpatialAnchorsAccount"},
