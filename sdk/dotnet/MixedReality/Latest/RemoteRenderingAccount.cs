...
namespace Pulumi.AzureRM.MixedReality.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var remoteRenderingAccount = new AzureRM.MixedReality.Latest.RemoteRenderingAccount("remoteRenderingAccount", new AzureRM.MixedReality.Latest.RemoteRenderingAccountArgs
    ///         {
    ///             AccountName = "MyAccount",
    ///             Identity = new AzureRM.MixedReality.Latest.Inputs.RemoteRenderingAccountIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ...
    public partial class RemoteRenderingAccount : Pulumi.CustomResource
    {
        ...
        public RemoteRenderingAccount(string name, RemoteRenderingAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/latest:RemoteRenderingAccount", name, args ?? new RemoteRenderingAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteRenderingAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality/latest:RemoteRenderingAccount", name, null, MakeResourceOptions(options, id))
        {
        }
