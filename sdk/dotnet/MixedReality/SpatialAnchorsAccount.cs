...
namespace Pulumi.AzureRM.MixedReality
{
    ...
    public partial class SpatialAnchorsAccount : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MixedRealityAccountPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public SpatialAnchorsAccount(string name, SpatialAnchorsAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality:SpatialAnchorsAccount", name, args ?? new SpatialAnchorsAccountArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private SpatialAnchorsAccount(string name, Input<string> id, SpatialAnchorsAccountState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:mixedreality:SpatialAnchorsAccount", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SpatialAnchorsAccountState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MixedRealityAccountPropertiesResponseGetArgs> Properties { get; set; } = null!;
