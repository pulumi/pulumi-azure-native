...
{
    [Obsolete(@"Version 2020-04-06-preview will be removed in v2 of the provider.
azure-native:mixedreality/v20200406preview:RemoteRenderingAccount is being removed in the next major version of this provider. Please upgrade to azure-native:mixedreality/v20210301preview:RemoteRenderingAccount to guarantee forwards compatibility.")]
    public static class GetRemoteRenderingAccount
    {
        ...
        public static Task<GetRemoteRenderingAccountResult> InvokeAsync(GetRemoteRenderingAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRemoteRenderingAccountResult>("azure-native:mixedreality/v20200406preview:getRemoteRenderingAccount", args ?? new GetRemoteRenderingAccountArgs(), options.WithDefaults());
        ...
        public static Output<GetRemoteRenderingAccountResult> Invoke(GetRemoteRenderingAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRemoteRenderingAccountResult>("azure-native:mixedreality/v20200406preview:getRemoteRenderingAccount", args ?? new GetRemoteRenderingAccountInvokeArgs(), options.WithDefaults());
    }
