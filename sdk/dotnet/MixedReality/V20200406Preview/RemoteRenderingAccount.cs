...
namespace Pulumi.AzureNative.MixedReality.V20200406Preview
{
    ...
    public partial class RemoteRenderingAccount : global::Pulumi.CustomResource
    {
        ...
        public RemoteRenderingAccount(string name, RemoteRenderingAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mixedreality/v20200406preview:RemoteRenderingAccount", name, args ?? new RemoteRenderingAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteRenderingAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mixedreality/v20200406preview:RemoteRenderingAccount", name, null, MakeResourceOptions(options, id))
        {
        }
