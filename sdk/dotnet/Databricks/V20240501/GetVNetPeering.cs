...
namespace Pulumi.AzureNative.Databricks.V20240501
{
    public static class GetVNetPeering
    {
        ...
        public static Task<GetVNetPeeringResult> InvokeAsync(GetVNetPeeringArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVNetPeeringResult>("azure-native:databricks/v20240501:getVNetPeering", args ?? new GetVNetPeeringArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the workspace vNet Peering.
        /// </summary>
        public static Output<GetVNetPeeringResult> Invoke(GetVNetPeeringInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVNetPeeringResult>("azure-native:databricks/v20240501:getVNetPeering", args ?? new GetVNetPeeringInvokeArgs(), options.WithDefaults());
    }
