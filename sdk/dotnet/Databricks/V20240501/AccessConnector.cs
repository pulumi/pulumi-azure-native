...
namespace Pulumi.AzureNative.Databricks.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databricks/v20240501:AccessConnector")]
    public partial class AccessConnector : global::Pulumi.CustomResource
    {
        ...
        public AccessConnector(string name, AccessConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240501:AccessConnector", name, args ?? new AccessConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240501:AccessConnector", name, null, MakeResourceOptions(options, id))
        {
        }
