...
namespace Pulumi.AzureNative.Databricks.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databricks/v20240501:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240501:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240501:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
