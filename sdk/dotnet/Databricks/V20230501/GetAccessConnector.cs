...
namespace Pulumi.AzureNative.Databricks.V20230501
{
    public static class GetAccessConnector
    {
        ...
        public static Task<GetAccessConnectorResult> InvokeAsync(GetAccessConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccessConnectorResult>("azure-native:databricks/v20230501:getAccessConnector", args ?? new GetAccessConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an azure databricks accessConnector.
        /// </summary>
        public static Output<GetAccessConnectorResult> Invoke(GetAccessConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccessConnectorResult>("azure-native:databricks/v20230501:getAccessConnector", args ?? new GetAccessConnectorInvokeArgs(), options.WithDefaults());
