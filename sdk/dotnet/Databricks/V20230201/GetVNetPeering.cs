...
namespace Pulumi.AzureNative.Databricks.V20230201
{
    public static class GetVNetPeering
    {
        ...
        public static Task<GetVNetPeeringResult> InvokeAsync(GetVNetPeeringArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVNetPeeringResult>("azure-native:databricks/v20230201:getVNetPeering", args ?? new GetVNetPeeringArgs(), options.WithDefaults());
