...
namespace Pulumi.AzureNative.Databricks.V20230201
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.Databricks.V20230201.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "myWorkspace.23456789-1111-1111-1111-111111111111",
    ///         Properties = new AzureNative.Databricks.V20230201.Inputs.PrivateEndpointConnectionPropertiesArgs
    ///         {
    ///             PrivateLinkServiceConnectionState = new AzureNative.Databricks.V20230201.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databricks/v20230201:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20230201:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20230201:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
