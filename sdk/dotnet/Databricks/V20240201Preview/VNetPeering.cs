...
namespace Pulumi.AzureNative.Databricks.V20240201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databricks/v20240201preview:VNetPeering")]
    public partial class VNetPeering : global::Pulumi.CustomResource
    {
        ...
        public VNetPeering(string name, VNetPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240201preview:VNetPeering", name, args ?? new VNetPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VNetPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240201preview:VNetPeering", name, null, MakeResourceOptions(options, id))
        {
        }
