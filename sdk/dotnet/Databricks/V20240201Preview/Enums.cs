...
namespace Pulumi.AzureNative.Databricks.V20240201Preview
{
    [EnumType]
    ...
    /// </summary>
    [EnumType]
    public readonly struct PrivateDbfsAccess : IEquatable<PrivateDbfsAccess>
    {
        private readonly string _value;

        private PrivateDbfsAccess(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static PrivateDbfsAccess Disabled { get; } = new PrivateDbfsAccess("Disabled");
        public static PrivateDbfsAccess Enabled { get; } = new PrivateDbfsAccess("Enabled");

        public static bool operator ==(PrivateDbfsAccess left, PrivateDbfsAccess right) => left.Equals(right);
        public static bool operator !=(PrivateDbfsAccess left, PrivateDbfsAccess right) => !left.Equals(right);

        public static explicit operator string(PrivateDbfsAccess value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is PrivateDbfsAccess other && Equals(other);
        public bool Equals(PrivateDbfsAccess other) => string.Equals(_value, other._value, StringComparison.Ordinal);
