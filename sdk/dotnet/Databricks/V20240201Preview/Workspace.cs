...
namespace Pulumi.AzureNative.Databricks.V20240201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databricks/v20240201preview:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("privateDbfsAccess")]
        public Output<string?> PrivateDbfsAccess { get; private set; } = null!;
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240201preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240201preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// Gets or Sets Private DBFS Access configuration information
        /// </summary>
        [Input("privateDbfsAccess")]
        public InputUnion<string, Pulumi.AzureNative.Databricks.V20240201Preview.PrivateDbfsAccess>? PrivateDbfsAccess { get; set; }

        /// <summary>
        /// The network access type for accessing workspace. Set value to disabled to access workspace only via private link.
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.Databricks.V20240201Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether data plane (clusters) to control plane communication happen over private endpoint. Supported values are 'AllRules' and 'NoAzureDatabricksRules'. 'NoAzureServiceRules' value is for internal use only.
        /// </summary>
        [Input("requiredNsgRules")]
        public InputUnion<string, Pulumi.AzureNative.Databricks.V20240201Preview.RequiredNsgRules>? RequiredNsgRules { get; set; }
