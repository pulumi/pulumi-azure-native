...
namespace Pulumi.AzureRM.Databricks.Preview
{
    ...
    public partial class VNetPeering : Pulumi.CustomResource
    {
        ...
        public VNetPeering(string name, VNetPeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databricks/preview:vNetPeering", name, args ?? new VNetPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VNetPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databricks/preview:vNetPeering", name, null, MakeResourceOptions(options, id))
        {
        }
