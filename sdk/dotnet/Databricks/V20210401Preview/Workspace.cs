...
namespace Pulumi.AzureNative.Databricks.V20210401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databricks/v20210401preview:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:databricks/v20230201:Workspace to guarantee forwards compatibility.")]
    ...
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20210401preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20210401preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
