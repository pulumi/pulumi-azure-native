...
namespace Pulumi.AzureNative.Databricks.V20210401Preview
{
    ...
    public partial class VNetPeering : global::Pulumi.CustomResource
    {
        ...
        public VNetPeering(string name, VNetPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20210401preview:vNetPeering", name, args ?? new VNetPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VNetPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20210401preview:vNetPeering", name, null, MakeResourceOptions(options, id))
        {
        }
