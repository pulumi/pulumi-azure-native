...
namespace Pulumi.AzureNative.Databricks.V20230915Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databricks/v20230915preview:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20230915preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20230915preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Databricks.V20230915Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether data plane (clusters) to control plane communication happen over private endpoint. Supported values are 'AllRules' and 'NoAzureDatabricksRules'. 'NoAzureServiceRules' value is for internal use only.
        /// </summary>
        [Input("requiredNsgRules")]
        public InputUnion<string, Pulumi.AzureNative.Databricks.V20230915Preview.RequiredNsgRules>? RequiredNsgRules { get; set; }
