...
namespace Pulumi.AzureNative.Databricks.V20230915Preview
{
    /// <summary>
    /// Peerings in a VirtualNetwork resource
    /// </summary>
    [AzureNativeResourceType("azure-native:databricks/v20230915preview:VNetPeering")]
    public partial class VNetPeering : global::Pulumi.CustomResource
    {
        ...
        public VNetPeering(string name, VNetPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20230915preview:VNetPeering", name, args ?? new VNetPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VNetPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20230915preview:VNetPeering", name, null, MakeResourceOptions(options, id))
        {
        }
