...
namespace Pulumi.AzureNative.Databricks.V20221001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databricks/v20221001preview:vNetPeering")]
    public partial class VNetPeering : Pulumi.CustomResource
    {
        ...
        public VNetPeering(string name, VNetPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20221001preview:vNetPeering", name, args ?? new VNetPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VNetPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20221001preview:vNetPeering", name, null, MakeResourceOptions(options, id))
        {
        }
