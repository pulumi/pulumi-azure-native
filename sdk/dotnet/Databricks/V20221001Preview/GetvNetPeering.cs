...
namespace Pulumi.AzureNative.Databricks.V20221001Preview
{
    public static class GetvNetPeering
    {
        ...
        public static Task<GetvNetPeeringResult> InvokeAsync(GetvNetPeeringArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetvNetPeeringResult>("azure-native:databricks/v20221001preview:getvNetPeering", args ?? new GetvNetPeeringArgs(), options.WithDefaults());

        /// <summary>
        /// Peerings in a VirtualNetwork resource
        /// </summary>
        public static Output<GetvNetPeeringResult> Invoke(GetvNetPeeringInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetvNetPeeringResult>("azure-native:databricks/v20221001preview:getvNetPeering", args ?? new GetvNetPeeringInvokeArgs(), options.WithDefaults());
    }
