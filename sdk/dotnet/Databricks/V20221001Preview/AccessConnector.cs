...
namespace Pulumi.AzureNative.Databricks.V20221001Preview
{
    ...
    /// {
    ///     var accessConnector = new AzureNative.Databricks.V20221001Preview.AccessConnector("accessConnector", new()
    ///     {
    ...
    public partial class AccessConnector : global::Pulumi.CustomResource
    {
        ...
        public AccessConnector(string name, AccessConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20221001preview:AccessConnector", name, args ?? new AccessConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20221001preview:AccessConnector", name, null, MakeResourceOptions(options, id))
        {
        }
