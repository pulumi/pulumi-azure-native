...
namespace Pulumi.AzureNative.Databricks.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databricks/v20240901preview:AccessConnector")]
    public partial class AccessConnector : global::Pulumi.CustomResource
    {
        ...
        public AccessConnector(string name, AccessConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240901preview:AccessConnector", name, args ?? new AccessConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20240901preview:AccessConnector", name, null, MakeResourceOptions(options, id))
        {
        }
