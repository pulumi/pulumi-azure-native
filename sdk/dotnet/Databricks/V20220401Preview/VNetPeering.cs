...
namespace Pulumi.AzureNative.Databricks.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databricks/v20220401preview:vNetPeering is being removed in the next major version of this provider. Please upgrade to azure-native:databricks/v20230201:vNetPeering to guarantee forwards compatibility.")]
    ...
    public partial class VNetPeering : global::Pulumi.CustomResource
    {
        ...
        public VNetPeering(string name, VNetPeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20220401preview:vNetPeering", name, args ?? new VNetPeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VNetPeering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databricks/v20220401preview:vNetPeering", name, null, MakeResourceOptions(options, id))
        {
        }
