...
namespace Pulumi.AzureRM.ResourceGraph.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var graphQuery = new AzureRM.ResourceGraph.Latest.GraphQuery("graphQuery", new AzureRM.ResourceGraph.Latest.GraphQueryArgs
    ///         {
    ...
    public partial class GraphQuery : Pulumi.CustomResource
    {
        ...
        public GraphQuery(string name, GraphQueryArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resourcegraph/latest:GraphQuery", name, args ?? new GraphQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resourcegraph/latest:GraphQuery", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:resourcegraph/v20180901preview:GraphQuery"},
