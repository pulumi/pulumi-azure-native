...
namespace Pulumi.AzureRM.ResourceGraph.Latest
{
    public static class GetGraphQuery
    {
        public static Task<GetGraphQueryResult> InvokeAsync(GetGraphQueryArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGraphQueryResult>("azurerm:resourcegraph/latest:getGraphQuery", args ?? new GetGraphQueryArgs(), options.WithVersion());
    }
