...
namespace Pulumi.AzureRM.ResourceGraph.V20200401Preview
{
    public static class GetGraphQuery
    {
        public static Task<GetGraphQueryResult> InvokeAsync(GetGraphQueryArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGraphQueryResult>("azurerm:resourcegraph/v20200401preview:getGraphQuery", args ?? new GetGraphQueryArgs(), options.WithVersion());
    }
