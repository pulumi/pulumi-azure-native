...
namespace Pulumi.AzureNative.ResourceGraph.V20200401Preview
{
    ...
    /// {
    ///     var graphQuery = new AzureNative.ResourceGraph.V20200401Preview.GraphQuery("graphQuery", new()
    ///     {
    ...
    public partial class GraphQuery : global::Pulumi.CustomResource
    {
        ...
        public GraphQuery(string name, GraphQueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resourcegraph/v20200401preview:GraphQuery", name, args ?? new GraphQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resourcegraph/v20200401preview:GraphQuery", name, null, MakeResourceOptions(options, id))
        {
        }
