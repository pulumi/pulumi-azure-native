...
namespace Pulumi.AzureNative.ResourceGraph.V20221001
{
    /// <summary>
    /// Graph Query entity definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:resourcegraph/v20221001:GraphQuery")]
    public partial class GraphQuery : global::Pulumi.CustomResource
    {
        ...
        public GraphQuery(string name, GraphQueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resourcegraph/v20221001:GraphQuery", name, args ?? new GraphQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resourcegraph/v20221001:GraphQuery", name, null, MakeResourceOptions(options, id))
        {
        }
