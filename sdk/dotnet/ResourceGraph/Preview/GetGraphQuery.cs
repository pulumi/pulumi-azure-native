...
namespace Pulumi.AzureRM.ResourceGraph.Preview
{
    public static class GetGraphQuery
    {
        public static Task<GetGraphQueryResult> InvokeAsync(GetGraphQueryArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGraphQueryResult>("azurerm:resourcegraph/preview:getGraphQuery", args ?? new GetGraphQueryArgs(), options.WithVersion());
    }
