...
namespace Pulumi.AzureRM.ResourceGraph.Preview
{
    ...
    public partial class GraphQuery : Pulumi.CustomResource
    {
        ...
        public GraphQuery(string name, GraphQueryArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resourcegraph/preview:GraphQuery", name, args ?? new GraphQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resourcegraph/preview:GraphQuery", name, null, MakeResourceOptions(options, id))
        {
        }
