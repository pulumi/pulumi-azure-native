...
namespace Pulumi.AzureNative.ResourceGraph
{
    ...
    public partial class GraphQuery : global::Pulumi.CustomResource
    {
        ...
        public GraphQuery(string name, GraphQueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resourcegraph:GraphQuery", name, args ?? new GraphQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resourcegraph:GraphQuery", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_resourcegraph_v20180901preview:resourcegraph:GraphQuery" },
                    new global::Pulumi.Alias { Type = "azure-native_resourcegraph_v20190401:resourcegraph:GraphQuery" },
                    new global::Pulumi.Alias { Type = "azure-native_resourcegraph_v20200401preview:resourcegraph:GraphQuery" },
                    new global::Pulumi.Alias { Type = "azure-native_resourcegraph_v20210301:resourcegraph:GraphQuery" },
                    new global::Pulumi.Alias { Type = "azure-native_resourcegraph_v20221001:resourcegraph:GraphQuery" },
                    new global::Pulumi.Alias { Type = "azure-native_resourcegraph_v20240401:resourcegraph:GraphQuery" },
                },
            };
