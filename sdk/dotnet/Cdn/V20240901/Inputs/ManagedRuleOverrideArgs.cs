...
namespace Pulumi.AzureNative.Cdn.V20240901.Inputs
{
    ...
    public sealed class ManagedRuleOverrideArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240901.ActionType>? Action { get; set; }

        /// <summary>
        /// Describes if the managed rule is in enabled or disabled state. Defaults to Disabled if not specified.
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240901.ManagedRuleEnabledState>? EnabledState { get; set; }
