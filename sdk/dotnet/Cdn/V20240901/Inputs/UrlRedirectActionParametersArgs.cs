...
namespace Pulumi.AzureNative.Cdn.V20240901.Inputs
{
    ...
    public sealed class UrlRedirectActionParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240901.DestinationProtocol>? DestinationProtocol { get; set; }

        /// <summary>
        /// The redirect type the rule will use when redirecting traffic.
        /// </summary>
        [Input("redirectType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240901.RedirectType> RedirectType { get; set; } = null!;
