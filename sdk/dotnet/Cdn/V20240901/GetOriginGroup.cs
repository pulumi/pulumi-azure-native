...
namespace Pulumi.AzureNative.Cdn.V20240901
{
    public static class GetOriginGroup
    {
        ...
        public static Task<GetOriginGroupResult> InvokeAsync(GetOriginGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOriginGroupResult>("azure-native:cdn/v20240901:getOriginGroup", args ?? new GetOriginGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing origin group within an endpoint.
        /// </summary>
        public static Output<GetOriginGroupResult> Invoke(GetOriginGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOriginGroupResult>("azure-native:cdn/v20240901:getOriginGroup", args ?? new GetOriginGroupInvokeArgs(), options.WithDefaults());
    }
