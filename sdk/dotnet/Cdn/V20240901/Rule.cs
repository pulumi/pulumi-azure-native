...
namespace Pulumi.AzureNative.Cdn.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240901:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240901:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240901:Rule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240901.MatchProcessingBehavior>? MatchProcessingBehavior { get; set; }
