...
namespace Pulumi.AzureNative.Cdn.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240901:AFDEndpoint")]
    public partial class AFDEndpoint : global::Pulumi.CustomResource
    {
        ...
        public AFDEndpoint(string name, AFDEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240901:AFDEndpoint", name, args ?? new AFDEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240901:AFDEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AFDEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240901.AutoGeneratedDomainNameLabelScope>? AutoGeneratedDomainNameLabelScope { get; set; }
