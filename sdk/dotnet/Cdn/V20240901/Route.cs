...
namespace Pulumi.AzureNative.Cdn.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240901:Route")]
    public partial class Route : global::Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240901:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240901:Route", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240901.ForwardingProtocol>? ForwardingProtocol { get; set; }

        /// <summary>
        /// Whether to automatically redirect HTTP traffic to HTTPS traffic. Note that this is a easy way to set up this rule and it will be the first rule that gets executed.
        /// </summary>
        [Input("httpsRedirect")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240901.HttpsRedirect>? HttpsRedirect { get; set; }

        /// <summary>
        /// whether this route will be linked to the default endpoint domain.
        /// </summary>
        [Input("linkToDefaultDomain")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240901.LinkToDefaultDomain>? LinkToDefaultDomain { get; set; }
        ...
        private InputList<Union<string, Pulumi.AzureNative.Cdn.V20240901.AFDEndpointProtocols>>? _supportedProtocols;

        /// <summary>
        /// List of supported protocols for this route.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Cdn.V20240901.AFDEndpointProtocols>> SupportedProtocols
        {
            get => _supportedProtocols ?? (_supportedProtocols = new InputList<Union<string, Pulumi.AzureNative.Cdn.V20240901.AFDEndpointProtocols>>());
