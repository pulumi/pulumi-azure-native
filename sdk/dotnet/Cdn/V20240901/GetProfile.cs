...
namespace Pulumi.AzureNative.Cdn.V20240901
{
    public static class GetProfile
    {
        ...
        public static Task<GetProfileResult> InvokeAsync(GetProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProfileResult>("azure-native:cdn/v20240901:getProfile", args ?? new GetProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an Azure Front Door Standard or Azure Front Door Premium or CDN profile with the specified profile name under the specified subscription and resource group.
        /// </summary>
        public static Output<GetProfileResult> Invoke(GetProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProfileResult>("azure-native:cdn/v20240901:getProfile", args ?? new GetProfileInvokeArgs(), options.WithDefaults());
    }
