...
namespace Pulumi.AzureNative.Cdn.V20240722Preview
{
    public static class GetEdgeActionVersion
    {
        ...
        public static Task<GetEdgeActionVersionResult> InvokeAsync(GetEdgeActionVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEdgeActionVersionResult>("azure-native:cdn/v20240722preview:getEdgeActionVersion", args ?? new GetEdgeActionVersionArgs(), options.WithDefaults());

        /// <summary>
        /// Get EdgeActionVersion resource
        /// </summary>
        public static Output<GetEdgeActionVersionResult> Invoke(GetEdgeActionVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEdgeActionVersionResult>("azure-native:cdn/v20240722preview:getEdgeActionVersion", args ?? new GetEdgeActionVersionInvokeArgs(), options.WithDefaults());
