...
namespace Pulumi.AzureNative.Cdn.V20171012
{
    ...
    [AzureNativeResourceType("azure-native:cdn/v20171012:CustomDomain")]
    public partial class CustomDomain : global::Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20171012:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20171012:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
