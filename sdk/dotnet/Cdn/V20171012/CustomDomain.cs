...
namespace Pulumi.AzureNextGen.Cdn.V20171012
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cdn/v20171012:CustomDomain")]
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn/v20171012:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn/v20171012:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
