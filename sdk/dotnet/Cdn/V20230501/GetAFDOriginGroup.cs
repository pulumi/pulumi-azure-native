...
namespace Pulumi.AzureNative.Cdn.V20230501
{
    public static class GetAFDOriginGroup
    {
        ...
        public static Task<GetAFDOriginGroupResult> InvokeAsync(GetAFDOriginGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAFDOriginGroupResult>("azure-native:cdn/v20230501:getAFDOriginGroup", args ?? new GetAFDOriginGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing origin group within a profile.
        /// </summary>
        public static Output<GetAFDOriginGroupResult> Invoke(GetAFDOriginGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAFDOriginGroupResult>("azure-native:cdn/v20230501:getAFDOriginGroup", args ?? new GetAFDOriginGroupInvokeArgs(), options.WithDefaults());
    }
