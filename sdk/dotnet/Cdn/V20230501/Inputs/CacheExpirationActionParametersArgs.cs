...
namespace Pulumi.AzureNative.Cdn.V20230501.Inputs
{
    ...
    public sealed class CacheExpirationActionParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20230501.CacheBehavior> CacheBehavior { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20230501.CacheType> CacheType { get; set; } = null!;
