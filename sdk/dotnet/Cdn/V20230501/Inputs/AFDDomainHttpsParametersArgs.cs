...
namespace Pulumi.AzureNative.Cdn.V20230501.Inputs
{
    ...
    public sealed class AFDDomainHttpsParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20230501.AfdCertificateType> CertificateType { get; set; } = null!;

        /// <summary>
        /// TLS protocol version that will be used for Https
        /// </summary>
        [Input("minimumTlsVersion")]
        public Input<Pulumi.AzureNative.Cdn.V20230501.AfdMinimumTlsVersion>? MinimumTlsVersion { get; set; }
