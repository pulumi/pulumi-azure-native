...
namespace Pulumi.AzureNative.Cdn.V20230501
{
    public static class GetPolicy
    {
        ...
        public static Task<GetPolicyResult> InvokeAsync(GetPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicyResult>("azure-native:cdn/v20230501:getPolicy", args ?? new GetPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve protection policy with specified name within a resource group.
        /// </summary>
        public static Output<GetPolicyResult> Invoke(GetPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicyResult>("azure-native:cdn/v20230501:getPolicy", args ?? new GetPolicyInvokeArgs(), options.WithDefaults());
