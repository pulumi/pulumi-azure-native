...
namespace Pulumi.AzureNative.Cdn.V20230501
{
    public static class GetAFDCustomDomain
    {
        ...
        public static Task<GetAFDCustomDomainResult> InvokeAsync(GetAFDCustomDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAFDCustomDomainResult>("azure-native:cdn/v20230501:getAFDCustomDomain", args ?? new GetAFDCustomDomainArgs(), options.WithDefaults());
