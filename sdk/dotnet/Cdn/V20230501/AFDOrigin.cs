...
namespace Pulumi.AzureNative.Cdn.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20230501:AFDOrigin")]
    public partial class AFDOrigin : global::Pulumi.CustomResource
    {
        ...
        public AFDOrigin(string name, AFDOriginArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20230501:AFDOrigin", name, args ?? new AFDOriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDOrigin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20230501:AFDOrigin", name, null, MakeResourceOptions(options, id))
        {
        }
