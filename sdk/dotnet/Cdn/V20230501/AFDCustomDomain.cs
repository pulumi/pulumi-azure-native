...
namespace Pulumi.AzureNative.Cdn.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20230501:AFDCustomDomain")]
    public partial class AFDCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public AFDCustomDomain(string name, AFDCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20230501:AFDCustomDomain", name, args ?? new AFDCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20230501:AFDCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
