...
namespace Pulumi.AzureNative.Cdn.V20210601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cdn/v20210601:AFDCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:AFDCustomDomain to guarantee forwards compatibility.")]
    ...
    public partial class AFDCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public AFDCustomDomain(string name, AFDCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20210601:AFDCustomDomain", name, args ?? new AFDCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20210601:AFDCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
