...
namespace Pulumi.AzureNative.Cdn.V20210601.Inputs
{
    ...
    /// </summary>
    public sealed class ClientPortMatchConditionParametersArgs : Pulumi.ResourceArgs
    {
        [Input("matchValues")]
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20210601.ClientPortOperator> Operator { get; set; } = null!;
