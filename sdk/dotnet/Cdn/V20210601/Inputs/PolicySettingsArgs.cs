...
namespace Pulumi.AzureNative.Cdn.V20210601.Inputs
{
    ...
    public sealed class PolicySettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20210601.PolicyEnabledState>? EnabledState { get; set; }

        /// <summary>
        /// Describes if it is in detection mode or prevention mode at policy level.
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20210601.PolicyMode>? Mode { get; set; }
