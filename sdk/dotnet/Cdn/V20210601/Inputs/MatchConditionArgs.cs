...
namespace Pulumi.AzureNative.Cdn.V20210601.Inputs
{
    ...
    public sealed class MatchConditionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20210601.WafMatchVariable> MatchVariable { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20210601.Operator> Operator { get; set; } = null!;
        ...
        [Input("transforms")]
        private InputList<Union<string, Pulumi.AzureNative.Cdn.V20210601.TransformType>>? _transforms;

        /// <summary>
        /// List of transforms.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Cdn.V20210601.TransformType>> Transforms
        {
            get => _transforms ?? (_transforms = new InputList<Union<string, Pulumi.AzureNative.Cdn.V20210601.TransformType>>());
