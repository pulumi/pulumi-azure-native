...
namespace Pulumi.AzureNative.Cdn.V20210601
{
    public static class GetProfile
    {
        ...
        public static Task<GetProfileResult> InvokeAsync(GetProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProfileResult>("azure-native:cdn/v20210601:getProfile", args ?? new GetProfileArgs(), options.WithVersion());

        /// <summary>
        /// A profile is a logical grouping of endpoints that share the same settings.
        /// </summary>
        public static Output<GetProfileResult> Invoke(GetProfileInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProfileResult>("azure-native:cdn/v20210601:getProfile", args ?? new GetProfileInvokeArgs(), options.WithVersion());
    }
