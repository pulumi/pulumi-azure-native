...
namespace Pulumi.AzureNative.Cdn.V20210601
{
    ...
    public partial class Route : global::Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20210601:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20210601:Route", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("httpsRedirect")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20210601.HttpsRedirect>? HttpsRedirect { get; set; }

        /// <summary>
        /// whether this route will be linked to the default endpoint domain.
        /// </summary>
        [Input("linkToDefaultDomain")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20210601.LinkToDefaultDomain>? LinkToDefaultDomain { get; set; }
        ...
        private InputList<Union<string, Pulumi.AzureNative.Cdn.V20210601.AFDEndpointProtocols>>? _supportedProtocols;

        /// <summary>
        /// List of supported protocols for this route.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Cdn.V20210601.AFDEndpointProtocols>> SupportedProtocols
        {
            get => _supportedProtocols ?? (_supportedProtocols = new InputList<Union<string, Pulumi.AzureNative.Cdn.V20210601.AFDEndpointProtocols>>());
