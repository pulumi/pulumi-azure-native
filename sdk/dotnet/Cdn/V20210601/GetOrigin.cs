...
namespace Pulumi.AzureNative.Cdn.V20210601
{
    public static class GetOrigin
    {
        ...
        public static Task<GetOriginResult> InvokeAsync(GetOriginArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOriginResult>("azure-native:cdn/v20210601:getOrigin", args ?? new GetOriginArgs(), options.WithDefaults());

        /// <summary>
        /// CDN origin is the source of the content being delivered via CDN. When the edge nodes represented by an endpoint do not have the requested content cached, they attempt to fetch it from one or more of the configured origins.
        /// </summary>
        public static Output<GetOriginResult> Invoke(GetOriginInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOriginResult>("azure-native:cdn/v20210601:getOrigin", args ?? new GetOriginInvokeArgs(), options.WithDefaults());
    }
