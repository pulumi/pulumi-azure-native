...
namespace Pulumi.AzureNative.Cdn.V20210601
{
    public static class GetOriginGroup
    {
        ...
        public static Task<GetOriginGroupResult> InvokeAsync(GetOriginGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOriginGroupResult>("azure-native:cdn/v20210601:getOriginGroup", args ?? new GetOriginGroupArgs(), options.WithVersion());

        /// <summary>
        /// Origin group comprising of origins is used for load balancing to origins when the content cannot be served from CDN.
        /// </summary>
        public static Output<GetOriginGroupResult> Invoke(GetOriginGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOriginGroupResult>("azure-native:cdn/v20210601:getOriginGroup", args ?? new GetOriginGroupInvokeArgs(), options.WithVersion());
    }
