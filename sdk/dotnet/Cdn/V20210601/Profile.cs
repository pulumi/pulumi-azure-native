...
namespace Pulumi.AzureNative.Cdn.V20210601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cdn/v20210601:Profile is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Profile to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:cdn/v20210601:Profile")]
    public partial class Profile : global::Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20210601:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20210601:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
