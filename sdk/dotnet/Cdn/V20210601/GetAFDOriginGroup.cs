...
{
    [Obsolete(@"azure-native:cdn/v20210601:AFDOriginGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:AFDOriginGroup to guarantee forwards compatibility.")]
    public static class GetAFDOriginGroup
    {
        ...
        public static Task<GetAFDOriginGroupResult> InvokeAsync(GetAFDOriginGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAFDOriginGroupResult>("azure-native:cdn/v20210601:getAFDOriginGroup", args ?? new GetAFDOriginGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing origin group within a profile.
        /// </summary>
        public static Output<GetAFDOriginGroupResult> Invoke(GetAFDOriginGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAFDOriginGroupResult>("azure-native:cdn/v20210601:getAFDOriginGroup", args ?? new GetAFDOriginGroupInvokeArgs(), options.WithDefaults());
    }
