...
namespace Pulumi.AzureRM.Cdn
{
    ...
    public partial class ProfileEndpointOriginGroup : Pulumi.CustomResource
    {
        ...
        private ProfileEndpointOriginGroup(string name, Input<string> id, ProfileEndpointOriginGroupState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:cdn:ProfileEndpointOriginGroup", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ProfileEndpointOriginGroup Get(string name, Input<string> id, ProfileEndpointOriginGroupState? state = null, CustomResourceOptions? options = null)
        {
            return new ProfileEndpointOriginGroup(name, id, state, options);
        }
    }
    ...
    public sealed class ProfileEndpointOriginGroupState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource name.
        /// </summary>
        ...
        public Input<Inputs.OriginGroupPropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public ProfileEndpointOriginGroupState()
        {
        }
    }
}
