...
namespace Pulumi.AzureNative.Cdn.Latest.Inputs
{
    ...
    public sealed class UrlRedirectActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.Latest.DestinationProtocol>? DestinationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.Latest.RedirectType> RedirectType { get; set; } = null!;
