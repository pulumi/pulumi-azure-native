...
namespace Pulumi.AzureNextGen.Cdn.Latest.Inputs
{
    ...
    public sealed class UrlRedirectActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.Latest.DestinationProtocol>? DestinationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.Latest.RedirectType> RedirectType { get; set; } = null!;
