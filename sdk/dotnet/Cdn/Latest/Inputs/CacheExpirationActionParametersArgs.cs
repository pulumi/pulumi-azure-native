...
namespace Pulumi.AzureNative.Cdn.Latest.Inputs
{
    ...
    public sealed class CacheExpirationActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.Latest.CacheBehavior> CacheBehavior { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.Latest.CacheType> CacheType { get; set; } = null!;
