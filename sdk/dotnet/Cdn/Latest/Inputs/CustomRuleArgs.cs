...
namespace Pulumi.AzureNative.Cdn.Latest.Inputs
{
    ...
    public sealed class CustomRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.Latest.ActionType> Action { get; set; } = null!;

        /// <summary>
        /// Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.Latest.CustomRuleEnabledState>? EnabledState { get; set; }
