...
namespace Pulumi.AzureNative.Cdn.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:cdn:AFDOrigin'.")]
    [AzureNativeResourceType("azure-native:cdn/latest:AFDOrigin")]
    public partial class AFDOrigin : Pulumi.CustomResource
    {
        ...
        public AFDOrigin(string name, AFDOriginArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/latest:AFDOrigin", name, args ?? new AFDOriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDOrigin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/latest:AFDOrigin", name, null, MakeResourceOptions(options, id))
        {
        }
