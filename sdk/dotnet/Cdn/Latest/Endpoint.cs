...
namespace Pulumi.AzureRM.Cdn.Latest
{
    ...
    ///                         Actions = 
    ///                         {
    ///                             new AzureRM.Cdn.Latest.Inputs.DeliveryRuleActionArgs
    ///                             {
    ...
    ///                         Conditions = 
    ///                         {
    ///                             new AzureRM.Cdn.Latest.Inputs.DeliveryRuleConditionArgs
    ///                             {
    ///                                 Name = "RemoteAddress",
    ///                             },
    ///                         },
    ...
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/latest:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/latest:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
