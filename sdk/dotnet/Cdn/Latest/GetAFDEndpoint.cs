...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getAFDEndpoint'.")]
    public static class GetAFDEndpoint
    {
        ...
        public static Task<GetAFDEndpointResult> InvokeAsync(GetAFDEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAFDEndpointResult>("azure-native:cdn/latest:getAFDEndpoint", args ?? new GetAFDEndpointArgs(), options.WithVersion());
    }
