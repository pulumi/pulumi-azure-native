...
namespace Pulumi.AzureNative.Cdn
{
    ...
    public partial class RuleSet : global::Pulumi.CustomResource
    {
        ...
        public RuleSet(string name, RuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn:RuleSet", name, args ?? new RuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn:RuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cdn/v20250101preview:RuleSet" },
                    new global::Pulumi.Alias { Type = "azure-native:cdn/v20250415:RuleSet" },
                    new global::Pulumi.Alias { Type = "azure-native:cdn/v20250601:RuleSet" },
                    new global::Pulumi.Alias { Type = "azure-native:cdn/v20250701preview:RuleSet" },
                    new global::Pulumi.Alias { Type = "azure-native:cdn/v20250901preview:RuleSet" },
                    new global::Pulumi.Alias { Type = "azure-native:cdn/v20251201:RuleSet" },
                    new global::Pulumi.Alias { Type = "azure-native:cdn/v20260401preview:RuleSet" },
                },
            };
