...
namespace Pulumi.AzureNative.Cdn.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240501preview:KeyGroup")]
    public partial class KeyGroup : global::Pulumi.CustomResource
    {
        ...
        public KeyGroup(string name, KeyGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240501preview:KeyGroup", name, args ?? new KeyGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240501preview:KeyGroup", name, null, MakeResourceOptions(options, id))
        {
        }
