...
namespace Pulumi.AzureNative.Cdn.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240501preview:AFDCustomDomain")]
    public partial class AFDCustomDomain : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("mtlsSettings")]
        public Output<Outputs.AFDDomainMtlsParametersResponse?> MtlsSettings { get; private set; } = null!;
        ...
        public AFDCustomDomain(string name, AFDCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240501preview:AFDCustomDomain", name, args ?? new AFDCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240501preview:AFDCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AFDCustomDomainArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mtlsSettings")]
        public Input<Inputs.AFDDomainMtlsParametersArgs>? MtlsSettings { get; set; }
