...
namespace Pulumi.AzureNative.Cdn.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240501preview:Route")]
    public partial class Route : global::Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240501preview:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240501preview:Route", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240501Preview.ForwardingProtocol>? ForwardingProtocol { get; set; }

        /// <summary>
        /// Whether or not gRPC is enabled on this route. Permitted values are 'Enabled' or 'Disabled'
        /// </summary>
        [Input("grpcState")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240501Preview.AFDRouteGrpcState>? GrpcState { get; set; }

        /// <summary>
        /// Whether to automatically redirect HTTP traffic to HTTPS traffic. Note that this is a easy way to set up this rule and it will be the first rule that gets executed.
        /// </summary>
        [Input("httpsRedirect")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240501Preview.HttpsRedirect>? HttpsRedirect { get; set; }

        /// <summary>
        /// whether this route will be linked to the default endpoint domain.
        /// </summary>
        [Input("linkToDefaultDomain")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240501Preview.LinkToDefaultDomain>? LinkToDefaultDomain { get; set; }
        ...
        private InputList<Union<string, Pulumi.AzureNative.Cdn.V20240501Preview.AFDEndpointProtocols>>? _supportedProtocols;

        /// <summary>
        /// List of supported protocols for this route.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Cdn.V20240501Preview.AFDEndpointProtocols>> SupportedProtocols
        {
            get => _supportedProtocols ?? (_supportedProtocols = new InputList<Union<string, Pulumi.AzureNative.Cdn.V20240501Preview.AFDEndpointProtocols>>());
