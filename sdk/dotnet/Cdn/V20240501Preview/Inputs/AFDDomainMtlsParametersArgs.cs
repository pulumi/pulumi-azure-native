...
namespace Pulumi.AzureNative.Cdn.V20240501Preview.Inputs
{
    ...
    public sealed class AFDDomainMtlsParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240501Preview.EnabledState>? CertificatePassthrough { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240501Preview.EnabledState>? CertificateValidation { get; set; }
        ...
        /// </summary>
        [Input("ocsp")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240501Preview.EnabledState>? Ocsp { get; set; }
