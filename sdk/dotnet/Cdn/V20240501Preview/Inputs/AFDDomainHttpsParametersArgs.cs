...
namespace Pulumi.AzureNative.Cdn.V20240501Preview.Inputs
{
    ...
    public sealed class AFDDomainHttpsParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240501Preview.AfdCertificateType> CertificateType { get; set; } = null!;

        /// <summary>
        /// cipher suite set type that will be used for Https
        /// </summary>
        [Input("cipherSuiteSetType")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240501Preview.AfdCipherSuiteSetType>? CipherSuiteSetType { get; set; }
        ...
        public Input<Pulumi.AzureNative.Cdn.V20240501Preview.AfdMinimumTlsVersion>? MinimumTlsVersion { get; set; }
