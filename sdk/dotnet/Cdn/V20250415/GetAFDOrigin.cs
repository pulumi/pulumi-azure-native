...
namespace Pulumi.AzureNative.Cdn.V20250415
{
    public static class GetAFDOrigin
    {
        ...
        public static Task<GetAFDOriginResult> InvokeAsync(GetAFDOriginArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAFDOriginResult>("azure-native:cdn/v20250415:getAFDOrigin", args ?? new GetAFDOriginArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing origin within an origin group.
        /// </summary>
        public static Output<GetAFDOriginResult> Invoke(GetAFDOriginInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAFDOriginResult>("azure-native:cdn/v20250415:getAFDOrigin", args ?? new GetAFDOriginInvokeArgs(), options.WithDefaults());
