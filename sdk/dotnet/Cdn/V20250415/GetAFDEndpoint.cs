...
namespace Pulumi.AzureNative.Cdn.V20250415
{
    public static class GetAFDEndpoint
    {
        ...
        public static Task<GetAFDEndpointResult> InvokeAsync(GetAFDEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAFDEndpointResult>("azure-native:cdn/v20250415:getAFDEndpoint", args ?? new GetAFDEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing AzureFrontDoor endpoint with the specified endpoint name under the specified subscription, resource group and profile.
        /// </summary>
        public static Output<GetAFDEndpointResult> Invoke(GetAFDEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAFDEndpointResult>("azure-native:cdn/v20250415:getAFDEndpoint", args ?? new GetAFDEndpointInvokeArgs(), options.WithDefaults());
