...
namespace Pulumi.AzureNative.Cdn.V20250415.Inputs
{
    ...
    public sealed class UrlRedirectActionParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20250415.DestinationProtocol>? DestinationProtocol { get; set; }

        /// <summary>
        /// The redirect type the rule will use when redirecting traffic.
        /// </summary>
        [Input("redirectType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20250415.RedirectType> RedirectType { get; set; } = null!;
