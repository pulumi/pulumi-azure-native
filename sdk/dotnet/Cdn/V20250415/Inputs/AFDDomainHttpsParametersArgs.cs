...
namespace Pulumi.AzureNative.Cdn.V20250415.Inputs
{
    ...
    public sealed class AFDDomainHttpsParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20250415.AfdCertificateType> CertificateType { get; set; } = null!;

        /// <summary>
        /// cipher suite set type that will be used for Https
        /// </summary>
        [Input("cipherSuiteSetType")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20250415.AfdCipherSuiteSetType>? CipherSuiteSetType { get; set; }
        ...
        public Input<Pulumi.AzureNative.Cdn.V20250415.AfdMinimumTlsVersion>? MinimumTlsVersion { get; set; }
