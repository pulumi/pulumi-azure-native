...
namespace Pulumi.AzureNative.Cdn.V20250415.Inputs
{
    ...
    public sealed class PostArgsMatchConditionParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20250415.PostArgsOperator> Operator { get; set; } = null!;
        ...
        [Input("transforms")]
        private InputList<Union<string, Pulumi.AzureNative.Cdn.V20250415.Transform>>? _transforms;

        /// <summary>
        /// List of transforms
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Cdn.V20250415.Transform>> Transforms
        {
            get => _transforms ?? (_transforms = new InputList<Union<string, Pulumi.AzureNative.Cdn.V20250415.Transform>>());
