...
namespace Pulumi.AzureNextGen.Cdn
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cdn:Origin")]
    public partial class Origin : Pulumi.CustomResource
    {
        ...
        public Origin(string name, OriginArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn:Origin", name, args ?? new OriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Origin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn:Origin", name, null, MakeResourceOptions(options, id))
        {
        }
