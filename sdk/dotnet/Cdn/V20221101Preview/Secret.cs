...
namespace Pulumi.AzureNative.Cdn.V20221101Preview
{
    ...
    /// {
    ///     var secret = new AzureNative.Cdn.V20221101Preview.Secret("secret", new()
    ///     {
    ///         Parameters = new AzureNative.Cdn.V20221101Preview.Inputs.CustomerCertificateParametersArgs
    ///         {
    ///             SecretSource = new AzureNative.Cdn.V20221101Preview.Inputs.ResourceReferenceArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20221101preview:Secret")]
    public partial class Secret : global::Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20221101preview:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20221101preview:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
