...
namespace Pulumi.AzureNative.Cdn.V20221101Preview
{
    ...
    /// {
    ///     var afdOrigin = new AzureNative.Cdn.V20221101Preview.AFDOrigin("afdOrigin", new()
    ///     {
    ...
    public partial class AFDOrigin : global::Pulumi.CustomResource
    {
        ...
        public AFDOrigin(string name, AFDOriginArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20221101preview:AFDOrigin", name, args ?? new AFDOriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDOrigin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20221101preview:AFDOrigin", name, null, MakeResourceOptions(options, id))
        {
        }
