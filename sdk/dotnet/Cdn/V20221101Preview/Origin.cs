...
namespace Pulumi.AzureNative.Cdn.V20221101Preview
{
    ...
    /// {
    ///     var origin = new AzureNative.Cdn.V20221101Preview.Origin("origin", new()
    ///     {
    ///         Enabled = true,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20221101preview:Origin")]
    public partial class Origin : global::Pulumi.CustomResource
    {
        ...
        public Origin(string name, OriginArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20221101preview:Origin", name, args ?? new OriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Origin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20221101preview:Origin", name, null, MakeResourceOptions(options, id))
        {
        }
