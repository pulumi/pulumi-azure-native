...
namespace Pulumi.AzureNative.Cdn.V20221101Preview.Inputs
{
    ...
    public sealed class RequestHeaderMatchConditionParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20221101Preview.RequestHeaderOperator> Operator { get; set; } = null!;
        ...
        [Input("transforms")]
        private InputList<Union<string, Pulumi.AzureNative.Cdn.V20221101Preview.Transform>>? _transforms;

        /// <summary>
        /// List of transforms
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Cdn.V20221101Preview.Transform>> Transforms
        {
            get => _transforms ?? (_transforms = new InputList<Union<string, Pulumi.AzureNative.Cdn.V20221101Preview.Transform>>());
