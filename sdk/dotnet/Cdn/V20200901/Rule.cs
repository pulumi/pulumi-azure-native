...
namespace Pulumi.AzureNative.Cdn.V20200901
{
    ...
    /// {
    ///     var rule = new AzureNative.Cdn.V20200901.Rule("rule", new()
    ///     {
    ///         Actions = new[]
    ///         {
    ///             new AzureNative.Cdn.V20200901.Inputs.DeliveryRuleResponseHeaderActionArgs
    ///             {
    ///                 Name = "ModifyResponseHeader",
    ///                 Parameters = new AzureNative.Cdn.V20200901.Inputs.HeaderActionParametersArgs
    ///                 {
    ...
    ///         Conditions = new[]
    ///         {
    ///             new AzureNative.Cdn.V20200901.Inputs.DeliveryRuleRequestMethodConditionArgs
    ///             {
    ///                 Name = "RequestMethod",
    ///                 Parameters = new AzureNative.Cdn.V20200901.Inputs.RequestMethodMatchConditionParametersArgs
    ///                 {
    ///                     MatchValues = new[]
    ///                     {
    ///                         "GET",
    ...
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200901:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200901:Rule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20200901.MatchProcessingBehavior>? MatchProcessingBehavior { get; set; }
