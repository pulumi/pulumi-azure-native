...
{
    [Obsolete(@"azure-native:cdn/v20200901:RuleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:RuleSet to guarantee forwards compatibility.")]
    public static class GetRuleSet
    {
        ...
        public static Task<GetRuleSetResult> InvokeAsync(GetRuleSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleSetResult>("azure-native:cdn/v20200901:getRuleSet", args ?? new GetRuleSetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing AzureFrontDoor rule set with the specified rule set name under the specified subscription, resource group and profile.
        /// </summary>
        public static Output<GetRuleSetResult> Invoke(GetRuleSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRuleSetResult>("azure-native:cdn/v20200901:getRuleSet", args ?? new GetRuleSetInvokeArgs(), options.WithDefaults());
    }
