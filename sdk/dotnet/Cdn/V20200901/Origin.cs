...
namespace Pulumi.AzureNative.Cdn.V20200901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cdn/v20200901:Origin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Origin to guarantee forwards compatibility.")]
    ...
    public partial class Origin : global::Pulumi.CustomResource
    {
        ...
        public Origin(string name, OriginArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200901:Origin", name, args ?? new OriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Origin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200901:Origin", name, null, MakeResourceOptions(options, id))
        {
        }
