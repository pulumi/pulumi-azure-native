...
namespace Pulumi.AzureNative.Cdn.V20200901
{
    ...
    /// {
    ///     var originGroup = new AzureNative.Cdn.V20200901.OriginGroup("originGroup", new()
    ///     {
    ...
    ///             ProbeProtocol = AzureNative.Cdn.V20200901.ProbeProtocol.Http,
    ///             ProbeRequestType = AzureNative.Cdn.V20200901.HealthProbeRequestType.GET,
    ///         },
    ...
    ///         ResponseBasedOriginErrorDetectionSettings = new AzureNative.Cdn.V20200901.Inputs.ResponseBasedOriginErrorDetectionParametersArgs
    ///         {
    ///             ResponseBasedDetectedErrorTypes = AzureNative.Cdn.V20200901.ResponseBasedDetectedErrorTypes.TcpErrorsOnly,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20200901:OriginGroup")]
    public partial class OriginGroup : global::Pulumi.CustomResource
    {
        ...
        public OriginGroup(string name, OriginGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200901:OriginGroup", name, args ?? new OriginGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OriginGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200901:OriginGroup", name, null, MakeResourceOptions(options, id))
        {
        }
