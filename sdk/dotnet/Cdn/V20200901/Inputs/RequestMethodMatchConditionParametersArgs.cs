...
namespace Pulumi.AzureNextGen.Cdn.V20200901.Inputs
{
    ...
    /// </summary>
    public sealed class RequestMethodMatchConditionParametersArgs : Pulumi.ResourceArgs
    {
        [Input("matchValues")]
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200901.RequestMethodOperator> Operator { get; set; } = null!;
