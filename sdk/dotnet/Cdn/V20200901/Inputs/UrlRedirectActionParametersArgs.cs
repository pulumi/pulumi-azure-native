...
namespace Pulumi.AzureNextGen.Cdn.V20200901.Inputs
{
    ...
    public sealed class UrlRedirectActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200901.DestinationProtocol>? DestinationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200901.RedirectType> RedirectType { get; set; } = null!;
