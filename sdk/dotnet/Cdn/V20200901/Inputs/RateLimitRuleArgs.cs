...
namespace Pulumi.AzureNextGen.Cdn.V20200901.Inputs
{
    ...
    public sealed class RateLimitRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200901.ActionType> Action { get; set; } = null!;

        /// <summary>
        /// Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200901.CustomRuleEnabledState>? EnabledState { get; set; }
