...
namespace Pulumi.AzureNative.Cdn.V20200901
{
    ...
    /// {
    ///     var afdOriginGroup = new AzureNative.Cdn.V20200901.AFDOriginGroup("afdOriginGroup", new()
    ///     {
    ///         HealthProbeSettings = new AzureNative.Cdn.V20200901.Inputs.HealthProbeParametersArgs
    ///         {
    ///             ProbeIntervalInSeconds = 10,
    ///             ProbePath = "/path2",
    ///             ProbeProtocol = AzureNative.Cdn.V20200901.ProbeProtocol.NotSet,
    ///             ProbeRequestType = AzureNative.Cdn.V20200901.HealthProbeRequestType.NotSet,
    ///         },
    ///         LoadBalancingSettings = new AzureNative.Cdn.V20200901.Inputs.LoadBalancingSettingsParametersArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:cdn/v20200901:AFDOriginGroup origingroup1 /subscriptions/subid/resourcegroups/RG/providers/Microsoft.Cdn/profiles/profile1/origingroups/origingroup1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20200901:AFDOriginGroup")]
    public partial class AFDOriginGroup : global::Pulumi.CustomResource
    {
        ...
        public AFDOriginGroup(string name, AFDOriginGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200901:AFDOriginGroup", name, args ?? new AFDOriginGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDOriginGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200901:AFDOriginGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AFDOriginGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20200901.EnabledState>? SessionAffinityState { get; set; }
