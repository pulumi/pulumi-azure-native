...
namespace Pulumi.AzureNative.Cdn.V20190615Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20190615preview:Profile")]
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615preview:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615preview:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
