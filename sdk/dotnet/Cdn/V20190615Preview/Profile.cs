...
namespace Pulumi.AzureRM.Cdn.V20190615Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var profile = new AzureRM.Cdn.V20190615Preview.Profile("profile", new AzureRM.Cdn.V20190615Preview.ProfileArgs
    ///         {
    ...
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615preview:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615preview:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
