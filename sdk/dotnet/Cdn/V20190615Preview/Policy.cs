...
namespace Pulumi.AzureRM.Cdn.V20190615Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policy = new AzureRM.Cdn.V20190615Preview.Policy("policy", new AzureRM.Cdn.V20190615Preview.PolicyArgs
    ///         {
    ///             CustomRules = new AzureRM.Cdn.V20190615Preview.Inputs.CustomRuleListArgs
    ///             {
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Cdn.V20190615Preview.Inputs.CustomRuleArgs
    ///                     {
    ///                         Action = "Block",
    ///                         EnabledState = "Enabled",
    ///                         MatchConditions = 
    ///                         {
    ///                             new AzureRM.Cdn.V20190615Preview.Inputs.MatchConditionArgs
    ///                             {
    ///                                 MatchValue = 
    ///                                 {
    ///                                     "CH",
    ...
    ///             },
    ///             Location = "WestUs",
    ///             ManagedRules = new AzureRM.Cdn.V20190615Preview.Inputs.ManagedRuleSetListArgs
    ///             {
    ///                 ManagedRuleSets = 
    ///                 {
    ///                     new AzureRM.Cdn.V20190615Preview.Inputs.ManagedRuleSetArgs
    ///                     {
    ///                         RuleGroupOverrides = 
    ///                         {
    ///                             new AzureRM.Cdn.V20190615Preview.Inputs.ManagedRuleGroupOverrideArgs
    ///                             {
    ///                                 RuleGroupName = "Group1",
    ///                                 Rules = 
    ///                                 {
    ///                                     new AzureRM.Cdn.V20190615Preview.Inputs.ManagedRuleOverrideArgs
    ///                                     {
    ///                                         Action = "Redirect",
    ///                                         EnabledState = "Enabled",
    ///                                         RuleId = "GROUP1-0001",
    ...
    ///             PolicySettings = new AzureRM.Cdn.V20190615Preview.Inputs.PolicySettingsArgs
    ///             {
    ...
    ///             },
    ///             RateLimitRules = new AzureRM.Cdn.V20190615Preview.Inputs.RateLimitRuleListArgs
    ///             {
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Cdn.V20190615Preview.Inputs.RateLimitRuleArgs
    ///                     {
    ///                         Action = "Block",
    ///                         EnabledState = "Enabled",
    ///                         MatchConditions = 
    ...
    ///             Sku = new AzureRM.Cdn.V20190615Preview.Inputs.SkuArgs
    ///             {
    ...
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615preview:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615preview:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
