...
namespace Pulumi.AzureNative.Cdn.V20190615Preview
{
    ...
    [AzureNativeResourceType("azure-native:cdn/v20190615preview:CustomDomain")]
    public partial class CustomDomain : global::Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615preview:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615preview:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
