...
namespace Pulumi.AzureRM.Cdn.V20190615Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var customDomain = new AzureRM.Cdn.V20190615Preview.CustomDomain("customDomain", new AzureRM.Cdn.V20190615Preview.CustomDomainArgs
    ///         {
    ...
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615preview:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615preview:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
