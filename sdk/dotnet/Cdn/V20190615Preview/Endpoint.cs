...
namespace Pulumi.AzureRM.Cdn.V20190615Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var endpoint = new AzureRM.Cdn.V20190615Preview.Endpoint("endpoint", new AzureRM.Cdn.V20190615Preview.EndpointArgs
    ///         {
    ...
    ///             },
    ///             DeliveryPolicy = new AzureRM.Cdn.V20190615Preview.Inputs.EndpointPropertiesUpdateParametersDeliveryPolicyArgs
    ///             {
    ///                 Description = "Test description for a policy.",
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Cdn.V20190615Preview.Inputs.DeliveryRuleArgs
    ///                     {
    ///                         Actions = 
    ///                         {
    ///                             new AzureRM.Cdn.V20190615Preview.Inputs.DeliveryRuleActionArgs
    ///                             {
    ...
    ///                         Conditions = 
    ///                         {
    ///                             new AzureRM.Cdn.V20190615Preview.Inputs.DeliveryRuleConditionArgs
    ///                             {
    ///                                 Name = "RemoteAddress",
    ///                                 Parameters = 
    ///                                 {
    ...
    ///             Origins = 
    ///             {
    ///                 new AzureRM.Cdn.V20190615Preview.Inputs.DeepCreatedOriginArgs
    ///                 {
    ///                     Name = "origin1",
    ///                 },
    ///             },
    ...
    ///                 { "kay1", "value1" },
    ///             },
    ///             WebApplicationFirewallPolicyLink = new AzureRM.Cdn.V20190615Preview.Inputs.EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgs
    ///             {
    ...
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615preview:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615preview:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
