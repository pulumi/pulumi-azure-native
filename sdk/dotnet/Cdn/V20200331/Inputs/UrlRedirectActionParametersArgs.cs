...
namespace Pulumi.AzureNextGen.Cdn.V20200331.Inputs
{
    ...
    public sealed class UrlRedirectActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200331.DestinationProtocol>? DestinationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200331.RedirectType> RedirectType { get; set; } = null!;
