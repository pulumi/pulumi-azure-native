...
namespace Pulumi.AzureNextGen.Cdn.V20200331.Inputs
{
    ...
    public sealed class CacheExpirationActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200331.CacheBehavior> CacheBehavior { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200331.CacheType> CacheType { get; set; } = null!;
