...
namespace Pulumi.AzureNextGen.Cdn.V20200331.Inputs
{
    ...
    public sealed class UrlFileExtensionMatchConditionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200331.UrlFileExtensionOperator> Operator { get; set; } = null!;

        [Input("transforms")]
        private InputList<Union<string, Pulumi.AzureNextGen.Cdn.V20200331.Transform>>? _transforms;

        /// <summary>
        /// List of transforms
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.Cdn.V20200331.Transform>> Transforms
        {
            get => _transforms ?? (_transforms = new InputList<Union<string, Pulumi.AzureNextGen.Cdn.V20200331.Transform>>());
