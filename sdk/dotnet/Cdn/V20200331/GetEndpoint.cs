...
namespace Pulumi.AzureRM.Cdn.V20200331
{
    public static class GetEndpoint
    {
        public static Task<GetEndpointResult> InvokeAsync(GetEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEndpointResult>("azurerm:cdn/v20200331:getEndpoint", args ?? new GetEndpointArgs(), options.WithVersion());
    }
    ...
    public sealed class GetEndpointResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.UrlSigningKeyResponseResult> UrlSigningKeys;
        /// <summary>
