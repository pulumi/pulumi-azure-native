...
namespace Pulumi.AzureNative.Cdn.V20200331
{
    public static class GetProfile
    {
        ...
        public static Task<GetProfileResult> InvokeAsync(GetProfileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProfileResult>("azure-native:cdn/v20200331:getProfile", args ?? new GetProfileArgs(), options.WithVersion());

        /// <summary>
        /// CDN profile is a logical grouping of endpoints that share the same settings, such as CDN provider and pricing tier.
        /// </summary>
        public static Output<GetProfileResult> Invoke(GetProfileInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProfileResult>("azure-native:cdn/v20200331:getProfile", args ?? new GetProfileInvokeArgs(), options.WithVersion());
    }
