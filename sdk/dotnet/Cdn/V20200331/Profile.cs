...
namespace Pulumi.AzureRM.Cdn.V20200331
{
    ...
    ///     public MyStack()
    ///     {
    ///         var profile = new AzureRM.Cdn.V20200331.Profile("profile", new AzureRM.Cdn.V20200331.ProfileArgs
    ///         {
    ...
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200331:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200331:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
