...
namespace Pulumi.AzureNative.Cdn.V20200331
{
    ...
    /// </summary>
    [Obsolete(@"Version 2020-03-31 will be removed in v2 of the provider.
azure-native:cdn/v20200331:Endpoint is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Endpoint to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:cdn/v20200331:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200331:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200331:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ResourceReferenceArgs>? DefaultOriginGroup { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20200331.OptimizationType>? OptimizationType { get; set; }
        ...
        /// The origin groups comprising of origins that are used for load balancing the traffic based on availability.
        /// </summary>
        public InputList<Inputs.DeepCreatedOriginGroupArgs> OriginGroups
        {
            get => _originGroups ?? (_originGroups = new InputList<Inputs.DeepCreatedOriginGroupArgs>());
        ...
        public Input<Pulumi.AzureNative.Cdn.V20200331.QueryStringCachingBehavior>? QueryStringCachingBehavior { get; set; }
