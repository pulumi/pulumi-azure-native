...
namespace Pulumi.AzureNative.Cdn.V20200331
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20200331:OriginGroup")]
    public partial class OriginGroup : Pulumi.CustomResource
    {
        ...
        public OriginGroup(string name, OriginGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200331:OriginGroup", name, args ?? new OriginGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OriginGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200331:OriginGroup", name, null, MakeResourceOptions(options, id))
        {
        }
