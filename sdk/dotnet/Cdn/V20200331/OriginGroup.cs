...
namespace Pulumi.AzureRM.Cdn.V20200331
{
    ...
    ///     public MyStack()
    ///     {
    ///         var originGroup = new AzureRM.Cdn.V20200331.OriginGroup("originGroup", new AzureRM.Cdn.V20200331.OriginGroupArgs
    ///         {
    ///             EndpointName = "endpoint1",
    ///             HealthProbeSettings = new AzureRM.Cdn.V20200331.Inputs.HealthProbeParametersArgs
    ///             {
    ...
    ///             Origins = 
    ///             {
    ///                 new AzureRM.Cdn.V20200331.Inputs.ResourceReferenceArgs
    ///                 {
    ...
    ///             ResponseBasedOriginErrorDetectionSettings = new AzureRM.Cdn.V20200331.Inputs.ResponseBasedOriginErrorDetectionParametersArgs
    ///             {
    ...
    public partial class OriginGroup : Pulumi.CustomResource
    {
        ...
        public OriginGroup(string name, OriginGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200331:OriginGroup", name, args ?? new OriginGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OriginGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200331:OriginGroup", name, null, MakeResourceOptions(options, id))
        {
        }
