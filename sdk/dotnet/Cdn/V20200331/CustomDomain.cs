...
namespace Pulumi.AzureNative.Cdn.V20200331
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20200331:CustomDomain")]
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200331:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20200331:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
