...
namespace Pulumi.AzureRM.Cdn.V20200331
{
    ...
    ///     public MyStack()
    ///     {
    ///         var origin = new AzureRM.Cdn.V20200331.Origin("origin", new AzureRM.Cdn.V20200331.OriginArgs
    ///         {
    ///             Enabled = true,
    ...
    public partial class Origin : Pulumi.CustomResource
    {
        ...
        public Origin(string name, OriginArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200331:Origin", name, args ?? new OriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Origin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200331:Origin", name, null, MakeResourceOptions(options, id))
        {
        }
