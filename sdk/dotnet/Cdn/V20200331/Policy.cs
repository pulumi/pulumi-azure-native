...
namespace Pulumi.AzureRM.Cdn.V20200331
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policy = new AzureRM.Cdn.V20200331.Policy("policy", new AzureRM.Cdn.V20200331.PolicyArgs
    ///         {
    ///             CustomRules = new AzureRM.Cdn.V20200331.Inputs.CustomRuleListArgs
    ///             {
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Cdn.V20200331.Inputs.CustomRuleArgs
    ///                     {
    ///                         Action = "Block",
    ///                         EnabledState = "Enabled",
    ///                         MatchConditions = 
    ///                         {
    ///                             new AzureRM.Cdn.V20200331.Inputs.MatchConditionArgs
    ///                             {
    ///                                 MatchValue = 
    ///                                 {
    ///                                     "CH",
    ...
    ///             },
    ///             Location = "WestUs",
    ///             ManagedRules = new AzureRM.Cdn.V20200331.Inputs.ManagedRuleSetListArgs
    ///             {
    ///                 ManagedRuleSets = 
    ///                 {
    ///                     new AzureRM.Cdn.V20200331.Inputs.ManagedRuleSetArgs
    ///                     {
    ///                         RuleGroupOverrides = 
    ///                         {
    ///                             new AzureRM.Cdn.V20200331.Inputs.ManagedRuleGroupOverrideArgs
    ///                             {
    ///                                 RuleGroupName = "Group1",
    ///                                 Rules = 
    ///                                 {
    ///                                     new AzureRM.Cdn.V20200331.Inputs.ManagedRuleOverrideArgs
    ///                                     {
    ///                                         Action = "Redirect",
    ///                                         EnabledState = "Enabled",
    ///                                         RuleId = "GROUP1-0001",
    ...
    ///             PolicySettings = new AzureRM.Cdn.V20200331.Inputs.PolicySettingsArgs
    ///             {
    ...
    ///             },
    ///             RateLimitRules = new AzureRM.Cdn.V20200331.Inputs.RateLimitRuleListArgs
    ///             {
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Cdn.V20200331.Inputs.RateLimitRuleArgs
    ///                     {
    ///                         Action = "Block",
    ///                         EnabledState = "Enabled",
    ///                         MatchConditions = 
    ...
    ///             Sku = new AzureRM.Cdn.V20200331.Inputs.SkuArgs
    ///             {
    ...
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200331:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200331:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
