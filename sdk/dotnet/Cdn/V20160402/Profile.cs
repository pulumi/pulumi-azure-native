...
namespace Pulumi.AzureNative.Cdn.V20160402
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20160402:Profile")]
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20160402:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20160402:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
