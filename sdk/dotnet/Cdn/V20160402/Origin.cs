...
namespace Pulumi.AzureNative.Cdn.V20160402
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20160402:Origin")]
    public partial class Origin : Pulumi.CustomResource
    {
        ...
        public Origin(string name, OriginArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20160402:Origin", name, args ?? new OriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Origin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20160402:Origin", name, null, MakeResourceOptions(options, id))
        {
        }
