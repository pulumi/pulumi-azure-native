...
namespace Pulumi.AzureNative.Cdn.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240201:AFDOrigin")]
    public partial class AFDOrigin : global::Pulumi.CustomResource
    {
        ...
        public AFDOrigin(string name, AFDOriginArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240201:AFDOrigin", name, args ?? new AFDOriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDOrigin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240201:AFDOrigin", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AFDOriginArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240201.EnabledState>? EnabledState { get; set; }
