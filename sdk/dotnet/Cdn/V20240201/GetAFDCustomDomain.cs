...
namespace Pulumi.AzureNative.Cdn.V20240201
{
    public static class GetAFDCustomDomain
    {
        ...
        public static Task<GetAFDCustomDomainResult> InvokeAsync(GetAFDCustomDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAFDCustomDomainResult>("azure-native:cdn/v20240201:getAFDCustomDomain", args ?? new GetAFDCustomDomainArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing AzureFrontDoor domain with the specified domain name under the specified subscription, resource group and profile.
        /// </summary>
        public static Output<GetAFDCustomDomainResult> Invoke(GetAFDCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAFDCustomDomainResult>("azure-native:cdn/v20240201:getAFDCustomDomain", args ?? new GetAFDCustomDomainInvokeArgs(), options.WithDefaults());
