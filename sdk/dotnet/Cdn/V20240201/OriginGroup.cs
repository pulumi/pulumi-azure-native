...
namespace Pulumi.AzureNative.Cdn.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240201:OriginGroup")]
    public partial class OriginGroup : global::Pulumi.CustomResource
    {
        ...
        public OriginGroup(string name, OriginGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240201:OriginGroup", name, args ?? new OriginGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OriginGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240201:OriginGroup", name, null, MakeResourceOptions(options, id))
        {
        }
