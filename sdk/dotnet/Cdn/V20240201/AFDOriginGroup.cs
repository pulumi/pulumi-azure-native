...
namespace Pulumi.AzureNative.Cdn.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240201:AFDOriginGroup")]
    public partial class AFDOriginGroup : global::Pulumi.CustomResource
    {
        ...
        public AFDOriginGroup(string name, AFDOriginGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240201:AFDOriginGroup", name, args ?? new AFDOriginGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDOriginGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240201:AFDOriginGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AFDOriginGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240201.EnabledState>? SessionAffinityState { get; set; }
