...
namespace Pulumi.AzureNative.Cdn.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240201:RuleSet")]
    public partial class RuleSet : global::Pulumi.CustomResource
    {
        ...
        public RuleSet(string name, RuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240201:RuleSet", name, args ?? new RuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240201:RuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
