...
namespace Pulumi.AzureNative.Cdn.V20240601Preview
{
    ...
    public readonly struct DeliveryRuleActionName : IEquatable<DeliveryRuleActionName>
    {
        ...
        public static DeliveryRuleActionName AfdUrlSigning { get; } = new DeliveryRuleActionName("AfdUrlSigning");
    ...
    public readonly struct SecretType : IEquatable<SecretType>
    {
        ...
        public static SecretType UrlSigningKey { get; } = new SecretType("UrlSigningKey");
        public static SecretType CustomerCertificate { get; } = new SecretType("CustomerCertificate");
        public static SecretType ManagedCertificate { get; } = new SecretType("ManagedCertificate");
        public static SecretType AzureFirstPartyManagedCertificate { get; } = new SecretType("AzureFirstPartyManagedCertificate");
        public static SecretType MtlsCertificateChain { get; } = new SecretType("MtlsCertificateChain");
    ...
    public readonly struct SecurityPolicyType : IEquatable<SecurityPolicyType>
    {
        ...
        public static SecurityPolicyType WebApplicationFirewall { get; } = new SecurityPolicyType("WebApplicationFirewall");
    ...
    /// </summary>
    [EnumType]
    public readonly struct WafMatchVariable : IEquatable<WafMatchVariable>
    {
        private readonly string _value;

        private WafMatchVariable(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static WafMatchVariable RemoteAddr { get; } = new WafMatchVariable("RemoteAddr");
        public static WafMatchVariable SocketAddr { get; } = new WafMatchVariable("SocketAddr");
        public static WafMatchVariable RequestMethod { get; } = new WafMatchVariable("RequestMethod");
        public static WafMatchVariable RequestHeader { get; } = new WafMatchVariable("RequestHeader");
        public static WafMatchVariable RequestUri { get; } = new WafMatchVariable("RequestUri");
        public static WafMatchVariable QueryString { get; } = new WafMatchVariable("QueryString");
        public static WafMatchVariable RequestBody { get; } = new WafMatchVariable("RequestBody");
        public static WafMatchVariable Cookies { get; } = new WafMatchVariable("Cookies");
        public static WafMatchVariable PostArgs { get; } = new WafMatchVariable("PostArgs");

        public static bool operator ==(WafMatchVariable left, WafMatchVariable right) => left.Equals(right);
        public static bool operator !=(WafMatchVariable left, WafMatchVariable right) => !left.Equals(right);

        public static explicit operator string(WafMatchVariable value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is WafMatchVariable other && Equals(other);
        public bool Equals(WafMatchVariable other) => string.Equals(_value, other._value, StringComparison.Ordinal);
