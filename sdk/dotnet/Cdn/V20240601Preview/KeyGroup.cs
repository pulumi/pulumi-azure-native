...
namespace Pulumi.AzureNative.Cdn.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240601preview:KeyGroup")]
    public partial class KeyGroup : global::Pulumi.CustomResource
    {
        ...
        public KeyGroup(string name, KeyGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240601preview:KeyGroup", name, args ?? new KeyGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240601preview:KeyGroup", name, null, MakeResourceOptions(options, id))
        {
        }
