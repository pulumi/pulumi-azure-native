...
namespace Pulumi.AzureNative.Cdn.V20240601Preview
{
    public static class GetAFDTargetGroup
    {
        ...
        public static Task<GetAFDTargetGroupResult> InvokeAsync(GetAFDTargetGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAFDTargetGroupResult>("azure-native:cdn/v20240601preview:getAFDTargetGroup", args ?? new GetAFDTargetGroupArgs(), options.WithDefaults());
