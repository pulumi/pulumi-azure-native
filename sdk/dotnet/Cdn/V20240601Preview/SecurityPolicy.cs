...
namespace Pulumi.AzureNative.Cdn.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240601preview:SecurityPolicy")]
    public partial class SecurityPolicy : global::Pulumi.CustomResource
    {
        ...
        public SecurityPolicy(string name, SecurityPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240601preview:SecurityPolicy", name, args ?? new SecurityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240601preview:SecurityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
