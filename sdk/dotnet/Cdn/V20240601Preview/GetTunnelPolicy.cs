...
namespace Pulumi.AzureNative.Cdn.V20240601Preview
{
    public static class GetTunnelPolicy
    {
        ...
        public static Task<GetTunnelPolicyResult> InvokeAsync(GetTunnelPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTunnelPolicyResult>("azure-native:cdn/v20240601preview:getTunnelPolicy", args ?? new GetTunnelPolicyArgs(), options.WithDefaults());
