...
namespace Pulumi.AzureNative.Cdn.V20240601Preview
{
    public static class GetRuleSet
    {
        ...
        public static Task<GetRuleSetResult> InvokeAsync(GetRuleSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleSetResult>("azure-native:cdn/v20240601preview:getRuleSet", args ?? new GetRuleSetArgs(), options.WithDefaults());
