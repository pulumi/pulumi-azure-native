...
namespace Pulumi.AzureNative.Cdn.V20240601Preview
{
    public static class GetAFDCustomDomain
    {
        ...
        public static Task<GetAFDCustomDomainResult> InvokeAsync(GetAFDCustomDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAFDCustomDomainResult>("azure-native:cdn/v20240601preview:getAFDCustomDomain", args ?? new GetAFDCustomDomainArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing AzureFrontDoor domain with the specified domain name under the specified subscription, resource group and profile.
        /// </summary>
        public static Output<GetAFDCustomDomainResult> Invoke(GetAFDCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAFDCustomDomainResult>("azure-native:cdn/v20240601preview:getAFDCustomDomain", args ?? new GetAFDCustomDomainInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetAFDCustomDomainResult
    {
        ...
        /// </summary>
        public readonly Outputs.AFDDomainMtlsParametersResponse? MtlsSettings;
        /// <summary>
        /// Resource name.
        /// </summary>
        ...
        private GetAFDCustomDomainResult(
            ...
            Outputs.AFDDomainMtlsParametersResponse? mtlsSettings,
