...
namespace Pulumi.AzureNative.Cdn.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20240601preview:AFDCustomDomain")]
    public partial class AFDCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public AFDCustomDomain(string name, AFDCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240601preview:AFDCustomDomain", name, args ?? new AFDCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20240601preview:AFDCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
