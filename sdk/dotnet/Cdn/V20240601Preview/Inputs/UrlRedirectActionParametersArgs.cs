...
namespace Pulumi.AzureNative.Cdn.V20240601Preview.Inputs
{
    ...
    public sealed class UrlRedirectActionParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240601Preview.DestinationProtocol>? DestinationProtocol { get; set; }

        /// <summary>
        /// The redirect type the rule will use when redirecting traffic.
        /// </summary>
        [Input("redirectType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240601Preview.RedirectType> RedirectType { get; set; } = null!;
