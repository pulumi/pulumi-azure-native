...
namespace Pulumi.AzureNative.Cdn.V20240601Preview.Inputs
{
    ...
    public sealed class CacheConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cacheBehavior")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240601Preview.RuleCacheBehavior>? CacheBehavior { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240601Preview.RuleIsCompressionEnabled>? IsCompressionEnabled { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20240601Preview.RuleQueryStringCachingBehavior>? QueryStringCachingBehavior { get; set; }
