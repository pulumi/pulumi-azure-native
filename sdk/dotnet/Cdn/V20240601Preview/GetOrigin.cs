...
namespace Pulumi.AzureNative.Cdn.V20240601Preview
{
    public static class GetOrigin
    {
        ...
        public static Task<GetOriginResult> InvokeAsync(GetOriginArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOriginResult>("azure-native:cdn/v20240601preview:getOrigin", args ?? new GetOriginArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing origin within an endpoint.
        /// </summary>
        public static Output<GetOriginResult> Invoke(GetOriginInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOriginResult>("azure-native:cdn/v20240601preview:getOrigin", args ?? new GetOriginInvokeArgs(), options.WithDefaults());
