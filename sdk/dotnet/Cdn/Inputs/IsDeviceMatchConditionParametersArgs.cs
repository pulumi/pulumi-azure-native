...
namespace Pulumi.AzureNative.Cdn.Inputs
{
    ...
    {
        [Input("matchValues")]
        private InputList<Union<string, Pulumi.AzureNative.Cdn.IsDeviceMatchValue>>? _matchValues;

        /// <summary>
        /// The match value for the condition of the delivery rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Cdn.IsDeviceMatchValue>> MatchValues
        {
            get => _matchValues ?? (_matchValues = new InputList<Union<string, Pulumi.AzureNative.Cdn.IsDeviceMatchValue>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.IsDeviceOperator> Operator { get; set; } = null!;
