...
namespace Pulumi.AzureNative.Cdn.Inputs
{
    ...
    {
        [Input("matchValues")]
        private InputList<Union<string, Pulumi.AzureNative.Cdn.RequestSchemeMatchValue>>? _matchValues;

        /// <summary>
        /// The match value for the condition of the delivery rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Cdn.RequestSchemeMatchValue>> MatchValues
        {
            get => _matchValues ?? (_matchValues = new InputList<Union<string, Pulumi.AzureNative.Cdn.RequestSchemeMatchValue>>());
