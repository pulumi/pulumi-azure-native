...
namespace Pulumi.AzureNextGen.Cdn.Inputs
{
    ...
    public sealed class CacheExpirationActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.CacheBehavior> CacheBehavior { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.CacheType> CacheType { get; set; } = null!;
