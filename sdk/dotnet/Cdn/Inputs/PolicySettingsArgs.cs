...
namespace Pulumi.AzureNative.Cdn.Inputs
{
    ...
    public sealed class PolicySettingsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabledState")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.PolicyEnabledState>? EnabledState { get; set; }

        /// <summary>
        /// Describes if it is in detection mode or prevention mode at policy level.
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.Cdn.PolicyMode>? Mode { get; set; }
