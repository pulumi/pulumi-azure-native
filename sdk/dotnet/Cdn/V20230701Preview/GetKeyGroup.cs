...
namespace Pulumi.AzureNative.Cdn.V20230701Preview
{
    public static class GetKeyGroup
    {
        ...
        public static Task<GetKeyGroupResult> InvokeAsync(GetKeyGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyGroupResult>("azure-native:cdn/v20230701preview:getKeyGroup", args ?? new GetKeyGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing KeyGroup within a profile.
        /// </summary>
        public static Output<GetKeyGroupResult> Invoke(GetKeyGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyGroupResult>("azure-native:cdn/v20230701preview:getKeyGroup", args ?? new GetKeyGroupInvokeArgs(), options.WithDefaults());
    }
