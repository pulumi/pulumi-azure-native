...
namespace Pulumi.AzureNative.Cdn.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20230701preview:AFDEndpoint")]
    public partial class AFDEndpoint : global::Pulumi.CustomResource
    {
        ...
        public AFDEndpoint(string name, AFDEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20230701preview:AFDEndpoint", name, args ?? new AFDEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20230701preview:AFDEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AFDEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20230701Preview.AutoGeneratedDomainNameLabelScope>? AutoGeneratedDomainNameLabelScope { get; set; }
