...
namespace Pulumi.AzureNative.Cdn.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20230701preview:Origin")]
    public partial class Origin : global::Pulumi.CustomResource
    {
        ...
        public Origin(string name, OriginArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20230701preview:Origin", name, args ?? new OriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Origin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20230701preview:Origin", name, null, MakeResourceOptions(options, id))
        {
        }
