...
namespace Pulumi.AzureRM.Cdn.V20190415
{
    ...
    ///     public MyStack()
    ///     {
    ///         var endpoint = new AzureRM.Cdn.V20190415.Endpoint("endpoint", new AzureRM.Cdn.V20190415.EndpointArgs
    ///         {
    ...
    ///             },
    ///             DeliveryPolicy = new AzureRM.Cdn.V20190415.Inputs.EndpointPropertiesUpdateParametersDeliveryPolicyArgs
    ///             {
    ///                 Description = "Test description for a policy.",
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Cdn.V20190415.Inputs.DeliveryRuleArgs
    ///                     {
    ///                         Actions = 
    ///                         {
    ///                             new AzureRM.Cdn.V20190415.Inputs.DeliveryRuleActionArgs
    ///                             {
    ...
    ///                         Conditions = 
    ///                         {
    ///                             new AzureRM.Cdn.V20190415.Inputs.DeliveryRuleConditionArgs
    ///                             {
    ///                                 Name = "RemoteAddress",
    ///                             },
    ///                         },
    ...
    ///             Origins = 
    ///             {
    ///                 new AzureRM.Cdn.V20190415.Inputs.DeepCreatedOriginArgs
    ///                 {
    ///                     Name = "origin1",
    ///                 },
    ///             },
    ...
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190415:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190415:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
