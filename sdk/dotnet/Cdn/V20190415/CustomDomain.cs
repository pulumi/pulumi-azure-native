...
namespace Pulumi.AzureRM.Cdn.V20190415
{
    ...
    ///     public MyStack()
    ///     {
    ///         var customDomain = new AzureRM.Cdn.V20190415.CustomDomain("customDomain", new AzureRM.Cdn.V20190415.CustomDomainArgs
    ///         {
    ...
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190415:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190415:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
