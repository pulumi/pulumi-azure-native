...
namespace Pulumi.AzureRM.Cdn.V20190615
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policy = new AzureRM.Cdn.V20190615.Policy("policy", new AzureRM.Cdn.V20190615.PolicyArgs
    ///         {
    ///             CustomRules = new AzureRM.Cdn.V20190615.Inputs.CustomRuleListArgs
    ///             {
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Cdn.V20190615.Inputs.CustomRuleArgs
    ///                     {
    ///                         Action = "Block",
    ///                         EnabledState = "Enabled",
    ///                         MatchConditions = 
    ///                         {
    ///                             new AzureRM.Cdn.V20190615.Inputs.MatchConditionArgs
    ///                             {
    ///                                 MatchValue = 
    ///                                 {
    ///                                     "CH",
    ...
    ///             },
    ///             Location = "WestUs",
    ///             ManagedRules = new AzureRM.Cdn.V20190615.Inputs.ManagedRuleSetListArgs
    ///             {
    ///                 ManagedRuleSets = 
    ///                 {
    ///                     new AzureRM.Cdn.V20190615.Inputs.ManagedRuleSetArgs
    ///                     {
    ///                         RuleGroupOverrides = 
    ///                         {
    ///                             new AzureRM.Cdn.V20190615.Inputs.ManagedRuleGroupOverrideArgs
    ///                             {
    ///                                 RuleGroupName = "Group1",
    ///                                 Rules = 
    ///                                 {
    ///                                     new AzureRM.Cdn.V20190615.Inputs.ManagedRuleOverrideArgs
    ///                                     {
    ///                                         Action = "Redirect",
    ///                                         EnabledState = "Enabled",
    ///                                         RuleId = "GROUP1-0001",
    ...
    ///             PolicySettings = new AzureRM.Cdn.V20190615.Inputs.PolicySettingsArgs
    ///             {
    ...
    ///             },
    ///             RateLimitRules = new AzureRM.Cdn.V20190615.Inputs.RateLimitRuleListArgs
    ///             {
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Cdn.V20190615.Inputs.RateLimitRuleArgs
    ///                     {
    ///                         Action = "Block",
    ///                         EnabledState = "Enabled",
    ///                         MatchConditions = 
    ...
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20190615:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
