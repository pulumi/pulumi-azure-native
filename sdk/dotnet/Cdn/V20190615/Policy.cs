...
namespace Pulumi.AzureNative.Cdn.V20190615
{
    ...
    [AzureNativeResourceType("azure-native:cdn/v20190615:Policy")]
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
