...
namespace Pulumi.AzureNative.Cdn.V20190615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20190615:CustomDomain")]
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
