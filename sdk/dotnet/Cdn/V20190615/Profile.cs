...
namespace Pulumi.AzureNative.Cdn.V20190615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20190615:Profile")]
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20190615:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
