...
namespace Pulumi.AzureNative.Cdn.V20190615.Inputs
{
    ...
    public sealed class CacheExpirationActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20190615.CacheBehavior> CacheBehavior { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20190615.CacheType> CacheType { get; set; } = null!;
