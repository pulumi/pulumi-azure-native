...
namespace Pulumi.AzureNextGen.Cdn.V20190615.Inputs
{
    ...
    public sealed class CacheExpirationActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20190615.CacheBehavior> CacheBehavior { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20190615.CacheType> CacheType { get; set; } = null!;
