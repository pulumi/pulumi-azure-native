...
namespace Pulumi.AzureNextGen.Cdn.V20190615.Inputs
{
    ...
    public sealed class UrlRedirectActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20190615.DestinationProtocol>? DestinationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20190615.RedirectType> RedirectType { get; set; } = null!;
