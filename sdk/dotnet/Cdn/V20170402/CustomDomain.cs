...
namespace Pulumi.AzureRM.Cdn.V20170402
{
    ...
    ///     public MyStack()
    ///     {
    ///         var customDomain = new AzureRM.Cdn.V20170402.CustomDomain("customDomain", new AzureRM.Cdn.V20170402.CustomDomainArgs
    ///         {
    ...
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20170402:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20170402:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
