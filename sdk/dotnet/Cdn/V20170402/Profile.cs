...
namespace Pulumi.AzureRM.Cdn.V20170402
{
    ...
    ///     public MyStack()
    ///     {
    ///         var profile = new AzureRM.Cdn.V20170402.Profile("profile", new AzureRM.Cdn.V20170402.ProfileArgs
    ///         {
    ///             Location = "WestCentralUs",
    ///             ProfileName = "profile1",
    ///             ResourceGroupName = "RG",
    ///             Sku = new AzureRM.Cdn.V20170402.Inputs.SkuArgs
    ///             {
    ...
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20170402:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20170402:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
