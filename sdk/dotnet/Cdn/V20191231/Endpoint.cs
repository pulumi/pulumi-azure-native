...
namespace Pulumi.AzureNextGen.Cdn.V20191231
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cdn/v20191231:Endpoint")]
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn/v20191231:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn/v20191231:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EndpointArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20191231.OptimizationType>? OptimizationType { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Cdn.V20191231.QueryStringCachingBehavior>? QueryStringCachingBehavior { get; set; }
