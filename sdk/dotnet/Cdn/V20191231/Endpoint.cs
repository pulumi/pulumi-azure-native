...
azure-native:cdn/v20191231:Endpoint is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Endpoint to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:cdn/v20191231:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20191231:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20191231:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20191231.OptimizationType>? OptimizationType { get; set; }
        ...
        public Input<Pulumi.AzureNative.Cdn.V20191231.QueryStringCachingBehavior>? QueryStringCachingBehavior { get; set; }
