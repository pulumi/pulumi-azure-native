...
namespace Pulumi.AzureRM.Cdn.V20191231
{
    ...
    ///     public MyStack()
    ///     {
    ///         var profile = new AzureRM.Cdn.V20191231.Profile("profile", new AzureRM.Cdn.V20191231.ProfileArgs
    ///         {
    ///             Location = "WestCentralUs",
    ///             ProfileName = "profile1",
    ///             ResourceGroupName = "RG",
    ///             Sku = new AzureRM.Cdn.V20191231.Inputs.SkuArgs
    ///             {
    ...
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20191231:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20191231:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
