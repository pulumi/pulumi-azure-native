...
namespace Pulumi.AzureNative.Cdn.V20191231
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20191231:Profile")]
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20191231:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20191231:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
