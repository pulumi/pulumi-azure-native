...
namespace Pulumi.AzureNative.Cdn.V20191231.Inputs
{
    ...
    public sealed class CacheExpirationActionParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20191231.CacheBehavior> CacheBehavior { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20191231.CacheType> CacheType { get; set; } = null!;
