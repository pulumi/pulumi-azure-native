...
namespace Pulumi.AzureRM.Cdn.V20191231
{
    ...
    ///     public MyStack()
    ///     {
    ///         var origin = new AzureRM.Cdn.V20191231.Origin("origin", new AzureRM.Cdn.V20191231.OriginArgs
    ///         {
    ///             Enabled = true,
    ...
    public partial class Origin : Pulumi.CustomResource
    {
        ...
        public Origin(string name, OriginArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20191231:Origin", name, args ?? new OriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Origin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20191231:Origin", name, null, MakeResourceOptions(options, id))
        {
        }
