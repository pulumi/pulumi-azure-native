...
namespace Pulumi.AzureNative.Cdn.V20191231
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20191231:CustomDomain")]
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20191231:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20191231:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
