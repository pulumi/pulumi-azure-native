...
namespace Pulumi.AzureRM.Cdn.V20191231
{
    ...
    ///     public MyStack()
    ///     {
    ///         var customDomain = new AzureRM.Cdn.V20191231.CustomDomain("customDomain", new AzureRM.Cdn.V20191231.CustomDomainArgs
    ///         {
    ...
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20191231:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20191231:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
