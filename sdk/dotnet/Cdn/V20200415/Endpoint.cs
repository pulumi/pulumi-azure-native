...
namespace Pulumi.AzureRM.Cdn.V20200415
{
    ...
    ///     public MyStack()
    ///     {
    ///         var endpoint = new AzureRM.Cdn.V20200415.Endpoint("endpoint", new AzureRM.Cdn.V20200415.EndpointArgs
    ///         {
    ...
    ///             },
    ///             DefaultOriginGroup = new AzureRM.Cdn.V20200415.Inputs.ResourceReferenceArgs
    ///             {
    ///                 Id = "/subscriptions/subid/resourceGroups/RG/providers/Microsoft.Cdn/profiles/profile1/endpoints/endpoint1/originGroups/originGroup1",
    ///             },
    ///             DeliveryPolicy = new AzureRM.Cdn.V20200415.Inputs.EndpointPropertiesUpdateParametersDeliveryPolicyArgs
    ///             {
    ///                 Description = "Test description for a policy.",
    ///                 Rules = 
    ///                 {
    ///                     new AzureRM.Cdn.V20200415.Inputs.DeliveryRuleArgs
    ///                     {
    ///                         Actions = 
    ///                         {
    ...
    ///             OriginGroups = 
    ///             {
    ///                 new AzureRM.Cdn.V20200415.Inputs.DeepCreatedOriginGroupArgs
    ///                 {
    ///                     Name = "originGroup1",
    ///                 },
    ///             },
    ...
    ///             Origins = 
    ///             {
    ///                 new AzureRM.Cdn.V20200415.Inputs.DeepCreatedOriginArgs
    ///                 {
    ///                     Name = "origin1",
    ///                 },
    ///                 new AzureRM.Cdn.V20200415.Inputs.DeepCreatedOriginArgs
    ...
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200415:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cdn/v20200415:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
