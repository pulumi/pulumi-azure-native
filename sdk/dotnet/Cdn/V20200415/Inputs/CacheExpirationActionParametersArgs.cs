...
namespace Pulumi.AzureNextGen.Cdn.V20200415.Inputs
{
    ...
    public sealed class CacheExpirationActionParametersArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200415.CacheBehavior> CacheBehavior { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Cdn.V20200415.CacheType> CacheType { get; set; } = null!;
