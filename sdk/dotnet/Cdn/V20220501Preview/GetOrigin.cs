...
{
    [Obsolete(@"azure-native:cdn/v20220501preview:Origin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Origin to guarantee forwards compatibility.")]
    public static class GetOrigin
    {
        ...
        public static Task<GetOriginResult> InvokeAsync(GetOriginArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOriginResult>("azure-native:cdn/v20220501preview:getOrigin", args ?? new GetOriginArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing origin within an endpoint.
        /// </summary>
        public static Output<GetOriginResult> Invoke(GetOriginInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOriginResult>("azure-native:cdn/v20220501preview:getOrigin", args ?? new GetOriginInvokeArgs(), options.WithDefaults());
    }
