...
namespace Pulumi.AzureNative.Cdn.V20220501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cdn/v20220501preview:RuleSet is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:RuleSet to guarantee forwards compatibility.")]
    ...
    public partial class RuleSet : global::Pulumi.CustomResource
    {
        ...
        public RuleSet(string name, RuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20220501preview:RuleSet", name, args ?? new RuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20220501preview:RuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
