...
namespace Pulumi.AzureNative.Cdn.V20220501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20220501preview:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20220501preview:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20220501preview:Rule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20220501Preview.MatchProcessingBehavior>? MatchProcessingBehavior { get; set; }
