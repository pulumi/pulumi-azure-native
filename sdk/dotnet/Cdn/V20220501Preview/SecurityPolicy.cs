...
namespace Pulumi.AzureNative.Cdn.V20220501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cdn/v20220501preview:SecurityPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:SecurityPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:cdn/v20220501preview:SecurityPolicy")]
    public partial class SecurityPolicy : global::Pulumi.CustomResource
    {
        ...
        public SecurityPolicy(string name, SecurityPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20220501preview:SecurityPolicy", name, args ?? new SecurityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20220501preview:SecurityPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
