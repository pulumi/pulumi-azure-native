...
namespace Pulumi.AzureNative.Cdn.V20220501Preview
{
    ...
    public partial class AFDOrigin : global::Pulumi.CustomResource
    {
        ...
        public AFDOrigin(string name, AFDOriginArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20220501preview:AFDOrigin", name, args ?? new AFDOriginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AFDOrigin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20220501preview:AFDOrigin", name, null, MakeResourceOptions(options, id))
        {
        }
