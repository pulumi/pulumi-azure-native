...
namespace Pulumi.AzureNative.Cdn.V20220501Preview.Inputs
{
    ...
    public sealed class UrlRedirectActionParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20220501Preview.DestinationProtocol>? DestinationProtocol { get; set; }

        /// <summary>
        /// The redirect type the rule will use when redirecting traffic.
        /// </summary>
        [Input("redirectType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Cdn.V20220501Preview.RedirectType> RedirectType { get; set; } = null!;
