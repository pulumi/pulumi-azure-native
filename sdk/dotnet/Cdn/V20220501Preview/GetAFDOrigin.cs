...
{
    [Obsolete(@"azure-native:cdn/v20220501preview:AFDOrigin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:AFDOrigin to guarantee forwards compatibility.")]
    public static class GetAFDOrigin
    {
        ...
        public static Task<GetAFDOriginResult> InvokeAsync(GetAFDOriginArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAFDOriginResult>("azure-native:cdn/v20220501preview:getAFDOrigin", args ?? new GetAFDOriginArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing origin within an origin group.
        /// </summary>
        public static Output<GetAFDOriginResult> Invoke(GetAFDOriginInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAFDOriginResult>("azure-native:cdn/v20220501preview:getAFDOrigin", args ?? new GetAFDOriginInvokeArgs(), options.WithDefaults());
    }
