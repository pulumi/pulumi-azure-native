...
namespace Pulumi.AzureNative.Cdn.V20220501Preview
{
    public static class GetRuleSet
    {
        ...
        public static Task<GetRuleSetResult> InvokeAsync(GetRuleSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleSetResult>("azure-native:cdn/v20220501preview:getRuleSet", args ?? new GetRuleSetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an existing AzureFrontDoor rule set with the specified rule set name under the specified subscription, resource group and profile.
        /// </summary>
        public static Output<GetRuleSetResult> Invoke(GetRuleSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRuleSetResult>("azure-native:cdn/v20220501preview:getRuleSet", args ?? new GetRuleSetInvokeArgs(), options.WithDefaults());
    }
