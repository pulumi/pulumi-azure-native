...
namespace Pulumi.AzureNative.Cdn.V20150601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20150601:Profile")]
    public partial class Profile : Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20150601:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20150601:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
