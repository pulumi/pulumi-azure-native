...
namespace Pulumi.AzureNextGen.Cdn.V20150601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cdn/v20150601:Endpoint")]
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn/v20150601:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn/v20150601:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
