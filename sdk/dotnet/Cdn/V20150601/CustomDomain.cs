...
namespace Pulumi.AzureNative.Cdn.V20150601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cdn/v20150601:CustomDomain")]
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20150601:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cdn/v20150601:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
