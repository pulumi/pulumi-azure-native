...
namespace Pulumi.AzureNative.Cdn
{
    public static class GetEdgeActionExecutionFilter
    {
        ...
        public static Task<GetEdgeActionExecutionFilterResult> InvokeAsync(GetEdgeActionExecutionFilterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEdgeActionExecutionFilterResult>("azure-native:cdn:getEdgeActionExecutionFilter", args ?? new GetEdgeActionExecutionFilterArgs(), options.WithDefaults());
        ...
        public static Output<GetEdgeActionExecutionFilterResult> Invoke(GetEdgeActionExecutionFilterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEdgeActionExecutionFilterResult>("azure-native:cdn:getEdgeActionExecutionFilter", args ?? new GetEdgeActionExecutionFilterInvokeArgs(), options.WithDefaults());
