...
namespace Pulumi.AzureNextGen.Cdn
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:cdn:CustomDomain")]
    public partial class CustomDomain : Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:cdn:CustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
