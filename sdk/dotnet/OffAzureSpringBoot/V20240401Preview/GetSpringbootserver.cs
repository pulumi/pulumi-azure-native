...
namespace Pulumi.AzureNative.OffAzureSpringBoot.V20240401Preview
{
    public static class GetSpringbootserver
    {
        ...
        public static Task<GetSpringbootserverResult> InvokeAsync(GetSpringbootserverArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSpringbootserverResult>("azure-native:offazurespringboot/v20240401preview:getSpringbootserver", args ?? new GetSpringbootserverArgs(), options.WithDefaults());

        /// <summary>
        /// List springbootservers resource.
        /// </summary>
        public static Output<GetSpringbootserverResult> Invoke(GetSpringbootserverInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSpringbootserverResult>("azure-native:offazurespringboot/v20240401preview:getSpringbootserver", args ?? new GetSpringbootserverInvokeArgs(), options.WithDefaults());
    }
