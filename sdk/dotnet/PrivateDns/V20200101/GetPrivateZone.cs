...
namespace Pulumi.AzureNative.PrivateDns.V20200101
{
    public static class GetPrivateZone
    {
        ...
        public static Task<GetPrivateZoneResult> InvokeAsync(GetPrivateZoneArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateZoneResult>("azure-native:privatedns/v20200101:getPrivateZone", args ?? new GetPrivateZoneArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Private DNS zone. Retrieves the zone properties, but not the virtual networks links or the record sets within the zone.
        /// </summary>
        public static Output<GetPrivateZoneResult> Invoke(GetPrivateZoneInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateZoneResult>("azure-native:privatedns/v20200101:getPrivateZone", args ?? new GetPrivateZoneInvokeArgs(), options.WithDefaults());
