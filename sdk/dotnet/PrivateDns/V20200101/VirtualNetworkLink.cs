...
namespace Pulumi.AzureNative.PrivateDns.V20200101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:privatedns/v20200101:VirtualNetworkLink")]
    public partial class VirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkLink(string name, VirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20200101:VirtualNetworkLink", name, args ?? new VirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20200101:VirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
