...
namespace Pulumi.AzureNative.PrivateDns.V20240601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:privatedns/v20240601:PrivateRecordSet")]
    public partial class PrivateRecordSet : global::Pulumi.CustomResource
    {
        ...
        public PrivateRecordSet(string name, PrivateRecordSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20240601:PrivateRecordSet", name, args ?? new PrivateRecordSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateRecordSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20240601:PrivateRecordSet", name, null, MakeResourceOptions(options, id))
        {
        }
