...
namespace Pulumi.AzureNative.PrivateDns.V20240601
{
    /// <summary>
    /// Describes a link to virtual network for a Private DNS zone.
    /// </summary>
    [AzureNativeResourceType("azure-native:privatedns/v20240601:VirtualNetworkLink")]
    public partial class VirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkLink(string name, VirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20240601:VirtualNetworkLink", name, args ?? new VirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20240601:VirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:privatedns:VirtualNetworkLink" },
                },
            };
    ...
    public sealed class VirtualNetworkLinkArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.PrivateDns.V20240601.ResolutionPolicy>? ResolutionPolicy { get; set; }
