...
namespace Pulumi.AzureNative.PrivateDns.V20240601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:privatedns/v20240601:PrivateZone")]
    public partial class PrivateZone : global::Pulumi.CustomResource
    {
        ...
        public PrivateZone(string name, PrivateZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20240601:PrivateZone", name, args ?? new PrivateZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20240601:PrivateZone", name, null, MakeResourceOptions(options, id))
        {
        }
