...
namespace Pulumi.AzureNative.PrivateDns
{
    public static class GetPrivateZone
    {
        ...
        public static Task<GetPrivateZoneResult> InvokeAsync(GetPrivateZoneArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateZoneResult>("azure-native:privatedns:getPrivateZone", args ?? new GetPrivateZoneArgs(), options.WithDefaults());
        ...
        public static Output<GetPrivateZoneResult> Invoke(GetPrivateZoneInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateZoneResult>("azure-native:privatedns:getPrivateZone", args ?? new GetPrivateZoneInvokeArgs(), options.WithDefaults());
