...
namespace Pulumi.AzureNative.PrivateDns
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:privatedns:PrivateZone")]
    public partial class PrivateZone : global::Pulumi.CustomResource
    {
        ...
        public PrivateZone(string name, PrivateZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:privatedns:PrivateZone", name, args ?? new PrivateZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:privatedns:PrivateZone", name, null, MakeResourceOptions(options, id))
        {
        }
