...
namespace Pulumi.AzureNative.PrivateDns
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:privatedns:VirtualNetworkLink")]
    public partial class VirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkLink(string name, VirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:privatedns:VirtualNetworkLink", name, args ?? new VirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:privatedns:VirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkLinkArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.PrivateDns.ResolutionPolicy>? ResolutionPolicy { get; set; }
