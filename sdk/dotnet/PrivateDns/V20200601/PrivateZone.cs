...
namespace Pulumi.AzureNative.PrivateDns.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:privatedns/v20200601:PrivateZone")]
    public partial class PrivateZone : global::Pulumi.CustomResource
    {
        ...
        public PrivateZone(string name, PrivateZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20200601:PrivateZone", name, args ?? new PrivateZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:privatedns/v20200601:PrivateZone", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:privatedns:PrivateZone" },
