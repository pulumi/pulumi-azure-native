...
namespace Pulumi.AzureNative.PrivateDns.V20200601
{
    public static class GetPrivateRecordSet
    {
        ...
        public static Task<GetPrivateRecordSetResult> InvokeAsync(GetPrivateRecordSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateRecordSetResult>("azure-native:privatedns/v20200601:getPrivateRecordSet", args ?? new GetPrivateRecordSetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a record set.
        /// </summary>
        public static Output<GetPrivateRecordSetResult> Invoke(GetPrivateRecordSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateRecordSetResult>("azure-native:privatedns/v20200601:getPrivateRecordSet", args ?? new GetPrivateRecordSetInvokeArgs(), options.WithDefaults());
