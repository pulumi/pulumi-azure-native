...
namespace Pulumi.AzureNative.DevTestLab.V20180915
{
    public static class GetFormula
    {
        ...
        public static Task<GetFormulaResult> InvokeAsync(GetFormulaArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFormulaResult>("azure-native:devtestlab/v20180915:getFormula", args ?? new GetFormulaArgs(), options.WithDefaults());

        /// <summary>
        /// A formula for creating a VM, specifying an image base and other parameters
        /// </summary>
        public static Output<GetFormulaResult> Invoke(GetFormulaInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFormulaResult>("azure-native:devtestlab/v20180915:getFormula", args ?? new GetFormulaInvokeArgs(), options.WithDefaults());
    }
