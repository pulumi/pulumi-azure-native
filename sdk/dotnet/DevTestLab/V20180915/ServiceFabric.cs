...
namespace Pulumi.AzureRM.DevTestLab.V20180915
{
    ...
    public partial class ServiceFabric : Pulumi.CustomResource
    {
        ...
        public ServiceFabric(string name, ServiceFabricArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/v20180915:ServiceFabric", name, args ?? new ServiceFabricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceFabric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/v20180915:ServiceFabric", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:devtestlab/latest:ServiceFabric"},
                    new Pulumi.Alias { Type = "azurerm:devtestlab/preview:ServiceFabric"},
                },
            };
