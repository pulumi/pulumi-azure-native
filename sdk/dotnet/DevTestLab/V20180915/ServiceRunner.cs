...
namespace Pulumi.AzureNative.DevTestLab.V20180915
{
    ...
    /// {
    ///     var serviceRunner = new AzureNative.DevTestLab.V20180915.ServiceRunner("serviceRunner", new()
    ///     {
    ///         Identity = new AzureNative.DevTestLab.V20180915.Inputs.IdentityPropertiesArgs
    ///         {
