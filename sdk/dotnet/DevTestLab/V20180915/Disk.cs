...
namespace Pulumi.AzureNative.DevTestLab.V20180915
{
    ...
    /// {
    ///     var disk = new AzureNative.DevTestLab.V20180915.Disk("disk", new()
    ///     {
    ///         DiskSizeGiB = 1023,
    ///         DiskType = "Standard",
    ///         LabName = "{labName}",
    ...
    public partial class Disk : global::Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20180915:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20180915:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
