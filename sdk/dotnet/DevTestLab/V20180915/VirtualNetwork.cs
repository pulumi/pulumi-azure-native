...
namespace Pulumi.AzureNative.DevTestLab.V20180915
{
    ...
    /// {
    ///     var virtualNetwork = new AzureNative.DevTestLab.V20180915.VirtualNetwork("virtualNetwork", new()
    ///     {
    ///         LabName = "{labName}",
    ///         Location = "{location}",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devtestlab/v20180915:VirtualNetwork")]
    public partial class VirtualNetwork : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20180915:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20180915:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
