...
namespace Pulumi.AzureNative.DevTestLab.V20180915
{
    ...
    /// {
    ///     var environment = new AzureNative.DevTestLab.V20180915.Environment("environment", new()
    ///     {
    ///         DeploymentProperties = new AzureNative.DevTestLab.V20180915.Inputs.EnvironmentDeploymentPropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devtestlab/v20180915:Environment")]
    public partial class Environment : global::Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20180915:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20180915:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
