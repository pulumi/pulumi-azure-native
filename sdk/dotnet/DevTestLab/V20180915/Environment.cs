...
namespace Pulumi.AzureNextGen.DevTestLab.V20180915
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devtestlab/v20180915:Environment")]
    public partial class Environment : Pulumi.CustomResource
    {
        ...
        public Environment(string name, EnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devtestlab/v20180915:Environment", name, args ?? new EnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Environment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devtestlab/v20180915:Environment", name, null, MakeResourceOptions(options, id))
        {
        }
