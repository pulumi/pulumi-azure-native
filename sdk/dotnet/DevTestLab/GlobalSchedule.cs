...
namespace Pulumi.AzureNative.DevTestLab
{
    ...
    public partial class GlobalSchedule : global::Pulumi.CustomResource
    {
        ...
        public GlobalSchedule(string name, GlobalScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab:GlobalSchedule", name, args ?? new GlobalScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab:GlobalSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_devtestlab_v20160515:devtestlab:GlobalSchedule" },
                    new global::Pulumi.Alias { Type = "azure-native_devtestlab_v20180915:devtestlab:GlobalSchedule" },
                },
            };
