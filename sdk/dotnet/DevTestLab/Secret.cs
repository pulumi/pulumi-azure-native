...
namespace Pulumi.AzureNextGen.DevTestLab
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devtestlab:Secret")]
    public partial class Secret : Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devtestlab:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devtestlab:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
