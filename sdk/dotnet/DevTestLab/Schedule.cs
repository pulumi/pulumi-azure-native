...
namespace Pulumi.AzureNative.DevTestLab
{
    ...
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:devtestlab/v20180915:Schedule" },
                    new global::Pulumi.Alias { Type = "azure-native_devtestlab_v20150521preview:devtestlab:Schedule" },
                    new global::Pulumi.Alias { Type = "azure-native_devtestlab_v20160515:devtestlab:Schedule" },
                    new global::Pulumi.Alias { Type = "azure-native_devtestlab_v20180915:devtestlab:Schedule" },
                },
            };
