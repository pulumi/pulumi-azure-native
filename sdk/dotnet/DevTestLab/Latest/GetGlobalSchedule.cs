...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getGlobalSchedule'.")]
    public static class GetGlobalSchedule
    {
        ...
        public static Task<GetGlobalScheduleResult> InvokeAsync(GetGlobalScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGlobalScheduleResult>("azure-native:devtestlab/latest:getGlobalSchedule", args ?? new GetGlobalScheduleArgs(), options.WithVersion());
    }
