...
namespace Pulumi.AzureNative.DevTestLab.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:Lab'.")]
    [AzureNativeResourceType("azure-native:devtestlab/latest:Lab")]
    public partial class Lab : Pulumi.CustomResource
    {
        ...
        public Lab(string name, LabArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/latest:Lab", name, args ?? new LabArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Lab(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/latest:Lab", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LabArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevTestLab.Latest.EnvironmentPermission>? EnvironmentPermission { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevTestLab.Latest.StorageType>? LabStorageType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevTestLab.Latest.PremiumDataDisk>? PremiumDataDisks { get; set; }
