...
namespace Pulumi.AzureNextGen.DevTestLab.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:devtestlab:VirtualMachineSchedule'.")]
    [AzureNextGenResourceType("azure-nextgen:devtestlab/latest:VirtualMachineSchedule")]
