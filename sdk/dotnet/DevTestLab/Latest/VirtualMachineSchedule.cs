...
namespace Pulumi.AzureNative.DevTestLab.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:VirtualMachineSchedule'.")]
    [AzureNativeResourceType("azure-native:devtestlab/latest:VirtualMachineSchedule")]
    public partial class VirtualMachineSchedule : Pulumi.CustomResource
    {
        ...
        public VirtualMachineSchedule(string name, VirtualMachineScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/latest:VirtualMachineSchedule", name, args ?? new VirtualMachineScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/latest:VirtualMachineSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
