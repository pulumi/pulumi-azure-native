...
namespace Pulumi.AzureRM.DevTestLab.Inputs
{
    ...
    /// </summary>
    public sealed class FormulaPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.LabVirtualMachineCreationParameterResponseArgs>? FormulaContent { get; set; }
        ...
        /// </summary>
        [Input("vm")]
        public Input<Inputs.FormulaPropertiesFromVmResponseArgs>? Vm { get; set; }

        public FormulaPropertiesResponseArgs()
        {
        }
    }
}
