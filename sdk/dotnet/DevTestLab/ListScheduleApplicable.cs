...
namespace Pulumi.AzureRM.DevTestLab
{
    public static class ListScheduleApplicable
    {
        public static Task<ListScheduleApplicableResult> InvokeAsync(ListScheduleApplicableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListScheduleApplicableResult>("azurerm:devtestlab:listScheduleApplicable", args ?? new ListScheduleApplicableArgs(), options.WithVersion());
    }
