...
namespace Pulumi.AzureNative.DevTestLab
{
    public static class GetPolicy
    {
        ...
        public static Task<GetPolicyResult> InvokeAsync(GetPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPolicyResult>("azure-native:devtestlab:getPolicy", args ?? new GetPolicyArgs(), options.WithVersion());
        ...
        public static Output<GetPolicyResult> Invoke(GetPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPolicyResult>("azure-native:devtestlab:getPolicy", args ?? new GetPolicyInvokeArgs(), options.WithVersion());
    }
