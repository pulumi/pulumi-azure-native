...
namespace Pulumi.AzureRM.DevTestLab
{
    public static class GetArtifactSource
    {
        public static Task<GetArtifactSourceResult> InvokeAsync(GetArtifactSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetArtifactSourceResult>("azurerm:devtestlab:getArtifactSource", args ?? new GetArtifactSourceArgs(), options.WithVersion());
    }
