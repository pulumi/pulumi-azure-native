...
namespace Pulumi.AzureNative.DevTestLab.V20160515
{
    public static class GetSchedule
    {
        ...
        public static Task<GetScheduleResult> InvokeAsync(GetScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScheduleResult>("azure-native:devtestlab/v20160515:getSchedule", args ?? new GetScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// A schedule.
        /// </summary>
        public static Output<GetScheduleResult> Invoke(GetScheduleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScheduleResult>("azure-native:devtestlab/v20160515:getSchedule", args ?? new GetScheduleInvokeArgs(), options.WithDefaults());
    }
