...
namespace Pulumi.AzureNative.DevTestLab.V20160515
{
    ...
    [AzureNativeResourceType("azure-native:devtestlab/v20160515:Policy")]
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20160515:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20160515:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
