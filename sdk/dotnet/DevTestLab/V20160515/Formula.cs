...
namespace Pulumi.AzureNative.DevTestLab.V20160515
{
    ...
    public partial class Formula : Pulumi.CustomResource
    {
        ...
        public Formula(string name, FormulaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20160515:Formula", name, args ?? new FormulaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Formula(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20160515:Formula", name, null, MakeResourceOptions(options, id))
        {
        }
