...
namespace Pulumi.AzureNative.DevTestLab.V20160515
{
    ...
    [AzureNativeResourceType("azure-native:devtestlab/v20160515:CustomImage")]
    public partial class CustomImage : Pulumi.CustomResource
    {
        ...
        public CustomImage(string name, CustomImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20160515:CustomImage", name, args ?? new CustomImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devtestlab/v20160515:CustomImage", name, null, MakeResourceOptions(options, id))
        {
        }
