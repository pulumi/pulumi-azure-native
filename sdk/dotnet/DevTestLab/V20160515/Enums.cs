...
namespace Pulumi.AzureNextGen.DevTestLab.V20160515
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct NotificationStatus : IEquatable<NotificationStatus>
    {
        private readonly string _value;
        ...
        public static NotificationStatus Disabled { get; } = new NotificationStatus("Disabled");
        public static NotificationStatus Enabled { get; } = new NotificationStatus("Enabled");

        public static bool operator ==(NotificationStatus left, NotificationStatus right) => left.Equals(right);
        public static bool operator !=(NotificationStatus left, NotificationStatus right) => !left.Equals(right);

        public static explicit operator string(NotificationStatus value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is NotificationStatus other && Equals(other);
        public bool Equals(NotificationStatus other) => string.Equals(_value, other._value, StringComparison.Ordinal);
