...
namespace Pulumi.AzureNative.DevTestLab.V20160515
{
    public static class GetFormula
    {
        ...
        public static Task<GetFormulaResult> InvokeAsync(GetFormulaArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFormulaResult>("azure-native:devtestlab/v20160515:getFormula", args ?? new GetFormulaArgs(), options.WithVersion());

        /// <summary>
        /// A formula for creating a VM, specifying an image base and other parameters
        /// </summary>
        public static Output<GetFormulaResult> Invoke(GetFormulaInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFormulaResult>("azure-native:devtestlab/v20160515:getFormula", args ?? new GetFormulaInvokeArgs(), options.WithVersion());
    }
