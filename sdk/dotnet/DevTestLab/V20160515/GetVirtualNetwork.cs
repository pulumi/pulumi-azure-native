...
namespace Pulumi.AzureRM.DevTestLab.V20160515
{
    public static class GetVirtualNetwork
    {
        public static Task<GetVirtualNetworkResult> InvokeAsync(GetVirtualNetworkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualNetworkResult>("azurerm:devtestlab/v20160515:getVirtualNetwork", args ?? new GetVirtualNetworkArgs(), options.WithVersion());
    }
