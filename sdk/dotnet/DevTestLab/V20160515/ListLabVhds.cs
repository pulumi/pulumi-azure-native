...
namespace Pulumi.AzureNative.DevTestLab.V20160515
{
    public static class ListLabVhds
    {
        ...
        public static Task<ListLabVhdsResult> InvokeAsync(ListLabVhdsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListLabVhdsResult>("azure-native:devtestlab/v20160515:listLabVhds", args ?? new ListLabVhdsArgs(), options.WithDefaults());

        /// <summary>
        /// The response of a list operation.
        /// </summary>
        public static Output<ListLabVhdsResult> Invoke(ListLabVhdsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListLabVhdsResult>("azure-native:devtestlab/v20160515:listLabVhds", args ?? new ListLabVhdsInvokeArgs(), options.WithDefaults());
    }
