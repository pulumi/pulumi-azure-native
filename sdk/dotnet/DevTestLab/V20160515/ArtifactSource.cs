...
namespace Pulumi.AzureNextGen.DevTestLab.V20160515
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devtestlab/v20160515:ArtifactSource")]
    public partial class ArtifactSource : Pulumi.CustomResource
    {
        ...
        public ArtifactSource(string name, ArtifactSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devtestlab/v20160515:ArtifactSource", name, args ?? new ArtifactSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArtifactSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devtestlab/v20160515:ArtifactSource", name, null, MakeResourceOptions(options, id))
        {
        }
