...
namespace Pulumi.AzureRM.DevTestLab.Preview
{
    public static class GetServiceFabricSchedule
    {
        public static Task<GetServiceFabricScheduleResult> InvokeAsync(GetServiceFabricScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceFabricScheduleResult>("azurerm:devtestlab/preview:getServiceFabricSchedule", args ?? new GetServiceFabricScheduleArgs(), options.WithVersion());
    }
