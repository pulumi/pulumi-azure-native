...
namespace Pulumi.AzureRM.DevTestLab.Preview
{
    public static class GetServiceRunner
    {
        public static Task<GetServiceRunnerResult> InvokeAsync(GetServiceRunnerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceRunnerResult>("azurerm:devtestlab/preview:getServiceRunner", args ?? new GetServiceRunnerArgs(), options.WithVersion());
    }
