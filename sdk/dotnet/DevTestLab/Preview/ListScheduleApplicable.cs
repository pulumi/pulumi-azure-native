...
namespace Pulumi.AzureRM.DevTestLab.Preview
{
    public static class ListScheduleApplicable
    {
        public static Task<ListScheduleApplicableResult> InvokeAsync(ListScheduleApplicableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListScheduleApplicableResult>("azurerm:devtestlab/preview:listScheduleApplicable", args ?? new ListScheduleApplicableArgs(), options.WithVersion());
    }
