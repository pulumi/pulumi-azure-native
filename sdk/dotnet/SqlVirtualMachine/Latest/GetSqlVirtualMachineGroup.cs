...
namespace Pulumi.AzureRM.SqlVirtualMachine.Latest
{
    public static class GetSqlVirtualMachineGroup
    {
        public static Task<GetSqlVirtualMachineGroupResult> InvokeAsync(GetSqlVirtualMachineGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlVirtualMachineGroupResult>("azurerm:sqlvirtualmachine/latest:getSqlVirtualMachineGroup", args ?? new GetSqlVirtualMachineGroupArgs(), options.WithVersion());
    }
