...
namespace Pulumi.AzureRM.SqlVirtualMachine.Latest
{
    public static class GetAvailabilityGroupListener
    {
        public static Task<GetAvailabilityGroupListenerResult> InvokeAsync(GetAvailabilityGroupListenerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAvailabilityGroupListenerResult>("azurerm:sqlvirtualmachine/latest:getAvailabilityGroupListener", args ?? new GetAvailabilityGroupListenerArgs(), options.WithVersion());
    }
