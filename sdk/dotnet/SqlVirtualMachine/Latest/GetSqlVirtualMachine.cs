...
namespace Pulumi.AzureRM.SqlVirtualMachine.Latest
{
    public static class GetSqlVirtualMachine
    {
        public static Task<GetSqlVirtualMachineResult> InvokeAsync(GetSqlVirtualMachineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlVirtualMachineResult>("azurerm:sqlvirtualmachine/latest:getSqlVirtualMachine", args ?? new GetSqlVirtualMachineArgs(), options.WithVersion());
    }
