...
namespace Pulumi.AzureRM.SqlVirtualMachine.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlVirtualMachineGroup = new AzureRM.SqlVirtualMachine.Latest.SqlVirtualMachineGroup("sqlVirtualMachineGroup", new AzureRM.SqlVirtualMachine.Latest.SqlVirtualMachineGroupArgs
    ///         {
    ...
    ///                 { "mytag", "myval" },
    ///             },
    ///             WsfcDomainProfile = new AzureRM.SqlVirtualMachine.Latest.Inputs.WsfcDomainProfileArgs
    ///             {
    ...
    public partial class SqlVirtualMachineGroup : Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachineGroup(string name, SqlVirtualMachineGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/latest:SqlVirtualMachineGroup", name, args ?? new SqlVirtualMachineGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachineGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/latest:SqlVirtualMachineGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup"},
                },
            };
