...
namespace Pulumi.AzureRM.SqlVirtualMachine.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlVirtualMachine = new AzureRM.SqlVirtualMachine.Latest.SqlVirtualMachine("sqlVirtualMachine", new AzureRM.SqlVirtualMachine.Latest.SqlVirtualMachineArgs
    ///         {
    ...
    ///             WsfcDomainCredentials = new AzureRM.SqlVirtualMachine.Latest.Inputs.WsfcDomainCredentialsArgs
    ///             {
    ...
    ///             ResourceGroupName = "testrg",
    ///             SqlVirtualMachineName = "testvm",
    ///             StorageConfigurationSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.StorageConfigurationSettingsArgs
    ///             {
    ///                 DiskConfigurationType = "EXTEND",
    ///                 SqlDataSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.SQLStorageSettingsArgs
    ///                 {
    ///                     Luns = 
    ///                     {
    ///                         2,
    ...
    ///                     },
    ///                 },
    ///                 SqlLogSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.SQLStorageSettingsArgs
    ///                 {
    ...
    ///                     },
    ///                 },
    ///                 SqlTempDbSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.SQLStorageSettingsArgs
    ///                 {
    ...
    ///         var sqlVirtualMachine = new AzureRM.SqlVirtualMachine.Latest.SqlVirtualMachine("sqlVirtualMachine", new AzureRM.SqlVirtualMachine.Latest.SqlVirtualMachineArgs
    ///         {
    ///             AutoBackupSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.AutoBackupSettingsArgs
    ///             {
    ...
    ///             },
    ///             AutoPatchingSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.AutoPatchingSettingsArgs
    ///             {
    ///                 DayOfWeek = "Sunday",
    ///                 Enable = true,
    ...
    ///             },
    ///             KeyVaultCredentialSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.KeyVaultCredentialSettingsArgs
    ///             {
    ///                 Enable = false,
    ///             },
    ///             Location = "northeurope",
    ///             ResourceGroupName = "testrg",
    ///             ServerConfigurationsManagementSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.ServerConfigurationsManagementSettingsArgs
    ///             {
    ///                 AdditionalFeaturesServerConfigurations = new AzureRM.SqlVirtualMachine.Latest.Inputs.AdditionalFeaturesServerConfigurationsArgs
    ///                 {
    ///                     IsRServicesEnabled = false,
    ///                 },
    ///                 SqlConnectivityUpdateSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.SqlConnectivityUpdateSettingsArgs
    ///                 {
    ...
    ///                 },
    ///                 SqlStorageUpdateSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.SqlStorageUpdateSettingsArgs
    ///                 {
    ///                     DiskConfigurationType = "NEW",
    ///                     DiskCount = 1,
    ///                     StartingDeviceId = 2,
    ///                 },
    ///                 SqlWorkloadTypeUpdateSettings = new AzureRM.SqlVirtualMachine.Latest.Inputs.SqlWorkloadTypeUpdateSettingsArgs
    ///                 {
    ...
    public partial class SqlVirtualMachine : Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachine(string name, SqlVirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/latest:SqlVirtualMachine", name, args ?? new SqlVirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/latest:SqlVirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sqlvirtualmachine/v20170301preview:SqlVirtualMachine"},
                },
            };
