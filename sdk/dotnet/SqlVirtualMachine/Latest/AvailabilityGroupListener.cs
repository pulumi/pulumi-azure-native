...
namespace Pulumi.AzureRM.SqlVirtualMachine.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var availabilityGroupListener = new AzureRM.SqlVirtualMachine.Latest.AvailabilityGroupListener("availabilityGroupListener", new AzureRM.SqlVirtualMachine.Latest.AvailabilityGroupListenerArgs
    ///         {
    ///             AvailabilityGroupListenerName = "agl-test",
    ///             AvailabilityGroupName = "ag-test",
    ///             LoadBalancerConfigurations = 
    ///             {
    ///                 new AzureRM.SqlVirtualMachine.Latest.Inputs.LoadBalancerConfigurationArgs
    ///                 {
    ///                     LoadBalancerResourceId = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.Network/loadBalancers/lb-test",
    ///                     PrivateIpAddress = new AzureRM.SqlVirtualMachine.Latest.Inputs.PrivateIPAddressArgs
    ///                     {
    ...
    public partial class AvailabilityGroupListener : Pulumi.CustomResource
    {
        ...
        public AvailabilityGroupListener(string name, AvailabilityGroupListenerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/latest:AvailabilityGroupListener", name, args ?? new AvailabilityGroupListenerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilityGroupListener(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/latest:AvailabilityGroupListener", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener"},
                },
            };
