...
namespace Pulumi.AzureNative.SqlVirtualMachine.V20220701Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachineGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachineGroup")]
    public partial class SqlVirtualMachineGroup : global::Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachineGroup(string name, SqlVirtualMachineGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachineGroup", name, args ?? new SqlVirtualMachineGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachineGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachineGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlVirtualMachineGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sqlImageSku")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20220701Preview.SqlVmGroupImageSku>? SqlImageSku { get; set; }
