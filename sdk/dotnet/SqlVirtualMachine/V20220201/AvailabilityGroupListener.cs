...
namespace Pulumi.AzureNative.SqlVirtualMachine.V20220201
{
    ...
    public partial class AvailabilityGroupListener : global::Pulumi.CustomResource
    {
        ...
        public AvailabilityGroupListener(string name, AvailabilityGroupListenerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20220201:AvailabilityGroupListener", name, args ?? new AvailabilityGroupListenerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilityGroupListener(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20220201:AvailabilityGroupListener", name, null, MakeResourceOptions(options, id))
        {
        }
