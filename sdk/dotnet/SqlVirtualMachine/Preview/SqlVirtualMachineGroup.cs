...
namespace Pulumi.AzureRM.SqlVirtualMachine.Preview
{
    /// <summary>
    ...
    public partial class SqlVirtualMachineGroup : Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachineGroup(string name, SqlVirtualMachineGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/preview:SqlVirtualMachineGroup", name, args ?? new SqlVirtualMachineGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachineGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/preview:SqlVirtualMachineGroup", name, null, MakeResourceOptions(options, id))
        {
        }
