...
namespace Pulumi.AzureRM.SqlVirtualMachine.Preview
{
    ...
    public partial class SqlVirtualMachine : Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachine(string name, SqlVirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/preview:SqlVirtualMachine", name, args ?? new SqlVirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/preview:SqlVirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
