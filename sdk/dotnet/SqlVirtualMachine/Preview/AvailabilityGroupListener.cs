...
namespace Pulumi.AzureRM.SqlVirtualMachine.Preview
{
    ...
    public partial class AvailabilityGroupListener : Pulumi.CustomResource
    {
        ...
        public AvailabilityGroupListener(string name, AvailabilityGroupListenerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/preview:AvailabilityGroupListener", name, args ?? new AvailabilityGroupListenerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilityGroupListener(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:sqlvirtualmachine/preview:AvailabilityGroupListener", name, null, MakeResourceOptions(options, id))
        {
        }
