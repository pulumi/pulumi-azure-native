...
namespace Pulumi.AzureRM.SqlVirtualMachine.Preview
{
    public static class GetSqlVirtualMachine
    {
        public static Task<GetSqlVirtualMachineResult> InvokeAsync(GetSqlVirtualMachineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlVirtualMachineResult>("azurerm:sqlvirtualmachine/preview:getSqlVirtualMachine", args ?? new GetSqlVirtualMachineArgs(), options.WithVersion());
    }
