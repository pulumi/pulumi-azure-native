...
namespace Pulumi.AzureNative.SqlVirtualMachine.V20220201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachineGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachineGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachineGroup")]
    public partial class SqlVirtualMachineGroup : global::Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachineGroup(string name, SqlVirtualMachineGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachineGroup", name, args ?? new SqlVirtualMachineGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachineGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachineGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:sqlvirtualmachine:SqlVirtualMachineGroup"},
    ...
    public sealed class SqlVirtualMachineGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sqlImageSku")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20220201Preview.SqlVmGroupImageSku>? SqlImageSku { get; set; }
