...
namespace Pulumi.AzureNative.SqlVirtualMachine.V20220201Preview
{
    ...
    public partial class SqlVirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachine(string name, SqlVirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachine", name, args ?? new SqlVirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlVirtualMachineArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sqlImageSku")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20220201Preview.SqlImageSku>? SqlImageSku { get; set; }

        /// <summary>
        /// SQL Server Management type.
        /// </summary>
        [Input("sqlManagement")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20220201Preview.SqlManagementMode>? SqlManagement { get; set; }

        /// <summary>
        /// SQL Server license type.
        /// </summary>
        [Input("sqlServerLicenseType")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20220201Preview.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
