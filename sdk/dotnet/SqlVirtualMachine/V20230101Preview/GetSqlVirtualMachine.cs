...
namespace Pulumi.AzureNative.SqlVirtualMachine.V20230101Preview
{
    public static class GetSqlVirtualMachine
    {
        ...
        public static Task<GetSqlVirtualMachineResult> InvokeAsync(GetSqlVirtualMachineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlVirtualMachineResult>("azure-native:sqlvirtualmachine/v20230101preview:getSqlVirtualMachine", args ?? new GetSqlVirtualMachineArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a SQL virtual machine.
        /// </summary>
        public static Output<GetSqlVirtualMachineResult> Invoke(GetSqlVirtualMachineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSqlVirtualMachineResult>("azure-native:sqlvirtualmachine/v20230101preview:getSqlVirtualMachine", args ?? new GetSqlVirtualMachineInvokeArgs(), options.WithDefaults());
