...
namespace Pulumi.AzureNative.SqlVirtualMachine.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup")]
    public partial class SqlVirtualMachineGroup : global::Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachineGroup(string name, SqlVirtualMachineGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup", name, args ?? new SqlVirtualMachineGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachineGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlVirtualMachineGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sqlImageSku")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20230101Preview.SqlVmGroupImageSku>? SqlImageSku { get; set; }
