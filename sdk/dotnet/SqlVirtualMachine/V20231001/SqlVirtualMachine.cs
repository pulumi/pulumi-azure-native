...
namespace Pulumi.AzureNative.SqlVirtualMachine.V20231001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sqlvirtualmachine/v20231001:SqlVirtualMachine")]
    public partial class SqlVirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachine(string name, SqlVirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20231001:SqlVirtualMachine", name, args ?? new SqlVirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20231001:SqlVirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlVirtualMachineArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20231001.LeastPrivilegeMode>? LeastPrivilegeMode { get; set; }
        ...
        /// </summary>
        [Input("sqlImageSku")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20231001.SqlImageSku>? SqlImageSku { get; set; }

        /// <summary>
        /// SQL Server Management type. NOTE: This parameter is not used anymore. API will automatically detect the Sql Management, refrain from using it.
        /// </summary>
        [Input("sqlManagement")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20231001.SqlManagementMode>? SqlManagement { get; set; }

        /// <summary>
        /// SQL Server license type.
        /// </summary>
        [Input("sqlServerLicenseType")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20231001.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
