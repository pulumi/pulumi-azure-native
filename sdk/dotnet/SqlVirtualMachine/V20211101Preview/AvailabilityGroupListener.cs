...
namespace Pulumi.AzureNative.SqlVirtualMachine.V20211101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:sqlvirtualmachine/v20211101preview:AvailabilityGroupListener")]
    public partial class AvailabilityGroupListener : global::Pulumi.CustomResource
    {
        ...
        public AvailabilityGroupListener(string name, AvailabilityGroupListenerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20211101preview:AvailabilityGroupListener", name, args ?? new AvailabilityGroupListenerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilityGroupListener(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20211101preview:AvailabilityGroupListener", name, null, MakeResourceOptions(options, id))
        {
        }
