...
namespace Pulumi.AzureNative.SqlVirtualMachine.V20211101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:sqlvirtualmachine/v20211101preview:SqlVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachine to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:sqlvirtualmachine/v20211101preview:SqlVirtualMachine")]
    public partial class SqlVirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public SqlVirtualMachine(string name, SqlVirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20211101preview:SqlVirtualMachine", name, args ?? new SqlVirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlVirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:sqlvirtualmachine/v20211101preview:SqlVirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlVirtualMachineArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sqlImageSku")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20211101Preview.SqlImageSku>? SqlImageSku { get; set; }

        /// <summary>
        /// SQL Server Management type.
        /// </summary>
        [Input("sqlManagement")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20211101Preview.SqlManagementMode>? SqlManagement { get; set; }

        /// <summary>
        /// SQL Server license type.
        /// </summary>
        [Input("sqlServerLicenseType")]
        public InputUnion<string, Pulumi.AzureNative.SqlVirtualMachine.V20211101Preview.SqlServerLicenseType>? SqlServerLicenseType { get; set; }
