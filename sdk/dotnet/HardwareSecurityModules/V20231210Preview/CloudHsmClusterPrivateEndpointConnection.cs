...
namespace Pulumi.AzureNative.HardwareSecurityModules.V20231210Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hardwaresecuritymodules/v20231210preview:CloudHsmClusterPrivateEndpointConnection")]
    public partial class CloudHsmClusterPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public CloudHsmClusterPrivateEndpointConnection(string name, CloudHsmClusterPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hardwaresecuritymodules/v20231210preview:CloudHsmClusterPrivateEndpointConnection", name, args ?? new CloudHsmClusterPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudHsmClusterPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hardwaresecuritymodules/v20231210preview:CloudHsmClusterPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
