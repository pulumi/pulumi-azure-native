...
namespace Pulumi.AzureNative.HardwareSecurityModules.V20211130
{
    ...
    public partial class DedicatedHsm : Pulumi.CustomResource
    {
        ...
        public DedicatedHsm(string name, DedicatedHsmArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hardwaresecuritymodules/v20211130:DedicatedHsm", name, args ?? new DedicatedHsmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHsm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hardwaresecuritymodules/v20211130:DedicatedHsm", name, null, MakeResourceOptions(options, id))
        {
        }
