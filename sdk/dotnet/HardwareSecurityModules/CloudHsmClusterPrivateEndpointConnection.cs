...
namespace Pulumi.AzureNative.HardwareSecurityModules
{
    ...
    public partial class CloudHsmClusterPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public CloudHsmClusterPrivateEndpointConnection(string name, CloudHsmClusterPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hardwaresecuritymodules:CloudHsmClusterPrivateEndpointConnection", name, args ?? new CloudHsmClusterPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudHsmClusterPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hardwaresecuritymodules:CloudHsmClusterPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_hardwaresecuritymodules_v20220831preview:hardwaresecuritymodules:CloudHsmClusterPrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_hardwaresecuritymodules_v20231210preview:hardwaresecuritymodules:CloudHsmClusterPrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_hardwaresecuritymodules_v20240630preview:hardwaresecuritymodules:CloudHsmClusterPrivateEndpointConnection" },
                },
            };
