...
namespace Pulumi.AzureRM.HardwareSecurityModules.Preview
{
    ...
    public partial class DedicatedHsm : Pulumi.CustomResource
    {
        ...
        public DedicatedHsm(string name, DedicatedHsmArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hardwaresecuritymodules/preview:DedicatedHsm", name, args ?? new DedicatedHsmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHsm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hardwaresecuritymodules/preview:DedicatedHsm", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:hardwaresecuritymodules/v20181031preview:DedicatedHsm"},
                },
            };
