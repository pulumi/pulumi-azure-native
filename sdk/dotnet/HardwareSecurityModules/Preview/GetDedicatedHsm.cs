...
namespace Pulumi.AzureRM.HardwareSecurityModules.Preview
{
    public static class GetDedicatedHsm
    {
        public static Task<GetDedicatedHsmResult> InvokeAsync(GetDedicatedHsmArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedHsmResult>("azurerm:hardwaresecuritymodules/preview:getDedicatedHsm", args ?? new GetDedicatedHsmArgs(), options.WithVersion());
    }
