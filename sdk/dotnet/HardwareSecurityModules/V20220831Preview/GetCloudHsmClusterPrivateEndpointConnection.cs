...
namespace Pulumi.AzureNative.HardwareSecurityModules.V20220831Preview
{
    public static class GetCloudHsmClusterPrivateEndpointConnection
    {
        ...
        public static Task<GetCloudHsmClusterPrivateEndpointConnectionResult> InvokeAsync(GetCloudHsmClusterPrivateEndpointConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCloudHsmClusterPrivateEndpointConnectionResult>("azure-native:hardwaresecuritymodules/v20220831preview:getCloudHsmClusterPrivateEndpointConnection", args ?? new GetCloudHsmClusterPrivateEndpointConnectionArgs(), options.WithDefaults());
