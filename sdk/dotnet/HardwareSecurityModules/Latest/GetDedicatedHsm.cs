...
namespace Pulumi.AzureRM.HardwareSecurityModules.Latest
{
    public static class GetDedicatedHsm
    {
        public static Task<GetDedicatedHsmResult> InvokeAsync(GetDedicatedHsmArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedHsmResult>("azurerm:hardwaresecuritymodules/latest:getDedicatedHsm", args ?? new GetDedicatedHsmArgs(), options.WithVersion());
    }
