...
namespace Pulumi.AzureRM.HardwareSecurityModules.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dedicatedHsm = new AzureRM.HardwareSecurityModules.Latest.DedicatedHsm("dedicatedHsm", new AzureRM.HardwareSecurityModules.Latest.DedicatedHsmArgs
    ///         {
    ///             Location = "westus",
    ///             Name = "hsm1",
    ///             NetworkProfile = new AzureRM.HardwareSecurityModules.Latest.Inputs.NetworkProfileArgs
    ///             {
    ///                 NetworkInterfaces = 
    ///                 {
    ///                     new AzureRM.HardwareSecurityModules.Latest.Inputs.NetworkInterfaceArgs
    ///                     {
    ///                         PrivateIpAddress = "1.0.0.1",
    ///                     },
    ///                 },
    ///                 Subnet = new AzureRM.HardwareSecurityModules.Latest.Inputs.ApiEntityReferenceArgs
    ///                 {
    ...
    ///             Sku = new AzureRM.HardwareSecurityModules.Latest.Inputs.SkuArgs
    ///             {
    ...
    public partial class DedicatedHsm : Pulumi.CustomResource
    {
        ...
        public DedicatedHsm(string name, DedicatedHsmArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hardwaresecuritymodules/latest:DedicatedHsm", name, args ?? new DedicatedHsmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHsm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hardwaresecuritymodules/latest:DedicatedHsm", name, null, MakeResourceOptions(options, id))
        {
        }
