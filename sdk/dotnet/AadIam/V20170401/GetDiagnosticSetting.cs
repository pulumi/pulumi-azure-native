...
namespace Pulumi.AzureNative.AadIam.V20170401
{
    public static class GetDiagnosticSetting
    {
        ...
        public static Task<GetDiagnosticSettingResult> InvokeAsync(GetDiagnosticSettingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDiagnosticSettingResult>("azure-native:aadiam/v20170401:getDiagnosticSetting", args ?? new GetDiagnosticSettingArgs(), options.WithDefaults());

        /// <summary>
        /// The diagnostic setting resource.
        /// </summary>
        public static Output<GetDiagnosticSettingResult> Invoke(GetDiagnosticSettingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDiagnosticSettingResult>("azure-native:aadiam/v20170401:getDiagnosticSetting", args ?? new GetDiagnosticSettingInvokeArgs(), options.WithDefaults());
    }
