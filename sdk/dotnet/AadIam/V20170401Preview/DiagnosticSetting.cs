...
namespace Pulumi.AzureNative.AadIam.V20170401Preview
{
    ...
    public partial class DiagnosticSetting : global::Pulumi.CustomResource
    {
        ...
        public DiagnosticSetting(string name, DiagnosticSettingArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:aadiam/v20170401preview:DiagnosticSetting", name, args ?? new DiagnosticSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiagnosticSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:aadiam/v20170401preview:DiagnosticSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:aadiam:DiagnosticSetting"},
                    new global::Pulumi.Alias { Type = "azure-native:aadiam/v20170401:DiagnosticSetting"},
                },
            };
