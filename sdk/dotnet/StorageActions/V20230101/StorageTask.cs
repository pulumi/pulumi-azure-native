...
namespace Pulumi.AzureNative.StorageActions.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storageactions/v20230101:StorageTask")]
    public partial class StorageTask : global::Pulumi.CustomResource
    {
        ...
        public StorageTask(string name, StorageTaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storageactions/v20230101:StorageTask", name, args ?? new StorageTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storageactions/v20230101:StorageTask", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:storageactions:StorageTask"},
                },
            };
