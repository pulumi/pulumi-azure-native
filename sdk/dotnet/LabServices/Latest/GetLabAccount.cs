...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getLabAccount'.")]
    public static class GetLabAccount
    {
        ...
        public static Task<GetLabAccountResult> InvokeAsync(GetLabAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLabAccountResult>("azure-native:labservices/latest:getLabAccount", args ?? new GetLabAccountArgs(), options.WithVersion());
    }
