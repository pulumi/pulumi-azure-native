...
namespace Pulumi.AzureNextGen.LabServices.Latest.Outputs
{
    ...
    [OutputType]
    public sealed class EnvironmentSizeInvokeResponseResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.SizeInfoInvokeResponseResult> VmSizes;

        [OutputConstructor]
        private EnvironmentSizeInvokeResponseResult(
            double maxPrice,
            ...
            ImmutableArray<Outputs.SizeInfoInvokeResponseResult> vmSizes)
        {
            MaxPrice = maxPrice;
            MinMemory = minMemory;
