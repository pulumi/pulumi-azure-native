...
namespace Pulumi.AzureRM.LabServices.Preview
{
    ...
    public partial class EnvironmentSetting : Pulumi.CustomResource
    {
        ...
        public EnvironmentSetting(string name, EnvironmentSettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:labservices/preview:EnvironmentSetting", name, args ?? new EnvironmentSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:labservices/preview:EnvironmentSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:labservices/latest:EnvironmentSetting"},
