...
namespace Pulumi.AzureRM.LabServices.Preview
{
    public static class GetEnvironmentSetting
    {
        public static Task<GetEnvironmentSettingResult> InvokeAsync(GetEnvironmentSettingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentSettingResult>("azurerm:labservices/preview:getEnvironmentSetting", args ?? new GetEnvironmentSettingArgs(), options.WithVersion());
    }
