...
namespace Pulumi.AzureRM.LabServices.Preview
{
    public static class GetEnvironment
    {
        public static Task<GetEnvironmentResult> InvokeAsync(GetEnvironmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentResult>("azurerm:labservices/preview:getEnvironment", args ?? new GetEnvironmentArgs(), options.WithVersion());
    }
