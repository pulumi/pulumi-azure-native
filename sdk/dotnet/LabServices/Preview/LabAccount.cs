...
namespace Pulumi.AzureRM.LabServices.Preview
{
    ...
    public partial class LabAccount : Pulumi.CustomResource
    {
        ...
        public LabAccount(string name, LabAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:labservices/preview:LabAccount", name, args ?? new LabAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:labservices/preview:LabAccount", name, null, MakeResourceOptions(options, id))
        {
        }
