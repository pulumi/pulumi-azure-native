...
namespace Pulumi.AzureNative.LabServices.V20220801
{
    public static class GetLabPlan
    {
        ...
        public static Task<GetLabPlanResult> InvokeAsync(GetLabPlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLabPlanResult>("azure-native:labservices/v20220801:getLabPlan", args ?? new GetLabPlanArgs(), options.WithDefaults());

        /// <summary>
        /// Lab Plans act as a permission container for creating labs via labs.azure.com. Additionally, they can provide a set of default configurations that will apply at the time of creating a lab, but these defaults can still be overwritten.
        /// </summary>
        public static Output<GetLabPlanResult> Invoke(GetLabPlanInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLabPlanResult>("azure-native:labservices/v20220801:getLabPlan", args ?? new GetLabPlanInvokeArgs(), options.WithDefaults());
    }
