...
namespace Pulumi.AzureNative.LabServices.V20220801
{
    ...
    public partial class LabPlan : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.LabPlanPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public LabPlan(string name, LabPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20220801:LabPlan", name, args ?? new LabPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20220801:LabPlan", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LabPlanArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LabPlanPropertiesArgs> Properties { get; set; } = null!;
