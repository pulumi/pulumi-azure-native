...
namespace Pulumi.AzureNative.LabServices.V20220801
{
    ...
    /// {
    ///     var schedule = new AzureNative.LabServices.V20220801.Schedule("schedule", new()
    ///     {
    ///         LabName = "testlab",
    ///         Notes = "Schedule 1 for students",
    ///         RecurrencePattern = new AzureNative.LabServices.V20220801.Inputs.RecurrencePatternArgs
    ///         {
    ///             ExpirationDate = "2020-08-14T23:59:59Z",
    ///             Frequency = AzureNative.LabServices.V20220801.RecurrenceFrequency.Daily,
    ///             Interval = 2,
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:labservices/v20220801:Schedule")]
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20220801:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20220801:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
