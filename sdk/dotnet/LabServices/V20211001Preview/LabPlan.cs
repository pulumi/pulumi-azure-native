...
namespace Pulumi.AzureNative.LabServices.V20211001Preview
{
    ...
    /// {
    ///     var labPlan = new AzureNative.LabServices.V20211001Preview.LabPlan("labPlan", new()
    ///     {
    ///         DefaultAutoShutdownProfile = new AzureNative.LabServices.V20211001Preview.Inputs.AutoShutdownProfileArgs
    ///         {
    ///             DisconnectDelay = "00:05",
    ///             IdleDelay = "01:00",
    ///             NoConnectDelay = "01:00",
    ///             ShutdownOnDisconnect = AzureNative.LabServices.V20211001Preview.EnableState.Enabled,
    ///             ShutdownOnIdle = AzureNative.LabServices.V20211001Preview.ShutdownOnIdleMode.UserAbsence,
    ///             ShutdownWhenNotConnected = AzureNative.LabServices.V20211001Preview.EnableState.Enabled,
    ///         },
    ///         DefaultConnectionProfile = new AzureNative.LabServices.V20211001Preview.Inputs.ConnectionProfileArgs
    ///         {
    ///             ClientRdpAccess = AzureNative.LabServices.V20211001Preview.ConnectionType.Public,
    ///             ClientSshAccess = AzureNative.LabServices.V20211001Preview.ConnectionType.Public,
    ///             WebRdpAccess = AzureNative.LabServices.V20211001Preview.ConnectionType.None,
    ///             WebSshAccess = AzureNative.LabServices.V20211001Preview.ConnectionType.None,
    ///         },
    ///         DefaultNetworkProfile = new AzureNative.LabServices.V20211001Preview.Inputs.LabPlanNetworkProfileArgs
    ///         {
    ...
    ///         SupportInfo = new AzureNative.LabServices.V20211001Preview.Inputs.SupportInfoArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:labservices/v20211001preview:LabPlan")]
    public partial class LabPlan : global::Pulumi.CustomResource
    {
        ...
        public LabPlan(string name, LabPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211001preview:LabPlan", name, args ?? new LabPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211001preview:LabPlan", name, null, MakeResourceOptions(options, id))
        {
        }
