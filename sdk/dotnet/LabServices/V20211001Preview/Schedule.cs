...
namespace Pulumi.AzureNative.LabServices.V20211001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:labservices/v20211001preview:Schedule is being removed in the next major version of this provider. Upgrade to at least azure-native:labservices/v20220801:Schedule to guarantee forwards compatibility.")]
    ...
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211001preview:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211001preview:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
