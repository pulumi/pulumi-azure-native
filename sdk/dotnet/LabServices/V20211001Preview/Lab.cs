...
namespace Pulumi.AzureNative.LabServices.V20211001Preview
{
    ...
    /// The lab resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:labservices/v20211001preview:Lab")]
    public partial class Lab : Pulumi.CustomResource
    {
        ...
        public Lab(string name, LabArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211001preview:Lab", name, args ?? new LabArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Lab(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211001preview:Lab", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:labservices/v20211001preview:Lab"},
                },
            };
