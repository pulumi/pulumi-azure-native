...
namespace Pulumi.AzureNative.LabServices.V20211001Preview
{
    public static class GetSchedule
    {
        ...
        public static Task<GetScheduleResult> InvokeAsync(GetScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScheduleResult>("azure-native:labservices/v20211001preview:getSchedule", args ?? new GetScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// Schedule for automatically turning virtual machines in a lab on and off at specified times.
        /// </summary>
        public static Output<GetScheduleResult> Invoke(GetScheduleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScheduleResult>("azure-native:labservices/v20211001preview:getSchedule", args ?? new GetScheduleInvokeArgs(), options.WithDefaults());
    }
