...
namespace Pulumi.AzureNative.LabServices.V20211115Preview
{
    public static class GetLabPlan
    {
        ...
        public static Task<GetLabPlanResult> InvokeAsync(GetLabPlanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLabPlanResult>("azure-native:labservices/v20211115preview:getLabPlan", args ?? new GetLabPlanArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the properties of a Lab Plan.
        /// </summary>
        public static Output<GetLabPlanResult> Invoke(GetLabPlanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLabPlanResult>("azure-native:labservices/v20211115preview:getLabPlan", args ?? new GetLabPlanInvokeArgs(), options.WithDefaults());
    }
