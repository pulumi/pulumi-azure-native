...
namespace Pulumi.AzureNative.LabServices.V20211115Preview.Inputs
{
    ...
    public sealed class VirtualMachineAdditionalCapabilitiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.LabServices.V20211115Preview.EnableState>? InstallGpuDrivers { get; set; }

        public VirtualMachineAdditionalCapabilitiesArgs()
        {
            InstallGpuDrivers = Pulumi.AzureNative.LabServices.V20211115Preview.EnableState.Disabled;
        }
