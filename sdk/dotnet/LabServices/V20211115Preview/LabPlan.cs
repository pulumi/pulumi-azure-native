...
namespace Pulumi.AzureNative.LabServices.V20211115Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:labservices/v20211115preview:LabPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:labservices/v20220801:LabPlan to guarantee forwards compatibility.")]
    ...
    public partial class LabPlan : global::Pulumi.CustomResource
    {
        ...
        public LabPlan(string name, LabPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211115preview:LabPlan", name, args ?? new LabPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211115preview:LabPlan", name, null, MakeResourceOptions(options, id))
        {
        }
