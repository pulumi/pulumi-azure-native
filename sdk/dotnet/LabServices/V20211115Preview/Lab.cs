...
namespace Pulumi.AzureNative.LabServices.V20211115Preview
{
    ...
    /// The lab resource.
    /// </summary>
    [Obsolete(@"azure-native:labservices/v20211115preview:Lab is being removed in the next major version of this provider. Please upgrade to azure-native:labservices/v20220801:Lab to guarantee forwards compatibility.")]
    ...
    public partial class Lab : global::Pulumi.CustomResource
    {
        ...
        public Lab(string name, LabArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211115preview:Lab", name, args ?? new LabArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Lab(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20211115preview:Lab", name, null, MakeResourceOptions(options, id))
        {
        }
