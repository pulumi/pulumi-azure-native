...
namespace Pulumi.AzureRM.LabServices
{
    public static class ListGlobalUserLabs
    {
        public static Task<ListGlobalUserLabsResult> InvokeAsync(ListGlobalUserLabsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListGlobalUserLabsResult>("azurerm:labservices:listGlobalUserLabs", args ?? new ListGlobalUserLabsArgs(), options.WithVersion());
    }
