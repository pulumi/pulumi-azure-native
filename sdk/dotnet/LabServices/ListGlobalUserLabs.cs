...
namespace Pulumi.AzureNative.LabServices
{
    public static class ListGlobalUserLabs
    {
        ...
        public static Task<ListGlobalUserLabsResult> InvokeAsync(ListGlobalUserLabsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListGlobalUserLabsResult>("azure-native:labservices:listGlobalUserLabs", args ?? new ListGlobalUserLabsArgs(), options.WithDefaults());
        ...
        public static Output<ListGlobalUserLabsResult> Invoke(ListGlobalUserLabsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListGlobalUserLabsResult>("azure-native:labservices:listGlobalUserLabs", args ?? new ListGlobalUserLabsInvokeArgs(), options.WithDefaults());
    }
