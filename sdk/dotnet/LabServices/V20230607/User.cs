...
namespace Pulumi.AzureNative.LabServices.V20230607
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:labservices/v20230607:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20230607:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20230607:User", name, null, MakeResourceOptions(options, id))
        {
        }
