...
namespace Pulumi.AzureNative.LabServices.V20230607
{
    public static class GetLab
    {
        ...
        public static Task<GetLabResult> InvokeAsync(GetLabArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLabResult>("azure-native:labservices/v20230607:getLab", args ?? new GetLabArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the properties of a lab resource.
        /// </summary>
        public static Output<GetLabResult> Invoke(GetLabInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLabResult>("azure-native:labservices/v20230607:getLab", args ?? new GetLabInvokeArgs(), options.WithDefaults());
    }
