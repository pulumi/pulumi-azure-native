...
namespace Pulumi.AzureNative.LabServices.V20230607
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:labservices/v20230607:LabPlan")]
    public partial class LabPlan : global::Pulumi.CustomResource
    {
        ...
        public LabPlan(string name, LabPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20230607:LabPlan", name, args ?? new LabPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20230607:LabPlan", name, null, MakeResourceOptions(options, id))
        {
        }
