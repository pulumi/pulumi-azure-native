...
namespace Pulumi.AzureNative.LabServices.V20230607.Inputs
{
    ...
    public sealed class VirtualMachineAdditionalCapabilitiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.LabServices.V20230607.EnableState>? InstallGpuDrivers { get; set; }

        public VirtualMachineAdditionalCapabilitiesArgs()
        {
            InstallGpuDrivers = Pulumi.AzureNative.LabServices.V20230607.EnableState.Disabled;
        }
