...
namespace Pulumi.AzureNative.LabServices.V20230607
{
    ...
    /// The lab resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:labservices/v20230607:Lab")]
    public partial class Lab : global::Pulumi.CustomResource
    {
        ...
        public Lab(string name, LabArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20230607:Lab", name, args ?? new LabArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Lab(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20230607:Lab", name, null, MakeResourceOptions(options, id))
        {
        }
