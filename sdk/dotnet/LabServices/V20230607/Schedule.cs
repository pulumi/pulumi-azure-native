...
namespace Pulumi.AzureNative.LabServices.V20230607
{
    /// <summary>
    /// Schedule for automatically turning virtual machines in a lab on and off at specified times.
    /// </summary>
    [AzureNativeResourceType("azure-native:labservices/v20230607:Schedule")]
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20230607:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:labservices/v20230607:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
