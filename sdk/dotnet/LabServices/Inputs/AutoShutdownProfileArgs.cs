...
namespace Pulumi.AzureNative.LabServices.Inputs
{
    ...
    public sealed class AutoShutdownProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.LabServices.EnableState>? ShutdownOnDisconnect { get; set; }

        /// <summary>
        /// Whether a VM will get shutdown when it has idled for a period of time.
        /// </summary>
        [Input("shutdownOnIdle")]
        public Input<Pulumi.AzureNative.LabServices.ShutdownOnIdleMode>? ShutdownOnIdle { get; set; }

        /// <summary>
        /// Whether a VM will get shutdown when it hasn't been connected to after a period of time.
        /// </summary>
        [Input("shutdownWhenNotConnected")]
        public Input<Pulumi.AzureNative.LabServices.EnableState>? ShutdownWhenNotConnected { get; set; }

        public AutoShutdownProfileArgs()
        {
            ShutdownOnDisconnect = Pulumi.AzureNative.LabServices.EnableState.Disabled;
