...
namespace Pulumi.AzureRM.LabServices.Inputs
{
    ...
    /// </summary>
    public sealed class EnvironmentSizeResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("vmSizes")]
        private InputList<Inputs.SizeInfoResponseArgs>? _vmSizes;

        /// <summary>
        /// Represents a set of compute sizes that can serve this given size type
        /// </summary>
        public InputList<Inputs.SizeInfoResponseArgs> VmSizes
        {
            get => _vmSizes ?? (_vmSizes = new InputList<Inputs.SizeInfoResponseArgs>());
            set => _vmSizes = value;
        }

        public EnvironmentSizeResponseArgs()
        {
        }
    }
}
