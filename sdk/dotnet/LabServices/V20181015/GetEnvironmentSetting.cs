...
namespace Pulumi.AzureRM.LabServices.V20181015
{
    public static class GetEnvironmentSetting
    {
        public static Task<GetEnvironmentSettingResult> InvokeAsync(GetEnvironmentSettingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentSettingResult>("azurerm:labservices/v20181015:getEnvironmentSetting", args ?? new GetEnvironmentSettingArgs(), options.WithVersion());
    }
