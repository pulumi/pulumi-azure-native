...
namespace Pulumi.AzureRM.LabServices.V20181015
{
    ...
    public partial class LabAccount : Pulumi.CustomResource
    {
        ...
        public LabAccount(string name, LabAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:labservices/v20181015:LabAccount", name, args ?? new LabAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:labservices/v20181015:LabAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:labservices/latest:LabAccount"},
                    new Pulumi.Alias { Type = "azurerm:labservices/preview:LabAccount"},
                },
            };
