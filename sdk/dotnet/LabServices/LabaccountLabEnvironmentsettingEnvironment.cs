...
namespace Pulumi.AzureRM.LabServices
{
    ...
    public partial class LabaccountLabEnvironmentsettingEnvironment : Pulumi.CustomResource
    {
        ...
        private LabaccountLabEnvironmentsettingEnvironment(string name, Input<string> id, LabaccountLabEnvironmentsettingEnvironmentState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:labservices:LabaccountLabEnvironmentsettingEnvironment", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LabaccountLabEnvironmentsettingEnvironment Get(string name, Input<string> id, LabaccountLabEnvironmentsettingEnvironmentState? state = null, CustomResourceOptions? options = null)
        {
            return new LabaccountLabEnvironmentsettingEnvironment(name, id, state, options);
        }
    }
    ...
    public sealed class LabaccountLabEnvironmentsettingEnvironmentState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The location of the resource.
        /// </summary>
        ...
        public LabaccountLabEnvironmentsettingEnvironmentState()
        {
        }
    }
}
