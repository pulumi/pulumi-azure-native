...
namespace Pulumi.AzureNative.Impact.V20240501Preview
{
    ...
    /// Insight resource
    /// </summary>
    [AzureNativeResourceType("azure-native:impact/v20240501preview:Insight")]
    public partial class Insight : global::Pulumi.CustomResource
    {
        ...
        public Insight(string name, InsightArgs args, CustomResourceOptions? options = null)
            : base("azure-native:impact/v20240501preview:Insight", name, args ?? new InsightArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Insight(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:impact/v20240501preview:Insight", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:impact:Insight" },
                },
            };
