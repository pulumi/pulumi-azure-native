...
namespace Pulumi.AzureNative.Impact.V20240501Preview
{
    public static class GetWorkloadImpact
    {
        ...
        public static Task<GetWorkloadImpactResult> InvokeAsync(GetWorkloadImpactArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkloadImpactResult>("azure-native:impact/v20240501preview:getWorkloadImpact", args ?? new GetWorkloadImpactArgs(), options.WithDefaults());
