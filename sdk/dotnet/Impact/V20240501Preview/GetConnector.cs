...
namespace Pulumi.AzureNative.Impact.V20240501Preview
{
    public static class GetConnector
    {
        ...
        public static Task<GetConnectorResult> InvokeAsync(GetConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectorResult>("azure-native:impact/v20240501preview:getConnector", args ?? new GetConnectorArgs(), options.WithDefaults());
