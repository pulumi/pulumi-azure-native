...
namespace Pulumi.AzureNative.Impact.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:impact/v20240501preview:Connector")]
    public partial class Connector : global::Pulumi.CustomResource
    {
        ...
        public Connector(string name, ConnectorArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:impact/v20240501preview:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:impact/v20240501preview:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:impact:Connector" },
                },
            };
