...
namespace Pulumi.AzureNative.Impact.V20240501Preview
{
    public static class GetInsight
    {
        ...
        public static Task<GetInsightResult> InvokeAsync(GetInsightArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInsightResult>("azure-native:impact/v20240501preview:getInsight", args ?? new GetInsightArgs(), options.WithDefaults());
