...
namespace Pulumi.AzureNative.Impact.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:impact/v20240501preview:WorkloadImpact")]
    public partial class WorkloadImpact : global::Pulumi.CustomResource
    {
        ...
        public WorkloadImpact(string name, WorkloadImpactArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:impact/v20240501preview:WorkloadImpact", name, args ?? new WorkloadImpactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadImpact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:impact/v20240501preview:WorkloadImpact", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:impact:WorkloadImpact" },
                },
            };
