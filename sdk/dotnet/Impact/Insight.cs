...
namespace Pulumi.AzureNative.Impact
{
    ...
    public partial class Insight : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.InsightPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public Insight(string name, InsightArgs args, CustomResourceOptions? options = null)
            : base("azure-native:impact:Insight", name, args ?? new InsightArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Insight(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:impact:Insight", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:impact/v20250101preview:Insight" },
                    new global::Pulumi.Alias { Type = "azure-native:impact/v20260101preview:Insight" },
                },
            };
    ...
    public sealed class InsightArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.InsightPropertiesArgs>? Properties { get; set; }
