...
namespace Pulumi.AzureNative.Impact
{
    ...
    public partial class Connector : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConnectorPropertiesResponse> Properties { get; private set; } = null!;
        ...
        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:impact:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:impact/v20250101preview:Connector" },
                    new global::Pulumi.Alias { Type = "azure-native:impact/v20260101preview:Connector" },
                },
            };
    ...
    public sealed class ConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.ConnectorPropertiesArgs>? Properties { get; set; }
