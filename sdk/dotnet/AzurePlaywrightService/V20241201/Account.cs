...
namespace Pulumi.AzureNative.AzurePlaywrightService.V20241201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azureplaywrightservice/v20241201:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azureplaywrightservice/v20241201:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azureplaywrightservice/v20241201:Account", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzurePlaywrightService.V20241201.EnablementStatus>? RegionalAffinity { get; set; }

        /// <summary>
        /// When enabled, this feature allows the workspace to upload and display test results, including artifacts like traces and screenshots, in the Playwright portal. This enables faster and more efficient troubleshooting.
        /// </summary>
        [Input("reporting")]
        public InputUnion<string, Pulumi.AzureNative.AzurePlaywrightService.V20241201.EnablementStatus>? Reporting { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzurePlaywrightService.V20241201.EnablementStatus>? ScalableExecution { get; set; }
