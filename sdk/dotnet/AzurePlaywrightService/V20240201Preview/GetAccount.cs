...
namespace Pulumi.AzureNative.AzurePlaywrightService.V20240201Preview
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:azureplaywrightservice/v20240201preview:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());
