...
namespace Pulumi.AzureNative.DBforPostgreSQL
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql:ServerGroupPrivateEndpointConnection")]
    public partial class ServerGroupPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public ServerGroupPrivateEndpointConnection(string name, ServerGroupPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql:ServerGroupPrivateEndpointConnection", name, args ?? new ServerGroupPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerGroupPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql:ServerGroupPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_dbforpostgresql_v20221108:dbforpostgresql:ServerGroupPrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_dbforpostgresql_v20230302preview:dbforpostgresql:ServerGroupPrivateEndpointConnection" },
                },
            };
