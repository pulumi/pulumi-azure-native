...
namespace Pulumi.AzureNextGen.DBforPostgreSQL.V20171201
{
    public static class GetConfiguration
    {
        public static Task<GetConfigurationResult> InvokeAsync(GetConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationResult>("azure-nextgen:dbforpostgresql/v20171201:getConfiguration", args ?? new GetConfigurationArgs(), options.WithVersion());
    }
