...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20171201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:dbforpostgresql/v20171201:ServerAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20171201preview:ServerAdministrator to guarantee forwards compatibility.")]
    ...
    public partial class ServerAdministrator : global::Pulumi.CustomResource
    {
        ...
        public ServerAdministrator(string name, ServerAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201:ServerAdministrator", name, args ?? new ServerAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201:ServerAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
