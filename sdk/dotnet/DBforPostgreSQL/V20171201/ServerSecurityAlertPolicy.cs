...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20171201
{
    ...
    /// {
    ///     var serverSecurityAlertPolicy = new AzureNative.DBforPostgreSQL.V20171201.ServerSecurityAlertPolicy("serverSecurityAlertPolicy", new()
    ///     {
    ///         DisabledAlerts = new[]
    ///         {
    ///             "Access_Anomaly",
    ...
    ///         State = AzureNative.DBforPostgreSQL.V20171201.ServerSecurityAlertPolicyState.Enabled,
    ...
    ///         SecurityAlertPolicyName = "Default",
    ///         ServerName = "securityalert-6440",
    ///         State = AzureNative.DBforPostgreSQL.V20171201.ServerSecurityAlertPolicyState.Disabled,
    ///     });
    /// 
    /// });
    /// 
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:dbforpostgresql/v20171201:ServerSecurityAlertPolicy Default /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/securityalert-4799/providers/Microsoft.DBforPostgreSQL/servers/securityalert-6440/securityAlertPolicies/default 
    /// ```
    /// </summary>
    ...
    public partial class ServerSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServerSecurityAlertPolicy(string name, ServerSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201:ServerSecurityAlertPolicy", name, args ?? new ServerSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201:ServerSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerSecurityAlertPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.DBforPostgreSQL.V20171201.ServerSecurityAlertPolicyState> State { get; set; } = null!;
