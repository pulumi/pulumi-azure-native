...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20171201
{
    ...
    /// {
    ///     var virtualNetworkRule = new AzureNative.DBforPostgreSQL.V20171201.VirtualNetworkRule("virtualNetworkRule", new()
    ///     {
    ...
    public partial class VirtualNetworkRule : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRule(string name, VirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201:VirtualNetworkRule", name, args ?? new VirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201:VirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
