...
namespace Pulumi.AzureNextGen.DBforPostgreSQL
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:dbforpostgresql:ServerGroup")]
    public partial class ServerGroup : Pulumi.CustomResource
    {
        ...
        public ServerGroup(string name, ServerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbforpostgresql:ServerGroup", name, args ?? new ServerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbforpostgresql:ServerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerGroupArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("citusVersion")]
        public InputUnion<string, Pulumi.AzureNextGen.DBforPostgreSQL.CitusVersion>? CitusVersion { get; set; }

        /// <summary>
        /// The mode to create a new server group.
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNextGen.DBforPostgreSQL.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DBforPostgreSQL.PostgreSQLVersion>? PostgresqlVersion { get; set; }
