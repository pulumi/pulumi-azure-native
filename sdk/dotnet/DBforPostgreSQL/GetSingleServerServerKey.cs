...
namespace Pulumi.AzureNative.DBforPostgreSQL
{
    public static class GetSingleServerServerKey
    {
        ...
        public static Task<GetSingleServerServerKeyResult> InvokeAsync(GetSingleServerServerKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSingleServerServerKeyResult>("azure-native:dbforpostgresql:getSingleServerServerKey", args ?? new GetSingleServerServerKeyArgs(), options.WithDefaults());
        ...
        public static Output<GetSingleServerServerKeyResult> Invoke(GetSingleServerServerKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSingleServerServerKeyResult>("azure-native:dbforpostgresql:getSingleServerServerKey", args ?? new GetSingleServerServerKeyInvokeArgs(), options.WithDefaults());
