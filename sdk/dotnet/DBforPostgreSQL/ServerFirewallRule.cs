...
namespace Pulumi.AzureRM.DBforPostgreSQL
{
    ...
    /// </summary>
    public partial class ServerFirewallRule : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ServerFirewallRule(string name, ServerFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbforpostgresql:ServerFirewallRule", name, args ?? new ServerFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ServerFirewallRule(string name, Input<string> id, ServerFirewallRuleState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:dbforpostgresql:ServerFirewallRule", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerFirewallRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
