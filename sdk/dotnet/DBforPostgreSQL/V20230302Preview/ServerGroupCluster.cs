...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20230302Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20230302preview:ServerGroupCluster")]
    public partial class ServerGroupCluster : global::Pulumi.CustomResource
    {
        ...
        public ServerGroupCluster(string name, ServerGroupClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20230302preview:ServerGroupCluster", name, args ?? new ServerGroupClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerGroupCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20230302preview:ServerGroupCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dbforpostgresql:ServerGroupCluster" },
                },
            };
