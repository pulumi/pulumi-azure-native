...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20230302Preview
{
    public static class GetServerGroupRole
    {
        ...
        public static Task<GetServerGroupRoleResult> InvokeAsync(GetServerGroupRoleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerGroupRoleResult>("azure-native:dbforpostgresql/v20230302preview:getServerGroupRole", args ?? new GetServerGroupRoleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a cluster role.
        /// </summary>
        public static Output<GetServerGroupRoleResult> Invoke(GetServerGroupRoleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerGroupRoleResult>("azure-native:dbforpostgresql/v20230302preview:getServerGroupRole", args ?? new GetServerGroupRoleInvokeArgs(), options.WithDefaults());
