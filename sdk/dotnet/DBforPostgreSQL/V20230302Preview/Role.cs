...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20230302Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20230302preview:Role")]
    public partial class Role : global::Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20230302preview:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20230302preview:Role", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230302Preview.PrincipalType> PrincipalType { get; set; } = null!;
        ...
        [Input("roleType")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230302Preview.RoleType>? RoleType { get; set; }
