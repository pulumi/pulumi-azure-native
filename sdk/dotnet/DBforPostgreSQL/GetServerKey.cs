...
namespace Pulumi.AzureNative.DBforPostgreSQL
{
    public static class GetServerKey
    {
        ...
        public static Output<GetServerKeyResult> Invoke(GetServerKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerKeyResult>("azure-native:dbforpostgresql:getServerKey", args ?? new GetServerKeyInvokeArgs(), options.WithDefaults());
    }
