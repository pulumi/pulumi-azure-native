...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview
{
    public static class GetAdministrator
    {
        ...
        public static Task<GetAdministratorResult> InvokeAsync(GetAdministratorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAdministratorResult>("azure-native:dbforpostgresql/v20230301preview:getAdministrator", args ?? new GetAdministratorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a server.
        /// </summary>
        public static Output<GetAdministratorResult> Invoke(GetAdministratorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAdministratorResult>("azure-native:dbforpostgresql/v20230301preview:getAdministrator", args ?? new GetAdministratorInvokeArgs(), options.WithDefaults());
