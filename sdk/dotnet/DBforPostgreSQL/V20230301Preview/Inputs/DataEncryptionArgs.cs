...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.Inputs
{
    ...
    public sealed class DataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.KeyStatusEnum>? GeoBackupEncryptionKeyStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.KeyStatusEnum>? PrimaryEncryptionKeyStatus { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.ArmServerKeyType>? Type { get; set; }
