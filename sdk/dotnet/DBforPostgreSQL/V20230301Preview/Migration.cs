...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20230301preview:Migration")]
    public partial class Migration : global::Pulumi.CustomResource
    {
        ...
        public Migration(string name, MigrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20230301preview:Migration", name, args ?? new MigrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Migration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20230301preview:Migration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MigrationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cancel")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.CancelEnum>? Cancel { get; set; }
        ...
        /// </summary>
        [Input("migrationMode")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.MigrationMode>? MigrationMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.OverwriteDbsInTargetEnum>? OverwriteDbsInTarget { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.LogicalReplicationOnSourceDbEnum>? SetupLogicalReplicationOnSourceDbIfNeeded { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.StartDataMigrationEnum>? StartDataMigration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230301Preview.TriggerCutoverEnum>? TriggerCutover { get; set; }
