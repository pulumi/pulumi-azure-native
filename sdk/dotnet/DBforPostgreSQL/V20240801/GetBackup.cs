...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20240801
{
    public static class GetBackup
    {
        ...
        public static Task<GetBackupResult> InvokeAsync(GetBackupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackupResult>("azure-native:dbforpostgresql/v20240801:getBackup", args ?? new GetBackupArgs(), options.WithDefaults());

        /// <summary>
        /// Get specific backup for a given server.
        /// </summary>
        public static Output<GetBackupResult> Invoke(GetBackupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackupResult>("azure-native:dbforpostgresql/v20240801:getBackup", args ?? new GetBackupInvokeArgs(), options.WithDefaults());
