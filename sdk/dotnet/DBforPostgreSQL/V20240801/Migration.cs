...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20240801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20240801:Migration")]
    public partial class Migration : global::Pulumi.CustomResource
    {
        ...
        public Migration(string name, MigrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20240801:Migration", name, args ?? new MigrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Migration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20240801:Migration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MigrationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cancel")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.CancelEnum>? Cancel { get; set; }
        ...
        /// </summary>
        [Input("migrateRoles")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.MigrateRolesEnum>? MigrateRoles { get; set; }
        ...
        /// </summary>
        [Input("migrationMode")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.MigrationMode>? MigrationMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.MigrationOption>? MigrationOption { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.OverwriteDbsInTargetEnum>? OverwriteDbsInTarget { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.LogicalReplicationOnSourceDbEnum>? SetupLogicalReplicationOnSourceDbIfNeeded { get; set; }
        ...
        /// </summary>
        [Input("sourceType")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.SourceType>? SourceType { get; set; }

        /// <summary>
        /// SSL modes for migration. Default SSL mode for PostgreSQLSingleServer is VerifyFull and Prefer for other source types
        /// </summary>
        [Input("sslMode")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.SslMode>? SslMode { get; set; }

        /// <summary>
        /// Indicates whether the data migration should start right away
        /// </summary>
        [Input("startDataMigration")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.StartDataMigrationEnum>? StartDataMigration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.TriggerCutoverEnum>? TriggerCutover { get; set; }
