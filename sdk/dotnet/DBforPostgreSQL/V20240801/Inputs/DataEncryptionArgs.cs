...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20240801.Inputs
{
    ...
    public sealed class DataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.KeyStatusEnum>? GeoBackupEncryptionKeyStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.KeyStatusEnum>? PrimaryEncryptionKeyStatus { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.ArmServerKeyType>? Type { get; set; }
