...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20240801.Inputs
{
    ...
    public sealed class StorageArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoGrow")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.StorageAutoGrow>? AutoGrow { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.AzureManagedDiskPerformanceTiers>? Tier { get; set; }

        /// <summary>
        /// Storage type for the server. Allowed values are Premium_LRS and PremiumV2_LRS, and default is Premium_LRS if not specified
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240801.StorageType>? Type { get; set; }
