...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20200214PrivatePreview
{
    public static class GetConfiguration
    {
        ...
        public static Task<GetConfigurationResult> InvokeAsync(GetConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationResult>("azure-native:dbforpostgresql/v20200214privatepreview:getConfiguration", args ?? new GetConfigurationArgs(), options.WithVersion());

        /// <summary>
        /// Represents a Configuration.
        /// </summary>
        public static Output<GetConfigurationResult> Invoke(GetConfigurationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConfigurationResult>("azure-native:dbforpostgresql/v20200214privatepreview:getConfiguration", args ?? new GetConfigurationInvokeArgs(), options.WithVersion());
    }
