...
namespace Pulumi.AzureRM.DBForPostgreSql.V20200214PrivatePreview
{
    ...
    public partial class Server : Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbforpostgresql/v20200214privatepreview:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbforpostgresql/v20200214privatepreview:Server", name, null, MakeResourceOptions(options, id))
        {
        }
