...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20200214PrivatePreview
{
    public static class GetServerKey
    {
        ...
        public static Task<GetServerKeyResult> InvokeAsync(GetServerKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerKeyResult>("azure-native:dbforpostgresql/v20200214privatepreview:getServerKey", args ?? new GetServerKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a PostgreSQL Server key.
        /// </summary>
        public static Output<GetServerKeyResult> Invoke(GetServerKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerKeyResult>("azure-native:dbforpostgresql/v20200214privatepreview:getServerKey", args ?? new GetServerKeyInvokeArgs(), options.WithDefaults());
    }
