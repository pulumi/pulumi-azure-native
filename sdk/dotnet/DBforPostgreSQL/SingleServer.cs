...
namespace Pulumi.AzureNative.DBforPostgreSQL
{
    ...
    public partial class SingleServer : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("sku")]
        public Output<Outputs.SingleServerSkuResponse?> Sku { get; private set; } = null!;
        ...
        public SingleServer(string name, SingleServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql:SingleServer", name, args ?? new SingleServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SingleServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql:SingleServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SingleServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sku")]
        public Input<Inputs.SingleServerSkuArgs>? Sku { get; set; }
