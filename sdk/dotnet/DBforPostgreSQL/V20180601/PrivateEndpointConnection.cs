...
namespace Pulumi.AzureRM.DBforPostgreSQL.V20180601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.DBforPostgreSQL.V20180601.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.DBforPostgreSQL.V20180601.PrivateEndpointConnectionArgs
    ///         {
    ///             PrivateEndpointConnectionName = "private-endpoint-connection-name",
    ///             PrivateLinkServiceConnectionState = new AzureRM.DBforPostgreSQL.V20180601.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbforpostgresql/v20180601:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbforpostgresql/v20180601:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
