...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20230601preview:Migration")]
    public partial class Migration : global::Pulumi.CustomResource
    {
        ...
        public Migration(string name, MigrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20230601preview:Migration", name, args ?? new MigrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Migration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20230601preview:Migration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MigrationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cancel")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview.CancelEnum>? Cancel { get; set; }
        ...
        /// </summary>
        [Input("migrationMode")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview.MigrationMode>? MigrationMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview.MigrationOption>? MigrationOption { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview.OverwriteDbsInTargetEnum>? OverwriteDbsInTarget { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview.LogicalReplicationOnSourceDbEnum>? SetupLogicalReplicationOnSourceDbIfNeeded { get; set; }
        ...
        /// </summary>
        [Input("sourceType")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview.SourceType>? SourceType { get; set; }

        /// <summary>
        /// SSL modes for migration. Default SSL mode for PostgreSQLSingleServer is VerifyFull and Prefer for other source types
        /// </summary>
        [Input("sslMode")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview.SslMode>? SslMode { get; set; }

        /// <summary>
        /// Indicates whether the data migration should start right away
        /// </summary>
        [Input("startDataMigration")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview.StartDataMigrationEnum>? StartDataMigration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20230601Preview.TriggerCutoverEnum>? TriggerCutover { get; set; }
