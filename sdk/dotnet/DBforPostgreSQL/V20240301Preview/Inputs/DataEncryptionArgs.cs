...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20240301Preview.Inputs
{
    ...
    public sealed class DataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240301Preview.KeyStatusEnum>? GeoBackupEncryptionKeyStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240301Preview.KeyStatusEnum>? PrimaryEncryptionKeyStatus { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20240301Preview.ArmServerKeyType>? Type { get; set; }
