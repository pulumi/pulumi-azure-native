...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20240301Preview
{
    public static class GetVirtualEndpoint
    {
        ...
        public static Task<GetVirtualEndpointResult> InvokeAsync(GetVirtualEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualEndpointResult>("azure-native:dbforpostgresql/v20240301preview:getVirtualEndpoint", args ?? new GetVirtualEndpointArgs(), options.WithDefaults());
