...
namespace Pulumi.AzureRM.DBforPostgreSQL.Preview
{
    ...
    public partial class ServerAdministrator : Pulumi.CustomResource
    {
        ...
        public ServerAdministrator(string name, ServerAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbforpostgresql/preview:ServerAdministrator", name, args ?? new ServerAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbforpostgresql/preview:ServerAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
