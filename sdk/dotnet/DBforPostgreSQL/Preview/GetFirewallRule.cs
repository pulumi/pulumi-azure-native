...
namespace Pulumi.AzureRM.DBforPostgreSQL.Preview
{
    public static class GetFirewallRule
    {
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azurerm:dbforpostgresql/preview:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithVersion());
    }
