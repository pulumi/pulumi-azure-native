...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20221201
{
    ...
    /// {
    ///     var configuration = new AzureNative.DBforPostgreSQL.V20221201.Configuration("configuration", new()
    ///     {
    ...
    public partial class Configuration : global::Pulumi.CustomResource
    {
        ...
        public Configuration(string name, ConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221201:Configuration", name, args ?? new ConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Configuration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221201:Configuration", name, null, MakeResourceOptions(options, id))
        {
        }
