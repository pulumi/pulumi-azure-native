...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20221201
{
    ...
    /// {
    ///     var administrator = new AzureNative.DBforPostgreSQL.V20221201.Administrator("administrator", new()
    ///     {
    ...
    public partial class Administrator : global::Pulumi.CustomResource
    {
        ...
        public Administrator(string name, AdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221201:Administrator", name, args ?? new AdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Administrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221201:Administrator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("principalType")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20221201.PrincipalType>? PrincipalType { get; set; }
