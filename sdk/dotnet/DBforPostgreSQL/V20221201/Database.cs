...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20221201
{
    ...
    /// {
    ///     var database = new AzureNative.DBforPostgreSQL.V20221201.Database("database", new()
    ///     {
    ///         Charset = "utf8",
    ...
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221201:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221201:Database", name, null, MakeResourceOptions(options, id))
        {
        }
