...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20221201
{
    public static class GetAdministrator
    {
        ...
        public static Task<GetAdministratorResult> InvokeAsync(GetAdministratorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAdministratorResult>("azure-native:dbforpostgresql/v20221201:getAdministrator", args ?? new GetAdministratorArgs(), options.WithDefaults());

        /// <summary>
        /// Represents an Active Directory administrator.
        /// </summary>
        public static Output<GetAdministratorResult> Invoke(GetAdministratorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAdministratorResult>("azure-native:dbforpostgresql/v20221201:getAdministrator", args ?? new GetAdministratorInvokeArgs(), options.WithDefaults());
    }
