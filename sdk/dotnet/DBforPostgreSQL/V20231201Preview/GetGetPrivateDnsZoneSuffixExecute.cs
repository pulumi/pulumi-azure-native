...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20231201Preview
{
    public static class GetGetPrivateDnsZoneSuffixExecute
    {
        ...
        public static Task<GetGetPrivateDnsZoneSuffixExecuteResult> InvokeAsync(GetGetPrivateDnsZoneSuffixExecuteArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGetPrivateDnsZoneSuffixExecuteResult>("azure-native:dbforpostgresql/v20231201preview:getGetPrivateDnsZoneSuffixExecute", args ?? new GetGetPrivateDnsZoneSuffixExecuteArgs(), options.WithDefaults());

        /// <summary>
        /// Get private DNS zone suffix in the cloud
        /// </summary>
        public static Output<GetGetPrivateDnsZoneSuffixExecuteResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGetPrivateDnsZoneSuffixExecuteResult>("azure-native:dbforpostgresql/v20231201preview:getGetPrivateDnsZoneSuffixExecute", InvokeArgs.Empty, options.WithDefaults());
