...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20231201Preview.Inputs
{
    ...
    public sealed class DataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20231201Preview.KeyStatusEnum>? GeoBackupEncryptionKeyStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20231201Preview.KeyStatusEnum>? PrimaryEncryptionKeyStatus { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20231201Preview.ArmServerKeyType>? Type { get; set; }
