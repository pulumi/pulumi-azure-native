...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20231201preview:VirtualEndpoint")]
    public partial class VirtualEndpoint : global::Pulumi.CustomResource
    {
        ...
        public VirtualEndpoint(string name, VirtualEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20231201preview:VirtualEndpoint", name, args ?? new VirtualEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20231201preview:VirtualEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("endpointType")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20231201Preview.VirtualEndpointType>? EndpointType { get; set; }
