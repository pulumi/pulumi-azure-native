...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20231201Preview
{
    public static class GetVirtualEndpoint
    {
        ...
        public static Task<GetVirtualEndpointResult> InvokeAsync(GetVirtualEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualEndpointResult>("azure-native:dbforpostgresql/v20231201preview:getVirtualEndpoint", args ?? new GetVirtualEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a virtual endpoint.
        /// </summary>
        public static Output<GetVirtualEndpointResult> Invoke(GetVirtualEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVirtualEndpointResult>("azure-native:dbforpostgresql/v20231201preview:getVirtualEndpoint", args ?? new GetVirtualEndpointInvokeArgs(), options.WithDefaults());
