...
namespace Pulumi.AzureNextGen.DBforPostgreSQL
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:dbforpostgresql:Server")]
    public partial class Server : Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbforpostgresql:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbforpostgresql:Server", name, null, MakeResourceOptions(options, id))
        {
        }
