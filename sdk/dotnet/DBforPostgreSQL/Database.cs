...
namespace Pulumi.AzureNextGen.DBforPostgreSQL
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:dbforpostgresql:Database")]
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbforpostgresql:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbforpostgresql:Database", name, null, MakeResourceOptions(options, id))
        {
        }
