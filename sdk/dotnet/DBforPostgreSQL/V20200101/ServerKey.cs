...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20200101
{
    ...
    /// {
    ///     var serverKey = new AzureNative.DBforPostgreSQL.V20200101.ServerKey("serverKey", new()
    ///     {
    ...
    public partial class ServerKey : global::Pulumi.CustomResource
    {
        ...
        public ServerKey(string name, ServerKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20200101:ServerKey", name, args ?? new ServerKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20200101:ServerKey", name, null, MakeResourceOptions(options, id))
        {
        }
