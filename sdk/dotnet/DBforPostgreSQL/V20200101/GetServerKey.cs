...
namespace Pulumi.AzureRM.DBforPostgreSQL.V20200101
{
    public static class GetServerKey
    {
        public static Task<GetServerKeyResult> InvokeAsync(GetServerKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerKeyResult>("azurerm:dbforpostgresql/v20200101:getServerKey", args ?? new GetServerKeyArgs(), options.WithVersion());
    }
