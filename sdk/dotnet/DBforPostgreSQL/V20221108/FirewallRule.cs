...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20221108
{
    ...
    /// {
    ///     var firewallRule = new AzureNative.DBforPostgreSQL.V20221108.FirewallRule("firewallRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20221108:FirewallRule")]
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221108:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221108:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
