...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20221108
{
    public static class GetServerGroupCluster
    {
        ...
        public static Task<GetServerGroupClusterResult> InvokeAsync(GetServerGroupClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerGroupClusterResult>("azure-native:dbforpostgresql/v20221108:getServerGroupCluster", args ?? new GetServerGroupClusterArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a cluster such as compute and storage configuration and cluster lifecycle metadata such as cluster creation date and time.
        /// </summary>
        public static Output<GetServerGroupClusterResult> Invoke(GetServerGroupClusterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerGroupClusterResult>("azure-native:dbforpostgresql/v20221108:getServerGroupCluster", args ?? new GetServerGroupClusterInvokeArgs(), options.WithDefaults());
