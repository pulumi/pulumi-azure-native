...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20221108
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20221108:ServerGroupCluster")]
    public partial class ServerGroupCluster : global::Pulumi.CustomResource
    {
        ...
        public ServerGroupCluster(string name, ServerGroupClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221108:ServerGroupCluster", name, args ?? new ServerGroupClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerGroupCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20221108:ServerGroupCluster", name, null, MakeResourceOptions(options, id))
        {
        }
