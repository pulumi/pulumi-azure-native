...
namespace Pulumi.AzureNextGen.DBforPostgreSQL.V20171201Preview.Inputs
{
    ...
    public sealed class StorageProfileArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DBforPostgreSQL.V20171201Preview.GeoRedundantBackup>? GeoRedundantBackup { get; set; }

        /// <summary>
        /// Enable Storage Auto Grow.
        /// </summary>
        [Input("storageAutogrow")]
        public InputUnion<string, Pulumi.AzureNextGen.DBforPostgreSQL.V20171201Preview.StorageAutogrow>? StorageAutogrow { get; set; }
