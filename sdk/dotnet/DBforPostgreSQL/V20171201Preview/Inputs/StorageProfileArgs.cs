...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20171201Preview.Inputs
{
    ...
    public sealed class StorageProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20171201Preview.GeoRedundantBackup>? GeoRedundantBackup { get; set; }

        /// <summary>
        /// Enable Storage Auto Grow.
        /// </summary>
        [Input("storageAutogrow")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20171201Preview.StorageAutogrow>? StorageAutogrow { get; set; }
