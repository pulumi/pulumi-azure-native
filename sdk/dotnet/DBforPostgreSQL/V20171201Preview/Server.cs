...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20171201Preview
{
    ...
    /// {
    ///     var server = new AzureNative.DBforPostgreSQL.V20171201Preview.Server("server", new()
    ///     {
    ///         Location = "brazilsouth",
    ///         Properties = new AzureNative.DBforPostgreSQL.V20171201Preview.Inputs.ServerPropertiesForRestoreArgs
    ///         {
    ...
    ///         Sku = new AzureNative.DBforPostgreSQL.V20171201Preview.Inputs.SkuArgs
    ///         {
    ///             Capacity = 2,
    ///             Family = "Gen4",
    ///             Name = "B_Gen4_2",
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforPostgreSQL.V20171201Preview.Inputs.ServerPropertiesForDefaultCreateArgs
    ///         {
    ///             AdministratorLogin = "cloudsa",
    ///             AdministratorLoginPassword = "password",
    ///             CreateMode = "Default",
    ///             SslEnforcement = AzureNative.DBforPostgreSQL.V20171201Preview.SslEnforcementEnum.Enabled,
    ///             StorageProfile = new AzureNative.DBforPostgreSQL.V20171201Preview.Inputs.StorageProfileArgs
    ///             {
    ...
    ///         Properties = new AzureNative.DBforPostgreSQL.V20171201Preview.Inputs.ServerPropertiesForReplicaArgs
    ///         {
    ///             CreateMode = "Replica",
    ...
    ///     {
    ///         Location = "Japan West",
    ///         Properties = new AzureNative.DBforPostgreSQL.V20171201Preview.Inputs.ServerPropertiesForGeoRestoreArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20171201preview:Server")]
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201preview:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201preview:Server", name, null, MakeResourceOptions(options, id))
        {
        }
