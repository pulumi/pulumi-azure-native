...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20171201Preview
{
    ...
    /// {
    ///     var serverAdministrator = new AzureNative.DBforPostgreSQL.V20171201Preview.ServerAdministrator("serverAdministrator", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20171201preview:ServerAdministrator")]
    public partial class ServerAdministrator : global::Pulumi.CustomResource
    {
        ...
        public ServerAdministrator(string name, ServerAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201preview:ServerAdministrator", name, args ?? new ServerAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201preview:ServerAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
