...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20171201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20171201preview:SingleServerServerSecurityAlertPolicy")]
    public partial class SingleServerServerSecurityAlertPolicy : global::Pulumi.CustomResource
    {
        ...
        public SingleServerServerSecurityAlertPolicy(string name, SingleServerServerSecurityAlertPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201preview:SingleServerServerSecurityAlertPolicy", name, args ?? new SingleServerServerSecurityAlertPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SingleServerServerSecurityAlertPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201preview:SingleServerServerSecurityAlertPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
