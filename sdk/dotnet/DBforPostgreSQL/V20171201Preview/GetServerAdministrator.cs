...
namespace Pulumi.AzureRM.DBForPostgreSQL.V20171201Preview
{
    public static class GetServerAdministrator
    {
        public static Task<GetServerAdministratorResult> InvokeAsync(GetServerAdministratorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerAdministratorResult>("azurerm:dbforpostgresql/v20171201preview:getServerAdministrator", args ?? new GetServerAdministratorArgs(), options.WithVersion());
    }
