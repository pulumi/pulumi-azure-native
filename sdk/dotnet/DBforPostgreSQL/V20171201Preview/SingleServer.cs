...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20171201Preview
{
    ...
    /// Represents a server.
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20171201preview:SingleServer")]
    public partial class SingleServer : global::Pulumi.CustomResource
    {
        ...
        public SingleServer(string name, SingleServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201preview:SingleServer", name, args ?? new SingleServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SingleServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20171201preview:SingleServer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:dbforpostgresql:SingleServer" },
