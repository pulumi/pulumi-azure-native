...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20171201Preview
{
    public static class GetSingleServerVirtualNetworkRule
    {
        ...
        public static Task<GetSingleServerVirtualNetworkRuleResult> InvokeAsync(GetSingleServerVirtualNetworkRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSingleServerVirtualNetworkRuleResult>("azure-native:dbforpostgresql/v20171201preview:getSingleServerVirtualNetworkRule", args ?? new GetSingleServerVirtualNetworkRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetSingleServerVirtualNetworkRuleResult> Invoke(GetSingleServerVirtualNetworkRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSingleServerVirtualNetworkRuleResult>("azure-native:dbforpostgresql/v20171201preview:getSingleServerVirtualNetworkRule", args ?? new GetSingleServerVirtualNetworkRuleInvokeArgs(), options.WithDefaults());
