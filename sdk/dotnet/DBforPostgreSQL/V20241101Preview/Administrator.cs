...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20241101preview:Administrator")]
    public partial class Administrator : global::Pulumi.CustomResource
    {
        ...
        public Administrator(string name, AdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20241101preview:Administrator", name, args ?? new AdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Administrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20241101preview:Administrator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("principalType")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview.PrincipalType>? PrincipalType { get; set; }
