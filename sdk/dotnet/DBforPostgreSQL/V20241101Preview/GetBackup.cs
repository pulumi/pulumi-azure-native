...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview
{
    public static class GetBackup
    {
        ...
        public static Task<GetBackupResult> InvokeAsync(GetBackupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackupResult>("azure-native:dbforpostgresql/v20241101preview:getBackup", args ?? new GetBackupArgs(), options.WithDefaults());
