...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview.Inputs
{
    ...
    public sealed class DataEncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview.KeyStatusEnum>? GeoBackupEncryptionKeyStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview.KeyStatusEnum>? PrimaryEncryptionKeyStatus { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview.ArmServerKeyType>? Type { get; set; }
