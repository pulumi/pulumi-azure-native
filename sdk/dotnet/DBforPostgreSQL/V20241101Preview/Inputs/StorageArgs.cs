...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview.Inputs
{
    ...
    public sealed class StorageArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoGrow")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview.StorageAutoGrow>? AutoGrow { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview.AzureManagedDiskPerformanceTiers>? Tier { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20241101Preview.StorageType>? Type { get; set; }
