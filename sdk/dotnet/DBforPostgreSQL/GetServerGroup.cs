...
namespace Pulumi.AzureNextGen.DBforPostgreSQL
{
    public static class GetServerGroup
    {
        public static Task<GetServerGroupResult> InvokeAsync(GetServerGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerGroupResult>("azure-nextgen:dbforpostgresql:getServerGroup", args ?? new GetServerGroupArgs(), options.WithVersion());
    }
