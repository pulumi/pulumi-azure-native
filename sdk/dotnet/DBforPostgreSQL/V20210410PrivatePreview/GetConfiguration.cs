...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20210410PrivatePreview
{
    public static class GetConfiguration
    {
        ...
        public static Task<GetConfigurationResult> InvokeAsync(GetConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationResult>("azure-native:dbforpostgresql/v20210410privatepreview:getConfiguration", args ?? new GetConfigurationArgs(), options.WithVersion());

        /// <summary>
        /// Represents a Configuration.
        /// </summary>
        public static Output<GetConfigurationResult> Invoke(GetConfigurationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConfigurationResult>("azure-native:dbforpostgresql/v20210410privatepreview:getConfiguration", args ?? new GetConfigurationInvokeArgs(), options.WithVersion());
    }
