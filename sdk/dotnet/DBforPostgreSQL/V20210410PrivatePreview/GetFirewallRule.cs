...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20210410PrivatePreview
{
    public static class GetFirewallRule
    {
        ...
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azure-native:dbforpostgresql/v20210410privatepreview:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithVersion());

        /// <summary>
        /// Represents a server firewall rule.
        /// </summary>
        public static Output<GetFirewallRuleResult> Invoke(GetFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFirewallRuleResult>("azure-native:dbforpostgresql/v20210410privatepreview:getFirewallRule", args ?? new GetFirewallRuleInvokeArgs(), options.WithVersion());
    }
