...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20210410PrivatePreview
{
    /// <summary>
    ...
    /// </summary>
    [EnumType]
    public readonly struct GeoRedundantBackupOption : IEquatable<GeoRedundantBackupOption>
    {
        private readonly string _value;

        private GeoRedundantBackupOption(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static GeoRedundantBackupOption Enabled { get; } = new GeoRedundantBackupOption("Enabled");
        public static GeoRedundantBackupOption Disabled { get; } = new GeoRedundantBackupOption("Disabled");

        public static bool operator ==(GeoRedundantBackupOption left, GeoRedundantBackupOption right) => left.Equals(right);
        public static bool operator !=(GeoRedundantBackupOption left, GeoRedundantBackupOption right) => !left.Equals(right);

        public static explicit operator string(GeoRedundantBackupOption value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GeoRedundantBackupOption other && Equals(other);
        public bool Equals(GeoRedundantBackupOption other) => string.Equals(_value, other._value, StringComparison.Ordinal);
