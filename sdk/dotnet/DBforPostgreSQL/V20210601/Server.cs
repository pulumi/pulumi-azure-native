...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20210601
{
    ...
    /// Represents a server.
    /// </summary>
    [Obsolete(@"azure-native:dbforpostgresql/v20210601:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20210615privatepreview:Server to guarantee forwards compatibility.")]
    ...
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20210601:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20210601:Server", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20210601.CreateMode>? CreateMode { get; set; }
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.DBforPostgreSQL.V20210601.ServerVersion>? Version { get; set; }
