...
namespace Pulumi.AzureNative.DBforPostgreSQL.V20210601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:dbforpostgresql/v20210601:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20230301preview:Database to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:dbforpostgresql/v20210601:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20210601:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbforpostgresql/v20210601:Database", name, null, MakeResourceOptions(options, id))
        {
        }
