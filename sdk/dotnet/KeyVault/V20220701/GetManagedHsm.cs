...
namespace Pulumi.AzureNative.KeyVault.V20220701
{
    public static class GetManagedHsm
    {
        ...
        public static Task<GetManagedHsmResult> InvokeAsync(GetManagedHsmArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedHsmResult>("azure-native:keyvault/v20220701:getManagedHsm", args ?? new GetManagedHsmArgs(), options.WithDefaults());

        /// <summary>
        /// Resource information with extended details.
        /// </summary>
        public static Output<GetManagedHsmResult> Invoke(GetManagedHsmInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetManagedHsmResult>("azure-native:keyvault/v20220701:getManagedHsm", args ?? new GetManagedHsmInvokeArgs(), options.WithDefaults());
    }
