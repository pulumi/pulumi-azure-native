...
namespace Pulumi.AzureNative.KeyVault.V20220701.Inputs
{
    ...
    public sealed class ManagedHsmSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.KeyVault.V20220701.ManagedHsmSkuFamily> Family { get; set; } = null!;

        /// <summary>
        /// SKU of the managed HSM Pool
        /// </summary>
        [Input("name", required: true)]
        public Input<Pulumi.AzureNative.KeyVault.V20220701.ManagedHsmSkuName> Name { get; set; } = null!;
