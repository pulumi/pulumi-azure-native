...
namespace Pulumi.AzureNextGen.KeyVault.V20150601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:keyvault/v20150601:Vault")]
    public partial class Vault : Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20150601:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20150601:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
