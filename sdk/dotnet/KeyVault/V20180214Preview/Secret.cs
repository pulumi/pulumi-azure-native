...
namespace Pulumi.AzureNextGen.KeyVault.V20180214Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:keyvault/v20180214preview:Secret")]
    public partial class Secret : Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20180214preview:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20180214preview:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
