...
namespace Pulumi.AzureNative.KeyVault.V20180214Preview
{
    ...
    [AzureNativeResourceType("azure-native:keyvault/v20180214preview:Secret")]
    public partial class Secret : Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20180214preview:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20180214preview:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
