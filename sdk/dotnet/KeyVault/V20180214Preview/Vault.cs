...
namespace Pulumi.AzureRM.KeyVault.V20180214Preview
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var vault = new AzureRM.KeyVault.V20180214Preview.Vault("vault", new AzureRM.KeyVault.V20180214Preview.VaultArgs
    ///         {
    ///             Location = "westus",
    ...
    public partial class Vault : Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/v20180214preview:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/v20180214preview:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
