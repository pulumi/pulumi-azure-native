...
namespace Pulumi.AzureNextGen.KeyVault.V20180214Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:keyvault/v20180214preview:Vault")]
    public partial class Vault : Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20180214preview:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20180214preview:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
