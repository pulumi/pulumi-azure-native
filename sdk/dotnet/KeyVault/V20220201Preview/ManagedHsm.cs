...
namespace Pulumi.AzureNative.KeyVault.V20220201Preview
{
    ...
    [AzureNativeResourceType("azure-native:keyvault/v20220201preview:ManagedHsm")]
    public partial class ManagedHsm : global::Pulumi.CustomResource
    {
        ...
        public ManagedHsm(string name, ManagedHsmArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20220201preview:ManagedHsm", name, args ?? new ManagedHsmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedHsm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20220201preview:ManagedHsm", name, null, MakeResourceOptions(options, id))
        {
        }
