...
namespace Pulumi.AzureNative.KeyVault.V20220201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20220201preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20220201preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20220201preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
