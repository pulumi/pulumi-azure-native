...
namespace Pulumi.AzureNative.KeyVault.V20230201
{
    ...
    /// {
    ///     var key = new AzureNative.KeyVault.V20230201.Key("key", new()
    ///     {
    ///         KeyName = "sample-key-name",
    ///         Properties = new AzureNative.KeyVault.V20230201.Inputs.KeyPropertiesArgs
    ///         {
    ///             Kty = "RSA",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20230201:Key")]
    public partial class Key : global::Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20230201:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20230201:Key", name, null, MakeResourceOptions(options, id))
        {
        }
