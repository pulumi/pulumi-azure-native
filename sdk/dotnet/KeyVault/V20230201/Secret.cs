...
namespace Pulumi.AzureNative.KeyVault.V20230201
{
    ...
    /// {
    ///     var secret = new AzureNative.KeyVault.V20230201.Secret("secret", new()
    ///     {
    ///         Properties = new AzureNative.KeyVault.V20230201.Inputs.SecretPropertiesArgs
    ///         {
    ///             Value = "secret-value",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20230201:Secret")]
    public partial class Secret : global::Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20230201:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20230201:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
