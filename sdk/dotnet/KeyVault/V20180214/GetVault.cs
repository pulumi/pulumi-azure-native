...
namespace Pulumi.AzureNative.KeyVault.V20180214
{
    public static class GetVault
    {
        ...
        public static Task<GetVaultResult> InvokeAsync(GetVaultArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVaultResult>("azure-native:keyvault/v20180214:getVault", args ?? new GetVaultArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified Azure key vault.
        /// </summary>
        public static Output<GetVaultResult> Invoke(GetVaultInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVaultResult>("azure-native:keyvault/v20180214:getVault", args ?? new GetVaultInvokeArgs(), options.WithDefaults());
    }
