...
namespace Pulumi.AzureNative.KeyVault.V20180214
{
    ...
    public static class GetVault
    {
        ...
        public static Task<GetVaultResult> InvokeAsync(GetVaultArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVaultResult>("azure-native:keyvault/v20180214:getVault", args ?? new GetVaultArgs(), options.WithDefaults());

        /// <summary>
        /// Resource information with extended details.
        /// </summary>
        public static Output<GetVaultResult> Invoke(GetVaultInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVaultResult>("azure-native:keyvault/v20180214:getVault", args ?? new GetVaultInvokeArgs(), options.WithDefaults());
    }
