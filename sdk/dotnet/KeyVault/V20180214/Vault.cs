...
namespace Pulumi.AzureNative.KeyVault.V20180214
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20180214:Vault")]
    public partial class Vault : Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20180214:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20180214:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
