...
namespace Pulumi.AzureRM.KeyVault.V20180214
{
    ...
    ///     public MyStack()
    ///     {
    ///         var vault = new AzureRM.KeyVault.V20180214.Vault("vault", new AzureRM.KeyVault.V20180214.VaultArgs
    ///         {
    ///             Location = "westus",
    ...
    public partial class Vault : Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/v20180214:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/v20180214:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
