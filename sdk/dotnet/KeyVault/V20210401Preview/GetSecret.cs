...
namespace Pulumi.AzureNative.KeyVault.V20210401Preview
{
    public static class GetSecret
    {
        ...
        public static Task<GetSecretResult> InvokeAsync(GetSecretArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecretResult>("azure-native:keyvault/v20210401preview:getSecret", args ?? new GetSecretArgs(), options.WithDefaults());

        /// <summary>
        /// Resource information with extended details.
        /// </summary>
        public static Output<GetSecretResult> Invoke(GetSecretInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSecretResult>("azure-native:keyvault/v20210401preview:getSecret", args ?? new GetSecretInvokeArgs(), options.WithDefaults());
    }
