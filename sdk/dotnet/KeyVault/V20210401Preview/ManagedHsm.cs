...
namespace Pulumi.AzureNative.KeyVault.V20210401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:keyvault/v20210401preview:ManagedHsm is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:keyvault/v20210401preview:ManagedHsm")]
    public partial class ManagedHsm : global::Pulumi.CustomResource
    {
        ...
        public ManagedHsm(string name, ManagedHsmArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20210401preview:ManagedHsm", name, args ?? new ManagedHsmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedHsm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20210401preview:ManagedHsm", name, null, MakeResourceOptions(options, id))
        {
        }
