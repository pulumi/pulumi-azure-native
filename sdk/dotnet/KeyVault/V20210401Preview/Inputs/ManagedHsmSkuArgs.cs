...
namespace Pulumi.AzureNative.KeyVault.V20210401Preview.Inputs
{
    ...
    public sealed class ManagedHsmSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.KeyVault.V20210401Preview.ManagedHsmSkuFamily> Family { get; set; } = null!;

        /// <summary>
        /// SKU of the managed HSM Pool
        /// </summary>
        [Input("name", required: true)]
        public Input<Pulumi.AzureNative.KeyVault.V20210401Preview.ManagedHsmSkuName> Name { get; set; } = null!;
