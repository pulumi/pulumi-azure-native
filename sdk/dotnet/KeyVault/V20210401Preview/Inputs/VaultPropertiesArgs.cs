...
namespace Pulumi.AzureNative.KeyVault.V20210401Preview.Inputs
{
    ...
    public sealed class VaultPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public Input<Pulumi.AzureNative.KeyVault.V20210401Preview.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.KeyVault.V20210401Preview.VaultProvisioningState>? ProvisioningState { get; set; }
