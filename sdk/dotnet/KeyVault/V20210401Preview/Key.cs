...
namespace Pulumi.AzureNative.KeyVault.V20210401Preview
{
    ...
    /// The key resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20210401preview:Key")]
    public partial class Key : Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20210401preview:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20210401preview:Key", name, null, MakeResourceOptions(options, id))
        {
        }
