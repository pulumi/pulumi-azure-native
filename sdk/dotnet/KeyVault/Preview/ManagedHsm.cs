...
namespace Pulumi.AzureRM.KeyVault.Preview
{
    ...
    public partial class ManagedHsm : Pulumi.CustomResource
    {
        ...
        public ManagedHsm(string name, ManagedHsmArgs args, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/preview:ManagedHsm", name, args ?? new ManagedHsmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedHsm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/preview:ManagedHsm", name, null, MakeResourceOptions(options, id))
        {
        }
