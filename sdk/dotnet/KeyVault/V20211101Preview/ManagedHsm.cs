...
namespace Pulumi.AzureNative.KeyVault.V20211101Preview
{
    ...
    [AzureNativeResourceType("azure-native:keyvault/v20211101preview:ManagedHsm")]
    public partial class ManagedHsm : global::Pulumi.CustomResource
    {
        ...
        public ManagedHsm(string name, ManagedHsmArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211101preview:ManagedHsm", name, args ?? new ManagedHsmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedHsm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211101preview:ManagedHsm", name, null, MakeResourceOptions(options, id))
        {
        }
