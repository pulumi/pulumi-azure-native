...
{
    [Obsolete(@"azure-native:keyvault/v20211101preview:Key is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:Key to guarantee forwards compatibility.")]
    public static class GetKey
    {
        ...
        public static Task<GetKeyResult> InvokeAsync(GetKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyResult>("azure-native:keyvault/v20211101preview:getKey", args ?? new GetKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the current version of the specified key from the specified key vault.
        /// </summary>
        public static Output<GetKeyResult> Invoke(GetKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyResult>("azure-native:keyvault/v20211101preview:getKey", args ?? new GetKeyInvokeArgs(), options.WithDefaults());
    }
