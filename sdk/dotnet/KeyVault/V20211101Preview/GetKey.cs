...
namespace Pulumi.AzureNative.KeyVault.V20211101Preview
{
    public static class GetKey
    {
        ...
        public static Task<GetKeyResult> InvokeAsync(GetKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKeyResult>("azure-native:keyvault/v20211101preview:getKey", args ?? new GetKeyArgs(), options.WithVersion());

        /// <summary>
        /// The key resource.
        /// </summary>
        public static Output<GetKeyResult> Invoke(GetKeyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKeyResult>("azure-native:keyvault/v20211101preview:getKey", args ?? new GetKeyInvokeArgs(), options.WithVersion());
    }
