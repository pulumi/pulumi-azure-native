...
namespace Pulumi.AzureNative.KeyVault.V20211101Preview
{
    ...
    [AzureNativeResourceType("azure-native:keyvault/v20211101preview:Key")]
    public partial class Key : global::Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211101preview:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211101preview:Key", name, null, MakeResourceOptions(options, id))
        {
        }
