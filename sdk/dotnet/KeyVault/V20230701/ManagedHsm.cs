...
namespace Pulumi.AzureNative.KeyVault.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20230701:ManagedHsm")]
    public partial class ManagedHsm : global::Pulumi.CustomResource
    {
        ...
        public ManagedHsm(string name, ManagedHsmArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20230701:ManagedHsm", name, args ?? new ManagedHsmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedHsm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20230701:ManagedHsm", name, null, MakeResourceOptions(options, id))
        {
        }
