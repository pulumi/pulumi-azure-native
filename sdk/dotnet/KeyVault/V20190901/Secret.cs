...
namespace Pulumi.AzureNextGen.KeyVault.V20190901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:keyvault/v20190901:Secret")]
    public partial class Secret : Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20190901:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20190901:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
