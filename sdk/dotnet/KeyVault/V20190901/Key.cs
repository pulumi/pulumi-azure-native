...
namespace Pulumi.AzureNative.KeyVault.V20190901
{
    ...
    /// {
    ///     var key = new AzureNative.KeyVault.V20190901.Key("key", new()
    ///     {
    ///         KeyName = "sample-key-name",
    ///         Properties = new AzureNative.KeyVault.V20190901.Inputs.KeyPropertiesArgs
    ///         {
    ///             Kty = "RSA",
    ///         },
    ...
    public partial class Key : global::Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20190901:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20190901:Key", name, null, MakeResourceOptions(options, id))
        {
        }
