...
namespace Pulumi.AzureNative.KeyVault.V20210601Preview.Inputs
{
    ...
    public sealed class ManagedHsmPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public Input<Pulumi.AzureNative.KeyVault.V20210601Preview.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.KeyVault.V20210601Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
