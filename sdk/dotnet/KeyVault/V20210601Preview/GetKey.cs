...
namespace Pulumi.AzureNative.KeyVault.V20210601Preview
{
    public static class GetKey
    {
        ...
        public static Task<GetKeyResult> InvokeAsync(GetKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKeyResult>("azure-native:keyvault/v20210601preview:getKey", args ?? new GetKeyArgs(), options.WithDefaults());

        /// <summary>
        /// The key resource.
        /// </summary>
        public static Output<GetKeyResult> Invoke(GetKeyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKeyResult>("azure-native:keyvault/v20210601preview:getKey", args ?? new GetKeyInvokeArgs(), options.WithDefaults());
    }
