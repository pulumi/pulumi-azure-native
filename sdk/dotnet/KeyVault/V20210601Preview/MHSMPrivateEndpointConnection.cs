...
namespace Pulumi.AzureNative.KeyVault.V20210601Preview
{
    ...
    /// {
    ///     var mhsmPrivateEndpointConnection = new AzureNative.KeyVault.V20210601Preview.MHSMPrivateEndpointConnection("mhsmPrivateEndpointConnection", new()
    ///     {
    ///         Name = "sample-mhsm",
    ///         PrivateEndpointConnectionName = "sample-pec",
    ///         PrivateLinkServiceConnectionState = new AzureNative.KeyVault.V20210601Preview.Inputs.MHSMPrivateLinkServiceConnectionStateArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20210601preview:MHSMPrivateEndpointConnection")]
    public partial class MHSMPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public MHSMPrivateEndpointConnection(string name, MHSMPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20210601preview:MHSMPrivateEndpointConnection", name, args ?? new MHSMPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MHSMPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20210601preview:MHSMPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
