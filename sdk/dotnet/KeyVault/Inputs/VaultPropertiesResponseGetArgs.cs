...
namespace Pulumi.AzureRM.KeyVault.Inputs
{
    ...
    public sealed class VaultPropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.AccessPolicyEntryResponseGetArgs>? _accessPolicies;

        /// <summary>
        /// An array of 0 to 1024 identities that have access to the key vault. All identities in the array must use the same tenant ID as the key vault's tenant ID. When `createMode` is set to `recover`, access policies are not required. Otherwise, access policies are required.
        /// </summary>
        public InputList<Inputs.AccessPolicyEntryResponseGetArgs> AccessPolicies
        {
            get => _accessPolicies ?? (_accessPolicies = new InputList<Inputs.AccessPolicyEntryResponseGetArgs>());
        ...
        private InputList<Inputs.PrivateEndpointConnectionItemResponseGetArgs>? _privateEndpointConnections;

        /// <summary>
        /// List of private endpoint connections associated with the key vault.
        /// </summary>
        public InputList<Inputs.PrivateEndpointConnectionItemResponseGetArgs> PrivateEndpointConnections
        {
            get => _privateEndpointConnections ?? (_privateEndpointConnections = new InputList<Inputs.PrivateEndpointConnectionItemResponseGetArgs>());
