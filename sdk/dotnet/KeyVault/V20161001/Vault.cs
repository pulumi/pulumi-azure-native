...
namespace Pulumi.AzureRM.KeyVault.V20161001
{
    /// <summary>
    ...
    public partial class Vault : Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/v20161001:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/v20161001:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
