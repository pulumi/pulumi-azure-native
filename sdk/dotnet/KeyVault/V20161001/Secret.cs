...
namespace Pulumi.AzureNextGen.KeyVault.V20161001
{
    ...
    public partial class Secret : Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20161001:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:keyvault/v20161001:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
