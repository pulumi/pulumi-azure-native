...
namespace Pulumi.AzureNative.KeyVault.V20161001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20161001:Secret")]
    public partial class Secret : Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20161001:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20161001:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
