...
namespace Pulumi.AzureNative.KeyVault.V20211001
{
    ...
    [AzureNativeResourceType("azure-native:keyvault/v20211001:Vault")]
    public partial class Vault : global::Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211001:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211001:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
