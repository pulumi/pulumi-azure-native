...
namespace Pulumi.AzureNative.KeyVault.V20211001
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:keyvault/v20211001:MHSMPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:MHSMPrivateEndpointConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:keyvault/v20211001:MHSMPrivateEndpointConnection")]
    public partial class MHSMPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public MHSMPrivateEndpointConnection(string name, MHSMPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211001:MHSMPrivateEndpointConnection", name, args ?? new MHSMPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MHSMPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211001:MHSMPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
