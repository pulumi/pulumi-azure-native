...
namespace Pulumi.AzureNative.KeyVault.V20211001.Inputs
{
    ...
    public sealed class ManagedHsmPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public Input<Pulumi.AzureNative.KeyVault.V20211001.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.KeyVault.V20211001.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
