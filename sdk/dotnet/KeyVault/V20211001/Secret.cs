...
namespace Pulumi.AzureNative.KeyVault.V20211001
{
    ...
    [AzureNativeResourceType("azure-native:keyvault/v20211001:Secret")]
    public partial class Secret : global::Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211001:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20211001:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
