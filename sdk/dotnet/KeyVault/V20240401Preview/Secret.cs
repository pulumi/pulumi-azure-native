...
namespace Pulumi.AzureNative.KeyVault.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20240401preview:Secret")]
    public partial class Secret : global::Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20240401preview:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20240401preview:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:keyvault/v20220201preview:Secret" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:keyvault/v20230201:Secret" },
                    new global::Pulumi.Alias { Type = "azure-native:keyvault/v20230701:Secret" },
                    new global::Pulumi.Alias { Type = "azure-native:keyvault/v20241101:Secret" },
                    new global::Pulumi.Alias { Type = "azure-native:keyvault/v20241201preview:Secret" },
                    new global::Pulumi.Alias { Type = "azure-native:keyvault:Secret" },
                },
            };
