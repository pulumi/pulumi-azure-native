...
namespace Pulumi.AzureNative.KeyVault.V20240401Preview
{
    public static class GetManagedHsm
    {
        ...
        public static Task<GetManagedHsmResult> InvokeAsync(GetManagedHsmArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedHsmResult>("azure-native:keyvault/v20240401preview:getManagedHsm", args ?? new GetManagedHsmArgs(), options.WithDefaults());
