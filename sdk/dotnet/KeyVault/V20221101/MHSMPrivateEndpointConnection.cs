...
namespace Pulumi.AzureNative.KeyVault.V20221101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20221101:MHSMPrivateEndpointConnection")]
    public partial class MHSMPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public MHSMPrivateEndpointConnection(string name, MHSMPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20221101:MHSMPrivateEndpointConnection", name, args ?? new MHSMPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MHSMPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20221101:MHSMPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
