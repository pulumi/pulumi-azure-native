...
namespace Pulumi.AzureNative.KeyVault.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:keyvault/v20241101:Secret")]
    public partial class Secret : global::Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20241101:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:keyvault/v20241101:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
