...
namespace Pulumi.AzureNative.KeyVault.V20241101.Inputs
{
    ...
    public sealed class NetworkRuleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bypass")]
        public InputUnion<string, Pulumi.AzureNative.KeyVault.V20241101.NetworkRuleBypassOptions>? Bypass { get; set; }

        /// <summary>
        /// The default action when no rule from ipRules and from virtualNetworkRules match. This is only used after the bypass property has been evaluated.
        /// </summary>
        [Input("defaultAction")]
        public InputUnion<string, Pulumi.AzureNative.KeyVault.V20241101.NetworkRuleAction>? DefaultAction { get; set; }
