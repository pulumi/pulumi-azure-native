...
namespace Pulumi.AzureNative.KeyVault.V20241101
{
    public static class GetKey
    {
        ...
        public static Task<GetKeyResult> InvokeAsync(GetKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyResult>("azure-native:keyvault/v20241101:getKey", args ?? new GetKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the current version of the specified key from the specified key vault.
        /// </summary>
        public static Output<GetKeyResult> Invoke(GetKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyResult>("azure-native:keyvault/v20241101:getKey", args ?? new GetKeyInvokeArgs(), options.WithDefaults());
