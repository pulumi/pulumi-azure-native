...
namespace Pulumi.AzureRM.KeyVault.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedHsm = new AzureRM.KeyVault.Latest.ManagedHsm("managedHsm", new AzureRM.KeyVault.Latest.ManagedHsmArgs
    ///         {
    ///             Location = "westus",
    ///             Name = "hsm1",
    ///             ResourceGroupName = "hsm-group",
    ///             Sku = new AzureRM.KeyVault.Latest.Inputs.ManagedHsmSkuArgs
    ///             {
    ///                 Family = "B",
    ///                 Name = "Standard_B1",
    ///             },
    ...
    public partial class ManagedHsm : Pulumi.CustomResource
    {
        ...
        public ManagedHsm(string name, ManagedHsmArgs args, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/latest:ManagedHsm", name, args ?? new ManagedHsmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedHsm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:keyvault/latest:ManagedHsm", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:keyvault/v20200401preview:ManagedHsm"},
                },
            };
