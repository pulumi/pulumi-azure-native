...
namespace Pulumi.AzureNextGen.KeyVault.Latest.Inputs
{
    ...
    public sealed class VaultPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public Input<Pulumi.AzureNextGen.KeyVault.Latest.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.KeyVault.Latest.VaultProvisioningState>? ProvisioningState { get; set; }
