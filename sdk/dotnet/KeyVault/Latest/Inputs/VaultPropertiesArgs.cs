...
namespace Pulumi.AzureNative.KeyVault.Latest.Inputs
{
    ...
    public sealed class VaultPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public Input<Pulumi.AzureNative.KeyVault.Latest.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.KeyVault.Latest.VaultProvisioningState>? ProvisioningState { get; set; }
