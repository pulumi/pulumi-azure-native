...
namespace Pulumi.AzureNative.Quantum.V20231113Preview
{
    ...
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:quantum/v20231113preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:quantum/v20231113preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
