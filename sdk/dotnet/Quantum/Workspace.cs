...
namespace Pulumi.AzureNextGen.Quantum
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:quantum:Workspace")]
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:quantum:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:quantum:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
