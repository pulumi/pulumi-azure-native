...
namespace Pulumi.AzureNative.Purview.V20211201
{
    public static class ListFeatureAccount
    {
        ...
        public static Task<ListFeatureAccountResult> InvokeAsync(ListFeatureAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListFeatureAccountResult>("azure-native:purview/v20211201:listFeatureAccount", args ?? new ListFeatureAccountArgs(), options.WithDefaults());
