...
namespace Pulumi.AzureNative.Purview.V20211201
{
    ...
    /// Account resource
    /// </summary>
    [AzureNativeResourceType("azure-native:purview/v20211201:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:purview/v20211201:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:purview/v20211201:Account", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Purview.V20211201.ManagedEventHubState>? ManagedEventHubState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Purview.V20211201.ManagedResourcesPublicNetworkAccess>? ManagedResourcesPublicNetworkAccess { get; set; }

        /// <summary>
        /// Gets or sets the public network access.
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.Purview.V20211201.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
