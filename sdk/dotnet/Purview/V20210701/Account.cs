...
namespace Pulumi.AzureNative.Purview.V20210701
{
    ...
    /// {
    ///     var account = new AzureNative.Purview.V20210701.Account("account", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:purview/v20210701:Account account1 /subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/SampleResourceGroup/providers/Microsoft.Purview/accounts/account1 
    /// ```
    /// </summary>
    ...
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:purview/v20210701:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:purview/v20210701:Account", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Purview.V20210701.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
