...
namespace Pulumi.AzureNative.Purview.V20230501Preview
{
    public static class GetKafkaConfiguration
    {
        ...
        public static Task<GetKafkaConfigurationResult> InvokeAsync(GetKafkaConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKafkaConfigurationResult>("azure-native:purview/v20230501preview:getKafkaConfiguration", args ?? new GetKafkaConfigurationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the kafka configuration for the account
        /// </summary>
        public static Output<GetKafkaConfigurationResult> Invoke(GetKafkaConfigurationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKafkaConfigurationResult>("azure-native:purview/v20230501preview:getKafkaConfiguration", args ?? new GetKafkaConfigurationInvokeArgs(), options.WithDefaults());
