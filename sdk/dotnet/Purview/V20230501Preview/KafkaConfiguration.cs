...
namespace Pulumi.AzureNative.Purview.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:purview/v20230501preview:KafkaConfiguration")]
    public partial class KafkaConfiguration : global::Pulumi.CustomResource
    {
        ...
        public KafkaConfiguration(string name, KafkaConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:purview/v20230501preview:KafkaConfiguration", name, args ?? new KafkaConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KafkaConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:purview/v20230501preview:KafkaConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class KafkaConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("eventHubType")]
        public InputUnion<string, Pulumi.AzureNative.Purview.V20230501Preview.EventHubType>? EventHubType { get; set; }

        /// <summary>
        /// The state of the event streaming service
        /// </summary>
        [Input("eventStreamingState")]
        public InputUnion<string, Pulumi.AzureNative.Purview.V20230501Preview.EventStreamingState>? EventStreamingState { get; set; }

        /// <summary>
        /// The event streaming service type
        /// </summary>
        [Input("eventStreamingType")]
        public InputUnion<string, Pulumi.AzureNative.Purview.V20230501Preview.EventStreamingType>? EventStreamingType { get; set; }
