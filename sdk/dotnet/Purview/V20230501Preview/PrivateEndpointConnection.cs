...
namespace Pulumi.AzureNative.Purview.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:purview/v20230501preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:purview/v20230501preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:purview/v20230501preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
