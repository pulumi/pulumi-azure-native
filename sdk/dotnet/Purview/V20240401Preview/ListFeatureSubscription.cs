...
namespace Pulumi.AzureNative.Purview.V20240401Preview
{
    public static class ListFeatureSubscription
    {
        ...
        public static Task<ListFeatureSubscriptionResult> InvokeAsync(ListFeatureSubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListFeatureSubscriptionResult>("azure-native:purview/v20240401preview:listFeatureSubscription", args ?? new ListFeatureSubscriptionArgs(), options.WithDefaults());
        ...
        public static Output<ListFeatureSubscriptionResult> Invoke(ListFeatureSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListFeatureSubscriptionResult>("azure-native:purview/v20240401preview:listFeatureSubscription", args ?? new ListFeatureSubscriptionInvokeArgs(), options.WithDefaults());
    }
