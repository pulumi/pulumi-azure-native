...
namespace Pulumi.AzureRM.BatchAI
{
    public static class ListJobRemoteLoginInformation
    {
        public static Task<ListJobRemoteLoginInformationResult> InvokeAsync(ListJobRemoteLoginInformationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListJobRemoteLoginInformationResult>("azurerm:batchai:listJobRemoteLoginInformation", args ?? new ListJobRemoteLoginInformationArgs(), options.WithVersion());
    }
