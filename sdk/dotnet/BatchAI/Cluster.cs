...
namespace Pulumi.AzureNextGen.BatchAI
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:batchai:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batchai:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batchai:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("vmPriority")]
        public Input<Pulumi.AzureNextGen.BatchAI.VmPriority>? VmPriority { get; set; }
        ...
        public ClusterArgs()
        {
            VmPriority = Pulumi.AzureNextGen.BatchAI.VmPriority.Dedicated;
        }
    }
}
