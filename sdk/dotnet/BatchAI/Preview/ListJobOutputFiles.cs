...
namespace Pulumi.AzureRM.BatchAI.Preview
{
    public static class ListJobOutputFiles
    {
        public static Task<ListJobOutputFilesResult> InvokeAsync(ListJobOutputFilesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListJobOutputFilesResult>("azurerm:batchai/preview:listJobOutputFiles", args ?? new ListJobOutputFilesArgs(), options.WithVersion());
    }
