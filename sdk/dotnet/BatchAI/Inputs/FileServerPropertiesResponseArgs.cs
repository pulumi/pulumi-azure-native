...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    public sealed class FileServerPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataDisks")]
        public Input<Inputs.DataDisksResponseArgs>? DataDisks { get; set; }

        /// <summary>
        /// File Server mount settings.
        /// </summary>
        [Input("mountSettings", required: true)]
        public Input<Inputs.MountSettingsResponseArgs> MountSettings { get; set; } = null!;
        ...
        public Input<Inputs.SshConfigurationResponseArgs>? SshConfiguration { get; set; }
