...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    /// </summary>
    public sealed class AzureStorageCredentialsInfoResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.KeyVaultSecretReferenceResponseArgs>? AccountKeySecretReference { get; set; }

        public AzureStorageCredentialsInfoResponseArgs()
        {
        }
    }
}
