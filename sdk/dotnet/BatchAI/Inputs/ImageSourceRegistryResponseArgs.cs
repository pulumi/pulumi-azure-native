...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    /// </summary>
    public sealed class ImageSourceRegistryResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Credentials to access the private docker repository.
        /// </summary>
        [Input("credentials")]
        public Input<Inputs.PrivateRegistryCredentialsResponseArgs>? Credentials { get; set; }
        ...
        public ImageSourceRegistryResponseArgs()
        {
        }
    }
}
