...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    /// </summary>
    public sealed class AppInsightsReferenceResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Azure Application Insights component resource ID.
        /// </summary>
        [Input("component", required: true)]
        public Input<Inputs.ResourceIdResponseArgs> Component { get; set; } = null!;
        ...
        public Input<Inputs.KeyVaultSecretReferenceResponseArgs>? InstrumentationKeySecretReference { get; set; }

        public AppInsightsReferenceResponseArgs()
        {
        }
    }
}
