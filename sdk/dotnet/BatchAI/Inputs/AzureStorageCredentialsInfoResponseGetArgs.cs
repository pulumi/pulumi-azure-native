...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    /// </summary>
    public sealed class AzureStorageCredentialsInfoResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.KeyVaultSecretReferenceResponseGetArgs>? AccountKeySecretReference { get; set; }

        public AzureStorageCredentialsInfoResponseGetArgs()
        {
        }
    }
}
