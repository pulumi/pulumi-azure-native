...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    /// </summary>
    public sealed class EnvironmentVariableWithSecretValueResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.KeyVaultSecretReferenceResponseGetArgs>? ValueSecretReference { get; set; }

        public EnvironmentVariableWithSecretValueResponseGetArgs()
        {
        }
    }
}
