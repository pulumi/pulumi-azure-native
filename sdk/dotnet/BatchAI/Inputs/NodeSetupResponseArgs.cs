...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    /// Node setup settings.
    /// </summary>
    public sealed class NodeSetupResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.PerformanceCountersSettingsResponseArgs>? PerformanceCountersSettings { get; set; }
        ...
        /// </summary>
        [Input("setupTask")]
        public Input<Inputs.SetupTaskResponseArgs>? SetupTask { get; set; }

        public NodeSetupResponseArgs()
        {
        }
    }
}
