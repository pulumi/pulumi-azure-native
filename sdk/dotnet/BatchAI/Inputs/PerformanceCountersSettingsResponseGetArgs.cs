...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    /// </summary>
    public sealed class PerformanceCountersSettingsResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.AppInsightsReferenceResponseGetArgs> AppInsightsReference { get; set; } = null!;

        public PerformanceCountersSettingsResponseGetArgs()
        {
        }
    }
}
