...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    /// </summary>
    public sealed class ContainerSettingsResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Information about docker image and docker registry to download the container from.
        /// </summary>
        [Input("imageSourceRegistry", required: true)]
        public Input<Inputs.ImageSourceRegistryResponseGetArgs> ImageSourceRegistry { get; set; } = null!;
        ...
        public ContainerSettingsResponseGetArgs()
        {
        }
    }
}
