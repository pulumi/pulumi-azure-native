...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    /// </summary>
    public sealed class PrivateRegistryCredentialsResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.KeyVaultSecretReferenceResponseGetArgs>? PasswordSecretReference { get; set; }
        ...
        public PrivateRegistryCredentialsResponseGetArgs()
        {
        }
    }
}
