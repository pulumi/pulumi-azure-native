...
namespace Pulumi.AzureRM.BatchAI.Inputs
{
    ...
    public sealed class ClusterPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.BatchAIErrorResponseArgs>? _errors;

        /// <summary>
        /// Collection of errors encountered by various compute nodes during node setup.
        /// </summary>
        public InputList<Inputs.BatchAIErrorResponseArgs> Errors
        {
            get => _errors ?? (_errors = new InputList<Inputs.BatchAIErrorResponseArgs>());
            set => _errors = value;
        }
        ...
        /// </summary>
        [Input("nodeSetup")]
        public Input<Inputs.NodeSetupResponseArgs>? NodeSetup { get; set; }

        /// <summary>
        /// Counts of various node states on the cluster.
        /// </summary>
        [Input("nodeStateCounts", required: true)]
        public Input<Inputs.NodeStateCountsResponseArgs> NodeStateCounts { get; set; } = null!;
        ...
        /// </summary>
        [Input("subnet")]
        public Input<Inputs.ResourceIdResponseArgs>? Subnet { get; set; }

        /// <summary>
        /// Administrator user account settings which can be used to SSH to compute nodes.
        /// </summary>
        [Input("userAccountSettings")]
        public Input<Inputs.UserAccountSettingsResponseArgs>? UserAccountSettings { get; set; }
