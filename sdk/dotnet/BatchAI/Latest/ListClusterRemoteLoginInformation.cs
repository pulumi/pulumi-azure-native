...
namespace Pulumi.AzureNextGen.BatchAI.Latest
{
    ...
    public sealed class ListClusterRemoteLoginInformationResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.RemoteLoginInformationInvokeResponseResult> Value;

        [OutputConstructor]
        private ListClusterRemoteLoginInformationResult(
            string nextLink,

            ImmutableArray<Outputs.RemoteLoginInformationInvokeResponseResult> value)
        {
            NextLink = nextLink;
            Value = value;
        }
