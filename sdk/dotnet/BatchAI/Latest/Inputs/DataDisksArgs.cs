...
namespace Pulumi.AzureNative.BatchAI.Latest.Inputs
{
    ...
    public sealed class DataDisksArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cachingType")]
        public Input<Pulumi.AzureNative.BatchAI.Latest.CachingType>? CachingType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.BatchAI.Latest.StorageAccountType> StorageAccountType { get; set; } = null!;

        public DataDisksArgs()
        {
            CachingType = Pulumi.AzureNative.BatchAI.Latest.CachingType.None;
        }
    }
}
