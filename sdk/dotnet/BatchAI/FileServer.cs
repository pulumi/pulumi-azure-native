...
namespace Pulumi.AzureNextGen.BatchAI
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:batchai:FileServer")]
    public partial class FileServer : Pulumi.CustomResource
    {
        ...
        public FileServer(string name, FileServerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:batchai:FileServer", name, args ?? new FileServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:batchai:FileServer", name, null, MakeResourceOptions(options, id))
        {
        }
