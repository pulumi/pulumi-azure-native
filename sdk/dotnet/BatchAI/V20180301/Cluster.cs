...
namespace Pulumi.AzureNative.BatchAI.V20180301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:batchai/v20180301:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:batchai/v20180301:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:batchai/v20180301:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:batchai/v20170901preview:Cluster"},
    ...
    public sealed class ClusterArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("vmPriority")]
        public Input<Pulumi.AzureNative.BatchAI.V20180301.VmPriority>? VmPriority { get; set; }
        ...
        public ClusterArgs()
        {
            VmPriority = Pulumi.AzureNative.BatchAI.V20180301.VmPriority.Dedicated;
        }
    }
}
