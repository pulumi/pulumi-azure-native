...
namespace Pulumi.AzureRM.BatchAI.V20180301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cluster = new AzureRM.BatchAI.V20180301.Cluster("cluster", new AzureRM.BatchAI.V20180301.ClusterArgs
    ///         {
    ///             ClusterName = "demo_cluster",
    ///             Location = "eastus",
    ///             NodeSetup = new AzureRM.BatchAI.V20180301.Inputs.NodeSetupArgs
    ///             {
    ///                 MountVolumes = new AzureRM.BatchAI.V20180301.Inputs.MountVolumesArgs
    ///                 {
    ///                     AzureFileShares = 
    ///                     {
    ///                         new AzureRM.BatchAI.V20180301.Inputs.AzureFileShareReferenceArgs
    ///                         {
    ///                             AccountName = "storage_account_name",
    ///                             AzureFileUrl = "https://storage_account_name.file.core.windows.net/azure_file_share_name",
    ///                             Credentials = new AzureRM.BatchAI.V20180301.Inputs.AzureStorageCredentialsInfoArgs
    ///                             {
    ...
    ///                     FileServers = 
    ///                     {
    ///                         new AzureRM.BatchAI.V20180301.Inputs.FileServerReferenceArgs
    ///                         {
    ///                             FileServer = new AzureRM.BatchAI.V20180301.Inputs.ResourceIdArgs
    ///                             {
    ...
    ///             ScaleSettings = new AzureRM.BatchAI.V20180301.Inputs.ScaleSettingsArgs
    ///             {
    ///                 Manual = new AzureRM.BatchAI.V20180301.Inputs.ManualScaleSettingsArgs
    ///                 {
    ...
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:batchai/v20170901preview:Cluster"},
                },
            };
