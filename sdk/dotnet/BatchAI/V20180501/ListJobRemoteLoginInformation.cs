...
namespace Pulumi.AzureNative.BatchAI.V20180501
{
    public static class ListJobRemoteLoginInformation
    {
        ...
        public static Task<ListJobRemoteLoginInformationResult> InvokeAsync(ListJobRemoteLoginInformationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListJobRemoteLoginInformationResult>("azure-native:batchai/v20180501:listJobRemoteLoginInformation", args ?? new ListJobRemoteLoginInformationArgs(), options.WithVersion());
    }
