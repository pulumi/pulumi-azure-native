...
namespace Pulumi.AzureNextGen.BatchAI.V20180501.Outputs
{
    ...
    [OutputType]
    public sealed class PerformanceCountersSettingsInvokeResponseResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.AppInsightsReferenceInvokeResponseResult AppInsightsReference;

        [OutputConstructor]
        private PerformanceCountersSettingsInvokeResponseResult(Outputs.AppInsightsReferenceInvokeResponseResult appInsightsReference)
        {
