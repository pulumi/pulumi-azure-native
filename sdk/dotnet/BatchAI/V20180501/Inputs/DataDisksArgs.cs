...
namespace Pulumi.AzureNative.BatchAI.V20180501.Inputs
{
    ...
    public sealed class DataDisksArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cachingType")]
        public Input<Pulumi.AzureNative.BatchAI.V20180501.CachingType>? CachingType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.BatchAI.V20180501.StorageAccountType> StorageAccountType { get; set; } = null!;

        public DataDisksArgs()
        {
            CachingType = Pulumi.AzureNative.BatchAI.V20180501.CachingType.None;
        }
    }
}
