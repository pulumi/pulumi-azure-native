...
namespace Pulumi.AzureNative.BatchAI.V20180501
{
    public static class ListJobOutputFiles
    {
        ...
        public static Task<ListJobOutputFilesResult> InvokeAsync(ListJobOutputFilesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListJobOutputFilesResult>("azure-native:batchai/v20180501:listJobOutputFiles", args ?? new ListJobOutputFilesArgs(), options.WithVersion());
    }
