...
namespace Pulumi.AzureRM.BatchAI.V20180501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cluster = new AzureRM.BatchAI.V20180501.Cluster("cluster", new AzureRM.BatchAI.V20180501.ClusterArgs
    ///         {
    ///             ClusterName = "demo_cluster",
    ///             NodeSetup = new AzureRM.BatchAI.V20180501.Inputs.NodeSetupArgs
    ///             {
    ///                 MountVolumes = new AzureRM.BatchAI.V20180501.Inputs.MountVolumesArgs
    ///                 {
    ///                     AzureFileShares = 
    ///                     {
    ///                         new AzureRM.BatchAI.V20180501.Inputs.AzureFileShareReferenceArgs
    ///                         {
    ///                             AccountName = "storage_account_name",
    ///                             AzureFileUrl = "https://storage_account_name.file.core.windows.net/azure_file_share_name",
    ///                             Credentials = new AzureRM.BatchAI.V20180501.Inputs.AzureStorageCredentialsInfoArgs
    ///                             {
    ...
    ///                     FileServers = 
    ///                     {
    ///                         new AzureRM.BatchAI.V20180501.Inputs.FileServerReferenceArgs
    ///                         {
    ///                             FileServer = new AzureRM.BatchAI.V20180501.Inputs.ResourceIdArgs
    ///                             {
    ...
    ///             ScaleSettings = new AzureRM.BatchAI.V20180501.Inputs.ScaleSettingsArgs
    ///             {
    ///                 Manual = new AzureRM.BatchAI.V20180501.Inputs.ManualScaleSettingsArgs
    ///                 {
