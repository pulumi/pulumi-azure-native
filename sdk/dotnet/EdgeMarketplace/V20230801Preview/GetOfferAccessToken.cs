...
namespace Pulumi.AzureNative.EdgeMarketplace.V20230801Preview
{
    public static class GetOfferAccessToken
    {
        ...
        public static Task<GetOfferAccessTokenResult> InvokeAsync(GetOfferAccessTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOfferAccessTokenResult>("azure-native:edgemarketplace/v20230801preview:getOfferAccessToken", args ?? new GetOfferAccessTokenArgs(), options.WithDefaults());
