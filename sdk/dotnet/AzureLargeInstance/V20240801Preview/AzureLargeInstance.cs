...
namespace Pulumi.AzureNative.AzureLargeInstance.V20240801Preview
{
    ...
    /// properties)
    /// </summary>
    [AzureNativeResourceType("azure-native:azurelargeinstance/v20240801preview:AzureLargeInstance")]
    public partial class AzureLargeInstance : global::Pulumi.CustomResource
    {
        ...
        public AzureLargeInstance(string name, AzureLargeInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurelargeinstance/v20240801preview:AzureLargeInstance", name, args ?? new AzureLargeInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureLargeInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurelargeinstance/v20240801preview:AzureLargeInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:azurelargeinstance:AzureLargeInstance" },
                },
            };
    ...
    public sealed class AzureLargeInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("powerState")]
        public InputUnion<string, Pulumi.AzureNative.AzureLargeInstance.V20240801Preview.AzureLargeInstancePowerStateEnum>? PowerState { get; set; }
