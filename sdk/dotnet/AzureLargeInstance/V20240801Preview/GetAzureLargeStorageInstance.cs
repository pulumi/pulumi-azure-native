...
namespace Pulumi.AzureNative.AzureLargeInstance.V20240801Preview
{
    public static class GetAzureLargeStorageInstance
    {
        ...
        public static Task<GetAzureLargeStorageInstanceResult> InvokeAsync(GetAzureLargeStorageInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAzureLargeStorageInstanceResult>("azure-native:azurelargeinstance/v20240801preview:getAzureLargeStorageInstance", args ?? new GetAzureLargeStorageInstanceArgs(), options.WithDefaults());
        ...
        public static Output<GetAzureLargeStorageInstanceResult> Invoke(GetAzureLargeStorageInstanceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAzureLargeStorageInstanceResult>("azure-native:azurelargeinstance/v20240801preview:getAzureLargeStorageInstance", args ?? new GetAzureLargeStorageInstanceInvokeArgs(), options.WithDefaults());
    }
