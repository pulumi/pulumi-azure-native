...
namespace Pulumi.AzureRM.ServiceBus.Preview
{
    ...
    public partial class NamespaceVirtualNetworkRule : Pulumi.CustomResource
    {
        ...
        public NamespaceVirtualNetworkRule(string name, NamespaceVirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/preview:NamespaceVirtualNetworkRule", name, args ?? new NamespaceVirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceVirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/preview:NamespaceVirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicebus/v20180101preview:NamespaceVirtualNetworkRule"},
                },
            };
