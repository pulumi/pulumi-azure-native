...
namespace Pulumi.AzureRM.ServiceBus.Preview
{
    ...
    public partial class MigrationConfig : Pulumi.CustomResource
    {
        ...
        public MigrationConfig(string name, MigrationConfigArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/preview:MigrationConfig", name, args ?? new MigrationConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MigrationConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/preview:MigrationConfig", name, null, MakeResourceOptions(options, id))
        {
        }
