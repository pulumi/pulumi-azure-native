...
namespace Pulumi.AzureRM.ServiceBus.Preview
{
    public static class ListNamespaceKeys
    {
        public static Task<ListNamespaceKeysResult> InvokeAsync(ListNamespaceKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceKeysResult>("azurerm:servicebus/preview:listNamespaceKeys", args ?? new ListNamespaceKeysArgs(), options.WithVersion());
    }
