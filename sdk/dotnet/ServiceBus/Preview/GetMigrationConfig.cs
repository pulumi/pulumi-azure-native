...
namespace Pulumi.AzureRM.ServiceBus.Preview
{
    public static class GetMigrationConfig
    {
        public static Task<GetMigrationConfigResult> InvokeAsync(GetMigrationConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMigrationConfigResult>("azurerm:servicebus/preview:getMigrationConfig", args ?? new GetMigrationConfigArgs(), options.WithVersion());
    }
