...
namespace Pulumi.AzureRM.ServiceBus.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.ServiceBus.Latest.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.ServiceBus.Latest.PrivateEndpointConnectionArgs
    ///         {
    ///             NamespaceName = "sdk-Namespace-2924",
    ///             PrivateEndpoint = new AzureRM.ServiceBus.Latest.Inputs.PrivateEndpointArgs
    ///             {
    ...
    ///             PrivateLinkServiceConnectionState = new AzureRM.ServiceBus.Latest.Inputs.ConnectionStateArgs
    ///             {
    ///                 Description = "testing",
    ///                 Status = "Rejected",
    ///             },
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/latest:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/latest:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicebus/v20180101preview:PrivateEndpointConnection"},
                },
            };
