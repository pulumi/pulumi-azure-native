...
namespace Pulumi.AzureRM.ServiceBus.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var namespaceVirtualNetworkRule = new AzureRM.ServiceBus.Latest.NamespaceVirtualNetworkRule("namespaceVirtualNetworkRule", new AzureRM.ServiceBus.Latest.NamespaceVirtualNetworkRuleArgs
    ///         {
    ...
    public partial class NamespaceVirtualNetworkRule : Pulumi.CustomResource
    {
        ...
        public NamespaceVirtualNetworkRule(string name, NamespaceVirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/latest:NamespaceVirtualNetworkRule", name, args ?? new NamespaceVirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceVirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/latest:NamespaceVirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
