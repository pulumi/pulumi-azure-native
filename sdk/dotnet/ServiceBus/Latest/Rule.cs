...
namespace Pulumi.AzureRM.ServiceBus.Latest
{
    ...
    public partial class Rule : Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/latest:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/latest:Rule", name, null, MakeResourceOptions(options, id))
        {
        }
