...
namespace Pulumi.AzureRM.ServiceBus.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var namespaceIpFilterRule = new AzureRM.ServiceBus.Latest.NamespaceIpFilterRule("namespaceIpFilterRule", new AzureRM.ServiceBus.Latest.NamespaceIpFilterRuleArgs
    ///         {
    ///             Action = "Accept",
    ...
    public partial class NamespaceIpFilterRule : Pulumi.CustomResource
    {
        ...
        public NamespaceIpFilterRule(string name, NamespaceIpFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/latest:NamespaceIpFilterRule", name, args ?? new NamespaceIpFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceIpFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/latest:NamespaceIpFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicebus/v20180101preview:NamespaceIpFilterRule"},
                },
            };
