...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:listTopicKeys'.")]
    public static class ListTopicKeys
    {
        ...
        public static Task<ListTopicKeysResult> InvokeAsync(ListTopicKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTopicKeysResult>("azure-native:servicebus/latest:listTopicKeys", args ?? new ListTopicKeysArgs(), options.WithVersion());
    }
