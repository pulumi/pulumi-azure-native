...
namespace Pulumi.AzureNextGen.ServiceBus.V20170401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicebus/v20170401:TopicAuthorizationRule")]
    public partial class TopicAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public TopicAuthorizationRule(string name, TopicAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20170401:TopicAuthorizationRule", name, args ?? new TopicAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20170401:TopicAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
