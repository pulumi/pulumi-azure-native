...
namespace Pulumi.AzureRM.ServiceBus.V20170401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var topicAuthorizationRule = new AzureRM.ServiceBus.V20170401.TopicAuthorizationRule("topicAuthorizationRule", new AzureRM.ServiceBus.V20170401.TopicAuthorizationRuleArgs
    ///         {
    ...
    public partial class TopicAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public TopicAuthorizationRule(string name, TopicAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20170401:TopicAuthorizationRule", name, args ?? new TopicAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20170401:TopicAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
