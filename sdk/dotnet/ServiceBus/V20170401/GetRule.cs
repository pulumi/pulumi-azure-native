...
{
    [Obsolete(@"azure-native:servicebus/v20170401:Rule is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20220101preview:Rule to guarantee forwards compatibility.")]
    public static class GetRule
    {
        ...
        public static Task<GetRuleResult> InvokeAsync(GetRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleResult>("azure-native:servicebus/v20170401:getRule", args ?? new GetRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the description for the specified rule.
        /// </summary>
        public static Output<GetRuleResult> Invoke(GetRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRuleResult>("azure-native:servicebus/v20170401:getRule", args ?? new GetRuleInvokeArgs(), options.WithDefaults());
    }
