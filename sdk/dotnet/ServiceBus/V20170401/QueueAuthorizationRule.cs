...
namespace Pulumi.AzureNextGen.ServiceBus.V20170401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicebus/v20170401:QueueAuthorizationRule")]
    public partial class QueueAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public QueueAuthorizationRule(string name, QueueAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20170401:QueueAuthorizationRule", name, args ?? new QueueAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20170401:QueueAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class QueueAuthorizationRuleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.AzureNextGen.ServiceBus.V20170401.AccessRights>? _rights;

        /// <summary>
        /// The rights associated with the rule.
        /// </summary>
        public InputList<Pulumi.AzureNextGen.ServiceBus.V20170401.AccessRights> Rights
        {
            get => _rights ?? (_rights = new InputList<Pulumi.AzureNextGen.ServiceBus.V20170401.AccessRights>());
            set => _rights = value;
        }
