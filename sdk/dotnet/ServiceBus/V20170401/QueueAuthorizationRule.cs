...
namespace Pulumi.AzureNative.ServiceBus.V20170401
{
    ...
    /// {
    ///     var queueAuthorizationRule = new AzureNative.ServiceBus.V20170401.QueueAuthorizationRule("queueAuthorizationRule", new()
    ///     {
    ...
    ///         Rights = new[]
    ///         {
    ///             AzureNative.ServiceBus.V20170401.AccessRights.Listen,
    ///             AzureNative.ServiceBus.V20170401.AccessRights.Send,
    ///         },
    ///     });
    /// 
    /// });
    ...
    public partial class QueueAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public QueueAuthorizationRule(string name, QueueAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20170401:QueueAuthorizationRule", name, args ?? new QueueAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20170401:QueueAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
