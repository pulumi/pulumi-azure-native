...
namespace Pulumi.AzureRM.ServiceBus.V20170401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var queueAuthorizationRule = new AzureRM.ServiceBus.V20170401.QueueAuthorizationRule("queueAuthorizationRule", new AzureRM.ServiceBus.V20170401.QueueAuthorizationRuleArgs
    ///         {
    ...
    public partial class QueueAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public QueueAuthorizationRule(string name, QueueAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20170401:QueueAuthorizationRule", name, args ?? new QueueAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20170401:QueueAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicebus/latest:QueueAuthorizationRule"},
