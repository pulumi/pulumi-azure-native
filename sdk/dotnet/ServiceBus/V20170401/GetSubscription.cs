...
namespace Pulumi.AzureNative.ServiceBus.V20170401
{
    public static class GetSubscription
    {
        ...
        public static Output<GetSubscriptionResult> Invoke(GetSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSubscriptionResult>("azure-native:servicebus/v20170401:getSubscription", args ?? new GetSubscriptionInvokeArgs(), options.WithVersion());
    }
