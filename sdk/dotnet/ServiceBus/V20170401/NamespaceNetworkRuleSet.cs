...
namespace Pulumi.AzureNextGen.ServiceBus.V20170401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicebus/v20170401:NamespaceNetworkRuleSet")]
    public partial class NamespaceNetworkRuleSet : Pulumi.CustomResource
    {
        ...
        public NamespaceNetworkRuleSet(string name, NamespaceNetworkRuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20170401:NamespaceNetworkRuleSet", name, args ?? new NamespaceNetworkRuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceNetworkRuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20170401:NamespaceNetworkRuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceNetworkRuleSetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("defaultAction")]
        public InputUnion<string, Pulumi.AzureNextGen.ServiceBus.V20170401.DefaultAction>? DefaultAction { get; set; }
