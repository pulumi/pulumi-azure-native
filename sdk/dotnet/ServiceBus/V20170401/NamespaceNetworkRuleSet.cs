...
namespace Pulumi.AzureNative.ServiceBus.V20170401
{
    ...
    /// {
    ///     var namespaceNetworkRuleSet = new AzureNative.ServiceBus.V20170401.NamespaceNetworkRuleSet("namespaceNetworkRuleSet", new()
    ///     {
    ///         DefaultAction = "Deny",
    ///         IpRules = new[]
    ///         {
    ///             new AzureNative.ServiceBus.V20170401.Inputs.NWRuleSetIpRulesArgs
    ///             {
    ///                 Action = "Allow",
    ///                 IpMask = "1.1.1.1",
    ///             },
    ...
    ///         {
    ///             new AzureNative.ServiceBus.V20170401.Inputs.NWRuleSetVirtualNetworkRulesArgs
    ///             {
    ///                 IgnoreMissingVnetServiceEndpoint = true,
    ///                 Subnet = new AzureNative.ServiceBus.V20170401.Inputs.SubnetArgs
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:servicebus/v20170401:NamespaceNetworkRuleSet default /subscriptions/854d368f-1828-428f-8f3c-f2affa9b2f7d/resourceGroups/resourcegroupid/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace-9659/networkrulesets/default 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20170401:NamespaceNetworkRuleSet")]
    public partial class NamespaceNetworkRuleSet : global::Pulumi.CustomResource
    {
        ...
        public NamespaceNetworkRuleSet(string name, NamespaceNetworkRuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20170401:NamespaceNetworkRuleSet", name, args ?? new NamespaceNetworkRuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceNetworkRuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20170401:NamespaceNetworkRuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceNetworkRuleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("defaultAction")]
        public InputUnion<string, Pulumi.AzureNative.ServiceBus.V20170401.DefaultAction>? DefaultAction { get; set; }
