...
namespace Pulumi.AzureNative.ServiceBus.V20230101Preview
{
    public static class ListTopicKeys
    {
        ...
        public static Task<ListTopicKeysResult> InvokeAsync(ListTopicKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListTopicKeysResult>("azure-native:servicebus/v20230101preview:listTopicKeys", args ?? new ListTopicKeysArgs(), options.WithDefaults());
