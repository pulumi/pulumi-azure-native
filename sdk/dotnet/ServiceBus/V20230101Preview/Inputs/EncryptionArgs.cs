...
namespace Pulumi.AzureNative.ServiceBus.V20230101Preview.Inputs
{
    ...
    public sealed class EncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("keySource")]
        public Input<Pulumi.AzureNative.ServiceBus.V20230101Preview.KeySource>? KeySource { get; set; }
        ...
        {
            KeySource = Pulumi.AzureNative.ServiceBus.V20230101Preview.KeySource.Microsoft_KeyVault;
        }
