...
namespace Pulumi.AzureNative.ServiceBus.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20230101preview:DisasterRecoveryConfig")]
    public partial class DisasterRecoveryConfig : global::Pulumi.CustomResource
    {
        ...
        public DisasterRecoveryConfig(string name, DisasterRecoveryConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20230101preview:DisasterRecoveryConfig", name, args ?? new DisasterRecoveryConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DisasterRecoveryConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20230101preview:DisasterRecoveryConfig", name, null, MakeResourceOptions(options, id))
        {
        }
