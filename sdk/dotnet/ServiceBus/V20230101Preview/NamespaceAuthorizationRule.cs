...
namespace Pulumi.AzureNative.ServiceBus.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20230101preview:NamespaceAuthorizationRule")]
    public partial class NamespaceAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public NamespaceAuthorizationRule(string name, NamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20230101preview:NamespaceAuthorizationRule", name, args ?? new NamespaceAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20230101preview:NamespaceAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceAuthorizationRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.AzureNative.ServiceBus.V20230101Preview.AccessRights>? _rights;

        /// <summary>
        /// The rights associated with the rule.
        /// </summary>
        public InputList<Pulumi.AzureNative.ServiceBus.V20230101Preview.AccessRights> Rights
        {
            get => _rights ?? (_rights = new InputList<Pulumi.AzureNative.ServiceBus.V20230101Preview.AccessRights>());
            set => _rights = value;
        }
