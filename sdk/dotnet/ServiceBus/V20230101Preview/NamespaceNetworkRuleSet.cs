...
namespace Pulumi.AzureNative.ServiceBus.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20230101preview:NamespaceNetworkRuleSet")]
    public partial class NamespaceNetworkRuleSet : global::Pulumi.CustomResource
    {
        ...
        public NamespaceNetworkRuleSet(string name, NamespaceNetworkRuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20230101preview:NamespaceNetworkRuleSet", name, args ?? new NamespaceNetworkRuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceNetworkRuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20230101preview:NamespaceNetworkRuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceNetworkRuleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("defaultAction")]
        public InputUnion<string, Pulumi.AzureNative.ServiceBus.V20230101Preview.DefaultAction>? DefaultAction { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceBus.V20230101Preview.PublicNetworkAccessFlag>? PublicNetworkAccess { get; set; }
