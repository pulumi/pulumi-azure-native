...
namespace Pulumi.AzureNative.ServiceBus.V20221001Preview
{
    public static class GetQueue
    {
        ...
        public static Task<GetQueueResult> InvokeAsync(GetQueueArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetQueueResult>("azure-native:servicebus/v20221001preview:getQueue", args ?? new GetQueueArgs(), options.WithDefaults());
