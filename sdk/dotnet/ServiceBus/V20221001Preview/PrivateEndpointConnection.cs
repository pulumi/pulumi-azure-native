...
namespace Pulumi.AzureNative.ServiceBus.V20221001Preview
{
    /// <summary>
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.ServiceBus.V20221001Preview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         NamespaceName = "sdk-Namespace-2924",
    ///         PrivateEndpoint = new AzureNative.ServiceBus.V20221001Preview.Inputs.PrivateEndpointArgs
    ///         {
    ...
    ///         PrivateLinkServiceConnectionState = new AzureNative.ServiceBus.V20221001Preview.Inputs.ConnectionStateArgs
    ///         {
    ///             Description = "testing",
    ///             Status = "Rejected",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:servicebus/v20221001preview:PrivateEndpointConnection 928c44d5-b7c6-423b-b6fa-811e0c27b3e0 /subscriptions/dbedb4e0-40e6-4145-81f3-f1314c150774/resourceGroups/SDK-ServiceBus-4794/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace-5828/privateEndpointConnections/928c44d5-b7c6-423b-b6fa-811e0c27b3e0 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20221001preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
