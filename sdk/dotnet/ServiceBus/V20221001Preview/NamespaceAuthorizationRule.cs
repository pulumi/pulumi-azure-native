...
namespace Pulumi.AzureNative.ServiceBus.V20221001Preview
{
    ...
    /// {
    ///     var namespaceAuthorizationRule = new AzureNative.ServiceBus.V20221001Preview.NamespaceAuthorizationRule("namespaceAuthorizationRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20221001preview:NamespaceAuthorizationRule")]
    public partial class NamespaceAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public NamespaceAuthorizationRule(string name, NamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:NamespaceAuthorizationRule", name, args ?? new NamespaceAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:NamespaceAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
