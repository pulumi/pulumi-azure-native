...
namespace Pulumi.AzureNative.ServiceBus.V20221001Preview
{
    ...
    /// {
    ///     var @namespace = new AzureNative.ServiceBus.V20221001Preview.Namespace("namespace", new()
    ///     {
    ///         Location = "South Central US",
    ///         NamespaceName = "sdk-Namespace2924",
    ///         PremiumMessagingPartitions = 2,
    ///         ResourceGroupName = "ArunMonocle",
    ///         Sku = new AzureNative.ServiceBus.V20221001Preview.Inputs.SBSkuArgs
    ///         {
    ///             Capacity = 4,
    ///             Name = AzureNative.ServiceBus.V20221001Preview.SkuName.Premium,
    ///             Tier = AzureNative.ServiceBus.V20221001Preview.SkuTier.Premium,
    ///         },
    ///         Tags = 
    ///         {
    ///             { "tag1", "value1" },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20221001preview:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceBus.V20221001Preview.TlsVersion>? MinimumTlsVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ServiceBus.V20221001Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
