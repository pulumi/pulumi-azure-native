...
namespace Pulumi.AzureNative.ServiceBus.V20221001Preview
{
    public static class ListQueueKeys
    {
        ...
        public static Task<ListQueueKeysResult> InvokeAsync(ListQueueKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListQueueKeysResult>("azure-native:servicebus/v20221001preview:listQueueKeys", args ?? new ListQueueKeysArgs(), options.WithDefaults());
