...
namespace Pulumi.AzureNative.ServiceBus.V20221001Preview
{
    public static class GetRule
    {
        ...
        public static Task<GetRuleResult> InvokeAsync(GetRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleResult>("azure-native:servicebus/v20221001preview:getRule", args ?? new GetRuleArgs(), options.WithDefaults());
