...
namespace Pulumi.AzureNative.ServiceBus.V20221001Preview
{
    ...
    /// {
    ///     var subscription = new AzureNative.ServiceBus.V20221001Preview.Subscription("subscription", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:servicebus/v20221001preview:Subscription sdk-Subscriptions-2178 /subscriptions/Subscriptionid/resourceGroups/ResourceGroup/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace-1349/topics/sdk-Topics-8740/subscriptions/sdk-Subscriptions-2178 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20221001preview:Subscription")]
    public partial class Subscription : global::Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.ServiceBus.V20221001Preview.EntityStatus>? Status { get; set; }
