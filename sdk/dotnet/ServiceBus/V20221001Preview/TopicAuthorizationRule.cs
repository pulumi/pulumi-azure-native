...
namespace Pulumi.AzureNative.ServiceBus.V20221001Preview
{
    ...
    /// {
    ///     var topicAuthorizationRule = new AzureNative.ServiceBus.V20221001Preview.TopicAuthorizationRule("topicAuthorizationRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20221001preview:TopicAuthorizationRule")]
    public partial class TopicAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public TopicAuthorizationRule(string name, TopicAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:TopicAuthorizationRule", name, args ?? new TopicAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20221001preview:TopicAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
