...
namespace Pulumi.AzureNative.ServiceBus.V20221001Preview.Inputs
{
    ...
    public sealed class EncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("keySource")]
        public Input<Pulumi.AzureNative.ServiceBus.V20221001Preview.KeySource>? KeySource { get; set; }
        ...
        {
            KeySource = Pulumi.AzureNative.ServiceBus.V20221001Preview.KeySource.Microsoft_KeyVault;
        }
