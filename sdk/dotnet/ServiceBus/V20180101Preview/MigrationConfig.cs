...
namespace Pulumi.AzureNative.ServiceBus.V20180101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:servicebus/v20180101preview:MigrationConfig is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:MigrationConfig to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:servicebus/v20180101preview:MigrationConfig")]
    public partial class MigrationConfig : global::Pulumi.CustomResource
    {
        ...
        public MigrationConfig(string name, MigrationConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20180101preview:MigrationConfig", name, args ?? new MigrationConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MigrationConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20180101preview:MigrationConfig", name, null, MakeResourceOptions(options, id))
        {
        }
