...
namespace Pulumi.AzureNative.ServiceBus.V20180101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:servicebus/v20180101preview:Rule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:Rule to guarantee forwards compatibility.")]
    ...
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20180101preview:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20180101preview:Rule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("filterType")]
        public Input<Pulumi.AzureNative.ServiceBus.V20180101Preview.FilterType>? FilterType { get; set; }
