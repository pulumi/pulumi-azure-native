...
namespace Pulumi.AzureNextGen.ServiceBus.V20180101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicebus/v20180101preview:Rule")]
    public partial class Rule : Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20180101preview:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20180101preview:Rule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("filterType")]
        public Input<Pulumi.AzureNextGen.ServiceBus.V20180101Preview.FilterType>? FilterType { get; set; }
