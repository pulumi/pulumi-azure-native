...
namespace Pulumi.AzureRM.ServiceBus.V20180101Preview
{
    ...
    public partial class Namespace : Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20180101preview:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20180101preview:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
