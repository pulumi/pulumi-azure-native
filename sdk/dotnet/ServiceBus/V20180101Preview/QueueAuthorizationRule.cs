...
namespace Pulumi.AzureNextGen.ServiceBus.V20180101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicebus/v20180101preview:QueueAuthorizationRule")]
    public partial class QueueAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public QueueAuthorizationRule(string name, QueueAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20180101preview:QueueAuthorizationRule", name, args ?? new QueueAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20180101preview:QueueAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
