...
namespace Pulumi.AzureNative.ServiceBus.V20240101
{
    public static class ListNamespaceKeys
    {
        ...
        public static Task<ListNamespaceKeysResult> InvokeAsync(ListNamespaceKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceKeysResult>("azure-native:servicebus/v20240101:listNamespaceKeys", args ?? new ListNamespaceKeysArgs(), options.WithDefaults());
