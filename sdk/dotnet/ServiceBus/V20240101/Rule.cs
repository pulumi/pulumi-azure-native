...
namespace Pulumi.AzureNative.ServiceBus.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20240101:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20240101:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20240101:Rule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("filterType")]
        public Input<Pulumi.AzureNative.ServiceBus.V20240101.FilterType>? FilterType { get; set; }
