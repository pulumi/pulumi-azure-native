...
namespace Pulumi.AzureNative.ServiceBus.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20240101:Subscription")]
    public partial class Subscription : global::Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20240101:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20240101:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.ServiceBus.V20240101.EntityStatus>? Status { get; set; }
