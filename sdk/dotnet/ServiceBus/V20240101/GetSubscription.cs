...
namespace Pulumi.AzureNative.ServiceBus.V20240101
{
    public static class GetSubscription
    {
        ...
        public static Task<GetSubscriptionResult> InvokeAsync(GetSubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSubscriptionResult>("azure-native:servicebus/v20240101:getSubscription", args ?? new GetSubscriptionArgs(), options.WithDefaults());
