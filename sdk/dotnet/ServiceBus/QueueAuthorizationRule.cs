...
namespace Pulumi.AzureNextGen.ServiceBus
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicebus:QueueAuthorizationRule")]
    public partial class QueueAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public QueueAuthorizationRule(string name, QueueAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus:QueueAuthorizationRule", name, args ?? new QueueAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus:QueueAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
