...
namespace Pulumi.AzureNative.ServiceBus.V20210101Preview
{
    ...
    [AzureNativeResourceType("azure-native:servicebus/v20210101preview:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20210101preview:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20210101preview:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
