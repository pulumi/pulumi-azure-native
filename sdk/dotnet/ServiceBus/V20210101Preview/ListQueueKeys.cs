...
namespace Pulumi.AzureNative.ServiceBus.V20210101Preview
{
    public static class ListQueueKeys
    {
        ...
        public static Task<ListQueueKeysResult> InvokeAsync(ListQueueKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListQueueKeysResult>("azure-native:servicebus/v20210101preview:listQueueKeys", args ?? new ListQueueKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Namespace/ServiceBus Connection String
        /// </summary>
        public static Output<ListQueueKeysResult> Invoke(ListQueueKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListQueueKeysResult>("azure-native:servicebus/v20210101preview:listQueueKeys", args ?? new ListQueueKeysInvokeArgs(), options.WithDefaults());
    }
