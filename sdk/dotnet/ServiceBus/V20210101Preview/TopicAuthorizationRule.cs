...
namespace Pulumi.AzureNative.ServiceBus.V20210101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:servicebus/v20210101preview:TopicAuthorizationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20220101preview:TopicAuthorizationRule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:servicebus/v20210101preview:TopicAuthorizationRule")]
    public partial class TopicAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public TopicAuthorizationRule(string name, TopicAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20210101preview:TopicAuthorizationRule", name, args ?? new TopicAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20210101preview:TopicAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
