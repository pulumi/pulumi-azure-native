...
namespace Pulumi.AzureRM.ServiceBus
{
    public static class ListNamespaceAuthorizationRuleKeys
    {
        public static Task<ListNamespaceAuthorizationRuleKeysResult> InvokeAsync(ListNamespaceAuthorizationRuleKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceAuthorizationRuleKeysResult>("azurerm:servicebus:listNamespaceAuthorizationRuleKeys", args ?? new ListNamespaceAuthorizationRuleKeysArgs(), options.WithVersion());
    }
