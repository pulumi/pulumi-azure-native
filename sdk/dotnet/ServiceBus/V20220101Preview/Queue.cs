...
namespace Pulumi.AzureNative.ServiceBus.V20220101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:servicebus/v20220101preview:Queue is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:Queue to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:servicebus/v20220101preview:Queue")]
    public partial class Queue : global::Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class QueueArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.ServiceBus.V20220101Preview.EntityStatus>? Status { get; set; }
