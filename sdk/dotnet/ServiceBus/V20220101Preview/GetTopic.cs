...
namespace Pulumi.AzureNative.ServiceBus.V20220101Preview
{
    public static class GetTopic
    {
        ...
        public static Task<GetTopicResult> InvokeAsync(GetTopicArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTopicResult>("azure-native:servicebus/v20220101preview:getTopic", args ?? new GetTopicArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a description for the specified topic.
        /// </summary>
        public static Output<GetTopicResult> Invoke(GetTopicInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTopicResult>("azure-native:servicebus/v20220101preview:getTopic", args ?? new GetTopicInvokeArgs(), options.WithDefaults());
    }
