...
namespace Pulumi.AzureNative.ServiceBus.V20220101Preview
{
    ...
    /// {
    ///     var rule = new AzureNative.ServiceBus.V20220101Preview.Rule("rule", new()
    ///     {
    ///         CorrelationFilter = new AzureNative.ServiceBus.V20220101Preview.Inputs.CorrelationFilterArgs
    ///         {
    ///             Properties = 
    ///             {
    ///                 { "topicHint", "Crop" },
    ...
    ///         ResourceGroupName = "resourceGroupName",
    ///         RuleName = "sdk-Rules-6571",
    ///         SqlFilter = new AzureNative.ServiceBus.V20220101Preview.Inputs.SqlFilterArgs
    ///         {
    ...
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:Rule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("filterType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceBus.V20220101Preview.FilterType>? FilterType { get; set; }
