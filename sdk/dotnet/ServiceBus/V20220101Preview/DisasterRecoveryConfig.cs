...
namespace Pulumi.AzureNative.ServiceBus.V20220101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20220101preview:DisasterRecoveryConfig")]
    public partial class DisasterRecoveryConfig : global::Pulumi.CustomResource
    {
        ...
        public DisasterRecoveryConfig(string name, DisasterRecoveryConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:DisasterRecoveryConfig", name, args ?? new DisasterRecoveryConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DisasterRecoveryConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:DisasterRecoveryConfig", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:servicebus:DisasterRecoveryConfig" },
