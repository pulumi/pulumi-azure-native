...
namespace Pulumi.AzureNative.ServiceBus.V20220101Preview
{
    ...
    public partial class MigrationConfig : global::Pulumi.CustomResource
    {
        ...
        public MigrationConfig(string name, MigrationConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:MigrationConfig", name, args ?? new MigrationConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MigrationConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:MigrationConfig", name, null, MakeResourceOptions(options, id))
        {
        }
