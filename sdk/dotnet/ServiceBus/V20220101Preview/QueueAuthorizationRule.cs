...
namespace Pulumi.AzureNative.ServiceBus.V20220101Preview
{
    ...
    /// {
    ///     var queueAuthorizationRule = new AzureNative.ServiceBus.V20220101Preview.QueueAuthorizationRule("queueAuthorizationRule", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:servicebus/v20220101preview:QueueAuthorizationRule sdk-AuthRules-5800 /subscriptions/5f750a97-50d9-4e36-8081-c9ee4c0210d4/resourceGroups/ArunMonocle/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace-7982/queues/sdk-Queues-2317/authorizationRules/sdk-AuthRules-5800 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20220101preview:QueueAuthorizationRule")]
    public partial class QueueAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public QueueAuthorizationRule(string name, QueueAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:QueueAuthorizationRule", name, args ?? new QueueAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20220101preview:QueueAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class QueueAuthorizationRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.ServiceBus.V20220101Preview.AccessRights>>? _rights;

        /// <summary>
        /// The rights associated with the rule.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceBus.V20220101Preview.AccessRights>> Rights
        {
            get => _rights ?? (_rights = new InputList<Union<string, Pulumi.AzureNative.ServiceBus.V20220101Preview.AccessRights>>());
            set => _rights = value;
        }
