...
namespace Pulumi.AzureNative.ServiceBus.V20220101Preview
{
    public static class ListTopicKeys
    {
        ...
        public static Task<ListTopicKeysResult> InvokeAsync(ListTopicKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListTopicKeysResult>("azure-native:servicebus/v20220101preview:listTopicKeys", args ?? new ListTopicKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the primary and secondary connection strings for the topic.
        /// </summary>
        public static Output<ListTopicKeysResult> Invoke(ListTopicKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListTopicKeysResult>("azure-native:servicebus/v20220101preview:listTopicKeys", args ?? new ListTopicKeysInvokeArgs(), options.WithDefaults());
