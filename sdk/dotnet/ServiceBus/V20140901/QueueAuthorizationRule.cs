...
namespace Pulumi.AzureNative.ServiceBus.V20140901
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:servicebus/v20140901:QueueAuthorizationRule myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/queues/{queueName}/authorizationRules/{authorizationRuleName} 
    /// ```
    /// </summary>
    ...
    public partial class QueueAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public QueueAuthorizationRule(string name, QueueAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20140901:QueueAuthorizationRule", name, args ?? new QueueAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20140901:QueueAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
