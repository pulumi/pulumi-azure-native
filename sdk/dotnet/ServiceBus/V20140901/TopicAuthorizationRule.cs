...
namespace Pulumi.AzureNative.ServiceBus.V20140901
{
    ...
    public partial class TopicAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public TopicAuthorizationRule(string name, TopicAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20140901:TopicAuthorizationRule", name, args ?? new TopicAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20140901:TopicAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TopicAuthorizationRuleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.AzureNative.ServiceBus.V20140901.AccessRights>? _rights;

        /// <summary>
        /// The rights associated with the rule.
        /// </summary>
        public InputList<Pulumi.AzureNative.ServiceBus.V20140901.AccessRights> Rights
        {
            get => _rights ?? (_rights = new InputList<Pulumi.AzureNative.ServiceBus.V20140901.AccessRights>());
            set => _rights = value;
        }
