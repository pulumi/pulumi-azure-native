...
namespace Pulumi.AzureRM.ServiceBus.V20140901
{
    ...
    public partial class Namespace : Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20140901:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20140901:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
