...
namespace Pulumi.AzureRM.ServiceBus.V20140901
{
    public static class GetTopicAuthorizationRule
    {
        public static Task<GetTopicAuthorizationRuleResult> InvokeAsync(GetTopicAuthorizationRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTopicAuthorizationRuleResult>("azurerm:servicebus/v20140901:getTopicAuthorizationRule", args ?? new GetTopicAuthorizationRuleArgs(), options.WithVersion());
    }
