...
namespace Pulumi.AzureNative.ServiceBus.V20150801
{
    ...
    /// {
    ///     var @namespace = new AzureNative.ServiceBus.V20150801.Namespace("namespace", new()
    ///     {
    ///         Location = "West US",
    ///         NamespaceName = "sdk-Namespace7816",
    ///         ResourceGroupName = "Default-ServiceBus-WestUS",
    ///         Sku = new AzureNative.ServiceBus.V20150801.Inputs.SkuArgs
    ///         {
    ///             Name = "Standard",
    ///             Tier = "Standard",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:servicebus/v20150801:Namespace sdk-Namespace7816 /subscriptions/e2f361f0-3b27-4503-a9cc-21cfba380093/resourceGroups/Default-ServiceBus-WestUS/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace7816 
    /// ```
    /// </summary>
    [Obsolete(@"Version 2015-08-01 will be removed in v2 of the provider.")]
    [AzureNativeResourceType("azure-native:servicebus/v20150801:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20150801:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20150801:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.ServiceBus.V20150801.NamespaceState>? Status { get; set; }
