...
namespace Pulumi.AzureNative.ServiceBus.V20150801
{
    public static class ListNamespaceKeys
    {
        ...
        public static Task<ListNamespaceKeysResult> InvokeAsync(ListNamespaceKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceKeysResult>("azure-native:servicebus/v20150801:listNamespaceKeys", args ?? new ListNamespaceKeysArgs(), options.WithVersion());

        /// <summary>
        /// Namespace/ServiceBus Connection String
        /// </summary>
        public static Output<ListNamespaceKeysResult> Invoke(ListNamespaceKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListNamespaceKeysResult>("azure-native:servicebus/v20150801:listNamespaceKeys", args ?? new ListNamespaceKeysInvokeArgs(), options.WithVersion());
    }
