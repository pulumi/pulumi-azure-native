...
namespace Pulumi.AzureNextGen.ServiceBus.V20150801
{
    ...
    public partial class QueueAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public QueueAuthorizationRule(string name, QueueAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20150801:QueueAuthorizationRule", name, args ?? new QueueAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueueAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicebus/v20150801:QueueAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
