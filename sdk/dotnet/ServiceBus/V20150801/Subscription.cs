...
namespace Pulumi.AzureNative.ServiceBus.V20150801
{
    ...
    public partial class Subscription : Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20150801:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20150801:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:servicebus/v20210101preview:Subscription"},
                    new Pulumi.Alias { Type = "azure-native:servicebus/v20210601preview:Subscription"},
                    new Pulumi.Alias { Type = "azure-nextgen:servicebus/v20210601preview:Subscription"},
                },
            };
    ...
    public sealed class SubscriptionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.ServiceBus.V20150801.EntityAvailabilityStatus>? EntityAvailabilityStatus { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.ServiceBus.V20150801.EntityStatus>? Status { get; set; }
