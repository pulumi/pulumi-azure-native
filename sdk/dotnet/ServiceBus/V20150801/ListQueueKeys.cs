...
namespace Pulumi.AzureNative.ServiceBus.V20150801
{
    public static class ListQueueKeys
    {
        ...
        public static Task<ListQueueKeysResult> InvokeAsync(ListQueueKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListQueueKeysResult>("azure-native:servicebus/v20150801:listQueueKeys", args ?? new ListQueueKeysArgs(), options.WithVersion());

        /// <summary>
        /// Namespace/ServiceBus Connection String
        /// </summary>
        public static Output<ListQueueKeysResult> Invoke(ListQueueKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListQueueKeysResult>("azure-native:servicebus/v20150801:listQueueKeys", args ?? new ListQueueKeysInvokeArgs(), options.WithVersion());
    }
