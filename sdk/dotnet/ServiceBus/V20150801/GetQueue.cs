...
namespace Pulumi.AzureNative.ServiceBus.V20150801
{
    public static class GetQueue
    {
        ...
        public static Task<GetQueueResult> InvokeAsync(GetQueueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetQueueResult>("azure-native:servicebus/v20150801:getQueue", args ?? new GetQueueArgs(), options.WithVersion());

        /// <summary>
        /// Description of queue Resource.
        /// </summary>
        public static Output<GetQueueResult> Invoke(GetQueueInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetQueueResult>("azure-native:servicebus/v20150801:getQueue", args ?? new GetQueueInvokeArgs(), options.WithVersion());
    }
