...
namespace Pulumi.AzureNative.ServiceBus.V20150801
{
    ...
    /// {
    ///     var namespaceAuthorizationRule = new AzureNative.ServiceBus.V20150801.NamespaceAuthorizationRule("namespaceAuthorizationRule", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:servicebus/v20150801:NamespaceAuthorizationRule sdk-Authrules9875 /subscriptions/e2f361f0-3b27-4503-a9cc-21cfba380093/resourceGroups/Default-ServiceBus-WestUS/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace8341/AuthorizationRules/sdk-Authrules9875 
    /// ```
    /// </summary>
    [Obsolete(@"Version 2015-08-01 will be removed in v2 of the provider.")]
    [AzureNativeResourceType("azure-native:servicebus/v20150801:NamespaceAuthorizationRule")]
    public partial class NamespaceAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public NamespaceAuthorizationRule(string name, NamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20150801:NamespaceAuthorizationRule", name, args ?? new NamespaceAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20150801:NamespaceAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
