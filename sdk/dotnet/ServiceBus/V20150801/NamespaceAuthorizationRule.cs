...
namespace Pulumi.AzureRM.ServiceBus.V20150801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var namespaceAuthorizationRule = new AzureRM.ServiceBus.V20150801.NamespaceAuthorizationRule("namespaceAuthorizationRule", new AzureRM.ServiceBus.V20150801.NamespaceAuthorizationRuleArgs
    ///         {
    ...
    public partial class NamespaceAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public NamespaceAuthorizationRule(string name, NamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20150801:NamespaceAuthorizationRule", name, args ?? new NamespaceAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicebus/v20150801:NamespaceAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
