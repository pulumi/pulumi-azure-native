...
namespace Pulumi.AzureRM.ServiceBus
{
    public static class ListNamespaceKeys
    {
        public static Task<ListNamespaceKeysResult> InvokeAsync(ListNamespaceKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceKeysResult>("azurerm:servicebus:listNamespaceKeys", args ?? new ListNamespaceKeysArgs(), options.WithVersion());
    }
