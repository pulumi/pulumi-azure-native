...
namespace Pulumi.AzureNative.ServiceBus.V20211101
{
    public static class GetRule
    {
        ...
        public static Task<GetRuleResult> InvokeAsync(GetRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRuleResult>("azure-native:servicebus/v20211101:getRule", args ?? new GetRuleArgs(), options.WithVersion());

        /// <summary>
        /// Description of Rule Resource.
        /// </summary>
        public static Output<GetRuleResult> Invoke(GetRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRuleResult>("azure-native:servicebus/v20211101:getRule", args ?? new GetRuleInvokeArgs(), options.WithVersion());
    }
