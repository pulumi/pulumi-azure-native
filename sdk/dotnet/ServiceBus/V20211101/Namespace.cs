...
namespace Pulumi.AzureNative.ServiceBus.V20211101
{
    ...
    [AzureNativeResourceType("azure-native:servicebus/v20211101:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20211101:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20211101:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
