...
namespace Pulumi.AzureNative.ServiceBus.V20211101
{
    public static class GetTopic
    {
        ...
        public static Task<GetTopicResult> InvokeAsync(GetTopicArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTopicResult>("azure-native:servicebus/v20211101:getTopic", args ?? new GetTopicArgs(), options.WithVersion());

        /// <summary>
        /// Description of topic resource.
        /// </summary>
        public static Output<GetTopicResult> Invoke(GetTopicInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTopicResult>("azure-native:servicebus/v20211101:getTopic", args ?? new GetTopicInvokeArgs(), options.WithVersion());
    }
