...
namespace Pulumi.AzureNative.ServiceBus.V20211101
{
    ...
    public partial class TopicAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public TopicAuthorizationRule(string name, TopicAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20211101:TopicAuthorizationRule", name, args ?? new TopicAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20211101:TopicAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
