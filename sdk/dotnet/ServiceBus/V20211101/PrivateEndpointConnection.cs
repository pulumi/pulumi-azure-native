...
namespace Pulumi.AzureNative.ServiceBus.V20211101
{
    ...
    [AzureNativeResourceType("azure-native:servicebus/v20211101:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20211101:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20211101:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
