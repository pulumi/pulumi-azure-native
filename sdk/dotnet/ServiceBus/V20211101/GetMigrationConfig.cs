...
namespace Pulumi.AzureNative.ServiceBus.V20211101
{
    ...
    public static class GetMigrationConfig
    {
        ...
        public static Task<GetMigrationConfigResult> InvokeAsync(GetMigrationConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMigrationConfigResult>("azure-native:servicebus/v20211101:getMigrationConfig", args ?? new GetMigrationConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves Migration Config
        /// </summary>
        public static Output<GetMigrationConfigResult> Invoke(GetMigrationConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMigrationConfigResult>("azure-native:servicebus/v20211101:getMigrationConfig", args ?? new GetMigrationConfigInvokeArgs(), options.WithDefaults());
    }
