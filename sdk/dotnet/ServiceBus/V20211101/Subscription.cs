...
namespace Pulumi.AzureNative.ServiceBus.V20211101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:servicebus/v20211101:Subscription is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:Subscription to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:servicebus/v20211101:Subscription")]
    public partial class Subscription : global::Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20211101:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20211101:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.ServiceBus.V20211101.EntityStatus>? Status { get; set; }
