...
namespace Pulumi.AzureNative.ServiceBus.V20211101
{
    public static class ListTopicKeys
    {
        ...
        public static Task<ListTopicKeysResult> InvokeAsync(ListTopicKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTopicKeysResult>("azure-native:servicebus/v20211101:listTopicKeys", args ?? new ListTopicKeysArgs(), options.WithVersion());

        /// <summary>
        /// Namespace/ServiceBus Connection String
        /// </summary>
        public static Output<ListTopicKeysResult> Invoke(ListTopicKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListTopicKeysResult>("azure-native:servicebus/v20211101:listTopicKeys", args ?? new ListTopicKeysInvokeArgs(), options.WithVersion());
    }
