...
namespace Pulumi.AzureNative.ServiceBus.V20210601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicebus/v20210601preview:Topic")]
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20210601preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20210601preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
