...
namespace Pulumi.AzureNative.ServiceBus.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:servicebus/v20210601preview:NamespaceNetworkRuleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:NamespaceNetworkRuleSet to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:servicebus/v20210601preview:NamespaceNetworkRuleSet")]
    public partial class NamespaceNetworkRuleSet : global::Pulumi.CustomResource
    {
        ...
        public NamespaceNetworkRuleSet(string name, NamespaceNetworkRuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20210601preview:NamespaceNetworkRuleSet", name, args ?? new NamespaceNetworkRuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceNetworkRuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicebus/v20210601preview:NamespaceNetworkRuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceNetworkRuleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("defaultAction")]
        public InputUnion<string, Pulumi.AzureNative.ServiceBus.V20210601Preview.DefaultAction>? DefaultAction { get; set; }
