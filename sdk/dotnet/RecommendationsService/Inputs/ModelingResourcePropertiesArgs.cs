...
namespace Pulumi.AzureNative.RecommendationsService.Inputs
{
    ...
    public sealed class ModelingResourcePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNative.RecommendationsService.ModelingFeatures>? Features { get; set; }
        ...
        /// </summary>
        [Input("size")]
        public InputUnion<string, Pulumi.AzureNative.RecommendationsService.ModelingSize>? Size { get; set; }
