...
namespace Pulumi.AzureNative.RecommendationsService.V20220301Preview
{
    ...
    public partial class ServiceEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ServiceEndpoint(string name, ServiceEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recommendationsservice/v20220301preview:ServiceEndpoint", name, args ?? new ServiceEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recommendationsservice/v20220301preview:ServiceEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
