...
namespace Pulumi.AzureNative.RecommendationsService
{
    ...
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:recommendationsservice:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:recommendationsservice:Account", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:recommendationsservice/v20220201:Account" },
                    new global::Pulumi.Alias { Type = "azure-native:recommendationsservice/v20220301preview:Account" },
                    new global::Pulumi.Alias { Type = "azure-native_recommendationsservice_v20220201:recommendationsservice:Account" },
                    new global::Pulumi.Alias { Type = "azure-native_recommendationsservice_v20220301preview:recommendationsservice:Account" },
                },
            };
    ...
    public sealed class AccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.AccountResourcePropertiesArgs>? Properties { get; set; }
