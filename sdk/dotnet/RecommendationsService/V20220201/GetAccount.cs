...
namespace Pulumi.AzureNative.RecommendationsService.V20220201
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:recommendationsservice/v20220201:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Account resource details.
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:recommendationsservice/v20220201:getAccount", args ?? new GetAccountInvokeArgs(), options.WithDefaults());
    }
