...
namespace Pulumi.AzureNative.DatabaseWatcher.V20230901Preview
{
    public static class GetWatcher
    {
        ...
        public static Task<GetWatcherResult> InvokeAsync(GetWatcherArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWatcherResult>("azure-native:databasewatcher/v20230901preview:getWatcher", args ?? new GetWatcherArgs(), options.WithDefaults());
