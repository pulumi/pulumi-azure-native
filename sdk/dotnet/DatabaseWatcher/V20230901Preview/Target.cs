...
namespace Pulumi.AzureNative.DatabaseWatcher.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databasewatcher/v20230901preview:Target")]
    public partial class Target : global::Pulumi.CustomResource
    {
        ...
        public Target(string name, TargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20230901preview:Target", name, args ?? new TargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Target(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20230901preview:Target", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DatabaseWatcher.V20230901Preview.TargetAuthenticationType> TargetAuthenticationType { get; set; } = null!;

        /// <summary>
        /// The target collection status.
        /// </summary>
        [Input("targetCollectionStatus")]
        public InputUnion<string, Pulumi.AzureNative.DatabaseWatcher.V20230901Preview.TargetCollectionStatus>? TargetCollectionStatus { get; set; }
