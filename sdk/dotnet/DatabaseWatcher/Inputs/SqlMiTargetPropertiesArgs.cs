...
namespace Pulumi.AzureNative.DatabaseWatcher.Inputs
{
    ...
    /// </summary>
    public sealed class SqlMiTargetPropertiesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("sqlMiResourceId", required: true)]
        public Input<string> SqlMiResourceId { get; set; } = null!;
        ...
        public SqlMiTargetPropertiesArgs()
        {
            ConnectionTcpPort = 1433;
            ReadIntent = false;
        }
        public static new SqlMiTargetPropertiesArgs Empty => new SqlMiTargetPropertiesArgs();
    }
}
