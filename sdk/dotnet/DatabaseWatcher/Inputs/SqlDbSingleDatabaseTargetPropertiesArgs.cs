...
namespace Pulumi.AzureNative.DatabaseWatcher.Inputs
{
    ...
    /// </summary>
    public sealed class SqlDbSingleDatabaseTargetPropertiesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("sqlDbResourceId", required: true)]
        public Input<string> SqlDbResourceId { get; set; } = null!;
        ...
        public SqlDbSingleDatabaseTargetPropertiesArgs()
        {
            ReadIntent = false;
        }
        public static new SqlDbSingleDatabaseTargetPropertiesArgs Empty => new SqlDbSingleDatabaseTargetPropertiesArgs();
    }
}
