...
namespace Pulumi.AzureNative.DatabaseWatcher
{
    ...
    /// Azure REST API version: 2024-10-01-preview. Prior API version in Azure Native 1.x: 2024-07-19-preview.
    /// 
    ...
    public partial class AlertRuleResource : global::Pulumi.CustomResource
    {
        ...
        public AlertRuleResource(string name, AlertRuleResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher:AlertRuleResource", name, args ?? new AlertRuleResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRuleResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher:AlertRuleResource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AlertRuleResourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DatabaseWatcher.AlertRuleCreationProperties> CreatedWithProperties { get; set; } = null!;
