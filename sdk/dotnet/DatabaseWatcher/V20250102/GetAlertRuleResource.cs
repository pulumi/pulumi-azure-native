...
namespace Pulumi.AzureNative.DatabaseWatcher.V20250102
{
    public static class GetAlertRuleResource
    {
        ...
        public static Task<GetAlertRuleResourceResult> InvokeAsync(GetAlertRuleResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleResourceResult>("azure-native:databasewatcher/v20250102:getAlertRuleResource", args ?? new GetAlertRuleResourceArgs(), options.WithDefaults());

        /// <summary>
        /// Get a AlertRuleResource
        /// </summary>
        public static Output<GetAlertRuleResourceResult> Invoke(GetAlertRuleResourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAlertRuleResourceResult>("azure-native:databasewatcher/v20250102:getAlertRuleResource", args ?? new GetAlertRuleResourceInvokeArgs(), options.WithDefaults());
