...
namespace Pulumi.AzureNative.DatabaseWatcher.V20250102
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databasewatcher/v20250102:Target")]
    public partial class Target : global::Pulumi.CustomResource
    {
        ...
        public Target(string name, TargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20250102:Target", name, args ?? new TargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Target(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20250102:Target", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DatabaseWatcher.V20250102.TargetAuthenticationType> TargetAuthenticationType { get; set; } = null!;
