...
namespace Pulumi.AzureNative.DatabaseWatcher.V20250102
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databasewatcher/v20250102:Watcher")]
    public partial class Watcher : global::Pulumi.CustomResource
    {
        ...
        public Watcher(string name, WatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20250102:Watcher", name, args ?? new WatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Watcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20250102:Watcher", name, null, MakeResourceOptions(options, id))
        {
        }
