...
namespace Pulumi.AzureNative.DatabaseWatcher.V20241001Preview
{
    public static class GetAlertRuleResource
    {
        ...
        public static Task<GetAlertRuleResourceResult> InvokeAsync(GetAlertRuleResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleResourceResult>("azure-native:databasewatcher/v20241001preview:getAlertRuleResource", args ?? new GetAlertRuleResourceArgs(), options.WithDefaults());
