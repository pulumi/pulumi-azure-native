...
namespace Pulumi.AzureNative.DatabaseWatcher.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databasewatcher/v20241001preview:SharedPrivateLinkResource")]
    public partial class SharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SharedPrivateLinkResource(string name, SharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20241001preview:SharedPrivateLinkResource", name, args ?? new SharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20241001preview:SharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
