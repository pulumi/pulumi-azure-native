...
namespace Pulumi.AzureNative.DatabaseWatcher.V20241001Preview
{
    public static class GetTarget
    {
        ...
        public static Task<GetTargetResult> InvokeAsync(GetTargetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTargetResult>("azure-native:databasewatcher/v20241001preview:getTarget", args ?? new GetTargetArgs(), options.WithDefaults());
