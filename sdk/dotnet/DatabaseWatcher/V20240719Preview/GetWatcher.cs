...
namespace Pulumi.AzureNative.DatabaseWatcher.V20240719Preview
{
    public static class GetWatcher
    {
        ...
        public static Task<GetWatcherResult> InvokeAsync(GetWatcherArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWatcherResult>("azure-native:databasewatcher/v20240719preview:getWatcher", args ?? new GetWatcherArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Watcher
        /// </summary>
        public static Output<GetWatcherResult> Invoke(GetWatcherInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWatcherResult>("azure-native:databasewatcher/v20240719preview:getWatcher", args ?? new GetWatcherInvokeArgs(), options.WithDefaults());
