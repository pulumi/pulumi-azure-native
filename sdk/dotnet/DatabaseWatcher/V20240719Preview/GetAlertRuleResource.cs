...
namespace Pulumi.AzureNative.DatabaseWatcher.V20240719Preview
{
    public static class GetAlertRuleResource
    {
        ...
        public static Task<GetAlertRuleResourceResult> InvokeAsync(GetAlertRuleResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleResourceResult>("azure-native:databasewatcher/v20240719preview:getAlertRuleResource", args ?? new GetAlertRuleResourceArgs(), options.WithDefaults());

        /// <summary>
        /// Get a AlertRuleResource
        /// </summary>
        public static Output<GetAlertRuleResourceResult> Invoke(GetAlertRuleResourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAlertRuleResourceResult>("azure-native:databasewatcher/v20240719preview:getAlertRuleResource", args ?? new GetAlertRuleResourceInvokeArgs(), options.WithDefaults());
