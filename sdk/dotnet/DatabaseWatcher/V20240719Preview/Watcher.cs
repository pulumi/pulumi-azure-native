...
namespace Pulumi.AzureNative.DatabaseWatcher.V20240719Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databasewatcher/v20240719preview:Watcher")]
    public partial class Watcher : global::Pulumi.CustomResource
    {
        ...
        public Watcher(string name, WatcherArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20240719preview:Watcher", name, args ?? new WatcherArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Watcher(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databasewatcher/v20240719preview:Watcher", name, null, MakeResourceOptions(options, id))
        {
        }
