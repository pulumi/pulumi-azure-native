...
namespace Pulumi.AzureNative.DatabaseWatcher.V20240719Preview
{
    public static class GetTarget
    {
        ...
        public static Task<GetTargetResult> InvokeAsync(GetTargetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTargetResult>("azure-native:databasewatcher/v20240719preview:getTarget", args ?? new GetTargetArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Target
        /// </summary>
        public static Output<GetTargetResult> Invoke(GetTargetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTargetResult>("azure-native:databasewatcher/v20240719preview:getTarget", args ?? new GetTargetInvokeArgs(), options.WithDefaults());
