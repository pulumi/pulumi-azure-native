...
namespace Pulumi.AzureNative.ScVmm.V20220521Preview
{
    public static class GetInventoryItem
    {
        ...
        public static Task<GetInventoryItemResult> InvokeAsync(GetInventoryItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInventoryItemResult>("azure-native:scvmm/v20220521preview:getInventoryItem", args ?? new GetInventoryItemArgs(), options.WithDefaults());
