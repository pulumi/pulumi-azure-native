...
namespace Pulumi.AzureNative.ScVmm.V20220521Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20220521preview:HybridIdentityMetadata")]
    public partial class HybridIdentityMetadata : global::Pulumi.CustomResource
    {
        ...
        public HybridIdentityMetadata(string name, HybridIdentityMetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20220521preview:HybridIdentityMetadata", name, args ?? new HybridIdentityMetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridIdentityMetadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20220521preview:HybridIdentityMetadata", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:scvmm:HybridIdentityMetadata" },
                },
            };
