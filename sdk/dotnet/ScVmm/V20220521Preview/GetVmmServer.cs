...
namespace Pulumi.AzureNative.ScVmm.V20220521Preview
{
    public static class GetVmmServer
    {
        ...
        public static Task<GetVmmServerResult> InvokeAsync(GetVmmServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVmmServerResult>("azure-native:scvmm/v20220521preview:getVmmServer", args ?? new GetVmmServerArgs(), options.WithDefaults());

        /// <summary>
        /// Implements VMMServer GET method.
        /// </summary>
        public static Output<GetVmmServerResult> Invoke(GetVmmServerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVmmServerResult>("azure-native:scvmm/v20220521preview:getVmmServer", args ?? new GetVmmServerInvokeArgs(), options.WithDefaults());
    }
