...
namespace Pulumi.AzureNative.ScVmm.V20220521Preview
{
    public static class GetCloud
    {
        ...
        public static Task<GetCloudResult> InvokeAsync(GetCloudArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCloudResult>("azure-native:scvmm/v20220521preview:getCloud", args ?? new GetCloudArgs(), options.WithDefaults());

        /// <summary>
        /// Implements Cloud GET method.
        /// </summary>
        public static Output<GetCloudResult> Invoke(GetCloudInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCloudResult>("azure-native:scvmm/v20220521preview:getCloud", args ?? new GetCloudInvokeArgs(), options.WithDefaults());
