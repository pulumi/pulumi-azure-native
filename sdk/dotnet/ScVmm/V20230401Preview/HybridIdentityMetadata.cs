...
namespace Pulumi.AzureNative.ScVmm.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20230401preview:HybridIdentityMetadata")]
    public partial class HybridIdentityMetadata : global::Pulumi.CustomResource
    {
        ...
        public HybridIdentityMetadata(string name, HybridIdentityMetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20230401preview:HybridIdentityMetadata", name, args ?? new HybridIdentityMetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridIdentityMetadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20230401preview:HybridIdentityMetadata", name, null, MakeResourceOptions(options, id))
        {
        }
