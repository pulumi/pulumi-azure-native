...
namespace Pulumi.AzureNative.ScVmm.V20230401Preview
{
    public static class GetVirtualMachine
    {
        ...
        public static Task<GetVirtualMachineResult> InvokeAsync(GetVirtualMachineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualMachineResult>("azure-native:scvmm/v20230401preview:getVirtualMachine", args ?? new GetVirtualMachineArgs(), options.WithDefaults());
