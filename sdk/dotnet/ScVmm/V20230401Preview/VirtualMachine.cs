...
namespace Pulumi.AzureNative.ScVmm.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20230401preview:VirtualMachine")]
    public partial class VirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20230401preview:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20230401preview:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
