...
namespace Pulumi.AzureNative.ScVmm.V20230401Preview
{
    public static class GetAvailabilitySet
    {
        ...
        public static Task<GetAvailabilitySetResult> InvokeAsync(GetAvailabilitySetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAvailabilitySetResult>("azure-native:scvmm/v20230401preview:getAvailabilitySet", args ?? new GetAvailabilitySetArgs(), options.WithDefaults());

        /// <summary>
        /// Implements AvailabilitySet GET method.
        /// </summary>
        public static Output<GetAvailabilitySetResult> Invoke(GetAvailabilitySetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAvailabilitySetResult>("azure-native:scvmm/v20230401preview:getAvailabilitySet", args ?? new GetAvailabilitySetInvokeArgs(), options.WithDefaults());
    }
