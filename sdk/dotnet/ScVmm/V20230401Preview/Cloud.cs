...
namespace Pulumi.AzureNative.ScVmm.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20230401preview:Cloud")]
    public partial class Cloud : global::Pulumi.CustomResource
    {
        ...
        public Cloud(string name, CloudArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20230401preview:Cloud", name, args ?? new CloudArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cloud(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20230401preview:Cloud", name, null, MakeResourceOptions(options, id))
        {
        }
