...
namespace Pulumi.AzureNative.ScVmm.V20231007
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20231007:VirtualMachineInstance")]
    public partial class VirtualMachineInstance : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineInstance(string name, VirtualMachineInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20231007:VirtualMachineInstance", name, args ?? new VirtualMachineInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20231007:VirtualMachineInstance", name, null, MakeResourceOptions(options, id))
        {
        }
