...
namespace Pulumi.AzureNative.ScVmm.V20231007
{
    public static class GetGuestAgent
    {
        ...
        public static Task<GetGuestAgentResult> InvokeAsync(GetGuestAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGuestAgentResult>("azure-native:scvmm/v20231007:getGuestAgent", args ?? new GetGuestAgentArgs(), options.WithDefaults());
