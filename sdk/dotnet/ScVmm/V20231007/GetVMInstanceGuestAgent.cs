...
namespace Pulumi.AzureNative.ScVmm.V20231007
{
    public static class GetVMInstanceGuestAgent
    {
        ...
        public static Task<GetVMInstanceGuestAgentResult> InvokeAsync(GetVMInstanceGuestAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVMInstanceGuestAgentResult>("azure-native:scvmm/v20231007:getVMInstanceGuestAgent", args ?? new GetVMInstanceGuestAgentArgs(), options.WithDefaults());
        ...
        public static Output<GetVMInstanceGuestAgentResult> Invoke(GetVMInstanceGuestAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVMInstanceGuestAgentResult>("azure-native:scvmm/v20231007:getVMInstanceGuestAgent", args ?? new GetVMInstanceGuestAgentInvokeArgs(), options.WithDefaults());
    }
