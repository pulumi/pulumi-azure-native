...
namespace Pulumi.AzureNative.ScVmm.V20231007
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20231007:GuestAgent")]
    public partial class GuestAgent : global::Pulumi.CustomResource
    {
        ...
        public GuestAgent(string name, GuestAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20231007:GuestAgent", name, args ?? new GuestAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20231007:GuestAgent", name, null, MakeResourceOptions(options, id))
        {
        }
