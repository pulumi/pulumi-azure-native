...
namespace Pulumi.AzureNative.ScVmm.V20231007
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20231007:VMInstanceGuestAgent")]
    public partial class VMInstanceGuestAgent : global::Pulumi.CustomResource
    {
        ...
        public VMInstanceGuestAgent(string name, VMInstanceGuestAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20231007:VMInstanceGuestAgent", name, args ?? new VMInstanceGuestAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VMInstanceGuestAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20231007:VMInstanceGuestAgent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VMInstanceGuestAgentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ScVmm.V20231007.ProvisioningAction>? ProvisioningAction { get; set; }
