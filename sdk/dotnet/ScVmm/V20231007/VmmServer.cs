...
namespace Pulumi.AzureNative.ScVmm.V20231007
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20231007:VmmServer")]
    public partial class VmmServer : global::Pulumi.CustomResource
    {
        ...
        public VmmServer(string name, VmmServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20231007:VmmServer", name, args ?? new VmmServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VmmServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20231007:VmmServer", name, null, MakeResourceOptions(options, id))
        {
        }
