...
namespace Pulumi.AzureNative.ScVmm
{
    public static class GetInventoryItem
    {
        ...
        public static Task<GetInventoryItemResult> InvokeAsync(GetInventoryItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInventoryItemResult>("azure-native:scvmm:getInventoryItem", args ?? new GetInventoryItemArgs(), options.WithDefaults());
        ...
        public static Output<GetInventoryItemResult> Invoke(GetInventoryItemInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetInventoryItemResult>("azure-native:scvmm:getInventoryItem", args ?? new GetInventoryItemInvokeArgs(), options.WithDefaults());
    }
