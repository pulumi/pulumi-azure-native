...
namespace Pulumi.AzureNative.ScVmm.V20200605Preview
{
    ...
    /// {
    ///     var virtualMachine = new AzureNative.ScVmm.V20200605Preview.VirtualMachine("virtualMachine", new()
    ///     {
    ...
    ///             Type = "customLocation",
    ///         },
    ///         HardwareProfile = new AzureNative.ScVmm.V20200605Preview.Inputs.HardwareProfileArgs
    ///         {
    ///             CpuCount = 4,
    ///             MemoryMB = 4096,
    ///         },
