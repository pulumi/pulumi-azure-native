...
namespace Pulumi.AzureNative.ScVmm.V20200605Preview
{
    ...
    public partial class Cloud : global::Pulumi.CustomResource
    {
        ...
        public Cloud(string name, CloudArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20200605preview:Cloud", name, args ?? new CloudArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cloud(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20200605preview:Cloud", name, null, MakeResourceOptions(options, id))
        {
        }
