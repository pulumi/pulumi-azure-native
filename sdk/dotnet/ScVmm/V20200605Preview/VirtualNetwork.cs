...
namespace Pulumi.AzureNative.ScVmm.V20200605Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:scvmm/v20200605preview:VirtualNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:scvmm/v20220521preview:VirtualNetwork to guarantee forwards compatibility.")]
    ...
    public partial class VirtualNetwork : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20200605preview:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20200605preview:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
