...
namespace Pulumi.AzureNative.ScVmm.V20200605Preview
{
    ...
    public partial class VmmServer : global::Pulumi.CustomResource
    {
        ...
        public VmmServer(string name, VmmServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20200605preview:VmmServer", name, args ?? new VmmServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VmmServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20200605preview:VmmServer", name, null, MakeResourceOptions(options, id))
        {
        }
