...
namespace Pulumi.AzureNative.ScVmm.V20200605Preview
{
    ...
    public partial class VirtualMachineTemplate : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineTemplate(string name, VirtualMachineTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20200605preview:VirtualMachineTemplate", name, args ?? new VirtualMachineTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20200605preview:VirtualMachineTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
