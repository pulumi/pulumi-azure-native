...
namespace Pulumi.AzureNative.ScVmm.V20240601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20240601:AvailabilitySet")]
    public partial class AvailabilitySet : global::Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20240601:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20240601:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
