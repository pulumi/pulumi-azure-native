...
namespace Pulumi.AzureNative.ScVmm.V20240601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20240601:Cloud")]
    public partial class Cloud : global::Pulumi.CustomResource
    {
        ...
        public Cloud(string name, CloudArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20240601:Cloud", name, args ?? new CloudArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cloud(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20240601:Cloud", name, null, MakeResourceOptions(options, id))
        {
        }
