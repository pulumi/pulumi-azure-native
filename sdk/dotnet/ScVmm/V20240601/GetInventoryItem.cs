...
namespace Pulumi.AzureNative.ScVmm.V20240601
{
    public static class GetInventoryItem
    {
        ...
        public static Task<GetInventoryItemResult> InvokeAsync(GetInventoryItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInventoryItemResult>("azure-native:scvmm/v20240601:getInventoryItem", args ?? new GetInventoryItemArgs(), options.WithDefaults());

        /// <summary>
        /// Shows an inventory item.
        /// </summary>
        public static Output<GetInventoryItemResult> Invoke(GetInventoryItemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInventoryItemResult>("azure-native:scvmm/v20240601:getInventoryItem", args ?? new GetInventoryItemInvokeArgs(), options.WithDefaults());
    }
