...
namespace Pulumi.AzureNative.ScVmm.V20240601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:scvmm/v20240601:VmmServer")]
    public partial class VmmServer : global::Pulumi.CustomResource
    {
        ...
        public VmmServer(string name, VmmServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20240601:VmmServer", name, args ?? new VmmServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VmmServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm/v20240601:VmmServer", name, null, MakeResourceOptions(options, id))
        {
        }
