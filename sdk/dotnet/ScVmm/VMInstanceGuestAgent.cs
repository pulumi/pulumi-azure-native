...
namespace Pulumi.AzureNative.ScVmm
{
    ...
    public partial class VMInstanceGuestAgent : global::Pulumi.CustomResource
    {
        ...
        public VMInstanceGuestAgent(string name, VMInstanceGuestAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:scvmm:VMInstanceGuestAgent", name, args ?? new VMInstanceGuestAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VMInstanceGuestAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:scvmm:VMInstanceGuestAgent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_scvmm_v20230401preview:scvmm:VMInstanceGuestAgent" },
                    new global::Pulumi.Alias { Type = "azure-native_scvmm_v20231007:scvmm:VMInstanceGuestAgent" },
                    new global::Pulumi.Alias { Type = "azure-native_scvmm_v20240601:scvmm:VMInstanceGuestAgent" },
                },
            };
