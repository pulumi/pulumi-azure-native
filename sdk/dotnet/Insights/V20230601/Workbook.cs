...
namespace Pulumi.AzureNative.Insights.V20230601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20230601:Workbook")]
    public partial class Workbook : global::Pulumi.CustomResource
    {
        ...
        public Workbook(string name, WorkbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230601:Workbook", name, args ?? new WorkbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230601:Workbook", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkbookArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20230601.WorkbookSharedTypeKind>? Kind { get; set; }
