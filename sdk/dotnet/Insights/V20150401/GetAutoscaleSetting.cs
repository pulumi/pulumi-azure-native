...
namespace Pulumi.AzureNative.Insights.V20150401
{
    public static class GetAutoscaleSetting
    {
        ...
        public static Output<GetAutoscaleSettingResult> Invoke(GetAutoscaleSettingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAutoscaleSettingResult>("azure-native:insights/v20150401:getAutoscaleSetting", args ?? new GetAutoscaleSettingInvokeArgs(), options.WithVersion());
    }
