...
namespace Pulumi.AzureNative.Insights.V20150401.Inputs
{
    ...
    public sealed class MetricTriggerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Insights.V20150401.ComparisonOperationType> Operator { get; set; } = null!;

        /// <summary>
        /// the metric statistic type. How the metrics from multiple instances are combined.
        /// </summary>
        [Input("statistic", required: true)]
        public Input<Pulumi.AzureNative.Insights.V20150401.MetricStatisticType> Statistic { get; set; } = null!;
        ...
        public Input<Pulumi.AzureNative.Insights.V20150401.TimeAggregationType> TimeAggregation { get; set; } = null!;
