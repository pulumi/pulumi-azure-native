...
namespace Pulumi.AzureNextGen.Insights.V20150401.Inputs
{
    ...
    public sealed class ScaleActionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Insights.V20150401.ScaleDirection> Direction { get; set; } = null!;

        /// <summary>
        /// the type of action that should occur when the scale rule fires.
        /// </summary>
        [Input("type", required: true)]
        public Input<Pulumi.AzureNextGen.Insights.V20150401.ScaleType> Type { get; set; } = null!;
