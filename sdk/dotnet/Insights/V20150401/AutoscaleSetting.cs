...
namespace Pulumi.AzureRM.Insights.V20150401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var autoscaleSetting = new AzureRM.Insights.V20150401.AutoscaleSetting("autoscaleSetting", new AzureRM.Insights.V20150401.AutoscaleSettingArgs
    ///         {
    ...
    ///             Notifications = 
    ///             {
    ///                 new AzureRM.Insights.V20150401.Inputs.AutoscaleNotificationArgs
    ///                 {
    ///                     Email = new AzureRM.Insights.V20150401.Inputs.EmailNotificationArgs
    ///                     {
    ///                         CustomEmails = 
    ///                         {
    ///                             "gu@ms.com",
    ...
    ///                     Webhooks = 
    ///                     {
    ///                         new AzureRM.Insights.V20150401.Inputs.WebhookNotificationArgs
    ///                         {
    ///                             Properties = ,
    ...
    ///             Profiles = 
    ///             {
    ///                 new AzureRM.Insights.V20150401.Inputs.AutoscaleProfileArgs
    ///                 {
    ///                     Capacity = new AzureRM.Insights.V20150401.Inputs.ScaleCapacityArgs
    ///                     {
    ///                         Default = "1",
    ///                         Maximum = "10",
    ///                         Minimum = "1",
    ///                     },
    ///                     FixedDate = new AzureRM.Insights.V20150401.Inputs.TimeWindowArgs
    ///                     {
    ...
    ///                     Rules = 
    ///                     {
    ///                         new AzureRM.Insights.V20150401.Inputs.ScaleRuleArgs
    ///                         {
    ///                             MetricTrigger = new AzureRM.Insights.V20150401.Inputs.MetricTriggerArgs
    ///                             {
    ...
    ///                                 TimeWindow = "PT5M",
    ///                             },
    ///                             ScaleAction = new AzureRM.Insights.V20150401.Inputs.ScaleActionArgs
    ///                             {
    ///                                 Cooldown = "PT5M",
    ///                                 Direction = "Increase",
    ///                                 Type = "ChangeCount",
    ...
    ///                     },
    ///                     Name = "saludos",
    ///                     Recurrence = new AzureRM.Insights.V20150401.Inputs.RecurrenceArgs
    ///                     {
    ///                         Frequency = "Week",
    ///                         Schedule = new AzureRM.Insights.V20150401.Inputs.RecurrentScheduleArgs
    ///                         {
    ///                             Days = 
    ///                             {
    ///                                 "1",
    ...
    public partial class AutoscaleSetting : Pulumi.CustomResource
    {
        ...
        public AutoscaleSetting(string name, AutoscaleSettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20150401:AutoscaleSetting", name, args ?? new AutoscaleSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutoscaleSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20150401:AutoscaleSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:insights/latest:AutoscaleSetting"},
                },
            };
