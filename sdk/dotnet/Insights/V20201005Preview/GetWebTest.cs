...
namespace Pulumi.AzureNative.Insights.V20201005Preview
{
    public static class GetWebTest
    {
        ...
        public static Output<GetWebTestResult> Invoke(GetWebTestInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebTestResult>("azure-native:insights/v20201005preview:getWebTest", args ?? new GetWebTestInvokeArgs(), options.WithVersion());
    }
