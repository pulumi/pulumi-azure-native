...
namespace Pulumi.AzureRM.Insights
{
    public static class GetAutoscaleSetting
    {
        public static Task<GetAutoscaleSettingResult> InvokeAsync(GetAutoscaleSettingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutoscaleSettingResult>("azurerm:insights:getAutoscaleSetting", args ?? new GetAutoscaleSettingArgs(), options.WithVersion());
    }
