...
namespace Pulumi.AzureRM.Insights.Preview
{
    public static class GetAnalyticsItem
    {
        public static Task<GetAnalyticsItemResult> InvokeAsync(GetAnalyticsItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAnalyticsItemResult>("azurerm:insights/preview:getAnalyticsItem", args ?? new GetAnalyticsItemArgs(), options.WithVersion());
    }
