...
namespace Pulumi.AzureRM.Insights.Preview
{
    ...
    public partial class Favorite : Pulumi.CustomResource
    {
        ...
        public Favorite(string name, FavoriteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:Favorite", name, args ?? new FavoriteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Favorite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:Favorite", name, null, MakeResourceOptions(options, id))
        {
        }
