...
namespace Pulumi.AzureRM.Insights.Preview
{
    ...
    public partial class QueryPack : Pulumi.CustomResource
    {
        ...
        public QueryPack(string name, QueryPackArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:QueryPack", name, args ?? new QueryPackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueryPack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:QueryPack", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:insights/v20190901preview:QueryPack"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static QueryPack Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
