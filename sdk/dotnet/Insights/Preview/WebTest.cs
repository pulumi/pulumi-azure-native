...
namespace Pulumi.AzureRM.Insights.Preview
{
    ...
    public partial class WebTest : Pulumi.CustomResource
    {
        ...
        public WebTest(string name, WebTestArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:WebTest", name, args ?? new WebTestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebTest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:WebTest", name, null, MakeResourceOptions(options, id))
        {
        }
