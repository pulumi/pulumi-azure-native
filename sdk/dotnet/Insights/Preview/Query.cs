...
namespace Pulumi.AzureRM.Insights.Preview
{
    ...
    public partial class Query : Pulumi.CustomResource
    {
        ...
        public Query(string name, QueryArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:Query", name, args ?? new QueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Query(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:Query", name, null, MakeResourceOptions(options, id))
        {
        }
