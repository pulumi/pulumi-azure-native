...
namespace Pulumi.AzureRM.Insights.Preview
{
    ...
    public partial class WorkbookTemplate : Pulumi.CustomResource
    {
        ...
        public WorkbookTemplate(string name, WorkbookTemplateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:WorkbookTemplate", name, args ?? new WorkbookTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkbookTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:WorkbookTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:insights/v20191017preview:WorkbookTemplate"},
                },
            };
