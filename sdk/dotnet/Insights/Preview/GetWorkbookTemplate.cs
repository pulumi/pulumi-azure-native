...
namespace Pulumi.AzureRM.Insights.Preview
{
    public static class GetWorkbookTemplate
    {
        public static Task<GetWorkbookTemplateResult> InvokeAsync(GetWorkbookTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkbookTemplateResult>("azurerm:insights/preview:getWorkbookTemplate", args ?? new GetWorkbookTemplateArgs(), options.WithVersion());
    }
