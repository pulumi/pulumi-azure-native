...
namespace Pulumi.AzureRM.Insights.Preview
{
    ...
    public partial class ExportConfiguration : Pulumi.CustomResource
    {
        ...
        public ExportConfiguration(string name, ExportConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:ExportConfiguration", name, args ?? new ExportConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExportConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/preview:ExportConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:insights/v20150501:ExportConfiguration"},
                },
            };
