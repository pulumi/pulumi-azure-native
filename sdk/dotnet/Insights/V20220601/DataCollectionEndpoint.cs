...
namespace Pulumi.AzureNative.Insights.V20220601
{
    ...
    public partial class DataCollectionEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionEndpoint(string name, DataCollectionEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20220601:DataCollectionEndpoint", name, args ?? new DataCollectionEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20220601:DataCollectionEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataCollectionEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20220601.KnownDataCollectionEndpointResourceKind>? Kind { get; set; }
