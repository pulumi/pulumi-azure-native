...
namespace Pulumi.AzureNative.Insights.V20220601.Inputs
{
    ...
    public sealed class DataFlowArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("streams")]
        private InputList<Union<string, Pulumi.AzureNative.Insights.V20220601.KnownDataFlowStreams>>? _streams;

        /// <summary>
        /// List of streams for this data flow.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Insights.V20220601.KnownDataFlowStreams>> Streams
        {
            get => _streams ?? (_streams = new InputList<Union<string, Pulumi.AzureNative.Insights.V20220601.KnownDataFlowStreams>>());
            set => _streams = value;
        }
