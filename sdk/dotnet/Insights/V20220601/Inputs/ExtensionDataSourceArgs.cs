...
namespace Pulumi.AzureNative.Insights.V20220601.Inputs
{
    ...
    public sealed class ExtensionDataSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("streams")]
        private InputList<Union<string, Pulumi.AzureNative.Insights.V20220601.KnownExtensionDataSourceStreams>>? _streams;

        /// <summary>
        /// List of streams that this data source will be sent to.
        /// A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Insights.V20220601.KnownExtensionDataSourceStreams>> Streams
        {
            get => _streams ?? (_streams = new InputList<Union<string, Pulumi.AzureNative.Insights.V20220601.KnownExtensionDataSourceStreams>>());
            set => _streams = value;
        }
