...
namespace Pulumi.AzureNative.Insights.V20220601
{
    public static class GetDataCollectionRule
    {
        ...
        public static Task<GetDataCollectionRuleResult> InvokeAsync(GetDataCollectionRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataCollectionRuleResult>("azure-native:insights/v20220601:getDataCollectionRule", args ?? new GetDataCollectionRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Definition of ARM tracked top level resource.
        /// </summary>
        public static Output<GetDataCollectionRuleResult> Invoke(GetDataCollectionRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataCollectionRuleResult>("azure-native:insights/v20220601:getDataCollectionRule", args ?? new GetDataCollectionRuleInvokeArgs(), options.WithDefaults());
    }
