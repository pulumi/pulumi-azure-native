...
namespace Pulumi.AzureNative.Insights
{
    ...
    /// Previous API Version: 2021-09-01-preview. See https://github.com/pulumi/pulumi-azure-native/discussions/1834 for information on migrating from v1 to v2 of the provider.
    /// </summary>
    ...
    public partial class DataCollectionEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionEndpoint(string name, DataCollectionEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights:DataCollectionEndpoint", name, args ?? new DataCollectionEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights:DataCollectionEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataCollectionEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.KnownDataCollectionEndpointResourceKind>? Kind { get; set; }
