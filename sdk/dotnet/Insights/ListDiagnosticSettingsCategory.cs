...
namespace Pulumi.AzureNative.Insights
{
    public static class ListDiagnosticSettingsCategory
    {
        ...
        public static Task<ListDiagnosticSettingsCategoryResult> InvokeAsync(ListDiagnosticSettingsCategoryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListDiagnosticSettingsCategoryResult>("azure-native:insights:listDiagnosticSettingsCategory", args ?? new ListDiagnosticSettingsCategoryArgs(), options.WithDefaults());
