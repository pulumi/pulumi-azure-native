...
namespace Pulumi.AzureNative.Insights.V20210701Preview
{
    ...
    /// {
    ///     var privateLinkScope = new AzureNative.Insights.V20210701Preview.PrivateLinkScope("privateLinkScope", new()
    ///     {
    ///         AccessModeSettings = new AzureNative.Insights.V20210701Preview.Inputs.AccessModeSettingsArgs
    ///         {
    ///             Exclusions = new[] {},
    ...
    public partial class PrivateLinkScope : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScope(string name, PrivateLinkScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210701preview:PrivateLinkScope", name, args ?? new PrivateLinkScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210701preview:PrivateLinkScope", name, null, MakeResourceOptions(options, id))
        {
        }
