...
namespace Pulumi.AzureNative.Insights.V20210701Preview
{
    ...
    /// {
    ///     var privateLinkScopedResource = new AzureNative.Insights.V20210701Preview.PrivateLinkScopedResource("privateLinkScopedResource", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:insights/v20210701preview:PrivateLinkScopedResource scoped-resource-name /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/MyResourceGroup/providers/Microsoft.Insights/privateLinkScopes/MyPrivateLinkScope/scopedResources/scoped-resource-name 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20210701preview:PrivateLinkScopedResource")]
    public partial class PrivateLinkScopedResource : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScopedResource(string name, PrivateLinkScopedResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210701preview:PrivateLinkScopedResource", name, args ?? new PrivateLinkScopedResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScopedResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210701preview:PrivateLinkScopedResource", name, null, MakeResourceOptions(options, id))
        {
        }
