...
namespace Pulumi.AzureNative.Insights.V20210901Preview
{
    ...
    public partial class DataCollectionRuleAssociation : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionRuleAssociation(string name, DataCollectionRuleAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901preview:DataCollectionRuleAssociation", name, args ?? new DataCollectionRuleAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionRuleAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901preview:DataCollectionRuleAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
