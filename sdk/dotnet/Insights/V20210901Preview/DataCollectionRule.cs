...
namespace Pulumi.AzureNative.Insights.V20210901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:insights/v20210901preview:DataCollectionRule is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20220601:DataCollectionRule to guarantee forwards compatibility.")]
    ...
    public partial class DataCollectionRule : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionRule(string name, DataCollectionRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901preview:DataCollectionRule", name, args ?? new DataCollectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901preview:DataCollectionRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataCollectionRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20210901Preview.KnownDataCollectionRuleResourceKind>? Kind { get; set; }
