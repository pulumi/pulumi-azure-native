...
namespace Pulumi.AzureNative.Insights.V20210901Preview
{
    ...
    /// {
    ///     var dataCollectionEndpoint = new AzureNative.Insights.V20210901Preview.DataCollectionEndpoint("dataCollectionEndpoint", new()
    ///     {
    ///         DataCollectionEndpointName = "myCollectionEndpoint",
    ///         Location = "eastus",
    ///         NetworkAcls = new AzureNative.Insights.V20210901Preview.Inputs.DataCollectionEndpointNetworkAclsArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20210901preview:DataCollectionEndpoint")]
    public partial class DataCollectionEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionEndpoint(string name, DataCollectionEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901preview:DataCollectionEndpoint", name, args ?? new DataCollectionEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901preview:DataCollectionEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataCollectionEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20210901Preview.KnownDataCollectionEndpointResourceKind>? Kind { get; set; }
