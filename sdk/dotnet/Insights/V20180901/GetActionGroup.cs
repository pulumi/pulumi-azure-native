...
namespace Pulumi.AzureNative.Insights.V20180901
{
    public static class GetActionGroup
    {
        ...
        public static Task<GetActionGroupResult> InvokeAsync(GetActionGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetActionGroupResult>("azure-native:insights/v20180901:getActionGroup", args ?? new GetActionGroupArgs(), options.WithDefaults());

        /// <summary>
        /// An action group resource.
        /// </summary>
        public static Output<GetActionGroupResult> Invoke(GetActionGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetActionGroupResult>("azure-native:insights/v20180901:getActionGroup", args ?? new GetActionGroupInvokeArgs(), options.WithDefaults());
    }
