...
namespace Pulumi.AzureNative.Insights.V20210308
{
    public static class GetMyWorkbook
    {
        ...
        public static Task<GetMyWorkbookResult> InvokeAsync(GetMyWorkbookArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMyWorkbookResult>("azure-native:insights/v20210308:getMyWorkbook", args ?? new GetMyWorkbookArgs(), options.WithVersion());

        /// <summary>
        /// An Application Insights private workbook definition.
        /// </summary>
        public static Output<GetMyWorkbookResult> Invoke(GetMyWorkbookInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMyWorkbookResult>("azure-native:insights/v20210308:getMyWorkbook", args ?? new GetMyWorkbookInvokeArgs(), options.WithVersion());
    }
