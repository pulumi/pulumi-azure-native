...
namespace Pulumi.AzureNative.Insights.V20210308
{
    ...
    /// {
    ///     var myWorkbook = new AzureNative.Insights.V20210308.MyWorkbook("myWorkbook", new()
    ///     {
    ///         Category = "workbook",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:insights/v20210308:MyWorkbook deadb33f-8bee-4d3b-a059-9be8dac93960 /subscriptions/00000000-0000-0000-0000-00000000/resourceGroups/my-resource-group/providers/Microsoft.Insights/myworkbooks/deadb33f-8bee-4d3b-a059-9be8dac93960 
    /// ```
    /// </summary>
    ...
    public partial class MyWorkbook : global::Pulumi.CustomResource
    {
        ...
        public MyWorkbook(string name, MyWorkbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210308:MyWorkbook", name, args ?? new MyWorkbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MyWorkbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210308:MyWorkbook", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MyWorkbookArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20210308.Kind>? Kind { get; set; }
