...
namespace Pulumi.AzureNative.Insights.V20210308
{
    ...
    /// {
    ///     var workbook = new AzureNative.Insights.V20210308.Workbook("workbook", new()
    ///     {
    ///         Category = "workbook",
    ...
    ///         Identity = new AzureNative.Insights.V20210308.Inputs.WorkbookManagedIdentityArgs
    ///         {
    ///             Type = "UserAssigned",
    ///         },
    ///         Kind = "shared",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20210308:Workbook")]
    public partial class Workbook : global::Pulumi.CustomResource
    {
        ...
        public Workbook(string name, WorkbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210308:Workbook", name, args ?? new WorkbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210308:Workbook", name, null, MakeResourceOptions(options, id))
        {
        }
