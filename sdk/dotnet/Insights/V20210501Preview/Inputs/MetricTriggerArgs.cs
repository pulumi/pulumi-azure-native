...
namespace Pulumi.AzureNative.Insights.V20210501Preview.Inputs
{
    ...
    public sealed class MetricTriggerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Insights.V20210501Preview.ComparisonOperationType> Operator { get; set; } = null!;

        /// <summary>
        /// the metric statistic type. How the metrics from multiple instances are combined.
        /// </summary>
        [Input("statistic", required: true)]
        public Input<Pulumi.AzureNative.Insights.V20210501Preview.MetricStatisticType> Statistic { get; set; } = null!;
        ...
        public Input<Pulumi.AzureNative.Insights.V20210501Preview.TimeAggregationType> TimeAggregation { get; set; } = null!;
