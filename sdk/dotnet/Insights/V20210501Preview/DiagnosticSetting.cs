...
namespace Pulumi.AzureNative.Insights.V20210501Preview
{
    ...
    public partial class DiagnosticSetting : Pulumi.CustomResource
    {
        ...
        public DiagnosticSetting(string name, DiagnosticSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210501preview:DiagnosticSetting", name, args ?? new DiagnosticSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiagnosticSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210501preview:DiagnosticSetting", name, null, MakeResourceOptions(options, id))
        {
        }
