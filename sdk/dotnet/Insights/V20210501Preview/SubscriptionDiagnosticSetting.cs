...
namespace Pulumi.AzureNative.Insights.V20210501Preview
{
    ...
    public partial class SubscriptionDiagnosticSetting : Pulumi.CustomResource
    {
        ...
        public SubscriptionDiagnosticSetting(string name, SubscriptionDiagnosticSettingArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210501preview:SubscriptionDiagnosticSetting", name, args ?? new SubscriptionDiagnosticSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionDiagnosticSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210501preview:SubscriptionDiagnosticSetting", name, null, MakeResourceOptions(options, id))
        {
        }
