...
namespace Pulumi.AzureRM.Insights
{
    ...
    /// </summary>
    public partial class ComponentExportconfiguration : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ComponentExportconfiguration(string name, ComponentExportconfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights:ComponentExportconfiguration", name, args ?? new ComponentExportconfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class ComponentExportconfigurationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
