...
namespace Pulumi.AzureNative.Insights.V20140401
{
    ...
    public partial class AutoscaleSetting : Pulumi.CustomResource
    {
        ...
        public AutoscaleSetting(string name, AutoscaleSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20140401:AutoscaleSetting", name, args ?? new AutoscaleSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutoscaleSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20140401:AutoscaleSetting", name, null, MakeResourceOptions(options, id))
        {
        }
