...
namespace Pulumi.AzureNative.Insights.V20170401
{
    ...
    public partial class ActivityLogAlert : global::Pulumi.CustomResource
    {
        ...
        public ActivityLogAlert(string name, ActivityLogAlertArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20170401:ActivityLogAlert", name, args ?? new ActivityLogAlertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActivityLogAlert(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20170401:ActivityLogAlert", name, null, MakeResourceOptions(options, id))
        {
        }
