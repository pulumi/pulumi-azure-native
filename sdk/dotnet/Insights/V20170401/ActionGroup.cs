...
namespace Pulumi.AzureRM.Insights.V20170401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var actionGroup = new AzureRM.Insights.V20170401.ActionGroup("actionGroup", new AzureRM.Insights.V20170401.ActionGroupArgs
    ///         {
    ///             ActionGroupName = "SampleActionGroup",
    ///             AutomationRunbookReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20170401.Inputs.AutomationRunbookReceiverArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Insights.V20170401.Inputs.AzureAppPushReceiverArgs
    ///                 {
    ...
    ///             EmailReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20170401.Inputs.EmailReceiverArgs
    ///                 {
    ///                     EmailAddress = "johndoe@email.com",
    ...
    ///             ItsmReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20170401.Inputs.ItsmReceiverArgs
    ///                 {
    ...
    ///             SmsReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20170401.Inputs.SmsReceiverArgs
    ///                 {
    ///                     CountryCode = "1",
    ...
    ///             WebhookReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20170401.Inputs.WebhookReceiverArgs
    ///                 {
    ///                     Name = "Sample webhook",
    ...
    public partial class ActionGroup : Pulumi.CustomResource
    {
        ...
        public ActionGroup(string name, ActionGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20170401:ActionGroup", name, args ?? new ActionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20170401:ActionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
