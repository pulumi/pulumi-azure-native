...
namespace Pulumi.AzureNative.Insights.V20230101
{
    /// <summary>
    ...
    public partial class ActionGroup : global::Pulumi.CustomResource
    {
        ...
        public ActionGroup(string name, ActionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230101:ActionGroup", name, args ?? new ActionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230101:ActionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
