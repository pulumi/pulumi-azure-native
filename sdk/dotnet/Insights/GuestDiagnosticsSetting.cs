...
namespace Pulumi.AzureNextGen.Insights
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:insights:guestDiagnosticsSetting")]
    public partial class GuestDiagnosticsSetting : Pulumi.CustomResource
    {
        ...
        public GuestDiagnosticsSetting(string name, GuestDiagnosticsSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:insights:guestDiagnosticsSetting", name, args ?? new GuestDiagnosticsSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestDiagnosticsSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:insights:guestDiagnosticsSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:insights/v20180601preview:guestDiagnosticsSetting"},
                },
            };
