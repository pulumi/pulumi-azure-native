...
namespace Pulumi.AzureNative.Insights.V20230901Preview
{
    public static class GetActionGroup
    {
        ...
        public static Task<GetActionGroupResult> InvokeAsync(GetActionGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActionGroupResult>("azure-native:insights/v20230901preview:getActionGroup", args ?? new GetActionGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Get an action group.
        /// </summary>
        public static Output<GetActionGroupResult> Invoke(GetActionGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetActionGroupResult>("azure-native:insights/v20230901preview:getActionGroup", args ?? new GetActionGroupInvokeArgs(), options.WithDefaults());
    }
