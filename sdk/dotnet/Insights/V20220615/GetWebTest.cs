...
namespace Pulumi.AzureNative.Insights.V20220615
{
    public static class GetWebTest
    {
        ...
        public static Task<GetWebTestResult> InvokeAsync(GetWebTestArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebTestResult>("azure-native:insights/v20220615:getWebTest", args ?? new GetWebTestArgs(), options.WithDefaults());

        /// <summary>
        /// An Application Insights WebTest definition.
        /// </summary>
        public static Output<GetWebTestResult> Invoke(GetWebTestInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebTestResult>("azure-native:insights/v20220615:getWebTest", args ?? new GetWebTestInvokeArgs(), options.WithDefaults());
    }
