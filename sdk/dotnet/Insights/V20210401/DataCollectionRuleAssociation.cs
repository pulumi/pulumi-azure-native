...
namespace Pulumi.AzureNative.Insights.V20210401
{
    ...
    public partial class DataCollectionRuleAssociation : Pulumi.CustomResource
    {
        ...
        public DataCollectionRuleAssociation(string name, DataCollectionRuleAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210401:DataCollectionRuleAssociation", name, args ?? new DataCollectionRuleAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionRuleAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210401:DataCollectionRuleAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
