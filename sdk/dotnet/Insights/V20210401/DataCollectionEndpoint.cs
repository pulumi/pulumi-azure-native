...
namespace Pulumi.AzureNative.Insights.V20210401
{
    ...
    public partial class DataCollectionEndpoint : Pulumi.CustomResource
    {
        ...
        public DataCollectionEndpoint(string name, DataCollectionEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210401:DataCollectionEndpoint", name, args ?? new DataCollectionEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210401:DataCollectionEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataCollectionEndpointArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20210401.KnownDataCollectionEndpointResourceKind>? Kind { get; set; }
