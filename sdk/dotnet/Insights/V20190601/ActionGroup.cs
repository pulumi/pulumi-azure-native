...
namespace Pulumi.AzureNative.Insights.V20190601
{
    ...
    /// {
    ///     var actionGroup = new AzureNative.Insights.V20190601.ActionGroup("actionGroup", new()
    ///     {
    ///         ActionGroupName = "SampleActionGroup",
    ///         ArmRoleReceivers = new[]
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.ArmRoleReceiverArgs
    ///             {
    ///                 Name = "Sample armRole",
    ...
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.AutomationRunbookReceiverArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.AzureAppPushReceiverArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.AzureFunctionReceiverArgs
    ///             {
    ...
    ///         EmailReceivers = new[]
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.EmailReceiverArgs
    ///             {
    ///                 EmailAddress = "johndoe@email.com",
    ...
    ///         ItsmReceivers = new[]
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.ItsmReceiverArgs
    ///             {
    ...
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.LogicAppReceiverArgs
    ///             {
    ...
    ///         SmsReceivers = new[]
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.SmsReceiverArgs
    ///             {
    ///                 CountryCode = "1",
    ...
    ///         VoiceReceivers = new[]
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.VoiceReceiverArgs
    ///             {
    ///                 CountryCode = "1",
    ///                 Name = "Sample voice",
    ///                 PhoneNumber = "1234567890",
    ...
    ///         {
    ///             new AzureNative.Insights.V20190601.Inputs.WebhookReceiverArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20190601:ActionGroup")]
    public partial class ActionGroup : global::Pulumi.CustomResource
    {
        ...
        public ActionGroup(string name, ActionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20190601:ActionGroup", name, args ?? new ActionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20190601:ActionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
