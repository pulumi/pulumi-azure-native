...
namespace Pulumi.AzureRM.Insights.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var actionGroup = new AzureRM.Insights.V20190601.ActionGroup("actionGroup", new AzureRM.Insights.V20190601.ActionGroupArgs
    ///         {
    ///             ActionGroupName = "SampleActionGroup",
    ///             ArmRoleReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.ArmRoleReceiverArgs
    ///                 {
    ///                     Name = "Sample armRole",
    ...
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.AutomationRunbookReceiverArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.AzureAppPushReceiverArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.AzureFunctionReceiverArgs
    ///                 {
    ...
    ///             EmailReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.EmailReceiverArgs
    ///                 {
    ///                     EmailAddress = "johndoe@email.com",
    ...
    ///             ItsmReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.ItsmReceiverArgs
    ///                 {
    ...
    ///             LogicAppReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.LogicAppReceiverArgs
    ///                 {
    ...
    ///             SmsReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.SmsReceiverArgs
    ///                 {
    ///                     CountryCode = "1",
    ...
    ///             VoiceReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.VoiceReceiverArgs
    ///                 {
    ///                     CountryCode = "1",
    ///                     Name = "Sample voice",
    ///                     PhoneNumber = "1234567890",
    ...
    ///             WebhookReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190601.Inputs.WebhookReceiverArgs
    ///                 {
