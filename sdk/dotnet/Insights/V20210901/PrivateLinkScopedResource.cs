...
namespace Pulumi.AzureNative.Insights.V20210901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20210901:PrivateLinkScopedResource")]
    public partial class PrivateLinkScopedResource : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScopedResource(string name, PrivateLinkScopedResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901:PrivateLinkScopedResource", name, args ?? new PrivateLinkScopedResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScopedResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901:PrivateLinkScopedResource", name, null, MakeResourceOptions(options, id))
        {
        }
