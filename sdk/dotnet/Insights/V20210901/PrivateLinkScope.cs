...
namespace Pulumi.AzureNative.Insights.V20210901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20210901:PrivateLinkScope")]
    public partial class PrivateLinkScope : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScope(string name, PrivateLinkScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901:PrivateLinkScope", name, args ?? new PrivateLinkScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210901:PrivateLinkScope", name, null, MakeResourceOptions(options, id))
        {
        }
