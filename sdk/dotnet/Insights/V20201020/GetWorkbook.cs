...
namespace Pulumi.AzureNative.Insights.V20201020
{
    public static class GetWorkbook
    {
        ...
        public static Task<GetWorkbookResult> InvokeAsync(GetWorkbookArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkbookResult>("azure-native:insights/v20201020:getWorkbook", args ?? new GetWorkbookArgs(), options.WithDefaults());

        /// <summary>
        /// An Application Insights workbook definition.
        /// </summary>
        public static Output<GetWorkbookResult> Invoke(GetWorkbookInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWorkbookResult>("azure-native:insights/v20201020:getWorkbook", args ?? new GetWorkbookInvokeArgs(), options.WithDefaults());
    }
