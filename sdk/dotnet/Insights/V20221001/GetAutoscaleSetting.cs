...
namespace Pulumi.AzureNative.Insights.V20221001
{
    public static class GetAutoscaleSetting
    {
        ...
        public static Task<GetAutoscaleSettingResult> InvokeAsync(GetAutoscaleSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutoscaleSettingResult>("azure-native:insights/v20221001:getAutoscaleSetting", args ?? new GetAutoscaleSettingArgs(), options.WithDefaults());
