...
namespace Pulumi.AzureNative.Insights.V20200202
{
    ...
    /// {
    ///     var component = new AzureNative.Insights.V20200202.Component("component", new()
    ///     {
    ///         ApplicationType = "web",
    ///         FlowType = "Bluefield",
    ///         Kind = "web",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20200202:Component")]
    public partial class Component : global::Pulumi.CustomResource
    {
        ...
        public Component(string name, ComponentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20200202:Component", name, args ?? new ComponentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Component(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20200202:Component", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ComponentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Insights.V20200202.ApplicationType> ApplicationType { get; set; } = null!;
        ...
        /// </summary>
        [Input("flowType")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20200202.FlowType>? FlowType { get; set; }
        ...
        /// </summary>
        [Input("ingestionMode")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20200202.IngestionMode>? IngestionMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Insights.V20200202.PublicNetworkAccessType>? PublicNetworkAccessForIngestion { get; set; }

        /// <summary>
        /// The network access type for accessing Application Insights query.
        /// </summary>
        [Input("publicNetworkAccessForQuery")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20200202.PublicNetworkAccessType>? PublicNetworkAccessForQuery { get; set; }

        /// <summary>
        /// Describes what tool created this Application Insights component. Customers using this API should set this to the default 'rest'.
        /// </summary>
        [Input("requestSource")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20200202.RequestSource>? RequestSource { get; set; }
