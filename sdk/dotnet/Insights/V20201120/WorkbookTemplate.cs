...
namespace Pulumi.AzureNative.Insights.V20201120
{
    ...
    /// {
    ///     var workbookTemplate = new AzureNative.Insights.V20201120.WorkbookTemplate("workbookTemplate", new()
    ///     {
    ///         Author = "Contoso",
    ///         Galleries = new[]
    ///         {
    ///             new AzureNative.Insights.V20201120.Inputs.WorkbookTemplateGalleryArgs
    ///             {
    ///                 Category = "Failures",
    ...
    public partial class WorkbookTemplate : global::Pulumi.CustomResource
    {
        ...
        public WorkbookTemplate(string name, WorkbookTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20201120:WorkbookTemplate", name, args ?? new WorkbookTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkbookTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20201120:WorkbookTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
