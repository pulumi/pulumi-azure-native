...
namespace Pulumi.AzureNative.Insights.V20220401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20220401:ActionGroup")]
    public partial class ActionGroup : global::Pulumi.CustomResource
    {
        ...
        public ActionGroup(string name, ActionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20220401:ActionGroup", name, args ?? new ActionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20220401:ActionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
