...
namespace Pulumi.AzureRM.Insights.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var actionGroup = new AzureRM.Insights.V20190301.ActionGroup("actionGroup", new AzureRM.Insights.V20190301.ActionGroupArgs
    ///         {
    ///             ActionGroupName = "SampleActionGroup",
    ///             ArmRoleReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.ArmRoleReceiverArgs
    ///                 {
    ///                     Name = "Sample armRole",
    ...
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.AutomationRunbookReceiverArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.AzureAppPushReceiverArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.AzureFunctionReceiverArgs
    ///                 {
    ...
    ///             EmailReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.EmailReceiverArgs
    ///                 {
    ///                     EmailAddress = "johndoe@email.com",
    ...
    ///             ItsmReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.ItsmReceiverArgs
    ///                 {
    ...
    ///             LogicAppReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.LogicAppReceiverArgs
    ///                 {
    ...
    ///             SmsReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.SmsReceiverArgs
    ///                 {
    ///                     CountryCode = "1",
    ...
    ///             VoiceReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.VoiceReceiverArgs
    ///                 {
    ///                     CountryCode = "1",
    ///                     Name = "Sample voice",
    ///                     PhoneNumber = "1234567890",
    ...
    ///             WebhookReceivers = 
    ///             {
    ///                 new AzureRM.Insights.V20190301.Inputs.WebhookReceiverArgs
    ///                 {
    ///                     Name = "Sample webhook",
