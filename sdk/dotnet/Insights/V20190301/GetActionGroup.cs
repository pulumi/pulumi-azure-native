...
namespace Pulumi.AzureNative.Insights.V20190301
{
    public static class GetActionGroup
    {
        ...
        public static Task<GetActionGroupResult> InvokeAsync(GetActionGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetActionGroupResult>("azure-native:insights/v20190301:getActionGroup", args ?? new GetActionGroupArgs(), options.WithVersion());

        /// <summary>
        /// An action group resource.
        /// </summary>
        public static Output<GetActionGroupResult> Invoke(GetActionGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetActionGroupResult>("azure-native:insights/v20190301:getActionGroup", args ?? new GetActionGroupInvokeArgs(), options.WithVersion());
    }
