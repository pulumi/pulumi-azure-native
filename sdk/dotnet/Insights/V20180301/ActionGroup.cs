...
namespace Pulumi.AzureNextGen.Insights.V20180301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:insights/v20180301:ActionGroup")]
    public partial class ActionGroup : Pulumi.CustomResource
    {
        ...
        public ActionGroup(string name, ActionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:insights/v20180301:ActionGroup", name, args ?? new ActionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:insights/v20180301:ActionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
