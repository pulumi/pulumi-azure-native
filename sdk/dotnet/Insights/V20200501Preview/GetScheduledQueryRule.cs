...
namespace Pulumi.AzureNative.Insights.V20200501Preview
{
    public static class GetScheduledQueryRule
    {
        ...
        public static Task<GetScheduledQueryRuleResult> InvokeAsync(GetScheduledQueryRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScheduledQueryRuleResult>("azure-native:insights/v20200501preview:getScheduledQueryRule", args ?? new GetScheduledQueryRuleArgs(), options.WithDefaults());

        /// <summary>
        /// The scheduled query rule resource.
        /// </summary>
        public static Output<GetScheduledQueryRuleResult> Invoke(GetScheduledQueryRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScheduledQueryRuleResult>("azure-native:insights/v20200501preview:getScheduledQueryRule", args ?? new GetScheduledQueryRuleInvokeArgs(), options.WithDefaults());
    }
