...
namespace Pulumi.AzureNative.Insights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights:TenantActionGroup")]
    public partial class TenantActionGroup : global::Pulumi.CustomResource
    {
        ...
        public TenantActionGroup(string name, TenantActionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights:TenantActionGroup", name, args ?? new TenantActionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TenantActionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights:TenantActionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
