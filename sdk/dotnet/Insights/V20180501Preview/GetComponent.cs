...
namespace Pulumi.AzureRM.Insights.V20180501Preview
{
    public static class GetComponent
    {
        public static Task<GetComponentResult> InvokeAsync(GetComponentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComponentResult>("azurerm:insights/v20180501preview:getComponent", args ?? new GetComponentArgs(), options.WithVersion());
    }
