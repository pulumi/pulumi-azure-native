...
namespace Pulumi.AzureNative.Insights.V20180501Preview
{
    ...
    public static class GetComponent
    {
        ...
        public static Task<GetComponentResult> InvokeAsync(GetComponentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetComponentResult>("azure-native:insights/v20180501preview:getComponent", args ?? new GetComponentArgs(), options.WithDefaults());

        /// <summary>
        /// Returns an Application Insights component.
        /// </summary>
        public static Output<GetComponentResult> Invoke(GetComponentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetComponentResult>("azure-native:insights/v20180501preview:getComponent", args ?? new GetComponentInvokeArgs(), options.WithDefaults());
    }
