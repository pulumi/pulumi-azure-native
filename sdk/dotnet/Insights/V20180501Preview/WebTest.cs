...
namespace Pulumi.AzureNative.Insights.V20180501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:insights/v20180501preview:WebTest is being removed in the next major version of this provider. Upgrade to at least azure-native:insights/v20201005preview:WebTest to guarantee forwards compatibility.")]
    ...
    public partial class WebTest : global::Pulumi.CustomResource
    {
        ...
        public WebTest(string name, WebTestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20180501preview:WebTest", name, args ?? new WebTestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebTest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20180501preview:WebTest", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebTestArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public Input<Pulumi.AzureNative.Insights.V20180501Preview.WebTestKind>? Kind { get; set; }
        ...
        public Input<Pulumi.AzureNative.Insights.V20180501Preview.WebTestKindEnum> WebTestKind { get; set; } = null!;
        ...
        {
            Frequency = 300;
            Kind = Pulumi.AzureNative.Insights.V20180501Preview.WebTestKind.Ping;
            Timeout = 30;
            WebTestKind = Pulumi.AzureNative.Insights.V20180501Preview.WebTestKindEnum.Ping;
        }
