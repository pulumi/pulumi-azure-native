...
namespace Pulumi.AzureRM.Insights.V20170501Preview
{
    ...
    public partial class SubscriptionDiagnosticSetting : Pulumi.CustomResource
    {
        ...
        public SubscriptionDiagnosticSetting(string name, SubscriptionDiagnosticSettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20170501preview:SubscriptionDiagnosticSetting", name, args ?? new SubscriptionDiagnosticSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionDiagnosticSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20170501preview:SubscriptionDiagnosticSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:insights/preview:SubscriptionDiagnosticSetting"},
                },
            };
