...
namespace Pulumi.AzureNative.Insights.Inputs
{
    ...
    public sealed class DynamicMetricCriteriaArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Insights.DynamicThresholdSensitivity> AlertSensitivity { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Insights.DynamicThresholdOperator> Operator { get; set; } = null!;
