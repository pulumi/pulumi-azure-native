...
namespace Pulumi.AzureNextGen.Insights.Inputs
{
    ...
    public sealed class DynamicMetricCriteriaArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Insights.DynamicThresholdSensitivity> AlertSensitivity { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Insights.DynamicThresholdOperator> Operator { get; set; } = null!;
