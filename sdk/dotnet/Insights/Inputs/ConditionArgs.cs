...
namespace Pulumi.AzureNative.Insights.Inputs
{
    ...
    public sealed class ConditionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operator")]
        public InputUnion<string, Pulumi.AzureNative.Insights.ConditionOperator>? Operator { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Insights.TimeAggregation>? TimeAggregation { get; set; }
