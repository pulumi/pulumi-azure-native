...
namespace Pulumi.AzureNative.Insights.V20220801Preview
{
    ...
    /// {
    ///     var scheduledQueryRule = new AzureNative.Insights.V20220801Preview.ScheduledQueryRule("scheduledQueryRule", new()
    ///     {
    ///         Actions = new AzureNative.Insights.V20220801Preview.Inputs.ActionsArgs
    ///         {
    ///             ActionGroups = new[]
    ///             {
    ...
    ///         Criteria = new AzureNative.Insights.V20220801Preview.Inputs.ScheduledQueryRuleCriteriaArgs
    ///         {
    ///             AllOf = new[]
    ///             {
    ///                 new AzureNative.Insights.V20220801Preview.Inputs.ConditionArgs
    ///                 {
    ///                     Dimensions = new[]
    ///                     {
    ///                         new AzureNative.Insights.V20220801Preview.Inputs.DimensionArgs
    ///                         {
    ///                             Name = "ComputerIp",
    ///                             Operator = "Exclude",
    ///                             Values = new[]
    ...
    ///                         },
    ///                     },
    ///                     FailingPeriods = new AzureNative.Insights.V20220801Preview.Inputs.ConditionFailingPeriodsArgs
    ///                     {
    ...
    ///         RuleName = "perf",
    ///         RuleResolveConfiguration = new AzureNative.Insights.V20220801Preview.Inputs.RuleResolveConfigurationArgs
    ///         {
    ///             AutoResolved = true,
    ///             TimeToResolve = "PT10M",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20220801preview:ScheduledQueryRule")]
    public partial class ScheduledQueryRule : global::Pulumi.CustomResource
    {
        ...
        public ScheduledQueryRule(string name, ScheduledQueryRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20220801preview:ScheduledQueryRule", name, args ?? new ScheduledQueryRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledQueryRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20220801preview:ScheduledQueryRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledQueryRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20220801Preview.Kind>? Kind { get; set; }
