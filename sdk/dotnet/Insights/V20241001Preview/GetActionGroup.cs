...
namespace Pulumi.AzureNative.Insights.V20241001Preview
{
    public static class GetActionGroup
    {
        ...
        public static Task<GetActionGroupResult> InvokeAsync(GetActionGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActionGroupResult>("azure-native:insights/v20241001preview:getActionGroup", args ?? new GetActionGroupArgs(), options.WithDefaults());
