...
namespace Pulumi.AzureNative.Insights.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20241001preview:ActionGroup")]
    public partial class ActionGroup : global::Pulumi.CustomResource
    {
        ...
        public ActionGroup(string name, ActionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20241001preview:ActionGroup", name, args ?? new ActionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20241001preview:ActionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
