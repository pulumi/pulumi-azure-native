...
namespace Pulumi.AzureRM.Insights.V20180617Preview
{
    ...
    public partial class Workbook : Pulumi.CustomResource
    {
        ...
        public Workbook(string name, WorkbookArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20180617preview:Workbook", name, args ?? new WorkbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20180617preview:Workbook", name, null, MakeResourceOptions(options, id))
        {
        }
