...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateLinkScope = new AzureRM.Insights.Latest.PrivateLinkScope("privateLinkScope", new AzureRM.Insights.Latest.PrivateLinkScopeArgs
    ///         {
    ///             Location = "Global",
    ...
    public partial class PrivateLinkScope : Pulumi.CustomResource
    {
        ...
        public PrivateLinkScope(string name, PrivateLinkScopeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:PrivateLinkScope", name, args ?? new PrivateLinkScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:PrivateLinkScope", name, null, MakeResourceOptions(options, id))
        {
        }
