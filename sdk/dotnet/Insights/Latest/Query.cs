...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var query = new AzureRM.Insights.Latest.Query("query", new AzureRM.Insights.Latest.QueryArgs
    ///         {
    ...
    ///             Related = new AzureRM.Insights.Latest.Inputs.LogAnalyticsQueryPackQueryPropertiesRelatedArgs
    ///             {
    ///                 Categories = 
    ///                 {
    ///                     "analytics",
    ...
    public partial class Query : Pulumi.CustomResource
    {
        ...
        public Query(string name, QueryArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:Query", name, args ?? new QueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Query(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:Query", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:insights/v20190901preview:Query"},
                },
            };
