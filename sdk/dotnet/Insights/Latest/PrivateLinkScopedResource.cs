...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateLinkScopedResource = new AzureRM.Insights.Latest.PrivateLinkScopedResource("privateLinkScopedResource", new AzureRM.Insights.Latest.PrivateLinkScopedResourceArgs
    ///         {
    ...
    public partial class PrivateLinkScopedResource : Pulumi.CustomResource
    {
        ...
        public PrivateLinkScopedResource(string name, PrivateLinkScopedResourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:PrivateLinkScopedResource", name, args ?? new PrivateLinkScopedResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScopedResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:PrivateLinkScopedResource", name, null, MakeResourceOptions(options, id))
        {
        }
