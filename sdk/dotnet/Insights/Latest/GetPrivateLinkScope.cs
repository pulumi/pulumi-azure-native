...
namespace Pulumi.AzureRM.Insights.Latest
{
    public static class GetPrivateLinkScope
    {
        public static Task<GetPrivateLinkScopeResult> InvokeAsync(GetPrivateLinkScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkScopeResult>("azurerm:insights/latest:getPrivateLinkScope", args ?? new GetPrivateLinkScopeArgs(), options.WithVersion());
    }
