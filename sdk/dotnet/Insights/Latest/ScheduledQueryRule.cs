...
namespace Pulumi.AzureNative.Insights.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:insights:ScheduledQueryRule'.")]
    [AzureNativeResourceType("azure-native:insights/latest:ScheduledQueryRule")]
    public partial class ScheduledQueryRule : Pulumi.CustomResource
    {
        ...
        public ScheduledQueryRule(string name, ScheduledQueryRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/latest:ScheduledQueryRule", name, args ?? new ScheduledQueryRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledQueryRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/latest:ScheduledQueryRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledQueryRuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabled")]
        public InputUnion<string, Pulumi.AzureNative.Insights.Latest.Enabled>? Enabled { get; set; }
