...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getWorkbook'.")]
    public static class GetWorkbook
    {
        ...
        public static Task<GetWorkbookResult> InvokeAsync(GetWorkbookArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkbookResult>("azure-native:insights/latest:getWorkbook", args ?? new GetWorkbookArgs(), options.WithVersion());
    }
