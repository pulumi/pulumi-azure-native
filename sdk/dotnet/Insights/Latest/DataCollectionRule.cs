...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dataCollectionRule = new AzureRM.Insights.Latest.DataCollectionRule("dataCollectionRule", new AzureRM.Insights.Latest.DataCollectionRuleArgs
    ///         {
    ///             DataCollectionRuleName = "myCollectionRule",
    ///             DataFlows = 
    ///             {
    ///                 new AzureRM.Insights.Latest.Inputs.DataFlowArgs
    ///                 {
    ///                     Destinations = 
    ///                     {
    ///                         "centralWorkspace",
    ...
    ///                 },
    ///             },
    ///             DataSources = new AzureRM.Insights.Latest.Inputs.DataCollectionRuleDataSourcesArgs
    ///             {
    ///                 PerformanceCounters = 
    ///                 {
    ///                     new AzureRM.Insights.Latest.Inputs.PerfCounterDataSourceArgs
    ///                     {
    ///                         CounterSpecifiers = 
    ///                         {
    ...
    ///                 Syslog = 
    ///                 {
    ///                     new AzureRM.Insights.Latest.Inputs.SyslogDataSourceArgs
    ///                     {
    ///                         FacilityNames = 
    ///                         {
    ///                             "cron",
    ...
    ///                 WindowsEventLogs = 
    ///                 {
    ///                     new AzureRM.Insights.Latest.Inputs.WindowsEventLogDataSourceArgs
    ///                     {
    ...
    ///                 },
    ///             },
    ///             Destinations = new AzureRM.Insights.Latest.Inputs.DataCollectionRuleDestinationsArgs
    ///             {
    ///                 LogAnalytics = 
    ///                 {
    ///                     new AzureRM.Insights.Latest.Inputs.LogAnalyticsDestinationArgs
    ///                     {
    ...
    public partial class DataCollectionRule : Pulumi.CustomResource
    {
        ...
        public DataCollectionRule(string name, DataCollectionRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:DataCollectionRule", name, args ?? new DataCollectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:DataCollectionRule", name, null, MakeResourceOptions(options, id))
        {
        }
