...
namespace Pulumi.AzureRM.Insights.Latest
{
    public static class GetDataCollectionRule
    {
        public static Task<GetDataCollectionRuleResult> InvokeAsync(GetDataCollectionRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataCollectionRuleResult>("azurerm:insights/latest:getDataCollectionRule", args ?? new GetDataCollectionRuleArgs(), options.WithVersion());
    }
