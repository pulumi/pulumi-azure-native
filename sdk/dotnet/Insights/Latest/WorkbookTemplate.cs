...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workbookTemplate = new AzureRM.Insights.Latest.WorkbookTemplate("workbookTemplate", new AzureRM.Insights.Latest.WorkbookTemplateArgs
    ///         {
    ///             Author = "Contoso",
    ///             Galleries = 
    ///             {
    ///                 new AzureRM.Insights.Latest.Inputs.WorkbookTemplateGalleryArgs
    ///                 {
    ///                     Category = "Failures",
    ...
    public partial class WorkbookTemplate : Pulumi.CustomResource
    {
        ...
        public WorkbookTemplate(string name, WorkbookTemplateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:WorkbookTemplate", name, args ?? new WorkbookTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkbookTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:WorkbookTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
