...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var componentLinkedStorageAccount = new AzureRM.Insights.Latest.ComponentLinkedStorageAccount("componentLinkedStorageAccount", new AzureRM.Insights.Latest.ComponentLinkedStorageAccountArgs
    ///         {
    ...
    public partial class ComponentLinkedStorageAccount : Pulumi.CustomResource
    {
        ...
        public ComponentLinkedStorageAccount(string name, ComponentLinkedStorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:ComponentLinkedStorageAccount", name, args ?? new ComponentLinkedStorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentLinkedStorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:ComponentLinkedStorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:insights/v20200301preview:ComponentLinkedStorageAccount"},
                },
            };
