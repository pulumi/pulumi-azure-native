...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var queryPack = new AzureRM.Insights.Latest.QueryPack("queryPack", new AzureRM.Insights.Latest.QueryPackArgs
    ///         {
    ...
    public partial class QueryPack : Pulumi.CustomResource
    {
        ...
        public QueryPack(string name, QueryPackArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:QueryPack", name, args ?? new QueryPackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueryPack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:QueryPack", name, null, MakeResourceOptions(options, id))
        {
        }
