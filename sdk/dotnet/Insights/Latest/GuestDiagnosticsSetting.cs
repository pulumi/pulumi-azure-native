...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var guestDiagnosticsSetting = new AzureRM.Insights.Latest.GuestDiagnosticsSetting("guestDiagnosticsSetting", new AzureRM.Insights.Latest.GuestDiagnosticsSettingArgs
    ///         {
    ///             DataSources = 
    ///             {
    ///                 new AzureRM.Insights.Latest.Inputs.DataSourceArgs
    ///                 {
    ///                     Configuration = new AzureRM.Insights.Latest.Inputs.DataSourceConfigurationArgs
    ///                     {
    ///                         PerfCounters = 
    ///                         {
    ///                             new AzureRM.Insights.Latest.Inputs.PerformanceCounterConfigurationArgs
    ///                             {
    ...
    ///                     Sinks = 
    ///                     {
    ///                         new AzureRM.Insights.Latest.Inputs.SinkConfigurationArgs
    ///                         {
    ///                             Kind = "LogAnalytics",
    ///                         },
    ///                     },
    ...
    ///                         Providers = 
    ///                         {
    ///                             new AzureRM.Insights.Latest.Inputs.EtwProviderConfigurationArgs
    ///                             {
    ///                                 Id = "1",
    ///                             },
    ///                             new AzureRM.Insights.Latest.Inputs.EtwProviderConfigurationArgs
    ...
    ///                         EventLogs = 
    ///                         {
    ///                             new AzureRM.Insights.Latest.Inputs.EventLogConfigurationArgs
    ///                             {
    ...
    public partial class GuestDiagnosticsSetting : Pulumi.CustomResource
    {
        ...
        public GuestDiagnosticsSetting(string name, GuestDiagnosticsSettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:guestDiagnosticsSetting", name, args ?? new GuestDiagnosticsSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestDiagnosticsSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:guestDiagnosticsSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:insights/v20180601preview:guestDiagnosticsSetting"},
                },
            };
