...
namespace Pulumi.AzureNative.Insights.Latest.Inputs
{
    ...
    public sealed class MetricTriggerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Insights.Latest.ComparisonOperationType> Operator { get; set; } = null!;

        /// <summary>
        /// the metric statistic type. How the metrics from multiple instances are combined.
        /// </summary>
        [Input("statistic", required: true)]
        public Input<Pulumi.AzureNative.Insights.Latest.MetricStatisticType> Statistic { get; set; } = null!;
        ...
        public Input<Pulumi.AzureNative.Insights.Latest.TimeAggregationType> TimeAggregation { get; set; } = null!;
