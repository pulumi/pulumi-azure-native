...
namespace Pulumi.AzureNative.Insights.Latest.Inputs
{
    ...
    public sealed class ScaleActionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Insights.Latest.ScaleDirection> Direction { get; set; } = null!;

        /// <summary>
        /// the type of action that should occur when the scale rule fires.
        /// </summary>
        [Input("type", required: true)]
        public Input<Pulumi.AzureNative.Insights.Latest.ScaleType> Type { get; set; } = null!;
