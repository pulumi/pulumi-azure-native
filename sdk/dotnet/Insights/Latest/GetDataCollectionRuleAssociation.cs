...
namespace Pulumi.AzureRM.Insights.Latest
{
    public static class GetDataCollectionRuleAssociation
    {
        public static Task<GetDataCollectionRuleAssociationResult> InvokeAsync(GetDataCollectionRuleAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataCollectionRuleAssociationResult>("azurerm:insights/latest:getDataCollectionRuleAssociation", args ?? new GetDataCollectionRuleAssociationArgs(), options.WithVersion());
    }
