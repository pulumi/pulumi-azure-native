...
namespace Pulumi.AzureNative.Insights.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:insights:ProactiveDetectionConfiguration'.")]
    [AzureNativeResourceType("azure-native:insights/latest:ProactiveDetectionConfiguration")]
    public partial class ProactiveDetectionConfiguration : Pulumi.CustomResource
    {
        ...
        public ProactiveDetectionConfiguration(string name, ProactiveDetectionConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/latest:ProactiveDetectionConfiguration", name, args ?? new ProactiveDetectionConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProactiveDetectionConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/latest:ProactiveDetectionConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
