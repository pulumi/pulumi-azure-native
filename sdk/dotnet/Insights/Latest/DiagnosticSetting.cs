...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var diagnosticSetting = new AzureRM.Insights.Latest.DiagnosticSetting("diagnosticSetting", new AzureRM.Insights.Latest.DiagnosticSettingArgs
    ///         {
    ...
    ///             Logs = 
    ///             {
    ///                 new AzureRM.Insights.Latest.Inputs.LogSettingsArgs
    ///                 {
    ...
    ///             Metrics = 
    ///             {
    ///                 new AzureRM.Insights.Latest.Inputs.MetricSettingsArgs
    ///                 {
    ...
    public partial class DiagnosticSetting : Pulumi.CustomResource
    {
        ...
        public DiagnosticSetting(string name, DiagnosticSettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:DiagnosticSetting", name, args ?? new DiagnosticSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiagnosticSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:DiagnosticSetting", name, null, MakeResourceOptions(options, id))
        {
        }
