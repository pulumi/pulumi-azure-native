...
namespace Pulumi.AzureRM.Insights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.Insights.Latest.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.Insights.Latest.PrivateEndpointConnectionArgs
    ///         {
    ///             PrivateEndpointConnectionName = "private-endpoint-connection-name",
    ///             PrivateLinkServiceConnectionState = new AzureRM.Insights.Latest.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/latest:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
