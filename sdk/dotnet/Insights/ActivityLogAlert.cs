...
namespace Pulumi.AzureNextGen.Insights
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:insights:ActivityLogAlert")]
    public partial class ActivityLogAlert : Pulumi.CustomResource
    {
        ...
        public ActivityLogAlert(string name, ActivityLogAlertArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:insights:ActivityLogAlert", name, args ?? new ActivityLogAlertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActivityLogAlert(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:insights:ActivityLogAlert", name, null, MakeResourceOptions(options, id))
        {
        }
