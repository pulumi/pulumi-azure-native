...
namespace Pulumi.AzureNative.Insights.V20230311
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20230311:DataCollectionRule")]
    public partial class DataCollectionRule : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionRule(string name, DataCollectionRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230311:DataCollectionRule", name, args ?? new DataCollectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230311:DataCollectionRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataCollectionRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20230311.KnownDataCollectionRuleResourceKind>? Kind { get; set; }
