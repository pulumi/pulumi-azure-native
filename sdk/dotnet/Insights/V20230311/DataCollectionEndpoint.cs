...
namespace Pulumi.AzureNative.Insights.V20230311
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20230311:DataCollectionEndpoint")]
    public partial class DataCollectionEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionEndpoint(string name, DataCollectionEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230311:DataCollectionEndpoint", name, args ?? new DataCollectionEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230311:DataCollectionEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataCollectionEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20230311.KnownDataCollectionEndpointResourceKind>? Kind { get; set; }
