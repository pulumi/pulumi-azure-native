...
namespace Pulumi.AzureNative.Insights.V20230311
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20230311:DataCollectionRuleAssociation")]
    public partial class DataCollectionRuleAssociation : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionRuleAssociation(string name, DataCollectionRuleAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230311:DataCollectionRuleAssociation", name, args ?? new DataCollectionRuleAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionRuleAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230311:DataCollectionRuleAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
