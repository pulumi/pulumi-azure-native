...
namespace Pulumi.AzureNative.Insights.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20230601preview:PrivateLinkScope")]
    public partial class PrivateLinkScope : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScope(string name, PrivateLinkScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230601preview:PrivateLinkScope", name, args ?? new PrivateLinkScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230601preview:PrivateLinkScope", name, null, MakeResourceOptions(options, id))
        {
        }
