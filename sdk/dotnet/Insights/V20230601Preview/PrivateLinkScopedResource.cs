...
namespace Pulumi.AzureNative.Insights.V20230601Preview
{
    /// <summary>
    /// A private link scoped resource
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20230601preview:PrivateLinkScopedResource")]
    public partial class PrivateLinkScopedResource : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScopedResource(string name, PrivateLinkScopedResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230601preview:PrivateLinkScopedResource", name, args ?? new PrivateLinkScopedResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScopedResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20230601preview:PrivateLinkScopedResource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateLinkScopedResourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Insights.V20230601Preview.ScopedResourceKind>? Kind { get; set; }
