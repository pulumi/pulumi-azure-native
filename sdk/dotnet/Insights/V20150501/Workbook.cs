...
namespace Pulumi.AzureRM.Insights.V20150501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workbook = new AzureRM.Insights.V20150501.Workbook("workbook", new AzureRM.Insights.V20150501.WorkbookArgs
    ///         {
    ///             Category = "workbook",
    ///             Location = "west us",
    ...
    public partial class Workbook : Pulumi.CustomResource
    {
        ...
        public Workbook(string name, WorkbookArgs args, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20150501:Workbook", name, args ?? new WorkbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:insights/v20150501:Workbook", name, null, MakeResourceOptions(options, id))
        {
        }
