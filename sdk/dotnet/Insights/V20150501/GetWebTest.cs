...
namespace Pulumi.AzureNative.Insights.V20150501
{
    public static class GetWebTest
    {
        ...
        public static Task<GetWebTestResult> InvokeAsync(GetWebTestArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebTestResult>("azure-native:insights/v20150501:getWebTest", args ?? new GetWebTestArgs(), options.WithDefaults());

        /// <summary>
        /// Get a specific Application Insights web test definition.
        /// </summary>
        public static Output<GetWebTestResult> Invoke(GetWebTestInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebTestResult>("azure-native:insights/v20150501:getWebTest", args ?? new GetWebTestInvokeArgs(), options.WithDefaults());
