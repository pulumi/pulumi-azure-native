...
namespace Pulumi.AzureNative.Insights.V20191101Preview
{
    ...
    /// {
    ///     var dataCollectionRule = new AzureNative.Insights.V20191101Preview.DataCollectionRule("dataCollectionRule", new()
    ///     {
    ///         DataCollectionRuleName = "myCollectionRule",
    ///         DataFlows = new[]
    ///         {
    ///             new AzureNative.Insights.V20191101Preview.Inputs.DataFlowArgs
    ///             {
    ///                 Destinations = new[]
    ///                 {
    ///                     "centralWorkspace",
    ...
    ///             },
    ///         },
    ///         DataSources = new AzureNative.Insights.V20191101Preview.Inputs.DataCollectionRuleDataSourcesArgs
    ///         {
    ///             PerformanceCounters = new[]
    ///             {
    ///                 new AzureNative.Insights.V20191101Preview.Inputs.PerfCounterDataSourceArgs
    ///                 {
    ...
    ///             Syslog = new[]
    ///             {
    ///                 new AzureNative.Insights.V20191101Preview.Inputs.SyslogDataSourceArgs
    ///                 {
    ///                     FacilityNames = new[]
    ///                     {
    ///                         "cron",
    ...
    ///             {
    ///                 new AzureNative.Insights.V20191101Preview.Inputs.WindowsEventLogDataSourceArgs
    ///                 {
    ...
    ///             },
    ///         },
    ///         Destinations = new AzureNative.Insights.V20191101Preview.Inputs.DataCollectionRuleDestinationsArgs
    ///         {
    ///             LogAnalytics = new[]
    ///             {
    ///                 new AzureNative.Insights.V20191101Preview.Inputs.LogAnalyticsDestinationArgs
    ///                 {
    ...
    public partial class DataCollectionRule : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionRule(string name, DataCollectionRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20191101preview:DataCollectionRule", name, args ?? new DataCollectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20191101preview:DataCollectionRule", name, null, MakeResourceOptions(options, id))
        {
        }
