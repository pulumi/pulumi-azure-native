...
namespace Pulumi.AzureRM.Insights.V20191101Preview
{
    public static class GetDataCollectionRuleAssociation
    {
        public static Task<GetDataCollectionRuleAssociationResult> InvokeAsync(GetDataCollectionRuleAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataCollectionRuleAssociationResult>("azurerm:insights/v20191101preview:getDataCollectionRuleAssociation", args ?? new GetDataCollectionRuleAssociationArgs(), options.WithVersion());
    }
