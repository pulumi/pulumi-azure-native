...
namespace Pulumi.AzureNative.Insights.V20210801
{
    ...
    /// {
    ///     var workbook = new AzureNative.Insights.V20210801.Workbook("workbook", new()
    ///     {
    ///         Category = "workbook",
    ...
    ///         Description = "Sample workbook",
    ///         DisplayName = "Sample workbook",
    ///         Identity = new AzureNative.Insights.V20210801.Inputs.WorkbookResourceIdentityArgs
    ///         {
    ///             Type = "UserAssigned",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:insights/v20210801:Workbook")]
    public partial class Workbook : global::Pulumi.CustomResource
    {
        ...
        public Workbook(string name, WorkbookArgs args, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210801:Workbook", name, args ?? new WorkbookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workbook(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:insights/v20210801:Workbook", name, null, MakeResourceOptions(options, id))
        {
        }
