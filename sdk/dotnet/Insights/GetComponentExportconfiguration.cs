...
{
    public static class GetComponentExportconfiguration
    {
        public static Task<GetComponentExportconfigurationResult> InvokeAsync(GetComponentExportconfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComponentExportconfigurationResult>("azurerm:insights:getComponentExportconfiguration", args ?? new GetComponentExportconfigurationArgs(), options.WithVersion());
    }


    public sealed class GetComponentExportconfigurationArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetComponentExportconfigurationArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetComponentExportconfigurationResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetComponentExportconfigurationResult(
