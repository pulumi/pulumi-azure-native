...
namespace Pulumi.AzureNative.Insights.V20230101Preview
{
    public static class GetActivityLogAlert
    {
        ...
        public static Task<GetActivityLogAlertResult> InvokeAsync(GetActivityLogAlertArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActivityLogAlertResult>("azure-native:insights/v20230101preview:getActivityLogAlert", args ?? new GetActivityLogAlertArgs(), options.WithDefaults());

        /// <summary>
        /// Get an Activity Log Alert rule.
        /// </summary>
        public static Output<GetActivityLogAlertResult> Invoke(GetActivityLogAlertInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetActivityLogAlertResult>("azure-native:insights/v20230101preview:getActivityLogAlert", args ?? new GetActivityLogAlertInvokeArgs(), options.WithDefaults());
    }
