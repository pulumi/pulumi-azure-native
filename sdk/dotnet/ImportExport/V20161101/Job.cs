...
namespace Pulumi.AzureNative.ImportExport.V20161101
{
    ...
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:importexport/v20161101:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:importexport/v20161101:Job", name, null, MakeResourceOptions(options, id))
        {
        }
