...
namespace Pulumi.AzureRM.ImportExport.Preview
{
    public static class ListBitLockerKey
    {
        public static Task<ListBitLockerKeyResult> InvokeAsync(ListBitLockerKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListBitLockerKeyResult>("azurerm:importexport/preview:listBitLockerKey", args ?? new ListBitLockerKeyArgs(), options.WithVersion());
    }
