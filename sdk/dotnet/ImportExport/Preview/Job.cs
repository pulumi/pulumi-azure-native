...
namespace Pulumi.AzureRM.ImportExport.Preview
{
    ...
    public partial class Job : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("identity")]
        public Output<Outputs.IdentityDetailsResponseResult?> Identity { get; private set; } = null!;
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azurerm:importexport/preview:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:importexport/preview:Job", name, null, MakeResourceOptions(options, id))
        {
        }
