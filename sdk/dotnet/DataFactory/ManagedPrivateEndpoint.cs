...
namespace Pulumi.AzureNextGen.DataFactory
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datafactory:ManagedPrivateEndpoint")]
    public partial class ManagedPrivateEndpoint : Pulumi.CustomResource
    {
        ...
        public ManagedPrivateEndpoint(string name, ManagedPrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datafactory:ManagedPrivateEndpoint", name, args ?? new ManagedPrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedPrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datafactory:ManagedPrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
