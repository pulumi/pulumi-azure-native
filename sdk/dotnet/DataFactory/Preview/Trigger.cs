...
namespace Pulumi.AzureRM.DataFactory.Preview
{
    ...
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Union<Outputs.ChainingTriggerResponseResult, Union<Outputs.MultiplePipelineTriggerResponseResult, Union<Outputs.RerunTumblingWindowTriggerResponseResult, Outputs.TumblingWindowTriggerResponseResult>>>> Properties { get; private set; } = null!;
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/preview:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/preview:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
