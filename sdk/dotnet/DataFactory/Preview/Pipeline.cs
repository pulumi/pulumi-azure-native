...
namespace Pulumi.AzureRM.DataFactory.Preview
{
    ...
    public partial class Pipeline : Pulumi.CustomResource
    {
        ...
        public Pipeline(string name, PipelineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/preview:Pipeline", name, args ?? new PipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/preview:Pipeline", name, null, MakeResourceOptions(options, id))
        {
        }
