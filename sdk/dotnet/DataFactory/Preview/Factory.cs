...
namespace Pulumi.AzureRM.DataFactory.Preview
{
    ...
    public partial class Factory : Pulumi.CustomResource
    {
        ...
        public Factory(string name, FactoryArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/preview:Factory", name, args ?? new FactoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Factory(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/preview:Factory", name, null, MakeResourceOptions(options, id))
        {
        }
