...
namespace Pulumi.AzureRM.DataFactory.Preview
{
    ...
    public partial class Dataset : Pulumi.CustomResource
    {
        ...
        public Dataset(string name, DatasetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/preview:Dataset", name, args ?? new DatasetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dataset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/preview:Dataset", name, null, MakeResourceOptions(options, id))
        {
        }
