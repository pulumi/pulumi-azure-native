...
namespace Pulumi.AzureNextGen.DataFactory
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datafactory:Trigger")]
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datafactory:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datafactory:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
