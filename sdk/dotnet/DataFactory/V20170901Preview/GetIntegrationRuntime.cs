...
namespace Pulumi.AzureRM.DataFactory.V20170901Preview
{
    public static class GetIntegrationRuntime
    {
        public static Task<GetIntegrationRuntimeResult> InvokeAsync(GetIntegrationRuntimeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIntegrationRuntimeResult>("azurerm:datafactory/v20170901preview:getIntegrationRuntime", args ?? new GetIntegrationRuntimeArgs(), options.WithVersion());
    }
