...
namespace Pulumi.AzureRM.DataFactory.V20170901Preview
{
    ...
    public partial class Factory : Pulumi.CustomResource
    {
        ...
        public Factory(string name, FactoryArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/v20170901preview:Factory", name, args ?? new FactoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Factory(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/v20170901preview:Factory", name, null, MakeResourceOptions(options, id))
        {
        }
