...
namespace Pulumi.AzureNative.DataFactory.V20170901Preview
{
    ...
    public partial class LinkedService : Pulumi.CustomResource
    {
        ...
        public LinkedService(string name, LinkedServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datafactory/v20170901preview:LinkedService", name, args ?? new LinkedServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datafactory/v20170901preview:LinkedService", name, null, MakeResourceOptions(options, id))
        {
        }
