...
namespace Pulumi.AzureRM.DataFactory.V20170901Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var integrationRuntime = new AzureRM.DataFactory.V20170901Preview.IntegrationRuntime("integrationRuntime", new AzureRM.DataFactory.V20170901Preview.IntegrationRuntimeArgs
    ///         {
    ...
    public partial class IntegrationRuntime : Pulumi.CustomResource
    {
        ...
        public IntegrationRuntime(string name, IntegrationRuntimeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/v20170901preview:IntegrationRuntime", name, args ?? new IntegrationRuntimeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationRuntime(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/v20170901preview:IntegrationRuntime", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:datafactory/latest:IntegrationRuntime"},
