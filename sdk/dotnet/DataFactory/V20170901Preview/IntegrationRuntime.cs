...
namespace Pulumi.AzureNextGen.DataFactory.V20170901Preview
{
    ...
    public partial class IntegrationRuntime : Pulumi.CustomResource
    {
        ...
        public IntegrationRuntime(string name, IntegrationRuntimeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datafactory/v20170901preview:IntegrationRuntime", name, args ?? new IntegrationRuntimeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationRuntime(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datafactory/v20170901preview:IntegrationRuntime", name, null, MakeResourceOptions(options, id))
        {
        }
