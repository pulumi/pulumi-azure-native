...
namespace Pulumi.AzureRM.DataFactory.V20170901Preview
{
    ...
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Union<Outputs.MultiplePipelineTriggerResponse, Outputs.TumblingWindowTriggerResponse>> Properties { get; private set; } = null!;
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/v20170901preview:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/v20170901preview:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
