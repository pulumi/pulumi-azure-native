...
namespace Pulumi.AzureRM.DataFactory.Latest
{
    ...
    public partial class ManagedPrivateEndpoint : Pulumi.CustomResource
    {
        ...
        public ManagedPrivateEndpoint(string name, ManagedPrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/latest:ManagedPrivateEndpoint", name, args ?? new ManagedPrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedPrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/latest:ManagedPrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:datafactory/v20180601:ManagedPrivateEndpoint"},
                },
            };
