...
namespace Pulumi.AzureRM.DataFactory.Latest
{
    ...
    public partial class Pipeline : Pulumi.CustomResource
    {
        ...
        public Pipeline(string name, PipelineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/latest:Pipeline", name, args ?? new PipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/latest:Pipeline", name, null, MakeResourceOptions(options, id))
        {
        }
