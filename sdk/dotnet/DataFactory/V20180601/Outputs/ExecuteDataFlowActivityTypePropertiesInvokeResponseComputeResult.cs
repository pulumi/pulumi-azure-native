...
namespace Pulumi.AzureNextGen.DataFactory.V20180601.Outputs
{
    ...
    [OutputType]
    public sealed class ExecuteDataFlowActivityTypePropertiesInvokeResponseComputeResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ExecuteDataFlowActivityTypePropertiesInvokeResponseComputeResult(
            object? computeType,
