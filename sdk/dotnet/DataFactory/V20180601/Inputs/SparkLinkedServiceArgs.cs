...
namespace Pulumi.AzureNextGen.DataFactory.V20180601.Inputs
{
    ...
    public sealed class SparkLinkedServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataFactory.V20180601.SparkAuthenticationType> AuthenticationType { get; set; } = null!;
        ...
        /// </summary>
        [Input("serverType")]
        public InputUnion<string, Pulumi.AzureNextGen.DataFactory.V20180601.SparkServerType>? ServerType { get; set; }

        /// <summary>
        /// The transport protocol to use in the Thrift layer.
        /// </summary>
        [Input("thriftTransportProtocol")]
        public InputUnion<string, Pulumi.AzureNextGen.DataFactory.V20180601.SparkThriftTransportProtocol>? ThriftTransportProtocol { get; set; }
