...
namespace Pulumi.AzureNative.DataFactory.V20180601.Inputs
{
    ...
    /// </summary>
    public sealed class ServiceNowV2SourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("expression")]
        public Input<Inputs.ExpressionV2Args>? Expression { get; set; }
        ...
        public ServiceNowV2SourceArgs()
        {
        }
        public static new ServiceNowV2SourceArgs Empty => new ServiceNowV2SourceArgs();
    }
}
