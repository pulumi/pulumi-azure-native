...
namespace Pulumi.AzureRM.DataFactory.V20180601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var linkedService = new AzureRM.DataFactory.V20180601.LinkedService("linkedService", new AzureRM.DataFactory.V20180601.LinkedServiceArgs
    ///         {
    ...
    public partial class LinkedService : Pulumi.CustomResource
    {
        ...
        public LinkedService(string name, LinkedServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/v20180601:LinkedService", name, args ?? new LinkedServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datafactory/v20180601:LinkedService", name, null, MakeResourceOptions(options, id))
        {
        }
