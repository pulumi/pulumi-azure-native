...
namespace Pulumi.AzureRM.DataFactory
{
    ...
    public partial class FactoryTrigger : Pulumi.CustomResource
    {
        ...
        private FactoryTrigger(string name, Input<string> id, FactoryTriggerState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:datafactory:FactoryTrigger", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FactoryTrigger Get(string name, Input<string> id, FactoryTriggerState? state = null, CustomResourceOptions? options = null)
        {
            return new FactoryTrigger(name, id, state, options);
        }
    }
    ...
    public sealed class FactoryTriggerState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Etag identifies change in the resource.
        /// </summary>
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.TriggerResponseGetArgs> Properties { get; set; } = null!;
