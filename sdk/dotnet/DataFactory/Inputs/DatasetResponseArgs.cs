...
namespace Pulumi.AzureRM.DataFactory.Inputs
{
    ...
    /// </summary>
    public sealed class DatasetResponseArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        /// </summary>
        [Input("folder")]
        public Input<Inputs.DatasetResponsePropertiesArgs>? Folder { get; set; }

        /// <summary>
        /// Linked service reference.
        /// </summary>
        [Input("linkedServiceName", required: true)]
        public Input<Inputs.LinkedServiceReferenceResponseArgs> LinkedServiceName { get; set; } = null!;
