...
namespace Pulumi.AzureRM.DataFactory.Inputs
{
    ...
    /// </summary>
    public sealed class DatasetResponseGetArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        /// </summary>
        [Input("folder")]
        public Input<Inputs.DatasetResponsePropertiesGetArgs>? Folder { get; set; }

        /// <summary>
        /// Linked service reference.
        /// </summary>
        [Input("linkedServiceName", required: true)]
        public Input<Inputs.LinkedServiceReferenceResponseGetArgs> LinkedServiceName { get; set; } = null!;

        /// <summary>
        /// Parameters for dataset.
        /// </summary>
        [Input("parameters")]
        public Input<Inputs.ParameterDefinitionSpecificationResponseGetArgs>? Parameters { get; set; }
