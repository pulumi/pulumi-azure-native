...
namespace Pulumi.AzureRM.DataFactory.Inputs
{
    ...
    /// </summary>
    public sealed class DataFlowResponseGetArgs : Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        /// </summary>
        [Input("folder")]
        public Input<Inputs.DataFlowResponsePropertiesGetArgs>? Folder { get; set; }
        ...
        public DataFlowResponseGetArgs()
        {
        }
    }
}
