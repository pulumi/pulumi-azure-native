...
namespace Pulumi.AzureNative.DataFactory
{
    ...
    public partial class GlobalParameter : global::Pulumi.CustomResource
    {
        ...
        public GlobalParameter(string name, GlobalParameterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datafactory:GlobalParameter", name, args ?? new GlobalParameterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalParameter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datafactory:GlobalParameter", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_datafactory_v20180601:datafactory:GlobalParameter" },
                },
            };
