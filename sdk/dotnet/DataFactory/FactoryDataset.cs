...
namespace Pulumi.AzureRM.DataFactory
{
    ...
    /// </summary>
    public partial class FactoryDataset : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a FactoryDataset resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public FactoryDataset(string name, FactoryDatasetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datafactory:FactoryDataset", name, args ?? new FactoryDatasetArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        /// <summary>
        /// Get an existing FactoryDataset resource's state with the given name, ID, and optional extra
    ...
    public sealed class FactoryDatasetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The factory name.
        /// </summary>
