...
namespace Pulumi.AzureNative.Fabric.V20250115Preview
{
    public static class GetFabricCapacity
    {
        ...
        public static Task<GetFabricCapacityResult> InvokeAsync(GetFabricCapacityArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFabricCapacityResult>("azure-native:fabric/v20250115preview:getFabricCapacity", args ?? new GetFabricCapacityArgs(), options.WithDefaults());

        /// <summary>
        /// Get a FabricCapacity
        /// </summary>
        public static Output<GetFabricCapacityResult> Invoke(GetFabricCapacityInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFabricCapacityResult>("azure-native:fabric/v20250115preview:getFabricCapacity", args ?? new GetFabricCapacityInvokeArgs(), options.WithDefaults());
