...
namespace Pulumi.AzureNative.Fabric.V20231101
{
    public static class GetFabricCapacity
    {
        ...
        public static Task<GetFabricCapacityResult> InvokeAsync(GetFabricCapacityArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFabricCapacityResult>("azure-native:fabric/v20231101:getFabricCapacity", args ?? new GetFabricCapacityArgs(), options.WithDefaults());
