...
namespace Pulumi.AzureNative.Marketplace.V20220901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:marketplace/v20220901:PrivateStoreCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:marketplace/v20220901:PrivateStoreCollection")]
    public partial class PrivateStoreCollection : global::Pulumi.CustomResource
    {
        ...
        public PrivateStoreCollection(string name, PrivateStoreCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20220901:PrivateStoreCollection", name, args ?? new PrivateStoreCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateStoreCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20220901:PrivateStoreCollection", name, null, MakeResourceOptions(options, id))
        {
        }
