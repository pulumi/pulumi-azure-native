...
namespace Pulumi.AzureNative.Marketplace.V20220901
{
    ...
    [AzureNativeResourceType("azure-native:marketplace/v20220901:PrivateStoreCollectionOffer")]
    public partial class PrivateStoreCollectionOffer : global::Pulumi.CustomResource
    {
        ...
        public PrivateStoreCollectionOffer(string name, PrivateStoreCollectionOfferArgs args, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20220901:PrivateStoreCollectionOffer", name, args ?? new PrivateStoreCollectionOfferArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateStoreCollectionOffer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20220901:PrivateStoreCollectionOffer", name, null, MakeResourceOptions(options, id))
        {
        }
