...
namespace Pulumi.AzureNative.Marketplace.V20210601
{
    ...
    public partial class PrivateStoreCollection : global::Pulumi.CustomResource
    {
        ...
        public PrivateStoreCollection(string name, PrivateStoreCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20210601:PrivateStoreCollection", name, args ?? new PrivateStoreCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateStoreCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20210601:PrivateStoreCollection", name, null, MakeResourceOptions(options, id))
        {
        }
