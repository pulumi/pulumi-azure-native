...
namespace Pulumi.AzureNative.Marketplace.V20210601
{
    ...
    public partial class PrivateStoreCollectionOffer : Pulumi.CustomResource
    {
        ...
        public PrivateStoreCollectionOffer(string name, PrivateStoreCollectionOfferArgs args, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20210601:PrivateStoreCollectionOffer", name, args ?? new PrivateStoreCollectionOfferArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateStoreCollectionOffer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20210601:PrivateStoreCollectionOffer", name, null, MakeResourceOptions(options, id))
        {
        }
