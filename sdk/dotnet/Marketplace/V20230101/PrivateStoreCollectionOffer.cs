...
namespace Pulumi.AzureNative.Marketplace.V20230101
{
    ...
    /// {
    ///     var privateStoreCollectionOffer = new AzureNative.Marketplace.V20230101.PrivateStoreCollectionOffer("privateStoreCollectionOffer", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:marketplace/v20230101:PrivateStoreCollectionOffer")]
    public partial class PrivateStoreCollectionOffer : global::Pulumi.CustomResource
    {
        ...
        public PrivateStoreCollectionOffer(string name, PrivateStoreCollectionOfferArgs args, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20230101:PrivateStoreCollectionOffer", name, args ?? new PrivateStoreCollectionOfferArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateStoreCollectionOffer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20230101:PrivateStoreCollectionOffer", name, null, MakeResourceOptions(options, id))
        {
        }
