...
namespace Pulumi.AzureNative.Marketplace.V20230101
{
    ...
    /// {
    ///     var privateStoreCollection = new AzureNative.Marketplace.V20230101.PrivateStoreCollection("privateStoreCollection", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:marketplace/v20230101:PrivateStoreCollection d0f5aa2c-ecc3-4d87-906a-f8c486dcc4f1 providers/Microsoft.Marketplace/privateStores/a0e28e55-90c4-41d8-8e34-bb7ef7775406/collections/d0f5aa2c-ecc3-4d87-906a-f8c486dcc4f1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:marketplace/v20230101:PrivateStoreCollection")]
    public partial class PrivateStoreCollection : global::Pulumi.CustomResource
    {
        ...
        public PrivateStoreCollection(string name, PrivateStoreCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20230101:PrivateStoreCollection", name, args ?? new PrivateStoreCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateStoreCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20230101:PrivateStoreCollection", name, null, MakeResourceOptions(options, id))
        {
        }
