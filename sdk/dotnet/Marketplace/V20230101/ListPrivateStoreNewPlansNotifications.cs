...
namespace Pulumi.AzureNative.Marketplace.V20230101
{
    public static class ListPrivateStoreNewPlansNotifications
    {
        ...
        public static Task<ListPrivateStoreNewPlansNotificationsResult> InvokeAsync(ListPrivateStoreNewPlansNotificationsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListPrivateStoreNewPlansNotificationsResult>("azure-native:marketplace/v20230101:listPrivateStoreNewPlansNotifications", args ?? new ListPrivateStoreNewPlansNotificationsArgs(), options.WithDefaults());
        ...
        public static Output<ListPrivateStoreNewPlansNotificationsResult> Invoke(ListPrivateStoreNewPlansNotificationsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListPrivateStoreNewPlansNotificationsResult>("azure-native:marketplace/v20230101:listPrivateStoreNewPlansNotifications", args ?? new ListPrivateStoreNewPlansNotificationsInvokeArgs(), options.WithDefaults());
    }
