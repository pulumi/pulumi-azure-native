...
namespace Pulumi.AzureNative.Marketplace.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:marketplace/v20220301:PrivateStoreCollectionOffer is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollectionOffer to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:marketplace/v20220301:PrivateStoreCollectionOffer")]
    public partial class PrivateStoreCollectionOffer : global::Pulumi.CustomResource
    {
        ...
        public PrivateStoreCollectionOffer(string name, PrivateStoreCollectionOfferArgs args, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20220301:PrivateStoreCollectionOffer", name, args ?? new PrivateStoreCollectionOfferArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateStoreCollectionOffer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:marketplace/v20220301:PrivateStoreCollectionOffer", name, null, MakeResourceOptions(options, id))
        {
        }
