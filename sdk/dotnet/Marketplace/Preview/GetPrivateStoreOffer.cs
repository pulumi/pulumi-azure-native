...
namespace Pulumi.AzureRM.Marketplace.Preview
{
    public static class GetPrivateStoreOffer
    {
        public static Task<GetPrivateStoreOfferResult> InvokeAsync(GetPrivateStoreOfferArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateStoreOfferResult>("azurerm:marketplace/preview:getPrivateStoreOffer", args ?? new GetPrivateStoreOfferArgs(), options.WithVersion());
    }
