...
namespace Pulumi.AzureRM.Marketplace.Preview
{
    ...
    public partial class PrivateStoreOffer : Pulumi.CustomResource
    {
        ...
        public PrivateStoreOffer(string name, PrivateStoreOfferArgs args, CustomResourceOptions? options = null)
            : base("azurerm:marketplace/preview:PrivateStoreOffer", name, args ?? new PrivateStoreOfferArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateStoreOffer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:marketplace/preview:PrivateStoreOffer", name, null, MakeResourceOptions(options, id))
        {
        }
