...
namespace Pulumi.AzureNative.CustomProviders.V20180901Preview.Inputs
{

    /// <summary>
    /// The route definition for an action implemented by the custom resource provider.
    /// </summary>
    public sealed class CustomRPActionRouteDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("routingType")]
        public InputUnion<string, Pulumi.AzureNative.CustomProviders.V20180901Preview.ActionRouting>? RoutingType { get; set; }

        public CustomRPActionRouteDefinitionArgs()
        {
        }
        public static new CustomRPActionRouteDefinitionArgs Empty => new CustomRPActionRouteDefinitionArgs();
    }
}
