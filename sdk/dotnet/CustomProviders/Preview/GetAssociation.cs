...
namespace Pulumi.AzureRM.CustomProviders.Preview
{
    public static class GetAssociation
    {
        public static Task<GetAssociationResult> InvokeAsync(GetAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAssociationResult>("azurerm:customproviders/preview:getAssociation", args ?? new GetAssociationArgs(), options.WithVersion());
    }
