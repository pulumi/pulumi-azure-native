...
namespace Pulumi.AzureRM.CustomProviders.Preview
{
    /// <summary>
    ...
    public partial class CustomResourceProvider : Pulumi.CustomResource
    {
        ...
        public CustomResourceProvider(string name, CustomResourceProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customproviders/preview:CustomResourceProvider", name, args ?? new CustomResourceProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomResourceProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customproviders/preview:CustomResourceProvider", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:customproviders/v20180901preview:CustomResourceProvider"},
                },
            };
