...
namespace Pulumi.AzureRM.CustomProviders.Preview
{
    ...
    public partial class Association : Pulumi.CustomResource
    {
        ...
        public Association(string name, AssociationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customproviders/preview:Association", name, args ?? new AssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Association(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customproviders/preview:Association", name, null, MakeResourceOptions(options, id))
        {
        }
