...
namespace Pulumi.AzureRM.CustomProviders.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var association = new AzureRM.CustomProviders.Latest.Association("association", new AzureRM.CustomProviders.Latest.AssociationArgs
    ///         {
    ...
    public partial class Association : Pulumi.CustomResource
    {
        ...
        public Association(string name, AssociationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customproviders/latest:Association", name, args ?? new AssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Association(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customproviders/latest:Association", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:customproviders/v20180901preview:Association"},
                },
            };
