...
namespace Pulumi.AzureRM.CustomProviders.Latest
{
    public static class GetAssociation
    {
        public static Task<GetAssociationResult> InvokeAsync(GetAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAssociationResult>("azurerm:customproviders/latest:getAssociation", args ?? new GetAssociationArgs(), options.WithVersion());
    }
