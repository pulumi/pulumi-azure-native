...
namespace Pulumi.AzureRM.CustomProviders.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var customResourceProvider = new AzureRM.CustomProviders.Latest.CustomResourceProvider("customResourceProvider", new AzureRM.CustomProviders.Latest.CustomResourceProviderArgs
    ///         {
    ///             Actions = 
    ///             {
    ///                 new AzureRM.CustomProviders.Latest.Inputs.CustomRPActionRouteDefinitionArgs
    ///                 {
    ...
    ///             ResourceTypes = 
    ///             {
    ///                 new AzureRM.CustomProviders.Latest.Inputs.CustomRPResourceTypeRouteDefinitionArgs
    ///                 {
    ...
    public partial class CustomResourceProvider : Pulumi.CustomResource
    {
        ...
        public CustomResourceProvider(string name, CustomResourceProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:customproviders/latest:CustomResourceProvider", name, args ?? new CustomResourceProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomResourceProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:customproviders/latest:CustomResourceProvider", name, null, MakeResourceOptions(options, id))
        {
        }
