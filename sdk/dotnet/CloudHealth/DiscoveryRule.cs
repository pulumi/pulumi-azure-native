...
namespace Pulumi.AzureNative.CloudHealth
{
    ...
    public partial class DiscoveryRule : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DiscoveryRulePropertiesResponse> Properties { get; private set; } = null!;
        ...
        public DiscoveryRule(string name, DiscoveryRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudhealth:DiscoveryRule", name, args ?? new DiscoveryRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiscoveryRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudhealth:DiscoveryRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cloudhealth/v20260501preview:DiscoveryRule" },
                },
            };
    ...
    public sealed class DiscoveryRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.DiscoveryRulePropertiesArgs>? Properties { get; set; }
