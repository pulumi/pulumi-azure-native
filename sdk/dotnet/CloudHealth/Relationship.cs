...
namespace Pulumi.AzureNative.CloudHealth
{
    ...
    public partial class Relationship : global::Pulumi.CustomResource
    {
        ...
        public Relationship(string name, RelationshipArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudhealth:Relationship", name, args ?? new RelationshipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Relationship(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudhealth:Relationship", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:cloudhealth/v20250501preview:Relationship" },
                    new global::Pulumi.Alias { Type = "azure-native:cloudhealth/v20260101preview:Relationship" },
                    new global::Pulumi.Alias { Type = "azure-native:cloudhealth/v20260501preview:Relationship" },
                },
            };
