...
namespace Pulumi.AzureNative.CloudHealth
{
    public static class GetRelationship
    {
        ...
        public static Task<GetRelationshipResult> InvokeAsync(GetRelationshipArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRelationshipResult>("azure-native:cloudhealth:getRelationship", args ?? new GetRelationshipArgs(), options.WithDefaults());
        ...
        public static Output<GetRelationshipResult> Invoke(GetRelationshipInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRelationshipResult>("azure-native:cloudhealth:getRelationship", args ?? new GetRelationshipInvokeArgs(), options.WithDefaults());
