...
namespace Pulumi.AzureNative.CloudHealth
{
    ...
    public partial class HealthModel : global::Pulumi.CustomResource
    {
        ...
        public HealthModel(string name, HealthModelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudhealth:HealthModel", name, args ?? new HealthModelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthModel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudhealth:HealthModel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cloudhealth/v20260501preview:HealthModel" },
                },
            };
