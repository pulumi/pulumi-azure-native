...
namespace Pulumi.AzureNative.PowerPlatform
{
    ...
    public partial class EnterprisePolicy : global::Pulumi.CustomResource
    {
        ...
        public EnterprisePolicy(string name, EnterprisePolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:powerplatform:EnterprisePolicy", name, args ?? new EnterprisePolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnterprisePolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:powerplatform:EnterprisePolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:powerplatform/v20201030preview:EnterprisePolicy"},
                },
            };
    ...
    public sealed class EnterprisePolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("healthStatus")]
        public InputUnion<string, Pulumi.AzureNative.PowerPlatform.HealthStatus>? HealthStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.PowerPlatform.EnterprisePolicyKind> Kind { get; set; } = null!;
