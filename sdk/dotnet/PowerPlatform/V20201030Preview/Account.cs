...
namespace Pulumi.AzureNative.PowerPlatform.V20201030Preview
{
    ...
    /// {
    ///     var account = new AzureNative.PowerPlatform.V20201030Preview.Account("account", new()
    ///     {
    ///         AccountName = "account",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:powerplatform/v20201030preview:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:powerplatform/v20201030preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:powerplatform/v20201030preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:powerplatform:Account"},
                },
            };
