...
namespace Pulumi.AzureRM.ManagementPartner.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var partner = new AzureRM.ManagementPartner.Latest.Partner("partner", new AzureRM.ManagementPartner.Latest.PartnerArgs
    ///         {
    ///             PartnerId = "123456",
    ///         });
    ///     }
    ...
    public partial class Partner : Pulumi.CustomResource
    {
        ...
        public Partner(string name, PartnerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managementpartner/latest:Partner", name, args ?? new PartnerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Partner(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managementpartner/latest:Partner", name, null, MakeResourceOptions(options, id))
        {
        }
