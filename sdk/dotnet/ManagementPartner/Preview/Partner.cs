...
namespace Pulumi.AzureRM.ManagementPartner.Preview
{
    ...
    public partial class Partner : Pulumi.CustomResource
    {
        ...
        public Partner(string name, PartnerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managementpartner/preview:Partner", name, args ?? new PartnerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Partner(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managementpartner/preview:Partner", name, null, MakeResourceOptions(options, id))
        {
        }
