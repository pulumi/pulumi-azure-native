...
namespace Pulumi.AzureRM.ManagementPartner.Preview
{
    public static class GetPartner
    {
        public static Task<GetPartnerResult> InvokeAsync(GetPartnerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPartnerResult>("azurerm:managementpartner/preview:getPartner", args ?? new GetPartnerArgs(), options.WithVersion());
    }
