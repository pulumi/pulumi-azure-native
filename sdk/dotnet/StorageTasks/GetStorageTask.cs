...
namespace Pulumi.AzureNative.StorageTasks
{
    public static class GetStorageTask
    {
        ...
        public static Task<GetStorageTaskResult> InvokeAsync(GetStorageTaskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageTaskResult>("azure-native:storagetasks:getStorageTask", args ?? new GetStorageTaskArgs(), options.WithDefaults());
        ...
        public static Output<GetStorageTaskResult> Invoke(GetStorageTaskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageTaskResult>("azure-native:storagetasks:getStorageTask", args ?? new GetStorageTaskInvokeArgs(), options.WithDefaults());
    }
