...
namespace Pulumi.AzureNative.StorageTasks.V20230101
{
    public static class GetStorageTask
    {
        ...
        public static Task<GetStorageTaskResult> InvokeAsync(GetStorageTaskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageTaskResult>("azure-native:storagetasks/v20230101:getStorageTask", args ?? new GetStorageTaskArgs(), options.WithDefaults());

        /// <summary>
        /// Get the storage task properties
        /// </summary>
        public static Output<GetStorageTaskResult> Invoke(GetStorageTaskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageTaskResult>("azure-native:storagetasks/v20230101:getStorageTask", args ?? new GetStorageTaskInvokeArgs(), options.WithDefaults());
    }
