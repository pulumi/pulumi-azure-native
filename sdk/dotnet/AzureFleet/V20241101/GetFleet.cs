...
namespace Pulumi.AzureNative.AzureFleet.V20241101
{
    public static class GetFleet
    {
        ...
        public static Task<GetFleetResult> InvokeAsync(GetFleetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFleetResult>("azure-native:azurefleet/v20241101:getFleet", args ?? new GetFleetArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Fleet
        /// </summary>
        public static Output<GetFleetResult> Invoke(GetFleetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFleetResult>("azure-native:azurefleet/v20241101:getFleet", args ?? new GetFleetInvokeArgs(), options.WithDefaults());
    }
