...
namespace Pulumi.AzureNative.AzureFleet.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurefleet/v20241101:Fleet")]
    public partial class Fleet : global::Pulumi.CustomResource
    {
        ...
        public Fleet(string name, FleetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurefleet/v20241101:Fleet", name, args ?? new FleetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fleet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurefleet/v20241101:Fleet", name, null, MakeResourceOptions(options, id))
        {
        }
