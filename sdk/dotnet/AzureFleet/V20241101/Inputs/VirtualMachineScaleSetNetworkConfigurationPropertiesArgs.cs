...
namespace Pulumi.AzureNative.AzureFleet.V20241101.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetNetworkConfigurationPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("auxiliaryMode")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20241101.NetworkInterfaceAuxiliaryMode>? AuxiliaryMode { get; set; }
        ...
        /// </summary>
        [Input("auxiliarySku")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20241101.NetworkInterfaceAuxiliarySku>? AuxiliarySku { get; set; }

        /// <summary>
        /// Specify what happens to the network interface when the VM is deleted
        /// </summary>
        [Input("deleteOption")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20241101.DeleteOptions>? DeleteOption { get; set; }
