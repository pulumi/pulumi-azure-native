...
namespace Pulumi.AzureNative.AzureFleet.V20241101.Inputs
{
    ...
    public sealed class DiffDiskSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("option")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20241101.DiffDiskOptions>? Option { get; set; }
        ...
        /// </summary>
        [Input("placement")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20241101.DiffDiskPlacement>? Placement { get; set; }
