...
namespace Pulumi.AzureNative.AzureFleet.V20241101.Inputs
{
    ...
    public sealed class VMAttributesArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _acceleratorManufacturers ?? (_acceleratorManufacturers = new InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.AcceleratorManufacturer>>());
        ...
        {
            get => _acceleratorTypes ?? (_acceleratorTypes = new InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.AcceleratorType>>());
            set => _acceleratorTypes = value;
        }

        [Input("architectureTypes")]
        private InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.ArchitectureType>>? _architectureTypes;

        /// <summary>
        /// The VM architecture types specified as a list. Optional parameter.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.ArchitectureType>> ArchitectureTypes
        {
            get => _architectureTypes ?? (_architectureTypes = new InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.ArchitectureType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20241101.VMAttributeSupport>? BurstableSupport { get; set; }

        [Input("cpuManufacturers")]
        private InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.CpuManufacturer>>? _cpuManufacturers;

        /// <summary>
        /// The VM CPU manufacturers specified as a list. Optional parameter.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.CpuManufacturer>> CpuManufacturers
        {
            get => _cpuManufacturers ?? (_cpuManufacturers = new InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.CpuManufacturer>>());
        ...
        private InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.LocalStorageDiskType>>? _localStorageDiskTypes;
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.LocalStorageDiskType>> LocalStorageDiskTypes
        {
            get => _localStorageDiskTypes ?? (_localStorageDiskTypes = new InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.LocalStorageDiskType>>());
        ...
        /// </summary>
        [Input("rdmaSupport")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20241101.VMAttributeSupport>? RdmaSupport { get; set; }
        ...
        [Input("vmCategories")]
        private InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.VMCategory>>? _vmCategories;

        /// <summary>
        /// The VM category specified as a list. Optional parameter.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.VMCategory>> VmCategories
        {
            get => _vmCategories ?? (_vmCategories = new InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20241101.VMCategory>>());
