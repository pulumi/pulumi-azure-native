...
namespace Pulumi.AzureNative.AzureFleet.V20231101Preview.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetStorageProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20231101Preview.DiskControllerTypes>>? _diskControllerType;
        public InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20231101Preview.DiskControllerTypes>> DiskControllerType
        {
            get => _diskControllerType ?? (_diskControllerType = new InputList<Union<string, Pulumi.AzureNative.AzureFleet.V20231101Preview.DiskControllerTypes>>());
