...
namespace Pulumi.AzureNative.AzureFleet.V20231101Preview
{
    public static class GetFleet
    {
        ...
        public static Task<GetFleetResult> InvokeAsync(GetFleetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFleetResult>("azure-native:azurefleet/v20231101preview:getFleet", args ?? new GetFleetArgs(), options.WithDefaults());
