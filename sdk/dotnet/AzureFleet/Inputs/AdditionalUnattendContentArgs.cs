...
namespace Pulumi.AzureNative.AzureFleet.Inputs
{
    ...
    public sealed class AdditionalUnattendContentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("componentName")]
        public Input<Pulumi.AzureNative.AzureFleet.ComponentName>? ComponentName { get; set; }
        ...
        /// </summary>
        [Input("passName")]
        public Input<Pulumi.AzureNative.AzureFleet.PassName>? PassName { get; set; }
        ...
        /// </summary>
        [Input("settingName")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.SettingNames>? SettingName { get; set; }
