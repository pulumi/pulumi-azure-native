...
namespace Pulumi.AzureNative.AzureFleet.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurefleet/v20240501preview:Fleet")]
    public partial class Fleet : global::Pulumi.CustomResource
    {
        ...
        public Fleet(string name, FleetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurefleet/v20240501preview:Fleet", name, args ?? new FleetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fleet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurefleet/v20240501preview:Fleet", name, null, MakeResourceOptions(options, id))
        {
        }
