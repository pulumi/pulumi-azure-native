...
namespace Pulumi.AzureNative.AzureFleet.V20240501Preview.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetDataDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20240501Preview.CachingTypes>? Caching { get; set; }

        /// <summary>
        /// The create option.
        /// </summary>
        [Input("createOption", required: true)]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20240501Preview.DiskCreateOptionTypes> CreateOption { get; set; } = null!;
        ...
        /// </summary>
        [Input("deleteOption")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20240501Preview.DiskDeleteOptionTypes>? DeleteOption { get; set; }
