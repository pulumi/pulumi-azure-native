...
namespace Pulumi.AzureNative.AzureFleet.V20240501Preview.Inputs
{
    ...
    public sealed class DiffDiskSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("option")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20240501Preview.DiffDiskOptions>? Option { get; set; }
        ...
        /// </summary>
        [Input("placement")]
        public InputUnion<string, Pulumi.AzureNative.AzureFleet.V20240501Preview.DiffDiskPlacement>? Placement { get; set; }
