...
namespace Pulumi.AzureRM.SoftwarePlan.V20191201
{
    /// <summary>
    ...
    public partial class HybridUseBenefit : Pulumi.CustomResource
    {
        ...
        public HybridUseBenefit(string name, HybridUseBenefitArgs args, CustomResourceOptions? options = null)
            : base("azurerm:softwareplan/v20191201:HybridUseBenefit", name, args ?? new HybridUseBenefitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridUseBenefit(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:softwareplan/v20191201:HybridUseBenefit", name, null, MakeResourceOptions(options, id))
        {
        }
