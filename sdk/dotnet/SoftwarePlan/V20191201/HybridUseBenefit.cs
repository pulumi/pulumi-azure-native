...
namespace Pulumi.AzureNative.SoftwarePlan.V20191201
{
    ...
    /// {
    ///     var hybridUseBenefit = new AzureNative.SoftwarePlan.V20191201.HybridUseBenefit("hybridUseBenefit", new()
    ///     {
    ...
    ///         Sku = new AzureNative.SoftwarePlan.V20191201.Inputs.SkuArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:softwareplan/v20191201:HybridUseBenefit")]
    public partial class HybridUseBenefit : global::Pulumi.CustomResource
    {
        ...
        public HybridUseBenefit(string name, HybridUseBenefitArgs args, CustomResourceOptions? options = null)
            : base("azure-native:softwareplan/v20191201:HybridUseBenefit", name, args ?? new HybridUseBenefitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridUseBenefit(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:softwareplan/v20191201:HybridUseBenefit", name, null, MakeResourceOptions(options, id))
        {
        }
