...
namespace Pulumi.AzureRM.SoftwarePlan.Preview
{
    public static class GetHybridUseBenefit
    {
        public static Task<GetHybridUseBenefitResult> InvokeAsync(GetHybridUseBenefitArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHybridUseBenefitResult>("azurerm:softwareplan/preview:getHybridUseBenefit", args ?? new GetHybridUseBenefitArgs(), options.WithVersion());
    }
