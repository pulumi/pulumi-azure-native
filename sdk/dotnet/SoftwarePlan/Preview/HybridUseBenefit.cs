...
namespace Pulumi.AzureRM.SoftwarePlan.Preview
{
    /// <summary>
    ...
    public partial class HybridUseBenefit : Pulumi.CustomResource
    {
        ...
        public HybridUseBenefit(string name, HybridUseBenefitArgs args, CustomResourceOptions? options = null)
            : base("azurerm:softwareplan/preview:HybridUseBenefit", name, args ?? new HybridUseBenefitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridUseBenefit(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:softwareplan/preview:HybridUseBenefit", name, null, MakeResourceOptions(options, id))
        {
        }
