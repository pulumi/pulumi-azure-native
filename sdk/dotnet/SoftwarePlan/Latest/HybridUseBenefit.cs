...
namespace Pulumi.AzureNative.SoftwarePlan.Latest
{
    /// <summary>
    /// Response on GET of a hybrid use benefit
    /// Latest API Version: 2019-12-01.
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:softwareplan:HybridUseBenefit'.")]
    [AzureNativeResourceType("azure-native:softwareplan/latest:HybridUseBenefit")]
    public partial class HybridUseBenefit : Pulumi.CustomResource
    {
        ...
        public HybridUseBenefit(string name, HybridUseBenefitArgs args, CustomResourceOptions? options = null)
            : base("azure-native:softwareplan/latest:HybridUseBenefit", name, args ?? new HybridUseBenefitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridUseBenefit(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:softwareplan/latest:HybridUseBenefit", name, null, MakeResourceOptions(options, id))
        {
        }
