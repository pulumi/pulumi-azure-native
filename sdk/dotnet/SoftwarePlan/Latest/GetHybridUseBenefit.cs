...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:softwareplan:getHybridUseBenefit'.")]
    public static class GetHybridUseBenefit
    {
        ...
        public static Task<GetHybridUseBenefitResult> InvokeAsync(GetHybridUseBenefitArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHybridUseBenefitResult>("azure-native:softwareplan/latest:getHybridUseBenefit", args ?? new GetHybridUseBenefitArgs(), options.WithVersion());
    }
