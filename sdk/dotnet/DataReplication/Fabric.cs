...
namespace Pulumi.AzureNative.DataReplication
{
    ...
    public partial class Fabric : global::Pulumi.CustomResource
    {
        ...
        public Fabric(string name, FabricArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datareplication:Fabric", name, args ?? new FabricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fabric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datareplication:Fabric", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:datareplication/v20260501:Fabric" },
                },
            };
