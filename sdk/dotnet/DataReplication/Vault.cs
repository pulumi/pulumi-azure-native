...
namespace Pulumi.AzureNative.DataReplication
{
    ...
    public partial class Vault : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VaultModelPropertiesResponse> Properties { get; private set; } = null!;

        [Output("systemData")]
        public Output<Outputs.VaultModelResponseSystemData> SystemData { get; private set; } = null!;
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datareplication:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datareplication:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_datareplication_v20210216preview:datareplication:Vault" },
                    new global::Pulumi.Alias { Type = "azure-native_datareplication_v20240901:datareplication:Vault" },
                },
            };
    ...
    public sealed class VaultArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.VaultModelPropertiesArgs>? Properties { get; set; }
