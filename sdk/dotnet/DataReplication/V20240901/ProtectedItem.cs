...
namespace Pulumi.AzureNative.DataReplication.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datareplication/v20240901:ProtectedItem")]
    public partial class ProtectedItem : global::Pulumi.CustomResource
    {
        ...
        public ProtectedItem(string name, ProtectedItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datareplication/v20240901:ProtectedItem", name, args ?? new ProtectedItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectedItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datareplication/v20240901:ProtectedItem", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProtectedItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.ProtectedItemModelPropertiesArgs>? Properties { get; set; }
