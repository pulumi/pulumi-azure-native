...
namespace Pulumi.AzureNative.DataReplication.V20240901
{
    ...
    /// Vault model.
    /// </summary>
    [AzureNativeResourceType("azure-native:datareplication/v20240901:Vault")]
    public partial class Vault : global::Pulumi.CustomResource
    {
        ...
        public Vault(string name, VaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datareplication/v20240901:Vault", name, args ?? new VaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datareplication/v20240901:Vault", name, null, MakeResourceOptions(options, id))
        {
        }
