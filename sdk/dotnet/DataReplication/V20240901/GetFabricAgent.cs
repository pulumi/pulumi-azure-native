...
namespace Pulumi.AzureNative.DataReplication.V20240901
{
    public static class GetFabricAgent
    {
        ...
        public static Task<GetFabricAgentResult> InvokeAsync(GetFabricAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFabricAgentResult>("azure-native:datareplication/v20240901:getFabricAgent", args ?? new GetFabricAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the fabric agent.
        /// </summary>
        public static Output<GetFabricAgentResult> Invoke(GetFabricAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFabricAgentResult>("azure-native:datareplication/v20240901:getFabricAgent", args ?? new GetFabricAgentInvokeArgs(), options.WithDefaults());
