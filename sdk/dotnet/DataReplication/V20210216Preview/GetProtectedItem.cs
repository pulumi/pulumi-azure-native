...
namespace Pulumi.AzureNative.DataReplication.V20210216Preview
{
    public static class GetProtectedItem
    {
        ...
        public static Task<GetProtectedItemResult> InvokeAsync(GetProtectedItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProtectedItemResult>("azure-native:datareplication/v20210216preview:getProtectedItem", args ?? new GetProtectedItemArgs(), options.WithDefaults());
