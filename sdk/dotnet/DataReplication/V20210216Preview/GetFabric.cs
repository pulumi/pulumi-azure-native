...
namespace Pulumi.AzureNative.DataReplication.V20210216Preview
{
    public static class GetFabric
    {
        ...
        public static Task<GetFabricResult> InvokeAsync(GetFabricArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFabricResult>("azure-native:datareplication/v20210216preview:getFabric", args ?? new GetFabricArgs(), options.WithDefaults());
