...
namespace Pulumi.AzureNative.DataReplication.V20210216Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datareplication/v20210216preview:ProtectedItem")]
    public partial class ProtectedItem : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ProtectedItemModelPropertiesResponse> Properties { get; private set; } = null!;

        [Output("systemData")]
        public Output<Outputs.ProtectedItemModelResponseSystemData> SystemData { get; private set; } = null!;
        ...
        public ProtectedItem(string name, ProtectedItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datareplication/v20210216preview:ProtectedItem", name, args ?? new ProtectedItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProtectedItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datareplication/v20210216preview:ProtectedItem", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:datareplication:ProtectedItem" },
                },
            };
    ...
    public sealed class ProtectedItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ProtectedItemModelPropertiesArgs> Properties { get; set; } = null!;
