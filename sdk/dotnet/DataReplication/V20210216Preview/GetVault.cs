...
namespace Pulumi.AzureNative.DataReplication.V20210216Preview
{
    public static class GetVault
    {
        ...
        public static Task<GetVaultResult> InvokeAsync(GetVaultArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVaultResult>("azure-native:datareplication/v20210216preview:getVault", args ?? new GetVaultArgs(), options.WithDefaults());
