...
namespace Pulumi.AzureNative.BillingTrust
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:billingtrust:Assessment")]
    public partial class Assessment : global::Pulumi.CustomResource
    {
        ...
        public Assessment(string name, AssessmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:billingtrust:Assessment", name, args ?? new AssessmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Assessment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:billingtrust:Assessment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:billingtrust/v20260317preview:Assessment" },
                },
            };
    ...
    public sealed class AssessmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.AssessmentPropertiesArgs>? Properties { get; set; }
