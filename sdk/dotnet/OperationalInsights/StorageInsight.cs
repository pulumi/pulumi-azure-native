...
namespace Pulumi.AzureRM.OperationalInsights
{
    ...
    public partial class StorageInsight : Pulumi.CustomResource
    {
        ...
        public StorageInsight(string name, StorageInsightArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights:StorageInsight", name, args ?? new StorageInsightArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageInsight(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights:StorageInsight", name, null, MakeResourceOptions(options, id))
        {
        }
