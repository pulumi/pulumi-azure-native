...
namespace Pulumi.AzureRM.OperationalInsights.V20200801
{
    public static class GetLinkedStorageAccount
    {
        public static Task<GetLinkedStorageAccountResult> InvokeAsync(GetLinkedStorageAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLinkedStorageAccountResult>("azurerm:operationalinsights/v20200801:getLinkedStorageAccount", args ?? new GetLinkedStorageAccountArgs(), options.WithVersion());
    }
