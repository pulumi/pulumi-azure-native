...
namespace Pulumi.AzureNative.OperationalInsights.V20200801
{
    ...
    public partial class DataExport : global::Pulumi.CustomResource
    {
        ...
        public DataExport(string name, DataExportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200801:DataExport", name, args ?? new DataExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataExport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200801:DataExport", name, null, MakeResourceOptions(options, id))
        {
        }
