...
namespace Pulumi.AzureRM.OperationalInsights.V20200801
{
    public static class GetDataSource
    {
        public static Task<GetDataSourceResult> InvokeAsync(GetDataSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataSourceResult>("azurerm:operationalinsights/v20200801:getDataSource", args ?? new GetDataSourceArgs(), options.WithVersion());
    }
