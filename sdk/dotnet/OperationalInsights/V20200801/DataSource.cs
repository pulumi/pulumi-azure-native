...
namespace Pulumi.AzureNative.OperationalInsights.V20200801
{
    ...
    /// {
    ///     var dataSource = new AzureNative.OperationalInsights.V20200801.DataSource("dataSource", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:operationalinsights/v20200801:DataSource AzTestDS774 /subscriptions/00000000-0000-0000-0000-000000000005/resourceGroups/OIAutoRest5123/providers/Microsoft.OperationalInsights/workspaces/AzTest9724/datasources/AzTestDS774 
    /// ```
    /// </summary>
    ...
    public partial class DataSource : global::Pulumi.CustomResource
    {
        ...
        public DataSource(string name, DataSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200801:DataSource", name, args ?? new DataSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200801:DataSource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20200801.DataSourceKind> Kind { get; set; } = null!;
