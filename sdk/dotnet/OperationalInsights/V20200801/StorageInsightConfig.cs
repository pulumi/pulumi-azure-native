...
namespace Pulumi.AzureRM.OperationalInsights.V20200801
{
    ...
    public partial class StorageInsightConfig : Pulumi.CustomResource
    {
        ...
        public StorageInsightConfig(string name, StorageInsightConfigArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20200801:StorageInsightConfig", name, args ?? new StorageInsightConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageInsightConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20200801:StorageInsightConfig", name, null, MakeResourceOptions(options, id))
        {
        }
