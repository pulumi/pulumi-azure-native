...
namespace Pulumi.AzureNative.OperationalInsights.V20200801
{
    ...
    /// {
    ///     var cluster = new AzureNative.OperationalInsights.V20200801.Cluster("cluster", new()
    ///     {
    ///         ClusterName = "oiautorest6685",
    ///         Location = "australiasoutheast",
    ///         ResourceGroupName = "oiautorest6685",
    ///         Sku = new AzureNative.OperationalInsights.V20200801.Inputs.ClusterSkuArgs
    ///         {
    ///             Capacity = 1000,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20200801:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200801:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200801:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
