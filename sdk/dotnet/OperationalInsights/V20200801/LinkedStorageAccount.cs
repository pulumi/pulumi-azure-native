...
namespace Pulumi.AzureRM.OperationalInsights.V20200801
{
    ...
    public partial class LinkedStorageAccount : Pulumi.CustomResource
    {
        ...
        public LinkedStorageAccount(string name, LinkedStorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20200801:LinkedStorageAccount", name, args ?? new LinkedStorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedStorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20200801:LinkedStorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
