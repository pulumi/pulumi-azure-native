...
namespace Pulumi.AzureNative.OperationalInsights.V20200801
{
    ...
    /// {
    ///     var linkedStorageAccount = new AzureNative.OperationalInsights.V20200801.LinkedStorageAccount("linkedStorageAccount", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20200801:LinkedStorageAccount")]
    public partial class LinkedStorageAccount : global::Pulumi.CustomResource
    {
        ...
        public LinkedStorageAccount(string name, LinkedStorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200801:LinkedStorageAccount", name, args ?? new LinkedStorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedStorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200801:LinkedStorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
