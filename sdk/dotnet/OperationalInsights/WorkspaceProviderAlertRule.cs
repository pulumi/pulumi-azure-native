...
namespace Pulumi.AzureRM.OperationalInsights
{
    ...
    /// Alert rule.
    /// </summary>
    public partial class WorkspaceProviderAlertRule : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a WorkspaceProviderAlertRule resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public WorkspaceProviderAlertRule(string name, WorkspaceProviderAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights:WorkspaceProviderAlertRule", name, args ?? new WorkspaceProviderAlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class WorkspaceProviderAlertRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Etag of the azure resource
        /// </summary>
