...
namespace Pulumi.AzureNative.OperationalInsights.V20221001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20221001:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20221001:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20221001:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("billingType")]
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20221001.BillingType>? BillingType { get; set; }
