...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    public static class GetDataSource
    {
        public static Task<GetDataSourceResult> InvokeAsync(GetDataSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataSourceResult>("azurerm:operationalinsights/preview:getDataSource", args ?? new GetDataSourceArgs(), options.WithVersion());
    }
