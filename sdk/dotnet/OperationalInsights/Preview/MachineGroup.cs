...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    ...
    public partial class MachineGroup : Pulumi.CustomResource
    {
        ...
        public MachineGroup(string name, MachineGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:MachineGroup", name, args ?? new MachineGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:MachineGroup", name, null, MakeResourceOptions(options, id))
        {
        }
