...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    public static class GetStorageInsightConfig
    {
        public static Task<GetStorageInsightConfigResult> InvokeAsync(GetStorageInsightConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageInsightConfigResult>("azurerm:operationalinsights/preview:getStorageInsightConfig", args ?? new GetStorageInsightConfigArgs(), options.WithVersion());
    }
