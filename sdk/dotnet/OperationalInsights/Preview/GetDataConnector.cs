...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    public static class GetDataConnector
    {
        public static Task<GetDataConnectorResult> InvokeAsync(GetDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectorResult>("azurerm:operationalinsights/preview:getDataConnector", args ?? new GetDataConnectorArgs(), options.WithVersion());
    }
