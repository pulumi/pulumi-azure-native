...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    public static class GetIncident
    {
        public static Task<GetIncidentResult> InvokeAsync(GetIncidentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIncidentResult>("azurerm:operationalinsights/preview:getIncident", args ?? new GetIncidentArgs(), options.WithVersion());
    }
