...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    ...
    public partial class StorageInsightConfig : Pulumi.CustomResource
    {
        ...
        public StorageInsightConfig(string name, StorageInsightConfigArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:StorageInsightConfig", name, args ?? new StorageInsightConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageInsightConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:StorageInsightConfig", name, null, MakeResourceOptions(options, id))
        {
        }
