...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    public static class GetWorkspace
    {
        public static Task<GetWorkspaceResult> InvokeAsync(GetWorkspaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceResult>("azurerm:operationalinsights/preview:getWorkspace", args ?? new GetWorkspaceArgs(), options.WithVersion());
    }
