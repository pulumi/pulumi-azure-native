...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    ...
    public partial class SavedSearch : Pulumi.CustomResource
    {
        ...
        public SavedSearch(string name, SavedSearchArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:SavedSearch", name, args ?? new SavedSearchArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SavedSearch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:SavedSearch", name, null, MakeResourceOptions(options, id))
        {
        }
