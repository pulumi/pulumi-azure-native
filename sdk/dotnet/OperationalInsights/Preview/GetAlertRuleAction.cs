...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    public static class GetAlertRuleAction
    {
        public static Task<GetAlertRuleActionResult> InvokeAsync(GetAlertRuleActionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleActionResult>("azurerm:operationalinsights/preview:getAlertRuleAction", args ?? new GetAlertRuleActionArgs(), options.WithVersion());
    }
