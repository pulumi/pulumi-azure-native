...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    ...
    public partial class Incident : Pulumi.CustomResource
    {
        ...
        public Incident(string name, IncidentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:Incident", name, args ?? new IncidentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Incident(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:Incident", name, null, MakeResourceOptions(options, id))
        {
        }
