...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    public static class GetAlertRule
    {
        public static Task<GetAlertRuleResult> InvokeAsync(GetAlertRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleResult>("azurerm:operationalinsights/preview:getAlertRule", args ?? new GetAlertRuleArgs(), options.WithVersion());
    }
