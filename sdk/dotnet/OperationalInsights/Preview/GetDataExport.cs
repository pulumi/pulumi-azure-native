...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    public static class GetDataExport
    {
        public static Task<GetDataExportResult> InvokeAsync(GetDataExportArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataExportResult>("azurerm:operationalinsights/preview:getDataExport", args ?? new GetDataExportArgs(), options.WithVersion());
    }
