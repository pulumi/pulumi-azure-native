...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    ...
    public partial class DataExport : Pulumi.CustomResource
    {
        ...
        public DataExport(string name, DataExportArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:DataExport", name, args ?? new DataExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataExport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:DataExport", name, null, MakeResourceOptions(options, id))
        {
        }
