...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    ...
    public partial class AlertRuleAction : Pulumi.CustomResource
    {
        ...
        public AlertRuleAction(string name, AlertRuleActionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:AlertRuleAction", name, args ?? new AlertRuleActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRuleAction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/preview:AlertRuleAction", name, null, MakeResourceOptions(options, id))
        {
        }
