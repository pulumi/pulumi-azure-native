...
namespace Pulumi.AzureRM.OperationalInsights.Preview
{
    public static class GetLinkedService
    {
        public static Task<GetLinkedServiceResult> InvokeAsync(GetLinkedServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLinkedServiceResult>("azurerm:operationalinsights/preview:getLinkedService", args ?? new GetLinkedServiceArgs(), options.WithVersion());
    }
