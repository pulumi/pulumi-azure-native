...
namespace Pulumi.AzureRM.OperationalInsights
{
    ...
    public partial class DataConnector : Pulumi.CustomResource
    {
        ...
        public DataConnector(string name, DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights:DataConnector", name, args ?? new DataConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights:DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
