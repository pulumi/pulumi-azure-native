...
namespace Pulumi.AzureRM.OperationalInsights.V20200301Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var linkedService = new AzureRM.OperationalInsights.V20200301Preview.LinkedService("linkedService", new AzureRM.OperationalInsights.V20200301Preview.LinkedServiceArgs
    ///         {
    ...
    public partial class LinkedService : Pulumi.CustomResource
    {
        ...
        public LinkedService(string name, LinkedServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20200301preview:LinkedService", name, args ?? new LinkedServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20200301preview:LinkedService", name, null, MakeResourceOptions(options, id))
        {
        }
