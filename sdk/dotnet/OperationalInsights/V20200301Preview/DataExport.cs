...
namespace Pulumi.AzureNextGen.OperationalInsights.V20200301Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:operationalinsights/v20200301preview:DataExport")]
    public partial class DataExport : Pulumi.CustomResource
    {
        ...
        public DataExport(string name, DataExportArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:operationalinsights/v20200301preview:DataExport", name, args ?? new DataExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataExport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:operationalinsights/v20200301preview:DataExport", name, null, MakeResourceOptions(options, id))
        {
        }
