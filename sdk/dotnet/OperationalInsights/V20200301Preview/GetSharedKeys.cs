...
namespace Pulumi.AzureNative.OperationalInsights.V20200301Preview
{
    public static class GetSharedKeys
    {
        ...
        public static Task<GetSharedKeysResult> InvokeAsync(GetSharedKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSharedKeysResult>("azure-native:operationalinsights/v20200301preview:getSharedKeys", args ?? new GetSharedKeysArgs(), options.WithVersion());

        /// <summary>
        /// The shared keys for a workspace.
        /// </summary>
        public static Output<GetSharedKeysResult> Invoke(GetSharedKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSharedKeysResult>("azure-native:operationalinsights/v20200301preview:getSharedKeys", args ?? new GetSharedKeysInvokeArgs(), options.WithVersion());
    }
