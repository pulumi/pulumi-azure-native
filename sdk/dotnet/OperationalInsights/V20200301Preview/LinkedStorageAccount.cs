...
namespace Pulumi.AzureRM.OperationalInsights.V20200301Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var linkedStorageAccount = new AzureRM.OperationalInsights.V20200301Preview.LinkedStorageAccount("linkedStorageAccount", new AzureRM.OperationalInsights.V20200301Preview.LinkedStorageAccountArgs
    ///         {
    ...
    public partial class LinkedStorageAccount : Pulumi.CustomResource
    {
        ...
        public LinkedStorageAccount(string name, LinkedStorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20200301preview:LinkedStorageAccount", name, args ?? new LinkedStorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedStorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20200301preview:LinkedStorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
