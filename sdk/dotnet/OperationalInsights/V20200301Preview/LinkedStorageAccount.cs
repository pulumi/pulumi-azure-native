...
namespace Pulumi.AzureNative.OperationalInsights.V20200301Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:operationalinsights/v20200301preview:LinkedStorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:operationalinsights/v20200801:LinkedStorageAccount to guarantee forwards compatibility.")]
    ...
    public partial class LinkedStorageAccount : global::Pulumi.CustomResource
    {
        ...
        public LinkedStorageAccount(string name, LinkedStorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200301preview:LinkedStorageAccount", name, args ?? new LinkedStorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedStorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200301preview:LinkedStorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
