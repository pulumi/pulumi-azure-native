...
namespace Pulumi.AzureRM.OperationalInsights.V20200301Preview
{
    public static class GetCluster
    {
        public static Task<GetClusterResult> InvokeAsync(GetClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetClusterResult>("azurerm:operationalinsights/v20200301preview:getCluster", args ?? new GetClusterArgs(), options.WithVersion());
    }
