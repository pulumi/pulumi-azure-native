...
namespace Pulumi.AzureNative.OperationalInsights.V20200301Preview
{
    public static class GetLinkedService
    {
        ...
        public static Task<GetLinkedServiceResult> InvokeAsync(GetLinkedServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLinkedServiceResult>("azure-native:operationalinsights/v20200301preview:getLinkedService", args ?? new GetLinkedServiceArgs(), options.WithDefaults());

        /// <summary>
        /// The top level Linked service resource container.
        /// </summary>
        public static Output<GetLinkedServiceResult> Invoke(GetLinkedServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLinkedServiceResult>("azure-native:operationalinsights/v20200301preview:getLinkedService", args ?? new GetLinkedServiceInvokeArgs(), options.WithDefaults());
    }
