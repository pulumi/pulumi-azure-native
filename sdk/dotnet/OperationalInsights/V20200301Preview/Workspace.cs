...
namespace Pulumi.AzureNextGen.OperationalInsights.V20200301Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:operationalinsights/v20200301preview:Workspace")]
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:operationalinsights/v20200301preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:operationalinsights/v20200301preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.OperationalInsights.V20200301Preview.WorkspaceEntityStatus>? ProvisioningState { get; set; }

        /// <summary>
        /// The network access type for accessing Log Analytics ingestion.
        /// </summary>
        [Input("publicNetworkAccessForIngestion")]
        public InputUnion<string, Pulumi.AzureNextGen.OperationalInsights.V20200301Preview.PublicNetworkAccessType>? PublicNetworkAccessForIngestion { get; set; }

        /// <summary>
        /// The network access type for accessing Log Analytics query.
        /// </summary>
        [Input("publicNetworkAccessForQuery")]
        public InputUnion<string, Pulumi.AzureNextGen.OperationalInsights.V20200301Preview.PublicNetworkAccessType>? PublicNetworkAccessForQuery { get; set; }
