...
namespace Pulumi.AzureNative.OperationalInsights.V20200301Preview
{
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200301preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200301preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20200301Preview.WorkspaceEntityStatus>? ProvisioningState { get; set; }

        /// <summary>
        /// The network access type for accessing Log Analytics ingestion.
        /// </summary>
        [Input("publicNetworkAccessForIngestion")]
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20200301Preview.PublicNetworkAccessType>? PublicNetworkAccessForIngestion { get; set; }

        /// <summary>
        /// The network access type for accessing Log Analytics query.
        /// </summary>
        [Input("publicNetworkAccessForQuery")]
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20200301Preview.PublicNetworkAccessType>? PublicNetworkAccessForQuery { get; set; }
