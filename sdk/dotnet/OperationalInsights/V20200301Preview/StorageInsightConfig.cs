...
namespace Pulumi.AzureNative.OperationalInsights.V20200301Preview
{
    ...
    public partial class StorageInsightConfig : Pulumi.CustomResource
    {
        ...
        public StorageInsightConfig(string name, StorageInsightConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200301preview:StorageInsightConfig", name, args ?? new StorageInsightConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageInsightConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20200301preview:StorageInsightConfig", name, null, MakeResourceOptions(options, id))
        {
        }
