...
namespace Pulumi.AzureRM.OperationalInsights
{
    ...
    public partial class SavedSearch : Pulumi.CustomResource
    {
        ...
        public SavedSearch(string name, SavedSearchArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights:SavedSearch", name, args ?? new SavedSearchArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SavedSearch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights:SavedSearch", name, null, MakeResourceOptions(options, id))
        {
        }
