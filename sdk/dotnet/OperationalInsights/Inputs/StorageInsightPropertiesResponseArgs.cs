...
namespace Pulumi.AzureRM.OperationalInsights.Inputs
{
    ...
    /// </summary>
    public sealed class StorageInsightPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        [Input("containers")]
        ...
        public Input<Inputs.StorageInsightStatusResponseArgs> Status { get; set; } = null!;

        /// <summary>
        /// The storage account connection details
        /// </summary>
        [Input("storageAccount", required: true)]
        public Input<Inputs.StorageAccountResponseArgs> StorageAccount { get; set; } = null!;
        ...
        public StorageInsightPropertiesResponseArgs()
        {
        }
    }
}
