...
namespace Pulumi.AzureRM.OperationalInsights.Inputs
{
    ...
    /// </summary>
    public sealed class IncidentPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Additional data on the incident
        /// </summary>
        [Input("additionalData", required: true)]
        public Input<Inputs.IncidentAdditionalDataResponseArgs> AdditionalData { get; set; } = null!;
        ...
        [Input("labels")]
        private InputList<Inputs.IncidentLabelResponseArgs>? _labels;

        /// <summary>
        /// List of labels relevant to this incident
        /// </summary>
        public InputList<Inputs.IncidentLabelResponseArgs> Labels
        {
            get => _labels ?? (_labels = new InputList<Inputs.IncidentLabelResponseArgs>());
            set => _labels = value;
        }
        ...
        /// </summary>
        [Input("owner")]
        public Input<Inputs.IncidentOwnerInfoResponseArgs>? Owner { get; set; }
        ...
        public IncidentPropertiesResponseArgs()
        {
        }
    }
}
