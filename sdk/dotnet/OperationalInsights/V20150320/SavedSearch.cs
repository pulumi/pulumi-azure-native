...
namespace Pulumi.AzureNative.OperationalInsights.V20150320
{
    ...
    /// </summary>
    [Obsolete(@"Version v20150320 will be removed in the next major version of the provider. Upgrade to version v20151101preview or later.")]
    ...
    public partial class SavedSearch : Pulumi.CustomResource
    {
        ...
        public SavedSearch(string name, SavedSearchArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20150320:SavedSearch", name, args ?? new SavedSearchArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SavedSearch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20150320:SavedSearch", name, null, MakeResourceOptions(options, id))
        {
        }
