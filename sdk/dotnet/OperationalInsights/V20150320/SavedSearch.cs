...
namespace Pulumi.AzureRM.OperationalInsights.V20150320
{
    ...
    ///     public MyStack()
    ///     {
    ///         var savedSearch = new AzureRM.OperationalInsights.V20150320.SavedSearch("savedSearch", new AzureRM.OperationalInsights.V20150320.SavedSearchArgs
    ///         {
    ...
    ///             Tags = 
    ///             {
    ///                 new AzureRM.OperationalInsights.V20150320.Inputs.TagArgs
    ///                 {
    ///                     Name = "Group",
    ///                     Value = "Computer",
    ///                 },
    ...
    public partial class SavedSearch : Pulumi.CustomResource
    {
        ...
        public SavedSearch(string name, SavedSearchArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20150320:SavedSearch", name, args ?? new SavedSearchArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SavedSearch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20150320:SavedSearch", name, null, MakeResourceOptions(options, id))
        {
        }
