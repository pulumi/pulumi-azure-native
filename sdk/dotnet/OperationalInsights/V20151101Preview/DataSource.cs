...
namespace Pulumi.AzureRM.OperationalInsights.V20151101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dataSource = new AzureRM.OperationalInsights.V20151101Preview.DataSource("dataSource", new AzureRM.OperationalInsights.V20151101Preview.DataSourceArgs
    ///         {
    ...
    public partial class DataSource : Pulumi.CustomResource
    {
        ...
        public DataSource(string name, DataSourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20151101preview:DataSource", name, args ?? new DataSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/v20151101preview:DataSource", name, null, MakeResourceOptions(options, id))
        {
        }
