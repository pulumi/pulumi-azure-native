...
namespace Pulumi.AzureNative.OperationalInsights.V20151101Preview
{
    ...
    /// {
    ///     var dataSource = new AzureNative.OperationalInsights.V20151101Preview.DataSource("dataSource", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20151101preview:DataSource")]
    public partial class DataSource : global::Pulumi.CustomResource
    {
        ...
        public DataSource(string name, DataSourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20151101preview:DataSource", name, args ?? new DataSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20151101preview:DataSource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20151101Preview.DataSourceKind> Kind { get; set; } = null!;
