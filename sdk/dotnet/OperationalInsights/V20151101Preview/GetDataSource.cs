...
namespace Pulumi.AzureRM.OperationalInsights.V20151101Preview
{
    public static class GetDataSource
    {
        public static Task<GetDataSourceResult> InvokeAsync(GetDataSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataSourceResult>("azurerm:operationalinsights/v20151101preview:getDataSource", args ?? new GetDataSourceArgs(), options.WithVersion());
    }
