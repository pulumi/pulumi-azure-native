...
namespace Pulumi.AzureNative.OperationalInsights.V20211201Preview
{
    ...
    /// {
    ///     var workspace = new AzureNative.OperationalInsights.V20211201Preview.Workspace("workspace", new()
    ///     {
    ///         Location = "australiasoutheast",
    ///         ResourceGroupName = "oiautorest6685",
    ///         RetentionInDays = 30,
    ///         Sku = new AzureNative.OperationalInsights.V20211201Preview.Inputs.WorkspaceSkuArgs
    ///         {
    ///             Name = "PerGB2018",
    ///         },
    ///         Tags = 
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:operationalinsights/v20211201preview:Workspace AzTest2170 /subscriptions/00000000-0000-0000-0000-000000000005/resourcegroups/oiautorest6685/providers/microsoft.operationalinsights/workspaces/aztest2170 
    /// ```
    /// </summary>
    ...
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20211201preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20211201preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20211201Preview.PublicNetworkAccessType>? PublicNetworkAccessForIngestion { get; set; }

        /// <summary>
        /// The network access type for accessing Log Analytics query.
        /// </summary>
        [Input("publicNetworkAccessForQuery")]
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20211201Preview.PublicNetworkAccessType>? PublicNetworkAccessForQuery { get; set; }
