...
namespace Pulumi.AzureNative.OperationalInsights.V20211201Preview
{
    ...
    /// {
    ///     var table = new AzureNative.OperationalInsights.V20211201Preview.Table("table", new()
    ///     {
    ///         ResourceGroupName = "oiautorest6685",
    ///         RetentionInDays = 45,
    ///         Schema = new AzureNative.OperationalInsights.V20211201Preview.Inputs.SchemaArgs
    ///         {
    ///             Columns = new[]
    ///             {
    ///                 new AzureNative.OperationalInsights.V20211201Preview.Inputs.ColumnArgs
    ///                 {
    ///                     Name = "MyNewColumn",
    ///                     Type = "guid",
    ///                 },
