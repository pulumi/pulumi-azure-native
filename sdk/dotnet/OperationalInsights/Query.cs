...
namespace Pulumi.AzureNative.OperationalInsights
{
    ...
    public partial class Query : Pulumi.CustomResource
    {
        ...
        public Query(string name, QueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights:Query", name, args ?? new QueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Query(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights:Query", name, null, MakeResourceOptions(options, id))
        {
        }
