...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    public static class GetLinkedService
    {
        ...
        public static Task<GetLinkedServiceResult> InvokeAsync(GetLinkedServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLinkedServiceResult>("azure-native:operationalinsights/v20250201:getLinkedService", args ?? new GetLinkedServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a linked service instance.
        /// </summary>
        public static Output<GetLinkedServiceResult> Invoke(GetLinkedServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLinkedServiceResult>("azure-native:operationalinsights/v20250201:getLinkedService", args ?? new GetLinkedServiceInvokeArgs(), options.WithDefaults());
