...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20250201:QueryPack")]
    public partial class QueryPack : global::Pulumi.CustomResource
    {
        ...
        public QueryPack(string name, QueryPackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:QueryPack", name, args ?? new QueryPackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueryPack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:QueryPack", name, null, MakeResourceOptions(options, id))
        {
        }
