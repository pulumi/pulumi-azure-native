...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20250201:Table")]
    public partial class Table : global::Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:Table", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TableArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("plan")]
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20250201.TablePlanEnum>? Plan { get; set; }
