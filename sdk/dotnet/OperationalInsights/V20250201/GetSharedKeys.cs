...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    public static class GetSharedKeys
    {
        ...
        public static Task<GetSharedKeysResult> InvokeAsync(GetSharedKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSharedKeysResult>("azure-native:operationalinsights/v20250201:getSharedKeys", args ?? new GetSharedKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the shared keys for a workspace.
        /// </summary>
        public static Output<GetSharedKeysResult> Invoke(GetSharedKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSharedKeysResult>("azure-native:operationalinsights/v20250201:getSharedKeys", args ?? new GetSharedKeysInvokeArgs(), options.WithDefaults());
