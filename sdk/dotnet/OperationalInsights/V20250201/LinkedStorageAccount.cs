...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20250201:LinkedStorageAccount")]
    public partial class LinkedStorageAccount : global::Pulumi.CustomResource
    {
        ...
        public LinkedStorageAccount(string name, LinkedStorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:LinkedStorageAccount", name, args ?? new LinkedStorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedStorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:LinkedStorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
