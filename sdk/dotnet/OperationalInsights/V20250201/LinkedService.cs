...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20250201:LinkedService")]
    public partial class LinkedService : global::Pulumi.CustomResource
    {
        ...
        public LinkedService(string name, LinkedServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:LinkedService", name, args ?? new LinkedServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:LinkedService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LinkedServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20250201.LinkedServiceEntityStatus>? ProvisioningState { get; set; }
