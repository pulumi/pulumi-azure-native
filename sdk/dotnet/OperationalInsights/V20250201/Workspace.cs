...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20250201:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("failover")]
        public Output<Outputs.WorkspaceFailoverPropertiesResponse?> Failover { get; private set; } = null!;
        ...
        /// </summary>
        [Output("replication")]
        public Output<Outputs.WorkspaceReplicationPropertiesResponse?> Replication { get; private set; } = null!;
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20250201.PublicNetworkAccessType>? PublicNetworkAccessForIngestion { get; set; }

        /// <summary>
        /// The network access type for accessing Log Analytics query.
        /// </summary>
        [Input("publicNetworkAccessForQuery")]
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20250201.PublicNetworkAccessType>? PublicNetworkAccessForQuery { get; set; }

        /// <summary>
        /// workspace replication properties.
        /// </summary>
        [Input("replication")]
        public Input<Inputs.WorkspaceReplicationPropertiesArgs>? Replication { get; set; }
