...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    public static class GetSavedSearch
    {
        ...
        public static Task<GetSavedSearchResult> InvokeAsync(GetSavedSearchArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSavedSearchResult>("azure-native:operationalinsights/v20250201:getSavedSearch", args ?? new GetSavedSearchArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified saved search for a given workspace.
        /// </summary>
        public static Output<GetSavedSearchResult> Invoke(GetSavedSearchInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSavedSearchResult>("azure-native:operationalinsights/v20250201:getSavedSearch", args ?? new GetSavedSearchInvokeArgs(), options.WithDefaults());
