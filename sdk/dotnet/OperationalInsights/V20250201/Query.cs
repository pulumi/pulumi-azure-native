...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20250201:Query")]
    public partial class Query : global::Pulumi.CustomResource
    {
        ...
        public Query(string name, QueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:Query", name, args ?? new QueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Query(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20250201:Query", name, null, MakeResourceOptions(options, id))
        {
        }
