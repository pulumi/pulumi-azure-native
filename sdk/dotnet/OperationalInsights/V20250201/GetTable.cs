...
namespace Pulumi.AzureNative.OperationalInsights.V20250201
{
    public static class GetTable
    {
        ...
        public static Task<GetTableResult> InvokeAsync(GetTableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTableResult>("azure-native:operationalinsights/v20250201:getTable", args ?? new GetTableArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Log Analytics workspace table.
        /// </summary>
        public static Output<GetTableResult> Invoke(GetTableInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTableResult>("azure-native:operationalinsights/v20250201:getTable", args ?? new GetTableInvokeArgs(), options.WithDefaults());
