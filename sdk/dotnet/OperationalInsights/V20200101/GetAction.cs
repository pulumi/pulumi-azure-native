...
namespace Pulumi.AzureNextGen.OperationalInsights.V20200101
{
    public static class GetAction
    {
        public static Task<GetActionResult> InvokeAsync(GetActionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetActionResult>("azure-nextgen:operationalinsights/v20200101:getAction", args ?? new GetActionArgs(), options.WithVersion());
    }
