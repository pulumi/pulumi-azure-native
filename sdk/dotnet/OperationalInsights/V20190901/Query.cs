...
namespace Pulumi.AzureNative.OperationalInsights.V20190901
{
    ...
    /// {
    ///     var query = new AzureNative.OperationalInsights.V20190901.Query("query", new()
    ///     {
    ...
    ///         Related = new AzureNative.OperationalInsights.V20190901.Inputs.LogAnalyticsQueryPackQueryPropertiesRelatedArgs
    ///         {
    ///             Categories = new[]
    ///             {
    ///                 "analytics",
    ...
    public partial class Query : global::Pulumi.CustomResource
    {
        ...
        public Query(string name, QueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20190901:Query", name, args ?? new QueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Query(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20190901:Query", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:operationalinsights:Query"},
