...
namespace Pulumi.AzureNative.OperationalInsights.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20230901:Table")]
    public partial class Table : global::Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:Table", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TableArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("plan")]
        public InputUnion<string, Pulumi.AzureNative.OperationalInsights.V20230901.TablePlanEnum>? Plan { get; set; }
