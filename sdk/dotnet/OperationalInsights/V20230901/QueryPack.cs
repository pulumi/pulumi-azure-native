...
namespace Pulumi.AzureNative.OperationalInsights.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20230901:QueryPack")]
    public partial class QueryPack : global::Pulumi.CustomResource
    {
        ...
        public QueryPack(string name, QueryPackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:QueryPack", name, args ?? new QueryPackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QueryPack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:QueryPack", name, null, MakeResourceOptions(options, id))
        {
        }
