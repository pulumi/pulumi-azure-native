...
namespace Pulumi.AzureNative.OperationalInsights.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20230901:Query")]
    public partial class Query : global::Pulumi.CustomResource
    {
        ...
        public Query(string name, QueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:Query", name, args ?? new QueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Query(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:Query", name, null, MakeResourceOptions(options, id))
        {
        }
