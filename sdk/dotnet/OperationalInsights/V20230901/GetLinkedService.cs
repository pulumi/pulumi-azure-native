...
namespace Pulumi.AzureNative.OperationalInsights.V20230901
{
    public static class GetLinkedService
    {
        ...
        public static Task<GetLinkedServiceResult> InvokeAsync(GetLinkedServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLinkedServiceResult>("azure-native:operationalinsights/v20230901:getLinkedService", args ?? new GetLinkedServiceArgs(), options.WithDefaults());
