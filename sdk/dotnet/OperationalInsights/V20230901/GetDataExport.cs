...
namespace Pulumi.AzureNative.OperationalInsights.V20230901
{
    public static class GetDataExport
    {
        ...
        public static Task<GetDataExportResult> InvokeAsync(GetDataExportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataExportResult>("azure-native:operationalinsights/v20230901:getDataExport", args ?? new GetDataExportArgs(), options.WithDefaults());
