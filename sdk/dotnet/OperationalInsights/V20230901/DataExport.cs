...
namespace Pulumi.AzureNative.OperationalInsights.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20230901:DataExport")]
    public partial class DataExport : global::Pulumi.CustomResource
    {
        ...
        public DataExport(string name, DataExportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:DataExport", name, args ?? new DataExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataExport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:DataExport", name, null, MakeResourceOptions(options, id))
        {
        }
