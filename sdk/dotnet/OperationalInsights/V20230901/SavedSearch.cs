...
namespace Pulumi.AzureNative.OperationalInsights.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:operationalinsights/v20230901:SavedSearch")]
    public partial class SavedSearch : global::Pulumi.CustomResource
    {
        ...
        public SavedSearch(string name, SavedSearchArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:SavedSearch", name, args ?? new SavedSearchArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SavedSearch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/v20230901:SavedSearch", name, null, MakeResourceOptions(options, id))
        {
        }
