...
namespace Pulumi.AzureNative.OperationalInsights.V20230901
{
    public static class GetQuery
    {
        ...
        public static Task<GetQueryResult> InvokeAsync(GetQueryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetQueryResult>("azure-native:operationalinsights/v20230901:getQuery", args ?? new GetQueryArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a specific Log Analytics Query defined within a Log Analytics QueryPack.
        /// </summary>
        public static Output<GetQueryResult> Invoke(GetQueryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetQueryResult>("azure-native:operationalinsights/v20230901:getQuery", args ?? new GetQueryInvokeArgs(), options.WithDefaults());
    }
