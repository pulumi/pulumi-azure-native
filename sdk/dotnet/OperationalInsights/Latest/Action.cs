...
namespace Pulumi.AzureNextGen.OperationalInsights.Latest
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:operationalinsights/latest:Action")]
    public partial class Action : Pulumi.CustomResource
    {
        ...
        public Action(string name, ActionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:operationalinsights/latest:Action", name, args ?? new ActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Action(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:operationalinsights/latest:Action", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:operationalinsights/v20200101:Action"},
                },
            };
