...
namespace Pulumi.AzureNative.OperationalInsights.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:operationalinsights:StorageInsightConfig'.")]
    [AzureNativeResourceType("azure-native:operationalinsights/latest:StorageInsightConfig")]
    public partial class StorageInsightConfig : Pulumi.CustomResource
    {
        ...
        public StorageInsightConfig(string name, StorageInsightConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/latest:StorageInsightConfig", name, args ?? new StorageInsightConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageInsightConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/latest:StorageInsightConfig", name, null, MakeResourceOptions(options, id))
        {
        }
