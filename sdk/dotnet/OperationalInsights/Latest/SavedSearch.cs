...
namespace Pulumi.AzureNative.OperationalInsights.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:operationalinsights:SavedSearch'.")]
    [AzureNativeResourceType("azure-native:operationalinsights/latest:SavedSearch")]
    public partial class SavedSearch : Pulumi.CustomResource
    {
        ...
        public SavedSearch(string name, SavedSearchArgs args, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/latest:SavedSearch", name, args ?? new SavedSearchArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SavedSearch(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:operationalinsights/latest:SavedSearch", name, null, MakeResourceOptions(options, id))
        {
        }
