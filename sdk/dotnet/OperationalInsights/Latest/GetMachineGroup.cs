...
namespace Pulumi.AzureRM.OperationalInsights.Latest
{
    public static class GetMachineGroup
    {
        public static Task<GetMachineGroupResult> InvokeAsync(GetMachineGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineGroupResult>("azurerm:operationalinsights/latest:getMachineGroup", args ?? new GetMachineGroupArgs(), options.WithVersion());
    }
