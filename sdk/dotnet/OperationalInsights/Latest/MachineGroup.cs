...
namespace Pulumi.AzureRM.OperationalInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineGroup = new AzureRM.OperationalInsights.Latest.MachineGroup("machineGroup", new AzureRM.OperationalInsights.Latest.MachineGroupArgs
    ///         {
    ///             Count = 1,
    ///             DisplayName = "Foo",
    ...
    ///             Machines = 
    ///             {
    ///                 new AzureRM.OperationalInsights.Latest.Inputs.MachineReferenceWithHintsArgs
    ///                 {
    ...
    public partial class MachineGroup : Pulumi.CustomResource
    {
        ...
        public MachineGroup(string name, MachineGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/latest:MachineGroup", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MachineGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights/latest:MachineGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:operationalinsights/v20151101preview:MachineGroup"},
                },
            };
