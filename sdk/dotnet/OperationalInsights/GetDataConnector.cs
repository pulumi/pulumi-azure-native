...
namespace Pulumi.AzureRM.OperationalInsights
{
    public static class GetDataConnector
    {
        public static Task<GetDataConnectorResult> InvokeAsync(GetDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectorResult>("azurerm:operationalinsights:getDataConnector", args ?? new GetDataConnectorArgs(), options.WithVersion());
    }
