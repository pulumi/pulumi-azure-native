...
namespace Pulumi.AzureRM.OperationalInsights
{
    ...
    public partial class AlertRule : Pulumi.CustomResource
    {
        ...
        public AlertRule(string name, AlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights:AlertRule", name, args ?? new AlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:operationalinsights:AlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
