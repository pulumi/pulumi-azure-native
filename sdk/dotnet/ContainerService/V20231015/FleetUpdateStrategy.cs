...
namespace Pulumi.AzureNative.ContainerService.V20231015
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20231015:FleetUpdateStrategy")]
    public partial class FleetUpdateStrategy : global::Pulumi.CustomResource
    {
        ...
        public FleetUpdateStrategy(string name, FleetUpdateStrategyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20231015:FleetUpdateStrategy", name, args ?? new FleetUpdateStrategyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FleetUpdateStrategy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20231015:FleetUpdateStrategy", name, null, MakeResourceOptions(options, id))
        {
        }
