...
namespace Pulumi.AzureNative.ContainerService.V20231015
{
    public static class GetUpdateRun
    {
        ...
        public static Task<GetUpdateRunResult> InvokeAsync(GetUpdateRunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUpdateRunResult>("azure-native:containerservice/v20231015:getUpdateRun", args ?? new GetUpdateRunArgs(), options.WithDefaults());

        /// <summary>
        /// Get a UpdateRun
        /// </summary>
        public static Output<GetUpdateRunResult> Invoke(GetUpdateRunInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUpdateRunResult>("azure-native:containerservice/v20231015:getUpdateRun", args ?? new GetUpdateRunInvokeArgs(), options.WithDefaults());
    }
