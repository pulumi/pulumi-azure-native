...
namespace Pulumi.AzureNative.ContainerService.V20231015
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20231015:FleetMember")]
    public partial class FleetMember : global::Pulumi.CustomResource
    {
        ...
        public FleetMember(string name, FleetMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20231015:FleetMember", name, args ?? new FleetMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FleetMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20231015:FleetMember", name, null, MakeResourceOptions(options, id))
        {
        }
