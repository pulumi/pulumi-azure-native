...
namespace Pulumi.AzureNative.ContainerService.V20220502Preview.Inputs
{
    ...
    public sealed class ManagedClusterSKUArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20220502Preview.ManagedClusterSKUName>? Name { get; set; }

        /// <summary>
        /// If not specified, the default is 'Free'. See [uptime SLA](https://docs.microsoft.com/azure/aks/uptime-sla) for more details.
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20220502Preview.ManagedClusterSKUTier>? Tier { get; set; }
