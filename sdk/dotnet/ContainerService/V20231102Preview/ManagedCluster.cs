...
namespace Pulumi.AzureNative.ContainerService.V20231102Preview
{
    ...
    /// Managed cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20231102preview:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20231102preview:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20231102preview:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20231102Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        /// </summary>
        [Input("supportPlan")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20231102Preview.KubernetesSupportPlan>? SupportPlan { get; set; }
