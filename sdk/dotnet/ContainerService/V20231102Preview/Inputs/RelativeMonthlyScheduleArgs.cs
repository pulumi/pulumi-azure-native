...
namespace Pulumi.AzureNative.ContainerService.V20231102Preview.Inputs
{
    ...
    public sealed class RelativeMonthlyScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20231102Preview.WeekDay> DayOfWeek { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20231102Preview.Type> WeekIndex { get; set; } = null!;
