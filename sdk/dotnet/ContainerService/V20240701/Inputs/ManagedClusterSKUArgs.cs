...
namespace Pulumi.AzureNative.ContainerService.V20240701.Inputs
{
    ...
    public sealed class ManagedClusterSKUArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240701.ManagedClusterSKUName>? Name { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240701.ManagedClusterSKUTier>? Tier { get; set; }
