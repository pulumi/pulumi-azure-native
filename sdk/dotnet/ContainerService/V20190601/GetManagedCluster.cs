...
namespace Pulumi.AzureRM.ContainerService.V20190601
{
    public static class GetManagedCluster
    {
        public static Task<GetManagedClusterResult> InvokeAsync(GetManagedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedClusterResult>("azurerm:containerservice/v20190601:getManagedCluster", args ?? new GetManagedClusterArgs(), options.WithVersion());
    }
