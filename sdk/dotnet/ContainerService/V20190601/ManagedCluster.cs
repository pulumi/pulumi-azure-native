...
namespace Pulumi.AzureNative.ContainerService.V20190601
{
    ...
    /// {
    ///     var managedCluster = new AzureNative.ContainerService.V20190601.ManagedCluster("managedCluster", new()
    ///     {
    ///         AddonProfiles = null,
    ///         AgentPoolProfiles = new[]
    ///         {
    ///             new AzureNative.ContainerService.V20190601.Inputs.ManagedClusterAgentPoolProfileArgs
    ///             {
    ...
    ///         EnableRBAC = true,
    ///         KubernetesVersion = "",
    ///         LinuxProfile = new AzureNative.ContainerService.V20190601.Inputs.ContainerServiceLinuxProfileArgs
    ///         {
    ///             AdminUsername = "azureuser",
    ///             Ssh = new AzureNative.ContainerService.V20190601.Inputs.ContainerServiceSshConfigurationArgs
    ///             {
    ///                 PublicKeys = new[]
    ///                 {
    ///                     new AzureNative.ContainerService.V20190601.Inputs.ContainerServiceSshPublicKeyArgs
    ///                     {
    ///                         KeyData = "keydata",
    ///                     },
    ///                 },
    ...
    ///         },
    ///         Location = "location1",
    ///         NetworkProfile = new AzureNative.ContainerService.V20190601.Inputs.ContainerServiceNetworkProfileArgs
    ///         {
    ///             LoadBalancerSku = "basic",
    ///         },
    ///         ResourceGroupName = "rg1",
    ///         ResourceName = "clustername1",
    ///         ServicePrincipalProfile = new AzureNative.ContainerService.V20190601.Inputs.ManagedClusterServicePrincipalProfileArgs
    ///         {
    ///             ClientId = "clientid",
    ///             Secret = "secret",
    ///         },
    ...
    ///             { "tier", "production" },
    ///         },
    ///         WindowsProfile = new AzureNative.ContainerService.V20190601.Inputs.ManagedClusterWindowsProfileArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:containerservice/v20190601:ManagedCluster clustername1 /subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/clustername1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20190601:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20190601:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20190601:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
