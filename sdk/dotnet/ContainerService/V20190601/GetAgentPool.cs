...
namespace Pulumi.AzureRM.ContainerService.V20190601
{
    public static class GetAgentPool
    {
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azurerm:containerservice/v20190601:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithVersion());
    }
