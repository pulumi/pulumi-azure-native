...
namespace Pulumi.AzureNative.ContainerService.V20220201
{
    public static class GetSnapshot
    {
        ...
        public static Task<GetSnapshotResult> InvokeAsync(GetSnapshotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotResult>("azure-native:containerservice/v20220201:getSnapshot", args ?? new GetSnapshotArgs(), options.WithDefaults());

        /// <summary>
        /// A node pool snapshot resource.
        /// </summary>
        public static Output<GetSnapshotResult> Invoke(GetSnapshotInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSnapshotResult>("azure-native:containerservice/v20220201:getSnapshot", args ?? new GetSnapshotInvokeArgs(), options.WithDefaults());
    }
