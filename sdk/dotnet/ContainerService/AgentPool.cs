...
namespace Pulumi.AzureNextGen.ContainerService
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:containerservice:AgentPool")]
    public partial class AgentPool : Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerservice:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerservice:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
