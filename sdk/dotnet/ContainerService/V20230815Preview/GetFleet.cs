...
namespace Pulumi.AzureNative.ContainerService.V20230815Preview
{
    public static class GetFleet
    {
        ...
        public static Task<GetFleetResult> InvokeAsync(GetFleetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFleetResult>("azure-native:containerservice/v20230815preview:getFleet", args ?? new GetFleetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Fleet.
        /// </summary>
        public static Output<GetFleetResult> Invoke(GetFleetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFleetResult>("azure-native:containerservice/v20230815preview:getFleet", args ?? new GetFleetInvokeArgs(), options.WithDefaults());
    }
