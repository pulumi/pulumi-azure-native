...
namespace Pulumi.AzureNative.ContainerService.V20230815Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230815preview:FleetMember")]
    public partial class FleetMember : global::Pulumi.CustomResource
    {
        ...
        public FleetMember(string name, FleetMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230815preview:FleetMember", name, args ?? new FleetMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FleetMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230815preview:FleetMember", name, null, MakeResourceOptions(options, id))
        {
        }
