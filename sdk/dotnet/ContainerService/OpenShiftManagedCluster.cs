...
namespace Pulumi.AzureRM.ContainerService
{
    ...
    public partial class OpenShiftManagedCluster : Pulumi.CustomResource
    {
        ...
        public OpenShiftManagedCluster(string name, OpenShiftManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice:OpenShiftManagedCluster", name, args ?? new OpenShiftManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftManagedCluster(string name, Input<string> id, OpenShiftManagedClusterState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:containerservice:OpenShiftManagedCluster", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpenShiftManagedCluster Get(string name, Input<string> id, OpenShiftManagedClusterState? state = null, CustomResourceOptions? options = null)
        {
            return new OpenShiftManagedCluster(name, id, state, options);
        }
    }
    ...
    public sealed class OpenShiftManagedClusterState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource location
        /// </summary>
        ...
        /// </summary>
        [Input("plan")]
        public Input<Inputs.PurchasePlanResponseGetArgs>? Plan { get; set; }

        /// <summary>
        /// Properties of a OpenShift managed cluster.
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.OpenShiftManagedClusterPropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public OpenShiftManagedClusterState()
        {
        }
    }
}
