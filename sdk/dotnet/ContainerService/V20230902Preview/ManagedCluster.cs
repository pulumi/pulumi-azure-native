...
namespace Pulumi.AzureNative.ContainerService.V20230902Preview
{
    ...
    /// Managed cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230902preview:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("guardrailsProfile")]
        public Output<Outputs.GuardrailsProfileResponse?> GuardrailsProfile { get; private set; } = null!;
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230902preview:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230902preview:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// The guardrails profile holds all the guardrails information for a given cluster
        /// </summary>
        [Input("guardrailsProfile")]
        public Input<Inputs.GuardrailsProfileArgs>? GuardrailsProfile { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230902Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        /// </summary>
        [Input("supportPlan")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230902Preview.KubernetesSupportPlan>? SupportPlan { get; set; }
