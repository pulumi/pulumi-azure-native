...
namespace Pulumi.AzureNative.ContainerService.V20230902Preview.Inputs
{
    ...
    public sealed class ManagedClusterPropertiesAutoScalerProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("expander")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230902Preview.Expander>? Expander { get; set; }

        [Input("expanders")]
        private InputList<Union<string, Pulumi.AzureNative.ContainerService.V20230902Preview.Expander>>? _expanders;
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerService.V20230902Preview.Expander>> Expanders
        {
            get => _expanders ?? (_expanders = new InputList<Union<string, Pulumi.AzureNative.ContainerService.V20230902Preview.Expander>>());
