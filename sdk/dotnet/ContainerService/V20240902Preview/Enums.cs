...
namespace Pulumi.AzureNative.ContainerService.V20240902Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct DriverType : IEquatable<DriverType>
    {
        private readonly string _value;
        ...
        /// </summary>
        public static DriverType GRID { get; } = new DriverType("GRID");
        /// <summary>
        ...
        /// </summary>
        public static DriverType CUDA { get; } = new DriverType("CUDA");

        public static bool operator ==(DriverType left, DriverType right) => left.Equals(right);
        public static bool operator !=(DriverType left, DriverType right) => !left.Equals(right);

        public static explicit operator string(DriverType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is DriverType other && Equals(other);
        public bool Equals(DriverType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct PodLinkLocalAccess : IEquatable<PodLinkLocalAccess>
    {
        private readonly string _value;

        private PodLinkLocalAccess(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static PodLinkLocalAccess IMDS { get; } = new PodLinkLocalAccess("IMDS");
        /// <summary>
        /// Pods with hostNetwork=false cannot access Azure Instance Metadata Service (IMDS).
        /// </summary>
        public static PodLinkLocalAccess None { get; } = new PodLinkLocalAccess("None");

        public static bool operator ==(PodLinkLocalAccess left, PodLinkLocalAccess right) => left.Equals(right);
        public static bool operator !=(PodLinkLocalAccess left, PodLinkLocalAccess right) => !left.Equals(right);

        public static explicit operator string(PodLinkLocalAccess value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is PodLinkLocalAccess other && Equals(other);
        public bool Equals(PodLinkLocalAccess other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct SeccompDefault : IEquatable<SeccompDefault>
    {
        private readonly string _value;

        private SeccompDefault(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static SeccompDefault Unconfined { get; } = new SeccompDefault("Unconfined");
        /// <summary>
        /// The default seccomp profile for container runtime is applied, which restricts certain system calls for enhanced security.
        /// </summary>
        public static SeccompDefault RuntimeDefault { get; } = new SeccompDefault("RuntimeDefault");

        public static bool operator ==(SeccompDefault left, SeccompDefault right) => left.Equals(right);
        public static bool operator !=(SeccompDefault left, SeccompDefault right) => !left.Equals(right);

        public static explicit operator string(SeccompDefault value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is SeccompDefault other && Equals(other);
        public bool Equals(SeccompDefault other) => string.Equals(_value, other._value, StringComparison.Ordinal);
