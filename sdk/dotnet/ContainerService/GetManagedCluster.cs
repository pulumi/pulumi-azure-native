...
namespace Pulumi.AzureRM.ContainerService
{
    public static class GetManagedCluster
    {
        public static Task<GetManagedClusterResult> InvokeAsync(GetManagedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedClusterResult>("azurerm:containerservice:getManagedCluster", args ?? new GetManagedClusterArgs(), options.WithVersion());
    }
