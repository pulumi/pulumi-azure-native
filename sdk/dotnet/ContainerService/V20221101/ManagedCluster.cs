...
namespace Pulumi.AzureNative.ContainerService.V20221101
{
    ...
    /// Managed cluster.
    /// </summary>
    [Obsolete(@"azure-native:containerservice/v20221101:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerservice/v20221101:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20221101:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20221101:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221101.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
