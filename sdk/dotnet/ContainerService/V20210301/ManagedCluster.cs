...
namespace Pulumi.AzureNative.ContainerService.V20210301
{
    ...
    /// {
    ///     var managedCluster = new AzureNative.ContainerService.V20210301.ManagedCluster("managedCluster", new()
    ///     {
    ///         AddonProfiles = 
    ///         {
    ///             { "azureKeyvaultSecretsProvider", new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterAddonProfileArgs
    ///             {
    ///                 Config = 
    ///                 {
    ...
    ///         {
    ///             new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterAgentPoolProfileArgs
    ///             {
    ///                 Count = 3,
    ...
    ///             },
    ///         },
    ///         AutoScalerProfile = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterPropertiesAutoScalerProfileArgs
    ///         {
    ...
    ///         EnableRBAC = true,
    ///         KubernetesVersion = "",
    ///         LinuxProfile = new AzureNative.ContainerService.V20210301.Inputs.ContainerServiceLinuxProfileArgs
    ///         {
    ///             AdminUsername = "azureuser",
    ///             Ssh = new AzureNative.ContainerService.V20210301.Inputs.ContainerServiceSshConfigurationArgs
    ///             {
    ///                 PublicKeys = new[]
    ///                 {
    ///                     new AzureNative.ContainerService.V20210301.Inputs.ContainerServiceSshPublicKeyArgs
    ///                     {
    ///                         KeyData = "keydata",
    ///                     },
    ///                 },
    ...
    ///         },
    ///         Location = "location1",
    ///         NetworkProfile = new AzureNative.ContainerService.V20210301.Inputs.ContainerServiceNetworkProfileArgs
    ///         {
    ///             LoadBalancerProfile = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterLoadBalancerProfileArgs
    ///             {
    ///                 ManagedOutboundIPs = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs
    ///                 {
    ///                     Count = 2,
    ///                 },
    ///             },
    ...
    ///         ServicePrincipalProfile = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterServicePrincipalProfileArgs
    ///         {
    ///             ClientId = "clientid",
    ///             Secret = "secret",
    ///         },
    ///         Sku = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterSKUArgs
    ///         {
    ///             Name = "Basic",
    ///             Tier = "Free",
    ///         },
    ...
    ///             { "tier", "production" },
    ///         },
    ///         WindowsProfile = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterWindowsProfileArgs
    ///         {
    ...
    ///         EnablePodSecurityPolicy = true,
    ///         EnableRBAC = true,
    ///         HttpProxyConfig = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterHTTPProxyConfigArgs
    ///         {
    ...
    ///             OutboundType = "loadBalancer",
    ///         },
    ///         PodIdentityProfile = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterPodIdentityProfileArgs
    ///         {
    ...
    ///             },
    ///         },
    ///         ApiServerAccessProfile = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterAPIServerAccessProfileArgs
    ///         {
    ...
    ///     var managedCluster = new AzureNative.ContainerService.V20210301.ManagedCluster("managedCluster", new()
    ///     {
    ///         AadProfile = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterAADProfileArgs
    ///         {
    ...
    ///         EnablePodSecurityPolicy = true,
    ///         EnableRBAC = true,
    ///         Identity = new AzureNative.ContainerService.V20210301.Inputs.ManagedClusterIdentityArgs
    ///         {
    ///             Type = AzureNative.ContainerService.V20210301.ResourceIdentityType.UserAssigned,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20210301:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20210301:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20210301:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
