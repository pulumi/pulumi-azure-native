...
namespace Pulumi.AzureNative.ContainerService
{
    public static class GetFleet
    {
        ...
        public static Task<GetFleetResult> InvokeAsync(GetFleetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFleetResult>("azure-native:containerservice:getFleet", args ?? new GetFleetArgs(), options.WithDefaults());
        ...
        public static Output<GetFleetResult> Invoke(GetFleetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFleetResult>("azure-native:containerservice:getFleet", args ?? new GetFleetInvokeArgs(), options.WithDefaults());
    }
