...
namespace Pulumi.AzureRM.ContainerService.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedCluster = new AzureRM.ContainerService.V20200601.ManagedCluster("managedCluster", new AzureRM.ContainerService.V20200601.ManagedClusterArgs
    ///         {
    ///             AddonProfiles = ,
    ///             AgentPoolProfiles = 
    ///             {
    ///                 new AzureRM.ContainerService.V20200601.Inputs.ManagedClusterAgentPoolProfileArgs
    ///                 {
    ///                     Count = 3,
    ...
    ///                 },
    ///             },
    ///             AutoScalerProfile = new AzureRM.ContainerService.V20200601.Inputs.ManagedClusterPropertiesAutoScalerProfileArgs
    ///             {
    ...
    ///             EnableRBAC = true,
    ///             KubernetesVersion = "",
    ///             LinuxProfile = new AzureRM.ContainerService.V20200601.Inputs.ContainerServiceLinuxProfileArgs
    ///             {
    ///                 AdminUsername = "azureuser",
    ///                 Ssh = new AzureRM.ContainerService.V20200601.Inputs.ContainerServiceSshConfigurationArgs
    ///                 {
    ///                     PublicKeys = 
    ///                     {
    ///                         new AzureRM.ContainerService.V20200601.Inputs.ContainerServiceSshPublicKeyArgs
    ///                         {
    ///                             KeyData = "keydata",
    ///                         },
    ///                     },
    ...
    ///             },
    ///             Location = "location1",
    ///             NetworkProfile = new AzureRM.ContainerService.V20200601.Inputs.ContainerServiceNetworkProfileArgs
    ///             {
    ///                 LoadBalancerProfile = new AzureRM.ContainerService.V20200601.Inputs.ManagedClusterLoadBalancerProfileArgs
    ///                 {
    ///                     ManagedOutboundIPs = new AzureRM.ContainerService.V20200601.Inputs.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs
    ///                     {
    ///                         Count = 2,
    ///                     },
    ///                 },
    ...
    ///             ServicePrincipalProfile = new AzureRM.ContainerService.V20200601.Inputs.ManagedClusterServicePrincipalProfileArgs
    ///             {
    ///                 ClientId = "clientid",
    ///                 Secret = "secret",
    ///             },
    ///             Sku = new AzureRM.ContainerService.V20200601.Inputs.ManagedClusterSKUArgs
    ///             {
    ///                 Name = "Basic",
    ///                 Tier = "Free",
    ///             },
    ...
    ///                 { "tier", "production" },
    ///             },
    ///             WindowsProfile = new AzureRM.ContainerService.V20200601.Inputs.ManagedClusterWindowsProfileArgs
    ///             {
    ...
    ///         var managedCluster = new AzureRM.ContainerService.V20200601.ManagedCluster("managedCluster", new AzureRM.ContainerService.V20200601.ManagedClusterArgs
    ///         {
    ///             AadProfile = new AzureRM.ContainerService.V20200601.Inputs.ManagedClusterAADProfileArgs
    ///             {
    ...
    ///             EnablePodSecurityPolicy = true,
    ///             EnableRBAC = true,
    ///             Identity = new AzureRM.ContainerService.V20200601.Inputs.ManagedClusterIdentityArgs
    ///             {
    ///                 Type = "UserAssigned",
    ///             },
    ///             KubernetesVersion = "",
    ...
    public partial class ManagedCluster : Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20200601:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20200601:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
