...
namespace Pulumi.AzureNative.ContainerService.V20220602Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20220602preview:ManagedClusterSnapshot")]
    public partial class ManagedClusterSnapshot : Pulumi.CustomResource
    {
        ...
        public ManagedClusterSnapshot(string name, ManagedClusterSnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220602preview:ManagedClusterSnapshot", name, args ?? new ManagedClusterSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedClusterSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220602preview:ManagedClusterSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
