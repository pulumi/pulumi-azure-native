...
namespace Pulumi.AzureNative.ContainerService.V20220602Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:containerservice/v20220602preview:Snapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:Snapshot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerservice/v20220602preview:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220602preview:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220602preview:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SnapshotArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("snapshotType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20220602Preview.SnapshotType>? SnapshotType { get; set; }
