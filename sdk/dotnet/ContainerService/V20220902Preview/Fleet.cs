...
namespace Pulumi.AzureNative.ContainerService.V20220902Preview
{
    ...
    /// {
    ///     var fleet = new AzureNative.ContainerService.V20220902Preview.Fleet("fleet", new()
    ///     {
    ///         FleetName = "fleet-1",
    ///         HubProfile = new AzureNative.ContainerService.V20220902Preview.Inputs.FleetHubProfileArgs
    ///         {
    ...
    public partial class Fleet : global::Pulumi.CustomResource
    {
        ...
        public Fleet(string name, FleetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220902preview:Fleet", name, args ?? new FleetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fleet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220902preview:Fleet", name, null, MakeResourceOptions(options, id))
        {
        }
