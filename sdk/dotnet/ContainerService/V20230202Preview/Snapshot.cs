...
namespace Pulumi.AzureNative.ContainerService.V20230202Preview
{
    ...
    /// {
    ///     var snapshot = new AzureNative.ContainerService.V20230202Preview.Snapshot("snapshot", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230202preview:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230202preview:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230202preview:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
