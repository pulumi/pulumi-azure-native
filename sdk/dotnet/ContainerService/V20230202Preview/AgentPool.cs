...
namespace Pulumi.AzureNative.ContainerService.V20230202Preview
{
    ...
    /// {
    ///     var agentPool = new AzureNative.ContainerService.V20230202Preview.AgentPool("agentPool", new()
    ///     {
    ...
    ///         AgentPoolName = "agentpool1",
    ///         Count = 3,
    ///         CreationData = new AzureNative.ContainerService.V20230202Preview.Inputs.CreationDataArgs
    ///         {
    ...
    ///         KubeletConfig = new AzureNative.ContainerService.V20230202Preview.Inputs.KubeletConfigArgs
    ///         {
    ...
    ///         },
    ///         LinuxOSConfig = new AzureNative.ContainerService.V20230202Preview.Inputs.LinuxOSConfigArgs
    ///         {
    ///             SwapFileSizeMB = 1500,
    ///             Sysctls = new AzureNative.ContainerService.V20230202Preview.Inputs.SysctlConfigArgs
    ///             {
    ...
    ///         ResourceName = "clustername1",
    ///         VmSize = "Standard_D4s_v3",
    ///         WindowsProfile = new AzureNative.ContainerService.V20230202Preview.Inputs.AgentPoolWindowsProfileArgs
    ///         {
    ...
    ///     {
    ///         AgentPoolName = "agentpool1",
    ///         PowerState = new AzureNative.ContainerService.V20230202Preview.Inputs.PowerStateArgs
    ///         {
    ///             Code = "Running",
    ///         },
    ///         ResourceGroupName = "rg1",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:containerservice/v20230202preview:AgentPool agentpool1 /subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/clustername1/agentPools/agentpool1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230202preview:AgentPool")]
    public partial class AgentPool : global::Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230202preview:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230202preview:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AgentPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.GPUInstanceProfile>? GpuInstanceProfile { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.KubeletDiskType>? KubeletDiskType { get; set; }
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.AgentPoolMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("osDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.OSDiskType>? OsDiskType { get; set; }

        /// <summary>
        /// Specifies the OS SKU used by the agent pool. If not specified, the default is Ubuntu if OSType=Linux or Windows2019 if OSType=Windows. And the default Windows OSSKU will be changed to Windows2022 after Windows2019 is deprecated.
        /// </summary>
        [Input("osSKU")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.OSSKU>? OsSKU { get; set; }

        /// <summary>
        /// The operating system type. The default is Linux.
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.OSType>? OsType { get; set; }
        ...
        /// </summary>
        [Input("scaleDownMode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.ScaleDownMode>? ScaleDownMode { get; set; }

        /// <summary>
        /// This cannot be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'.
        /// </summary>
        [Input("scaleSetEvictionPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.ScaleSetEvictionPolicy>? ScaleSetEvictionPolicy { get; set; }

        /// <summary>
        /// The Virtual Machine Scale Set priority. If not specified, the default is 'Regular'.
        /// </summary>
        [Input("scaleSetPriority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.ScaleSetPriority>? ScaleSetPriority { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.AgentPoolType>? Type { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.WorkloadRuntime>? WorkloadRuntime { get; set; }
