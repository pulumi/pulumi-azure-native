...
namespace Pulumi.AzureNative.ContainerService.V20230202Preview.Inputs
{
    ...
    public sealed class ManagedClusterSKUArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.ManagedClusterSKUName>? Name { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230202Preview.ManagedClusterSKUTier>? Tier { get; set; }
