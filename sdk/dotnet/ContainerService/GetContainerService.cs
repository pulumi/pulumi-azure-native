...
namespace Pulumi.AzureRM.ContainerService
{
    public static class GetContainerService
    {
        public static Task<GetContainerServiceResult> InvokeAsync(GetContainerServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContainerServiceResult>("azurerm:containerservice:getContainerService", args ?? new GetContainerServiceArgs(), options.WithVersion());
    }
