...
namespace Pulumi.AzureNative.ContainerService.V20210901
{
    ...
    /// Agent Pool.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20210901:AgentPool")]
    public partial class AgentPool : Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20210901:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20210901:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AgentPoolArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.GPUInstanceProfile>? GpuInstanceProfile { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.KubeletDiskType>? KubeletDiskType { get; set; }
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.AgentPoolMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("osDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.OSDiskType>? OsDiskType { get; set; }

        /// <summary>
        /// Specifies an OS SKU. This value must not be specified if OSType is Windows.
        /// </summary>
        [Input("osSKU")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.OSSKU>? OsSKU { get; set; }

        /// <summary>
        /// The operating system type. The default is Linux.
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.OSType>? OsType { get; set; }
        ...
        /// </summary>
        [Input("scaleDownMode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.ScaleDownMode>? ScaleDownMode { get; set; }

        /// <summary>
        /// This cannot be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'.
        /// </summary>
        [Input("scaleSetEvictionPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.ScaleSetEvictionPolicy>? ScaleSetEvictionPolicy { get; set; }

        /// <summary>
        /// The Virtual Machine Scale Set priority. If not specified, the default is 'Regular'.
        /// </summary>
        [Input("scaleSetPriority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.ScaleSetPriority>? ScaleSetPriority { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.AgentPoolType>? Type { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20210901.WorkloadRuntime>? WorkloadRuntime { get; set; }
