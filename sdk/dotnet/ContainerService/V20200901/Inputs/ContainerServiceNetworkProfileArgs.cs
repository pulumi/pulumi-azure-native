...
namespace Pulumi.AzureNative.ContainerService.V20200901.Inputs
{
    ...
    public sealed class ContainerServiceNetworkProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20200901.LoadBalancerSku>? LoadBalancerSku { get; set; }

        /// <summary>
        /// Network mode used for building Kubernetes network.
        /// </summary>
        [Input("networkMode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20200901.NetworkMode>? NetworkMode { get; set; }

        /// <summary>
        /// Network plugin used for building Kubernetes network.
        /// </summary>
        [Input("networkPlugin")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20200901.NetworkPlugin>? NetworkPlugin { get; set; }

        /// <summary>
        /// Network policy used for building Kubernetes network.
        /// </summary>
        [Input("networkPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20200901.NetworkPolicy>? NetworkPolicy { get; set; }

        /// <summary>
        /// The outbound (egress) routing method.
        /// </summary>
        [Input("outboundType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20200901.OutboundType>? OutboundType { get; set; }
