...
namespace Pulumi.AzureNative.ContainerService
{
    ...
    public partial class FleetUpdateStrategy : global::Pulumi.CustomResource
    {
        ...
        public FleetUpdateStrategy(string name, FleetUpdateStrategyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice:FleetUpdateStrategy", name, args ?? new FleetUpdateStrategyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FleetUpdateStrategy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice:FleetUpdateStrategy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:containerservice/v20250301:FleetUpdateStrategy" },
                    new global::Pulumi.Alias { Type = "azure-native:containerservice/v20250401preview:FleetUpdateStrategy" },
                    new global::Pulumi.Alias { Type = "azure-native:containerservice/v20250801preview:FleetUpdateStrategy" },
                    new global::Pulumi.Alias { Type = "azure-native:containerservice/v20260201preview:FleetUpdateStrategy" },
                    new global::Pulumi.Alias { Type = "azure-native:containerservice/v20260302preview:FleetUpdateStrategy" },
                    new global::Pulumi.Alias { Type = "azure-native:containerservice/v20260601:FleetUpdateStrategy" },
                },
            };
