...
namespace Pulumi.AzureRM.ContainerService.V20190430
{
    ...
    ///     public MyStack()
    ///     {
    ///         var openShiftManagedCluster = new AzureRM.ContainerService.V20190430.OpenShiftManagedCluster("openShiftManagedCluster", new AzureRM.ContainerService.V20190430.OpenShiftManagedClusterArgs
    ///         {
    ///             AgentPoolProfiles = 
    ///             {
    ///                 new AzureRM.ContainerService.V20190430.Inputs.OpenShiftManagedClusterAgentPoolProfileArgs
    ///                 {
    ///                     Count = 2,
    ///                     Name = "infra",
    ///                     OsType = "Linux",
    ...
    ///                 },
    ///             },
    ///             AuthProfile = new AzureRM.ContainerService.V20190430.Inputs.OpenShiftManagedClusterAuthProfileArgs
    ///             {
    ///                 IdentityProviders = 
    ///                 {
    ...
    ///             },
    ///             Location = "location1",
    ///             MasterPoolProfile = new AzureRM.ContainerService.V20190430.Inputs.OpenShiftManagedClusterMasterPoolProfileArgs
    ///             {
    ///                 Count = 3,
    ///                 Name = "master",
    ///                 OsType = "Linux",
    ...
    ///                 VmSize = "Standard_D4s_v3",
    ///             },
    ///             NetworkProfile = new AzureRM.ContainerService.V20190430.Inputs.NetworkProfileArgs
    ///             {
    ///                 VnetCidr = "10.0.0.0/8",
    ///             },
    ...
    ///             RouterProfiles = 
    ///             {
    ///                 new AzureRM.ContainerService.V20190430.Inputs.OpenShiftRouterProfileArgs
    ///                 {
    ///                     Name = "default",
    ///                 },
    ///             },
