...
namespace Pulumi.AzureNative.ContainerService.V20190430
{
    ...
    public partial class OpenShiftManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public OpenShiftManagedCluster(string name, OpenShiftManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20190430:OpenShiftManagedCluster", name, args ?? new OpenShiftManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20190430:OpenShiftManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
