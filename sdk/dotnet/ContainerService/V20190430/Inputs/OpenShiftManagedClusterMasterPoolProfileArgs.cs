...
namespace Pulumi.AzureNative.ContainerService.V20190430.Inputs
{
    ...
    public sealed class OpenShiftManagedClusterMasterPoolProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20190430.OSType>? OsType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20190430.OpenShiftContainerServiceVMSize> VmSize { get; set; } = null!;
