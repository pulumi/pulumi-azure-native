...
namespace Pulumi.AzureNative.ContainerService.V20240102Preview
{
    public static class GetAgentPool
    {
        ...
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azure-native:containerservice/v20240102preview:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithDefaults());
