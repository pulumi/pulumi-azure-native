...
namespace Pulumi.AzureNative.ContainerService.V20240102Preview
{
    /// <summary>
    /// Whether VPA add-on is enabled and configured to scale AKS-managed add-ons.
    /// </summary>
    [EnumType]
    public readonly struct AddonAutoscaling : IEquatable<AddonAutoscaling>
    {
        private readonly string _value;

        private AddonAutoscaling(string value)
        {
        ...
        /// </summary>
        public static AddonAutoscaling Enabled { get; } = new AddonAutoscaling("Enabled");
        /// <summary>
        /// Feature to autoscale AKS-managed add-ons is disabled.
        /// </summary>
        public static AddonAutoscaling Disabled { get; } = new AddonAutoscaling("Disabled");

        public static bool operator ==(AddonAutoscaling left, AddonAutoscaling right) => left.Equals(right);
        public static bool operator !=(AddonAutoscaling left, AddonAutoscaling right) => !left.Equals(right);

        public static explicit operator string(AddonAutoscaling value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is AddonAutoscaling other && Equals(other);
        public bool Equals(AddonAutoscaling other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct IpvsScheduler : IEquatable<IpvsScheduler>
    {
        private readonly string _value;

        private IpvsScheduler(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Round Robin
        /// </summary>
        public static IpvsScheduler RoundRobin { get; } = new IpvsScheduler("RoundRobin");
        /// <summary>
        /// Least Connection
        /// </summary>
        public static IpvsScheduler LeastConnection { get; } = new IpvsScheduler("LeastConnection");

        public static bool operator ==(IpvsScheduler left, IpvsScheduler right) => left.Equals(right);
        public static bool operator !=(IpvsScheduler left, IpvsScheduler right) => !left.Equals(right);

        public static explicit operator string(IpvsScheduler value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is IpvsScheduler other && Equals(other);
        public bool Equals(IpvsScheduler other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct Level : IEquatable<Level>
    {
        ...
        public static Level Warning { get; } = new Level("Warning");
        public static Level Enforcement { get; } = new Level("Enforcement");
    ...
    public readonly struct Mode : IEquatable<Mode>
    {
        ...
        /// IPTables proxy mode
        /// </summary>
        public static Mode IPTABLES { get; } = new Mode("IPTABLES");
        /// <summary>
        /// IPVS proxy mode. Must be using Kubernetes version &gt;= 1.22.
        /// </summary>
        public static Mode IPVS { get; } = new Mode("IPVS");
    ...
    public readonly struct OSSKU : IEquatable<OSSKU>
    {
        ...
        /// </summary>
        public static OSSKU Mariner { get; } = new OSSKU("Mariner");
        /// <summary>
        ...
        /// </summary>
        public static OSSKU WindowsAnnual { get; } = new OSSKU("WindowsAnnual");
    ...
    public readonly struct WorkloadRuntime : IEquatable<WorkloadRuntime>
    {
        ...
        /// </summary>
        public static WorkloadRuntime KataMshvVmIsolation { get; } = new WorkloadRuntime("KataMshvVmIsolation");
