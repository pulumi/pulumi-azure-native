...
namespace Pulumi.AzureRM.ContainerService.Preview
{
    ...
    public partial class OpenShiftManagedCluster : Pulumi.CustomResource
    {
        ...
        public OpenShiftManagedCluster(string name, OpenShiftManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/preview:OpenShiftManagedCluster", name, args ?? new OpenShiftManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/preview:OpenShiftManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
