...
namespace Pulumi.AzureRM.ContainerService.Preview
{
    public static class GetContainerService
    {
        public static Task<GetContainerServiceResult> InvokeAsync(GetContainerServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContainerServiceResult>("azurerm:containerservice/preview:getContainerService", args ?? new GetContainerServiceArgs(), options.WithVersion());
    }
