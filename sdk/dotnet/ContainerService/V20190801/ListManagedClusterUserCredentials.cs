...
namespace Pulumi.AzureRM.ContainerService.V20190801
{
    public static class ListManagedClusterUserCredentials
    {
        public static Task<ListManagedClusterUserCredentialsResult> InvokeAsync(ListManagedClusterUserCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListManagedClusterUserCredentialsResult>("azurerm:containerservice/v20190801:listManagedClusterUserCredentials", args ?? new ListManagedClusterUserCredentialsArgs(), options.WithVersion());
    }
