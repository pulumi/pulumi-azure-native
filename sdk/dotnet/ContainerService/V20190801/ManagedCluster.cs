...
namespace Pulumi.AzureRM.ContainerService.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedCluster = new AzureRM.ContainerService.V20190801.ManagedCluster("managedCluster", new AzureRM.ContainerService.V20190801.ManagedClusterArgs
    ///         {
    ///             AddonProfiles = ,
    ///             AgentPoolProfiles = 
    ///             {
    ///                 new AzureRM.ContainerService.V20190801.Inputs.ManagedClusterAgentPoolProfileArgs
    ///                 {
    ///                     AvailabilityZones = 
    ///                     {
    ///                         "1",
    ...
    ///             EnableRBAC = true,
    ///             KubernetesVersion = "",
    ///             LinuxProfile = new AzureRM.ContainerService.V20190801.Inputs.ContainerServiceLinuxProfileArgs
    ///             {
    ///                 AdminUsername = "azureuser",
    ///                 Ssh = new AzureRM.ContainerService.V20190801.Inputs.ContainerServiceSshConfigurationArgs
    ///                 {
    ///                     PublicKeys = 
    ///                     {
    ///                         new AzureRM.ContainerService.V20190801.Inputs.ContainerServiceSshPublicKeyArgs
    ///                         {
    ///                             KeyData = "keydata",
    ///                         },
    ///                     },
    ...
    ///             },
    ///             Location = "location1",
    ///             NetworkProfile = new AzureRM.ContainerService.V20190801.Inputs.ContainerServiceNetworkProfileArgs
    ///             {
    ///                 LoadBalancerProfile = new AzureRM.ContainerService.V20190801.Inputs.ManagedClusterLoadBalancerProfileArgs
    ///                 {
    ///                     ManagedOutboundIPs = new AzureRM.ContainerService.V20190801.Inputs.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs
    ///                     {
    ///                         Count = 2,
    ///                     },
    ///                 },
    ...
    ///             ServicePrincipalProfile = new AzureRM.ContainerService.V20190801.Inputs.ManagedClusterServicePrincipalProfileArgs
    ///             {
    ///                 ClientId = "clientid",
    ///                 Secret = "secret",
    ///             },
    ...
    ///                 { "tier", "production" },
    ///             },
    ///             WindowsProfile = new AzureRM.ContainerService.V20190801.Inputs.ManagedClusterWindowsProfileArgs
    ///             {
    ...
    public partial class ManagedCluster : Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20190801:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20190801:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
