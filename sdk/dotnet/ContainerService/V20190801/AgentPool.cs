...
namespace Pulumi.AzureNative.ContainerService.V20190801
{
    ...
    /// Agent Pool.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20190801:AgentPool")]
    public partial class AgentPool : global::Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20190801:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20190801:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AgentPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20190801.OSType>? OsType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20190801.ScaleSetEvictionPolicy>? ScaleSetEvictionPolicy { get; set; }

        /// <summary>
        /// ScaleSetPriority to be used to specify virtual machine scale set priority. Default to regular.
        /// </summary>
        [Input("scaleSetPriority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20190801.ScaleSetPriority>? ScaleSetPriority { get; set; }

        /// <summary>
        /// AgentPoolType represents types of an agent pool
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20190801.AgentPoolType>? Type { get; set; }

        /// <summary>
        /// Size of agent VMs.
        /// </summary>
        [Input("vmSize")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20190801.ContainerServiceVMSizeTypes>? VmSize { get; set; }
