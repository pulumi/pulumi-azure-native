...
{
    [Obsolete(@"azure-native:containerservice/v20191001:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20200601:AgentPool to guarantee forwards compatibility.")]
    public static class GetAgentPool
    {
        ...
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azure-native:containerservice/v20191001:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the agent pool by managed cluster and resource group.
        /// </summary>
        public static Output<GetAgentPoolResult> Invoke(GetAgentPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAgentPoolResult>("azure-native:containerservice/v20191001:getAgentPool", args ?? new GetAgentPoolInvokeArgs(), options.WithDefaults());
    }
