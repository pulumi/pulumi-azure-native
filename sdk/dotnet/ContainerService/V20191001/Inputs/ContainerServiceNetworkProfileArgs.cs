...
namespace Pulumi.AzureNextGen.ContainerService.V20191001.Inputs
{
    ...
    public sealed class ContainerServiceNetworkProfileArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ContainerService.V20191001.LoadBalancerSku>? LoadBalancerSku { get; set; }

        /// <summary>
        /// Network plugin used for building Kubernetes network.
        /// </summary>
        [Input("networkPlugin")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerService.V20191001.NetworkPlugin>? NetworkPlugin { get; set; }

        /// <summary>
        /// Network policy used for building Kubernetes network.
        /// </summary>
        [Input("networkPolicy")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerService.V20191001.NetworkPolicy>? NetworkPolicy { get; set; }
