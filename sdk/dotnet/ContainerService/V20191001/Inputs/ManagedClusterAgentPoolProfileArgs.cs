...
namespace Pulumi.AzureNative.ContainerService.V20191001.Inputs
{
    ...
    public sealed class ManagedClusterAgentPoolProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20191001.OSType>? OsType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20191001.ScaleSetEvictionPolicy>? ScaleSetEvictionPolicy { get; set; }

        /// <summary>
        /// ScaleSetPriority to be used to specify virtual machine scale set priority. Default to regular.
        /// </summary>
        [Input("scaleSetPriority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20191001.ScaleSetPriority>? ScaleSetPriority { get; set; }

        /// <summary>
        /// AgentPoolType represents types of an agent pool
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20191001.AgentPoolType>? Type { get; set; }

        /// <summary>
        /// Size of agent VMs.
        /// </summary>
        [Input("vmSize")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20191001.ContainerServiceVMSizeTypes>? VmSize { get; set; }
