...
namespace Pulumi.AzureNative.ContainerService.V20191001
{
    ...
    [AzureNativeResourceType("azure-native:containerservice/v20191001:AgentPool")]
    public partial class AgentPool : global::Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20191001:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20191001:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
