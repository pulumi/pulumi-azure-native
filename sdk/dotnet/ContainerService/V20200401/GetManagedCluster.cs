...
namespace Pulumi.AzureRM.ContainerService.V20200401
{
    public static class GetManagedCluster
    {
        public static Task<GetManagedClusterResult> InvokeAsync(GetManagedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedClusterResult>("azurerm:containerservice/v20200401:getManagedCluster", args ?? new GetManagedClusterArgs(), options.WithVersion());
    }
