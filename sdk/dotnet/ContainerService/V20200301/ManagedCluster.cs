...
namespace Pulumi.AzureRM.ContainerService.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedCluster = new AzureRM.ContainerService.V20200301.ManagedCluster("managedCluster", new AzureRM.ContainerService.V20200301.ManagedClusterArgs
    ///         {
    ///             AddonProfiles = ,
    ///             AgentPoolProfiles = 
    ///             {
    ///                 new AzureRM.ContainerService.V20200301.Inputs.ManagedClusterAgentPoolProfileArgs
    ///                 {
    ///                     AvailabilityZones = 
    ///                     {
    ///                         "1",
    ...
    ///                 },
    ///             },
    ///             AutoScalerProfile = new AzureRM.ContainerService.V20200301.Inputs.ManagedClusterPropertiesAutoScalerProfileArgs
    ///             {
    ...
    ///             EnableRBAC = true,
    ///             KubernetesVersion = "",
    ///             LinuxProfile = new AzureRM.ContainerService.V20200301.Inputs.ContainerServiceLinuxProfileArgs
    ///             {
    ///                 AdminUsername = "azureuser",
    ///                 Ssh = new AzureRM.ContainerService.V20200301.Inputs.ContainerServiceSshConfigurationArgs
    ///                 {
    ///                     PublicKeys = 
    ///                     {
    ///                         new AzureRM.ContainerService.V20200301.Inputs.ContainerServiceSshPublicKeyArgs
    ///                         {
    ///                             KeyData = "keydata",
    ///                         },
    ///                     },
    ...
    ///             },
    ///             Location = "location1",
    ///             NetworkProfile = new AzureRM.ContainerService.V20200301.Inputs.ContainerServiceNetworkProfileArgs
    ///             {
    ///                 LoadBalancerProfile = new AzureRM.ContainerService.V20200301.Inputs.ManagedClusterLoadBalancerProfileArgs
    ///                 {
    ///                     ManagedOutboundIPs = new AzureRM.ContainerService.V20200301.Inputs.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs
    ///                     {
    ///                         Count = 2,
    ///                     },
    ///                 },
    ...
    ///             ServicePrincipalProfile = new AzureRM.ContainerService.V20200301.Inputs.ManagedClusterServicePrincipalProfileArgs
    ///             {
    ///                 ClientId = "clientid",
    ///                 Secret = "secret",
    ///             },
    ///             Sku = new AzureRM.ContainerService.V20200301.Inputs.ManagedClusterSKUArgs
    ///             {
    ///                 Name = "Basic",
    ///                 Tier = "Free",
    ///             },
    ...
    ///                 { "tier", "production" },
    ///             },
    ///             WindowsProfile = new AzureRM.ContainerService.V20200301.Inputs.ManagedClusterWindowsProfileArgs
    ///             {
    ...
    public partial class ManagedCluster : Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20200301:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20200301:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
