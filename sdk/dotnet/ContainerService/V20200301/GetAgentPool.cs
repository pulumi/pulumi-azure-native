...
namespace Pulumi.AzureRM.ContainerService.V20200301
{
    public static class GetAgentPool
    {
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azurerm:containerservice/v20200301:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithVersion());
    }
