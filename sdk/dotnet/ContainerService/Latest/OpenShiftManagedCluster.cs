...
namespace Pulumi.AzureRM.ContainerService.Latest
{
    ...
    public partial class OpenShiftManagedCluster : Pulumi.CustomResource
    {
        ...
        public OpenShiftManagedCluster(string name, OpenShiftManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/latest:OpenShiftManagedCluster", name, args ?? new OpenShiftManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/latest:OpenShiftManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
