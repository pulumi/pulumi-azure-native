...
namespace Pulumi.AzureRM.ContainerService.Latest
{
    ...
    public partial class ContainerService : Pulumi.CustomResource
    {
        ...
        public ContainerService(string name, ContainerServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/latest:ContainerService", name, args ?? new ContainerServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/latest:ContainerService", name, null, MakeResourceOptions(options, id))
        {
        }
