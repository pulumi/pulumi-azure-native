...
namespace Pulumi.AzureNative.ContainerService.V20250101
{
    ...
    /// Agent Pool.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20250101:AgentPool")]
    public partial class AgentPool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("gpuProfile")]
        public Output<Outputs.GPUProfileResponse?> GpuProfile { get; private set; } = null!;
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20250101:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20250101:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
