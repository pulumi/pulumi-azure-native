...
namespace Pulumi.AzureNative.ContainerService.V20220702Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20220702preview:Fleet")]
    public partial class Fleet : global::Pulumi.CustomResource
    {
        ...
        public Fleet(string name, FleetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220702preview:Fleet", name, args ?? new FleetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fleet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220702preview:Fleet", name, null, MakeResourceOptions(options, id))
        {
        }
