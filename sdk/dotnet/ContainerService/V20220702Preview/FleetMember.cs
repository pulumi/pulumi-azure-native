...
namespace Pulumi.AzureNative.ContainerService.V20220702Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20220702preview:FleetMember")]
    public partial class FleetMember : global::Pulumi.CustomResource
    {
        ...
        public FleetMember(string name, FleetMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220702preview:FleetMember", name, args ?? new FleetMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FleetMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220702preview:FleetMember", name, null, MakeResourceOptions(options, id))
        {
        }
