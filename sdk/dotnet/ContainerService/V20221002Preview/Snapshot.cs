...
namespace Pulumi.AzureNative.ContainerService.V20221002Preview
{
    ...
    [AzureNativeResourceType("azure-native:containerservice/v20221002preview:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20221002preview:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20221002preview:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
