...
namespace Pulumi.AzureNextGen.ContainerService.V20190201.Inputs
{
    ...
    public sealed class ContainerServiceNetworkProfileArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("networkPlugin")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerService.V20190201.NetworkPlugin>? NetworkPlugin { get; set; }

        /// <summary>
        /// Network policy used for building Kubernetes network.
        /// </summary>
        [Input("networkPolicy")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerService.V20190201.NetworkPolicy>? NetworkPolicy { get; set; }
