...
namespace Pulumi.AzureNative.ContainerService.V20190201
{
    ...
    public static class GetAgentPool
    {
        ...
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azure-native:containerservice/v20190201:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Agent Pool.
        /// </summary>
        public static Output<GetAgentPoolResult> Invoke(GetAgentPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAgentPoolResult>("azure-native:containerservice/v20190201:getAgentPool", args ?? new GetAgentPoolInvokeArgs(), options.WithDefaults());
    }
