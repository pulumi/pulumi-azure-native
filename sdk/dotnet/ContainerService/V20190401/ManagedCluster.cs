...
namespace Pulumi.AzureRM.ContainerService.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedCluster = new AzureRM.ContainerService.V20190401.ManagedCluster("managedCluster", new AzureRM.ContainerService.V20190401.ManagedClusterArgs
    ///         {
    ///             AddonProfiles = ,
    ///             AgentPoolProfiles = 
    ///             {
    ///                 new AzureRM.ContainerService.V20190401.Inputs.ManagedClusterAgentPoolProfileArgs
    ///                 {
    ///                     Count = 3,
    ///                     Name = "nodepool1",
    ///                     OsType = "Linux",
    ...
    ///             EnableRBAC = true,
    ///             KubernetesVersion = "",
    ///             LinuxProfile = new AzureRM.ContainerService.V20190401.Inputs.ContainerServiceLinuxProfileArgs
    ///             {
    ///                 AdminUsername = "azureuser",
    ///                 Ssh = new AzureRM.ContainerService.V20190401.Inputs.ContainerServiceSshConfigurationArgs
    ///                 {
    ///                     PublicKeys = 
    ///                     {
    ///                         new AzureRM.ContainerService.V20190401.Inputs.ContainerServiceSshPublicKeyArgs
    ///                         {
    ///                             KeyData = "keydata",
    ///                         },
    ///                     },
    ...
    ///             },
    ///             Location = "location1",
    ///             NetworkProfile = new AzureRM.ContainerService.V20190401.Inputs.ContainerServiceNetworkProfileArgs
    ///             {
    ///                 LoadBalancerSku = "basic",
    ///             },
    ///             ResourceGroupName = "rg1",
    ///             ResourceName = "clustername1",
    ///             ServicePrincipalProfile = new AzureRM.ContainerService.V20190401.Inputs.ManagedClusterServicePrincipalProfileArgs
    ///             {
    ///                 ClientId = "clientid",
    ///                 Secret = "secret",
    ///             },
    ...
    ///                 { "tier", "production" },
    ///             },
    ///             WindowsProfile = new AzureRM.ContainerService.V20190401.Inputs.ManagedClusterWindowsProfileArgs
    ///             {
