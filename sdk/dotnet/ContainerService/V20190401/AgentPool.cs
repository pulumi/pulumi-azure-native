...
namespace Pulumi.AzureRM.ContainerService.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var agentPool = new AzureRM.ContainerService.V20190401.AgentPool("agentPool", new AzureRM.ContainerService.V20190401.AgentPoolArgs
    ///         {
    ...
    public partial class AgentPool : Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20190401:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20190401:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
