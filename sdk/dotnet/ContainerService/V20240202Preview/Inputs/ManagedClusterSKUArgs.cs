...
namespace Pulumi.AzureNative.ContainerService.V20240202Preview.Inputs
{
    ...
    public sealed class ManagedClusterSKUArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("name")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240202Preview.ManagedClusterSKUName>? Name { get; set; }
        ...
        /// </summary>
        [Input("tier")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240202Preview.ManagedClusterSKUTier>? Tier { get; set; }
