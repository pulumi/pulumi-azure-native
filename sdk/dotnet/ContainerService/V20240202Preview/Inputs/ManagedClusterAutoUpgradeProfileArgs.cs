...
namespace Pulumi.AzureNative.ContainerService.V20240202Preview.Inputs
{
    ...
    public sealed class ManagedClusterAutoUpgradeProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240202Preview.NodeOSUpgradeChannel>? NodeOSUpgradeChannel { get; set; }

        /// <summary>
        /// For more information see [setting the AKS cluster auto-upgrade channel](https://docs.microsoft.com/azure/aks/upgrade-cluster#set-auto-upgrade-channel).
        /// </summary>
        [Input("upgradeChannel")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240202Preview.UpgradeChannel>? UpgradeChannel { get; set; }
