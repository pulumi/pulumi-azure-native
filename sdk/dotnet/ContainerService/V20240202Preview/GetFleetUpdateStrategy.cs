...
namespace Pulumi.AzureNative.ContainerService.V20240202Preview
{
    public static class GetFleetUpdateStrategy
    {
        ...
        public static Task<GetFleetUpdateStrategyResult> InvokeAsync(GetFleetUpdateStrategyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFleetUpdateStrategyResult>("azure-native:containerservice/v20240202preview:getFleetUpdateStrategy", args ?? new GetFleetUpdateStrategyArgs(), options.WithDefaults());
        ...
        public static Output<GetFleetUpdateStrategyResult> Invoke(GetFleetUpdateStrategyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFleetUpdateStrategyResult>("azure-native:containerservice/v20240202preview:getFleetUpdateStrategy", args ?? new GetFleetUpdateStrategyInvokeArgs(), options.WithDefaults());
    }
