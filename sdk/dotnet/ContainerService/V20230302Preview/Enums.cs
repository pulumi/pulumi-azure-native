...
namespace Pulumi.AzureNative.ContainerService.V20230302Preview
{
    /// <summary>
    ...
    /// </summary>
    [EnumType]
    public readonly struct ControlPlaneUpgradeOverride : IEquatable<ControlPlaneUpgradeOverride>
    {
        private readonly string _value;

        private ControlPlaneUpgradeOverride(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static ControlPlaneUpgradeOverride IgnoreKubernetesDeprecations { get; } = new ControlPlaneUpgradeOverride("IgnoreKubernetesDeprecations");

        public static bool operator ==(ControlPlaneUpgradeOverride left, ControlPlaneUpgradeOverride right) => left.Equals(right);
        public static bool operator !=(ControlPlaneUpgradeOverride left, ControlPlaneUpgradeOverride right) => !left.Equals(right);

        public static explicit operator string(ControlPlaneUpgradeOverride value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ControlPlaneUpgradeOverride other && Equals(other);
        public bool Equals(ControlPlaneUpgradeOverride other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct ControlledValues : IEquatable<ControlledValues>
    {
        private readonly string _value;

        private ControlledValues(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static ControlledValues RequestsAndLimits { get; } = new ControlledValues("RequestsAndLimits");
        /// <summary>
        /// Autoscaler will control resource requests only.
        /// </summary>
        public static ControlledValues RequestsOnly { get; } = new ControlledValues("RequestsOnly");

        public static bool operator ==(ControlledValues left, ControlledValues right) => left.Equals(right);
        public static bool operator !=(ControlledValues left, ControlledValues right) => !left.Equals(right);

        public static explicit operator string(ControlledValues value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ControlledValues other && Equals(other);
        public bool Equals(ControlledValues other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct UpdateMode : IEquatable<UpdateMode>
    {
        ...
        /// </summary>
        public static UpdateMode Off { get; } = new UpdateMode("Off");
        /// <summary>
        /// Autoscaler only assigns resources on pod creation and doesn't change them during the lifetime of the pod.
        /// </summary>
        public static UpdateMode Initial { get; } = new UpdateMode("Initial");
        /// <summary>
        ...
        /// </summary>
        public static UpdateMode Recreate { get; } = new UpdateMode("Recreate");
        /// <summary>
        ...
        /// </summary>
        public static UpdateMode Auto { get; } = new UpdateMode("Auto");
