...
namespace Pulumi.AzureNative.ContainerService.Inputs
{
    ...
    public sealed class OpenShiftManagedClusterAgentPoolProfileArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("role")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.OpenShiftAgentPoolProfileRole>? Role { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.OpenShiftContainerServiceVMSize> VmSize { get; set; } = null!;
