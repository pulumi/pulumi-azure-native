...
namespace Pulumi.AzureNative.ContainerService.V20230801
{
    ...
    /// Agent Pool.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230801:AgentPool")]
    public partial class AgentPool : global::Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230801:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230801:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
