...
namespace Pulumi.AzureNative.ContainerService.V20231002Preview.Inputs
{
    ...
    public sealed class RelativeMonthlyScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20231002Preview.WeekDay> DayOfWeek { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20231002Preview.Type> WeekIndex { get; set; } = null!;
