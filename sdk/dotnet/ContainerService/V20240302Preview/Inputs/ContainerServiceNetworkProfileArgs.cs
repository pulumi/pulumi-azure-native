...
namespace Pulumi.AzureNative.ContainerService.V20240302Preview.Inputs
{
    ...
    public sealed class ContainerServiceNetworkProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("ipFamilies")]
        private InputList<Union<string, Pulumi.AzureNative.ContainerService.V20240302Preview.IpFamily>>? _ipFamilies;

        /// <summary>
        /// IP families are used to determine single-stack or dual-stack clusters. For single-stack, the expected value is IPv4. For dual-stack, the expected values are IPv4 and IPv6.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerService.V20240302Preview.IpFamily>> IpFamilies
        {
            get => _ipFamilies ?? (_ipFamilies = new InputList<Union<string, Pulumi.AzureNative.ContainerService.V20240302Preview.IpFamily>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240302Preview.LoadBalancerSku>? LoadBalancerSku { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240302Preview.NetworkDataplane>? NetworkDataplane { get; set; }

        /// <summary>
        /// This cannot be specified if networkPlugin is anything other than 'azure'.
        /// </summary>
        [Input("networkMode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240302Preview.NetworkMode>? NetworkMode { get; set; }

        /// <summary>
        /// Network plugin used for building the Kubernetes network.
        /// </summary>
        [Input("networkPlugin")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240302Preview.NetworkPlugin>? NetworkPlugin { get; set; }

        /// <summary>
        /// Network plugin mode used for building the Kubernetes network.
        /// </summary>
        [Input("networkPluginMode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240302Preview.NetworkPluginMode>? NetworkPluginMode { get; set; }

        /// <summary>
        /// Network policy used for building the Kubernetes network.
        /// </summary>
        [Input("networkPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240302Preview.NetworkPolicy>? NetworkPolicy { get; set; }

        /// <summary>
        /// This can only be set at cluster creation time and cannot be changed later. For more information see [egress outbound type](https://docs.microsoft.com/azure/aks/egress-outboundtype).
        /// </summary>
        [Input("outboundType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240302Preview.OutboundType>? OutboundType { get; set; }
