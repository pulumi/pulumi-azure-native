...
namespace Pulumi.AzureNative.ContainerService.V20240302Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct ClusterServiceLoadBalancerHealthProbeMode : IEquatable<ClusterServiceLoadBalancerHealthProbeMode>
    {
        private readonly string _value;

        private ClusterServiceLoadBalancerHealthProbeMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static ClusterServiceLoadBalancerHealthProbeMode ServiceNodePort { get; } = new ClusterServiceLoadBalancerHealthProbeMode("ServiceNodePort");
        /// <summary>
        ...
        /// </summary>
        public static ClusterServiceLoadBalancerHealthProbeMode Shared { get; } = new ClusterServiceLoadBalancerHealthProbeMode("Shared");
        ...
        public static explicit operator string(ClusterServiceLoadBalancerHealthProbeMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ClusterServiceLoadBalancerHealthProbeMode other && Equals(other);
        public bool Equals(ClusterServiceLoadBalancerHealthProbeMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
