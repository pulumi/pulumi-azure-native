...
namespace Pulumi.AzureRM.ContainerService.V20170701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var containerService = new AzureRM.ContainerService.V20170701.ContainerService("containerService", new AzureRM.ContainerService.V20170701.ContainerServiceArgs
    ///         {
    ...
    public partial class ContainerService : Pulumi.CustomResource
    {
        ...
        public ContainerService(string name, ContainerServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20170701:ContainerService", name, args ?? new ContainerServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20170701:ContainerService", name, null, MakeResourceOptions(options, id))
        {
        }
