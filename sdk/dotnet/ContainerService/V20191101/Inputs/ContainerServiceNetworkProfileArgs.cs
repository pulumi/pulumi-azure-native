...
namespace Pulumi.AzureNative.ContainerService.V20191101.Inputs
{
    ...
    public sealed class ContainerServiceNetworkProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20191101.LoadBalancerSku>? LoadBalancerSku { get; set; }

        /// <summary>
        /// Network plugin used for building Kubernetes network.
        /// </summary>
        [Input("networkPlugin")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20191101.NetworkPlugin>? NetworkPlugin { get; set; }

        /// <summary>
        /// Network policy used for building Kubernetes network.
        /// </summary>
        [Input("networkPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20191101.NetworkPolicy>? NetworkPolicy { get; set; }

        /// <summary>
        /// The outbound (egress) routing method.
        /// </summary>
        [Input("outboundType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20191101.OutboundType>? OutboundType { get; set; }
