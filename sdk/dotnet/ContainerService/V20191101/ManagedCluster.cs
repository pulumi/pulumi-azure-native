...
namespace Pulumi.AzureNative.ContainerService.V20191101
{
    ...
    [AzureNativeResourceType("azure-native:containerservice/v20191101:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20191101:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20191101:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
