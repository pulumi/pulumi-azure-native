...
namespace Pulumi.AzureRM.ContainerService.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var agentPool = new AzureRM.ContainerService.V20191101.AgentPool("agentPool", new AzureRM.ContainerService.V20191101.AgentPoolArgs
    ///         {
    ...
    public partial class AgentPool : Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20191101:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20191101:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
