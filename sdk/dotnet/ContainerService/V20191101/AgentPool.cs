...
namespace Pulumi.AzureNextGen.ContainerService.V20191101
{
    ...
    /// Agent Pool.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:containerservice/v20191101:AgentPool")]
    public partial class AgentPool : Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerservice/v20191101:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerservice/v20191101:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
