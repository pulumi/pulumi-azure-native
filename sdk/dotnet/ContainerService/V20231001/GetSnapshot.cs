...
namespace Pulumi.AzureNative.ContainerService.V20231001
{
    public static class GetSnapshot
    {
        ...
        public static Task<GetSnapshotResult> InvokeAsync(GetSnapshotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotResult>("azure-native:containerservice/v20231001:getSnapshot", args ?? new GetSnapshotArgs(), options.WithDefaults());
