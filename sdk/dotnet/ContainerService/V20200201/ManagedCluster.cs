...
namespace Pulumi.AzureRM.ContainerService.V20200201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var managedCluster = new AzureRM.ContainerService.V20200201.ManagedCluster("managedCluster", new AzureRM.ContainerService.V20200201.ManagedClusterArgs
    ///         {
    ///             AddonProfiles = ,
    ///             AgentPoolProfiles = 
    ///             {
    ///                 new AzureRM.ContainerService.V20200201.Inputs.ManagedClusterAgentPoolProfileArgs
    ///                 {
    ///                     AvailabilityZones = 
    ///                     {
    ///                         "1",
    ...
    ///                 },
    ///             },
    ///             AutoScalerProfile = new AzureRM.ContainerService.V20200201.Inputs.ManagedClusterPropertiesAutoScalerProfileArgs
    ///             {
    ...
    ///             EnableRBAC = true,
    ///             KubernetesVersion = "",
    ///             LinuxProfile = new AzureRM.ContainerService.V20200201.Inputs.ContainerServiceLinuxProfileArgs
    ///             {
    ///                 AdminUsername = "azureuser",
    ///                 Ssh = new AzureRM.ContainerService.V20200201.Inputs.ContainerServiceSshConfigurationArgs
    ///                 {
    ///                     PublicKeys = 
    ///                     {
    ///                         new AzureRM.ContainerService.V20200201.Inputs.ContainerServiceSshPublicKeyArgs
    ///                         {
    ///                             KeyData = "keydata",
    ///                         },
    ///                     },
    ...
    ///             },
    ///             Location = "location1",
    ///             NetworkProfile = new AzureRM.ContainerService.V20200201.Inputs.ContainerServiceNetworkProfileArgs
    ///             {
    ///                 LoadBalancerProfile = new AzureRM.ContainerService.V20200201.Inputs.ManagedClusterLoadBalancerProfileArgs
    ///                 {
    ///                     ManagedOutboundIPs = new AzureRM.ContainerService.V20200201.Inputs.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs
    ///                     {
    ///                         Count = 2,
    ///                     },
    ///                 },
    ...
    ///             ServicePrincipalProfile = new AzureRM.ContainerService.V20200201.Inputs.ManagedClusterServicePrincipalProfileArgs
    ///             {
    ///                 ClientId = "clientid",
    ///                 Secret = "secret",
    ///             },
    ...
    ///                 { "tier", "production" },
    ///             },
    ///             WindowsProfile = new AzureRM.ContainerService.V20200201.Inputs.ManagedClusterWindowsProfileArgs
    ///             {
    ...
    public partial class ManagedCluster : Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20200201:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20200201:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
