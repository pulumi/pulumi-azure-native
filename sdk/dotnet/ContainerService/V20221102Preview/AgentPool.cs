...
namespace Pulumi.AzureNative.ContainerService.V20221102Preview
{
    ...
    /// Agent Pool.
    /// </summary>
    [Obsolete(@"azure-native:containerservice/v20221102preview:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:AgentPool to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerservice/v20221102preview:AgentPool")]
    public partial class AgentPool : global::Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20221102preview:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20221102preview:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AgentPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.GPUInstanceProfile>? GpuInstanceProfile { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.KubeletDiskType>? KubeletDiskType { get; set; }
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.AgentPoolMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("osDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.OSDiskType>? OsDiskType { get; set; }

        /// <summary>
        /// Specifies the OS SKU used by the agent pool. If not specified, the default is Ubuntu if OSType=Linux or Windows2019 if OSType=Windows. And the default Windows OSSKU will be changed to Windows2022 after Windows2019 is deprecated.
        /// </summary>
        [Input("osSKU")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.OSSKU>? OsSKU { get; set; }

        /// <summary>
        /// The operating system type. The default is Linux.
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.OSType>? OsType { get; set; }
        ...
        /// </summary>
        [Input("scaleDownMode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.ScaleDownMode>? ScaleDownMode { get; set; }

        /// <summary>
        /// This cannot be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'.
        /// </summary>
        [Input("scaleSetEvictionPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.ScaleSetEvictionPolicy>? ScaleSetEvictionPolicy { get; set; }

        /// <summary>
        /// The Virtual Machine Scale Set priority. If not specified, the default is 'Regular'.
        /// </summary>
        [Input("scaleSetPriority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.ScaleSetPriority>? ScaleSetPriority { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.AgentPoolType>? Type { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20221102Preview.WorkloadRuntime>? WorkloadRuntime { get; set; }
