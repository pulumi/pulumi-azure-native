...
namespace Pulumi.AzureNative.ContainerService.V20240101
{
    ...
    /// Managed cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20240101:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240101:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240101:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240101.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        /// </summary>
        [Input("supportPlan")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240101.KubernetesSupportPlan>? SupportPlan { get; set; }
