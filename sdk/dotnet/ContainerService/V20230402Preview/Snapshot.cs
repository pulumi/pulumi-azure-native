...
namespace Pulumi.AzureNative.ContainerService.V20230402Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230402preview:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230402preview:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230402preview:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
