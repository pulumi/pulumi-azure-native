...
namespace Pulumi.AzureNative.ContainerService.V20151101Preview
{
    ...
    public partial class ContainerService : Pulumi.CustomResource
    {
        ...
        public ContainerService(string name, ContainerServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20151101preview:ContainerService", name, args ?? new ContainerServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20151101preview:ContainerService", name, null, MakeResourceOptions(options, id))
        {
        }
