...
namespace Pulumi.AzureNative.ContainerService.V20151101Preview
{
    ...
    public static class GetContainerService
    {
        ...
        public static Task<GetContainerServiceResult> InvokeAsync(GetContainerServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContainerServiceResult>("azure-native:containerservice/v20151101preview:getContainerService", args ?? new GetContainerServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Container service
        /// </summary>
        public static Output<GetContainerServiceResult> Invoke(GetContainerServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetContainerServiceResult>("azure-native:containerservice/v20151101preview:getContainerService", args ?? new GetContainerServiceInvokeArgs(), options.WithDefaults());
    }
