...
namespace Pulumi.AzureNative.ContainerService.V20230201
{
    ...
    /// {
    ///     var managedCluster = new AzureNative.ContainerService.V20230201.ManagedCluster("managedCluster", new()
    ///     {
    ///         AddonProfiles = null,
    ///         AgentPoolProfiles = new[]
    ///         {
    ///             new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterAgentPoolProfileArgs
    ///             {
    ///                 Count = 3,
    ...
    ///             },
    ///         },
    ///         AutoScalerProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterPropertiesAutoScalerProfileArgs
    ///         {
    ...
    ///         EnableRBAC = true,
    ///         KubernetesVersion = "",
    ///         LinuxProfile = new AzureNative.ContainerService.V20230201.Inputs.ContainerServiceLinuxProfileArgs
    ///         {
    ///             AdminUsername = "azureuser",
    ///             Ssh = new AzureNative.ContainerService.V20230201.Inputs.ContainerServiceSshConfigurationArgs
    ///             {
    ///                 PublicKeys = new[]
    ///                 {
    ///                     new AzureNative.ContainerService.V20230201.Inputs.ContainerServiceSshPublicKeyArgs
    ///                     {
    ///                         KeyData = "keydata",
    ///                     },
    ///                 },
    ...
    ///         },
    ///         Location = "location1",
    ///         NetworkProfile = new AzureNative.ContainerService.V20230201.Inputs.ContainerServiceNetworkProfileArgs
    ///         {
    ///             LoadBalancerProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterLoadBalancerProfileArgs
    ///             {
    ///                 ManagedOutboundIPs = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs
    ///                 {
    ///                     Count = 2,
    ///                 },
    ///             },
    ...
    ///         ServicePrincipalProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterServicePrincipalProfileArgs
    ///         {
    ///             ClientId = "clientid",
    ///             Secret = "secret",
    ///         },
    ///         Sku = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterSKUArgs
    ///         {
    ///             Name = "Basic",
    ///             Tier = "Free",
    ///         },
    ...
    ///             { "tier", "production" },
    ///         },
    ///         WindowsProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterWindowsProfileArgs
    ///         {
    ...
    ///         {
    ///             LoadBalancerSku = "standard",
    ///             NatGatewayProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterNATGatewayProfileArgs
    ///             {
    ///                 ManagedOutboundIPProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterManagedOutboundIPProfileArgs
    ///                 {
    ///                     Count = 2,
    ///                 },
    ///             },
    ...
    ///         AddonProfiles = 
    ///         {
    ///             { "azureKeyvaultSecretsProvider", new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterAddonProfileArgs
    ///             {
    ///                 Config = 
    ///                 {
    ...
    ///         EnablePodSecurityPolicy = true,
    ///         EnableRBAC = true,
    ///         HttpProxyConfig = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterHTTPProxyConfigArgs
    ///         {
    ...
    ///             OutboundType = "loadBalancer",
    ///         },
    ///         PodIdentityProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterPodIdentityProfileArgs
    ///         {
    ...
    ///             },
    ///         },
    ///         ApiServerAccessProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterAPIServerAccessProfileArgs
    ///         {
    ...
    ///         ResourceGroupName = "rg1",
    ///         ResourceName = "clustername1",
    ///         SecurityProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterSecurityProfileArgs
    ///         {
    ///             Defender = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterSecurityProfileDefenderArgs
    ///             {
    ///                 LogAnalyticsWorkspaceResourceId = "/subscriptions/SUB_ID/resourcegroups/RG_NAME/providers/microsoft.operationalinsights/workspaces/WORKSPACE_NAME",
    ///                 SecurityMonitoring = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterSecurityProfileDefenderSecurityMonitoringArgs
    ///                 {
    ///                     Enabled = true,
    ///                 },
    ///             },
    ///             WorkloadIdentity = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterSecurityProfileWorkloadIdentityArgs
    ///             {
    ///                 Enabled = true,
    ///             },
    ///         },
    ...
    ///     var managedCluster = new AzureNative.ContainerService.V20230201.ManagedCluster("managedCluster", new()
    ///     {
    ///         AadProfile = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterAADProfileArgs
    ///         {
    ...
    ///         EnablePodSecurityPolicy = true,
    ///         EnableRBAC = true,
    ///         Identity = new AzureNative.ContainerService.V20230201.Inputs.ManagedClusterIdentityArgs
    ///         {
    ///             Type = AzureNative.ContainerService.V20230201.ResourceIdentityType.UserAssigned,
    ...
    ///             AdminPassword = "replacePassword1234$",
    ///             AdminUsername = "azureuser",
    ///             GmsaProfile = new AzureNative.ContainerService.V20230201.Inputs.WindowsGmsaProfileArgs
    ///             {
    ///                 Enabled = true,
    ///             },
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230201:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230201:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230201:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230201.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
