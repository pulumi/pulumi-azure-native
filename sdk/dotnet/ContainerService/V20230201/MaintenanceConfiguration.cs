...
namespace Pulumi.AzureNative.ContainerService.V20230201
{
    ...
    /// {
    ///     var maintenanceConfiguration = new AzureNative.ContainerService.V20230201.MaintenanceConfiguration("maintenanceConfiguration", new()
    ///     {
    ///         ConfigName = "default",
    ///         NotAllowedTime = new[]
    ///         {
    ///             new AzureNative.ContainerService.V20230201.Inputs.TimeSpanArgs
    ///             {
    ...
    ///         TimeInWeek = new[]
    ///         {
    ///             new AzureNative.ContainerService.V20230201.Inputs.TimeInWeekArgs
    ///             {
    ///                 Day = "Monday",
    ///                 HourSlots = new[]
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230201:MaintenanceConfiguration")]
    public partial class MaintenanceConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MaintenanceConfiguration(string name, MaintenanceConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230201:MaintenanceConfiguration", name, args ?? new MaintenanceConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MaintenanceConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230201:MaintenanceConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
