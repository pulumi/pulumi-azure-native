...
namespace Pulumi.AzureNative.ContainerService.V20230201
{
    ...
    /// {
    ///     var snapshot = new AzureNative.ContainerService.V20230201.Snapshot("snapshot", new()
    ///     {
    ///         CreationData = new AzureNative.ContainerService.V20230201.Inputs.CreationDataArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:containerservice/v20230201:Snapshot snapshot1 /subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/snapshots/snapshot1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230201:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230201:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230201:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SnapshotArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("snapshotType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230201.SnapshotType>? SnapshotType { get; set; }
