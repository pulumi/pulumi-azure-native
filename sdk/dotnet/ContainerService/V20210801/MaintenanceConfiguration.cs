...
namespace Pulumi.AzureNative.ContainerService.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20210801:MaintenanceConfiguration")]
    public partial class MaintenanceConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MaintenanceConfiguration(string name, MaintenanceConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20210801:MaintenanceConfiguration", name, args ?? new MaintenanceConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MaintenanceConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20210801:MaintenanceConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
