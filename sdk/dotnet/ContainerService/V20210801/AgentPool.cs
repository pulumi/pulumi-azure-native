...
namespace Pulumi.AzureNative.ContainerService.V20210801
{
    ...
    /// {
    ///     var agentPool = new AzureNative.ContainerService.V20210801.AgentPool("agentPool", new()
    ///     {
    ///         AgentPoolName = "agentpool1",
    ///         Count = 3,
    ///         CreationData = new AzureNative.ContainerService.V20210801.Inputs.CreationDataArgs
    ///         {
    ...
    ///         KubeletConfig = new AzureNative.ContainerService.V20210801.Inputs.KubeletConfigArgs
    ///         {
    ...
    ///         },
    ///         LinuxOSConfig = new AzureNative.ContainerService.V20210801.Inputs.LinuxOSConfigArgs
    ///         {
    ///             SwapFileSizeMB = 1500,
    ///             Sysctls = new AzureNative.ContainerService.V20210801.Inputs.SysctlConfigArgs
    ///             {
