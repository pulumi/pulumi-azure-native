...
namespace Pulumi.AzureRM.ContainerService.V20180930Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var openShiftManagedCluster = new AzureRM.ContainerService.V20180930Preview.OpenShiftManagedCluster("openShiftManagedCluster", new AzureRM.ContainerService.V20180930Preview.OpenShiftManagedClusterArgs
    ///         {
    ///             AgentPoolProfiles = 
    ///             {
    ///                 new AzureRM.ContainerService.V20180930Preview.Inputs.OpenShiftManagedClusterAgentPoolProfileArgs
    ///                 {
    ///                     Count = 2,
    ///                     Name = "infra",
    ///                     OsType = "Linux",
    ...
    ///                 },
    ///             },
    ///             AuthProfile = new AzureRM.ContainerService.V20180930Preview.Inputs.OpenShiftManagedClusterAuthProfileArgs
    ///             {
    ///                 IdentityProviders = 
    ///                 {
    ///                     new AzureRM.ContainerService.V20180930Preview.Inputs.OpenShiftManagedClusterIdentityProviderArgs
    ///                     {
    ///                         Name = "Azure AD",
    ///                         Provider = new AzureRM.ContainerService.V20180930Preview.Inputs.OpenShiftManagedClusterBaseIdentityProviderArgs
    ///                         {
    ///                             ClientId = "{clientId}",
    ...
    ///             Location = "location1",
    ///             MasterPoolProfile = new AzureRM.ContainerService.V20180930Preview.Inputs.OpenShiftManagedClusterMasterPoolProfileArgs
    ///             {
    ///                 Count = 3,
    ///                 Name = "master",
    ///                 OsType = "Linux",
    ...
    ///                 VmSize = "Standard_D4s_v3",
    ///             },
    ///             NetworkProfile = new AzureRM.ContainerService.V20180930Preview.Inputs.NetworkProfileArgs
    ///             {
    ///                 VnetCidr = "10.0.0.0/8",
    ///             },
    ...
    ///             RouterProfiles = 
    ///             {
    ///                 new AzureRM.ContainerService.V20180930Preview.Inputs.OpenShiftRouterProfileArgs
    ///                 {
    ///                     Name = "default",
    ///                 },
    ///             },
    ...
    public partial class OpenShiftManagedCluster : Pulumi.CustomResource
    {
        ...
        public OpenShiftManagedCluster(string name, OpenShiftManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20180930preview:OpenShiftManagedCluster", name, args ?? new OpenShiftManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenShiftManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20180930preview:OpenShiftManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
