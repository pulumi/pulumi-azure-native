...
namespace Pulumi.AzureNative.ContainerService.V20180930Preview.Inputs
{
    ...
    public sealed class OpenShiftManagedClusterMasterPoolProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20180930Preview.OSType>? OsType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20180930Preview.OpenShiftContainerServiceVMSize> VmSize { get; set; } = null!;
