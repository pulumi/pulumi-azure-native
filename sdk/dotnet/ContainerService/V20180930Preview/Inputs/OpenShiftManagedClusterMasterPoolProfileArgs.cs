...
namespace Pulumi.AzureNextGen.ContainerService.V20180930Preview.Inputs
{
    ...
    public sealed class OpenShiftManagedClusterMasterPoolProfileArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerService.V20180930Preview.OSType>? OsType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ContainerService.V20180930Preview.OpenShiftContainerServiceVMSize> VmSize { get; set; } = null!;
