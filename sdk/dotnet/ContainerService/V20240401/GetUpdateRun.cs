...
namespace Pulumi.AzureNative.ContainerService.V20240401
{
    public static class GetUpdateRun
    {
        ...
        public static Task<GetUpdateRunResult> InvokeAsync(GetUpdateRunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUpdateRunResult>("azure-native:containerservice/v20240401:getUpdateRun", args ?? new GetUpdateRunArgs(), options.WithDefaults());
