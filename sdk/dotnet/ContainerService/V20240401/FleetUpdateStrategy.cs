...
namespace Pulumi.AzureNative.ContainerService.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20240401:FleetUpdateStrategy")]
    public partial class FleetUpdateStrategy : global::Pulumi.CustomResource
    {
        ...
        public FleetUpdateStrategy(string name, FleetUpdateStrategyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240401:FleetUpdateStrategy", name, args ?? new FleetUpdateStrategyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FleetUpdateStrategy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240401:FleetUpdateStrategy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:containerservice/v20230815preview:FleetUpdateStrategy" },
