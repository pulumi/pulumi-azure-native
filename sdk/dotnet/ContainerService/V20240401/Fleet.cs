...
namespace Pulumi.AzureNative.ContainerService.V20240401
{
    ...
    /// The Fleet resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20240401:Fleet")]
    public partial class Fleet : global::Pulumi.CustomResource
    {
        ...
        public Fleet(string name, FleetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240401:Fleet", name, args ?? new FleetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fleet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240401:Fleet", name, null, MakeResourceOptions(options, id))
        {
        }
