...
namespace Pulumi.AzureRM.ContainerService.V20170131
{
    public static class GetContainerService
    {
        public static Task<GetContainerServiceResult> InvokeAsync(GetContainerServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContainerServiceResult>("azurerm:containerservice/v20170131:getContainerService", args ?? new GetContainerServiceArgs(), options.WithVersion());
    }
