...
namespace Pulumi.AzureNative.ContainerService.V20170131
{
    ...
    /// Container service.
    /// </summary>
    [Obsolete(@"Version v20170131 will be removed in the next major version of the provider. Upgrade to version v20190430 or later.")]
    ...
    public partial class ContainerService : Pulumi.CustomResource
    {
        ...
        public ContainerService(string name, ContainerServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20170131:ContainerService", name, args ?? new ContainerServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20170131:ContainerService", name, null, MakeResourceOptions(options, id))
        {
        }
