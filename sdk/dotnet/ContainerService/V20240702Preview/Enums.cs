...
namespace Pulumi.AzureNative.ContainerService.V20240702Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct TLSManagement : IEquatable<TLSManagement>
    {
        private readonly string _value;

        private TLSManagement(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static TLSManagement None { get; } = new TLSManagement("None");
        /// <summary>
        /// Enable TLS and cert rotation is managed by Azure.
        /// </summary>
        public static TLSManagement Managed { get; } = new TLSManagement("Managed");

        public static bool operator ==(TLSManagement left, TLSManagement right) => left.Equals(right);
        public static bool operator !=(TLSManagement left, TLSManagement right) => !left.Equals(right);

        public static explicit operator string(TLSManagement value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is TLSManagement other && Equals(other);
        public bool Equals(TLSManagement other) => string.Equals(_value, other._value, StringComparison.Ordinal);
