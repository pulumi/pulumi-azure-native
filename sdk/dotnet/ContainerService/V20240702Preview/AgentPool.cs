...
namespace Pulumi.AzureNative.ContainerService.V20240702Preview
{
    ...
    /// Agent Pool.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20240702preview:AgentPool")]
    public partial class AgentPool : global::Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240702preview:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240702preview:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AgentPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.GPUInstanceProfile>? GpuInstanceProfile { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.KubeletDiskType>? KubeletDiskType { get; set; }
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.AgentPoolMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("osDiskType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.OSDiskType>? OsDiskType { get; set; }

        /// <summary>
        /// Specifies the OS SKU used by the agent pool. If not specified, the default is Ubuntu if OSType=Linux or Windows2019 if OSType=Windows. And the default Windows OSSKU will be changed to Windows2022 after Windows2019 is deprecated.
        /// </summary>
        [Input("osSKU")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.OSSKU>? OsSKU { get; set; }

        /// <summary>
        /// The operating system type. The default is Linux.
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.OSType>? OsType { get; set; }

        /// <summary>
        /// The IP allocation mode for pods in the agent pool. Must be used with podSubnetId. The default is 'DynamicIndividual'.
        /// </summary>
        [Input("podIPAllocationMode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.PodIPAllocationMode>? PodIPAllocationMode { get; set; }
        ...
        /// </summary>
        [Input("scaleDownMode")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.ScaleDownMode>? ScaleDownMode { get; set; }

        /// <summary>
        /// This cannot be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'.
        /// </summary>
        [Input("scaleSetEvictionPolicy")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.ScaleSetEvictionPolicy>? ScaleSetEvictionPolicy { get; set; }

        /// <summary>
        /// The Virtual Machine Scale Set priority. If not specified, the default is 'Regular'.
        /// </summary>
        [Input("scaleSetPriority")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.ScaleSetPriority>? ScaleSetPriority { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.AgentPoolType>? Type { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.WorkloadRuntime>? WorkloadRuntime { get; set; }
