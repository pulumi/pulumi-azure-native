...
namespace Pulumi.AzureNative.ContainerService.V20240702Preview
{
    public static class GetLoadBalancer
    {
        ...
        public static Task<GetLoadBalancerResult> InvokeAsync(GetLoadBalancerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLoadBalancerResult>("azure-native:containerservice/v20240702preview:getLoadBalancer", args ?? new GetLoadBalancerArgs(), options.WithDefaults());
