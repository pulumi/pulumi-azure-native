...
namespace Pulumi.AzureNative.ContainerService.V20240702Preview
{
    ...
    /// Managed cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20240702preview:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("safeguardsProfile")]
        public Output<Outputs.SafeguardsProfileResponse?> SafeguardsProfile { get; private set; } = null!;
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240702preview:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240702preview:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        /// The Safeguards profile holds all the safeguards information for a given cluster
        /// </summary>
        [Input("safeguardsProfile")]
        public Input<Inputs.SafeguardsProfileArgs>? SafeguardsProfile { get; set; }
        ...
        /// </summary>
        [Input("supportPlan")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240702Preview.KubernetesSupportPlan>? SupportPlan { get; set; }
