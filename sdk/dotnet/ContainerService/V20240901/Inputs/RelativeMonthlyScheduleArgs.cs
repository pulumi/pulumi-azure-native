...
namespace Pulumi.AzureNative.ContainerService.V20240901.Inputs
{
    ...
    public sealed class RelativeMonthlyScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240901.WeekDay> DayOfWeek { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240901.Type> WeekIndex { get; set; } = null!;
