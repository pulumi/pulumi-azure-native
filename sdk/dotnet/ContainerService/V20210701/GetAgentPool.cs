...
namespace Pulumi.AzureNative.ContainerService.V20210701
{
    public static class GetAgentPool
    {
        ...
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azure-native:containerservice/v20210701:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithVersion());

        /// <summary>
        /// Agent Pool.
        /// </summary>
        public static Output<GetAgentPoolResult> Invoke(GetAgentPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAgentPoolResult>("azure-native:containerservice/v20210701:getAgentPool", args ?? new GetAgentPoolInvokeArgs(), options.WithVersion());
    }
