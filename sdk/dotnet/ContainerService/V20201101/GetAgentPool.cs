...
namespace Pulumi.AzureNextGen.ContainerService.V20201101
{
    public static class GetAgentPool
    {
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azure-nextgen:containerservice/v20201101:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithVersion());
    }
