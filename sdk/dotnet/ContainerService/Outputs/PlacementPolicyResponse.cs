...
namespace Pulumi.AzureNative.ContainerService.Outputs
{
    ...
    public sealed class PlacementPolicyResponse
    {
        ...
        /// </summary>
        public readonly Outputs.AffinityResponse? Affinity;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.TolerationResponse> Tolerations;

        [OutputConstructor]
        private PlacementPolicyResponse(
            Outputs.AffinityResponse? affinity,

            ImmutableArray<string> clusterNames,

            string? placementType,

            ImmutableArray<Outputs.TolerationResponse> tolerations)
        {
            Affinity = affinity;
