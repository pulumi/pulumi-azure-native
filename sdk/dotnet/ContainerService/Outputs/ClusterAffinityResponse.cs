...
namespace Pulumi.AzureNative.ContainerService.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterAffinityResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ClusterSelectorResponse? RequiredDuringSchedulingIgnoredDuringExecution;

        [OutputConstructor]
        private ClusterAffinityResponse(Outputs.ClusterSelectorResponse? requiredDuringSchedulingIgnoredDuringExecution)
        {
