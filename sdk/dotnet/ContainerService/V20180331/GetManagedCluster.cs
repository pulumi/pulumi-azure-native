...
namespace Pulumi.AzureRM.ContainerService.V20180331
{
    public static class GetManagedCluster
    {
        public static Task<GetManagedClusterResult> InvokeAsync(GetManagedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedClusterResult>("azurerm:containerservice/v20180331:getManagedCluster", args ?? new GetManagedClusterArgs(), options.WithVersion());
    }
