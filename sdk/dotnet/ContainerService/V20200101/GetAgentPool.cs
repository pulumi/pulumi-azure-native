...
namespace Pulumi.AzureRM.ContainerService.V20200101
{
    public static class GetAgentPool
    {
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azurerm:containerservice/v20200101:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithVersion());
    }
