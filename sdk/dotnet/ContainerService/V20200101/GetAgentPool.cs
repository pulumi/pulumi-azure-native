...
namespace Pulumi.AzureNextGen.ContainerService.V20200101
{
    public static class GetAgentPool
    {
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azure-nextgen:containerservice/v20200101:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithVersion());
    }
