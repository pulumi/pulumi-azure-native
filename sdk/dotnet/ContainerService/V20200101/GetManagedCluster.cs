...
namespace Pulumi.AzureNextGen.ContainerService.V20200101
{
    public static class GetManagedCluster
    {
        public static Task<GetManagedClusterResult> InvokeAsync(GetManagedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedClusterResult>("azure-nextgen:containerservice/v20200101:getManagedCluster", args ?? new GetManagedClusterArgs(), options.WithVersion());
    }
