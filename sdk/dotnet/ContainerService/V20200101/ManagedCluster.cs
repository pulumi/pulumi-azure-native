...
namespace Pulumi.AzureNative.ContainerService.V20200101
{
    ...
    /// Managed cluster.
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20200101:ManagedCluster")]
    public partial class ManagedCluster : Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20200101:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20200101:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:containerservice/v20210501:ManagedCluster"},
                    new Pulumi.Alias { Type = "azure-native:containerservice/v20210701:ManagedCluster"},
                    new Pulumi.Alias { Type = "azure-nextgen:containerservice/v20210701:ManagedCluster"},
                    new Pulumi.Alias { Type = "azure-native:containerservice/v20210801:ManagedCluster"},
                    new Pulumi.Alias { Type = "azure-nextgen:containerservice/v20210801:ManagedCluster"},
                    new Pulumi.Alias { Type = "azure-native:containerservice/v20210901:ManagedCluster"},
                    new Pulumi.Alias { Type = "azure-nextgen:containerservice/v20210901:ManagedCluster"},
                },
            };
