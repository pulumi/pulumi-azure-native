...
namespace Pulumi.AzureNative.ContainerService.V20241002Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20241002preview:ManagedClusterSnapshot")]
    public partial class ManagedClusterSnapshot : global::Pulumi.CustomResource
    {
        ...
        public ManagedClusterSnapshot(string name, ManagedClusterSnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20241002preview:ManagedClusterSnapshot", name, args ?? new ManagedClusterSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedClusterSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20241002preview:ManagedClusterSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
