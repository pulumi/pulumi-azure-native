...
namespace Pulumi.AzureNative.ContainerService.V20230615Preview
{
    public static class GetFleetMember
    {
        ...
        public static Task<GetFleetMemberResult> InvokeAsync(GetFleetMemberArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFleetMemberResult>("azure-native:containerservice/v20230615preview:getFleetMember", args ?? new GetFleetMemberArgs(), options.WithDefaults());

        /// <summary>
        /// Get a FleetMember
        /// </summary>
        public static Output<GetFleetMemberResult> Invoke(GetFleetMemberInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFleetMemberResult>("azure-native:containerservice/v20230615preview:getFleetMember", args ?? new GetFleetMemberInvokeArgs(), options.WithDefaults());
    }
