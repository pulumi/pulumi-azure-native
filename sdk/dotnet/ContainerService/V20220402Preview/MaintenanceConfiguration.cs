...
namespace Pulumi.AzureNative.ContainerService.V20220402Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:containerservice/v20220402preview:MaintenanceConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:MaintenanceConfiguration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:containerservice/v20220402preview:MaintenanceConfiguration")]
    public partial class MaintenanceConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MaintenanceConfiguration(string name, MaintenanceConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220402preview:MaintenanceConfiguration", name, args ?? new MaintenanceConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MaintenanceConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20220402preview:MaintenanceConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
