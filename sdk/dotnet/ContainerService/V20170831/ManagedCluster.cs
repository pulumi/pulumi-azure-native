...
namespace Pulumi.AzureNative.ContainerService.V20170831
{
    ...
    /// Managed cluster.
    /// </summary>
    [Obsolete(@"Version v20170831 will be removed in the next major version of the provider. Upgrade to version v20190430 or later.")]
    ...
    public partial class ManagedCluster : Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20170831:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20170831:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
