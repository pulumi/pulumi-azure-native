...
namespace Pulumi.AzureRM.ContainerService.V20170831
{
    public static class GetManagedCluster
    {
        public static Task<GetManagedClusterResult> InvokeAsync(GetManagedClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedClusterResult>("azurerm:containerservice/v20170831:getManagedCluster", args ?? new GetManagedClusterArgs(), options.WithVersion());
    }
