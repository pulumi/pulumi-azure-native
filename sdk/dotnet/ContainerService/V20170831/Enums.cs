...
namespace Pulumi.AzureNextGen.ContainerService.V20170831
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct ContainerServiceStorageProfileTypes : IEquatable<ContainerServiceStorageProfileTypes>
    {
        private readonly string _value;

        private ContainerServiceStorageProfileTypes(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static ContainerServiceStorageProfileTypes StorageAccount { get; } = new ContainerServiceStorageProfileTypes("StorageAccount");
        public static ContainerServiceStorageProfileTypes ManagedDisks { get; } = new ContainerServiceStorageProfileTypes("ManagedDisks");
        ...
        public static explicit operator string(ContainerServiceStorageProfileTypes value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ContainerServiceStorageProfileTypes other && Equals(other);
        public bool Equals(ContainerServiceStorageProfileTypes other) => string.Equals(_value, other._value, StringComparison.Ordinal);
