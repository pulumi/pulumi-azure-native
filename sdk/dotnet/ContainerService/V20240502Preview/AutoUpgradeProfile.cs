...
namespace Pulumi.AzureNative.ContainerService.V20240502Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20240502preview:AutoUpgradeProfile")]
    public partial class AutoUpgradeProfile : global::Pulumi.CustomResource
    {
        ...
        public AutoUpgradeProfile(string name, AutoUpgradeProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240502preview:AutoUpgradeProfile", name, args ?? new AutoUpgradeProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutoUpgradeProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240502preview:AutoUpgradeProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:containerservice:AutoUpgradeProfile" },
                },
            };
    ...
    public sealed class AutoUpgradeProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240502Preview.UpgradeChannel> Channel { get; set; } = null!;
