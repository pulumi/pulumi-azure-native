...
namespace Pulumi.AzureNative.ContainerService.V20240502Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20240502preview:FleetUpdateStrategy")]
    public partial class FleetUpdateStrategy : global::Pulumi.CustomResource
    {
        ...
        public FleetUpdateStrategy(string name, FleetUpdateStrategyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240502preview:FleetUpdateStrategy", name, args ?? new FleetUpdateStrategyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FleetUpdateStrategy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240502preview:FleetUpdateStrategy", name, null, MakeResourceOptions(options, id))
        {
        }
