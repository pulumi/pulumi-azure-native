...
namespace Pulumi.AzureNative.ContainerService.V20240502Preview
{
    public static class GetAutoUpgradeProfile
    {
        ...
        public static Task<GetAutoUpgradeProfileResult> InvokeAsync(GetAutoUpgradeProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutoUpgradeProfileResult>("azure-native:containerservice/v20240502preview:getAutoUpgradeProfile", args ?? new GetAutoUpgradeProfileArgs(), options.WithDefaults());
