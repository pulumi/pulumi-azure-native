...
namespace Pulumi.AzureNative.ContainerService.V20240502Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20240502preview:ManagedClusterSnapshot")]
    public partial class ManagedClusterSnapshot : global::Pulumi.CustomResource
    {
        ...
        public ManagedClusterSnapshot(string name, ManagedClusterSnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240502preview:ManagedClusterSnapshot", name, args ?? new ManagedClusterSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedClusterSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240502preview:ManagedClusterSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedClusterSnapshotArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("snapshotType")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20240502Preview.SnapshotType>? SnapshotType { get; set; }
