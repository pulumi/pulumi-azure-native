...
namespace Pulumi.AzureNative.ContainerService.V20240502Preview
{
    public static class GetUpdateRun
    {
        ...
        public static Task<GetUpdateRunResult> InvokeAsync(GetUpdateRunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUpdateRunResult>("azure-native:containerservice/v20240502preview:getUpdateRun", args ?? new GetUpdateRunArgs(), options.WithDefaults());

        /// <summary>
        /// Get a UpdateRun
        /// </summary>
        public static Output<GetUpdateRunResult> Invoke(GetUpdateRunInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUpdateRunResult>("azure-native:containerservice/v20240502preview:getUpdateRun", args ?? new GetUpdateRunInvokeArgs(), options.WithDefaults());
