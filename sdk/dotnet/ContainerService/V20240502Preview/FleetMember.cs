...
namespace Pulumi.AzureNative.ContainerService.V20240502Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20240502preview:FleetMember")]
    public partial class FleetMember : global::Pulumi.CustomResource
    {
        ...
        public FleetMember(string name, FleetMemberArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240502preview:FleetMember", name, args ?? new FleetMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FleetMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20240502preview:FleetMember", name, null, MakeResourceOptions(options, id))
        {
        }
