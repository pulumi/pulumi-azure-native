...
namespace Pulumi.AzureRM.ContainerService.V20160930
{
    public static class GetContainerService
    {
        public static Task<GetContainerServiceResult> InvokeAsync(GetContainerServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContainerServiceResult>("azurerm:containerservice/v20160930:getContainerService", args ?? new GetContainerServiceArgs(), options.WithVersion());
    }
