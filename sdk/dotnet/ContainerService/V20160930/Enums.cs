...
namespace Pulumi.AzureNative.ContainerService.V20160930
{
    /// <summary>
    /// The orchestrator to use to manage container service cluster resources. Valid values are Swarm, DCOS, and Custom.
    /// </summary>
    [EnumType]
    public readonly struct ContainerServiceOchestratorTypes : IEquatable<ContainerServiceOchestratorTypes>
    {
        private readonly string _value;

        private ContainerServiceOchestratorTypes(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static ContainerServiceOchestratorTypes Swarm { get; } = new ContainerServiceOchestratorTypes("Swarm");
        public static ContainerServiceOchestratorTypes DCOS { get; } = new ContainerServiceOchestratorTypes("DCOS");
        public static ContainerServiceOchestratorTypes Custom { get; } = new ContainerServiceOchestratorTypes("Custom");
        public static ContainerServiceOchestratorTypes Kubernetes { get; } = new ContainerServiceOchestratorTypes("Kubernetes");

        public static bool operator ==(ContainerServiceOchestratorTypes left, ContainerServiceOchestratorTypes right) => left.Equals(right);
        public static bool operator !=(ContainerServiceOchestratorTypes left, ContainerServiceOchestratorTypes right) => !left.Equals(right);

        public static explicit operator string(ContainerServiceOchestratorTypes value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ContainerServiceOchestratorTypes other && Equals(other);
        public bool Equals(ContainerServiceOchestratorTypes other) => string.Equals(_value, other._value, StringComparison.Ordinal);
