...
namespace Pulumi.AzureRM.ContainerService.V20160930
{
    /// <summary>
    /// Container service.
    /// </summary>
    public partial class ContainerService : Pulumi.CustomResource
    {
        ...
        public ContainerService(string name, ContainerServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20160930:ContainerService", name, args ?? new ContainerServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20160930:ContainerService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:containerservice/v20151101preview:ContainerService"},
