...
namespace Pulumi.AzureNative.ContainerService.V20230502Preview.Inputs
{
    ...
    public sealed class UpgradeOverrideSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.ContainerService.V20230502Preview.ControlPlaneUpgradeOverride>>? _controlPlaneOverrides;

        /// <summary>
        /// List of upgrade overrides when upgrading a cluster's control plane.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ContainerService.V20230502Preview.ControlPlaneUpgradeOverride>> ControlPlaneOverrides
        {
            get => _controlPlaneOverrides ?? (_controlPlaneOverrides = new InputList<Union<string, Pulumi.AzureNative.ContainerService.V20230502Preview.ControlPlaneUpgradeOverride>>());
