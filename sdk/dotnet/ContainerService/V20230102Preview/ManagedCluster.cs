...
namespace Pulumi.AzureNative.ContainerService.V20230102Preview
{
    ...
    /// {
    ///     var managedCluster = new AzureNative.ContainerService.V20230102Preview.ManagedCluster("managedCluster", new()
    ///     {
    ///         AddonProfiles = null,
    ///         AgentPoolProfiles = new[]
    ///         {
    ///             new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterAgentPoolProfileArgs
    ///             {
    ...
    ///             },
    ///         },
    ///         AutoScalerProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterPropertiesAutoScalerProfileArgs
    ///         {
    ...
    ///         EnableRBAC = true,
    ///         KubernetesVersion = "",
    ///         LinuxProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ContainerServiceLinuxProfileArgs
    ///         {
    ///             AdminUsername = "azureuser",
    ///             Ssh = new AzureNative.ContainerService.V20230102Preview.Inputs.ContainerServiceSshConfigurationArgs
    ///             {
    ///                 PublicKeys = new[]
    ///                 {
    ///                     new AzureNative.ContainerService.V20230102Preview.Inputs.ContainerServiceSshPublicKeyArgs
    ///                     {
    ///                         KeyData = "keydata",
    ///                     },
    ///                 },
    ...
    ///         },
    ///         Location = "location1",
    ///         NetworkProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ContainerServiceNetworkProfileArgs
    ///         {
    ///             LoadBalancerProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterLoadBalancerProfileArgs
    ///             {
    ///                 ManagedOutboundIPs = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterLoadBalancerProfileManagedOutboundIPsArgs
    ///                 {
    ///                     Count = 2,
    ///                 },
    ///             },
    ...
    ///         ServicePrincipalProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterServicePrincipalProfileArgs
    ///         {
    ///             ClientId = "clientid",
    ///             Secret = "secret",
    ///         },
    ///         Sku = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterSKUArgs
    ///         {
    ///             Name = "Basic",
    ///             Tier = "Free",
    ///         },
    ...
    ///             { "tier", "production" },
    ///         },
    ///         WindowsProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterWindowsProfileArgs
    ///         {
    ...
    ///             },
    ///         },
    ///         CreationData = new AzureNative.ContainerService.V20230102Preview.Inputs.CreationDataArgs
    ///         {
    ...
    ///         {
    ///             LoadBalancerSku = "standard",
    ///             NatGatewayProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterNATGatewayProfileArgs
    ///             {
    ///                 ManagedOutboundIPProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterManagedOutboundIPProfileArgs
    ///                 {
    ///                     Count = 2,
    ///                 },
    ///             },
    ...
    ///         AddonProfiles = 
    ///         {
    ///             { "azureKeyvaultSecretsProvider", new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterAddonProfileArgs
    ///             {
    ///                 Config = 
    ///                 {
    ...
    ///         ResourceGroupName = "rg1",
    ///         ResourceName = "clustername1",
    ///         SecurityProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterSecurityProfileArgs
    ///         {
    ...
    ///         EnablePodSecurityPolicy = true,
    ///         EnableRBAC = true,
    ///         HttpProxyConfig = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterHTTPProxyConfigArgs
    ///         {
    ...
    ///             OutboundType = "loadBalancer",
    ///         },
    ///         PodIdentityProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterPodIdentityProfileArgs
    ///         {
    ...
    ///             },
    ///         },
    ///         ApiServerAccessProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterAPIServerAccessProfileArgs
    ///         {
    ...
    ///         SecurityProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterSecurityProfileArgs
    ///         {
    ///             Defender = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterSecurityProfileDefenderArgs
    ///             {
    ///                 LogAnalyticsWorkspaceResourceId = "/subscriptions/SUB_ID/resourcegroups/RG_NAME/providers/microsoft.operationalinsights/workspaces/WORKSPACE_NAME",
    ///                 SecurityMonitoring = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterSecurityProfileDefenderSecurityMonitoringArgs
    ///                 {
    ///                     Enabled = true,
    ///                 },
    ///             },
    ...
    ///         },
    ///         DnsPrefix = "dnsprefix1",
    ///         IngressProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterIngressProfileArgs
    ///         {
    ///             WebAppRouting = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterIngressProfileWebAppRoutingArgs
    ///             {
    ...
    ///     var managedCluster = new AzureNative.ContainerService.V20230102Preview.ManagedCluster("managedCluster", new()
    ///     {
    ///         AadProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterAADProfileArgs
    ///         {
    ...
    ///         EnablePodSecurityPolicy = true,
    ///         EnableRBAC = true,
    ///         Identity = new AzureNative.ContainerService.V20230102Preview.Inputs.ManagedClusterIdentityArgs
    ///         {
    ///             Type = AzureNative.ContainerService.V20230102Preview.ResourceIdentityType.UserAssigned,
    ...
    ///             { "tier", "production" },
    ///         },
    ///         UpgradeSettings = new AzureNative.ContainerService.V20230102Preview.Inputs.ClusterUpgradeSettingsArgs
    ///         {
    ///             OverrideSettings = new AzureNative.ContainerService.V20230102Preview.Inputs.UpgradeOverrideSettingsArgs
    ///             {
    ///                 ControlPlaneOverrides = new[]
    ///                 {
    ...
    ///             AdminPassword = "replacePassword1234$",
    ///             AdminUsername = "azureuser",
    ///             GmsaProfile = new AzureNative.ContainerService.V20230102Preview.Inputs.WindowsGmsaProfileArgs
    ///             {
    ///                 Enabled = true,
    ///             },
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230102preview:ManagedCluster")]
    public partial class ManagedCluster : global::Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230102preview:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230102preview:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230102Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
