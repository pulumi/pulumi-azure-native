...
namespace Pulumi.AzureNative.ContainerService.V20230102Preview
{
    ...
    /// {
    ///     var managedClusterSnapshot = new AzureNative.ContainerService.V20230102Preview.ManagedClusterSnapshot("managedClusterSnapshot", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230102preview:ManagedClusterSnapshot")]
    public partial class ManagedClusterSnapshot : global::Pulumi.CustomResource
    {
        ...
        public ManagedClusterSnapshot(string name, ManagedClusterSnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230102preview:ManagedClusterSnapshot", name, args ?? new ManagedClusterSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedClusterSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230102preview:ManagedClusterSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
