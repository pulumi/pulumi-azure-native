...
namespace Pulumi.AzureNative.ContainerService.V20230102Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct EbpfDataplane : IEquatable<EbpfDataplane>
    {
        private readonly string _value;

        private EbpfDataplane(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static EbpfDataplane Cilium { get; } = new EbpfDataplane("cilium");

        public static bool operator ==(EbpfDataplane left, EbpfDataplane right) => left.Equals(right);
        public static bool operator !=(EbpfDataplane left, EbpfDataplane right) => !left.Equals(right);

        public static explicit operator string(EbpfDataplane value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is EbpfDataplane other && Equals(other);
        public bool Equals(EbpfDataplane other) => string.Equals(_value, other._value, StringComparison.Ordinal);
