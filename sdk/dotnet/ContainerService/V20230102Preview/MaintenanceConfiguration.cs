...
namespace Pulumi.AzureNative.ContainerService.V20230102Preview
{
    ...
    /// {
    ///     var maintenanceConfiguration = new AzureNative.ContainerService.V20230102Preview.MaintenanceConfiguration("maintenanceConfiguration", new()
    ///     {
    ///         ConfigName = "default",
    ///         NotAllowedTime = new[]
    ///         {
    ///             new AzureNative.ContainerService.V20230102Preview.Inputs.TimeSpanArgs
    ///             {
    ...
    ///         TimeInWeek = new[]
    ///         {
    ///             new AzureNative.ContainerService.V20230102Preview.Inputs.TimeInWeekArgs
    ///             {
    ///                 Day = "Monday",
    ///                 HourSlots = new[]
    ///                 {
    ...
    ///         MaintenanceWindow = new AzureNative.ContainerService.V20230102Preview.Inputs.MaintenanceWindowArgs
    ///         {
    ///             DurationHours = 10,
    ///             NotAllowedDates = new[]
    ///             {
    ///                 new AzureNative.ContainerService.V20230102Preview.Inputs.DateSpanArgs
    ///                 {
    ///                     End = "2023-02-25",
    ///                     Start = "2023-02-18",
    ///                 },
    ...
    ///                 },
    ///             },
    ///             Schedule = new AzureNative.ContainerService.V20230102Preview.Inputs.ScheduleArgs
    ///             {
    ///                 RelativeMonthly = new AzureNative.ContainerService.V20230102Preview.Inputs.RelativeMonthlyScheduleArgs
    ///                 {
    ///                     DayOfWeek = "Monday",
    ///                     IntervalMonths = 3,
    ///                     WeekIndex = "First",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20230102preview:MaintenanceConfiguration")]
    public partial class MaintenanceConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MaintenanceConfiguration(string name, MaintenanceConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230102preview:MaintenanceConfiguration", name, args ?? new MaintenanceConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MaintenanceConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20230102preview:MaintenanceConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
