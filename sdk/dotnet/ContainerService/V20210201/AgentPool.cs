...
namespace Pulumi.AzureNative.ContainerService.V20210201
{
    ...
    /// {
    ///     var agentPool = new AzureNative.ContainerService.V20210201.AgentPool("agentPool", new()
    ///     {
    ...
    ///         AgentPoolName = "agentpool1",
    ///         Count = 3,
    ///         KubeletConfig = new AzureNative.ContainerService.V20210201.Inputs.KubeletConfigArgs
    ///         {
    ...
    ///         },
    ///         LinuxOSConfig = new AzureNative.ContainerService.V20210201.Inputs.LinuxOSConfigArgs
    ///         {
    ///             SwapFileSizeMB = 1500,
    ///             Sysctls = new AzureNative.ContainerService.V20210201.Inputs.SysctlConfigArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:containerservice/v20210201:AgentPool agentpool1 /subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/clustername1/agentPools/agentpool1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:containerservice/v20210201:AgentPool")]
    public partial class AgentPool : global::Pulumi.CustomResource
    {
        ...
        public AgentPool(string name, AgentPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20210201:AgentPool", name, args ?? new AgentPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerservice/v20210201:AgentPool", name, null, MakeResourceOptions(options, id))
        {
        }
