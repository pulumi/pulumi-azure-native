...
namespace Pulumi.AzureRM.ContainerService
{
    ...
    public partial class ContainerService : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ContainerServicePropertiesResponse> Properties { get; private set; } = null!;
        ...
        public ContainerService(string name, ContainerServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice:ContainerService", name, args ?? new ContainerServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerService(string name, Input<string> id, ContainerServiceState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:containerservice:ContainerService", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerServiceState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ContainerServicePropertiesResponseGetArgs> Properties { get; set; } = null!;
