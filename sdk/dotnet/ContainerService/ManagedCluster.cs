...
namespace Pulumi.AzureNextGen.ContainerService
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:containerservice:ManagedCluster")]
    public partial class ManagedCluster : Pulumi.CustomResource
    {
        ...
        public ManagedCluster(string name, ManagedClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerservice:ManagedCluster", name, args ?? new ManagedClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:containerservice:ManagedCluster", name, null, MakeResourceOptions(options, id))
        {
        }
