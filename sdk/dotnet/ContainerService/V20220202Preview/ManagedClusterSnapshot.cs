...
namespace Pulumi.AzureNative.ContainerService.V20220202Preview
{
    ...
    /// {
    ///     var managedClusterSnapshot = new AzureNative.ContainerService.V20220202Preview.ManagedClusterSnapshot("managedClusterSnapshot", new()
    ///     {
    ///         CreationData = new AzureNative.ContainerService.V20220202Preview.Inputs.CreationDataArgs
    ///         {
