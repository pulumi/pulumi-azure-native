...
namespace Pulumi.AzureNextGen.ContainerService.V20180801Preview.Inputs
{
    ...
    public sealed class ContainerServiceNetworkProfileArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("networkPlugin")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerService.V20180801Preview.NetworkPlugin>? NetworkPlugin { get; set; }

        /// <summary>
        /// Network policy used for building Kubernetes network.
        /// </summary>
        [Input("networkPolicy")]
        public InputUnion<string, Pulumi.AzureNextGen.ContainerService.V20180801Preview.NetworkPolicy>? NetworkPolicy { get; set; }
