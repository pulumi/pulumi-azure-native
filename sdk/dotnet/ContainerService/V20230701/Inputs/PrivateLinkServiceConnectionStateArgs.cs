...
namespace Pulumi.AzureNative.ContainerService.V20230701.Inputs
{
    ...
    public sealed class PrivateLinkServiceConnectionStateArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.ContainerService.V20230701.ConnectionStatus>? Status { get; set; }
