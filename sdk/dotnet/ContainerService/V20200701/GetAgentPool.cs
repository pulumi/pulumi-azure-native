...
namespace Pulumi.AzureRM.ContainerService.V20200701
{
    public static class GetAgentPool
    {
        public static Task<GetAgentPoolResult> InvokeAsync(GetAgentPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAgentPoolResult>("azurerm:containerservice/v20200701:getAgentPool", args ?? new GetAgentPoolArgs(), options.WithVersion());
    }
