...
namespace Pulumi.AzureRM.ContainerService.V20200701
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.ContainerService.V20200701.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.ContainerService.V20200701.PrivateEndpointConnectionArgs
    ///         {
    ///             PrivateEndpointConnectionName = "privateendpointconnection1",
    ///             PrivateLinkServiceConnectionState = new AzureRM.ContainerService.V20200701.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ///                 Status = "Approved",
    ///             },
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20200701:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:containerservice/v20200701:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:containerservice/v20200601:PrivateEndpointConnection"},
                },
            };
