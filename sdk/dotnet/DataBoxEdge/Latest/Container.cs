...
namespace Pulumi.AzureRM.DataBoxEdge.Latest
{
    ...
    public partial class Container : Pulumi.CustomResource
    {
        ...
        public Container(string name, ContainerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/latest:Container", name, args ?? new ContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Container(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/latest:Container", name, null, MakeResourceOptions(options, id))
        {
        }
