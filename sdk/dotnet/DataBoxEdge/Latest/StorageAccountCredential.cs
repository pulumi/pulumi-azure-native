...
namespace Pulumi.AzureRM.DataBoxEdge.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var storageAccountCredential = new AzureRM.DataBoxEdge.Latest.StorageAccountCredential("storageAccountCredential", new AzureRM.DataBoxEdge.Latest.StorageAccountCredentialArgs
    ///         {
    ///             AccountKey = new AzureRM.DataBoxEdge.Latest.Inputs.AsymmetricEncryptedSecretArgs
    ///             {
    ...
    public partial class StorageAccountCredential : Pulumi.CustomResource
    {
        ...
        public StorageAccountCredential(string name, StorageAccountCredentialArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/latest:StorageAccountCredential", name, args ?? new StorageAccountCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccountCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/latest:StorageAccountCredential", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:databoxedge/v20200501preview:StorageAccountCredential"},
                },
            };
