...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    /// {
    ///     var device = new AzureNative.DataBoxEdge.V20210201Preview.Device("device", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         Location = "WUS",
    ///         ResourceGroupName = "GroupForEdgeAutomation",
    ///         Sku = new AzureNative.DataBoxEdge.V20210201Preview.Inputs.SkuArgs
    ///         {
    ///             Name = "Edge",
    ///             Tier = "Standard",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210201preview:Device")]
    public partial class Device : global::Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:Device", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeviceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201Preview.DataBoxEdgeDeviceStatus>? DataBoxEdgeDeviceStatus { get; set; }
