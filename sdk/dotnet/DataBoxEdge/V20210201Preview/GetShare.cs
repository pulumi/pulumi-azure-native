...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    public static class GetShare
    {
        ...
        public static Task<GetShareResult> InvokeAsync(GetShareArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetShareResult>("azure-native:databoxedge/v20210201preview:getShare", args ?? new GetShareArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a share on the  Data Box Edge/Gateway device.
        /// </summary>
        public static Output<GetShareResult> Invoke(GetShareInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetShareResult>("azure-native:databoxedge/v20210201preview:getShare", args ?? new GetShareInvokeArgs(), options.WithDefaults());
    }
