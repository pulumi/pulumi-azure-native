...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    public static class GetArcAddon
    {
        ...
        public static Task<GetArcAddonResult> InvokeAsync(GetArcAddonArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetArcAddonResult>("azure-native:databoxedge/v20210201preview:getArcAddon", args ?? new GetArcAddonArgs(), options.WithDefaults());

        /// <summary>
        /// Arc Addon.
        /// </summary>
        public static Output<GetArcAddonResult> Invoke(GetArcAddonInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetArcAddonResult>("azure-native:databoxedge/v20210201preview:getArcAddon", args ?? new GetArcAddonInvokeArgs(), options.WithDefaults());
    }
