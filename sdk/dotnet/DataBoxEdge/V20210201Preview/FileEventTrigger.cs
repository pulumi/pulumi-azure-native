...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    /// {
    ///     var fileEventTrigger = new AzureNative.DataBoxEdge.V20210201Preview.FileEventTrigger("fileEventTrigger", new()
    ///     {
    ...
    ///         SinkInfo = new AzureNative.DataBoxEdge.V20210201Preview.Inputs.RoleSinkInfoArgs
    ///         {
    ...
    ///         },
    ///         SourceInfo = new AzureNative.DataBoxEdge.V20210201Preview.Inputs.FileSourceInfoArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210201preview:FileEventTrigger")]
    public partial class FileEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public FileEventTrigger(string name, FileEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:FileEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FileEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:FileEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
