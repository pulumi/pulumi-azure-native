...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    public static class GetRole
    {
        ...
        public static Task<GetRoleResult> InvokeAsync(GetRoleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRoleResult>("azure-native:databoxedge/v20210201preview:getRole", args ?? new GetRoleArgs(), options.WithVersion());

        /// <summary>
        /// Compute role.
        /// </summary>
        public static Output<GetRoleResult> Invoke(GetRoleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRoleResult>("azure-native:databoxedge/v20210201preview:getRole", args ?? new GetRoleInvokeArgs(), options.WithVersion());
    }
