...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20210201preview:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:StorageAccount to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20210201preview:StorageAccount")]
    public partial class StorageAccount : global::Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201Preview.DataPolicy> DataPolicy { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201Preview.StorageAccountStatus>? StorageAccountStatus { get; set; }
