...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    public static class GetMonitoringConfig
    {
        ...
        public static Task<GetMonitoringConfigResult> InvokeAsync(GetMonitoringConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMonitoringConfigResult>("azure-native:databoxedge/v20210201preview:getMonitoringConfig", args ?? new GetMonitoringConfigArgs(), options.WithVersion());

        /// <summary>
        /// The metric setting details for the role
        /// </summary>
        public static Output<GetMonitoringConfigResult> Invoke(GetMonitoringConfigInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMonitoringConfigResult>("azure-native:databoxedge/v20210201preview:getMonitoringConfig", args ?? new GetMonitoringConfigInvokeArgs(), options.WithVersion());
    }
