...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    /// {
    ///     var user = new AzureNative.DataBoxEdge.V20210201Preview.User("user", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         EncryptedPassword = new AzureNative.DataBoxEdge.V20210201Preview.Inputs.AsymmetricEncryptedSecretArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210201preview:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:User", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("userType")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201Preview.UserType>? UserType { get; set; }
