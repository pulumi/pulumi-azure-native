...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    public static class GetTrigger
    {
        ...
        public static Output<GetTriggerResult> Invoke(GetTriggerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTriggerResult>("azure-native:databoxedge/v20210201preview:getTrigger", args ?? new GetTriggerInvokeArgs(), options.WithVersion());
    }
