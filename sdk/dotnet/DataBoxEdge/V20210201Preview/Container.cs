...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210201preview:Container")]
    public partial class Container : Pulumi.CustomResource
    {
        ...
        public Container(string name, ContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:Container", name, args ?? new ContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Container(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:Container", name, null, MakeResourceOptions(options, id))
        {
        }
