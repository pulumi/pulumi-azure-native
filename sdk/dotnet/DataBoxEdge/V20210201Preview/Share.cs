...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20210201preview:Share is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Share to guarantee forwards compatibility.")]
    ...
    public partial class Share : global::Pulumi.CustomResource
    {
        ...
        public Share(string name, ShareArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:Share", name, args ?? new ShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Share(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:Share", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ShareArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201Preview.ShareAccessProtocol> AccessProtocol { get; set; } = null!;
        ...
        /// </summary>
        [Input("dataPolicy")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201Preview.DataPolicy>? DataPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201Preview.MonitoringStatus> MonitoringStatus { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201Preview.ShareStatus> ShareStatus { get; set; } = null!;
