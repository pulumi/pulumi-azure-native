...
{
    [Obsolete(@"azure-native:databoxedge/v20221201preview:StorageAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:StorageAccount to guarantee forwards compatibility.")]
    public static class GetStorageAccount
    {
        ...
        public static Task<GetStorageAccountResult> InvokeAsync(GetStorageAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageAccountResult>("azure-native:databoxedge/v20221201preview:getStorageAccount", args ?? new GetStorageAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a Storage Account on the  Data Box Edge/Gateway device.
        /// </summary>
        public static Output<GetStorageAccountResult> Invoke(GetStorageAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageAccountResult>("azure-native:databoxedge/v20221201preview:getStorageAccount", args ?? new GetStorageAccountInvokeArgs(), options.WithDefaults());
    }
