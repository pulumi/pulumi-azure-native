...
namespace Pulumi.AzureNative.DataBoxEdge.V20221201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20221201preview:StorageAccountCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:StorageAccountCredential to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20221201preview:StorageAccountCredential")]
    public partial class StorageAccountCredential : global::Pulumi.CustomResource
    {
        ...
        public StorageAccountCredential(string name, StorageAccountCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20221201preview:StorageAccountCredential", name, args ?? new StorageAccountCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccountCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20221201preview:StorageAccountCredential", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountCredentialArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20221201Preview.AccountType> AccountType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20221201Preview.SSLStatus> SslStatus { get; set; } = null!;
