...
namespace Pulumi.AzureNative.DataBoxEdge.V20221201Preview
{
    public static class GetUser
    {
        ...
        public static Task<GetUserResult> InvokeAsync(GetUserArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserResult>("azure-native:databoxedge/v20221201preview:getUser", args ?? new GetUserArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified user.
        /// </summary>
        public static Output<GetUserResult> Invoke(GetUserInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserResult>("azure-native:databoxedge/v20221201preview:getUser", args ?? new GetUserInvokeArgs(), options.WithDefaults());
    }
