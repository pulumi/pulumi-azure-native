...
namespace Pulumi.AzureNative.DataBoxEdge.V20221201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20221201preview:Container")]
    public partial class Container : global::Pulumi.CustomResource
    {
        ...
        public Container(string name, ContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20221201preview:Container", name, args ?? new ContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Container(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20221201preview:Container", name, null, MakeResourceOptions(options, id))
        {
        }
