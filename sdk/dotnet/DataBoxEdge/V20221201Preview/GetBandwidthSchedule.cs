...
namespace Pulumi.AzureNative.DataBoxEdge.V20221201Preview
{
    ...
    public static class GetBandwidthSchedule
    {
        ...
        public static Task<GetBandwidthScheduleResult> InvokeAsync(GetBandwidthScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBandwidthScheduleResult>("azure-native:databoxedge/v20221201preview:getBandwidthSchedule", args ?? new GetBandwidthScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified bandwidth schedule.
        /// </summary>
        public static Output<GetBandwidthScheduleResult> Invoke(GetBandwidthScheduleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBandwidthScheduleResult>("azure-native:databoxedge/v20221201preview:getBandwidthSchedule", args ?? new GetBandwidthScheduleInvokeArgs(), options.WithDefaults());
    }
