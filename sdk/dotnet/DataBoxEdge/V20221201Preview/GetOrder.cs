...
namespace Pulumi.AzureNative.DataBoxEdge.V20221201Preview
{
    ...
    public static class GetOrder
    {
        ...
        public static Task<GetOrderResult> InvokeAsync(GetOrderArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOrderResult>("azure-native:databoxedge/v20221201preview:getOrder", args ?? new GetOrderArgs(), options.WithDefaults());

        /// <summary>
        /// The order details.
        /// </summary>
        public static Output<GetOrderResult> Invoke(GetOrderInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrderResult>("azure-native:databoxedge/v20221201preview:getOrder", args ?? new GetOrderInvokeArgs(), options.WithDefaults());
    }
