...
namespace Pulumi.AzureNative.DataBoxEdge.V20221201Preview
{
    /// <summary>
    /// Compute role.
    /// 
    ...
    /// {
    ///     var ioTRole = new AzureNative.DataBoxEdge.V20221201Preview.IoTRole("ioTRole", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         HostPlatform = "Linux",
    ///         IoTDeviceDetails = new AzureNative.DataBoxEdge.V20221201Preview.Inputs.IoTDeviceInfoArgs
    ///         {
    ///             Authentication = new AzureNative.DataBoxEdge.V20221201Preview.Inputs.AuthenticationArgs
    ///             {
    ///                 SymmetricKey = new AzureNative.DataBoxEdge.V20221201Preview.Inputs.SymmetricKeyArgs
    ///                 {
    ///                     ConnectionString = new AzureNative.DataBoxEdge.V20221201Preview.Inputs.AsymmetricEncryptedSecretArgs
    ///                     {
    ...
    ///         },
    ///         IoTEdgeDeviceDetails = new AzureNative.DataBoxEdge.V20221201Preview.Inputs.IoTDeviceInfoArgs
    ///         {
    ///             Authentication = new AzureNative.DataBoxEdge.V20221201Preview.Inputs.AuthenticationArgs
    ///             {
    ///                 SymmetricKey = new AzureNative.DataBoxEdge.V20221201Preview.Inputs.SymmetricKeyArgs
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databoxedge/v20221201preview:IoTRole IoTRole1 /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/testedgedevice/roles/IoTRole1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20221201preview:IoTRole")]
    public partial class IoTRole : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.ComputeResourceResponse?> ComputeResource { get; private set; } = null!;
        ...
        /// </summary>
        [Output("ioTEdgeAgentInfo")]
        public Output<Outputs.IoTEdgeAgentInfoResponse?> IoTEdgeAgentInfo { get; private set; } = null!;
        ...
        public IoTRole(string name, IoTRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20221201preview:IoTRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20221201preview:IoTRole", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IoTRoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20221201Preview.PlatformType> HostPlatform { get; set; } = null!;
        ...
        /// Iot edge agent details to download the agent and bootstrap iot runtime.
        /// </summary>
        [Input("ioTEdgeAgentInfo")]
        public Input<Inputs.IoTEdgeAgentInfoArgs>? IoTEdgeAgentInfo { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20221201Preview.RoleStatus> RoleStatus { get; set; } = null!;
