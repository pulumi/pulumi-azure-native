...
namespace Pulumi.AzureNative.DataBoxEdge.V20221201Preview
{
    public static class GetMarketplaceImageSasTokenSASToken
    {
        public static Task<GetMarketplaceImageSasTokenSASTokenResult> InvokeAsync(GetMarketplaceImageSasTokenSASTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMarketplaceImageSasTokenSASTokenResult>("azure-native:databoxedge/v20221201preview:getMarketplaceImageSasTokenSASToken", args ?? new GetMarketplaceImageSasTokenSASTokenArgs(), options.WithDefaults());
        ...
        public static Output<GetMarketplaceImageSasTokenSASTokenResult> Invoke(GetMarketplaceImageSasTokenSASTokenInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMarketplaceImageSasTokenSASTokenResult>("azure-native:databoxedge/v20221201preview:getMarketplaceImageSasTokenSASToken", args ?? new GetMarketplaceImageSasTokenSASTokenInvokeArgs(), options.WithDefaults());
