...
namespace Pulumi.AzureNative.DataBoxEdge.V20221201Preview
{
    ...
    /// {
    ///     var arcAddon = new AzureNative.DataBoxEdge.V20221201Preview.ArcAddon("arcAddon", new()
    ///     {
    ///         AddonName = "arcName",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databoxedge/v20221201preview:ArcAddon arcName /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourcegroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/addonExamples/roles/kubernetesRole/addons/arcName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20221201preview:ArcAddon")]
    public partial class ArcAddon : global::Pulumi.CustomResource
    {
        ...
        public ArcAddon(string name, ArcAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20221201preview:ArcAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ArcAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20221201preview:ArcAddon", name, null, MakeResourceOptions(options, id))
        {
        }
