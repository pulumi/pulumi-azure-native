...
namespace Pulumi.AzureNative.DataBoxEdge.V20220401Preview
{
    ...
    public static class GetAddon
    {
        ...
        public static Task<GetAddonResult> InvokeAsync(GetAddonArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAddonResult>("azure-native:databoxedge/v20220401preview:getAddon", args ?? new GetAddonArgs(), options.WithDefaults());

        /// <summary>
        /// Role Addon
        /// </summary>
        public static Output<GetAddonResult> Invoke(GetAddonInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAddonResult>("azure-native:databoxedge/v20220401preview:getAddon", args ?? new GetAddonInvokeArgs(), options.WithDefaults());
    }
