...
namespace Pulumi.AzureNative.DataBoxEdge.V20220401Preview
{
    ...
    /// {
    ///     var fileEventTrigger = new AzureNative.DataBoxEdge.V20220401Preview.FileEventTrigger("fileEventTrigger", new()
    ///     {
    ...
    ///         SinkInfo = new AzureNative.DataBoxEdge.V20220401Preview.Inputs.RoleSinkInfoArgs
    ///         {
    ...
    ///         },
    ///         SourceInfo = new AzureNative.DataBoxEdge.V20220401Preview.Inputs.FileSourceInfoArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20220401preview:FileEventTrigger")]
    public partial class FileEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public FileEventTrigger(string name, FileEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220401preview:FileEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FileEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220401preview:FileEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
