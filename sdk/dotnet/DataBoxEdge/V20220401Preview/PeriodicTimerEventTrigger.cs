...
namespace Pulumi.AzureNative.DataBoxEdge.V20220401Preview
{
    ...
    /// {
    ///     var periodicTimerEventTrigger = new AzureNative.DataBoxEdge.V20220401Preview.PeriodicTimerEventTrigger("periodicTimerEventTrigger", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20220401preview:PeriodicTimerEventTrigger")]
    public partial class PeriodicTimerEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public PeriodicTimerEventTrigger(string name, PeriodicTimerEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220401preview:PeriodicTimerEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private PeriodicTimerEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220401preview:PeriodicTimerEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
