...
namespace Pulumi.AzureNative.DataBoxEdge.V20220401Preview
{
    ...
    public static class GetTrigger
    {
        ...
        public static Task<GetTriggerResult> InvokeAsync(GetTriggerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTriggerResult>("azure-native:databoxedge/v20220401preview:getTrigger", args ?? new GetTriggerArgs(), options.WithDefaults());

        /// <summary>
        /// Trigger details.
        /// </summary>
        public static Output<GetTriggerResult> Invoke(GetTriggerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTriggerResult>("azure-native:databoxedge/v20220401preview:getTrigger", args ?? new GetTriggerInvokeArgs(), options.WithDefaults());
    }
