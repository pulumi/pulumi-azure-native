...
namespace Pulumi.AzureNative.DataBoxEdge.V20220401Preview
{
    ...
    /// Role Addon
    /// </summary>
    [Obsolete(@"Please use one of the variants: ArcAddon.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20220401preview:Addon")]
    public partial class Addon : Pulumi.CustomResource
    {
        ...
        public Addon(string name, AddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220401preview:Addon", name, args ?? new AddonArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Addon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220401preview:Addon", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AddonArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20220401Preview.AddonType> Kind { get; set; } = null!;
