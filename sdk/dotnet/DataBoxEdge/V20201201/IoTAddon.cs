...
namespace Pulumi.AzureNative.DataBoxEdge.V20201201
{
    ...
    /// {
    ///     var ioTAddon = new AzureNative.DataBoxEdge.V20201201.IoTAddon("ioTAddon", new()
    ///     {
    ///         AddonName = "arcName",
    ...
    public partial class IoTAddon : global::Pulumi.CustomResource
    {
        ...
        public IoTAddon(string name, IoTAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:IoTAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:IoTAddon", name, null, MakeResourceOptions(options, id))
        {
        }
