...
namespace Pulumi.AzureNative.DataBoxEdge.V20201201
{
    ...
    /// {
    ///     var user = new AzureNative.DataBoxEdge.V20201201.User("user", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         EncryptedPassword = new AzureNative.DataBoxEdge.V20201201.Inputs.AsymmetricEncryptedSecretArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databoxedge/v20201201:User user1 /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/testedgedevice/users/user1 
    /// ```
    /// </summary>
    ...
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:User", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20201201.UserType> UserType { get; set; } = null!;
