...
namespace Pulumi.AzureNative.DataBoxEdge.V20201201
{
    ...
    /// {
    ///     var kubernetesRole = new AzureNative.DataBoxEdge.V20201201.KubernetesRole("kubernetesRole", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20201201:KubernetesRole")]
    public partial class KubernetesRole : global::Pulumi.CustomResource
    {
        ...
        public KubernetesRole(string name, KubernetesRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:KubernetesRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:KubernetesRole", name, null, MakeResourceOptions(options, id))
        {
        }
