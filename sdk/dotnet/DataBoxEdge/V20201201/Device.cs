...
namespace Pulumi.AzureNative.DataBoxEdge.V20201201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20201201:Device is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20210201:Device to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20201201:Device")]
    public partial class Device : global::Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:Device", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeviceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20201201.DataBoxEdgeDeviceStatus>? DataBoxEdgeDeviceStatus { get; set; }
