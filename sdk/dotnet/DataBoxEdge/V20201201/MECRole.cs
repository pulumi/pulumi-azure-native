...
namespace Pulumi.AzureNative.DataBoxEdge.V20201201
{
    ...
    /// {
    ///     var mecRole = new AzureNative.DataBoxEdge.V20201201.MECRole("mecRole", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20201201:MECRole")]
    public partial class MECRole : global::Pulumi.CustomResource
    {
        ...
        public MECRole(string name, MECRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:MECRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MECRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:MECRole", name, null, MakeResourceOptions(options, id))
        {
        }
