...
namespace Pulumi.AzureNative.DataBoxEdge.V20201201
{
    public static class GetStorageAccount
    {
        ...
        public static Task<GetStorageAccountResult> InvokeAsync(GetStorageAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageAccountResult>("azure-native:databoxedge/v20201201:getStorageAccount", args ?? new GetStorageAccountArgs(), options.WithVersion());

        /// <summary>
        /// Represents a Storage Account on the  Data Box Edge/Gateway device.
        /// </summary>
        public static Output<GetStorageAccountResult> Invoke(GetStorageAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStorageAccountResult>("azure-native:databoxedge/v20201201:getStorageAccount", args ?? new GetStorageAccountInvokeArgs(), options.WithVersion());
    }
