...
namespace Pulumi.AzureNative.DataBoxEdge.V20201201
{
    ...
    /// {
    ///     var storageAccountCredential = new AzureNative.DataBoxEdge.V20201201.StorageAccountCredential("storageAccountCredential", new()
    ///     {
    ///         AccountKey = new AzureNative.DataBoxEdge.V20201201.Inputs.AsymmetricEncryptedSecretArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20201201:StorageAccountCredential")]
    public partial class StorageAccountCredential : global::Pulumi.CustomResource
    {
        ...
        public StorageAccountCredential(string name, StorageAccountCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:StorageAccountCredential", name, args ?? new StorageAccountCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccountCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:StorageAccountCredential", name, null, MakeResourceOptions(options, id))
        {
        }
