...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    ...
    /// Compute role.
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20210601:IoTRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.")]
    ...
    public partial class IoTRole : global::Pulumi.CustomResource
    {
        ...
        public IoTRole(string name, IoTRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:IoTRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:IoTRole", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IoTRoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601.PlatformType> HostPlatform { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601.RoleStatus> RoleStatus { get; set; } = null!;
