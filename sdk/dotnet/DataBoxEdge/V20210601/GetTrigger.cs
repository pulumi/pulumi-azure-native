...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    ...
    public static class GetTrigger
    {
        ...
        public static Task<GetTriggerResult> InvokeAsync(GetTriggerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTriggerResult>("azure-native:databoxedge/v20210601:getTrigger", args ?? new GetTriggerArgs(), options.WithVersion());

        /// <summary>
        /// Trigger details.
        /// </summary>
        public static Output<GetTriggerResult> Invoke(GetTriggerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTriggerResult>("azure-native:databoxedge/v20210601:getTrigger", args ?? new GetTriggerInvokeArgs(), options.WithVersion());
    }
