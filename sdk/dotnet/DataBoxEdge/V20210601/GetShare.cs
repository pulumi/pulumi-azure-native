...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    public static class GetShare
    {
        ...
        public static Task<GetShareResult> InvokeAsync(GetShareArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetShareResult>("azure-native:databoxedge/v20210601:getShare", args ?? new GetShareArgs(), options.WithVersion());

        /// <summary>
        /// Represents a share on the  Data Box Edge/Gateway device.
        /// </summary>
        public static Output<GetShareResult> Invoke(GetShareInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetShareResult>("azure-native:databoxedge/v20210601:getShare", args ?? new GetShareInvokeArgs(), options.WithVersion());
    }
