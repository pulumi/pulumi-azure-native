...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    ...
    /// {
    ///     var ioTAddon = new AzureNative.DataBoxEdge.V20210601.IoTAddon("ioTAddon", new()
    ///     {
    ///         AddonName = "arcName",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210601:IoTAddon")]
    public partial class IoTAddon : global::Pulumi.CustomResource
    {
        ...
        public IoTAddon(string name, IoTAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:IoTAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:IoTAddon", name, null, MakeResourceOptions(options, id))
        {
        }
