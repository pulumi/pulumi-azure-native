...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20210601:BandwidthSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:BandwidthSchedule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20210601:BandwidthSchedule")]
    public partial class BandwidthSchedule : global::Pulumi.CustomResource
    {
        ...
        public BandwidthSchedule(string name, BandwidthScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:BandwidthSchedule", name, args ?? new BandwidthScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:BandwidthSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BandwidthScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.DataBoxEdge.V20210601.DayOfWeek>>? _days;

        /// <summary>
        /// The days of the week when this schedule is applicable.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.DataBoxEdge.V20210601.DayOfWeek>> Days
        {
            get => _days ?? (_days = new InputList<Union<string, Pulumi.AzureNative.DataBoxEdge.V20210601.DayOfWeek>>());
            set => _days = value;
        }
