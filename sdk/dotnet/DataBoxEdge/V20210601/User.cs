...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20210601:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:User", name, null, MakeResourceOptions(options, id))
        {
        }
