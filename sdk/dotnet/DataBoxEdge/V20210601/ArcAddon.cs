...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    ...
    /// {
    ///     var arcAddon = new AzureNative.DataBoxEdge.V20210601.ArcAddon("arcAddon", new()
    ///     {
    ///         AddonName = "arcName",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databoxedge/v20210601:ArcAddon arcName /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourcegroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/addonExamples/roles/kubernetesRole/addons/arcName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210601:ArcAddon")]
    public partial class ArcAddon : global::Pulumi.CustomResource
    {
        ...
        public ArcAddon(string name, ArcAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:ArcAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ArcAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:ArcAddon", name, null, MakeResourceOptions(options, id))
        {
        }
