...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    ...
    /// MEC role.
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20210601:MECRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:MECRole to guarantee forwards compatibility.")]
    ...
    public partial class MECRole : global::Pulumi.CustomResource
    {
        ...
        public MECRole(string name, MECRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:MECRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MECRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:MECRole", name, null, MakeResourceOptions(options, id))
        {
        }
