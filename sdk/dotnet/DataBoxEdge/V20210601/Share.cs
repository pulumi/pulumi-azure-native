...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210601:Share")]
    public partial class Share : Pulumi.CustomResource
    {
        ...
        public Share(string name, ShareArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:Share", name, args ?? new ShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Share(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601:Share", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601:Share"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20201201:Share"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210201:Share"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201:Share"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210201preview:Share"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201preview:Share"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601preview:Share"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601preview:Share"},
                },
            };
    ...
    public sealed class ShareArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601.ShareAccessProtocol> AccessProtocol { get; set; } = null!;
        ...
        /// </summary>
        [Input("dataPolicy")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601.DataPolicy>? DataPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601.MonitoringStatus> MonitoringStatus { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601.ShareStatus> ShareStatus { get; set; } = null!;
