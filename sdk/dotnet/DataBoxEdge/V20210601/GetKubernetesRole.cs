...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601
{
    public static class GetKubernetesRole
    {
        ...
        public static Task<GetKubernetesRoleResult> InvokeAsync(GetKubernetesRoleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKubernetesRoleResult>("azure-native:databoxedge/v20210601:getKubernetesRole", args ?? new GetKubernetesRoleArgs(), options.WithVersion());

        /// <summary>
        /// Kubernetes role.
        /// </summary>
        public static Output<GetKubernetesRoleResult> Invoke(GetKubernetesRoleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKubernetesRoleResult>("azure-native:databoxedge/v20210601:getKubernetesRole", args ?? new GetKubernetesRoleInvokeArgs(), options.WithVersion());
    }
