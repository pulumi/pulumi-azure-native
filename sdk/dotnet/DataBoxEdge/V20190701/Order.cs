...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20190701
{
    ...
    /// The order details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:databoxedge/v20190701:Order")]
    public partial class Order : Pulumi.CustomResource
    {
        ...
        public Order(string name, OrderArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20190701:Order", name, args ?? new OrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Order(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20190701:Order", name, null, MakeResourceOptions(options, id))
        {
        }
