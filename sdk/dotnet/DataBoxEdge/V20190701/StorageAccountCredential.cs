...
namespace Pulumi.AzureNative.DataBoxEdge.V20190701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20190701:StorageAccountCredential")]
    public partial class StorageAccountCredential : Pulumi.CustomResource
    {
        ...
        public StorageAccountCredential(string name, StorageAccountCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190701:StorageAccountCredential", name, args ?? new StorageAccountCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccountCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190701:StorageAccountCredential", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountCredentialArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20190701.AccountType> AccountType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20190701.SSLStatus> SslStatus { get; set; } = null!;
