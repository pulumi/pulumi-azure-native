...
namespace Pulumi.AzureRM.DataBoxEdge.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var storageAccountCredential = new AzureRM.DataBoxEdge.V20190701.StorageAccountCredential("storageAccountCredential", new AzureRM.DataBoxEdge.V20190701.StorageAccountCredentialArgs
    ///         {
    ///             AccountKey = new AzureRM.DataBoxEdge.V20190701.Inputs.AsymmetricEncryptedSecretArgs
    ///             {
    ...
    public partial class StorageAccountCredential : Pulumi.CustomResource
    {
        ...
        public StorageAccountCredential(string name, StorageAccountCredentialArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190701:StorageAccountCredential", name, args ?? new StorageAccountCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccountCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190701:StorageAccountCredential", name, null, MakeResourceOptions(options, id))
        {
        }
