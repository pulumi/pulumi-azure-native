...
namespace Pulumi.AzureRM.DataBoxEdge.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var role = new AzureRM.DataBoxEdge.V20190701.Role("role", new AzureRM.DataBoxEdge.V20190701.RoleArgs
    ///         {
    ...
    public partial class Role : Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190701:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190701:Role", name, null, MakeResourceOptions(options, id))
        {
        }
