...
namespace Pulumi.AzureRM.DataBoxEdge.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var bandwidthSchedule = new AzureRM.DataBoxEdge.V20190701.BandwidthSchedule("bandwidthSchedule", new AzureRM.DataBoxEdge.V20190701.BandwidthScheduleArgs
    ///         {
    ///             Days = 
    ///             {
    ///                 "Sunday",
    ...
    public partial class BandwidthSchedule : Pulumi.CustomResource
    {
        ...
        public BandwidthSchedule(string name, BandwidthScheduleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190701:BandwidthSchedule", name, args ?? new BandwidthScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190701:BandwidthSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
