...
namespace Pulumi.AzureNative.DataBoxEdge.V20190701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20190701:BandwidthSchedule")]
    public partial class BandwidthSchedule : Pulumi.CustomResource
    {
        ...
        public BandwidthSchedule(string name, BandwidthScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190701:BandwidthSchedule", name, args ?? new BandwidthScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190701:BandwidthSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
