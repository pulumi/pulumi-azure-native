...
namespace Pulumi.AzureRM.DataBoxEdge.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var user = new AzureRM.DataBoxEdge.V20190701.User("user", new AzureRM.DataBoxEdge.V20190701.UserArgs
    ///         {
    ///             DeviceName = "testedgedevice",
    ///             EncryptedPassword = new AzureRM.DataBoxEdge.V20190701.Inputs.AsymmetricEncryptedSecretArgs
    ///             {
    ...
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190701:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190701:User", name, null, MakeResourceOptions(options, id))
        {
        }
