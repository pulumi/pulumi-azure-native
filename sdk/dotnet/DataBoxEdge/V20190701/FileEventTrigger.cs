...
namespace Pulumi.AzureNative.DataBoxEdge.V20190701
{
    ...
    /// {
    ///     var fileEventTrigger = new AzureNative.DataBoxEdge.V20190701.FileEventTrigger("fileEventTrigger", new()
    ///     {
    ...
    ///         SinkInfo = new AzureNative.DataBoxEdge.V20190701.Inputs.RoleSinkInfoArgs
    ///         {
    ...
    ///         },
    ///         SourceInfo = new AzureNative.DataBoxEdge.V20190701.Inputs.FileSourceInfoArgs
    ///         {
    ...
    public partial class FileEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public FileEventTrigger(string name, FileEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190701:FileEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FileEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190701:FileEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
