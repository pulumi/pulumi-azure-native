...
namespace Pulumi.AzureRM.DataBoxEdge
{
    public static class GetStorageAccount
    {
        public static Task<GetStorageAccountResult> InvokeAsync(GetStorageAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageAccountResult>("azurerm:databoxedge:getStorageAccount", args ?? new GetStorageAccountArgs(), options.WithVersion());
    }
