...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    public static class GetKubernetesRole
    {
        ...
        public static Task<GetKubernetesRoleResult> InvokeAsync(GetKubernetesRoleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKubernetesRoleResult>("azure-native:databoxedge/v20220301:getKubernetesRole", args ?? new GetKubernetesRoleArgs(), options.WithDefaults());
        ...
        public static Output<GetKubernetesRoleResult> Invoke(GetKubernetesRoleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKubernetesRoleResult>("azure-native:databoxedge/v20220301:getKubernetesRole", args ?? new GetKubernetesRoleInvokeArgs(), options.WithDefaults());
    }
