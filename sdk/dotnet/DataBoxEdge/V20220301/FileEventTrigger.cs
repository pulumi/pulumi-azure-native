...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    ...
    /// {
    ///     var fileEventTrigger = new AzureNative.DataBoxEdge.V20220301.FileEventTrigger("fileEventTrigger", new()
    ///     {
    ...
    ///         SinkInfo = new AzureNative.DataBoxEdge.V20220301.Inputs.RoleSinkInfoArgs
    ///         {
    ...
    ///         },
    ///         SourceInfo = new AzureNative.DataBoxEdge.V20220301.Inputs.FileSourceInfoArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20220301:FileEventTrigger")]
    public partial class FileEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public FileEventTrigger(string name, FileEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:FileEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FileEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:FileEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
