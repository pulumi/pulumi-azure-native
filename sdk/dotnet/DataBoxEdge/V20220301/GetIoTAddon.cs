...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    public static class GetIoTAddon
    {
        ...
        public static Task<GetIoTAddonResult> InvokeAsync(GetIoTAddonArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIoTAddonResult>("azure-native:databoxedge/v20220301:getIoTAddon", args ?? new GetIoTAddonArgs(), options.WithDefaults());

        /// <summary>
        /// IoT Addon.
        /// </summary>
        public static Output<GetIoTAddonResult> Invoke(GetIoTAddonInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIoTAddonResult>("azure-native:databoxedge/v20220301:getIoTAddon", args ?? new GetIoTAddonInvokeArgs(), options.WithDefaults());
    }
