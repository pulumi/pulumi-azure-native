...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    ...
    /// {
    ///     var cloudEdgeManagementRole = new AzureNative.DataBoxEdge.V20220301.CloudEdgeManagementRole("cloudEdgeManagementRole", new()
    ///     {
    ...
    public partial class CloudEdgeManagementRole : global::Pulumi.CustomResource
    {
        ...
        public CloudEdgeManagementRole(string name, CloudEdgeManagementRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:CloudEdgeManagementRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CloudEdgeManagementRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:CloudEdgeManagementRole", name, null, MakeResourceOptions(options, id))
        {
        }
