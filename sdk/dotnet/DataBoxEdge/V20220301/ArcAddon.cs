...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    ...
    /// {
    ///     var arcAddon = new AzureNative.DataBoxEdge.V20220301.ArcAddon("arcAddon", new()
    ///     {
    ///         AddonName = "arcName",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20220301:ArcAddon")]
    public partial class ArcAddon : global::Pulumi.CustomResource
    {
        ...
        public ArcAddon(string name, ArcAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:ArcAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ArcAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:ArcAddon", name, null, MakeResourceOptions(options, id))
        {
        }
