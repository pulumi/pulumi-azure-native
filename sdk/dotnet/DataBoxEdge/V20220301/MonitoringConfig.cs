...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20220301:MonitoringConfig")]
    public partial class MonitoringConfig : Pulumi.CustomResource
    {
        ...
        public MonitoringConfig(string name, MonitoringConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:MonitoringConfig", name, args ?? new MonitoringConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:MonitoringConfig", name, null, MakeResourceOptions(options, id))
        {
        }
