...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20220301:Trigger")]
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TriggerArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20220301.TriggerEventType> Kind { get; set; } = null!;
