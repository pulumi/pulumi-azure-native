...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    ...
    /// {
    ///     var periodicTimerEventTrigger = new AzureNative.DataBoxEdge.V20220301.PeriodicTimerEventTrigger("periodicTimerEventTrigger", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databoxedge/v20220301:PeriodicTimerEventTrigger trigger1 /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/testedgedevice/triggers/trigger1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20220301:PeriodicTimerEventTrigger")]
    public partial class PeriodicTimerEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public PeriodicTimerEventTrigger(string name, PeriodicTimerEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:PeriodicTimerEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private PeriodicTimerEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:PeriodicTimerEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
