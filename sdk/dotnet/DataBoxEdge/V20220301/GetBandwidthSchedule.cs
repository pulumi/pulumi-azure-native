...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    public static class GetBandwidthSchedule
    {
        ...
        public static Task<GetBandwidthScheduleResult> InvokeAsync(GetBandwidthScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBandwidthScheduleResult>("azure-native:databoxedge/v20220301:getBandwidthSchedule", args ?? new GetBandwidthScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// The bandwidth schedule details.
        /// </summary>
        public static Output<GetBandwidthScheduleResult> Invoke(GetBandwidthScheduleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBandwidthScheduleResult>("azure-native:databoxedge/v20220301:getBandwidthSchedule", args ?? new GetBandwidthScheduleInvokeArgs(), options.WithDefaults());
    }
