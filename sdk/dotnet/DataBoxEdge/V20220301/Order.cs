...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    ...
    /// The order details.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20220301:Order")]
    public partial class Order : Pulumi.CustomResource
    {
        ...
        public Order(string name, OrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:Order", name, args ?? new OrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Order(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:Order", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrderArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("shipmentType")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20220301.ShipmentType>? ShipmentType { get; set; }
