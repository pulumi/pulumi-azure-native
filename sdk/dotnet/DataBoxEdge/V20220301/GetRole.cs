...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    ...
    public static class GetRole
    {
        ...
        public static Task<GetRoleResult> InvokeAsync(GetRoleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRoleResult>("azure-native:databoxedge/v20220301:getRole", args ?? new GetRoleArgs(), options.WithDefaults());

        /// <summary>
        /// Compute role.
        /// </summary>
        public static Output<GetRoleResult> Invoke(GetRoleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRoleResult>("azure-native:databoxedge/v20220301:getRole", args ?? new GetRoleInvokeArgs(), options.WithDefaults());
    }
