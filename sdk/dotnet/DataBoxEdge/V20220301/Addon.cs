...
namespace Pulumi.AzureNative.DataBoxEdge.V20220301
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20220301:Addon")]
    public partial class Addon : global::Pulumi.CustomResource
    {
        ...
        public Addon(string name, AddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:Addon", name, args ?? new AddonArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Addon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20220301:Addon", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:databoxedge/v20210601:Addon"},
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:databoxedge/v20221201preview:Addon"},
                    new global::Pulumi.Alias { Type = "azure-native:databoxedge/v20230101preview:Addon"},
                },
            };
    ...
    public sealed class AddonArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20220301.AddonType> Kind { get; set; } = null!;
