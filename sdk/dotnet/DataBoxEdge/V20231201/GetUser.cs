...
namespace Pulumi.AzureNative.DataBoxEdge.V20231201
{
    public static class GetUser
    {
        ...
        public static Task<GetUserResult> InvokeAsync(GetUserArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserResult>("azure-native:databoxedge/v20231201:getUser", args ?? new GetUserArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified user.
        /// </summary>
        public static Output<GetUserResult> Invoke(GetUserInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserResult>("azure-native:databoxedge/v20231201:getUser", args ?? new GetUserInvokeArgs(), options.WithDefaults());
    }
