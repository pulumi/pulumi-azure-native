...
namespace Pulumi.AzureNative.DataBoxEdge.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20231201:StorageAccount")]
    public partial class StorageAccount : global::Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20231201.DataPolicy> DataPolicy { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20231201.StorageAccountStatus>? StorageAccountStatus { get; set; }
