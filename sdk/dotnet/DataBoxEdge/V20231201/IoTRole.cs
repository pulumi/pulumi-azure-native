...
namespace Pulumi.AzureNative.DataBoxEdge.V20231201
{
    ...
    /// Compute role.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20231201:IoTRole")]
    public partial class IoTRole : global::Pulumi.CustomResource
    {
        ...
        public IoTRole(string name, IoTRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:IoTRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:IoTRole", name, null, MakeResourceOptions(options, id))
        {
        }
