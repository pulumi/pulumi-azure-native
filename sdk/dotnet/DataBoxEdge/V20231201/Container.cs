...
namespace Pulumi.AzureNative.DataBoxEdge.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20231201:Container")]
    public partial class Container : global::Pulumi.CustomResource
    {
        ...
        public Container(string name, ContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:Container", name, args ?? new ContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Container(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:Container", name, null, MakeResourceOptions(options, id))
        {
        }
