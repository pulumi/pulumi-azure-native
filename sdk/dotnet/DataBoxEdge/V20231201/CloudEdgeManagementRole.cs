...
namespace Pulumi.AzureNative.DataBoxEdge.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20231201:CloudEdgeManagementRole")]
    public partial class CloudEdgeManagementRole : global::Pulumi.CustomResource
    {
        ...
        public CloudEdgeManagementRole(string name, CloudEdgeManagementRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:CloudEdgeManagementRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CloudEdgeManagementRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:CloudEdgeManagementRole", name, null, MakeResourceOptions(options, id))
        {
        }
