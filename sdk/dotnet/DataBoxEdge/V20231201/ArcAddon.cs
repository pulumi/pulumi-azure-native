...
namespace Pulumi.AzureNative.DataBoxEdge.V20231201
{
    ...
    /// Arc Addon.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20231201:ArcAddon")]
    public partial class ArcAddon : global::Pulumi.CustomResource
    {
        ...
        public ArcAddon(string name, ArcAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:ArcAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ArcAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:ArcAddon", name, null, MakeResourceOptions(options, id))
        {
        }
