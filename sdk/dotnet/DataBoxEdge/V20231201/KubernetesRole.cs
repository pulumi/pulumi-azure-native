...
namespace Pulumi.AzureNative.DataBoxEdge.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20231201:KubernetesRole")]
    public partial class KubernetesRole : global::Pulumi.CustomResource
    {
        ...
        public KubernetesRole(string name, KubernetesRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:KubernetesRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:KubernetesRole", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class KubernetesRoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20231201.PlatformType> HostPlatform { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20231201.RoleStatus> RoleStatus { get; set; } = null!;
