...
namespace Pulumi.AzureNative.DataBoxEdge.V20231201
{
    ...
    /// The order details.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20231201:Order")]
    public partial class Order : global::Pulumi.CustomResource
    {
        ...
        public Order(string name, OrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:Order", name, args ?? new OrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Order(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20231201:Order", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrderArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("shipmentType")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20231201.ShipmentType>? ShipmentType { get; set; }
