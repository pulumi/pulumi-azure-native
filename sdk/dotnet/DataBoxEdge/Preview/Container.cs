...
namespace Pulumi.AzureRM.DataBoxEdge.Preview
{
    ...
    public partial class Container : Pulumi.CustomResource
    {
        ...
        public Container(string name, ContainerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/preview:Container", name, args ?? new ContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Container(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/preview:Container", name, null, MakeResourceOptions(options, id))
        {
        }
