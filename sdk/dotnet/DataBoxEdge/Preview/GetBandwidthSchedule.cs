...
namespace Pulumi.AzureRM.DataBoxEdge.Preview
{
    public static class GetBandwidthSchedule
    {
        public static Task<GetBandwidthScheduleResult> InvokeAsync(GetBandwidthScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBandwidthScheduleResult>("azurerm:databoxedge/preview:getBandwidthSchedule", args ?? new GetBandwidthScheduleArgs(), options.WithVersion());
    }
