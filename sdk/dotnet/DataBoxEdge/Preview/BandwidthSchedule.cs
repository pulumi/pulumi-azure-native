...
namespace Pulumi.AzureRM.DataBoxEdge.Preview
{
    ...
    public partial class BandwidthSchedule : Pulumi.CustomResource
    {
        ...
        public BandwidthSchedule(string name, BandwidthScheduleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/preview:BandwidthSchedule", name, args ?? new BandwidthScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/preview:BandwidthSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
