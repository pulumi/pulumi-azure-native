...
namespace Pulumi.AzureRM.DataBoxEdge.Preview
{
    ...
    public partial class Role : Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/preview:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/preview:Role", name, null, MakeResourceOptions(options, id))
        {
        }
