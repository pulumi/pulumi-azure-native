...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview
{
    ...
    public partial class Share : Pulumi.CustomResource
    {
        ...
        public Share(string name, ShareArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200501preview:Share", name, args ?? new ShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Share(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200501preview:Share", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ShareArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview.ShareAccessProtocol> AccessProtocol { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview.MonitoringStatus> MonitoringStatus { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview.ShareStatus> ShareStatus { get; set; } = null!;
