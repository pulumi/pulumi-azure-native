...
namespace Pulumi.AzureNative.DataBoxEdge.V20200501Preview
{
    ...
    /// {
    ///     var fileEventTrigger = new AzureNative.DataBoxEdge.V20200501Preview.FileEventTrigger("fileEventTrigger", new()
    ///     {
    ...
    ///         SinkInfo = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.RoleSinkInfoArgs
    ///         {
    ...
    ///         },
    ///         SourceInfo = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.FileSourceInfoArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databoxedge/v20200501preview:FileEventTrigger trigger1 /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/testedgedevice/triggers/trigger1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20200501preview:FileEventTrigger")]
    public partial class FileEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public FileEventTrigger(string name, FileEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:FileEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FileEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:FileEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
