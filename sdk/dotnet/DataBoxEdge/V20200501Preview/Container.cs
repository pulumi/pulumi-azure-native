...
namespace Pulumi.AzureNative.DataBoxEdge.V20200501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20200501preview:Container")]
    public partial class Container : Pulumi.CustomResource
    {
        ...
        public Container(string name, ContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:Container", name, args ?? new ContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Container(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:Container", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20201201:Container"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210201:Container"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201:Container"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210201preview:Container"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201preview:Container"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601:Container"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601:Container"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601preview:Container"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601preview:Container"},
                },
            };
