...
namespace Pulumi.AzureNative.DataBoxEdge.V20200501Preview
{
    ...
    /// {
    ///     var order = new AzureNative.DataBoxEdge.V20200501Preview.Order("order", new()
    ///     {
    ///         ContactInformation = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.ContactDetailsArgs
    ///         {
    ...
    ///         ShippingAddress = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.AddressArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databoxedge/v20200501preview:Order default /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/testedgedevice/orders/default 
    /// ```
    /// </summary>
    [Obsolete(@"Version 2020-05-01-preview will be removed in v2 of the provider.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20200501preview:Order")]
    public partial class Order : global::Pulumi.CustomResource
    {
        ...
        public Order(string name, OrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:Order", name, args ?? new OrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Order(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:Order", name, null, MakeResourceOptions(options, id))
        {
        }
