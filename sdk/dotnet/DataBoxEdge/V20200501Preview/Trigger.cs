...
namespace Pulumi.AzureRM.DataBoxEdge.V20200501Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var trigger = new AzureRM.DataBoxEdge.V20200501Preview.Trigger("trigger", new AzureRM.DataBoxEdge.V20200501Preview.TriggerArgs
    ///         {
    ...
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20200501preview:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20200501preview:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
