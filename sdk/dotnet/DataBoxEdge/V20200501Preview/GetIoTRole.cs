...
namespace Pulumi.AzureNative.DataBoxEdge.V20200501Preview
{
    public static class GetIoTRole
    {
        ...
        public static Task<GetIoTRoleResult> InvokeAsync(GetIoTRoleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIoTRoleResult>("azure-native:databoxedge/v20200501preview:getIoTRole", args ?? new GetIoTRoleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a specific role by name.
        /// </summary>
        public static Output<GetIoTRoleResult> Invoke(GetIoTRoleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIoTRoleResult>("azure-native:databoxedge/v20200501preview:getIoTRole", args ?? new GetIoTRoleInvokeArgs(), options.WithDefaults());
    }
