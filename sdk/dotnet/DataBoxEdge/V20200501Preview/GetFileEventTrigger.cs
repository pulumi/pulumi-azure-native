...
namespace Pulumi.AzureNative.DataBoxEdge.V20200501Preview
{
    public static class GetFileEventTrigger
    {
        ...
        public static Task<GetFileEventTriggerResult> InvokeAsync(GetFileEventTriggerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFileEventTriggerResult>("azure-native:databoxedge/v20200501preview:getFileEventTrigger", args ?? new GetFileEventTriggerArgs(), options.WithDefaults());

        /// <summary>
        /// Trigger details.
        /// </summary>
        public static Output<GetFileEventTriggerResult> Invoke(GetFileEventTriggerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFileEventTriggerResult>("azure-native:databoxedge/v20200501preview:getFileEventTrigger", args ?? new GetFileEventTriggerInvokeArgs(), options.WithDefaults());
    }
