...
namespace Pulumi.AzureNative.DataBoxEdge.V20200501Preview
{
    ...
    /// {
    ///     var ioTRole = new AzureNative.DataBoxEdge.V20200501Preview.IoTRole("ioTRole", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         HostPlatform = "Linux",
    ///         IoTDeviceDetails = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.IoTDeviceInfoArgs
    ///         {
    ///             Authentication = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.AuthenticationArgs
    ///             {
    ///                 SymmetricKey = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.SymmetricKeyArgs
    ///                 {
    ///                     ConnectionString = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.AsymmetricEncryptedSecretArgs
    ///                     {
    ...
    ///         },
    ///         IoTEdgeDeviceDetails = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.IoTDeviceInfoArgs
    ///         {
    ///             Authentication = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.AuthenticationArgs
    ///             {
    ///                 SymmetricKey = new AzureNative.DataBoxEdge.V20200501Preview.Inputs.SymmetricKeyArgs
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20200501preview:IoTRole")]
    public partial class IoTRole : global::Pulumi.CustomResource
    {
        ...
        public IoTRole(string name, IoTRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:IoTRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:IoTRole", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IoTRoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200501Preview.PlatformType> HostPlatform { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200501Preview.RoleStatus> RoleStatus { get; set; } = null!;
