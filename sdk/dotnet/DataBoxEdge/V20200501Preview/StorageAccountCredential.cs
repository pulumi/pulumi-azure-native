...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:databoxedge/v20200501preview:StorageAccountCredential")]
    ...
    public sealed class StorageAccountCredentialArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview.AccountType> AccountType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview.SSLStatus> SslStatus { get; set; } = null!;
