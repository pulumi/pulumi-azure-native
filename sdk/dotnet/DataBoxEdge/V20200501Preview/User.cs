...
namespace Pulumi.AzureRM.DataBoxEdge.V20200501Preview
{
    ...
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20200501preview:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20200501preview:User", name, null, MakeResourceOptions(options, id))
        {
        }
