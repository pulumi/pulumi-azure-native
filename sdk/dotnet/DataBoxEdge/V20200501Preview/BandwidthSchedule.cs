...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview
{
    ...
    public sealed class BandwidthScheduleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview.DayOfWeek>>? _days;

        /// <summary>
        /// The days of the week when this schedule is applicable.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview.DayOfWeek>> Days
        {
            get => _days ?? (_days = new InputList<Union<string, Pulumi.AzureNextGen.DataBoxEdge.V20200501Preview.DayOfWeek>>());
            set => _days = value;
        }
