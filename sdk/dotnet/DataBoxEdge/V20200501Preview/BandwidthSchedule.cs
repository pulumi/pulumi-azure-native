...
namespace Pulumi.AzureNative.DataBoxEdge.V20200501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20200501preview:BandwidthSchedule")]
    public partial class BandwidthSchedule : Pulumi.CustomResource
    {
        ...
        public BandwidthSchedule(string name, BandwidthScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:BandwidthSchedule", name, args ?? new BandwidthScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200501preview:BandwidthSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
