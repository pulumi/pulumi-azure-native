...
namespace Pulumi.AzureRM.DataBoxEdge
{
    ...
    /// </summary>
    public partial class DataBoxEdgeDevice : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DataBoxEdgeDevice(string name, DataBoxEdgeDeviceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge:DataBoxEdgeDevice", name, args ?? new DataBoxEdgeDeviceArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class DataBoxEdgeDeviceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The etag for the devices.
        /// </summary>
