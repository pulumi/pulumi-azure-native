...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20210201:Container is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20210201:Container")]
    public partial class Container : global::Pulumi.CustomResource
    {
        ...
        public Container(string name, ContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:Container", name, args ?? new ContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Container(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:Container", name, null, MakeResourceOptions(options, id))
        {
        }
