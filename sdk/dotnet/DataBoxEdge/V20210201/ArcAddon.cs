...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    /// Arc Addon.
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20210201:ArcAddon is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:ArcAddon to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20210201:ArcAddon")]
    public partial class ArcAddon : global::Pulumi.CustomResource
    {
        ...
        public ArcAddon(string name, ArcAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:ArcAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ArcAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:ArcAddon", name, null, MakeResourceOptions(options, id))
        {
        }
