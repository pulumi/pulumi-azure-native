...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    /// {
    ///     var kubernetesRole = new AzureNative.DataBoxEdge.V20210201.KubernetesRole("kubernetesRole", new()
    ///     {
    ...
    public partial class KubernetesRole : global::Pulumi.CustomResource
    {
        ...
        public KubernetesRole(string name, KubernetesRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:KubernetesRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:KubernetesRole", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class KubernetesRoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201.PlatformType> HostPlatform { get; set; } = null!;
