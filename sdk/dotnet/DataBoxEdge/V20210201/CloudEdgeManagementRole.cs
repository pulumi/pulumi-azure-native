...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    /// {
    ///     var cloudEdgeManagementRole = new AzureNative.DataBoxEdge.V20210201.CloudEdgeManagementRole("cloudEdgeManagementRole", new()
    ///     {
    ...
    public partial class CloudEdgeManagementRole : global::Pulumi.CustomResource
    {
        ...
        public CloudEdgeManagementRole(string name, CloudEdgeManagementRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:CloudEdgeManagementRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CloudEdgeManagementRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:CloudEdgeManagementRole", name, null, MakeResourceOptions(options, id))
        {
        }
