...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    /// {
    ///     var periodicTimerEventTrigger = new AzureNative.DataBoxEdge.V20210201.PeriodicTimerEventTrigger("periodicTimerEventTrigger", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210201:PeriodicTimerEventTrigger")]
    public partial class PeriodicTimerEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public PeriodicTimerEventTrigger(string name, PeriodicTimerEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:PeriodicTimerEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private PeriodicTimerEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:PeriodicTimerEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
