...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    public static class GetIoTRole
    {
        ...
        public static Task<GetIoTRoleResult> InvokeAsync(GetIoTRoleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIoTRoleResult>("azure-native:databoxedge/v20210201:getIoTRole", args ?? new GetIoTRoleArgs(), options.WithDefaults());

        /// <summary>
        /// Compute role.
        /// </summary>
        public static Output<GetIoTRoleResult> Invoke(GetIoTRoleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIoTRoleResult>("azure-native:databoxedge/v20210201:getIoTRole", args ?? new GetIoTRoleInvokeArgs(), options.WithDefaults());
    }
