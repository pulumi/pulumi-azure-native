...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20210201:Trigger")]
    public partial class Trigger : global::Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TriggerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201.TriggerEventType> Kind { get; set; } = null!;
