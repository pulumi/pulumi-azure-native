...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    public static class GetDevice
    {
        ...
        public static Task<GetDeviceResult> InvokeAsync(GetDeviceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeviceResult>("azure-native:databoxedge/v20210201:getDevice", args ?? new GetDeviceArgs(), options.WithDefaults());

        /// <summary>
        /// The Data Box Edge/Gateway device.
        /// </summary>
        public static Output<GetDeviceResult> Invoke(GetDeviceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDeviceResult>("azure-native:databoxedge/v20210201:getDevice", args ?? new GetDeviceInvokeArgs(), options.WithDefaults());
    }
