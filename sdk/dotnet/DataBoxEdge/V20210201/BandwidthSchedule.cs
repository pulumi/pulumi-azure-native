...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210201:BandwidthSchedule")]
    public partial class BandwidthSchedule : global::Pulumi.CustomResource
    {
        ...
        public BandwidthSchedule(string name, BandwidthScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:BandwidthSchedule", name, args ?? new BandwidthScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:BandwidthSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
