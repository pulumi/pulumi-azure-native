...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    public static class GetMonitoringConfig
    {
        ...
        public static Output<GetMonitoringConfigResult> Invoke(GetMonitoringConfigInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMonitoringConfigResult>("azure-native:databoxedge/v20210201:getMonitoringConfig", args ?? new GetMonitoringConfigInvokeArgs(), options.WithVersion());
    }
