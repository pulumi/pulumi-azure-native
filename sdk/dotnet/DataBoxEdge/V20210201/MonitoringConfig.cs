...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20210201:MonitoringConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20210201:MonitoringConfig")]
    public partial class MonitoringConfig : global::Pulumi.CustomResource
    {
        ...
        public MonitoringConfig(string name, MonitoringConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:MonitoringConfig", name, args ?? new MonitoringConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:MonitoringConfig", name, null, MakeResourceOptions(options, id))
        {
        }
