...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210201:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:User", name, null, MakeResourceOptions(options, id))
        {
        }
