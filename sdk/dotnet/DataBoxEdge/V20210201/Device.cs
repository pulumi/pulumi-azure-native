...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    /// {
    ///     var device = new AzureNative.DataBoxEdge.V20210201.Device("device", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         Location = "WUS",
    ///         ResourceGroupName = "GroupForEdgeAutomation",
    ///         Sku = new AzureNative.DataBoxEdge.V20210201.Inputs.SkuArgs
    ///         {
    ///             Name = "Edge",
    ///             Tier = "Standard",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20210201:Device")]
    public partial class Device : global::Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201:Device", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeviceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201.DataBoxEdgeDeviceStatus>? DataBoxEdgeDeviceStatus { get; set; }
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201.DataBoxEdgeDeviceKind>? Kind { get; set; }
