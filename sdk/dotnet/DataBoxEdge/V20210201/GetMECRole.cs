...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201
{
    ...
    public static class GetMECRole
    {
        ...
        public static Task<GetMECRoleResult> InvokeAsync(GetMECRoleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMECRoleResult>("azure-native:databoxedge/v20210201:getMECRole", args ?? new GetMECRoleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a specific role by name.
        /// </summary>
        public static Output<GetMECRoleResult> Invoke(GetMECRoleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMECRoleResult>("azure-native:databoxedge/v20210201:getMECRole", args ?? new GetMECRoleInvokeArgs(), options.WithDefaults());
    }
