...
namespace Pulumi.AzureRM.DataBoxEdge.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var role = new AzureRM.DataBoxEdge.V20190301.Role("role", new AzureRM.DataBoxEdge.V20190301.RoleArgs
    ///         {
    ...
    public partial class Role : Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190301:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190301:Role", name, null, MakeResourceOptions(options, id))
        {
        }
