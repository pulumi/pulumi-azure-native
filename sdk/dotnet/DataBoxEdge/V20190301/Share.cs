...
namespace Pulumi.AzureRM.DataBoxEdge.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var share = new AzureRM.DataBoxEdge.V20190301.Share("share", new AzureRM.DataBoxEdge.V20190301.ShareArgs
    ///         {
    ///             AccessProtocol = "SMB",
    ///             AzureContainerInfo = new AzureRM.DataBoxEdge.V20190301.Inputs.AzureContainerInfoArgs
    ///             {
    ...
    ///             UserAccessRights = 
    ///             {
    ///                 new AzureRM.DataBoxEdge.V20190301.Inputs.UserAccessRightArgs
    ///                 {
    ///                     AccessType = "Change",
