...
namespace Pulumi.AzureRM.DataBoxEdge.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var trigger = new AzureRM.DataBoxEdge.V20190301.Trigger("trigger", new AzureRM.DataBoxEdge.V20190301.TriggerArgs
    ///         {
    ...
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190301:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190301:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
