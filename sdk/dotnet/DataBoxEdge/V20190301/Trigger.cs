...
namespace Pulumi.AzureNative.DataBoxEdge.V20190301
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20190301:Trigger")]
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190301:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190301:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201:Trigger"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210201preview:Trigger"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201preview:Trigger"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601:Trigger"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601:Trigger"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601preview:Trigger"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601preview:Trigger"},
                },
            };
    ...
    public sealed class TriggerArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20190301.TriggerEventType> Kind { get; set; } = null!;
