...
namespace Pulumi.AzureNative.DataBoxEdge.V20190301
{
    ...
    public partial class FileEventTrigger : Pulumi.CustomResource
    {
        ...
        public FileEventTrigger(string name, FileEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190301:FileEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FileEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190301:FileEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
