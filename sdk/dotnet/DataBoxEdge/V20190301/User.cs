...
namespace Pulumi.AzureNative.DataBoxEdge.V20190301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20190301:User")]
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190301:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190301:User", name, null, MakeResourceOptions(options, id))
        {
        }
