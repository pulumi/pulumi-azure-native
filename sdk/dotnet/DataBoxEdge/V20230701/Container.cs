...
namespace Pulumi.AzureNative.DataBoxEdge.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230701:Container")]
    public partial class Container : global::Pulumi.CustomResource
    {
        ...
        public Container(string name, ContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:Container", name, args ?? new ContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Container(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:Container", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20230701.AzureContainerDataFormat> DataFormat { get; set; } = null!;
