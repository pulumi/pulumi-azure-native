...
namespace Pulumi.AzureNative.DataBoxEdge.V20230701
{
    ...
    /// MEC role.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230701:MECRole")]
    public partial class MECRole : global::Pulumi.CustomResource
    {
        ...
        public MECRole(string name, MECRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:MECRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MECRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:MECRole", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MECRoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20230701.RoleStatus> RoleStatus { get; set; } = null!;
