...
namespace Pulumi.AzureNative.DataBoxEdge.V20230701
{
    ...
    /// Trigger details.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230701:PeriodicTimerEventTrigger")]
    public partial class PeriodicTimerEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public PeriodicTimerEventTrigger(string name, PeriodicTimerEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:PeriodicTimerEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private PeriodicTimerEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:PeriodicTimerEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
