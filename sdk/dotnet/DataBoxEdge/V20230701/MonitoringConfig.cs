...
namespace Pulumi.AzureNative.DataBoxEdge.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230701:MonitoringConfig")]
    public partial class MonitoringConfig : global::Pulumi.CustomResource
    {
        ...
        public MonitoringConfig(string name, MonitoringConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:MonitoringConfig", name, args ?? new MonitoringConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:MonitoringConfig", name, null, MakeResourceOptions(options, id))
        {
        }
