...
namespace Pulumi.AzureNative.DataBoxEdge.V20230701
{
    ...
    /// Trigger details.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230701:FileEventTrigger")]
    public partial class FileEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public FileEventTrigger(string name, FileEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:FileEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FileEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:FileEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
