...
namespace Pulumi.AzureNative.DataBoxEdge.V20230701
{
    ...
    /// Arc Addon.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230701:ArcAddon")]
    public partial class ArcAddon : global::Pulumi.CustomResource
    {
        ...
        public ArcAddon(string name, ArcAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:ArcAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ArcAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:ArcAddon", name, null, MakeResourceOptions(options, id))
        {
        }
