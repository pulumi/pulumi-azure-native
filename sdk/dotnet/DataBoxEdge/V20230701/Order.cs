...
namespace Pulumi.AzureNative.DataBoxEdge.V20230701
{
    ...
    /// The order details.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230701:Order")]
    public partial class Order : global::Pulumi.CustomResource
    {
        ...
        public Order(string name, OrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:Order", name, args ?? new OrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Order(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230701:Order", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrderArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("shipmentType")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20230701.ShipmentType>? ShipmentType { get; set; }
