...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901
{
    ...
    /// {
    ///     var kubernetesRole = new AzureNative.DataBoxEdge.V20200901.KubernetesRole("kubernetesRole", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20200901:KubernetesRole")]
    public partial class KubernetesRole : global::Pulumi.CustomResource
    {
        ...
        public KubernetesRole(string name, KubernetesRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:KubernetesRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:KubernetesRole", name, null, MakeResourceOptions(options, id))
        {
        }
