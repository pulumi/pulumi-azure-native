...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901
{
    ...
    /// {
    ///     var arcAddon = new AzureNative.DataBoxEdge.V20200901.ArcAddon("arcAddon", new()
    ///     {
    ///         AddonName = "arcName",
    ...
    public partial class ArcAddon : global::Pulumi.CustomResource
    {
        ...
        public ArcAddon(string name, ArcAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:ArcAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ArcAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:ArcAddon", name, null, MakeResourceOptions(options, id))
        {
        }
