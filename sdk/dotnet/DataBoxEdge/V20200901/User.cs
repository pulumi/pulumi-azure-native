...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:databoxedge/v20200901:User")]
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901:User", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("userType")]
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20200901.UserType>? UserType { get; set; }
