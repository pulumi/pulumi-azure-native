...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20200901:CloudEdgeManagementRole")]
    public partial class CloudEdgeManagementRole : global::Pulumi.CustomResource
    {
        ...
        public CloudEdgeManagementRole(string name, CloudEdgeManagementRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:CloudEdgeManagementRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CloudEdgeManagementRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:CloudEdgeManagementRole", name, null, MakeResourceOptions(options, id))
        {
        }
