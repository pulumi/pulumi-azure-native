...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901
{
    public static class GetArcAddon
    {
        ...
        public static Task<GetArcAddonResult> InvokeAsync(GetArcAddonArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetArcAddonResult>("azure-native:databoxedge/v20200901:getArcAddon", args ?? new GetArcAddonArgs(), options.WithVersion());

        /// <summary>
        /// Arc Addon.
        /// </summary>
        public static Output<GetArcAddonResult> Invoke(GetArcAddonInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetArcAddonResult>("azure-native:databoxedge/v20200901:getArcAddon", args ?? new GetArcAddonInvokeArgs(), options.WithVersion());
    }
