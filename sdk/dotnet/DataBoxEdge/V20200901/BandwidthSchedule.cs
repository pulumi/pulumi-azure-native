...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:databoxedge/v20200901:BandwidthSchedule")]
    public partial class BandwidthSchedule : Pulumi.CustomResource
    {
        ...
        public BandwidthSchedule(string name, BandwidthScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901:BandwidthSchedule", name, args ?? new BandwidthScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901:BandwidthSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BandwidthScheduleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNextGen.DataBoxEdge.V20200901.DayOfWeek>>? _days;

        /// <summary>
        /// The days of the week when this schedule is applicable.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.DataBoxEdge.V20200901.DayOfWeek>> Days
        {
            get => _days ?? (_days = new InputList<Union<string, Pulumi.AzureNextGen.DataBoxEdge.V20200901.DayOfWeek>>());
            set => _days = value;
        }
