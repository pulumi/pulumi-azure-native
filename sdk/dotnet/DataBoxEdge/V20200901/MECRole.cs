...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901
{
    ...
    /// {
    ///     var mecRole = new AzureNative.DataBoxEdge.V20200901.MECRole("mecRole", new()
    ///     {
    ...
    public partial class MECRole : global::Pulumi.CustomResource
    {
        ...
        public MECRole(string name, MECRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:MECRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MECRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:MECRole", name, null, MakeResourceOptions(options, id))
        {
        }
