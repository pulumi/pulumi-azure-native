...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901
{
    public static class GetOrder
    {
        ...
        public static Task<GetOrderResult> InvokeAsync(GetOrderArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOrderResult>("azure-native:databoxedge/v20200901:getOrder", args ?? new GetOrderArgs(), options.WithVersion());

        /// <summary>
        /// The order details.
        /// </summary>
        public static Output<GetOrderResult> Invoke(GetOrderInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOrderResult>("azure-native:databoxedge/v20200901:getOrder", args ?? new GetOrderInvokeArgs(), options.WithVersion());
    }
