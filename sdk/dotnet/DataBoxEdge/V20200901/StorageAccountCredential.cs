...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20200901:StorageAccountCredential")]
    public partial class StorageAccountCredential : Pulumi.CustomResource
    {
        ...
        public StorageAccountCredential(string name, StorageAccountCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:StorageAccountCredential", name, args ?? new StorageAccountCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccountCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901:StorageAccountCredential", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201:StorageAccountCredential"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210201preview:StorageAccountCredential"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201preview:StorageAccountCredential"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601:StorageAccountCredential"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601:StorageAccountCredential"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601preview:StorageAccountCredential"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601preview:StorageAccountCredential"},
                },
            };
    ...
    public sealed class StorageAccountCredentialArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200901.AccountType> AccountType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200901.SSLStatus> SslStatus { get; set; } = null!;
