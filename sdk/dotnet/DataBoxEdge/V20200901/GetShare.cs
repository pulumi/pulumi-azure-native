...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901
{
    ...
    public static class GetShare
    {
        ...
        public static Task<GetShareResult> InvokeAsync(GetShareArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetShareResult>("azure-native:databoxedge/v20200901:getShare", args ?? new GetShareArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a share on the  Data Box Edge/Gateway device.
        /// </summary>
        public static Output<GetShareResult> Invoke(GetShareInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetShareResult>("azure-native:databoxedge/v20200901:getShare", args ?? new GetShareInvokeArgs(), options.WithDefaults());
    }
