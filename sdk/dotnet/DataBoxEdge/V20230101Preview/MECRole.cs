...
namespace Pulumi.AzureNative.DataBoxEdge.V20230101Preview
{
    ...
    /// {
    ///     var mecRole = new AzureNative.DataBoxEdge.V20230101Preview.MECRole("mecRole", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databoxedge/v20230101preview:MECRole IoTRole1 /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/testedgedevice/roles/IoTRole1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230101preview:MECRole")]
    public partial class MECRole : global::Pulumi.CustomResource
    {
        ...
        public MECRole(string name, MECRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:MECRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MECRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:MECRole", name, null, MakeResourceOptions(options, id))
        {
        }
