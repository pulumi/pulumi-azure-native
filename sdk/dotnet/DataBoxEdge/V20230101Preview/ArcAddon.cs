...
namespace Pulumi.AzureNative.DataBoxEdge.V20230101Preview
{
    ...
    /// {
    ///     var arcAddon = new AzureNative.DataBoxEdge.V20230101Preview.ArcAddon("arcAddon", new()
    ///     {
    ///         AddonName = "arcName",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230101preview:ArcAddon")]
    public partial class ArcAddon : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Arc Custom Locations ObjectId
        /// </summary>
        [Output("customLocationsObjectId")]
        public Output<string> CustomLocationsObjectId { get; private set; } = null!;
        ...
        public ArcAddon(string name, ArcAddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:ArcAddon", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ArcAddon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:ArcAddon", name, null, MakeResourceOptions(options, id))
        {
        }
