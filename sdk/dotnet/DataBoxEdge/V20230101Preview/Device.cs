...
namespace Pulumi.AzureNative.DataBoxEdge.V20230101Preview
{
    ...
    /// {
    ///     var device = new AzureNative.DataBoxEdge.V20230101Preview.Device("device", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         Location = "WUS",
    ///         ResourceGroupName = "GroupForEdgeAutomation",
    ///         Sku = new AzureNative.DataBoxEdge.V20230101Preview.Inputs.SkuArgs
    ///         {
    ///             Name = "Edge",
    ///             Tier = "Standard",
    ///         },
    ...
    ///     var device = new AzureNative.DataBoxEdge.V20230101Preview.Device("device", new()
    ///     {
    ///         DataResidency = new AzureNative.DataBoxEdge.V20230101Preview.Inputs.DataResidencyArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230101preview:Device")]
    public partial class Device : global::Pulumi.CustomResource
    {
        /// <summary>
        /// The details of compute version information
        /// </summary>
        [Output("computeVersionInformation")]
        public Output<Outputs.ComputeVersionInformationResponse> ComputeVersionInformation { get; private set; } = null!;
        ...
        /// </summary>
        [Output("kubernetesPlatform")]
        public Output<string> KubernetesPlatform { get; private set; } = null!;
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:Device", name, null, MakeResourceOptions(options, id))
        {
        }
