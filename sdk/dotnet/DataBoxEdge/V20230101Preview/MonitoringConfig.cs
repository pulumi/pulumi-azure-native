...
namespace Pulumi.AzureNative.DataBoxEdge.V20230101Preview
{
    ...
    /// {
    ///     var monitoringConfig = new AzureNative.DataBoxEdge.V20230101Preview.MonitoringConfig("monitoringConfig", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         MetricConfigurations = new[]
    ///         {
    ///             new AzureNative.DataBoxEdge.V20230101Preview.Inputs.MetricConfigurationArgs
    ///             {
    ///                 CounterSets = new[]
    ///                 {
    ///                     new AzureNative.DataBoxEdge.V20230101Preview.Inputs.MetricCounterSetArgs
    ///                     {
    ///                         Counters = new[]
    ///                         {
    ///                             new AzureNative.DataBoxEdge.V20230101Preview.Inputs.MetricCounterArgs
    ///                             {
    ///                                 Name = "test",
    ///                             },
    ///                         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230101preview:MonitoringConfig")]
    public partial class MonitoringConfig : global::Pulumi.CustomResource
    {
        ...
        public MonitoringConfig(string name, MonitoringConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:MonitoringConfig", name, args ?? new MonitoringConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:MonitoringConfig", name, null, MakeResourceOptions(options, id))
        {
        }
