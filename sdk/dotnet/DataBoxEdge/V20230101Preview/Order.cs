...
namespace Pulumi.AzureNative.DataBoxEdge.V20230101Preview
{
    ...
    /// {
    ///     var order = new AzureNative.DataBoxEdge.V20230101Preview.Order("order", new()
    ///     {
    ///         ContactInformation = new AzureNative.DataBoxEdge.V20230101Preview.Inputs.ContactDetailsArgs
    ///         {
    ...
    ///         ShippingAddress = new AzureNative.DataBoxEdge.V20230101Preview.Inputs.AddressArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20230101preview:Order")]
    public partial class Order : global::Pulumi.CustomResource
    {
        ...
        public Order(string name, OrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:Order", name, args ?? new OrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Order(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20230101preview:Order", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrderArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("shipmentType")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20230101Preview.ShipmentType>? ShipmentType { get; set; }
