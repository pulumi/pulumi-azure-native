...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200901Preview
{
    public static class GetDevice
    {
        public static Task<GetDeviceResult> InvokeAsync(GetDeviceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeviceResult>("azure-nextgen:databoxedge/v20200901preview:getDevice", args ?? new GetDeviceArgs(), options.WithVersion());
    }
