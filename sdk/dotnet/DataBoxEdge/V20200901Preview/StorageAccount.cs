...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20200901preview:StorageAccount")]
    public partial class StorageAccount : Pulumi.CustomResource
    {
        ...
        public StorageAccount(string name, StorageAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901preview:StorageAccount", name, args ?? new StorageAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901preview:StorageAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200901Preview.DataPolicy> DataPolicy { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200901Preview.StorageAccountStatus>? StorageAccountStatus { get; set; }
