...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901Preview
{
    ...
    /// {
    ///     var periodicTimerEventTrigger = new AzureNative.DataBoxEdge.V20200901Preview.PeriodicTimerEventTrigger("periodicTimerEventTrigger", new()
    ///     {
    ...
    public partial class PeriodicTimerEventTrigger : global::Pulumi.CustomResource
    {
        ...
        public PeriodicTimerEventTrigger(string name, PeriodicTimerEventTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901preview:PeriodicTimerEventTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private PeriodicTimerEventTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901preview:PeriodicTimerEventTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
