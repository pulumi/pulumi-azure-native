...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200901Preview
{
    public static class GetContainer
    {
        public static Task<GetContainerResult> InvokeAsync(GetContainerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContainerResult>("azure-nextgen:databoxedge/v20200901preview:getContainer", args ?? new GetContainerArgs(), options.WithVersion());
    }
