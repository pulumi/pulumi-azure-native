...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901Preview
{
    public static class GetIoTAddon
    {
        ...
        public static Task<GetIoTAddonResult> InvokeAsync(GetIoTAddonArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIoTAddonResult>("azure-native:databoxedge/v20200901preview:getIoTAddon", args ?? new GetIoTAddonArgs(), options.WithDefaults());

        /// <summary>
        /// IoT Addon.
        /// </summary>
        public static Output<GetIoTAddonResult> Invoke(GetIoTAddonInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIoTAddonResult>("azure-native:databoxedge/v20200901preview:getIoTAddon", args ?? new GetIoTAddonInvokeArgs(), options.WithDefaults());
    }
