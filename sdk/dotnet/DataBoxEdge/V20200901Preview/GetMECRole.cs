...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901Preview
{
    public static class GetMECRole
    {
        ...
        public static Task<GetMECRoleResult> InvokeAsync(GetMECRoleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMECRoleResult>("azure-native:databoxedge/v20200901preview:getMECRole", args ?? new GetMECRoleArgs(), options.WithDefaults());

        /// <summary>
        /// MEC role.
        /// </summary>
        public static Output<GetMECRoleResult> Invoke(GetMECRoleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMECRoleResult>("azure-native:databoxedge/v20200901preview:getMECRole", args ?? new GetMECRoleInvokeArgs(), options.WithDefaults());
    }
