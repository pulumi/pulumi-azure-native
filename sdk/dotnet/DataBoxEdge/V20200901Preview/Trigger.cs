...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200901Preview
{
    ...
    /// Trigger details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:databoxedge/v20200901preview:Trigger")]
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901preview:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901preview:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TriggerArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20200901Preview.TriggerEventType> Kind { get; set; } = null!;
