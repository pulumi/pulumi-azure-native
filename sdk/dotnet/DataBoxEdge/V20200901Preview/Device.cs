...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200901Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:databoxedge/v20200901preview:Device")]
    public partial class Device : Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901preview:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901preview:Device", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeviceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20200901Preview.DataBoxEdgeDeviceStatus>? DataBoxEdgeDeviceStatus { get; set; }
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20200901Preview.DataBoxEdgeDeviceKind>? Kind { get; set; }
