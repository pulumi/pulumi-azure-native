...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20200901preview:Device")]
    public partial class Device : Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901preview:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20200901preview:Device", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201:Device"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210201preview:Device"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201preview:Device"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601:Device"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601:Device"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601preview:Device"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601preview:Device"},
                },
            };
    ...
    public sealed class DeviceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200901Preview.DataBoxEdgeDeviceStatus>? DataBoxEdgeDeviceStatus { get; set; }
