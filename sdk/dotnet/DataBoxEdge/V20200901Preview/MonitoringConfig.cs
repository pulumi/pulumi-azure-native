...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20200901Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:databoxedge/v20200901preview:MonitoringConfig")]
    public partial class MonitoringConfig : Pulumi.CustomResource
    {
        ...
        public MonitoringConfig(string name, MonitoringConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901preview:MonitoringConfig", name, args ?? new MonitoringConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:databoxedge/v20200901preview:MonitoringConfig", name, null, MakeResourceOptions(options, id))
        {
        }
