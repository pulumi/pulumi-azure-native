...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901Preview
{
    ...
    public static class GetBandwidthSchedule
    {
        ...
        public static Task<GetBandwidthScheduleResult> InvokeAsync(GetBandwidthScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBandwidthScheduleResult>("azure-native:databoxedge/v20200901preview:getBandwidthSchedule", args ?? new GetBandwidthScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// The bandwidth schedule details.
        /// </summary>
        public static Output<GetBandwidthScheduleResult> Invoke(GetBandwidthScheduleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBandwidthScheduleResult>("azure-native:databoxedge/v20200901preview:getBandwidthSchedule", args ?? new GetBandwidthScheduleInvokeArgs(), options.WithDefaults());
    }
