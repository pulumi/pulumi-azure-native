...
namespace Pulumi.AzureNative.DataBoxEdge.V20200901Preview.Inputs
{
    ...
    public sealed class SharePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200901Preview.ShareAccessProtocol> AccessProtocol { get; set; } = null!;
        ...
        /// </summary>
        [Input("dataPolicy")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200901Preview.DataPolicy>? DataPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200901Preview.MonitoringStatus> MonitoringStatus { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20200901Preview.ShareStatus> ShareStatus { get; set; } = null!;
