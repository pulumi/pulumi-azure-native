...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:databoxedge/v20210601preview:BandwidthSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:BandwidthSchedule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20210601preview:BandwidthSchedule")]
    public partial class BandwidthSchedule : global::Pulumi.CustomResource
    {
        ...
        public BandwidthSchedule(string name, BandwidthScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:BandwidthSchedule", name, args ?? new BandwidthScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:BandwidthSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
