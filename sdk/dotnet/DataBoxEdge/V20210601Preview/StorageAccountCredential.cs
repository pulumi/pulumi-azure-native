...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    ...
    public partial class StorageAccountCredential : Pulumi.CustomResource
    {
        ...
        public StorageAccountCredential(string name, StorageAccountCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:StorageAccountCredential", name, args ?? new StorageAccountCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageAccountCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:StorageAccountCredential", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageAccountCredentialArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601Preview.AccountType> AccountType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601Preview.SSLStatus> SslStatus { get; set; } = null!;
