...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    public static class GetFileEventTrigger
    {
        ...
        public static Task<GetFileEventTriggerResult> InvokeAsync(GetFileEventTriggerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFileEventTriggerResult>("azure-native:databoxedge/v20210601preview:getFileEventTrigger", args ?? new GetFileEventTriggerArgs(), options.WithDefaults());

        /// <summary>
        /// Get a specific trigger by name.
        /// </summary>
        public static Output<GetFileEventTriggerResult> Invoke(GetFileEventTriggerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFileEventTriggerResult>("azure-native:databoxedge/v20210601preview:getFileEventTrigger", args ?? new GetFileEventTriggerInvokeArgs(), options.WithDefaults());
