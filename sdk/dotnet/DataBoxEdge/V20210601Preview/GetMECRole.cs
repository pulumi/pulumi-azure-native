...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    public static class GetMECRole
    {
        ...
        public static Task<GetMECRoleResult> InvokeAsync(GetMECRoleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMECRoleResult>("azure-native:databoxedge/v20210601preview:getMECRole", args ?? new GetMECRoleArgs(), options.WithVersion());

        /// <summary>
        /// MEC role.
        /// </summary>
        public static Output<GetMECRoleResult> Invoke(GetMECRoleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMECRoleResult>("azure-native:databoxedge/v20210601preview:getMECRole", args ?? new GetMECRoleInvokeArgs(), options.WithVersion());
    }
