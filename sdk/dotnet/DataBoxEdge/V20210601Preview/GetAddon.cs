...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    ...
    public static class GetAddon
    {
        ...
        public static Task<GetAddonResult> InvokeAsync(GetAddonArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAddonResult>("azure-native:databoxedge/v20210601preview:getAddon", args ?? new GetAddonArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a specific addon by name.
        /// </summary>
        public static Output<GetAddonResult> Invoke(GetAddonInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAddonResult>("azure-native:databoxedge/v20210601preview:getAddon", args ?? new GetAddonInvokeArgs(), options.WithDefaults());
    }
