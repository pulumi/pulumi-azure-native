...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    ...
    /// {
    ///     var kubernetesRole = new AzureNative.DataBoxEdge.V20210601Preview.KubernetesRole("kubernetesRole", new()
    ///     {
    ...
    public partial class KubernetesRole : global::Pulumi.CustomResource
    {
        ...
        public KubernetesRole(string name, KubernetesRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:KubernetesRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KubernetesRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:KubernetesRole", name, null, MakeResourceOptions(options, id))
        {
        }
