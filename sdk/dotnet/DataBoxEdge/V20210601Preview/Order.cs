...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20210601preview:Order")]
    public partial class Order : global::Pulumi.CustomResource
    {
        ...
        public Order(string name, OrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:Order", name, args ?? new OrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Order(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:Order", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class OrderArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("shipmentType")]
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601Preview.ShipmentType>? ShipmentType { get; set; }
