...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20210601preview:Addon")]
    public partial class Addon : Pulumi.CustomResource
    {
        ...
        public Addon(string name, AddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:Addon", name, args ?? new AddonArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Addon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:Addon", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AddonArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601Preview.AddonType> Kind { get; set; } = null!;
