...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    ...
    public static class GetRole
    {
        ...
        public static Task<GetRoleResult> InvokeAsync(GetRoleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRoleResult>("azure-native:databoxedge/v20210601preview:getRole", args ?? new GetRoleArgs(), options.WithDefaults());

        /// <summary>
        /// Compute role.
        /// </summary>
        public static Output<GetRoleResult> Invoke(GetRoleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRoleResult>("azure-native:databoxedge/v20210601preview:getRole", args ?? new GetRoleInvokeArgs(), options.WithDefaults());
    }
