...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20210601preview:Role")]
    public partial class Role : Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210601preview:Role", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601preview:Role"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20201201:Role"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210201:Role"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201:Role"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210201preview:Role"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210201preview:Role"},
                    new Pulumi.Alias { Type = "azure-native:databoxedge/v20210601:Role"},
                    new Pulumi.Alias { Type = "azure-nextgen:databoxedge/v20210601:Role"},
                },
            };
    ...
    public sealed class RoleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210601Preview.RoleTypes> Kind { get; set; } = null!;
