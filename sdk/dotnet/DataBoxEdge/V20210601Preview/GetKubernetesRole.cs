...
namespace Pulumi.AzureNative.DataBoxEdge.V20210601Preview
{
    public static class GetKubernetesRole
    {
        ...
        public static Task<GetKubernetesRoleResult> InvokeAsync(GetKubernetesRoleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKubernetesRoleResult>("azure-native:databoxedge/v20210601preview:getKubernetesRole", args ?? new GetKubernetesRoleArgs(), options.WithDefaults());

        /// <summary>
        /// Kubernetes role.
        /// </summary>
        public static Output<GetKubernetesRoleResult> Invoke(GetKubernetesRoleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKubernetesRoleResult>("azure-native:databoxedge/v20210601preview:getKubernetesRole", args ?? new GetKubernetesRoleInvokeArgs(), options.WithDefaults());
    }
