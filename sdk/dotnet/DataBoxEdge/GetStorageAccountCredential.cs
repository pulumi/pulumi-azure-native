...
namespace Pulumi.AzureRM.DataBoxEdge
{
    public static class GetStorageAccountCredential
    {
        public static Task<GetStorageAccountCredentialResult> InvokeAsync(GetStorageAccountCredentialArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageAccountCredentialResult>("azurerm:databoxedge:getStorageAccountCredential", args ?? new GetStorageAccountCredentialArgs(), options.WithVersion());
    }
