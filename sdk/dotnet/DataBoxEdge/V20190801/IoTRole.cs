...
namespace Pulumi.AzureNative.DataBoxEdge.V20190801
{
    ...
    /// {
    ///     var ioTRole = new AzureNative.DataBoxEdge.V20190801.IoTRole("ioTRole", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         HostPlatform = "Linux",
    ///         IoTDeviceDetails = new AzureNative.DataBoxEdge.V20190801.Inputs.IoTDeviceInfoArgs
    ///         {
    ///             Authentication = new AzureNative.DataBoxEdge.V20190801.Inputs.AuthenticationArgs
    ///             {
    ///                 SymmetricKey = new AzureNative.DataBoxEdge.V20190801.Inputs.SymmetricKeyArgs
    ///                 {
    ///                     ConnectionString = new AzureNative.DataBoxEdge.V20190801.Inputs.AsymmetricEncryptedSecretArgs
    ///                     {
    ...
    ///         },
    ///         IoTEdgeDeviceDetails = new AzureNative.DataBoxEdge.V20190801.Inputs.IoTDeviceInfoArgs
    ///         {
    ///             Authentication = new AzureNative.DataBoxEdge.V20190801.Inputs.AuthenticationArgs
    ///             {
    ///                 SymmetricKey = new AzureNative.DataBoxEdge.V20190801.Inputs.SymmetricKeyArgs
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:databoxedge/v20190801:IoTRole IoTRole1 /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/testedgedevice/roles/IoTRole1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20190801:IoTRole")]
    public partial class IoTRole : global::Pulumi.CustomResource
    {
        ...
        public IoTRole(string name, IoTRoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190801:IoTRole", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTRole(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190801:IoTRole", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IoTRoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20190801.PlatformType> HostPlatform { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20190801.RoleStatus> RoleStatus { get; set; } = null!;
