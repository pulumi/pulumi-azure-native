...
namespace Pulumi.AzureNative.DataBoxEdge.V20190801
{
    ...
    /// {
    ///     var user = new AzureNative.DataBoxEdge.V20190801.User("user", new()
    ///     {
    ///         DeviceName = "testedgedevice",
    ///         EncryptedPassword = new AzureNative.DataBoxEdge.V20190801.Inputs.AsymmetricEncryptedSecretArgs
    ///         {
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20190801:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190801:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190801:User", name, null, MakeResourceOptions(options, id))
        {
        }
