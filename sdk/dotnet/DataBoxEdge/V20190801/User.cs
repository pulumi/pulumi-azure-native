...
namespace Pulumi.AzureRM.DataBoxEdge.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var user = new AzureRM.DataBoxEdge.V20190801.User("user", new AzureRM.DataBoxEdge.V20190801.UserArgs
    ///         {
    ///             DeviceName = "testedgedevice",
    ///             EncryptedPassword = new AzureRM.DataBoxEdge.V20190801.Inputs.AsymmetricEncryptedSecretArgs
    ///             {
    ...
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190801:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190801:User", name, null, MakeResourceOptions(options, id))
        {
        }
