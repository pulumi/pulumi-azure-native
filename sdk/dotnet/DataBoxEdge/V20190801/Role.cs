...
namespace Pulumi.AzureRM.DataBoxEdge.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var role = new AzureRM.DataBoxEdge.V20190801.Role("role", new AzureRM.DataBoxEdge.V20190801.RoleArgs
    ///         {
    ...
    public partial class Role : Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190801:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:databoxedge/v20190801:Role", name, null, MakeResourceOptions(options, id))
        {
        }
