...
namespace Pulumi.AzureNextGen.DataBoxEdge.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:databoxedge/v20190801:Share")]
    ...
    public sealed class ShareArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20190801.ShareAccessProtocol> AccessProtocol { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20190801.MonitoringStatus> MonitoringStatus { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataBoxEdge.V20190801.ShareStatus> ShareStatus { get; set; } = null!;
