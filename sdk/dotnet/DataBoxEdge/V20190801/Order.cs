...
namespace Pulumi.AzureNative.DataBoxEdge.V20190801
{
    ...
    /// The order details.
    /// </summary>
    [AzureNativeResourceType("azure-native:databoxedge/v20190801:Order")]
    public partial class Order : Pulumi.CustomResource
    {
        ...
        public Order(string name, OrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190801:Order", name, args ?? new OrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Order(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20190801:Order", name, null, MakeResourceOptions(options, id))
        {
        }
