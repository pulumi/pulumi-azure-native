...
namespace Pulumi.AzureNative.DnsResolver
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver:DnsResolver")]
    public partial class DnsResolver : global::Pulumi.CustomResource
    {
        ...
        public DnsResolver(string name, DnsResolverArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver:DnsResolver", name, args ?? new DnsResolverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsResolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver:DnsResolver", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_dnsresolver_v20200401preview:dnsresolver:DnsResolver" },
                    new global::Pulumi.Alias { Type = "azure-native_dnsresolver_v20220701:dnsresolver:DnsResolver" },
                    new global::Pulumi.Alias { Type = "azure-native_dnsresolver_v20230701preview:dnsresolver:DnsResolver" },
                },
            };
