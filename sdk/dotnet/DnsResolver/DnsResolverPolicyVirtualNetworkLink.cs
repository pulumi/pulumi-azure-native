...
namespace Pulumi.AzureNative.DnsResolver
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver:DnsResolverPolicyVirtualNetworkLink")]
    public partial class DnsResolverPolicyVirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public DnsResolverPolicyVirtualNetworkLink(string name, DnsResolverPolicyVirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver:DnsResolverPolicyVirtualNetworkLink", name, args ?? new DnsResolverPolicyVirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsResolverPolicyVirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver:DnsResolverPolicyVirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dnsresolver/v20250501:DnsResolverPolicyVirtualNetworkLink" },
                    new global::Pulumi.Alias { Type = "azure-native:dnsresolver/v20251001preview:DnsResolverPolicyVirtualNetworkLink" },
