...
namespace Pulumi.AzureNative.DnsResolver
{
    public static class ListDnsForwardingRulesetByVirtualNetwork
    {
        ...
        public static Task<ListDnsForwardingRulesetByVirtualNetworkResult> InvokeAsync(ListDnsForwardingRulesetByVirtualNetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListDnsForwardingRulesetByVirtualNetworkResult>("azure-native:dnsresolver:listDnsForwardingRulesetByVirtualNetwork", args ?? new ListDnsForwardingRulesetByVirtualNetworkArgs(), options.WithDefaults());
        ...
        public static Output<ListDnsForwardingRulesetByVirtualNetworkResult> Invoke(ListDnsForwardingRulesetByVirtualNetworkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListDnsForwardingRulesetByVirtualNetworkResult>("azure-native:dnsresolver:listDnsForwardingRulesetByVirtualNetwork", args ?? new ListDnsForwardingRulesetByVirtualNetworkInvokeArgs(), options.WithDefaults());
