...
namespace Pulumi.AzureNative.DnsResolver
{
    public static class GetOutboundEndpoint
    {
        ...
        public static Task<GetOutboundEndpointResult> InvokeAsync(GetOutboundEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOutboundEndpointResult>("azure-native:dnsresolver:getOutboundEndpoint", args ?? new GetOutboundEndpointArgs(), options.WithDefaults());
        ...
        public static Output<GetOutboundEndpointResult> Invoke(GetOutboundEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOutboundEndpointResult>("azure-native:dnsresolver:getOutboundEndpoint", args ?? new GetOutboundEndpointInvokeArgs(), options.WithDefaults());
