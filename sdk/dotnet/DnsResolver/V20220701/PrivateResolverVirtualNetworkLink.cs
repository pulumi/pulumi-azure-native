...
namespace Pulumi.AzureNative.DnsResolver.V20220701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20220701:PrivateResolverVirtualNetworkLink")]
    public partial class PrivateResolverVirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public PrivateResolverVirtualNetworkLink(string name, PrivateResolverVirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20220701:PrivateResolverVirtualNetworkLink", name, args ?? new PrivateResolverVirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateResolverVirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20220701:PrivateResolverVirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dnsresolver:PrivateResolverVirtualNetworkLink" },
