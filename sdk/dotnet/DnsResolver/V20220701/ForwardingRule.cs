...
namespace Pulumi.AzureNative.DnsResolver.V20220701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20220701:ForwardingRule")]
    public partial class ForwardingRule : global::Pulumi.CustomResource
    {
        ...
        public ForwardingRule(string name, ForwardingRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20220701:ForwardingRule", name, args ?? new ForwardingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ForwardingRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20220701:ForwardingRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ForwardingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DnsResolver.V20220701.ForwardingRuleState>? ForwardingRuleState { get; set; }
