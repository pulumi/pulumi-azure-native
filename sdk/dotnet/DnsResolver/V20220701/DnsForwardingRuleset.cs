...
namespace Pulumi.AzureNative.DnsResolver.V20220701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20220701:DnsForwardingRuleset")]
    public partial class DnsForwardingRuleset : global::Pulumi.CustomResource
    {
        ...
        public DnsForwardingRuleset(string name, DnsForwardingRulesetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20220701:DnsForwardingRuleset", name, args ?? new DnsForwardingRulesetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsForwardingRuleset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20220701:DnsForwardingRuleset", name, null, MakeResourceOptions(options, id))
        {
        }
