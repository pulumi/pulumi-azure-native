...
namespace Pulumi.AzureNative.DnsResolver.V20220701
{
    public static class GetDnsResolver
    {
        ...
        public static Task<GetDnsResolverResult> InvokeAsync(GetDnsResolverArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnsResolverResult>("azure-native:dnsresolver/v20220701:getDnsResolver", args ?? new GetDnsResolverArgs(), options.WithDefaults());

        /// <summary>
        /// Gets properties of a DNS resolver.
        /// </summary>
        public static Output<GetDnsResolverResult> Invoke(GetDnsResolverInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDnsResolverResult>("azure-native:dnsresolver/v20220701:getDnsResolver", args ?? new GetDnsResolverInvokeArgs(), options.WithDefaults());
