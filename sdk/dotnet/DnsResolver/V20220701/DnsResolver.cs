...
namespace Pulumi.AzureNative.DnsResolver.V20220701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20220701:DnsResolver")]
    public partial class DnsResolver : global::Pulumi.CustomResource
    {
        ...
        public DnsResolver(string name, DnsResolverArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20220701:DnsResolver", name, args ?? new DnsResolverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsResolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20220701:DnsResolver", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dnsresolver:DnsResolver" },
                    new global::Pulumi.Alias { Type = "azure-native:network:DnsResolver" },
                    new global::Pulumi.Alias { Type = "azure-native:dnsresolver/v20200401preview:DnsResolver" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20200401preview:DnsResolver" },
                    new global::Pulumi.Alias { Type = "azure-native:dnsresolver/v20230701preview:DnsResolver" },
                    new global::Pulumi.Alias { Type = "azure-native:network/v20230701preview:DnsResolver" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DnsResolver Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
