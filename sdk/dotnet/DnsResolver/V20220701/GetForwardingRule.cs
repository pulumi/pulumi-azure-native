...
namespace Pulumi.AzureNative.DnsResolver.V20220701
{
    public static class GetForwardingRule
    {
        ...
        public static Task<GetForwardingRuleResult> InvokeAsync(GetForwardingRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetForwardingRuleResult>("azure-native:dnsresolver/v20220701:getForwardingRule", args ?? new GetForwardingRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets properties of a forwarding rule in a DNS forwarding ruleset.
        /// </summary>
        public static Output<GetForwardingRuleResult> Invoke(GetForwardingRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetForwardingRuleResult>("azure-native:dnsresolver/v20220701:getForwardingRule", args ?? new GetForwardingRuleInvokeArgs(), options.WithDefaults());
