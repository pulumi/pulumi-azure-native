...
namespace Pulumi.AzureNative.DnsResolver
{
    public static class GetDnsResolver
    {
        ...
        public static Task<GetDnsResolverResult> InvokeAsync(GetDnsResolverArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnsResolverResult>("azure-native:dnsresolver:getDnsResolver", args ?? new GetDnsResolverArgs(), options.WithDefaults());
        ...
        public static Output<GetDnsResolverResult> Invoke(GetDnsResolverInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDnsResolverResult>("azure-native:dnsresolver:getDnsResolver", args ?? new GetDnsResolverInvokeArgs(), options.WithDefaults());
