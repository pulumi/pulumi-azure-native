...
namespace Pulumi.AzureNative.DnsResolver.V20200401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20200401preview:DnsResolver")]
    public partial class DnsResolver : global::Pulumi.CustomResource
    {
        ...
        public DnsResolver(string name, DnsResolverArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20200401preview:DnsResolver", name, args ?? new DnsResolverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsResolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20200401preview:DnsResolver", name, null, MakeResourceOptions(options, id))
        {
        }
