...
namespace Pulumi.AzureNative.DnsResolver.V20200401Preview
{
    public static class GetDnsResolver
    {
        ...
        public static Task<GetDnsResolverResult> InvokeAsync(GetDnsResolverArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnsResolverResult>("azure-native:dnsresolver/v20200401preview:getDnsResolver", args ?? new GetDnsResolverArgs(), options.WithDefaults());

        /// <summary>
        /// Gets properties of a DNS resolver.
        /// </summary>
        public static Output<GetDnsResolverResult> Invoke(GetDnsResolverInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDnsResolverResult>("azure-native:dnsresolver/v20200401preview:getDnsResolver", args ?? new GetDnsResolverInvokeArgs(), options.WithDefaults());
