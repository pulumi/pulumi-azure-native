...
namespace Pulumi.AzureNative.DnsResolver.V20200401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20200401preview:OutboundEndpoint")]
    public partial class OutboundEndpoint : global::Pulumi.CustomResource
    {
        ...
        public OutboundEndpoint(string name, OutboundEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20200401preview:OutboundEndpoint", name, args ?? new OutboundEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OutboundEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20200401preview:OutboundEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
