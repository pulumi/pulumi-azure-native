...
namespace Pulumi.AzureNative.DnsResolver.V20200401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20200401preview:ForwardingRule")]
    public partial class ForwardingRule : global::Pulumi.CustomResource
    {
        ...
        public ForwardingRule(string name, ForwardingRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20200401preview:ForwardingRule", name, args ?? new ForwardingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ForwardingRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20200401preview:ForwardingRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dnsresolver:ForwardingRule" },
    ...
    public sealed class ForwardingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DnsResolver.V20200401Preview.ForwardingRuleState>? ForwardingRuleState { get; set; }
