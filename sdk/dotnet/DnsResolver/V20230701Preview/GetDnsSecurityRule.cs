...
namespace Pulumi.AzureNative.DnsResolver.V20230701Preview
{
    public static class GetDnsSecurityRule
    {
        ...
        public static Task<GetDnsSecurityRuleResult> InvokeAsync(GetDnsSecurityRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnsSecurityRuleResult>("azure-native:dnsresolver/v20230701preview:getDnsSecurityRule", args ?? new GetDnsSecurityRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets properties of a DNS security rule for a DNS resolver policy.
        /// </summary>
        public static Output<GetDnsSecurityRuleResult> Invoke(GetDnsSecurityRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDnsSecurityRuleResult>("azure-native:dnsresolver/v20230701preview:getDnsSecurityRule", args ?? new GetDnsSecurityRuleInvokeArgs(), options.WithDefaults());
