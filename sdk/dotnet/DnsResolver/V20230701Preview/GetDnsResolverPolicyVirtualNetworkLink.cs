...
namespace Pulumi.AzureNative.DnsResolver.V20230701Preview
{
    public static class GetDnsResolverPolicyVirtualNetworkLink
    {
        ...
        public static Task<GetDnsResolverPolicyVirtualNetworkLinkResult> InvokeAsync(GetDnsResolverPolicyVirtualNetworkLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDnsResolverPolicyVirtualNetworkLinkResult>("azure-native:dnsresolver/v20230701preview:getDnsResolverPolicyVirtualNetworkLink", args ?? new GetDnsResolverPolicyVirtualNetworkLinkArgs(), options.WithDefaults());
        ...
        public static Output<GetDnsResolverPolicyVirtualNetworkLinkResult> Invoke(GetDnsResolverPolicyVirtualNetworkLinkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDnsResolverPolicyVirtualNetworkLinkResult>("azure-native:dnsresolver/v20230701preview:getDnsResolverPolicyVirtualNetworkLink", args ?? new GetDnsResolverPolicyVirtualNetworkLinkInvokeArgs(), options.WithDefaults());
