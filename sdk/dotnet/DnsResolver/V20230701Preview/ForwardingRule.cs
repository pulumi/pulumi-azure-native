...
namespace Pulumi.AzureNative.DnsResolver.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20230701preview:ForwardingRule")]
    public partial class ForwardingRule : global::Pulumi.CustomResource
    {
        ...
        public ForwardingRule(string name, ForwardingRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20230701preview:ForwardingRule", name, args ?? new ForwardingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ForwardingRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20230701preview:ForwardingRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ForwardingRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DnsResolver.V20230701Preview.ForwardingRuleState>? ForwardingRuleState { get; set; }
