...
namespace Pulumi.AzureNative.DnsResolver.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20230701preview:PrivateResolverVirtualNetworkLink")]
    public partial class PrivateResolverVirtualNetworkLink : global::Pulumi.CustomResource
    {
        ...
        public PrivateResolverVirtualNetworkLink(string name, PrivateResolverVirtualNetworkLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20230701preview:PrivateResolverVirtualNetworkLink", name, args ?? new PrivateResolverVirtualNetworkLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateResolverVirtualNetworkLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20230701preview:PrivateResolverVirtualNetworkLink", name, null, MakeResourceOptions(options, id))
        {
        }
