...
namespace Pulumi.AzureNative.DnsResolver.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20230701preview:OutboundEndpoint")]
    public partial class OutboundEndpoint : global::Pulumi.CustomResource
    {
        ...
        public OutboundEndpoint(string name, OutboundEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20230701preview:OutboundEndpoint", name, args ?? new OutboundEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OutboundEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20230701preview:OutboundEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dnsresolver:OutboundEndpoint" },
