...
namespace Pulumi.AzureNative.DnsResolver.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dnsresolver/v20230701preview:InboundEndpoint")]
    public partial class InboundEndpoint : global::Pulumi.CustomResource
    {
        ...
        public InboundEndpoint(string name, InboundEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20230701preview:InboundEndpoint", name, args ?? new InboundEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InboundEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dnsresolver/v20230701preview:InboundEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
