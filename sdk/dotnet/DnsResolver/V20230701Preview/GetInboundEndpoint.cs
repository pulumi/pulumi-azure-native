...
namespace Pulumi.AzureNative.DnsResolver.V20230701Preview
{
    public static class GetInboundEndpoint
    {
        ...
        public static Task<GetInboundEndpointResult> InvokeAsync(GetInboundEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInboundEndpointResult>("azure-native:dnsresolver/v20230701preview:getInboundEndpoint", args ?? new GetInboundEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Gets properties of an inbound endpoint for a DNS resolver.
        /// </summary>
        public static Output<GetInboundEndpointResult> Invoke(GetInboundEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInboundEndpointResult>("azure-native:dnsresolver/v20230701preview:getInboundEndpoint", args ?? new GetInboundEndpointInvokeArgs(), options.WithDefaults());
