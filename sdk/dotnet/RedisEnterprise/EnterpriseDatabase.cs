...
namespace Pulumi.AzureNative.RedisEnterprise
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:redisenterprise:EnterpriseDatabase")]
    public partial class EnterpriseDatabase : global::Pulumi.CustomResource
    {
        ...
        public EnterpriseDatabase(string name, EnterpriseDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:redisenterprise:EnterpriseDatabase", name, args ?? new EnterpriseDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnterpriseDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:redisenterprise:EnterpriseDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:redisenterprise/v20240901preview:EnterpriseDatabase" },
    ...
    public sealed class EnterpriseDatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.RedisEnterprise.EvictionPolicy>? EvictionPolicy { get; set; }
