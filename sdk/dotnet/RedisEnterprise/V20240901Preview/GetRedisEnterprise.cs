...
namespace Pulumi.AzureNative.RedisEnterprise.V20240901Preview
{
    public static class GetRedisEnterprise
    {
        ...
        public static Task<GetRedisEnterpriseResult> InvokeAsync(GetRedisEnterpriseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRedisEnterpriseResult>("azure-native:redisenterprise/v20240901preview:getRedisEnterprise", args ?? new GetRedisEnterpriseArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a Redis Enterprise cluster
        /// </summary>
        public static Output<GetRedisEnterpriseResult> Invoke(GetRedisEnterpriseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRedisEnterpriseResult>("azure-native:redisenterprise/v20240901preview:getRedisEnterprise", args ?? new GetRedisEnterpriseInvokeArgs(), options.WithDefaults());
