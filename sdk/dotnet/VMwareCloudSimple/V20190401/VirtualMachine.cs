...
namespace Pulumi.AzureRM.VMwareCloudSimple.V20190401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualMachine = new AzureRM.VMwareCloudSimple.V20190401.VirtualMachine("virtualMachine", new AzureRM.VMwareCloudSimple.V20190401.VirtualMachineArgs
    ///         {
    ///             AmountOfRam = 4096,
    ///             Disks = 
    ///             {
    ///                 new AzureRM.VMwareCloudSimple.V20190401.Inputs.VirtualDiskArgs
    ///                 {
    ///                     ControllerId = "1000",
    ...
    ///             Nics = 
    ///             {
    ///                 new AzureRM.VMwareCloudSimple.V20190401.Inputs.VirtualNicArgs
    ///                 {
    ///                     Network = new AzureRM.VMwareCloudSimple.V20190401.Inputs.VirtualNetworkArgs
    ///                     {
    ...
    ///             ResourcePool = new AzureRM.VMwareCloudSimple.V20190401.Inputs.ResourcePoolArgs
    ///             {
