...
namespace Pulumi.AzureRM.VMwareCloudSimple.Inputs
{
    ...
    public sealed class VirtualMachinePropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.VirtualDiskControllerResponseGetArgs>? _controllers;

        /// <summary>
        /// The list of Virtual Disks' Controllers
        /// </summary>
        public InputList<Inputs.VirtualDiskControllerResponseGetArgs> Controllers
        {
            get => _controllers ?? (_controllers = new InputList<Inputs.VirtualDiskControllerResponseGetArgs>());
        ...
        /// </summary>
        [Input("customization")]
        public Input<Inputs.GuestOSCustomizationResponseGetArgs>? Customization { get; set; }

        [Input("disks")]
        private InputList<Inputs.VirtualDiskResponseGetArgs>? _disks;

        /// <summary>
        /// The list of Virtual Disks
        /// </summary>
        public InputList<Inputs.VirtualDiskResponseGetArgs> Disks
        {
            get => _disks ?? (_disks = new InputList<Inputs.VirtualDiskResponseGetArgs>());
            set => _disks = value;
        }
        ...
        [Input("nics")]
        private InputList<Inputs.VirtualNicResponseGetArgs>? _nics;

        /// <summary>
        /// The list of Virtual NICs
        /// </summary>
        public InputList<Inputs.VirtualNicResponseGetArgs> Nics
        {
            get => _nics ?? (_nics = new InputList<Inputs.VirtualNicResponseGetArgs>());
            set => _nics = value;
        }
        ...
        /// </summary>
        [Input("resourcePool")]
        public Input<Inputs.ResourcePoolResponseGetArgs>? ResourcePool { get; set; }
