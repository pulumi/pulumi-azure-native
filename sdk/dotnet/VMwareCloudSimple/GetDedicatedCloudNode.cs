...
namespace Pulumi.AzureRM.VMwareCloudSimple
{
    public static class GetDedicatedCloudNode
    {
        public static Task<GetDedicatedCloudNodeResult> InvokeAsync(GetDedicatedCloudNodeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedCloudNodeResult>("azurerm:vmwarecloudsimple:getDedicatedCloudNode", args ?? new GetDedicatedCloudNodeArgs(), options.WithVersion());
    }
