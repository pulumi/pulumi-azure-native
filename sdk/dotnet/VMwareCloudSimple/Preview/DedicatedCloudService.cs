...
namespace Pulumi.AzureRM.VMwareCloudSimple.Preview
{
    /// <summary>
    ...
    public partial class DedicatedCloudService : Pulumi.CustomResource
    {
        ...
        public DedicatedCloudService(string name, DedicatedCloudServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:vmwarecloudsimple/preview:DedicatedCloudService", name, args ?? new DedicatedCloudServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedCloudService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:vmwarecloudsimple/preview:DedicatedCloudService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:vmwarecloudsimple/v20190401:DedicatedCloudService"},
                },
            };
