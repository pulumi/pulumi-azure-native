...
namespace Pulumi.AzureRM.VMwareCloudSimple.Preview
{
    ...
    public partial class DedicatedCloudNode : Pulumi.CustomResource
    {
        ...
        public DedicatedCloudNode(string name, DedicatedCloudNodeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:vmwarecloudsimple/preview:DedicatedCloudNode", name, args ?? new DedicatedCloudNodeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedCloudNode(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:vmwarecloudsimple/preview:DedicatedCloudNode", name, null, MakeResourceOptions(options, id))
        {
        }
