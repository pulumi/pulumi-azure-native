...
namespace Pulumi.AzureNative.VoiceServices
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:voiceservices:Contact")]
    public partial class Contact : global::Pulumi.CustomResource
    {
        ...
        public Contact(string name, ContactArgs args, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices:Contact", name, args ?? new ContactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Contact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices:Contact", name, null, MakeResourceOptions(options, id))
        {
        }
