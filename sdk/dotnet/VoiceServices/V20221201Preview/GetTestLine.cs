...
namespace Pulumi.AzureNative.VoiceServices.V20221201Preview
{
    public static class GetTestLine
    {
        ...
        public static Task<GetTestLineResult> InvokeAsync(GetTestLineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTestLineResult>("azure-native:voiceservices/v20221201preview:getTestLine", args ?? new GetTestLineArgs(), options.WithDefaults());

        /// <summary>
        /// Get a TestLine
        /// </summary>
        public static Output<GetTestLineResult> Invoke(GetTestLineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTestLineResult>("azure-native:voiceservices/v20221201preview:getTestLine", args ?? new GetTestLineInvokeArgs(), options.WithDefaults());
    }
