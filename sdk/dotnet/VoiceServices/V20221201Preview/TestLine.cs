...
namespace Pulumi.AzureNative.VoiceServices.V20221201Preview
{
    ...
    public partial class TestLine : global::Pulumi.CustomResource
    {
        ...
        public TestLine(string name, TestLineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20221201preview:TestLine", name, args ?? new TestLineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TestLine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20221201preview:TestLine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TestLineArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.VoiceServices.V20221201Preview.TestLinePurpose> Purpose { get; set; } = null!;
