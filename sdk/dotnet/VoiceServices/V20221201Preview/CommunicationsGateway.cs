...
namespace Pulumi.AzureNative.VoiceServices.V20221201Preview
{
    ...
    public partial class CommunicationsGateway : global::Pulumi.CustomResource
    {
        ...
        public CommunicationsGateway(string name, CommunicationsGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20221201preview:CommunicationsGateway", name, args ?? new CommunicationsGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommunicationsGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20221201preview:CommunicationsGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CommunicationsGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20221201Preview.TeamsCodecs>>? _codecs;

        /// <summary>
        /// Voice codecs to support
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20221201Preview.TeamsCodecs>> Codecs
        {
            get => _codecs ?? (_codecs = new InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20221201Preview.TeamsCodecs>>());
            set => _codecs = value;
        }
        ...
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20221201Preview.Connectivity> Connectivity { get; set; } = null!;

        /// <summary>
        /// How to handle 911 calls
        /// </summary>
        [Input("e911Type", required: true)]
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20221201Preview.E911Type> E911Type { get; set; } = null!;
        ...
        private InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20221201Preview.CommunicationsPlatform>>? _platforms;

        /// <summary>
        /// What platforms to support
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20221201Preview.CommunicationsPlatform>> Platforms
        {
            get => _platforms ?? (_platforms = new InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20221201Preview.CommunicationsPlatform>>());
