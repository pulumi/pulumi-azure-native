...
namespace Pulumi.AzureNative.VoiceServices.V20230403
{
    ...
    /// A TestLine resource
    /// </summary>
    [AzureNativeResourceType("azure-native:voiceservices/v20230403:TestLine")]
    public partial class TestLine : global::Pulumi.CustomResource
    {
        ...
        public TestLine(string name, TestLineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20230403:TestLine", name, args ?? new TestLineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TestLine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20230403:TestLine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TestLineArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20230403.TestLinePurpose> Purpose { get; set; } = null!;
