...
namespace Pulumi.AzureNative.VoiceServices.V20230403
{
    public static class GetTestLine
    {
        ...
        public static Task<GetTestLineResult> InvokeAsync(GetTestLineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTestLineResult>("azure-native:voiceservices/v20230403:getTestLine", args ?? new GetTestLineArgs(), options.WithDefaults());
