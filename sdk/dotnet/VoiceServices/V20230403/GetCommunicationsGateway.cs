...
namespace Pulumi.AzureNative.VoiceServices.V20230403
{
    public static class GetCommunicationsGateway
    {
        ...
        public static Task<GetCommunicationsGatewayResult> InvokeAsync(GetCommunicationsGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCommunicationsGatewayResult>("azure-native:voiceservices/v20230403:getCommunicationsGateway", args ?? new GetCommunicationsGatewayArgs(), options.WithDefaults());
