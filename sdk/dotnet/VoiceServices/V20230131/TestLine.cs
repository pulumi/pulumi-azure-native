...
namespace Pulumi.AzureNative.VoiceServices.V20230131
{
    ...
    /// A TestLine resource
    /// </summary>
    [Obsolete(@"azure-native:voiceservices/v20230131:TestLine is being removed in the next major version of this provider. Upgrade to at least azure-native:voiceservices/v20230403:TestLine to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:voiceservices/v20230131:TestLine")]
    public partial class TestLine : global::Pulumi.CustomResource
    {
        ...
        public TestLine(string name, TestLineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20230131:TestLine", name, args ?? new TestLineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TestLine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20230131:TestLine", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:voiceservices:TestLine"},
    ...
    public sealed class TestLineArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20230131.TestLinePurpose> Purpose { get; set; } = null!;
