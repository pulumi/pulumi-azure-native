...
namespace Pulumi.AzureNative.VoiceServices.V20230131
{
    ...
    public static class GetCommunicationsGateway
    {
        ...
        public static Task<GetCommunicationsGatewayResult> InvokeAsync(GetCommunicationsGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCommunicationsGatewayResult>("azure-native:voiceservices/v20230131:getCommunicationsGateway", args ?? new GetCommunicationsGatewayArgs(), options.WithDefaults());
        ...
        public static Output<GetCommunicationsGatewayResult> Invoke(GetCommunicationsGatewayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCommunicationsGatewayResult>("azure-native:voiceservices/v20230131:getCommunicationsGateway", args ?? new GetCommunicationsGatewayInvokeArgs(), options.WithDefaults());
    }
