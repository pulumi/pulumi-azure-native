...
namespace Pulumi.AzureNative.VoiceServices.V20230131
{
    ...
    /// {
    ///     var communicationsGateway = new AzureNative.VoiceServices.V20230131.CommunicationsGateway("communicationsGateway", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.VoiceServices.V20230131.Inputs.ServiceRegionPropertiesArgs
    ///             {
    ///                 Name = "useast",
    ///                 PrimaryRegionProperties = new AzureNative.VoiceServices.V20230131.Inputs.PrimaryRegionPropertiesArgs
    ///                 {
    ...
    public partial class CommunicationsGateway : global::Pulumi.CustomResource
    {
        ...
        public CommunicationsGateway(string name, CommunicationsGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20230131:CommunicationsGateway", name, args ?? new CommunicationsGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommunicationsGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20230131:CommunicationsGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CommunicationsGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20230131.AutoGeneratedDomainNameLabelScope>? AutoGeneratedDomainNameLabelScope { get; set; }

        [Input("codecs", required: true)]
        private InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230131.TeamsCodecs>>? _codecs;

        /// <summary>
        /// Voice codecs to support
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230131.TeamsCodecs>> Codecs
        {
            get => _codecs ?? (_codecs = new InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230131.TeamsCodecs>>());
            set => _codecs = value;
        }
        ...
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20230131.Connectivity> Connectivity { get; set; } = null!;

        /// <summary>
        /// How to handle 911 calls
        /// </summary>
        [Input("e911Type", required: true)]
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20230131.E911Type> E911Type { get; set; } = null!;
        ...
        private InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230131.CommunicationsPlatform>>? _platforms;

        /// <summary>
        /// What platforms to support
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230131.CommunicationsPlatform>> Platforms
        {
            get => _platforms ?? (_platforms = new InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230131.CommunicationsPlatform>>());
