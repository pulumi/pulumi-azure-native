...
namespace Pulumi.AzureNative.VoiceServices.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:voiceservices/v20230901:CommunicationsGateway")]
    public partial class CommunicationsGateway : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("allocatedMediaAddressPrefixes")]
        public Output<ImmutableArray<string>> AllocatedMediaAddressPrefixes { get; private set; } = null!;

        /// <summary>
        /// A list of IP allocated prefixes which may be used to receive signaling data from this Communications Gateway.
        /// </summary>
        [Output("allocatedSignalingAddressPrefixes")]
        public Output<ImmutableArray<string>> AllocatedSignalingAddressPrefixes { get; private set; } = null!;

        /// <summary>
        /// Details of API bridge functionality, if required
        /// </summary>
        [Output("apiBridge")]
        public Output<Outputs.ApiBridgePropertiesResponse?> ApiBridge { get; private set; } = null!;
        ...
        /// </summary>
        [Output("customSipHeaders")]
        public Output<Outputs.CustomSipHeadersPropertiesResponse?> CustomSipHeaders { get; private set; } = null!;

        /// <summary>
        /// Details of DNS Domains to delegate to the Communications Gateway.
        /// </summary>
        [Output("dnsDelegations")]
        public Output<Outputs.DnsDelegationsPropertiesResponse?> DnsDelegations { get; private set; } = null!;
        ...
        public CommunicationsGateway(string name, CommunicationsGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20230901:CommunicationsGateway", name, args ?? new CommunicationsGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommunicationsGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:voiceservices/v20230901:CommunicationsGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CommunicationsGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("apiBridge")]
        public Input<Inputs.ApiBridgePropertiesArgs>? ApiBridge { get; set; }

        /// <summary>
        /// The scope at which the auto-generated domain name can be re-used
        /// </summary>
        [Input("autoGeneratedDomainNameLabelScope")]
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20230901.AutoGeneratedDomainNameLabelScope>? AutoGeneratedDomainNameLabelScope { get; set; }

        [Input("codecs", required: true)]
        private InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230901.TeamsCodecs>>? _codecs;

        /// <summary>
        /// Voice codecs to support
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230901.TeamsCodecs>> Codecs
        {
            get => _codecs ?? (_codecs = new InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230901.TeamsCodecs>>());
            set => _codecs = value;
        }
        ...
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20230901.Connectivity> Connectivity { get; set; } = null!;

        /// <summary>
        /// Custom SIP Header to add to any subscriber with a custom_header value, if required.
        /// </summary>
        [Input("customSipHeaders")]
        public Input<Inputs.CustomSipHeadersPropertiesArgs>? CustomSipHeaders { get; set; }

        /// <summary>
        /// Details of DNS Domains to delegate to the Communications Gateway.
        /// </summary>
        [Input("dnsDelegations")]
        public Input<Inputs.DnsDelegationsPropertiesArgs>? DnsDelegations { get; set; }

        /// <summary>
        /// How to handle 911 calls
        /// </summary>
        [Input("e911Type", required: true)]
        public InputUnion<string, Pulumi.AzureNative.VoiceServices.V20230901.E911Type> E911Type { get; set; } = null!;
        ...
        private InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230901.CommunicationsPlatform>>? _platforms;

        /// <summary>
        /// What platforms to support
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230901.CommunicationsPlatform>> Platforms
        {
            get => _platforms ?? (_platforms = new InputList<Union<string, Pulumi.AzureNative.VoiceServices.V20230901.CommunicationsPlatform>>());
