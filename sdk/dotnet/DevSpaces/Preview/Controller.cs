...
namespace Pulumi.AzureRM.DevSpaces.Preview
{
    public partial class Controller : Pulumi.CustomResource
    {
        ...
        public Controller(string name, ControllerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devspaces/preview:Controller", name, args ?? new ControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Controller(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devspaces/preview:Controller", name, null, MakeResourceOptions(options, id))
        {
        }
