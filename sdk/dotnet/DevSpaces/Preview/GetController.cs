...
namespace Pulumi.AzureRM.DevSpaces.Preview
{
    public static class GetController
    {
        public static Task<GetControllerResult> InvokeAsync(GetControllerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetControllerResult>("azurerm:devspaces/preview:getController", args ?? new GetControllerArgs(), options.WithVersion());
    }
