...
namespace Pulumi.AzureRM.DevSpaces
{
    public static class ListControllerConnectionDetails
    {
        public static Task<ListControllerConnectionDetailsResult> InvokeAsync(ListControllerConnectionDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListControllerConnectionDetailsResult>("azurerm:devspaces:listControllerConnectionDetails", args ?? new ListControllerConnectionDetailsArgs(), options.WithVersion());
    }
