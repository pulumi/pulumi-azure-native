...
namespace Pulumi.AzureNative.DevSpaces.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devspaces:Controller'.")]
    [AzureNativeResourceType("azure-native:devspaces/latest:Controller")]
    public partial class Controller : Pulumi.CustomResource
    {
        ...
        public Controller(string name, ControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devspaces/latest:Controller", name, args ?? new ControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Controller(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devspaces/latest:Controller", name, null, MakeResourceOptions(options, id))
        {
        }
