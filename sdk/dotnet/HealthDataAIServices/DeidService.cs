...
namespace Pulumi.AzureNative.HealthDataAIServices
{
    ...
    public partial class DeidService : global::Pulumi.CustomResource
    {
        ...
        public DeidService(string name, DeidServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthdataaiservices:DeidService", name, args ?? new DeidServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeidService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthdataaiservices:DeidService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_healthdataaiservices_v20240228preview:healthdataaiservices:DeidService" },
