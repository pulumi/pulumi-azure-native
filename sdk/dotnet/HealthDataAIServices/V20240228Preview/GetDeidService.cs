...
namespace Pulumi.AzureNative.HealthDataAIServices.V20240228Preview
{
    public static class GetDeidService
    {
        ...
        public static Task<GetDeidServiceResult> InvokeAsync(GetDeidServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeidServiceResult>("azure-native:healthdataaiservices/v20240228preview:getDeidService", args ?? new GetDeidServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Get a DeidService
        /// </summary>
        public static Output<GetDeidServiceResult> Invoke(GetDeidServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDeidServiceResult>("azure-native:healthdataaiservices/v20240228preview:getDeidService", args ?? new GetDeidServiceInvokeArgs(), options.WithDefaults());
    }
