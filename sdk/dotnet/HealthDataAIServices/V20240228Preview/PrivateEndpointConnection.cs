...
namespace Pulumi.AzureNative.HealthDataAIServices.V20240228Preview
{
    /// <summary>
    /// Holder for private endpoint connections
    /// </summary>
    [AzureNativeResourceType("azure-native:healthdataaiservices/v20240228preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthdataaiservices/v20240228preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthdataaiservices/v20240228preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
