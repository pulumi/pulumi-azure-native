...
namespace Pulumi.AzureNative.HealthDataAIServices.V20240920
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthdataaiservices/v20240920:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthdataaiservices/v20240920:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthdataaiservices/v20240920:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
