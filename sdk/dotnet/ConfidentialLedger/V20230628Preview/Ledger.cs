...
namespace Pulumi.AzureNative.ConfidentialLedger.V20230628Preview
{
    /// <summary>
    /// Confidential Ledger. Contains the properties of Confidential Ledger Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:confidentialledger/v20230628preview:Ledger")]
    public partial class Ledger : global::Pulumi.CustomResource
    {
        ...
        public Ledger(string name, LedgerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20230628preview:Ledger", name, args ?? new LedgerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ledger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20230628preview:Ledger", name, null, MakeResourceOptions(options, id))
        {
        }
