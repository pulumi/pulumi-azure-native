...
namespace Pulumi.AzureNative.ConfidentialLedger.V20240709Preview
{
    /// <summary>
    /// Confidential Ledger. Contains the properties of Confidential Ledger Resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:confidentialledger/v20240709preview:Ledger")]
    public partial class Ledger : global::Pulumi.CustomResource
    {
        ...
        public Ledger(string name, LedgerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20240709preview:Ledger", name, args ?? new LedgerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ledger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20240709preview:Ledger", name, null, MakeResourceOptions(options, id))
        {
        }
