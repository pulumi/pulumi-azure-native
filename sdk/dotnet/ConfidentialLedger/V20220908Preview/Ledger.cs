...
namespace Pulumi.AzureNative.ConfidentialLedger.V20220908Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:confidentialledger/v20220908preview:Ledger is being removed in the next major version of this provider. Please upgrade to azure-native:confidentialledger/v20230126preview:Ledger to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:confidentialledger/v20220908preview:Ledger")]
    public partial class Ledger : global::Pulumi.CustomResource
    {
        ...
        public Ledger(string name, LedgerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20220908preview:Ledger", name, args ?? new LedgerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ledger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20220908preview:Ledger", name, null, MakeResourceOptions(options, id))
        {
        }
