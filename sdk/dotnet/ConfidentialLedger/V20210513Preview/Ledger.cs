...
namespace Pulumi.AzureNative.ConfidentialLedger.V20210513Preview
{
    ...
    public partial class Ledger : Pulumi.CustomResource
    {
        ...
        public Ledger(string name, LedgerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20210513preview:Ledger", name, args ?? new LedgerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ledger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20210513preview:Ledger", name, null, MakeResourceOptions(options, id))
        {
        }
