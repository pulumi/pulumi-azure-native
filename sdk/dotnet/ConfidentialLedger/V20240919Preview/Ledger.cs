...
namespace Pulumi.AzureNative.ConfidentialLedger.V20240919Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:confidentialledger/v20240919preview:Ledger")]
    public partial class Ledger : global::Pulumi.CustomResource
    {
        ...
        public Ledger(string name, LedgerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20240919preview:Ledger", name, args ?? new LedgerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ledger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:confidentialledger/v20240919preview:Ledger", name, null, MakeResourceOptions(options, id))
        {
        }
