...
namespace Pulumi.AzureNative.ResourceConnector.V20211031Preview
{
    ...
    public partial class Appliance : global::Pulumi.CustomResource
    {
        ...
        public Appliance(string name, ApplianceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resourceconnector/v20211031preview:Appliance", name, args ?? new ApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Appliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resourceconnector/v20211031preview:Appliance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplianceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("distro")]
        public InputUnion<string, Pulumi.AzureNative.ResourceConnector.V20211031Preview.Distro>? Distro { get; set; }
