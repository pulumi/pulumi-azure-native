...
namespace Pulumi.AzureNative.ResourceConnector.V20221027
{
    public static class GetAppliance
    {
        ...
        public static Task<GetApplianceResult> InvokeAsync(GetApplianceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApplianceResult>("azure-native:resourceconnector/v20221027:getAppliance", args ?? new GetApplianceArgs(), options.WithDefaults());
