...
namespace Pulumi.AzureNative.ResourceConnector.V20221027
{
    ...
    /// {
    ///     var appliance = new AzureNative.ResourceConnector.V20221027.Appliance("appliance", new()
    ///     {
    ///         Distro = "AKSEdge",
    ///         InfrastructureConfig = new AzureNative.ResourceConnector.V20221027.Inputs.AppliancePropertiesInfrastructureConfigArgs
    ///         {
    ///             Provider = "VMWare",
    ///         },
    ///         Location = "West US",
