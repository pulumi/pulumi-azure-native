...
namespace Pulumi.AzureNative.ResourceConnector.V20220415Preview
{
    ...
    public partial class Appliance : Pulumi.CustomResource
    {
        ...
        public Appliance(string name, ApplianceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resourceconnector/v20220415preview:Appliance", name, args ?? new ApplianceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Appliance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resourceconnector/v20220415preview:Appliance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:resourceconnector:Appliance"},
    ...
    public sealed class ApplianceArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("distro")]
        public InputUnion<string, Pulumi.AzureNative.ResourceConnector.V20220415Preview.Distro>? Distro { get; set; }
