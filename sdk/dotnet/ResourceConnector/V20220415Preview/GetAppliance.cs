...
namespace Pulumi.AzureNative.ResourceConnector.V20220415Preview
{
    public static class GetAppliance
    {
        ...
        public static Task<GetApplianceResult> InvokeAsync(GetApplianceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplianceResult>("azure-native:resourceconnector/v20220415preview:getAppliance", args ?? new GetApplianceArgs(), options.WithDefaults());

        /// <summary>
        /// Appliances definition.
        /// </summary>
        public static Output<GetApplianceResult> Invoke(GetApplianceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplianceResult>("azure-native:resourceconnector/v20220415preview:getAppliance", args ?? new GetApplianceInvokeArgs(), options.WithDefaults());
    }
