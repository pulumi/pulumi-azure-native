...
namespace Pulumi.AzureNative.AzureData.V20190724Preview
{
    ...
    /// {
    ///     var sqlServer = new AzureNative.AzureData.V20190724Preview.SqlServer("sqlServer", new()
    ///     {
    ///         Cores = 8,
    ///         Edition = "Latin",
    ///         PropertyBag = "",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredata/v20190724preview:SqlServer")]
    public partial class SqlServer : global::Pulumi.CustomResource
    {
        ...
        public SqlServer(string name, SqlServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20190724preview:SqlServer", name, args ?? new SqlServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20190724preview:SqlServer", name, null, MakeResourceOptions(options, id))
        {
        }
