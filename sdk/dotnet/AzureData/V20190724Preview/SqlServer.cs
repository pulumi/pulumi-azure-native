...
namespace Pulumi.AzureRM.AzureData.V20190724Preview
{
    ...
    public partial class SqlServer : Pulumi.CustomResource
    {
        ...
        public SqlServer(string name, SqlServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/v20190724preview:SqlServer", name, args ?? new SqlServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/v20190724preview:SqlServer", name, null, MakeResourceOptions(options, id))
        {
        }
