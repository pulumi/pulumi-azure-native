...
namespace Pulumi.AzureNextGen.AzureData.V20190724Preview
{
    ...
    /// A SQL server.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:azuredata/v20190724preview:SqlServer")]
    public partial class SqlServer : Pulumi.CustomResource
    {
        ...
        public SqlServer(string name, SqlServerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:azuredata/v20190724preview:SqlServer", name, args ?? new SqlServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:azuredata/v20190724preview:SqlServer", name, null, MakeResourceOptions(options, id))
        {
        }
