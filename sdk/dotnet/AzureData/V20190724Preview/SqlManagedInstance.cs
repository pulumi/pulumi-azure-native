...
namespace Pulumi.AzureNative.AzureData.V20190724Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredata/v20190724preview:SqlManagedInstance")]
    public partial class SqlManagedInstance : Pulumi.CustomResource
    {
        ...
        public SqlManagedInstance(string name, SqlManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20190724preview:SqlManagedInstance", name, args ?? new SqlManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20190724preview:SqlManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
