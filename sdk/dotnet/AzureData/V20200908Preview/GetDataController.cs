...
namespace Pulumi.AzureNative.AzureData.V20200908Preview
{
    public static class GetDataController
    {
        ...
        public static Task<GetDataControllerResult> InvokeAsync(GetDataControllerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataControllerResult>("azure-native:azuredata/v20200908preview:getDataController", args ?? new GetDataControllerArgs(), options.WithVersion());
    }
