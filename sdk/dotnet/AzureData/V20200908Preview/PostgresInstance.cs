...
namespace Pulumi.AzureNative.AzureData.V20200908Preview
{
    ...
    /// A Postgres Instance.
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredata/v20200908preview:PostgresInstance")]
    public partial class PostgresInstance : Pulumi.CustomResource
    {
        ...
        public PostgresInstance(string name, PostgresInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20200908preview:PostgresInstance", name, args ?? new PostgresInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostgresInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20200908preview:PostgresInstance", name, null, MakeResourceOptions(options, id))
        {
        }
