...
namespace Pulumi.AzureNative.AzureData.V20200908Preview
{
    ...
    /// A SqlServerInstance.
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredata/v20200908preview:SqlServerInstance")]
    public partial class SqlServerInstance : Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20200908preview:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20200908preview:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
