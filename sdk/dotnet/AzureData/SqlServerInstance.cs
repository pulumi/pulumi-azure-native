...
namespace Pulumi.AzureNextGen.AzureData
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:azuredata:SqlServerInstance")]
    public partial class SqlServerInstance : Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:azuredata:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:azuredata:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
