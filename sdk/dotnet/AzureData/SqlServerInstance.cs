...
namespace Pulumi.AzureNative.AzureData
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azuredata:SqlServerInstance")]
    public partial class SqlServerInstance : Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredata:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredata:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:azuredata/v20190724preview:SqlServerInstance"},
                    new Pulumi.Alias { Type = "azure-nextgen:azuredata/v20190724preview:SqlServerInstance"},
