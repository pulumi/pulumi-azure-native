...
namespace Pulumi.AzureNative.AzureData.V20170301Preview
{
    public static class GetSqlServerRegistration
    {
        ...
        public static Output<GetSqlServerRegistrationResult> Invoke(GetSqlServerRegistrationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSqlServerRegistrationResult>("azure-native:azuredata/v20170301preview:getSqlServerRegistration", args ?? new GetSqlServerRegistrationInvokeArgs(), options.WithVersion());
    }
