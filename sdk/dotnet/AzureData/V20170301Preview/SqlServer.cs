...
namespace Pulumi.AzureNative.AzureData.V20170301Preview
{
    ...
    public partial class SqlServer : Pulumi.CustomResource
    {
        ...
        public SqlServer(string name, SqlServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20170301preview:SqlServer", name, args ?? new SqlServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azuredata/v20170301preview:SqlServer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:azuredata:SqlServer"},
