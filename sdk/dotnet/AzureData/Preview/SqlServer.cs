...
namespace Pulumi.AzureRM.AzureData.Preview
{
    ...
    public partial class SqlServer : Pulumi.CustomResource
    {
        ...
        public SqlServer(string name, SqlServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/preview:SqlServer", name, args ?? new SqlServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/preview:SqlServer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:azuredata/v20170301preview:SqlServer"},
