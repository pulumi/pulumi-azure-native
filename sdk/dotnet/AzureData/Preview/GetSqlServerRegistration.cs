...
namespace Pulumi.AzureRM.AzureData.Preview
{
    public static class GetSqlServerRegistration
    {
        public static Task<GetSqlServerRegistrationResult> InvokeAsync(GetSqlServerRegistrationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerRegistrationResult>("azurerm:azuredata/preview:getSqlServerRegistration", args ?? new GetSqlServerRegistrationArgs(), options.WithVersion());
    }
