...
namespace Pulumi.AzureRM.AzureData.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dataController = new AzureRM.AzureData.Latest.DataController("dataController", new AzureRM.AzureData.Latest.DataControllerArgs
    ///         {
    ///             DataControllerName = "testdataController",
    ///             Location = "northeurope",
    ///             OnPremiseProperty = new AzureRM.AzureData.Latest.Inputs.OnPremisePropertyArgs
    ///             {
    ...
    public partial class DataController : Pulumi.CustomResource
    {
        ...
        public DataController(string name, DataControllerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:DataController", name, args ?? new DataControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:DataController", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:azuredata/v20190724preview:DataController"},
                },
            };
