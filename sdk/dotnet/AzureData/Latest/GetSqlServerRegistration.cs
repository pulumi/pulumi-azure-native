...
namespace Pulumi.AzureRM.AzureData.Latest
{
    public static class GetSqlServerRegistration
    {
        public static Task<GetSqlServerRegistrationResult> InvokeAsync(GetSqlServerRegistrationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerRegistrationResult>("azurerm:azuredata/latest:getSqlServerRegistration", args ?? new GetSqlServerRegistrationArgs(), options.WithVersion());
    }
