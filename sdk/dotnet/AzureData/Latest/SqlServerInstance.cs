...
namespace Pulumi.AzureRM.AzureData.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlServerInstance = new AzureRM.AzureData.Latest.SqlServerInstance("sqlServerInstance", new AzureRM.AzureData.Latest.SqlServerInstanceArgs
    ///         {
    ...
    public partial class SqlServerInstance : Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:azuredata/v20190724preview:SqlServerInstance"},
                },
            };
