...
namespace Pulumi.AzureRM.AzureData.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlManagedInstance = new AzureRM.AzureData.Latest.SqlManagedInstance("sqlManagedInstance", new AzureRM.AzureData.Latest.SqlManagedInstanceArgs
    ///         {
    ///             Admin = "Admin user",
    ...
    public partial class SqlManagedInstance : Pulumi.CustomResource
    {
        ...
        public SqlManagedInstance(string name, SqlManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:SqlManagedInstance", name, args ?? new SqlManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:SqlManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:azuredata/v20190724preview:SqlManagedInstance"},
                },
            };
