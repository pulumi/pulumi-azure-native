...
namespace Pulumi.AzureRM.AzureData.Latest
{
    public static class GetSqlManagedInstance
    {
        public static Task<GetSqlManagedInstanceResult> InvokeAsync(GetSqlManagedInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlManagedInstanceResult>("azurerm:azuredata/latest:getSqlManagedInstance", args ?? new GetSqlManagedInstanceArgs(), options.WithVersion());
    }
