...
namespace Pulumi.AzureRM.AzureData.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlServer = new AzureRM.AzureData.Latest.SqlServer("sqlServer", new AzureRM.AzureData.Latest.SqlServerArgs
    ///         {
    ///             Cores = 8,
    ///             Edition = "Latin",
    ///             PropertyBag = "",
    ...
    public partial class SqlServer : Pulumi.CustomResource
    {
        ...
        public SqlServer(string name, SqlServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:SqlServer", name, args ?? new SqlServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:SqlServer", name, null, MakeResourceOptions(options, id))
        {
        }
