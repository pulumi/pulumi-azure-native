...
namespace Pulumi.AzureRM.AzureData.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var postgresInstance = new AzureRM.AzureData.Latest.PostgresInstance("postgresInstance", new AzureRM.AzureData.Latest.PostgresInstanceArgs
    ///         {
    ...
    public partial class PostgresInstance : Pulumi.CustomResource
    {
        ...
        public PostgresInstance(string name, PostgresInstanceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:PostgresInstance", name, args ?? new PostgresInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostgresInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:PostgresInstance", name, null, MakeResourceOptions(options, id))
        {
        }
