...
namespace Pulumi.AzureRM.AzureData.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlServerRegistration = new AzureRM.AzureData.Latest.SqlServerRegistration("sqlServerRegistration", new AzureRM.AzureData.Latest.SqlServerRegistrationArgs
    ///         {
    ...
    public partial class SqlServerRegistration : Pulumi.CustomResource
    {
        ...
        public SqlServerRegistration(string name, SqlServerRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:SqlServerRegistration", name, args ?? new SqlServerRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azuredata/latest:SqlServerRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
