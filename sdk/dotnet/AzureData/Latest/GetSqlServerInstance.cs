...
namespace Pulumi.AzureRM.AzureData.Latest
{
    public static class GetSqlServerInstance
    {
        public static Task<GetSqlServerInstanceResult> InvokeAsync(GetSqlServerInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerInstanceResult>("azurerm:azuredata/latest:getSqlServerInstance", args ?? new GetSqlServerInstanceArgs(), options.WithVersion());
    }
