...
namespace Pulumi.AzureNative.EventHub.V20150801
{
    public static class ListEventHubKeys
    {
        ...
        public static Output<ListEventHubKeysResult> Invoke(ListEventHubKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListEventHubKeysResult>("azure-native:eventhub/v20150801:listEventHubKeys", args ?? new ListEventHubKeysInvokeArgs(), options.WithVersion());
    }
