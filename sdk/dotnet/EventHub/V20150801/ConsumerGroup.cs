...
namespace Pulumi.AzureRM.EventHub.V20150801
{
    ...
    public partial class ConsumerGroup : Pulumi.CustomResource
    {
        ...
        public ConsumerGroup(string name, ConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/v20150801:ConsumerGroup", name, args ?? new ConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/v20150801:ConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
