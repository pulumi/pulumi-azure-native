...
namespace Pulumi.AzureNextGen.EventHub.V20150801
{
    ...
    public partial class NamespaceAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public NamespaceAuthorizationRule(string name, NamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub/v20150801:NamespaceAuthorizationRule", name, args ?? new NamespaceAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub/v20150801:NamespaceAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceAuthorizationRuleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.AzureNextGen.EventHub.V20150801.AccessRights>? _rights;

        /// <summary>
        /// The rights associated with the rule.
        /// </summary>
        public InputList<Pulumi.AzureNextGen.EventHub.V20150801.AccessRights> Rights
        {
            get => _rights ?? (_rights = new InputList<Pulumi.AzureNextGen.EventHub.V20150801.AccessRights>());
            set => _rights = value;
        }
