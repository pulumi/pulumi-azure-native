...
namespace Pulumi.AzureNextGen.EventHub
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventhub:EventHubAuthorizationRule")]
    public partial class EventHubAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public EventHubAuthorizationRule(string name, EventHubAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub:EventHubAuthorizationRule", name, args ?? new EventHubAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHubAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub:EventHubAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubAuthorizationRuleArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNextGen.EventHub.AccessRights>>? _rights;

        /// <summary>
        /// The rights associated with the rule.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNextGen.EventHub.AccessRights>> Rights
        {
            get => _rights ?? (_rights = new InputList<Union<string, Pulumi.AzureNextGen.EventHub.AccessRights>>());
            set => _rights = value;
        }
