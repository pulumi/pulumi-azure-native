...
namespace Pulumi.AzureRM.EventHub
{
    public static class ListNamespaceAuthorizationRuleKeys
    {
        public static Task<ListNamespaceAuthorizationRuleKeysResult> InvokeAsync(ListNamespaceAuthorizationRuleKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceAuthorizationRuleKeysResult>("azurerm:eventhub:listNamespaceAuthorizationRuleKeys", args ?? new ListNamespaceAuthorizationRuleKeysArgs(), options.WithVersion());
    }
