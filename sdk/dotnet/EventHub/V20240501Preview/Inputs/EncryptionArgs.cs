...
namespace Pulumi.AzureNative.EventHub.V20240501Preview.Inputs
{
    ...
    public sealed class EncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("keySource")]
        public Input<Pulumi.AzureNative.EventHub.V20240501Preview.KeySource>? KeySource { get; set; }
        ...
        {
            KeySource = Pulumi.AzureNative.EventHub.V20240501Preview.KeySource.Microsoft_KeyVault;
        }
