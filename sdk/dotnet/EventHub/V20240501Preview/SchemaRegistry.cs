...
namespace Pulumi.AzureNative.EventHub.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20240501preview:SchemaRegistry")]
    public partial class SchemaRegistry : global::Pulumi.CustomResource
    {
        ...
        public SchemaRegistry(string name, SchemaRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240501preview:SchemaRegistry", name, args ?? new SchemaRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240501preview:SchemaRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SchemaRegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20240501Preview.SchemaCompatibility>? SchemaCompatibility { get; set; }
        ...
        [Input("schemaType")]
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20240501Preview.SchemaType>? SchemaType { get; set; }
