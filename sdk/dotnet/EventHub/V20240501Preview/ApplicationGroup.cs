...
namespace Pulumi.AzureNative.EventHub.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20240501preview:ApplicationGroup")]
    public partial class ApplicationGroup : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240501preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240501preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
