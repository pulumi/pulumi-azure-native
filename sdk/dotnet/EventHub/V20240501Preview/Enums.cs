...
namespace Pulumi.AzureNative.EventHub.V20240501Preview
{
    ...
    public readonly struct SchemaType : IEquatable<SchemaType>
    {
        ...
        public static SchemaType ProtoBuf { get; } = new SchemaType("ProtoBuf");
    ...
    public readonly struct TimestampType : IEquatable<TimestampType>
    {
        ...
        private TimestampType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        public static explicit operator string(TimestampType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is TimestampType other && Equals(other);
        public bool Equals(TimestampType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
