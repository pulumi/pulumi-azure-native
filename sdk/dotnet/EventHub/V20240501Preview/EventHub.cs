...
namespace Pulumi.AzureNative.EventHub.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20240501preview:EventHub")]
    public partial class EventHub : global::Pulumi.CustomResource
    {
        ...
        public EventHub(string name, EventHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240501preview:EventHub", name, args ?? new EventHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240501preview:EventHub", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.EventHub.V20240501Preview.EntityStatus>? Status { get; set; }
