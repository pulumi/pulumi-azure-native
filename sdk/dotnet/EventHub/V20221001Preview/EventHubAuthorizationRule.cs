...
namespace Pulumi.AzureNative.EventHub.V20221001Preview
{
    ...
    public partial class EventHubAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public EventHubAuthorizationRule(string name, EventHubAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:EventHubAuthorizationRule", name, args ?? new EventHubAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHubAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:EventHubAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
