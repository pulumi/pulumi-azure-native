...
namespace Pulumi.AzureNative.EventHub.V20221001Preview
{
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateEndpointConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20221001Preview.EndPointProvisioningState>? ProvisioningState { get; set; }
