...
namespace Pulumi.AzureNative.EventHub.V20221001Preview
{
    ...
    /// {
    ///     var schemaRegistry = new AzureNative.EventHub.V20221001Preview.SchemaRegistry("schemaRegistry", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20221001preview:SchemaRegistry")]
    public partial class SchemaRegistry : global::Pulumi.CustomResource
    {
        ...
        public SchemaRegistry(string name, SchemaRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:SchemaRegistry", name, args ?? new SchemaRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:SchemaRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SchemaRegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20221001Preview.SchemaCompatibility>? SchemaCompatibility { get; set; }
        ...
        [Input("schemaType")]
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20221001Preview.SchemaType>? SchemaType { get; set; }
