...
namespace Pulumi.AzureNative.EventHub.V20221001Preview
{
    ...
    /// {
    ///     var cluster = new AzureNative.EventHub.V20221001Preview.Cluster("cluster", new()
    ///     {
    ///         ClusterName = "testCluster",
    ///         Location = "South Central US",
    ///         ResourceGroupName = "myResourceGroup",
    ///         Sku = new AzureNative.EventHub.V20221001Preview.Inputs.ClusterSkuArgs
    ///         {
    ///             Capacity = 1,
    ///             Name = "Dedicated",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20221001preview:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
