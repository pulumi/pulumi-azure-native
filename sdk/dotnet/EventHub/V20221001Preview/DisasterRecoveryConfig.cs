...
namespace Pulumi.AzureNative.EventHub.V20221001Preview
{
    ...
    /// {
    ///     var disasterRecoveryConfig = new AzureNative.EventHub.V20221001Preview.DisasterRecoveryConfig("disasterRecoveryConfig", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20221001preview:DisasterRecoveryConfig")]
    public partial class DisasterRecoveryConfig : global::Pulumi.CustomResource
    {
        ...
        public DisasterRecoveryConfig(string name, DisasterRecoveryConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:DisasterRecoveryConfig", name, args ?? new DisasterRecoveryConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DisasterRecoveryConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:DisasterRecoveryConfig", name, null, MakeResourceOptions(options, id))
        {
        }
