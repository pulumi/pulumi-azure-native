...
namespace Pulumi.AzureNative.EventHub.V20221001Preview
{
    ...
    /// {
    ///     var consumerGroup = new AzureNative.EventHub.V20221001Preview.ConsumerGroup("consumerGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20221001preview:ConsumerGroup")]
    public partial class ConsumerGroup : global::Pulumi.CustomResource
    {
        ...
        public ConsumerGroup(string name, ConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:ConsumerGroup", name, args ?? new ConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20221001preview:ConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
