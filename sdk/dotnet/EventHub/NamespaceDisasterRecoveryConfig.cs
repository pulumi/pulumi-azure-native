...
namespace Pulumi.AzureRM.EventHub
{
    ...
    public partial class NamespaceDisasterRecoveryConfig : Pulumi.CustomResource
    {
        ...
        public NamespaceDisasterRecoveryConfig(string name, NamespaceDisasterRecoveryConfigArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventhub:NamespaceDisasterRecoveryConfig", name, args ?? new NamespaceDisasterRecoveryConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceDisasterRecoveryConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventhub:NamespaceDisasterRecoveryConfig", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NamespaceDisasterRecoveryConfig Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new NamespaceDisasterRecoveryConfig(name, id, options);
        }
    }
