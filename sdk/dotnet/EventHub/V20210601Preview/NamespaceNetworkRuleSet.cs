...
namespace Pulumi.AzureNative.EventHub.V20210601Preview
{
    ...
    public partial class NamespaceNetworkRuleSet : global::Pulumi.CustomResource
    {
        ...
        public NamespaceNetworkRuleSet(string name, NamespaceNetworkRuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20210601preview:NamespaceNetworkRuleSet", name, args ?? new NamespaceNetworkRuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceNetworkRuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20210601preview:NamespaceNetworkRuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceNetworkRuleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("defaultAction")]
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20210601Preview.DefaultAction>? DefaultAction { get; set; }
