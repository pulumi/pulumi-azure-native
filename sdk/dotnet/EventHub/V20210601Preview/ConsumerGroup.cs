...
namespace Pulumi.AzureNative.EventHub.V20210601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20210601preview:ConsumerGroup")]
    public partial class ConsumerGroup : Pulumi.CustomResource
    {
        ...
        public ConsumerGroup(string name, ConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20210601preview:ConsumerGroup", name, args ?? new ConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20210601preview:ConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
