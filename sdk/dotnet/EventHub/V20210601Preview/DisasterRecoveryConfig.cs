...
namespace Pulumi.AzureNative.EventHub.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:eventhub/v20210601preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:eventhub/v20210601preview:DisasterRecoveryConfig")]
    public partial class DisasterRecoveryConfig : global::Pulumi.CustomResource
    {
        ...
        public DisasterRecoveryConfig(string name, DisasterRecoveryConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20210601preview:DisasterRecoveryConfig", name, args ?? new DisasterRecoveryConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DisasterRecoveryConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20210601preview:DisasterRecoveryConfig", name, null, MakeResourceOptions(options, id))
        {
        }
