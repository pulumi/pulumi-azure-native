...
namespace Pulumi.AzureNative.EventHub.V20210601Preview.Inputs
{
    ...
    public sealed class EncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("keySource")]
        public Input<Pulumi.AzureNative.EventHub.V20210601Preview.KeySource>? KeySource { get; set; }
        ...
        {
            KeySource = Pulumi.AzureNative.EventHub.V20210601Preview.KeySource.Microsoft_KeyVault;
        }
