...
{
    [Obsolete(@"azure-native:eventhub/v20210601preview:EventHub is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.")]
    public static class GetEventHub
    {
        ...
        public static Task<GetEventHubResult> InvokeAsync(GetEventHubArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEventHubResult>("azure-native:eventhub/v20210601preview:getEventHub", args ?? new GetEventHubArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an Event Hubs description for the specified Event Hub.
        /// </summary>
        public static Output<GetEventHubResult> Invoke(GetEventHubInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEventHubResult>("azure-native:eventhub/v20210601preview:getEventHub", args ?? new GetEventHubInvokeArgs(), options.WithDefaults());
    }
