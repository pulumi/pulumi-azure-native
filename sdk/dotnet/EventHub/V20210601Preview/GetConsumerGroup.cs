...
namespace Pulumi.AzureNative.EventHub.V20210601Preview
{
    public static class GetConsumerGroup
    {
        ...
        public static Task<GetConsumerGroupResult> InvokeAsync(GetConsumerGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConsumerGroupResult>("azure-native:eventhub/v20210601preview:getConsumerGroup", args ?? new GetConsumerGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Single item in List or Get Consumer group operation
        /// </summary>
        public static Output<GetConsumerGroupResult> Invoke(GetConsumerGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConsumerGroupResult>("azure-native:eventhub/v20210601preview:getConsumerGroup", args ?? new GetConsumerGroupInvokeArgs(), options.WithDefaults());
    }
