...
namespace Pulumi.AzureNative.EventHub.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:eventhub:Namespace'.")]
    [AzureNativeResourceType("azure-native:eventhub/latest:Namespace")]
    public partial class Namespace : Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/latest:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/latest:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
