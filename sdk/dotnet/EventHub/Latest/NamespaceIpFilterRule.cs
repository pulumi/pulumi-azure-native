...
namespace Pulumi.AzureRM.EventHub.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var namespaceIpFilterRule = new AzureRM.EventHub.Latest.NamespaceIpFilterRule("namespaceIpFilterRule", new AzureRM.EventHub.Latest.NamespaceIpFilterRuleArgs
    ///         {
    ///             Action = "Accept",
    ...
    public partial class NamespaceIpFilterRule : Pulumi.CustomResource
    {
        ...
        public NamespaceIpFilterRule(string name, NamespaceIpFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/latest:NamespaceIpFilterRule", name, args ?? new NamespaceIpFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceIpFilterRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/latest:NamespaceIpFilterRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:eventhub/v20180101preview:NamespaceIpFilterRule"},
                },
            };
