...
namespace Pulumi.AzureRM.EventHub.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var namespaceVirtualNetworkRule = new AzureRM.EventHub.Latest.NamespaceVirtualNetworkRule("namespaceVirtualNetworkRule", new AzureRM.EventHub.Latest.NamespaceVirtualNetworkRuleArgs
    ///         {
    ...
    public partial class NamespaceVirtualNetworkRule : Pulumi.CustomResource
    {
        ...
        public NamespaceVirtualNetworkRule(string name, NamespaceVirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/latest:NamespaceVirtualNetworkRule", name, args ?? new NamespaceVirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceVirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/latest:NamespaceVirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
