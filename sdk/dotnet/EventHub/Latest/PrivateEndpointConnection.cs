...
namespace Pulumi.AzureRM.EventHub.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.EventHub.Latest.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.EventHub.Latest.PrivateEndpointConnectionArgs
    ///         {
    ///             NamespaceName = "sdk-Namespace-2924",
    ///             PrivateEndpoint = new AzureRM.EventHub.Latest.Inputs.PrivateEndpointArgs
    ///             {
    ...
    ///             PrivateLinkServiceConnectionState = new AzureRM.EventHub.Latest.Inputs.ConnectionStateArgs
    ///             {
    ///                 Description = "testing",
    ///                 Status = "Rejected",
    ///             },
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/latest:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/latest:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:eventhub/v20180101preview:PrivateEndpointConnection"},
                },
            };
