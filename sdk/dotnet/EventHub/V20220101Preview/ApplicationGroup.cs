...
namespace Pulumi.AzureNative.EventHub.V20220101Preview
{
    ...
    /// {
    ///     var applicationGroup = new AzureNative.EventHub.V20220101Preview.ApplicationGroup("applicationGroup", new()
    ///     {
    ...
    public partial class ApplicationGroup : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20220101preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20220101preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
