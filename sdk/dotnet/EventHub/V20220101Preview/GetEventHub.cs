...
namespace Pulumi.AzureNative.EventHub.V20220101Preview
{
    public static class GetEventHub
    {
        ...
        public static Task<GetEventHubResult> InvokeAsync(GetEventHubArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEventHubResult>("azure-native:eventhub/v20220101preview:getEventHub", args ?? new GetEventHubArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an Event Hubs description for the specified Event Hub.
        /// </summary>
        public static Output<GetEventHubResult> Invoke(GetEventHubInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEventHubResult>("azure-native:eventhub/v20220101preview:getEventHub", args ?? new GetEventHubInvokeArgs(), options.WithDefaults());
