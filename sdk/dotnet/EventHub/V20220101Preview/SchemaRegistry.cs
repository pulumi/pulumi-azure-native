...
namespace Pulumi.AzureNative.EventHub.V20220101Preview
{
    ...
    public partial class SchemaRegistry : Pulumi.CustomResource
    {
        ...
        public SchemaRegistry(string name, SchemaRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20220101preview:SchemaRegistry", name, args ?? new SchemaRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20220101preview:SchemaRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:eventhub:SchemaRegistry"},
    ...
    public sealed class SchemaRegistryArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20220101Preview.SchemaCompatibility>? SchemaCompatibility { get; set; }
        ...
        [Input("schemaType")]
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20220101Preview.SchemaType>? SchemaType { get; set; }
