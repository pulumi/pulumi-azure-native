...
namespace Pulumi.AzureNative.EventHub.V20220101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20220101preview:EventHubAuthorizationRule")]
    public partial class EventHubAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public EventHubAuthorizationRule(string name, EventHubAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20220101preview:EventHubAuthorizationRule", name, args ?? new EventHubAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHubAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20220101preview:EventHubAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
