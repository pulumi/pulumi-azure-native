...
namespace Pulumi.AzureRM.EventHub
{
    ...
    public partial class Namespace : Pulumi.CustomResource
    {
        ...
        private Namespace(string name, Input<string> id, NamespaceState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:eventhub:Namespace", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EHNamespaceResponsePropertiesGetArgs> Properties { get; set; } = null!;
