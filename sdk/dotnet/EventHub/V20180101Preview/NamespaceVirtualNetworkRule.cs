...
namespace Pulumi.AzureNative.EventHub.V20180101Preview
{
    ...
    /// {
    ///     var namespaceVirtualNetworkRule = new AzureNative.EventHub.V20180101Preview.NamespaceVirtualNetworkRule("namespaceVirtualNetworkRule", new()
    ///     {
    ...
    public partial class NamespaceVirtualNetworkRule : global::Pulumi.CustomResource
    {
        ...
        public NamespaceVirtualNetworkRule(string name, NamespaceVirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20180101preview:NamespaceVirtualNetworkRule", name, args ?? new NamespaceVirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceVirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20180101preview:NamespaceVirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
