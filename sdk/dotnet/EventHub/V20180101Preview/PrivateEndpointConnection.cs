...
namespace Pulumi.AzureNative.EventHub.V20180101Preview
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.EventHub.V20180101Preview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         NamespaceName = "sdk-Namespace-2924",
    ///         PrivateEndpoint = new AzureNative.EventHub.V20180101Preview.Inputs.PrivateEndpointArgs
    ///         {
    ...
    ///         PrivateLinkServiceConnectionState = new AzureNative.EventHub.V20180101Preview.Inputs.ConnectionStateArgs
    ///         {
    ///             Description = "testing",
    ///             Status = "Rejected",
    ///         },
