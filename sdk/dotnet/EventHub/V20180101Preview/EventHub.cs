...
namespace Pulumi.AzureNextGen.EventHub.V20180101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventhub/v20180101preview:EventHub")]
    public partial class EventHub : Pulumi.CustomResource
    {
        ...
        public EventHub(string name, EventHubArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub/v20180101preview:EventHub", name, args ?? new EventHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub/v20180101preview:EventHub", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNextGen.EventHub.V20180101Preview.EntityStatus>? Status { get; set; }
