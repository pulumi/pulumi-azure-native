...
namespace Pulumi.AzureNative.EventHub.V20180101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:eventhub/v20180101preview:EventHub is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:eventhub/v20180101preview:EventHub")]
    public partial class EventHub : global::Pulumi.CustomResource
    {
        ...
        public EventHub(string name, EventHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20180101preview:EventHub", name, args ?? new EventHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20180101preview:EventHub", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.EventHub.V20180101Preview.EntityStatus>? Status { get; set; }
