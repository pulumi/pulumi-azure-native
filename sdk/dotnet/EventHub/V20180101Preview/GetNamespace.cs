...
namespace Pulumi.AzureNative.EventHub.V20180101Preview
{
    public static class GetNamespace
    {
        ...
        public static Task<GetNamespaceResult> InvokeAsync(GetNamespaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNamespaceResult>("azure-native:eventhub/v20180101preview:getNamespace", args ?? new GetNamespaceArgs(), options.WithVersion());

        /// <summary>
        /// Single Namespace item in List or Get Operation
        /// </summary>
        public static Output<GetNamespaceResult> Invoke(GetNamespaceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNamespaceResult>("azure-native:eventhub/v20180101preview:getNamespace", args ?? new GetNamespaceInvokeArgs(), options.WithVersion());
    }
