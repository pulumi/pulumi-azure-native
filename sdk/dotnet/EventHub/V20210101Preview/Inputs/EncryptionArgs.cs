...
namespace Pulumi.AzureNative.EventHub.V20210101Preview.Inputs
{
    ...
    public sealed class EncryptionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("keySource")]
        public Input<Pulumi.AzureNative.EventHub.V20210101Preview.KeySource>? KeySource { get; set; }
        ...
        {
            KeySource = Pulumi.AzureNative.EventHub.V20210101Preview.KeySource.Microsoft_KeyVault;
        }
    }
}
