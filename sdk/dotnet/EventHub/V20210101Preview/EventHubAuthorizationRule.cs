...
namespace Pulumi.AzureNative.EventHub.V20210101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:eventhub/v20210101preview:EventHubAuthorizationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHubAuthorizationRule to guarantee forwards compatibility.")]
    ...
    public partial class EventHubAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public EventHubAuthorizationRule(string name, EventHubAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20210101preview:EventHubAuthorizationRule", name, args ?? new EventHubAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHubAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20210101preview:EventHubAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubAuthorizationRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.EventHub.V20210101Preview.AccessRights>>? _rights;

        /// <summary>
        /// The rights associated with the rule.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.EventHub.V20210101Preview.AccessRights>> Rights
        {
            get => _rights ?? (_rights = new InputList<Union<string, Pulumi.AzureNative.EventHub.V20210101Preview.AccessRights>>());
            set => _rights = value;
        }
