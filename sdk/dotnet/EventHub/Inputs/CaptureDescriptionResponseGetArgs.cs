...
namespace Pulumi.AzureRM.EventHub.Inputs
{
    ...
    /// </summary>
    public sealed class CaptureDescriptionResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Properties of Destination where capture will be stored. (Storage Account, Blob Names)
        /// </summary>
        [Input("destination")]
        public Input<Inputs.DestinationResponseGetArgs>? Destination { get; set; }
        ...
        public CaptureDescriptionResponseGetArgs()
        {
        }
    }
}
