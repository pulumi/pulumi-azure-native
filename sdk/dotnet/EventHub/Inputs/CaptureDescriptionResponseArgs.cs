...
namespace Pulumi.AzureRM.EventHub.Inputs
{
    ...
    /// </summary>
    public sealed class CaptureDescriptionResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Properties of Destination where capture will be stored. (Storage Account, Blob Names)
        /// </summary>
        [Input("destination")]
        public Input<Inputs.DestinationResponseArgs>? Destination { get; set; }
        ...
        public CaptureDescriptionResponseArgs()
        {
        }
    }
}
