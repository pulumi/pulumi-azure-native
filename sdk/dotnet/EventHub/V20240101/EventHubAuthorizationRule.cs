...
namespace Pulumi.AzureNative.EventHub.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20240101:EventHubAuthorizationRule")]
    public partial class EventHubAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public EventHubAuthorizationRule(string name, EventHubAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240101:EventHubAuthorizationRule", name, args ?? new EventHubAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHubAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240101:EventHubAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubAuthorizationRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.EventHub.V20240101.AccessRights>>? _rights;

        /// <summary>
        /// The rights associated with the rule.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.EventHub.V20240101.AccessRights>> Rights
        {
            get => _rights ?? (_rights = new InputList<Union<string, Pulumi.AzureNative.EventHub.V20240101.AccessRights>>());
            set => _rights = value;
        }
