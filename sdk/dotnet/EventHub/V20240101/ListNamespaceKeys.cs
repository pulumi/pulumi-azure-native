...
namespace Pulumi.AzureNative.EventHub.V20240101
{
    public static class ListNamespaceKeys
    {
        ...
        public static Task<ListNamespaceKeysResult> InvokeAsync(ListNamespaceKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceKeysResult>("azure-native:eventhub/v20240101:listNamespaceKeys", args ?? new ListNamespaceKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the primary and secondary connection strings for the Namespace.
        /// </summary>
        public static Output<ListNamespaceKeysResult> Invoke(ListNamespaceKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListNamespaceKeysResult>("azure-native:eventhub/v20240101:listNamespaceKeys", args ?? new ListNamespaceKeysInvokeArgs(), options.WithDefaults());
