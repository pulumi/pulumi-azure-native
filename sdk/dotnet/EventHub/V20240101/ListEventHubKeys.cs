...
namespace Pulumi.AzureNative.EventHub.V20240101
{
    public static class ListEventHubKeys
    {
        ...
        public static Task<ListEventHubKeysResult> InvokeAsync(ListEventHubKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListEventHubKeysResult>("azure-native:eventhub/v20240101:listEventHubKeys", args ?? new ListEventHubKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the ACS and SAS connection strings for the Event Hub.
        /// </summary>
        public static Output<ListEventHubKeysResult> Invoke(ListEventHubKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListEventHubKeysResult>("azure-native:eventhub/v20240101:listEventHubKeys", args ?? new ListEventHubKeysInvokeArgs(), options.WithDefaults());
    }
