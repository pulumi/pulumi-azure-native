...
namespace Pulumi.AzureNative.EventHub.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20240101:NamespaceNetworkRuleSet")]
    public partial class NamespaceNetworkRuleSet : global::Pulumi.CustomResource
    {
        ...
        public NamespaceNetworkRuleSet(string name, NamespaceNetworkRuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240101:NamespaceNetworkRuleSet", name, args ?? new NamespaceNetworkRuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceNetworkRuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240101:NamespaceNetworkRuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceNetworkRuleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("defaultAction")]
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20240101.DefaultAction>? DefaultAction { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20240101.PublicNetworkAccessFlag>? PublicNetworkAccess { get; set; }
