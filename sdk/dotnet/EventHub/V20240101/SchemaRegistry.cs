...
namespace Pulumi.AzureNative.EventHub.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20240101:SchemaRegistry")]
    public partial class SchemaRegistry : global::Pulumi.CustomResource
    {
        ...
        public SchemaRegistry(string name, SchemaRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240101:SchemaRegistry", name, args ?? new SchemaRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20240101:SchemaRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SchemaRegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20240101.SchemaCompatibility>? SchemaCompatibility { get; set; }
        ...
        [Input("schemaType")]
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20240101.SchemaType>? SchemaType { get; set; }
