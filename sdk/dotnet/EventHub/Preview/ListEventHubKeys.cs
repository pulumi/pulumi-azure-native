...
namespace Pulumi.AzureRM.EventHub.Preview
{
    public static class ListEventHubKeys
    {
        public static Task<ListEventHubKeysResult> InvokeAsync(ListEventHubKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListEventHubKeysResult>("azurerm:eventhub/preview:listEventHubKeys", args ?? new ListEventHubKeysArgs(), options.WithVersion());
    }
