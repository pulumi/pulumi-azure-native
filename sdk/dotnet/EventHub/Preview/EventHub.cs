...
namespace Pulumi.AzureRM.EventHub.Preview
{
    ...
    public partial class EventHub : Pulumi.CustomResource
    {
        ...
        public EventHub(string name, EventHubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/preview:EventHub", name, args ?? new EventHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/preview:EventHub", name, null, MakeResourceOptions(options, id))
        {
        }
