...
namespace Pulumi.AzureRM.EventHub.Preview
{
    public static class GetConsumerGroup
    {
        public static Task<GetConsumerGroupResult> InvokeAsync(GetConsumerGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConsumerGroupResult>("azurerm:eventhub/preview:getConsumerGroup", args ?? new GetConsumerGroupArgs(), options.WithVersion());
    }
