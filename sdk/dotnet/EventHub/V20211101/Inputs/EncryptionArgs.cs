...
namespace Pulumi.AzureNative.EventHub.V20211101.Inputs
{
    ...
    public sealed class EncryptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("keySource")]
        public Input<Pulumi.AzureNative.EventHub.V20211101.KeySource>? KeySource { get; set; }
        ...
        {
            KeySource = Pulumi.AzureNative.EventHub.V20211101.KeySource.Microsoft_KeyVault;
        }
