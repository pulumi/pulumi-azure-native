...
namespace Pulumi.AzureNative.EventHub.V20211101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:eventhub/v20211101:ConsumerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:ConsumerGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:eventhub/v20211101:ConsumerGroup")]
    public partial class ConsumerGroup : global::Pulumi.CustomResource
    {
        ...
        public ConsumerGroup(string name, ConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20211101:ConsumerGroup", name, args ?? new ConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20211101:ConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
