...
namespace Pulumi.AzureNative.EventHub.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20211101:EventHub")]
    public partial class EventHub : Pulumi.CustomResource
    {
        ...
        public EventHub(string name, EventHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20211101:EventHub", name, args ?? new EventHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20211101:EventHub", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.AzureNative.EventHub.V20211101.EntityStatus>? Status { get; set; }
