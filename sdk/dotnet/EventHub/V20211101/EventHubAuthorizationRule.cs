...
namespace Pulumi.AzureNative.EventHub.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20211101:EventHubAuthorizationRule")]
    public partial class EventHubAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public EventHubAuthorizationRule(string name, EventHubAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20211101:EventHubAuthorizationRule", name, args ?? new EventHubAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHubAuthorizationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20211101:EventHubAuthorizationRule", name, null, MakeResourceOptions(options, id))
        {
        }
