...
namespace Pulumi.AzureNative.EventHub.V20170401
{
    ...
    /// {
    ///     var eventHubAuthorizationRule = new AzureNative.EventHub.V20170401.EventHubAuthorizationRule("eventHubAuthorizationRule", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:eventhub/v20170401:EventHubAuthorizationRule sdk-Authrules-2513 /subscriptions/5f750a97-50d9-4e36-8081-c9ee4c0210d4/resourceGroups/ArunMonocle/providers/Microsoft.EventHub/namespaces/sdk-Namespace-960/eventhubs/sdk-EventHub-532/authorizationRules/sdk-Authrules-2513 
    /// ```
    /// </summary>
