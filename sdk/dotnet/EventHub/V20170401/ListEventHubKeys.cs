...
namespace Pulumi.AzureNative.EventHub.V20170401
{
    public static class ListEventHubKeys
    {
        ...
        public static Task<ListEventHubKeysResult> InvokeAsync(ListEventHubKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListEventHubKeysResult>("azure-native:eventhub/v20170401:listEventHubKeys", args ?? new ListEventHubKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Namespace/EventHub Connection String
        /// </summary>
        public static Output<ListEventHubKeysResult> Invoke(ListEventHubKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListEventHubKeysResult>("azure-native:eventhub/v20170401:listEventHubKeys", args ?? new ListEventHubKeysInvokeArgs(), options.WithDefaults());
    }
