...
namespace Pulumi.AzureNative.EventHub.V20170401
{
    ...
    /// {
    ///     var consumerGroup = new AzureNative.EventHub.V20170401.ConsumerGroup("consumerGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20170401:ConsumerGroup")]
    public partial class ConsumerGroup : global::Pulumi.CustomResource
    {
        ...
        public ConsumerGroup(string name, ConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20170401:ConsumerGroup", name, args ?? new ConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20170401:ConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
