...
namespace Pulumi.AzureRM.EventHub.V20170401
{
    ...
    public partial class ConsumerGroup : Pulumi.CustomResource
    {
        ...
        public ConsumerGroup(string name, ConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/v20170401:ConsumerGroup", name, args ?? new ConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventhub/v20170401:ConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
