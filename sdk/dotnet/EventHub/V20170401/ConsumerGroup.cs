...
namespace Pulumi.AzureNextGen.EventHub.V20170401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventhub/v20170401:ConsumerGroup")]
    public partial class ConsumerGroup : Pulumi.CustomResource
    {
        ...
        public ConsumerGroup(string name, ConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub/v20170401:ConsumerGroup", name, args ?? new ConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub/v20170401:ConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
