...
namespace Pulumi.AzureNextGen.EventHub
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventhub:NamespaceNetworkRuleSet")]
    public partial class NamespaceNetworkRuleSet : Pulumi.CustomResource
    {
        ...
        public NamespaceNetworkRuleSet(string name, NamespaceNetworkRuleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub:NamespaceNetworkRuleSet", name, args ?? new NamespaceNetworkRuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceNetworkRuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub:NamespaceNetworkRuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceNetworkRuleSetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("defaultAction")]
        public InputUnion<string, Pulumi.AzureNextGen.EventHub.DefaultAction>? DefaultAction { get; set; }
