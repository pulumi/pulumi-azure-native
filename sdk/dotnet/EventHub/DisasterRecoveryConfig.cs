...
namespace Pulumi.AzureNative.EventHub
{
    ...
    public partial class DisasterRecoveryConfig : global::Pulumi.CustomResource
    {
        ...
        public DisasterRecoveryConfig(string name, DisasterRecoveryConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub:DisasterRecoveryConfig", name, args ?? new DisasterRecoveryConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DisasterRecoveryConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub:DisasterRecoveryConfig", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventhub/v20250501preview:DisasterRecoveryConfig" },
                    new global::Pulumi.Alias { Type = "azure-native:eventhub/v20260101:DisasterRecoveryConfig" },
                    new global::Pulumi.Alias { Type = "azure-native:eventhub/v20260701preview:DisasterRecoveryConfig" },
                },
            };
