...
namespace Pulumi.AzureNextGen.EventHub
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventhub:DisasterRecoveryConfig")]
    public partial class DisasterRecoveryConfig : Pulumi.CustomResource
    {
        ...
        public DisasterRecoveryConfig(string name, DisasterRecoveryConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub:DisasterRecoveryConfig", name, args ?? new DisasterRecoveryConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DisasterRecoveryConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventhub:DisasterRecoveryConfig", name, null, MakeResourceOptions(options, id))
        {
        }
