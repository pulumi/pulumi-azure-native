...
namespace Pulumi.AzureNative.EventHub.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20230101preview:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20230101preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20230101preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
