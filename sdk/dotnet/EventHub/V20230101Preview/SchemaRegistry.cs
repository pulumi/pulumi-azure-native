...
namespace Pulumi.AzureNative.EventHub.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20230101preview:SchemaRegistry")]
    public partial class SchemaRegistry : global::Pulumi.CustomResource
    {
        ...
        public SchemaRegistry(string name, SchemaRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20230101preview:SchemaRegistry", name, args ?? new SchemaRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20230101preview:SchemaRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SchemaRegistryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20230101Preview.SchemaCompatibility>? SchemaCompatibility { get; set; }
        ...
        [Input("schemaType")]
        public InputUnion<string, Pulumi.AzureNative.EventHub.V20230101Preview.SchemaType>? SchemaType { get; set; }
