...
namespace Pulumi.AzureNative.EventHub.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventhub/v20230101preview:ApplicationGroup")]
    public partial class ApplicationGroup : global::Pulumi.CustomResource
    {
        ...
        public ApplicationGroup(string name, ApplicationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20230101preview:ApplicationGroup", name, args ?? new ApplicationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventhub/v20230101preview:ApplicationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
