...
namespace Pulumi.AzureNative.AgFoodPlatform.V20210901Preview
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.AgFoodPlatform.V20210901Preview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         FarmBeatsResourceName = "examples-farmbeatsResourceName",
    ///         PrivateEndpointConnectionName = "privateEndpointConnectionName",
    ///         PrivateLinkServiceConnectionState = new AzureNative.AgFoodPlatform.V20210901Preview.Inputs.PrivateLinkServiceConnectionStateArgs
    ///         {
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20210901preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20210901preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
