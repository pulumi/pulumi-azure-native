...
namespace Pulumi.AzureNative.AgFoodPlatform.V20210901Preview
{
    ...
    /// {
    ///     var extension = new AzureNative.AgFoodPlatform.V20210901Preview.Extension("extension", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:agfoodplatform/v20210901preview:Extension")]
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20210901preview:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20210901preview:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
