...
namespace Pulumi.AzureNative.AgFoodPlatform.V20210901Preview
{
    ...
    public partial class FarmBeatsModel : global::Pulumi.CustomResource
    {
        ...
        public FarmBeatsModel(string name, FarmBeatsModelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20210901preview:FarmBeatsModel", name, args ?? new FarmBeatsModelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FarmBeatsModel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20210901preview:FarmBeatsModel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:agfoodplatform/v20230601preview:FarmBeatsModel" },
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FarmBeatsModel Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class FarmBeatsModelArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AgFoodPlatform.V20210901Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
