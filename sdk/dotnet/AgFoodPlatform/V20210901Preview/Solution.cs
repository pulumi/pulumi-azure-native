...
namespace Pulumi.AzureNative.AgFoodPlatform.V20210901Preview
{
    ...
    public partial class Solution : global::Pulumi.CustomResource
    {
        ...
        public Solution(string name, SolutionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20210901preview:Solution", name, args ?? new SolutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Solution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20210901preview:Solution", name, null, MakeResourceOptions(options, id))
        {
        }
