...
namespace Pulumi.AzureNative.AgFoodPlatform.V20200512Preview
{
    ...
    /// {
    ///     var farmBeatsModel = new AzureNative.AgFoodPlatform.V20200512Preview.FarmBeatsModel("farmBeatsModel", new()
    ///     {
    ...
    public partial class FarmBeatsModel : global::Pulumi.CustomResource
    {
        ...
        public FarmBeatsModel(string name, FarmBeatsModelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20200512preview:FarmBeatsModel", name, args ?? new FarmBeatsModelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FarmBeatsModel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20200512preview:FarmBeatsModel", name, null, MakeResourceOptions(options, id))
        {
        }
