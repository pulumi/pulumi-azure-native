...
namespace Pulumi.AzureNative.AgFoodPlatform.V20230601Preview
{
    ...
    /// DataConnector Model.
    /// </summary>
    [AzureNativeResourceType("azure-native:agfoodplatform/v20230601preview:DataConnector")]
    public partial class DataConnector : global::Pulumi.CustomResource
    {
        ...
        public DataConnector(string name, DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20230601preview:DataConnector", name, args ?? new DataConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20230601preview:DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:agfoodplatform:DataConnector" },
                },
            };
