...
namespace Pulumi.AzureNative.AgFoodPlatform.V20230601Preview
{
    ...
    /// Extension resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:agfoodplatform/v20230601preview:Extension")]
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20230601preview:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20230601preview:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
