...
namespace Pulumi.AzureNative.AgFoodPlatform.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:agfoodplatform/v20230601preview:DataManagerForAgricultureResource")]
    public partial class DataManagerForAgricultureResource : global::Pulumi.CustomResource
    {
        ...
        public DataManagerForAgricultureResource(string name, DataManagerForAgricultureResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20230601preview:DataManagerForAgricultureResource", name, args ?? new DataManagerForAgricultureResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataManagerForAgricultureResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform/v20230601preview:DataManagerForAgricultureResource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataManagerForAgricultureResourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AgFoodPlatform.V20230601Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
