...
namespace Pulumi.AzureNative.AgFoodPlatform.V20230601Preview
{
    public static class GetDataConnector
    {
        ...
        public static Task<GetDataConnectorResult> InvokeAsync(GetDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectorResult>("azure-native:agfoodplatform/v20230601preview:getDataConnector", args ?? new GetDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Get specific Data Connector resource by DataConnectorName.
        /// </summary>
        public static Output<GetDataConnectorResult> Invoke(GetDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataConnectorResult>("azure-native:agfoodplatform/v20230601preview:getDataConnector", args ?? new GetDataConnectorInvokeArgs(), options.WithDefaults());
