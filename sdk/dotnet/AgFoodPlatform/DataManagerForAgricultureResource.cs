...
namespace Pulumi.AzureNative.AgFoodPlatform
{
    ...
    public partial class DataManagerForAgricultureResource : global::Pulumi.CustomResource
    {
        ...
        public DataManagerForAgricultureResource(string name, DataManagerForAgricultureResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform:DataManagerForAgricultureResource", name, args ?? new DataManagerForAgricultureResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataManagerForAgricultureResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform:DataManagerForAgricultureResource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataManagerForAgricultureResource Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DataManagerForAgricultureResource(name, id, options);
        }
    }

    public sealed class DataManagerForAgricultureResourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public DataManagerForAgricultureResourceArgs()
        {
        }
        public static new DataManagerForAgricultureResourceArgs Empty => new DataManagerForAgricultureResourceArgs();
    }
}
