...
namespace Pulumi.AzureNative.AgFoodPlatform
{
    ...
    public partial class Solution : global::Pulumi.CustomResource
    {
        ...
        public Solution(string name, SolutionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform:Solution", name, args ?? new SolutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Solution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:agfoodplatform:Solution", name, null, MakeResourceOptions(options, id))
        {
        }
