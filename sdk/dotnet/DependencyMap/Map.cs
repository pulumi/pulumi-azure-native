...
namespace Pulumi.AzureNative.DependencyMap
{
    ...
    public partial class Map : global::Pulumi.CustomResource
    {
        ...
        public Map(string name, MapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dependencymap:Map", name, args ?? new MapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Map(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dependencymap:Map", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dependencymap/v20250501preview:Map" },
                    new global::Pulumi.Alias { Type = "azure-native:dependencymap/v20250701preview:Map" },
                },
            };
