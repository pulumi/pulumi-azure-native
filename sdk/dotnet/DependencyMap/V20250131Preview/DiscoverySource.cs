...
namespace Pulumi.AzureNative.DependencyMap.V20250131Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dependencymap/v20250131preview:DiscoverySource")]
    public partial class DiscoverySource : global::Pulumi.CustomResource
    {
        ...
        public DiscoverySource(string name, DiscoverySourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dependencymap/v20250131preview:DiscoverySource", name, args ?? new DiscoverySourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiscoverySource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dependencymap/v20250131preview:DiscoverySource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:dependencymap:DiscoverySource" },
                },
            };
    ...
    public sealed class DiscoverySourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DependencyMap.V20250131Preview.SourceType> SourceType { get; set; } = null!;
