...
namespace Pulumi.AzureNative.DependencyMap.V20250131Preview
{
    /// <summary>
    /// A Maps resource
    /// </summary>
    [AzureNativeResourceType("azure-native:dependencymap/v20250131preview:Map")]
    public partial class Map : global::Pulumi.CustomResource
    {
        ...
        public Map(string name, MapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dependencymap/v20250131preview:Map", name, args ?? new MapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Map(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dependencymap/v20250131preview:Map", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:dependencymap:Map" },
                },
            };
