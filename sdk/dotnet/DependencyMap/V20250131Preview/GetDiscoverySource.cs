...
namespace Pulumi.AzureNative.DependencyMap.V20250131Preview
{
    public static class GetDiscoverySource
    {
        ...
        public static Task<GetDiscoverySourceResult> InvokeAsync(GetDiscoverySourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiscoverySourceResult>("azure-native:dependencymap/v20250131preview:getDiscoverySource", args ?? new GetDiscoverySourceArgs(), options.WithDefaults());

        /// <summary>
        /// Get a DiscoverySourceResource
        /// </summary>
        public static Output<GetDiscoverySourceResult> Invoke(GetDiscoverySourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiscoverySourceResult>("azure-native:dependencymap/v20250131preview:getDiscoverySource", args ?? new GetDiscoverySourceInvokeArgs(), options.WithDefaults());
