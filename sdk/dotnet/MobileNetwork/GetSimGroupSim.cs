...
namespace Pulumi.AzureNative.MobileNetwork
{
    public static class GetSimGroupSim
    {
        ...
        public static Task<GetSimGroupSimResult> InvokeAsync(GetSimGroupSimArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSimGroupSimResult>("azure-native:mobilenetwork:getSimGroupSim", args ?? new GetSimGroupSimArgs(), options.WithDefaults());
        ...
        public static Output<GetSimGroupSimResult> Invoke(GetSimGroupSimInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSimGroupSimResult>("azure-native:mobilenetwork:getSimGroupSim", args ?? new GetSimGroupSimInvokeArgs(), options.WithDefaults());
