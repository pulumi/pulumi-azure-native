...
namespace Pulumi.AzureNative.MobileNetwork.V20230601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20230601:PacketCapture")]
    public partial class PacketCapture : global::Pulumi.CustomResource
    {
        ...
        public PacketCapture(string name, PacketCaptureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230601:PacketCapture", name, args ?? new PacketCaptureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCapture(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230601:PacketCapture", name, null, MakeResourceOptions(options, id))
        {
        }
