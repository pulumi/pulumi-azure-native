...
namespace Pulumi.AzureNative.MobileNetwork.V20230601
{
    public static class GetDiagnosticsPackage
    {
        ...
        public static Task<GetDiagnosticsPackageResult> InvokeAsync(GetDiagnosticsPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiagnosticsPackageResult>("azure-native:mobilenetwork/v20230601:getDiagnosticsPackage", args ?? new GetDiagnosticsPackageArgs(), options.WithDefaults());
