...
namespace Pulumi.AzureNative.MobileNetwork.V20230601
{
    ...
    /// SIM resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20230601:SimGroupSim")]
    public partial class SimGroupSim : global::Pulumi.CustomResource
    {
        ...
        public SimGroupSim(string name, SimGroupSimArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230601:SimGroupSim", name, args ?? new SimGroupSimArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SimGroupSim(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230601:SimGroupSim", name, null, MakeResourceOptions(options, id))
        {
        }
