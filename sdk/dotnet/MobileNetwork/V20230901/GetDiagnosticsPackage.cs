...
namespace Pulumi.AzureNative.MobileNetwork.V20230901
{
    public static class GetDiagnosticsPackage
    {
        ...
        public static Task<GetDiagnosticsPackageResult> InvokeAsync(GetDiagnosticsPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiagnosticsPackageResult>("azure-native:mobilenetwork/v20230901:getDiagnosticsPackage", args ?? new GetDiagnosticsPackageArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified diagnostics package.
        /// </summary>
        public static Output<GetDiagnosticsPackageResult> Invoke(GetDiagnosticsPackageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiagnosticsPackageResult>("azure-native:mobilenetwork/v20230901:getDiagnosticsPackage", args ?? new GetDiagnosticsPackageInvokeArgs(), options.WithDefaults());
