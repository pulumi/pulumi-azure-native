...
namespace Pulumi.AzureNative.MobileNetwork.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20230901:DataNetwork")]
    public partial class DataNetwork : global::Pulumi.CustomResource
    {
        ...
        public DataNetwork(string name, DataNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230901:DataNetwork", name, args ?? new DataNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230901:DataNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
