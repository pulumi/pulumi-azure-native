...
namespace Pulumi.AzureNative.MobileNetwork.V20230901
{
    ...
    /// SIM group resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20230901:SimGroup")]
    public partial class SimGroup : global::Pulumi.CustomResource
    {
        ...
        public SimGroup(string name, SimGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230901:SimGroup", name, args ?? new SimGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SimGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230901:SimGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:mobilenetwork:SimGroup" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:mobilenetwork/v20240401:SimGroup" },
                },
            };
