...
namespace Pulumi.AzureNative.MobileNetwork.V20230901.Inputs
{
    ...
    public sealed class DataNetworkConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.MobileNetwork.V20230901.PduSessionType>>? _additionalAllowedSessionTypes;

        /// <summary>
        /// Allowed session types in addition to the default session type. Must not duplicate the default session type.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MobileNetwork.V20230901.PduSessionType>> AdditionalAllowedSessionTypes
        {
            get => _additionalAllowedSessionTypes ?? (_additionalAllowedSessionTypes = new InputList<Union<string, Pulumi.AzureNative.MobileNetwork.V20230901.PduSessionType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.MobileNetwork.V20230901.PduSessionType>? DefaultSessionType { get; set; }
