...
namespace Pulumi.AzureNative.MobileNetwork.V20230901
{
    ...
    /// SIM policy resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20230901:SimPolicy")]
    public partial class SimPolicy : global::Pulumi.CustomResource
    {
        ...
        public SimPolicy(string name, SimPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230901:SimPolicy", name, args ?? new SimPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SimPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230901:SimPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
