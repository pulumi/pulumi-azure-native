...
namespace Pulumi.AzureNative.MobileNetwork.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20230901:MobileNetwork")]
    public partial class MobileNetwork : global::Pulumi.CustomResource
    {
        ...
        public MobileNetwork(string name, MobileNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230901:MobileNetwork", name, args ?? new MobileNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MobileNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20230901:MobileNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
