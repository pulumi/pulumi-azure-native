...
namespace Pulumi.AzureNative.MobileNetwork.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240401:Slice")]
    public partial class Slice : global::Pulumi.CustomResource
    {
        ...
        public Slice(string name, SliceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:Slice", name, args ?? new SliceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Slice(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:Slice", name, null, MakeResourceOptions(options, id))
        {
        }
