...
namespace Pulumi.AzureNative.MobileNetwork.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240401:PacketCoreControlPlane")]
    public partial class PacketCoreControlPlane : global::Pulumi.CustomResource
    {
        ...
        public PacketCoreControlPlane(string name, PacketCoreControlPlaneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:PacketCoreControlPlane", name, args ?? new PacketCoreControlPlaneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCoreControlPlane(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:PacketCoreControlPlane", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PacketCoreControlPlaneArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MobileNetwork.V20240401.CoreNetworkType>? CoreNetworkTechnology { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.MobileNetwork.V20240401.BillingSku> Sku { get; set; } = null!;
