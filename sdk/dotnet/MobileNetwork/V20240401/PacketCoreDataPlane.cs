...
namespace Pulumi.AzureNative.MobileNetwork.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240401:PacketCoreDataPlane")]
    public partial class PacketCoreDataPlane : global::Pulumi.CustomResource
    {
        ...
        public PacketCoreDataPlane(string name, PacketCoreDataPlaneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:PacketCoreDataPlane", name, args ?? new PacketCoreDataPlaneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCoreDataPlane(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:PacketCoreDataPlane", name, null, MakeResourceOptions(options, id))
        {
        }
