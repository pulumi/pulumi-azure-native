...
namespace Pulumi.AzureNative.MobileNetwork.V20240401
{
    public static class GetSim
    {
        ...
        public static Task<GetSimResult> InvokeAsync(GetSimArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSimResult>("azure-native:mobilenetwork/v20240401:getSim", args ?? new GetSimArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified SIM.
        /// </summary>
        public static Output<GetSimResult> Invoke(GetSimInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSimResult>("azure-native:mobilenetwork/v20240401:getSim", args ?? new GetSimInvokeArgs(), options.WithDefaults());
