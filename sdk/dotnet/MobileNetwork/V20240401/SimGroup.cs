...
namespace Pulumi.AzureNative.MobileNetwork.V20240401
{
    ...
    /// SIM group resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240401:SimGroup")]
    public partial class SimGroup : global::Pulumi.CustomResource
    {
        ...
        public SimGroup(string name, SimGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:SimGroup", name, args ?? new SimGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SimGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:SimGroup", name, null, MakeResourceOptions(options, id))
        {
        }
