...
namespace Pulumi.AzureNative.MobileNetwork.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240401:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:Service", name, null, MakeResourceOptions(options, id))
        {
        }
