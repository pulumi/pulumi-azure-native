...
namespace Pulumi.AzureNative.MobileNetwork.V20240401
{
    ...
    /// SIM resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240401:SimGroupSim")]
    public partial class SimGroupSim : global::Pulumi.CustomResource
    {
        ...
        public SimGroupSim(string name, SimGroupSimArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:SimGroupSim", name, args ?? new SimGroupSimArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SimGroupSim(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:SimGroupSim", name, null, MakeResourceOptions(options, id))
        {
        }
