...
namespace Pulumi.AzureNative.MobileNetwork.V20240401.Inputs
{
    ...
    {
        [Input("nasEncryption")]
        private InputList<Union<string, Pulumi.AzureNative.MobileNetwork.V20240401.NasEncryptionType>>? _nasEncryption;
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MobileNetwork.V20240401.NasEncryptionType>> NasEncryption
        {
            get => _nasEncryption ?? (_nasEncryption = new InputList<Union<string, Pulumi.AzureNative.MobileNetwork.V20240401.NasEncryptionType>>());
