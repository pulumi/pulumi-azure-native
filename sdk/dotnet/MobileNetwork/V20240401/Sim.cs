...
namespace Pulumi.AzureNative.MobileNetwork.V20240401
{
    ...
    /// SIM resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240401:Sim")]
    public partial class Sim : global::Pulumi.CustomResource
    {
        ...
        public Sim(string name, SimArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:Sim", name, args ?? new SimArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Sim(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240401:Sim", name, null, MakeResourceOptions(options, id))
        {
        }
