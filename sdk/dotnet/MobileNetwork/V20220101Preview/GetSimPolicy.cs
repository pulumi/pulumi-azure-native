...
namespace Pulumi.AzureNative.MobileNetwork.V20220101Preview
{
    public static class GetSimPolicy
    {
        ...
        public static Task<GetSimPolicyResult> InvokeAsync(GetSimPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSimPolicyResult>("azure-native:mobilenetwork/v20220101preview:getSimPolicy", args ?? new GetSimPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Sim policy resource.
        /// </summary>
        public static Output<GetSimPolicyResult> Invoke(GetSimPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSimPolicyResult>("azure-native:mobilenetwork/v20220101preview:getSimPolicy", args ?? new GetSimPolicyInvokeArgs(), options.WithDefaults());
    }
