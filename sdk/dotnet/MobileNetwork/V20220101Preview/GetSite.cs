...
namespace Pulumi.AzureNative.MobileNetwork.V20220101Preview
{
    public static class GetSite
    {
        ...
        public static Task<GetSiteResult> InvokeAsync(GetSiteArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSiteResult>("azure-native:mobilenetwork/v20220101preview:getSite", args ?? new GetSiteArgs(), options.WithDefaults());

        /// <summary>
        /// Site resource.
        /// </summary>
        public static Output<GetSiteResult> Invoke(GetSiteInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSiteResult>("azure-native:mobilenetwork/v20220101preview:getSite", args ?? new GetSiteInvokeArgs(), options.WithDefaults());
    }
