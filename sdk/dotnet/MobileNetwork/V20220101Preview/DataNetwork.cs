...
namespace Pulumi.AzureNative.MobileNetwork.V20220101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20220101preview:DataNetwork")]
    public partial class DataNetwork : global::Pulumi.CustomResource
    {
        ...
        public DataNetwork(string name, DataNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220101preview:DataNetwork", name, args ?? new DataNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220101preview:DataNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
