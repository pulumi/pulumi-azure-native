...
namespace Pulumi.AzureNative.MobileNetwork.V20220101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20220101preview:Slice")]
    public partial class Slice : Pulumi.CustomResource
    {
        ...
        public Slice(string name, SliceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220101preview:Slice", name, args ?? new SliceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Slice(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220101preview:Slice", name, null, MakeResourceOptions(options, id))
        {
        }
