...
namespace Pulumi.AzureNative.MobileNetwork.V20220101Preview
{
    public static class GetMobileNetwork
    {
        ...
        public static Task<GetMobileNetworkResult> InvokeAsync(GetMobileNetworkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMobileNetworkResult>("azure-native:mobilenetwork/v20220101preview:getMobileNetwork", args ?? new GetMobileNetworkArgs(), options.WithDefaults());

        /// <summary>
        /// Mobile network resource.
        /// </summary>
        public static Output<GetMobileNetworkResult> Invoke(GetMobileNetworkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMobileNetworkResult>("azure-native:mobilenetwork/v20220101preview:getMobileNetwork", args ?? new GetMobileNetworkInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetMobileNetworkArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class GetMobileNetworkInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The name of the mobile network.
        /// </summary>
