...
namespace Pulumi.AzureNative.MobileNetwork.V20220101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20220101preview:PacketCoreDataPlane")]
    public partial class PacketCoreDataPlane : global::Pulumi.CustomResource
    {
        ...
        public PacketCoreDataPlane(string name, PacketCoreDataPlaneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220101preview:PacketCoreDataPlane", name, args ?? new PacketCoreDataPlaneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCoreDataPlane(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220101preview:PacketCoreDataPlane", name, null, MakeResourceOptions(options, id))
        {
        }
