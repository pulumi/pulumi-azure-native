...
namespace Pulumi.AzureNative.MobileNetwork.V20220401Preview
{
    public static class GetSlice
    {
        ...
        public static Task<GetSliceResult> InvokeAsync(GetSliceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSliceResult>("azure-native:mobilenetwork/v20220401preview:getSlice", args ?? new GetSliceArgs(), options.WithDefaults());

        /// <summary>
        /// Network slice resource.
        /// </summary>
        public static Output<GetSliceResult> Invoke(GetSliceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSliceResult>("azure-native:mobilenetwork/v20220401preview:getSlice", args ?? new GetSliceInvokeArgs(), options.WithDefaults());
    }
