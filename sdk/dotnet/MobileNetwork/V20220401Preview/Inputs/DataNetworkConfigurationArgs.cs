...
namespace Pulumi.AzureNative.MobileNetwork.V20220401Preview.Inputs
{
    ...
    public sealed class DataNetworkConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MobileNetwork.V20220401Preview.PduSessionType>> AdditionalAllowedSessionTypes
        {
            get => _additionalAllowedSessionTypes ?? (_additionalAllowedSessionTypes = new InputList<Union<string, Pulumi.AzureNative.MobileNetwork.V20220401Preview.PduSessionType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.MobileNetwork.V20220401Preview.PduSessionType>? DefaultSessionType { get; set; }
