...
namespace Pulumi.AzureNative.MobileNetwork.V20220401Preview
{
    ...
    /// {
    ///     var mobileNetwork = new AzureNative.MobileNetwork.V20220401Preview.MobileNetwork("mobileNetwork", new()
    ///     {
    ///         Location = "eastus",
    ///         MobileNetworkName = "testMobileNetwork",
    ///         PublicLandMobileNetworkIdentifier = new AzureNative.MobileNetwork.V20220401Preview.Inputs.PlmnIdArgs
    ///         {
    ///             Mcc = "001",
    ///             Mnc = "01",
    ///         },
    ...
    public partial class MobileNetwork : global::Pulumi.CustomResource
    {
        ...
        public MobileNetwork(string name, MobileNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220401preview:MobileNetwork", name, args ?? new MobileNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MobileNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220401preview:MobileNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
