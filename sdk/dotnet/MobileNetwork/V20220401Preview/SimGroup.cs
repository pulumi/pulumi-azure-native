...
namespace Pulumi.AzureNative.MobileNetwork.V20220401Preview
{
    ...
    /// {
    ///     var simGroup = new AzureNative.MobileNetwork.V20220401Preview.SimGroup("simGroup", new()
    ///     {
    ///         EncryptionKey = new AzureNative.MobileNetwork.V20220401Preview.Inputs.KeyVaultKeyArgs
    ///         {
    ...
    public partial class SimGroup : global::Pulumi.CustomResource
    {
        ...
        public SimGroup(string name, SimGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220401preview:SimGroup", name, args ?? new SimGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SimGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220401preview:SimGroup", name, null, MakeResourceOptions(options, id))
        {
        }
