...
namespace Pulumi.AzureNative.MobileNetwork
{
    ...
    public partial class SimPolicy : Pulumi.CustomResource
    {
        ...
        public SimPolicy(string name, SimPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork:SimPolicy", name, args ?? new SimPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SimPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork:SimPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:mobilenetwork/v20220301preview:SimPolicy"},
                    new Pulumi.Alias { Type = "azure-native:mobilenetwork/v20220401preview:SimPolicy"},
                },
            };
