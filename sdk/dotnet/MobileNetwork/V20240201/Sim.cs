...
namespace Pulumi.AzureNative.MobileNetwork.V20240201
{
    ...
    /// SIM resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240201:Sim")]
    public partial class Sim : global::Pulumi.CustomResource
    {
        ...
        public Sim(string name, SimArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:Sim", name, args ?? new SimArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Sim(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:Sim", name, null, MakeResourceOptions(options, id))
        {
        }
