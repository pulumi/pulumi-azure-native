...
namespace Pulumi.AzureNative.MobileNetwork.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240201:MobileNetwork")]
    public partial class MobileNetwork : global::Pulumi.CustomResource
    {
        ...
        public MobileNetwork(string name, MobileNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:MobileNetwork", name, args ?? new MobileNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MobileNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:MobileNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
