...
namespace Pulumi.AzureNative.MobileNetwork.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240201:AttachedDataNetwork")]
    public partial class AttachedDataNetwork : global::Pulumi.CustomResource
    {
        ...
        public AttachedDataNetwork(string name, AttachedDataNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:AttachedDataNetwork", name, args ?? new AttachedDataNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDataNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:AttachedDataNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
