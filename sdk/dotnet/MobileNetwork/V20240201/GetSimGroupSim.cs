...
namespace Pulumi.AzureNative.MobileNetwork.V20240201
{
    public static class GetSimGroupSim
    {
        ...
        public static Task<GetSimGroupSimResult> InvokeAsync(GetSimGroupSimArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSimGroupSimResult>("azure-native:mobilenetwork/v20240201:getSimGroupSim", args ?? new GetSimGroupSimArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about the specified SIM.
        /// </summary>
        public static Output<GetSimGroupSimResult> Invoke(GetSimGroupSimInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSimGroupSimResult>("azure-native:mobilenetwork/v20240201:getSimGroupSim", args ?? new GetSimGroupSimInvokeArgs(), options.WithDefaults());
