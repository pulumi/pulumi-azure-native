...
namespace Pulumi.AzureNative.MobileNetwork.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240201:Slice")]
    public partial class Slice : global::Pulumi.CustomResource
    {
        ...
        public Slice(string name, SliceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:Slice", name, args ?? new SliceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Slice(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:Slice", name, null, MakeResourceOptions(options, id))
        {
        }
