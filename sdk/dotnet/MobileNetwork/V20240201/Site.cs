...
namespace Pulumi.AzureNative.MobileNetwork.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240201:Site")]
    public partial class Site : global::Pulumi.CustomResource
    {
        ...
        public Site(string name, SiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:Site", name, args ?? new SiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Site(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:Site", name, null, MakeResourceOptions(options, id))
        {
        }
