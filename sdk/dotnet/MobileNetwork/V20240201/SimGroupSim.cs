...
namespace Pulumi.AzureNative.MobileNetwork.V20240201
{
    ...
    /// SIM resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240201:SimGroupSim")]
    public partial class SimGroupSim : global::Pulumi.CustomResource
    {
        ...
        public SimGroupSim(string name, SimGroupSimArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:SimGroupSim", name, args ?? new SimGroupSimArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SimGroupSim(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:SimGroupSim", name, null, MakeResourceOptions(options, id))
        {
        }
