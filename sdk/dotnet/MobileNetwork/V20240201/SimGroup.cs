...
namespace Pulumi.AzureNative.MobileNetwork.V20240201
{
    ...
    /// SIM group resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240201:SimGroup")]
    public partial class SimGroup : global::Pulumi.CustomResource
    {
        ...
        public SimGroup(string name, SimGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:SimGroup", name, args ?? new SimGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SimGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:SimGroup", name, null, MakeResourceOptions(options, id))
        {
        }
