...
namespace Pulumi.AzureNative.MobileNetwork.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20240201:PacketCoreControlPlane")]
    public partial class PacketCoreControlPlane : global::Pulumi.CustomResource
    {
        ...
        public PacketCoreControlPlane(string name, PacketCoreControlPlaneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:PacketCoreControlPlane", name, args ?? new PacketCoreControlPlaneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCoreControlPlane(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20240201:PacketCoreControlPlane", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PacketCoreControlPlaneArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MobileNetwork.V20240201.CoreNetworkType>? CoreNetworkTechnology { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.MobileNetwork.V20240201.BillingSku> Sku { get; set; } = null!;
