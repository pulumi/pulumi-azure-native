...
namespace Pulumi.AzureNative.MobileNetwork.V20221101
{
    ...
    /// {
    ///     var slice = new AzureNative.MobileNetwork.V20221101.Slice("slice", new()
    ///     {
    ...
    ///         SliceName = "testSlice",
    ///         Snssai = new AzureNative.MobileNetwork.V20221101.Inputs.SnssaiArgs
    ///         {
    ///             Sd = "1abcde",
    ///             Sst = 1,
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilenetwork/v20221101:Slice")]
    public partial class Slice : global::Pulumi.CustomResource
    {
        ...
        public Slice(string name, SliceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20221101:Slice", name, args ?? new SliceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Slice(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20221101:Slice", name, null, MakeResourceOptions(options, id))
        {
        }
