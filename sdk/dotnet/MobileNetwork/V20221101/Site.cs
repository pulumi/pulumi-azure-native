...
namespace Pulumi.AzureNative.MobileNetwork.V20221101
{
    ...
    public partial class Site : global::Pulumi.CustomResource
    {
        ...
        public Site(string name, SiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20221101:Site", name, args ?? new SiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Site(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20221101:Site", name, null, MakeResourceOptions(options, id))
        {
        }
