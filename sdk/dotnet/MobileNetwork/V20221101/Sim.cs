...
namespace Pulumi.AzureNative.MobileNetwork.V20221101
{
    ...
    /// {
    ///     var sim = new AzureNative.MobileNetwork.V20221101.Sim("sim", new()
    ///     {
    ...
    ///         SimName = "testSim",
    ///         SimPolicy = new AzureNative.MobileNetwork.V20221101.Inputs.SimPolicyResourceIdArgs
    ///         {
    ...
    ///         {
    ///             new AzureNative.MobileNetwork.V20221101.Inputs.SimStaticIpPropertiesArgs
    ///             {
    ///                 AttachedDataNetwork = new AzureNative.MobileNetwork.V20221101.Inputs.AttachedDataNetworkResourceIdArgs
    ///                 {
    ...
    ///                 },
    ///                 StaticIp = new AzureNative.MobileNetwork.V20221101.Inputs.SimStaticIpPropertiesStaticIpArgs
    ///                 {
    ///                     Ipv4Address = "2.4.0.1",
    ///                 },
    ///             },
