...
namespace Pulumi.AzureNative.MobileNetwork.V20220301Preview
{
    ...
    public partial class MobileNetwork : global::Pulumi.CustomResource
    {
        ...
        public MobileNetwork(string name, MobileNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:MobileNetwork", name, args ?? new MobileNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MobileNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:MobileNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
