...
namespace Pulumi.AzureNative.MobileNetwork.V20220301Preview
{
    ...
    /// Site resource.
    /// </summary>
    [Obsolete(@"azure-native:mobilenetwork/v20220301preview:Site is being removed in the next major version of this provider. Upgrade to at least azure-native:mobilenetwork/v20220401preview:Site to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:mobilenetwork/v20220301preview:Site")]
    public partial class Site : global::Pulumi.CustomResource
    {
        ...
        public Site(string name, SiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:Site", name, args ?? new SiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Site(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:Site", name, null, MakeResourceOptions(options, id))
        {
        }
