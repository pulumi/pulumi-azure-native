...
namespace Pulumi.AzureNative.MobileNetwork.V20220301Preview
{
    ...
    public partial class DataNetwork : global::Pulumi.CustomResource
    {
        ...
        public DataNetwork(string name, DataNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:DataNetwork", name, args ?? new DataNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:DataNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:mobilenetwork/v20240201:DataNetwork" },
                    new global::Pulumi.Alias { Type = "azure-native:mobilenetwork/v20240401:DataNetwork" },
                },
            };
