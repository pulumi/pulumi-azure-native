...
namespace Pulumi.AzureNative.MobileNetwork.V20220301Preview
{
    ...
    public partial class AttachedDataNetwork : global::Pulumi.CustomResource
    {
        ...
        public AttachedDataNetwork(string name, AttachedDataNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:AttachedDataNetwork", name, args ?? new AttachedDataNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDataNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:AttachedDataNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
