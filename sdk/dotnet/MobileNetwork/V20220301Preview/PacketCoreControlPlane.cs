...
namespace Pulumi.AzureNative.MobileNetwork.V20220301Preview
{
    ...
    public partial class PacketCoreControlPlane : Pulumi.CustomResource
    {
        ...
        public PacketCoreControlPlane(string name, PacketCoreControlPlaneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:PacketCoreControlPlane", name, args ?? new PacketCoreControlPlaneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCoreControlPlane(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork/v20220301preview:PacketCoreControlPlane", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:mobilenetwork/v20220401preview:PacketCoreControlPlane"},
                },
            };
