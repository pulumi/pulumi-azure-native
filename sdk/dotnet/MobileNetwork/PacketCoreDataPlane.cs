...
namespace Pulumi.AzureNative.MobileNetwork
{
    ...
    public partial class PacketCoreDataPlane : Pulumi.CustomResource
    {
        ...
        public PacketCoreDataPlane(string name, PacketCoreDataPlaneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork:PacketCoreDataPlane", name, args ?? new PacketCoreDataPlaneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PacketCoreDataPlane(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilenetwork:PacketCoreDataPlane", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:mobilenetwork/v20220301preview:PacketCoreDataPlane"},
                    new Pulumi.Alias { Type = "azure-native:mobilenetwork/v20220401preview:PacketCoreDataPlane"},
                },
            };
