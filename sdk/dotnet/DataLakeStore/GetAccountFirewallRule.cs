...
namespace Pulumi.AzureRM.DataLakeStore
{
    public static class GetAccountFirewallRule
    {
        public static Task<GetAccountFirewallRuleResult> InvokeAsync(GetAccountFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountFirewallRuleResult>("azurerm:datalakestore:getAccountFirewallRule", args ?? new GetAccountFirewallRuleArgs(), options.WithVersion());
    }
