...
namespace Pulumi.AzureNative.DataLakeStore
{
    ...
    public partial class VirtualNetworkRule : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRule(string name, VirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datalakestore:VirtualNetworkRule", name, args ?? new VirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datalakestore:VirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:datalakestore/v20161101:VirtualNetworkRule" },
                    new global::Pulumi.Alias { Type = "azure-native_datalakestore_v20161101:datalakestore:VirtualNetworkRule" },
                },
            };
