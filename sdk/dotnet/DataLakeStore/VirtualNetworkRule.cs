...
namespace Pulumi.AzureNextGen.DataLakeStore
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datalakestore:VirtualNetworkRule")]
    public partial class VirtualNetworkRule : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRule(string name, VirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datalakestore:VirtualNetworkRule", name, args ?? new VirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datalakestore:VirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
