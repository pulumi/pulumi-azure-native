...
namespace Pulumi.AzureRM.DataLakeStore
{
    ...
    public partial class AccountVirtualNetworkRule : Pulumi.CustomResource
    {
        ...
        private AccountVirtualNetworkRule(string name, Input<string> id, AccountVirtualNetworkRuleState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:datalakestore:AccountVirtualNetworkRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AccountVirtualNetworkRule Get(string name, Input<string> id, AccountVirtualNetworkRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new AccountVirtualNetworkRule(name, id, state, options);
        }
    }
    ...
    public sealed class AccountVirtualNetworkRuleState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The resource name.
        /// </summary>
        ...
        public AccountVirtualNetworkRuleState()
        {
        }
    }
}
