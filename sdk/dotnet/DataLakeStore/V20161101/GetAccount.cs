...
namespace Pulumi.AzureNative.DataLakeStore.V20161101
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:datalakestore/v20161101:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Data Lake Store account information.
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:datalakestore/v20161101:getAccount", args ?? new GetAccountInvokeArgs(), options.WithDefaults());
    }
