...
namespace Pulumi.AzureNextGen.DataLakeStore
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datalakestore:Account")]
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datalakestore:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datalakestore:Account", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccountArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.DataLakeStore.EncryptionState>? EncryptionState { get; set; }

        /// <summary>
        /// The current state of allowing or disallowing IPs originating within Azure through the firewall. If the firewall is disabled, this is not enforced.
        /// </summary>
        [Input("firewallAllowAzureIps")]
        public Input<Pulumi.AzureNextGen.DataLakeStore.FirewallAllowAzureIpsState>? FirewallAllowAzureIps { get; set; }
        ...
        /// </summary>
        [Input("firewallState")]
        public Input<Pulumi.AzureNextGen.DataLakeStore.FirewallState>? FirewallState { get; set; }
        ...
        /// </summary>
        [Input("newTier")]
        public Input<Pulumi.AzureNextGen.DataLakeStore.TierType>? NewTier { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.DataLakeStore.TrustedIdProviderState>? TrustedIdProviderState { get; set; }
