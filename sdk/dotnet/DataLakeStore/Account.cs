...
namespace Pulumi.AzureNative.DataLakeStore
{
    ...
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datalakestore:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datalakestore:Account", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:datalakestore/v20161101:Account" },
                    new global::Pulumi.Alias { Type = "azure-native_datalakestore_v20161101:datalakestore:Account" },
                },
            };
    ...
    public sealed class AccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.DataLakeStore.EncryptionState>? EncryptionState { get; set; }

        /// <summary>
        /// The current state of allowing or disallowing IPs originating within Azure through the firewall. If the firewall is disabled, this is not enforced.
        /// </summary>
        [Input("firewallAllowAzureIps")]
        public Input<Pulumi.AzureNative.DataLakeStore.FirewallAllowAzureIpsState>? FirewallAllowAzureIps { get; set; }
        ...
        /// </summary>
        [Input("firewallState")]
        public Input<Pulumi.AzureNative.DataLakeStore.FirewallState>? FirewallState { get; set; }
        ...
        /// </summary>
        [Input("newTier")]
        public Input<Pulumi.AzureNative.DataLakeStore.TierType>? NewTier { get; set; }
        ...
        public Input<Pulumi.AzureNative.DataLakeStore.TrustedIdProviderState>? TrustedIdProviderState { get; set; }
