...
namespace Pulumi.AzureNative.Cloudngfw.V20250206Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20250206preview:PostRule")]
    public partial class PostRule : global::Pulumi.CustomResource
    {
        ...
        public PostRule(string name, PostRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20250206preview:PostRule", name, args ?? new PostRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20250206preview:PostRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PostRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("actionType")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.ActionEnum>? ActionType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.DecryptionRuleTypeEnum>? DecryptionRuleType { get; set; }
        ...
        /// </summary>
        [Input("enableLogging")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.StateEnum>? EnableLogging { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.BooleanEnum>? NegateDestination { get; set; }

        /// <summary>
        /// cidr should not be 'any'
        /// </summary>
        [Input("negateSource")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.BooleanEnum>? NegateSource { get; set; }
        ...
        /// </summary>
        [Input("ruleState")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.StateEnum>? RuleState { get; set; }
