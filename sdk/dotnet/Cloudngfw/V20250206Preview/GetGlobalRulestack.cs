...
namespace Pulumi.AzureNative.Cloudngfw.V20250206Preview
{
    public static class GetGlobalRulestack
    {
        ...
        public static Task<GetGlobalRulestackResult> InvokeAsync(GetGlobalRulestackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGlobalRulestackResult>("azure-native:cloudngfw/v20250206preview:getGlobalRulestack", args ?? new GetGlobalRulestackArgs(), options.WithDefaults());

        /// <summary>
        /// Get a GlobalRulestackResource
        /// </summary>
        public static Output<GetGlobalRulestackResult> Invoke(GetGlobalRulestackInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGlobalRulestackResult>("azure-native:cloudngfw/v20250206preview:getGlobalRulestack", args ?? new GetGlobalRulestackInvokeArgs(), options.WithDefaults());
