...
namespace Pulumi.AzureNative.Cloudngfw.V20250206Preview
{
    public static class GetLocalRulestackSupportInfo
    {
        ...
        public static Task<GetLocalRulestackSupportInfoResult> InvokeAsync(GetLocalRulestackSupportInfoArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLocalRulestackSupportInfoResult>("azure-native:cloudngfw/v20250206preview:getLocalRulestackSupportInfo", args ?? new GetLocalRulestackSupportInfoArgs(), options.WithDefaults());
        ...
        public static Output<GetLocalRulestackSupportInfoResult> Invoke(GetLocalRulestackSupportInfoInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLocalRulestackSupportInfoResult>("azure-native:cloudngfw/v20250206preview:getLocalRulestackSupportInfo", args ?? new GetLocalRulestackSupportInfoInvokeArgs(), options.WithDefaults());
