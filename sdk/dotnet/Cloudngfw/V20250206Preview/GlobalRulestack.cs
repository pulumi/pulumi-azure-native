...
namespace Pulumi.AzureNative.Cloudngfw.V20250206Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20250206preview:GlobalRulestack")]
    public partial class GlobalRulestack : global::Pulumi.CustomResource
    {
        ...
        public GlobalRulestack(string name, GlobalRulestackArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20250206preview:GlobalRulestack", name, args ?? new GlobalRulestackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalRulestack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20250206preview:GlobalRulestack", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GlobalRulestackArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("defaultMode")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.DefaultMode>? DefaultMode { get; set; }
        ...
        /// </summary>
        [Input("scope")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.ScopeType>? Scope { get; set; }
