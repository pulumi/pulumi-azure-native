...
namespace Pulumi.AzureNative.Cloudngfw.V20250206Preview.Inputs
{
    ...
    public sealed class NetworkProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.EgressNat> EnableEgressNat { get; set; } = null!;

        /// <summary>
        /// vnet or vwan, cannot be updated
        /// </summary>
        [Input("networkType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20250206Preview.NetworkType> NetworkType { get; set; } = null!;
