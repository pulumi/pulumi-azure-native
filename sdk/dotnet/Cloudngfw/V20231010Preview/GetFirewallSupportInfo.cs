...
namespace Pulumi.AzureNative.Cloudngfw.V20231010Preview
{
    public static class GetFirewallSupportInfo
    {
        ...
        public static Task<GetFirewallSupportInfoResult> InvokeAsync(GetFirewallSupportInfoArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallSupportInfoResult>("azure-native:cloudngfw/v20231010preview:getFirewallSupportInfo", args ?? new GetFirewallSupportInfoArgs(), options.WithDefaults());
