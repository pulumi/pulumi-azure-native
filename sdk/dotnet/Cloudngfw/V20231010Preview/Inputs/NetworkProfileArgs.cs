...
namespace Pulumi.AzureNative.Cloudngfw.V20231010Preview.Inputs
{
    ...
    public sealed class NetworkProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20231010Preview.EgressNat> EnableEgressNat { get; set; } = null!;

        /// <summary>
        /// vnet or vwan, cannot be updated
        /// </summary>
        [Input("networkType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20231010Preview.NetworkType> NetworkType { get; set; } = null!;
