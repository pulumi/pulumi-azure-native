...
namespace Pulumi.AzureNative.Cloudngfw.V20231010Preview
{
    public static class ListLocalRulestackAppIds
    {
        ...
        public static Task<ListLocalRulestackAppIdsResult> InvokeAsync(ListLocalRulestackAppIdsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListLocalRulestackAppIdsResult>("azure-native:cloudngfw/v20231010preview:listLocalRulestackAppIds", args ?? new ListLocalRulestackAppIdsArgs(), options.WithDefaults());
