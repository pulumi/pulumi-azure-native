...
namespace Pulumi.AzureNative.Cloudngfw.V20231010Preview
{
    public static class GetCertificateObjectLocalRulestack
    {
        ...
        public static Task<GetCertificateObjectLocalRulestackResult> InvokeAsync(GetCertificateObjectLocalRulestackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificateObjectLocalRulestackResult>("azure-native:cloudngfw/v20231010preview:getCertificateObjectLocalRulestack", args ?? new GetCertificateObjectLocalRulestackArgs(), options.WithDefaults());
        ...
        public static Output<GetCertificateObjectLocalRulestackResult> Invoke(GetCertificateObjectLocalRulestackInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCertificateObjectLocalRulestackResult>("azure-native:cloudngfw/v20231010preview:getCertificateObjectLocalRulestack", args ?? new GetCertificateObjectLocalRulestackInvokeArgs(), options.WithDefaults());
    }
