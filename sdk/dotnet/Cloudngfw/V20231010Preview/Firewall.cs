...
namespace Pulumi.AzureNative.Cloudngfw.V20231010Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20231010preview:Firewall")]
    public partial class Firewall : global::Pulumi.CustomResource
    {
        ...
        public Firewall(string name, FirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20231010preview:Firewall", name, args ?? new FirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Firewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20231010preview:Firewall", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FirewallArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20231010Preview.BooleanEnum>? IsPanoramaManaged { get; set; }
