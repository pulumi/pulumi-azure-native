...
namespace Pulumi.AzureNative.Cloudngfw.V20231010Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20231010preview:FqdnListGlobalRulestack")]
    public partial class FqdnListGlobalRulestack : global::Pulumi.CustomResource
    {
        ...
        public FqdnListGlobalRulestack(string name, FqdnListGlobalRulestackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20231010preview:FqdnListGlobalRulestack", name, args ?? new FqdnListGlobalRulestackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FqdnListGlobalRulestack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20231010preview:FqdnListGlobalRulestack", name, null, MakeResourceOptions(options, id))
        {
        }
