...
namespace Pulumi.AzureNative.Cloudngfw.V20231010Preview
{
    public static class ListLocalRulestackSecurityServices
    {
        ...
        public static Task<ListLocalRulestackSecurityServicesResult> InvokeAsync(ListLocalRulestackSecurityServicesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListLocalRulestackSecurityServicesResult>("azure-native:cloudngfw/v20231010preview:listLocalRulestackSecurityServices", args ?? new ListLocalRulestackSecurityServicesArgs(), options.WithDefaults());
        ...
        public static Output<ListLocalRulestackSecurityServicesResult> Invoke(ListLocalRulestackSecurityServicesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListLocalRulestackSecurityServicesResult>("azure-native:cloudngfw/v20231010preview:listLocalRulestackSecurityServices", args ?? new ListLocalRulestackSecurityServicesInvokeArgs(), options.WithDefaults());
