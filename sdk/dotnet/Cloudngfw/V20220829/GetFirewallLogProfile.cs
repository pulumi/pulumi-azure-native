...
namespace Pulumi.AzureNative.Cloudngfw.V20220829
{
    public static class GetFirewallLogProfile
    {
        ...
        public static Task<GetFirewallLogProfileResult> InvokeAsync(GetFirewallLogProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallLogProfileResult>("azure-native:cloudngfw/v20220829:getFirewallLogProfile", args ?? new GetFirewallLogProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Log Profile for Firewall
        /// </summary>
        public static Output<GetFirewallLogProfileResult> Invoke(GetFirewallLogProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallLogProfileResult>("azure-native:cloudngfw/v20220829:getFirewallLogProfile", args ?? new GetFirewallLogProfileInvokeArgs(), options.WithDefaults());
    }
