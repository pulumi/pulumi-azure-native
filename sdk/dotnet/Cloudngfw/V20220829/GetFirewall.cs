...
namespace Pulumi.AzureNative.Cloudngfw.V20220829
{
    public static class GetFirewall
    {
        ...
        public static Task<GetFirewallResult> InvokeAsync(GetFirewallArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallResult>("azure-native:cloudngfw/v20220829:getFirewall", args ?? new GetFirewallArgs(), options.WithDefaults());

        /// <summary>
        /// Get a FirewallResource
        /// </summary>
        public static Output<GetFirewallResult> Invoke(GetFirewallInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallResult>("azure-native:cloudngfw/v20220829:getFirewall", args ?? new GetFirewallInvokeArgs(), options.WithDefaults());
