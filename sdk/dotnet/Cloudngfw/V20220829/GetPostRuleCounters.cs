...
namespace Pulumi.AzureNative.Cloudngfw.V20220829
{
    public static class GetPostRuleCounters
    {
        ...
        public static Task<GetPostRuleCountersResult> InvokeAsync(GetPostRuleCountersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPostRuleCountersResult>("azure-native:cloudngfw/v20220829:getPostRuleCounters", args ?? new GetPostRuleCountersArgs(), options.WithDefaults());

        /// <summary>
        /// Get counters
        /// </summary>
        public static Output<GetPostRuleCountersResult> Invoke(GetPostRuleCountersInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPostRuleCountersResult>("azure-native:cloudngfw/v20220829:getPostRuleCounters", args ?? new GetPostRuleCountersInvokeArgs(), options.WithDefaults());
