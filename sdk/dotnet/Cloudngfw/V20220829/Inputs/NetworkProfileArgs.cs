...
namespace Pulumi.AzureNative.Cloudngfw.V20220829.Inputs
{
    ...
    public sealed class NetworkProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20220829.EgressNat> EnableEgressNat { get; set; } = null!;

        /// <summary>
        /// vnet or vwan, cannot be updated
        /// </summary>
        [Input("networkType", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20220829.NetworkType> NetworkType { get; set; } = null!;
