...
namespace Pulumi.AzureNative.Cloudngfw.V20220829
{
    public static class GetGlobalRulestack
    {
        ...
        public static Task<GetGlobalRulestackResult> InvokeAsync(GetGlobalRulestackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGlobalRulestackResult>("azure-native:cloudngfw/v20220829:getGlobalRulestack", args ?? new GetGlobalRulestackArgs(), options.WithDefaults());

        /// <summary>
        /// Get a GlobalRulestackResource
        /// </summary>
        public static Output<GetGlobalRulestackResult> Invoke(GetGlobalRulestackInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGlobalRulestackResult>("azure-native:cloudngfw/v20220829:getGlobalRulestack", args ?? new GetGlobalRulestackInvokeArgs(), options.WithDefaults());
    }
