...
namespace Pulumi.AzureNative.Cloudngfw.V20220829
{
    public static class GetPreRule
    {
        ...
        public static Task<GetPreRuleResult> InvokeAsync(GetPreRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPreRuleResult>("azure-native:cloudngfw/v20220829:getPreRule", args ?? new GetPreRuleArgs(), options.WithDefaults());
