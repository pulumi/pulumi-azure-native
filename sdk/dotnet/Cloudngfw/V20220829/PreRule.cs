...
namespace Pulumi.AzureNative.Cloudngfw.V20220829
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20220829:PreRule")]
    public partial class PreRule : global::Pulumi.CustomResource
    {
        ...
        public PreRule(string name, PreRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20220829:PreRule", name, args ?? new PreRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PreRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20220829:PreRule", name, null, MakeResourceOptions(options, id))
        {
        }
