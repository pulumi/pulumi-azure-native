...
namespace Pulumi.AzureNative.Cloudngfw.V20230901Preview
{
    public static class GetLocalRulestack
    {
        ...
        public static Task<GetLocalRulestackResult> InvokeAsync(GetLocalRulestackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLocalRulestackResult>("azure-native:cloudngfw/v20230901preview:getLocalRulestack", args ?? new GetLocalRulestackArgs(), options.WithDefaults());

        /// <summary>
        /// Get a LocalRulestackResource
        /// </summary>
        public static Output<GetLocalRulestackResult> Invoke(GetLocalRulestackInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLocalRulestackResult>("azure-native:cloudngfw/v20230901preview:getLocalRulestack", args ?? new GetLocalRulestackInvokeArgs(), options.WithDefaults());
    }
