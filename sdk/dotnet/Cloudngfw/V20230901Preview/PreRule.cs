...
namespace Pulumi.AzureNative.Cloudngfw.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20230901preview:PreRule")]
    public partial class PreRule : global::Pulumi.CustomResource
    {
        ...
        public PreRule(string name, PreRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20230901preview:PreRule", name, args ?? new PreRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PreRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20230901preview:PreRule", name, null, MakeResourceOptions(options, id))
        {
        }
