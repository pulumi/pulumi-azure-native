...
namespace Pulumi.AzureNative.Cloudngfw.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20230901preview:LocalRule")]
    public partial class LocalRule : global::Pulumi.CustomResource
    {
        ...
        public LocalRule(string name, LocalRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20230901preview:LocalRule", name, args ?? new LocalRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20230901preview:LocalRule", name, null, MakeResourceOptions(options, id))
        {
        }
