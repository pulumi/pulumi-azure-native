...
namespace Pulumi.AzureNative.Cloudngfw.V20230901Preview
{
    public static class GetPreRule
    {
        ...
        public static Task<GetPreRuleResult> InvokeAsync(GetPreRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPreRuleResult>("azure-native:cloudngfw/v20230901preview:getPreRule", args ?? new GetPreRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Get a PreRulesResource
        /// </summary>
        public static Output<GetPreRuleResult> Invoke(GetPreRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPreRuleResult>("azure-native:cloudngfw/v20230901preview:getPreRule", args ?? new GetPreRuleInvokeArgs(), options.WithDefaults());
    }
