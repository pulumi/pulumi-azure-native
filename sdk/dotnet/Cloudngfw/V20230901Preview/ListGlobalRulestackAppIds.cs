...
namespace Pulumi.AzureNative.Cloudngfw.V20230901Preview
{
    public static class ListGlobalRulestackAppIds
    {
        ...
        public static Task<ListGlobalRulestackAppIdsResult> InvokeAsync(ListGlobalRulestackAppIdsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListGlobalRulestackAppIdsResult>("azure-native:cloudngfw/v20230901preview:listGlobalRulestackAppIds", args ?? new ListGlobalRulestackAppIdsArgs(), options.WithDefaults());
        ...
        public static Output<ListGlobalRulestackAppIdsResult> Invoke(ListGlobalRulestackAppIdsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListGlobalRulestackAppIdsResult>("azure-native:cloudngfw/v20230901preview:listGlobalRulestackAppIds", args ?? new ListGlobalRulestackAppIdsInvokeArgs(), options.WithDefaults());
    }
