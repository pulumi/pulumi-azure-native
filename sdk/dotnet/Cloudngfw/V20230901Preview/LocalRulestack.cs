...
namespace Pulumi.AzureNative.Cloudngfw.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20230901preview:LocalRulestack")]
    public partial class LocalRulestack : global::Pulumi.CustomResource
    {
        ...
        public LocalRulestack(string name, LocalRulestackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20230901preview:LocalRulestack", name, args ?? new LocalRulestackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalRulestack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20230901preview:LocalRulestack", name, null, MakeResourceOptions(options, id))
        {
        }
