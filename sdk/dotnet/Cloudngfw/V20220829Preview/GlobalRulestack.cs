...
namespace Pulumi.AzureNative.Cloudngfw.V20220829Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20220829preview:GlobalRulestack")]
    public partial class GlobalRulestack : global::Pulumi.CustomResource
    {
        ...
        public GlobalRulestack(string name, GlobalRulestackArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20220829preview:GlobalRulestack", name, args ?? new GlobalRulestackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalRulestack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20220829preview:GlobalRulestack", name, null, MakeResourceOptions(options, id))
        {
        }
