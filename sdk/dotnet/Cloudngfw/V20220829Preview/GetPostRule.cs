...
namespace Pulumi.AzureNative.Cloudngfw.V20220829Preview
{
    public static class GetPostRule
    {
        ...
        public static Task<GetPostRuleResult> InvokeAsync(GetPostRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPostRuleResult>("azure-native:cloudngfw/v20220829preview:getPostRule", args ?? new GetPostRuleArgs(), options.WithDefaults());
