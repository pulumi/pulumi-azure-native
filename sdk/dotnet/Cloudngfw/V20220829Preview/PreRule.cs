...
namespace Pulumi.AzureNative.Cloudngfw.V20220829Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20220829preview:PreRule")]
    public partial class PreRule : global::Pulumi.CustomResource
    {
        ...
        public PreRule(string name, PreRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20220829preview:PreRule", name, args ?? new PreRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PreRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20220829preview:PreRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PreRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("actionType")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20220829Preview.ActionEnum>? ActionType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20220829Preview.DecryptionRuleTypeEnum>? DecryptionRuleType { get; set; }
        ...
        /// </summary>
        [Input("enableLogging")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20220829Preview.StateEnum>? EnableLogging { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20220829Preview.BooleanEnum>? NegateDestination { get; set; }

        /// <summary>
        /// cidr should not be 'any'
        /// </summary>
        [Input("negateSource")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20220829Preview.BooleanEnum>? NegateSource { get; set; }
        ...
        /// </summary>
        [Input("ruleState")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20220829Preview.StateEnum>? RuleState { get; set; }
