...
namespace Pulumi.AzureNative.Cloudngfw.V20220829Preview
{
    public static class GetLocalRulestack
    {
        ...
        public static Task<GetLocalRulestackResult> InvokeAsync(GetLocalRulestackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLocalRulestackResult>("azure-native:cloudngfw/v20220829preview:getLocalRulestack", args ?? new GetLocalRulestackArgs(), options.WithDefaults());
