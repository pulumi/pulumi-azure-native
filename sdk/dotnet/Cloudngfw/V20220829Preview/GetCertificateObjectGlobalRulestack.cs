...
namespace Pulumi.AzureNative.Cloudngfw.V20220829Preview
{
    public static class GetCertificateObjectGlobalRulestack
    {
        ...
        public static Task<GetCertificateObjectGlobalRulestackResult> InvokeAsync(GetCertificateObjectGlobalRulestackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificateObjectGlobalRulestackResult>("azure-native:cloudngfw/v20220829preview:getCertificateObjectGlobalRulestack", args ?? new GetCertificateObjectGlobalRulestackArgs(), options.WithDefaults());
        ...
        public static Output<GetCertificateObjectGlobalRulestackResult> Invoke(GetCertificateObjectGlobalRulestackInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCertificateObjectGlobalRulestackResult>("azure-native:cloudngfw/v20220829preview:getCertificateObjectGlobalRulestack", args ?? new GetCertificateObjectGlobalRulestackInvokeArgs(), options.WithDefaults());
    }
