...
namespace Pulumi.AzureNative.Cloudngfw.V20220829Preview
{
    public static class GetCertificateObjectLocalRulestack
    {
        ...
        public static Task<GetCertificateObjectLocalRulestackResult> InvokeAsync(GetCertificateObjectLocalRulestackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificateObjectLocalRulestackResult>("azure-native:cloudngfw/v20220829preview:getCertificateObjectLocalRulestack", args ?? new GetCertificateObjectLocalRulestackArgs(), options.WithDefaults());
        ...
        public static Output<GetCertificateObjectLocalRulestackResult> Invoke(GetCertificateObjectLocalRulestackInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCertificateObjectLocalRulestackResult>("azure-native:cloudngfw/v20220829preview:getCertificateObjectLocalRulestack", args ?? new GetCertificateObjectLocalRulestackInvokeArgs(), options.WithDefaults());
    }
