...
namespace Pulumi.AzureNative.Cloudngfw
{
    ...
    public partial class FqdnListGlobalRulestack : global::Pulumi.CustomResource
    {
        ...
        public FqdnListGlobalRulestack(string name, FqdnListGlobalRulestackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw:FqdnListGlobalRulestack", name, args ?? new FqdnListGlobalRulestackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FqdnListGlobalRulestack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw:FqdnListGlobalRulestack", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cloudngfw/v20250523:FqdnListGlobalRulestack" },
                    new global::Pulumi.Alias { Type = "azure-native:cloudngfw/v20250707preview:FqdnListGlobalRulestack" },
                    new global::Pulumi.Alias { Type = "azure-native:cloudngfw/v20251008:FqdnListGlobalRulestack" },
                    new global::Pulumi.Alias { Type = "azure-native:cloudngfw/v20260126preview:FqdnListGlobalRulestack" },
                    new global::Pulumi.Alias { Type = "azure-native:cloudngfw/v20260511preview:FqdnListGlobalRulestack" },
                },
            };
