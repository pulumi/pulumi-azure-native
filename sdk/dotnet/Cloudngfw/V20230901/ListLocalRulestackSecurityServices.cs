...
namespace Pulumi.AzureNative.Cloudngfw.V20230901
{
    public static class ListLocalRulestackSecurityServices
    {
        ...
        public static Task<ListLocalRulestackSecurityServicesResult> InvokeAsync(ListLocalRulestackSecurityServicesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListLocalRulestackSecurityServicesResult>("azure-native:cloudngfw/v20230901:listLocalRulestackSecurityServices", args ?? new ListLocalRulestackSecurityServicesArgs(), options.WithDefaults());
        ...
        public static Output<ListLocalRulestackSecurityServicesResult> Invoke(ListLocalRulestackSecurityServicesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListLocalRulestackSecurityServicesResult>("azure-native:cloudngfw/v20230901:listLocalRulestackSecurityServices", args ?? new ListLocalRulestackSecurityServicesInvokeArgs(), options.WithDefaults());
    }
