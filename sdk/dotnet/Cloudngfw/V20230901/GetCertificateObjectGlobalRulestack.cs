...
namespace Pulumi.AzureNative.Cloudngfw.V20230901
{
    public static class GetCertificateObjectGlobalRulestack
    {
        ...
        public static Task<GetCertificateObjectGlobalRulestackResult> InvokeAsync(GetCertificateObjectGlobalRulestackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificateObjectGlobalRulestackResult>("azure-native:cloudngfw/v20230901:getCertificateObjectGlobalRulestack", args ?? new GetCertificateObjectGlobalRulestackArgs(), options.WithDefaults());
