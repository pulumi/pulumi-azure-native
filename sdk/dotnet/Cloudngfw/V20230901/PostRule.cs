...
namespace Pulumi.AzureNative.Cloudngfw.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20230901:PostRule")]
    public partial class PostRule : global::Pulumi.CustomResource
    {
        ...
        public PostRule(string name, PostRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20230901:PostRule", name, args ?? new PostRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20230901:PostRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PostRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("actionType")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20230901.ActionEnum>? ActionType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20230901.DecryptionRuleTypeEnum>? DecryptionRuleType { get; set; }
        ...
        /// </summary>
        [Input("enableLogging")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20230901.StateEnum>? EnableLogging { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20230901.BooleanEnum>? NegateDestination { get; set; }

        /// <summary>
        /// cidr should not be 'any'
        /// </summary>
        [Input("negateSource")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20230901.BooleanEnum>? NegateSource { get; set; }
        ...
        /// </summary>
        [Input("ruleState")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20230901.StateEnum>? RuleState { get; set; }
