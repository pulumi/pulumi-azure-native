...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    public static class GetPostRuleCounters
    {
        ...
        public static Task<GetPostRuleCountersResult> InvokeAsync(GetPostRuleCountersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPostRuleCountersResult>("azure-native:cloudngfw/v20240119preview:getPostRuleCounters", args ?? new GetPostRuleCountersArgs(), options.WithDefaults());
