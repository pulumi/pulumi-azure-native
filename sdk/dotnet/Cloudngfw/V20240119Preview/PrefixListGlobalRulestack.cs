...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20240119preview:PrefixListGlobalRulestack")]
    public partial class PrefixListGlobalRulestack : global::Pulumi.CustomResource
    {
        ...
        public PrefixListGlobalRulestack(string name, PrefixListGlobalRulestackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:PrefixListGlobalRulestack", name, args ?? new PrefixListGlobalRulestackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrefixListGlobalRulestack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:PrefixListGlobalRulestack", name, null, MakeResourceOptions(options, id))
        {
        }
