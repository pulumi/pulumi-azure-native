...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20240119preview:PreRule")]
    public partial class PreRule : global::Pulumi.CustomResource
    {
        ...
        public PreRule(string name, PreRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:PreRule", name, args ?? new PreRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PreRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:PreRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PreRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("actionType")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240119Preview.ActionEnum>? ActionType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240119Preview.DecryptionRuleTypeEnum>? DecryptionRuleType { get; set; }
        ...
        /// </summary>
        [Input("enableLogging")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240119Preview.StateEnum>? EnableLogging { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240119Preview.BooleanEnum>? NegateDestination { get; set; }

        /// <summary>
        /// cidr should not be 'any'
        /// </summary>
        [Input("negateSource")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240119Preview.BooleanEnum>? NegateSource { get; set; }
        ...
        /// </summary>
        [Input("ruleState")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240119Preview.StateEnum>? RuleState { get; set; }
