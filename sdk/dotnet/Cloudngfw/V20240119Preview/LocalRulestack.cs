...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20240119preview:LocalRulestack")]
    public partial class LocalRulestack : global::Pulumi.CustomResource
    {
        ...
        public LocalRulestack(string name, LocalRulestackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:LocalRulestack", name, args ?? new LocalRulestackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalRulestack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:LocalRulestack", name, null, MakeResourceOptions(options, id))
        {
        }
