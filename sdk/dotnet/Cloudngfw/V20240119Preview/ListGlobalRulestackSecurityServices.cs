...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    public static class ListGlobalRulestackSecurityServices
    {
        ...
        public static Task<ListGlobalRulestackSecurityServicesResult> InvokeAsync(ListGlobalRulestackSecurityServicesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListGlobalRulestackSecurityServicesResult>("azure-native:cloudngfw/v20240119preview:listGlobalRulestackSecurityServices", args ?? new ListGlobalRulestackSecurityServicesArgs(), options.WithDefaults());
        ...
        public static Output<ListGlobalRulestackSecurityServicesResult> Invoke(ListGlobalRulestackSecurityServicesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListGlobalRulestackSecurityServicesResult>("azure-native:cloudngfw/v20240119preview:listGlobalRulestackSecurityServices", args ?? new ListGlobalRulestackSecurityServicesInvokeArgs(), options.WithDefaults());
