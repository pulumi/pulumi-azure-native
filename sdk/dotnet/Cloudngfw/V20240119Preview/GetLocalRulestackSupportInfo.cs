...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    public static class GetLocalRulestackSupportInfo
    {
        ...
        public static Task<GetLocalRulestackSupportInfoResult> InvokeAsync(GetLocalRulestackSupportInfoArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLocalRulestackSupportInfoResult>("azure-native:cloudngfw/v20240119preview:getLocalRulestackSupportInfo", args ?? new GetLocalRulestackSupportInfoArgs(), options.WithDefaults());
