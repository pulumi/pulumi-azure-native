...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    public static class GetPostRule
    {
        ...
        public static Task<GetPostRuleResult> InvokeAsync(GetPostRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPostRuleResult>("azure-native:cloudngfw/v20240119preview:getPostRule", args ?? new GetPostRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Get a PostRulesResource
        /// </summary>
        public static Output<GetPostRuleResult> Invoke(GetPostRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPostRuleResult>("azure-native:cloudngfw/v20240119preview:getPostRule", args ?? new GetPostRuleInvokeArgs(), options.WithDefaults());
