...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20240119preview:PostRule")]
    public partial class PostRule : global::Pulumi.CustomResource
    {
        ...
        public PostRule(string name, PostRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:PostRule", name, args ?? new PostRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:PostRule", name, null, MakeResourceOptions(options, id))
        {
        }
