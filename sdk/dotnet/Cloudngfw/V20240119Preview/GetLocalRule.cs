...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    public static class GetLocalRule
    {
        ...
        public static Task<GetLocalRuleResult> InvokeAsync(GetLocalRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLocalRuleResult>("azure-native:cloudngfw/v20240119preview:getLocalRule", args ?? new GetLocalRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Get a LocalRulesResource
        /// </summary>
        public static Output<GetLocalRuleResult> Invoke(GetLocalRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLocalRuleResult>("azure-native:cloudngfw/v20240119preview:getLocalRule", args ?? new GetLocalRuleInvokeArgs(), options.WithDefaults());
    }
