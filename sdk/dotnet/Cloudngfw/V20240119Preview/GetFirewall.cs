...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    public static class GetFirewall
    {
        ...
        public static Task<GetFirewallResult> InvokeAsync(GetFirewallArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallResult>("azure-native:cloudngfw/v20240119preview:getFirewall", args ?? new GetFirewallArgs(), options.WithDefaults());

        /// <summary>
        /// Get a FirewallResource
        /// </summary>
        public static Output<GetFirewallResult> Invoke(GetFirewallInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallResult>("azure-native:cloudngfw/v20240119preview:getFirewall", args ?? new GetFirewallInvokeArgs(), options.WithDefaults());
    }
