...
namespace Pulumi.AzureNative.Cloudngfw.V20240119Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20240119preview:Firewall")]
    public partial class Firewall : global::Pulumi.CustomResource
    {
        ...
        public Firewall(string name, FirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:Firewall", name, args ?? new FirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Firewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240119preview:Firewall", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FirewallArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240119Preview.BooleanEnum>? IsPanoramaManaged { get; set; }

        /// <summary>
        /// Strata Cloud Managed: Default is False. Default will be CloudSec managed
        /// </summary>
        [Input("isStrataCloudManaged")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240119Preview.BooleanEnum>? IsStrataCloudManaged { get; set; }
