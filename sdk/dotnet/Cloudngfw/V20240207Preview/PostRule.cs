...
namespace Pulumi.AzureNative.Cloudngfw.V20240207Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20240207preview:PostRule")]
    public partial class PostRule : global::Pulumi.CustomResource
    {
        ...
        public PostRule(string name, PostRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240207preview:PostRule", name, args ?? new PostRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240207preview:PostRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PostRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("actionType")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240207Preview.ActionEnum>? ActionType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240207Preview.DecryptionRuleTypeEnum>? DecryptionRuleType { get; set; }
        ...
        /// </summary>
        [Input("enableLogging")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240207Preview.StateEnum>? EnableLogging { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240207Preview.BooleanEnum>? NegateDestination { get; set; }

        /// <summary>
        /// cidr should not be 'any'
        /// </summary>
        [Input("negateSource")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240207Preview.BooleanEnum>? NegateSource { get; set; }
        ...
        /// </summary>
        [Input("ruleState")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240207Preview.StateEnum>? RuleState { get; set; }
