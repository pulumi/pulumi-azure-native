...
namespace Pulumi.AzureNative.Cloudngfw.V20240207Preview
{
    public static class GetLocalRuleCounters
    {
        ...
        public static Task<GetLocalRuleCountersResult> InvokeAsync(GetLocalRuleCountersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLocalRuleCountersResult>("azure-native:cloudngfw/v20240207preview:getLocalRuleCounters", args ?? new GetLocalRuleCountersArgs(), options.WithDefaults());

        /// <summary>
        /// Get counters
        /// </summary>
        public static Output<GetLocalRuleCountersResult> Invoke(GetLocalRuleCountersInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLocalRuleCountersResult>("azure-native:cloudngfw/v20240207preview:getLocalRuleCounters", args ?? new GetLocalRuleCountersInvokeArgs(), options.WithDefaults());
