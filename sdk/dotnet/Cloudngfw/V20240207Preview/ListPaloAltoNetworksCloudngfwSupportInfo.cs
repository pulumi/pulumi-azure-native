...
namespace Pulumi.AzureNative.Cloudngfw.V20240207Preview
{
    public static class ListPaloAltoNetworksCloudngfwSupportInfo
    {
        ...
        public static Task<ListPaloAltoNetworksCloudngfwSupportInfoResult> InvokeAsync(ListPaloAltoNetworksCloudngfwSupportInfoArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListPaloAltoNetworksCloudngfwSupportInfoResult>("azure-native:cloudngfw/v20240207preview:listPaloAltoNetworksCloudngfwSupportInfo", args ?? new ListPaloAltoNetworksCloudngfwSupportInfoArgs(), options.WithDefaults());

        /// <summary>
        /// Support information for the service
        /// </summary>
        public static Output<ListPaloAltoNetworksCloudngfwSupportInfoResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListPaloAltoNetworksCloudngfwSupportInfoResult>("azure-native:cloudngfw/v20240207preview:listPaloAltoNetworksCloudngfwSupportInfo", InvokeArgs.Empty, options.WithDefaults());
