...
namespace Pulumi.AzureNative.Cloudngfw.V20240207Preview
{
    public static class GetFirewallSupportInfo
    {
        ...
        public static Task<GetFirewallSupportInfoResult> InvokeAsync(GetFirewallSupportInfoArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallSupportInfoResult>("azure-native:cloudngfw/v20240207preview:getFirewallSupportInfo", args ?? new GetFirewallSupportInfoArgs(), options.WithDefaults());
        ...
        public static Output<GetFirewallSupportInfoResult> Invoke(GetFirewallSupportInfoInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallSupportInfoResult>("azure-native:cloudngfw/v20240207preview:getFirewallSupportInfo", args ?? new GetFirewallSupportInfoInvokeArgs(), options.WithDefaults());
