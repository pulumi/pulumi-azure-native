...
namespace Pulumi.AzureNative.Cloudngfw.V20240207Preview
{
    public static class ListPaloAltoNetworksCloudngfwProductSerialNumberStatus
    {
        ...
        public static Task<ListPaloAltoNetworksCloudngfwProductSerialNumberStatusResult> InvokeAsync(ListPaloAltoNetworksCloudngfwProductSerialNumberStatusArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListPaloAltoNetworksCloudngfwProductSerialNumberStatusResult>("azure-native:cloudngfw/v20240207preview:listPaloAltoNetworksCloudngfwProductSerialNumberStatus", args ?? new ListPaloAltoNetworksCloudngfwProductSerialNumberStatusArgs(), options.WithDefaults());
