...
namespace Pulumi.AzureNative.Cloudngfw.V20240207Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20240207preview:PreRule")]
    public partial class PreRule : global::Pulumi.CustomResource
    {
        ...
        public PreRule(string name, PreRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240207preview:PreRule", name, args ?? new PreRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PreRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240207preview:PreRule", name, null, MakeResourceOptions(options, id))
        {
        }
