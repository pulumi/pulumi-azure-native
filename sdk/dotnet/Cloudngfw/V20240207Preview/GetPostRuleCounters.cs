...
namespace Pulumi.AzureNative.Cloudngfw.V20240207Preview
{
    public static class GetPostRuleCounters
    {
        ...
        public static Task<GetPostRuleCountersResult> InvokeAsync(GetPostRuleCountersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPostRuleCountersResult>("azure-native:cloudngfw/v20240207preview:getPostRuleCounters", args ?? new GetPostRuleCountersArgs(), options.WithDefaults());

        /// <summary>
        /// Get counters
        /// </summary>
        public static Output<GetPostRuleCountersResult> Invoke(GetPostRuleCountersInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPostRuleCountersResult>("azure-native:cloudngfw/v20240207preview:getPostRuleCounters", args ?? new GetPostRuleCountersInvokeArgs(), options.WithDefaults());
    }
