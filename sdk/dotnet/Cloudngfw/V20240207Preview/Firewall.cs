...
namespace Pulumi.AzureNative.Cloudngfw.V20240207Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cloudngfw/v20240207preview:Firewall")]
    public partial class Firewall : global::Pulumi.CustomResource
    {
        ...
        public Firewall(string name, FirewallArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240207preview:Firewall", name, args ?? new FirewallArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Firewall(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cloudngfw/v20240207preview:Firewall", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FirewallArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240207Preview.BooleanEnum>? IsPanoramaManaged { get; set; }

        /// <summary>
        /// Strata Cloud Managed: Default is False. Default will be CloudSec managed
        /// </summary>
        [Input("isStrataCloudManaged")]
        public InputUnion<string, Pulumi.AzureNative.Cloudngfw.V20240207Preview.BooleanEnum>? IsStrataCloudManaged { get; set; }
