...
namespace Pulumi.AzureRM.AlertsManagement.V20181102PrivatePreview
{
    ...
    public partial class ActionRuleByName : Pulumi.CustomResource
    {
        ...
        public ActionRuleByName(string name, ActionRuleByNameArgs args, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/v20181102privatepreview:ActionRuleByName", name, args ?? new ActionRuleByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionRuleByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/v20181102privatepreview:ActionRuleByName", name, null, MakeResourceOptions(options, id))
        {
        }
