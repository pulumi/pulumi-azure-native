...
namespace Pulumi.AzureNative.AlertsManagement.V20181102PrivatePreview
{
    ...
    public partial class ActionRuleByName : global::Pulumi.CustomResource
    {
        ...
        public ActionRuleByName(string name, ActionRuleByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:alertsmanagement/v20181102privatepreview:ActionRuleByName", name, args ?? new ActionRuleByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionRuleByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:alertsmanagement/v20181102privatepreview:ActionRuleByName", name, null, MakeResourceOptions(options, id))
        {
        }
