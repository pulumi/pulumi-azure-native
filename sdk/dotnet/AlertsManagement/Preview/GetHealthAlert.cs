...
namespace Pulumi.AzureRM.AlertsManagement.Preview
{
    public static class GetHealthAlert
    {
        public static Task<GetHealthAlertResult> InvokeAsync(GetHealthAlertArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHealthAlertResult>("azurerm:alertsmanagement/preview:getHealthAlert", args ?? new GetHealthAlertArgs(), options.WithVersion());
    }
