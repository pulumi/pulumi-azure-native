...
namespace Pulumi.AzureRM.AlertsManagement.Preview
{
    ...
    public partial class ActionRuleByName : Pulumi.CustomResource
    {
        ...
        public ActionRuleByName(string name, ActionRuleByNameArgs args, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/preview:ActionRuleByName", name, args ?? new ActionRuleByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionRuleByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/preview:ActionRuleByName", name, null, MakeResourceOptions(options, id))
        {
        }
