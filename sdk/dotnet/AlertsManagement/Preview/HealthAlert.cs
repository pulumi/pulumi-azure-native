...
namespace Pulumi.AzureRM.AlertsManagement.Preview
{
    ...
    public partial class HealthAlert : Pulumi.CustomResource
    {
        ...
        public HealthAlert(string name, HealthAlertArgs args, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/preview:HealthAlert", name, args ?? new HealthAlertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthAlert(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/preview:HealthAlert", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:alertsmanagement/v20200804preview:HealthAlert"},
                },
            };
