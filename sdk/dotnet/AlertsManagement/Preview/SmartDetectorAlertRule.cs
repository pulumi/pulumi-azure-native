...
namespace Pulumi.AzureRM.AlertsManagement.Preview
{
    ...
    public partial class SmartDetectorAlertRule : Pulumi.CustomResource
    {
        ...
        public SmartDetectorAlertRule(string name, SmartDetectorAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/preview:SmartDetectorAlertRule", name, args ?? new SmartDetectorAlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SmartDetectorAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/preview:SmartDetectorAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
