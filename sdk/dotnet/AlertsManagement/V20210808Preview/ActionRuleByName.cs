...
namespace Pulumi.AzureNative.AlertsManagement.V20210808Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:alertsmanagement/v20210808preview:ActionRuleByName")]
    public partial class ActionRuleByName : Pulumi.CustomResource
    {
        ...
        public ActionRuleByName(string name, ActionRuleByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:alertsmanagement/v20210808preview:ActionRuleByName", name, args ?? new ActionRuleByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionRuleByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:alertsmanagement/v20210808preview:ActionRuleByName", name, null, MakeResourceOptions(options, id))
        {
        }
