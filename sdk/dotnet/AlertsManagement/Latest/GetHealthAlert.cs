...
namespace Pulumi.AzureRM.AlertsManagement.Latest
{
    public static class GetHealthAlert
    {
        public static Task<GetHealthAlertResult> InvokeAsync(GetHealthAlertArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHealthAlertResult>("azurerm:alertsmanagement/latest:getHealthAlert", args ?? new GetHealthAlertArgs(), options.WithVersion());
    }
