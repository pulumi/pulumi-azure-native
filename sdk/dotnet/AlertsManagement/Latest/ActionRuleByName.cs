...
namespace Pulumi.AzureRM.AlertsManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var actionRuleByName = new AzureRM.AlertsManagement.Latest.ActionRuleByName("actionRuleByName", new AzureRM.AlertsManagement.Latest.ActionRuleByNameArgs
    ///         {
    ...
    public partial class ActionRuleByName : Pulumi.CustomResource
    {
        ...
        public ActionRuleByName(string name, ActionRuleByNameArgs args, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/latest:ActionRuleByName", name, args ?? new ActionRuleByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActionRuleByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/latest:ActionRuleByName", name, null, MakeResourceOptions(options, id))
        {
        }
