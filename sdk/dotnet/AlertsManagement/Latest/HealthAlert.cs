...
namespace Pulumi.AzureRM.AlertsManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var healthAlert = new AzureRM.AlertsManagement.Latest.HealthAlert("healthAlert", new AzureRM.AlertsManagement.Latest.HealthAlertArgs
    ///         {
    ///             Actions = 
    ///             {
    ///                 new AzureRM.AlertsManagement.Latest.Inputs.HealthAlertActionArgs
    ///                 {
    ...
    ///                 },
    ///             },
    ///             Criteria = new AzureRM.AlertsManagement.Latest.Inputs.HealthAlertCriteriaArgs
    ///             {
    ///                 AllOf = 
    ///                 {
    ///                     new AzureRM.AlertsManagement.Latest.Inputs.VmGuestHealthAlertCriterionArgs
    ///                     {
    ...
    public partial class HealthAlert : Pulumi.CustomResource
    {
        ...
        public HealthAlert(string name, HealthAlertArgs args, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/latest:HealthAlert", name, args ?? new HealthAlertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthAlert(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/latest:HealthAlert", name, null, MakeResourceOptions(options, id))
        {
        }
