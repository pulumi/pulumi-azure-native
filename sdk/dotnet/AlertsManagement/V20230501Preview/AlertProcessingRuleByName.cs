...
namespace Pulumi.AzureNative.AlertsManagement.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:alertsmanagement/v20230501preview:AlertProcessingRuleByName")]
    public partial class AlertProcessingRuleByName : global::Pulumi.CustomResource
    {
        ...
        public AlertProcessingRuleByName(string name, AlertProcessingRuleByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:alertsmanagement/v20230501preview:AlertProcessingRuleByName", name, args ?? new AlertProcessingRuleByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertProcessingRuleByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:alertsmanagement/v20230501preview:AlertProcessingRuleByName", name, null, MakeResourceOptions(options, id))
        {
        }
