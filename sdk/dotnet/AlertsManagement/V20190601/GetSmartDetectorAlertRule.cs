...
namespace Pulumi.AzureRM.AlertsManagement.V20190601
{
    public static class GetSmartDetectorAlertRule
    {
        public static Task<GetSmartDetectorAlertRuleResult> InvokeAsync(GetSmartDetectorAlertRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSmartDetectorAlertRuleResult>("azurerm:alertsmanagement/v20190601:getSmartDetectorAlertRule", args ?? new GetSmartDetectorAlertRuleArgs(), options.WithVersion());
    }
