...
namespace Pulumi.AzureNative.AlertsManagement.V20190601
{
    ...
    /// {
    ///     var smartDetectorAlertRule = new AzureNative.AlertsManagement.V20190601.SmartDetectorAlertRule("smartDetectorAlertRule", new()
    ///     {
    ///         ActionGroups = new AzureNative.AlertsManagement.V20190601.Inputs.ActionGroupsInformationArgs
    ///         {
    ...
    ///         Detector = new AzureNative.AlertsManagement.V20190601.Inputs.DetectorArgs
    ///         {
    ///             Id = "VMMemoryLeak",
    ///         },
    ///         Frequency = "PT5M",
    ...
    ///         Severity = "Sev3",
    ///         State = "Enabled",
    ///         Throttling = new AzureNative.AlertsManagement.V20190601.Inputs.ThrottlingInformationArgs
    ///         {
    ///             Duration = "PT20M",
    ///         },
    ///     });
