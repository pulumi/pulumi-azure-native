...
namespace Pulumi.AzureRM.AlertsManagement.V20190601
{
    ...
    public partial class SmartDetectorAlertRule : Pulumi.CustomResource
    {
        ...
        public SmartDetectorAlertRule(string name, SmartDetectorAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/v20190601:SmartDetectorAlertRule", name, args ?? new SmartDetectorAlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SmartDetectorAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/v20190601:SmartDetectorAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:alertsmanagement/v20190301:SmartDetectorAlertRule"},
                },
            };
