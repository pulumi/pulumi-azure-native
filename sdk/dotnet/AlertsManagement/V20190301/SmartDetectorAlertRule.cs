...
namespace Pulumi.AzureRM.AlertsManagement.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var smartDetectorAlertRule = new AzureRM.AlertsManagement.V20190301.SmartDetectorAlertRule("smartDetectorAlertRule", new AzureRM.AlertsManagement.V20190301.SmartDetectorAlertRuleArgs
    ///         {
    ///             ActionGroups = new AzureRM.AlertsManagement.V20190301.Inputs.ActionGroupsInformationArgs
    ///             {
    ...
    ///             Detector = new AzureRM.AlertsManagement.V20190301.Inputs.DetectorArgs
    ///             {
    ///                 Id = "VMMemoryLeak",
    ///             },
    ///             Frequency = "PT5M",
    ...
    ///             Severity = "Sev3",
    ///             State = "Enabled",
    ///             Throttling = new AzureRM.AlertsManagement.V20190301.Inputs.ThrottlingInformationArgs
    ///             {
    ///                 Duration = "PT20M",
    ///             },
    ///         });
    ...
    public partial class SmartDetectorAlertRule : Pulumi.CustomResource
    {
        ...
        public SmartDetectorAlertRule(string name, SmartDetectorAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/v20190301:SmartDetectorAlertRule", name, args ?? new SmartDetectorAlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SmartDetectorAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:alertsmanagement/v20190301:SmartDetectorAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
