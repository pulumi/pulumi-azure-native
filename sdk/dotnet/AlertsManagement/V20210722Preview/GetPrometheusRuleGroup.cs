...
namespace Pulumi.AzureNative.AlertsManagement.V20210722Preview
{
    public static class GetPrometheusRuleGroup
    {
        ...
        public static Task<GetPrometheusRuleGroupResult> InvokeAsync(GetPrometheusRuleGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrometheusRuleGroupResult>("azure-native:alertsmanagement/v20210722preview:getPrometheusRuleGroup", args ?? new GetPrometheusRuleGroupArgs(), options.WithVersion());
        ...
        public static Output<GetPrometheusRuleGroupResult> Invoke(GetPrometheusRuleGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrometheusRuleGroupResult>("azure-native:alertsmanagement/v20210722preview:getPrometheusRuleGroup", args ?? new GetPrometheusRuleGroupInvokeArgs(), options.WithVersion());
    }
