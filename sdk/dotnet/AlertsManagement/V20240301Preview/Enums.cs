...
namespace Pulumi.AzureNative.AlertsManagement.V20240301Preview
{
    /// <summary>
    ...
    /// </summary>
    [EnumType]
    public readonly struct UpdateType : IEquatable<UpdateType>
    {
        private readonly string _value;
        ...
        public static UpdateType TimeBased { get; } = new UpdateType("timeBased");

        public static bool operator ==(UpdateType left, UpdateType right) => left.Equals(right);
        public static bool operator !=(UpdateType left, UpdateType right) => !left.Equals(right);

        public static explicit operator string(UpdateType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is UpdateType other && Equals(other);
        public bool Equals(UpdateType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
