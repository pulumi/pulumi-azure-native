...
namespace Pulumi.AzureNative.AlertsManagement.V20240301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:alertsmanagement/v20240301preview:AlertProcessingRuleByName")]
    public partial class AlertProcessingRuleByName : global::Pulumi.CustomResource
    {
        ...
        public AlertProcessingRuleByName(string name, AlertProcessingRuleByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:alertsmanagement/v20240301preview:AlertProcessingRuleByName", name, args ?? new AlertProcessingRuleByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertProcessingRuleByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:alertsmanagement/v20240301preview:AlertProcessingRuleByName", name, null, MakeResourceOptions(options, id))
        {
        }
