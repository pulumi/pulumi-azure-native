...
namespace Pulumi.AzureNative.AlertsManagement
{
    ...
    public partial class PrometheusRuleGroup : Pulumi.CustomResource
    {
        /// <summary>
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:alertsmanagement/v20210722preview:PrometheusRuleGroup"},
                },
            };
    ...
    public sealed class PrometheusRuleGroupArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// the description of the Prometheus rule group that will be included in the alert email.
        /// </summary>
