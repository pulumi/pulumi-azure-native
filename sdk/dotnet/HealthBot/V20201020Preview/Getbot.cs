...
namespace Pulumi.AzureNextGen.HealthBot.V20201020Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:healthbot/v20201020preview:getbot")]
    public partial class Getbot : Pulumi.CustomResource
    {
        ...
        public Getbot(string name, GetbotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:healthbot/v20201020preview:getbot", name, args ?? new GetbotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Getbot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:healthbot/v20201020preview:getbot", name, null, MakeResourceOptions(options, id))
        {
        }
