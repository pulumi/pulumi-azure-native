...
namespace Pulumi.AzureNative.HealthBot.V20201020Preview
{
    ...
    public partial class Getbot : Pulumi.CustomResource
    {
        ...
        public Getbot(string name, GetbotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthbot/v20201020preview:getbot", name, args ?? new GetbotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Getbot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthbot/v20201020preview:getbot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:healthbot/v20201020:getbot"},
