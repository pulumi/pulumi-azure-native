...
namespace Pulumi.AzureNative.HealthBot.V20240201
{
    public static class GetBot
    {
        ...
        public static Task<GetBotResult> InvokeAsync(GetBotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBotResult>("azure-native:healthbot/v20240201:getBot", args ?? new GetBotArgs(), options.WithDefaults());

        /// <summary>
        /// Get a HealthBot.
        /// </summary>
        public static Output<GetBotResult> Invoke(GetBotInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBotResult>("azure-native:healthbot/v20240201:getBot", args ?? new GetBotInvokeArgs(), options.WithDefaults());
