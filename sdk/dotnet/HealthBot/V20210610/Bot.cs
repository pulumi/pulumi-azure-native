...
namespace Pulumi.AzureNative.HealthBot.V20210610
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthbot/v20210610:Bot")]
    public partial class Bot : global::Pulumi.CustomResource
    {
        ...
        public Bot(string name, BotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthbot/v20210610:Bot", name, args ?? new BotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthbot/v20210610:Bot", name, null, MakeResourceOptions(options, id))
        {
        }
