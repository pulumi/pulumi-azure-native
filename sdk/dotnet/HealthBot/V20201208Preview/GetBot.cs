...
{
    [Obsolete(@"Version 2020-12-08-preview will be removed in v2 of the provider.")]
    public static class GetBot
    {
        ...
        public static Task<GetBotResult> InvokeAsync(GetBotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBotResult>("azure-native:healthbot/v20201208preview:getBot", args ?? new GetBotArgs(), options.WithDefaults());

        /// <summary>
        /// HealthBot resource definition
        /// </summary>
        public static Output<GetBotResult> Invoke(GetBotInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBotResult>("azure-native:healthbot/v20201208preview:getBot", args ?? new GetBotInvokeArgs(), options.WithDefaults());
    }
