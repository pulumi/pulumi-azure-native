...
namespace Pulumi.AzureNative.HealthBot.V20201208Preview
{
    public static class GetBot
    {
        ...
        public static Task<GetBotResult> InvokeAsync(GetBotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBotResult>("azure-native:healthbot/v20201208preview:getBot", args ?? new GetBotArgs(), options.WithDefaults());

        /// <summary>
        /// HealthBot resource definition
        /// </summary>
        public static Output<GetBotResult> Invoke(GetBotInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBotResult>("azure-native:healthbot/v20201208preview:getBot", args ?? new GetBotInvokeArgs(), options.WithDefaults());
    }
