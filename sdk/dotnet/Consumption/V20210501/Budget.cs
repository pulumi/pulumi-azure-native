...
namespace Pulumi.AzureNative.Consumption.V20210501
{
    /// <summary>
    /// A budget resource.
    /// </summary>
    [Obsolete(@"azure-native:consumption/v20210501:Budget is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20220901:Budget to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:consumption/v20210501:Budget")]
    public partial class Budget : global::Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20210501:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20210501:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20210501.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20210501.TimeGrainType> TimeGrain { get; set; } = null!;
