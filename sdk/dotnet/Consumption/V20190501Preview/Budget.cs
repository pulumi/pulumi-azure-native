...
namespace Pulumi.AzureRM.Consumption.V20190501Preview
{
    /// <summary>
    /// A budget resource.
    /// 
    ...
    ///     public MyStack()
    ///     {
    ///         var budget = new AzureRM.Consumption.V20190501Preview.Budget("budget", new AzureRM.Consumption.V20190501Preview.BudgetArgs
    ///         {
    ///             Amount = 100.65,
    ///             BudgetName = "TestBudget",
    ///             Category = "Cost",
    ///             ETag = "\"1d34d016a593709\"",
    ///             Filters = new AzureRM.Consumption.V20190501Preview.Inputs.FiltersArgs
    ///             {
    ///                 Meters = 
    ///                 {
    ...
    ///             Notifications = 
    ///             {
    ///                 { "Actual_GreaterThan_80_Percent", new AzureRM.Consumption.V20190501Preview.Inputs.NotificationArgs
    ///                 {
    ///                     ContactEmails = 
    ///                     {
    ///                         "johndoe@contoso.com",
    ...
    ///             TimeGrain = "Monthly",
    ///             TimePeriod = new AzureRM.Consumption.V20190501Preview.Inputs.BudgetTimePeriodArgs
    ///             {
    ...
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20190501preview:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20190501preview:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
