...
namespace Pulumi.AzureRM.Consumption.Preview
{
    /// <summary>
    /// A budget resource.
    /// </summary>
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:consumption/preview:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:consumption/preview:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
