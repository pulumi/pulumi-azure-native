...
namespace Pulumi.AzureNextGen.Consumption.V20171230Preview
{
    ...
    /// A budget resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:consumption/v20171230preview:Budget")]
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:consumption/v20171230preview:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:consumption/v20171230preview:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Consumption.V20171230Preview.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Consumption.V20171230Preview.TimeGrainType> TimeGrain { get; set; } = null!;
