...
namespace Pulumi.AzureNative.Consumption.V20171230Preview
{
    ...
    /// A budget resource.
    /// </summary>
    [Obsolete(@"Version v20171230preview will be removed in the next major version of the provider. Upgrade to version v20191001 or later.")]
    ...
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20171230preview:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20171230preview:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20171230Preview.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20171230Preview.TimeGrainType> TimeGrain { get; set; } = null!;
