...
namespace Pulumi.AzureNative.Consumption.Latest.Inputs
{
    ...
    public sealed class NotificationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("locale")]
        public InputUnion<string, Pulumi.AzureNative.Consumption.Latest.CultureCode>? Locale { get; set; }

        /// <summary>
        /// The comparison operator.
        /// </summary>
        [Input("operator", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Consumption.Latest.OperatorType> Operator { get; set; } = null!;
        ...
        /// </summary>
        [Input("thresholdType")]
        public InputUnion<string, Pulumi.AzureNative.Consumption.Latest.ThresholdType>? ThresholdType { get; set; }
