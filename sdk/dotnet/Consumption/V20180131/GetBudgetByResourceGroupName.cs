...
namespace Pulumi.AzureRM.Consumption.V20180131
{
    public static class GetBudgetByResourceGroupName
    {
        public static Task<GetBudgetByResourceGroupNameResult> InvokeAsync(GetBudgetByResourceGroupNameArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBudgetByResourceGroupNameResult>("azurerm:consumption/v20180131:getBudgetByResourceGroupName", args ?? new GetBudgetByResourceGroupNameArgs(), options.WithVersion());
    }
