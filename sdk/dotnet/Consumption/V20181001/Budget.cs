...
namespace Pulumi.AzureNative.Consumption.V20181001
{
    ...
    /// {
    ///     var budget = new AzureNative.Consumption.V20181001.Budget("budget", new()
    ///     {
    ///         Amount = 100.65,
    ...
    public partial class Budget : global::Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20181001:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20181001:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
