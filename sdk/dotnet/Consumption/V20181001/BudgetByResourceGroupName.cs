...
namespace Pulumi.AzureNative.Consumption.V20181001
{
    ...
    /// {
    ///     var budgetByResourceGroupName = new AzureNative.Consumption.V20181001.BudgetByResourceGroupName("budgetByResourceGroupName", new()
    ///     {
    ///         Amount = 100.65,
    ///         BudgetName = "TestBudget",
    ///         Category = "Cost",
    ///         ETag = "\"1d34d016a593709\"",
    ///         Filters = new AzureNative.Consumption.V20181001.Inputs.FiltersArgs
    ///         {
    ///             Meters = new[]
    ///             {
    ...
    ///         Notifications = 
    ///         {
    ///             { "Actual_GreaterThan_80_Percent", new AzureNative.Consumption.V20181001.Inputs.NotificationArgs
    ///             {
    ///                 ContactEmails = new[]
    ///                 {
    ///                     "johndoe@contoso.com",
    ...
    ///         TimeGrain = "Monthly",
    ///         TimePeriod = new AzureNative.Consumption.V20181001.Inputs.BudgetTimePeriodArgs
    ///         {
    ...
    [AzureNativeResourceType("azure-native:consumption/v20181001:BudgetByResourceGroupName")]
    public partial class BudgetByResourceGroupName : global::Pulumi.CustomResource
    {
        ...
        public BudgetByResourceGroupName(string name, BudgetByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20181001:BudgetByResourceGroupName", name, args ?? new BudgetByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BudgetByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20181001:BudgetByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetByResourceGroupNameArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20181001.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20181001.TimeGrainType> TimeGrain { get; set; } = null!;
