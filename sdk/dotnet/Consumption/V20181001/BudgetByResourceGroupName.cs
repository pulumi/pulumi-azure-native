...
namespace Pulumi.AzureRM.Consumption.V20181001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var budgetByResourceGroupName = new AzureRM.Consumption.V20181001.BudgetByResourceGroupName("budgetByResourceGroupName", new AzureRM.Consumption.V20181001.BudgetByResourceGroupNameArgs
    ///         {
    ///             Amount = 100.65,
    ///             BudgetName = "TestBudget",
    ///             Category = "Cost",
    ///             ETag = "\"1d34d016a593709\"",
    ///             Filters = new AzureRM.Consumption.V20181001.Inputs.FiltersArgs
    ///             {
    ///                 Meters = 
    ///                 {
    ...
    ///             Notifications = 
    ///             {
    ///                 { "Actual_GreaterThan_80_Percent", new AzureRM.Consumption.V20181001.Inputs.NotificationArgs
    ///                 {
    ///                     ContactEmails = 
    ///                     {
    ///                         "johndoe@contoso.com",
    ...
    ///             TimeGrain = "Monthly",
    ///             TimePeriod = new AzureRM.Consumption.V20181001.Inputs.BudgetTimePeriodArgs
    ///             {
    ...
    public partial class BudgetByResourceGroupName : Pulumi.CustomResource
    {
        ...
        public BudgetByResourceGroupName(string name, BudgetByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20181001:BudgetByResourceGroupName", name, args ?? new BudgetByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BudgetByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20181001:BudgetByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
