...
namespace Pulumi.AzureNative.Consumption.V20191001.Inputs
{
    ...
    public sealed class NotificationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("locale")]
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20191001.CultureCode>? Locale { get; set; }

        /// <summary>
        /// The comparison operator.
        /// </summary>
        [Input("operator", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20191001.OperatorType> Operator { get; set; } = null!;
        ...
        /// </summary>
        [Input("thresholdType")]
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20191001.ThresholdType>? ThresholdType { get; set; }
