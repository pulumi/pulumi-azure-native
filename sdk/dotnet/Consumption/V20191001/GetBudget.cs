...
namespace Pulumi.AzureNative.Consumption.V20191001
{
    ...
    public static class GetBudget
    {
        ...
        public static Task<GetBudgetResult> InvokeAsync(GetBudgetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBudgetResult>("azure-native:consumption/v20191001:getBudget", args ?? new GetBudgetArgs(), options.WithDefaults());

        /// <summary>
        /// A budget resource.
        /// </summary>
        public static Output<GetBudgetResult> Invoke(GetBudgetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBudgetResult>("azure-native:consumption/v20191001:getBudget", args ?? new GetBudgetInvokeArgs(), options.WithDefaults());
    }
