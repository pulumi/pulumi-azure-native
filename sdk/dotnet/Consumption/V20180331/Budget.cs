...
namespace Pulumi.AzureRM.Consumption.V20180331
{
    ...
    ///     public MyStack()
    ///     {
    ///         var budget = new AzureRM.Consumption.V20180331.Budget("budget", new AzureRM.Consumption.V20180331.BudgetArgs
    ///         {
    ///             Amount = 100.65,
    ...
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180331:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180331:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
