...
namespace Pulumi.AzureNative.Consumption.V20180331
{
    ...
    public static class GetBudgetByResourceGroupName
    {
        ...
        public static Task<GetBudgetByResourceGroupNameResult> InvokeAsync(GetBudgetByResourceGroupNameArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBudgetByResourceGroupNameResult>("azure-native:consumption/v20180331:getBudgetByResourceGroupName", args ?? new GetBudgetByResourceGroupNameArgs(), options.WithDefaults());
        ...
        public static Output<GetBudgetByResourceGroupNameResult> Invoke(GetBudgetByResourceGroupNameInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBudgetByResourceGroupNameResult>("azure-native:consumption/v20180331:getBudgetByResourceGroupName", args ?? new GetBudgetByResourceGroupNameInvokeArgs(), options.WithDefaults());
    }
