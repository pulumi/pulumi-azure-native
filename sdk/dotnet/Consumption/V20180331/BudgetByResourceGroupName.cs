...
namespace Pulumi.AzureRM.Consumption.V20180331
{
    ...
    ///     public MyStack()
    ///     {
    ///         var budgetByResourceGroupName = new AzureRM.Consumption.V20180331.BudgetByResourceGroupName("budgetByResourceGroupName", new AzureRM.Consumption.V20180331.BudgetByResourceGroupNameArgs
    ///         {
    ///             Amount = 100.65,
    ///             BudgetName = "TestBudget",
    ///             Category = "Cost",
    ///             ETag = "\"1d34d016a593709\"",
    ///             Filters = new AzureRM.Consumption.V20180331.Inputs.FiltersArgs
    ///             {
    ///                 Meters = 
    ///                 {
    ...
    ///             Notifications = 
    ///             {
    ///                 { "Actual_GreaterThan_80_Percent", new AzureRM.Consumption.V20180331.Inputs.NotificationArgs
    ///                 {
    ///                     ContactEmails = 
    ///                     {
    ///                         "johndoe@contoso.com",
    ...
    ///             TimeGrain = "Monthly",
    ///             TimePeriod = new AzureRM.Consumption.V20180331.Inputs.BudgetTimePeriodArgs
    ///             {
    ...
    public partial class BudgetByResourceGroupName : Pulumi.CustomResource
    {
        ...
        public BudgetByResourceGroupName(string name, BudgetByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180331:BudgetByResourceGroupName", name, args ?? new BudgetByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BudgetByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180331:BudgetByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:consumption/v20180630:BudgetByResourceGroupName"},
