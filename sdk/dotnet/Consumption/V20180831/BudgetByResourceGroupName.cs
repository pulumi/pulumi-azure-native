...
azure-native:consumption/v20180831:BudgetByResourceGroupName is being removed in the next major version of this provider. Please upgrade to azure-native:consumption/v20181001:BudgetByResourceGroupName to guarantee forwards compatibility.")]
    ...
    public partial class BudgetByResourceGroupName : global::Pulumi.CustomResource
    {
        ...
        public BudgetByResourceGroupName(string name, BudgetByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20180831:BudgetByResourceGroupName", name, args ?? new BudgetByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BudgetByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20180831:BudgetByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
