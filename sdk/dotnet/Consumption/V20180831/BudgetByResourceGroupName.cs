...
namespace Pulumi.AzureRM.Consumption.V20180831
{
    ...
    ///     public MyStack()
    ///     {
    ///         var budgetByResourceGroupName = new AzureRM.Consumption.V20180831.BudgetByResourceGroupName("budgetByResourceGroupName", new AzureRM.Consumption.V20180831.BudgetByResourceGroupNameArgs
    ///         {
    ///             Amount = 100.65,
    ...
    public partial class BudgetByResourceGroupName : Pulumi.CustomResource
    {
        ...
        public BudgetByResourceGroupName(string name, BudgetByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180831:BudgetByResourceGroupName", name, args ?? new BudgetByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BudgetByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180831:BudgetByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
