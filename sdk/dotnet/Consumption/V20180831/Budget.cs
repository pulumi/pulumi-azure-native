...
namespace Pulumi.AzureRM.Consumption.V20180831
{
    /// <summary>
    /// A budget resource.
    /// 
    ...
    ///     public MyStack()
    ///     {
    ///         var budget = new AzureRM.Consumption.V20180831.Budget("budget", new AzureRM.Consumption.V20180831.BudgetArgs
    ///         {
    ///             Amount = 100.65,
    ///             BudgetName = "TestBudget",
    ///             Category = "Cost",
    ///             ETag = "\"1d34d016a593709\"",
    ///             Filters = new AzureRM.Consumption.V20180831.Inputs.FiltersArgs
    ///             {
    ///                 Meters = 
    ///                 {
    ...
    ///             Notifications = 
    ///             {
    ///                 { "Actual_GreaterThan_80_Percent", new AzureRM.Consumption.V20180831.Inputs.NotificationArgs
    ///                 {
    ///                     ContactEmails = 
    ///                     {
    ///                         "johndoe@contoso.com",
    ...
    ///             },
    ///             TimeGrain = "Monthly",
    ///             TimePeriod = new AzureRM.Consumption.V20180831.Inputs.BudgetTimePeriodArgs
    ///             {
    ...
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180831:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180831:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:consumption/v20171230preview:Budget"},
                    ...
                    new Pulumi.Alias { Type = "azurerm:consumption/v20181001:Budget"},
                },
            };
