...
namespace Pulumi.AzureNative.Consumption.V20180831
{
    /// <summary>
    /// A budget resource.
    /// </summary>
    [Obsolete(@"Version v20180831 will be removed in the next major version of the provider. Upgrade to version v20191001 or later.")]
    [AzureNativeResourceType("azure-native:consumption/v20180831:Budget")]
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20180831:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20180831:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:consumption/v20181001:Budget"},
                },
            };
    ...
    public sealed class BudgetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20180831.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20180831.TimeGrainType> TimeGrain { get; set; } = null!;
