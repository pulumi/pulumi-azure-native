...
namespace Pulumi.AzureNative.Consumption.V20211001
{
    ...
    /// A budget resource.
    /// </summary>
    [Obsolete(@"azure-native:consumption/v20211001:Budget is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20230501:Budget to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:consumption/v20211001:Budget")]
    public partial class Budget : global::Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20211001:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20211001:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20211001.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20211001.TimeGrainType> TimeGrain { get; set; } = null!;
