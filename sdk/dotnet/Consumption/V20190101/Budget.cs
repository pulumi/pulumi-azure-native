...
namespace Pulumi.AzureNextGen.Consumption.V20190101
{
    ...
    /// A budget resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:consumption/v20190101:Budget")]
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:consumption/v20190101:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:consumption/v20190101:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Consumption.V20190101.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Consumption.V20190101.TimeGrainType> TimeGrain { get; set; } = null!;
