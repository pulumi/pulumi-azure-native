...
namespace Pulumi.AzureNextGen.Consumption
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:consumption:Budget")]
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:consumption:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:consumption:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
