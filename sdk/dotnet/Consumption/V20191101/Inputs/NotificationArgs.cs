...
namespace Pulumi.AzureNative.Consumption.V20191101.Inputs
{
    ...
    public sealed class NotificationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20191101.OperatorType> Operator { get; set; } = null!;
        ...
        /// </summary>
        [Input("thresholdType")]
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20191101.ThresholdType>? ThresholdType { get; set; }
