...
namespace Pulumi.AzureNative.Consumption.V20190401Preview
{
    /// <summary>
    /// A budget resource.
    /// </summary>
    [Obsolete(@"Version 2019-04-01-preview will be removed in v2 of the provider.
azure-native:consumption/v20190401preview:Budget is being removed in the next major version of this provider. Please upgrade to azure-native:consumption/v20190501:Budget to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:consumption/v20190401preview:Budget")]
    public partial class Budget : global::Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20190401preview:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20190401preview:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20190401Preview.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20190401Preview.TimeGrainType> TimeGrain { get; set; } = null!;
