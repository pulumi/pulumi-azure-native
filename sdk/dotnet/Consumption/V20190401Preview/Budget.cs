...
namespace Pulumi.AzureNextGen.Consumption.V20190401Preview
{
    /// <summary>
    /// A budget resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:consumption/v20190401preview:Budget")]
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:consumption/v20190401preview:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:consumption/v20190401preview:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
