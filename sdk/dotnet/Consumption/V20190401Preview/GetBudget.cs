...
namespace Pulumi.AzureNative.Consumption.V20190401Preview
{
    ...
    public static class GetBudget
    {
        ...
        public static Task<GetBudgetResult> InvokeAsync(GetBudgetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBudgetResult>("azure-native:consumption/v20190401preview:getBudget", args ?? new GetBudgetArgs(), options.WithDefaults());

        /// <summary>
        /// A budget resource.
        /// </summary>
        public static Output<GetBudgetResult> Invoke(GetBudgetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBudgetResult>("azure-native:consumption/v20190401preview:getBudget", args ?? new GetBudgetInvokeArgs(), options.WithDefaults());
    }
