...
namespace Pulumi.AzureNative.Consumption.V20190501.Inputs
{
    ...
    public sealed class NotificationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20190501.OperatorType> Operator { get; set; } = null!;
        ...
        /// </summary>
        [Input("thresholdType")]
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20190501.ThresholdType>? ThresholdType { get; set; }
