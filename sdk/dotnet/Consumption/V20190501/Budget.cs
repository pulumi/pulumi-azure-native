...
namespace Pulumi.AzureNative.Consumption.V20190501
{
    ...
    /// {
    ///     var budget = new AzureNative.Consumption.V20190501.Budget("budget", new()
    ///     {
    ///         Amount = 100.65,
    ///         BudgetName = "TestBudget",
    ///         Category = "Cost",
    ///         ETag = "\"1d34d016a593709\"",
    ///         Filter = new AzureNative.Consumption.V20190501.Inputs.FilterArgs
    ///         {
    ///             Meters = new[]
    ///             {
    ...
    ///         Notifications = 
    ///         {
    ///             { "Actual_GreaterThan_80_Percent", new AzureNative.Consumption.V20190501.Inputs.NotificationArgs
    ///             {
    ///                 ContactEmails = new[]
    ///                 {
    ///                     "johndoe@contoso.com",
    ...
    ///         TimeGrain = "Monthly",
    ///         TimePeriod = new AzureNative.Consumption.V20190501.Inputs.BudgetTimePeriodArgs
    ///         {
    ...
    [AzureNativeResourceType("azure-native:consumption/v20190501:Budget")]
    public partial class Budget : global::Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20190501:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20190501:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20190501.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20190501.TimeGrainType> TimeGrain { get; set; } = null!;
