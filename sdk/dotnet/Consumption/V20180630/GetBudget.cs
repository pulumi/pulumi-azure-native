...
namespace Pulumi.AzureNative.Consumption.V20180630
{
    [Obsolete(@"Version v20180630 will be removed in the next major version of the provider. Upgrade to version v20191001 or later.")]
    public static class GetBudget
    {
        ...
        public static Task<GetBudgetResult> InvokeAsync(GetBudgetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBudgetResult>("azure-native:consumption/v20180630:getBudget", args ?? new GetBudgetArgs(), options.WithDefaults());

        /// <summary>
        /// A budget resource.
        /// </summary>
        public static Output<GetBudgetResult> Invoke(GetBudgetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBudgetResult>("azure-native:consumption/v20180630:getBudget", args ?? new GetBudgetInvokeArgs(), options.WithDefaults());
    }
