...
namespace Pulumi.AzureRM.Consumption.V20180630
{
    ...
    ///     public MyStack()
    ///     {
    ///         var budget = new AzureRM.Consumption.V20180630.Budget("budget", new AzureRM.Consumption.V20180630.BudgetArgs
    ///         {
    ///             Amount = 100.65,
    ...
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180630:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:consumption/v20180630:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
