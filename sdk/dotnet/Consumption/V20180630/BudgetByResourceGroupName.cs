...
namespace Pulumi.AzureNextGen.Consumption.V20180630
{
    ...
    /// A budget resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:consumption/v20180630:BudgetByResourceGroupName")]
    ...
    public sealed class BudgetByResourceGroupNameArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Consumption.V20180630.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Consumption.V20180630.TimeGrainType> TimeGrain { get; set; } = null!;
