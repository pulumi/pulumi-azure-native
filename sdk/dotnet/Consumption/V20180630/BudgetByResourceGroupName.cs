...
namespace Pulumi.AzureNative.Consumption.V20180630
{
    ...
    [AzureNativeResourceType("azure-native:consumption/v20180630:BudgetByResourceGroupName")]
    public partial class BudgetByResourceGroupName : Pulumi.CustomResource
    {
        ...
        public BudgetByResourceGroupName(string name, BudgetByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20180630:BudgetByResourceGroupName", name, args ?? new BudgetByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BudgetByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:consumption/v20180630:BudgetByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetByResourceGroupNameArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20180630.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Consumption.V20180630.TimeGrainType> TimeGrain { get; set; } = null!;
