...
namespace Pulumi.AzureRM.Consumption.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var budget = new AzureRM.Consumption.V20190601.Budget("budget", new AzureRM.Consumption.V20190601.BudgetArgs
    ///         {
    ///             Amount = 100.65,
    ///             BudgetName = "TestBudget",
    ///             Category = "Cost",
    ///             ETag = "\"1d34d016a593709\"",
    ///             Filters = new AzureRM.Consumption.V20190601.Inputs.FiltersArgs
    ///             {
    ///                 Meters = 
    ///                 {
    ...
    ///             Notifications = 
    ///             {
    ///                 { "Actual_GreaterThan_80_Percent", new AzureRM.Consumption.V20190601.Inputs.NotificationArgs
    ///                 {
    ///                     ContactEmails = 
    ///                     {
    ///                         "johndoe@contoso.com",
    ...
    ///             TimeGrain = "Monthly",
    ///             TimePeriod = new AzureRM.Consumption.V20190601.Inputs.BudgetTimePeriodArgs
    ///             {
