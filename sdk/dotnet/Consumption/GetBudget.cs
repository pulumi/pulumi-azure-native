...
namespace Pulumi.AzureRM.Consumption
{
    public static class GetBudget
    {
        public static Task<GetBudgetResult> InvokeAsync(GetBudgetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBudgetResult>("azurerm:consumption:getBudget", args ?? new GetBudgetArgs(), options.WithVersion());
    }
