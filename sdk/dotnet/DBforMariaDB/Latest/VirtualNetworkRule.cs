...
namespace Pulumi.AzureRM.DBforMariaDB.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetworkRule = new AzureRM.DBforMariaDB.Latest.VirtualNetworkRule("virtualNetworkRule", new AzureRM.DBforMariaDB.Latest.VirtualNetworkRuleArgs
    ///         {
    ...
    public partial class VirtualNetworkRule : Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRule(string name, VirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbformariadb/latest:VirtualNetworkRule", name, args ?? new VirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbformariadb/latest:VirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
