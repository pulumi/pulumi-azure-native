...
namespace Pulumi.AzureRM.DBforMariaDB.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverKey = new AzureRM.DBforMariaDB.Latest.ServerKey("serverKey", new AzureRM.DBforMariaDB.Latest.ServerKeyArgs
    ///         {
    ...
    public partial class ServerKey : Pulumi.CustomResource
    {
        ...
        public ServerKey(string name, ServerKeyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbformariadb/latest:ServerKey", name, args ?? new ServerKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbformariadb/latest:ServerKey", name, null, MakeResourceOptions(options, id))
        {
        }
