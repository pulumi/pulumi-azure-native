...
namespace Pulumi.AzureRM.DBforMariaDB.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var firewallRule = new AzureRM.DBforMariaDB.Latest.FirewallRule("firewallRule", new AzureRM.DBforMariaDB.Latest.FirewallRuleArgs
    ///         {
    ...
    public partial class FirewallRule : Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbformariadb/latest:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbformariadb/latest:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
