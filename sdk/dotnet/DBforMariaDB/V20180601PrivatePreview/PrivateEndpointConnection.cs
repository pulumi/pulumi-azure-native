...
namespace Pulumi.AzureNextGen.DBforMariaDB.V20180601PrivatePreview
{
    /// <summary>
    /// A private endpoint connection
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:dbformariadb/v20180601privatepreview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformariadb/v20180601privatepreview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformariadb/v20180601privatepreview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
