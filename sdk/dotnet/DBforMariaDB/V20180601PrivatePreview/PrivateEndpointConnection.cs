...
namespace Pulumi.AzureNative.DBforMariaDB.V20180601PrivatePreview
{
    /// <summary>
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.DBforMariaDB.V20180601PrivatePreview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "private-endpoint-connection-name",
    ///         PrivateLinkServiceConnectionState = new AzureNative.DBforMariaDB.V20180601PrivatePreview.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///         {
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601privatepreview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601privatepreview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
