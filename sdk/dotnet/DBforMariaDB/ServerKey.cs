...
namespace Pulumi.AzureNextGen.DBforMariaDB
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:dbformariadb:ServerKey")]
    public partial class ServerKey : Pulumi.CustomResource
    {
        ...
        public ServerKey(string name, ServerKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformariadb:ServerKey", name, args ?? new ServerKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformariadb:ServerKey", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerKeyArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DBforMariaDB.ServerKeyType> ServerKeyType { get; set; } = null!;
