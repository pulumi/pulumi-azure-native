...
namespace Pulumi.AzureRM.DBforMariaDB.Preview
{
    public static class GetFirewallRule
    {
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azurerm:dbformariadb/preview:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithVersion());
    }
