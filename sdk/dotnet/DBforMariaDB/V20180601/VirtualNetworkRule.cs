...
namespace Pulumi.AzureNative.DBforMariaDB.V20180601
{
    ...
    /// {
    ///     var virtualNetworkRule = new AzureNative.DBforMariaDB.V20180601.VirtualNetworkRule("virtualNetworkRule", new()
    ///     {
    ...
    public partial class VirtualNetworkRule : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetworkRule(string name, VirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601:VirtualNetworkRule", name, args ?? new VirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601:VirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
