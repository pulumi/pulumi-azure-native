...
namespace Pulumi.AzureNative.DBforMariaDB.V20180601
{
    ...
    /// {
    ///     var firewallRule = new AzureNative.DBforMariaDB.V20180601.FirewallRule("firewallRule", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:dbformariadb/v20180601:FirewallRule rule1 /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/TestGroup/providers/Microsoft.DBforMariaDB/servers/testserver/firewallRules/rule1 
    /// ```
    /// </summary>
    ...
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
