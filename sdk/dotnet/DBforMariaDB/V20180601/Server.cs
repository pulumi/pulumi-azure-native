...
namespace Pulumi.AzureNative.DBforMariaDB.V20180601
{
    ...
    /// {
    ///     var server = new AzureNative.DBforMariaDB.V20180601.Server("server", new()
    ///     {
    ///         Location = "brazilsouth",
    ///         Properties = new AzureNative.DBforMariaDB.V20180601.Inputs.ServerPropertiesForRestoreArgs
    ///         {
    ...
    ///         Sku = new AzureNative.DBforMariaDB.V20180601.Inputs.SkuArgs
    ///         {
    ///             Capacity = 2,
    ///             Family = "Gen5",
    ///             Name = "GP_Gen5_2",
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforMariaDB.V20180601.Inputs.ServerPropertiesForDefaultCreateArgs
    ///         {
    ///             AdministratorLogin = "cloudsa",
    ///             AdministratorLoginPassword = "&lt;administratorLoginPassword&gt;",
    ///             CreateMode = "Default",
    ///             MinimalTlsVersion = "TLS1_2",
    ///             SslEnforcement = AzureNative.DBforMariaDB.V20180601.SslEnforcementEnum.Enabled,
    ///             StorageProfile = new AzureNative.DBforMariaDB.V20180601.Inputs.StorageProfileArgs
    ///             {
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforMariaDB.V20180601.Inputs.ServerPropertiesForReplicaArgs
    ///         {
    ///             CreateMode = "Replica",
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforMariaDB.V20180601.Inputs.ServerPropertiesForGeoRestoreArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:dbformariadb/v20180601:Server targetserver /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testrg/providers/Microsoft.DBforMariaDB/servers/targetserver 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformariadb/v20180601:Server")]
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601:Server", name, null, MakeResourceOptions(options, id))
        {
        }
