...
namespace Pulumi.AzureNative.DBforMariaDB.V20180601
{
    public static class GetFirewallRule
    {
        ...
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azure-native:dbformariadb/v20180601:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithVersion());

        /// <summary>
        /// Represents a server firewall rule.
        /// </summary>
        public static Output<GetFirewallRuleResult> Invoke(GetFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFirewallRuleResult>("azure-native:dbformariadb/v20180601:getFirewallRule", args ?? new GetFirewallRuleInvokeArgs(), options.WithVersion());
    }
