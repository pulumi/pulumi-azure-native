...
namespace Pulumi.AzureNative.DBforMariaDB.V20180601Preview
{
    ...
    /// {
    ///     var server = new AzureNative.DBforMariaDB.V20180601Preview.Server("server", new()
    ///     {
    ///         Location = "brazilsouth",
    ///         Properties = new AzureNative.DBforMariaDB.V20180601Preview.Inputs.ServerPropertiesForRestoreArgs
    ///         {
    ...
    ///         Sku = new AzureNative.DBforMariaDB.V20180601Preview.Inputs.SkuArgs
    ///         {
    ///             Capacity = 2,
    ///             Family = "Gen5",
    ///             Name = "GP_Gen5_2",
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforMariaDB.V20180601Preview.Inputs.ServerPropertiesForDefaultCreateArgs
    ///         {
    ///             AdministratorLogin = "cloudsa",
    ///             AdministratorLoginPassword = "&lt;administratorLoginPassword&gt;",
    ///             CreateMode = "Default",
    ///             SslEnforcement = AzureNative.DBforMariaDB.V20180601Preview.SslEnforcementEnum.Enabled,
    ///             StorageProfile = new AzureNative.DBforMariaDB.V20180601Preview.Inputs.StorageProfileArgs
    ///             {
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforMariaDB.V20180601Preview.Inputs.ServerPropertiesForReplicaArgs
    ///         {
    ///             CreateMode = "Replica",
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforMariaDB.V20180601Preview.Inputs.ServerPropertiesForGeoRestoreArgs
    ///         {
    ...
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601preview:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601preview:Server", name, null, MakeResourceOptions(options, id))
        {
        }
