...
namespace Pulumi.AzureNative.DBforMariaDB.V20180601Preview
{
    ...
    /// {
    ///     var database = new AzureNative.DBforMariaDB.V20180601Preview.Database("database", new()
    ///     {
    ///         Charset = "utf8",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformariadb/v20180601preview:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformariadb/v20180601preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:dbformariadb:Database"},
