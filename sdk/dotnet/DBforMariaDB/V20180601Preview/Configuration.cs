...
namespace Pulumi.AzureNextGen.DBforMariaDB.V20180601Preview
{
    ...
    public partial class Configuration : Pulumi.CustomResource
    {
        ...
        public Configuration(string name, ConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformariadb/v20180601preview:Configuration", name, args ?? new ConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Configuration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformariadb/v20180601preview:Configuration", name, null, MakeResourceOptions(options, id))
        {
        }
