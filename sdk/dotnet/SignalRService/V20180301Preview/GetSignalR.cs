...
namespace Pulumi.AzureRM.SignalRService.V20180301Preview
{
    public static class GetSignalR
    {
        public static Task<GetSignalRResult> InvokeAsync(GetSignalRArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSignalRResult>("azurerm:signalrservice/v20180301preview:getSignalR", args ?? new GetSignalRArgs(), options.WithVersion());
    }
