...
namespace Pulumi.AzureRM.SignalRService.Inputs
{
    ...
    /// </summary>
    public sealed class SignalRPropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Cross-Origin Resource Sharing (CORS) settings.
        /// </summary>
        [Input("cors")]
        public Input<Inputs.SignalRCorsSettingsResponseGetArgs>? Cors { get; set; }
        ...
        [Input("features")]
        private InputList<Inputs.SignalRFeatureResponseGetArgs>? _features;
        ...
        /// </summary>
        public InputList<Inputs.SignalRFeatureResponseGetArgs> Features
        {
            get => _features ?? (_features = new InputList<Inputs.SignalRFeatureResponseGetArgs>());
            set => _features = value;
        }
        ...
        /// </summary>
        [Input("networkACLs")]
        public Input<Inputs.SignalRNetworkACLsResponseGetArgs>? NetworkACLs { get; set; }
        ...
        /// </summary>
        [Input("upstream")]
        public Input<Inputs.ServerlessUpstreamSettingsResponseGetArgs>? Upstream { get; set; }
        ...
        public SignalRPropertiesResponseGetArgs()
        {
        }
    }
}
