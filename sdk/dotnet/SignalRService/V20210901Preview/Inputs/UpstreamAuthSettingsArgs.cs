...
namespace Pulumi.AzureNative.SignalRService.V20210901Preview.Inputs
{
    ...
    public sealed class UpstreamAuthSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.SignalRService.V20210901Preview.UpstreamAuthType>? Type { get; set; }
