...
namespace Pulumi.AzureNative.SignalRService.V20230301Preview
{
    ...
    /// {
    ///     var signalRCustomDomain = new AzureNative.SignalRService.V20230301Preview.SignalRCustomDomain("signalRCustomDomain", new()
    ///     {
    ///         CustomCertificate = new AzureNative.SignalRService.V20230301Preview.Inputs.ResourceReferenceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20230301preview:SignalRCustomDomain")]
    public partial class SignalRCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public SignalRCustomDomain(string name, SignalRCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230301preview:SignalRCustomDomain", name, args ?? new SignalRCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230301preview:SignalRCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
