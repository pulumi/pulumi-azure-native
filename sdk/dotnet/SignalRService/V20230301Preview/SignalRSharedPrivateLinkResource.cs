...
namespace Pulumi.AzureNative.SignalRService.V20230301Preview
{
    ...
    /// {
    ///     var signalRSharedPrivateLinkResource = new AzureNative.SignalRService.V20230301Preview.SignalRSharedPrivateLinkResource("signalRSharedPrivateLinkResource", new()
    ///     {
    ///         GroupId = "sites",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20230301preview:SignalRSharedPrivateLinkResource")]
    public partial class SignalRSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SignalRSharedPrivateLinkResource(string name, SignalRSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230301preview:SignalRSharedPrivateLinkResource", name, args ?? new SignalRSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230301preview:SignalRSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
