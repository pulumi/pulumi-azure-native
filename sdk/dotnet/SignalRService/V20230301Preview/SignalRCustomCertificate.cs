...
namespace Pulumi.AzureNative.SignalRService.V20230301Preview
{
    ...
    /// {
    ///     var signalRCustomCertificate = new AzureNative.SignalRService.V20230301Preview.SignalRCustomCertificate("signalRCustomCertificate", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20230301preview:SignalRCustomCertificate")]
    public partial class SignalRCustomCertificate : global::Pulumi.CustomResource
    {
        ...
        public SignalRCustomCertificate(string name, SignalRCustomCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230301preview:SignalRCustomCertificate", name, args ?? new SignalRCustomCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRCustomCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230301preview:SignalRCustomCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
