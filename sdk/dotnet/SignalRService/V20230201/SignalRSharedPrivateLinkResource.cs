...
namespace Pulumi.AzureNative.SignalRService.V20230201
{
    ...
    /// {
    ///     var signalRSharedPrivateLinkResource = new AzureNative.SignalRService.V20230201.SignalRSharedPrivateLinkResource("signalRSharedPrivateLinkResource", new()
    ///     {
    ///         GroupId = "sites",
    ...
    public partial class SignalRSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SignalRSharedPrivateLinkResource(string name, SignalRSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230201:SignalRSharedPrivateLinkResource", name, args ?? new SignalRSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230201:SignalRSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
