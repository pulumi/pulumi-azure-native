...
namespace Pulumi.AzureNative.SignalRService.V20230201
{
    ...
    /// {
    ///     var signalRCustomCertificate = new AzureNative.SignalRService.V20230201.SignalRCustomCertificate("signalRCustomCertificate", new()
    ///     {
    ...
    public partial class SignalRCustomCertificate : global::Pulumi.CustomResource
    {
        ...
        public SignalRCustomCertificate(string name, SignalRCustomCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230201:SignalRCustomCertificate", name, args ?? new SignalRCustomCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRCustomCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230201:SignalRCustomCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
