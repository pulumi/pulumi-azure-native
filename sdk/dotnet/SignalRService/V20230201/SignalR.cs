...
namespace Pulumi.AzureNative.SignalRService.V20230201
{
    ...
    /// {
    ///     var signalR = new AzureNative.SignalRService.V20230201.SignalR("signalR", new()
    ///     {
    ///         Cors = new AzureNative.SignalRService.V20230201.Inputs.SignalRCorsSettingsArgs
    ///         {
    ///             AllowedOrigins = new[]
    ///             {
    ///                 "https://foo.com",
    ...
    ///         Features = new[]
    ///         {
    ///             new AzureNative.SignalRService.V20230201.Inputs.SignalRFeatureArgs
    ///             {
    ///                 Flag = "ServiceMode",
    ///                 Properties = null,
    ///                 Value = "Serverless",
    ...
    ///             },
    ///         },
    ///         Identity = new AzureNative.SignalRService.V20230201.Inputs.ManagedIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Kind = "SignalR",
    ///         LiveTraceConfiguration = new AzureNative.SignalRService.V20230201.Inputs.LiveTraceConfigurationArgs
    ///         {
    ///             Categories = new[]
    ///             {
    ///                 new AzureNative.SignalRService.V20230201.Inputs.LiveTraceCategoryArgs
    ///                 {
    ///                     Enabled = "true",
    ...
    ///         },
    ///         Location = "eastus",
    ///         NetworkACLs = new AzureNative.SignalRService.V20230201.Inputs.SignalRNetworkACLsArgs
    ///         {
    ///             DefaultAction = "Deny",
    ///             PrivateEndpoints = new[]
    ///             {
    ///                 new AzureNative.SignalRService.V20230201.Inputs.PrivateEndpointACLArgs
    ///                 {
    ///                     Allow = new[]
    ///                     {
    ///                         "ServerConnection",
    ...
    ///                 },
    ///             },
    ///             PublicNetwork = new AzureNative.SignalRService.V20230201.Inputs.NetworkACLArgs
    ///             {
    ///                 Allow = new[]
    ///                 {
    ///                     "ClientConnection",
    ...
    ///         Serverless = new AzureNative.SignalRService.V20230201.Inputs.ServerlessSettingsArgs
    ///         {
    ///             ConnectionTimeoutInSeconds = 5,
    ///         },
    ///         Sku = new AzureNative.SignalRService.V20230201.Inputs.ResourceSkuArgs
    ///         {
    ///             Capacity = 1,
    ///             Name = "Premium_P1",
    ///             Tier = "Premium",
    ...
    ///             { "key1", "value1" },
    ///         },
    ///         Tls = new AzureNative.SignalRService.V20230201.Inputs.SignalRTlsSettingsArgs
    ///         {
    ///             ClientCertEnabled = false,
    ///         },
    ///         Upstream = new AzureNative.SignalRService.V20230201.Inputs.ServerlessUpstreamSettingsArgs
    ///         {
    ///             Templates = new[]
    ///             {
    ///                 new AzureNative.SignalRService.V20230201.Inputs.UpstreamTemplateArgs
    ///                 {
    ///                     Auth = new AzureNative.SignalRService.V20230201.Inputs.UpstreamAuthSettingsArgs
    ///                     {
    ///                         ManagedIdentity = new AzureNative.SignalRService.V20230201.Inputs.ManagedIdentitySettingsArgs
    ///                         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20230201:SignalR")]
    public partial class SignalR : global::Pulumi.CustomResource
    {
        ...
        public SignalR(string name, SignalRArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230201:SignalR", name, args ?? new SignalRArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalR(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20230201:SignalR", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SignalRArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.SignalRService.V20230201.ServiceKind>? Kind { get; set; }
