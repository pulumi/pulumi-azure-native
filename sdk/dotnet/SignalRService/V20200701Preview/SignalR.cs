...
namespace Pulumi.AzureNextGen.SignalRService.V20200701Preview
{
    ...
    public partial class SignalR : Pulumi.CustomResource
    {
        ...
        public SignalR(string name, SignalRArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:signalrservice/v20200701preview:SignalR", name, args ?? new SignalRArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalR(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:signalrservice/v20200701preview:SignalR", name, null, MakeResourceOptions(options, id))
        {
        }
