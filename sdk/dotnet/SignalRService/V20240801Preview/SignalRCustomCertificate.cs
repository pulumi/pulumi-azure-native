...
namespace Pulumi.AzureNative.SignalRService.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20240801preview:SignalRCustomCertificate")]
    public partial class SignalRCustomCertificate : global::Pulumi.CustomResource
    {
        ...
        public SignalRCustomCertificate(string name, SignalRCustomCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240801preview:SignalRCustomCertificate", name, args ?? new SignalRCustomCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRCustomCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240801preview:SignalRCustomCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
