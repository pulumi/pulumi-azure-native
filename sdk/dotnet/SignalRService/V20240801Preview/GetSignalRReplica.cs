...
namespace Pulumi.AzureNative.SignalRService.V20240801Preview
{
    public static class GetSignalRReplica
    {
        ...
        public static Task<GetSignalRReplicaResult> InvokeAsync(GetSignalRReplicaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSignalRReplicaResult>("azure-native:signalrservice/v20240801preview:getSignalRReplica", args ?? new GetSignalRReplicaArgs(), options.WithDefaults());

        /// <summary>
        /// Get the replica and its properties.
        /// </summary>
        public static Output<GetSignalRReplicaResult> Invoke(GetSignalRReplicaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSignalRReplicaResult>("azure-native:signalrservice/v20240801preview:getSignalRReplica", args ?? new GetSignalRReplicaInvokeArgs(), options.WithDefaults());
