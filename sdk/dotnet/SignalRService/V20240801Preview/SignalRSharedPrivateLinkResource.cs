...
namespace Pulumi.AzureNative.SignalRService.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20240801preview:SignalRSharedPrivateLinkResource")]
    public partial class SignalRSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SignalRSharedPrivateLinkResource(string name, SignalRSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240801preview:SignalRSharedPrivateLinkResource", name, args ?? new SignalRSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240801preview:SignalRSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
