...
namespace Pulumi.AzureNative.SignalRService.V20240801Preview
{
    ...
    /// A custom domain
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20240801preview:SignalRCustomDomain")]
    public partial class SignalRCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public SignalRCustomDomain(string name, SignalRCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240801preview:SignalRCustomDomain", name, args ?? new SignalRCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240801preview:SignalRCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
