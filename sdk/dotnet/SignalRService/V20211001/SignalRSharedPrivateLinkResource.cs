...
namespace Pulumi.AzureNative.SignalRService.V20211001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20211001:SignalRSharedPrivateLinkResource")]
    public partial class SignalRSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SignalRSharedPrivateLinkResource(string name, SignalRSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20211001:SignalRSharedPrivateLinkResource", name, args ?? new SignalRSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20211001:SignalRSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
