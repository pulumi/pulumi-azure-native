...
namespace Pulumi.AzureNative.SignalRService.V20211001
{
    public static class GetSignalR
    {
        ...
        public static Task<GetSignalRResult> InvokeAsync(GetSignalRArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSignalRResult>("azure-native:signalrservice/v20211001:getSignalR", args ?? new GetSignalRArgs(), options.WithDefaults());

        /// <summary>
        /// A class represent a resource.
        /// </summary>
        public static Output<GetSignalRResult> Invoke(GetSignalRInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSignalRResult>("azure-native:signalrservice/v20211001:getSignalR", args ?? new GetSignalRInvokeArgs(), options.WithDefaults());
    }
