...
namespace Pulumi.AzureNative.SignalRService.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20240401preview:SignalRCustomCertificate")]
    public partial class SignalRCustomCertificate : global::Pulumi.CustomResource
    {
        ...
        public SignalRCustomCertificate(string name, SignalRCustomCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240401preview:SignalRCustomCertificate", name, args ?? new SignalRCustomCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRCustomCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240401preview:SignalRCustomCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
