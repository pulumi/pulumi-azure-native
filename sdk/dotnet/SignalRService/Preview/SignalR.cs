...
namespace Pulumi.AzureRM.SignalRService.Preview
{
    ...
    public partial class SignalR : Pulumi.CustomResource
    {
        ...
        public SignalR(string name, SignalRArgs args, CustomResourceOptions? options = null)
            : base("azurerm:signalrservice/preview:SignalR", name, args ?? new SignalRArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalR(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:signalrservice/preview:SignalR", name, null, MakeResourceOptions(options, id))
        {
        }
