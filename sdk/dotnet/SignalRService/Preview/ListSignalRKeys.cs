...
namespace Pulumi.AzureRM.SignalRService.Preview
{
    public static class ListSignalRKeys
    {
        public static Task<ListSignalRKeysResult> InvokeAsync(ListSignalRKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListSignalRKeysResult>("azurerm:signalrservice/preview:listSignalRKeys", args ?? new ListSignalRKeysArgs(), options.WithVersion());
    }
