...
namespace Pulumi.AzureNative.SignalRService.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:signalrservice/v20220801preview:SignalRSharedPrivateLinkResource is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRSharedPrivateLinkResource to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:signalrservice/v20220801preview:SignalRSharedPrivateLinkResource")]
    public partial class SignalRSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SignalRSharedPrivateLinkResource(string name, SignalRSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220801preview:SignalRSharedPrivateLinkResource", name, args ?? new SignalRSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220801preview:SignalRSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
