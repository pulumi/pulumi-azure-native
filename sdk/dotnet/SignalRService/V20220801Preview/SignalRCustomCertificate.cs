...
namespace Pulumi.AzureNative.SignalRService.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:signalrservice/v20220801preview:SignalRCustomCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRCustomCertificate to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:signalrservice/v20220801preview:SignalRCustomCertificate")]
    public partial class SignalRCustomCertificate : global::Pulumi.CustomResource
    {
        ...
        public SignalRCustomCertificate(string name, SignalRCustomCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220801preview:SignalRCustomCertificate", name, args ?? new SignalRCustomCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRCustomCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220801preview:SignalRCustomCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
