...
namespace Pulumi.AzureNative.SignalRService.V20220801Preview
{
    ...
    [AzureNativeResourceType("azure-native:signalrservice/v20220801preview:SignalR")]
    public partial class SignalR : global::Pulumi.CustomResource
    {
        ...
        public SignalR(string name, SignalRArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220801preview:SignalR", name, args ?? new SignalRArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalR(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220801preview:SignalR", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SignalRArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.SignalRService.V20220801Preview.ServiceKind>? Kind { get; set; }
