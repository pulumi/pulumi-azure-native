...
namespace Pulumi.AzureNative.SignalRService.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20240101preview:SignalRPrivateEndpointConnection")]
    public partial class SignalRPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public SignalRPrivateEndpointConnection(string name, SignalRPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240101preview:SignalRPrivateEndpointConnection", name, args ?? new SignalRPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240101preview:SignalRPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
