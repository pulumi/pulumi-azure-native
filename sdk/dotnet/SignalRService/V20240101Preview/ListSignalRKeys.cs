...
namespace Pulumi.AzureNative.SignalRService.V20240101Preview
{
    public static class ListSignalRKeys
    {
        ...
        public static Task<ListSignalRKeysResult> InvokeAsync(ListSignalRKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListSignalRKeysResult>("azure-native:signalrservice/v20240101preview:listSignalRKeys", args ?? new ListSignalRKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Get the access keys of the resource.
        /// </summary>
        public static Output<ListSignalRKeysResult> Invoke(ListSignalRKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListSignalRKeysResult>("azure-native:signalrservice/v20240101preview:listSignalRKeys", args ?? new ListSignalRKeysInvokeArgs(), options.WithDefaults());
