...
namespace Pulumi.AzureNative.SignalRService.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:signalrservice/v20210601preview:SignalRSharedPrivateLinkResource is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRSharedPrivateLinkResource to guarantee forwards compatibility.")]
    ...
    public partial class SignalRSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SignalRSharedPrivateLinkResource(string name, SignalRSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20210601preview:SignalRSharedPrivateLinkResource", name, args ?? new SignalRSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20210601preview:SignalRSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
