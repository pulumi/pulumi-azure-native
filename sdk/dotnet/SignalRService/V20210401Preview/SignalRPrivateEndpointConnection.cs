...
namespace Pulumi.AzureNative.SignalRService.V20210401Preview
{
    ...
    [AzureNativeResourceType("azure-native:signalrservice/v20210401preview:SignalRPrivateEndpointConnection")]
    public partial class SignalRPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public SignalRPrivateEndpointConnection(string name, SignalRPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20210401preview:SignalRPrivateEndpointConnection", name, args ?? new SignalRPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20210401preview:SignalRPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
