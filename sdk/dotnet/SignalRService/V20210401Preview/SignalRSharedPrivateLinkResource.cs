...
namespace Pulumi.AzureNative.SignalRService.V20210401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20210401preview:SignalRSharedPrivateLinkResource")]
    public partial class SignalRSharedPrivateLinkResource : Pulumi.CustomResource
    {
        ...
        public SignalRSharedPrivateLinkResource(string name, SignalRSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20210401preview:SignalRSharedPrivateLinkResource", name, args ?? new SignalRSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20210401preview:SignalRSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:signalrservice/v20210401preview:SignalRSharedPrivateLinkResource"},
                    new Pulumi.Alias { Type = "azure-native:signalrservice:SignalRSharedPrivateLinkResource"},
                    new Pulumi.Alias { Type = "azure-nextgen:signalrservice:SignalRSharedPrivateLinkResource"},
                    new Pulumi.Alias { Type = "azure-native:signalrservice/v20210601preview:SignalRSharedPrivateLinkResource"},
                    new Pulumi.Alias { Type = "azure-nextgen:signalrservice/v20210601preview:SignalRSharedPrivateLinkResource"},
                    new Pulumi.Alias { Type = "azure-native:signalrservice/v20210901preview:SignalRSharedPrivateLinkResource"},
                    new Pulumi.Alias { Type = "azure-nextgen:signalrservice/v20210901preview:SignalRSharedPrivateLinkResource"},
                    new Pulumi.Alias { Type = "azure-native:signalrservice/v20211001:SignalRSharedPrivateLinkResource"},
                    new Pulumi.Alias { Type = "azure-nextgen:signalrservice/v20211001:SignalRSharedPrivateLinkResource"},
                },
            };
