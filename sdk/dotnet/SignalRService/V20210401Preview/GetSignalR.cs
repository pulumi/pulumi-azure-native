...
namespace Pulumi.AzureNative.SignalRService.V20210401Preview
{
    public static class GetSignalR
    {
        ...
        public static Task<GetSignalRResult> InvokeAsync(GetSignalRArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSignalRResult>("azure-native:signalrservice/v20210401preview:getSignalR", args ?? new GetSignalRArgs(), options.WithVersion());

        /// <summary>
        /// A class represent a resource.
        /// </summary>
        public static Output<GetSignalRResult> Invoke(GetSignalRInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSignalRResult>("azure-native:signalrservice/v20210401preview:getSignalR", args ?? new GetSignalRInvokeArgs(), options.WithVersion());
    }
