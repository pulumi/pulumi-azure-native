...
namespace Pulumi.AzureNative.SignalRService.V20220201
{
    ...
    [AzureNativeResourceType("azure-native:signalrservice/v20220201:SignalRPrivateEndpointConnection")]
    public partial class SignalRPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public SignalRPrivateEndpointConnection(string name, SignalRPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220201:SignalRPrivateEndpointConnection", name, args ?? new SignalRPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220201:SignalRPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
