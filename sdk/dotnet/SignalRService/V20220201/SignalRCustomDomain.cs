...
namespace Pulumi.AzureNative.SignalRService.V20220201
{
    ...
    /// {
    ///     var signalRCustomDomain = new AzureNative.SignalRService.V20220201.SignalRCustomDomain("signalRCustomDomain", new()
    ///     {
    ///         CustomCertificate = new AzureNative.SignalRService.V20220201.Inputs.ResourceReferenceArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:signalrservice/v20220201:SignalRCustomDomain myDomain /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/Microsoft.SignalRService/SignalR/mySignalRService/customDomains/myDomain 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20220201:SignalRCustomDomain")]
    public partial class SignalRCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public SignalRCustomDomain(string name, SignalRCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220201:SignalRCustomDomain", name, args ?? new SignalRCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20220201:SignalRCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
