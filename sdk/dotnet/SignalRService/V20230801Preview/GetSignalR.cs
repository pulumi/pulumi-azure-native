...
namespace Pulumi.AzureNative.SignalRService.V20230801Preview
{
    public static class GetSignalR
    {
        ...
        public static Task<GetSignalRResult> InvokeAsync(GetSignalRArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSignalRResult>("azure-native:signalrservice/v20230801preview:getSignalR", args ?? new GetSignalRArgs(), options.WithDefaults());

        /// <summary>
        /// Get the resource and its properties.
        /// </summary>
        public static Output<GetSignalRResult> Invoke(GetSignalRInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSignalRResult>("azure-native:signalrservice/v20230801preview:getSignalR", args ?? new GetSignalRInvokeArgs(), options.WithDefaults());
    }
