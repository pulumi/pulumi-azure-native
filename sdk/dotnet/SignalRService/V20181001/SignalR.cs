...
namespace Pulumi.AzureNative.SignalRService.V20181001
{
    ...
    public partial class SignalR : Pulumi.CustomResource
    {
        ...
        public SignalR(string name, SignalRArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20181001:SignalR", name, args ?? new SignalRArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalR(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20181001:SignalR", name, null, MakeResourceOptions(options, id))
        {
        }
