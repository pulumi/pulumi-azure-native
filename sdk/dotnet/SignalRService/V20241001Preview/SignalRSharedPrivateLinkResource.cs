...
namespace Pulumi.AzureNative.SignalRService.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20241001preview:SignalRSharedPrivateLinkResource")]
    public partial class SignalRSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public SignalRSharedPrivateLinkResource(string name, SignalRSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20241001preview:SignalRSharedPrivateLinkResource", name, args ?? new SignalRSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20241001preview:SignalRSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
