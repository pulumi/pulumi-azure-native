...
namespace Pulumi.AzureNative.SignalRService.V20241001Preview
{
    public static class ListSignalRKeys
    {
        ...
        public static Task<ListSignalRKeysResult> InvokeAsync(ListSignalRKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListSignalRKeysResult>("azure-native:signalrservice/v20241001preview:listSignalRKeys", args ?? new ListSignalRKeysArgs(), options.WithDefaults());
