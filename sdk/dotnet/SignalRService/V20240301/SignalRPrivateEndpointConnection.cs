...
namespace Pulumi.AzureNative.SignalRService.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20240301:SignalRPrivateEndpointConnection")]
    public partial class SignalRPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public SignalRPrivateEndpointConnection(string name, SignalRPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240301:SignalRPrivateEndpointConnection", name, args ?? new SignalRPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalRPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240301:SignalRPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
