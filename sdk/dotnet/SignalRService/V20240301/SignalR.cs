...
namespace Pulumi.AzureNative.SignalRService.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:signalrservice/v20240301:SignalR")]
    public partial class SignalR : global::Pulumi.CustomResource
    {
        ...
        public SignalR(string name, SignalRArgs args, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240301:SignalR", name, args ?? new SignalRArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SignalR(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:signalrservice/v20240301:SignalR", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SignalRArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.SignalRService.V20240301.ServiceKind>? Kind { get; set; }
