...
namespace Pulumi.AzureNative.AzureResilienceManagement
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azureresiliencemanagement:UsagePlan")]
    public partial class UsagePlan : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.UsagePlanPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public UsagePlan(string name, UsagePlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azureresiliencemanagement:UsagePlan", name, args ?? new UsagePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UsagePlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azureresiliencemanagement:UsagePlan", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:azureresiliencemanagement/v20260301preview:UsagePlan" },
                    new global::Pulumi.Alias { Type = "azure-native:azureresiliencemanagement/v20260401preview:UsagePlan" },
                    new global::Pulumi.Alias { Type = "azure-native:azureresiliencemanagement/v20260601preview:UsagePlan" },
                },
            };
    ...
    public sealed class UsagePlanArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.UsagePlanPropertiesArgs>? Properties { get; set; }
