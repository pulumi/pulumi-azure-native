...
namespace Pulumi.AzureRM.StorageSync.Preview
{
    ...
    public partial class SyncGroup : Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/preview:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/preview:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
