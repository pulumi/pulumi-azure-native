...
namespace Pulumi.AzureRM.StorageSync.Preview
{
    ...
    public partial class RegisteredServer : Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/preview:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/preview:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
