...
namespace Pulumi.AzureRM.StorageSync.Preview
{
    public static class GetCloudEndpoint
    {
        public static Task<GetCloudEndpointResult> InvokeAsync(GetCloudEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCloudEndpointResult>("azurerm:storagesync/preview:getCloudEndpoint", args ?? new GetCloudEndpointArgs(), options.WithVersion());
    }
