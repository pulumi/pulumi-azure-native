...
namespace Pulumi.AzureRM.StorageSync.Preview
{
    /// <summary>
    ...
    public partial class StorageSyncService : Pulumi.CustomResource
    {
        ...
        public StorageSyncService(string name, StorageSyncServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/preview:StorageSyncService", name, args ?? new StorageSyncServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageSyncService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/preview:StorageSyncService", name, null, MakeResourceOptions(options, id))
        {
        }
