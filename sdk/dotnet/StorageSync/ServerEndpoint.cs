...
namespace Pulumi.AzureNextGen.StorageSync
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storagesync:ServerEndpoint")]
    public partial class ServerEndpoint : Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerEndpointArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cloudTiering")]
        public InputUnion<string, Pulumi.AzureNextGen.StorageSync.FeatureStatus>? CloudTiering { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.StorageSync.InitialDownloadPolicy>? InitialDownloadPolicy { get; set; }

        /// <summary>
        /// Policy for enabling follow-the-sun business models: link local cache to cloud behavior to pre-populate before local access.
        /// </summary>
        [Input("localCacheMode")]
        public InputUnion<string, Pulumi.AzureNextGen.StorageSync.LocalCacheMode>? LocalCacheMode { get; set; }

        /// <summary>
        /// Offline data transfer
        /// </summary>
        [Input("offlineDataTransfer")]
        public InputUnion<string, Pulumi.AzureNextGen.StorageSync.FeatureStatus>? OfflineDataTransfer { get; set; }
