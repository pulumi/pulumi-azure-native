...
namespace Pulumi.AzureRM.StorageSync.V20200301
{
    ...
    public partial class ServerEndpoint : Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20200301:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20200301:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:storagesync/v20180402:ServerEndpoint"},
                    new Alias { Type = "azurerm:storagesync/v20180701:ServerEndpoint"},
                    new Alias { Type = "azurerm:storagesync/v20181001:ServerEndpoint"},
                    new Alias { Type = "azurerm:storagesync/v20190201:ServerEndpoint"},
                    new Alias { Type = "azurerm:storagesync/v20190301:ServerEndpoint"},
                    new Alias { Type = "azurerm:storagesync/v20190601:ServerEndpoint"},
                    new Alias { Type = "azurerm:storagesync/v20191001:ServerEndpoint"},
                },
            };
