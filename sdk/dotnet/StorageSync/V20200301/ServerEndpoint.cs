...
namespace Pulumi.AzureRM.StorageSync.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverEndpoint = new AzureRM.StorageSync.V20200301.ServerEndpoint("serverEndpoint", new AzureRM.StorageSync.V20200301.ServerEndpointArgs
    ///         {
    ///             CloudTiering = "off",
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:storagesync/v20181001:ServerEndpoint"},
