...
namespace Pulumi.AzureNative.StorageSync.V20220901.Inputs
{
    ...
    public sealed class PrivateLinkServiceConnectionStateArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.StorageSync.V20220901.PrivateEndpointServiceConnectionStatus>? Status { get; set; }
