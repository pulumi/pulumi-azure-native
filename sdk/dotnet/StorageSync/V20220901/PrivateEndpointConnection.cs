...
namespace Pulumi.AzureNative.StorageSync.V20220901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagesync/v20220901:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
