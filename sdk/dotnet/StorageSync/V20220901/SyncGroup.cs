...
namespace Pulumi.AzureNative.StorageSync.V20220901
{
    /// <summary>
    /// Sync Group object.
    /// </summary>
    [AzureNativeResourceType("azure-native:storagesync/v20220901:SyncGroup")]
    public partial class SyncGroup : global::Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
