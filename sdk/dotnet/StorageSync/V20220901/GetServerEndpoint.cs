...
namespace Pulumi.AzureNative.StorageSync.V20220901
{
    public static class GetServerEndpoint
    {
        ...
        public static Task<GetServerEndpointResult> InvokeAsync(GetServerEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerEndpointResult>("azure-native:storagesync/v20220901:getServerEndpoint", args ?? new GetServerEndpointArgs(), options.WithDefaults());
