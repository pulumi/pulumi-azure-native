...
namespace Pulumi.AzureNative.StorageSync.V20220901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagesync/v20220901:StorageSyncService")]
    public partial class StorageSyncService : global::Pulumi.CustomResource
    {
        ...
        public StorageSyncService(string name, StorageSyncServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:StorageSyncService", name, args ?? new StorageSyncServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageSyncService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:StorageSyncService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageSyncServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageSync.V20220901.IncomingTrafficPolicy>? IncomingTrafficPolicy { get; set; }
