...
namespace Pulumi.AzureNative.StorageSync.V20220901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagesync/v20220901:ServerEndpoint")]
    public partial class ServerEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cloudTiering")]
        public InputUnion<string, Pulumi.AzureNative.StorageSync.V20220901.FeatureStatus>? CloudTiering { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageSync.V20220901.InitialDownloadPolicy>? InitialDownloadPolicy { get; set; }

        /// <summary>
        /// Policy for how the initial upload sync session is performed.
        /// </summary>
        [Input("initialUploadPolicy")]
        public InputUnion<string, Pulumi.AzureNative.StorageSync.V20220901.InitialUploadPolicy>? InitialUploadPolicy { get; set; }

        /// <summary>
        /// Policy for enabling follow-the-sun business models: link local cache to cloud behavior to pre-populate before local access.
        /// </summary>
        [Input("localCacheMode")]
        public InputUnion<string, Pulumi.AzureNative.StorageSync.V20220901.LocalCacheMode>? LocalCacheMode { get; set; }

        /// <summary>
        /// Offline data transfer
        /// </summary>
        [Input("offlineDataTransfer")]
        public InputUnion<string, Pulumi.AzureNative.StorageSync.V20220901.FeatureStatus>? OfflineDataTransfer { get; set; }
