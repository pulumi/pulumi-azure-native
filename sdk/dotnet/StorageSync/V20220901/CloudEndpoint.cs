...
namespace Pulumi.AzureNative.StorageSync.V20220901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagesync/v20220901:CloudEndpoint")]
    public partial class CloudEndpoint : global::Pulumi.CustomResource
    {
        ...
        public CloudEndpoint(string name, CloudEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:CloudEndpoint", name, args ?? new CloudEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220901:CloudEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
