...
namespace Pulumi.AzureRM.StorageSync.V20170605Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var storageSyncService = new AzureRM.StorageSync.V20170605Preview.StorageSyncService("storageSyncService", new AzureRM.StorageSync.V20170605Preview.StorageSyncServiceArgs
    ///         {
    ///             Location = "WestUS",
    ...
    public partial class StorageSyncService : Pulumi.CustomResource
    {
        ...
        public StorageSyncService(string name, StorageSyncServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20170605preview:StorageSyncService", name, args ?? new StorageSyncServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageSyncService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20170605preview:StorageSyncService", name, null, MakeResourceOptions(options, id))
        {
        }
