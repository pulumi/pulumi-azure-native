...
namespace Pulumi.AzureNative.StorageSync.V20170605Preview
{
    ...
    public partial class CloudEndpoint : Pulumi.CustomResource
    {
        ...
        public CloudEndpoint(string name, CloudEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20170605preview:CloudEndpoint", name, args ?? new CloudEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20170605preview:CloudEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
