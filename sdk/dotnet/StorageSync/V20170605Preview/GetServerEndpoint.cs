...
namespace Pulumi.AzureRM.StorageSync.V20170605Preview
{
    public static class GetServerEndpoint
    {
        public static Task<GetServerEndpointResult> InvokeAsync(GetServerEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerEndpointResult>("azurerm:storagesync/v20170605preview:getServerEndpoint", args ?? new GetServerEndpointArgs(), options.WithVersion());
    }
