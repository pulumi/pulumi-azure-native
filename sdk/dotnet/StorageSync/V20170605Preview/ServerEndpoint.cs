...
namespace Pulumi.AzureRM.StorageSync.V20170605Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverEndpoint = new AzureRM.StorageSync.V20170605Preview.ServerEndpoint("serverEndpoint", new AzureRM.StorageSync.V20170605Preview.ServerEndpointArgs
    ///         {
    ///             CloudTiering = "off",
    ...
    public partial class ServerEndpoint : Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20170605preview:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20170605preview:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
