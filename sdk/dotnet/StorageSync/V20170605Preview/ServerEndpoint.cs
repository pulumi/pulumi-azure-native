...
namespace Pulumi.AzureNative.StorageSync.V20170605Preview
{
    ...
    /// {
    ///     var serverEndpoint = new AzureNative.StorageSync.V20170605Preview.ServerEndpoint("serverEndpoint", new()
    ///     {
    ///         CloudTiering = "off",
    ...
    [AzureNativeResourceType("azure-native:storagesync/v20170605preview:ServerEndpoint")]
    public partial class ServerEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20170605preview:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20170605preview:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
