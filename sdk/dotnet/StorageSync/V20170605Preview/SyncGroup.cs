...
namespace Pulumi.AzureRM.StorageSync.V20170605Preview
{
    /// <summary>
    /// Sync Group object.
    /// 
    ...
    ///     public MyStack()
    ///     {
    ///         var syncGroup = new AzureRM.StorageSync.V20170605Preview.SyncGroup("syncGroup", new AzureRM.StorageSync.V20170605Preview.SyncGroupArgs
    ///         {
    ...
    public partial class SyncGroup : Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20170605preview:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20170605preview:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
