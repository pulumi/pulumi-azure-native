...
namespace Pulumi.AzureNative.StorageSync.V20170605Preview
{
    ...
    /// {
    ///     var syncGroup = new AzureNative.StorageSync.V20170605Preview.SyncGroup("syncGroup", new()
    ///     {
    ...
    [AzureNativeResourceType("azure-native:storagesync/v20170605preview:SyncGroup")]
    public partial class SyncGroup : global::Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20170605preview:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20170605preview:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
