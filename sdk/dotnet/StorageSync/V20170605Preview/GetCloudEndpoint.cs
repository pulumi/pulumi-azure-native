...
namespace Pulumi.AzureRM.StorageSync.V20170605Preview
{
    public static class GetCloudEndpoint
    {
        public static Task<GetCloudEndpointResult> InvokeAsync(GetCloudEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCloudEndpointResult>("azurerm:storagesync/v20170605preview:getCloudEndpoint", args ?? new GetCloudEndpointArgs(), options.WithVersion());
    }
