...
namespace Pulumi.AzureRM.StorageSync.V20170605Preview
{
    public static class GetStorageSyncService
    {
        public static Task<GetStorageSyncServiceResult> InvokeAsync(GetStorageSyncServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageSyncServiceResult>("azurerm:storagesync/v20170605preview:getStorageSyncService", args ?? new GetStorageSyncServiceArgs(), options.WithVersion());
    }
