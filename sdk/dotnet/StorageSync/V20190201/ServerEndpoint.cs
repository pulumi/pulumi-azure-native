...
namespace Pulumi.AzureNative.StorageSync.V20190201
{
    ...
    public partial class ServerEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190201:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190201:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
