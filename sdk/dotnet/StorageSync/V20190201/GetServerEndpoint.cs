...
namespace Pulumi.AzureNextGen.StorageSync.V20190201
{
    public static class GetServerEndpoint
    {
        public static Task<GetServerEndpointResult> InvokeAsync(GetServerEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerEndpointResult>("azure-nextgen:storagesync/v20190201:getServerEndpoint", args ?? new GetServerEndpointArgs(), options.WithVersion());
    }
