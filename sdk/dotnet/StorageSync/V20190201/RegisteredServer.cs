...
namespace Pulumi.AzureNative.StorageSync.V20190201
{
    ...
    [AzureNativeResourceType("azure-native:storagesync/v20190201:RegisteredServer")]
    public partial class RegisteredServer : global::Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190201:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190201:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
