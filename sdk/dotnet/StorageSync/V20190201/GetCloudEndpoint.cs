...
namespace Pulumi.AzureNative.StorageSync.V20190201
{
    ...
    public static class GetCloudEndpoint
    {
        ...
        public static Task<GetCloudEndpointResult> InvokeAsync(GetCloudEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCloudEndpointResult>("azure-native:storagesync/v20190201:getCloudEndpoint", args ?? new GetCloudEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Cloud Endpoint object.
        /// </summary>
        public static Output<GetCloudEndpointResult> Invoke(GetCloudEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCloudEndpointResult>("azure-native:storagesync/v20190201:getCloudEndpoint", args ?? new GetCloudEndpointInvokeArgs(), options.WithDefaults());
    }
