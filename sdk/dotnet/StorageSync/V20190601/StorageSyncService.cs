...
namespace Pulumi.AzureRM.StorageSync.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var storageSyncService = new AzureRM.StorageSync.V20190601.StorageSyncService("storageSyncService", new AzureRM.StorageSync.V20190601.StorageSyncServiceArgs
    ///         {
    ///             Location = "WestUS",
    ...
    public partial class StorageSyncService : Pulumi.CustomResource
    {
        ...
        public StorageSyncService(string name, StorageSyncServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190601:StorageSyncService", name, args ?? new StorageSyncServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageSyncService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190601:StorageSyncService", name, null, MakeResourceOptions(options, id))
        {
        }
