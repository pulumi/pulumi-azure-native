...
namespace Pulumi.AzureRM.StorageSync.V20190601
{
    public static class GetRegisteredServer
    {
        public static Task<GetRegisteredServerResult> InvokeAsync(GetRegisteredServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegisteredServerResult>("azurerm:storagesync/v20190601:getRegisteredServer", args ?? new GetRegisteredServerArgs(), options.WithVersion());
    }
