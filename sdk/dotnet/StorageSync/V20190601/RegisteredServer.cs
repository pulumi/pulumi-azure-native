...
namespace Pulumi.AzureNative.StorageSync.V20190601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagesync/v20190601:RegisteredServer")]
    public partial class RegisteredServer : Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190601:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190601:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
