...
namespace Pulumi.AzureRM.StorageSync.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var syncGroup = new AzureRM.StorageSync.V20190601.SyncGroup("syncGroup", new AzureRM.StorageSync.V20190601.SyncGroupArgs
    ///         {
    ...
    public partial class SyncGroup : Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190601:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190601:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
