...
namespace Pulumi.AzureRM.StorageSync.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cloudEndpoint = new AzureRM.StorageSync.V20190601.CloudEndpoint("cloudEndpoint", new AzureRM.StorageSync.V20190601.CloudEndpointArgs
    ///         {
    ...
    public partial class CloudEndpoint : Pulumi.CustomResource
    {
        ...
        public CloudEndpoint(string name, CloudEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190601:CloudEndpoint", name, args ?? new CloudEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190601:CloudEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
