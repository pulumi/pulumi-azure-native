...
namespace Pulumi.AzureNextGen.StorageSync.V20190601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storagesync/v20190601:CloudEndpoint")]
    public partial class CloudEndpoint : Pulumi.CustomResource
    {
        ...
        public CloudEndpoint(string name, CloudEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync/v20190601:CloudEndpoint", name, args ?? new CloudEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync/v20190601:CloudEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
