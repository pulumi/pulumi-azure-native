...
namespace Pulumi.AzureRM.StorageSync.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverEndpoint = new AzureRM.StorageSync.V20190601.ServerEndpoint("serverEndpoint", new AzureRM.StorageSync.V20190601.ServerEndpointArgs
    ///         {
    ///             CloudTiering = "off",
    ...
    public partial class ServerEndpoint : Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190601:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190601:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
