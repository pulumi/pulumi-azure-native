...
namespace Pulumi.AzureNative.StorageSync.V20190601
{
    public static class GetStorageSyncService
    {
        ...
        public static Task<GetStorageSyncServiceResult> InvokeAsync(GetStorageSyncServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageSyncServiceResult>("azure-native:storagesync/v20190601:getStorageSyncService", args ?? new GetStorageSyncServiceArgs(), options.WithVersion());

        /// <summary>
        /// Storage Sync Service object.
        /// </summary>
        public static Output<GetStorageSyncServiceResult> Invoke(GetStorageSyncServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStorageSyncServiceResult>("azure-native:storagesync/v20190601:getStorageSyncService", args ?? new GetStorageSyncServiceInvokeArgs(), options.WithVersion());
    }
