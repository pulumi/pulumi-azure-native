...
namespace Pulumi.AzureRM.StorageSync.V20180402
{
    ...
    public partial class RegisteredServer : Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20180402:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20180402:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:storagesync/v20180701:RegisteredServer"},
                    new Alias { Type = "azurerm:storagesync/v20181001:RegisteredServer"},
                    new Alias { Type = "azurerm:storagesync/v20190201:RegisteredServer"},
                    new Alias { Type = "azurerm:storagesync/v20190301:RegisteredServer"},
                    new Alias { Type = "azurerm:storagesync/v20190601:RegisteredServer"},
                    new Alias { Type = "azurerm:storagesync/v20191001:RegisteredServer"},
                    new Alias { Type = "azurerm:storagesync/v20200301:RegisteredServer"},
                },
            };
