...
namespace Pulumi.AzureNextGen.StorageSync.V20180402
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storagesync/v20180402:StorageSyncService")]
    public partial class StorageSyncService : Pulumi.CustomResource
    {
        ...
        public StorageSyncService(string name, StorageSyncServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync/v20180402:StorageSyncService", name, args ?? new StorageSyncServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageSyncService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync/v20180402:StorageSyncService", name, null, MakeResourceOptions(options, id))
        {
        }
