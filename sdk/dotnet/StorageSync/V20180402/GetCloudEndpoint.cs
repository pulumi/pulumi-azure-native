...
namespace Pulumi.AzureRM.StorageSync.V20180402
{
    public static class GetCloudEndpoint
    {
        public static Task<GetCloudEndpointResult> InvokeAsync(GetCloudEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCloudEndpointResult>("azurerm:storagesync/v20180402:getCloudEndpoint", args ?? new GetCloudEndpointArgs(), options.WithVersion());
    }
