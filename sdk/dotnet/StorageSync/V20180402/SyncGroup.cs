...
namespace Pulumi.AzureNative.StorageSync.V20180402
{
    ...
    /// {
    ///     var syncGroup = new AzureNative.StorageSync.V20180402.SyncGroup("syncGroup", new()
    ///     {
    ...
    public partial class SyncGroup : global::Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20180402:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20180402:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
