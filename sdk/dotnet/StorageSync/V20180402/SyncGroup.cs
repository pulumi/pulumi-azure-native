...
namespace Pulumi.AzureRM.StorageSync.V20180402
{
    ...
    ///     public MyStack()
    ///     {
    ///         var syncGroup = new AzureRM.StorageSync.V20180402.SyncGroup("syncGroup", new AzureRM.StorageSync.V20180402.SyncGroupArgs
    ///         {
    ...
    public partial class SyncGroup : Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20180402:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20180402:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
