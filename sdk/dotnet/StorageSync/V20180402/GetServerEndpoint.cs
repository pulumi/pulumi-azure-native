...
namespace Pulumi.AzureRM.StorageSync.V20180402
{
    public static class GetServerEndpoint
    {
        public static Task<GetServerEndpointResult> InvokeAsync(GetServerEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerEndpointResult>("azurerm:storagesync/v20180402:getServerEndpoint", args ?? new GetServerEndpointArgs(), options.WithVersion());
    }
