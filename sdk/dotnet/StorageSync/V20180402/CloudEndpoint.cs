...
namespace Pulumi.AzureNative.StorageSync.V20180402
{
    ...
    /// {
    ///     var cloudEndpoint = new AzureNative.StorageSync.V20180402.CloudEndpoint("cloudEndpoint", new()
    ///     {
    ...
    [AzureNativeResourceType("azure-native:storagesync/v20180402:CloudEndpoint")]
    public partial class CloudEndpoint : global::Pulumi.CustomResource
    {
        ...
        public CloudEndpoint(string name, CloudEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20180402:CloudEndpoint", name, args ?? new CloudEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20180402:CloudEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
