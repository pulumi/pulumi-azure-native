...
namespace Pulumi.AzureNative.StorageSync.V20190301
{
    ...
    [AzureNativeResourceType("azure-native:storagesync/v20190301:SyncGroup")]
    public partial class SyncGroup : Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190301:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190301:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
