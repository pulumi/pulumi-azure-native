...
namespace Pulumi.AzureRM.StorageSync.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var registeredServer = new AzureRM.StorageSync.V20190301.RegisteredServer("registeredServer", new AzureRM.StorageSync.V20190301.RegisteredServerArgs
    ///         {
    ...
    public partial class RegisteredServer : Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190301:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20190301:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
