...
namespace Pulumi.AzureNextGen.StorageSync.V20190301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storagesync/v20190301:RegisteredServer")]
    public partial class RegisteredServer : Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync/v20190301:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync/v20190301:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
