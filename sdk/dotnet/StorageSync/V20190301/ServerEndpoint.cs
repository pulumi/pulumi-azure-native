...
azure-native:storagesync/v20190301:ServerEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:storagesync/v20191001:ServerEndpoint to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storagesync/v20190301:ServerEndpoint")]
    public partial class ServerEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190301:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20190301:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
