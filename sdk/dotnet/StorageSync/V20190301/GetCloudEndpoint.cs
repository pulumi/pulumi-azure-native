...
azure-native:storagesync/v20190301:CloudEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:CloudEndpoint to guarantee forwards compatibility.")]
    public static class GetCloudEndpoint
    {
        ...
        public static Task<GetCloudEndpointResult> InvokeAsync(GetCloudEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCloudEndpointResult>("azure-native:storagesync/v20190301:getCloudEndpoint", args ?? new GetCloudEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Get a given CloudEndpoint.
        /// </summary>
        public static Output<GetCloudEndpointResult> Invoke(GetCloudEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCloudEndpointResult>("azure-native:storagesync/v20190301:getCloudEndpoint", args ?? new GetCloudEndpointInvokeArgs(), options.WithDefaults());
    }
