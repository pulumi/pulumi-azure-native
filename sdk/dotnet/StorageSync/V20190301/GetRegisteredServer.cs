...
namespace Pulumi.AzureNative.StorageSync.V20190301
{
    public static class GetRegisteredServer
    {
        ...
        public static Task<GetRegisteredServerResult> InvokeAsync(GetRegisteredServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegisteredServerResult>("azure-native:storagesync/v20190301:getRegisteredServer", args ?? new GetRegisteredServerArgs(), options.WithVersion());

        /// <summary>
        /// Registered Server resource.
        /// </summary>
        public static Output<GetRegisteredServerResult> Invoke(GetRegisteredServerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegisteredServerResult>("azure-native:storagesync/v20190301:getRegisteredServer", args ?? new GetRegisteredServerInvokeArgs(), options.WithVersion());
    }
