...
namespace Pulumi.AzureNative.StorageSync.V20191001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:storagesync/v20191001:RegisteredServer")]
    public partial class RegisteredServer : Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20191001:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20191001:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
