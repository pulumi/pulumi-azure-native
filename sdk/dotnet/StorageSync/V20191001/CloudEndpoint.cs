...
azure-native:storagesync/v20191001:CloudEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:storagesync/v20220601:CloudEndpoint to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storagesync/v20191001:CloudEndpoint")]
    public partial class CloudEndpoint : global::Pulumi.CustomResource
    {
        ...
        public CloudEndpoint(string name, CloudEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20191001:CloudEndpoint", name, args ?? new CloudEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20191001:CloudEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
