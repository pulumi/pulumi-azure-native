...
namespace Pulumi.AzureNative.StorageSync.V20191001
{
    ...
    public static class GetSyncGroup
    {
        ...
        public static Task<GetSyncGroupResult> InvokeAsync(GetSyncGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSyncGroupResult>("azure-native:storagesync/v20191001:getSyncGroup", args ?? new GetSyncGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Sync Group object.
        /// </summary>
        public static Output<GetSyncGroupResult> Invoke(GetSyncGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSyncGroupResult>("azure-native:storagesync/v20191001:getSyncGroup", args ?? new GetSyncGroupInvokeArgs(), options.WithDefaults());
    }
