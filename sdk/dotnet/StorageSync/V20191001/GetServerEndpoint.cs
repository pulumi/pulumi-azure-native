...
namespace Pulumi.AzureNextGen.StorageSync.V20191001
{
    public static class GetServerEndpoint
    {
        public static Task<GetServerEndpointResult> InvokeAsync(GetServerEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerEndpointResult>("azure-nextgen:storagesync/v20191001:getServerEndpoint", args ?? new GetServerEndpointArgs(), options.WithVersion());
    }
