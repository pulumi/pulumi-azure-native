...
namespace Pulumi.AzureRM.StorageSync.V20191001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var storageSyncService = new AzureRM.StorageSync.V20191001.StorageSyncService("storageSyncService", new AzureRM.StorageSync.V20191001.StorageSyncServiceArgs
    ///         {
    ///             Location = "WestUS",
    ...
    public partial class StorageSyncService : Pulumi.CustomResource
    {
        ...
        public StorageSyncService(string name, StorageSyncServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20191001:StorageSyncService", name, args ?? new StorageSyncServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageSyncService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20191001:StorageSyncService", name, null, MakeResourceOptions(options, id))
        {
        }
