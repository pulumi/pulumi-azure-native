...
namespace Pulumi.AzureRM.StorageSync.V20191001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverEndpoint = new AzureRM.StorageSync.V20191001.ServerEndpoint("serverEndpoint", new AzureRM.StorageSync.V20191001.ServerEndpointArgs
    ///         {
    ///             CloudTiering = "off",
    ...
    public partial class ServerEndpoint : Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20191001:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20191001:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
