...
namespace Pulumi.AzureNextGen.StorageSync.V20191001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storagesync/v20191001:ServerEndpoint")]
    public partial class ServerEndpoint : Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync/v20191001:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync/v20191001:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
