...
namespace Pulumi.AzureRM.StorageSync.V20191001
{
    public static class GetStorageSyncService
    {
        public static Task<GetStorageSyncServiceResult> InvokeAsync(GetStorageSyncServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageSyncServiceResult>("azurerm:storagesync/v20191001:getStorageSyncService", args ?? new GetStorageSyncServiceArgs(), options.WithVersion());
    }
