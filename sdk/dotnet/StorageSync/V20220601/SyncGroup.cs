...
namespace Pulumi.AzureNative.StorageSync.V20220601
{
    ...
    /// {
    ///     var syncGroup = new AzureNative.StorageSync.V20220601.SyncGroup("syncGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storagesync/v20220601:SyncGroup")]
    public partial class SyncGroup : global::Pulumi.CustomResource
    {
        ...
        public SyncGroup(string name, SyncGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220601:SyncGroup", name, args ?? new SyncGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SyncGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220601:SyncGroup", name, null, MakeResourceOptions(options, id))
        {
        }
