...
namespace Pulumi.AzureNative.StorageSync.V20220601
{
    ...
    /// {
    ///     var registeredServer = new AzureNative.StorageSync.V20220601.RegisteredServer("registeredServer", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:storagesync/v20220601:RegisteredServer")]
    public partial class RegisteredServer : global::Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220601:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20220601:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
