...
namespace Pulumi.AzureNative.StorageSync.V20220601.Inputs
{
    ...
    public sealed class PrivateLinkServiceConnectionStateArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.StorageSync.V20220601.PrivateEndpointServiceConnectionStatus>? Status { get; set; }
