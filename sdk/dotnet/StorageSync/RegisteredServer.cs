...
namespace Pulumi.AzureNextGen.StorageSync
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:storagesync:RegisteredServer")]
    public partial class RegisteredServer : Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:storagesync:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
