...
namespace Pulumi.AzureNative.StorageSync.V20200901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storagesync/v20200901:StorageSyncService is being removed in the next major version of this provider. Please upgrade to azure-native:storagesync/v20220601:StorageSyncService to guarantee forwards compatibility.")]
    ...
    public partial class StorageSyncService : global::Pulumi.CustomResource
    {
        ...
        public StorageSyncService(string name, StorageSyncServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20200901:StorageSyncService", name, args ?? new StorageSyncServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageSyncService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20200901:StorageSyncService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StorageSyncServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StorageSync.V20200901.IncomingTrafficPolicy>? IncomingTrafficPolicy { get; set; }
