...
namespace Pulumi.AzureNextGen.StorageSync.V20200901.Inputs
{
    ...
    public sealed class PrivateLinkServiceConnectionStateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNextGen.StorageSync.V20200901.PrivateEndpointServiceConnectionStatus>? Status { get; set; }
