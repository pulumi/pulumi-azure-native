...
namespace Pulumi.AzureNative.StorageSync.V20200901
{
    public static class GetStorageSyncService
    {
        ...
        public static Task<GetStorageSyncServiceResult> InvokeAsync(GetStorageSyncServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageSyncServiceResult>("azure-native:storagesync/v20200901:getStorageSyncService", args ?? new GetStorageSyncServiceArgs(), options.WithVersion());

        /// <summary>
        /// Storage Sync Service object.
        /// </summary>
        public static Output<GetStorageSyncServiceResult> Invoke(GetStorageSyncServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStorageSyncServiceResult>("azure-native:storagesync/v20200901:getStorageSyncService", args ?? new GetStorageSyncServiceInvokeArgs(), options.WithVersion());
    }
