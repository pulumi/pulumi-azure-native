...
namespace Pulumi.AzureNative.StorageSync.V20200901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:storagesync/v20200901:RegisteredServer is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:RegisteredServer to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:storagesync/v20200901:RegisteredServer")]
    public partial class RegisteredServer : global::Pulumi.CustomResource
    {
        ...
        public RegisteredServer(string name, RegisteredServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20200901:RegisteredServer", name, args ?? new RegisteredServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20200901:RegisteredServer", name, null, MakeResourceOptions(options, id))
        {
        }
