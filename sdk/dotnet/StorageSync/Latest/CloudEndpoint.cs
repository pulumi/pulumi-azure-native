...
namespace Pulumi.AzureRM.StorageSync.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cloudEndpoint = new AzureRM.StorageSync.Latest.CloudEndpoint("cloudEndpoint", new AzureRM.StorageSync.Latest.CloudEndpointArgs
    ///         {
    ...
    public partial class CloudEndpoint : Pulumi.CustomResource
    {
        ...
        public CloudEndpoint(string name, CloudEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/latest:CloudEndpoint", name, args ?? new CloudEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/latest:CloudEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
