...
namespace Pulumi.AzureRM.StorageSync.V20181001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cloudEndpoint = new AzureRM.StorageSync.V20181001.CloudEndpoint("cloudEndpoint", new AzureRM.StorageSync.V20181001.CloudEndpointArgs
    ///         {
    ...
    public partial class CloudEndpoint : Pulumi.CustomResource
    {
        ...
        public CloudEndpoint(string name, CloudEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20181001:CloudEndpoint", name, args ?? new CloudEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20181001:CloudEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
