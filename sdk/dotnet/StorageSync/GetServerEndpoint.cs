...
namespace Pulumi.AzureRM.StorageSync
{
    public static class GetServerEndpoint
    {
        public static Task<GetServerEndpointResult> InvokeAsync(GetServerEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerEndpointResult>("azurerm:storagesync:getServerEndpoint", args ?? new GetServerEndpointArgs(), options.WithVersion());
    }
