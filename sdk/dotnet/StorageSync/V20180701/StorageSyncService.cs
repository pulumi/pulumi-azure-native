...
namespace Pulumi.AzureNative.StorageSync.V20180701
{
    ...
    public partial class StorageSyncService : global::Pulumi.CustomResource
    {
        ...
        public StorageSyncService(string name, StorageSyncServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20180701:StorageSyncService", name, args ?? new StorageSyncServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageSyncService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20180701:StorageSyncService", name, null, MakeResourceOptions(options, id))
        {
        }
