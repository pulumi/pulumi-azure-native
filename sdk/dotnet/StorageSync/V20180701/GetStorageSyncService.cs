...
azure-native:storagesync/v20180701:StorageSyncService is being removed in the next major version of this provider. Please upgrade to azure-native:storagesync/v20191001:StorageSyncService to guarantee forwards compatibility.")]
    public static class GetStorageSyncService
    {
        ...
        public static Task<GetStorageSyncServiceResult> InvokeAsync(GetStorageSyncServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageSyncServiceResult>("azure-native:storagesync/v20180701:getStorageSyncService", args ?? new GetStorageSyncServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Get a given StorageSyncService.
        /// </summary>
        public static Output<GetStorageSyncServiceResult> Invoke(GetStorageSyncServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageSyncServiceResult>("azure-native:storagesync/v20180701:getStorageSyncService", args ?? new GetStorageSyncServiceInvokeArgs(), options.WithDefaults());
    }
