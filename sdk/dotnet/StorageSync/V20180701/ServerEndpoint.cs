...
namespace Pulumi.AzureNative.StorageSync.V20180701
{
    ...
    /// {
    ///     var serverEndpoint = new AzureNative.StorageSync.V20180701.ServerEndpoint("serverEndpoint", new()
    ///     {
    ///         CloudTiering = "off",
    ...
    [AzureNativeResourceType("azure-native:storagesync/v20180701:ServerEndpoint")]
    public partial class ServerEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ServerEndpoint(string name, ServerEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20180701:ServerEndpoint", name, args ?? new ServerEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:storagesync/v20180701:ServerEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
