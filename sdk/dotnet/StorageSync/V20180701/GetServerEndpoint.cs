...
namespace Pulumi.AzureNative.StorageSync.V20180701
{
    ...
    public static class GetServerEndpoint
    {
        ...
        public static Task<GetServerEndpointResult> InvokeAsync(GetServerEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerEndpointResult>("azure-native:storagesync/v20180701:getServerEndpoint", args ?? new GetServerEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Server Endpoint object.
        /// </summary>
        public static Output<GetServerEndpointResult> Invoke(GetServerEndpointInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServerEndpointResult>("azure-native:storagesync/v20180701:getServerEndpoint", args ?? new GetServerEndpointInvokeArgs(), options.WithDefaults());
    }
