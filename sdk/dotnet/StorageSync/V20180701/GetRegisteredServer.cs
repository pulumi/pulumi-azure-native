...
namespace Pulumi.AzureNative.StorageSync.V20180701
{
    ...
    public static class GetRegisteredServer
    {
        ...
        public static Task<GetRegisteredServerResult> InvokeAsync(GetRegisteredServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegisteredServerResult>("azure-native:storagesync/v20180701:getRegisteredServer", args ?? new GetRegisteredServerArgs(), options.WithDefaults());

        /// <summary>
        /// Get a given registered server.
        /// </summary>
        public static Output<GetRegisteredServerResult> Invoke(GetRegisteredServerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegisteredServerResult>("azure-native:storagesync/v20180701:getRegisteredServer", args ?? new GetRegisteredServerInvokeArgs(), options.WithDefaults());
    }
