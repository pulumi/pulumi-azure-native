...
namespace Pulumi.AzureNative.StorageSync.V20180701
{
    ...
    public static class GetSyncGroup
    {
        ...
        public static Task<GetSyncGroupResult> InvokeAsync(GetSyncGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSyncGroupResult>("azure-native:storagesync/v20180701:getSyncGroup", args ?? new GetSyncGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Sync Group object.
        /// </summary>
        public static Output<GetSyncGroupResult> Invoke(GetSyncGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSyncGroupResult>("azure-native:storagesync/v20180701:getSyncGroup", args ?? new GetSyncGroupInvokeArgs(), options.WithDefaults());
    }
