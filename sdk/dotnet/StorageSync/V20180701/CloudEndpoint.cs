...
namespace Pulumi.AzureRM.StorageSync.V20180701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cloudEndpoint = new AzureRM.StorageSync.V20180701.CloudEndpoint("cloudEndpoint", new AzureRM.StorageSync.V20180701.CloudEndpointArgs
    ///         {
    ...
    public partial class CloudEndpoint : Pulumi.CustomResource
    {
        ...
        public CloudEndpoint(string name, CloudEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20180701:CloudEndpoint", name, args ?? new CloudEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:storagesync/v20180701:CloudEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
