...
namespace Pulumi.AzureRM.Addons.Preview
{
    public static class GetSupportPlanType
    {
        public static Task<GetSupportPlanTypeResult> InvokeAsync(GetSupportPlanTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSupportPlanTypeResult>("azurerm:addons/preview:getSupportPlanType", args ?? new GetSupportPlanTypeArgs(), options.WithVersion());
    }
