...
namespace Pulumi.AzureNative.CostManagement.V20211001
{
    public static class GetView
    {
        ...
        public static Task<GetViewResult> InvokeAsync(GetViewArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetViewResult>("azure-native:costmanagement/v20211001:getView", args ?? new GetViewArgs(), options.WithDefaults());

        /// <summary>
        /// States and configurations of Cost Analysis.
        /// </summary>
        public static Output<GetViewResult> Invoke(GetViewInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetViewResult>("azure-native:costmanagement/v20211001:getView", args ?? new GetViewInvokeArgs(), options.WithDefaults());
    }
