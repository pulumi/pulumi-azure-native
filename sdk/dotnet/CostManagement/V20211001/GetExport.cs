...
namespace Pulumi.AzureNative.CostManagement.V20211001
{
    public static class GetExport
    {
        ...
        public static Task<GetExportResult> InvokeAsync(GetExportArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExportResult>("azure-native:costmanagement/v20211001:getExport", args ?? new GetExportArgs(), options.WithVersion());

        /// <summary>
        /// An export resource.
        /// </summary>
        public static Output<GetExportResult> Invoke(GetExportInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetExportResult>("azure-native:costmanagement/v20211001:getExport", args ?? new GetExportInvokeArgs(), options.WithVersion());
    }
