...
namespace Pulumi.AzureNative.CostManagement.V20211001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20211001:View")]
    public partial class View : Pulumi.CustomResource
    {
        ...
        public View(string name, ViewArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20211001:View", name, args ?? new ViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private View(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20211001:View", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:costmanagement/v20211001:View"},
