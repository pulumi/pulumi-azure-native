...
namespace Pulumi.AzureNative.CostManagement.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230401preview:View")]
    public partial class View : global::Pulumi.CustomResource
    {
        ...
        public View(string name, ViewArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230401preview:View", name, args ?? new ViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private View(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230401preview:View", name, null, MakeResourceOptions(options, id))
        {
        }
