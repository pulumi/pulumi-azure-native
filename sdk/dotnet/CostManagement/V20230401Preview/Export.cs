...
namespace Pulumi.AzureNative.CostManagement.V20230401Preview
{
    ...
    /// An export resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230401preview:Export")]
    public partial class Export : global::Pulumi.CustomResource
    {
        ...
        public Export(string name, ExportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230401preview:Export", name, args ?? new ExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Export(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230401preview:Export", name, null, MakeResourceOptions(options, id))
        {
        }
