...
namespace Pulumi.AzureNative.CostManagement.V20230401Preview
{
    public static class GetScheduledActionByScope
    {
        ...
        public static Task<GetScheduledActionByScopeResult> InvokeAsync(GetScheduledActionByScopeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScheduledActionByScopeResult>("azure-native:costmanagement/v20230401preview:getScheduledActionByScope", args ?? new GetScheduledActionByScopeArgs(), options.WithDefaults());
        ...
        public static Output<GetScheduledActionByScopeResult> Invoke(GetScheduledActionByScopeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScheduledActionByScopeResult>("azure-native:costmanagement/v20230401preview:getScheduledActionByScope", args ?? new GetScheduledActionByScopeInvokeArgs(), options.WithDefaults());
