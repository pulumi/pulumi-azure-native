...
namespace Pulumi.AzureNative.CostManagement.V20230401Preview.Inputs
{
    ...
    public sealed class NotificationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("frequency")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230401Preview.Frequency>? Frequency { get; set; }
        ...
        /// </summary>
        [Input("locale")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230401Preview.CultureCode>? Locale { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230401Preview.BudgetNotificationOperatorType> Operator { get; set; } = null!;
        ...
        /// </summary>
        [Input("thresholdType")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230401Preview.ThresholdType>? ThresholdType { get; set; }
