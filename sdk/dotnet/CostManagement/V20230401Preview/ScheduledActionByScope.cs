...
namespace Pulumi.AzureNative.CostManagement.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230401preview:ScheduledActionByScope")]
    public partial class ScheduledActionByScope : global::Pulumi.CustomResource
    {
        ...
        public ScheduledActionByScope(string name, ScheduledActionByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230401preview:ScheduledActionByScope", name, args ?? new ScheduledActionByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledActionByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230401preview:ScheduledActionByScope", name, null, MakeResourceOptions(options, id))
        {
        }
