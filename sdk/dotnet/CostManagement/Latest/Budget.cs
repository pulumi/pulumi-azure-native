...
namespace Pulumi.AzureRM.CostManagement.Latest
{
    ...
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
