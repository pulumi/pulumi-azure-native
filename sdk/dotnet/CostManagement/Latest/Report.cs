...
namespace Pulumi.AzureRM.CostManagement.Latest
{
    ...
    public partial class Report : Pulumi.CustomResource
    {
        ...
        public Report(string name, ReportArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:Report", name, args ?? new ReportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Report(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:Report", name, null, MakeResourceOptions(options, id))
        {
        }
