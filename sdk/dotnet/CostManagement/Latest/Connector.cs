...
namespace Pulumi.AzureRM.CostManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var connector = new AzureRM.CostManagement.Latest.Connector("connector", new AzureRM.CostManagement.Latest.ConnectorArgs
    ///         {
    ...
    public partial class Connector : Pulumi.CustomResource
    {
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
