...
namespace Pulumi.AzureRM.CostManagement.Latest
{
    ...
    public partial class ReportByResourceGroupName : Pulumi.CustomResource
    {
        ...
        public ReportByResourceGroupName(string name, ReportByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:ReportByResourceGroupName", name, args ?? new ReportByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReportByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:ReportByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
