...
namespace Pulumi.AzureNative.CostManagement.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:costmanagement:Setting'.")]
    [AzureNativeResourceType("azure-native:costmanagement/latest:Setting")]
    public partial class Setting : Pulumi.CustomResource
    {
        ...
        public Setting(string name, SettingArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/latest:Setting", name, args ?? new SettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Setting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/latest:Setting", name, null, MakeResourceOptions(options, id))
        {
        }
