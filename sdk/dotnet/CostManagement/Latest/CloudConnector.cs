...
namespace Pulumi.AzureRM.CostManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cloudConnector = new AzureRM.CostManagement.Latest.CloudConnector("cloudConnector", new AzureRM.CostManagement.Latest.CloudConnectorArgs
    ///         {
    ...
    public partial class CloudConnector : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.ConnectorCollectionInfoResponseResult> CollectionInfo { get; private set; } = null!;
        ...
        public CloudConnector(string name, CloudConnectorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:CloudConnector", name, args ?? new CloudConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:CloudConnector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:costmanagement/v20190301preview:CloudConnector"},
                },
            };
