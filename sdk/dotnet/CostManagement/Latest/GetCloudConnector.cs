...
namespace Pulumi.AzureRM.CostManagement.Latest
{
    public static class GetCloudConnector
    {
        public static Task<GetCloudConnectorResult> InvokeAsync(GetCloudConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCloudConnectorResult>("azurerm:costmanagement/latest:getCloudConnector", args ?? new GetCloudConnectorArgs(), options.WithVersion());
    }
