...
namespace Pulumi.AzureRM.CostManagement.Latest
{
    ...
    public partial class ReportConfigByResourceGroupName : Pulumi.CustomResource
    {
        ...
        public ReportConfigByResourceGroupName(string name, ReportConfigByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:ReportConfigByResourceGroupName", name, args ?? new ReportConfigByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReportConfigByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/latest:ReportConfigByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:costmanagement/v20180531:ReportConfigByResourceGroupName"},
                },
            };
