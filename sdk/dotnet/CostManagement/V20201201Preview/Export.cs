...
namespace Pulumi.AzureNative.CostManagement.V20201201Preview
{
    ...
    /// An export resource.
    /// </summary>
    [Obsolete(@"azure-native:costmanagement/v20201201preview:Export is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20230401preview:Export to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:costmanagement/v20201201preview:Export")]
    public partial class Export : global::Pulumi.CustomResource
    {
        ...
        public Export(string name, ExportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20201201preview:Export", name, args ?? new ExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Export(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20201201preview:Export", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExportArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20201201Preview.FormatType>? Format { get; set; }
