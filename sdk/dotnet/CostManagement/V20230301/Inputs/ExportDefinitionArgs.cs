...
namespace Pulumi.AzureNative.CostManagement.V20230301.Inputs
{
    ...
    public sealed class ExportDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230301.TimeframeType> Timeframe { get; set; } = null!;

        /// <summary>
        /// The type of the export. Note that 'Usage' is equivalent to 'ActualCost' and is applicable to exports that do not yet provide data for charges or amortization for service reservations.
        /// </summary>
        [Input("type", required: true)]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230301.ExportType> Type { get; set; } = null!;
