...
namespace Pulumi.AzureNative.CostManagement.V20230301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230301:ViewByScope")]
    public partial class ViewByScope : global::Pulumi.CustomResource
    {
        ...
        public ViewByScope(string name, ViewByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230301:ViewByScope", name, args ?? new ViewByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ViewByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230301:ViewByScope", name, null, MakeResourceOptions(options, id))
        {
        }
