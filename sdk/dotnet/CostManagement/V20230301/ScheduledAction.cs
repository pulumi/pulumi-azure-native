...
namespace Pulumi.AzureNative.CostManagement.V20230301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230301:ScheduledAction")]
    public partial class ScheduledAction : global::Pulumi.CustomResource
    {
        ...
        public ScheduledAction(string name, ScheduledActionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230301:ScheduledAction", name, args ?? new ScheduledActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230301:ScheduledAction", name, null, MakeResourceOptions(options, id))
        {
        }
