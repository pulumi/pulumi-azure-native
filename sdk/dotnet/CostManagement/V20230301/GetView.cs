...
namespace Pulumi.AzureNative.CostManagement.V20230301
{
    public static class GetView
    {
        ...
        public static Task<GetViewResult> InvokeAsync(GetViewArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetViewResult>("azure-native:costmanagement/v20230301:getView", args ?? new GetViewArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the view by view name.
        /// </summary>
        public static Output<GetViewResult> Invoke(GetViewInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetViewResult>("azure-native:costmanagement/v20230301:getView", args ?? new GetViewInvokeArgs(), options.WithDefaults());
