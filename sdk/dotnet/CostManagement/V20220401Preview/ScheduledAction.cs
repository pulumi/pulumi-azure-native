...
namespace Pulumi.AzureNative.CostManagement.V20220401Preview
{
    ...
    public partial class ScheduledAction : Pulumi.CustomResource
    {
        ...
        public ScheduledAction(string name, ScheduledActionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20220401preview:ScheduledAction", name, args ?? new ScheduledActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20220401preview:ScheduledAction", name, null, MakeResourceOptions(options, id))
        {
        }
