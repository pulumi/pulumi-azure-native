...
namespace Pulumi.AzureRM.CostManagement.Preview
{
    ...
    public partial class ReportConfig : Pulumi.CustomResource
    {
        ...
        public ReportConfig(string name, ReportConfigArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:ReportConfig", name, args ?? new ReportConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReportConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:ReportConfig", name, null, MakeResourceOptions(options, id))
        {
        }
