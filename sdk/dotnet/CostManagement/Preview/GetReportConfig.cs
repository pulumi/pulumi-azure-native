...
namespace Pulumi.AzureRM.CostManagement.Preview
{
    public static class GetReportConfig
    {
        public static Task<GetReportConfigResult> InvokeAsync(GetReportConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReportConfigResult>("azurerm:costmanagement/preview:getReportConfig", args ?? new GetReportConfigArgs(), options.WithVersion());
    }
