...
namespace Pulumi.AzureRM.CostManagement.Preview
{
    ...
    public partial class View : Pulumi.CustomResource
    {
        ...
        public View(string name, ViewArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:View", name, args ?? new ViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private View(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:View", name, null, MakeResourceOptions(options, id))
        {
        }
