...
namespace Pulumi.AzureRM.CostManagement.Preview
{
    ...
    public partial class CloudConnector : Pulumi.CustomResource
    {
        ...
        public CloudConnector(string name, CloudConnectorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:CloudConnector", name, args ?? new CloudConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:CloudConnector", name, null, MakeResourceOptions(options, id))
        {
        }
