...
namespace Pulumi.AzureRM.CostManagement.Preview
{
    public static class GetViewByScope
    {
        public static Task<GetViewByScopeResult> InvokeAsync(GetViewByScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetViewByScopeResult>("azurerm:costmanagement/preview:getViewByScope", args ?? new GetViewByScopeArgs(), options.WithVersion());
    }
