...
namespace Pulumi.AzureRM.CostManagement.Preview
{
    public static class GetCloudConnector
    {
        public static Task<GetCloudConnectorResult> InvokeAsync(GetCloudConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCloudConnectorResult>("azurerm:costmanagement/preview:getCloudConnector", args ?? new GetCloudConnectorArgs(), options.WithVersion());
    }
