...
namespace Pulumi.AzureRM.CostManagement.Preview
{
    ...
    public partial class Connector : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("collection")]
        public Output<Outputs.ConnectorCollectionInfoResponseResult> Collection { get; private set; } = null!;
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:costmanagement/v20180801preview:Connector"},
                },
            };
