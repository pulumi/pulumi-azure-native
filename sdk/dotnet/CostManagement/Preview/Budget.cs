...
namespace Pulumi.AzureRM.CostManagement.Preview
{
    ...
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("filter")]
        public Output<Outputs.ReportConfigFilterResponseResult?> Filter { get; private set; } = null!;
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:costmanagement/v20190401preview:Budget"},
                },
            };
