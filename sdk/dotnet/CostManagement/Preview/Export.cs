...
namespace Pulumi.AzureRM.CostManagement.Preview
{
    ...
    public partial class Export : Pulumi.CustomResource
    {
        ...
        public Export(string name, ExportArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:Export", name, args ?? new ExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Export(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/preview:Export", name, null, MakeResourceOptions(options, id))
        {
        }
