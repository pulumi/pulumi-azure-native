...
namespace Pulumi.AzureNextGen.CostManagement
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:costmanagement:ReportByResourceGroupName")]
    public partial class ReportByResourceGroupName : Pulumi.CustomResource
    {
        ...
        public ReportByResourceGroupName(string name, ReportByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:costmanagement:ReportByResourceGroupName", name, args ?? new ReportByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReportByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:costmanagement:ReportByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
