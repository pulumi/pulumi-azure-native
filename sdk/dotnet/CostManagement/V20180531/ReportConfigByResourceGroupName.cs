...
namespace Pulumi.AzureNative.CostManagement.V20180531
{
    ...
    [AzureNativeResourceType("azure-native:costmanagement/v20180531:ReportConfigByResourceGroupName")]
    public partial class ReportConfigByResourceGroupName : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ReportConfigByResourceGroupName(string name, ReportConfigByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20180531:ReportConfigByResourceGroupName", name, args ?? new ReportConfigByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReportConfigByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20180531:ReportConfigByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReportConfigByResourceGroupNameArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Has definition for the report config.
        /// </summary>
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20180531.FormatType>? Format { get; set; }
        ...
        public static new ReportConfigByResourceGroupNameArgs Empty => new ReportConfigByResourceGroupNameArgs();
    }
}
