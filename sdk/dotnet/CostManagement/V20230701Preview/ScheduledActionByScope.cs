...
namespace Pulumi.AzureNative.CostManagement.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230701preview:ScheduledActionByScope")]
    public partial class ScheduledActionByScope : global::Pulumi.CustomResource
    {
        ...
        public ScheduledActionByScope(string name, ScheduledActionByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230701preview:ScheduledActionByScope", name, args ?? new ScheduledActionByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledActionByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230701preview:ScheduledActionByScope", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledActionByScopeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230701Preview.ScheduledActionKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230701Preview.ScheduledActionStatus> Status { get; set; } = null!;
