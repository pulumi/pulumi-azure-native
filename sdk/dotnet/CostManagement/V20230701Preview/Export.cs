...
namespace Pulumi.AzureNative.CostManagement.V20230701Preview
{
    ...
    /// An export resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230701preview:Export")]
    public partial class Export : global::Pulumi.CustomResource
    {
        ...
        public Export(string name, ExportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230701preview:Export", name, args ?? new ExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Export(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230701preview:Export", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExportArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230701Preview.CompressionModeType>? CompressionMode { get; set; }

        /// <summary>
        /// Allow customers to select overwrite data(OverwritePreviousReport) for exports. This setting will enable overwrite data for the same month in customer storage account. By default set to CreateNewReport.
        /// </summary>
        [Input("dataOverwriteBehavior")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230701Preview.DataOverwriteBehaviorType>? DataOverwriteBehavior { get; set; }
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230701Preview.FormatType>? Format { get; set; }
