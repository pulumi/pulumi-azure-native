...
namespace Pulumi.AzureNative.CostManagement.V20240801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20240801:TagInheritanceSetting")]
    public partial class TagInheritanceSetting : global::Pulumi.CustomResource
    {
        ...
        public TagInheritanceSetting(string name, TagInheritanceSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:TagInheritanceSetting", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private TagInheritanceSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:TagInheritanceSetting", name, null, MakeResourceOptions(options, id))
        {
        }
