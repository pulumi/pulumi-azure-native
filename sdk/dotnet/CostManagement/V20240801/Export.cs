...
namespace Pulumi.AzureNative.CostManagement.V20240801
{
    ...
    /// An export resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20240801:Export")]
    public partial class Export : global::Pulumi.CustomResource
    {
        ...
        public Export(string name, ExportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:Export", name, args ?? new ExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Export(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:Export", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExportArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20240801.FormatType>? Format { get; set; }
