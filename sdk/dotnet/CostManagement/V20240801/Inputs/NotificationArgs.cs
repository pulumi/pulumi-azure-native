...
namespace Pulumi.AzureNative.CostManagement.V20240801.Inputs
{
    ...
    public sealed class NotificationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("frequency")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20240801.Frequency>? Frequency { get; set; }
        ...
        /// </summary>
        [Input("locale")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20240801.CultureCode>? Locale { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20240801.BudgetNotificationOperatorType> Operator { get; set; } = null!;
        ...
        /// </summary>
        [Input("thresholdType")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20240801.ThresholdType>? ThresholdType { get; set; }
