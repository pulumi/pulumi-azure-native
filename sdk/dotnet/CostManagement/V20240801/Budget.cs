...
namespace Pulumi.AzureNative.CostManagement.V20240801
{
    ...
    /// A budget resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20240801:Budget")]
    public partial class Budget : global::Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20240801.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20240801.TimeGrainType> TimeGrain { get; set; } = null!;
