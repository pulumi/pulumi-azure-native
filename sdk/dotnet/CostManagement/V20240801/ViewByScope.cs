...
namespace Pulumi.AzureNative.CostManagement.V20240801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20240801:ViewByScope")]
    public partial class ViewByScope : global::Pulumi.CustomResource
    {
        ...
        public ViewByScope(string name, ViewByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:ViewByScope", name, args ?? new ViewByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ViewByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:ViewByScope", name, null, MakeResourceOptions(options, id))
        {
        }
