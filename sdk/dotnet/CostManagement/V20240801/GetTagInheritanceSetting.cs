...
namespace Pulumi.AzureNative.CostManagement.V20240801
{
    public static class GetTagInheritanceSetting
    {
        ...
        public static Task<GetTagInheritanceSettingResult> InvokeAsync(GetTagInheritanceSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagInheritanceSettingResult>("azure-native:costmanagement/v20240801:getTagInheritanceSetting", args ?? new GetTagInheritanceSettingArgs(), options.WithDefaults());
