...
namespace Pulumi.AzureNative.CostManagement.V20240801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20240801:CostAllocationRule")]
    public partial class CostAllocationRule : global::Pulumi.CustomResource
    {
        ...
        public CostAllocationRule(string name, CostAllocationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:CostAllocationRule", name, args ?? new CostAllocationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CostAllocationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20240801:CostAllocationRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:costmanagement/v20230901:CostAllocationRule" },
                    new global::Pulumi.Alias { Type = "azure-native:costmanagement/v20231101:CostAllocationRule" },
                    new global::Pulumi.Alias { Type = "azure-native:costmanagement/v20241001preview:CostAllocationRule" },
