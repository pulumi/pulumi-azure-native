...
namespace Pulumi.AzureNative.CostManagement.V20240801
{
    public static class GetScheduledAction
    {
        ...
        public static Task<GetScheduledActionResult> InvokeAsync(GetScheduledActionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScheduledActionResult>("azure-native:costmanagement/v20240801:getScheduledAction", args ?? new GetScheduledActionArgs(), options.WithDefaults());

        /// <summary>
        /// Get the private scheduled action by name.
        /// </summary>
        public static Output<GetScheduledActionResult> Invoke(GetScheduledActionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScheduledActionResult>("azure-native:costmanagement/v20240801:getScheduledAction", args ?? new GetScheduledActionInvokeArgs(), options.WithDefaults());
