...
namespace Pulumi.AzureNative.CostManagement.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230801:ViewByScope")]
    public partial class ViewByScope : global::Pulumi.CustomResource
    {
        ...
        public ViewByScope(string name, ViewByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230801:ViewByScope", name, args ?? new ViewByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ViewByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230801:ViewByScope", name, null, MakeResourceOptions(options, id))
        {
        }
