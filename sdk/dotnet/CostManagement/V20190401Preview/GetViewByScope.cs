...
namespace Pulumi.AzureRM.CostManagement.V20190401Preview
{
    public static class GetViewByScope
    {
        public static Task<GetViewByScopeResult> InvokeAsync(GetViewByScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetViewByScopeResult>("azurerm:costmanagement/v20190401preview:getViewByScope", args ?? new GetViewByScopeArgs(), options.WithVersion());
    }
