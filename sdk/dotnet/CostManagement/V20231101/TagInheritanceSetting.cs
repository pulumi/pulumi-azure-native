...
namespace Pulumi.AzureNative.CostManagement.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20231101:TagInheritanceSetting")]
    public partial class TagInheritanceSetting : global::Pulumi.CustomResource
    {
        ...
        public TagInheritanceSetting(string name, TagInheritanceSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20231101:TagInheritanceSetting", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private TagInheritanceSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20231101:TagInheritanceSetting", name, null, MakeResourceOptions(options, id))
        {
        }
