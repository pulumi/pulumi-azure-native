...
namespace Pulumi.AzureNative.CostManagement.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20231101:ScheduledAction")]
    public partial class ScheduledAction : global::Pulumi.CustomResource
    {
        ...
        public ScheduledAction(string name, ScheduledActionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20231101:ScheduledAction", name, args ?? new ScheduledActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20231101:ScheduledAction", name, null, MakeResourceOptions(options, id))
        {
        }
