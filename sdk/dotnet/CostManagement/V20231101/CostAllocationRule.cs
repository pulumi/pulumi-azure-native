...
namespace Pulumi.AzureNative.CostManagement.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20231101:CostAllocationRule")]
    public partial class CostAllocationRule : global::Pulumi.CustomResource
    {
        ...
        public CostAllocationRule(string name, CostAllocationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20231101:CostAllocationRule", name, args ?? new CostAllocationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CostAllocationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20231101:CostAllocationRule", name, null, MakeResourceOptions(options, id))
        {
        }
