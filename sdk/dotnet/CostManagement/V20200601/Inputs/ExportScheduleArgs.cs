...
namespace Pulumi.AzureNative.CostManagement.V20200601.Inputs
{
    ...
    public sealed class ExportScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("recurrence")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20200601.RecurrenceType>? Recurrence { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20200601.StatusType>? Status { get; set; }
