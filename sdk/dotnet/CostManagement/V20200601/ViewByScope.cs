...
namespace Pulumi.AzureRM.CostManagement.V20200601
{
    ...
    public partial class ViewByScope : Pulumi.CustomResource
    {
        ...
        public ViewByScope(string name, ViewByScopeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/v20200601:ViewByScope", name, args ?? new ViewByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ViewByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/v20200601:ViewByScope", name, null, MakeResourceOptions(options, id))
        {
        }
