...
namespace Pulumi.AzureNative.CostManagement.V20200601
{
    public static class GetViewByScope
    {
        ...
        public static Task<GetViewByScopeResult> InvokeAsync(GetViewByScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetViewByScopeResult>("azure-native:costmanagement/v20200601:getViewByScope", args ?? new GetViewByScopeArgs(), options.WithDefaults());

        /// <summary>
        /// States and configurations of Cost Analysis.
        /// </summary>
        public static Output<GetViewByScopeResult> Invoke(GetViewByScopeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetViewByScopeResult>("azure-native:costmanagement/v20200601:getViewByScope", args ?? new GetViewByScopeInvokeArgs(), options.WithDefaults());
    }
