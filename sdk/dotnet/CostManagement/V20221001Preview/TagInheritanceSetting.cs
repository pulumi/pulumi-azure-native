...
namespace Pulumi.AzureNative.CostManagement.V20221001Preview
{
    ...
    public partial class TagInheritanceSetting : global::Pulumi.CustomResource
    {
        ...
        public TagInheritanceSetting(string name, TagInheritanceSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20221001preview:TagInheritanceSetting", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private TagInheritanceSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20221001preview:TagInheritanceSetting", name, null, MakeResourceOptions(options, id))
        {
        }
