...
namespace Pulumi.AzureNative.CostManagement.V20221001Preview
{
    public static class GetViewByScope
    {
        ...
        public static Task<GetViewByScopeResult> InvokeAsync(GetViewByScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetViewByScopeResult>("azure-native:costmanagement/v20221001preview:getViewByScope", args ?? new GetViewByScopeArgs(), options.WithDefaults());

        /// <summary>
        /// States and configurations of Cost Analysis.
        /// </summary>
        public static Output<GetViewByScopeResult> Invoke(GetViewByScopeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetViewByScopeResult>("azure-native:costmanagement/v20221001preview:getViewByScope", args ?? new GetViewByScopeInvokeArgs(), options.WithDefaults());
    }
