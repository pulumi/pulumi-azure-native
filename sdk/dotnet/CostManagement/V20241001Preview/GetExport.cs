...
namespace Pulumi.AzureNative.CostManagement.V20241001Preview
{
    public static class GetExport
    {
        ...
        public static Task<GetExportResult> InvokeAsync(GetExportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExportResult>("azure-native:costmanagement/v20241001preview:getExport", args ?? new GetExportArgs(), options.WithDefaults());

        /// <summary>
        /// The operation to get the export for the defined scope by export name.
        /// </summary>
        public static Output<GetExportResult> Invoke(GetExportInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExportResult>("azure-native:costmanagement/v20241001preview:getExport", args ?? new GetExportInvokeArgs(), options.WithDefaults());
