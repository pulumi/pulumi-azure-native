...
namespace Pulumi.AzureNative.CostManagement.V20241001Preview
{
    /// <summary>
    /// Scheduled action definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20241001preview:ScheduledAction")]
    public partial class ScheduledAction : global::Pulumi.CustomResource
    {
        ...
        public ScheduledAction(string name, ScheduledActionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20241001preview:ScheduledAction", name, args ?? new ScheduledActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20241001preview:ScheduledAction", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledActionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20241001Preview.ScheduledActionKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20241001Preview.ScheduledActionStatus> Status { get; set; } = null!;
