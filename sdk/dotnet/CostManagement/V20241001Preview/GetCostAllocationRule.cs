...
namespace Pulumi.AzureNative.CostManagement.V20241001Preview
{
    public static class GetCostAllocationRule
    {
        ...
        public static Task<GetCostAllocationRuleResult> InvokeAsync(GetCostAllocationRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCostAllocationRuleResult>("azure-native:costmanagement/v20241001preview:getCostAllocationRule", args ?? new GetCostAllocationRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Get a cost allocation rule by rule name and billing account or enterprise enrollment.
        /// </summary>
        public static Output<GetCostAllocationRuleResult> Invoke(GetCostAllocationRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCostAllocationRuleResult>("azure-native:costmanagement/v20241001preview:getCostAllocationRule", args ?? new GetCostAllocationRuleInvokeArgs(), options.WithDefaults());
