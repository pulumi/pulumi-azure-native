...
namespace Pulumi.AzureNative.CostManagement.V20241001Preview
{
    ...
    /// An export resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20241001preview:Export")]
    public partial class Export : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("dataOverwriteBehavior")]
        public Output<string?> DataOverwriteBehavior { get; private set; } = null!;
        ...
        public Output<string?> ExportDescription { get; private set; } = null!;
        ...
        /// </summary>
        [Output("systemSuspensionContext")]
        public Output<Outputs.ExportSuspensionContextResponse> SystemSuspensionContext { get; private set; } = null!;
        ...
        public Export(string name, ExportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20241001preview:Export", name, args ?? new ExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Export(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20241001preview:Export", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExportArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20241001Preview.CompressionModeType>? CompressionMode { get; set; }

        /// <summary>
        /// Allow customers to select overwrite data(OverwritePreviousReport) for exports. This setting will enable overwrite data for the same month in customer storage account. By default set to CreateNewReport.
        /// </summary>
        [Input("dataOverwriteBehavior")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20241001Preview.DataOverwriteBehaviorType>? DataOverwriteBehavior { get; set; }
        ...
        public Input<string>? ExportDescription { get; set; }
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20241001Preview.FormatType>? Format { get; set; }
