...
namespace Pulumi.AzureNative.CostManagement
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement:ReportConfigByResourceGroupName")]
    public partial class ReportConfigByResourceGroupName : Pulumi.CustomResource
    {
        ...
        public ReportConfigByResourceGroupName(string name, ReportConfigByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement:ReportConfigByResourceGroupName", name, args ?? new ReportConfigByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReportConfigByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement:ReportConfigByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
