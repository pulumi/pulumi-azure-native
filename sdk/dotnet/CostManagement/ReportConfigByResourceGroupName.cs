...
namespace Pulumi.AzureNextGen.CostManagement
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:costmanagement:ReportConfigByResourceGroupName")]
    public partial class ReportConfigByResourceGroupName : Pulumi.CustomResource
    {
        ...
        public ReportConfigByResourceGroupName(string name, ReportConfigByResourceGroupNameArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:costmanagement:ReportConfigByResourceGroupName", name, args ?? new ReportConfigByResourceGroupNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReportConfigByResourceGroupName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:costmanagement:ReportConfigByResourceGroupName", name, null, MakeResourceOptions(options, id))
        {
        }
