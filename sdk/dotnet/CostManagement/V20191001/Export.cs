...
namespace Pulumi.AzureNative.CostManagement.V20191001
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:costmanagement/v20191001:Export TestExport subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.CostManagement/exports/TestExport 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20191001:Export")]
    public partial class Export : global::Pulumi.CustomResource
    {
        ...
        public Export(string name, ExportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20191001:Export", name, args ?? new ExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Export(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20191001:Export", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExportArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20191001.FormatType>? Format { get; set; }
