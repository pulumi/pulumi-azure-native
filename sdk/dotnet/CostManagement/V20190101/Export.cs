...
namespace Pulumi.AzureRM.CostManagement.V20190101
{
    /// <summary>
    /// A export resource.
    /// </summary>
    public partial class Export : Pulumi.CustomResource
    {
        ...
        public Export(string name, ExportArgs args, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/v20190101:Export", name, args ?? new ExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Export(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:costmanagement/v20190101:Export", name, null, MakeResourceOptions(options, id))
        {
        }
