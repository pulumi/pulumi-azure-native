...
namespace Pulumi.AzureNative.CostManagement.V20221005Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20221005preview:ViewByScope")]
    public partial class ViewByScope : global::Pulumi.CustomResource
    {
        ...
        public ViewByScope(string name, ViewByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20221005preview:ViewByScope", name, args ?? new ViewByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ViewByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20221005preview:ViewByScope", name, null, MakeResourceOptions(options, id))
        {
        }
