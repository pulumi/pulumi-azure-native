...
namespace Pulumi.AzureNative.CostManagement.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230901:CostAllocationRule")]
    public partial class CostAllocationRule : global::Pulumi.CustomResource
    {
        ...
        public CostAllocationRule(string name, CostAllocationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230901:CostAllocationRule", name, args ?? new CostAllocationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CostAllocationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230901:CostAllocationRule", name, null, MakeResourceOptions(options, id))
        {
        }
