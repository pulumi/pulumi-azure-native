...
namespace Pulumi.AzureNative.CostManagement.V20230901
{
    public static class GetBudget
    {
        ...
        public static Task<GetBudgetResult> InvokeAsync(GetBudgetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBudgetResult>("azure-native:costmanagement/v20230901:getBudget", args ?? new GetBudgetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the budget for the scope by budget name.
        /// </summary>
        public static Output<GetBudgetResult> Invoke(GetBudgetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBudgetResult>("azure-native:costmanagement/v20230901:getBudget", args ?? new GetBudgetInvokeArgs(), options.WithDefaults());
    }
