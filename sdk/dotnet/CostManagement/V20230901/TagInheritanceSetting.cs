...
namespace Pulumi.AzureNative.CostManagement.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230901:TagInheritanceSetting")]
    public partial class TagInheritanceSetting : global::Pulumi.CustomResource
    {
        ...
        public TagInheritanceSetting(string name, TagInheritanceSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230901:TagInheritanceSetting", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private TagInheritanceSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230901:TagInheritanceSetting", name, null, MakeResourceOptions(options, id))
        {
        }
