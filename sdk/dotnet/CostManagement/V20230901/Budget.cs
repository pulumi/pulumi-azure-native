...
namespace Pulumi.AzureNative.CostManagement.V20230901
{
    ...
    /// A budget resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20230901:Budget")]
    public partial class Budget : global::Pulumi.CustomResource
    {
        ...
        public Budget(string name, BudgetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230901:Budget", name, args ?? new BudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Budget(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20230901:Budget", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BudgetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230901.CategoryType> Category { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20230901.TimeGrainType> TimeGrain { get; set; } = null!;
