...
namespace Pulumi.AzureNative.CostManagement.V20221001
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:costmanagement/v20221001:ScheduledActionByScope monthlyCostByResource subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.CostManagement/scheduledActions/monthlyCostByResource 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20221001:ScheduledActionByScope")]
    public partial class ScheduledActionByScope : global::Pulumi.CustomResource
    {
        ...
        public ScheduledActionByScope(string name, ScheduledActionByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20221001:ScheduledActionByScope", name, args ?? new ScheduledActionByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledActionByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20221001:ScheduledActionByScope", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledActionByScopeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20221001.ScheduledActionKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20221001.ScheduledActionStatus> Status { get; set; } = null!;
