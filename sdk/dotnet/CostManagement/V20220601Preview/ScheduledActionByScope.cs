...
namespace Pulumi.AzureNative.CostManagement.V20220601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20220601preview:ScheduledActionByScope")]
    public partial class ScheduledActionByScope : Pulumi.CustomResource
    {
        ...
        public ScheduledActionByScope(string name, ScheduledActionByScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20220601preview:ScheduledActionByScope", name, args ?? new ScheduledActionByScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledActionByScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20220601preview:ScheduledActionByScope", name, null, MakeResourceOptions(options, id))
        {
        }
