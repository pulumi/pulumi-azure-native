...
namespace Pulumi.AzureNextGen.CostManagement.V20191101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:costmanagement/v20191101:View")]
    public partial class View : Pulumi.CustomResource
    {
        ...
        public View(string name, ViewArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:costmanagement/v20191101:View", name, args ?? new ViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private View(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:costmanagement/v20191101:View", name, null, MakeResourceOptions(options, id))
        {
        }
