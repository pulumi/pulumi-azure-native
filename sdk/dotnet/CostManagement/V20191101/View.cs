...
namespace Pulumi.AzureNative.CostManagement.V20191101
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:costmanagement/v20191101:View swaggerExample /providers/Microsoft.CostManagement/views/swaggerExample 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:costmanagement/v20191101:View")]
    public partial class View : global::Pulumi.CustomResource
    {
        ...
        public View(string name, ViewArgs args, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20191101:View", name, args ?? new ViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private View(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:costmanagement/v20191101:View", name, null, MakeResourceOptions(options, id))
        {
        }
