...
namespace Pulumi.AzureNextGen.CostManagement.V20191101.Inputs
{
    ...
    public sealed class ExportScheduleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.CostManagement.V20191101.RecurrenceType> Recurrence { get; set; } = null!;
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNextGen.CostManagement.V20191101.StatusType>? Status { get; set; }
