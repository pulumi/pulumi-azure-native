...
namespace Pulumi.AzureNative.CostManagement.V20191101.Inputs
{
    ...
    public sealed class ExportDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20191101.TimeframeType> Timeframe { get; set; } = null!;

        /// <summary>
        /// The type of the query.
        /// </summary>
        [Input("type", required: true)]
        public InputUnion<string, Pulumi.AzureNative.CostManagement.V20191101.ExportType> Type { get; set; } = null!;
