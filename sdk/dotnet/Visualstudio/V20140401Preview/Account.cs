...
namespace Pulumi.AzureRM.Visualstudio.V20140401Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var account = new AzureRM.Visualstudio.V20140401Preview.Account("account", new AzureRM.Visualstudio.V20140401Preview.AccountArgs
    ///         {
    ///             AccountName = "Example",
    ///             Location = "Central US",
    ...
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:visualstudio/v20140401preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:visualstudio/v20140401preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
