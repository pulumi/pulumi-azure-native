...
namespace Pulumi.AzureRM.Visualstudio.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var account = new AzureRM.Visualstudio.Latest.Account("account", new AzureRM.Visualstudio.Latest.AccountArgs
    ///         {
    ///             AccountName = "Example",
    ///             Location = "Central US",
    ...
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:visualstudio/latest:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:visualstudio/latest:Account", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:visualstudio/v20171101preview:Account"},
                },
            };
