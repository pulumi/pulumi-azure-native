...
namespace Pulumi.AzureRM.Visualstudio.Preview
{
    public static class GetExtension
    {
        public static Task<GetExtensionResult> InvokeAsync(GetExtensionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExtensionResult>("azurerm:visualstudio/preview:getExtension", args ?? new GetExtensionArgs(), options.WithVersion());
    }
