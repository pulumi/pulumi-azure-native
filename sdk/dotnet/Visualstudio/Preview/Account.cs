...
namespace Pulumi.AzureRM.Visualstudio.Preview
{
    ...
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:visualstudio/preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:visualstudio/preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
