...
namespace Pulumi.AzureNative.CognitiveServices.V20221201
{
    ...
    /// {
    ///     var deployment = new AzureNative.CognitiveServices.V20221201.Deployment("deployment", new()
    ///     {
    ///         AccountName = "accountName",
    ///         DeploymentName = "deploymentName",
    ///         Properties = new AzureNative.CognitiveServices.V20221201.Inputs.DeploymentPropertiesArgs
    ///         {
    ///             Model = new AzureNative.CognitiveServices.V20221201.Inputs.DeploymentModelArgs
    ///             {
    ///                 Format = "OpenAI",
    ///                 Name = "ada",
    ///                 Version = "1",
    ///             },
    ///             ScaleSettings = new AzureNative.CognitiveServices.V20221201.Inputs.DeploymentScaleSettingsArgs
    ///             {
    ///                 Capacity = 1,
    ///                 ScaleType = "Manual",
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20221201:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20221201:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20221201:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
