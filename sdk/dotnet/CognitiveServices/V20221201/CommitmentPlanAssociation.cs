...
namespace Pulumi.AzureNative.CognitiveServices.V20221201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cognitiveservices/v20221201:CommitmentPlanAssociation is being removed in the next major version of this provider. Upgrade to at least azure-native:cognitiveservices/v20230501:CommitmentPlanAssociation to guarantee forwards compatibility.")]
    ...
    public partial class CommitmentPlanAssociation : global::Pulumi.CustomResource
    {
        ...
        public CommitmentPlanAssociation(string name, CommitmentPlanAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20221201:CommitmentPlanAssociation", name, args ?? new CommitmentPlanAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommitmentPlanAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20221201:CommitmentPlanAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
