...
namespace Pulumi.AzureNative.CognitiveServices.V20221201
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.CognitiveServices.V20221201.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         AccountName = "sto9699",
    ///         PrivateEndpointConnectionName = "{privateEndpointConnectionName}",
    ///         Properties = new AzureNative.CognitiveServices.V20221201.Inputs.PrivateEndpointConnectionPropertiesArgs
    ///         {
    ///             PrivateLinkServiceConnectionState = new AzureNative.CognitiveServices.V20221201.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20221201:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20221201:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
