...
namespace Pulumi.AzureNative.CognitiveServices.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20230501:CommitmentPlan")]
    public partial class CommitmentPlan : global::Pulumi.CustomResource
    {
        ...
        public CommitmentPlan(string name, CommitmentPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20230501:CommitmentPlan", name, args ?? new CommitmentPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommitmentPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20230501:CommitmentPlan", name, null, MakeResourceOptions(options, id))
        {
        }
