...
namespace Pulumi.AzureNative.CognitiveServices.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20230501:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20230501:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20230501:Account", name, null, MakeResourceOptions(options, id))
        {
        }
