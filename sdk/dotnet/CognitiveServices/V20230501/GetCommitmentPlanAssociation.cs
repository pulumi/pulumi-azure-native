...
namespace Pulumi.AzureNative.CognitiveServices.V20230501
{
    public static class GetCommitmentPlanAssociation
    {
        ...
        public static Task<GetCommitmentPlanAssociationResult> InvokeAsync(GetCommitmentPlanAssociationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCommitmentPlanAssociationResult>("azure-native:cognitiveservices/v20230501:getCommitmentPlanAssociation", args ?? new GetCommitmentPlanAssociationArgs(), options.WithDefaults());
