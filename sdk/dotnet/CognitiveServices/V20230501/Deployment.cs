...
namespace Pulumi.AzureNative.CognitiveServices.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20230501:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20230501:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20230501:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
