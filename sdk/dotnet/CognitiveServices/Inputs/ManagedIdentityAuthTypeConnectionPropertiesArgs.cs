...
namespace Pulumi.AzureNative.CognitiveServices.Inputs
{
    ...
    public sealed class ManagedIdentityAuthTypeConnectionPropertiesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("credentials")]
        public Input<Inputs.ConnectionManagedIdentityArgs>? Credentials { get; set; }
        ...
        public ManagedIdentityAuthTypeConnectionPropertiesArgs()
        {
        }
        public static new ManagedIdentityAuthTypeConnectionPropertiesArgs Empty => new ManagedIdentityAuthTypeConnectionPropertiesArgs();
    }
}
