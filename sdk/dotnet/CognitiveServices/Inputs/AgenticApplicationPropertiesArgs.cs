...
namespace Pulumi.AzureNative.CognitiveServices.Inputs
{
    ...
    /// </summary>
    public sealed class AgenticApplicationPropertiesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("agents")]
        private InputList<Inputs.AgentReferencePropertiesArgs>? _agents;
        ...
        /// </summary>
        public InputList<Inputs.AgentReferencePropertiesArgs> Agents
        {
            get => _agents ?? (_agents = new InputList<Inputs.AgentReferencePropertiesArgs>());
            set => _agents = value;
        }
        ...
        public AgenticApplicationPropertiesArgs()
        {
        }
        public static new AgenticApplicationPropertiesArgs Empty => new AgenticApplicationPropertiesArgs();
    }
}
