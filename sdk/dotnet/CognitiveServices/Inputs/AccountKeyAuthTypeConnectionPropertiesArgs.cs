...
namespace Pulumi.AzureNative.CognitiveServices.Inputs
{
    ...
    /// </summary>
    public sealed class AccountKeyAuthTypeConnectionPropertiesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("credentials")]
        public Input<Inputs.ConnectionAccountKeyArgs>? Credentials { get; set; }
        ...
        public AccountKeyAuthTypeConnectionPropertiesArgs()
        {
        }
        public static new AccountKeyAuthTypeConnectionPropertiesArgs Empty => new AccountKeyAuthTypeConnectionPropertiesArgs();
    }
}
