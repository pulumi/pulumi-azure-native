...
namespace Pulumi.AzureNative.CognitiveServices.Inputs
{
    ...
    public sealed class ServicePrincipalAuthTypeConnectionPropertiesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("credentials")]
        public Input<Inputs.ConnectionServicePrincipalArgs>? Credentials { get; set; }
        ...
        public ServicePrincipalAuthTypeConnectionPropertiesArgs()
        {
        }
        public static new ServicePrincipalAuthTypeConnectionPropertiesArgs Empty => new ServicePrincipalAuthTypeConnectionPropertiesArgs();
    }
}
