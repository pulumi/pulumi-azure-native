...
namespace Pulumi.AzureRM.CognitiveServices.Preview
{
    /// <summary>
    ...
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:cognitiveservices/preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:cognitiveservices/preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
