...
namespace Pulumi.AzureNative.CognitiveServices.V20211001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20211001:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20211001:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20211001:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:cognitiveservices/v20211001:PrivateEndpointConnection"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:cognitiveservices/v20170418:PrivateEndpointConnection"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:cognitiveservices/v20210430:PrivateEndpointConnection"},
                },
            };
