...
namespace Pulumi.AzureNative.CognitiveServices.V20211001
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:cognitiveservices/v20211001:CommitmentPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:cognitiveservices/v20230501:CommitmentPlan to guarantee forwards compatibility.")]
    ...
    public partial class CommitmentPlan : global::Pulumi.CustomResource
    {
        ...
        public CommitmentPlan(string name, CommitmentPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20211001:CommitmentPlan", name, args ?? new CommitmentPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommitmentPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20211001:CommitmentPlan", name, null, MakeResourceOptions(options, id))
        {
        }
