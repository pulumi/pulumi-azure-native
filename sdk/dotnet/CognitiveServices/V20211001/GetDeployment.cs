...
namespace Pulumi.AzureNative.CognitiveServices.V20211001
{
    public static class GetDeployment
    {
        ...
        public static Task<GetDeploymentResult> InvokeAsync(GetDeploymentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentResult>("azure-native:cognitiveservices/v20211001:getDeployment", args ?? new GetDeploymentArgs(), options.WithVersion());

        /// <summary>
        /// Cognitive Services account deployment.
        /// </summary>
        public static Output<GetDeploymentResult> Invoke(GetDeploymentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDeploymentResult>("azure-native:cognitiveservices/v20211001:getDeployment", args ?? new GetDeploymentInvokeArgs(), options.WithVersion());
    }
