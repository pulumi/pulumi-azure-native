...
namespace Pulumi.AzureNative.CognitiveServices.V20220301
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:cognitiveservices/v20220301:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Cognitive Services account is an Azure resource representing the provisioned account, it's type, location and SKU.
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:cognitiveservices/v20220301:getAccount", args ?? new GetAccountInvokeArgs(), options.WithDefaults());
    }
