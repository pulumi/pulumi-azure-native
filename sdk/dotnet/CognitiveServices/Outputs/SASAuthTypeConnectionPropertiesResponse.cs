...
namespace Pulumi.AzureNative.CognitiveServices.Outputs
{
    ...
    [OutputType]
    public sealed class SASAuthTypeConnectionPropertiesResponse
    {
        /// <summary>
        ...
        public readonly Outputs.ConnectionSharedAccessSignatureResponse? Credentials;
        ...
        [OutputConstructor]
        private SASAuthTypeConnectionPropertiesResponse(
            string authType,
            ...
            Outputs.ConnectionSharedAccessSignatureResponse? credentials,
