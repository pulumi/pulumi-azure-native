...
namespace Pulumi.AzureNative.CognitiveServices.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class AgenticApplicationPropertiesResponse
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.AgentReferencePropertiesResponse> Agents;
        /// <summary>
        ...
        [OutputConstructor]
        private AgenticApplicationPropertiesResponse(
            Outputs.AssignedIdentityResponse? agentIdentityBlueprint,

            ImmutableArray<Outputs.AgentReferencePropertiesResponse> agents,
