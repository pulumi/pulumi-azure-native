...
namespace Pulumi.AzureNative.CognitiveServices.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class RaiPolicyPropertiesResponseV1
    {
        /// <summary>
        /// Name of Rai policy.
        /// </summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.RaiPolicyContentFilterResponseV1> ContentFilters;
        /// <summary>
        ...
        [OutputConstructor]
        private RaiPolicyPropertiesResponseV1(
            string? basePolicyName,

            ImmutableArray<Outputs.RaiPolicyContentFilterResponseV1> contentFilters,
