...
namespace Pulumi.AzureNative.CognitiveServices.V20241001
{
    public static class GetRaiPolicy
    {
        ...
        public static Task<GetRaiPolicyResult> InvokeAsync(GetRaiPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRaiPolicyResult>("azure-native:cognitiveservices/v20241001:getRaiPolicy", args ?? new GetRaiPolicyArgs(), options.WithDefaults());
