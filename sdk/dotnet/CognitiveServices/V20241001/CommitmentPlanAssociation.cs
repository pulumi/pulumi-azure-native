...
namespace Pulumi.AzureNative.CognitiveServices.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20241001:CommitmentPlanAssociation")]
    public partial class CommitmentPlanAssociation : global::Pulumi.CustomResource
    {
        ...
        public CommitmentPlanAssociation(string name, CommitmentPlanAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20241001:CommitmentPlanAssociation", name, args ?? new CommitmentPlanAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommitmentPlanAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20241001:CommitmentPlanAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
