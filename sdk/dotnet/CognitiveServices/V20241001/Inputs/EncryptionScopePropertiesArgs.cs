...
namespace Pulumi.AzureNative.CognitiveServices.V20241001.Inputs
{
    ...
    public sealed class EncryptionScopePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("keySource")]
        public InputUnion<string, Pulumi.AzureNative.CognitiveServices.V20241001.KeySource>? KeySource { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.CognitiveServices.V20241001.EncryptionScopeState>? State { get; set; }
