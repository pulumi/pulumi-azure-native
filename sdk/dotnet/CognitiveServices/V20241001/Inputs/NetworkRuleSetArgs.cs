...
namespace Pulumi.AzureNative.CognitiveServices.V20241001.Inputs
{
    ...
    public sealed class NetworkRuleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bypass")]
        public InputUnion<string, Pulumi.AzureNative.CognitiveServices.V20241001.ByPassSelection>? Bypass { get; set; }

        /// <summary>
        /// The default action when no rule from ipRules and from virtualNetworkRules match. This is only used after the bypass property has been evaluated.
        /// </summary>
        [Input("defaultAction")]
        public InputUnion<string, Pulumi.AzureNative.CognitiveServices.V20241001.NetworkRuleAction>? DefaultAction { get; set; }
