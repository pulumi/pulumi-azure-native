...
namespace Pulumi.AzureNative.CognitiveServices.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20241001:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20241001:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20241001:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
