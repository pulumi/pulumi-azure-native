...
namespace Pulumi.AzureNative.CognitiveServices.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20241001:EncryptionScope")]
    public partial class EncryptionScope : global::Pulumi.CustomResource
    {
        ...
        public EncryptionScope(string name, EncryptionScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20241001:EncryptionScope", name, args ?? new EncryptionScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EncryptionScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20241001:EncryptionScope", name, null, MakeResourceOptions(options, id))
        {
        }
