...
namespace Pulumi.AzureNative.CognitiveServices.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20241001:CommitmentPlan")]
    public partial class CommitmentPlan : global::Pulumi.CustomResource
    {
        ...
        public CommitmentPlan(string name, CommitmentPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20241001:CommitmentPlan", name, args ?? new CommitmentPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommitmentPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20241001:CommitmentPlan", name, null, MakeResourceOptions(options, id))
        {
        }
