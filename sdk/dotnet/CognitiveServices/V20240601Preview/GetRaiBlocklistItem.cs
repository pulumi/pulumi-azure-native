...
namespace Pulumi.AzureNative.CognitiveServices.V20240601Preview
{
    public static class GetRaiBlocklistItem
    {
        ...
        public static Task<GetRaiBlocklistItemResult> InvokeAsync(GetRaiBlocklistItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRaiBlocklistItemResult>("azure-native:cognitiveservices/v20240601preview:getRaiBlocklistItem", args ?? new GetRaiBlocklistItemArgs(), options.WithDefaults());
