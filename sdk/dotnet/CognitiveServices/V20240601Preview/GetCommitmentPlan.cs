...
namespace Pulumi.AzureNative.CognitiveServices.V20240601Preview
{
    public static class GetCommitmentPlan
    {
        ...
        public static Task<GetCommitmentPlanResult> InvokeAsync(GetCommitmentPlanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCommitmentPlanResult>("azure-native:cognitiveservices/v20240601preview:getCommitmentPlan", args ?? new GetCommitmentPlanArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified commitmentPlans associated with the Cognitive Services account.
        /// </summary>
        public static Output<GetCommitmentPlanResult> Invoke(GetCommitmentPlanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCommitmentPlanResult>("azure-native:cognitiveservices/v20240601preview:getCommitmentPlan", args ?? new GetCommitmentPlanInvokeArgs(), options.WithDefaults());
    }
