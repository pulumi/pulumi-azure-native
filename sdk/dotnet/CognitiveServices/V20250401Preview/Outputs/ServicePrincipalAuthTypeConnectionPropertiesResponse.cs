...
namespace Pulumi.AzureNative.CognitiveServices.V20250401Preview.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePrincipalAuthTypeConnectionPropertiesResponse
    {
        /// <summary>
        ...
        public readonly Outputs.ConnectionServicePrincipalResponse? Credentials;
        ...
        [OutputConstructor]
        private ServicePrincipalAuthTypeConnectionPropertiesResponse(
            string authType,
            ...
            Outputs.ConnectionServicePrincipalResponse? credentials,
