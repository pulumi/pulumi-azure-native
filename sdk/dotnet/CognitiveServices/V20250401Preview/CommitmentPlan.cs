...
namespace Pulumi.AzureNative.CognitiveServices.V20250401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20250401preview:CommitmentPlan")]
    public partial class CommitmentPlan : global::Pulumi.CustomResource
    {
        ...
        public CommitmentPlan(string name, CommitmentPlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20250401preview:CommitmentPlan", name, args ?? new CommitmentPlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommitmentPlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20250401preview:CommitmentPlan", name, null, MakeResourceOptions(options, id))
        {
        }
