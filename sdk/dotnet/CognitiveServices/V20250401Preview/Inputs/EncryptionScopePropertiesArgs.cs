...
namespace Pulumi.AzureNative.CognitiveServices.V20250401Preview.Inputs
{
    ...
    public sealed class EncryptionScopePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("keySource")]
        public InputUnion<string, Pulumi.AzureNative.CognitiveServices.V20250401Preview.KeySource>? KeySource { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.CognitiveServices.V20250401Preview.EncryptionScopeState>? State { get; set; }
