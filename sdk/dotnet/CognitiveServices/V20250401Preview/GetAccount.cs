...
namespace Pulumi.AzureNative.CognitiveServices.V20250401Preview
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:cognitiveservices/v20250401preview:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a Cognitive Services account specified by the parameters.
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:cognitiveservices/v20250401preview:getAccount", args ?? new GetAccountInvokeArgs(), options.WithDefaults());
