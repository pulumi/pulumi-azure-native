...
namespace Pulumi.AzureNative.CognitiveServices.V20250401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20250401preview:RaiBlocklist")]
    public partial class RaiBlocklist : global::Pulumi.CustomResource
    {
        ...
        public RaiBlocklist(string name, RaiBlocklistArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20250401preview:RaiBlocklist", name, args ?? new RaiBlocklistArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RaiBlocklist(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20250401preview:RaiBlocklist", name, null, MakeResourceOptions(options, id))
        {
        }
