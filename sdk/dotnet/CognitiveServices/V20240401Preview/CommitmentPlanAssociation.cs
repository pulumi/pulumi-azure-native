...
namespace Pulumi.AzureNative.CognitiveServices.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20240401preview:CommitmentPlanAssociation")]
    public partial class CommitmentPlanAssociation : global::Pulumi.CustomResource
    {
        ...
        public CommitmentPlanAssociation(string name, CommitmentPlanAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20240401preview:CommitmentPlanAssociation", name, args ?? new CommitmentPlanAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommitmentPlanAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20240401preview:CommitmentPlanAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
