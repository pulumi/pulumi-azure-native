...
namespace Pulumi.AzureNative.CognitiveServices.V20240401Preview
{
    public static class GetRaiBlocklist
    {
        ...
        public static Task<GetRaiBlocklistResult> InvokeAsync(GetRaiBlocklistArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRaiBlocklistResult>("azure-native:cognitiveservices/v20240401preview:getRaiBlocklist", args ?? new GetRaiBlocklistArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified custom blocklist associated with the Azure OpenAI account.
        /// </summary>
        public static Output<GetRaiBlocklistResult> Invoke(GetRaiBlocklistInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRaiBlocklistResult>("azure-native:cognitiveservices/v20240401preview:getRaiBlocklist", args ?? new GetRaiBlocklistInvokeArgs(), options.WithDefaults());
