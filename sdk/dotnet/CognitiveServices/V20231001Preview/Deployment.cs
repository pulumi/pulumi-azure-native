...
namespace Pulumi.AzureNative.CognitiveServices.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20231001preview:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20231001preview:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20231001preview:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
