...
namespace Pulumi.AzureNative.CognitiveServices.V20231001Preview
{
    public static class ListAccountKeys
    {
        ...
        public static Task<ListAccountKeysResult> InvokeAsync(ListAccountKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAccountKeysResult>("azure-native:cognitiveservices/v20231001preview:listAccountKeys", args ?? new ListAccountKeysArgs(), options.WithDefaults());
