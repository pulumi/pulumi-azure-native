...
namespace Pulumi.AzureNative.CognitiveServices.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cognitiveservices/v20231001preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20231001preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cognitiveservices/v20231001preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
