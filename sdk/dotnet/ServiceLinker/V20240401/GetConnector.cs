...
namespace Pulumi.AzureNative.ServiceLinker.V20240401
{
    public static class GetConnector
    {
        ...
        public static Task<GetConnectorResult> InvokeAsync(GetConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectorResult>("azure-native:servicelinker/v20240401:getConnector", args ?? new GetConnectorArgs(), options.WithDefaults());
