...
namespace Pulumi.AzureNative.ServiceLinker.V20240401.Inputs
{
    ...
    public sealed class FirewallRulesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("azureServices")]
        public InputUnion<string, Pulumi.AzureNative.ServiceLinker.V20240401.AllowType>? AzureServices { get; set; }

        /// <summary>
        /// Allow caller client IP to access the target service if true. the property is used when connecting local application to target service.
        /// </summary>
        [Input("callerClientIP")]
        public InputUnion<string, Pulumi.AzureNative.ServiceLinker.V20240401.AllowType>? CallerClientIP { get; set; }
