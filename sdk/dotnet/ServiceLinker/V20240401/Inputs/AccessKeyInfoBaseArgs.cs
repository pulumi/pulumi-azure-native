...
namespace Pulumi.AzureNative.ServiceLinker.V20240401.Inputs
{
    ...
    public sealed class AccessKeyInfoBaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("permissions")]
        private InputList<Union<string, Pulumi.AzureNative.ServiceLinker.V20240401.AccessKeyPermissions>>? _permissions;
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceLinker.V20240401.AccessKeyPermissions>> Permissions
        {
            get => _permissions ?? (_permissions = new InputList<Union<string, Pulumi.AzureNative.ServiceLinker.V20240401.AccessKeyPermissions>>());
