...
namespace Pulumi.AzureNative.ServiceLinker.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicelinker/v20240401:Linker")]
    public partial class Linker : global::Pulumi.CustomResource
    {
        ...
        public Linker(string name, LinkerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20240401:Linker", name, args ?? new LinkerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Linker(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20240401:Linker", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LinkerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("clientType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceLinker.V20240401.ClientType>? ClientType { get; set; }
