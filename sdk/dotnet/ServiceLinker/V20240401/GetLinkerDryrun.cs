...
namespace Pulumi.AzureNative.ServiceLinker.V20240401
{
    public static class GetLinkerDryrun
    {
        ...
        public static Task<GetLinkerDryrunResult> InvokeAsync(GetLinkerDryrunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLinkerDryrunResult>("azure-native:servicelinker/v20240401:getLinkerDryrun", args ?? new GetLinkerDryrunArgs(), options.WithDefaults());
