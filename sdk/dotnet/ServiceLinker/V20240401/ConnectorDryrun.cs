...
namespace Pulumi.AzureNative.ServiceLinker.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicelinker/v20240401:ConnectorDryrun")]
    public partial class ConnectorDryrun : global::Pulumi.CustomResource
    {
        ...
        public ConnectorDryrun(string name, ConnectorDryrunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20240401:ConnectorDryrun", name, args ?? new ConnectorDryrunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorDryrun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20240401:ConnectorDryrun", name, null, MakeResourceOptions(options, id))
        {
        }
