...
namespace Pulumi.AzureNative.ServiceLinker.V20240401
{
    public static class ListLinkerConfigurations
    {
        ...
        public static Task<ListLinkerConfigurationsResult> InvokeAsync(ListLinkerConfigurationsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListLinkerConfigurationsResult>("azure-native:servicelinker/v20240401:listLinkerConfigurations", args ?? new ListLinkerConfigurationsArgs(), options.WithDefaults());
