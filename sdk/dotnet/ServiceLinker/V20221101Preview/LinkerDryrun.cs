...
namespace Pulumi.AzureNative.ServiceLinker.V20221101Preview
{
    ...
    public partial class LinkerDryrun : global::Pulumi.CustomResource
    {
        ...
        public LinkerDryrun(string name, LinkerDryrunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20221101preview:LinkerDryrun", name, args ?? new LinkerDryrunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkerDryrun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20221101preview:LinkerDryrun", name, null, MakeResourceOptions(options, id))
        {
        }
