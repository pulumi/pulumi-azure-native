...
namespace Pulumi.AzureNative.ServiceLinker.V20221101Preview
{
    ...
    /// {
    ///     var connectorDryrun = new AzureNative.ServiceLinker.V20221101Preview.ConnectorDryrun("connectorDryrun", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:servicelinker/v20221101preview:ConnectorDryrun")]
    public partial class ConnectorDryrun : global::Pulumi.CustomResource
    {
        ...
        public ConnectorDryrun(string name, ConnectorDryrunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20221101preview:ConnectorDryrun", name, args ?? new ConnectorDryrunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorDryrun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20221101preview:ConnectorDryrun", name, null, MakeResourceOptions(options, id))
        {
        }
