...
namespace Pulumi.AzureNative.ServiceLinker.V20230401Preview
{
    public static class GetLinker
    {
        ...
        public static Task<GetLinkerResult> InvokeAsync(GetLinkerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLinkerResult>("azure-native:servicelinker/v20230401preview:getLinker", args ?? new GetLinkerArgs(), options.WithDefaults());

        /// <summary>
        /// Returns Linker resource for a given name.
        /// </summary>
        public static Output<GetLinkerResult> Invoke(GetLinkerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLinkerResult>("azure-native:servicelinker/v20230401preview:getLinker", args ?? new GetLinkerInvokeArgs(), options.WithDefaults());
