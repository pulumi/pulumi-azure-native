...
namespace Pulumi.AzureNative.ServiceLinker.V20230401Preview
{
    public static class GetLinkerDryrun
    {
        ...
        public static Task<GetLinkerDryrunResult> InvokeAsync(GetLinkerDryrunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLinkerDryrunResult>("azure-native:servicelinker/v20230401preview:getLinkerDryrun", args ?? new GetLinkerDryrunArgs(), options.WithDefaults());

        /// <summary>
        /// get a dryrun job
        /// </summary>
        public static Output<GetLinkerDryrunResult> Invoke(GetLinkerDryrunInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLinkerDryrunResult>("azure-native:servicelinker/v20230401preview:getLinkerDryrun", args ?? new GetLinkerDryrunInvokeArgs(), options.WithDefaults());
    }
