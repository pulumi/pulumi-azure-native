...
namespace Pulumi.AzureNative.ServiceLinker.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicelinker/v20230401preview:Linker")]
    public partial class Linker : global::Pulumi.CustomResource
    {
        ...
        public Linker(string name, LinkerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20230401preview:Linker", name, args ?? new LinkerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Linker(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20230401preview:Linker", name, null, MakeResourceOptions(options, id))
        {
        }
