...
namespace Pulumi.AzureNative.ServiceLinker.V20220101Preview
{
    /// <summary>
    /// Linker of source and target resource
    /// </summary>
    [Obsolete(@"azure-native:servicelinker/v20220101preview:Linker is being removed in the next major version of this provider. Upgrade to at least azure-native:servicelinker/v20221101preview:Linker to guarantee forwards compatibility.")]
    ...
    public partial class Linker : global::Pulumi.CustomResource
    {
        ...
        public Linker(string name, LinkerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20220101preview:Linker", name, args ?? new LinkerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Linker(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20220101preview:Linker", name, null, MakeResourceOptions(options, id))
        {
        }
