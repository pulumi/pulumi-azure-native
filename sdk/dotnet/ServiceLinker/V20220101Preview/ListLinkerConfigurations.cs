...
namespace Pulumi.AzureNative.ServiceLinker.V20220101Preview
{
    public static class ListLinkerConfigurations
    {
        ...
        public static Task<ListLinkerConfigurationsResult> InvokeAsync(ListLinkerConfigurationsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListLinkerConfigurationsResult>("azure-native:servicelinker/v20220101preview:listLinkerConfigurations", args ?? new ListLinkerConfigurationsArgs(), options.WithDefaults());
        ...
        public static Output<ListLinkerConfigurationsResult> Invoke(ListLinkerConfigurationsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListLinkerConfigurationsResult>("azure-native:servicelinker/v20220101preview:listLinkerConfigurations", args ?? new ListLinkerConfigurationsInvokeArgs(), options.WithDefaults());
    }
