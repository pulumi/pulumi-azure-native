...
namespace Pulumi.AzureNative.ServiceLinker.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicelinker/v20240701preview:ConnectorDryrun")]
    public partial class ConnectorDryrun : global::Pulumi.CustomResource
    {
        ...
        public ConnectorDryrun(string name, ConnectorDryrunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20240701preview:ConnectorDryrun", name, args ?? new ConnectorDryrunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorDryrun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20240701preview:ConnectorDryrun", name, null, MakeResourceOptions(options, id))
        {
        }
