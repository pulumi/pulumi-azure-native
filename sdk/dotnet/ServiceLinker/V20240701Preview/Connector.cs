...
namespace Pulumi.AzureNative.ServiceLinker.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:servicelinker/v20240701preview:Connector")]
    public partial class Connector : global::Pulumi.CustomResource
    {
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20240701preview:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker/v20240701preview:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("clientType")]
        public InputUnion<string, Pulumi.AzureNative.ServiceLinker.V20240701Preview.ClientType>? ClientType { get; set; }
