...
namespace Pulumi.AzureNative.ServiceLinker.V20240701Preview.Inputs
{
    ...
    public sealed class AccessKeyInfoBaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("permissions")]
        private InputList<Union<string, Pulumi.AzureNative.ServiceLinker.V20240701Preview.AccessKeyPermissions>>? _permissions;
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ServiceLinker.V20240701Preview.AccessKeyPermissions>> Permissions
        {
            get => _permissions ?? (_permissions = new InputList<Union<string, Pulumi.AzureNative.ServiceLinker.V20240701Preview.AccessKeyPermissions>>());
