...
namespace Pulumi.AzureNative.ServiceLinker.V20240701Preview
{
    public static class GetConnectorDryrun
    {
        ...
        public static Task<GetConnectorDryrunResult> InvokeAsync(GetConnectorDryrunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectorDryrunResult>("azure-native:servicelinker/v20240701preview:getConnectorDryrun", args ?? new GetConnectorDryrunArgs(), options.WithDefaults());

        /// <summary>
        /// get a dryrun job
        /// </summary>
        public static Output<GetConnectorDryrunResult> Invoke(GetConnectorDryrunInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectorDryrunResult>("azure-native:servicelinker/v20240701preview:getConnectorDryrun", args ?? new GetConnectorDryrunInvokeArgs(), options.WithDefaults());
    }
