...
namespace Pulumi.AzureNative.ServiceLinker.V20240701Preview
{
    public static class GetConnector
    {
        ...
        public static Task<GetConnectorResult> InvokeAsync(GetConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectorResult>("azure-native:servicelinker/v20240701preview:getConnector", args ?? new GetConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Returns Connector resource for a given name.
        /// </summary>
        public static Output<GetConnectorResult> Invoke(GetConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectorResult>("azure-native:servicelinker/v20240701preview:getConnector", args ?? new GetConnectorInvokeArgs(), options.WithDefaults());
    }
