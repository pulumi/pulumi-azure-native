...
namespace Pulumi.AzureNative.ServiceLinker.V20240701Preview
{
    ...
    public readonly struct AzureResourceType : IEquatable<AzureResourceType>
    {
        ...
        public static AzureResourceType AppConfig { get; } = new AzureResourceType("AppConfig");
    ...
    public readonly struct TargetServiceType : IEquatable<TargetServiceType>
    {
        ...
        public static TargetServiceType FabricPlatform { get; } = new TargetServiceType("FabricPlatform");
