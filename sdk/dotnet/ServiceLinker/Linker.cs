...
namespace Pulumi.AzureNative.ServiceLinker
{
    ...
    /// 
    /// Other available API versions: 2021-11-01-preview, 2022-01-01-preview, 2022-05-01, 2022-11-01-preview, 2023-04-01-preview, 2024-07-01-preview.
    /// </summary>
    ...
    public partial class Linker : global::Pulumi.CustomResource
    {
        ...
        public Linker(string name, LinkerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker:Linker", name, args ?? new LinkerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Linker(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicelinker:Linker", name, null, MakeResourceOptions(options, id))
        {
        }
