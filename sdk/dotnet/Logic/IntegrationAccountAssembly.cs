...
namespace Pulumi.AzureRM.Logic
{
    ...
    public partial class IntegrationAccountAssembly : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountAssembly(string name, IntegrationAccountAssemblyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic:IntegrationAccountAssembly", name, args ?? new IntegrationAccountAssemblyArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private IntegrationAccountAssembly(string name, Input<string> id, IntegrationAccountAssemblyState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:logic:IntegrationAccountAssembly", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IntegrationAccountAssemblyState : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.AssemblyPropertiesResponseGetArgs> Properties { get; set; } = null!;
