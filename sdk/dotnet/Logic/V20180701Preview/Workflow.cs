...
namespace Pulumi.AzureRM.Logic.V20180701Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workflow = new AzureRM.Logic.V20180701Preview.Workflow("workflow", new AzureRM.Logic.V20180701Preview.WorkflowArgs
    ///         {
    ///             Definition = 
    ///             {
    ...
    ///                 } },
    ///             },
    ///             IntegrationAccount = new AzureRM.Logic.V20180701Preview.Inputs.ResourceReferenceArgs
    ///             {
    ...
    ///             Parameters = 
    ///             {
    ///                 { "$connections", new AzureRM.Logic.V20180701Preview.Inputs.WorkflowParameterArgs
    ///                 {
    ///                     Value = 
    ///                     {
    ...
    public partial class Workflow : Pulumi.CustomResource
    {
        ...
        public Workflow(string name, WorkflowArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:Workflow", name, args ?? new WorkflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workflow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:Workflow", name, null, MakeResourceOptions(options, id))
        {
        }
