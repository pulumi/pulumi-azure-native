...
namespace Pulumi.AzureNative.Logic.V20180701Preview
{
    ...
    /// {
    ///     var workflow = new AzureNative.Logic.V20180701Preview.Workflow("workflow", new()
    ///     {
    ///         Definition = 
    ///         {
    ...
    ///             } },
    ///         },
    ///         IntegrationAccount = new AzureNative.Logic.V20180701Preview.Inputs.ResourceReferenceArgs
    ///         {
    ...
    ///         Parameters = 
    ///         {
    ///             { "$connections", new AzureNative.Logic.V20180701Preview.Inputs.WorkflowParameterArgs
    ///             {
    ///                 Value = 
    ///                 {
