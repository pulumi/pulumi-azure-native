...
namespace Pulumi.AzureNextGen.Logic.V20180701Preview
{
    ...
    public partial class IntegrationAccountBatchConfiguration : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountBatchConfiguration(string name, IntegrationAccountBatchConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic/v20180701preview:IntegrationAccountBatchConfiguration", name, args ?? new IntegrationAccountBatchConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountBatchConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic/v20180701preview:IntegrationAccountBatchConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
