...
namespace Pulumi.AzureRM.Logic.V20180701Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var integrationAccountMap = new AzureRM.Logic.V20180701Preview.IntegrationAccountMap("integrationAccountMap", new AzureRM.Logic.V20180701Preview.IntegrationAccountMapArgs
    ///         {
    ...
    public partial class IntegrationAccountMap : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountMap(string name, IntegrationAccountMapArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:IntegrationAccountMap", name, args ?? new IntegrationAccountMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:IntegrationAccountMap", name, null, MakeResourceOptions(options, id))
        {
        }
