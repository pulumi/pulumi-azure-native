...
namespace Pulumi.AzureNative.Logic.V20180701Preview
{
    ...
    public partial class IntegrationAccountPartner : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountPartner(string name, IntegrationAccountPartnerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20180701preview:IntegrationAccountPartner", name, args ?? new IntegrationAccountPartnerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountPartner(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20180701preview:IntegrationAccountPartner", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IntegrationAccountPartnerArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Logic.V20180701Preview.PartnerType> PartnerType { get; set; } = null!;
