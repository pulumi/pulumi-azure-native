...
namespace Pulumi.AzureRM.Logic.V20180701Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var integrationAccountPartner = new AzureRM.Logic.V20180701Preview.IntegrationAccountPartner("integrationAccountPartner", new AzureRM.Logic.V20180701Preview.IntegrationAccountPartnerArgs
    ///         {
    ///             Content = new AzureRM.Logic.V20180701Preview.Inputs.PartnerContentArgs
    ///             {
    ///                 B2b = new AzureRM.Logic.V20180701Preview.Inputs.B2BPartnerContentArgs
    ///                 {
    ///                     BusinessIdentities = 
    ///                     {
    ///                         new AzureRM.Logic.V20180701Preview.Inputs.BusinessIdentityArgs
    ///                         {
    ///                             Qualifier = "AA",
    ///                             Value = "ZZ",
    ///                         },
    ...
    public partial class IntegrationAccountPartner : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountPartner(string name, IntegrationAccountPartnerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:IntegrationAccountPartner", name, args ?? new IntegrationAccountPartnerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountPartner(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:IntegrationAccountPartner", name, null, MakeResourceOptions(options, id))
        {
        }
