...
namespace Pulumi.AzureNative.Logic.V20180701Preview
{
    ...
    public partial class IntegrationAccountAgreement : global::Pulumi.CustomResource
    {
        ...
        public IntegrationAccountAgreement(string name, IntegrationAccountAgreementArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20180701preview:IntegrationAccountAgreement", name, args ?? new IntegrationAccountAgreementArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountAgreement(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20180701preview:IntegrationAccountAgreement", name, null, MakeResourceOptions(options, id))
        {
        }
