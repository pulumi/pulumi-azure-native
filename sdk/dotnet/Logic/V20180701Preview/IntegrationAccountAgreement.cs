...
namespace Pulumi.AzureNextGen.Logic.V20180701Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:logic/v20180701preview:IntegrationAccountAgreement")]
    public partial class IntegrationAccountAgreement : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountAgreement(string name, IntegrationAccountAgreementArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic/v20180701preview:IntegrationAccountAgreement", name, args ?? new IntegrationAccountAgreementArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountAgreement(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic/v20180701preview:IntegrationAccountAgreement", name, null, MakeResourceOptions(options, id))
        {
        }
