...
namespace Pulumi.AzureNative.Logic.V20180701Preview.Inputs
{
    ...
    public sealed class X12EnvelopeSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Logic.V20180701Preview.X12DateFormat> GroupHeaderDateFormat { get; set; } = null!;

        /// <summary>
        /// The group header time format.
        /// </summary>
        [Input("groupHeaderTimeFormat", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Logic.V20180701Preview.X12TimeFormat> GroupHeaderTimeFormat { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Logic.V20180701Preview.UsageIndicator> UsageIndicator { get; set; } = null!;
