...
namespace Pulumi.AzureNative.Logic.V20180701Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:logic/v20180701preview:IntegrationAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:logic/v20190501:IntegrationAccount to guarantee forwards compatibility.")]
    ...
    public partial class IntegrationAccount : global::Pulumi.CustomResource
    {
        ...
        public IntegrationAccount(string name, IntegrationAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20180701preview:IntegrationAccount", name, args ?? new IntegrationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20180701preview:IntegrationAccount", name, null, MakeResourceOptions(options, id))
        {
        }
