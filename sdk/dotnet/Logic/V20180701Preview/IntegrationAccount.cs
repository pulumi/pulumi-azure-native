...
namespace Pulumi.AzureRM.Logic.V20180701Preview
{
    ...
    public partial class IntegrationAccount : Pulumi.CustomResource
    {
        ...
        public IntegrationAccount(string name, IntegrationAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:IntegrationAccount", name, args ?? new IntegrationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:IntegrationAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:logic/latest:IntegrationAccount"},
                    new Pulumi.Alias { Type = "azurerm:logic/preview:IntegrationAccount"},
                    new Pulumi.Alias { Type = "azurerm:logic/v20150801preview:IntegrationAccount"},
                    new Pulumi.Alias { Type = "azurerm:logic/v20160601:IntegrationAccount"},
                    new Pulumi.Alias { Type = "azurerm:logic/v20190501:IntegrationAccount"},
                },
            };
