...
namespace Pulumi.AzureRM.Logic.V20180701Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var integrationAccountCertificate = new AzureRM.Logic.V20180701Preview.IntegrationAccountCertificate("integrationAccountCertificate", new AzureRM.Logic.V20180701Preview.IntegrationAccountCertificateArgs
    ///         {
    ///             CertificateName = "testCertificate",
    ///             IntegrationAccountName = "testIntegrationAccount",
    ///             Key = new AzureRM.Logic.V20180701Preview.Inputs.KeyVaultKeyReferenceArgs
    ///             {
    ///                 KeyName = "&lt;keyName&gt;",
    ///                 KeyVault = new AzureRM.Logic.V20180701Preview.Inputs.KeyVaultKeyReferenceKeyVaultArgs
    ///                 {
    ...
    public partial class IntegrationAccountCertificate : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountCertificate(string name, IntegrationAccountCertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:IntegrationAccountCertificate", name, args ?? new IntegrationAccountCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20180701preview:IntegrationAccountCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
