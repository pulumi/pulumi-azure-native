...
namespace Pulumi.AzureRM.Logic
{
    ...
    public partial class IntegrationServiceEnvironment : Pulumi.CustomResource
    {
        ...
        public IntegrationServiceEnvironment(string name, IntegrationServiceEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic:IntegrationServiceEnvironment", name, args ?? new IntegrationServiceEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationServiceEnvironment(string name, Input<string> id, IntegrationServiceEnvironmentState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:logic:IntegrationServiceEnvironment", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IntegrationServiceEnvironment Get(string name, Input<string> id, IntegrationServiceEnvironmentState? state = null, CustomResourceOptions? options = null)
        {
            return new IntegrationServiceEnvironment(name, id, state, options);
        }
    }
    ...
    public sealed class IntegrationServiceEnvironmentState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The resource location.
        /// </summary>
        ...
        public Input<Inputs.IntegrationServiceEnvironmentPropertiesResponseGetArgs> Properties { get; set; } = null!;

        /// <summary>
        /// The sku.
        /// </summary>
        [Input("sku")]
        public Input<Inputs.IntegrationServiceEnvironmentSkuResponseGetArgs>? Sku { get; set; }
        ...
        public IntegrationServiceEnvironmentState()
        {
        }
    }
}
