...
namespace Pulumi.AzureNative.Logic
{
    ...
    public partial class IntegrationAccountMap : global::Pulumi.CustomResource
    {
        ...
        public IntegrationAccountMap(string name, IntegrationAccountMapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic:IntegrationAccountMap", name, args ?? new IntegrationAccountMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic:IntegrationAccountMap", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_logic_v20150801preview:logic:IntegrationAccountMap" },
                    new global::Pulumi.Alias { Type = "azure-native_logic_v20160601:logic:IntegrationAccountMap" },
                    new global::Pulumi.Alias { Type = "azure-native_logic_v20180701preview:logic:IntegrationAccountMap" },
                    new global::Pulumi.Alias { Type = "azure-native_logic_v20190501:logic:IntegrationAccountMap" },
                },
            };
