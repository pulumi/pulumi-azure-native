...
namespace Pulumi.AzureNextGen.Logic
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:logic:IntegrationAccountMap")]
    public partial class IntegrationAccountMap : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountMap(string name, IntegrationAccountMapArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic:IntegrationAccountMap", name, args ?? new IntegrationAccountMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic:IntegrationAccountMap", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IntegrationAccountMapArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Logic.MapType> MapType { get; set; } = null!;
