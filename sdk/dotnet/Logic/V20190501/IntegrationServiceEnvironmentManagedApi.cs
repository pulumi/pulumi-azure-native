...
namespace Pulumi.AzureNative.Logic.V20190501
{
    ...
    /// {
    ///     var integrationServiceEnvironmentManagedApi = new AzureNative.Logic.V20190501.IntegrationServiceEnvironmentManagedApi("integrationServiceEnvironmentManagedApi", new()
    ///     {
    ///         ApiName = "servicebus",
    ...
    public partial class IntegrationServiceEnvironmentManagedApi : global::Pulumi.CustomResource
    {
        ...
        public IntegrationServiceEnvironmentManagedApi(string name, IntegrationServiceEnvironmentManagedApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:IntegrationServiceEnvironmentManagedApi", name, args ?? new IntegrationServiceEnvironmentManagedApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationServiceEnvironmentManagedApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:IntegrationServiceEnvironmentManagedApi", name, null, MakeResourceOptions(options, id))
        {
        }
