...
namespace Pulumi.AzureNextGen.Logic.V20190501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:logic/v20190501:IntegrationAccountMap")]
    ...
    public sealed class IntegrationAccountMapArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Logic.V20190501.MapType> MapType { get; set; } = null!;
