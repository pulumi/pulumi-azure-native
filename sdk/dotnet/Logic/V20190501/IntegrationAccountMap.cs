...
namespace Pulumi.AzureNative.Logic.V20190501
{
    ...
    /// {
    ///     var integrationAccountMap = new AzureNative.Logic.V20190501.IntegrationAccountMap("integrationAccountMap", new()
    ///     {
    ...
    public partial class IntegrationAccountMap : global::Pulumi.CustomResource
    {
        ...
        public IntegrationAccountMap(string name, IntegrationAccountMapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:IntegrationAccountMap", name, args ?? new IntegrationAccountMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:IntegrationAccountMap", name, null, MakeResourceOptions(options, id))
        {
        }
