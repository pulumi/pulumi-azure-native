...
namespace Pulumi.AzureRM.Logic.V20190501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var integrationAccountSession = new AzureRM.Logic.V20190501.IntegrationAccountSession("integrationAccountSession", new AzureRM.Logic.V20190501.IntegrationAccountSessionArgs
    ///         {
    ///             Content = 
    ///             {
    ///                 { "controlNumber", "1234" },
    ...
    public partial class IntegrationAccountSession : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountSession(string name, IntegrationAccountSessionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20190501:IntegrationAccountSession", name, args ?? new IntegrationAccountSessionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountSession(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20190501:IntegrationAccountSession", name, null, MakeResourceOptions(options, id))
        {
        }
