...
namespace Pulumi.AzureRM.Logic.V20190501
{
    ...
    public partial class IntegrationAccountAssembly : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountAssembly(string name, IntegrationAccountAssemblyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20190501:IntegrationAccountAssembly", name, args ?? new IntegrationAccountAssemblyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountAssembly(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20190501:IntegrationAccountAssembly", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:logic/v20160601:IntegrationAccountAssembly"},
                },
            };
