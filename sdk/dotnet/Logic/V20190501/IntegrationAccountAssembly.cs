...
namespace Pulumi.AzureNative.Logic.V20190501
{
    ...
    /// {
    ///     var integrationAccountAssembly = new AzureNative.Logic.V20190501.IntegrationAccountAssembly("integrationAccountAssembly", new()
    ///     {
    ///         AssemblyArtifactName = "testAssembly",
    ///         IntegrationAccountName = "testIntegrationAccount",
    ///         Location = "westus",
    ///         Properties = new AzureNative.Logic.V20190501.Inputs.AssemblyPropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:logic/v20190501:IntegrationAccountAssembly")]
    public partial class IntegrationAccountAssembly : global::Pulumi.CustomResource
    {
        ...
        public IntegrationAccountAssembly(string name, IntegrationAccountAssemblyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:IntegrationAccountAssembly", name, args ?? new IntegrationAccountAssemblyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountAssembly(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:IntegrationAccountAssembly", name, null, MakeResourceOptions(options, id))
        {
        }
