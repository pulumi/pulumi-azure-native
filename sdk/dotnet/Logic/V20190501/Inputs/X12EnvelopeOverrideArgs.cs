...
namespace Pulumi.AzureNative.Logic.V20190501.Inputs
{
    ...
    public sealed class X12EnvelopeOverrideArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Logic.V20190501.X12DateFormat> DateFormat { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Logic.V20190501.X12TimeFormat> TimeFormat { get; set; } = null!;
