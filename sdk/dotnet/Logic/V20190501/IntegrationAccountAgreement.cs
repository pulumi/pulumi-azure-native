...
namespace Pulumi.AzureRM.Logic.V20190501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var integrationAccountAgreement = new AzureRM.Logic.V20190501.IntegrationAccountAgreement("integrationAccountAgreement", new AzureRM.Logic.V20190501.IntegrationAccountAgreementArgs
    ///         {
    ///             AgreementName = "testAgreement",
    ///             AgreementType = "AS2",
    ///             Content = new AzureRM.Logic.V20190501.Inputs.AgreementContentArgs
    ///             {
    ///                 AS2 = new AzureRM.Logic.V20190501.Inputs.AS2AgreementContentArgs
    ///                 {
    ///                     ReceiveAgreement = new AzureRM.Logic.V20190501.Inputs.AS2OneWayAgreementArgs
    ///                     {
    ///                         ProtocolSettings = new AzureRM.Logic.V20190501.Inputs.AS2ProtocolSettingsArgs
    ///                         {
    ///                             AcknowledgementConnectionSettings = new AzureRM.Logic.V20190501.Inputs.AS2AcknowledgementConnectionSettingsArgs
    ///                             {
    ...
    ///                             },
    ///                             EnvelopeSettings = new AzureRM.Logic.V20190501.Inputs.AS2EnvelopeSettingsArgs
    ///                             {
    ...
    ///                             },
    ///                             ErrorSettings = new AzureRM.Logic.V20190501.Inputs.AS2ErrorSettingsArgs
    ///                             {
    ///                                 ResendIfMDNNotReceived = true,
    ///                                 SuspendDuplicateMessage = true,
    ///                             },
    ///                             MdnSettings = new AzureRM.Logic.V20190501.Inputs.AS2MdnSettingsArgs
    ///                             {
    ...
    ///                             },
    ///                             MessageConnectionSettings = new AzureRM.Logic.V20190501.Inputs.AS2MessageConnectionSettingsArgs
    ///                             {
    ///                                 IgnoreCertificateNameMismatch = true,
    ///                                 KeepHttpConnectionAlive = true,
    ///                                 SupportHttpStatusCodeContinue = true,
    ///                                 UnfoldHttpHeaders = true,
    ///                             },
    ///                             SecuritySettings = new AzureRM.Logic.V20190501.Inputs.AS2SecuritySettingsArgs
    ///                             {
    ...
    ///                             },
    ///                             ValidationSettings = new AzureRM.Logic.V20190501.Inputs.AS2ValidationSettingsArgs
    ///                             {
    ...
    ///                             },
    ///                         },
    ///                         ReceiverBusinessIdentity = new AzureRM.Logic.V20190501.Inputs.BusinessIdentityArgs
    ///                         {
    ///                             Qualifier = "ZZ",
    ///                             Value = "ZZ",
    ///                         },
    ///                         SenderBusinessIdentity = new AzureRM.Logic.V20190501.Inputs.BusinessIdentityArgs
    ///                         {
    ///                             Qualifier = "AA",
    ///                             Value = "AA",
    ///                         },
    ///                     },
    ///                     SendAgreement = new AzureRM.Logic.V20190501.Inputs.AS2OneWayAgreementArgs
    ///                     {
    ///                         ProtocolSettings = new AzureRM.Logic.V20190501.Inputs.AS2ProtocolSettingsArgs
    ///                         {
    ///                             AcknowledgementConnectionSettings = new AzureRM.Logic.V20190501.Inputs.AS2AcknowledgementConnectionSettingsArgs
    ...
    ///                 },
    ///             },
    ///             GuestIdentity = new AzureRM.Logic.V20190501.Inputs.BusinessIdentityArgs
    ///             {
    ///                 Qualifier = "AA",
    ///                 Value = "AA",
    ///             },
    ///             GuestPartner = "GuestPartner",
    ///             HostIdentity = new AzureRM.Logic.V20190501.Inputs.BusinessIdentityArgs
    ///             {
    ///                 Qualifier = "ZZ",
    ///                 Value = "ZZ",
    ///             },
    ...
    public partial class IntegrationAccountAgreement : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountAgreement(string name, IntegrationAccountAgreementArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20190501:IntegrationAccountAgreement", name, args ?? new IntegrationAccountAgreementArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountAgreement(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20190501:IntegrationAccountAgreement", name, null, MakeResourceOptions(options, id))
        {
        }
