...
namespace Pulumi.AzureNextGen.Logic.V20190501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:logic/v20190501:IntegrationAccountCertificate")]
    public partial class IntegrationAccountCertificate : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountCertificate(string name, IntegrationAccountCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic/v20190501:IntegrationAccountCertificate", name, args ?? new IntegrationAccountCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic/v20190501:IntegrationAccountCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
