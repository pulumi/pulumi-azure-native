...
namespace Pulumi.AzureNative.Logic.V20190501
{
    ...
    /// {
    ///     var integrationAccountCertificate = new AzureNative.Logic.V20190501.IntegrationAccountCertificate("integrationAccountCertificate", new()
    ///     {
    ///         CertificateName = "testCertificate",
    ///         IntegrationAccountName = "testIntegrationAccount",
    ///         Key = new AzureNative.Logic.V20190501.Inputs.KeyVaultKeyReferenceArgs
    ///         {
    ///             KeyName = "&lt;keyName&gt;",
    ///             KeyVault = new AzureNative.Logic.V20190501.Inputs.KeyVaultKeyReferenceKeyVaultArgs
    ///             {
    ...
    public partial class IntegrationAccountCertificate : global::Pulumi.CustomResource
    {
        ...
        public IntegrationAccountCertificate(string name, IntegrationAccountCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:IntegrationAccountCertificate", name, args ?? new IntegrationAccountCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:IntegrationAccountCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
