...
namespace Pulumi.AzureNative.Logic.V20190501
{
    ...
    /// {
    ///     var workflow = new AzureNative.Logic.V20190501.Workflow("workflow", new()
    ///     {
    ///         Definition = 
    ///         {
    ...
    ///             } },
    ///         },
    ///         IntegrationAccount = new AzureNative.Logic.V20190501.Inputs.ResourceReferenceArgs
    ///         {
    ...
    ///         Parameters = 
    ///         {
    ///             { "$connections", new AzureNative.Logic.V20190501.Inputs.WorkflowParameterArgs
    ///             {
    ///                 Value = 
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:logic/v20190501:Workflow myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName} 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:logic/v20190501:Workflow")]
    public partial class Workflow : global::Pulumi.CustomResource
    {
        ...
        public Workflow(string name, WorkflowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:Workflow", name, args ?? new WorkflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workflow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20190501:Workflow", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkflowArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Logic.V20190501.WorkflowState>? State { get; set; }
