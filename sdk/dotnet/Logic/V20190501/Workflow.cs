...
namespace Pulumi.AzureRM.Logic.V20190501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workflow = new AzureRM.Logic.V20190501.Workflow("workflow", new AzureRM.Logic.V20190501.WorkflowArgs
    ///         {
    ///             Definition = 
    ///             {
    ...
    ///                 } },
    ///             },
    ///             IntegrationAccount = new AzureRM.Logic.V20190501.Inputs.ResourceReferenceArgs
    ///             {
    ...
    ///             Parameters = 
    ///             {
    ///                 { "$connections", new AzureRM.Logic.V20190501.Inputs.WorkflowParameterArgs
    ///                 {
    ///                     Value = 
    ///                     {
