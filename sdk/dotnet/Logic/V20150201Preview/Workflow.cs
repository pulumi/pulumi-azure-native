...
namespace Pulumi.AzureRM.Logic.V20150201Preview
{
    public partial class Workflow : Pulumi.CustomResource
    {
        ...
        public Workflow(string name, WorkflowArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20150201preview:Workflow", name, args ?? new WorkflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workflow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20150201preview:Workflow", name, null, MakeResourceOptions(options, id))
        {
        }
