...
namespace Pulumi.AzureRM.Logic.V20150201Preview
{
    public partial class WorkflowAccessKey : Pulumi.CustomResource
    {
        ...
        public WorkflowAccessKey(string name, WorkflowAccessKeyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20150201preview:WorkflowAccessKey", name, args ?? new WorkflowAccessKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkflowAccessKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20150201preview:WorkflowAccessKey", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:logic/preview:WorkflowAccessKey"},
                },
            };
