...
namespace Pulumi.AzureRM.Logic.Latest
{
    public static class GetWorkflowAccessKey
    {
        public static Task<GetWorkflowAccessKeyResult> InvokeAsync(GetWorkflowAccessKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkflowAccessKeyResult>("azurerm:logic/latest:getWorkflowAccessKey", args ?? new GetWorkflowAccessKeyArgs(), options.WithVersion());
    }
