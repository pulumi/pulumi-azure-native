...
namespace Pulumi.AzureNative.Logic.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:logic:IntegrationAccountAssembly'.")]
    [AzureNativeResourceType("azure-native:logic/latest:IntegrationAccountAssembly")]
    public partial class IntegrationAccountAssembly : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountAssembly(string name, IntegrationAccountAssemblyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/latest:IntegrationAccountAssembly", name, args ?? new IntegrationAccountAssemblyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountAssembly(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/latest:IntegrationAccountAssembly", name, null, MakeResourceOptions(options, id))
        {
        }
