...
namespace Pulumi.AzureNextGen.Logic.Latest
{
    ...
    public readonly struct IntegrationAccountSkuName : IEquatable<IntegrationAccountSkuName>
    {
        ...
        public static IntegrationAccountSkuName Basic { get; } = new IntegrationAccountSkuName("Basic");
    ...
    /// </summary>
    [EnumType]
    public readonly struct IntegrationServiceEnvironmentAccessEndpointType : IEquatable<IntegrationServiceEnvironmentAccessEndpointType>
    {
        private readonly string _value;

        private IntegrationServiceEnvironmentAccessEndpointType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static IntegrationServiceEnvironmentAccessEndpointType NotSpecified { get; } = new IntegrationServiceEnvironmentAccessEndpointType("NotSpecified");
        public static IntegrationServiceEnvironmentAccessEndpointType External { get; } = new IntegrationServiceEnvironmentAccessEndpointType("External");
        public static IntegrationServiceEnvironmentAccessEndpointType Internal { get; } = new IntegrationServiceEnvironmentAccessEndpointType("Internal");
        ...
        public static explicit operator string(IntegrationServiceEnvironmentAccessEndpointType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is IntegrationServiceEnvironmentAccessEndpointType other && Equals(other);
        public bool Equals(IntegrationServiceEnvironmentAccessEndpointType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct IntegrationServiceEnvironmentSkuName : IEquatable<IntegrationServiceEnvironmentSkuName>
    {
        private readonly string _value;

        private IntegrationServiceEnvironmentSkuName(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static IntegrationServiceEnvironmentSkuName NotSpecified { get; } = new IntegrationServiceEnvironmentSkuName("NotSpecified");
        public static IntegrationServiceEnvironmentSkuName Premium { get; } = new IntegrationServiceEnvironmentSkuName("Premium");
        public static IntegrationServiceEnvironmentSkuName Developer { get; } = new IntegrationServiceEnvironmentSkuName("Developer");
        ...
        public static explicit operator string(IntegrationServiceEnvironmentSkuName value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is IntegrationServiceEnvironmentSkuName other && Equals(other);
        public bool Equals(IntegrationServiceEnvironmentSkuName other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct MapType : IEquatable<MapType>
    {
        ...
        public static MapType Xslt20 { get; } = new MapType("Xslt20");
        public static MapType Xslt30 { get; } = new MapType("Xslt30");
        public static MapType Liquid { get; } = new MapType("Liquid");
    ...
    /// </summary>
    [EnumType]
    public readonly struct WorkflowProvisioningState : IEquatable<WorkflowProvisioningState>
    {
        private readonly string _value;

        private WorkflowProvisioningState(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static WorkflowProvisioningState NotSpecified { get; } = new WorkflowProvisioningState("NotSpecified");
        public static WorkflowProvisioningState Accepted { get; } = new WorkflowProvisioningState("Accepted");
        public static WorkflowProvisioningState Running { get; } = new WorkflowProvisioningState("Running");
        public static WorkflowProvisioningState Ready { get; } = new WorkflowProvisioningState("Ready");
        public static WorkflowProvisioningState Creating { get; } = new WorkflowProvisioningState("Creating");
        public static WorkflowProvisioningState Created { get; } = new WorkflowProvisioningState("Created");
        public static WorkflowProvisioningState Deleting { get; } = new WorkflowProvisioningState("Deleting");
        public static WorkflowProvisioningState Deleted { get; } = new WorkflowProvisioningState("Deleted");
        public static WorkflowProvisioningState Canceled { get; } = new WorkflowProvisioningState("Canceled");
        public static WorkflowProvisioningState Failed { get; } = new WorkflowProvisioningState("Failed");
        public static WorkflowProvisioningState Succeeded { get; } = new WorkflowProvisioningState("Succeeded");
        public static WorkflowProvisioningState Moving { get; } = new WorkflowProvisioningState("Moving");
        public static WorkflowProvisioningState Updating { get; } = new WorkflowProvisioningState("Updating");
        public static WorkflowProvisioningState Registering { get; } = new WorkflowProvisioningState("Registering");
        public static WorkflowProvisioningState Registered { get; } = new WorkflowProvisioningState("Registered");
        public static WorkflowProvisioningState Unregistering { get; } = new WorkflowProvisioningState("Unregistering");
        public static WorkflowProvisioningState Unregistered { get; } = new WorkflowProvisioningState("Unregistered");
        public static WorkflowProvisioningState Completed { get; } = new WorkflowProvisioningState("Completed");
        public static WorkflowProvisioningState Renewing { get; } = new WorkflowProvisioningState("Renewing");
        public static WorkflowProvisioningState Pending { get; } = new WorkflowProvisioningState("Pending");
        public static WorkflowProvisioningState Waiting { get; } = new WorkflowProvisioningState("Waiting");
        public static WorkflowProvisioningState InProgress { get; } = new WorkflowProvisioningState("InProgress");

        public static bool operator ==(WorkflowProvisioningState left, WorkflowProvisioningState right) => left.Equals(right);
        public static bool operator !=(WorkflowProvisioningState left, WorkflowProvisioningState right) => !left.Equals(right);

        public static explicit operator string(WorkflowProvisioningState value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is WorkflowProvisioningState other && Equals(other);
        public bool Equals(WorkflowProvisioningState other) => string.Equals(_value, other._value, StringComparison.Ordinal);
