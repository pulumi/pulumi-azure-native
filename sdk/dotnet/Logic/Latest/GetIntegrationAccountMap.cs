...
namespace Pulumi.AzureRM.Logic.Latest
{
    public static class GetIntegrationAccountMap
    {
        public static Task<GetIntegrationAccountMapResult> InvokeAsync(GetIntegrationAccountMapArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIntegrationAccountMapResult>("azurerm:logic/latest:getIntegrationAccountMap", args ?? new GetIntegrationAccountMapArgs(), options.WithVersion());
    }
