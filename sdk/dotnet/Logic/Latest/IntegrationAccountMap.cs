...
namespace Pulumi.AzureRM.Logic.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var integrationAccountMap = new AzureRM.Logic.Latest.IntegrationAccountMap("integrationAccountMap", new AzureRM.Logic.Latest.IntegrationAccountMapArgs
    ///         {
    ...
    public partial class IntegrationAccountMap : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountMap(string name, IntegrationAccountMapArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/latest:IntegrationAccountMap", name, args ?? new IntegrationAccountMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/latest:IntegrationAccountMap", name, null, MakeResourceOptions(options, id))
        {
        }
