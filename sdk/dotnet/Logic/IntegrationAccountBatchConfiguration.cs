...
namespace Pulumi.AzureRM.Logic
{
    ...
    public partial class IntegrationAccountBatchConfiguration : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountBatchConfiguration(string name, IntegrationAccountBatchConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic:IntegrationAccountBatchConfiguration", name, args ?? new IntegrationAccountBatchConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private IntegrationAccountBatchConfiguration(string name, Input<string> id, IntegrationAccountBatchConfigurationState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:logic:IntegrationAccountBatchConfiguration", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IntegrationAccountBatchConfigurationState : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.BatchConfigurationPropertiesResponseGetArgs> Properties { get; set; } = null!;
