...
namespace Pulumi.AzureRM.Logic.V20150801Preview
{
    public static class GetIntegrationAccountAgreement
    {
        public static Task<GetIntegrationAccountAgreementResult> InvokeAsync(GetIntegrationAccountAgreementArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIntegrationAccountAgreementResult>("azurerm:logic/v20150801preview:getIntegrationAccountAgreement", args ?? new GetIntegrationAccountAgreementArgs(), options.WithVersion());
    }
