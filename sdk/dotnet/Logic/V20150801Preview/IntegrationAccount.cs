...
namespace Pulumi.AzureNative.Logic.V20150801Preview
{
    ...
    public partial class IntegrationAccount : global::Pulumi.CustomResource
    {
        ...
        public IntegrationAccount(string name, IntegrationAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20150801preview:IntegrationAccount", name, args ?? new IntegrationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20150801preview:IntegrationAccount", name, null, MakeResourceOptions(options, id))
        {
        }
