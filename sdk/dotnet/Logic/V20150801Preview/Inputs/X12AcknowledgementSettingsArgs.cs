...
namespace Pulumi.AzureNextGen.Logic.V20150801Preview.Inputs
{
    ...
    public sealed class X12AcknowledgementSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("batchImplementationAcknowledgements")]
        public Input<bool>? BatchImplementationAcknowledgements { get; set; }
        ...
        /// </summary>
        [Input("needImplementationAcknowledgement")]
        public Input<bool>? NeedImplementationAcknowledgement { get; set; }
