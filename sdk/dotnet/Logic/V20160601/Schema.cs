...
namespace Pulumi.AzureRM.Logic.V20160601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var schema = new AzureRM.Logic.V20160601.Schema("schema", new AzureRM.Logic.V20160601.SchemaArgs
    ///         {
    ...
    public partial class Schema : Pulumi.CustomResource
    {
        ...
        public Schema(string name, SchemaArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20160601:Schema", name, args ?? new SchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20160601:Schema", name, null, MakeResourceOptions(options, id))
        {
        }
