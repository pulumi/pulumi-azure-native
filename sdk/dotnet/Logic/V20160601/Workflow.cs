...
namespace Pulumi.AzureRM.Logic.V20160601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workflow = new AzureRM.Logic.V20160601.Workflow("workflow", new AzureRM.Logic.V20160601.WorkflowArgs
    ///         {
    ///             Definition = 
    ///             {
    ...
    ///             Parameters = 
    ///             {
    ///                 { "$connections", new AzureRM.Logic.V20160601.Inputs.WorkflowParameterArgs
    ///                 {
    ///                     Value = 
    ///                     {
    ...
    public partial class Workflow : Pulumi.CustomResource
    {
        ...
        public Workflow(string name, WorkflowArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20160601:Workflow", name, args ?? new WorkflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workflow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/v20160601:Workflow", name, null, MakeResourceOptions(options, id))
        {
        }
