...
namespace Pulumi.AzureNative.Logic.V20160601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:logic/v20160601:IntegrationAccountBatchConfiguration")]
    public partial class IntegrationAccountBatchConfiguration : global::Pulumi.CustomResource
    {
        ...
        public IntegrationAccountBatchConfiguration(string name, IntegrationAccountBatchConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20160601:IntegrationAccountBatchConfiguration", name, args ?? new IntegrationAccountBatchConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountBatchConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic/v20160601:IntegrationAccountBatchConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
