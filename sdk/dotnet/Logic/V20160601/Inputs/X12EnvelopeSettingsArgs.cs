...
namespace Pulumi.AzureNative.Logic.V20160601.Inputs
{
    ...
    public sealed class X12EnvelopeSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Logic.V20160601.X12DateFormat> GroupHeaderDateFormat { get; set; } = null!;

        /// <summary>
        /// The group header time format.
        /// </summary>
        [Input("groupHeaderTimeFormat", required: true)]
        public Input<Pulumi.AzureNative.Logic.V20160601.X12TimeFormat> GroupHeaderTimeFormat { get; set; } = null!;
        ...
        public Input<Pulumi.AzureNative.Logic.V20160601.UsageIndicator> UsageIndicator { get; set; } = null!;
