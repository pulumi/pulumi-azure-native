...
namespace Pulumi.AzureNative.Logic
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct OpenAuthenticationProviderType : IEquatable<OpenAuthenticationProviderType>
    {
        private readonly string _value;

        private OpenAuthenticationProviderType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static OpenAuthenticationProviderType AAD { get; } = new OpenAuthenticationProviderType("AAD");

        public static bool operator ==(OpenAuthenticationProviderType left, OpenAuthenticationProviderType right) => left.Equals(right);
        public static bool operator !=(OpenAuthenticationProviderType left, OpenAuthenticationProviderType right) => !left.Equals(right);

        public static explicit operator string(OpenAuthenticationProviderType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is OpenAuthenticationProviderType other && Equals(other);
        public bool Equals(OpenAuthenticationProviderType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
