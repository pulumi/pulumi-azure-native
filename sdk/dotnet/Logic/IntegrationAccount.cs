...
namespace Pulumi.AzureRM.Logic
{
    ...
    public partial class IntegrationAccount : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.IntegrationAccountPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public IntegrationAccount(string name, IntegrationAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic:IntegrationAccount", name, args ?? new IntegrationAccountArgs(), MakeResourceOptions(options, ""))
        {
        }
