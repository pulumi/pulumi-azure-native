...
namespace Pulumi.AzureNextGen.Logic
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:logic:IntegrationAccountCertificate")]
    public partial class IntegrationAccountCertificate : Pulumi.CustomResource
    {
        ...
        public IntegrationAccountCertificate(string name, IntegrationAccountCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic:IntegrationAccountCertificate", name, args ?? new IntegrationAccountCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:logic:IntegrationAccountCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
