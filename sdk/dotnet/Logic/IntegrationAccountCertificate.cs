...
namespace Pulumi.AzureNative.Logic
{
    ...
    public partial class IntegrationAccountCertificate : global::Pulumi.CustomResource
    {
        ...
        public IntegrationAccountCertificate(string name, IntegrationAccountCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:logic:IntegrationAccountCertificate", name, args ?? new IntegrationAccountCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationAccountCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:logic:IntegrationAccountCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_logic_v20150801preview:logic:IntegrationAccountCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native_logic_v20160601:logic:IntegrationAccountCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native_logic_v20180701preview:logic:IntegrationAccountCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native_logic_v20190501:logic:IntegrationAccountCertificate" },
                },
            };
