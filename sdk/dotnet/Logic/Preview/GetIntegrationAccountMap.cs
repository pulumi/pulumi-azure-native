...
namespace Pulumi.AzureRM.Logic.Preview
{
    public static class GetIntegrationAccountMap
    {
        public static Task<GetIntegrationAccountMapResult> InvokeAsync(GetIntegrationAccountMapArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIntegrationAccountMapResult>("azurerm:logic/preview:getIntegrationAccountMap", args ?? new GetIntegrationAccountMapArgs(), options.WithVersion());
    }
