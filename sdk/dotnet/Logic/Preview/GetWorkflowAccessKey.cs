...
namespace Pulumi.AzureRM.Logic.Preview
{
    public static class GetWorkflowAccessKey
    {
        public static Task<GetWorkflowAccessKeyResult> InvokeAsync(GetWorkflowAccessKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkflowAccessKeyResult>("azurerm:logic/preview:getWorkflowAccessKey", args ?? new GetWorkflowAccessKeyArgs(), options.WithVersion());
    }
