...
namespace Pulumi.AzureRM.Logic.Preview
{
    ...
    public partial class IntegrationServiceEnvironment : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.IntegrationServiceEnvironmentPropertiesResponseResult> Properties { get; private set; } = null!;

        /// <summary>
        /// The sku.
        /// </summary>
        [Output("sku")]
        public Output<Outputs.IntegrationServiceEnvironmentSkuResponseResult?> Sku { get; private set; } = null!;
        ...
        public IntegrationServiceEnvironment(string name, IntegrationServiceEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:logic/preview:IntegrationServiceEnvironment", name, args ?? new IntegrationServiceEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationServiceEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:logic/preview:IntegrationServiceEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:logic/latest:IntegrationServiceEnvironment"},
                    new Pulumi.Alias { Type = "azurerm:logic/v20190501:IntegrationServiceEnvironment"},
                },
            };
