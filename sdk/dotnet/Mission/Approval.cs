...
namespace Pulumi.AzureNative.Mission
{
    ...
    public partial class Approval : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("parent1")]
        public Output<string?> Parent1 { get; private set; } = null!;

        /// <summary>
        /// Parameter for optimizing query results
        /// </summary>
        [Output("parent2")]
        public Output<string?> Parent2 { get; private set; } = null!;
    ...
    public sealed class ApprovalArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("parent1")]
        public Input<string>? Parent1 { get; set; }

        /// <summary>
        /// Parameter for optimizing query results
        /// </summary>
        [Input("parent2")]
        public Input<string>? Parent2 { get; set; }
