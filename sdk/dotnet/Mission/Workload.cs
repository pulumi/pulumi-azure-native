...
namespace Pulumi.AzureNative.Mission
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mission:Workload")]
    public partial class Workload : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("resourceGroupCollection")]
        public Output<ImmutableArray<string>> ResourceGroupCollection { get; private set; } = null!;
        ...
        public Workload(string name, WorkloadArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mission:Workload", name, args ?? new WorkloadArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workload(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mission:Workload", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:mission/v20240601preview:Workload" },
                    new global::Pulumi.Alias { Type = "azure-native:mission/v20241201preview:Workload" },
                    new global::Pulumi.Alias { Type = "azure-native:mission/v20250501preview:Workload" },
                    new global::Pulumi.Alias { Type = "azure-native:mission/v20251101preview:Workload" },
                    new global::Pulumi.Alias { Type = "azure-native:mission/v20260301preview:Workload" },
                },
            };
    ...
    public sealed class WorkloadArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("resourceGroupCollection")]
        private InputList<string>? _resourceGroupCollection;

        /// <summary>
        /// List of resource group ids.
        /// </summary>
        public InputList<string> ResourceGroupCollection
        {
            get => _resourceGroupCollection ?? (_resourceGroupCollection = new InputList<string>());
            set => _resourceGroupCollection = value;
        }
