...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere
{
    ...
    public partial class MachineExtension : global::Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20201001preview:connectedvmwarevsphere:MachineExtension" },
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20220110preview:connectedvmwarevsphere:MachineExtension" },
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20220715preview:connectedvmwarevsphere:MachineExtension" },
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:MachineExtension" },
                },
            };
