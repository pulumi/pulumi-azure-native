...
{
    [Obsolete(@"azure-native:connectedvmwarevsphere/v20220110preview:InventoryItem is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:InventoryItem to guarantee forwards compatibility.")]
    public static class GetInventoryItem
    {
        ...
        public static Task<GetInventoryItemResult> InvokeAsync(GetInventoryItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInventoryItemResult>("azure-native:connectedvmwarevsphere/v20220110preview:getInventoryItem", args ?? new GetInventoryItemArgs(), options.WithDefaults());

        /// <summary>
        /// Implements InventoryItem GET method.
        /// </summary>
        public static Output<GetInventoryItemResult> Invoke(GetInventoryItemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInventoryItemResult>("azure-native:connectedvmwarevsphere/v20220110preview:getInventoryItem", args ?? new GetInventoryItemInvokeArgs(), options.WithDefaults());
    }
