...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220110Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:connectedvmwarevsphere/v20220110preview:VirtualNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:VirtualNetwork to guarantee forwards compatibility.")]
    ...
    public partial class VirtualNetwork : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220110preview:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220110preview:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
