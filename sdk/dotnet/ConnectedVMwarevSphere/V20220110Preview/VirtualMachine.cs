...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220110Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:connectedvmwarevsphere/v20220110preview:VirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachine to guarantee forwards compatibility.")]
    ...
    public sealed class VirtualMachineArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("firmwareType")]
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20220110Preview.FirmwareType>? FirmwareType { get; set; }
