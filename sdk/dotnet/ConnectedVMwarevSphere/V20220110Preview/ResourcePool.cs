...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220110Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool")]
    public partial class ResourcePool : global::Pulumi.CustomResource
    {
        ...
        public ResourcePool(string name, ResourcePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool", name, args ?? new ResourcePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourcePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool", name, null, MakeResourceOptions(options, id))
        {
        }
