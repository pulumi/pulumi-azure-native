...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220110Preview
{
    ...
    public partial class InventoryItem : Pulumi.CustomResource
    {
        ...
        public InventoryItem(string name, InventoryItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220110preview:InventoryItem", name, args ?? new InventoryItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InventoryItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220110preview:InventoryItem", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InventoryItemArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20220110Preview.InventoryType> InventoryType { get; set; } = null!;
