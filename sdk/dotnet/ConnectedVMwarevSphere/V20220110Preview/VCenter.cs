...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220110Preview
{
    ...
    /// Defines the vCenter.
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20220110preview:VCenter")]
    public partial class VCenter : global::Pulumi.CustomResource
    {
        ...
        public VCenter(string name, VCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220110preview:VCenter", name, args ?? new VCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220110preview:VCenter", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:connectedvmwarevsphere/v20230301preview:VCenter" },
                    new global::Pulumi.Alias { Type = "azure-native:connectedvmwarevsphere/v20231001:VCenter" },
                    new global::Pulumi.Alias { Type = "azure-native:connectedvmwarevsphere/v20231201:VCenter" },
                },
            };
