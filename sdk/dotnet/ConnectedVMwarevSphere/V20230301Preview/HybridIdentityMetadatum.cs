...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20230301preview:HybridIdentityMetadatum")]
    public partial class HybridIdentityMetadatum : global::Pulumi.CustomResource
    {
        ...
        public HybridIdentityMetadatum(string name, HybridIdentityMetadatumArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:HybridIdentityMetadatum", name, args ?? new HybridIdentityMetadatumArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridIdentityMetadatum(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:HybridIdentityMetadatum", name, null, MakeResourceOptions(options, id))
        {
        }
