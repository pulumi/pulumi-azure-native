...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20230301Preview
{
    public static class GetVMInstanceGuestAgent
    {
        ...
        public static Task<GetVMInstanceGuestAgentResult> InvokeAsync(GetVMInstanceGuestAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVMInstanceGuestAgentResult>("azure-native:connectedvmwarevsphere/v20230301preview:getVMInstanceGuestAgent", args ?? new GetVMInstanceGuestAgentArgs(), options.WithDefaults());
        ...
        public static Output<GetVMInstanceGuestAgentResult> Invoke(GetVMInstanceGuestAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVMInstanceGuestAgentResult>("azure-native:connectedvmwarevsphere/v20230301preview:getVMInstanceGuestAgent", args ?? new GetVMInstanceGuestAgentInvokeArgs(), options.WithDefaults());
    }
