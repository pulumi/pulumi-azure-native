...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20230301Preview
{
    public static class GetInventoryItem
    {
        ...
        public static Task<GetInventoryItemResult> InvokeAsync(GetInventoryItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInventoryItemResult>("azure-native:connectedvmwarevsphere/v20230301preview:getInventoryItem", args ?? new GetInventoryItemArgs(), options.WithDefaults());

        /// <summary>
        /// Implements InventoryItem GET method.
        /// </summary>
        public static Output<GetInventoryItemResult> Invoke(GetInventoryItemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInventoryItemResult>("azure-native:connectedvmwarevsphere/v20230301preview:getInventoryItem", args ?? new GetInventoryItemInvokeArgs(), options.WithDefaults());
