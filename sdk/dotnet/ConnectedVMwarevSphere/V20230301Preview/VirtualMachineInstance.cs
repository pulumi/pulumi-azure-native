...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachineInstance")]
    public partial class VirtualMachineInstance : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineInstance(string name, VirtualMachineInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachineInstance", name, args ?? new VirtualMachineInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachineInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:connectedvmwarevsphere/v20231201:VirtualMachineInstance" },
                },
            };
