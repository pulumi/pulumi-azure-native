...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20230301preview:InventoryItem")]
    public partial class InventoryItem : global::Pulumi.CustomResource
    {
        ...
        public InventoryItem(string name, InventoryItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:InventoryItem", name, args ?? new InventoryItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InventoryItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:InventoryItem", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InventoryItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20230301Preview.InventoryType> InventoryType { get; set; } = null!;
