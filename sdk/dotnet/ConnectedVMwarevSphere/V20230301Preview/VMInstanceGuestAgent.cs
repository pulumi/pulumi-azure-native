...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20230301preview:VMInstanceGuestAgent")]
    public partial class VMInstanceGuestAgent : global::Pulumi.CustomResource
    {
        ...
        public VMInstanceGuestAgent(string name, VMInstanceGuestAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:VMInstanceGuestAgent", name, args ?? new VMInstanceGuestAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VMInstanceGuestAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:VMInstanceGuestAgent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VMInstanceGuestAgentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20230301Preview.ProvisioningAction>? ProvisioningAction { get; set; }
