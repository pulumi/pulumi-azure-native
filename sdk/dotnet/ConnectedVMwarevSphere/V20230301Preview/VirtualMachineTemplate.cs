...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachineTemplate")]
    public partial class VirtualMachineTemplate : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineTemplate(string name, VirtualMachineTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachineTemplate", name, args ?? new VirtualMachineTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachineTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
