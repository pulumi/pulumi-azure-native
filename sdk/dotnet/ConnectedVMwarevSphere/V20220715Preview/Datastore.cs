...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview
{
    ...
    /// {
    ///     var datastore = new AzureNative.ConnectedVMwarevSphere.V20220715Preview.Datastore("datastore", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:connectedvmwarevsphere/v20220715preview:Datastore HRDatastore /subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/testrg/providers/Microsoft.ConnectedVMwarevSphere/Datastores/HRDatastore 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20220715preview:Datastore")]
    public partial class Datastore : global::Pulumi.CustomResource
    {
        ...
        public Datastore(string name, DatastoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:Datastore", name, args ?? new DatastoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Datastore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:Datastore", name, null, MakeResourceOptions(options, id))
        {
        }
