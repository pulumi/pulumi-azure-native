...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview
{
    ...
    /// {
    ///     var guestAgent = new AzureNative.ConnectedVMwarevSphere.V20220715Preview.GuestAgent("guestAgent", new()
    ///     {
    ///         Credentials = new AzureNative.ConnectedVMwarevSphere.V20220715Preview.Inputs.GuestCredentialArgs
    ///         {
    ///             Password = "&lt;password&gt;",
    ///             Username = "tempuser",
    ///         },
    ///         HttpProxyConfig = new AzureNative.ConnectedVMwarevSphere.V20220715Preview.Inputs.HttpProxyConfigurationArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent")]
    public partial class GuestAgent : global::Pulumi.CustomResource
    {
        ...
        public GuestAgent(string name, GuestAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent", name, args ?? new GuestAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent", name, null, MakeResourceOptions(options, id))
        {
        }
