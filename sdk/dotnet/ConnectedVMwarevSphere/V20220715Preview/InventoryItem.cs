...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview
{
    ...
    /// {
    ///     var inventoryItem = new AzureNative.ConnectedVMwarevSphere.V20220715Preview.InventoryItem("inventoryItem", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20220715preview:InventoryItem")]
    public partial class InventoryItem : global::Pulumi.CustomResource
    {
        ...
        public InventoryItem(string name, InventoryItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:InventoryItem", name, args ?? new InventoryItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InventoryItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:InventoryItem", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InventoryItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview.InventoryType> InventoryType { get; set; } = null!;
