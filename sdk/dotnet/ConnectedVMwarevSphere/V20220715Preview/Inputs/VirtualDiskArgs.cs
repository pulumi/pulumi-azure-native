...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview.Inputs
{
    ...
    public sealed class VirtualDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("diskMode")]
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview.DiskMode>? DiskMode { get; set; }
        ...
        /// </summary>
        [Input("diskType")]
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview.DiskType>? DiskType { get; set; }
