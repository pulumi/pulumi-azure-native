...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview
{
    ...
    public partial class VCenter : global::Pulumi.CustomResource
    {
        ...
        public VCenter(string name, VCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:VCenter", name, args ?? new VCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:VCenter", name, null, MakeResourceOptions(options, id))
        {
        }
