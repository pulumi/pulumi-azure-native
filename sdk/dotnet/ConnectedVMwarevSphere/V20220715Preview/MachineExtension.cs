...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview
{
    ...
    /// {
    ///     var machineExtension = new AzureNative.ConnectedVMwarevSphere.V20220715Preview.MachineExtension("machineExtension", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20220715preview:MachineExtension")]
    public partial class MachineExtension : global::Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
