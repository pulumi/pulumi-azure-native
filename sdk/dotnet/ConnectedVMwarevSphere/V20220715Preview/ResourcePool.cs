...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20220715Preview
{
    ...
    /// {
    ///     var resourcePool = new AzureNative.ConnectedVMwarevSphere.V20220715Preview.ResourcePool("resourcePool", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool HRPool /subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/testrg/providers/Microsoft.ConnectedVMwarevSphere/ResourcePools/HRPool 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool")]
    public partial class ResourcePool : global::Pulumi.CustomResource
    {
        ...
        public ResourcePool(string name, ResourcePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool", name, args ?? new ResourcePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourcePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool", name, null, MakeResourceOptions(options, id))
        {
        }
