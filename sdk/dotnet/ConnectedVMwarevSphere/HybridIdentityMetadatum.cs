...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere
{
    ...
    public partial class HybridIdentityMetadatum : global::Pulumi.CustomResource
    {
        ...
        public HybridIdentityMetadatum(string name, HybridIdentityMetadatumArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere:HybridIdentityMetadatum", name, args ?? new HybridIdentityMetadatumArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridIdentityMetadatum(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere:HybridIdentityMetadatum", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20201001preview:connectedvmwarevsphere:HybridIdentityMetadatum" },
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20220110preview:connectedvmwarevsphere:HybridIdentityMetadatum" },
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20220715preview:connectedvmwarevsphere:HybridIdentityMetadatum" },
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:HybridIdentityMetadatum" },
                },
            };
