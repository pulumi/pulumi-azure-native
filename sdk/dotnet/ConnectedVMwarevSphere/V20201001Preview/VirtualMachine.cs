...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20201001Preview
{
    ...
    /// {
    ///     var virtualMachine = new AzureNative.ConnectedVMwarevSphere.V20201001Preview.VirtualMachine("virtualMachine", new()
    ///     {
    ...
    ///             Type = "customLocation",
    ///         },
    ///         HardwareProfile = new AzureNative.ConnectedVMwarevSphere.V20201001Preview.Inputs.HardwareProfileArgs
    ///         {
    ///             MemorySizeMB = 4196,
    ///             NumCPUs = 4,
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachine")]
    public partial class VirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualMachineArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("firmwareType")]
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20201001Preview.FirmwareType>? FirmwareType { get; set; }
