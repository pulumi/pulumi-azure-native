...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20201001Preview
{
    ...
    /// {
    ///     var resourcePool = new AzureNative.ConnectedVMwarevSphere.V20201001Preview.ResourcePool("resourcePool", new()
    ///     {
    ...
    public partial class ResourcePool : global::Pulumi.CustomResource
    {
        ...
        public ResourcePool(string name, ResourcePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:ResourcePool", name, args ?? new ResourcePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourcePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:ResourcePool", name, null, MakeResourceOptions(options, id))
        {
        }
