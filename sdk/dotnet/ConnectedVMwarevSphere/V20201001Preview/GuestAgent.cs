...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20201001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent to guarantee forwards compatibility.")]
    ...
    public partial class GuestAgent : global::Pulumi.CustomResource
    {
        ...
        public GuestAgent(string name, GuestAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent", name, args ?? new GuestAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent", name, null, MakeResourceOptions(options, id))
        {
        }
