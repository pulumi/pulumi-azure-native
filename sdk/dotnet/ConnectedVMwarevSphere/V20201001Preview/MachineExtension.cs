...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20201001Preview
{
    ...
    /// {
    ///     var machineExtension = new AzureNative.ConnectedVMwarevSphere.V20201001Preview.MachineExtension("machineExtension", new()
    ///     {
    ...
    public partial class MachineExtension : global::Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
