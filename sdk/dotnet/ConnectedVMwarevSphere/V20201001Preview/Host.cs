...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20201001Preview
{
    ...
    /// Define the host.
    /// </summary>
    [Obsolete(@"azure-native:connectedvmwarevsphere/v20201001preview:Host is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Host to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20201001preview:Host")]
    public partial class Host : global::Pulumi.CustomResource
    {
        ...
        public Host(string name, HostArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:Host", name, args ?? new HostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Host(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:Host", name, null, MakeResourceOptions(options, id))
        {
        }
