...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20201001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachineTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachineTemplate to guarantee forwards compatibility.")]
    ...
    public partial class VirtualMachineTemplate : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineTemplate(string name, VirtualMachineTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachineTemplate", name, args ?? new VirtualMachineTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachineTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:connectedvmwarevsphere:VirtualMachineTemplate"},
