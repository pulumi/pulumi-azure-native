...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20201001Preview
{
    ...
    /// {
    ///     var vCenter = new AzureNative.ConnectedVMwarevSphere.V20201001Preview.VCenter("vCenter", new()
    ///     {
    ///         Credentials = new AzureNative.ConnectedVMwarevSphere.V20201001Preview.Inputs.VICredentialArgs
    ///         {
    ///             Password = "&lt;password&gt;",
    ///             Username = "tempuser",
    ///         },
    ...
    public partial class VCenter : global::Pulumi.CustomResource
    {
        ...
        public VCenter(string name, VCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:VCenter", name, args ?? new VCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20201001preview:VCenter", name, null, MakeResourceOptions(options, id))
        {
        }
