...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20231001
{
    public static class GetDatastore
    {
        ...
        public static Task<GetDatastoreResult> InvokeAsync(GetDatastoreArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDatastoreResult>("azure-native:connectedvmwarevsphere/v20231001:getDatastore", args ?? new GetDatastoreArgs(), options.WithDefaults());
