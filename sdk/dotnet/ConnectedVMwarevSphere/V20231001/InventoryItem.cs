...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20231001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20231001:InventoryItem")]
    public partial class InventoryItem : global::Pulumi.CustomResource
    {
        ...
        public InventoryItem(string name, InventoryItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20231001:InventoryItem", name, args ?? new InventoryItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InventoryItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20231001:InventoryItem", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InventoryItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20231001.InventoryType> InventoryType { get; set; } = null!;
