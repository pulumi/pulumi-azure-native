...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20231001
{
    ...
    /// Defines the vCenter.
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20231001:VCenter")]
    public partial class VCenter : global::Pulumi.CustomResource
    {
        ...
        public VCenter(string name, VCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20231001:VCenter", name, args ?? new VCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20231001:VCenter", name, null, MakeResourceOptions(options, id))
        {
        }
