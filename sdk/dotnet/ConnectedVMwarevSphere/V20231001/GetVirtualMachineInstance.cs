...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20231001
{
    public static class GetVirtualMachineInstance
    {
        ...
        public static Task<GetVirtualMachineInstanceResult> InvokeAsync(GetVirtualMachineInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualMachineInstanceResult>("azure-native:connectedvmwarevsphere/v20231001:getVirtualMachineInstance", args ?? new GetVirtualMachineInstanceArgs(), options.WithDefaults());
