...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20231001
{
    ...
    /// Define the host.
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20231001:Host")]
    public partial class Host : global::Pulumi.CustomResource
    {
        ...
        public Host(string name, HostArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20231001:Host", name, args ?? new HostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Host(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20231001:Host", name, null, MakeResourceOptions(options, id))
        {
        }
