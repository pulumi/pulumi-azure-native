...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20231201
{
    public static class GetVCenter
    {
        ...
        public static Task<GetVCenterResult> InvokeAsync(GetVCenterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVCenterResult>("azure-native:connectedvmwarevsphere/v20231201:getVCenter", args ?? new GetVCenterArgs(), options.WithDefaults());

        /// <summary>
        /// Implements vCenter GET method.
        /// </summary>
        public static Output<GetVCenterResult> Invoke(GetVCenterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVCenterResult>("azure-native:connectedvmwarevsphere/v20231201:getVCenter", args ?? new GetVCenterInvokeArgs(), options.WithDefaults());
    }
