...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20231201
{
    public static class GetResourcePool
    {
        ...
        public static Task<GetResourcePoolResult> InvokeAsync(GetResourcePoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResourcePoolResult>("azure-native:connectedvmwarevsphere/v20231201:getResourcePool", args ?? new GetResourcePoolArgs(), options.WithDefaults());

        /// <summary>
        /// Implements resourcePool GET method.
        /// </summary>
        public static Output<GetResourcePoolResult> Invoke(GetResourcePoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetResourcePoolResult>("azure-native:connectedvmwarevsphere/v20231201:getResourcePool", args ?? new GetResourcePoolInvokeArgs(), options.WithDefaults());
    }
