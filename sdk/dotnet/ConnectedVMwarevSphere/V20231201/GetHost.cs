...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20231201
{
    public static class GetHost
    {
        ...
        public static Task<GetHostResult> InvokeAsync(GetHostArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHostResult>("azure-native:connectedvmwarevsphere/v20231201:getHost", args ?? new GetHostArgs(), options.WithDefaults());
