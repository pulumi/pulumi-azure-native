...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:connectedvmwarevsphere/v20231201:VMInstanceGuestAgent")]
    public partial class VMInstanceGuestAgent : global::Pulumi.CustomResource
    {
        ...
        public VMInstanceGuestAgent(string name, VMInstanceGuestAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20231201:VMInstanceGuestAgent", name, args ?? new VMInstanceGuestAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VMInstanceGuestAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere/v20231201:VMInstanceGuestAgent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VMInstanceGuestAgentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ConnectedVMwarevSphere.V20231201.ProvisioningAction>? ProvisioningAction { get; set; }
