...
namespace Pulumi.AzureNative.ConnectedVMwarevSphere
{
    ...
    public partial class VMInstanceGuestAgent : global::Pulumi.CustomResource
    {
        ...
        public VMInstanceGuestAgent(string name, VMInstanceGuestAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere:VMInstanceGuestAgent", name, args ?? new VMInstanceGuestAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VMInstanceGuestAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:connectedvmwarevsphere:VMInstanceGuestAgent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:VMInstanceGuestAgent" },
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20231001:connectedvmwarevsphere:VMInstanceGuestAgent" },
                    new global::Pulumi.Alias { Type = "azure-native_connectedvmwarevsphere_v20231201:connectedvmwarevsphere:VMInstanceGuestAgent" },
                },
            };
