...
namespace Pulumi.AzureNative.IntegrationSpaces
{
    ...
    public partial class Space : global::Pulumi.CustomResource
    {
        ...
        public Space(string name, SpaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:integrationspaces:Space", name, args ?? new SpaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Space(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:integrationspaces:Space", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:integrationspaces/v20231114preview:Space" },
                    new global::Pulumi.Alias { Type = "azure-native_integrationspaces_v20231114preview:integrationspaces:Space" },
                },
            };
