...
namespace Pulumi.AzureNative.IntegrationSpaces
{
    ...
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:integrationspaces:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:integrationspaces:Application", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_integrationspaces_v20231114preview:integrationspaces:Application" },
                },
            };
    ...
    public sealed class ApplicationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// The tracking data stores.
        /// </summary>
        public InputMap<Inputs.TrackingDataStoreArgs> TrackingDataStores
        {
            get => _trackingDataStores ?? (_trackingDataStores = new InputMap<Inputs.TrackingDataStoreArgs>());
            set => _trackingDataStores = value;
        }
