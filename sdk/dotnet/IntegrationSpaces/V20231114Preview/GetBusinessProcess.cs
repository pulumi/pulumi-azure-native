...
namespace Pulumi.AzureNative.IntegrationSpaces.V20231114Preview
{
    public static class GetBusinessProcess
    {
        ...
        public static Task<GetBusinessProcessResult> InvokeAsync(GetBusinessProcessArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBusinessProcessResult>("azure-native:integrationspaces/v20231114preview:getBusinessProcess", args ?? new GetBusinessProcessArgs(), options.WithDefaults());
