...
namespace Pulumi.AzureNative.IntegrationSpaces.V20231114Preview
{
    public static class GetSpace
    {
        ...
        public static Task<GetSpaceResult> InvokeAsync(GetSpaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSpaceResult>("azure-native:integrationspaces/v20231114preview:getSpace", args ?? new GetSpaceArgs(), options.WithDefaults());
