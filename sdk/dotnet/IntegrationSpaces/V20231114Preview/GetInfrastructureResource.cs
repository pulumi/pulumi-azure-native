...
namespace Pulumi.AzureNative.IntegrationSpaces.V20231114Preview
{
    public static class GetInfrastructureResource
    {
        ...
        public static Task<GetInfrastructureResourceResult> InvokeAsync(GetInfrastructureResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInfrastructureResourceResult>("azure-native:integrationspaces/v20231114preview:getInfrastructureResource", args ?? new GetInfrastructureResourceArgs(), options.WithDefaults());
