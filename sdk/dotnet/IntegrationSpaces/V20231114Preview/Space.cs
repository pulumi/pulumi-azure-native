...
namespace Pulumi.AzureNative.IntegrationSpaces.V20231114Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:integrationspaces/v20231114preview:Space")]
    public partial class Space : global::Pulumi.CustomResource
    {
        ...
        public Space(string name, SpaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:integrationspaces/v20231114preview:Space", name, args ?? new SpaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Space(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:integrationspaces/v20231114preview:Space", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:integrationspaces:Space" },
                },
            };
