...
namespace Pulumi.AzureNative.SerialConsole.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:serialconsole:SerialPort'.")]
    [AzureNativeResourceType("azure-native:serialconsole/latest:SerialPort")]
    public partial class SerialPort : Pulumi.CustomResource
    {
        ...
        public SerialPort(string name, SerialPortArgs args, CustomResourceOptions? options = null)
            : base("azure-native:serialconsole/latest:SerialPort", name, args ?? new SerialPortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SerialPort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:serialconsole/latest:SerialPort", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SerialPortArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.SerialConsole.Latest.SerialPortState>? State { get; set; }
