...
namespace Pulumi.AzureNative.SerialConsole.V20180501
{
    ...
    /// {
    ///     var serialPort = new AzureNative.SerialConsole.V20180501.SerialPort("serialPort", new()
    ///     {
    ///         ParentResource = "myVM",
    ...
    ///         SerialPort = "0",
    ///         State = AzureNative.SerialConsole.V20180501.SerialPortState.Enabled,
    ///     });
    /// 
    /// });
    /// 
    ...
    public partial class SerialPort : global::Pulumi.CustomResource
    {
        ...
        public SerialPort(string name, SerialPortArgs args, CustomResourceOptions? options = null)
            : base("azure-native:serialconsole/v20180501:SerialPort", name, args ?? new SerialPortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SerialPort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:serialconsole/v20180501:SerialPort", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SerialPortArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.SerialConsole.V20180501.SerialPortState>? State { get; set; }
