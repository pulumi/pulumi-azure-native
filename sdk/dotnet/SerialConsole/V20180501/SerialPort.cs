...
namespace Pulumi.AzureNextGen.SerialConsole.V20180501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:serialconsole/v20180501:SerialPort")]
    public partial class SerialPort : Pulumi.CustomResource
    {
        ...
        public SerialPort(string name, SerialPortArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:serialconsole/v20180501:SerialPort", name, args ?? new SerialPortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SerialPort(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:serialconsole/v20180501:SerialPort", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SerialPortArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNextGen.SerialConsole.V20180501.SerialPortState>? State { get; set; }
