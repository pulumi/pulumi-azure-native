...
namespace Pulumi.AzureNative.ManagedIdentity.V20230731Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managedidentity/v20230731preview:FederatedIdentityCredential")]
    public partial class FederatedIdentityCredential : global::Pulumi.CustomResource
    {
        ...
        public FederatedIdentityCredential(string name, FederatedIdentityCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20230731preview:FederatedIdentityCredential", name, args ?? new FederatedIdentityCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederatedIdentityCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20230731preview:FederatedIdentityCredential", name, null, MakeResourceOptions(options, id))
        {
        }
