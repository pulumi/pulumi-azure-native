...
namespace Pulumi.AzureNative.ManagedIdentity.V20230731Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managedidentity/v20230731preview:UserAssignedIdentity")]
    public partial class UserAssignedIdentity : global::Pulumi.CustomResource
    {
        ...
        public UserAssignedIdentity(string name, UserAssignedIdentityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20230731preview:UserAssignedIdentity", name, args ?? new UserAssignedIdentityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserAssignedIdentity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20230731preview:UserAssignedIdentity", name, null, MakeResourceOptions(options, id))
        {
        }
