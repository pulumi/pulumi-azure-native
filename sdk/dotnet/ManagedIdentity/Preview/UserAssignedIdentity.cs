...
namespace Pulumi.AzureRM.ManagedIdentity.Preview
{
    ...
    public partial class UserAssignedIdentity : Pulumi.CustomResource
    {
        ...
        public UserAssignedIdentity(string name, UserAssignedIdentityArgs args, CustomResourceOptions? options = null)
            : base("azurerm:managedidentity/preview:UserAssignedIdentity", name, args ?? new UserAssignedIdentityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserAssignedIdentity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:managedidentity/preview:UserAssignedIdentity", name, null, MakeResourceOptions(options, id))
        {
        }
