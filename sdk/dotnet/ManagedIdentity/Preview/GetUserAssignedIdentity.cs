...
namespace Pulumi.AzureRM.ManagedIdentity.Preview
{
    public static class GetUserAssignedIdentity
    {
        public static Task<GetUserAssignedIdentityResult> InvokeAsync(GetUserAssignedIdentityArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetUserAssignedIdentityResult>("azurerm:managedidentity/preview:getUserAssignedIdentity", args ?? new GetUserAssignedIdentityArgs(), options.WithVersion());
    }
