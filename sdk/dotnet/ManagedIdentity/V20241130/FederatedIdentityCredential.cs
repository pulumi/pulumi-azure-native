...
namespace Pulumi.AzureNative.ManagedIdentity.V20241130
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managedidentity/v20241130:FederatedIdentityCredential")]
    public partial class FederatedIdentityCredential : global::Pulumi.CustomResource
    {
        ...
        public FederatedIdentityCredential(string name, FederatedIdentityCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20241130:FederatedIdentityCredential", name, args ?? new FederatedIdentityCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederatedIdentityCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20241130:FederatedIdentityCredential", name, null, MakeResourceOptions(options, id))
        {
        }
