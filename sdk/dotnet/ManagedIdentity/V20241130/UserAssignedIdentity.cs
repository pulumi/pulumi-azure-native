...
namespace Pulumi.AzureNative.ManagedIdentity.V20241130
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managedidentity/v20241130:UserAssignedIdentity")]
    public partial class UserAssignedIdentity : global::Pulumi.CustomResource
    {
        ...
        public UserAssignedIdentity(string name, UserAssignedIdentityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20241130:UserAssignedIdentity", name, args ?? new UserAssignedIdentityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserAssignedIdentity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20241130:UserAssignedIdentity", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserAssignedIdentityArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedIdentity.V20241130.IsolationScope>? IsolationScope { get; set; }
