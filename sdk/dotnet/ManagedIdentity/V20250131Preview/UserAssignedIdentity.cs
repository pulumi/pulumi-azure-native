...
namespace Pulumi.AzureNative.ManagedIdentity.V20250131Preview
{
    /// <summary>
    /// Describes an identity resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:managedidentity/v20250131preview:UserAssignedIdentity")]
    public partial class UserAssignedIdentity : global::Pulumi.CustomResource
    {
        ...
        public UserAssignedIdentity(string name, UserAssignedIdentityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20250131preview:UserAssignedIdentity", name, args ?? new UserAssignedIdentityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserAssignedIdentity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20250131preview:UserAssignedIdentity", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserAssignedIdentityArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedIdentity.V20250131Preview.IsolationScope>? IsolationScope { get; set; }
