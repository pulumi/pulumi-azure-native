...
namespace Pulumi.AzureNative.ManagedIdentity.V20250131Preview
{
    public static class GetFederatedIdentityCredential
    {
        ...
        public static Task<GetFederatedIdentityCredentialResult> InvokeAsync(GetFederatedIdentityCredentialArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFederatedIdentityCredentialResult>("azure-native:managedidentity/v20250131preview:getFederatedIdentityCredential", args ?? new GetFederatedIdentityCredentialArgs(), options.WithDefaults());
        ...
        public static Output<GetFederatedIdentityCredentialResult> Invoke(GetFederatedIdentityCredentialInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFederatedIdentityCredentialResult>("azure-native:managedidentity/v20250131preview:getFederatedIdentityCredential", args ?? new GetFederatedIdentityCredentialInvokeArgs(), options.WithDefaults());
    ...
    public sealed class GetFederatedIdentityCredentialResult
    {
        ...
        /// </summary>
        public readonly Outputs.FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpression? ClaimsMatchingExpression;
        /// <summary>
        ...
        private GetFederatedIdentityCredentialResult(
            ...
            Outputs.FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpression? claimsMatchingExpression,
