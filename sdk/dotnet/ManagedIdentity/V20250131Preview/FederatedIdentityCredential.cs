...
namespace Pulumi.AzureNative.ManagedIdentity.V20250131Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managedidentity/v20250131preview:FederatedIdentityCredential")]
    public partial class FederatedIdentityCredential : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpression?> ClaimsMatchingExpression { get; private set; } = null!;
        ...
        public FederatedIdentityCredential(string name, FederatedIdentityCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20250131preview:FederatedIdentityCredential", name, args ?? new FederatedIdentityCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederatedIdentityCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20250131preview:FederatedIdentityCredential", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FederatedIdentityCredentialArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgs>? ClaimsMatchingExpression { get; set; }
