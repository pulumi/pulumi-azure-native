...
namespace Pulumi.AzureNative.ManagedIdentity.V20220131Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:managedidentity/v20220131preview:FederatedIdentityCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:managedidentity/v20230131:FederatedIdentityCredential to guarantee forwards compatibility.")]
    ...
    public partial class FederatedIdentityCredential : global::Pulumi.CustomResource
    {
        ...
        public FederatedIdentityCredential(string name, FederatedIdentityCredentialArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20220131preview:FederatedIdentityCredential", name, args ?? new FederatedIdentityCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederatedIdentityCredential(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20220131preview:FederatedIdentityCredential", name, null, MakeResourceOptions(options, id))
        {
        }
