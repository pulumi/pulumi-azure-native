...
namespace Pulumi.AzureNative.ManagedIdentity.V20220131Preview
{
    ...
    [AzureNativeResourceType("azure-native:managedidentity/v20220131preview:UserAssignedIdentity")]
    public partial class UserAssignedIdentity : global::Pulumi.CustomResource
    {
        ...
        public UserAssignedIdentity(string name, UserAssignedIdentityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20220131preview:UserAssignedIdentity", name, args ?? new UserAssignedIdentityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserAssignedIdentity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20220131preview:UserAssignedIdentity", name, null, MakeResourceOptions(options, id))
        {
        }
