...
namespace Pulumi.AzureNative.ManagedIdentity.V20181130
{
    ...
    /// {
    ///     var userAssignedIdentity = new AzureNative.ManagedIdentity.V20181130.UserAssignedIdentity("userAssignedIdentity", new()
    ///     {
    ///         Location = "eastus",
    ...
    public partial class UserAssignedIdentity : global::Pulumi.CustomResource
    {
        ...
        public UserAssignedIdentity(string name, UserAssignedIdentityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20181130:UserAssignedIdentity", name, args ?? new UserAssignedIdentityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserAssignedIdentity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managedidentity/v20181130:UserAssignedIdentity", name, null, MakeResourceOptions(options, id))
        {
        }
