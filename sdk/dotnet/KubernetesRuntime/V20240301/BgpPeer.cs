...
namespace Pulumi.AzureNative.KubernetesRuntime.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesruntime/v20240301:BgpPeer")]
    public partial class BgpPeer : global::Pulumi.CustomResource
    {
        ...
        public BgpPeer(string name, BgpPeerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20240301:BgpPeer", name, args ?? new BgpPeerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BgpPeer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20240301:BgpPeer", name, null, MakeResourceOptions(options, id))
        {
        }
