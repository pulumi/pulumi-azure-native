...
namespace Pulumi.AzureNative.KubernetesRuntime.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesruntime/v20240301:StorageClass")]
    public partial class StorageClass : global::Pulumi.CustomResource
    {
        ...
        public StorageClass(string name, StorageClassArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20240301:StorageClass", name, args ?? new StorageClassArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageClass(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20240301:StorageClass", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("accessModes")]
        private InputList<Union<string, Pulumi.AzureNative.KubernetesRuntime.V20240301.AccessMode>>? _accessModes;

        /// <summary>
        /// The access mode: [ReadWriteOnce, ReadWriteMany] or [ReadWriteOnce]
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.KubernetesRuntime.V20240301.AccessMode>> AccessModes
        {
            get => _accessModes ?? (_accessModes = new InputList<Union<string, Pulumi.AzureNative.KubernetesRuntime.V20240301.AccessMode>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.V20240301.VolumeExpansion>? AllowVolumeExpansion { get; set; }

        /// <summary>
        /// Allow single data node failure
        /// </summary>
        [Input("dataResilience")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.V20240301.DataResilienceTier>? DataResilience { get; set; }

        /// <summary>
        /// Failover speed: NA, Slow, Fast
        /// </summary>
        [Input("failoverSpeed")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.V20240301.FailoverTier>? FailoverSpeed { get; set; }
        ...
        /// </summary>
        [Input("performance")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.V20240301.PerformanceTier>? Performance { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.V20240301.VolumeBindingMode>? VolumeBindingMode { get; set; }
