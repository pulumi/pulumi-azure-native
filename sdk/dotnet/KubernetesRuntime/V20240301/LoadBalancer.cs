...
namespace Pulumi.AzureNative.KubernetesRuntime.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesruntime/v20240301:LoadBalancer")]
    public partial class LoadBalancer : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20240301:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20240301:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LoadBalancerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.V20240301.AdvertiseMode> AdvertiseMode { get; set; } = null!;
