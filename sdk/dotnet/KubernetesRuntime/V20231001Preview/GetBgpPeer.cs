...
namespace Pulumi.AzureNative.KubernetesRuntime.V20231001Preview
{
    public static class GetBgpPeer
    {
        ...
        public static Task<GetBgpPeerResult> InvokeAsync(GetBgpPeerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBgpPeerResult>("azure-native:kubernetesruntime/v20231001preview:getBgpPeer", args ?? new GetBgpPeerArgs(), options.WithDefaults());
