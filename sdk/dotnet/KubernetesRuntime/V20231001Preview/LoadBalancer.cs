...
namespace Pulumi.AzureNative.KubernetesRuntime.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesruntime/v20231001preview:LoadBalancer")]
    public partial class LoadBalancer : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20231001preview:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20231001preview:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:kubernetesruntime:LoadBalancer" },
                },
            };
    ...
    public sealed class LoadBalancerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.V20231001Preview.AdvertiseMode> AdvertiseMode { get; set; } = null!;
