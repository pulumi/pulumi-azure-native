...
namespace Pulumi.AzureNative.KubernetesRuntime.V20231001Preview
{
    public static class GetStorageClass
    {
        ...
        public static Task<GetStorageClassResult> InvokeAsync(GetStorageClassArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageClassResult>("azure-native:kubernetesruntime/v20231001preview:getStorageClass", args ?? new GetStorageClassArgs(), options.WithDefaults());

        /// <summary>
        /// Get a StorageClassResource
        /// </summary>
        public static Output<GetStorageClassResult> Invoke(GetStorageClassInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageClassResult>("azure-native:kubernetesruntime/v20231001preview:getStorageClass", args ?? new GetStorageClassInvokeArgs(), options.WithDefaults());
    }
