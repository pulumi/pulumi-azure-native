...
namespace Pulumi.AzureNative.KubernetesRuntime.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesruntime/v20231001preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("rpObjectId")]
        public Output<string> RpObjectId { get; private set; } = null!;
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20231001preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20231001preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:kubernetesruntime:Service" },
                },
            };
