...
namespace Pulumi.AzureNative.KubernetesRuntime.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesruntime/v20231001preview:BgpPeer")]
    public partial class BgpPeer : global::Pulumi.CustomResource
    {
        ...
        public BgpPeer(string name, BgpPeerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20231001preview:BgpPeer", name, args ?? new BgpPeerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BgpPeer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime/v20231001preview:BgpPeer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:kubernetesruntime:BgpPeer" },
