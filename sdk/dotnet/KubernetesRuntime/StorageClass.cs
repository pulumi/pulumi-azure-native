...
namespace Pulumi.AzureNative.KubernetesRuntime
{
    ...
    public partial class StorageClass : global::Pulumi.CustomResource
    {
        ...
        public StorageClass(string name, StorageClassArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime:StorageClass", name, args ?? new StorageClassArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageClass(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesruntime:StorageClass", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("accessModes")]
        private InputList<Union<string, Pulumi.AzureNative.KubernetesRuntime.AccessMode>>? _accessModes;

        /// <summary>
        /// The access mode: [ReadWriteOnce, ReadWriteMany] or [ReadWriteOnce]
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.KubernetesRuntime.AccessMode>> AccessModes
        {
            get => _accessModes ?? (_accessModes = new InputList<Union<string, Pulumi.AzureNative.KubernetesRuntime.AccessMode>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.VolumeExpansion>? AllowVolumeExpansion { get; set; }

        /// <summary>
        /// Allow single data node failure
        /// </summary>
        [Input("dataResilience")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.DataResilienceTier>? DataResilience { get; set; }

        /// <summary>
        /// Failover speed: NA, Slow, Fast
        /// </summary>
        [Input("failoverSpeed")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.FailoverTier>? FailoverSpeed { get; set; }
        ...
        /// </summary>
        [Input("performance")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.PerformanceTier>? Performance { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.KubernetesRuntime.VolumeBindingMode>? VolumeBindingMode { get; set; }
