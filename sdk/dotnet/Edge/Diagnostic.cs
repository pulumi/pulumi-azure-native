...
namespace Pulumi.AzureNative.Edge
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:edge:Diagnostic")]
    public partial class Diagnostic : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DiagnosticPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public Diagnostic(string name, DiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edge:Diagnostic", name, args ?? new DiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Diagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edge:Diagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250601:Diagnostic" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250801:Diagnostic" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250815preview:Diagnostic" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20260301:Diagnostic" },
                },
            };
