...
namespace Pulumi.AzureNative.Edge
{
    ...
    public partial class WorkflowVersion : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.WorkflowVersionPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public WorkflowVersion(string name, WorkflowVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edge:WorkflowVersion", name, args ?? new WorkflowVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkflowVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edge:WorkflowVersion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250601:WorkflowVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250801:WorkflowVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250815preview:WorkflowVersion" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20260301:WorkflowVersion" },
                },
            };
    ...
    public sealed class WorkflowVersionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.WorkflowVersionPropertiesArgs>? Properties { get; set; }
