...
namespace Pulumi.AzureNative.Edge
{
    ...
    public partial class Context : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ContextPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public Context(string name, ContextArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edge:Context", name, args ?? new ContextArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Context(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edge:Context", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250601:Context" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250801:Context" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250815preview:Context" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20260301:Context" },
                },
            };
    ...
    public sealed class ContextArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.ContextPropertiesArgs>? Properties { get; set; }
