...
namespace Pulumi.AzureNative.Edge
{
    ...
    public partial class SitesBySubscription : global::Pulumi.CustomResource
    {
        ...
        private SitesBySubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edge:SitesBySubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20240201preview:SitesBySubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250301preview:SitesBySubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250601:SitesBySubscription" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SitesBySubscription Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SitesBySubscription(name, id, options);
        }
    }

    public sealed class SitesBySubscriptionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The resource-specific properties for this resource.
        /// </summary>
        ...
        public static new SitesBySubscriptionArgs Empty => new SitesBySubscriptionArgs();
    }
}
