...
namespace Pulumi.AzureNative.Edge
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:edge:Execution")]
    public partial class Execution : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ExecutionPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public Execution(string name, ExecutionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edge:Execution", name, args ?? new ExecutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Execution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edge:Execution", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250601:Execution" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250801:Execution" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250815preview:Execution" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20260301:Execution" },
                },
            };
    ...
    public sealed class ExecutionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.ExecutionPropertiesArgs>? Properties { get; set; }
