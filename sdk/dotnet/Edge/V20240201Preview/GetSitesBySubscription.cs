...
namespace Pulumi.AzureNative.Edge.V20240201Preview
{
    public static class GetSitesBySubscription
    {
        ...
        public static Task<GetSitesBySubscriptionResult> InvokeAsync(GetSitesBySubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSitesBySubscriptionResult>("azure-native:edge/v20240201preview:getSitesBySubscription", args ?? new GetSitesBySubscriptionArgs(), options.WithDefaults());
