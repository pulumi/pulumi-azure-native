...
namespace Pulumi.AzureNative.Edge
{
    ...
    public partial class Target : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.TargetPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public Target(string name, TargetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:edge:Target", name, args ?? new TargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Target(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:edge:Target", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250601:Target" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250801:Target" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20250815preview:Target" },
                    new global::Pulumi.Alias { Type = "azure-native:edge/v20260301:Target" },
                },
            };
    ...
    public sealed class TargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.TargetPropertiesArgs>? Properties { get; set; }
