...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    public static class GetDiagnosticService
    {
        ...
        public static Task<GetDiagnosticServiceResult> InvokeAsync(GetDiagnosticServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiagnosticServiceResult>("azure-native:iotoperationsmq/v20231004preview:getDiagnosticService", args ?? new GetDiagnosticServiceArgs(), options.WithDefaults());
