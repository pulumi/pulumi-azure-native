...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    public static class GetMqttBridgeConnector
    {
        ...
        public static Task<GetMqttBridgeConnectorResult> InvokeAsync(GetMqttBridgeConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMqttBridgeConnectorResult>("azure-native:iotoperationsmq/v20231004preview:getMqttBridgeConnector", args ?? new GetMqttBridgeConnectorArgs(), options.WithDefaults());
        ...
        public static Output<GetMqttBridgeConnectorResult> Invoke(GetMqttBridgeConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMqttBridgeConnectorResult>("azure-native:iotoperationsmq/v20231004preview:getMqttBridgeConnector", args ?? new GetMqttBridgeConnectorInvokeArgs(), options.WithDefaults());
    }
