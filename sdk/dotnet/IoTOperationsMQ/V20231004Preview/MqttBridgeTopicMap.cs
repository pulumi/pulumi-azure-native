...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperationsmq/v20231004preview:MqttBridgeTopicMap")]
    public partial class MqttBridgeTopicMap : global::Pulumi.CustomResource
    {
        ...
        public MqttBridgeTopicMap(string name, MqttBridgeTopicMapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:MqttBridgeTopicMap", name, args ?? new MqttBridgeTopicMapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MqttBridgeTopicMap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:MqttBridgeTopicMap", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:iotoperationsmq:MqttBridgeTopicMap"},
                },
            };
