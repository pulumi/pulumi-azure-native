...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperationsmq/v20231004preview:DataLakeConnector")]
    public partial class DataLakeConnector : global::Pulumi.CustomResource
    {
        ...
        public DataLakeConnector(string name, DataLakeConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:DataLakeConnector", name, args ?? new DataLakeConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataLakeConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:DataLakeConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataLakeConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview.DataLakeDatabaseFormat> DatabaseFormat { get; set; } = null!;
