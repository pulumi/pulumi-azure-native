...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    public static class GetMq
    {
        ...
        public static Task<GetMqResult> InvokeAsync(GetMqArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMqResult>("azure-native:iotoperationsmq/v20231004preview:getMq", args ?? new GetMqArgs(), options.WithDefaults());

        /// <summary>
        /// Get a MqResource
        /// </summary>
        public static Output<GetMqResult> Invoke(GetMqInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMqResult>("azure-native:iotoperationsmq/v20231004preview:getMq", args ?? new GetMqInvokeArgs(), options.WithDefaults());
