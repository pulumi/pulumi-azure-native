...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    ...
    /// MQ broker resource
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperationsmq/v20231004preview:Broker")]
    public partial class Broker : global::Pulumi.CustomResource
    {
        ...
        public Broker(string name, BrokerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:Broker", name, args ?? new BrokerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Broker(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:Broker", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:iotoperationsmq:Broker"},
                },
            };
    ...
    public sealed class BrokerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("memoryProfile")]
        public InputUnion<string, Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview.BrokerMemoryProfile>? MemoryProfile { get; set; }

        /// <summary>
        /// The Running Mode of the Broker Deployment.
        /// </summary>
        [Input("mode", required: true)]
        public InputUnion<string, Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview.RunMode> Mode { get; set; } = null!;
