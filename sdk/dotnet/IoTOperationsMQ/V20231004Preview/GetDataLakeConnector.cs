...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    public static class GetDataLakeConnector
    {
        ...
        public static Task<GetDataLakeConnectorResult> InvokeAsync(GetDataLakeConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataLakeConnectorResult>("azure-native:iotoperationsmq/v20231004preview:getDataLakeConnector", args ?? new GetDataLakeConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Get a DataLakeConnectorResource
        /// </summary>
        public static Output<GetDataLakeConnectorResult> Invoke(GetDataLakeConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataLakeConnectorResult>("azure-native:iotoperationsmq/v20231004preview:getDataLakeConnector", args ?? new GetDataLakeConnectorInvokeArgs(), options.WithDefaults());
