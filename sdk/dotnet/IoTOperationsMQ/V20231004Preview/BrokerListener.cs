...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperationsmq/v20231004preview:BrokerListener")]
    public partial class BrokerListener : global::Pulumi.CustomResource
    {
        ...
        public BrokerListener(string name, BrokerListenerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:BrokerListener", name, args ?? new BrokerListenerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BrokerListener(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:BrokerListener", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:iotoperationsmq:BrokerListener"},
                },
            };
    ...
    public sealed class BrokerListenerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("serviceType")]
        public InputUnion<string, Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview.ServiceType>? ServiceType { get; set; }
