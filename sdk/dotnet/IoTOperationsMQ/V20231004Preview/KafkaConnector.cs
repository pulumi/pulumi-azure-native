...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperationsmq/v20231004preview:KafkaConnector")]
    public partial class KafkaConnector : global::Pulumi.CustomResource
    {
        ...
        public KafkaConnector(string name, KafkaConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:KafkaConnector", name, args ?? new KafkaConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KafkaConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:KafkaConnector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:iotoperationsmq:KafkaConnector" },
                },
            };
