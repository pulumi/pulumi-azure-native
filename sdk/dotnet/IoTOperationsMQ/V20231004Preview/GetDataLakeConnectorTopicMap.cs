...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    public static class GetDataLakeConnectorTopicMap
    {
        ...
        public static Task<GetDataLakeConnectorTopicMapResult> InvokeAsync(GetDataLakeConnectorTopicMapArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataLakeConnectorTopicMapResult>("azure-native:iotoperationsmq/v20231004preview:getDataLakeConnectorTopicMap", args ?? new GetDataLakeConnectorTopicMapArgs(), options.WithDefaults());
