...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotoperationsmq/v20231004preview:BrokerAuthentication")]
    public partial class BrokerAuthentication : global::Pulumi.CustomResource
    {
        ...
        public BrokerAuthentication(string name, BrokerAuthenticationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:BrokerAuthentication", name, args ?? new BrokerAuthenticationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BrokerAuthentication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotoperationsmq/v20231004preview:BrokerAuthentication", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:iotoperationsmq:BrokerAuthentication"},
                },
            };
