...
namespace Pulumi.AzureNative.IoTOperationsMQ.V20231004Preview
{
    public static class GetMqttBridgeTopicMap
    {
        ...
        public static Task<GetMqttBridgeTopicMapResult> InvokeAsync(GetMqttBridgeTopicMapArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMqttBridgeTopicMapResult>("azure-native:iotoperationsmq/v20231004preview:getMqttBridgeTopicMap", args ?? new GetMqttBridgeTopicMapArgs(), options.WithDefaults());
