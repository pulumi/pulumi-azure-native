...
namespace Pulumi.AzureNative.DBforMySQL.V20210501
{
    public static class GetGetPrivateDnsZoneSuffixExecute
    {
        ...
        public static Output<GetGetPrivateDnsZoneSuffixExecuteResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGetPrivateDnsZoneSuffixExecuteResult>("azure-native:dbformysql/v20210501:getGetPrivateDnsZoneSuffixExecute", InvokeArgs.Empty, options.WithDefaults());
