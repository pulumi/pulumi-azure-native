...
namespace Pulumi.AzureNextGen.DBforMySQL.V20200701Preview
{
    ...
    /// A MySQL Server key.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:dbformysql/v20200701preview:ServerKey")]
    public partial class ServerKey : Pulumi.CustomResource
    {
        ...
        public ServerKey(string name, ServerKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformysql/v20200701preview:ServerKey", name, args ?? new ServerKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformysql/v20200701preview:ServerKey", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerKeyArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DBforMySQL.V20200701Preview.ServerKeyType> ServerKeyType { get; set; } = null!;
