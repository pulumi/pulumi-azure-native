...
namespace Pulumi.AzureNative.DBforMySQL.V20200701Preview
{
    ...
    /// A MySQL Server key.
    /// </summary>
    [Obsolete(@"azure-native:dbformysql/v20200701preview:ServerKey is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20200701privatepreview:ServerKey to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:dbformysql/v20200701preview:ServerKey")]
    public partial class ServerKey : global::Pulumi.CustomResource
    {
        ...
        public ServerKey(string name, ServerKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20200701preview:ServerKey", name, args ?? new ServerKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20200701preview:ServerKey", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:dbformysql/v20200701privatepreview:ServerKey"},
                },
            };
    ...
    public sealed class ServerKeyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20200701Preview.ServerKeyType> ServerKeyType { get; set; } = null!;
