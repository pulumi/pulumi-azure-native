...
namespace Pulumi.AzureNative.DBforMySQL.V20211201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20211201preview:Configuration")]
    public partial class Configuration : global::Pulumi.CustomResource
    {
        ...
        public Configuration(string name, ConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20211201preview:Configuration", name, args ?? new ConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Configuration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20211201preview:Configuration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("source")]
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20211201Preview.ConfigurationSource>? Source { get; set; }
