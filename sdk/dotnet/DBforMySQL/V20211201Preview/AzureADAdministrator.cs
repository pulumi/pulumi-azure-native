...
namespace Pulumi.AzureNative.DBforMySQL.V20211201Preview
{
    ...
    public partial class AzureADAdministrator : Pulumi.CustomResource
    {
        ...
        public AzureADAdministrator(string name, AzureADAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20211201preview:AzureADAdministrator", name, args ?? new AzureADAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureADAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20211201preview:AzureADAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:dbformysql:AzureADAdministrator"},
                },
            };
    ...
    public sealed class AzureADAdministratorArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20211201Preview.AdministratorType>? AdministratorType { get; set; }
