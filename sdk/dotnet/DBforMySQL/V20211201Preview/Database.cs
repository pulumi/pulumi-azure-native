...
namespace Pulumi.AzureNative.DBforMySQL.V20211201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20211201preview:Database")]
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20211201preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20211201preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
