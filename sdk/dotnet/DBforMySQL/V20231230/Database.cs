...
namespace Pulumi.AzureNative.DBforMySQL.V20231230
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20231230:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20231230:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20231230:Database", name, null, MakeResourceOptions(options, id))
        {
        }
