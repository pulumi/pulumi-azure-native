...
namespace Pulumi.AzureNative.DBforMySQL.V20231230
{
    ...
    /// Represents a server.
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20231230:Server")]
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20231230:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20231230:Server", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20231230.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20231230.ReplicationRole>? ReplicationRole { get; set; }
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20231230.ServerVersion>? Version { get; set; }
