...
namespace Pulumi.AzureNative.DBforMySQL.V20231230
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20231230:FirewallRule")]
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20231230:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20231230:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
