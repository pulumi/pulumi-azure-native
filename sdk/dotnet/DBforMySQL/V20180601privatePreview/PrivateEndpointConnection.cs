...
namespace Pulumi.AzureRM.DBforMySQL.V20180601privatePreview
{
    /// <summary>
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql/v20180601privatepreview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql/v20180601privatepreview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
