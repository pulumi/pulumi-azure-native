...
namespace Pulumi.AzureNative.DBforMySQL.V20230630
{
    public static class GetAzureADAdministrator
    {
        ...
        public static Task<GetAzureADAdministratorResult> InvokeAsync(GetAzureADAdministratorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAzureADAdministratorResult>("azure-native:dbformysql/v20230630:getAzureADAdministrator", args ?? new GetAzureADAdministratorArgs(), options.WithDefaults());
        ...
        public static Output<GetAzureADAdministratorResult> Invoke(GetAzureADAdministratorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAzureADAdministratorResult>("azure-native:dbformysql/v20230630:getAzureADAdministrator", args ?? new GetAzureADAdministratorInvokeArgs(), options.WithDefaults());
