...
namespace Pulumi.AzureNative.DBforMySQL.V20230630
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20230630:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20230630:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20230630:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
