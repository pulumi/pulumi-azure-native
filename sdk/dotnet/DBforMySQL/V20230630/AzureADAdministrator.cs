...
namespace Pulumi.AzureNative.DBforMySQL.V20230630
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20230630:AzureADAdministrator")]
    public partial class AzureADAdministrator : global::Pulumi.CustomResource
    {
        ...
        public AzureADAdministrator(string name, AzureADAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20230630:AzureADAdministrator", name, args ?? new AzureADAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureADAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20230630:AzureADAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AzureADAdministratorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20230630.AdministratorType>? AdministratorType { get; set; }
