...
namespace Pulumi.AzureNative.DBforMySQL.V20171201
{
    public static class GetServerAdministrator
    {
        ...
        public static Task<GetServerAdministratorResult> InvokeAsync(GetServerAdministratorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServerAdministratorResult>("azure-native:dbformysql/v20171201:getServerAdministrator", args ?? new GetServerAdministratorArgs(), options.WithVersion());
        ...
        public static Output<GetServerAdministratorResult> Invoke(GetServerAdministratorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServerAdministratorResult>("azure-native:dbformysql/v20171201:getServerAdministrator", args ?? new GetServerAdministratorInvokeArgs(), options.WithVersion());
    }
