...
namespace Pulumi.AzureNative.DBforMySQL.V20171201
{
    public static class GetSingleServerVirtualNetworkRule
    {
        ...
        public static Task<GetSingleServerVirtualNetworkRuleResult> InvokeAsync(GetSingleServerVirtualNetworkRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSingleServerVirtualNetworkRuleResult>("azure-native:dbformysql/v20171201:getSingleServerVirtualNetworkRule", args ?? new GetSingleServerVirtualNetworkRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetSingleServerVirtualNetworkRuleResult> Invoke(GetSingleServerVirtualNetworkRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSingleServerVirtualNetworkRuleResult>("azure-native:dbformysql/v20171201:getSingleServerVirtualNetworkRule", args ?? new GetSingleServerVirtualNetworkRuleInvokeArgs(), options.WithDefaults());
