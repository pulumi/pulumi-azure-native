...
namespace Pulumi.AzureRM.DBforMySQL.V20171201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var server = new AzureRM.DBforMySQL.V20171201.Server("server", new AzureRM.DBforMySQL.V20171201.ServerArgs
    ///         {
    ///             Location = "brazilsouth",
    ///             ResourceGroupName = "TargetResourceGroup",
    ///             ServerName = "targetserver",
    ///             Sku = new AzureRM.DBforMySQL.V20171201.Inputs.SkuArgs
    ///             {
    ///                 Capacity = 2,
    ///                 Family = "Gen5",
    ///                 Name = "GP_Gen5_2",
