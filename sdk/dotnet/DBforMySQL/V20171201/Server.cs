...
namespace Pulumi.AzureNative.DBforMySQL.V20171201
{
    ...
    /// {
    ///     var server = new AzureNative.DBforMySQL.V20171201.Server("server", new()
    ///     {
    ///         Location = "brazilsouth",
    ///         Properties = new AzureNative.DBforMySQL.V20171201.Inputs.ServerPropertiesForRestoreArgs
    ///         {
    ...
    ///         Sku = new AzureNative.DBforMySQL.V20171201.Inputs.SkuArgs
    ///         {
    ///             Capacity = 2,
    ///             Family = "Gen5",
    ///             Name = "GP_Gen5_2",
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforMySQL.V20171201.Inputs.ServerPropertiesForDefaultCreateArgs
    ///         {
    ///             AdministratorLogin = "cloudsa",
    ///             AdministratorLoginPassword = "&lt;administratorLoginPassword&gt;",
    ///             CreateMode = "Default",
    ///             SslEnforcement = AzureNative.DBforMySQL.V20171201.SslEnforcementEnum.Enabled,
    ///             StorageProfile = new AzureNative.DBforMySQL.V20171201.Inputs.StorageProfileArgs
    ///             {
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforMySQL.V20171201.Inputs.ServerPropertiesForReplicaArgs
    ///         {
    ///             CreateMode = "Replica",
    ...
    ///     {
    ///         Location = "westus",
    ///         Properties = new AzureNative.DBforMySQL.V20171201.Inputs.ServerPropertiesForGeoRestoreArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20171201:Server")]
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201:Server", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:dbformysql/v20171201preview:Server"},
