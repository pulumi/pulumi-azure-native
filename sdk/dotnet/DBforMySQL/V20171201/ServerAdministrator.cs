...
namespace Pulumi.AzureNextGen.DBforMySQL.V20171201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:dbformysql/v20171201:ServerAdministrator")]
    ...
    public sealed class ServerAdministratorArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DBforMySQL.V20171201.AdministratorType> AdministratorType { get; set; } = null!;
