...
namespace Pulumi.AzureNative.DBforMySQL.V20171201
{
    ...
    /// {
    ///     var serverAdministrator = new AzureNative.DBforMySQL.V20171201.ServerAdministrator("serverAdministrator", new()
    ///     {
    ...
    public partial class ServerAdministrator : global::Pulumi.CustomResource
    {
        ...
        public ServerAdministrator(string name, ServerAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201:ServerAdministrator", name, args ?? new ServerAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201:ServerAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
