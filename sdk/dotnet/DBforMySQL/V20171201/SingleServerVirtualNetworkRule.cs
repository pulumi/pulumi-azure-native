...
namespace Pulumi.AzureNative.DBforMySQL.V20171201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20171201:SingleServerVirtualNetworkRule")]
    public partial class SingleServerVirtualNetworkRule : global::Pulumi.CustomResource
    {
        ...
        public SingleServerVirtualNetworkRule(string name, SingleServerVirtualNetworkRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201:SingleServerVirtualNetworkRule", name, args ?? new SingleServerVirtualNetworkRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SingleServerVirtualNetworkRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201:SingleServerVirtualNetworkRule", name, null, MakeResourceOptions(options, id))
        {
        }
