...
namespace Pulumi.AzureNative.DBforMySQL.V20220930Preview
{
    ...
    /// {
    ///     var server = new AzureNative.DBforMySQL.V20220930Preview.Server("server", new()
    ///     {
    ///         AdministratorLogin = "cloudsa",
    ///         AdministratorLoginPassword = "your_password",
    ///         AvailabilityZone = "1",
    ///         Backup = new AzureNative.DBforMySQL.V20220930Preview.Inputs.BackupArgs
    ///         {
    ///             BackupRetentionDays = 7,
    ///             GeoRedundantBackup = "Disabled",
    ///         },
    ///         CreateMode = "Default",
    ///         HighAvailability = new AzureNative.DBforMySQL.V20220930Preview.Inputs.HighAvailabilityArgs
    ///         {
    ///             Mode = "ZoneRedundant",
    ...
    ///         Sku = new AzureNative.DBforMySQL.V20220930Preview.Inputs.SkuArgs
    ///         {
    ///             Name = "Standard_D2ds_v4",
    ///             Tier = "GeneralPurpose",
    ///         },
    ///         Storage = new AzureNative.DBforMySQL.V20220930Preview.Inputs.StorageArgs
    ///         {
    ///             AutoGrow = "Disabled",
    ///             Iops = 600,
    ///             StorageSizeGB = 100,
    ...
    ///         },
    ///         CreateMode = "Default",
    ///         DataEncryption = new AzureNative.DBforMySQL.V20220930Preview.Inputs.DataEncryptionArgs
    ///         {
    ...
    ///             Type = AzureNative.DBforMySQL.V20220930Preview.DataEncryptionType.AzureKeyVault,
    ///         },
    ///         HighAvailability = new AzureNative.DBforMySQL.V20220930Preview.Inputs.HighAvailabilityArgs
    ///         {
    ///             Mode = "ZoneRedundant",
    ///             StandbyAvailabilityZone = "3",
    ///         },
    ///         Identity = new AzureNative.DBforMySQL.V20220930Preview.Inputs.IdentityArgs
    ///         {
    ///             Type = "UserAssigned",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20220930preview:Server")]
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20220930preview:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20220930preview:Server", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20220930Preview.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20220930Preview.ReplicationRole>? ReplicationRole { get; set; }
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20220930Preview.ServerVersion>? Version { get; set; }
