...
namespace Pulumi.AzureRM.DBforMySQL.Preview
{
    public static class GetMaintenanceWindow
    {
        public static Task<GetMaintenanceWindowResult> InvokeAsync(GetMaintenanceWindowArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMaintenanceWindowResult>("azurerm:dbformysql/preview:getMaintenanceWindow", args ?? new GetMaintenanceWindowArgs(), options.WithVersion());
    }
