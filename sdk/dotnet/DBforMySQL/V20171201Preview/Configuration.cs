...
namespace Pulumi.AzureNative.DBforMySQL.V20171201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20171201preview:Configuration")]
    public partial class Configuration : Pulumi.CustomResource
    {
        ...
        public Configuration(string name, ConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201preview:Configuration", name, args ?? new ConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Configuration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201preview:Configuration", name, null, MakeResourceOptions(options, id))
        {
        }
