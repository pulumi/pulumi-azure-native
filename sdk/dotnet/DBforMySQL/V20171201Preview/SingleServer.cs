...
namespace Pulumi.AzureNative.DBforMySQL.V20171201Preview
{
    ...
    /// Represents a server.
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20171201preview:SingleServer")]
    public partial class SingleServer : global::Pulumi.CustomResource
    {
        ...
        public SingleServer(string name, SingleServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201preview:SingleServer", name, args ?? new SingleServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SingleServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201preview:SingleServer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:dbformysql:SingleServer" },
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SingleServer Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SingleServer(name, id, options);
        }
    }

    public sealed class SingleServerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public SingleServerArgs()
        {
        }
        public static new SingleServerArgs Empty => new SingleServerArgs();
    }
}
