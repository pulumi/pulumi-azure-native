...
namespace Pulumi.AzureRM.DBForMySQL.V20171201Preview
{
    ...
    public partial class ServerAdministrator : Pulumi.CustomResource
    {
        ...
        public ServerAdministrator(string name, ServerAdministratorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql/v20171201preview:ServerAdministrator", name, args ?? new ServerAdministratorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAdministrator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql/v20171201preview:ServerAdministrator", name, null, MakeResourceOptions(options, id))
        {
        }
