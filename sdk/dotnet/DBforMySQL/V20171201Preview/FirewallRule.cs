...
namespace Pulumi.AzureNative.DBforMySQL.V20171201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20171201preview:FirewallRule")]
    public partial class FirewallRule : Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201preview:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20171201preview:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
