...
namespace Pulumi.AzureNative.DBforMySQL.V20171201Preview
{
    public static class GetSingleServerDatabase
    {
        ...
        public static Task<GetSingleServerDatabaseResult> InvokeAsync(GetSingleServerDatabaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSingleServerDatabaseResult>("azure-native:dbformysql/v20171201preview:getSingleServerDatabase", args ?? new GetSingleServerDatabaseArgs(), options.WithDefaults());
        ...
        public static Output<GetSingleServerDatabaseResult> Invoke(GetSingleServerDatabaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSingleServerDatabaseResult>("azure-native:dbformysql/v20171201preview:getSingleServerDatabase", args ?? new GetSingleServerDatabaseInvokeArgs(), options.WithDefaults());
