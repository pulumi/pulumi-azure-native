...
namespace Pulumi.AzureNextGen.DBforMySQL.V20171201Preview
{
    ...
    /// Represents a server.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:dbformysql/v20171201preview:Server")]
    public partial class Server : Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformysql/v20171201preview:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:dbformysql/v20171201preview:Server", name, null, MakeResourceOptions(options, id))
        {
        }
