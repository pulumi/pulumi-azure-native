...
namespace Pulumi.AzureNative.DBforMySQL.V20231201Preview
{
    ...
    /// Represents a server.
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20231201preview:Server")]
    public partial class Server : global::Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20231201preview:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20231201preview:Server", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServerArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20231201Preview.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20231201Preview.ReplicationRole>? ReplicationRole { get; set; }
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20231201Preview.ServerVersion>? Version { get; set; }
