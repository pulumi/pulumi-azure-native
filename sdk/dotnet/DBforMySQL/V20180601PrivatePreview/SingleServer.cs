...
namespace Pulumi.AzureNative.DBforMySQL.V20180601PrivatePreview
{
    ...
    /// Represents a server.
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20180601privatepreview:SingleServer")]
    public partial class SingleServer : global::Pulumi.CustomResource
    {
        ...
        public SingleServer(string name, SingleServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20180601privatepreview:SingleServer", name, args ?? new SingleServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SingleServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20180601privatepreview:SingleServer", name, null, MakeResourceOptions(options, id))
        {
        }
