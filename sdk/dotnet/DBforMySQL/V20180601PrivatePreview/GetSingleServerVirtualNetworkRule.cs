...
namespace Pulumi.AzureNative.DBforMySQL.V20180601PrivatePreview
{
    public static class GetSingleServerVirtualNetworkRule
    {
        ...
        public static Task<GetSingleServerVirtualNetworkRuleResult> InvokeAsync(GetSingleServerVirtualNetworkRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSingleServerVirtualNetworkRuleResult>("azure-native:dbformysql/v20180601privatepreview:getSingleServerVirtualNetworkRule", args ?? new GetSingleServerVirtualNetworkRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetSingleServerVirtualNetworkRuleResult> Invoke(GetSingleServerVirtualNetworkRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSingleServerVirtualNetworkRuleResult>("azure-native:dbformysql/v20180601privatepreview:getSingleServerVirtualNetworkRule", args ?? new GetSingleServerVirtualNetworkRuleInvokeArgs(), options.WithDefaults());
