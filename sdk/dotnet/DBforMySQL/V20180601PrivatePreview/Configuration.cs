...
namespace Pulumi.AzureNative.DBforMySQL.V20180601PrivatePreview
{
    ...
    /// {
    ///     var configuration = new AzureNative.DBforMySQL.V20180601PrivatePreview.Configuration("configuration", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20180601privatepreview:Configuration")]
    public partial class Configuration : global::Pulumi.CustomResource
    {
        ...
        public Configuration(string name, ConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20180601privatepreview:Configuration", name, args ?? new ConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Configuration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20180601privatepreview:Configuration", name, null, MakeResourceOptions(options, id))
        {
        }
