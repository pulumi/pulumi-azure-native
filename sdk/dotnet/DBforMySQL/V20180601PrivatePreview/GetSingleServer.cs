...
namespace Pulumi.AzureNative.DBforMySQL.V20180601PrivatePreview
{
    public static class GetSingleServer
    {
        ...
        public static Task<GetSingleServerResult> InvokeAsync(GetSingleServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSingleServerResult>("azure-native:dbformysql/v20180601privatepreview:getSingleServer", args ?? new GetSingleServerArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a server.
        /// </summary>
        public static Output<GetSingleServerResult> Invoke(GetSingleServerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSingleServerResult>("azure-native:dbformysql/v20180601privatepreview:getSingleServer", args ?? new GetSingleServerInvokeArgs(), options.WithDefaults());
