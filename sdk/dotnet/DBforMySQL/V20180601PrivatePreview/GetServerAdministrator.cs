...
namespace Pulumi.AzureNative.DBforMySQL.V20180601PrivatePreview
{
    public static class GetServerAdministrator
    {
        ...
        public static Task<GetServerAdministratorResult> InvokeAsync(GetServerAdministratorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerAdministratorResult>("azure-native:dbformysql/v20180601privatepreview:getServerAdministrator", args ?? new GetServerAdministratorArgs(), options.WithDefaults());
