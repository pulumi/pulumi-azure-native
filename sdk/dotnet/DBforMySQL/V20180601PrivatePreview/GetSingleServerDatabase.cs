...
namespace Pulumi.AzureNative.DBforMySQL.V20180601PrivatePreview
{
    public static class GetSingleServerDatabase
    {
        ...
        public static Task<GetSingleServerDatabaseResult> InvokeAsync(GetSingleServerDatabaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSingleServerDatabaseResult>("azure-native:dbformysql/v20180601privatepreview:getSingleServerDatabase", args ?? new GetSingleServerDatabaseArgs(), options.WithDefaults());
        ...
        public static Output<GetSingleServerDatabaseResult> Invoke(GetSingleServerDatabaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSingleServerDatabaseResult>("azure-native:dbformysql/v20180601privatepreview:getSingleServerDatabase", args ?? new GetSingleServerDatabaseInvokeArgs(), options.WithDefaults());
