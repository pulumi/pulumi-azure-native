...
namespace Pulumi.AzureNative.DBforMySQL.V20180601PrivatePreview
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.DBforMySQL.V20180601PrivatePreview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "private-endpoint-connection-name",
    ///         PrivateLinkServiceConnectionState = new AzureNative.DBforMySQL.V20180601PrivatePreview.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///         {
