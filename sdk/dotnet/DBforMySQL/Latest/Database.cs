...
namespace Pulumi.AzureRM.DBforMySQL.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var database = new AzureRM.DBforMySQL.Latest.Database("database", new AzureRM.DBforMySQL.Latest.DatabaseArgs
    ///         {
    ///             Charset = "utf8",
    ...
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql/latest:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql/latest:Database", name, null, MakeResourceOptions(options, id))
        {
        }
