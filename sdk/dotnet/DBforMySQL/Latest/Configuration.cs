...
namespace Pulumi.AzureNative.DBforMySQL.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbformysql:Configuration'.")]
    [AzureNativeResourceType("azure-native:dbformysql/latest:Configuration")]
    public partial class Configuration : Pulumi.CustomResource
    {
        ...
        public Configuration(string name, ConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/latest:Configuration", name, args ?? new ConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Configuration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/latest:Configuration", name, null, MakeResourceOptions(options, id))
        {
        }
