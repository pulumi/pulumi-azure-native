...
namespace Pulumi.AzureNextGen.DBforMySQL.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:dbformysql:Configuration'.")]
    [AzureNextGenResourceType("azure-nextgen:dbformysql/latest:Configuration")]
