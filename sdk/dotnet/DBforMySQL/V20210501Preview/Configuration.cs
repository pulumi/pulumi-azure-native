...
namespace Pulumi.AzureNative.DBforMySQL.V20210501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:dbformysql/v20210501preview:Configuration is being removed in the next major version of this provider. Upgrade to at least azure-native:dbformysql/v20220101:Configuration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:dbformysql/v20210501preview:Configuration")]
    public partial class Configuration : global::Pulumi.CustomResource
    {
        ...
        public Configuration(string name, ConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20210501preview:Configuration", name, args ?? new ConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Configuration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20210501preview:Configuration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("source")]
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20210501Preview.ConfigurationSource>? Source { get; set; }
