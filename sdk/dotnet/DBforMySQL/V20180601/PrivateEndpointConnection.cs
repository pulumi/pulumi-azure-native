...
namespace Pulumi.AzureNative.DBforMySQL.V20180601
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.DBforMySQL.V20180601.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "private-endpoint-connection-name",
    ///         PrivateLinkServiceConnectionState = new AzureNative.DBforMySQL.V20180601.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///         {
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20180601:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20180601:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
