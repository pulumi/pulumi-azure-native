...
namespace Pulumi.AzureRM.DBForMySql.V20200701PrivatePreview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var serverKey = new AzureRM.DBForMySql.V20200701PrivatePreview.ServerKey("serverKey", new AzureRM.DBForMySql.V20200701PrivatePreview.ServerKeyArgs
    ///         {
    ...
    public partial class ServerKey : Pulumi.CustomResource
    {
        ...
        public ServerKey(string name, ServerKeyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql/v20200701privatepreview:ServerKey", name, args ?? new ServerKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql/v20200701privatepreview:ServerKey", name, null, MakeResourceOptions(options, id))
        {
        }
