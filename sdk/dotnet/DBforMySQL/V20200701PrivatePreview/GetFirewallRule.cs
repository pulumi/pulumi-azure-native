...
namespace Pulumi.AzureNative.DBforMySQL.V20200701PrivatePreview
{
    ...
    public static class GetFirewallRule
    {
        ...
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azure-native:dbformysql/v20200701privatepreview:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a server firewall rule.
        /// </summary>
        public static Output<GetFirewallRuleResult> Invoke(GetFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallRuleResult>("azure-native:dbformysql/v20200701privatepreview:getFirewallRule", args ?? new GetFirewallRuleInvokeArgs(), options.WithDefaults());
    }
