...
namespace Pulumi.AzureRM.DBforMySQL
{
    ...
    public partial class Server : Pulumi.CustomResource
    {
        ...
        public Server(string name, ServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql:Server", name, args ?? new ServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Server(string name, Input<string> id, ServerState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:dbformysql:Server", name, state, MakeResourceOptions(options, id))
        {
        }
