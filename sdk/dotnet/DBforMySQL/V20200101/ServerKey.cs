...
namespace Pulumi.AzureNative.DBforMySQL.V20200101
{
    ...
    /// {
    ///     var serverKey = new AzureNative.DBforMySQL.V20200101.ServerKey("serverKey", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:dbformysql/v20200101:ServerKey omeVault_someKey_01234567890123456789012345678901 /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testrg/providers/Microsoft.DBforMySQL/servers/testserver/keys/someVault_someKey_01234567890123456789012345678901 
    /// ```
    /// </summary>
    ...
    public partial class ServerKey : global::Pulumi.CustomResource
    {
        ...
        public ServerKey(string name, ServerKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20200101:ServerKey", name, args ?? new ServerKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20200101:ServerKey", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:dbformysql/v20200101privatepreview:ServerKey"},
                },
            };
    ...
    public sealed class ServerKeyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DBforMySQL.V20200101.ServerKeyType> ServerKeyType { get; set; } = null!;
