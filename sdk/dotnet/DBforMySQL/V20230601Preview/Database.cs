...
namespace Pulumi.AzureNative.DBforMySQL.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20230601preview:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20230601preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20230601preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
