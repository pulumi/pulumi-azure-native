...
namespace Pulumi.AzureNative.DBforMySQL.V20220101
{
    ...
    /// {
    ///     var database = new AzureNative.DBforMySQL.V20220101.Database("database", new()
    ///     {
    ///         Charset = "utf8",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dbformysql/v20220101:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20220101:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dbformysql/v20220101:Database", name, null, MakeResourceOptions(options, id))
        {
        }
