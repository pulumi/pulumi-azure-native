...
namespace Pulumi.AzureNative.DBforMySQL.V20220101
{
    public static class GetFirewallRule
    {
        ...
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azure-native:dbformysql/v20220101:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithDefaults());
