...
namespace Pulumi.AzureNative.DeviceRegistry
{
    ...
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("messaging")]
        public Output<Outputs.MessagingResponse?> Messaging { get; private set; } = null!;
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry/v20250701preview:Namespace" },
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry/v20251001:Namespace" },
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry/v20251101preview:Namespace" },
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry/v20260301preview:Namespace" },
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry/v20260401:Namespace" },
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry/v20261101preview:Namespace" },
                },
            };
    ...
    public sealed class NamespaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("messaging")]
        public Input<Inputs.MessagingArgs>? Messaging { get; set; }
