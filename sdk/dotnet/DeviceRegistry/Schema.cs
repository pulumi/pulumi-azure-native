...
namespace Pulumi.AzureNative.DeviceRegistry
{
    ...
    public partial class Schema : global::Pulumi.CustomResource
    {
        ...
        public Schema(string name, SchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry:Schema", name, args ?? new SchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry:Schema", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry/v20260301preview:Schema" },
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry/v20260401:Schema" },
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry/v20261101preview:Schema" },
                },
            };
    ...
    public sealed class SchemaArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DeviceRegistry.Format> Format { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DeviceRegistry.SchemaType> SchemaType { get; set; } = null!;
