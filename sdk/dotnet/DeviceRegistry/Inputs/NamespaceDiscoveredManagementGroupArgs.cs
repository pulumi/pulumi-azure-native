...
namespace Pulumi.AzureNative.DeviceRegistry.Inputs
{
    ...
    /// </summary>
    public sealed class NamespaceDiscoveredManagementGroupArgs : global::Pulumi.ResourceArgs
    {
        [Input("actions")]
        private InputList<Inputs.NamespaceDiscoveredManagementActionArgs>? _actions;

        /// <summary>
        /// Array of actions that are part of the management group. Each action can have an individual configuration.
        /// </summary>
        public InputList<Inputs.NamespaceDiscoveredManagementActionArgs> Actions
        {
            get => _actions ?? (_actions = new InputList<Inputs.NamespaceDiscoveredManagementActionArgs>());
            set => _actions = value;
        }
        ...
        public NamespaceDiscoveredManagementGroupArgs()
        {
            DefaultTimeoutInSeconds = 100;
        }
        public static new NamespaceDiscoveredManagementGroupArgs Empty => new NamespaceDiscoveredManagementGroupArgs();
    }
}
