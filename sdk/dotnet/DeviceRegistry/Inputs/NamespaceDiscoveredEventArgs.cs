...
namespace Pulumi.AzureNative.DeviceRegistry.Inputs
{
    ...
    /// </summary>
    public sealed class NamespaceDiscoveredEventArgs : global::Pulumi.ResourceArgs
    {
        [Input("dataPoints")]
        private InputList<Inputs.NamespaceDiscoveredEventDataPointArgs>? _dataPoints;

        /// <summary>
        /// Array of data points that are part of the event. Each data point can have a per-data point configuration.
        /// </summary>
        public InputList<Inputs.NamespaceDiscoveredEventDataPointArgs> DataPoints
        {
            get => _dataPoints ?? (_dataPoints = new InputList<Inputs.NamespaceDiscoveredEventDataPointArgs>());
        ...
        public NamespaceDiscoveredEventArgs()
        {
        }
        public static new NamespaceDiscoveredEventArgs Empty => new NamespaceDiscoveredEventArgs();
    }
}
