...
namespace Pulumi.AzureNative.DeviceRegistry.V20241101
{
    ...
    /// Asset definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceregistry/v20241101:Asset")]
    public partial class Asset : global::Pulumi.CustomResource
    {
        ...
        public Asset(string name, AssetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20241101:Asset", name, args ?? new AssetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Asset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20241101:Asset", name, null, MakeResourceOptions(options, id))
        {
        }
