...
namespace Pulumi.AzureNative.DeviceRegistry.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceregistry/v20241101:AssetEndpointProfile")]
    public partial class AssetEndpointProfile : global::Pulumi.CustomResource
    {
        ...
        public AssetEndpointProfile(string name, AssetEndpointProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20241101:AssetEndpointProfile", name, args ?? new AssetEndpointProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssetEndpointProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20241101:AssetEndpointProfile", name, null, MakeResourceOptions(options, id))
        {
        }
