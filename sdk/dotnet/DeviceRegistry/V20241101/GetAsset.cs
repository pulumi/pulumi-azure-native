...
namespace Pulumi.AzureNative.DeviceRegistry.V20241101
{
    public static class GetAsset
    {
        ...
        public static Task<GetAssetResult> InvokeAsync(GetAssetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssetResult>("azure-native:deviceregistry/v20241101:getAsset", args ?? new GetAssetArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Asset
        /// </summary>
        public static Output<GetAssetResult> Invoke(GetAssetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAssetResult>("azure-native:deviceregistry/v20241101:getAsset", args ?? new GetAssetInvokeArgs(), options.WithDefaults());
