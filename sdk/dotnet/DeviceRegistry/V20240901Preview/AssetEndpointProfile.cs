...
namespace Pulumi.AzureNative.DeviceRegistry.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceregistry/v20240901preview:AssetEndpointProfile")]
    public partial class AssetEndpointProfile : global::Pulumi.CustomResource
    {
        ...
        public AssetEndpointProfile(string name, AssetEndpointProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:AssetEndpointProfile", name, args ?? new AssetEndpointProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssetEndpointProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:AssetEndpointProfile", name, null, MakeResourceOptions(options, id))
        {
        }
