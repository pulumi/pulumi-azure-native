...
namespace Pulumi.AzureNative.DeviceRegistry.V20240901Preview
{
    public static class GetAsset
    {
        ...
        public static Task<GetAssetResult> InvokeAsync(GetAssetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAssetResult>("azure-native:deviceregistry/v20240901preview:getAsset", args ?? new GetAssetArgs(), options.WithDefaults());
