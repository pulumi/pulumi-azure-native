...
namespace Pulumi.AzureNative.DeviceRegistry.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceregistry/v20240901preview:SchemaVersion")]
    public partial class SchemaVersion : global::Pulumi.CustomResource
    {
        ...
        public SchemaVersion(string name, SchemaVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:SchemaVersion", name, args ?? new SchemaVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:SchemaVersion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry:SchemaVersion" },
                },
            };
