...
namespace Pulumi.AzureNative.DeviceRegistry.V20240901Preview
{
    public static class GetSchemaVersion
    {
        ...
        public static Task<GetSchemaVersionResult> InvokeAsync(GetSchemaVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSchemaVersionResult>("azure-native:deviceregistry/v20240901preview:getSchemaVersion", args ?? new GetSchemaVersionArgs(), options.WithDefaults());

        /// <summary>
        /// Get a SchemaVersion
        /// </summary>
        public static Output<GetSchemaVersionResult> Invoke(GetSchemaVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSchemaVersionResult>("azure-native:deviceregistry/v20240901preview:getSchemaVersion", args ?? new GetSchemaVersionInvokeArgs(), options.WithDefaults());
    }
