...
namespace Pulumi.AzureNative.DeviceRegistry.V20240901Preview
{
    public static class GetSchema
    {
        ...
        public static Task<GetSchemaResult> InvokeAsync(GetSchemaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSchemaResult>("azure-native:deviceregistry/v20240901preview:getSchema", args ?? new GetSchemaArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Schema
        /// </summary>
        public static Output<GetSchemaResult> Invoke(GetSchemaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSchemaResult>("azure-native:deviceregistry/v20240901preview:getSchema", args ?? new GetSchemaInvokeArgs(), options.WithDefaults());
