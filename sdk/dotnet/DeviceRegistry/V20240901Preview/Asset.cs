...
namespace Pulumi.AzureNative.DeviceRegistry.V20240901Preview
{
    ...
    /// Asset definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceregistry/v20240901preview:Asset")]
    public partial class Asset : global::Pulumi.CustomResource
    {
        ...
        public Asset(string name, AssetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:Asset", name, args ?? new AssetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Asset(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:Asset", name, null, MakeResourceOptions(options, id))
        {
        }
