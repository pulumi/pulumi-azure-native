...
namespace Pulumi.AzureNative.DeviceRegistry.V20240901Preview
{
    ...
    /// Schema definition.
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceregistry/v20240901preview:Schema")]
    public partial class Schema : global::Pulumi.CustomResource
    {
        ...
        public Schema(string name, SchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:Schema", name, args ?? new SchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:Schema", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry:Schema" },
                },
            };
    ...
    public sealed class SchemaArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DeviceRegistry.V20240901Preview.Format> Format { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DeviceRegistry.V20240901Preview.SchemaType> SchemaType { get; set; } = null!;
