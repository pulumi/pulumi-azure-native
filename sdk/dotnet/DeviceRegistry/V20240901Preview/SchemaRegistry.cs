...
namespace Pulumi.AzureNative.DeviceRegistry.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceregistry/v20240901preview:SchemaRegistry")]
    public partial class SchemaRegistry : global::Pulumi.CustomResource
    {
        ...
        public SchemaRegistry(string name, SchemaRegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:SchemaRegistry", name, args ?? new SchemaRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaRegistry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceregistry/v20240901preview:SchemaRegistry", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:deviceregistry:SchemaRegistry" },
                },
            };
