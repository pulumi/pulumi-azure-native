...
namespace Pulumi.AzureRM.WindowsESU.Latest
{
    public static class GetMultipleActivationKey
    {
        public static Task<GetMultipleActivationKeyResult> InvokeAsync(GetMultipleActivationKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMultipleActivationKeyResult>("azurerm:windowsesu/latest:getMultipleActivationKey", args ?? new GetMultipleActivationKeyArgs(), options.WithVersion());
    }
