...
namespace Pulumi.AzureRM.WindowsESU.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var multipleActivationKey = new AzureRM.WindowsESU.Latest.MultipleActivationKey("multipleActivationKey", new AzureRM.WindowsESU.Latest.MultipleActivationKeyArgs
    ///         {
    ...
    public partial class MultipleActivationKey : Pulumi.CustomResource
    {
        ...
        public MultipleActivationKey(string name, MultipleActivationKeyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:windowsesu/latest:MultipleActivationKey", name, args ?? new MultipleActivationKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MultipleActivationKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:windowsesu/latest:MultipleActivationKey", name, null, MakeResourceOptions(options, id))
        {
        }
