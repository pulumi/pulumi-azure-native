...
namespace Pulumi.AzureRM.AVS.V20200320
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cluster = new AzureRM.AVS.V20200320.Cluster("cluster", new AzureRM.AVS.V20200320.ClusterArgs
    ///         {
    ...
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:avs/v20200320:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:avs/v20200320:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
