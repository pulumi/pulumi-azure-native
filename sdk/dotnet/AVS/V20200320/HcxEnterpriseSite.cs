...
namespace Pulumi.AzureNative.AVS.V20200320
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:avs/v20200320:HcxEnterpriseSite is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:HcxEnterpriseSite to guarantee forwards compatibility.")]
    ...
    public partial class HcxEnterpriseSite : global::Pulumi.CustomResource
    {
        ...
        public HcxEnterpriseSite(string name, HcxEnterpriseSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20200320:HcxEnterpriseSite", name, args ?? new HcxEnterpriseSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HcxEnterpriseSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20200320:HcxEnterpriseSite", name, null, MakeResourceOptions(options, id))
        {
        }
