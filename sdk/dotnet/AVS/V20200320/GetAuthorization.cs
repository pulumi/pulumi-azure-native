...
namespace Pulumi.AzureNative.AVS.V20200320
{
    public static class GetAuthorization
    {
        ...
        public static Task<GetAuthorizationResult> InvokeAsync(GetAuthorizationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationResult>("azure-native:avs/v20200320:getAuthorization", args ?? new GetAuthorizationArgs(), options.WithDefaults());

        /// <summary>
        /// ExpressRoute Circuit Authorization
        /// </summary>
        public static Output<GetAuthorizationResult> Invoke(GetAuthorizationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAuthorizationResult>("azure-native:avs/v20200320:getAuthorization", args ?? new GetAuthorizationInvokeArgs(), options.WithDefaults());
    }
