...
namespace Pulumi.AzureNative.AVS.V20210601
{
    ...
    /// NSX Port Mirroring
    /// </summary>
    [Obsolete(@"azure-native:avs/v20210601:WorkloadNetworkPortMirroring is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkPortMirroring to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:avs/v20210601:WorkloadNetworkPortMirroring")]
    public partial class WorkloadNetworkPortMirroring : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkPortMirroring(string name, WorkloadNetworkPortMirroringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:WorkloadNetworkPortMirroring", name, args ?? new WorkloadNetworkPortMirroringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkPortMirroring(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:WorkloadNetworkPortMirroring", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:avs:WorkloadNetworkPortMirroring"},
    ...
    public sealed class WorkloadNetworkPortMirroringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20210601.PortMirroringDirectionEnum>? Direction { get; set; }
