...
namespace Pulumi.AzureNative.AVS.V20210601
{
    ...
    public partial class WorkloadNetworkDnsService : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkDnsService(string name, WorkloadNetworkDnsServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:WorkloadNetworkDnsService", name, args ?? new WorkloadNetworkDnsServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkDnsService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:WorkloadNetworkDnsService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkloadNetworkDnsServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("logLevel")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20210601.DnsServiceLogLevelEnum>? LogLevel { get; set; }
