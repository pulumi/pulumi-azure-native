...
namespace Pulumi.AzureNative.AVS.V20210601
{
    ...
    /// {
    ///     var scriptExecution = new AzureNative.AVS.V20210601.ScriptExecution("scriptExecution", new()
    ///     {
    ///         HiddenParameters = new[]
    ///         {
    ///             new AzureNative.AVS.V20210601.Inputs.ScriptSecureStringExecutionParameterArgs
    ///             {
    ///                 Name = "Password",
    ...
    ///         Parameters = new[]
    ///         {
    ///             new AzureNative.AVS.V20210601.Inputs.ScriptStringExecutionParameterArgs
    ///             {
    ///                 Name = "DomainName",
    ///                 Type = "Value",
    ...
    public partial class ScriptExecution : global::Pulumi.CustomResource
    {
        ...
        public ScriptExecution(string name, ScriptExecutionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:ScriptExecution", name, args ?? new ScriptExecutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScriptExecution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:ScriptExecution", name, null, MakeResourceOptions(options, id))
        {
        }
