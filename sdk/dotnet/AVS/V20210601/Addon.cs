...
namespace Pulumi.AzureNative.AVS.V20210601
{
    ...
    public partial class Addon : global::Pulumi.CustomResource
    {
        ...
        public Addon(string name, AddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:Addon", name, args ?? new AddonArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Addon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:Addon", name, null, MakeResourceOptions(options, id))
        {
        }
