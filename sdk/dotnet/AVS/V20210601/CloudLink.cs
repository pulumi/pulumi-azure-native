...
namespace Pulumi.AzureNative.AVS.V20210601
{
    ...
    /// {
    ///     var cloudLink = new AzureNative.AVS.V20210601.CloudLink("cloudLink", new()
    ///     {
    ...
    public partial class CloudLink : global::Pulumi.CustomResource
    {
        ...
        public CloudLink(string name, CloudLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:CloudLink", name, args ?? new CloudLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:CloudLink", name, null, MakeResourceOptions(options, id))
        {
        }
