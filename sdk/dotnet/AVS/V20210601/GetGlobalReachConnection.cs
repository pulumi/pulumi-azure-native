...
namespace Pulumi.AzureNative.AVS.V20210601
{
    public static class GetGlobalReachConnection
    {
        ...
        public static Task<GetGlobalReachConnectionResult> InvokeAsync(GetGlobalReachConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGlobalReachConnectionResult>("azure-native:avs/v20210601:getGlobalReachConnection", args ?? new GetGlobalReachConnectionArgs(), options.WithVersion());
        ...
        public static Output<GetGlobalReachConnectionResult> Invoke(GetGlobalReachConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGlobalReachConnectionResult>("azure-native:avs/v20210601:getGlobalReachConnection", args ?? new GetGlobalReachConnectionInvokeArgs(), options.WithVersion());
    }
