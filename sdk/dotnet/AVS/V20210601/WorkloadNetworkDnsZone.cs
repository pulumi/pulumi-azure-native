...
namespace Pulumi.AzureNative.AVS.V20210601
{
    ...
    /// NSX DNS Zone
    /// </summary>
    [Obsolete(@"azure-native:avs/v20210601:WorkloadNetworkDnsZone is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkDnsZone to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:avs/v20210601:WorkloadNetworkDnsZone")]
    public partial class WorkloadNetworkDnsZone : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkDnsZone(string name, WorkloadNetworkDnsZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:WorkloadNetworkDnsZone", name, args ?? new WorkloadNetworkDnsZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkDnsZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:WorkloadNetworkDnsZone", name, null, MakeResourceOptions(options, id))
        {
        }
