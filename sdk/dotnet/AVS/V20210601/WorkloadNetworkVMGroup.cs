...
namespace Pulumi.AzureNative.AVS.V20210601
{
    ...
    [AzureNativeResourceType("azure-native:avs/v20210601:WorkloadNetworkVMGroup")]
    public partial class WorkloadNetworkVMGroup : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkVMGroup(string name, WorkloadNetworkVMGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:WorkloadNetworkVMGroup", name, args ?? new WorkloadNetworkVMGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkVMGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:WorkloadNetworkVMGroup", name, null, MakeResourceOptions(options, id))
        {
        }
