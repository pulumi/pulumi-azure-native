...
namespace Pulumi.AzureNative.AVS.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20210601:GlobalReachConnection")]
    public partial class GlobalReachConnection : Pulumi.CustomResource
    {
        ...
        public GlobalReachConnection(string name, GlobalReachConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:GlobalReachConnection", name, args ?? new GlobalReachConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalReachConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210601:GlobalReachConnection", name, null, MakeResourceOptions(options, id))
        {
        }
