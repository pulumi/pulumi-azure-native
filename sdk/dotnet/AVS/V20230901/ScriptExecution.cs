...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:ScriptExecution")]
    public partial class ScriptExecution : global::Pulumi.CustomResource
    {
        ...
        public ScriptExecution(string name, ScriptExecutionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:ScriptExecution", name, args ?? new ScriptExecutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScriptExecution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:ScriptExecution", name, null, MakeResourceOptions(options, id))
        {
        }
