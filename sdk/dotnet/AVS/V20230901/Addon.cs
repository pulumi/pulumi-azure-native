...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// An addon resource
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:Addon")]
    public partial class Addon : global::Pulumi.CustomResource
    {
        ...
        public Addon(string name, AddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:Addon", name, args ?? new AddonArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Addon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:Addon", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AddonArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AVS.V20230901.AddonType> AddonType { get; set; } = null!;
