...
namespace Pulumi.AzureNative.AVS.V20230901
{
    public static class GetAddon
    {
        ...
        public static Task<GetAddonResult> InvokeAsync(GetAddonArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAddonResult>("azure-native:avs/v20230901:getAddon", args ?? new GetAddonArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Addon
        /// </summary>
        public static Output<GetAddonResult> Invoke(GetAddonInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAddonResult>("azure-native:avs/v20230901:getAddon", args ?? new GetAddonInvokeArgs(), options.WithDefaults());
