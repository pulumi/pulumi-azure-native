...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:CloudLink")]
    public partial class CloudLink : global::Pulumi.CustomResource
    {
        ...
        public CloudLink(string name, CloudLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:CloudLink", name, args ?? new CloudLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:CloudLink", name, null, MakeResourceOptions(options, id))
        {
        }
