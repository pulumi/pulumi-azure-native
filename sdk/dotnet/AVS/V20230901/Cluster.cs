...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// A cluster resource
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
