...
namespace Pulumi.AzureNative.AVS.V20230901
{
    public static class GetScriptExecution
    {
        ...
        public static Task<GetScriptExecutionResult> InvokeAsync(GetScriptExecutionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScriptExecutionResult>("azure-native:avs/v20230901:getScriptExecution", args ?? new GetScriptExecutionArgs(), options.WithDefaults());

        /// <summary>
        /// Get a ScriptExecution
        /// </summary>
        public static Output<GetScriptExecutionResult> Invoke(GetScriptExecutionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScriptExecutionResult>("azure-native:avs/v20230901:getScriptExecution", args ?? new GetScriptExecutionInvokeArgs(), options.WithDefaults());
