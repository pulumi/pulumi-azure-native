...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// NSX VM Group
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:WorkloadNetworkVMGroup")]
    public partial class WorkloadNetworkVMGroup : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkVMGroup(string name, WorkloadNetworkVMGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:WorkloadNetworkVMGroup", name, args ?? new WorkloadNetworkVMGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkVMGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:WorkloadNetworkVMGroup", name, null, MakeResourceOptions(options, id))
        {
        }
