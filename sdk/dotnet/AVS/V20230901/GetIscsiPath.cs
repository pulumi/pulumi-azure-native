...
namespace Pulumi.AzureNative.AVS.V20230901
{
    public static class GetIscsiPath
    {
        ...
        public static Task<GetIscsiPathResult> InvokeAsync(GetIscsiPathArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIscsiPathResult>("azure-native:avs/v20230901:getIscsiPath", args ?? new GetIscsiPathArgs(), options.WithDefaults());
