...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:PrivateCloud")]
    public partial class PrivateCloud : global::Pulumi.CustomResource
    {
        ...
        public PrivateCloud(string name, PrivateCloudArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:PrivateCloud", name, args ?? new PrivateCloudArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateCloud(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:PrivateCloud", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateCloudArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dnsZoneType")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20230901.DnsZoneType>? DnsZoneType { get; set; }
        ...
        /// </summary>
        [Input("internet")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20230901.InternetEnum>? Internet { get; set; }
