...
namespace Pulumi.AzureNative.AVS.V20230901
{
    public static class ListClusterZones
    {
        ...
        public static Task<ListClusterZonesResult> InvokeAsync(ListClusterZonesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListClusterZonesResult>("azure-native:avs/v20230901:listClusterZones", args ?? new ListClusterZonesArgs(), options.WithDefaults());
