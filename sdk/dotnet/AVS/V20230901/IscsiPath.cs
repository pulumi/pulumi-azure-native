...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:IscsiPath")]
    public partial class IscsiPath : global::Pulumi.CustomResource
    {
        ...
        public IscsiPath(string name, IscsiPathArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:IscsiPath", name, args ?? new IscsiPathArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IscsiPath(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:IscsiPath", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:avs:IscsiPath" },
                },
            };
