...
namespace Pulumi.AzureNative.AVS.V20230901
{
    public static class GetAuthorization
    {
        ...
        public static Task<GetAuthorizationResult> InvokeAsync(GetAuthorizationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationResult>("azure-native:avs/v20230901:getAuthorization", args ?? new GetAuthorizationArgs(), options.WithDefaults());
