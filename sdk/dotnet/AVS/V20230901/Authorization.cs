...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:Authorization")]
    public partial class Authorization : global::Pulumi.CustomResource
    {
        ...
        public Authorization(string name, AuthorizationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:Authorization", name, args ?? new AuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Authorization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:Authorization", name, null, MakeResourceOptions(options, id))
        {
        }
