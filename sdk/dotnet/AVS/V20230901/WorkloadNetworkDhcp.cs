...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// NSX DHCP
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:WorkloadNetworkDhcp")]
    public partial class WorkloadNetworkDhcp : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkDhcp(string name, WorkloadNetworkDhcpArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:WorkloadNetworkDhcp", name, args ?? new WorkloadNetworkDhcpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkDhcp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:WorkloadNetworkDhcp", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkloadNetworkDhcpArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AVS.V20230901.DhcpTypeEnum> DhcpType { get; set; } = null!;
