...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:HcxEnterpriseSite")]
    public partial class HcxEnterpriseSite : global::Pulumi.CustomResource
    {
        ...
        public HcxEnterpriseSite(string name, HcxEnterpriseSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:HcxEnterpriseSite", name, args ?? new HcxEnterpriseSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HcxEnterpriseSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:HcxEnterpriseSite", name, null, MakeResourceOptions(options, id))
        {
        }
