...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:PlacementPolicy")]
    public partial class PlacementPolicy : global::Pulumi.CustomResource
    {
        ...
        public PlacementPolicy(string name, PlacementPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:PlacementPolicy", name, args ?? new PlacementPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PlacementPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:PlacementPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PlacementPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20230901.PlacementPolicyState>? State { get; set; }

        /// <summary>
        /// Placement Policy type
        /// </summary>
        [Input("type", required: true)]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20230901.PlacementPolicyType> Type { get; set; } = null!;
