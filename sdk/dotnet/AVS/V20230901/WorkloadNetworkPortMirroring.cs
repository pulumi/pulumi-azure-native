...
namespace Pulumi.AzureNative.AVS.V20230901
{
    ...
    /// NSX Port Mirroring
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230901:WorkloadNetworkPortMirroring")]
    public partial class WorkloadNetworkPortMirroring : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkPortMirroring(string name, WorkloadNetworkPortMirroringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:WorkloadNetworkPortMirroring", name, args ?? new WorkloadNetworkPortMirroringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkPortMirroring(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230901:WorkloadNetworkPortMirroring", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkloadNetworkPortMirroringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20230901.PortMirroringDirectionEnum>? Direction { get; set; }
