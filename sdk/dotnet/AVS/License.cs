...
namespace Pulumi.AzureNative.AVS
{
    ...
    public partial class License : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VmwareFirewallLicensePropertiesResponse> Properties { get; private set; } = null!;
        ...
        public License(string name, LicenseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs:License", name, args ?? new LicenseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private License(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs:License", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:avs/v20250901:License" },
                },
            };
    ...
    public sealed class LicenseArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.VmwareFirewallLicensePropertiesArgs>? Properties { get; set; }
