...
namespace Pulumi.AzureNative.AVS.V20230301
{
    ...
    /// NSX Port Mirroring
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230301:WorkloadNetworkPortMirroring")]
    public partial class WorkloadNetworkPortMirroring : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkPortMirroring(string name, WorkloadNetworkPortMirroringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:WorkloadNetworkPortMirroring", name, args ?? new WorkloadNetworkPortMirroringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkPortMirroring(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:WorkloadNetworkPortMirroring", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkloadNetworkPortMirroringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20230301.PortMirroringDirectionEnum>? Direction { get; set; }
