...
namespace Pulumi.AzureNative.AVS.V20230301
{
    ...
    /// NSX DHCP
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230301:WorkloadNetworkDhcp")]
    public partial class WorkloadNetworkDhcp : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkDhcp(string name, WorkloadNetworkDhcpArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:WorkloadNetworkDhcp", name, args ?? new WorkloadNetworkDhcpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkDhcp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:WorkloadNetworkDhcp", name, null, MakeResourceOptions(options, id))
        {
        }
