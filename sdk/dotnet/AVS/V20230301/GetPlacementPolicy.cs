...
namespace Pulumi.AzureNative.AVS.V20230301
{
    public static class GetPlacementPolicy
    {
        ...
        public static Task<GetPlacementPolicyResult> InvokeAsync(GetPlacementPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPlacementPolicyResult>("azure-native:avs/v20230301:getPlacementPolicy", args ?? new GetPlacementPolicyArgs(), options.WithDefaults());
