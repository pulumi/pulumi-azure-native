...
namespace Pulumi.AzureNative.AVS.V20230301
{
    ...
    /// A cluster resource
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230301:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
