...
namespace Pulumi.AzureNative.AVS.V20230301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230301:PrivateCloud")]
    public partial class PrivateCloud : global::Pulumi.CustomResource
    {
        ...
        public PrivateCloud(string name, PrivateCloudArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:PrivateCloud", name, args ?? new PrivateCloudArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateCloud(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:PrivateCloud", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateCloudArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("internet")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20230301.InternetEnum>? Internet { get; set; }
