...
namespace Pulumi.AzureNative.AVS.V20230301
{
    ...
    /// NSX Public IP Block
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230301:WorkloadNetworkPublicIP")]
    public partial class WorkloadNetworkPublicIP : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkPublicIP(string name, WorkloadNetworkPublicIPArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:WorkloadNetworkPublicIP", name, args ?? new WorkloadNetworkPublicIPArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkPublicIP(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:WorkloadNetworkPublicIP", name, null, MakeResourceOptions(options, id))
        {
        }
