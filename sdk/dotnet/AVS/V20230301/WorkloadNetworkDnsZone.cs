...
namespace Pulumi.AzureNative.AVS.V20230301
{
    ...
    /// NSX DNS Zone
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230301:WorkloadNetworkDnsZone")]
    public partial class WorkloadNetworkDnsZone : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkDnsZone(string name, WorkloadNetworkDnsZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:WorkloadNetworkDnsZone", name, args ?? new WorkloadNetworkDnsZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkDnsZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:WorkloadNetworkDnsZone", name, null, MakeResourceOptions(options, id))
        {
        }
