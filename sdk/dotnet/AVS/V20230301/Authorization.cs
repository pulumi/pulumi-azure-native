...
namespace Pulumi.AzureNative.AVS.V20230301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230301:Authorization")]
    public partial class Authorization : global::Pulumi.CustomResource
    {
        ...
        public Authorization(string name, AuthorizationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:Authorization", name, args ?? new AuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Authorization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:Authorization", name, null, MakeResourceOptions(options, id))
        {
        }
