...
namespace Pulumi.AzureNative.AVS.V20230301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20230301:GlobalReachConnection")]
    public partial class GlobalReachConnection : global::Pulumi.CustomResource
    {
        ...
        public GlobalReachConnection(string name, GlobalReachConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:GlobalReachConnection", name, args ?? new GlobalReachConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalReachConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20230301:GlobalReachConnection", name, null, MakeResourceOptions(options, id))
        {
        }
