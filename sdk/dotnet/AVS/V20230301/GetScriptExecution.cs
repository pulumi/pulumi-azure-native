...
namespace Pulumi.AzureNative.AVS.V20230301
{
    public static class GetScriptExecution
    {
        ...
        public static Task<GetScriptExecutionResult> InvokeAsync(GetScriptExecutionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScriptExecutionResult>("azure-native:avs/v20230301:getScriptExecution", args ?? new GetScriptExecutionArgs(), options.WithDefaults());

        /// <summary>
        /// An instance of a script executed by a user - custom or AVS
        /// </summary>
        public static Output<GetScriptExecutionResult> Invoke(GetScriptExecutionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScriptExecutionResult>("azure-native:avs/v20230301:getScriptExecution", args ?? new GetScriptExecutionInvokeArgs(), options.WithDefaults());
    }
