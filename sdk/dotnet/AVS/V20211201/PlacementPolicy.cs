...
namespace Pulumi.AzureNative.AVS.V20211201
{
    ...
    /// {
    ///     var placementPolicy = new AzureNative.AVS.V20211201.PlacementPolicy("placementPolicy", new()
    ///     {
    ///         ClusterName = "cluster1",
    ///         PlacementPolicyName = "policy1",
    ///         PrivateCloudName = "cloud1",
    ///         Properties = new AzureNative.AVS.V20211201.Inputs.VmHostPlacementPolicyPropertiesArgs
    ///         {
    ...
    public partial class PlacementPolicy : global::Pulumi.CustomResource
    {
        ...
        public PlacementPolicy(string name, PlacementPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:PlacementPolicy", name, args ?? new PlacementPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PlacementPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:PlacementPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
