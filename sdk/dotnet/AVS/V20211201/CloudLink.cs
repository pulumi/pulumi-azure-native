...
namespace Pulumi.AzureNative.AVS.V20211201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:avs/v20211201:CloudLink is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:CloudLink to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:avs/v20211201:CloudLink")]
    public partial class CloudLink : global::Pulumi.CustomResource
    {
        ...
        public CloudLink(string name, CloudLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:CloudLink", name, args ?? new CloudLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:CloudLink", name, null, MakeResourceOptions(options, id))
        {
        }
