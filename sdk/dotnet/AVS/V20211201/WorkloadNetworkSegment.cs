...
namespace Pulumi.AzureNative.AVS.V20211201
{
    ...
    /// NSX Segment
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20211201:WorkloadNetworkSegment")]
    public partial class WorkloadNetworkSegment : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkSegment(string name, WorkloadNetworkSegmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:WorkloadNetworkSegment", name, args ?? new WorkloadNetworkSegmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkSegment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:WorkloadNetworkSegment", name, null, MakeResourceOptions(options, id))
        {
        }
