...
namespace Pulumi.AzureNative.AVS.V20211201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:avs/v20211201:ScriptExecution is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:ScriptExecution to guarantee forwards compatibility.")]
    ...
    public partial class ScriptExecution : global::Pulumi.CustomResource
    {
        ...
        public ScriptExecution(string name, ScriptExecutionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:ScriptExecution", name, args ?? new ScriptExecutionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScriptExecution(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:ScriptExecution", name, null, MakeResourceOptions(options, id))
        {
        }
