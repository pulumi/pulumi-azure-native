...
namespace Pulumi.AzureNative.AVS.V20211201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:avs/v20211201:GlobalReachConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:GlobalReachConnection to guarantee forwards compatibility.")]
    ...
    public partial class GlobalReachConnection : global::Pulumi.CustomResource
    {
        ...
        public GlobalReachConnection(string name, GlobalReachConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:GlobalReachConnection", name, args ?? new GlobalReachConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalReachConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:GlobalReachConnection", name, null, MakeResourceOptions(options, id))
        {
        }
