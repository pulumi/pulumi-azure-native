...
namespace Pulumi.AzureNative.AVS.V20211201
{
    ...
    /// NSX VM Group
    /// </summary>
    [Obsolete(@"azure-native:avs/v20211201:WorkloadNetworkVMGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkVMGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:avs/v20211201:WorkloadNetworkVMGroup")]
    public partial class WorkloadNetworkVMGroup : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkVMGroup(string name, WorkloadNetworkVMGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:WorkloadNetworkVMGroup", name, args ?? new WorkloadNetworkVMGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkVMGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:WorkloadNetworkVMGroup", name, null, MakeResourceOptions(options, id))
        {
        }
