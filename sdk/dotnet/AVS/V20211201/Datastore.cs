...
namespace Pulumi.AzureNative.AVS.V20211201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:avs/v20211201:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:Datastore to guarantee forwards compatibility.")]
    ...
    public partial class Datastore : global::Pulumi.CustomResource
    {
        ...
        public Datastore(string name, DatastoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:Datastore", name, args ?? new DatastoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Datastore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20211201:Datastore", name, null, MakeResourceOptions(options, id))
        {
        }
