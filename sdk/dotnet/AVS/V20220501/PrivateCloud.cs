...
namespace Pulumi.AzureNative.AVS.V20220501
{
    ...
    /// {
    ///     var privateCloud = new AzureNative.AVS.V20220501.PrivateCloud("privateCloud", new()
    ///     {
    ///         Identity = new AzureNative.AVS.V20220501.Inputs.PrivateCloudIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Location = "eastus2",
    ///         ManagementCluster = new AzureNative.AVS.V20220501.Inputs.ManagementClusterArgs
    ///         {
    ///             ClusterSize = 4,
    ///         },
    ...
    ///     var privateCloud = new AzureNative.AVS.V20220501.PrivateCloud("privateCloud", new()
    ///     {
    ///         Availability = new AzureNative.AVS.V20220501.Inputs.AvailabilityPropertiesArgs
    ///         {
    ///             SecondaryZone = 2,
    ///             Strategy = "DualZone",
    ///             Zone = 1,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20220501:PrivateCloud")]
    public partial class PrivateCloud : global::Pulumi.CustomResource
    {
        ...
        public PrivateCloud(string name, PrivateCloudArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:PrivateCloud", name, args ?? new PrivateCloudArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateCloud(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:PrivateCloud", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateCloudArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("internet")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20220501.InternetEnum>? Internet { get; set; }
