...
namespace Pulumi.AzureNative.AVS.V20220501
{
    public static class GetCloudLink
    {
        ...
        public static Task<GetCloudLinkResult> InvokeAsync(GetCloudLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCloudLinkResult>("azure-native:avs/v20220501:getCloudLink", args ?? new GetCloudLinkArgs(), options.WithDefaults());

        /// <summary>
        /// A cloud link resource
        /// </summary>
        public static Output<GetCloudLinkResult> Invoke(GetCloudLinkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCloudLinkResult>("azure-native:avs/v20220501:getCloudLink", args ?? new GetCloudLinkInvokeArgs(), options.WithDefaults());
