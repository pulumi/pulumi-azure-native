...
namespace Pulumi.AzureNative.AVS.V20220501
{
    ...
    /// {
    ///     var hcxEnterpriseSite = new AzureNative.AVS.V20220501.HcxEnterpriseSite("hcxEnterpriseSite", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:avs/v20220501:HcxEnterpriseSite site1 /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/group1/providers/Microsoft.AVS/privateClouds/cloud1/hcxEnterpriseSites/site1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20220501:HcxEnterpriseSite")]
    public partial class HcxEnterpriseSite : global::Pulumi.CustomResource
    {
        ...
        public HcxEnterpriseSite(string name, HcxEnterpriseSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:HcxEnterpriseSite", name, args ?? new HcxEnterpriseSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HcxEnterpriseSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:HcxEnterpriseSite", name, null, MakeResourceOptions(options, id))
        {
        }
