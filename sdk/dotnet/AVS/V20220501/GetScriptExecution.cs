...
namespace Pulumi.AzureNative.AVS.V20220501
{
    public static class GetScriptExecution
    {
        ...
        public static Task<GetScriptExecutionResult> InvokeAsync(GetScriptExecutionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScriptExecutionResult>("azure-native:avs/v20220501:getScriptExecution", args ?? new GetScriptExecutionArgs(), options.WithDefaults());
