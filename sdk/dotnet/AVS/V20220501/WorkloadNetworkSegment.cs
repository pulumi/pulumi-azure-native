...
namespace Pulumi.AzureNative.AVS.V20220501
{
    ...
    /// {
    ///     var workloadNetworkSegment = new AzureNative.AVS.V20220501.WorkloadNetworkSegment("workloadNetworkSegment", new()
    ///     {
    ...
    ///         Revision = 1,
    ///         SegmentId = "segment1",
    ///         Subnet = new AzureNative.AVS.V20220501.Inputs.WorkloadNetworkSegmentSubnetArgs
    ///         {
    ///             DhcpRanges = new[]
    ///             {
    ///                 "40.20.0.0-40.20.0.1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20220501:WorkloadNetworkSegment")]
    public partial class WorkloadNetworkSegment : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkSegment(string name, WorkloadNetworkSegmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:WorkloadNetworkSegment", name, args ?? new WorkloadNetworkSegmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkSegment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:WorkloadNetworkSegment", name, null, MakeResourceOptions(options, id))
        {
        }
