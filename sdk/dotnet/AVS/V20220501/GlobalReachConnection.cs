...
namespace Pulumi.AzureNative.AVS.V20220501
{
    ...
    /// {
    ///     var globalReachConnection = new AzureNative.AVS.V20220501.GlobalReachConnection("globalReachConnection", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20220501:GlobalReachConnection")]
    public partial class GlobalReachConnection : global::Pulumi.CustomResource
    {
        ...
        public GlobalReachConnection(string name, GlobalReachConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:GlobalReachConnection", name, args ?? new GlobalReachConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalReachConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:GlobalReachConnection", name, null, MakeResourceOptions(options, id))
        {
        }
