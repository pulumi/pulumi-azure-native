...
namespace Pulumi.AzureNative.AVS.V20220501
{
    ...
    /// {
    ///     var cloudLink = new AzureNative.AVS.V20220501.CloudLink("cloudLink", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20220501:CloudLink")]
    public partial class CloudLink : global::Pulumi.CustomResource
    {
        ...
        public CloudLink(string name, CloudLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:CloudLink", name, args ?? new CloudLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:CloudLink", name, null, MakeResourceOptions(options, id))
        {
        }
