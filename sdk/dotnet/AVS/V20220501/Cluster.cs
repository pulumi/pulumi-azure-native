...
namespace Pulumi.AzureNative.AVS.V20220501
{
    ...
    /// {
    ///     var cluster = new AzureNative.AVS.V20220501.Cluster("cluster", new()
    ///     {
    ///         ClusterName = "cluster1",
    ///         ClusterSize = 3,
    ///         PrivateCloudName = "cloud1",
    ///         ResourceGroupName = "group1",
    ///         Sku = new AzureNative.AVS.V20220501.Inputs.SkuArgs
    ///         {
    ///             Name = "AV20",
    ///         },
    ///     });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:avs/v20220501:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20220501:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
