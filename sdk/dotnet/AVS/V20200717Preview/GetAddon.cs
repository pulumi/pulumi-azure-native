...
{
    [Obsolete(@"azure-native:avs/v20200717preview:Addon is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20210101preview:Addon to guarantee forwards compatibility.")]
    public static class GetAddon
    {
        ...
        public static Task<GetAddonResult> InvokeAsync(GetAddonArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAddonResult>("azure-native:avs/v20200717preview:getAddon", args ?? new GetAddonArgs(), options.WithDefaults());

        /// <summary>
        /// An addon resource
        /// </summary>
        public static Output<GetAddonResult> Invoke(GetAddonInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAddonResult>("azure-native:avs/v20200717preview:getAddon", args ?? new GetAddonInvokeArgs(), options.WithDefaults());
    }
