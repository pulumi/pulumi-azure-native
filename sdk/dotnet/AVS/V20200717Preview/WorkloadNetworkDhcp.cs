...
namespace Pulumi.AzureNative.AVS.V20200717Preview
{
    ...
    /// {
    ///     var workloadNetworkDhcp = new AzureNative.AVS.V20200717Preview.WorkloadNetworkDhcp("workloadNetworkDhcp", new()
    ///     {
    ///         DhcpId = "dhcp1",
    ///         DhcpType = "SERVER",
    ...
    public partial class WorkloadNetworkDhcp : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkDhcp(string name, WorkloadNetworkDhcpArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20200717preview:WorkloadNetworkDhcp", name, args ?? new WorkloadNetworkDhcpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkDhcp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20200717preview:WorkloadNetworkDhcp", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkloadNetworkDhcpArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AVS.V20200717Preview.DhcpTypeEnum> DhcpType { get; set; } = null!;
