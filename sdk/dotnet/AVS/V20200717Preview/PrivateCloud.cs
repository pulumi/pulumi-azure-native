...
namespace Pulumi.AzureNextGen.AVS.V20200717Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:avs/v20200717preview:PrivateCloud")]
    public partial class PrivateCloud : Pulumi.CustomResource
    {
        ...
        public PrivateCloud(string name, PrivateCloudArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20200717preview:PrivateCloud", name, args ?? new PrivateCloudArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateCloud(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20200717preview:PrivateCloud", name, null, MakeResourceOptions(options, id))
        {
        }
