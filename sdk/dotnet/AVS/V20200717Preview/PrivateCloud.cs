...
namespace Pulumi.AzureNative.AVS.V20200717Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:avs/v20200717preview:PrivateCloud is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:PrivateCloud to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:avs/v20200717preview:PrivateCloud")]
    public partial class PrivateCloud : global::Pulumi.CustomResource
    {
        ...
        public PrivateCloud(string name, PrivateCloudArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20200717preview:PrivateCloud", name, args ?? new PrivateCloudArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateCloud(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20200717preview:PrivateCloud", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateCloudArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("internet")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20200717Preview.InternetEnum>? Internet { get; set; }
