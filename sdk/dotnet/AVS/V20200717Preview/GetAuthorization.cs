...
namespace Pulumi.AzureNative.AVS.V20200717Preview
{
    public static class GetAuthorization
    {
        ...
        public static Task<GetAuthorizationResult> InvokeAsync(GetAuthorizationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationResult>("azure-native:avs/v20200717preview:getAuthorization", args ?? new GetAuthorizationArgs(), options.WithVersion());

        /// <summary>
        /// ExpressRoute Circuit Authorization
        /// </summary>
        public static Output<GetAuthorizationResult> Invoke(GetAuthorizationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAuthorizationResult>("azure-native:avs/v20200717preview:getAuthorization", args ?? new GetAuthorizationInvokeArgs(), options.WithVersion());
    }
