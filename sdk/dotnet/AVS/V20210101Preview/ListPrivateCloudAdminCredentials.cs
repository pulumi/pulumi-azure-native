...
namespace Pulumi.AzureNative.AVS.V20210101Preview
{
    public static class ListPrivateCloudAdminCredentials
    {
        ...
        public static Output<ListPrivateCloudAdminCredentialsResult> Invoke(ListPrivateCloudAdminCredentialsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListPrivateCloudAdminCredentialsResult>("azure-native:avs/v20210101preview:listPrivateCloudAdminCredentials", args ?? new ListPrivateCloudAdminCredentialsInvokeArgs(), options.WithVersion());
    }
