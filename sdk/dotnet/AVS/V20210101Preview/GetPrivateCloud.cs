...
namespace Pulumi.AzureNextGen.AVS.V20210101Preview
{
    public static class GetPrivateCloud
    {
        ...
        public static Task<GetPrivateCloudResult> InvokeAsync(GetPrivateCloudArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateCloudResult>("azure-nextgen:avs/v20210101preview:getPrivateCloud", args ?? new GetPrivateCloudArgs(), options.WithVersion());
    }
