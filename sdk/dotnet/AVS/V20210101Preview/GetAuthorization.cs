...
namespace Pulumi.AzureNative.AVS.V20210101Preview
{
    public static class GetAuthorization
    {
        ...
        public static Task<GetAuthorizationResult> InvokeAsync(GetAuthorizationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationResult>("azure-native:avs/v20210101preview:getAuthorization", args ?? new GetAuthorizationArgs(), options.WithDefaults());

        /// <summary>
        /// ExpressRoute Circuit Authorization
        /// </summary>
        public static Output<GetAuthorizationResult> Invoke(GetAuthorizationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAuthorizationResult>("azure-native:avs/v20210101preview:getAuthorization", args ?? new GetAuthorizationInvokeArgs(), options.WithDefaults());
    }
