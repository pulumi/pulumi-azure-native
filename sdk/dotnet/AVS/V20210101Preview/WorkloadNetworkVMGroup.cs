...
namespace Pulumi.AzureNextGen.AVS.V20210101Preview
{
    ...
    /// NSX VM Group
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:avs/v20210101preview:WorkloadNetworkVMGroup")]
    public partial class WorkloadNetworkVMGroup : Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkVMGroup(string name, WorkloadNetworkVMGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:WorkloadNetworkVMGroup", name, args ?? new WorkloadNetworkVMGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkVMGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:WorkloadNetworkVMGroup", name, null, MakeResourceOptions(options, id))
        {
        }
