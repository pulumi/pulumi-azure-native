...
namespace Pulumi.AzureNative.AVS.V20210101Preview
{
    ...
    /// NSX VM Group
    /// </summary>
    [Obsolete(@"azure-native:avs/v20210101preview:WorkloadNetworkVMGroup is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkVMGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:avs/v20210101preview:WorkloadNetworkVMGroup")]
    public partial class WorkloadNetworkVMGroup : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkVMGroup(string name, WorkloadNetworkVMGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210101preview:WorkloadNetworkVMGroup", name, args ?? new WorkloadNetworkVMGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkVMGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210101preview:WorkloadNetworkVMGroup", name, null, MakeResourceOptions(options, id))
        {
        }
