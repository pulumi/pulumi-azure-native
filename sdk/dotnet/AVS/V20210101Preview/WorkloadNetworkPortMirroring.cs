...
namespace Pulumi.AzureNextGen.AVS.V20210101Preview
{
    ...
    /// NSX Port Mirroring
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:avs/v20210101preview:WorkloadNetworkPortMirroring")]
    public partial class WorkloadNetworkPortMirroring : Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkPortMirroring(string name, WorkloadNetworkPortMirroringArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:WorkloadNetworkPortMirroring", name, args ?? new WorkloadNetworkPortMirroringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkPortMirroring(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:WorkloadNetworkPortMirroring", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkloadNetworkPortMirroringArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNextGen.AVS.V20210101Preview.PortMirroringDirectionEnum>? Direction { get; set; }
