...
namespace Pulumi.AzureNative.AVS.V20210101Preview
{
    ...
    /// NSX Port Mirroring
    /// </summary>
    [Obsolete(@"azure-native:avs/v20210101preview:WorkloadNetworkPortMirroring is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkPortMirroring to guarantee forwards compatibility.")]
    ...
    public partial class WorkloadNetworkPortMirroring : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkPortMirroring(string name, WorkloadNetworkPortMirroringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210101preview:WorkloadNetworkPortMirroring", name, args ?? new WorkloadNetworkPortMirroringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkPortMirroring(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210101preview:WorkloadNetworkPortMirroring", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkloadNetworkPortMirroringArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("direction")]
        public InputUnion<string, Pulumi.AzureNative.AVS.V20210101Preview.PortMirroringDirectionEnum>? Direction { get; set; }
