...
namespace Pulumi.AzureNextGen.AVS.V20210101Preview
{
    ...
    /// NSX DNS Zone
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:avs/v20210101preview:WorkloadNetworkDnsZone")]
    public partial class WorkloadNetworkDnsZone : Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkDnsZone(string name, WorkloadNetworkDnsZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:WorkloadNetworkDnsZone", name, args ?? new WorkloadNetworkDnsZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkDnsZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:WorkloadNetworkDnsZone", name, null, MakeResourceOptions(options, id))
        {
        }
