...
namespace Pulumi.AzureNative.AVS.V20210101Preview
{
    ...
    public partial class WorkloadNetworkDnsZone : global::Pulumi.CustomResource
    {
        ...
        public WorkloadNetworkDnsZone(string name, WorkloadNetworkDnsZoneArgs args, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210101preview:WorkloadNetworkDnsZone", name, args ?? new WorkloadNetworkDnsZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkloadNetworkDnsZone(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:avs/v20210101preview:WorkloadNetworkDnsZone", name, null, MakeResourceOptions(options, id))
        {
        }
