...
namespace Pulumi.AzureNextGen.AVS.V20210101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:avs/v20210101preview:PrivateCloud")]
    public partial class PrivateCloud : Pulumi.CustomResource
    {
        ...
        public PrivateCloud(string name, PrivateCloudArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:PrivateCloud", name, args ?? new PrivateCloudArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateCloud(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:PrivateCloud", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateCloudArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("internet")]
        public InputUnion<string, Pulumi.AzureNextGen.AVS.V20210101Preview.InternetEnum>? Internet { get; set; }
