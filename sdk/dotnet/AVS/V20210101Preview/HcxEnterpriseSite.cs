...
namespace Pulumi.AzureNextGen.AVS.V20210101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:avs/v20210101preview:HcxEnterpriseSite")]
    public partial class HcxEnterpriseSite : Pulumi.CustomResource
    {
        ...
        public HcxEnterpriseSite(string name, HcxEnterpriseSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:HcxEnterpriseSite", name, args ?? new HcxEnterpriseSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HcxEnterpriseSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:HcxEnterpriseSite", name, null, MakeResourceOptions(options, id))
        {
        }
