...
namespace Pulumi.AzureNextGen.AVS.V20210101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:avs/v20210101preview:GlobalReachConnection")]
    public partial class GlobalReachConnection : Pulumi.CustomResource
    {
        ...
        public GlobalReachConnection(string name, GlobalReachConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:GlobalReachConnection", name, args ?? new GlobalReachConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalReachConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:avs/v20210101preview:GlobalReachConnection", name, null, MakeResourceOptions(options, id))
        {
        }
