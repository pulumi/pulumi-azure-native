...
namespace Pulumi.AzureNative.CodeSigning.V20240205Preview
{
    public static class GetCertificateProfile
    {
        ...
        public static Task<GetCertificateProfileResult> InvokeAsync(GetCertificateProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificateProfileResult>("azure-native:codesigning/v20240205preview:getCertificateProfile", args ?? new GetCertificateProfileArgs(), options.WithDefaults());
