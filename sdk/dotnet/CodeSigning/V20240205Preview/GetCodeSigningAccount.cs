...
namespace Pulumi.AzureNative.CodeSigning.V20240205Preview
{
    public static class GetCodeSigningAccount
    {
        ...
        public static Task<GetCodeSigningAccountResult> InvokeAsync(GetCodeSigningAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCodeSigningAccountResult>("azure-native:codesigning/v20240205preview:getCodeSigningAccount", args ?? new GetCodeSigningAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Get a trusted Signing Account.
        /// </summary>
        public static Output<GetCodeSigningAccountResult> Invoke(GetCodeSigningAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCodeSigningAccountResult>("azure-native:codesigning/v20240205preview:getCodeSigningAccount", args ?? new GetCodeSigningAccountInvokeArgs(), options.WithDefaults());
