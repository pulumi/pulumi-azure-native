...
namespace Pulumi.AzureNative.CodeSigning.V20240930Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:codesigning/v20240930preview:CertificateProfile")]
    public partial class CertificateProfile : global::Pulumi.CustomResource
    {
        ...
        public CertificateProfile(string name, CertificateProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:codesigning/v20240930preview:CertificateProfile", name, args ?? new CertificateProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CertificateProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:codesigning/v20240930preview:CertificateProfile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CertificateProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.CodeSigning.V20240930Preview.ProfileType> ProfileType { get; set; } = null!;
