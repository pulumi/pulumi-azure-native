...
namespace Pulumi.AzureRM.IoTSpaces.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var ioTSpace = new AzureRM.IoTSpaces.Latest.IoTSpace("ioTSpace", new AzureRM.IoTSpaces.Latest.IoTSpaceArgs
    ///         {
    ///             Location = "string",
    ///             ResourceGroupName = "resRg",
    ///             ResourceName = "myIoTSpacesService",
    ///             Sku = new AzureRM.IoTSpaces.Latest.Inputs.IoTSpacesSkuInfoArgs
    ///             {
    ///                 Name = "F1",
    ///             },
    ///         });
    ...
    public partial class IoTSpace : Pulumi.CustomResource
    {
        ...
        public IoTSpace(string name, IoTSpaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:iotspaces/latest:IoTSpace", name, args ?? new IoTSpaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IoTSpace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:iotspaces/latest:IoTSpace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:iotspaces/v20171001preview:IoTSpace"},
                },
            };
