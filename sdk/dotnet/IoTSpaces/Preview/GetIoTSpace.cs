...
namespace Pulumi.AzureRM.IoTSpaces.Preview
{
    public static class GetIoTSpace
    {
        public static Task<GetIoTSpaceResult> InvokeAsync(GetIoTSpaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIoTSpaceResult>("azurerm:iotspaces/preview:getIoTSpace", args ?? new GetIoTSpaceArgs(), options.WithVersion());
    }
