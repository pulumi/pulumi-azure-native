...
namespace Pulumi.AzureRM.IoTSpaces.Preview
{
    ...
    public partial class IoTSpace : Pulumi.CustomResource
    {
        ...
        public IoTSpace(string name, IoTSpaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:iotspaces/preview:IoTSpace", name, args ?? new IoTSpaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IoTSpace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:iotspaces/preview:IoTSpace", name, null, MakeResourceOptions(options, id))
        {
        }
