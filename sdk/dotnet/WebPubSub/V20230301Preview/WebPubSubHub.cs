...
namespace Pulumi.AzureNative.WebPubSub.V20230301Preview
{
    ...
    /// {
    ///     var webPubSubHub = new AzureNative.WebPubSub.V20230301Preview.WebPubSubHub("webPubSubHub", new()
    ///     {
    ///         HubName = "exampleHub",
    ///         Properties = new AzureNative.WebPubSub.V20230301Preview.Inputs.WebPubSubHubPropertiesArgs
    ///         {
    ///             AnonymousConnectPolicy = "allow",
    ///             EventHandlers = new[]
    ///             {
    ///                 new AzureNative.WebPubSub.V20230301Preview.Inputs.EventHandlerArgs
    ///                 {
    ///                     Auth = new AzureNative.WebPubSub.V20230301Preview.Inputs.UpstreamAuthSettingsArgs
    ///                     {
    ///                         ManagedIdentity = new AzureNative.WebPubSub.V20230301Preview.Inputs.ManagedIdentitySettingsArgs
    ///                         {
    ///                             Resource = "abc",
    ///                         },
    ...
    ///             EventListeners = new[]
    ///             {
    ///                 new AzureNative.WebPubSub.V20230301Preview.Inputs.EventListenerArgs
    ///                 {
    ///                     Endpoint = 
    ///                     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:webpubsub/v20230301preview:WebPubSubHub exampleHub /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/Microsoft.SignalRService/WebPubSub/myWebPubSubService/hubs/exampleHub 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20230301preview:WebPubSubHub")]
    public partial class WebPubSubHub : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubHub(string name, WebPubSubHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230301preview:WebPubSubHub", name, args ?? new WebPubSubHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230301preview:WebPubSubHub", name, null, MakeResourceOptions(options, id))
        {
        }
