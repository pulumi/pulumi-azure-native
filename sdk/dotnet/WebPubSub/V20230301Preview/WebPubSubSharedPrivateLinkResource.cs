...
namespace Pulumi.AzureNative.WebPubSub.V20230301Preview
{
    ...
    /// {
    ///     var webPubSubSharedPrivateLinkResource = new AzureNative.WebPubSub.V20230301Preview.WebPubSubSharedPrivateLinkResource("webPubSubSharedPrivateLinkResource", new()
    ///     {
    ///         GroupId = "sites",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20230301preview:WebPubSubSharedPrivateLinkResource")]
    public partial class WebPubSubSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubSharedPrivateLinkResource(string name, WebPubSubSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230301preview:WebPubSubSharedPrivateLinkResource", name, args ?? new WebPubSubSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230301preview:WebPubSubSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
