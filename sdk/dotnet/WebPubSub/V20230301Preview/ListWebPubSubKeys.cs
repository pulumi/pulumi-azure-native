...
namespace Pulumi.AzureNative.WebPubSub.V20230301Preview
{
    public static class ListWebPubSubKeys
    {
        ...
        public static Task<ListWebPubSubKeysResult> InvokeAsync(ListWebPubSubKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWebPubSubKeysResult>("azure-native:webpubsub/v20230301preview:listWebPubSubKeys", args ?? new ListWebPubSubKeysArgs(), options.WithDefaults());
