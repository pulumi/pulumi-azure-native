...
namespace Pulumi.AzureNative.WebPubSub
{
    ...
    public partial class WebPubSubCustomCertificate : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubCustomCertificate(string name, WebPubSubCustomCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub:WebPubSubCustomCertificate", name, args ?? new WebPubSubCustomCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubCustomCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub:WebPubSubCustomCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:webpubsub/v20250101preview:WebPubSubCustomCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native:webpubsub/v20250801preview:WebPubSubCustomCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native:webpubsub/v20251201preview:WebPubSubCustomCertificate" },
                },
            };
