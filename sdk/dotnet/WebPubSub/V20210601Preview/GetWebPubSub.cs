...
namespace Pulumi.AzureNative.WebPubSub.V20210601Preview
{
    public static class GetWebPubSub
    {
        ...
        public static Task<GetWebPubSubResult> InvokeAsync(GetWebPubSubArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebPubSubResult>("azure-native:webpubsub/v20210601preview:getWebPubSub", args ?? new GetWebPubSubArgs(), options.WithDefaults());

        /// <summary>
        /// Get the resource and its properties.
        /// </summary>
        public static Output<GetWebPubSubResult> Invoke(GetWebPubSubInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebPubSubResult>("azure-native:webpubsub/v20210601preview:getWebPubSub", args ?? new GetWebPubSubInvokeArgs(), options.WithDefaults());
