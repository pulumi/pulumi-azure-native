...
namespace Pulumi.AzureNative.WebPubSub.V20241001Preview
{
    ...
    /// A hub setting
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20241001preview:WebPubSubHub")]
    public partial class WebPubSubHub : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubHub(string name, WebPubSubHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20241001preview:WebPubSubHub", name, args ?? new WebPubSubHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20241001preview:WebPubSubHub", name, null, MakeResourceOptions(options, id))
        {
        }
