...
namespace Pulumi.AzureNative.WebPubSub.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20241001preview:WebPubSubSharedPrivateLinkResource")]
    public partial class WebPubSubSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubSharedPrivateLinkResource(string name, WebPubSubSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20241001preview:WebPubSubSharedPrivateLinkResource", name, args ?? new WebPubSubSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20241001preview:WebPubSubSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
