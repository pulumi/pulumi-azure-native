...
namespace Pulumi.AzureNative.WebPubSub.V20241001Preview
{
    ...
    [EnumType]
    public readonly struct ClientTrafficControlRuleDiscriminator : IEquatable<ClientTrafficControlRuleDiscriminator>
    {
        private readonly string _value;

        private ClientTrafficControlRuleDiscriminator(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static ClientTrafficControlRuleDiscriminator TrafficThrottleByJwtSignatureRule { get; } = new ClientTrafficControlRuleDiscriminator("TrafficThrottleByJwtSignatureRule");
        public static ClientTrafficControlRuleDiscriminator TrafficThrottleByUserIdRule { get; } = new ClientTrafficControlRuleDiscriminator("TrafficThrottleByUserIdRule");
        public static ClientTrafficControlRuleDiscriminator TrafficThrottleByJwtCustomClaimRule { get; } = new ClientTrafficControlRuleDiscriminator("TrafficThrottleByJwtCustomClaimRule");
        ...
        public static explicit operator string(ClientTrafficControlRuleDiscriminator value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ClientTrafficControlRuleDiscriminator other && Equals(other);
        public bool Equals(ClientTrafficControlRuleDiscriminator other) => string.Equals(_value, other._value, StringComparison.Ordinal);
