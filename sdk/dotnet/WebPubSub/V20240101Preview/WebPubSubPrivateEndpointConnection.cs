...
namespace Pulumi.AzureNative.WebPubSub.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20240101preview:WebPubSubPrivateEndpointConnection")]
    public partial class WebPubSubPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubPrivateEndpointConnection(string name, WebPubSubPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240101preview:WebPubSubPrivateEndpointConnection", name, args ?? new WebPubSubPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240101preview:WebPubSubPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
