...
namespace Pulumi.AzureNative.WebPubSub.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20240101preview:WebPubSub")]
    public partial class WebPubSub : global::Pulumi.CustomResource
    {
        ...
        public WebPubSub(string name, WebPubSubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240101preview:WebPubSub", name, args ?? new WebPubSubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240101preview:WebPubSub", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebPubSubArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.WebPubSub.V20240101Preview.ServiceKind>? Kind { get; set; }
