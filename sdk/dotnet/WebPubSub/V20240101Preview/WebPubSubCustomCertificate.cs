...
namespace Pulumi.AzureNative.WebPubSub.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20240101preview:WebPubSubCustomCertificate")]
    public partial class WebPubSubCustomCertificate : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubCustomCertificate(string name, WebPubSubCustomCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240101preview:WebPubSubCustomCertificate", name, args ?? new WebPubSubCustomCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubCustomCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240101preview:WebPubSubCustomCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
