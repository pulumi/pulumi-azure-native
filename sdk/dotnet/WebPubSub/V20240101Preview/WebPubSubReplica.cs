...
namespace Pulumi.AzureNative.WebPubSub.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20240101preview:WebPubSubReplica")]
    public partial class WebPubSubReplica : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubReplica(string name, WebPubSubReplicaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240101preview:WebPubSubReplica", name, args ?? new WebPubSubReplicaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubReplica(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240101preview:WebPubSubReplica", name, null, MakeResourceOptions(options, id))
        {
        }
