...
namespace Pulumi.AzureNative.WebPubSub.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20240401preview:WebPubSubReplica")]
    public partial class WebPubSubReplica : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubReplica(string name, WebPubSubReplicaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240401preview:WebPubSubReplica", name, args ?? new WebPubSubReplicaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubReplica(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240401preview:WebPubSubReplica", name, null, MakeResourceOptions(options, id))
        {
        }
