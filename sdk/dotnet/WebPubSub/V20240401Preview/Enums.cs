...
namespace Pulumi.AzureNative.WebPubSub.V20240401Preview
{
    ...
    [EnumType]
    public readonly struct ClientConnectionCountRuleDiscriminator : IEquatable<ClientConnectionCountRuleDiscriminator>
    {
        private readonly string _value;

        private ClientConnectionCountRuleDiscriminator(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static ClientConnectionCountRuleDiscriminator ThrottleByJwtSignatureRule { get; } = new ClientConnectionCountRuleDiscriminator("ThrottleByJwtSignatureRule");
        public static ClientConnectionCountRuleDiscriminator ThrottleByUserIdRule { get; } = new ClientConnectionCountRuleDiscriminator("ThrottleByUserIdRule");
        public static ClientConnectionCountRuleDiscriminator ThrottleByJwtCustomClaimRule { get; } = new ClientConnectionCountRuleDiscriminator("ThrottleByJwtCustomClaimRule");
        ...
        public static explicit operator string(ClientConnectionCountRuleDiscriminator value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ClientConnectionCountRuleDiscriminator other && Equals(other);
        public bool Equals(ClientConnectionCountRuleDiscriminator other) => string.Equals(_value, other._value, StringComparison.Ordinal);
