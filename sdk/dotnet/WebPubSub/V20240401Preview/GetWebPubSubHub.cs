...
namespace Pulumi.AzureNative.WebPubSub.V20240401Preview
{
    public static class GetWebPubSubHub
    {
        ...
        public static Task<GetWebPubSubHubResult> InvokeAsync(GetWebPubSubHubArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebPubSubHubResult>("azure-native:webpubsub/v20240401preview:getWebPubSubHub", args ?? new GetWebPubSubHubArgs(), options.WithDefaults());

        /// <summary>
        /// Get a hub setting.
        /// </summary>
        public static Output<GetWebPubSubHubResult> Invoke(GetWebPubSubHubInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebPubSubHubResult>("azure-native:webpubsub/v20240401preview:getWebPubSubHub", args ?? new GetWebPubSubHubInvokeArgs(), options.WithDefaults());
