...
namespace Pulumi.AzureNative.WebPubSub.V20240301
{
    /// <summary>
    /// A class represent a replica resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20240301:WebPubSubReplica")]
    public partial class WebPubSubReplica : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubReplica(string name, WebPubSubReplicaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240301:WebPubSubReplica", name, args ?? new WebPubSubReplicaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubReplica(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240301:WebPubSubReplica", name, null, MakeResourceOptions(options, id))
        {
        }
