...
namespace Pulumi.AzureNative.WebPubSub.V20240301
{
    ...
    /// A hub setting
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20240301:WebPubSubHub")]
    public partial class WebPubSubHub : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubHub(string name, WebPubSubHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240301:WebPubSubHub", name, args ?? new WebPubSubHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240301:WebPubSubHub", name, null, MakeResourceOptions(options, id))
        {
        }
