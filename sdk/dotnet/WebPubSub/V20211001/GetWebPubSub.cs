...
namespace Pulumi.AzureNative.WebPubSub.V20211001
{
    public static class GetWebPubSub
    {
        ...
        public static Task<GetWebPubSubResult> InvokeAsync(GetWebPubSubArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebPubSubResult>("azure-native:webpubsub/v20211001:getWebPubSub", args ?? new GetWebPubSubArgs(), options.WithDefaults());

        /// <summary>
        /// A class represent a resource.
        /// </summary>
        public static Output<GetWebPubSubResult> Invoke(GetWebPubSubInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebPubSubResult>("azure-native:webpubsub/v20211001:getWebPubSub", args ?? new GetWebPubSubInvokeArgs(), options.WithDefaults());
    }
