...
namespace Pulumi.AzureNative.WebPubSub.V20211001
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:webpubsub/v20211001:WebPubSubSharedPrivateLinkResource is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230301preview:WebPubSubSharedPrivateLinkResource to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:webpubsub/v20211001:WebPubSubSharedPrivateLinkResource")]
    public partial class WebPubSubSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubSharedPrivateLinkResource(string name, WebPubSubSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20211001:WebPubSubSharedPrivateLinkResource", name, args ?? new WebPubSubSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20211001:WebPubSubSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
