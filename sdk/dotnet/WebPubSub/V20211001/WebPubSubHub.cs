...
namespace Pulumi.AzureNative.WebPubSub.V20211001
{
    ...
    /// {
    ///     var webPubSubHub = new AzureNative.WebPubSub.V20211001.WebPubSubHub("webPubSubHub", new()
    ///     {
    ///         HubName = "exampleHub",
    ///         Properties = new AzureNative.WebPubSub.V20211001.Inputs.WebPubSubHubPropertiesArgs
    ///         {
    ///             EventHandlers = new[]
    ///             {
    ///                 new AzureNative.WebPubSub.V20211001.Inputs.EventHandlerArgs
    ///                 {
    ///                     Auth = new AzureNative.WebPubSub.V20211001.Inputs.UpstreamAuthSettingsArgs
    ///                     {
    ///                         ManagedIdentity = new AzureNative.WebPubSub.V20211001.Inputs.ManagedIdentitySettingsArgs
    ///                         {
    ///                             Resource = "abc",
    ///                         },
    ...
    public partial class WebPubSubHub : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubHub(string name, WebPubSubHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20211001:WebPubSubHub", name, args ?? new WebPubSubHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20211001:WebPubSubHub", name, null, MakeResourceOptions(options, id))
        {
        }
