...
namespace Pulumi.AzureNative.WebPubSub.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20240801preview:WebPubSubPrivateEndpointConnection")]
    public partial class WebPubSubPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubPrivateEndpointConnection(string name, WebPubSubPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240801preview:WebPubSubPrivateEndpointConnection", name, args ?? new WebPubSubPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20240801preview:WebPubSubPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
