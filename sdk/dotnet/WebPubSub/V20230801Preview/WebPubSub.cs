...
namespace Pulumi.AzureNative.WebPubSub.V20230801Preview
{
    /// <summary>
    /// A class represent a resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20230801preview:WebPubSub")]
    public partial class WebPubSub : global::Pulumi.CustomResource
    {
        ...
        public WebPubSub(string name, WebPubSubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230801preview:WebPubSub", name, args ?? new WebPubSubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230801preview:WebPubSub", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:webpubsub/v20240101preview:WebPubSub" },
    ...
    public sealed class WebPubSubArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.WebPubSub.V20230801Preview.ServiceKind>? Kind { get; set; }
