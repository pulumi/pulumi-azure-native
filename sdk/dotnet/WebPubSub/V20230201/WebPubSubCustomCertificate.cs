...
namespace Pulumi.AzureNative.WebPubSub.V20230201
{
    ...
    public partial class WebPubSubCustomCertificate : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubCustomCertificate(string name, WebPubSubCustomCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230201:WebPubSubCustomCertificate", name, args ?? new WebPubSubCustomCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubCustomCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230201:WebPubSubCustomCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
