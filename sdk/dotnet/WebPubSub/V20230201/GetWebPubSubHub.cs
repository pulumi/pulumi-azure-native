...
namespace Pulumi.AzureNative.WebPubSub.V20230201
{
    public static class GetWebPubSubHub
    {
        ...
        public static Task<GetWebPubSubHubResult> InvokeAsync(GetWebPubSubHubArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebPubSubHubResult>("azure-native:webpubsub/v20230201:getWebPubSubHub", args ?? new GetWebPubSubHubArgs(), options.WithDefaults());

        /// <summary>
        /// Get a hub setting.
        /// </summary>
        public static Output<GetWebPubSubHubResult> Invoke(GetWebPubSubHubInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebPubSubHubResult>("azure-native:webpubsub/v20230201:getWebPubSubHub", args ?? new GetWebPubSubHubInvokeArgs(), options.WithDefaults());
    }
