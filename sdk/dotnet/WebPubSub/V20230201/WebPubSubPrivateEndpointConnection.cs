...
namespace Pulumi.AzureNative.WebPubSub.V20230201
{
    ...
    /// {
    ///     var webPubSubPrivateEndpointConnection = new AzureNative.WebPubSub.V20230201.WebPubSubPrivateEndpointConnection("webPubSubPrivateEndpointConnection", new()
    ///     {
    ///         PrivateEndpoint = new AzureNative.WebPubSub.V20230201.Inputs.PrivateEndpointArgs
    ///         {
    ///             Id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/Microsoft.Network/privateEndpoints/myPrivateEndpoint",
    ///         },
    ///         PrivateEndpointConnectionName = "mywebpubsubservice.1fa229cd-bf3f-47f0-8c49-afb36723997e",
    ///         PrivateLinkServiceConnectionState = new AzureNative.WebPubSub.V20230201.Inputs.PrivateLinkServiceConnectionStateArgs
    ///         {
    ...
    public partial class WebPubSubPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubPrivateEndpointConnection(string name, WebPubSubPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230201:WebPubSubPrivateEndpointConnection", name, args ?? new WebPubSubPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20230201:WebPubSubPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
