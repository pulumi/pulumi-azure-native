...
namespace Pulumi.AzureNative.WebPubSub.V20230601Preview
{
    public static class GetWebPubSubReplica
    {
        ...
        public static Task<GetWebPubSubReplicaResult> InvokeAsync(GetWebPubSubReplicaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebPubSubReplicaResult>("azure-native:webpubsub/v20230601preview:getWebPubSubReplica", args ?? new GetWebPubSubReplicaArgs(), options.WithDefaults());
