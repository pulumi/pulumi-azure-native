...
namespace Pulumi.AzureNative.WebPubSub.V20220801Preview
{
    ...
    /// A hub setting
    /// </summary>
    [AzureNativeResourceType("azure-native:webpubsub/v20220801preview:WebPubSubHub")]
    public partial class WebPubSubHub : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubHub(string name, WebPubSubHubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20220801preview:WebPubSubHub", name, args ?? new WebPubSubHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20220801preview:WebPubSubHub", name, null, MakeResourceOptions(options, id))
        {
        }
