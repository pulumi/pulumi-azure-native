...
namespace Pulumi.AzureNative.WebPubSub.V20220801Preview
{
    ...
    [AzureNativeResourceType("azure-native:webpubsub/v20220801preview:WebPubSub")]
    public partial class WebPubSub : global::Pulumi.CustomResource
    {
        ...
        public WebPubSub(string name, WebPubSubArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20220801preview:WebPubSub", name, args ?? new WebPubSubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20220801preview:WebPubSub", name, null, MakeResourceOptions(options, id))
        {
        }
