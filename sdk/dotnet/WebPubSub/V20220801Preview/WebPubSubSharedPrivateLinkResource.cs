...
namespace Pulumi.AzureNative.WebPubSub.V20220801Preview
{
    /// <summary>
    /// Describes a Shared Private Link Resource
    /// </summary>
    [Obsolete(@"azure-native:webpubsub/v20220801preview:WebPubSubSharedPrivateLinkResource is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230301preview:WebPubSubSharedPrivateLinkResource to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:webpubsub/v20220801preview:WebPubSubSharedPrivateLinkResource")]
    public partial class WebPubSubSharedPrivateLinkResource : global::Pulumi.CustomResource
    {
        ...
        public WebPubSubSharedPrivateLinkResource(string name, WebPubSubSharedPrivateLinkResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20220801preview:WebPubSubSharedPrivateLinkResource", name, args ?? new WebPubSubSharedPrivateLinkResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebPubSubSharedPrivateLinkResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:webpubsub/v20220801preview:WebPubSubSharedPrivateLinkResource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:webpubsub:WebPubSubSharedPrivateLinkResource"},
