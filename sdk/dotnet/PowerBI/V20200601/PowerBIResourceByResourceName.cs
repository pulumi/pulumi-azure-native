...
{
    [AzureNativeResourceType("azure-native:powerbi/v20200601:PowerBIResourceByResourceName")]
    public partial class PowerBIResourceByResourceName : Pulumi.CustomResource
    {
        ...
        public PowerBIResourceByResourceName(string name, PowerBIResourceByResourceNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:powerbi/v20200601:PowerBIResourceByResourceName", name, args ?? new PowerBIResourceByResourceNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PowerBIResourceByResourceName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:powerbi/v20200601:PowerBIResourceByResourceName", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:powerbi:PowerBIResourceByResourceName"},
