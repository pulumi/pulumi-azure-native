...
namespace Pulumi.AzureNative.AgriculturePlatform.V20240601Preview
{
    public static class ListAgriServiceAvailableSolutions
    {
        ...
        public static Task<ListAgriServiceAvailableSolutionsResult> InvokeAsync(ListAgriServiceAvailableSolutionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAgriServiceAvailableSolutionsResult>("azure-native:agricultureplatform/v20240601preview:listAgriServiceAvailableSolutions", args ?? new ListAgriServiceAvailableSolutionsArgs(), options.WithDefaults());
        ...
        public static Output<ListAgriServiceAvailableSolutionsResult> Invoke(ListAgriServiceAvailableSolutionsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListAgriServiceAvailableSolutionsResult>("azure-native:agricultureplatform/v20240601preview:listAgriServiceAvailableSolutions", args ?? new ListAgriServiceAvailableSolutionsInvokeArgs(), options.WithDefaults());
