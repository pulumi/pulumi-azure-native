...
namespace Pulumi.AzureNative.ElasticSan.V20240501
{
    public static class GetVolumeSnapshot
    {
        ...
        public static Task<GetVolumeSnapshotResult> InvokeAsync(GetVolumeSnapshotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVolumeSnapshotResult>("azure-native:elasticsan/v20240501:getVolumeSnapshot", args ?? new GetVolumeSnapshotArgs(), options.WithDefaults());
