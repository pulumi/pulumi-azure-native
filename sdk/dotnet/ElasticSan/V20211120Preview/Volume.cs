...
namespace Pulumi.AzureNative.ElasticSan.V20211120Preview
{
    ...
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20211120preview:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20211120preview:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
