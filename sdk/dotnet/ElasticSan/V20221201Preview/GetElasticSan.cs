...
namespace Pulumi.AzureNative.ElasticSan.V20221201Preview
{
    public static class GetElasticSan
    {
        ...
        public static Task<GetElasticSanResult> InvokeAsync(GetElasticSanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetElasticSanResult>("azure-native:elasticsan/v20221201preview:getElasticSan", args ?? new GetElasticSanArgs(), options.WithDefaults());

        /// <summary>
        /// Get a ElasticSan.
        /// </summary>
        public static Output<GetElasticSanResult> Invoke(GetElasticSanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetElasticSanResult>("azure-native:elasticsan/v20221201preview:getElasticSan", args ?? new GetElasticSanInvokeArgs(), options.WithDefaults());
