...
namespace Pulumi.AzureNative.ElasticSan.V20221201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elasticsan/v20221201preview:ElasticSan")]
    public partial class ElasticSan : global::Pulumi.CustomResource
    {
        ...
        public ElasticSan(string name, ElasticSanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20221201preview:ElasticSan", name, args ?? new ElasticSanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ElasticSan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20221201preview:ElasticSan", name, null, MakeResourceOptions(options, id))
        {
        }
