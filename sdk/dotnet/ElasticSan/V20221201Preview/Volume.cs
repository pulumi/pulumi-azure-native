...
namespace Pulumi.AzureNative.ElasticSan.V20221201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elasticsan/v20221201preview:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20221201preview:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20221201preview:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
