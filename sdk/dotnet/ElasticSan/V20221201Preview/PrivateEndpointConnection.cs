...
namespace Pulumi.AzureNative.ElasticSan.V20221201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elasticsan/v20221201preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20221201preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20221201preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
