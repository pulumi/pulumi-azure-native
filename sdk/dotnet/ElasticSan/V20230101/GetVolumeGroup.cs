...
namespace Pulumi.AzureNative.ElasticSan.V20230101
{
    public static class GetVolumeGroup
    {
        ...
        public static Task<GetVolumeGroupResult> InvokeAsync(GetVolumeGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVolumeGroupResult>("azure-native:elasticsan/v20230101:getVolumeGroup", args ?? new GetVolumeGroupArgs(), options.WithDefaults());
