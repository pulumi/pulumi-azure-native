...
namespace Pulumi.AzureNative.ElasticSan.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elasticsan/v20230101:VolumeSnapshot")]
    public partial class VolumeSnapshot : global::Pulumi.CustomResource
    {
        ...
        public VolumeSnapshot(string name, VolumeSnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20230101:VolumeSnapshot", name, args ?? new VolumeSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20230101:VolumeSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
