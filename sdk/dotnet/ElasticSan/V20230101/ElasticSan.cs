...
namespace Pulumi.AzureNative.ElasticSan.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elasticsan/v20230101:ElasticSan")]
    public partial class ElasticSan : global::Pulumi.CustomResource
    {
        ...
        public ElasticSan(string name, ElasticSanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20230101:ElasticSan", name, args ?? new ElasticSanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ElasticSan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20230101:ElasticSan", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ElasticSanArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ElasticSan.V20230101.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
