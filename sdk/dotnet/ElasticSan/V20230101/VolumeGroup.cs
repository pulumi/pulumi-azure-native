...
namespace Pulumi.AzureNative.ElasticSan.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elasticsan/v20230101:VolumeGroup")]
    public partial class VolumeGroup : global::Pulumi.CustomResource
    {
        ...
        public VolumeGroup(string name, VolumeGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20230101:VolumeGroup", name, args ?? new VolumeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20230101:VolumeGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:elasticsan/v20240601preview:VolumeGroup" },
                },
            };
    ...
    public sealed class VolumeGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("encryption")]
        public InputUnion<string, Pulumi.AzureNative.ElasticSan.V20230101.EncryptionType>? Encryption { get; set; }
        ...
        /// </summary>
        [Input("protocolType")]
        public InputUnion<string, Pulumi.AzureNative.ElasticSan.V20230101.StorageTargetType>? ProtocolType { get; set; }
