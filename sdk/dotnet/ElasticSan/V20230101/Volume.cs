...
namespace Pulumi.AzureNative.ElasticSan.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elasticsan/v20230101:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20230101:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20230101:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
