...
namespace Pulumi.AzureNative.ElasticSan.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elasticsan/v20240601preview:ElasticSan")]
    public partial class ElasticSan : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Auto Scale Properties for Elastic San Appliance.
        /// </summary>
        [Output("autoScaleProperties")]
        public Output<Outputs.AutoScalePropertiesResponse?> AutoScaleProperties { get; private set; } = null!;
        ...
        public ElasticSan(string name, ElasticSanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20240601preview:ElasticSan", name, args ?? new ElasticSanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ElasticSan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20240601preview:ElasticSan", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ElasticSanArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ElasticSan.V20240601Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
