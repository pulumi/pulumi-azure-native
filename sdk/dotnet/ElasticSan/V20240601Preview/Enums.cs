...
namespace Pulumi.AzureNative.ElasticSan.V20240601Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct AutoScalePolicyEnforcement : IEquatable<AutoScalePolicyEnforcement>
    {
        private readonly string _value;

        private AutoScalePolicyEnforcement(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static AutoScalePolicyEnforcement None { get; } = new AutoScalePolicyEnforcement("None");
        public static AutoScalePolicyEnforcement Enabled { get; } = new AutoScalePolicyEnforcement("Enabled");
        public static AutoScalePolicyEnforcement Disabled { get; } = new AutoScalePolicyEnforcement("Disabled");

        public static bool operator ==(AutoScalePolicyEnforcement left, AutoScalePolicyEnforcement right) => left.Equals(right);
        public static bool operator !=(AutoScalePolicyEnforcement left, AutoScalePolicyEnforcement right) => !left.Equals(right);

        public static explicit operator string(AutoScalePolicyEnforcement value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is AutoScalePolicyEnforcement other && Equals(other);
        public bool Equals(AutoScalePolicyEnforcement other) => string.Equals(_value, other._value, StringComparison.Ordinal);
