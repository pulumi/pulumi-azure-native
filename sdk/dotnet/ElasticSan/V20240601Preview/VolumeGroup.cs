...
namespace Pulumi.AzureNative.ElasticSan.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elasticsan/v20240601preview:VolumeGroup")]
    public partial class VolumeGroup : global::Pulumi.CustomResource
    {
        ...
        public VolumeGroup(string name, VolumeGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20240601preview:VolumeGroup", name, args ?? new VolumeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan/v20240601preview:VolumeGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VolumeGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("encryption")]
        public InputUnion<string, Pulumi.AzureNative.ElasticSan.V20240601Preview.EncryptionType>? Encryption { get; set; }
        ...
        /// </summary>
        [Input("protocolType")]
        public InputUnion<string, Pulumi.AzureNative.ElasticSan.V20240601Preview.StorageTargetType>? ProtocolType { get; set; }
