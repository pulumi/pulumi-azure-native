...
namespace Pulumi.AzureNative.ElasticSan
{
    ...
    public partial class VolumeSnapshot : global::Pulumi.CustomResource
    {
        ...
        public VolumeSnapshot(string name, VolumeSnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan:VolumeSnapshot", name, args ?? new VolumeSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elasticsan:VolumeSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_elasticsan_v20230101:elasticsan:VolumeSnapshot" },
                    new global::Pulumi.Alias { Type = "azure-native_elasticsan_v20240501:elasticsan:VolumeSnapshot" },
                    new global::Pulumi.Alias { Type = "azure-native_elasticsan_v20240601preview:elasticsan:VolumeSnapshot" },
                },
            };
