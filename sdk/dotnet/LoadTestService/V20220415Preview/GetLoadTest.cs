...
namespace Pulumi.AzureNative.LoadTestService.V20220415Preview
{
    public static class GetLoadTest
    {
        ...
        public static Task<GetLoadTestResult> InvokeAsync(GetLoadTestArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLoadTestResult>("azure-native:loadtestservice/v20220415preview:getLoadTest", args ?? new GetLoadTestArgs(), options.WithDefaults());

        /// <summary>
        /// LoadTest details
        /// </summary>
        public static Output<GetLoadTestResult> Invoke(GetLoadTestInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLoadTestResult>("azure-native:loadtestservice/v20220415preview:getLoadTest", args ?? new GetLoadTestInvokeArgs(), options.WithDefaults());
    }
