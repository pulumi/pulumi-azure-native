...
namespace Pulumi.AzureNative.LoadTestService.V20220415Preview
{
    ...
    public partial class LoadTest : Pulumi.CustomResource
    {
        ...
        public LoadTest(string name, LoadTestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:loadtestservice/v20220415preview:LoadTest", name, args ?? new LoadTestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadTest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:loadtestservice/v20220415preview:LoadTest", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:loadtestservice:LoadTest"},
