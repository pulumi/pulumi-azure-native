...
namespace Pulumi.AzureNative.LoadTestService.V20220415Preview.Inputs
{
    ...
    public sealed class EncryptionPropertiesIdentityArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.LoadTestService.V20220415Preview.Type>? Type { get; set; }
