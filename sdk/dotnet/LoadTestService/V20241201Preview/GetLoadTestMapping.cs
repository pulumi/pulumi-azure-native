...
namespace Pulumi.AzureNative.LoadTestService.V20241201Preview
{
    public static class GetLoadTestMapping
    {
        ...
        public static Task<GetLoadTestMappingResult> InvokeAsync(GetLoadTestMappingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLoadTestMappingResult>("azure-native:loadtestservice/v20241201preview:getLoadTestMapping", args ?? new GetLoadTestMappingArgs(), options.WithDefaults());

        /// <summary>
        /// Get a LoadTestMappingResource
        /// </summary>
        public static Output<GetLoadTestMappingResult> Invoke(GetLoadTestMappingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLoadTestMappingResult>("azure-native:loadtestservice/v20241201preview:getLoadTestMapping", args ?? new GetLoadTestMappingInvokeArgs(), options.WithDefaults());
