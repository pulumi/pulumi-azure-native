...
namespace Pulumi.AzureNative.LoadTestService.V20241201Preview
{
    public static class GetLoadTest
    {
        ...
        public static Task<GetLoadTestResult> InvokeAsync(GetLoadTestArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLoadTestResult>("azure-native:loadtestservice/v20241201preview:getLoadTest", args ?? new GetLoadTestArgs(), options.WithDefaults());

        /// <summary>
        /// Get a LoadTestResource
        /// </summary>
        public static Output<GetLoadTestResult> Invoke(GetLoadTestInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLoadTestResult>("azure-native:loadtestservice/v20241201preview:getLoadTest", args ?? new GetLoadTestInvokeArgs(), options.WithDefaults());
