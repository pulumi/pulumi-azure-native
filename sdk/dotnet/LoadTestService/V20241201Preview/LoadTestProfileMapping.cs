...
namespace Pulumi.AzureNative.LoadTestService.V20241201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:loadtestservice/v20241201preview:LoadTestProfileMapping")]
    public partial class LoadTestProfileMapping : global::Pulumi.CustomResource
    {
        ...
        public LoadTestProfileMapping(string name, LoadTestProfileMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:loadtestservice/v20241201preview:LoadTestProfileMapping", name, args ?? new LoadTestProfileMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadTestProfileMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:loadtestservice/v20241201preview:LoadTestProfileMapping", name, null, MakeResourceOptions(options, id))
        {
        }
