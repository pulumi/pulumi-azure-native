...
namespace Pulumi.AzureNative.LoadTestService.V20231201Preview
{
    ...
    /// LoadTest details.
    /// </summary>
    [AzureNativeResourceType("azure-native:loadtestservice/v20231201preview:LoadTest")]
    public partial class LoadTest : global::Pulumi.CustomResource
    {
        ...
        public LoadTest(string name, LoadTestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:loadtestservice/v20231201preview:LoadTest", name, args ?? new LoadTestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadTest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:loadtestservice/v20231201preview:LoadTest", name, null, MakeResourceOptions(options, id))
        {
        }
