...
namespace Pulumi.AzureNative.LoadTestService.V20211201Preview
{
    ...
    public partial class LoadTest : global::Pulumi.CustomResource
    {
        ...
        public LoadTest(string name, LoadTestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:loadtestservice/v20211201preview:LoadTest", name, args ?? new LoadTestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadTest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:loadtestservice/v20211201preview:LoadTest", name, null, MakeResourceOptions(options, id))
        {
        }
