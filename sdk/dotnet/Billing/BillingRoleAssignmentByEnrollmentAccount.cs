...
namespace Pulumi.AzureNative.Billing
{
    ...
    /// Azure REST API version: 2024-04-01. Prior API version in Azure Native 1.x: 2019-10-01-preview.
    /// 
    ...
    public partial class BillingRoleAssignmentByEnrollmentAccount : global::Pulumi.CustomResource
    {
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BillingRoleAssignmentByEnrollmentAccount Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
