...
namespace Pulumi.AzureRM.Billing.Latest
{
    public static class GetReportByBillingAccount
    {
        public static Task<GetReportByBillingAccountResult> InvokeAsync(GetReportByBillingAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReportByBillingAccountResult>("azurerm:billing/latest:getReportByBillingAccount", args ?? new GetReportByBillingAccountArgs(), options.WithVersion());
    }
