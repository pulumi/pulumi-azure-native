...
namespace Pulumi.AzureRM.Billing.Latest
{
    public static class GetReportByDepartment
    {
        public static Task<GetReportByDepartmentResult> InvokeAsync(GetReportByDepartmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReportByDepartmentResult>("azurerm:billing/latest:getReportByDepartment", args ?? new GetReportByDepartmentArgs(), options.WithVersion());
    }
