...
namespace Pulumi.AzureRM.Billing.Latest
{
    ...
    public partial class ReportByDepartment : Pulumi.CustomResource
    {
        ...
        public ReportByDepartment(string name, ReportByDepartmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:ReportByDepartment", name, args ?? new ReportByDepartmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReportByDepartment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:ReportByDepartment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:billing/v20180801preview:ReportByDepartment"},
                },
            };
