...
namespace Pulumi.AzureRM.Billing.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var billingRoleAssignmentByBillingAccount = new AzureRM.Billing.Latest.BillingRoleAssignmentByBillingAccount("billingRoleAssignmentByBillingAccount", new AzureRM.Billing.Latest.BillingRoleAssignmentByBillingAccountArgs
    ///         {
    ...
    public partial class BillingRoleAssignmentByBillingAccount : Pulumi.CustomResource
    {
        ...
        public BillingRoleAssignmentByBillingAccount(string name, BillingRoleAssignmentByBillingAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:BillingRoleAssignmentByBillingAccount", name, args ?? new BillingRoleAssignmentByBillingAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingRoleAssignmentByBillingAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:BillingRoleAssignmentByBillingAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:billing/v20191001preview:BillingRoleAssignmentByBillingAccount"},
                },
            };
