...
namespace Pulumi.AzureRM.Billing.Latest
{
    /// <summary>
    /// The role assignment
    /// 
    ...
    ///     public MyStack()
    ///     {
    ///         var billingRoleAssignmentByDepartment = new AzureRM.Billing.Latest.BillingRoleAssignmentByDepartment("billingRoleAssignmentByDepartment", new AzureRM.Billing.Latest.BillingRoleAssignmentByDepartmentArgs
    ///         {
    ...
    public partial class BillingRoleAssignmentByDepartment : Pulumi.CustomResource
    {
        ...
        public BillingRoleAssignmentByDepartment(string name, BillingRoleAssignmentByDepartmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:BillingRoleAssignmentByDepartment", name, args ?? new BillingRoleAssignmentByDepartmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingRoleAssignmentByDepartment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:BillingRoleAssignmentByDepartment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:billing/v20191001preview:BillingRoleAssignmentByDepartment"},
                },
            };
