...
namespace Pulumi.AzureRM.Billing.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var costAllocationRule = new AzureRM.Billing.Latest.CostAllocationRule("costAllocationRule", new AzureRM.Billing.Latest.CostAllocationRuleArgs
    ///         {
    ...
    public partial class CostAllocationRule : Pulumi.CustomResource
    {
        ...
        public CostAllocationRule(string name, CostAllocationRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:CostAllocationRule", name, args ?? new CostAllocationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CostAllocationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:CostAllocationRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:billing/v20200301preview:CostAllocationRule"},
                },
            };
