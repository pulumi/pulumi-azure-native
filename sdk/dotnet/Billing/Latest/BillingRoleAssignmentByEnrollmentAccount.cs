...
namespace Pulumi.AzureRM.Billing.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var billingRoleAssignmentByEnrollmentAccount = new AzureRM.Billing.Latest.BillingRoleAssignmentByEnrollmentAccount("billingRoleAssignmentByEnrollmentAccount", new AzureRM.Billing.Latest.BillingRoleAssignmentByEnrollmentAccountArgs
    ///         {
    ...
    public partial class BillingRoleAssignmentByEnrollmentAccount : Pulumi.CustomResource
    {
        ...
        public BillingRoleAssignmentByEnrollmentAccount(string name, BillingRoleAssignmentByEnrollmentAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:BillingRoleAssignmentByEnrollmentAccount", name, args ?? new BillingRoleAssignmentByEnrollmentAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingRoleAssignmentByEnrollmentAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:billing/latest:BillingRoleAssignmentByEnrollmentAccount", name, null, MakeResourceOptions(options, id))
        {
        }
