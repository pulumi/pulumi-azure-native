...
namespace Pulumi.AzureNative.Billing.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:billing/v20240401:BillingRoleAssignmentByBillingAccount")]
    public partial class BillingRoleAssignmentByBillingAccount : global::Pulumi.CustomResource
    {
        ...
        public BillingRoleAssignmentByBillingAccount(string name, BillingRoleAssignmentByBillingAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:billing/v20240401:BillingRoleAssignmentByBillingAccount", name, args ?? new BillingRoleAssignmentByBillingAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingRoleAssignmentByBillingAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:billing/v20240401:BillingRoleAssignmentByBillingAccount", name, null, MakeResourceOptions(options, id))
        {
        }
