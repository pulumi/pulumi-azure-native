...
namespace Pulumi.AzureNative.Billing.V20240401
{
    public static class GetInvoiceSection
    {
        ...
        public static Task<GetInvoiceSectionResult> InvokeAsync(GetInvoiceSectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInvoiceSectionResult>("azure-native:billing/v20240401:getInvoiceSection", args ?? new GetInvoiceSectionArgs(), options.WithDefaults());
