...
namespace Pulumi.AzureNative.Billing.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:billing/v20240401:BillingRoleAssignmentByEnrollmentAccount")]
    public partial class BillingRoleAssignmentByEnrollmentAccount : global::Pulumi.CustomResource
    {
        ...
        public BillingRoleAssignmentByEnrollmentAccount(string name, BillingRoleAssignmentByEnrollmentAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:billing/v20240401:BillingRoleAssignmentByEnrollmentAccount", name, args ?? new BillingRoleAssignmentByEnrollmentAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingRoleAssignmentByEnrollmentAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:billing/v20240401:BillingRoleAssignmentByEnrollmentAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:billing:BillingRoleAssignmentByEnrollmentAccount" },
