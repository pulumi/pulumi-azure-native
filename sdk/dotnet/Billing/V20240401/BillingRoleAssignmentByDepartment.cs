...
namespace Pulumi.AzureNative.Billing.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:billing/v20240401:BillingRoleAssignmentByDepartment")]
    public partial class BillingRoleAssignmentByDepartment : global::Pulumi.CustomResource
    {
        ...
        public BillingRoleAssignmentByDepartment(string name, BillingRoleAssignmentByDepartmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:billing/v20240401:BillingRoleAssignmentByDepartment", name, args ?? new BillingRoleAssignmentByDepartmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingRoleAssignmentByDepartment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:billing/v20240401:BillingRoleAssignmentByDepartment", name, null, MakeResourceOptions(options, id))
        {
        }
