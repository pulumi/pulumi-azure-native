...
namespace Pulumi.AzureNextGen.Billing
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:billing:BillingRoleAssignmentByBillingAccount")]
    public partial class BillingRoleAssignmentByBillingAccount : Pulumi.CustomResource
    {
        ...
        public BillingRoleAssignmentByBillingAccount(string name, BillingRoleAssignmentByBillingAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:billing:BillingRoleAssignmentByBillingAccount", name, args ?? new BillingRoleAssignmentByBillingAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingRoleAssignmentByBillingAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:billing:BillingRoleAssignmentByBillingAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:billing/v20191001preview:BillingRoleAssignmentByBillingAccount"},
                },
            };
