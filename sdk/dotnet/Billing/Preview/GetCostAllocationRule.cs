...
namespace Pulumi.AzureRM.Billing.Preview
{
    public static class GetCostAllocationRule
    {
        public static Task<GetCostAllocationRuleResult> InvokeAsync(GetCostAllocationRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCostAllocationRuleResult>("azurerm:billing/preview:getCostAllocationRule", args ?? new GetCostAllocationRuleArgs(), options.WithVersion());
    }
