...
namespace Pulumi.AzureRM.Billing.Preview
{
    ...
    public partial class BillingRoleAssignmentByEnrollmentAccount : Pulumi.CustomResource
    {
        ...
        public BillingRoleAssignmentByEnrollmentAccount(string name, BillingRoleAssignmentByEnrollmentAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:billing/preview:BillingRoleAssignmentByEnrollmentAccount", name, args ?? new BillingRoleAssignmentByEnrollmentAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BillingRoleAssignmentByEnrollmentAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:billing/preview:BillingRoleAssignmentByEnrollmentAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:billing/v20191001preview:BillingRoleAssignmentByEnrollmentAccount"},
                },
            };
