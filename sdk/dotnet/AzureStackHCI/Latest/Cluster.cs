...
namespace Pulumi.AzureRM.AzureStackHCI.Latest
{
    /// <summary>
    /// Cluster details.
    /// 
    ...
    ///     public MyStack()
    ///     {
    ///         var cluster = new AzureRM.AzureStackHCI.Latest.Cluster("cluster", new AzureRM.AzureStackHCI.Latest.ClusterArgs
    ///         {
    ...
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azurestackhci/latest:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azurestackhci/latest:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:azurestackhci/v20200301preview:Cluster"},
                },
            };
