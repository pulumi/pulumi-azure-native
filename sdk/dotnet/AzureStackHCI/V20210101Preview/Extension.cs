...
namespace Pulumi.AzureNative.AzureStackHCI.V20210101Preview
{
    ...
    /// {
    ///     var extension = new AzureNative.AzureStackHCI.V20210101Preview.Extension("extension", new()
    ///     {
    ...
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210101preview:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210101preview:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
