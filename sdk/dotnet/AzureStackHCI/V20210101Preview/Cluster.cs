...
namespace Pulumi.AzureNative.AzureStackHCI.V20210101Preview
{
    ...
    /// Cluster details.
    /// </summary>
    [Obsolete(@"azure-native:azurestackhci/v20210101preview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20220101:Cluster to guarantee forwards compatibility.")]
    ...
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210101preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210101preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
