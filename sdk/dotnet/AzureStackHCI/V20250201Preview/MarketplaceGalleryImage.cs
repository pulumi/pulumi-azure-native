...
namespace Pulumi.AzureNative.AzureStackHCI.V20250201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20250201preview:MarketplaceGalleryImage")]
    public partial class MarketplaceGalleryImage : global::Pulumi.CustomResource
    {
        ...
        public MarketplaceGalleryImage(string name, MarketplaceGalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:MarketplaceGalleryImage", name, args ?? new MarketplaceGalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MarketplaceGalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:MarketplaceGalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
