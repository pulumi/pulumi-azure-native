...
namespace Pulumi.AzureNative.AzureStackHCI.V20250201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20250201preview:GalleryImage")]
    public partial class GalleryImage : global::Pulumi.CustomResource
    {
        ...
        public GalleryImage(string name, GalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:GalleryImage", name, args ?? new GalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:GalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GalleryImageArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20250201Preview.CloudInitDataSource>? CloudInitDataSource { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20250201Preview.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20250201Preview.OperatingSystemTypes> OsType { get; set; } = null!;
