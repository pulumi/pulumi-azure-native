...
namespace Pulumi.AzureNative.AzureStackHCI.V20250201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20250201preview:GuestAgent")]
    public partial class GuestAgent : global::Pulumi.CustomResource
    {
        ...
        public GuestAgent(string name, GuestAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:GuestAgent", name, args ?? new GuestAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:GuestAgent", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GuestAgentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20250201Preview.ProvisioningAction>? ProvisioningAction { get; set; }
