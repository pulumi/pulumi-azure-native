...
namespace Pulumi.AzureNative.AzureStackHCI.V20250201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20250201preview:HciEdgeDevice")]
    public partial class HciEdgeDevice : global::Pulumi.CustomResource
    {
        ...
        public HciEdgeDevice(string name, HciEdgeDeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:HciEdgeDevice", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private HciEdgeDevice(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:HciEdgeDevice", name, null, MakeResourceOptions(options, id))
        {
        }
