...
namespace Pulumi.AzureNative.AzureStackHCI.V20250201Preview
{
    ...
    /// Cluster details.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20250201preview:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("clusterPattern")]
        public Output<string> ClusterPattern { get; private set; } = null!;
        ...
        /// </summary>
        [Output("localAvailabilityZones")]
        public Output<ImmutableArray<Outputs.LocalAvailabilityZonesResponse>> LocalAvailabilityZones { get; private set; } = null!;
        ...
        /// </summary>
        [Output("secretsLocations")]
        public Output<ImmutableArray<Outputs.SecretsLocationDetailsResponse>> SecretsLocations { get; private set; } = null!;
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250201preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20230601:Cluster" },
    ...
    public sealed class ClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("localAvailabilityZones")]
        private InputList<Inputs.LocalAvailabilityZonesArgs>? _localAvailabilityZones;

        /// <summary>
        /// Local Availability Zone information for HCI cluster
        /// </summary>
        public InputList<Inputs.LocalAvailabilityZonesArgs> LocalAvailabilityZones
        {
            get => _localAvailabilityZones ?? (_localAvailabilityZones = new InputList<Inputs.LocalAvailabilityZonesArgs>());
            set => _localAvailabilityZones = value;
        }
        ...
        [Input("secretsLocations")]
        private InputList<Inputs.SecretsLocationDetailsArgs>? _secretsLocations;

        /// <summary>
        /// List of secret locations.
        /// </summary>
        public InputList<Inputs.SecretsLocationDetailsArgs> SecretsLocations
        {
            get => _secretsLocations ?? (_secretsLocations = new InputList<Inputs.SecretsLocationDetailsArgs>());
            set => _secretsLocations = value;
        }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20250201Preview.ManagedServiceIdentityType> Type { get; set; } = null!;
