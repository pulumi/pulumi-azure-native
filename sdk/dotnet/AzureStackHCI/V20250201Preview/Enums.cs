...
namespace Pulumi.AzureNative.AzureStackHCI.V20250201Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct ClusterPattern : IEquatable<ClusterPattern>
    {
        private readonly string _value;

        private ClusterPattern(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// Standard cluster.
        /// </summary>
        public static ClusterPattern Standard { get; } = new ClusterPattern("Standard");
        /// <summary>
        /// RackAware cluster.
        /// </summary>
        public static ClusterPattern RackAware { get; } = new ClusterPattern("RackAware");

        public static bool operator ==(ClusterPattern left, ClusterPattern right) => left.Equals(right);
        public static bool operator !=(ClusterPattern left, ClusterPattern right) => !left.Equals(right);

        public static explicit operator string(ClusterPattern value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ClusterPattern other && Equals(other);
        public bool Equals(ClusterPattern other) => string.Equals(_value, other._value, StringComparison.Ordinal);
