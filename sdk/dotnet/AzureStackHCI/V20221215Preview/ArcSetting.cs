...
namespace Pulumi.AzureNative.AzureStackHCI.V20221215Preview
{
    ...
    /// ArcSetting details.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20221215preview:ArcSetting")]
    public partial class ArcSetting : global::Pulumi.CustomResource
    {
        ...
        public ArcSetting(string name, ArcSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221215preview:ArcSetting", name, args ?? new ArcSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArcSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221215preview:ArcSetting", name, null, MakeResourceOptions(options, id))
        {
        }
