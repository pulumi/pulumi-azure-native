...
namespace Pulumi.AzureNative.AzureStackHCI.V20221215Preview
{
    ...
    /// Cluster details.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20221215preview:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221215preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221215preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20221215Preview.ManagedServiceIdentityType> Type { get; set; } = null!;
