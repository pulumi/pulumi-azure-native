...
namespace Pulumi.AzureNative.AzureStackHCI.V20221215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20221215preview:UpdateSummary")]
    public partial class UpdateSummary : global::Pulumi.CustomResource
    {
        ...
        public UpdateSummary(string name, UpdateSummaryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221215preview:UpdateSummary", name, args ?? new UpdateSummaryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UpdateSummary(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221215preview:UpdateSummary", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UpdateSummaryArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20221215Preview.UpdateSummariesPropertiesState>? State { get; set; }
