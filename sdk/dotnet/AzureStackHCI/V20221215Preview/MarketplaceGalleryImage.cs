...
namespace Pulumi.AzureNative.AzureStackHCI.V20221215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20221215preview:MarketplaceGalleryImage")]
    public partial class MarketplaceGalleryImage : global::Pulumi.CustomResource
    {
        ...
        public MarketplaceGalleryImage(string name, MarketplaceGalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221215preview:MarketplaceGalleryImage", name, args ?? new MarketplaceGalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MarketplaceGalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221215preview:MarketplaceGalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
