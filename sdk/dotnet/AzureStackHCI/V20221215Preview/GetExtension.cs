...
namespace Pulumi.AzureNative.AzureStackHCI.V20221215Preview
{
    public static class GetExtension
    {
        ...
        public static Task<GetExtensionResult> InvokeAsync(GetExtensionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExtensionResult>("azure-native:azurestackhci/v20221215preview:getExtension", args ?? new GetExtensionArgs(), options.WithDefaults());

        /// <summary>
        /// Get particular Arc Extension of HCI Cluster.
        /// </summary>
        public static Output<GetExtensionResult> Invoke(GetExtensionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExtensionResult>("azure-native:azurestackhci/v20221215preview:getExtension", args ?? new GetExtensionInvokeArgs(), options.WithDefaults());
