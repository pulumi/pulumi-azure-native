...
namespace Pulumi.AzureNative.AzureStackHCI.V20210901Preview
{
    ...
    /// {
    ///     var arcSetting = new AzureNative.AzureStackHCI.V20210901Preview.ArcSetting("arcSetting", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:azurestackhci/v20210901preview:ArcSetting myresource1 /subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/test-rg/providers/Microsoft.AzureStackHCI/clusters/myCluster/arcSettings/default 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20210901preview:ArcSetting")]
    public partial class ArcSetting : global::Pulumi.CustomResource
    {
        ...
        public ArcSetting(string name, ArcSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210901preview:ArcSetting", name, args ?? new ArcSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArcSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210901preview:ArcSetting", name, null, MakeResourceOptions(options, id))
        {
        }
