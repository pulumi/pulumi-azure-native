...
namespace Pulumi.AzureNative.AzureStackHCI.V20210901Preview
{
    ...
    [AzureNativeResourceType("azure-native:azurestackhci/v20210901preview:Extension")]
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210901preview:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210901preview:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ExtensionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createdByType")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20210901Preview.CreatedByType>? CreatedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20210901Preview.CreatedByType>? LastModifiedByType { get; set; }
