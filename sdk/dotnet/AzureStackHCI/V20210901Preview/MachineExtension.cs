...
namespace Pulumi.AzureNative.AzureStackHCI.V20210901Preview
{
    ...
    /// {
    ///     var machineExtension = new AzureNative.AzureStackHCI.V20210901Preview.MachineExtension("machineExtension", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:azurestackhci/v20210901preview:MachineExtension CustomScriptExtension /subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.AzureStackHCI/virtualMachines/myVirtualMachine/Extensions/CustomScriptExtension 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20210901preview:MachineExtension")]
    public partial class MachineExtension : global::Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210901preview:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210901preview:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
