...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci:DevicePool")]
    public partial class DevicePool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DevicePoolPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public DevicePool(string name, DevicePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:DevicePool", name, args ?? new DevicePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevicePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:DevicePool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260301preview:DevicePool" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260401preview:DevicePool" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260501preview:DevicePool" },
                },
            };
    ...
    public sealed class DevicePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.DevicePoolPropertiesArgs>? Properties { get; set; }
