...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    public partial class VirtualnetworkRetrieve : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("subnets")]
        public Output<ImmutableArray<Outputs.VirtualnetworksPropertiesResponseSubnets>> Subnets { get; private set; } = null!;
        ...
        public VirtualnetworkRetrieve(string name, VirtualnetworkRetrieveArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:VirtualnetworkRetrieve", name, args ?? new VirtualnetworkRetrieveArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualnetworkRetrieve(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:VirtualnetworkRetrieve", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualnetworkRetrieveArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("subnets")]
        private InputList<Inputs.VirtualnetworksPropertiesSubnetsArgs>? _subnets;

        /// <summary>
        /// Subnet - list of subnets under the virtual network
        /// </summary>
        public InputList<Inputs.VirtualnetworksPropertiesSubnetsArgs> Subnets
        {
            get => _subnets ?? (_subnets = new InputList<Inputs.VirtualnetworksPropertiesSubnetsArgs>());
            set => _subnets = value;
        }
