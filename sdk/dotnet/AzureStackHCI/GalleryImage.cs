...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    public partial class GalleryImage : global::Pulumi.CustomResource
    {
        ...
        public GalleryImage(string name, GalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:GalleryImage", name, args ?? new GalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:GalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260201preview:GalleryImage" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260401preview:GalleryImage" },
                },
            };
