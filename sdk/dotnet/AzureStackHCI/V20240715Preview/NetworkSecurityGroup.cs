...
namespace Pulumi.AzureNative.AzureStackHCI.V20240715Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20240715preview:NetworkSecurityGroup")]
    public partial class NetworkSecurityGroup : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityGroup(string name, NetworkSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240715preview:NetworkSecurityGroup", name, args ?? new NetworkSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240715preview:NetworkSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
