...
namespace Pulumi.AzureNative.AzureStackHCI.V20240715Preview
{
    public static class GetLogicalNetwork
    {
        ...
        public static Task<GetLogicalNetworkResult> InvokeAsync(GetLogicalNetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLogicalNetworkResult>("azure-native:azurestackhci/v20240715preview:getLogicalNetwork", args ?? new GetLogicalNetworkArgs(), options.WithDefaults());

        /// <summary>
        /// The operation to get a logical network.
        /// </summary>
        public static Output<GetLogicalNetworkResult> Invoke(GetLogicalNetworkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLogicalNetworkResult>("azure-native:azurestackhci/v20240715preview:getLogicalNetwork", args ?? new GetLogicalNetworkInvokeArgs(), options.WithDefaults());
