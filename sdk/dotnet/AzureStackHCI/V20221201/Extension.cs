...
namespace Pulumi.AzureNative.AzureStackHCI.V20221201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:azurestackhci/v20221201:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Extension to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:azurestackhci/v20221201:Extension")]
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221201:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221201:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
