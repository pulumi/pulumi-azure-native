...
namespace Pulumi.AzureNative.AzureStackHCI.V20220901
{
    ...
    /// {
    ///     var cluster = new AzureNative.AzureStackHCI.V20220901.Cluster("cluster", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20220901:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20220901:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20220901:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
