...
namespace Pulumi.AzureNative.AzureStackHCI.V20220901
{
    /// <summary>
    /// ArcSetting details.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20220901:ArcSetting")]
    public partial class ArcSetting : global::Pulumi.CustomResource
    {
        ...
        public ArcSetting(string name, ArcSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20220901:ArcSetting", name, args ?? new ArcSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArcSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20220901:ArcSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ArcSettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createdByType")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20220901.CreatedByType>? CreatedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20220901.CreatedByType>? LastModifiedByType { get; set; }
