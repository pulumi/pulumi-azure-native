...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    public partial class NetworkSecurityGroup : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityGroup(string name, NetworkSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:NetworkSecurityGroup", name, args ?? new NetworkSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:NetworkSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20250601preview:NetworkSecurityGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20250901preview:NetworkSecurityGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260201preview:NetworkSecurityGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260401preview:NetworkSecurityGroup" },
                },
            };
