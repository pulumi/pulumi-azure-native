...
namespace Pulumi.AzureNative.AzureStackHCI.V20231101Preview
{
    public static class GetCluster
    {
        ...
        public static Task<GetClusterResult> InvokeAsync(GetClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterResult>("azure-native:azurestackhci/v20231101preview:getCluster", args ?? new GetClusterArgs(), options.WithDefaults());
