...
namespace Pulumi.AzureNative.AzureStackHCI.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20231101preview:SecuritySetting")]
    public partial class SecuritySetting : global::Pulumi.CustomResource
    {
        ...
        public SecuritySetting(string name, SecuritySettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20231101preview:SecuritySetting", name, args ?? new SecuritySettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecuritySetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20231101preview:SecuritySetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecuritySettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20231101Preview.ComplianceAssignmentType>? SecuredCoreComplianceAssignment { get; set; }
