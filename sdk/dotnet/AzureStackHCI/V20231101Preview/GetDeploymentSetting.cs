...
namespace Pulumi.AzureNative.AzureStackHCI.V20231101Preview
{
    public static class GetDeploymentSetting
    {
        ...
        public static Task<GetDeploymentSettingResult> InvokeAsync(GetDeploymentSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentSettingResult>("azure-native:azurestackhci/v20231101preview:getDeploymentSetting", args ?? new GetDeploymentSettingArgs(), options.WithDefaults());
