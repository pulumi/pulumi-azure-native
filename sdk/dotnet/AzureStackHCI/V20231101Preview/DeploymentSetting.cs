...
namespace Pulumi.AzureNative.AzureStackHCI.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20231101preview:DeploymentSetting")]
    public partial class DeploymentSetting : global::Pulumi.CustomResource
    {
        ...
        public DeploymentSetting(string name, DeploymentSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20231101preview:DeploymentSetting", name, args ?? new DeploymentSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20231101preview:DeploymentSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeploymentSettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20231101Preview.DeploymentMode> DeploymentMode { get; set; } = null!;
