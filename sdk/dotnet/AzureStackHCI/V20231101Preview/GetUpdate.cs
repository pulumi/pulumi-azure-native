...
namespace Pulumi.AzureNative.AzureStackHCI.V20231101Preview
{
    public static class GetUpdate
    {
        ...
        public static Task<GetUpdateResult> InvokeAsync(GetUpdateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUpdateResult>("azure-native:azurestackhci/v20231101preview:getUpdate", args ?? new GetUpdateArgs(), options.WithDefaults());
