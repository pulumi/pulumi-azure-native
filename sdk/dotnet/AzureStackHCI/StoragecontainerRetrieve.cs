...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci:StoragecontainerRetrieve")]
    public partial class StoragecontainerRetrieve : global::Pulumi.CustomResource
    {
        ...
        public StoragecontainerRetrieve(string name, StoragecontainerRetrieveArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:StoragecontainerRetrieve", name, args ?? new StoragecontainerRetrieveArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StoragecontainerRetrieve(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:StoragecontainerRetrieve", name, null, MakeResourceOptions(options, id))
        {
        }
