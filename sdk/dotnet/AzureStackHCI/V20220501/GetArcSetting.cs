...
{
    [Obsolete(@"azure-native:azurestackhci/v20220501:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:ArcSetting to guarantee forwards compatibility.")]
    public static class GetArcSetting
    {
        ...
        public static Task<GetArcSettingResult> InvokeAsync(GetArcSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetArcSettingResult>("azure-native:azurestackhci/v20220501:getArcSetting", args ?? new GetArcSettingArgs(), options.WithDefaults());

        /// <summary>
        /// Get ArcSetting resource details of HCI Cluster.
        /// </summary>
        public static Output<GetArcSettingResult> Invoke(GetArcSettingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetArcSettingResult>("azure-native:azurestackhci/v20220501:getArcSetting", args ?? new GetArcSettingInvokeArgs(), options.WithDefaults());
    }
