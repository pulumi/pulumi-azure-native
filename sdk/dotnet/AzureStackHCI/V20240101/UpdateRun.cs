...
namespace Pulumi.AzureNative.AzureStackHCI.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20240101:UpdateRun")]
    public partial class UpdateRun : global::Pulumi.CustomResource
    {
        ...
        public UpdateRun(string name, UpdateRunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240101:UpdateRun", name, args ?? new UpdateRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UpdateRun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240101:UpdateRun", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UpdateRunArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240101.UpdateRunPropertiesState>? State { get; set; }
