...
namespace Pulumi.AzureNative.AzureStackHCI.V20240101
{
    public static class GetLogicalNetwork
    {
        ...
        public static Task<GetLogicalNetworkResult> InvokeAsync(GetLogicalNetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLogicalNetworkResult>("azure-native:azurestackhci/v20240101:getLogicalNetwork", args ?? new GetLogicalNetworkArgs(), options.WithDefaults());

        /// <summary>
        /// The logical network resource definition.
        /// </summary>
        public static Output<GetLogicalNetworkResult> Invoke(GetLogicalNetworkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLogicalNetworkResult>("azure-native:azurestackhci/v20240101:getLogicalNetwork", args ?? new GetLogicalNetworkInvokeArgs(), options.WithDefaults());
