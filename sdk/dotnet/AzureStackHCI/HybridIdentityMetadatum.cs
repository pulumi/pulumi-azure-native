...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    public partial class HybridIdentityMetadatum : global::Pulumi.CustomResource
    {
        ...
        public HybridIdentityMetadatum(string name, HybridIdentityMetadatumArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:HybridIdentityMetadatum", name, args ?? new HybridIdentityMetadatumArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HybridIdentityMetadatum(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:HybridIdentityMetadatum", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_azurestackhci_v20210901preview:azurestackhci:HybridIdentityMetadatum" },
                    new global::Pulumi.Alias { Type = "azure-native_azurestackhci_v20221215preview:azurestackhci:HybridIdentityMetadatum" },
                },
            };
