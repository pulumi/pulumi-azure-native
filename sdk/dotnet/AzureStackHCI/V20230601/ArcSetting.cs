...
namespace Pulumi.AzureNative.AzureStackHCI.V20230601
{
    ...
    /// ArcSetting details.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20230601:ArcSetting")]
    public partial class ArcSetting : global::Pulumi.CustomResource
    {
        ...
        public ArcSetting(string name, ArcSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230601:ArcSetting", name, args ?? new ArcSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArcSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230601:ArcSetting", name, null, MakeResourceOptions(options, id))
        {
        }
