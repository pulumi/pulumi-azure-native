...
namespace Pulumi.AzureNative.AzureStackHCI.V20240501Preview
{
    public static class GetGalleryImage
    {
        ...
        public static Task<GetGalleryImageResult> InvokeAsync(GetGalleryImageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGalleryImageResult>("azure-native:azurestackhci/v20240501preview:getGalleryImage", args ?? new GetGalleryImageArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a gallery image
        /// </summary>
        public static Output<GetGalleryImageResult> Invoke(GetGalleryImageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGalleryImageResult>("azure-native:azurestackhci/v20240501preview:getGalleryImage", args ?? new GetGalleryImageInvokeArgs(), options.WithDefaults());
    }
