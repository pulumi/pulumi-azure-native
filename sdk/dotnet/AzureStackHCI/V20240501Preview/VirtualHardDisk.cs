...
namespace Pulumi.AzureNative.AzureStackHCI.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20240501preview:VirtualHardDisk")]
    public partial class VirtualHardDisk : global::Pulumi.CustomResource
    {
        ...
        public VirtualHardDisk(string name, VirtualHardDiskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240501preview:VirtualHardDisk", name, args ?? new VirtualHardDiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualHardDisk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240501preview:VirtualHardDisk", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualHardDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240501Preview.DiskFileFormat>? DiskFileFormat { get; set; }
