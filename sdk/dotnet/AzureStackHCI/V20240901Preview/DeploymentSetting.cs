...
namespace Pulumi.AzureNative.AzureStackHCI.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20240901preview:DeploymentSetting")]
    public partial class DeploymentSetting : global::Pulumi.CustomResource
    {
        ...
        public DeploymentSetting(string name, DeploymentSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240901preview:DeploymentSetting", name, args ?? new DeploymentSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240901preview:DeploymentSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeploymentSettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240901Preview.DeploymentMode> DeploymentMode { get; set; } = null!;
        ...
        /// </summary>
        [Input("operationType")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240901Preview.OperationType>? OperationType { get; set; }
