...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    public partial class SecurityRule : global::Pulumi.CustomResource
    {
        ...
        public SecurityRule(string name, SecurityRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:SecurityRule", name, args ?? new SecurityRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:SecurityRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20250601preview:SecurityRule" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20250901preview:SecurityRule" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260201preview:SecurityRule" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260401preview:SecurityRule" },
                },
            };
    ...
    public sealed class SecurityRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.SecurityRuleAccess> Access { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.SecurityRuleDirection> Direction { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.SecurityRuleProtocol> Protocol { get; set; } = null!;
