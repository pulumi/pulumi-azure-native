...
namespace Pulumi.AzureNative.AzureStackHCI.V20250401Preview
{
    public static class GetGuestAgent
    {
        ...
        public static Task<GetGuestAgentResult> InvokeAsync(GetGuestAgentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGuestAgentResult>("azure-native:azurestackhci/v20250401preview:getGuestAgent", args ?? new GetGuestAgentArgs(), options.WithDefaults());

        /// <summary>
        /// Implements GuestAgent GET method.
        /// </summary>
        public static Output<GetGuestAgentResult> Invoke(GetGuestAgentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGuestAgentResult>("azure-native:azurestackhci/v20250401preview:getGuestAgent", args ?? new GetGuestAgentInvokeArgs(), options.WithDefaults());
