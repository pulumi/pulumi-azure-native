...
namespace Pulumi.AzureNative.AzureStackHCI.V20250401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20250401preview:GalleryImage")]
    public partial class GalleryImage : global::Pulumi.CustomResource
    {
        ...
        public GalleryImage(string name, GalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250401preview:GalleryImage", name, args ?? new GalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20250401preview:GalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
