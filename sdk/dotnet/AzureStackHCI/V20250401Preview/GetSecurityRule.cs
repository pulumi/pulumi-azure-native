...
namespace Pulumi.AzureNative.AzureStackHCI.V20250401Preview
{
    public static class GetSecurityRule
    {
        ...
        public static Task<GetSecurityRuleResult> InvokeAsync(GetSecurityRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecurityRuleResult>("azure-native:azurestackhci/v20250401preview:getSecurityRule", args ?? new GetSecurityRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the specified security rule.
        /// </summary>
        public static Output<GetSecurityRuleResult> Invoke(GetSecurityRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecurityRuleResult>("azure-native:azurestackhci/v20250401preview:getSecurityRule", args ?? new GetSecurityRuleInvokeArgs(), options.WithDefaults());
