...
namespace Pulumi.AzureNative.AzureStackHCI.V20210901
{
    ...
    /// ArcSetting details.
    /// </summary>
    [Obsolete(@"azure-native:azurestackhci/v20210901:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20210901preview:ArcSetting to guarantee forwards compatibility.")]
    ...
    public partial class ArcSetting : global::Pulumi.CustomResource
    {
        ...
        public ArcSetting(string name, ArcSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210901:ArcSetting", name, args ?? new ArcSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArcSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210901:ArcSetting", name, null, MakeResourceOptions(options, id))
        {
        }
