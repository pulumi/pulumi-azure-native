...
namespace Pulumi.AzureNative.AzureStackHCI.V20230701Preview
{
    public static class GetVirtualHardDisk
    {
        ...
        public static Task<GetVirtualHardDiskResult> InvokeAsync(GetVirtualHardDiskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualHardDiskResult>("azure-native:azurestackhci/v20230701preview:getVirtualHardDisk", args ?? new GetVirtualHardDiskArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a virtual hard disk
        /// </summary>
        public static Output<GetVirtualHardDiskResult> Invoke(GetVirtualHardDiskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVirtualHardDiskResult>("azure-native:azurestackhci/v20230701preview:getVirtualHardDisk", args ?? new GetVirtualHardDiskInvokeArgs(), options.WithDefaults());
    }
