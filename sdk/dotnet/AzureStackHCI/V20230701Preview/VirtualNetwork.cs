...
namespace Pulumi.AzureNative.AzureStackHCI.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20230701preview:VirtualNetwork")]
    public partial class VirtualNetwork : global::Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230701preview:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230701preview:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualNetworkArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("networkType")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20230701Preview.NetworkTypeEnum>? NetworkType { get; set; }
