...
namespace Pulumi.AzureNative.AzureStackHCI.V20241201Preview
{
    public static class GetHciEdgeDevice
    {
        ...
        public static Task<GetHciEdgeDeviceResult> InvokeAsync(GetHciEdgeDeviceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHciEdgeDeviceResult>("azure-native:azurestackhci/v20241201preview:getHciEdgeDevice", args ?? new GetHciEdgeDeviceArgs(), options.WithDefaults());

        /// <summary>
        /// Get a EdgeDevice
        /// </summary>
        public static Output<GetHciEdgeDeviceResult> Invoke(GetHciEdgeDeviceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHciEdgeDeviceResult>("azure-native:azurestackhci/v20241201preview:getHciEdgeDevice", args ?? new GetHciEdgeDeviceInvokeArgs(), options.WithDefaults());
