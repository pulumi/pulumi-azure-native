...
namespace Pulumi.AzureNative.AzureStackHCI.V20241201Preview
{
    ...
    /// Update details
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20241201preview:Update")]
    public partial class Update : global::Pulumi.CustomResource
    {
        ...
        public Update(string name, UpdateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20241201preview:Update", name, args ?? new UpdateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Update(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20241201preview:Update", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UpdateArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20241201Preview.AvailabilityType>? AvailabilityType { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20241201Preview.State>? State { get; set; }
