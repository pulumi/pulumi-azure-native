...
namespace Pulumi.AzureNative.AzureStackHCI.V20241201Preview
{
    public static class GetUpdateRun
    {
        ...
        public static Task<GetUpdateRunResult> InvokeAsync(GetUpdateRunArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUpdateRunResult>("azure-native:azurestackhci/v20241201preview:getUpdateRun", args ?? new GetUpdateRunArgs(), options.WithDefaults());

        /// <summary>
        /// Get the Update run for a specified update
        /// </summary>
        public static Output<GetUpdateRunResult> Invoke(GetUpdateRunInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUpdateRunResult>("azure-native:azurestackhci/v20241201preview:getUpdateRun", args ?? new GetUpdateRunInvokeArgs(), options.WithDefaults());
