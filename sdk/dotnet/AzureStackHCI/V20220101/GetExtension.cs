...
namespace Pulumi.AzureNative.AzureStackHCI.V20220101
{
    public static class GetExtension
    {
        ...
        public static Task<GetExtensionResult> InvokeAsync(GetExtensionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExtensionResult>("azure-native:azurestackhci/v20220101:getExtension", args ?? new GetExtensionArgs(), options.WithDefaults());

        /// <summary>
        /// Get particular Arc Extension of HCI Cluster.
        /// </summary>
        public static Output<GetExtensionResult> Invoke(GetExtensionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExtensionResult>("azure-native:azurestackhci/v20220101:getExtension", args ?? new GetExtensionInvokeArgs(), options.WithDefaults());
    }
