...
namespace Pulumi.AzureNative.AzureStackHCI.V20220101
{
    public static class GetCluster
    {
        ...
        public static Task<GetClusterResult> InvokeAsync(GetClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetClusterResult>("azure-native:azurestackhci/v20220101:getCluster", args ?? new GetClusterArgs(), options.WithVersion());

        /// <summary>
        /// Cluster details.
        /// </summary>
        public static Output<GetClusterResult> Invoke(GetClusterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetClusterResult>("azure-native:azurestackhci/v20220101:getCluster", args ?? new GetClusterInvokeArgs(), options.WithVersion());
    }
