...
{
    [Obsolete(@"azure-native:azurestackhci/v20220101:ArcSetting is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20221001:ArcSetting to guarantee forwards compatibility.")]
    public static class GetArcSetting
    {
        ...
        public static Task<GetArcSettingResult> InvokeAsync(GetArcSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetArcSettingResult>("azure-native:azurestackhci/v20220101:getArcSetting", args ?? new GetArcSettingArgs(), options.WithDefaults());

        /// <summary>
        /// Get ArcSetting resource details of HCI Cluster.
        /// </summary>
        public static Output<GetArcSettingResult> Invoke(GetArcSettingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetArcSettingResult>("azure-native:azurestackhci/v20220101:getArcSetting", args ?? new GetArcSettingInvokeArgs(), options.WithDefaults());
    }
