...
namespace Pulumi.AzureNative.AzureStackHCI.V20220301
{
    ...
    /// ArcSetting details.
    /// </summary>
    [Obsolete(@"azure-native:azurestackhci/v20220301:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:ArcSetting to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:azurestackhci/v20220301:ArcSetting")]
    public partial class ArcSetting : global::Pulumi.CustomResource
    {
        ...
        public ArcSetting(string name, ArcSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20220301:ArcSetting", name, args ?? new ArcSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArcSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20220301:ArcSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ArcSettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createdByType")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20220301.CreatedByType>? CreatedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20220301.CreatedByType>? LastModifiedByType { get; set; }
