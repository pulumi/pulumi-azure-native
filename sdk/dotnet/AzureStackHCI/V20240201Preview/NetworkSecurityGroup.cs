...
namespace Pulumi.AzureNative.AzureStackHCI.V20240201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20240201preview:NetworkSecurityGroup")]
    public partial class NetworkSecurityGroup : global::Pulumi.CustomResource
    {
        ...
        public NetworkSecurityGroup(string name, NetworkSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240201preview:NetworkSecurityGroup", name, args ?? new NetworkSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240201preview:NetworkSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
