...
namespace Pulumi.AzureNative.AzureStackHCI.V20240201Preview
{
    public static class GetStorageContainer
    {
        ...
        public static Task<GetStorageContainerResult> InvokeAsync(GetStorageContainerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStorageContainerResult>("azure-native:azurestackhci/v20240201preview:getStorageContainer", args ?? new GetStorageContainerArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a storage container
        /// </summary>
        public static Output<GetStorageContainerResult> Invoke(GetStorageContainerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStorageContainerResult>("azure-native:azurestackhci/v20240201preview:getStorageContainer", args ?? new GetStorageContainerInvokeArgs(), options.WithDefaults());
