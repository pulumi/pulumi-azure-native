...
namespace Pulumi.AzureNative.AzureStackHCI.V20240401
{
    public static class GetUpdate
    {
        ...
        public static Task<GetUpdateResult> InvokeAsync(GetUpdateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUpdateResult>("azure-native:azurestackhci/v20240401:getUpdate", args ?? new GetUpdateArgs(), options.WithDefaults());

        /// <summary>
        /// Get specified Update
        /// </summary>
        public static Output<GetUpdateResult> Invoke(GetUpdateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUpdateResult>("azure-native:azurestackhci/v20240401:getUpdate", args ?? new GetUpdateInvokeArgs(), options.WithDefaults());
