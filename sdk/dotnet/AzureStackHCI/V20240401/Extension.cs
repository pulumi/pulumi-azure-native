...
namespace Pulumi.AzureNative.AzureStackHCI.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20240401:Extension")]
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240401:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240401:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
