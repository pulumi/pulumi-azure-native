...
namespace Pulumi.AzureNative.AzureStackHCI.V20240401.Inputs
{
    ...
    public sealed class ClusterDesiredPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240401.DiagnosticLevel>? DiagnosticLevel { get; set; }

        /// <summary>
        /// Desired state of Windows Server Subscription.
        /// </summary>
        [Input("windowsServerSubscription")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240401.WindowsServerSubscription>? WindowsServerSubscription { get; set; }
