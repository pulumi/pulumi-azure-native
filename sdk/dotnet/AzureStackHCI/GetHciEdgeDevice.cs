...
namespace Pulumi.AzureNative.AzureStackHCI
{
    public static class GetHciEdgeDevice
    {
        ...
        public static Task<GetHciEdgeDeviceResult> InvokeAsync(GetHciEdgeDeviceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHciEdgeDeviceResult>("azure-native:azurestackhci:getHciEdgeDevice", args ?? new GetHciEdgeDeviceArgs(), options.WithDefaults());
        ...
        public static Output<GetHciEdgeDeviceResult> Invoke(GetHciEdgeDeviceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHciEdgeDeviceResult>("azure-native:azurestackhci:getHciEdgeDevice", args ?? new GetHciEdgeDeviceInvokeArgs(), options.WithDefaults());
