...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    public partial class NatGateway : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NatGatewayPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public NatGateway(string name, NatGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:NatGateway", name, args ?? new NatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:NatGateway", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20250901preview:NatGateway" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260201preview:NatGateway" },
                    new global::Pulumi.Alias { Type = "azure-native:azurestackhci/v20260401preview:NatGateway" },
                },
            };
    ...
    public sealed class NatGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.NatGatewayPropertiesArgs>? Properties { get; set; }
