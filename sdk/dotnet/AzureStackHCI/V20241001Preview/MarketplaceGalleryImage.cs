...
namespace Pulumi.AzureNative.AzureStackHCI.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20241001preview:MarketplaceGalleryImage")]
    public partial class MarketplaceGalleryImage : global::Pulumi.CustomResource
    {
        ...
        public MarketplaceGalleryImage(string name, MarketplaceGalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20241001preview:MarketplaceGalleryImage", name, args ?? new MarketplaceGalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MarketplaceGalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20241001preview:MarketplaceGalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MarketplaceGalleryImageArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20241001Preview.CloudInitDataSource>? CloudInitDataSource { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20241001Preview.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20241001Preview.OperatingSystemTypes> OsType { get; set; } = null!;
