...
namespace Pulumi.AzureNative.AzureStackHCI.V20230301
{
    ...
    /// {
    ///     var updateSummary = new AzureNative.AzureStackHCI.V20230301.UpdateSummary("updateSummary", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20230301:UpdateSummary")]
    public partial class UpdateSummary : global::Pulumi.CustomResource
    {
        ...
        public UpdateSummary(string name, UpdateSummaryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230301:UpdateSummary", name, args ?? new UpdateSummaryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UpdateSummary(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230301:UpdateSummary", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UpdateSummaryArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20230301.UpdateSummariesPropertiesState>? State { get; set; }
