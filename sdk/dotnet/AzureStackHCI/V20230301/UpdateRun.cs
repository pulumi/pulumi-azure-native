...
namespace Pulumi.AzureNative.AzureStackHCI.V20230301
{
    ...
    /// {
    ///     var updateRun = new AzureNative.AzureStackHCI.V20230301.UpdateRun("updateRun", new()
    ///     {
    ...
    ///         Steps = new[]
    ///         {
    ///             new AzureNative.AzureStackHCI.V20230301.Inputs.StepArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:azurestackhci/v20230301:UpdateRun Microsoft4.2203.2.32/23b779ba-0d52-4a80-8571-45ca74664ec3 /subscriptions/b8d594e5-51f3-4c11-9c54-a7771b81c712/resourceGroups/testrg/providers/Microsoft.AzureStackHCI/clusters/testcluster/updates/Microsoft4.2203.2.32/updateRuns/23b779ba-0d52-4a80-8571-45ca74664ec3 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20230301:UpdateRun")]
    public partial class UpdateRun : global::Pulumi.CustomResource
    {
        ...
        public UpdateRun(string name, UpdateRunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230301:UpdateRun", name, args ?? new UpdateRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UpdateRun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230301:UpdateRun", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UpdateRunArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20230301.UpdateRunPropertiesState>? State { get; set; }
