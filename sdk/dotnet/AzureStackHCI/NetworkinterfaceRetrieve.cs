...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci:NetworkinterfaceRetrieve")]
    public partial class NetworkinterfaceRetrieve : global::Pulumi.CustomResource
    {
        ...
        public NetworkinterfaceRetrieve(string name, NetworkinterfaceRetrieveArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:NetworkinterfaceRetrieve", name, args ?? new NetworkinterfaceRetrieveArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkinterfaceRetrieve(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:NetworkinterfaceRetrieve", name, null, MakeResourceOptions(options, id))
        {
        }
