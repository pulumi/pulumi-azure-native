...
namespace Pulumi.AzureNative.AzureStackHCI.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20240801preview:GalleryImage")]
    public partial class GalleryImage : global::Pulumi.CustomResource
    {
        ...
        public GalleryImage(string name, GalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240801preview:GalleryImage", name, args ?? new GalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240801preview:GalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
