...
namespace Pulumi.AzureNative.AzureStackHCI.V20240801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20240801preview:MarketplaceGalleryImage")]
    public partial class MarketplaceGalleryImage : global::Pulumi.CustomResource
    {
        ...
        public MarketplaceGalleryImage(string name, MarketplaceGalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240801preview:MarketplaceGalleryImage", name, args ?? new MarketplaceGalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MarketplaceGalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240801preview:MarketplaceGalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MarketplaceGalleryImageArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240801Preview.CloudInitDataSource>? CloudInitDataSource { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240801Preview.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240801Preview.OperatingSystemTypes> OsType { get; set; } = null!;
