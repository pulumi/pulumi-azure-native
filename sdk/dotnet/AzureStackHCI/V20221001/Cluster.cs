...
namespace Pulumi.AzureNative.AzureStackHCI.V20221001
{
    ...
    /// {
    ///     var cluster = new AzureNative.AzureStackHCI.V20221001.Cluster("cluster", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:azurestackhci/v20221001:Cluster myCluster /subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/test-rg/providers/Microsoft.AzureStackHCI/clusters/myCluster 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20221001:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221001:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221001:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createdByType")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20221001.CreatedByType>? CreatedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20221001.CreatedByType>? LastModifiedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20221001.ManagedServiceIdentityType> Type { get; set; } = null!;
