...
namespace Pulumi.AzureNative.AzureStackHCI.V20221001
{
    ...
    /// {
    ///     var arcSetting = new AzureNative.AzureStackHCI.V20221001.ArcSetting("arcSetting", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20221001:ArcSetting")]
    public partial class ArcSetting : global::Pulumi.CustomResource
    {
        ...
        public ArcSetting(string name, ArcSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221001:ArcSetting", name, args ?? new ArcSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArcSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20221001:ArcSetting", name, null, MakeResourceOptions(options, id))
        {
        }
