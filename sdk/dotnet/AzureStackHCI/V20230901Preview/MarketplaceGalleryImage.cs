...
namespace Pulumi.AzureNative.AzureStackHCI.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20230901preview:MarketplaceGalleryImage")]
    public partial class MarketplaceGalleryImage : global::Pulumi.CustomResource
    {
        ...
        public MarketplaceGalleryImage(string name, MarketplaceGalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230901preview:MarketplaceGalleryImage", name, args ?? new MarketplaceGalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MarketplaceGalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230901preview:MarketplaceGalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
