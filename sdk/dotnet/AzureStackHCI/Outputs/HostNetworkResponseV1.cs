...
namespace Pulumi.AzureNative.AzureStackHCI.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class HostNetworkResponseV1
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.IntentsResponseV1> Intents;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.StorageNetworksResponseV1> StorageNetworks;

        [OutputConstructor]
        private HostNetworkResponseV1(
            bool enableStorageAutoIp,

            ImmutableArray<Outputs.IntentsResponseV1> intents,

            bool storageConnectivitySwitchless,

            ImmutableArray<Outputs.StorageNetworksResponseV1> storageNetworks)
        {
