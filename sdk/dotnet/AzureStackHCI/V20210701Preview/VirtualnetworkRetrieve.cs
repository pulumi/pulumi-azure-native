...
namespace Pulumi.AzureNative.AzureStackHCI.V20210701Preview
{
    ...
    public partial class VirtualnetworkRetrieve : global::Pulumi.CustomResource
    {
        ...
        public VirtualnetworkRetrieve(string name, VirtualnetworkRetrieveArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210701preview:virtualnetworkRetrieve", name, args ?? new VirtualnetworkRetrieveArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualnetworkRetrieve(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210701preview:virtualnetworkRetrieve", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualnetworkRetrieveArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("networkType")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20210701Preview.NetworkTypeEnum>? NetworkType { get; set; }
