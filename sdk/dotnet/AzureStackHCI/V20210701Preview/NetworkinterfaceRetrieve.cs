...
namespace Pulumi.AzureNative.AzureStackHCI.V20210701Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:azurestackhci/v20210701preview:networkinterfaceRetrieve is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20210901preview:networkinterfaceRetrieve to guarantee forwards compatibility.")]
    ...
    public partial class NetworkinterfaceRetrieve : global::Pulumi.CustomResource
    {
        ...
        public NetworkinterfaceRetrieve(string name, NetworkinterfaceRetrieveArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210701preview:networkinterfaceRetrieve", name, args ?? new NetworkinterfaceRetrieveArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkinterfaceRetrieve(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20210701preview:networkinterfaceRetrieve", name, null, MakeResourceOptions(options, id))
        {
        }
