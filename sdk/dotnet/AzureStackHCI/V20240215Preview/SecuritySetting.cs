...
namespace Pulumi.AzureNative.AzureStackHCI.V20240215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20240215preview:SecuritySetting")]
    public partial class SecuritySetting : global::Pulumi.CustomResource
    {
        ...
        public SecuritySetting(string name, SecuritySettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240215preview:SecuritySetting", name, args ?? new SecuritySettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecuritySetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20240215preview:SecuritySetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecuritySettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20240215Preview.ComplianceAssignmentType>? SecuredCoreComplianceAssignment { get; set; }
