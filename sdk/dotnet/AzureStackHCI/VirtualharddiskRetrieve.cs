...
namespace Pulumi.AzureNative.AzureStackHCI
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci:VirtualharddiskRetrieve")]
    public partial class VirtualharddiskRetrieve : global::Pulumi.CustomResource
    {
        ...
        public VirtualharddiskRetrieve(string name, VirtualharddiskRetrieveArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:VirtualharddiskRetrieve", name, args ?? new VirtualharddiskRetrieveArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualharddiskRetrieve(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci:VirtualharddiskRetrieve", name, null, MakeResourceOptions(options, id))
        {
        }
