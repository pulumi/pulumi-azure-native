...
namespace Pulumi.AzureNative.AzureStackHCI.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestackhci/v20230801preview:UpdateRun")]
    public partial class UpdateRun : global::Pulumi.CustomResource
    {
        ...
        public UpdateRun(string name, UpdateRunArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230801preview:UpdateRun", name, args ?? new UpdateRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UpdateRun(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestackhci/v20230801preview:UpdateRun", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UpdateRunArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.AzureStackHCI.V20230801Preview.UpdateRunPropertiesState>? State { get; set; }
