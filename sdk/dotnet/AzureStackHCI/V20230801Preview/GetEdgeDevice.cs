...
namespace Pulumi.AzureNative.AzureStackHCI.V20230801Preview
{
    public static class GetEdgeDevice
    {
        ...
        public static Task<GetEdgeDeviceResult> InvokeAsync(GetEdgeDeviceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEdgeDeviceResult>("azure-native:azurestackhci/v20230801preview:getEdgeDevice", args ?? new GetEdgeDeviceArgs(), options.WithDefaults());
