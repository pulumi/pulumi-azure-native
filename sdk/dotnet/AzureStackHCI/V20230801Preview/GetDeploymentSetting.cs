...
namespace Pulumi.AzureNative.AzureStackHCI.V20230801Preview
{
    public static class GetDeploymentSetting
    {
        ...
        public static Task<GetDeploymentSettingResult> InvokeAsync(GetDeploymentSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentSettingResult>("azure-native:azurestackhci/v20230801preview:getDeploymentSetting", args ?? new GetDeploymentSettingArgs(), options.WithDefaults());

        /// <summary>
        /// Get a DeploymentSetting
        /// </summary>
        public static Output<GetDeploymentSettingResult> Invoke(GetDeploymentSettingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDeploymentSettingResult>("azure-native:azurestackhci/v20230801preview:getDeploymentSetting", args ?? new GetDeploymentSettingInvokeArgs(), options.WithDefaults());
    }
