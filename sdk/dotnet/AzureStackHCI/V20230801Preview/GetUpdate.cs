...
namespace Pulumi.AzureNative.AzureStackHCI.V20230801Preview
{
    public static class GetUpdate
    {
        ...
        public static Task<GetUpdateResult> InvokeAsync(GetUpdateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUpdateResult>("azure-native:azurestackhci/v20230801preview:getUpdate", args ?? new GetUpdateArgs(), options.WithDefaults());

        /// <summary>
        /// Get specified Update
        /// </summary>
        public static Output<GetUpdateResult> Invoke(GetUpdateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUpdateResult>("azure-native:azurestackhci/v20230801preview:getUpdate", args ?? new GetUpdateInvokeArgs(), options.WithDefaults());
    }
