...
namespace Pulumi.AzureRM.Kusto
{
    ...
    public partial class ClusterPrincipalAssignment : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ClusterPrincipalPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public ClusterPrincipalAssignment(string name, ClusterPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto:ClusterPrincipalAssignment", name, args ?? new ClusterPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ClusterPrincipalAssignment(string name, Input<string> id, ClusterPrincipalAssignmentState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:kusto:ClusterPrincipalAssignment", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterPrincipalAssignmentState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ClusterPrincipalPropertiesResponseGetArgs> Properties { get; set; } = null!;
