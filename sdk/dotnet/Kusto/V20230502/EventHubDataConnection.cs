...
namespace Pulumi.AzureNative.Kusto.V20230502
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20230502:EventHubDataConnection")]
    public partial class EventHubDataConnection : global::Pulumi.CustomResource
    {
        ...
        public EventHubDataConnection(string name, EventHubDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230502:EventHubDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventHubDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230502:EventHubDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("compression")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20230502.Compression>? Compression { get; set; }
        ...
        /// </summary>
        [Input("dataFormat")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20230502.EventHubDataFormat>? DataFormat { get; set; }
