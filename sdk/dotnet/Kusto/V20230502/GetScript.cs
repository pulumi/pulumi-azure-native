...
namespace Pulumi.AzureNative.Kusto.V20230502
{
    public static class GetScript
    {
        ...
        public static Task<GetScriptResult> InvokeAsync(GetScriptArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScriptResult>("azure-native:kusto/v20230502:getScript", args ?? new GetScriptArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a Kusto cluster database script.
        /// </summary>
        public static Output<GetScriptResult> Invoke(GetScriptInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScriptResult>("azure-native:kusto/v20230502:getScript", args ?? new GetScriptInvokeArgs(), options.WithDefaults());
    }
