...
namespace Pulumi.AzureNative.Kusto.V20230502
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20230502:ManagedPrivateEndpoint")]
    public partial class ManagedPrivateEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ManagedPrivateEndpoint(string name, ManagedPrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230502:ManagedPrivateEndpoint", name, args ?? new ManagedPrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedPrivateEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230502:ManagedPrivateEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
