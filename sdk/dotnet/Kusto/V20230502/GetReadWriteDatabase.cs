...
namespace Pulumi.AzureNative.Kusto.V20230502
{
    public static class GetReadWriteDatabase
    {
        ...
        public static Task<GetReadWriteDatabaseResult> InvokeAsync(GetReadWriteDatabaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReadWriteDatabaseResult>("azure-native:kusto/v20230502:getReadWriteDatabase", args ?? new GetReadWriteDatabaseArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a database.
        /// </summary>
        public static Output<GetReadWriteDatabaseResult> Invoke(GetReadWriteDatabaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReadWriteDatabaseResult>("azure-native:kusto/v20230502:getReadWriteDatabase", args ?? new GetReadWriteDatabaseInvokeArgs(), options.WithDefaults());
    }
