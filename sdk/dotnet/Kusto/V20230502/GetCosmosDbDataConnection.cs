...
namespace Pulumi.AzureNative.Kusto.V20230502
{
    public static class GetCosmosDbDataConnection
    {
        ...
        public static Task<GetCosmosDbDataConnectionResult> InvokeAsync(GetCosmosDbDataConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCosmosDbDataConnectionResult>("azure-native:kusto/v20230502:getCosmosDbDataConnection", args ?? new GetCosmosDbDataConnectionArgs(), options.WithDefaults());
        ...
        public static Output<GetCosmosDbDataConnectionResult> Invoke(GetCosmosDbDataConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCosmosDbDataConnectionResult>("azure-native:kusto/v20230502:getCosmosDbDataConnection", args ?? new GetCosmosDbDataConnectionInvokeArgs(), options.WithDefaults());
