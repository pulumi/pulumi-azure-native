...
namespace Pulumi.AzureNative.Kusto.V20220707
{
    ...
    [AzureNativeResourceType("azure-native:kusto/v20220707:DataConnection")]
    public partial class DataConnection : global::Pulumi.CustomResource
    {
        ...
        public DataConnection(string name, DataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:DataConnection", name, args ?? new DataConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:DataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20220707.DataConnectionKind> Kind { get; set; } = null!;
