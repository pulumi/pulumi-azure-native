...
namespace Pulumi.AzureNative.Kusto.V20220707
{
    ...
    public partial class EventHubDataConnection : global::Pulumi.CustomResource
    {
        ...
        public EventHubDataConnection(string name, EventHubDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:EventHubDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventHubDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:EventHubDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("compression")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20220707.Compression>? Compression { get; set; }
        ...
        /// </summary>
        [Input("dataFormat")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20220707.EventHubDataFormat>? DataFormat { get; set; }
