...
namespace Pulumi.AzureNative.Kusto.V20220707
{
    ...
    [AzureNativeResourceType("azure-native:kusto/v20220707:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:Database", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20220707.Kind> Kind { get; set; } = null!;
