...
namespace Pulumi.AzureNative.Kusto.V20220707
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20220707:DatabasePrincipalAssignment")]
    public partial class DatabasePrincipalAssignment : global::Pulumi.CustomResource
    {
        ...
        public DatabasePrincipalAssignment(string name, DatabasePrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:DatabasePrincipalAssignment", name, args ?? new DatabasePrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabasePrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:DatabasePrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabasePrincipalAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20220707.DatabasePrincipalRole> Role { get; set; } = null!;
