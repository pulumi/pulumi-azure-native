...
namespace Pulumi.AzureNative.Kusto.V20220707
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kusto/v20220707:IotHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:kusto/v20220707:IotHubDataConnection")]
    public partial class IotHubDataConnection : global::Pulumi.CustomResource
    {
        ...
        public IotHubDataConnection(string name, IotHubDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:IotHubDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IotHubDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220707:IotHubDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IotHubDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataFormat")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20220707.IotHubDataFormat>? DataFormat { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20220707.DatabaseRouting>? DatabaseRouting { get; set; }
