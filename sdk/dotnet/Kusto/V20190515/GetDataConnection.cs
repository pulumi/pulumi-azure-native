...
namespace Pulumi.AzureRM.Kusto.V20190515
{
    public static class GetDataConnection
    {
        public static Task<GetDataConnectionResult> InvokeAsync(GetDataConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectionResult>("azurerm:kusto/v20190515:getDataConnection", args ?? new GetDataConnectionArgs(), options.WithVersion());
    }
