...
namespace Pulumi.AzureRM.Kusto.V20190515
{
    ...
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20190515:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20190515:Database", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:kusto/v20190121:Database"},
                    new Alias { Type = "azurerm:kusto/v20190907:Database"},
                    new Alias { Type = "azurerm:kusto/v20191109:Database"},
                    new Alias { Type = "azurerm:kusto/v20200215:Database"},
                    new Alias { Type = "azurerm:kusto/v20200614:Database"},
                },
            };
