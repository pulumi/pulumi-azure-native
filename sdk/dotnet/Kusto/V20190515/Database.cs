...
namespace Pulumi.AzureNextGen.Kusto.V20190515
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:kusto/v20190515:Database")]
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20190515:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20190515:Database", name, null, MakeResourceOptions(options, id))
        {
        }
