...
namespace Pulumi.AzureNative.Kusto.V20190515
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20190515:Database")]
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190515:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190515:Database", name, null, MakeResourceOptions(options, id))
        {
        }
