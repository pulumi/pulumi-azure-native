...
namespace Pulumi.AzureNative.Kusto.V20190515
{
    ...
    /// {
    ///     var eventGridDataConnection = new AzureNative.Kusto.V20190515.EventGridDataConnection("eventGridDataConnection", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:kusto/v20190515:EventGridDataConnection KustoClusterRPTest4/KustoDatabase8/DataConnections8 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/KustoClusterRPTest4/Databases/KustoDatabase8/DataConnections/DataConnections8 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20190515:EventGridDataConnection")]
    public partial class EventGridDataConnection : global::Pulumi.CustomResource
    {
        ...
        public EventGridDataConnection(string name, EventGridDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190515:EventGridDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventGridDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190515:EventGridDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventGridDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20190515.DataFormat> DataFormat { get; set; } = null!;
