...
namespace Pulumi.AzureNextGen.Kusto.V20190515
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:kusto/v20190515:DataConnection")]
    public partial class DataConnection : Pulumi.CustomResource
    {
        ...
        public DataConnection(string name, DataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20190515:DataConnection", name, args ?? new DataConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20190515:DataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataConnectionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Kusto.V20190515.Kind> Kind { get; set; } = null!;
