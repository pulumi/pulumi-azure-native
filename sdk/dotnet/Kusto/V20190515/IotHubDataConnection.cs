...
namespace Pulumi.AzureNative.Kusto.V20190515
{
    ...
    /// {
    ///     var iotHubDataConnection = new AzureNative.Kusto.V20190515.IotHubDataConnection("iotHubDataConnection", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20190515:IotHubDataConnection")]
    public partial class IotHubDataConnection : global::Pulumi.CustomResource
    {
        ...
        public IotHubDataConnection(string name, IotHubDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190515:IotHubDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IotHubDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190515:IotHubDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
