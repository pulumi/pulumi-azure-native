...
namespace Pulumi.AzureNative.Kusto.V20190121
{
    public static class GetCluster
    {
        ...
        public static Task<GetClusterResult> InvokeAsync(GetClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetClusterResult>("azure-native:kusto/v20190121:getCluster", args ?? new GetClusterArgs(), options.WithDefaults());

        /// <summary>
        /// Class representing a Kusto cluster.
        /// </summary>
        public static Output<GetClusterResult> Invoke(GetClusterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetClusterResult>("azure-native:kusto/v20190121:getCluster", args ?? new GetClusterInvokeArgs(), options.WithDefaults());
    }
