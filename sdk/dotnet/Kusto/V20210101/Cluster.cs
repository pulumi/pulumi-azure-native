...
namespace Pulumi.AzureNative.Kusto.V20210101
{
    ...
    /// {
    ///     var cluster = new AzureNative.Kusto.V20210101.Cluster("cluster", new()
    ///     {
    ///         ClusterName = "kustoclusterrptest4",
    ///         EnableDoubleEncryption = false,
    ///         EnablePurge = true,
    ///         EnableStreamingIngest = true,
    ///         Identity = new AzureNative.Kusto.V20210101.Inputs.IdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Location = "westus",
    ///         ResourceGroupName = "kustorptest",
    ///         Sku = new AzureNative.Kusto.V20210101.Inputs.AzureSkuArgs
    ///         {
    ///             Capacity = 2,
    ///             Name = "Standard_L8s",
    ///             Tier = "Standard",
    ...
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210101:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210101:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("engineType")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20210101.EngineType>? EngineType { get; set; }
