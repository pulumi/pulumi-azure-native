...
namespace Pulumi.AzureNative.Kusto.V20210101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kusto/v20210101:AttachedDatabaseConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:AttachedDatabaseConfiguration to guarantee forwards compatibility.")]
    ...
    public partial class AttachedDatabaseConfiguration : global::Pulumi.CustomResource
    {
        ...
        public AttachedDatabaseConfiguration(string name, AttachedDatabaseConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210101:AttachedDatabaseConfiguration", name, args ?? new AttachedDatabaseConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDatabaseConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210101:AttachedDatabaseConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AttachedDatabaseConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20210101.DefaultPrincipalsModificationKind> DefaultPrincipalsModificationKind { get; set; } = null!;
