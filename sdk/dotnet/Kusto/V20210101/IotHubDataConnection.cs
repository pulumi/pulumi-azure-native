...
namespace Pulumi.AzureNative.Kusto.V20210101
{
    ...
    /// {
    ///     var iotHubDataConnection = new AzureNative.Kusto.V20210101.IotHubDataConnection("iotHubDataConnection", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:kusto/v20210101:IotHubDataConnection KustoClusterRPTest4/KustoDatabase8/DataConnections8 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/KustoClusterRPTest4/Databases/KustoDatabase8/DataConnections/DataConnections8 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20210101:IotHubDataConnection")]
    public partial class IotHubDataConnection : global::Pulumi.CustomResource
    {
        ...
        public IotHubDataConnection(string name, IotHubDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210101:IotHubDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IotHubDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210101:IotHubDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IotHubDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataFormat")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20210101.IotHubDataFormat>? DataFormat { get; set; }
