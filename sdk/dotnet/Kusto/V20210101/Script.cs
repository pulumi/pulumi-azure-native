...
namespace Pulumi.AzureNative.Kusto.V20210101
{
    ...
    /// {
    ///     var script = new AzureNative.Kusto.V20210101.Script("script", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:kusto/v20210101:Script KustoClusterRPTest4/KustoDatabase8/kustoScript1 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/KustoClusterRPTest4/Databases/KustoDatabase8/Scripts/kustoScript1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20210101:Script")]
    public partial class Script : global::Pulumi.CustomResource
    {
        ...
        public Script(string name, ScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210101:Script", name, args ?? new ScriptArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Script(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210101:Script", name, null, MakeResourceOptions(options, id))
        {
        }
