...
namespace Pulumi.AzureNative.Kusto.V20191109
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kusto/v20191109:EventHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:EventHubDataConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:kusto/v20191109:EventHubDataConnection")]
    public partial class EventHubDataConnection : global::Pulumi.CustomResource
    {
        ...
        public EventHubDataConnection(string name, EventHubDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20191109:EventHubDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventHubDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20191109:EventHubDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("compression")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20191109.Compression>? Compression { get; set; }
        ...
        /// </summary>
        [Input("dataFormat")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20191109.EventHubDataFormat>? DataFormat { get; set; }
