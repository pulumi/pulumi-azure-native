...
namespace Pulumi.AzureNextGen.Kusto.V20191109
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:kusto/v20191109:Database")]
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20191109:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20191109:Database", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Kusto.V20191109.Kind> Kind { get; set; } = null!;
