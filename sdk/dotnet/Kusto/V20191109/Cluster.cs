...
namespace Pulumi.AzureRM.Kusto.V20191109
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cluster = new AzureRM.Kusto.V20191109.Cluster("cluster", new AzureRM.Kusto.V20191109.ClusterArgs
    ///         {
    ///             ClusterName = "KustoClusterRPTest4",
    ///             EnableStreamingIngest = true,
    ///             Identity = new AzureRM.Kusto.V20191109.Inputs.IdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             KeyVaultProperties = new AzureRM.Kusto.V20191109.Inputs.KeyVaultPropertiesArgs
    ///             {
    ///                 KeyName = "keyName",
    ...
    ///             Sku = new AzureRM.Kusto.V20191109.Inputs.AzureSkuArgs
    ///             {
    ///                 Capacity = 2,
    ///                 Name = "Standard_L8s",
    ///                 Tier = "Standard",
