...
namespace Pulumi.AzureNative.Kusto.V20191109
{
    ...
    /// {
    ///     var readWriteDatabase = new AzureNative.Kusto.V20191109.ReadWriteDatabase("readWriteDatabase", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20191109:ReadWriteDatabase")]
    public partial class ReadWriteDatabase : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("isFollowed")]
        public Output<string> IsFollowed { get; private set; } = null!;
        ...
        public ReadWriteDatabase(string name, ReadWriteDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20191109:ReadWriteDatabase", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ReadWriteDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20191109:ReadWriteDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
