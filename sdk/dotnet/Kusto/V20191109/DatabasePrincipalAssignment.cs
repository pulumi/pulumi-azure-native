...
namespace Pulumi.AzureRM.Kusto.V20191109
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databasePrincipalAssignment = new AzureRM.Kusto.V20191109.DatabasePrincipalAssignment("databasePrincipalAssignment", new AzureRM.Kusto.V20191109.DatabasePrincipalAssignmentArgs
    ///         {
    ...
    public partial class DatabasePrincipalAssignment : Pulumi.CustomResource
    {
        ...
        public DatabasePrincipalAssignment(string name, DatabasePrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20191109:DatabasePrincipalAssignment", name, args ?? new DatabasePrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabasePrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20191109:DatabasePrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:kusto/v20200215:DatabasePrincipalAssignment"},
