...
namespace Pulumi.AzureRM.Kusto.V20191109
{
    ...
    ///     public MyStack()
    ///     {
    ///         var attachedDatabaseConfiguration = new AzureRM.Kusto.V20191109.AttachedDatabaseConfiguration("attachedDatabaseConfiguration", new AzureRM.Kusto.V20191109.AttachedDatabaseConfigurationArgs
    ///         {
    ...
    public partial class AttachedDatabaseConfiguration : Pulumi.CustomResource
    {
        ...
        public AttachedDatabaseConfiguration(string name, AttachedDatabaseConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20191109:AttachedDatabaseConfiguration", name, args ?? new AttachedDatabaseConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDatabaseConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20191109:AttachedDatabaseConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
