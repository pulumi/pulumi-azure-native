...
namespace Pulumi.AzureNextGen.Kusto.V20191109
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:kusto/v20191109:AttachedDatabaseConfiguration")]
    public partial class AttachedDatabaseConfiguration : Pulumi.CustomResource
    {
        ...
        public AttachedDatabaseConfiguration(string name, AttachedDatabaseConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20191109:AttachedDatabaseConfiguration", name, args ?? new AttachedDatabaseConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDatabaseConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20191109:AttachedDatabaseConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
