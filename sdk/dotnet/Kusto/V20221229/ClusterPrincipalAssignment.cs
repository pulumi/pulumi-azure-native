...
namespace Pulumi.AzureNative.Kusto.V20221229
{
    ...
    /// {
    ///     var clusterPrincipalAssignment = new AzureNative.Kusto.V20221229.ClusterPrincipalAssignment("clusterPrincipalAssignment", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221229:ClusterPrincipalAssignment")]
    public partial class ClusterPrincipalAssignment : global::Pulumi.CustomResource
    {
        ...
        public ClusterPrincipalAssignment(string name, ClusterPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:ClusterPrincipalAssignment", name, args ?? new ClusterPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterPrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:ClusterPrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterPrincipalAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20221229.ClusterPrincipalRole> Role { get; set; } = null!;
