...
namespace Pulumi.AzureNative.Kusto.V20221229
{
    ...
    /// {
    ///     var readWriteDatabase = new AzureNative.Kusto.V20221229.ReadWriteDatabase("readWriteDatabase", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:kusto/v20221229:ReadWriteDatabase kustoCluster/KustoDatabase8 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/kustoCluster/Databases/KustoDatabase8 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221229:ReadWriteDatabase")]
    public partial class ReadWriteDatabase : global::Pulumi.CustomResource
    {
        ...
        public ReadWriteDatabase(string name, ReadWriteDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:ReadWriteDatabase", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ReadWriteDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:ReadWriteDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
