...
namespace Pulumi.AzureNative.Kusto.V20221229
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.Kusto.V20221229.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         ClusterName = "kustoclusterrptest4",
    ///         PrivateEndpointConnectionName = "privateEndpointTest",
    ///         PrivateLinkServiceConnectionState = new AzureNative.Kusto.V20221229.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221229:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
