...
namespace Pulumi.AzureNative.Kusto.V20221229
{
    ...
    /// {
    ///     var databasePrincipalAssignment = new AzureNative.Kusto.V20221229.DatabasePrincipalAssignment("databasePrincipalAssignment", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:kusto/v20221229:DatabasePrincipalAssignment kustoCluster/Kustodatabase8/kustoprincipal1 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/kustoCluster/Databases/Kustodatabase8/PrincipalAssignments/kustoprincipal1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221229:DatabasePrincipalAssignment")]
    public partial class DatabasePrincipalAssignment : global::Pulumi.CustomResource
    {
        ...
        public DatabasePrincipalAssignment(string name, DatabasePrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:DatabasePrincipalAssignment", name, args ?? new DatabasePrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabasePrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:DatabasePrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabasePrincipalAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20221229.PrincipalType> PrincipalType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20221229.DatabasePrincipalRole> Role { get; set; } = null!;
