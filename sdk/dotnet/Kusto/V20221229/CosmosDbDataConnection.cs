...
namespace Pulumi.AzureNative.Kusto.V20221229
{
    ...
    /// {
    ///     var cosmosDbDataConnection = new AzureNative.Kusto.V20221229.CosmosDbDataConnection("cosmosDbDataConnection", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221229:CosmosDbDataConnection")]
    public partial class CosmosDbDataConnection : global::Pulumi.CustomResource
    {
        ...
        public CosmosDbDataConnection(string name, CosmosDbDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:CosmosDbDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CosmosDbDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:CosmosDbDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
