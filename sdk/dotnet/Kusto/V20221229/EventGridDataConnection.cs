...
namespace Pulumi.AzureNative.Kusto.V20221229
{
    ...
    /// {
    ///     var eventGridDataConnection = new AzureNative.Kusto.V20221229.EventGridDataConnection("eventGridDataConnection", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:kusto/v20221229:EventGridDataConnection kustoCluster/KustoDatabase8/dataConnectionTest /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/kustoCluster/Databases/KustoDatabase8/DataConnections/KustoDataConnection9 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221229:EventGridDataConnection")]
    public partial class EventGridDataConnection : global::Pulumi.CustomResource
    {
        ...
        public EventGridDataConnection(string name, EventGridDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:EventGridDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventGridDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:EventGridDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventGridDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20221229.BlobStorageEventType>? BlobStorageEventType { get; set; }
        ...
        /// </summary>
        [Input("dataFormat")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20221229.EventGridDataFormat>? DataFormat { get; set; }
