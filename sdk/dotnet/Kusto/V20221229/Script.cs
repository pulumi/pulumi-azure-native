...
namespace Pulumi.AzureNative.Kusto.V20221229
{
    ...
    /// {
    ///     var script = new AzureNative.Kusto.V20221229.Script("script", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221229:Script")]
    public partial class Script : global::Pulumi.CustomResource
    {
        ...
        public Script(string name, ScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:Script", name, args ?? new ScriptArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Script(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221229:Script", name, null, MakeResourceOptions(options, id))
        {
        }
