...
namespace Pulumi.AzureRM.Kusto
{
    ...
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, ClusterState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:kusto:Cluster", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ClusterPropertiesResponseGetArgs> Properties { get; set; } = null!;

        /// <summary>
        /// The SKU of the cluster.
        /// </summary>
        [Input("sku", required: true)]
        public Input<Inputs.AzureSkuResponseGetArgs> Sku { get; set; } = null!;
        ...
        /// </summary>
        [Input("zones")]
        public Input<Inputs.ZonesResponseGetArgs>? Zones { get; set; }
