...
namespace Pulumi.AzureNative.Kusto.V20230815
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20230815:ClusterPrincipalAssignment")]
    public partial class ClusterPrincipalAssignment : global::Pulumi.CustomResource
    {
        ...
        public ClusterPrincipalAssignment(string name, ClusterPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230815:ClusterPrincipalAssignment", name, args ?? new ClusterPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterPrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230815:ClusterPrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterPrincipalAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20230815.PrincipalType> PrincipalType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20230815.ClusterPrincipalRole> Role { get; set; } = null!;
