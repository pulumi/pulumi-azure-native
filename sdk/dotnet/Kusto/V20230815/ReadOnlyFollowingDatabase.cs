...
namespace Pulumi.AzureNative.Kusto.V20230815
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20230815:ReadOnlyFollowingDatabase")]
    public partial class ReadOnlyFollowingDatabase : global::Pulumi.CustomResource
    {
        ...
        public ReadOnlyFollowingDatabase(string name, ReadOnlyFollowingDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230815:ReadOnlyFollowingDatabase", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ReadOnlyFollowingDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230815:ReadOnlyFollowingDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
