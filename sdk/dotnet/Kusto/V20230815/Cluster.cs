...
namespace Pulumi.AzureNative.Kusto.V20230815
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20230815:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230815:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20230815:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("engineType")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20230815.EngineType>? EngineType { get; set; }
        ...
        /// </summary>
        [Input("publicIPType")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20230815.PublicIPType>? PublicIPType { get; set; }

        /// <summary>
        /// Public network access to the cluster is enabled by default. When disabled, only private endpoint connection to the cluster is allowed
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20230815.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20230815.ClusterNetworkAccessFlag>? RestrictOutboundNetworkAccess { get; set; }
