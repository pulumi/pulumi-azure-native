...
namespace Pulumi.AzureNative.Kusto.V20200215
{
    ...
    /// {
    ///     var eventHubDataConnection = new AzureNative.Kusto.V20200215.EventHubDataConnection("eventHubDataConnection", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:kusto/v20200215:EventHubDataConnection KustoClusterRPTest4/KustoDatabase8/DataConnections8 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/KustoClusterRPTest4/Databases/KustoDatabase8/DataConnections/DataConnections8 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20200215:EventHubDataConnection")]
    public partial class EventHubDataConnection : global::Pulumi.CustomResource
    {
        ...
        public EventHubDataConnection(string name, EventHubDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200215:EventHubDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventHubDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200215:EventHubDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventHubDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("compression")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20200215.Compression>? Compression { get; set; }
        ...
        /// </summary>
        [Input("dataFormat")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20200215.EventHubDataFormat>? DataFormat { get; set; }
