...
namespace Pulumi.AzureNative.Kusto.V20200215
{
    ...
    /// {
    ///     var eventGridDataConnection = new AzureNative.Kusto.V20200215.EventGridDataConnection("eventGridDataConnection", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20200215:EventGridDataConnection")]
    public partial class EventGridDataConnection : global::Pulumi.CustomResource
    {
        ...
        public EventGridDataConnection(string name, EventGridDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200215:EventGridDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EventGridDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200215:EventGridDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventGridDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20200215.EventGridDataFormat> DataFormat { get; set; } = null!;
