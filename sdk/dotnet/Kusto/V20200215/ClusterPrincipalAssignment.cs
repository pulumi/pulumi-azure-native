...
namespace Pulumi.AzureRM.Kusto.V20200215
{
    ...
    ///     public MyStack()
    ///     {
    ///         var clusterPrincipalAssignment = new AzureRM.Kusto.V20200215.ClusterPrincipalAssignment("clusterPrincipalAssignment", new AzureRM.Kusto.V20200215.ClusterPrincipalAssignmentArgs
    ///         {
    ...
    public partial class ClusterPrincipalAssignment : Pulumi.CustomResource
    {
        ...
        public ClusterPrincipalAssignment(string name, ClusterPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20200215:ClusterPrincipalAssignment", name, args ?? new ClusterPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterPrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20200215:ClusterPrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
