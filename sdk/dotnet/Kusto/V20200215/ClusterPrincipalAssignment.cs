...
namespace Pulumi.AzureNextGen.Kusto.V20200215
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:kusto/v20200215:ClusterPrincipalAssignment")]
    public partial class ClusterPrincipalAssignment : Pulumi.CustomResource
    {
        ...
        public ClusterPrincipalAssignment(string name, ClusterPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20200215:ClusterPrincipalAssignment", name, args ?? new ClusterPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterPrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20200215:ClusterPrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterPrincipalAssignmentArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Kusto.V20200215.PrincipalType> PrincipalType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Kusto.V20200215.ClusterPrincipalRole> Role { get; set; } = null!;
