...
namespace Pulumi.AzureNative.Kusto.V20200215
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kusto/v20200215:ClusterPrincipalAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ClusterPrincipalAssignment to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:kusto/v20200215:ClusterPrincipalAssignment")]
    public partial class ClusterPrincipalAssignment : global::Pulumi.CustomResource
    {
        ...
        public ClusterPrincipalAssignment(string name, ClusterPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200215:ClusterPrincipalAssignment", name, args ?? new ClusterPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterPrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200215:ClusterPrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterPrincipalAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20200215.PrincipalType> PrincipalType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20200215.ClusterPrincipalRole> Role { get; set; } = null!;
