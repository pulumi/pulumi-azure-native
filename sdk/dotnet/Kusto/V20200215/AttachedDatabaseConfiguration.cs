...
namespace Pulumi.AzureRM.Kusto.V20200215
{
    ...
    ///     public MyStack()
    ///     {
    ///         var attachedDatabaseConfiguration = new AzureRM.Kusto.V20200215.AttachedDatabaseConfiguration("attachedDatabaseConfiguration", new AzureRM.Kusto.V20200215.AttachedDatabaseConfigurationArgs
    ///         {
    ...
    public partial class AttachedDatabaseConfiguration : Pulumi.CustomResource
    {
        ...
        public AttachedDatabaseConfiguration(string name, AttachedDatabaseConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20200215:AttachedDatabaseConfiguration", name, args ?? new AttachedDatabaseConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDatabaseConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20200215:AttachedDatabaseConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:kusto/latest:AttachedDatabaseConfiguration"},
