...
namespace Pulumi.AzureNative.Kusto.V20200215
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20200215:DatabasePrincipalAssignment")]
    public partial class DatabasePrincipalAssignment : global::Pulumi.CustomResource
    {
        ...
        public DatabasePrincipalAssignment(string name, DatabasePrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200215:DatabasePrincipalAssignment", name, args ?? new DatabasePrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabasePrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200215:DatabasePrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabasePrincipalAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20200215.DatabasePrincipalRole> Role { get; set; } = null!;
