...
namespace Pulumi.AzureNative.Kusto.V20221111
{
    ...
    /// {
    ///     var readOnlyFollowingDatabase = new AzureNative.Kusto.V20221111.ReadOnlyFollowingDatabase("readOnlyFollowingDatabase", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221111:ReadOnlyFollowingDatabase")]
    public partial class ReadOnlyFollowingDatabase : global::Pulumi.CustomResource
    {
        ...
        public ReadOnlyFollowingDatabase(string name, ReadOnlyFollowingDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221111:ReadOnlyFollowingDatabase", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ReadOnlyFollowingDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221111:ReadOnlyFollowingDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
