...
namespace Pulumi.AzureNative.Kusto.V20221111
{
    ...
    /// {
    ///     var readWriteDatabase = new AzureNative.Kusto.V20221111.ReadWriteDatabase("readWriteDatabase", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221111:ReadWriteDatabase")]
    public partial class ReadWriteDatabase : global::Pulumi.CustomResource
    {
        ...
        public ReadWriteDatabase(string name, ReadWriteDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221111:ReadWriteDatabase", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ReadWriteDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221111:ReadWriteDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
