...
namespace Pulumi.AzureNative.Kusto.V20221111
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20221111:Script")]
    public partial class Script : global::Pulumi.CustomResource
    {
        ...
        public Script(string name, ScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221111:Script", name, args ?? new ScriptArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Script(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221111:Script", name, null, MakeResourceOptions(options, id))
        {
        }
