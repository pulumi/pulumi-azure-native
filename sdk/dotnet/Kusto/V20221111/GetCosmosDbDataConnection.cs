...
{
    [Obsolete(@"azure-native:kusto/v20221111:CosmosDbDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:CosmosDbDataConnection to guarantee forwards compatibility.")]
    public static class GetCosmosDbDataConnection
    {
        ...
        public static Task<GetCosmosDbDataConnectionResult> InvokeAsync(GetCosmosDbDataConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCosmosDbDataConnectionResult>("azure-native:kusto/v20221111:getCosmosDbDataConnection", args ?? new GetCosmosDbDataConnectionArgs(), options.WithDefaults());
        ...
        public static Output<GetCosmosDbDataConnectionResult> Invoke(GetCosmosDbDataConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCosmosDbDataConnectionResult>("azure-native:kusto/v20221111:getCosmosDbDataConnection", args ?? new GetCosmosDbDataConnectionInvokeArgs(), options.WithDefaults());
    }
