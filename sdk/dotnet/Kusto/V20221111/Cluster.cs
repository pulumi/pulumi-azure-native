...
namespace Pulumi.AzureNative.Kusto.V20221111
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kusto/v20221111:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:Cluster to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:kusto/v20221111:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221111:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20221111:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("engineType")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20221111.EngineType>? EngineType { get; set; }
        ...
        /// </summary>
        [Input("publicIPType")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20221111.PublicIPType>? PublicIPType { get; set; }

        /// <summary>
        /// Public network access to the cluster is enabled by default. When disabled, only private endpoint connection to the cluster is allowed
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20221111.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20221111.ClusterNetworkAccessFlag>? RestrictOutboundNetworkAccess { get; set; }
