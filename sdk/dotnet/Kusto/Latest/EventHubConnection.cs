...
namespace Pulumi.AzureRM.Kusto.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var eventHubConnection = new AzureRM.Kusto.Latest.EventHubConnection("eventHubConnection", new AzureRM.Kusto.Latest.EventHubConnectionArgs
    ///         {
    ...
    public partial class EventHubConnection : Pulumi.CustomResource
    {
        ...
        public EventHubConnection(string name, EventHubConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/latest:EventHubConnection", name, args ?? new EventHubConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventHubConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/latest:EventHubConnection", name, null, MakeResourceOptions(options, id))
        {
        }
