...
namespace Pulumi.AzureNative.Kusto.V20170907PrivatePreview
{
    ...
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20170907privatepreview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20170907privatepreview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
