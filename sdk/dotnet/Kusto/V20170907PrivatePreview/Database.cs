...
namespace Pulumi.AzureRM.Kusto.V20170907PrivatePreview
{
    ...
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20170907privatepreview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20170907privatepreview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
