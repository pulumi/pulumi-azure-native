...
namespace Pulumi.AzureNative.Kusto.V20170907PrivatePreview
{
    public static class GetDatabase
    {
        ...
        public static Task<GetDatabaseResult> InvokeAsync(GetDatabaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseResult>("azure-native:kusto/v20170907privatepreview:getDatabase", args ?? new GetDatabaseArgs(), options.WithDefaults());

        /// <summary>
        /// Class representing a Kusto database.
        /// </summary>
        public static Output<GetDatabaseResult> Invoke(GetDatabaseInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseResult>("azure-native:kusto/v20170907privatepreview:getDatabase", args ?? new GetDatabaseInvokeArgs(), options.WithDefaults());
    }
