...
namespace Pulumi.AzureNextGen.Kusto.V20200918
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:kusto/v20200918:AttachedDatabaseConfiguration")]
    public partial class AttachedDatabaseConfiguration : Pulumi.CustomResource
    {
        ...
        public AttachedDatabaseConfiguration(string name, AttachedDatabaseConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20200918:AttachedDatabaseConfiguration", name, args ?? new AttachedDatabaseConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDatabaseConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20200918:AttachedDatabaseConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AttachedDatabaseConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Kusto.V20200918.DefaultPrincipalsModificationKind> DefaultPrincipalsModificationKind { get; set; } = null!;
