...
namespace Pulumi.AzureNative.Kusto.V20200918
{
    ...
    public static class GetDataConnection
    {
        ...
        public static Output<GetDataConnectionResult> Invoke(GetDataConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataConnectionResult>("azure-native:kusto/v20200918:getDataConnection", args ?? new GetDataConnectionInvokeArgs(), options.WithVersion());
    }
