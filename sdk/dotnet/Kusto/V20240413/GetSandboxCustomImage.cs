...
namespace Pulumi.AzureNative.Kusto.V20240413
{
    public static class GetSandboxCustomImage
    {
        ...
        public static Task<GetSandboxCustomImageResult> InvokeAsync(GetSandboxCustomImageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSandboxCustomImageResult>("azure-native:kusto/v20240413:getSandboxCustomImage", args ?? new GetSandboxCustomImageArgs(), options.WithDefaults());
