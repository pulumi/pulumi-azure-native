...
namespace Pulumi.AzureNative.Kusto.V20240413
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20240413:CosmosDbDataConnection")]
    public partial class CosmosDbDataConnection : global::Pulumi.CustomResource
    {
        ...
        public CosmosDbDataConnection(string name, CosmosDbDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20240413:CosmosDbDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CosmosDbDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20240413:CosmosDbDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
