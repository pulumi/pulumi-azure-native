...
namespace Pulumi.AzureNative.Kusto.V20240413
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20240413:Script")]
    public partial class Script : global::Pulumi.CustomResource
    {
        ...
        public Script(string name, ScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20240413:Script", name, args ?? new ScriptArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Script(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20240413:Script", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScriptArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20240413.PrincipalPermissionsAction>? PrincipalPermissionsAction { get; set; }
        ...
        /// </summary>
        [Input("scriptLevel")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20240413.ScriptLevel>? ScriptLevel { get; set; }
