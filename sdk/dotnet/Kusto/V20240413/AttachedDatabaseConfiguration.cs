...
namespace Pulumi.AzureNative.Kusto.V20240413
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20240413:AttachedDatabaseConfiguration")]
    public partial class AttachedDatabaseConfiguration : global::Pulumi.CustomResource
    {
        ...
        public AttachedDatabaseConfiguration(string name, AttachedDatabaseConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20240413:AttachedDatabaseConfiguration", name, args ?? new AttachedDatabaseConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDatabaseConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20240413:AttachedDatabaseConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AttachedDatabaseConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20240413.DefaultPrincipalsModificationKind> DefaultPrincipalsModificationKind { get; set; } = null!;
