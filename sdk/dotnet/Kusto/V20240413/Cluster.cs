...
namespace Pulumi.AzureNative.Kusto.V20240413
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20240413:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("calloutPolicies")]
        public Output<ImmutableArray<Outputs.CalloutPolicyResponse>> CalloutPolicies { get; private set; } = null!;
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20240413:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20240413:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("calloutPolicies")]
        private InputList<Inputs.CalloutPolicyArgs>? _calloutPolicies;

        /// <summary>
        /// List of callout policies for egress from Cluster.
        /// </summary>
        public InputList<Inputs.CalloutPolicyArgs> CalloutPolicies
        {
            get => _calloutPolicies ?? (_calloutPolicies = new InputList<Inputs.CalloutPolicyArgs>());
            set => _calloutPolicies = value;
        }
        ...
        /// </summary>
        [Input("engineType")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20240413.EngineType>? EngineType { get; set; }
        ...
        /// </summary>
        [Input("publicIPType")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20240413.PublicIPType>? PublicIPType { get; set; }

        /// <summary>
        /// Public network access to the cluster is enabled by default. When disabled, only private endpoint connection to the cluster is allowed
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20240413.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20240413.ClusterNetworkAccessFlag>? RestrictOutboundNetworkAccess { get; set; }
