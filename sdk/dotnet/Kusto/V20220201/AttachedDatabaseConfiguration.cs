...
namespace Pulumi.AzureNative.Kusto.V20220201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20220201:AttachedDatabaseConfiguration")]
    public partial class AttachedDatabaseConfiguration : global::Pulumi.CustomResource
    {
        ...
        public AttachedDatabaseConfiguration(string name, AttachedDatabaseConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220201:AttachedDatabaseConfiguration", name, args ?? new AttachedDatabaseConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AttachedDatabaseConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20220201:AttachedDatabaseConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AttachedDatabaseConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20220201.DefaultPrincipalsModificationKind> DefaultPrincipalsModificationKind { get; set; } = null!;
