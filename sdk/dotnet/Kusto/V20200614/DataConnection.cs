...
namespace Pulumi.AzureNative.Kusto.V20200614
{
    ...
    [AzureNativeResourceType("azure-native:kusto/v20200614:DataConnection")]
    public partial class DataConnection : global::Pulumi.CustomResource
    {
        ...
        public DataConnection(string name, DataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200614:DataConnection", name, args ?? new DataConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200614:DataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:kusto/v20190907:DataConnection"},
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:kusto/v20221111:DataConnection"},
                    new global::Pulumi.Alias { Type = "azure-native:kusto/v20221229:DataConnection"},
                },
            };
    ...
    public sealed class DataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20200614.DataConnectionKind> Kind { get; set; } = null!;
