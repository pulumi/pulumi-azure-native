...
namespace Pulumi.AzureRM.Kusto.V20200614
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var database = new AzureRM.Kusto.V20200614.Database("database", new AzureRM.Kusto.V20200614.DatabaseArgs
    ///         {
    ...
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20200614:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20200614:Database", name, null, MakeResourceOptions(options, id))
        {
        }
