...
namespace Pulumi.AzureNative.Kusto.V20200614
{
    ...
    /// {
    ///     var iotHubDataConnection = new AzureNative.Kusto.V20200614.IotHubDataConnection("iotHubDataConnection", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20200614:IotHubDataConnection")]
    public partial class IotHubDataConnection : global::Pulumi.CustomResource
    {
        ...
        public IotHubDataConnection(string name, IotHubDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200614:IotHubDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IotHubDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200614:IotHubDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IotHubDataConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataFormat")]
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20200614.IotHubDataFormat>? DataFormat { get; set; }
