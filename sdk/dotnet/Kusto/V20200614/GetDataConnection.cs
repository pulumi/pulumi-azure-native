...
namespace Pulumi.AzureNative.Kusto.V20200614
{
    ...
    public static class GetDataConnection
    {
        ...
        public static Task<GetDataConnectionResult> InvokeAsync(GetDataConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectionResult>("azure-native:kusto/v20200614:getDataConnection", args ?? new GetDataConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Returns a data connection.
        /// </summary>
        public static Output<GetDataConnectionResult> Invoke(GetDataConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataConnectionResult>("azure-native:kusto/v20200614:getDataConnection", args ?? new GetDataConnectionInvokeArgs(), options.WithDefaults());
    }
