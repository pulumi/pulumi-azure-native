...
namespace Pulumi.AzureRM.Kusto.V20200614
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databasePrincipalAssignment = new AzureRM.Kusto.V20200614.DatabasePrincipalAssignment("databasePrincipalAssignment", new AzureRM.Kusto.V20200614.DatabasePrincipalAssignmentArgs
    ///         {
    ...
    public partial class DatabasePrincipalAssignment : Pulumi.CustomResource
    {
        ...
        public DatabasePrincipalAssignment(string name, DatabasePrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20200614:DatabasePrincipalAssignment", name, args ?? new DatabasePrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabasePrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20200614:DatabasePrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
