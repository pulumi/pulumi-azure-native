...
namespace Pulumi.AzureNative.Kusto.V20200614
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20200614:ReadWriteDatabase")]
    public partial class ReadWriteDatabase : Pulumi.CustomResource
    {
        ...
        public ReadWriteDatabase(string name, ReadWriteDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200614:ReadWriteDatabase", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ReadWriteDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20200614:ReadWriteDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
