...
namespace Pulumi.AzureNative.Kusto.V20190907
{
    ...
    /// {
    ///     var readOnlyFollowingDatabase = new AzureNative.Kusto.V20190907.ReadOnlyFollowingDatabase("readOnlyFollowingDatabase", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kusto/v20190907:ReadOnlyFollowingDatabase")]
    public partial class ReadOnlyFollowingDatabase : global::Pulumi.CustomResource
    {
        ...
        public ReadOnlyFollowingDatabase(string name, ReadOnlyFollowingDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190907:ReadOnlyFollowingDatabase", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ReadOnlyFollowingDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190907:ReadOnlyFollowingDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
