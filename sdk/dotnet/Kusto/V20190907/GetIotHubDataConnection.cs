...
namespace Pulumi.AzureNative.Kusto.V20190907
{
    public static class GetIotHubDataConnection
    {
        ...
        public static Task<GetIotHubDataConnectionResult> InvokeAsync(GetIotHubDataConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotHubDataConnectionResult>("azure-native:kusto/v20190907:getIotHubDataConnection", args ?? new GetIotHubDataConnectionArgs(), options.WithVersion());
        ...
        public static Output<GetIotHubDataConnectionResult> Invoke(GetIotHubDataConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIotHubDataConnectionResult>("azure-native:kusto/v20190907:getIotHubDataConnection", args ?? new GetIotHubDataConnectionInvokeArgs(), options.WithVersion());
    }
