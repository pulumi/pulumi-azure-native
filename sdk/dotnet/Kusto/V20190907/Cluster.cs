...
namespace Pulumi.AzureNextGen.Kusto.V20190907
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:kusto/v20190907:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20190907:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20190907:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
