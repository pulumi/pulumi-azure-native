...
namespace Pulumi.AzureNative.Kusto.V20190907
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kusto/v20190907:IotHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:kusto/v20190907:IotHubDataConnection")]
    public partial class IotHubDataConnection : global::Pulumi.CustomResource
    {
        ...
        public IotHubDataConnection(string name, IotHubDataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190907:IotHubDataConnection", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IotHubDataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190907:IotHubDataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
