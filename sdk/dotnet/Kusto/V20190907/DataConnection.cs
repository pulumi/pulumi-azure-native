...
namespace Pulumi.AzureRM.Kusto.V20190907
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dataConnection = new AzureRM.Kusto.V20190907.DataConnection("dataConnection", new AzureRM.Kusto.V20190907.DataConnectionArgs
    ///         {
    ...
    public partial class DataConnection : Pulumi.CustomResource
    {
        ...
        public DataConnection(string name, DataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20190907:DataConnection", name, args ?? new DataConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20190907:DataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
