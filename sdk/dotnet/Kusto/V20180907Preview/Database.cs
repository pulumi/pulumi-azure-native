...
namespace Pulumi.AzureRM.Kusto.V20180907Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var database = new AzureRM.Kusto.V20180907Preview.Database("database", new AzureRM.Kusto.V20180907Preview.DatabaseArgs
    ///         {
    ...
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20180907preview:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20180907preview:Database", name, null, MakeResourceOptions(options, id))
        {
        }
