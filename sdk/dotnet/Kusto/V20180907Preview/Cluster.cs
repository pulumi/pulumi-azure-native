...
namespace Pulumi.AzureRM.Kusto.V20180907Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cluster = new AzureRM.Kusto.V20180907Preview.Cluster("cluster", new AzureRM.Kusto.V20180907Preview.ClusterArgs
    ///         {
    ///             ClusterName = "KustoClusterRPTest4",
    ///             Location = "westus",
    ///             ResourceGroupName = "kustorptest",
    ///             Sku = new AzureRM.Kusto.V20180907Preview.Inputs.AzureSkuArgs
    ///             {
    ///                 Capacity = 2,
    ///                 Name = "L8",
    ///                 Tier = "Standard",
    ...
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20180907preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kusto/v20180907preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
