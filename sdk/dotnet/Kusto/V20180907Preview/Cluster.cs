...
namespace Pulumi.AzureNextGen.Kusto.V20180907Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:kusto/v20180907preview:Cluster")]
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20180907preview:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kusto/v20180907preview:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
