...
namespace Pulumi.AzureNative.Kusto.V20210827
{
    ...
    public partial class Script : Pulumi.CustomResource
    {
        ...
        public Script(string name, ScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210827:Script", name, args ?? new ScriptArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Script(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210827:Script", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:kusto/v20210827:Script"},
                    new Pulumi.Alias { Type = "azure-native:kusto:Script"},
                    new Pulumi.Alias { Type = "azure-nextgen:kusto:Script"},
                    new Pulumi.Alias { Type = "azure-native:kusto/v20210101:Script"},
                    new Pulumi.Alias { Type = "azure-nextgen:kusto/v20210101:Script"},
                },
            };
