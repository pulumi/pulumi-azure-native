...
namespace Pulumi.AzureNative.Kusto.V20210827
{
    ...
    public static class GetDataConnection
    {
        ...
        public static Task<GetDataConnectionResult> InvokeAsync(GetDataConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectionResult>("azure-native:kusto/v20210827:getDataConnection", args ?? new GetDataConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Class representing an data connection.
        /// </summary>
        public static Output<GetDataConnectionResult> Invoke(GetDataConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataConnectionResult>("azure-native:kusto/v20210827:getDataConnection", args ?? new GetDataConnectionInvokeArgs(), options.WithDefaults());
    }
