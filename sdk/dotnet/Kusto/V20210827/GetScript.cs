...
namespace Pulumi.AzureNative.Kusto.V20210827
{
    public static class GetScript
    {
        ...
        public static Task<GetScriptResult> InvokeAsync(GetScriptArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScriptResult>("azure-native:kusto/v20210827:getScript", args ?? new GetScriptArgs(), options.WithDefaults());

        /// <summary>
        /// Class representing a database script.
        /// </summary>
        public static Output<GetScriptResult> Invoke(GetScriptInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScriptResult>("azure-native:kusto/v20210827:getScript", args ?? new GetScriptInvokeArgs(), options.WithDefaults());
    }
