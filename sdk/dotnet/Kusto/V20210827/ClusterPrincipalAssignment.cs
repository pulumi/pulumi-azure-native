...
namespace Pulumi.AzureNative.Kusto.V20210827
{
    ...
    public partial class ClusterPrincipalAssignment : Pulumi.CustomResource
    {
        ...
        public ClusterPrincipalAssignment(string name, ClusterPrincipalAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210827:ClusterPrincipalAssignment", name, args ?? new ClusterPrincipalAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterPrincipalAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20210827:ClusterPrincipalAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClusterPrincipalAssignmentArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20210827.PrincipalType> PrincipalType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20210827.ClusterPrincipalRole> Role { get; set; } = null!;
