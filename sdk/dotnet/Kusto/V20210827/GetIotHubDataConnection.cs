...
namespace Pulumi.AzureNative.Kusto.V20210827
{
    public static class GetIotHubDataConnection
    {
        ...
        public static Task<GetIotHubDataConnectionResult> InvokeAsync(GetIotHubDataConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotHubDataConnectionResult>("azure-native:kusto/v20210827:getIotHubDataConnection", args ?? new GetIotHubDataConnectionArgs(), options.WithDefaults());
        ...
        public static Output<GetIotHubDataConnectionResult> Invoke(GetIotHubDataConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIotHubDataConnectionResult>("azure-native:kusto/v20210827:getIotHubDataConnection", args ?? new GetIotHubDataConnectionInvokeArgs(), options.WithDefaults());
    }
