...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20211101Preview
{
    ...
    /// {
    ///     var fluxConfiguration = new AzureNative.KubernetesConfiguration.V20211101Preview.FluxConfiguration("fluxConfiguration", new()
    ///     {
    ///         ClusterName = "clusterName1",
    ///         ClusterResourceName = "connectedClusters",
    ///         ClusterRp = "Microsoft.Kubernetes",
    ///         FluxConfigurationName = "srs-fluxconfig",
    ///         GitRepository = new AzureNative.KubernetesConfiguration.V20211101Preview.Inputs.GitRepositoryDefinitionArgs
    ///         {
    ///             HttpsCAFile = "ZXhhbXBsZWNlcnRpZmljYXRl",
    ///             RepositoryRef = new AzureNative.KubernetesConfiguration.V20211101Preview.Inputs.RepositoryRefDefinitionArgs
    ///             {
    ///                 Branch = "master",
    ///             },
    ...
    ///         Kustomizations = 
    ///         {
    ///             { "srs-kustomization1", new AzureNative.KubernetesConfiguration.V20211101Preview.Inputs.KustomizationDefinitionArgs
    ///             {
    ///                 DependsOn = new[] {},
    ///                 Path = "./test/path",
    ///                 SyncIntervalInSeconds = 600,
    ...
    ///                 Validation = "none",
    ///             } },
    ///             { "srs-kustomization2", new AzureNative.KubernetesConfiguration.V20211101Preview.Inputs.KustomizationDefinitionArgs
    ///             {
    ///                 DependsOn = new[]
    ///                 {
    ///                     new AzureNative.KubernetesConfiguration.V20211101Preview.Inputs.DependsOnDefinitionArgs
    ///                     {
    ...
    public partial class FluxConfiguration : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("lastSourceSyncedAt")]
        public Output<string> LastSourceSyncedAt { get; private set; } = null!;

        /// <summary>
        /// Branch and SHA of the last source commit synced with the cluster.
        /// </summary>
        [Output("lastSourceSyncedCommitId")]
        public Output<string> LastSourceSyncedCommitId { get; private set; } = null!;
        ...
        public FluxConfiguration(string name, FluxConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20211101preview:FluxConfiguration", name, args ?? new FluxConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FluxConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20211101preview:FluxConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FluxConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("scope")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20211101Preview.ScopeType>? Scope { get; set; }

        /// <summary>
        /// Source Kind to pull the configuration data from.
        /// </summary>
        [Input("sourceKind")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20211101Preview.SourceKindType>? SourceKind { get; set; }
