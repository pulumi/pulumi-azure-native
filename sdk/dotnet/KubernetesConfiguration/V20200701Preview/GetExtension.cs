...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20200701Preview
{
    public static class GetExtension
    {
        ...
        public static Task<GetExtensionResult> InvokeAsync(GetExtensionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExtensionResult>("azure-native:kubernetesconfiguration/v20200701preview:getExtension", args ?? new GetExtensionArgs(), options.WithVersion());

        /// <summary>
        /// The Extension Instance object.
        /// </summary>
        public static Output<GetExtensionResult> Invoke(GetExtensionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetExtensionResult>("azure-native:kubernetesconfiguration/v20200701preview:getExtension", args ?? new GetExtensionInvokeArgs(), options.WithVersion());
    }
