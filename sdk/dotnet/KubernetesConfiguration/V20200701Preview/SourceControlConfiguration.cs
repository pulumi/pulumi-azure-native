...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20200701Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kubernetesconfiguration/v20200701preview:SourceControlConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:SourceControlConfiguration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:kubernetesconfiguration/v20200701preview:SourceControlConfiguration")]
    public partial class SourceControlConfiguration : global::Pulumi.CustomResource
    {
        ...
        public SourceControlConfiguration(string name, SourceControlConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20200701preview:SourceControlConfiguration", name, args ?? new SourceControlConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControlConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20200701preview:SourceControlConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operatorScope")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20200701Preview.OperatorScopeType>? OperatorScope { get; set; }

        /// <summary>
        /// Type of the operator
        /// </summary>
        [Input("operatorType")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20200701Preview.OperatorType>? OperatorType { get; set; }
