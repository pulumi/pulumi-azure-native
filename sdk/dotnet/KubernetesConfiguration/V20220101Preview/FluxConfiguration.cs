...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20220101Preview
{
    ...
    /// {
    ///     var fluxConfiguration = new AzureNative.KubernetesConfiguration.V20220101Preview.FluxConfiguration("fluxConfiguration", new()
    ///     {
    ///         ClusterName = "clusterName1",
    ///         ClusterResourceName = "connectedClusters",
    ///         ClusterRp = "Microsoft.Kubernetes",
    ///         FluxConfigurationName = "srs-fluxconfig",
    ///         GitRepository = new AzureNative.KubernetesConfiguration.V20220101Preview.Inputs.GitRepositoryDefinitionArgs
    ///         {
    ///             HttpsCACert = "ZXhhbXBsZWNlcnRpZmljYXRl",
    ///             RepositoryRef = new AzureNative.KubernetesConfiguration.V20220101Preview.Inputs.RepositoryRefDefinitionArgs
    ///             {
    ///                 Branch = "master",
    ///             },
    ...
    ///         Kustomizations = 
    ///         {
    ///             { "srs-kustomization1", new AzureNative.KubernetesConfiguration.V20220101Preview.Inputs.KustomizationDefinitionArgs
    ///             {
    ///                 DependsOn = new[] {},
    ///                 Path = "./test/path",
    ///                 SyncIntervalInSeconds = 600,
    ///                 TimeoutInSeconds = 600,
    ///             } },
    ///             { "srs-kustomization2", new AzureNative.KubernetesConfiguration.V20220101Preview.Inputs.KustomizationDefinitionArgs
    ///             {
    ///                 DependsOn = new[]
    ///                 {
    ///                     new AzureNative.KubernetesConfiguration.V20220101Preview.Inputs.DependsOnDefinitionArgs
    ///                     {
    ...
    ///     var fluxConfiguration = new AzureNative.KubernetesConfiguration.V20220101Preview.FluxConfiguration("fluxConfiguration", new()
    ///     {
    ///         Bucket = new AzureNative.KubernetesConfiguration.V20220101Preview.Inputs.BucketDefinitionArgs
    ///         {
