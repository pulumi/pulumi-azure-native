...
{
    [Obsolete(@"azure-native:kubernetesconfiguration/v20220101preview:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20220402preview:Extension to guarantee forwards compatibility.")]
    public static class GetExtension
    {
        ...
        public static Task<GetExtensionResult> InvokeAsync(GetExtensionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExtensionResult>("azure-native:kubernetesconfiguration/v20220101preview:getExtension", args ?? new GetExtensionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets Kubernetes Cluster Extension.
        /// </summary>
        public static Output<GetExtensionResult> Invoke(GetExtensionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetExtensionResult>("azure-native:kubernetesconfiguration/v20220101preview:getExtension", args ?? new GetExtensionInvokeArgs(), options.WithDefaults());
    }
