...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20241101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesconfiguration/v20241101preview:PrivateLinkScope")]
    public partial class PrivateLinkScope : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.KubernetesConfigurationPrivateLinkScopePropertiesResponse> Properties { get; private set; } = null!;
        ...
        public PrivateLinkScope(string name, PrivateLinkScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20241101preview:PrivateLinkScope", name, args ?? new PrivateLinkScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20241101preview:PrivateLinkScope", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateLinkScopeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.KubernetesConfigurationPrivateLinkScopePropertiesArgs>? Properties { get; set; }
