...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20230501
{
    public static class GetFluxConfiguration
    {
        ...
        public static Task<GetFluxConfigurationResult> InvokeAsync(GetFluxConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFluxConfigurationResult>("azure-native:kubernetesconfiguration/v20230501:getFluxConfiguration", args ?? new GetFluxConfigurationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets details of the Flux Configuration.
        /// </summary>
        public static Output<GetFluxConfigurationResult> Invoke(GetFluxConfigurationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFluxConfigurationResult>("azure-native:kubernetesconfiguration/v20230501:getFluxConfiguration", args ?? new GetFluxConfigurationInvokeArgs(), options.WithDefaults());
