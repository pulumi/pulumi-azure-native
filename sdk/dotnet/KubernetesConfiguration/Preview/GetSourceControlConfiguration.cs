...
namespace Pulumi.AzureRM.KubernetesConfiguration.Preview
{
    public static class GetSourceControlConfiguration
    {
        public static Task<GetSourceControlConfigurationResult> InvokeAsync(GetSourceControlConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSourceControlConfigurationResult>("azurerm:kubernetesconfiguration/preview:getSourceControlConfiguration", args ?? new GetSourceControlConfigurationArgs(), options.WithVersion());
    }
