...
namespace Pulumi.AzureRM.KubernetesConfiguration.Preview
{
    /// <summary>
    ...
    public partial class SourceControlConfiguration : Pulumi.CustomResource
    {
        ...
        public SourceControlConfiguration(string name, SourceControlConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kubernetesconfiguration/preview:SourceControlConfiguration", name, args ?? new SourceControlConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControlConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kubernetesconfiguration/preview:SourceControlConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
