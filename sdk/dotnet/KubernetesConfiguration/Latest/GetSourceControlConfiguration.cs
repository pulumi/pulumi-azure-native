...
namespace Pulumi.AzureRM.KubernetesConfiguration.Latest
{
    public static class GetSourceControlConfiguration
    {
        public static Task<GetSourceControlConfigurationResult> InvokeAsync(GetSourceControlConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSourceControlConfigurationResult>("azurerm:kubernetesconfiguration/latest:getSourceControlConfiguration", args ?? new GetSourceControlConfigurationArgs(), options.WithVersion());
    }
