...
namespace Pulumi.AzureRM.KubernetesConfiguration.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sourceControlConfiguration = new AzureRM.KubernetesConfiguration.Latest.SourceControlConfiguration("sourceControlConfiguration", new AzureRM.KubernetesConfiguration.Latest.SourceControlConfigurationArgs
    ///         {
    ///             ClusterName = "clusterName1",
    ///             ClusterResourceName = "connectedClusters",
    ///             ClusterRp = "Microsoft.Kubernetes",
    ///             EnableHelmOperator = "true",
    ///             HelmOperatorProperties = new AzureRM.KubernetesConfiguration.Latest.Inputs.HelmOperatorPropertiesArgs
    ///             {
    ...
    public partial class SourceControlConfiguration : Pulumi.CustomResource
    {
        ...
        public SourceControlConfiguration(string name, SourceControlConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:kubernetesconfiguration/latest:SourceControlConfiguration", name, args ?? new SourceControlConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControlConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:kubernetesconfiguration/latest:SourceControlConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:kubernetesconfiguration/v20191101preview:SourceControlConfiguration"},
                },
            };
