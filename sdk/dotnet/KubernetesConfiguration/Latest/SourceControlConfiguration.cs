...
namespace Pulumi.AzureNextGen.KubernetesConfiguration.Latest
{
    ...
    public partial class SourceControlConfiguration : Pulumi.CustomResource
    {
        ...
        public SourceControlConfiguration(string name, SourceControlConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:kubernetesconfiguration/latest:SourceControlConfiguration", name, args ?? new SourceControlConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControlConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:kubernetesconfiguration/latest:SourceControlConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operatorScope")]
        public InputUnion<string, Pulumi.AzureNextGen.KubernetesConfiguration.Latest.OperatorScopeType>? OperatorScope { get; set; }

        /// <summary>
        /// Type of the operator
        /// </summary>
        [Input("operatorType")]
        public InputUnion<string, Pulumi.AzureNextGen.KubernetesConfiguration.Latest.OperatorType>? OperatorType { get; set; }
