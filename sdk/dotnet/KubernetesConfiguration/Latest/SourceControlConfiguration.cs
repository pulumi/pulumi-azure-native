...
namespace Pulumi.AzureNative.KubernetesConfiguration.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:kubernetesconfiguration:SourceControlConfiguration'.")]
    [AzureNativeResourceType("azure-native:kubernetesconfiguration/latest:SourceControlConfiguration")]
    public partial class SourceControlConfiguration : Pulumi.CustomResource
    {
        ...
        public SourceControlConfiguration(string name, SourceControlConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/latest:SourceControlConfiguration", name, args ?? new SourceControlConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControlConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/latest:SourceControlConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operatorScope")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.Latest.OperatorScopeType>? OperatorScope { get; set; }

        /// <summary>
        /// Type of the operator
        /// </summary>
        [Input("operatorType")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.Latest.OperatorType>? OperatorType { get; set; }
