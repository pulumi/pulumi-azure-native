...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20221101
{
    ...
    /// {
    ///     var extension = new AzureNative.KubernetesConfiguration.V20221101.Extension("extension", new()
    ///     {
    ...
    ///         Scope = new AzureNative.KubernetesConfiguration.V20221101.Inputs.ScopeArgs
    ///         {
    ///             Cluster = new AzureNative.KubernetesConfiguration.V20221101.Inputs.ScopeClusterArgs
    ///             {
    ...
    ///         Plan = new AzureNative.KubernetesConfiguration.V20221101.Inputs.PlanArgs
    ///         {
    ...
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("isSystemExtension")]
        public Output<bool> IsSystemExtension { get; private set; } = null!;
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20221101:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20221101:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
