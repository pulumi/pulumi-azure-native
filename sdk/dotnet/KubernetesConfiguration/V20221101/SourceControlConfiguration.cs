...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20221101
{
    ...
    /// {
    ///     var sourceControlConfiguration = new AzureNative.KubernetesConfiguration.V20221101.SourceControlConfiguration("sourceControlConfiguration", new()
    ///     {
    ...
    ///         HelmOperatorProperties = new AzureNative.KubernetesConfiguration.V20221101.Inputs.HelmOperatorPropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesconfiguration/v20221101:SourceControlConfiguration")]
    public partial class SourceControlConfiguration : global::Pulumi.CustomResource
    {
        ...
        public SourceControlConfiguration(string name, SourceControlConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20221101:SourceControlConfiguration", name, args ?? new SourceControlConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControlConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20221101:SourceControlConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("operatorScope")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20221101.OperatorScopeType>? OperatorScope { get; set; }

        /// <summary>
        /// Type of the operator
        /// </summary>
        [Input("operatorType")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20221101.OperatorType>? OperatorType { get; set; }
