...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20221101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kubernetesconfiguration/v20221101:FluxConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20230501:FluxConfiguration to guarantee forwards compatibility.")]
    ...
    public partial class FluxConfiguration : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("azureBlob")]
        public Output<Outputs.AzureBlobDefinitionResponse?> AzureBlob { get; private set; } = null!;
        ...
        public FluxConfiguration(string name, FluxConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20221101:FluxConfiguration", name, args ?? new FluxConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FluxConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20221101:FluxConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FluxConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("azureBlob")]
        public Input<Inputs.AzureBlobDefinitionArgs>? AzureBlob { get; set; }
        ...
        /// </summary>
        [Input("scope")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20221101.ScopeType>? Scope { get; set; }

        /// <summary>
        /// Source Kind to pull the configuration data from.
        /// </summary>
        [Input("sourceKind")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20221101.SourceKindType>? SourceKind { get; set; }
