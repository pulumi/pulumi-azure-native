...
namespace Pulumi.AzureNextGen.KubernetesConfiguration.V20201001Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct EnableHelmOperatorType : IEquatable<EnableHelmOperatorType>
    {
        private readonly string _value;

        private EnableHelmOperatorType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static EnableHelmOperatorType @True { get; } = new EnableHelmOperatorType("true");
        public static EnableHelmOperatorType @False { get; } = new EnableHelmOperatorType("false");

        public static bool operator ==(EnableHelmOperatorType left, EnableHelmOperatorType right) => left.Equals(right);
        public static bool operator !=(EnableHelmOperatorType left, EnableHelmOperatorType right) => !left.Equals(right);

        public static explicit operator string(EnableHelmOperatorType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is EnableHelmOperatorType other && Equals(other);
        public bool Equals(EnableHelmOperatorType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
