...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20201001Preview
{
    public static class GetSourceControlConfiguration
    {
        ...
        public static Task<GetSourceControlConfigurationResult> InvokeAsync(GetSourceControlConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSourceControlConfigurationResult>("azure-native:kubernetesconfiguration/v20201001preview:getSourceControlConfiguration", args ?? new GetSourceControlConfigurationArgs(), options.WithVersion());
        ...
        public static Output<GetSourceControlConfigurationResult> Invoke(GetSourceControlConfigurationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSourceControlConfigurationResult>("azure-native:kubernetesconfiguration/v20201001preview:getSourceControlConfiguration", args ?? new GetSourceControlConfigurationInvokeArgs(), options.WithVersion());
    }
