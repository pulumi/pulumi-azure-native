...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:kubernetesconfiguration/v20220301:FluxConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetesconfiguration/v20221101:FluxConfiguration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:kubernetesconfiguration/v20220301:FluxConfiguration")]
    public partial class FluxConfiguration : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("sourceSyncedCommitId")]
        public Output<string> SourceSyncedCommitId { get; private set; } = null!;

        /// <summary>
        /// Datetime the fluxConfiguration synced its source on the cluster.
        /// </summary>
        [Output("sourceUpdatedAt")]
        public Output<string> SourceUpdatedAt { get; private set; } = null!;
        ...
        public FluxConfiguration(string name, FluxConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20220301:FluxConfiguration", name, args ?? new FluxConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FluxConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20220301:FluxConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FluxConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("scope")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20220301.ScopeType>? Scope { get; set; }

        /// <summary>
        /// Source Kind to pull the configuration data from.
        /// </summary>
        [Input("sourceKind")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20220301.SourceKindType>? SourceKind { get; set; }
