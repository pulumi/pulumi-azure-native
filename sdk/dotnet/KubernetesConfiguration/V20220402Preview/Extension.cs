...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20220402Preview
{
    ...
    /// {
    ///     var extension = new AzureNative.KubernetesConfiguration.V20220402Preview.Extension("extension", new()
    ///     {
    ...
    ///         Scope = new AzureNative.KubernetesConfiguration.V20220402Preview.Inputs.ScopeArgs
    ///         {
    ///             Cluster = new AzureNative.KubernetesConfiguration.V20220402Preview.Inputs.ScopeClusterArgs
    ///             {
    ...
    ///         Plan = new AzureNative.KubernetesConfiguration.V20220402Preview.Inputs.PlanArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesconfiguration/v20220402preview:Extension")]
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20220402preview:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20220402preview:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
