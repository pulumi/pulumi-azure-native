...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20220701
{
    ...
    public partial class FluxConfiguration : global::Pulumi.CustomResource
    {
        ...
        public FluxConfiguration(string name, FluxConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20220701:FluxConfiguration", name, args ?? new FluxConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FluxConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20220701:FluxConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FluxConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("scope")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20220701.ScopeType>? Scope { get; set; }

        /// <summary>
        /// Source Kind to pull the configuration data from.
        /// </summary>
        [Input("sourceKind")]
        public InputUnion<string, Pulumi.AzureNative.KubernetesConfiguration.V20220701.SourceKindType>? SourceKind { get; set; }
