...
namespace Pulumi.AzureNative.KubernetesConfiguration.V20220701
{
    ...
    /// {
    ///     var extension = new AzureNative.KubernetesConfiguration.V20220701.Extension("extension", new()
    ///     {
    ...
    ///         Scope = new AzureNative.KubernetesConfiguration.V20220701.Inputs.ScopeArgs
    ///         {
    ///             Cluster = new AzureNative.KubernetesConfiguration.V20220701.Inputs.ScopeClusterArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:kubernetesconfiguration/v20220701:Extension")]
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20220701:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kubernetesconfiguration/v20220701:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
