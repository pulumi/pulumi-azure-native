...
namespace Pulumi.AzureRM.DevOps.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var pipeline = new AzureRM.DevOps.Latest.Pipeline("pipeline", new AzureRM.DevOps.Latest.PipelineArgs
    ///         {
    ///             BootstrapConfiguration = new AzureRM.DevOps.Latest.Inputs.BootstrapConfigurationArgs
    ///             {
    ///                 Template = new AzureRM.DevOps.Latest.Inputs.PipelineTemplateArgs
    ///                 {
    ...
    ///             },
    ///             Location = "South India",
    ///             Organization = new AzureRM.DevOps.Latest.Inputs.OrganizationReferenceArgs
    ///             {
    ///                 Name = "myAspNetWebAppPipeline-org",
    ///             },
    ///             PipelineName = "myAspNetWebAppPipeline",
    ///             Project = new AzureRM.DevOps.Latest.Inputs.ProjectReferenceArgs
    ///             {
    ...
    public partial class Pipeline : Pulumi.CustomResource
    {
        ...
        public Pipeline(string name, PipelineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devops/latest:Pipeline", name, args ?? new PipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devops/latest:Pipeline", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:devops/v20190701preview:Pipeline"},
                },
            };
