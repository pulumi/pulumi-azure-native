...
namespace Pulumi.AzureNative.OffAzure.V20200707
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.OffAzure.V20200707.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20200707:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20200707:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20200707:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
