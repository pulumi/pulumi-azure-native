...
namespace Pulumi.AzureNextGen.OffAzure.V20200707
{
    ...
    public partial class MasterSite : Pulumi.CustomResource
    {
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MasterSite Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new MasterSite(name, id, options);
        }
    }

    public sealed class MasterSiteArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// eTag for concurrency control.
        /// </summary>
