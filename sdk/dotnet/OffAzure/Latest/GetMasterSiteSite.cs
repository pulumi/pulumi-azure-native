...
namespace Pulumi.AzureRM.OffAzure.Latest
{
    public static class GetMasterSiteSite
    {
        public static Task<GetMasterSiteSiteResult> InvokeAsync(GetMasterSiteSiteArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMasterSiteSiteResult>("azurerm:offazure/latest:getMasterSiteSite", args ?? new GetMasterSiteSiteArgs(), options.WithVersion());
    }
