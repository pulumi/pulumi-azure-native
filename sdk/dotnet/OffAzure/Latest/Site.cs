...
namespace Pulumi.AzureRM.OffAzure.Latest
{
    ...
    public partial class Site : Pulumi.CustomResource
    {
        ...
        public Site(string name, SiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:offazure/latest:Site", name, args ?? new SiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Site(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:offazure/latest:Site", name, null, MakeResourceOptions(options, id))
        {
        }
