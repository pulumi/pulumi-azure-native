...
namespace Pulumi.AzureRM.OffAzure.Latest
{
    ...
    public partial class HyperVSiteSite : Pulumi.CustomResource
    {
        ...
        public HyperVSiteSite(string name, HyperVSiteSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:offazure/latest:HyperVSiteSite", name, args ?? new HyperVSiteSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HyperVSiteSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:offazure/latest:HyperVSiteSite", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:offazure/v20200101:HyperVSiteSite"},
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HyperVSiteSite Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new HyperVSiteSite(name, id, options);
        }
    }

    public sealed class HyperVSiteSiteArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// eTag for concurrency control.
        /// </summary>
