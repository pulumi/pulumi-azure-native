...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    public static class GetWebAppDiscoverySiteDataSourcesController
    {
        ...
        public static Task<GetWebAppDiscoverySiteDataSourcesControllerResult> InvokeAsync(GetWebAppDiscoverySiteDataSourcesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppDiscoverySiteDataSourcesControllerResult>("azure-native:offazure/v20240501preview:getWebAppDiscoverySiteDataSourcesController", args ?? new GetWebAppDiscoverySiteDataSourcesControllerArgs(), options.WithDefaults());
