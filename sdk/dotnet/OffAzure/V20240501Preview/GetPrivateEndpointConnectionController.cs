...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    public static class GetPrivateEndpointConnectionController
    {
        ...
        public static Task<GetPrivateEndpointConnectionControllerResult> InvokeAsync(GetPrivateEndpointConnectionControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointConnectionControllerResult>("azure-native:offazure/v20240501preview:getPrivateEndpointConnectionController", args ?? new GetPrivateEndpointConnectionControllerArgs(), options.WithDefaults());
