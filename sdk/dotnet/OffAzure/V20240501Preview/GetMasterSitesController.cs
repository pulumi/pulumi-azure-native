...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    public static class GetMasterSitesController
    {
        ...
        public static Task<GetMasterSitesControllerResult> InvokeAsync(GetMasterSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMasterSitesControllerResult>("azure-native:offazure/v20240501preview:getMasterSitesController", args ?? new GetMasterSitesControllerArgs(), options.WithDefaults());
        ...
        public static Output<GetMasterSitesControllerResult> Invoke(GetMasterSitesControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMasterSitesControllerResult>("azure-native:offazure/v20240501preview:getMasterSitesController", args ?? new GetMasterSitesControllerInvokeArgs(), options.WithDefaults());
