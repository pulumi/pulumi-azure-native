...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20240501preview:VcenterController")]
    public partial class VcenterController : global::Pulumi.CustomResource
    {
        ...
        public VcenterController(string name, VcenterControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20240501preview:VcenterController", name, args ?? new VcenterControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VcenterController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20240501preview:VcenterController", name, null, MakeResourceOptions(options, id))
        {
        }
