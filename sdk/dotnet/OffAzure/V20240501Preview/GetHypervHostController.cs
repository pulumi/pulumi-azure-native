...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    public static class GetHypervHostController
    {
        ...
        public static Task<GetHypervHostControllerResult> InvokeAsync(GetHypervHostControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHypervHostControllerResult>("azure-native:offazure/v20240501preview:getHypervHostController", args ?? new GetHypervHostControllerArgs(), options.WithDefaults());
