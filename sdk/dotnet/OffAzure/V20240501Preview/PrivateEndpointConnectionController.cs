...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20240501preview:PrivateEndpointConnectionController")]
    public partial class PrivateEndpointConnectionController : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionController(string name, PrivateEndpointConnectionControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20240501preview:PrivateEndpointConnectionController", name, args ?? new PrivateEndpointConnectionControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20240501preview:PrivateEndpointConnectionController", name, null, MakeResourceOptions(options, id))
        {
        }
