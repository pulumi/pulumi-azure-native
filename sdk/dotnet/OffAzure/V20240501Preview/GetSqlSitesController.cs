...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    public static class GetSqlSitesController
    {
        ...
        public static Task<GetSqlSitesControllerResult> InvokeAsync(GetSqlSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlSitesControllerResult>("azure-native:offazure/v20240501preview:getSqlSitesController", args ?? new GetSqlSitesControllerArgs(), options.WithDefaults());
