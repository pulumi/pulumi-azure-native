...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    public static class GetSitesController
    {
        ...
        public static Task<GetSitesControllerResult> InvokeAsync(GetSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSitesControllerResult>("azure-native:offazure/v20240501preview:getSitesController", args ?? new GetSitesControllerArgs(), options.WithDefaults());

        /// <summary>
        /// Get a VmwareSite
        /// </summary>
        public static Output<GetSitesControllerResult> Invoke(GetSitesControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSitesControllerResult>("azure-native:offazure/v20240501preview:getSitesController", args ?? new GetSitesControllerInvokeArgs(), options.WithDefaults());
