...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20240501preview:HypervClusterControllerCluster")]
    public partial class HypervClusterControllerCluster : global::Pulumi.CustomResource
    {
        ...
        public HypervClusterControllerCluster(string name, HypervClusterControllerClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20240501preview:HypervClusterControllerCluster", name, args ?? new HypervClusterControllerClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HypervClusterControllerCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20240501preview:HypervClusterControllerCluster", name, null, MakeResourceOptions(options, id))
        {
        }
