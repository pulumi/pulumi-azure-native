...
namespace Pulumi.AzureNative.OffAzure.V20240501Preview
{
    public static class ListHypervSitesControllerHealthSummary
    {
        ...
        public static Task<ListHypervSitesControllerHealthSummaryResult> InvokeAsync(ListHypervSitesControllerHealthSummaryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListHypervSitesControllerHealthSummaryResult>("azure-native:offazure/v20240501preview:listHypervSitesControllerHealthSummary", args ?? new ListHypervSitesControllerHealthSummaryArgs(), options.WithDefaults());
        ...
        public static Output<ListHypervSitesControllerHealthSummaryResult> Invoke(ListHypervSitesControllerHealthSummaryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListHypervSitesControllerHealthSummaryResult>("azure-native:offazure/v20240501preview:listHypervSitesControllerHealthSummary", args ?? new ListHypervSitesControllerHealthSummaryInvokeArgs(), options.WithDefaults());
