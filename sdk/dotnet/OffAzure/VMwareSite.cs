...
namespace Pulumi.AzureRM.OffAzure
{
    ...
    /// Site REST Resource.
    /// </summary>
    public partial class VMwareSite : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public VMwareSite(string name, VMwareSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:offazure:VMwareSite", name, args ?? new VMwareSiteArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class VMwareSiteArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// eTag for concurrency control.
        /// </summary>
