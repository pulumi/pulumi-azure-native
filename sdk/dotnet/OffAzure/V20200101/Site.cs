...
namespace Pulumi.AzureNative.OffAzure.V20200101
{
    ...
    /// {
    ///     var site = new AzureNative.OffAzure.V20200101.Site("site", new()
    ///     {
    ///         Location = "eastus",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20200101:Site")]
    public partial class Site : global::Pulumi.CustomResource
    {
        ...
        public Site(string name, SiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20200101:Site", name, args ?? new SiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Site(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20200101:Site", name, null, MakeResourceOptions(options, id))
        {
        }
