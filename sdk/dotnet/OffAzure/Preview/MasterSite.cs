...
namespace Pulumi.AzureRM.OffAzure.Preview
{
    ...
    public partial class MasterSite : Pulumi.CustomResource
    {
        ...
        public MasterSite(string name, MasterSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:offazure/preview:MasterSite", name, args ?? new MasterSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MasterSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:offazure/preview:MasterSite", name, null, MakeResourceOptions(options, id))
        {
        }
