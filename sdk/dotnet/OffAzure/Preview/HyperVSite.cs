...
namespace Pulumi.AzureRM.OffAzure.Preview
{
    ...
    public partial class HyperVSite : Pulumi.CustomResource
    {
        ...
        public HyperVSite(string name, HyperVSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:offazure/preview:HyperVSite", name, args ?? new HyperVSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HyperVSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:offazure/preview:HyperVSite", name, null, MakeResourceOptions(options, id))
        {
        }
