...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    public static class GetVcenterController
    {
        ...
        public static Task<GetVcenterControllerResult> InvokeAsync(GetVcenterControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVcenterControllerResult>("azure-native:offazure/v20231001preview:getVcenterController", args ?? new GetVcenterControllerArgs(), options.WithDefaults());
