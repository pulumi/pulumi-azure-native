...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    ...
    /// A MasterSite
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20231001preview:MasterSitesController")]
    public partial class MasterSitesController : global::Pulumi.CustomResource
    {
        ...
        public MasterSitesController(string name, MasterSitesControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20231001preview:MasterSitesController", name, args ?? new MasterSitesControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MasterSitesController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20231001preview:MasterSitesController", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MasterSitesControllerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.OffAzure.V20231001Preview.MasterSitePropertiesPublicNetworkAccess>? PublicNetworkAccess { get; set; }
