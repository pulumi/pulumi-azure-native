...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    public static class GetWebAppSitesController
    {
        ...
        public static Task<GetWebAppSitesControllerResult> InvokeAsync(GetWebAppSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppSitesControllerResult>("azure-native:offazure/v20231001preview:getWebAppSitesController", args ?? new GetWebAppSitesControllerArgs(), options.WithDefaults());
        ...
        public static Output<GetWebAppSitesControllerResult> Invoke(GetWebAppSitesControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebAppSitesControllerResult>("azure-native:offazure/v20231001preview:getWebAppSitesController", args ?? new GetWebAppSitesControllerInvokeArgs(), options.WithDefaults());
