...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20231001preview:HypervClusterControllerCluster")]
    public partial class HypervClusterControllerCluster : global::Pulumi.CustomResource
    {
        ...
        public HypervClusterControllerCluster(string name, HypervClusterControllerClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20231001preview:HypervClusterControllerCluster", name, args ?? new HypervClusterControllerClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HypervClusterControllerCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20231001preview:HypervClusterControllerCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HypervClusterControllerClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.OffAzure.V20231001Preview.ProvisioningState>? ProvisioningState { get; set; }
