...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20231001preview:HypervHostController")]
    public partial class HypervHostController : global::Pulumi.CustomResource
    {
        ...
        public HypervHostController(string name, HypervHostControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20231001preview:HypervHostController", name, args ?? new HypervHostControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HypervHostController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20231001preview:HypervHostController", name, null, MakeResourceOptions(options, id))
        {
        }
