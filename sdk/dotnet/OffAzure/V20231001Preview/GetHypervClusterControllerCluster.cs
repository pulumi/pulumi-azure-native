...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    public static class GetHypervClusterControllerCluster
    {
        ...
        public static Task<GetHypervClusterControllerClusterResult> InvokeAsync(GetHypervClusterControllerClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHypervClusterControllerClusterResult>("azure-native:offazure/v20231001preview:getHypervClusterControllerCluster", args ?? new GetHypervClusterControllerClusterArgs(), options.WithDefaults());
