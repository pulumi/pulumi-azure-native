...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    public static class GetSqlSitesController
    {
        ...
        public static Task<GetSqlSitesControllerResult> InvokeAsync(GetSqlSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlSitesControllerResult>("azure-native:offazure/v20231001preview:getSqlSitesController", args ?? new GetSqlSitesControllerArgs(), options.WithDefaults());

        /// <summary>
        /// Method to get a site.
        /// </summary>
        public static Output<GetSqlSitesControllerResult> Invoke(GetSqlSitesControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSqlSitesControllerResult>("azure-native:offazure/v20231001preview:getSqlSitesController", args ?? new GetSqlSitesControllerInvokeArgs(), options.WithDefaults());
