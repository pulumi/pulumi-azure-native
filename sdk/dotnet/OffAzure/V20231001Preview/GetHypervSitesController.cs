...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    public static class GetHypervSitesController
    {
        ...
        public static Task<GetHypervSitesControllerResult> InvokeAsync(GetHypervSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHypervSitesControllerResult>("azure-native:offazure/v20231001preview:getHypervSitesController", args ?? new GetHypervSitesControllerArgs(), options.WithDefaults());
        ...
        public static Output<GetHypervSitesControllerResult> Invoke(GetHypervSitesControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHypervSitesControllerResult>("azure-native:offazure/v20231001preview:getHypervSitesController", args ?? new GetHypervSitesControllerInvokeArgs(), options.WithDefaults());
