...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20231001preview:VcenterController")]
    public partial class VcenterController : global::Pulumi.CustomResource
    {
        ...
        public VcenterController(string name, VcenterControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20231001preview:VcenterController", name, args ?? new VcenterControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VcenterController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20231001preview:VcenterController", name, null, MakeResourceOptions(options, id))
        {
        }
