...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    public static class ListHypervSitesControllerHealthSummary
    {
        ...
        public static Task<ListHypervSitesControllerHealthSummaryResult> InvokeAsync(ListHypervSitesControllerHealthSummaryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListHypervSitesControllerHealthSummaryResult>("azure-native:offazure/v20231001preview:listHypervSitesControllerHealthSummary", args ?? new ListHypervSitesControllerHealthSummaryArgs(), options.WithDefaults());
        ...
        public static Output<ListHypervSitesControllerHealthSummaryResult> Invoke(ListHypervSitesControllerHealthSummaryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListHypervSitesControllerHealthSummaryResult>("azure-native:offazure/v20231001preview:listHypervSitesControllerHealthSummary", args ?? new ListHypervSitesControllerHealthSummaryInvokeArgs(), options.WithDefaults());
    }
