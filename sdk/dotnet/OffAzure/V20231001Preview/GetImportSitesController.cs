...
namespace Pulumi.AzureNative.OffAzure.V20231001Preview
{
    public static class GetImportSitesController
    {
        ...
        public static Task<GetImportSitesControllerResult> InvokeAsync(GetImportSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetImportSitesControllerResult>("azure-native:offazure/v20231001preview:getImportSitesController", args ?? new GetImportSitesControllerArgs(), options.WithDefaults());
        ...
        public static Output<GetImportSitesControllerResult> Invoke(GetImportSitesControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetImportSitesControllerResult>("azure-native:offazure/v20231001preview:getImportSitesController", args ?? new GetImportSitesControllerInvokeArgs(), options.WithDefaults());
