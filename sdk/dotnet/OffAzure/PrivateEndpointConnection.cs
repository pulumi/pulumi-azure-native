...
namespace Pulumi.AzureNative.OffAzure
{
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_offazure_v20200707:offazure:PrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_offazure_v20230606:offazure:PrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_offazure_v20231001preview:offazure:PrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native_offazure_v20240501preview:offazure:PrivateEndpointConnection" },
                },
            };
