...
namespace Pulumi.AzureNative.OffAzure
{
    ...
    public partial class SitesController : global::Pulumi.CustomResource
    {
        ...
        public SitesController(string name, SitesControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure:SitesController", name, args ?? new SitesControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SitesController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure:SitesController", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:offazure/v20240701preview:SitesController" },
                    new global::Pulumi.Alias { Type = "azure-native:offazure/v20241201preview:SitesController" },
