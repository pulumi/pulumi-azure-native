...
namespace Pulumi.AzureNative.OffAzure
{
    ...
    public partial class WebAppDiscoverySiteDataSourcesController : global::Pulumi.CustomResource
    {
        ...
        public WebAppDiscoverySiteDataSourcesController(string name, WebAppDiscoverySiteDataSourcesControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure:WebAppDiscoverySiteDataSourcesController", name, args ?? new WebAppDiscoverySiteDataSourcesControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDiscoverySiteDataSourcesController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure:WebAppDiscoverySiteDataSourcesController", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:offazure/v20240701preview:WebAppDiscoverySiteDataSourcesController" },
                    new global::Pulumi.Alias { Type = "azure-native:offazure/v20241201preview:WebAppDiscoverySiteDataSourcesController" },
                },
            };
