...
namespace Pulumi.AzureRM.OffAzure
{
    ...
    public partial class HyperVSite : Pulumi.CustomResource
    {
        ...
        public HyperVSite(string name, HyperVSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:offazure:HyperVSite", name, args ?? new HyperVSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HyperVSite(string name, Input<string> id, HyperVSiteState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:offazure:HyperVSite", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HyperVSiteState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// eTag for concurrency control.
        /// </summary>
