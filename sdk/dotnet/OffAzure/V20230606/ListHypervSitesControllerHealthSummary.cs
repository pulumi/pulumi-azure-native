...
namespace Pulumi.AzureNative.OffAzure.V20230606
{
    public static class ListHypervSitesControllerHealthSummary
    {
        ...
        public static Task<ListHypervSitesControllerHealthSummaryResult> InvokeAsync(ListHypervSitesControllerHealthSummaryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListHypervSitesControllerHealthSummaryResult>("azure-native:offazure/v20230606:listHypervSitesControllerHealthSummary", args ?? new ListHypervSitesControllerHealthSummaryArgs(), options.WithDefaults());
        ...
        public static Output<ListHypervSitesControllerHealthSummaryResult> Invoke(ListHypervSitesControllerHealthSummaryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListHypervSitesControllerHealthSummaryResult>("azure-native:offazure/v20230606:listHypervSitesControllerHealthSummary", args ?? new ListHypervSitesControllerHealthSummaryInvokeArgs(), options.WithDefaults());
    }
