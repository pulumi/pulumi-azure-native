...
namespace Pulumi.AzureNative.OffAzure.V20230606
{
    public static class GetSitesController
    {
        ...
        public static Task<GetSitesControllerResult> InvokeAsync(GetSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSitesControllerResult>("azure-native:offazure/v20230606:getSitesController", args ?? new GetSitesControllerArgs(), options.WithDefaults());

        /// <summary>
        /// Get a VmwareSite
        /// </summary>
        public static Output<GetSitesControllerResult> Invoke(GetSitesControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSitesControllerResult>("azure-native:offazure/v20230606:getSitesController", args ?? new GetSitesControllerInvokeArgs(), options.WithDefaults());
