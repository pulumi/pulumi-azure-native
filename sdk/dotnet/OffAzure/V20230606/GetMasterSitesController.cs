...
namespace Pulumi.AzureNative.OffAzure.V20230606
{
    public static class GetMasterSitesController
    {
        ...
        public static Task<GetMasterSitesControllerResult> InvokeAsync(GetMasterSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMasterSitesControllerResult>("azure-native:offazure/v20230606:getMasterSitesController", args ?? new GetMasterSitesControllerArgs(), options.WithDefaults());
