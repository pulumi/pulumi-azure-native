...
namespace Pulumi.AzureNative.OffAzure.V20230606
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20230606:HypervClusterControllerCluster")]
    public partial class HypervClusterControllerCluster : global::Pulumi.CustomResource
    {
        ...
        public HypervClusterControllerCluster(string name, HypervClusterControllerClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20230606:HypervClusterControllerCluster", name, args ?? new HypervClusterControllerClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HypervClusterControllerCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20230606:HypervClusterControllerCluster", name, null, MakeResourceOptions(options, id))
        {
        }
