...
namespace Pulumi.AzureNative.OffAzure.V20230606
{
    public static class GetServerSitesController
    {
        ...
        public static Task<GetServerSitesControllerResult> InvokeAsync(GetServerSitesControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerSitesControllerResult>("azure-native:offazure/v20230606:getServerSitesController", args ?? new GetServerSitesControllerArgs(), options.WithDefaults());
