...
namespace Pulumi.AzureNative.OffAzure.V20230606
{
    public static class GetSqlDiscoverySiteDataSourceController
    {
        ...
        public static Task<GetSqlDiscoverySiteDataSourceControllerResult> InvokeAsync(GetSqlDiscoverySiteDataSourceControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlDiscoverySiteDataSourceControllerResult>("azure-native:offazure/v20230606:getSqlDiscoverySiteDataSourceController", args ?? new GetSqlDiscoverySiteDataSourceControllerArgs(), options.WithDefaults());
