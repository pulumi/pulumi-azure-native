...
namespace Pulumi.AzureNative.OffAzure.V20230606
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:offazure/v20230606:VcenterController")]
    public partial class VcenterController : global::Pulumi.CustomResource
    {
        ...
        public VcenterController(string name, VcenterControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20230606:VcenterController", name, args ?? new VcenterControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VcenterController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:offazure/v20230606:VcenterController", name, null, MakeResourceOptions(options, id))
        {
        }
