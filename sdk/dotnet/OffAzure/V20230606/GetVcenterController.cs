...
namespace Pulumi.AzureNative.OffAzure.V20230606
{
    public static class GetVcenterController
    {
        ...
        public static Task<GetVcenterControllerResult> InvokeAsync(GetVcenterControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVcenterControllerResult>("azure-native:offazure/v20230606:getVcenterController", args ?? new GetVcenterControllerArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Vcenter
        /// </summary>
        public static Output<GetVcenterControllerResult> Invoke(GetVcenterControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVcenterControllerResult>("azure-native:offazure/v20230606:getVcenterController", args ?? new GetVcenterControllerInvokeArgs(), options.WithDefaults());
