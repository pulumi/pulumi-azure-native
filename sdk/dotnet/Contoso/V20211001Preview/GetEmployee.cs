...
namespace Pulumi.AzureNative.Contoso.V20211001Preview
{
    public static class GetEmployee
    {
        ...
        public static Task<GetEmployeeResult> InvokeAsync(GetEmployeeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEmployeeResult>("azure-native:contoso/v20211001preview:getEmployee", args ?? new GetEmployeeArgs(), options.WithDefaults());
