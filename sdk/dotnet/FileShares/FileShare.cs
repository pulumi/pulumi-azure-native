...
namespace Pulumi.AzureNative.FileShares
{
    ...
    public partial class FileShare : global::Pulumi.CustomResource
    {
        ...
        public FileShare(string name, FileShareArgs args, CustomResourceOptions? options = null)
            : base("azure-native:fileshares:FileShare", name, args ?? new FileShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileShare(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:fileshares:FileShare", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:fileshares/v20250601preview:FileShare" },
                    new global::Pulumi.Alias { Type = "azure-native:fileshares/v20250901preview:FileShare" },
                    new global::Pulumi.Alias { Type = "azure-native:fileshares/v20260601:FileShare" },
                },
            };
