...
namespace Pulumi.AzureNative.EventGrid
{
    ...
    public partial class DomainEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public DomainEventSubscription(string name, DomainEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid:DomainEventSubscription", name, args ?? new DomainEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid:DomainEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20250401preview:DomainEventSubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20250715preview:DomainEventSubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20251115preview:DomainEventSubscription" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DomainEventSubscription Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DomainEventSubscription(name, id, options);
        }
    }

    public sealed class DomainEventSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The dead letter destination of the event subscription. Any event that cannot be delivered to its' destination is sent to the dead letter destination.
        /// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
        ...
        public DomainEventSubscriptionArgs()
        {
            EventDeliverySchema = "EventGridSchema";
        }
        public static new DomainEventSubscriptionArgs Empty => new DomainEventSubscriptionArgs();
    }
}
