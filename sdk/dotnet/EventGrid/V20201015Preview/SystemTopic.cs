...
namespace Pulumi.AzureNative.EventGrid.V20201015Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20201015preview:SystemTopic")]
    public partial class SystemTopic : Pulumi.CustomResource
    {
        ...
        public SystemTopic(string name, SystemTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20201015preview:SystemTopic", name, args ?? new SystemTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20201015preview:SystemTopic", name, null, MakeResourceOptions(options, id))
        {
        }
