...
namespace Pulumi.AzureNative.EventGrid.V20211201
{
    ...
    /// EventGrid Domain.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20211201:Domain")]
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211201:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211201:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
