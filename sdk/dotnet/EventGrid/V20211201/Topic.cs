...
namespace Pulumi.AzureNative.EventGrid.V20211201
{
    ...
    /// EventGrid Topic
    /// </summary>
    [Obsolete(@"azure-native:eventgrid/v20211201:Topic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:Topic to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:eventgrid/v20211201:Topic")]
    public partial class Topic : global::Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211201:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211201:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20211201.InputSchema>? InputSchema { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20211201.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
