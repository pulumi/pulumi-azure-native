...
namespace Pulumi.AzureRM.EventGrid.V20170615Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var eventSubscription = new AzureRM.EventGrid.V20170615Preview.EventSubscription("eventSubscription", new AzureRM.EventGrid.V20170615Preview.EventSubscriptionArgs
    ///         {
    ///             Destination = new AzureRM.EventGrid.V20170615Preview.Inputs.EventSubscriptionDestinationArgs
    ///             {
    ///                 EndpointType = "WebHook",
    ///             },
    ///             EventSubscriptionName = "examplesubscription1",
    ///             Filter = new AzureRM.EventGrid.V20170615Preview.Inputs.EventSubscriptionFilterArgs
    ///             {
    ...
    public partial class EventSubscription : Pulumi.CustomResource
    {
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20170615preview:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20170615preview:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
