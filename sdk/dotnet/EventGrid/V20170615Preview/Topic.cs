...
namespace Pulumi.AzureNextGen.EventGrid.V20170615Preview
{
    ...
    /// EventGrid Topic
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventgrid/v20170615preview:Topic")]
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20170615preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20170615preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
