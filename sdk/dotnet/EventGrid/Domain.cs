...
namespace Pulumi.AzureNextGen.EventGrid
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventgrid:Domain")]
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNextGen.EventGrid.InputSchema>? InputSchema { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.EventGrid.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
