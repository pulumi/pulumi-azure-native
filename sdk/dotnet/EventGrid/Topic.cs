...
namespace Pulumi.AzureNextGen.EventGrid
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventgrid:Topic")]
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
