...
namespace Pulumi.AzureNative.EventGrid.V20210601Preview
{
    ...
    /// {
    ///     var partnerNamespace = new AzureNative.EventGrid.V20210601Preview.PartnerNamespace("partnerNamespace", new()
    ///     {
    ///         Location = "westus",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:eventgrid/v20210601preview:PartnerNamespace examplePartnerNamespaceName1 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/resourceGroups/examplerg/providers/Microsoft.EventGrid/partnerNamespaces/examplePartnerNamespaceName1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20210601preview:PartnerNamespace")]
    public partial class PartnerNamespace : global::Pulumi.CustomResource
    {
        ...
        public PartnerNamespace(string name, PartnerNamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20210601preview:PartnerNamespace", name, args ?? new PartnerNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerNamespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20210601preview:PartnerNamespace", name, null, MakeResourceOptions(options, id))
        {
        }
