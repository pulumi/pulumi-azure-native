...
namespace Pulumi.AzureNative.EventGrid.V20210601Preview
{
    ...
    /// {
    ///     var partnerRegistration = new AzureNative.EventGrid.V20210601Preview.PartnerRegistration("partnerRegistration", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:eventgrid/v20210601preview:PartnerRegistration examplePartnerRegistrationName1 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/resourceGroups/examplerg/providers/Microsoft.EventGrid/partnerRegistrations/examplePartnerRegistrationName1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20210601preview:PartnerRegistration")]
    public partial class PartnerRegistration : global::Pulumi.CustomResource
    {
        ...
        public PartnerRegistration(string name, PartnerRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20210601preview:PartnerRegistration", name, args ?? new PartnerRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20210601preview:PartnerRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerRegistrationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20210601Preview.PartnerRegistrationVisibilityState>? VisibilityState { get; set; }
