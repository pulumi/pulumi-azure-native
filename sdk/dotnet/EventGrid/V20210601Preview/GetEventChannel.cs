...
namespace Pulumi.AzureNative.EventGrid.V20210601Preview
{
    public static class GetEventChannel
    {
        ...
        public static Task<GetEventChannelResult> InvokeAsync(GetEventChannelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEventChannelResult>("azure-native:eventgrid/v20210601preview:getEventChannel", args ?? new GetEventChannelArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of an event channel.
        /// </summary>
        public static Output<GetEventChannelResult> Invoke(GetEventChannelInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEventChannelResult>("azure-native:eventgrid/v20210601preview:getEventChannel", args ?? new GetEventChannelInvokeArgs(), options.WithDefaults());
