...
namespace Pulumi.AzureNative.EventGrid.V20210601Preview
{
    ...
    /// Event Subscription
    /// </summary>
    [Obsolete(@"azure-native:eventgrid/v20210601preview:PartnerTopicEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerTopicEventSubscription to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:eventgrid/v20210601preview:PartnerTopicEventSubscription")]
    public partial class PartnerTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public PartnerTopicEventSubscription(string name, PartnerTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20210601preview:PartnerTopicEventSubscription", name, args ?? new PartnerTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20210601preview:PartnerTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
