...
namespace Pulumi.AzureNative.EventGrid.V20210601Preview
{
    ...
    public partial class EventChannel : global::Pulumi.CustomResource
    {
        ...
        public EventChannel(string name, EventChannelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20210601preview:EventChannel", name, args ?? new EventChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventChannel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20210601preview:EventChannel", name, null, MakeResourceOptions(options, id))
        {
        }
