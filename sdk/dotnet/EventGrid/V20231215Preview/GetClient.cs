...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    public static class GetClient
    {
        ...
        public static Task<GetClientResult> InvokeAsync(GetClientArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClientResult>("azure-native:eventgrid/v20231215preview:getClient", args ?? new GetClientArgs(), options.WithDefaults());
