...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    public static class GetDomain
    {
        ...
        public static Task<GetDomainResult> InvokeAsync(GetDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainResult>("azure-native:eventgrid/v20231215preview:getDomain", args ?? new GetDomainArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of a domain.
        /// </summary>
        public static Output<GetDomainResult> Invoke(GetDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDomainResult>("azure-native:eventgrid/v20231215preview:getDomain", args ?? new GetDomainInvokeArgs(), options.WithDefaults());
