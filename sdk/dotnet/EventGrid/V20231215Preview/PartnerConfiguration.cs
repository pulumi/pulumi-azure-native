...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20231215preview:PartnerConfiguration")]
    public partial class PartnerConfiguration : global::Pulumi.CustomResource
    {
        ...
        public PartnerConfiguration(string name, PartnerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:PartnerConfiguration", name, args ?? new PartnerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:PartnerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20231215Preview.PartnerConfigurationProvisioningState>? ProvisioningState { get; set; }
