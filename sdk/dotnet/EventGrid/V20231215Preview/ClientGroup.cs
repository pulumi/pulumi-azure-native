...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20231215preview:ClientGroup")]
    public partial class ClientGroup : global::Pulumi.CustomResource
    {
        ...
        public ClientGroup(string name, ClientGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:ClientGroup", name, args ?? new ClientGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClientGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:ClientGroup", name, null, MakeResourceOptions(options, id))
        {
        }
