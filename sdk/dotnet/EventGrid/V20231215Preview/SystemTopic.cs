...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20231215preview:SystemTopic")]
    public partial class SystemTopic : global::Pulumi.CustomResource
    {
        ...
        public SystemTopic(string name, SystemTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:SystemTopic", name, args ?? new SystemTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:SystemTopic", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20250215:SystemTopic" },
