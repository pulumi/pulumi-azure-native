...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20231215preview:PermissionBinding")]
    public partial class PermissionBinding : global::Pulumi.CustomResource
    {
        ...
        public PermissionBinding(string name, PermissionBindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:PermissionBinding", name, args ?? new PermissionBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PermissionBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:PermissionBinding", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PermissionBindingArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("permission")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20231215Preview.PermissionType>? Permission { get; set; }
