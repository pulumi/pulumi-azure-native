...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    ...
    /// EventGrid Topic
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20231215preview:Topic")]
    public partial class Topic : global::Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20201015preview:Topic" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20240601preview:Topic" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20241215preview:Topic" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20250215:Topic" },
    ...
    public sealed class TopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20231215Preview.DataResidencyBoundary>? DataResidencyBoundary { get; set; }
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20231215Preview.InputSchema>? InputSchema { get; set; }
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20231215Preview.ResourceKind>? Kind { get; set; }
