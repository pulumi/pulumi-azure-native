...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    public static class ListNamespaceTopicSharedAccessKeys
    {
        ...
        public static Task<ListNamespaceTopicSharedAccessKeysResult> InvokeAsync(ListNamespaceTopicSharedAccessKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceTopicSharedAccessKeysResult>("azure-native:eventgrid/v20231215preview:listNamespaceTopicSharedAccessKeys", args ?? new ListNamespaceTopicSharedAccessKeysArgs(), options.WithDefaults());
