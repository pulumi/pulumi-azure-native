...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20231215preview:DomainTopicEventSubscription")]
    public partial class DomainTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public DomainTopicEventSubscription(string name, DomainTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:DomainTopicEventSubscription", name, args ?? new DomainTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:DomainTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid:DomainTopicEventSubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20211015preview:DomainTopicEventSubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20220615:DomainTopicEventSubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20230601preview:DomainTopicEventSubscription" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DomainTopicEventSubscription Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DomainTopicEventSubscription(name, id, options);
        }
    }

    public sealed class DomainTopicEventSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The dead letter destination of the event subscription. Any event that cannot be delivered to its' destination is sent to the dead letter destination.
        /// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20231215Preview.EventDeliverySchema>? EventDeliverySchema { get; set; }
        ...
        public DomainTopicEventSubscriptionArgs()
        {
            EventDeliverySchema = "EventGridSchema";
        }
        public static new DomainTopicEventSubscriptionArgs Empty => new DomainTopicEventSubscriptionArgs();
    }
}
