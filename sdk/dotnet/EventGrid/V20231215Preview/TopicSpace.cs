...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20231215preview:TopicSpace")]
    public partial class TopicSpace : global::Pulumi.CustomResource
    {
        ...
        public TopicSpace(string name, TopicSpaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:TopicSpace", name, args ?? new TopicSpaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicSpace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:TopicSpace", name, null, MakeResourceOptions(options, id))
        {
        }
