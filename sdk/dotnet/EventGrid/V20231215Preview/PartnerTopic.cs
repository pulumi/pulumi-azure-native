...
namespace Pulumi.AzureNative.EventGrid.V20231215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20231215preview:PartnerTopic")]
    public partial class PartnerTopic : global::Pulumi.CustomResource
    {
        ...
        public PartnerTopic(string name, PartnerTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:PartnerTopic", name, args ?? new PartnerTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20231215preview:PartnerTopic", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20250215:PartnerTopic" },
    ...
    public sealed class PartnerTopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20231215Preview.PartnerTopicActivationState>? ActivationState { get; set; }
