...
namespace Pulumi.AzureNative.EventGrid.V20190601
{
    ...
    /// EventGrid Topic
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20190601:Topic")]
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20190601:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20190601:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
