...
namespace Pulumi.AzureNextGen.EventGrid.V20190601
{
    ...
    /// Event Subscription
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventgrid/v20190601:EventSubscription")]
    public partial class EventSubscription : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("destination")]
        public Output<Union<Outputs.EventHubEventSubscriptionDestinationResponse, Union<Outputs.HybridConnectionEventSubscriptionDestinationResponse, Union<Outputs.ServiceBusQueueEventSubscriptionDestinationResponse, Union<Outputs.StorageQueueEventSubscriptionDestinationResponse, Outputs.WebHookEventSubscriptionDestinationResponse>>>>?> Destination { get; private set; } = null!;
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20190601:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20190601:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
