...
namespace Pulumi.AzureRM.EventGrid.V20190601
{
    public static class GetDomainTopic
    {
        public static Task<GetDomainTopicResult> InvokeAsync(GetDomainTopicArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDomainTopicResult>("azurerm:eventgrid/v20190601:getDomainTopic", args ?? new GetDomainTopicArgs(), options.WithVersion());
    }
