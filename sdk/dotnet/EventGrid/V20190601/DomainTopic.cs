...
namespace Pulumi.AzureRM.EventGrid.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var domainTopic = new AzureRM.EventGrid.V20190601.DomainTopic("domainTopic", new AzureRM.EventGrid.V20190601.DomainTopicArgs
    ///         {
    ...
    public partial class DomainTopic : Pulumi.CustomResource
    {
        ...
        public DomainTopic(string name, DomainTopicArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20190601:DomainTopic", name, args ?? new DomainTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20190601:DomainTopic", name, null, MakeResourceOptions(options, id))
        {
        }
