...
namespace Pulumi.AzureNative.EventGrid.V20200401Preview
{
    public static class GetDomainTopic
    {
        ...
        public static Task<GetDomainTopicResult> InvokeAsync(GetDomainTopicArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDomainTopicResult>("azure-native:eventgrid/v20200401preview:getDomainTopic", args ?? new GetDomainTopicArgs(), options.WithDefaults());

        /// <summary>
        /// Domain Topic.
        /// </summary>
        public static Output<GetDomainTopicResult> Invoke(GetDomainTopicInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDomainTopicResult>("azure-native:eventgrid/v20200401preview:getDomainTopic", args ?? new GetDomainTopicInvokeArgs(), options.WithDefaults());
    }
