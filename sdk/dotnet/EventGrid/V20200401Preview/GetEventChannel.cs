...
{
    [Obsolete(@"azure-native:eventgrid/v20200401preview:EventChannel is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20211015preview:EventChannel to guarantee forwards compatibility.")]
    public static class GetEventChannel
    {
        ...
        public static Task<GetEventChannelResult> InvokeAsync(GetEventChannelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEventChannelResult>("azure-native:eventgrid/v20200401preview:getEventChannel", args ?? new GetEventChannelArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of an event channel.
        /// </summary>
        public static Output<GetEventChannelResult> Invoke(GetEventChannelInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEventChannelResult>("azure-native:eventgrid/v20200401preview:getEventChannel", args ?? new GetEventChannelInvokeArgs(), options.WithDefaults());
    }
