...
namespace Pulumi.AzureNative.EventGrid.V20200401Preview
{
    ...
    /// Domain Topic.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20200401preview:DomainTopic")]
    public partial class DomainTopic : Pulumi.CustomResource
    {
        ...
        public DomainTopic(string name, DomainTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20200401preview:DomainTopic", name, args ?? new DomainTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20200401preview:DomainTopic", name, null, MakeResourceOptions(options, id))
        {
        }
