...
namespace Pulumi.AzureRM.EventGrid.V20200401Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var domain = new AzureRM.EventGrid.V20200401Preview.Domain("domain", new AzureRM.EventGrid.V20200401Preview.DomainArgs
    ///         {
    ///             DomainName = "exampledomain1",
    ///             InboundIpRules = 
    ///             {
    ///                 new AzureRM.EventGrid.V20200401Preview.Inputs.InboundIpRuleArgs
    ///                 {
    ///                     Action = "Allow",
    ///                     IpMask = "12.18.30.15",
    ///                 },
    ...
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200401preview:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200401preview:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
