...
namespace Pulumi.AzureNative.EventGrid.V20200401Preview
{
    ...
    /// {
    ///     var domain = new AzureNative.EventGrid.V20200401Preview.Domain("domain", new()
    ///     {
    ///         DomainName = "exampledomain1",
    ///         InboundIpRules = new[]
    ///         {
    ///             new AzureNative.EventGrid.V20200401Preview.Inputs.InboundIpRuleArgs
    ///             {
    ///                 Action = "Allow",
    ///                 IpMask = "12.18.30.15",
    ///             },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:eventgrid/v20200401preview:Domain exampledomain1 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/resourceGroups/examplerg/providers/Microsoft.EventGrid/domains/exampledomain1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20200401preview:Domain")]
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20200401preview:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20200401preview:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20200401Preview.InputSchema>? InputSchema { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20200401Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
