...
namespace Pulumi.AzureRM.EventGrid.V20200401Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var topic = new AzureRM.EventGrid.V20200401Preview.Topic("topic", new AzureRM.EventGrid.V20200401Preview.TopicArgs
    ///         {
    ///             InboundIpRules = 
    ///             {
    ...
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200401preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200401preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
