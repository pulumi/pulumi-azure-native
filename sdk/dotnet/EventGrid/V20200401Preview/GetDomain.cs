...
namespace Pulumi.AzureNative.EventGrid.V20200401Preview
{
    public static class GetDomain
    {
        ...
        public static Task<GetDomainResult> InvokeAsync(GetDomainArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDomainResult>("azure-native:eventgrid/v20200401preview:getDomain", args ?? new GetDomainArgs(), options.WithDefaults());

        /// <summary>
        /// EventGrid Domain.
        /// </summary>
        public static Output<GetDomainResult> Invoke(GetDomainInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDomainResult>("azure-native:eventgrid/v20200401preview:getDomain", args ?? new GetDomainInvokeArgs(), options.WithDefaults());
    }
