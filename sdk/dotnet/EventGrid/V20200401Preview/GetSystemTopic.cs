...
namespace Pulumi.AzureNative.EventGrid.V20200401Preview
{
    public static class GetSystemTopic
    {
        ...
        public static Output<GetSystemTopicResult> Invoke(GetSystemTopicInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSystemTopicResult>("azure-native:eventgrid/v20200401preview:getSystemTopic", args ?? new GetSystemTopicInvokeArgs(), options.WithVersion());
    }
