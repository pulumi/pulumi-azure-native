...
namespace Pulumi.AzureNative.EventGrid.V20200401Preview
{
    ...
    /// {
    ///     var systemTopicEventSubscription = new AzureNative.EventGrid.V20200401Preview.SystemTopicEventSubscription("systemTopicEventSubscription", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:eventgrid/v20200401preview:SystemTopicEventSubscription exampleEventSubscriptionName1 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/resourceGroups/examplerg/providers/Microsoft.EventGrid/systemTopics/exampleSystemTopic1/eventSubscriptions/exampleEventSubscriptionName1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20200401preview:SystemTopicEventSubscription")]
    public partial class SystemTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public SystemTopicEventSubscription(string name, SystemTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20200401preview:SystemTopicEventSubscription", name, args ?? new SystemTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20200401preview:SystemTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
