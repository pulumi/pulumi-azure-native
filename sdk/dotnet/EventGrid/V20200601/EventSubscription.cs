...
namespace Pulumi.AzureNextGen.EventGrid.V20200601
{
    ...
    /// Event Subscription
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventgrid/v20200601:EventSubscription")]
    public partial class EventSubscription : Pulumi.CustomResource
    {
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20200601:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20200601:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventSubscriptionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.EventGrid.V20200601.EventDeliverySchema>? EventDeliverySchema { get; set; }
