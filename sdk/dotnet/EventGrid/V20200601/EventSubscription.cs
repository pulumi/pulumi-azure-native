...
namespace Pulumi.AzureNative.EventGrid.V20200601
{
    ...
    /// {
    ///     var eventSubscription = new AzureNative.EventGrid.V20200601.EventSubscription("eventSubscription", new()
    ///     {
    ///         DeadLetterDestination = new AzureNative.EventGrid.V20200601.Inputs.StorageBlobDeadLetterDestinationArgs
    ///         {
    ///             BlobContainerName = "contosocontainer",
    ///             EndpointType = "StorageBlob",
    ///             ResourceId = "/subscriptions/55f3dcd4-cac7-43b4-990b-a139d62a1eb2/resourceGroups/TestRG/providers/Microsoft.Storage/storageAccounts/contosostg",
    ///         },
    ///         Destination = new AzureNative.EventGrid.V20200601.Inputs.EventHubEventSubscriptionDestinationArgs
    ///         {
    ///             EndpointType = "EventHub",
    ///             ResourceId = "/subscriptions/55f3dcd4-cac7-43b4-990b-a139d62a1eb2/resourceGroups/TestRG/providers/Microsoft.EventHub/namespaces/ContosoNamespace/eventhubs/EH1",
    ///         },
    ///         EventSubscriptionName = "examplesubscription1",
    ///         Filter = new AzureNative.EventGrid.V20200601.Inputs.EventSubscriptionFilterArgs
    ///         {
    ...
    ///             ResourceId = "/subscriptions/55f3dcd4-cac7-43b4-990b-a139d62a1eb2/resourceGroups/TestRG/providers/Microsoft.Storage/storageAccounts/contosostg",
    ///         },
    ///         Destination = new AzureNative.EventGrid.V20200601.Inputs.HybridConnectionEventSubscriptionDestinationArgs
    ///         {
    ...
    ///             ResourceId = "/subscriptions/55f3dcd4-cac7-43b4-990b-a139d62a1eb2/resourceGroups/TestRG/providers/Microsoft.Storage/storageAccounts/contosostg",
    ///         },
    ///         Destination = new AzureNative.EventGrid.V20200601.Inputs.StorageQueueEventSubscriptionDestinationArgs
    ///         {
    ...
    ///     var eventSubscription = new AzureNative.EventGrid.V20200601.EventSubscription("eventSubscription", new()
    ///     {
    ///         Destination = new AzureNative.EventGrid.V20200601.Inputs.WebHookEventSubscriptionDestinationArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20200601:EventSubscription")]
    public partial class EventSubscription : global::Pulumi.CustomResource
    {
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20200601:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20200601:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EventSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20200601.EventDeliverySchema>? EventDeliverySchema { get; set; }
