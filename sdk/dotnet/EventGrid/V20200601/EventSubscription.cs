...
namespace Pulumi.AzureRM.EventGrid.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var eventSubscription = new AzureRM.EventGrid.V20200601.EventSubscription("eventSubscription", new AzureRM.EventGrid.V20200601.EventSubscriptionArgs
    ///         {
    ///             DeadLetterDestination = new AzureRM.EventGrid.V20200601.Inputs.DeadLetterDestinationArgs
    ///             {
    ///                 EndpointType = "StorageBlob",
    ///             },
    ///             Destination = new AzureRM.EventGrid.V20200601.Inputs.EventSubscriptionDestinationArgs
    ///             {
    ...
    ///             Filter = new AzureRM.EventGrid.V20200601.Inputs.EventSubscriptionFilterArgs
    ///             {
    ...
    public partial class EventSubscription : Pulumi.CustomResource
    {
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200601:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200601:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
