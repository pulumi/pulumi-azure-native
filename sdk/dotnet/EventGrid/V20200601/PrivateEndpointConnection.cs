...
namespace Pulumi.AzureNative.EventGrid.V20200601
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.EventGrid.V20200601.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         ParentName = "exampletopic1",
    ///         ParentType = "topics",
    ///         PrivateEndpointConnectionName = "BMTPE5.8A30D251-4C61-489D-A1AA-B37C4A329B8B",
    ///         PrivateLinkServiceConnectionState = new AzureNative.EventGrid.V20200601.Inputs.ConnectionStateArgs
    ///         {
