...
namespace Pulumi.AzureNextGen.EventGrid.V20200601
{
    ...
    /// EventGrid Topic
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventgrid/v20200601:Topic")]
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20200601:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20200601:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
