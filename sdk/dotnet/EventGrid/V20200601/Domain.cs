...
namespace Pulumi.AzureNextGen.EventGrid.V20200601
{
    ...
    /// EventGrid Domain.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventgrid/v20200601:Domain")]
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20200601:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20200601:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
