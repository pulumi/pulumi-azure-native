...
namespace Pulumi.AzureRM.EventGrid.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var domain = new AzureRM.EventGrid.V20200601.Domain("domain", new AzureRM.EventGrid.V20200601.DomainArgs
    ///         {
    ...
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200601:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200601:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
