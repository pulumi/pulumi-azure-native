...
namespace Pulumi.AzureNative.EventGrid.V20190101
{
    ...
    /// Event Subscription
    /// </summary>
    [Obsolete(@"Version v20190101 will be removed in the next major version of the provider. Upgrade to version v20200401preview or later.")]
    [AzureNativeResourceType("azure-native:eventgrid/v20190101:EventSubscription")]
    public partial class EventSubscription : Pulumi.CustomResource
    {
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20190101:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20190101:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
