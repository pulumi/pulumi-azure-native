...
namespace Pulumi.AzureRM.EventGrid.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var topic = new AzureRM.EventGrid.V20190101.Topic("topic", new AzureRM.EventGrid.V20190101.TopicArgs
    ///         {
    ///             Location = "westus2",
    ...
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20190101:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20190101:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
