...
namespace Pulumi.AzureNative.EventGrid
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid:ClientGroup")]
    public partial class ClientGroup : global::Pulumi.CustomResource
    {
        ...
        public ClientGroup(string name, ClientGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid:ClientGroup", name, args ?? new ClientGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClientGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid:ClientGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20250401preview:ClientGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20250715preview:ClientGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20251115preview:ClientGroup" },
                },
            };
