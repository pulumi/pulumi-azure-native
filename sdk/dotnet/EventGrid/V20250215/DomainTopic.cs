...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// Domain Topic.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:DomainTopic")]
    public partial class DomainTopic : global::Pulumi.CustomResource
    {
        ...
        public DomainTopic(string name, DomainTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:DomainTopic", name, args ?? new DomainTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:DomainTopic", name, null, MakeResourceOptions(options, id))
        {
        }
