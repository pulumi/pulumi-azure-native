...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    public static class GetPartnerConfiguration
    {
        ...
        public static Task<GetPartnerConfigurationResult> InvokeAsync(GetPartnerConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPartnerConfigurationResult>("azure-native:eventgrid/v20250215:getPartnerConfiguration", args ?? new GetPartnerConfigurationArgs(), options.WithDefaults());
        ...
        public static Output<GetPartnerConfigurationResult> Invoke(GetPartnerConfigurationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPartnerConfigurationResult>("azure-native:eventgrid/v20250215:getPartnerConfiguration", args ?? new GetPartnerConfigurationInvokeArgs(), options.WithDefaults());
