...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:ClientGroup")]
    public partial class ClientGroup : global::Pulumi.CustomResource
    {
        ...
        public ClientGroup(string name, ClientGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:ClientGroup", name, args ?? new ClientGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClientGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:ClientGroup", name, null, MakeResourceOptions(options, id))
        {
        }
