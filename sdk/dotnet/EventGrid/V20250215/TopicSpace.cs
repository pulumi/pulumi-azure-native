...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:TopicSpace")]
    public partial class TopicSpace : global::Pulumi.CustomResource
    {
        ...
        public TopicSpace(string name, TopicSpaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:TopicSpace", name, args ?? new TopicSpaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicSpace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:TopicSpace", name, null, MakeResourceOptions(options, id))
        {
        }
