...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    public static class GetDomainEventSubscription
    {
        ...
        public static Task<GetDomainEventSubscriptionResult> InvokeAsync(GetDomainEventSubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainEventSubscriptionResult>("azure-native:eventgrid/v20250215:getDomainEventSubscription", args ?? new GetDomainEventSubscriptionArgs(), options.WithDefaults());
        ...
        public static Output<GetDomainEventSubscriptionResult> Invoke(GetDomainEventSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDomainEventSubscriptionResult>("azure-native:eventgrid/v20250215:getDomainEventSubscription", args ?? new GetDomainEventSubscriptionInvokeArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of an event subscription of a domain.
        /// </summary>
        public static Output<GetDomainEventSubscriptionResult> Invoke(GetDomainEventSubscriptionInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetDomainEventSubscriptionResult>("azure-native:eventgrid/v20250215:getDomainEventSubscription", args ?? new GetDomainEventSubscriptionInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetDomainEventSubscriptionArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Name of the domain.
        /// </summary>
        ...
        public GetDomainEventSubscriptionArgs()
        {
        }
        public static new GetDomainEventSubscriptionArgs Empty => new GetDomainEventSubscriptionArgs();
    }

    public sealed class GetDomainEventSubscriptionInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Name of the domain.
        /// </summary>
        ...
        public GetDomainEventSubscriptionInvokeArgs()
        {
        }
        public static new GetDomainEventSubscriptionInvokeArgs Empty => new GetDomainEventSubscriptionInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainEventSubscriptionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDomainEventSubscriptionResult(
