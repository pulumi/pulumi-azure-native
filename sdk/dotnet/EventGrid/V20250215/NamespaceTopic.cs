...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:NamespaceTopic")]
    public partial class NamespaceTopic : global::Pulumi.CustomResource
    {
        ...
        public NamespaceTopic(string name, NamespaceTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:NamespaceTopic", name, args ?? new NamespaceTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:NamespaceTopic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceTopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20250215.EventInputSchema>? InputSchema { get; set; }
        ...
        /// </summary>
        [Input("publisherType")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20250215.PublisherType>? PublisherType { get; set; }
