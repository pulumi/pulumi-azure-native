...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:PartnerConfiguration")]
    public partial class PartnerConfiguration : global::Pulumi.CustomResource
    {
        ...
        public PartnerConfiguration(string name, PartnerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:PartnerConfiguration", name, args ?? new PartnerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:PartnerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20250215.PartnerConfigurationProvisioningState>? ProvisioningState { get; set; }
