...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:TopicEventSubscription")]
    public partial class TopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public TopicEventSubscription(string name, TopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:TopicEventSubscription", name, args ?? new TopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:TopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
