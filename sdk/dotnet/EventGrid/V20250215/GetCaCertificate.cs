...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    public static class GetCaCertificate
    {
        ...
        public static Task<GetCaCertificateResult> InvokeAsync(GetCaCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCaCertificateResult>("azure-native:eventgrid/v20250215:getCaCertificate", args ?? new GetCaCertificateArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of a CA certificate.
        /// </summary>
        public static Output<GetCaCertificateResult> Invoke(GetCaCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCaCertificateResult>("azure-native:eventgrid/v20250215:getCaCertificate", args ?? new GetCaCertificateInvokeArgs(), options.WithDefaults());
