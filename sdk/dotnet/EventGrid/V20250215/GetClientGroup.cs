...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    public static class GetClientGroup
    {
        ...
        public static Task<GetClientGroupResult> InvokeAsync(GetClientGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClientGroupResult>("azure-native:eventgrid/v20250215:getClientGroup", args ?? new GetClientGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of a client group.
        /// </summary>
        public static Output<GetClientGroupResult> Invoke(GetClientGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClientGroupResult>("azure-native:eventgrid/v20250215:getClientGroup", args ?? new GetClientGroupInvokeArgs(), options.WithDefaults());
