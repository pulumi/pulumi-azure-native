...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:NamespaceTopicEventSubscription")]
    public partial class NamespaceTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public NamespaceTopicEventSubscription(string name, NamespaceTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:NamespaceTopicEventSubscription", name, args ?? new NamespaceTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:NamespaceTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceTopicEventSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20250215.DeliverySchema>? EventDeliverySchema { get; set; }
