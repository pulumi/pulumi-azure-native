...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// The Client resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:Client")]
    public partial class Client : global::Pulumi.CustomResource
    {
        ...
        public Client(string name, ClientArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:Client", name, args ?? new ClientArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Client(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:Client", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClientArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20250215.ClientState>? State { get; set; }
