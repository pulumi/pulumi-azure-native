...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// EventGrid Topic
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:Topic")]
    public partial class Topic : global::Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
