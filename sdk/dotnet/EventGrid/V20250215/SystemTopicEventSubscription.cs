...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:SystemTopicEventSubscription")]
    public partial class SystemTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public SystemTopicEventSubscription(string name, SystemTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:SystemTopicEventSubscription", name, args ?? new SystemTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:SystemTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
