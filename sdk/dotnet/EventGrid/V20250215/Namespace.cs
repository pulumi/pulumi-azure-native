...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// Namespace resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
