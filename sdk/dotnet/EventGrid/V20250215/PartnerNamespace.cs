...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:PartnerNamespace")]
    public partial class PartnerNamespace : global::Pulumi.CustomResource
    {
        ...
        public PartnerNamespace(string name, PartnerNamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:PartnerNamespace", name, args ?? new PartnerNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerNamespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:PartnerNamespace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerNamespaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20250215.TlsVersion>? MinimumTlsVersionAllowed { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20250215.PartnerTopicRoutingMode>? PartnerTopicRoutingMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20250215.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
