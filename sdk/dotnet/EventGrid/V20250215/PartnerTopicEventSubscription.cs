...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20250215:PartnerTopicEventSubscription")]
    public partial class PartnerTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public PartnerTopicEventSubscription(string name, PartnerTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:PartnerTopicEventSubscription", name, args ?? new PartnerTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20250215:PartnerTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
