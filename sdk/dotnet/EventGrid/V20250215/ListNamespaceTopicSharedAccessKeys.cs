...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    public static class ListNamespaceTopicSharedAccessKeys
    {
        ...
        public static Task<ListNamespaceTopicSharedAccessKeysResult> InvokeAsync(ListNamespaceTopicSharedAccessKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceTopicSharedAccessKeysResult>("azure-native:eventgrid/v20250215:listNamespaceTopicSharedAccessKeys", args ?? new ListNamespaceTopicSharedAccessKeysArgs(), options.WithDefaults());
        ...
        public static Output<ListNamespaceTopicSharedAccessKeysResult> Invoke(ListNamespaceTopicSharedAccessKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListNamespaceTopicSharedAccessKeysResult>("azure-native:eventgrid/v20250215:listNamespaceTopicSharedAccessKeys", args ?? new ListNamespaceTopicSharedAccessKeysInvokeArgs(), options.WithDefaults());
