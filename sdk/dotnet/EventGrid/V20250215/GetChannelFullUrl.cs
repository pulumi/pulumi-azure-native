...
namespace Pulumi.AzureNative.EventGrid.V20250215
{
    public static class GetChannelFullUrl
    {
        ...
        public static Task<GetChannelFullUrlResult> InvokeAsync(GetChannelFullUrlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetChannelFullUrlResult>("azure-native:eventgrid/v20250215:getChannelFullUrl", args ?? new GetChannelFullUrlArgs(), options.WithDefaults());

        /// <summary>
        /// Get the full endpoint URL of a partner destination channel.
        /// </summary>
        public static Output<GetChannelFullUrlResult> Invoke(GetChannelFullUrlInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetChannelFullUrlResult>("azure-native:eventgrid/v20250215:getChannelFullUrl", args ?? new GetChannelFullUrlInvokeArgs(), options.WithDefaults());
