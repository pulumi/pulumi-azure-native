...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    public static class ListNamespaceTopicSharedAccessKeys
    {
        ...
        public static Task<ListNamespaceTopicSharedAccessKeysResult> InvokeAsync(ListNamespaceTopicSharedAccessKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListNamespaceTopicSharedAccessKeysResult>("azure-native:eventgrid/v20241215preview:listNamespaceTopicSharedAccessKeys", args ?? new ListNamespaceTopicSharedAccessKeysArgs(), options.WithDefaults());
        ...
        public static Output<ListNamespaceTopicSharedAccessKeysResult> Invoke(ListNamespaceTopicSharedAccessKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListNamespaceTopicSharedAccessKeysResult>("azure-native:eventgrid/v20241215preview:listNamespaceTopicSharedAccessKeys", args ?? new ListNamespaceTopicSharedAccessKeysInvokeArgs(), options.WithDefaults());
