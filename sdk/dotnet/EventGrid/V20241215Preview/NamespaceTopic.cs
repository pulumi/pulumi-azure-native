...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:NamespaceTopic")]
    public partial class NamespaceTopic : global::Pulumi.CustomResource
    {
        ...
        public NamespaceTopic(string name, NamespaceTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:NamespaceTopic", name, args ?? new NamespaceTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:NamespaceTopic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceTopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20241215Preview.EventInputSchema>? InputSchema { get; set; }
        ...
        /// </summary>
        [Input("publisherType")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20241215Preview.PublisherType>? PublisherType { get; set; }
