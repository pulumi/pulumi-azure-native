...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// Channel info.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:Channel")]
    public partial class Channel : global::Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ChannelArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("channelType")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20241215Preview.ChannelType>? ChannelType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20241215Preview.ChannelProvisioningState>? ProvisioningState { get; set; }

        /// <summary>
        /// The readiness state of the corresponding partner topic.
        /// </summary>
        [Input("readinessState")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20241215Preview.ReadinessState>? ReadinessState { get; set; }
