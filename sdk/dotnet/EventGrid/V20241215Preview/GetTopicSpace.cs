...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    public static class GetTopicSpace
    {
        ...
        public static Task<GetTopicSpaceResult> InvokeAsync(GetTopicSpaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTopicSpaceResult>("azure-native:eventgrid/v20241215preview:getTopicSpace", args ?? new GetTopicSpaceArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of a topic space.
        /// </summary>
        public static Output<GetTopicSpaceResult> Invoke(GetTopicSpaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTopicSpaceResult>("azure-native:eventgrid/v20241215preview:getTopicSpace", args ?? new GetTopicSpaceInvokeArgs(), options.WithDefaults());
    }
