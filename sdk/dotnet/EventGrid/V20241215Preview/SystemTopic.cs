...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:SystemTopic")]
    public partial class SystemTopic : global::Pulumi.CustomResource
    {
        ...
        public SystemTopic(string name, SystemTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:SystemTopic", name, args ?? new SystemTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:SystemTopic", name, null, MakeResourceOptions(options, id))
        {
        }
