...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription")]
    public partial class DomainTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public DomainTopicEventSubscription(string name, DomainTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription", name, args ?? new DomainTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
