...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription")]
    public partial class NamespaceTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public NamespaceTopicEventSubscription(string name, NamespaceTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription", name, args ?? new NamespaceTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NamespaceTopicEventSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20241215Preview.DeliverySchema>? EventDeliverySchema { get; set; }
