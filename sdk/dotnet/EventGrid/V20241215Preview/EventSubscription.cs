...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:EventSubscription")]
    public partial class EventSubscription : global::Pulumi.CustomResource
    {
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
