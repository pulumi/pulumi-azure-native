...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:CaCertificate")]
    public partial class CaCertificate : global::Pulumi.CustomResource
    {
        ...
        public CaCertificate(string name, CaCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:CaCertificate", name, args ?? new CaCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CaCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:CaCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
