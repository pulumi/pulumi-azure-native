...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:DomainEventSubscription")]
    public partial class DomainEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public DomainEventSubscription(string name, DomainEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:DomainEventSubscription", name, args ?? new DomainEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:DomainEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
