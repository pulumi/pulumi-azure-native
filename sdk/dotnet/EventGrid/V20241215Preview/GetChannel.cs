...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    public static class GetChannel
    {
        ...
        public static Task<GetChannelResult> InvokeAsync(GetChannelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetChannelResult>("azure-native:eventgrid/v20241215preview:getChannel", args ?? new GetChannelArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of a channel.
        /// </summary>
        public static Output<GetChannelResult> Invoke(GetChannelInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetChannelResult>("azure-native:eventgrid/v20241215preview:getChannel", args ?? new GetChannelInvokeArgs(), options.WithDefaults());
