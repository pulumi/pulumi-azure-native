...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:PartnerRegistration")]
    public partial class PartnerRegistration : global::Pulumi.CustomResource
    {
        ...
        public PartnerRegistration(string name, PartnerRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:PartnerRegistration", name, args ?? new PartnerRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:PartnerRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
