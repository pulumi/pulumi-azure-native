...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// EventGrid Domain.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:Domain")]
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
