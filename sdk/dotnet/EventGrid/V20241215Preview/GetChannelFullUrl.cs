...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    public static class GetChannelFullUrl
    {
        ...
        public static Task<GetChannelFullUrlResult> InvokeAsync(GetChannelFullUrlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetChannelFullUrlResult>("azure-native:eventgrid/v20241215preview:getChannelFullUrl", args ?? new GetChannelFullUrlArgs(), options.WithDefaults());
