...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// Domain Topic.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:DomainTopic")]
    public partial class DomainTopic : global::Pulumi.CustomResource
    {
        ...
        public DomainTopic(string name, DomainTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:DomainTopic", name, args ?? new DomainTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:DomainTopic", name, null, MakeResourceOptions(options, id))
        {
        }
