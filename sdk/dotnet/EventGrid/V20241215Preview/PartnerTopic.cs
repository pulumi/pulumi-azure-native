...
namespace Pulumi.AzureNative.EventGrid.V20241215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20241215preview:PartnerTopic")]
    public partial class PartnerTopic : global::Pulumi.CustomResource
    {
        ...
        public PartnerTopic(string name, PartnerTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:PartnerTopic", name, args ?? new PartnerTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20241215preview:PartnerTopic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerTopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20241215Preview.PartnerTopicActivationState>? ActivationState { get; set; }
