...
namespace Pulumi.AzureNative.EventGrid
{
    ...
    public partial class Client : global::Pulumi.CustomResource
    {
        ...
        public Client(string name, ClientArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid:Client", name, args ?? new ClientArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Client(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid:Client", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20230601preview:eventgrid:Client" },
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20231215preview:eventgrid:Client" },
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20240601preview:eventgrid:Client" },
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20241215preview:eventgrid:Client" },
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20250215:eventgrid:Client" },
                },
            };
    ...
    public sealed class ClientArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.ClientState>? State { get; set; }
