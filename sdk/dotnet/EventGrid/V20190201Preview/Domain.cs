...
namespace Pulumi.AzureNextGen.EventGrid.V20190201Preview
{
    ...
    /// EventGrid Domain
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventgrid/v20190201preview:Domain")]
    public partial class Domain : Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20190201preview:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20190201preview:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
