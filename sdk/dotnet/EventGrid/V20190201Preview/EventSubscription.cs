...
namespace Pulumi.AzureRM.EventGrid.V20190201Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var eventSubscription = new AzureRM.EventGrid.V20190201Preview.EventSubscription("eventSubscription", new AzureRM.EventGrid.V20190201Preview.EventSubscriptionArgs
    ///         {
    ///             Destination = new AzureRM.EventGrid.V20190201Preview.Inputs.EventSubscriptionDestinationArgs
    ///             {
    ...
    ///             Filter = new AzureRM.EventGrid.V20190201Preview.Inputs.EventSubscriptionFilterArgs
    ///             {
    ...
    public partial class EventSubscription : Pulumi.CustomResource
    {
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20190201preview:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20190201preview:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
