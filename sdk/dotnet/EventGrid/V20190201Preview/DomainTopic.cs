...
namespace Pulumi.AzureRM.EventGrid.V20190201Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var domainTopic = new AzureRM.EventGrid.V20190201Preview.DomainTopic("domainTopic", new AzureRM.EventGrid.V20190201Preview.DomainTopicArgs
    ///         {
    ...
    public partial class DomainTopic : Pulumi.CustomResource
    {
        ...
        public DomainTopic(string name, DomainTopicArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20190201preview:DomainTopic", name, args ?? new DomainTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20190201preview:DomainTopic", name, null, MakeResourceOptions(options, id))
        {
        }
