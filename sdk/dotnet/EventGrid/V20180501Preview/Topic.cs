...
namespace Pulumi.AzureRM.EventGrid.V20180501Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var topic = new AzureRM.EventGrid.V20180501Preview.Topic("topic", new AzureRM.EventGrid.V20180501Preview.TopicArgs
    ///         {
    ///             Location = "westus2",
    ...
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20180501preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20180501preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
