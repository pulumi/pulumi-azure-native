...
namespace Pulumi.AzureNative.EventGrid.V20180501Preview
{
    /// <summary>
    /// EventGrid Topic
    /// </summary>
    [Obsolete(@"Version v20180501preview will be removed in the next major version of the provider. Upgrade to version v20200401preview or later.")]
    [AzureNativeResourceType("azure-native:eventgrid/v20180501preview:Topic")]
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20180501preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20180501preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TopicArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20180501Preview.InputSchema>? InputSchema { get; set; }
