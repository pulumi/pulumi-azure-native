...
namespace Pulumi.AzureNextGen.EventGrid
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:eventgrid:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrivateEndpointConnectionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.EventGrid.ResourceProvisioningState>? ProvisioningState { get; set; }
