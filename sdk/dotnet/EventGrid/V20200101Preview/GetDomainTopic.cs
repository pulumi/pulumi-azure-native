...
namespace Pulumi.AzureRM.EventGrid.V20200101Preview
{
    public static class GetDomainTopic
    {
        public static Task<GetDomainTopicResult> InvokeAsync(GetDomainTopicArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDomainTopicResult>("azurerm:eventgrid/v20200101preview:getDomainTopic", args ?? new GetDomainTopicArgs(), options.WithVersion());
    }
