...
namespace Pulumi.AzureRM.EventGrid.V20200101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var eventSubscription = new AzureRM.EventGrid.V20200101Preview.EventSubscription("eventSubscription", new AzureRM.EventGrid.V20200101Preview.EventSubscriptionArgs
    ///         {
    ///             DeadLetterDestination = new AzureRM.EventGrid.V20200101Preview.Inputs.DeadLetterDestinationArgs
    ///             {
    ///                 EndpointType = "StorageBlob",
    ///             },
    ///             Destination = new AzureRM.EventGrid.V20200101Preview.Inputs.EventSubscriptionDestinationArgs
    ///             {
    ...
    ///             Filter = new AzureRM.EventGrid.V20200101Preview.Inputs.EventSubscriptionFilterArgs
    ///             {
    ...
    public partial class EventSubscription : Pulumi.CustomResource
    {
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200101preview:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/v20200101preview:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
