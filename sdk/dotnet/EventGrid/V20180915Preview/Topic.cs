...
namespace Pulumi.AzureNextGen.EventGrid.V20180915Preview
{
    ...
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20180915preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:eventgrid/v20180915preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
