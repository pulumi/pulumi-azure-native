...
{
    [Obsolete(@"Version v20180915preview will be removed in the next major version of the provider. Upgrade to version v20200401preview or later.")]
    public static class GetTopic
    {
        ...
        public static Task<GetTopicResult> InvokeAsync(GetTopicArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTopicResult>("azure-native:eventgrid/v20180915preview:getTopic", args ?? new GetTopicArgs(), options.WithDefaults());

        /// <summary>
        /// EventGrid Topic
        /// </summary>
        public static Output<GetTopicResult> Invoke(GetTopicInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTopicResult>("azure-native:eventgrid/v20180915preview:getTopic", args ?? new GetTopicInvokeArgs(), options.WithDefaults());
    }
