...
{
    [Obsolete(@"Version 2018-09-15-preview will be removed in v2 of the provider.
azure-native:eventgrid/v20180915preview:Topic is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20200401preview:Topic to guarantee forwards compatibility.")]
    public static class GetTopic
    {
        ...
        public static Task<GetTopicResult> InvokeAsync(GetTopicArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTopicResult>("azure-native:eventgrid/v20180915preview:getTopic", args ?? new GetTopicArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of a topic
        /// </summary>
        public static Output<GetTopicResult> Invoke(GetTopicInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTopicResult>("azure-native:eventgrid/v20180915preview:getTopic", args ?? new GetTopicInvokeArgs(), options.WithDefaults());
    }
