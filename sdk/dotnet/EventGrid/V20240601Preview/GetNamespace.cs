...
namespace Pulumi.AzureNative.EventGrid.V20240601Preview
{
    public static class GetNamespace
    {
        ...
        public static Task<GetNamespaceResult> InvokeAsync(GetNamespaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNamespaceResult>("azure-native:eventgrid/v20240601preview:getNamespace", args ?? new GetNamespaceArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of a namespace.
        /// </summary>
        public static Output<GetNamespaceResult> Invoke(GetNamespaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNamespaceResult>("azure-native:eventgrid/v20240601preview:getNamespace", args ?? new GetNamespaceInvokeArgs(), options.WithDefaults());
