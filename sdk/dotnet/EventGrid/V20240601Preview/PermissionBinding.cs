...
namespace Pulumi.AzureNative.EventGrid.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20240601preview:PermissionBinding")]
    public partial class PermissionBinding : global::Pulumi.CustomResource
    {
        ...
        public PermissionBinding(string name, PermissionBindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:PermissionBinding", name, args ?? new PermissionBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PermissionBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:PermissionBinding", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PermissionBindingArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("permission")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20240601Preview.PermissionType>? Permission { get; set; }
