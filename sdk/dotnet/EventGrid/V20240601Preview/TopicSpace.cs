...
namespace Pulumi.AzureNative.EventGrid.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20240601preview:TopicSpace")]
    public partial class TopicSpace : global::Pulumi.CustomResource
    {
        ...
        public TopicSpace(string name, TopicSpaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:TopicSpace", name, args ?? new TopicSpaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicSpace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:TopicSpace", name, null, MakeResourceOptions(options, id))
        {
        }
