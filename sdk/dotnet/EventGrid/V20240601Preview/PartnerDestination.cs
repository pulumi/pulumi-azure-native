...
namespace Pulumi.AzureNative.EventGrid.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20240601preview:PartnerDestination")]
    public partial class PartnerDestination : global::Pulumi.CustomResource
    {
        ...
        public PartnerDestination(string name, PartnerDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:PartnerDestination", name, args ?? new PartnerDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:PartnerDestination", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerDestinationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20240601Preview.PartnerDestinationActivationState>? ActivationState { get; set; }
