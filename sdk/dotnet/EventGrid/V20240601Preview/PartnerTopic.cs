...
namespace Pulumi.AzureNative.EventGrid.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20240601preview:PartnerTopic")]
    public partial class PartnerTopic : global::Pulumi.CustomResource
    {
        ...
        public PartnerTopic(string name, PartnerTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:PartnerTopic", name, args ?? new PartnerTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:PartnerTopic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerTopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20240601Preview.PartnerTopicActivationState>? ActivationState { get; set; }
