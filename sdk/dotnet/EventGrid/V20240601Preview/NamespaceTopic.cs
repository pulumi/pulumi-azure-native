...
namespace Pulumi.AzureNative.EventGrid.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20240601preview:NamespaceTopic")]
    public partial class NamespaceTopic : global::Pulumi.CustomResource
    {
        ...
        public NamespaceTopic(string name, NamespaceTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:NamespaceTopic", name, args ?? new NamespaceTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamespaceTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:NamespaceTopic", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20250215:NamespaceTopic" },
    ...
    public sealed class NamespaceTopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20240601Preview.EventInputSchema>? InputSchema { get; set; }
        ...
        /// </summary>
        [Input("publisherType")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20240601Preview.PublisherType>? PublisherType { get; set; }
