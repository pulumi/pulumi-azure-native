...
namespace Pulumi.AzureNative.EventGrid.V20240601Preview
{
    ...
    /// Namespace resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20240601preview:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20240601preview:Namespace", name, null, MakeResourceOptions(options, id))
        {
        }
