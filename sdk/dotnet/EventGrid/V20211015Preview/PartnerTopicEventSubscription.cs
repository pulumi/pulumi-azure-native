...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    /// Event Subscription
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20211015preview:PartnerTopicEventSubscription")]
    public partial class PartnerTopicEventSubscription : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public PartnerTopicEventSubscription(string name, PartnerTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerTopicEventSubscription", name, args ?? new PartnerTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20200401preview:PartnerTopicEventSubscription" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20230601preview:PartnerTopicEventSubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20231215preview:PartnerTopicEventSubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20240601preview:PartnerTopicEventSubscription" },
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20241215preview:PartnerTopicEventSubscription" },
                },
            };
    ...
    public sealed class PartnerTopicEventSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The dead letter destination of the event subscription. Any event that cannot be delivered to its' destination is sent to the dead letter destination.
        /// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20211015Preview.EventDeliverySchema>? EventDeliverySchema { get; set; }
        ...
        public static new PartnerTopicEventSubscriptionArgs Empty => new PartnerTopicEventSubscriptionArgs();
    }
}
