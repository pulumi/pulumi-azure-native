...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    public partial class PartnerNamespace : Pulumi.CustomResource
    {
        ...
        public PartnerNamespace(string name, PartnerNamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerNamespace", name, args ?? new PartnerNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerNamespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerNamespace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerNamespaceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20211015Preview.PartnerTopicRoutingMode>? PartnerTopicRoutingMode { get; set; }
