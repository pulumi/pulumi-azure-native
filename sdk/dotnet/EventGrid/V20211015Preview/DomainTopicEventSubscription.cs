...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    /// Event Subscription
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20211015preview:DomainTopicEventSubscription")]
    public partial class DomainTopicEventSubscription : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DomainTopicEventSubscription(string name, DomainTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:DomainTopicEventSubscription", name, args ?? new DomainTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:DomainTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:eventgrid:DomainTopicEventSubscription"},
                    new Pulumi.Alias { Type = "azure-native:eventgrid/v20220615:DomainTopicEventSubscription"},
                },
            };
    ...
    public sealed class DomainTopicEventSubscriptionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The dead letter destination of the event subscription. Any event that cannot be delivered to its' destination is sent to the dead letter destination.
        /// Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery / dead-lettering.
