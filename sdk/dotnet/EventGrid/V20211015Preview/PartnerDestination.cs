...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    public partial class PartnerDestination : Pulumi.CustomResource
    {
        ...
        public PartnerDestination(string name, PartnerDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerDestination", name, args ?? new PartnerDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerDestination", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:eventgrid:PartnerDestination"},
                },
            };
    ...
    public sealed class PartnerDestinationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20211015Preview.PartnerDestinationActivationState>? ActivationState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20211015Preview.PartnerDestinationProvisioningState>? ProvisioningState { get; set; }
