...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    /// Event Subscription
    /// </summary>
    [Obsolete(@"azure-native:eventgrid/v20211015preview:TopicEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:TopicEventSubscription to guarantee forwards compatibility.")]
    ...
    public partial class TopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public TopicEventSubscription(string name, TopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:TopicEventSubscription", name, args ?? new TopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:TopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
