...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    /// {
    ///     var eventChannel = new AzureNative.EventGrid.V20211015Preview.EventChannel("eventChannel", new()
    ///     {
    ///         Destination = new AzureNative.EventGrid.V20211015Preview.Inputs.EventChannelDestinationArgs
    ///         {
    ...
    ///         Source = new AzureNative.EventGrid.V20211015Preview.Inputs.EventChannelSourceArgs
    ///         {
    ...
    public partial class EventChannel : global::Pulumi.CustomResource
    {
        ...
        public EventChannel(string name, EventChannelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:EventChannel", name, args ?? new EventChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventChannel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:EventChannel", name, null, MakeResourceOptions(options, id))
        {
        }
