...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    public static class GetPartnerConfiguration
    {
        ...
        public static Task<GetPartnerConfigurationResult> InvokeAsync(GetPartnerConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPartnerConfigurationResult>("azure-native:eventgrid/v20211015preview:getPartnerConfiguration", args ?? new GetPartnerConfigurationArgs(), options.WithDefaults());
        ...
        public static Output<GetPartnerConfigurationResult> Invoke(GetPartnerConfigurationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPartnerConfigurationResult>("azure-native:eventgrid/v20211015preview:getPartnerConfiguration", args ?? new GetPartnerConfigurationInvokeArgs(), options.WithDefaults());
    }
