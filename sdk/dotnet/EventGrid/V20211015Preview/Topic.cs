...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    /// {
    ///     var topic = new AzureNative.EventGrid.V20211015Preview.Topic("topic", new()
    ///     {
    ///         InboundIpRules = new[]
    ///         {
    ...
    ///     var topic = new AzureNative.EventGrid.V20211015Preview.Topic("topic", new()
    ///     {
    ///         ExtendedLocation = new AzureNative.EventGrid.V20211015Preview.Inputs.ExtendedLocationArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20211015preview:Topic")]
    public partial class Topic : global::Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20211015Preview.ResourceKind>? Kind { get; set; }
