...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:eventgrid/v20211015preview:PartnerTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerTopic to guarantee forwards compatibility.")]
    ...
    public partial class PartnerTopic : global::Pulumi.CustomResource
    {
        ...
        public PartnerTopic(string name, PartnerTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerTopic", name, args ?? new PartnerTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerTopic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerTopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20211015Preview.PartnerTopicActivationState>? ActivationState { get; set; }
