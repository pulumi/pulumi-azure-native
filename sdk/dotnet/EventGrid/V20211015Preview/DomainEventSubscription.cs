...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    /// Event Subscription
    /// </summary>
    [Obsolete(@"azure-native:eventgrid/v20211015preview:DomainEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainEventSubscription to guarantee forwards compatibility.")]
    ...
    public partial class DomainEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public DomainEventSubscription(string name, DomainEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:DomainEventSubscription", name, args ?? new DomainEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:DomainEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
