...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    /// {
    ///     var partnerRegistration = new AzureNative.EventGrid.V20211015Preview.PartnerRegistration("partnerRegistration", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20211015preview:PartnerRegistration")]
    public partial class PartnerRegistration : global::Pulumi.CustomResource
    {
        ...
        public PartnerRegistration(string name, PartnerRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerRegistration", name, args ?? new PartnerRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:PartnerRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerRegistrationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20211015Preview.PartnerRegistrationVisibilityState>? VisibilityState { get; set; }
