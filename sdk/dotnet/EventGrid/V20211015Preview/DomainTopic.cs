...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    ...
    /// Domain Topic.
    /// </summary>
    [Obsolete(@"azure-native:eventgrid/v20211015preview:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:eventgrid/v20211015preview:DomainTopic")]
    public partial class DomainTopic : global::Pulumi.CustomResource
    {
        ...
        public DomainTopic(string name, DomainTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:DomainTopic", name, args ?? new DomainTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20211015preview:DomainTopic", name, null, MakeResourceOptions(options, id))
        {
        }
