...
namespace Pulumi.AzureNative.EventGrid.V20211015Preview
{
    public static class GetEventChannel
    {
        ...
        public static Task<GetEventChannelResult> InvokeAsync(GetEventChannelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEventChannelResult>("azure-native:eventgrid/v20211015preview:getEventChannel", args ?? new GetEventChannelArgs(), options.WithDefaults());
