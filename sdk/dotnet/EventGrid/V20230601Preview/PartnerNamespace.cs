...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20230601preview:PartnerNamespace")]
    public partial class PartnerNamespace : global::Pulumi.CustomResource
    {
        ...
        public PartnerNamespace(string name, PartnerNamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:PartnerNamespace", name, args ?? new PartnerNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerNamespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:PartnerNamespace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerNamespaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20230601Preview.PartnerTopicRoutingMode>? PartnerTopicRoutingMode { get; set; }
