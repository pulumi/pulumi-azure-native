...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    public static class GetCaCertificate
    {
        ...
        public static Task<GetCaCertificateResult> InvokeAsync(GetCaCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCaCertificateResult>("azure-native:eventgrid/v20230601preview:getCaCertificate", args ?? new GetCaCertificateArgs(), options.WithDefaults());
