...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20230601preview:TopicEventSubscription")]
    public partial class TopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public TopicEventSubscription(string name, TopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:TopicEventSubscription", name, args ?? new TopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:TopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
