...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    ...
    /// The Client resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20230601preview:Client")]
    public partial class Client : global::Pulumi.CustomResource
    {
        ...
        public Client(string name, ClientArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:Client", name, args ?? new ClientArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Client(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:Client", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClientArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20230601Preview.ClientState>? State { get; set; }
