...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    ...
    /// Event Subscription.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20230601preview:SystemTopicEventSubscription")]
    public partial class SystemTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public SystemTopicEventSubscription(string name, SystemTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:SystemTopicEventSubscription", name, args ?? new SystemTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:SystemTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
