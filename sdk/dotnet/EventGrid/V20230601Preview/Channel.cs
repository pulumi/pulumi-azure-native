...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    ...
    /// Channel info.
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20230601preview:Channel")]
    public partial class Channel : global::Pulumi.CustomResource
    {
        ...
        public Channel(string name, ChannelArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:Channel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ChannelArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("channelType")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20230601Preview.ChannelType>? ChannelType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20230601Preview.ChannelProvisioningState>? ProvisioningState { get; set; }

        /// <summary>
        /// The readiness state of the corresponding partner topic.
        /// </summary>
        [Input("readinessState")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20230601Preview.ReadinessState>? ReadinessState { get; set; }
