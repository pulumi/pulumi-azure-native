...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    public static class GetClient
    {
        ...
        public static Task<GetClientResult> InvokeAsync(GetClientArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClientResult>("azure-native:eventgrid/v20230601preview:getClient", args ?? new GetClientArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of a client.
        /// </summary>
        public static Output<GetClientResult> Invoke(GetClientInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClientResult>("azure-native:eventgrid/v20230601preview:getClient", args ?? new GetClientInvokeArgs(), options.WithDefaults());
