...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20230601preview:CaCertificate")]
    public partial class CaCertificate : global::Pulumi.CustomResource
    {
        ...
        public CaCertificate(string name, CaCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:CaCertificate", name, args ?? new CaCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CaCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:CaCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
