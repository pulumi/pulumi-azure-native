...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20230601preview:SystemTopic")]
    public partial class SystemTopic : global::Pulumi.CustomResource
    {
        ...
        public SystemTopic(string name, SystemTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:SystemTopic", name, args ?? new SystemTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:SystemTopic", name, null, MakeResourceOptions(options, id))
        {
        }
