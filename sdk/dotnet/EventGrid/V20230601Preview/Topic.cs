...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    ...
    /// EventGrid Topic
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20230601preview:Topic")]
    public partial class Topic : global::Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20230601preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20230601Preview.DataResidencyBoundary>? DataResidencyBoundary { get; set; }
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20230601Preview.InputSchema>? InputSchema { get; set; }
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20230601Preview.ResourceKind>? Kind { get; set; }
