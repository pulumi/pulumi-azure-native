...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    public static class GetPermissionBinding
    {
        ...
        public static Task<GetPermissionBindingResult> InvokeAsync(GetPermissionBindingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPermissionBindingResult>("azure-native:eventgrid/v20230601preview:getPermissionBinding", args ?? new GetPermissionBindingArgs(), options.WithDefaults());
