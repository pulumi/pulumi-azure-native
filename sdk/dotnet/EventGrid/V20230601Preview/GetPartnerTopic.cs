...
namespace Pulumi.AzureNative.EventGrid.V20230601Preview
{
    public static class GetPartnerTopic
    {
        ...
        public static Task<GetPartnerTopicResult> InvokeAsync(GetPartnerTopicArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPartnerTopicResult>("azure-native:eventgrid/v20230601preview:getPartnerTopic", args ?? new GetPartnerTopicArgs(), options.WithDefaults());

        /// <summary>
        /// Get properties of a partner topic.
        /// </summary>
        public static Output<GetPartnerTopicResult> Invoke(GetPartnerTopicInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPartnerTopicResult>("azure-native:eventgrid/v20230601preview:getPartnerTopic", args ?? new GetPartnerTopicInvokeArgs(), options.WithDefaults());
