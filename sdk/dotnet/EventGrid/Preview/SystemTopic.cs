...
namespace Pulumi.AzureRM.EventGrid.Preview
{
    ...
    public partial class SystemTopic : Pulumi.CustomResource
    {
        ...
        public SystemTopic(string name, SystemTopicArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/preview:SystemTopic", name, args ?? new SystemTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/preview:SystemTopic", name, null, MakeResourceOptions(options, id))
        {
        }
