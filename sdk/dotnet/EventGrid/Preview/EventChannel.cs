...
namespace Pulumi.AzureRM.EventGrid.Preview
{
    ...
    public partial class EventChannel : Pulumi.CustomResource
    {
        ...
        public EventChannel(string name, EventChannelArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/preview:EventChannel", name, args ?? new EventChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventChannel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/preview:EventChannel", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:eventgrid/v20200401preview:EventChannel"},
                },
            };
