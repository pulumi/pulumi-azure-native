...
namespace Pulumi.AzureRM.EventGrid.Preview
{
    ...
    public partial class DomainTopic : Pulumi.CustomResource
    {
        ...
        public DomainTopic(string name, DomainTopicArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/preview:DomainTopic", name, args ?? new DomainTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/preview:DomainTopic", name, null, MakeResourceOptions(options, id))
        {
        }
