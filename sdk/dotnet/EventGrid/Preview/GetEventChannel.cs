...
namespace Pulumi.AzureRM.EventGrid.Preview
{
    public static class GetEventChannel
    {
        public static Task<GetEventChannelResult> InvokeAsync(GetEventChannelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEventChannelResult>("azurerm:eventgrid/preview:getEventChannel", args ?? new GetEventChannelArgs(), options.WithVersion());
    }
