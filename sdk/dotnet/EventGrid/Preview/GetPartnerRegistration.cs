...
namespace Pulumi.AzureRM.EventGrid.Preview
{
    public static class GetPartnerRegistration
    {
        public static Task<GetPartnerRegistrationResult> InvokeAsync(GetPartnerRegistrationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPartnerRegistrationResult>("azurerm:eventgrid/preview:getPartnerRegistration", args ?? new GetPartnerRegistrationArgs(), options.WithVersion());
    }
