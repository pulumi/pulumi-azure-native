...
namespace Pulumi.AzureNative.EventGrid
{
    ...
    public partial class PermissionBinding : global::Pulumi.CustomResource
    {
        ...
        public PermissionBinding(string name, PermissionBindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid:PermissionBinding", name, args ?? new PermissionBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PermissionBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid:PermissionBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:eventgrid/v20241215preview:PermissionBinding" },
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20230601preview:eventgrid:PermissionBinding" },
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20231215preview:eventgrid:PermissionBinding" },
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20240601preview:eventgrid:PermissionBinding" },
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20241215preview:eventgrid:PermissionBinding" },
                    new global::Pulumi.Alias { Type = "azure-native_eventgrid_v20250215:eventgrid:PermissionBinding" },
                },
            };
    ...
    public sealed class PermissionBindingArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("permission")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.PermissionType>? Permission { get; set; }
