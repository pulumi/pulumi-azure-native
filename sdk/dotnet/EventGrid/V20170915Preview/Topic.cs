...
namespace Pulumi.AzureNative.EventGrid.V20170915Preview
{
    ...
    [AzureNativeResourceType("azure-native:eventgrid/v20170915preview:Topic")]
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20170915preview:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20170915preview:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
