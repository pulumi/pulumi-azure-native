...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    ...
    /// {
    ///     var domainTopicEventSubscription = new AzureNative.EventGrid.V20220615.DomainTopicEventSubscription("domainTopicEventSubscription", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20220615:DomainTopicEventSubscription")]
    public partial class DomainTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public DomainTopicEventSubscription(string name, DomainTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:DomainTopicEventSubscription", name, args ?? new DomainTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:DomainTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
