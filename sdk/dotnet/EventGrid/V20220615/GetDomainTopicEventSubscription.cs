...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    public static class GetDomainTopicEventSubscription
    {
        ...
        public static Task<GetDomainTopicEventSubscriptionResult> InvokeAsync(GetDomainTopicEventSubscriptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDomainTopicEventSubscriptionResult>("azure-native:eventgrid/v20220615:getDomainTopicEventSubscription", args ?? new GetDomainTopicEventSubscriptionArgs(), options.WithDefaults());
        ...
        public static Output<GetDomainTopicEventSubscriptionResult> Invoke(GetDomainTopicEventSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDomainTopicEventSubscriptionResult>("azure-native:eventgrid/v20220615:getDomainTopicEventSubscription", args ?? new GetDomainTopicEventSubscriptionInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetDomainTopicEventSubscriptionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class GetDomainTopicEventSubscriptionInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// Name of the top level domain.
        /// </summary>
