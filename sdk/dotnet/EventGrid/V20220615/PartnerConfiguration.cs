...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    ...
    /// {
    ///     var partnerConfiguration = new AzureNative.EventGrid.V20220615.PartnerConfiguration("partnerConfiguration", new()
    ///     {
    ///         PartnerAuthorization = new AzureNative.EventGrid.V20220615.Inputs.PartnerAuthorizationArgs
    ///         {
    ///             AuthorizedPartnersList = new[]
    ///             {
    ///                 new AzureNative.EventGrid.V20220615.Inputs.PartnerArgs
    ///                 {
    ...
    public partial class PartnerConfiguration : global::Pulumi.CustomResource
    {
        ...
        public PartnerConfiguration(string name, PartnerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:PartnerConfiguration", name, args ?? new PartnerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:PartnerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20220615.PartnerConfigurationProvisioningState>? ProvisioningState { get; set; }
