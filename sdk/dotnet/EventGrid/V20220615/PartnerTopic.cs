...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:eventgrid/v20220615:PartnerTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerTopic to guarantee forwards compatibility.")]
    ...
    public partial class PartnerTopic : global::Pulumi.CustomResource
    {
        ...
        public PartnerTopic(string name, PartnerTopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:PartnerTopic", name, args ?? new PartnerTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:PartnerTopic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerTopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20220615.PartnerTopicActivationState>? ActivationState { get; set; }
