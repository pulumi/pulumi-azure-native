...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    public static class GetSystemTopic
    {
        ...
        public static Task<GetSystemTopicResult> InvokeAsync(GetSystemTopicArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSystemTopicResult>("azure-native:eventgrid/v20220615:getSystemTopic", args ?? new GetSystemTopicArgs(), options.WithDefaults());

        /// <summary>
        /// EventGrid System Topic.
        /// </summary>
        public static Output<GetSystemTopicResult> Invoke(GetSystemTopicInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSystemTopicResult>("azure-native:eventgrid/v20220615:getSystemTopic", args ?? new GetSystemTopicInvokeArgs(), options.WithDefaults());
    }
