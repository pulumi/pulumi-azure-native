...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    ...
    /// {
    ///     var domainEventSubscription = new AzureNative.EventGrid.V20220615.DomainEventSubscription("domainEventSubscription", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:eventgrid/v20220615:DomainEventSubscription exampleEventSubscriptionName1 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/resourceGroups/examplerg/providers/Microsoft.EventGrid/domains/exampleDomain1/eventSubscriptions/exampleEventSubscriptionName1 
    /// ```
    /// </summary>
    ...
    public partial class DomainEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public DomainEventSubscription(string name, DomainEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:DomainEventSubscription", name, args ?? new DomainEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:DomainEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
