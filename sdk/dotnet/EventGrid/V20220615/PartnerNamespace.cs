...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    ...
    public partial class PartnerNamespace : global::Pulumi.CustomResource
    {
        ...
        public PartnerNamespace(string name, PartnerNamespaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:PartnerNamespace", name, args ?? new PartnerNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerNamespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:PartnerNamespace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartnerNamespaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20220615.PartnerTopicRoutingMode>? PartnerTopicRoutingMode { get; set; }
