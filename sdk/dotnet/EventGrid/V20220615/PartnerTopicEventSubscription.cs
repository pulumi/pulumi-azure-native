...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    ...
    /// {
    ///     var partnerTopicEventSubscription = new AzureNative.EventGrid.V20220615.PartnerTopicEventSubscription("partnerTopicEventSubscription", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:eventgrid/v20220615:PartnerTopicEventSubscription exampleEventSubscriptionName1 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/resourceGroups/examplerg/providers/Microsoft.EventGrid/partnerTopics/examplePartnerTopic1/eventSubscriptions/exampleEventSubscriptionName1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:eventgrid/v20220615:PartnerTopicEventSubscription")]
    public partial class PartnerTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public PartnerTopicEventSubscription(string name, PartnerTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:PartnerTopicEventSubscription", name, args ?? new PartnerTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:PartnerTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
