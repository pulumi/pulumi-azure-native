...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    ...
    /// {
    ///     var systemTopicEventSubscription = new AzureNative.EventGrid.V20220615.SystemTopicEventSubscription("systemTopicEventSubscription", new()
    ///     {
    ...
    public partial class SystemTopicEventSubscription : global::Pulumi.CustomResource
    {
        ...
        public SystemTopicEventSubscription(string name, SystemTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:SystemTopicEventSubscription", name, args ?? new SystemTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:SystemTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
