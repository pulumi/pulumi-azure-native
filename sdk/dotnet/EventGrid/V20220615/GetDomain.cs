...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    public static class GetDomain
    {
        ...
        public static Task<GetDomainResult> InvokeAsync(GetDomainArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDomainResult>("azure-native:eventgrid/v20220615:getDomain", args ?? new GetDomainArgs(), options.WithDefaults());

        /// <summary>
        /// EventGrid Domain.
        /// </summary>
        public static Output<GetDomainResult> Invoke(GetDomainInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDomainResult>("azure-native:eventgrid/v20220615:getDomain", args ?? new GetDomainInvokeArgs(), options.WithDefaults());
    }
