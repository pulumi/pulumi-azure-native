...
namespace Pulumi.AzureNative.EventGrid.V20220615
{
    ...
    public partial class Topic : global::Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:eventgrid/v20220615:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TopicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20220615.DataResidencyBoundary>? DataResidencyBoundary { get; set; }
        ...
        /// </summary>
        [Input("inputSchema")]
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20220615.InputSchema>? InputSchema { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.EventGrid.V20220615.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
