...
namespace Pulumi.AzureRM.EventGrid.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var partnerTopicEventSubscription = new AzureRM.EventGrid.Latest.PartnerTopicEventSubscription("partnerTopicEventSubscription", new AzureRM.EventGrid.Latest.PartnerTopicEventSubscriptionArgs
    ///         {
    ///             Destination = 
    ///             {
    ...
    public partial class PartnerTopicEventSubscription : Pulumi.CustomResource
    {
        ...
        public PartnerTopicEventSubscription(string name, PartnerTopicEventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:PartnerTopicEventSubscription", name, args ?? new PartnerTopicEventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerTopicEventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:PartnerTopicEventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:eventgrid/v20200401preview:PartnerTopicEventSubscription"},
                },
            };
