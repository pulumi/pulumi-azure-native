...
namespace Pulumi.AzureRM.EventGrid.Latest
{
    public static class GetEventChannel
    {
        public static Task<GetEventChannelResult> InvokeAsync(GetEventChannelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEventChannelResult>("azurerm:eventgrid/latest:getEventChannel", args ?? new GetEventChannelArgs(), options.WithVersion());
    }
