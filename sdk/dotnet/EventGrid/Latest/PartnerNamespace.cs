...
namespace Pulumi.AzureRM.EventGrid.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var partnerNamespace = new AzureRM.EventGrid.Latest.PartnerNamespace("partnerNamespace", new AzureRM.EventGrid.Latest.PartnerNamespaceArgs
    ///         {
    ///             Location = "westus",
    ...
    public partial class PartnerNamespace : Pulumi.CustomResource
    {
        ...
        public PartnerNamespace(string name, PartnerNamespaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:PartnerNamespace", name, args ?? new PartnerNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerNamespace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:PartnerNamespace", name, null, MakeResourceOptions(options, id))
        {
        }
