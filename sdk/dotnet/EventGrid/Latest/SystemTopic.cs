...
namespace Pulumi.AzureRM.EventGrid.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var systemTopic = new AzureRM.EventGrid.Latest.SystemTopic("systemTopic", new AzureRM.EventGrid.Latest.SystemTopicArgs
    ///         {
    ///             Location = "westus2",
    ...
    public partial class SystemTopic : Pulumi.CustomResource
    {
        ...
        public SystemTopic(string name, SystemTopicArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:SystemTopic", name, args ?? new SystemTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemTopic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:SystemTopic", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:eventgrid/v20200401preview:SystemTopic"},
                },
            };
