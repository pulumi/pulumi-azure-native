...
namespace Pulumi.AzureRM.EventGrid.Latest
{
    public static class GetPartnerRegistration
    {
        public static Task<GetPartnerRegistrationResult> InvokeAsync(GetPartnerRegistrationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPartnerRegistrationResult>("azurerm:eventgrid/latest:getPartnerRegistration", args ?? new GetPartnerRegistrationArgs(), options.WithVersion());
    }
