...
namespace Pulumi.AzureRM.EventGrid.Latest
{
    ...
    ///         {
    ///             DeadLetterDestination = new AzureRM.EventGrid.Latest.Inputs.DeadLetterDestinationArgs
    ///             {
    ///                 EndpointType = "StorageBlob",
    ///             },
    ///             Destination = new AzureRM.EventGrid.Latest.Inputs.EventSubscriptionDestinationArgs
    ///             {
    ...
    public partial class EventSubscription : Pulumi.CustomResource
    {
        ...
        public EventSubscription(string name, EventSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:EventSubscription", name, args ?? new EventSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:EventSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
