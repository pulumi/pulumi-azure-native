...
namespace Pulumi.AzureRM.EventGrid.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var eventChannel = new AzureRM.EventGrid.Latest.EventChannel("eventChannel", new AzureRM.EventGrid.Latest.EventChannelArgs
    ///         {
    ///             Destination = new AzureRM.EventGrid.Latest.Inputs.EventChannelDestinationArgs
    ///             {
    ...
    ///             Source = new AzureRM.EventGrid.Latest.Inputs.EventChannelSourceArgs
    ///             {
    ...
    public partial class EventChannel : Pulumi.CustomResource
    {
        ...
        public EventChannel(string name, EventChannelArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:EventChannel", name, args ?? new EventChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventChannel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:EventChannel", name, null, MakeResourceOptions(options, id))
        {
        }
