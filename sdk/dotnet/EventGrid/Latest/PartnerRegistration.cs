...
namespace Pulumi.AzureRM.EventGrid.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var partnerRegistration = new AzureRM.EventGrid.Latest.PartnerRegistration("partnerRegistration", new AzureRM.EventGrid.Latest.PartnerRegistrationArgs
    ///         {
    ...
    public partial class PartnerRegistration : Pulumi.CustomResource
    {
        ...
        public PartnerRegistration(string name, PartnerRegistrationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:PartnerRegistration", name, args ?? new PartnerRegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PartnerRegistration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:eventgrid/latest:PartnerRegistration", name, null, MakeResourceOptions(options, id))
        {
        }
