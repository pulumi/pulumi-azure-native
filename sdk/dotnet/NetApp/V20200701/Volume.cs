...
namespace Pulumi.AzureNextGen.NetApp.V20200701
{
    ...
    /// Volume resource
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp/v20200701:Volume")]
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200701:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200701:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VolumeArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("securityStyle")]
        public InputUnion<string, Pulumi.AzureNextGen.NetApp.V20200701.SecurityStyle>? SecurityStyle { get; set; }

        /// <summary>
        /// The service level of the file system
        /// </summary>
        [Input("serviceLevel")]
        public InputUnion<string, Pulumi.AzureNextGen.NetApp.V20200701.ServiceLevel>? ServiceLevel { get; set; }
