...
namespace Pulumi.AzureNextGen.NetApp.V20200701.Inputs
{
    ...
    public sealed class ReplicationObjectArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("endpointType")]
        public InputUnion<string, Pulumi.AzureNextGen.NetApp.V20200701.EndpointType>? EndpointType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.NetApp.V20200701.ReplicationSchedule> ReplicationSchedule { get; set; } = null!;
