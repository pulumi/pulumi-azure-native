...
namespace Pulumi.AzureNextGen.NetApp.V20200701
{
    public static class GetSnapshotPolicy
    {
        public static Task<GetSnapshotPolicyResult> InvokeAsync(GetSnapshotPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotPolicyResult>("azure-nextgen:netapp/v20200701:getSnapshotPolicy", args ?? new GetSnapshotPolicyArgs(), options.WithVersion());
    }
