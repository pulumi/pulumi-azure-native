...
namespace Pulumi.AzureNative.NetApp.V20200701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20200701:BackupPolicy")]
    public partial class BackupPolicy : Pulumi.CustomResource
    {
        ...
        public BackupPolicy(string name, BackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200701:BackupPolicy", name, args ?? new BackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200701:BackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
