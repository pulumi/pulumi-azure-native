...
namespace Pulumi.AzureNative.NetApp.V20200701
{
    ...
    public static class GetPool
    {
        ...
        public static Task<GetPoolResult> InvokeAsync(GetPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPoolResult>("azure-native:netapp/v20200701:getPool", args ?? new GetPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Capacity pool resource
        /// </summary>
        public static Output<GetPoolResult> Invoke(GetPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPoolResult>("azure-native:netapp/v20200701:getPool", args ?? new GetPoolInvokeArgs(), options.WithDefaults());
    }
