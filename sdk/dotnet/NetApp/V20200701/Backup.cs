...
namespace Pulumi.AzureNextGen.NetApp.V20200701
{
    ...
    /// Backup of a Volume
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp/v20200701:Backup")]
    public partial class Backup : Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200701:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200701:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
