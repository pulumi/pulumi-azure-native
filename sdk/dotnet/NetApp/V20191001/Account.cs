...
namespace Pulumi.AzureNative.NetApp.V20191001
{
    ...
    [AzureNativeResourceType("azure-native:netapp/v20191001:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20191001:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20191001:Account", name, null, MakeResourceOptions(options, id))
        {
        }
