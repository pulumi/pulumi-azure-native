...
namespace Pulumi.AzureRM.NetApp.V20191001
{
    ...
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20191001:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20191001:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:netapp/v20190501:Volume"},
                    new Alias { Type = "azurerm:netapp/v20190601:Volume"},
                    new Alias { Type = "azurerm:netapp/v20190701:Volume"},
                    ...
                    new Alias { Type = "azurerm:netapp/v20200601:Volume"},
                },
            };
