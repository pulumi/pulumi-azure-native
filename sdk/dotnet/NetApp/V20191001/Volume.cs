...
namespace Pulumi.AzureNative.NetApp.V20191001
{
    /// <summary>
    /// Volume resource
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20191001:Volume")]
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20191001:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20191001:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
