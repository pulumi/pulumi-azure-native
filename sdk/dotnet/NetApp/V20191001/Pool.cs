...
namespace Pulumi.AzureRM.NetApp.V20191001
{
    ...
    public partial class Pool : Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20191001:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20191001:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:netapp/v20190501:Pool"},
                    new Alias { Type = "azurerm:netapp/v20190601:Pool"},
                    new Alias { Type = "azurerm:netapp/v20190701:Pool"},
                    new Alias { Type = "azurerm:netapp/v20190801:Pool"},
                    new Alias { Type = "azurerm:netapp/v20191101:Pool"},
