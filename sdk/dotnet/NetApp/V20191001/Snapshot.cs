...
namespace Pulumi.AzureNative.NetApp.V20191001
{
    ...
    /// {
    ///     var snapshot = new AzureNative.NetApp.V20191001.Snapshot("snapshot", new()
    ///     {
    ...
    [AzureNativeResourceType("azure-native:netapp/v20191001:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20191001:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20191001:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
