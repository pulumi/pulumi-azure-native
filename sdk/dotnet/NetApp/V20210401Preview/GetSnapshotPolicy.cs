...
namespace Pulumi.AzureNative.NetApp.V20210401Preview
{
    public static class GetSnapshotPolicy
    {
        ...
        public static Task<GetSnapshotPolicyResult> InvokeAsync(GetSnapshotPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotPolicyResult>("azure-native:netapp/v20210401preview:getSnapshotPolicy", args ?? new GetSnapshotPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Snapshot policy information
        /// </summary>
        public static Output<GetSnapshotPolicyResult> Invoke(GetSnapshotPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSnapshotPolicyResult>("azure-native:netapp/v20210401preview:getSnapshotPolicy", args ?? new GetSnapshotPolicyInvokeArgs(), options.WithVersion());
    }
