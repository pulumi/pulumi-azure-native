...
namespace Pulumi.AzureNative.NetApp.V20210401Preview
{
    ...
    /// {
    ///     var backupPolicy = new AzureNative.NetApp.V20210401Preview.BackupPolicy("backupPolicy", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20210401preview:BackupPolicy")]
    public partial class BackupPolicy : global::Pulumi.CustomResource
    {
        ...
        public BackupPolicy(string name, BackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401preview:BackupPolicy", name, args ?? new BackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401preview:BackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
