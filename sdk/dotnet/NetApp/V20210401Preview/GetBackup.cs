...
namespace Pulumi.AzureNative.NetApp.V20210401Preview
{
    public static class GetBackup
    {
        ...
        public static Task<GetBackupResult> InvokeAsync(GetBackupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupResult>("azure-native:netapp/v20210401preview:getBackup", args ?? new GetBackupArgs(), options.WithVersion());

        /// <summary>
        /// Backup of a Volume
        /// </summary>
        public static Output<GetBackupResult> Invoke(GetBackupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackupResult>("azure-native:netapp/v20210401preview:getBackup", args ?? new GetBackupInvokeArgs(), options.WithVersion());
    }
