...
namespace Pulumi.AzureNative.NetApp.V20210401Preview
{
    ...
    public partial class SnapshotPolicy : Pulumi.CustomResource
    {
        ...
        public SnapshotPolicy(string name, SnapshotPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401preview:SnapshotPolicy", name, args ?? new SnapshotPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401preview:SnapshotPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210401preview:SnapshotPolicy"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210201:SnapshotPolicy"},
                    new Pulumi.Alias { Type = "azure-native:netapp/v20210401:SnapshotPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210401:SnapshotPolicy"},
                    new Pulumi.Alias { Type = "azure-native:netapp/v20210601:SnapshotPolicy"},
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210601:SnapshotPolicy"},
                },
            };
