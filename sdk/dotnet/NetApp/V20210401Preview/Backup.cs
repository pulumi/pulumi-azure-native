...
namespace Pulumi.AzureNative.NetApp.V20210401Preview
{
    ...
    /// Backup of a Volume
    /// </summary>
    [Obsolete(@"azure-native:netapp/v20210401preview:Backup is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Backup to guarantee forwards compatibility.")]
    ...
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401preview:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401preview:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
