...
namespace Pulumi.AzureNative.NetApp.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240701preview:VolumeQuotaRule")]
    public partial class VolumeQuotaRule : global::Pulumi.CustomResource
    {
        ...
        public VolumeQuotaRule(string name, VolumeQuotaRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:VolumeQuotaRule", name, args ?? new VolumeQuotaRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeQuotaRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:VolumeQuotaRule", name, null, MakeResourceOptions(options, id))
        {
        }
