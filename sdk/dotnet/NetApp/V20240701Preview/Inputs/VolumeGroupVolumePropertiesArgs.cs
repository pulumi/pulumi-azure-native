...
namespace Pulumi.AzureNative.NetApp.V20240701Preview.Inputs
{
    ...
    public sealed class VolumeGroupVolumePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.AcceptGrowCapacityPoolForShortTermCloneSplit>? AcceptGrowCapacityPoolForShortTermCloneSplit { get; set; }

        /// <summary>
        /// Specifies whether the volume is enabled for Azure VMware Solution (AVS) datastore purpose
        /// </summary>
        [Input("avsDataStore")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.AvsDataStore>? AvsDataStore { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.CoolAccessRetrievalPolicy>? CoolAccessRetrievalPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.EnableSubvolumes>? EnableSubvolumes { get; set; }

        /// <summary>
        /// Source of key used to encrypt data in volume. Applicable if NetApp account has encryption.keySource = 'Microsoft.KeyVault'. Possible values (case-insensitive) are: 'Microsoft.NetApp, Microsoft.KeyVault'
        /// </summary>
        [Input("encryptionKeySource")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.EncryptionKeySource>? EncryptionKeySource { get; set; }
        ...
        /// </summary>
        [Input("language")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.VolumeLanguage>? Language { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.NetworkFeatures>? NetworkFeatures { get; set; }
        ...
        /// </summary>
        [Input("securityStyle")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.SecurityStyle>? SecurityStyle { get; set; }

        /// <summary>
        /// The service level of the file system
        /// </summary>
        [Input("serviceLevel")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.ServiceLevel>? ServiceLevel { get; set; }

        /// <summary>
        /// Enables access-based enumeration share property for SMB Shares. Only applicable for SMB/DualProtocol volume
        /// </summary>
        [Input("smbAccessBasedEnumeration")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.SmbAccessBasedEnumeration>? SmbAccessBasedEnumeration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.SmbNonBrowsable>? SmbNonBrowsable { get; set; }
