...
namespace Pulumi.AzureNative.NetApp.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240701preview:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:Account", name, null, MakeResourceOptions(options, id))
        {
        }
