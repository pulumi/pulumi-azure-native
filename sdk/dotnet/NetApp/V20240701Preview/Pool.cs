...
namespace Pulumi.AzureNative.NetApp.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240701preview:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
