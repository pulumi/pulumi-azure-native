...
namespace Pulumi.AzureNative.NetApp.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240701preview:CapacityPoolPool")]
    public partial class CapacityPoolPool : global::Pulumi.CustomResource
    {
        ...
        public Output<double?> CustomThroughputMibps { get; private set; } = null!;
        ...
        public CapacityPoolPool(string name, CapacityPoolPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:CapacityPoolPool", name, args ?? new CapacityPoolPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:CapacityPoolPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CapacityPoolPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<double>? CustomThroughputMibps { get; set; }

        /// <summary>
        /// Encryption type of the capacity pool, set encryption type for data at rest for this pool and all volumes in it. This value can only be set when creating new pool.
        /// </summary>
        [Input("encryptionType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.EncryptionType>? EncryptionType { get; set; }
        ...
        /// </summary>
        [Input("qosType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.QosType>? QosType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240701Preview.ServiceLevel> ServiceLevel { get; set; } = null!;
