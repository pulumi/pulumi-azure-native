...
namespace Pulumi.AzureNative.NetApp.V20240701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240701preview:Subvolume")]
    public partial class Subvolume : global::Pulumi.CustomResource
    {
        ...
        public Subvolume(string name, SubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:Subvolume", name, args ?? new SubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701preview:Subvolume", name, null, MakeResourceOptions(options, id))
        {
        }
