...
namespace Pulumi.AzureRM.NetApp.V20191101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var account = new AzureRM.NetApp.V20191101.Account("account", new AzureRM.NetApp.V20191101.AccountArgs
    ///         {
    ...
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20191101:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20191101:Account", name, null, MakeResourceOptions(options, id))
        {
        }
