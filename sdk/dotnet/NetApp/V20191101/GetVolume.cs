...
namespace Pulumi.AzureNative.NetApp.V20191101
{
    ...
    public static class GetVolume
    {
        ...
        public static Task<GetVolumeResult> InvokeAsync(GetVolumeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVolumeResult>("azure-native:netapp/v20191101:getVolume", args ?? new GetVolumeArgs(), options.WithDefaults());

        /// <summary>
        /// Volume resource
        /// </summary>
        public static Output<GetVolumeResult> Invoke(GetVolumeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVolumeResult>("azure-native:netapp/v20191101:getVolume", args ?? new GetVolumeInvokeArgs(), options.WithDefaults());
    }
