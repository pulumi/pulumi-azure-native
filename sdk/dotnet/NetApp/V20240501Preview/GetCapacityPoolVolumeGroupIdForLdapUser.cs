...
namespace Pulumi.AzureNative.NetApp.V20240501Preview
{
    public static class GetCapacityPoolVolumeGroupIdForLdapUser
    {
        ...
        public static Task<GetCapacityPoolVolumeGroupIdForLdapUserResult> InvokeAsync(GetCapacityPoolVolumeGroupIdForLdapUserArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCapacityPoolVolumeGroupIdForLdapUserResult>("azure-native:netapp/v20240501preview:getCapacityPoolVolumeGroupIdForLdapUser", args ?? new GetCapacityPoolVolumeGroupIdForLdapUserArgs(), options.WithDefaults());
        ...
        public static Output<GetCapacityPoolVolumeGroupIdForLdapUserResult> Invoke(GetCapacityPoolVolumeGroupIdForLdapUserInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCapacityPoolVolumeGroupIdForLdapUserResult>("azure-native:netapp/v20240501preview:getCapacityPoolVolumeGroupIdForLdapUser", args ?? new GetCapacityPoolVolumeGroupIdForLdapUserInvokeArgs(), options.WithDefaults());
