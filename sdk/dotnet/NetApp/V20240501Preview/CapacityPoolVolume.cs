...
namespace Pulumi.AzureNative.NetApp.V20240501Preview
{
    ...
    /// Volume resource
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240501preview:CapacityPoolVolume")]
    public partial class CapacityPoolVolume : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolVolume(string name, CapacityPoolVolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240501preview:CapacityPoolVolume", name, args ?? new CapacityPoolVolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolVolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240501preview:CapacityPoolVolume", name, null, MakeResourceOptions(options, id))
        {
        }
