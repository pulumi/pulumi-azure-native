...
namespace Pulumi.AzureNative.NetApp.V20240501Preview
{
    public static class ListVolumeQuotaReport
    {
        ...
        public static Task<ListVolumeQuotaReportResult> InvokeAsync(ListVolumeQuotaReportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListVolumeQuotaReportResult>("azure-native:netapp/v20240501preview:listVolumeQuotaReport", args ?? new ListVolumeQuotaReportArgs(), options.WithDefaults());
