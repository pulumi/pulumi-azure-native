...
namespace Pulumi.AzureNative.NetApp.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240501preview:CapacityPoolSubvolume")]
    public partial class CapacityPoolSubvolume : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolSubvolume(string name, CapacityPoolSubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240501preview:CapacityPoolSubvolume", name, args ?? new CapacityPoolSubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolSubvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240501preview:CapacityPoolSubvolume", name, null, MakeResourceOptions(options, id))
        {
        }
