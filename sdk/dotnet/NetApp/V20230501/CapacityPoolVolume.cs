...
namespace Pulumi.AzureNative.NetApp.V20230501
{
    ...
    /// Volume resource
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20230501:CapacityPoolVolume")]
    public partial class CapacityPoolVolume : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolVolume(string name, CapacityPoolVolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230501:CapacityPoolVolume", name, args ?? new CapacityPoolVolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolVolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230501:CapacityPoolVolume", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CapacityPoolVolumeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("avsDataStore")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230501.AvsDataStore>? AvsDataStore { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230501.CoolAccessRetrievalPolicy>? CoolAccessRetrievalPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230501.EnableSubvolumes>? EnableSubvolumes { get; set; }

        /// <summary>
        /// Source of key used to encrypt data in volume. Applicable if NetApp account has encryption.keySource = 'Microsoft.KeyVault'. Possible values (case-insensitive) are: 'Microsoft.NetApp, Microsoft.KeyVault'
        /// </summary>
        [Input("encryptionKeySource")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230501.EncryptionKeySource>? EncryptionKeySource { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230501.NetworkFeatures>? NetworkFeatures { get; set; }
        ...
        /// </summary>
        [Input("securityStyle")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230501.SecurityStyle>? SecurityStyle { get; set; }

        /// <summary>
        /// The service level of the file system
        /// </summary>
        [Input("serviceLevel")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230501.ServiceLevel>? ServiceLevel { get; set; }

        /// <summary>
        /// Enables access-based enumeration share property for SMB Shares. Only applicable for SMB/DualProtocol volume
        /// </summary>
        [Input("smbAccessBasedEnumeration")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230501.SmbAccessBasedEnumeration>? SmbAccessBasedEnumeration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230501.SmbNonBrowsable>? SmbNonBrowsable { get; set; }
