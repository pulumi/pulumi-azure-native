...
namespace Pulumi.AzureNextGen.NetApp
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp:Account")]
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp:Account", name, null, MakeResourceOptions(options, id))
        {
        }
