...
namespace Pulumi.AzureNative.NetApp.V20221101Preview
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:netapp/v20221101preview:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());
