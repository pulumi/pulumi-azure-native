...
namespace Pulumi.AzureNative.NetApp.V20221101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20221101preview:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20221101preview:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20221101preview:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
