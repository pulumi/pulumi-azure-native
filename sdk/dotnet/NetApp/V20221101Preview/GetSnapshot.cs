...
namespace Pulumi.AzureNative.NetApp.V20221101Preview
{
    public static class GetSnapshot
    {
        ...
        public static Task<GetSnapshotResult> InvokeAsync(GetSnapshotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotResult>("azure-native:netapp/v20221101preview:getSnapshot", args ?? new GetSnapshotArgs(), options.WithDefaults());

        /// <summary>
        /// Get details of the specified snapshot
        /// </summary>
        public static Output<GetSnapshotResult> Invoke(GetSnapshotInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSnapshotResult>("azure-native:netapp/v20221101preview:getSnapshot", args ?? new GetSnapshotInvokeArgs(), options.WithDefaults());
    }
