...
namespace Pulumi.AzureNative.NetApp.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20230701preview:VolumeGroup")]
    public partial class VolumeGroup : global::Pulumi.CustomResource
    {
        ...
        public VolumeGroup(string name, VolumeGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230701preview:VolumeGroup", name, args ?? new VolumeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230701preview:VolumeGroup", name, null, MakeResourceOptions(options, id))
        {
        }
