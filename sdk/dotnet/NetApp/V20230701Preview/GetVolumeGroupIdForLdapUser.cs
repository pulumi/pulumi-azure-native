...
namespace Pulumi.AzureNative.NetApp.V20230701Preview
{
    public static class GetVolumeGroupIdForLdapUser
    {
        ...
        public static Task<GetVolumeGroupIdForLdapUserResult> InvokeAsync(GetVolumeGroupIdForLdapUserArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVolumeGroupIdForLdapUserResult>("azure-native:netapp/v20230701preview:getVolumeGroupIdForLdapUser", args ?? new GetVolumeGroupIdForLdapUserArgs(), options.WithDefaults());
