...
namespace Pulumi.AzureNative.NetApp.V20230701Preview
{
    public static class GetCapacityPoolVolumeGroupIdForLdapUser
    {
        ...
        public static Task<GetCapacityPoolVolumeGroupIdForLdapUserResult> InvokeAsync(GetCapacityPoolVolumeGroupIdForLdapUserArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCapacityPoolVolumeGroupIdForLdapUserResult>("azure-native:netapp/v20230701preview:getCapacityPoolVolumeGroupIdForLdapUser", args ?? new GetCapacityPoolVolumeGroupIdForLdapUserArgs(), options.WithDefaults());
        ...
        public static Output<GetCapacityPoolVolumeGroupIdForLdapUserResult> Invoke(GetCapacityPoolVolumeGroupIdForLdapUserInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCapacityPoolVolumeGroupIdForLdapUserResult>("azure-native:netapp/v20230701preview:getCapacityPoolVolumeGroupIdForLdapUser", args ?? new GetCapacityPoolVolumeGroupIdForLdapUserInvokeArgs(), options.WithDefaults());
