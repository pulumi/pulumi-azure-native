...
namespace Pulumi.AzureNative.NetApp.V20190701
{
    /// <summary>
    /// Snapshot of a Volume
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20190701:Snapshot")]
    public partial class Snapshot : Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190701:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190701:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210201:Snapshot"},
                    new Pulumi.Alias { Type = "azure-native:netapp/v20210401:Snapshot"},
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210401:Snapshot"},
                    new Pulumi.Alias { Type = "azure-native:netapp/v20210401preview:Snapshot"},
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210401preview:Snapshot"},
                    new Pulumi.Alias { Type = "azure-native:netapp/v20210601:Snapshot"},
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210601:Snapshot"},
                },
            };
