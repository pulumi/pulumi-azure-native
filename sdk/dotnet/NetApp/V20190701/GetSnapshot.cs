...
namespace Pulumi.AzureNative.NetApp.V20190701
{
    public static class GetSnapshot
    {
        ...
        public static Task<GetSnapshotResult> InvokeAsync(GetSnapshotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotResult>("azure-native:netapp/v20190701:getSnapshot", args ?? new GetSnapshotArgs(), options.WithVersion());

        /// <summary>
        /// Snapshot of a Volume
        /// </summary>
        public static Output<GetSnapshotResult> Invoke(GetSnapshotInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSnapshotResult>("azure-native:netapp/v20190701:getSnapshot", args ?? new GetSnapshotInvokeArgs(), options.WithVersion());
    }
