...
namespace Pulumi.AzureNative.NetApp.V20190701
{
    ...
    /// {
    ///     var pool = new AzureNative.NetApp.V20190701.Pool("pool", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:netapp/v20190701:Pool myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName} 
    /// ```
    /// </summary>
    ...
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190701:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190701:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
