...
namespace Pulumi.AzureNative.NetApp.V20210401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20210401:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
