...
namespace Pulumi.AzureNative.NetApp.V20210401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20210401:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210401:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
