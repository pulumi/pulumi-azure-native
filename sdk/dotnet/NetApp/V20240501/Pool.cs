...
namespace Pulumi.AzureNative.NetApp.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240501:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240501:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240501:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240501.EncryptionType>? EncryptionType { get; set; }
        ...
        /// </summary>
        [Input("qosType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240501.QosType>? QosType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240501.ServiceLevel> ServiceLevel { get; set; } = null!;
