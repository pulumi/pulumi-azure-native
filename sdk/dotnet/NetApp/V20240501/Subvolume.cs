...
namespace Pulumi.AzureNative.NetApp.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240501:Subvolume")]
    public partial class Subvolume : global::Pulumi.CustomResource
    {
        ...
        public Subvolume(string name, SubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240501:Subvolume", name, args ?? new SubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240501:Subvolume", name, null, MakeResourceOptions(options, id))
        {
        }
