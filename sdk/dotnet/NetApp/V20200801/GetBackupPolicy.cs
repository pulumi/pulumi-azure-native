...
namespace Pulumi.AzureNextGen.NetApp.V20200801
{
    public static class GetBackupPolicy
    {
        public static Task<GetBackupPolicyResult> InvokeAsync(GetBackupPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupPolicyResult>("azure-nextgen:netapp/v20200801:getBackupPolicy", args ?? new GetBackupPolicyArgs(), options.WithVersion());
    }
