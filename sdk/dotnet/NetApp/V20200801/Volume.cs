...
namespace Pulumi.AzureNative.NetApp.V20200801
{
    /// <summary>
    /// Volume resource
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20200801:Volume")]
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200801:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200801:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210201:Volume"},
                    new Pulumi.Alias { Type = "azure-native:netapp/v20210401:Volume"},
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210401:Volume"},
                    new Pulumi.Alias { Type = "azure-native:netapp/v20210401preview:Volume"},
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210401preview:Volume"},
                    new Pulumi.Alias { Type = "azure-native:netapp/v20210601:Volume"},
                    new Pulumi.Alias { Type = "azure-nextgen:netapp/v20210601:Volume"},
                },
            };
