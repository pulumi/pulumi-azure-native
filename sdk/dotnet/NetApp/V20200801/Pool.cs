...
namespace Pulumi.AzureNextGen.NetApp.V20200801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp/v20200801:Pool")]
    public partial class Pool : Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200801:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200801:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("qosType")]
        public InputUnion<string, Pulumi.AzureNextGen.NetApp.V20200801.QosType>? QosType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.NetApp.V20200801.ServiceLevel> ServiceLevel { get; set; } = null!;
