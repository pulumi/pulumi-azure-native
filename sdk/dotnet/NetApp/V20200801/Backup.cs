...
namespace Pulumi.AzureNative.NetApp.V20200801
{
    ...
    /// Backup of a Volume
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20200801:Backup")]
    public partial class Backup : Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200801:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200801:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
