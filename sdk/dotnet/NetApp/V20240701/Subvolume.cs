...
namespace Pulumi.AzureNative.NetApp.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240701:Subvolume")]
    public partial class Subvolume : global::Pulumi.CustomResource
    {
        ...
        public Subvolume(string name, SubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701:Subvolume", name, args ?? new SubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701:Subvolume", name, null, MakeResourceOptions(options, id))
        {
        }
