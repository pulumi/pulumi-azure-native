...
namespace Pulumi.AzureNative.NetApp.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240701:CapacityPoolPool")]
    public partial class CapacityPoolPool : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolPool(string name, CapacityPoolPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701:CapacityPoolPool", name, args ?? new CapacityPoolPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240701:CapacityPoolPool", name, null, MakeResourceOptions(options, id))
        {
        }
