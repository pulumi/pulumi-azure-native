...
namespace Pulumi.AzureNative.NetApp.V20240701
{
    public static class GetCapacityPoolSubvolume
    {
        ...
        public static Task<GetCapacityPoolSubvolumeResult> InvokeAsync(GetCapacityPoolSubvolumeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCapacityPoolSubvolumeResult>("azure-native:netapp/v20240701:getCapacityPoolSubvolume", args ?? new GetCapacityPoolSubvolumeArgs(), options.WithDefaults());
        ...
        public static Output<GetCapacityPoolSubvolumeResult> Invoke(GetCapacityPoolSubvolumeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCapacityPoolSubvolumeResult>("azure-native:netapp/v20240701:getCapacityPoolSubvolume", args ?? new GetCapacityPoolSubvolumeInvokeArgs(), options.WithDefaults());
