...
namespace Pulumi.AzureNative.NetApp.V20240701
{
    public static class GetSubvolumeMetadata
    {
        ...
        public static Task<GetSubvolumeMetadataResult> InvokeAsync(GetSubvolumeMetadataArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSubvolumeMetadataResult>("azure-native:netapp/v20240701:getSubvolumeMetadata", args ?? new GetSubvolumeMetadataArgs(), options.WithDefaults());

        /// <summary>
        /// Get details of the specified subvolume
        /// </summary>
        public static Output<GetSubvolumeMetadataResult> Invoke(GetSubvolumeMetadataInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSubvolumeMetadataResult>("azure-native:netapp/v20240701:getSubvolumeMetadata", args ?? new GetSubvolumeMetadataInvokeArgs(), options.WithDefaults());
    }
