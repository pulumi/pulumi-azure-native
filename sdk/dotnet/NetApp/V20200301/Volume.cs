...
namespace Pulumi.AzureNextGen.NetApp.V20200301
{
    ...
    /// Volume resource
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp/v20200301:Volume")]
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200301:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200301:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VolumeArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("serviceLevel")]
        public InputUnion<string, Pulumi.AzureNextGen.NetApp.V20200301.ServiceLevel>? ServiceLevel { get; set; }
