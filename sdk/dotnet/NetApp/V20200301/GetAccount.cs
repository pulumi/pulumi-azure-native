...
namespace Pulumi.AzureNative.NetApp.V20200301
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:netapp/v20200301:getAccount", args ?? new GetAccountArgs(), options.WithVersion());

        /// <summary>
        /// NetApp account resource
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:netapp/v20200301:getAccount", args ?? new GetAccountInvokeArgs(), options.WithVersion());
    }
