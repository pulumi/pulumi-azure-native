...
namespace Pulumi.AzureNative.NetApp.V20240301Preview
{
    public static class ListCapacityPoolVolumeQuotaReport
    {
        ...
        public static Task<ListCapacityPoolVolumeQuotaReportResult> InvokeAsync(ListCapacityPoolVolumeQuotaReportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListCapacityPoolVolumeQuotaReportResult>("azure-native:netapp/v20240301preview:listCapacityPoolVolumeQuotaReport", args ?? new ListCapacityPoolVolumeQuotaReportArgs(), options.WithDefaults());
        ...
        public static Output<ListCapacityPoolVolumeQuotaReportResult> Invoke(ListCapacityPoolVolumeQuotaReportInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListCapacityPoolVolumeQuotaReportResult>("azure-native:netapp/v20240301preview:listCapacityPoolVolumeQuotaReport", args ?? new ListCapacityPoolVolumeQuotaReportInvokeArgs(), options.WithDefaults());
