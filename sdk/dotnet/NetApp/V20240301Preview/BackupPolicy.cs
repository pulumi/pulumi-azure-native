...
namespace Pulumi.AzureNative.NetApp.V20240301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240301preview:BackupPolicy")]
    public partial class BackupPolicy : global::Pulumi.CustomResource
    {
        ...
        public BackupPolicy(string name, BackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240301preview:BackupPolicy", name, args ?? new BackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240301preview:BackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
