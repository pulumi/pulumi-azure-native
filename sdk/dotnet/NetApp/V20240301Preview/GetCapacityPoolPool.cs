...
namespace Pulumi.AzureNative.NetApp.V20240301Preview
{
    public static class GetCapacityPoolPool
    {
        ...
        public static Task<GetCapacityPoolPoolResult> InvokeAsync(GetCapacityPoolPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCapacityPoolPoolResult>("azure-native:netapp/v20240301preview:getCapacityPoolPool", args ?? new GetCapacityPoolPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Get details of the specified capacity pool
        /// </summary>
        public static Output<GetCapacityPoolPoolResult> Invoke(GetCapacityPoolPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCapacityPoolPoolResult>("azure-native:netapp/v20240301preview:getCapacityPoolPool", args ?? new GetCapacityPoolPoolInvokeArgs(), options.WithDefaults());
