...
namespace Pulumi.AzureNative.NetApp.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240901:CapacityPoolVolumeQuotaRule")]
    public partial class CapacityPoolVolumeQuotaRule : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolVolumeQuotaRule(string name, CapacityPoolVolumeQuotaRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901:CapacityPoolVolumeQuotaRule", name, args ?? new CapacityPoolVolumeQuotaRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolVolumeQuotaRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901:CapacityPoolVolumeQuotaRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CapacityPoolVolumeQuotaRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("quotaType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901.Type>? QuotaType { get; set; }
