...
namespace Pulumi.AzureNative.NetApp.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240901:VolumeQuotaRule")]
    public partial class VolumeQuotaRule : global::Pulumi.CustomResource
    {
        ...
        public VolumeQuotaRule(string name, VolumeQuotaRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901:VolumeQuotaRule", name, args ?? new VolumeQuotaRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeQuotaRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901:VolumeQuotaRule", name, null, MakeResourceOptions(options, id))
        {
        }
