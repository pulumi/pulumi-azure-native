...
namespace Pulumi.AzureNative.NetApp.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240901:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
