...
namespace Pulumi.AzureNative.NetApp.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240901:CapacityPoolPool")]
    public partial class CapacityPoolPool : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolPool(string name, CapacityPoolPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901:CapacityPoolPool", name, args ?? new CapacityPoolPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901:CapacityPoolPool", name, null, MakeResourceOptions(options, id))
        {
        }
