...
namespace Pulumi.AzureNative.NetApp.V20211001
{
    ...
    /// {
    ///     var subvolume = new AzureNative.NetApp.V20211001.Subvolume("subvolume", new()
    ///     {
    ...
    public partial class Subvolume : global::Pulumi.CustomResource
    {
        ...
        public Subvolume(string name, SubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20211001:Subvolume", name, args ?? new SubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20211001:Subvolume", name, null, MakeResourceOptions(options, id))
        {
        }
