...
namespace Pulumi.AzureNative.NetApp.V20211001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20211001:SnapshotPolicy")]
    public partial class SnapshotPolicy : Pulumi.CustomResource
    {
        ...
        public SnapshotPolicy(string name, SnapshotPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20211001:SnapshotPolicy", name, args ?? new SnapshotPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20211001:SnapshotPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
