...
namespace Pulumi.AzureNative.NetApp.V20211001.Inputs
{
    ...
    public sealed class ReplicationObjectArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("endpointType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20211001.EndpointType>? EndpointType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20211001.ReplicationSchedule>? ReplicationSchedule { get; set; }
