...
namespace Pulumi.AzureNative.NetApp.V20211001.Inputs
{
    ...
    public sealed class PoolPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20211001.EncryptionType>? EncryptionType { get; set; }

        /// <summary>
        /// The qos type of the pool
        /// </summary>
        [Input("qosType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20211001.QosType>? QosType { get; set; }

        /// <summary>
        /// The service level of the file system
        /// </summary>
        [Input("serviceLevel", required: true)]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20211001.ServiceLevel> ServiceLevel { get; set; } = null!;
