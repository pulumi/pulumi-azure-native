...
namespace Pulumi.AzureRM.NetApp.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var snapshot = new AzureRM.NetApp.V20190801.Snapshot("snapshot", new AzureRM.NetApp.V20190801.SnapshotArgs
    ///         {
    ...
    public partial class Snapshot : Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20190801:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20190801:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
