...
namespace Pulumi.AzureRM.NetApp.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var volume = new AzureRM.NetApp.V20190801.Volume("volume", new AzureRM.NetApp.V20190801.VolumeArgs
    ///         {
    ...
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20190801:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20190801:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
