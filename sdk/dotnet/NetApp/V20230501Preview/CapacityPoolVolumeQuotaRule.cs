...
namespace Pulumi.AzureNative.NetApp.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20230501preview:CapacityPoolVolumeQuotaRule")]
    public partial class CapacityPoolVolumeQuotaRule : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolVolumeQuotaRule(string name, CapacityPoolVolumeQuotaRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230501preview:CapacityPoolVolumeQuotaRule", name, args ?? new CapacityPoolVolumeQuotaRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolVolumeQuotaRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230501preview:CapacityPoolVolumeQuotaRule", name, null, MakeResourceOptions(options, id))
        {
        }
