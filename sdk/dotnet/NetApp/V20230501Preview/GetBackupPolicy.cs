...
namespace Pulumi.AzureNative.NetApp.V20230501Preview
{
    public static class GetBackupPolicy
    {
        ...
        public static Task<GetBackupPolicyResult> InvokeAsync(GetBackupPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackupPolicyResult>("azure-native:netapp/v20230501preview:getBackupPolicy", args ?? new GetBackupPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Get a particular backup Policy
        /// </summary>
        public static Output<GetBackupPolicyResult> Invoke(GetBackupPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackupPolicyResult>("azure-native:netapp/v20230501preview:getBackupPolicy", args ?? new GetBackupPolicyInvokeArgs(), options.WithDefaults());
