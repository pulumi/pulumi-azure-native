...
namespace Pulumi.AzureNative.NetApp.V20210601
{
    public static class GetVolume
    {
        ...
        public static Task<GetVolumeResult> InvokeAsync(GetVolumeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVolumeResult>("azure-native:netapp/v20210601:getVolume", args ?? new GetVolumeArgs(), options.WithVersion());

        /// <summary>
        /// Volume resource
        /// </summary>
        public static Output<GetVolumeResult> Invoke(GetVolumeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVolumeResult>("azure-native:netapp/v20210601:getVolume", args ?? new GetVolumeInvokeArgs(), options.WithVersion());
    }
