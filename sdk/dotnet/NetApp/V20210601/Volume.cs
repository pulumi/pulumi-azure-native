...
namespace Pulumi.AzureNative.NetApp.V20210601
{
    ...
    /// Volume resource
    /// </summary>
    [Obsolete(@"azure-native:netapp/v20210601:Volume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20211001:Volume to guarantee forwards compatibility.")]
    ...
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210601:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210601:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
