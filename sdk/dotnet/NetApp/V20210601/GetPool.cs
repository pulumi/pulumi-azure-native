...
namespace Pulumi.AzureNative.NetApp.V20210601
{
    public static class GetPool
    {
        ...
        public static Task<GetPoolResult> InvokeAsync(GetPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPoolResult>("azure-native:netapp/v20210601:getPool", args ?? new GetPoolArgs(), options.WithVersion());

        /// <summary>
        /// Capacity pool resource
        /// </summary>
        public static Output<GetPoolResult> Invoke(GetPoolInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPoolResult>("azure-native:netapp/v20210601:getPool", args ?? new GetPoolInvokeArgs(), options.WithVersion());
    }
