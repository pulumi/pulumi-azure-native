...
namespace Pulumi.AzureNative.NetApp.V20210601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:netapp/v20210601:SnapshotPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:netapp/v20210601:SnapshotPolicy")]
    public partial class SnapshotPolicy : global::Pulumi.CustomResource
    {
        ...
        public SnapshotPolicy(string name, SnapshotPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210601:SnapshotPolicy", name, args ?? new SnapshotPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210601:SnapshotPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
