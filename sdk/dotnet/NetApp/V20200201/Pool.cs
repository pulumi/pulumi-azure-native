...
namespace Pulumi.AzureRM.NetApp.V20200201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var pool = new AzureRM.NetApp.V20200201.Pool("pool", new AzureRM.NetApp.V20200201.PoolArgs
    ///         {
    ...
    public partial class Pool : Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20200201:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20200201:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
