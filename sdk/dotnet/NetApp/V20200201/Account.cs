...
namespace Pulumi.AzureRM.NetApp.V20200201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var account = new AzureRM.NetApp.V20200201.Account("account", new AzureRM.NetApp.V20200201.AccountArgs
    ///         {
    ...
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20200201:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20200201:Account", name, null, MakeResourceOptions(options, id))
        {
        }
