...
namespace Pulumi.AzureNative.NetApp.V20200201
{
    ...
    /// {
    ///     var volume = new AzureNative.NetApp.V20200201.Volume("volume", new()
    ///     {
    ...
    [AzureNativeResourceType("azure-native:netapp/v20200201:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200201:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200201:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
