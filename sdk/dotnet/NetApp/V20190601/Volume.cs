...
namespace Pulumi.AzureNative.NetApp.V20190601
{
    ...
    /// Volume resource
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20190601:Volume")]
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190601:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190601:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VolumeArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("serviceLevel")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20190601.ServiceLevel>? ServiceLevel { get; set; }
