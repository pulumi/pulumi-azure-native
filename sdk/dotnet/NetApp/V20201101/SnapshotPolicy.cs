...
namespace Pulumi.AzureNextGen.NetApp.V20201101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp/v20201101:SnapshotPolicy")]
    public partial class SnapshotPolicy : Pulumi.CustomResource
    {
        ...
        public SnapshotPolicy(string name, SnapshotPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20201101:SnapshotPolicy", name, args ?? new SnapshotPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20201101:SnapshotPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
