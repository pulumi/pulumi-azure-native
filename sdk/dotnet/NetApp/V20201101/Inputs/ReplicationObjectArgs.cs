...
namespace Pulumi.AzureNative.NetApp.V20201101.Inputs
{
    ...
    public sealed class ReplicationObjectArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("endpointType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20201101.EndpointType>? EndpointType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20201101.ReplicationSchedule> ReplicationSchedule { get; set; } = null!;
