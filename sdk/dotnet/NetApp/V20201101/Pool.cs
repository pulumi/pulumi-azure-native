...
namespace Pulumi.AzureNative.NetApp.V20201101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20201101:Pool")]
    public partial class Pool : Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20201101:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20201101:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
