...
namespace Pulumi.AzureNextGen.NetApp.V20201101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp/v20201101:BackupPolicy")]
    public partial class BackupPolicy : Pulumi.CustomResource
    {
        ...
        public BackupPolicy(string name, BackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20201101:BackupPolicy", name, args ?? new BackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20201101:BackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
