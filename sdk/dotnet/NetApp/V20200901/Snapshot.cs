...
namespace Pulumi.AzureNextGen.NetApp.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp/v20200901:Snapshot")]
    public partial class Snapshot : Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200901:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200901:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
