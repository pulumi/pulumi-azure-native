...
namespace Pulumi.AzureRM.NetApp.V20190501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var pool = new AzureRM.NetApp.V20190501.Pool("pool", new AzureRM.NetApp.V20190501.PoolArgs
    ///         {
    ...
    public partial class Pool : Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20190501:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20190501:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
