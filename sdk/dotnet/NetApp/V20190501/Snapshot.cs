...
namespace Pulumi.AzureNative.NetApp.V20190501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20190501:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190501:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190501:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
