...
namespace Pulumi.AzureRM.NetApp.V20190501
{
    /// <summary>
    /// Volume resource
    /// 
    ...
    ///     public MyStack()
    ///     {
    ///         var volume = new AzureRM.NetApp.V20190501.Volume("volume", new AzureRM.NetApp.V20190501.VolumeArgs
    ///         {
    ...
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20190501:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp/v20190501:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
