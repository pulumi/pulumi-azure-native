...
namespace Pulumi.AzureNative.NetApp.V20190501
{
    ...
    /// {
    ///     var volume = new AzureNative.NetApp.V20190501.Volume("volume", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:netapp/v20190501:Volume myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName} 
    /// ```
    /// </summary>
    [Obsolete(@"Version 2019-05-01 will be removed in v2 of the provider.")]
    [AzureNativeResourceType("azure-native:netapp/v20190501:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190501:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20190501:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
