...
namespace Pulumi.AzureNative.NetApp.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20231101preview:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101preview:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101preview:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
