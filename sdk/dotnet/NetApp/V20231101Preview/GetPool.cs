...
namespace Pulumi.AzureNative.NetApp.V20231101Preview
{
    public static class GetPool
    {
        ...
        public static Task<GetPoolResult> InvokeAsync(GetPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPoolResult>("azure-native:netapp/v20231101preview:getPool", args ?? new GetPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Get details of the specified capacity pool
        /// </summary>
        public static Output<GetPoolResult> Invoke(GetPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPoolResult>("azure-native:netapp/v20231101preview:getPool", args ?? new GetPoolInvokeArgs(), options.WithDefaults());
