...
namespace Pulumi.AzureNative.NetApp.V20231101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20231101preview:BackupVault")]
    public partial class BackupVault : global::Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101preview:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101preview:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
