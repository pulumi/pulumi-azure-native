...
namespace Pulumi.AzureNative.NetApp.V20231101
{
    public static class GetCapacityPoolVolume
    {
        ...
        public static Task<GetCapacityPoolVolumeResult> InvokeAsync(GetCapacityPoolVolumeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCapacityPoolVolumeResult>("azure-native:netapp/v20231101:getCapacityPoolVolume", args ?? new GetCapacityPoolVolumeArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of the specified volume
        /// </summary>
        public static Output<GetCapacityPoolVolumeResult> Invoke(GetCapacityPoolVolumeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCapacityPoolVolumeResult>("azure-native:netapp/v20231101:getCapacityPoolVolume", args ?? new GetCapacityPoolVolumeInvokeArgs(), options.WithDefaults());
