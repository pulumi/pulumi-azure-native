...
namespace Pulumi.AzureNative.NetApp.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20231101:BackupVault")]
    public partial class BackupVault : global::Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
