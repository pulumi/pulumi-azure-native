...
namespace Pulumi.AzureNative.NetApp.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20231101:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
