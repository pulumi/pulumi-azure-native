...
namespace Pulumi.AzureNative.NetApp.V20231101
{
    public static class GetBackup
    {
        ...
        public static Task<GetBackupResult> InvokeAsync(GetBackupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackupResult>("azure-native:netapp/v20231101:getBackup", args ?? new GetBackupArgs(), options.WithDefaults());

        /// <summary>
        /// Get the specified Backup under Backup Vault.
        /// </summary>
        public static Output<GetBackupResult> Invoke(GetBackupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackupResult>("azure-native:netapp/v20231101:getBackup", args ?? new GetBackupInvokeArgs(), options.WithDefaults());
    }
