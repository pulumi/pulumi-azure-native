...
namespace Pulumi.AzureNative.NetApp.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20231101:Subvolume")]
    public partial class Subvolume : global::Pulumi.CustomResource
    {
        ...
        public Subvolume(string name, SubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101:Subvolume", name, args ?? new SubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20231101:Subvolume", name, null, MakeResourceOptions(options, id))
        {
        }
