...
namespace Pulumi.AzureNative.NetApp.V20240101
{
    public static class GetVolumeGroup
    {
        ...
        public static Task<GetVolumeGroupResult> InvokeAsync(GetVolumeGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVolumeGroupResult>("azure-native:netapp/v20240101:getVolumeGroup", args ?? new GetVolumeGroupArgs(), options.WithDefaults());
