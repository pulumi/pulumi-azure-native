...
namespace Pulumi.AzureNative.NetApp.V20220501
{
    ...
    /// {
    ///     var account = new AzureNative.NetApp.V20220501.Account("account", new()
    ///     {
    ///         AccountName = "account1",
    ///         ActiveDirectories = new[]
    ///         {
    ///             new AzureNative.NetApp.V20220501.Inputs.ActiveDirectoryArgs
    ///             {
    ///                 AesEncryption = true,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220501:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220501:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220501:Account", name, null, MakeResourceOptions(options, id))
        {
        }
