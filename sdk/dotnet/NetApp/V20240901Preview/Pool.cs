...
namespace Pulumi.AzureNative.NetApp.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240901preview:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901preview:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901preview:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.EncryptionType>? EncryptionType { get; set; }
        ...
        /// </summary>
        [Input("qosType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.QosType>? QosType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.ServiceLevel> ServiceLevel { get; set; } = null!;
