...
namespace Pulumi.AzureNative.NetApp.V20240901Preview
{
    public static class ListVolumeQuotaReport
    {
        ...
        public static Task<ListVolumeQuotaReportResult> InvokeAsync(ListVolumeQuotaReportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListVolumeQuotaReportResult>("azure-native:netapp/v20240901preview:listVolumeQuotaReport", args ?? new ListVolumeQuotaReportArgs(), options.WithDefaults());

        /// <summary>
        /// Returns report of quotas for the volume
        /// </summary>
        public static Output<ListVolumeQuotaReportResult> Invoke(ListVolumeQuotaReportInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListVolumeQuotaReportResult>("azure-native:netapp/v20240901preview:listVolumeQuotaReport", args ?? new ListVolumeQuotaReportInvokeArgs(), options.WithDefaults());
