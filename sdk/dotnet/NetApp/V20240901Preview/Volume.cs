...
namespace Pulumi.AzureNative.NetApp.V20240901Preview
{
    ...
    /// Volume resource
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240901preview:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901preview:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901preview:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VolumeArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.AcceptGrowCapacityPoolForShortTermCloneSplit>? AcceptGrowCapacityPoolForShortTermCloneSplit { get; set; }
        ...
        /// </summary>
        [Input("avsDataStore")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.AvsDataStore>? AvsDataStore { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.CoolAccessRetrievalPolicy>? CoolAccessRetrievalPolicy { get; set; }

        /// <summary>
        /// coolAccessTieringPolicy determines which cold data blocks are moved to cool tier. The possible values for this field are: Auto - Moves cold user data blocks in both the Snapshot copies and the active file system to the cool tier tier. This policy is the default. SnapshotOnly - Moves user data blocks of the Volume Snapshot copies that are not associated with the active file system to the cool tier.
        /// </summary>
        [Input("coolAccessTieringPolicy")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.CoolAccessTieringPolicy>? CoolAccessTieringPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.EnableSubvolumes>? EnableSubvolumes { get; set; }

        /// <summary>
        /// Source of key used to encrypt data in volume. Applicable if NetApp account has encryption.keySource = 'Microsoft.KeyVault'. Possible values (case-insensitive) are: 'Microsoft.NetApp, Microsoft.KeyVault'
        /// </summary>
        [Input("encryptionKeySource")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.EncryptionKeySource>? EncryptionKeySource { get; set; }
        ...
        /// </summary>
        [Input("language")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.VolumeLanguage>? Language { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.NetworkFeatures>? NetworkFeatures { get; set; }
        ...
        /// </summary>
        [Input("securityStyle")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.SecurityStyle>? SecurityStyle { get; set; }

        /// <summary>
        /// The service level of the file system
        /// </summary>
        [Input("serviceLevel")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.ServiceLevel>? ServiceLevel { get; set; }

        /// <summary>
        /// Enables access-based enumeration share property for SMB Shares. Only applicable for SMB/DualProtocol volume
        /// </summary>
        [Input("smbAccessBasedEnumeration")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.SmbAccessBasedEnumeration>? SmbAccessBasedEnumeration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240901Preview.SmbNonBrowsable>? SmbNonBrowsable { get; set; }
