...
namespace Pulumi.AzureNative.NetApp.V20240901Preview
{
    public static class GetVolume
    {
        ...
        public static Task<GetVolumeResult> InvokeAsync(GetVolumeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVolumeResult>("azure-native:netapp/v20240901preview:getVolume", args ?? new GetVolumeArgs(), options.WithDefaults());

        /// <summary>
        /// Get the details of the specified volume
        /// </summary>
        public static Output<GetVolumeResult> Invoke(GetVolumeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVolumeResult>("azure-native:netapp/v20240901preview:getVolume", args ?? new GetVolumeInvokeArgs(), options.WithDefaults());
