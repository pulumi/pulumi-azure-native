...
namespace Pulumi.AzureNative.NetApp.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20240901preview:SnapshotPolicy")]
    public partial class SnapshotPolicy : global::Pulumi.CustomResource
    {
        ...
        public SnapshotPolicy(string name, SnapshotPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901preview:SnapshotPolicy", name, args ?? new SnapshotPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20240901preview:SnapshotPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
