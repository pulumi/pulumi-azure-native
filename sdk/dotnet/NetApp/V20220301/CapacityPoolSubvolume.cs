...
namespace Pulumi.AzureNative.NetApp.V20220301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220301:CapacityPoolSubvolume")]
    public partial class CapacityPoolSubvolume : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolSubvolume(string name, CapacityPoolSubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220301:CapacityPoolSubvolume", name, args ?? new CapacityPoolSubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolSubvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220301:CapacityPoolSubvolume", name, null, MakeResourceOptions(options, id))
        {
        }
