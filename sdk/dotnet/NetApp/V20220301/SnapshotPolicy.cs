...
namespace Pulumi.AzureNative.NetApp.V20220301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220301:SnapshotPolicy")]
    public partial class SnapshotPolicy : global::Pulumi.CustomResource
    {
        ...
        public SnapshotPolicy(string name, SnapshotPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220301:SnapshotPolicy", name, args ?? new SnapshotPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220301:SnapshotPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
