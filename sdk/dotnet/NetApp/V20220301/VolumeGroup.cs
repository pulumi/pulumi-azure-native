...
namespace Pulumi.AzureNative.NetApp.V20220301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220301:VolumeGroup")]
    public partial class VolumeGroup : Pulumi.CustomResource
    {
        ...
        public VolumeGroup(string name, VolumeGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220301:VolumeGroup", name, args ?? new VolumeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220301:VolumeGroup", name, null, MakeResourceOptions(options, id))
        {
        }
