...
namespace Pulumi.AzureNative.NetApp.V20220301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220301:Subvolume")]
    public partial class Subvolume : Pulumi.CustomResource
    {
        ...
        public Subvolume(string name, SubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220301:Subvolume", name, args ?? new SubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220301:Subvolume", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:netapp:Subvolume"},
