...
namespace Pulumi.AzureNative.NetApp
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp:CapacityPoolPool")]
    public partial class CapacityPoolPool : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolPool(string name, CapacityPoolPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp:CapacityPoolPool", name, args ?? new CapacityPoolPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp:CapacityPoolPool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:netapp/v20240901preview:CapacityPoolPool" },
