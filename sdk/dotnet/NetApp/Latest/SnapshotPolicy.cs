...
namespace Pulumi.AzureNextGen.NetApp.Latest
{
    ...
    public partial class SnapshotPolicy : Pulumi.CustomResource
    {
        ...
        public SnapshotPolicy(string name, SnapshotPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/latest:SnapshotPolicy", name, args ?? new SnapshotPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/latest:SnapshotPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
