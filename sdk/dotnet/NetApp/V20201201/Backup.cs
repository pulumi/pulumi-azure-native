...
namespace Pulumi.AzureNative.NetApp.V20201201
{
    ...
    /// {
    ///     var backup = new AzureNative.NetApp.V20201201.Backup("backup", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:netapp/v20201201:Backup account1/pool1/volume1/backup1 /subscriptions/D633CC2E-722B-4AE1-B636-BBD9E4C60ED9/resourceGroups/myRG/providers/Microsoft.NetApp/netAppAccounts/account1/capacityPools/pool1/volumes/volume1/backups/backup1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20201201:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20201201:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20201201:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
