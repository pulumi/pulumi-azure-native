...
namespace Pulumi.AzureNative.NetApp.V20201201
{
    ...
    /// {
    ///     var volume = new AzureNative.NetApp.V20201201.Volume("volume", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20201201:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20201201:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20201201:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
