...
namespace Pulumi.AzureNative.NetApp.V20210201
{
    ...
    /// Backup of a Volume
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20210201:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210201:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210201:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
