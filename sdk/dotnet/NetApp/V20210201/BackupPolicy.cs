...
namespace Pulumi.AzureNative.NetApp.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:netapp/v20210201:BackupPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20210401:BackupPolicy to guarantee forwards compatibility.")]
    ...
    public partial class BackupPolicy : global::Pulumi.CustomResource
    {
        ...
        public BackupPolicy(string name, BackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210201:BackupPolicy", name, args ?? new BackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210201:BackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
