...
namespace Pulumi.AzureNative.NetApp.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20210201:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210201:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210201:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
