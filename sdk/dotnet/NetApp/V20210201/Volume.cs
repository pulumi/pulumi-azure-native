...
namespace Pulumi.AzureNative.NetApp.V20210201
{
    ...
    /// Volume resource
    /// </summary>
    [Obsolete(@"azure-native:netapp/v20210201:Volume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20211001:Volume to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:netapp/v20210201:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210201:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20210201:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VolumeArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("securityStyle")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20210201.SecurityStyle>? SecurityStyle { get; set; }

        /// <summary>
        /// The service level of the file system
        /// </summary>
        [Input("serviceLevel")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20210201.ServiceLevel>? ServiceLevel { get; set; }
