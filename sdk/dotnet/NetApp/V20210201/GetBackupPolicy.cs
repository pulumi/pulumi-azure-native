...
namespace Pulumi.AzureNative.NetApp.V20210201
{
    public static class GetBackupPolicy
    {
        ...
        public static Task<GetBackupPolicyResult> InvokeAsync(GetBackupPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupPolicyResult>("azure-native:netapp/v20210201:getBackupPolicy", args ?? new GetBackupPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Backup policy information
        /// </summary>
        public static Output<GetBackupPolicyResult> Invoke(GetBackupPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackupPolicyResult>("azure-native:netapp/v20210201:getBackupPolicy", args ?? new GetBackupPolicyInvokeArgs(), options.WithVersion());
    }
