...
namespace Pulumi.AzureNative.NetApp.V20200601
{
    ...
    /// Backup of a Volume
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20200601:Backup")]
    public partial class Backup : Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200601:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20200601:Backup", name, null, MakeResourceOptions(options, id))
        {
        }
