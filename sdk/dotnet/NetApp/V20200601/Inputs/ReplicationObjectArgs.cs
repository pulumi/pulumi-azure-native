...
namespace Pulumi.AzureNative.NetApp.V20200601.Inputs
{
    ...
    public sealed class ReplicationObjectArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("endpointType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20200601.EndpointType>? EndpointType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20200601.ReplicationSchedule> ReplicationSchedule { get; set; } = null!;
