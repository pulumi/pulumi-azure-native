...
namespace Pulumi.AzureNative.NetApp.V20240301.Inputs
{
    ...
    public sealed class ReplicationObjectArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("endpointType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240301.EndpointType>? EndpointType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20240301.ReplicationSchedule>? ReplicationSchedule { get; set; }
