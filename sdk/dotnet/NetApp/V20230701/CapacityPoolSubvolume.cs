...
namespace Pulumi.AzureNative.NetApp.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20230701:CapacityPoolSubvolume")]
    public partial class CapacityPoolSubvolume : global::Pulumi.CustomResource
    {
        ...
        public CapacityPoolSubvolume(string name, CapacityPoolSubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230701:CapacityPoolSubvolume", name, args ?? new CapacityPoolSubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityPoolSubvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230701:CapacityPoolSubvolume", name, null, MakeResourceOptions(options, id))
        {
        }
