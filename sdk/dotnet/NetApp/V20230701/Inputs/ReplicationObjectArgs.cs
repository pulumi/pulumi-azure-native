...
namespace Pulumi.AzureNative.NetApp.V20230701.Inputs
{
    ...
    public sealed class ReplicationObjectArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("endpointType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230701.EndpointType>? EndpointType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20230701.ReplicationSchedule>? ReplicationSchedule { get; set; }
