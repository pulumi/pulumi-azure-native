...
namespace Pulumi.AzureNative.NetApp.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20230701:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230701:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20230701:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
