...
namespace Pulumi.AzureNextGen.NetApp.V20200501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp/v20200501:Pool")]
    public partial class Pool : Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200501:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200501:Pool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PoolArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.NetApp.V20200501.ServiceLevel> ServiceLevel { get; set; } = null!;
