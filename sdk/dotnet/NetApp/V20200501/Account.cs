...
namespace Pulumi.AzureNextGen.NetApp.V20200501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:netapp/v20200501:Account")]
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200501:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:netapp/v20200501:Account", name, null, MakeResourceOptions(options, id))
        {
        }
