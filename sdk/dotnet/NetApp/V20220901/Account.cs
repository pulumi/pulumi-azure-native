...
namespace Pulumi.AzureNative.NetApp.V20220901
{
    ...
    /// {
    ///     var account = new AzureNative.NetApp.V20220901.Account("account", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.NetApp.V20220901.Inputs.ActiveDirectoryArgs
    ///             {
    ///                 AesEncryption = true,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220901:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220901:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220901:Account", name, null, MakeResourceOptions(options, id))
        {
        }
