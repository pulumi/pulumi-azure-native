...
namespace Pulumi.AzureNative.NetApp.V20220901
{
    ...
    /// {
    ///     var volumeGroup = new AzureNative.NetApp.V20220901.VolumeGroup("volumeGroup", new()
    ///     {
    ///         AccountName = "account1",
    ///         GroupMetaData = new AzureNative.NetApp.V20220901.Inputs.VolumeGroupMetaDataArgs
    ///         {
    ...
    ///         Volumes = new[]
    ///         {
    ///             new AzureNative.NetApp.V20220901.Inputs.VolumeGroupVolumePropertiesArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220901:VolumeGroup")]
    public partial class VolumeGroup : global::Pulumi.CustomResource
    {
        ...
        public VolumeGroup(string name, VolumeGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220901:VolumeGroup", name, args ?? new VolumeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220901:VolumeGroup", name, null, MakeResourceOptions(options, id))
        {
        }
