...
namespace Pulumi.AzureNative.NetApp.V20220901
{
    ...
    /// {
    ///     var snapshotPolicy = new AzureNative.NetApp.V20220901.SnapshotPolicy("snapshotPolicy", new()
    ///     {
    ///         AccountName = "account1",
    ///         DailySchedule = new AzureNative.NetApp.V20220901.Inputs.DailyScheduleArgs
    ///         {
    ///             Hour = 14,
    ///             Minute = 30,
    ///             SnapshotsToKeep = 4,
    ///         },
    ///         Enabled = true,
    ///         HourlySchedule = new AzureNative.NetApp.V20220901.Inputs.HourlyScheduleArgs
    ///         {
    ///             Minute = 50,
    ///             SnapshotsToKeep = 2,
    ///         },
    ///         Location = "eastus",
    ///         MonthlySchedule = new AzureNative.NetApp.V20220901.Inputs.MonthlyScheduleArgs
    ///         {
    ...
    ///         WeeklySchedule = new AzureNative.NetApp.V20220901.Inputs.WeeklyScheduleArgs
    ///         {
    ///             Day = "Wednesday",
    ///             Hour = 14,
    ///             Minute = 45,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220901:SnapshotPolicy")]
    public partial class SnapshotPolicy : global::Pulumi.CustomResource
    {
        ...
        public SnapshotPolicy(string name, SnapshotPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220901:SnapshotPolicy", name, args ?? new SnapshotPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220901:SnapshotPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
