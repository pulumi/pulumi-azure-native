...
namespace Pulumi.AzureNative.NetApp.V20220101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:netapp/v20220101:BackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:BackupPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:netapp/v20220101:BackupPolicy")]
    public partial class BackupPolicy : global::Pulumi.CustomResource
    {
        ...
        public BackupPolicy(string name, BackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220101:BackupPolicy", name, args ?? new BackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220101:BackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
