...
namespace Pulumi.AzureNative.NetApp.V20220101
{
    ...
    /// {
    ///     var volumeQuotaRule = new AzureNative.NetApp.V20220101.VolumeQuotaRule("volumeQuotaRule", new()
    ///     {
    ...
    public partial class VolumeQuotaRule : global::Pulumi.CustomResource
    {
        ...
        public VolumeQuotaRule(string name, VolumeQuotaRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220101:VolumeQuotaRule", name, args ?? new VolumeQuotaRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeQuotaRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220101:VolumeQuotaRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VolumeQuotaRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("quotaType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20220101.Type>? QuotaType { get; set; }
