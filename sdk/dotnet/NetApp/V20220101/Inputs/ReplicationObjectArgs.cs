...
namespace Pulumi.AzureNative.NetApp.V20220101.Inputs
{
    ...
    public sealed class ReplicationObjectArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("endpointType")]
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20220101.EndpointType>? EndpointType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.NetApp.V20220101.ReplicationSchedule>? ReplicationSchedule { get; set; }
