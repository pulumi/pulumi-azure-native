...
namespace Pulumi.AzureNative.NetApp.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220101:Subvolume")]
    public partial class Subvolume : Pulumi.CustomResource
    {
        ...
        public Subvolume(string name, SubvolumeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220101:Subvolume", name, args ?? new SubvolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subvolume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220101:Subvolume", name, null, MakeResourceOptions(options, id))
        {
        }
