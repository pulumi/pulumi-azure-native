...
namespace Pulumi.AzureNative.NetApp.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:netapp/v20220101:VolumeGroup")]
    public partial class VolumeGroup : global::Pulumi.CustomResource
    {
        ...
        public VolumeGroup(string name, VolumeGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220101:VolumeGroup", name, args ?? new VolumeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:netapp/v20220101:VolumeGroup", name, null, MakeResourceOptions(options, id))
        {
        }
