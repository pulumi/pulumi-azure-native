...
namespace Pulumi.AzureNative.NetApp.V20220101
{
    public static class GetCapacityPoolPool
    {
        ...
        public static Task<GetCapacityPoolPoolResult> InvokeAsync(GetCapacityPoolPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCapacityPoolPoolResult>("azure-native:netapp/v20220101:getCapacityPoolPool", args ?? new GetCapacityPoolPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Get details of the specified capacity pool
        /// </summary>
        public static Output<GetCapacityPoolPoolResult> Invoke(GetCapacityPoolPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCapacityPoolPoolResult>("azure-native:netapp/v20220101:getCapacityPoolPool", args ?? new GetCapacityPoolPoolInvokeArgs(), options.WithDefaults());
