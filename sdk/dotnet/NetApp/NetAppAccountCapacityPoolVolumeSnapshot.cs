...
namespace Pulumi.AzureRM.NetApp
{
    ...
    public partial class NetAppAccountCapacityPoolVolumeSnapshot : Pulumi.CustomResource
    {
        ...
        private NetAppAccountCapacityPoolVolumeSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:netapp:NetAppAccountCapacityPoolVolumeSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetAppAccountCapacityPoolVolumeSnapshot Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new NetAppAccountCapacityPoolVolumeSnapshot(name, id, options);
        }
    }
