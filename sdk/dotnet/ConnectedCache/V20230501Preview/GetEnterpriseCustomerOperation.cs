...
namespace Pulumi.AzureNative.ConnectedCache.V20230501Preview
{
    public static class GetEnterpriseCustomerOperation
    {
        ...
        public static Task<GetEnterpriseCustomerOperationResult> InvokeAsync(GetEnterpriseCustomerOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEnterpriseCustomerOperationResult>("azure-native:connectedcache/v20230501preview:getEnterpriseCustomerOperation", args ?? new GetEnterpriseCustomerOperationArgs(), options.WithDefaults());
