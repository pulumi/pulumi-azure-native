...
namespace Pulumi.AzureNative.ConnectedCache.V20230501Preview
{
    public static class GetCacheNodesOperation
    {
        ...
        public static Task<GetCacheNodesOperationResult> InvokeAsync(GetCacheNodesOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCacheNodesOperationResult>("azure-native:connectedcache/v20230501preview:getCacheNodesOperation", args ?? new GetCacheNodesOperationArgs(), options.WithDefaults());
