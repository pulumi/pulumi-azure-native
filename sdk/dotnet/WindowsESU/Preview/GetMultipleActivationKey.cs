...
namespace Pulumi.AzureRM.WindowsESU.Preview
{
    public static class GetMultipleActivationKey
    {
        public static Task<GetMultipleActivationKeyResult> InvokeAsync(GetMultipleActivationKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMultipleActivationKeyResult>("azurerm:windowsesu/preview:getMultipleActivationKey", args ?? new GetMultipleActivationKeyArgs(), options.WithVersion());
    }
