...
namespace Pulumi.AzureRM.WindowsESU.Preview
{
    ...
    public partial class MultipleActivationKey : Pulumi.CustomResource
    {
        ...
        public MultipleActivationKey(string name, MultipleActivationKeyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:windowsesu/preview:MultipleActivationKey", name, args ?? new MultipleActivationKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MultipleActivationKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:windowsesu/preview:MultipleActivationKey", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:windowsesu/v20190916preview:MultipleActivationKey"},
                },
            };
