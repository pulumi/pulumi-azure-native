...
namespace Pulumi.AzureNative.AzureStack.V20220601
{
    public static class ListProductDetails
    {
        ...
        public static Task<ListProductDetailsResult> InvokeAsync(ListProductDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListProductDetailsResult>("azure-native:azurestack/v20220601:listProductDetails", args ?? new ListProductDetailsArgs(), options.WithDefaults());

        /// <summary>
        /// Extended description about the product required for installing it into Azure Stack.
        /// </summary>
        public static Output<ListProductDetailsResult> Invoke(ListProductDetailsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListProductDetailsResult>("azure-native:azurestack/v20220601:listProductDetails", args ?? new ListProductDetailsInvokeArgs(), options.WithDefaults());
    }
