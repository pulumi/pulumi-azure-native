...
namespace Pulumi.AzureNative.AzureStack.V20220601
{
    ...
    /// {
    ///     var registration = new AzureNative.AzureStack.V20220601.Registration("registration", new()
    ///     {
    ///         Location = "global",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestack/v20220601:Registration")]
    public partial class Registration : global::Pulumi.CustomResource
    {
        ...
        public Registration(string name, RegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestack/v20220601:Registration", name, args ?? new RegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestack/v20220601:Registration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegistrationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("location")]
        public InputUnion<string, Pulumi.AzureNative.AzureStack.V20220601.Location>? Location { get; set; }
