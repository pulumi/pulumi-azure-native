...
namespace Pulumi.AzureNative.AzureStack.V20220601
{
    ...
    /// {
    ///     var customerSubscription = new AzureNative.AzureStack.V20220601.CustomerSubscription("customerSubscription", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurestack/v20220601:CustomerSubscription")]
    public partial class CustomerSubscription : global::Pulumi.CustomResource
    {
        ...
        public CustomerSubscription(string name, CustomerSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestack/v20220601:CustomerSubscription", name, args ?? new CustomerSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomerSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestack/v20220601:CustomerSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
