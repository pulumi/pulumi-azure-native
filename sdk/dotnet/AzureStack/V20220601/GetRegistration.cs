...
namespace Pulumi.AzureNative.AzureStack.V20220601
{
    public static class GetRegistration
    {
        ...
        public static Task<GetRegistrationResult> InvokeAsync(GetRegistrationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegistrationResult>("azure-native:azurestack/v20220601:getRegistration", args ?? new GetRegistrationArgs(), options.WithDefaults());

        /// <summary>
        /// Registration information.
        /// </summary>
        public static Output<GetRegistrationResult> Invoke(GetRegistrationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegistrationResult>("azure-native:azurestack/v20220601:getRegistration", args ?? new GetRegistrationInvokeArgs(), options.WithDefaults());
    }
