...
namespace Pulumi.AzureNative.AzureStack.V20220601
{
    public static class GetProduct
    {
        ...
        public static Task<GetProductResult> InvokeAsync(GetProductArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductResult>("azure-native:azurestack/v20220601:getProduct", args ?? new GetProductArgs(), options.WithDefaults());

        /// <summary>
        /// Product information.
        /// </summary>
        public static Output<GetProductResult> Invoke(GetProductInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProductResult>("azure-native:azurestack/v20220601:getProduct", args ?? new GetProductInvokeArgs(), options.WithDefaults());
    }
