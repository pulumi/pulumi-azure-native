...
namespace Pulumi.AzureRM.AzureStack.V20170601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var customerSubscription = new AzureRM.AzureStack.V20170601.CustomerSubscription("customerSubscription", new AzureRM.AzureStack.V20170601.CustomerSubscriptionArgs
    ///         {
    ...
    public partial class CustomerSubscription : Pulumi.CustomResource
    {
        ...
        public CustomerSubscription(string name, CustomerSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azurestack/v20170601:CustomerSubscription", name, args ?? new CustomerSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomerSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azurestack/v20170601:CustomerSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
