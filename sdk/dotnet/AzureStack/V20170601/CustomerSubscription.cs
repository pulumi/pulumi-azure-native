...
namespace Pulumi.AzureNative.AzureStack.V20170601
{
    ...
    /// {
    ///     var customerSubscription = new AzureNative.AzureStack.V20170601.CustomerSubscription("customerSubscription", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:azurestack/v20170601:CustomerSubscription myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.AzureStack/registrations/{registrationName}/customerSubscriptions/{customerSubscriptionName} 
    /// ```
    /// </summary>
