...
namespace Pulumi.AzureNative.AzureStack.V20170601
{
    ...
    /// {
    ///     var registration = new AzureNative.AzureStack.V20170601.Registration("registration", new()
    ///     {
    ///         Location = "global",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:azurestack/v20170601:Registration testregistration /subscriptions/dd8597b4-8739-4467-8b10-f8679f62bfbf/resourceGroups/azurestack/providers/Microsoft.AzureStack/registrations/testregistration 
    /// ```
    /// </summary>
    ...
    public partial class Registration : global::Pulumi.CustomResource
    {
        ...
        public Registration(string name, RegistrationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurestack/v20170601:Registration", name, args ?? new RegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurestack/v20170601:Registration", name, null, MakeResourceOptions(options, id))
        {
        }
