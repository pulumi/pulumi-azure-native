...
namespace Pulumi.AzureNative.AzureStack.V20160101
{
    public static class GetProducts
    {
        ...
        public static Task<GetProductsResult> InvokeAsync(GetProductsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductsResult>("azure-native:azurestack/v20160101:getProducts", args ?? new GetProductsArgs(), options.WithDefaults());

        /// <summary>
        /// Pageable list of products.
        /// </summary>
        public static Output<GetProductsResult> Invoke(GetProductsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProductsResult>("azure-native:azurestack/v20160101:getProducts", args ?? new GetProductsInvokeArgs(), options.WithDefaults());
    }
