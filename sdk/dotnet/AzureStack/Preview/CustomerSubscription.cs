...
namespace Pulumi.AzureRM.AzureStack.Preview
{
    /// <summary>
    ...
    public partial class CustomerSubscription : Pulumi.CustomResource
    {
        ...
        public CustomerSubscription(string name, CustomerSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azurestack/preview:CustomerSubscription", name, args ?? new CustomerSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomerSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azurestack/preview:CustomerSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
