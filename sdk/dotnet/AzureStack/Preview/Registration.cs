...
namespace Pulumi.AzureRM.AzureStack.Preview
{
    ...
    public partial class Registration : Pulumi.CustomResource
    {
        ...
        public Registration(string name, RegistrationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:azurestack/preview:Registration", name, args ?? new RegistrationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:azurestack/preview:Registration", name, null, MakeResourceOptions(options, id))
        {
        }
