...
namespace Pulumi.AzureRM.AzureStack.Preview
{
    public static class GetRegistration
    {
        public static Task<GetRegistrationResult> InvokeAsync(GetRegistrationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegistrationResult>("azurerm:azurestack/preview:getRegistration", args ?? new GetRegistrationArgs(), options.WithVersion());
    }
