...
namespace Pulumi.AzureRM.AzureStack.Preview
{
    public static class ListProductDetails
    {
        public static Task<ListProductDetailsResult> InvokeAsync(ListProductDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListProductDetailsResult>("azurerm:azurestack/preview:listProductDetails", args ?? new ListProductDetailsArgs(), options.WithVersion());
    }
