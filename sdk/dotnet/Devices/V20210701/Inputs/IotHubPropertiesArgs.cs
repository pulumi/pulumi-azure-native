...
namespace Pulumi.AzureNative.Devices.V20210701.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210701.Capabilities>? Features { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210701.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
