...
namespace Pulumi.AzureNative.Devices.V20210701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20210701:IotHubResource")]
    public partial class IotHubResource : Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210701:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210701:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
