...
namespace Pulumi.AzureNative.Devices.V20210701
{
    /// <summary>
    /// The private endpoint connection of an IotHub
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20210701:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210701:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210701:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20200831:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20200831preview:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20200831preview:PrivateEndpointConnection"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210303preview:PrivateEndpointConnection"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210702:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210702preview:PrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210702preview:PrivateEndpointConnection"},
                },
            };
