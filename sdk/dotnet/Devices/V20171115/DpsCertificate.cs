...
namespace Pulumi.AzureRM.Devices.V20171115
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dpsCertificate = new AzureRM.Devices.V20171115.DpsCertificate("dpsCertificate", new AzureRM.Devices.V20171115.DpsCertificateArgs
    ///         {
    ///             Certificate = "############################################",
    ...
    public partial class DpsCertificate : Pulumi.CustomResource
    {
        ...
        public DpsCertificate(string name, DpsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20171115:DpsCertificate", name, args ?? new DpsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DpsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20171115:DpsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
