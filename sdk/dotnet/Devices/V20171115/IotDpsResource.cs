...
namespace Pulumi.AzureRM.Devices.V20171115
{
    ...
    ///     public MyStack()
    ///     {
    ///         var iotDpsResource = new AzureRM.Devices.V20171115.IotDpsResource("iotDpsResource", new AzureRM.Devices.V20171115.IotDpsResourceArgs
    ///         {
    ///             Location = "East US",
    ///             ProvisioningServiceName = "myFirstProvisioningService",
    ///             ResourceGroupName = "myResourceGroup",
    ///             Sku = new AzureRM.Devices.V20171115.Inputs.IotDpsSkuInfoArgs
    ///             {
    ///                 Capacity = 1,
    ///                 Name = "S1",
    ///             },
    ...
    public partial class IotDpsResource : Pulumi.CustomResource
    {
        ...
        public IotDpsResource(string name, IotDpsResourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20171115:IotDpsResource", name, args ?? new IotDpsResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20171115:IotDpsResource", name, null, MakeResourceOptions(options, id))
        {
        }
