...
namespace Pulumi.AzureNative.Devices.V20221115Preview
{
    ...
    /// {
    ///     var iotHubResourceEventHubConsumerGroup = new AzureNative.Devices.V20221115Preview.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup", new()
    ///     {
    ///         EventHubEndpointName = "events",
    ///         Name = "test",
    ///         Properties = new AzureNative.Devices.V20221115Preview.Inputs.EventHubConsumerGroupNameArgs
    ///         {
    ///             Name = "test",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20221115preview:IotHubResourceEventHubConsumerGroup")]
    public partial class IotHubResourceEventHubConsumerGroup : global::Pulumi.CustomResource
    {
        ...
        public IotHubResourceEventHubConsumerGroup(string name, IotHubResourceEventHubConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20221115preview:IotHubResourceEventHubConsumerGroup", name, args ?? new IotHubResourceEventHubConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResourceEventHubConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20221115preview:IotHubResourceEventHubConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
