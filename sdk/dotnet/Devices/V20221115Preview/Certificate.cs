...
namespace Pulumi.AzureNative.Devices.V20221115Preview
{
    ...
    /// {
    ///     var certificate = new AzureNative.Devices.V20221115Preview.Certificate("certificate", new()
    ///     {
    ///         CertificateName = "cert",
    ///         Properties = new AzureNative.Devices.V20221115Preview.Inputs.CertificatePropertiesArgs
    ///         {
    ///             Certificate = "############################################",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20221115preview:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20221115preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20221115preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
