...
namespace Pulumi.AzureNative.Devices.V20221115Preview.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20221115Preview.Capabilities>? Features { get; set; }
        ...
        /// </summary>
        [Input("ipVersion")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20221115Preview.IpVersion>? IpVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20221115Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
