...
namespace Pulumi.AzureNextGen.Devices.V20190322Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devices/v20190322preview:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20190322preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20190322preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
