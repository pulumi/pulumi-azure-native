...
namespace Pulumi.AzureNextGen.Devices.Latest
{
    ...
    public partial class IotHubResource : Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/latest:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/latest:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
