...
namespace Pulumi.AzureNative.Devices.V20210201Preview.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210201Preview.Capabilities>? Features { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210201Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
