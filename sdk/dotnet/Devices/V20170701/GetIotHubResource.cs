...
namespace Pulumi.AzureNextGen.Devices.V20170701
{
    public static class GetIotHubResource
    {
        public static Task<GetIotHubResourceResult> InvokeAsync(GetIotHubResourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotHubResourceResult>("azure-nextgen:devices/v20170701:getIotHubResource", args ?? new GetIotHubResourceArgs(), options.WithVersion());
    }
