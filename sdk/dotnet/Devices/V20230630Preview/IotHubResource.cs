...
namespace Pulumi.AzureNative.Devices.V20230630Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20230630preview:IotHubResource")]
    public partial class IotHubResource : global::Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20230630preview:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20230630preview:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
