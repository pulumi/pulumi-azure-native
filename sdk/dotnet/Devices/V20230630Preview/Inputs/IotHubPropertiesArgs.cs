...
namespace Pulumi.AzureNative.Devices.V20230630Preview.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20230630Preview.Capabilities>? Features { get; set; }
        ...
        /// </summary>
        [Input("ipVersion")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20230630Preview.IpVersion>? IpVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20230630Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
