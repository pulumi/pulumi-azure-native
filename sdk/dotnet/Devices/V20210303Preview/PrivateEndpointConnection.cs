...
namespace Pulumi.AzureNative.Devices.V20210303Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20210303preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210303preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210303preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
