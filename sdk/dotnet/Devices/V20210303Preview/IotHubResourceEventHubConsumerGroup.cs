...
namespace Pulumi.AzureNative.Devices.V20210303Preview
{
    ...
    /// {
    ///     var iotHubResourceEventHubConsumerGroup = new AzureNative.Devices.V20210303Preview.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup", new()
    ///     {
    ///         EventHubEndpointName = "events",
    ///         Name = "test",
    ///         Properties = new AzureNative.Devices.V20210303Preview.Inputs.EventHubConsumerGroupNameArgs
    ///         {
    ///             Name = "test",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:devices/v20210303preview:IotHubResourceEventHubConsumerGroup test /subscriptions/cmd-sub-1/resourceGroups/cmd-rg-1/providers/Microsoft.Devices/IotHubs/test-hub-2/eventHubEndpoints/events/ConsumerGroups/%24Default 
    /// ```
    /// </summary>
