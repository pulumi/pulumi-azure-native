...
namespace Pulumi.AzureNative.Devices.V20210303Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20210303preview:IotHubResourceEventHubConsumerGroup")]
    public partial class IotHubResourceEventHubConsumerGroup : Pulumi.CustomResource
    {
        ...
        public IotHubResourceEventHubConsumerGroup(string name, IotHubResourceEventHubConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210303preview:IotHubResourceEventHubConsumerGroup", name, args ?? new IotHubResourceEventHubConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResourceEventHubConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210303preview:IotHubResourceEventHubConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210303preview:IotHubResourceEventHubConsumerGroup"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:devices/v20190701preview:IotHubResourceEventHubConsumerGroup"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210201preview:IotHubResourceEventHubConsumerGroup"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210331:IotHubResourceEventHubConsumerGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210331:IotHubResourceEventHubConsumerGroup"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210701:IotHubResourceEventHubConsumerGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210701:IotHubResourceEventHubConsumerGroup"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210701preview:IotHubResourceEventHubConsumerGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210701preview:IotHubResourceEventHubConsumerGroup"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210901preview:IotHubResourceEventHubConsumerGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210901preview:IotHubResourceEventHubConsumerGroup"},
                },
            };
