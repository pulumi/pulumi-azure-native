...
namespace Pulumi.AzureNative.Devices.V20210901Preview
{
    public static class GetIotHubResource
    {
        ...
        public static Task<GetIotHubResourceResult> InvokeAsync(GetIotHubResourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotHubResourceResult>("azure-native:devices/v20210901preview:getIotHubResource", args ?? new GetIotHubResourceArgs(), options.WithVersion());
    }
