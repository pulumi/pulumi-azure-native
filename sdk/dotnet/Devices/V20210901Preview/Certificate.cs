...
namespace Pulumi.AzureNative.Devices.V20210901Preview
{
    /// <summary>
    /// The X509 Certificate.
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20210901preview:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210901preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210901preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
