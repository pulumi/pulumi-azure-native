...
namespace Pulumi.AzureNative.Devices.V20210901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20210901preview:IotHubResourceEventHubConsumerGroup")]
    public partial class IotHubResourceEventHubConsumerGroup : Pulumi.CustomResource
    {
        ...
        public IotHubResourceEventHubConsumerGroup(string name, IotHubResourceEventHubConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210901preview:IotHubResourceEventHubConsumerGroup", name, args ?? new IotHubResourceEventHubConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResourceEventHubConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210901preview:IotHubResourceEventHubConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
