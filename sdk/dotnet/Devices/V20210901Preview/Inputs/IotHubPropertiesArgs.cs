...
namespace Pulumi.AzureNative.Devices.V20210901Preview.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210901Preview.Capabilities>? Features { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210901Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
