...
namespace Pulumi.AzureNative.Devices.V20210901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20210901preview:IotHubResource")]
    public partial class IotHubResource : Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210901preview:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20210901preview:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
