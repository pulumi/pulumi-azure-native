...
namespace Pulumi.AzureNative.Devices.V20230301Preview
{
    ...
    public partial class IotDpsResource : global::Pulumi.CustomResource
    {
        ...
        public IotDpsResource(string name, IotDpsResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20230301preview:IotDpsResource", name, args ?? new IotDpsResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20230301preview:IotDpsResource", name, null, MakeResourceOptions(options, id))
        {
        }
