...
namespace Pulumi.AzureNative.Devices.V20230301Preview
{
    public static class GetDpsCertificate
    {
        ...
        public static Task<GetDpsCertificateResult> InvokeAsync(GetDpsCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDpsCertificateResult>("azure-native:devices/v20230301preview:getDpsCertificate", args ?? new GetDpsCertificateArgs(), options.WithDefaults());

        /// <summary>
        /// Get the certificate from the provisioning service.
        /// </summary>
        public static Output<GetDpsCertificateResult> Invoke(GetDpsCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDpsCertificateResult>("azure-native:devices/v20230301preview:getDpsCertificate", args ?? new GetDpsCertificateInvokeArgs(), options.WithDefaults());
