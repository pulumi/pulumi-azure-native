...
namespace Pulumi.AzureNative.Devices.V20230301Preview
{
    ...
    /// {
    ///     var dpsCertificate = new AzureNative.Devices.V20230301Preview.DpsCertificate("dpsCertificate", new()
    ///     {
    ///         CertificateName = "cert",
    ///         Properties = new AzureNative.Devices.V20230301Preview.Inputs.CertificatePropertiesArgs
    ///         {
    ///             Certificate = "MA==",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:devices/v20230301preview:DpsCertificate cert /subscriptions/91d12660-3dec-467a-be2a-213b5544ddc0/resourceGroups/myResourceGroup/providers/Microsoft.Devices/ProvisioningServives/myFirstProvisioningService/certificates/cert 
    /// ```
    /// </summary>
