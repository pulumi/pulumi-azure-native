...
namespace Pulumi.AzureNative.Devices.V20230301Preview
{
    ...
    /// {
    ///     var iotDpsResourcePrivateEndpointConnection = new AzureNative.Devices.V20230301Preview.IotDpsResourcePrivateEndpointConnection("iotDpsResourcePrivateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "myPrivateEndpointConnection",
    ///         Properties = new AzureNative.Devices.V20230301Preview.Inputs.PrivateEndpointConnectionPropertiesArgs
    ///         {
    ///             PrivateLinkServiceConnectionState = new AzureNative.Devices.V20230301Preview.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20230301preview:IotDpsResourcePrivateEndpointConnection")]
    public partial class IotDpsResourcePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public IotDpsResourcePrivateEndpointConnection(string name, IotDpsResourcePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20230301preview:IotDpsResourcePrivateEndpointConnection", name, args ?? new IotDpsResourcePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResourcePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20230301preview:IotDpsResourcePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
