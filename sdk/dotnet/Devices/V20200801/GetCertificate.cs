...
namespace Pulumi.AzureNextGen.Devices.V20200801
{
    public static class GetCertificate
    {
        public static Task<GetCertificateResult> InvokeAsync(GetCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCertificateResult>("azure-nextgen:devices/v20200801:getCertificate", args ?? new GetCertificateArgs(), options.WithVersion());
    }
