...
namespace Pulumi.AzureNative.Devices.V20220205
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20220205:DpsCertificate")]
    public partial class DpsCertificate : global::Pulumi.CustomResource
    {
        ...
        public DpsCertificate(string name, DpsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20220205:DpsCertificate", name, args ?? new DpsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DpsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20220205:DpsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
