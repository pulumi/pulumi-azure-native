...
namespace Pulumi.AzureNative.Devices.V20220205
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20220205:IotDpsResource")]
    public partial class IotDpsResource : global::Pulumi.CustomResource
    {
        ...
        public IotDpsResource(string name, IotDpsResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20220205:IotDpsResource", name, args ?? new IotDpsResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20220205:IotDpsResource", name, null, MakeResourceOptions(options, id))
        {
        }
