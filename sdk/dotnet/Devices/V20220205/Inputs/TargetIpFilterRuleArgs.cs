...
namespace Pulumi.AzureNative.Devices.V20220205.Inputs
{
    ...
    public sealed class TargetIpFilterRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Devices.V20220205.IpFilterActionType> Action { get; set; } = null!;
        ...
        /// </summary>
        [Input("target")]
        public Input<Pulumi.AzureNative.Devices.V20220205.IpFilterTargetType>? Target { get; set; }
