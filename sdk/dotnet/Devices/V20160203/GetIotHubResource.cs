...
namespace Pulumi.AzureNative.Devices.V20160203
{
    ...
    public static class GetIotHubResource
    {
        ...
        public static Task<GetIotHubResourceResult> InvokeAsync(GetIotHubResourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotHubResourceResult>("azure-native:devices/v20160203:getIotHubResource", args ?? new GetIotHubResourceArgs(), options.WithDefaults());

        /// <summary>
        /// The description of the IoT hub.
        /// </summary>
        public static Output<GetIotHubResourceResult> Invoke(GetIotHubResourceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIotHubResourceResult>("azure-native:devices/v20160203:getIotHubResource", args ?? new GetIotHubResourceInvokeArgs(), options.WithDefaults());
    }
