...
namespace Pulumi.AzureNative.Devices.V20230630
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20230630:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20230630:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20230630:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
