...
namespace Pulumi.AzureNative.Devices.V20200831
{
    ...
    /// {
    ///     var certificate = new AzureNative.Devices.V20200831.Certificate("certificate", new()
    ///     {
    ///         CertificateName = "cert",
    ///         Properties = new AzureNative.Devices.V20200831.Inputs.CertificatePropertiesArgs
    ///         {
    ///             Certificate = "############################################",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:devices/v20200831:Certificate cert /subscriptions/91d12660-3dec-467a-be2a-213b5544ddc0/resourceGroups/myResourceGroup/providers/Microsoft.Devices/ProvisioningServives/myFirstProvisioningService/certificates/cert 
    /// ```
    /// </summary>
