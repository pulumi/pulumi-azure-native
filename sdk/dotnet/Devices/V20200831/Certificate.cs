...
namespace Pulumi.AzureNative.Devices.V20200831
{
    /// <summary>
    /// The X509 Certificate.
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20200831:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200831:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200831:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210201preview:Certificate"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210303preview:Certificate"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210303preview:Certificate"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210331:Certificate"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210331:Certificate"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210701:Certificate"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210701:Certificate"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210701preview:Certificate"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210701preview:Certificate"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210901preview:Certificate"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210901preview:Certificate"},
                },
            };
