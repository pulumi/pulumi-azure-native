...
namespace Pulumi.AzureNextGen.Devices.V20200831
{
    /// <summary>
    /// The X509 Certificate.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devices/v20200831:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20200831:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20200831:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
