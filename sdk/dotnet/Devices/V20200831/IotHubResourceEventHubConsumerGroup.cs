...
namespace Pulumi.AzureNative.Devices.V20200831
{
    ...
    /// {
    ///     var iotHubResourceEventHubConsumerGroup = new AzureNative.Devices.V20200831.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup", new()
    ///     {
    ///         EventHubEndpointName = "events",
    ///         Name = "test",
    ///         Properties = new AzureNative.Devices.V20200831.Inputs.EventHubConsumerGroupNameArgs
    ///         {
    ///             Name = "test",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20200831:IotHubResourceEventHubConsumerGroup")]
    public partial class IotHubResourceEventHubConsumerGroup : global::Pulumi.CustomResource
    {
        ...
        public IotHubResourceEventHubConsumerGroup(string name, IotHubResourceEventHubConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200831:IotHubResourceEventHubConsumerGroup", name, args ?? new IotHubResourceEventHubConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResourceEventHubConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200831:IotHubResourceEventHubConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
