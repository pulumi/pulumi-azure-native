...
namespace Pulumi.AzureNative.Devices.V20190322
{
    ...
    [AzureNativeResourceType("azure-native:devices/v20190322:IotHubResource")]
    public partial class IotHubResource : global::Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20190322:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20190322:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
