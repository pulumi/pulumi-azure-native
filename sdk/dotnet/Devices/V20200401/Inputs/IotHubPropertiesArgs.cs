...
namespace Pulumi.AzureNextGen.Devices.V20200401.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNextGen.Devices.V20200401.Capabilities>? Features { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Devices.V20200401.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
