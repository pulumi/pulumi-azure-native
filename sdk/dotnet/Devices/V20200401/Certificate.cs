...
namespace Pulumi.AzureNative.Devices.V20200401
{
    ...
    /// {
    ///     var certificate = new AzureNative.Devices.V20200401.Certificate("certificate", new()
    ///     {
    ///         Certificate = "############################################",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20200401:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200401:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200401:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
