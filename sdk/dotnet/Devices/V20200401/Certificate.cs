...
namespace Pulumi.AzureRM.Devices.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var certificate = new AzureRM.Devices.V20200401.Certificate("certificate", new AzureRM.Devices.V20200401.CertificateArgs
    ///         {
    ///             Certificate = "############################################",
    ...
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200401:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200401:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
