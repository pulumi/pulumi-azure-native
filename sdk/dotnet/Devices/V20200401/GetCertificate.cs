...
namespace Pulumi.AzureNextGen.Devices.V20200401
{
    public static class GetCertificate
    {
        public static Task<GetCertificateResult> InvokeAsync(GetCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCertificateResult>("azure-nextgen:devices/v20200401:getCertificate", args ?? new GetCertificateArgs(), options.WithVersion());
    }
