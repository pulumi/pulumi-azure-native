...
namespace Pulumi.AzureNextGen.Devices.V20200301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devices/v20200301:IotDpsResource")]
    public partial class IotDpsResource : Pulumi.CustomResource
    {
        ...
        public IotDpsResource(string name, IotDpsResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20200301:IotDpsResource", name, args ?? new IotDpsResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20200301:IotDpsResource", name, null, MakeResourceOptions(options, id))
        {
        }
