...
namespace Pulumi.AzureRM.Devices.V20200301
{
    public static class GetDpsCertificate
    {
        public static Task<GetDpsCertificateResult> InvokeAsync(GetDpsCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDpsCertificateResult>("azurerm:devices/v20200301:getDpsCertificate", args ?? new GetDpsCertificateArgs(), options.WithVersion());
    }
