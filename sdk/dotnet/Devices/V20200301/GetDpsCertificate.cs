...
{
    [Obsolete(@"azure-native:devices/v20200301:DpsCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20211015:DpsCertificate to guarantee forwards compatibility.")]
    public static class GetDpsCertificate
    {
        ...
        public static Task<GetDpsCertificateResult> InvokeAsync(GetDpsCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDpsCertificateResult>("azure-native:devices/v20200301:getDpsCertificate", args ?? new GetDpsCertificateArgs(), options.WithDefaults());

        /// <summary>
        /// Get the certificate from the provisioning service.
        /// </summary>
        public static Output<GetDpsCertificateResult> Invoke(GetDpsCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDpsCertificateResult>("azure-native:devices/v20200301:getDpsCertificate", args ?? new GetDpsCertificateInvokeArgs(), options.WithDefaults());
    }
