...
namespace Pulumi.AzureNative.Devices.V20200301
{
    public static class GetDpsCertificate
    {
        ...
        public static Task<GetDpsCertificateResult> InvokeAsync(GetDpsCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDpsCertificateResult>("azure-native:devices/v20200301:getDpsCertificate", args ?? new GetDpsCertificateArgs(), options.WithDefaults());

        /// <summary>
        /// The X509 Certificate.
        /// </summary>
        public static Output<GetDpsCertificateResult> Invoke(GetDpsCertificateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDpsCertificateResult>("azure-native:devices/v20200301:getDpsCertificate", args ?? new GetDpsCertificateInvokeArgs(), options.WithDefaults());
    }
