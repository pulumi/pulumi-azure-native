...
{
    [Obsolete(@"azure-native:devices/v20200301:IotDpsResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20200901preview:IotDpsResource to guarantee forwards compatibility.")]
    public static class GetIotDpsResource
    {
        ...
        public static Task<GetIotDpsResourceResult> InvokeAsync(GetIotDpsResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIotDpsResourceResult>("azure-native:devices/v20200301:getIotDpsResource", args ?? new GetIotDpsResourceArgs(), options.WithDefaults());

        /// <summary>
        /// Get the metadata of the provisioning service without SAS keys.
        /// </summary>
        public static Output<GetIotDpsResourceResult> Invoke(GetIotDpsResourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIotDpsResourceResult>("azure-native:devices/v20200301:getIotDpsResource", args ?? new GetIotDpsResourceInvokeArgs(), options.WithDefaults());
    }
