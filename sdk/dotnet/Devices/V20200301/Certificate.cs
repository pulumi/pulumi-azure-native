...
namespace Pulumi.AzureNextGen.Devices.V20200301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devices/v20200301:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20200301:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20200301:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
