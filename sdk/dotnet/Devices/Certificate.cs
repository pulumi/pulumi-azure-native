...
namespace Pulumi.AzureNextGen.Devices
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devices:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
