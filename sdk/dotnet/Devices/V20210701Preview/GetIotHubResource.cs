...
{
    [Obsolete(@"azure-native:devices/v20210701preview:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:IotHubResource to guarantee forwards compatibility.")]
    public static class GetIotHubResource
    {
        ...
        public static Task<GetIotHubResourceResult> InvokeAsync(GetIotHubResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIotHubResourceResult>("azure-native:devices/v20210701preview:getIotHubResource", args ?? new GetIotHubResourceArgs(), options.WithDefaults());

        /// <summary>
        /// Get the non-security related metadata of an IoT hub.
        /// </summary>
        public static Output<GetIotHubResourceResult> Invoke(GetIotHubResourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIotHubResourceResult>("azure-native:devices/v20210701preview:getIotHubResource", args ?? new GetIotHubResourceInvokeArgs(), options.WithDefaults());
    }
