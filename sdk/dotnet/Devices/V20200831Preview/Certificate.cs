...
namespace Pulumi.AzureNative.Devices.V20200831Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20200831preview:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200831preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200831preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
