...
namespace Pulumi.AzureNextGen.Devices.V20200831Preview.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNextGen.Devices.V20200831Preview.Capabilities>? Features { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Devices.V20200831Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
