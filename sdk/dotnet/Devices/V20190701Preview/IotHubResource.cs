...
namespace Pulumi.AzureNextGen.Devices.V20190701Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devices/v20190701preview:IotHubResource")]
    public partial class IotHubResource : Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20190701preview:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20190701preview:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
