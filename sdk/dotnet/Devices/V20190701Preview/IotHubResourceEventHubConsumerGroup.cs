...
namespace Pulumi.AzureRM.Devices.V20190701Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var iotHubResourceEventHubConsumerGroup = new AzureRM.Devices.V20190701Preview.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup", new AzureRM.Devices.V20190701Preview.IotHubResourceEventHubConsumerGroupArgs
    ///         {
    ...
    public partial class IotHubResourceEventHubConsumerGroup : Pulumi.CustomResource
    {
        ...
        public IotHubResourceEventHubConsumerGroup(string name, IotHubResourceEventHubConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20190701preview:IotHubResourceEventHubConsumerGroup", name, args ?? new IotHubResourceEventHubConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResourceEventHubConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20190701preview:IotHubResourceEventHubConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
