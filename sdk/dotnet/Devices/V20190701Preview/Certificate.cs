...
namespace Pulumi.AzureNative.Devices.V20190701Preview
{
    ...
    [AzureNativeResourceType("azure-native:devices/v20190701preview:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20190701preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20190701preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
