...
namespace Pulumi.AzureNative.Devices.V20170119
{
    ...
    [AzureNativeResourceType("azure-native:devices/v20170119:IotHubResource")]
    public partial class IotHubResource : global::Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20170119:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20170119:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
