...
namespace Pulumi.AzureRM.Devices
{
    ...
    public partial class IotHub : Pulumi.CustomResource
    {
        ...
        public IotHub(string name, IotHubArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices:IotHub", name, args ?? new IotHubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHub(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices:IotHub", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IotHub Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new IotHub(name, id, options);
        }
    }
