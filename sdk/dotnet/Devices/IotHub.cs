...
namespace Pulumi.AzureRM.Devices
{
    ...
    public partial class IotHub : Pulumi.CustomResource
    {
        ...
        private IotHub(string name, Input<string> id, IotHubState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:devices:IotHub", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IotHubState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.IotHubPropertiesResponseGetArgs> Properties { get; set; } = null!;

        /// <summary>
        /// IotHub SKU info
        /// </summary>
        [Input("sku", required: true)]
        public Input<Inputs.IotHubSkuInfoResponseGetArgs> Sku { get; set; } = null!;
