...
namespace Pulumi.AzureNextGen.Devices.V20181201Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct IotHubReplicaRoleType : IEquatable<IotHubReplicaRoleType>
    {
        private readonly string _value;

        private IotHubReplicaRoleType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static IotHubReplicaRoleType Primary { get; } = new IotHubReplicaRoleType("primary");
        public static IotHubReplicaRoleType Secondary { get; } = new IotHubReplicaRoleType("secondary");

        public static bool operator ==(IotHubReplicaRoleType left, IotHubReplicaRoleType right) => left.Equals(right);
        public static bool operator !=(IotHubReplicaRoleType left, IotHubReplicaRoleType right) => !left.Equals(right);

        public static explicit operator string(IotHubReplicaRoleType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is IotHubReplicaRoleType other && Equals(other);
        public bool Equals(IotHubReplicaRoleType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
