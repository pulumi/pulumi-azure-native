...
namespace Pulumi.AzureRM.Devices.V20181201Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var certificate = new AzureRM.Devices.V20181201Preview.Certificate("certificate", new AzureRM.Devices.V20181201Preview.CertificateArgs
    ///         {
    ///             Certificate = "############################################",
    ...
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20181201preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20181201preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
