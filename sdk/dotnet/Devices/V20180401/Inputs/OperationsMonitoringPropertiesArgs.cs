...
namespace Pulumi.AzureNextGen.Devices.V20180401.Inputs
{
    ...
    {
        [Input("events")]
        private InputMap<Union<string, Pulumi.AzureNextGen.Devices.V20180401.OperationMonitoringLevel>>? _events;
        public InputMap<Union<string, Pulumi.AzureNextGen.Devices.V20180401.OperationMonitoringLevel>> Events
        {
            get => _events ?? (_events = new InputMap<Union<string, Pulumi.AzureNextGen.Devices.V20180401.OperationMonitoringLevel>>());
            set => _events = value;
        }
