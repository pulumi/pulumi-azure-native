...
namespace Pulumi.AzureNative.Devices.V20180401
{
    /// <summary>
    /// The X509 Certificate.
    /// </summary>
    [Obsolete(@"Version v20180401 will be removed in the next major version of the provider. Upgrade to version v20200301 or later.")]
    [AzureNativeResourceType("azure-native:devices/v20180401:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20180401:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20180401:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
