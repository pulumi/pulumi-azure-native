...
namespace Pulumi.AzureNative.Devices.V20211015
{
    ...
    [AzureNativeResourceType("azure-native:devices/v20211015:IotDpsResource")]
    public partial class IotDpsResource : global::Pulumi.CustomResource
    {
        ...
        public IotDpsResource(string name, IotDpsResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20211015:IotDpsResource", name, args ?? new IotDpsResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20211015:IotDpsResource", name, null, MakeResourceOptions(options, id))
        {
        }
