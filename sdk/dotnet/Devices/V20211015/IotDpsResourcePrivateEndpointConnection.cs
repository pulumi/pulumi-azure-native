...
namespace Pulumi.AzureNative.Devices.V20211015
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20211015:IotDpsResourcePrivateEndpointConnection")]
    public partial class IotDpsResourcePrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public IotDpsResourcePrivateEndpointConnection(string name, IotDpsResourcePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20211015:IotDpsResourcePrivateEndpointConnection", name, args ?? new IotDpsResourcePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResourcePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20211015:IotDpsResourcePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
