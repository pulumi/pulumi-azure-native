...
namespace Pulumi.AzureNative.Devices.V20211015
{
    ...
    /// {
    ///     var dpsCertificate = new AzureNative.Devices.V20211015.DpsCertificate("dpsCertificate", new()
    ///     {
    ///         Certificate = "############################################",
    ...
    public partial class DpsCertificate : global::Pulumi.CustomResource
    {
        ...
        public DpsCertificate(string name, DpsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20211015:DpsCertificate", name, args ?? new DpsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DpsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20211015:DpsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
