...
namespace Pulumi.AzureNative.Devices.V20210702Preview.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210702Preview.Capabilities>? Features { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210702Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
