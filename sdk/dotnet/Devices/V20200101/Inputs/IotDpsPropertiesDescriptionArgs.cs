...
namespace Pulumi.AzureNative.Devices.V20200101.Inputs
{
    ...
    public sealed class IotDpsPropertiesDescriptionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20200101.AllocationPolicy>? AllocationPolicy { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20200101.State>? State { get; set; }
