...
namespace Pulumi.AzureNative.Devices.V20210331.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210331.Capabilities>? Features { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20210331.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
