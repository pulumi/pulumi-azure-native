...
namespace Pulumi.AzureNative.Devices.V20200615
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:devices/v20200615:IotHubResource is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20220430preview:IotHubResource to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:devices/v20200615:IotHubResource")]
    public partial class IotHubResource : global::Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200615:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200615:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
