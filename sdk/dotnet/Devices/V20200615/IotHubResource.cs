...
namespace Pulumi.AzureRM.Devices.V20200615
{
    ...
    ///     public MyStack()
    ///     {
    ///         var iotHubResource = new AzureRM.Devices.V20200615.IotHubResource("iotHubResource", new AzureRM.Devices.V20200615.IotHubResourceArgs
    ///         {
    ///             Etag = "AAAAAAFD6M4=",
    ///             Location = "centraluseuap",
    ///             ResourceGroupName = "myResourceGroup",
    ///             ResourceName = "testHub",
    ///             Sku = new AzureRM.Devices.V20200615.Inputs.IotHubSkuInfoArgs
    ///             {
    ///                 Capacity = 1,
    ///                 Name = "S1",
    ///             },
    ...
    public partial class IotHubResource : Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200615:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200615:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
