...
namespace Pulumi.AzureRM.Devices.V20200615
{
    ...
    ///     public MyStack()
    ///     {
    ///         var iotHubResourceEventHubConsumerGroup = new AzureRM.Devices.V20200615.IotHubResourceEventHubConsumerGroup("iotHubResourceEventHubConsumerGroup", new AzureRM.Devices.V20200615.IotHubResourceEventHubConsumerGroupArgs
    ///         {
    ...
    public partial class IotHubResourceEventHubConsumerGroup : Pulumi.CustomResource
    {
        ...
        public IotHubResourceEventHubConsumerGroup(string name, IotHubResourceEventHubConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200615:IotHubResourceEventHubConsumerGroup", name, args ?? new IotHubResourceEventHubConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResourceEventHubConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200615:IotHubResourceEventHubConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
