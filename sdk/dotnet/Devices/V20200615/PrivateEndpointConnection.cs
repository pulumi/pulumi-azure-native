...
namespace Pulumi.AzureRM.Devices.V20200615
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.Devices.V20200615.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.Devices.V20200615.PrivateEndpointConnectionArgs
    ///         {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200615:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200615:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
