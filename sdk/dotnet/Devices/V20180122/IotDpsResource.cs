...
namespace Pulumi.AzureRM.Devices.V20180122
{
    ...
    ///     public MyStack()
    ///     {
    ///         var iotDpsResource = new AzureRM.Devices.V20180122.IotDpsResource("iotDpsResource", new AzureRM.Devices.V20180122.IotDpsResourceArgs
    ///         {
    ///             Location = "East US",
    ///             ProvisioningServiceName = "myFirstProvisioningService",
    ///             ResourceGroupName = "myResourceGroup",
    ///             Sku = new AzureRM.Devices.V20180122.Inputs.IotDpsSkuInfoArgs
    ///             {
    ///                 Capacity = 1,
    ///                 Name = "S1",
    ///             },
    ...
    public partial class IotDpsResource : Pulumi.CustomResource
    {
        ...
        public IotDpsResource(string name, IotDpsResourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20180122:IotDpsResource", name, args ?? new IotDpsResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20180122:IotDpsResource", name, null, MakeResourceOptions(options, id))
        {
        }
