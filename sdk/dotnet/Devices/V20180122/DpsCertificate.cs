...
namespace Pulumi.AzureRM.Devices.V20180122
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dpsCertificate = new AzureRM.Devices.V20180122.DpsCertificate("dpsCertificate", new AzureRM.Devices.V20180122.DpsCertificateArgs
    ///         {
    ///             Certificate = "############################################",
    ...
    public partial class DpsCertificate : Pulumi.CustomResource
    {
        ...
        public DpsCertificate(string name, DpsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20180122:DpsCertificate", name, args ?? new DpsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DpsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20180122:DpsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:devices/latest:DpsCertificate"},
                    new Pulumi.Alias { Type = "azurerm:devices/v20170821preview:DpsCertificate"},
                    new Pulumi.Alias { Type = "azurerm:devices/v20171115:DpsCertificate"},
                    new Pulumi.Alias { Type = "azurerm:devices/v20200101:DpsCertificate"},
                    new Pulumi.Alias { Type = "azurerm:devices/v20200301:DpsCertificate"},
                    new Pulumi.Alias { Type = "azurerm:devices/v20200901preview:DpsCertificate"},
                },
            };
