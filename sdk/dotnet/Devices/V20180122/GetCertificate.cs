...
namespace Pulumi.AzureNextGen.Devices.V20180122
{
    public static class GetCertificate
    {
        public static Task<GetCertificateResult> InvokeAsync(GetCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCertificateResult>("azure-nextgen:devices/v20180122:getCertificate", args ?? new GetCertificateArgs(), options.WithVersion());
    }
