...
namespace Pulumi.AzureNative.Devices.V20180122
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20180122:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20180122:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20180122:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
