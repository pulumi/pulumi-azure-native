...
namespace Pulumi.AzureNative.Devices.V20180122
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20180122:IotHubResourceEventHubConsumerGroup")]
    public partial class IotHubResourceEventHubConsumerGroup : Pulumi.CustomResource
    {
        ...
        public IotHubResourceEventHubConsumerGroup(string name, IotHubResourceEventHubConsumerGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20180122:IotHubResourceEventHubConsumerGroup", name, args ?? new IotHubResourceEventHubConsumerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResourceEventHubConsumerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20180122:IotHubResourceEventHubConsumerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
