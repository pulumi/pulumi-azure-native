...
namespace Pulumi.AzureNative.Devices
{
    public static class GetIotHubResource
    {
        ...
        public static Output<GetIotHubResourceResult> Invoke(GetIotHubResourceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIotHubResourceResult>("azure-native:devices:getIotHubResource", args ?? new GetIotHubResourceInvokeArgs(), options.WithVersion());
    }
