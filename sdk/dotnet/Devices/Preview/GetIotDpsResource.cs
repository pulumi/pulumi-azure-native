...
namespace Pulumi.AzureRM.Devices.Preview
{
    public static class GetIotDpsResource
    {
        public static Task<GetIotDpsResourceResult> InvokeAsync(GetIotDpsResourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotDpsResourceResult>("azurerm:devices/preview:getIotDpsResource", args ?? new GetIotDpsResourceArgs(), options.WithVersion());
    }
