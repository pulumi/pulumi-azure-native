...
namespace Pulumi.AzureRM.Devices.V20170821Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dpsCertificate = new AzureRM.Devices.V20170821Preview.DpsCertificate("dpsCertificate", new AzureRM.Devices.V20170821Preview.DpsCertificateArgs
    ///         {
    ///             Certificate = "############################################",
    ...
    public partial class DpsCertificate : Pulumi.CustomResource
    {
        ...
        public DpsCertificate(string name, DpsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20170821preview:DpsCertificate", name, args ?? new DpsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DpsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20170821preview:DpsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
