...
azure-native:devices/v20170821preview:DpsCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:devices/v20211015:DpsCertificate to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:devices/v20170821preview:DpsCertificate")]
    public partial class DpsCertificate : global::Pulumi.CustomResource
    {
        ...
        public DpsCertificate(string name, DpsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20170821preview:DpsCertificate", name, args ?? new DpsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DpsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20170821preview:DpsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
