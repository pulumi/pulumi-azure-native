...
namespace Pulumi.AzureNative.Devices.V20170821Preview
{
    ...
    public partial class IotDpsResource : Pulumi.CustomResource
    {
        ...
        public IotDpsResource(string name, IotDpsResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20170821preview:IotDpsResource", name, args ?? new IotDpsResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20170821preview:IotDpsResource", name, null, MakeResourceOptions(options, id))
        {
        }
