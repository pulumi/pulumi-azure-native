...
namespace Pulumi.AzureNative.Devices.V20250201Preview
{
    public static class GetIotDpsResource
    {
        ...
        public static Task<GetIotDpsResourceResult> InvokeAsync(GetIotDpsResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIotDpsResourceResult>("azure-native:devices/v20250201preview:getIotDpsResource", args ?? new GetIotDpsResourceArgs(), options.WithDefaults());

        /// <summary>
        /// Get the metadata of the provisioning service without SAS keys.
        /// </summary>
        public static Output<GetIotDpsResourceResult> Invoke(GetIotDpsResourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIotDpsResourceResult>("azure-native:devices/v20250201preview:getIotDpsResource", args ?? new GetIotDpsResourceInvokeArgs(), options.WithDefaults());
    }
