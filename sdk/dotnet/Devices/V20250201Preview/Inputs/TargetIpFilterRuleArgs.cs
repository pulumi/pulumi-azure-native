...
namespace Pulumi.AzureNative.Devices.V20250201Preview.Inputs
{
    ...
    public sealed class TargetIpFilterRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Devices.V20250201Preview.IpFilterActionType> Action { get; set; } = null!;
        ...
        /// </summary>
        [Input("target")]
        public Input<Pulumi.AzureNative.Devices.V20250201Preview.IpFilterTargetType>? Target { get; set; }
