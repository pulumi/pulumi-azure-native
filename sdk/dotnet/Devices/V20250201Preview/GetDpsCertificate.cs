...
namespace Pulumi.AzureNative.Devices.V20250201Preview
{
    public static class GetDpsCertificate
    {
        ...
        public static Task<GetDpsCertificateResult> InvokeAsync(GetDpsCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDpsCertificateResult>("azure-native:devices/v20250201preview:getDpsCertificate", args ?? new GetDpsCertificateArgs(), options.WithDefaults());
