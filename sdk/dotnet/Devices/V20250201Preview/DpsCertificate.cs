...
namespace Pulumi.AzureNative.Devices.V20250201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20250201preview:DpsCertificate")]
    public partial class DpsCertificate : global::Pulumi.CustomResource
    {
        ...
        public DpsCertificate(string name, DpsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20250201preview:DpsCertificate", name, args ?? new DpsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DpsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20250201preview:DpsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
