...
namespace Pulumi.AzureNative.Devices.V20250201Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct IotHubAuthenticationType : IEquatable<IotHubAuthenticationType>
    {
        private readonly string _value;

        private IotHubAuthenticationType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static IotHubAuthenticationType KeyBased { get; } = new IotHubAuthenticationType("KeyBased");
        public static IotHubAuthenticationType UserAssigned { get; } = new IotHubAuthenticationType("UserAssigned");
        public static IotHubAuthenticationType SystemAssigned { get; } = new IotHubAuthenticationType("SystemAssigned");

        public static bool operator ==(IotHubAuthenticationType left, IotHubAuthenticationType right) => left.Equals(right);
        public static bool operator !=(IotHubAuthenticationType left, IotHubAuthenticationType right) => !left.Equals(right);

        public static explicit operator string(IotHubAuthenticationType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is IotHubAuthenticationType other && Equals(other);
        public bool Equals(IotHubAuthenticationType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
