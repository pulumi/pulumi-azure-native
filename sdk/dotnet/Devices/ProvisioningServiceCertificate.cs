...
namespace Pulumi.AzureRM.Devices
{
    ...
    public partial class ProvisioningServiceCertificate : Pulumi.CustomResource
    {
        ...
        private ProvisioningServiceCertificate(string name, Input<string> id, ProvisioningServiceCertificateState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:devices:ProvisioningServiceCertificate", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ProvisioningServiceCertificate Get(string name, Input<string> id, ProvisioningServiceCertificateState? state = null, CustomResourceOptions? options = null)
        {
            return new ProvisioningServiceCertificate(name, id, state, options);
        }
    }
    ...
    public sealed class ProvisioningServiceCertificateState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The entity tag.
        /// </summary>
        ...
        public ProvisioningServiceCertificateState()
        {
        }
    }
}
