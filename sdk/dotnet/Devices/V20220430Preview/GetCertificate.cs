...
{
    [Obsolete(@"azure-native:devices/v20220430preview:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:devices/v20221115preview:Certificate to guarantee forwards compatibility.")]
    public static class GetCertificate
    {
        ...
        public static Task<GetCertificateResult> InvokeAsync(GetCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificateResult>("azure-native:devices/v20220430preview:getCertificate", args ?? new GetCertificateArgs(), options.WithDefaults());
