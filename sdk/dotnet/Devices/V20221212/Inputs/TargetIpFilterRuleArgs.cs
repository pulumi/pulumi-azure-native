...
namespace Pulumi.AzureNative.Devices.V20221212.Inputs
{
    ...
    public sealed class TargetIpFilterRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Devices.V20221212.IpFilterActionType> Action { get; set; } = null!;
        ...
        /// </summary>
        [Input("target")]
        public Input<Pulumi.AzureNative.Devices.V20221212.IpFilterTargetType>? Target { get; set; }
