...
namespace Pulumi.AzureNative.Devices.V20221212
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:devices/v20221212:DpsCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:devices/v20230301preview:DpsCertificate to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:devices/v20221212:DpsCertificate")]
    public partial class DpsCertificate : global::Pulumi.CustomResource
    {
        ...
        public DpsCertificate(string name, DpsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20221212:DpsCertificate", name, args ?? new DpsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DpsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20221212:DpsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
