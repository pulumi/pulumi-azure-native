...
namespace Pulumi.AzureNative.Devices.V20200710Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devices/v20200710preview:IotHubResource")]
    public partial class IotHubResource : Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200710preview:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20200710preview:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210201preview:IotHubResource"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210303preview:IotHubResource"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210303preview:IotHubResource"},
                    new Pulumi.Alias { Type = "azure-native:devices/v20210331:IotHubResource"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210331:IotHubResource"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:devices/v20210901preview:IotHubResource"},
                    new Pulumi.Alias { Type = "azure-nextgen:devices/v20210901preview:IotHubResource"},
                },
            };
