...
namespace Pulumi.AzureRM.Devices.V20200710Preview
{
    public static class GetCertificate
    {
        public static Task<GetCertificateResult> InvokeAsync(GetCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCertificateResult>("azurerm:devices/v20200710preview:getCertificate", args ?? new GetCertificateArgs(), options.WithVersion());
    }
