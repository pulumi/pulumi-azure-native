...
namespace Pulumi.AzureRM.Devices.V20200710Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var certificate = new AzureRM.Devices.V20200710Preview.Certificate("certificate", new AzureRM.Devices.V20200710Preview.CertificateArgs
    ///         {
    ...
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200710preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20200710preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
