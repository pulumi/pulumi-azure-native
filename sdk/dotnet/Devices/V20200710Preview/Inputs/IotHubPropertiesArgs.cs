...
namespace Pulumi.AzureNextGen.Devices.V20200710Preview.Inputs
{
    ...
    public sealed class IotHubPropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("features")]
        public InputUnion<string, Pulumi.AzureNextGen.Devices.V20200710Preview.Capabilities>? Features { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Devices.V20200710Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
