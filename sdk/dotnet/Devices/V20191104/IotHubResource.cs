...
namespace Pulumi.AzureNative.Devices.V20191104
{
    ...
    /// </summary>
    [Obsolete(@"Version 2019-11-04 will be removed in v2 of the provider.
azure-native:devices/v20191104:IotHubResource is being removed in the next major version of this provider. Please upgrade to azure-native:devices/v20220430preview:IotHubResource to guarantee forwards compatibility.")]
    ...
    public partial class IotHubResource : global::Pulumi.CustomResource
    {
        ...
        public IotHubResource(string name, IotHubResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20191104:IotHubResource", name, args ?? new IotHubResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotHubResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devices/v20191104:IotHubResource", name, null, MakeResourceOptions(options, id))
        {
        }
