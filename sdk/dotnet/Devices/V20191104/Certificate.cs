...
namespace Pulumi.AzureRM.Devices.V20191104
{
    ...
    ///     public MyStack()
    ///     {
    ///         var certificate = new AzureRM.Devices.V20191104.Certificate("certificate", new AzureRM.Devices.V20191104.CertificateArgs
    ///         {
    ///             Certificate = "############################################",
    ...
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20191104:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devices/v20191104:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
