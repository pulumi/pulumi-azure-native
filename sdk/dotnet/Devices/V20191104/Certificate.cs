...
namespace Pulumi.AzureNextGen.Devices.V20191104
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devices/v20191104:Certificate")]
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20191104:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices/v20191104:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
