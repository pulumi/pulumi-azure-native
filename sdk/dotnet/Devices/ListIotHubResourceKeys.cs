...
namespace Pulumi.AzureRM.Devices
{
    public static class ListIotHubResourceKeys
    {
        public static Task<ListIotHubResourceKeysResult> InvokeAsync(ListIotHubResourceKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListIotHubResourceKeysResult>("azurerm:devices:listIotHubResourceKeys", args ?? new ListIotHubResourceKeysArgs(), options.WithVersion());
    }
