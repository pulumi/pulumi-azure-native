...
namespace Pulumi.AzureNative.Devices.V20200901Preview.Inputs
{
    ...
    public sealed class IotDpsPropertiesDescriptionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20200901Preview.AllocationPolicy>? AllocationPolicy { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Devices.V20200901Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }

        /// <summary>
        /// Current state of the provisioning service.
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.Devices.V20200901Preview.State>? State { get; set; }
