...
namespace Pulumi.AzureNextGen.Devices
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:devices:DpsCertificate")]
    public partial class DpsCertificate : Pulumi.CustomResource
    {
        ...
        public DpsCertificate(string name, DpsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices:DpsCertificate", name, args ?? new DpsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DpsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:devices:DpsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
