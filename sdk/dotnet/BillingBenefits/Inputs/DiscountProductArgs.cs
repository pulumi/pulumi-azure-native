...
namespace Pulumi.AzureNative.BillingBenefits.Inputs
{
    ...
    /// </summary>
    public sealed class DiscountProductArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public DiscountProductArgs()
        {
        }
        public static new DiscountProductArgs Empty => new DiscountProductArgs();
    }
}
