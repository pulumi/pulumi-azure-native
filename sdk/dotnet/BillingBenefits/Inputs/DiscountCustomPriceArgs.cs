...
namespace Pulumi.AzureNative.BillingBenefits.Inputs
{
    ...
    /// </summary>
    public sealed class DiscountCustomPriceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("customPriceProperties")]
        public Input<Inputs.CustomPricePropertiesArgs>? CustomPriceProperties { get; set; }
        ...
        public DiscountCustomPriceArgs()
        {
        }
        public static new DiscountCustomPriceArgs Empty => new DiscountCustomPriceArgs();
    }
}
