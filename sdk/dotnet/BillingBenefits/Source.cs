...
namespace Pulumi.AzureNative.BillingBenefits
{
    ...
    public partial class Source : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("credit")]
        public Output<Outputs.CommitmentResponse?> Credit { get; private set; } = null!;
        ...
        /// </summary>
        [Output("impactedBillingPeriod")]
        public Output<string?> ImpactedBillingPeriod { get; private set; } = null!;
        ...
        public Source(string name, SourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:billingbenefits:Source", name, args ?? new SourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Source(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:billingbenefits:Source", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:billingbenefits/v20250501preview:Source" },
                    new global::Pulumi.Alias { Type = "azure-native:billingbenefits/v20251201preview:Source" },
                    new global::Pulumi.Alias { Type = "azure-native:billingbenefits/v20260601:Source" },
                },
            };
    ...
    public sealed class SourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// The billing period of the impact for the resource. Format YYYYMM
        /// </summary>
        [Input("impactedBillingPeriod")]
        public Input<string>? ImpactedBillingPeriod { get; set; }
