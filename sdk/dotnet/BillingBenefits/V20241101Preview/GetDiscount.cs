...
namespace Pulumi.AzureNative.BillingBenefits.V20241101Preview
{
    public static class GetDiscount
    {
        ...
        public static Task<GetDiscountResult> InvokeAsync(GetDiscountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiscountResult>("azure-native:billingbenefits/v20241101preview:getDiscount", args ?? new GetDiscountArgs(), options.WithDefaults());

        /// <summary>
        /// Get discount at resource group level
        /// </summary>
        public static Output<GetDiscountResult> Invoke(GetDiscountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiscountResult>("azure-native:billingbenefits/v20241101preview:getDiscount", args ?? new GetDiscountInvokeArgs(), options.WithDefaults());
