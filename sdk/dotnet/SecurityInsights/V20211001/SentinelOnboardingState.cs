...
namespace Pulumi.AzureNative.SecurityInsights.V20211001
{
    ...
    public partial class SentinelOnboardingState : Pulumi.CustomResource
    {
        ...
        public SentinelOnboardingState(string name, SentinelOnboardingStateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001:SentinelOnboardingState", name, args ?? new SentinelOnboardingStateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SentinelOnboardingState(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001:SentinelOnboardingState", name, null, MakeResourceOptions(options, id))
        {
        }
