...
namespace Pulumi.AzureNative.SecurityInsights.V20211001
{
    public static class GetIncidentComment
    {
        ...
        public static Task<GetIncidentCommentResult> InvokeAsync(GetIncidentCommentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIncidentCommentResult>("azure-native:securityinsights/v20211001:getIncidentComment", args ?? new GetIncidentCommentArgs(), options.WithDefaults());

        /// <summary>
        /// Represents an incident comment
        /// </summary>
        public static Output<GetIncidentCommentResult> Invoke(GetIncidentCommentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIncidentCommentResult>("azure-native:securityinsights/v20211001:getIncidentComment", args ?? new GetIncidentCommentInvokeArgs(), options.WithDefaults());
    }
