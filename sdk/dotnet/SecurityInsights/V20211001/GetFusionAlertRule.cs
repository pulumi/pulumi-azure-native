...
{
    [Obsolete(@"azure-native:securityinsights/v20211001:FusionAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20211001preview:FusionAlertRule to guarantee forwards compatibility.")]
    public static class GetFusionAlertRule
    {
        ...
        public static Task<GetFusionAlertRuleResult> InvokeAsync(GetFusionAlertRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFusionAlertRuleResult>("azure-native:securityinsights/v20211001:getFusionAlertRule", args ?? new GetFusionAlertRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the alert rule.
        /// </summary>
        public static Output<GetFusionAlertRuleResult> Invoke(GetFusionAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFusionAlertRuleResult>("azure-native:securityinsights/v20211001:getFusionAlertRule", args ?? new GetFusionAlertRuleInvokeArgs(), options.WithDefaults());
    }
