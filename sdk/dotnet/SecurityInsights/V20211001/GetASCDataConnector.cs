...
namespace Pulumi.AzureNative.SecurityInsights.V20211001
{
    public static class GetASCDataConnector
    {
        ...
        public static Task<GetASCDataConnectorResult> InvokeAsync(GetASCDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetASCDataConnectorResult>("azure-native:securityinsights/v20211001:getASCDataConnector", args ?? new GetASCDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a data connector.
        /// </summary>
        public static Output<GetASCDataConnectorResult> Invoke(GetASCDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetASCDataConnectorResult>("azure-native:securityinsights/v20211001:getASCDataConnector", args ?? new GetASCDataConnectorInvokeArgs(), options.WithDefaults());
