...
namespace Pulumi.AzureNative.SecurityInsights.V20211001
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20211001:IncidentRelation")]
    public partial class IncidentRelation : global::Pulumi.CustomResource
    {
        ...
        public IncidentRelation(string name, IncidentRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001:IncidentRelation", name, args ?? new IncidentRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001:IncidentRelation", name, null, MakeResourceOptions(options, id))
        {
        }
