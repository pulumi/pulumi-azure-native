...
namespace Pulumi.AzureNative.SecurityInsights.V20211001
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20211001:AADDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AADDataConnector to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20211001:AADDataConnector")]
    public partial class AADDataConnector : global::Pulumi.CustomResource
    {
        ...
        public AADDataConnector(string name, AADDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001:AADDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AADDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001:AADDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
