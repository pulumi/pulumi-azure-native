...
namespace Pulumi.AzureNative.SecurityInsights.V20211001
{
    ...
    /// {
    ///     var scheduledAlertRule = new AzureNative.SecurityInsights.V20211001.ScheduledAlertRule("scheduledAlertRule", new()
    ///     {
    ...
    ///     var scheduledAlertRule = new AzureNative.SecurityInsights.V20211001.ScheduledAlertRule("scheduledAlertRule", new()
    ///     {
    ///         AlertDetailsOverride = new AzureNative.SecurityInsights.V20211001.Inputs.AlertDetailsOverrideArgs
    ///         {
    ...
    ///         EntityMappings = new[]
    ///         {
    ///             new AzureNative.SecurityInsights.V20211001.Inputs.EntityMappingArgs
    ///             {
    ///                 EntityType = "Host",
    ///                 FieldMappings = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20211001.Inputs.FieldMappingArgs
    ///                     {
    ///                         ColumnName = "Computer",
    ///                         Identifier = "FullName",
    ///                     },
    ...
    ///             },
    ///         },
    ///         EventGroupingSettings = new AzureNative.SecurityInsights.V20211001.Inputs.EventGroupingSettingsArgs
    ///         {
    ///             AggregationKind = "AlertPerResult",
    ///         },
    ///         IncidentConfiguration = new AzureNative.SecurityInsights.V20211001.Inputs.IncidentConfigurationArgs
    ///         {
    ///             CreateIncident = true,
    ///             GroupingConfiguration = new AzureNative.SecurityInsights.V20211001.Inputs.GroupingConfigurationArgs
    ///             {
    ///                 Enabled = true,
    ...
    ///             "LateralMovement",
    ///         },
    ///         TriggerOperator = AzureNative.SecurityInsights.V20211001.TriggerOperator.GreaterThan,
    ///         TriggerThreshold = 0,
    ///         WorkspaceName = "myWorkspace",
    ///     });
    /// 
    ...
    public partial class ScheduledAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ScheduledAlertRule(string name, ScheduledAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001:ScheduledAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001:ScheduledAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20211001.AlertSeverity> Severity { get; set; } = null!;
        ...
        [Input("tactics")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20211001.AttackTactic>>? _tactics;

        /// <summary>
        /// The tactics of the alert rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20211001.AttackTactic>> Tactics
        {
        ...
        public Input<Pulumi.AzureNative.SecurityInsights.V20211001.TriggerOperator> TriggerOperator { get; set; } = null!;
