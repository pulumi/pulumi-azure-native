...
namespace Pulumi.AzureNative.SecurityInsights.V20221101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20221101preview:SourceControl")]
    public partial class SourceControl : global::Pulumi.CustomResource
    {
        ...
        public SourceControl(string name, SourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101preview:SourceControl", name, args ?? new SourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101preview:SourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221101Preview.ContentType>>? _contentTypes;

        /// <summary>
        /// Array of source control content types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221101Preview.ContentType>> ContentTypes
        {
            get => _contentTypes ?? (_contentTypes = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221101Preview.ContentType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221101Preview.RepoType> RepoType { get; set; } = null!;
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221101Preview.Version>? Version { get; set; }
