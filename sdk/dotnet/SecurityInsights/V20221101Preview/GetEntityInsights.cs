...
namespace Pulumi.AzureNative.SecurityInsights.V20221101Preview
{
    public static class GetEntityInsights
    {
        ...
        public static Task<GetEntityInsightsResult> InvokeAsync(GetEntityInsightsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEntityInsightsResult>("azure-native:securityinsights/v20221101preview:getEntityInsights", args ?? new GetEntityInsightsArgs(), options.WithDefaults());

        /// <summary>
        /// Execute Insights for an entity.
        /// </summary>
        public static Output<GetEntityInsightsResult> Invoke(GetEntityInsightsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEntityInsightsResult>("azure-native:securityinsights/v20221101preview:getEntityInsights", args ?? new GetEntityInsightsInvokeArgs(), options.WithDefaults());
    }
