...
namespace Pulumi.AzureNative.SecurityInsights.V20221101Preview
{
    ...
    /// {
    ///     var awsCloudTrailDataConnector = new AzureNative.SecurityInsights.V20221101Preview.AwsCloudTrailDataConnector("awsCloudTrailDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20221101preview:AwsCloudTrailDataConnector")]
    public partial class AwsCloudTrailDataConnector : global::Pulumi.CustomResource
    {
        ...
        public AwsCloudTrailDataConnector(string name, AwsCloudTrailDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101preview:AwsCloudTrailDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AwsCloudTrailDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101preview:AwsCloudTrailDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
