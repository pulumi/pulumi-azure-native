...
namespace Pulumi.AzureNative.SecurityInsights.V20221101Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20221101preview:ProductSetting")]
    public partial class ProductSetting : global::Pulumi.CustomResource
    {
        ...
        public ProductSetting(string name, ProductSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101preview:ProductSetting", name, args ?? new ProductSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101preview:ProductSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20230301preview:ProductSetting"},
                },
            };
    ...
    public sealed class ProductSettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221101Preview.SettingKind> Kind { get; set; } = null!;
