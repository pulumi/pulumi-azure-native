...
{
    [Obsolete(@"azure-native:securityinsights/v20221101preview:EntityAnalytics is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:EntityAnalytics to guarantee forwards compatibility.")]
    public static class GetEntityAnalytics
    {
        ...
        public static Task<GetEntityAnalyticsResult> InvokeAsync(GetEntityAnalyticsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEntityAnalyticsResult>("azure-native:securityinsights/v20221101preview:getEntityAnalytics", args ?? new GetEntityAnalyticsArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a setting.
        /// </summary>
        public static Output<GetEntityAnalyticsResult> Invoke(GetEntityAnalyticsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEntityAnalyticsResult>("azure-native:securityinsights/v20221101preview:getEntityAnalytics", args ?? new GetEntityAnalyticsInvokeArgs(), options.WithDefaults());
    }
