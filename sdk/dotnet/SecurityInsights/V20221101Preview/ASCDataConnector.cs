...
namespace Pulumi.AzureNative.SecurityInsights.V20221101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20221101preview:ASCDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ASCDataConnector to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20221101preview:ASCDataConnector")]
    public partial class ASCDataConnector : global::Pulumi.CustomResource
    {
        ...
        public ASCDataConnector(string name, ASCDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101preview:ASCDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ASCDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101preview:ASCDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
