...
namespace Pulumi.AzureNative.SecurityInsights
{
    ...
    public static class GetDataConnector
    {
        ...
        public static Task<GetDataConnectorResult> InvokeAsync(GetDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectorResult>("azure-native:securityinsights:getDataConnector", args ?? new GetDataConnectorArgs(), options.WithDefaults());
        ...
        public static Output<GetDataConnectorResult> Invoke(GetDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataConnectorResult>("azure-native:securityinsights:getDataConnector", args ?? new GetDataConnectorInvokeArgs(), options.WithDefaults());
    }
