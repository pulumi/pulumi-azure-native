...
namespace Pulumi.AzureNative.SecurityInsights.V20250101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20250101preview:Anomalies")]
    public partial class Anomalies : global::Pulumi.CustomResource
    {
        ...
        public Anomalies(string name, AnomaliesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20250101preview:Anomalies", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Anomalies(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20250101preview:Anomalies", name, null, MakeResourceOptions(options, id))
        {
        }
