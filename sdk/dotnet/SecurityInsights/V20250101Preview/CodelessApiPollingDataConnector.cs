...
namespace Pulumi.AzureNative.SecurityInsights.V20250101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20250101preview:CodelessApiPollingDataConnector")]
    public partial class CodelessApiPollingDataConnector : global::Pulumi.CustomResource
    {
        ...
        public CodelessApiPollingDataConnector(string name, CodelessApiPollingDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20250101preview:CodelessApiPollingDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CodelessApiPollingDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20250101preview:CodelessApiPollingDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
