...
namespace Pulumi.AzureNative.SecurityInsights.V20250101Preview.Inputs
{
    ...
    public sealed class SapAgentConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20250101Preview.KeyVaultAuthenticationMode>? KeyVaultAuthenticationMode { get; set; }
        ...
        /// </summary>
        [Input("secretSource")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20250101Preview.SecretSource>? SecretSource { get; set; }
