...
namespace Pulumi.AzureNative.SecurityInsights.V20250101Preview
{
    public static class GetAutomationRule
    {
        ...
        public static Task<GetAutomationRuleResult> InvokeAsync(GetAutomationRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutomationRuleResult>("azure-native:securityinsights/v20250101preview:getAutomationRule", args ?? new GetAutomationRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the automation rule.
        /// </summary>
        public static Output<GetAutomationRuleResult> Invoke(GetAutomationRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAutomationRuleResult>("azure-native:securityinsights/v20250101preview:getAutomationRule", args ?? new GetAutomationRuleInvokeArgs(), options.WithDefaults());
