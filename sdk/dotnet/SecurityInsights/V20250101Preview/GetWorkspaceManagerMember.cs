...
namespace Pulumi.AzureNative.SecurityInsights.V20250101Preview
{
    public static class GetWorkspaceManagerMember
    {
        ...
        public static Task<GetWorkspaceManagerMemberResult> InvokeAsync(GetWorkspaceManagerMemberArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceManagerMemberResult>("azure-native:securityinsights/v20250101preview:getWorkspaceManagerMember", args ?? new GetWorkspaceManagerMemberArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkspaceManagerMemberResult> Invoke(GetWorkspaceManagerMemberInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceManagerMemberResult>("azure-native:securityinsights/v20250101preview:getWorkspaceManagerMember", args ?? new GetWorkspaceManagerMemberInvokeArgs(), options.WithDefaults());
