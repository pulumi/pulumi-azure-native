...
namespace Pulumi.AzureNative.SecurityInsights.V20250101Preview
{
    public static class ListGeodataByIp
    {
        ...
        public static Task<ListGeodataByIpResult> InvokeAsync(ListGeodataByIpArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListGeodataByIpResult>("azure-native:securityinsights/v20250101preview:listGeodataByIp", args ?? new ListGeodataByIpArgs(), options.WithDefaults());

        /// <summary>
        /// Get geodata for a single IP address
        /// </summary>
        public static Output<ListGeodataByIpResult> Invoke(ListGeodataByIpInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListGeodataByIpResult>("azure-native:securityinsights/v20250101preview:listGeodataByIp", args ?? new ListGeodataByIpInvokeArgs(), options.WithDefaults());
