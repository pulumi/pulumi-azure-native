...
namespace Pulumi.AzureNative.SecurityInsights.V20230701Preview
{
    public static class GetIoTDataConnector
    {
        ...
        public static Task<GetIoTDataConnectorResult> InvokeAsync(GetIoTDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIoTDataConnectorResult>("azure-native:securityinsights/v20230701preview:getIoTDataConnector", args ?? new GetIoTDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a data connector.
        /// </summary>
        public static Output<GetIoTDataConnectorResult> Invoke(GetIoTDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIoTDataConnectorResult>("azure-native:securityinsights/v20230701preview:getIoTDataConnector", args ?? new GetIoTDataConnectorInvokeArgs(), options.WithDefaults());
