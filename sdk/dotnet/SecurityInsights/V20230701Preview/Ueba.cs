...
namespace Pulumi.AzureNative.SecurityInsights.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230701preview:Ueba")]
    public partial class Ueba : global::Pulumi.CustomResource
    {
        ...
        public Ueba(string name, UebaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230701preview:Ueba", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Ueba(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230701preview:Ueba", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("dataSources")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230701Preview.UebaDataSources>>? _dataSources;

        /// <summary>
        /// The relevant data sources that enriched by ueba
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230701Preview.UebaDataSources>> DataSources
        {
            get => _dataSources ?? (_dataSources = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230701Preview.UebaDataSources>>());
