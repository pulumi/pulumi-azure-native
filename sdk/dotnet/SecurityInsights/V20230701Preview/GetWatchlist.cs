...
namespace Pulumi.AzureNative.SecurityInsights.V20230701Preview
{
    public static class GetWatchlist
    {
        ...
        public static Task<GetWatchlistResult> InvokeAsync(GetWatchlistArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWatchlistResult>("azure-native:securityinsights/v20230701preview:getWatchlist", args ?? new GetWatchlistArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a watchlist, without its watchlist items.
        /// </summary>
        public static Output<GetWatchlistResult> Invoke(GetWatchlistInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWatchlistResult>("azure-native:securityinsights/v20230701preview:getWatchlist", args ?? new GetWatchlistInvokeArgs(), options.WithDefaults());
    }
