...
namespace Pulumi.AzureNative.SecurityInsights.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230701preview:MLBehaviorAnalyticsAlertRule")]
    public partial class MLBehaviorAnalyticsAlertRule : global::Pulumi.CustomResource
    {
        ...
        public MLBehaviorAnalyticsAlertRule(string name, MLBehaviorAnalyticsAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230701preview:MLBehaviorAnalyticsAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MLBehaviorAnalyticsAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230701preview:MLBehaviorAnalyticsAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
