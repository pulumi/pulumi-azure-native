...
namespace Pulumi.AzureNative.SecurityInsights.V20230701Preview.Inputs
{
    ...
    {
        [Input("arrayType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230701Preview.AutomationRulePropertyArrayChangedConditionSupportedArrayType>? ArrayType { get; set; }

        [Input("changeType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230701Preview.AutomationRulePropertyArrayChangedConditionSupportedChangeType>? ChangeType { get; set; }
