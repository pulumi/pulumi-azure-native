...
namespace Pulumi.AzureNative.SecurityInsights.V20230701Preview.Inputs
{
    ...
    public sealed class MtpFilteredProvidersArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230701Preview.MtpProvider>>? _alerts;
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230701Preview.MtpProvider>> Alerts
        {
            get => _alerts ?? (_alerts = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230701Preview.MtpProvider>>());
            set => _alerts = value;
        }
