...
namespace Pulumi.AzureNative.SecurityInsights.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230701preview:OfficePowerBIDataConnector")]
    public partial class OfficePowerBIDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficePowerBIDataConnector(string name, OfficePowerBIDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230701preview:OfficePowerBIDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficePowerBIDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230701preview:OfficePowerBIDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
