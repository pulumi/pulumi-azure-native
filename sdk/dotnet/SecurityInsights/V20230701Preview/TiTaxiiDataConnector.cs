...
namespace Pulumi.AzureNative.SecurityInsights.V20230701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230701preview:TiTaxiiDataConnector")]
    public partial class TiTaxiiDataConnector : global::Pulumi.CustomResource
    {
        ...
        public TiTaxiiDataConnector(string name, TiTaxiiDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230701preview:TiTaxiiDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private TiTaxiiDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230701preview:TiTaxiiDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TiTaxiiDataConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230701Preview.PollingFrequency> PollingFrequency { get; set; } = null!;
