...
namespace Pulumi.AzureNative.SecurityInsights.V20230201
{
    ...
    /// {
    ///     var mdatpDataConnector = new AzureNative.SecurityInsights.V20230201.MDATPDataConnector("mdatpDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201:MDATPDataConnector")]
    public partial class MDATPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MDATPDataConnector(string name, MDATPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:MDATPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MDATPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:MDATPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
