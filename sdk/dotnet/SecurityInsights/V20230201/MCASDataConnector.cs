...
namespace Pulumi.AzureNative.SecurityInsights.V20230201
{
    ...
    /// {
    ///     var mcasDataConnector = new AzureNative.SecurityInsights.V20230201.MCASDataConnector("mcasDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201:MCASDataConnector")]
    public partial class MCASDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MCASDataConnector(string name, MCASDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:MCASDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MCASDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:MCASDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
