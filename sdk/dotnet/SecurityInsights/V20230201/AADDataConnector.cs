...
namespace Pulumi.AzureNative.SecurityInsights.V20230201
{
    ...
    /// {
    ///     var aadDataConnector = new AzureNative.SecurityInsights.V20230201.AADDataConnector("aadDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201:AADDataConnector")]
    public partial class AADDataConnector : global::Pulumi.CustomResource
    {
        ...
        public AADDataConnector(string name, AADDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:AADDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AADDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:AADDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
