...
namespace Pulumi.AzureNative.SecurityInsights.V20230201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector")]
    public partial class AwsCloudTrailDataConnector : global::Pulumi.CustomResource
    {
        ...
        public AwsCloudTrailDataConnector(string name, AwsCloudTrailDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AwsCloudTrailDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
