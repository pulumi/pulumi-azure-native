...
{
    [Obsolete(@"azure-native:securityinsights/v20230201:IncidentRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:IncidentRelation to guarantee forwards compatibility.")]
    public static class GetIncidentRelation
    {
        ...
        public static Task<GetIncidentRelationResult> InvokeAsync(GetIncidentRelationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIncidentRelationResult>("azure-native:securityinsights/v20230201:getIncidentRelation", args ?? new GetIncidentRelationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a relation for a given incident.
        /// </summary>
        public static Output<GetIncidentRelationResult> Invoke(GetIncidentRelationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIncidentRelationResult>("azure-native:securityinsights/v20230201:getIncidentRelation", args ?? new GetIncidentRelationInvokeArgs(), options.WithDefaults());
    }
