...
{
    [Obsolete(@"azure-native:securityinsights/v20230201:Metadata is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Metadata to guarantee forwards compatibility.")]
    public static class GetMetadata
    {
        ...
        public static Task<GetMetadataResult> InvokeAsync(GetMetadataArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMetadataResult>("azure-native:securityinsights/v20230201:getMetadata", args ?? new GetMetadataArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Metadata.
        /// </summary>
        public static Output<GetMetadataResult> Invoke(GetMetadataInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMetadataResult>("azure-native:securityinsights/v20230201:getMetadata", args ?? new GetMetadataInvokeArgs(), options.WithDefaults());
    }
