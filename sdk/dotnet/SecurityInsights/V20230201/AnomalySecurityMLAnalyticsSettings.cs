...
namespace Pulumi.AzureNative.SecurityInsights.V20230201
{
    ...
    /// {
    ///     var anomalySecurityMLAnalyticsSettings = new AzureNative.SecurityInsights.V20230201.AnomalySecurityMLAnalyticsSettings("anomalySecurityMLAnalyticsSettings", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.SecurityInsights.V20230201.Inputs.SecurityMLAnalyticsSettingsDataSourceArgs
    ///             {
    ///                 ConnectorId = "AWS",
    ///                 DataTypes = new[]
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201:AnomalySecurityMLAnalyticsSettings")]
    public partial class AnomalySecurityMLAnalyticsSettings : global::Pulumi.CustomResource
    {
        ...
        public AnomalySecurityMLAnalyticsSettings(string name, AnomalySecurityMLAnalyticsSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:AnomalySecurityMLAnalyticsSettings", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AnomalySecurityMLAnalyticsSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201:AnomalySecurityMLAnalyticsSettings", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AnomalySecurityMLAnalyticsSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230201.SettingsStatus> SettingsStatus { get; set; } = null!;
