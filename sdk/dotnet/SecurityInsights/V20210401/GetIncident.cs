...
namespace Pulumi.AzureNative.SecurityInsights.V20210401
{
    public static class GetIncident
    {
        ...
        public static Task<GetIncidentResult> InvokeAsync(GetIncidentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIncidentResult>("azure-native:securityinsights/v20210401:getIncident", args ?? new GetIncidentArgs(), options.WithDefaults());

        /// <summary>
        /// Represents an incident in Azure Security Insights.
        /// </summary>
        public static Output<GetIncidentResult> Invoke(GetIncidentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIncidentResult>("azure-native:securityinsights/v20210401:getIncident", args ?? new GetIncidentInvokeArgs(), options.WithDefaults());
    }
