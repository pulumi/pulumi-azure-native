...
namespace Pulumi.AzureNative.SecurityInsights.V20210401
{
    ...
    /// {
    ///     var threatIntelligenceIndicator = new AzureNative.SecurityInsights.V20210401.ThreatIntelligenceIndicator("threatIntelligenceIndicator", new()
    ///     {
    ///         Confidence = 78,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20210401:ThreatIntelligenceIndicator")]
    public partial class ThreatIntelligenceIndicator : global::Pulumi.CustomResource
    {
        ...
        public ThreatIntelligenceIndicator(string name, ThreatIntelligenceIndicatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210401:ThreatIntelligenceIndicator", name, args ?? new ThreatIntelligenceIndicatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ThreatIntelligenceIndicator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210401:ThreatIntelligenceIndicator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ThreatIntelligenceIndicatorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210401.ThreatIntelligenceResourceInnerKind> Kind { get; set; } = null!;
