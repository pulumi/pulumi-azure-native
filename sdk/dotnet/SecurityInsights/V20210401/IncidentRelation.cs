...
namespace Pulumi.AzureNative.SecurityInsights.V20210401
{
    ...
    public partial class IncidentRelation : Pulumi.CustomResource
    {
        ...
        public IncidentRelation(string name, IncidentRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210401:IncidentRelation", name, args ?? new IncidentRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210401:IncidentRelation", name, null, MakeResourceOptions(options, id))
        {
        }
