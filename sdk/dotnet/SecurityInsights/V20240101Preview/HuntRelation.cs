...
namespace Pulumi.AzureNative.SecurityInsights.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20240101preview:HuntRelation")]
    public partial class HuntRelation : global::Pulumi.CustomResource
    {
        ...
        public HuntRelation(string name, HuntRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240101preview:HuntRelation", name, args ?? new HuntRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HuntRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240101preview:HuntRelation", name, null, MakeResourceOptions(options, id))
        {
        }
