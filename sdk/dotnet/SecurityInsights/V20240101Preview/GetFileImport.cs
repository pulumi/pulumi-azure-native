...
namespace Pulumi.AzureNative.SecurityInsights.V20240101Preview
{
    public static class GetFileImport
    {
        ...
        public static Task<GetFileImportResult> InvokeAsync(GetFileImportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFileImportResult>("azure-native:securityinsights/v20240101preview:getFileImport", args ?? new GetFileImportArgs(), options.WithDefaults());
