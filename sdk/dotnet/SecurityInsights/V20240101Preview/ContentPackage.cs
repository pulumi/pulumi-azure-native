...
namespace Pulumi.AzureNative.SecurityInsights.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20240101preview:ContentPackage")]
    public partial class ContentPackage : global::Pulumi.CustomResource
    {
        ...
        public ContentPackage(string name, ContentPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240101preview:ContentPackage", name, args ?? new ContentPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240101preview:ContentPackage", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContentPackageArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240101Preview.PackageKind> ContentKind { get; set; } = null!;
        ...
        /// </summary>
        [Input("isDeprecated")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240101Preview.Flag>? IsDeprecated { get; set; }

        /// <summary>
        /// Flag indicates if this package is among the featured list.
        /// </summary>
        [Input("isFeatured")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240101Preview.Flag>? IsFeatured { get; set; }

        /// <summary>
        /// Flag indicates if this is a newly published package.
        /// </summary>
        [Input("isNew")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240101Preview.Flag>? IsNew { get; set; }

        /// <summary>
        /// Flag indicates if this package is in preview.
        /// </summary>
        [Input("isPreview")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240101Preview.Flag>? IsPreview { get; set; }
