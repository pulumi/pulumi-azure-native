...
namespace Pulumi.AzureNative.SecurityInsights.V20240101Preview.Inputs
{
    ...
    {
        [Input("arrayType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240101Preview.AutomationRulePropertyArrayChangedConditionSupportedArrayType>? ArrayType { get; set; }

        [Input("changeType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240101Preview.AutomationRulePropertyArrayChangedConditionSupportedChangeType>? ChangeType { get; set; }
