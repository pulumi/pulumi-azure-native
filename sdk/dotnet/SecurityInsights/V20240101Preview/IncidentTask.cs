...
{
    [AzureNativeResourceType("azure-native:securityinsights/v20240101preview:IncidentTask")]
    public partial class IncidentTask : global::Pulumi.CustomResource
    {
        ...
        public IncidentTask(string name, IncidentTaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240101preview:IncidentTask", name, args ?? new IncidentTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240101preview:IncidentTask", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IncidentTaskArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240101Preview.IncidentTaskStatus> Status { get; set; } = null!;
