...
namespace Pulumi.AzureNative.SecurityInsights.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20240101preview:ThreatIntelligenceAlertRule")]
    public partial class ThreatIntelligenceAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ThreatIntelligenceAlertRule(string name, ThreatIntelligenceAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240101preview:ThreatIntelligenceAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ThreatIntelligenceAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240101preview:ThreatIntelligenceAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
