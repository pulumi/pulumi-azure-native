...
namespace Pulumi.AzureNative.SecurityInsights.V20240101Preview
{
    public static class GetHuntRelation
    {
        ...
        public static Task<GetHuntRelationResult> InvokeAsync(GetHuntRelationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHuntRelationResult>("azure-native:securityinsights/v20240101preview:getHuntRelation", args ?? new GetHuntRelationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a hunt relation
        /// </summary>
        public static Output<GetHuntRelationResult> Invoke(GetHuntRelationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHuntRelationResult>("azure-native:securityinsights/v20240101preview:getHuntRelation", args ?? new GetHuntRelationInvokeArgs(), options.WithDefaults());
