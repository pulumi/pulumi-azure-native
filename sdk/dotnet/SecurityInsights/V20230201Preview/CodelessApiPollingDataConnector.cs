...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var codelessApiPollingDataConnector = new AzureNative.SecurityInsights.V20230201Preview.CodelessApiPollingDataConnector("codelessApiPollingDataConnector", new()
    ///     {
    ...
    ///         Kind = "APIPolling",
    ///         PollingConfig = new AzureNative.SecurityInsights.V20230201Preview.Inputs.CodelessConnectorPollingConfigPropertiesArgs
    ///         {
    ///             Auth = new AzureNative.SecurityInsights.V20230201Preview.Inputs.CodelessConnectorPollingAuthPropertiesArgs
    ///             {
    ///                 ApiKeyIdentifier = "token",
    ///                 ApiKeyName = "Authorization",
    ///                 AuthType = "APIKey",
    ///             },
    ///             Paging = new AzureNative.SecurityInsights.V20230201Preview.Inputs.CodelessConnectorPollingPagingPropertiesArgs
    ///             {
    ///                 PageSizeParaName = "per_page",
    ///                 PagingType = "LinkHeader",
    ///             },
    ///             Request = new AzureNative.SecurityInsights.V20230201Preview.Inputs.CodelessConnectorPollingRequestPropertiesArgs
    ///             {
    ...
    ///                 TimeoutInSeconds = 60,
    ///             },
    ///             Response = new AzureNative.SecurityInsights.V20230201Preview.Inputs.CodelessConnectorPollingResponsePropertiesArgs
    ///             {
    ///                 EventsJsonPaths = new[]
    ///                 {
    ///                     "$",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20230201preview:CodelessApiPollingDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    ...
    public partial class CodelessApiPollingDataConnector : global::Pulumi.CustomResource
    {
        ...
        public CodelessApiPollingDataConnector(string name, CodelessApiPollingDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:CodelessApiPollingDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CodelessApiPollingDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:CodelessApiPollingDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
