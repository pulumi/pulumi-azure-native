...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var office365ProjectDataConnector = new AzureNative.SecurityInsights.V20230201Preview.Office365ProjectDataConnector("office365ProjectDataConnector", new()
    ///     {
    ...
    ///     {
    ///         DataConnectorId = "73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    ///         DataTypes = new AzureNative.SecurityInsights.V20230201Preview.Inputs.Office365ProjectConnectorDataTypesArgs
    ///         {
    ///             Logs = new AzureNative.SecurityInsights.V20230201Preview.Inputs.Office365ProjectConnectorDataTypesLogsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20230201preview:Office365ProjectDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201preview:Office365ProjectDataConnector")]
    public partial class Office365ProjectDataConnector : global::Pulumi.CustomResource
    {
        ...
        public Office365ProjectDataConnector(string name, Office365ProjectDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:Office365ProjectDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Office365ProjectDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:Office365ProjectDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
