...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var scheduledAlertRule = new AzureNative.SecurityInsights.V20230201Preview.ScheduledAlertRule("scheduledAlertRule", new()
    ///     {
    ...
    ///     var scheduledAlertRule = new AzureNative.SecurityInsights.V20230201Preview.ScheduledAlertRule("scheduledAlertRule", new()
    ///     {
    ///         AlertDetailsOverride = new AzureNative.SecurityInsights.V20230201Preview.Inputs.AlertDetailsOverrideArgs
    ///         {
    ///             AlertDescriptionFormat = "Suspicious activity was made by {{ComputerIP}}",
    ///             AlertDisplayNameFormat = "Alert from {{Computer}}",
    ///             AlertDynamicProperties = new[]
    ///             {
    ///                 new AzureNative.SecurityInsights.V20230201Preview.Inputs.AlertPropertyMappingArgs
    ///                 {
    ...
    ///         EntityMappings = new[]
    ///         {
    ///             new AzureNative.SecurityInsights.V20230201Preview.Inputs.EntityMappingArgs
    ///             {
    ///                 EntityType = "Host",
    ///                 FieldMappings = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20230201Preview.Inputs.FieldMappingArgs
    ///                     {
    ///                         ColumnName = "Computer",
    ///                         Identifier = "FullName",
    ///                     },
    ...
    ///         {
    ///             new AzureNative.SecurityInsights.V20230201Preview.Inputs.SentinelEntityMappingArgs
    ///             {
    ///                 ColumnName = "Entities",
    ///             },
    ///         },
    ...
    ///             "T1021",
    ///         },
    ///         TriggerOperator = AzureNative.SecurityInsights.V20230201Preview.TriggerOperator.GreaterThan,
    ///         TriggerThreshold = 0,
    ///         WorkspaceName = "myWorkspace",
    ///     });
    /// 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201preview:ScheduledAlertRule")]
    public partial class ScheduledAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ScheduledAlertRule(string name, ScheduledAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:ScheduledAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:ScheduledAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.SecurityInsights.V20230201Preview.TriggerOperator> TriggerOperator { get; set; } = null!;
