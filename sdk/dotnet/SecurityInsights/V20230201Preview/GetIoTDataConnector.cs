...
{
    [Obsolete(@"azure-native:securityinsights/v20230201preview:IoTDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:IoTDataConnector to guarantee forwards compatibility.")]
    public static class GetIoTDataConnector
    {
        ...
        public static Task<GetIoTDataConnectorResult> InvokeAsync(GetIoTDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIoTDataConnectorResult>("azure-native:securityinsights/v20230201preview:getIoTDataConnector", args ?? new GetIoTDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a data connector.
        /// </summary>
        public static Output<GetIoTDataConnectorResult> Invoke(GetIoTDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIoTDataConnectorResult>("azure-native:securityinsights/v20230201preview:getIoTDataConnector", args ?? new GetIoTDataConnectorInvokeArgs(), options.WithDefaults());
    }
