...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    public static class GetSourceControl
    {
        ...
        public static Task<GetSourceControlResult> InvokeAsync(GetSourceControlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSourceControlResult>("azure-native:securityinsights/v20230201preview:getSourceControl", args ?? new GetSourceControlArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a source control byt its identifier.
        /// </summary>
        public static Output<GetSourceControlResult> Invoke(GetSourceControlInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSourceControlResult>("azure-native:securityinsights/v20230201preview:getSourceControl", args ?? new GetSourceControlInvokeArgs(), options.WithDefaults());
    }
