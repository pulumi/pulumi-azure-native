...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20230201preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20230201preview:MLBehaviorAnalyticsAlertRule")]
    public partial class MLBehaviorAnalyticsAlertRule : global::Pulumi.CustomResource
    {
        ...
        public MLBehaviorAnalyticsAlertRule(string name, MLBehaviorAnalyticsAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:MLBehaviorAnalyticsAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MLBehaviorAnalyticsAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:MLBehaviorAnalyticsAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
