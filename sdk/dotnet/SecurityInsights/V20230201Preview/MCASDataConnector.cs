...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var mcasDataConnector = new AzureNative.SecurityInsights.V20230201Preview.MCASDataConnector("mcasDataConnector", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20230201preview:MCASDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201preview:MCASDataConnector")]
    public partial class MCASDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MCASDataConnector(string name, MCASDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:MCASDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MCASDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:MCASDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
