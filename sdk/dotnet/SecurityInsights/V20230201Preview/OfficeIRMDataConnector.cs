...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var officeIRMDataConnector = new AzureNative.SecurityInsights.V20230201Preview.OfficeIRMDataConnector("officeIRMDataConnector", new()
    ///     {
