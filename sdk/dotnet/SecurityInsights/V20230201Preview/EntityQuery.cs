...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20230201preview:EntityQuery")]
    public partial class EntityQuery : global::Pulumi.CustomResource
    {
        ...
        public EntityQuery(string name, EntityQueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:EntityQuery", name, args ?? new EntityQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntityQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:EntityQuery", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EntityQueryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230201Preview.CustomEntityQueryKind> Kind { get; set; } = null!;
