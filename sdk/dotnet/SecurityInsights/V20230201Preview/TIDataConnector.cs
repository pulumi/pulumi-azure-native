...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var tiDataConnector = new AzureNative.SecurityInsights.V20230201Preview.TIDataConnector("tiDataConnector", new()
    ///     {
    ...
    ///     {
    ///         DataConnectorId = "73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    ///         DataTypes = new AzureNative.SecurityInsights.V20230201Preview.Inputs.TIDataConnectorDataTypesArgs
    ///         {
    ///             Indicators = new AzureNative.SecurityInsights.V20230201Preview.Inputs.TIDataConnectorDataTypesIndicatorsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201preview:TIDataConnector")]
    public partial class TIDataConnector : global::Pulumi.CustomResource
    {
        ...
        public TIDataConnector(string name, TIDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:TIDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private TIDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:TIDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
