...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var nrtAlertRule = new AzureNative.SecurityInsights.V20230201Preview.NrtAlertRule("nrtAlertRule", new()
    ///     {
    ...
    ///         DisplayName = "Rule2",
    ///         Enabled = true,
    ///         EventGroupingSettings = new AzureNative.SecurityInsights.V20230201Preview.Inputs.EventGroupingSettingsArgs
    ///         {
    ///             AggregationKind = "AlertPerResult",
    ///         },
    ///         IncidentConfiguration = new AzureNative.SecurityInsights.V20230201Preview.Inputs.IncidentConfigurationArgs
    ///         {
    ///             CreateIncident = true,
    ///             GroupingConfiguration = new AzureNative.SecurityInsights.V20230201Preview.Inputs.GroupingConfigurationArgs
    ///             {
    ///                 Enabled = true,
    ///                 GroupByEntities = new[]
    ///                 {
    ...
    public partial class NrtAlertRule : global::Pulumi.CustomResource
    {
        ...
        public NrtAlertRule(string name, NrtAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:NrtAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private NrtAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:NrtAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NrtAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230201Preview.AlertSeverity> Severity { get; set; } = null!;
        ...
        [Input("tactics")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230201Preview.AttackTactic>>? _tactics;

        /// <summary>
        /// The tactics of the alert rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230201Preview.AttackTactic>> Tactics
        {
            get => _tactics ?? (_tactics = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230201Preview.AttackTactic>>());
            set => _tactics = value;
        }
