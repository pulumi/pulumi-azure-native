...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var fusionAlertRule = new AzureNative.SecurityInsights.V20230201Preview.FusionAlertRule("fusionAlertRule", new()
    ///     {
    ...
    ///         SourceSettings = new[]
    ///         {
    ///             new AzureNative.SecurityInsights.V20230201Preview.Inputs.FusionSourceSettingsArgs
    ///             {
    ///                 Enabled = true,
    ...
    ///                 SourceSubTypes = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20230201Preview.Inputs.FusionSourceSubTypeSettingArgs
    ///                     {
    ///                         Enabled = true,
    ///                         SeverityFilters = new AzureNative.SecurityInsights.V20230201Preview.Inputs.FusionSubTypeSeverityFilterArgs
    ///                         {
    ///                             Filters = new[]
    ///                             {
    ///                                 new AzureNative.SecurityInsights.V20230201Preview.Inputs.FusionSubTypeSeverityFiltersItemArgs
    ///                                 {
    ///                                     Enabled = true,
    ///                                     Severity = "High",
    ///                                 },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20230201preview:FusionAlertRule 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalIinsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/alertRules/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201preview:FusionAlertRule")]
    public partial class FusionAlertRule : global::Pulumi.CustomResource
    {
        ...
        public FusionAlertRule(string name, FusionAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:FusionAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FusionAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:FusionAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
