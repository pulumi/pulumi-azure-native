...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var metadata = new AzureNative.SecurityInsights.V20230201Preview.Metadata("metadata", new()
    ///     {
    ///         Author = new AzureNative.SecurityInsights.V20230201Preview.Inputs.MetadataAuthorArgs
    ///         {
    ///             Email = "email@microsoft.com",
    ///             Name = "User Name",
    ///         },
    ///         Categories = new AzureNative.SecurityInsights.V20230201Preview.Inputs.MetadataCategoriesArgs
    ///         {
    ///             Domains = new[]
    ///             {
    ///                 "Application",
    ...
    ///         CustomVersion = "1.0",
    ///         Dependencies = new AzureNative.SecurityInsights.V20230201Preview.Inputs.MetadataDependenciesArgs
    ///         {
    ///             Criteria = new[]
    ///             {
    ///                 new AzureNative.SecurityInsights.V20230201Preview.Inputs.MetadataDependenciesArgs
    ///                 {
    ///                     Criteria = new[]
    ///                     {
    ///                         new AzureNative.SecurityInsights.V20230201Preview.Inputs.MetadataDependenciesArgs
    ...
    ///         Source = new AzureNative.SecurityInsights.V20230201Preview.Inputs.MetadataSourceArgs
    ///         {
    ///             Kind = "Solution",
    ///             Name = "Contoso Solution 1.0",
    ///             SourceId = "b688a130-76f4-4a07-bf57-762222a3cadf",
    ///         },
    ///         Support = new AzureNative.SecurityInsights.V20230201Preview.Inputs.MetadataSupportArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20230201preview:Metadata metadataName /subscriptions/2e1dc338-d04d-4443-b721-037eff4fdcac/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/metadata/metadataName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201preview:Metadata")]
    public partial class Metadata : global::Pulumi.CustomResource
    {
        ...
        public Metadata(string name, MetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:Metadata", name, args ?? new MetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Metadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:Metadata", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MetadataArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230201Preview.Kind> Kind { get; set; } = null!;
