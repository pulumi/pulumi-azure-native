...
namespace Pulumi.AzureNative.SecurityInsights.V20230201Preview
{
    ...
    /// {
    ///     var mtpDataConnector = new AzureNative.SecurityInsights.V20230201Preview.MTPDataConnector("mtpDataConnector", new()
    ///     {
    ...
    ///         DataTypes = new AzureNative.SecurityInsights.V20230201Preview.Inputs.MTPDataConnectorDataTypesArgs
    ///         {
    ///             Alerts = new AzureNative.SecurityInsights.V20230201Preview.Inputs.MTPDataConnectorDataTypesAlertsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///             Incidents = new AzureNative.SecurityInsights.V20230201Preview.Inputs.MTPDataConnectorDataTypesIncidentsArgs
    ///             {
    ///                 State = "Disabled",
    ///             },
    ///         },
    ///         FilteredProviders = new AzureNative.SecurityInsights.V20230201Preview.Inputs.MtpFilteredProvidersArgs
    ///         {
    ///             Alerts = new[]
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230201preview:MTPDataConnector")]
    public partial class MTPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MTPDataConnector(string name, MTPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:MTPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MTPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230201preview:MTPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
