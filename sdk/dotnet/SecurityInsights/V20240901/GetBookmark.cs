...
namespace Pulumi.AzureNative.SecurityInsights.V20240901
{
    public static class GetBookmark
    {
        ...
        public static Task<GetBookmarkResult> InvokeAsync(GetBookmarkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBookmarkResult>("azure-native:securityinsights/v20240901:getBookmark", args ?? new GetBookmarkArgs(), options.WithDefaults());
