...
namespace Pulumi.AzureNative.SecurityInsights.V20240901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20240901:ThreatIntelligenceIndicator")]
    public partial class ThreatIntelligenceIndicator : global::Pulumi.CustomResource
    {
        ...
        public ThreatIntelligenceIndicator(string name, ThreatIntelligenceIndicatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240901:ThreatIntelligenceIndicator", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ThreatIntelligenceIndicator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240901:ThreatIntelligenceIndicator", name, null, MakeResourceOptions(options, id))
        {
        }
