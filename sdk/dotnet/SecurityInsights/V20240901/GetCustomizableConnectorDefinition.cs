...
namespace Pulumi.AzureNative.SecurityInsights.V20240901
{
    public static class GetCustomizableConnectorDefinition
    {
        ...
        public static Task<GetCustomizableConnectorDefinitionResult> InvokeAsync(GetCustomizableConnectorDefinitionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomizableConnectorDefinitionResult>("azure-native:securityinsights/v20240901:getCustomizableConnectorDefinition", args ?? new GetCustomizableConnectorDefinitionArgs(), options.WithDefaults());
