...
namespace Pulumi.AzureNative.SecurityInsights.V20240901
{
    public static class GetContentTemplate
    {
        ...
        public static Task<GetContentTemplateResult> InvokeAsync(GetContentTemplateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContentTemplateResult>("azure-native:securityinsights/v20240901:getContentTemplate", args ?? new GetContentTemplateArgs(), options.WithDefaults());
        ...
        public static Output<GetContentTemplateResult> Invoke(GetContentTemplateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContentTemplateResult>("azure-native:securityinsights/v20240901:getContentTemplate", args ?? new GetContentTemplateInvokeArgs(), options.WithDefaults());
