...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    ...
    public static class GetAlertRule
    {
        ...
        public static Task<GetAlertRuleResult> InvokeAsync(GetAlertRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleResult>("azure-native:securityinsights/v20210901preview:getAlertRule", args ?? new GetAlertRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the alert rule.
        /// </summary>
        public static Output<GetAlertRuleResult> Invoke(GetAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAlertRuleResult>("azure-native:securityinsights/v20210901preview:getAlertRule", args ?? new GetAlertRuleInvokeArgs(), options.WithDefaults());
    }
