...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    public static class GetBookmark
    {
        ...
        public static Task<GetBookmarkResult> InvokeAsync(GetBookmarkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBookmarkResult>("azure-native:securityinsights/v20210901preview:getBookmark", args ?? new GetBookmarkArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a bookmark in Azure Security Insights.
        /// </summary>
        public static Output<GetBookmarkResult> Invoke(GetBookmarkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBookmarkResult>("azure-native:securityinsights/v20210901preview:getBookmark", args ?? new GetBookmarkInvokeArgs(), options.WithDefaults());
    }
