...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview.Inputs
{
    ...
    public sealed class AutomationRuleTriggeringLogicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210901Preview.TriggersOn> TriggersOn { get; set; } = null!;

        /// <summary>
        /// The type of event the automation rule triggers on
        /// </summary>
        [Input("triggersWhen", required: true)]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210901Preview.TriggersWhen> TriggersWhen { get; set; } = null!;
