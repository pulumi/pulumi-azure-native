...
{
    [Obsolete(@"azure-native:securityinsights/v20210901preview:BookmarkRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:BookmarkRelation to guarantee forwards compatibility.")]
    public static class GetBookmarkRelation
    {
        ...
        public static Task<GetBookmarkRelationResult> InvokeAsync(GetBookmarkRelationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBookmarkRelationResult>("azure-native:securityinsights/v20210901preview:getBookmarkRelation", args ?? new GetBookmarkRelationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a bookmark relation.
        /// </summary>
        public static Output<GetBookmarkRelationResult> Invoke(GetBookmarkRelationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBookmarkRelationResult>("azure-native:securityinsights/v20210901preview:getBookmarkRelation", args ?? new GetBookmarkRelationInvokeArgs(), options.WithDefaults());
    }
