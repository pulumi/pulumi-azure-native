...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    public static class GetEyesOn
    {
        ...
        public static Task<GetEyesOnResult> InvokeAsync(GetEyesOnArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEyesOnResult>("azure-native:securityinsights/v20210901preview:getEyesOn", args ?? new GetEyesOnArgs(), options.WithVersion());

        /// <summary>
        /// Settings with single toggle.
        /// </summary>
        public static Output<GetEyesOnResult> Invoke(GetEyesOnInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEyesOnResult>("azure-native:securityinsights/v20210901preview:getEyesOn", args ?? new GetEyesOnInvokeArgs(), options.WithVersion());
    }
