...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20210901preview:AlertRule")]
    public partial class AlertRule : Pulumi.CustomResource
    {
        ...
        public AlertRule(string name, AlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:AlertRule", name, args ?? new AlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:AlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AlertRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210901Preview.AlertRuleKind> Kind { get; set; } = null!;
