...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    public static class GetMetadata
    {
        ...
        public static Task<GetMetadataResult> InvokeAsync(GetMetadataArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMetadataResult>("azure-native:securityinsights/v20210901preview:getMetadata", args ?? new GetMetadataArgs(), options.WithVersion());

        /// <summary>
        /// Metadata resource definition.
        /// </summary>
        public static Output<GetMetadataResult> Invoke(GetMetadataInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMetadataResult>("azure-native:securityinsights/v20210901preview:getMetadata", args ?? new GetMetadataInvokeArgs(), options.WithVersion());
    }
