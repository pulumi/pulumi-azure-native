...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20210901preview:AutomationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:AutomationRule to guarantee forwards compatibility.")]
    ...
    public partial class AutomationRule : global::Pulumi.CustomResource
    {
        ...
        public AutomationRule(string name, AutomationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:AutomationRule", name, args ?? new AutomationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutomationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:AutomationRule", name, null, MakeResourceOptions(options, id))
        {
        }
