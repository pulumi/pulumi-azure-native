...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    public static class GetAnomalies
    {
        ...
        public static Task<GetAnomaliesResult> InvokeAsync(GetAnomaliesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAnomaliesResult>("azure-native:securityinsights/v20210901preview:getAnomalies", args ?? new GetAnomaliesArgs(), options.WithDefaults());

        /// <summary>
        /// Settings with single toggle.
        /// </summary>
        public static Output<GetAnomaliesResult> Invoke(GetAnomaliesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAnomaliesResult>("azure-native:securityinsights/v20210901preview:getAnomalies", args ?? new GetAnomaliesInvokeArgs(), options.WithDefaults());
    }
