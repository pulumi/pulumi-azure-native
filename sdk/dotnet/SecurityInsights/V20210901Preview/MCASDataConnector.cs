...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    ...
    /// {
    ///     var mcasDataConnector = new AzureNative.SecurityInsights.V20210901Preview.MCASDataConnector("mcasDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20210901preview:MCASDataConnector")]
    public partial class MCASDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MCASDataConnector(string name, MCASDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:MCASDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MCASDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:MCASDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
