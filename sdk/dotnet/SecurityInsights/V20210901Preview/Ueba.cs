...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    ...
    /// {
    ///     var ueba = new AzureNative.SecurityInsights.V20210901Preview.Ueba("ueba", new()
    ///     {
    ...
    public partial class Ueba : global::Pulumi.CustomResource
    {
        ...
        public Ueba(string name, UebaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:Ueba", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Ueba(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:Ueba", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UebaArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// The relevant data sources that enriched by ueba
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20210901Preview.UebaDataSources>> DataSources
        {
            get => _dataSources ?? (_dataSources = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20210901Preview.UebaDataSources>>());
