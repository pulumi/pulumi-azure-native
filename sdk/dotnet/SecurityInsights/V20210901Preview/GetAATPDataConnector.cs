...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    public static class GetAATPDataConnector
    {
        ...
        public static Task<GetAATPDataConnectorResult> InvokeAsync(GetAATPDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAATPDataConnectorResult>("azure-native:securityinsights/v20210901preview:getAATPDataConnector", args ?? new GetAATPDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Represents AATP (Azure Advanced Threat Protection) data connector.
        /// </summary>
        public static Output<GetAATPDataConnectorResult> Invoke(GetAATPDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAATPDataConnectorResult>("azure-native:securityinsights/v20210901preview:getAATPDataConnector", args ?? new GetAATPDataConnectorInvokeArgs(), options.WithDefaults());
    }
