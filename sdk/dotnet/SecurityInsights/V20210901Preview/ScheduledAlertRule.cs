...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    ...
    /// {
    ///     var scheduledAlertRule = new AzureNative.SecurityInsights.V20210901Preview.ScheduledAlertRule("scheduledAlertRule", new()
    ///     {
    ...
    ///     var scheduledAlertRule = new AzureNative.SecurityInsights.V20210901Preview.ScheduledAlertRule("scheduledAlertRule", new()
    ///     {
    ///         AlertDetailsOverride = new AzureNative.SecurityInsights.V20210901Preview.Inputs.AlertDetailsOverrideArgs
    ///         {
    ...
    ///         EntityMappings = new[]
    ///         {
    ///             new AzureNative.SecurityInsights.V20210901Preview.Inputs.EntityMappingArgs
    ///             {
    ///                 EntityType = "Host",
    ///                 FieldMappings = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20210901Preview.Inputs.FieldMappingArgs
    ///                     {
    ///                         ColumnName = "Computer",
    ///                         Identifier = "FullName",
    ///                     },
    ...
    ///             },
    ///         },
    ///         EventGroupingSettings = new AzureNative.SecurityInsights.V20210901Preview.Inputs.EventGroupingSettingsArgs
    ///         {
    ///             AggregationKind = "AlertPerResult",
    ///         },
    ///         IncidentConfiguration = new AzureNative.SecurityInsights.V20210901Preview.Inputs.IncidentConfigurationArgs
    ///         {
    ///             CreateIncident = true,
    ///             GroupingConfiguration = new AzureNative.SecurityInsights.V20210901Preview.Inputs.GroupingConfigurationArgs
    ///             {
    ///                 Enabled = true,
    ...
    ///             "LateralMovement",
    ///         },
    ///         TriggerOperator = AzureNative.SecurityInsights.V20210901Preview.TriggerOperator.GreaterThan,
    ///         TriggerThreshold = 0,
    ///         WorkspaceName = "myWorkspace",
    ///     });
    /// 
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20210901preview:ScheduledAlertRule 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalIinsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/alertRules/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20210901preview:ScheduledAlertRule")]
    public partial class ScheduledAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ScheduledAlertRule(string name, ScheduledAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:ScheduledAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:ScheduledAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210901Preview.AlertSeverity> Severity { get; set; } = null!;
        ...
        [Input("tactics")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20210901Preview.AttackTactic>>? _tactics;

        /// <summary>
        /// The tactics of the alert rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20210901Preview.AttackTactic>> Tactics
        {
            get => _tactics ?? (_tactics = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20210901Preview.AttackTactic>>());
            set => _tactics = value;
        }
        ...
        public Input<Pulumi.AzureNative.SecurityInsights.V20210901Preview.TriggerOperator> TriggerOperator { get; set; } = null!;
