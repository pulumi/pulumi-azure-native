...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20210901preview:SentinelOnboardingState")]
    public partial class SentinelOnboardingState : global::Pulumi.CustomResource
    {
        ...
        public SentinelOnboardingState(string name, SentinelOnboardingStateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:SentinelOnboardingState", name, args ?? new SentinelOnboardingStateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SentinelOnboardingState(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:SentinelOnboardingState", name, null, MakeResourceOptions(options, id))
        {
        }
