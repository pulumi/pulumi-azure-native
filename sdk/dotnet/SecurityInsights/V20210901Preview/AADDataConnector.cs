...
namespace Pulumi.AzureNative.SecurityInsights.V20210901Preview
{
    ...
    /// {
    ///     var aadDataConnector = new AzureNative.SecurityInsights.V20210901Preview.AADDataConnector("aadDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20210901preview:AADDataConnector")]
    public partial class AADDataConnector : global::Pulumi.CustomResource
    {
        ...
        public AADDataConnector(string name, AADDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:AADDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AADDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210901preview:AADDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
