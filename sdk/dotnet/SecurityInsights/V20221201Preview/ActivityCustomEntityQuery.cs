...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20221201preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ActivityCustomEntityQuery to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20221201preview:ActivityCustomEntityQuery")]
    public partial class ActivityCustomEntityQuery : global::Pulumi.CustomResource
    {
        ...
        public ActivityCustomEntityQuery(string name, ActivityCustomEntityQueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:ActivityCustomEntityQuery", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ActivityCustomEntityQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:ActivityCustomEntityQuery", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ActivityCustomEntityQueryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.EntityType>? InputEntityType { get; set; }
