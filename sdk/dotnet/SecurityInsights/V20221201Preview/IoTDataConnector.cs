...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview
{
    ...
    /// {
    ///     var ioTDataConnector = new AzureNative.SecurityInsights.V20221201Preview.IoTDataConnector("ioTDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20221201preview:IoTDataConnector")]
    public partial class IoTDataConnector : global::Pulumi.CustomResource
    {
        ...
        public IoTDataConnector(string name, IoTDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:IoTDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:IoTDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
