...
{
    [Obsolete(@"azure-native:securityinsights/v20221201preview:Office365ProjectDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Office365ProjectDataConnector to guarantee forwards compatibility.")]
    public static class GetOffice365ProjectDataConnector
    {
        ...
        public static Task<GetOffice365ProjectDataConnectorResult> InvokeAsync(GetOffice365ProjectDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOffice365ProjectDataConnectorResult>("azure-native:securityinsights/v20221201preview:getOffice365ProjectDataConnector", args ?? new GetOffice365ProjectDataConnectorArgs(), options.WithDefaults());
        ...
        public static Output<GetOffice365ProjectDataConnectorResult> Invoke(GetOffice365ProjectDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOffice365ProjectDataConnectorResult>("azure-native:securityinsights/v20221201preview:getOffice365ProjectDataConnector", args ?? new GetOffice365ProjectDataConnectorInvokeArgs(), options.WithDefaults());
    }
