...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview.Inputs
{
    ...
    {
        [Input("operator")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.AutomationRulePropertyConditionSupportedOperator>? Operator { get; set; }

        /// <summary>
        /// The property to evaluate in an automation rule property condition.
        /// </summary>
        [Input("propertyName")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.AutomationRulePropertyConditionSupportedProperty>? PropertyName { get; set; }
