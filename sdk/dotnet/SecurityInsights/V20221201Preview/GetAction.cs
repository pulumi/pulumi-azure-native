...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview
{
    public static class GetAction
    {
        ...
        public static Task<GetActionResult> InvokeAsync(GetActionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActionResult>("azure-native:securityinsights/v20221201preview:getAction", args ?? new GetActionArgs(), options.WithDefaults());

        /// <summary>
        /// Action for alert rule.
        /// </summary>
        public static Output<GetActionResult> Invoke(GetActionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetActionResult>("azure-native:securityinsights/v20221201preview:getAction", args ?? new GetActionInvokeArgs(), options.WithDefaults());
    }
