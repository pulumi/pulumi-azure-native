...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview
{
    public static class GetFileImport
    {
        ...
        public static Task<GetFileImportResult> InvokeAsync(GetFileImportArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFileImportResult>("azure-native:securityinsights/v20221201preview:getFileImport", args ?? new GetFileImportArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a file import in Azure Security Insights.
        /// </summary>
        public static Output<GetFileImportResult> Invoke(GetFileImportInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFileImportResult>("azure-native:securityinsights/v20221201preview:getFileImport", args ?? new GetFileImportInvokeArgs(), options.WithDefaults());
    }
