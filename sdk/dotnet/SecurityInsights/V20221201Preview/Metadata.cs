...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20221201preview:Metadata")]
    public partial class Metadata : global::Pulumi.CustomResource
    {
        ...
        public Metadata(string name, MetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:Metadata", name, args ?? new MetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Metadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:Metadata", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MetadataArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.Kind> Kind { get; set; } = null!;
