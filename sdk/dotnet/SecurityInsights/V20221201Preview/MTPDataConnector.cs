...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20221201preview:MTPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:MTPDataConnector to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20221201preview:MTPDataConnector")]
    public partial class MTPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MTPDataConnector(string name, MTPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:MTPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MTPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:MTPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
