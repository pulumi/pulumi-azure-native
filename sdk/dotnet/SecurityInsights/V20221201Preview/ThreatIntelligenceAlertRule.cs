...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview
{
    ...
    /// {
    ///     var threatIntelligenceAlertRule = new AzureNative.SecurityInsights.V20221201Preview.ThreatIntelligenceAlertRule("threatIntelligenceAlertRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20221201preview:ThreatIntelligenceAlertRule")]
    public partial class ThreatIntelligenceAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ThreatIntelligenceAlertRule(string name, ThreatIntelligenceAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:ThreatIntelligenceAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ThreatIntelligenceAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:ThreatIntelligenceAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
