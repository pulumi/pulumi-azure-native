...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview
{
    ...
    /// {
    ///     var microsoftSecurityIncidentCreationAlertRule = new AzureNative.SecurityInsights.V20221201Preview.MicrosoftSecurityIncidentCreationAlertRule("microsoftSecurityIncidentCreationAlertRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20221201preview:MicrosoftSecurityIncidentCreationAlertRule")]
    public partial class MicrosoftSecurityIncidentCreationAlertRule : global::Pulumi.CustomResource
    {
        ...
        public MicrosoftSecurityIncidentCreationAlertRule(string name, MicrosoftSecurityIncidentCreationAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:MicrosoftSecurityIncidentCreationAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MicrosoftSecurityIncidentCreationAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:MicrosoftSecurityIncidentCreationAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MicrosoftSecurityIncidentCreationAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.MicrosoftSecurityProductName> ProductFilter { get; set; } = null!;
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.AlertSeverity>>? _severitiesFilter;

        /// <summary>
        /// the alerts' severities on which the cases will be generated
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.AlertSeverity>> SeveritiesFilter
        {
            get => _severitiesFilter ?? (_severitiesFilter = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.AlertSeverity>>());
