...
{
    [Obsolete(@"azure-native:securityinsights/v20221201preview:Incident is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20221201preview:Incident")]
    public partial class Incident : global::Pulumi.CustomResource
    {
        ...
        public Incident(string name, IncidentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:Incident", name, args ?? new IncidentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Incident(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:Incident", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IncidentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.IncidentClassification>? Classification { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.IncidentClassificationReason>? ClassificationReason { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.IncidentSeverity> Severity { get; set; } = null!;

        /// <summary>
        /// The status of the incident
        /// </summary>
        [Input("status", required: true)]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221201Preview.IncidentStatus> Status { get; set; } = null!;
