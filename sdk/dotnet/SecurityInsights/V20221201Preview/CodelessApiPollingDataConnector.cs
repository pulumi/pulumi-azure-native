...
namespace Pulumi.AzureNative.SecurityInsights.V20221201Preview
{
    ...
    /// {
    ///     var codelessApiPollingDataConnector = new AzureNative.SecurityInsights.V20221201Preview.CodelessApiPollingDataConnector("codelessApiPollingDataConnector", new()
    ///     {
    ...
    ///         Kind = "APIPolling",
    ///         PollingConfig = new AzureNative.SecurityInsights.V20221201Preview.Inputs.CodelessConnectorPollingConfigPropertiesArgs
    ///         {
    ///             Auth = new AzureNative.SecurityInsights.V20221201Preview.Inputs.CodelessConnectorPollingAuthPropertiesArgs
    ///             {
    ///                 ApiKeyIdentifier = "token",
    ///                 ApiKeyName = "Authorization",
    ///                 AuthType = "APIKey",
    ///             },
    ///             Paging = new AzureNative.SecurityInsights.V20221201Preview.Inputs.CodelessConnectorPollingPagingPropertiesArgs
    ///             {
    ///                 PageSizeParaName = "per_page",
    ///                 PagingType = "LinkHeader",
    ///             },
    ///             Request = new AzureNative.SecurityInsights.V20221201Preview.Inputs.CodelessConnectorPollingRequestPropertiesArgs
    ///             {
    ...
    ///                 TimeoutInSeconds = 60,
    ///             },
    ///             Response = new AzureNative.SecurityInsights.V20221201Preview.Inputs.CodelessConnectorPollingResponsePropertiesArgs
    ///             {
    ///                 EventsJsonPaths = new[]
    ///                 {
    ///                     "$",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20221201preview:CodelessApiPollingDataConnector")]
    public partial class CodelessApiPollingDataConnector : global::Pulumi.CustomResource
    {
        ...
        public CodelessApiPollingDataConnector(string name, CodelessApiPollingDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:CodelessApiPollingDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CodelessApiPollingDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221201preview:CodelessApiPollingDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
