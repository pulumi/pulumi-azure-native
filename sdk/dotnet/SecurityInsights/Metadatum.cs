...
namespace Pulumi.AzureNative.SecurityInsights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights:Metadatum")]
    public partial class Metadatum : Pulumi.CustomResource
    {
        ...
        public Metadatum(string name, MetadatumArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:Metadatum", name, args ?? new MetadatumArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Metadatum(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:Metadatum", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:securityinsights/v20210301preview:Metadatum"},
