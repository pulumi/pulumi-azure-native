...
namespace Pulumi.AzureNative.SecurityInsights.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230601preview:CodelessApiPollingDataConnector")]
    public partial class CodelessApiPollingDataConnector : global::Pulumi.CustomResource
    {
        ...
        public CodelessApiPollingDataConnector(string name, CodelessApiPollingDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230601preview:CodelessApiPollingDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CodelessApiPollingDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230601preview:CodelessApiPollingDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
