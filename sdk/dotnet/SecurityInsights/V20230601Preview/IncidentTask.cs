...
{
    [AzureNativeResourceType("azure-native:securityinsights/v20230601preview:IncidentTask")]
    public partial class IncidentTask : global::Pulumi.CustomResource
    {
        ...
        public IncidentTask(string name, IncidentTaskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230601preview:IncidentTask", name, args ?? new IncidentTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230601preview:IncidentTask", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IncidentTaskArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230601Preview.IncidentTaskStatus> Status { get; set; } = null!;
