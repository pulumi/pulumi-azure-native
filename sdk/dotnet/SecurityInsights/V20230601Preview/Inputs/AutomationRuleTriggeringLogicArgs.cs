...
namespace Pulumi.AzureNative.SecurityInsights.V20230601Preview.Inputs
{
    ...
    public sealed class AutomationRuleTriggeringLogicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230601Preview.TriggersOn> TriggersOn { get; set; } = null!;

        [Input("triggersWhen", required: true)]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230601Preview.TriggersWhen> TriggersWhen { get; set; } = null!;
