...
namespace Pulumi.AzureNative.SecurityInsights.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230601preview:HuntRelation")]
    public partial class HuntRelation : global::Pulumi.CustomResource
    {
        ...
        public HuntRelation(string name, HuntRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230601preview:HuntRelation", name, args ?? new HuntRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HuntRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230601preview:HuntRelation", name, null, MakeResourceOptions(options, id))
        {
        }
