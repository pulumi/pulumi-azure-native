...
namespace Pulumi.AzureNative.SecurityInsights.V20221101
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20221101:DataConnector")]
    public partial class DataConnector : global::Pulumi.CustomResource
    {
        ...
        public DataConnector(string name, DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:DataConnector", name, args ?? new DataConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221101.DataConnectorKind> Kind { get; set; } = null!;
