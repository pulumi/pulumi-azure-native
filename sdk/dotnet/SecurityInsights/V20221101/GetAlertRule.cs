...
namespace Pulumi.AzureNative.SecurityInsights.V20221101
{
    ...
    public static class GetAlertRule
    {
        ...
        public static Task<GetAlertRuleResult> InvokeAsync(GetAlertRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleResult>("azure-native:securityinsights/v20221101:getAlertRule", args ?? new GetAlertRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Alert rule.
        /// </summary>
        public static Output<GetAlertRuleResult> Invoke(GetAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAlertRuleResult>("azure-native:securityinsights/v20221101:getAlertRule", args ?? new GetAlertRuleInvokeArgs(), options.WithDefaults());
    }
