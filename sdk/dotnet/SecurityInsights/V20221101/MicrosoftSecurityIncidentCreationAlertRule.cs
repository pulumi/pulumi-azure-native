...
namespace Pulumi.AzureNative.SecurityInsights.V20221101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20221101:MicrosoftSecurityIncidentCreationAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:MicrosoftSecurityIncidentCreationAlertRule to guarantee forwards compatibility.")]
    ...
    public partial class MicrosoftSecurityIncidentCreationAlertRule : global::Pulumi.CustomResource
    {
        ...
        public MicrosoftSecurityIncidentCreationAlertRule(string name, MicrosoftSecurityIncidentCreationAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:MicrosoftSecurityIncidentCreationAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MicrosoftSecurityIncidentCreationAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:MicrosoftSecurityIncidentCreationAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MicrosoftSecurityIncidentCreationAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221101.MicrosoftSecurityProductName> ProductFilter { get; set; } = null!;
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221101.AlertSeverity>>? _severitiesFilter;

        /// <summary>
        /// the alerts' severities on which the cases will be generated
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221101.AlertSeverity>> SeveritiesFilter
        {
            get => _severitiesFilter ?? (_severitiesFilter = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221101.AlertSeverity>>());
