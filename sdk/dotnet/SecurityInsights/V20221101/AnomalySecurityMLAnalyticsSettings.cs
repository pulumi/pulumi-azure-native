...
namespace Pulumi.AzureNative.SecurityInsights.V20221101
{
    ...
    /// {
    ///     var anomalySecurityMLAnalyticsSettings = new AzureNative.SecurityInsights.V20221101.AnomalySecurityMLAnalyticsSettings("anomalySecurityMLAnalyticsSettings", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.SecurityInsights.V20221101.Inputs.SecurityMLAnalyticsSettingsDataSourceArgs
    ///             {
    ///                 ConnectorId = "AWS",
    ///                 DataTypes = new[]
    ///                 {
