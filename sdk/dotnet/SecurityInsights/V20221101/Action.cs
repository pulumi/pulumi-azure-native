...
namespace Pulumi.AzureNative.SecurityInsights.V20221101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20221101:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Action to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20221101:Action")]
    public partial class Action : global::Pulumi.CustomResource
    {
        ...
        public Action(string name, ActionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:Action", name, args ?? new ActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Action(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:Action", name, null, MakeResourceOptions(options, id))
        {
        }
