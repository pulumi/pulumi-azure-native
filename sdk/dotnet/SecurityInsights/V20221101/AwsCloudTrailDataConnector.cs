...
namespace Pulumi.AzureNative.SecurityInsights.V20221101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20221101:AwsCloudTrailDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20221101:AwsCloudTrailDataConnector")]
    public partial class AwsCloudTrailDataConnector : global::Pulumi.CustomResource
    {
        ...
        public AwsCloudTrailDataConnector(string name, AwsCloudTrailDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:AwsCloudTrailDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AwsCloudTrailDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:AwsCloudTrailDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
