...
namespace Pulumi.AzureNative.SecurityInsights.V20221101
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20221101:ASCDataConnector")]
    public partial class ASCDataConnector : global::Pulumi.CustomResource
    {
        ...
        public ASCDataConnector(string name, ASCDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:ASCDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ASCDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221101:ASCDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
