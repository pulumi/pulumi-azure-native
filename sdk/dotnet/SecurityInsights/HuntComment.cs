...
namespace Pulumi.AzureNative.SecurityInsights
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights:HuntComment")]
    public partial class HuntComment : global::Pulumi.CustomResource
    {
        ...
        public HuntComment(string name, HuntCommentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:HuntComment", name, args ?? new HuntCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HuntComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:HuntComment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20250401preview:HuntComment" },
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20250701preview:HuntComment" },
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20251001preview:HuntComment" },
                },
            };
