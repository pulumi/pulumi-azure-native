...
namespace Pulumi.AzureNative.SecurityInsights.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231001preview:AwsCloudTrailDataConnector")]
    public partial class AwsCloudTrailDataConnector : global::Pulumi.CustomResource
    {
        ...
        public AwsCloudTrailDataConnector(string name, AwsCloudTrailDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231001preview:AwsCloudTrailDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AwsCloudTrailDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231001preview:AwsCloudTrailDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
