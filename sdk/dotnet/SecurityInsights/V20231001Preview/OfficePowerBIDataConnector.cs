...
namespace Pulumi.AzureNative.SecurityInsights.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231001preview:OfficePowerBIDataConnector")]
    public partial class OfficePowerBIDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficePowerBIDataConnector(string name, OfficePowerBIDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231001preview:OfficePowerBIDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficePowerBIDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231001preview:OfficePowerBIDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
