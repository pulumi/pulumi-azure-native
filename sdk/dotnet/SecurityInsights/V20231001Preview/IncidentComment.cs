...
namespace Pulumi.AzureNative.SecurityInsights.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231001preview:IncidentComment")]
    public partial class IncidentComment : global::Pulumi.CustomResource
    {
        ...
        public IncidentComment(string name, IncidentCommentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231001preview:IncidentComment", name, args ?? new IncidentCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231001preview:IncidentComment", name, null, MakeResourceOptions(options, id))
        {
        }
