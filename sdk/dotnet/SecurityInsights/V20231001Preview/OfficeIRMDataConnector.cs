...
namespace Pulumi.AzureNative.SecurityInsights.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231001preview:OfficeIRMDataConnector")]
    public partial class OfficeIRMDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficeIRMDataConnector(string name, OfficeIRMDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231001preview:OfficeIRMDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficeIRMDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231001preview:OfficeIRMDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
