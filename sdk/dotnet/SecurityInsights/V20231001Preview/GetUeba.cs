...
namespace Pulumi.AzureNative.SecurityInsights.V20231001Preview
{
    public static class GetUeba
    {
        ...
        public static Task<GetUebaResult> InvokeAsync(GetUebaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUebaResult>("azure-native:securityinsights/v20231001preview:getUeba", args ?? new GetUebaArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a setting.
        /// </summary>
        public static Output<GetUebaResult> Invoke(GetUebaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUebaResult>("azure-native:securityinsights/v20231001preview:getUeba", args ?? new GetUebaInvokeArgs(), options.WithDefaults());
    }
