...
namespace Pulumi.AzureNative.SecurityInsights.V20231001Preview
{
    public static class GetContentPackage
    {
        ...
        public static Task<GetContentPackageResult> InvokeAsync(GetContentPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContentPackageResult>("azure-native:securityinsights/v20231001preview:getContentPackage", args ?? new GetContentPackageArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an installed packages by its id.
        /// </summary>
        public static Output<GetContentPackageResult> Invoke(GetContentPackageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContentPackageResult>("azure-native:securityinsights/v20231001preview:getContentPackage", args ?? new GetContentPackageInvokeArgs(), options.WithDefaults());
