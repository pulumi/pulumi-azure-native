...
namespace Pulumi.AzureNative.SecurityInsights.Inputs
{
    ...
    public sealed class SapAgentConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.KeyVaultAuthenticationMode>? KeyVaultAuthenticationMode { get; set; }
        ...
        /// </summary>
        [Input("secretSource")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.SecretSource>? SecretSource { get; set; }
