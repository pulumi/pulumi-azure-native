...
namespace Pulumi.AzureNative.SecurityInsights.V20250301
{
    public static class GetAction
    {
        ...
        public static Task<GetActionResult> InvokeAsync(GetActionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActionResult>("azure-native:securityinsights/v20250301:getAction", args ?? new GetActionArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the action of alert rule.
        /// </summary>
        public static Output<GetActionResult> Invoke(GetActionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetActionResult>("azure-native:securityinsights/v20250301:getAction", args ?? new GetActionInvokeArgs(), options.WithDefaults());
