...
namespace Pulumi.AzureNative.SecurityInsights.V20250301
{
    public static class GetFusionAlertRule
    {
        ...
        public static Task<GetFusionAlertRuleResult> InvokeAsync(GetFusionAlertRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFusionAlertRuleResult>("azure-native:securityinsights/v20250301:getFusionAlertRule", args ?? new GetFusionAlertRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the alert rule.
        /// </summary>
        public static Output<GetFusionAlertRuleResult> Invoke(GetFusionAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFusionAlertRuleResult>("azure-native:securityinsights/v20250301:getFusionAlertRule", args ?? new GetFusionAlertRuleInvokeArgs(), options.WithDefaults());
