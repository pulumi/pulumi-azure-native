...
namespace Pulumi.AzureNative.SecurityInsights.V20250301
{
    public static class GetContentTemplate
    {
        ...
        public static Task<GetContentTemplateResult> InvokeAsync(GetContentTemplateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContentTemplateResult>("azure-native:securityinsights/v20250301:getContentTemplate", args ?? new GetContentTemplateArgs(), options.WithDefaults());
        ...
        public static Output<GetContentTemplateResult> Invoke(GetContentTemplateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContentTemplateResult>("azure-native:securityinsights/v20250301:getContentTemplate", args ?? new GetContentTemplateInvokeArgs(), options.WithDefaults());
