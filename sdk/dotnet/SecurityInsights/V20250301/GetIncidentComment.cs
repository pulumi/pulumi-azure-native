...
namespace Pulumi.AzureNative.SecurityInsights.V20250301
{
    public static class GetIncidentComment
    {
        ...
        public static Task<GetIncidentCommentResult> InvokeAsync(GetIncidentCommentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIncidentCommentResult>("azure-native:securityinsights/v20250301:getIncidentComment", args ?? new GetIncidentCommentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a comment for a given incident.
        /// </summary>
        public static Output<GetIncidentCommentResult> Invoke(GetIncidentCommentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIncidentCommentResult>("azure-native:securityinsights/v20250301:getIncidentComment", args ?? new GetIncidentCommentInvokeArgs(), options.WithDefaults());
