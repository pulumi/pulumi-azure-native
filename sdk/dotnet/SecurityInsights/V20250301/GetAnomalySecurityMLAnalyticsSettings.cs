...
namespace Pulumi.AzureNative.SecurityInsights.V20250301
{
    public static class GetAnomalySecurityMLAnalyticsSettings
    {
        ...
        public static Task<GetAnomalySecurityMLAnalyticsSettingsResult> InvokeAsync(GetAnomalySecurityMLAnalyticsSettingsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAnomalySecurityMLAnalyticsSettingsResult>("azure-native:securityinsights/v20250301:getAnomalySecurityMLAnalyticsSettings", args ?? new GetAnomalySecurityMLAnalyticsSettingsArgs(), options.WithDefaults());
        ...
        public static Output<GetAnomalySecurityMLAnalyticsSettingsResult> Invoke(GetAnomalySecurityMLAnalyticsSettingsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAnomalySecurityMLAnalyticsSettingsResult>("azure-native:securityinsights/v20250301:getAnomalySecurityMLAnalyticsSettings", args ?? new GetAnomalySecurityMLAnalyticsSettingsInvokeArgs(), options.WithDefaults());
