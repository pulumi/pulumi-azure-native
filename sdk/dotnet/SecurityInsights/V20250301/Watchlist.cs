...
namespace Pulumi.AzureNative.SecurityInsights.V20250301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20250301:Watchlist")]
    public partial class Watchlist : global::Pulumi.CustomResource
    {
        ...
        public Watchlist(string name, WatchlistArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20250301:Watchlist", name, args ?? new WatchlistArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Watchlist(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20250301:Watchlist", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WatchlistArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sourceType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20250301.SourceType>? SourceType { get; set; }
