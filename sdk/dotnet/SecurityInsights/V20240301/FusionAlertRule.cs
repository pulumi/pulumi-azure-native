...
namespace Pulumi.AzureNative.SecurityInsights.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20240301:FusionAlertRule")]
    public partial class FusionAlertRule : global::Pulumi.CustomResource
    {
        ...
        public FusionAlertRule(string name, FusionAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240301:FusionAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FusionAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240301:FusionAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
