...
namespace Pulumi.AzureNative.SecurityInsights.V20240301.Inputs
{
    ...
    public sealed class AutomationRuleTriggeringLogicArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240301.TriggersOn> TriggersOn { get; set; } = null!;

        [Input("triggersWhen", required: true)]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240301.TriggersWhen> TriggersWhen { get; set; } = null!;
