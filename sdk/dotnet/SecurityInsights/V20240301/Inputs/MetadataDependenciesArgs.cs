...
namespace Pulumi.AzureNative.SecurityInsights.V20240301.Inputs
{
    ...
    public sealed class MetadataDependenciesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240301.Kind>? Kind { get; set; }
        ...
        /// </summary>
        [Input("operator")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240301.Operator>? Operator { get; set; }
