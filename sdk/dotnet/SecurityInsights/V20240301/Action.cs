...
namespace Pulumi.AzureNative.SecurityInsights.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20240301:Action")]
    public partial class Action : global::Pulumi.CustomResource
    {
        ...
        public Action(string name, ActionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240301:Action", name, args ?? new ActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Action(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240301:Action", name, null, MakeResourceOptions(options, id))
        {
        }
