...
namespace Pulumi.AzureNative.SecurityInsights.V20240301
{
    public static class GetAADDataConnector
    {
        ...
        public static Task<GetAADDataConnectorResult> InvokeAsync(GetAADDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAADDataConnectorResult>("azure-native:securityinsights/v20240301:getAADDataConnector", args ?? new GetAADDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a data connector.
        /// </summary>
        public static Output<GetAADDataConnectorResult> Invoke(GetAADDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAADDataConnectorResult>("azure-native:securityinsights/v20240301:getAADDataConnector", args ?? new GetAADDataConnectorInvokeArgs(), options.WithDefaults());
