...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    public static class GetBookmarkRelation
    {
        public static Task<GetBookmarkRelationResult> InvokeAsync(GetBookmarkRelationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBookmarkRelationResult>("azurerm:securityinsights/preview:getBookmarkRelation", args ?? new GetBookmarkRelationArgs(), options.WithVersion());
    }
