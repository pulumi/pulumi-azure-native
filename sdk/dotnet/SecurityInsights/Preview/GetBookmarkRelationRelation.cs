...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    public static class GetBookmarkRelationRelation
    {
        public static Task<GetBookmarkRelationRelationResult> InvokeAsync(GetBookmarkRelationRelationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBookmarkRelationRelationResult>("azurerm:securityinsights/preview:getBookmarkRelationRelation", args ?? new GetBookmarkRelationRelationArgs(), options.WithVersion());
    }
