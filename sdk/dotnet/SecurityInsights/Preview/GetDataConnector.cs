...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    public static class GetDataConnector
    {
        public static Task<GetDataConnectorResult> InvokeAsync(GetDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectorResult>("azurerm:securityinsights/preview:getDataConnector", args ?? new GetDataConnectorArgs(), options.WithVersion());
    }
