...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    public static class GetIncidentRelation
    {
        public static Task<GetIncidentRelationResult> InvokeAsync(GetIncidentRelationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIncidentRelationResult>("azurerm:securityinsights/preview:getIncidentRelation", args ?? new GetIncidentRelationArgs(), options.WithVersion());
    }
