...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    ...
    public partial class Watchlist : Pulumi.CustomResource
    {
        ...
        public Watchlist(string name, WatchlistArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/preview:Watchlist", name, args ?? new WatchlistArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Watchlist(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/preview:Watchlist", name, null, MakeResourceOptions(options, id))
        {
        }
