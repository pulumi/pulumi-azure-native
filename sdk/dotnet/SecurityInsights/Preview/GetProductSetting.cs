...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    public static class GetProductSetting
    {
        public static Task<GetProductSettingResult> InvokeAsync(GetProductSettingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductSettingResult>("azurerm:securityinsights/preview:getProductSetting", args ?? new GetProductSettingArgs(), options.WithVersion());
    }
