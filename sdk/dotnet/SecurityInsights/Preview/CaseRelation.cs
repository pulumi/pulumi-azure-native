...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    ...
    public partial class CaseRelation : Pulumi.CustomResource
    {
        ...
        public CaseRelation(string name, CaseRelationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/preview:CaseRelation", name, args ?? new CaseRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CaseRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/preview:CaseRelation", name, null, MakeResourceOptions(options, id))
        {
        }
