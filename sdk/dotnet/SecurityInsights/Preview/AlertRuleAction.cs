...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    ...
    public partial class AlertRuleAction : Pulumi.CustomResource
    {
        ...
        public AlertRuleAction(string name, AlertRuleActionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/preview:AlertRuleAction", name, args ?? new AlertRuleActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRuleAction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/preview:AlertRuleAction", name, null, MakeResourceOptions(options, id))
        {
        }
