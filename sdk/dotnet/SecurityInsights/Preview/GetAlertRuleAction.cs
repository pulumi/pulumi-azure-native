...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    public static class GetAlertRuleAction
    {
        public static Task<GetAlertRuleActionResult> InvokeAsync(GetAlertRuleActionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleActionResult>("azurerm:securityinsights/preview:getAlertRuleAction", args ?? new GetAlertRuleActionArgs(), options.WithVersion());
    }
