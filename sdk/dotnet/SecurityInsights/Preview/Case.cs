...
namespace Pulumi.AzureRM.SecurityInsights.Preview
{
    ...
    public partial class Case : Pulumi.CustomResource
    {
        ...
        public Case(string name, CaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/preview:Case", name, args ?? new CaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Case(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/preview:Case", name, null, MakeResourceOptions(options, id))
        {
        }
