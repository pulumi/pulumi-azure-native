...
namespace Pulumi.AzureNative.SecurityInsights.V20220501Preview
{
    ...
    /// {
    ///     var codelessUiDataConnector = new AzureNative.SecurityInsights.V20220501Preview.CodelessUiDataConnector("codelessUiDataConnector", new()
    ///     {
    ...
    ///     var codelessUiDataConnector = new AzureNative.SecurityInsights.V20220501Preview.CodelessUiDataConnector("codelessUiDataConnector", new()
    ///     {
    ///         ConnectorUiConfig = new AzureNative.SecurityInsights.V20220501Preview.Inputs.CodelessUiConnectorConfigPropertiesArgs
    ///         {
    ///             Availability = new AzureNative.SecurityInsights.V20220501Preview.Inputs.AvailabilityArgs
    ///             {
    ///                 IsPreview = true,
    ///                 Status = 1,
    ///             },
    ...
    ///             {
    ///                 new AzureNative.SecurityInsights.V20220501Preview.Inputs.CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs
    ///                 {
    ...
    ///             DataTypes = new[]
    ///             {
    ///                 new AzureNative.SecurityInsights.V20220501Preview.Inputs.CodelessUiConnectorConfigPropertiesDataTypesArgs
    ///                 {
    ...
    ///             GraphQueries = new[]
    ///             {
    ///                 new AzureNative.SecurityInsights.V20220501Preview.Inputs.CodelessUiConnectorConfigPropertiesGraphQueriesArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureNative.SecurityInsights.V20220501Preview.Inputs.CodelessUiConnectorConfigPropertiesInstructionStepsArgs
    ///                 {
    ...
    ///                     Instructions = new[]
    ///                     {
    ///                         new AzureNative.SecurityInsights.V20220501Preview.Inputs.InstructionStepsInstructionsArgs
    ///                         {
    ///                             Parameters = 
    ///                             {
    ///                                 { "fillWith", new[]
    ...
    ///                 },
    ///             },
    ///             Permissions = new AzureNative.SecurityInsights.V20220501Preview.Inputs.PermissionsArgs
    ///             {
    ///                 Customs = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20220501Preview.Inputs.PermissionsCustomsArgs
    ///                     {
    ...
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20220501Preview.Inputs.PermissionsResourceProviderArgs
    ///                     {
    ///                         PermissionsDisplayText = "read and write permissions on the workspace are required.",
    ///                         Provider = "Microsoft.OperationalInsights/workspaces",
    ///                         ProviderDisplayName = "Workspace",
    ///                         RequiredPermissions = new AzureNative.SecurityInsights.V20220501Preview.Inputs.RequiredPermissionsArgs
    ///                         {
    ///                             Delete = true,
    ///                             Read = true,
    ///                             Write = true,
    ...
    ///             SampleQueries = new[]
    ///             {
    ///                 new AzureNative.SecurityInsights.V20220501Preview.Inputs.CodelessUiConnectorConfigPropertiesSampleQueriesArgs
    ///                 {
    ...
    public partial class CodelessUiDataConnector : global::Pulumi.CustomResource
    {
        ...
        public CodelessUiDataConnector(string name, CodelessUiDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:CodelessUiDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CodelessUiDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:CodelessUiDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
