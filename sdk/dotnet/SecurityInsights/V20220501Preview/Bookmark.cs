...
namespace Pulumi.AzureNative.SecurityInsights.V20220501Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20220501preview:Bookmark")]
    public partial class Bookmark : global::Pulumi.CustomResource
    {
        ...
        public Bookmark(string name, BookmarkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:Bookmark", name, args ?? new BookmarkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bookmark(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:Bookmark", name, null, MakeResourceOptions(options, id))
        {
        }
