...
namespace Pulumi.AzureNative.SecurityInsights.V20220501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20220501preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20220501preview:MLBehaviorAnalyticsAlertRule")]
    public partial class MLBehaviorAnalyticsAlertRule : global::Pulumi.CustomResource
    {
        ...
        public MLBehaviorAnalyticsAlertRule(string name, MLBehaviorAnalyticsAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:MLBehaviorAnalyticsAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MLBehaviorAnalyticsAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:MLBehaviorAnalyticsAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
