...
namespace Pulumi.AzureNative.SecurityInsights.V20220501Preview
{
    public static class GetTIDataConnector
    {
        ...
        public static Task<GetTIDataConnectorResult> InvokeAsync(GetTIDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTIDataConnectorResult>("azure-native:securityinsights/v20220501preview:getTIDataConnector", args ?? new GetTIDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Represents threat intelligence data connector.
        /// </summary>
        public static Output<GetTIDataConnectorResult> Invoke(GetTIDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTIDataConnectorResult>("azure-native:securityinsights/v20220501preview:getTIDataConnector", args ?? new GetTIDataConnectorInvokeArgs(), options.WithDefaults());
    }
