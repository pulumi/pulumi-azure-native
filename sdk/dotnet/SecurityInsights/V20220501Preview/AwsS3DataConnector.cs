...
namespace Pulumi.AzureNative.SecurityInsights.V20220501Preview
{
    ...
    /// {
    ///     var awsS3DataConnector = new AzureNative.SecurityInsights.V20220501Preview.AwsS3DataConnector("awsS3DataConnector", new()
    ///     {
    ...
    public partial class AwsS3DataConnector : global::Pulumi.CustomResource
    {
        ...
        public AwsS3DataConnector(string name, AwsS3DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:AwsS3DataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AwsS3DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:AwsS3DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
