...
{
    [Obsolete(@"azure-native:securityinsights/v20220501preview:Incident is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.")]
    public static class GetIncident
    {
        ...
        public static Task<GetIncidentResult> InvokeAsync(GetIncidentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIncidentResult>("azure-native:securityinsights/v20220501preview:getIncident", args ?? new GetIncidentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an incident.
        /// </summary>
        public static Output<GetIncidentResult> Invoke(GetIncidentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIncidentResult>("azure-native:securityinsights/v20220501preview:getIncident", args ?? new GetIncidentInvokeArgs(), options.WithDefaults());
    }
