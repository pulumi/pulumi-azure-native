...
namespace Pulumi.AzureNative.SecurityInsights.V20220501Preview
{
    ...
    /// {
    ///     var fusionAlertRule = new AzureNative.SecurityInsights.V20220501Preview.FusionAlertRule("fusionAlertRule", new()
    ///     {
    ...
    ///         SourceSettings = new[]
    ///         {
    ///             new AzureNative.SecurityInsights.V20220501Preview.Inputs.FusionSourceSettingsArgs
    ///             {
    ///                 Enabled = true,
    ...
    ///                 SourceSubTypes = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20220501Preview.Inputs.FusionSourceSubTypeSettingArgs
    ///                     {
    ///                         Enabled = true,
    ///                         SeverityFilters = new AzureNative.SecurityInsights.V20220501Preview.Inputs.FusionSubTypeSeverityFilterArgs
    ///                         {
    ///                             Filters = new[]
    ///                             {
    ///                                 new AzureNative.SecurityInsights.V20220501Preview.Inputs.FusionSubTypeSeverityFiltersItemArgs
    ///                                 {
    ///                                     Enabled = true,
    ///                                     Severity = "High",
    ///                                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220501preview:FusionAlertRule")]
    public partial class FusionAlertRule : global::Pulumi.CustomResource
    {
        ...
        public FusionAlertRule(string name, FusionAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:FusionAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FusionAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:FusionAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
