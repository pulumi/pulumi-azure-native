...
namespace Pulumi.AzureNative.SecurityInsights.V20220501Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20220501preview:DataConnector")]
    public partial class DataConnector : global::Pulumi.CustomResource
    {
        ...
        public DataConnector(string name, DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:DataConnector", name, args ?? new DataConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220501preview:DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220501Preview.DataConnectorKind> Kind { get; set; } = null!;
