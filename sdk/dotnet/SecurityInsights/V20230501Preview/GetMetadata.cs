...
namespace Pulumi.AzureNative.SecurityInsights.V20230501Preview
{
    public static class GetMetadata
    {
        ...
        public static Task<GetMetadataResult> InvokeAsync(GetMetadataArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMetadataResult>("azure-native:securityinsights/v20230501preview:getMetadata", args ?? new GetMetadataArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Metadata.
        /// </summary>
        public static Output<GetMetadataResult> Invoke(GetMetadataInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMetadataResult>("azure-native:securityinsights/v20230501preview:getMetadata", args ?? new GetMetadataInvokeArgs(), options.WithDefaults());
