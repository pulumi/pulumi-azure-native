...
namespace Pulumi.AzureNative.SecurityInsights.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230501preview:OfficePowerBIDataConnector")]
    public partial class OfficePowerBIDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficePowerBIDataConnector(string name, OfficePowerBIDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:OfficePowerBIDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficePowerBIDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:OfficePowerBIDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
