...
namespace Pulumi.AzureNative.SecurityInsights.V20230501Preview
{
    public static class GetContentTemplate
    {
        ...
        public static Task<GetContentTemplateResult> InvokeAsync(GetContentTemplateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContentTemplateResult>("azure-native:securityinsights/v20230501preview:getContentTemplate", args ?? new GetContentTemplateArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a template byt its identifier.
        /// </summary>
        public static Output<GetContentTemplateResult> Invoke(GetContentTemplateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContentTemplateResult>("azure-native:securityinsights/v20230501preview:getContentTemplate", args ?? new GetContentTemplateInvokeArgs(), options.WithDefaults());
