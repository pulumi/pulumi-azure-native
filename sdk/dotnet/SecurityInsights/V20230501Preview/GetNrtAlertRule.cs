...
namespace Pulumi.AzureNative.SecurityInsights.V20230501Preview
{
    public static class GetNrtAlertRule
    {
        ...
        public static Task<GetNrtAlertRuleResult> InvokeAsync(GetNrtAlertRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNrtAlertRuleResult>("azure-native:securityinsights/v20230501preview:getNrtAlertRule", args ?? new GetNrtAlertRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the alert rule.
        /// </summary>
        public static Output<GetNrtAlertRuleResult> Invoke(GetNrtAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNrtAlertRuleResult>("azure-native:securityinsights/v20230501preview:getNrtAlertRule", args ?? new GetNrtAlertRuleInvokeArgs(), options.WithDefaults());
