...
namespace Pulumi.AzureNative.SecurityInsights.V20230501Preview
{
    public static class GetSourceControl
    {
        ...
        public static Task<GetSourceControlResult> InvokeAsync(GetSourceControlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSourceControlResult>("azure-native:securityinsights/v20230501preview:getSourceControl", args ?? new GetSourceControlArgs(), options.WithDefaults());
