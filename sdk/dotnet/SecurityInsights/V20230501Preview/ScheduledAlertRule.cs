...
namespace Pulumi.AzureNative.SecurityInsights.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230501preview:ScheduledAlertRule")]
    public partial class ScheduledAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ScheduledAlertRule(string name, ScheduledAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:ScheduledAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:ScheduledAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.SecurityInsights.V20230501Preview.TriggerOperator> TriggerOperator { get; set; } = null!;
