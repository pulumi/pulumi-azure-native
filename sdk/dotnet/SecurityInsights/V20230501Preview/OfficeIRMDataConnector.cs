...
namespace Pulumi.AzureNative.SecurityInsights.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230501preview:OfficeIRMDataConnector")]
    public partial class OfficeIRMDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficeIRMDataConnector(string name, OfficeIRMDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:OfficeIRMDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficeIRMDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:OfficeIRMDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
