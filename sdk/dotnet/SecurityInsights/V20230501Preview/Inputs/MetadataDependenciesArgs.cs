...
namespace Pulumi.AzureNative.SecurityInsights.V20230501Preview.Inputs
{
    ...
    public sealed class MetadataDependenciesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230501Preview.Kind>? Kind { get; set; }
        ...
        /// </summary>
        [Input("operator")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230501Preview.Operator>? Operator { get; set; }
