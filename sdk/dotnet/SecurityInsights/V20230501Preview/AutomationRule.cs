...
{
    [AzureNativeResourceType("azure-native:securityinsights/v20230501preview:AutomationRule")]
    public partial class AutomationRule : global::Pulumi.CustomResource
    {
        ...
        public AutomationRule(string name, AutomationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:AutomationRule", name, args ?? new AutomationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutomationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:AutomationRule", name, null, MakeResourceOptions(options, id))
        {
        }
