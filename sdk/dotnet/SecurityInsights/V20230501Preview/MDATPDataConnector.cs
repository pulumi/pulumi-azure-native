...
namespace Pulumi.AzureNative.SecurityInsights.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230501preview:MDATPDataConnector")]
    public partial class MDATPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MDATPDataConnector(string name, MDATPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:MDATPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MDATPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230501preview:MDATPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
