...
namespace Pulumi.AzureRM.SecurityInsights.V20190101Preview
{
    public static class GetIncidentRelationRelation
    {
        public static Task<GetIncidentRelationRelationResult> InvokeAsync(GetIncidentRelationRelationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIncidentRelationRelationResult>("azurerm:securityinsights/v20190101preview:getIncidentRelationRelation", args ?? new GetIncidentRelationRelationArgs(), options.WithVersion());
    }
