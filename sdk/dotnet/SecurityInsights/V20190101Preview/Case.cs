...
namespace Pulumi.AzureRM.SecurityInsights.V20190101Preview
{
    ...
    public partial class Case : Pulumi.CustomResource
    {
        ...
        public Case(string name, CaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/v20190101preview:Case", name, args ?? new CaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Case(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/v20190101preview:Case", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:securityinsights/preview:Case"},
                },
            };
