...
namespace Pulumi.AzureNative.SecurityInsights.V20190101Preview
{
    ...
    public partial class ProductSetting : Pulumi.CustomResource
    {
        ...
        public ProductSetting(string name, ProductSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20190101preview:ProductSetting", name, args ?? new ProductSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20190101preview:ProductSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProductSettingArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20190101Preview.SettingKind> Kind { get; set; } = null!;
