...
namespace Pulumi.AzureNative.SecurityInsights.V20190101Preview
{
    public static class GetMSTIDataConnector
    {
        ...
        public static Task<GetMSTIDataConnectorResult> InvokeAsync(GetMSTIDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMSTIDataConnectorResult>("azure-native:securityinsights/v20190101preview:getMSTIDataConnector", args ?? new GetMSTIDataConnectorArgs(), options.WithVersion());

        /// <summary>
        /// Represents Microsoft Threat Intelligence data connector.
        /// </summary>
        public static Output<GetMSTIDataConnectorResult> Invoke(GetMSTIDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMSTIDataConnectorResult>("azure-native:securityinsights/v20190101preview:getMSTIDataConnector", args ?? new GetMSTIDataConnectorInvokeArgs(), options.WithVersion());
    }
