...
namespace Pulumi.AzureRM.SecurityInsights.V20190101Preview
{
    ...
    public partial class CaseRelation : Pulumi.CustomResource
    {
        ...
        public CaseRelation(string name, CaseRelationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/v20190101preview:CaseRelation", name, args ?? new CaseRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CaseRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/v20190101preview:CaseRelation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:securityinsights/preview:CaseRelation"},
                },
            };
