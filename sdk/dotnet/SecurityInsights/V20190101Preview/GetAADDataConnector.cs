...
namespace Pulumi.AzureNative.SecurityInsights.V20190101Preview
{
    public static class GetAADDataConnector
    {
        ...
        public static Task<GetAADDataConnectorResult> InvokeAsync(GetAADDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAADDataConnectorResult>("azure-native:securityinsights/v20190101preview:getAADDataConnector", args ?? new GetAADDataConnectorArgs(), options.WithVersion());

        /// <summary>
        /// Represents AAD (Azure Active Directory) data connector.
        /// </summary>
        public static Output<GetAADDataConnectorResult> Invoke(GetAADDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAADDataConnectorResult>("azure-native:securityinsights/v20190101preview:getAADDataConnector", args ?? new GetAADDataConnectorInvokeArgs(), options.WithVersion());
    }
