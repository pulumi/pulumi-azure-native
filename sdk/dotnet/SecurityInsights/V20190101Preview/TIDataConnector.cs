...
namespace Pulumi.AzureNative.SecurityInsights.V20190101Preview
{
    ...
    /// {
    ///     var tiDataConnector = new AzureNative.SecurityInsights.V20190101Preview.TIDataConnector("tiDataConnector", new()
    ///     {
    ...
    ///     {
    ///         DataConnectorId = "73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    ///         DataTypes = new AzureNative.SecurityInsights.V20190101Preview.Inputs.TIDataConnectorDataTypesArgs
    ///         {
    ///             Indicators = new AzureNative.SecurityInsights.V20190101Preview.Inputs.TIDataConnectorDataTypesIndicatorsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
