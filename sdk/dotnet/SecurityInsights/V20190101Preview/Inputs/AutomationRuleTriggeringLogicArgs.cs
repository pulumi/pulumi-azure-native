...
namespace Pulumi.AzureNative.SecurityInsights.V20190101Preview.Inputs
{
    ...
    public sealed class AutomationRuleTriggeringLogicArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20190101Preview.TriggersOn> TriggersOn { get; set; } = null!;

        /// <summary>
        /// The type of event the automation rule triggers on
        /// </summary>
        [Input("triggersWhen", required: true)]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20190101Preview.TriggersWhen> TriggersWhen { get; set; } = null!;
