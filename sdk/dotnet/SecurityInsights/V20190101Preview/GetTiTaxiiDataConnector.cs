...
namespace Pulumi.AzureNative.SecurityInsights.V20190101Preview
{
    public static class GetTiTaxiiDataConnector
    {
        ...
        public static Task<GetTiTaxiiDataConnectorResult> InvokeAsync(GetTiTaxiiDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTiTaxiiDataConnectorResult>("azure-native:securityinsights/v20190101preview:getTiTaxiiDataConnector", args ?? new GetTiTaxiiDataConnectorArgs(), options.WithVersion());
        ...
        public static Output<GetTiTaxiiDataConnectorResult> Invoke(GetTiTaxiiDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTiTaxiiDataConnectorResult>("azure-native:securityinsights/v20190101preview:getTiTaxiiDataConnector", args ?? new GetTiTaxiiDataConnectorInvokeArgs(), options.WithVersion());
    }
