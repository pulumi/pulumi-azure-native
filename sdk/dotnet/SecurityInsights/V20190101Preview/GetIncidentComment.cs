...
namespace Pulumi.AzureNative.SecurityInsights.V20190101Preview
{
    public static class GetIncidentComment
    {
        ...
        public static Task<GetIncidentCommentResult> InvokeAsync(GetIncidentCommentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIncidentCommentResult>("azure-native:securityinsights/v20190101preview:getIncidentComment", args ?? new GetIncidentCommentArgs(), options.WithDefaults());

        /// <summary>
        /// Represents an incident comment
        /// </summary>
        public static Output<GetIncidentCommentResult> Invoke(GetIncidentCommentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIncidentCommentResult>("azure-native:securityinsights/v20190101preview:getIncidentComment", args ?? new GetIncidentCommentInvokeArgs(), options.WithDefaults());
    }
