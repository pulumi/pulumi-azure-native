...
namespace Pulumi.AzureNative.SecurityInsights.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20241001preview:BookmarkRelation")]
    public partial class BookmarkRelation : global::Pulumi.CustomResource
    {
        ...
        public BookmarkRelation(string name, BookmarkRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:BookmarkRelation", name, args ?? new BookmarkRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BookmarkRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:BookmarkRelation", name, null, MakeResourceOptions(options, id))
        {
        }
