...
namespace Pulumi.AzureNative.SecurityInsights.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20241001preview:ContentTemplate")]
    public partial class ContentTemplate : global::Pulumi.CustomResource
    {
        ...
        public ContentTemplate(string name, ContentTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:ContentTemplate", name, args ?? new ContentTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:ContentTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContentTemplateArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.Kind> ContentKind { get; set; } = null!;
        ...
        /// </summary>
        [Input("packageKind")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.PackageKind>? PackageKind { get; set; }
