...
namespace Pulumi.AzureNative.SecurityInsights.V20241001Preview.Inputs
{
    ...
    public sealed class SapAgentConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.KeyVaultAuthenticationMode>? KeyVaultAuthenticationMode { get; set; }
        ...
        /// </summary>
        [Input("secretSource")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.SecretSource>? SecretSource { get; set; }
