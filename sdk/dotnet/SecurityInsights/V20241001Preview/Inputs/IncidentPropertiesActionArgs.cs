...
namespace Pulumi.AzureNative.SecurityInsights.V20241001Preview.Inputs
{
    ...
    public sealed class IncidentPropertiesActionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.IncidentClassification>? Classification { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.IncidentClassificationReason>? ClassificationReason { get; set; }
        ...
        /// </summary>
        [Input("severity")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.IncidentSeverity>? Severity { get; set; }

        /// <summary>
        /// The status of the incident
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.IncidentStatus>? Status { get; set; }
