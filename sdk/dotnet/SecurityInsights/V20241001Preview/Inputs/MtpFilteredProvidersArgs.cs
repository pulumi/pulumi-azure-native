...
namespace Pulumi.AzureNative.SecurityInsights.V20241001Preview.Inputs
{
    ...
    public sealed class MtpFilteredProvidersArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.MtpProvider>>? _alerts;
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.MtpProvider>> Alerts
        {
            get => _alerts ?? (_alerts = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.MtpProvider>>());
            set => _alerts = value;
        }
