...
namespace Pulumi.AzureNative.SecurityInsights.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20241001preview:HuntRelation")]
    public partial class HuntRelation : global::Pulumi.CustomResource
    {
        ...
        public HuntRelation(string name, HuntRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:HuntRelation", name, args ?? new HuntRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HuntRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:HuntRelation", name, null, MakeResourceOptions(options, id))
        {
        }
