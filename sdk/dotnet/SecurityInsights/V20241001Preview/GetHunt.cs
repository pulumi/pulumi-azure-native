...
namespace Pulumi.AzureNative.SecurityInsights.V20241001Preview
{
    public static class GetHunt
    {
        ...
        public static Task<GetHuntResult> InvokeAsync(GetHuntArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHuntResult>("azure-native:securityinsights/v20241001preview:getHunt", args ?? new GetHuntArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a hunt, without relations and comments.
        /// </summary>
        public static Output<GetHuntResult> Invoke(GetHuntInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHuntResult>("azure-native:securityinsights/v20241001preview:getHunt", args ?? new GetHuntInvokeArgs(), options.WithDefaults());
