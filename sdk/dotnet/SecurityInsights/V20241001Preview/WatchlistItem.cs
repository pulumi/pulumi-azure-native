...
namespace Pulumi.AzureNative.SecurityInsights.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20241001preview:WatchlistItem")]
    public partial class WatchlistItem : global::Pulumi.CustomResource
    {
        ...
        public WatchlistItem(string name, WatchlistItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:WatchlistItem", name, args ?? new WatchlistItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WatchlistItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:WatchlistItem", name, null, MakeResourceOptions(options, id))
        {
        }
