...
{
    [AzureNativeResourceType("azure-native:securityinsights/v20241001preview:Incident")]
    public partial class Incident : global::Pulumi.CustomResource
    {
        ...
        public Incident(string name, IncidentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:Incident", name, args ?? new IncidentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Incident(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:Incident", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IncidentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.IncidentSeverity> Severity { get; set; } = null!;

        /// <summary>
        /// The status of the incident
        /// </summary>
        [Input("status", required: true)]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.IncidentStatus> Status { get; set; } = null!;
