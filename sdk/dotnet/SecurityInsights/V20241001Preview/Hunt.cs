...
namespace Pulumi.AzureNative.SecurityInsights.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20241001preview:Hunt")]
    public partial class Hunt : global::Pulumi.CustomResource
    {
        ...
        public Hunt(string name, HuntArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:Hunt", name, args ?? new HuntArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Hunt(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20241001preview:Hunt", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("attackTactics")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.AttackTactic>>? _attackTactics;

        /// <summary>
        /// A list of mitre attack tactics the hunt is associated with
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.AttackTactic>> AttackTactics
        {
            get => _attackTactics ?? (_attackTactics = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.AttackTactic>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.HypothesisStatus>? HypothesisStatus { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20241001Preview.Status>? Status { get; set; }
