...
namespace Pulumi.AzureNative.SecurityInsights.V20231101
{
    public static class GetAADDataConnector
    {
        ...
        public static Task<GetAADDataConnectorResult> InvokeAsync(GetAADDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAADDataConnectorResult>("azure-native:securityinsights/v20231101:getAADDataConnector", args ?? new GetAADDataConnectorArgs(), options.WithDefaults());
