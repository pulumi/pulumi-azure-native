...
namespace Pulumi.AzureNative.SecurityInsights.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231101:Metadata")]
    public partial class Metadata : global::Pulumi.CustomResource
    {
        ...
        public Metadata(string name, MetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231101:Metadata", name, args ?? new MetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Metadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231101:Metadata", name, null, MakeResourceOptions(options, id))
        {
        }
