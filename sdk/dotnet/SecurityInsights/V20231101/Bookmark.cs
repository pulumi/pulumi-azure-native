...
namespace Pulumi.AzureNative.SecurityInsights.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231101:Bookmark")]
    public partial class Bookmark : global::Pulumi.CustomResource
    {
        ...
        public Bookmark(string name, BookmarkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231101:Bookmark", name, args ?? new BookmarkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bookmark(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231101:Bookmark", name, null, MakeResourceOptions(options, id))
        {
        }
