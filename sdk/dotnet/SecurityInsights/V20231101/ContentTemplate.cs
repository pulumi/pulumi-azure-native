...
namespace Pulumi.AzureNative.SecurityInsights.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231101:ContentTemplate")]
    public partial class ContentTemplate : global::Pulumi.CustomResource
    {
        ...
        public ContentTemplate(string name, ContentTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231101:ContentTemplate", name, args ?? new ContentTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231101:ContentTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContentTemplateArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20231101.Kind> ContentKind { get; set; } = null!;
        ...
        /// </summary>
        [Input("packageKind")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20231101.PackageKind>? PackageKind { get; set; }
