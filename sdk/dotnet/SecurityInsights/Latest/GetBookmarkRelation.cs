...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    public static class GetBookmarkRelation
    {
        public static Task<GetBookmarkRelationResult> InvokeAsync(GetBookmarkRelationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBookmarkRelationResult>("azurerm:securityinsights/latest:getBookmarkRelation", args ?? new GetBookmarkRelationArgs(), options.WithVersion());
    }
