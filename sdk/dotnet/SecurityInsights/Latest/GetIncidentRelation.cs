...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    public static class GetIncidentRelation
    {
        public static Task<GetIncidentRelationResult> InvokeAsync(GetIncidentRelationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIncidentRelationResult>("azurerm:securityinsights/latest:getIncidentRelation", args ?? new GetIncidentRelationArgs(), options.WithVersion());
    }
