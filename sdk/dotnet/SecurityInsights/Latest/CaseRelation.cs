...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var caseRelation = new AzureRM.SecurityInsights.Latest.CaseRelation("caseRelation", new AzureRM.SecurityInsights.Latest.CaseRelationArgs
    ///         {
    ///             CaseId = "afbd324f-6c48-459c-8710-8d1e1cd03812",
    ///             OperationalInsightsResourceProvider = "Microsoft.OperationalInsights",
    ///             RelationName = "4bb36b7b-26ff-4d1c-9cbe-0d8ab3da0014",
    ///             ResourceGroupName = "myRg",
    ///             SourceRelationNode = new AzureRM.SecurityInsights.Latest.Inputs.RelationNodeArgs
    ///             {
    ///                 RelationNodeId = "afbd324f-6c48-459c-8710-8d1e1cd03812",
    ///             },
    ///             TargetRelationNode = new AzureRM.SecurityInsights.Latest.Inputs.RelationNodeArgs
    ///             {
    ...
    public partial class CaseRelation : Pulumi.CustomResource
    {
        ...
        public CaseRelation(string name, CaseRelationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:CaseRelation", name, args ?? new CaseRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CaseRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:CaseRelation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:securityinsights/v20190101preview:CaseRelation"},
                },
            };
