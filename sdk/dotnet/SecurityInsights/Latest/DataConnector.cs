...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dataConnector = new AzureRM.SecurityInsights.Latest.DataConnector("dataConnector", new AzureRM.SecurityInsights.Latest.DataConnectorArgs
    ///         {
    ...
    public partial class DataConnector : Pulumi.CustomResource
    {
        ...
        public DataConnector(string name, DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:DataConnector", name, args ?? new DataConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
