...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    public static class GetAlertRuleAction
    {
        public static Task<GetAlertRuleActionResult> InvokeAsync(GetAlertRuleActionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleActionResult>("azurerm:securityinsights/latest:getAlertRuleAction", args ?? new GetAlertRuleActionArgs(), options.WithVersion());
    }
