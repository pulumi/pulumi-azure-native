...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var productSetting = new AzureRM.SecurityInsights.Latest.ProductSetting("productSetting", new AzureRM.SecurityInsights.Latest.ProductSettingArgs
    ///         {
    ...
    public partial class ProductSetting : Pulumi.CustomResource
    {
        ...
        public ProductSetting(string name, ProductSettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:ProductSetting", name, args ?? new ProductSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:ProductSetting", name, null, MakeResourceOptions(options, id))
        {
        }
