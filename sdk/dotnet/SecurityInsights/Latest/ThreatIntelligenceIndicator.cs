...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var threatIntelligenceIndicator = new AzureRM.SecurityInsights.Latest.ThreatIntelligenceIndicator("threatIntelligenceIndicator", new AzureRM.SecurityInsights.Latest.ThreatIntelligenceIndicatorArgs
    ///         {
    ///             Confidence = 78,
    ...
    public partial class ThreatIntelligenceIndicator : Pulumi.CustomResource
    {
        ...
        public ThreatIntelligenceIndicator(string name, ThreatIntelligenceIndicatorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:ThreatIntelligenceIndicator", name, args ?? new ThreatIntelligenceIndicatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ThreatIntelligenceIndicator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:ThreatIntelligenceIndicator", name, null, MakeResourceOptions(options, id))
        {
        }
