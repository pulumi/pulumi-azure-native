...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    public static class GetDataConnector
    {
        public static Task<GetDataConnectorResult> InvokeAsync(GetDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectorResult>("azurerm:securityinsights/latest:getDataConnector", args ?? new GetDataConnectorArgs(), options.WithVersion());
    }
