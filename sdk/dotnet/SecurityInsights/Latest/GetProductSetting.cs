...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    public static class GetProductSetting
    {
        public static Task<GetProductSettingResult> InvokeAsync(GetProductSettingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductSettingResult>("azurerm:securityinsights/latest:getProductSetting", args ?? new GetProductSettingArgs(), options.WithVersion());
    }
