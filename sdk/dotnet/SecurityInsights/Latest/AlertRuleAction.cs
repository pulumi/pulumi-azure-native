...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var alertRuleAction = new AzureRM.SecurityInsights.Latest.AlertRuleAction("alertRuleAction", new AzureRM.SecurityInsights.Latest.AlertRuleActionArgs
    ///         {
    ...
    public partial class AlertRuleAction : Pulumi.CustomResource
    {
        ...
        public AlertRuleAction(string name, AlertRuleActionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:AlertRuleAction", name, args ?? new AlertRuleActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRuleAction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:AlertRuleAction", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:securityinsights/v20190101preview:AlertRuleAction"},
                },
            };
