...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var @case = new AzureRM.SecurityInsights.Latest.Case("case", new AzureRM.SecurityInsights.Latest.CaseArgs
    ///         {
    ...
    ///             Owner = new AzureRM.SecurityInsights.Latest.Inputs.UserInfoArgs
    ///             {
    ...
    public partial class Case : Pulumi.CustomResource
    {
        ...
        public Case(string name, CaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:Case", name, args ?? new CaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Case(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:Case", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:securityinsights/v20190101preview:Case"},
                },
            };
