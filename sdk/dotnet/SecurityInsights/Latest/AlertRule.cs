...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var alertRule = new AzureRM.SecurityInsights.Latest.AlertRule("alertRule", new AzureRM.SecurityInsights.Latest.AlertRuleArgs
    ///         {
    ...
    public partial class AlertRule : Pulumi.CustomResource
    {
        ...
        public AlertRule(string name, AlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:AlertRule", name, args ?? new AlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:AlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:securityinsights/v20190101preview:AlertRule"},
                },
            };
