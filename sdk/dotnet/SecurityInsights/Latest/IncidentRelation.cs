...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var incidentRelation = new AzureRM.SecurityInsights.Latest.IncidentRelation("incidentRelation", new AzureRM.SecurityInsights.Latest.IncidentRelationArgs
    ///         {
    ...
    public partial class IncidentRelation : Pulumi.CustomResource
    {
        ...
        public IncidentRelation(string name, IncidentRelationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:IncidentRelation", name, args ?? new IncidentRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:IncidentRelation", name, null, MakeResourceOptions(options, id))
        {
        }
