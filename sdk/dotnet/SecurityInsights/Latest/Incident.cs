...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var incident = new AzureRM.SecurityInsights.Latest.Incident("incident", new AzureRM.SecurityInsights.Latest.IncidentArgs
    ///         {
    ...
    ///             Owner = new AzureRM.SecurityInsights.Latest.Inputs.IncidentOwnerInfoArgs
    ///             {
    ...
    public partial class Incident : Pulumi.CustomResource
    {
        ...
        public Incident(string name, IncidentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:Incident", name, args ?? new IncidentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Incident(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:Incident", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:securityinsights/v20190101preview:Incident"},
                },
            };
