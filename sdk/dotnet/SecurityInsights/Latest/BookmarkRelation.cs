...
namespace Pulumi.AzureRM.SecurityInsights.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var bookmarkRelation = new AzureRM.SecurityInsights.Latest.BookmarkRelation("bookmarkRelation", new AzureRM.SecurityInsights.Latest.BookmarkRelationArgs
    ///         {
    ...
    public partial class BookmarkRelation : Pulumi.CustomResource
    {
        ...
        public BookmarkRelation(string name, BookmarkRelationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:BookmarkRelation", name, args ?? new BookmarkRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BookmarkRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:securityinsights/latest:BookmarkRelation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:securityinsights/v20190101preview:BookmarkRelation"},
                },
            };
