...
namespace Pulumi.AzureNative.SecurityInsights.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230801preview:WorkspaceManagerConfiguration")]
    public partial class WorkspaceManagerConfiguration : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceManagerConfiguration(string name, WorkspaceManagerConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230801preview:WorkspaceManagerConfiguration", name, args ?? new WorkspaceManagerConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceManagerConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230801preview:WorkspaceManagerConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceManagerConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230801Preview.Mode> Mode { get; set; } = null!;
