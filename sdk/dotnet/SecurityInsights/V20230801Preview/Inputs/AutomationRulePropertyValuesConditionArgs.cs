...
namespace Pulumi.AzureNative.SecurityInsights.V20230801Preview.Inputs
{
    ...
    {
        [Input("operator")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230801Preview.AutomationRulePropertyConditionSupportedOperator>? Operator { get; set; }

        /// <summary>
        /// The property to evaluate in an automation rule property condition.
        /// </summary>
        [Input("propertyName")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230801Preview.AutomationRulePropertyConditionSupportedProperty>? PropertyName { get; set; }
