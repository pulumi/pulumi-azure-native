...
namespace Pulumi.AzureNative.SecurityInsights.V20230801Preview.Inputs
{
    ...
    {
        [Input("arrayType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230801Preview.AutomationRulePropertyArrayChangedConditionSupportedArrayType>? ArrayType { get; set; }

        [Input("changeType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230801Preview.AutomationRulePropertyArrayChangedConditionSupportedChangeType>? ChangeType { get; set; }
