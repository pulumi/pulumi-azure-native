...
namespace Pulumi.AzureNative.SecurityInsights.V20230801Preview
{
    public static class GetHuntComment
    {
        ...
        public static Task<GetHuntCommentResult> InvokeAsync(GetHuntCommentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHuntCommentResult>("azure-native:securityinsights/v20230801preview:getHuntComment", args ?? new GetHuntCommentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a hunt comment
        /// </summary>
        public static Output<GetHuntCommentResult> Invoke(GetHuntCommentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHuntCommentResult>("azure-native:securityinsights/v20230801preview:getHuntComment", args ?? new GetHuntCommentInvokeArgs(), options.WithDefaults());
