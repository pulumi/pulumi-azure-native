...
namespace Pulumi.AzureNative.SecurityInsights.V20230801Preview
{
    public static class GetIncidentTask
    {
        ...
        public static Task<GetIncidentTaskResult> InvokeAsync(GetIncidentTaskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIncidentTaskResult>("azure-native:securityinsights/v20230801preview:getIncidentTask", args ?? new GetIncidentTaskArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an incident task.
        /// </summary>
        public static Output<GetIncidentTaskResult> Invoke(GetIncidentTaskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIncidentTaskResult>("azure-native:securityinsights/v20230801preview:getIncidentTask", args ?? new GetIncidentTaskInvokeArgs(), options.WithDefaults());
