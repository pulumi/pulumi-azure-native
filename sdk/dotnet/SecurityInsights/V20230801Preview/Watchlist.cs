...
namespace Pulumi.AzureNative.SecurityInsights.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230801preview:Watchlist")]
    public partial class Watchlist : global::Pulumi.CustomResource
    {
        ...
        public Watchlist(string name, WatchlistArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230801preview:Watchlist", name, args ?? new WatchlistArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Watchlist(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230801preview:Watchlist", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WatchlistArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sourceType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230801Preview.SourceType>? SourceType { get; set; }
