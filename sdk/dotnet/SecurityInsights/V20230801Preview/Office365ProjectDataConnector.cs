...
namespace Pulumi.AzureNative.SecurityInsights.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230801preview:Office365ProjectDataConnector")]
    public partial class Office365ProjectDataConnector : global::Pulumi.CustomResource
    {
        ...
        public Office365ProjectDataConnector(string name, Office365ProjectDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230801preview:Office365ProjectDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Office365ProjectDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230801preview:Office365ProjectDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
