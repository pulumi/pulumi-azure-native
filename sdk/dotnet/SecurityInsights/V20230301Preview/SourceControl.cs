...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var sourceControl = new AzureNative.SecurityInsights.V20230301Preview.SourceControl("sourceControl", new()
    ///     {
    ///         ContentTypes = new[]
    ///         {
    ///             "AnalyticRules",
    ...
    ///         RepoType = "Github",
    ///         Repository = new AzureNative.SecurityInsights.V20230301Preview.Inputs.RepositoryArgs
    ///         {
    ///             Branch = "master",
    ///             DisplayUrl = "https://github.com/user/repo",
    ///             PathMapping = new[]
    ///             {
    ///                 new AzureNative.SecurityInsights.V20230301Preview.Inputs.ContentPathMapArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:SourceControl")]
    public partial class SourceControl : global::Pulumi.CustomResource
    {
        ...
        public SourceControl(string name, SourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:SourceControl", name, args ?? new SourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:SourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.ContentType>>? _contentTypes;

        /// <summary>
        /// Array of source control content types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.ContentType>> ContentTypes
        {
            get => _contentTypes ?? (_contentTypes = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.ContentType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.RepoType> RepoType { get; set; } = null!;
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.Version>? Version { get; set; }
