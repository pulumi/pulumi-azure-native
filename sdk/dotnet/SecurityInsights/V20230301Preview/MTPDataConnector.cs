...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var mtpDataConnector = new AzureNative.SecurityInsights.V20230301Preview.MTPDataConnector("mtpDataConnector", new()
    ///     {
    ...
    ///         DataTypes = new AzureNative.SecurityInsights.V20230301Preview.Inputs.MTPDataConnectorDataTypesArgs
    ///         {
    ///             Alerts = new AzureNative.SecurityInsights.V20230301Preview.Inputs.MTPDataConnectorDataTypesAlertsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///             Incidents = new AzureNative.SecurityInsights.V20230301Preview.Inputs.MTPDataConnectorDataTypesIncidentsArgs
    ///             {
    ///                 State = "Disabled",
    ///             },
    ///         },
    ///         FilteredProviders = new AzureNative.SecurityInsights.V20230301Preview.Inputs.MtpFilteredProvidersArgs
    ///         {
    ///             Alerts = new[]
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:MTPDataConnector")]
    public partial class MTPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MTPDataConnector(string name, MTPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:MTPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MTPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:MTPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
