...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var anomalySecurityMLAnalyticsSettings = new AzureNative.SecurityInsights.V20230301Preview.AnomalySecurityMLAnalyticsSettings("anomalySecurityMLAnalyticsSettings", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.SecurityInsights.V20230301Preview.Inputs.SecurityMLAnalyticsSettingsDataSourceArgs
    ///             {
    ///                 ConnectorId = "AWS",
    ///                 DataTypes = new[]
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:AnomalySecurityMLAnalyticsSettings")]
    public partial class AnomalySecurityMLAnalyticsSettings : global::Pulumi.CustomResource
    {
        ...
        public AnomalySecurityMLAnalyticsSettings(string name, AnomalySecurityMLAnalyticsSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:AnomalySecurityMLAnalyticsSettings", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AnomalySecurityMLAnalyticsSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:AnomalySecurityMLAnalyticsSettings", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AnomalySecurityMLAnalyticsSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.SettingsStatus> SettingsStatus { get; set; } = null!;

        [Input("tactics")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.AttackTactic>>? _tactics;

        /// <summary>
        /// The tactics of the SecurityMLAnalyticsSettings
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.AttackTactic>> Tactics
        {
            get => _tactics ?? (_tactics = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.AttackTactic>>());
            set => _tactics = value;
        }
