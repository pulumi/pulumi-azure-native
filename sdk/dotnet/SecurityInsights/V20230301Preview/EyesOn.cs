...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var eyesOn = new AzureNative.SecurityInsights.V20230301Preview.EyesOn("eyesOn", new()
    ///     {
    ///         Kind = "EyesOn",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20230301preview:EyesOn EyesOn /subscriptions/bd794837-4d29-4647-9105-6339bfdb4e6a/resourceGroups/mms-eus/providers/Microsoft.OperationalInsights/workspaces/avdvirInt/providers/Microsoft.SecurityInsights/settings/EyesOn 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:EyesOn")]
    public partial class EyesOn : global::Pulumi.CustomResource
    {
        ...
        public EyesOn(string name, EyesOnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:EyesOn", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EyesOn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:EyesOn", name, null, MakeResourceOptions(options, id))
        {
        }
