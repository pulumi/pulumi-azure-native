...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var microsoftSecurityIncidentCreationAlertRule = new AzureNative.SecurityInsights.V20230301Preview.MicrosoftSecurityIncidentCreationAlertRule("microsoftSecurityIncidentCreationAlertRule", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20230301preview:MicrosoftSecurityIncidentCreationAlertRule 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalIinsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/alertRules/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:MicrosoftSecurityIncidentCreationAlertRule")]
    public partial class MicrosoftSecurityIncidentCreationAlertRule : global::Pulumi.CustomResource
    {
        ...
        public MicrosoftSecurityIncidentCreationAlertRule(string name, MicrosoftSecurityIncidentCreationAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:MicrosoftSecurityIncidentCreationAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MicrosoftSecurityIncidentCreationAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:MicrosoftSecurityIncidentCreationAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MicrosoftSecurityIncidentCreationAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.MicrosoftSecurityProductName> ProductFilter { get; set; } = null!;
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.AlertSeverity>>? _severitiesFilter;

        /// <summary>
        /// the alerts' severities on which the cases will be generated
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.AlertSeverity>> SeveritiesFilter
        {
            get => _severitiesFilter ?? (_severitiesFilter = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.AlertSeverity>>());
