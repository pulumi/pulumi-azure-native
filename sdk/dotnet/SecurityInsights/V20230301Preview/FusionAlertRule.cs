...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var fusionAlertRule = new AzureNative.SecurityInsights.V20230301Preview.FusionAlertRule("fusionAlertRule", new()
    ///     {
    ...
    ///         SourceSettings = new[]
    ///         {
    ///             new AzureNative.SecurityInsights.V20230301Preview.Inputs.FusionSourceSettingsArgs
    ///             {
    ///                 Enabled = true,
    ...
    ///                 SourceSubTypes = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20230301Preview.Inputs.FusionSourceSubTypeSettingArgs
    ///                     {
    ///                         Enabled = true,
    ///                         SeverityFilters = new AzureNative.SecurityInsights.V20230301Preview.Inputs.FusionSubTypeSeverityFilterArgs
    ///                         {
    ///                             Filters = new[]
    ///                             {
    ///                                 new AzureNative.SecurityInsights.V20230301Preview.Inputs.FusionSubTypeSeverityFiltersItemArgs
    ///                                 {
    ///                                     Enabled = true,
    ///                                     Severity = "High",
    ///                                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:FusionAlertRule")]
    public partial class FusionAlertRule : global::Pulumi.CustomResource
    {
        ...
        public FusionAlertRule(string name, FusionAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:FusionAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FusionAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:FusionAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
