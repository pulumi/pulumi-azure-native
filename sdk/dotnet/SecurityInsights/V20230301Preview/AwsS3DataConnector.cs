...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var awsS3DataConnector = new AzureNative.SecurityInsights.V20230301Preview.AwsS3DataConnector("awsS3DataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:AwsS3DataConnector")]
    public partial class AwsS3DataConnector : global::Pulumi.CustomResource
    {
        ...
        public AwsS3DataConnector(string name, AwsS3DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:AwsS3DataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AwsS3DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:AwsS3DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
