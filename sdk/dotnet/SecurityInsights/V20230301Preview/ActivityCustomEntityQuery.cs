...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var activityCustomEntityQuery = new AzureNative.SecurityInsights.V20230301Preview.ActivityCustomEntityQuery("activityCustomEntityQuery", new()
    ///     {
    ...
    ///         Kind = "Activity",
    ///         QueryDefinitions = new AzureNative.SecurityInsights.V20230301Preview.Inputs.ActivityEntityQueriesPropertiesQueryDefinitionsArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:ActivityCustomEntityQuery")]
    public partial class ActivityCustomEntityQuery : global::Pulumi.CustomResource
    {
        ...
        public ActivityCustomEntityQuery(string name, ActivityCustomEntityQueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:ActivityCustomEntityQuery", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ActivityCustomEntityQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:ActivityCustomEntityQuery", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ActivityCustomEntityQueryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.EntityType>? InputEntityType { get; set; }
