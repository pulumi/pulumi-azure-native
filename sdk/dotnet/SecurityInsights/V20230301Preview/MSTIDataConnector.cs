...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var mstiDataConnector = new AzureNative.SecurityInsights.V20230301Preview.MSTIDataConnector("mstiDataConnector", new()
    ///     {
    ...
    ///         DataTypes = new AzureNative.SecurityInsights.V20230301Preview.Inputs.MSTIDataConnectorDataTypesArgs
    ///         {
    ///             MicrosoftEmergingThreatFeed = new AzureNative.SecurityInsights.V20230301Preview.Inputs.MSTIDataConnectorDataTypesMicrosoftEmergingThreatFeedArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:MSTIDataConnector")]
    public partial class MSTIDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MSTIDataConnector(string name, MSTIDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:MSTIDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MSTIDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:MSTIDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
