...
namespace Pulumi.AzureNative.SecurityInsights.V20230301Preview
{
    ...
    /// {
    ///     var fileImport = new AzureNative.SecurityInsights.V20230301Preview.FileImport("fileImport", new()
    ///     {
    ///         ContentType = "StixIndicator",
    ///         FileImportId = "73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    ///         ImportFile = new AzureNative.SecurityInsights.V20230301Preview.Inputs.FileMetadataArgs
    ///         {
    ///             FileFormat = "JSON",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230301preview:FileImport")]
    public partial class FileImport : global::Pulumi.CustomResource
    {
        ...
        public FileImport(string name, FileImportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:FileImport", name, args ?? new FileImportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileImport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230301preview:FileImport", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FileImportArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.FileImportContentType> ContentType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230301Preview.IngestionMode> IngestionMode { get; set; } = null!;
