...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    public static class GetEntitiesGetTimeline
    {
        ...
        public static Task<GetEntitiesGetTimelineResult> InvokeAsync(GetEntitiesGetTimelineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEntitiesGetTimelineResult>("azure-native:securityinsights/v20230401preview:getEntitiesGetTimeline", args ?? new GetEntitiesGetTimelineArgs(), options.WithDefaults());
        ...
        public static Output<GetEntitiesGetTimelineResult> Invoke(GetEntitiesGetTimelineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEntitiesGetTimelineResult>("azure-native:securityinsights/v20230401preview:getEntitiesGetTimeline", args ?? new GetEntitiesGetTimelineInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetEntitiesGetTimelineArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("kinds")]
        private List<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.EntityTimelineKind>>? _kinds;

        /// <summary>
        /// Array of timeline Item kinds.
        /// </summary>
        public List<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.EntityTimelineKind>> Kinds
        {
            get => _kinds ?? (_kinds = new List<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.EntityTimelineKind>>());
            set => _kinds = value;
        }
    ...
    public sealed class GetEntitiesGetTimelineInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("kinds")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.EntityTimelineKind>>? _kinds;

        /// <summary>
        /// Array of timeline Item kinds.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.EntityTimelineKind>> Kinds
        {
            get => _kinds ?? (_kinds = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.EntityTimelineKind>>());
            set => _kinds = value;
        }
