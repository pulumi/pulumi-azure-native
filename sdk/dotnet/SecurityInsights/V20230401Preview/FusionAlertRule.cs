...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var fusionAlertRule = new AzureNative.SecurityInsights.V20230401Preview.FusionAlertRule("fusionAlertRule", new()
    ///     {
    ...
    ///         SourceSettings = new[]
    ///         {
    ///             new AzureNative.SecurityInsights.V20230401Preview.Inputs.FusionSourceSettingsArgs
    ///             {
    ///                 Enabled = true,
    ...
    ///                 SourceSubTypes = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20230401Preview.Inputs.FusionSourceSubTypeSettingArgs
    ///                     {
    ///                         Enabled = true,
    ///                         SeverityFilters = new AzureNative.SecurityInsights.V20230401Preview.Inputs.FusionSubTypeSeverityFilterArgs
    ///                         {
    ///                             Filters = new[]
    ///                             {
    ///                                 new AzureNative.SecurityInsights.V20230401Preview.Inputs.FusionSubTypeSeverityFiltersItemArgs
    ///                                 {
    ///                                     Enabled = true,
    ///                                     Severity = "High",
    ///                                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230401preview:FusionAlertRule")]
    public partial class FusionAlertRule : global::Pulumi.CustomResource
    {
        ...
        public FusionAlertRule(string name, FusionAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:FusionAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FusionAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:FusionAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
