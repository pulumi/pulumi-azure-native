...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var metadata = new AzureNative.SecurityInsights.V20230401Preview.Metadata("metadata", new()
    ///     {
    ...
    ///             Name = "User Name",
    ///         },
    ///         Categories = new AzureNative.SecurityInsights.V20230401Preview.Inputs.MetadataCategoriesArgs
    ///         {
    ///             Domains = new[]
    ///             {
    ///                 "Application",
    ...
    ///         CustomVersion = "1.0",
    ///         Dependencies = new AzureNative.SecurityInsights.V20230401Preview.Inputs.MetadataDependenciesArgs
    ///         {
    ///             Criteria = new[]
    ///             {
    ///                 new AzureNative.SecurityInsights.V20230401Preview.Inputs.MetadataDependenciesArgs
    ///                 {
    ///                     Criteria = new[]
    ///                     {
    ///                         new AzureNative.SecurityInsights.V20230401Preview.Inputs.MetadataDependenciesArgs
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230401preview:Metadata")]
    public partial class Metadata : global::Pulumi.CustomResource
    {
        ...
        public Metadata(string name, MetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:Metadata", name, args ?? new MetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Metadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:Metadata", name, null, MakeResourceOptions(options, id))
        {
        }
