...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var ascDataConnector = new AzureNative.SecurityInsights.V20230401Preview.ASCDataConnector("ascDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230401preview:ASCDataConnector")]
    public partial class ASCDataConnector : global::Pulumi.CustomResource
    {
        ...
        public ASCDataConnector(string name, ASCDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:ASCDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ASCDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:ASCDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
