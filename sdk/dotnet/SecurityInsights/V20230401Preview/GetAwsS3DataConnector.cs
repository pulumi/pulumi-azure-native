...
{
    [Obsolete(@"azure-native:securityinsights/v20230401preview:AwsS3DataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:AwsS3DataConnector to guarantee forwards compatibility.")]
    public static class GetAwsS3DataConnector
    {
        ...
        public static Task<GetAwsS3DataConnectorResult> InvokeAsync(GetAwsS3DataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAwsS3DataConnectorResult>("azure-native:securityinsights/v20230401preview:getAwsS3DataConnector", args ?? new GetAwsS3DataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a data connector.
        /// </summary>
        public static Output<GetAwsS3DataConnectorResult> Invoke(GetAwsS3DataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAwsS3DataConnectorResult>("azure-native:securityinsights/v20230401preview:getAwsS3DataConnector", args ?? new GetAwsS3DataConnectorInvokeArgs(), options.WithDefaults());
    }
