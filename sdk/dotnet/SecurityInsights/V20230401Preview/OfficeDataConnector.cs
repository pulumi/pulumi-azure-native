...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var officeDataConnector = new AzureNative.SecurityInsights.V20230401Preview.OfficeDataConnector("officeDataConnector", new()
    ///     {
    ...
    ///     {
    ///         DataConnectorId = "73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    ///         DataTypes = new AzureNative.SecurityInsights.V20230401Preview.Inputs.OfficeDataConnectorDataTypesArgs
    ///         {
    ///             Exchange = new AzureNative.SecurityInsights.V20230401Preview.Inputs.OfficeDataConnectorDataTypesExchangeArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///             SharePoint = new AzureNative.SecurityInsights.V20230401Preview.Inputs.OfficeDataConnectorDataTypesSharePointArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///             Teams = new AzureNative.SecurityInsights.V20230401Preview.Inputs.OfficeDataConnectorDataTypesTeamsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230401preview:OfficeDataConnector")]
    public partial class OfficeDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficeDataConnector(string name, OfficeDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:OfficeDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficeDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:OfficeDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
