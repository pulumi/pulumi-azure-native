...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var mtpDataConnector = new AzureNative.SecurityInsights.V20230401Preview.MTPDataConnector("mtpDataConnector", new()
    ///     {
    ...
    ///         DataTypes = new AzureNative.SecurityInsights.V20230401Preview.Inputs.MTPDataConnectorDataTypesArgs
    ///         {
    ///             Alerts = new AzureNative.SecurityInsights.V20230401Preview.Inputs.MTPDataConnectorDataTypesAlertsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///             Incidents = new AzureNative.SecurityInsights.V20230401Preview.Inputs.MTPDataConnectorDataTypesIncidentsArgs
    ///             {
    ///                 State = "Disabled",
    ///             },
    ///         },
    ///         FilteredProviders = new AzureNative.SecurityInsights.V20230401Preview.Inputs.MtpFilteredProvidersArgs
    ///         {
    ///             Alerts = new[]
    ///             {
    ...
    public partial class MTPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MTPDataConnector(string name, MTPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:MTPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MTPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:MTPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
