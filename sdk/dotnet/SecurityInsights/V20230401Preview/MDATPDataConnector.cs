...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var mdatpDataConnector = new AzureNative.SecurityInsights.V20230401Preview.MDATPDataConnector("mdatpDataConnector", new()
    ///     {
    ...
    public partial class MDATPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MDATPDataConnector(string name, MDATPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:MDATPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MDATPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:MDATPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
