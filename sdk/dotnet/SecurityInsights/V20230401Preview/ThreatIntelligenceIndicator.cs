...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var threatIntelligenceIndicator = new AzureNative.SecurityInsights.V20230401Preview.ThreatIntelligenceIndicator("threatIntelligenceIndicator", new()
    ///     {
    ///         Confidence = 78,
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20230401preview:ThreatIntelligenceIndicator 180105c7-a28d-b1a2-4a78-234f6ec80fd6 /subscriptions/bd794837-4d29-4647-9105-6339bfdb4e6a/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/ThreatIntelligence/180105c7-a28d-b1a2-4a78-234f6ec80fd6 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230401preview:ThreatIntelligenceIndicator")]
    public partial class ThreatIntelligenceIndicator : global::Pulumi.CustomResource
    {
        ...
        public ThreatIntelligenceIndicator(string name, ThreatIntelligenceIndicatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:ThreatIntelligenceIndicator", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ThreatIntelligenceIndicator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:ThreatIntelligenceIndicator", name, null, MakeResourceOptions(options, id))
        {
        }
