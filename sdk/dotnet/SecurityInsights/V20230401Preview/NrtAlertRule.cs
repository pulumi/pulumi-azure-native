...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var nrtAlertRule = new AzureNative.SecurityInsights.V20230401Preview.NrtAlertRule("nrtAlertRule", new()
    ///     {
    ...
    ///         DisplayName = "Rule2",
    ///         Enabled = true,
    ///         EventGroupingSettings = new AzureNative.SecurityInsights.V20230401Preview.Inputs.EventGroupingSettingsArgs
    ///         {
    ///             AggregationKind = "AlertPerResult",
    ///         },
    ///         IncidentConfiguration = new AzureNative.SecurityInsights.V20230401Preview.Inputs.IncidentConfigurationArgs
    ///         {
    ///             CreateIncident = true,
    ///             GroupingConfiguration = new AzureNative.SecurityInsights.V20230401Preview.Inputs.GroupingConfigurationArgs
    ///             {
    ///                 Enabled = true,
    ///                 GroupByEntities = new[]
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230401preview:NrtAlertRule")]
    public partial class NrtAlertRule : global::Pulumi.CustomResource
    {
        ...
        public NrtAlertRule(string name, NrtAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:NrtAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private NrtAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:NrtAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
