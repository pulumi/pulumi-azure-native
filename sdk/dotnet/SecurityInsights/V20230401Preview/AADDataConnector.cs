...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20230401preview:AADDataConnector")]
    public partial class AADDataConnector : global::Pulumi.CustomResource
    {
        ...
        public AADDataConnector(string name, AADDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:AADDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AADDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:AADDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
