...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var incidentComment = new AzureNative.SecurityInsights.V20230401Preview.IncidentComment("incidentComment", new()
    ///     {
    ...
    public partial class IncidentComment : global::Pulumi.CustomResource
    {
        ...
        public IncidentComment(string name, IncidentCommentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:IncidentComment", name, args ?? new IncidentCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:IncidentComment", name, null, MakeResourceOptions(options, id))
        {
        }
