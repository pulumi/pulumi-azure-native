...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20230401preview:Hunt is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Hunt to guarantee forwards compatibility.")]
    ...
    public partial class Hunt : global::Pulumi.CustomResource
    {
        ...
        public Hunt(string name, HuntArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:Hunt", name, args ?? new HuntArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Hunt(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:Hunt", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("attackTactics")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.AttackTactic>>? _attackTactics;

        /// <summary>
        /// A list of mitre attack tactics the hunt is associated with
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.AttackTactic>> AttackTactics
        {
            get => _attackTactics ?? (_attackTactics = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.AttackTactic>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.HypothesisStatus>? HypothesisStatus { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.Status>? Status { get; set; }
