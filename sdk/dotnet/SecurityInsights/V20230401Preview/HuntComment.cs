...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    public partial class HuntComment : global::Pulumi.CustomResource
    {
        ...
        public HuntComment(string name, HuntCommentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:HuntComment", name, args ?? new HuntCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HuntComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:HuntComment", name, null, MakeResourceOptions(options, id))
        {
        }
