...
namespace Pulumi.AzureNative.SecurityInsights.V20230401Preview
{
    ...
    /// {
    ///     var anomalySecurityMLAnalyticsSettings = new AzureNative.SecurityInsights.V20230401Preview.AnomalySecurityMLAnalyticsSettings("anomalySecurityMLAnalyticsSettings", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.SecurityInsights.V20230401Preview.Inputs.SecurityMLAnalyticsSettingsDataSourceArgs
    ///             {
    ///                 ConnectorId = "AWS",
    ///                 DataTypes = new[]
    ///                 {
    ...
    public partial class AnomalySecurityMLAnalyticsSettings : global::Pulumi.CustomResource
    {
        ...
        public AnomalySecurityMLAnalyticsSettings(string name, AnomalySecurityMLAnalyticsSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:AnomalySecurityMLAnalyticsSettings", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AnomalySecurityMLAnalyticsSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230401preview:AnomalySecurityMLAnalyticsSettings", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AnomalySecurityMLAnalyticsSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.SettingsStatus> SettingsStatus { get; set; } = null!;

        [Input("tactics")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.AttackTactic>>? _tactics;

        /// <summary>
        /// The tactics of the SecurityMLAnalyticsSettings
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.AttackTactic>> Tactics
        {
            get => _tactics ?? (_tactics = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230401Preview.AttackTactic>>());
            set => _tactics = value;
        }
