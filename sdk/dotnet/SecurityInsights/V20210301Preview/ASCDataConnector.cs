...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    ...
    /// {
    ///     var ascDataConnector = new AzureNative.SecurityInsights.V20210301Preview.ASCDataConnector("ascDataConnector", new()
    ///     {
