...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    ...
    public static class GetProductSetting
    {
        ...
        public static Output<GetProductSettingResult> Invoke(GetProductSettingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProductSettingResult>("azure-native:securityinsights/v20210301preview:getProductSetting", args ?? new GetProductSettingInvokeArgs(), options.WithVersion());
    }
