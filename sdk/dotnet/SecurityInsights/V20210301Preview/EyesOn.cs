...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20210301preview:EyesOn")]
    public partial class EyesOn : Pulumi.CustomResource
    {
        ...
        public EyesOn(string name, EyesOnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:EyesOn", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EyesOn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:EyesOn", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:securityinsights/v20210301preview:EyesOn"},
                    new Pulumi.Alias { Type = "azure-native:securityinsights:EyesOn"},
                    new Pulumi.Alias { Type = "azure-nextgen:securityinsights:EyesOn"},
                    new Pulumi.Alias { Type = "azure-native:securityinsights/v20190101preview:EyesOn"},
                    new Pulumi.Alias { Type = "azure-nextgen:securityinsights/v20190101preview:EyesOn"},
                },
            };
