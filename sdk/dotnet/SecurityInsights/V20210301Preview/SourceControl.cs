...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    ...
    /// {
    ///     var sourceControl = new AzureNative.SecurityInsights.V20210301Preview.SourceControl("sourceControl", new()
    ///     {
    ///         ContentTypes = new[]
    ///         {
    ///             "AnalyticRules",
    ...
    ///         RepoType = "Github",
    ///         Repository = new AzureNative.SecurityInsights.V20210301Preview.Inputs.RepositoryArgs
    ///         {
    ///             Branch = "master",
    ///             DisplayUrl = "https://github.com/user/repo",
    ///             PathMapping = new[]
    ///             {
    ///                 new AzureNative.SecurityInsights.V20210301Preview.Inputs.ContentPathMapArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20210301preview:SourceControl")]
    public partial class SourceControl : global::Pulumi.CustomResource
    {
        ...
        public SourceControl(string name, SourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:SourceControl", name, args ?? new SourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:SourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.ContentType>>? _contentTypes;

        /// <summary>
        /// Array of source control content types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.ContentType>> ContentTypes
        {
            get => _contentTypes ?? (_contentTypes = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.ContentType>>());
        ...
        /// </summary>
        [Input("createdByType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.CreatedByType>? CreatedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.CreatedByType>? LastModifiedByType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.RepoType> RepoType { get; set; } = null!;
