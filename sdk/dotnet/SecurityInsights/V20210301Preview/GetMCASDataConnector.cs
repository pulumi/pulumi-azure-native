...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    public static class GetMCASDataConnector
    {
        ...
        public static Output<GetMCASDataConnectorResult> Invoke(GetMCASDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMCASDataConnectorResult>("azure-native:securityinsights/v20210301preview:getMCASDataConnector", args ?? new GetMCASDataConnectorInvokeArgs(), options.WithVersion());
    }
