...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20210301preview:MDATPDataConnector")]
    public partial class MDATPDataConnector : Pulumi.CustomResource
    {
        ...
        public MDATPDataConnector(string name, MDATPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:MDATPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MDATPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:MDATPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:securityinsights/v20210301preview:MDATPDataConnector"},
                    new Pulumi.Alias { Type = "azure-native:securityinsights:MDATPDataConnector"},
                    new Pulumi.Alias { Type = "azure-nextgen:securityinsights:MDATPDataConnector"},
                    new Pulumi.Alias { Type = "azure-native:securityinsights/v20190101preview:MDATPDataConnector"},
                    new Pulumi.Alias { Type = "azure-nextgen:securityinsights/v20190101preview:MDATPDataConnector"},
                    new Pulumi.Alias { Type = "azure-native:securityinsights/v20200101:MDATPDataConnector"},
                    new Pulumi.Alias { Type = "azure-nextgen:securityinsights/v20200101:MDATPDataConnector"},
                },
            };
