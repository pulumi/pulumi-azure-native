...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20210301preview:EntityQuery")]
    public partial class EntityQuery : global::Pulumi.CustomResource
    {
        ...
        public EntityQuery(string name, EntityQueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:EntityQuery", name, args ?? new EntityQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntityQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:EntityQuery", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20221001preview:EntityQuery"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20221101preview:EntityQuery"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20221201preview:EntityQuery"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20230201preview:EntityQuery"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20230301preview:EntityQuery"},
                },
            };
    ...
    public sealed class EntityQueryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.CustomEntityQueryKind> Kind { get; set; } = null!;
