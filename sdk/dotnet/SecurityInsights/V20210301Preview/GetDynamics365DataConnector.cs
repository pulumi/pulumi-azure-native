...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    public static class GetDynamics365DataConnector
    {
        ...
        public static Task<GetDynamics365DataConnectorResult> InvokeAsync(GetDynamics365DataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDynamics365DataConnectorResult>("azure-native:securityinsights/v20210301preview:getDynamics365DataConnector", args ?? new GetDynamics365DataConnectorArgs(), options.WithVersion());
        ...
        public static Output<GetDynamics365DataConnectorResult> Invoke(GetDynamics365DataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDynamics365DataConnectorResult>("azure-native:securityinsights/v20210301preview:getDynamics365DataConnector", args ?? new GetDynamics365DataConnectorInvokeArgs(), options.WithVersion());
    }
