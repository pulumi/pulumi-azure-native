...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    ...
    public static class GetAlertRule
    {
        ...
        public static Task<GetAlertRuleResult> InvokeAsync(GetAlertRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAlertRuleResult>("azure-native:securityinsights/v20210301preview:getAlertRule", args ?? new GetAlertRuleArgs(), options.WithVersion());

        /// <summary>
        /// Alert rule.
        /// </summary>
        public static Output<GetAlertRuleResult> Invoke(GetAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAlertRuleResult>("azure-native:securityinsights/v20210301preview:getAlertRule", args ?? new GetAlertRuleInvokeArgs(), options.WithVersion());
    }
