...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    public static class GetASCDataConnector
    {
        ...
        public static Output<GetASCDataConnectorResult> Invoke(GetASCDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetASCDataConnectorResult>("azure-native:securityinsights/v20210301preview:getASCDataConnector", args ?? new GetASCDataConnectorInvokeArgs(), options.WithVersion());
    }
