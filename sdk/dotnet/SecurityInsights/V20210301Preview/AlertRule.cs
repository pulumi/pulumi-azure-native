...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    ...
    /// Alert rule.
    /// </summary>
    [Obsolete(@"Please use one of the variants: FusionAlertRule, MLBehaviorAnalyticsAlertRule, MicrosoftSecurityIncidentCreationAlertRule, ScheduledAlertRule, ThreatIntelligenceAlertRule.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20210301preview:AlertRule")]
    public partial class AlertRule : global::Pulumi.CustomResource
    {
        ...
        public AlertRule(string name, AlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:AlertRule", name, args ?? new AlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20210301preview:AlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20200101:AlertRule"},
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20220801:AlertRule"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20220801preview:AlertRule"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20220901preview:AlertRule"},
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20221101preview:AlertRule"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20221201preview:AlertRule"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20230201:AlertRule"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20230201preview:AlertRule"},
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20230301preview:AlertRule"},
                },
            };
    ...
    public sealed class AlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.AlertRuleKind> Kind { get; set; } = null!;
