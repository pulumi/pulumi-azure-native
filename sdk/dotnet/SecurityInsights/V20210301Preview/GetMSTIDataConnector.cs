...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    public static class GetMSTIDataConnector
    {
        ...
        public static Task<GetMSTIDataConnectorResult> InvokeAsync(GetMSTIDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMSTIDataConnectorResult>("azure-native:securityinsights/v20210301preview:getMSTIDataConnector", args ?? new GetMSTIDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Represents Microsoft Threat Intelligence data connector.
        /// </summary>
        public static Output<GetMSTIDataConnectorResult> Invoke(GetMSTIDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMSTIDataConnectorResult>("azure-native:securityinsights/v20210301preview:getMSTIDataConnector", args ?? new GetMSTIDataConnectorInvokeArgs(), options.WithDefaults());
    }
