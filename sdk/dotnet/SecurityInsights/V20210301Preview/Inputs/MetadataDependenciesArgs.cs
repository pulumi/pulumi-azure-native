...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview.Inputs
{
    ...
    public sealed class MetadataDependenciesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.Kind>? Kind { get; set; }
        ...
        /// </summary>
        [Input("operator")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20210301Preview.Operator>? Operator { get; set; }
