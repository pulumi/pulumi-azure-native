...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    ...
    public static class GetDataConnector
    {
        ...
        public static Task<GetDataConnectorResult> InvokeAsync(GetDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectorResult>("azure-native:securityinsights/v20210301preview:getDataConnector", args ?? new GetDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Data connector
        /// </summary>
        public static Output<GetDataConnectorResult> Invoke(GetDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataConnectorResult>("azure-native:securityinsights/v20210301preview:getDataConnector", args ?? new GetDataConnectorInvokeArgs(), options.WithDefaults());
    }
