...
namespace Pulumi.AzureNative.SecurityInsights.V20210301Preview
{
    public static class GetAATPDataConnector
    {
        ...
        public static Output<GetAATPDataConnectorResult> Invoke(GetAATPDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAATPDataConnectorResult>("azure-native:securityinsights/v20210301preview:getAATPDataConnector", args ?? new GetAATPDataConnectorInvokeArgs(), options.WithVersion());
    }
