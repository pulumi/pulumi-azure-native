...
{
    [AzureNativeResourceType("azure-native:securityinsights/v20211001preview:AutomationRule")]
    public partial class AutomationRule : Pulumi.CustomResource
    {
        ...
        public AutomationRule(string name, AutomationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:AutomationRule", name, args ?? new AutomationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutomationRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:AutomationRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:securityinsights/v20190101preview:AutomationRule"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:securityinsights/v20220701preview:AutomationRule"},
                    new Pulumi.Alias { Type = "azure-native:securityinsights/v20220801preview:AutomationRule"},
                },
            };
