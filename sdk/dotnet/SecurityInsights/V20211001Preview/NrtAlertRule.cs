...
namespace Pulumi.AzureNative.SecurityInsights.V20211001Preview
{
    ...
    /// {
    ///     var nrtAlertRule = new AzureNative.SecurityInsights.V20211001Preview.NrtAlertRule("nrtAlertRule", new()
    ///     {
    ...
    ///         DisplayName = "Rule2",
    ///         Enabled = true,
    ///         IncidentConfiguration = new AzureNative.SecurityInsights.V20211001Preview.Inputs.IncidentConfigurationArgs
    ///         {
    ///             CreateIncident = true,
    ///             GroupingConfiguration = new AzureNative.SecurityInsights.V20211001Preview.Inputs.GroupingConfigurationArgs
    ///             {
    ///                 Enabled = true,
    ///                 GroupByEntities = new[]
    ///                 {
