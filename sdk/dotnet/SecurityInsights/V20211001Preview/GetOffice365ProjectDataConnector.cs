...
namespace Pulumi.AzureNative.SecurityInsights.V20211001Preview
{
    public static class GetOffice365ProjectDataConnector
    {
        ...
        public static Task<GetOffice365ProjectDataConnectorResult> InvokeAsync(GetOffice365ProjectDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOffice365ProjectDataConnectorResult>("azure-native:securityinsights/v20211001preview:getOffice365ProjectDataConnector", args ?? new GetOffice365ProjectDataConnectorArgs(), options.WithDefaults());
        ...
        public static Output<GetOffice365ProjectDataConnectorResult> Invoke(GetOffice365ProjectDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetOffice365ProjectDataConnectorResult>("azure-native:securityinsights/v20211001preview:getOffice365ProjectDataConnector", args ?? new GetOffice365ProjectDataConnectorInvokeArgs(), options.WithDefaults());
    }
