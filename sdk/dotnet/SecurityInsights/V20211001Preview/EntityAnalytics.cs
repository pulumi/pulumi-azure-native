...
namespace Pulumi.AzureNative.SecurityInsights.V20211001Preview
{
    ...
    /// {
    ///     var entityAnalytics = new AzureNative.SecurityInsights.V20211001Preview.EntityAnalytics("entityAnalytics", new()
    ///     {
    ...
    public partial class EntityAnalytics : global::Pulumi.CustomResource
    {
        ...
        public EntityAnalytics(string name, EntityAnalyticsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:EntityAnalytics", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EntityAnalytics(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:EntityAnalytics", name, null, MakeResourceOptions(options, id))
        {
        }
