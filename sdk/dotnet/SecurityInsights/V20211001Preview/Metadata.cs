...
namespace Pulumi.AzureNative.SecurityInsights.V20211001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20211001preview:Metadata")]
    public partial class Metadata : Pulumi.CustomResource
    {
        ...
        public Metadata(string name, MetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:Metadata", name, args ?? new MetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Metadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:Metadata", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MetadataArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20211001Preview.Kind> Kind { get; set; } = null!;
