...
namespace Pulumi.AzureNative.SecurityInsights.V20211001Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20211001preview:WatchlistItem")]
    public partial class WatchlistItem : global::Pulumi.CustomResource
    {
        ...
        public WatchlistItem(string name, WatchlistItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:WatchlistItem", name, args ?? new WatchlistItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WatchlistItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:WatchlistItem", name, null, MakeResourceOptions(options, id))
        {
        }
