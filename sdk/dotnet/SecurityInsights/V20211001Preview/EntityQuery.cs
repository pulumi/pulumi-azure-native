...
namespace Pulumi.AzureNative.SecurityInsights.V20211001Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20211001preview:EntityQuery")]
    public partial class EntityQuery : Pulumi.CustomResource
    {
        ...
        public EntityQuery(string name, EntityQueryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:EntityQuery", name, args ?? new EntityQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntityQuery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20211001preview:EntityQuery", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EntityQueryArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20211001Preview.CustomEntityQueryKind> Kind { get; set; } = null!;
