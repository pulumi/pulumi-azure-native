...
namespace Pulumi.AzureNative.SecurityInsights.V20220601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20220601preview:MDATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:MDATPDataConnector to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20220601preview:MDATPDataConnector")]
    public partial class MDATPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MDATPDataConnector(string name, MDATPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:MDATPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MDATPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:MDATPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
