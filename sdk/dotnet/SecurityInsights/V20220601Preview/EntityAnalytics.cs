...
namespace Pulumi.AzureNative.SecurityInsights.V20220601Preview
{
    ...
    /// {
    ///     var entityAnalytics = new AzureNative.SecurityInsights.V20220601Preview.EntityAnalytics("entityAnalytics", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20220601preview:EntityAnalytics EyesOn /subscriptions/bd794837-4d29-4647-9105-6339bfdb4e6a/resourceGroups/mms-eus/providers/Microsoft.OperationalInsights/workspaces/avdvirInt/providers/Microsoft.SecurityInsights/settings/EyesOn 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220601preview:EntityAnalytics")]
    public partial class EntityAnalytics : global::Pulumi.CustomResource
    {
        ...
        public EntityAnalytics(string name, EntityAnalyticsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:EntityAnalytics", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EntityAnalytics(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:EntityAnalytics", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EntityAnalyticsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220601Preview.EntityProviders>>? _entityProviders;

        /// <summary>
        /// The relevant entity providers that are synced
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220601Preview.EntityProviders>> EntityProviders
        {
            get => _entityProviders ?? (_entityProviders = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220601Preview.EntityProviders>>());
