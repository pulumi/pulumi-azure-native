...
namespace Pulumi.AzureNative.SecurityInsights.V20220601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220601preview:ThreatIntelligenceIndicator")]
    public partial class ThreatIntelligenceIndicator : Pulumi.CustomResource
    {
        ...
        public ThreatIntelligenceIndicator(string name, ThreatIntelligenceIndicatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:ThreatIntelligenceIndicator", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ThreatIntelligenceIndicator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:ThreatIntelligenceIndicator", name, null, MakeResourceOptions(options, id))
        {
        }
