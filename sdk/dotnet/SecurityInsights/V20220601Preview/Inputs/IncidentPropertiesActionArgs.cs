...
namespace Pulumi.AzureNative.SecurityInsights.V20220601Preview.Inputs
{
    ...
    public sealed class IncidentPropertiesActionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220601Preview.IncidentClassification>? Classification { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220601Preview.IncidentClassificationReason>? ClassificationReason { get; set; }
        ...
        /// </summary>
        [Input("severity")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220601Preview.IncidentSeverity>? Severity { get; set; }

        /// <summary>
        /// The status of the incident
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220601Preview.IncidentStatus>? Status { get; set; }
