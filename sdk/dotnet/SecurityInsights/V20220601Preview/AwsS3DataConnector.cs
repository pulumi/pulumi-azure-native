...
namespace Pulumi.AzureNative.SecurityInsights.V20220601Preview
{
    ...
    /// {
    ///     var awsS3DataConnector = new AzureNative.SecurityInsights.V20220601Preview.AwsS3DataConnector("awsS3DataConnector", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20220601preview:AwsS3DataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220601preview:AwsS3DataConnector")]
    public partial class AwsS3DataConnector : global::Pulumi.CustomResource
    {
        ...
        public AwsS3DataConnector(string name, AwsS3DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:AwsS3DataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AwsS3DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:AwsS3DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
