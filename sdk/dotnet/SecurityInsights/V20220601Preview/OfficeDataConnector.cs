...
namespace Pulumi.AzureNative.SecurityInsights.V20220601Preview
{
    ...
    /// {
    ///     var officeDataConnector = new AzureNative.SecurityInsights.V20220601Preview.OfficeDataConnector("officeDataConnector", new()
    ///     {
    ...
    ///     {
    ///         DataConnectorId = "73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    ///         DataTypes = new AzureNative.SecurityInsights.V20220601Preview.Inputs.OfficeDataConnectorDataTypesArgs
    ///         {
    ///             Exchange = new AzureNative.SecurityInsights.V20220601Preview.Inputs.OfficeDataConnectorDataTypesExchangeArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///             SharePoint = new AzureNative.SecurityInsights.V20220601Preview.Inputs.OfficeDataConnectorDataTypesSharePointArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///             Teams = new AzureNative.SecurityInsights.V20220601Preview.Inputs.OfficeDataConnectorDataTypesTeamsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
    ...
    public partial class OfficeDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficeDataConnector(string name, OfficeDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:OfficeDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficeDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:OfficeDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
