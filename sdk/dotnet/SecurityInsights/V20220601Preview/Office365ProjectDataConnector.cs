...
namespace Pulumi.AzureNative.SecurityInsights.V20220601Preview
{
    ...
    /// {
    ///     var office365ProjectDataConnector = new AzureNative.SecurityInsights.V20220601Preview.Office365ProjectDataConnector("office365ProjectDataConnector", new()
    ///     {
    ...
    ///     {
    ///         DataConnectorId = "73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    ///         DataTypes = new AzureNative.SecurityInsights.V20220601Preview.Inputs.Office365ProjectConnectorDataTypesArgs
    ///         {
    ///             Logs = new AzureNative.SecurityInsights.V20220601Preview.Inputs.Office365ProjectConnectorDataTypesLogsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
    ...
    public partial class Office365ProjectDataConnector : global::Pulumi.CustomResource
    {
        ...
        public Office365ProjectDataConnector(string name, Office365ProjectDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:Office365ProjectDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Office365ProjectDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220601preview:Office365ProjectDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
