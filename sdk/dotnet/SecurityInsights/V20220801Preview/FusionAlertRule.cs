...
namespace Pulumi.AzureNative.SecurityInsights.V20220801Preview
{
    ...
    /// {
    ///     var fusionAlertRule = new AzureNative.SecurityInsights.V20220801Preview.FusionAlertRule("fusionAlertRule", new()
    ///     {
    ...
    ///         SourceSettings = new[]
    ///         {
    ///             new AzureNative.SecurityInsights.V20220801Preview.Inputs.FusionSourceSettingsArgs
    ///             {
    ///                 Enabled = true,
    ...
    ///                 SourceSubTypes = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20220801Preview.Inputs.FusionSourceSubTypeSettingArgs
    ///                     {
    ///                         Enabled = true,
    ///                         SeverityFilters = new AzureNative.SecurityInsights.V20220801Preview.Inputs.FusionSubTypeSeverityFilterArgs
    ///                         {
    ///                             Filters = new[]
    ///                             {
    ///                                 new AzureNative.SecurityInsights.V20220801Preview.Inputs.FusionSubTypeSeverityFiltersItemArgs
    ///                                 {
    ///                                     Enabled = true,
    ///                                     Severity = "High",
    ///                                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220801preview:FusionAlertRule")]
    public partial class FusionAlertRule : global::Pulumi.CustomResource
    {
        ...
        public FusionAlertRule(string name, FusionAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:FusionAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private FusionAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:FusionAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
