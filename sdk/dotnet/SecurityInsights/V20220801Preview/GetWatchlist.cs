...
namespace Pulumi.AzureNative.SecurityInsights.V20220801Preview
{
    public static class GetWatchlist
    {
        ...
        public static Task<GetWatchlistResult> InvokeAsync(GetWatchlistArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWatchlistResult>("azure-native:securityinsights/v20220801preview:getWatchlist", args ?? new GetWatchlistArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a Watchlist in Azure Security Insights.
        /// </summary>
        public static Output<GetWatchlistResult> Invoke(GetWatchlistInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWatchlistResult>("azure-native:securityinsights/v20220801preview:getWatchlist", args ?? new GetWatchlistInvokeArgs(), options.WithDefaults());
    }
