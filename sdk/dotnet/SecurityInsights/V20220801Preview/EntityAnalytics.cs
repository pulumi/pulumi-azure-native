...
namespace Pulumi.AzureNative.SecurityInsights.V20220801Preview
{
    ...
    /// {
    ///     var entityAnalytics = new AzureNative.SecurityInsights.V20220801Preview.EntityAnalytics("entityAnalytics", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20220801preview:EntityAnalytics EyesOn /subscriptions/bd794837-4d29-4647-9105-6339bfdb4e6a/resourceGroups/mms-eus/providers/Microsoft.OperationalInsights/workspaces/avdvirInt/providers/Microsoft.SecurityInsights/settings/EyesOn 
    /// ```
    /// </summary>
    ...
    public partial class EntityAnalytics : global::Pulumi.CustomResource
    {
        ...
        public EntityAnalytics(string name, EntityAnalyticsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:EntityAnalytics", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EntityAnalytics(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:EntityAnalytics", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EntityAnalyticsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// The relevant entity providers that are synced
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220801Preview.EntityProviders>> EntityProviders
        {
            get => _entityProviders ?? (_entityProviders = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220801Preview.EntityProviders>>());
