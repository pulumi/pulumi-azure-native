...
namespace Pulumi.AzureNative.SecurityInsights.V20220801Preview
{
    ...
    /// {
    ///     var officePowerBIDataConnector = new AzureNative.SecurityInsights.V20220801Preview.OfficePowerBIDataConnector("officePowerBIDataConnector", new()
    ///     {
    ...
    ///     {
    ///         DataConnectorId = "73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    ///         DataTypes = new AzureNative.SecurityInsights.V20220801Preview.Inputs.OfficePowerBIConnectorDataTypesArgs
    ///         {
    ///             Logs = new AzureNative.SecurityInsights.V20220801Preview.Inputs.OfficePowerBIConnectorDataTypesLogsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20220801preview:OfficePowerBIDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220801preview:OfficePowerBIDataConnector")]
    public partial class OfficePowerBIDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficePowerBIDataConnector(string name, OfficePowerBIDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:OfficePowerBIDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficePowerBIDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:OfficePowerBIDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
