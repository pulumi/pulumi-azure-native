...
namespace Pulumi.AzureNative.SecurityInsights.V20220801Preview
{
    ...
    /// {
    ///     var threatIntelligenceAlertRule = new AzureNative.SecurityInsights.V20220801Preview.ThreatIntelligenceAlertRule("threatIntelligenceAlertRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220801preview:ThreatIntelligenceAlertRule")]
    public partial class ThreatIntelligenceAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ThreatIntelligenceAlertRule(string name, ThreatIntelligenceAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:ThreatIntelligenceAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ThreatIntelligenceAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:ThreatIntelligenceAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
