...
namespace Pulumi.AzureNative.SecurityInsights.V20220801Preview
{
    ...
    /// {
    ///     var anomalySecurityMLAnalyticsSettings = new AzureNative.SecurityInsights.V20220801Preview.AnomalySecurityMLAnalyticsSettings("anomalySecurityMLAnalyticsSettings", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.SecurityInsights.V20220801Preview.Inputs.SecurityMLAnalyticsSettingsDataSourceArgs
    ///             {
    ///                 ConnectorId = "AWS",
    ///                 DataTypes = new[]
    ///                 {
