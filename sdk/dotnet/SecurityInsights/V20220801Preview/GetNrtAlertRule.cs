...
namespace Pulumi.AzureNative.SecurityInsights.V20220801Preview
{
    public static class GetNrtAlertRule
    {
        ...
        public static Task<GetNrtAlertRuleResult> InvokeAsync(GetNrtAlertRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNrtAlertRuleResult>("azure-native:securityinsights/v20220801preview:getNrtAlertRule", args ?? new GetNrtAlertRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Represents NRT alert rule.
        /// </summary>
        public static Output<GetNrtAlertRuleResult> Invoke(GetNrtAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNrtAlertRuleResult>("azure-native:securityinsights/v20220801preview:getNrtAlertRule", args ?? new GetNrtAlertRuleInvokeArgs(), options.WithDefaults());
    }
