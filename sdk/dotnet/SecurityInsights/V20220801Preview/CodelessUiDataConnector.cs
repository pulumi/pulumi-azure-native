...
namespace Pulumi.AzureNative.SecurityInsights.V20220801Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20220801preview:CodelessUiDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:CodelessUiDataConnector to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20220801preview:CodelessUiDataConnector")]
    public partial class CodelessUiDataConnector : global::Pulumi.CustomResource
    {
        ...
        public CodelessUiDataConnector(string name, CodelessUiDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:CodelessUiDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CodelessUiDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801preview:CodelessUiDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
