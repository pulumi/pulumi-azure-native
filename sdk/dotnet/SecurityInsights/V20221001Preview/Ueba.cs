...
namespace Pulumi.AzureNative.SecurityInsights.V20221001Preview
{
    ...
    /// {
    ///     var ueba = new AzureNative.SecurityInsights.V20221001Preview.Ueba("ueba", new()
    ///     {
    ...
    public partial class Ueba : global::Pulumi.CustomResource
    {
        ...
        public Ueba(string name, UebaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:Ueba", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Ueba(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:Ueba", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("dataSources")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221001Preview.UebaDataSources>>? _dataSources;

        /// <summary>
        /// The relevant data sources that enriched by ueba
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221001Preview.UebaDataSources>> DataSources
        {
            get => _dataSources ?? (_dataSources = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20221001Preview.UebaDataSources>>());
