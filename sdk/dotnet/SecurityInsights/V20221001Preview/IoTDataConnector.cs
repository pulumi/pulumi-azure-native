...
namespace Pulumi.AzureNative.SecurityInsights.V20221001Preview
{
    ...
    /// {
    ///     var ioTDataConnector = new AzureNative.SecurityInsights.V20221001Preview.IoTDataConnector("ioTDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20221001preview:IoTDataConnector")]
    public partial class IoTDataConnector : global::Pulumi.CustomResource
    {
        ...
        public IoTDataConnector(string name, IoTDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:IoTDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:IoTDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
