...
namespace Pulumi.AzureNative.SecurityInsights.V20221001Preview
{
    ...
    /// {
    ///     var anomalies = new AzureNative.SecurityInsights.V20221001Preview.Anomalies("anomalies", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20221001preview:Anomalies")]
    public partial class Anomalies : global::Pulumi.CustomResource
    {
        ...
        public Anomalies(string name, AnomaliesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:Anomalies", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Anomalies(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:Anomalies", name, null, MakeResourceOptions(options, id))
        {
        }
