...
namespace Pulumi.AzureNative.SecurityInsights.V20221001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20221001preview:Metadata is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Metadata to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20221001preview:Metadata")]
    public partial class Metadata : global::Pulumi.CustomResource
    {
        ...
        public Metadata(string name, MetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:Metadata", name, args ?? new MetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Metadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:Metadata", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MetadataArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221001Preview.Kind> Kind { get; set; } = null!;
