...
namespace Pulumi.AzureNative.SecurityInsights.V20221001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20221001preview:FileImport is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:FileImport to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20221001preview:FileImport")]
    public partial class FileImport : global::Pulumi.CustomResource
    {
        ...
        public FileImport(string name, FileImportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:FileImport", name, args ?? new FileImportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileImport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20221001preview:FileImport", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FileImportArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221001Preview.FileImportContentType> ContentType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20221001Preview.IngestionMode> IngestionMode { get; set; } = null!;
