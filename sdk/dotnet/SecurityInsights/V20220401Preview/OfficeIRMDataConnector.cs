...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview
{
    ...
    /// {
    ///     var officeIRMDataConnector = new AzureNative.SecurityInsights.V20220401Preview.OfficeIRMDataConnector("officeIRMDataConnector", new()
    ///     {
    ...
    public partial class OfficeIRMDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficeIRMDataConnector(string name, OfficeIRMDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:OfficeIRMDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficeIRMDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:OfficeIRMDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
