...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview
{
    ...
    /// {
    ///     var tiTaxiiDataConnector = new AzureNative.SecurityInsights.V20220401Preview.TiTaxiiDataConnector("tiTaxiiDataConnector", new()
    ///     {
    ...
    ///         DataTypes = new AzureNative.SecurityInsights.V20220401Preview.Inputs.TiTaxiiDataConnectorDataTypesArgs
    ///         {
    ///             TaxiiClient = new AzureNative.SecurityInsights.V20220401Preview.Inputs.TiTaxiiDataConnectorDataTypesTaxiiClientArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
    ...
    public partial class TiTaxiiDataConnector : global::Pulumi.CustomResource
    {
        ...
        public TiTaxiiDataConnector(string name, TiTaxiiDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:TiTaxiiDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private TiTaxiiDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:TiTaxiiDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TiTaxiiDataConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.PollingFrequency> PollingFrequency { get; set; } = null!;
