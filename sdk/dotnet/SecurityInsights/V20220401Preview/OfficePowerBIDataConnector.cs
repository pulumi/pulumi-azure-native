...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview
{
    ...
    /// {
    ///     var officePowerBIDataConnector = new AzureNative.SecurityInsights.V20220401Preview.OfficePowerBIDataConnector("officePowerBIDataConnector", new()
    ///     {
    ...
    ///     {
    ///         DataConnectorId = "73e01a99-5cd7-4139-a149-9f2736ff2ab5",
    ///         DataTypes = new AzureNative.SecurityInsights.V20220401Preview.Inputs.OfficePowerBIConnectorDataTypesArgs
    ///         {
    ///             Logs = new AzureNative.SecurityInsights.V20220401Preview.Inputs.OfficePowerBIConnectorDataTypesLogsArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
    ...
    public partial class OfficePowerBIDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficePowerBIDataConnector(string name, OfficePowerBIDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:OfficePowerBIDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficePowerBIDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:OfficePowerBIDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
