...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview
{
    public static class GetAATPDataConnector
    {
        ...
        public static Task<GetAATPDataConnectorResult> InvokeAsync(GetAATPDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAATPDataConnectorResult>("azure-native:securityinsights/v20220401preview:getAATPDataConnector", args ?? new GetAATPDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Represents AATP (Azure Advanced Threat Protection) data connector.
        /// </summary>
        public static Output<GetAATPDataConnectorResult> Invoke(GetAATPDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAATPDataConnectorResult>("azure-native:securityinsights/v20220401preview:getAATPDataConnector", args ?? new GetAATPDataConnectorInvokeArgs(), options.WithDefaults());
    }
