...
{
    [Obsolete(@"azure-native:securityinsights/v20220401preview:OfficeIRMDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:OfficeIRMDataConnector to guarantee forwards compatibility.")]
    public static class GetOfficeIRMDataConnector
    {
        ...
        public static Task<GetOfficeIRMDataConnectorResult> InvokeAsync(GetOfficeIRMDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOfficeIRMDataConnectorResult>("azure-native:securityinsights/v20220401preview:getOfficeIRMDataConnector", args ?? new GetOfficeIRMDataConnectorArgs(), options.WithDefaults());
        ...
        public static Output<GetOfficeIRMDataConnectorResult> Invoke(GetOfficeIRMDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOfficeIRMDataConnectorResult>("azure-native:securityinsights/v20220401preview:getOfficeIRMDataConnector", args ?? new GetOfficeIRMDataConnectorInvokeArgs(), options.WithDefaults());
    }
