...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview
{
    public static class GetAADDataConnector
    {
        ...
        public static Task<GetAADDataConnectorResult> InvokeAsync(GetAADDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAADDataConnectorResult>("azure-native:securityinsights/v20220401preview:getAADDataConnector", args ?? new GetAADDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Represents AAD (Azure Active Directory) data connector.
        /// </summary>
        public static Output<GetAADDataConnectorResult> Invoke(GetAADDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAADDataConnectorResult>("azure-native:securityinsights/v20220401preview:getAADDataConnector", args ?? new GetAADDataConnectorInvokeArgs(), options.WithDefaults());
    }
