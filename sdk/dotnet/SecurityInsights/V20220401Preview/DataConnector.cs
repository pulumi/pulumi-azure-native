...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20220401preview:DataConnector")]
    public partial class DataConnector : Pulumi.CustomResource
    {
        ...
        public DataConnector(string name, DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:DataConnector", name, args ?? new DataConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataConnectorArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.DataConnectorKind> Kind { get; set; } = null!;
