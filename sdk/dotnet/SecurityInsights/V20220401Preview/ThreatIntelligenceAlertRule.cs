...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20220401preview:ThreatIntelligenceAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceAlertRule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20220401preview:ThreatIntelligenceAlertRule")]
    public partial class ThreatIntelligenceAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ThreatIntelligenceAlertRule(string name, ThreatIntelligenceAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:ThreatIntelligenceAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ThreatIntelligenceAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:ThreatIntelligenceAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
