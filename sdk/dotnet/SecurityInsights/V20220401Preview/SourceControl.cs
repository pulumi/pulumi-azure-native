...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220401preview:SourceControl")]
    public partial class SourceControl : Pulumi.CustomResource
    {
        ...
        public SourceControl(string name, SourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:SourceControl", name, args ?? new SourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220401preview:SourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.ContentType>>? _contentTypes;

        /// <summary>
        /// Array of source control content types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.ContentType>> ContentTypes
        {
            get => _contentTypes ?? (_contentTypes = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.ContentType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.RepoType> RepoType { get; set; } = null!;
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.Version>? Version { get; set; }
