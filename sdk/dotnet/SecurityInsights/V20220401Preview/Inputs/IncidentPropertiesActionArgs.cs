...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview.Inputs
{
    ...
    public sealed class IncidentPropertiesActionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.IncidentClassification>? Classification { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.IncidentClassificationReason>? ClassificationReason { get; set; }
        ...
        /// </summary>
        [Input("severity")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.IncidentSeverity>? Severity { get; set; }

        /// <summary>
        /// The status of the incident
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.IncidentStatus>? Status { get; set; }
