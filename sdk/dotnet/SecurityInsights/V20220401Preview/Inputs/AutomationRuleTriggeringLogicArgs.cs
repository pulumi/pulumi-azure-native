...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview.Inputs
{
    ...
    public sealed class AutomationRuleTriggeringLogicArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.TriggersOn> TriggersOn { get; set; } = null!;

        [Input("triggersWhen", required: true)]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220401Preview.TriggersWhen> TriggersWhen { get; set; } = null!;
