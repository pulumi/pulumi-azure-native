...
namespace Pulumi.AzureNative.SecurityInsights.V20220401Preview
{
    public static class GetMLBehaviorAnalyticsAlertRule
    {
        ...
        public static Task<GetMLBehaviorAnalyticsAlertRuleResult> InvokeAsync(GetMLBehaviorAnalyticsAlertRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMLBehaviorAnalyticsAlertRuleResult>("azure-native:securityinsights/v20220401preview:getMLBehaviorAnalyticsAlertRule", args ?? new GetMLBehaviorAnalyticsAlertRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetMLBehaviorAnalyticsAlertRuleResult> Invoke(GetMLBehaviorAnalyticsAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMLBehaviorAnalyticsAlertRuleResult>("azure-native:securityinsights/v20220401preview:getMLBehaviorAnalyticsAlertRule", args ?? new GetMLBehaviorAnalyticsAlertRuleInvokeArgs(), options.WithDefaults());
    }
