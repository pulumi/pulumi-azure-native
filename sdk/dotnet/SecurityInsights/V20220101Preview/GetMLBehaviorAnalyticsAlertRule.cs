...
{
    [Obsolete(@"azure-native:securityinsights/v20220101preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.")]
    public static class GetMLBehaviorAnalyticsAlertRule
    {
        ...
        public static Task<GetMLBehaviorAnalyticsAlertRuleResult> InvokeAsync(GetMLBehaviorAnalyticsAlertRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMLBehaviorAnalyticsAlertRuleResult>("azure-native:securityinsights/v20220101preview:getMLBehaviorAnalyticsAlertRule", args ?? new GetMLBehaviorAnalyticsAlertRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetMLBehaviorAnalyticsAlertRuleResult> Invoke(GetMLBehaviorAnalyticsAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMLBehaviorAnalyticsAlertRuleResult>("azure-native:securityinsights/v20220101preview:getMLBehaviorAnalyticsAlertRule", args ?? new GetMLBehaviorAnalyticsAlertRuleInvokeArgs(), options.WithDefaults());
    }
