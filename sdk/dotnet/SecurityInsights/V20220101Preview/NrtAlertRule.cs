...
namespace Pulumi.AzureNative.SecurityInsights.V20220101Preview
{
    ...
    /// {
    ///     var nrtAlertRule = new AzureNative.SecurityInsights.V20220101Preview.NrtAlertRule("nrtAlertRule", new()
    ///     {
    ...
    ///         DisplayName = "Rule2",
    ///         Enabled = true,
    ///         IncidentConfiguration = new AzureNative.SecurityInsights.V20220101Preview.Inputs.IncidentConfigurationArgs
    ///         {
    ///             CreateIncident = true,
    ///             GroupingConfiguration = new AzureNative.SecurityInsights.V20220101Preview.Inputs.GroupingConfigurationArgs
    ///             {
    ///                 Enabled = true,
    ///                 GroupByEntities = new[]
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220101preview:NrtAlertRule")]
    public partial class NrtAlertRule : global::Pulumi.CustomResource
    {
        ...
        public NrtAlertRule(string name, NrtAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:NrtAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private NrtAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:NrtAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NrtAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.AlertSeverity> Severity { get; set; } = null!;
