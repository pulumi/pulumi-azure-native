...
namespace Pulumi.AzureNative.SecurityInsights.V20220101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20220101preview:Bookmark is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20220101preview:Bookmark")]
    public partial class Bookmark : global::Pulumi.CustomResource
    {
        ...
        public Bookmark(string name, BookmarkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:Bookmark", name, args ?? new BookmarkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bookmark(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:Bookmark", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BookmarkArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("tactics")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.AttackTactic>>? _tactics;

        /// <summary>
        /// A list of relevant mitre attacks
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.AttackTactic>> Tactics
        {
            get => _tactics ?? (_tactics = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.AttackTactic>>());
            set => _tactics = value;
        }
