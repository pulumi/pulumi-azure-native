...
namespace Pulumi.AzureNative.SecurityInsights.V20220101Preview.Inputs
{
    ...
    public sealed class IncidentPropertiesActionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("severity")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.IncidentSeverity>? Severity { get; set; }

        /// <summary>
        /// The status of the incident
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.IncidentStatus>? Status { get; set; }
