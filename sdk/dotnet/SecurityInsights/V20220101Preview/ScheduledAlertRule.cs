...
namespace Pulumi.AzureNative.SecurityInsights.V20220101Preview
{
    ...
    /// {
    ///     var scheduledAlertRule = new AzureNative.SecurityInsights.V20220101Preview.ScheduledAlertRule("scheduledAlertRule", new()
    ///     {
    ...
    ///     var scheduledAlertRule = new AzureNative.SecurityInsights.V20220101Preview.ScheduledAlertRule("scheduledAlertRule", new()
    ///     {
    ///         AlertDetailsOverride = new AzureNative.SecurityInsights.V20220101Preview.Inputs.AlertDetailsOverrideArgs
    ///         {
    ...
    ///         EntityMappings = new[]
    ///         {
    ///             new AzureNative.SecurityInsights.V20220101Preview.Inputs.EntityMappingArgs
    ///             {
    ///                 EntityType = "Host",
    ///                 FieldMappings = new[]
    ///                 {
    ///                     new AzureNative.SecurityInsights.V20220101Preview.Inputs.FieldMappingArgs
    ///                     {
    ///                         ColumnName = "Computer",
    ///                         Identifier = "FullName",
    ///                     },
    ...
    ///             },
    ///         },
    ///         EventGroupingSettings = new AzureNative.SecurityInsights.V20220101Preview.Inputs.EventGroupingSettingsArgs
    ///         {
    ...
    ///             "T1021",
    ///         },
    ///         TriggerOperator = AzureNative.SecurityInsights.V20220101Preview.TriggerOperator.GreaterThan,
    ///         TriggerThreshold = 0,
    ///         WorkspaceName = "myWorkspace",
    ///     });
    /// 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220101preview:ScheduledAlertRule")]
    public partial class ScheduledAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ScheduledAlertRule(string name, ScheduledAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:ScheduledAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:ScheduledAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.SecurityInsights.V20220101Preview.TriggerOperator> TriggerOperator { get; set; } = null!;
