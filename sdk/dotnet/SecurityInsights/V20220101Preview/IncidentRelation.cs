...
namespace Pulumi.AzureNative.SecurityInsights.V20220101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220101preview:IncidentRelation")]
    public partial class IncidentRelation : Pulumi.CustomResource
    {
        ...
        public IncidentRelation(string name, IncidentRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:IncidentRelation", name, args ?? new IncidentRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:IncidentRelation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:securityinsights/v20220701preview:IncidentRelation"},
                },
            };
