...
namespace Pulumi.AzureNative.SecurityInsights.V20220101Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20220101preview:AlertRule")]
    public partial class AlertRule : global::Pulumi.CustomResource
    {
        ...
        public AlertRule(string name, AlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:AlertRule", name, args ?? new AlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:AlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.AlertRuleKind> Kind { get; set; } = null!;
