...
namespace Pulumi.AzureNative.SecurityInsights.V20220101Preview
{
    public static class GetBookmarkRelation
    {
        ...
        public static Task<GetBookmarkRelationResult> InvokeAsync(GetBookmarkRelationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBookmarkRelationResult>("azure-native:securityinsights/v20220101preview:getBookmarkRelation", args ?? new GetBookmarkRelationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a bookmark relation.
        /// </summary>
        public static Output<GetBookmarkRelationResult> Invoke(GetBookmarkRelationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBookmarkRelationResult>("azure-native:securityinsights/v20220101preview:getBookmarkRelation", args ?? new GetBookmarkRelationInvokeArgs(), options.WithDefaults());
    }
