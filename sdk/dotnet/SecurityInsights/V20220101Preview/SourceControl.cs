...
namespace Pulumi.AzureNative.SecurityInsights.V20220101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20220101preview:SourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230501preview:SourceControl to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20220101preview:SourceControl")]
    public partial class SourceControl : global::Pulumi.CustomResource
    {
        ...
        public SourceControl(string name, SourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:SourceControl", name, args ?? new SourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220101preview:SourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourceControlArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.ContentType>>? _contentTypes;

        /// <summary>
        /// Array of source control content types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.ContentType>> ContentTypes
        {
            get => _contentTypes ?? (_contentTypes = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.ContentType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.RepoType> RepoType { get; set; } = null!;
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220101Preview.Version>? Version { get; set; }
