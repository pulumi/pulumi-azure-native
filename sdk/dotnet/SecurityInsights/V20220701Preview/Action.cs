...
namespace Pulumi.AzureNative.SecurityInsights.V20220701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220701preview:Action")]
    public partial class Action : global::Pulumi.CustomResource
    {
        ...
        public Action(string name, ActionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:Action", name, args ?? new ActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Action(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:Action", name, null, MakeResourceOptions(options, id))
        {
        }
