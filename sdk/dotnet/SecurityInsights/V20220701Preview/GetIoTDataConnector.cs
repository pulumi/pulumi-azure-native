...
namespace Pulumi.AzureNative.SecurityInsights.V20220701Preview
{
    public static class GetIoTDataConnector
    {
        ...
        public static Task<GetIoTDataConnectorResult> InvokeAsync(GetIoTDataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIoTDataConnectorResult>("azure-native:securityinsights/v20220701preview:getIoTDataConnector", args ?? new GetIoTDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Represents IoT data connector.
        /// </summary>
        public static Output<GetIoTDataConnectorResult> Invoke(GetIoTDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIoTDataConnectorResult>("azure-native:securityinsights/v20220701preview:getIoTDataConnector", args ?? new GetIoTDataConnectorInvokeArgs(), options.WithDefaults());
    }
