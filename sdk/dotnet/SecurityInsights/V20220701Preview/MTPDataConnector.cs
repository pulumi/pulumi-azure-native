...
namespace Pulumi.AzureNative.SecurityInsights.V20220701Preview
{
    ...
    /// {
    ///     var mtpDataConnector = new AzureNative.SecurityInsights.V20220701Preview.MTPDataConnector("mtpDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220701preview:MTPDataConnector")]
    public partial class MTPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MTPDataConnector(string name, MTPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:MTPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MTPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:MTPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
