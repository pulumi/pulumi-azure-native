...
namespace Pulumi.AzureNative.SecurityInsights.V20220701Preview
{
    ...
    /// {
    ///     var nrtAlertRule = new AzureNative.SecurityInsights.V20220701Preview.NrtAlertRule("nrtAlertRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220701preview:NrtAlertRule")]
    public partial class NrtAlertRule : global::Pulumi.CustomResource
    {
        ...
        public NrtAlertRule(string name, NrtAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:NrtAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private NrtAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:NrtAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
