...
namespace Pulumi.AzureNative.SecurityInsights.V20220701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220701preview:IncidentRelation")]
    public partial class IncidentRelation : global::Pulumi.CustomResource
    {
        ...
        public IncidentRelation(string name, IncidentRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:IncidentRelation", name, args ?? new IncidentRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:IncidentRelation", name, null, MakeResourceOptions(options, id))
        {
        }
