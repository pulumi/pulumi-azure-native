...
{
    [Obsolete(@"azure-native:securityinsights/v20220701preview:WatchlistItem is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:WatchlistItem to guarantee forwards compatibility.")]
    public static class GetWatchlistItem
    {
        ...
        public static Task<GetWatchlistItemResult> InvokeAsync(GetWatchlistItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWatchlistItemResult>("azure-native:securityinsights/v20220701preview:getWatchlistItem", args ?? new GetWatchlistItemArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a watchlist, without its watchlist items.
        /// </summary>
        public static Output<GetWatchlistItemResult> Invoke(GetWatchlistItemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWatchlistItemResult>("azure-native:securityinsights/v20220701preview:getWatchlistItem", args ?? new GetWatchlistItemInvokeArgs(), options.WithDefaults());
    }
