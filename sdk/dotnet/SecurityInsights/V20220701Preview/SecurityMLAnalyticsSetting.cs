...
namespace Pulumi.AzureNative.SecurityInsights.V20220701Preview
{
    ...
    public partial class SecurityMLAnalyticsSetting : global::Pulumi.CustomResource
    {
        ...
        public SecurityMLAnalyticsSetting(string name, SecurityMLAnalyticsSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:SecurityMLAnalyticsSetting", name, args ?? new SecurityMLAnalyticsSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityMLAnalyticsSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:SecurityMLAnalyticsSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityMLAnalyticsSettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220701Preview.SecurityMLAnalyticsSettingsKind> Kind { get; set; } = null!;
