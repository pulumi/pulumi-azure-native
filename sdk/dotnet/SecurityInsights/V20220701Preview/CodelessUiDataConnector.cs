...
namespace Pulumi.AzureNative.SecurityInsights.V20220701Preview
{
    ...
    /// {
    ///     var codelessUiDataConnector = new AzureNative.SecurityInsights.V20220701Preview.CodelessUiDataConnector("codelessUiDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220701preview:CodelessUiDataConnector")]
    public partial class CodelessUiDataConnector : global::Pulumi.CustomResource
    {
        ...
        public CodelessUiDataConnector(string name, CodelessUiDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:CodelessUiDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CodelessUiDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:CodelessUiDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
