...
namespace Pulumi.AzureNative.SecurityInsights.V20220701Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20220701preview:ProductSetting")]
    public partial class ProductSetting : Pulumi.CustomResource
    {
        ...
        public ProductSetting(string name, ProductSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:ProductSetting", name, args ?? new ProductSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220701preview:ProductSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProductSettingArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220701Preview.SettingKind> Kind { get; set; } = null!;
