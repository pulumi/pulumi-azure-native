...
namespace Pulumi.AzureNative.SecurityInsights.V20220701Preview
{
    public static class GetAwsS3DataConnector
    {
        ...
        public static Task<GetAwsS3DataConnectorResult> InvokeAsync(GetAwsS3DataConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAwsS3DataConnectorResult>("azure-native:securityinsights/v20220701preview:getAwsS3DataConnector", args ?? new GetAwsS3DataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Represents Amazon Web Services S3 data connector.
        /// </summary>
        public static Output<GetAwsS3DataConnectorResult> Invoke(GetAwsS3DataConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAwsS3DataConnectorResult>("azure-native:securityinsights/v20220701preview:getAwsS3DataConnector", args ?? new GetAwsS3DataConnectorInvokeArgs(), options.WithDefaults());
    }
