...
namespace Pulumi.AzureNative.SecurityInsights
{
    ...
    public partial class BusinessApplicationAgent : global::Pulumi.CustomResource
    {
        ...
        public BusinessApplicationAgent(string name, BusinessApplicationAgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:BusinessApplicationAgent", name, args ?? new BusinessApplicationAgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BusinessApplicationAgent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:BusinessApplicationAgent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20250701preview:BusinessApplicationAgent" },
                },
            };
