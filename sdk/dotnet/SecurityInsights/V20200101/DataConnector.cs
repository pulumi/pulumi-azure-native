...
namespace Pulumi.AzureNextGen.SecurityInsights.V20200101
{
    ...
    /// Data connector.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:securityinsights/v20200101:DataConnector")]
    public partial class DataConnector : Pulumi.CustomResource
    {
        ...
        public DataConnector(string name, DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:securityinsights/v20200101:DataConnector", name, args ?? new DataConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:securityinsights/v20200101:DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataConnectorArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.SecurityInsights.V20200101.DataConnectorKind> Kind { get; set; } = null!;
