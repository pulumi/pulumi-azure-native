...
namespace Pulumi.AzureNative.SecurityInsights.V20200101
{
    ...
    public partial class MDATPDataConnector : Pulumi.CustomResource
    {
        ...
        public MDATPDataConnector(string name, MDATPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20200101:MDATPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MDATPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20200101:MDATPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
