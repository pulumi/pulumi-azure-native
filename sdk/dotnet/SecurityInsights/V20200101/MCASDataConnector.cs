...
namespace Pulumi.AzureNative.SecurityInsights.V20200101
{
    ...
    /// {
    ///     var mcasDataConnector = new AzureNative.SecurityInsights.V20200101.MCASDataConnector("mcasDataConnector", new()
    ///     {
