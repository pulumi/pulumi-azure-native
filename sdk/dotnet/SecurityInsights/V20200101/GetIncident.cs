...
namespace Pulumi.AzureNative.SecurityInsights.V20200101
{
    public static class GetIncident
    {
        ...
        public static Task<GetIncidentResult> InvokeAsync(GetIncidentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIncidentResult>("azure-native:securityinsights/v20200101:getIncident", args ?? new GetIncidentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an incident.
        /// </summary>
        public static Output<GetIncidentResult> Invoke(GetIncidentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIncidentResult>("azure-native:securityinsights/v20200101:getIncident", args ?? new GetIncidentInvokeArgs(), options.WithDefaults());
