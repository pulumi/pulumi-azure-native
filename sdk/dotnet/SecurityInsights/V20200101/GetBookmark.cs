...
namespace Pulumi.AzureNative.SecurityInsights.V20200101
{
    public static class GetBookmark
    {
        ...
        public static Output<GetBookmarkResult> Invoke(GetBookmarkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBookmarkResult>("azure-native:securityinsights/v20200101:getBookmark", args ?? new GetBookmarkInvokeArgs(), options.WithVersion());
    }
