...
namespace Pulumi.AzureNative.SecurityInsights.V20200101
{
    ...
    /// {
    ///     var ascDataConnector = new AzureNative.SecurityInsights.V20200101.ASCDataConnector("ascDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20200101:ASCDataConnector")]
    public partial class ASCDataConnector : global::Pulumi.CustomResource
    {
        ...
        public ASCDataConnector(string name, ASCDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20200101:ASCDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ASCDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20200101:ASCDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
