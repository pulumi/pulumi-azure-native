...
namespace Pulumi.AzureNative.SecurityInsights.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230901preview:FileImport")]
    public partial class FileImport : global::Pulumi.CustomResource
    {
        ...
        public FileImport(string name, FileImportArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:FileImport", name, args ?? new FileImportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileImport(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:FileImport", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FileImportArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230901Preview.FileImportContentType> ContentType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230901Preview.IngestionMode> IngestionMode { get; set; } = null!;
