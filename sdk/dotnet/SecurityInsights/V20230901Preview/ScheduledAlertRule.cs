...
namespace Pulumi.AzureNative.SecurityInsights.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230901preview:ScheduledAlertRule")]
    public partial class ScheduledAlertRule : global::Pulumi.CustomResource
    {
        ...
        public ScheduledAlertRule(string name, ScheduledAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:ScheduledAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:ScheduledAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledAlertRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20230901Preview.AlertSeverity> Severity { get; set; } = null!;
        ...
        [Input("tactics")]
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230901Preview.AttackTactic>>? _tactics;

        /// <summary>
        /// The tactics of the alert rule
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230901Preview.AttackTactic>> Tactics
        {
            get => _tactics ?? (_tactics = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20230901Preview.AttackTactic>>());
            set => _tactics = value;
        }
        ...
        public Input<Pulumi.AzureNative.SecurityInsights.V20230901Preview.TriggerOperator> TriggerOperator { get; set; } = null!;
