...
namespace Pulumi.AzureNative.SecurityInsights.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230901preview:NrtAlertRule")]
    public partial class NrtAlertRule : global::Pulumi.CustomResource
    {
        ...
        public NrtAlertRule(string name, NrtAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:NrtAlertRule", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private NrtAlertRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:NrtAlertRule", name, null, MakeResourceOptions(options, id))
        {
        }
