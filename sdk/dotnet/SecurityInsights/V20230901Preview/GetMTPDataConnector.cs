...
namespace Pulumi.AzureNative.SecurityInsights.V20230901Preview
{
    public static class GetMTPDataConnector
    {
        ...
        public static Task<GetMTPDataConnectorResult> InvokeAsync(GetMTPDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMTPDataConnectorResult>("azure-native:securityinsights/v20230901preview:getMTPDataConnector", args ?? new GetMTPDataConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a data connector.
        /// </summary>
        public static Output<GetMTPDataConnectorResult> Invoke(GetMTPDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMTPDataConnectorResult>("azure-native:securityinsights/v20230901preview:getMTPDataConnector", args ?? new GetMTPDataConnectorInvokeArgs(), options.WithDefaults());
