...
namespace Pulumi.AzureNative.SecurityInsights.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230901preview:IoTDataConnector")]
    public partial class IoTDataConnector : global::Pulumi.CustomResource
    {
        ...
        public IoTDataConnector(string name, IoTDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:IoTDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private IoTDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:IoTDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
