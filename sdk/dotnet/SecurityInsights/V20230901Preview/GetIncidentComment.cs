...
namespace Pulumi.AzureNative.SecurityInsights.V20230901Preview
{
    public static class GetIncidentComment
    {
        ...
        public static Task<GetIncidentCommentResult> InvokeAsync(GetIncidentCommentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIncidentCommentResult>("azure-native:securityinsights/v20230901preview:getIncidentComment", args ?? new GetIncidentCommentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an incident comment.
        /// </summary>
        public static Output<GetIncidentCommentResult> Invoke(GetIncidentCommentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIncidentCommentResult>("azure-native:securityinsights/v20230901preview:getIncidentComment", args ?? new GetIncidentCommentInvokeArgs(), options.WithDefaults());
