...
namespace Pulumi.AzureNative.SecurityInsights.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230901preview:CodelessUiDataConnector")]
    public partial class CodelessUiDataConnector : global::Pulumi.CustomResource
    {
        ...
        public CodelessUiDataConnector(string name, CodelessUiDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:CodelessUiDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private CodelessUiDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:CodelessUiDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
