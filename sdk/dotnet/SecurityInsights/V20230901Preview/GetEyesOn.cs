...
namespace Pulumi.AzureNative.SecurityInsights.V20230901Preview
{
    public static class GetEyesOn
    {
        ...
        public static Task<GetEyesOnResult> InvokeAsync(GetEyesOnArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEyesOnResult>("azure-native:securityinsights/v20230901preview:getEyesOn", args ?? new GetEyesOnArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a setting.
        /// </summary>
        public static Output<GetEyesOnResult> Invoke(GetEyesOnInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEyesOnResult>("azure-native:securityinsights/v20230901preview:getEyesOn", args ?? new GetEyesOnInvokeArgs(), options.WithDefaults());
    }
