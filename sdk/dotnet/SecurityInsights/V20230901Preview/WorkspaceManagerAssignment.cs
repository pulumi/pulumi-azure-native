...
namespace Pulumi.AzureNative.SecurityInsights.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20230901preview:WorkspaceManagerAssignment")]
    public partial class WorkspaceManagerAssignment : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceManagerAssignment(string name, WorkspaceManagerAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:WorkspaceManagerAssignment", name, args ?? new WorkspaceManagerAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceManagerAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20230901preview:WorkspaceManagerAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
