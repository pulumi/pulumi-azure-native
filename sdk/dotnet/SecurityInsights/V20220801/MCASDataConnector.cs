...
namespace Pulumi.AzureNative.SecurityInsights.V20220801
{
    ...
    /// {
    ///     var mcasDataConnector = new AzureNative.SecurityInsights.V20220801.MCASDataConnector("mcasDataConnector", new()
    ///     {
    ...
    public partial class MCASDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MCASDataConnector(string name, MCASDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801:MCASDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MCASDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801:MCASDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
