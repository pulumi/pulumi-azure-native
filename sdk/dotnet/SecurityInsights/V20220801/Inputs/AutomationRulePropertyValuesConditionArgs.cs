...
namespace Pulumi.AzureNative.SecurityInsights.V20220801.Inputs
{
    ...
    {
        [Input("operator")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220801.AutomationRulePropertyConditionSupportedOperator>? Operator { get; set; }

        /// <summary>
        /// The property to evaluate in an automation rule property condition
        /// </summary>
        [Input("propertyName")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220801.AutomationRulePropertyConditionSupportedProperty>? PropertyName { get; set; }
