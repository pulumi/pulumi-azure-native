...
namespace Pulumi.AzureNative.SecurityInsights.V20220801
{
    public static class GetFusionAlertRule
    {
        ...
        public static Task<GetFusionAlertRuleResult> InvokeAsync(GetFusionAlertRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFusionAlertRuleResult>("azure-native:securityinsights/v20220801:getFusionAlertRule", args ?? new GetFusionAlertRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Represents Fusion alert rule.
        /// </summary>
        public static Output<GetFusionAlertRuleResult> Invoke(GetFusionAlertRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetFusionAlertRuleResult>("azure-native:securityinsights/v20220801:getFusionAlertRule", args ?? new GetFusionAlertRuleInvokeArgs(), options.WithDefaults());
    }
