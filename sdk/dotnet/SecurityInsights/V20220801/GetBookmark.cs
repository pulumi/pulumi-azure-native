...
namespace Pulumi.AzureNative.SecurityInsights.V20220801
{
    public static class GetBookmark
    {
        ...
        public static Task<GetBookmarkResult> InvokeAsync(GetBookmarkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBookmarkResult>("azure-native:securityinsights/v20220801:getBookmark", args ?? new GetBookmarkArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a bookmark in Azure Security Insights.
        /// </summary>
        public static Output<GetBookmarkResult> Invoke(GetBookmarkInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBookmarkResult>("azure-native:securityinsights/v20220801:getBookmark", args ?? new GetBookmarkInvokeArgs(), options.WithDefaults());
    }
