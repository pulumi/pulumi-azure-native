...
{
    [Obsolete(@"azure-native:securityinsights/v20220801:Bookmark is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.")]
    public static class GetBookmark
    {
        ...
        public static Task<GetBookmarkResult> InvokeAsync(GetBookmarkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBookmarkResult>("azure-native:securityinsights/v20220801:getBookmark", args ?? new GetBookmarkArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a bookmark.
        /// </summary>
        public static Output<GetBookmarkResult> Invoke(GetBookmarkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBookmarkResult>("azure-native:securityinsights/v20220801:getBookmark", args ?? new GetBookmarkInvokeArgs(), options.WithDefaults());
    }
