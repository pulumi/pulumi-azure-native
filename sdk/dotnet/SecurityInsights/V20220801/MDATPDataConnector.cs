...
namespace Pulumi.AzureNative.SecurityInsights.V20220801
{
    ...
    /// {
    ///     var mdatpDataConnector = new AzureNative.SecurityInsights.V20220801.MDATPDataConnector("mdatpDataConnector", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220801:MDATPDataConnector")]
    public partial class MDATPDataConnector : global::Pulumi.CustomResource
    {
        ...
        public MDATPDataConnector(string name, MDATPDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801:MDATPDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MDATPDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220801:MDATPDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
