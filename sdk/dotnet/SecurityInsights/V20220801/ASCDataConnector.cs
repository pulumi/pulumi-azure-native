...
namespace Pulumi.AzureNative.SecurityInsights.V20220801
{
    ...
    /// {
    ///     var ascDataConnector = new AzureNative.SecurityInsights.V20220801.ASCDataConnector("ascDataConnector", new()
    ///     {
