...
namespace Pulumi.AzureNative.SecurityInsights
{
    ...
    public partial class ContentTemplate : global::Pulumi.CustomResource
    {
        ...
        public ContentTemplate(string name, ContentTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:ContentTemplate", name, args ?? new ContentTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:ContentTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20250401preview:ContentTemplate" },
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20250601:ContentTemplate" },
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20250701preview:ContentTemplate" },
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20250901:ContentTemplate" },
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20251001preview:ContentTemplate" },
                },
            };
    ...
    public sealed class ContentTemplateArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("packageKind")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.PackageKind>? PackageKind { get; set; }
