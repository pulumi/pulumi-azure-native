...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview
{
    public static class GetIncidentRelation
    {
        ...
        public static Task<GetIncidentRelationResult> InvokeAsync(GetIncidentRelationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIncidentRelationResult>("azure-native:securityinsights/v20240401preview:getIncidentRelation", args ?? new GetIncidentRelationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an incident relation.
        /// </summary>
        public static Output<GetIncidentRelationResult> Invoke(GetIncidentRelationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIncidentRelationResult>("azure-native:securityinsights/v20240401preview:getIncidentRelation", args ?? new GetIncidentRelationInvokeArgs(), options.WithDefaults());
    }
