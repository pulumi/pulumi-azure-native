...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20240401preview:HuntComment")]
    public partial class HuntComment : global::Pulumi.CustomResource
    {
        ...
        public HuntComment(string name, HuntCommentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240401preview:HuntComment", name, args ?? new HuntCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HuntComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240401preview:HuntComment", name, null, MakeResourceOptions(options, id))
        {
        }
