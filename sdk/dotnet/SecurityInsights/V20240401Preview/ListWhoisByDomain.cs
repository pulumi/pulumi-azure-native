...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview
{
    public static class ListWhoisByDomain
    {
        ...
        public static Task<ListWhoisByDomainResult> InvokeAsync(ListWhoisByDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWhoisByDomainResult>("azure-native:securityinsights/v20240401preview:listWhoisByDomain", args ?? new ListWhoisByDomainArgs(), options.WithDefaults());
