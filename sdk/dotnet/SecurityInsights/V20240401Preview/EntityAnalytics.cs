...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20240401preview:EntityAnalytics")]
    public partial class EntityAnalytics : global::Pulumi.CustomResource
    {
        ...
        public EntityAnalytics(string name, EntityAnalyticsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240401preview:EntityAnalytics", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EntityAnalytics(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240401preview:EntityAnalytics", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EntityAnalyticsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.EntityProviders>>? _entityProviders;

        /// <summary>
        /// The relevant entity providers that are synced
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.EntityProviders>> EntityProviders
        {
            get => _entityProviders ?? (_entityProviders = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.EntityProviders>>());
