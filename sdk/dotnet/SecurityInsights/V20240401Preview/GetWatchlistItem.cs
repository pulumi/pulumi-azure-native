...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview
{
    public static class GetWatchlistItem
    {
        ...
        public static Task<GetWatchlistItemResult> InvokeAsync(GetWatchlistItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWatchlistItemResult>("azure-native:securityinsights/v20240401preview:getWatchlistItem", args ?? new GetWatchlistItemArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a watchlist, without its watchlist items.
        /// </summary>
        public static Output<GetWatchlistItemResult> Invoke(GetWatchlistItemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWatchlistItemResult>("azure-native:securityinsights/v20240401preview:getWatchlistItem", args ?? new GetWatchlistItemInvokeArgs(), options.WithDefaults());
    }
