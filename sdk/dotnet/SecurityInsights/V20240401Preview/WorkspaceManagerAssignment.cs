...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20240401preview:WorkspaceManagerAssignment")]
    public partial class WorkspaceManagerAssignment : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceManagerAssignment(string name, WorkspaceManagerAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240401preview:WorkspaceManagerAssignment", name, args ?? new WorkspaceManagerAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceManagerAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20240401preview:WorkspaceManagerAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
