...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview
{
    public static class GetSystem
    {
        ...
        public static Task<GetSystemResult> InvokeAsync(GetSystemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSystemResult>("azure-native:securityinsights/v20240401preview:getSystem", args ?? new GetSystemArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the system.
        /// </summary>
        public static Output<GetSystemResult> Invoke(GetSystemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSystemResult>("azure-native:securityinsights/v20240401preview:getSystem", args ?? new GetSystemInvokeArgs(), options.WithDefaults());
