...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview.Inputs
{
    ...
    {
        [Input("arrayType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.AutomationRulePropertyArrayChangedConditionSupportedArrayType>? ArrayType { get; set; }

        [Input("changeType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.AutomationRulePropertyArrayChangedConditionSupportedChangeType>? ChangeType { get; set; }
