...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview.Inputs
{
    ...
    public sealed class LogArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ingestionType")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.IngestionType>? IngestionType { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.LogStatusType>? Status { get; set; }

        /// <summary>
        /// Types of logs and tables.
        /// </summary>
        [Input("type", required: true)]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.LogType> Type { get; set; } = null!;
