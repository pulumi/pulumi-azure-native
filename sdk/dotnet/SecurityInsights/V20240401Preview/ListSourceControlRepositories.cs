...
namespace Pulumi.AzureNative.SecurityInsights.V20240401Preview
{
    public static class ListSourceControlRepositories
    {
        ...
        public static Task<ListSourceControlRepositoriesResult> InvokeAsync(ListSourceControlRepositoriesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListSourceControlRepositoriesResult>("azure-native:securityinsights/v20240401preview:listSourceControlRepositories", args ?? new ListSourceControlRepositoriesArgs(), options.WithDefaults());
        ...
        public static Output<ListSourceControlRepositoriesResult> Invoke(ListSourceControlRepositoriesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListSourceControlRepositoriesResult>("azure-native:securityinsights/v20240401preview:listSourceControlRepositories", args ?? new ListSourceControlRepositoriesInvokeArgs(), options.WithDefaults());
    ...
    public sealed class ListSourceControlRepositoriesArgs : global::Pulumi.InvokeArgs
    {
        ...
        public Union<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.RepositoryAccessKind> Kind { get; set; } = null!;
    ...
    public sealed class ListSourceControlRepositoriesInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("kind", required: true)]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20240401Preview.RepositoryAccessKind> Kind { get; set; } = null!;
