...
namespace Pulumi.AzureNative.SecurityInsights.V20231201Preview
{
    ...
    public readonly struct AlertProperty : IEquatable<AlertProperty>
    {
        ...
        /// </summary>
        public static AlertProperty SubTechniques { get; } = new AlertProperty("SubTechniques");
    ...
    /// </summary>
    [EnumType]
    public readonly struct DataConnectorDefinitionKind : IEquatable<DataConnectorDefinitionKind>
    {
        private readonly string _value;

        private DataConnectorDefinitionKind(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static DataConnectorDefinitionKind Customizable { get; } = new DataConnectorDefinitionKind("Customizable");

        public static bool operator ==(DataConnectorDefinitionKind left, DataConnectorDefinitionKind right) => left.Equals(right);
        public static bool operator !=(DataConnectorDefinitionKind left, DataConnectorDefinitionKind right) => !left.Equals(right);

        public static explicit operator string(DataConnectorDefinitionKind value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is DataConnectorDefinitionKind other && Equals(other);
        public bool Equals(DataConnectorDefinitionKind other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct DataConnectorKind : IEquatable<DataConnectorKind>
    {
        ...
        public static DataConnectorKind GCP { get; } = new DataConnectorKind("GCP");
    ...
    /// </summary>
    [EnumType]
    public readonly struct ProviderPermissionsScope : IEquatable<ProviderPermissionsScope>
    {
        private readonly string _value;

        private ProviderPermissionsScope(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static ProviderPermissionsScope Subscription { get; } = new ProviderPermissionsScope("Subscription");
        public static ProviderPermissionsScope ResourceGroup { get; } = new ProviderPermissionsScope("ResourceGroup");
        public static ProviderPermissionsScope Workspace { get; } = new ProviderPermissionsScope("Workspace");

        public static bool operator ==(ProviderPermissionsScope left, ProviderPermissionsScope right) => left.Equals(right);
        public static bool operator !=(ProviderPermissionsScope left, ProviderPermissionsScope right) => !left.Equals(right);

        public static explicit operator string(ProviderPermissionsScope value) => value._value;
