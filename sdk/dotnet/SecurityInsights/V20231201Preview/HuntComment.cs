...
namespace Pulumi.AzureNative.SecurityInsights.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231201preview:HuntComment")]
    public partial class HuntComment : global::Pulumi.CustomResource
    {
        ...
        public HuntComment(string name, HuntCommentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231201preview:HuntComment", name, args ?? new HuntCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HuntComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231201preview:HuntComment", name, null, MakeResourceOptions(options, id))
        {
        }
