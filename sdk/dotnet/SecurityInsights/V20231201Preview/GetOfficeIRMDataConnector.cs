...
namespace Pulumi.AzureNative.SecurityInsights.V20231201Preview
{
    public static class GetOfficeIRMDataConnector
    {
        ...
        public static Task<GetOfficeIRMDataConnectorResult> InvokeAsync(GetOfficeIRMDataConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOfficeIRMDataConnectorResult>("azure-native:securityinsights/v20231201preview:getOfficeIRMDataConnector", args ?? new GetOfficeIRMDataConnectorArgs(), options.WithDefaults());
        ...
        public static Output<GetOfficeIRMDataConnectorResult> Invoke(GetOfficeIRMDataConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOfficeIRMDataConnectorResult>("azure-native:securityinsights/v20231201preview:getOfficeIRMDataConnector", args ?? new GetOfficeIRMDataConnectorInvokeArgs(), options.WithDefaults());
    }
