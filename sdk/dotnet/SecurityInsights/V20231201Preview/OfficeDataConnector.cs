...
namespace Pulumi.AzureNative.SecurityInsights.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231201preview:OfficeDataConnector")]
    public partial class OfficeDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficeDataConnector(string name, OfficeDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231201preview:OfficeDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficeDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231201preview:OfficeDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
