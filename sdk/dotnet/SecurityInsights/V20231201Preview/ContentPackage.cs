...
namespace Pulumi.AzureNative.SecurityInsights.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231201preview:ContentPackage")]
    public partial class ContentPackage : global::Pulumi.CustomResource
    {
        ...
        public ContentPackage(string name, ContentPackageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231201preview:ContentPackage", name, args ?? new ContentPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentPackage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231201preview:ContentPackage", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20231101:ContentPackage" },
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20240101preview:ContentPackage" },
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20240301:ContentPackage" },
                    new global::Pulumi.Alias { Type = "azure-native:securityinsights/v20240401preview:ContentPackage" },
    ...
    public sealed class ContentPackageArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20231201Preview.PackageKind> ContentKind { get; set; } = null!;
        ...
        /// </summary>
        [Input("isDeprecated")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20231201Preview.Flag>? IsDeprecated { get; set; }

        /// <summary>
        /// Flag indicates if this package is among the featured list.
        /// </summary>
        [Input("isFeatured")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20231201Preview.Flag>? IsFeatured { get; set; }

        /// <summary>
        /// Flag indicates if this is a newly published package.
        /// </summary>
        [Input("isNew")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20231201Preview.Flag>? IsNew { get; set; }

        /// <summary>
        /// Flag indicates if this package is in preview.
        /// </summary>
        [Input("isPreview")]
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20231201Preview.Flag>? IsPreview { get; set; }
