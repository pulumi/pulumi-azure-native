...
namespace Pulumi.AzureNative.SecurityInsights.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20231201preview:EyesOn")]
    public partial class EyesOn : global::Pulumi.CustomResource
    {
        ...
        public EyesOn(string name, EyesOnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231201preview:EyesOn", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EyesOn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20231201preview:EyesOn", name, null, MakeResourceOptions(options, id))
        {
        }
