...
namespace Pulumi.AzureNative.SecurityInsights.V20220901Preview
{
    public static class GetAction
    {
        ...
        public static Task<GetActionResult> InvokeAsync(GetActionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetActionResult>("azure-native:securityinsights/v20220901preview:getAction", args ?? new GetActionArgs(), options.WithDefaults());

        /// <summary>
        /// Action for alert rule.
        /// </summary>
        public static Output<GetActionResult> Invoke(GetActionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetActionResult>("azure-native:securityinsights/v20220901preview:getAction", args ?? new GetActionInvokeArgs(), options.WithDefaults());
    }
