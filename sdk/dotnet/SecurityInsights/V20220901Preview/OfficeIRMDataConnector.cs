...
namespace Pulumi.AzureNative.SecurityInsights.V20220901Preview
{
    ...
    /// {
    ///     var officeIRMDataConnector = new AzureNative.SecurityInsights.V20220901Preview.OfficeIRMDataConnector("officeIRMDataConnector", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20220901preview:OfficeIRMDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220901preview:OfficeIRMDataConnector")]
    public partial class OfficeIRMDataConnector : global::Pulumi.CustomResource
    {
        ...
        public OfficeIRMDataConnector(string name, OfficeIRMDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:OfficeIRMDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private OfficeIRMDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:OfficeIRMDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
