...
namespace Pulumi.AzureNative.SecurityInsights.V20220901Preview
{
    ...
    /// {
    ///     var dynamics365DataConnector = new AzureNative.SecurityInsights.V20220901Preview.Dynamics365DataConnector("dynamics365DataConnector", new()
    ///     {
    ...
    ///         DataTypes = new AzureNative.SecurityInsights.V20220901Preview.Inputs.Dynamics365DataConnectorDataTypesArgs
    ///         {
    ///             Dynamics365CdsActivities = new AzureNative.SecurityInsights.V20220901Preview.Inputs.Dynamics365DataConnectorDataTypesDynamics365CdsActivitiesArgs
    ///             {
    ///                 State = "Enabled",
    ///             },
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:securityinsights/v20220901preview:Dynamics365DataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220901preview:Dynamics365DataConnector")]
    public partial class Dynamics365DataConnector : global::Pulumi.CustomResource
    {
        ...
        public Dynamics365DataConnector(string name, Dynamics365DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:Dynamics365DataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private Dynamics365DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:Dynamics365DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
