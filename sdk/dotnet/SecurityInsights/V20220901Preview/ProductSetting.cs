...
namespace Pulumi.AzureNative.SecurityInsights.V20220901Preview
{
    ...
    [AzureNativeResourceType("azure-native:securityinsights/v20220901preview:ProductSetting")]
    public partial class ProductSetting : global::Pulumi.CustomResource
    {
        ...
        public ProductSetting(string name, ProductSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:ProductSetting", name, args ?? new ProductSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:ProductSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProductSettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220901Preview.SettingKind> Kind { get; set; } = null!;
