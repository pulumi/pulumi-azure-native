...
namespace Pulumi.AzureNative.SecurityInsights.V20220901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20220901preview:IncidentRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:IncidentRelation to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20220901preview:IncidentRelation")]
    public partial class IncidentRelation : global::Pulumi.CustomResource
    {
        ...
        public IncidentRelation(string name, IncidentRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:IncidentRelation", name, args ?? new IncidentRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IncidentRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:IncidentRelation", name, null, MakeResourceOptions(options, id))
        {
        }
