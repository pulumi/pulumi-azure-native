...
namespace Pulumi.AzureNative.SecurityInsights.V20220901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20220901preview:AwsCloudTrailDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20220901preview:AwsCloudTrailDataConnector")]
    public partial class AwsCloudTrailDataConnector : global::Pulumi.CustomResource
    {
        ...
        public AwsCloudTrailDataConnector(string name, AwsCloudTrailDataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:AwsCloudTrailDataConnector", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AwsCloudTrailDataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:AwsCloudTrailDataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
