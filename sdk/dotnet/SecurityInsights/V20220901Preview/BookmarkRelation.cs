...
namespace Pulumi.AzureNative.SecurityInsights.V20220901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:securityinsights/v20220901preview:BookmarkRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:BookmarkRelation to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:securityinsights/v20220901preview:BookmarkRelation")]
    public partial class BookmarkRelation : global::Pulumi.CustomResource
    {
        ...
        public BookmarkRelation(string name, BookmarkRelationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:BookmarkRelation", name, args ?? new BookmarkRelationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BookmarkRelation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:BookmarkRelation", name, null, MakeResourceOptions(options, id))
        {
        }
