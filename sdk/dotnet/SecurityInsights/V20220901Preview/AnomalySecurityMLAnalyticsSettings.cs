...
namespace Pulumi.AzureNative.SecurityInsights.V20220901Preview
{
    ...
    /// {
    ///     var anomalySecurityMLAnalyticsSettings = new AzureNative.SecurityInsights.V20220901Preview.AnomalySecurityMLAnalyticsSettings("anomalySecurityMLAnalyticsSettings", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.SecurityInsights.V20220901Preview.Inputs.SecurityMLAnalyticsSettingsDataSourceArgs
    ///             {
    ///                 ConnectorId = "AWS",
    ///                 DataTypes = new[]
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:securityinsights/v20220901preview:AnomalySecurityMLAnalyticsSettings")]
    public partial class AnomalySecurityMLAnalyticsSettings : global::Pulumi.CustomResource
    {
        ...
        public AnomalySecurityMLAnalyticsSettings(string name, AnomalySecurityMLAnalyticsSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:AnomalySecurityMLAnalyticsSettings", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AnomalySecurityMLAnalyticsSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20220901preview:AnomalySecurityMLAnalyticsSettings", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AnomalySecurityMLAnalyticsSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20220901Preview.SettingsStatus> SettingsStatus { get; set; } = null!;
