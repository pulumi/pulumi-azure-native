...
namespace Pulumi.AzureNative.SecurityInsights
{
    ...
    public partial class SourceControl : global::Pulumi.CustomResource
    {
        ...
        public SourceControl(string name, SourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:SourceControl", name, args ?? new SourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights:SourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20210301preview:securityinsights:SourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20210901preview:securityinsights:SourceControl" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20220501preview:securityinsights:SourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20220601preview:securityinsights:SourceControl" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20220901preview:securityinsights:SourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20221001preview:securityinsights:SourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20221101preview:securityinsights:SourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20221201preview:securityinsights:SourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20230201preview:securityinsights:SourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20230301preview:securityinsights:SourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20230401preview:securityinsights:SourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native_securityinsights_v20230501preview:securityinsights:SourceControl" },
                },
            };
    ...
    public sealed class SourceControlArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.SecurityInsights.ContentType>>? _contentTypes;

        /// <summary>
        /// Array of source control content types.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.SecurityInsights.ContentType>> ContentTypes
        {
            get => _contentTypes ?? (_contentTypes = new InputList<Union<string, Pulumi.AzureNative.SecurityInsights.ContentType>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.RepoType> RepoType { get; set; } = null!;
