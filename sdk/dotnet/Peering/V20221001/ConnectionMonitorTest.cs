...
namespace Pulumi.AzureNative.Peering.V20221001
{
    ...
    /// {
    ///     var connectionMonitorTest = new AzureNative.Peering.V20221001.ConnectionMonitorTest("connectionMonitorTest", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20221001:ConnectionMonitorTest")]
    public partial class ConnectionMonitorTest : global::Pulumi.CustomResource
    {
        ...
        public ConnectionMonitorTest(string name, ConnectionMonitorTestArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:ConnectionMonitorTest", name, args ?? new ConnectionMonitorTestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionMonitorTest(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:ConnectionMonitorTest", name, null, MakeResourceOptions(options, id))
        {
        }
