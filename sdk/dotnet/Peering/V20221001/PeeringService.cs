...
namespace Pulumi.AzureNative.Peering.V20221001
{
    ...
    /// {
    ///     var peeringService = new AzureNative.Peering.V20221001.PeeringService("peeringService", new()
    ///     {
    ///         Location = "eastus",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:peering/v20221001:PeeringService peeringServiceName /subscriptions/subId/resourceGroups/rgName/providers/Microsoft.Peering/peeringServices/peeringServiceName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20221001:PeeringService")]
    public partial class PeeringService : global::Pulumi.CustomResource
    {
        ...
        public PeeringService(string name, PeeringServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:PeeringService", name, args ?? new PeeringServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeeringService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:PeeringService", name, null, MakeResourceOptions(options, id))
        {
        }
