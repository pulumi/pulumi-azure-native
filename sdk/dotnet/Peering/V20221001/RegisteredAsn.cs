...
namespace Pulumi.AzureNative.Peering.V20221001
{
    ...
    /// {
    ///     var registeredAsn = new AzureNative.Peering.V20221001.RegisteredAsn("registeredAsn", new()
    ///     {
    ///         Asn = 65000,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20221001:RegisteredAsn")]
    public partial class RegisteredAsn : global::Pulumi.CustomResource
    {
        ...
        public RegisteredAsn(string name, RegisteredAsnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:RegisteredAsn", name, args ?? new RegisteredAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:RegisteredAsn", name, null, MakeResourceOptions(options, id))
        {
        }
