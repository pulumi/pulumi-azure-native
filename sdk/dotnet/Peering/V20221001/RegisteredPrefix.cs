...
namespace Pulumi.AzureNative.Peering.V20221001
{
    ...
    public partial class RegisteredPrefix : global::Pulumi.CustomResource
    {
        ...
        public RegisteredPrefix(string name, RegisteredPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:RegisteredPrefix", name, args ?? new RegisteredPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:RegisteredPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
