...
namespace Pulumi.AzureNative.Peering.V20221001
{
    ...
    public partial class PeerAsn : global::Pulumi.CustomResource
    {
        ...
        public PeerAsn(string name, PeerAsnArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:PeerAsn", name, args ?? new PeerAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeerAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20221001:PeerAsn", name, null, MakeResourceOptions(options, id))
        {
        }
