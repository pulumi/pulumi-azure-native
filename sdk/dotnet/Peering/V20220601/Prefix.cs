...
namespace Pulumi.AzureNative.Peering.V20220601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:peering/v20220601:Prefix is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:Prefix to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:peering/v20220601:Prefix")]
    public partial class Prefix : global::Pulumi.CustomResource
    {
        ...
        public Prefix(string name, PrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220601:Prefix", name, args ?? new PrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Prefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220601:Prefix", name, null, MakeResourceOptions(options, id))
        {
        }
