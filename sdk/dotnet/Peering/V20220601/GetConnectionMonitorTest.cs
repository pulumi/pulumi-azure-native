...
namespace Pulumi.AzureNative.Peering.V20220601
{
    public static class GetConnectionMonitorTest
    {
        ...
        public static Task<GetConnectionMonitorTestResult> InvokeAsync(GetConnectionMonitorTestArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConnectionMonitorTestResult>("azure-native:peering/v20220601:getConnectionMonitorTest", args ?? new GetConnectionMonitorTestArgs(), options.WithDefaults());
        ...
        public static Output<GetConnectionMonitorTestResult> Invoke(GetConnectionMonitorTestInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetConnectionMonitorTestResult>("azure-native:peering/v20220601:getConnectionMonitorTest", args ?? new GetConnectionMonitorTestInvokeArgs(), options.WithDefaults());
    }
