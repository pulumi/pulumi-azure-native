...
namespace Pulumi.AzureNextGen.Peering.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:peering/v20201001:RegisteredPrefix")]
    public partial class RegisteredPrefix : Pulumi.CustomResource
    {
        ...
        public RegisteredPrefix(string name, RegisteredPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20201001:RegisteredPrefix", name, args ?? new RegisteredPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20201001:RegisteredPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
