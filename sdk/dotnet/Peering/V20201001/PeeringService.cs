...
namespace Pulumi.AzureNative.Peering.V20201001
{
    ...
    /// Peering Service
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20201001:PeeringService")]
    public partial class PeeringService : Pulumi.CustomResource
    {
        ...
        public PeeringService(string name, PeeringServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20201001:PeeringService", name, args ?? new PeeringServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeeringService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20201001:PeeringService", name, null, MakeResourceOptions(options, id))
        {
        }
