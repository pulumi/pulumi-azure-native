...
namespace Pulumi.AzureNextGen.Peering.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:peering/v20201001:RegisteredAsn")]
    public partial class RegisteredAsn : Pulumi.CustomResource
    {
        ...
        public RegisteredAsn(string name, RegisteredAsnArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20201001:RegisteredAsn", name, args ?? new RegisteredAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20201001:RegisteredAsn", name, null, MakeResourceOptions(options, id))
        {
        }
