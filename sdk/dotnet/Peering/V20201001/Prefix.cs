...
namespace Pulumi.AzureNextGen.Peering.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:peering/v20201001:Prefix")]
    public partial class Prefix : Pulumi.CustomResource
    {
        ...
        public Prefix(string name, PrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20201001:Prefix", name, args ?? new PrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Prefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20201001:Prefix", name, null, MakeResourceOptions(options, id))
        {
        }
