...
namespace Pulumi.AzureNextGen.Peering.V20200101Preview
{
    ...
    /// Peering Service
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:peering/v20200101preview:PeeringService")]
    public partial class PeeringService : Pulumi.CustomResource
    {
        ...
        public PeeringService(string name, PeeringServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20200101preview:PeeringService", name, args ?? new PeeringServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeeringService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20200101preview:PeeringService", name, null, MakeResourceOptions(options, id))
        {
        }
