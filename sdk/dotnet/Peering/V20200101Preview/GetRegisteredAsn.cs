...
namespace Pulumi.AzureNative.Peering.V20200101Preview
{
    ...
    public static class GetRegisteredAsn
    {
        ...
        public static Task<GetRegisteredAsnResult> InvokeAsync(GetRegisteredAsnArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegisteredAsnResult>("azure-native:peering/v20200101preview:getRegisteredAsn", args ?? new GetRegisteredAsnArgs(), options.WithDefaults());

        /// <summary>
        /// The customer's ASN that is registered by the peering service provider.
        /// </summary>
        public static Output<GetRegisteredAsnResult> Invoke(GetRegisteredAsnInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRegisteredAsnResult>("azure-native:peering/v20200101preview:getRegisteredAsn", args ?? new GetRegisteredAsnInvokeArgs(), options.WithDefaults());
    }
