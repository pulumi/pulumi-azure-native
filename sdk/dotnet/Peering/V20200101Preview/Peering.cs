...
namespace Pulumi.AzureRM.Peering.V20200101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var peering = new AzureRM.Peering.V20200101Preview.Peering("peering", new AzureRM.Peering.V20200101Preview.PeeringArgs
    ///         {
    ///             Direct = new AzureRM.Peering.V20200101Preview.Inputs.PeeringPropertiesDirectArgs
    ///             {
    ///                 Connections = 
    ///                 {
    ///                     new AzureRM.Peering.V20200101Preview.Inputs.DirectConnectionArgs
    ///                     {
    ///                         BandwidthInMbps = 10000,
    ///                         BgpSession = new AzureRM.Peering.V20200101Preview.Inputs.BgpSessionArgs
    ///                         {
    ...
    ///                 PeerAsn = new AzureRM.Peering.V20200101Preview.Inputs.SubResourceArgs
    ///                 {
    ...
    ///             Sku = new AzureRM.Peering.V20200101Preview.Inputs.PeeringSkuArgs
    ///             {
    ...
    ///         var peering = new AzureRM.Peering.V20200101Preview.Peering("peering", new AzureRM.Peering.V20200101Preview.PeeringArgs
    ///         {
    ///             Exchange = new AzureRM.Peering.V20200101Preview.Inputs.PeeringPropertiesExchangeArgs
    ///             {
    ///                 Connections = 
    ///                 {
    ///                     new AzureRM.Peering.V20200101Preview.Inputs.ExchangeConnectionArgs
    ///                     {
    ///                         BgpSession = new AzureRM.Peering.V20200101Preview.Inputs.BgpSessionArgs
    ///                         {
    ///                             MaxPrefixesAdvertisedV4 = 1000,
    ...
    public partial class Peering : Pulumi.CustomResource
    {
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20200101preview:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20200101preview:Peering", name, null, MakeResourceOptions(options, id))
        {
        }
