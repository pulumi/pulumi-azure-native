...
namespace Pulumi.AzureRM.Peering.V20200101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var prefix = new AzureRM.Peering.V20200101Preview.Prefix("prefix", new AzureRM.Peering.V20200101Preview.PrefixArgs
    ///         {
    ...
    public partial class Prefix : Pulumi.CustomResource
    {
        ...
        public Prefix(string name, PrefixArgs args, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20200101preview:Prefix", name, args ?? new PrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Prefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20200101preview:Prefix", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:peering/v20200401:Prefix"},
                },
            };
