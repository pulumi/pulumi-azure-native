...
namespace Pulumi.AzureRM.Peering.V20190901Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var peering = new AzureRM.Peering.V20190901Preview.Peering("peering", new AzureRM.Peering.V20190901Preview.PeeringArgs
    ///         {
    ///             Direct = new AzureRM.Peering.V20190901Preview.Inputs.PeeringPropertiesDirectArgs
    ///             {
    ///                 Connections = 
    ///                 {
    ///                     new AzureRM.Peering.V20190901Preview.Inputs.DirectConnectionArgs
    ///                     {
    ///                         BandwidthInMbps = 10000,
    ///                         BgpSession = new AzureRM.Peering.V20190901Preview.Inputs.BgpSessionArgs
    ///                         {
    ...
    ///                 PeerAsn = new AzureRM.Peering.V20190901Preview.Inputs.SubResourceArgs
    ///                 {
    ...
    ///             Sku = new AzureRM.Peering.V20190901Preview.Inputs.PeeringSkuArgs
    ///             {
    ...
    ///         var peering = new AzureRM.Peering.V20190901Preview.Peering("peering", new AzureRM.Peering.V20190901Preview.PeeringArgs
    ///         {
    ///             Exchange = new AzureRM.Peering.V20190901Preview.Inputs.PeeringPropertiesExchangeArgs
    ///             {
    ///                 Connections = 
    ///                 {
    ///                     new AzureRM.Peering.V20190901Preview.Inputs.ExchangeConnectionArgs
    ///                     {
    ///                         BgpSession = new AzureRM.Peering.V20190901Preview.Inputs.BgpSessionArgs
    ///                         {
    ///                             MaxPrefixesAdvertisedV4 = 1000,
    ...
    public partial class Peering : Pulumi.CustomResource
    {
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20190901preview:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20190901preview:Peering", name, null, MakeResourceOptions(options, id))
        {
        }
