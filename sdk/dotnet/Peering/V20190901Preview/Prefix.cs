...
namespace Pulumi.AzureRM.Peering.V20190901Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var prefix = new AzureRM.Peering.V20190901Preview.Prefix("prefix", new AzureRM.Peering.V20190901Preview.PrefixArgs
    ///         {
    ...
    public partial class Prefix : Pulumi.CustomResource
    {
        ...
        public Prefix(string name, PrefixArgs args, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20190901preview:Prefix", name, args ?? new PrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Prefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20190901preview:Prefix", name, null, MakeResourceOptions(options, id))
        {
        }
