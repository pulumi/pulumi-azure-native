...
namespace Pulumi.AzureNextGen.Peering.V20190901Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:peering/v20190901preview:PeerAsn")]
    public partial class PeerAsn : Pulumi.CustomResource
    {
        ...
        public PeerAsn(string name, PeerAsnArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20190901preview:PeerAsn", name, args ?? new PeerAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeerAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20190901preview:PeerAsn", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PeerAsnArgs : Pulumi.ResourceArgs
    {
        ...
        /// The contact information of the peer.
        /// </summary>
        [Input("peerContactInfo")]
        public Input<Inputs.ContactInfoArgs>? PeerContactInfo { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Peering.V20190901Preview.ValidationState>? ValidationState { get; set; }
