...
namespace Pulumi.AzureRM.Peering.V20190901Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var peeringService = new AzureRM.Peering.V20190901Preview.PeeringService("peeringService", new AzureRM.Peering.V20190901Preview.PeeringServiceArgs
    ///         {
    ///             Location = "eastus",
    ...
    public partial class PeeringService : Pulumi.CustomResource
    {
        ...
        public PeeringService(string name, PeeringServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20190901preview:PeeringService", name, args ?? new PeeringServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeeringService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20190901preview:PeeringService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:peering/v20200401:PeeringService"},
                },
            };
