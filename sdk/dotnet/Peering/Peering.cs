...
namespace Pulumi.AzureRM.Peering
{
    ...
    public partial class Peering : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PeeringPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("azurerm:peering:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, PeeringState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:peering:Peering", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PeeringState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PeeringPropertiesResponseGetArgs> Properties { get; set; } = null!;

        /// <summary>
        /// The SKU that defines the tier and kind of the peering.
        /// </summary>
        [Input("sku", required: true)]
        public Input<Inputs.PeeringSkuResponseGetArgs> Sku { get; set; } = null!;
