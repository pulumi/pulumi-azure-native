...
namespace Pulumi.AzureNative.Peering.V20200401
{
    ...
    public partial class PeerAsn : Pulumi.CustomResource
    {
        ...
        public PeerAsn(string name, PeerAsnArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20200401:PeerAsn", name, args ?? new PeerAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeerAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20200401:PeerAsn", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PeerAsnArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Peering.V20200401.ValidationState>? ValidationState { get; set; }
