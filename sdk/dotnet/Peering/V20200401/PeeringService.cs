...
namespace Pulumi.AzureNative.Peering.V20200401
{
    ...
    [AzureNativeResourceType("azure-native:peering/v20200401:PeeringService")]
    public partial class PeeringService : Pulumi.CustomResource
    {
        ...
        public PeeringService(string name, PeeringServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20200401:PeeringService", name, args ?? new PeeringServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeeringService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20200401:PeeringService", name, null, MakeResourceOptions(options, id))
        {
        }
