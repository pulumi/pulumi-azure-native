...
namespace Pulumi.AzureNative.Peering.V20200401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20200401:RegisteredAsn")]
    public partial class RegisteredAsn : Pulumi.CustomResource
    {
        ...
        public RegisteredAsn(string name, RegisteredAsnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20200401:RegisteredAsn", name, args ?? new RegisteredAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20200401:RegisteredAsn", name, null, MakeResourceOptions(options, id))
        {
        }
