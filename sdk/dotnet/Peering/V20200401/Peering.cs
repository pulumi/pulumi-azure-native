...
namespace Pulumi.AzureNative.Peering.V20200401
{
    ...
    public partial class Peering : global::Pulumi.CustomResource
    {
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20200401:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20200401:Peering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Peering.V20200401.Kind> Kind { get; set; } = null!;
