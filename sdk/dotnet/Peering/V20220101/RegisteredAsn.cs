...
namespace Pulumi.AzureNative.Peering.V20220101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:peering/v20220101:RegisteredAsn is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:RegisteredAsn to guarantee forwards compatibility.")]
    ...
    public partial class RegisteredAsn : global::Pulumi.CustomResource
    {
        ...
        public RegisteredAsn(string name, RegisteredAsnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220101:RegisteredAsn", name, args ?? new RegisteredAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220101:RegisteredAsn", name, null, MakeResourceOptions(options, id))
        {
        }
