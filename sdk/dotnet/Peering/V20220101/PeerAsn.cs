...
namespace Pulumi.AzureNative.Peering.V20220101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:peering/v20220101:PeerAsn is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:PeerAsn to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:peering/v20220101:PeerAsn")]
    public partial class PeerAsn : global::Pulumi.CustomResource
    {
        ...
        public PeerAsn(string name, PeerAsnArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220101:PeerAsn", name, args ?? new PeerAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeerAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220101:PeerAsn", name, null, MakeResourceOptions(options, id))
        {
        }
