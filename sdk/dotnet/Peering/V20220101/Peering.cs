...
namespace Pulumi.AzureNative.Peering.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20220101:Peering")]
    public partial class Peering : global::Pulumi.CustomResource
    {
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220101:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220101:Peering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Peering.V20220101.Kind> Kind { get; set; } = null!;
