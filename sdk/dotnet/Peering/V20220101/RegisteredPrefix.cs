...
namespace Pulumi.AzureNative.Peering.V20220101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20220101:RegisteredPrefix")]
    public partial class RegisteredPrefix : global::Pulumi.CustomResource
    {
        ...
        public RegisteredPrefix(string name, RegisteredPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220101:RegisteredPrefix", name, args ?? new RegisteredPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20220101:RegisteredPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
