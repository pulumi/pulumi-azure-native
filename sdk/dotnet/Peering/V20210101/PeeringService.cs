...
namespace Pulumi.AzureNative.Peering.V20210101
{
    ...
    /// {
    ///     var peeringService = new AzureNative.Peering.V20210101.PeeringService("peeringService", new()
    ///     {
    ///         Location = "eastus",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20210101:PeeringService")]
    public partial class PeeringService : global::Pulumi.CustomResource
    {
        ...
        public PeeringService(string name, PeeringServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:PeeringService", name, args ?? new PeeringServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeeringService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:PeeringService", name, null, MakeResourceOptions(options, id))
        {
        }
