...
namespace Pulumi.AzureNative.Peering.V20210101
{
    public static class GetPeerAsn
    {
        ...
        public static Task<GetPeerAsnResult> InvokeAsync(GetPeerAsnArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPeerAsnResult>("azure-native:peering/v20210101:getPeerAsn", args ?? new GetPeerAsnArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the peer ASN with the specified name under the given subscription.
        /// </summary>
        public static Output<GetPeerAsnResult> Invoke(GetPeerAsnInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPeerAsnResult>("azure-native:peering/v20210101:getPeerAsn", args ?? new GetPeerAsnInvokeArgs(), options.WithDefaults());
