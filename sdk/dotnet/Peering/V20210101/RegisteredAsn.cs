...
namespace Pulumi.AzureNative.Peering.V20210101
{
    ...
    /// {
    ///     var registeredAsn = new AzureNative.Peering.V20210101.RegisteredAsn("registeredAsn", new()
    ///     {
    ///         Asn = 65000,
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:peering/v20210101:RegisteredAsn registeredAsnName /subscriptions/subId/resourceGroups/rgName/providers/Microsoft.Peering/peerings/peeringName/registeredAsns/registeredAsnName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20210101:RegisteredAsn")]
    public partial class RegisteredAsn : global::Pulumi.CustomResource
    {
        ...
        public RegisteredAsn(string name, RegisteredAsnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:RegisteredAsn", name, args ?? new RegisteredAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:RegisteredAsn", name, null, MakeResourceOptions(options, id))
        {
        }
