...
namespace Pulumi.AzureNative.Peering.V20210101
{
    ...
    /// {
    ///     var peering = new AzureNative.Peering.V20210101.Peering("peering", new()
    ///     {
    ///         Direct = new AzureNative.Peering.V20210101.Inputs.PeeringPropertiesDirectArgs
    ///         {
    ///             Connections = new[]
    ///             {
    ///                 new AzureNative.Peering.V20210101.Inputs.DirectConnectionArgs
    ///                 {
    ///                     BandwidthInMbps = 10000,
    ///                     BgpSession = new AzureNative.Peering.V20210101.Inputs.BgpSessionArgs
    ///                     {
    ...
    ///             PeerAsn = new AzureNative.Peering.V20210101.Inputs.SubResourceArgs
    ///             {
    ...
    ///         Sku = new AzureNative.Peering.V20210101.Inputs.PeeringSkuArgs
    ///         {
    ...
    ///     var peering = new AzureNative.Peering.V20210101.Peering("peering", new()
    ///     {
    ///         Exchange = new AzureNative.Peering.V20210101.Inputs.PeeringPropertiesExchangeArgs
    ///         {
    ///             Connections = new[]
    ///             {
    ///                 new AzureNative.Peering.V20210101.Inputs.ExchangeConnectionArgs
    ///                 {
    ///                     BgpSession = new AzureNative.Peering.V20210101.Inputs.BgpSessionArgs
    ///                     {
    ///                         MaxPrefixesAdvertisedV4 = 1000,
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:peering/v20210101:Peering peeringName /subscriptions/subId/resourceGroups/rgName/providers/Microsoft.Peering/peerings/peeringName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20210101:Peering")]
    public partial class Peering : global::Pulumi.CustomResource
    {
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:Peering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Peering.V20210101.Kind> Kind { get; set; } = null!;
