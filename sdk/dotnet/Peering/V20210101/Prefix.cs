...
namespace Pulumi.AzureNative.Peering.V20210101
{
    ...
    [AzureNativeResourceType("azure-native:peering/v20210101:Prefix")]
    public partial class Prefix : global::Pulumi.CustomResource
    {
        ...
        public Prefix(string name, PrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:Prefix", name, args ?? new PrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Prefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:Prefix", name, null, MakeResourceOptions(options, id))
        {
        }
