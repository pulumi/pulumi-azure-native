...
namespace Pulumi.AzureNative.Peering.V20210101
{
    ...
    /// {
    ///     var registeredPrefix = new AzureNative.Peering.V20210101.RegisteredPrefix("registeredPrefix", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20210101:RegisteredPrefix")]
    public partial class RegisteredPrefix : global::Pulumi.CustomResource
    {
        ...
        public RegisteredPrefix(string name, RegisteredPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:RegisteredPrefix", name, args ?? new RegisteredPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210101:RegisteredPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
