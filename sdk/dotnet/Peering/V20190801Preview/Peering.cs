...
namespace Pulumi.AzureNextGen.Peering.V20190801Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:peering/v20190801preview:Peering")]
    public partial class Peering : Pulumi.CustomResource
    {
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20190801preview:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:peering/v20190801preview:Peering", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PeeringArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Peering.V20190801Preview.Kind> Kind { get; set; } = null!;
