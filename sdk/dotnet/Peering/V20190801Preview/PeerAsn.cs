...
namespace Pulumi.AzureRM.Peering.V20190801Preview
{
    ...
    public partial class PeerAsn : Pulumi.CustomResource
    {
        ...
        public PeerAsn(string name, PeerAsnArgs args, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20190801preview:PeerAsn", name, args ?? new PeerAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeerAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:peering/v20190801preview:PeerAsn", name, null, MakeResourceOptions(options, id))
        {
        }
