...
namespace Pulumi.AzureRM.Peering.Preview
{
    public static class GetRegisteredAsn
    {
        public static Task<GetRegisteredAsnResult> InvokeAsync(GetRegisteredAsnArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegisteredAsnResult>("azurerm:peering/preview:getRegisteredAsn", args ?? new GetRegisteredAsnArgs(), options.WithVersion());
    }
