...
namespace Pulumi.AzureNative.Peering.Latest
{
    ...
    public partial class RegisteredPrefix : Pulumi.CustomResource
    {
        ...
        public RegisteredPrefix(string name, RegisteredPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/latest:RegisteredPrefix", name, args ?? new RegisteredPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/latest:RegisteredPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:peering/v20210101:RegisteredPrefix"},
                },
            };
