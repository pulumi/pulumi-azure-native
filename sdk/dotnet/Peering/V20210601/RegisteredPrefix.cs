...
namespace Pulumi.AzureNative.Peering.V20210601
{
    ...
    public partial class RegisteredPrefix : global::Pulumi.CustomResource
    {
        ...
        public RegisteredPrefix(string name, RegisteredPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:RegisteredPrefix", name, args ?? new RegisteredPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegisteredPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:RegisteredPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
