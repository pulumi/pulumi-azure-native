...
namespace Pulumi.AzureNative.Peering.V20210601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:peering/v20210601:Peering is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:Peering to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:peering/v20210601:Peering")]
    public partial class Peering : global::Pulumi.CustomResource
    {
        ...
        public Peering(string name, PeeringArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:Peering", name, args ?? new PeeringArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Peering(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:Peering", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:peering:Peering"},
    ...
    public sealed class PeeringArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Peering.V20210601.Kind> Kind { get; set; } = null!;
