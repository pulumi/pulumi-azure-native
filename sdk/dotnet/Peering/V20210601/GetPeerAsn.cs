...
namespace Pulumi.AzureNative.Peering.V20210601
{
    public static class GetPeerAsn
    {
        ...
        public static Task<GetPeerAsnResult> InvokeAsync(GetPeerAsnArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPeerAsnResult>("azure-native:peering/v20210601:getPeerAsn", args ?? new GetPeerAsnArgs(), options.WithVersion());

        /// <summary>
        /// The essential information related to the peer's ASN.
        /// </summary>
        public static Output<GetPeerAsnResult> Invoke(GetPeerAsnInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPeerAsnResult>("azure-native:peering/v20210601:getPeerAsn", args ?? new GetPeerAsnInvokeArgs(), options.WithVersion());
    }
