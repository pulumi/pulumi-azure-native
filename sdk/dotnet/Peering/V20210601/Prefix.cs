...
namespace Pulumi.AzureNative.Peering.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20210601:Prefix")]
    public partial class Prefix : global::Pulumi.CustomResource
    {
        ...
        public Prefix(string name, PrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:Prefix", name, args ?? new PrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Prefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:Prefix", name, null, MakeResourceOptions(options, id))
        {
        }
