...
namespace Pulumi.AzureNative.Peering.V20210601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20210601:PeerAsn")]
    public partial class PeerAsn : global::Pulumi.CustomResource
    {
        ...
        public PeerAsn(string name, PeerAsnArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:PeerAsn", name, args ?? new PeerAsnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeerAsn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:PeerAsn", name, null, MakeResourceOptions(options, id))
        {
        }
