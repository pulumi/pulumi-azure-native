...
namespace Pulumi.AzureNative.Peering.V20210601
{
    ...
    /// Peering Service
    /// </summary>
    [AzureNativeResourceType("azure-native:peering/v20210601:PeeringService")]
    public partial class PeeringService : Pulumi.CustomResource
    {
        ...
        public PeeringService(string name, PeeringServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:PeeringService", name, args ?? new PeeringServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeeringService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:peering/v20210601:PeeringService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:peering/v20220101:PeeringService"},
                    new Pulumi.Alias { Type = "azure-native:peering/v20220601:PeeringService"},
                },
            };
