...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20240401:RegistryComponentContainer")]
    public partial class RegistryComponentContainer : global::Pulumi.CustomResource
    {
        ...
        public RegistryComponentContainer(string name, RegistryComponentContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240401:RegistryComponentContainer", name, args ?? new RegistryComponentContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistryComponentContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240401:RegistryComponentContainer", name, null, MakeResourceOptions(options, id))
        {
        }
