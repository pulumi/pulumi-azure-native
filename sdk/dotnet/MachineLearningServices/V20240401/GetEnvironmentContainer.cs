...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401
{
    public static class GetEnvironmentContainer
    {
        ...
        public static Task<GetEnvironmentContainerResult> InvokeAsync(GetEnvironmentContainerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentContainerResult>("azure-native:machinelearningservices/v20240401:getEnvironmentContainer", args ?? new GetEnvironmentContainerArgs(), options.WithDefaults());
        ...
        public static Output<GetEnvironmentContainerResult> Invoke(GetEnvironmentContainerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEnvironmentContainerResult>("azure-native:machinelearningservices/v20240401:getEnvironmentContainer", args ?? new GetEnvironmentContainerInvokeArgs(), options.WithDefaults());
