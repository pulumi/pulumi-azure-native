...
namespace Pulumi.AzureNative.MachineLearningServices.V20210701
{
    public static class GetCompute
    {
        ...
        public static Task<GetComputeResult> InvokeAsync(GetComputeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComputeResult>("azure-native:machinelearningservices/v20210701:getCompute", args ?? new GetComputeArgs(), options.WithVersion());

        /// <summary>
        /// Machine Learning compute object wrapped into ARM resource envelope.
        /// </summary>
        public static Output<GetComputeResult> Invoke(GetComputeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetComputeResult>("azure-native:machinelearningservices/v20210701:getCompute", args ?? new GetComputeInvokeArgs(), options.WithVersion());
    }
