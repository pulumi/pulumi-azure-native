...
namespace Pulumi.AzureNative.MachineLearningServices.V20210301Preview
{
    public static class ListWorkspaceStorageAccountKeys
    {
        public static Task<ListWorkspaceStorageAccountKeysResult> InvokeAsync(ListWorkspaceStorageAccountKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWorkspaceStorageAccountKeysResult>("azure-native:machinelearningservices/v20210301preview:listWorkspaceStorageAccountKeys", args ?? new ListWorkspaceStorageAccountKeysArgs(), options.WithDefaults());
        ...
        public static Output<ListWorkspaceStorageAccountKeysResult> Invoke(ListWorkspaceStorageAccountKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListWorkspaceStorageAccountKeysResult>("azure-native:machinelearningservices/v20210301preview:listWorkspaceStorageAccountKeys", args ?? new ListWorkspaceStorageAccountKeysInvokeArgs(), options.WithDefaults());
    }


    public sealed class ListWorkspaceStorageAccountKeysArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class ListWorkspaceStorageAccountKeysInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The name of the resource group. The name is case insensitive.
        /// </summary>
