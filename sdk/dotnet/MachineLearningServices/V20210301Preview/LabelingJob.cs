...
namespace Pulumi.AzureNative.MachineLearningServices.V20210301Preview
{
    ...
    public partial class LabelingJob : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.LabelingJobResponse> Properties { get; private set; } = null!;
        ...
        public LabelingJob(string name, LabelingJobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:LabelingJob", name, args ?? new LabelingJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabelingJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:LabelingJob", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LabelingJobArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LabelingJobArgs> Properties { get; set; } = null!;
