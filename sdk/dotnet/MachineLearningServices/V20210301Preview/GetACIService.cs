...
namespace Pulumi.AzureNative.MachineLearningServices.V20210301Preview
{
    public static class GetACIService
    {
        ...
        public static Task<GetACIServiceResult> InvokeAsync(GetACIServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetACIServiceResult>("azure-native:machinelearningservices/v20210301preview:getACIService", args ?? new GetACIServiceArgs(), options.WithVersion());
    }
