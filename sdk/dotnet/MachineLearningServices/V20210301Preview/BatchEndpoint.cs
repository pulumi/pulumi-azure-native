...
namespace Pulumi.AzureNative.MachineLearningServices.V20210301Preview
{
    ...
    public partial class BatchEndpoint : Pulumi.CustomResource
    {
        ...
        public BatchEndpoint(string name, BatchEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:BatchEndpoint", name, args ?? new BatchEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:BatchEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:machinelearningservices/v20210301preview:BatchEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:machinelearningservices:BatchEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:machinelearningservices:BatchEndpoint"},
                },
            };
