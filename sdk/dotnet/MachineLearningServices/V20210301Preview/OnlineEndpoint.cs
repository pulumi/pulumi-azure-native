    ...
    public partial class OnlineEndpoint : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:machinelearningservices/v20210301preview:OnlineEndpoint"},
                    new Pulumi.Alias { Type = "azure-native:machinelearningservices:OnlineEndpoint"},
                    new Pulumi.Alias { Type = "azure-nextgen:machinelearningservices:OnlineEndpoint"},
                },
            };
