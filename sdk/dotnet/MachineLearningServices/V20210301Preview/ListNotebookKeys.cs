...
namespace Pulumi.AzureNative.MachineLearningServices.V20210301Preview
{
    public static class ListNotebookKeys
    {
        public static Task<ListNotebookKeysResult> InvokeAsync(ListNotebookKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNotebookKeysResult>("azure-native:machinelearningservices/v20210301preview:listNotebookKeys", args ?? new ListNotebookKeysArgs(), options.WithVersion());
    }
