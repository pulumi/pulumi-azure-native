...
namespace Pulumi.AzureNative.MachineLearningServices.V20210301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210301preview:AKSService")]
    public partial class AKSService : Pulumi.CustomResource
    {
        ...
        public AKSService(string name, AKSServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:AKSService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AKSService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:AKSService", name, null, MakeResourceOptions(options, id))
        {
        }
