...
namespace Pulumi.AzureNative.MachineLearningServices.V20210301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210301preview:EndpointVariant")]
    public partial class EndpointVariant : Pulumi.CustomResource
    {
        ...
        public EndpointVariant(string name, EndpointVariantArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:EndpointVariant", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EndpointVariant(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:EndpointVariant", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EndpointVariantArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20210301Preview.VariantType>? Type { get; set; }
