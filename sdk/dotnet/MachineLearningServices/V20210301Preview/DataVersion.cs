...
namespace Pulumi.AzureNative.MachineLearningServices.V20210301Preview
{
    ...
    /// {
    ///     var dataVersion = new AzureNative.MachineLearningServices.V20210301Preview.DataVersion("dataVersion", new()
    ///     {
    ///         Name = "dataset123",
    ///         Properties = new AzureNative.MachineLearningServices.V20210301Preview.Inputs.DataVersionArgs
    ///         {
    ///             DatasetType = "Simple",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210301preview:DataVersion")]
    public partial class DataVersion : global::Pulumi.CustomResource
    {
        ...
        public DataVersion(string name, DataVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:DataVersion", name, args ?? new DataVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:DataVersion", name, null, MakeResourceOptions(options, id))
        {
        }
