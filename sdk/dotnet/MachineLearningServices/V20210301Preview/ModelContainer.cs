...
namespace Pulumi.AzureNative.MachineLearningServices.V20210301Preview
{
    ...
    /// {
    ///     var modelContainer = new AzureNative.MachineLearningServices.V20210301Preview.ModelContainer("modelContainer", new()
    ///     {
    ///         Name = "testContainer",
    ///         Properties = new AzureNative.MachineLearningServices.V20210301Preview.Inputs.ModelContainerArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210301preview:ModelContainer")]
    public partial class ModelContainer : global::Pulumi.CustomResource
    {
        ...
        public ModelContainer(string name, ModelContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:ModelContainer", name, args ?? new ModelContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ModelContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210301preview:ModelContainer", name, null, MakeResourceOptions(options, id))
        {
        }
