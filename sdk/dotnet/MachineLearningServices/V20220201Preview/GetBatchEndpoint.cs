...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    public static class GetBatchEndpoint
    {
        public static Task<GetBatchEndpointResult> InvokeAsync(GetBatchEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBatchEndpointResult>("azure-native:machinelearningservices/v20220201preview:getBatchEndpoint", args ?? new GetBatchEndpointArgs(), options.WithDefaults());

        public static Output<GetBatchEndpointResult> Invoke(GetBatchEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBatchEndpointResult>("azure-native:machinelearningservices/v20220201preview:getBatchEndpoint", args ?? new GetBatchEndpointInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetBatchEndpointResult
    {
        ...
        /// </summary>
        public readonly Outputs.BatchEndpointResponse BatchEndpointDetails;
        /// <summary>
        ...
        private GetBatchEndpointResult(
            Outputs.BatchEndpointResponse batchEndpointDetails,
            ...
            string type)
        {
            BatchEndpointDetails = batchEndpointDetails;
            Id = id;
            Identity = identity;
            Kind = kind;
            Location = location;
