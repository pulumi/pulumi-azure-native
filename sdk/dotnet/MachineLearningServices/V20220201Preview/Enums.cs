...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    ...
    public readonly struct DataType : IEquatable<DataType>
    {
        ...
        public static DataType UriFile { get; } = new DataType("UriFile");
        public static DataType UriFolder { get; } = new DataType("UriFolder");
    ...
    public readonly struct JobInputType : IEquatable<JobInputType>
    {
        ...
        public static JobInputType UriFile { get; } = new JobInputType("UriFile");
        public static JobInputType UriFolder { get; } = new JobInputType("UriFolder");
        public static JobInputType MLTable { get; } = new JobInputType("MLTable");
        public static JobInputType CustomModel { get; } = new JobInputType("CustomModel");
        public static JobInputType MLFlowModel { get; } = new JobInputType("MLFlowModel");
        public static JobInputType TritonModel { get; } = new JobInputType("TritonModel");
    ...
    public readonly struct JobOutputType : IEquatable<JobOutputType>
    {
        ...
        public static JobOutputType UriFile { get; } = new JobOutputType("UriFile");
        public static JobOutputType UriFolder { get; } = new JobOutputType("UriFolder");
        public static JobOutputType MLTable { get; } = new JobOutputType("MLTable");
        public static JobOutputType CustomModel { get; } = new JobOutputType("CustomModel");
        public static JobOutputType MLFlowModel { get; } = new JobOutputType("MLFlowModel");
        public static JobOutputType TritonModel { get; } = new JobOutputType("TritonModel");
    ...
    public readonly struct ModelType : IEquatable<ModelType>
    {
        ...
        public static ModelType CustomModel { get; } = new ModelType("CustomModel");
        public static ModelType MLFlowModel { get; } = new ModelType("MLFlowModel");
        public static ModelType TritonModel { get; } = new ModelType("TritonModel");

        public static bool operator ==(ModelType left, ModelType right) => left.Equals(right);
        public static bool operator !=(ModelType left, ModelType right) => !left.Equals(right);

        public static explicit operator string(ModelType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ModelType other && Equals(other);
        public bool Equals(ModelType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct ScheduleType : IEquatable<ScheduleType>
    {
        private readonly string _value;
        ...
        /// Cron schedule type
        /// </summary>
        public static ScheduleType Cron { get; } = new ScheduleType("Cron");
        /// <summary>
        /// Recurrence schedule type
        /// </summary>
        public static ScheduleType Recurrence { get; } = new ScheduleType("Recurrence");

        public static bool operator ==(ScheduleType left, ScheduleType right) => left.Equals(right);
        public static bool operator !=(ScheduleType left, ScheduleType right) => !left.Equals(right);

        public static explicit operator string(ScheduleType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ScheduleType other && Equals(other);
        public bool Equals(ScheduleType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
