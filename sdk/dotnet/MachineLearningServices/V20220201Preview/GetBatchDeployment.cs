...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    public static class GetBatchDeployment
    {
        public static Task<GetBatchDeploymentResult> InvokeAsync(GetBatchDeploymentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBatchDeploymentResult>("azure-native:machinelearningservices/v20220201preview:getBatchDeployment", args ?? new GetBatchDeploymentArgs(), options.WithDefaults());

        public static Output<GetBatchDeploymentResult> Invoke(GetBatchDeploymentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBatchDeploymentResult>("azure-native:machinelearningservices/v20220201preview:getBatchDeployment", args ?? new GetBatchDeploymentInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetBatchDeploymentResult
    {
        ...
        /// </summary>
        public readonly Outputs.BatchDeploymentResponse BatchDeploymentDetails;
        /// <summary>
        ...
        private GetBatchDeploymentResult(
            Outputs.BatchDeploymentResponse batchDeploymentDetails,
            ...
            string type)
        {
            BatchDeploymentDetails = batchDeploymentDetails;
            Id = id;
            Identity = identity;
            Kind = kind;
            Location = location;
