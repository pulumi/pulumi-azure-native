...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("azure-native:machinelearningservices/v20220201preview:getJob", args ?? new GetJobArgs(), options.WithDefaults());

        /// <summary>
        /// Azure Resource Manager resource envelope.
        /// </summary>
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetJobResult>("azure-native:machinelearningservices/v20220201preview:getJob", args ?? new GetJobInvokeArgs(), options.WithDefaults());
    }
