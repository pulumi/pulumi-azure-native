...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    public static class GetCompute
    {
        ...
        public static Task<GetComputeResult> InvokeAsync(GetComputeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetComputeResult>("azure-native:machinelearningservices/v20220201preview:getCompute", args ?? new GetComputeArgs(), options.WithDefaults());

        /// <summary>
        /// Machine Learning compute object wrapped into ARM resource envelope.
        /// </summary>
        public static Output<GetComputeResult> Invoke(GetComputeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetComputeResult>("azure-native:machinelearningservices/v20220201preview:getCompute", args ?? new GetComputeInvokeArgs(), options.WithDefaults());
    }
