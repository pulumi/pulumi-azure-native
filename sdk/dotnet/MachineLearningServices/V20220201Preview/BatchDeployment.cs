...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    ...
    public partial class BatchDeployment : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("batchDeploymentDetails")]
        public Output<Outputs.BatchDeploymentResponse> BatchDeploymentDetails { get; private set; } = null!;
        ...
        public BatchDeployment(string name, BatchDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220201preview:BatchDeployment", name, args ?? new BatchDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220201preview:BatchDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BatchDeploymentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// [Required] Additional attributes of the entity.
        /// </summary>
        [Input("batchDeploymentDetails", required: true)]
        public Input<Inputs.BatchDeploymentArgs> BatchDeploymentDetails { get; set; } = null!;
