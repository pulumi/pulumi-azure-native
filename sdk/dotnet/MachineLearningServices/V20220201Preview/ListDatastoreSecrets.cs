...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    public static class ListDatastoreSecrets
    {
        ...
        public static Task<ListDatastoreSecretsResult> InvokeAsync(ListDatastoreSecretsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListDatastoreSecretsResult>("azure-native:machinelearningservices/v20220201preview:listDatastoreSecrets", args ?? new ListDatastoreSecretsArgs(), options.WithDefaults());

        /// <summary>
        /// Base definition for datastore secrets.
        /// </summary>
        public static Output<ListDatastoreSecretsResult> Invoke(ListDatastoreSecretsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListDatastoreSecretsResult>("azure-native:machinelearningservices/v20220201preview:listDatastoreSecrets", args ?? new ListDatastoreSecretsInvokeArgs(), options.WithDefaults());
    }
