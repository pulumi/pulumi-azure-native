...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    ...
    public partial class DataContainer : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("dataContainerDetails")]
        public Output<Outputs.DataContainerResponse> DataContainerDetails { get; private set; } = null!;
        ...
        public DataContainer(string name, DataContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220201preview:DataContainer", name, args ?? new DataContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220201preview:DataContainer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataContainerArgs : Pulumi.ResourceArgs
    {
        ...
        /// [Required] Additional attributes of the entity.
        /// </summary>
        [Input("dataContainerDetails", required: true)]
        public Input<Inputs.DataContainerArgs> DataContainerDetails { get; set; } = null!;
