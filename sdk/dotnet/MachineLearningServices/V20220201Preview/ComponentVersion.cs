...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    ...
    /// {
    ///     var componentVersion = new AzureNative.MachineLearningServices.V20220201Preview.ComponentVersion("componentVersion", new()
    ///     {
    ///         ComponentVersionDetails = new AzureNative.MachineLearningServices.V20220201Preview.Inputs.ComponentVersionArgs
    ///         {
    ///             ComponentSpec = 
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20220201preview:ComponentVersion")]
    public partial class ComponentVersion : global::Pulumi.CustomResource
    {
        ...
        public ComponentVersion(string name, ComponentVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220201preview:ComponentVersion", name, args ?? new ComponentVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220201preview:ComponentVersion", name, null, MakeResourceOptions(options, id))
        {
        }
