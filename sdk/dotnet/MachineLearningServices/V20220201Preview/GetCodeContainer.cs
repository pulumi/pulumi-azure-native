...
namespace Pulumi.AzureNative.MachineLearningServices.V20220201Preview
{
    public static class GetCodeContainer
    {
        ...
        public static Task<GetCodeContainerResult> InvokeAsync(GetCodeContainerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCodeContainerResult>("azure-native:machinelearningservices/v20220201preview:getCodeContainer", args ?? new GetCodeContainerArgs(), options.WithDefaults());

        /// <summary>
        /// Azure Resource Manager resource envelope.
        /// </summary>
        public static Output<GetCodeContainerResult> Invoke(GetCodeContainerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCodeContainerResult>("azure-native:machinelearningservices/v20220201preview:getCodeContainer", args ?? new GetCodeContainerInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetCodeContainerResult
    {
        ...
        /// </summary>
        public readonly Outputs.CodeContainerResponse CodeContainerDetails;
        /// <summary>
        ...
        private GetCodeContainerResult(
            Outputs.CodeContainerResponse codeContainerDetails,
            ...
            string type)
        {
            CodeContainerDetails = codeContainerDetails;
            Id = id;
            Name = name;
