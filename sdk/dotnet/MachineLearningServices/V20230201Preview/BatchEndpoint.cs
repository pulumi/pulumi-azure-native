...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview
{
    ...
    /// {
    ///     var batchEndpoint = new AzureNative.MachineLearningServices.V20230201Preview.BatchEndpoint("batchEndpoint", new()
    ///     {
    ///         BatchEndpointProperties = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.BatchEndpointArgs
    ///         {
    ///             AuthMode = "AMLToken",
    ///             Defaults = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.BatchEndpointDefaultsArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230201preview:BatchEndpoint")]
    public partial class BatchEndpoint : global::Pulumi.CustomResource
    {
        ...
        public BatchEndpoint(string name, BatchEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:BatchEndpoint", name, args ?? new BatchEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:BatchEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
