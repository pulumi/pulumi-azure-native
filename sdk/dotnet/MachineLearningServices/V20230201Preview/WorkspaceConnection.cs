...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview
{
    ...
    /// {
    ///     var workspaceConnection = new AzureNative.MachineLearningServices.V20230201Preview.WorkspaceConnection("workspaceConnection", new()
    ///     {
    ///         ConnectionName = "connection-1",
    ///         Properties = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.NoneAuthTypeWorkspaceConnectionPropertiesArgs
    ///         {
    ///             AuthType = "None",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230201preview:WorkspaceConnection")]
    public partial class WorkspaceConnection : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceConnection(string name, WorkspaceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:WorkspaceConnection", name, args ?? new WorkspaceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:WorkspaceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
