...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview
{
    ...
    /// {
    ///     var batchDeployment = new AzureNative.MachineLearningServices.V20230201Preview.BatchDeployment("batchDeployment", new()
    ///     {
    ///         BatchDeploymentProperties = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.BatchDeploymentArgs
    ///         {
    ///             CodeConfiguration = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.CodeConfigurationArgs
    ///             {
    ///                 CodeId = "string",
    ...
    ///             MiniBatchSize = 1,
    ///             Model = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.IdAssetReferenceArgs
    ///             {
    ///                 AssetId = "string",
    ///                 ReferenceType = "Id",
    ///             },
    ...
    ///                 { "string", "string" },
    ///             },
    ///             Resources = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.DeploymentResourceConfigurationArgs
    ///             {
    ///                 InstanceCount = 1,
    ///                 InstanceType = "string",
    ///                 Properties = 
    ...
    ///                 },
    ///             },
    ///             RetrySettings = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.BatchRetrySettingsArgs
    ///             {
    ///                 MaxRetries = 1,
    ///                 Timeout = "PT5M",
    ///             },
    ...
    ///         Identity = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.ManagedServiceIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ...
    ///         Sku = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.SkuArgs
    ///         {
    ///             Capacity = 1,
    ///             Family = "string",
    ///             Name = "string",
    ///             Size = "string",
    ///             Tier = AzureNative.MachineLearningServices.V20230201Preview.SkuTier.Free,
    ///         },
    ///         Tags = null,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230201preview:BatchDeployment")]
    public partial class BatchDeployment : global::Pulumi.CustomResource
    {
        ...
        public BatchDeployment(string name, BatchDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:BatchDeployment", name, args ?? new BatchDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:BatchDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
