...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview
{
    ...
    /// {
    ///     var modelContainer = new AzureNative.MachineLearningServices.V20230201Preview.ModelContainer("modelContainer", new()
    ///     {
    ///         ModelContainerProperties = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.ModelContainerArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:machinelearningservices/v20230201preview:ModelContainer testContainer /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/workspace123/models/testContainer 
    /// ```
    /// </summary>
