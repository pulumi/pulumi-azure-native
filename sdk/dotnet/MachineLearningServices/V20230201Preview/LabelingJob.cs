...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview
{
    ...
    /// {
    ///     var labelingJob = new AzureNative.MachineLearningServices.V20230201Preview.LabelingJob("labelingJob", new()
    ///     {
    ///         Id = "testLabelingJob",
    ///         LabelingJobProperties = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.LabelingJobArgs
    ///         {
    ///             Description = "string",
    ///             JobInstructions = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.LabelingJobInstructionsArgs
    ///             {
    ...
    ///             LabelCategories = 
    ///             {
    ///                 { "myCategory1", new AzureNative.MachineLearningServices.V20230201Preview.Inputs.LabelCategoryArgs
    ///                 {
    ///                     Classes = 
    ///                     {
    ///                         { "myLabelClass1", new AzureNative.MachineLearningServices.V20230201Preview.Inputs.LabelClassArgs
    ///                         {
    ///                             DisplayName = "myLabelClass1",
    ///                             Subclasses = null,
    ///                         } },
    ///                         { "myLabelClass2", new AzureNative.MachineLearningServices.V20230201Preview.Inputs.LabelClassArgs
    ///                         {
    ...
    ///                 } },
    ///                 { "myCategory2", new AzureNative.MachineLearningServices.V20230201Preview.Inputs.LabelCategoryArgs
    ///                 {
    ///                     Classes = 
    ///                     {
    ///                         { "myLabelClass1", new AzureNative.MachineLearningServices.V20230201Preview.Inputs.LabelClassArgs
    ...
    ///                 } },
    ///             },
    ///             LabelingJobMediaProperties = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.LabelingJobImagePropertiesArgs
    ///             {
    ///                 MediaType = "Image",
    ///             },
    ///             MlAssistConfiguration = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.MLAssistConfigurationEnabledArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:machinelearningservices/v20230201preview:LabelingJob testLabelingJob /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/testworkspace/labelingJobs/testLabelingJob 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230201preview:LabelingJob")]
    public partial class LabelingJob : global::Pulumi.CustomResource
    {
        ...
        public LabelingJob(string name, LabelingJobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:LabelingJob", name, args ?? new LabelingJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabelingJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:LabelingJob", name, null, MakeResourceOptions(options, id))
        {
        }
