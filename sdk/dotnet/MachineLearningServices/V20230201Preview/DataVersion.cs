...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview
{
    ...
    /// {
    ///     var dataVersion = new AzureNative.MachineLearningServices.V20230201Preview.DataVersion("dataVersion", new()
    ///     {
    ///         DataVersionBaseProperties = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.UriFileDataVersionArgs
    ///         {
    ///             DataType = "uri_file",
    ///             DataUri = "string",
    ///             Description = "string",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230201preview:DataVersion")]
    public partial class DataVersion : global::Pulumi.CustomResource
    {
        ...
        public DataVersion(string name, DataVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:DataVersion", name, args ?? new DataVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:DataVersion", name, null, MakeResourceOptions(options, id))
        {
        }
