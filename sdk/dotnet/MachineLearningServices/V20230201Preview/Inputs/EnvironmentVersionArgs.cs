...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview.Inputs
{
    ...
    public sealed class EnvironmentVersionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoRebuild")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230201Preview.AutoRebuildSetting>? AutoRebuild { get; set; }
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230201Preview.OperatingSystemType>? OsType { get; set; }
