...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview.Inputs
{
    ...
    public sealed class ImageModelSettingsClassificationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230201Preview.LearningRateScheduler>? LearningRateScheduler { get; set; }
        ...
        /// </summary>
        [Input("optimizer")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230201Preview.StochasticOptimizer>? Optimizer { get; set; }
