...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview.Inputs
{
    ...
    public sealed class RandomSamplingAlgorithmArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("logbase")]
        public Input<string>? Logbase { get; set; }

        /// <summary>
        /// The specific type of random algorithm
        /// </summary>
        [Input("rule")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230201Preview.RandomSamplingAlgorithmRule>? Rule { get; set; }
