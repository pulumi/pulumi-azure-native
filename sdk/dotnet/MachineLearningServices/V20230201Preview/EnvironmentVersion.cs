...
namespace Pulumi.AzureNative.MachineLearningServices.V20230201Preview
{
    ...
    /// {
    ///     var environmentVersion = new AzureNative.MachineLearningServices.V20230201Preview.EnvironmentVersion("environmentVersion", new()
    ///     {
    ///         EnvironmentVersionProperties = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.EnvironmentVersionArgs
    ///         {
    ///             Build = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.BuildContextArgs
    ///             {
    ...
    ///             InferenceConfig = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.InferenceContainerPropertiesArgs
    ///             {
    ///                 LivenessRoute = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.RouteArgs
    ///                 {
    ///                     Path = "string",
    ///                     Port = 1,
    ///                 },
    ///                 ReadinessRoute = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.RouteArgs
    ///                 {
    ///                     Path = "string",
    ///                     Port = 1,
    ///                 },
    ///                 ScoringRoute = new AzureNative.MachineLearningServices.V20230201Preview.Inputs.RouteArgs
    ///                 {
    ///                     Path = "string",
    ///                     Port = 1,
    ///                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230201preview:EnvironmentVersion")]
    public partial class EnvironmentVersion : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentVersion(string name, EnvironmentVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:EnvironmentVersion", name, args ?? new EnvironmentVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230201preview:EnvironmentVersion", name, null, MakeResourceOptions(options, id))
        {
        }
