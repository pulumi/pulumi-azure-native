...
{
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230401:OnlineDeployment")]
    public partial class OnlineDeployment : global::Pulumi.CustomResource
    {
        ...
        public OnlineDeployment(string name, OnlineDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401:OnlineDeployment", name, args ?? new OnlineDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OnlineDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401:OnlineDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
