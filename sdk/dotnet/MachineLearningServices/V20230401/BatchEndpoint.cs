...
{
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230401:BatchEndpoint")]
    public partial class BatchEndpoint : global::Pulumi.CustomResource
    {
        ...
        public BatchEndpoint(string name, BatchEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401:BatchEndpoint", name, args ?? new BatchEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401:BatchEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
