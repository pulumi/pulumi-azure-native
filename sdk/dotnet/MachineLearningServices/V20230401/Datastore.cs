...
namespace Pulumi.AzureNative.MachineLearningServices.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230401:Datastore")]
    public partial class Datastore : global::Pulumi.CustomResource
    {
        ...
        public Datastore(string name, DatastoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401:Datastore", name, args ?? new DatastoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Datastore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401:Datastore", name, null, MakeResourceOptions(options, id))
        {
        }
