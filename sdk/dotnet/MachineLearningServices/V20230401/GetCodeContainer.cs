...
namespace Pulumi.AzureNative.MachineLearningServices.V20230401
{
    public static class GetCodeContainer
    {
        ...
        public static Task<GetCodeContainerResult> InvokeAsync(GetCodeContainerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCodeContainerResult>("azure-native:machinelearningservices/v20230401:getCodeContainer", args ?? new GetCodeContainerArgs(), options.WithDefaults());

        /// <summary>
        /// Azure Resource Manager resource envelope.
        /// </summary>
        public static Output<GetCodeContainerResult> Invoke(GetCodeContainerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCodeContainerResult>("azure-native:machinelearningservices/v20230401:getCodeContainer", args ?? new GetCodeContainerInvokeArgs(), options.WithDefaults());
    }
