...
namespace Pulumi.AzureNative.MachineLearningServices.V20230401.Inputs
{
    ...
    public sealed class BatchDeploymentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("loggingLevel")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230401.BatchLoggingLevel>? LoggingLevel { get; set; }
        ...
        /// </summary>
        [Input("outputAction")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230401.BatchOutputAction>? OutputAction { get; set; }
