...
namespace Pulumi.AzureNative.MachineLearningServices.V20230401.Inputs
{
    ...
    public sealed class ImageModelSettingsObjectDetectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("modelSize")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230401.ModelSize>? ModelSize { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230401.ValidationMetricType>? ValidationMetricType { get; set; }
