...
namespace Pulumi.AzureNative.MachineLearningServices.V20230401.Inputs
{
    ...
    public sealed class ImageModelSettingsClassificationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230401.LearningRateScheduler>? LearningRateScheduler { get; set; }
        ...
        /// </summary>
        [Input("optimizer")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20230401.StochasticOptimizer>? Optimizer { get; set; }
