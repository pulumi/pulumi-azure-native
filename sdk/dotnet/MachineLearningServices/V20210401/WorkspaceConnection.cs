...
namespace Pulumi.AzureNative.MachineLearningServices.V20210401
{
    ...
    /// {
    ///     var workspaceConnection = new AzureNative.MachineLearningServices.V20210401.WorkspaceConnection("workspaceConnection", new()
    ///     {
    ///         AuthType = "PAT",
    ///         Category = "ACR",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210401:WorkspaceConnection")]
    public partial class WorkspaceConnection : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceConnection(string name, WorkspaceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210401:WorkspaceConnection", name, args ?? new WorkspaceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210401:WorkspaceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceConnectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("valueFormat")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20210401.ValueFormat>? ValueFormat { get; set; }
