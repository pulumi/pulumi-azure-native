...
namespace Pulumi.AzureNative.MachineLearningServices.V20210401
{
    ...
    public static class GetMachineLearningService
    {
        ...
        public static Task<GetMachineLearningServiceResult> InvokeAsync(GetMachineLearningServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineLearningServiceResult>("azure-native:machinelearningservices/v20210401:getMachineLearningService", args ?? new GetMachineLearningServiceArgs(), options.WithVersion());
        ...
        public static Output<GetMachineLearningServiceResult> Invoke(GetMachineLearningServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMachineLearningServiceResult>("azure-native:machinelearningservices/v20210401:getMachineLearningService", args ?? new GetMachineLearningServiceInvokeArgs(), options.WithVersion());
    }
