...
namespace Pulumi.AzureNative.MachineLearningServices.V20210401
{
    public static class GetAKSService
    {
        ...
        public static Task<GetAKSServiceResult> InvokeAsync(GetAKSServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAKSServiceResult>("azure-native:machinelearningservices/v20210401:getAKSService", args ?? new GetAKSServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Machine Learning service object wrapped into ARM resource envelope.
        /// </summary>
        public static Output<GetAKSServiceResult> Invoke(GetAKSServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAKSServiceResult>("azure-native:machinelearningservices/v20210401:getAKSService", args ?? new GetAKSServiceInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetAKSServiceResult
    {
        /// <summary>
