...
namespace Pulumi.AzureNative.MachineLearningServices.V20210401
{
    ...
    /// {
    ///     var aksService = new AzureNative.MachineLearningServices.V20210401.AKSService("aksService", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210401:AKSService")]
    public partial class AKSService : global::Pulumi.CustomResource
    {
        ...
        public AKSService(string name, AKSServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210401:AKSService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AKSService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210401:AKSService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AKSServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20210401.VariantType>? Type { get; set; }
