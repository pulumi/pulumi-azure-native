...
namespace Pulumi.AzureNative.MachineLearningServices.V20210401
{
    ...
    /// {
    ///     var endpointVariant = new AzureNative.MachineLearningServices.V20210401.EndpointVariant("endpointVariant", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210401:EndpointVariant")]
    public partial class EndpointVariant : global::Pulumi.CustomResource
    {
        ...
        public EndpointVariant(string name, EndpointVariantArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210401:EndpointVariant", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EndpointVariant(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210401:EndpointVariant", name, null, MakeResourceOptions(options, id))
        {
        }
