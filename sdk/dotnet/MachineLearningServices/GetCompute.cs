...
namespace Pulumi.AzureNative.MachineLearningServices
{
    public static class GetCompute
    {
        ...
        public static Task<GetComputeResult> InvokeAsync(GetComputeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComputeResult>("azure-native:machinelearningservices:getCompute", args ?? new GetComputeArgs(), options.WithDefaults());
        ...
        public static Output<GetComputeResult> Invoke(GetComputeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetComputeResult>("azure-native:machinelearningservices:getCompute", args ?? new GetComputeInvokeArgs(), options.WithDefaults());
    }
