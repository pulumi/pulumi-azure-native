...
{
    [AzureNativeResourceType("azure-native:machinelearningservices/v20240101preview:CapacityReservationGroup")]
    public partial class CapacityReservationGroup : global::Pulumi.CustomResource
    {
        /// <summary>
        /// [Required] Additional attributes of the entity.
        /// </summary>
        [Output("capacityReservationGroupProperties")]
        public Output<Outputs.CapacityReservationGroupResponse> CapacityReservationGroupProperties { get; private set; } = null!;
        ...
        public CapacityReservationGroup(string name, CapacityReservationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240101preview:CapacityReservationGroup", name, args ?? new CapacityReservationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240101preview:CapacityReservationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
