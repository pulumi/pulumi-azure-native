...
namespace Pulumi.AzureNative.MachineLearningServices.V20240101Preview
{
    public static class ListEndpointKeys
    {
        public static Task<ListEndpointKeysResult> InvokeAsync(ListEndpointKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListEndpointKeysResult>("azure-native:machinelearningservices/v20240101preview:listEndpointKeys", args ?? new ListEndpointKeysArgs(), options.WithDefaults());
