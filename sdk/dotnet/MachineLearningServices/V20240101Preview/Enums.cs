...
namespace Pulumi.AzureNative.MachineLearningServices.V20240101Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct GenerationSafetyQualityMetric : IEquatable<GenerationSafetyQualityMetric>
    {
        private readonly string _value;

        private GenerationSafetyQualityMetric(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static GenerationSafetyQualityMetric AcceptableGroundednessScorePerInstance { get; } = new GenerationSafetyQualityMetric("AcceptableGroundednessScorePerInstance");
        public static GenerationSafetyQualityMetric AggregatedGroundednessPassRate { get; } = new GenerationSafetyQualityMetric("AggregatedGroundednessPassRate");
        public static GenerationSafetyQualityMetric AcceptableCoherenceScorePerInstance { get; } = new GenerationSafetyQualityMetric("AcceptableCoherenceScorePerInstance");
        public static GenerationSafetyQualityMetric AggregatedCoherencePassRate { get; } = new GenerationSafetyQualityMetric("AggregatedCoherencePassRate");
        public static GenerationSafetyQualityMetric AcceptableFluencyScorePerInstance { get; } = new GenerationSafetyQualityMetric("AcceptableFluencyScorePerInstance");
        public static GenerationSafetyQualityMetric AggregatedFluencyPassRate { get; } = new GenerationSafetyQualityMetric("AggregatedFluencyPassRate");
        public static GenerationSafetyQualityMetric AcceptableSimilarityScorePerInstance { get; } = new GenerationSafetyQualityMetric("AcceptableSimilarityScorePerInstance");
        public static GenerationSafetyQualityMetric AggregatedSimilarityPassRate { get; } = new GenerationSafetyQualityMetric("AggregatedSimilarityPassRate");
        public static GenerationSafetyQualityMetric AcceptableRelevanceScorePerInstance { get; } = new GenerationSafetyQualityMetric("AcceptableRelevanceScorePerInstance");
        public static GenerationSafetyQualityMetric AggregatedRelevancePassRate { get; } = new GenerationSafetyQualityMetric("AggregatedRelevancePassRate");

        public static bool operator ==(GenerationSafetyQualityMetric left, GenerationSafetyQualityMetric right) => left.Equals(right);
        public static bool operator !=(GenerationSafetyQualityMetric left, GenerationSafetyQualityMetric right) => !left.Equals(right);

        public static explicit operator string(GenerationSafetyQualityMetric value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GenerationSafetyQualityMetric other && Equals(other);
        public bool Equals(GenerationSafetyQualityMetric other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct GenerationTokenUsageMetric : IEquatable<GenerationTokenUsageMetric>
    {
        private readonly string _value;

        private GenerationTokenUsageMetric(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static GenerationTokenUsageMetric TotalTokenCount { get; } = new GenerationTokenUsageMetric("TotalTokenCount");
        public static GenerationTokenUsageMetric TotalTokenCountPerGroup { get; } = new GenerationTokenUsageMetric("TotalTokenCountPerGroup");

        public static bool operator ==(GenerationTokenUsageMetric left, GenerationTokenUsageMetric right) => left.Equals(right);
        public static bool operator !=(GenerationTokenUsageMetric left, GenerationTokenUsageMetric right) => !left.Equals(right);

        public static explicit operator string(GenerationTokenUsageMetric value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GenerationTokenUsageMetric other && Equals(other);
        public bool Equals(GenerationTokenUsageMetric other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct ModelTaskType : IEquatable<ModelTaskType>
    {
        ...
        public static ModelTaskType QuestionAnswering { get; } = new ModelTaskType("QuestionAnswering");
    ...
    public readonly struct MonitoringNotificationType : IEquatable<MonitoringNotificationType>
    {
        ...
        /// </summary>
        public static MonitoringNotificationType AzureMonitor { get; } = new MonitoringNotificationType("AzureMonitor");
    ...
    public readonly struct MonitoringSignalType : IEquatable<MonitoringSignalType>
    {
        ...
        /// </summary>
        public static MonitoringSignalType GenerationSafetyQuality { get; } = new MonitoringSignalType("GenerationSafetyQuality");
        /// <summary>
        /// Tracks the token usage of generative endpoints.
        /// </summary>
        public static MonitoringSignalType GenerationTokenStatistics { get; } = new MonitoringSignalType("GenerationTokenStatistics");
