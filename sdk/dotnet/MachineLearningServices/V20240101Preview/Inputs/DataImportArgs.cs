...
namespace Pulumi.AzureNative.MachineLearningServices.V20240101Preview.Inputs
{
    ...
    public sealed class DataImportArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("source")]
        public InputUnion<Inputs.DatabaseSourceArgs, Inputs.FileSystemSourceArgs>? Source { get; set; }
        ...
        public static new DataImportArgs Empty => new DataImportArgs();
    }
}
