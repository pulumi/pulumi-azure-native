...
namespace Pulumi.AzureNative.MachineLearningServices.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20240101preview:EnvironmentVersion")]
    public partial class EnvironmentVersion : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentVersion(string name, EnvironmentVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240101preview:EnvironmentVersion", name, args ?? new EnvironmentVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240101preview:EnvironmentVersion", name, null, MakeResourceOptions(options, id))
        {
        }
