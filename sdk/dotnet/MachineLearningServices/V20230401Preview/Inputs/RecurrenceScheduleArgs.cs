...
namespace Pulumi.AzureNative.MachineLearningServices.V20230401Preview.Inputs
{
    ...
    public sealed class RecurrenceScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("weekDays")]
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230401Preview.WeekDay>>? _weekDays;

        /// <summary>
        /// List of days for the schedule.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230401Preview.WeekDay>> WeekDays
        {
            get => _weekDays ?? (_weekDays = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230401Preview.WeekDay>>());
            set => _weekDays = value;
        }
