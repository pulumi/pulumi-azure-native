...
namespace Pulumi.AzureNative.MachineLearningServices.V20230401Preview
{
    ...
    public partial class ManagedNetworkSettingsRule : global::Pulumi.CustomResource
    {
        ...
        public ManagedNetworkSettingsRule(string name, ManagedNetworkSettingsRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401preview:ManagedNetworkSettingsRule", name, args ?? new ManagedNetworkSettingsRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedNetworkSettingsRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401preview:ManagedNetworkSettingsRule", name, null, MakeResourceOptions(options, id))
        {
        }
