...
namespace Pulumi.AzureNative.MachineLearningServices.V20230401Preview
{
    ...
    /// {
    ///     var onlineDeployment = new AzureNative.MachineLearningServices.V20230401Preview.OnlineDeployment("onlineDeployment", new()
    ///     {
    ...
    ///         Kind = "string",
    ///         Location = "string",
    ///         OnlineDeploymentProperties = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.KubernetesOnlineDeploymentArgs
    ///         {
    ///             AppInsightsEnabled = false,
    ///             CodeConfiguration = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.CodeConfigurationArgs
    ///             {
    ///                 CodeId = "string",
    ///                 ScoringScript = "string",
    ///             },
    ///             ContainerResourceRequirements = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.ContainerResourceRequirementsArgs
    ///             {
    ///                 ContainerResourceLimits = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.ContainerResourceSettingsArgs
    ///                 {
    ///                     Cpu = "\"1\"",
    ///                     Gpu = "\"1\"",
    ///                     Memory = "\"2Gi\"",
    ///                 },
    ///                 ContainerResourceRequests = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.ContainerResourceSettingsArgs
    ///                 {
    ///                     Cpu = "\"1\"",
    ///                     Gpu = "\"1\"",
    ///                     Memory = "\"2Gi\"",
    ...
    ///             },
    ///             InstanceType = "string",
    ///             LivenessProbe = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.ProbeSettingsArgs
    ///             {
    ///                 FailureThreshold = 1,
    ///                 InitialDelay = "PT5M",
    ///                 Period = "PT5M",
    ...
    ///                 { "string", "string" },
    ///             },
    ///             RequestSettings = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.OnlineRequestSettingsArgs
    ///             {
    ///                 MaxConcurrentRequestsPerInstance = 1,
    ///                 MaxQueueWait = "PT5M",
    ///                 RequestTimeout = "PT5M",
    ///             },
    ///             ScaleSettings = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.DefaultScaleSettingsArgs
    ///             {
    ///                 ScaleType = "Default",
    ///             },
    ///         },
    ...
    ///         Kind = "string",
    ///         Location = "string",
    ///         OnlineDeploymentProperties = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.ManagedOnlineDeploymentArgs
    ///         {
    ///             AppInsightsEnabled = false,
    ///             CodeConfiguration = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.CodeConfigurationArgs
    ///             {
    ...
    ///                 { "string", "string" },
    ///             },
    ///             ReadinessProbe = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.ProbeSettingsArgs
    ///             {
    ///                 FailureThreshold = 30,
    ///                 InitialDelay = "PT1S",
    ///                 Period = "PT10S",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:machinelearningservices/v20230401preview:OnlineDeployment string string 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230401preview:OnlineDeployment")]
    public partial class OnlineDeployment : global::Pulumi.CustomResource
    {
        ...
        public OnlineDeployment(string name, OnlineDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401preview:OnlineDeployment", name, args ?? new OnlineDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OnlineDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401preview:OnlineDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
