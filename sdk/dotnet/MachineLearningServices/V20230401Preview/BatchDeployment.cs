...
namespace Pulumi.AzureNative.MachineLearningServices.V20230401Preview
{
    ...
    /// {
    ///     var batchDeployment = new AzureNative.MachineLearningServices.V20230401Preview.BatchDeployment("batchDeployment", new()
    ///     {
    ///         BatchDeploymentProperties = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.BatchDeploymentArgs
    ///         {
    ...
    ///             MiniBatchSize = 1,
    ///             Model = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.IdAssetReferenceArgs
    ///             {
    ///                 AssetId = "string",
    ///                 ReferenceType = "Id",
    ///             },
    ...
    ///                 { "string", "string" },
    ///             },
    ///             Resources = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.DeploymentResourceConfigurationArgs
    ///             {
    ///                 InstanceCount = 1,
    ///                 InstanceType = "string",
    ///                 Properties = 
    ...
    ///                 },
    ///             },
    ///             RetrySettings = new AzureNative.MachineLearningServices.V20230401Preview.Inputs.BatchRetrySettingsArgs
    ///             {
    ///                 MaxRetries = 1,
    ///                 Timeout = "PT5M",
    ///             },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:machinelearningservices/v20230401preview:BatchDeployment string string 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230401preview:BatchDeployment")]
    public partial class BatchDeployment : global::Pulumi.CustomResource
    {
        ...
        public BatchDeployment(string name, BatchDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401preview:BatchDeployment", name, args ?? new BatchDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230401preview:BatchDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
