...
namespace Pulumi.AzureNextGen.MachineLearningServices.V20200218Preview.Inputs
{
    ...
    public sealed class ComputeInstancePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningServices.V20200218Preview.ApplicationSharingPolicy>? ApplicationSharingPolicy { get; set; }

        /// <summary>
        /// The Compute Instance Authorization type. Available values are personal (default).
        /// </summary>
        [Input("computeInstanceAuthorizationType")]
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningServices.V20200218Preview.ComputeInstanceAuthorizationType>? ComputeInstanceAuthorizationType { get; set; }
