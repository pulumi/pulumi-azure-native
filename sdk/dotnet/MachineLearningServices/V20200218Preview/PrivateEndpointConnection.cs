...
namespace Pulumi.AzureRM.MachineLearningServices.V20200218Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.MachineLearningServices.V20200218Preview.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.MachineLearningServices.V20200218Preview.PrivateEndpointConnectionArgs
    ///         {
    ///             PrivateEndpointConnectionName = "{privateEndpointConnectionName}",
    ///             PrivateLinkServiceConnectionState = new AzureRM.MachineLearningServices.V20200218Preview.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200218preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200218preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
