...
namespace Pulumi.AzureNative.MachineLearningServices
{
    ...
    public partial class ConnectionRaiBlocklistItem : global::Pulumi.CustomResource
    {
        ...
        public ConnectionRaiBlocklistItem(string name, ConnectionRaiBlocklistItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices:ConnectionRaiBlocklistItem", name, args ?? new ConnectionRaiBlocklistItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionRaiBlocklistItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices:ConnectionRaiBlocklistItem", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:machinelearningservices/v20250401preview:ConnectionRaiBlocklistItem" },
                    new global::Pulumi.Alias { Type = "azure-native:machinelearningservices/v20250701preview:ConnectionRaiBlocklistItem" },
