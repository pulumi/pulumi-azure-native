...
namespace Pulumi.AzureNative.MachineLearningServices.V20190601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20190601:MachineLearningCompute")]
    public partial class MachineLearningCompute : Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20190601:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20190601:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
