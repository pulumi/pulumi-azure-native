...
namespace Pulumi.AzureRM.MachineLearningServices.V20190601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineLearningCompute = new AzureRM.MachineLearningServices.V20190601.MachineLearningCompute("machineLearningCompute", new AzureRM.MachineLearningServices.V20190601.MachineLearningComputeArgs
    ///         {
    ...
    ///             ComputeName = "compute123",
    ///             Location = "eastus",
    ///             Properties = new AzureRM.MachineLearningServices.V20190601.Inputs.ComputeArgs
    ///             {
    ...
    public partial class MachineLearningCompute : Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20190601:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20190601:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
