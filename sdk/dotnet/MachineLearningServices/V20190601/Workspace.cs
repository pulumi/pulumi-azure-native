...
namespace Pulumi.AzureNextGen.MachineLearningServices.V20190601
{
    /// <summary>
    /// An object that represents a machine learning workspace.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:machinelearningservices/v20190601:Workspace")]
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:machinelearningservices/v20190601:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:machinelearningservices/v20190601:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
