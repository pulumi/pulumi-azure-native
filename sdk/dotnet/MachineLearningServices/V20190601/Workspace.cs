...
namespace Pulumi.AzureNative.MachineLearningServices.V20190601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20190601:Workspace")]
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20190601:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20190601:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:machinelearningservices/v20210301preview:Workspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:machinelearningservices/v20210301preview:Workspace"},
                    new Pulumi.Alias { Type = "azure-native:machinelearningservices/v20210401:Workspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:machinelearningservices/v20210401:Workspace"},
                    new Pulumi.Alias { Type = "azure-native:machinelearningservices/v20210701:Workspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:machinelearningservices/v20210701:Workspace"},
                },
            };
