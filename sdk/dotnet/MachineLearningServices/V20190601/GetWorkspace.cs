...
namespace Pulumi.AzureRM.MachineLearningServices.V20190601
{
    public static class GetWorkspace
    {
        public static Task<GetWorkspaceResult> InvokeAsync(GetWorkspaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceResult>("azurerm:machinelearningservices/v20190601:getWorkspace", args ?? new GetWorkspaceArgs(), options.WithVersion());
    }
