...
namespace Pulumi.AzureNative.MachineLearningServices.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230801preview:RegistryComponentContainer")]
    public partial class RegistryComponentContainer : global::Pulumi.CustomResource
    {
        ...
        public RegistryComponentContainer(string name, RegistryComponentContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230801preview:RegistryComponentContainer", name, args ?? new RegistryComponentContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegistryComponentContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230801preview:RegistryComponentContainer", name, null, MakeResourceOptions(options, id))
        {
        }
