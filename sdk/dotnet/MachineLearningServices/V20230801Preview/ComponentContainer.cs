...
namespace Pulumi.AzureNative.MachineLearningServices.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230801preview:ComponentContainer")]
    public partial class ComponentContainer : global::Pulumi.CustomResource
    {
        ...
        public ComponentContainer(string name, ComponentContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230801preview:ComponentContainer", name, args ?? new ComponentContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230801preview:ComponentContainer", name, null, MakeResourceOptions(options, id))
        {
        }
