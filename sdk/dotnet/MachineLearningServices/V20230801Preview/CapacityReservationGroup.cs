...
{
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230801preview:CapacityReservationGroup")]
    public partial class CapacityReservationGroup : global::Pulumi.CustomResource
    {
        ...
        public CapacityReservationGroup(string name, CapacityReservationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230801preview:CapacityReservationGroup", name, args ?? new CapacityReservationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230801preview:CapacityReservationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
