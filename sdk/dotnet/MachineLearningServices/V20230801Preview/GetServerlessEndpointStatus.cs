...
namespace Pulumi.AzureNative.MachineLearningServices.V20230801Preview
{
    public static class GetServerlessEndpointStatus
    {
        public static Task<GetServerlessEndpointStatusResult> InvokeAsync(GetServerlessEndpointStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerlessEndpointStatusResult>("azure-native:machinelearningservices/v20230801preview:getServerlessEndpointStatus", args ?? new GetServerlessEndpointStatusArgs(), options.WithDefaults());
