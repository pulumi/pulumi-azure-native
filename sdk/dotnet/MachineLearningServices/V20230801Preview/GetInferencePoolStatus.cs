...
namespace Pulumi.AzureNative.MachineLearningServices.V20230801Preview
{
    public static class GetInferencePoolStatus
    {
        public static Task<GetInferencePoolStatusResult> InvokeAsync(GetInferencePoolStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInferencePoolStatusResult>("azure-native:machinelearningservices/v20230801preview:getInferencePoolStatus", args ?? new GetInferencePoolStatusArgs(), options.WithDefaults());
        ...
        public static Output<GetInferencePoolStatusResult> Invoke(GetInferencePoolStatusInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInferencePoolStatusResult>("azure-native:machinelearningservices/v20230801preview:getInferencePoolStatus", args ?? new GetInferencePoolStatusInvokeArgs(), options.WithDefaults());
    }
