...
namespace Pulumi.AzureNative.MachineLearningServices.V20230801Preview
{
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("azure-native:machinelearningservices/v20230801preview:getJob", args ?? new GetJobArgs(), options.WithDefaults());

        /// <summary>
        /// Azure Resource Manager resource envelope.
        /// </summary>
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobResult>("azure-native:machinelearningservices/v20230801preview:getJob", args ?? new GetJobInvokeArgs(), options.WithDefaults());
