...
namespace Pulumi.AzureNative.MachineLearningServices.V20230801Preview.Inputs
{
    ...
    public sealed class ForecastingTrainingSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230801Preview.ForecastingModels>>? _allowedTrainingAlgorithms;

        /// <summary>
        /// Allowed models for forecasting task.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230801Preview.ForecastingModels>> AllowedTrainingAlgorithms
        {
            get => _allowedTrainingAlgorithms ?? (_allowedTrainingAlgorithms = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230801Preview.ForecastingModels>>());
            set => _allowedTrainingAlgorithms = value;
        }

        [Input("blockedTrainingAlgorithms")]
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230801Preview.ForecastingModels>>? _blockedTrainingAlgorithms;

        /// <summary>
        /// Blocked models for forecasting task.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230801Preview.ForecastingModels>> BlockedTrainingAlgorithms
        {
            get => _blockedTrainingAlgorithms ?? (_blockedTrainingAlgorithms = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230801Preview.ForecastingModels>>());
