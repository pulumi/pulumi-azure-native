...
namespace Pulumi.AzureNative.MachineLearningServices.V20230801Preview
{
    public static class GetRegistryCodeVersion
    {
        ...
        public static Task<GetRegistryCodeVersionResult> InvokeAsync(GetRegistryCodeVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegistryCodeVersionResult>("azure-native:machinelearningservices/v20230801preview:getRegistryCodeVersion", args ?? new GetRegistryCodeVersionArgs(), options.WithDefaults());
        ...
        public static Output<GetRegistryCodeVersionResult> Invoke(GetRegistryCodeVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegistryCodeVersionResult>("azure-native:machinelearningservices/v20230801preview:getRegistryCodeVersion", args ?? new GetRegistryCodeVersionInvokeArgs(), options.WithDefaults());
