...
namespace Pulumi.AzureNative.MachineLearningServices
{
    ...
    public partial class ACIService : Pulumi.CustomResource
    {
        ...
        public ACIService(string name, ACIServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices:ACIService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ACIService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices:ACIService", name, null, MakeResourceOptions(options, id))
        {
        }
