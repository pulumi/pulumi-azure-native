...
namespace Pulumi.AzureNative.MachineLearningServices.V20220101Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct AllowRecoverSoftDeletedWorkspace : IEquatable<AllowRecoverSoftDeletedWorkspace>
    {
        private readonly string _value;

        private AllowRecoverSoftDeletedWorkspace(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static AllowRecoverSoftDeletedWorkspace True { get; } = new AllowRecoverSoftDeletedWorkspace("True");
        public static AllowRecoverSoftDeletedWorkspace False { get; } = new AllowRecoverSoftDeletedWorkspace("False");

        public static bool operator ==(AllowRecoverSoftDeletedWorkspace left, AllowRecoverSoftDeletedWorkspace right) => left.Equals(right);
        public static bool operator !=(AllowRecoverSoftDeletedWorkspace left, AllowRecoverSoftDeletedWorkspace right) => !left.Equals(right);

        public static explicit operator string(AllowRecoverSoftDeletedWorkspace value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is AllowRecoverSoftDeletedWorkspace other && Equals(other);
        public bool Equals(AllowRecoverSoftDeletedWorkspace other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct SoftDeleteEnabled : IEquatable<SoftDeleteEnabled>
    {
        private readonly string _value;

        private SoftDeleteEnabled(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static SoftDeleteEnabled True { get; } = new SoftDeleteEnabled("True");
        public static SoftDeleteEnabled False { get; } = new SoftDeleteEnabled("False");

        public static bool operator ==(SoftDeleteEnabled left, SoftDeleteEnabled right) => left.Equals(right);
        public static bool operator !=(SoftDeleteEnabled left, SoftDeleteEnabled right) => !left.Equals(right);

        public static explicit operator string(SoftDeleteEnabled value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is SoftDeleteEnabled other && Equals(other);
        public bool Equals(SoftDeleteEnabled other) => string.Equals(_value, other._value, StringComparison.Ordinal);
