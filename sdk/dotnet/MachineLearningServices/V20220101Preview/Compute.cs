...
namespace Pulumi.AzureNative.MachineLearningServices.V20220101Preview
{
    ...
    public partial class Compute : global::Pulumi.CustomResource
    {
        ...
        public Compute(string name, ComputeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220101preview:Compute", name, args ?? new ComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Compute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220101preview:Compute", name, null, MakeResourceOptions(options, id))
        {
        }
