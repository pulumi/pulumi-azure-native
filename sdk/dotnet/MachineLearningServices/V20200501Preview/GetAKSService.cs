...
{
    [Obsolete(@"azure-native:machinelearningservices/v20200501preview:AKSService is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:AKSService to guarantee forwards compatibility.")]
    public static class GetAKSService
    {
        ...
        public static Task<GetAKSServiceResult> InvokeAsync(GetAKSServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAKSServiceResult>("azure-native:machinelearningservices/v20200501preview:getAKSService", args ?? new GetAKSServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Service by name.
        /// </summary>
        public static Output<GetAKSServiceResult> Invoke(GetAKSServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAKSServiceResult>("azure-native:machinelearningservices/v20200501preview:getAKSService", args ?? new GetAKSServiceInvokeArgs(), options.WithDefaults());
    }
