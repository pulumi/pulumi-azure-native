...
namespace Pulumi.AzureRM.MachineLearningServices.V20200501Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var linkedWorkspace = new AzureRM.MachineLearningServices.V20200501Preview.LinkedWorkspace("linkedWorkspace", new AzureRM.MachineLearningServices.V20200501Preview.LinkedWorkspaceArgs
    ///         {
    ///             LinkName = "link-1",
    ///             Name = "link-1",
    ...
    public partial class LinkedWorkspace : Pulumi.CustomResource
    {
        ...
        public LinkedWorkspace(string name, LinkedWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200501preview:LinkedWorkspace", name, args ?? new LinkedWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200501preview:LinkedWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
