...
namespace Pulumi.AzureNative.MachineLearningServices.V20200501Preview.Inputs
{
    ...
    public sealed class DatasetCreateRequestParametersArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Header type.
        /// </summary>
        [Input("header")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20200501Preview.Header>? Header { get; set; }
        ...
        /// </summary>
        [Input("sourceType")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20200501Preview.SourceType>? SourceType { get; set; }

        public DatasetCreateRequestParametersArgs()
        {
            IncludePath = false;
        }
        public static new DatasetCreateRequestParametersArgs Empty => new DatasetCreateRequestParametersArgs();
    }
}
