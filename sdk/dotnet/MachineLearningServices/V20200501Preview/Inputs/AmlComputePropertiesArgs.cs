...
namespace Pulumi.AzureNextGen.MachineLearningServices.V20200501Preview.Inputs
{
    ...
    public sealed class AmlComputePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningServices.V20200501Preview.RemoteLoginPortPublicAccess>? RemoteLoginPortPublicAccess { get; set; }
        ...
        /// </summary>
        [Input("vmPriority")]
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningServices.V20200501Preview.VmPriority>? VmPriority { get; set; }
