...
namespace Pulumi.AzureNative.MachineLearningServices.V20200501Preview
{
    ...
    /// {
    ///     var aksService = new AzureNative.MachineLearningServices.V20200501Preview.AKSService("aksService", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20200501preview:AKSService")]
    public partial class AKSService : global::Pulumi.CustomResource
    {
        ...
        public AKSService(string name, AKSServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200501preview:AKSService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AKSService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200501preview:AKSService", name, null, MakeResourceOptions(options, id))
        {
        }
