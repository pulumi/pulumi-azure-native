...
namespace Pulumi.AzureNative.MachineLearningServices.V20200501Preview
{
    ...
    /// {
    ///     var aciService = new AzureNative.MachineLearningServices.V20200501Preview.ACIService("aciService", new()
    ///     {
    ///         AppInsightsEnabled = true,
    ///         AuthEnabled = true,
    ///         ComputeType = "ACI",
    ///         ContainerResourceRequirements = new AzureNative.MachineLearningServices.V20200501Preview.Inputs.ContainerResourceRequirementsArgs
    ///         {
    ///             Cpu = 1,
    ///             MemoryInGB = 1,
    ///         },
    ///         EnvironmentImageRequest = new AzureNative.MachineLearningServices.V20200501Preview.Inputs.CreateServiceRequestEnvironmentImageRequestArgs
    ///         {
    ///             Assets = new[]
    ///             {
    ///                 new AzureNative.MachineLearningServices.V20200501Preview.Inputs.ImageAssetArgs
    ///                 {
    ...
    ///             Environment = new AzureNative.MachineLearningServices.V20200501Preview.Inputs.EnvironmentImageRequestEnvironmentArgs
    ///             {
    ///                 Docker = new AzureNative.MachineLearningServices.V20200501Preview.Inputs.ModelEnvironmentDefinitionDockerArgs
    ///                 {
    ...
    ///                 Python = new AzureNative.MachineLearningServices.V20200501Preview.Inputs.ModelEnvironmentDefinitionPythonArgs
    ///                 {
    ///                     CondaDependencies = 
    ///                     {
    ///                         { "channels", new[]
    ...
    ///                 },
    ///                 Spark = new AzureNative.MachineLearningServices.V20200501Preview.Inputs.ModelEnvironmentDefinitionSparkArgs
    ///                 {
    ///                     Packages = new[] {},
    ...
    ///             Models = new[]
    ///             {
    ///                 new AzureNative.MachineLearningServices.V20200501Preview.Inputs.ModelArgs
    ///                 {
    ///                     MimeType = "application/x-python",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:machinelearningservices/v20200501preview:ACIService service456 subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/workspaces123/services/service456 
    /// ```
    /// </summary>
    ...
    public partial class ACIService : global::Pulumi.CustomResource
    {
        ...
        public ACIService(string name, ACIServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200501preview:ACIService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ACIService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200501preview:ACIService", name, null, MakeResourceOptions(options, id))
        {
        }
