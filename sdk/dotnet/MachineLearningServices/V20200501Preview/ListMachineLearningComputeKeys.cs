...
namespace Pulumi.AzureRM.MachineLearningServices.V20200501Preview
{
    public static class ListMachineLearningComputeKeys
    {
        public static Task<ListMachineLearningComputeKeysResult> InvokeAsync(ListMachineLearningComputeKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListMachineLearningComputeKeysResult>("azurerm:machinelearningservices/v20200501preview:listMachineLearningComputeKeys", args ?? new ListMachineLearningComputeKeysArgs(), options.WithVersion());
    }
