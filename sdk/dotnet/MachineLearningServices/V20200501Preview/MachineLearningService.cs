...
namespace Pulumi.AzureRM.MachineLearningServices.V20200501Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineLearningService = new AzureRM.MachineLearningServices.V20200501Preview.MachineLearningService("machineLearningService", new AzureRM.MachineLearningServices.V20200501Preview.MachineLearningServiceArgs
    ///         {
    ///             ComputeType = "ACI",
    ///             EnvironmentImageRequest = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.CreateServiceRequestEnvironmentImageRequestArgs
    ///             {
    ///                 Assets = 
    ///                 {
    ///                     new AzureRM.MachineLearningServices.V20200501Preview.Inputs.ImageAssetArgs
    ///                     {
    ...
    ///                 Environment = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.EnvironmentImageRequestEnvironmentArgs
    ///                 {
    ///                     Docker = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.ModelEnvironmentDefinitionDockerArgs
    ///                     {
    ...
    ///                     Python = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.ModelEnvironmentDefinitionPythonArgs
    ///                     {
    ///                         CondaDependencies = 
    ///                         {
    ///                             { "channels", 
    ...
    ///                     },
    ///                     Spark = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.ModelEnvironmentDefinitionSparkArgs
    ///                     {
    ///                         Packages = {},
    ...
    ///                 Models = 
    ///                 {
    ///                     new AzureRM.MachineLearningServices.V20200501Preview.Inputs.ModelArgs
    ///                     {
    ///                         MimeType = "application/x-python",
    ...
    public partial class MachineLearningService : Pulumi.CustomResource
    {
        ...
        public MachineLearningService(string name, MachineLearningServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200501preview:MachineLearningService", name, args ?? new MachineLearningServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200501preview:MachineLearningService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:machinelearningservices/v20200515preview:MachineLearningService"},
