...
namespace Pulumi.AzureNative.MachineLearningServices.V20200501Preview
{
    ...
    public static class GetMachineLearningService
    {
        ...
        public static Output<GetMachineLearningServiceResult> Invoke(GetMachineLearningServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMachineLearningServiceResult>("azure-native:machinelearningservices/v20200501preview:getMachineLearningService", args ?? new GetMachineLearningServiceInvokeArgs(), options.WithVersion());
    }
