...
namespace Pulumi.AzureRM.MachineLearningServices.V20200501Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workspace = new AzureRM.MachineLearningServices.V20200501Preview.Workspace("workspace", new AzureRM.MachineLearningServices.V20200501Preview.WorkspaceArgs
    ///         {
    ///             ApplicationInsights = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/microsoft.insights/components/testinsights",
    ///             ContainerRegistry = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/Microsoft.ContainerRegistry/registries/testRegistry",
    ///             Description = "test description",
    ///             Encryption = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.EncryptionPropertyArgs
    ///             {
    ///                 KeyVaultProperties = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.KeyVaultPropertiesArgs
    ///                 {
    ///                     IdentityClientId = "",
    ...
    ///             HbiWorkspace = false,
    ///             Identity = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.IdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ...
    ///             {
    ///                 new AzureRM.MachineLearningServices.V20200501Preview.Inputs.SharedPrivateLinkResourceArgs
    ///                 {
    ///                     Name = "testdbresource",
    ///                 },
    ///             },
    ///             Sku = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.SkuArgs
    ///             {
    ///                 Name = "Basic",
    ///                 Tier = "Basic",
    ///             },
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200501preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200501preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
