...
namespace Pulumi.AzureRM.MachineLearningServices.V20200501Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineLearningCompute = new AzureRM.MachineLearningServices.V20200501Preview.MachineLearningCompute("machineLearningCompute", new AzureRM.MachineLearningServices.V20200501Preview.MachineLearningComputeArgs
    ///         {
    ...
    ///             ComputeName = "compute123",
    ///             Location = "eastus",
    ///             Properties = new AzureRM.MachineLearningServices.V20200501Preview.Inputs.ComputeArgs
    ///             {
    ...
    public partial class MachineLearningCompute : Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200501preview:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200501preview:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
