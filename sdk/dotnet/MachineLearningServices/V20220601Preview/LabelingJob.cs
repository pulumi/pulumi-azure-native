...
namespace Pulumi.AzureNative.MachineLearningServices.V20220601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20220601preview:LabelingJob is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:LabelingJob to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20220601preview:LabelingJob")]
    public partial class LabelingJob : global::Pulumi.CustomResource
    {
        ...
        public LabelingJob(string name, LabelingJobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:LabelingJob", name, args ?? new LabelingJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabelingJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:LabelingJob", name, null, MakeResourceOptions(options, id))
        {
        }
