...
namespace Pulumi.AzureNative.MachineLearningServices.V20220601Preview.Inputs
{
    ...
    /// </summary>
    public sealed class TextClassificationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("logVerbosity")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20220601Preview.LogVerbosity>? LogVerbosity { get; set; }

        /// <summary>
        /// Primary metric for Text-Classification task.
        /// </summary>
        [Input("primaryMetric")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20220601Preview.ClassificationPrimaryMetrics>? PrimaryMetric { get; set; }
