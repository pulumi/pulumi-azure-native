...
namespace Pulumi.AzureNative.MachineLearningServices.V20220601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20220601preview:Datastore")]
    public partial class Datastore : Pulumi.CustomResource
    {
        ...
        public Datastore(string name, DatastoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:Datastore", name, args ?? new DatastoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Datastore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:Datastore", name, null, MakeResourceOptions(options, id))
        {
        }
