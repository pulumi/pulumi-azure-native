...
namespace Pulumi.AzureNative.MachineLearningServices.V20220601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20220601preview:Schedule is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:Schedule to guarantee forwards compatibility.")]
    ...
    public partial class Schedule : global::Pulumi.CustomResource
    {
        ...
        public Schedule(string name, ScheduleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:Schedule", name, args ?? new ScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:Schedule", name, null, MakeResourceOptions(options, id))
        {
        }
