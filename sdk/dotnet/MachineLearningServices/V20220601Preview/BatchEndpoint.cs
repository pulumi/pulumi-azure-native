...
{
    [Obsolete(@"azure-native:machinelearningservices/v20220601preview:BatchEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:BatchEndpoint to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20220601preview:BatchEndpoint")]
    public partial class BatchEndpoint : global::Pulumi.CustomResource
    {
        ...
        public BatchEndpoint(string name, BatchEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:BatchEndpoint", name, args ?? new BatchEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:BatchEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
