...
{
    [Obsolete(@"azure-native:machinelearningservices/v20220601preview:WorkspaceConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:WorkspaceConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20220601preview:WorkspaceConnection")]
    public partial class WorkspaceConnection : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceConnection(string name, WorkspaceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:WorkspaceConnection", name, args ?? new WorkspaceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220601preview:WorkspaceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
