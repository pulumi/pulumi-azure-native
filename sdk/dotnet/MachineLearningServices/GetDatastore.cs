...
namespace Pulumi.AzureNative.MachineLearningServices
{
    public static class GetDatastore
    {
        ...
        public static Task<GetDatastoreResult> InvokeAsync(GetDatastoreArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatastoreResult>("azure-native:machinelearningservices:getDatastore", args ?? new GetDatastoreArgs(), options.WithDefaults());
        ...
        public static Output<GetDatastoreResult> Invoke(GetDatastoreInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatastoreResult>("azure-native:machinelearningservices:getDatastore", args ?? new GetDatastoreInvokeArgs(), options.WithDefaults());
    }
