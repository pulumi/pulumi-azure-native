...
namespace Pulumi.AzureRM.MachineLearningServices.V20181119
{
    ...
    ///             ComputeName = "compute123",
    ///             Location = "eastus",
    ///             Properties = new AzureRM.MachineLearningServices.V20181119.Inputs.ComputeArgs
    ///             {
    ///                 ScaleSettings = 
    ///                 {
    ///                     { "maxNodeCount", 1 },
    ...
    public partial class MachineLearningCompute : Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20181119:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20181119:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
