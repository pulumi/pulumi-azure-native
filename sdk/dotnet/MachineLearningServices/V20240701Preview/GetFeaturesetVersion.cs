...
namespace Pulumi.AzureNative.MachineLearningServices.V20240701Preview
{
    public static class GetFeaturesetVersion
    {
        ...
        public static Task<GetFeaturesetVersionResult> InvokeAsync(GetFeaturesetVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFeaturesetVersionResult>("azure-native:machinelearningservices/v20240701preview:getFeaturesetVersion", args ?? new GetFeaturesetVersionArgs(), options.WithDefaults());
