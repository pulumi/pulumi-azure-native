...
namespace Pulumi.AzureNative.MachineLearningServices.V20240701Preview.Inputs
{
    ...
    public sealed class RaiPolicyPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20240701Preview.RaiPolicyMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20240701Preview.RaiPolicyType>? Type { get; set; }
