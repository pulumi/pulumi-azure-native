...
namespace Pulumi.AzureNative.MachineLearningServices.V20240701Preview
{
    public static class GetCompute
    {
        ...
        public static Task<GetComputeResult> InvokeAsync(GetComputeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetComputeResult>("azure-native:machinelearningservices/v20240701preview:getCompute", args ?? new GetComputeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets compute definition by its name. Any secrets (storage keys, service credentials, etc) are not returned - use 'keys' nested resource to get them.
        /// </summary>
        public static Output<GetComputeResult> Invoke(GetComputeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetComputeResult>("azure-native:machinelearningservices/v20240701preview:getCompute", args ?? new GetComputeInvokeArgs(), options.WithDefaults());
