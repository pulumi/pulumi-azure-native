...
namespace Pulumi.AzureNative.MachineLearningServices.V20240701Preview
{
    public static class GetBatchEndpoint
    {
        public static Task<GetBatchEndpointResult> InvokeAsync(GetBatchEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBatchEndpointResult>("azure-native:machinelearningservices/v20240701preview:getBatchEndpoint", args ?? new GetBatchEndpointArgs(), options.WithDefaults());

        public static Output<GetBatchEndpointResult> Invoke(GetBatchEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBatchEndpointResult>("azure-native:machinelearningservices/v20240701preview:getBatchEndpoint", args ?? new GetBatchEndpointInvokeArgs(), options.WithDefaults());
    }
