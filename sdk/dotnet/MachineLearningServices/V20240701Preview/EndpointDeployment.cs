...
{
    [AzureNativeResourceType("azure-native:machinelearningservices/v20240701preview:EndpointDeployment")]
    public partial class EndpointDeployment : global::Pulumi.CustomResource
    {
        ...
        public EndpointDeployment(string name, EndpointDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240701preview:EndpointDeployment", name, args ?? new EndpointDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EndpointDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240701preview:EndpointDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
