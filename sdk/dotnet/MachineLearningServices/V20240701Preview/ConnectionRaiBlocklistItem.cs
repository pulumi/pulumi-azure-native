...
{
    [AzureNativeResourceType("azure-native:machinelearningservices/v20240701preview:ConnectionRaiBlocklistItem")]
    public partial class ConnectionRaiBlocklistItem : global::Pulumi.CustomResource
    {
        ...
        public ConnectionRaiBlocklistItem(string name, ConnectionRaiBlocklistItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240701preview:ConnectionRaiBlocklistItem", name, args ?? new ConnectionRaiBlocklistItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionRaiBlocklistItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240701preview:ConnectionRaiBlocklistItem", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConnectionRaiBlocklistItem Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ConnectionRaiBlocklistItem(name, id, options);
        }
    }

    public sealed class ConnectionRaiBlocklistItemArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public ConnectionRaiBlocklistItemArgs()
        {
        }
        public static new ConnectionRaiBlocklistItemArgs Empty => new ConnectionRaiBlocklistItemArgs();
    }
}
