...
namespace Pulumi.AzureNative.MachineLearningServices.V20240701Preview
{
    public static class GetRegistryCodeVersion
    {
        ...
        public static Task<GetRegistryCodeVersionResult> InvokeAsync(GetRegistryCodeVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegistryCodeVersionResult>("azure-native:machinelearningservices/v20240701preview:getRegistryCodeVersion", args ?? new GetRegistryCodeVersionArgs(), options.WithDefaults());
        ...
        public static Output<GetRegistryCodeVersionResult> Invoke(GetRegistryCodeVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegistryCodeVersionResult>("azure-native:machinelearningservices/v20240701preview:getRegistryCodeVersion", args ?? new GetRegistryCodeVersionInvokeArgs(), options.WithDefaults());
