...
namespace Pulumi.AzureNative.MachineLearningServices.V20221001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221001:ModelVersion")]
    public partial class ModelVersion : global::Pulumi.CustomResource
    {
        ...
        public ModelVersion(string name, ModelVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001:ModelVersion", name, args ?? new ModelVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ModelVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001:ModelVersion", name, null, MakeResourceOptions(options, id))
        {
        }
