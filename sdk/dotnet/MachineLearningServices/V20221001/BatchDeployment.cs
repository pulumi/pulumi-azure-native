...
{
    [Obsolete(@"azure-native:machinelearningservices/v20221001:BatchDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:BatchDeployment to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221001:BatchDeployment")]
    public partial class BatchDeployment : global::Pulumi.CustomResource
    {
        ...
        public BatchDeployment(string name, BatchDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001:BatchDeployment", name, args ?? new BatchDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001:BatchDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
