...
namespace Pulumi.AzureNative.MachineLearningServices.V20221001
{
    ...
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221001:Job")]
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001:Job", name, null, MakeResourceOptions(options, id))
        {
        }
