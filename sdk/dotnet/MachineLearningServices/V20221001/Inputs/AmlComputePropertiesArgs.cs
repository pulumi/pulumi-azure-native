...
namespace Pulumi.AzureNative.MachineLearningServices.V20221001.Inputs
{
    ...
    public sealed class AmlComputePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20221001.OsType>? OsType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20221001.RemoteLoginPortPublicAccess>? RemoteLoginPortPublicAccess { get; set; }
        ...
        /// </summary>
        [Input("vmPriority")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20221001.VmPriority>? VmPriority { get; set; }
