...
namespace Pulumi.AzureNative.MachineLearningServices.V20221001.Inputs
{
    ...
    public sealed class ImageModelSettingsObjectDetectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("modelSize")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20221001.ModelSize>? ModelSize { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20221001.ValidationMetricType>? ValidationMetricType { get; set; }
