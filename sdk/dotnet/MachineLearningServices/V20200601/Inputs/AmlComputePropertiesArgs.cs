...
namespace Pulumi.AzureNative.MachineLearningServices.V20200601.Inputs
{
    ...
    public sealed class AmlComputePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20200601.RemoteLoginPortPublicAccess>? RemoteLoginPortPublicAccess { get; set; }
        ...
        /// </summary>
        [Input("vmPriority")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20200601.VmPriority>? VmPriority { get; set; }
