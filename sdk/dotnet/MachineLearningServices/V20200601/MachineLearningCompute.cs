...
namespace Pulumi.AzureRM.MachineLearningServices.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineLearningCompute = new AzureRM.MachineLearningServices.V20200601.MachineLearningCompute("machineLearningCompute", new AzureRM.MachineLearningServices.V20200601.MachineLearningComputeArgs
    ///         {
    ...
    ///         {
    ///             ComputeName = "compute123",
    ///             Identity = new AzureRM.MachineLearningServices.V20200601.Inputs.IdentityArgs
    ///             {
    ///                 Type = "SystemAssigned,UserAssigned",
    ///             },
    ///             Location = "eastus",
    ///             Properties = new AzureRM.MachineLearningServices.V20200601.Inputs.ComputeArgs
    ///             {
    ...
    public partial class MachineLearningCompute : Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200601:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200601:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:machinelearningservices/v20200301:MachineLearningCompute"},
    ...
    public sealed class MachineLearningComputeArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public InputUnion<Inputs.AKSArgs, InputUnion<Inputs.AmlComputeArgs, InputUnion<Inputs.ComputeInstanceArgs, InputUnion<Inputs.DataFactoryArgs, InputUnion<Inputs.DataLakeAnalyticsArgs, InputUnion<Inputs.DatabricksArgs, InputUnion<Inputs.HDInsightArgs, Inputs.VirtualMachineArgs>>>>>>>? Properties { get; set; }
