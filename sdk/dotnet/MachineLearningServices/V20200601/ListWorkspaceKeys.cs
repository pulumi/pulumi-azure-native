...
namespace Pulumi.AzureNextGen.MachineLearningServices.V20200601
{
    public static class ListWorkspaceKeys
    {
        public static Task<ListWorkspaceKeysResult> InvokeAsync(ListWorkspaceKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWorkspaceKeysResult>("azure-nextgen:machinelearningservices/v20200601:listWorkspaceKeys", args ?? new ListWorkspaceKeysArgs(), options.WithVersion());
    }
