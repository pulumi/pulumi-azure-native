...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20241001:ComponentVersion")]
    public partial class ComponentVersion : global::Pulumi.CustomResource
    {
        ...
        public ComponentVersion(string name, ComponentVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20241001:ComponentVersion", name, args ?? new ComponentVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20241001:ComponentVersion", name, null, MakeResourceOptions(options, id))
        {
        }
