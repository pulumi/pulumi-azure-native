...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001.Inputs
{
    ...
    public sealed class EnvironmentVersionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoRebuild")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001.AutoRebuildSetting>? AutoRebuild { get; set; }
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001.OperatingSystemType>? OsType { get; set; }
