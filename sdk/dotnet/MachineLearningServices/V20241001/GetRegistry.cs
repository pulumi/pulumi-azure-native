...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001
{
    public static class GetRegistry
    {
        public static Task<GetRegistryResult> InvokeAsync(GetRegistryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegistryResult>("azure-native:machinelearningservices/v20241001:getRegistry", args ?? new GetRegistryArgs(), options.WithDefaults());

        public static Output<GetRegistryResult> Invoke(GetRegistryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegistryResult>("azure-native:machinelearningservices/v20241001:getRegistry", args ?? new GetRegistryInvokeArgs(), options.WithDefaults());
