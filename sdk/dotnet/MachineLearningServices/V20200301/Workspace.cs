...
namespace Pulumi.AzureRM.MachineLearningServices.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workspace = new AzureRM.MachineLearningServices.V20200301.Workspace("workspace", new AzureRM.MachineLearningServices.V20200301.WorkspaceArgs
    ///         {
    ///             ApplicationInsights = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/microsoft.insights/components/testinsights",
    ///             ContainerRegistry = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/Microsoft.ContainerRegistry/registries/testRegistry",
    ///             Description = "test description",
    ///             Encryption = new AzureRM.MachineLearningServices.V20200301.Inputs.EncryptionPropertyArgs
    ///             {
    ///                 KeyVaultProperties = new AzureRM.MachineLearningServices.V20200301.Inputs.KeyVaultPropertiesArgs
    ///                 {
    ///                     IdentityClientId = "",
    ...
    ///             HbiWorkspace = false,
    ///             Identity = new AzureRM.MachineLearningServices.V20200301.Inputs.IdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ...
    ///             {
    ///                 new AzureRM.MachineLearningServices.V20200301.Inputs.SharedPrivateLinkResourceArgs
    ///                 {
    ///                     Name = "testdbresource",
    ///                 },
    ///             },
    ///             Sku = new AzureRM.MachineLearningServices.V20200301.Inputs.SkuArgs
    ///             {
    ///                 Name = "Basic",
    ///                 Tier = "Basic",
    ///             },
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200301:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200301:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:machinelearningservices/v20200101:Workspace"},
                    new Pulumi.Alias { Type = "azurerm:machinelearningservices/v20200218preview:Workspace"},
                    new Pulumi.Alias { Type = "azurerm:machinelearningservices/v20200401:Workspace"},
                    new Pulumi.Alias { Type = "azurerm:machinelearningservices/v20200501preview:Workspace"},
                    new Pulumi.Alias { Type = "azurerm:machinelearningservices/v20200515preview:Workspace"},
                    new Pulumi.Alias { Type = "azurerm:machinelearningservices/v20200601:Workspace"},
                    new Pulumi.Alias { Type = "azurerm:machinelearningservices/v20200901preview:Workspace"},
                },
            };
