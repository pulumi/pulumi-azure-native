...
namespace Pulumi.AzureNextGen.MachineLearningServices.V20210101.Inputs
{
    ...
    public sealed class ComputeInstancePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningServices.V20210101.ApplicationSharingPolicy>? ApplicationSharingPolicy { get; set; }

        /// <summary>
        /// The Compute Instance Authorization type. Available values are personal (default).
        /// </summary>
        [Input("computeInstanceAuthorizationType")]
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningServices.V20210101.ComputeInstanceAuthorizationType>? ComputeInstanceAuthorizationType { get; set; }
