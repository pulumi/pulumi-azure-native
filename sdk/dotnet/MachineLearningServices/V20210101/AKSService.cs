...
namespace Pulumi.AzureNative.MachineLearningServices.V20210101
{
    ...
    /// {
    ///     var aksService = new AzureNative.MachineLearningServices.V20210101.AKSService("aksService", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:machinelearningservices/v20210101:AKSService service456 subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/workspaces123/services/service456 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210101:AKSService")]
    public partial class AKSService : global::Pulumi.CustomResource
    {
        ...
        public AKSService(string name, AKSServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210101:AKSService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AKSService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210101:AKSService", name, null, MakeResourceOptions(options, id))
        {
        }
