...
namespace Pulumi.AzureNative.MachineLearningServices.V20210101
{
    ...
    public partial class ACIService : Pulumi.CustomResource
    {
        ...
        public ACIService(string name, ACIServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210101:ACIService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ACIService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210101:ACIService", name, null, MakeResourceOptions(options, id))
        {
        }
