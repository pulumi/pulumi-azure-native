...
namespace Pulumi.AzureNative.MachineLearningServices.V20210101
{
    ...
    /// {
    ///     var workspace = new AzureNative.MachineLearningServices.V20210101.Workspace("workspace", new()
    ///     {
    ///         ApplicationInsights = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/microsoft.insights/components/testinsights",
    ///         ContainerRegistry = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/Microsoft.ContainerRegistry/registries/testRegistry",
    ///         Description = "test description",
    ///         Encryption = new AzureNative.MachineLearningServices.V20210101.Inputs.EncryptionPropertyArgs
    ///         {
    ///             Identity = new AzureNative.MachineLearningServices.V20210101.Inputs.IdentityForCmkArgs
    ///             {
    ...
    ///             },
    ///             KeyVaultProperties = new AzureNative.MachineLearningServices.V20210101.Inputs.KeyVaultPropertiesArgs
    ///             {
    ///                 IdentityClientId = "",
    ...
    ///         HbiWorkspace = false,
    ///         Identity = new AzureNative.MachineLearningServices.V20210101.Inputs.IdentityArgs
    ///         {
    ///             Type = AzureNative.MachineLearningServices.V20210101.ResourceIdentityType.SystemAssigned_UserAssigned,
    ...
    ///         {
    ///             new AzureNative.MachineLearningServices.V20210101.Inputs.SharedPrivateLinkResourceArgs
    ///             {
    ///                 GroupId = "Sql",
    ///                 Name = "testdbresource",
    ...
    ///             },
    ///         },
    ///         Sku = new AzureNative.MachineLearningServices.V20210101.Inputs.SkuArgs
    ///         {
    ///             Name = "Basic",
    ///             Tier = "Basic",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:machinelearningservices/v20210101:Workspace testworkspace /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/Microsoft.MachineLearningServices/workspaces/testworkspace 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210101:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210101:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210101:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
