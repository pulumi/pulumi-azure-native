...
namespace Pulumi.AzureNative.MachineLearningServices.V20210101
{
    ...
    public static class GetMachineLearningService
    {
        ...
        public static Task<GetMachineLearningServiceResult> InvokeAsync(GetMachineLearningServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineLearningServiceResult>("azure-native:machinelearningservices/v20210101:getMachineLearningService", args ?? new GetMachineLearningServiceArgs(), options.WithDefaults());
        ...
        public static Output<GetMachineLearningServiceResult> Invoke(GetMachineLearningServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMachineLearningServiceResult>("azure-native:machinelearningservices/v20210101:getMachineLearningService", args ?? new GetMachineLearningServiceInvokeArgs(), options.WithDefaults());
    }
