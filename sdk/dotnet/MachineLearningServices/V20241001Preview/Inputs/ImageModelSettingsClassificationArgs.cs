...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001Preview.Inputs
{
    ...
    public sealed class ImageModelSettingsClassificationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.LearningRateScheduler>? LearningRateScheduler { get; set; }
        ...
        /// </summary>
        [Input("optimizer")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.StochasticOptimizer>? Optimizer { get; set; }
