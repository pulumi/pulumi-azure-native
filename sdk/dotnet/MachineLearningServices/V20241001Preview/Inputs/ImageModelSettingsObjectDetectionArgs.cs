...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001Preview.Inputs
{
    ...
    public sealed class ImageModelSettingsObjectDetectionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("modelSize")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.ModelSize>? ModelSize { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.ValidationMetricType>? ValidationMetricType { get; set; }
