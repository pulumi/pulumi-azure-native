...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001Preview.Inputs
{
    ...
    public sealed class RecurrenceScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("weekDays")]
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.WeekDay>>? _weekDays;

        /// <summary>
        /// List of days for the schedule.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.WeekDay>> WeekDays
        {
            get => _weekDays ?? (_weekDays = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.WeekDay>>());
            set => _weekDays = value;
        }
