...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001Preview.Inputs
{
    ...
    public sealed class RaiPolicyPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.RaiPolicyMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.RaiPolicyType>? Type { get; set; }
