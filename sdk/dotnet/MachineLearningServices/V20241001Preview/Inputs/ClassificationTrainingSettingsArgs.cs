...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001Preview.Inputs
{
    ...
    public sealed class ClassificationTrainingSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.ClassificationModels>>? _allowedTrainingAlgorithms;

        /// <summary>
        /// Allowed models for classification task.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.ClassificationModels>> AllowedTrainingAlgorithms
        {
            get => _allowedTrainingAlgorithms ?? (_allowedTrainingAlgorithms = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.ClassificationModels>>());
            set => _allowedTrainingAlgorithms = value;
        }

        [Input("blockedTrainingAlgorithms")]
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.ClassificationModels>>? _blockedTrainingAlgorithms;

        /// <summary>
        /// Blocked models for classification task.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.ClassificationModels>> BlockedTrainingAlgorithms
        {
            get => _blockedTrainingAlgorithms ?? (_blockedTrainingAlgorithms = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.ClassificationModels>>());
