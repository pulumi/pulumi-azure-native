...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001Preview.Inputs
{
    ...
    public sealed class EnvironmentVersionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoRebuild")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.AutoRebuildSetting>? AutoRebuild { get; set; }
        ...
        /// </summary>
        [Input("osType")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20241001Preview.OperatingSystemType>? OsType { get; set; }
