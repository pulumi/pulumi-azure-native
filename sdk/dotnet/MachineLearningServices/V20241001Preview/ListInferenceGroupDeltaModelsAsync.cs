...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001Preview
{
    public static class ListInferenceGroupDeltaModelsAsync
    {
        ...
        public static Task<ListInferenceGroupDeltaModelsAsyncResult> InvokeAsync(ListInferenceGroupDeltaModelsAsyncArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListInferenceGroupDeltaModelsAsyncResult>("azure-native:machinelearningservices/v20241001preview:listInferenceGroupDeltaModelsAsync", args ?? new ListInferenceGroupDeltaModelsAsyncArgs(), options.WithDefaults());
