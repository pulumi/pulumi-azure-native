...
namespace Pulumi.AzureNative.MachineLearningServices.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20241001preview:EnvironmentVersion")]
    public partial class EnvironmentVersion : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentVersion(string name, EnvironmentVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20241001preview:EnvironmentVersion", name, args ?? new EnvironmentVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20241001preview:EnvironmentVersion", name, null, MakeResourceOptions(options, id))
        {
        }
