...
{
    [AzureNativeResourceType("azure-native:machinelearningservices/v20241001preview:Registry")]
    public partial class Registry : global::Pulumi.CustomResource
    {
        ...
        public Registry(string name, RegistryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20241001preview:Registry", name, args ?? new RegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Registry(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20241001preview:Registry", name, null, MakeResourceOptions(options, id))
        {
        }
