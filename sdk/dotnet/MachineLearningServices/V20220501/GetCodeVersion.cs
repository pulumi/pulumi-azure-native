...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501
{
    public static class GetCodeVersion
    {
        ...
        public static Task<GetCodeVersionResult> InvokeAsync(GetCodeVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCodeVersionResult>("azure-native:machinelearningservices/v20220501:getCodeVersion", args ?? new GetCodeVersionArgs(), options.WithDefaults());

        /// <summary>
        /// Azure Resource Manager resource envelope.
        /// </summary>
        public static Output<GetCodeVersionResult> Invoke(GetCodeVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCodeVersionResult>("azure-native:machinelearningservices/v20220501:getCodeVersion", args ?? new GetCodeVersionInvokeArgs(), options.WithDefaults());
    }
