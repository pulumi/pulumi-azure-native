...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20220501:Compute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:Compute to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20220501:Compute")]
    public partial class Compute : global::Pulumi.CustomResource
    {
        ...
        public Compute(string name, ComputeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:Compute", name, args ?? new ComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Compute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:Compute", name, null, MakeResourceOptions(options, id))
        {
        }
