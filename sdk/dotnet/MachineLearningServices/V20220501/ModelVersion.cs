...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20220501:ModelVersion")]
    public partial class ModelVersion : global::Pulumi.CustomResource
    {
        ...
        public ModelVersion(string name, ModelVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:ModelVersion", name, args ?? new ModelVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ModelVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:ModelVersion", name, null, MakeResourceOptions(options, id))
        {
        }
