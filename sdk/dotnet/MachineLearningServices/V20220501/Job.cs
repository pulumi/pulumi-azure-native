...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20220501:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:Job to guarantee forwards compatibility.")]
    ...
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:Job", name, null, MakeResourceOptions(options, id))
        {
        }
