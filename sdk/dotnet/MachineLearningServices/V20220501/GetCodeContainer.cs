...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501
{
    public static class GetCodeContainer
    {
        ...
        public static Task<GetCodeContainerResult> InvokeAsync(GetCodeContainerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCodeContainerResult>("azure-native:machinelearningservices/v20220501:getCodeContainer", args ?? new GetCodeContainerArgs(), options.WithDefaults());

        /// <summary>
        /// Azure Resource Manager resource envelope.
        /// </summary>
        public static Output<GetCodeContainerResult> Invoke(GetCodeContainerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCodeContainerResult>("azure-native:machinelearningservices/v20220501:getCodeContainer", args ?? new GetCodeContainerInvokeArgs(), options.WithDefaults());
    }
