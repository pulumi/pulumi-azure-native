...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501
{
    public static class ListDatastoreSecrets
    {
        ...
        public static Task<ListDatastoreSecretsResult> InvokeAsync(ListDatastoreSecretsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListDatastoreSecretsResult>("azure-native:machinelearningservices/v20220501:listDatastoreSecrets", args ?? new ListDatastoreSecretsArgs(), options.WithDefaults());

        /// <summary>
        /// Base definition for datastore secrets.
        /// </summary>
        public static Output<ListDatastoreSecretsResult> Invoke(ListDatastoreSecretsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListDatastoreSecretsResult>("azure-native:machinelearningservices/v20220501:listDatastoreSecrets", args ?? new ListDatastoreSecretsInvokeArgs(), options.WithDefaults());
