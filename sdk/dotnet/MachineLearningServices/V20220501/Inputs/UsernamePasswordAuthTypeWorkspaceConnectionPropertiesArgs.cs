...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501.Inputs
{
    ...
    public sealed class UsernamePasswordAuthTypeWorkspaceConnectionPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("category")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20220501.ConnectionCategory>? Category { get; set; }
        ...
        /// </summary>
        [Input("valueFormat")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20220501.ValueFormat>? ValueFormat { get; set; }
