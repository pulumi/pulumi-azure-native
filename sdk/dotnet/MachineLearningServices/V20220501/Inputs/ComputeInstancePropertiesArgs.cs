...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501.Inputs
{
    ...
    public sealed class ComputeInstancePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20220501.ApplicationSharingPolicy>? ApplicationSharingPolicy { get; set; }

        /// <summary>
        /// The Compute Instance Authorization type. Available values are personal (default).
        /// </summary>
        [Input("computeInstanceAuthorizationType")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20220501.ComputeInstanceAuthorizationType>? ComputeInstanceAuthorizationType { get; set; }
