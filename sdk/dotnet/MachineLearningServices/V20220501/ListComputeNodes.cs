...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501
{
    public static class ListComputeNodes
    {
        ...
        public static Task<ListComputeNodesResult> InvokeAsync(ListComputeNodesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListComputeNodesResult>("azure-native:machinelearningservices/v20220501:listComputeNodes", args ?? new ListComputeNodesArgs(), options.WithDefaults());

        /// <summary>
        /// Result of AmlCompute Nodes
        /// </summary>
        public static Output<ListComputeNodesResult> Invoke(ListComputeNodesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListComputeNodesResult>("azure-native:machinelearningservices/v20220501:listComputeNodes", args ?? new ListComputeNodesInvokeArgs(), options.WithDefaults());
    }
