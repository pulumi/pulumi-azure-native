...
namespace Pulumi.AzureNative.MachineLearningServices.V20220501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20220501:ModelContainer")]
    public partial class ModelContainer : global::Pulumi.CustomResource
    {
        ...
        public ModelContainer(string name, ModelContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:ModelContainer", name, args ?? new ModelContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ModelContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:ModelContainer", name, null, MakeResourceOptions(options, id))
        {
        }
