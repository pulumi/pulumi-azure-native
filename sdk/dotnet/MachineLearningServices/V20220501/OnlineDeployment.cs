...
{
    [Obsolete(@"azure-native:machinelearningservices/v20220501:OnlineDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:OnlineDeployment to guarantee forwards compatibility.")]
    ...
    public partial class OnlineDeployment : global::Pulumi.CustomResource
    {
        ...
        public OnlineDeployment(string name, OnlineDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:OnlineDeployment", name, args ?? new OnlineDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OnlineDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20220501:OnlineDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
