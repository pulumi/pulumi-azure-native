...
namespace Pulumi.AzureRM.MachineLearningServices.V20200401
{
    public static class GetMachineLearningCompute
    {
        public static Task<GetMachineLearningComputeResult> InvokeAsync(GetMachineLearningComputeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineLearningComputeResult>("azurerm:machinelearningservices/v20200401:getMachineLearningCompute", args ?? new GetMachineLearningComputeArgs(), options.WithVersion());
    }
