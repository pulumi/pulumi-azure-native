...
namespace Pulumi.AzureRM.MachineLearningServices.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.MachineLearningServices.V20200401.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.MachineLearningServices.V20200401.PrivateEndpointConnectionArgs
    ///         {
    ///             PrivateEndpointConnectionName = "{privateEndpointConnectionName}",
    ///             PrivateLinkServiceConnectionState = new AzureRM.MachineLearningServices.V20200401.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
