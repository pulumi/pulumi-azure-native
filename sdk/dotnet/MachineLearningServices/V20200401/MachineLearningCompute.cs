...
namespace Pulumi.AzureRM.MachineLearningServices.V20200401
{
    ...
    public partial class MachineLearningCompute : Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200401:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200401:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
