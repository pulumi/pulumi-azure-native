...
namespace Pulumi.AzureRM.MachineLearningServices.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workspace = new AzureRM.MachineLearningServices.V20200401.Workspace("workspace", new AzureRM.MachineLearningServices.V20200401.WorkspaceArgs
    ///         {
    ///             ApplicationInsights = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/microsoft.insights/components/testinsights",
    ///             ContainerRegistry = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/Microsoft.ContainerRegistry/registries/testRegistry",
    ///             Description = "test description",
    ///             Encryption = new AzureRM.MachineLearningServices.V20200401.Inputs.EncryptionPropertyArgs
    ///             {
    ///                 KeyVaultProperties = new AzureRM.MachineLearningServices.V20200401.Inputs.KeyVaultPropertiesArgs
    ///                 {
    ///                     IdentityClientId = "",
    ...
    ///             {
    ///                 new AzureRM.MachineLearningServices.V20200401.Inputs.SharedPrivateLinkResourceArgs
    ///                 {
    ///                     Name = "testdbresource",
    ///                 },
    ///             },
    ///             Sku = new AzureRM.MachineLearningServices.V20200401.Inputs.SkuArgs
    ///             {
    ///                 Name = "Basic",
    ///                 Tier = "Basic",
    ///             },
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200401:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200401:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
