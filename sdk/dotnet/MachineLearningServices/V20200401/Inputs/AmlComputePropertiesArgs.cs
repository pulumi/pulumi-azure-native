...
namespace Pulumi.AzureNextGen.MachineLearningServices.V20200401.Inputs
{
    ...
    public sealed class AmlComputePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningServices.V20200401.RemoteLoginPortPublicAccess>? RemoteLoginPortPublicAccess { get; set; }
        ...
        /// </summary>
        [Input("vmPriority")]
        public InputUnion<string, Pulumi.AzureNextGen.MachineLearningServices.V20200401.VmPriority>? VmPriority { get; set; }
