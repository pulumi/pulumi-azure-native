...
namespace Pulumi.AzureNative.MachineLearningServices.V20230601Preview
{
    public static class ListFeaturesetVersionMaterializationJobs
    {
        ...
        public static Task<ListFeaturesetVersionMaterializationJobsResult> InvokeAsync(ListFeaturesetVersionMaterializationJobsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListFeaturesetVersionMaterializationJobsResult>("azure-native:machinelearningservices/v20230601preview:listFeaturesetVersionMaterializationJobs", args ?? new ListFeaturesetVersionMaterializationJobsArgs(), options.WithDefaults());
