...
namespace Pulumi.AzureNative.MachineLearningServices.V20230601Preview
{
    public static class ListComputeKeys
    {
        ...
        public static Task<ListComputeKeysResult> InvokeAsync(ListComputeKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListComputeKeysResult>("azure-native:machinelearningservices/v20230601preview:listComputeKeys", args ?? new ListComputeKeysArgs(), options.WithDefaults());
