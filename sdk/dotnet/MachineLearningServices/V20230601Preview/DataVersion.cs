...
namespace Pulumi.AzureNative.MachineLearningServices.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230601preview:DataVersion")]
    public partial class DataVersion : global::Pulumi.CustomResource
    {
        ...
        public DataVersion(string name, DataVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230601preview:DataVersion", name, args ?? new DataVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230601preview:DataVersion", name, null, MakeResourceOptions(options, id))
        {
        }
