...
namespace Pulumi.AzureNative.MachineLearningServices.V20230601Preview.Inputs
{
    ...
    public sealed class RegressionTrainingSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230601Preview.RegressionModels>>? _allowedTrainingAlgorithms;

        /// <summary>
        /// Allowed models for regression task.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230601Preview.RegressionModels>> AllowedTrainingAlgorithms
        {
            get => _allowedTrainingAlgorithms ?? (_allowedTrainingAlgorithms = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230601Preview.RegressionModels>>());
            set => _allowedTrainingAlgorithms = value;
        }

        [Input("blockedTrainingAlgorithms")]
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230601Preview.RegressionModels>>? _blockedTrainingAlgorithms;

        /// <summary>
        /// Blocked models for regression task.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230601Preview.RegressionModels>> BlockedTrainingAlgorithms
        {
            get => _blockedTrainingAlgorithms ?? (_blockedTrainingAlgorithms = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20230601Preview.RegressionModels>>());
