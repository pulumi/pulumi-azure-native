...
namespace Pulumi.AzureNative.MachineLearningServices.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20230601preview:LabelingJob")]
    public partial class LabelingJob : global::Pulumi.CustomResource
    {
        ...
        public LabelingJob(string name, LabelingJobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230601preview:LabelingJob", name, args ?? new LabelingJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabelingJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20230601preview:LabelingJob", name, null, MakeResourceOptions(options, id))
        {
        }
