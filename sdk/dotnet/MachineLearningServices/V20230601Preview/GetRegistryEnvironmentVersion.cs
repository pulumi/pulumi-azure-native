...
namespace Pulumi.AzureNative.MachineLearningServices.V20230601Preview
{
    public static class GetRegistryEnvironmentVersion
    {
        ...
        public static Task<GetRegistryEnvironmentVersionResult> InvokeAsync(GetRegistryEnvironmentVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegistryEnvironmentVersionResult>("azure-native:machinelearningservices/v20230601preview:getRegistryEnvironmentVersion", args ?? new GetRegistryEnvironmentVersionArgs(), options.WithDefaults());
        ...
        public static Output<GetRegistryEnvironmentVersionResult> Invoke(GetRegistryEnvironmentVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegistryEnvironmentVersionResult>("azure-native:machinelearningservices/v20230601preview:getRegistryEnvironmentVersion", args ?? new GetRegistryEnvironmentVersionInvokeArgs(), options.WithDefaults());
