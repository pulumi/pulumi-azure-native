...
namespace Pulumi.AzureNative.MachineLearningServices.V20230601Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct GenerationTokenStatisticsMetric : IEquatable<GenerationTokenStatisticsMetric>
    {
        private readonly string _value;

        private GenerationTokenStatisticsMetric(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static GenerationTokenStatisticsMetric TotalTokenCount { get; } = new GenerationTokenStatisticsMetric("TotalTokenCount");
        public static GenerationTokenStatisticsMetric TotalTokenCountPerGroup { get; } = new GenerationTokenStatisticsMetric("TotalTokenCountPerGroup");

        public static bool operator ==(GenerationTokenStatisticsMetric left, GenerationTokenStatisticsMetric right) => left.Equals(right);
        public static bool operator !=(GenerationTokenStatisticsMetric left, GenerationTokenStatisticsMetric right) => !left.Equals(right);

        public static explicit operator string(GenerationTokenStatisticsMetric value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is GenerationTokenStatisticsMetric other && Equals(other);
        public bool Equals(GenerationTokenStatisticsMetric other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct MonitoringInputDataType : IEquatable<MonitoringInputDataType>
    {
        ...
        /// </summary>
        public static MonitoringInputDataType Trailing { get; } = new MonitoringInputDataType("Trailing");
        /// <summary>
