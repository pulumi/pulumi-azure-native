...
namespace Pulumi.AzureNative.MachineLearningServices.V20190501
{
    ...
    /// </summary>
    [Obsolete(@"Version v20190501 will be removed in the next major version of the provider. Upgrade to version v20200301 or later.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20190501:Workspace")]
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20190501:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20190501:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
