...
namespace Pulumi.AzureRM.MachineLearningServices.V20190501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineLearningCompute = new AzureRM.MachineLearningServices.V20190501.MachineLearningCompute("machineLearningCompute", new AzureRM.MachineLearningServices.V20190501.MachineLearningComputeArgs
    ///         {
    ...
    ///             ComputeName = "compute123",
    ///             Location = "eastus",
    ///             Properties = new AzureRM.MachineLearningServices.V20190501.Inputs.ComputeArgs
    ///             {
    ///                 ScaleSettings = 
    ///                 {
    ///                     { "maxNodeCount", 1 },
    ...
    public partial class MachineLearningCompute : Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20190501:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20190501:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
