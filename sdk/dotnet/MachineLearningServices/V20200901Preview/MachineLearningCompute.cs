...
namespace Pulumi.AzureNextGen.MachineLearningServices.V20200901Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:machinelearningservices/v20200901preview:MachineLearningCompute")]
    public partial class MachineLearningCompute : Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:machinelearningservices/v20200901preview:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:machinelearningservices/v20200901preview:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
