...
namespace Pulumi.AzureNative.MachineLearningServices.V20200901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20200901preview:EndpointVariant is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility.")]
    ...
    public partial class EndpointVariant : global::Pulumi.CustomResource
    {
        ...
        public EndpointVariant(string name, EndpointVariantArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200901preview:EndpointVariant", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EndpointVariant(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200901preview:EndpointVariant", name, null, MakeResourceOptions(options, id))
        {
        }
