...
namespace Pulumi.AzureNative.MachineLearningServices.V20200901Preview
{
    ...
    /// {
    ///     var aciService = new AzureNative.MachineLearningServices.V20200901Preview.ACIService("aciService", new()
    ///     {
    ///         AppInsightsEnabled = true,
    ///         AuthEnabled = true,
    ///         ComputeType = "ACI",
    ///         ContainerResourceRequirements = new AzureNative.MachineLearningServices.V20200901Preview.Inputs.ContainerResourceRequirementsArgs
    ///         {
    ///             Cpu = 1,
    ///             MemoryInGB = 1,
    ///         },
    ///         EnvironmentImageRequest = new AzureNative.MachineLearningServices.V20200901Preview.Inputs.CreateServiceRequestEnvironmentImageRequestArgs
    ///         {
    ///             Assets = new[]
    ///             {
    ///                 new AzureNative.MachineLearningServices.V20200901Preview.Inputs.ImageAssetArgs
    ///                 {
    ...
    ///             Environment = new AzureNative.MachineLearningServices.V20200901Preview.Inputs.EnvironmentImageRequestEnvironmentArgs
    ///             {
    ///                 Docker = new AzureNative.MachineLearningServices.V20200901Preview.Inputs.ModelEnvironmentDefinitionDockerArgs
    ///                 {
    ...
    ///                 Python = new AzureNative.MachineLearningServices.V20200901Preview.Inputs.ModelEnvironmentDefinitionPythonArgs
    ///                 {
    ///                     CondaDependencies = 
    ///                     {
    ///                         { "channels", new[]
    ...
    ///                 },
    ///                 Spark = new AzureNative.MachineLearningServices.V20200901Preview.Inputs.ModelEnvironmentDefinitionSparkArgs
    ///                 {
    ///                     Packages = new[] {},
    ...
    ///             Models = new[]
    ///             {
    ///                 new AzureNative.MachineLearningServices.V20200901Preview.Inputs.ModelArgs
    ///                 {
    ///                     MimeType = "application/x-python",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20200901preview:ACIService")]
    public partial class ACIService : global::Pulumi.CustomResource
    {
        ...
        public ACIService(string name, ACIServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200901preview:ACIService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ACIService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200901preview:ACIService", name, null, MakeResourceOptions(options, id))
        {
        }
