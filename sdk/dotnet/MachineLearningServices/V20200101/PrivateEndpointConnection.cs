...
namespace Pulumi.AzureRM.MachineLearningServices.V20200101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.MachineLearningServices.V20200101.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.MachineLearningServices.V20200101.PrivateEndpointConnectionArgs
    ///         {
    ///             PrivateEndpointConnectionName = "{privateEndpointConnectionName}",
    ///             PrivateLinkServiceConnectionState = new AzureRM.MachineLearningServices.V20200101.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200101:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200101:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
