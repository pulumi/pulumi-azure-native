...
namespace Pulumi.AzureNative.MachineLearningServices.V20200101
{
    ...
    public static class GetMachineLearningCompute
    {
        ...
        public static Task<GetMachineLearningComputeResult> InvokeAsync(GetMachineLearningComputeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineLearningComputeResult>("azure-native:machinelearningservices/v20200101:getMachineLearningCompute", args ?? new GetMachineLearningComputeArgs(), options.WithDefaults());
        ...
        public static Output<GetMachineLearningComputeResult> Invoke(GetMachineLearningComputeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMachineLearningComputeResult>("azure-native:machinelearningservices/v20200101:getMachineLearningCompute", args ?? new GetMachineLearningComputeInvokeArgs(), options.WithDefaults());
    }
