...
namespace Pulumi.AzureRM.MachineLearningServices.V20180301Preview
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var workspace = new AzureRM.MachineLearningServices.V20180301Preview.Workspace("workspace", new AzureRM.MachineLearningServices.V20180301Preview.WorkspaceArgs
    ///         {
    ...
    ///             Identity = new AzureRM.MachineLearningServices.V20180301Preview.Inputs.IdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("batchaiWorkspace")]
        public Output<string?> BatchaiWorkspace { get; private set; } = null!;
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20180301preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20180301preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : Pulumi.ResourceArgs
    {
        ...
        /// ARM id of the Batch AI workspace associated with this workspace. This cannot be changed once the workspace has been created
        /// </summary>
        [Input("batchaiWorkspace")]
        public Input<string>? BatchaiWorkspace { get; set; }
