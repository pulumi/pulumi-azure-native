...
namespace Pulumi.AzureNextGen.MachineLearningServices.V20180301Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:machinelearningservices/v20180301preview:Workspace")]
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:machinelearningservices/v20180301preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:machinelearningservices/v20180301preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
