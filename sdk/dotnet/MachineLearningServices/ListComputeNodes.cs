...
namespace Pulumi.AzureNative.MachineLearningServices
{
    public static class ListComputeNodes
    {
        ...
        public static Task<ListComputeNodesResult> InvokeAsync(ListComputeNodesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListComputeNodesResult>("azure-native:machinelearningservices:listComputeNodes", args ?? new ListComputeNodesArgs(), options.WithDefaults());
        ...
        public static Output<ListComputeNodesResult> Invoke(ListComputeNodesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListComputeNodesResult>("azure-native:machinelearningservices:listComputeNodes", args ?? new ListComputeNodesInvokeArgs(), options.WithDefaults());
    }
