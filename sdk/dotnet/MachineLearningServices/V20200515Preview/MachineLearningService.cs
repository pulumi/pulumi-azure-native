...
namespace Pulumi.AzureNative.MachineLearningServices.V20200515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20200515preview:MachineLearningService")]
    public partial class MachineLearningService : Pulumi.CustomResource
    {
        ...
        public MachineLearningService(string name, MachineLearningServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200515preview:MachineLearningService", name, args ?? new MachineLearningServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200515preview:MachineLearningService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:machinelearningservices/v20210301preview:MachineLearningService"},
                    new Pulumi.Alias { Type = "azure-nextgen:machinelearningservices/v20210301preview:MachineLearningService"},
                    new Pulumi.Alias { Type = "azure-native:machinelearningservices/v20210401:MachineLearningService"},
                    new Pulumi.Alias { Type = "azure-nextgen:machinelearningservices/v20210401:MachineLearningService"},
                },
            };
    ...
    public sealed class MachineLearningServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20200515Preview.ComputeEnvironmentType> ComputeType { get; set; } = null!;
