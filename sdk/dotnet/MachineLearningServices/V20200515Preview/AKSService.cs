...
namespace Pulumi.AzureNative.MachineLearningServices.V20200515Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20200515preview:AKSService is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:AKSService to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20200515preview:AKSService")]
    public partial class AKSService : global::Pulumi.CustomResource
    {
        ...
        public AKSService(string name, AKSServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200515preview:AKSService", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AKSService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200515preview:AKSService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AKSServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20200515Preview.VariantType>? Type { get; set; }
