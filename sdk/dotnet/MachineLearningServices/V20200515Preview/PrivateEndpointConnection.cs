...
namespace Pulumi.AzureRM.MachineLearningServices.V20200515Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.MachineLearningServices.V20200515Preview.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.MachineLearningServices.V20200515Preview.PrivateEndpointConnectionArgs
    ///         {
    ///             PrivateEndpointConnectionName = "{privateEndpointConnectionName}",
    ///             PrivateLinkServiceConnectionState = new AzureRM.MachineLearningServices.V20200515Preview.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200515preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200515preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
