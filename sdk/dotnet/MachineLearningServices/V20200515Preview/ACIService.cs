...
namespace Pulumi.AzureNative.MachineLearningServices.V20200515Preview
{
    ...
    /// {
    ///     var aciService = new AzureNative.MachineLearningServices.V20200515Preview.ACIService("aciService", new()
    ///     {
    ///         AppInsightsEnabled = true,
    ///         AuthEnabled = true,
    ///         ComputeType = "ACI",
    ///         ContainerResourceRequirements = new AzureNative.MachineLearningServices.V20200515Preview.Inputs.ContainerResourceRequirementsArgs
    ///         {
    ///             Cpu = 1,
    ///             MemoryInGB = 1,
    ///         },
    ///         EnvironmentImageRequest = new AzureNative.MachineLearningServices.V20200515Preview.Inputs.CreateServiceRequestEnvironmentImageRequestArgs
    ///         {
    ///             Assets = new[]
    ///             {
    ///                 new AzureNative.MachineLearningServices.V20200515Preview.Inputs.ImageAssetArgs
    ///                 {
    ...
    ///             Environment = new AzureNative.MachineLearningServices.V20200515Preview.Inputs.EnvironmentImageRequestEnvironmentArgs
    ///             {
    ///                 Docker = new AzureNative.MachineLearningServices.V20200515Preview.Inputs.ModelEnvironmentDefinitionDockerArgs
    ///                 {
    ...
    ///                 Python = new AzureNative.MachineLearningServices.V20200515Preview.Inputs.ModelEnvironmentDefinitionPythonArgs
    ///                 {
    ///                     CondaDependencies = 
    ///                     {
    ///                         { "channels", new[]
    ...
    ///                 },
    ///                 Spark = new AzureNative.MachineLearningServices.V20200515Preview.Inputs.ModelEnvironmentDefinitionSparkArgs
    ///                 {
    ///                     Packages = new[] {},
    ...
    ///             Models = new[]
    ///             {
    ///                 new AzureNative.MachineLearningServices.V20200515Preview.Inputs.ModelArgs
    ///                 {
    ///                     MimeType = "application/x-python",
