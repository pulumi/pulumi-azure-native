...
namespace Pulumi.AzureNative.MachineLearningServices.V20200515Preview
{
    ...
    /// {
    ///     var endpointVariant = new AzureNative.MachineLearningServices.V20200515Preview.EndpointVariant("endpointVariant", new()
    ///     {
    ...
    public partial class EndpointVariant : global::Pulumi.CustomResource
    {
        ...
        public EndpointVariant(string name, EndpointVariantArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200515preview:EndpointVariant", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EndpointVariant(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200515preview:EndpointVariant", name, null, MakeResourceOptions(options, id))
        {
        }
