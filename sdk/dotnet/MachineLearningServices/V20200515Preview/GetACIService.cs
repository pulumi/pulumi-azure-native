...
namespace Pulumi.AzureNative.MachineLearningServices.V20200515Preview
{
    public static class GetACIService
    {
        ...
        public static Task<GetACIServiceResult> InvokeAsync(GetACIServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetACIServiceResult>("azure-native:machinelearningservices/v20200515preview:getACIService", args ?? new GetACIServiceArgs(), options.WithVersion());

        /// <summary>
        /// Machine Learning service object wrapped into ARM resource envelope.
        /// </summary>
        public static Output<GetACIServiceResult> Invoke(GetACIServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetACIServiceResult>("azure-native:machinelearningservices/v20200515preview:getACIService", args ?? new GetACIServiceInvokeArgs(), options.WithVersion());
    }
