...
namespace Pulumi.AzureNative.MachineLearningServices.V20200515Preview
{
    ...
    public partial class LinkedWorkspace : global::Pulumi.CustomResource
    {
        ...
        public LinkedWorkspace(string name, LinkedWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200515preview:LinkedWorkspace", name, args ?? new LinkedWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200515preview:LinkedWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
