...
namespace Pulumi.AzureRM.MachineLearningServices.V20200515Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineLearningCompute = new AzureRM.MachineLearningServices.V20200515Preview.MachineLearningCompute("machineLearningCompute", new AzureRM.MachineLearningServices.V20200515Preview.MachineLearningComputeArgs
    ///         {
    ...
    ///             ComputeName = "compute123",
    ///             Location = "eastus",
    ///             Properties = new AzureRM.MachineLearningServices.V20200515Preview.Inputs.ComputeArgs
    ///             {
    ...
    public partial class MachineLearningCompute : Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200515preview:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20200515preview:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
