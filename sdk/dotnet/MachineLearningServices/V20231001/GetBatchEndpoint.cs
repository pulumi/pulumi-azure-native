...
namespace Pulumi.AzureNative.MachineLearningServices.V20231001
{
    public static class GetBatchEndpoint
    {
        public static Task<GetBatchEndpointResult> InvokeAsync(GetBatchEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBatchEndpointResult>("azure-native:machinelearningservices/v20231001:getBatchEndpoint", args ?? new GetBatchEndpointArgs(), options.WithDefaults());

        public static Output<GetBatchEndpointResult> Invoke(GetBatchEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBatchEndpointResult>("azure-native:machinelearningservices/v20231001:getBatchEndpoint", args ?? new GetBatchEndpointInvokeArgs(), options.WithDefaults());
