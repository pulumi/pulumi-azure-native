...
namespace Pulumi.AzureNative.MachineLearningServices.V20231001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20231001:ComponentContainer")]
    public partial class ComponentContainer : global::Pulumi.CustomResource
    {
        ...
        public ComponentContainer(string name, ComponentContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20231001:ComponentContainer", name, args ?? new ComponentContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20231001:ComponentContainer", name, null, MakeResourceOptions(options, id))
        {
        }
