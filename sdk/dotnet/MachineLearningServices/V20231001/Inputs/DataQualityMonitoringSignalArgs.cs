...
namespace Pulumi.AzureNative.MachineLearningServices.V20231001.Inputs
{
    ...
    public sealed class DataQualityMonitoringSignalArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputMap<Union<string, Pulumi.AzureNative.MachineLearningServices.V20231001.MonitoringFeatureDataType>>? _featureDataTypeOverride;

        /// <summary>
        /// A dictionary that maps feature names to their respective data types.
        /// </summary>
        public InputMap<Union<string, Pulumi.AzureNative.MachineLearningServices.V20231001.MonitoringFeatureDataType>> FeatureDataTypeOverride
        {
            get => _featureDataTypeOverride ?? (_featureDataTypeOverride = new InputMap<Union<string, Pulumi.AzureNative.MachineLearningServices.V20231001.MonitoringFeatureDataType>>());
        ...
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20231001.MonitoringNotificationType>>? _notificationTypes;

        /// <summary>
        /// The current notification mode for this signal.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20231001.MonitoringNotificationType>> NotificationTypes
        {
            get => _notificationTypes ?? (_notificationTypes = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20231001.MonitoringNotificationType>>());
