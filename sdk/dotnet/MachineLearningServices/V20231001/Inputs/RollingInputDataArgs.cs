...
namespace Pulumi.AzureNative.MachineLearningServices.V20231001.Inputs
{
    ...
    /// </summary>
    public sealed class RollingInputDataArgs : global::Pulumi.ResourceArgs
    {
        [Input("columns")]
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20231001.JobInputType> JobInputType { get; set; } = null!;
        ...
        public RollingInputDataArgs()
        {
        }
        public static new RollingInputDataArgs Empty => new RollingInputDataArgs();
    }
}
