...
namespace Pulumi.AzureNative.MachineLearningServices.V20231001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20231001:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20231001:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20231001:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20231001.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
