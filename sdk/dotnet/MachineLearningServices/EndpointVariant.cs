...
namespace Pulumi.AzureNative.MachineLearningServices
{
    ...
    public partial class EndpointVariant : Pulumi.CustomResource
    {
        ...
        public EndpointVariant(string name, EndpointVariantArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices:EndpointVariant", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private EndpointVariant(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices:EndpointVariant", name, null, MakeResourceOptions(options, id))
        {
        }
