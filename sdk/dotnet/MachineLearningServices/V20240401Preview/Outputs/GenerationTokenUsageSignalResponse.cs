...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401Preview.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GenerationTokenUsageSignalResponse
    {
        /// <summary>
        /// [Required] Gets or sets the metrics to calculate and the corresponding thresholds.
        /// </summary>
        public readonly ImmutableArray<Outputs.GenerationTokenUsageMetricThresholdResponse> MetricThresholds;
        /// <summary>
        ...
        [OutputConstructor]
        private GenerationTokenUsageSignalResponse(
            ImmutableArray<Outputs.GenerationTokenUsageMetricThresholdResponse> metricThresholds,
