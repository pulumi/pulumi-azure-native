...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401Preview
{
    public static class GetEndpointDeployment
    {
        public static Task<GetEndpointDeploymentResult> InvokeAsync(GetEndpointDeploymentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEndpointDeploymentResult>("azure-native:machinelearningservices/v20240401preview:getEndpointDeployment", args ?? new GetEndpointDeploymentArgs(), options.WithDefaults());
