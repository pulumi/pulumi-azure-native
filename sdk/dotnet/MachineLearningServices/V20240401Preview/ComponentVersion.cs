...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20240401preview:ComponentVersion")]
    public partial class ComponentVersion : global::Pulumi.CustomResource
    {
        ...
        public ComponentVersion(string name, ComponentVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240401preview:ComponentVersion", name, args ?? new ComponentVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240401preview:ComponentVersion", name, null, MakeResourceOptions(options, id))
        {
        }
