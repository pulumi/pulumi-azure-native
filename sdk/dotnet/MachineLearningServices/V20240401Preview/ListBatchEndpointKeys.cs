...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401Preview
{
    public static class ListBatchEndpointKeys
    {
        ...
        public static Task<ListBatchEndpointKeysResult> InvokeAsync(ListBatchEndpointKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListBatchEndpointKeysResult>("azure-native:machinelearningservices/v20240401preview:listBatchEndpointKeys", args ?? new ListBatchEndpointKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Keys for endpoint authentication.
        /// </summary>
        public static Output<ListBatchEndpointKeysResult> Invoke(ListBatchEndpointKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListBatchEndpointKeysResult>("azure-native:machinelearningservices/v20240401preview:listBatchEndpointKeys", args ?? new ListBatchEndpointKeysInvokeArgs(), options.WithDefaults());
    }
