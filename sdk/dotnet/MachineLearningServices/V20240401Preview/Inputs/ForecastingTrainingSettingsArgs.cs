...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401Preview.Inputs
{
    ...
    public sealed class ForecastingTrainingSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20240401Preview.ForecastingModels>>? _allowedTrainingAlgorithms;

        /// <summary>
        /// Allowed models for forecasting task.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20240401Preview.ForecastingModels>> AllowedTrainingAlgorithms
        {
            get => _allowedTrainingAlgorithms ?? (_allowedTrainingAlgorithms = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20240401Preview.ForecastingModels>>());
            set => _allowedTrainingAlgorithms = value;
        }

        [Input("blockedTrainingAlgorithms")]
        private InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20240401Preview.ForecastingModels>>? _blockedTrainingAlgorithms;

        /// <summary>
        /// Blocked models for forecasting task.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20240401Preview.ForecastingModels>> BlockedTrainingAlgorithms
        {
            get => _blockedTrainingAlgorithms ?? (_blockedTrainingAlgorithms = new InputList<Union<string, Pulumi.AzureNative.MachineLearningServices.V20240401Preview.ForecastingModels>>());
