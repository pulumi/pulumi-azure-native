...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401Preview.Inputs
{
    ...
    public sealed class ImageModelSettingsClassificationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20240401Preview.LearningRateScheduler>? LearningRateScheduler { get; set; }
        ...
        /// </summary>
        [Input("optimizer")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20240401Preview.StochasticOptimizer>? Optimizer { get; set; }
