...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20240401preview:ComponentContainer")]
    public partial class ComponentContainer : global::Pulumi.CustomResource
    {
        ...
        public ComponentContainer(string name, ComponentContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240401preview:ComponentContainer", name, args ?? new ComponentContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20240401preview:ComponentContainer", name, null, MakeResourceOptions(options, id))
        {
        }
