...
namespace Pulumi.AzureNative.MachineLearningServices.V20240401Preview
{
    public static class GetLabelingJob
    {
        ...
        public static Task<GetLabelingJobResult> InvokeAsync(GetLabelingJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLabelingJobResult>("azure-native:machinelearningservices/v20240401preview:getLabelingJob", args ?? new GetLabelingJobArgs(), options.WithDefaults());

        /// <summary>
        /// Azure Resource Manager resource envelope.
        /// </summary>
        public static Output<GetLabelingJobResult> Invoke(GetLabelingJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLabelingJobResult>("azure-native:machinelearningservices/v20240401preview:getLabelingJob", args ?? new GetLabelingJobInvokeArgs(), options.WithDefaults());
