...
{
    [AzureNativeResourceType("azure-native:machinelearningservices/v20250101preview:ConnectionRaiBlocklistItem")]
    public partial class ConnectionRaiBlocklistItem : global::Pulumi.CustomResource
    {
        ...
        public ConnectionRaiBlocklistItem(string name, ConnectionRaiBlocklistItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20250101preview:ConnectionRaiBlocklistItem", name, args ?? new ConnectionRaiBlocklistItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionRaiBlocklistItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20250101preview:ConnectionRaiBlocklistItem", name, null, MakeResourceOptions(options, id))
        {
        }
