...
namespace Pulumi.AzureNative.MachineLearningServices.V20250101Preview
{
    public static class ListInferenceGroupDeltaModelsAsync
    {
        ...
        public static Task<ListInferenceGroupDeltaModelsAsyncResult> InvokeAsync(ListInferenceGroupDeltaModelsAsyncArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListInferenceGroupDeltaModelsAsyncResult>("azure-native:machinelearningservices/v20250101preview:listInferenceGroupDeltaModelsAsync", args ?? new ListInferenceGroupDeltaModelsAsyncArgs(), options.WithDefaults());
        ...
        public static Output<ListInferenceGroupDeltaModelsAsyncResult> Invoke(ListInferenceGroupDeltaModelsAsyncInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListInferenceGroupDeltaModelsAsyncResult>("azure-native:machinelearningservices/v20250101preview:listInferenceGroupDeltaModelsAsync", args ?? new ListInferenceGroupDeltaModelsAsyncInvokeArgs(), options.WithDefaults());
