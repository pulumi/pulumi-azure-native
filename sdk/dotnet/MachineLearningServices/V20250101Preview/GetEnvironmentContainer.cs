...
namespace Pulumi.AzureNative.MachineLearningServices.V20250101Preview
{
    public static class GetEnvironmentContainer
    {
        ...
        public static Task<GetEnvironmentContainerResult> InvokeAsync(GetEnvironmentContainerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentContainerResult>("azure-native:machinelearningservices/v20250101preview:getEnvironmentContainer", args ?? new GetEnvironmentContainerArgs(), options.WithDefaults());
        ...
        public static Output<GetEnvironmentContainerResult> Invoke(GetEnvironmentContainerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEnvironmentContainerResult>("azure-native:machinelearningservices/v20250101preview:getEnvironmentContainer", args ?? new GetEnvironmentContainerInvokeArgs(), options.WithDefaults());
