...
{
    [AzureNativeResourceType("azure-native:machinelearningservices/v20250101preview:ServerlessEndpoint")]
    public partial class ServerlessEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ServerlessEndpoint(string name, ServerlessEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20250101preview:ServerlessEndpoint", name, args ?? new ServerlessEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerlessEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20250101preview:ServerlessEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
