...
namespace Pulumi.AzureNative.MachineLearningServices.V20250101Preview
{
    public static class GetInferenceGroupStatus
    {
        public static Task<GetInferenceGroupStatusResult> InvokeAsync(GetInferenceGroupStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInferenceGroupStatusResult>("azure-native:machinelearningservices/v20250101preview:getInferenceGroupStatus", args ?? new GetInferenceGroupStatusArgs(), options.WithDefaults());
        ...
        public static Output<GetInferenceGroupStatusResult> Invoke(GetInferenceGroupStatusInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInferenceGroupStatusResult>("azure-native:machinelearningservices/v20250101preview:getInferenceGroupStatus", args ?? new GetInferenceGroupStatusInvokeArgs(), options.WithDefaults());
