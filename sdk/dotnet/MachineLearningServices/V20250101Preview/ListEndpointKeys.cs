...
namespace Pulumi.AzureNative.MachineLearningServices.V20250101Preview
{
    public static class ListEndpointKeys
    {
        public static Task<ListEndpointKeysResult> InvokeAsync(ListEndpointKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListEndpointKeysResult>("azure-native:machinelearningservices/v20250101preview:listEndpointKeys", args ?? new ListEndpointKeysArgs(), options.WithDefaults());

        public static Output<ListEndpointKeysResult> Invoke(ListEndpointKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListEndpointKeysResult>("azure-native:machinelearningservices/v20250101preview:listEndpointKeys", args ?? new ListEndpointKeysInvokeArgs(), options.WithDefaults());
