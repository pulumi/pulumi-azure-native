...
namespace Pulumi.AzureNative.MachineLearningServices.V20221001Preview
{
    ...
    public static class GetModelVersion
    {
        ...
        public static Task<GetModelVersionResult> InvokeAsync(GetModelVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetModelVersionResult>("azure-native:machinelearningservices/v20221001preview:getModelVersion", args ?? new GetModelVersionArgs(), options.WithDefaults());

        /// <summary>
        /// Azure Resource Manager resource envelope.
        /// </summary>
        public static Output<GetModelVersionResult> Invoke(GetModelVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetModelVersionResult>("azure-native:machinelearningservices/v20221001preview:getModelVersion", args ?? new GetModelVersionInvokeArgs(), options.WithDefaults());
    }
