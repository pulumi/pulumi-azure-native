...
namespace Pulumi.AzureNative.MachineLearningServices.V20221001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20221001preview:ComponentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:ComponentVersion to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221001preview:ComponentVersion")]
    public partial class ComponentVersion : global::Pulumi.CustomResource
    {
        ...
        public ComponentVersion(string name, ComponentVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:ComponentVersion", name, args ?? new ComponentVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ComponentVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:ComponentVersion", name, null, MakeResourceOptions(options, id))
        {
        }
