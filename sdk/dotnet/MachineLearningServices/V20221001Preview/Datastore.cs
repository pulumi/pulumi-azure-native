...
namespace Pulumi.AzureNative.MachineLearningServices.V20221001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20221001preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:Datastore to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221001preview:Datastore")]
    public partial class Datastore : global::Pulumi.CustomResource
    {
        ...
        public Datastore(string name, DatastoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:Datastore", name, args ?? new DatastoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Datastore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:Datastore", name, null, MakeResourceOptions(options, id))
        {
        }
