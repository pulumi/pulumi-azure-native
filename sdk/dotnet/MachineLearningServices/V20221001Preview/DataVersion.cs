...
namespace Pulumi.AzureNative.MachineLearningServices.V20221001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20221001preview:DataVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:DataVersion to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221001preview:DataVersion")]
    public partial class DataVersion : global::Pulumi.CustomResource
    {
        ...
        public DataVersion(string name, DataVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:DataVersion", name, args ?? new DataVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:DataVersion", name, null, MakeResourceOptions(options, id))
        {
        }
