...
namespace Pulumi.AzureNative.MachineLearningServices.V20221001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221001preview:ModelContainer")]
    public partial class ModelContainer : global::Pulumi.CustomResource
    {
        ...
        public ModelContainer(string name, ModelContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:ModelContainer", name, args ?? new ModelContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ModelContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:ModelContainer", name, null, MakeResourceOptions(options, id))
        {
        }
