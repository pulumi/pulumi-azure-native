...
{
    [Obsolete(@"azure-native:machinelearningservices/v20221001preview:BatchDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:BatchDeployment to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221001preview:BatchDeployment")]
    public partial class BatchDeployment : global::Pulumi.CustomResource
    {
        ...
        public BatchDeployment(string name, BatchDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:BatchDeployment", name, args ?? new BatchDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221001preview:BatchDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
