...
{
    [Obsolete(@"azure-native:machinelearningservices/v20221001preview:RegistryEnvironmentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:RegistryEnvironmentVersion to guarantee forwards compatibility.")]
    public static class GetRegistryEnvironmentVersion
    {
        ...
        public static Task<GetRegistryEnvironmentVersionResult> InvokeAsync(GetRegistryEnvironmentVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRegistryEnvironmentVersionResult>("azure-native:machinelearningservices/v20221001preview:getRegistryEnvironmentVersion", args ?? new GetRegistryEnvironmentVersionArgs(), options.WithDefaults());
        ...
        public static Output<GetRegistryEnvironmentVersionResult> Invoke(GetRegistryEnvironmentVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRegistryEnvironmentVersionResult>("azure-native:machinelearningservices/v20221001preview:getRegistryEnvironmentVersion", args ?? new GetRegistryEnvironmentVersionInvokeArgs(), options.WithDefaults());
    }
