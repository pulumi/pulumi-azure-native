...
namespace Pulumi.AzureNative.MachineLearningServices.Inputs
{
    ...
    public sealed class ComputeStartStopScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("action")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.ComputePowerAction>? Action { get; set; }
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.ScheduleStatus>? Status { get; set; }
