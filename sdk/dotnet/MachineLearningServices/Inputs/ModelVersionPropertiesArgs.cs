...
namespace Pulumi.AzureNative.MachineLearningServices.Inputs
{
    ...
    /// </summary>
    public sealed class ModelVersionPropertiesArgs : global::Pulumi.ResourceArgs
    {
        [Input("datasets")]
        ...
        public ModelVersionPropertiesArgs()
        {
            IsAnonymous = false;
            IsArchived = false;
        }
        public static new ModelVersionPropertiesArgs Empty => new ModelVersionPropertiesArgs();
    }
}
