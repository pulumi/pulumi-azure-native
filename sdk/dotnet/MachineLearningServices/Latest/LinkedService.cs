...
namespace Pulumi.AzureRM.MachineLearningServices.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var linkedService = new AzureRM.MachineLearningServices.Latest.LinkedService("linkedService", new AzureRM.MachineLearningServices.Latest.LinkedServiceArgs
    ///         {
    ...
    public partial class LinkedService : Pulumi.CustomResource
    {
        ...
        public LinkedService(string name, LinkedServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/latest:LinkedService", name, args ?? new LinkedServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LinkedService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/latest:LinkedService", name, null, MakeResourceOptions(options, id))
        {
        }
