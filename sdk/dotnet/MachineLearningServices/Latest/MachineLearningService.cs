...
namespace Pulumi.AzureRM.MachineLearningServices.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineLearningService = new AzureRM.MachineLearningServices.Latest.MachineLearningService("machineLearningService", new AzureRM.MachineLearningServices.Latest.MachineLearningServiceArgs
    ///         {
    ///             ComputeType = "ACI",
    ///             EnvironmentImageRequest = new AzureRM.MachineLearningServices.Latest.Inputs.CreateServiceRequestEnvironmentImageRequestArgs
    ///             {
    ///                 Assets = 
    ///                 {
    ///                     new AzureRM.MachineLearningServices.Latest.Inputs.ImageAssetArgs
    ///                     {
    ...
    ///                 Environment = new AzureRM.MachineLearningServices.Latest.Inputs.EnvironmentImageRequestEnvironmentArgs
    ///                 {
    ///                     Docker = new AzureRM.MachineLearningServices.Latest.Inputs.ModelEnvironmentDefinitionDockerArgs
    ///                     {
    ...
    ///                     Python = new AzureRM.MachineLearningServices.Latest.Inputs.ModelEnvironmentDefinitionPythonArgs
    ///                     {
    ///                         CondaDependencies = 
    ///                         {
    ///                             { "channels", 
    ...
    ///                     },
    ///                     Spark = new AzureRM.MachineLearningServices.Latest.Inputs.ModelEnvironmentDefinitionSparkArgs
    ///                     {
    ///                         Packages = {},
    ...
    ///                 Models = 
    ///                 {
    ///                     new AzureRM.MachineLearningServices.Latest.Inputs.ModelArgs
    ///                     {
    ///                         MimeType = "application/x-python",
    ...
    public partial class MachineLearningService : Pulumi.CustomResource
    {
        ...
        public MachineLearningService(string name, MachineLearningServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/latest:MachineLearningService", name, args ?? new MachineLearningServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/latest:MachineLearningService", name, null, MakeResourceOptions(options, id))
        {
        }
