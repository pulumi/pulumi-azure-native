...
namespace Pulumi.AzureNative.MachineLearningServices.V20221201Preview
{
    ...
    /// {
    ///     var modelContainer = new AzureNative.MachineLearningServices.V20221201Preview.ModelContainer("modelContainer", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221201preview:ModelContainer")]
    public partial class ModelContainer : global::Pulumi.CustomResource
    {
        ...
        public ModelContainer(string name, ModelContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:ModelContainer", name, args ?? new ModelContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ModelContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:ModelContainer", name, null, MakeResourceOptions(options, id))
        {
        }
