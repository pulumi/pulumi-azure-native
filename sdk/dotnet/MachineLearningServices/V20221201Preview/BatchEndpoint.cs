...
namespace Pulumi.AzureNative.MachineLearningServices.V20221201Preview
{
    ...
    /// {
    ///     var batchEndpoint = new AzureNative.MachineLearningServices.V20221201Preview.BatchEndpoint("batchEndpoint", new()
    ///     {
    ///         BatchEndpointProperties = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.BatchEndpointArgs
    ///         {
    ///             AuthMode = "AMLToken",
    ///             Defaults = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.BatchEndpointDefaultsArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:machinelearningservices/v20221201preview:BatchEndpoint string string 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221201preview:BatchEndpoint")]
    public partial class BatchEndpoint : global::Pulumi.CustomResource
    {
        ...
        public BatchEndpoint(string name, BatchEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:BatchEndpoint", name, args ?? new BatchEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BatchEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:BatchEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
