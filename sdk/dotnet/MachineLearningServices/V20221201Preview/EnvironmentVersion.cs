...
namespace Pulumi.AzureNative.MachineLearningServices.V20221201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:machinelearningservices/v20221201preview:EnvironmentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:EnvironmentVersion to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221201preview:EnvironmentVersion")]
    public partial class EnvironmentVersion : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentVersion(string name, EnvironmentVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:EnvironmentVersion", name, args ?? new EnvironmentVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnvironmentVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:EnvironmentVersion", name, null, MakeResourceOptions(options, id))
        {
        }
