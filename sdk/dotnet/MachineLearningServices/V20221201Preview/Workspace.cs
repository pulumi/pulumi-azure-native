...
namespace Pulumi.AzureNative.MachineLearningServices.V20221201Preview
{
    ...
    /// {
    ///     var workspace = new AzureNative.MachineLearningServices.V20221201Preview.Workspace("workspace", new()
    ///     {
    ///         ApplicationInsights = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/microsoft.insights/components/testinsights",
    ///         ContainerRegistry = "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/workspace-1234/providers/Microsoft.ContainerRegistry/registries/testRegistry",
    ///         Description = "test description",
    ///         Encryption = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.EncryptionPropertyArgs
    ///         {
    ///             Identity = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.IdentityForCmkArgs
    ///             {
    ...
    ///             },
    ///             KeyVaultProperties = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.EncryptionKeyVaultPropertiesArgs
    ///             {
    ///                 IdentityClientId = "",
    ...
    ///         {
    ///             new AzureNative.MachineLearningServices.V20221201Preview.Inputs.SharedPrivateLinkResourceArgs
    ///             {
    ///                 GroupId = "Sql",
    ///                 Name = "testdbresource",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221201preview:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20221201Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
