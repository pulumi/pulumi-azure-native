...
namespace Pulumi.AzureNative.MachineLearningServices.V20221201Preview
{
    ...
    /// {
    ///     var dataVersion = new AzureNative.MachineLearningServices.V20221201Preview.DataVersion("dataVersion", new()
    ///     {
    ///         DataVersionBaseProperties = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.UriFileDataVersionArgs
    ///         {
    ///             DataType = "uri_file",
    ///             DataUri = "string",
    ///             Description = "string",
