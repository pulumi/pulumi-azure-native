...
namespace Pulumi.AzureNative.MachineLearningServices.V20221201Preview
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.MachineLearningServices.V20221201Preview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "{privateEndpointConnectionName}",
    ///         PrivateLinkServiceConnectionState = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.PrivateLinkServiceConnectionStateArgs
    ///         {
