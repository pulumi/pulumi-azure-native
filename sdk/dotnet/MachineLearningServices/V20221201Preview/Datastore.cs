...
namespace Pulumi.AzureNative.MachineLearningServices.V20221201Preview
{
    ...
    /// {
    ///     var datastore = new AzureNative.MachineLearningServices.V20221201Preview.Datastore("datastore", new()
    ///     {
    ///         DatastoreProperties = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.AzureDataLakeGen1DatastoreArgs
    ///         {
    ///             Credentials = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.ServicePrincipalDatastoreCredentialsArgs
    ///             {
    ///                 AuthorityUrl = "string",
    ///                 ClientId = "00000000-1111-2222-3333-444444444444",
    ///                 CredentialsType = "ServicePrincipal",
    ///                 ResourceUrl = "string",
    ///                 Secrets = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.ServicePrincipalDatastoreSecretsArgs
    ///                 {
    ///                     ClientSecret = "string",
    ...
    ///     var datastore = new AzureNative.MachineLearningServices.V20221201Preview.Datastore("datastore", new()
    ///     {
    ///         DatastoreProperties = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.AzureDataLakeGen2DatastoreArgs
    ///         {
    ///             AccountName = "string",
    ///             Credentials = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.ServicePrincipalDatastoreCredentialsArgs
    ///             {
    ...
    ///     var datastore = new AzureNative.MachineLearningServices.V20221201Preview.Datastore("datastore", new()
    ///     {
    ///         DatastoreProperties = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.AzureFileDatastoreArgs
    ///         {
    ///             AccountName = "string",
    ///             Credentials = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.AccountKeyDatastoreCredentialsArgs
    ///             {
    ///                 CredentialsType = "AccountKey",
    ///                 Secrets = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.AccountKeyDatastoreSecretsArgs
    ///                 {
    ///                     Key = "string",
    ...
    ///     var datastore = new AzureNative.MachineLearningServices.V20221201Preview.Datastore("datastore", new()
    ///     {
    ///         DatastoreProperties = new AzureNative.MachineLearningServices.V20221201Preview.Inputs.AzureBlobDatastoreArgs
    ///         {
    ///             AccountName = "string",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:machinelearningservices/v20221201preview:Datastore string string 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:machinelearningservices/v20221201preview:Datastore")]
    public partial class Datastore : global::Pulumi.CustomResource
    {
        ...
        public Datastore(string name, DatastoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:Datastore", name, args ?? new DatastoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Datastore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20221201preview:Datastore", name, null, MakeResourceOptions(options, id))
        {
        }
