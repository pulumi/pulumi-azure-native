...
namespace Pulumi.AzureNative.MachineLearningServices.V20221201Preview
{
    public static class GetComponentVersion
    {
        ...
        public static Task<GetComponentVersionResult> InvokeAsync(GetComponentVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetComponentVersionResult>("azure-native:machinelearningservices/v20221201preview:getComponentVersion", args ?? new GetComponentVersionArgs(), options.WithDefaults());

        /// <summary>
        /// Azure Resource Manager resource envelope.
        /// </summary>
        public static Output<GetComponentVersionResult> Invoke(GetComponentVersionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetComponentVersionResult>("azure-native:machinelearningservices/v20221201preview:getComponentVersion", args ?? new GetComponentVersionInvokeArgs(), options.WithDefaults());
    }
