...
namespace Pulumi.AzureNextGen.MachineLearningServices.V20200801
{
    public static class GetMachineLearningCompute
    {
        public static Task<GetMachineLearningComputeResult> InvokeAsync(GetMachineLearningComputeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineLearningComputeResult>("azure-nextgen:machinelearningservices/v20200801:getMachineLearningCompute", args ?? new GetMachineLearningComputeArgs(), options.WithVersion());
    }
