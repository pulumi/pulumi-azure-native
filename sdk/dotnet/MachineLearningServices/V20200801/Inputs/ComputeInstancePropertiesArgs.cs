...
namespace Pulumi.AzureNative.MachineLearningServices.V20200801.Inputs
{
    ...
    public sealed class ComputeInstancePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20200801.ApplicationSharingPolicy>? ApplicationSharingPolicy { get; set; }

        /// <summary>
        /// The Compute Instance Authorization type. Available values are personal (default).
        /// </summary>
        [Input("computeInstanceAuthorizationType")]
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20200801.ComputeInstanceAuthorizationType>? ComputeInstanceAuthorizationType { get; set; }
