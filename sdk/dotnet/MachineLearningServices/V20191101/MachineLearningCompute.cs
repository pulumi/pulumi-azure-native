...
namespace Pulumi.AzureNative.MachineLearningServices.V20191101
{
    ...
    [AzureNativeResourceType("azure-native:machinelearningservices/v20191101:MachineLearningCompute")]
    public partial class MachineLearningCompute : global::Pulumi.CustomResource
    {
        ...
        public MachineLearningCompute(string name, MachineLearningComputeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20191101:MachineLearningCompute", name, args ?? new MachineLearningComputeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningCompute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20191101:MachineLearningCompute", name, null, MakeResourceOptions(options, id))
        {
        }
