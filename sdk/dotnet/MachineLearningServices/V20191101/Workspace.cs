...
namespace Pulumi.AzureRM.MachineLearningServices.V20191101
{
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20191101:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/v20191101:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
