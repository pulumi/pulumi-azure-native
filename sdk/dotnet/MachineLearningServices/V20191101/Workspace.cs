...
namespace Pulumi.AzureNative.MachineLearningServices.V20191101
{
    ...
    [AzureNativeResourceType("azure-native:machinelearningservices/v20191101:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20191101:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20191101:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
