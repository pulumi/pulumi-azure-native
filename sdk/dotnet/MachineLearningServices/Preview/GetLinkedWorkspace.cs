...
namespace Pulumi.AzureRM.MachineLearningServices.Preview
{
    public static class GetLinkedWorkspace
    {
        public static Task<GetLinkedWorkspaceResult> InvokeAsync(GetLinkedWorkspaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLinkedWorkspaceResult>("azurerm:machinelearningservices/preview:getLinkedWorkspace", args ?? new GetLinkedWorkspaceArgs(), options.WithVersion());
    }
