...
namespace Pulumi.AzureRM.MachineLearningServices.Preview
{
    ...
    public partial class WorkspaceConnection : Pulumi.CustomResource
    {
        ...
        public WorkspaceConnection(string name, WorkspaceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/preview:WorkspaceConnection", name, args ?? new WorkspaceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningservices/preview:WorkspaceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
