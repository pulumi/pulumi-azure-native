...
namespace Pulumi.AzureRM.MachineLearningServices.Preview
{
    public static class GetMachineLearningService
    {
        public static Task<GetMachineLearningServiceResult> InvokeAsync(GetMachineLearningServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineLearningServiceResult>("azurerm:machinelearningservices/preview:getMachineLearningService", args ?? new GetMachineLearningServiceArgs(), options.WithVersion());
    }
