...
namespace Pulumi.AzureRM.MachineLearningServices.Preview
{
    public static class GetLinkedService
    {
        public static Task<GetLinkedServiceResult> InvokeAsync(GetLinkedServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLinkedServiceResult>("azurerm:machinelearningservices/preview:getLinkedService", args ?? new GetLinkedServiceArgs(), options.WithVersion());
    }
