...
namespace Pulumi.AzureRM.MachineLearningServices.Preview
{
    public static class GetMachineLearningCompute
    {
        public static Task<GetMachineLearningComputeResult> InvokeAsync(GetMachineLearningComputeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineLearningComputeResult>("azurerm:machinelearningservices/preview:getMachineLearningCompute", args ?? new GetMachineLearningComputeArgs(), options.WithVersion());
    }
