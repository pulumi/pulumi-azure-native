...
namespace Pulumi.AzureNative.ComputeSchedule
{
    ...
    public partial class ScheduledAction : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ScheduledActionPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public ScheduledAction(string name, ScheduledActionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:computeschedule:ScheduledAction", name, args ?? new ScheduledActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledAction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:computeschedule:ScheduledAction", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:computeschedule/v20260301preview:ScheduledAction" },
                    new global::Pulumi.Alias { Type = "azure-native:computeschedule/v20260415preview:ScheduledAction" },
                },
            };
    ...
    public sealed class ScheduledActionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.ScheduledActionPropertiesArgs>? Properties { get; set; }
