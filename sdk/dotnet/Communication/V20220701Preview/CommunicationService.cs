...
namespace Pulumi.AzureNative.Communication.V20220701Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:communication/v20220701preview:CommunicationService is being removed in the next major version of this provider. Upgrade to at least azure-native:communication/v20230401preview:CommunicationService to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:communication/v20220701preview:CommunicationService")]
    public partial class CommunicationService : global::Pulumi.CustomResource
    {
        ...
        public CommunicationService(string name, CommunicationServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20220701preview:CommunicationService", name, args ?? new CommunicationServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommunicationService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20220701preview:CommunicationService", name, null, MakeResourceOptions(options, id))
        {
        }
