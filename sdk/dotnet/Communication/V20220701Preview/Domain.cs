...
namespace Pulumi.AzureNative.Communication.V20220701Preview
{
    ...
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20220701preview:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20220701preview:Domain", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Communication.V20220701Preview.DomainManagement> DomainManagement { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Communication.V20220701Preview.UserEngagementTracking>? UserEngagementTracking { get; set; }
