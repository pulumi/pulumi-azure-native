...
namespace Pulumi.AzureNative.Communication.V20220701Preview
{
    ...
    public partial class EmailService : global::Pulumi.CustomResource
    {
        ...
        public EmailService(string name, EmailServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20220701preview:EmailService", name, args ?? new EmailServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20220701preview:EmailService", name, null, MakeResourceOptions(options, id))
        {
        }
