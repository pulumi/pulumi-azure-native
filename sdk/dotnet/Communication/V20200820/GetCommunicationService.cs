...
namespace Pulumi.AzureNative.Communication.V20200820
{
    public static class GetCommunicationService
    {
        ...
        public static Task<GetCommunicationServiceResult> InvokeAsync(GetCommunicationServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCommunicationServiceResult>("azure-native:communication/v20200820:getCommunicationService", args ?? new GetCommunicationServiceArgs(), options.WithVersion());
        ...
        public static Output<GetCommunicationServiceResult> Invoke(GetCommunicationServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCommunicationServiceResult>("azure-native:communication/v20200820:getCommunicationService", args ?? new GetCommunicationServiceInvokeArgs(), options.WithVersion());
    }
