...
namespace Pulumi.AzureNative.Communication.V20200820
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:communication/v20200820:CommunicationService is being removed in the next major version of this provider. Upgrade to at least azure-native:communication/v20230401preview:CommunicationService to guarantee forwards compatibility.")]
    ...
    public partial class CommunicationService : global::Pulumi.CustomResource
    {
        ...
        public CommunicationService(string name, CommunicationServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20200820:CommunicationService", name, args ?? new CommunicationServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommunicationService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20200820:CommunicationService", name, null, MakeResourceOptions(options, id))
        {
        }
