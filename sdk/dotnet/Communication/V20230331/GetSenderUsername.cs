...
namespace Pulumi.AzureNative.Communication.V20230331
{
    public static class GetSenderUsername
    {
        ...
        public static Task<GetSenderUsernameResult> InvokeAsync(GetSenderUsernameArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSenderUsernameResult>("azure-native:communication/v20230331:getSenderUsername", args ?? new GetSenderUsernameArgs(), options.WithDefaults());

        /// <summary>
        /// Get a valid sender username for a domains resource.
        /// </summary>
        public static Output<GetSenderUsernameResult> Invoke(GetSenderUsernameInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSenderUsernameResult>("azure-native:communication/v20230331:getSenderUsername", args ?? new GetSenderUsernameInvokeArgs(), options.WithDefaults());
    }
