...
namespace Pulumi.AzureNative.Communication.V20230331
{
    ...
    public static class GetCommunicationService
    {
        ...
        public static Task<GetCommunicationServiceResult> InvokeAsync(GetCommunicationServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCommunicationServiceResult>("azure-native:communication/v20230331:getCommunicationService", args ?? new GetCommunicationServiceArgs(), options.WithDefaults());
        ...
        public static Output<GetCommunicationServiceResult> Invoke(GetCommunicationServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCommunicationServiceResult>("azure-native:communication/v20230331:getCommunicationService", args ?? new GetCommunicationServiceInvokeArgs(), options.WithDefaults());
    }
