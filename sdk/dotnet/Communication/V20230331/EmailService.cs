...
namespace Pulumi.AzureNative.Communication.V20230331
{
    ...
    /// {
    ///     var emailService = new AzureNative.Communication.V20230331.EmailService("emailService", new()
    ///     {
    ...
    public partial class EmailService : global::Pulumi.CustomResource
    {
        ...
        public EmailService(string name, EmailServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230331:EmailService", name, args ?? new EmailServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230331:EmailService", name, null, MakeResourceOptions(options, id))
        {
        }
