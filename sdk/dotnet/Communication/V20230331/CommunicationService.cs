...
namespace Pulumi.AzureNative.Communication.V20230331
{
    /// <summary>
    ...
    /// {
    ///     var communicationService = new AzureNative.Communication.V20230331.CommunicationService("communicationService", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:communication/v20230331:CommunicationService MyCommunicationResource /subscriptions/11112222-3333-4444-5555-666677778888/resourceGroups/MyResourceGroup/providers/Microsoft.Communication/CommunicationServices/MyCommunicationResource 
    /// ```
    /// </summary>
    ...
    public partial class CommunicationService : global::Pulumi.CustomResource
    {
        ...
        public CommunicationService(string name, CommunicationServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230331:CommunicationService", name, args ?? new CommunicationServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommunicationService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230331:CommunicationService", name, null, MakeResourceOptions(options, id))
        {
        }
