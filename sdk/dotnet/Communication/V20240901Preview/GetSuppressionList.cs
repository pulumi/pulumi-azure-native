...
namespace Pulumi.AzureNative.Communication.V20240901Preview
{
    public static class GetSuppressionList
    {
        ...
        public static Task<GetSuppressionListResult> InvokeAsync(GetSuppressionListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionListResult>("azure-native:communication/v20240901preview:getSuppressionList", args ?? new GetSuppressionListArgs(), options.WithDefaults());

        /// <summary>
        /// Get a SuppressionList resource.
        /// </summary>
        public static Output<GetSuppressionListResult> Invoke(GetSuppressionListInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSuppressionListResult>("azure-native:communication/v20240901preview:getSuppressionList", args ?? new GetSuppressionListInvokeArgs(), options.WithDefaults());
