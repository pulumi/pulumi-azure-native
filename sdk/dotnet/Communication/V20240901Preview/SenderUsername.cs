...
namespace Pulumi.AzureNative.Communication.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:communication/v20240901preview:SenderUsername")]
    public partial class SenderUsername : global::Pulumi.CustomResource
    {
        ...
        public SenderUsername(string name, SenderUsernameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20240901preview:SenderUsername", name, args ?? new SenderUsernameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SenderUsername(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20240901preview:SenderUsername", name, null, MakeResourceOptions(options, id))
        {
        }
