...
namespace Pulumi.AzureNative.Communication.V20240901Preview
{
    public static class GetEmailService
    {
        ...
        public static Task<GetEmailServiceResult> InvokeAsync(GetEmailServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEmailServiceResult>("azure-native:communication/v20240901preview:getEmailService", args ?? new GetEmailServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Get the EmailService and its properties.
        /// </summary>
        public static Output<GetEmailServiceResult> Invoke(GetEmailServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEmailServiceResult>("azure-native:communication/v20240901preview:getEmailService", args ?? new GetEmailServiceInvokeArgs(), options.WithDefaults());
