...
namespace Pulumi.AzureNative.Communication.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:communication/v20240901preview:SuppressionListAddress")]
    public partial class SuppressionListAddress : global::Pulumi.CustomResource
    {
        ...
        public SuppressionListAddress(string name, SuppressionListAddressArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20240901preview:SuppressionListAddress", name, args ?? new SuppressionListAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SuppressionListAddress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20240901preview:SuppressionListAddress", name, null, MakeResourceOptions(options, id))
        {
        }
