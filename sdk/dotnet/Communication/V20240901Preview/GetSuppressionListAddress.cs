...
namespace Pulumi.AzureNative.Communication.V20240901Preview
{
    public static class GetSuppressionListAddress
    {
        ...
        public static Task<GetSuppressionListAddressResult> InvokeAsync(GetSuppressionListAddressArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionListAddressResult>("azure-native:communication/v20240901preview:getSuppressionListAddress", args ?? new GetSuppressionListAddressArgs(), options.WithDefaults());
        ...
        public static Output<GetSuppressionListAddressResult> Invoke(GetSuppressionListAddressInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSuppressionListAddressResult>("azure-native:communication/v20240901preview:getSuppressionListAddress", args ?? new GetSuppressionListAddressInvokeArgs(), options.WithDefaults());
