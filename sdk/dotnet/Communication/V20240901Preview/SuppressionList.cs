...
namespace Pulumi.AzureNative.Communication.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:communication/v20240901preview:SuppressionList")]
    public partial class SuppressionList : global::Pulumi.CustomResource
    {
        ...
        public SuppressionList(string name, SuppressionListArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20240901preview:SuppressionList", name, args ?? new SuppressionListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SuppressionList(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20240901preview:SuppressionList", name, null, MakeResourceOptions(options, id))
        {
        }
