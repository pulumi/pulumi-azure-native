...
namespace Pulumi.AzureNative.Communication.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:communication/v20240901preview:EmailService")]
    public partial class EmailService : global::Pulumi.CustomResource
    {
        ...
        public EmailService(string name, EmailServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20240901preview:EmailService", name, args ?? new EmailServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20240901preview:EmailService", name, null, MakeResourceOptions(options, id))
        {
        }
