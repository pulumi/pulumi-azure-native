...
namespace Pulumi.AzureNative.Communication.V20230601Preview
{
    public static class GetSuppressionListAddress
    {
        ...
        public static Task<GetSuppressionListAddressResult> InvokeAsync(GetSuppressionListAddressArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionListAddressResult>("azure-native:communication/v20230601preview:getSuppressionListAddress", args ?? new GetSuppressionListAddressArgs(), options.WithDefaults());
