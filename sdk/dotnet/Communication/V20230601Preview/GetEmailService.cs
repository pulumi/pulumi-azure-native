...
namespace Pulumi.AzureNative.Communication.V20230601Preview
{
    public static class GetEmailService
    {
        ...
        public static Task<GetEmailServiceResult> InvokeAsync(GetEmailServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEmailServiceResult>("azure-native:communication/v20230601preview:getEmailService", args ?? new GetEmailServiceArgs(), options.WithDefaults());
