...
namespace Pulumi.AzureNative.Communication.V20230601Preview
{
    public static class GetSuppressionList
    {
        ...
        public static Task<GetSuppressionListResult> InvokeAsync(GetSuppressionListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSuppressionListResult>("azure-native:communication/v20230601preview:getSuppressionList", args ?? new GetSuppressionListArgs(), options.WithDefaults());
