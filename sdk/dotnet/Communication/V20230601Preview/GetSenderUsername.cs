...
namespace Pulumi.AzureNative.Communication.V20230601Preview
{
    public static class GetSenderUsername
    {
        ...
        public static Task<GetSenderUsernameResult> InvokeAsync(GetSenderUsernameArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSenderUsernameResult>("azure-native:communication/v20230601preview:getSenderUsername", args ?? new GetSenderUsernameArgs(), options.WithDefaults());
