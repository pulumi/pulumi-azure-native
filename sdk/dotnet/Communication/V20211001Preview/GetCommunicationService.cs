...
namespace Pulumi.AzureNative.Communication.V20211001Preview
{
    public static class GetCommunicationService
    {
        ...
        public static Task<GetCommunicationServiceResult> InvokeAsync(GetCommunicationServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCommunicationServiceResult>("azure-native:communication/v20211001preview:getCommunicationService", args ?? new GetCommunicationServiceArgs(), options.WithDefaults());
        ...
        public static Output<GetCommunicationServiceResult> Invoke(GetCommunicationServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCommunicationServiceResult>("azure-native:communication/v20211001preview:getCommunicationService", args ?? new GetCommunicationServiceInvokeArgs(), options.WithDefaults());
    }
