...
namespace Pulumi.AzureNative.Communication.V20211001Preview
{
    ...
    public partial class CommunicationService : global::Pulumi.CustomResource
    {
        ...
        public CommunicationService(string name, CommunicationServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20211001preview:CommunicationService", name, args ?? new CommunicationServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommunicationService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20211001preview:CommunicationService", name, null, MakeResourceOptions(options, id))
        {
        }
