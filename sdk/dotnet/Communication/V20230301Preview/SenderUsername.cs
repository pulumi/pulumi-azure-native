...
namespace Pulumi.AzureNative.Communication.V20230301Preview
{
    ...
    /// {
    ///     var senderUsername = new AzureNative.Communication.V20230301Preview.SenderUsername("senderUsername", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:communication/v20230301preview:SenderUsername")]
    public partial class SenderUsername : global::Pulumi.CustomResource
    {
        ...
        public SenderUsername(string name, SenderUsernameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230301preview:SenderUsername", name, args ?? new SenderUsernameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SenderUsername(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230301preview:SenderUsername", name, null, MakeResourceOptions(options, id))
        {
        }
