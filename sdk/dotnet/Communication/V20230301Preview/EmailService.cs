...
namespace Pulumi.AzureNative.Communication.V20230301Preview
{
    ...
    /// {
    ///     var emailService = new AzureNative.Communication.V20230301Preview.EmailService("emailService", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:communication/v20230301preview:EmailService")]
    public partial class EmailService : global::Pulumi.CustomResource
    {
        ...
        public EmailService(string name, EmailServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230301preview:EmailService", name, args ?? new EmailServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230301preview:EmailService", name, null, MakeResourceOptions(options, id))
        {
        }
