...
namespace Pulumi.AzureNative.Communication.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:communication/v20230401:CommunicationService")]
    public partial class CommunicationService : global::Pulumi.CustomResource
    {
        ...
        public CommunicationService(string name, CommunicationServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230401:CommunicationService", name, args ?? new CommunicationServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CommunicationService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230401:CommunicationService", name, null, MakeResourceOptions(options, id))
        {
        }
