...
namespace Pulumi.AzureNative.Communication.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:communication/v20230401:EmailService")]
    public partial class EmailService : global::Pulumi.CustomResource
    {
        ...
        public EmailService(string name, EmailServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230401:EmailService", name, args ?? new EmailServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:communication/v20230401:EmailService", name, null, MakeResourceOptions(options, id))
        {
        }
