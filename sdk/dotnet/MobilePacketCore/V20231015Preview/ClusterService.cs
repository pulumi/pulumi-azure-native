...
namespace Pulumi.AzureNative.MobilePacketCore.V20231015Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilepacketcore/v20231015preview:ClusterService")]
    public partial class ClusterService : global::Pulumi.CustomResource
    {
        ...
        public ClusterService(string name, ClusterServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilepacketcore/v20231015preview:ClusterService", name, args ?? new ClusterServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilepacketcore/v20231015preview:ClusterService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:mobilepacketcore:ClusterService" },
                },
            };
    ...
    public sealed class ClusterServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MobilePacketCore.V20231015Preview.SkuDeploymentType> DeploymentType { get; set; } = null!;
