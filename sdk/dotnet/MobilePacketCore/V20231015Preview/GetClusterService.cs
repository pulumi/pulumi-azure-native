...
namespace Pulumi.AzureNative.MobilePacketCore.V20231015Preview
{
    public static class GetClusterService
    {
        ...
        public static Task<GetClusterServiceResult> InvokeAsync(GetClusterServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClusterServiceResult>("azure-native:mobilepacketcore/v20231015preview:getClusterService", args ?? new GetClusterServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Get a ClusterServiceResource
        /// </summary>
        public static Output<GetClusterServiceResult> Invoke(GetClusterServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClusterServiceResult>("azure-native:mobilepacketcore/v20231015preview:getClusterService", args ?? new GetClusterServiceInvokeArgs(), options.WithDefaults());
    }
