...
namespace Pulumi.AzureNative.MobilePacketCore.V20230515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mobilepacketcore/v20230515preview:NetworkFunction")]
    public partial class NetworkFunction : global::Pulumi.CustomResource
    {
        ...
        public NetworkFunction(string name, NetworkFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mobilepacketcore/v20230515preview:NetworkFunction", name, args ?? new NetworkFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mobilepacketcore/v20230515preview:NetworkFunction", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:mobilepacketcore:NetworkFunction"},
                },
            };
    ...
    public sealed class NetworkFunctionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MobilePacketCore.V20230515Preview.NetworkFunctionAdministrativeState> NetworkFunctionAdministrativeState { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.MobilePacketCore.V20230515Preview.NetworkFunctionType> NetworkFunctionType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.MobilePacketCore.V20230515Preview.SkuDefinitions> Sku { get; set; } = null!;
