...
namespace Pulumi.AzureNative.MobilePacketCore.V20230515Preview
{
    public static class GetNetworkFunction
    {
        ...
        public static Task<GetNetworkFunctionResult> InvokeAsync(GetNetworkFunctionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkFunctionResult>("azure-native:mobilepacketcore/v20230515preview:getNetworkFunction", args ?? new GetNetworkFunctionArgs(), options.WithDefaults());

        /// <summary>
        /// Get a NetworkFunctionResource
        /// </summary>
        public static Output<GetNetworkFunctionResult> Invoke(GetNetworkFunctionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkFunctionResult>("azure-native:mobilepacketcore/v20230515preview:getNetworkFunction", args ?? new GetNetworkFunctionInvokeArgs(), options.WithDefaults());
    }
