...
namespace Pulumi.AzureNative.WeightsAndBiases
{
    ...
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:weightsandbiases:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:weightsandbiases:Instance", name, null, MakeResourceOptions(options, id))
        {
        }
