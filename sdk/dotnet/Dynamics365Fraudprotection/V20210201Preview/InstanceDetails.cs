...
namespace Pulumi.AzureNative.Dynamics365Fraudprotection.V20210201Preview
{
    ...
    public partial class InstanceDetails : Pulumi.CustomResource
    {
        ...
        public InstanceDetails(string name, InstanceDetailsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dynamics365fraudprotection/v20210201preview:InstanceDetails", name, args ?? new InstanceDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dynamics365fraudprotection/v20210201preview:InstanceDetails", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:dynamics365fraudprotection/v20210201preview:InstanceDetails"},
                    new Pulumi.Alias { Type = "azure-native:dynamics365fraudprotection:InstanceDetails"},
                    new Pulumi.Alias { Type = "azure-nextgen:dynamics365fraudprotection:InstanceDetails"},
                },
            };
