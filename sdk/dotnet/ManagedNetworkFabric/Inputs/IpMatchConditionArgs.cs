...
namespace Pulumi.AzureNative.ManagedNetworkFabric.Inputs
{
    ...
    public sealed class IpMatchConditionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("prefixType")]
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.PrefixType>? PrefixType { get; set; }

        /// <summary>
        /// IP Address type.
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.SourceDestinationType>? Type { get; set; }
