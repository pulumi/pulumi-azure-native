...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetNetworkToNetworkInterconnect
    {
        ...
        public static Task<GetNetworkToNetworkInterconnectResult> InvokeAsync(GetNetworkToNetworkInterconnectArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkToNetworkInterconnectResult>("azure-native:managednetworkfabric/v20230201preview:getNetworkToNetworkInterconnect", args ?? new GetNetworkToNetworkInterconnectArgs(), options.WithDefaults());
