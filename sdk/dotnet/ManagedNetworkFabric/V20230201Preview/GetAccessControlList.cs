...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetAccessControlList
    {
        ...
        public static Task<GetAccessControlListResult> InvokeAsync(GetAccessControlListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccessControlListResult>("azure-native:managednetworkfabric/v20230201preview:getAccessControlList", args ?? new GetAccessControlListArgs(), options.WithDefaults());
