...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetExternalNetwork
    {
        ...
        public static Task<GetExternalNetworkResult> InvokeAsync(GetExternalNetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetExternalNetworkResult>("azure-native:managednetworkfabric/v20230201preview:getExternalNetwork", args ?? new GetExternalNetworkArgs(), options.WithDefaults());
