...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    ...
    /// {
    ///     var l3IsolationDomain = new AzureNative.ManagedNetworkFabric.V20230201Preview.L3IsolationDomain("l3IsolationDomain", new()
    ///     {
    ///         AggregateRouteConfiguration = new AzureNative.ManagedNetworkFabric.V20230201Preview.Inputs.L3IsolationDomainPatchPropertiesAggregateRouteConfigurationArgs
    ///         {
    ///             Ipv4Routes = new[]
    ///             {
    ///                 new AzureNative.ManagedNetworkFabric.V20230201Preview.Inputs.L3IsolationDomainPatchPropertiesIpv4RoutesArgs
    ///                 {
    ///                     Prefix = "10.0.0.0/24",
    ///                 },
    ///             },
    ///             Ipv6Routes = new[]
    ///             {
    ///                 new AzureNative.ManagedNetworkFabric.V20230201Preview.Inputs.L3IsolationDomainPatchPropertiesIpv6RoutesArgs
    ///                 {
    ///                     Prefix = "10.0.0.1",
    ///                 },
    ///             },
    ///         },
    ///         ConnectedSubnetRoutePolicy = new AzureNative.ManagedNetworkFabric.V20230201Preview.Inputs.L3IsolationDomainPatchPropertiesConnectedSubnetRoutePolicyArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230201preview:L3IsolationDomain")]
    public partial class L3IsolationDomain : global::Pulumi.CustomResource
    {
        ...
        public L3IsolationDomain(string name, L3IsolationDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:L3IsolationDomain", name, args ?? new L3IsolationDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private L3IsolationDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:L3IsolationDomain", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class L3IsolationDomainArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview.RedistributeConnectedSubnets>? RedistributeConnectedSubnets { get; set; }

        /// <summary>
        /// Advertise Static Routes. Ex: "True" | "False".
        /// </summary>
        [Input("redistributeStaticRoutes")]
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview.RedistributeStaticRoutes>? RedistributeStaticRoutes { get; set; }
