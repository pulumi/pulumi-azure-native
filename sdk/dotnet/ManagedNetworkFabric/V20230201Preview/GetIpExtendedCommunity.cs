...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetIpExtendedCommunity
    {
        ...
        public static Task<GetIpExtendedCommunityResult> InvokeAsync(GetIpExtendedCommunityArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpExtendedCommunityResult>("azure-native:managednetworkfabric/v20230201preview:getIpExtendedCommunity", args ?? new GetIpExtendedCommunityArgs(), options.WithDefaults());
