...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    ...
    public partial class NetworkDevice : global::Pulumi.CustomResource
    {
        ...
        public NetworkDevice(string name, NetworkDeviceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:NetworkDevice", name, args ?? new NetworkDeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkDevice(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:NetworkDevice", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkDeviceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview.NetworkDeviceRoleTypes> NetworkDeviceRole { get; set; } = null!;
