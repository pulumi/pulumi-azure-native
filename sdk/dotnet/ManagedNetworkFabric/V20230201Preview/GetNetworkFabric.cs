...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetNetworkFabric
    {
        ...
        public static Task<GetNetworkFabricResult> InvokeAsync(GetNetworkFabricArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkFabricResult>("azure-native:managednetworkfabric/v20230201preview:getNetworkFabric", args ?? new GetNetworkFabricArgs(), options.WithDefaults());

        /// <summary>
        /// Get Network Fabric resource details.
        /// </summary>
        public static Output<GetNetworkFabricResult> Invoke(GetNetworkFabricInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkFabricResult>("azure-native:managednetworkfabric/v20230201preview:getNetworkFabric", args ?? new GetNetworkFabricInvokeArgs(), options.WithDefaults());
