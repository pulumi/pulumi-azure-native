...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetNetworkInterfaceStatus
    {
        ...
        public static Task<GetNetworkInterfaceStatusResult> InvokeAsync(GetNetworkInterfaceStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkInterfaceStatusResult>("azure-native:managednetworkfabric/v20230201preview:getNetworkInterfaceStatus", args ?? new GetNetworkInterfaceStatusArgs(), options.WithDefaults());
