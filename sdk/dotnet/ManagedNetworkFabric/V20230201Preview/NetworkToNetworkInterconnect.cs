...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    ...
    public partial class NetworkToNetworkInterconnect : global::Pulumi.CustomResource
    {
        ...
        public NetworkToNetworkInterconnect(string name, NetworkToNetworkInterconnectArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:NetworkToNetworkInterconnect", name, args ?? new NetworkToNetworkInterconnectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkToNetworkInterconnect(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:NetworkToNetworkInterconnect", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkToNetworkInterconnectArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview.BooleanEnumProperty> IsManagementType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview.BooleanEnumProperty> UseOptionB { get; set; } = null!;
