...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetIpCommunity
    {
        ...
        public static Task<GetIpCommunityResult> InvokeAsync(GetIpCommunityArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpCommunityResult>("azure-native:managednetworkfabric/v20230201preview:getIpCommunity", args ?? new GetIpCommunityArgs(), options.WithDefaults());

        /// <summary>
        /// Implements an IP Community GET method.
        /// </summary>
        public static Output<GetIpCommunityResult> Invoke(GetIpCommunityInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpCommunityResult>("azure-native:managednetworkfabric/v20230201preview:getIpCommunity", args ?? new GetIpCommunityInvokeArgs(), options.WithDefaults());
