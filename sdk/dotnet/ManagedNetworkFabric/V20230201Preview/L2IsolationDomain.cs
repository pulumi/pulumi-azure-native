...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    ...
    public partial class L2IsolationDomain : global::Pulumi.CustomResource
    {
        ...
        public L2IsolationDomain(string name, L2IsolationDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:L2IsolationDomain", name, args ?? new L2IsolationDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private L2IsolationDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:L2IsolationDomain", name, null, MakeResourceOptions(options, id))
        {
        }
