...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    ...
    public partial class AccessControlList : global::Pulumi.CustomResource
    {
        ...
        public AccessControlList(string name, AccessControlListArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:AccessControlList", name, args ?? new AccessControlListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessControlList(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:AccessControlList", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccessControlListArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview.AddressFamily> AddressFamily { get; set; } = null!;
