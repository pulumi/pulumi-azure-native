...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetL2IsolationDomain
    {
        ...
        public static Task<GetL2IsolationDomainResult> InvokeAsync(GetL2IsolationDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetL2IsolationDomainResult>("azure-native:managednetworkfabric/v20230201preview:getL2IsolationDomain", args ?? new GetL2IsolationDomainArgs(), options.WithDefaults());
