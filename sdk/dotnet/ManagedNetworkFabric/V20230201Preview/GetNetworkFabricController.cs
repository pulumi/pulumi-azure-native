...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetNetworkFabricController
    {
        ...
        public static Task<GetNetworkFabricControllerResult> InvokeAsync(GetNetworkFabricControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkFabricControllerResult>("azure-native:managednetworkfabric/v20230201preview:getNetworkFabricController", args ?? new GetNetworkFabricControllerArgs(), options.WithDefaults());
        ...
        public static Output<GetNetworkFabricControllerResult> Invoke(GetNetworkFabricControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkFabricControllerResult>("azure-native:managednetworkfabric/v20230201preview:getNetworkFabricController", args ?? new GetNetworkFabricControllerInvokeArgs(), options.WithDefaults());
    }
