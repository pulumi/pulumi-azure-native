...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    ...
    /// {
    ///     var networkRack = new AzureNative.ManagedNetworkFabric.V20230201Preview.NetworkRack("networkRack", new()
    ///     {
    ///         Annotation = "null",
    ///         Location = "eastus",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230201preview:NetworkRack")]
    public partial class NetworkRack : global::Pulumi.CustomResource
    {
        ...
        public NetworkRack(string name, NetworkRackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:NetworkRack", name, args ?? new NetworkRackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkRack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:NetworkRack", name, null, MakeResourceOptions(options, id))
        {
        }
