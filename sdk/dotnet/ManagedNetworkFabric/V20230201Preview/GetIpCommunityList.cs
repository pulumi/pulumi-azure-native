...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    public static class GetIpCommunityList
    {
        ...
        public static Task<GetIpCommunityListResult> InvokeAsync(GetIpCommunityListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpCommunityListResult>("azure-native:managednetworkfabric/v20230201preview:getIpCommunityList", args ?? new GetIpCommunityListArgs(), options.WithDefaults());

        /// <summary>
        /// Implements Ip Community List GET method.
        /// </summary>
        public static Output<GetIpCommunityListResult> Invoke(GetIpCommunityListInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpCommunityListResult>("azure-native:managednetworkfabric/v20230201preview:getIpCommunityList", args ?? new GetIpCommunityListInvokeArgs(), options.WithDefaults());
    }
