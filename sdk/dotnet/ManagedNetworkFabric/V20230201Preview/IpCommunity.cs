...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230201preview:IpCommunity")]
    public partial class IpCommunity : global::Pulumi.CustomResource
    {
        ...
        public IpCommunity(string name, IpCommunityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:IpCommunity", name, args ?? new IpCommunityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpCommunity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230201preview:IpCommunity", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:managednetworkfabric:IpCommunity"},
    ...
    public sealed class IpCommunityArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview.WellKnownCommunities>>? _wellKnownCommunities;

        /// <summary>
        /// Supported well known Community List.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview.WellKnownCommunities>> WellKnownCommunities
        {
            get => _wellKnownCommunities ?? (_wellKnownCommunities = new InputList<Union<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230201Preview.WellKnownCommunities>>());
