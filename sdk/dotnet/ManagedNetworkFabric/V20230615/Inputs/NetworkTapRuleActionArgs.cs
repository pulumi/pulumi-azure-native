...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615.Inputs
{
    ...
    public sealed class NetworkTapRuleActionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230615.BooleanEnumProperty>? IsTimestampEnabled { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230615.TapRuleActionType>? Type { get; set; }
