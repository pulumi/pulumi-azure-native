...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    public static class GetNetworkTapRule
    {
        ...
        public static Task<GetNetworkTapRuleResult> InvokeAsync(GetNetworkTapRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkTapRuleResult>("azure-native:managednetworkfabric/v20230615:getNetworkTapRule", args ?? new GetNetworkTapRuleArgs(), options.WithDefaults());
