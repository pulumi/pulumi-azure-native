...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:IpExtendedCommunity")]
    public partial class IpExtendedCommunity : global::Pulumi.CustomResource
    {
        ...
        public IpExtendedCommunity(string name, IpExtendedCommunityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:IpExtendedCommunity", name, args ?? new IpExtendedCommunityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpExtendedCommunity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:IpExtendedCommunity", name, null, MakeResourceOptions(options, id))
        {
        }
