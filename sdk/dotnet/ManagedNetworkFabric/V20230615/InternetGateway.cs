...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:InternetGateway")]
    public partial class InternetGateway : global::Pulumi.CustomResource
    {
        ...
        public InternetGateway(string name, InternetGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:InternetGateway", name, args ?? new InternetGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InternetGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:InternetGateway", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:managednetworkfabric:InternetGateway"},
                },
            };
    ...
    public sealed class InternetGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230615.GatewayType> Type { get; set; } = null!;
