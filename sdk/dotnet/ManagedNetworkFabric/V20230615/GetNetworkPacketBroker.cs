...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    public static class GetNetworkPacketBroker
    {
        ...
        public static Task<GetNetworkPacketBrokerResult> InvokeAsync(GetNetworkPacketBrokerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkPacketBrokerResult>("azure-native:managednetworkfabric/v20230615:getNetworkPacketBroker", args ?? new GetNetworkPacketBrokerArgs(), options.WithDefaults());
