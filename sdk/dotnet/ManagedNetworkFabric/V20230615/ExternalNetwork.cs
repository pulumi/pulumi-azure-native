...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:ExternalNetwork")]
    public partial class ExternalNetwork : global::Pulumi.CustomResource
    {
        ...
        public ExternalNetwork(string name, ExternalNetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:ExternalNetwork", name, args ?? new ExternalNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExternalNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:ExternalNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
