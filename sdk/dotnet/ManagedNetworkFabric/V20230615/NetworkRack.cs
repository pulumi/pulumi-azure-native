...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:NetworkRack")]
    public partial class NetworkRack : global::Pulumi.CustomResource
    {
        ...
        public NetworkRack(string name, NetworkRackArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:NetworkRack", name, args ?? new NetworkRackArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkRack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:NetworkRack", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkRackArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230615.NetworkRackType>? NetworkRackType { get; set; }
