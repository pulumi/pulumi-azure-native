...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    public static class GetNetworkRack
    {
        ...
        public static Task<GetNetworkRackResult> InvokeAsync(GetNetworkRackArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkRackResult>("azure-native:managednetworkfabric/v20230615:getNetworkRack", args ?? new GetNetworkRackArgs(), options.WithDefaults());
