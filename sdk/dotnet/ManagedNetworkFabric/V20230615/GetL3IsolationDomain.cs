...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    public static class GetL3IsolationDomain
    {
        ...
        public static Task<GetL3IsolationDomainResult> InvokeAsync(GetL3IsolationDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetL3IsolationDomainResult>("azure-native:managednetworkfabric/v20230615:getL3IsolationDomain", args ?? new GetL3IsolationDomainArgs(), options.WithDefaults());
