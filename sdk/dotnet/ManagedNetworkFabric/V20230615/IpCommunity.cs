...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:IpCommunity")]
    public partial class IpCommunity : global::Pulumi.CustomResource
    {
        ...
        public IpCommunity(string name, IpCommunityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:IpCommunity", name, args ?? new IpCommunityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpCommunity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:IpCommunity", name, null, MakeResourceOptions(options, id))
        {
        }
