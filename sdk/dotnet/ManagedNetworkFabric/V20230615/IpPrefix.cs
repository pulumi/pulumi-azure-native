...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:IpPrefix")]
    public partial class IpPrefix : global::Pulumi.CustomResource
    {
        ...
        public IpPrefix(string name, IpPrefixArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:IpPrefix", name, args ?? new IpPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpPrefix(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:IpPrefix", name, null, MakeResourceOptions(options, id))
        {
        }
