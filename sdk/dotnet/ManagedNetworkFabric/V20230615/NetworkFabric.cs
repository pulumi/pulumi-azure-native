...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:NetworkFabric")]
    public partial class NetworkFabric : global::Pulumi.CustomResource
    {
        ...
        public NetworkFabric(string name, NetworkFabricArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:NetworkFabric", name, args ?? new NetworkFabricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkFabric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:NetworkFabric", name, null, MakeResourceOptions(options, id))
        {
        }
