...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    public static class GetL2IsolationDomain
    {
        ...
        public static Task<GetL2IsolationDomainResult> InvokeAsync(GetL2IsolationDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetL2IsolationDomainResult>("azure-native:managednetworkfabric/v20230615:getL2IsolationDomain", args ?? new GetL2IsolationDomainArgs(), options.WithDefaults());

        /// <summary>
        /// Implements L2 Isolation Domain GET method.
        /// </summary>
        public static Output<GetL2IsolationDomainResult> Invoke(GetL2IsolationDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetL2IsolationDomainResult>("azure-native:managednetworkfabric/v20230615:getL2IsolationDomain", args ?? new GetL2IsolationDomainInvokeArgs(), options.WithDefaults());
