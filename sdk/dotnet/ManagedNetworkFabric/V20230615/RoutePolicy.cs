...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:RoutePolicy")]
    public partial class RoutePolicy : global::Pulumi.CustomResource
    {
        ...
        public RoutePolicy(string name, RoutePolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:RoutePolicy", name, args ?? new RoutePolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RoutePolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:RoutePolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RoutePolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230615.AddressFamilyType>? AddressFamilyType { get; set; }
