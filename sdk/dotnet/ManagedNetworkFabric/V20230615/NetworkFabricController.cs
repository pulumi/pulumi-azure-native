...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:NetworkFabricController")]
    public partial class NetworkFabricController : global::Pulumi.CustomResource
    {
        ...
        public NetworkFabricController(string name, NetworkFabricControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:NetworkFabricController", name, args ?? new NetworkFabricControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkFabricController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:NetworkFabricController", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:managednetworkfabric:NetworkFabricController" },
    ...
    public sealed class NetworkFabricControllerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230615.IsWorkloadManagementNetworkEnabled>? IsWorkloadManagementNetworkEnabled { get; set; }
        ...
        /// </summary>
        [Input("nfcSku")]
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230615.NfcSku>? NfcSku { get; set; }
