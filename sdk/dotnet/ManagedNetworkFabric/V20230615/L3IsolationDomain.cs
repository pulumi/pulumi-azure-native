...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:managednetworkfabric/v20230615:L3IsolationDomain")]
    public partial class L3IsolationDomain : global::Pulumi.CustomResource
    {
        ...
        public L3IsolationDomain(string name, L3IsolationDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:L3IsolationDomain", name, args ?? new L3IsolationDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private L3IsolationDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric/v20230615:L3IsolationDomain", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:managednetworkfabric:L3IsolationDomain"},
    ...
    public sealed class L3IsolationDomainArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230615.RedistributeConnectedSubnets>? RedistributeConnectedSubnets { get; set; }

        /// <summary>
        /// Advertise Static Routes. Ex: "True" | "False".
        /// </summary>
        [Input("redistributeStaticRoutes")]
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.V20230615.RedistributeStaticRoutes>? RedistributeStaticRoutes { get; set; }
