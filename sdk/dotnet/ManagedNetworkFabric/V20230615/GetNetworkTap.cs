...
namespace Pulumi.AzureNative.ManagedNetworkFabric.V20230615
{
    public static class GetNetworkTap
    {
        ...
        public static Task<GetNetworkTapResult> InvokeAsync(GetNetworkTapArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkTapResult>("azure-native:managednetworkfabric/v20230615:getNetworkTap", args ?? new GetNetworkTapArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves details of this Network Tap.
        /// </summary>
        public static Output<GetNetworkTapResult> Invoke(GetNetworkTapInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkTapResult>("azure-native:managednetworkfabric/v20230615:getNetworkTap", args ?? new GetNetworkTapInvokeArgs(), options.WithDefaults());
