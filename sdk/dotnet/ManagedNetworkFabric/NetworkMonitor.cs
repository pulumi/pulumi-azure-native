...
namespace Pulumi.AzureNative.ManagedNetworkFabric
{
    ...
    public partial class NetworkMonitor : global::Pulumi.CustomResource
    {
        ...
        public NetworkMonitor(string name, NetworkMonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric:NetworkMonitor", name, args ?? new NetworkMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkMonitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric:NetworkMonitor", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkMonitor Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new NetworkMonitor(name, id, options);
        }
    }
