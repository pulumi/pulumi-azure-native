...
namespace Pulumi.AzureNative.ManagedNetworkFabric
{
    ...
    public partial class NetworkTap : global::Pulumi.CustomResource
    {
        ...
        public NetworkTap(string name, NetworkTapArgs args, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric:NetworkTap", name, args ?? new NetworkTapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkTap(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:managednetworkfabric:NetworkTap", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:managednetworkfabric/v20240215preview:NetworkTap" },
                    new global::Pulumi.Alias { Type = "azure-native:managednetworkfabric/v20240615preview:NetworkTap" },
                    new global::Pulumi.Alias { Type = "azure-native:managednetworkfabric/v20250715:NetworkTap" },
                },
            };
    ...
    public sealed class NetworkTapArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("pollingType")]
        public InputUnion<string, Pulumi.AzureNative.ManagedNetworkFabric.PollingType>? PollingType { get; set; }
