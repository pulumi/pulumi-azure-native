...
namespace Pulumi.AzureNative.VirtualMachineImages.V20190501Preview
{
    ...
    /// </summary>
    [Obsolete(@"Version v20190501preview will be removed in the next major version of the provider. Upgrade to version v20200214 or later.")]
    ...
    public partial class VirtualMachineImageTemplate : Pulumi.CustomResource
    {
        ...
        public VirtualMachineImageTemplate(string name, VirtualMachineImageTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20190501preview:VirtualMachineImageTemplate", name, args ?? new VirtualMachineImageTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineImageTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20190501preview:VirtualMachineImageTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
