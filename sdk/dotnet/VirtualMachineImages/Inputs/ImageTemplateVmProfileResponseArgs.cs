...
namespace Pulumi.AzureRM.VirtualMachineImages.Inputs
{
    ...
    /// </summary>
    public sealed class ImageTemplateVmProfileResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("vnetConfig")]
        public Input<Inputs.VirtualNetworkConfigResponseArgs>? VnetConfig { get; set; }

        public ImageTemplateVmProfileResponseArgs()
        {
        }
    }
}
