...
namespace Pulumi.AzureRM.VirtualMachineImages.V20200214
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualMachineImageTemplate = new AzureRM.VirtualMachineImages.V20200214.VirtualMachineImageTemplate("virtualMachineImageTemplate", new AzureRM.VirtualMachineImages.V20200214.VirtualMachineImageTemplateArgs
    ///         {
    ///             Customize = 
    ///             {
    ...
    ///             },
    ///             VmProfile = new AzureRM.VirtualMachineImages.V20200214.Inputs.ImageTemplateVmProfileArgs
    ///             {
    ///                 OsDiskSizeGB = 64,
    ///                 VmSize = "Standard_D2s_v3",
    ///                 VnetConfig = new AzureRM.VirtualMachineImages.V20200214.Inputs.VirtualNetworkConfigArgs
    ///                 {
    ...
    public partial class VirtualMachineImageTemplate : Pulumi.CustomResource
    {
        ...
        public VirtualMachineImageTemplate(string name, VirtualMachineImageTemplateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:virtualmachineimages/v20200214:VirtualMachineImageTemplate", name, args ?? new VirtualMachineImageTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineImageTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:virtualmachineimages/v20200214:VirtualMachineImageTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
