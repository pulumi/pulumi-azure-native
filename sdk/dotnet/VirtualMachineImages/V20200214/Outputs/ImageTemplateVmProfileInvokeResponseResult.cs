...
namespace Pulumi.AzureNextGen.VirtualMachineImages.V20200214.Outputs
{
    ...
    [OutputType]
    public sealed class ImageTemplateVmProfileInvokeResponseResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.VirtualNetworkConfigInvokeResponseResult? VnetConfig;

        [OutputConstructor]
        private ImageTemplateVmProfileInvokeResponseResult(
            int? osDiskSizeGB,

            string? vmSize,

            Outputs.VirtualNetworkConfigInvokeResponseResult? vnetConfig)
        {
