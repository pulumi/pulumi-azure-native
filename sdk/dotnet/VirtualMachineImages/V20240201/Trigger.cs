...
namespace Pulumi.AzureNative.VirtualMachineImages.V20240201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:virtualmachineimages/v20240201:Trigger")]
    public partial class Trigger : global::Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20240201:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20240201:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
