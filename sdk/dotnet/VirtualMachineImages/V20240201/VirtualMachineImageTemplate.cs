...
namespace Pulumi.AzureNative.VirtualMachineImages.V20240201
{
    /// <summary>
    /// Image template is an ARM resource managed by Microsoft.VirtualMachineImages provider
    /// </summary>
    [AzureNativeResourceType("azure-native:virtualmachineimages/v20240201:VirtualMachineImageTemplate")]
    public partial class VirtualMachineImageTemplate : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineImageTemplate(string name, VirtualMachineImageTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20240201:VirtualMachineImageTemplate", name, args ?? new VirtualMachineImageTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineImageTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20240201:VirtualMachineImageTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
