...
namespace Pulumi.AzureRM.VirtualMachineImages.Preview
{
    public static class GetVirtualMachineImageTemplate
    {
        public static Task<GetVirtualMachineImageTemplateResult> InvokeAsync(GetVirtualMachineImageTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualMachineImageTemplateResult>("azurerm:virtualmachineimages/preview:getVirtualMachineImageTemplate", args ?? new GetVirtualMachineImageTemplateArgs(), options.WithVersion());
    }
