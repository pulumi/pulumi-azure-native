...
namespace Pulumi.AzureNative.VirtualMachineImages.V20230701
{
    public static class GetTrigger
    {
        ...
        public static Task<GetTriggerResult> InvokeAsync(GetTriggerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTriggerResult>("azure-native:virtualmachineimages/v20230701:getTrigger", args ?? new GetTriggerArgs(), options.WithDefaults());
