...
namespace Pulumi.AzureNative.VirtualMachineImages.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:virtualmachineimages/v20230701:VirtualMachineImageTemplate")]
    public partial class VirtualMachineImageTemplate : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineImageTemplate(string name, VirtualMachineImageTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20230701:VirtualMachineImageTemplate", name, args ?? new VirtualMachineImageTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineImageTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20230701:VirtualMachineImageTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
