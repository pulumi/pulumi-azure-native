...
namespace Pulumi.AzureNative.VirtualMachineImages.V20211001
{
    ...
    public partial class VirtualMachineImageTemplate : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineImageTemplate(string name, VirtualMachineImageTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20211001:VirtualMachineImageTemplate", name, args ?? new VirtualMachineImageTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineImageTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:virtualmachineimages/v20211001:VirtualMachineImageTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
