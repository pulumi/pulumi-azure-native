...
namespace Pulumi.AzureNative.VirtualMachineImages.V20220701
{
    public static class GetTrigger
    {
        ...
        public static Task<GetTriggerResult> InvokeAsync(GetTriggerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTriggerResult>("azure-native:virtualmachineimages/v20220701:getTrigger", args ?? new GetTriggerArgs(), options.WithDefaults());

        /// <summary>
        /// Get the specified trigger for the specified image template resource
        /// </summary>
        public static Output<GetTriggerResult> Invoke(GetTriggerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTriggerResult>("azure-native:virtualmachineimages/v20220701:getTrigger", args ?? new GetTriggerInvokeArgs(), options.WithDefaults());
