...
namespace Pulumi.AzureNative.Elastic.V20250115Preview
{
    public static class GetOpenAI
    {
        ...
        public static Task<GetOpenAIResult> InvokeAsync(GetOpenAIArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOpenAIResult>("azure-native:elastic/v20250115preview:getOpenAI", args ?? new GetOpenAIArgs(), options.WithDefaults());

        /// <summary>
        /// Capture properties of Open AI resource Integration.
        /// </summary>
        public static Output<GetOpenAIResult> Invoke(GetOpenAIInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOpenAIResult>("azure-native:elastic/v20250115preview:getOpenAI", args ?? new GetOpenAIInvokeArgs(), options.WithDefaults());
