...
namespace Pulumi.AzureNative.Elastic.V20250115Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elastic/v20250115preview:OpenAI")]
    public partial class OpenAI : global::Pulumi.CustomResource
    {
        ...
        public OpenAI(string name, OpenAIArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20250115preview:OpenAI", name, args ?? new OpenAIArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenAI(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20250115preview:OpenAI", name, null, MakeResourceOptions(options, id))
        {
        }
