...
namespace Pulumi.AzureNative.Elastic.V20220701Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:elastic/v20220701preview:TagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20230615preview:TagRule to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:elastic/v20220701preview:TagRule")]
    public partial class TagRule : global::Pulumi.CustomResource
    {
        ...
        public TagRule(string name, TagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20220701preview:TagRule", name, args ?? new TagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20220701preview:TagRule", name, null, MakeResourceOptions(options, id))
        {
        }
