...
{
    [Obsolete(@"azure-native:elastic/v20220701preview:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20230615preview:Monitor to guarantee forwards compatibility.")]
    public static class GetMonitor
    {
        ...
        public static Task<GetMonitorResult> InvokeAsync(GetMonitorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMonitorResult>("azure-native:elastic/v20220701preview:getMonitor", args ?? new GetMonitorArgs(), options.WithDefaults());

        /// <summary>
        /// Monitor resource.
        /// </summary>
        public static Output<GetMonitorResult> Invoke(GetMonitorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMonitorResult>("azure-native:elastic/v20220701preview:getMonitor", args ?? new GetMonitorInvokeArgs(), options.WithDefaults());
    }
