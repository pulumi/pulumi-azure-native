...
namespace Pulumi.AzureNative.Elastic.V20240615Preview
{
    public static class GetOrganizationApiKey
    {
        ...
        public static Task<GetOrganizationApiKeyResult> InvokeAsync(GetOrganizationApiKeyArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOrganizationApiKeyResult>("azure-native:elastic/v20240615preview:getOrganizationApiKey", args ?? new GetOrganizationApiKeyArgs(), options.WithDefaults());
        ...
        public static Output<GetOrganizationApiKeyResult> Invoke(GetOrganizationApiKeyInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrganizationApiKeyResult>("azure-native:elastic/v20240615preview:getOrganizationApiKey", args ?? new GetOrganizationApiKeyInvokeArgs(), options.WithDefaults());
    }
