...
namespace Pulumi.AzureNative.Elastic.V20240615Preview
{
    public static class GetBillingInfo
    {
        ...
        public static Task<GetBillingInfoResult> InvokeAsync(GetBillingInfoArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBillingInfoResult>("azure-native:elastic/v20240615preview:getBillingInfo", args ?? new GetBillingInfoArgs(), options.WithDefaults());
