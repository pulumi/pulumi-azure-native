...
namespace Pulumi.AzureNative.Elastic.V20241001Preview
{
    public static class GetMonitor
    {
        ...
        public static Task<GetMonitorResult> InvokeAsync(GetMonitorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMonitorResult>("azure-native:elastic/v20241001preview:getMonitor", args ?? new GetMonitorArgs(), options.WithDefaults());

        /// <summary>
        /// Monitor resource.
        /// </summary>
        public static Output<GetMonitorResult> Invoke(GetMonitorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMonitorResult>("azure-native:elastic/v20241001preview:getMonitor", args ?? new GetMonitorInvokeArgs(), options.WithDefaults());
