...
namespace Pulumi.AzureNative.Elastic.V20241001Preview
{
    public static class GetOpenAIStatus
    {
        ...
        public static Task<GetOpenAIStatusResult> InvokeAsync(GetOpenAIStatusArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOpenAIStatusResult>("azure-native:elastic/v20241001preview:getOpenAIStatus", args ?? new GetOpenAIStatusArgs(), options.WithDefaults());

        /// <summary>
        /// Status of the OpenAI Integration
        /// </summary>
        public static Output<GetOpenAIStatusResult> Invoke(GetOpenAIStatusInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOpenAIStatusResult>("azure-native:elastic/v20241001preview:getOpenAIStatus", args ?? new GetOpenAIStatusInvokeArgs(), options.WithDefaults());
    }
