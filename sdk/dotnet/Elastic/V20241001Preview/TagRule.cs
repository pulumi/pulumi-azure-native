...
namespace Pulumi.AzureNative.Elastic.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elastic/v20241001preview:TagRule")]
    public partial class TagRule : global::Pulumi.CustomResource
    {
        ...
        public TagRule(string name, TagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20241001preview:TagRule", name, args ?? new TagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20241001preview:TagRule", name, null, MakeResourceOptions(options, id))
        {
        }
