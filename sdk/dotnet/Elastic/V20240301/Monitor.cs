...
namespace Pulumi.AzureNative.Elastic.V20240301
{
    ...
    /// Monitor resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:elastic/v20240301:Monitor")]
    public partial class Monitor : global::Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20240301:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20240301:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
