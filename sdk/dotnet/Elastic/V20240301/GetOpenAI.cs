...
namespace Pulumi.AzureNative.Elastic.V20240301
{
    public static class GetOpenAI
    {
        ...
        public static Task<GetOpenAIResult> InvokeAsync(GetOpenAIArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOpenAIResult>("azure-native:elastic/v20240301:getOpenAI", args ?? new GetOpenAIArgs(), options.WithDefaults());

        /// <summary>
        /// Capture properties of Open AI resource Integration.
        /// </summary>
        public static Output<GetOpenAIResult> Invoke(GetOpenAIInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOpenAIResult>("azure-native:elastic/v20240301:getOpenAI", args ?? new GetOpenAIInvokeArgs(), options.WithDefaults());
