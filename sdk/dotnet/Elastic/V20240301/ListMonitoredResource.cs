...
namespace Pulumi.AzureNative.Elastic.V20240301
{
    public static class ListMonitoredResource
    {
        ...
        public static Task<ListMonitoredResourceResult> InvokeAsync(ListMonitoredResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListMonitoredResourceResult>("azure-native:elastic/v20240301:listMonitoredResource", args ?? new ListMonitoredResourceArgs(), options.WithDefaults());
