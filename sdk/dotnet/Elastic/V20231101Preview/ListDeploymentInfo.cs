...
namespace Pulumi.AzureNative.Elastic.V20231101Preview
{
    public static class ListDeploymentInfo
    {
        ...
        public static Task<ListDeploymentInfoResult> InvokeAsync(ListDeploymentInfoArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListDeploymentInfoResult>("azure-native:elastic/v20231101preview:listDeploymentInfo", args ?? new ListDeploymentInfoArgs(), options.WithDefaults());

        /// <summary>
        /// The properties of deployment in Elastic cloud corresponding to the Elastic monitor resource.
        /// </summary>
        public static Output<ListDeploymentInfoResult> Invoke(ListDeploymentInfoInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListDeploymentInfoResult>("azure-native:elastic/v20231101preview:listDeploymentInfo", args ?? new ListDeploymentInfoInvokeArgs(), options.WithDefaults());
