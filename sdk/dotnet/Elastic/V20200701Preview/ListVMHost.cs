...
namespace Pulumi.AzureNative.Elastic.V20200701Preview
{
    public static class ListVMHost
    {
        ...
        public static Task<ListVMHostResult> InvokeAsync(ListVMHostArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListVMHostResult>("azure-native:elastic/v20200701preview:listVMHost", args ?? new ListVMHostArgs(), options.WithDefaults());

        /// <summary>
        /// Response of a list operation.
        /// </summary>
        public static Output<ListVMHostResult> Invoke(ListVMHostInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListVMHostResult>("azure-native:elastic/v20200701preview:listVMHost", args ?? new ListVMHostInvokeArgs(), options.WithDefaults());
    }
