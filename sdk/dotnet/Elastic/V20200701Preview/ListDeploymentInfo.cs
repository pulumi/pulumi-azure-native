...
namespace Pulumi.AzureNative.Elastic.V20200701Preview
{
    public static class ListDeploymentInfo
    {
        ...
        public static Task<ListDeploymentInfoResult> InvokeAsync(ListDeploymentInfoArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListDeploymentInfoResult>("azure-native:elastic/v20200701preview:listDeploymentInfo", args ?? new ListDeploymentInfoArgs(), options.WithDefaults());

        /// <summary>
        /// The properties of deployment in Elastic cloud corresponding to the Elastic monitor resource.
        /// </summary>
        public static Output<ListDeploymentInfoResult> Invoke(ListDeploymentInfoInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListDeploymentInfoResult>("azure-native:elastic/v20200701preview:listDeploymentInfo", args ?? new ListDeploymentInfoInvokeArgs(), options.WithDefaults());
    }
