...
namespace Pulumi.AzureNative.Elastic.V20220901Preview
{
    ...
    /// {
    ///     var tagRule = new AzureNative.Elastic.V20220901Preview.TagRule("tagRule", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:elastic/v20220901preview:TagRule")]
    public partial class TagRule : global::Pulumi.CustomResource
    {
        ...
        public TagRule(string name, TagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20220901preview:TagRule", name, args ?? new TagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20220901preview:TagRule", name, null, MakeResourceOptions(options, id))
        {
        }
