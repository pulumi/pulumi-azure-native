...
namespace Pulumi.AzureNative.Elastic.V20220901Preview
{
    public static class ListListAssociatedTrafficFilter
    {
        ...
        public static Task<ListListAssociatedTrafficFilterResult> InvokeAsync(ListListAssociatedTrafficFilterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListListAssociatedTrafficFilterResult>("azure-native:elastic/v20220901preview:listListAssociatedTrafficFilter", args ?? new ListListAssociatedTrafficFilterArgs(), options.WithDefaults());
        ...
        public static Output<ListListAssociatedTrafficFilterResult> Invoke(ListListAssociatedTrafficFilterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListListAssociatedTrafficFilterResult>("azure-native:elastic/v20220901preview:listListAssociatedTrafficFilter", args ?? new ListListAssociatedTrafficFilterInvokeArgs(), options.WithDefaults());
