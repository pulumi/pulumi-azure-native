...
namespace Pulumi.AzureNative.Elastic.V20200701
{
    ...
    /// {
    ///     var monitor = new AzureNative.Elastic.V20200701.Monitor("monitor", new()
    ///     {
    ...
    public partial class Monitor : global::Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20200701:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20200701:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
