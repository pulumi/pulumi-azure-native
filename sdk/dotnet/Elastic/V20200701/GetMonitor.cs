...
namespace Pulumi.AzureNative.Elastic.V20200701
{
    public static class GetMonitor
    {
        ...
        public static Task<GetMonitorResult> InvokeAsync(GetMonitorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMonitorResult>("azure-native:elastic/v20200701:getMonitor", args ?? new GetMonitorArgs(), options.WithDefaults());

        /// <summary>
        /// Monitor resource.
        /// </summary>
        public static Output<GetMonitorResult> Invoke(GetMonitorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMonitorResult>("azure-native:elastic/v20200701:getMonitor", args ?? new GetMonitorInvokeArgs(), options.WithDefaults());
    }
