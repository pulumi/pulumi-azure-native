...
namespace Pulumi.AzureNative.Elastic.V20231001Preview
{
    public static class ListlistAssociatedTrafficFilter
    {
        ...
        public static Task<ListlistAssociatedTrafficFilterResult> InvokeAsync(ListlistAssociatedTrafficFilterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListlistAssociatedTrafficFilterResult>("azure-native:elastic/v20231001preview:listlistAssociatedTrafficFilter", args ?? new ListlistAssociatedTrafficFilterArgs(), options.WithDefaults());
        ...
        public static Output<ListlistAssociatedTrafficFilterResult> Invoke(ListlistAssociatedTrafficFilterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListlistAssociatedTrafficFilterResult>("azure-native:elastic/v20231001preview:listlistAssociatedTrafficFilter", args ?? new ListlistAssociatedTrafficFilterInvokeArgs(), options.WithDefaults());
    }
