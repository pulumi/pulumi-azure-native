...
namespace Pulumi.AzureNative.Elastic.V20211001Preview
{
    ...
    /// Monitor resource.
    /// </summary>
    [Obsolete(@"azure-native:elastic/v20211001preview:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20220901preview:Monitor to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:elastic/v20211001preview:Monitor")]
    public partial class Monitor : global::Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20211001preview:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20211001preview:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
