...
namespace Pulumi.AzureNative.Elastic.V20230201Preview
{
    ...
    /// Monitor resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:elastic/v20230201preview:Monitor")]
    public partial class Monitor : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Flag to determine if User API Key has to be generated and shared.
        /// </summary>
        [Output("generateApiKey")]
        public Output<bool> GenerateApiKey { get; private set; } = null!;
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20230201preview:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20230201preview:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
