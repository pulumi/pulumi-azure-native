...
namespace Pulumi.AzureNative.Elastic.V20230201Preview
{
    ...
    /// {
    ///     var tagRule = new AzureNative.Elastic.V20230201Preview.TagRule("tagRule", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:elastic/v20230201preview:TagRule default /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Datadog/monitors/myMonitor/tagRules/default 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:elastic/v20230201preview:TagRule")]
    public partial class TagRule : global::Pulumi.CustomResource
    {
        ...
        public TagRule(string name, TagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20230201preview:TagRule", name, args ?? new TagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20230201preview:TagRule", name, null, MakeResourceOptions(options, id))
        {
        }
