...
namespace Pulumi.AzureNative.Elastic.V20230501Preview
{
    public static class GetTagRule
    {
        ...
        public static Task<GetTagRuleResult> InvokeAsync(GetTagRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagRuleResult>("azure-native:elastic/v20230501preview:getTagRule", args ?? new GetTagRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Capture logs and metrics of Azure resources based on ARM tags.
        /// </summary>
        public static Output<GetTagRuleResult> Invoke(GetTagRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTagRuleResult>("azure-native:elastic/v20230501preview:getTagRule", args ?? new GetTagRuleInvokeArgs(), options.WithDefaults());
    }
