...
namespace Pulumi.AzureNative.Elastic.V20230501Preview
{
    ...
    /// Monitor resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:elastic/v20230501preview:Monitor")]
    public partial class Monitor : global::Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20230501preview:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20230501preview:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
