...
namespace Pulumi.AzureNative.Elastic.V20230615Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:elastic/v20230615preview:TagRule")]
    public partial class TagRule : global::Pulumi.CustomResource
    {
        ...
        public TagRule(string name, TagRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20230615preview:TagRule", name, args ?? new TagRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:elastic/v20230615preview:TagRule", name, null, MakeResourceOptions(options, id))
        {
        }
