...
namespace Pulumi.AzureNative.Elastic.V20240501Preview
{
    public static class GetTagRule
    {
        ...
        public static Task<GetTagRuleResult> InvokeAsync(GetTagRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagRuleResult>("azure-native:elastic/v20240501preview:getTagRule", args ?? new GetTagRuleArgs(), options.WithDefaults());
