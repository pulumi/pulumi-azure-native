...
namespace Pulumi.AzureNative.Elastic.V20240101Preview
{
    public static class ListVMHost
    {
        ...
        public static Task<ListVMHostResult> InvokeAsync(ListVMHostArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListVMHostResult>("azure-native:elastic/v20240101preview:listVMHost", args ?? new ListVMHostArgs(), options.WithDefaults());
