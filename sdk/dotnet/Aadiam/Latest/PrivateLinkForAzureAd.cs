...
namespace Pulumi.AzureRM.Aadiam.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateLinkForAzureAd = new AzureRM.Aadiam.Latest.PrivateLinkForAzureAd("privateLinkForAzureAd", new AzureRM.Aadiam.Latest.PrivateLinkForAzureAdArgs
    ///         {
    ///             AllTenants = false,
    ...
    public partial class PrivateLinkForAzureAd : Pulumi.CustomResource
    {
        ...
        public PrivateLinkForAzureAd(string name, PrivateLinkForAzureAdArgs args, CustomResourceOptions? options = null)
            : base("azurerm:aadiam/latest:privateLinkForAzureAd", name, args ?? new PrivateLinkForAzureAdArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkForAzureAd(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:aadiam/latest:privateLinkForAzureAd", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:aadiam/v20200301preview:privateLinkForAzureAd"},
                },
            };
