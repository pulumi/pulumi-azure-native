...
namespace Pulumi.AzureRM.Aadiam.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var azureADMetric = new AzureRM.Aadiam.Latest.AzureADMetric("azureADMetric", new AzureRM.Aadiam.Latest.AzureADMetricArgs
    ///         {
    ...
    public partial class AzureADMetric : Pulumi.CustomResource
    {
        ...
        public AzureADMetric(string name, AzureADMetricArgs args, CustomResourceOptions? options = null)
            : base("azurerm:aadiam/latest:azureADMetric", name, args ?? new AzureADMetricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureADMetric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:aadiam/latest:azureADMetric", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:aadiam/v20200701preview:azureADMetric"},
                },
            };
