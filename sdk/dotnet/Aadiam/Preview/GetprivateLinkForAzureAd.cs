...
namespace Pulumi.AzureRM.Aadiam.Preview
{
    public static class GetprivateLinkForAzureAd
    {
        public static Task<GetprivateLinkForAzureAdResult> InvokeAsync(GetprivateLinkForAzureAdArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetprivateLinkForAzureAdResult>("azurerm:aadiam/preview:getprivateLinkForAzureAd", args ?? new GetprivateLinkForAzureAdArgs(), options.WithVersion());
    }
