...
namespace Pulumi.AzureNative.HealthcareApis.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20211101:IotConnectorFhirDestination")]
    public partial class IotConnectorFhirDestination : global::Pulumi.CustomResource
    {
        ...
        public IotConnectorFhirDestination(string name, IotConnectorFhirDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20211101:IotConnectorFhirDestination", name, args ?? new IotConnectorFhirDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnectorFhirDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20211101:IotConnectorFhirDestination", name, null, MakeResourceOptions(options, id))
        {
        }
