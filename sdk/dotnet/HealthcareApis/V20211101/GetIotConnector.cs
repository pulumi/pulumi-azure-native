...
namespace Pulumi.AzureNative.HealthcareApis.V20211101
{
    ...
    public static class GetIotConnector
    {
        ...
        public static Task<GetIotConnectorResult> InvokeAsync(GetIotConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotConnectorResult>("azure-native:healthcareapis/v20211101:getIotConnector", args ?? new GetIotConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// IoT Connector definition.
        /// </summary>
        public static Output<GetIotConnectorResult> Invoke(GetIotConnectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIotConnectorResult>("azure-native:healthcareapis/v20211101:getIotConnector", args ?? new GetIotConnectorInvokeArgs(), options.WithDefaults());
    }
