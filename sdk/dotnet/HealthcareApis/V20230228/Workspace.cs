...
namespace Pulumi.AzureNative.HealthcareApis.V20230228
{
    ...
    /// {
    ///     var workspace = new AzureNative.HealthcareApis.V20230228.Workspace("workspace", new()
    ///     {
    ///         Location = "westus",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20230228:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20230228:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20230228:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
