...
namespace Pulumi.AzureNative.HealthcareApis.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20231201:IotConnectorFhirDestination")]
    public partial class IotConnectorFhirDestination : global::Pulumi.CustomResource
    {
        ...
        public IotConnectorFhirDestination(string name, IotConnectorFhirDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231201:IotConnectorFhirDestination", name, args ?? new IotConnectorFhirDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnectorFhirDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231201:IotConnectorFhirDestination", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IotConnectorFhirDestinationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.HealthcareApis.V20231201.IotIdentityResolutionType> ResourceIdentityResolutionType { get; set; } = null!;
