...
namespace Pulumi.AzureNative.HealthcareApis.V20231201
{
    ...
    /// Workspace resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20231201:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231201:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231201:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
