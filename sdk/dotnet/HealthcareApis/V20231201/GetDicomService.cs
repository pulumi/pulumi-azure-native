...
namespace Pulumi.AzureNative.HealthcareApis.V20231201
{
    public static class GetDicomService
    {
        ...
        public static Task<GetDicomServiceResult> InvokeAsync(GetDicomServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDicomServiceResult>("azure-native:healthcareapis/v20231201:getDicomService", args ?? new GetDicomServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified DICOM Service.
        /// </summary>
        public static Output<GetDicomServiceResult> Invoke(GetDicomServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDicomServiceResult>("azure-native:healthcareapis/v20231201:getDicomService", args ?? new GetDicomServiceInvokeArgs(), options.WithDefaults());
