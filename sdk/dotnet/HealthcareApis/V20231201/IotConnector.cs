...
namespace Pulumi.AzureNative.HealthcareApis.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20231201:IotConnector")]
    public partial class IotConnector : global::Pulumi.CustomResource
    {
        ...
        public IotConnector(string name, IotConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231201:IotConnector", name, args ?? new IotConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231201:IotConnector", name, null, MakeResourceOptions(options, id))
        {
        }
