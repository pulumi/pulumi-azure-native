...
namespace Pulumi.AzureNative.HealthcareApis.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20231201:WorkspacePrivateEndpointConnection")]
    public partial class WorkspacePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public WorkspacePrivateEndpointConnection(string name, WorkspacePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231201:WorkspacePrivateEndpointConnection", name, args ?? new WorkspacePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspacePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231201:WorkspacePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
