...
namespace Pulumi.AzureNative.HealthcareApis.V20190916
{
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20190916:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20190916:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.HealthcareApis.V20190916.Kind> Kind { get; set; } = null!;
