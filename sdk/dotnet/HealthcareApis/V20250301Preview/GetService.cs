...
namespace Pulumi.AzureNative.HealthcareApis.V20250301Preview
{
    public static class GetService
    {
        ...
        public static Task<GetServiceResult> InvokeAsync(GetServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServiceResult>("azure-native:healthcareapis/v20250301preview:getService", args ?? new GetServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Get the metadata of a service instance.
        /// </summary>
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServiceResult>("azure-native:healthcareapis/v20250301preview:getService", args ?? new GetServiceInvokeArgs(), options.WithDefaults());
