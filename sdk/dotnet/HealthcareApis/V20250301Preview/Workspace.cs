...
namespace Pulumi.AzureNative.HealthcareApis.V20250301Preview
{
    ...
    /// Workspace resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20250301preview:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20250301preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20250301preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
