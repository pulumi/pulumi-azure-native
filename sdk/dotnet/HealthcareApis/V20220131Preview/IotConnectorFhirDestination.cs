...
namespace Pulumi.AzureNative.HealthcareApis.V20220131Preview
{
    ...
    public partial class IotConnectorFhirDestination : global::Pulumi.CustomResource
    {
        ...
        public IotConnectorFhirDestination(string name, IotConnectorFhirDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220131preview:IotConnectorFhirDestination", name, args ?? new IotConnectorFhirDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnectorFhirDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220131preview:IotConnectorFhirDestination", name, null, MakeResourceOptions(options, id))
        {
        }
