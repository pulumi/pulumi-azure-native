...
namespace Pulumi.AzureNative.HealthcareApis.V20220131Preview
{
    ...
    public partial class FhirService : global::Pulumi.CustomResource
    {
        ...
        public FhirService(string name, FhirServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220131preview:FhirService", name, args ?? new FhirServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FhirService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220131preview:FhirService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FhirServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.HealthcareApis.V20220131Preview.FhirServiceKind>? Kind { get; set; }
