...
{
    [Obsolete(@"azure-native:healthcareapis/v20220131preview:FhirService is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20221201:FhirService to guarantee forwards compatibility.")]
    public static class GetFhirService
    {
        ...
        public static Task<GetFhirServiceResult> InvokeAsync(GetFhirServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFhirServiceResult>("azure-native:healthcareapis/v20220131preview:getFhirService", args ?? new GetFhirServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified FHIR Service.
        /// </summary>
        public static Output<GetFhirServiceResult> Invoke(GetFhirServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFhirServiceResult>("azure-native:healthcareapis/v20220131preview:getFhirService", args ?? new GetFhirServiceInvokeArgs(), options.WithDefaults());
    }
