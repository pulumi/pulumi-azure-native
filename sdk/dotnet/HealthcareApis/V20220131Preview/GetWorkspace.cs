...
namespace Pulumi.AzureNative.HealthcareApis.V20220131Preview
{
    public static class GetWorkspace
    {
        ...
        public static Task<GetWorkspaceResult> InvokeAsync(GetWorkspaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceResult>("azure-native:healthcareapis/v20220131preview:getWorkspace", args ?? new GetWorkspaceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified workspace.
        /// </summary>
        public static Output<GetWorkspaceResult> Invoke(GetWorkspaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceResult>("azure-native:healthcareapis/v20220131preview:getWorkspace", args ?? new GetWorkspaceInvokeArgs(), options.WithDefaults());
