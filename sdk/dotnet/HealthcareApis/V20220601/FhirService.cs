...
namespace Pulumi.AzureNative.HealthcareApis.V20220601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:healthcareapis/v20220601:FhirService is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:FhirService to guarantee forwards compatibility.")]
    ...
    public partial class FhirService : global::Pulumi.CustomResource
    {
        ...
        public FhirService(string name, FhirServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220601:FhirService", name, args ?? new FhirServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FhirService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220601:FhirService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FhirServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.HealthcareApis.V20220601.FhirServiceKind>? Kind { get; set; }
