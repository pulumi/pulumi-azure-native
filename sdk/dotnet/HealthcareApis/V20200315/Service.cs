...
namespace Pulumi.AzureNative.HealthcareApis.V20200315
{
    ...
    /// {
    ///     var service = new AzureNative.HealthcareApis.V20200315.Service("service", new()
    ///     {
    ///         Identity = new AzureNative.HealthcareApis.V20200315.Inputs.ResourceIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Kind = AzureNative.HealthcareApis.V20200315.Kind.Fhir_R4,
    ///         Location = "westus2",
    ///         Properties = new AzureNative.HealthcareApis.V20200315.Inputs.ServicesPropertiesArgs
    ///         {
    ///             AccessPolicies = new[]
    ///             {
    ///                 new AzureNative.HealthcareApis.V20200315.Inputs.ServiceAccessPolicyEntryArgs
    ///                 {
    ...
    ///                 },
    ///             },
    ///             AuthenticationConfiguration = new AzureNative.HealthcareApis.V20200315.Inputs.ServiceAuthenticationConfigurationInfoArgs
    ///             {
    ///                 Audience = "https://azurehealthcareapis.com",
    ///                 Authority = "https://login.microsoftonline.com/abfde7b2-df0f-47e6-aabf-2462b07508dc",
    ///                 SmartProxyEnabled = true,
    ///             },
    ///             CorsConfiguration = new AzureNative.HealthcareApis.V20200315.Inputs.ServiceCorsConfigurationInfoArgs
    ///             {
    ...
    ///                 },
    ///             },
    ///             CosmosDbConfiguration = new AzureNative.HealthcareApis.V20200315.Inputs.ServiceCosmosDbConfigurationInfoArgs
    ///             {
    ///                 KeyVaultKeyUri = "https://my-vault.vault.azure.net/keys/my-key",
    ///                 OfferThroughput = 1000,
    ///             },
    ///             ExportConfiguration = new AzureNative.HealthcareApis.V20200315.Inputs.ServiceExportConfigurationInfoArgs
    ///             {
    ...
    [AzureNativeResourceType("azure-native:healthcareapis/v20200315:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20200315:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20200315:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.HealthcareApis.V20200315.Kind> Kind { get; set; } = null!;
