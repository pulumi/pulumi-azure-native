...
namespace Pulumi.AzureNative.HealthcareApis.V20220515
{
    ...
    /// {
    ///     var dicomService = new AzureNative.HealthcareApis.V20220515.DicomService("dicomService", new()
    ///     {
    ...
    public partial class DicomService : global::Pulumi.CustomResource
    {
        ...
        public DicomService(string name, DicomServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220515:DicomService", name, args ?? new DicomServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DicomService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220515:DicomService", name, null, MakeResourceOptions(options, id))
        {
        }
