...
namespace Pulumi.AzureNative.HealthcareApis.V20220515
{
    ...
    /// {
    ///     var service = new AzureNative.HealthcareApis.V20220515.Service("service", new()
    ///     {
    ///         Identity = new AzureNative.HealthcareApis.V20220515.Inputs.ServicesResourceIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Kind = AzureNative.HealthcareApis.V20220515.Kind.Fhir_R4,
    ///         Location = "westus2",
    ///         Properties = new AzureNative.HealthcareApis.V20220515.Inputs.ServicesPropertiesArgs
    ///         {
    ///             AccessPolicies = new[]
    ///             {
    ///                 new AzureNative.HealthcareApis.V20220515.Inputs.ServiceAccessPolicyEntryArgs
    ///                 {
    ...
    ///                 },
    ///             },
    ///             AuthenticationConfiguration = new AzureNative.HealthcareApis.V20220515.Inputs.ServiceAuthenticationConfigurationInfoArgs
    ///             {
    ///                 Audience = "https://azurehealthcareapis.com",
    ///                 Authority = "https://login.microsoftonline.com/abfde7b2-df0f-47e6-aabf-2462b07508dc",
    ///                 SmartProxyEnabled = true,
    ///             },
    ///             CorsConfiguration = new AzureNative.HealthcareApis.V20220515.Inputs.ServiceCorsConfigurationInfoArgs
    ///             {
    ...
    ///                 },
    ///             },
    ///             CosmosDbConfiguration = new AzureNative.HealthcareApis.V20220515.Inputs.ServiceCosmosDbConfigurationInfoArgs
    ///             {
    ///                 KeyVaultKeyUri = "https://my-vault.vault.azure.net/keys/my-key",
    ///                 OfferThroughput = 1000,
    ///             },
    ///             ExportConfiguration = new AzureNative.HealthcareApis.V20220515.Inputs.ServiceExportConfigurationInfoArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20220515:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220515:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220515:Service", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:healthcareapis/v20221201:Service"},
    ...
    public sealed class ServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.HealthcareApis.V20220515.Kind> Kind { get; set; } = null!;
