...
namespace Pulumi.AzureNative.HealthcareApis.V20220515
{
    ...
    /// {
    ///     var iotConnector = new AzureNative.HealthcareApis.V20220515.IotConnector("iotConnector", new()
    ///     {
    ///         DeviceMapping = new AzureNative.HealthcareApis.V20220515.Inputs.IotMappingPropertiesArgs
    ///         {
    ///             Content = 
    ///             {
    ///                 { "template", new[]
    ...
    ///             Type = "SystemAssigned",
    ///         },
    ///         IngestionEndpointConfiguration = new AzureNative.HealthcareApis.V20220515.Inputs.IotEventHubIngestionEndpointConfigurationArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20220515:IotConnector")]
    public partial class IotConnector : global::Pulumi.CustomResource
    {
        ...
        public IotConnector(string name, IotConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220515:IotConnector", name, args ?? new IotConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220515:IotConnector", name, null, MakeResourceOptions(options, id))
        {
        }
