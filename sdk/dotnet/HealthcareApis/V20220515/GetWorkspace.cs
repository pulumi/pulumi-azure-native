...
namespace Pulumi.AzureNative.HealthcareApis.V20220515
{
    public static class GetWorkspace
    {
        ...
        public static Task<GetWorkspaceResult> InvokeAsync(GetWorkspaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceResult>("azure-native:healthcareapis/v20220515:getWorkspace", args ?? new GetWorkspaceArgs(), options.WithDefaults());

        /// <summary>
        /// Workspace resource.
        /// </summary>
        public static Output<GetWorkspaceResult> Invoke(GetWorkspaceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWorkspaceResult>("azure-native:healthcareapis/v20220515:getWorkspace", args ?? new GetWorkspaceInvokeArgs(), options.WithDefaults());
    }
