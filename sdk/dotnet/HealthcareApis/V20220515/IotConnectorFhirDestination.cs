...
namespace Pulumi.AzureNative.HealthcareApis.V20220515
{
    ...
    /// {
    ///     var iotConnectorFhirDestination = new AzureNative.HealthcareApis.V20220515.IotConnectorFhirDestination("iotConnectorFhirDestination", new()
    ///     {
    ///         FhirDestinationName = "dest1",
    ///         FhirMapping = new AzureNative.HealthcareApis.V20220515.Inputs.IotMappingPropertiesArgs
    ///         {
    ///             Content = 
    ///             {
    ///                 { "template", new[]
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20220515:IotConnectorFhirDestination")]
    public partial class IotConnectorFhirDestination : global::Pulumi.CustomResource
    {
        ...
        public IotConnectorFhirDestination(string name, IotConnectorFhirDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220515:IotConnectorFhirDestination", name, args ?? new IotConnectorFhirDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnectorFhirDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20220515:IotConnectorFhirDestination", name, null, MakeResourceOptions(options, id))
        {
        }
