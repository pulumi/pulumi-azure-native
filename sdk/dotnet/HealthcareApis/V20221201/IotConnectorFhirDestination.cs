...
namespace Pulumi.AzureNative.HealthcareApis.V20221201
{
    ...
    /// {
    ///     var iotConnectorFhirDestination = new AzureNative.HealthcareApis.V20221201.IotConnectorFhirDestination("iotConnectorFhirDestination", new()
    ///     {
    ///         FhirDestinationName = "dest1",
    ///         FhirMapping = new AzureNative.HealthcareApis.V20221201.Inputs.IotMappingPropertiesArgs
    ///         {
    ///             Content = 
    ///             {
    ///                 { "template", new[]
