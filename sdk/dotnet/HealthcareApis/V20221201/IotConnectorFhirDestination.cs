...
namespace Pulumi.AzureNative.HealthcareApis.V20221201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:healthcareapis/v20221201:IotConnectorFhirDestination is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnectorFhirDestination to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:healthcareapis/v20221201:IotConnectorFhirDestination")]
    public partial class IotConnectorFhirDestination : global::Pulumi.CustomResource
    {
        ...
        public IotConnectorFhirDestination(string name, IotConnectorFhirDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221201:IotConnectorFhirDestination", name, args ?? new IotConnectorFhirDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnectorFhirDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221201:IotConnectorFhirDestination", name, null, MakeResourceOptions(options, id))
        {
        }
