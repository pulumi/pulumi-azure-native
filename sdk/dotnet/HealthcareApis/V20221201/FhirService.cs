...
namespace Pulumi.AzureNative.HealthcareApis.V20221201
{
    ...
    /// {
    ///     var fhirService = new AzureNative.HealthcareApis.V20221201.FhirService("fhirService", new()
    ///     {
    ///         AccessPolicies = new[]
    ///         {
    ///             new AzureNative.HealthcareApis.V20221201.Inputs.FhirServiceAccessPolicyEntryArgs
    ///             {
    ...
    ///             },
    ///         },
    ///         AcrConfiguration = new AzureNative.HealthcareApis.V20221201.Inputs.FhirServiceAcrConfigurationArgs
    ///         {
    ///             LoginServers = new[]
    ///             {
    ///                 "test1.azurecr.io",
    ///             },
    ///         },
    ///         AuthenticationConfiguration = new AzureNative.HealthcareApis.V20221201.Inputs.FhirServiceAuthenticationConfigurationArgs
    ///         {
    ///             Audience = "https://azurehealthcareapis.com",
    ///             Authority = "https://login.microsoftonline.com/abfde7b2-df0f-47e6-aabf-2462b07508dc",
    ///             SmartProxyEnabled = true,
    ///         },
    ///         CorsConfiguration = new AzureNative.HealthcareApis.V20221201.Inputs.FhirServiceCorsConfigurationArgs
    ///         {
    ...
    ///             },
    ///         },
    ///         ExportConfiguration = new AzureNative.HealthcareApis.V20221201.Inputs.FhirServiceExportConfigurationArgs
    ///         {
    ...
    ///             Type = "SystemAssigned",
    ///         },
    ///         ImplementationGuidesConfiguration = new AzureNative.HealthcareApis.V20221201.Inputs.ImplementationGuidesConfigurationArgs
    ///         {
    ///             UsCoreMissingData = false,
    ///         },
    ///         ImportConfiguration = new AzureNative.HealthcareApis.V20221201.Inputs.FhirServiceImportConfigurationArgs
    ///         {
    ///             Enabled = false,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20221201:FhirService")]
    public partial class FhirService : global::Pulumi.CustomResource
    {
        ...
        public FhirService(string name, FhirServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221201:FhirService", name, args ?? new FhirServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FhirService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221201:FhirService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FhirServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.HealthcareApis.V20221201.FhirServiceKind>? Kind { get; set; }
