...
namespace Pulumi.AzureNative.HealthcareApis.V20221201
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.HealthcareApis.V20221201.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "myConnection",
    ///         PrivateLinkServiceConnectionState = new AzureNative.HealthcareApis.V20221201.Inputs.PrivateLinkServiceConnectionStateArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:healthcareapis/v20221201:PrivateEndpointConnection myConnection /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.HealthcareApis/services/service1/privateEndpointConnections/myConnection 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20221201:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221201:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221201:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
