...
namespace Pulumi.AzureNative.HealthcareApis.V20231101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20231101:DicomService")]
    public partial class DicomService : global::Pulumi.CustomResource
    {
        ...
        public DicomService(string name, DicomServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231101:DicomService", name, args ?? new DicomServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DicomService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20231101:DicomService", name, null, MakeResourceOptions(options, id))
        {
        }
