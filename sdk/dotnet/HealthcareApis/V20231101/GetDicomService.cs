...
namespace Pulumi.AzureNative.HealthcareApis.V20231101
{
    public static class GetDicomService
    {
        ...
        public static Task<GetDicomServiceResult> InvokeAsync(GetDicomServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDicomServiceResult>("azure-native:healthcareapis/v20231101:getDicomService", args ?? new GetDicomServiceArgs(), options.WithDefaults());
