...
namespace Pulumi.AzureNative.HealthcareApis.V20231101
{
    public static class GetIotConnector
    {
        ...
        public static Task<GetIotConnectorResult> InvokeAsync(GetIotConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIotConnectorResult>("azure-native:healthcareapis/v20231101:getIotConnector", args ?? new GetIotConnectorArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified IoT Connector.
        /// </summary>
        public static Output<GetIotConnectorResult> Invoke(GetIotConnectorInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIotConnectorResult>("azure-native:healthcareapis/v20231101:getIotConnector", args ?? new GetIotConnectorInvokeArgs(), options.WithDefaults());
