...
namespace Pulumi.AzureNative.HealthcareApis.V20221001Preview
{
    ...
    [AzureNativeResourceType("azure-native:healthcareapis/v20221001preview:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221001preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221001preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
