...
namespace Pulumi.AzureNative.HealthcareApis.V20221001Preview
{
    ...
    [AzureNativeResourceType("azure-native:healthcareapis/v20221001preview:WorkspacePrivateEndpointConnection")]
    public partial class WorkspacePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public WorkspacePrivateEndpointConnection(string name, WorkspacePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221001preview:WorkspacePrivateEndpointConnection", name, args ?? new WorkspacePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspacePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221001preview:WorkspacePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
