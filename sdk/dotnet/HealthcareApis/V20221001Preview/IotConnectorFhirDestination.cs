...
namespace Pulumi.AzureNative.HealthcareApis.V20221001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20221001preview:IotConnectorFhirDestination")]
    public partial class IotConnectorFhirDestination : global::Pulumi.CustomResource
    {
        ...
        public IotConnectorFhirDestination(string name, IotConnectorFhirDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221001preview:IotConnectorFhirDestination", name, args ?? new IotConnectorFhirDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnectorFhirDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20221001preview:IotConnectorFhirDestination", name, null, MakeResourceOptions(options, id))
        {
        }
