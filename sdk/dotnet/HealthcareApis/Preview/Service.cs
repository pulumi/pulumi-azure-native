...
namespace Pulumi.AzureRM.HealthcareApis.Preview
{
    /// <summary>
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:healthcareapis/preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:healthcareapis/preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
