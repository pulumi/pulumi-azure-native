...
namespace Pulumi.AzureNative.HealthcareApis.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20240301:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20240301:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20240301:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.HealthcareApis.V20240301.Kind> Kind { get; set; } = null!;
