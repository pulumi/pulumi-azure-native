...
namespace Pulumi.AzureNative.HealthcareApis.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:healthcareapis/v20210601preview:DicomService is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:DicomService to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:healthcareapis/v20210601preview:DicomService")]
    public partial class DicomService : global::Pulumi.CustomResource
    {
        ...
        public DicomService(string name, DicomServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20210601preview:DicomService", name, args ?? new DicomServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DicomService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20210601preview:DicomService", name, null, MakeResourceOptions(options, id))
        {
        }
