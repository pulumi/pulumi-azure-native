...
namespace Pulumi.AzureNative.HealthcareApis.V20210601Preview
{
    ...
    [AzureNativeResourceType("azure-native:healthcareapis/v20210601preview:IotConnectorFhirDestination")]
    public partial class IotConnectorFhirDestination : Pulumi.CustomResource
    {
        ...
        public IotConnectorFhirDestination(string name, IotConnectorFhirDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20210601preview:IotConnectorFhirDestination", name, args ?? new IotConnectorFhirDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnectorFhirDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20210601preview:IotConnectorFhirDestination", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:healthcareapis:IotConnectorFhirDestination"},
    ...
    public sealed class IotConnectorFhirDestinationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.HealthcareApis.V20210601Preview.IotIdentityResolutionType> ResourceIdentityResolutionType { get; set; } = null!;
