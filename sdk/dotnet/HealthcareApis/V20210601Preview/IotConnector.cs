...
namespace Pulumi.AzureNative.HealthcareApis.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:healthcareapis/v20210601preview:IotConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnector to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:healthcareapis/v20210601preview:IotConnector")]
    public partial class IotConnector : global::Pulumi.CustomResource
    {
        ...
        public IotConnector(string name, IotConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20210601preview:IotConnector", name, args ?? new IotConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20210601preview:IotConnector", name, null, MakeResourceOptions(options, id))
        {
        }
