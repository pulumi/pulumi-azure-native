...
namespace Pulumi.AzureNative.HealthcareApis.V20210601Preview
{
    ...
    /// Workspace resource.
    /// </summary>
    [Obsolete(@"azure-native:healthcareapis/v20210601preview:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20221201:Workspace to guarantee forwards compatibility.")]
    ...
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20210601preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20210601preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
