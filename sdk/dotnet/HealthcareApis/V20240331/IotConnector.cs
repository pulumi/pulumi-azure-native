...
namespace Pulumi.AzureNative.HealthcareApis.V20240331
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20240331:IotConnector")]
    public partial class IotConnector : global::Pulumi.CustomResource
    {
        ...
        public IotConnector(string name, IotConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20240331:IotConnector", name, args ?? new IotConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20240331:IotConnector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:healthcareapis/v20250301preview:IotConnector" },
