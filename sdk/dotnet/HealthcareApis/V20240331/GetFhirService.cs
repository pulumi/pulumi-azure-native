...
namespace Pulumi.AzureNative.HealthcareApis.V20240331
{
    public static class GetFhirService
    {
        ...
        public static Task<GetFhirServiceResult> InvokeAsync(GetFhirServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFhirServiceResult>("azure-native:healthcareapis/v20240331:getFhirService", args ?? new GetFhirServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified FHIR Service.
        /// </summary>
        public static Output<GetFhirServiceResult> Invoke(GetFhirServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFhirServiceResult>("azure-native:healthcareapis/v20240331:getFhirService", args ?? new GetFhirServiceInvokeArgs(), options.WithDefaults());
    }
