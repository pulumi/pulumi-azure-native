...
namespace Pulumi.AzureNative.HealthcareApis.V20240331
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20240331:IotConnectorFhirDestination")]
    public partial class IotConnectorFhirDestination : global::Pulumi.CustomResource
    {
        ...
        public IotConnectorFhirDestination(string name, IotConnectorFhirDestinationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20240331:IotConnectorFhirDestination", name, args ?? new IotConnectorFhirDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnectorFhirDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20240331:IotConnectorFhirDestination", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IotConnectorFhirDestinationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.HealthcareApis.V20240331.IotIdentityResolutionType> ResourceIdentityResolutionType { get; set; } = null!;
