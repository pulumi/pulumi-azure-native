...
namespace Pulumi.AzureNative.HealthcareApis.V20240331
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20240331:FhirService")]
    public partial class FhirService : global::Pulumi.CustomResource
    {
        ...
        public FhirService(string name, FhirServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20240331:FhirService", name, args ?? new FhirServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FhirService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20240331:FhirService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FhirServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.HealthcareApis.V20240331.FhirServiceKind>? Kind { get; set; }
