...
namespace Pulumi.AzureNative.HealthcareApis.V20230906
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:healthcareapis/v20230906:IotConnector")]
    public partial class IotConnector : global::Pulumi.CustomResource
    {
        ...
        public IotConnector(string name, IotConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20230906:IotConnector", name, args ?? new IotConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:healthcareapis/v20230906:IotConnector", name, null, MakeResourceOptions(options, id))
        {
        }
