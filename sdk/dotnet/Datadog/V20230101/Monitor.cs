...
{
    [AzureNativeResourceType("azure-native:datadog/v20230101:Monitor")]
    public partial class Monitor : global::Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datadog/v20230101:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datadog/v20230101:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
