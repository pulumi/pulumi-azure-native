...
namespace Pulumi.AzureNative.Datadog.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:datadog:Monitor'.")]
    [AzureNativeResourceType("azure-native:datadog/latest:Monitor")]
    public partial class Monitor : Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datadog/latest:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datadog/latest:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
