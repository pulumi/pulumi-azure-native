...
namespace Pulumi.AzureNative.Datadog.V20220601
{
    public static class ListMonitorHosts
    {
        ...
        public static Task<ListMonitorHostsResult> InvokeAsync(ListMonitorHostsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListMonitorHostsResult>("azure-native:datadog/v20220601:listMonitorHosts", args ?? new ListMonitorHostsArgs(), options.WithDefaults());

        /// <summary>
        /// Response of a list operation.
        /// </summary>
        public static Output<ListMonitorHostsResult> Invoke(ListMonitorHostsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListMonitorHostsResult>("azure-native:datadog/v20220601:listMonitorHosts", args ?? new ListMonitorHostsInvokeArgs(), options.WithDefaults());
    }
