...
namespace Pulumi.AzureNative.Datadog.V20220601
{
    public static class ListMonitorApiKeys
    {
        ...
        public static Task<ListMonitorApiKeysResult> InvokeAsync(ListMonitorApiKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListMonitorApiKeysResult>("azure-native:datadog/v20220601:listMonitorApiKeys", args ?? new ListMonitorApiKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Response of a list operation.
        /// </summary>
        public static Output<ListMonitorApiKeysResult> Invoke(ListMonitorApiKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListMonitorApiKeysResult>("azure-native:datadog/v20220601:listMonitorApiKeys", args ?? new ListMonitorApiKeysInvokeArgs(), options.WithDefaults());
    }
