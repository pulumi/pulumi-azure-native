...
namespace Pulumi.AzureNative.Datadog.V20210301
{
    ...
    /// {
    ///     var monitor = new AzureNative.Datadog.V20210301.Monitor("monitor", new()
    ///     {
    ...
    public partial class Monitor : global::Pulumi.CustomResource
    {
        ...
        public Monitor(string name, MonitorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datadog/v20210301:Monitor", name, args ?? new MonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Monitor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datadog/v20210301:Monitor", name, null, MakeResourceOptions(options, id))
        {
        }
