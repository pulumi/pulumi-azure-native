...
namespace Pulumi.AzureNative.Datadog.V20220801
{
    public static class ListMonitorApiKeys
    {
        ...
        public static Task<ListMonitorApiKeysResult> InvokeAsync(ListMonitorApiKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListMonitorApiKeysResult>("azure-native:datadog/v20220801:listMonitorApiKeys", args ?? new ListMonitorApiKeysArgs(), options.WithDefaults());
