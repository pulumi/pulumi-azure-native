...
namespace Pulumi.AzureNative.DevHub.V20250301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devhub/v20250301preview:Workflow")]
    public partial class Workflow : global::Pulumi.CustomResource
    {
        ...
        public Workflow(string name, WorkflowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devhub/v20250301preview:Workflow", name, args ?? new WorkflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workflow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devhub/v20250301preview:Workflow", name, null, MakeResourceOptions(options, id))
        {
        }
