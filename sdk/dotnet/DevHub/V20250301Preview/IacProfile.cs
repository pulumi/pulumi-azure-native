...
namespace Pulumi.AzureNative.DevHub.V20250301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devhub/v20250301preview:IacProfile")]
    public partial class IacProfile : global::Pulumi.CustomResource
    {
        ...
        public IacProfile(string name, IacProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devhub/v20250301preview:IacProfile", name, args ?? new IacProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IacProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devhub/v20250301preview:IacProfile", name, null, MakeResourceOptions(options, id))
        {
        }
