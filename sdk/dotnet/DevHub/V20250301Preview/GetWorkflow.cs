...
namespace Pulumi.AzureNative.DevHub.V20250301Preview
{
    public static class GetWorkflow
    {
        ...
        public static Task<GetWorkflowResult> InvokeAsync(GetWorkflowArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkflowResult>("azure-native:devhub/v20250301preview:getWorkflow", args ?? new GetWorkflowArgs(), options.WithDefaults());

        /// <summary>
        /// Resource representation of a workflow
        /// </summary>
        public static Output<GetWorkflowResult> Invoke(GetWorkflowInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkflowResult>("azure-native:devhub/v20250301preview:getWorkflow", args ?? new GetWorkflowInvokeArgs(), options.WithDefaults());
