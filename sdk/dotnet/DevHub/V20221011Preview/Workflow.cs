...
namespace Pulumi.AzureNative.DevHub.V20221011Preview
{
    ...
    /// {
    ///     var workflow = new AzureNative.DevHub.V20221011Preview.Workflow("workflow", new()
    ///     {
    ///         Acr = new AzureNative.DevHub.V20221011Preview.Inputs.ACRArgs
    ///         {
    ...
    ///         BranchName = "branch1",
    ///         DeploymentProperties = new AzureNative.DevHub.V20221011Preview.Inputs.DeploymentPropertiesArgs
    ///         {
    ...
    ///         OidcCredentials = new AzureNative.DevHub.V20221011Preview.Inputs.GitHubWorkflowProfileOidcCredentialsArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:devhub/v20221011preview:Workflow")]
    public partial class Workflow : global::Pulumi.CustomResource
    {
        ...
        public Workflow(string name, WorkflowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devhub/v20221011preview:Workflow", name, args ?? new WorkflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workflow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devhub/v20221011preview:Workflow", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkflowArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevHub.V20221011Preview.DockerfileGenerationMode>? DockerfileGenerationMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevHub.V20221011Preview.GenerationLanguage>? GenerationLanguage { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevHub.V20221011Preview.ManifestGenerationMode>? ManifestGenerationMode { get; set; }
        ...
        /// </summary>
        [Input("manifestType")]
        public InputUnion<string, Pulumi.AzureNative.DevHub.V20221011Preview.GenerationManifestType>? ManifestType { get; set; }
