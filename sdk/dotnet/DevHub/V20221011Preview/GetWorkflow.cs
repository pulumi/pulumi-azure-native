...
namespace Pulumi.AzureNative.DevHub.V20221011Preview
{
    public static class GetWorkflow
    {
        ...
        public static Task<GetWorkflowResult> InvokeAsync(GetWorkflowArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkflowResult>("azure-native:devhub/v20221011preview:getWorkflow", args ?? new GetWorkflowArgs(), options.WithDefaults());
