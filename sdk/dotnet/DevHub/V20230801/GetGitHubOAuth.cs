...
namespace Pulumi.AzureNative.DevHub.V20230801
{
    public static class GetGitHubOAuth
    {
        ...
        public static Task<GetGitHubOAuthResult> InvokeAsync(GetGitHubOAuthArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGitHubOAuthResult>("azure-native:devhub/v20230801:getGitHubOAuth", args ?? new GetGitHubOAuthArgs(), options.WithDefaults());
