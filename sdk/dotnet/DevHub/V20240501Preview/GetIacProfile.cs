...
namespace Pulumi.AzureNative.DevHub.V20240501Preview
{
    public static class GetIacProfile
    {
        ...
        public static Task<GetIacProfileResult> InvokeAsync(GetIacProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIacProfileResult>("azure-native:devhub/v20240501preview:getIacProfile", args ?? new GetIacProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Resource representation of a IacProfile.
        /// </summary>
        public static Output<GetIacProfileResult> Invoke(GetIacProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIacProfileResult>("azure-native:devhub/v20240501preview:getIacProfile", args ?? new GetIacProfileInvokeArgs(), options.WithDefaults());
