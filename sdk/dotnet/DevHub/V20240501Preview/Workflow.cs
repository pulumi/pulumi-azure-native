...
namespace Pulumi.AzureNative.DevHub.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:devhub/v20240501preview:Workflow")]
    public partial class Workflow : global::Pulumi.CustomResource
    {
        ...
        public Workflow(string name, WorkflowArgs args, CustomResourceOptions? options = null)
            : base("azure-native:devhub/v20240501preview:Workflow", name, args ?? new WorkflowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workflow(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:devhub/v20240501preview:Workflow", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkflowArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DevHub.V20240501Preview.DockerfileGenerationMode>? DockerfileGenerationMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevHub.V20240501Preview.GenerationLanguage>? GenerationLanguage { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DevHub.V20240501Preview.ManifestGenerationMode>? ManifestGenerationMode { get; set; }
        ...
        /// </summary>
        [Input("manifestType")]
        public InputUnion<string, Pulumi.AzureNative.DevHub.V20240501Preview.GenerationManifestType>? ManifestType { get; set; }
