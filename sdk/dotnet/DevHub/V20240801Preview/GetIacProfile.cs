...
namespace Pulumi.AzureNative.DevHub.V20240801Preview
{
    public static class GetIacProfile
    {
        ...
        public static Task<GetIacProfileResult> InvokeAsync(GetIacProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIacProfileResult>("azure-native:devhub/v20240801preview:getIacProfile", args ?? new GetIacProfileArgs(), options.WithDefaults());
