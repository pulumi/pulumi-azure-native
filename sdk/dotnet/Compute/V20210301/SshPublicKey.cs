...
namespace Pulumi.AzureNative.Compute.V20210301
{
    ...
    public partial class SshPublicKey : Pulumi.CustomResource
    {
        ...
        public SshPublicKey(string name, SshPublicKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:SshPublicKey", name, args ?? new SshPublicKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SshPublicKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:SshPublicKey", name, null, MakeResourceOptions(options, id))
        {
        }
