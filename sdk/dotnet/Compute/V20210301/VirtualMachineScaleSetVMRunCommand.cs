...
namespace Pulumi.AzureNative.Compute.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20210301:VirtualMachineScaleSetVMRunCommand is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetVMRunCommand to guarantee forwards compatibility.")]
    ...
    public partial class VirtualMachineScaleSetVMRunCommand : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVMRunCommand(string name, VirtualMachineScaleSetVMRunCommandArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:VirtualMachineScaleSetVMRunCommand", name, args ?? new VirtualMachineScaleSetVMRunCommandArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVMRunCommand(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:VirtualMachineScaleSetVMRunCommand", name, null, MakeResourceOptions(options, id))
        {
        }
