...
namespace Pulumi.AzureNative.Compute.V20210301
{
    public static class GetVirtualMachine
    {
        ...
        public static Task<GetVirtualMachineResult> InvokeAsync(GetVirtualMachineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualMachineResult>("azure-native:compute/v20210301:getVirtualMachine", args ?? new GetVirtualMachineArgs(), options.WithVersion());

        /// <summary>
        /// Describes a Virtual Machine.
        /// </summary>
        public static Output<GetVirtualMachineResult> Invoke(GetVirtualMachineInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVirtualMachineResult>("azure-native:compute/v20210301:getVirtualMachine", args ?? new GetVirtualMachineInvokeArgs(), options.WithVersion());
    }
