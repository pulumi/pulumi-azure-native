...
namespace Pulumi.AzureNative.Compute.V20210301
{
    ...
    /// {
    ///     var cloudService = new AzureNative.Compute.V20210301.CloudService("cloudService", new()
    ///     {
    ///         CloudServiceName = "{cs-name}",
    ///         Location = "westus",
    ///         Properties = new AzureNative.Compute.V20210301.Inputs.CloudServicePropertiesArgs
    ///         {
    ///             Configuration = "{ServiceConfiguration}",
    ///             NetworkProfile = new AzureNative.Compute.V20210301.Inputs.CloudServiceNetworkProfileArgs
    ///             {
    ///                 LoadBalancerConfigurations = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20210301.Inputs.LoadBalancerConfigurationArgs
    ///                     {
    ///                         Name = "contosolb",
    ///                         Properties = new AzureNative.Compute.V20210301.Inputs.LoadBalancerConfigurationPropertiesArgs
    ///                         {
    ///                             FrontendIPConfigurations = new[]
    ///                             {
    ///                                 new AzureNative.Compute.V20210301.Inputs.LoadBalancerFrontendIPConfigurationArgs
    ///                                 {
    ///                                     Name = "contosofe",
    ///                                     Properties = new AzureNative.Compute.V20210301.Inputs.LoadBalancerFrontendIPConfigurationPropertiesArgs
    ///                                     {
    ///                                         PublicIPAddress = new AzureNative.Compute.V20210301.Inputs.SubResourceArgs
    ///                                         {
    ...
    ///             RoleProfile = new AzureNative.Compute.V20210301.Inputs.CloudServiceRoleProfileArgs
    ///             {
    ///                 Roles = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20210301.Inputs.CloudServiceRoleProfilePropertiesArgs
    ///                     {
    ///                         Name = "ContosoFrontend",
    ///                         Sku = new AzureNative.Compute.V20210301.Inputs.CloudServiceRoleSkuArgs
    ///                         {
    ///                             Capacity = 1,
    ///                             Name = "Standard_D1_v2",
    ///                             Tier = "Standard",
    ...
    ///                 },
    ///             },
    ///             OsProfile = new AzureNative.Compute.V20210301.Inputs.CloudServiceOsProfileArgs
    ///             {
    ///                 Secrets = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20210301.Inputs.CloudServiceVaultSecretGroupArgs
    ///                     {
    ///                         SourceVault = new AzureNative.Compute.V20210301.Inputs.SubResourceArgs
    ///                         {
    ///                             Id = "/subscriptions/{subscription-id}/resourceGroups/ConstosoRG/providers/Microsoft.KeyVault/vaults/{keyvault-name}",
    ///                         },
    ///                         VaultCertificates = new[]
    ///                         {
    ///                             new AzureNative.Compute.V20210301.Inputs.CloudServiceVaultCertificateArgs
    ///                             {
    ...
    ///         {
    ///             Configuration = "{ServiceConfiguration}",
    ///             ExtensionProfile = new AzureNative.Compute.V20210301.Inputs.CloudServiceExtensionProfileArgs
    ///             {
    ///                 Extensions = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20210301.Inputs.ExtensionArgs
    ///                     {
    ///                         Name = "RDPExtension",
    ///                         Properties = new AzureNative.Compute.V20210301.Inputs.CloudServiceExtensionPropertiesArgs
    ///                         {
    ...
    public partial class CloudService : global::Pulumi.CustomResource
    {
        ...
        public CloudService(string name, CloudServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:CloudService", name, args ?? new CloudServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:CloudService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CloudService Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class CloudServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.CloudServicePropertiesArgs>? Properties { get; set; }
