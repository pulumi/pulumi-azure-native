...
namespace Pulumi.AzureNative.Compute.V20210301
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20210301:RestorePoint")]
    public partial class RestorePoint : global::Pulumi.CustomResource
    {
        ...
        public RestorePoint(string name, RestorePointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:RestorePoint", name, args ?? new RestorePointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:RestorePoint", name, null, MakeResourceOptions(options, id))
        {
        }
