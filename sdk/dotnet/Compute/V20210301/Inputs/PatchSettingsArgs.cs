...
namespace Pulumi.AzureNative.Compute.V20210301.Inputs
{
    ...
    public sealed class PatchSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20210301.WindowsPatchAssessmentMode>? AssessmentMode { get; set; }
        ...
        /// </summary>
        [Input("patchMode")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20210301.WindowsVMGuestPatchMode>? PatchMode { get; set; }
