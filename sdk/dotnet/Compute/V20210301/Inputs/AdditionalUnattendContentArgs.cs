...
namespace Pulumi.AzureNative.Compute.V20210301.Inputs
{
    ...
    public sealed class AdditionalUnattendContentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("componentName")]
        public Input<Pulumi.AzureNative.Compute.V20210301.ComponentNames>? ComponentName { get; set; }
        ...
        /// </summary>
        [Input("passName")]
        public Input<Pulumi.AzureNative.Compute.V20210301.PassNames>? PassName { get; set; }

        /// <summary>
        /// Specifies the name of the setting to which the content applies. Possible values are: FirstLogonCommands and AutoLogon.
        /// </summary>
        [Input("settingName")]
        public Input<Pulumi.AzureNative.Compute.V20210301.SettingNames>? SettingName { get; set; }
