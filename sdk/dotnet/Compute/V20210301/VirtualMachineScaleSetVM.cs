...
namespace Pulumi.AzureNative.Compute.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20210301:VirtualMachineScaleSetVM is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSetVM to guarantee forwards compatibility.")]
    ...
    public partial class VirtualMachineScaleSetVM : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVM(string name, VirtualMachineScaleSetVMArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:VirtualMachineScaleSetVM", name, args ?? new VirtualMachineScaleSetVMArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVM(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210301:VirtualMachineScaleSetVM", name, null, MakeResourceOptions(options, id))
        {
        }
