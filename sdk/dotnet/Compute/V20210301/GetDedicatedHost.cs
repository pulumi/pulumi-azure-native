...
{
    [Obsolete(@"azure-native:compute/v20210301:DedicatedHost is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:DedicatedHost to guarantee forwards compatibility.")]
    public static class GetDedicatedHost
    {
        ...
        public static Task<GetDedicatedHostResult> InvokeAsync(GetDedicatedHostArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedHostResult>("azure-native:compute/v20210301:getDedicatedHost", args ?? new GetDedicatedHostArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves information about a dedicated host.
        /// </summary>
        public static Output<GetDedicatedHostResult> Invoke(GetDedicatedHostInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDedicatedHostResult>("azure-native:compute/v20210301:getDedicatedHost", args ?? new GetDedicatedHostInvokeArgs(), options.WithDefaults());
    }
