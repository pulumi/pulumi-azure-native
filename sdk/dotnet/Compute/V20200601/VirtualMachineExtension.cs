...
namespace Pulumi.AzureNextGen.Compute.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20200601:VirtualMachineExtension")]
    public partial class VirtualMachineExtension : Pulumi.CustomResource
    {
        ...
        public VirtualMachineExtension(string name, VirtualMachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200601:VirtualMachineExtension", name, args ?? new VirtualMachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200601:VirtualMachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
