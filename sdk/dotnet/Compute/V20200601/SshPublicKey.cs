...
namespace Pulumi.AzureRM.Compute.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sshPublicKey = new AzureRM.Compute.V20200601.SshPublicKey("sshPublicKey", new AzureRM.Compute.V20200601.SshPublicKeyArgs
    ///         {
    ///             Location = "westus",
    ...
    public partial class SshPublicKey : Pulumi.CustomResource
    {
        ...
        public SshPublicKey(string name, SshPublicKeyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200601:SshPublicKey", name, args ?? new SshPublicKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SshPublicKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200601:SshPublicKey", name, null, MakeResourceOptions(options, id))
        {
        }
