...
namespace Pulumi.AzureNextGen.Compute.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20200601:DedicatedHost")]
    ...
    public sealed class DedicatedHostArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public Input<Pulumi.AzureNextGen.Compute.V20200601.DedicatedHostLicenseTypes>? LicenseType { get; set; }
