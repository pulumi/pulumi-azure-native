...
namespace Pulumi.AzureNextGen.Compute.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20200601:Image")]
    public partial class Image : Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200601:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200601:Image", name, null, MakeResourceOptions(options, id))
        {
        }
