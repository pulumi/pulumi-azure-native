...
namespace Pulumi.AzureNative.Compute.V20210701
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20210701:GalleryApplicationVersion")]
    public partial class GalleryApplicationVersion : global::Pulumi.CustomResource
    {
        ...
        public GalleryApplicationVersion(string name, GalleryApplicationVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:GalleryApplicationVersion", name, args ?? new GalleryApplicationVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryApplicationVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:GalleryApplicationVersion", name, null, MakeResourceOptions(options, id))
        {
        }
