...
namespace Pulumi.AzureNative.Compute.V20210701
{
    ...
    public partial class RestorePoint : Pulumi.CustomResource
    {
        ...
        public RestorePoint(string name, RestorePointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:RestorePoint", name, args ?? new RestorePointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:RestorePoint", name, null, MakeResourceOptions(options, id))
        {
        }
