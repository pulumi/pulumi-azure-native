...
namespace Pulumi.AzureNative.Compute.V20210701
{
    public static class GetGalleryImage
    {
        ...
        public static Task<GetGalleryImageResult> InvokeAsync(GetGalleryImageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGalleryImageResult>("azure-native:compute/v20210701:getGalleryImage", args ?? new GetGalleryImageArgs(), options.WithVersion());

        /// <summary>
        /// Specifies information about the gallery image definition that you want to create or update.
        /// </summary>
        public static Output<GetGalleryImageResult> Invoke(GetGalleryImageInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGalleryImageResult>("azure-native:compute/v20210701:getGalleryImage", args ?? new GetGalleryImageInvokeArgs(), options.WithVersion());
    }
