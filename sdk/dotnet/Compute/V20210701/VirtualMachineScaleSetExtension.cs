...
namespace Pulumi.AzureNative.Compute.V20210701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20210701:VirtualMachineScaleSetExtension")]
    public partial class VirtualMachineScaleSetExtension : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetExtension(string name, VirtualMachineScaleSetExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:VirtualMachineScaleSetExtension", name, args ?? new VirtualMachineScaleSetExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:VirtualMachineScaleSetExtension", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210701:VirtualMachineScaleSetExtension"},
                    new Pulumi.Alias { Type = "azure-native:compute:VirtualMachineScaleSetExtension"},
                    new Pulumi.Alias { Type = "azure-nextgen:compute:VirtualMachineScaleSetExtension"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20201201:VirtualMachineScaleSetExtension"},
                    new Pulumi.Alias { Type = "azure-native:compute/v20210301:VirtualMachineScaleSetExtension"},
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210301:VirtualMachineScaleSetExtension"},
                    new Pulumi.Alias { Type = "azure-native:compute/v20210401:VirtualMachineScaleSetExtension"},
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210401:VirtualMachineScaleSetExtension"},
                },
            };
