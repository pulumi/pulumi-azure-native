...
namespace Pulumi.AzureNative.Compute.V20210701
{
    public static class GetRestorePoint
    {
        ...
        public static Task<GetRestorePointResult> InvokeAsync(GetRestorePointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRestorePointResult>("azure-native:compute/v20210701:getRestorePoint", args ?? new GetRestorePointArgs(), options.WithDefaults());

        /// <summary>
        /// Restore Point details.
        /// </summary>
        public static Output<GetRestorePointResult> Invoke(GetRestorePointInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetRestorePointResult>("azure-native:compute/v20210701:getRestorePoint", args ?? new GetRestorePointInvokeArgs(), options.WithDefaults());
    }
