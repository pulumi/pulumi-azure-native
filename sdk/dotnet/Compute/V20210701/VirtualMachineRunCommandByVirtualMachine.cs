...
namespace Pulumi.AzureNative.Compute.V20210701
{
    ...
    public partial class VirtualMachineRunCommandByVirtualMachine : Pulumi.CustomResource
    {
        ...
        public VirtualMachineRunCommandByVirtualMachine(string name, VirtualMachineRunCommandByVirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:VirtualMachineRunCommandByVirtualMachine", name, args ?? new VirtualMachineRunCommandByVirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineRunCommandByVirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:VirtualMachineRunCommandByVirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210701:VirtualMachineRunCommandByVirtualMachine"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210301:VirtualMachineRunCommandByVirtualMachine"},
                    new Pulumi.Alias { Type = "azure-native:compute/v20210401:VirtualMachineRunCommandByVirtualMachine"},
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210401:VirtualMachineRunCommandByVirtualMachine"},
                },
            };
