...
namespace Pulumi.AzureNative.Compute.V20210701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20210701:AvailabilitySet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:AvailabilitySet to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20210701:AvailabilitySet")]
    public partial class AvailabilitySet : global::Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210701:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
