...
namespace Pulumi.AzureNextGen.Compute.V20190301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20190301:VirtualMachineScaleSetExtension")]
    public partial class VirtualMachineScaleSetExtension : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetExtension(string name, VirtualMachineScaleSetExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190301:VirtualMachineScaleSetExtension", name, args ?? new VirtualMachineScaleSetExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190301:VirtualMachineScaleSetExtension", name, null, MakeResourceOptions(options, id))
        {
        }
