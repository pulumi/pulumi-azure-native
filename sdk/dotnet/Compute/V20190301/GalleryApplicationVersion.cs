...
namespace Pulumi.AzureRM.Compute.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var galleryApplicationVersion = new AzureRM.Compute.V20190301.GalleryApplicationVersion("galleryApplicationVersion", new AzureRM.Compute.V20190301.GalleryApplicationVersionArgs
    ///         {
    ///             GalleryApplicationName = "myGalleryApplicationName",
    ///             GalleryApplicationVersionName = "1.0.0",
    ///             GalleryName = "myGalleryName",
    ///             Location = "West US",
    ///             PublishingProfile = new AzureRM.Compute.V20190301.Inputs.GalleryApplicationVersionPublishingProfileArgs
    ///             {
    ///                 EndOfLifeDate = "2019-07-01T07:00:00Z",
    ///                 ReplicaCount = 1,
    ///                 Source = new AzureRM.Compute.V20190301.Inputs.UserArtifactSourceArgs
    ///                 {
    ...
    public partial class GalleryApplicationVersion : Pulumi.CustomResource
    {
        ...
        public GalleryApplicationVersion(string name, GalleryApplicationVersionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:GalleryApplicationVersion", name, args ?? new GalleryApplicationVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryApplicationVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:GalleryApplicationVersion", name, null, MakeResourceOptions(options, id))
        {
        }
