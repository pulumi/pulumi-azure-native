...
namespace Pulumi.AzureRM.Compute.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var galleryImage = new AzureRM.Compute.V20190301.GalleryImage("galleryImage", new AzureRM.Compute.V20190301.GalleryImageArgs
    ///         {
    ///             GalleryImageName = "myGalleryImageName",
    ///             GalleryName = "myGalleryName",
    ///             Identifier = new AzureRM.Compute.V20190301.Inputs.GalleryImageIdentifierArgs
    ///             {
    ///                 Offer = "myOfferName",
    ...
    public partial class GalleryImage : Pulumi.CustomResource
    {
        ...
        public GalleryImage(string name, GalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:GalleryImage", name, args ?? new GalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:GalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
