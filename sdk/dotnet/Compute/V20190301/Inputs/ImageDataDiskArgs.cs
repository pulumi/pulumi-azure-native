...
namespace Pulumi.AzureNextGen.Compute.V20190301.Inputs
{
    ...
    public sealed class ImageDataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNextGen.Compute.V20190301.CachingTypes>? Caching { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20190301.StorageAccountTypes>? StorageAccountType { get; set; }
