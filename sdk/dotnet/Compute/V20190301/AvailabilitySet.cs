...
namespace Pulumi.AzureNative.Compute.V20190301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20190301:AvailabilitySet")]
    public partial class AvailabilitySet : Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190301:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190301:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
