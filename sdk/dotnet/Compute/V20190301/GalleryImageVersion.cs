...
namespace Pulumi.AzureNextGen.Compute.V20190301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20190301:GalleryImageVersion")]
    public partial class GalleryImageVersion : Pulumi.CustomResource
    {
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190301:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190301:GalleryImageVersion", name, null, MakeResourceOptions(options, id))
        {
        }
