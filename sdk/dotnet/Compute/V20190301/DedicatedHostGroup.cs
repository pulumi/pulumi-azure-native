...
namespace Pulumi.AzureNextGen.Compute.V20190301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20190301:DedicatedHostGroup")]
    public partial class DedicatedHostGroup : Pulumi.CustomResource
    {
        ...
        public DedicatedHostGroup(string name, DedicatedHostGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190301:DedicatedHostGroup", name, args ?? new DedicatedHostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHostGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190301:DedicatedHostGroup", name, null, MakeResourceOptions(options, id))
        {
        }
