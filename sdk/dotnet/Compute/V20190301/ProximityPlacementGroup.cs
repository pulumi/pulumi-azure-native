...
namespace Pulumi.AzureRM.Compute.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var proximityPlacementGroup = new AzureRM.Compute.V20190301.ProximityPlacementGroup("proximityPlacementGroup", new AzureRM.Compute.V20190301.ProximityPlacementGroupArgs
    ///         {
    ///             Location = "westus",
    ...
    public partial class ProximityPlacementGroup : Pulumi.CustomResource
    {
        ...
        public ProximityPlacementGroup(string name, ProximityPlacementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:ProximityPlacementGroup", name, args ?? new ProximityPlacementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProximityPlacementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:ProximityPlacementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
