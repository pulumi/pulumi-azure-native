...
namespace Pulumi.AzureNative.Compute.V20190301
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20190301:VirtualMachineScaleSet")]
    public partial class VirtualMachineScaleSet : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSet(string name, VirtualMachineScaleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190301:VirtualMachineScaleSet", name, args ?? new VirtualMachineScaleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190301:VirtualMachineScaleSet", name, null, MakeResourceOptions(options, id))
        {
        }
