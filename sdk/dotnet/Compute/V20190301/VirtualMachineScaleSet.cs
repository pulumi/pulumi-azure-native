...
namespace Pulumi.AzureRM.Compute.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualMachineScaleSet = new AzureRM.Compute.V20190301.VirtualMachineScaleSet("virtualMachineScaleSet", new AzureRM.Compute.V20190301.VirtualMachineScaleSetArgs
    ///         {
    ///             Location = "westus",
    ///             Overprovision = true,
    ///             ResourceGroupName = "myResourceGroup",
    ///             Sku = new AzureRM.Compute.V20190301.Inputs.SkuArgs
    ///             {
    ///                 Capacity = 3,
    ///                 Name = "Standard_D1_v2",
    ///                 Tier = "Standard",
    ///             },
    ///             UpgradePolicy = new AzureRM.Compute.V20190301.Inputs.UpgradePolicyArgs
    ///             {
    ///                 Mode = "Manual",
    ///             },
    ///             VirtualMachineProfile = new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///             {
    ///                 NetworkProfile = new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetNetworkProfileArgs
    ///                 {
    ///                     NetworkInterfaceConfigurations = 
    ///                     {
    ///                         new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetNetworkConfigurationArgs
    ///                         {
    ///                             Name = "{vmss-name}",
    ///                         },
    ///                     },
    ///                 },
    ///                 OsProfile = new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetOSProfileArgs
    ///                 {
    ///                     AdminPassword = "{your-password}",
    ///                     AdminUsername = "{your-username}",
    ///                     ComputerNamePrefix = "{vmss-name}",
    ///                 },
    ///                 StorageProfile = new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetStorageProfileArgs
    ///                 {
    ///                     OsDisk = new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetOSDiskArgs
    ///                     {
    ///                         Caching = "ReadWrite",
    ///                         CreateOption = "FromImage",
    ///                         Image = new AzureRM.Compute.V20190301.Inputs.VirtualHardDiskArgs
    ///                         {
    ...
    ///                 StorageProfile = new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetStorageProfileArgs
    ///                 {
    ///                     ImageReference = new AzureRM.Compute.V20190301.Inputs.ImageReferenceArgs
    ///                     {
    ///                         Offer = "WindowsServer",
    ...
    ///                         Caching = "ReadWrite",
    ///                         CreateOption = "FromImage",
    ///                         ManagedDisk = new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetManagedDiskParametersArgs
    ///                         {
    ...
    ///             Location = "westus",
    ///             Overprovision = true,
    ///             Plan = new AzureRM.Compute.V20190301.Inputs.PlanArgs
    ///             {
    ///                 Name = "windows2016",
    ...
    ///         var virtualMachineScaleSet = new AzureRM.Compute.V20190301.VirtualMachineScaleSet("virtualMachineScaleSet", new AzureRM.Compute.V20190301.VirtualMachineScaleSetArgs
    ///         {
    ///             AutomaticRepairsPolicy = new AzureRM.Compute.V20190301.Inputs.AutomaticRepairsPolicyArgs
    ///             {
    ///                 Enabled = true,
    ///                 GracePeriod = "PT30M",
    ///             },
    ...
    ///             VirtualMachineProfile = new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///             {
    ///                 DiagnosticsProfile = new AzureRM.Compute.V20190301.Inputs.DiagnosticsProfileArgs
    ///                 {
    ///                     BootDiagnostics = new AzureRM.Compute.V20190301.Inputs.BootDiagnosticsArgs
    ///                     {
    ///                         Enabled = true,
    ...
    ///                     DataDisks = 
    ///                     {
    ///                         new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetDataDiskArgs
    ///                         {
    ///                             CreateOption = "Empty",
    ///                             DiskSizeGB = 1023,
    ///                             Lun = 0,
    ...
    ///                         Caching = "ReadOnly",
    ///                         CreateOption = "FromImage",
    ///                         DiffDiskSettings = new AzureRM.Compute.V20190301.Inputs.DiffDiskSettingsArgs
    ///                         {
    ///                             Option = "Local",
    ///                         },
    ///                         ManagedDisk = new AzureRM.Compute.V20190301.Inputs.VirtualMachineScaleSetManagedDiskParametersArgs
    ...
    ///                     AdminUsername = "{your-username}",
    ///                     ComputerNamePrefix = "{vmss-name}",
    ///                     LinuxConfiguration = new AzureRM.Compute.V20190301.Inputs.LinuxConfigurationArgs
    ///                     {
    ///                         DisablePasswordAuthentication = true,
    ///                         Ssh = new AzureRM.Compute.V20190301.Inputs.SshConfigurationArgs
    ///                         {
    ///                             PublicKeys = 
    ///                             {
    ///                                 new AzureRM.Compute.V20190301.Inputs.SshPublicKeyArgs
    ///                                 {
    ...
    ///                     ComputerNamePrefix = "{vmss-name}",
    ///                 },
    ///                 ScheduledEventsProfile = new AzureRM.Compute.V20190301.Inputs.ScheduledEventsProfileArgs
    ///                 {
    ///                     TerminateNotificationProfile = new AzureRM.Compute.V20190301.Inputs.TerminateNotificationProfileArgs
    ///                     {
    ///                         Enable = true,
    ...
    public partial class VirtualMachineScaleSet : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSet(string name, VirtualMachineScaleSetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:VirtualMachineScaleSet", name, args ?? new VirtualMachineScaleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:VirtualMachineScaleSet", name, null, MakeResourceOptions(options, id))
        {
        }
