...
namespace Pulumi.AzureRM.Compute.V20190301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dedicatedHost = new AzureRM.Compute.V20190301.DedicatedHost("dedicatedHost", new AzureRM.Compute.V20190301.DedicatedHostArgs
    ///         {
    ...
    public partial class DedicatedHost : Pulumi.CustomResource
    {
        ...
        public DedicatedHost(string name, DedicatedHostArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:DedicatedHost", name, args ?? new DedicatedHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190301:DedicatedHost", name, null, MakeResourceOptions(options, id))
        {
        }
