...
azure-native:compute/v20190301:Gallery is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220303:Gallery to guarantee forwards compatibility.")]
    ...
    public partial class Gallery : global::Pulumi.CustomResource
    {
        ...
        public Gallery(string name, GalleryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190301:Gallery", name, args ?? new GalleryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gallery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190301:Gallery", name, null, MakeResourceOptions(options, id))
        {
        }
