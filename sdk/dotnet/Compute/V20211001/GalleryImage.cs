...
namespace Pulumi.AzureNative.Compute.V20211001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20211001:GalleryImage")]
    public partial class GalleryImage : Pulumi.CustomResource
    {
        ...
        public GalleryImage(string name, GalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211001:GalleryImage", name, args ?? new GalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211001:GalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GalleryImageArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20211001.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public Input<Pulumi.AzureNative.Compute.V20211001.OperatingSystemStateTypes> OsState { get; set; } = null!;

        /// <summary>
        /// This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. &lt;br&gt;&lt;br&gt; Possible values are: &lt;br&gt;&lt;br&gt; **Windows** &lt;br&gt;&lt;br&gt; **Linux**
        /// </summary>
        [Input("osType", required: true)]
        public Input<Pulumi.AzureNative.Compute.V20211001.OperatingSystemTypes> OsType { get; set; } = null!;
