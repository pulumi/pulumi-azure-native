...
{
    [Obsolete(@"azure-native:compute/v20211001:GalleryImage is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryImage to guarantee forwards compatibility.")]
    public static class GetGalleryImage
    {
        ...
        public static Task<GetGalleryImageResult> InvokeAsync(GetGalleryImageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGalleryImageResult>("azure-native:compute/v20211001:getGalleryImage", args ?? new GetGalleryImageArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves information about a gallery image definition.
        /// </summary>
        public static Output<GetGalleryImageResult> Invoke(GetGalleryImageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGalleryImageResult>("azure-native:compute/v20211001:getGalleryImage", args ?? new GetGalleryImageInvokeArgs(), options.WithDefaults());
    }
