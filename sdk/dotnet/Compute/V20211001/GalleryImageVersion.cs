...
namespace Pulumi.AzureNative.Compute.V20211001
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20211001:GalleryImageVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220303:GalleryImageVersion to guarantee forwards compatibility.")]
    ...
    public partial class GalleryImageVersion : global::Pulumi.CustomResource
    {
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211001:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211001:GalleryImageVersion", name, null, MakeResourceOptions(options, id))
        {
        }
