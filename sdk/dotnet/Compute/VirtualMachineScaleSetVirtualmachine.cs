...
namespace Pulumi.AzureRM.Compute
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetVirtualmachine : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VirtualMachineScaleSetVMPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public VirtualMachineScaleSetVirtualmachine(string name, VirtualMachineScaleSetVirtualmachineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute:VirtualMachineScaleSetVirtualmachine", name, args ?? new VirtualMachineScaleSetVirtualmachineArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class VirtualMachineScaleSetVirtualmachineArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource location
        /// </summary>
