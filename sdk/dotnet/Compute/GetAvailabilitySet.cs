...
namespace Pulumi.AzureRM.Compute
{
    public static class GetAvailabilitySet
    {
        public static Task<GetAvailabilitySetResult> InvokeAsync(GetAvailabilitySetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAvailabilitySetResult>("azurerm:compute:getAvailabilitySet", args ?? new GetAvailabilitySetArgs(), options.WithVersion());
    }
