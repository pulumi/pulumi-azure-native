...
namespace Pulumi.AzureNative.Compute.Inputs
{
    ...
    public sealed class AutomaticZoneRebalancingPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.RebalanceBehavior>? RebalanceBehavior { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.RebalanceStrategy>? RebalanceStrategy { get; set; }
