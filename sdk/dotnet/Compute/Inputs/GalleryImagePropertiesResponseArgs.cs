...
namespace Pulumi.AzureRM.Compute.Inputs
{
    ...
    public sealed class GalleryImagePropertiesResponseArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("disallowed")]
        public Input<Inputs.DisallowedResponseArgs>? Disallowed { get; set; }
        ...
        public Input<Inputs.GalleryImageIdentifierResponseArgs> Identifier { get; set; } = null!;
        ...
        /// </summary>
        [Input("purchasePlan")]
        public Input<Inputs.ImagePurchasePlanResponseArgs>? PurchasePlan { get; set; }

        /// <summary>
        /// The properties describe the recommended machine configuration for this Image Definition. These properties are updatable.
        /// </summary>
        [Input("recommended")]
        public Input<Inputs.RecommendedMachineConfigurationResponseArgs>? Recommended { get; set; }
