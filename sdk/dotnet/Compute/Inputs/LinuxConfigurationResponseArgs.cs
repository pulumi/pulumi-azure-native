...
namespace Pulumi.AzureRM.Compute.Inputs
{
    ...
    /// </summary>
    public sealed class LinuxConfigurationResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ssh")]
        public Input<Inputs.SshConfigurationResponseArgs>? Ssh { get; set; }

        public LinuxConfigurationResponseArgs()
        {
        }
    }
}
