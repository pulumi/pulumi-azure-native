...
namespace Pulumi.AzureRM.Compute.Inputs
{
    ...
    public sealed class WindowsConfigurationResponseGetArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.AdditionalUnattendContentResponseGetArgs>? _additionalUnattendContent;

        /// <summary>
        /// Specifies additional base-64 encoded XML formatted information that can be included in the Unattend.xml file, which is used by Windows Setup.
        /// </summary>
        public InputList<Inputs.AdditionalUnattendContentResponseGetArgs> AdditionalUnattendContent
        {
            get => _additionalUnattendContent ?? (_additionalUnattendContent = new InputList<Inputs.AdditionalUnattendContentResponseGetArgs>());
        ...
        /// </summary>
        [Input("patchSettings")]
        public Input<Inputs.PatchSettingsResponseGetArgs>? PatchSettings { get; set; }
        ...
        /// </summary>
        [Input("winRM")]
        public Input<Inputs.WinRMConfigurationResponseGetArgs>? WinRM { get; set; }
