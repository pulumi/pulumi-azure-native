...
namespace Pulumi.AzureRM.Compute.Inputs
{
    ...
    /// </summary>
    public sealed class WindowsConfigurationResponseArgs : Pulumi.ResourceArgs
    {
        [Input("additionalUnattendContent")]
        private InputList<Inputs.AdditionalUnattendContentResponseArgs>? _additionalUnattendContent;

        /// <summary>
        /// Specifies additional base-64 encoded XML formatted information that can be included in the Unattend.xml file, which is used by Windows Setup.
        /// </summary>
        public InputList<Inputs.AdditionalUnattendContentResponseArgs> AdditionalUnattendContent
        {
            get => _additionalUnattendContent ?? (_additionalUnattendContent = new InputList<Inputs.AdditionalUnattendContentResponseArgs>());
        ...
        /// </summary>
        [Input("patchSettings")]
        public Input<Inputs.PatchSettingsResponseArgs>? PatchSettings { get; set; }
        ...
        /// </summary>
        [Input("winRM")]
        public Input<Inputs.WinRMConfigurationResponseArgs>? WinRM { get; set; }

        public WindowsConfigurationResponseArgs()
        {
        }
    }
}
