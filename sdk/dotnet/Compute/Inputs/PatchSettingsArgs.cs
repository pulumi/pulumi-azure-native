...
namespace Pulumi.AzureNative.Compute.Inputs
{
    ...
    public sealed class PatchSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.WindowsPatchAssessmentMode>? AssessmentMode { get; set; }
        ...
        /// </summary>
        [Input("patchMode")]
        public InputUnion<string, Pulumi.AzureNative.Compute.WindowsVMGuestPatchMode>? PatchMode { get; set; }
