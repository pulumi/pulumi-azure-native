...
namespace Pulumi.AzureRM.Compute.Inputs
{
    ...
    /// </summary>
    public sealed class DiskPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ShareInfoElementResponseArgs>? _shareInfo;

        /// <summary>
        /// Details of the list of all VMs that have the disk attached. maxShares should be set to a value greater than one for disks to allow attaching them to multiple VMs.
        /// </summary>
        public InputList<Inputs.ShareInfoElementResponseArgs> ShareInfo
        {
            get => _shareInfo ?? (_shareInfo = new InputList<Inputs.ShareInfoElementResponseArgs>());
        ...
        public DiskPropertiesResponseArgs()
        {
        }
    }
}
