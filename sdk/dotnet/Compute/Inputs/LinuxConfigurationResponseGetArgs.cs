...
namespace Pulumi.AzureRM.Compute.Inputs
{
    ...
    /// </summary>
    public sealed class LinuxConfigurationResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("ssh")]
        public Input<Inputs.SshConfigurationResponseGetArgs>? Ssh { get; set; }

        public LinuxConfigurationResponseGetArgs()
        {
        }
    }
}
