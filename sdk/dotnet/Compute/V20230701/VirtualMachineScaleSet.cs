...
namespace Pulumi.AzureNative.Compute.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230701:VirtualMachineScaleSet")]
    public partial class VirtualMachineScaleSet : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSet(string name, VirtualMachineScaleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230701:VirtualMachineScaleSet", name, args ?? new VirtualMachineScaleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230701:VirtualMachineScaleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualMachineScaleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230701.OrchestrationMode>? OrchestrationMode { get; set; }
