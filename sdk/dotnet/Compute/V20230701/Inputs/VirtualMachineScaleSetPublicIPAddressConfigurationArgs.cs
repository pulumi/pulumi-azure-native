...
namespace Pulumi.AzureNative.Compute.V20230701.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetPublicIPAddressConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("deleteOption")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230701.DeleteOptions>? DeleteOption { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230701.IPVersion>? PublicIPAddressVersion { get; set; }
