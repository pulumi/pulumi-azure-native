...
namespace Pulumi.AzureNative.Compute.V20230701.Inputs
{
    ...
    public sealed class PatchSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230701.WindowsPatchAssessmentMode>? AssessmentMode { get; set; }
        ...
        /// </summary>
        [Input("patchMode")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230701.WindowsVMGuestPatchMode>? PatchMode { get; set; }
