...
namespace Pulumi.AzureNative.Compute.V20230701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230701:AvailabilitySet")]
    public partial class AvailabilitySet : global::Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230701:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230701:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:compute/v20240701:AvailabilitySet" },
                    new global::Pulumi.Alias { Type = "azure-native:compute/v20241101:AvailabilitySet" },
