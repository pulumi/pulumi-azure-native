...
namespace Pulumi.AzureNative.Compute.V20220702
{
    ...
    /// {
    ///     var snapshot = new AzureNative.Compute.V20220702.Snapshot("snapshot", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20220702:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220702:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220702:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
