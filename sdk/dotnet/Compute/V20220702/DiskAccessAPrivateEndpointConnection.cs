...
namespace Pulumi.AzureNative.Compute.V20220702
{
    ...
    /// {
    ///     var diskAccessAPrivateEndpointConnection = new AzureNative.Compute.V20220702.DiskAccessAPrivateEndpointConnection("diskAccessAPrivateEndpointConnection", new()
    ///     {
    ///         DiskAccessName = "myDiskAccess",
    ///         PrivateEndpointConnectionName = "myPrivateEndpointConnection",
    ///         PrivateLinkServiceConnectionState = new AzureNative.Compute.V20220702.Inputs.PrivateLinkServiceConnectionStateArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection")]
    public partial class DiskAccessAPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public DiskAccessAPrivateEndpointConnection(string name, DiskAccessAPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection", name, args ?? new DiskAccessAPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccessAPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
