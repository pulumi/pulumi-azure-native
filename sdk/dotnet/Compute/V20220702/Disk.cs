...
namespace Pulumi.AzureNative.Compute.V20220702
{
    ...
    /// {
    ///     var disk = new AzureNative.Compute.V20220702.Disk("disk", new()
    ///     {
    ///         CreationData = new AzureNative.Compute.V20220702.Inputs.CreationDataArgs
    ///         {
    ///             CreateOption = "FromImage",
    ///             ImageReference = new AzureNative.Compute.V20220702.Inputs.ImageDiskReferenceArgs
    ///             {
    ...
    ///         DiskName = "myDisk",
    ///         Location = "West US",
    ///         OsType = AzureNative.Compute.V20220702.OperatingSystemTypes.Windows,
    ///         ResourceGroupName = "myResourceGroup",
    ///         SecurityProfile = new AzureNative.Compute.V20220702.Inputs.DiskSecurityProfileArgs
    ///         {
    ...
    ///         DiskName = "myDisk",
    ///         DiskSizeGB = 200,
    ///         Encryption = new AzureNative.Compute.V20220702.Inputs.EncryptionArgs
    ///         {
    ...
    ///         {
    ///             CreateOption = "FromImage",
    ///             GalleryImageReference = new AzureNative.Compute.V20220702.Inputs.ImageDiskReferenceArgs
    ///             {
    ...
    ///         Location = "West US",
    ///         ResourceGroupName = "myResourceGroup",
    ///         Sku = new AzureNative.Compute.V20220702.Inputs.DiskSkuArgs
    ///         {
    ///             Name = "PremiumV2_LRS",
    ///         },
    ///     });
    ...
    ///         DiskName = "myDisk",
    ///         DiskSizeGB = 200,
    ///         ExtendedLocation = new AzureNative.Compute.V20220702.Inputs.ExtendedLocationArgs
    ///         {
    ///             Name = "{edge-zone-id}",
    ///             Type = "EdgeZone",
    ///         },
