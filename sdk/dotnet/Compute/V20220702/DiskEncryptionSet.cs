...
namespace Pulumi.AzureNative.Compute.V20220702
{
    ...
    /// {
    ///     var diskEncryptionSet = new AzureNative.Compute.V20220702.DiskEncryptionSet("diskEncryptionSet", new()
    ///     {
    ///         ActiveKey = new AzureNative.Compute.V20220702.Inputs.KeyForDiskEncryptionSetArgs
    ///         {
    ///             KeyUrl = "https://myvaultdifferentsub.vault-int.azure-int.net/keys/{key}",
    ///         },
    ///         DiskEncryptionSetName = "myDiskEncryptionSet",
    ///         EncryptionType = "EncryptionAtRestWithCustomerKey",
    ///         Identity = new AzureNative.Compute.V20220702.Inputs.EncryptionSetIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Location = "West US",
    ...
    ///             SourceVault = new AzureNative.Compute.V20220702.Inputs.SourceVaultArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20220702:DiskEncryptionSet")]
    public partial class DiskEncryptionSet : global::Pulumi.CustomResource
    {
        ...
        public DiskEncryptionSet(string name, DiskEncryptionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220702:DiskEncryptionSet", name, args ?? new DiskEncryptionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskEncryptionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220702:DiskEncryptionSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiskEncryptionSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220702.DiskEncryptionSetType>? EncryptionType { get; set; }
