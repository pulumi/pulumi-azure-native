...
namespace Pulumi.AzureNative.Compute.V20220702
{
    public static class GetDiskEncryptionSet
    {
        ...
        public static Task<GetDiskEncryptionSetResult> InvokeAsync(GetDiskEncryptionSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDiskEncryptionSetResult>("azure-native:compute/v20220702:getDiskEncryptionSet", args ?? new GetDiskEncryptionSetArgs(), options.WithDefaults());

        /// <summary>
        /// disk encryption set resource.
        /// </summary>
        public static Output<GetDiskEncryptionSetResult> Invoke(GetDiskEncryptionSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDiskEncryptionSetResult>("azure-native:compute/v20220702:getDiskEncryptionSet", args ?? new GetDiskEncryptionSetInvokeArgs(), options.WithDefaults());
    }
