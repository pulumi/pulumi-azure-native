...
namespace Pulumi.AzureNative.Compute.V20230102
{
    public static class GetDiskAccess
    {
        ...
        public static Task<GetDiskAccessResult> InvokeAsync(GetDiskAccessArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiskAccessResult>("azure-native:compute/v20230102:getDiskAccess", args ?? new GetDiskAccessArgs(), options.WithDefaults());
