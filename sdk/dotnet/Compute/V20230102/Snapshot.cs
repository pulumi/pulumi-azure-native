...
namespace Pulumi.AzureNative.Compute.V20230102
{
    ...
    /// Snapshot resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230102:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230102:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230102:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SnapshotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230102.DataAccessAuthMode>? DataAccessAuthMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230102.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230102.NetworkAccessPolicy>? NetworkAccessPolicy { get; set; }

        /// <summary>
        /// The Operating System type.
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNative.Compute.V20230102.OperatingSystemTypes>? OsType { get; set; }

        /// <summary>
        /// Policy for controlling export on the disk.
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230102.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
