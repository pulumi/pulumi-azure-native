...
namespace Pulumi.AzureNative.Compute.V20171201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20171201:VirtualMachineScaleSet")]
    public partial class VirtualMachineScaleSet : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSet(string name, VirtualMachineScaleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20171201:VirtualMachineScaleSet", name, args ?? new VirtualMachineScaleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20171201:VirtualMachineScaleSet", name, null, MakeResourceOptions(options, id))
        {
        }
