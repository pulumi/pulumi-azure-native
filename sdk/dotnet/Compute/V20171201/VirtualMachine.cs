...
namespace Pulumi.AzureNextGen.Compute.V20171201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20171201:VirtualMachine")]
    public partial class VirtualMachine : Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20171201:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20171201:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
