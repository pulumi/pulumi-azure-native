...
namespace Pulumi.AzureNative.Compute.V20171201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20171201:VirtualMachine")]
    public partial class VirtualMachine : Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20171201:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20171201:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
