...
namespace Pulumi.AzureNative.Compute.V20171201.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetVMProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20171201.VirtualMachineEvictionPolicyTypes>? EvictionPolicy { get; set; }
        ...
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20171201.VirtualMachinePriorityTypes>? Priority { get; set; }
