...
namespace Pulumi.AzureNextGen.Compute.V20171201.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetVMProfileArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20171201.VirtualMachineEvictionPolicyTypes>? EvictionPolicy { get; set; }
        ...
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20171201.VirtualMachinePriorityTypes>? Priority { get; set; }
