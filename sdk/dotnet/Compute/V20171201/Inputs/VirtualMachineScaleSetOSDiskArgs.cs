...
namespace Pulumi.AzureNative.Compute.V20171201.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetOSDiskArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20171201.DiskCreateOptionTypes> CreateOption { get; set; } = null!;
        ...
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNative.Compute.V20171201.OperatingSystemTypes>? OsType { get; set; }
