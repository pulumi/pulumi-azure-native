...
namespace Pulumi.AzureRM.Compute
{
    ...
    public partial class GalleryImage : Pulumi.CustomResource
    {
        ...
        private GalleryImage(string name, Input<string> id, GalleryImageState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:compute:GalleryImage", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GalleryImage Get(string name, Input<string> id, GalleryImageState? state = null, CustomResourceOptions? options = null)
        {
            return new GalleryImage(name, id, state, options);
        }
    }
    ...
    public sealed class GalleryImageState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource location
        /// </summary>
        ...
        public Input<Inputs.GalleryImagePropertiesResponseGetArgs> Properties { get; set; } = null!;
