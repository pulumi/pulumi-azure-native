...
namespace Pulumi.AzureRM.Compute.V20170330
{
    ...
    ///     public MyStack()
    ///     {
    ///         var disk = new AzureRM.Compute.V20170330.Disk("disk", new AzureRM.Compute.V20170330.DiskArgs
    ///         {
    ///             CreationData = new AzureRM.Compute.V20170330.Inputs.CreationDataArgs
    ///             {
    ///                 CreateOption = "Copy",
    ...
    ///                 ImageReference = new AzureRM.Compute.V20170330.Inputs.ImageDiskReferenceArgs
    ///                 {
    ...
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20170330:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20170330:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
