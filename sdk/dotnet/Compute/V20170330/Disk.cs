...
namespace Pulumi.AzureNative.Compute.V20170330
{
    ...
    /// Disk resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20170330:Disk")]
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20170330:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20170330:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
