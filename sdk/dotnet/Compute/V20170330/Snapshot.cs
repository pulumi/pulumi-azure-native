...
namespace Pulumi.AzureNative.Compute.V20170330
{
    ...
    /// {
    ///     var snapshot = new AzureNative.Compute.V20170330.Snapshot("snapshot", new()
    ///     {
    ///         CreationData = new AzureNative.Compute.V20170330.Inputs.CreationDataArgs
    ///         {
    ///             CreateOption = AzureNative.Compute.V20170330.DiskCreateOption.Import,
    ...
    ///         CreationData = new AzureNative.Compute.V20170330.Inputs.CreationDataArgs
    ///         {
    ///             CreateOption = AzureNative.Compute.V20170330.DiskCreateOption.Copy,
    ...
    [AzureNativeResourceType("azure-native:compute/v20170330:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20170330:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20170330:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
