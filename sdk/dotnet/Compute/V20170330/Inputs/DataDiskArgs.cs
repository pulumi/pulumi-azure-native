...
namespace Pulumi.AzureNative.Compute.V20170330.Inputs
{
    ...
    public sealed class DataDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Compute.V20170330.CachingTypes>? Caching { get; set; }
        ...
        public Input<Pulumi.AzureNative.Compute.V20170330.DiskCreateOptionTypes> CreateOption { get; set; } = null!;
