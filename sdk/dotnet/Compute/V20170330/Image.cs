...
namespace Pulumi.AzureRM.Compute.V20170330
{
    ...
    ///     public MyStack()
    ///     {
    ///         var image = new AzureRM.Compute.V20170330.Image("image", new AzureRM.Compute.V20170330.ImageArgs
    ///         {
    ///             ImageName = "myImage",
    ///             Location = "West US",
    ///             ResourceGroupName = "myResourceGroup",
    ///             StorageProfile = new AzureRM.Compute.V20170330.Inputs.ImageStorageProfileArgs
    ///             {
    ///                 OsDisk = new AzureRM.Compute.V20170330.Inputs.ImageOSDiskArgs
    ///                 {
    ...
    ///                 OsDisk = new AzureRM.Compute.V20170330.Inputs.ImageOSDiskArgs
    ///                 {
    ///                     ManagedDisk = new AzureRM.Compute.V20170330.Inputs.SubResourceArgs
    ///                     {
    ...
    ///                     OsState = "Generalized",
    ///                     OsType = "Linux",
    ///                     Snapshot = new AzureRM.Compute.V20170330.Inputs.SubResourceArgs
    ///                     {
    ...
    ///             Location = "West US",
    ///             ResourceGroupName = "myResourceGroup",
    ///             SourceVirtualMachine = new AzureRM.Compute.V20170330.Inputs.SubResourceArgs
    ///             {
    ...
    ///                 DataDisks = 
    ///                 {
    ///                     new AzureRM.Compute.V20170330.Inputs.ImageDataDiskArgs
    ///                     {
    ...
    public partial class Image : Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20170330:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20170330:Image", name, null, MakeResourceOptions(options, id))
        {
        }
