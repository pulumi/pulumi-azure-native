...
namespace Pulumi.AzureRM.Compute.V20170330
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualMachine = new AzureRM.Compute.V20170330.VirtualMachine("virtualMachine", new AzureRM.Compute.V20170330.VirtualMachineArgs
    ///         {
    ///             HardwareProfile = new AzureRM.Compute.V20170330.Inputs.HardwareProfileArgs
    ///             {
    ///                 VmSize = "Standard_D1_v2",
    ///             },
    ///             Location = "westus",
    ///             NetworkProfile = new AzureRM.Compute.V20170330.Inputs.NetworkProfileArgs
    ///             {
    ///                 NetworkInterfaces = 
    ///                 {
    ///                     new AzureRM.Compute.V20170330.Inputs.NetworkInterfaceReferenceArgs
    ///                     {
    ///                         Id = "/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Network/networkInterfaces/{existing-nic-name}",
    ///                     },
    ///                 },
    ///             },
    ///             OsProfile = new AzureRM.Compute.V20170330.Inputs.OSProfileArgs
    ///             {
    ...
    ///             StorageProfile = new AzureRM.Compute.V20170330.Inputs.StorageProfileArgs
    ///             {
    ///                 OsDisk = new AzureRM.Compute.V20170330.Inputs.OSDiskArgs
    ///                 {
    ///                     Caching = "ReadWrite",
    ...
    ///                     Name = "myVMosdisk",
    ///                     OsType = "Windows",
    ///                     Vhd = new AzureRM.Compute.V20170330.Inputs.VirtualHardDiskArgs
    ///                     {
    ...
    ///                 DataDisks = 
    ///                 {
    ///                     new AzureRM.Compute.V20170330.Inputs.DataDiskArgs
    ///                     {
    ///                         CreateOption = "Empty",
    ///                         DiskSizeGB = 1023,
    ///                         Lun = 0,
    ...
    ///                     Caching = "ReadWrite",
    ///                     CreateOption = "FromImage",
    ///                     ManagedDisk = new AzureRM.Compute.V20170330.Inputs.ManagedDiskParametersArgs
    ///                     {
    ...
    ///         var virtualMachine = new AzureRM.Compute.V20170330.VirtualMachine("virtualMachine", new AzureRM.Compute.V20170330.VirtualMachineArgs
    ///         {
    ///             AvailabilitySet = new AzureRM.Compute.V20170330.Inputs.SubResourceArgs
    ///             {
    ...
    public partial class VirtualMachine : Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20170330:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20170330:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
