...
namespace Pulumi.AzureNextGen.Compute.V20170330
{
    public static class GetAvailabilitySet
    {
        public static Task<GetAvailabilitySetResult> InvokeAsync(GetAvailabilitySetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAvailabilitySetResult>("azure-nextgen:compute/v20170330:getAvailabilitySet", args ?? new GetAvailabilitySetArgs(), options.WithVersion());
    }
