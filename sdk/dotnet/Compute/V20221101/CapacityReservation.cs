...
namespace Pulumi.AzureNative.Compute.V20221101
{
    ...
    /// {
    ///     var capacityReservation = new AzureNative.Compute.V20221101.CapacityReservation("capacityReservation", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20221101:CapacityReservation")]
    public partial class CapacityReservation : global::Pulumi.CustomResource
    {
        ...
        public CapacityReservation(string name, CapacityReservationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:CapacityReservation", name, args ?? new CapacityReservationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:CapacityReservation", name, null, MakeResourceOptions(options, id))
        {
        }
