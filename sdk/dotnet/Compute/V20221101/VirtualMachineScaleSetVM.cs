...
namespace Pulumi.AzureNative.Compute.V20221101
{
    ...
    /// {
    ///     var virtualMachineScaleSetVM = new AzureNative.Compute.V20221101.VirtualMachineScaleSetVM("virtualMachineScaleSetVM", new()
    ///     {
    ...
    ///                 {
    ///                     DeleteOption = "Delete",
    ///                     DnsSettings = new AzureNative.Compute.V20221101.Inputs.VirtualMachineNetworkInterfaceDnsSettingsConfigurationArgs
    ///                     {
    ///                         DnsServers = new[]
    ///                         {
    ///                             "aaaaaa",
    ///                         },
    ///                     },
    ///                     DscpConfiguration = new AzureNative.Compute.V20221101.Inputs.SubResourceArgs
    ///                     {
    ///                         Id = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
    ///                     },
    ...
    ///                             {
    ///                                 DeleteOption = "Delete",
    ///                                 DnsSettings = new AzureNative.Compute.V20221101.Inputs.VirtualMachinePublicIPAddressDnsSettingsConfigurationArgs
    ///                                 {
    ...
    ///                                 IpTags = new[]
    ///                                 {
    ///                                     new AzureNative.Compute.V20221101.Inputs.VirtualMachineIpTagArgs
    ///                                     {
    ...
    ///                                 PublicIPPrefix = new AzureNative.Compute.V20221101.Inputs.SubResourceArgs
    ///                                 {
    ///                                     Id = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
    ///                                 },
    ...
    ///                                 },
    ///                             },
    ///                             Subnet = new AzureNative.Compute.V20221101.Inputs.SubResourceArgs
    ///                             {
    ///                                 Id = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
    ///                             },
    ///                         },
    ///                     },
    ///                     Name = "aaaaaaaaaaa",
    ///                     NetworkSecurityGroup = new AzureNative.Compute.V20221101.Inputs.SubResourceArgs
    ///                     {
    ///                         Id = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}",
    ///                     },
    ///                     Primary = true,
    ...
    ///             },
    ///         },
    ///         NetworkProfileConfiguration = new AzureNative.Compute.V20221101.Inputs.VirtualMachineScaleSetVMNetworkProfileConfigurationArgs
    ///         {
    ///             NetworkInterfaceConfigurations = new[]
    ///             {
    ...
    ///                 {
    ///                     DeleteOption = "Delete",
    ///                     DnsSettings = new AzureNative.Compute.V20221101.Inputs.VirtualMachineScaleSetNetworkConfigurationDnsSettingsArgs
    ///                     {
    ///                         DnsServers = new[] {},
    ///                     },
    ///                     EnableAcceleratedNetworking = true,
    ...
    ///                             {
    ///                                 DeleteOption = "Delete",
    ///                                 DnsSettings = new AzureNative.Compute.V20221101.Inputs.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsArgs
    ///                                 {
    ...
    ///                                 IpTags = new[]
    ///                                 {
    ///                                     new AzureNative.Compute.V20221101.Inputs.VirtualMachineScaleSetIpTagArgs
    ///                                     {
    ///                                         IpTagType = "aaaaaaa",
    ...
    ///                 {
    ///                     new AzureNative.Compute.V20221101.Inputs.AdditionalUnattendContentArgs
    ///                     {
    ///                         ComponentName = AzureNative.Compute.V20221101.ComponentNames.Microsoft_Windows_Shell_Setup,
    ///                         Content = "aaaaaaaaaaaaaaaaaaaa",
    ///                         PassName = AzureNative.Compute.V20221101.PassNames.OobeSystem,
    ///                         SettingName = AzureNative.Compute.V20221101.SettingNames.AutoLogon,
    ///                     },
    ///                 },
    ...
    ///                 WinRM = new AzureNative.Compute.V20221101.Inputs.WinRMConfigurationArgs
    ///                 {
    ///                     Listeners = new[]
    ///                     {
    ///                         new AzureNative.Compute.V20221101.Inputs.WinRMListenerArgs
    ///                         {
    ///                             CertificateUrl = "aaaaaaaaaaaaaaaaaaaaaa",
    ///                             Protocol = AzureNative.Compute.V20221101.ProtocolTypes.Http,
    ///                         },
    ///                     },
    ///                 },
    ///             },
    ...
    ///         },
    ///         ProtectionPolicy = new AzureNative.Compute.V20221101.Inputs.VirtualMachineScaleSetVMProtectionPolicyArgs
    ///         {
    ...
    ///                 {
    ///                     Caching = AzureNative.Compute.V20221101.CachingTypes.None,
    ///                     CreateOption = "Empty",
    ///                     DeleteOption = "Delete",
    ...
    ///                 },
    ///                 DiskSizeGB = 127,
    ///                 EncryptionSettings = new AzureNative.Compute.V20221101.Inputs.DiskEncryptionSettingsArgs
    ///                 {
    ///                     DiskEncryptionKey = new AzureNative.Compute.V20221101.Inputs.KeyVaultSecretReferenceArgs
    ///                     {
    ///                         SecretUrl = "aaaaaaaa",
    ...
    ///                     },
    ///                     Enabled = true,
    ///                     KeyEncryptionKey = new AzureNative.Compute.V20221101.Inputs.KeyVaultKeyReferenceArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20221101:VirtualMachineScaleSetVM")]
    public partial class VirtualMachineScaleSetVM : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVM(string name, VirtualMachineScaleSetVMArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:VirtualMachineScaleSetVM", name, args ?? new VirtualMachineScaleSetVMArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVM(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:VirtualMachineScaleSetVM", name, null, MakeResourceOptions(options, id))
        {
        }
