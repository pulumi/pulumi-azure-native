...
namespace Pulumi.AzureNative.Compute.V20221101
{
    ...
    /// {
    ///     var virtualMachineScaleSetVMExtension = new AzureNative.Compute.V20221101.VirtualMachineScaleSetVMExtension("virtualMachineScaleSetVMExtension", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:compute/v20221101:VirtualMachineScaleSetVMExtension myVMExtension /subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/virtualMachineScaleSets/myvmScaleSet/virtualMachines/0/extensions/myVMExtension 
    /// ```
    /// </summary>
    ...
    public partial class VirtualMachineScaleSetVMExtension : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVMExtension(string name, VirtualMachineScaleSetVMExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:VirtualMachineScaleSetVMExtension", name, args ?? new VirtualMachineScaleSetVMExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVMExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:VirtualMachineScaleSetVMExtension", name, null, MakeResourceOptions(options, id))
        {
        }
