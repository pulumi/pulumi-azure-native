...
namespace Pulumi.AzureNative.Compute.V20221101.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetStorageProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Compute.V20221101.DiskControllerTypes>>? _diskControllerType;
        public InputList<Union<string, Pulumi.AzureNative.Compute.V20221101.DiskControllerTypes>> DiskControllerType
        {
            get => _diskControllerType ?? (_diskControllerType = new InputList<Union<string, Pulumi.AzureNative.Compute.V20221101.DiskControllerTypes>>());
