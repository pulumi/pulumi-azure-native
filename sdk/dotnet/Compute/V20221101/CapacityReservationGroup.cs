...
namespace Pulumi.AzureNative.Compute.V20221101
{
    ...
    /// {
    ///     var capacityReservationGroup = new AzureNative.Compute.V20221101.CapacityReservationGroup("capacityReservationGroup", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20221101:CapacityReservationGroup")]
    public partial class CapacityReservationGroup : global::Pulumi.CustomResource
    {
        ...
        public CapacityReservationGroup(string name, CapacityReservationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:CapacityReservationGroup", name, args ?? new CapacityReservationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:CapacityReservationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
