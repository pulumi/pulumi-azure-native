...
namespace Pulumi.AzureNative.Compute.V20221101
{
    ...
    /// {
    ///     var restorePoint = new AzureNative.Compute.V20221101.RestorePoint("restorePoint", new()
    ///     {
    ///         ResourceGroupName = "myResourceGroup",
    ///         RestorePointCollectionName = "rpcName",
    ///         RestorePointName = "rpName",
    ///         SourceRestorePoint = new AzureNative.Compute.V20221101.Inputs.ApiEntityReferenceArgs
    ///         {
    ...
    ///         ExcludeDisks = new[]
    ///         {
    ///             new AzureNative.Compute.V20221101.Inputs.ApiEntityReferenceArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:compute/v20221101:RestorePoint rpName /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/restorePointCollections/rpcName/restorePoints/rpName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20221101:RestorePoint")]
    public partial class RestorePoint : global::Pulumi.CustomResource
    {
        ...
        public RestorePoint(string name, RestorePointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:RestorePoint", name, args ?? new RestorePointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:RestorePoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RestorePointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20221101.ConsistencyModeTypes>? ConsistencyMode { get; set; }
