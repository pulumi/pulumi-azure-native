...
{
    [Obsolete(@"azure-native:compute/v20221101:CapacityReservationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:CapacityReservationGroup to guarantee forwards compatibility.")]
    public static class GetCapacityReservationGroup
    {
        ...
        public static Task<GetCapacityReservationGroupResult> InvokeAsync(GetCapacityReservationGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCapacityReservationGroupResult>("azure-native:compute/v20221101:getCapacityReservationGroup", args ?? new GetCapacityReservationGroupArgs(), options.WithDefaults());
        ...
        public static Output<GetCapacityReservationGroupResult> Invoke(GetCapacityReservationGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCapacityReservationGroupResult>("azure-native:compute/v20221101:getCapacityReservationGroup", args ?? new GetCapacityReservationGroupInvokeArgs(), options.WithDefaults());
    }
