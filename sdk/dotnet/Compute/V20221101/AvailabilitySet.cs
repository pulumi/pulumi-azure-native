...
namespace Pulumi.AzureNative.Compute.V20221101
{
    ...
    /// {
    ///     var availabilitySet = new AzureNative.Compute.V20221101.AvailabilitySet("availabilitySet", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:compute/v20221101:AvailabilitySet myAvailabilitySet /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/availabilitySets/myAvailabilitySet 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20221101:AvailabilitySet")]
    public partial class AvailabilitySet : global::Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20221101:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
