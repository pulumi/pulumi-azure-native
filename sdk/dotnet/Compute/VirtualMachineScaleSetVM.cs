...
namespace Pulumi.AzureNextGen.Compute
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute:VirtualMachineScaleSetVM")]
    public partial class VirtualMachineScaleSetVM : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVM(string name, VirtualMachineScaleSetVMArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute:VirtualMachineScaleSetVM", name, args ?? new VirtualMachineScaleSetVMArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVM(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute:VirtualMachineScaleSetVM", name, null, MakeResourceOptions(options, id))
        {
        }
