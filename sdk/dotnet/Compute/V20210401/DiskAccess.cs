...
namespace Pulumi.AzureNative.Compute.V20210401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20210401:DiskAccess")]
    public partial class DiskAccess : global::Pulumi.CustomResource
    {
        ...
        public DiskAccess(string name, DiskAccessArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:DiskAccess", name, args ?? new DiskAccessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:DiskAccess", name, null, MakeResourceOptions(options, id))
        {
        }
