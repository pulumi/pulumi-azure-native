...
namespace Pulumi.AzureNative.Compute.V20210401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20210401:VirtualMachineScaleSetVM")]
    public partial class VirtualMachineScaleSetVM : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVM(string name, VirtualMachineScaleSetVMArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:VirtualMachineScaleSetVM", name, args ?? new VirtualMachineScaleSetVMArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVM(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:VirtualMachineScaleSetVM", name, null, MakeResourceOptions(options, id))
        {
        }
