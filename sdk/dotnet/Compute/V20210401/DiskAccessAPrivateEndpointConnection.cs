...
namespace Pulumi.AzureNative.Compute.V20210401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20210401:DiskAccessAPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20210401:DiskAccessAPrivateEndpointConnection")]
    public partial class DiskAccessAPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public DiskAccessAPrivateEndpointConnection(string name, DiskAccessAPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:DiskAccessAPrivateEndpointConnection", name, args ?? new DiskAccessAPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccessAPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:DiskAccessAPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
