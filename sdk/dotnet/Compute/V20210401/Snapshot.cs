...
namespace Pulumi.AzureNative.Compute.V20210401
{
    ...
    /// Snapshot resource.
    /// </summary>
    [Obsolete(@"azure-native:compute/v20210401:Snapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:Snapshot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20210401:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SnapshotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20210401.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20210401.NetworkAccessPolicy>? NetworkAccessPolicy { get; set; }

        /// <summary>
        /// The Operating System type.
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNative.Compute.V20210401.OperatingSystemTypes>? OsType { get; set; }

        /// <summary>
        /// Policy for controlling export on the disk.
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20210401.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
