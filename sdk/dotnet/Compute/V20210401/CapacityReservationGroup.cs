...
namespace Pulumi.AzureNative.Compute.V20210401
{
    ...
    public partial class CapacityReservationGroup : Pulumi.CustomResource
    {
        ...
        public CapacityReservationGroup(string name, CapacityReservationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:CapacityReservationGroup", name, args ?? new CapacityReservationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20210401:CapacityReservationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210401:CapacityReservationGroup"},
                    new Pulumi.Alias { Type = "azure-native:compute:CapacityReservationGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:compute:CapacityReservationGroup"},
                    new Pulumi.Alias { Type = "azure-native:compute/v20210701:CapacityReservationGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210701:CapacityReservationGroup"},
                },
            };
