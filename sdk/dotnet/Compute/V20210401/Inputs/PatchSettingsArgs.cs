...
namespace Pulumi.AzureNative.Compute.V20210401.Inputs
{
    ...
    public sealed class PatchSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20210401.WindowsPatchAssessmentMode>? AssessmentMode { get; set; }
        ...
        /// </summary>
        [Input("patchMode")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20210401.WindowsVMGuestPatchMode>? PatchMode { get; set; }
