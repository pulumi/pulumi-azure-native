        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210401:ProximityPlacementGroup"},
                    new Pulumi.Alias { Type = "azure-native:compute/v20210701:ProximityPlacementGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210701:ProximityPlacementGroup"},
                },
            };
