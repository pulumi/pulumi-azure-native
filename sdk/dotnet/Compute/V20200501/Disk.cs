...
namespace Pulumi.AzureNative.Compute.V20200501
{
    ...
    /// Disk resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20200501:Disk")]
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200501:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200501:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
