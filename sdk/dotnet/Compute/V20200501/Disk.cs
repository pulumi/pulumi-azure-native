...
namespace Pulumi.AzureRM.Compute.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var disk = new AzureRM.Compute.V20200501.Disk("disk", new AzureRM.Compute.V20200501.DiskArgs
    ///         {
    ...
    ///             DiskName = "myDisk",
    ///             DiskSizeGB = 200,
    ///             Encryption = new AzureRM.Compute.V20200501.Inputs.EncryptionArgs
    ///             {
    ...
    ///                 ImageReference = new AzureRM.Compute.V20200501.Inputs.ImageDiskReferenceArgs
    ///                 {
    ...
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200501:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200501:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
