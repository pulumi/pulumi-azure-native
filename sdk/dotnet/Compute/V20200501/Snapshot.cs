...
namespace Pulumi.AzureRM.Compute.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var snapshot = new AzureRM.Compute.V20200501.Snapshot("snapshot", new AzureRM.Compute.V20200501.SnapshotArgs
    ///         {
    ///             CreationData = new AzureRM.Compute.V20200501.Inputs.CreationDataArgs
    ///             {
    ///                 CreateOption = "Import",
    ...
    public partial class Snapshot : Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200501:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200501:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
