...
namespace Pulumi.AzureRM.Compute.V20200501
{
    ...
    ///     public MyStack()
    ///     {
    ///         var diskEncryptionSet = new AzureRM.Compute.V20200501.DiskEncryptionSet("diskEncryptionSet", new AzureRM.Compute.V20200501.DiskEncryptionSetArgs
    ///         {
    ///             ActiveKey = new AzureRM.Compute.V20200501.Inputs.KeyVaultAndKeyReferenceArgs
    ///             {
    ///                 KeyUrl = "https://myvmvault.vault-int.azure-int.net/keys/{key}",
    ///                 SourceVault = new AzureRM.Compute.V20200501.Inputs.SourceVaultArgs
    ///                 {
    ///                     Id = "/subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.KeyVault/vaults/myVMVault",
    ///                 },
    ///             },
    ///             DiskEncryptionSetName = "myDiskEncryptionSet",
    ///             Identity = new AzureRM.Compute.V20200501.Inputs.EncryptionSetIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "West US",
    ...
    public partial class DiskEncryptionSet : Pulumi.CustomResource
    {
        ...
        public DiskEncryptionSet(string name, DiskEncryptionSetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200501:DiskEncryptionSet", name, args ?? new DiskEncryptionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskEncryptionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200501:DiskEncryptionSet", name, null, MakeResourceOptions(options, id))
        {
        }
