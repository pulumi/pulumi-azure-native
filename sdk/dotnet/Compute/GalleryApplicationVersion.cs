...
namespace Pulumi.AzureRM.Compute
{
    ...
    public partial class GalleryApplicationVersion : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GalleryApplicationVersionPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public GalleryApplicationVersion(string name, GalleryApplicationVersionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute:GalleryApplicationVersion", name, args ?? new GalleryApplicationVersionArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private GalleryApplicationVersion(string name, Input<string> id, GalleryApplicationVersionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:compute:GalleryApplicationVersion", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GalleryApplicationVersionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.GalleryApplicationVersionPropertiesArgs>? Properties { get; set; }
    ...
    public sealed class GalleryApplicationVersionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource location
        /// </summary>
        ...
        public Input<Inputs.GalleryApplicationVersionPropertiesResponseGetArgs> Properties { get; set; } = null!;
