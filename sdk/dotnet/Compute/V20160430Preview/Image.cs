...
namespace Pulumi.AzureNextGen.Compute.V20160430Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20160430preview:Image")]
    public partial class Image : Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20160430preview:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20160430preview:Image", name, null, MakeResourceOptions(options, id))
        {
        }
