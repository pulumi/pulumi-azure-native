...
namespace Pulumi.AzureNextGen.Compute.V20160430Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20160430preview:VirtualMachine")]
    public partial class VirtualMachine : Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20160430preview:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20160430preview:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
