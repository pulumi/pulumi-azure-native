...
azure-native:compute/v20160430preview:VirtualMachine is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:VirtualMachine to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20160430preview:VirtualMachine")]
    public partial class VirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20160430preview:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20160430preview:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
