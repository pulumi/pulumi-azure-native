...
namespace Pulumi.AzureRM.Compute.V20160430Preview
{
    public static class GetVirtualMachine
    {
        public static Task<GetVirtualMachineResult> InvokeAsync(GetVirtualMachineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualMachineResult>("azurerm:compute/v20160430preview:getVirtualMachine", args ?? new GetVirtualMachineArgs(), options.WithVersion());
    }
