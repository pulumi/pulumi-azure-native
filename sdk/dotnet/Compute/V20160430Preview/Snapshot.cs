...
namespace Pulumi.AzureRM.Compute.V20160430Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var snapshot = new AzureRM.Compute.V20160430Preview.Snapshot("snapshot", new AzureRM.Compute.V20160430Preview.SnapshotArgs
    ///         {
    ///             CreationData = new AzureRM.Compute.V20160430Preview.Inputs.CreationDataArgs
    ///             {
    ///                 CreateOption = "Import",
    ...
    public partial class Snapshot : Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20160430preview:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20160430preview:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:compute/v20200630:Snapshot"},
                },
            };
