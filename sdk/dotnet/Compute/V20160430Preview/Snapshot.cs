...
namespace Pulumi.AzureNative.Compute.V20160430Preview
{
    ...
    /// {
    ///     var snapshot = new AzureNative.Compute.V20160430Preview.Snapshot("snapshot", new()
    ///     {
    ///         CreationData = new AzureNative.Compute.V20160430Preview.Inputs.CreationDataArgs
    ///         {
    ///             CreateOption = AzureNative.Compute.V20160430Preview.DiskCreateOption.Import,
    ...
    ///         CreationData = new AzureNative.Compute.V20160430Preview.Inputs.CreationDataArgs
    ///         {
    ///             CreateOption = AzureNative.Compute.V20160430Preview.DiskCreateOption.Copy,
    ...
    [AzureNativeResourceType("azure-native:compute/v20160430preview:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20160430preview:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20160430preview:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
