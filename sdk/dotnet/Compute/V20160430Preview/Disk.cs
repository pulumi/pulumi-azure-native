...
namespace Pulumi.AzureRM.Compute.V20160430Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var disk = new AzureRM.Compute.V20160430Preview.Disk("disk", new AzureRM.Compute.V20160430Preview.DiskArgs
    ///         {
    ...
    ///                 ImageReference = new AzureRM.Compute.V20160430Preview.Inputs.ImageDiskReferenceArgs
    ///                 {
    ...
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20160430preview:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20160430preview:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
