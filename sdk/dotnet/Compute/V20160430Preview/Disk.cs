...
namespace Pulumi.AzureNative.Compute.V20160430Preview
{
    ...
    /// {
    ///     var disk = new AzureNative.Compute.V20160430Preview.Disk("disk", new()
    ///     {
    ...
    ///         CreationData = new AzureNative.Compute.V20160430Preview.Inputs.CreationDataArgs
    ///         {
    ///             CreateOption = AzureNative.Compute.V20160430Preview.DiskCreateOption.FromImage,
    ///             ImageReference = new AzureNative.Compute.V20160430Preview.Inputs.ImageDiskReferenceArgs
    ///             {
    ...
    ///         DiskName = "myDisk",
    ///         Location = "West US",
    ///         OsType = AzureNative.Compute.V20160430Preview.OperatingSystemTypes.Windows,
    ///         ResourceGroupName = "myResourceGroup",
    ///     });
    /// 
    /// });
    ...
    ///         CreationData = new AzureNative.Compute.V20160430Preview.Inputs.CreationDataArgs
    ///         {
    ///             CreateOption = AzureNative.Compute.V20160430Preview.DiskCreateOption.Empty,
    ///         },
    ///         DiskName = "myDisk",
    ///         DiskSizeGB = 200,
    ///         Location = "West US",
