...
namespace Pulumi.AzureRM.Compute.V20160430Preview
{
    ...
    public partial class AvailabilitySet : Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20160430preview:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20160430preview:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
