...
namespace Pulumi.AzureNextGen.Compute.V20160430Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20160430preview:AvailabilitySet")]
    public partial class AvailabilitySet : Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20160430preview:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20160430preview:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
