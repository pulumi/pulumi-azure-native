...
namespace Pulumi.AzureNative.Compute.V20160430Preview
{
    ...
    public partial class VirtualMachineScaleSet : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSet(string name, VirtualMachineScaleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20160430preview:VirtualMachineScaleSet", name, args ?? new VirtualMachineScaleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20160430preview:VirtualMachineScaleSet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210301:VirtualMachineScaleSet"},
                    new Pulumi.Alias { Type = "azure-native:compute/v20210401:VirtualMachineScaleSet"},
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210401:VirtualMachineScaleSet"},
                    new Pulumi.Alias { Type = "azure-native:compute/v20210701:VirtualMachineScaleSet"},
                    new Pulumi.Alias { Type = "azure-nextgen:compute/v20210701:VirtualMachineScaleSet"},
                },
            };
