...
namespace Pulumi.AzureNative.Compute.V20220803.Inputs
{
    ...
    public sealed class GalleryImageVersionPublishingProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220803.ReplicationMode>? ReplicationMode { get; set; }

        /// <summary>
        /// Specifies the storage account type to be used to store the image. This property is not updatable.
        /// </summary>
        [Input("storageAccountType")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220803.StorageAccountType>? StorageAccountType { get; set; }
