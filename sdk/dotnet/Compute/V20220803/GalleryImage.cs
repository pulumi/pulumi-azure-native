...
namespace Pulumi.AzureNative.Compute.V20220803
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20220803:GalleryImage")]
    public partial class GalleryImage : global::Pulumi.CustomResource
    {
        ...
        public GalleryImage(string name, GalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220803:GalleryImage", name, args ?? new GalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220803:GalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GalleryImageArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("architecture")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220803.Architecture>? Architecture { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220803.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public Input<Pulumi.AzureNative.Compute.V20220803.OperatingSystemStateTypes> OsState { get; set; } = null!;

        /// <summary>
        /// This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. Possible values are: **Windows,** **Linux.**
        /// </summary>
        [Input("osType", required: true)]
        public Input<Pulumi.AzureNative.Compute.V20220803.OperatingSystemTypes> OsType { get; set; } = null!;
