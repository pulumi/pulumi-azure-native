...
namespace Pulumi.AzureNative.Compute.V20220404
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20220404:CloudService is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220904:CloudService to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20220404:CloudService")]
    public partial class CloudService : global::Pulumi.CustomResource
    {
        ...
        public CloudService(string name, CloudServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220404:CloudService", name, args ?? new CloudServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220404:CloudService", name, null, MakeResourceOptions(options, id))
        {
        }
