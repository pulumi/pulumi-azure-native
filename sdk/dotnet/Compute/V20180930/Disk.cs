...
namespace Pulumi.AzureRM.Compute.V20180930
{
    ...
    ///     public MyStack()
    ///     {
    ///         var disk = new AzureRM.Compute.V20180930.Disk("disk", new AzureRM.Compute.V20180930.DiskArgs
    ///         {
    ...
    ///                 ImageReference = new AzureRM.Compute.V20180930.Inputs.ImageDiskReferenceArgs
    ///                 {
    ...
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180930:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180930:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
