...
namespace Pulumi.AzureNative.Compute.V20180930
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20180930:Disk")]
    public partial class Disk : global::Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20180930:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20180930:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20180930.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNative.Compute.V20180930.OperatingSystemTypes>? OsType { get; set; }
