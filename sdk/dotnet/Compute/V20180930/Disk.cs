...
namespace Pulumi.AzureNextGen.Compute.V20180930
{
    ...
    /// Disk resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20180930:Disk")]
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180930:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180930:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiskArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20180930.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNextGen.Compute.V20180930.OperatingSystemTypes>? OsType { get; set; }
