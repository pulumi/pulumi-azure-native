...
namespace Pulumi.AzureNextGen.Compute.V20181120
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20181120:GuestConfigurationAssignment")]
    public partial class GuestConfigurationAssignment : Pulumi.CustomResource
    {
        ...
        public GuestConfigurationAssignment(string name, GuestConfigurationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20181120:GuestConfigurationAssignment", name, args ?? new GuestConfigurationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20181120:GuestConfigurationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
