...
namespace Pulumi.AzureRM.Compute.V20181120
{
    ...
    ///     public MyStack()
    ///     {
    ///         var guestConfigurationAssignment = new AzureRM.Compute.V20181120.GuestConfigurationAssignment("guestConfigurationAssignment", new AzureRM.Compute.V20181120.GuestConfigurationAssignmentArgs
    ///         {
    ...
    public partial class GuestConfigurationAssignment : Pulumi.CustomResource
    {
        ...
        public GuestConfigurationAssignment(string name, GuestConfigurationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20181120:GuestConfigurationAssignment", name, args ?? new GuestConfigurationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestConfigurationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20181120:GuestConfigurationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
