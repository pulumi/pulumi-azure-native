...
namespace Pulumi.AzureNextGen.Compute.V20200930
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20200930:DiskEncryptionSet")]
    public partial class DiskEncryptionSet : Pulumi.CustomResource
    {
        ...
        public DiskEncryptionSet(string name, DiskEncryptionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200930:DiskEncryptionSet", name, args ?? new DiskEncryptionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskEncryptionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200930:DiskEncryptionSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiskEncryptionSetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20200930.DiskEncryptionSetType>? EncryptionType { get; set; }
