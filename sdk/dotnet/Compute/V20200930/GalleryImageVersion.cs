...
namespace Pulumi.AzureNextGen.Compute.V20200930
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20200930:GalleryImageVersion")]
    public partial class GalleryImageVersion : Pulumi.CustomResource
    {
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200930:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200930:GalleryImageVersion", name, null, MakeResourceOptions(options, id))
        {
        }
