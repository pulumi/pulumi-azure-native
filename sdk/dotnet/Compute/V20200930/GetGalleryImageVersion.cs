...
namespace Pulumi.AzureNative.Compute.V20200930
{
    public static class GetGalleryImageVersion
    {
        ...
        public static Output<GetGalleryImageVersionResult> Invoke(GetGalleryImageVersionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGalleryImageVersionResult>("azure-native:compute/v20200930:getGalleryImageVersion", args ?? new GetGalleryImageVersionInvokeArgs(), options.WithVersion());
    }
