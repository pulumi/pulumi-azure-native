...
namespace Pulumi.AzureNative.Compute.V20200930
{
    ...
    /// {
    ///     var galleryApplicationVersion = new AzureNative.Compute.V20200930.GalleryApplicationVersion("galleryApplicationVersion", new()
    ///     {
    ///         GalleryApplicationName = "myGalleryApplicationName",
    ///         GalleryApplicationVersionName = "1.0.0",
    ///         GalleryName = "myGalleryName",
    ///         Location = "West US",
    ///         PublishingProfile = new AzureNative.Compute.V20200930.Inputs.GalleryApplicationVersionPublishingProfileArgs
    ///         {
    ///             EndOfLifeDate = "2019-07-01T07:00:00Z",
    ///             ManageActions = new AzureNative.Compute.V20200930.Inputs.UserArtifactManageArgs
    ///             {
    ///                 Install = "powershell -command \"Expand-Archive -Path package.zip -DestinationPath C:\\package\"",
    ///                 Remove = "del C:\\package ",
    ///             },
    ///             ReplicaCount = 1,
    ///             Source = new AzureNative.Compute.V20200930.Inputs.UserArtifactSourceArgs
    ///             {
    ...
    ///             TargetRegions = new[]
    ///             {
    ///                 new AzureNative.Compute.V20200930.Inputs.TargetRegionArgs
    ///                 {
    ///                     Name = "West US",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20200930:GalleryApplicationVersion")]
    public partial class GalleryApplicationVersion : global::Pulumi.CustomResource
    {
        ...
        public GalleryApplicationVersion(string name, GalleryApplicationVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200930:GalleryApplicationVersion", name, args ?? new GalleryApplicationVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryApplicationVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200930:GalleryApplicationVersion", name, null, MakeResourceOptions(options, id))
        {
        }
