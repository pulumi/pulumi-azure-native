...
namespace Pulumi.AzureRM.Compute.V20200930
{
    ...
    ///     public MyStack()
    ///     {
    ///         var galleryApplication = new AzureRM.Compute.V20200930.GalleryApplication("galleryApplication", new AzureRM.Compute.V20200930.GalleryApplicationArgs
    ///         {
    ...
    public partial class GalleryApplication : Pulumi.CustomResource
    {
        ...
        public GalleryApplication(string name, GalleryApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200930:GalleryApplication", name, args ?? new GalleryApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryApplication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200930:GalleryApplication", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:compute/latest:GalleryApplication"},
