...
namespace Pulumi.AzureNextGen.Compute.V20200930
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20200930:GalleryApplication")]
    public partial class GalleryApplication : Pulumi.CustomResource
    {
        ...
        public GalleryApplication(string name, GalleryApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200930:GalleryApplication", name, args ?? new GalleryApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryApplication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200930:GalleryApplication", name, null, MakeResourceOptions(options, id))
        {
        }
