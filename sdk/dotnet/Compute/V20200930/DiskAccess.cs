...
namespace Pulumi.AzureNextGen.Compute.V20200930
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20200930:DiskAccess")]
    public partial class DiskAccess : Pulumi.CustomResource
    {
        ...
        public DiskAccess(string name, DiskAccessArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200930:DiskAccess", name, args ?? new DiskAccessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20200930:DiskAccess", name, null, MakeResourceOptions(options, id))
        {
        }
