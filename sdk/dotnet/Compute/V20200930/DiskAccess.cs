...
namespace Pulumi.AzureNative.Compute.V20200930
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20200930:DiskAccess is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskAccess to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20200930:DiskAccess")]
    public partial class DiskAccess : global::Pulumi.CustomResource
    {
        ...
        public DiskAccess(string name, DiskAccessArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200930:DiskAccess", name, args ?? new DiskAccessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200930:DiskAccess", name, null, MakeResourceOptions(options, id))
        {
        }
