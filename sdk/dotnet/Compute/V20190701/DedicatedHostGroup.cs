...
namespace Pulumi.AzureRM.Compute.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dedicatedHostGroup = new AzureRM.Compute.V20190701.DedicatedHostGroup("dedicatedHostGroup", new AzureRM.Compute.V20190701.DedicatedHostGroupArgs
    ///         {
    ...
    public partial class DedicatedHostGroup : Pulumi.CustomResource
    {
        ...
        public DedicatedHostGroup(string name, DedicatedHostGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:DedicatedHostGroup", name, args ?? new DedicatedHostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHostGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:DedicatedHostGroup", name, null, MakeResourceOptions(options, id))
        {
        }
