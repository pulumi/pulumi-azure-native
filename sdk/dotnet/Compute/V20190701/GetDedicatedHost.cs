...
namespace Pulumi.AzureRM.Compute.V20190701
{
    public static class GetDedicatedHost
    {
        public static Task<GetDedicatedHostResult> InvokeAsync(GetDedicatedHostArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedHostResult>("azurerm:compute/v20190701:getDedicatedHost", args ?? new GetDedicatedHostArgs(), options.WithVersion());
    }
