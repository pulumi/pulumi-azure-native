    ...
    public partial class GalleryImage : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:compute/v20180601:GalleryImage"},
                    new Alias { Type = "azurerm:compute/v20190301:GalleryImage"},
                    new Alias { Type = "azurerm:compute/v20191201:GalleryImage"},
                },
            };
