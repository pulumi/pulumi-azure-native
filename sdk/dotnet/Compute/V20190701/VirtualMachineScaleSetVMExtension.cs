...
namespace Pulumi.AzureRM.Compute.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualMachineScaleSetVMExtension = new AzureRM.Compute.V20190701.VirtualMachineScaleSetVMExtension("virtualMachineScaleSetVMExtension", new AzureRM.Compute.V20190701.VirtualMachineScaleSetVMExtensionArgs
    ///         {
    ...
    public partial class VirtualMachineScaleSetVMExtension : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVMExtension(string name, VirtualMachineScaleSetVMExtensionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:VirtualMachineScaleSetVMExtension", name, args ?? new VirtualMachineScaleSetVMExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVMExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:VirtualMachineScaleSetVMExtension", name, null, MakeResourceOptions(options, id))
        {
        }
