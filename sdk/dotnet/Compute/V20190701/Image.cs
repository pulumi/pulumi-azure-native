...
azure-native:compute/v20190701:Image is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:Image to guarantee forwards compatibility.")]
    ...
    public partial class Image : global::Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190701:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190701:Image", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ImageArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20190701.HyperVGenerationTypes>? HyperVGeneration { get; set; }
