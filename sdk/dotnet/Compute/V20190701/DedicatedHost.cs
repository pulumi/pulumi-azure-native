...
azure-native:compute/v20190701:DedicatedHost is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20221101:DedicatedHost to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20190701:DedicatedHost")]
    public partial class DedicatedHost : global::Pulumi.CustomResource
    {
        ...
        public DedicatedHost(string name, DedicatedHostArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190701:DedicatedHost", name, args ?? new DedicatedHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190701:DedicatedHost", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DedicatedHostArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public Input<Pulumi.AzureNative.Compute.V20190701.DedicatedHostLicenseTypes>? LicenseType { get; set; }
