...
namespace Pulumi.AzureRM.Compute.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dedicatedHost = new AzureRM.Compute.V20190701.DedicatedHost("dedicatedHost", new AzureRM.Compute.V20190701.DedicatedHostArgs
    ///         {
    ...
    ///             Sku = new AzureRM.Compute.V20190701.Inputs.SkuArgs
    ///             {
    ///                 Name = "DSv3-Type1",
    ///             },
    ///             Tags = 
    ...
    public partial class DedicatedHost : Pulumi.CustomResource
    {
        ...
        public DedicatedHost(string name, DedicatedHostArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:DedicatedHost", name, args ?? new DedicatedHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:DedicatedHost", name, null, MakeResourceOptions(options, id))
        {
        }
