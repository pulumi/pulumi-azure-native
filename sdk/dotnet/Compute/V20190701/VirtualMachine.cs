...
namespace Pulumi.AzureNative.Compute.V20190701
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20190701:VirtualMachine")]
    public partial class VirtualMachine : Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190701:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190701:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualMachineArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20190701.VirtualMachineEvictionPolicyTypes>? EvictionPolicy { get; set; }
        ...
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20190701.VirtualMachinePriorityTypes>? Priority { get; set; }
