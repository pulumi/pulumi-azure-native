...
namespace Pulumi.AzureNative.Compute.V20190701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20190701:DiskEncryptionSet")]
    public partial class DiskEncryptionSet : Pulumi.CustomResource
    {
        ...
        public DiskEncryptionSet(string name, DiskEncryptionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190701:DiskEncryptionSet", name, args ?? new DiskEncryptionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskEncryptionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20190701:DiskEncryptionSet", name, null, MakeResourceOptions(options, id))
        {
        }
