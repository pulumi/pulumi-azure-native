...
namespace Pulumi.AzureRM.Compute.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var diskEncryptionSet = new AzureRM.Compute.V20190701.DiskEncryptionSet("diskEncryptionSet", new AzureRM.Compute.V20190701.DiskEncryptionSetArgs
    ///         {
    ///             ActiveKey = new AzureRM.Compute.V20190701.Inputs.KeyVaultAndKeyReferenceArgs
    ///             {
    ///                 KeyUrl = "https://myvmvault.vault-int.azure-int.net/keys/{key}",
    ///                 SourceVault = new AzureRM.Compute.V20190701.Inputs.SourceVaultArgs
    ///                 {
    ///                     Id = "/subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.KeyVault/vaults/myVMVault",
    ///                 },
    ///             },
    ///             DiskEncryptionSetName = "myDiskEncryptionSet",
    ///             Identity = new AzureRM.Compute.V20190701.Inputs.EncryptionSetIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "West US",
