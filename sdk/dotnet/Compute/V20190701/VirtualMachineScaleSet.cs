...
namespace Pulumi.AzureRM.Compute.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualMachineScaleSet = new AzureRM.Compute.V20190701.VirtualMachineScaleSet("virtualMachineScaleSet", new AzureRM.Compute.V20190701.VirtualMachineScaleSetArgs
    ///         {
    ///             Location = "westus",
    ///             Overprovision = true,
    ...
    ///                 Tier = "Standard",
    ///             },
    ///             UpgradePolicy = new AzureRM.Compute.V20190701.Inputs.UpgradePolicyArgs
    ///             {
    ///                 Mode = "Manual",
    ///             },
    ///             VirtualMachineProfile = new AzureRM.Compute.V20190701.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///             {
    ///                 NetworkProfile = new AzureRM.Compute.V20190701.Inputs.VirtualMachineScaleSetNetworkProfileArgs
    ///                 {
    ///                     NetworkInterfaceConfigurations = 
    ///                     {
    ///                         new AzureRM.Compute.V20190701.Inputs.VirtualMachineScaleSetNetworkConfigurationArgs
    ///                         {
    ///                             Name = "{vmss-name}",
    ///                         },
    ///                     },
    ///                 },
    ///                 OsProfile = new AzureRM.Compute.V20190701.Inputs.VirtualMachineScaleSetOSProfileArgs
    ///                 {
    ///                     AdminPassword = "{your-password}",
    ///                     AdminUsername = "{your-username}",
    ///                     ComputerNamePrefix = "{vmss-name}",
    ///                 },
    ///                 StorageProfile = new AzureRM.Compute.V20190701.Inputs.VirtualMachineScaleSetStorageProfileArgs
    ///                 {
    ///                     OsDisk = new AzureRM.Compute.V20190701.Inputs.VirtualMachineScaleSetOSDiskArgs
    ///                     {
    ///                         Caching = "ReadWrite",
    ...
    ///                         Caching = "ReadWrite",
    ///                         CreateOption = "FromImage",
    ///                         ManagedDisk = new AzureRM.Compute.V20190701.Inputs.VirtualMachineScaleSetManagedDiskParametersArgs
    ///                         {
    ...
    ///                     DataDisks = 
    ///                     {
    ///                         new AzureRM.Compute.V20190701.Inputs.VirtualMachineScaleSetDataDiskArgs
    ///                         {
    ///                             Caching = "ReadWrite",
    ///                             CreateOption = "Empty",
    ///                             DiskSizeGB = 1023,
    ...
    ///         var virtualMachineScaleSet = new AzureRM.Compute.V20190701.VirtualMachineScaleSet("virtualMachineScaleSet", new AzureRM.Compute.V20190701.VirtualMachineScaleSetArgs
    ///         {
    ///             AutomaticRepairsPolicy = new AzureRM.Compute.V20190701.Inputs.AutomaticRepairsPolicyArgs
    ///             {
    ///                 Enabled = true,
    ///                 GracePeriod = "PT30M",
    ///             },
    ...
    ///                     ComputerNamePrefix = "{vmss-name}",
    ///                 },
    ///                 ScheduledEventsProfile = new AzureRM.Compute.V20190701.Inputs.ScheduledEventsProfileArgs
    ///                 {
    ///                     TerminateNotificationProfile = new AzureRM.Compute.V20190701.Inputs.TerminateNotificationProfileArgs
    ///                     {
    ///                         Enable = true,
    ...
    public partial class VirtualMachineScaleSet : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSet(string name, VirtualMachineScaleSetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:VirtualMachineScaleSet", name, args ?? new VirtualMachineScaleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:VirtualMachineScaleSet", name, null, MakeResourceOptions(options, id))
        {
        }
