...
namespace Pulumi.AzureNextGen.Compute.V20190701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20190701:Gallery")]
    public partial class Gallery : Pulumi.CustomResource
    {
        ...
        public Gallery(string name, GalleryArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190701:Gallery", name, args ?? new GalleryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gallery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190701:Gallery", name, null, MakeResourceOptions(options, id))
        {
        }
