...
namespace Pulumi.AzureRM.Compute.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var gallery = new AzureRM.Compute.V20190701.Gallery("gallery", new AzureRM.Compute.V20190701.GalleryArgs
    ///         {
    ...
    public partial class Gallery : Pulumi.CustomResource
    {
        ...
        public Gallery(string name, GalleryArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:Gallery", name, args ?? new GalleryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gallery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:Gallery", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:compute/latest:Gallery"},
                    new Pulumi.Alias { Type = "azurerm:compute/v20180601:Gallery"},
