...
namespace Pulumi.AzureNative.Compute.V20190701
{
    ...
    public static class GetGalleryImage
    {
        ...
        public static Task<GetGalleryImageResult> InvokeAsync(GetGalleryImageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGalleryImageResult>("azure-native:compute/v20190701:getGalleryImage", args ?? new GetGalleryImageArgs(), options.WithDefaults());

        /// <summary>
        /// Specifies information about the gallery Image Definition that you want to create or update.
        /// </summary>
        public static Output<GetGalleryImageResult> Invoke(GetGalleryImageInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGalleryImageResult>("azure-native:compute/v20190701:getGalleryImage", args ?? new GetGalleryImageInvokeArgs(), options.WithDefaults());
    }
