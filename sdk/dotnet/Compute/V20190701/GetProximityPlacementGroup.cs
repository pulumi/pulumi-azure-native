...
namespace Pulumi.AzureNative.Compute.V20190701
{
    public static class GetProximityPlacementGroup
    {
        ...
        public static Task<GetProximityPlacementGroupResult> InvokeAsync(GetProximityPlacementGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProximityPlacementGroupResult>("azure-native:compute/v20190701:getProximityPlacementGroup", args ?? new GetProximityPlacementGroupArgs(), options.WithVersion());
        ...
        public static Output<GetProximityPlacementGroupResult> Invoke(GetProximityPlacementGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProximityPlacementGroupResult>("azure-native:compute/v20190701:getProximityPlacementGroup", args ?? new GetProximityPlacementGroupInvokeArgs(), options.WithVersion());
    }
