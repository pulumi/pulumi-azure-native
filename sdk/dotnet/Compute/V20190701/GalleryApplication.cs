...
namespace Pulumi.AzureNextGen.Compute.V20190701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20190701:GalleryApplication")]
    public partial class GalleryApplication : Pulumi.CustomResource
    {
        ...
        public GalleryApplication(string name, GalleryApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190701:GalleryApplication", name, args ?? new GalleryApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryApplication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190701:GalleryApplication", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GalleryApplicationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Compute.V20190701.OperatingSystemTypes> SupportedOSType { get; set; } = null!;
