...
namespace Pulumi.AzureNextGen.Compute.V20190701
{
    ...
    /// Disk resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20190701:Disk")]
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190701:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20190701:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
