...
namespace Pulumi.AzureRM.Compute.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var disk = new AzureRM.Compute.V20190701.Disk("disk", new AzureRM.Compute.V20190701.DiskArgs
    ///         {
    ///             CreationData = new AzureRM.Compute.V20190701.Inputs.CreationDataArgs
    ///             {
    ///                 CreateOption = "Copy",
    ...
    ///                 ImageReference = new AzureRM.Compute.V20190701.Inputs.ImageDiskReferenceArgs
    ///                 {
    ...
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20190701:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
