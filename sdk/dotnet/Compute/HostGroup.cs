...
namespace Pulumi.AzureRM.Compute
{
    ...
    public partial class HostGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DedicatedHostGroupPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public HostGroup(string name, HostGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute:HostGroup", name, args ?? new HostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
