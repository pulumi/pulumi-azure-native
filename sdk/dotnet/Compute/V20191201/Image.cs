...
namespace Pulumi.AzureRM.Compute.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var image = new AzureRM.Compute.V20191201.Image("image", new AzureRM.Compute.V20191201.ImageArgs
    ///         {
    ///             ImageName = "myImage",
    ///             Location = "West US",
    ///             ResourceGroupName = "myResourceGroup",
    ///             StorageProfile = new AzureRM.Compute.V20191201.Inputs.ImageStorageProfileArgs
    ///             {
    ///                 OsDisk = new AzureRM.Compute.V20191201.Inputs.ImageOSDiskArgs
    ///                 {
    ///                     BlobUri = "https://mystorageaccount.blob.core.windows.net/osimages/osimage.vhd",
    ///                     DiskEncryptionSet = new AzureRM.Compute.V20191201.Inputs.DiskEncryptionSetParametersArgs
    ///                     {
    ...
    ///                         Id = "/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/diskEncryptionSets/{existing-diskEncryptionSet-name}",
    ///                     },
    ///                     ManagedDisk = new AzureRM.Compute.V20191201.Inputs.SubResourceArgs
    ///                     {
    ...
    ///                     OsState = "Generalized",
    ///                     OsType = "Linux",
    ///                     Snapshot = new AzureRM.Compute.V20191201.Inputs.SubResourceArgs
    ///                     {
    ...
    ///             Location = "West US",
    ///             ResourceGroupName = "myResourceGroup",
    ///             SourceVirtualMachine = new AzureRM.Compute.V20191201.Inputs.SubResourceArgs
    ///             {
    ...
    ///                 DataDisks = 
    ///                 {
    ///                     new AzureRM.Compute.V20191201.Inputs.ImageDataDiskArgs
    ///                     {
    ...
    public partial class Image : Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:Image", name, null, MakeResourceOptions(options, id))
        {
        }
