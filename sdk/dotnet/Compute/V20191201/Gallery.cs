...
namespace Pulumi.AzureNative.Compute.V20191201
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20191201:Gallery")]
    public partial class Gallery : Pulumi.CustomResource
    {
        ...
        public Gallery(string name, GalleryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:Gallery", name, args ?? new GalleryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gallery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:Gallery", name, null, MakeResourceOptions(options, id))
        {
        }
