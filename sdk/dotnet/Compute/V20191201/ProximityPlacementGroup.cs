...
namespace Pulumi.AzureNative.Compute.V20191201
{
    ...
    public partial class ProximityPlacementGroup : Pulumi.CustomResource
    {
        ...
        public ProximityPlacementGroup(string name, ProximityPlacementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:ProximityPlacementGroup", name, args ?? new ProximityPlacementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProximityPlacementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:ProximityPlacementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProximityPlacementGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20191201.ProximityPlacementGroupType>? ProximityPlacementGroupType { get; set; }
