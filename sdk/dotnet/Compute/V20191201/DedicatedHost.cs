...
namespace Pulumi.AzureNextGen.Compute.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20191201:DedicatedHost")]
    public partial class DedicatedHost : Pulumi.CustomResource
    {
        ...
        public DedicatedHost(string name, DedicatedHostArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20191201:DedicatedHost", name, args ?? new DedicatedHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20191201:DedicatedHost", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DedicatedHostArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public Input<Pulumi.AzureNextGen.Compute.V20191201.DedicatedHostLicenseTypes>? LicenseType { get; set; }
