...
namespace Pulumi.AzureNative.Compute.V20191201
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20191201:DedicatedHost")]
    public partial class DedicatedHost : global::Pulumi.CustomResource
    {
        ...
        public DedicatedHost(string name, DedicatedHostArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:DedicatedHost", name, args ?? new DedicatedHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:DedicatedHost", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DedicatedHostArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public Input<Pulumi.AzureNative.Compute.V20191201.DedicatedHostLicenseTypes>? LicenseType { get; set; }
