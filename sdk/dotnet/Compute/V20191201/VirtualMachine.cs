...
namespace Pulumi.AzureRM.Compute.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualMachine = new AzureRM.Compute.V20191201.VirtualMachine("virtualMachine", new AzureRM.Compute.V20191201.VirtualMachineArgs
    ///         {
    ///             HardwareProfile = new AzureRM.Compute.V20191201.Inputs.HardwareProfileArgs
    ///             {
    ///                 VmSize = "Standard_D1_v2",
    ///             },
    ///             Location = "westus",
    ///             NetworkProfile = new AzureRM.Compute.V20191201.Inputs.NetworkProfileArgs
    ///             {
    ///                 NetworkInterfaces = 
    ///                 {
    ///                     new AzureRM.Compute.V20191201.Inputs.NetworkInterfaceReferenceArgs
    ///                     {
    ///                         Id = "/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Network/networkInterfaces/{existing-nic-name}",
    ///                     },
    ///                 },
    ///             },
    ///             OsProfile = new AzureRM.Compute.V20191201.Inputs.OSProfileArgs
    ///             {
    ...
    ///             StorageProfile = new AzureRM.Compute.V20191201.Inputs.StorageProfileArgs
    ///             {
    ///                 OsDisk = new AzureRM.Compute.V20191201.Inputs.OSDiskArgs
    ///                 {
    ///                     Caching = "ReadWrite",
    ///                     CreateOption = "FromImage",
    ///                     Image = new AzureRM.Compute.V20191201.Inputs.VirtualHardDiskArgs
    ///                     {
    ///                         Uri = "http://{existing-storage-account-name}.blob.core.windows.net/{existing-container-name}/{existing-generalized-os-image-blob-name}.vhd",
    ///                     },
    ///                     Name = "myVMosdisk",
    ///                     OsType = "Windows",
    ///                     Vhd = new AzureRM.Compute.V20191201.Inputs.VirtualHardDiskArgs
    ///                     {
    ...
    ///                 DataDisks = 
    ///                 {
    ///                     new AzureRM.Compute.V20191201.Inputs.DataDiskArgs
    ///                     {
    ///                         CreateOption = "Empty",
    ///                         DiskSizeGB = 1023,
    ///                         Lun = 0,
    ...
    ///                     },
    ///                 },
    ///                 ImageReference = new AzureRM.Compute.V20191201.Inputs.ImageReferenceArgs
    ///                 {
    ///                     Offer = "WindowsServer",
    ...
    ///                     Caching = "ReadWrite",
    ///                     CreateOption = "FromImage",
    ///                     ManagedDisk = new AzureRM.Compute.V20191201.Inputs.ManagedDiskParametersArgs
    ///                     {
    ...
    ///         var virtualMachine = new AzureRM.Compute.V20191201.VirtualMachine("virtualMachine", new AzureRM.Compute.V20191201.VirtualMachineArgs
    ///         {
    ///             AvailabilitySet = new AzureRM.Compute.V20191201.Inputs.SubResourceArgs
    ///             {
    ...
    ///                 ComputerName = "myVM",
    ///             },
    ///             Plan = new AzureRM.Compute.V20191201.Inputs.PlanArgs
    ///             {
    ///                 Name = "windows2016",
    ...
    ///         var virtualMachine = new AzureRM.Compute.V20191201.VirtualMachine("virtualMachine", new AzureRM.Compute.V20191201.VirtualMachineArgs
    ///         {
    ///             DiagnosticsProfile = new AzureRM.Compute.V20191201.Inputs.DiagnosticsProfileArgs
    ///             {
    ///                 BootDiagnostics = new AzureRM.Compute.V20191201.Inputs.BootDiagnosticsArgs
    ///                 {
    ///                     Enabled = true,
    ...
    ///                     Caching = "ReadOnly",
    ///                     CreateOption = "FromImage",
    ///                     DiffDiskSettings = new AzureRM.Compute.V20191201.Inputs.DiffDiskSettingsArgs
    ///                     {
    ///                         Option = "Local",
    ///                         Placement = "CacheDisk",
    ///                     },
    ...
    ///                 AdminUsername = "{your-username}",
    ///                 ComputerName = "myVM",
    ///                 LinuxConfiguration = new AzureRM.Compute.V20191201.Inputs.LinuxConfigurationArgs
    ///                 {
    ///                     DisablePasswordAuthentication = true,
    ///                     Ssh = new AzureRM.Compute.V20191201.Inputs.SshConfigurationArgs
    ///                     {
    ///                         PublicKeys = 
    ///                         {
    ///                             new AzureRM.Compute.V20191201.Inputs.SshPublicKeyArgs
    ///                             {
    ...
    public partial class VirtualMachine : Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
