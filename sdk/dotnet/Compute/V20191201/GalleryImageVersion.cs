...
namespace Pulumi.AzureNextGen.Compute.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20191201:GalleryImageVersion")]
    public partial class GalleryImageVersion : Pulumi.CustomResource
    {
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20191201:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20191201:GalleryImageVersion", name, null, MakeResourceOptions(options, id))
        {
        }
