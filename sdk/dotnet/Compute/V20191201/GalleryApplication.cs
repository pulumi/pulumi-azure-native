...
namespace Pulumi.AzureRM.Compute.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var galleryApplication = new AzureRM.Compute.V20191201.GalleryApplication("galleryApplication", new AzureRM.Compute.V20191201.GalleryApplicationArgs
    ///         {
    ...
    public partial class GalleryApplication : Pulumi.CustomResource
    {
        ...
        public GalleryApplication(string name, GalleryApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:GalleryApplication", name, args ?? new GalleryApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryApplication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:GalleryApplication", name, null, MakeResourceOptions(options, id))
        {
        }
