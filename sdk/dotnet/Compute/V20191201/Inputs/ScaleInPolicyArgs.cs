...
namespace Pulumi.AzureNative.Compute.V20191201.Inputs
{
    ...
    public sealed class ScaleInPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Compute.V20191201.VirtualMachineScaleSetScaleInRules>> Rules
        {
            get => _rules ?? (_rules = new InputList<Union<string, Pulumi.AzureNative.Compute.V20191201.VirtualMachineScaleSetScaleInRules>>());
            set => _rules = value;
        }
