...
namespace Pulumi.AzureNative.Compute.V20191201.Inputs
{
    ...
    public sealed class OSDiskArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20191201.DiskCreateOptionTypes> CreateOption { get; set; } = null!;
        ...
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNative.Compute.V20191201.OperatingSystemTypes>? OsType { get; set; }
