...
namespace Pulumi.AzureNative.Compute.V20191201
{
    ...
    public static class GetDedicatedHost
    {
        ...
        public static Task<GetDedicatedHostResult> InvokeAsync(GetDedicatedHostArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedHostResult>("azure-native:compute/v20191201:getDedicatedHost", args ?? new GetDedicatedHostArgs(), options.WithDefaults());

        /// <summary>
        /// Specifies information about the Dedicated host.
        /// </summary>
        public static Output<GetDedicatedHostResult> Invoke(GetDedicatedHostInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDedicatedHostResult>("azure-native:compute/v20191201:getDedicatedHost", args ?? new GetDedicatedHostInvokeArgs(), options.WithDefaults());
    }
