...
namespace Pulumi.AzureRM.Compute.V20191201
{
    public static class GetProximityPlacementGroup
    {
        public static Task<GetProximityPlacementGroupResult> InvokeAsync(GetProximityPlacementGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProximityPlacementGroupResult>("azurerm:compute/v20191201:getProximityPlacementGroup", args ?? new GetProximityPlacementGroupArgs(), options.WithVersion());
    }
