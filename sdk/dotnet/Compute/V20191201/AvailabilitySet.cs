...
namespace Pulumi.AzureNextGen.Compute.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20191201:AvailabilitySet")]
    public partial class AvailabilitySet : Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20191201:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20191201:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
