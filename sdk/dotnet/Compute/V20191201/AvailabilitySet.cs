...
namespace Pulumi.AzureRM.Compute.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var availabilitySet = new AzureRM.Compute.V20191201.AvailabilitySet("availabilitySet", new AzureRM.Compute.V20191201.AvailabilitySetArgs
    ///         {
    ...
    public partial class AvailabilitySet : Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
