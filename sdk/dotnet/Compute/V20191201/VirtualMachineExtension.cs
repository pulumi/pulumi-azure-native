...
namespace Pulumi.AzureNative.Compute.V20191201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20191201:VirtualMachineExtension")]
    public partial class VirtualMachineExtension : Pulumi.CustomResource
    {
        ...
        public VirtualMachineExtension(string name, VirtualMachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:VirtualMachineExtension", name, args ?? new VirtualMachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:VirtualMachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
