...
namespace Pulumi.AzureRM.Compute.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dedicatedHostGroup = new AzureRM.Compute.V20191201.DedicatedHostGroup("dedicatedHostGroup", new AzureRM.Compute.V20191201.DedicatedHostGroupArgs
    ///         {
    ...
    public partial class DedicatedHostGroup : Pulumi.CustomResource
    {
        ...
        public DedicatedHostGroup(string name, DedicatedHostGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:DedicatedHostGroup", name, args ?? new DedicatedHostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHostGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20191201:DedicatedHostGroup", name, null, MakeResourceOptions(options, id))
        {
        }
