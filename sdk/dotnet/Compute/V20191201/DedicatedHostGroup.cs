...
namespace Pulumi.AzureNative.Compute.V20191201
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20191201:DedicatedHostGroup")]
    public partial class DedicatedHostGroup : Pulumi.CustomResource
    {
        ...
        public DedicatedHostGroup(string name, DedicatedHostGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:DedicatedHostGroup", name, args ?? new DedicatedHostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHostGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191201:DedicatedHostGroup", name, null, MakeResourceOptions(options, id))
        {
        }
