...
namespace Pulumi.AzureNative.Compute.V20211201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20211201:DiskEncryptionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskEncryptionSet to guarantee forwards compatibility.")]
    ...
    public partial class DiskEncryptionSet : global::Pulumi.CustomResource
    {
        ...
        public DiskEncryptionSet(string name, DiskEncryptionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211201:DiskEncryptionSet", name, args ?? new DiskEncryptionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskEncryptionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211201:DiskEncryptionSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiskEncryptionSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20211201.DiskEncryptionSetType>? EncryptionType { get; set; }
