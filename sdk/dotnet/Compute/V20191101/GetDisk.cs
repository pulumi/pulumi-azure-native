...
namespace Pulumi.AzureNative.Compute.V20191101
{
    public static class GetDisk
    {
        ...
        public static Task<GetDiskResult> InvokeAsync(GetDiskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiskResult>("azure-native:compute/v20191101:getDisk", args ?? new GetDiskArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a disk.
        /// </summary>
        public static Output<GetDiskResult> Invoke(GetDiskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiskResult>("azure-native:compute/v20191101:getDisk", args ?? new GetDiskInvokeArgs(), options.WithDefaults());
    }
