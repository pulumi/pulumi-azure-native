...
namespace Pulumi.AzureNative.Compute.V20191101
{
    ...
    public partial class DiskEncryptionSet : global::Pulumi.CustomResource
    {
        ...
        public DiskEncryptionSet(string name, DiskEncryptionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191101:DiskEncryptionSet", name, args ?? new DiskEncryptionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskEncryptionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20191101:DiskEncryptionSet", name, null, MakeResourceOptions(options, id))
        {
        }
