...
namespace Pulumi.AzureRM.Compute
{
    ...
    public partial class Gallery : Pulumi.CustomResource
    {
        ...
        private Gallery(string name, Input<string> id, GalleryState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:compute:Gallery", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GalleryState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource location
        /// </summary>
        ...
        public Input<Inputs.GalleryPropertiesResponseGetArgs> Properties { get; set; } = null!;
