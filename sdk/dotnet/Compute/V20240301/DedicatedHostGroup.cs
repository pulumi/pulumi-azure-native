...
namespace Pulumi.AzureNative.Compute.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240301:DedicatedHostGroup")]
    public partial class DedicatedHostGroup : global::Pulumi.CustomResource
    {
        ...
        public DedicatedHostGroup(string name, DedicatedHostGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240301:DedicatedHostGroup", name, args ?? new DedicatedHostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHostGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240301:DedicatedHostGroup", name, null, MakeResourceOptions(options, id))
        {
        }
