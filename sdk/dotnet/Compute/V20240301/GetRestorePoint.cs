...
namespace Pulumi.AzureNative.Compute.V20240301
{
    public static class GetRestorePoint
    {
        ...
        public static Task<GetRestorePointResult> InvokeAsync(GetRestorePointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRestorePointResult>("azure-native:compute/v20240301:getRestorePoint", args ?? new GetRestorePointArgs(), options.WithDefaults());

        /// <summary>
        /// The operation to get the restore point.
        /// </summary>
        public static Output<GetRestorePointResult> Invoke(GetRestorePointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRestorePointResult>("azure-native:compute/v20240301:getRestorePoint", args ?? new GetRestorePointInvokeArgs(), options.WithDefaults());
