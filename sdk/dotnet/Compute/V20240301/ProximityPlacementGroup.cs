...
namespace Pulumi.AzureNative.Compute.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240301:ProximityPlacementGroup")]
    public partial class ProximityPlacementGroup : global::Pulumi.CustomResource
    {
        ...
        public ProximityPlacementGroup(string name, ProximityPlacementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240301:ProximityPlacementGroup", name, args ?? new ProximityPlacementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProximityPlacementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240301:ProximityPlacementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProximityPlacementGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20240301.ProximityPlacementGroupType>? ProximityPlacementGroupType { get; set; }
