...
namespace Pulumi.AzureNative.Compute.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240301:VirtualMachineRunCommandByVirtualMachine")]
    public partial class VirtualMachineRunCommandByVirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineRunCommandByVirtualMachine(string name, VirtualMachineRunCommandByVirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240301:VirtualMachineRunCommandByVirtualMachine", name, args ?? new VirtualMachineRunCommandByVirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineRunCommandByVirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240301:VirtualMachineRunCommandByVirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
