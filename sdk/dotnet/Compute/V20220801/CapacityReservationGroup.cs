...
namespace Pulumi.AzureNative.Compute.V20220801
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20220801:CapacityReservationGroup")]
    public partial class CapacityReservationGroup : global::Pulumi.CustomResource
    {
        ...
        public CapacityReservationGroup(string name, CapacityReservationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220801:CapacityReservationGroup", name, args ?? new CapacityReservationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220801:CapacityReservationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
