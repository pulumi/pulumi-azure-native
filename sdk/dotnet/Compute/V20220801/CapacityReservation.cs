...
namespace Pulumi.AzureNative.Compute.V20220801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20220801:CapacityReservation is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:CapacityReservation to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20220801:CapacityReservation")]
    public partial class CapacityReservation : global::Pulumi.CustomResource
    {
        ...
        public CapacityReservation(string name, CapacityReservationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220801:CapacityReservation", name, args ?? new CapacityReservationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220801:CapacityReservation", name, null, MakeResourceOptions(options, id))
        {
        }
