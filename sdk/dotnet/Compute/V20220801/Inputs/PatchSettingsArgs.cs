...
namespace Pulumi.AzureNative.Compute.V20220801.Inputs
{
    ...
    public sealed class PatchSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220801.WindowsPatchAssessmentMode>? AssessmentMode { get; set; }
        ...
        /// </summary>
        [Input("patchMode")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220801.WindowsVMGuestPatchMode>? PatchMode { get; set; }
