...
namespace Pulumi.AzureNative.Compute.V20220801.Inputs
{
    ...
    public sealed class LinuxPatchSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220801.LinuxPatchAssessmentMode>? AssessmentMode { get; set; }
        ...
        /// </summary>
        [Input("patchMode")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220801.LinuxVMGuestPatchMode>? PatchMode { get; set; }
