...
namespace Pulumi.AzureNative.Compute.V20220801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20220801:VirtualMachineScaleSetVMExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:VirtualMachineScaleSetVMExtension to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20220801:VirtualMachineScaleSetVMExtension")]
    public partial class VirtualMachineScaleSetVMExtension : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVMExtension(string name, VirtualMachineScaleSetVMExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220801:VirtualMachineScaleSetVMExtension", name, args ?? new VirtualMachineScaleSetVMExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVMExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220801:VirtualMachineScaleSetVMExtension", name, null, MakeResourceOptions(options, id))
        {
        }
