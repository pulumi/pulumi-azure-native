...
azure-native:compute/v20180401:Disk is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20180601:Disk to guarantee forwards compatibility.")]
    public static class GetDisk
    {
        ...
        public static Task<GetDiskResult> InvokeAsync(GetDiskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiskResult>("azure-native:compute/v20180401:getDisk", args ?? new GetDiskArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a disk.
        /// </summary>
        public static Output<GetDiskResult> Invoke(GetDiskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiskResult>("azure-native:compute/v20180401:getDisk", args ?? new GetDiskInvokeArgs(), options.WithDefaults());
    }
