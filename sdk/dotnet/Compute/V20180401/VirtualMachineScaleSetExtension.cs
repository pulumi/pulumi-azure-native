...
namespace Pulumi.AzureRM.Compute.V20180401
{
    ...
    public partial class VirtualMachineScaleSetExtension : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetExtension(string name, VirtualMachineScaleSetExtensionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180401:VirtualMachineScaleSetExtension", name, args ?? new VirtualMachineScaleSetExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180401:VirtualMachineScaleSetExtension", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:compute/v20170330:VirtualMachineScaleSetExtension"},
                    new Alias { Type = "azurerm:compute/v20171201:VirtualMachineScaleSetExtension"},
                    new Alias { Type = "azurerm:compute/v20180601:VirtualMachineScaleSetExtension"},
                    new Alias { Type = "azurerm:compute/v20181001:VirtualMachineScaleSetExtension"},
                    new Alias { Type = "azurerm:compute/v20190301:VirtualMachineScaleSetExtension"},
                    new Alias { Type = "azurerm:compute/v20190701:VirtualMachineScaleSetExtension"},
                    new Alias { Type = "azurerm:compute/v20191201:VirtualMachineScaleSetExtension"},
                    new Alias { Type = "azurerm:compute/v20200601:VirtualMachineScaleSetExtension"},
                },
            };
