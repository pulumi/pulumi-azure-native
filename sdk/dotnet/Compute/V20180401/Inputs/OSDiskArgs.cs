...
namespace Pulumi.AzureNextGen.Compute.V20180401.Inputs
{
    ...
    public sealed class OSDiskArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20180401.DiskCreateOptionTypes> CreateOption { get; set; } = null!;
        ...
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNextGen.Compute.V20180401.OperatingSystemTypes>? OsType { get; set; }
