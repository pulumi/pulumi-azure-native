...
namespace Pulumi.AzureRM.Compute.V20180401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var image = new AzureRM.Compute.V20180401.Image("image", new AzureRM.Compute.V20180401.ImageArgs
    ///         {
    ///             ImageName = "myImage",
    ///             Location = "West US",
    ///             ResourceGroupName = "myResourceGroup",
    ///             StorageProfile = new AzureRM.Compute.V20180401.Inputs.ImageStorageProfileArgs
    ///             {
    ///                 OsDisk = new AzureRM.Compute.V20180401.Inputs.ImageOSDiskArgs
    ///                 {
    ...
    ///                 OsDisk = new AzureRM.Compute.V20180401.Inputs.ImageOSDiskArgs
    ///                 {
    ///                     ManagedDisk = new AzureRM.Compute.V20180401.Inputs.SubResourceArgs
    ///                     {
    ...
    ///                     OsState = "Generalized",
    ///                     OsType = "Linux",
    ///                     Snapshot = new AzureRM.Compute.V20180401.Inputs.SubResourceArgs
    ///                     {
    ...
    ///             Location = "West US",
    ///             ResourceGroupName = "myResourceGroup",
    ///             SourceVirtualMachine = new AzureRM.Compute.V20180401.Inputs.SubResourceArgs
    ///             {
    ...
    ///                 DataDisks = 
    ///                 {
    ///                     new AzureRM.Compute.V20180401.Inputs.ImageDataDiskArgs
    ///                     {
    ...
    public partial class Image : Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180401:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180401:Image", name, null, MakeResourceOptions(options, id))
        {
        }
