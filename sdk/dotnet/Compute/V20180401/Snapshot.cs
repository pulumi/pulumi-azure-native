...
namespace Pulumi.AzureNextGen.Compute.V20180401
{
    ...
    /// Snapshot resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20180401:Snapshot")]
    public partial class Snapshot : Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180401:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180401:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
