...
namespace Pulumi.AzureNextGen.Compute.V20180401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20180401:VirtualMachineExtension")]
    public partial class VirtualMachineExtension : Pulumi.CustomResource
    {
        ...
        public VirtualMachineExtension(string name, VirtualMachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180401:VirtualMachineExtension", name, args ?? new VirtualMachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180401:VirtualMachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
