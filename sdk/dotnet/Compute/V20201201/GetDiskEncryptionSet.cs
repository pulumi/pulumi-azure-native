...
namespace Pulumi.AzureNative.Compute.V20201201
{
    public static class GetDiskEncryptionSet
    {
        ...
        public static Task<GetDiskEncryptionSetResult> InvokeAsync(GetDiskEncryptionSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDiskEncryptionSetResult>("azure-native:compute/v20201201:getDiskEncryptionSet", args ?? new GetDiskEncryptionSetArgs(), options.WithVersion());

        /// <summary>
        /// disk encryption set resource.
        /// </summary>
        public static Output<GetDiskEncryptionSetResult> Invoke(GetDiskEncryptionSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDiskEncryptionSetResult>("azure-native:compute/v20201201:getDiskEncryptionSet", args ?? new GetDiskEncryptionSetInvokeArgs(), options.WithVersion());
    }
