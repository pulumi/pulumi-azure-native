...
namespace Pulumi.AzureNative.Compute.V20201201
{
    ...
    /// {
    ///     var image = new AzureNative.Compute.V20201201.Image("image", new()
    ///     {
    ///         ImageName = "myImage",
    ///         Location = "West US",
    ///         ResourceGroupName = "myResourceGroup",
    ///         StorageProfile = new AzureNative.Compute.V20201201.Inputs.ImageStorageProfileArgs
    ///         {
    ///             OsDisk = new AzureNative.Compute.V20201201.Inputs.ImageOSDiskArgs
    ///             {
    ///                 BlobUri = "https://mystorageaccount.blob.core.windows.net/osimages/osimage.vhd",
    ///                 DiskEncryptionSet = new AzureNative.Compute.V20201201.Inputs.DiskEncryptionSetParametersArgs
    ///                 {
    ///                     Id = "/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/diskEncryptionSets/{existing-diskEncryptionSet-name}",
    ///                 },
    ///                 OsState = AzureNative.Compute.V20201201.OperatingSystemStateTypes.Generalized,
    ///                 OsType = AzureNative.Compute.V20201201.OperatingSystemTypes.Linux,
    ///             },
    ///         },
    ///     });
    /// 
    ...
    ///                     Id = "/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/diskEncryptionSets/{existing-diskEncryptionSet-name}",
    ///                 },
    ///                 ManagedDisk = new AzureNative.Compute.V20201201.Inputs.SubResourceArgs
    ///                 {
    ...
    ///                 OsState = AzureNative.Compute.V20201201.OperatingSystemStateTypes.Generalized,
    ///                 OsType = AzureNative.Compute.V20201201.OperatingSystemTypes.Linux,
    ///                 Snapshot = new AzureNative.Compute.V20201201.Inputs.SubResourceArgs
    ///                 {
    ...
    ///         Location = "West US",
    ///         ResourceGroupName = "myResourceGroup",
    ///         SourceVirtualMachine = new AzureNative.Compute.V20201201.Inputs.SubResourceArgs
    ///         {
    ...
    ///             DataDisks = new[]
    ///             {
    ///                 new AzureNative.Compute.V20201201.Inputs.ImageDataDiskArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20201201:Image")]
    public partial class Image : global::Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20201201:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20201201:Image", name, null, MakeResourceOptions(options, id))
        {
        }
