...
namespace Pulumi.AzureNextGen.Compute.V20201201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20201201:VirtualMachine")]
    public partial class VirtualMachine : Pulumi.CustomResource
    {
        ...
        public VirtualMachine(string name, VirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20201201:VirtualMachine", name, args ?? new VirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20201201:VirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualMachineArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20201201.VirtualMachineEvictionPolicyTypes>? EvictionPolicy { get; set; }
        ...
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20201201.VirtualMachinePriorityTypes>? Priority { get; set; }
