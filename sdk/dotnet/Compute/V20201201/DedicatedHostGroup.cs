...
namespace Pulumi.AzureNextGen.Compute.V20201201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20201201:DedicatedHostGroup")]
    public partial class DedicatedHostGroup : Pulumi.CustomResource
    {
        ...
        public DedicatedHostGroup(string name, DedicatedHostGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20201201:DedicatedHostGroup", name, args ?? new DedicatedHostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHostGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20201201:DedicatedHostGroup", name, null, MakeResourceOptions(options, id))
        {
        }
