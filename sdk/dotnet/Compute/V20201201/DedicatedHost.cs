...
namespace Pulumi.AzureNative.Compute.V20201201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20201201:DedicatedHost is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:DedicatedHost to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20201201:DedicatedHost")]
    public partial class DedicatedHost : global::Pulumi.CustomResource
    {
        ...
        public DedicatedHost(string name, DedicatedHostArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20201201:DedicatedHost", name, args ?? new DedicatedHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHost(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20201201:DedicatedHost", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:compute/v20221101:DedicatedHost"},
    ...
    public sealed class DedicatedHostArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public Input<Pulumi.AzureNative.Compute.V20201201.DedicatedHostLicenseTypes>? LicenseType { get; set; }
