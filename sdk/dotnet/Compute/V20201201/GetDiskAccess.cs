...
namespace Pulumi.AzureNative.Compute.V20201201
{
    public static class GetDiskAccess
    {
        ...
        public static Task<GetDiskAccessResult> InvokeAsync(GetDiskAccessArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDiskAccessResult>("azure-native:compute/v20201201:getDiskAccess", args ?? new GetDiskAccessArgs(), options.WithVersion());

        /// <summary>
        /// disk access resource.
        /// </summary>
        public static Output<GetDiskAccessResult> Invoke(GetDiskAccessInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDiskAccessResult>("azure-native:compute/v20201201:getDiskAccess", args ?? new GetDiskAccessInvokeArgs(), options.WithVersion());
    }
