...
namespace Pulumi.AzureNextGen.Compute.V20201201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20201201:ProximityPlacementGroup")]
    public partial class ProximityPlacementGroup : Pulumi.CustomResource
    {
        ...
        public ProximityPlacementGroup(string name, ProximityPlacementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20201201:ProximityPlacementGroup", name, args ?? new ProximityPlacementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProximityPlacementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20201201:ProximityPlacementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProximityPlacementGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20201201.ProximityPlacementGroupType>? ProximityPlacementGroupType { get; set; }
