...
namespace Pulumi.AzureNative.Compute.V20201201
{
    ...
    /// {
    ///     var snapshot = new AzureNative.Compute.V20201201.Snapshot("snapshot", new()
    ///     {
    ///         CreationData = new AzureNative.Compute.V20201201.Inputs.CreationDataArgs
    ///         {
    ///             CreateOption = "Import",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:compute/v20201201:Snapshot mySnapshot2 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/snapshots/{snapshotName} 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20201201:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20201201:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20201201:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SnapshotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20201201.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20201201.NetworkAccessPolicy>? NetworkAccessPolicy { get; set; }
