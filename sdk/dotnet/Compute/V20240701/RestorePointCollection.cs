...
namespace Pulumi.AzureNative.Compute.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240701:RestorePointCollection")]
    public partial class RestorePointCollection : global::Pulumi.CustomResource
    {
        ...
        public RestorePointCollection(string name, RestorePointCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240701:RestorePointCollection", name, args ?? new RestorePointCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePointCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240701:RestorePointCollection", name, null, MakeResourceOptions(options, id))
        {
        }
