...
namespace Pulumi.AzureNative.Compute.V20240701.Inputs
{
    ...
    public sealed class LinuxPatchSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20240701.LinuxPatchAssessmentMode>? AssessmentMode { get; set; }
        ...
        /// </summary>
        [Input("patchMode")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20240701.LinuxVMGuestPatchMode>? PatchMode { get; set; }
