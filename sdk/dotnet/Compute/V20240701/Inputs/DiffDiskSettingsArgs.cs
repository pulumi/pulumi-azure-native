...
namespace Pulumi.AzureNative.Compute.V20240701.Inputs
{
    ...
    public sealed class DiffDiskSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("option")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20240701.DiffDiskOptions>? Option { get; set; }
        ...
        /// </summary>
        [Input("placement")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20240701.DiffDiskPlacement>? Placement { get; set; }
