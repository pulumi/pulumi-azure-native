...
namespace Pulumi.AzureNative.Compute.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240701:VirtualMachineScaleSetExtension")]
    public partial class VirtualMachineScaleSetExtension : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetExtension(string name, VirtualMachineScaleSetExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240701:VirtualMachineScaleSetExtension", name, args ?? new VirtualMachineScaleSetExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240701:VirtualMachineScaleSetExtension", name, null, MakeResourceOptions(options, id))
        {
        }
