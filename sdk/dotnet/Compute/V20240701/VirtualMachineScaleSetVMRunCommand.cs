...
namespace Pulumi.AzureNative.Compute.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240701:VirtualMachineScaleSetVMRunCommand")]
    public partial class VirtualMachineScaleSetVMRunCommand : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVMRunCommand(string name, VirtualMachineScaleSetVMRunCommandArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240701:VirtualMachineScaleSetVMRunCommand", name, args ?? new VirtualMachineScaleSetVMRunCommandArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVMRunCommand(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240701:VirtualMachineScaleSetVMRunCommand", name, null, MakeResourceOptions(options, id))
        {
        }
