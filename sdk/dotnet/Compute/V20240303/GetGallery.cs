...
namespace Pulumi.AzureNative.Compute.V20240303
{
    public static class GetGallery
    {
        ...
        public static Task<GetGalleryResult> InvokeAsync(GetGalleryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGalleryResult>("azure-native:compute/v20240303:getGallery", args ?? new GetGalleryArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves information about a Shared Image Gallery.
        /// </summary>
        public static Output<GetGalleryResult> Invoke(GetGalleryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGalleryResult>("azure-native:compute/v20240303:getGallery", args ?? new GetGalleryInvokeArgs(), options.WithDefaults());
    }
