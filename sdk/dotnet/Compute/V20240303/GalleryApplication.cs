...
namespace Pulumi.AzureNative.Compute.V20240303
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240303:GalleryApplication")]
    public partial class GalleryApplication : global::Pulumi.CustomResource
    {
        ...
        public GalleryApplication(string name, GalleryApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240303:GalleryApplication", name, args ?? new GalleryApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryApplication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240303:GalleryApplication", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GalleryApplicationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Compute.V20240303.OperatingSystemTypes> SupportedOSType { get; set; } = null!;
