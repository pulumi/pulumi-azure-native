...
namespace Pulumi.AzureNative.Compute.V20240303
{
    public static class GetGalleryImageVersion
    {
        ...
        public static Task<GetGalleryImageVersionResult> InvokeAsync(GetGalleryImageVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGalleryImageVersionResult>("azure-native:compute/v20240303:getGalleryImageVersion", args ?? new GetGalleryImageVersionArgs(), options.WithDefaults());
