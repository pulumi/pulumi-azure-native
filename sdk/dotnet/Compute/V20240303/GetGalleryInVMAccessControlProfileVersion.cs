...
namespace Pulumi.AzureNative.Compute.V20240303
{
    public static class GetGalleryInVMAccessControlProfileVersion
    {
        ...
        public static Task<GetGalleryInVMAccessControlProfileVersionResult> InvokeAsync(GetGalleryInVMAccessControlProfileVersionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGalleryInVMAccessControlProfileVersionResult>("azure-native:compute/v20240303:getGalleryInVMAccessControlProfileVersion", args ?? new GetGalleryInVMAccessControlProfileVersionArgs(), options.WithDefaults());
