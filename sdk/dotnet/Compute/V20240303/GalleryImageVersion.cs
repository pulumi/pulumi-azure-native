...
namespace Pulumi.AzureNative.Compute.V20240303
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240303:GalleryImageVersion")]
    public partial class GalleryImageVersion : global::Pulumi.CustomResource
    {
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240303:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240303:GalleryImageVersion", name, null, MakeResourceOptions(options, id))
        {
        }
