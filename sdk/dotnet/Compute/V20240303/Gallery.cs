...
namespace Pulumi.AzureNative.Compute.V20240303
{
    /// <summary>
    /// Specifies information about the Shared Image Gallery that you want to create or update.
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240303:Gallery")]
    public partial class Gallery : global::Pulumi.CustomResource
    {
        ...
        public Gallery(string name, GalleryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240303:Gallery", name, args ?? new GalleryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gallery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240303:Gallery", name, null, MakeResourceOptions(options, id))
        {
        }
