...
namespace Pulumi.AzureNative.Compute.V20240303
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240303:GalleryInVMAccessControlProfileVersion")]
    public partial class GalleryInVMAccessControlProfileVersion : global::Pulumi.CustomResource
    {
        ...
        public GalleryInVMAccessControlProfileVersion(string name, GalleryInVMAccessControlProfileVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240303:GalleryInVMAccessControlProfileVersion", name, args ?? new GalleryInVMAccessControlProfileVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryInVMAccessControlProfileVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240303:GalleryInVMAccessControlProfileVersion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:compute:GalleryInVMAccessControlProfileVersion" },
                },
            };
    ...
    public sealed class GalleryInVMAccessControlProfileVersionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20240303.EndpointAccess> DefaultAccess { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20240303.AccessControlRulesMode> Mode { get; set; } = null!;
