...
namespace Pulumi.AzureNative.Compute.Latest.Inputs
{
    ...
    public sealed class OSDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Compute.Latest.CachingTypes>? Caching { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.Latest.DiskCreateOptionTypes> CreateOption { get; set; } = null!;
        ...
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNative.Compute.Latest.OperatingSystemTypes>? OsType { get; set; }
