...
namespace Pulumi.AzureNextGen.Compute.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:compute:DiskEncryptionSet'.")]
    ...
    public partial class DiskEncryptionSet : Pulumi.CustomResource
    {
        ...
        public DiskEncryptionSet(string name, DiskEncryptionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/latest:DiskEncryptionSet", name, args ?? new DiskEncryptionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskEncryptionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/latest:DiskEncryptionSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiskEncryptionSetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Compute.Latest.DiskEncryptionSetType>? EncryptionType { get; set; }
