...
namespace Pulumi.AzureRM.Compute.Latest
{
    ...
    ///                 DataDiskImages = 
    ///                 {
    ///                     new AzureRM.Compute.Latest.Inputs.GalleryDataDiskImageArgs
    ///                     {
    ///                         HostCaching = "None",
    ///                         Lun = 1,
    ///                         Source = new AzureRM.Compute.Latest.Inputs.GalleryArtifactVersionSourceArgs
    ...
    ///                     },
    ///                 },
    ///                 OsDiskImage = new AzureRM.Compute.Latest.Inputs.GalleryOSDiskImageArgs
    ///                 {
    ...
    public partial class GalleryImageVersion : Pulumi.CustomResource
    {
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/latest:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/latest:GalleryImageVersion", name, null, MakeResourceOptions(options, id))
        {
        }
