...
namespace Pulumi.AzureNative.Compute.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:compute:CloudService'.")]
    [AzureNativeResourceType("azure-native:compute/latest:CloudService")]
    public partial class CloudService : Pulumi.CustomResource
    {
        ...
        public CloudService(string name, CloudServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/latest:CloudService", name, args ?? new CloudServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/latest:CloudService", name, null, MakeResourceOptions(options, id))
        {
        }
