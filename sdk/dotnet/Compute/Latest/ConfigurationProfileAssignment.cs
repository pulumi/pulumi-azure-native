...
namespace Pulumi.AzureRM.Compute.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var configurationProfileAssignment = new AzureRM.Compute.Latest.ConfigurationProfileAssignment("configurationProfileAssignment", new AzureRM.Compute.Latest.ConfigurationProfileAssignmentArgs
    ///         {
    ...
    public partial class ConfigurationProfileAssignment : Pulumi.CustomResource
    {
        ...
        public ConfigurationProfileAssignment(string name, ConfigurationProfileAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/latest:ConfigurationProfileAssignment", name, args ?? new ConfigurationProfileAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfileAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/latest:ConfigurationProfileAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
