...
namespace Pulumi.AzureNative.Compute.V20241101.Inputs
{
    ...
    public sealed class OSDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Compute.V20241101.CachingTypes>? Caching { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20241101.DiskCreateOptionTypes> CreateOption { get; set; } = null!;

        /// <summary>
        /// Specifies whether OS Disk should be deleted or detached upon VM deletion. Possible values are: **Delete.** If this value is used, the OS disk is deleted when VM is deleted. **Detach.** If this value is used, the os disk is retained after VM is deleted. The default value is set to **Detach**. For an ephemeral OS Disk, the default value is set to **Delete**. The user cannot change the delete option for an ephemeral OS Disk.
        /// </summary>
        [Input("deleteOption")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20241101.DiskDeleteOptionTypes>? DeleteOption { get; set; }
        ...
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNative.Compute.V20241101.OperatingSystemTypes>? OsType { get; set; }
