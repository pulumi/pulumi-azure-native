...
namespace Pulumi.AzureNative.Compute.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20241101:VirtualMachineExtension")]
    public partial class VirtualMachineExtension : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineExtension(string name, VirtualMachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241101:VirtualMachineExtension", name, args ?? new VirtualMachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241101:VirtualMachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
