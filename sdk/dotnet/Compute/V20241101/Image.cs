...
namespace Pulumi.AzureNative.Compute.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20241101:Image")]
    public partial class Image : global::Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241101:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241101:Image", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ImageArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20241101.HyperVGenerationTypes>? HyperVGeneration { get; set; }
