...
namespace Pulumi.AzureNative.Compute.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20241101:RestorePoint")]
    public partial class RestorePoint : global::Pulumi.CustomResource
    {
        ...
        public RestorePoint(string name, RestorePointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241101:RestorePoint", name, args ?? new RestorePointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241101:RestorePoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RestorePointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20241101.ConsistencyModeTypes>? ConsistencyMode { get; set; }
