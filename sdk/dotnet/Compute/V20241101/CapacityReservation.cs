...
namespace Pulumi.AzureNative.Compute.V20241101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20241101:CapacityReservation")]
    public partial class CapacityReservation : global::Pulumi.CustomResource
    {
        ...
        public CapacityReservation(string name, CapacityReservationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241101:CapacityReservation", name, args ?? new CapacityReservationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241101:CapacityReservation", name, null, MakeResourceOptions(options, id))
        {
        }
