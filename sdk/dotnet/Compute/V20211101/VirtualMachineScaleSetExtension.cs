...
namespace Pulumi.AzureNative.Compute.V20211101
{
    ...
    /// {
    ///     var virtualMachineScaleSetExtension = new AzureNative.Compute.V20211101.VirtualMachineScaleSetExtension("virtualMachineScaleSetExtension", new()
    ///     {
    ...
    public partial class VirtualMachineScaleSetExtension : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetExtension(string name, VirtualMachineScaleSetExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:VirtualMachineScaleSetExtension", name, args ?? new VirtualMachineScaleSetExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:VirtualMachineScaleSetExtension", name, null, MakeResourceOptions(options, id))
        {
        }
