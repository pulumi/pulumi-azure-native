...
namespace Pulumi.AzureNative.Compute.V20211101
{
    public static class GetCapacityReservationGroup
    {
        ...
        public static Task<GetCapacityReservationGroupResult> InvokeAsync(GetCapacityReservationGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCapacityReservationGroupResult>("azure-native:compute/v20211101:getCapacityReservationGroup", args ?? new GetCapacityReservationGroupArgs(), options.WithVersion());
        ...
        public static Output<GetCapacityReservationGroupResult> Invoke(GetCapacityReservationGroupInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCapacityReservationGroupResult>("azure-native:compute/v20211101:getCapacityReservationGroup", args ?? new GetCapacityReservationGroupInvokeArgs(), options.WithVersion());
    }
