...
namespace Pulumi.AzureNative.Compute.V20211101
{
    ...
    public partial class RestorePoint : global::Pulumi.CustomResource
    {
        ...
        public RestorePoint(string name, RestorePointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:RestorePoint", name, args ?? new RestorePointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:RestorePoint", name, null, MakeResourceOptions(options, id))
        {
        }
