...
namespace Pulumi.AzureNative.Compute.V20211101
{
    ...
    public partial class CapacityReservation : global::Pulumi.CustomResource
    {
        ...
        public CapacityReservation(string name, CapacityReservationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:CapacityReservation", name, args ?? new CapacityReservationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:CapacityReservation", name, null, MakeResourceOptions(options, id))
        {
        }
