...
namespace Pulumi.AzureNative.Compute.V20211101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20211101:VirtualMachineRunCommandByVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineRunCommandByVirtualMachine to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20211101:VirtualMachineRunCommandByVirtualMachine")]
    public partial class VirtualMachineRunCommandByVirtualMachine : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineRunCommandByVirtualMachine(string name, VirtualMachineRunCommandByVirtualMachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:VirtualMachineRunCommandByVirtualMachine", name, args ?? new VirtualMachineRunCommandByVirtualMachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineRunCommandByVirtualMachine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:VirtualMachineRunCommandByVirtualMachine", name, null, MakeResourceOptions(options, id))
        {
        }
