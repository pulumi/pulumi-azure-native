...
namespace Pulumi.AzureNative.Compute.V20211101
{
    ...
    /// {
    ///     var virtualMachineExtension = new AzureNative.Compute.V20211101.VirtualMachineExtension("virtualMachineExtension", new()
    ///     {
    ///         AutoUpgradeMinorVersion = true,
    ///         EnableAutomaticUpgrade = true,
    ///         ForceUpdateTag = "a",
    ///         InstanceView = new AzureNative.Compute.V20211101.Inputs.VirtualMachineExtensionInstanceViewArgs
    ///         {
    ///             Name = "aaaaaaaaaaaaaaaaa",
    ///             Statuses = new[]
    ///             {
    ///                 new AzureNative.Compute.V20211101.Inputs.InstanceViewStatusArgs
    ///                 {
    ///                     Code = "aaaaaaaaaaaaaaaaaaaaaaa",
    ///                     DisplayStatus = "aaaaaa",
    ///                     Level = AzureNative.Compute.V20211101.StatusLevelTypes.Info,
    ///                     Message = "a",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20211101:VirtualMachineExtension")]
    public partial class VirtualMachineExtension : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineExtension(string name, VirtualMachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:VirtualMachineExtension", name, args ?? new VirtualMachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:VirtualMachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
