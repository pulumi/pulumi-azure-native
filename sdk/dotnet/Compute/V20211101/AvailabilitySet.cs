...
namespace Pulumi.AzureNative.Compute.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20211101:AvailabilitySet")]
    public partial class AvailabilitySet : global::Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20211101:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
