...
azure-native:compute/v20160330:AvailabilitySet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20160430preview:AvailabilitySet to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20160330:AvailabilitySet")]
    public partial class AvailabilitySet : global::Pulumi.CustomResource
    {
        ...
        public AvailabilitySet(string name, AvailabilitySetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20160330:AvailabilitySet", name, args ?? new AvailabilitySetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailabilitySet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20160330:AvailabilitySet", name, null, MakeResourceOptions(options, id))
        {
        }
