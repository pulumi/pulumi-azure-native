...
namespace Pulumi.AzureNextGen.Compute.V20160330
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20160330:VirtualMachineExtension")]
    public partial class VirtualMachineExtension : Pulumi.CustomResource
    {
        ...
        public VirtualMachineExtension(string name, VirtualMachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20160330:VirtualMachineExtension", name, args ?? new VirtualMachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20160330:VirtualMachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
