...
namespace Pulumi.AzureNative.Compute.V20220303
{
    ...
    public partial class GalleryApplication : global::Pulumi.CustomResource
    {
        ...
        public GalleryApplication(string name, GalleryApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220303:GalleryApplication", name, args ?? new GalleryApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryApplication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220303:GalleryApplication", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GalleryApplicationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Compute.V20220303.OperatingSystemTypes> SupportedOSType { get; set; } = null!;
