...
namespace Pulumi.AzureNative.Compute.V20220303
{
    ...
    /// {
    ///     var galleryImage = new AzureNative.Compute.V20220303.GalleryImage("galleryImage", new()
    ///     {
    ///         GalleryImageName = "myGalleryImageName",
    ///         GalleryName = "myGalleryName",
    ///         HyperVGeneration = "V1",
    ///         Identifier = new AzureNative.Compute.V20220303.Inputs.GalleryImageIdentifierArgs
    ///         {
    ///             Offer = "myOfferName",
    ...
    ///         },
    ///         Location = "West US",
    ///         OsState = AzureNative.Compute.V20220303.OperatingSystemStateTypes.Generalized,
    ///         OsType = AzureNative.Compute.V20220303.OperatingSystemTypes.Windows,
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:compute/v20220303:GalleryImage myGalleryImageName /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{galleryImageName} 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20220303:GalleryImage")]
    public partial class GalleryImage : global::Pulumi.CustomResource
    {
        ...
        public GalleryImage(string name, GalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220303:GalleryImage", name, args ?? new GalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220303:GalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GalleryImageArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("architecture")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220303.Architecture>? Architecture { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220303.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public Input<Pulumi.AzureNative.Compute.V20220303.OperatingSystemStateTypes> OsState { get; set; } = null!;

        /// <summary>
        /// This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. &lt;br&gt;&lt;br&gt; Possible values are: &lt;br&gt;&lt;br&gt; **Windows** &lt;br&gt;&lt;br&gt; **Linux**
        /// </summary>
        [Input("osType", required: true)]
        public Input<Pulumi.AzureNative.Compute.V20220303.OperatingSystemTypes> OsType { get; set; } = null!;
