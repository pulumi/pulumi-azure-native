...
namespace Pulumi.AzureNative.Compute.V20220303
{
    ...
    /// {
    ///     var galleryImageVersion = new AzureNative.Compute.V20220303.GalleryImageVersion("galleryImageVersion", new()
    ///     {
    ///         GalleryImageName = "myGalleryImageName",
    ///         GalleryImageVersionName = "1.0.0",
    ///         GalleryName = "myGalleryName",
    ///         Location = "West US",
    ///         PublishingProfile = new AzureNative.Compute.V20220303.Inputs.GalleryImageVersionPublishingProfileArgs
    ///         {
    ///             TargetRegions = new[]
    ///             {
    ///                 new AzureNative.Compute.V20220303.Inputs.TargetRegionArgs
    ///                 {
    ///                     Encryption = new AzureNative.Compute.V20220303.Inputs.EncryptionImagesArgs
    ///                     {
    ///                         DataDiskImages = new[]
    ///                         {
    ///                             new AzureNative.Compute.V20220303.Inputs.DataDiskImageEncryptionArgs
    ///                             {
    ...
    ///                             },
    ///                         },
    ///                         OsDiskImage = new AzureNative.Compute.V20220303.Inputs.OSDiskImageEncryptionArgs
    ///                         {
    ///                             DiskEncryptionSetId = "/subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/diskEncryptionSet/myWestUSDiskEncryptionSet",
    ///                         },
    ///                     },
    ...
    ///         SafetyProfile = new AzureNative.Compute.V20220303.Inputs.GalleryImageVersionSafetyProfileArgs
    ///         {
    ///             AllowDeletionOfReplicatedLocations = false,
    ///         },
    ///         StorageProfile = new AzureNative.Compute.V20220303.Inputs.GalleryImageVersionStorageProfileArgs
    ///         {
    ///             Source = new AzureNative.Compute.V20220303.Inputs.GalleryArtifactVersionFullSourceArgs
    ///             {
    ...
    ///             DataDiskImages = new[]
    ///             {
    ///                 new AzureNative.Compute.V20220303.Inputs.GalleryDataDiskImageArgs
    ///                 {
    ///                     HostCaching = AzureNative.Compute.V20220303.HostCaching.None,
    ///                     Lun = 1,
    ///                     Source = new AzureNative.Compute.V20220303.Inputs.GalleryDiskImageSourceArgs
    ///                     {
    ///                         Id = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Compute/disks/{dataDiskName}",
    ///                     },
    ///                 },
    ///             },
    ///             OsDiskImage = new AzureNative.Compute.V20220303.Inputs.GalleryOSDiskImageArgs
    ///             {
    ///                 HostCaching = AzureNative.Compute.V20220303.HostCaching.ReadOnly,
    ///                 Source = new AzureNative.Compute.V20220303.Inputs.GalleryDiskImageSourceArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20220303:GalleryImageVersion")]
    public partial class GalleryImageVersion : global::Pulumi.CustomResource
    {
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220303:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220303:GalleryImageVersion", name, null, MakeResourceOptions(options, id))
        {
        }
