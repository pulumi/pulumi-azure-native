...
namespace Pulumi.AzureNative.Compute.V20230901
{
    public static class GetSshPublicKey
    {
        ...
        public static Task<GetSshPublicKeyResult> InvokeAsync(GetSshPublicKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSshPublicKeyResult>("azure-native:compute/v20230901:getSshPublicKey", args ?? new GetSshPublicKeyArgs(), options.WithDefaults());
