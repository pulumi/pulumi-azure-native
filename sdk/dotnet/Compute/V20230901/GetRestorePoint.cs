...
namespace Pulumi.AzureNative.Compute.V20230901
{
    public static class GetRestorePoint
    {
        ...
        public static Task<GetRestorePointResult> InvokeAsync(GetRestorePointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRestorePointResult>("azure-native:compute/v20230901:getRestorePoint", args ?? new GetRestorePointArgs(), options.WithDefaults());
