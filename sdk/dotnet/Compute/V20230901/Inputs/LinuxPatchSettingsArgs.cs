...
namespace Pulumi.AzureNative.Compute.V20230901.Inputs
{
    ...
    public sealed class LinuxPatchSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230901.LinuxPatchAssessmentMode>? AssessmentMode { get; set; }
        ...
        /// </summary>
        [Input("patchMode")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230901.LinuxVMGuestPatchMode>? PatchMode { get; set; }
