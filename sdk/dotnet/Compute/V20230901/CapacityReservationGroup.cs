...
namespace Pulumi.AzureNative.Compute.V20230901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230901:CapacityReservationGroup")]
    public partial class CapacityReservationGroup : global::Pulumi.CustomResource
    {
        ...
        public CapacityReservationGroup(string name, CapacityReservationGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230901:CapacityReservationGroup", name, args ?? new CapacityReservationGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservationGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230901:CapacityReservationGroup", name, null, MakeResourceOptions(options, id))
        {
        }
