...
namespace Pulumi.AzureRM.Compute
{
    public static class GetHostGroup
    {
        public static Task<GetHostGroupResult> InvokeAsync(GetHostGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHostGroupResult>("azurerm:compute:getHostGroup", args ?? new GetHostGroupArgs(), options.WithVersion());
    }


    public sealed class GetHostGroupArgs : Pulumi.InvokeArgs
    {
        /// <summary>
