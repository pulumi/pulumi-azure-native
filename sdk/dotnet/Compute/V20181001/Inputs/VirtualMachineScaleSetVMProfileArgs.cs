...
namespace Pulumi.AzureNative.Compute.V20181001.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetVMProfileArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20181001.VirtualMachineEvictionPolicyTypes>? EvictionPolicy { get; set; }
        ...
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20181001.VirtualMachinePriorityTypes>? Priority { get; set; }
