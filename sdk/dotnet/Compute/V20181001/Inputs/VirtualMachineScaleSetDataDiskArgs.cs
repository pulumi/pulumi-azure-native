...
namespace Pulumi.AzureNative.Compute.V20181001.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetDataDiskArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Compute.V20181001.CachingTypes>? Caching { get; set; }

        /// <summary>
        /// The create option.
        /// </summary>
        [Input("createOption", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20181001.DiskCreateOptionTypes> CreateOption { get; set; } = null!;
