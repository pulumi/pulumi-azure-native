...
namespace Pulumi.AzureNextGen.Compute.V20181001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20181001:VirtualMachineScaleSetVM")]
    public partial class VirtualMachineScaleSetVM : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVM(string name, VirtualMachineScaleSetVMArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20181001:VirtualMachineScaleSetVM", name, args ?? new VirtualMachineScaleSetVMArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVM(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20181001:VirtualMachineScaleSetVM", name, null, MakeResourceOptions(options, id))
        {
        }
