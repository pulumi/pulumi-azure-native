...
namespace Pulumi.AzureNextGen.Compute.V20181001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20181001:Image")]
    public partial class Image : Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20181001:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20181001:Image", name, null, MakeResourceOptions(options, id))
        {
        }
