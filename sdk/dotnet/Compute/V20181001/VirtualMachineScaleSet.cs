...
namespace Pulumi.AzureRM.Compute.V20181001
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualMachineScaleSet = new AzureRM.Compute.V20181001.VirtualMachineScaleSet("virtualMachineScaleSet", new AzureRM.Compute.V20181001.VirtualMachineScaleSetArgs
    ///         {
    ///             Location = "westus",
    ///             Overprovision = true,
    ///             ResourceGroupName = "myResourceGroup",
    ///             Sku = new AzureRM.Compute.V20181001.Inputs.SkuArgs
    ///             {
    ///                 Capacity = 3,
    ///                 Name = "Standard_D1_v2",
    ///                 Tier = "Standard",
    ///             },
    ///             UpgradePolicy = new AzureRM.Compute.V20181001.Inputs.UpgradePolicyArgs
    ///             {
    ///                 Mode = "Manual",
    ///             },
    ///             VirtualMachineProfile = new AzureRM.Compute.V20181001.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///             {
    ///                 NetworkProfile = new AzureRM.Compute.V20181001.Inputs.VirtualMachineScaleSetNetworkProfileArgs
    ///                 {
    ///                     NetworkInterfaceConfigurations = 
    ///                     {
    ///                         new AzureRM.Compute.V20181001.Inputs.VirtualMachineScaleSetNetworkConfigurationArgs
    ///                         {
    ///                             Name = "{vmss-name}",
    ///                         },
    ///                     },
    ///                 },
    ///                 OsProfile = new AzureRM.Compute.V20181001.Inputs.VirtualMachineScaleSetOSProfileArgs
    ///                 {
    ///                     AdminPassword = "{your-password}",
    ///                     AdminUsername = "{your-username}",
    ///                     ComputerNamePrefix = "{vmss-name}",
    ///                 },
    ///                 StorageProfile = new AzureRM.Compute.V20181001.Inputs.VirtualMachineScaleSetStorageProfileArgs
    ///                 {
    ///                     OsDisk = new AzureRM.Compute.V20181001.Inputs.VirtualMachineScaleSetOSDiskArgs
    ///                     {
    ///                         Caching = "ReadWrite",
    ...
    ///                         Caching = "ReadWrite",
    ///                         CreateOption = "FromImage",
    ///                         ManagedDisk = new AzureRM.Compute.V20181001.Inputs.VirtualMachineScaleSetManagedDiskParametersArgs
    ///                         {
    ...
    ///         var virtualMachineScaleSet = new AzureRM.Compute.V20181001.VirtualMachineScaleSet("virtualMachineScaleSet", new AzureRM.Compute.V20181001.VirtualMachineScaleSetArgs
    ///         {
    ///             AutomaticRepairsPolicy = new AzureRM.Compute.V20181001.Inputs.AutomaticRepairsPolicyArgs
    ///             {
    ///                 Enabled = true,
    ///                 GracePeriod = "PT30M",
    ///             },
    ...
    ///                     DataDisks = 
    ///                     {
    ///                         new AzureRM.Compute.V20181001.Inputs.VirtualMachineScaleSetDataDiskArgs
    ///                         {
    ///                             CreateOption = "Empty",
    ///                             DiskSizeGB = 1023,
    ///                             Lun = 0,
