...
namespace Pulumi.AzureNative.Compute.V20230703
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230703:Gallery")]
    public partial class Gallery : global::Pulumi.CustomResource
    {
        ...
        public Gallery(string name, GalleryArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230703:Gallery", name, args ?? new GalleryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gallery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230703:Gallery", name, null, MakeResourceOptions(options, id))
        {
        }
