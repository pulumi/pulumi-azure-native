...
namespace Pulumi.AzureNative.Compute.V20230703
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230703:GalleryImageVersion")]
    public partial class GalleryImageVersion : global::Pulumi.CustomResource
    {
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230703:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230703:GalleryImageVersion", name, null, MakeResourceOptions(options, id))
        {
        }
