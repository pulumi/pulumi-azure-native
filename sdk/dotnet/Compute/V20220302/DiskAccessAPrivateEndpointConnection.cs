...
namespace Pulumi.AzureNative.Compute.V20220302
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20220302:DiskAccessAPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20220702:DiskAccessAPrivateEndpointConnection to guarantee forwards compatibility.")]
    ...
    public partial class DiskAccessAPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public DiskAccessAPrivateEndpointConnection(string name, DiskAccessAPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220302:DiskAccessAPrivateEndpointConnection", name, args ?? new DiskAccessAPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccessAPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220302:DiskAccessAPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
