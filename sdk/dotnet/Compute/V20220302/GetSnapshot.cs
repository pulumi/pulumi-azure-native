...
namespace Pulumi.AzureNative.Compute.V20220302
{
    public static class GetSnapshot
    {
        ...
        public static Task<GetSnapshotResult> InvokeAsync(GetSnapshotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSnapshotResult>("azure-native:compute/v20220302:getSnapshot", args ?? new GetSnapshotArgs(), options.WithDefaults());

        /// <summary>
        /// Snapshot resource.
        /// </summary>
        public static Output<GetSnapshotResult> Invoke(GetSnapshotInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSnapshotResult>("azure-native:compute/v20220302:getSnapshot", args ?? new GetSnapshotInvokeArgs(), options.WithDefaults());
    }
