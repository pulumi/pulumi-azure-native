...
namespace Pulumi.AzureNative.Compute.V20220103
{
    public static class GetGalleryApplication
    {
        ...
        public static Task<GetGalleryApplicationResult> InvokeAsync(GetGalleryApplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGalleryApplicationResult>("azure-native:compute/v20220103:getGalleryApplication", args ?? new GetGalleryApplicationArgs(), options.WithDefaults());

        /// <summary>
        /// Specifies information about the gallery Application Definition that you want to create or update.
        /// </summary>
        public static Output<GetGalleryApplicationResult> Invoke(GetGalleryApplicationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGalleryApplicationResult>("azure-native:compute/v20220103:getGalleryApplication", args ?? new GetGalleryApplicationInvokeArgs(), options.WithDefaults());
    }
