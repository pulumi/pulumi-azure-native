...
namespace Pulumi.AzureNative.Compute.V20220103
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20220103:GalleryImageVersion")]
    public partial class GalleryImageVersion : global::Pulumi.CustomResource
    {
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220103:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220103:GalleryImageVersion", name, null, MakeResourceOptions(options, id))
        {
        }
