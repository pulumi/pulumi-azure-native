...
namespace Pulumi.AzureRM.Compute.Preview
{
    public static class GetVirtualMachine
    {
        public static Task<GetVirtualMachineResult> InvokeAsync(GetVirtualMachineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualMachineResult>("azurerm:compute/preview:getVirtualMachine", args ?? new GetVirtualMachineArgs(), options.WithVersion());
    }
