...
namespace Pulumi.AzureRM.Compute.Preview
{
    ...
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/preview:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/preview:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
