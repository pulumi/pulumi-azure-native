...
namespace Pulumi.AzureRM.Compute.Preview
{
    public static class GetProximityPlacementGroup
    {
        public static Task<GetProximityPlacementGroupResult> InvokeAsync(GetProximityPlacementGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProximityPlacementGroupResult>("azurerm:compute/preview:getProximityPlacementGroup", args ?? new GetProximityPlacementGroupArgs(), options.WithVersion());
    }
