...
namespace Pulumi.AzureRM.Compute.Preview
{
    public static class GetDedicatedHost
    {
        public static Task<GetDedicatedHostResult> InvokeAsync(GetDedicatedHostArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedHostResult>("azurerm:compute/preview:getDedicatedHost", args ?? new GetDedicatedHostArgs(), options.WithVersion());
    }
