...
namespace Pulumi.AzureRM.Compute.Preview
{
    ...
    public partial class Image : Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/preview:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/preview:Image", name, null, MakeResourceOptions(options, id))
        {
        }
