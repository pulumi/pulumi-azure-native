...
namespace Pulumi.AzureRM.Compute.Preview
{
    public static class GetDiskEncryptionSet
    {
        public static Task<GetDiskEncryptionSetResult> InvokeAsync(GetDiskEncryptionSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDiskEncryptionSetResult>("azurerm:compute/preview:getDiskEncryptionSet", args ?? new GetDiskEncryptionSetArgs(), options.WithVersion());
    }
