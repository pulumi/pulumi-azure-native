...
namespace Pulumi.AzureNative.Compute.V20220904
{
    ...
    /// {
    ///     var cloudService = new AzureNative.Compute.V20220904.CloudService("cloudService", new()
    ///     {
    ///         CloudServiceName = "{cs-name}",
    ///         Location = "westus",
    ///         Properties = new AzureNative.Compute.V20220904.Inputs.CloudServicePropertiesArgs
    ///         {
    ///             Configuration = "{ServiceConfiguration}",
    ///             NetworkProfile = new AzureNative.Compute.V20220904.Inputs.CloudServiceNetworkProfileArgs
    ///             {
    ///                 LoadBalancerConfigurations = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20220904.Inputs.LoadBalancerConfigurationArgs
    ///                     {
    ///                         Name = "contosolb",
    ///                         Properties = new AzureNative.Compute.V20220904.Inputs.LoadBalancerConfigurationPropertiesArgs
    ///                         {
    ///                             FrontendIpConfigurations = new[]
    ///                             {
    ///                                 new AzureNative.Compute.V20220904.Inputs.LoadBalancerFrontendIpConfigurationArgs
    ///                                 {
    ///                                     Name = "contosofe",
    ///                                     Properties = new AzureNative.Compute.V20220904.Inputs.LoadBalancerFrontendIpConfigurationPropertiesArgs
    ///                                     {
    ///                                         PublicIPAddress = new AzureNative.Compute.V20220904.Inputs.SubResourceArgs
    ///                                         {
    ...
    ///             RoleProfile = new AzureNative.Compute.V20220904.Inputs.CloudServiceRoleProfileArgs
    ///             {
    ///                 Roles = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20220904.Inputs.CloudServiceRoleProfilePropertiesArgs
    ///                     {
    ///                         Name = "ContosoFrontend",
    ///                         Sku = new AzureNative.Compute.V20220904.Inputs.CloudServiceRoleSkuArgs
    ///                         {
    ///                             Capacity = 1,
    ///                             Name = "Standard_D1_v2",
    ///                             Tier = "Standard",
    ...
    ///                 },
    ///             },
    ///             OsProfile = new AzureNative.Compute.V20220904.Inputs.CloudServiceOsProfileArgs
    ///             {
    ///                 Secrets = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20220904.Inputs.CloudServiceVaultSecretGroupArgs
    ///                     {
    ///                         SourceVault = new AzureNative.Compute.V20220904.Inputs.SubResourceArgs
    ///                         {
    ///                             Id = "/subscriptions/{subscription-id}/resourceGroups/ConstosoRG/providers/Microsoft.KeyVault/vaults/{keyvault-name}",
    ///                         },
    ///                         VaultCertificates = new[]
    ///                         {
    ///                             new AzureNative.Compute.V20220904.Inputs.CloudServiceVaultCertificateArgs
    ///                             {
    ...
    ///         {
    ///             Configuration = "{ServiceConfiguration}",
    ///             ExtensionProfile = new AzureNative.Compute.V20220904.Inputs.CloudServiceExtensionProfileArgs
    ///             {
    ///                 Extensions = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20220904.Inputs.ExtensionArgs
    ///                     {
    ///                         Name = "RDPExtension",
    ///                         Properties = new AzureNative.Compute.V20220904.Inputs.CloudServiceExtensionPropertiesArgs
    ///                         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20220904:CloudService")]
    public partial class CloudService : global::Pulumi.CustomResource
    {
        ...
        public CloudService(string name, CloudServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220904:CloudService", name, args ?? new CloudServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220904:CloudService", name, null, MakeResourceOptions(options, id))
        {
        }
