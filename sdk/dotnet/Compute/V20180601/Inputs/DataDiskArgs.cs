...
namespace Pulumi.AzureNative.Compute.V20180601.Inputs
{
    ...
    public sealed class DataDiskArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("caching")]
        public Input<Pulumi.AzureNative.Compute.V20180601.CachingTypes>? Caching { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20180601.DiskCreateOptionTypes> CreateOption { get; set; } = null!;
