...
namespace Pulumi.AzureNextGen.Compute.V20180601.Inputs
{
    ...
    public sealed class UpgradePolicyArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("autoOSUpgradePolicy")]
        public Input<Inputs.AutoOSUpgradePolicyArgs>? AutoOSUpgradePolicy { get; set; }
        ...
        /// </summary>
        [Input("mode")]
        public Input<Pulumi.AzureNextGen.Compute.V20180601.UpgradeMode>? Mode { get; set; }
