...
namespace Pulumi.AzureNextGen.Compute.V20180601.Inputs
{
    ...
    public sealed class VirtualMachineScaleSetVMProfileArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20180601.VirtualMachineEvictionPolicyTypes>? EvictionPolicy { get; set; }
        ...
        /// </summary>
        [Input("priority")]
        public InputUnion<string, Pulumi.AzureNextGen.Compute.V20180601.VirtualMachinePriorityTypes>? Priority { get; set; }
