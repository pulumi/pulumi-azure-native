...
namespace Pulumi.AzureNextGen.Compute.V20180601
{
    ...
    /// Disk resource.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20180601:Disk")]
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180601:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180601:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
