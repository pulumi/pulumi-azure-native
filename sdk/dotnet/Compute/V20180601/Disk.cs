...
namespace Pulumi.AzureNative.Compute.V20180601
{
    ...
    /// {
    ///     var disk = new AzureNative.Compute.V20180601.Disk("disk", new()
    ///     {
    ...
    ///             ImageReference = new AzureNative.Compute.V20180601.Inputs.ImageDiskReferenceArgs
    ///             {
    ...
    ///         DiskName = "myDisk",
    ///         Location = "West US",
    ///         OsType = AzureNative.Compute.V20180601.OperatingSystemTypes.Windows,
    ///         ResourceGroupName = "myResourceGroup",
    ///     });
    /// 
    /// });
    ...
    [AzureNativeResourceType("azure-native:compute/v20180601:Disk")]
    public partial class Disk : global::Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20180601:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20180601:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
