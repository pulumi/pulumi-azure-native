...
namespace Pulumi.AzureRM.Compute.V20180601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var proximityPlacementGroup = new AzureRM.Compute.V20180601.ProximityPlacementGroup("proximityPlacementGroup", new AzureRM.Compute.V20180601.ProximityPlacementGroupArgs
    ///         {
    ///             Location = "westus",
    ...
    public partial class ProximityPlacementGroup : Pulumi.CustomResource
    {
        ...
        public ProximityPlacementGroup(string name, ProximityPlacementGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180601:ProximityPlacementGroup", name, args ?? new ProximityPlacementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProximityPlacementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180601:ProximityPlacementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
