...
namespace Pulumi.AzureNextGen.Compute.V20180601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:compute/v20180601:GalleryImage")]
    public partial class GalleryImage : Pulumi.CustomResource
    {
        ...
        public GalleryImage(string name, GalleryImageArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180601:GalleryImage", name, args ?? new GalleryImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:compute/v20180601:GalleryImage", name, null, MakeResourceOptions(options, id))
        {
        }
