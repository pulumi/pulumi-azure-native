...
namespace Pulumi.AzureRM.Compute.V20180601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var gallery = new AzureRM.Compute.V20180601.Gallery("gallery", new AzureRM.Compute.V20180601.GalleryArgs
    ///         {
    ...
    public partial class Gallery : Pulumi.CustomResource
    {
        ...
        public Gallery(string name, GalleryArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180601:Gallery", name, args ?? new GalleryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gallery(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20180601:Gallery", name, null, MakeResourceOptions(options, id))
        {
        }
