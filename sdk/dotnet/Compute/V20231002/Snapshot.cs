...
namespace Pulumi.AzureNative.Compute.V20231002
{
    /// <summary>
    /// Snapshot resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20231002:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("copyCompletionError")]
        public Output<Outputs.CopyCompletionErrorResponse?> CopyCompletionError { get; private set; } = null!;
        ...
        /// </summary>
        [Output("incrementalSnapshotFamilyId")]
        public Output<string> IncrementalSnapshotFamilyId { get; private set; } = null!;
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20231002:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20231002:Snapshot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SnapshotArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// Indicates the error details if the background copy of a resource created via the CopyStart operation fails.
        /// </summary>
        [Input("copyCompletionError")]
        public Input<Inputs.CopyCompletionErrorArgs>? CopyCompletionError { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20231002.DataAccessAuthMode>? DataAccessAuthMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20231002.HyperVGeneration>? HyperVGeneration { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20231002.NetworkAccessPolicy>? NetworkAccessPolicy { get; set; }

        /// <summary>
        /// The Operating System type.
        /// </summary>
        [Input("osType")]
        public Input<Pulumi.AzureNative.Compute.V20231002.OperatingSystemTypes>? OsType { get; set; }

        /// <summary>
        /// Policy for controlling export on the disk.
        /// </summary>
        [Input("publicNetworkAccess")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20231002.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
