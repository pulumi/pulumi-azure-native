...
namespace Pulumi.AzureNative.Compute.V20230402
{
    ...
    /// Disk resource.
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230402:Disk")]
    public partial class Disk : global::Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230402:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230402:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
