...
namespace Pulumi.AzureNative.Compute.V20230402
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230402:DiskAccess")]
    public partial class DiskAccess : global::Pulumi.CustomResource
    {
        ...
        public DiskAccess(string name, DiskAccessArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230402:DiskAccess", name, args ?? new DiskAccessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230402:DiskAccess", name, null, MakeResourceOptions(options, id))
        {
        }
