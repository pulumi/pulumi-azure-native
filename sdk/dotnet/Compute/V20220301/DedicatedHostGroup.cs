...
namespace Pulumi.AzureNative.Compute.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20220301:DedicatedHostGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:DedicatedHostGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20220301:DedicatedHostGroup")]
    public partial class DedicatedHostGroup : global::Pulumi.CustomResource
    {
        ...
        public DedicatedHostGroup(string name, DedicatedHostGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:DedicatedHostGroup", name, args ?? new DedicatedHostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHostGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:DedicatedHostGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:compute/v20220801:DedicatedHostGroup"},
                    new global::Pulumi.Alias { Type = "azure-native:compute/v20221101:DedicatedHostGroup"},
                    new global::Pulumi.Alias { Type = "azure-native:compute/v20230301:DedicatedHostGroup"},
                },
            };
