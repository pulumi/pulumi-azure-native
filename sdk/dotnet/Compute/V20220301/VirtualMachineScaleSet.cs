...
namespace Pulumi.AzureNative.Compute.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20220301:VirtualMachineScaleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20230301:VirtualMachineScaleSet to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20220301:VirtualMachineScaleSet")]
    public partial class VirtualMachineScaleSet : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSet(string name, VirtualMachineScaleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:VirtualMachineScaleSet", name, args ?? new VirtualMachineScaleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:VirtualMachineScaleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualMachineScaleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220301.OrchestrationMode>? OrchestrationMode { get; set; }
