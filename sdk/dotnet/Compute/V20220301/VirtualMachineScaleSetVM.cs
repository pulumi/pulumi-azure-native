...
namespace Pulumi.AzureNative.Compute.V20220301
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20220301:VirtualMachineScaleSetVM")]
    public partial class VirtualMachineScaleSetVM : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVM(string name, VirtualMachineScaleSetVMArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:VirtualMachineScaleSetVM", name, args ?? new VirtualMachineScaleSetVMArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVM(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:VirtualMachineScaleSetVM", name, null, MakeResourceOptions(options, id))
        {
        }
