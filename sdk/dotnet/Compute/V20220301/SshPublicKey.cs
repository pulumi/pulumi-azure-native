...
namespace Pulumi.AzureNative.Compute.V20220301
{
    ...
    [AzureNativeResourceType("azure-native:compute/v20220301:SshPublicKey")]
    public partial class SshPublicKey : global::Pulumi.CustomResource
    {
        ...
        public SshPublicKey(string name, SshPublicKeyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:SshPublicKey", name, args ?? new SshPublicKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SshPublicKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:SshPublicKey", name, null, MakeResourceOptions(options, id))
        {
        }
