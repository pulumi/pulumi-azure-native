...
namespace Pulumi.AzureNative.Compute.V20220301
{
    public static class GetLogAnalyticExportRequestRateByInterval
    {
        ...
        public static Task<GetLogAnalyticExportRequestRateByIntervalResult> InvokeAsync(GetLogAnalyticExportRequestRateByIntervalArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLogAnalyticExportRequestRateByIntervalResult>("azure-native:compute/v20220301:getLogAnalyticExportRequestRateByInterval", args ?? new GetLogAnalyticExportRequestRateByIntervalArgs(), options.WithDefaults());
        ...
        public static Output<GetLogAnalyticExportRequestRateByIntervalResult> Invoke(GetLogAnalyticExportRequestRateByIntervalInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLogAnalyticExportRequestRateByIntervalResult>("azure-native:compute/v20220301:getLogAnalyticExportRequestRateByInterval", args ?? new GetLogAnalyticExportRequestRateByIntervalInvokeArgs(), options.WithDefaults());

        /// <summary>
        /// Export logs that show Api requests made by this subscription in the given time window to show throttling activities.
        /// </summary>
        public static Output<GetLogAnalyticExportRequestRateByIntervalResult> Invoke(GetLogAnalyticExportRequestRateByIntervalInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetLogAnalyticExportRequestRateByIntervalResult>("azure-native:compute/v20220301:getLogAnalyticExportRequestRateByInterval", args ?? new GetLogAnalyticExportRequestRateByIntervalInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetLogAnalyticExportRequestRateByIntervalArgs : global::Pulumi.InvokeArgs
    {
        ...
        public Pulumi.AzureNative.Compute.V20220301.IntervalInMins IntervalLength { get; set; }
    ...
    public sealed class GetLogAnalyticExportRequestRateByIntervalInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("intervalLength", required: true)]
        public Input<Pulumi.AzureNative.Compute.V20220301.IntervalInMins> IntervalLength { get; set; } = null!;
