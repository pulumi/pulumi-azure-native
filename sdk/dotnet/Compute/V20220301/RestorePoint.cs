...
namespace Pulumi.AzureNative.Compute.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:compute/v20220301:RestorePoint is being removed in the next major version of this provider. Upgrade to at least azure-native:compute/v20221101:RestorePoint to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:compute/v20220301:RestorePoint")]
    public partial class RestorePoint : global::Pulumi.CustomResource
    {
        ...
        public RestorePoint(string name, RestorePointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:RestorePoint", name, args ?? new RestorePointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20220301:RestorePoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RestorePointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20220301.ConsistencyModeTypes>? ConsistencyMode { get; set; }
