...
namespace Pulumi.AzureNextGen.Compute.V20150615
{
    public static class GetAvailabilitySet
    {
        public static Task<GetAvailabilitySetResult> InvokeAsync(GetAvailabilitySetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAvailabilitySetResult>("azure-nextgen:compute/v20150615:getAvailabilitySet", args ?? new GetAvailabilitySetArgs(), options.WithVersion());
    }
