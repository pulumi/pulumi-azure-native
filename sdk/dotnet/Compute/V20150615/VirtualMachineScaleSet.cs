...
namespace Pulumi.AzureNative.Compute.V20150615
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20150615:VirtualMachineScaleSet")]
    public partial class VirtualMachineScaleSet : Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSet(string name, VirtualMachineScaleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20150615:VirtualMachineScaleSet", name, args ?? new VirtualMachineScaleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20150615:VirtualMachineScaleSet", name, null, MakeResourceOptions(options, id))
        {
        }
