...
namespace Pulumi.AzureNative.Compute.V20241104
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20241104:CloudService")]
    public partial class CloudService : global::Pulumi.CustomResource
    {
        ...
        public CloudService(string name, CloudServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241104:CloudService", name, args ?? new CloudServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20241104:CloudService", name, null, MakeResourceOptions(options, id))
        {
        }
