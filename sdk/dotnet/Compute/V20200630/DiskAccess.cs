...
namespace Pulumi.AzureRM.Compute.V20200630
{
    ...
    public partial class DiskAccess : Pulumi.CustomResource
    {
        ...
        public DiskAccess(string name, DiskAccessArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200630:DiskAccess", name, args ?? new DiskAccessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:compute/v20200630:DiskAccess", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:compute/v20200501:DiskAccess"},
                },
            };
