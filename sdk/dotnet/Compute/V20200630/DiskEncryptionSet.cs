...
namespace Pulumi.AzureNative.Compute.V20200630
{
    ...
    public partial class DiskEncryptionSet : global::Pulumi.CustomResource
    {
        ...
        public DiskEncryptionSet(string name, DiskEncryptionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200630:DiskEncryptionSet", name, args ?? new DiskEncryptionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskEncryptionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200630:DiskEncryptionSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiskEncryptionSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20200630.DiskEncryptionSetType>? EncryptionType { get; set; }
