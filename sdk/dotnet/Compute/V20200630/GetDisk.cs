...
azure-native:compute/v20200630:Disk is being removed in the next major version of this provider. Please upgrade to azure-native:compute/v20220702:Disk to guarantee forwards compatibility.")]
    public static class GetDisk
    {
        ...
        public static Task<GetDiskResult> InvokeAsync(GetDiskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiskResult>("azure-native:compute/v20200630:getDisk", args ?? new GetDiskArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a disk.
        /// </summary>
        public static Output<GetDiskResult> Invoke(GetDiskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiskResult>("azure-native:compute/v20200630:getDisk", args ?? new GetDiskInvokeArgs(), options.WithDefaults());
    }
