...
namespace Pulumi.AzureNative.Compute.V20200630
{
    public static class GetDisk
    {
        ...
        public static Task<GetDiskResult> InvokeAsync(GetDiskArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDiskResult>("azure-native:compute/v20200630:getDisk", args ?? new GetDiskArgs(), options.WithVersion());

        /// <summary>
        /// Disk resource.
        /// </summary>
        public static Output<GetDiskResult> Invoke(GetDiskInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDiskResult>("azure-native:compute/v20200630:getDisk", args ?? new GetDiskInvokeArgs(), options.WithVersion());
    }
