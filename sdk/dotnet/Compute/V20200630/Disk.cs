...
namespace Pulumi.AzureNative.Compute.V20200630
{
    ...
    public partial class Disk : Pulumi.CustomResource
    {
        ...
        public Disk(string name, DiskArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200630:Disk", name, args ?? new DiskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Disk(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20200630:Disk", name, null, MakeResourceOptions(options, id))
        {
        }
