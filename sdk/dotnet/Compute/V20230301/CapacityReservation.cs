...
namespace Pulumi.AzureNative.Compute.V20230301
{
    ...
    /// {
    ///     var capacityReservation = new AzureNative.Compute.V20230301.CapacityReservation("capacityReservation", new()
    ///     {
    ///         CapacityReservationGroupName = "myCapacityReservationGroup",
    ///         CapacityReservationName = "myCapacityReservation",
    ///         Location = "westus",
    ///         ResourceGroupName = "myResourceGroup",
    ///         Sku = new AzureNative.Compute.V20230301.Inputs.SkuArgs
    ///         {
    ///             Capacity = 4,
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230301:CapacityReservation")]
    public partial class CapacityReservation : global::Pulumi.CustomResource
    {
        ...
        public CapacityReservation(string name, CapacityReservationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:CapacityReservation", name, args ?? new CapacityReservationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:CapacityReservation", name, null, MakeResourceOptions(options, id))
        {
        }
