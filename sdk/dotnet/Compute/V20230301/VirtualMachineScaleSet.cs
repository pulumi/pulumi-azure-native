...
namespace Pulumi.AzureNative.Compute.V20230301
{
    ...
    /// {
    ///     var virtualMachineScaleSet = new AzureNative.Compute.V20230301.VirtualMachineScaleSet("virtualMachineScaleSet", new()
    ///     {
    ///         Location = "westus",
    ///         Overprovision = true,
    ...
    ///             Tier = "Standard",
    ///         },
    ///         UpgradePolicy = new AzureNative.Compute.V20230301.Inputs.UpgradePolicyArgs
    ///         {
    ///             Mode = AzureNative.Compute.V20230301.UpgradeMode.Manual,
    ///         },
    ///         VirtualMachineProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///         {
    ...
    ///                 },
    ///             },
    ///             ExtensionProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetExtensionProfileArgs
    ///             {
    ///                 Extensions = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetExtensionArgs
    ///                     {
    ...
    ///                 },
    ///             },
    ///             NetworkProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetNetworkProfileArgs
    ///             {
    ...
    ///                 },
    ///             },
    ///             OsProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetOSProfileArgs
    ///             {
    ///                 AdminPassword = "{your-password}",
    ///                 AdminUsername = "{your-username}",
    ///                 ComputerNamePrefix = "{vmss-name}",
    ///             },
    ///             StorageProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetStorageProfileArgs
    ///             {
    ...
    ///                     Version = "latest",
    ///                 },
    ///                 OsDisk = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetOSDiskArgs
    ///                 {
    ///                     Caching = AzureNative.Compute.V20230301.CachingTypes.ReadWrite,
    ///                     CreateOption = "FromImage",
    ///                     ManagedDisk = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetManagedDiskParametersArgs
    ///                     {
    ...
    ///                         AutoUpgradeMinorVersion = false,
    ///                         Name = "{extension-name}",
    ///                         ProtectedSettingsFromKeyVault = new AzureNative.Compute.V20230301.Inputs.KeyVaultSecretReferenceArgs
    ///                         {
    ...
    ///         VirtualMachineProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///         {
    ///             ApplicationProfile = new AzureNative.Compute.V20230301.Inputs.ApplicationProfileArgs
    ///             {
    ///                 GalleryApplications = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20230301.Inputs.VMGalleryApplicationArgs
    ///                     {
    ...
    ///         VirtualMachineProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///         {
    ///             HardwareProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetHardwareProfileArgs
    ///             {
    ...
    ///                 DataDisks = new[]
    ///                 {
    ///                     new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetDataDiskArgs
    ///                     {
    ///                         Caching = AzureNative.Compute.V20230301.CachingTypes.ReadWrite,
    ///                         CreateOption = "Empty",
    ///                         DiskSizeGB = 1023,
    ...
    ///                 OsDisk = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetOSDiskArgs
    ///                 {
    ///                     Caching = AzureNative.Compute.V20230301.CachingTypes.ReadOnly,
    ///                     CreateOption = "FromImage",
    ///                     ManagedDisk = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetManagedDiskParametersArgs
    ///                     {
    ///                         StorageAccountType = "Standard_LRS",
    ...
    ///                 ComputerNamePrefix = "{vmss-name}",
    ///             },
    ///             ScheduledEventsProfile = new AzureNative.Compute.V20230301.Inputs.ScheduledEventsProfileArgs
    ///             {
    ///                 OsImageNotificationProfile = new AzureNative.Compute.V20230301.Inputs.OSImageNotificationProfileArgs
    ///                 {
    ///                     Enable = true,
    ...
    ///         UpgradePolicy = new AzureNative.Compute.V20230301.Inputs.UpgradePolicyArgs
    ///         {
    ///             AutomaticOSUpgradePolicy = new AzureNative.Compute.V20230301.Inputs.AutomaticOSUpgradePolicyArgs
    ///             {
    ///                 EnableAutomaticOSUpgrade = true,
    ///             },
    ///             Mode = AzureNative.Compute.V20230301.UpgradeMode.Automatic,
    ///         },
    ///         VirtualMachineProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///         {
    ///             NetworkProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetNetworkProfileArgs
    ...
    ///                 ComputerNamePrefix = "{vmss-name}",
    ///             },
    ///             SecurityPostureReference = new AzureNative.Compute.V20230301.Inputs.SecurityPostureReferenceArgs
    ///             {
    ...
    ///                     ManagedDisk = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetManagedDiskParametersArgs
    ///                     {
    ///                         SecurityProfile = new AzureNative.Compute.V20230301.Inputs.VMDiskSecurityProfileArgs
    ///                         {
    ...
    ///                 ComputerNamePrefix = "{vmss-name}",
    ///             },
    ///             ServiceArtifactReference = new AzureNative.Compute.V20230301.Inputs.ServiceArtifactReferenceArgs
    ///             {
    ...
    ///     var virtualMachineScaleSet = new AzureNative.Compute.V20230301.VirtualMachineScaleSet("virtualMachineScaleSet", new()
    ///     {
    ///         AutomaticRepairsPolicy = new AzureNative.Compute.V20230301.Inputs.AutomaticRepairsPolicyArgs
    ///         {
    ///             Enabled = true,
    ///             GracePeriod = "PT10M",
    ///         },
    ...
    ///         PriorityMixPolicy = new AzureNative.Compute.V20230301.Inputs.PriorityMixPolicyArgs
    ///         {
    ...
    ///         VirtualMachineProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///         {
    ///             BillingProfile = new AzureNative.Compute.V20230301.Inputs.BillingProfileArgs
    ///             {
    ///                 MaxPrice = -1,
    ///             },
    ...
    ///         Overprovision = true,
    ///         ResourceGroupName = "myResourceGroup",
    ///         ScaleInPolicy = new AzureNative.Compute.V20230301.Inputs.ScaleInPolicyArgs
    ///         {
    ///             ForceDeletion = true,
    ///             Rules = new[]
    ///             {
    ...
    ///             Tier = "Standard",
    ///         },
    ///         SpotRestorePolicy = new AzureNative.Compute.V20230301.Inputs.SpotRestorePolicyArgs
    ///         {
    ///             Enabled = true,
    ///             RestoreTimeout = "PT1H",
    ///         },
    ...
    ///             ScheduledEventsProfile = new AzureNative.Compute.V20230301.Inputs.ScheduledEventsProfileArgs
    ///             {
    ///                 TerminateNotificationProfile = new AzureNative.Compute.V20230301.Inputs.TerminateNotificationProfileArgs
    ///                 {
    ///                     Enable = true,
    ...
    ///         VirtualMachineProfile = new AzureNative.Compute.V20230301.Inputs.VirtualMachineScaleSetVMProfileArgs
    ///         {
    ///             CapacityReservation = new AzureNative.Compute.V20230301.Inputs.CapacityReservationProfileArgs
    ///             {
    ///                 CapacityReservationGroup = new AzureNative.Compute.V20230301.Inputs.SubResourceArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230301:VirtualMachineScaleSet")]
    public partial class VirtualMachineScaleSet : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSet(string name, VirtualMachineScaleSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:VirtualMachineScaleSet", name, args ?? new VirtualMachineScaleSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:VirtualMachineScaleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualMachineScaleSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230301.OrchestrationMode>? OrchestrationMode { get; set; }
