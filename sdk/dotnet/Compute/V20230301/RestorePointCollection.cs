...
namespace Pulumi.AzureNative.Compute.V20230301
{
    ...
    /// {
    ///     var restorePointCollection = new AzureNative.Compute.V20230301.RestorePointCollection("restorePointCollection", new()
    ///     {
    ///         Location = "norwayeast",
    ///         ResourceGroupName = "myResourceGroup",
    ///         RestorePointCollectionName = "myRpc",
    ///         Source = new AzureNative.Compute.V20230301.Inputs.RestorePointCollectionSourcePropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230301:RestorePointCollection")]
    public partial class RestorePointCollection : global::Pulumi.CustomResource
    {
        ...
        public RestorePointCollection(string name, RestorePointCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:RestorePointCollection", name, args ?? new RestorePointCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePointCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:RestorePointCollection", name, null, MakeResourceOptions(options, id))
        {
        }
