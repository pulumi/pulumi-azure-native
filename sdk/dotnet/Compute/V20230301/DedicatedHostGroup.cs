...
namespace Pulumi.AzureNative.Compute.V20230301
{
    ...
    /// {
    ///     var dedicatedHostGroup = new AzureNative.Compute.V20230301.DedicatedHostGroup("dedicatedHostGroup", new()
    ///     {
    ///         AdditionalCapabilities = new AzureNative.Compute.V20230301.Inputs.DedicatedHostGroupPropertiesAdditionalCapabilitiesArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:compute/v20230301:DedicatedHostGroup myDedicatedHostGroup /subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/HostGroups/myDedicatedHostGroup 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230301:DedicatedHostGroup")]
    public partial class DedicatedHostGroup : global::Pulumi.CustomResource
    {
        ...
        public DedicatedHostGroup(string name, DedicatedHostGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:DedicatedHostGroup", name, args ?? new DedicatedHostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DedicatedHostGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:DedicatedHostGroup", name, null, MakeResourceOptions(options, id))
        {
        }
