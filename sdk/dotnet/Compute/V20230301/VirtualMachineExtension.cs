...
namespace Pulumi.AzureNative.Compute.V20230301
{
    ...
    /// {
    ///     var virtualMachineExtension = new AzureNative.Compute.V20230301.VirtualMachineExtension("virtualMachineExtension", new()
    ///     {
    ///         AutoUpgradeMinorVersion = true,
    ///         EnableAutomaticUpgrade = true,
    ///         ForceUpdateTag = "a",
    ///         InstanceView = new AzureNative.Compute.V20230301.Inputs.VirtualMachineExtensionInstanceViewArgs
    ///         {
    ///             Name = "aaaaaaaaaaaaaaaaa",
    ///             Statuses = new[]
    ///             {
    ///                 new AzureNative.Compute.V20230301.Inputs.InstanceViewStatusArgs
    ///                 {
    ///                     Code = "aaaaaaaaaaaaaaaaaaaaaaa",
    ///                     DisplayStatus = "aaaaaa",
    ///                     Level = AzureNative.Compute.V20230301.StatusLevelTypes.Info,
    ///                     Message = "a",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:compute/v20230301:VirtualMachineExtension myVMExtension /subscriptions/{subscription-id}/resourceGroups/rgcompute/providers/Microsoft.Compute/virtualMachines/myVM/extensions/myVMExtension 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230301:VirtualMachineExtension")]
    public partial class VirtualMachineExtension : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineExtension(string name, VirtualMachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:VirtualMachineExtension", name, args ?? new VirtualMachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:VirtualMachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
