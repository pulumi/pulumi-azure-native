...
namespace Pulumi.AzureNative.Compute.V20230301
{
    public static class GetDedicatedHostGroup
    {
        ...
        public static Task<GetDedicatedHostGroupResult> InvokeAsync(GetDedicatedHostGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedHostGroupResult>("azure-native:compute/v20230301:getDedicatedHostGroup", args ?? new GetDedicatedHostGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves information about a dedicated host group.
        /// </summary>
        public static Output<GetDedicatedHostGroupResult> Invoke(GetDedicatedHostGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDedicatedHostGroupResult>("azure-native:compute/v20230301:getDedicatedHostGroup", args ?? new GetDedicatedHostGroupInvokeArgs(), options.WithDefaults());
    }
