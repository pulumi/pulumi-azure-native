...
namespace Pulumi.AzureNative.Compute.V20230301
{
    ...
    /// {
    ///     var restorePoint = new AzureNative.Compute.V20230301.RestorePoint("restorePoint", new()
    ///     {
    ///         ResourceGroupName = "myResourceGroup",
    ///         RestorePointCollectionName = "rpcName",
    ///         RestorePointName = "rpName",
    ///         SourceRestorePoint = new AzureNative.Compute.V20230301.Inputs.ApiEntityReferenceArgs
    ///         {
    ...
    ///         ExcludeDisks = new[]
    ///         {
    ///             new AzureNative.Compute.V20230301.Inputs.ApiEntityReferenceArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230301:RestorePoint")]
    public partial class RestorePoint : global::Pulumi.CustomResource
    {
        ...
        public RestorePoint(string name, RestorePointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:RestorePoint", name, args ?? new RestorePointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RestorePoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:RestorePoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RestorePointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230301.ConsistencyModeTypes>? ConsistencyMode { get; set; }
