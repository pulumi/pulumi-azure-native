...
namespace Pulumi.AzureNative.Compute.V20230301.Inputs
{
    ...
    public sealed class DiffDiskSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("option")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230301.DiffDiskOptions>? Option { get; set; }

        /// <summary>
        /// Specifies the ephemeral disk placement for operating system disk. Possible values are: **CacheDisk,** **ResourceDisk.** The defaulting behavior is: **CacheDisk** if one is configured for the VM size otherwise **ResourceDisk** is used. Refer to the VM size documentation for Windows VM at https://docs.microsoft.com/azure/virtual-machines/windows/sizes and Linux VM at https://docs.microsoft.com/azure/virtual-machines/linux/sizes to check which VM sizes exposes a cache disk.
        /// </summary>
        [Input("placement")]
        public InputUnion<string, Pulumi.AzureNative.Compute.V20230301.DiffDiskPlacement>? Placement { get; set; }
