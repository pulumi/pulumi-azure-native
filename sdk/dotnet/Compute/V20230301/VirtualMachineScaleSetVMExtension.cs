...
namespace Pulumi.AzureNative.Compute.V20230301
{
    ...
    /// {
    ///     var virtualMachineScaleSetVMExtension = new AzureNative.Compute.V20230301.VirtualMachineScaleSetVMExtension("virtualMachineScaleSetVMExtension", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20230301:VirtualMachineScaleSetVMExtension")]
    public partial class VirtualMachineScaleSetVMExtension : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachineScaleSetVMExtension(string name, VirtualMachineScaleSetVMExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:VirtualMachineScaleSetVMExtension", name, args ?? new VirtualMachineScaleSetVMExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineScaleSetVMExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20230301:VirtualMachineScaleSetVMExtension", name, null, MakeResourceOptions(options, id))
        {
        }
