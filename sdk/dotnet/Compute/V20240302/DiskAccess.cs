...
namespace Pulumi.AzureNative.Compute.V20240302
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240302:DiskAccess")]
    public partial class DiskAccess : global::Pulumi.CustomResource
    {
        ...
        public DiskAccess(string name, DiskAccessArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240302:DiskAccess", name, args ?? new DiskAccessArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccess(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240302:DiskAccess", name, null, MakeResourceOptions(options, id))
        {
        }
