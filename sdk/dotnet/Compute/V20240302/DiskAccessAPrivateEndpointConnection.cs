...
namespace Pulumi.AzureNative.Compute.V20240302
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:compute/v20240302:DiskAccessAPrivateEndpointConnection")]
    public partial class DiskAccessAPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public DiskAccessAPrivateEndpointConnection(string name, DiskAccessAPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240302:DiskAccessAPrivateEndpointConnection", name, args ?? new DiskAccessAPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAccessAPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:compute/v20240302:DiskAccessAPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
