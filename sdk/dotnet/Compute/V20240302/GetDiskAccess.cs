...
namespace Pulumi.AzureNative.Compute.V20240302
{
    public static class GetDiskAccess
    {
        ...
        public static Task<GetDiskAccessResult> InvokeAsync(GetDiskAccessArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiskAccessResult>("azure-native:compute/v20240302:getDiskAccess", args ?? new GetDiskAccessArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a disk access resource.
        /// </summary>
        public static Output<GetDiskAccessResult> Invoke(GetDiskAccessInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiskAccessResult>("azure-native:compute/v20240302:getDiskAccess", args ?? new GetDiskAccessInvokeArgs(), options.WithDefaults());
