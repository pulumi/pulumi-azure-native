...
namespace Pulumi.AzureRM.Compute
{
    ...
    public partial class GalleryImageVersion : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GalleryImageVersionPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public GalleryImageVersion(string name, GalleryImageVersionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:compute:GalleryImageVersion", name, args ?? new GalleryImageVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GalleryImageVersion(string name, Input<string> id, GalleryImageVersionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:compute:GalleryImageVersion", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GalleryImageVersion Get(string name, Input<string> id, GalleryImageVersionState? state = null, CustomResourceOptions? options = null)
        {
            return new GalleryImageVersion(name, id, state, options);
        }
    }
    ...
    public sealed class GalleryImageVersionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource location
        /// </summary>
        ...
        public Input<Inputs.GalleryImageVersionPropertiesResponseGetArgs> Properties { get; set; } = null!;
