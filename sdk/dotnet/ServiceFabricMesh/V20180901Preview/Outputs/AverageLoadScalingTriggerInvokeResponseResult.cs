...
namespace Pulumi.AzureNextGen.ServiceFabricMesh.V20180901Preview.Outputs
{
    ...
    [OutputType]
    public sealed class AverageLoadScalingTriggerInvokeResponseResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.AutoScalingResourceMetricInvokeResponseResult Metric;
        /// <summary>
        ...
        [OutputConstructor]
        private AverageLoadScalingTriggerInvokeResponseResult(
            string kind,

            double lowerLoadThreshold,

            Outputs.AutoScalingResourceMetricInvokeResponseResult metric,
