...
namespace Pulumi.AzureNextGen.ServiceFabricMesh.V20180701Preview.Outputs
{
    ...
    [OutputType]
    public sealed class IngressConfigInvokeResponseResult
    {
        /// <summary>
        /// Configuration for layer4 public connectivity for this network.
        /// </summary>
        public readonly ImmutableArray<Outputs.Layer4IngressConfigInvokeResponseResult> Layer4;
        /// <summary>
        ...
        [OutputConstructor]
        private IngressConfigInvokeResponseResult(
            ImmutableArray<Outputs.Layer4IngressConfigInvokeResponseResult> layer4,
