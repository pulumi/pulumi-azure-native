...
namespace Pulumi.AzureRM.ServiceFabricMesh.V20180701Preview.Outputs
{
    ...
    [OutputType]
    public sealed class IngressConfigResponseResult
    {
        /// <summary>
        /// Configuration for layer4 public connectivity for this network.
        /// </summary>
        public readonly ImmutableArray<Outputs.Layer4IngressConfigResponseResult> Layer4;
        /// <summary>
        ...
        [OutputConstructor]
        private IngressConfigResponseResult(
            ImmutableArray<Outputs.Layer4IngressConfigResponseResult> layer4,
