...
namespace Pulumi.AzureRM.ServiceFabricMesh.V20180701Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var network = new AzureRM.ServiceFabricMesh.V20180701Preview.Network("network", new AzureRM.ServiceFabricMesh.V20180701Preview.NetworkArgs
    ///         {
    ///             AddressPrefix = "10.0.0.4/22",
    ///             IngressConfig = new AzureRM.ServiceFabricMesh.V20180701Preview.Inputs.IngressConfigArgs
    ///             {
    ///                 Layer4 = 
    ///                 {
    ///                     new AzureRM.ServiceFabricMesh.V20180701Preview.Inputs.Layer4IngressConfigArgs
    ///                     {
    ...
    public partial class Network : Pulumi.CustomResource
    {
        ...
        public Network(string name, NetworkArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/v20180701preview:Network", name, args ?? new NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Network(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/v20180701preview:Network", name, null, MakeResourceOptions(options, id))
        {
        }
