...
namespace Pulumi.AzureRM.ServiceFabricMesh.V20180701Preview
{
    public static class GetVolume
    {
        public static Task<GetVolumeResult> InvokeAsync(GetVolumeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVolumeResult>("azurerm:servicefabricmesh/v20180701preview:getVolume", args ?? new GetVolumeArgs(), options.WithVersion());
    }
