...
namespace Pulumi.AzureNative.ServiceFabricMesh
{
    ...
    public partial class Network : global::Pulumi.CustomResource
    {
        ...
        public Network(string name, NetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:servicefabricmesh:Network", name, args ?? new NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Network(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:servicefabricmesh:Network", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_servicefabricmesh_v20180701preview:servicefabricmesh:Network" },
                    new global::Pulumi.Alias { Type = "azure-native_servicefabricmesh_v20180901preview:servicefabricmesh:Network" },
                },
            };
