...
namespace Pulumi.AzureNextGen.ServiceFabricMesh
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:servicefabricmesh:Network")]
    public partial class Network : Pulumi.CustomResource
    {
        ...
        public Network(string name, NetworkArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicefabricmesh:Network", name, args ?? new NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Network(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:servicefabricmesh:Network", name, null, MakeResourceOptions(options, id))
        {
        }
