...
namespace Pulumi.AzureRM.ServiceFabricMesh.Preview
{
    public static class GetSecretValue
    {
        public static Task<GetSecretValueResult> InvokeAsync(GetSecretValueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecretValueResult>("azurerm:servicefabricmesh/preview:getSecretValue", args ?? new GetSecretValueArgs(), options.WithVersion());
    }
