...
namespace Pulumi.AzureRM.ServiceFabricMesh.Preview
{
    ...
    public partial class Gateway : Pulumi.CustomResource
    {
        ...
        public Gateway(string name, GatewayArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/preview:Gateway", name, args ?? new GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/preview:Gateway", name, null, MakeResourceOptions(options, id))
        {
        }
