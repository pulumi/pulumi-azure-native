...
namespace Pulumi.AzureRM.ServiceFabricMesh.Preview
{
    public static class ListSecretValue
    {
        public static Task<ListSecretValueResult> InvokeAsync(ListSecretValueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListSecretValueResult>("azurerm:servicefabricmesh/preview:listSecretValue", args ?? new ListSecretValueArgs(), options.WithVersion());
    }
