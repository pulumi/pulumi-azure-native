...
namespace Pulumi.AzureRM.ServiceFabricMesh.Preview
{
    ...
    public partial class Network : Pulumi.CustomResource
    {
        ...
        public Network(string name, NetworkArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/preview:Network", name, args ?? new NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Network(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/preview:Network", name, null, MakeResourceOptions(options, id))
        {
        }
