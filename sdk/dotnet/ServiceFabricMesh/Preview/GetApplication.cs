...
namespace Pulumi.AzureRM.ServiceFabricMesh.Preview
{
    public static class GetApplication
    {
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("azurerm:servicefabricmesh/preview:getApplication", args ?? new GetApplicationArgs(), options.WithVersion());
    }
