...
namespace Pulumi.AzureRM.ServiceFabricMesh.Preview
{
    ...
    public partial class SecretValue : Pulumi.CustomResource
    {
        ...
        public SecretValue(string name, SecretValueArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/preview:SecretValue", name, args ?? new SecretValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/preview:SecretValue", name, null, MakeResourceOptions(options, id))
        {
        }
