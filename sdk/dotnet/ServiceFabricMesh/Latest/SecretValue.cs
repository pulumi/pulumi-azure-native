...
namespace Pulumi.AzureRM.ServiceFabricMesh.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var secretValue = new AzureRM.ServiceFabricMesh.Latest.SecretValue("secretValue", new AzureRM.ServiceFabricMesh.Latest.SecretValueArgs
    ///         {
    ...
    public partial class SecretValue : Pulumi.CustomResource
    {
        ...
        public SecretValue(string name, SecretValueArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:SecretValue", name, args ?? new SecretValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:SecretValue", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicefabricmesh/v20180901preview:SecretValue"},
                },
            };
