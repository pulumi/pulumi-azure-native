...
namespace Pulumi.AzureRM.ServiceFabricMesh.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var volume = new AzureRM.ServiceFabricMesh.Latest.Volume("volume", new AzureRM.ServiceFabricMesh.Latest.VolumeArgs
    ///         {
    ///             AzureFileParameters = new AzureRM.ServiceFabricMesh.Latest.Inputs.VolumeProviderParametersAzureFileArgs
    ///             {
    ...
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicefabricmesh/v20180701preview:Volume"},
