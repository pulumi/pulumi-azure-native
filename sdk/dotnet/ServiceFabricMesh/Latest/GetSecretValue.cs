...
namespace Pulumi.AzureRM.ServiceFabricMesh.Latest
{
    public static class GetSecretValue
    {
        public static Task<GetSecretValueResult> InvokeAsync(GetSecretValueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecretValueResult>("azurerm:servicefabricmesh/latest:getSecretValue", args ?? new GetSecretValueArgs(), options.WithVersion());
    }
