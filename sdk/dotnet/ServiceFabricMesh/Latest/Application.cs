...
namespace Pulumi.AzureRM.ServiceFabricMesh.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var application = new AzureRM.ServiceFabricMesh.Latest.Application("application", new AzureRM.ServiceFabricMesh.Latest.ApplicationArgs
    ///         {
    ...
    ///             Services = 
    ///             {
    ///                 new AzureRM.ServiceFabricMesh.Latest.Inputs.ServiceResourceDescriptionArgs
    ///                 {
    ...
    public partial class Application : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("diagnostics")]
        public Output<Outputs.DiagnosticsDescriptionResponseResult?> Diagnostics { get; private set; } = null!;
        ...
        /// </summary>
        [Output("services")]
        public Output<ImmutableArray<Outputs.ServiceResourceDescriptionResponseResult>> Services { get; private set; } = null!;
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:Application", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicefabricmesh/v20180701preview:Application"},
