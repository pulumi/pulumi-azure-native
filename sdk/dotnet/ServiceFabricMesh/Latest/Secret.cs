...
namespace Pulumi.AzureRM.ServiceFabricMesh.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var secret = new AzureRM.ServiceFabricMesh.Latest.Secret("secret", new AzureRM.ServiceFabricMesh.Latest.SecretArgs
    ///         {
    ///             Location = "EastUS",
    ...
    public partial class Secret : Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:Secret", name, null, MakeResourceOptions(options, id))
        {
        }
