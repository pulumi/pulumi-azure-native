...
namespace Pulumi.AzureRM.ServiceFabricMesh.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var network = new AzureRM.ServiceFabricMesh.Latest.Network("network", new AzureRM.ServiceFabricMesh.Latest.NetworkArgs
    ///         {
    ///             Location = "EastUS",
    ...
    public partial class Network : Pulumi.CustomResource
    {
        ...
        public Network(string name, NetworkArgs args, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:Network", name, args ?? new NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Network(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:servicefabricmesh/latest:Network", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:servicefabricmesh/v20180701preview:Network"},
