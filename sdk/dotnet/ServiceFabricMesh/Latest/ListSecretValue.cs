...
namespace Pulumi.AzureRM.ServiceFabricMesh.Latest
{
    public static class ListSecretValue
    {
        public static Task<ListSecretValueResult> InvokeAsync(ListSecretValueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListSecretValueResult>("azurerm:servicefabricmesh/latest:listSecretValue", args ?? new ListSecretValueArgs(), options.WithVersion());
    }
