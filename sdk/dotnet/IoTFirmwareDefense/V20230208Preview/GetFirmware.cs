...
namespace Pulumi.AzureNative.IoTFirmwareDefense.V20230208Preview
{
    public static class GetFirmware
    {
        ...
        public static Task<GetFirmwareResult> InvokeAsync(GetFirmwareArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirmwareResult>("azure-native:iotfirmwaredefense/v20230208preview:getFirmware", args ?? new GetFirmwareArgs(), options.WithDefaults());

        /// <summary>
        /// Get firmware.
        /// </summary>
        public static Output<GetFirmwareResult> Invoke(GetFirmwareInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirmwareResult>("azure-native:iotfirmwaredefense/v20230208preview:getFirmware", args ?? new GetFirmwareInvokeArgs(), options.WithDefaults());
    }
