...
namespace Pulumi.AzureNative.IoTFirmwareDefense.V20240110
{
    public static class GetFirmware
    {
        ...
        public static Task<GetFirmwareResult> InvokeAsync(GetFirmwareArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirmwareResult>("azure-native:iotfirmwaredefense/v20240110:getFirmware", args ?? new GetFirmwareArgs(), options.WithDefaults());
