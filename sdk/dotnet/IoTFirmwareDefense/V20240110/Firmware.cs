...
namespace Pulumi.AzureNative.IoTFirmwareDefense.V20240110
{
    ...
    /// Firmware definition
    /// </summary>
    [AzureNativeResourceType("azure-native:iotfirmwaredefense/v20240110:Firmware")]
    public partial class Firmware : global::Pulumi.CustomResource
    {
        ...
        public Firmware(string name, FirmwareArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotfirmwaredefense/v20240110:Firmware", name, args ?? new FirmwareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Firmware(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotfirmwaredefense/v20240110:Firmware", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FirmwareArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.IoTFirmwareDefense.V20240110.Status>? Status { get; set; }
