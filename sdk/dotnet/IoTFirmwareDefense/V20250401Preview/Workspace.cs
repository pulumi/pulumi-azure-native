...
namespace Pulumi.AzureNative.IoTFirmwareDefense.V20250401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:iotfirmwaredefense/v20250401preview:Workspace")]
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotfirmwaredefense/v20250401preview:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotfirmwaredefense/v20250401preview:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
