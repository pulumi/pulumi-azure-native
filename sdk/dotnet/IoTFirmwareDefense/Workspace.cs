...
namespace Pulumi.AzureNative.IoTFirmwareDefense
{
    ...
    public partial class Workspace : global::Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:iotfirmwaredefense:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:iotfirmwaredefense:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_iotfirmwaredefense_v20230208preview:iotfirmwaredefense:Workspace" },
                    new global::Pulumi.Alias { Type = "azure-native_iotfirmwaredefense_v20240110:iotfirmwaredefense:Workspace" },
                    new global::Pulumi.Alias { Type = "azure-native_iotfirmwaredefense_v20250401preview:iotfirmwaredefense:Workspace" },
                },
            };
