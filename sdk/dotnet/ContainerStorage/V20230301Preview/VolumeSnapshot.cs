...
namespace Pulumi.AzureNative.ContainerStorage.V20230301Preview
{
    ...
    public partial class VolumeSnapshot : global::Pulumi.CustomResource
    {
        ...
        public VolumeSnapshot(string name, VolumeSnapshotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:containerstorage/v20230301preview:VolumeSnapshot", name, args ?? new VolumeSnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VolumeSnapshot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:containerstorage/v20230301preview:VolumeSnapshot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:containerstorage:VolumeSnapshot"},
                },
            };
