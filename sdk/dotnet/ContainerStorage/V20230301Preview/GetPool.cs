...
namespace Pulumi.AzureNative.ContainerStorage.V20230301Preview
{
    public static class GetPool
    {
        ...
        public static Task<GetPoolResult> InvokeAsync(GetPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPoolResult>("azure-native:containerstorage/v20230301preview:getPool", args ?? new GetPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Pool
        /// </summary>
        public static Output<GetPoolResult> Invoke(GetPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPoolResult>("azure-native:containerstorage/v20230301preview:getPool", args ?? new GetPoolInvokeArgs(), options.WithDefaults());
    }
