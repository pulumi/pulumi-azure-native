...
namespace Pulumi.AzureNative.ContainerStorage.V20230701Preview
{
    public static class GetPool
    {
        ...
        public static Task<GetPoolResult> InvokeAsync(GetPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPoolResult>("azure-native:containerstorage/v20230701preview:getPool", args ?? new GetPoolArgs(), options.WithDefaults());
