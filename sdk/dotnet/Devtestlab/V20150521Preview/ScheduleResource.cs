...
namespace Pulumi.AzureRM.DevTestLab.V20150521Preview
{
    ...
    public partial class ScheduleResource : Pulumi.CustomResource
    {
        ...
        public ScheduleResource(string name, ScheduleResourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/v20150521preview:ScheduleResource", name, args ?? new ScheduleResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduleResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/v20150521preview:ScheduleResource", name, null, MakeResourceOptions(options, id))
        {
        }
