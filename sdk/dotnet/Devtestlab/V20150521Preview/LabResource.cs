...
namespace Pulumi.AzureRM.DevTestLab.V20150521Preview
{
    ...
    public partial class LabResource : Pulumi.CustomResource
    {
        ...
        public LabResource(string name, LabResourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/v20150521preview:LabResource", name, args ?? new LabResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LabResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/v20150521preview:LabResource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:devtestlab/latest:LabResource"},
                    new Pulumi.Alias { Type = "azurerm:devtestlab/preview:LabResource"},
                    new Pulumi.Alias { Type = "azurerm:devtestlab/v20160515:LabResource"},
                    new Pulumi.Alias { Type = "azurerm:devtestlab/v20180915:LabResource"},
                },
            };
