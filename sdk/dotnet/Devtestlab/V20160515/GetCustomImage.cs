...
namespace Pulumi.AzureRM.DevTestLab.V20160515
{
    public static class GetCustomImage
    {
        public static Task<GetCustomImageResult> InvokeAsync(GetCustomImageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCustomImageResult>("azurerm:devtestlab/v20160515:getCustomImage", args ?? new GetCustomImageArgs(), options.WithVersion());
    }
