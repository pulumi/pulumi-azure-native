...
namespace Pulumi.AzureRM.DevTestLab.Latest
{
    ...
    public partial class CustomImage : Pulumi.CustomResource
    {
        ...
        public CustomImage(string name, CustomImageArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/latest:CustomImage", name, args ?? new CustomImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomImage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/latest:CustomImage", name, null, MakeResourceOptions(options, id))
        {
        }
