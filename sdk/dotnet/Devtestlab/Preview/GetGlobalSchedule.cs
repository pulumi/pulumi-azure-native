...
namespace Pulumi.AzureRM.DevTestLab.Preview
{
    public static class GetGlobalSchedule
    {
        public static Task<GetGlobalScheduleResult> InvokeAsync(GetGlobalScheduleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGlobalScheduleResult>("azurerm:devtestlab/preview:getGlobalSchedule", args ?? new GetGlobalScheduleArgs(), options.WithVersion());
    }
