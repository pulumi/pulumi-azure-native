...
namespace Pulumi.AzureRM.DevTestLab.Preview
{
    ...
    public partial class Formula : Pulumi.CustomResource
    {
        ...
        public Formula(string name, FormulaArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/preview:Formula", name, args ?? new FormulaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Formula(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/preview:Formula", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:devtestlab/v20160515:Formula"},
