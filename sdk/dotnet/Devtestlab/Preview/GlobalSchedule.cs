...
namespace Pulumi.AzureRM.DevTestLab.Preview
{
    ...
    public partial class GlobalSchedule : Pulumi.CustomResource
    {
        ...
        public GlobalSchedule(string name, GlobalScheduleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/preview:GlobalSchedule", name, args ?? new GlobalScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalSchedule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/preview:GlobalSchedule", name, null, MakeResourceOptions(options, id))
        {
        }
