...
namespace Pulumi.AzureRM.DevTestLab.Preview
{
    public static class GetServiceFabric
    {
        public static Task<GetServiceFabricResult> InvokeAsync(GetServiceFabricArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceFabricResult>("azurerm:devtestlab/preview:getServiceFabric", args ?? new GetServiceFabricArgs(), options.WithVersion());
    }
