...
namespace Pulumi.AzureRM.DevTestLab.Preview
{
    ...
    public partial class ServiceFabric : Pulumi.CustomResource
    {
        ...
        public ServiceFabric(string name, ServiceFabricArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/preview:ServiceFabric", name, args ?? new ServiceFabricArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceFabric(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/preview:ServiceFabric", name, null, MakeResourceOptions(options, id))
        {
        }
