...
namespace Pulumi.AzureRM.DevTestLab.Preview
{
    ...
    public partial class ServiceRunner : Pulumi.CustomResource
    {
        ...
        public ServiceRunner(string name, ServiceRunnerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/preview:ServiceRunner", name, args ?? new ServiceRunnerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceRunner(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/preview:ServiceRunner", name, null, MakeResourceOptions(options, id))
        {
        }
