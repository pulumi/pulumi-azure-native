...
namespace Pulumi.AzureRM.DevTestLab.V20180915
{
    ...
    ///     public MyStack()
    ///     {
    ///         var virtualNetwork = new AzureRM.DevTestLab.V20180915.VirtualNetwork("virtualNetwork", new AzureRM.DevTestLab.V20180915.VirtualNetworkArgs
    ///         {
    ...
    public partial class VirtualNetwork : Pulumi.CustomResource
    {
        ...
        public VirtualNetwork(string name, VirtualNetworkArgs args, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/v20180915:VirtualNetwork", name, args ?? new VirtualNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNetwork(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:devtestlab/v20180915:VirtualNetwork", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:devtestlab/latest:VirtualNetwork"},
