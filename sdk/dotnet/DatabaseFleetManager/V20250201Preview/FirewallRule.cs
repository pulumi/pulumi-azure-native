...
namespace Pulumi.AzureNative.DatabaseFleetManager.V20250201Preview
{
    /// <summary>
    /// A firewall rule.
    /// </summary>
    [AzureNativeResourceType("azure-native:databasefleetmanager/v20250201preview:FirewallRule")]
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databasefleetmanager/v20250201preview:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databasefleetmanager/v20250201preview:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:databasefleetmanager:FirewallRule" },
                },
            };
