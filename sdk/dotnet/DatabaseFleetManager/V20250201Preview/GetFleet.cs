...
namespace Pulumi.AzureNative.DatabaseFleetManager.V20250201Preview
{
    public static class GetFleet
    {
        ...
        public static Task<GetFleetResult> InvokeAsync(GetFleetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFleetResult>("azure-native:databasefleetmanager/v20250201preview:getFleet", args ?? new GetFleetArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a fleet resource.
        /// </summary>
        public static Output<GetFleetResult> Invoke(GetFleetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFleetResult>("azure-native:databasefleetmanager/v20250201preview:getFleet", args ?? new GetFleetInvokeArgs(), options.WithDefaults());
