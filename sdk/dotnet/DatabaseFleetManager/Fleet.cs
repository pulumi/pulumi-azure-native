...
namespace Pulumi.AzureNative.DatabaseFleetManager
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:databasefleetmanager:Fleet")]
    public partial class Fleet : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FleetPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public Fleet(string name, FleetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databasefleetmanager:Fleet", name, args ?? new FleetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fleet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databasefleetmanager:Fleet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native_databasefleetmanager_v20250201preview:databasefleetmanager:Fleet" },
                },
            };
    ...
    public sealed class FleetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.FleetPropertiesArgs>? Properties { get; set; }
