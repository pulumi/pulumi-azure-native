...
namespace Pulumi.AzureRM.EnterpriseKnowledgeGraph.V20181203
{
    /// <summary>
    ...
    public partial class EnterpriseKnowledgeGraph : Pulumi.CustomResource
    {
        ...
        public EnterpriseKnowledgeGraph(string name, EnterpriseKnowledgeGraphArgs args, CustomResourceOptions? options = null)
            : base("azurerm:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph", name, args ?? new EnterpriseKnowledgeGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnterpriseKnowledgeGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:enterpriseknowledgegraph/preview:EnterpriseKnowledgeGraph"},
                },
            };
