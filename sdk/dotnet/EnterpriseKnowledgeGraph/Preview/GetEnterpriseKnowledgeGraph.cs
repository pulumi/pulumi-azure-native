...
namespace Pulumi.AzureRM.EnterpriseKnowledgeGraph.Preview
{
    public static class GetEnterpriseKnowledgeGraph
    {
        public static Task<GetEnterpriseKnowledgeGraphResult> InvokeAsync(GetEnterpriseKnowledgeGraphArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnterpriseKnowledgeGraphResult>("azurerm:enterpriseknowledgegraph/preview:getEnterpriseKnowledgeGraph", args ?? new GetEnterpriseKnowledgeGraphArgs(), options.WithVersion());
    }
