...
namespace Pulumi.AzureRM.EnterpriseKnowledgeGraph.Preview
{
    /// <summary>
    ...
    public partial class EnterpriseKnowledgeGraph : Pulumi.CustomResource
    {
        ...
        public EnterpriseKnowledgeGraph(string name, EnterpriseKnowledgeGraphArgs args, CustomResourceOptions? options = null)
            : base("azurerm:enterpriseknowledgegraph/preview:EnterpriseKnowledgeGraph", name, args ?? new EnterpriseKnowledgeGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EnterpriseKnowledgeGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:enterpriseknowledgegraph/preview:EnterpriseKnowledgeGraph", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:enterpriseknowledgegraph/latest:EnterpriseKnowledgeGraph"},
