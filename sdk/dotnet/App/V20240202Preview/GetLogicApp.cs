...
namespace Pulumi.AzureNative.App.V20240202Preview
{
    public static class GetLogicApp
    {
        ...
        public static Task<GetLogicAppResult> InvokeAsync(GetLogicAppArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLogicAppResult>("azure-native:app/v20240202preview:getLogicApp", args ?? new GetLogicAppArgs(), options.WithDefaults());

        /// <summary>
        /// A logic app extension resource
        /// </summary>
        public static Output<GetLogicAppResult> Invoke(GetLogicAppInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLogicAppResult>("azure-native:app/v20240202preview:getLogicApp", args ?? new GetLogicAppInvokeArgs(), options.WithDefaults());
