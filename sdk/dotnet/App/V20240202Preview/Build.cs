...
namespace Pulumi.AzureNative.App.V20240202Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240202preview:Build")]
    public partial class Build : global::Pulumi.CustomResource
    {
        ...
        public Build(string name, BuildArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240202preview:Build", name, args ?? new BuildArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Build(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240202preview:Build", name, null, MakeResourceOptions(options, id))
        {
        }
