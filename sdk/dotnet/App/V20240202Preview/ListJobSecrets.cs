...
namespace Pulumi.AzureNative.App.V20240202Preview
{
    public static class ListJobSecrets
    {
        ...
        public static Task<ListJobSecretsResult> InvokeAsync(ListJobSecretsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListJobSecretsResult>("azure-native:app/v20240202preview:listJobSecrets", args ?? new ListJobSecretsArgs(), options.WithDefaults());
