...
namespace Pulumi.AzureNative.App.V20240202Preview
{
    public static class GetAppResiliency
    {
        ...
        public static Task<GetAppResiliencyResult> InvokeAsync(GetAppResiliencyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppResiliencyResult>("azure-native:app/v20240202preview:getAppResiliency", args ?? new GetAppResiliencyArgs(), options.WithDefaults());

        /// <summary>
        /// Get container app resiliency policy.
        /// </summary>
        public static Output<GetAppResiliencyResult> Invoke(GetAppResiliencyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppResiliencyResult>("azure-native:app/v20240202preview:getAppResiliency", args ?? new GetAppResiliencyInvokeArgs(), options.WithDefaults());
    }
