...
namespace Pulumi.AzureNative.App.V20240202Preview.Inputs
{
    ...
    public sealed class DaprArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("appProtocol")]
        public InputUnion<string, Pulumi.AzureNative.App.V20240202Preview.AppProtocol>? AppProtocol { get; set; }
        ...
        /// </summary>
        [Input("logLevel")]
        public InputUnion<string, Pulumi.AzureNative.App.V20240202Preview.LogLevel>? LogLevel { get; set; }
