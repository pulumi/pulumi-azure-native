...
namespace Pulumi.AzureNative.App.V20240202Preview
{
    public static class GetContainerAppsSessionPool
    {
        ...
        public static Task<GetContainerAppsSessionPoolResult> InvokeAsync(GetContainerAppsSessionPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContainerAppsSessionPoolResult>("azure-native:app/v20240202preview:getContainerAppsSessionPool", args ?? new GetContainerAppsSessionPoolArgs(), options.WithDefaults());
        ...
        public static Output<GetContainerAppsSessionPoolResult> Invoke(GetContainerAppsSessionPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContainerAppsSessionPoolResult>("azure-native:app/v20240202preview:getContainerAppsSessionPool", args ?? new GetContainerAppsSessionPoolInvokeArgs(), options.WithDefaults());
