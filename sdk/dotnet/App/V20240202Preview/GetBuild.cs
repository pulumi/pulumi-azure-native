...
namespace Pulumi.AzureNative.App.V20240202Preview
{
    public static class GetBuild
    {
        ...
        public static Task<GetBuildResult> InvokeAsync(GetBuildArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBuildResult>("azure-native:app/v20240202preview:getBuild", args ?? new GetBuildArgs(), options.WithDefaults());

        /// <summary>
        /// Get a BuildResource
        /// </summary>
        public static Output<GetBuildResult> Invoke(GetBuildInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBuildResult>("azure-native:app/v20240202preview:getBuild", args ?? new GetBuildInvokeArgs(), options.WithDefaults());
    }
