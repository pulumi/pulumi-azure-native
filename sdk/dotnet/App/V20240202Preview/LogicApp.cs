...
namespace Pulumi.AzureNative.App.V20240202Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240202preview:LogicApp")]
    public partial class LogicApp : global::Pulumi.CustomResource
    {
        ...
        public LogicApp(string name, LogicAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240202preview:LogicApp", name, args ?? new LogicAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogicApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240202preview:LogicApp", name, null, MakeResourceOptions(options, id))
        {
        }
