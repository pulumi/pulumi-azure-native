...
namespace Pulumi.AzureNative.App
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app:Agent")]
    public partial class Agent : global::Pulumi.CustomResource
    {
        ...
        public Agent(string name, AgentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app:Agent", name, args ?? new AgentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Agent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app:Agent", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:app/v20260101:Agent" },
                },
            };
    ...
    public sealed class AgentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.AgentPropertiesArgs>? Properties { get; set; }
