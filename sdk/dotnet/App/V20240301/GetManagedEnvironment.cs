...
namespace Pulumi.AzureNative.App.V20240301
{
    public static class GetManagedEnvironment
    {
        ...
        public static Task<GetManagedEnvironmentResult> InvokeAsync(GetManagedEnvironmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedEnvironmentResult>("azure-native:app/v20240301:getManagedEnvironment", args ?? new GetManagedEnvironmentArgs(), options.WithDefaults());

        /// <summary>
        /// Get the properties of a Managed Environment used to host container apps.
        /// </summary>
        public static Output<GetManagedEnvironmentResult> Invoke(GetManagedEnvironmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagedEnvironmentResult>("azure-native:app/v20240301:getManagedEnvironment", args ?? new GetManagedEnvironmentInvokeArgs(), options.WithDefaults());
