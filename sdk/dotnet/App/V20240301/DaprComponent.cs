...
namespace Pulumi.AzureNative.App.V20240301
{
    ...
    /// Dapr Component.
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240301:DaprComponent")]
    public partial class DaprComponent : global::Pulumi.CustomResource
    {
        ...
        public DaprComponent(string name, DaprComponentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240301:DaprComponent", name, args ?? new DaprComponentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DaprComponent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240301:DaprComponent", name, null, MakeResourceOptions(options, id))
        {
        }
