...
namespace Pulumi.AzureNative.App.V20240301
{
    ...
    /// Container App Job
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240301:Job")]
    public partial class Job : global::Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240301:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240301:Job", name, null, MakeResourceOptions(options, id))
        {
        }
