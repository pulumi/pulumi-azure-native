...
namespace Pulumi.AzureNative.App.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240301:ConnectedEnvironment")]
    public partial class ConnectedEnvironment : global::Pulumi.CustomResource
    {
        ...
        public ConnectedEnvironment(string name, ConnectedEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240301:ConnectedEnvironment", name, args ?? new ConnectedEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240301:ConnectedEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
