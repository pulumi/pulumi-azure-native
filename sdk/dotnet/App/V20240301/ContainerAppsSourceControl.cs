...
namespace Pulumi.AzureNative.App.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240301:ContainerAppsSourceControl")]
    public partial class ContainerAppsSourceControl : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSourceControl(string name, ContainerAppsSourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240301:ContainerAppsSourceControl", name, args ?? new ContainerAppsSourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240301:ContainerAppsSourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:app/v20240202preview:ContainerAppsSourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20240802preview:ContainerAppsSourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20241002preview:ContainerAppsSourceControl" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20250101:ContainerAppsSourceControl" },
