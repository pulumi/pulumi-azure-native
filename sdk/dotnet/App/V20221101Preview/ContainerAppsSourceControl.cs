...
namespace Pulumi.AzureNative.App.V20221101Preview
{
    ...
    /// {
    ///     var containerAppsSourceControl = new AzureNative.App.V20221101Preview.ContainerAppsSourceControl("containerAppsSourceControl", new()
    ///     {
    ///         Branch = "master",
    ///         ContainerAppName = "testcanadacentral",
    ///         GithubActionConfiguration = new AzureNative.App.V20221101Preview.Inputs.GithubActionConfigurationArgs
    ///         {
    ///             AzureCredentials = new AzureNative.App.V20221101Preview.Inputs.AzureCredentialsArgs
    ///             {
    ///                 ClientId = "&lt;clientid&gt;",
    ...
    ///             ContextPath = "./",
    ///             Image = "image/tag",
    ///             RegistryInfo = new AzureNative.App.V20221101Preview.Inputs.RegistryInfoArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20221101preview:ContainerAppsSourceControl")]
    public partial class ContainerAppsSourceControl : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSourceControl(string name, ContainerAppsSourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20221101preview:ContainerAppsSourceControl", name, args ?? new ContainerAppsSourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20221101preview:ContainerAppsSourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
