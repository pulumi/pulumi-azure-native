...
namespace Pulumi.AzureNative.App.V20221101Preview
{
    ...
    /// {
    ///     var connectedEnvironment = new AzureNative.App.V20221101Preview.ConnectedEnvironment("connectedEnvironment", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20221101preview:ConnectedEnvironment")]
    public partial class ConnectedEnvironment : global::Pulumi.CustomResource
    {
        ...
        public ConnectedEnvironment(string name, ConnectedEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20221101preview:ConnectedEnvironment", name, args ?? new ConnectedEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20221101preview:ConnectedEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
