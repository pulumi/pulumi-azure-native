...
namespace Pulumi.AzureNative.App.V20221101Preview
{
    public static class GetJob
    {
        ...
        public static Task<GetJobResult> InvokeAsync(GetJobArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetJobResult>("azure-native:app/v20221101preview:getJob", args ?? new GetJobArgs(), options.WithDefaults());

        /// <summary>
        /// Container App Job
        /// </summary>
        public static Output<GetJobResult> Invoke(GetJobInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetJobResult>("azure-native:app/v20221101preview:getJob", args ?? new GetJobInvokeArgs(), options.WithDefaults());
