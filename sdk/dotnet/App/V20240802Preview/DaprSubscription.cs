...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240802preview:DaprSubscription")]
    public partial class DaprSubscription : global::Pulumi.CustomResource
    {
        ...
        public DaprSubscription(string name, DaprSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:DaprSubscription", name, args ?? new DaprSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DaprSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:DaprSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
