...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240802preview:Builder")]
    public partial class Builder : global::Pulumi.CustomResource
    {
        ...
        public Builder(string name, BuilderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:Builder", name, args ?? new BuilderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Builder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:Builder", name, null, MakeResourceOptions(options, id))
        {
        }
