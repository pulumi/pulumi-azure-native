...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240802preview:ManagedCertificate")]
    public partial class ManagedCertificate : global::Pulumi.CustomResource
    {
        ...
        public ManagedCertificate(string name, ManagedCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:ManagedCertificate", name, args ?? new ManagedCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:ManagedCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
