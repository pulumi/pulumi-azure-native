...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    public static class GetManagedEnvironmentAuthToken
    {
        ...
        public static Task<GetManagedEnvironmentAuthTokenResult> InvokeAsync(GetManagedEnvironmentAuthTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedEnvironmentAuthTokenResult>("azure-native:app/v20240802preview:getManagedEnvironmentAuthToken", args ?? new GetManagedEnvironmentAuthTokenArgs(), options.WithDefaults());
