...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    public static class GetAppResiliency
    {
        ...
        public static Task<GetAppResiliencyResult> InvokeAsync(GetAppResiliencyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppResiliencyResult>("azure-native:app/v20240802preview:getAppResiliency", args ?? new GetAppResiliencyArgs(), options.WithDefaults());
