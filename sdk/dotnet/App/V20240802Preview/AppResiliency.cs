...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240802preview:AppResiliency")]
    public partial class AppResiliency : global::Pulumi.CustomResource
    {
        ...
        public AppResiliency(string name, AppResiliencyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:AppResiliency", name, args ?? new AppResiliencyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppResiliency(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:AppResiliency", name, null, MakeResourceOptions(options, id))
        {
        }
