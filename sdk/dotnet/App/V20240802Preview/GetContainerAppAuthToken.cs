...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    public static class GetContainerAppAuthToken
    {
        ...
        public static Task<GetContainerAppAuthTokenResult> InvokeAsync(GetContainerAppAuthTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContainerAppAuthTokenResult>("azure-native:app/v20240802preview:getContainerAppAuthToken", args ?? new GetContainerAppAuthTokenArgs(), options.WithDefaults());
        ...
        public static Output<GetContainerAppAuthTokenResult> Invoke(GetContainerAppAuthTokenInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContainerAppAuthTokenResult>("azure-native:app/v20240802preview:getContainerAppAuthToken", args ?? new GetContainerAppAuthTokenInvokeArgs(), options.WithDefaults());
