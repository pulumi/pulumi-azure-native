...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    public static class ListContainerAppCustomHostNameAnalysis
    {
        ...
        public static Task<ListContainerAppCustomHostNameAnalysisResult> InvokeAsync(ListContainerAppCustomHostNameAnalysisArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListContainerAppCustomHostNameAnalysisResult>("azure-native:app/v20240802preview:listContainerAppCustomHostNameAnalysis", args ?? new ListContainerAppCustomHostNameAnalysisArgs(), options.WithDefaults());
        ...
        public static Output<ListContainerAppCustomHostNameAnalysisResult> Invoke(ListContainerAppCustomHostNameAnalysisInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListContainerAppCustomHostNameAnalysisResult>("azure-native:app/v20240802preview:listContainerAppCustomHostNameAnalysis", args ?? new ListContainerAppCustomHostNameAnalysisInvokeArgs(), options.WithDefaults());
