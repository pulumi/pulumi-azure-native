...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    public static class GetDotNetComponent
    {
        ...
        public static Task<GetDotNetComponentResult> InvokeAsync(GetDotNetComponentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDotNetComponentResult>("azure-native:app/v20240802preview:getDotNetComponent", args ?? new GetDotNetComponentArgs(), options.WithDefaults());

        /// <summary>
        /// .NET Component.
        /// </summary>
        public static Output<GetDotNetComponentResult> Invoke(GetDotNetComponentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDotNetComponentResult>("azure-native:app/v20240802preview:getDotNetComponent", args ?? new GetDotNetComponentInvokeArgs(), options.WithDefaults());
