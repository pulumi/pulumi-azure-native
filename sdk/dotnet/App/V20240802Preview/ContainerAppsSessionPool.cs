...
namespace Pulumi.AzureNative.App.V20240802Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20240802preview:ContainerAppsSessionPool")]
    public partial class ContainerAppsSessionPool : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSessionPool(string name, ContainerAppsSessionPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:ContainerAppsSessionPool", name, args ?? new ContainerAppsSessionPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSessionPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20240802preview:ContainerAppsSessionPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerAppsSessionPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("containerType")]
        public InputUnion<string, Pulumi.AzureNative.App.V20240802Preview.ContainerType>? ContainerType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.App.V20240802Preview.PoolManagementType>? PoolManagementType { get; set; }
