...
namespace Pulumi.AzureNative.App
{
    ...
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:app/v20250202preview:Certificate" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20250701:Certificate" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20251002preview:Certificate" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20260101:Certificate" },
                },
            };
