...
namespace Pulumi.AzureNative.App.V20221001.Inputs
{
    ...
    public sealed class DaprArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("appProtocol")]
        public InputUnion<string, Pulumi.AzureNative.App.V20221001.AppProtocol>? AppProtocol { get; set; }
        ...
        /// </summary>
        [Input("logLevel")]
        public InputUnion<string, Pulumi.AzureNative.App.V20221001.LogLevel>? LogLevel { get; set; }
