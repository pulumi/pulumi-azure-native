...
namespace Pulumi.AzureNative.App.V20221001.Inputs
{
    ...
    public sealed class IngressArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.App.V20221001.IngressClientCertificateMode>? ClientCertificateMode { get; set; }
        ...
        /// </summary>
        [Input("transport")]
        public InputUnion<string, Pulumi.AzureNative.App.V20221001.IngressTransportMethod>? Transport { get; set; }
