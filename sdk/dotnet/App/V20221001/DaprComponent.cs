...
namespace Pulumi.AzureNative.App.V20221001
{
    ...
    /// {
    ///     var daprComponent = new AzureNative.App.V20221001.DaprComponent("daprComponent", new()
    ///     {
    ...
    public partial class DaprComponent : global::Pulumi.CustomResource
    {
        ...
        public DaprComponent(string name, DaprComponentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20221001:DaprComponent", name, args ?? new DaprComponentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DaprComponent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20221001:DaprComponent", name, null, MakeResourceOptions(options, id))
        {
        }
