...
namespace Pulumi.AzureNative.App.V20220301
{
    public static class GetContainerApp
    {
        ...
        public static Task<GetContainerAppResult> InvokeAsync(GetContainerAppArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContainerAppResult>("azure-native:app/v20220301:getContainerApp", args ?? new GetContainerAppArgs(), options.WithDefaults());

        /// <summary>
        /// Container App.
        /// </summary>
        public static Output<GetContainerAppResult> Invoke(GetContainerAppInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContainerAppResult>("azure-native:app/v20220301:getContainerApp", args ?? new GetContainerAppInvokeArgs(), options.WithDefaults());
    }
