...
namespace Pulumi.AzureNative.App.V20220301
{
    ...
    /// Dapr Component.
    /// </summary>
    [Obsolete(@"azure-native:app/v20220301:DaprComponent is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:DaprComponent to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:app/v20220301:DaprComponent")]
    public partial class DaprComponent : global::Pulumi.CustomResource
    {
        ...
        public DaprComponent(string name, DaprComponentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220301:DaprComponent", name, args ?? new DaprComponentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DaprComponent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220301:DaprComponent", name, null, MakeResourceOptions(options, id))
        {
        }
