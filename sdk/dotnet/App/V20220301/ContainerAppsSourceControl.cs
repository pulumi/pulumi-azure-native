...
namespace Pulumi.AzureNative.App.V20220301
{
    ...
    /// {
    ///     var containerAppsSourceControl = new AzureNative.App.V20220301.ContainerAppsSourceControl("containerAppsSourceControl", new()
    ///     {
    ///         Branch = "master",
    ///         ContainerAppName = "testcanadacentral",
    ///         GithubActionConfiguration = new AzureNative.App.V20220301.Inputs.GithubActionConfigurationArgs
    ///         {
    ///             AzureCredentials = new AzureNative.App.V20220301.Inputs.AzureCredentialsArgs
    ///             {
    ///                 ClientId = "&lt;clientid&gt;",
    ...
    ///             ContextPath = "./",
    ///             Image = "image/tag",
    ///             RegistryInfo = new AzureNative.App.V20220301.Inputs.RegistryInfoArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:app/v20220301:ContainerAppsSourceControl current /subscriptions/651f8027-33e8-4ec4-97b4-f6e9f3dc8744/resourceGroups/workerapps-rg-xj/providers/Microsoft.App/containerApps/myapp/sourcecontrols/current 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20220301:ContainerAppsSourceControl")]
    public partial class ContainerAppsSourceControl : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSourceControl(string name, ContainerAppsSourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220301:ContainerAppsSourceControl", name, args ?? new ContainerAppsSourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220301:ContainerAppsSourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
