...
namespace Pulumi.AzureNative.App.V20230501
{
    /// <summary>
    /// Storage resource for managedEnvironment.
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230501:ManagedEnvironmentsStorage")]
    public partial class ManagedEnvironmentsStorage : global::Pulumi.CustomResource
    {
        ...
        public ManagedEnvironmentsStorage(string name, ManagedEnvironmentsStorageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ManagedEnvironmentsStorage", name, args ?? new ManagedEnvironmentsStorageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedEnvironmentsStorage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ManagedEnvironmentsStorage", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:app/v20240202preview:ManagedEnvironmentsStorage" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20240301:ManagedEnvironmentsStorage" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20240802preview:ManagedEnvironmentsStorage" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20241002preview:ManagedEnvironmentsStorage" },
                    new global::Pulumi.Alias { Type = "azure-native:app/v20250101:ManagedEnvironmentsStorage" },
                    new global::Pulumi.Alias { Type = "azure-native:app:ManagedEnvironmentsStorage" },
                },
            };
