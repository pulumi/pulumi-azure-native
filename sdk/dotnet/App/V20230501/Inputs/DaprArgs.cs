...
namespace Pulumi.AzureNative.App.V20230501.Inputs
{
    ...
    public sealed class DaprArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("appProtocol")]
        public InputUnion<string, Pulumi.AzureNative.App.V20230501.AppProtocol>? AppProtocol { get; set; }
        ...
        /// </summary>
        [Input("logLevel")]
        public InputUnion<string, Pulumi.AzureNative.App.V20230501.LogLevel>? LogLevel { get; set; }
