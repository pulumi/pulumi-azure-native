...
namespace Pulumi.AzureNative.App.V20230501.Inputs
{
    ...
    public sealed class IngressArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.App.V20230501.IngressClientCertificateMode>? ClientCertificateMode { get; set; }
        ...
        /// </summary>
        [Input("transport")]
        public InputUnion<string, Pulumi.AzureNative.App.V20230501.IngressTransportMethod>? Transport { get; set; }
