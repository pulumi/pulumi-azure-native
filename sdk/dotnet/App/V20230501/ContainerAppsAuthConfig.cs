...
namespace Pulumi.AzureNative.App.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230501:ContainerAppsAuthConfig")]
    public partial class ContainerAppsAuthConfig : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsAuthConfig(string name, ContainerAppsAuthConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ContainerAppsAuthConfig", name, args ?? new ContainerAppsAuthConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsAuthConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ContainerAppsAuthConfig", name, null, MakeResourceOptions(options, id))
        {
        }
