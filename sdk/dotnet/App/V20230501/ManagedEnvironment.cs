...
namespace Pulumi.AzureNative.App.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230501:ManagedEnvironment")]
    public partial class ManagedEnvironment : global::Pulumi.CustomResource
    {
        ...
        public ManagedEnvironment(string name, ManagedEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ManagedEnvironment", name, args ?? new ManagedEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ManagedEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
