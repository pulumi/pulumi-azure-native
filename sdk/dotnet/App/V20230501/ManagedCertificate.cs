...
namespace Pulumi.AzureNative.App.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230501:ManagedCertificate")]
    public partial class ManagedCertificate : global::Pulumi.CustomResource
    {
        ...
        public ManagedCertificate(string name, ManagedCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ManagedCertificate", name, args ?? new ManagedCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ManagedCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
