...
namespace Pulumi.AzureNative.App.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230501:ContainerAppsSourceControl")]
    public partial class ContainerAppsSourceControl : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSourceControl(string name, ContainerAppsSourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ContainerAppsSourceControl", name, args ?? new ContainerAppsSourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230501:ContainerAppsSourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
