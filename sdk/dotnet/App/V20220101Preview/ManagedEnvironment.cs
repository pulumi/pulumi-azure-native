...
namespace Pulumi.AzureNative.App.V20220101Preview
{
    ...
    /// {
    ///     var managedEnvironment = new AzureNative.App.V20220101Preview.ManagedEnvironment("managedEnvironment", new()
    ///     {
    ///         AppLogsConfiguration = new AzureNative.App.V20220101Preview.Inputs.AppLogsConfigurationArgs
    ///         {
    ///             LogAnalyticsConfiguration = new AzureNative.App.V20220101Preview.Inputs.LogAnalyticsConfigurationArgs
    ///             {
    ///                 CustomerId = "string",
    ///                 SharedKey = "string",
    ///             },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20220101preview:ManagedEnvironment")]
    public partial class ManagedEnvironment : global::Pulumi.CustomResource
    {
        ...
        public ManagedEnvironment(string name, ManagedEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220101preview:ManagedEnvironment", name, args ?? new ManagedEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220101preview:ManagedEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
