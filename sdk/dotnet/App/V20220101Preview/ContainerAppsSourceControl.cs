...
namespace Pulumi.AzureNative.App.V20220101Preview
{
    ...
    /// {
    ///     var containerAppsSourceControl = new AzureNative.App.V20220101Preview.ContainerAppsSourceControl("containerAppsSourceControl", new()
    ///     {
    ///         Branch = "master",
    ///         ContainerAppName = "testcanadacentral",
    ///         GithubActionConfiguration = new AzureNative.App.V20220101Preview.Inputs.GithubActionConfigurationArgs
    ///         {
    ///             AzureCredentials = new AzureNative.App.V20220101Preview.Inputs.AzureCredentialsArgs
    ///             {
    ///                 ClientId = "&lt;clientid&gt;",
    ///                 ClientSecret = "&lt;clientsecret&gt;",
    ///                 TenantId = "&lt;tenantid&gt;",
    ///             },
    ///             RegistryInfo = new AzureNative.App.V20220101Preview.Inputs.RegistryInfoArgs
    ///             {
    ...
    public partial class ContainerAppsSourceControl : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSourceControl(string name, ContainerAppsSourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220101preview:ContainerAppsSourceControl", name, args ?? new ContainerAppsSourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220101preview:ContainerAppsSourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
