...
namespace Pulumi.AzureNative.App.V20230502Preview
{
    public static class GetDaprComponent
    {
        ...
        public static Task<GetDaprComponentResult> InvokeAsync(GetDaprComponentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDaprComponentResult>("azure-native:app/v20230502preview:getDaprComponent", args ?? new GetDaprComponentArgs(), options.WithDefaults());

        /// <summary>
        /// Dapr Component.
        /// </summary>
        public static Output<GetDaprComponentResult> Invoke(GetDaprComponentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDaprComponentResult>("azure-native:app/v20230502preview:getDaprComponent", args ?? new GetDaprComponentInvokeArgs(), options.WithDefaults());
