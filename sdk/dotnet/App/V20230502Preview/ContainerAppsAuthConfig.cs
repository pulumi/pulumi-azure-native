...
namespace Pulumi.AzureNative.App.V20230502Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230502preview:ContainerAppsAuthConfig")]
    public partial class ContainerAppsAuthConfig : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsAuthConfig(string name, ContainerAppsAuthConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230502preview:ContainerAppsAuthConfig", name, args ?? new ContainerAppsAuthConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsAuthConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230502preview:ContainerAppsAuthConfig", name, null, MakeResourceOptions(options, id))
        {
        }
