...
namespace Pulumi.AzureNative.App.V20230502Preview
{
    ...
    /// Dapr Component.
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230502preview:ConnectedEnvironmentsDaprComponent")]
    public partial class ConnectedEnvironmentsDaprComponent : global::Pulumi.CustomResource
    {
        ...
        public ConnectedEnvironmentsDaprComponent(string name, ConnectedEnvironmentsDaprComponentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230502preview:ConnectedEnvironmentsDaprComponent", name, args ?? new ConnectedEnvironmentsDaprComponentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedEnvironmentsDaprComponent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230502preview:ConnectedEnvironmentsDaprComponent", name, null, MakeResourceOptions(options, id))
        {
        }
