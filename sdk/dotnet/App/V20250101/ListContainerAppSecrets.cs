...
namespace Pulumi.AzureNative.App.V20250101
{
    public static class ListContainerAppSecrets
    {
        ...
        public static Task<ListContainerAppSecretsResult> InvokeAsync(ListContainerAppSecretsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListContainerAppSecretsResult>("azure-native:app/v20250101:listContainerAppSecrets", args ?? new ListContainerAppSecretsArgs(), options.WithDefaults());
        ...
        public static Output<ListContainerAppSecretsResult> Invoke(ListContainerAppSecretsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListContainerAppSecretsResult>("azure-native:app/v20250101:listContainerAppSecrets", args ?? new ListContainerAppSecretsInvokeArgs(), options.WithDefaults());
