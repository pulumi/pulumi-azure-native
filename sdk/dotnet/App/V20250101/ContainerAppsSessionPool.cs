...
namespace Pulumi.AzureNative.App.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20250101:ContainerAppsSessionPool")]
    public partial class ContainerAppsSessionPool : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSessionPool(string name, ContainerAppsSessionPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20250101:ContainerAppsSessionPool", name, args ?? new ContainerAppsSessionPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSessionPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20250101:ContainerAppsSessionPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerAppsSessionPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("containerType")]
        public InputUnion<string, Pulumi.AzureNative.App.V20250101.ContainerType>? ContainerType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.App.V20250101.PoolManagementType>? PoolManagementType { get; set; }
