...
namespace Pulumi.AzureNative.App.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20250101:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20250101:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20250101:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
