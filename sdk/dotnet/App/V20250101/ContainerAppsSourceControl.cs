...
namespace Pulumi.AzureNative.App.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20250101:ContainerAppsSourceControl")]
    public partial class ContainerAppsSourceControl : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSourceControl(string name, ContainerAppsSourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20250101:ContainerAppsSourceControl", name, args ?? new ContainerAppsSourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20250101:ContainerAppsSourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
