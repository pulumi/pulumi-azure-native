...
namespace Pulumi.AzureNative.App.V20250101
{
    ...
    /// Dapr Component.
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20250101:DaprComponent")]
    public partial class DaprComponent : global::Pulumi.CustomResource
    {
        ...
        public DaprComponent(string name, DaprComponentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20250101:DaprComponent", name, args ?? new DaprComponentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DaprComponent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20250101:DaprComponent", name, null, MakeResourceOptions(options, id))
        {
        }
