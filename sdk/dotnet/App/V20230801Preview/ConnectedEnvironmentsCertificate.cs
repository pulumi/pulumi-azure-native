...
namespace Pulumi.AzureNative.App.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230801preview:ConnectedEnvironmentsCertificate")]
    public partial class ConnectedEnvironmentsCertificate : global::Pulumi.CustomResource
    {
        ...
        public ConnectedEnvironmentsCertificate(string name, ConnectedEnvironmentsCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230801preview:ConnectedEnvironmentsCertificate", name, args ?? new ConnectedEnvironmentsCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectedEnvironmentsCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230801preview:ConnectedEnvironmentsCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
