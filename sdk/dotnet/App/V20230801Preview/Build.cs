...
namespace Pulumi.AzureNative.App.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230801preview:Build")]
    public partial class Build : global::Pulumi.CustomResource
    {
        ...
        public Build(string name, BuildArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230801preview:Build", name, args ?? new BuildArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Build(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230801preview:Build", name, null, MakeResourceOptions(options, id))
        {
        }
