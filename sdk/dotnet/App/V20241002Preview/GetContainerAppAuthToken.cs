...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    public static class GetContainerAppAuthToken
    {
        ...
        public static Task<GetContainerAppAuthTokenResult> InvokeAsync(GetContainerAppAuthTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContainerAppAuthTokenResult>("azure-native:app/v20241002preview:getContainerAppAuthToken", args ?? new GetContainerAppAuthTokenArgs(), options.WithDefaults());
        ...
        public static Output<GetContainerAppAuthTokenResult> Invoke(GetContainerAppAuthTokenInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContainerAppAuthTokenResult>("azure-native:app/v20241002preview:getContainerAppAuthToken", args ?? new GetContainerAppAuthTokenInvokeArgs(), options.WithDefaults());
