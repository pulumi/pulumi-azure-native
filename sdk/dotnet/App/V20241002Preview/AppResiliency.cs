...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20241002preview:AppResiliency")]
    public partial class AppResiliency : global::Pulumi.CustomResource
    {
        ...
        public AppResiliency(string name, AppResiliencyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:AppResiliency", name, args ?? new AppResiliencyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppResiliency(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:AppResiliency", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:app:AppResiliency" },
