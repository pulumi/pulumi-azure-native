...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20241002preview:DaprSubscription")]
    public partial class DaprSubscription : global::Pulumi.CustomResource
    {
        ...
        public DaprSubscription(string name, DaprSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:DaprSubscription", name, args ?? new DaprSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DaprSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:DaprSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
