...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20241002preview:ContainerAppsSessionPool")]
    public partial class ContainerAppsSessionPool : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSessionPool(string name, ContainerAppsSessionPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:ContainerAppsSessionPool", name, args ?? new ContainerAppsSessionPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSessionPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:ContainerAppsSessionPool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerAppsSessionPoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("containerType")]
        public InputUnion<string, Pulumi.AzureNative.App.V20241002Preview.ContainerType>? ContainerType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.App.V20241002Preview.PoolManagementType>? PoolManagementType { get; set; }
