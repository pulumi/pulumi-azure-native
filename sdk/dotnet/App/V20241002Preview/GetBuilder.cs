...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    public static class GetBuilder
    {
        ...
        public static Task<GetBuilderResult> InvokeAsync(GetBuilderArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBuilderResult>("azure-native:app/v20241002preview:getBuilder", args ?? new GetBuilderArgs(), options.WithDefaults());

        /// <summary>
        /// Get a BuilderResource
        /// </summary>
        public static Output<GetBuilderResult> Invoke(GetBuilderInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBuilderResult>("azure-native:app/v20241002preview:getBuilder", args ?? new GetBuilderInvokeArgs(), options.WithDefaults());
    }
