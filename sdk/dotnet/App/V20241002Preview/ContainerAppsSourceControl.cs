...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20241002preview:ContainerAppsSourceControl")]
    public partial class ContainerAppsSourceControl : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsSourceControl(string name, ContainerAppsSourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:ContainerAppsSourceControl", name, args ?? new ContainerAppsSourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsSourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:ContainerAppsSourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
