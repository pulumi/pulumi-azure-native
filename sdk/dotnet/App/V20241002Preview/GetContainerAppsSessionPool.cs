...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    public static class GetContainerAppsSessionPool
    {
        ...
        public static Task<GetContainerAppsSessionPoolResult> InvokeAsync(GetContainerAppsSessionPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContainerAppsSessionPoolResult>("azure-native:app/v20241002preview:getContainerAppsSessionPool", args ?? new GetContainerAppsSessionPoolArgs(), options.WithDefaults());
