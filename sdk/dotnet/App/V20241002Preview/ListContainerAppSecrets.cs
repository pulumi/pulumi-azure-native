...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    public static class ListContainerAppSecrets
    {
        ...
        public static Task<ListContainerAppSecretsResult> InvokeAsync(ListContainerAppSecretsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListContainerAppSecretsResult>("azure-native:app/v20241002preview:listContainerAppSecrets", args ?? new ListContainerAppSecretsArgs(), options.WithDefaults());
        ...
        public static Output<ListContainerAppSecretsResult> Invoke(ListContainerAppSecretsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListContainerAppSecretsResult>("azure-native:app/v20241002preview:listContainerAppSecrets", args ?? new ListContainerAppSecretsInvokeArgs(), options.WithDefaults());
    }
