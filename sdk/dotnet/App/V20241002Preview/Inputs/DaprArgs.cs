...
namespace Pulumi.AzureNative.App.V20241002Preview.Inputs
{
    ...
    public sealed class DaprArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("appProtocol")]
        public InputUnion<string, Pulumi.AzureNative.App.V20241002Preview.AppProtocol>? AppProtocol { get; set; }
        ...
        /// </summary>
        [Input("logLevel")]
        public InputUnion<string, Pulumi.AzureNative.App.V20241002Preview.LogLevel>? LogLevel { get; set; }
