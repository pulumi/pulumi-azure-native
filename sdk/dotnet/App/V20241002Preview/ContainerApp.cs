...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    ...
    /// Container App.
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20241002preview:ContainerApp")]
    public partial class ContainerApp : global::Pulumi.CustomResource
    {
        ...
        public Output<string> RunningStatus { get; private set; } = null!;
        ...
        public ContainerApp(string name, ContainerAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:ContainerApp", name, args ?? new ContainerAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20241002preview:ContainerApp", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ContainerAppArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.App.V20241002Preview.Kind>? Kind { get; set; }
