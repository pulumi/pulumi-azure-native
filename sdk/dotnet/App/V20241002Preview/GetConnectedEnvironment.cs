...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    public static class GetConnectedEnvironment
    {
        ...
        public static Task<GetConnectedEnvironmentResult> InvokeAsync(GetConnectedEnvironmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConnectedEnvironmentResult>("azure-native:app/v20241002preview:getConnectedEnvironment", args ?? new GetConnectedEnvironmentArgs(), options.WithDefaults());
        ...
        public static Output<GetConnectedEnvironmentResult> Invoke(GetConnectedEnvironmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConnectedEnvironmentResult>("azure-native:app/v20241002preview:getConnectedEnvironment", args ?? new GetConnectedEnvironmentInvokeArgs(), options.WithDefaults());
    }
