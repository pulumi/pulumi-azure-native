...
namespace Pulumi.AzureNative.App.V20241002Preview
{
    public static class GetDaprSubscription
    {
        ...
        public static Task<GetDaprSubscriptionResult> InvokeAsync(GetDaprSubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDaprSubscriptionResult>("azure-native:app/v20241002preview:getDaprSubscription", args ?? new GetDaprSubscriptionArgs(), options.WithDefaults());

        /// <summary>
        /// Dapr PubSub Event Subscription.
        /// </summary>
        public static Output<GetDaprSubscriptionResult> Invoke(GetDaprSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDaprSubscriptionResult>("azure-native:app/v20241002preview:getDaprSubscription", args ?? new GetDaprSubscriptionInvokeArgs(), options.WithDefaults());
