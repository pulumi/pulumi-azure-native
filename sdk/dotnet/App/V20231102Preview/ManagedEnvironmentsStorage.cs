...
namespace Pulumi.AzureNative.App.V20231102Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20231102preview:ManagedEnvironmentsStorage")]
    public partial class ManagedEnvironmentsStorage : global::Pulumi.CustomResource
    {
        ...
        public ManagedEnvironmentsStorage(string name, ManagedEnvironmentsStorageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20231102preview:ManagedEnvironmentsStorage", name, args ?? new ManagedEnvironmentsStorageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedEnvironmentsStorage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20231102preview:ManagedEnvironmentsStorage", name, null, MakeResourceOptions(options, id))
        {
        }
