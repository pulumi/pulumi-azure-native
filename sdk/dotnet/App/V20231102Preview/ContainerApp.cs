...
namespace Pulumi.AzureNative.App.V20231102Preview
{
    ...
    /// Container App.
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20231102preview:ContainerApp")]
    public partial class ContainerApp : global::Pulumi.CustomResource
    {
        ...
        public ContainerApp(string name, ContainerAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20231102preview:ContainerApp", name, args ?? new ContainerAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20231102preview:ContainerApp", name, null, MakeResourceOptions(options, id))
        {
        }
