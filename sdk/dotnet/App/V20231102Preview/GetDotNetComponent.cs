...
namespace Pulumi.AzureNative.App.V20231102Preview
{
    public static class GetDotNetComponent
    {
        ...
        public static Task<GetDotNetComponentResult> InvokeAsync(GetDotNetComponentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDotNetComponentResult>("azure-native:app/v20231102preview:getDotNetComponent", args ?? new GetDotNetComponentArgs(), options.WithDefaults());
