...
namespace Pulumi.AzureNative.App.V20231102Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20231102preview:ManagedEnvironment")]
    public partial class ManagedEnvironment : global::Pulumi.CustomResource
    {
        ...
        public ManagedEnvironment(string name, ManagedEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20231102preview:ManagedEnvironment", name, args ?? new ManagedEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20231102preview:ManagedEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
