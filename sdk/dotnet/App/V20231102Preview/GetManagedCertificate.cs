...
namespace Pulumi.AzureNative.App.V20231102Preview
{
    public static class GetManagedCertificate
    {
        ...
        public static Task<GetManagedCertificateResult> InvokeAsync(GetManagedCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedCertificateResult>("azure-native:app/v20231102preview:getManagedCertificate", args ?? new GetManagedCertificateArgs(), options.WithDefaults());

        /// <summary>
        /// Managed certificates used for Custom Domain bindings of Container Apps in a Managed Environment
        /// </summary>
        public static Output<GetManagedCertificateResult> Invoke(GetManagedCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagedCertificateResult>("azure-native:app/v20231102preview:getManagedCertificate", args ?? new GetManagedCertificateInvokeArgs(), options.WithDefaults());
    }
