...
namespace Pulumi.AzureNative.App.V20220601Preview
{
    ...
    /// Container App.
    /// </summary>
    [Obsolete(@"azure-native:app/v20220601preview:ContainerApp is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20221001:ContainerApp to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:app/v20220601preview:ContainerApp")]
    public partial class ContainerApp : global::Pulumi.CustomResource
    {
        ...
        public ContainerApp(string name, ContainerAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220601preview:ContainerApp", name, args ?? new ContainerAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220601preview:ContainerApp", name, null, MakeResourceOptions(options, id))
        {
        }
