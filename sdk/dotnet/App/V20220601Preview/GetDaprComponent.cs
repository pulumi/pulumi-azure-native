...
{
    [Obsolete(@"azure-native:app/v20220601preview:DaprComponent is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:DaprComponent to guarantee forwards compatibility.")]
    public static class GetDaprComponent
    {
        ...
        public static Task<GetDaprComponentResult> InvokeAsync(GetDaprComponentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDaprComponentResult>("azure-native:app/v20220601preview:getDaprComponent", args ?? new GetDaprComponentArgs(), options.WithDefaults());

        /// <summary>
        /// Dapr Component.
        /// </summary>
        public static Output<GetDaprComponentResult> Invoke(GetDaprComponentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDaprComponentResult>("azure-native:app/v20220601preview:getDaprComponent", args ?? new GetDaprComponentInvokeArgs(), options.WithDefaults());
    }
