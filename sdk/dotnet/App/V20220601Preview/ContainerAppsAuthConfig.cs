...
namespace Pulumi.AzureNative.App.V20220601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:app/v20220601preview:ContainerAppsAuthConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ContainerAppsAuthConfig to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:app/v20220601preview:ContainerAppsAuthConfig")]
    public partial class ContainerAppsAuthConfig : global::Pulumi.CustomResource
    {
        ...
        public ContainerAppsAuthConfig(string name, ContainerAppsAuthConfigArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220601preview:ContainerAppsAuthConfig", name, args ?? new ContainerAppsAuthConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerAppsAuthConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20220601preview:ContainerAppsAuthConfig", name, null, MakeResourceOptions(options, id))
        {
        }
