...
namespace Pulumi.AzureNative.App.V20230401Preview
{
    ...
    /// Dapr Component.
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230401preview:DaprComponent")]
    public partial class DaprComponent : global::Pulumi.CustomResource
    {
        ...
        public DaprComponent(string name, DaprComponentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230401preview:DaprComponent", name, args ?? new DaprComponentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DaprComponent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230401preview:DaprComponent", name, null, MakeResourceOptions(options, id))
        {
        }
