...
namespace Pulumi.AzureNative.App.V20230401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:app/v20230401preview:ManagedEnvironmentsStorage")]
    public partial class ManagedEnvironmentsStorage : global::Pulumi.CustomResource
    {
        ...
        public ManagedEnvironmentsStorage(string name, ManagedEnvironmentsStorageArgs args, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230401preview:ManagedEnvironmentsStorage", name, args ?? new ManagedEnvironmentsStorageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedEnvironmentsStorage(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:app/v20230401preview:ManagedEnvironmentsStorage", name, null, MakeResourceOptions(options, id))
        {
        }
