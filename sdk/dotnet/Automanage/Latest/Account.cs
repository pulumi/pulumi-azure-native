...
namespace Pulumi.AzureRM.Automanage.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var account = new AzureRM.Automanage.Latest.Account("account", new AzureRM.Automanage.Latest.AccountArgs
    ///         {
    ///             AccountName = "account",
    ///             Identity = new AzureRM.Automanage.Latest.Inputs.AccountIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "East US",
    ...
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:automanage/latest:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:automanage/latest:Account", name, null, MakeResourceOptions(options, id))
        {
        }
