...
namespace Pulumi.AzureNative.Automanage.V20210430Preview
{
    ...
    public partial class ConfigurationProfileHCRPAssignment : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationProfileHCRPAssignment(string name, ConfigurationProfileHCRPAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20210430preview:ConfigurationProfileHCRPAssignment", name, args ?? new ConfigurationProfileHCRPAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfileHCRPAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20210430preview:ConfigurationProfileHCRPAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:automanage:ConfigurationProfileHCRPAssignment" },
