...
namespace Pulumi.AzureNative.Automanage.V20210430Preview
{
    ...
    public partial class ConfigurationProfileHCIAssignment : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationProfileHCIAssignment(string name, ConfigurationProfileHCIAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20210430preview:ConfigurationProfileHCIAssignment", name, args ?? new ConfigurationProfileHCIAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfileHCIAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20210430preview:ConfigurationProfileHCIAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:automanage:ConfigurationProfileHCIAssignment" },
