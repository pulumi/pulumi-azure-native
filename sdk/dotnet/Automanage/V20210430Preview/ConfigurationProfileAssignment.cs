...
namespace Pulumi.AzureNative.Automanage.V20210430Preview
{
    ...
    public partial class ConfigurationProfileAssignment : Pulumi.CustomResource
    {
        ...
        public ConfigurationProfileAssignment(string name, ConfigurationProfileAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20210430preview:ConfigurationProfileAssignment", name, args ?? new ConfigurationProfileAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfileAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20210430preview:ConfigurationProfileAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
