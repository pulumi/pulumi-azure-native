...
namespace Pulumi.AzureNative.Automanage.V20210430Preview
{
    ...
    public partial class ConfigurationProfile : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationProfile(string name, ConfigurationProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20210430preview:ConfigurationProfile", name, args ?? new ConfigurationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20210430preview:ConfigurationProfile", name, null, MakeResourceOptions(options, id))
        {
        }
