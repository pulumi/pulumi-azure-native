...
namespace Pulumi.AzureNative.Automanage
{
    ...
    public partial class ConfigurationProfileHCIAssignment : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationProfileHCIAssignment(string name, ConfigurationProfileHCIAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automanage:ConfigurationProfileHCIAssignment", name, args ?? new ConfigurationProfileHCIAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfileHCIAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automanage:ConfigurationProfileHCIAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_automanage_v20210430preview:automanage:ConfigurationProfileHCIAssignment" },
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConfigurationProfileHCIAssignment Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ConfigurationProfileHCIAssignment(name, id, options);
        }
    }
