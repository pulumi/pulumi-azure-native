...
namespace Pulumi.AzureNative.Automanage
{
    ...
    public partial class ConfigurationProfile : Pulumi.CustomResource
    {
        ...
        public ConfigurationProfile(string name, ConfigurationProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automanage:ConfigurationProfile", name, args ?? new ConfigurationProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automanage:ConfigurationProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:automanage:ConfigurationProfile"},
                    new Pulumi.Alias { Type = "azure-native:automanage/v20210430preview:ConfigurationProfile"},
                    new Pulumi.Alias { Type = "azure-nextgen:automanage/v20210430preview:ConfigurationProfile"},
                },
            };
