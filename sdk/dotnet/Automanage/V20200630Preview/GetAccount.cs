...
namespace Pulumi.AzureNative.Automanage.V20200630Preview
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:automanage/v20200630preview:getAccount", args ?? new GetAccountArgs(), options.WithVersion());

        /// <summary>
        /// Definition of the Automanage account.
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:automanage/v20200630preview:getAccount", args ?? new GetAccountInvokeArgs(), options.WithVersion());
    }
