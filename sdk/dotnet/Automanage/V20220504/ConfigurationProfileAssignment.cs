...
namespace Pulumi.AzureNative.Automanage.V20220504
{
    ...
    /// {
    ///     var configurationProfileAssignment = new AzureNative.Automanage.V20220504.ConfigurationProfileAssignment("configurationProfileAssignment", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:automanage/v20220504:ConfigurationProfileAssignment default /subscriptions/subscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.Compute/virtualMachines/myVMName/providers/Microsoft.Automanage/configurationProfileAssignments/default 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:automanage/v20220504:ConfigurationProfileAssignment")]
    public partial class ConfigurationProfileAssignment : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationProfileAssignment(string name, ConfigurationProfileAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20220504:ConfigurationProfileAssignment", name, args ?? new ConfigurationProfileAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationProfileAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:automanage/v20220504:ConfigurationProfileAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
