...
namespace Pulumi.AzureRM.Security.Preview
{
    ...
    public partial class SecurityContact : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.SecurityContactPropertiesResponseAlertNotificationsResult?> AlertNotifications { get; private set; } = null!;
        ...
        public Output<Outputs.SecurityContactPropertiesResponseNotificationsByRoleResult?> NotificationsByRole { get; private set; } = null!;
        ...
        public SecurityContact(string name, SecurityContactArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/preview:SecurityContact", name, args ?? new SecurityContactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityContact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/preview:SecurityContact", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:security/v20200101preview:SecurityContact"},
                },
            };
