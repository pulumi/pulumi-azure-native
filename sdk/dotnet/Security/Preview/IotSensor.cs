...
namespace Pulumi.AzureRM.Security.Preview
{
    ...
    public partial class IotSensor : Pulumi.CustomResource
    {
        ...
        public IotSensor(string name, IotSensorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/preview:IotSensor", name, args ?? new IotSensorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotSensor(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/preview:IotSensor", name, null, MakeResourceOptions(options, id))
        {
        }
