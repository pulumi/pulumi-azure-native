...
namespace Pulumi.AzureRM.Security.Preview
{
    ...
    public partial class AlertsSuppressionRule : Pulumi.CustomResource
    {
        ...
        public AlertsSuppressionRule(string name, AlertsSuppressionRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/preview:AlertsSuppressionRule", name, args ?? new AlertsSuppressionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertsSuppressionRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/preview:AlertsSuppressionRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:security/v20190101preview:AlertsSuppressionRule"},
                },
            };
