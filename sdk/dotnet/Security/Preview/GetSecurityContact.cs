...
namespace Pulumi.AzureRM.Security.Preview
{
    public static class GetSecurityContact
    {
        public static Task<GetSecurityContactResult> InvokeAsync(GetSecurityContactArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecurityContactResult>("azurerm:security/preview:getSecurityContact", args ?? new GetSecurityContactArgs(), options.WithVersion());
    }
