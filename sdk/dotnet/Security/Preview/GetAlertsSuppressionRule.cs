...
namespace Pulumi.AzureRM.Security.Preview
{
    public static class GetAlertsSuppressionRule
    {
        public static Task<GetAlertsSuppressionRuleResult> InvokeAsync(GetAlertsSuppressionRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAlertsSuppressionRuleResult>("azurerm:security/preview:getAlertsSuppressionRule", args ?? new GetAlertsSuppressionRuleArgs(), options.WithVersion());
    }
