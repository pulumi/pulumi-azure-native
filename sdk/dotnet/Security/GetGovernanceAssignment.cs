...
namespace Pulumi.AzureNative.Security
{
    public static class GetGovernanceAssignment
    {
        ...
        public static Task<GetGovernanceAssignmentResult> InvokeAsync(GetGovernanceAssignmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGovernanceAssignmentResult>("azure-native:security:getGovernanceAssignment", args ?? new GetGovernanceAssignmentArgs(), options.WithDefaults());
        ...
        public static Output<GetGovernanceAssignmentResult> Invoke(GetGovernanceAssignmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGovernanceAssignmentResult>("azure-native:security:getGovernanceAssignment", args ?? new GetGovernanceAssignmentInvokeArgs(), options.WithDefaults());
    }
