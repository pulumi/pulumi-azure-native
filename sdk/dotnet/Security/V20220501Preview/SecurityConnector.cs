...
namespace Pulumi.AzureNative.Security.V20220501Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:security/v20220501preview:SecurityConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:security/v20220801preview:SecurityConnector to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:security/v20220501preview:SecurityConnector")]
    public partial class SecurityConnector : global::Pulumi.CustomResource
    {
        ...
        public SecurityConnector(string name, SecurityConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20220501preview:SecurityConnector", name, args ?? new SecurityConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20220501preview:SecurityConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Security.V20220501Preview.CloudName>? EnvironmentName { get; set; }
