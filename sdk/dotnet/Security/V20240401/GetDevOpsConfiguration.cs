...
namespace Pulumi.AzureNative.Security.V20240401
{
    public static class GetDevOpsConfiguration
    {
        ...
        public static Task<GetDevOpsConfigurationResult> InvokeAsync(GetDevOpsConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDevOpsConfigurationResult>("azure-native:security/v20240401:getDevOpsConfiguration", args ?? new GetDevOpsConfigurationArgs(), options.WithDefaults());
