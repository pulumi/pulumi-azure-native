...
namespace Pulumi.AzureNative.Security.V20240401
{
    public static class ListAzureDevOpsOrgAvailable
    {
        ...
        public static Task<ListAzureDevOpsOrgAvailableResult> InvokeAsync(ListAzureDevOpsOrgAvailableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAzureDevOpsOrgAvailableResult>("azure-native:security/v20240401:listAzureDevOpsOrgAvailable", args ?? new ListAzureDevOpsOrgAvailableArgs(), options.WithDefaults());
        ...
        public static Output<ListAzureDevOpsOrgAvailableResult> Invoke(ListAzureDevOpsOrgAvailableInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListAzureDevOpsOrgAvailableResult>("azure-native:security/v20240401:listAzureDevOpsOrgAvailable", args ?? new ListAzureDevOpsOrgAvailableInvokeArgs(), options.WithDefaults());
    }
