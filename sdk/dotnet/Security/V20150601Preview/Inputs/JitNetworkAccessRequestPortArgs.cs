...
namespace Pulumi.AzureNative.Security.V20150601Preview.Inputs
{
    ...
    public sealed class JitNetworkAccessRequestPortArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public InputUnion<string, Pulumi.AzureNative.Security.V20150601Preview.Status> Status { get; set; } = null!;

        /// <summary>
        /// A description of why the `status` has its value
        /// </summary>
        [Input("statusReason", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Security.V20150601Preview.StatusReason> StatusReason { get; set; } = null!;

        public JitNetworkAccessRequestPortArgs()
        {
        }
        public static new JitNetworkAccessRequestPortArgs Empty => new JitNetworkAccessRequestPortArgs();
    }
}
