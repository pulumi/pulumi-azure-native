...
namespace Pulumi.AzureRM.Security.V20150601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var jitNetworkAccessPolicy = new AzureRM.Security.V20150601Preview.JitNetworkAccessPolicy("jitNetworkAccessPolicy", new AzureRM.Security.V20150601Preview.JitNetworkAccessPolicyArgs
    ///         {
    ...
    ///             Requests = 
    ///             {
    ///                 new AzureRM.Security.V20150601Preview.Inputs.JitNetworkAccessRequestArgs
    ///                 {
    ///                     Requestor = "barbara@contoso.com",
    ///                     StartTimeUtc = "2018-05-17T08:06:45.5691611Z",
    ///                     VirtualMachines = 
    ///                     {
    ///                         new AzureRM.Security.V20150601Preview.Inputs.JitNetworkAccessRequestVirtualMachineArgs
    ///                         {
    ///                             Id = "/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/myRg1/providers/Microsoft.Compute/virtualMachines/vm1",
    ///                             Ports = 
    ///                             {
    ///                                 new AzureRM.Security.V20150601Preview.Inputs.JitNetworkAccessRequestPortArgs
    ///                                 {
    ...
    ///             VirtualMachines = 
    ///             {
    ///                 new AzureRM.Security.V20150601Preview.Inputs.JitNetworkAccessPolicyVirtualMachineArgs
    ///                 {
    ///                     Id = "/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/myRg1/providers/Microsoft.Compute/virtualMachines/vm1",
    ///                     Ports = 
    ///                     {
    ///                         new AzureRM.Security.V20150601Preview.Inputs.JitNetworkAccessPortRuleArgs
    ///                         {
    ...
    public partial class JitNetworkAccessPolicy : Pulumi.CustomResource
    {
        ...
        public JitNetworkAccessPolicy(string name, JitNetworkAccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/v20150601preview:JitNetworkAccessPolicy", name, args ?? new JitNetworkAccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JitNetworkAccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/v20150601preview:JitNetworkAccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
