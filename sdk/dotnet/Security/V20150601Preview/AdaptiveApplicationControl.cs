...
namespace Pulumi.AzureRM.Security.V20150601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var adaptiveApplicationControl = new AzureRM.Security.V20150601Preview.AdaptiveApplicationControl("adaptiveApplicationControl", new AzureRM.Security.V20150601Preview.AdaptiveApplicationControlArgs
    ///         {
    ...
    ///             PathRecommendations = 
    ///             {
    ///                 new AzureRM.Security.V20150601Preview.Inputs.PathRecommendationArgs
    ///                 {
    ///                     Action = "Recommended",
    ///                     Common = true,
    ...
    ///                     PublisherInfo = new AzureRM.Security.V20150601Preview.Inputs.PublisherInfoArgs
    ///                     {
    ///                         BinaryName = "*",
    ///                         ProductName = "*",
    ...
    ///                     Usernames = 
    ///                     {
    ///                         new AzureRM.Security.V20150601Preview.Inputs.UserRecommendationArgs
    ///                         {
    ...
    ///                 },
    ///             },
    ///             ProtectionMode = new AzureRM.Security.V20150601Preview.Inputs.ProtectionModeArgs
    ///             {
    ///                 Exe = "Audit",
    ///                 Msi = "None",
    ///                 Script = "None",
    ...
    ///             VmRecommendations = 
    ///             {
    ///                 new AzureRM.Security.V20150601Preview.Inputs.VmRecommendationArgs
    ///                 {
    ///                     ConfigurationStatus = "Configured",
