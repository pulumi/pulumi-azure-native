...
namespace Pulumi.AzureRM.Security.Inputs
{
    ...
    public sealed class JitNetworkAccessPortRuleResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.PortNumberResponseGetArgs> Number { get; set; } = null!;

        [Input("protocol", required: true)]
        public Input<string> Protocol { get; set; } = null!;

        public JitNetworkAccessPortRuleResponseGetArgs()
        {
        }
    }
}
