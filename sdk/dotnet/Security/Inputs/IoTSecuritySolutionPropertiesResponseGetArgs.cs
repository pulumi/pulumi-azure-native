...
namespace Pulumi.AzureRM.Security.Inputs
{
    ...
    /// </summary>
    public sealed class IoTSecuritySolutionPropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        [Input("autoDiscoveredResources", required: true)]
        private InputList<string>? _autoDiscoveredResources;

        /// <summary>
        /// List of resources that were automatically discovered as relevant to the security solution.
        /// </summary>
        public InputList<string> AutoDiscoveredResources
        {
            get => _autoDiscoveredResources ?? (_autoDiscoveredResources = new InputList<string>());
            set => _autoDiscoveredResources = value;
        }
        ...
        public Input<Inputs.RecommendationConfigurationListResponseGetArgs>? RecommendationsConfiguration { get; set; }
        ...
        public Input<Inputs.UserDefinedResourcesPropertiesResponseGetArgs>? UserDefinedResources { get; set; }
        ...
        public IoTSecuritySolutionPropertiesResponseGetArgs()
        {
        }
    }
}
