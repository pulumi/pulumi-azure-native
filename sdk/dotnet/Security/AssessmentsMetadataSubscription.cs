...
namespace Pulumi.AzureNative.Security
{
    ...
    public partial class AssessmentsMetadataSubscription : global::Pulumi.CustomResource
    {
        ...
        public AssessmentsMetadataSubscription(string name, AssessmentsMetadataSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security:AssessmentsMetadataSubscription", name, args ?? new AssessmentsMetadataSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentsMetadataSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security:AssessmentsMetadataSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:security/v20250504preview:AssessmentsMetadataSubscription" },
