...
namespace Pulumi.AzureNative.Security.V20240101
{
    public static class GetPricing
    {
        ...
        public static Task<GetPricingResult> InvokeAsync(GetPricingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPricingResult>("azure-native:security/v20240101:getPricing", args ?? new GetPricingArgs(), options.WithDefaults());
