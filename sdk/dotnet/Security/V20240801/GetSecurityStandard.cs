...
namespace Pulumi.AzureNative.Security.V20240801
{
    public static class GetSecurityStandard
    {
        ...
        public static Task<GetSecurityStandardResult> InvokeAsync(GetSecurityStandardArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecurityStandardResult>("azure-native:security/v20240801:getSecurityStandard", args ?? new GetSecurityStandardArgs(), options.WithDefaults());

        /// <summary>
        /// Get a specific security standard for the requested scope by standardId
        /// </summary>
        public static Output<GetSecurityStandardResult> Invoke(GetSecurityStandardInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecurityStandardResult>("azure-native:security/v20240801:getSecurityStandard", args ?? new GetSecurityStandardInvokeArgs(), options.WithDefaults());
