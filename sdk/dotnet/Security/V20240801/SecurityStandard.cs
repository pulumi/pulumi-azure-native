...
namespace Pulumi.AzureNative.Security.V20240801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:security/v20240801:SecurityStandard")]
    public partial class SecurityStandard : global::Pulumi.CustomResource
    {
        ...
        public SecurityStandard(string name, SecurityStandardArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20240801:SecurityStandard", name, args ?? new SecurityStandardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityStandard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20240801:SecurityStandard", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:security:SecurityStandard" },
                },
            };
    ...
    public sealed class SecurityStandardArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Security.V20240801.StandardSupportedCloud>>? _cloudProviders;

        /// <summary>
        /// List of all standard supported clouds.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Security.V20240801.StandardSupportedCloud>> CloudProviders
        {
            get => _cloudProviders ?? (_cloudProviders = new InputList<Union<string, Pulumi.AzureNative.Security.V20240801.StandardSupportedCloud>>());
