...
namespace Pulumi.AzureNative.Security.V20240801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:security/v20240801:StandardAssignment")]
    public partial class StandardAssignment : global::Pulumi.CustomResource
    {
        ...
        public StandardAssignment(string name, StandardAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20240801:StandardAssignment", name, args ?? new StandardAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StandardAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20240801:StandardAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:security:StandardAssignment" },
                },
            };
    ...
    public sealed class StandardAssignmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("effect")]
        public InputUnion<string, Pulumi.AzureNative.Security.V20240801.Effect>? Effect { get; set; }
