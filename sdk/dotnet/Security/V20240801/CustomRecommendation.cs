...
namespace Pulumi.AzureNative.Security.V20240801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:security/v20240801:CustomRecommendation")]
    public partial class CustomRecommendation : global::Pulumi.CustomResource
    {
        ...
        public CustomRecommendation(string name, CustomRecommendationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20240801:CustomRecommendation", name, args ?? new CustomRecommendationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomRecommendation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20240801:CustomRecommendation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:security:CustomRecommendation" },
                },
            };
    ...
    public sealed class CustomRecommendationArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.Security.V20240801.RecommendationSupportedClouds>>? _cloudProviders;

        /// <summary>
        /// List of all standard supported clouds.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Security.V20240801.RecommendationSupportedClouds>> CloudProviders
        {
            get => _cloudProviders ?? (_cloudProviders = new InputList<Union<string, Pulumi.AzureNative.Security.V20240801.RecommendationSupportedClouds>>());
        ...
        /// </summary>
        [Input("securityIssue")]
        public InputUnion<string, Pulumi.AzureNative.Security.V20240801.SecurityIssue>? SecurityIssue { get; set; }

        /// <summary>
        /// The severity to relate to the assessments generated by this Recommendation.
        /// </summary>
        [Input("severity")]
        public InputUnion<string, Pulumi.AzureNative.Security.V20240801.SeverityEnum>? Severity { get; set; }
