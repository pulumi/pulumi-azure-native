...
namespace Pulumi.AzureNative.Security.V20231201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:security/v20231201preview:Automation")]
    public partial class Automation : global::Pulumi.CustomResource
    {
        ...
        public Automation(string name, AutomationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20231201preview:Automation", name, args ?? new AutomationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Automation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20231201preview:Automation", name, null, MakeResourceOptions(options, id))
        {
        }
