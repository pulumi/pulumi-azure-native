...
namespace Pulumi.AzureNative.Security.V20200101
{
    ...
    /// {
    ///     var adaptiveApplicationControl = new AzureNative.Security.V20200101.AdaptiveApplicationControl("adaptiveApplicationControl", new()
    ///     {
    ...
    ///         {
    ///             new AzureNative.Security.V20200101.Inputs.PathRecommendationArgs
    ///             {
    ///                 Action = "Recommended",
    ///                 Common = true,
    ...
    ///                 PublisherInfo = new AzureNative.Security.V20200101.Inputs.PublisherInfoArgs
    ///                 {
    ///                     BinaryName = "*",
    ///                     ProductName = "*",
    ...
    ///                 Usernames = new[]
    ///                 {
    ///                     new AzureNative.Security.V20200101.Inputs.UserRecommendationArgs
    ///                     {
    ...
    ///             },
    ///         },
    ///         ProtectionMode = new AzureNative.Security.V20200101.Inputs.ProtectionModeArgs
    ///         {
    ///             Exe = "Audit",
    ///             Msi = "None",
    ///             Script = "None",
    ...
    ///         {
    ///             new AzureNative.Security.V20200101.Inputs.VmRecommendationArgs
    ///             {
    ///                 ConfigurationStatus = "Configured",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:security/v20200101:AdaptiveApplicationControl ERELGROUP1 /subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/providers/Microsoft.Security/locations/centralus/applicationWhitelistings/ERELGROUP1 
    /// ```
    /// </summary>
