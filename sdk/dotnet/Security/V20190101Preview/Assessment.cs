...
namespace Pulumi.AzureNative.Security.V20190101Preview
{
    ...
    public partial class Assessment : global::Pulumi.CustomResource
    {
        ...
        public Assessment(string name, AssessmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20190101preview:Assessment", name, args ?? new AssessmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Assessment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20190101preview:Assessment", name, null, MakeResourceOptions(options, id))
        {
        }
