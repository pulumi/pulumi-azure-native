...
namespace Pulumi.AzureNative.Security
{
    public static class GetScanner
    {
        ...
        public static Task<GetScannerResult> InvokeAsync(GetScannerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScannerResult>("azure-native:security:getScanner", args ?? new GetScannerArgs(), options.WithVersion());
        ...
        public static Output<GetScannerResult> Invoke(GetScannerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScannerResult>("azure-native:security:getScanner", args ?? new GetScannerInvokeArgs(), options.WithVersion());
    }
