...
namespace Pulumi.AzureNative.Security.V20240301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:security/v20240301preview:SecurityConnector")]
    public partial class SecurityConnector : global::Pulumi.CustomResource
    {
        ...
        public SecurityConnector(string name, SecurityConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20240301preview:SecurityConnector", name, args ?? new SecurityConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20240301preview:SecurityConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Security.V20240301Preview.CloudName>? EnvironmentName { get; set; }
