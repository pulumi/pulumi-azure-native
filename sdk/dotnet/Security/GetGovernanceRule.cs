...
namespace Pulumi.AzureNative.Security
{
    public static class GetGovernanceRule
    {
        ...
        public static Task<GetGovernanceRuleResult> InvokeAsync(GetGovernanceRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGovernanceRuleResult>("azure-native:security:getGovernanceRule", args ?? new GetGovernanceRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetGovernanceRuleResult> Invoke(GetGovernanceRuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGovernanceRuleResult>("azure-native:security:getGovernanceRule", args ?? new GetGovernanceRuleInvokeArgs(), options.WithDefaults());
    }
