...
namespace Pulumi.AzureNative.Security.V20231115
{
    public static class GetAPICollectionByAzureApiManagementService
    {
        ...
        public static Task<GetAPICollectionByAzureApiManagementServiceResult> InvokeAsync(GetAPICollectionByAzureApiManagementServiceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAPICollectionByAzureApiManagementServiceResult>("azure-native:security/v20231115:getAPICollectionByAzureApiManagementService", args ?? new GetAPICollectionByAzureApiManagementServiceArgs(), options.WithDefaults());
        ...
        public static Output<GetAPICollectionByAzureApiManagementServiceResult> Invoke(GetAPICollectionByAzureApiManagementServiceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAPICollectionByAzureApiManagementServiceResult>("azure-native:security/v20231115:getAPICollectionByAzureApiManagementService", args ?? new GetAPICollectionByAzureApiManagementServiceInvokeArgs(), options.WithDefaults());
    }
