...
namespace Pulumi.AzureRM.Security.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var connector = new AzureRM.Security.Latest.Connector("connector", new AzureRM.Security.Latest.ConnectorArgs
    ///         {
    ...
    ///             HybridComputeSettings = new AzureRM.Security.Latest.Inputs.HybridComputeSettingsPropertiesArgs
    ///             {
    ///                 AutoProvision = "On",
    ///                 ProxyServer = new AzureRM.Security.Latest.Inputs.ProxyServerPropertiesArgs
    ///                 {
    ///                     Ip = "167.220.197.140",
    ///                     Port = "34",
    ///                 },
    ...
    ///                 ServicePrincipal = new AzureRM.Security.Latest.Inputs.ServicePrincipalPropertiesArgs
    ///                 {
    ...
    public partial class Connector : Pulumi.CustomResource
    {
        ...
        public Connector(string name, ConnectorArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:Connector", name, args ?? new ConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:Connector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:security/v20200101preview:Connector"},
                },
            };
