...
namespace Pulumi.AzureRM.Security.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var workspaceSetting = new AzureRM.Security.Latest.WorkspaceSetting("workspaceSetting", new AzureRM.Security.Latest.WorkspaceSettingArgs
    ///         {
    ...
    public partial class WorkspaceSetting : Pulumi.CustomResource
    {
        ...
        public WorkspaceSetting(string name, WorkspaceSettingArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:WorkspaceSetting", name, args ?? new WorkspaceSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:WorkspaceSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:security/v20170801preview:WorkspaceSetting"},
                },
            };
