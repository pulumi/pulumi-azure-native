...
namespace Pulumi.AzureRM.Security.Latest
{
    public static class GetAlertsSuppressionRule
    {
        public static Task<GetAlertsSuppressionRuleResult> InvokeAsync(GetAlertsSuppressionRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAlertsSuppressionRuleResult>("azurerm:security/latest:getAlertsSuppressionRule", args ?? new GetAlertsSuppressionRuleArgs(), options.WithVersion());
    }
    ...
    public sealed class GetAlertsSuppressionRuleResult
    {
        ...
        /// </summary>
        public readonly Outputs.SuppressionAlertsScopeResponseResult? SuppressionAlertsScope;
        /// <summary>
        /// Resource type
        /// </summary>
        ...
        private GetAlertsSuppressionRuleResult(
            ...
            Outputs.SuppressionAlertsScopeResponseResult? suppressionAlertsScope,
