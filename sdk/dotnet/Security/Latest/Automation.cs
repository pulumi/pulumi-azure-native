...
namespace Pulumi.AzureRM.Security.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var automation = new AzureRM.Security.Latest.Automation("automation", new AzureRM.Security.Latest.AutomationArgs
    ///         {
    ///             Actions = 
    ///             {
    ///                 
    ...
    ///             Scopes = 
    ///             {
    ///                 new AzureRM.Security.Latest.Inputs.AutomationScopeArgs
    ///                 {
    ...
    ///             Sources = 
    ///             {
    ///                 new AzureRM.Security.Latest.Inputs.AutomationSourceArgs
    ///                 {
    ...
    ///                     RuleSets = 
    ///                     {
    ///                         new AzureRM.Security.Latest.Inputs.AutomationRuleSetArgs
    ///                         {
    ///                             Rules = 
    ///                             {
    ///                                 new AzureRM.Security.Latest.Inputs.AutomationTriggeringRuleArgs
    ///                                 {
    ///                                     ExpectedValue = "High",
    ///                                     Operator = "Equals",
    ...
    public partial class Automation : Pulumi.CustomResource
    {
        ...
        public Automation(string name, AutomationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:Automation", name, args ?? new AutomationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Automation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:Automation", name, null, MakeResourceOptions(options, id))
        {
        }
