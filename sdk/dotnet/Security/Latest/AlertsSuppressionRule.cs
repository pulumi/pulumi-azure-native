...
namespace Pulumi.AzureRM.Security.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var alertsSuppressionRule = new AzureRM.Security.Latest.AlertsSuppressionRule("alertsSuppressionRule", new AzureRM.Security.Latest.AlertsSuppressionRuleArgs
    ///         {
    ///             AlertType = "IpAnomaly",
    ...
    ///             State = "Enabled",
    ///             SuppressionAlertsScope = new AzureRM.Security.Latest.Inputs.SuppressionAlertsScopeArgs
    ///             {
    ///                 AllOf = 
    ///                 {
    ///                     new AzureRM.Security.Latest.Inputs.ScopeElementArgs
    ///                     {
    ...
    public partial class AlertsSuppressionRule : Pulumi.CustomResource
    {
        ...
        public AlertsSuppressionRule(string name, AlertsSuppressionRuleArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:AlertsSuppressionRule", name, args ?? new AlertsSuppressionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertsSuppressionRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:AlertsSuppressionRule", name, null, MakeResourceOptions(options, id))
        {
        }
