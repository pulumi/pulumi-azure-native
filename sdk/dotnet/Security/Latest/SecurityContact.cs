...
namespace Pulumi.AzureRM.Security.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var securityContact = new AzureRM.Security.Latest.SecurityContact("securityContact", new AzureRM.Security.Latest.SecurityContactArgs
    ///         {
    ...
    public partial class SecurityContact : Pulumi.CustomResource
    {
        ...
        public SecurityContact(string name, SecurityContactArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:SecurityContact", name, args ?? new SecurityContactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityContact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/latest:SecurityContact", name, null, MakeResourceOptions(options, id))
        {
        }
