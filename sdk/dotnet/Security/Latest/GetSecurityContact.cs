...
namespace Pulumi.AzureRM.Security.Latest
{
    public static class GetSecurityContact
    {
        public static Task<GetSecurityContactResult> InvokeAsync(GetSecurityContactArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecurityContactResult>("azurerm:security/latest:getSecurityContact", args ?? new GetSecurityContactArgs(), options.WithVersion());
    }
