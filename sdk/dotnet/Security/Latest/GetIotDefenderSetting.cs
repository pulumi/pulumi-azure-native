...
namespace Pulumi.AzureRM.Security.Latest
{
    public static class GetIotDefenderSetting
    {
        public static Task<GetIotDefenderSettingResult> InvokeAsync(GetIotDefenderSettingArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIotDefenderSettingResult>("azurerm:security/latest:getIotDefenderSetting", args ?? new GetIotDefenderSettingArgs(), options.WithVersion());
    }
