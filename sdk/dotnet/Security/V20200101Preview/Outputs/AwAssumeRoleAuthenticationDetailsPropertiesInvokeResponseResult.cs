...
namespace Pulumi.AzureNextGen.Security.V20200101Preview.Outputs
{
    ...
    [OutputType]
    public sealed class AwAssumeRoleAuthenticationDetailsPropertiesInvokeResponseResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AwAssumeRoleAuthenticationDetailsPropertiesInvokeResponseResult(
            string accountId,
