...
namespace Pulumi.AzureNative.Security
{
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:security/v20210701preview:CustomAssessmentAutomation"},
    ...
    public sealed class CustomAssessmentAutomationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Security.ImplementationEffortEnum>? ImplementationEffort { get; set; }
        ...
        /// </summary>
        [Input("userImpact")]
        public InputUnion<string, Pulumi.AzureNative.Security.UserImpactEnum>? UserImpact { get; set; }
