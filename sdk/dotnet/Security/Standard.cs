...
namespace Pulumi.AzureNative.Security
{
    ...
    public partial class Standard : Pulumi.CustomResource
    {
        ...
        public Standard(string name, StandardArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security:Standard", name, args ?? new StandardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Standard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security:Standard", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:security/v20210801preview:Standard"},
                },
            };
