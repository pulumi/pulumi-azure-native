...
namespace Pulumi.AzureNative.Security.V20240515Preview
{
    public static class GetDevOpsPolicyAssignment
    {
        ...
        public static Task<GetDevOpsPolicyAssignmentResult> InvokeAsync(GetDevOpsPolicyAssignmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDevOpsPolicyAssignmentResult>("azure-native:security/v20240515preview:getDevOpsPolicyAssignment", args ?? new GetDevOpsPolicyAssignmentArgs(), options.WithDefaults());
