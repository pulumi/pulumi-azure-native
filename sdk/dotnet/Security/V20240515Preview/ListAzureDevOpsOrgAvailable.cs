...
namespace Pulumi.AzureNative.Security.V20240515Preview
{
    public static class ListAzureDevOpsOrgAvailable
    {
        ...
        public static Task<ListAzureDevOpsOrgAvailableResult> InvokeAsync(ListAzureDevOpsOrgAvailableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListAzureDevOpsOrgAvailableResult>("azure-native:security/v20240515preview:listAzureDevOpsOrgAvailable", args ?? new ListAzureDevOpsOrgAvailableArgs(), options.WithDefaults());
