...
namespace Pulumi.AzureNative.Security.V20221120Preview
{
    ...
    public partial class APICollection : global::Pulumi.CustomResource
    {
        ...
        public APICollection(string name, APICollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20221120preview:APICollection", name, args ?? new APICollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private APICollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20221120preview:APICollection", name, null, MakeResourceOptions(options, id))
        {
        }
