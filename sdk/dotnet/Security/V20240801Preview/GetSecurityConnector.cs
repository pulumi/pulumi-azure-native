...
namespace Pulumi.AzureNative.Security.V20240801Preview
{
    public static class GetSecurityConnector
    {
        ...
        public static Task<GetSecurityConnectorResult> InvokeAsync(GetSecurityConnectorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecurityConnectorResult>("azure-native:security/v20240801preview:getSecurityConnector", args ?? new GetSecurityConnectorArgs(), options.WithDefaults());
