...
namespace Pulumi.AzureNative.Security.V20210701Preview
{
    ...
    public partial class CustomAssessmentAutomation : Pulumi.CustomResource
    {
        ...
        public CustomAssessmentAutomation(string name, CustomAssessmentAutomationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20210701preview:CustomAssessmentAutomation", name, args ?? new CustomAssessmentAutomationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomAssessmentAutomation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20210701preview:CustomAssessmentAutomation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CustomAssessmentAutomationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Security.V20210701Preview.ImplementationEffortEnum>? ImplementationEffort { get; set; }
        ...
        /// </summary>
        [Input("severity")]
        public InputUnion<string, Pulumi.AzureNative.Security.V20210701Preview.SeverityEnum>? Severity { get; set; }

        /// <summary>
        /// Relevant cloud for the custom assessment automation.
        /// </summary>
        [Input("supportedCloud")]
        public InputUnion<string, Pulumi.AzureNative.Security.V20210701Preview.SupportedCloudEnum>? SupportedCloud { get; set; }

        /// <summary>
        /// The user impact to relate to the assessments generated by this assessment automation.
        /// </summary>
        [Input("userImpact")]
        public InputUnion<string, Pulumi.AzureNative.Security.V20210701Preview.UserImpactEnum>? UserImpact { get; set; }
