...
namespace Pulumi.AzureNative.Security.V20210701Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct ImplementationEffortEnum : IEquatable<ImplementationEffortEnum>
    {
        private readonly string _value;

        private ImplementationEffortEnum(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static ImplementationEffortEnum High { get; } = new ImplementationEffortEnum("High");
        public static ImplementationEffortEnum Moderate { get; } = new ImplementationEffortEnum("Moderate");
        public static ImplementationEffortEnum Low { get; } = new ImplementationEffortEnum("Low");

        public static bool operator ==(ImplementationEffortEnum left, ImplementationEffortEnum right) => left.Equals(right);
        public static bool operator !=(ImplementationEffortEnum left, ImplementationEffortEnum right) => !left.Equals(right);

        public static explicit operator string(ImplementationEffortEnum value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ImplementationEffortEnum other && Equals(other);
        public bool Equals(ImplementationEffortEnum other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct UserImpactEnum : IEquatable<UserImpactEnum>
    {
        private readonly string _value;

        private UserImpactEnum(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static UserImpactEnum High { get; } = new UserImpactEnum("High");
        public static UserImpactEnum Moderate { get; } = new UserImpactEnum("Moderate");
        public static UserImpactEnum Low { get; } = new UserImpactEnum("Low");

        public static bool operator ==(UserImpactEnum left, UserImpactEnum right) => left.Equals(right);
        public static bool operator !=(UserImpactEnum left, UserImpactEnum right) => !left.Equals(right);

        public static explicit operator string(UserImpactEnum value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is UserImpactEnum other && Equals(other);
        public bool Equals(UserImpactEnum other) => string.Equals(_value, other._value, StringComparison.Ordinal);
