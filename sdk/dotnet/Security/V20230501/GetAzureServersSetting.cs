...
namespace Pulumi.AzureNative.Security.V20230501
{
    public static class GetAzureServersSetting
    {
        ...
        public static Task<GetAzureServersSettingResult> InvokeAsync(GetAzureServersSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAzureServersSettingResult>("azure-native:security/v20230501:getAzureServersSetting", args ?? new GetAzureServersSettingArgs(), options.WithDefaults());
        ...
        public static Output<GetAzureServersSettingResult> Invoke(GetAzureServersSettingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAzureServersSettingResult>("azure-native:security/v20230501:getAzureServersSetting", args ?? new GetAzureServersSettingInvokeArgs(), options.WithDefaults());
    }
