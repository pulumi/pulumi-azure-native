...
namespace Pulumi.AzureNative.Security
{
    ...
    public partial class IngestionSetting : global::Pulumi.CustomResource
    {
        ...
        public IngestionSetting(string name, IngestionSettingArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:security:IngestionSetting", name, args ?? new IngestionSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IngestionSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security:IngestionSetting", name, null, MakeResourceOptions(options, id))
        {
        }
