...
namespace Pulumi.AzureNextGen.Security.V20170801Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct AlertNotifications : IEquatable<AlertNotifications>
    {
        private readonly string _value;

        private AlertNotifications(string value)
        {
        ...
        /// </summary>
        public static AlertNotifications On { get; } = new AlertNotifications("On");
        /// <summary>
        /// Don't get notifications on new alerts
        /// </summary>
        public static AlertNotifications Off { get; } = new AlertNotifications("Off");

        public static bool operator ==(AlertNotifications left, AlertNotifications right) => left.Equals(right);
        public static bool operator !=(AlertNotifications left, AlertNotifications right) => !left.Equals(right);

        public static explicit operator string(AlertNotifications value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is AlertNotifications other && Equals(other);
        public bool Equals(AlertNotifications other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct AlertsToAdmins : IEquatable<AlertsToAdmins>
    {
        private readonly string _value;

        private AlertsToAdmins(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static AlertsToAdmins On { get; } = new AlertsToAdmins("On");
        /// <summary>
        /// Don't send notification on new alerts to the subscription's admins
        /// </summary>
        public static AlertsToAdmins Off { get; } = new AlertsToAdmins("Off");

        public static bool operator ==(AlertsToAdmins left, AlertsToAdmins right) => left.Equals(right);
        public static bool operator !=(AlertsToAdmins left, AlertsToAdmins right) => !left.Equals(right);

        public static explicit operator string(AlertsToAdmins value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is AlertsToAdmins other && Equals(other);
        public bool Equals(AlertsToAdmins other) => string.Equals(_value, other._value, StringComparison.Ordinal);
