...
namespace Pulumi.AzureNative.Security.V20170801Preview
{
    ...
    public partial class AdvancedThreatProtection : Pulumi.CustomResource
    {
        ...
        public AdvancedThreatProtection(string name, AdvancedThreatProtectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20170801preview:AdvancedThreatProtection", name, args ?? new AdvancedThreatProtectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AdvancedThreatProtection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20170801preview:AdvancedThreatProtection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:security:AdvancedThreatProtection"},
