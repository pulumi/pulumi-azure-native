...
namespace Pulumi.AzureRM.Security.V20170801Preview
{
    ...
    public partial class SecurityContact : Pulumi.CustomResource
    {
        ...
        public SecurityContact(string name, SecurityContactArgs args, CustomResourceOptions? options = null)
            : base("azurerm:security/v20170801preview:SecurityContact", name, args ?? new SecurityContactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityContact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:security/v20170801preview:SecurityContact", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:security/latest:SecurityContact"},
