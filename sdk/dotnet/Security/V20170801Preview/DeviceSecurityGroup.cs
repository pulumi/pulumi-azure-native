...
namespace Pulumi.AzureRM.Security.V20170801Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var deviceSecurityGroup = new AzureRM.Security.V20170801Preview.DeviceSecurityGroup("deviceSecurityGroup", new AzureRM.Security.V20170801Preview.DeviceSecurityGroupArgs
    ///         {
    ...
    ///             TimeWindowRules = 
    ///             {
    ///                 new AzureRM.Security.V20170801Preview.Inputs.TimeWindowCustomAlertRuleArgs
    ///                 {
    ///                     IsEnabled = true,
    ///                     MaxThreshold = 30,
    ///                     MinThreshold = 0,
