...
namespace Pulumi.AzureNative.Security.V20220701Preview
{
    ...
    /// {
    ///     var securityConnectorApplication = new AzureNative.Security.V20220701Preview.SecurityConnectorApplication("securityConnectorApplication", new()
    ///     {
    ...
    public partial class SecurityConnectorApplication : global::Pulumi.CustomResource
    {
        ...
        public SecurityConnectorApplication(string name, SecurityConnectorApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20220701preview:SecurityConnectorApplication", name, args ?? new SecurityConnectorApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityConnectorApplication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20220701preview:SecurityConnectorApplication", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityConnectorApplicationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Security.V20220701Preview.ApplicationSourceResourceType> SourceResourceType { get; set; } = null!;
