...
namespace Pulumi.AzureNative.Security.V20220701Preview
{
    ...
    /// {
    ///     var application = new AzureNative.Security.V20220701Preview.Application("application", new()
    ///     {
    ...
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security/v20220701preview:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security/v20220701preview:Application", name, null, MakeResourceOptions(options, id))
        {
        }
