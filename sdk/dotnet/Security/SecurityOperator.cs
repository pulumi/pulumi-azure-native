...
namespace Pulumi.AzureNative.Security
{
    ...
    public partial class SecurityOperator : global::Pulumi.CustomResource
    {
        ...
        public SecurityOperator(string name, SecurityOperatorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security:SecurityOperator", name, args ?? new SecurityOperatorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecurityOperator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security:SecurityOperator", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_security_v20230101preview:security:SecurityOperator" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SecurityOperator Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SecurityOperator(name, id, options);
        }
    }
    ...
    public sealed class SecurityOperatorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public static new SecurityOperatorArgs Empty => new SecurityOperatorArgs();
    }
}
