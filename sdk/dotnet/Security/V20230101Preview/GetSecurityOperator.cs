...
namespace Pulumi.AzureNative.Security.V20230101Preview
{
    public static class GetSecurityOperator
    {
        ...
        public static Task<GetSecurityOperatorResult> InvokeAsync(GetSecurityOperatorArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecurityOperatorResult>("azure-native:security/v20230101preview:getSecurityOperator", args ?? new GetSecurityOperatorArgs(), options.WithDefaults());
