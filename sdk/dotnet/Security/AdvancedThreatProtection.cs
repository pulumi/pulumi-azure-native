...
namespace Pulumi.AzureNative.Security
{
    ...
    public partial class AdvancedThreatProtection : global::Pulumi.CustomResource
    {
        ...
        public AdvancedThreatProtection(string name, AdvancedThreatProtectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:security:AdvancedThreatProtection", name, args ?? new AdvancedThreatProtectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AdvancedThreatProtection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:security:AdvancedThreatProtection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_security_v20170801preview:security:AdvancedThreatProtection" },
                    new global::Pulumi.Alias { Type = "azure-native_security_v20190101:security:AdvancedThreatProtection" },
                },
            };
