...
namespace Pulumi.AzureNative.VisualStudio.V20171101Preview
{
    ...
    /// {
    ///     var extension = new AzureNative.VisualStudio.V20171101Preview.Extension("extension", new()
    ///     {
    ///         AccountResourceName = "ExampleAccount",
    ///         ExtensionResourceName = "ms.example",
    ///         Location = "Central US",
    ///         Plan = new AzureNative.VisualStudio.V20171101Preview.Inputs.ExtensionResourcePlanArgs
    ///         {
    ///             Name = "ExamplePlan",
    ...
    public partial class Extension : global::Pulumi.CustomResource
    {
        ...
        public Extension(string name, ExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:visualstudio/v20171101preview:Extension", name, args ?? new ExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Extension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:visualstudio/v20171101preview:Extension", name, null, MakeResourceOptions(options, id))
        {
        }
