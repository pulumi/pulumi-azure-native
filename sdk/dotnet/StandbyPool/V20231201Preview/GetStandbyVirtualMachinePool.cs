...
namespace Pulumi.AzureNative.StandbyPool.V20231201Preview
{
    public static class GetStandbyVirtualMachinePool
    {
        ...
        public static Task<GetStandbyVirtualMachinePoolResult> InvokeAsync(GetStandbyVirtualMachinePoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStandbyVirtualMachinePoolResult>("azure-native:standbypool/v20231201preview:getStandbyVirtualMachinePool", args ?? new GetStandbyVirtualMachinePoolArgs(), options.WithDefaults());
