...
namespace Pulumi.AzureNative.StandbyPool.V20240301Preview
{
    public static class GetStandbyContainerGroupPool
    {
        ...
        public static Task<GetStandbyContainerGroupPoolResult> InvokeAsync(GetStandbyContainerGroupPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStandbyContainerGroupPoolResult>("azure-native:standbypool/v20240301preview:getStandbyContainerGroupPool", args ?? new GetStandbyContainerGroupPoolArgs(), options.WithDefaults());
        ...
        public static Output<GetStandbyContainerGroupPoolResult> Invoke(GetStandbyContainerGroupPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStandbyContainerGroupPoolResult>("azure-native:standbypool/v20240301preview:getStandbyContainerGroupPool", args ?? new GetStandbyContainerGroupPoolInvokeArgs(), options.WithDefaults());
