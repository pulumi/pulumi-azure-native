...
namespace Pulumi.AzureNative.StandbyPool.V20240301Preview
{
    public static class GetStandbyVirtualMachinePool
    {
        ...
        public static Task<GetStandbyVirtualMachinePoolResult> InvokeAsync(GetStandbyVirtualMachinePoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStandbyVirtualMachinePoolResult>("azure-native:standbypool/v20240301preview:getStandbyVirtualMachinePool", args ?? new GetStandbyVirtualMachinePoolArgs(), options.WithDefaults());
        ...
        public static Output<GetStandbyVirtualMachinePoolResult> Invoke(GetStandbyVirtualMachinePoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStandbyVirtualMachinePoolResult>("azure-native:standbypool/v20240301preview:getStandbyVirtualMachinePool", args ?? new GetStandbyVirtualMachinePoolInvokeArgs(), options.WithDefaults());
