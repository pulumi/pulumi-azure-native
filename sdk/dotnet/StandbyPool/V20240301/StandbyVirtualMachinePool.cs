...
namespace Pulumi.AzureNative.StandbyPool.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:standbypool/v20240301:StandbyVirtualMachinePool")]
    public partial class StandbyVirtualMachinePool : global::Pulumi.CustomResource
    {
        ...
        public StandbyVirtualMachinePool(string name, StandbyVirtualMachinePoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:standbypool/v20240301:StandbyVirtualMachinePool", name, args ?? new StandbyVirtualMachinePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StandbyVirtualMachinePool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:standbypool/v20240301:StandbyVirtualMachinePool", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StandbyVirtualMachinePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.StandbyPool.V20240301.VirtualMachineState> VirtualMachineState { get; set; } = null!;
