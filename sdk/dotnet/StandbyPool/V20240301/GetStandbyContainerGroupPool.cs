...
namespace Pulumi.AzureNative.StandbyPool.V20240301
{
    public static class GetStandbyContainerGroupPool
    {
        ...
        public static Task<GetStandbyContainerGroupPoolResult> InvokeAsync(GetStandbyContainerGroupPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStandbyContainerGroupPoolResult>("azure-native:standbypool/v20240301:getStandbyContainerGroupPool", args ?? new GetStandbyContainerGroupPoolArgs(), options.WithDefaults());
