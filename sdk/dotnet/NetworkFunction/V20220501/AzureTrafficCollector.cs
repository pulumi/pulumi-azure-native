...
namespace Pulumi.AzureNative.NetworkFunction.V20220501
{
    ...
    public partial class AzureTrafficCollector : Pulumi.CustomResource
    {
        ...
        public AzureTrafficCollector(string name, AzureTrafficCollectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction/v20220501:AzureTrafficCollector", name, args ?? new AzureTrafficCollectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureTrafficCollector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction/v20220501:AzureTrafficCollector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:networkfunction/v20210901preview:AzureTrafficCollector"},
