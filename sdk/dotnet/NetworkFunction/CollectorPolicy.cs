...
namespace Pulumi.AzureNative.NetworkFunction
{
    ...
    public partial class CollectorPolicy : global::Pulumi.CustomResource
    {
        ...
        public CollectorPolicy(string name, CollectorPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction:CollectorPolicy", name, args ?? new CollectorPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CollectorPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction:CollectorPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_networkfunction_v20210901preview:networkfunction:CollectorPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native_networkfunction_v20220501:networkfunction:CollectorPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native_networkfunction_v20220801:networkfunction:CollectorPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native_networkfunction_v20221101:networkfunction:CollectorPolicy" },
                },
            };
