...
namespace Pulumi.AzureNative.NetworkFunction.V20221101
{
    ...
    /// {
    ///     var azureTrafficCollector = new AzureNative.NetworkFunction.V20221101.AzureTrafficCollector("azureTrafficCollector", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:networkfunction/v20221101:AzureTrafficCollector atc /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.NetworkFunction/azureTrafficCollectors/atc 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:networkfunction/v20221101:AzureTrafficCollector")]
    public partial class AzureTrafficCollector : global::Pulumi.CustomResource
    {
        ...
        public AzureTrafficCollector(string name, AzureTrafficCollectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction/v20221101:AzureTrafficCollector", name, args ?? new AzureTrafficCollectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureTrafficCollector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction/v20221101:AzureTrafficCollector", name, null, MakeResourceOptions(options, id))
        {
        }
