...
namespace Pulumi.AzureNative.NetworkFunction.V20221101
{
    /// <summary>
    ...
    public partial class CollectorPolicy : global::Pulumi.CustomResource
    {
        ...
        public CollectorPolicy(string name, CollectorPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction/v20221101:CollectorPolicy", name, args ?? new CollectorPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CollectorPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction/v20221101:CollectorPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
