...
namespace Pulumi.AzureNative.NetworkFunction
{
    ...
    public partial class AzureTrafficCollector : global::Pulumi.CustomResource
    {
        ...
        public AzureTrafficCollector(string name, AzureTrafficCollectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction:AzureTrafficCollector", name, args ?? new AzureTrafficCollectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureTrafficCollector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction:AzureTrafficCollector", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_networkfunction_v20210901preview:networkfunction:AzureTrafficCollector" },
                    new global::Pulumi.Alias { Type = "azure-native_networkfunction_v20220501:networkfunction:AzureTrafficCollector" },
                    new global::Pulumi.Alias { Type = "azure-native_networkfunction_v20220801:networkfunction:AzureTrafficCollector" },
                    new global::Pulumi.Alias { Type = "azure-native_networkfunction_v20221101:networkfunction:AzureTrafficCollector" },
                },
            };
