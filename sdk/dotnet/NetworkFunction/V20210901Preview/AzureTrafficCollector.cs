...
namespace Pulumi.AzureNative.NetworkFunction.V20210901Preview
{
    ...
    public partial class AzureTrafficCollector : global::Pulumi.CustomResource
    {
        ...
        public AzureTrafficCollector(string name, AzureTrafficCollectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction/v20210901preview:AzureTrafficCollector", name, args ?? new AzureTrafficCollectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureTrafficCollector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:networkfunction/v20210901preview:AzureTrafficCollector", name, null, MakeResourceOptions(options, id))
        {
        }
