...
namespace Pulumi.AzureNative.SecretSyncController
{
    ...
    public partial class AzureKeyVaultSecretProviderClass : global::Pulumi.CustomResource
    {
        ...
        public AzureKeyVaultSecretProviderClass(string name, AzureKeyVaultSecretProviderClassArgs args, CustomResourceOptions? options = null)
            : base("azure-native:secretsynccontroller:AzureKeyVaultSecretProviderClass", name, args ?? new AzureKeyVaultSecretProviderClassArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureKeyVaultSecretProviderClass(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:secretsynccontroller:AzureKeyVaultSecretProviderClass", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:secretsynccontroller/v20240821preview:AzureKeyVaultSecretProviderClass" },
                    new global::Pulumi.Alias { Type = "azure-native_secretsynccontroller_v20240821preview:secretsynccontroller:AzureKeyVaultSecretProviderClass" },
                },
            };
