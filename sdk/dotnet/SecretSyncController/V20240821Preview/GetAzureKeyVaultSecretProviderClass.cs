...
namespace Pulumi.AzureNative.SecretSyncController.V20240821Preview
{
    public static class GetAzureKeyVaultSecretProviderClass
    {
        ...
        public static Task<GetAzureKeyVaultSecretProviderClassResult> InvokeAsync(GetAzureKeyVaultSecretProviderClassArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAzureKeyVaultSecretProviderClassResult>("azure-native:secretsynccontroller/v20240821preview:getAzureKeyVaultSecretProviderClass", args ?? new GetAzureKeyVaultSecretProviderClassArgs(), options.WithDefaults());
        ...
        public static Output<GetAzureKeyVaultSecretProviderClassResult> Invoke(GetAzureKeyVaultSecretProviderClassInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAzureKeyVaultSecretProviderClassResult>("azure-native:secretsynccontroller/v20240821preview:getAzureKeyVaultSecretProviderClass", args ?? new GetAzureKeyVaultSecretProviderClassInvokeArgs(), options.WithDefaults());
