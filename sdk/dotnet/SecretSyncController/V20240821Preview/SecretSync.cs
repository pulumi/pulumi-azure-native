...
namespace Pulumi.AzureNative.SecretSyncController.V20240821Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:secretsynccontroller/v20240821preview:SecretSync")]
    public partial class SecretSync : global::Pulumi.CustomResource
    {
        ...
        public SecretSync(string name, SecretSyncArgs args, CustomResourceOptions? options = null)
            : base("azure-native:secretsynccontroller/v20240821preview:SecretSync", name, args ?? new SecretSyncArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretSync(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:secretsynccontroller/v20240821preview:SecretSync", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:secretsynccontroller:SecretSync" },
                },
            };
    ...
    public sealed class SecretSyncArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecretSyncController.V20240821Preview.KubernetesSecretType> KubernetesSecretType { get; set; } = null!;
