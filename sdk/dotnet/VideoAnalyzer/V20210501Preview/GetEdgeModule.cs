...
namespace Pulumi.AzureNative.VideoAnalyzer.V20210501Preview
{
    public static class GetEdgeModule
    {
        ...
        public static Task<GetEdgeModuleResult> InvokeAsync(GetEdgeModuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEdgeModuleResult>("azure-native:videoanalyzer/v20210501preview:getEdgeModule", args ?? new GetEdgeModuleArgs(), options.WithVersion());

        /// <summary>
        /// The representation of an edge module.
        /// </summary>
        public static Output<GetEdgeModuleResult> Invoke(GetEdgeModuleInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEdgeModuleResult>("azure-native:videoanalyzer/v20210501preview:getEdgeModule", args ?? new GetEdgeModuleInvokeArgs(), options.WithVersion());
    }
