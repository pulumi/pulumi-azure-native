...
namespace Pulumi.AzureNative.VideoAnalyzer.V20210501Preview
{
    public static class ListEdgeModuleProvisioningToken
    {
        ...
        public static Task<ListEdgeModuleProvisioningTokenResult> InvokeAsync(ListEdgeModuleProvisioningTokenArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListEdgeModuleProvisioningTokenResult>("azure-native:videoanalyzer/v20210501preview:listEdgeModuleProvisioningToken", args ?? new ListEdgeModuleProvisioningTokenArgs(), options.WithVersion());
        ...
        public static Output<ListEdgeModuleProvisioningTokenResult> Invoke(ListEdgeModuleProvisioningTokenInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListEdgeModuleProvisioningTokenResult>("azure-native:videoanalyzer/v20210501preview:listEdgeModuleProvisioningToken", args ?? new ListEdgeModuleProvisioningTokenInvokeArgs(), options.WithVersion());
    }
