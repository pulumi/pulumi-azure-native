...
namespace Pulumi.AzureNative.VideoAnalyzer.V20211101Preview
{
    ...
    public partial class PipelineJob : global::Pulumi.CustomResource
    {
        ...
        public PipelineJob(string name, PipelineJobArgs args, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer/v20211101preview:PipelineJob", name, args ?? new PipelineJobArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PipelineJob(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer/v20211101preview:PipelineJob", name, null, MakeResourceOptions(options, id))
        {
        }
