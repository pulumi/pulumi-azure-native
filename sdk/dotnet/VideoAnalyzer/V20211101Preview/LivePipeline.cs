...
namespace Pulumi.AzureNative.VideoAnalyzer.V20211101Preview
{
    ...
    public partial class LivePipeline : global::Pulumi.CustomResource
    {
        ...
        public LivePipeline(string name, LivePipelineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer/v20211101preview:LivePipeline", name, args ?? new LivePipelineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LivePipeline(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer/v20211101preview:LivePipeline", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:videoanalyzer:LivePipeline"},
                },
            };
