...
namespace Pulumi.AzureNative.VideoAnalyzer.V20211101Preview
{
    ...
    public partial class AccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AccessPolicy(string name, AccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer/v20211101preview:AccessPolicy", name, args ?? new AccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer/v20211101preview:AccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AccessPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("role")]
        public InputUnion<string, Pulumi.AzureNative.VideoAnalyzer.V20211101Preview.AccessPolicyRole>? Role { get; set; }
