...
namespace Pulumi.AzureNative.VideoAnalyzer.V20211101Preview
{
    public static class GetVideo
    {
        ...
        public static Task<GetVideoResult> InvokeAsync(GetVideoArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVideoResult>("azure-native:videoanalyzer/v20211101preview:getVideo", args ?? new GetVideoArgs(), options.WithDefaults());
