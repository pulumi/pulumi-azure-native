...
namespace Pulumi.AzureNative.VideoAnalyzer.V20211101Preview
{
    ...
    /// {
    ///     var edgeModule = new AzureNative.VideoAnalyzer.V20211101Preview.EdgeModule("edgeModule", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:videoanalyzer/v20211101preview:EdgeModule edgeModule1 /subscriptions/591e76c3-3e97-44db-879c-3e2b12961b62/resourceGroups/testrg/providers/Microsoft.Media/videoAnalyzers/testaccount2/edgeModules/edgeModule1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:videoanalyzer/v20211101preview:EdgeModule")]
    public partial class EdgeModule : global::Pulumi.CustomResource
    {
        ...
        public EdgeModule(string name, EdgeModuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer/v20211101preview:EdgeModule", name, args ?? new EdgeModuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EdgeModule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer/v20211101preview:EdgeModule", name, null, MakeResourceOptions(options, id))
        {
        }
