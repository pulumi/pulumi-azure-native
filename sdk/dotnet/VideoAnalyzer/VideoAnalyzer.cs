...
namespace Pulumi.AzureNative.VideoAnalyzer
{
    ...
    public partial class VideoAnalyzer : Pulumi.CustomResource
    {
        ...
        public VideoAnalyzer(string name, VideoAnalyzerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer:VideoAnalyzer", name, args ?? new VideoAnalyzerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VideoAnalyzer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:videoanalyzer:VideoAnalyzer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:videoanalyzer:VideoAnalyzer"},
                    new Pulumi.Alias { Type = "azure-native:videoanalyzer/v20210501preview:VideoAnalyzer"},
                    new Pulumi.Alias { Type = "azure-nextgen:videoanalyzer/v20210501preview:VideoAnalyzer"},
                    new Pulumi.Alias { Type = "azure-native:videoanalyzer/v20211101preview:VideoAnalyzer"},
                    new Pulumi.Alias { Type = "azure-nextgen:videoanalyzer/v20211101preview:VideoAnalyzer"},
                },
            };
