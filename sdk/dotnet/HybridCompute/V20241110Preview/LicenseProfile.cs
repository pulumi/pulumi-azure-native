...
namespace Pulumi.AzureNative.HybridCompute.V20241110Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20241110preview:LicenseProfile")]
    public partial class LicenseProfile : global::Pulumi.CustomResource
    {
        ...
        public LicenseProfile(string name, LicenseProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20241110preview:LicenseProfile", name, args ?? new LicenseProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LicenseProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20241110preview:LicenseProfile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LicenseProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("productType")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20241110Preview.LicenseProfileProductType>? ProductType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20241110Preview.LicenseProfileSubscriptionStatus>? SubscriptionStatus { get; set; }
