...
namespace Pulumi.AzureNative.HybridCompute.V20241110Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20241110preview:Gateway")]
    public partial class Gateway : global::Pulumi.CustomResource
    {
        ...
        public Gateway(string name, GatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20241110preview:Gateway", name, args ?? new GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20241110preview:Gateway", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:hybridcompute/v20250113:Gateway" },
    ...
    public sealed class GatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20241110Preview.GatewayType>? GatewayType { get; set; }
