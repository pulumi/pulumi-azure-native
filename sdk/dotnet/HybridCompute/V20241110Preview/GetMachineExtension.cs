...
namespace Pulumi.AzureNative.HybridCompute.V20241110Preview
{
    public static class GetMachineExtension
    {
        ...
        public static Task<GetMachineExtensionResult> InvokeAsync(GetMachineExtensionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMachineExtensionResult>("azure-native:hybridcompute/v20241110preview:getMachineExtension", args ?? new GetMachineExtensionArgs(), options.WithDefaults());

        /// <summary>
        /// The operation to get the extension.
        /// </summary>
        public static Output<GetMachineExtensionResult> Invoke(GetMachineExtensionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMachineExtensionResult>("azure-native:hybridcompute/v20241110preview:getMachineExtension", args ?? new GetMachineExtensionInvokeArgs(), options.WithDefaults());
    }
