...
namespace Pulumi.AzureNative.HybridCompute.V20240710
{
    public static class GetLicense
    {
        ...
        public static Task<GetLicenseResult> InvokeAsync(GetLicenseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLicenseResult>("azure-native:hybridcompute/v20240710:getLicense", args ?? new GetLicenseArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves information about the view of a license.
        /// </summary>
        public static Output<GetLicenseResult> Invoke(GetLicenseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLicenseResult>("azure-native:hybridcompute/v20240710:getLicense", args ?? new GetLicenseInvokeArgs(), options.WithDefaults());
    }
