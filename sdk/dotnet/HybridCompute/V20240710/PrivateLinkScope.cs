...
namespace Pulumi.AzureNative.HybridCompute.V20240710
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20240710:PrivateLinkScope")]
    public partial class PrivateLinkScope : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScope(string name, PrivateLinkScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240710:PrivateLinkScope", name, args ?? new PrivateLinkScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240710:PrivateLinkScope", name, null, MakeResourceOptions(options, id))
        {
        }
