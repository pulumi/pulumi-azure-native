...
namespace Pulumi.AzureNative.HybridCompute.V20240710
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20240710:MachineExtension")]
    public partial class MachineExtension : global::Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240710:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240710:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
