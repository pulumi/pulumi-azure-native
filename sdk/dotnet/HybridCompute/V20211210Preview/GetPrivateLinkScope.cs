...
namespace Pulumi.AzureNative.HybridCompute.V20211210Preview
{
    public static class GetPrivateLinkScope
    {
        ...
        public static Task<GetPrivateLinkScopeResult> InvokeAsync(GetPrivateLinkScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkScopeResult>("azure-native:hybridcompute/v20211210preview:getPrivateLinkScope", args ?? new GetPrivateLinkScopeArgs(), options.WithVersion());

        /// <summary>
        /// An Azure Arc PrivateLinkScope definition.
        /// </summary>
        public static Output<GetPrivateLinkScopeResult> Invoke(GetPrivateLinkScopeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrivateLinkScopeResult>("azure-native:hybridcompute/v20211210preview:getPrivateLinkScope", args ?? new GetPrivateLinkScopeInvokeArgs(), options.WithVersion());
    }
