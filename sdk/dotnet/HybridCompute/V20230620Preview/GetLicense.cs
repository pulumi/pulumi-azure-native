...
namespace Pulumi.AzureNative.HybridCompute.V20230620Preview
{
    public static class GetLicense
    {
        ...
        public static Task<GetLicenseResult> InvokeAsync(GetLicenseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLicenseResult>("azure-native:hybridcompute/v20230620preview:getLicense", args ?? new GetLicenseArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves information about the view of a license.
        /// </summary>
        public static Output<GetLicenseResult> Invoke(GetLicenseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLicenseResult>("azure-native:hybridcompute/v20230620preview:getLicense", args ?? new GetLicenseInvokeArgs(), options.WithDefaults());
    }
