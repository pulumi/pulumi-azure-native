...
namespace Pulumi.AzureNextGen.HybridCompute
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:hybridcompute:MachineExtension")]
    public partial class MachineExtension : Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybridcompute:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybridcompute:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
