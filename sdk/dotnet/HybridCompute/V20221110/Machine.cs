...
namespace Pulumi.AzureNative.HybridCompute.V20221110
{
    ...
    [AzureNativeResourceType("azure-native:hybridcompute/v20221110:Machine")]
    public partial class Machine : global::Pulumi.CustomResource
    {
        ...
        public Machine(string name, MachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20221110:Machine", name, args ?? new MachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Machine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20221110:Machine", name, null, MakeResourceOptions(options, id))
        {
        }
