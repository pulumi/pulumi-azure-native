...
namespace Pulumi.AzureRM.HybridCompute.V20190318Preview
{
    ...
    public partial class Machine : Pulumi.CustomResource
    {
        ...
        public Machine(string name, MachineArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/v20190318preview:Machine", name, args ?? new MachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Machine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/v20190318preview:Machine", name, null, MakeResourceOptions(options, id))
        {
        }
