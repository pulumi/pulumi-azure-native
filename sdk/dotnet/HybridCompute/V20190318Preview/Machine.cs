...
namespace Pulumi.AzureNative.HybridCompute.V20190318Preview
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:hybridcompute/v20190318preview:Machine myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/machines/{name} 
    /// ```
    /// </summary>
    ...
    public partial class Machine : global::Pulumi.CustomResource
    {
        ...
        public Machine(string name, MachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20190318preview:Machine", name, args ?? new MachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Machine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20190318preview:Machine", name, null, MakeResourceOptions(options, id))
        {
        }
