...
namespace Pulumi.AzureNative.HybridCompute.V20240910Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20240910preview:License")]
    public partial class License : global::Pulumi.CustomResource
    {
        ...
        public License(string name, LicenseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240910preview:License", name, args ?? new LicenseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private License(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240910preview:License", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LicenseArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20240910Preview.LicenseType>? LicenseType { get; set; }
