...
namespace Pulumi.AzureNative.HybridCompute.V20221227Preview
{
    ...
    /// {
    ///     var machineExtension = new AzureNative.HybridCompute.V20221227Preview.MachineExtension("machineExtension", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20221227preview:MachineExtension")]
    public partial class MachineExtension : global::Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20221227preview:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20221227preview:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
