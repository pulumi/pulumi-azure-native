...
namespace Pulumi.AzureNative.HybridCompute.V20221227Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:hybridcompute/v20221227preview:Machine is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20230425preview:Machine to guarantee forwards compatibility.")]
    ...
    public partial class Machine : global::Pulumi.CustomResource
    {
        ...
        public Machine(string name, MachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20221227preview:Machine", name, args ?? new MachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Machine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20221227preview:Machine", name, null, MakeResourceOptions(options, id))
        {
        }
