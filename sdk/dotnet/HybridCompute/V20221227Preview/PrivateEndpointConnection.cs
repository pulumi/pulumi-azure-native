...
namespace Pulumi.AzureNative.HybridCompute.V20221227Preview
{
    /// <summary>
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.HybridCompute.V20221227Preview.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "private-endpoint-connection-name",
    ///         Properties = new AzureNative.HybridCompute.V20221227Preview.Inputs.PrivateEndpointConnectionPropertiesArgs
    ///         {
    ///             PrivateLinkServiceConnectionState = new AzureNative.HybridCompute.V20221227Preview.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:hybridcompute/v20221227preview:PrivateEndpointConnection private-endpoint-connection-name /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/myResourceGroup/providers/Microsoft.HybridCompute/privateLinkScopes/myPrivateLinkScope/privateEndpointConnections/private-endpoint-connection-name 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20221227preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20221227preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20221227preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
