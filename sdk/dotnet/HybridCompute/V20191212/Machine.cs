...
namespace Pulumi.AzureNative.HybridCompute.V20191212
{
    ...
    [AzureNativeResourceType("azure-native:hybridcompute/v20191212:Machine")]
    public partial class Machine : Pulumi.CustomResource
    {
        ...
        public Machine(string name, MachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20191212:Machine", name, args ?? new MachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Machine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20191212:Machine", name, null, MakeResourceOptions(options, id))
        {
        }
