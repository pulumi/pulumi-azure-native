...
namespace Pulumi.AzureNative.HybridCompute.V20240331Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20240331preview:MachineRunCommand")]
    public partial class MachineRunCommand : global::Pulumi.CustomResource
    {
        ...
        public MachineRunCommand(string name, MachineRunCommandArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240331preview:MachineRunCommand", name, args ?? new MachineRunCommandArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineRunCommand(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240331preview:MachineRunCommand", name, null, MakeResourceOptions(options, id))
        {
        }
