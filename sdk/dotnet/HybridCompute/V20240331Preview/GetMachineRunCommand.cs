...
namespace Pulumi.AzureNative.HybridCompute.V20240331Preview
{
    public static class GetMachineRunCommand
    {
        ...
        public static Task<GetMachineRunCommandResult> InvokeAsync(GetMachineRunCommandArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMachineRunCommandResult>("azure-native:hybridcompute/v20240331preview:getMachineRunCommand", args ?? new GetMachineRunCommandArgs(), options.WithDefaults());
