...
namespace Pulumi.AzureNative.HybridCompute.V20240331Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20240331preview:LicenseProfile")]
    public partial class LicenseProfile : global::Pulumi.CustomResource
    {
        ...
        public LicenseProfile(string name, LicenseProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240331preview:LicenseProfile", name, args ?? new LicenseProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LicenseProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240331preview:LicenseProfile", name, null, MakeResourceOptions(options, id))
        {
        }
