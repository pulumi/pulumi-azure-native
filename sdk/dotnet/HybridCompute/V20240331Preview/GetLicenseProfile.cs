...
namespace Pulumi.AzureNative.HybridCompute.V20240331Preview
{
    public static class GetLicenseProfile
    {
        ...
        public static Task<GetLicenseProfileResult> InvokeAsync(GetLicenseProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLicenseProfileResult>("azure-native:hybridcompute/v20240331preview:getLicenseProfile", args ?? new GetLicenseProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves information about the view of a license profile.
        /// </summary>
        public static Output<GetLicenseProfileResult> Invoke(GetLicenseProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLicenseProfileResult>("azure-native:hybridcompute/v20240331preview:getLicenseProfile", args ?? new GetLicenseProfileInvokeArgs(), options.WithDefaults());
    }
