...
namespace Pulumi.AzureNative.HybridCompute.V20240331Preview.Inputs
{
    ...
    public sealed class LicenseDetailsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("edition")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20240331Preview.LicenseEdition>? Edition { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20240331Preview.LicenseState>? State { get; set; }

        /// <summary>
        /// Describes the license target server.
        /// </summary>
        [Input("target")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20240331Preview.LicenseTarget>? Target { get; set; }

        /// <summary>
        /// Describes the license core type (pCore or vCore).
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20240331Preview.LicenseCoreType>? Type { get; set; }
