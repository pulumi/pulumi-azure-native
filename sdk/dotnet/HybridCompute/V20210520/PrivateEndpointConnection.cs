...
namespace Pulumi.AzureNative.HybridCompute.V20210520
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:hybridcompute/v20210520:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20221227preview:PrivateEndpointConnection to guarantee forwards compatibility.")]
    ...
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20210520:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20210520:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
