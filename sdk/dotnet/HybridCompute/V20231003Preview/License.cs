...
namespace Pulumi.AzureNative.HybridCompute.V20231003Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20231003preview:License")]
    public partial class License : global::Pulumi.CustomResource
    {
        ...
        public License(string name, LicenseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20231003preview:License", name, args ?? new LicenseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private License(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20231003preview:License", name, null, MakeResourceOptions(options, id))
        {
        }
