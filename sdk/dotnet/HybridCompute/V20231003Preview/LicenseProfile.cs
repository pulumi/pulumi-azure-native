...
namespace Pulumi.AzureNative.HybridCompute.V20231003Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20231003preview:LicenseProfile")]
    public partial class LicenseProfile : global::Pulumi.CustomResource
    {
        ...
        public LicenseProfile(string name, LicenseProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20231003preview:LicenseProfile", name, args ?? new LicenseProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LicenseProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20231003preview:LicenseProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:hybridcompute/v20240731preview:LicenseProfile" },
                    new global::Pulumi.Alias { Type = "azure-native:hybridcompute/v20240910preview:LicenseProfile" },
                    new global::Pulumi.Alias { Type = "azure-native:hybridcompute/v20241110preview:LicenseProfile" },
                    new global::Pulumi.Alias { Type = "azure-native:hybridcompute/v20250113:LicenseProfile" },
    ...
    public sealed class LicenseProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("productType")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20231003Preview.LicenseProfileProductType>? ProductType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20231003Preview.LicenseProfileSubscriptionStatus>? SubscriptionStatus { get; set; }
