...
namespace Pulumi.AzureNative.HybridCompute.V20231003Preview
{
    public static class GetMachineRunCommand
    {
        ...
        public static Task<GetMachineRunCommandResult> InvokeAsync(GetMachineRunCommandArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMachineRunCommandResult>("azure-native:hybridcompute/v20231003preview:getMachineRunCommand", args ?? new GetMachineRunCommandArgs(), options.WithDefaults());

        /// <summary>
        /// The operation to get a run command.
        /// </summary>
        public static Output<GetMachineRunCommandResult> Invoke(GetMachineRunCommandInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMachineRunCommandResult>("azure-native:hybridcompute/v20231003preview:getMachineRunCommand", args ?? new GetMachineRunCommandInvokeArgs(), options.WithDefaults());
    }
