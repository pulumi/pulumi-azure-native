...
namespace Pulumi.AzureNative.HybridCompute.V20200815Preview
{
    ...
    /// {
    ///     var machineExtension = new AzureNative.HybridCompute.V20200815Preview.MachineExtension("machineExtension", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20200815preview:MachineExtension")]
    public partial class MachineExtension : global::Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20200815preview:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20200815preview:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
