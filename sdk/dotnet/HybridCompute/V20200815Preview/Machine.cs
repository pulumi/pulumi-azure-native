...
namespace Pulumi.AzureNative.HybridCompute.V20200815Preview
{
    ...
    /// {
    ///     var machine = new AzureNative.HybridCompute.V20200815Preview.Machine("machine", new()
    ///     {
    ///         ClientPublicKey = "string",
    ///         Identity = new AzureNative.HybridCompute.V20200815Preview.Inputs.MachineIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Location = "eastus2euap",
    ///         LocationData = new AzureNative.HybridCompute.V20200815Preview.Inputs.LocationDataArgs
    ///         {
    ///             Name = "Redmond",
    ///         },
    ///         Name = "myMachine",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20200815preview:Machine")]
    public partial class Machine : global::Pulumi.CustomResource
    {
        ...
        public Machine(string name, MachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20200815preview:Machine", name, args ?? new MachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Machine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20200815preview:Machine", name, null, MakeResourceOptions(options, id))
        {
        }
