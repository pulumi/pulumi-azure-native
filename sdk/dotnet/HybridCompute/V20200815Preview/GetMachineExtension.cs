...
namespace Pulumi.AzureNative.HybridCompute.V20200815Preview
{
    public static class GetMachineExtension
    {
        ...
        public static Task<GetMachineExtensionResult> InvokeAsync(GetMachineExtensionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineExtensionResult>("azure-native:hybridcompute/v20200815preview:getMachineExtension", args ?? new GetMachineExtensionArgs(), options.WithVersion());

        /// <summary>
        /// Describes a Machine Extension.
        /// </summary>
        public static Output<GetMachineExtensionResult> Invoke(GetMachineExtensionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMachineExtensionResult>("azure-native:hybridcompute/v20200815preview:getMachineExtension", args ?? new GetMachineExtensionInvokeArgs(), options.WithVersion());
    }
