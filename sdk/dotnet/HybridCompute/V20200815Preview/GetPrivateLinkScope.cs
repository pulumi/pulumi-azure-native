...
namespace Pulumi.AzureRM.HybridCompute.V20200815Preview
{
    public static class GetPrivateLinkScope
    {
        public static Task<GetPrivateLinkScopeResult> InvokeAsync(GetPrivateLinkScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkScopeResult>("azurerm:hybridcompute/v20200815preview:getPrivateLinkScope", args ?? new GetPrivateLinkScopeArgs(), options.WithVersion());
    }
