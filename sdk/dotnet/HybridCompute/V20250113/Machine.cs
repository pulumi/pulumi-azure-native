...
namespace Pulumi.AzureNative.HybridCompute.V20250113
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20250113:Machine")]
    public partial class Machine : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("identityKeyStore")]
        public Output<string?> IdentityKeyStore { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tpmEkCertificate")]
        public Output<string?> TpmEkCertificate { get; private set; } = null!;
        ...
        public Machine(string name, MachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20250113:Machine", name, args ?? new MachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Machine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20250113:Machine", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MachineArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// Specifies the identity key store a machine is using.
        /// </summary>
        [Input("identityKeyStore")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20250113.IdentityKeyStore>? IdentityKeyStore { get; set; }

        /// <summary>
        /// Indicates which kind of Arc machine placement on-premises, such as HCI, SCVMM or VMware etc.
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20250113.ArcKindEnum>? Kind { get; set; }
        ...
        /// Endorsement Key Certificate of the Trusted Platform Module (TPM) that the client provides to be used during initial resource onboarding.
        /// </summary>
        [Input("tpmEkCertificate")]
        public Input<string>? TpmEkCertificate { get; set; }
