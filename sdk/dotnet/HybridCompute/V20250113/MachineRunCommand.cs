...
namespace Pulumi.AzureNative.HybridCompute.V20250113
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20250113:MachineRunCommand")]
    public partial class MachineRunCommand : global::Pulumi.CustomResource
    {
        ...
        public MachineRunCommand(string name, MachineRunCommandArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20250113:MachineRunCommand", name, args ?? new MachineRunCommandArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineRunCommand(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20250113:MachineRunCommand", name, null, MakeResourceOptions(options, id))
        {
        }
