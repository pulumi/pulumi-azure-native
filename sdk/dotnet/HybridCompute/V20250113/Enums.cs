...
namespace Pulumi.AzureNative.HybridCompute.V20250113
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct IdentityKeyStore : IEquatable<IdentityKeyStore>
    {
        private readonly string _value;

        private IdentityKeyStore(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static IdentityKeyStore TPM { get; } = new IdentityKeyStore("TPM");
        public static IdentityKeyStore Default { get; } = new IdentityKeyStore("Default");

        public static bool operator ==(IdentityKeyStore left, IdentityKeyStore right) => left.Equals(right);
        public static bool operator !=(IdentityKeyStore left, IdentityKeyStore right) => !left.Equals(right);

        public static explicit operator string(IdentityKeyStore value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is IdentityKeyStore other && Equals(other);
        public bool Equals(IdentityKeyStore other) => string.Equals(_value, other._value, StringComparison.Ordinal);
