...
namespace Pulumi.AzureNative.HybridCompute.V20250113
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20250113:LicenseProfile")]
    public partial class LicenseProfile : global::Pulumi.CustomResource
    {
        ...
        public LicenseProfile(string name, LicenseProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20250113:LicenseProfile", name, args ?? new LicenseProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LicenseProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20250113:LicenseProfile", name, null, MakeResourceOptions(options, id))
        {
        }
