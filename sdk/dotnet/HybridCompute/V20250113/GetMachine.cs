...
namespace Pulumi.AzureNative.HybridCompute.V20250113
{
    public static class GetMachine
    {
        ...
        public static Task<GetMachineResult> InvokeAsync(GetMachineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMachineResult>("azure-native:hybridcompute/v20250113:getMachine", args ?? new GetMachineArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves information about the model view or the instance view of a hybrid machine.
        /// </summary>
        public static Output<GetMachineResult> Invoke(GetMachineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMachineResult>("azure-native:hybridcompute/v20250113:getMachine", args ?? new GetMachineInvokeArgs(), options.WithDefaults());
    ...
    public sealed class GetMachineResult
    {
        ...
        /// </summary>
        public readonly string? IdentityKeyStore;
        /// <summary>
        ...
        /// </summary>
        public readonly string? TpmEkCertificate;
        /// <summary>
