...
namespace Pulumi.AzureNative.HybridCompute.V20220310
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:hybridcompute/v20220310:MachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20220510preview:MachineExtension to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:hybridcompute/v20220310:MachineExtension")]
    public partial class MachineExtension : global::Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20220310:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20220310:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
