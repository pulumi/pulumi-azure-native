...
namespace Pulumi.AzureNextGen.HybridCompute.V20200730Preview
{
    public static class GetMachine
    {
        public static Task<GetMachineResult> InvokeAsync(GetMachineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineResult>("azure-nextgen:hybridcompute/v20200730preview:getMachine", args ?? new GetMachineArgs(), options.WithVersion());
    }
