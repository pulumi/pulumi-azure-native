...
namespace Pulumi.AzureNative.HybridCompute.V20200730Preview
{
    public static class GetMachine
    {
        ...
        public static Task<GetMachineResult> InvokeAsync(GetMachineArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineResult>("azure-native:hybridcompute/v20200730preview:getMachine", args ?? new GetMachineArgs(), options.WithVersion());

        /// <summary>
        /// Describes a hybrid machine.
        /// </summary>
        public static Output<GetMachineResult> Invoke(GetMachineInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetMachineResult>("azure-native:hybridcompute/v20200730preview:getMachine", args ?? new GetMachineInvokeArgs(), options.WithVersion());
    }
