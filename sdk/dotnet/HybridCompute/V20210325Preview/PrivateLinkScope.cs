...
namespace Pulumi.AzureNative.HybridCompute.V20210325Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:hybridcompute/v20210325preview:PrivateLinkScope is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20230425preview:PrivateLinkScope to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:hybridcompute/v20210325preview:PrivateLinkScope")]
    public partial class PrivateLinkScope : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScope(string name, PrivateLinkScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20210325preview:PrivateLinkScope", name, args ?? new PrivateLinkScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20210325preview:PrivateLinkScope", name, null, MakeResourceOptions(options, id))
        {
        }
