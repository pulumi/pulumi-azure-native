...
namespace Pulumi.AzureRM.HybridCompute.V20200802
{
    public static class GetMachineExtension
    {
        public static Task<GetMachineExtensionResult> InvokeAsync(GetMachineExtensionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineExtensionResult>("azurerm:hybridcompute/v20200802:getMachineExtension", args ?? new GetMachineExtensionArgs(), options.WithVersion());
    }
