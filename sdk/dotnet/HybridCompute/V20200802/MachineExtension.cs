...
namespace Pulumi.AzureRM.HybridCompute.V20200802
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineExtension = new AzureRM.HybridCompute.V20200802.MachineExtension("machineExtension", new AzureRM.HybridCompute.V20200802.MachineExtensionArgs
    ///         {
    ...
    public partial class MachineExtension : Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/v20200802:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/v20200802:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
