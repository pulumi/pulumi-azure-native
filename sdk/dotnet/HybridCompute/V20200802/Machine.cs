...
namespace Pulumi.AzureNextGen.HybridCompute.V20200802
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:hybridcompute/v20200802:Machine")]
    public partial class Machine : Pulumi.CustomResource
    {
        ...
        public Machine(string name, MachineArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybridcompute/v20200802:Machine", name, args ?? new MachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Machine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:hybridcompute/v20200802:Machine", name, null, MakeResourceOptions(options, id))
        {
        }
