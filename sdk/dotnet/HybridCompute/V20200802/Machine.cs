...
namespace Pulumi.AzureNative.HybridCompute.V20200802
{
    /// <summary>
    ...
    /// {
    ///     var machine = new AzureNative.HybridCompute.V20200802.Machine("machine", new()
    ///     {
    ///         ClientPublicKey = "string",
    ///         Identity = new AzureNative.HybridCompute.V20200802.Inputs.MachineIdentityArgs
    ///         {
    ///             Type = "SystemAssigned",
    ///         },
    ///         Location = "eastus2euap",
    ///         LocationData = new AzureNative.HybridCompute.V20200802.Inputs.LocationDataArgs
    ///         {
    ///             Name = "Redmond",
    ///         },
    ///         Name = "myMachine",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:hybridcompute/v20200802:Machine myMachine /subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.HybridCompute/machines/myMachine 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20200802:Machine")]
    public partial class Machine : global::Pulumi.CustomResource
    {
        ...
        public Machine(string name, MachineArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20200802:Machine", name, args ?? new MachineArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Machine(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20200802:Machine", name, null, MakeResourceOptions(options, id))
        {
        }
