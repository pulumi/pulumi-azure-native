...
namespace Pulumi.AzureNative.HybridCompute.V20200802
{
    public static class GetMachine
    {
        ...
        public static Task<GetMachineResult> InvokeAsync(GetMachineArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMachineResult>("azure-native:hybridcompute/v20200802:getMachine", args ?? new GetMachineArgs(), options.WithDefaults());

        /// <summary>
        /// Describes a hybrid machine.
        /// </summary>
        public static Output<GetMachineResult> Invoke(GetMachineInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMachineResult>("azure-native:hybridcompute/v20200802:getMachine", args ?? new GetMachineInvokeArgs(), options.WithDefaults());
    }
