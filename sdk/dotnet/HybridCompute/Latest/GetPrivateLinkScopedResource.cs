...
namespace Pulumi.AzureRM.HybridCompute.Latest
{
    public static class GetPrivateLinkScopedResource
    {
        public static Task<GetPrivateLinkScopedResourceResult> InvokeAsync(GetPrivateLinkScopedResourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkScopedResourceResult>("azurerm:hybridcompute/latest:getPrivateLinkScopedResource", args ?? new GetPrivateLinkScopedResourceArgs(), options.WithVersion());
    }
