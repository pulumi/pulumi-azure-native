...
namespace Pulumi.AzureRM.HybridCompute.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var machineExtension = new AzureRM.HybridCompute.Latest.MachineExtension("machineExtension", new AzureRM.HybridCompute.Latest.MachineExtensionArgs
    ///         {
    ...
    public partial class MachineExtension : Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/latest:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/latest:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
