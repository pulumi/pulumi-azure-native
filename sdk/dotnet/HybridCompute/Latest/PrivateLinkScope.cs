...
namespace Pulumi.AzureRM.HybridCompute.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateLinkScope = new AzureRM.HybridCompute.Latest.PrivateLinkScope("privateLinkScope", new AzureRM.HybridCompute.Latest.PrivateLinkScopeArgs
    ///         {
    ///             Location = "westus",
    ...
    public partial class PrivateLinkScope : Pulumi.CustomResource
    {
        ...
        public PrivateLinkScope(string name, PrivateLinkScopeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/latest:PrivateLinkScope", name, args ?? new PrivateLinkScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/latest:PrivateLinkScope", name, null, MakeResourceOptions(options, id))
        {
        }
