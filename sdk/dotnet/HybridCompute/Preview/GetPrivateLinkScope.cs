...
namespace Pulumi.AzureRM.HybridCompute.Preview
{
    public static class GetPrivateLinkScope
    {
        public static Task<GetPrivateLinkScopeResult> InvokeAsync(GetPrivateLinkScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateLinkScopeResult>("azurerm:hybridcompute/preview:getPrivateLinkScope", args ?? new GetPrivateLinkScopeArgs(), options.WithVersion());
    }
