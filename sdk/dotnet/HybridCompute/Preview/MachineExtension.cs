...
namespace Pulumi.AzureRM.HybridCompute.Preview
{
    ...
    public partial class MachineExtension : Pulumi.CustomResource
    {
        ...
        public MachineExtension(string name, MachineExtensionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/preview:MachineExtension", name, args ?? new MachineExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:hybridcompute/preview:MachineExtension", name, null, MakeResourceOptions(options, id))
        {
        }
