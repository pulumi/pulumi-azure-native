...
namespace Pulumi.AzureRM.HybridCompute.Preview
{
    public static class GetMachineExtension
    {
        public static Task<GetMachineExtensionResult> InvokeAsync(GetMachineExtensionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineExtensionResult>("azurerm:hybridcompute/preview:getMachineExtension", args ?? new GetMachineExtensionArgs(), options.WithVersion());
    }
