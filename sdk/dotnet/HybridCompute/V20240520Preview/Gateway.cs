...
namespace Pulumi.AzureNative.HybridCompute.V20240520Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:hybridcompute/v20240520preview:Gateway")]
    public partial class Gateway : global::Pulumi.CustomResource
    {
        ...
        public Gateway(string name, GatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240520preview:Gateway", name, args ?? new GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:hybridcompute/v20240520preview:Gateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("gatewayType")]
        public InputUnion<string, Pulumi.AzureNative.HybridCompute.V20240520Preview.GatewayType>? GatewayType { get; set; }
