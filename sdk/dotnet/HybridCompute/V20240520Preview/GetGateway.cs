...
namespace Pulumi.AzureNative.HybridCompute.V20240520Preview
{
    public static class GetGateway
    {
        ...
        public static Task<GetGatewayResult> InvokeAsync(GetGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewayResult>("azure-native:hybridcompute/v20240520preview:getGateway", args ?? new GetGatewayArgs(), options.WithDefaults());
