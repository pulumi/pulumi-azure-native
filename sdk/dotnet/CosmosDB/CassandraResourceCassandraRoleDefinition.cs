...
namespace Pulumi.AzureNative.CosmosDB
{
    ...
    public partial class CassandraResourceCassandraRoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraRoleDefinition(string name, CassandraResourceCassandraRoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:CassandraResourceCassandraRoleDefinition", name, args ?? new CassandraResourceCassandraRoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraRoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:CassandraResourceCassandraRoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20260315:CassandraResourceCassandraRoleDefinition" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20260401preview:CassandraResourceCassandraRoleDefinition" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CassandraResourceCassandraRoleDefinition Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new CassandraResourceCassandraRoleDefinition(name, id, options);
        }
    }

    public sealed class CassandraResourceCassandraRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public CassandraResourceCassandraRoleDefinitionArgs()
        {
        }
        public static new CassandraResourceCassandraRoleDefinitionArgs Empty => new CassandraResourceCassandraRoleDefinitionArgs();
    }
}
