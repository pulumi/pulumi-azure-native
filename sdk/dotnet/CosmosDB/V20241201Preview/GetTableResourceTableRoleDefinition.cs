...
namespace Pulumi.AzureNative.CosmosDB.V20241201Preview
{
    public static class GetTableResourceTableRoleDefinition
    {
        ...
        public static Task<GetTableResourceTableRoleDefinitionResult> InvokeAsync(GetTableResourceTableRoleDefinitionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTableResourceTableRoleDefinitionResult>("azure-native:cosmosdb/v20241201preview:getTableResourceTableRoleDefinition", args ?? new GetTableResourceTableRoleDefinitionArgs(), options.WithDefaults());
        ...
        public static Output<GetTableResourceTableRoleDefinitionResult> Invoke(GetTableResourceTableRoleDefinitionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTableResourceTableRoleDefinitionResult>("azure-native:cosmosdb/v20241201preview:getTableResourceTableRoleDefinition", args ?? new GetTableResourceTableRoleDefinitionInvokeArgs(), options.WithDefaults());
