...
namespace Pulumi.AzureNative.CosmosDB.V20241201Preview
{
    public static class GetGraphResourceGraph
    {
        ...
        public static Task<GetGraphResourceGraphResult> InvokeAsync(GetGraphResourceGraphArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGraphResourceGraphResult>("azure-native:cosmosdb/v20241201preview:getGraphResourceGraph", args ?? new GetGraphResourceGraphArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the Graph resource under an existing Azure Cosmos DB database account with the provided name.
        /// </summary>
        public static Output<GetGraphResourceGraphResult> Invoke(GetGraphResourceGraphInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGraphResourceGraphResult>("azure-native:cosmosdb/v20241201preview:getGraphResourceGraph", args ?? new GetGraphResourceGraphInvokeArgs(), options.WithDefaults());
