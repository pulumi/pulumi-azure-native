...
namespace Pulumi.AzureNative.CosmosDB.V20241201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cosmosdb/v20241201preview:ThroughputPoolAccount")]
    public partial class ThroughputPoolAccount : global::Pulumi.CustomResource
    {
        ...
        public ThroughputPoolAccount(string name, ThroughputPoolAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20241201preview:ThroughputPoolAccount", name, args ?? new ThroughputPoolAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ThroughputPoolAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20241201preview:ThroughputPoolAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb:ThroughputPoolAccount" },
