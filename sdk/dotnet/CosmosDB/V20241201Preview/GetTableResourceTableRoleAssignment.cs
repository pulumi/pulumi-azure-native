...
namespace Pulumi.AzureNative.CosmosDB.V20241201Preview
{
    public static class GetTableResourceTableRoleAssignment
    {
        ...
        public static Task<GetTableResourceTableRoleAssignmentResult> InvokeAsync(GetTableResourceTableRoleAssignmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTableResourceTableRoleAssignmentResult>("azure-native:cosmosdb/v20241201preview:getTableResourceTableRoleAssignment", args ?? new GetTableResourceTableRoleAssignmentArgs(), options.WithDefaults());
        ...
        public static Output<GetTableResourceTableRoleAssignmentResult> Invoke(GetTableResourceTableRoleAssignmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTableResourceTableRoleAssignmentResult>("azure-native:cosmosdb/v20241201preview:getTableResourceTableRoleAssignment", args ?? new GetTableResourceTableRoleAssignmentInvokeArgs(), options.WithDefaults());
