...
namespace Pulumi.AzureNative.CosmosDB.V20241201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cosmosdb/v20241201preview:CassandraCluster")]
    public partial class CassandraCluster : global::Pulumi.CustomResource
    {
        ...
        public CassandraCluster(string name, CassandraClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20241201preview:CassandraCluster", name, args ?? new CassandraClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20241201preview:CassandraCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb:CassandraCluster" },
