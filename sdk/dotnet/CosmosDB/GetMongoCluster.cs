...
namespace Pulumi.AzureNative.CosmosDB
{
    public static class GetMongoCluster
    {
        ...
        public static Task<GetMongoClusterResult> InvokeAsync(GetMongoClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMongoClusterResult>("azure-native:cosmosdb:getMongoCluster", args ?? new GetMongoClusterArgs(), options.WithDefaults());
        ...
        public static Output<GetMongoClusterResult> Invoke(GetMongoClusterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMongoClusterResult>("azure-native:cosmosdb:getMongoCluster", args ?? new GetMongoClusterInvokeArgs(), options.WithDefaults());
