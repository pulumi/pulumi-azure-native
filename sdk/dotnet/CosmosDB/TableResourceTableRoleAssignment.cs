...
namespace Pulumi.AzureNative.CosmosDB
{
    ...
    public partial class TableResourceTableRoleAssignment : global::Pulumi.CustomResource
    {
        ...
        public TableResourceTableRoleAssignment(string name, TableResourceTableRoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:TableResourceTableRoleAssignment", name, args ?? new TableResourceTableRoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTableRoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:TableResourceTableRoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20260315:TableResourceTableRoleAssignment" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20260401preview:TableResourceTableRoleAssignment" },
