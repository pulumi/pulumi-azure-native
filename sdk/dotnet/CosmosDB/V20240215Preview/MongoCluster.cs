...
namespace Pulumi.AzureNative.CosmosDB.V20240215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cosmosdb/v20240215preview:MongoCluster")]
    public partial class MongoCluster : global::Pulumi.CustomResource
    {
        ...
        public MongoCluster(string name, MongoClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20240215preview:MongoCluster", name, args ?? new MongoClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20240215preview:MongoCluster", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb:MongoCluster" },
    ...
    public sealed class MongoClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.CosmosDB.V20240215Preview.CreateMode>? CreateMode { get; set; }
