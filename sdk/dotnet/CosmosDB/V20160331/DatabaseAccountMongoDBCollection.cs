...
namespace Pulumi.AzureNative.CosmosDB.V20160331
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cosmosdb/v20160331:DatabaseAccountMongoDBCollection")]
    public partial class DatabaseAccountMongoDBCollection : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccountMongoDBCollection(string name, DatabaseAccountMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20160331:DatabaseAccountMongoDBCollection", name, args ?? new DatabaseAccountMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20160331:DatabaseAccountMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb:DatabaseAccountMongoDBCollection" },
