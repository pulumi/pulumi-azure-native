...
namespace Pulumi.AzureNative.CosmosDB
{
    ...
    public partial class ThroughputPool : global::Pulumi.CustomResource
    {
        ...
        public ThroughputPool(string name, ThroughputPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:ThroughputPool", name, args ?? new ThroughputPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ThroughputPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:ThroughputPool", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20250501preview:ThroughputPool" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20251101preview:ThroughputPool" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20260401preview:ThroughputPool" },
