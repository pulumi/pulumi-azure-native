...
namespace Pulumi.AzureNative.CosmosDB.V20230915Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cosmosdb/v20230915preview:DatabaseAccount")]
    public partial class DatabaseAccount : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20230915preview:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20230915preview:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.CosmosDB.V20230915Preview.ConnectorOffer>? ConnectorOffer { get; set; }
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.CosmosDB.V20230915Preview.CreateMode>? CreateMode { get; set; }

        /// <summary>
        /// Indicates the status of the Customer Managed Key feature on the account. In case there are errors, the property provides troubleshooting guidance.
        /// </summary>
        [Input("customerManagedKeyStatus")]
        public InputUnion<string, Pulumi.AzureNative.CosmosDB.V20230915Preview.CustomerManagedKeyStatus>? CustomerManagedKeyStatus { get; set; }

        /// <summary>
        /// The offer type for the database
        /// </summary>
        [Input("databaseAccountOfferType", required: true)]
        public Input<Pulumi.AzureNative.CosmosDB.V20230915Preview.DatabaseAccountOfferType> DatabaseAccountOfferType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.CosmosDB.V20230915Preview.DefaultPriorityLevel>? DefaultPriorityLevel { get; set; }
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.CosmosDB.V20230915Preview.DatabaseAccountKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.CosmosDB.V20230915Preview.MinimalTlsVersion>? MinimalTlsVersion { get; set; }

        /// <summary>
        /// Indicates what services are allowed to bypass firewall checks.
        /// </summary>
        [Input("networkAclBypass")]
        public Input<Pulumi.AzureNative.CosmosDB.V20230915Preview.NetworkAclBypass>? NetworkAclBypass { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.CosmosDB.V20230915Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
