...
namespace Pulumi.AzureNative.CosmosDB.V20210701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cosmosdb/v20210701preview:CassandraCluster")]
    public partial class CassandraCluster : global::Pulumi.CustomResource
    {
        ...
        public CassandraCluster(string name, CassandraClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20210701preview:CassandraCluster", name, args ?? new CassandraClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb/v20210701preview:CassandraCluster", name, null, MakeResourceOptions(options, id))
        {
        }
