...
namespace Pulumi.AzureNative.CosmosDB
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:cosmosdb:ThroughputPoolAccount")]
    public partial class ThroughputPoolAccount : global::Pulumi.CustomResource
    {
        ...
        public ThroughputPoolAccount(string name, ThroughputPoolAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:ThroughputPoolAccount", name, args ?? new ThroughputPoolAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ThroughputPoolAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:ThroughputPoolAccount", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20250501preview:ThroughputPoolAccount" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20251101preview:ThroughputPoolAccount" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20260401preview:ThroughputPoolAccount" },
