...
namespace Pulumi.AzureNative.CosmosDB
{
    ...
    public partial class MongoMIResourceMongoMIRoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public MongoMIResourceMongoMIRoleDefinition(string name, MongoMIResourceMongoMIRoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:MongoMIResourceMongoMIRoleDefinition", name, args ?? new MongoMIResourceMongoMIRoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoMIResourceMongoMIRoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:MongoMIResourceMongoMIRoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20250501preview:MongoMIResourceMongoMIRoleDefinition" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20251101preview:MongoMIResourceMongoMIRoleDefinition" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20260315:MongoMIResourceMongoMIRoleDefinition" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20260401preview:MongoMIResourceMongoMIRoleDefinition" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MongoMIResourceMongoMIRoleDefinition Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new MongoMIResourceMongoMIRoleDefinition(name, id, options);
        }
    }

    public sealed class MongoMIResourceMongoMIRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public MongoMIResourceMongoMIRoleDefinitionArgs()
        {
        }
        public static new MongoMIResourceMongoMIRoleDefinitionArgs Empty => new MongoMIResourceMongoMIRoleDefinitionArgs();
    }
}
