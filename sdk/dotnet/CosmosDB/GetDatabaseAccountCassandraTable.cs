...
namespace Pulumi.AzureNative.CosmosDB
{
    public static class GetDatabaseAccountCassandraTable
    {
        ...
        public static Task<GetDatabaseAccountCassandraTableResult> InvokeAsync(GetDatabaseAccountCassandraTableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountCassandraTableResult>("azure-native:cosmosdb:getDatabaseAccountCassandraTable", args ?? new GetDatabaseAccountCassandraTableArgs(), options.WithDefaults());
        ...
        public static Output<GetDatabaseAccountCassandraTableResult> Invoke(GetDatabaseAccountCassandraTableInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountCassandraTableResult>("azure-native:cosmosdb:getDatabaseAccountCassandraTable", args ?? new GetDatabaseAccountCassandraTableInvokeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the Cassandra table under an existing Azure Cosmos DB database account.
        /// Azure REST API version: 2016-03-31.
        /// </summary>
        public static Output<GetDatabaseAccountCassandraTableResult> Invoke(GetDatabaseAccountCassandraTableInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountCassandraTableResult>("azure-native:cosmosdb:getDatabaseAccountCassandraTable", args ?? new GetDatabaseAccountCassandraTableInvokeArgs(), options.WithDefaults());
    }
