...
namespace Pulumi.AzureNative.CosmosDB
{
    ...
    /// {
    ///     var gremlinResourceGremlinRoleDefinition = new AzureNative.CosmosDB.GremlinResourceGremlinRoleDefinition("gremlinResourceGremlinRoleDefinition", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:cosmosdb:GremlinResourceGremlinRoleDefinition myRoleDefinitionId /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/gremlinRoleDefinitions/{roleDefinitionId} 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:cosmosdb:GremlinResourceGremlinRoleDefinition")]
    public partial class GremlinResourceGremlinRoleDefinition : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GremlinResourceGremlinRoleDefinition(string name, GremlinResourceGremlinRoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:GremlinResourceGremlinRoleDefinition", name, args ?? new GremlinResourceGremlinRoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinRoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:cosmosdb:GremlinResourceGremlinRoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20250501preview:GremlinResourceGremlinRoleDefinition" },
                    new global::Pulumi.Alias { Type = "azure-native:cosmosdb/v20251101preview:GremlinResourceGremlinRoleDefinition" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GremlinResourceGremlinRoleDefinition Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new GremlinResourceGremlinRoleDefinition(name, id, options);
        }
    }

    public sealed class GremlinResourceGremlinRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.CosmosDB.RoleDefinitionType>? Type { get; set; }

        public GremlinResourceGremlinRoleDefinitionArgs()
        {
        }
        public static new GremlinResourceGremlinRoleDefinitionArgs Empty => new GremlinResourceGremlinRoleDefinitionArgs();
    }
}
