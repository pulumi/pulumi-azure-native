...
namespace Pulumi.AzureNative.DataProtection.V20221001Preview
{
    ...
    [AzureNativeResourceType("azure-native:dataprotection/v20221001preview:BackupInstance")]
    public partial class BackupInstance : global::Pulumi.CustomResource
    {
        ...
        public BackupInstance(string name, BackupInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20221001preview:BackupInstance", name, args ?? new BackupInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20221001preview:BackupInstance", name, null, MakeResourceOptions(options, id))
        {
        }
