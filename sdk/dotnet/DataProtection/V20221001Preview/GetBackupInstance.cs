...
{
    [Obsolete(@"azure-native:dataprotection/v20221001preview:BackupInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupInstance to guarantee forwards compatibility.")]
    public static class GetBackupInstance
    {
        ...
        public static Task<GetBackupInstanceResult> InvokeAsync(GetBackupInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackupInstanceResult>("azure-native:dataprotection/v20221001preview:getBackupInstance", args ?? new GetBackupInstanceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a backup instance with name in a backup vault
        /// </summary>
        public static Output<GetBackupInstanceResult> Invoke(GetBackupInstanceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackupInstanceResult>("azure-native:dataprotection/v20221001preview:getBackupInstance", args ?? new GetBackupInstanceInvokeArgs(), options.WithDefaults());
    }
