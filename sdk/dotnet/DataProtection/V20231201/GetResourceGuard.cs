...
namespace Pulumi.AzureNative.DataProtection.V20231201
{
    public static class GetResourceGuard
    {
        public static Task<GetResourceGuardResult> InvokeAsync(GetResourceGuardArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResourceGuardResult>("azure-native:dataprotection/v20231201:getResourceGuard", args ?? new GetResourceGuardArgs(), options.WithDefaults());
