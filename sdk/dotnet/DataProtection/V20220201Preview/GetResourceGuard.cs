...
namespace Pulumi.AzureNative.DataProtection.V20220201Preview
{
    public static class GetResourceGuard
    {
        public static Task<GetResourceGuardResult> InvokeAsync(GetResourceGuardArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourceGuardResult>("azure-native:dataprotection/v20220201preview:getResourceGuard", args ?? new GetResourceGuardArgs(), options.WithDefaults());

        public static Output<GetResourceGuardResult> Invoke(GetResourceGuardInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetResourceGuardResult>("azure-native:dataprotection/v20220201preview:getResourceGuard", args ?? new GetResourceGuardInvokeArgs(), options.WithDefaults());
    }
