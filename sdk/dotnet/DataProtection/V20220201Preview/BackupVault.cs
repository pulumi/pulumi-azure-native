...
namespace Pulumi.AzureNative.DataProtection.V20220201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20220201preview:BackupVault")]
    public partial class BackupVault : global::Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220201preview:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220201preview:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
