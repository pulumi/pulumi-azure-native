...
namespace Pulumi.AzureNative.DataProtection.V20230501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20230501:DppResourceGuardProxy")]
    public partial class DppResourceGuardProxy : global::Pulumi.CustomResource
    {
        ...
        public DppResourceGuardProxy(string name, DppResourceGuardProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20230501:DppResourceGuardProxy", name, args ?? new DppResourceGuardProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DppResourceGuardProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20230501:DppResourceGuardProxy", name, null, MakeResourceOptions(options, id))
        {
        }
