...
namespace Pulumi.AzureNative.DataProtection.V20230101
{
    ...
    /// {
    ///     var dppResourceGuardProxy = new AzureNative.DataProtection.V20230101.DppResourceGuardProxy("dppResourceGuardProxy", new()
    ///     {
    ///         Properties = new AzureNative.DataProtection.V20230101.Inputs.ResourceGuardProxyBaseArgs
    ///         {
    ...
    public partial class DppResourceGuardProxy : global::Pulumi.CustomResource
    {
        ...
        public DppResourceGuardProxy(string name, DppResourceGuardProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20230101:DppResourceGuardProxy", name, args ?? new DppResourceGuardProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DppResourceGuardProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20230101:DppResourceGuardProxy", name, null, MakeResourceOptions(options, id))
        {
        }
