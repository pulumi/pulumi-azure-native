...
namespace Pulumi.AzureNative.DataProtection.V20230101
{
    ...
    /// {
    ///     var backupVault = new AzureNative.DataProtection.V20230101.BackupVault("backupVault", new()
    ///     {
    ///         Identity = new AzureNative.DataProtection.V20230101.Inputs.DppIdentityDetailsArgs
    ///         {
    ///             Type = "None",
    ///         },
    ///         Location = "WestUS",
    ///         Properties = new AzureNative.DataProtection.V20230101.Inputs.BackupVaultArgs
    ///         {
    ///             MonitoringSettings = new AzureNative.DataProtection.V20230101.Inputs.MonitoringSettingsArgs
    ///             {
    ///                 AzureMonitorAlertSettings = new AzureNative.DataProtection.V20230101.Inputs.AzureMonitorAlertSettingsArgs
    ///                 {
    ...
    ///             StorageSettings = new[]
    ///             {
    ///                 new AzureNative.DataProtection.V20230101.Inputs.StorageSettingArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20230101:BackupVault")]
    public partial class BackupVault : global::Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20230101:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20230101:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
