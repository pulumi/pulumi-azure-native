...
namespace Pulumi.AzureNative.DataProtection.V20210601Preview
{
    public static class GetBackupVault
    {
        ...
        public static Task<GetBackupVaultResult> InvokeAsync(GetBackupVaultArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupVaultResult>("azure-native:dataprotection/v20210601preview:getBackupVault", args ?? new GetBackupVaultArgs(), options.WithDefaults());

        /// <summary>
        /// Backup Vault Resource
        /// </summary>
        public static Output<GetBackupVaultResult> Invoke(GetBackupVaultInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackupVaultResult>("azure-native:dataprotection/v20210601preview:getBackupVault", args ?? new GetBackupVaultInvokeArgs(), options.WithDefaults());
    }
