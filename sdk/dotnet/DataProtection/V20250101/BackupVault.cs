...
namespace Pulumi.AzureNative.DataProtection.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20250101:BackupVault")]
    public partial class BackupVault : global::Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250101:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250101:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
