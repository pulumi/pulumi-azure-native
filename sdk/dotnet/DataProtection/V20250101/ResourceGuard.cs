...
{
    [AzureNativeResourceType("azure-native:dataprotection/v20250101:ResourceGuard")]
    public partial class ResourceGuard : global::Pulumi.CustomResource
    {
        ...
        public ResourceGuard(string name, ResourceGuardArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250101:ResourceGuard", name, args ?? new ResourceGuardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGuard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250101:ResourceGuard", name, null, MakeResourceOptions(options, id))
        {
        }
