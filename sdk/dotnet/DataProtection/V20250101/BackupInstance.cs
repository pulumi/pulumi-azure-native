...
namespace Pulumi.AzureNative.DataProtection.V20250101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20250101:BackupInstance")]
    public partial class BackupInstance : global::Pulumi.CustomResource
    {
        ...
        public BackupInstance(string name, BackupInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250101:BackupInstance", name, args ?? new BackupInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250101:BackupInstance", name, null, MakeResourceOptions(options, id))
        {
        }
