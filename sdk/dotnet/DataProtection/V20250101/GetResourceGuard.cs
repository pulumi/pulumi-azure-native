...
namespace Pulumi.AzureNative.DataProtection.V20250101
{
    public static class GetResourceGuard
    {
        public static Task<GetResourceGuardResult> InvokeAsync(GetResourceGuardArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResourceGuardResult>("azure-native:dataprotection/v20250101:getResourceGuard", args ?? new GetResourceGuardArgs(), options.WithDefaults());

        public static Output<GetResourceGuardResult> Invoke(GetResourceGuardInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetResourceGuardResult>("azure-native:dataprotection/v20250101:getResourceGuard", args ?? new GetResourceGuardInvokeArgs(), options.WithDefaults());
