...
namespace Pulumi.AzureNative.DataProtection.V20211001Preview
{
    public static class GetBackupVault
    {
        ...
        public static Task<GetBackupVaultResult> InvokeAsync(GetBackupVaultArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackupVaultResult>("azure-native:dataprotection/v20211001preview:getBackupVault", args ?? new GetBackupVaultArgs(), options.WithVersion());

        /// <summary>
        /// Backup Vault Resource
        /// </summary>
        public static Output<GetBackupVaultResult> Invoke(GetBackupVaultInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackupVaultResult>("azure-native:dataprotection/v20211001preview:getBackupVault", args ?? new GetBackupVaultInvokeArgs(), options.WithVersion());
    }
