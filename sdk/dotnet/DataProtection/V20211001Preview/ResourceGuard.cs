...
namespace Pulumi.AzureNative.DataProtection.V20211001Preview
{
    ...
    /// {
    ///     var resourceGuard = new AzureNative.DataProtection.V20211001Preview.ResourceGuard("resourceGuard", new()
    ///     {
    ///         Location = "WestUS",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:dataprotection/v20211001preview:ResourceGuard VaultGuardTestNew /subscriptions/c999d45b-944f-418c-a0d8-c3fcfd1802c8/resourceGroups/vaultguardRGNew/providers/Microsoft.DataProtection/resourceGuards/VaultGuardTestNew 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20211001preview:ResourceGuard")]
    public partial class ResourceGuard : global::Pulumi.CustomResource
    {
        ...
        public ResourceGuard(string name, ResourceGuardArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20211001preview:ResourceGuard", name, args ?? new ResourceGuardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGuard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20211001preview:ResourceGuard", name, null, MakeResourceOptions(options, id))
        {
        }
