...
namespace Pulumi.AzureNative.DataProtection.V20211001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20211001preview:BackupInstance")]
    public partial class BackupInstance : Pulumi.CustomResource
    {
        ...
        public BackupInstance(string name, BackupInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20211001preview:BackupInstance", name, args ?? new BackupInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20211001preview:BackupInstance", name, null, MakeResourceOptions(options, id))
        {
        }
