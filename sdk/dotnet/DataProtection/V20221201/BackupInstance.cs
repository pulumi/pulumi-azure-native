...
namespace Pulumi.AzureNative.DataProtection.V20221201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:dataprotection/v20221201:BackupInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupInstance to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:dataprotection/v20221201:BackupInstance")]
    public partial class BackupInstance : global::Pulumi.CustomResource
    {
        ...
        public BackupInstance(string name, BackupInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20221201:BackupInstance", name, args ?? new BackupInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20221201:BackupInstance", name, null, MakeResourceOptions(options, id))
        {
        }
