...
namespace Pulumi.AzureNative.DataProtection.V20221201
{
    ...
    public static class GetBackupInstance
    {
        ...
        public static Task<GetBackupInstanceResult> InvokeAsync(GetBackupInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackupInstanceResult>("azure-native:dataprotection/v20221201:getBackupInstance", args ?? new GetBackupInstanceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a backup instance with name in a backup vault
        /// </summary>
        public static Output<GetBackupInstanceResult> Invoke(GetBackupInstanceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackupInstanceResult>("azure-native:dataprotection/v20221201:getBackupInstance", args ?? new GetBackupInstanceInvokeArgs(), options.WithDefaults());
    }
