...
namespace Pulumi.AzureNative.DataProtection.V20210101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:dataprotection/v20210101:BackupVault is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupVault to guarantee forwards compatibility.")]
    ...
    public partial class BackupVault : global::Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20210101:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20210101:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
