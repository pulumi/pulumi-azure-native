...
namespace Pulumi.AzureNative.DataProtection.V20210101
{
    public static class GetBackupInstance
    {
        ...
        public static Output<GetBackupInstanceResult> Invoke(GetBackupInstanceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackupInstanceResult>("azure-native:dataprotection/v20210101:getBackupInstance", args ?? new GetBackupInstanceInvokeArgs(), options.WithVersion());
    }
