...
namespace Pulumi.AzureNative.DataProtection.V20211201Preview
{
    ...
    public partial class ResourceGuard : Pulumi.CustomResource
    {
        ...
        public ResourceGuard(string name, ResourceGuardArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20211201preview:ResourceGuard", name, args ?? new ResourceGuardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGuard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20211201preview:ResourceGuard", name, null, MakeResourceOptions(options, id))
        {
        }
