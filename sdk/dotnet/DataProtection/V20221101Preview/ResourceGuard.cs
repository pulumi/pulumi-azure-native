...
namespace Pulumi.AzureNative.DataProtection.V20221101Preview
{
    ...
    /// {
    ///     var resourceGuard = new AzureNative.DataProtection.V20221101Preview.ResourceGuard("resourceGuard", new()
    ///     {
    ///         Location = "WestUS",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20221101preview:ResourceGuard")]
    public partial class ResourceGuard : global::Pulumi.CustomResource
    {
        ...
        public ResourceGuard(string name, ResourceGuardArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20221101preview:ResourceGuard", name, args ?? new ResourceGuardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGuard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20221101preview:ResourceGuard", name, null, MakeResourceOptions(options, id))
        {
        }
