...
namespace Pulumi.AzureNative.DataProtection.V20220401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20220401:BackupInstance")]
    public partial class BackupInstance : global::Pulumi.CustomResource
    {
        ...
        public BackupInstance(string name, BackupInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220401:BackupInstance", name, args ?? new BackupInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220401:BackupInstance", name, null, MakeResourceOptions(options, id))
        {
        }
