...
namespace Pulumi.AzureNative.DataProtection.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20240401:DppResourceGuardProxy")]
    public partial class DppResourceGuardProxy : global::Pulumi.CustomResource
    {
        ...
        public DppResourceGuardProxy(string name, DppResourceGuardProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20240401:DppResourceGuardProxy", name, args ?? new DppResourceGuardProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DppResourceGuardProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20240401:DppResourceGuardProxy", name, null, MakeResourceOptions(options, id))
        {
        }
