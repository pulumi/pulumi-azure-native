...
namespace Pulumi.AzureNative.DataProtection.V20220331Preview
{
    ...
    [AzureNativeResourceType("azure-native:dataprotection/v20220331preview:ResourceGuard")]
    public partial class ResourceGuard : global::Pulumi.CustomResource
    {
        ...
        public ResourceGuard(string name, ResourceGuardArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220331preview:ResourceGuard", name, args ?? new ResourceGuardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGuard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220331preview:ResourceGuard", name, null, MakeResourceOptions(options, id))
        {
        }
