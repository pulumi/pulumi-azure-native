...
namespace Pulumi.AzureNative.DataProtection.V20220501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:dataprotection/v20220501:BackupVault is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupVault to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:dataprotection/v20220501:BackupVault")]
    public partial class BackupVault : global::Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220501:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220501:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
