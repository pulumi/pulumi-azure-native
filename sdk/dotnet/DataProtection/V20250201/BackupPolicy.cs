...
namespace Pulumi.AzureNative.DataProtection.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20250201:BackupPolicy")]
    public partial class BackupPolicy : global::Pulumi.CustomResource
    {
        ...
        public BackupPolicy(string name, BackupPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250201:BackupPolicy", name, args ?? new BackupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250201:BackupPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
