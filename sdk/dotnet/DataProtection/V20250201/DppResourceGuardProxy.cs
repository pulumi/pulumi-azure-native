...
namespace Pulumi.AzureNative.DataProtection.V20250201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20250201:DppResourceGuardProxy")]
    public partial class DppResourceGuardProxy : global::Pulumi.CustomResource
    {
        ...
        public DppResourceGuardProxy(string name, DppResourceGuardProxyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250201:DppResourceGuardProxy", name, args ?? new DppResourceGuardProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DppResourceGuardProxy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20250201:DppResourceGuardProxy", name, null, MakeResourceOptions(options, id))
        {
        }
