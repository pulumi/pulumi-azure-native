...
namespace Pulumi.AzureNative.DataProtection.V20250201.Inputs
{
    ...
    public sealed class KubernetesClusterBackupDatasourceParametersArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.DataProtection.V20250201.AKSVolumeTypes>>? _includedVolumeTypes;

        /// <summary>
        /// Gets or sets the include volume types property. This property sets the volume types to be included during backup.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.DataProtection.V20250201.AKSVolumeTypes>> IncludedVolumeTypes
        {
            get => _includedVolumeTypes ?? (_includedVolumeTypes = new InputList<Union<string, Pulumi.AzureNative.DataProtection.V20250201.AKSVolumeTypes>>());
