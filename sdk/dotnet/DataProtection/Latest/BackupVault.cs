...
namespace Pulumi.AzureNative.DataProtection.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dataprotection:BackupVault'.")]
    [AzureNativeResourceType("azure-native:dataprotection/latest:BackupVault")]
    public partial class BackupVault : Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/latest:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/latest:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
