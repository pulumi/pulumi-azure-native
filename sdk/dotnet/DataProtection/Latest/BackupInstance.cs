...
namespace Pulumi.AzureNative.DataProtection.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dataprotection:BackupInstance'.")]
    [AzureNativeResourceType("azure-native:dataprotection/latest:BackupInstance")]
    public partial class BackupInstance : Pulumi.CustomResource
    {
        ...
        public BackupInstance(string name, BackupInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/latest:BackupInstance", name, args ?? new BackupInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/latest:BackupInstance", name, null, MakeResourceOptions(options, id))
        {
        }
