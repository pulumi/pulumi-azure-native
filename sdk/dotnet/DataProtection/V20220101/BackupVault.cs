...
namespace Pulumi.AzureNative.DataProtection.V20220101
{
    ...
    public partial class BackupVault : Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220101:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220101:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
