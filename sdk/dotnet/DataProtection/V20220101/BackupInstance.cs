...
namespace Pulumi.AzureNative.DataProtection.V20220101
{
    ...
    [AzureNativeResourceType("azure-native:dataprotection/v20220101:BackupInstance")]
    public partial class BackupInstance : global::Pulumi.CustomResource
    {
        ...
        public BackupInstance(string name, BackupInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220101:BackupInstance", name, args ?? new BackupInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20220101:BackupInstance", name, null, MakeResourceOptions(options, id))
        {
        }
