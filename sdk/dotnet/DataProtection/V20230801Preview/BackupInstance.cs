...
namespace Pulumi.AzureNative.DataProtection.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:dataprotection/v20230801preview:BackupInstance")]
    public partial class BackupInstance : global::Pulumi.CustomResource
    {
        ...
        public BackupInstance(string name, BackupInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20230801preview:BackupInstance", name, args ?? new BackupInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:dataprotection/v20230801preview:BackupInstance", name, null, MakeResourceOptions(options, id))
        {
        }
