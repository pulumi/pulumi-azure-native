...
namespace Pulumi.AzureNative.AppConfiguration.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appconfiguration/v20240501:Replica")]
    public partial class Replica : global::Pulumi.CustomResource
    {
        ...
        public Replica(string name, ReplicaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20240501:Replica", name, args ?? new ReplicaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replica(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20240501:Replica", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:appconfiguration:Replica" },
                },
            };
