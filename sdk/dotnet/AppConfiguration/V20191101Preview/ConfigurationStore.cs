...
namespace Pulumi.AzureRM.AppConfiguration.V20191101Preview
{
    /// <summary>
    ...
    public partial class ConfigurationStore : Pulumi.CustomResource
    {
        ...
        public ConfigurationStore(string name, ConfigurationStoreArgs args, CustomResourceOptions? options = null)
            : base("azurerm:appconfiguration/v20191101preview:ConfigurationStore", name, args ?? new ConfigurationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:appconfiguration/v20191101preview:ConfigurationStore", name, null, MakeResourceOptions(options, id))
        {
        }
