...
namespace Pulumi.AzureRM.AppConfiguration.V20191101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.AppConfiguration.V20191101Preview.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.AppConfiguration.V20191101Preview.PrivateEndpointConnectionArgs
    ///         {
    ///             ConfigStoreName = "contoso",
    ///             PrivateEndpointConnectionName = "myConnection",
    ///             PrivateLinkServiceConnectionState = new AzureRM.AppConfiguration.V20191101Preview.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:appconfiguration/v20191101preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:appconfiguration/v20191101preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
