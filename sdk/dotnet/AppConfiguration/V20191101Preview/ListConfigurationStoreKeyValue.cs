...
namespace Pulumi.AzureNative.AppConfiguration.V20191101Preview
{
    public static class ListConfigurationStoreKeyValue
    {
        ...
        public static Output<ListConfigurationStoreKeyValueResult> Invoke(ListConfigurationStoreKeyValueInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListConfigurationStoreKeyValueResult>("azure-native:appconfiguration/v20191101preview:listConfigurationStoreKeyValue", args ?? new ListConfigurationStoreKeyValueInvokeArgs(), options.WithVersion());
    }
