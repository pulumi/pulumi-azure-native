...
namespace Pulumi.AzureRM.AppConfiguration.V20191101Preview
{
    public static class ListConfigurationStoreKeyValue
    {
        public static Task<ListConfigurationStoreKeyValueResult> InvokeAsync(ListConfigurationStoreKeyValueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListConfigurationStoreKeyValueResult>("azurerm:appconfiguration/v20191101preview:listConfigurationStoreKeyValue", args ?? new ListConfigurationStoreKeyValueArgs(), options.WithVersion());
    }
