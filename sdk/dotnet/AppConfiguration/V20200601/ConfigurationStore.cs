...
namespace Pulumi.AzureNative.AppConfiguration.V20200601
{
    ...
    /// {
    ///     var configurationStore = new AzureNative.AppConfiguration.V20200601.ConfigurationStore("configurationStore", new()
    ///     {
    ///         ConfigStoreName = "contoso",
    ///         Location = "westus",
    ///         ResourceGroupName = "myResourceGroup",
    ///         Sku = new AzureNative.AppConfiguration.V20200601.Inputs.SkuArgs
    ///         {
    ///             Name = "Standard",
    ///         },
    ///         Tags = 
    ...
    ///     {
    ///         ConfigStoreName = "contoso",
    ///         Identity = new AzureNative.AppConfiguration.V20200601.Inputs.ResourceIdentityArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appconfiguration/v20200601:ConfigurationStore")]
    public partial class ConfigurationStore : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationStore(string name, ConfigurationStoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20200601:ConfigurationStore", name, args ?? new ConfigurationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20200601:ConfigurationStore", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationStoreArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AppConfiguration.V20200601.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
