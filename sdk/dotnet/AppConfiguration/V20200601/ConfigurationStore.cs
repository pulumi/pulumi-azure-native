...
namespace Pulumi.AzureNextGen.AppConfiguration.V20200601
{
    ...
    public partial class ConfigurationStore : Pulumi.CustomResource
    {
        ...
        public ConfigurationStore(string name, ConfigurationStoreArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:appconfiguration/v20200601:ConfigurationStore", name, args ?? new ConfigurationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:appconfiguration/v20200601:ConfigurationStore", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationStoreArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.AppConfiguration.V20200601.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
