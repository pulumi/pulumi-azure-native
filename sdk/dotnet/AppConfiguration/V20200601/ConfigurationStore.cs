...
namespace Pulumi.AzureRM.AppConfiguration.V20200601
{
    ...
    public partial class ConfigurationStore : Pulumi.CustomResource
    {
        ...
        public ConfigurationStore(string name, ConfigurationStoreArgs args, CustomResourceOptions? options = null)
            : base("azurerm:appconfiguration/v20200601:ConfigurationStore", name, args ?? new ConfigurationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:appconfiguration/v20200601:ConfigurationStore", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:appconfiguration/v20191001:ConfigurationStore"},
                },
            };
