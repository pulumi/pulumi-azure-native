...
namespace Pulumi.AzureRM.AppConfiguration.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.AppConfiguration.V20200601.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.AppConfiguration.V20200601.PrivateEndpointConnectionArgs
    ///         {
    ///             ConfigStoreName = "contoso",
    ///             PrivateEndpointConnectionName = "myConnection",
    ///             PrivateLinkServiceConnectionState = new AzureRM.AppConfiguration.V20200601.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:appconfiguration/v20200601:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:appconfiguration/v20200601:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
