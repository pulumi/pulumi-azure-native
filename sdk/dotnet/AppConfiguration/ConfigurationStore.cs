...
namespace Pulumi.AzureNextGen.AppConfiguration
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:appconfiguration:ConfigurationStore")]
    public partial class ConfigurationStore : Pulumi.CustomResource
    {
        ...
        public ConfigurationStore(string name, ConfigurationStoreArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:appconfiguration:ConfigurationStore", name, args ?? new ConfigurationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:appconfiguration:ConfigurationStore", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationStoreArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.AppConfiguration.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
