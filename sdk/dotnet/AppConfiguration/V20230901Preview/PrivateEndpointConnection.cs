...
namespace Pulumi.AzureNative.AppConfiguration.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appconfiguration/v20230901preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230901preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230901preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
