...
namespace Pulumi.AzureNative.AppConfiguration.V20230901Preview
{
    public static class GetReplica
    {
        ...
        public static Task<GetReplicaResult> InvokeAsync(GetReplicaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReplicaResult>("azure-native:appconfiguration/v20230901preview:getReplica", args ?? new GetReplicaArgs(), options.WithDefaults());
