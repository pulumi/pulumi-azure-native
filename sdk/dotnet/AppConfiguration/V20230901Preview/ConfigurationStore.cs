...
namespace Pulumi.AzureNative.AppConfiguration.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appconfiguration/v20230901preview:ConfigurationStore")]
    public partial class ConfigurationStore : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.ExperimentationPropertiesResponse?> Experimentation { get; private set; } = null!;
        ...
        /// </summary>
        [Output("telemetry")]
        public Output<Outputs.TelemetryPropertiesResponse?> Telemetry { get; private set; } = null!;
        ...
        public ConfigurationStore(string name, ConfigurationStoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230901preview:ConfigurationStore", name, args ?? new ConfigurationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230901preview:ConfigurationStore", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationStoreArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public Input<Pulumi.AzureNative.AppConfiguration.V20230901Preview.CreateMode>? CreateMode { get; set; }
        ...
        public Input<Inputs.ExperimentationPropertiesArgs>? Experimentation { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AppConfiguration.V20230901Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        /// </summary>
        [Input("telemetry")]
        public Input<Inputs.TelemetryPropertiesArgs>? Telemetry { get; set; }
