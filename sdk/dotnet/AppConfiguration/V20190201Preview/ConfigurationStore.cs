...
namespace Pulumi.AzureNative.AppConfiguration.V20190201Preview
{
    ...
    /// </summary>
    [Obsolete(@"Version v20190201preview will be removed in the next major version of the provider. Upgrade to version v20200601 or later.")]
    ...
    public partial class ConfigurationStore : Pulumi.CustomResource
    {
        ...
        public ConfigurationStore(string name, ConfigurationStoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20190201preview:ConfigurationStore", name, args ?? new ConfigurationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20190201preview:ConfigurationStore", name, null, MakeResourceOptions(options, id))
        {
        }
