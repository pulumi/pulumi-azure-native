...
namespace Pulumi.AzureNative.AppConfiguration
{
    public static class GetReplica
    {
        ...
        public static Task<GetReplicaResult> InvokeAsync(GetReplicaArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReplicaResult>("azure-native:appconfiguration:getReplica", args ?? new GetReplicaArgs(), options.WithDefaults());
        ...
        public static Output<GetReplicaResult> Invoke(GetReplicaInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetReplicaResult>("azure-native:appconfiguration:getReplica", args ?? new GetReplicaInvokeArgs(), options.WithDefaults());
    }
