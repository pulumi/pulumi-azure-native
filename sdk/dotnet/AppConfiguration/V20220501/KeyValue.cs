...
namespace Pulumi.AzureNative.AppConfiguration.V20220501
{
    /// <summary>
    /// The key-value resource along with all resource properties.
    /// </summary>
    [Obsolete(@"azure-native:appconfiguration/v20220501:KeyValue is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:KeyValue to guarantee forwards compatibility.")]
    ...
    public partial class KeyValue : global::Pulumi.CustomResource
    {
        ...
        public KeyValue(string name, KeyValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20220501:KeyValue", name, args ?? new KeyValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20220501:KeyValue", name, null, MakeResourceOptions(options, id))
        {
        }
