...
namespace Pulumi.AzureRM.AppConfiguration
{
    ...
    /// </summary>
    public partial class ConfigurationStorePrivateEndpointConnection : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ConfigurationStorePrivateEndpointConnection(string name, ConfigurationStorePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:appconfiguration:ConfigurationStorePrivateEndpointConnection", name, args ?? new ConfigurationStorePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class ConfigurationStorePrivateEndpointConnectionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
