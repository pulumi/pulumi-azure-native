...
namespace Pulumi.AzureNative.AppConfiguration.V20230301
{
    ...
    /// {
    ///     var keyValue = new AzureNative.AppConfiguration.V20230301.KeyValue("keyValue", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appconfiguration/v20230301:KeyValue")]
    public partial class KeyValue : global::Pulumi.CustomResource
    {
        ...
        public KeyValue(string name, KeyValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230301:KeyValue", name, args ?? new KeyValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230301:KeyValue", name, null, MakeResourceOptions(options, id))
        {
        }
