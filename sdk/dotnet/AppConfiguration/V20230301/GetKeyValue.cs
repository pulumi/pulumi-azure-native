...
namespace Pulumi.AzureNative.AppConfiguration.V20230301
{
    public static class GetKeyValue
    {
        ...
        public static Task<GetKeyValueResult> InvokeAsync(GetKeyValueArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyValueResult>("azure-native:appconfiguration/v20230301:getKeyValue", args ?? new GetKeyValueArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified key-value. NOTE: This operation is intended for use in ARM Template deployments. For all other scenarios involving App Configuration key-values the data plane API should be used instead.
        /// </summary>
        public static Output<GetKeyValueResult> Invoke(GetKeyValueInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyValueResult>("azure-native:appconfiguration/v20230301:getKeyValue", args ?? new GetKeyValueInvokeArgs(), options.WithDefaults());
    }
