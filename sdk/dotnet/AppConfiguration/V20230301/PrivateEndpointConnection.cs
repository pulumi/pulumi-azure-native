...
namespace Pulumi.AzureNative.AppConfiguration.V20230301
{
    /// <summary>
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.AppConfiguration.V20230301.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         ConfigStoreName = "contoso",
    ///         PrivateEndpointConnectionName = "myConnection",
    ///         PrivateLinkServiceConnectionState = new AzureNative.AppConfiguration.V20230301.Inputs.PrivateLinkServiceConnectionStateArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:appconfiguration/v20230301:PrivateEndpointConnection myConnection /subscriptions/c80fb759-c965-4c6a-9110-9b2b2d038882/resourceGroups/myResourceGroup/providers/Microsoft.AppConfiguration/configurationStores/contoso/privateEndpointConnections/myConnection 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:appconfiguration/v20230301:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230301:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230301:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
