...
namespace Pulumi.AzureNative.AppConfiguration.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appconfiguration/v20230801preview:KeyValue")]
    public partial class KeyValue : global::Pulumi.CustomResource
    {
        ...
        public KeyValue(string name, KeyValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230801preview:KeyValue", name, args ?? new KeyValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230801preview:KeyValue", name, null, MakeResourceOptions(options, id))
        {
        }
