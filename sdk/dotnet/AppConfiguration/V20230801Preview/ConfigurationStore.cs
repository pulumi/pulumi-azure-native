...
namespace Pulumi.AzureNative.AppConfiguration.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appconfiguration/v20230801preview:ConfigurationStore")]
    public partial class ConfigurationStore : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationStore(string name, ConfigurationStoreArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230801preview:ConfigurationStore", name, args ?? new ConfigurationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230801preview:ConfigurationStore", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationStoreArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public Input<Pulumi.AzureNative.AppConfiguration.V20230801Preview.CreateMode>? CreateMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AppConfiguration.V20230801Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
