...
namespace Pulumi.AzureNative.AppConfiguration.V20230801Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:appconfiguration/v20230801preview:Replica")]
    public partial class Replica : global::Pulumi.CustomResource
    {
        ...
        public Replica(string name, ReplicaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230801preview:Replica", name, args ?? new ReplicaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replica(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20230801preview:Replica", name, null, MakeResourceOptions(options, id))
        {
        }
