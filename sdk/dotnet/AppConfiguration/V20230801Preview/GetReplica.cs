...
namespace Pulumi.AzureNative.AppConfiguration.V20230801Preview
{
    public static class GetReplica
    {
        ...
        public static Task<GetReplicaResult> InvokeAsync(GetReplicaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReplicaResult>("azure-native:appconfiguration/v20230801preview:getReplica", args ?? new GetReplicaArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified replica.
        /// </summary>
        public static Output<GetReplicaResult> Invoke(GetReplicaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReplicaResult>("azure-native:appconfiguration/v20230801preview:getReplica", args ?? new GetReplicaInvokeArgs(), options.WithDefaults());
    }
