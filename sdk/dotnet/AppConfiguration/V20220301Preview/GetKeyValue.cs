...
{
    [Obsolete(@"azure-native:appconfiguration/v20220301preview:KeyValue is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:KeyValue to guarantee forwards compatibility.")]
    public static class GetKeyValue
    {
        ...
        public static Task<GetKeyValueResult> InvokeAsync(GetKeyValueArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyValueResult>("azure-native:appconfiguration/v20220301preview:getKeyValue", args ?? new GetKeyValueArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the properties of the specified key-value.
        /// </summary>
        public static Output<GetKeyValueResult> Invoke(GetKeyValueInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyValueResult>("azure-native:appconfiguration/v20220301preview:getKeyValue", args ?? new GetKeyValueInvokeArgs(), options.WithDefaults());
    }
