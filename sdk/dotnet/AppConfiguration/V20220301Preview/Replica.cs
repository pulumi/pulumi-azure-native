...
namespace Pulumi.AzureNative.AppConfiguration.V20220301Preview
{
    ...
    public partial class Replica : Pulumi.CustomResource
    {
        ...
        public Replica(string name, ReplicaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20220301preview:Replica", name, args ?? new ReplicaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Replica(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20220301preview:Replica", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:appconfiguration:Replica"},
                },
            };
