...
namespace Pulumi.AzureNextGen.AppConfiguration.V20200701Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:appconfiguration/v20200701preview:ConfigurationStore")]
    public partial class ConfigurationStore : Pulumi.CustomResource
    {
        ...
        public ConfigurationStore(string name, ConfigurationStoreArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:appconfiguration/v20200701preview:ConfigurationStore", name, args ?? new ConfigurationStoreArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationStore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:appconfiguration/v20200701preview:ConfigurationStore", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationStoreArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.AppConfiguration.V20200701Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
