...
namespace Pulumi.AzureNextGen.AppConfiguration.V20200701Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:appconfiguration/v20200701preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:appconfiguration/v20200701preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:appconfiguration/v20200701preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
