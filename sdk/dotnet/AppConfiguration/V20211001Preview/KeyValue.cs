...
namespace Pulumi.AzureNative.AppConfiguration.V20211001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:appconfiguration/v20211001preview:KeyValue is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:KeyValue to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:appconfiguration/v20211001preview:KeyValue")]
    public partial class KeyValue : global::Pulumi.CustomResource
    {
        ...
        public KeyValue(string name, KeyValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20211001preview:KeyValue", name, args ?? new KeyValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:appconfiguration/v20211001preview:KeyValue", name, null, MakeResourceOptions(options, id))
        {
        }
