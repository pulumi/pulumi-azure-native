...
namespace Pulumi.AzureNative.AppConfiguration.V20211001Preview
{
    public static class GetKeyValue
    {
        ...
        public static Task<GetKeyValueResult> InvokeAsync(GetKeyValueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKeyValueResult>("azure-native:appconfiguration/v20211001preview:getKeyValue", args ?? new GetKeyValueArgs(), options.WithVersion());

        /// <summary>
        /// The key-value resource along with all resource properties.
        /// </summary>
        public static Output<GetKeyValueResult> Invoke(GetKeyValueInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKeyValueResult>("azure-native:appconfiguration/v20211001preview:getKeyValue", args ?? new GetKeyValueInvokeArgs(), options.WithVersion());
    }
