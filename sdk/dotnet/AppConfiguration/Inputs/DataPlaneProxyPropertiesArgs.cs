...
namespace Pulumi.AzureNative.AppConfiguration.Inputs
{
    ...
    public sealed class DataPlaneProxyPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AppConfiguration.AuthenticationMode>? AuthenticationMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AppConfiguration.PrivateLinkDelegation>? PrivateLinkDelegation { get; set; }
