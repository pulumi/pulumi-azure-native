...
namespace Pulumi.AzureNative.DocumentDB.V20241201Preview
{
    public static class GetTableResourceTableRoleAssignment
    {
        ...
        public static Task<GetTableResourceTableRoleAssignmentResult> InvokeAsync(GetTableResourceTableRoleAssignmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTableResourceTableRoleAssignmentResult>("azure-native:documentdb/v20241201preview:getTableResourceTableRoleAssignment", args ?? new GetTableResourceTableRoleAssignmentArgs(), options.WithDefaults());
