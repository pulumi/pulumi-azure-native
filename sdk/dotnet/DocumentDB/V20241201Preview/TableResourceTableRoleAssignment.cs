...
namespace Pulumi.AzureNative.DocumentDB.V20241201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20241201preview:TableResourceTableRoleAssignment")]
    public partial class TableResourceTableRoleAssignment : global::Pulumi.CustomResource
    {
        ...
        public TableResourceTableRoleAssignment(string name, TableResourceTableRoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241201preview:TableResourceTableRoleAssignment", name, args ?? new TableResourceTableRoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTableRoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241201preview:TableResourceTableRoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
