...
namespace Pulumi.AzureNative.DocumentDB.V20241201Preview
{
    public static class GetThroughputPool
    {
        ...
        public static Task<GetThroughputPoolResult> InvokeAsync(GetThroughputPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetThroughputPoolResult>("azure-native:documentdb/v20241201preview:getThroughputPool", args ?? new GetThroughputPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the properties of an existing Azure Cosmos DB Throughput Pool
        /// </summary>
        public static Output<GetThroughputPoolResult> Invoke(GetThroughputPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetThroughputPoolResult>("azure-native:documentdb/v20241201preview:getThroughputPool", args ?? new GetThroughputPoolInvokeArgs(), options.WithDefaults());
