...
namespace Pulumi.AzureNative.DocumentDB.V20241201Preview
{
    public static class GetCassandraDataCenter
    {
        ...
        public static Task<GetCassandraDataCenterResult> InvokeAsync(GetCassandraDataCenterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCassandraDataCenterResult>("azure-native:documentdb/v20241201preview:getCassandraDataCenter", args ?? new GetCassandraDataCenterArgs(), options.WithDefaults());
        ...
        public static Output<GetCassandraDataCenterResult> Invoke(GetCassandraDataCenterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCassandraDataCenterResult>("azure-native:documentdb/v20241201preview:getCassandraDataCenter", args ?? new GetCassandraDataCenterInvokeArgs(), options.WithDefaults());
