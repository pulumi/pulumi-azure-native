...
namespace Pulumi.AzureNative.DocumentDB.V20241201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20241201preview:NotebookWorkspace")]
    public partial class NotebookWorkspace : global::Pulumi.CustomResource
    {
        ...
        public NotebookWorkspace(string name, NotebookWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241201preview:NotebookWorkspace", name, args ?? new NotebookWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241201preview:NotebookWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
