...
namespace Pulumi.AzureRM.DocumentDB
{
    public static class GetSqlResourceSqlDatabase
    {
        public static Task<GetSqlResourceSqlDatabaseResult> InvokeAsync(GetSqlResourceSqlDatabaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlResourceSqlDatabaseResult>("azurerm:documentdb:getSqlResourceSqlDatabase", args ?? new GetSqlResourceSqlDatabaseArgs(), options.WithVersion());
    }
    ...
    public sealed class GetSqlResourceSqlDatabaseResult
    {
        ...
        /// </summary>
        public readonly Outputs.SqlDatabaseGetPropertiesResponseResult Properties;
        /// <summary>
        ...
        private GetSqlResourceSqlDatabaseResult(
            ...
            Outputs.SqlDatabaseGetPropertiesResponseResult properties,
