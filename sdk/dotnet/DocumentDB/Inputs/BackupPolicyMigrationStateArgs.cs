...
namespace Pulumi.AzureNative.DocumentDB.Inputs
{
    ...
    public sealed class BackupPolicyMigrationStateArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.BackupPolicyMigrationStatus>? Status { get; set; }

        /// <summary>
        /// Describes the target backup policy type of the backup policy migration.
        /// </summary>
        [Input("targetType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.BackupPolicyType>? TargetType { get; set; }
