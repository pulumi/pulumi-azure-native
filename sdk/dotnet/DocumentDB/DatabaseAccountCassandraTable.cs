...
namespace Pulumi.AzureNextGen.DocumentDB
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb:DatabaseAccountCassandraTable")]
    public partial class DatabaseAccountCassandraTable : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraTable(string name, DatabaseAccountCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb:DatabaseAccountCassandraTable", name, args ?? new DatabaseAccountCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb:DatabaseAccountCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
