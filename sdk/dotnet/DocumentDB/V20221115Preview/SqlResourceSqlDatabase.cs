...
namespace Pulumi.AzureNative.DocumentDB.V20221115Preview
{
    ...
    /// {
    ///     var sqlResourceSqlDatabase = new AzureNative.DocumentDB.V20221115Preview.SqlResourceSqlDatabase("sqlResourceSqlDatabase", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         DatabaseName = "databaseName",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20221115Preview.Inputs.SqlDatabaseResourceArgs
    ///         {
    ///             Id = "databaseName",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20221115preview:SqlResourceSqlDatabase")]
    public partial class SqlResourceSqlDatabase : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
