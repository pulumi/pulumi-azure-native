...
namespace Pulumi.AzureNative.DocumentDB.V20221115Preview
{
    public static class GetTableResourceTable
    {
        ...
        public static Task<GetTableResourceTableResult> InvokeAsync(GetTableResourceTableArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTableResourceTableResult>("azure-native:documentdb/v20221115preview:getTableResourceTable", args ?? new GetTableResourceTableArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the Tables under an existing Azure Cosmos DB database account with the provided name.
        /// </summary>
        public static Output<GetTableResourceTableResult> Invoke(GetTableResourceTableInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTableResourceTableResult>("azure-native:documentdb/v20221115preview:getTableResourceTable", args ?? new GetTableResourceTableInvokeArgs(), options.WithDefaults());
    }
