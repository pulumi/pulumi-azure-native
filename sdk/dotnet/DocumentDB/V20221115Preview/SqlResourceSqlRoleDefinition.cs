...
namespace Pulumi.AzureNative.DocumentDB.V20221115Preview
{
    ...
    /// {
    ///     var sqlResourceSqlRoleDefinition = new AzureNative.DocumentDB.V20221115Preview.SqlResourceSqlRoleDefinition("sqlResourceSqlRoleDefinition", new()
    ///     {
    ...
    ///         Permissions = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20221115Preview.Inputs.PermissionArgs
    ///             {
    ///                 DataActions = new[]
    ///                 {
    ...
    ///         RoleName = "myRoleName",
    ///         Type = AzureNative.DocumentDB.V20221115Preview.RoleDefinitionType.CustomRole,
    ///     });
    /// 
    /// });
    /// 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20221115preview:SqlResourceSqlRoleDefinition")]
    public partial class SqlResourceSqlRoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlRoleDefinition(string name, SqlResourceSqlRoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:SqlResourceSqlRoleDefinition", name, args ?? new SqlResourceSqlRoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlRoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:SqlResourceSqlRoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlResourceSqlRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.DocumentDB.V20221115Preview.RoleDefinitionType>? Type { get; set; }
