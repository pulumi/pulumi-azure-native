...
namespace Pulumi.AzureNative.DocumentDB.V20221115Preview
{
    ...
    /// {
    ///     var mongoDBResourceMongoUserDefinition = new AzureNative.DocumentDB.V20221115Preview.MongoDBResourceMongoUserDefinition("mongoDBResourceMongoUserDefinition", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20221115preview:MongoDBResourceMongoUserDefinition")]
    public partial class MongoDBResourceMongoUserDefinition : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoUserDefinition(string name, MongoDBResourceMongoUserDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:MongoDBResourceMongoUserDefinition", name, args ?? new MongoDBResourceMongoUserDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoUserDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:MongoDBResourceMongoUserDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
