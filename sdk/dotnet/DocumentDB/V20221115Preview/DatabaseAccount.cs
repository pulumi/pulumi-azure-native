...
namespace Pulumi.AzureNative.DocumentDB.V20221115Preview
{
    ...
    /// {
    ///     var databaseAccount = new AzureNative.DocumentDB.V20221115Preview.DatabaseAccount("databaseAccount", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         AnalyticalStorageConfiguration = new AzureNative.DocumentDB.V20221115Preview.Inputs.AnalyticalStorageConfigurationArgs
    ///         {
    ///             SchemaType = "WellDefined",
    ///         },
    ///         ApiProperties = new AzureNative.DocumentDB.V20221115Preview.Inputs.ApiPropertiesArgs
    ///         {
    ///             ServerVersion = "3.2",
    ///         },
    ///         BackupPolicy = new AzureNative.DocumentDB.V20221115Preview.Inputs.PeriodicModeBackupPolicyArgs
    ///         {
    ///             PeriodicModeProperties = new AzureNative.DocumentDB.V20221115Preview.Inputs.PeriodicModePropertiesArgs
    ///             {
    ...
    ///             Type = "Periodic",
    ///         },
    ///         Capacity = new AzureNative.DocumentDB.V20221115Preview.Inputs.CapacityArgs
    ///         {
    ///             TotalThroughputLimit = 2000,
    ///         },
    ///         ConsistencyPolicy = new AzureNative.DocumentDB.V20221115Preview.Inputs.ConsistencyPolicyArgs
    ///         {
    ///             DefaultConsistencyLevel = AzureNative.DocumentDB.V20221115Preview.DefaultConsistencyLevel.BoundedStaleness,
    ///             MaxIntervalInSeconds = 10,
    ///             MaxStalenessPrefix = 200,
    ///         },
    ///         Cors = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20221115Preview.Inputs.CorsPolicyArgs
    ///             {
    ///                 AllowedOrigins = "https://test",
    ///             },
    ///         },
    ///         CreateMode = "Default",
    ///         DatabaseAccountOfferType = AzureNative.DocumentDB.V20221115Preview.DatabaseAccountOfferType.Standard,
    ///         DefaultIdentity = "FirstPartyIdentity",
    ///         EnableAnalyticalStorage = true,
    ///         EnableBurstCapacity = true,
    ///         EnableFreeTier = false,
    ///         EnableMaterializedViews = false,
    ///         Identity = new AzureNative.DocumentDB.V20221115Preview.Inputs.ManagedServiceIdentityArgs
    ///         {
    ///             Type = AzureNative.DocumentDB.V20221115Preview.ResourceIdentityType.SystemAssigned_UserAssigned,
    ...
    ///         IpRules = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20221115Preview.Inputs.IpAddressOrRangeArgs
    ///             {
    ...
    ///         Locations = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20221115Preview.Inputs.LocationArgs
    ///             {
    ///                 FailoverPriority = 0,
    ...
    ///         NetworkAclBypass = AzureNative.DocumentDB.V20221115Preview.NetworkAclBypass.AzureServices,
    ...
    ///         {
    ///             new AzureNative.DocumentDB.V20221115Preview.Inputs.VirtualNetworkRuleArgs
    ///             {
    ...
    ///             ServerVersion = "3.2",
    ///         },
    ///         BackupPolicy = new AzureNative.DocumentDB.V20221115Preview.Inputs.ContinuousModeBackupPolicyArgs
    ///         {
    ///             ContinuousModeProperties = new AzureNative.DocumentDB.V20221115Preview.Inputs.ContinuousModePropertiesArgs
    ///             {
    ...
    ///         ResourceGroupName = "rg1",
    ///         RestoreParameters = new AzureNative.DocumentDB.V20221115Preview.Inputs.RestoreParametersArgs
    ///         {
    ///             DatabasesToRestore = new[]
    ///             {
    ///                 new AzureNative.DocumentDB.V20221115Preview.Inputs.DatabaseRestoreResourceArgs
    ///                 {
    ///                     CollectionNames = new[]
    ///                     {
    ///                         "collection1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20221115preview:DatabaseAccount")]
    public partial class DatabaseAccount : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20221115Preview.ConnectorOffer>? ConnectorOffer { get; set; }
        ...
        public Input<Pulumi.AzureNative.DocumentDB.V20221115Preview.DatabaseAccountOfferType> DatabaseAccountOfferType { get; set; } = null!;
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20221115Preview.DatabaseAccountKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20221115Preview.MinimalTlsVersion>? MinimalTlsVersion { get; set; }

        /// <summary>
        /// Indicates what services are allowed to bypass firewall checks.
        /// </summary>
        [Input("networkAclBypass")]
        public Input<Pulumi.AzureNative.DocumentDB.V20221115Preview.NetworkAclBypass>? NetworkAclBypass { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20221115Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
