...
namespace Pulumi.AzureNative.DocumentDB.V20221115Preview
{
    ...
    /// {
    ///     var cassandraResourceCassandraTable = new AzureNative.DocumentDB.V20221115Preview.CassandraResourceCassandraTable("cassandraResourceCassandraTable", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         KeyspaceName = "keyspaceName",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20221115Preview.Inputs.CassandraTableResourceArgs
    ///         {
    ///             AnalyticalStorageTtl = 500,
    ///             DefaultTtl = 100,
    ///             Id = "tableName",
    ///             Schema = new AzureNative.DocumentDB.V20221115Preview.Inputs.CassandraSchemaArgs
    ///             {
    ///                 ClusterKeys = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20221115Preview.Inputs.ClusterKeyArgs
    ///                     {
    ///                         Name = "columnA",
    ///                         OrderBy = "Asc",
    ///                     },
    ...
    ///                 Columns = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20221115Preview.Inputs.ColumnArgs
    ///                     {
    ///                         Name = "columnA",
    ///                         Type = "Ascii",
    ///                     },
    ...
    ///                 PartitionKeys = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20221115Preview.Inputs.CassandraPartitionKeyArgs
    ///                     {
    ///                         Name = "columnA",
    ///                     },
    ///                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20221115preview:CassandraResourceCassandraTable")]
    public partial class CassandraResourceCassandraTable : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraTable(string name, CassandraResourceCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:CassandraResourceCassandraTable", name, args ?? new CassandraResourceCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:CassandraResourceCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
