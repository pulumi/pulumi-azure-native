...
namespace Pulumi.AzureNative.DocumentDB.V20221115Preview
{
    public static class GetGraphResourceGraph
    {
        ...
        public static Task<GetGraphResourceGraphResult> InvokeAsync(GetGraphResourceGraphArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGraphResourceGraphResult>("azure-native:documentdb/v20221115preview:getGraphResourceGraph", args ?? new GetGraphResourceGraphArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the Graph resource under an existing Azure Cosmos DB database account with the provided name.
        /// </summary>
        public static Output<GetGraphResourceGraphResult> Invoke(GetGraphResourceGraphInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGraphResourceGraphResult>("azure-native:documentdb/v20221115preview:getGraphResourceGraph", args ?? new GetGraphResourceGraphInvokeArgs(), options.WithDefaults());
    }
    ...
    [OutputType]
    public sealed class GetGraphResourceGraphResult
    {
        /// <summary>
        ...
        public readonly Outputs.GraphResourceGetPropertiesResponseOptions? Options;
        public readonly Outputs.GraphResourceGetPropertiesResponseResource? Resource;
        /// <summary>
        ...
        private GetGraphResourceGraphResult(
            ...
            Outputs.GraphResourceGetPropertiesResponseOptions? options,
