...
namespace Pulumi.AzureNative.DocumentDB.V20221115Preview
{
    ...
    /// {
    ///     var sqlResourceSqlContainer = new AzureNative.DocumentDB.V20221115Preview.SqlResourceSqlContainer("sqlResourceSqlContainer", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20221115Preview.Inputs.SqlContainerResourceArgs
    ///         {
    ///             ClientEncryptionPolicy = new AzureNative.DocumentDB.V20221115Preview.Inputs.ClientEncryptionPolicyArgs
    ///             {
    ///                 IncludedPaths = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20221115Preview.Inputs.ClientEncryptionIncludedPathArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20221115preview:SqlResourceSqlContainer")]
    public partial class SqlResourceSqlContainer : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlContainer(string name, SqlResourceSqlContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:SqlResourceSqlContainer", name, args ?? new SqlResourceSqlContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115preview:SqlResourceSqlContainer", name, null, MakeResourceOptions(options, id))
        {
        }
