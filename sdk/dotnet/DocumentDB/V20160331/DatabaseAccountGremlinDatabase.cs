...
namespace Pulumi.AzureNative.DocumentDB.V20160331
{
    ...
    /// {
    ///     var databaseAccountGremlinDatabase = new AzureNative.DocumentDB.V20160331.DatabaseAccountGremlinDatabase("databaseAccountGremlinDatabase", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         DatabaseName = "databaseName",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20160331.Inputs.GremlinDatabaseResourceArgs
    ///         {
    ///             Id = "databaseName",
    ///         },
    ...
    [AzureNativeResourceType("azure-native:documentdb/v20160331:DatabaseAccountGremlinDatabase")]
    public partial class DatabaseAccountGremlinDatabase : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccountGremlinDatabase(string name, DatabaseAccountGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20160331:DatabaseAccountGremlinDatabase", name, args ?? new DatabaseAccountGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20160331:DatabaseAccountGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
