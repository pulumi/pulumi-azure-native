...
namespace Pulumi.AzureRM.DocumentDB.V20160331
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountGremlinDatabase = new AzureRM.DocumentDB.V20160331.DatabaseAccountGremlinDatabase("databaseAccountGremlinDatabase", new AzureRM.DocumentDB.V20160331.DatabaseAccountGremlinDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20160331.Inputs.GremlinDatabaseResourceArgs
    ///             {
    ///                 Id = "databaseName",
    ///             },
    ...
    public partial class DatabaseAccountGremlinDatabase : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountGremlinDatabase(string name, DatabaseAccountGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160331:DatabaseAccountGremlinDatabase", name, args ?? new DatabaseAccountGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160331:DatabaseAccountGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
