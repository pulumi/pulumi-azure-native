...
namespace Pulumi.AzureRM.DocumentDB.V20160331
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountSqlContainer = new AzureRM.DocumentDB.V20160331.DatabaseAccountSqlContainer("databaseAccountSqlContainer", new AzureRM.DocumentDB.V20160331.DatabaseAccountSqlContainerArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             ContainerName = "containerName",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20160331.Inputs.SqlContainerResourceArgs
    ///             {
    ...
    public partial class DatabaseAccountSqlContainer : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountSqlContainer(string name, DatabaseAccountSqlContainerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160331:DatabaseAccountSqlContainer", name, args ?? new DatabaseAccountSqlContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountSqlContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160331:DatabaseAccountSqlContainer", name, null, MakeResourceOptions(options, id))
        {
        }
