...
namespace Pulumi.AzureNative.DocumentDB.V20160331
{
    ...
    public static class GetDatabaseAccountSqlDatabase
    {
        ...
        public static Task<GetDatabaseAccountSqlDatabaseResult> InvokeAsync(GetDatabaseAccountSqlDatabaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountSqlDatabaseResult>("azure-native:documentdb/v20160331:getDatabaseAccountSqlDatabase", args ?? new GetDatabaseAccountSqlDatabaseArgs(), options.WithDefaults());
        ...
        public static Output<GetDatabaseAccountSqlDatabaseResult> Invoke(GetDatabaseAccountSqlDatabaseInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountSqlDatabaseResult>("azure-native:documentdb/v20160331:getDatabaseAccountSqlDatabase", args ?? new GetDatabaseAccountSqlDatabaseInvokeArgs(), options.WithDefaults());
    }
