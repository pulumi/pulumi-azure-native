...
namespace Pulumi.AzureNative.DocumentDB.V20160331
{
    ...
    /// {
    ///     var databaseAccountMongoDBDatabase = new AzureNative.DocumentDB.V20160331.DatabaseAccountMongoDBDatabase("databaseAccountMongoDBDatabase", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         DatabaseName = "databaseName",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20160331.Inputs.MongoDBDatabaseResourceArgs
    ///         {
    ...
    public partial class DatabaseAccountMongoDBDatabase : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccountMongoDBDatabase(string name, DatabaseAccountMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20160331:DatabaseAccountMongoDBDatabase", name, args ?? new DatabaseAccountMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20160331:DatabaseAccountMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
