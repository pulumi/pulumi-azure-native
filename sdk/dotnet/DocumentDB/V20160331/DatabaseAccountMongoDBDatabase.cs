...
namespace Pulumi.AzureRM.DocumentDB.V20160331
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountMongoDBDatabase = new AzureRM.DocumentDB.V20160331.DatabaseAccountMongoDBDatabase("databaseAccountMongoDBDatabase", new AzureRM.DocumentDB.V20160331.DatabaseAccountMongoDBDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20160331.Inputs.MongoDBDatabaseResourceArgs
    ///             {
    ...
    public partial class DatabaseAccountMongoDBDatabase : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountMongoDBDatabase(string name, DatabaseAccountMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160331:DatabaseAccountMongoDBDatabase", name, args ?? new DatabaseAccountMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160331:DatabaseAccountMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
