...
namespace Pulumi.AzureNextGen.DocumentDB.V20160331
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20160331:DatabaseAccountCassandraKeyspace")]
    public partial class DatabaseAccountCassandraKeyspace : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraKeyspace(string name, DatabaseAccountCassandraKeyspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20160331:DatabaseAccountCassandraKeyspace", name, args ?? new DatabaseAccountCassandraKeyspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraKeyspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20160331:DatabaseAccountCassandraKeyspace", name, null, MakeResourceOptions(options, id))
        {
        }
