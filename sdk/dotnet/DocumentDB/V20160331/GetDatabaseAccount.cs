...
namespace Pulumi.AzureNextGen.DocumentDB.V20160331
{
    public static class GetDatabaseAccount
    {
        public static Task<GetDatabaseAccountResult> InvokeAsync(GetDatabaseAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountResult>("azure-nextgen:documentdb/v20160331:getDatabaseAccount", args ?? new GetDatabaseAccountArgs(), options.WithVersion());
    }
