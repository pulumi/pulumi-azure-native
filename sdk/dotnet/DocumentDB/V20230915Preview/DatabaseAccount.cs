...
namespace Pulumi.AzureNative.DocumentDB.V20230915Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230915preview:DatabaseAccount")]
    public partial class DatabaseAccount : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915preview:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915preview:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915Preview.ConnectorOffer>? ConnectorOffer { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915Preview.CustomerManagedKeyStatus>? CustomerManagedKeyStatus { get; set; }

        /// <summary>
        /// The offer type for the database
        /// </summary>
        [Input("databaseAccountOfferType", required: true)]
        public Input<Pulumi.AzureNative.DocumentDB.V20230915Preview.DatabaseAccountOfferType> DatabaseAccountOfferType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915Preview.DefaultPriorityLevel>? DefaultPriorityLevel { get; set; }
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915Preview.DatabaseAccountKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915Preview.MinimalTlsVersion>? MinimalTlsVersion { get; set; }

        /// <summary>
        /// Indicates what services are allowed to bypass firewall checks.
        /// </summary>
        [Input("networkAclBypass")]
        public Input<Pulumi.AzureNative.DocumentDB.V20230915Preview.NetworkAclBypass>? NetworkAclBypass { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
