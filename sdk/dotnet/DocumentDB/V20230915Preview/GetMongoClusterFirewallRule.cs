...
namespace Pulumi.AzureNative.DocumentDB.V20230915Preview
{
    public static class GetMongoClusterFirewallRule
    {
        ...
        public static Task<GetMongoClusterFirewallRuleResult> InvokeAsync(GetMongoClusterFirewallRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMongoClusterFirewallRuleResult>("azure-native:documentdb/v20230915preview:getMongoClusterFirewallRule", args ?? new GetMongoClusterFirewallRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetMongoClusterFirewallRuleResult> Invoke(GetMongoClusterFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMongoClusterFirewallRuleResult>("azure-native:documentdb/v20230915preview:getMongoClusterFirewallRule", args ?? new GetMongoClusterFirewallRuleInvokeArgs(), options.WithDefaults());
