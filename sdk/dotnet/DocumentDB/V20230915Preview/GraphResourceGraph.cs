...
namespace Pulumi.AzureNative.DocumentDB.V20230915Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230915preview:GraphResourceGraph")]
    public partial class GraphResourceGraph : global::Pulumi.CustomResource
    {
        ...
        public GraphResourceGraph(string name, GraphResourceGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915preview:GraphResourceGraph", name, args ?? new GraphResourceGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphResourceGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915preview:GraphResourceGraph", name, null, MakeResourceOptions(options, id))
        {
        }
