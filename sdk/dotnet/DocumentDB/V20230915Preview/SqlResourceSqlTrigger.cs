...
namespace Pulumi.AzureNative.DocumentDB.V20230915Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230915preview:SqlResourceSqlTrigger")]
    public partial class SqlResourceSqlTrigger : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915preview:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915preview:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
