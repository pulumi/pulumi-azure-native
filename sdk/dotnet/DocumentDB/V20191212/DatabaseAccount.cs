...
namespace Pulumi.AzureNextGen.DocumentDB.V20191212
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20191212:DatabaseAccount")]
    public partial class DatabaseAccount : Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20191212:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20191212:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
