...
namespace Pulumi.AzureRM.DocumentDB.V20191212
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cassandraResourceCassandraKeyspace = new AzureRM.DocumentDB.V20191212.CassandraResourceCassandraKeyspace("cassandraResourceCassandraKeyspace", new AzureRM.DocumentDB.V20191212.CassandraResourceCassandraKeyspaceArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             KeyspaceName = "keyspaceName",
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20191212.Inputs.CassandraKeyspaceResourceArgs
    ///             {
    ///                 Id = "keyspaceName",
    ///             },
    ...
    public partial class CassandraResourceCassandraKeyspace : Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraKeyspace(string name, CassandraResourceCassandraKeyspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:CassandraResourceCassandraKeyspace", name, args ?? new CassandraResourceCassandraKeyspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraKeyspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:CassandraResourceCassandraKeyspace", name, null, MakeResourceOptions(options, id))
        {
        }
