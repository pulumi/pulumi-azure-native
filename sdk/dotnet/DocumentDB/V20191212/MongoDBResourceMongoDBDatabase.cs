...
namespace Pulumi.AzureNative.DocumentDB.V20191212
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20191212:MongoDBResourceMongoDBDatabase")]
    public partial class MongoDBResourceMongoDBDatabase : Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBDatabase(string name, MongoDBResourceMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20191212:MongoDBResourceMongoDBDatabase", name, args ?? new MongoDBResourceMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20191212:MongoDBResourceMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
