...
namespace Pulumi.AzureRM.DocumentDB.V20191212
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlResourceSqlTrigger = new AzureRM.DocumentDB.V20191212.SqlResourceSqlTrigger("sqlResourceSqlTrigger", new AzureRM.DocumentDB.V20191212.SqlResourceSqlTriggerArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             ContainerName = "containerName",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20191212.Inputs.SqlTriggerResourceArgs
    ///             {
    ///                 Body = "body",
    ///                 Id = "triggerName",
    ...
    public partial class SqlResourceSqlTrigger : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
