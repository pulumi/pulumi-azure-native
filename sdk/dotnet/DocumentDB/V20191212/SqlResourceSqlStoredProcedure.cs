...
namespace Pulumi.AzureRM.DocumentDB.V20191212
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlResourceSqlStoredProcedure = new AzureRM.DocumentDB.V20191212.SqlResourceSqlStoredProcedure("sqlResourceSqlStoredProcedure", new AzureRM.DocumentDB.V20191212.SqlResourceSqlStoredProcedureArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             ContainerName = "containerName",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20191212.Inputs.SqlStoredProcedureResourceArgs
    ///             {
    ///                 Body = "body",
    ...
    public partial class SqlResourceSqlStoredProcedure : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlStoredProcedure(string name, SqlResourceSqlStoredProcedureArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:SqlResourceSqlStoredProcedure", name, args ?? new SqlResourceSqlStoredProcedureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlStoredProcedure(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:SqlResourceSqlStoredProcedure", name, null, MakeResourceOptions(options, id))
        {
        }
