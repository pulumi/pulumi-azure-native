...
namespace Pulumi.AzureRM.DocumentDB.V20191212
{
    public static class GetNotebookWorkspace
    {
        public static Task<GetNotebookWorkspaceResult> InvokeAsync(GetNotebookWorkspaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNotebookWorkspaceResult>("azurerm:documentdb/v20191212:getNotebookWorkspace", args ?? new GetNotebookWorkspaceArgs(), options.WithVersion());
    }
