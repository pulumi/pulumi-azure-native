...
namespace Pulumi.AzureRM.DocumentDB.V20191212
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tableResourceTable = new AzureRM.DocumentDB.V20191212.TableResourceTable("tableResourceTable", new AzureRM.DocumentDB.V20191212.TableResourceTableArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20191212.Inputs.TableResourceArgs
    ///             {
    ///                 Id = "tableName",
    ///             },
    ...
    public partial class TableResourceTable : Pulumi.CustomResource
    {
        ...
        public TableResourceTable(string name, TableResourceTableArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:TableResourceTable", name, args ?? new TableResourceTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:TableResourceTable", name, null, MakeResourceOptions(options, id))
        {
        }
