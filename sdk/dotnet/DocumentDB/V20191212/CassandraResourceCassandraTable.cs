...
namespace Pulumi.AzureNative.DocumentDB.V20191212
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20191212:CassandraResourceCassandraTable")]
    public partial class CassandraResourceCassandraTable : Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraTable(string name, CassandraResourceCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20191212:CassandraResourceCassandraTable", name, args ?? new CassandraResourceCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20191212:CassandraResourceCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20150408:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20151106:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20151106:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20160319:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20160319:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20160331:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20160331:CassandraResourceCassandraTable"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20200601preview:CassandraResourceCassandraTable"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210401preview:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210401preview:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210415:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210415:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210515:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210515:CassandraResourceCassandraTable"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210615:CassandraResourceCassandraTable"},
    ...
    public sealed class CassandraResourceCassandraTableArgs : Pulumi.ResourceArgs
    {
        /// <summary>
