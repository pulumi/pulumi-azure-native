...
namespace Pulumi.AzureNextGen.DocumentDB.V20191212
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20191212:CassandraResourceCassandraTable")]
    public partial class CassandraResourceCassandraTable : Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraTable(string name, CassandraResourceCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20191212:CassandraResourceCassandraTable", name, args ?? new CassandraResourceCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20191212:CassandraResourceCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
