...
namespace Pulumi.AzureRM.DocumentDB.V20191212
{
    ...
    ///     public MyStack()
    ///     {
    ///         var notebookWorkspace = new AzureRM.DocumentDB.V20191212.NotebookWorkspace("notebookWorkspace", new AzureRM.DocumentDB.V20191212.NotebookWorkspaceArgs
    ///         {
    ///             AccountName = "ddb1",
    ...
    public partial class NotebookWorkspace : Pulumi.CustomResource
    {
        ...
        public NotebookWorkspace(string name, NotebookWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:NotebookWorkspace", name, args ?? new NotebookWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20191212:NotebookWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
