...
namespace Pulumi.AzureNative.DocumentDB.V20220815
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:documentdb/v20220815:CassandraDataCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:CassandraDataCenter to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20220815:CassandraDataCenter")]
    public partial class CassandraDataCenter : global::Pulumi.CustomResource
    {
        ...
        public CassandraDataCenter(string name, CassandraDataCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815:CassandraDataCenter", name, args ?? new CassandraDataCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraDataCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815:CassandraDataCenter", name, null, MakeResourceOptions(options, id))
        {
        }
