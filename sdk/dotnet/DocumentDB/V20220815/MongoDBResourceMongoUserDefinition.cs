...
namespace Pulumi.AzureNative.DocumentDB.V20220815
{
    ...
    [AzureNativeResourceType("azure-native:documentdb/v20220815:MongoDBResourceMongoUserDefinition")]
    public partial class MongoDBResourceMongoUserDefinition : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoUserDefinition(string name, MongoDBResourceMongoUserDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815:MongoDBResourceMongoUserDefinition", name, args ?? new MongoDBResourceMongoUserDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoUserDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815:MongoDBResourceMongoUserDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
