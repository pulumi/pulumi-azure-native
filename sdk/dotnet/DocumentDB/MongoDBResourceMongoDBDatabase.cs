...
namespace Pulumi.AzureNextGen.DocumentDB
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb:MongoDBResourceMongoDBDatabase")]
    public partial class MongoDBResourceMongoDBDatabase : Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBDatabase(string name, MongoDBResourceMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb:MongoDBResourceMongoDBDatabase", name, args ?? new MongoDBResourceMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb:MongoDBResourceMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
