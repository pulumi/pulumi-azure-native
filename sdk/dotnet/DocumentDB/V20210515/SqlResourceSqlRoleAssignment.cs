...
namespace Pulumi.AzureNative.DocumentDB.V20210515
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:documentdb/v20210515:SqlResourceSqlRoleAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:SqlResourceSqlRoleAssignment to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20210515:SqlResourceSqlRoleAssignment")]
    public partial class SqlResourceSqlRoleAssignment : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlRoleAssignment(string name, SqlResourceSqlRoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210515:SqlResourceSqlRoleAssignment", name, args ?? new SqlResourceSqlRoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlRoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210515:SqlResourceSqlRoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
