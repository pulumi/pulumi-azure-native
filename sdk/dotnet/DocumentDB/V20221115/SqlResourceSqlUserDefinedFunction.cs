...
namespace Pulumi.AzureNative.DocumentDB.V20221115
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:documentdb/v20221115:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20221115:SqlResourceSqlUserDefinedFunction")]
    public partial class SqlResourceSqlUserDefinedFunction : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlUserDefinedFunction(string name, SqlResourceSqlUserDefinedFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115:SqlResourceSqlUserDefinedFunction", name, args ?? new SqlResourceSqlUserDefinedFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlUserDefinedFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115:SqlResourceSqlUserDefinedFunction", name, null, MakeResourceOptions(options, id))
        {
        }
