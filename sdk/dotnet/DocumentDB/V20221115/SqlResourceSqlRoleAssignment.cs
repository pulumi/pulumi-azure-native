...
namespace Pulumi.AzureNative.DocumentDB.V20221115
{
    ...
    [AzureNativeResourceType("azure-native:documentdb/v20221115:SqlResourceSqlRoleAssignment")]
    public partial class SqlResourceSqlRoleAssignment : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlRoleAssignment(string name, SqlResourceSqlRoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115:SqlResourceSqlRoleAssignment", name, args ?? new SqlResourceSqlRoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlRoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115:SqlResourceSqlRoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
