...
namespace Pulumi.AzureNative.DocumentDB.V20221115
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:documentdb/v20221115:GremlinResourceGremlinDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GremlinResourceGremlinDatabase to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20221115:GremlinResourceGremlinDatabase")]
    public partial class GremlinResourceGremlinDatabase : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinDatabase(string name, GremlinResourceGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115:GremlinResourceGremlinDatabase", name, args ?? new GremlinResourceGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20221115:GremlinResourceGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
