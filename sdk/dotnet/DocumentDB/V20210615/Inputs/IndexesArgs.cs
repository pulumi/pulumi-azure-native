...
namespace Pulumi.AzureNative.DocumentDB.V20210615.Inputs
{
    ...
    public sealed class IndexesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20210615.DataType>? DataType { get; set; }

        /// <summary>
        /// Indicates the type of index.
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20210615.IndexKind>? Kind { get; set; }
