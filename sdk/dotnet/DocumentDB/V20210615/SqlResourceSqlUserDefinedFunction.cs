...
namespace Pulumi.AzureNative.DocumentDB.V20210615
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:documentdb/v20210615:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20210615:SqlResourceSqlUserDefinedFunction")]
    public partial class SqlResourceSqlUserDefinedFunction : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlUserDefinedFunction(string name, SqlResourceSqlUserDefinedFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210615:SqlResourceSqlUserDefinedFunction", name, args ?? new SqlResourceSqlUserDefinedFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlUserDefinedFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210615:SqlResourceSqlUserDefinedFunction", name, null, MakeResourceOptions(options, id))
        {
        }
