...
namespace Pulumi.AzureNative.DocumentDB
{
    ...
    /// 
    /// Other available API versions: 2023-04-15, 2024-02-15-preview, 2024-12-01-preview.
    /// </summary>
    ...
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb:Service", name, null, MakeResourceOptions(options, id))
        {
        }
