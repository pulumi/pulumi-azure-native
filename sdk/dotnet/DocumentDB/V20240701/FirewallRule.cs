...
namespace Pulumi.AzureNative.DocumentDB.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240701:FirewallRule")]
    public partial class FirewallRule : global::Pulumi.CustomResource
    {
        ...
        public FirewallRule(string name, FirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240701:FirewallRule", name, args ?? new FirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240701:FirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:documentdb/v20230301preview:FirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:documentdb/v20230315preview:FirewallRule" },
                    new global::Pulumi.Alias { Type = "azure-native:documentdb/v20230915preview:FirewallRule" },
