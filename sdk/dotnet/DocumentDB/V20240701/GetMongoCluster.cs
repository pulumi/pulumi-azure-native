...
namespace Pulumi.AzureNative.DocumentDB.V20240701
{
    public static class GetMongoCluster
    {
        ...
        public static Task<GetMongoClusterResult> InvokeAsync(GetMongoClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMongoClusterResult>("azure-native:documentdb/v20240701:getMongoCluster", args ?? new GetMongoClusterArgs(), options.WithDefaults());
