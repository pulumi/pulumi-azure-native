...
namespace Pulumi.AzureNative.DocumentDB.V20240701
{
    public static class GetFirewallRule
    {
        ...
        public static Task<GetFirewallRuleResult> InvokeAsync(GetFirewallRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallRuleResult>("azure-native:documentdb/v20240701:getFirewallRule", args ?? new GetFirewallRuleArgs(), options.WithDefaults());
