...
namespace Pulumi.AzureNative.DocumentDB.V20230915.Inputs
{
    ...
    public sealed class ConflictResolutionPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915.ConflictResolutionMode>? Mode { get; set; }
