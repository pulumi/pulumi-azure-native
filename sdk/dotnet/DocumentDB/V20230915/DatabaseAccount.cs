...
namespace Pulumi.AzureNative.DocumentDB.V20230915
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230915:DatabaseAccount")]
    public partial class DatabaseAccount : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915.ConnectorOffer>? ConnectorOffer { get; set; }
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915.CreateMode>? CreateMode { get; set; }

        /// <summary>
        /// Indicates the status of the Customer Managed Key feature on the account. In case there are errors, the property provides troubleshooting guidance.
        /// </summary>
        [Input("customerManagedKeyStatus")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915.CustomerManagedKeyStatus>? CustomerManagedKeyStatus { get; set; }

        /// <summary>
        /// The offer type for the database
        /// </summary>
        [Input("databaseAccountOfferType", required: true)]
        public Input<Pulumi.AzureNative.DocumentDB.V20230915.DatabaseAccountOfferType> DatabaseAccountOfferType { get; set; } = null!;
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915.DatabaseAccountKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915.MinimalTlsVersion>? MinimalTlsVersion { get; set; }

        /// <summary>
        /// Indicates what services are allowed to bypass firewall checks.
        /// </summary>
        [Input("networkAclBypass")]
        public Input<Pulumi.AzureNative.DocumentDB.V20230915.NetworkAclBypass>? NetworkAclBypass { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230915.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
