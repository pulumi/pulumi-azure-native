...
namespace Pulumi.AzureNative.DocumentDB.V20230915
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230915:NotebookWorkspace")]
    public partial class NotebookWorkspace : global::Pulumi.CustomResource
    {
        ...
        public NotebookWorkspace(string name, NotebookWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915:NotebookWorkspace", name, args ?? new NotebookWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915:NotebookWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
