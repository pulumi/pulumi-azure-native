...
namespace Pulumi.AzureNative.DocumentDB.V20230915
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230915:GremlinResourceGremlinDatabase")]
    public partial class GremlinResourceGremlinDatabase : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinDatabase(string name, GremlinResourceGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915:GremlinResourceGremlinDatabase", name, args ?? new GremlinResourceGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230915:GremlinResourceGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
