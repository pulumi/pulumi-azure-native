...
namespace Pulumi.AzureNative.DocumentDB.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240601preview:MongoCluster")]
    public partial class MongoCluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("infrastructureVersion")]
        public Output<string> InfrastructureVersion { get; private set; } = null!;
        ...
        /// </summary>
        [Output("replica")]
        public Output<Outputs.ReplicationPropertiesResponse> Replica { get; private set; } = null!;
        ...
        public MongoCluster(string name, MongoClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240601preview:MongoCluster", name, args ?? new MongoClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240601preview:MongoCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MongoClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20240601Preview.CreateMode>? CreateMode { get; set; }
        ...
        private InputList<Union<string, Pulumi.AzureNative.DocumentDB.V20240601Preview.PreviewFeature>>? _previewFeatures;

        /// <summary>
        /// List of private endpoint connections.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.DocumentDB.V20240601Preview.PreviewFeature>> PreviewFeatures
        {
            get => _previewFeatures ?? (_previewFeatures = new InputList<Union<string, Pulumi.AzureNative.DocumentDB.V20240601Preview.PreviewFeature>>());
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20240601Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
