...
namespace Pulumi.AzureNative.DocumentDB.V20230315
{
    ...
    public partial class MongoDBResourceMongoRoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoRoleDefinition(string name, MongoDBResourceMongoRoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition", name, args ?? new MongoDBResourceMongoRoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoRoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MongoDBResourceMongoRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.DocumentDB.V20230315.MongoRoleDefinitionType>? Type { get; set; }
