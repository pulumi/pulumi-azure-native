...
namespace Pulumi.AzureNative.DocumentDB.V20230315
{
    ...
    /// {
    ///     var cassandraDataCenter = new AzureNative.DocumentDB.V20230315.CassandraDataCenter("cassandraDataCenter", new()
    ///     {
    ///         ClusterName = "cassandra-prod",
    ///         DataCenterName = "dc1",
    ///         Properties = new AzureNative.DocumentDB.V20230315.Inputs.DataCenterResourcePropertiesArgs
    ///         {
