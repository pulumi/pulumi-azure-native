...
namespace Pulumi.AzureNative.DocumentDB.V20230315
{
    ...
    /// {
    ///     var cassandraCluster = new AzureNative.DocumentDB.V20230315.CassandraCluster("cassandraCluster", new()
    ///     {
    ///         ClusterName = "cassandra-prod",
    ///         Location = "West US",
    ///         Properties = new AzureNative.DocumentDB.V20230315.Inputs.ClusterResourcePropertiesArgs
    ///         {
    ///             AuthenticationMethod = "Cassandra",
    ///             CassandraVersion = "3.11",
    ///             ClientCertificates = new[]
    ///             {
    ///                 new AzureNative.DocumentDB.V20230315.Inputs.CertificateArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureNative.DocumentDB.V20230315.Inputs.SeedNodeArgs
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20230315:CassandraCluster cassandra-prod /subscriptions/subid/resourceGroups/cassandra-prod-rg/providers/Microsoft.DocumentDB/cassandraClusters/cassandra-prod 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230315:CassandraCluster")]
    public partial class CassandraCluster : global::Pulumi.CustomResource
    {
        ...
        public CassandraCluster(string name, CassandraClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:CassandraCluster", name, args ?? new CassandraClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:CassandraCluster", name, null, MakeResourceOptions(options, id))
        {
        }
