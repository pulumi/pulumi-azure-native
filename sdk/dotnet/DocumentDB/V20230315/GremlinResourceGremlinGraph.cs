...
namespace Pulumi.AzureNative.DocumentDB.V20230315
{
    ...
    /// {
    ///     var gremlinResourceGremlinGraph = new AzureNative.DocumentDB.V20230315.GremlinResourceGremlinGraph("gremlinResourceGremlinGraph", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20230315.Inputs.GremlinGraphResourceArgs
    ///         {
    ///             ConflictResolutionPolicy = new AzureNative.DocumentDB.V20230315.Inputs.ConflictResolutionPolicyArgs
    ///             {
    ...
    ///             DefaultTtl = 100,
    ///             Id = "graphName",
    ///             IndexingPolicy = new AzureNative.DocumentDB.V20230315.Inputs.IndexingPolicyArgs
    ///             {
    ///                 Automatic = true,
    ///                 ExcludedPaths = new[] {},
    ///                 IncludedPaths = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20230315.Inputs.IncludedPathArgs
    ///                     {
    ///                         Indexes = new[]
    ///                         {
    ///                             new AzureNative.DocumentDB.V20230315.Inputs.IndexesArgs
    ///                             {
    ///                                 DataType = "String",
    ///                                 Kind = "Range",
    ///                                 Precision = -1,
    ...
    ///             },
    ///             PartitionKey = new AzureNative.DocumentDB.V20230315.Inputs.ContainerPartitionKeyArgs
    ///             {
    ///                 Kind = "Hash",
    ///                 Paths = new[]
    ///                 {
    ...
    ///                 },
    ///             },
    ///             UniqueKeyPolicy = new AzureNative.DocumentDB.V20230315.Inputs.UniqueKeyPolicyArgs
    ///             {
    ///                 UniqueKeys = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20230315.Inputs.UniqueKeyArgs
    ///                     {
    ///                         Paths = new[]
    ///                         {
    ///                             "/testPath",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20230315:GremlinResourceGremlinGraph graphName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/gremlinDatabases/databaseName/gremlinGraphs/graphName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230315:GremlinResourceGremlinGraph")]
    public partial class GremlinResourceGremlinGraph : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
