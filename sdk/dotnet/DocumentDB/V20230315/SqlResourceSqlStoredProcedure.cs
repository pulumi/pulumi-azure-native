...
namespace Pulumi.AzureNative.DocumentDB.V20230315
{
    ...
    /// {
    ///     var sqlResourceSqlStoredProcedure = new AzureNative.DocumentDB.V20230315.SqlResourceSqlStoredProcedure("sqlResourceSqlStoredProcedure", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         ContainerName = "containerName",
    ///         DatabaseName = "databaseName",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20230315.Inputs.SqlStoredProcedureResourceArgs
    ///         {
    ///             Body = "body",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230315:SqlResourceSqlStoredProcedure")]
    public partial class SqlResourceSqlStoredProcedure : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlStoredProcedure(string name, SqlResourceSqlStoredProcedureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:SqlResourceSqlStoredProcedure", name, args ?? new SqlResourceSqlStoredProcedureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlStoredProcedure(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:SqlResourceSqlStoredProcedure", name, null, MakeResourceOptions(options, id))
        {
        }
