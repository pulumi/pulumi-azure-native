...
namespace Pulumi.AzureNative.DocumentDB.V20230315
{
    ...
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("instanceSize")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230315.ServiceSize>? InstanceSize { get; set; }
        ...
        /// </summary>
        [Input("serviceType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230315.ServiceType>? ServiceType { get; set; }
