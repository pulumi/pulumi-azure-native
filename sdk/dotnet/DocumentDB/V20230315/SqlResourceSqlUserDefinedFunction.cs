...
namespace Pulumi.AzureNative.DocumentDB.V20230315
{
    ...
    /// {
    ///     var sqlResourceSqlUserDefinedFunction = new AzureNative.DocumentDB.V20230315.SqlResourceSqlUserDefinedFunction("sqlResourceSqlUserDefinedFunction", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         ContainerName = "containerName",
    ///         DatabaseName = "databaseName",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20230315.Inputs.SqlUserDefinedFunctionResourceArgs
    ///         {
    ///             Body = "body",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230315:SqlResourceSqlUserDefinedFunction")]
    public partial class SqlResourceSqlUserDefinedFunction : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlUserDefinedFunction(string name, SqlResourceSqlUserDefinedFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:SqlResourceSqlUserDefinedFunction", name, args ?? new SqlResourceSqlUserDefinedFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlUserDefinedFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:SqlResourceSqlUserDefinedFunction", name, null, MakeResourceOptions(options, id))
        {
        }
