...
namespace Pulumi.AzureNative.DocumentDB.V20230315
{
    ...
    /// {
    ///     var cassandraResourceCassandraTable = new AzureNative.DocumentDB.V20230315.CassandraResourceCassandraTable("cassandraResourceCassandraTable", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         KeyspaceName = "keyspaceName",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20230315.Inputs.CassandraTableResourceArgs
    ///         {
    ///             DefaultTtl = 100,
    ///             Id = "tableName",
    ///             Schema = new AzureNative.DocumentDB.V20230315.Inputs.CassandraSchemaArgs
    ///             {
    ///                 ClusterKeys = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20230315.Inputs.ClusterKeyArgs
    ///                     {
    ///                         Name = "columnA",
    ///                         OrderBy = "Asc",
    ///                     },
    ...
    ///                 Columns = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20230315.Inputs.ColumnArgs
    ///                     {
    ///                         Name = "columnA",
    ///                         Type = "Ascii",
    ///                     },
    ...
    ///                 PartitionKeys = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20230315.Inputs.CassandraPartitionKeyArgs
    ///                     {
    ///                         Name = "columnA",
    ///                     },
    ///                 },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20230315:CassandraResourceCassandraTable tableName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/cassandraKeyspaces/keyspaceName/cassandraTables/tableName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230315:CassandraResourceCassandraTable")]
    public partial class CassandraResourceCassandraTable : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraTable(string name, CassandraResourceCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:CassandraResourceCassandraTable", name, args ?? new CassandraResourceCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:CassandraResourceCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
