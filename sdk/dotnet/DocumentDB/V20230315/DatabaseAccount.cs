...
namespace Pulumi.AzureNative.DocumentDB.V20230315
{
    ...
    /// {
    ///     var databaseAccount = new AzureNative.DocumentDB.V20230315.DatabaseAccount("databaseAccount", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         {
    ///             DefaultConsistencyLevel = AzureNative.DocumentDB.V20230315.DefaultConsistencyLevel.BoundedStaleness,
    ///             MaxIntervalInSeconds = 10,
    ///             MaxStalenessPrefix = 200,
    ///         },
    ///         Cors = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20230315.Inputs.CorsPolicyArgs
    ///             {
    ...
    ///         Identity = new AzureNative.DocumentDB.V20230315.Inputs.ManagedServiceIdentityArgs
    ///         {
    ///             Type = AzureNative.DocumentDB.V20230315.ResourceIdentityType.SystemAssigned_UserAssigned,
    ...
    ///         IpRules = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20230315.Inputs.IpAddressOrRangeArgs
    ///             {
    ...
    ///         NetworkAclBypass = AzureNative.DocumentDB.V20230315.NetworkAclBypass.AzureServices,
    ...
    ///         {
    ///             new AzureNative.DocumentDB.V20230315.Inputs.VirtualNetworkRuleArgs
    ///             {
    ...
    ///             ServerVersion = "3.2",
    ///         },
    ///         BackupPolicy = new AzureNative.DocumentDB.V20230315.Inputs.ContinuousModeBackupPolicyArgs
    ///         {
    ///             Type = "Continuous",
    ///         },
    ///         ConsistencyPolicy = new AzureNative.DocumentDB.V20230315.Inputs.ConsistencyPolicyArgs
    ...
    ///         ResourceGroupName = "rg1",
    ///         RestoreParameters = new AzureNative.DocumentDB.V20230315.Inputs.RestoreParametersArgs
    ///         {
    ///             DatabasesToRestore = new[]
    ///             {
    ///                 new AzureNative.DocumentDB.V20230315.Inputs.DatabaseRestoreResourceArgs
    ///                 {
    ///                     CollectionNames = new[]
    ///                     {
    ///                         "collection1",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20230315:DatabaseAccount ddb1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230315:DatabaseAccount")]
    public partial class DatabaseAccount : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230315.ConnectorOffer>? ConnectorOffer { get; set; }
        ...
        /// </summary>
        [Input("createMode")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230315.CreateMode>? CreateMode { get; set; }

        /// <summary>
        /// The offer type for the database
        /// </summary>
        [Input("databaseAccountOfferType", required: true)]
        public Input<Pulumi.AzureNative.DocumentDB.V20230315.DatabaseAccountOfferType> DatabaseAccountOfferType { get; set; } = null!;
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230315.DatabaseAccountKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230315.MinimalTlsVersion>? MinimalTlsVersion { get; set; }

        /// <summary>
        /// Indicates what services are allowed to bypass firewall checks.
        /// </summary>
        [Input("networkAclBypass")]
        public Input<Pulumi.AzureNative.DocumentDB.V20230315.NetworkAclBypass>? NetworkAclBypass { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20230315.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
