...
namespace Pulumi.AzureRM.DocumentDB
{
    ...
    public partial class DatabaseAccountMongodbDatabase : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MongoDBDatabaseGetPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public DatabaseAccountMongodbDatabase(string name, DatabaseAccountMongodbDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb:DatabaseAccountMongodbDatabase", name, args ?? new DatabaseAccountMongodbDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountMongodbDatabase(string name, Input<string> id, DatabaseAccountMongodbDatabaseState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:documentdb:DatabaseAccountMongodbDatabase", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseAccountMongodbDatabase Get(string name, Input<string> id, DatabaseAccountMongodbDatabaseState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseAccountMongodbDatabase(name, id, state, options);
        }
    }
    ...
    public sealed class DatabaseAccountMongodbDatabaseState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The location of the resource group to which the resource belongs.
        /// </summary>
        ...
        /// </summary>
        [Input("properties", required: true)]
        public Input<Inputs.MongoDBDatabaseGetPropertiesResponseGetArgs> Properties { get; set; } = null!;
        ...
        public DatabaseAccountMongodbDatabaseState()
        {
        }
    }
}
