...
namespace Pulumi.AzureNative.DocumentDB.V20220515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20220515preview:CassandraResourceCassandraTable")]
    public partial class CassandraResourceCassandraTable : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraTable(string name, CassandraResourceCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220515preview:CassandraResourceCassandraTable", name, args ?? new CassandraResourceCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220515preview:CassandraResourceCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
