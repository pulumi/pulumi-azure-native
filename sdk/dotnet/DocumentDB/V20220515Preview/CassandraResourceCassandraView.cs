...
namespace Pulumi.AzureNative.DocumentDB.V20220515Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:documentdb/v20220515preview:CassandraResourceCassandraView is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:CassandraResourceCassandraView to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20220515preview:CassandraResourceCassandraView")]
    public partial class CassandraResourceCassandraView : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraView(string name, CassandraResourceCassandraViewArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220515preview:CassandraResourceCassandraView", name, args ?? new CassandraResourceCassandraViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraView(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220515preview:CassandraResourceCassandraView", name, null, MakeResourceOptions(options, id))
        {
        }
