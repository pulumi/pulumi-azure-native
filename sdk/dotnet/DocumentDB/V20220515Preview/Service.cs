...
namespace Pulumi.AzureNative.DocumentDB.V20220515Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:documentdb/v20220515preview:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:Service to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20220515preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220515preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220515preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("instanceSize")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20220515Preview.ServiceSize>? InstanceSize { get; set; }
        ...
        /// </summary>
        [Input("serviceType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20220515Preview.ServiceType>? ServiceType { get; set; }
