...
namespace Pulumi.AzureNative.DocumentDB.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240901preview:SqlResourceSqlTrigger")]
    public partial class SqlResourceSqlTrigger : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
