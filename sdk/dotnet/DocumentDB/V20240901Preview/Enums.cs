...
namespace Pulumi.AzureNative.DocumentDB.V20240901Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct AutoReplicate : IEquatable<AutoReplicate>
    {
        private readonly string _value;

        private AutoReplicate(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static AutoReplicate None { get; } = new AutoReplicate("None");
        public static AutoReplicate SystemKeyspaces { get; } = new AutoReplicate("SystemKeyspaces");
        public static AutoReplicate AllKeyspaces { get; } = new AutoReplicate("AllKeyspaces");

        public static bool operator ==(AutoReplicate left, AutoReplicate right) => left.Equals(right);
        public static bool operator !=(AutoReplicate left, AutoReplicate right) => !left.Equals(right);

        public static explicit operator string(AutoReplicate value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is AutoReplicate other && Equals(other);
        public bool Equals(AutoReplicate other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct CapacityMode : IEquatable<CapacityMode>
    {
        private readonly string _value;
        ...
        public static CapacityMode None { get; } = new CapacityMode("None");
        public static CapacityMode Provisioned { get; } = new CapacityMode("Provisioned");
        public static CapacityMode Serverless { get; } = new CapacityMode("Serverless");

        public static bool operator ==(CapacityMode left, CapacityMode right) => left.Equals(right);
        public static bool operator !=(CapacityMode left, CapacityMode right) => !left.Equals(right);

        public static explicit operator string(CapacityMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is CapacityMode other && Equals(other);
        public bool Equals(CapacityMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    /// </summary>
    [EnumType]
    public readonly struct ScheduledEventStrategy : IEquatable<ScheduledEventStrategy>
    {
        private readonly string _value;

        private ScheduledEventStrategy(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static ScheduledEventStrategy Ignore { get; } = new ScheduledEventStrategy("Ignore");
        public static ScheduledEventStrategy StopAny { get; } = new ScheduledEventStrategy("StopAny");
        public static ScheduledEventStrategy StopByRack { get; } = new ScheduledEventStrategy("StopByRack");

        public static bool operator ==(ScheduledEventStrategy left, ScheduledEventStrategy right) => left.Equals(right);
        public static bool operator !=(ScheduledEventStrategy left, ScheduledEventStrategy right) => !left.Equals(right);

        public static explicit operator string(ScheduledEventStrategy value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ScheduledEventStrategy other && Equals(other);
        public bool Equals(ScheduledEventStrategy other) => string.Equals(_value, other._value, StringComparison.Ordinal);
