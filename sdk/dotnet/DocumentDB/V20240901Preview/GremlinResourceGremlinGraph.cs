...
namespace Pulumi.AzureNative.DocumentDB.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240901preview:GremlinResourceGremlinGraph")]
    public partial class GremlinResourceGremlinGraph : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
