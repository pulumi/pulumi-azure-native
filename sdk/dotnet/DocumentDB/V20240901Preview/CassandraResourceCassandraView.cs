...
namespace Pulumi.AzureNative.DocumentDB.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240901preview:CassandraResourceCassandraView")]
    public partial class CassandraResourceCassandraView : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraView(string name, CassandraResourceCassandraViewArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:CassandraResourceCassandraView", name, args ?? new CassandraResourceCassandraViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraView(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:CassandraResourceCassandraView", name, null, MakeResourceOptions(options, id))
        {
        }
