...
namespace Pulumi.AzureNative.DocumentDB.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240901preview:SqlResourceSqlDatabase")]
    public partial class SqlResourceSqlDatabase : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
