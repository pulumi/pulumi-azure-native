...
namespace Pulumi.AzureNative.DocumentDB.V20240901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240901preview:SqlResourceSqlStoredProcedure")]
    public partial class SqlResourceSqlStoredProcedure : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlStoredProcedure(string name, SqlResourceSqlStoredProcedureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:SqlResourceSqlStoredProcedure", name, args ?? new SqlResourceSqlStoredProcedureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlStoredProcedure(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240901preview:SqlResourceSqlStoredProcedure", name, null, MakeResourceOptions(options, id))
        {
        }
