...
namespace Pulumi.AzureRM.DocumentDB.Preview
{
    ...
    public partial class GremlinResourceGremlinGraph : Pulumi.CustomResource
    {
        ...
        [Output("options")]
        public Output<Outputs.GremlinGraphGetPropertiesResponseOptionsResult?> Options { get; private set; } = null!;
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/preview:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/preview:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
