...
namespace Pulumi.AzureRM.DocumentDB.Preview
{
    /// <summary>
    ...
    public partial class MongoDBResourceMongoDBCollection : Pulumi.CustomResource
    {
        ...
        [Output("options")]
        public Output<Outputs.MongoDBCollectionGetPropertiesResponseOptionsResult?> Options { get; private set; } = null!;

        [Output("resource")]
        public Output<Outputs.MongoDBCollectionGetPropertiesResponseResourceResult?> Resource { get; private set; } = null!;
        ...
        public MongoDBResourceMongoDBCollection(string name, MongoDBResourceMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/preview:MongoDBResourceMongoDBCollection", name, args ?? new MongoDBResourceMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/preview:MongoDBResourceMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:documentdb/v20200301:MongoDBResourceMongoDBCollection"},
