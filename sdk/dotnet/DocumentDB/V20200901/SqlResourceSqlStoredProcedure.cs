...
namespace Pulumi.AzureNextGen.DocumentDB.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20200901:SqlResourceSqlStoredProcedure")]
    public partial class SqlResourceSqlStoredProcedure : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlStoredProcedure(string name, SqlResourceSqlStoredProcedureArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200901:SqlResourceSqlStoredProcedure", name, args ?? new SqlResourceSqlStoredProcedureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlStoredProcedure(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200901:SqlResourceSqlStoredProcedure", name, null, MakeResourceOptions(options, id))
        {
        }
