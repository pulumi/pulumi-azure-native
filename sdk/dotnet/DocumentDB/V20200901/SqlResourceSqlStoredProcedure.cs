...
azure-native:documentdb/v20200901:SqlResourceSqlStoredProcedure is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlStoredProcedure to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20200901:SqlResourceSqlStoredProcedure")]
    public partial class SqlResourceSqlStoredProcedure : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlStoredProcedure(string name, SqlResourceSqlStoredProcedureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200901:SqlResourceSqlStoredProcedure", name, args ?? new SqlResourceSqlStoredProcedureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlStoredProcedure(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200901:SqlResourceSqlStoredProcedure", name, null, MakeResourceOptions(options, id))
        {
        }
