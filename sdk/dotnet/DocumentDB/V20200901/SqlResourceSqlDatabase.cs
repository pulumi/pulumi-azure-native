...
namespace Pulumi.AzureNative.DocumentDB.V20200901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20200901:SqlResourceSqlDatabase")]
    public partial class SqlResourceSqlDatabase : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200901:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200901:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20150408:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20151106:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20151106:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20160319:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20160319:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20160331:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20160331:SqlResourceSqlDatabase"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210115:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210301preview:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210301preview:SqlResourceSqlDatabase"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210515:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210615:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210615:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210701preview:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210701preview:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20211015:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20211015:SqlResourceSqlDatabase"},
                },
            };
