...
namespace Pulumi.AzureNextGen.DocumentDB.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20200901:SqlResourceSqlTrigger")]
    public partial class SqlResourceSqlTrigger : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200901:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200901:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
