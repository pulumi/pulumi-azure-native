...
namespace Pulumi.AzureNative.DocumentDB.V20200901
{
    ...
    /// {
    ///     var databaseAccount = new AzureNative.DocumentDB.V20200901.DatabaseAccount("databaseAccount", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         ApiProperties = new AzureNative.DocumentDB.V20200901.Inputs.ApiPropertiesArgs
    ///         {
    ///             ServerVersion = "3.2",
    ///         },
    ///         BackupPolicy = new AzureNative.DocumentDB.V20200901.Inputs.PeriodicModeBackupPolicyArgs
    ///         {
    ///             PeriodicModeProperties = new AzureNative.DocumentDB.V20200901.Inputs.PeriodicModePropertiesArgs
    ///             {
    ...
    ///             Type = "Periodic",
    ///         },
    ///         ConsistencyPolicy = new AzureNative.DocumentDB.V20200901.Inputs.ConsistencyPolicyArgs
    ///         {
    ///             DefaultConsistencyLevel = AzureNative.DocumentDB.V20200901.DefaultConsistencyLevel.BoundedStaleness,
    ///             MaxIntervalInSeconds = 10,
    ///             MaxStalenessPrefix = 200,
    ///         },
    ///         Cors = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20200901.Inputs.CorsPolicyArgs
    ///             {
    ///                 AllowedOrigins = "https://test",
    ///             },
    ///         },
    ///         DatabaseAccountOfferType = AzureNative.DocumentDB.V20200901.DatabaseAccountOfferType.Standard,
    ///         EnableAnalyticalStorage = true,
    ///         EnableFreeTier = false,
    ///         IpRules = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20200901.Inputs.IpAddressOrRangeArgs
    ///             {
    ...
    ///         Locations = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20200901.Inputs.LocationArgs
    ///             {
    ///                 FailoverPriority = 0,
    ...
    ///         {
    ///             new AzureNative.DocumentDB.V20200901.Inputs.VirtualNetworkRuleArgs
    ///             {
    ...
    [AzureNativeResourceType("azure-native:documentdb/v20200901:DatabaseAccount")]
    public partial class DatabaseAccount : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200901:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200901:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20200901.ConnectorOffer>? ConnectorOffer { get; set; }
        ...
        public Input<Pulumi.AzureNative.DocumentDB.V20200901.DatabaseAccountOfferType> DatabaseAccountOfferType { get; set; } = null!;
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20200901.DatabaseAccountKind>? Kind { get; set; }
