...
namespace Pulumi.AzureNative.DocumentDB.V20200901
{
    public static class GetNotebookWorkspace
    {
        ...
        public static Task<GetNotebookWorkspaceResult> InvokeAsync(GetNotebookWorkspaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNotebookWorkspaceResult>("azure-native:documentdb/v20200901:getNotebookWorkspace", args ?? new GetNotebookWorkspaceArgs(), options.WithVersion());

        /// <summary>
        /// A notebook workspace resource
        /// </summary>
        public static Output<GetNotebookWorkspaceResult> Invoke(GetNotebookWorkspaceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNotebookWorkspaceResult>("azure-native:documentdb/v20200901:getNotebookWorkspace", args ?? new GetNotebookWorkspaceInvokeArgs(), options.WithVersion());
    }
