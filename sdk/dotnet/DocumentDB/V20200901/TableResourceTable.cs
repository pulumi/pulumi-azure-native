...
namespace Pulumi.AzureNative.DocumentDB.V20200901
{
    ...
    public partial class TableResourceTable : Pulumi.CustomResource
    {
        ...
        public TableResourceTable(string name, TableResourceTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200901:TableResourceTable", name, args ?? new TableResourceTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200901:TableResourceTable", name, null, MakeResourceOptions(options, id))
        {
        }
