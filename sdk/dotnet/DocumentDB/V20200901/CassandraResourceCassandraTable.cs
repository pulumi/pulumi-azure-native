...
namespace Pulumi.AzureNextGen.DocumentDB.V20200901
{
    ...
    public partial class CassandraResourceCassandraTable : Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraTable(string name, CassandraResourceCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200901:CassandraResourceCassandraTable", name, args ?? new CassandraResourceCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200901:CassandraResourceCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
