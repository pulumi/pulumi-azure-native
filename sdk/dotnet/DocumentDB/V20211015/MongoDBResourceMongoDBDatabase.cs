...
namespace Pulumi.AzureNative.DocumentDB.V20211015
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20211015:MongoDBResourceMongoDBDatabase")]
    public partial class MongoDBResourceMongoDBDatabase : Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBDatabase(string name, MongoDBResourceMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015:MongoDBResourceMongoDBDatabase", name, args ?? new MongoDBResourceMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015:MongoDBResourceMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20211015:MongoDBResourceMongoDBDatabase"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210515:MongoDBResourceMongoDBDatabase"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210615:MongoDBResourceMongoDBDatabase"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210615:MongoDBResourceMongoDBDatabase"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210701preview:MongoDBResourceMongoDBDatabase"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210701preview:MongoDBResourceMongoDBDatabase"},
                },
            };
