...
namespace Pulumi.AzureNative.DocumentDB.V20211015.Inputs
{
    ...
    public sealed class BackupPolicyMigrationStateArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20211015.BackupPolicyMigrationStatus>? Status { get; set; }

        /// <summary>
        /// Describes the target backup policy type of the backup policy migration.
        /// </summary>
        [Input("targetType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20211015.BackupPolicyType>? TargetType { get; set; }
