...
namespace Pulumi.AzureNative.DocumentDB.V20211015
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20211015:SqlResourceSqlRoleAssignment")]
    public partial class SqlResourceSqlRoleAssignment : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlRoleAssignment(string name, SqlResourceSqlRoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015:SqlResourceSqlRoleAssignment", name, args ?? new SqlResourceSqlRoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlRoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015:SqlResourceSqlRoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
