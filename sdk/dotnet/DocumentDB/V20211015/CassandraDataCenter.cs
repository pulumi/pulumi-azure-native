...
namespace Pulumi.AzureNative.DocumentDB.V20211015
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20211015:CassandraDataCenter")]
    public partial class CassandraDataCenter : Pulumi.CustomResource
    {
        ...
        public CassandraDataCenter(string name, CassandraDataCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015:CassandraDataCenter", name, args ?? new CassandraDataCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraDataCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015:CassandraDataCenter", name, null, MakeResourceOptions(options, id))
        {
        }
