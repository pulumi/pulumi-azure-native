...
namespace Pulumi.AzureNative.DocumentDB.V20240215Preview
{
    public static class GetThroughputPoolAccount
    {
        ...
        public static Task<GetThroughputPoolAccountResult> InvokeAsync(GetThroughputPoolAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetThroughputPoolAccountResult>("azure-native:documentdb/v20240215preview:getThroughputPoolAccount", args ?? new GetThroughputPoolAccountArgs(), options.WithDefaults());
        ...
        public static Output<GetThroughputPoolAccountResult> Invoke(GetThroughputPoolAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetThroughputPoolAccountResult>("azure-native:documentdb/v20240215preview:getThroughputPoolAccount", args ?? new GetThroughputPoolAccountInvokeArgs(), options.WithDefaults());
