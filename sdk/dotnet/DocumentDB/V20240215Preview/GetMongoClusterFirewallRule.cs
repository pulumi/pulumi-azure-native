...
namespace Pulumi.AzureNative.DocumentDB.V20240215Preview
{
    public static class GetMongoClusterFirewallRule
    {
        ...
        public static Task<GetMongoClusterFirewallRuleResult> InvokeAsync(GetMongoClusterFirewallRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMongoClusterFirewallRuleResult>("azure-native:documentdb/v20240215preview:getMongoClusterFirewallRule", args ?? new GetMongoClusterFirewallRuleArgs(), options.WithDefaults());
        ...
        public static Output<GetMongoClusterFirewallRuleResult> Invoke(GetMongoClusterFirewallRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMongoClusterFirewallRuleResult>("azure-native:documentdb/v20240215preview:getMongoClusterFirewallRule", args ?? new GetMongoClusterFirewallRuleInvokeArgs(), options.WithDefaults());
    }
