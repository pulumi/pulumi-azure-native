...
namespace Pulumi.AzureNative.DocumentDB.V20240215Preview
{
    public static class GetCassandraCluster
    {
        ...
        public static Task<GetCassandraClusterResult> InvokeAsync(GetCassandraClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCassandraClusterResult>("azure-native:documentdb/v20240215preview:getCassandraCluster", args ?? new GetCassandraClusterArgs(), options.WithDefaults());

        /// <summary>
        /// Get the properties of a managed Cassandra cluster.
        /// </summary>
        public static Output<GetCassandraClusterResult> Invoke(GetCassandraClusterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCassandraClusterResult>("azure-native:documentdb/v20240215preview:getCassandraCluster", args ?? new GetCassandraClusterInvokeArgs(), options.WithDefaults());
