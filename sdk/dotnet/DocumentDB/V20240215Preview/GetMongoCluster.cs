...
namespace Pulumi.AzureNative.DocumentDB.V20240215Preview
{
    public static class GetMongoCluster
    {
        ...
        public static Task<GetMongoClusterResult> InvokeAsync(GetMongoClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMongoClusterResult>("azure-native:documentdb/v20240215preview:getMongoCluster", args ?? new GetMongoClusterArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a mongo cluster.
        /// </summary>
        public static Output<GetMongoClusterResult> Invoke(GetMongoClusterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMongoClusterResult>("azure-native:documentdb/v20240215preview:getMongoCluster", args ?? new GetMongoClusterInvokeArgs(), options.WithDefaults());
