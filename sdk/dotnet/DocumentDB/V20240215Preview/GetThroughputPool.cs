...
namespace Pulumi.AzureNative.DocumentDB.V20240215Preview
{
    public static class GetThroughputPool
    {
        ...
        public static Task<GetThroughputPoolResult> InvokeAsync(GetThroughputPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetThroughputPoolResult>("azure-native:documentdb/v20240215preview:getThroughputPool", args ?? new GetThroughputPoolArgs(), options.WithDefaults());
