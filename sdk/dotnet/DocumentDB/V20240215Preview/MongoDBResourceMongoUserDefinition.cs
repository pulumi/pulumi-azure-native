...
namespace Pulumi.AzureNative.DocumentDB.V20240215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240215preview:MongoDBResourceMongoUserDefinition")]
    public partial class MongoDBResourceMongoUserDefinition : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoUserDefinition(string name, MongoDBResourceMongoUserDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240215preview:MongoDBResourceMongoUserDefinition", name, args ?? new MongoDBResourceMongoUserDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoUserDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240215preview:MongoDBResourceMongoUserDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
