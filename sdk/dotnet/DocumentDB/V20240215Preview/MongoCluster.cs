...
namespace Pulumi.AzureNative.DocumentDB.V20240215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240215preview:MongoCluster")]
    public partial class MongoCluster : global::Pulumi.CustomResource
    {
        ...
        public MongoCluster(string name, MongoClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240215preview:MongoCluster", name, args ?? new MongoClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240215preview:MongoCluster", name, null, MakeResourceOptions(options, id))
        {
        }
