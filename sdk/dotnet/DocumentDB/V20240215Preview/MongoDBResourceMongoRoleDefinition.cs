...
namespace Pulumi.AzureNative.DocumentDB.V20240215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240215preview:MongoDBResourceMongoRoleDefinition")]
    public partial class MongoDBResourceMongoRoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoRoleDefinition(string name, MongoDBResourceMongoRoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240215preview:MongoDBResourceMongoRoleDefinition", name, args ?? new MongoDBResourceMongoRoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoRoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240215preview:MongoDBResourceMongoRoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MongoDBResourceMongoRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.DocumentDB.V20240215Preview.MongoRoleDefinitionType>? Type { get; set; }
