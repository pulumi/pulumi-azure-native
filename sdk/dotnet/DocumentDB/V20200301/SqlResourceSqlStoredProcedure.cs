...
namespace Pulumi.AzureRM.DocumentDB.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlResourceSqlStoredProcedure = new AzureRM.DocumentDB.V20200301.SqlResourceSqlStoredProcedure("sqlResourceSqlStoredProcedure", new AzureRM.DocumentDB.V20200301.SqlResourceSqlStoredProcedureArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             ContainerName = "containerName",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20200301.Inputs.SqlStoredProcedureResourceArgs
    ///             {
    ///                 Body = "body",
    ...
    public partial class SqlResourceSqlStoredProcedure : Pulumi.CustomResource
    {
        ...
        [Output("resource")]
        public Output<Outputs.SqlStoredProcedureGetPropertiesResponseResourceResult?> Resource { get; private set; } = null!;
        ...
        public SqlResourceSqlStoredProcedure(string name, SqlResourceSqlStoredProcedureArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:SqlResourceSqlStoredProcedure", name, args ?? new SqlResourceSqlStoredProcedureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlStoredProcedure(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:SqlResourceSqlStoredProcedure", name, null, MakeResourceOptions(options, id))
        {
        }
