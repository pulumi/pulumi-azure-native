...
namespace Pulumi.AzureNextGen.DocumentDB.V20200301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20200301:SqlResourceSqlDatabase")]
    public partial class SqlResourceSqlDatabase : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200301:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200301:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
