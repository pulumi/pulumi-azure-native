...
namespace Pulumi.AzureRM.DocumentDB.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlResourceSqlDatabase = new AzureRM.DocumentDB.V20200301.SqlResourceSqlDatabase("sqlResourceSqlDatabase", new AzureRM.DocumentDB.V20200301.SqlResourceSqlDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20200301.Inputs.SqlDatabaseResourceArgs
    ///             {
    ///                 Id = "databaseName",
    ///             },
    ...
    public partial class SqlResourceSqlDatabase : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
