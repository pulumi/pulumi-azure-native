...
namespace Pulumi.AzureNative.DocumentDB.V20200301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20200301:SqlResourceSqlDatabase")]
    public partial class SqlResourceSqlDatabase : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200301:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200301:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
