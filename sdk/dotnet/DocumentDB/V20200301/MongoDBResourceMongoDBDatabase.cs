...
namespace Pulumi.AzureRM.DocumentDB.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var mongoDBResourceMongoDBDatabase = new AzureRM.DocumentDB.V20200301.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase", new AzureRM.DocumentDB.V20200301.MongoDBResourceMongoDBDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20200301.Inputs.MongoDBDatabaseResourceArgs
    ///             {
    ///                 Id = "databaseName",
    ///             },
    ...
    public partial class MongoDBResourceMongoDBDatabase : Pulumi.CustomResource
    {
        ...
        [Output("options")]
        public Output<Outputs.MongoDBDatabaseGetPropertiesResponseOptionsResult?> Options { get; private set; } = null!;

        [Output("resource")]
        public Output<Outputs.MongoDBDatabaseGetPropertiesResponseResourceResult?> Resource { get; private set; } = null!;
        ...
        public MongoDBResourceMongoDBDatabase(string name, MongoDBResourceMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:MongoDBResourceMongoDBDatabase", name, args ?? new MongoDBResourceMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:MongoDBResourceMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
