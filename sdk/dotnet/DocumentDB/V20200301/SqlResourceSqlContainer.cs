...
namespace Pulumi.AzureRM.DocumentDB.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlResourceSqlContainer = new AzureRM.DocumentDB.V20200301.SqlResourceSqlContainer("sqlResourceSqlContainer", new AzureRM.DocumentDB.V20200301.SqlResourceSqlContainerArgs
    ///         {
    ///             AccountName = "ddb1",
    ...
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20200301.Inputs.SqlContainerResourceArgs
    ///             {
    ...
    public partial class SqlResourceSqlContainer : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlContainer(string name, SqlResourceSqlContainerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:SqlResourceSqlContainer", name, args ?? new SqlResourceSqlContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:SqlResourceSqlContainer", name, null, MakeResourceOptions(options, id))
        {
        }
