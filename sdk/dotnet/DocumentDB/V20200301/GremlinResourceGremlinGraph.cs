...
namespace Pulumi.AzureRM.DocumentDB.V20200301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var gremlinResourceGremlinGraph = new AzureRM.DocumentDB.V20200301.GremlinResourceGremlinGraph("gremlinResourceGremlinGraph", new AzureRM.DocumentDB.V20200301.GremlinResourceGremlinGraphArgs
    ///         {
    ///             AccountName = "ddb1",
    ...
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20200301.Inputs.GremlinGraphResourceArgs
    ///             {
    ///                 ConflictResolutionPolicy = new AzureRM.DocumentDB.V20200301.Inputs.ConflictResolutionPolicyArgs
    ///                 {
    ...
    ///                 DefaultTtl = 100,
    ///                 Id = "graphName",
    ///                 IndexingPolicy = new AzureRM.DocumentDB.V20200301.Inputs.IndexingPolicyArgs
    ///                 {
    ///                     Automatic = true,
    ///                     ExcludedPaths = {},
    ///                     IncludedPaths = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20200301.Inputs.IncludedPathArgs
    ///                         {
    ///                             Indexes = 
    ///                             {
    ///                                 new AzureRM.DocumentDB.V20200301.Inputs.IndexesArgs
    ///                                 {
    ///                                     DataType = "String",
    ///                                     Kind = "Range",
    ///                                     Precision = -1,
    ...
    ///                 },
    ///                 PartitionKey = new AzureRM.DocumentDB.V20200301.Inputs.ContainerPartitionKeyArgs
    ///                 {
    ///                     Kind = "Hash",
    ///                     Paths = 
    ///                     {
    ...
    ///                     },
    ///                 },
    ///                 UniqueKeyPolicy = new AzureRM.DocumentDB.V20200301.Inputs.UniqueKeyPolicyArgs
    ///                 {
    ///                     UniqueKeys = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20200301.Inputs.UniqueKeyArgs
    ///                         {
    ///                             Paths = 
    ///                             {
    ///                                 "/testPath",
    ...
    public partial class GremlinResourceGremlinGraph : Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
