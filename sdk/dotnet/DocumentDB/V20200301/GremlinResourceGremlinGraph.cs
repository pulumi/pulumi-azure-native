...
namespace Pulumi.AzureNative.DocumentDB.V20200301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20200301:GremlinResourceGremlinGraph")]
    public partial class GremlinResourceGremlinGraph : Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200301:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200301:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
