...
namespace Pulumi.AzureNextGen.DocumentDB.V20200301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20200301:SqlResourceSqlTrigger")]
    public partial class SqlResourceSqlTrigger : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200301:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200301:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
