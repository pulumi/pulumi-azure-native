...
namespace Pulumi.AzureRM.DocumentDB.V20200301
{
    ...
    public partial class SqlResourceSqlUserDefinedFunction : Pulumi.CustomResource
    {
        ...
        [Output("resource")]
        public Output<Outputs.SqlUserDefinedFunctionGetPropertiesResponseResourceResult?> Resource { get; private set; } = null!;
        ...
        public SqlResourceSqlUserDefinedFunction(string name, SqlResourceSqlUserDefinedFunctionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:SqlResourceSqlUserDefinedFunction", name, args ?? new SqlResourceSqlUserDefinedFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlUserDefinedFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200301:SqlResourceSqlUserDefinedFunction", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:documentdb/v20190801:SqlResourceSqlUserDefinedFunction"},
                    new Alias { Type = "azurerm:documentdb/v20191212:SqlResourceSqlUserDefinedFunction"},
                    new Alias { Type = "azurerm:documentdb/v20200401:SqlResourceSqlUserDefinedFunction"},
                },
            };
