...
namespace Pulumi.AzureNative.DocumentDB.V20210701Preview.Inputs
{
    ...
    public sealed class BackupPolicyMigrationStateArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20210701Preview.BackupPolicyMigrationStatus>? Status { get; set; }

        /// <summary>
        /// Describes the target backup policy type of the backup policy migration.
        /// </summary>
        [Input("targetType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20210701Preview.BackupPolicyType>? TargetType { get; set; }
