...
namespace Pulumi.AzureNative.DocumentDB.V20210701Preview.Inputs
{
    ...
    public sealed class IndexesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20210701Preview.DataType>? DataType { get; set; }

        /// <summary>
        /// Indicates the type of index.
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20210701Preview.IndexKind>? Kind { get; set; }
