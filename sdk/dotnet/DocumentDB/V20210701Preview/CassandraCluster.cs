...
namespace Pulumi.AzureNative.DocumentDB.V20210701Preview
{
    ...
    /// {
    ///     var cassandraCluster = new AzureNative.DocumentDB.V20210701Preview.CassandraCluster("cassandraCluster", new()
    ///     {
    ///         ClusterName = "cassandra-prod",
    ///         Location = "West US",
    ///         Properties = new AzureNative.DocumentDB.V20210701Preview.Inputs.ClusterResourcePropertiesArgs
    ///         {
    ///             AuthenticationMethod = "Cassandra",
    ///             CassandraVersion = "3.11",
    ///             ClientCertificates = new[]
    ///             {
    ///                 new AzureNative.DocumentDB.V20210701Preview.Inputs.CertificateArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureNative.DocumentDB.V20210701Preview.Inputs.SeedNodeArgs
    ///                 {
