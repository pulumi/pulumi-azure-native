...
namespace Pulumi.AzureNative.DocumentDB.V20210701Preview
{
    ...
    /// {
    ///     var graphResourceGraph = new AzureNative.DocumentDB.V20210701Preview.GraphResourceGraph("graphResourceGraph", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         GraphName = "graphName",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20210701Preview.Inputs.GraphResourceArgs
    ///         {
    ///             Id = "graphName",
    ///         },
    ...
    public partial class GraphResourceGraph : global::Pulumi.CustomResource
    {
        ...
        public GraphResourceGraph(string name, GraphResourceGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210701preview:GraphResourceGraph", name, args ?? new GraphResourceGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphResourceGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210701preview:GraphResourceGraph", name, null, MakeResourceOptions(options, id))
        {
        }
