...
namespace Pulumi.AzureNative.DocumentDB.V20210701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210701preview:SqlResourceSqlContainer")]
    public partial class SqlResourceSqlContainer : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlContainer(string name, SqlResourceSqlContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210701preview:SqlResourceSqlContainer", name, args ?? new SqlResourceSqlContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210701preview:SqlResourceSqlContainer", name, null, MakeResourceOptions(options, id))
        {
        }
