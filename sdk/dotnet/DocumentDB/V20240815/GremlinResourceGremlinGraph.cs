...
namespace Pulumi.AzureNative.DocumentDB.V20240815
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240815:GremlinResourceGremlinGraph")]
    public partial class GremlinResourceGremlinGraph : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240815:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240815:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
