...
namespace Pulumi.AzureNative.DocumentDB.V20240815
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240815:SqlResourceSqlUserDefinedFunction")]
    public partial class SqlResourceSqlUserDefinedFunction : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlUserDefinedFunction(string name, SqlResourceSqlUserDefinedFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240815:SqlResourceSqlUserDefinedFunction", name, args ?? new SqlResourceSqlUserDefinedFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlUserDefinedFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240815:SqlResourceSqlUserDefinedFunction", name, null, MakeResourceOptions(options, id))
        {
        }
