...
namespace Pulumi.AzureNative.DocumentDB.V20240815
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240815:CassandraCluster")]
    public partial class CassandraCluster : global::Pulumi.CustomResource
    {
        ...
        public CassandraCluster(string name, CassandraClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240815:CassandraCluster", name, args ?? new CassandraClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240815:CassandraCluster", name, null, MakeResourceOptions(options, id))
        {
        }
