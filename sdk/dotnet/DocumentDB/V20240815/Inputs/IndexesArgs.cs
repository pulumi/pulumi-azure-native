...
namespace Pulumi.AzureNative.DocumentDB.V20240815.Inputs
{
    ...
    public sealed class IndexesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20240815.DataType>? DataType { get; set; }

        /// <summary>
        /// Indicates the type of index.
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20240815.IndexKind>? Kind { get; set; }
