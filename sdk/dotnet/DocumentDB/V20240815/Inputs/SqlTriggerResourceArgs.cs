...
namespace Pulumi.AzureNative.DocumentDB.V20240815.Inputs
{
    ...
    public sealed class SqlTriggerResourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20240815.TriggerOperation>? TriggerOperation { get; set; }

        /// <summary>
        /// Type of the Trigger
        /// </summary>
        [Input("triggerType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20240815.TriggerType>? TriggerType { get; set; }
