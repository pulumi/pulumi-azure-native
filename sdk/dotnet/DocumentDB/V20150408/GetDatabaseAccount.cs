...
namespace Pulumi.AzureRM.DocumentDB.V20150408
{
    public static class GetDatabaseAccount
    {
        public static Task<GetDatabaseAccountResult> InvokeAsync(GetDatabaseAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountResult>("azurerm:documentdb/v20150408:getDatabaseAccount", args ?? new GetDatabaseAccountArgs(), options.WithVersion());
    }
