...
namespace Pulumi.AzureNextGen.DocumentDB.V20150408
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20150408:DatabaseAccountCassandraKeyspace")]
    public partial class DatabaseAccountCassandraKeyspace : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraKeyspace(string name, DatabaseAccountCassandraKeyspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20150408:DatabaseAccountCassandraKeyspace", name, args ?? new DatabaseAccountCassandraKeyspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraKeyspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20150408:DatabaseAccountCassandraKeyspace", name, null, MakeResourceOptions(options, id))
        {
        }
