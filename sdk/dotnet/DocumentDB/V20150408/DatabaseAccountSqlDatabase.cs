...
namespace Pulumi.AzureRM.DocumentDB.V20150408
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountSqlDatabase = new AzureRM.DocumentDB.V20150408.DatabaseAccountSqlDatabase("databaseAccountSqlDatabase", new AzureRM.DocumentDB.V20150408.DatabaseAccountSqlDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20150408.Inputs.SqlDatabaseResourceArgs
    ///             {
    ///                 Id = "databaseName",
    ///             },
    ...
    public partial class DatabaseAccountSqlDatabase : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountSqlDatabase(string name, DatabaseAccountSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150408:DatabaseAccountSqlDatabase", name, args ?? new DatabaseAccountSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150408:DatabaseAccountSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
