...
namespace Pulumi.AzureRM.DocumentDB.V20150408
{
    public static class GetDatabaseAccountCassandraTable
    {
        public static Task<GetDatabaseAccountCassandraTableResult> InvokeAsync(GetDatabaseAccountCassandraTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountCassandraTableResult>("azurerm:documentdb/v20150408:getDatabaseAccountCassandraTable", args ?? new GetDatabaseAccountCassandraTableArgs(), options.WithVersion());
    }
