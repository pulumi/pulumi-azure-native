...
namespace Pulumi.AzureNative.DocumentDB.V20150408
{
    public static class GetDatabaseAccountCassandraTable
    {
        ...
        public static Output<GetDatabaseAccountCassandraTableResult> Invoke(GetDatabaseAccountCassandraTableInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountCassandraTableResult>("azure-native:documentdb/v20150408:getDatabaseAccountCassandraTable", args ?? new GetDatabaseAccountCassandraTableInvokeArgs(), options.WithVersion());
    }
