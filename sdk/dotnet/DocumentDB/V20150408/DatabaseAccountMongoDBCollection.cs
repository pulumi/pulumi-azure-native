...
namespace Pulumi.AzureRM.DocumentDB.V20150408
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountMongoDBCollection = new AzureRM.DocumentDB.V20150408.DatabaseAccountMongoDBCollection("databaseAccountMongoDBCollection", new AzureRM.DocumentDB.V20150408.DatabaseAccountMongoDBCollectionArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             CollectionName = "collectionName",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20150408.Inputs.MongoDBCollectionResourceArgs
    ///             {
    ///                 Id = "testcoll",
    ///                 Indexes = 
    ///                 {
    ///                     new AzureRM.DocumentDB.V20150408.Inputs.MongoIndexArgs
    ///                     {
    ///                         Key = new AzureRM.DocumentDB.V20150408.Inputs.MongoIndexKeysArgs
    ///                         {
    ///                             Keys = 
    ///                             {
    ///                                 "testKey",
    ///                             },
    ///                         },
    ///                         Options = new AzureRM.DocumentDB.V20150408.Inputs.MongoIndexOptionsArgs
    ///                         {
    ...
    public partial class DatabaseAccountMongoDBCollection : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountMongoDBCollection(string name, DatabaseAccountMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150408:DatabaseAccountMongoDBCollection", name, args ?? new DatabaseAccountMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150408:DatabaseAccountMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
