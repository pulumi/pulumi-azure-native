...
namespace Pulumi.AzureNative.DocumentDB.V20150408
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20150408:DatabaseAccountCassandraTable")]
    public partial class DatabaseAccountCassandraTable : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraTable(string name, DatabaseAccountCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20150408:DatabaseAccountCassandraTable", name, args ?? new DatabaseAccountCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20150408:DatabaseAccountCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
