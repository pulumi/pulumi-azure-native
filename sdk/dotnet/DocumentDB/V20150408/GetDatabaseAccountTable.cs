...
namespace Pulumi.AzureNative.DocumentDB.V20150408
{
    public static class GetDatabaseAccountTable
    {
        ...
        public static Task<GetDatabaseAccountTableResult> InvokeAsync(GetDatabaseAccountTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountTableResult>("azure-native:documentdb/v20150408:getDatabaseAccountTable", args ?? new GetDatabaseAccountTableArgs(), options.WithVersion());
        ...
        public static Output<GetDatabaseAccountTableResult> Invoke(GetDatabaseAccountTableInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountTableResult>("azure-native:documentdb/v20150408:getDatabaseAccountTable", args ?? new GetDatabaseAccountTableInvokeArgs(), options.WithVersion());
    }
