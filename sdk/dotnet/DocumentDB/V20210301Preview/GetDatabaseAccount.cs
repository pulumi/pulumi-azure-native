...
namespace Pulumi.AzureNative.DocumentDB.V20210301Preview
{
    public static class GetDatabaseAccount
    {
        ...
        public static Task<GetDatabaseAccountResult> InvokeAsync(GetDatabaseAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountResult>("azure-native:documentdb/v20210301preview:getDatabaseAccount", args ?? new GetDatabaseAccountArgs(), options.WithVersion());

        /// <summary>
        /// An Azure Cosmos DB database account.
        /// </summary>
        public static Output<GetDatabaseAccountResult> Invoke(GetDatabaseAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountResult>("azure-native:documentdb/v20210301preview:getDatabaseAccount", args ?? new GetDatabaseAccountInvokeArgs(), options.WithVersion());
    }
