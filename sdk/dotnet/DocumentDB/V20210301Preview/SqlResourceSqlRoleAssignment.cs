...
namespace Pulumi.AzureNative.DocumentDB.V20210301Preview
{
    ...
    /// {
    ///     var sqlResourceSqlRoleAssignment = new AzureNative.DocumentDB.V20210301Preview.SqlResourceSqlRoleAssignment("sqlResourceSqlRoleAssignment", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210301preview:SqlResourceSqlRoleAssignment")]
    public partial class SqlResourceSqlRoleAssignment : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlRoleAssignment(string name, SqlResourceSqlRoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210301preview:SqlResourceSqlRoleAssignment", name, args ?? new SqlResourceSqlRoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlRoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210301preview:SqlResourceSqlRoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
