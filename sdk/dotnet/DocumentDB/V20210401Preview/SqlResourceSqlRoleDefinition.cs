...
namespace Pulumi.AzureNative.DocumentDB.V20210401Preview
{
    ...
    [AzureNativeResourceType("azure-native:documentdb/v20210401preview:SqlResourceSqlRoleDefinition")]
    public partial class SqlResourceSqlRoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlRoleDefinition(string name, SqlResourceSqlRoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210401preview:SqlResourceSqlRoleDefinition", name, args ?? new SqlResourceSqlRoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlRoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210401preview:SqlResourceSqlRoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlResourceSqlRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.DocumentDB.V20210401Preview.RoleDefinitionType>? Type { get; set; }
