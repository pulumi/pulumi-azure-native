...
namespace Pulumi.AzureNative.DocumentDB.V20210401Preview
{
    public static class GetService
    {
        ...
        public static Task<GetServiceResult> InvokeAsync(GetServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceResult>("azure-native:documentdb/v20210401preview:getService", args ?? new GetServiceArgs(), options.WithDefaults());

        /// <summary>
        /// Properties for the database account.
        /// </summary>
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceResult>("azure-native:documentdb/v20210401preview:getService", args ?? new GetServiceInvokeArgs(), options.WithDefaults());
    }
