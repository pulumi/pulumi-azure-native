...
namespace Pulumi.AzureNative.DocumentDB.V20210401Preview
{
    public static class GetCassandraDataCenter
    {
        ...
        public static Task<GetCassandraDataCenterResult> InvokeAsync(GetCassandraDataCenterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCassandraDataCenterResult>("azure-native:documentdb/v20210401preview:getCassandraDataCenter", args ?? new GetCassandraDataCenterArgs(), options.WithVersion());
        ...
        public static Output<GetCassandraDataCenterResult> Invoke(GetCassandraDataCenterInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCassandraDataCenterResult>("azure-native:documentdb/v20210401preview:getCassandraDataCenter", args ?? new GetCassandraDataCenterInvokeArgs(), options.WithVersion());
    }
