...
namespace Pulumi.AzureNative.DocumentDB.V20210401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210401preview:SqlResourceSqlTrigger")]
    public partial class SqlResourceSqlTrigger : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210401preview:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210401preview:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210401preview:SqlResourceSqlTrigger"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20200901:SqlResourceSqlTrigger"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20200901:SqlResourceSqlTrigger"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210415:SqlResourceSqlTrigger"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210515:SqlResourceSqlTrigger"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210515:SqlResourceSqlTrigger"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210615:SqlResourceSqlTrigger"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210615:SqlResourceSqlTrigger"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210701preview:SqlResourceSqlTrigger"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210701preview:SqlResourceSqlTrigger"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20211015:SqlResourceSqlTrigger"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20211015:SqlResourceSqlTrigger"},
                },
            };
