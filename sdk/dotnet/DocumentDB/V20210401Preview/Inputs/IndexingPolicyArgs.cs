...
namespace Pulumi.AzureNative.DocumentDB.V20210401Preview.Inputs
{
    ...
    public sealed class IndexingPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<ImmutableArray<Input<Inputs.CompositePathArgs>>>? _compositeIndexes;

        /// <summary>
        /// List of composite path list
        /// </summary>
        public InputList<ImmutableArray<Input<Inputs.CompositePathArgs>>> CompositeIndexes
        {
            get => _compositeIndexes ?? (_compositeIndexes = new InputList<ImmutableArray<Input<Inputs.CompositePathArgs>>>());
        ...
        /// </summary>
        [Input("indexingMode")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20210401Preview.IndexingMode>? IndexingMode { get; set; }
