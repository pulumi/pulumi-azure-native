...
namespace Pulumi.AzureNative.DocumentDB.V20210401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210401preview:NotebookWorkspace")]
    public partial class NotebookWorkspace : Pulumi.CustomResource
    {
        ...
        public NotebookWorkspace(string name, NotebookWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210401preview:NotebookWorkspace", name, args ?? new NotebookWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210401preview:NotebookWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210401preview:NotebookWorkspace"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210415:NotebookWorkspace"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210515:NotebookWorkspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210515:NotebookWorkspace"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210615:NotebookWorkspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210615:NotebookWorkspace"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20210701preview:NotebookWorkspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20210701preview:NotebookWorkspace"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20211015:NotebookWorkspace"},
                    new Pulumi.Alias { Type = "azure-nextgen:documentdb/v20211015:NotebookWorkspace"},
                },
            };
