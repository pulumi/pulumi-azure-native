...
namespace Pulumi.AzureNative.DocumentDB.V20210401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210401preview:CassandraDataCenter")]
    public partial class CassandraDataCenter : Pulumi.CustomResource
    {
        ...
        public CassandraDataCenter(string name, CassandraDataCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210401preview:CassandraDataCenter", name, args ?? new CassandraDataCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraDataCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210401preview:CassandraDataCenter", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20211115preview:CassandraDataCenter"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20220215preview:CassandraDataCenter"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20220515:CassandraDataCenter"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20220515preview:CassandraDataCenter"},
                },
            };
