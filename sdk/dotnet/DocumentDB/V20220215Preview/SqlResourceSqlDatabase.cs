...
namespace Pulumi.AzureNative.DocumentDB.V20220215Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:documentdb/v20220215preview:SqlResourceSqlDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlDatabase to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20220215preview:SqlResourceSqlDatabase")]
    public partial class SqlResourceSqlDatabase : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220215preview:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220215preview:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
