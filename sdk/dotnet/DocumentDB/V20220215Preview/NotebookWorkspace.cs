...
namespace Pulumi.AzureNative.DocumentDB.V20220215Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20220215preview:NotebookWorkspace")]
    public partial class NotebookWorkspace : Pulumi.CustomResource
    {
        ...
        public NotebookWorkspace(string name, NotebookWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220215preview:NotebookWorkspace", name, args ?? new NotebookWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220215preview:NotebookWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
