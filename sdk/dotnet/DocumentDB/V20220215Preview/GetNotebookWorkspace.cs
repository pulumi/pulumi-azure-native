...
namespace Pulumi.AzureNative.DocumentDB.V20220215Preview
{
    public static class GetNotebookWorkspace
    {
        ...
        public static Task<GetNotebookWorkspaceResult> InvokeAsync(GetNotebookWorkspaceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNotebookWorkspaceResult>("azure-native:documentdb/v20220215preview:getNotebookWorkspace", args ?? new GetNotebookWorkspaceArgs(), options.WithDefaults());

        /// <summary>
        /// A notebook workspace resource
        /// </summary>
        public static Output<GetNotebookWorkspaceResult> Invoke(GetNotebookWorkspaceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetNotebookWorkspaceResult>("azure-native:documentdb/v20220215preview:getNotebookWorkspace", args ?? new GetNotebookWorkspaceInvokeArgs(), options.WithDefaults());
    }
