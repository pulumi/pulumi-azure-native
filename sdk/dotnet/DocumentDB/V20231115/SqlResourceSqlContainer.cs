...
namespace Pulumi.AzureNative.DocumentDB.V20231115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20231115:SqlResourceSqlContainer")]
    public partial class SqlResourceSqlContainer : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlContainer(string name, SqlResourceSqlContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115:SqlResourceSqlContainer", name, args ?? new SqlResourceSqlContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115:SqlResourceSqlContainer", name, null, MakeResourceOptions(options, id))
        {
        }
