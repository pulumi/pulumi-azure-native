...
namespace Pulumi.AzureNative.DocumentDB.V20231115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20231115:CassandraResourceCassandraTable")]
    public partial class CassandraResourceCassandraTable : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraTable(string name, CassandraResourceCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115:CassandraResourceCassandraTable", name, args ?? new CassandraResourceCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115:CassandraResourceCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
