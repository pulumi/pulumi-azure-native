...
namespace Pulumi.AzureNative.DocumentDB.V20231115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20231115:SqlResourceSqlDatabase")]
    public partial class SqlResourceSqlDatabase : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
