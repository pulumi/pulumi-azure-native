...
namespace Pulumi.AzureNative.DocumentDB.V20210315
{
    ...
    /// {
    ///     var tableResourceTable = new AzureNative.DocumentDB.V20210315.TableResourceTable("tableResourceTable", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20210315.Inputs.TableResourceArgs
    ///         {
    ///             Id = "tableName",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210315:TableResourceTable")]
    public partial class TableResourceTable : global::Pulumi.CustomResource
    {
        ...
        public TableResourceTable(string name, TableResourceTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:TableResourceTable", name, args ?? new TableResourceTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:TableResourceTable", name, null, MakeResourceOptions(options, id))
        {
        }
