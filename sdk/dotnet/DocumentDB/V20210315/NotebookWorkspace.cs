...
namespace Pulumi.AzureNative.DocumentDB.V20210315
{
    ...
    /// {
    ///     var notebookWorkspace = new AzureNative.DocumentDB.V20210315.NotebookWorkspace("notebookWorkspace", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210315:NotebookWorkspace")]
    public partial class NotebookWorkspace : global::Pulumi.CustomResource
    {
        ...
        public NotebookWorkspace(string name, NotebookWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:NotebookWorkspace", name, args ?? new NotebookWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:NotebookWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
