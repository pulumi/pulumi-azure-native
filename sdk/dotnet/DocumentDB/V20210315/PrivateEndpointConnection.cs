...
namespace Pulumi.AzureNative.DocumentDB.V20210315
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.DocumentDB.V20210315.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         PrivateEndpointConnectionName = "privateEndpointConnectionName",
    ///         PrivateLinkServiceConnectionState = new AzureNative.DocumentDB.V20210315.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20210315:PrivateEndpointConnection privateEndpointConnectionName /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/rg1/providers/Microsoft.DocumentDb/databaseAccounts/ddb1/privateEndpointConnections/privateEndpointConnectionName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210315:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
