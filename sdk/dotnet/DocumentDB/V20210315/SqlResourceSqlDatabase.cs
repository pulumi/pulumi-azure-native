...
namespace Pulumi.AzureNative.DocumentDB.V20210315
{
    ...
    /// {
    ///     var sqlResourceSqlDatabase = new AzureNative.DocumentDB.V20210315.SqlResourceSqlDatabase("sqlResourceSqlDatabase", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         DatabaseName = "databaseName",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20210315.Inputs.SqlDatabaseResourceArgs
    ///         {
    ///             Id = "databaseName",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20210315:SqlResourceSqlDatabase databaseName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/sqlDatabases/databaseName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210315:SqlResourceSqlDatabase")]
    public partial class SqlResourceSqlDatabase : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
