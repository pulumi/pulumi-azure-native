...
namespace Pulumi.AzureNative.DocumentDB.V20210315
{
    ...
    /// {
    ///     var mongoDBResourceMongoDBCollection = new AzureNative.DocumentDB.V20210315.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20210315.Inputs.MongoDBCollectionResourceArgs
    ///         {
    ///             Id = "collectionName",
    ///             Indexes = new[]
    ///             {
    ///                 new AzureNative.DocumentDB.V20210315.Inputs.MongoIndexArgs
    ///                 {
    ///                     Key = new AzureNative.DocumentDB.V20210315.Inputs.MongoIndexKeysArgs
    ///                     {
    ///                         Keys = new[]
    ///                         {
    ///                             "testKey",
    ///                         },
    ///                     },
    ///                     Options = new AzureNative.DocumentDB.V20210315.Inputs.MongoIndexOptionsArgs
    ///                     {
    ...
    public partial class MongoDBResourceMongoDBCollection : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBCollection(string name, MongoDBResourceMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:MongoDBResourceMongoDBCollection", name, args ?? new MongoDBResourceMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:MongoDBResourceMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
