...
namespace Pulumi.AzureNative.DocumentDB.V20210315
{
    ...
    /// {
    ///     var gremlinResourceGremlinDatabase = new AzureNative.DocumentDB.V20210315.GremlinResourceGremlinDatabase("gremlinResourceGremlinDatabase", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         DatabaseName = "databaseName",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20210315.Inputs.GremlinDatabaseResourceArgs
    ///         {
    ///             Id = "databaseName",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210315:GremlinResourceGremlinDatabase")]
    public partial class GremlinResourceGremlinDatabase : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinDatabase(string name, GremlinResourceGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:GremlinResourceGremlinDatabase", name, args ?? new GremlinResourceGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210315:GremlinResourceGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
