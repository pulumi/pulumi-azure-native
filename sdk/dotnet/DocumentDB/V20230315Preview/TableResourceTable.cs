...
namespace Pulumi.AzureNative.DocumentDB.V20230315Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230315preview:TableResourceTable")]
    public partial class TableResourceTable : global::Pulumi.CustomResource
    {
        ...
        public TableResourceTable(string name, TableResourceTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315preview:TableResourceTable", name, args ?? new TableResourceTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230315preview:TableResourceTable", name, null, MakeResourceOptions(options, id))
        {
        }
