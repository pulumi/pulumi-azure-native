...
namespace Pulumi.AzureNative.DocumentDB.V20211015Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20211015preview:SqlResourceSqlStoredProcedure")]
    public partial class SqlResourceSqlStoredProcedure : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlStoredProcedure(string name, SqlResourceSqlStoredProcedureArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015preview:SqlResourceSqlStoredProcedure", name, args ?? new SqlResourceSqlStoredProcedureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlStoredProcedure(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015preview:SqlResourceSqlStoredProcedure", name, null, MakeResourceOptions(options, id))
        {
        }
