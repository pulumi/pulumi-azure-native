...
namespace Pulumi.AzureNative.DocumentDB.V20211015Preview
{
    ...
    public partial class MongoDBResourceMongoUserDefinition : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public MongoDBResourceMongoUserDefinition(string name, MongoDBResourceMongoUserDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015preview:MongoDBResourceMongoUserDefinition", name, args ?? new MongoDBResourceMongoUserDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoUserDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015preview:MongoDBResourceMongoUserDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-native:documentdb:MongoDBResourceMongoUserDefinition"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20211115preview:MongoDBResourceMongoUserDefinition"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20220215preview:MongoDBResourceMongoUserDefinition"},
                    new Pulumi.Alias { Type = "azure-native:documentdb/v20220515preview:MongoDBResourceMongoUserDefinition"},
                },
            };
    ...
    public sealed class MongoDBResourceMongoUserDefinitionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
