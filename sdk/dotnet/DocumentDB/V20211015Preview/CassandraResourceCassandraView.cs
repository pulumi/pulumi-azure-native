...
namespace Pulumi.AzureNative.DocumentDB.V20211015Preview
{
    ...
    public partial class CassandraResourceCassandraView : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraView(string name, CassandraResourceCassandraViewArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015preview:CassandraResourceCassandraView", name, args ?? new CassandraResourceCassandraViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraView(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015preview:CassandraResourceCassandraView", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CassandraResourceCassandraViewArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CassandraViewCreateUpdatePropertiesArgs> Properties { get; set; } = null!;
