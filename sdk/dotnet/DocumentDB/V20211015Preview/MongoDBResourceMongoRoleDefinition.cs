...
namespace Pulumi.AzureNative.DocumentDB.V20211015Preview
{
    ...
    /// {
    ///     var mongoDBResourceMongoRoleDefinition = new AzureNative.DocumentDB.V20211015Preview.MongoDBResourceMongoRoleDefinition("mongoDBResourceMongoRoleDefinition", new()
    ///     {
    ...
    ///         Privileges = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20211015Preview.Inputs.PrivilegeArgs
    ///             {
    ///                 Actions = new[]
    ///                 {
    ///                     "insert",
    ///                     "find",
    ///                 },
    ///                 Resource = new AzureNative.DocumentDB.V20211015Preview.Inputs.PrivilegeResourceArgs
    ///                 {
    ///                     Collection = "sales",
    ///                     Db = "sales",
    ///                 },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20211015preview:MongoDBResourceMongoRoleDefinition")]
    public partial class MongoDBResourceMongoRoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoRoleDefinition(string name, MongoDBResourceMongoRoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015preview:MongoDBResourceMongoRoleDefinition", name, args ?? new MongoDBResourceMongoRoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoRoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211015preview:MongoDBResourceMongoRoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MongoDBResourceMongoRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.DocumentDB.V20211015Preview.MongoRoleDefinitionType>? Type { get; set; }
