...
namespace Pulumi.AzureRM.DocumentDB.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var privateEndpointConnection = new AzureRM.DocumentDB.Latest.PrivateEndpointConnection("privateEndpointConnection", new AzureRM.DocumentDB.Latest.PrivateEndpointConnectionArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             PrivateEndpointConnectionName = "privateEndpointConnectionName",
    ///             PrivateLinkServiceConnectionState = new AzureRM.DocumentDB.Latest.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    ///             {
    ...
    public partial class PrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/latest:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/latest:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:documentdb/v20190801preview:PrivateEndpointConnection"},
                },
            };
