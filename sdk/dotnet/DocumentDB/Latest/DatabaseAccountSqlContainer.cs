...
namespace Pulumi.AzureNextGen.DocumentDB.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:documentdb:DatabaseAccountSqlContainer'.")]
    [AzureNextGenResourceType("azure-nextgen:documentdb/latest:DatabaseAccountSqlContainer")]
    public partial class DatabaseAccountSqlContainer : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountSqlContainer(string name, DatabaseAccountSqlContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/latest:DatabaseAccountSqlContainer", name, args ?? new DatabaseAccountSqlContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountSqlContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/latest:DatabaseAccountSqlContainer", name, null, MakeResourceOptions(options, id))
        {
        }
