...
namespace Pulumi.AzureNextGen.DocumentDB.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:documentdb:SqlResourceSqlTrigger'.")]
    [AzureNextGenResourceType("azure-nextgen:documentdb/latest:SqlResourceSqlTrigger")]
    public partial class SqlResourceSqlTrigger : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/latest:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/latest:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
