...
namespace Pulumi.AzureRM.DocumentDB.Latest
{
    public static class GetDatabaseAccount
    {
        public static Task<GetDatabaseAccountResult> InvokeAsync(GetDatabaseAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountResult>("azurerm:documentdb/latest:getDatabaseAccount", args ?? new GetDatabaseAccountArgs(), options.WithVersion());
    }
