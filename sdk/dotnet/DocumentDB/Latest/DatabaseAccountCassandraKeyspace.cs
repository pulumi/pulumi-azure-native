...
namespace Pulumi.AzureRM.DocumentDB.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountCassandraKeyspace = new AzureRM.DocumentDB.Latest.DatabaseAccountCassandraKeyspace("databaseAccountCassandraKeyspace", new AzureRM.DocumentDB.Latest.DatabaseAccountCassandraKeyspaceArgs
    ///         {
    ///             AccountName = "ddb1",
    ...
    public partial class DatabaseAccountCassandraKeyspace : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraKeyspace(string name, DatabaseAccountCassandraKeyspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/latest:DatabaseAccountCassandraKeyspace", name, args ?? new DatabaseAccountCassandraKeyspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraKeyspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/latest:DatabaseAccountCassandraKeyspace", name, null, MakeResourceOptions(options, id))
        {
        }
