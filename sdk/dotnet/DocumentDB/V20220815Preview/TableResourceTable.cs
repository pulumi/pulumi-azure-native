...
namespace Pulumi.AzureNative.DocumentDB.V20220815Preview
{
    ...
    /// {
    ///     var tableResourceTable = new AzureNative.DocumentDB.V20220815Preview.TableResourceTable("tableResourceTable", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20220815Preview.Inputs.TableResourceArgs
    ///         {
    ///             Id = "tableName",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20220815preview:TableResourceTable tableName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/tables/tableName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20220815preview:TableResourceTable")]
    public partial class TableResourceTable : global::Pulumi.CustomResource
    {
        ...
        public TableResourceTable(string name, TableResourceTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815preview:TableResourceTable", name, args ?? new TableResourceTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815preview:TableResourceTable", name, null, MakeResourceOptions(options, id))
        {
        }
