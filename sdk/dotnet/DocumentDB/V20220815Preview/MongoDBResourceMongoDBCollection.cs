...
namespace Pulumi.AzureNative.DocumentDB.V20220815Preview
{
    ...
    /// {
    ///     var mongoDBResourceMongoDBCollection = new AzureNative.DocumentDB.V20220815Preview.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20220815Preview.Inputs.MongoDBCollectionResourceArgs
    ///         {
    ///             AnalyticalStorageTtl = 500,
    ///             Id = "collectionName",
    ///             Indexes = new[]
    ///             {
    ///                 new AzureNative.DocumentDB.V20220815Preview.Inputs.MongoIndexArgs
    ///                 {
    ///                     Key = new AzureNative.DocumentDB.V20220815Preview.Inputs.MongoIndexKeysArgs
    ///                     {
    ///                         Keys = new[]
    ///                         {
    ///                             "_ts",
    ///                         },
    ///                     },
    ///                     Options = new AzureNative.DocumentDB.V20220815Preview.Inputs.MongoIndexOptionsArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBCollection")]
    public partial class MongoDBResourceMongoDBCollection : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBCollection(string name, MongoDBResourceMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBCollection", name, args ?? new MongoDBResourceMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
