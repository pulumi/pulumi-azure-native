...
namespace Pulumi.AzureNative.DocumentDB.V20220815Preview
{
    ...
    /// {
    ///     var gremlinResourceGremlinDatabase = new AzureNative.DocumentDB.V20220815Preview.GremlinResourceGremlinDatabase("gremlinResourceGremlinDatabase", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         DatabaseName = "databaseName",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20220815Preview.Inputs.GremlinDatabaseResourceArgs
    ///         {
    ///             Id = "databaseName",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20220815preview:GremlinResourceGremlinDatabase databaseName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/gremlinDatabases/databaseName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20220815preview:GremlinResourceGremlinDatabase")]
    public partial class GremlinResourceGremlinDatabase : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinDatabase(string name, GremlinResourceGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815preview:GremlinResourceGremlinDatabase", name, args ?? new GremlinResourceGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815preview:GremlinResourceGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
