...
namespace Pulumi.AzureNative.DocumentDB.V20220815Preview
{
    ...
    /// {
    ///     var gremlinResourceGremlinGraph = new AzureNative.DocumentDB.V20220815Preview.GremlinResourceGremlinGraph("gremlinResourceGremlinGraph", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20220815Preview.Inputs.GremlinGraphResourceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph")]
    public partial class GremlinResourceGremlinGraph : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
