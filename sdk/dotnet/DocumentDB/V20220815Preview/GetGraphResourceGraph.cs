...
namespace Pulumi.AzureNative.DocumentDB.V20220815Preview
{
    public static class GetGraphResourceGraph
    {
        ...
        public static Task<GetGraphResourceGraphResult> InvokeAsync(GetGraphResourceGraphArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGraphResourceGraphResult>("azure-native:documentdb/v20220815preview:getGraphResourceGraph", args ?? new GetGraphResourceGraphArgs(), options.WithDefaults());

        /// <summary>
        /// An Azure Cosmos DB Graph resource.
        /// </summary>
        public static Output<GetGraphResourceGraphResult> Invoke(GetGraphResourceGraphInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGraphResourceGraphResult>("azure-native:documentdb/v20220815preview:getGraphResourceGraph", args ?? new GetGraphResourceGraphInvokeArgs(), options.WithDefaults());
    }
