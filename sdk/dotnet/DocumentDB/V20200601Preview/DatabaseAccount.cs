...
namespace Pulumi.AzureRM.DocumentDB.V20200601Preview
{
    ...
    public partial class DatabaseAccount : Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200601preview:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200601preview:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
