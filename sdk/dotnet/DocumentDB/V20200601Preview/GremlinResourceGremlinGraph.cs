...
namespace Pulumi.AzureNextGen.DocumentDB.V20200601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20200601preview:GremlinResourceGremlinGraph")]
    public partial class GremlinResourceGremlinGraph : Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200601preview:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200601preview:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
