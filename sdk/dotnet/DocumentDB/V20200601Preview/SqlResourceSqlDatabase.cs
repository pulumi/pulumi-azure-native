...
namespace Pulumi.AzureRM.DocumentDB.V20200601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlResourceSqlDatabase = new AzureRM.DocumentDB.V20200601Preview.SqlResourceSqlDatabase("sqlResourceSqlDatabase", new AzureRM.DocumentDB.V20200601Preview.SqlResourceSqlDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20200601Preview.Inputs.SqlDatabaseResourceArgs
    ///             {
    ///                 Id = "databaseName",
    ///             },
    ...
    public partial class SqlResourceSqlDatabase : Pulumi.CustomResource
    {
        ...
        [Output("options")]
        public Output<Outputs.SqlDatabaseGetPropertiesResponseOptionsResult?> Options { get; private set; } = null!;
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200601preview:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200601preview:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
