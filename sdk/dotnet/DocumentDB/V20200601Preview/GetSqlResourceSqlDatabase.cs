...
namespace Pulumi.AzureNextGen.DocumentDB.V20200601Preview
{
    public static class GetSqlResourceSqlDatabase
    {
        public static Task<GetSqlResourceSqlDatabaseResult> InvokeAsync(GetSqlResourceSqlDatabaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlResourceSqlDatabaseResult>("azure-nextgen:documentdb/v20200601preview:getSqlResourceSqlDatabase", args ?? new GetSqlResourceSqlDatabaseArgs(), options.WithVersion());
    }
    ...
    public sealed class GetSqlResourceSqlDatabaseResult
    {
        ...
        public readonly Outputs.SqlDatabaseGetPropertiesInvokeResponseOptionsResult? Options;
        public readonly Outputs.SqlDatabaseGetPropertiesInvokeResponseResourceResult? Resource;
        /// <summary>
        ...
        private GetSqlResourceSqlDatabaseResult(
            ...
            Outputs.SqlDatabaseGetPropertiesInvokeResponseOptionsResult? options,

            Outputs.SqlDatabaseGetPropertiesInvokeResponseResourceResult? resource,
