...
namespace Pulumi.AzureRM.DocumentDB.V20160319
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountMongoDBDatabase = new AzureRM.DocumentDB.V20160319.DatabaseAccountMongoDBDatabase("databaseAccountMongoDBDatabase", new AzureRM.DocumentDB.V20160319.DatabaseAccountMongoDBDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20160319.Inputs.MongoDBDatabaseResourceArgs
    ///             {
    ...
    public partial class DatabaseAccountMongoDBDatabase : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountMongoDBDatabase(string name, DatabaseAccountMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160319:DatabaseAccountMongoDBDatabase", name, args ?? new DatabaseAccountMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160319:DatabaseAccountMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:documentdb/v20150408:DatabaseAccountMongoDBDatabase"},
                    new Pulumi.Alias { Type = "azurerm:documentdb/v20151106:DatabaseAccountMongoDBDatabase"},
                    new Pulumi.Alias { Type = "azurerm:documentdb/v20160331:DatabaseAccountMongoDBDatabase"},
                },
            };
