...
namespace Pulumi.AzureNative.DocumentDB.V20160319
{
    ...
    public static class GetDatabaseAccountCassandraTable
    {
        ...
        public static Task<GetDatabaseAccountCassandraTableResult> InvokeAsync(GetDatabaseAccountCassandraTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountCassandraTableResult>("azure-native:documentdb/v20160319:getDatabaseAccountCassandraTable", args ?? new GetDatabaseAccountCassandraTableArgs(), options.WithDefaults());
        ...
        public static Output<GetDatabaseAccountCassandraTableResult> Invoke(GetDatabaseAccountCassandraTableInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountCassandraTableResult>("azure-native:documentdb/v20160319:getDatabaseAccountCassandraTable", args ?? new GetDatabaseAccountCassandraTableInvokeArgs(), options.WithDefaults());
    }
