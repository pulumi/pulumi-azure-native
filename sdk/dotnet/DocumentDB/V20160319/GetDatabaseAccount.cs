...
namespace Pulumi.AzureRM.DocumentDB.V20160319
{
    public static class GetDatabaseAccount
    {
        public static Task<GetDatabaseAccountResult> InvokeAsync(GetDatabaseAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountResult>("azurerm:documentdb/v20160319:getDatabaseAccount", args ?? new GetDatabaseAccountArgs(), options.WithVersion());
    }
    ...
    public sealed class GetDatabaseAccountResult
    {
        ...
        /// </summary>
        public readonly Outputs.DatabaseAccountPropertiesResponseResult Properties;
        /// <summary>
        ...
        private GetDatabaseAccountResult(
            ...
            Outputs.DatabaseAccountPropertiesResponseResult properties,
