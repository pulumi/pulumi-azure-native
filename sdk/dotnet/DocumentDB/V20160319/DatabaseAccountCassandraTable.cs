...
namespace Pulumi.AzureRM.DocumentDB.V20160319
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountCassandraTable = new AzureRM.DocumentDB.V20160319.DatabaseAccountCassandraTable("databaseAccountCassandraTable", new AzureRM.DocumentDB.V20160319.DatabaseAccountCassandraTableArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             KeyspaceName = "tableName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20160319.Inputs.CassandraTableResourceArgs
    ///             {
    ///                 DefaultTtl = 100,
    ///                 Id = "tableName",
    ///                 Schema = new AzureRM.DocumentDB.V20160319.Inputs.CassandraSchemaArgs
    ///                 {
    ///                     ClusterKeys = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20160319.Inputs.ClusterKeyArgs
    ///                         {
    ///                             Name = "columnA",
    ///                             OrderBy = "Asc",
    ///                         },
    ...
    ///                     Columns = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20160319.Inputs.ColumnArgs
    ///                         {
    ///                             Name = "columnA",
    ///                             Type = "Ascii",
    ///                         },
    ...
    ///                     PartitionKeys = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20160319.Inputs.CassandraPartitionKeyArgs
    ///                         {
    ///                             Name = "columnA",
    ///                         },
    ///                     },
    ...
    public partial class DatabaseAccountCassandraTable : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraTable(string name, DatabaseAccountCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160319:DatabaseAccountCassandraTable", name, args ?? new DatabaseAccountCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160319:DatabaseAccountCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
