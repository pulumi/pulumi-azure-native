...
namespace Pulumi.AzureRM.DocumentDB.V20160319
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccount = new AzureRM.DocumentDB.V20160319.DatabaseAccount("databaseAccount", new AzureRM.DocumentDB.V20160319.DatabaseAccountArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             ConsistencyPolicy = new AzureRM.DocumentDB.V20160319.Inputs.ConsistencyPolicyArgs
    ///             {
    ...
    ///             Locations = 
    ///             {
    ///                 new AzureRM.DocumentDB.V20160319.Inputs.LocationArgs
    ///                 {
    ///                     FailoverPriority = 0,
    ...
    ///             VirtualNetworkRules = 
    ///             {
    ///                 new AzureRM.DocumentDB.V20160319.Inputs.VirtualNetworkRuleArgs
    ///                 {
    ...
    public partial class DatabaseAccount : Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160319:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160319:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
