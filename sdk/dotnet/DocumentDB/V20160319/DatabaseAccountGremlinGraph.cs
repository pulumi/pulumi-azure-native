...
namespace Pulumi.AzureRM.DocumentDB.V20160319
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountGremlinGraph = new AzureRM.DocumentDB.V20160319.DatabaseAccountGremlinGraph("databaseAccountGremlinGraph", new AzureRM.DocumentDB.V20160319.DatabaseAccountGremlinGraphArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             GraphName = "graphName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20160319.Inputs.GremlinGraphResourceArgs
    ///             {
    ...
    public partial class DatabaseAccountGremlinGraph : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountGremlinGraph(string name, DatabaseAccountGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160319:DatabaseAccountGremlinGraph", name, args ?? new DatabaseAccountGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20160319:DatabaseAccountGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
