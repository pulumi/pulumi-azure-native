...
namespace Pulumi.AzureRM.DocumentDB
{
    public static class GetSqlResourceSqlTrigger
    {
        public static Task<GetSqlResourceSqlTriggerResult> InvokeAsync(GetSqlResourceSqlTriggerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlResourceSqlTriggerResult>("azurerm:documentdb:getSqlResourceSqlTrigger", args ?? new GetSqlResourceSqlTriggerArgs(), options.WithVersion());
    }
    ...
    public sealed class GetSqlResourceSqlTriggerResult
    {
        ...
        /// </summary>
        public readonly Outputs.SqlTriggerGetPropertiesResponseResult Properties;
        /// <summary>
        ...
        private GetSqlResourceSqlTriggerResult(
            ...
            Outputs.SqlTriggerGetPropertiesResponseResult properties,
