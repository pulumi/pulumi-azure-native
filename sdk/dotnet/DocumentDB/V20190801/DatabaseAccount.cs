...
namespace Pulumi.AzureRM.DocumentDB.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccount = new AzureRM.DocumentDB.V20190801.DatabaseAccount("databaseAccount", new AzureRM.DocumentDB.V20190801.DatabaseAccountArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             ConsistencyPolicy = new AzureRM.DocumentDB.V20190801.Inputs.ConsistencyPolicyArgs
    ///             {
    ...
    ///             Locations = 
    ///             {
    ///                 new AzureRM.DocumentDB.V20190801.Inputs.LocationArgs
    ///                 {
    ///                     FailoverPriority = 0,
    ...
    ///             VirtualNetworkRules = 
    ///             {
    ///                 new AzureRM.DocumentDB.V20190801.Inputs.VirtualNetworkRuleArgs
    ///                 {
