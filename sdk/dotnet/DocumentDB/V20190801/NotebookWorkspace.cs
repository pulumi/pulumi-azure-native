...
namespace Pulumi.AzureNative.DocumentDB.V20190801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20190801:NotebookWorkspace")]
    public partial class NotebookWorkspace : Pulumi.CustomResource
    {
        ...
        public NotebookWorkspace(string name, NotebookWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:NotebookWorkspace", name, args ?? new NotebookWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:NotebookWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
