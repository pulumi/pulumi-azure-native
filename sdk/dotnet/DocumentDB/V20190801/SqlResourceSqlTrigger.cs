...
namespace Pulumi.AzureNative.DocumentDB.V20190801
{
    ...
    /// {
    ///     var sqlResourceSqlTrigger = new AzureNative.DocumentDB.V20190801.SqlResourceSqlTrigger("sqlResourceSqlTrigger", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         ContainerName = "containerName",
    ///         DatabaseName = "databaseName",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20190801.Inputs.SqlTriggerResourceArgs
    ///         {
    ///             Body = "body",
    ///             Id = "triggerName",
    ...
    [AzureNativeResourceType("azure-native:documentdb/v20190801:SqlResourceSqlTrigger")]
    public partial class SqlResourceSqlTrigger : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
