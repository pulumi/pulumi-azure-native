...
namespace Pulumi.AzureRM.DocumentDB.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var sqlResourceSqlDatabase = new AzureRM.DocumentDB.V20190801.SqlResourceSqlDatabase("sqlResourceSqlDatabase", new AzureRM.DocumentDB.V20190801.SqlResourceSqlDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20190801.Inputs.SqlDatabaseResourceArgs
    ///             {
    ///                 Id = "databaseName",
    ///             },
    ...
    public partial class SqlResourceSqlDatabase : Pulumi.CustomResource
    {
        ...
        [Output("resource")]
        public Output<Outputs.SqlDatabaseGetPropertiesResponseResourceResult?> Resource { get; private set; } = null!;
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20190801:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20190801:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:documentdb/v20200401:SqlResourceSqlDatabase"},
                    new Pulumi.Alias { Type = "azurerm:documentdb/v20200601preview:SqlResourceSqlDatabase"},
                },
            };
