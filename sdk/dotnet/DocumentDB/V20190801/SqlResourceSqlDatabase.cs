...
namespace Pulumi.AzureNative.DocumentDB.V20190801
{
    ...
    /// {
    ///     var sqlResourceSqlDatabase = new AzureNative.DocumentDB.V20190801.SqlResourceSqlDatabase("sqlResourceSqlDatabase", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         DatabaseName = "databaseName",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20190801.Inputs.SqlDatabaseResourceArgs
    ///         {
    ///             Id = "databaseName",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20190801:SqlResourceSqlDatabase databaseName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/sqlDatabases/databaseName 
    /// ```
    /// </summary>
    ...
    public partial class SqlResourceSqlDatabase : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
