...
namespace Pulumi.AzureNative.DocumentDB.V20190801
{
    ...
    /// {
    ///     var mongoDBResourceMongoDBCollection = new AzureNative.DocumentDB.V20190801.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20190801.Inputs.MongoDBCollectionResourceArgs
    ///         {
    ///             Id = "collectionName",
    ///             Indexes = new[]
    ///             {
    ///                 new AzureNative.DocumentDB.V20190801.Inputs.MongoIndexArgs
    ///                 {
    ///                     Key = new AzureNative.DocumentDB.V20190801.Inputs.MongoIndexKeysArgs
    ///                     {
    ///                         Keys = new[]
    ///                         {
    ///                             "testKey",
    ///                         },
    ///                     },
    ///                     Options = new AzureNative.DocumentDB.V20190801.Inputs.MongoIndexOptionsArgs
    ///                     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20190801:MongoDBResourceMongoDBCollection collectionName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/mongodbDatabases/databaseName/mongodbCollections/collectionName 
    /// ```
    /// </summary>
    [Obsolete(@"Version 2019-08-01 will be removed in v2 of the provider.")]
    [AzureNativeResourceType("azure-native:documentdb/v20190801:MongoDBResourceMongoDBCollection")]
    public partial class MongoDBResourceMongoDBCollection : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBCollection(string name, MongoDBResourceMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:MongoDBResourceMongoDBCollection", name, args ?? new MongoDBResourceMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:MongoDBResourceMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
