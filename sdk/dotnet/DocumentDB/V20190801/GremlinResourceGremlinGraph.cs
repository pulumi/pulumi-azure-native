...
namespace Pulumi.AzureNative.DocumentDB.V20190801
{
    ...
    /// {
    ///     var gremlinResourceGremlinGraph = new AzureNative.DocumentDB.V20190801.GremlinResourceGremlinGraph("gremlinResourceGremlinGraph", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20190801.Inputs.GremlinGraphResourceArgs
    ///         {
    ...
    [AzureNativeResourceType("azure-native:documentdb/v20190801:GremlinResourceGremlinGraph")]
    public partial class GremlinResourceGremlinGraph : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
