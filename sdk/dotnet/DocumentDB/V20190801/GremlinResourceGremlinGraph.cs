...
namespace Pulumi.AzureRM.DocumentDB.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var gremlinResourceGremlinGraph = new AzureRM.DocumentDB.V20190801.GremlinResourceGremlinGraph("gremlinResourceGremlinGraph", new AzureRM.DocumentDB.V20190801.GremlinResourceGremlinGraphArgs
    ///         {
    ///             AccountName = "ddb1",
    ...
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20190801.Inputs.GremlinGraphResourceArgs
    ///             {
    ...
    public partial class GremlinResourceGremlinGraph : Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinGraph(string name, GremlinResourceGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20190801:GremlinResourceGremlinGraph", name, args ?? new GremlinResourceGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20190801:GremlinResourceGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
