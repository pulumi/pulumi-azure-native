...
namespace Pulumi.AzureNative.DocumentDB.V20190801
{
    ...
    /// {
    ///     var sqlResourceSqlContainer = new AzureNative.DocumentDB.V20190801.SqlResourceSqlContainer("sqlResourceSqlContainer", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20190801.Inputs.SqlContainerResourceArgs
    ///         {
    ///             ConflictResolutionPolicy = new AzureNative.DocumentDB.V20190801.Inputs.ConflictResolutionPolicyArgs
    ///             {
    ...
    ///             DefaultTtl = 100,
    ///             Id = "containerName",
    ///             IndexingPolicy = new AzureNative.DocumentDB.V20190801.Inputs.IndexingPolicyArgs
    ///             {
    ///                 Automatic = true,
    ///                 ExcludedPaths = new[] {},
    ///                 IncludedPaths = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20190801.Inputs.IncludedPathArgs
    ///                     {
    ///                         Indexes = new[]
    ///                         {
    ///                             new AzureNative.DocumentDB.V20190801.Inputs.IndexesArgs
    ///                             {
    ///                                 DataType = "String",
    ///                                 Kind = "Range",
    ///                                 Precision = -1,
    ...
    ///             },
    ///             PartitionKey = new AzureNative.DocumentDB.V20190801.Inputs.ContainerPartitionKeyArgs
    ///             {
    ///                 Kind = "Hash",
    ///                 Paths = new[]
    ///                 {
    ...
    ///                 },
    ///             },
    ///             UniqueKeyPolicy = new AzureNative.DocumentDB.V20190801.Inputs.UniqueKeyPolicyArgs
    ///             {
    ///                 UniqueKeys = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20190801.Inputs.UniqueKeyArgs
    ///                     {
    ///                         Paths = new[]
    ///                         {
    ///                             "/testPath",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20190801:SqlResourceSqlContainer containerName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/sqlDatabases/databaseName/containers/containerName 
    /// ```
    /// </summary>
    ...
    public partial class SqlResourceSqlContainer : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlContainer(string name, SqlResourceSqlContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:SqlResourceSqlContainer", name, args ?? new SqlResourceSqlContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:SqlResourceSqlContainer", name, null, MakeResourceOptions(options, id))
        {
        }
