...
namespace Pulumi.AzureRM.DocumentDB.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var mongoDBResourceMongoDBDatabase = new AzureRM.DocumentDB.V20190801.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase", new AzureRM.DocumentDB.V20190801.MongoDBResourceMongoDBDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20190801.Inputs.MongoDBDatabaseResourceArgs
    ///             {
    ///                 Id = "databaseName",
    ///             },
    ...
    public partial class MongoDBResourceMongoDBDatabase : Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBDatabase(string name, MongoDBResourceMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20190801:MongoDBResourceMongoDBDatabase", name, args ?? new MongoDBResourceMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20190801:MongoDBResourceMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
