...
namespace Pulumi.AzureNative.DocumentDB.V20190801
{
    ...
    /// {
    ///     var cassandraResourceCassandraTable = new AzureNative.DocumentDB.V20190801.CassandraResourceCassandraTable("cassandraResourceCassandraTable", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         KeyspaceName = "keyspaceName",
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20190801.Inputs.CassandraTableResourceArgs
    ///         {
    ///             DefaultTtl = 100,
    ///             Id = "tableName",
    ///             Schema = new AzureNative.DocumentDB.V20190801.Inputs.CassandraSchemaArgs
    ///             {
    ///                 ClusterKeys = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20190801.Inputs.ClusterKeyArgs
    ///                     {
    ///                         Name = "columnA",
    ///                         OrderBy = "Asc",
    ///                     },
    ...
    ///                 Columns = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20190801.Inputs.ColumnArgs
    ///                     {
    ///                         Name = "columnA",
    ///                         Type = "Ascii",
    ///                     },
    ...
    ///                 PartitionKeys = new[]
    ///                 {
    ///                     new AzureNative.DocumentDB.V20190801.Inputs.CassandraPartitionKeyArgs
    ///                     {
    ///                         Name = "columnA",
    ///                     },
    ///                 },
    ...
    public partial class CassandraResourceCassandraTable : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraTable(string name, CassandraResourceCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:CassandraResourceCassandraTable", name, args ?? new CassandraResourceCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20190801:CassandraResourceCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
