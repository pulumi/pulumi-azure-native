...
namespace Pulumi.AzureNative.DocumentDB.V20231115Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20231115preview:CassandraCluster")]
    public partial class CassandraCluster : global::Pulumi.CustomResource
    {
        ...
        public CassandraCluster(string name, CassandraClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115preview:CassandraCluster", name, args ?? new CassandraClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115preview:CassandraCluster", name, null, MakeResourceOptions(options, id))
        {
        }
