...
namespace Pulumi.AzureNative.DocumentDB.V20231115Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20231115preview:GremlinResourceGremlinDatabase")]
    public partial class GremlinResourceGremlinDatabase : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinDatabase(string name, GremlinResourceGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115preview:GremlinResourceGremlinDatabase", name, args ?? new GremlinResourceGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115preview:GremlinResourceGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
