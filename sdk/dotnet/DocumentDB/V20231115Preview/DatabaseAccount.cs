...
namespace Pulumi.AzureNative.DocumentDB.V20231115Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20231115preview:DatabaseAccount")]
    public partial class DatabaseAccount : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115preview:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20231115preview:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20231115Preview.ConnectorOffer>? ConnectorOffer { get; set; }
        ...
        public Input<Pulumi.AzureNative.DocumentDB.V20231115Preview.DatabaseAccountOfferType> DatabaseAccountOfferType { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20231115Preview.DefaultPriorityLevel>? DefaultPriorityLevel { get; set; }
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20231115Preview.DatabaseAccountKind>? Kind { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20231115Preview.MinimalTlsVersion>? MinimalTlsVersion { get; set; }

        /// <summary>
        /// Indicates what services are allowed to bypass firewall checks.
        /// </summary>
        [Input("networkAclBypass")]
        public Input<Pulumi.AzureNative.DocumentDB.V20231115Preview.NetworkAclBypass>? NetworkAclBypass { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20231115Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
