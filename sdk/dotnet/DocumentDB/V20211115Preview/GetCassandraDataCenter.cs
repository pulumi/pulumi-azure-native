...
namespace Pulumi.AzureNative.DocumentDB.V20211115Preview
{
    ...
    public static class GetCassandraDataCenter
    {
        ...
        public static Task<GetCassandraDataCenterResult> InvokeAsync(GetCassandraDataCenterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCassandraDataCenterResult>("azure-native:documentdb/v20211115preview:getCassandraDataCenter", args ?? new GetCassandraDataCenterArgs(), options.WithDefaults());
        ...
        public static Output<GetCassandraDataCenterResult> Invoke(GetCassandraDataCenterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCassandraDataCenterResult>("azure-native:documentdb/v20211115preview:getCassandraDataCenter", args ?? new GetCassandraDataCenterInvokeArgs(), options.WithDefaults());
    }
