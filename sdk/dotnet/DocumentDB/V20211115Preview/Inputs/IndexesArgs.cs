...
namespace Pulumi.AzureNative.DocumentDB.V20211115Preview.Inputs
{
    ...
    public sealed class IndexesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20211115Preview.DataType>? DataType { get; set; }

        /// <summary>
        /// Indicates the type of index.
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20211115Preview.IndexKind>? Kind { get; set; }
