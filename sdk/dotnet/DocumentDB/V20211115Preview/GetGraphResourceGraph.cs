...
namespace Pulumi.AzureNative.DocumentDB.V20211115Preview
{
    public static class GetGraphResourceGraph
    {
        ...
        public static Task<GetGraphResourceGraphResult> InvokeAsync(GetGraphResourceGraphArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGraphResourceGraphResult>("azure-native:documentdb/v20211115preview:getGraphResourceGraph", args ?? new GetGraphResourceGraphArgs(), options.WithDefaults());

        /// <summary>
        /// An Azure Cosmos DB Graph resource.
        /// </summary>
        public static Output<GetGraphResourceGraphResult> Invoke(GetGraphResourceGraphInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGraphResourceGraphResult>("azure-native:documentdb/v20211115preview:getGraphResourceGraph", args ?? new GetGraphResourceGraphInvokeArgs(), options.WithDefaults());
    }
