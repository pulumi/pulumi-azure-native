...
namespace Pulumi.AzureNative.DocumentDB.V20211115Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20211115preview:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211115preview:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20211115preview:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("instanceSize")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20211115Preview.ServiceSize>? InstanceSize { get; set; }
        ...
        /// </summary>
        [Input("serviceType")]
        public InputUnion<string, Pulumi.AzureNative.DocumentDB.V20211115Preview.ServiceType>? ServiceType { get; set; }
