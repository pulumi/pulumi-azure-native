...
namespace Pulumi.AzureNative.DocumentDB.V20240515
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240515:MongoDBResourceMongoDBCollection")]
    public partial class MongoDBResourceMongoDBCollection : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBCollection(string name, MongoDBResourceMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240515:MongoDBResourceMongoDBCollection", name, args ?? new MongoDBResourceMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240515:MongoDBResourceMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
