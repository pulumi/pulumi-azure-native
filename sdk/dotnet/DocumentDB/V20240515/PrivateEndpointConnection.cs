...
namespace Pulumi.AzureNative.DocumentDB.V20240515
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240515:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240515:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240515:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
