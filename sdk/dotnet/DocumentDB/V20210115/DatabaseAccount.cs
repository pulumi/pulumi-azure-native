...
namespace Pulumi.AzureNextGen.DocumentDB.V20210115
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20210115:DatabaseAccount")]
    public partial class DatabaseAccount : Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20210115:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20210115:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseAccountArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DocumentDB.V20210115.ConnectorOffer>? ConnectorOffer { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.DocumentDB.V20210115.DatabaseAccountOfferType> DatabaseAccountOfferType { get; set; } = null!;
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNextGen.DocumentDB.V20210115.DatabaseAccountKind>? Kind { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.DocumentDB.V20210115.NetworkAclBypass>? NetworkAclBypass { get; set; }
