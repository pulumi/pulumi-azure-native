...
namespace Pulumi.AzureNative.DocumentDB.V20210115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210115:SqlResourceSqlContainer")]
    public partial class SqlResourceSqlContainer : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlContainer(string name, SqlResourceSqlContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210115:SqlResourceSqlContainer", name, args ?? new SqlResourceSqlContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210115:SqlResourceSqlContainer", name, null, MakeResourceOptions(options, id))
        {
        }
