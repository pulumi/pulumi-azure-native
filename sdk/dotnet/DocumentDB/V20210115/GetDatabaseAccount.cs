...
namespace Pulumi.AzureNextGen.DocumentDB.V20210115
{
    public static class GetDatabaseAccount
    {
        public static Task<GetDatabaseAccountResult> InvokeAsync(GetDatabaseAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountResult>("azure-nextgen:documentdb/v20210115:getDatabaseAccount", args ?? new GetDatabaseAccountArgs(), options.WithVersion());
    }
