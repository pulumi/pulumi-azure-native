...
{
    [Obsolete(@"azure-native:documentdb/v20210115:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20210401preview:DatabaseAccount to guarantee forwards compatibility.")]
    public static class GetDatabaseAccount
    {
        ...
        public static Task<GetDatabaseAccountResult> InvokeAsync(GetDatabaseAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountResult>("azure-native:documentdb/v20210115:getDatabaseAccount", args ?? new GetDatabaseAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves the properties of an existing Azure Cosmos DB database account.
        /// </summary>
        public static Output<GetDatabaseAccountResult> Invoke(GetDatabaseAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountResult>("azure-native:documentdb/v20210115:getDatabaseAccount", args ?? new GetDatabaseAccountInvokeArgs(), options.WithDefaults());
    }
