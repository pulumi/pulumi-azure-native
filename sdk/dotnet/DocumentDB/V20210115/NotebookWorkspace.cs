...
namespace Pulumi.AzureNextGen.DocumentDB.V20210115
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20210115:NotebookWorkspace")]
    public partial class NotebookWorkspace : Pulumi.CustomResource
    {
        ...
        public NotebookWorkspace(string name, NotebookWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20210115:NotebookWorkspace", name, args ?? new NotebookWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20210115:NotebookWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
