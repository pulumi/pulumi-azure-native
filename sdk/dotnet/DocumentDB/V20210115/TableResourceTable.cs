...
namespace Pulumi.AzureNative.DocumentDB.V20210115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20210115:TableResourceTable")]
    public partial class TableResourceTable : global::Pulumi.CustomResource
    {
        ...
        public TableResourceTable(string name, TableResourceTableArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210115:TableResourceTable", name, args ?? new TableResourceTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20210115:TableResourceTable", name, null, MakeResourceOptions(options, id))
        {
        }
