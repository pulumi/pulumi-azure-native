...
namespace Pulumi.AzureNextGen.DocumentDB.V20210115
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20210115:TableResourceTable")]
    public partial class TableResourceTable : Pulumi.CustomResource
    {
        ...
        public TableResourceTable(string name, TableResourceTableArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20210115:TableResourceTable", name, args ?? new TableResourceTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20210115:TableResourceTable", name, null, MakeResourceOptions(options, id))
        {
        }
