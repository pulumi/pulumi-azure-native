...
namespace Pulumi.AzureNative.DocumentDB.V20150401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20150401:DatabaseAccountMongoDBDatabase")]
    public partial class DatabaseAccountMongoDBDatabase : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountMongoDBDatabase(string name, DatabaseAccountMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20150401:DatabaseAccountMongoDBDatabase", name, args ?? new DatabaseAccountMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20150401:DatabaseAccountMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
