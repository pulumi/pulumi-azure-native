...
namespace Pulumi.AzureRM.DocumentDB.V20150401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountCassandraKeyspace = new AzureRM.DocumentDB.V20150401.DatabaseAccountCassandraKeyspace("databaseAccountCassandraKeyspace", new AzureRM.DocumentDB.V20150401.DatabaseAccountCassandraKeyspaceArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             KeyspaceName = "keyspaceName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20150401.Inputs.CassandraKeyspaceResourceArgs
    ///             {
    ///                 Id = "keyspaceName",
    ///             },
    ...
    public partial class DatabaseAccountCassandraKeyspace : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraKeyspace(string name, DatabaseAccountCassandraKeyspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150401:DatabaseAccountCassandraKeyspace", name, args ?? new DatabaseAccountCassandraKeyspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraKeyspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150401:DatabaseAccountCassandraKeyspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:documentdb/latest:DatabaseAccountCassandraKeyspace"},
