...
namespace Pulumi.AzureRM.DocumentDB.V20150401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountSqlContainer = new AzureRM.DocumentDB.V20150401.DatabaseAccountSqlContainer("databaseAccountSqlContainer", new AzureRM.DocumentDB.V20150401.DatabaseAccountSqlContainerArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             ContainerName = "containerName",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20150401.Inputs.SqlContainerResourceArgs
    ///             {
    ///                 ConflictResolutionPolicy = new AzureRM.DocumentDB.V20150401.Inputs.ConflictResolutionPolicyArgs
    ///                 {
    ...
    ///                 DefaultTtl = 100,
    ///                 Id = "containerName",
    ///                 IndexingPolicy = new AzureRM.DocumentDB.V20150401.Inputs.IndexingPolicyArgs
    ///                 {
    ///                     Automatic = true,
    ///                     ExcludedPaths = {},
    ///                     IncludedPaths = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20150401.Inputs.IncludedPathArgs
    ///                         {
    ///                             Indexes = 
    ///                             {
    ///                                 new AzureRM.DocumentDB.V20150401.Inputs.IndexesArgs
    ///                                 {
    ///                                     DataType = "String",
    ///                                     Kind = "Range",
    ///                                     Precision = -1,
    ...
    ///                 },
    ///                 PartitionKey = new AzureRM.DocumentDB.V20150401.Inputs.ContainerPartitionKeyArgs
    ///                 {
    ///                     Kind = "Hash",
    ///                     Paths = 
    ///                     {
    ...
    ///                     },
    ///                 },
    ///                 UniqueKeyPolicy = new AzureRM.DocumentDB.V20150401.Inputs.UniqueKeyPolicyArgs
    ///                 {
    ///                     UniqueKeys = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20150401.Inputs.UniqueKeyArgs
    ///                         {
    ///                             Paths = 
    ///                             {
    ///                                 "/testPath",
