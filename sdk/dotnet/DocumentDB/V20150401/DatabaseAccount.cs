...
namespace Pulumi.AzureRM.DocumentDB.V20150401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccount = new AzureRM.DocumentDB.V20150401.DatabaseAccount("databaseAccount", new AzureRM.DocumentDB.V20150401.DatabaseAccountArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             ConsistencyPolicy = new AzureRM.DocumentDB.V20150401.Inputs.ConsistencyPolicyArgs
    ///             {
    ...
    ///             Locations = 
    ///             {
    ///                 new AzureRM.DocumentDB.V20150401.Inputs.LocationArgs
    ///                 {
    ///                     FailoverPriority = 0,
    ...
    ///             VirtualNetworkRules = 
    ///             {
    ///                 new AzureRM.DocumentDB.V20150401.Inputs.VirtualNetworkRuleArgs
    ///                 {
    ...
    public partial class DatabaseAccount : Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150401:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150401:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
