...
namespace Pulumi.AzureNative.DocumentDB.V20150401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20150401:DatabaseAccountSqlDatabase")]
    public partial class DatabaseAccountSqlDatabase : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountSqlDatabase(string name, DatabaseAccountSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20150401:DatabaseAccountSqlDatabase", name, args ?? new DatabaseAccountSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20150401:DatabaseAccountSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
