...
namespace Pulumi.AzureRM.DocumentDB.V20150401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountCassandraTable = new AzureRM.DocumentDB.V20150401.DatabaseAccountCassandraTable("databaseAccountCassandraTable", new AzureRM.DocumentDB.V20150401.DatabaseAccountCassandraTableArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             KeyspaceName = "tableName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20150401.Inputs.CassandraTableResourceArgs
    ///             {
    ///                 DefaultTtl = 100,
    ///                 Id = "tableName",
    ///                 Schema = new AzureRM.DocumentDB.V20150401.Inputs.CassandraSchemaArgs
    ///                 {
    ///                     ClusterKeys = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20150401.Inputs.ClusterKeyArgs
    ///                         {
    ///                             Name = "columnA",
    ///                             OrderBy = "Asc",
    ///                         },
    ...
    ///                     Columns = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20150401.Inputs.ColumnArgs
    ///                         {
    ///                             Name = "columnA",
    ///                             Type = "Ascii",
    ///                         },
    ...
    ///                     PartitionKeys = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20150401.Inputs.CassandraPartitionKeyArgs
    ///                         {
    ///                             Name = "columnA",
    ///                         },
    ///                     },
    ...
    public partial class DatabaseAccountCassandraTable : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraTable(string name, DatabaseAccountCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150401:DatabaseAccountCassandraTable", name, args ?? new DatabaseAccountCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150401:DatabaseAccountCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
