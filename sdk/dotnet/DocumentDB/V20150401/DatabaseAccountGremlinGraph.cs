...
namespace Pulumi.AzureNextGen.DocumentDB.V20150401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20150401:DatabaseAccountGremlinGraph")]
    public partial class DatabaseAccountGremlinGraph : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountGremlinGraph(string name, DatabaseAccountGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20150401:DatabaseAccountGremlinGraph", name, args ?? new DatabaseAccountGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20150401:DatabaseAccountGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
