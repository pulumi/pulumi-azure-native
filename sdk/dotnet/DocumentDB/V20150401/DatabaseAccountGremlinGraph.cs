...
namespace Pulumi.AzureRM.DocumentDB.V20150401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountGremlinGraph = new AzureRM.DocumentDB.V20150401.DatabaseAccountGremlinGraph("databaseAccountGremlinGraph", new AzureRM.DocumentDB.V20150401.DatabaseAccountGremlinGraphArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             GraphName = "graphName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20150401.Inputs.GremlinGraphResourceArgs
    ///             {
    ...
    public partial class DatabaseAccountGremlinGraph : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountGremlinGraph(string name, DatabaseAccountGremlinGraphArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150401:DatabaseAccountGremlinGraph", name, args ?? new DatabaseAccountGremlinGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountGremlinGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20150401:DatabaseAccountGremlinGraph", name, null, MakeResourceOptions(options, id))
        {
        }
