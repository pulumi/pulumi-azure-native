...
namespace Pulumi.AzureNative.DocumentDB.V20150401
{
    public static class GetDatabaseAccountSqlDatabase
    {
        ...
        public static Task<GetDatabaseAccountSqlDatabaseResult> InvokeAsync(GetDatabaseAccountSqlDatabaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountSqlDatabaseResult>("azure-native:documentdb/v20150401:getDatabaseAccountSqlDatabase", args ?? new GetDatabaseAccountSqlDatabaseArgs(), options.WithVersion());
        ...
        public static Output<GetDatabaseAccountSqlDatabaseResult> Invoke(GetDatabaseAccountSqlDatabaseInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountSqlDatabaseResult>("azure-native:documentdb/v20150401:getDatabaseAccountSqlDatabase", args ?? new GetDatabaseAccountSqlDatabaseInvokeArgs(), options.WithVersion());
    }
