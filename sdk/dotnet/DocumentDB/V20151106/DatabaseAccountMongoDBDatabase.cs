...
namespace Pulumi.AzureNative.DocumentDB.V20151106
{
    ...
    [AzureNativeResourceType("azure-native:documentdb/v20151106:DatabaseAccountMongoDBDatabase")]
    public partial class DatabaseAccountMongoDBDatabase : global::Pulumi.CustomResource
    {
        ...
        public DatabaseAccountMongoDBDatabase(string name, DatabaseAccountMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20151106:DatabaseAccountMongoDBDatabase", name, args ?? new DatabaseAccountMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20151106:DatabaseAccountMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
