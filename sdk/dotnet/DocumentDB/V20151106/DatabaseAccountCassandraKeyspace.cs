...
namespace Pulumi.AzureNextGen.DocumentDB.V20151106
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20151106:DatabaseAccountCassandraKeyspace")]
    public partial class DatabaseAccountCassandraKeyspace : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraKeyspace(string name, DatabaseAccountCassandraKeyspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20151106:DatabaseAccountCassandraKeyspace", name, args ?? new DatabaseAccountCassandraKeyspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraKeyspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20151106:DatabaseAccountCassandraKeyspace", name, null, MakeResourceOptions(options, id))
        {
        }
