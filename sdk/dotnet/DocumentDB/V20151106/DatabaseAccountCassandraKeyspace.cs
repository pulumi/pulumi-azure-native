...
namespace Pulumi.AzureRM.DocumentDB.V20151106
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountCassandraKeyspace = new AzureRM.DocumentDB.V20151106.DatabaseAccountCassandraKeyspace("databaseAccountCassandraKeyspace", new AzureRM.DocumentDB.V20151106.DatabaseAccountCassandraKeyspaceArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             KeyspaceName = "keyspaceName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20151106.Inputs.CassandraKeyspaceResourceArgs
    ///             {
    ///                 Id = "keyspaceName",
    ///             },
    ...
    public partial class DatabaseAccountCassandraKeyspace : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountCassandraKeyspace(string name, DatabaseAccountCassandraKeyspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20151106:DatabaseAccountCassandraKeyspace", name, args ?? new DatabaseAccountCassandraKeyspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountCassandraKeyspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20151106:DatabaseAccountCassandraKeyspace", name, null, MakeResourceOptions(options, id))
        {
        }
