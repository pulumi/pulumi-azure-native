...
namespace Pulumi.AzureRM.DocumentDB.V20151106
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccount = new AzureRM.DocumentDB.V20151106.DatabaseAccount("databaseAccount", new AzureRM.DocumentDB.V20151106.DatabaseAccountArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             ConsistencyPolicy = new AzureRM.DocumentDB.V20151106.Inputs.ConsistencyPolicyArgs
    ///             {
    ...
    ///             Locations = 
    ///             {
    ///                 new AzureRM.DocumentDB.V20151106.Inputs.LocationArgs
    ///                 {
    ///                     FailoverPriority = 0,
    ...
    ///             VirtualNetworkRules = 
    ///             {
    ///                 new AzureRM.DocumentDB.V20151106.Inputs.VirtualNetworkRuleArgs
    ///                 {
    ...
    public partial class DatabaseAccount : Pulumi.CustomResource
    {
        ...
        public DatabaseAccount(string name, DatabaseAccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20151106:DatabaseAccount", name, args ?? new DatabaseAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20151106:DatabaseAccount", name, null, MakeResourceOptions(options, id))
        {
        }
