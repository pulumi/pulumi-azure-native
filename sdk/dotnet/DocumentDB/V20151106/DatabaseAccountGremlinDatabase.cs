...
namespace Pulumi.AzureRM.DocumentDB.V20151106
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountGremlinDatabase = new AzureRM.DocumentDB.V20151106.DatabaseAccountGremlinDatabase("databaseAccountGremlinDatabase", new AzureRM.DocumentDB.V20151106.DatabaseAccountGremlinDatabaseArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             DatabaseName = "databaseName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20151106.Inputs.GremlinDatabaseResourceArgs
    ///             {
    ///                 Id = "databaseName",
    ///             },
    ...
    public partial class DatabaseAccountGremlinDatabase : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountGremlinDatabase(string name, DatabaseAccountGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20151106:DatabaseAccountGremlinDatabase", name, args ?? new DatabaseAccountGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20151106:DatabaseAccountGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
