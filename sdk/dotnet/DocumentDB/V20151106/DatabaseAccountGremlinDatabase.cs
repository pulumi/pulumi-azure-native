...
namespace Pulumi.AzureNextGen.DocumentDB.V20151106
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20151106:DatabaseAccountGremlinDatabase")]
    public partial class DatabaseAccountGremlinDatabase : Pulumi.CustomResource
    {
        ...
        public DatabaseAccountGremlinDatabase(string name, DatabaseAccountGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20151106:DatabaseAccountGremlinDatabase", name, args ?? new DatabaseAccountGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseAccountGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20151106:DatabaseAccountGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
