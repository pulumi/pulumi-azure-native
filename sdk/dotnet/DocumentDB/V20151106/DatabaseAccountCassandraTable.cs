...
namespace Pulumi.AzureRM.DocumentDB.V20151106
{
    ...
    ///     public MyStack()
    ///     {
    ///         var databaseAccountCassandraTable = new AzureRM.DocumentDB.V20151106.DatabaseAccountCassandraTable("databaseAccountCassandraTable", new AzureRM.DocumentDB.V20151106.DatabaseAccountCassandraTableArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             KeyspaceName = "tableName",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20151106.Inputs.CassandraTableResourceArgs
    ///             {
    ///                 DefaultTtl = 100,
    ///                 Id = "tableName",
    ///                 Schema = new AzureRM.DocumentDB.V20151106.Inputs.CassandraSchemaArgs
    ///                 {
    ///                     ClusterKeys = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20151106.Inputs.ClusterKeyArgs
    ///                         {
    ///                             Name = "columnA",
    ///                             OrderBy = "Asc",
    ///                         },
    ...
    ///                     Columns = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20151106.Inputs.ColumnArgs
    ///                         {
    ///                             Name = "columnA",
    ///                             Type = "Ascii",
    ///                         },
    ...
    ///                     PartitionKeys = 
    ///                     {
    ///                         new AzureRM.DocumentDB.V20151106.Inputs.CassandraPartitionKeyArgs
    ///                         {
    ///                             Name = "columnA",
    ///                         },
    ///                     },
