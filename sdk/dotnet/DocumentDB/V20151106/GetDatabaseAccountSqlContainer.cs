...
namespace Pulumi.AzureNative.DocumentDB.V20151106
{
    public static class GetDatabaseAccountSqlContainer
    {
        ...
        public static Task<GetDatabaseAccountSqlContainerResult> InvokeAsync(GetDatabaseAccountSqlContainerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountSqlContainerResult>("azure-native:documentdb/v20151106:getDatabaseAccountSqlContainer", args ?? new GetDatabaseAccountSqlContainerArgs(), options.WithVersion());
        ...
        public static Output<GetDatabaseAccountSqlContainerResult> Invoke(GetDatabaseAccountSqlContainerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDatabaseAccountSqlContainerResult>("azure-native:documentdb/v20151106:getDatabaseAccountSqlContainer", args ?? new GetDatabaseAccountSqlContainerInvokeArgs(), options.WithVersion());
    }
