...
namespace Pulumi.AzureNative.DocumentDB.V20240515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240515preview:ThroughputPool")]
    public partial class ThroughputPool : global::Pulumi.CustomResource
    {
        ...
        public ThroughputPool(string name, ThroughputPoolArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240515preview:ThroughputPool", name, args ?? new ThroughputPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ThroughputPool(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240515preview:ThroughputPool", name, null, MakeResourceOptions(options, id))
        {
        }
