...
namespace Pulumi.AzureNative.DocumentDB.V20240515Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20240515preview:ThroughputPoolAccount")]
    public partial class ThroughputPoolAccount : global::Pulumi.CustomResource
    {
        ...
        public ThroughputPoolAccount(string name, ThroughputPoolAccountArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240515preview:ThroughputPoolAccount", name, args ?? new ThroughputPoolAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ThroughputPoolAccount(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20240515preview:ThroughputPoolAccount", name, null, MakeResourceOptions(options, id))
        {
        }
