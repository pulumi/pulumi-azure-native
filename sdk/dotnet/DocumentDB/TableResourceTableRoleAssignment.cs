...
namespace Pulumi.AzureNative.DocumentDB
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb:TableResourceTableRoleAssignment")]
    public partial class TableResourceTableRoleAssignment : global::Pulumi.CustomResource
    {
        ...
        public TableResourceTableRoleAssignment(string name, TableResourceTableRoleAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb:TableResourceTableRoleAssignment", name, args ?? new TableResourceTableRoleAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTableRoleAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb:TableResourceTableRoleAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
