...
namespace Pulumi.AzureNative.DocumentDB.V20230415
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230415:CassandraDataCenter")]
    public partial class CassandraDataCenter : global::Pulumi.CustomResource
    {
        ...
        public CassandraDataCenter(string name, CassandraDataCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230415:CassandraDataCenter", name, args ?? new CassandraDataCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraDataCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230415:CassandraDataCenter", name, null, MakeResourceOptions(options, id))
        {
        }
