...
namespace Pulumi.AzureNative.DocumentDB.V20230415
{
    /// <summary>
    /// An Azure Cosmos DB MongoDB collection.
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230415:MongoDBResourceMongoDBCollection")]
    public partial class MongoDBResourceMongoDBCollection : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBCollection(string name, MongoDBResourceMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230415:MongoDBResourceMongoDBCollection", name, args ?? new MongoDBResourceMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230415:MongoDBResourceMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
