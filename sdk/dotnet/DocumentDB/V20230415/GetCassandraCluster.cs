...
namespace Pulumi.AzureNative.DocumentDB.V20230415
{
    public static class GetCassandraCluster
    {
        ...
        public static Task<GetCassandraClusterResult> InvokeAsync(GetCassandraClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCassandraClusterResult>("azure-native:documentdb/v20230415:getCassandraCluster", args ?? new GetCassandraClusterArgs(), options.WithDefaults());
