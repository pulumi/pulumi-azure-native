...
namespace Pulumi.AzureNative.DocumentDB.V20230415
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230415:GremlinResourceGremlinDatabase")]
    public partial class GremlinResourceGremlinDatabase : global::Pulumi.CustomResource
    {
        ...
        public GremlinResourceGremlinDatabase(string name, GremlinResourceGremlinDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230415:GremlinResourceGremlinDatabase", name, args ?? new GremlinResourceGremlinDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GremlinResourceGremlinDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230415:GremlinResourceGremlinDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
