...
namespace Pulumi.AzureRM.DocumentDB
{
    public static class GetDatabaseAccount
    {
        public static Task<GetDatabaseAccountResult> InvokeAsync(GetDatabaseAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAccountResult>("azurerm:documentdb:getDatabaseAccount", args ?? new GetDatabaseAccountArgs(), options.WithVersion());
    }
