...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    /// {
    ///     var cassandraCluster = new AzureNative.DocumentDB.V20230301Preview.CassandraCluster("cassandraCluster", new()
    ///     {
    ///         ClusterName = "cassandra-prod",
    ///         Location = "West US",
    ///         Properties = new AzureNative.DocumentDB.V20230301Preview.Inputs.ClusterResourcePropertiesArgs
    ///         {
    ///             AuthenticationMethod = "Cassandra",
    ///             CassandraVersion = "3.11",
    ///             ClientCertificates = new[]
    ///             {
    ///                 new AzureNative.DocumentDB.V20230301Preview.Inputs.CertificateArgs
    ///                 {
    ...
    ///             {
    ///                 new AzureNative.DocumentDB.V20230301Preview.Inputs.SeedNodeArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230301preview:CassandraCluster")]
    public partial class CassandraCluster : global::Pulumi.CustomResource
    {
        ...
        public CassandraCluster(string name, CassandraClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:CassandraCluster", name, args ?? new CassandraClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:CassandraCluster", name, null, MakeResourceOptions(options, id))
        {
        }
