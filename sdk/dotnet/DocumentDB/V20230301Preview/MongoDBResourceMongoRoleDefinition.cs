...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    /// {
    ///     var mongoDBResourceMongoRoleDefinition = new AzureNative.DocumentDB.V20230301Preview.MongoDBResourceMongoRoleDefinition("mongoDBResourceMongoRoleDefinition", new()
    ///     {
    ...
    ///         Privileges = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20230301Preview.Inputs.PrivilegeArgs
    ///             {
    ///                 Actions = new[]
    ///                 {
    ///                     "insert",
    ///                     "find",
    ///                 },
    ///                 Resource = new AzureNative.DocumentDB.V20230301Preview.Inputs.PrivilegeResourceArgs
    ///                 {
    ///                     Collection = "sales",
    ///                     Db = "sales",
    ///                 },
    ...
    public sealed class MongoDBResourceMongoRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.DocumentDB.V20230301Preview.MongoRoleDefinitionType>? Type { get; set; }
