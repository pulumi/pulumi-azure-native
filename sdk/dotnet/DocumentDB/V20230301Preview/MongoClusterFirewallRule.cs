...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    public partial class MongoClusterFirewallRule : global::Pulumi.CustomResource
    {
        ...
        public MongoClusterFirewallRule(string name, MongoClusterFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:MongoClusterFirewallRule", name, args ?? new MongoClusterFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoClusterFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:MongoClusterFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
