...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    /// {
    ///     var sqlResourceSqlTrigger = new AzureNative.DocumentDB.V20230301Preview.SqlResourceSqlTrigger("sqlResourceSqlTrigger", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         ContainerName = "containerName",
    ///         DatabaseName = "databaseName",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20230301Preview.Inputs.SqlTriggerResourceArgs
    ///         {
    ///             Body = "body",
    ///             Id = "triggerName",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230301preview:SqlResourceSqlTrigger")]
    public partial class SqlResourceSqlTrigger : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
