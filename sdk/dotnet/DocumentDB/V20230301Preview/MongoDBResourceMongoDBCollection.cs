...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    /// {
    ///     var mongoDBResourceMongoDBCollection = new AzureNative.DocumentDB.V20230301Preview.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection", new()
    ///     {
    ///         AccountName = "ddb1",
    ...
    ///         Location = "West US",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20230301Preview.Inputs.MongoDBCollectionResourceArgs
    ///         {
    ///             AnalyticalStorageTtl = 500,
    ///             Id = "collectionName",
    ///             Indexes = new[]
    ///             {
    ///                 new AzureNative.DocumentDB.V20230301Preview.Inputs.MongoIndexArgs
    ///                 {
    ///                     Key = new AzureNative.DocumentDB.V20230301Preview.Inputs.MongoIndexKeysArgs
    ///                     {
    ///                         Keys = new[]
    ///                         {
    ///                             "_ts",
    ///                         },
    ///                     },
    ///                     Options = new AzureNative.DocumentDB.V20230301Preview.Inputs.MongoIndexOptionsArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230301preview:MongoDBResourceMongoDBCollection")]
    public partial class MongoDBResourceMongoDBCollection : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBCollection(string name, MongoDBResourceMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:MongoDBResourceMongoDBCollection", name, args ?? new MongoDBResourceMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:MongoDBResourceMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
