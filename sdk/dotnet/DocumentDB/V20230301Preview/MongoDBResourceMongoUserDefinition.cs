...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    /// {
    ///     var mongoDBResourceMongoUserDefinition = new AzureNative.DocumentDB.V20230301Preview.MongoDBResourceMongoUserDefinition("mongoDBResourceMongoUserDefinition", new()
    ///     {
    ...
    ///         Roles = new[]
    ///         {
    ///             new AzureNative.DocumentDB.V20230301Preview.Inputs.RoleArgs
    ///             {
    ///                 Db = "sales",
    ///                 Role = "myReadRole",
    ///             },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20230301preview:MongoDBResourceMongoUserDefinition myUserName /subscriptions/mySubscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.DocumentDB/databaseAccounts/myAccountName/mongodbUserDefinitions/myUserId 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230301preview:MongoDBResourceMongoUserDefinition")]
    public partial class MongoDBResourceMongoUserDefinition : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoUserDefinition(string name, MongoDBResourceMongoUserDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:MongoDBResourceMongoUserDefinition", name, args ?? new MongoDBResourceMongoUserDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoUserDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:MongoDBResourceMongoUserDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
