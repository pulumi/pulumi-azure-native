...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    /// {
    ///     var cassandraDataCenter = new AzureNative.DocumentDB.V20230301Preview.CassandraDataCenter("cassandraDataCenter", new()
    ///     {
    ///         ClusterName = "cassandra-prod",
    ///         DataCenterName = "dc1",
    ///         Properties = new AzureNative.DocumentDB.V20230301Preview.Inputs.DataCenterResourcePropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230301preview:CassandraDataCenter")]
    public partial class CassandraDataCenter : global::Pulumi.CustomResource
    {
        ...
        public CassandraDataCenter(string name, CassandraDataCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:CassandraDataCenter", name, args ?? new CassandraDataCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraDataCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:CassandraDataCenter", name, null, MakeResourceOptions(options, id))
        {
        }
