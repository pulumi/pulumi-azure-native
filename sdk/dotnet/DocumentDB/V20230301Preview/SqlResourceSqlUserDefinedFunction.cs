...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    /// {
    ///     var sqlResourceSqlUserDefinedFunction = new AzureNative.DocumentDB.V20230301Preview.SqlResourceSqlUserDefinedFunction("sqlResourceSqlUserDefinedFunction", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         ContainerName = "containerName",
    ///         DatabaseName = "databaseName",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20230301Preview.Inputs.SqlUserDefinedFunctionResourceArgs
    ///         {
    ///             Body = "body",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:documentdb/v20230301preview:SqlResourceSqlUserDefinedFunction userDefinedFunctionName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/sqlDatabases/databaseName/sqlContainers/containerName/sqlUserDefinedFunctions/userDefinedFunctionName 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230301preview:SqlResourceSqlUserDefinedFunction")]
    public partial class SqlResourceSqlUserDefinedFunction : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlUserDefinedFunction(string name, SqlResourceSqlUserDefinedFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:SqlResourceSqlUserDefinedFunction", name, args ?? new SqlResourceSqlUserDefinedFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlUserDefinedFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:SqlResourceSqlUserDefinedFunction", name, null, MakeResourceOptions(options, id))
        {
        }
