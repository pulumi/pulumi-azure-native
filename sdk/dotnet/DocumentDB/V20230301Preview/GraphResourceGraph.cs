...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230301preview:GraphResourceGraph")]
    public partial class GraphResourceGraph : global::Pulumi.CustomResource
    {
        ...
        [Output("options")]
        public Output<Outputs.GraphResourceGetPropertiesResponseOptions?> Options { get; private set; } = null!;

        [Output("resource")]
        public Output<Outputs.GraphResourceGetPropertiesResponseResource?> Resource { get; private set; } = null!;
        ...
        public GraphResourceGraph(string name, GraphResourceGraphArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:GraphResourceGraph", name, args ?? new GraphResourceGraphArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphResourceGraph(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:GraphResourceGraph", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:documentdb/v20240515preview:GraphResourceGraph" },
                    new global::Pulumi.Alias { Type = "azure-native:documentdb/v20240901preview:GraphResourceGraph" },
                    new global::Pulumi.Alias { Type = "azure-native:documentdb/v20241201preview:GraphResourceGraph" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GraphResourceGraph Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
