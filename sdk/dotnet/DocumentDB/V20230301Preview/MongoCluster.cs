...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    public partial class MongoCluster : global::Pulumi.CustomResource
    {
        ...
        public MongoCluster(string name, MongoClusterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:MongoCluster", name, args ?? new MongoClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:MongoCluster", name, null, MakeResourceOptions(options, id))
        {
        }
