...
namespace Pulumi.AzureNative.DocumentDB.V20230301Preview
{
    ...
    /// {
    ///     var cassandraResourceCassandraView = new AzureNative.DocumentDB.V20230301Preview.CassandraResourceCassandraView("cassandraResourceCassandraView", new()
    ///     {
    ///         AccountName = "ddb1",
    ///         KeyspaceName = "keyspacename",
    ///         Options = null,
    ///         Resource = new AzureNative.DocumentDB.V20230301Preview.Inputs.CassandraViewResourceArgs
    ///         {
    ///             Id = "viewname",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20230301preview:CassandraResourceCassandraView")]
    public partial class CassandraResourceCassandraView : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraView(string name, CassandraResourceCassandraViewArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:CassandraResourceCassandraView", name, args ?? new CassandraResourceCassandraViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraView(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20230301preview:CassandraResourceCassandraView", name, null, MakeResourceOptions(options, id))
        {
        }
