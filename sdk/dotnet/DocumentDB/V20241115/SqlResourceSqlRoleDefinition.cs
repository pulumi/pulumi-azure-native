...
namespace Pulumi.AzureNative.DocumentDB.V20241115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20241115:SqlResourceSqlRoleDefinition")]
    public partial class SqlResourceSqlRoleDefinition : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlRoleDefinition(string name, SqlResourceSqlRoleDefinitionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241115:SqlResourceSqlRoleDefinition", name, args ?? new SqlResourceSqlRoleDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlRoleDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241115:SqlResourceSqlRoleDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlResourceSqlRoleDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.DocumentDB.V20241115.RoleDefinitionType>? Type { get; set; }
