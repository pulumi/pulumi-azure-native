...
namespace Pulumi.AzureNative.DocumentDB.V20241115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20241115:CassandraResourceCassandraKeyspace")]
    public partial class CassandraResourceCassandraKeyspace : global::Pulumi.CustomResource
    {
        ...
        public CassandraResourceCassandraKeyspace(string name, CassandraResourceCassandraKeyspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241115:CassandraResourceCassandraKeyspace", name, args ?? new CassandraResourceCassandraKeyspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraKeyspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241115:CassandraResourceCassandraKeyspace", name, null, MakeResourceOptions(options, id))
        {
        }
