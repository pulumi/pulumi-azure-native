...
namespace Pulumi.AzureNative.DocumentDB.V20241115
{
    /// <summary>
    /// A managed Cassandra data center.
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20241115:CassandraDataCenter")]
    public partial class CassandraDataCenter : global::Pulumi.CustomResource
    {
        ...
        public CassandraDataCenter(string name, CassandraDataCenterArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241115:CassandraDataCenter", name, args ?? new CassandraDataCenterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraDataCenter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241115:CassandraDataCenter", name, null, MakeResourceOptions(options, id))
        {
        }
