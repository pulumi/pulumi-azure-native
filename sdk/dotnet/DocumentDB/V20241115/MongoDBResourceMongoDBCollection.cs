...
namespace Pulumi.AzureNative.DocumentDB.V20241115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20241115:MongoDBResourceMongoDBCollection")]
    public partial class MongoDBResourceMongoDBCollection : global::Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBCollection(string name, MongoDBResourceMongoDBCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241115:MongoDBResourceMongoDBCollection", name, args ?? new MongoDBResourceMongoDBCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBCollection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20241115:MongoDBResourceMongoDBCollection", name, null, MakeResourceOptions(options, id))
        {
        }
