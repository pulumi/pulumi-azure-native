...
namespace Pulumi.AzureRM.DocumentDB.V20200401
{
    ...
    public partial class CassandraResourceCassandraTable : Pulumi.CustomResource
    {
        ...
        [Output("options")]
        public Output<Outputs.CassandraTableGetPropertiesResponseOptionsResult?> Options { get; private set; } = null!;
        ...
        public CassandraResourceCassandraTable(string name, CassandraResourceCassandraTableArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200401:CassandraResourceCassandraTable", name, args ?? new CassandraResourceCassandraTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CassandraResourceCassandraTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200401:CassandraResourceCassandraTable", name, null, MakeResourceOptions(options, id))
        {
        }
