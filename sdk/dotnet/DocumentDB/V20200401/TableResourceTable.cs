...
namespace Pulumi.AzureNextGen.DocumentDB.V20200401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20200401:TableResourceTable")]
    public partial class TableResourceTable : Pulumi.CustomResource
    {
        ...
        public TableResourceTable(string name, TableResourceTableArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200401:TableResourceTable", name, args ?? new TableResourceTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200401:TableResourceTable", name, null, MakeResourceOptions(options, id))
        {
        }
