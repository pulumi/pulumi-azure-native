...
namespace Pulumi.AzureRM.DocumentDB.V20200401
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tableResourceTable = new AzureRM.DocumentDB.V20200401.TableResourceTable("tableResourceTable", new AzureRM.DocumentDB.V20200401.TableResourceTableArgs
    ///         {
    ///             AccountName = "ddb1",
    ///             Location = "West US",
    ///             Options = ,
    ///             Resource = new AzureRM.DocumentDB.V20200401.Inputs.TableResourceArgs
    ///             {
    ///                 Id = "tableName",
    ///             },
    ...
    public partial class TableResourceTable : Pulumi.CustomResource
    {
        ...
        [Output("options")]
        public Output<Outputs.TableGetPropertiesResponseOptionsResult?> Options { get; private set; } = null!;

        [Output("resource")]
        public Output<Outputs.TableGetPropertiesResponseResourceResult?> Resource { get; private set; } = null!;
        ...
        public TableResourceTable(string name, TableResourceTableArgs args, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200401:TableResourceTable", name, args ?? new TableResourceTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TableResourceTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:documentdb/v20200401:TableResourceTable", name, null, MakeResourceOptions(options, id))
        {
        }
