...
azure-native:documentdb/v20200401:SqlResourceSqlTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:SqlResourceSqlTrigger to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:documentdb/v20200401:SqlResourceSqlTrigger")]
    public partial class SqlResourceSqlTrigger : global::Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlTrigger(string name, SqlResourceSqlTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200401:SqlResourceSqlTrigger", name, args ?? new SqlResourceSqlTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200401:SqlResourceSqlTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
