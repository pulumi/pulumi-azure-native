...
namespace Pulumi.AzureNative.DocumentDB.V20200401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:documentdb/v20200401:NotebookWorkspace")]
    public partial class NotebookWorkspace : Pulumi.CustomResource
    {
        ...
        public NotebookWorkspace(string name, NotebookWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200401:NotebookWorkspace", name, args ?? new NotebookWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotebookWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200401:NotebookWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
