...
namespace Pulumi.AzureNextGen.DocumentDB.V20200401
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:documentdb/v20200401:MongoDBResourceMongoDBDatabase")]
    public partial class MongoDBResourceMongoDBDatabase : Pulumi.CustomResource
    {
        ...
        public MongoDBResourceMongoDBDatabase(string name, MongoDBResourceMongoDBDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200401:MongoDBResourceMongoDBDatabase", name, args ?? new MongoDBResourceMongoDBDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoDBResourceMongoDBDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:documentdb/v20200401:MongoDBResourceMongoDBDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
