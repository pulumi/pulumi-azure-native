...
namespace Pulumi.AzureNative.DocumentDB.V20200401
{
    ...
    public partial class SqlResourceSqlDatabase : Pulumi.CustomResource
    {
        ...
        public SqlResourceSqlDatabase(string name, SqlResourceSqlDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200401:SqlResourceSqlDatabase", name, args ?? new SqlResourceSqlDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlResourceSqlDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:documentdb/v20200401:SqlResourceSqlDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
