...
namespace Pulumi.AzureRM.DocumentDB.V20200401
{
    public static class GetTableResourceTable
    {
        public static Task<GetTableResourceTableResult> InvokeAsync(GetTableResourceTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTableResourceTableResult>("azurerm:documentdb/v20200401:getTableResourceTable", args ?? new GetTableResourceTableArgs(), options.WithVersion());
    }
    ...
    public sealed class GetTableResourceTableResult
    {
        ...
        /// </summary>
        public readonly Outputs.TableGetPropertiesResponseResult Properties;
        /// <summary>
        ...
        private GetTableResourceTableResult(
            ...
            Outputs.TableGetPropertiesResponseResult properties,
