...
namespace Pulumi.AzureRM.Blockchain.Preview
{
    public static class GetBlockchainMember
    {
        public static Task<GetBlockchainMemberResult> InvokeAsync(GetBlockchainMemberArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlockchainMemberResult>("azurerm:blockchain/preview:getBlockchainMember", args ?? new GetBlockchainMemberArgs(), options.WithVersion());
    }
