...
namespace Pulumi.AzureRM.Blockchain.Preview
{
    ...
    public partial class TransactionNode : Pulumi.CustomResource
    {
        ...
        public TransactionNode(string name, TransactionNodeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:blockchain/preview:TransactionNode", name, args ?? new TransactionNodeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransactionNode(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:blockchain/preview:TransactionNode", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:blockchain/v20180601preview:TransactionNode"},
                },
            };
