...
namespace Pulumi.AzureRM.Blockchain.Preview
{
    public static class ListTransactionNodeApiKeys
    {
        public static Task<ListTransactionNodeApiKeysResult> InvokeAsync(ListTransactionNodeApiKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTransactionNodeApiKeysResult>("azurerm:blockchain/preview:listTransactionNodeApiKeys", args ?? new ListTransactionNodeApiKeysArgs(), options.WithVersion());
    }
