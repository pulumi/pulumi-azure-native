...
namespace Pulumi.AzureRM.Blockchain.Preview
{
    /// <summary>
    ...
    public partial class BlockchainMember : Pulumi.CustomResource
    {
        ...
        public BlockchainMember(string name, BlockchainMemberArgs args, CustomResourceOptions? options = null)
            : base("azurerm:blockchain/preview:BlockchainMember", name, args ?? new BlockchainMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlockchainMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:blockchain/preview:BlockchainMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:blockchain/v20180601preview:BlockchainMember"},
                },
            };
