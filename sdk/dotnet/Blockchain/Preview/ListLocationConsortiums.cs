...
namespace Pulumi.AzureRM.Blockchain.Preview
{
    public static class ListLocationConsortiums
    {
        public static Task<ListLocationConsortiumsResult> InvokeAsync(ListLocationConsortiumsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListLocationConsortiumsResult>("azurerm:blockchain/preview:listLocationConsortiums", args ?? new ListLocationConsortiumsArgs(), options.WithVersion());
    }
