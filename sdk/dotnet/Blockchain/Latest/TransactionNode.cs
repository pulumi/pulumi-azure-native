...
namespace Pulumi.AzureRM.Blockchain.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var transactionNode = new AzureRM.Blockchain.Latest.TransactionNode("transactionNode", new AzureRM.Blockchain.Latest.TransactionNodeArgs
    ///         {
    ...
    public partial class TransactionNode : Pulumi.CustomResource
    {
        ...
        public TransactionNode(string name, TransactionNodeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:blockchain/latest:TransactionNode", name, args ?? new TransactionNodeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransactionNode(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:blockchain/latest:TransactionNode", name, null, MakeResourceOptions(options, id))
        {
        }
