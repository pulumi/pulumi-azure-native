...
namespace Pulumi.AzureRM.Blockchain.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var blockchainMember = new AzureRM.Blockchain.Latest.BlockchainMember("blockchainMember", new AzureRM.Blockchain.Latest.BlockchainMemberArgs
    ///         {
    ...
    ///             ValidatorNodesSku = new AzureRM.Blockchain.Latest.Inputs.BlockchainMemberNodesSkuArgs
    ///             {
    ///                 Capacity = 2,
    ///             },
    ///         });
    ...
    public partial class BlockchainMember : Pulumi.CustomResource
    {
        ...
        public BlockchainMember(string name, BlockchainMemberArgs args, CustomResourceOptions? options = null)
            : base("azurerm:blockchain/latest:BlockchainMember", name, args ?? new BlockchainMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BlockchainMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:blockchain/latest:BlockchainMember", name, null, MakeResourceOptions(options, id))
        {
        }
