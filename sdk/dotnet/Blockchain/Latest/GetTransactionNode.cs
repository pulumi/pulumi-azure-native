...
namespace Pulumi.AzureRM.Blockchain.Latest
{
    public static class GetTransactionNode
    {
        public static Task<GetTransactionNodeResult> InvokeAsync(GetTransactionNodeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTransactionNodeResult>("azurerm:blockchain/latest:getTransactionNode", args ?? new GetTransactionNodeArgs(), options.WithVersion());
    }
