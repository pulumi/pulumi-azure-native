...
namespace Pulumi.AzureRM.Blockchain.Latest
{
    public static class GetBlockchainMember
    {
        public static Task<GetBlockchainMemberResult> InvokeAsync(GetBlockchainMemberArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlockchainMemberResult>("azurerm:blockchain/latest:getBlockchainMember", args ?? new GetBlockchainMemberArgs(), options.WithVersion());
    }
