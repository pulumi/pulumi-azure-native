...
namespace Pulumi.AzureNative.MongoCluster.V20240601Preview
{
    public static class GetMongoCluster
    {
        ...
        public static Task<GetMongoClusterResult> InvokeAsync(GetMongoClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMongoClusterResult>("azure-native:mongocluster/v20240601preview:getMongoCluster", args ?? new GetMongoClusterArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a mongo cluster.
        /// </summary>
        public static Output<GetMongoClusterResult> Invoke(GetMongoClusterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMongoClusterResult>("azure-native:mongocluster/v20240601preview:getMongoCluster", args ?? new GetMongoClusterInvokeArgs(), options.WithDefaults());
