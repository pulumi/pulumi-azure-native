...
namespace Pulumi.AzureNative.MongoCluster.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mongocluster/v20241001preview:MongoClusterFirewallRule")]
    public partial class MongoClusterFirewallRule : global::Pulumi.CustomResource
    {
        ...
        public MongoClusterFirewallRule(string name, MongoClusterFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mongocluster/v20241001preview:MongoClusterFirewallRule", name, args ?? new MongoClusterFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoClusterFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mongocluster/v20241001preview:MongoClusterFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
