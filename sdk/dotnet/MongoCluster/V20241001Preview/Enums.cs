...
namespace Pulumi.AzureNative.MongoCluster.V20241001Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct DataApiMode : IEquatable<DataApiMode>
    {
        private readonly string _value;

        private DataApiMode(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static DataApiMode Enabled { get; } = new DataApiMode("Enabled");
        /// <summary>
        /// Mongo Data API is disabled for the cluster.
        /// </summary>
        public static DataApiMode Disabled { get; } = new DataApiMode("Disabled");

        public static bool operator ==(DataApiMode left, DataApiMode right) => left.Equals(right);
        public static bool operator !=(DataApiMode left, DataApiMode right) => !left.Equals(right);

        public static explicit operator string(DataApiMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is DataApiMode other && Equals(other);
        public bool Equals(DataApiMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
