...
namespace Pulumi.AzureNative.MongoCluster
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:mongocluster:MongoClusterFirewallRule")]
    public partial class MongoClusterFirewallRule : global::Pulumi.CustomResource
    {
        ...
        public MongoClusterFirewallRule(string name, MongoClusterFirewallRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:mongocluster:MongoClusterFirewallRule", name, args ?? new MongoClusterFirewallRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MongoClusterFirewallRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:mongocluster:MongoClusterFirewallRule", name, null, MakeResourceOptions(options, id))
        {
        }
