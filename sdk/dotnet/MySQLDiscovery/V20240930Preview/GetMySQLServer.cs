...
namespace Pulumi.AzureNative.MySQLDiscovery.V20240930Preview
{
    public static class GetMySQLServer
    {
        ...
        public static Task<GetMySQLServerResult> InvokeAsync(GetMySQLServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMySQLServerResult>("azure-native:mysqldiscovery/v20240930preview:getMySQLServer", args ?? new GetMySQLServerArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the MySQLServers resource.
        /// </summary>
        public static Output<GetMySQLServerResult> Invoke(GetMySQLServerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMySQLServerResult>("azure-native:mysqldiscovery/v20240930preview:getMySQLServer", args ?? new GetMySQLServerInvokeArgs(), options.WithDefaults());
