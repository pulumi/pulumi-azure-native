...
namespace Pulumi.AzureNative.MySQLDiscovery.V20240930Preview
{
    public static class GetMySQLSite
    {
        ...
        public static Task<GetMySQLSiteResult> InvokeAsync(GetMySQLSiteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMySQLSiteResult>("azure-native:mysqldiscovery/v20240930preview:getMySQLSite", args ?? new GetMySQLSiteArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the MySQLSites resource.
        /// </summary>
        public static Output<GetMySQLSiteResult> Invoke(GetMySQLSiteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMySQLSiteResult>("azure-native:mysqldiscovery/v20240930preview:getMySQLSite", args ?? new GetMySQLSiteInvokeArgs(), options.WithDefaults());
