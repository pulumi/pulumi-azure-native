...
namespace Pulumi.AzureNative.Web.V20200901
{
    ...
    [AzureNativeResourceType("azure-native:web/v20200901:WebAppDeploymentSlot")]
    public partial class WebAppDeploymentSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppDeploymentSlot(string name, WebAppDeploymentSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppDeploymentSlot", name, args ?? new WebAppDeploymentSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDeploymentSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppDeploymentSlot", name, null, MakeResourceOptions(options, id))
        {
        }
