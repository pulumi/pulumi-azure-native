...
namespace Pulumi.AzureNextGen.Web.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200901:AppServicePlanRouteForVnet")]
    public partial class AppServicePlanRouteForVnet : Pulumi.CustomResource
    {
        ...
        public AppServicePlanRouteForVnet(string name, AppServicePlanRouteForVnetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:AppServicePlanRouteForVnet", name, args ?? new AppServicePlanRouteForVnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlanRouteForVnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:AppServicePlanRouteForVnet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServicePlanRouteForVnetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("routeType")]
        public InputUnion<string, Pulumi.AzureNextGen.Web.V20200901.RouteType>? RouteType { get; set; }
