...
namespace Pulumi.AzureNextGen.Web.V20200901
{
    public static class GetWebAppFunction
    {
        public static Task<GetWebAppFunctionResult> InvokeAsync(GetWebAppFunctionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppFunctionResult>("azure-nextgen:web/v20200901:getWebAppFunction", args ?? new GetWebAppFunctionArgs(), options.WithVersion());
    }
