...
namespace Pulumi.AzureNextGen.Web.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200901:WebAppAuthSettingsSlot")]
    public partial class WebAppAuthSettingsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettingsSlot(string name, WebAppAuthSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:WebAppAuthSettingsSlot", name, args ?? new WebAppAuthSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:WebAppAuthSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
