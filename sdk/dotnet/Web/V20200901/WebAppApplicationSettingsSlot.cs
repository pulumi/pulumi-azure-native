...
namespace Pulumi.AzureNative.Web.V20200901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20200901:WebAppApplicationSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppApplicationSettingsSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20200901:WebAppApplicationSettingsSlot")]
    public partial class WebAppApplicationSettingsSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppApplicationSettingsSlot(string name, WebAppApplicationSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppApplicationSettingsSlot", name, args ?? new WebAppApplicationSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppApplicationSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppApplicationSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
