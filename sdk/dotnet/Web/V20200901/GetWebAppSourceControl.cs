...
namespace Pulumi.AzureNextGen.Web.V20200901
{
    public static class GetWebAppSourceControl
    {
        public static Task<GetWebAppSourceControlResult> InvokeAsync(GetWebAppSourceControlArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppSourceControlResult>("azure-nextgen:web/v20200901:getWebAppSourceControl", args ?? new GetWebAppSourceControlArgs(), options.WithVersion());
    }
