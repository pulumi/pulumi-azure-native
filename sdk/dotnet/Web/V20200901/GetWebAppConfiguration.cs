...
namespace Pulumi.AzureNative.Web.V20200901
{
    public static class GetWebAppConfiguration
    {
        ...
        public static Task<GetWebAppConfigurationResult> InvokeAsync(GetWebAppConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppConfigurationResult>("azure-native:web/v20200901:getWebAppConfiguration", args ?? new GetWebAppConfigurationArgs(), options.WithVersion());
    }
