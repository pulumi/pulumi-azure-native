...
{
    [Obsolete(@"azure-native:web/v20200901:WebAppSiteExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSiteExtension to guarantee forwards compatibility.")]
    public static class GetWebAppSiteExtension
    {
        ...
        public static Task<GetWebAppSiteExtensionResult> InvokeAsync(GetWebAppSiteExtensionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppSiteExtensionResult>("azure-native:web/v20200901:getWebAppSiteExtension", args ?? new GetWebAppSiteExtensionArgs(), options.WithDefaults());
        ...
        public static Output<GetWebAppSiteExtensionResult> Invoke(GetWebAppSiteExtensionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebAppSiteExtensionResult>("azure-native:web/v20200901:getWebAppSiteExtension", args ?? new GetWebAppSiteExtensionInvokeArgs(), options.WithDefaults());
    }
