...
namespace Pulumi.AzureNative.Web.V20200901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20200901:WebAppBackupConfigurationSlot")]
    public partial class WebAppBackupConfigurationSlot : Pulumi.CustomResource
    {
        ...
        public WebAppBackupConfigurationSlot(string name, WebAppBackupConfigurationSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppBackupConfigurationSlot", name, args ?? new WebAppBackupConfigurationSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppBackupConfigurationSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppBackupConfigurationSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppBackupConfigurationSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:WebAppBackupConfigurationSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppBackupConfigurationSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppBackupConfigurationSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppBackupConfigurationSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppBackupConfigurationSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppBackupConfigurationSlot"},
                },
            };
