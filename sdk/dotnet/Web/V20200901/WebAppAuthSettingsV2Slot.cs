...
{
    [Obsolete(@"azure-native:web/v20200901:WebAppAuthSettingsV2Slot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAuthSettingsV2Slot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20200901:WebAppAuthSettingsV2Slot")]
    public partial class WebAppAuthSettingsV2Slot : global::Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettingsV2Slot(string name, WebAppAuthSettingsV2SlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppAuthSettingsV2Slot", name, args ?? new WebAppAuthSettingsV2SlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettingsV2Slot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppAuthSettingsV2Slot", name, null, MakeResourceOptions(options, id))
        {
        }
