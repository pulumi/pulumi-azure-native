...
namespace Pulumi.AzureNextGen.Web.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200901:WebAppSwiftVirtualNetworkConnectionSlot")]
    public partial class WebAppSwiftVirtualNetworkConnectionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSwiftVirtualNetworkConnectionSlot(string name, WebAppSwiftVirtualNetworkConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:WebAppSwiftVirtualNetworkConnectionSlot", name, args ?? new WebAppSwiftVirtualNetworkConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSwiftVirtualNetworkConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:WebAppSwiftVirtualNetworkConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
