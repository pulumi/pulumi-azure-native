...
namespace Pulumi.AzureNextGen.Web.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200901:WebAppAuthSettings")]
    public partial class WebAppAuthSettings : Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettings(string name, WebAppAuthSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:WebAppAuthSettings", name, args ?? new WebAppAuthSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:WebAppAuthSettings", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppAuthSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Web.V20200901.BuiltInAuthenticationProvider>? DefaultProvider { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Web.V20200901.UnauthenticatedClientAction>? UnauthenticatedClientAction { get; set; }
