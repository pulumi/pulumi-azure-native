...
namespace Pulumi.AzureNative.Web.V20200901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20200901:WebAppConfiguration")]
    public partial class WebAppConfiguration : Pulumi.CustomResource
    {
        ...
        public WebAppConfiguration(string name, WebAppConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppConfiguration", name, args ?? new WebAppConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
