...
namespace Pulumi.AzureNative.Web.V20200901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20200901:WebAppSitePushSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSitePushSettings to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20200901:WebAppSitePushSettings")]
    public partial class WebAppSitePushSettings : global::Pulumi.CustomResource
    {
        ...
        public WebAppSitePushSettings(string name, WebAppSitePushSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppSitePushSettings", name, args ?? new WebAppSitePushSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSitePushSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200901:WebAppSitePushSettings", name, null, MakeResourceOptions(options, id))
        {
        }
