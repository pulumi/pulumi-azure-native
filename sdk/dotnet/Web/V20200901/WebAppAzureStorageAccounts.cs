...
namespace Pulumi.AzureNextGen.Web.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200901:WebAppAzureStorageAccounts")]
    public partial class WebAppAzureStorageAccounts : Pulumi.CustomResource
    {
        ...
        public WebAppAzureStorageAccounts(string name, WebAppAzureStorageAccountsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:WebAppAzureStorageAccounts", name, args ?? new WebAppAzureStorageAccountsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAzureStorageAccounts(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200901:WebAppAzureStorageAccounts", name, null, MakeResourceOptions(options, id))
        {
        }
