...
namespace Pulumi.AzureRM.Web
{
    ...
    public partial class AppServiceSlotDomainOwnershipIdentifier : Pulumi.CustomResource
    {
        ...
        private AppServiceSlotDomainOwnershipIdentifier(string name, Input<string> id, AppServiceSlotDomainOwnershipIdentifierState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:web:AppServiceSlotDomainOwnershipIdentifier", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AppServiceSlotDomainOwnershipIdentifier Get(string name, Input<string> id, AppServiceSlotDomainOwnershipIdentifierState? state = null, CustomResourceOptions? options = null)
        {
            return new AppServiceSlotDomainOwnershipIdentifier(name, id, state, options);
        }
    }
    ...
    public sealed class AppServiceSlotDomainOwnershipIdentifierState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Kind of resource.
        /// </summary>
        ...
        public AppServiceSlotDomainOwnershipIdentifierState()
        {
        }
    }
}
