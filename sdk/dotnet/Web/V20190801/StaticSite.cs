...
namespace Pulumi.AzureRM.Web.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var staticSite = new AzureRM.Web.V20190801.StaticSite("staticSite", new AzureRM.Web.V20190801.StaticSiteArgs
    ///         {
    ///             Branch = "master",
    ///             BuildProperties = new AzureRM.Web.V20190801.Inputs.StaticSiteBuildPropertiesArgs
    ///             {
    ///                 ApiLocation = "api",
    ...
    ///             Sku = new AzureRM.Web.V20190801.Inputs.SkuDescriptionArgs
    ///             {
    ///                 Name = "Basic",
    ///                 Tier = "Basic",
    ///             },
    ...
    public partial class StaticSite : Pulumi.CustomResource
    {
        ...
        public StaticSite(string name, StaticSiteArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/v20190801:StaticSite", name, args ?? new StaticSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/v20190801:StaticSite", name, null, MakeResourceOptions(options, id))
        {
        }
