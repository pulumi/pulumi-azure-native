...
namespace Pulumi.AzureNative.Web.V20190801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20190801:AppServiceEnvironment")]
    public partial class AppServiceEnvironment : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironment(string name, AppServiceEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:AppServiceEnvironment", name, args ?? new AppServiceEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:AppServiceEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceEnvironmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20190801.InternalLoadBalancingMode>? InternalLoadBalancingMode { get; set; }
