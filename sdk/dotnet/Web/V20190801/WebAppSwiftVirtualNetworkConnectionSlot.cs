...
namespace Pulumi.AzureNextGen.Web.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot")]
    public partial class WebAppSwiftVirtualNetworkConnectionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSwiftVirtualNetworkConnectionSlot(string name, WebAppSwiftVirtualNetworkConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot", name, args ?? new WebAppSwiftVirtualNetworkConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSwiftVirtualNetworkConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
