...
namespace Pulumi.AzureNative.Web.V20190801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20190801:AppServicePlanRouteForVnet is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:AppServicePlanRouteForVnet to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20190801:AppServicePlanRouteForVnet")]
    public partial class AppServicePlanRouteForVnet : global::Pulumi.CustomResource
    {
        ...
        public AppServicePlanRouteForVnet(string name, AppServicePlanRouteForVnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:AppServicePlanRouteForVnet", name, args ?? new AppServicePlanRouteForVnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlanRouteForVnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:AppServicePlanRouteForVnet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServicePlanRouteForVnetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("routeType")]
        public InputUnion<string, Pulumi.AzureNative.Web.V20190801.RouteType>? RouteType { get; set; }
