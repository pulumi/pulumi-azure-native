...
namespace Pulumi.AzureNative.Web.V20190801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20190801:WebAppRelayServiceConnection")]
    public partial class WebAppRelayServiceConnection : global::Pulumi.CustomResource
    {
        ...
        public WebAppRelayServiceConnection(string name, WebAppRelayServiceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebAppRelayServiceConnection", name, args ?? new WebAppRelayServiceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppRelayServiceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebAppRelayServiceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
