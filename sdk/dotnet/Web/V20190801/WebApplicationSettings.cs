...
namespace Pulumi.AzureNextGen.Web.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20190801:WebApplicationSettings")]
    public partial class WebApplicationSettings : Pulumi.CustomResource
    {
        ...
        public WebApplicationSettings(string name, WebApplicationSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebApplicationSettings", name, args ?? new WebApplicationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApplicationSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebApplicationSettings", name, null, MakeResourceOptions(options, id))
        {
        }
