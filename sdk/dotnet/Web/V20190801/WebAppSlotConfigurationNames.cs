        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:web/v20201001:WebAppSlotConfigurationNames"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201001:WebAppSlotConfigurationNames"},
                    new Pulumi.Alias { Type = "azure-native:web/v20201201:WebAppSlotConfigurationNames"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppSlotConfigurationNames"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:WebAppSlotConfigurationNames"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppSlotConfigurationNames"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppSlotConfigurationNames"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppSlotConfigurationNames"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppSlotConfigurationNames"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppSlotConfigurationNames"},
                },
            };
