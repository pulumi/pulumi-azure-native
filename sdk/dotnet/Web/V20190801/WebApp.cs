...
namespace Pulumi.AzureNative.Web.V20190801
{
    ...
    public partial class WebApp : Pulumi.CustomResource
    {
        ...
        public WebApp(string name, WebAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebApp", name, args ?? new WebAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebApp", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebApp"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:WebApp"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebApp"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebApp"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebApp"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebApp"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebApp"},
                },
            };
