...
namespace Pulumi.AzureNextGen.Web.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20190801:WebAppMetadataSlot")]
    public partial class WebAppMetadataSlot : Pulumi.CustomResource
    {
        ...
        public WebAppMetadataSlot(string name, WebAppMetadataSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppMetadataSlot", name, args ?? new WebAppMetadataSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppMetadataSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppMetadataSlot", name, null, MakeResourceOptions(options, id))
        {
        }
