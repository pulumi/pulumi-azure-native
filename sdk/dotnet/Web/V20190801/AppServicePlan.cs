...
namespace Pulumi.AzureRM.Web.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var appServicePlan = new AzureRM.Web.V20190801.AppServicePlan("appServicePlan", new AzureRM.Web.V20190801.AppServicePlanArgs
    ///         {
    ///             Kind = "app",
    ///             Location = "East US",
    ///             Name = "testsf6141",
    ...
    public partial class AppServicePlan : Pulumi.CustomResource
    {
        ...
        public AppServicePlan(string name, AppServicePlanArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/v20190801:AppServicePlan", name, args ?? new AppServicePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/v20190801:AppServicePlan", name, null, MakeResourceOptions(options, id))
        {
        }
