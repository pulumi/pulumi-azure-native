...
namespace Pulumi.AzureRM.Web.V20190801
{
    public static class ListWebAppMetadataSlot
    {
        public static Task<ListWebAppMetadataSlotResult> InvokeAsync(ListWebAppMetadataSlotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebAppMetadataSlotResult>("azurerm:web/v20190801:listWebAppMetadataSlot", args ?? new ListWebAppMetadataSlotArgs(), options.WithVersion());
    }
