...
namespace Pulumi.AzureNative.Web.V20190801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20190801:WebAppInstanceFunctionSlot")]
    public partial class WebAppInstanceFunctionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppInstanceFunctionSlot(string name, WebAppInstanceFunctionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebAppInstanceFunctionSlot", name, args ?? new WebAppInstanceFunctionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppInstanceFunctionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebAppInstanceFunctionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppInstanceFunctionSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:WebAppInstanceFunctionSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppInstanceFunctionSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppInstanceFunctionSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppInstanceFunctionSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppInstanceFunctionSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppInstanceFunctionSlot"},
                },
            };
