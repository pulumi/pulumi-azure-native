...
namespace Pulumi.AzureNative.Web.V20190801
{
    public static class ListWebAppHostKeys
    {
        ...
        public static Task<ListWebAppHostKeysResult> InvokeAsync(ListWebAppHostKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWebAppHostKeysResult>("azure-native:web/v20190801:listWebAppHostKeys", args ?? new ListWebAppHostKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Get host secrets for a function app.
        /// </summary>
        public static Output<ListWebAppHostKeysResult> Invoke(ListWebAppHostKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListWebAppHostKeysResult>("azure-native:web/v20190801:listWebAppHostKeys", args ?? new ListWebAppHostKeysInvokeArgs(), options.WithDefaults());
    }
