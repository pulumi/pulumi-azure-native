...
{
    [Obsolete(@"azure-native:web/v20190801:WebAppDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppDeployment to guarantee forwards compatibility.")]
    public static class GetWebAppDeployment
    {
        ...
        public static Task<GetWebAppDeploymentResult> InvokeAsync(GetWebAppDeploymentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppDeploymentResult>("azure-native:web/v20190801:getWebAppDeployment", args ?? new GetWebAppDeploymentArgs(), options.WithDefaults());

        /// <summary>
        /// Get a deployment by its ID for an app, or a deployment slot.
        /// </summary>
        public static Output<GetWebAppDeploymentResult> Invoke(GetWebAppDeploymentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebAppDeploymentResult>("azure-native:web/v20190801:getWebAppDeployment", args ?? new GetWebAppDeploymentInvokeArgs(), options.WithDefaults());
    }
