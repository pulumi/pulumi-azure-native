...
namespace Pulumi.AzureNextGen.Web.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20190801:WebAppPublicCertificate")]
    public partial class WebAppPublicCertificate : Pulumi.CustomResource
    {
        ...
        public WebAppPublicCertificate(string name, WebAppPublicCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppPublicCertificate", name, args ?? new WebAppPublicCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPublicCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppPublicCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppPublicCertificateArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Web.V20190801.PublicCertificateLocation>? PublicCertificateLocation { get; set; }
