...
namespace Pulumi.AzureNextGen.Web.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20190801:WebAppDeployment")]
    public partial class WebAppDeployment : Pulumi.CustomResource
    {
        ...
        public WebAppDeployment(string name, WebAppDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppDeployment", name, args ?? new WebAppDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
