...
namespace Pulumi.AzureNative.Web.V20190801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20190801:WebAppVnetConnection")]
    public partial class WebAppVnetConnection : Pulumi.CustomResource
    {
        ...
        public WebAppVnetConnection(string name, WebAppVnetConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebAppVnetConnection", name, args ?? new WebAppVnetConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppVnetConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebAppVnetConnection", name, null, MakeResourceOptions(options, id))
        {
        }
