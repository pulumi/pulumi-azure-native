...
namespace Pulumi.AzureNative.Web.V20190801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20190801:WebAppFunction")]
    public partial class WebAppFunction : Pulumi.CustomResource
    {
        ...
        public WebAppFunction(string name, WebAppFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebAppFunction", name, args ?? new WebAppFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20190801:WebAppFunction", name, null, MakeResourceOptions(options, id))
        {
        }
