...
namespace Pulumi.AzureNextGen.Web.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20190801:WebAppBackupConfigurationSlot")]
    public partial class WebAppBackupConfigurationSlot : Pulumi.CustomResource
    {
        ...
        public WebAppBackupConfigurationSlot(string name, WebAppBackupConfigurationSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppBackupConfigurationSlot", name, args ?? new WebAppBackupConfigurationSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppBackupConfigurationSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppBackupConfigurationSlot", name, null, MakeResourceOptions(options, id))
        {
        }
