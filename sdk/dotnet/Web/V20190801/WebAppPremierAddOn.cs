...
namespace Pulumi.AzureNextGen.Web.V20190801
{
    ...
    /// Premier add-on.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20190801:WebAppPremierAddOn")]
    public partial class WebAppPremierAddOn : Pulumi.CustomResource
    {
        ...
        public WebAppPremierAddOn(string name, WebAppPremierAddOnArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppPremierAddOn", name, args ?? new WebAppPremierAddOnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPremierAddOn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20190801:WebAppPremierAddOn", name, null, MakeResourceOptions(options, id))
        {
        }
