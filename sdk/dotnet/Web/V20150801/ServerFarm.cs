        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:ServerFarm"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:ServerFarm"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:ServerFarm"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:ServerFarm"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:ServerFarm"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:ServerFarm"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:ServerFarm"},
                },
            };
