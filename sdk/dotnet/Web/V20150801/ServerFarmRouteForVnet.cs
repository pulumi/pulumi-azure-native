    ...
    public partial class ServerFarmRouteForVnet : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20150801:ServerFarmRouteForVnet"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:ServerFarmRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:ServerFarmRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:ServerFarmRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:ServerFarmRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:ServerFarmRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:ServerFarmRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:ServerFarmRouteForVnet"},
                },
            };
