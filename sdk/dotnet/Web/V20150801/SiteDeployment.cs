    ...
    public partial class SiteDeployment : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20150801:SiteDeployment"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:SiteDeployment"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:SiteDeployment"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:SiteDeployment"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:SiteDeployment"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:SiteDeployment"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:SiteDeployment"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:SiteDeployment"},
                },
            };
