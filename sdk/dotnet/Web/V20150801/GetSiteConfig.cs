...
{
    public static class GetSiteConfig
    {
        /// <summary>
        /// Configuration of Azure web site
        /// </summary>
        public static Task<GetSiteConfigResult> InvokeAsync(GetSiteConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSiteConfigResult>("azure-native:web/v20150801:getSiteConfig", args ?? new GetSiteConfigArgs(), options.WithVersion());
    }


    public sealed class GetSiteConfigArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// Name of web app
        /// </summary>
    ...
    [OutputType]
    public sealed class GetSiteConfigResult
    {
        /// <summary>
        /// Always On
        /// </summary>
