    ...
    public partial class SiteSourceControl : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:web/v20160801:SiteSourceControl"},
                    new Alias { Type = "azurerm:web/v20180201:SiteSourceControl"},
                    new Alias { Type = "azurerm:web/v20181101:SiteSourceControl"},
                    new Alias { Type = "azurerm:web/v20190801:SiteSourceControl"},
                    new Alias { Type = "azurerm:web/v20200601:SiteSourceControl"},
                },
            };
