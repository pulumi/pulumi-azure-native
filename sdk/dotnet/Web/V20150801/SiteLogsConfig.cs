    ...
    public partial class SiteLogsConfig : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20150801:SiteLogsConfig"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:SiteLogsConfig"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:SiteLogsConfig"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:SiteLogsConfig"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:SiteLogsConfig"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:SiteLogsConfig"},
                },
            };
