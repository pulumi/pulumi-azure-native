...
namespace Pulumi.AzureNative.Web.V20150801
{
    ...
    public partial class SiteBackupConfiguration : Pulumi.CustomResource
    {
        ...
        public SiteBackupConfiguration(string name, SiteBackupConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20150801:SiteBackupConfiguration", name, args ?? new SiteBackupConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SiteBackupConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20150801:SiteBackupConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201001:SiteBackupConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:web/v20201201:SiteBackupConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:SiteBackupConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:SiteBackupConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:SiteBackupConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:SiteBackupConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:SiteBackupConfiguration"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:SiteBackupConfiguration"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:SiteBackupConfiguration"},
                },
            };
