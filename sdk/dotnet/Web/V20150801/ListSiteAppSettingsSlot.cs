...
namespace Pulumi.AzureRM.Web.V20150801
{
    public static class ListSiteAppSettingsSlot
    {
        public static Task<ListSiteAppSettingsSlotResult> InvokeAsync(ListSiteAppSettingsSlotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListSiteAppSettingsSlotResult>("azurerm:web/v20150801:listSiteAppSettingsSlot", args ?? new ListSiteAppSettingsSlotArgs(), options.WithVersion());
    }
