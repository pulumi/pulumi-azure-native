...
namespace Pulumi.AzureNative.Web.V20150801
{
    ...
    public partial class SiteSlot : Pulumi.CustomResource
    {
        ...
        public SiteSlot(string name, SiteSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20150801:SiteSlot", name, args ?? new SiteSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SiteSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20150801:SiteSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201001:SiteSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20201201:SiteSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:SiteSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:SiteSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:SiteSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:SiteSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:SiteSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:SiteSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:SiteSlot"},
                },
            };
