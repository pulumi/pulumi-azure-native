...
namespace Pulumi.AzureNative.Web.V20150801.Inputs
{
    ...
    public sealed class BackupScheduleArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20150801.FrequencyUnit> FrequencyUnit { get; set; } = null!;
    ...
    public sealed class BackupSchedule : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("frequencyUnit", required: true)]
        public Pulumi.AzureNative.Web.V20150801.FrequencyUnit FrequencyUnit { get; set; }
