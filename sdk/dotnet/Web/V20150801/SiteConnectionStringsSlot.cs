    ...
    public partial class SiteConnectionStringsSlot : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20150801:SiteConnectionStringsSlot"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:SiteConnectionStringsSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:SiteConnectionStringsSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:SiteConnectionStringsSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:SiteConnectionStringsSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:SiteConnectionStringsSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:SiteConnectionStringsSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:SiteConnectionStringsSlot"},
                },
            };
