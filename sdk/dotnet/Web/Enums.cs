...
namespace Pulumi.AzureNative.Web
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct IPMode : IEquatable<IPMode>
    {
        private readonly string _value;
        ...
        public static IPMode IPv4 { get; } = new IPMode("IPv4");
        public static IPMode IPv6 { get; } = new IPMode("IPv6");
        public static IPMode IPv4AndIPv6 { get; } = new IPMode("IPv4AndIPv6");

        public static bool operator ==(IPMode left, IPMode right) => left.Equals(right);
        public static bool operator !=(IPMode left, IPMode right) => !left.Equals(right);

        public static explicit operator string(IPMode value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is IPMode other && Equals(other);
        public bool Equals(IPMode other) => string.Equals(_value, other._value, StringComparison.Ordinal);
    ...
    public readonly struct SiteLoadBalancing : IEquatable<SiteLoadBalancing>
    {
        ...
        public static SiteLoadBalancing LeastRequestsWithTieBreaker { get; } = new SiteLoadBalancing("LeastRequestsWithTieBreaker");
