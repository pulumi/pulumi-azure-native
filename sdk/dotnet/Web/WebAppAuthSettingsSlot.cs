...
namespace Pulumi.AzureNextGen.Web
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web:WebAppAuthSettingsSlot")]
    public partial class WebAppAuthSettingsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettingsSlot(string name, WebAppAuthSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:WebAppAuthSettingsSlot", name, args ?? new WebAppAuthSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:WebAppAuthSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppAuthSettingsSlotArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Web.BuiltInAuthenticationProvider>? DefaultProvider { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Web.UnauthenticatedClientAction>? UnauthenticatedClientAction { get; set; }
