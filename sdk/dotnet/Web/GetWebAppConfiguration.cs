...
namespace Pulumi.AzureNative.Web
{
    public static class GetWebAppConfiguration
    {
        ...
        public static Task<GetWebAppConfigurationResult> InvokeAsync(GetWebAppConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppConfigurationResult>("azure-native:web:getWebAppConfiguration", args ?? new GetWebAppConfigurationArgs(), options.WithVersion());
    }
