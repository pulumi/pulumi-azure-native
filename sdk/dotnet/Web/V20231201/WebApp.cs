...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:WebApp")]
    public partial class WebApp : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("daprConfig")]
        public Output<Outputs.DaprConfigResponse?> DaprConfig { get; private set; } = null!;
        ...
        /// </summary>
        [Output("dnsConfiguration")]
        public Output<Outputs.SiteDnsConfigResponse?> DnsConfiguration { get; private set; } = null!;
        ...
        /// </summary>
        [Output("functionAppConfig")]
        public Output<Outputs.FunctionAppConfigResponse?> FunctionAppConfig { get; private set; } = null!;
        ...
        public Output<Outputs.ResourceConfigResponse?> ResourceConfig { get; private set; } = null!;
        ...
        public WebApp(string name, WebAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebApp", name, args ?? new WebAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebApp", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20231201.ClientCertMode>? ClientCertMode { get; set; }
        ...
        /// </summary>
        [Input("daprConfig")]
        public Input<Inputs.DaprConfigArgs>? DaprConfig { get; set; }

        /// <summary>
        /// Property to configure various DNS related settings for a site.
        /// </summary>
        [Input("dnsConfiguration")]
        public Input<Inputs.SiteDnsConfigArgs>? DnsConfiguration { get; set; }
        ...
        /// Configuration specific of the Azure Function app.
        /// </summary>
        [Input("functionAppConfig")]
        public Input<Inputs.FunctionAppConfigArgs>? FunctionAppConfig { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20231201.RedundancyMode>? RedundancyMode { get; set; }
