...
namespace Pulumi.AzureNative.Web.V20231201
{
    public static class ListWebAppWorkflowsConnections
    {
        ...
        public static Task<ListWebAppWorkflowsConnectionsResult> InvokeAsync(ListWebAppWorkflowsConnectionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWebAppWorkflowsConnectionsResult>("azure-native:web/v20231201:listWebAppWorkflowsConnections", args ?? new ListWebAppWorkflowsConnectionsArgs(), options.WithDefaults());
