...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild")]
    public partial class StaticSiteUserProvidedFunctionAppForStaticSiteBuild : global::Pulumi.CustomResource
    {
        ...
        public StaticSiteUserProvidedFunctionAppForStaticSiteBuild(string name, StaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, args ?? new StaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private StaticSiteUserProvidedFunctionAppForStaticSiteBuild(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, null, MakeResourceOptions(options, id))
        {
        }
