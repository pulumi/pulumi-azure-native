...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:KubeEnvironment")]
    public partial class KubeEnvironment : global::Pulumi.CustomResource
    {
        ...
        public KubeEnvironment(string name, KubeEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:KubeEnvironment", name, args ?? new KubeEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KubeEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:KubeEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
