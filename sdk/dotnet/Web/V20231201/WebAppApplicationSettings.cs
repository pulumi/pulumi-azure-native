...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:WebAppApplicationSettings")]
    public partial class WebAppApplicationSettings : global::Pulumi.CustomResource
    {
        ...
        public WebAppApplicationSettings(string name, WebAppApplicationSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppApplicationSettings", name, args ?? new WebAppApplicationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppApplicationSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppApplicationSettings", name, null, MakeResourceOptions(options, id))
        {
        }
