...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// Container of a site
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:WebAppSiteContainerSlot")]
    public partial class WebAppSiteContainerSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppSiteContainerSlot(string name, WebAppSiteContainerSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppSiteContainerSlot", name, args ?? new WebAppSiteContainerSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteContainerSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppSiteContainerSlot", name, null, MakeResourceOptions(options, id))
        {
        }
