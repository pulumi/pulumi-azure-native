...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:AppServiceEnvironmentAseCustomDnsSuffixConfiguration")]
    public partial class AppServiceEnvironmentAseCustomDnsSuffixConfiguration : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironmentAseCustomDnsSuffixConfiguration(string name, AppServiceEnvironmentAseCustomDnsSuffixConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, args ?? new AppServiceEnvironmentAseCustomDnsSuffixConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AppServiceEnvironmentAseCustomDnsSuffixConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
