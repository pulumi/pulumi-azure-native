...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:WebAppDeployment")]
    public partial class WebAppDeployment : global::Pulumi.CustomResource
    {
        ...
        public WebAppDeployment(string name, WebAppDeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppDeployment", name, args ?? new WebAppDeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDeployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppDeployment", name, null, MakeResourceOptions(options, id))
        {
        }
