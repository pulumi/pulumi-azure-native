...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:StaticSiteLinkedBackend")]
    public partial class StaticSiteLinkedBackend : global::Pulumi.CustomResource
    {
        ...
        public StaticSiteLinkedBackend(string name, StaticSiteLinkedBackendArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:StaticSiteLinkedBackend", name, args ?? new StaticSiteLinkedBackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSiteLinkedBackend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:StaticSiteLinkedBackend", name, null, MakeResourceOptions(options, id))
        {
        }
