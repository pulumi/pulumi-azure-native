...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// Container App.
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:ContainerApp")]
    public partial class ContainerApp : global::Pulumi.CustomResource
    {
        ...
        public ContainerApp(string name, ContainerAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:ContainerApp", name, args ?? new ContainerAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:ContainerApp", name, null, MakeResourceOptions(options, id))
        {
        }
