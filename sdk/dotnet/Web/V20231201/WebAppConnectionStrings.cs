...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:WebAppConnectionStrings")]
    public partial class WebAppConnectionStrings : global::Pulumi.CustomResource
    {
        ...
        public WebAppConnectionStrings(string name, WebAppConnectionStringsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppConnectionStrings", name, args ?? new WebAppConnectionStringsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConnectionStrings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppConnectionStrings", name, null, MakeResourceOptions(options, id))
        {
        }
