...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:WebAppSiteExtensionSlot")]
    public partial class WebAppSiteExtensionSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppSiteExtensionSlot(string name, WebAppSiteExtensionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppSiteExtensionSlot", name, args ?? new WebAppSiteExtensionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteExtensionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppSiteExtensionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
