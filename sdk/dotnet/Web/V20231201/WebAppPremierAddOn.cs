...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// Premier add-on.
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:WebAppPremierAddOn")]
    public partial class WebAppPremierAddOn : global::Pulumi.CustomResource
    {
        ...
        public WebAppPremierAddOn(string name, WebAppPremierAddOnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppPremierAddOn", name, args ?? new WebAppPremierAddOnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPremierAddOn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppPremierAddOn", name, null, MakeResourceOptions(options, id))
        {
        }
