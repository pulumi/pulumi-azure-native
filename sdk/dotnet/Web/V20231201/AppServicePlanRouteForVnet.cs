...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:AppServicePlanRouteForVnet")]
    public partial class AppServicePlanRouteForVnet : global::Pulumi.CustomResource
    {
        ...
        public AppServicePlanRouteForVnet(string name, AppServicePlanRouteForVnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:AppServicePlanRouteForVnet", name, args ?? new AppServicePlanRouteForVnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlanRouteForVnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:AppServicePlanRouteForVnet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServicePlanRouteForVnetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("routeType")]
        public InputUnion<string, Pulumi.AzureNative.Web.V20231201.RouteType>? RouteType { get; set; }
