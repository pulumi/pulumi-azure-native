...
namespace Pulumi.AzureNative.Web.V20231201
{
    public static class GetWebAppSiteContainerSlot
    {
        ...
        public static Task<GetWebAppSiteContainerSlotResult> InvokeAsync(GetWebAppSiteContainerSlotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppSiteContainerSlotResult>("azure-native:web/v20231201:getWebAppSiteContainerSlot", args ?? new GetWebAppSiteContainerSlotArgs(), options.WithDefaults());
        ...
        public static Output<GetWebAppSiteContainerSlotResult> Invoke(GetWebAppSiteContainerSlotInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebAppSiteContainerSlotResult>("azure-native:web/v20231201:getWebAppSiteContainerSlot", args ?? new GetWebAppSiteContainerSlotInvokeArgs(), options.WithDefaults());
    }
