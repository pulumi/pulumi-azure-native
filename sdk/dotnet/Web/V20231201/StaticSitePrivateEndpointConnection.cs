...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:StaticSitePrivateEndpointConnection")]
    public partial class StaticSitePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public StaticSitePrivateEndpointConnection(string name, StaticSitePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:StaticSitePrivateEndpointConnection", name, args ?? new StaticSitePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSitePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:StaticSitePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
