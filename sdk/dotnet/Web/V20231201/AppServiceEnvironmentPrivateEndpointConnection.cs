...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:AppServiceEnvironmentPrivateEndpointConnection")]
    public partial class AppServiceEnvironmentPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironmentPrivateEndpointConnection(string name, AppServiceEnvironmentPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:AppServiceEnvironmentPrivateEndpointConnection", name, args ?? new AppServiceEnvironmentPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironmentPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:AppServiceEnvironmentPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
