...
namespace Pulumi.AzureNative.Web.V20231201
{
    ...
    /// Container of a site
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20231201:WebAppSiteContainer")]
    public partial class WebAppSiteContainer : global::Pulumi.CustomResource
    {
        ...
        public WebAppSiteContainer(string name, WebAppSiteContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppSiteContainer", name, args ?? new WebAppSiteContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20231201:WebAppSiteContainer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:web:WebAppSiteContainer" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WebAppSiteContainer Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new WebAppSiteContainer(name, id, options);
        }
    }

    public sealed class WebAppSiteContainerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Auth Type
        /// </summary>
        [Input("authType")]
        public Input<Pulumi.AzureNative.Web.V20231201.AuthType>? AuthType { get; set; }
        ...
        public WebAppSiteContainerArgs()
        {
        }
        public static new WebAppSiteContainerArgs Empty => new WebAppSiteContainerArgs();
    }
}
