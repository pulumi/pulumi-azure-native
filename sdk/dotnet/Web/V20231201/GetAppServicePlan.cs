...
namespace Pulumi.AzureNative.Web.V20231201
{
    public static class GetAppServicePlan
    {
        ...
        public static Task<GetAppServicePlanResult> InvokeAsync(GetAppServicePlanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppServicePlanResult>("azure-native:web/v20231201:getAppServicePlan", args ?? new GetAppServicePlanArgs(), options.WithDefaults());
