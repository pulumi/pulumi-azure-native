...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:AppServiceEnvironment")]
    public partial class AppServiceEnvironment : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironment(string name, AppServiceEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:AppServiceEnvironment", name, args ?? new AppServiceEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:AppServiceEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceEnvironmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20240401.LoadBalancingMode>? InternalLoadBalancingMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20240401.UpgradePreference>? UpgradePreference { get; set; }
