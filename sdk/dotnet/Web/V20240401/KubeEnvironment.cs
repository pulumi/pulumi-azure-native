...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:KubeEnvironment")]
    public partial class KubeEnvironment : global::Pulumi.CustomResource
    {
        ...
        public KubeEnvironment(string name, KubeEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:KubeEnvironment", name, args ?? new KubeEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KubeEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:KubeEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
