...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// Container of a site
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:WebAppSiteContainer")]
    public partial class WebAppSiteContainer : global::Pulumi.CustomResource
    {
        ...
        public WebAppSiteContainer(string name, WebAppSiteContainerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppSiteContainer", name, args ?? new WebAppSiteContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteContainer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppSiteContainer", name, null, MakeResourceOptions(options, id))
        {
        }
