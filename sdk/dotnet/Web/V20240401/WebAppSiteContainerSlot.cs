...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// Container of a site
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:WebAppSiteContainerSlot")]
    public partial class WebAppSiteContainerSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppSiteContainerSlot(string name, WebAppSiteContainerSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppSiteContainerSlot", name, args ?? new WebAppSiteContainerSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteContainerSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppSiteContainerSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppSiteContainerSlotArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("authType")]
        public Input<Pulumi.AzureNative.Web.V20240401.AuthType>? AuthType { get; set; }
