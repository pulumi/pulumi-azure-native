...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:WebAppPrivateEndpointConnectionSlot")]
    public partial class WebAppPrivateEndpointConnectionSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppPrivateEndpointConnectionSlot(string name, WebAppPrivateEndpointConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppPrivateEndpointConnectionSlot", name, args ?? new WebAppPrivateEndpointConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPrivateEndpointConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppPrivateEndpointConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
