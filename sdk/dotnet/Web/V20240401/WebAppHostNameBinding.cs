...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:WebAppHostNameBinding")]
    public partial class WebAppHostNameBinding : global::Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBinding(string name, WebAppHostNameBindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppHostNameBinding", name, args ?? new WebAppHostNameBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppHostNameBinding", name, null, MakeResourceOptions(options, id))
        {
        }
