...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:WebAppSlot")]
    public partial class WebAppSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppSlot(string name, WebAppSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppSlot", name, args ?? new WebAppSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppSlotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20240401.AutoGeneratedDomainNameLabelScope>? AutoGeneratedDomainNameLabelScope { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20240401.ClientCertMode>? ClientCertMode { get; set; }
        ...
        /// </summary>
        [Input("ipMode")]
        public Input<Pulumi.AzureNative.Web.V20240401.IPMode>? IpMode { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20240401.RedundancyMode>? RedundancyMode { get; set; }
