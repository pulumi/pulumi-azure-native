...
namespace Pulumi.AzureNative.Web.V20240401
{
    public static class ListWebAppWorkflowsConnections
    {
        ...
        public static Task<ListWebAppWorkflowsConnectionsResult> InvokeAsync(ListWebAppWorkflowsConnectionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWebAppWorkflowsConnectionsResult>("azure-native:web/v20240401:listWebAppWorkflowsConnections", args ?? new ListWebAppWorkflowsConnectionsArgs(), options.WithDefaults());
        ...
        public static Output<ListWebAppWorkflowsConnectionsResult> Invoke(ListWebAppWorkflowsConnectionsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListWebAppWorkflowsConnectionsResult>("azure-native:web/v20240401:listWebAppWorkflowsConnections", args ?? new ListWebAppWorkflowsConnectionsInvokeArgs(), options.WithDefaults());
    }
