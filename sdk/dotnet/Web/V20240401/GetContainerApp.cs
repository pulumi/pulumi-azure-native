...
namespace Pulumi.AzureNative.Web.V20240401
{
    public static class GetContainerApp
    {
        ...
        public static Task<GetContainerAppResult> InvokeAsync(GetContainerAppArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContainerAppResult>("azure-native:web/v20240401:getContainerApp", args ?? new GetContainerAppArgs(), options.WithDefaults());

        /// <summary>
        /// Container App.
        /// </summary>
        public static Output<GetContainerAppResult> Invoke(GetContainerAppInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContainerAppResult>("azure-native:web/v20240401:getContainerApp", args ?? new GetContainerAppInvokeArgs(), options.WithDefaults());
    }
