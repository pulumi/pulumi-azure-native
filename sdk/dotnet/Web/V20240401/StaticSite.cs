...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:StaticSite")]
    public partial class StaticSite : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.DatabaseConnectionOverviewResponse>> DatabaseConnections { get; private set; } = null!;
        ...
        /// </summary>
        [Output("linkedBackends")]
        public Output<ImmutableArray<Outputs.StaticSiteLinkedBackendResponse>> LinkedBackends { get; private set; } = null!;
        ...
        public StaticSite(string name, StaticSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:StaticSite", name, args ?? new StaticSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:StaticSite", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StaticSiteArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20240401.EnterpriseGradeCdnStatus>? EnterpriseGradeCdnStatus { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20240401.StagingEnvironmentPolicy>? StagingEnvironmentPolicy { get; set; }
