...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// App Service plan.
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:AppServicePlan")]
    public partial class AppServicePlan : global::Pulumi.CustomResource
    {
        ...
        public AppServicePlan(string name, AppServicePlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:AppServicePlan", name, args ?? new AppServicePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:AppServicePlan", name, null, MakeResourceOptions(options, id))
        {
        }
