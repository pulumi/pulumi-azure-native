...
namespace Pulumi.AzureNative.Web.V20240401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20240401:WebAppPrivateEndpointConnection")]
    public partial class WebAppPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public WebAppPrivateEndpointConnection(string name, WebAppPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppPrivateEndpointConnection", name, args ?? new WebAppPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20240401:WebAppPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
