...
namespace Pulumi.AzureNative.Web.V20220901
{
    public static class ListWebAppWorkflowsConnectionsSlot
    {
        ...
        public static Task<ListWebAppWorkflowsConnectionsSlotResult> InvokeAsync(ListWebAppWorkflowsConnectionsSlotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWebAppWorkflowsConnectionsSlotResult>("azure-native:web/v20220901:listWebAppWorkflowsConnectionsSlot", args ?? new ListWebAppWorkflowsConnectionsSlotArgs(), options.WithDefaults());
        ...
        public static Output<ListWebAppWorkflowsConnectionsSlotResult> Invoke(ListWebAppWorkflowsConnectionsSlotInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListWebAppWorkflowsConnectionsSlotResult>("azure-native:web/v20220901:listWebAppWorkflowsConnectionsSlot", args ?? new ListWebAppWorkflowsConnectionsSlotInvokeArgs(), options.WithDefaults());
    }
