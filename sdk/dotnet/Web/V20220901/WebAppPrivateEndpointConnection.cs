...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// {
    ///     var webAppPrivateEndpointConnection = new AzureNative.Web.V20220901.WebAppPrivateEndpointConnection("webAppPrivateEndpointConnection", new()
    ///     {
    ///         Name = "testSite",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:web/v20220901:WebAppPrivateEndpointConnection myresource1 /subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/rg/providers/Microsoft.Web/sites/testSite/privateEndpointConnections/connection 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppPrivateEndpointConnection")]
    public partial class WebAppPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public WebAppPrivateEndpointConnection(string name, WebAppPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppPrivateEndpointConnection", name, args ?? new WebAppPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
