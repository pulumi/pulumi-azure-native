...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// {
    ///     var appServicePlan = new AzureNative.Web.V20220901.AppServicePlan("appServicePlan", new()
    ///     {
    ///         Kind = "app",
    ///         Location = "East US",
    ///         Name = "testsf6141",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:AppServicePlan")]
    public partial class AppServicePlan : global::Pulumi.CustomResource
    {
        ...
        public AppServicePlan(string name, AppServicePlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:AppServicePlan", name, args ?? new AppServicePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:AppServicePlan", name, null, MakeResourceOptions(options, id))
        {
        }
