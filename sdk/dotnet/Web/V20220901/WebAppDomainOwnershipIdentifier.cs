...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppDomainOwnershipIdentifier")]
    public partial class WebAppDomainOwnershipIdentifier : global::Pulumi.CustomResource
    {
        ...
        public WebAppDomainOwnershipIdentifier(string name, WebAppDomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppDomainOwnershipIdentifier", name, args ?? new WebAppDomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppDomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
