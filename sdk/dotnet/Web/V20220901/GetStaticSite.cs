...
namespace Pulumi.AzureNative.Web.V20220901
{
    public static class GetStaticSite
    {
        ...
        public static Task<GetStaticSiteResult> InvokeAsync(GetStaticSiteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStaticSiteResult>("azure-native:web/v20220901:getStaticSite", args ?? new GetStaticSiteArgs(), options.WithDefaults());
