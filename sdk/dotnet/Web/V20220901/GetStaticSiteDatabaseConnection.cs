...
namespace Pulumi.AzureNative.Web.V20220901
{
    public static class GetStaticSiteDatabaseConnection
    {
        ...
        public static Task<GetStaticSiteDatabaseConnectionResult> InvokeAsync(GetStaticSiteDatabaseConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStaticSiteDatabaseConnectionResult>("azure-native:web/v20220901:getStaticSiteDatabaseConnection", args ?? new GetStaticSiteDatabaseConnectionArgs(), options.WithDefaults());
