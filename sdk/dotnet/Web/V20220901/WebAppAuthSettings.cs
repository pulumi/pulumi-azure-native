...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// {
    ///     var webAppAuthSettings = new AzureNative.Web.V20220901.WebAppAuthSettings("webAppAuthSettings", new()
    ///     {
    ...
    ///         DefaultProvider = AzureNative.Web.V20220901.BuiltInAuthenticationProvider.Google,
    ///         Enabled = true,
    ///         Name = "sitef6141",
    ...
    ///         UnauthenticatedClientAction = AzureNative.Web.V20220901.UnauthenticatedClientAction.RedirectToLoginPage,
    ///     });
    /// 
    /// });
    /// 
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppAuthSettings")]
    public partial class WebAppAuthSettings : global::Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettings(string name, WebAppAuthSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppAuthSettings", name, args ?? new WebAppAuthSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppAuthSettings", name, null, MakeResourceOptions(options, id))
        {
        }
