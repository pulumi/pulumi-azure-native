...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppMetadataSlot")]
    public partial class WebAppMetadataSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppMetadataSlot(string name, WebAppMetadataSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppMetadataSlot", name, args ?? new WebAppMetadataSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppMetadataSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppMetadataSlot", name, null, MakeResourceOptions(options, id))
        {
        }
