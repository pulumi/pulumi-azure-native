...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppSourceControl")]
    public partial class WebAppSourceControl : global::Pulumi.CustomResource
    {
        ...
        public WebAppSourceControl(string name, WebAppSourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppSourceControl", name, args ?? new WebAppSourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppSourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
