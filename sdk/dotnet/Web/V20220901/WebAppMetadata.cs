...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:web/v20220901:WebAppMetadata myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/config/metadata 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppMetadata")]
    public partial class WebAppMetadata : global::Pulumi.CustomResource
    {
        ...
        public WebAppMetadata(string name, WebAppMetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppMetadata", name, args ?? new WebAppMetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppMetadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppMetadata", name, null, MakeResourceOptions(options, id))
        {
        }
