...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:web/v20220901:WebAppDiagnosticLogsConfiguration myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/config/logs 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppDiagnosticLogsConfiguration")]
    public partial class WebAppDiagnosticLogsConfiguration : global::Pulumi.CustomResource
    {
        ...
        public WebAppDiagnosticLogsConfiguration(string name, WebAppDiagnosticLogsConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppDiagnosticLogsConfiguration", name, args ?? new WebAppDiagnosticLogsConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDiagnosticLogsConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppDiagnosticLogsConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
