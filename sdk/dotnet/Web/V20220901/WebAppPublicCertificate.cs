...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:web/v20220901:WebAppPublicCertificate myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/publicCertificates/{publicCertificateName} 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppPublicCertificate")]
    public partial class WebAppPublicCertificate : global::Pulumi.CustomResource
    {
        ...
        public WebAppPublicCertificate(string name, WebAppPublicCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppPublicCertificate", name, args ?? new WebAppPublicCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPublicCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppPublicCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppPublicCertificateArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20220901.PublicCertificateLocation>? PublicCertificateLocation { get; set; }
