...
{
    [Obsolete(@"azure-native:web/v20220901:WebApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebApp to guarantee forwards compatibility.")]
    public static class GetWebApp
    {
        ...
        public static Task<GetWebAppResult> InvokeAsync(GetWebAppArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppResult>("azure-native:web/v20220901:getWebApp", args ?? new GetWebAppArgs(), options.WithDefaults());

        /// <summary>
        /// Description for Gets the details of a web, mobile, or API app.
        /// </summary>
        public static Output<GetWebAppResult> Invoke(GetWebAppInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebAppResult>("azure-native:web/v20220901:getWebApp", args ?? new GetWebAppInvokeArgs(), options.WithDefaults());
    }
