...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// {
    ///     var appServiceEnvironment = new AzureNative.Web.V20220901.AppServiceEnvironment("appServiceEnvironment", new()
    ///     {
    ///         Kind = "Asev3",
    ///         Location = "South Central US",
    ///         Name = "test-ase",
    ///         ResourceGroupName = "test-rg",
    ///         VirtualNetwork = new AzureNative.Web.V20220901.Inputs.VirtualNetworkProfileArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:AppServiceEnvironment")]
    public partial class AppServiceEnvironment : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironment(string name, AppServiceEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:AppServiceEnvironment", name, args ?? new AppServiceEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:AppServiceEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceEnvironmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20220901.LoadBalancingMode>? InternalLoadBalancingMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20220901.UpgradePreference>? UpgradePreference { get; set; }
