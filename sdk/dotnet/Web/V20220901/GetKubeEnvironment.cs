...
namespace Pulumi.AzureNative.Web.V20220901
{
    public static class GetKubeEnvironment
    {
        ...
        public static Task<GetKubeEnvironmentResult> InvokeAsync(GetKubeEnvironmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKubeEnvironmentResult>("azure-native:web/v20220901:getKubeEnvironment", args ?? new GetKubeEnvironmentArgs(), options.WithDefaults());
