...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// {
    ///     var staticSiteCustomDomain = new AzureNative.Web.V20220901.StaticSiteCustomDomain("staticSiteCustomDomain", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:StaticSiteCustomDomain")]
    public partial class StaticSiteCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public StaticSiteCustomDomain(string name, StaticSiteCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:StaticSiteCustomDomain", name, args ?? new StaticSiteCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSiteCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:StaticSiteCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
