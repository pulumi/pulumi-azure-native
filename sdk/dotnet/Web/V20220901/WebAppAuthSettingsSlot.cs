...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppAuthSettingsSlot")]
    public partial class WebAppAuthSettingsSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettingsSlot(string name, WebAppAuthSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppAuthSettingsSlot", name, args ?? new WebAppAuthSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppAuthSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppAuthSettingsSlotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20220901.BuiltInAuthenticationProvider>? DefaultProvider { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20220901.UnauthenticatedClientAction>? UnauthenticatedClientAction { get; set; }
