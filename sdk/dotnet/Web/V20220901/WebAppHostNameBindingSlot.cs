...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppHostNameBindingSlot")]
    public partial class WebAppHostNameBindingSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBindingSlot(string name, WebAppHostNameBindingSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppHostNameBindingSlot", name, args ?? new WebAppHostNameBindingSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBindingSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppHostNameBindingSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppHostNameBindingSlotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20220901.AzureResourceType>? AzureResourceType { get; set; }

        /// <summary>
        /// Custom DNS record type.
        /// </summary>
        [Input("customHostNameDnsRecordType")]
        public Input<Pulumi.AzureNative.Web.V20220901.CustomHostNameDnsRecordType>? CustomHostNameDnsRecordType { get; set; }
        ...
        /// </summary>
        [Input("hostNameType")]
        public Input<Pulumi.AzureNative.Web.V20220901.HostNameType>? HostNameType { get; set; }
        ...
        /// </summary>
        [Input("sslState")]
        public Input<Pulumi.AzureNative.Web.V20220901.SslState>? SslState { get; set; }
