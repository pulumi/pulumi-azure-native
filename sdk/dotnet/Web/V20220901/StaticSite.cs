...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// {
    ///     var staticSite = new AzureNative.Web.V20220901.StaticSite("staticSite", new()
    ///     {
    ///         Branch = "master",
    ///         BuildProperties = new AzureNative.Web.V20220901.Inputs.StaticSiteBuildPropertiesArgs
    ///         {
    ///             ApiLocation = "api",
    ...
    ///         Sku = new AzureNative.Web.V20220901.Inputs.SkuDescriptionArgs
    ///         {
    ///             Name = "Basic",
    ///             Tier = "Basic",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:StaticSite")]
    public partial class StaticSite : global::Pulumi.CustomResource
    {
        ...
        public StaticSite(string name, StaticSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:StaticSite", name, args ?? new StaticSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:StaticSite", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StaticSiteArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20220901.EnterpriseGradeCdnStatus>? EnterpriseGradeCdnStatus { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20220901.StagingEnvironmentPolicy>? StagingEnvironmentPolicy { get; set; }
