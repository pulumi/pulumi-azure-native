...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// {
    ///     var webApp = new AzureNative.Web.V20220901.WebApp("webApp", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebApp")]
    public partial class WebApp : global::Pulumi.CustomResource
    {
        ...
        public WebApp(string name, WebAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebApp", name, args ?? new WebAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebApp", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20220901.ClientCertMode>? ClientCertMode { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20220901.RedundancyMode>? RedundancyMode { get; set; }
