...
namespace Pulumi.AzureNative.Web.V20220901
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:web/v20220901:WebAppInstanceFunctionSlot myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/functions/{functionName} 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220901:WebAppInstanceFunctionSlot")]
    public partial class WebAppInstanceFunctionSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppInstanceFunctionSlot(string name, WebAppInstanceFunctionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppInstanceFunctionSlot", name, args ?? new WebAppInstanceFunctionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppInstanceFunctionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220901:WebAppInstanceFunctionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
