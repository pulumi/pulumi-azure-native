...
namespace Pulumi.AzureNative.Web.V20210101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210101:WebAppRelayServiceConnectionSlot")]
    public partial class WebAppRelayServiceConnectionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppRelayServiceConnectionSlot(string name, WebAppRelayServiceConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppRelayServiceConnectionSlot", name, args ?? new WebAppRelayServiceConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppRelayServiceConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppRelayServiceConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
