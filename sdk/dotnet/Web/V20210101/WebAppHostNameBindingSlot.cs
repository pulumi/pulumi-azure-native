...
namespace Pulumi.AzureNative.Web.V20210101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210101:WebAppHostNameBindingSlot")]
    public partial class WebAppHostNameBindingSlot : Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBindingSlot(string name, WebAppHostNameBindingSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppHostNameBindingSlot", name, args ?? new WebAppHostNameBindingSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBindingSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppHostNameBindingSlot", name, null, MakeResourceOptions(options, id))
        {
        }
