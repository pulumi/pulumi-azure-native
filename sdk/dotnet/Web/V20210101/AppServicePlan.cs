...
namespace Pulumi.AzureNative.Web.V20210101
{
    ...
    public partial class AppServicePlan : Pulumi.CustomResource
    {
        ...
        public AppServicePlan(string name, AppServicePlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:AppServicePlan", name, args ?? new AppServicePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:AppServicePlan", name, null, MakeResourceOptions(options, id))
        {
        }
