...
namespace Pulumi.AzureNative.Web.V20210101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210101:StaticSite")]
    public partial class StaticSite : Pulumi.CustomResource
    {
        ...
        public StaticSite(string name, StaticSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:StaticSite", name, args ?? new StaticSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:StaticSite", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StaticSiteArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20210101.StagingEnvironmentPolicy>? StagingEnvironmentPolicy { get; set; }
