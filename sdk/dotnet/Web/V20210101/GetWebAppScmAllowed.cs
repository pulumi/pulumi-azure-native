...
namespace Pulumi.AzureNative.Web.V20210101
{
    public static class GetWebAppScmAllowed
    {
        ...
        public static Task<GetWebAppScmAllowedResult> InvokeAsync(GetWebAppScmAllowedArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppScmAllowedResult>("azure-native:web/v20210101:getWebAppScmAllowed", args ?? new GetWebAppScmAllowedArgs(), options.WithDefaults());
