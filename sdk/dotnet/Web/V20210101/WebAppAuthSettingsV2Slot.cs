...
namespace Pulumi.AzureNative.Web.V20210101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210101:WebAppAuthSettingsV2Slot")]
    public partial class WebAppAuthSettingsV2Slot : Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettingsV2Slot(string name, WebAppAuthSettingsV2SlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppAuthSettingsV2Slot", name, args ?? new WebAppAuthSettingsV2SlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettingsV2Slot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppAuthSettingsV2Slot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppAuthSettingsV2Slot"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppAuthSettingsV2Slot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppAuthSettingsV2Slot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppAuthSettingsV2Slot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppAuthSettingsV2Slot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppAuthSettingsV2Slot"},
                },
            };
