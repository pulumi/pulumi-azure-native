...
namespace Pulumi.AzureNative.Web.V20210101
{
    ...
    /// Premier add-on.
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210101:WebAppPremierAddOnSlot")]
    public partial class WebAppPremierAddOnSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppPremierAddOnSlot(string name, WebAppPremierAddOnSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppPremierAddOnSlot", name, args ?? new WebAppPremierAddOnSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPremierAddOnSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppPremierAddOnSlot", name, null, MakeResourceOptions(options, id))
        {
        }
