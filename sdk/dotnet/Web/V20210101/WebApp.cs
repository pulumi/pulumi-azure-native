...
namespace Pulumi.AzureNative.Web.V20210101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210101:WebApp")]
    public partial class WebApp : Pulumi.CustomResource
    {
        ...
        public WebApp(string name, WebAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebApp", name, args ?? new WebAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebApp", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20210101.ClientCertMode>? ClientCertMode { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20210101.RedundancyMode>? RedundancyMode { get; set; }
