...
namespace Pulumi.AzureNative.Web.V20210101
{
    public static class ListStaticSiteAppSettings
    {
        ...
        public static Output<ListStaticSiteAppSettingsResult> Invoke(ListStaticSiteAppSettingsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListStaticSiteAppSettingsResult>("azure-native:web/v20210101:listStaticSiteAppSettings", args ?? new ListStaticSiteAppSettingsInvokeArgs(), options.WithVersion());
    }
