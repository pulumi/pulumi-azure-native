...
namespace Pulumi.AzureNative.Web.V20210101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210101:WebAppAzureStorageAccounts")]
    public partial class WebAppAzureStorageAccounts : Pulumi.CustomResource
    {
        ...
        public WebAppAzureStorageAccounts(string name, WebAppAzureStorageAccountsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppAzureStorageAccounts", name, args ?? new WebAppAzureStorageAccountsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAzureStorageAccounts(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppAzureStorageAccounts", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppAzureStorageAccounts"},
                    new Pulumi.Alias { Type = "azure-native:web:WebAppAzureStorageAccounts"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppAzureStorageAccounts"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppAzureStorageAccounts"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppAzureStorageAccounts"},
                },
            };
