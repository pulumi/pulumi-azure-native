...
namespace Pulumi.AzureNative.Web.V20210101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210101:WebAppApplicationSettings")]
    public partial class WebAppApplicationSettings : Pulumi.CustomResource
    {
        ...
        public WebAppApplicationSettings(string name, WebAppApplicationSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppApplicationSettings", name, args ?? new WebAppApplicationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppApplicationSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210101:WebAppApplicationSettings", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppApplicationSettings"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20160801:WebAppApplicationSettings"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppApplicationSettings"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppApplicationSettings"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppApplicationSettings"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppApplicationSettings"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppApplicationSettings"},
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WebAppApplicationSettings Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
