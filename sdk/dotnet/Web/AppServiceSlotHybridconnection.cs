...
namespace Pulumi.AzureRM.Web
{
    ...
    public partial class AppServiceSlotHybridconnection : Pulumi.CustomResource
    {
        ...
        private AppServiceSlotHybridconnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web:AppServiceSlotHybridconnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AppServiceSlotHybridconnection Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new AppServiceSlotHybridconnection(name, id, options);
        }
    }
