...
namespace Pulumi.AzureNextGen.Web
{
    public static class ListWebApplicationSettings
    {
        public static Task<ListWebApplicationSettingsResult> InvokeAsync(ListWebApplicationSettingsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebApplicationSettingsResult>("azure-nextgen:web:listWebApplicationSettings", args ?? new ListWebApplicationSettingsArgs(), options.WithVersion());
    }
