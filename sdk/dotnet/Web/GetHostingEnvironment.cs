...
namespace Pulumi.AzureRM.Web
{
    public static class GetHostingEnvironment
    {
        public static Task<GetHostingEnvironmentResult> InvokeAsync(GetHostingEnvironmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHostingEnvironmentResult>("azurerm:web:getHostingEnvironment", args ?? new GetHostingEnvironmentArgs(), options.WithVersion());
    }
