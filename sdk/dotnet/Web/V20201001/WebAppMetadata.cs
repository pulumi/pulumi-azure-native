...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:WebAppMetadata")]
    public partial class WebAppMetadata : Pulumi.CustomResource
    {
        ...
        public WebAppMetadata(string name, WebAppMetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppMetadata", name, args ?? new WebAppMetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppMetadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppMetadata", name, null, MakeResourceOptions(options, id))
        {
        }
