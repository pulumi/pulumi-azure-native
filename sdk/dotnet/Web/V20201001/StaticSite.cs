...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// {
    ///     var staticSite = new AzureNative.Web.V20201001.StaticSite("staticSite", new()
    ///     {
    ///         Branch = "master",
    ///         BuildProperties = new AzureNative.Web.V20201001.Inputs.StaticSiteBuildPropertiesArgs
    ///         {
    ///             ApiLocation = "api",
    ...
    ///         Sku = new AzureNative.Web.V20201001.Inputs.SkuDescriptionArgs
    ///         {
    ///             Name = "Basic",
    ///             Tier = "Basic",
    ///         },
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:StaticSite")]
    public partial class StaticSite : global::Pulumi.CustomResource
    {
        ...
        public StaticSite(string name, StaticSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:StaticSite", name, args ?? new StaticSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:StaticSite", name, null, MakeResourceOptions(options, id))
        {
        }
