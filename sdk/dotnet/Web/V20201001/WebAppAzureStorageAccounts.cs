...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:WebAppAzureStorageAccounts")]
    public partial class WebAppAzureStorageAccounts : global::Pulumi.CustomResource
    {
        ...
        public WebAppAzureStorageAccounts(string name, WebAppAzureStorageAccountsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppAzureStorageAccounts", name, args ?? new WebAppAzureStorageAccountsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAzureStorageAccounts(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppAzureStorageAccounts", name, null, MakeResourceOptions(options, id))
        {
        }
