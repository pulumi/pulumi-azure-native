...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:AppServicePlanRouteForVnet")]
    public partial class AppServicePlanRouteForVnet : global::Pulumi.CustomResource
    {
        ...
        public AppServicePlanRouteForVnet(string name, AppServicePlanRouteForVnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:AppServicePlanRouteForVnet", name, args ?? new AppServicePlanRouteForVnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlanRouteForVnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:AppServicePlanRouteForVnet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServicePlanRouteForVnetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("routeType")]
        public InputUnion<string, Pulumi.AzureNative.Web.V20201001.RouteType>? RouteType { get; set; }
