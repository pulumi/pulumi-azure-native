...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:WebAppHostNameBinding")]
    public partial class WebAppHostNameBinding : global::Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBinding(string name, WebAppHostNameBindingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppHostNameBinding", name, args ?? new WebAppHostNameBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppHostNameBinding", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:web/v20230101:WebAppHostNameBinding" },
                    new global::Pulumi.Alias { Type = "azure-native:web/v20231201:WebAppHostNameBinding" },
                    new global::Pulumi.Alias { Type = "azure-native:web/v20240401:WebAppHostNameBinding" },
                    new global::Pulumi.Alias { Type = "azure-native:web:WebAppHostNameBinding" },
                },
            };
    ...
    public sealed class WebAppHostNameBindingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20201001.AzureResourceType>? AzureResourceType { get; set; }

        /// <summary>
        /// Custom DNS record type.
        /// </summary>
        [Input("customHostNameDnsRecordType")]
        public Input<Pulumi.AzureNative.Web.V20201001.CustomHostNameDnsRecordType>? CustomHostNameDnsRecordType { get; set; }
        ...
        /// </summary>
        [Input("hostNameType")]
        public Input<Pulumi.AzureNative.Web.V20201001.HostNameType>? HostNameType { get; set; }
        ...
        /// </summary>
        [Input("sslState")]
        public Input<Pulumi.AzureNative.Web.V20201001.SslState>? SslState { get; set; }
