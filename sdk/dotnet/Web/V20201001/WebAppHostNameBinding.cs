...
namespace Pulumi.AzureNextGen.Web.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20201001:WebAppHostNameBinding")]
    public partial class WebAppHostNameBinding : Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBinding(string name, WebAppHostNameBindingArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20201001:WebAppHostNameBinding", name, args ?? new WebAppHostNameBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20201001:WebAppHostNameBinding", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppHostNameBindingArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Web.V20201001.AzureResourceType>? AzureResourceType { get; set; }

        /// <summary>
        /// Custom DNS record type.
        /// </summary>
        [Input("customHostNameDnsRecordType")]
        public Input<Pulumi.AzureNextGen.Web.V20201001.CustomHostNameDnsRecordType>? CustomHostNameDnsRecordType { get; set; }
        ...
        /// </summary>
        [Input("hostNameType")]
        public Input<Pulumi.AzureNextGen.Web.V20201001.HostNameType>? HostNameType { get; set; }
        ...
        /// </summary>
        [Input("sslState")]
        public Input<Pulumi.AzureNextGen.Web.V20201001.SslState>? SslState { get; set; }
