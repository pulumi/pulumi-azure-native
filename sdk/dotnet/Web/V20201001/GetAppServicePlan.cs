...
namespace Pulumi.AzureNextGen.Web.V20201001
{
    public static class GetAppServicePlan
    {
        public static Task<GetAppServicePlanResult> InvokeAsync(GetAppServicePlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAppServicePlanResult>("azure-nextgen:web/v20201001:getAppServicePlan", args ?? new GetAppServicePlanArgs(), options.WithVersion());
    }
