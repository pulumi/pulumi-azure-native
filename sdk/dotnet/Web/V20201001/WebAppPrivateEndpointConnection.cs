...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// {
    ///     var webAppPrivateEndpointConnection = new AzureNative.Web.V20201001.WebAppPrivateEndpointConnection("webAppPrivateEndpointConnection", new()
    ///     {
    ///         Name = "testSite",
    ///         PrivateEndpointConnectionName = "connection",
    ///         PrivateLinkServiceConnectionState = new AzureNative.Web.V20201001.Inputs.PrivateLinkConnectionStateArgs
    ///         {
    ///             ActionsRequired = "",
    ...
    public partial class WebAppPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public WebAppPrivateEndpointConnection(string name, WebAppPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppPrivateEndpointConnection", name, args ?? new WebAppPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
