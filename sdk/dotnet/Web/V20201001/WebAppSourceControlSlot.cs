...
namespace Pulumi.AzureNextGen.Web.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20201001:WebAppSourceControlSlot")]
    public partial class WebAppSourceControlSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSourceControlSlot(string name, WebAppSourceControlSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20201001:WebAppSourceControlSlot", name, args ?? new WebAppSourceControlSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSourceControlSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20201001:WebAppSourceControlSlot", name, null, MakeResourceOptions(options, id))
        {
        }
