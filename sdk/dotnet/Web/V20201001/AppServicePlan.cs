...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// {
    ///     var appServicePlan = new AzureNative.Web.V20201001.AppServicePlan("appServicePlan", new()
    ///     {
    ///         Kind = "app",
    ///         Location = "East US",
    ///         Name = "testsf6141",
    ...
    public partial class AppServicePlan : global::Pulumi.CustomResource
    {
        ...
        public AppServicePlan(string name, AppServicePlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:AppServicePlan", name, args ?? new AppServicePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:AppServicePlan", name, null, MakeResourceOptions(options, id))
        {
        }
