...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:WebAppSiteExtension")]
    public partial class WebAppSiteExtension : Pulumi.CustomResource
    {
        ...
        public WebAppSiteExtension(string name, WebAppSiteExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppSiteExtension", name, args ?? new WebAppSiteExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppSiteExtension", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:web/v20160801:WebAppSiteExtension"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppSiteExtension"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210301:WebAppSiteExtension"},
                    new Pulumi.Alias { Type = "azure-native:web/v20220301:WebAppSiteExtension"},
                },
            };
