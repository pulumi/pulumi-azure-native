...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:web/v20201001:WebAppMetadataSlot myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/metadata 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:WebAppMetadataSlot")]
    public partial class WebAppMetadataSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppMetadataSlot(string name, WebAppMetadataSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppMetadataSlot", name, args ?? new WebAppMetadataSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppMetadataSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppMetadataSlot", name, null, MakeResourceOptions(options, id))
        {
        }
