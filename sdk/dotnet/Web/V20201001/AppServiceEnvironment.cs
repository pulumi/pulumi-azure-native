...
namespace Pulumi.AzureNextGen.Web.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20201001:AppServiceEnvironment")]
    public partial class AppServiceEnvironment : Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironment(string name, AppServiceEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20201001:AppServiceEnvironment", name, args ?? new AppServiceEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20201001:AppServiceEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceEnvironmentArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Web.V20201001.LoadBalancingMode>? InternalLoadBalancingMode { get; set; }
