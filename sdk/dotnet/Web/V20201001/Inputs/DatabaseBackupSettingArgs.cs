...
namespace Pulumi.AzureNative.Web.V20201001.Inputs
{
    ...
    public sealed class DatabaseBackupSettingArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20201001.DatabaseType> DatabaseType { get; set; } = null!;
    ...
    public sealed class DatabaseBackupSetting : Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("databaseType", required: true)]
        public Union<string, Pulumi.AzureNative.Web.V20201001.DatabaseType> DatabaseType { get; set; } = null!;
