...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:WebAppSitePushSettings")]
    public partial class WebAppSitePushSettings : Pulumi.CustomResource
    {
        ...
        public WebAppSitePushSettings(string name, WebAppSitePushSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppSitePushSettings", name, args ?? new WebAppSitePushSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSitePushSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppSitePushSettings", name, null, MakeResourceOptions(options, id))
        {
        }
