...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:WebAppInstanceFunctionSlot")]
    public partial class WebAppInstanceFunctionSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppInstanceFunctionSlot(string name, WebAppInstanceFunctionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppInstanceFunctionSlot", name, args ?? new WebAppInstanceFunctionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppInstanceFunctionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppInstanceFunctionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
