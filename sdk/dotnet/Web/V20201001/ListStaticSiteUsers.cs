...
namespace Pulumi.AzureNative.Web.V20201001
{
    public static class ListStaticSiteUsers
    {
        ...
        public static Task<ListStaticSiteUsersResult> InvokeAsync(ListStaticSiteUsersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListStaticSiteUsersResult>("azure-native:web/v20201001:listStaticSiteUsers", args ?? new ListStaticSiteUsersArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the list of users of a static site.
        /// </summary>
        public static Output<ListStaticSiteUsersResult> Invoke(ListStaticSiteUsersInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListStaticSiteUsersResult>("azure-native:web/v20201001:listStaticSiteUsers", args ?? new ListStaticSiteUsersInvokeArgs(), options.WithDefaults());
    }
