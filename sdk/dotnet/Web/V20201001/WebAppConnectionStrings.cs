...
namespace Pulumi.AzureNative.Web.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201001:WebAppConnectionStrings")]
    public partial class WebAppConnectionStrings : Pulumi.CustomResource
    {
        ...
        public WebAppConnectionStrings(string name, WebAppConnectionStringsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppConnectionStrings", name, args ?? new WebAppConnectionStringsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConnectionStrings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201001:WebAppConnectionStrings", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppConnectionStrings"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppConnectionStrings"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppConnectionStrings"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppConnectionStrings"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppConnectionStrings"},
                },
            };
