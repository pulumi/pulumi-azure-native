...
namespace Pulumi.AzureNextGen.Web.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20201001:WebAppVnetConnectionSlot")]
    public partial class WebAppVnetConnectionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppVnetConnectionSlot(string name, WebAppVnetConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20201001:WebAppVnetConnectionSlot", name, args ?? new WebAppVnetConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppVnetConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20201001:WebAppVnetConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
