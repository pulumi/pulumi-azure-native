...
namespace Pulumi.AzureNative.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:StaticSiteCustomDomain'.")]
    [AzureNativeResourceType("azure-native:web/latest:StaticSiteCustomDomain")]
    public partial class StaticSiteCustomDomain : Pulumi.CustomResource
    {
        ...
        public StaticSiteCustomDomain(string name, StaticSiteCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:StaticSiteCustomDomain", name, args ?? new StaticSiteCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSiteCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:StaticSiteCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
