...
namespace Pulumi.AzureNative.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppAzureStorageAccountsSlot'.")]
    [AzureNativeResourceType("azure-native:web/latest:WebAppAzureStorageAccountsSlot")]
    public partial class WebAppAzureStorageAccountsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppAzureStorageAccountsSlot(string name, WebAppAzureStorageAccountsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppAzureStorageAccountsSlot", name, args ?? new WebAppAzureStorageAccountsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAzureStorageAccountsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppAzureStorageAccountsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
