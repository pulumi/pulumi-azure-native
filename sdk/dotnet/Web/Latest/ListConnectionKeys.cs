...
namespace Pulumi.AzureRM.Web.Latest
{
    public static class ListConnectionKeys
    {
        public static Task<ListConnectionKeysResult> InvokeAsync(ListConnectionKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListConnectionKeysResult>("azurerm:web/latest:listConnectionKeys", args ?? new ListConnectionKeysArgs(), options.WithVersion());
    }
