...
namespace Pulumi.AzureRM.Web.Latest
{
    ...
    public partial class CertificateCsr : Pulumi.CustomResource
    {
        ...
        public CertificateCsr(string name, CertificateCsrArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/latest:CertificateCsr", name, args ?? new CertificateCsrArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CertificateCsr(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/latest:CertificateCsr", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:web/v20150801:CertificateCsr"},
                },
            };
