...
namespace Pulumi.AzureNative.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppSlotConfigurationNames'.")]
    [AzureNativeResourceType("azure-native:web/latest:WebAppSlotConfigurationNames")]
    public partial class WebAppSlotConfigurationNames : Pulumi.CustomResource
    {
        ...
        public WebAppSlotConfigurationNames(string name, WebAppSlotConfigurationNamesArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppSlotConfigurationNames", name, args ?? new WebAppSlotConfigurationNamesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSlotConfigurationNames(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppSlotConfigurationNames", name, null, MakeResourceOptions(options, id))
        {
        }
