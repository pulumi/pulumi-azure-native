...
namespace Pulumi.AzureNextGen.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:web:WebAppSlotConfigurationNames'.")]
    [AzureNextGenResourceType("azure-nextgen:web/latest:WebAppSlotConfigurationNames")]
    public partial class WebAppSlotConfigurationNames : Pulumi.CustomResource
    {
        ...
        public WebAppSlotConfigurationNames(string name, WebAppSlotConfigurationNamesArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/latest:WebAppSlotConfigurationNames", name, args ?? new WebAppSlotConfigurationNamesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSlotConfigurationNames(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/latest:WebAppSlotConfigurationNames", name, null, MakeResourceOptions(options, id))
        {
        }
