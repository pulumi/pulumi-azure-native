...
{
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSiteCustomDomain'.")]
    public static class GetStaticSiteCustomDomain
    {
        ...
        public static Task<GetStaticSiteCustomDomainResult> InvokeAsync(GetStaticSiteCustomDomainArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStaticSiteCustomDomainResult>("azure-native:web/latest:getStaticSiteCustomDomain", args ?? new GetStaticSiteCustomDomainArgs(), options.WithVersion());
    }
