...
namespace Pulumi.AzureNative.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppConnectionStringsSlot'.")]
    [AzureNativeResourceType("azure-native:web/latest:WebAppConnectionStringsSlot")]
    public partial class WebAppConnectionStringsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppConnectionStringsSlot(string name, WebAppConnectionStringsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppConnectionStringsSlot", name, args ?? new WebAppConnectionStringsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConnectionStringsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppConnectionStringsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
