...
namespace Pulumi.AzureNative.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppSwiftVirtualNetworkConnectionSlot'.")]
    [AzureNativeResourceType("azure-native:web/latest:WebAppSwiftVirtualNetworkConnectionSlot")]
    public partial class WebAppSwiftVirtualNetworkConnectionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSwiftVirtualNetworkConnectionSlot(string name, WebAppSwiftVirtualNetworkConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppSwiftVirtualNetworkConnectionSlot", name, args ?? new WebAppSwiftVirtualNetworkConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSwiftVirtualNetworkConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppSwiftVirtualNetworkConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
