...
namespace Pulumi.AzureNative.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppPremierAddOnSlot'.")]
    [AzureNativeResourceType("azure-native:web/latest:WebAppPremierAddOnSlot")]
    public partial class WebAppPremierAddOnSlot : Pulumi.CustomResource
    {
        ...
        public WebAppPremierAddOnSlot(string name, WebAppPremierAddOnSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppPremierAddOnSlot", name, args ?? new WebAppPremierAddOnSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPremierAddOnSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppPremierAddOnSlot", name, null, MakeResourceOptions(options, id))
        {
        }
