...
namespace Pulumi.AzureNextGen.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:web:WebApplicationSettings'.")]
    [AzureNextGenResourceType("azure-nextgen:web/latest:WebApplicationSettings")]
    public partial class WebApplicationSettings : Pulumi.CustomResource
    {
        ...
        public WebApplicationSettings(string name, WebApplicationSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/latest:WebApplicationSettings", name, args ?? new WebApplicationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApplicationSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/latest:WebApplicationSettings", name, null, MakeResourceOptions(options, id))
        {
        }
