...
namespace Pulumi.AzureNative.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppSitePushSettingsSlot'.")]
    [AzureNativeResourceType("azure-native:web/latest:WebAppSitePushSettingsSlot")]
    public partial class WebAppSitePushSettingsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSitePushSettingsSlot(string name, WebAppSitePushSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppSitePushSettingsSlot", name, args ?? new WebAppSitePushSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSitePushSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppSitePushSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
