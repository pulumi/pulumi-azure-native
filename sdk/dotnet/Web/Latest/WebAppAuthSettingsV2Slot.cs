...
namespace Pulumi.AzureNative.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppAuthSettingsV2Slot'.")]
    [AzureNativeResourceType("azure-native:web/latest:WebAppAuthSettingsV2Slot")]
    public partial class WebAppAuthSettingsV2Slot : Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettingsV2Slot(string name, WebAppAuthSettingsV2SlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppAuthSettingsV2Slot", name, args ?? new WebAppAuthSettingsV2SlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettingsV2Slot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppAuthSettingsV2Slot", name, null, MakeResourceOptions(options, id))
        {
        }
