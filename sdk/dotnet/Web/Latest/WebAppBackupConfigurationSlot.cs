...
namespace Pulumi.AzureNative.Web.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppBackupConfigurationSlot'.")]
    [AzureNativeResourceType("azure-native:web/latest:WebAppBackupConfigurationSlot")]
    public partial class WebAppBackupConfigurationSlot : Pulumi.CustomResource
    {
        ...
        public WebAppBackupConfigurationSlot(string name, WebAppBackupConfigurationSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppBackupConfigurationSlot", name, args ?? new WebAppBackupConfigurationSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppBackupConfigurationSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/latest:WebAppBackupConfigurationSlot", name, null, MakeResourceOptions(options, id))
        {
        }
