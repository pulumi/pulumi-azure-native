...
namespace Pulumi.AzureRM.Web.Latest
{
    ...
    public partial class WebAppPublicCertificateSlot : Pulumi.CustomResource
    {
        ...
        public WebAppPublicCertificateSlot(string name, WebAppPublicCertificateSlotArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/latest:WebAppPublicCertificateSlot", name, args ?? new WebAppPublicCertificateSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPublicCertificateSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/latest:WebAppPublicCertificateSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:web/v20181101:WebAppPublicCertificateSlot"},
