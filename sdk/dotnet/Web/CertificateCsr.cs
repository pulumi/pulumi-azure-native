...
namespace Pulumi.AzureNextGen.Web
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web:CertificateCsr")]
    public partial class CertificateCsr : Pulumi.CustomResource
    {
        ...
        public CertificateCsr(string name, CertificateCsrArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:CertificateCsr", name, args ?? new CertificateCsrArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CertificateCsr(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:CertificateCsr", name, null, MakeResourceOptions(options, id))
        {
        }
