...
namespace Pulumi.AzureNative.Web.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210301:StaticSitePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSitePrivateEndpointConnection to guarantee forwards compatibility.")]
    ...
    public partial class StaticSitePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public StaticSitePrivateEndpointConnection(string name, StaticSitePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:StaticSitePrivateEndpointConnection", name, args ?? new StaticSitePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSitePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:StaticSitePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
