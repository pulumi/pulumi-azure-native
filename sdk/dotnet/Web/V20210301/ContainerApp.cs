...
namespace Pulumi.AzureNative.Web.V20210301
{
    ...
    [AzureNativeResourceType("azure-native:web/v20210301:ContainerApp")]
    public partial class ContainerApp : global::Pulumi.CustomResource
    {
        ...
        public ContainerApp(string name, ContainerAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:ContainerApp", name, args ?? new ContainerAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:ContainerApp", name, null, MakeResourceOptions(options, id))
        {
        }
