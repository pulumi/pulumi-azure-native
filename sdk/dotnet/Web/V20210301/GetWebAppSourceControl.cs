...
namespace Pulumi.AzureNative.Web.V20210301
{
    public static class GetWebAppSourceControl
    {
        ...
        public static Task<GetWebAppSourceControlResult> InvokeAsync(GetWebAppSourceControlArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppSourceControlResult>("azure-native:web/v20210301:getWebAppSourceControl", args ?? new GetWebAppSourceControlArgs(), options.WithDefaults());
        ...
        public static Output<GetWebAppSourceControlResult> Invoke(GetWebAppSourceControlInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebAppSourceControlResult>("azure-native:web/v20210301:getWebAppSourceControl", args ?? new GetWebAppSourceControlInvokeArgs(), options.WithDefaults());
    }
