...
namespace Pulumi.AzureNative.Web.V20210301
{
    ...
    public partial class StaticSite : global::Pulumi.CustomResource
    {
        ...
        public StaticSite(string name, StaticSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:StaticSite", name, args ?? new StaticSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:StaticSite", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StaticSiteArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20210301.EnterpriseGradeCdnStatus>? EnterpriseGradeCdnStatus { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20210301.StagingEnvironmentPolicy>? StagingEnvironmentPolicy { get; set; }
