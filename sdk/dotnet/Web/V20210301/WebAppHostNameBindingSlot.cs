...
namespace Pulumi.AzureNative.Web.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210301:WebAppHostNameBindingSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHostNameBindingSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20210301:WebAppHostNameBindingSlot")]
    public partial class WebAppHostNameBindingSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBindingSlot(string name, WebAppHostNameBindingSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:WebAppHostNameBindingSlot", name, args ?? new WebAppHostNameBindingSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBindingSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:WebAppHostNameBindingSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppHostNameBindingSlotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20210301.AzureResourceType>? AzureResourceType { get; set; }

        /// <summary>
        /// Custom DNS record type.
        /// </summary>
        [Input("customHostNameDnsRecordType")]
        public Input<Pulumi.AzureNative.Web.V20210301.CustomHostNameDnsRecordType>? CustomHostNameDnsRecordType { get; set; }
        ...
        /// </summary>
        [Input("hostNameType")]
        public Input<Pulumi.AzureNative.Web.V20210301.HostNameType>? HostNameType { get; set; }
        ...
        /// </summary>
        [Input("sslState")]
        public Input<Pulumi.AzureNative.Web.V20210301.SslState>? SslState { get; set; }
