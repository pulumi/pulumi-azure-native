...
namespace Pulumi.AzureNative.Web.V20210301
{
    public static class ListWebAppSiteBackups
    {
        ...
        public static Task<ListWebAppSiteBackupsResult> InvokeAsync(ListWebAppSiteBackupsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebAppSiteBackupsResult>("azure-native:web/v20210301:listWebAppSiteBackups", args ?? new ListWebAppSiteBackupsArgs(), options.WithVersion());

        /// <summary>
        /// Collection of backup items.
        /// </summary>
        public static Output<ListWebAppSiteBackupsResult> Invoke(ListWebAppSiteBackupsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListWebAppSiteBackupsResult>("azure-native:web/v20210301:listWebAppSiteBackups", args ?? new ListWebAppSiteBackupsInvokeArgs(), options.WithVersion());
    }
