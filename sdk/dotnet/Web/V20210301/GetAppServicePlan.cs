...
namespace Pulumi.AzureNative.Web.V20210301
{
    public static class GetAppServicePlan
    {
        ...
        public static Task<GetAppServicePlanResult> InvokeAsync(GetAppServicePlanArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppServicePlanResult>("azure-native:web/v20210301:getAppServicePlan", args ?? new GetAppServicePlanArgs(), options.WithDefaults());

        /// <summary>
        /// Get an App Service plan.
        /// </summary>
        public static Output<GetAppServicePlanResult> Invoke(GetAppServicePlanInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppServicePlanResult>("azure-native:web/v20210301:getAppServicePlan", args ?? new GetAppServicePlanInvokeArgs(), options.WithDefaults());
    }
