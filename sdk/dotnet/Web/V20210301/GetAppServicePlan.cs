...
namespace Pulumi.AzureNative.Web.V20210301
{
    public static class GetAppServicePlan
    {
        ...
        public static Task<GetAppServicePlanResult> InvokeAsync(GetAppServicePlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAppServicePlanResult>("azure-native:web/v20210301:getAppServicePlan", args ?? new GetAppServicePlanArgs(), options.WithVersion());

        /// <summary>
        /// App Service plan.
        /// </summary>
        public static Output<GetAppServicePlanResult> Invoke(GetAppServicePlanInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAppServicePlanResult>("azure-native:web/v20210301:getAppServicePlan", args ?? new GetAppServicePlanInvokeArgs(), options.WithVersion());
    }
