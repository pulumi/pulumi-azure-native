...
namespace Pulumi.AzureNative.Web.V20210301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210301:StaticSiteUserProvidedFunctionAppForStaticSiteBuild is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSiteUserProvidedFunctionAppForStaticSiteBuild to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20210301:StaticSiteUserProvidedFunctionAppForStaticSiteBuild")]
    public partial class StaticSiteUserProvidedFunctionAppForStaticSiteBuild : global::Pulumi.CustomResource
    {
        ...
        public StaticSiteUserProvidedFunctionAppForStaticSiteBuild(string name, StaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, args ?? new StaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private StaticSiteUserProvidedFunctionAppForStaticSiteBuild(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210301:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, null, MakeResourceOptions(options, id))
        {
        }
