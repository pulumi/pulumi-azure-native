...
namespace Pulumi.AzureRM.Web.V20180201
{
    public static class ListWebAppMetadata
    {
        public static Task<ListWebAppMetadataResult> InvokeAsync(ListWebAppMetadataArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebAppMetadataResult>("azurerm:web/v20180201:listWebAppMetadata", args ?? new ListWebAppMetadataArgs(), options.WithVersion());
    }
