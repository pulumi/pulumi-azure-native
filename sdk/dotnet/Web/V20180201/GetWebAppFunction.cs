...
namespace Pulumi.AzureRM.Web.V20180201
{
    public static class GetWebAppFunction
    {
        public static Task<GetWebAppFunctionResult> InvokeAsync(GetWebAppFunctionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppFunctionResult>("azurerm:web/v20180201:getWebAppFunction", args ?? new GetWebAppFunctionArgs(), options.WithVersion());
    }
