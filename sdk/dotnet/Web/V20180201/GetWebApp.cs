...
namespace Pulumi.AzureRM.Web.V20180201
{
    public static class GetWebApp
    {
        public static Task<GetWebAppResult> InvokeAsync(GetWebAppArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppResult>("azurerm:web/v20180201:getWebApp", args ?? new GetWebAppArgs(), options.WithVersion());
    }
    ...
    public sealed class GetWebAppResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GeoDistributionResponseResult> GeoDistributions;
        /// <summary>
        ...
        private GetWebAppResult(
            ...
            ImmutableArray<Outputs.GeoDistributionResponseResult> geoDistributions,
