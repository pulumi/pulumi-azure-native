...
namespace Pulumi.AzureRM.Web.V20180201
{
    ...
    public partial class WebAppHostNameBindingSlot : Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBindingSlot(string name, WebAppHostNameBindingSlotArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/v20180201:WebAppHostNameBindingSlot", name, args ?? new WebAppHostNameBindingSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBindingSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/v20180201:WebAppHostNameBindingSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:web/v20150801:WebAppHostNameBindingSlot"},
                    new Alias { Type = "azurerm:web/v20160801:WebAppHostNameBindingSlot"},
                    new Alias { Type = "azurerm:web/v20181101:WebAppHostNameBindingSlot"},
                    new Alias { Type = "azurerm:web/v20190801:WebAppHostNameBindingSlot"},
                    new Alias { Type = "azurerm:web/v20200601:WebAppHostNameBindingSlot"},
                },
            };
