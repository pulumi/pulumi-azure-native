...
namespace Pulumi.AzureNative.Web.V20180201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20180201:WebAppBackupConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppBackupConfiguration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20180201:WebAppBackupConfiguration")]
    public partial class WebAppBackupConfiguration : global::Pulumi.CustomResource
    {
        ...
        public WebAppBackupConfiguration(string name, WebAppBackupConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20180201:WebAppBackupConfiguration", name, args ?? new WebAppBackupConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppBackupConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20180201:WebAppBackupConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
