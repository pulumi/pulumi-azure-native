...
namespace Pulumi.AzureNextGen.Web.V20180201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20180201:AppServiceEnvironment")]
    public partial class AppServiceEnvironment : Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironment(string name, AppServiceEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20180201:AppServiceEnvironment", name, args ?? new AppServiceEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20180201:AppServiceEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceEnvironmentArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Web.V20180201.InternalLoadBalancingMode>? InternalLoadBalancingMode { get; set; }
