...
namespace Pulumi.AzureNextGen.Web.V20180201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20180201:WebAppConnectionStringsSlot")]
    public partial class WebAppConnectionStringsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppConnectionStringsSlot(string name, WebAppConnectionStringsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20180201:WebAppConnectionStringsSlot", name, args ?? new WebAppConnectionStringsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConnectionStringsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20180201:WebAppConnectionStringsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
