...
namespace Pulumi.AzureNative.Web.V20180201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20180201:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppConnectionStringsSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20180201:WebAppConnectionStringsSlot")]
    public partial class WebAppConnectionStringsSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppConnectionStringsSlot(string name, WebAppConnectionStringsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20180201:WebAppConnectionStringsSlot", name, args ?? new WebAppConnectionStringsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConnectionStringsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20180201:WebAppConnectionStringsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
