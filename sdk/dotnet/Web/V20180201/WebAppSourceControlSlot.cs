...
namespace Pulumi.AzureNative.Web.V20180201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20180201:WebAppSourceControlSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSourceControlSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20180201:WebAppSourceControlSlot")]
    public partial class WebAppSourceControlSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppSourceControlSlot(string name, WebAppSourceControlSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20180201:WebAppSourceControlSlot", name, args ?? new WebAppSourceControlSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSourceControlSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20180201:WebAppSourceControlSlot", name, null, MakeResourceOptions(options, id))
        {
        }
