...
namespace Pulumi.AzureRM.Web.V20180201
{
    ...
    public partial class WebAppSourceControlSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSourceControlSlot(string name, WebAppSourceControlSlotArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/v20180201:WebAppSourceControlSlot", name, args ?? new WebAppSourceControlSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSourceControlSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/v20180201:WebAppSourceControlSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:web/preview:WebAppSourceControlSlot"},
                    ...
                    new Pulumi.Alias { Type = "azurerm:web/v20181101:WebAppSourceControlSlot"},
                    new Pulumi.Alias { Type = "azurerm:web/v20190801:WebAppSourceControlSlot"},
                    new Pulumi.Alias { Type = "azurerm:web/v20200601:WebAppSourceControlSlot"},
                },
            };
