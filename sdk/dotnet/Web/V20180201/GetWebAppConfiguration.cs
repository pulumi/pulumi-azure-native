...
namespace Pulumi.AzureNative.Web.V20180201
{
    public static class GetWebAppConfiguration
    {
        ...
        public static Task<GetWebAppConfigurationResult> InvokeAsync(GetWebAppConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppConfigurationResult>("azure-native:web/v20180201:getWebAppConfiguration", args ?? new GetWebAppConfigurationArgs(), options.WithVersion());
    }
