...
namespace Pulumi.AzureNextGen.Web.V20180201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20180201:WebApplicationSettings")]
    public partial class WebApplicationSettings : Pulumi.CustomResource
    {
        ...
        public WebApplicationSettings(string name, WebApplicationSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20180201:WebApplicationSettings", name, args ?? new WebApplicationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApplicationSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20180201:WebApplicationSettings", name, null, MakeResourceOptions(options, id))
        {
        }
