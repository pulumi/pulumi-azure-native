...
namespace Pulumi.AzureNextGen.Web.V20180201
{
    ...
    /// App Service plan.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20180201:AppServicePlan")]
    public partial class AppServicePlan : Pulumi.CustomResource
    {
        ...
        public AppServicePlan(string name, AppServicePlanArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20180201:AppServicePlan", name, args ?? new AppServicePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20180201:AppServicePlan", name, null, MakeResourceOptions(options, id))
        {
        }
