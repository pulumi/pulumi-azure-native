...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20220301:WebAppBackupConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppBackupConfiguration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20220301:WebAppBackupConfiguration")]
    public partial class WebAppBackupConfiguration : global::Pulumi.CustomResource
    {
        ...
        public WebAppBackupConfiguration(string name, WebAppBackupConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppBackupConfiguration", name, args ?? new WebAppBackupConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppBackupConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppBackupConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
