...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20220301:WebAppAzureStorageAccounts is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAzureStorageAccounts to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20220301:WebAppAzureStorageAccounts")]
    public partial class WebAppAzureStorageAccounts : global::Pulumi.CustomResource
    {
        ...
        public WebAppAzureStorageAccounts(string name, WebAppAzureStorageAccountsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppAzureStorageAccounts", name, args ?? new WebAppAzureStorageAccountsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAzureStorageAccounts(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppAzureStorageAccounts", name, null, MakeResourceOptions(options, id))
        {
        }
