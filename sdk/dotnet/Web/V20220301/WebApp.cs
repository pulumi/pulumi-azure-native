...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20220301:WebApp is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebApp to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20220301:WebApp")]
    public partial class WebApp : global::Pulumi.CustomResource
    {
        ...
        public WebApp(string name, WebAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebApp", name, args ?? new WebAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebApp", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20220301.ClientCertMode>? ClientCertMode { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20220301.RedundancyMode>? RedundancyMode { get; set; }
