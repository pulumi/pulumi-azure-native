...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20220301:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.")]
    ...
    public partial class WebAppDomainOwnershipIdentifier : global::Pulumi.CustomResource
    {
        ...
        public WebAppDomainOwnershipIdentifier(string name, WebAppDomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppDomainOwnershipIdentifier", name, args ?? new WebAppDomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppDomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
