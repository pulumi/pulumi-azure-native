...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// {
    ///     var appServiceEnvironmentAseCustomDnsSuffixConfiguration = new AzureNative.Web.V20220301.AppServiceEnvironmentAseCustomDnsSuffixConfiguration("appServiceEnvironmentAseCustomDnsSuffixConfiguration", new()
    ///     {
    ...
    public partial class AppServiceEnvironmentAseCustomDnsSuffixConfiguration : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironmentAseCustomDnsSuffixConfiguration(string name, AppServiceEnvironmentAseCustomDnsSuffixConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, args ?? new AppServiceEnvironmentAseCustomDnsSuffixConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AppServiceEnvironmentAseCustomDnsSuffixConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
