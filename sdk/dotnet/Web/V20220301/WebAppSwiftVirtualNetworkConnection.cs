...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20220301:WebAppSwiftVirtualNetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSwiftVirtualNetworkConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20220301:WebAppSwiftVirtualNetworkConnection")]
    public partial class WebAppSwiftVirtualNetworkConnection : global::Pulumi.CustomResource
    {
        ...
        public WebAppSwiftVirtualNetworkConnection(string name, WebAppSwiftVirtualNetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppSwiftVirtualNetworkConnection", name, args ?? new WebAppSwiftVirtualNetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSwiftVirtualNetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppSwiftVirtualNetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
