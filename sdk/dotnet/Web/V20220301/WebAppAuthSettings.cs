...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20220301:WebAppAuthSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAuthSettings to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20220301:WebAppAuthSettings")]
    public partial class WebAppAuthSettings : global::Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettings(string name, WebAppAuthSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppAuthSettings", name, args ?? new WebAppAuthSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppAuthSettings", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppAuthSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20220301.BuiltInAuthenticationProvider>? DefaultProvider { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20220301.UnauthenticatedClientAction>? UnauthenticatedClientAction { get; set; }
