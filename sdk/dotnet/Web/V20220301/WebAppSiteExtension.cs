...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    [AzureNativeResourceType("azure-native:web/v20220301:WebAppSiteExtension")]
    public partial class WebAppSiteExtension : global::Pulumi.CustomResource
    {
        ...
        public WebAppSiteExtension(string name, WebAppSiteExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppSiteExtension", name, args ?? new WebAppSiteExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppSiteExtension", name, null, MakeResourceOptions(options, id))
        {
        }
