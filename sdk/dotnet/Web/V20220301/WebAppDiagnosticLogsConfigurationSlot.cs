...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220301:WebAppDiagnosticLogsConfigurationSlot")]
    public partial class WebAppDiagnosticLogsConfigurationSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppDiagnosticLogsConfigurationSlot(string name, WebAppDiagnosticLogsConfigurationSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppDiagnosticLogsConfigurationSlot", name, args ?? new WebAppDiagnosticLogsConfigurationSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDiagnosticLogsConfigurationSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppDiagnosticLogsConfigurationSlot", name, null, MakeResourceOptions(options, id))
        {
        }
