...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    [AzureNativeResourceType("azure-native:web/v20220301:StaticSiteUserProvidedFunctionAppForStaticSiteBuild")]
    public partial class StaticSiteUserProvidedFunctionAppForStaticSiteBuild : global::Pulumi.CustomResource
    {
        ...
        public StaticSiteUserProvidedFunctionAppForStaticSiteBuild(string name, StaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, args ?? new StaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private StaticSiteUserProvidedFunctionAppForStaticSiteBuild(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, null, MakeResourceOptions(options, id))
        {
        }
