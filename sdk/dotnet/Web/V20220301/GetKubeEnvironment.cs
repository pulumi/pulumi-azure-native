...
{
    [Obsolete(@"azure-native:web/v20220301:KubeEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:KubeEnvironment to guarantee forwards compatibility.")]
    public static class GetKubeEnvironment
    {
        ...
        public static Task<GetKubeEnvironmentResult> InvokeAsync(GetKubeEnvironmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKubeEnvironmentResult>("azure-native:web/v20220301:getKubeEnvironment", args ?? new GetKubeEnvironmentArgs(), options.WithDefaults());

        /// <summary>
        /// Description for Get the properties of a Kubernetes Environment.
        /// </summary>
        public static Output<GetKubeEnvironmentResult> Invoke(GetKubeEnvironmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKubeEnvironmentResult>("azure-native:web/v20220301:getKubeEnvironment", args ?? new GetKubeEnvironmentInvokeArgs(), options.WithDefaults());
    }
