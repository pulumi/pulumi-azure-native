...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// Premier add-on.
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20220301:WebAppPremierAddOn")]
    public partial class WebAppPremierAddOn : global::Pulumi.CustomResource
    {
        ...
        public WebAppPremierAddOn(string name, WebAppPremierAddOnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppPremierAddOn", name, args ?? new WebAppPremierAddOnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPremierAddOn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppPremierAddOn", name, null, MakeResourceOptions(options, id))
        {
        }
