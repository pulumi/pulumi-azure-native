...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20220301:WebAppBackupConfigurationSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppBackupConfigurationSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20220301:WebAppBackupConfigurationSlot")]
    public partial class WebAppBackupConfigurationSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppBackupConfigurationSlot(string name, WebAppBackupConfigurationSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppBackupConfigurationSlot", name, args ?? new WebAppBackupConfigurationSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppBackupConfigurationSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:WebAppBackupConfigurationSlot", name, null, MakeResourceOptions(options, id))
        {
        }
