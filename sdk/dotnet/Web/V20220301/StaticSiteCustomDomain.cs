...
namespace Pulumi.AzureNative.Web.V20220301
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20220301:StaticSiteCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:StaticSiteCustomDomain to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20220301:StaticSiteCustomDomain")]
    public partial class StaticSiteCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public StaticSiteCustomDomain(string name, StaticSiteCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:StaticSiteCustomDomain", name, args ?? new StaticSiteCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSiteCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20220301:StaticSiteCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:web:StaticSiteCustomDomain"},
