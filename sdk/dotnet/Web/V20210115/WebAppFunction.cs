...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210115:WebAppFunction")]
    public partial class WebAppFunction : Pulumi.CustomResource
    {
        ...
        public WebAppFunction(string name, WebAppFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppFunction", name, args ?? new WebAppFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppFunction", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppFunction"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppFunction"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:WebAppFunction"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppFunction"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppFunction"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppFunction"},
                },
            };
