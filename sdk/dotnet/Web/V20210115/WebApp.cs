...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210115:WebApp")]
    public partial class WebApp : global::Pulumi.CustomResource
    {
        ...
        public WebApp(string name, WebAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebApp", name, args ?? new WebAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebApp", name, null, MakeResourceOptions(options, id))
        {
        }
