...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210115:WebAppDeploymentSlot")]
    public partial class WebAppDeploymentSlot : Pulumi.CustomResource
    {
        ...
        public WebAppDeploymentSlot(string name, WebAppDeploymentSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppDeploymentSlot", name, args ?? new WebAppDeploymentSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDeploymentSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppDeploymentSlot", name, null, MakeResourceOptions(options, id))
        {
        }
