...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    [AzureNativeResourceType("azure-native:web/v20210115:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
