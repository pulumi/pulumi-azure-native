...
namespace Pulumi.AzureNative.Web.V20210115
{
    public static class ListStaticSiteSecrets
    {
        ...
        public static Task<ListStaticSiteSecretsResult> InvokeAsync(ListStaticSiteSecretsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListStaticSiteSecretsResult>("azure-native:web/v20210115:listStaticSiteSecrets", args ?? new ListStaticSiteSecretsArgs(), options.WithVersion());

        /// <summary>
        /// String dictionary resource.
        /// </summary>
        public static Output<ListStaticSiteSecretsResult> Invoke(ListStaticSiteSecretsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListStaticSiteSecretsResult>("azure-native:web/v20210115:listStaticSiteSecrets", args ?? new ListStaticSiteSecretsInvokeArgs(), options.WithVersion());
    }
