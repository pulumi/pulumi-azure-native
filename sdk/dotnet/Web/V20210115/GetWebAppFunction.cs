...
namespace Pulumi.AzureNative.Web.V20210115
{
    public static class GetWebAppFunction
    {
        ...
        public static Task<GetWebAppFunctionResult> InvokeAsync(GetWebAppFunctionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppFunctionResult>("azure-native:web/v20210115:getWebAppFunction", args ?? new GetWebAppFunctionArgs(), options.WithDefaults());

        /// <summary>
        /// Function information.
        /// </summary>
        public static Output<GetWebAppFunctionResult> Invoke(GetWebAppFunctionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebAppFunctionResult>("azure-native:web/v20210115:getWebAppFunction", args ?? new GetWebAppFunctionInvokeArgs(), options.WithDefaults());
    }
