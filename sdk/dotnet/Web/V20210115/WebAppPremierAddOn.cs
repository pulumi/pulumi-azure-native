...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    /// Premier add-on.
    /// </summary>
    [Obsolete(@"azure-native:web/v20210115:WebAppPremierAddOn is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPremierAddOn to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20210115:WebAppPremierAddOn")]
    public partial class WebAppPremierAddOn : global::Pulumi.CustomResource
    {
        ...
        public WebAppPremierAddOn(string name, WebAppPremierAddOnArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppPremierAddOn", name, args ?? new WebAppPremierAddOnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPremierAddOn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppPremierAddOn", name, null, MakeResourceOptions(options, id))
        {
        }
