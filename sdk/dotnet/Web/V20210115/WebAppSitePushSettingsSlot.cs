...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210115:WebAppSitePushSettingsSlot")]
    public partial class WebAppSitePushSettingsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSitePushSettingsSlot(string name, WebAppSitePushSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppSitePushSettingsSlot", name, args ?? new WebAppSitePushSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSitePushSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppSitePushSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppSitePushSettingsSlot"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20200901:WebAppSitePushSettingsSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20201001:WebAppSitePushSettingsSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201001:WebAppSitePushSettingsSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20201201:WebAppSitePushSettingsSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppSitePushSettingsSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:WebAppSitePushSettingsSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppSitePushSettingsSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppSitePushSettingsSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppSitePushSettingsSlot"},
                },
            };
