...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210115:WebAppDiagnosticLogsConfiguration")]
    public partial class WebAppDiagnosticLogsConfiguration : Pulumi.CustomResource
    {
        ...
        public WebAppDiagnosticLogsConfiguration(string name, WebAppDiagnosticLogsConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppDiagnosticLogsConfiguration", name, args ?? new WebAppDiagnosticLogsConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDiagnosticLogsConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppDiagnosticLogsConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
