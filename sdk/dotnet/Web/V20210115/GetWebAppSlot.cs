...
namespace Pulumi.AzureNative.Web.V20210115
{
    public static class GetWebAppSlot
    {
        ...
        public static Task<GetWebAppSlotResult> InvokeAsync(GetWebAppSlotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppSlotResult>("azure-native:web/v20210115:getWebAppSlot", args ?? new GetWebAppSlotArgs(), options.WithDefaults());

        /// <summary>
        /// A web app, a mobile app backend, or an API app.
        /// </summary>
        public static Output<GetWebAppSlotResult> Invoke(GetWebAppSlotInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebAppSlotResult>("azure-native:web/v20210115:getWebAppSlot", args ?? new GetWebAppSlotInvokeArgs(), options.WithDefaults());
    }
