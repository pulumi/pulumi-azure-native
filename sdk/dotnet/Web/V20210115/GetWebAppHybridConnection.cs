...
namespace Pulumi.AzureNative.Web.V20210115
{
    public static class GetWebAppHybridConnection
    {
        ...
        public static Task<GetWebAppHybridConnectionResult> InvokeAsync(GetWebAppHybridConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppHybridConnectionResult>("azure-native:web/v20210115:getWebAppHybridConnection", args ?? new GetWebAppHybridConnectionArgs(), options.WithVersion());
        ...
        public static Output<GetWebAppHybridConnectionResult> Invoke(GetWebAppHybridConnectionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebAppHybridConnectionResult>("azure-native:web/v20210115:getWebAppHybridConnection", args ?? new GetWebAppHybridConnectionInvokeArgs(), options.WithVersion());
    }
