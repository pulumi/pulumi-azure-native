...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210115:WebAppSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20210115:WebAppSlot")]
    public partial class WebAppSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppSlot(string name, WebAppSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppSlot", name, args ?? new WebAppSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppSlotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20210115.ClientCertMode>? ClientCertMode { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20210115.RedundancyMode>? RedundancyMode { get; set; }
