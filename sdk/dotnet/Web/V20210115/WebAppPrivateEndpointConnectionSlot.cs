...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210115:WebAppPrivateEndpointConnectionSlot")]
    public partial class WebAppPrivateEndpointConnectionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppPrivateEndpointConnectionSlot(string name, WebAppPrivateEndpointConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppPrivateEndpointConnectionSlot", name, args ?? new WebAppPrivateEndpointConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPrivateEndpointConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppPrivateEndpointConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppPrivateEndpointConnectionSlot"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppPrivateEndpointConnectionSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppPrivateEndpointConnectionSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppPrivateEndpointConnectionSlot"},
                },
            };
