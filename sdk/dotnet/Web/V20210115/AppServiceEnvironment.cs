...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    public partial class AppServiceEnvironment : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironment(string name, AppServiceEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:AppServiceEnvironment", name, args ?? new AppServiceEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:AppServiceEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceEnvironmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20210115.LoadBalancingMode>? InternalLoadBalancingMode { get; set; }
