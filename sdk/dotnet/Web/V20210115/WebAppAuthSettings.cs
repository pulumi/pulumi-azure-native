...
namespace Pulumi.AzureNative.Web.V20210115
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210115:WebAppAuthSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppAuthSettings to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20210115:WebAppAuthSettings")]
    public partial class WebAppAuthSettings : global::Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettings(string name, WebAppAuthSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppAuthSettings", name, args ?? new WebAppAuthSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210115:WebAppAuthSettings", name, null, MakeResourceOptions(options, id))
        {
        }
