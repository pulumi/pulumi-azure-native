...
namespace Pulumi.AzureNative.Web.Inputs
{
    ...
    /// </summary>
    public sealed class IdentityProvidersV1Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputMap<Inputs.CustomOpenIdConnectProviderV1Args>? _customOpenIdConnectProviders;

        /// <summary>
        /// The map of the name of the alias of each custom Open ID Connect provider to the
        /// configuration settings of the custom Open ID Connect provider.
        /// </summary>
        public InputMap<Inputs.CustomOpenIdConnectProviderV1Args> CustomOpenIdConnectProviders
        {
            get => _customOpenIdConnectProviders ?? (_customOpenIdConnectProviders = new InputMap<Inputs.CustomOpenIdConnectProviderV1Args>());
        ...
        public IdentityProvidersV1Args()
        {
        }
        public static new IdentityProvidersV1Args Empty => new IdentityProvidersV1Args();
    }
}
