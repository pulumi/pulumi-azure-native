...
namespace Pulumi.AzureRM.Web.Inputs
{
    ...
    /// </summary>
    public sealed class VnetInfoResponsePropertiesArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.VnetRouteResponseArgs>? _routes;

        /// <summary>
        /// The routes that this Virtual Network connection uses.
        /// </summary>
        public InputList<Inputs.VnetRouteResponseArgs> Routes
        {
            get => _routes ?? (_routes = new InputList<Inputs.VnetRouteResponseArgs>());
            set => _routes = value;
        }
        ...
        public VnetInfoResponsePropertiesArgs()
        {
        }
    }
}
