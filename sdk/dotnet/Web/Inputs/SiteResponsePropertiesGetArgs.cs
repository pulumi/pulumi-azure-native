...
namespace Pulumi.AzureRM.Web.Inputs
{
    ...
    /// </summary>
    public sealed class SiteResponsePropertiesGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("cloningInfo")]
        public Input<Inputs.CloningInfoResponseGetArgs>? CloningInfo { get; set; }
        ...
        private InputList<Inputs.HostNameSslStateResponseGetArgs>? _hostNameSslStates;

        /// <summary>
        /// Hostname SSL states are used to manage the SSL bindings for app's hostnames.
        /// </summary>
        public InputList<Inputs.HostNameSslStateResponseGetArgs> HostNameSslStates
        {
            get => _hostNameSslStates ?? (_hostNameSslStates = new InputList<Inputs.HostNameSslStateResponseGetArgs>());
        ...
        /// </summary>
        [Input("siteConfig")]
        public Input<Inputs.SiteConfigResponseGetArgs>? SiteConfig { get; set; }

        /// <summary>
        /// Status of the last deployment slot swap operation.
        /// </summary>
        [Input("slotSwapStatus", required: true)]
        public Input<Inputs.SlotSwapStatusResponseGetArgs> SlotSwapStatus { get; set; } = null!;
        ...
        public SiteResponsePropertiesGetArgs()
        {
        }
    }
}
