...
namespace Pulumi.AzureNative.Web
{
    ...
    public partial class AiGateway : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.AiGatewayPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public AiGateway(string name, AiGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web:AiGateway", name, args ?? new AiGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AiGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web:AiGateway", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AiGateway Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new AiGateway(name, id, options);
        }
    }
