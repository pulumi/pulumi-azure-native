...
namespace Pulumi.AzureNextGen.Web
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web:ManagedHostingEnvironment")]
    public partial class ManagedHostingEnvironment : Pulumi.CustomResource
    {
        ...
        public ManagedHostingEnvironment(string name, ManagedHostingEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:ManagedHostingEnvironment", name, args ?? new ManagedHostingEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedHostingEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:ManagedHostingEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedHostingEnvironmentArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Web.InternalLoadBalancingMode>? InternalLoadBalancingMode { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Web.ProvisioningState>? ProvisioningState { get; set; }
        ...
        public Input<Pulumi.AzureNextGen.Web.HostingEnvironmentStatus> Status { get; set; } = null!;
