...
namespace Pulumi.AzureNative.Web
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web:ManagedHostingEnvironment")]
    public partial class ManagedHostingEnvironment : Pulumi.CustomResource
    {
        ...
        public ManagedHostingEnvironment(string name, ManagedHostingEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web:ManagedHostingEnvironment", name, args ?? new ManagedHostingEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagedHostingEnvironment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web:ManagedHostingEnvironment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ManagedHostingEnvironmentArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.InternalLoadBalancingMode>? InternalLoadBalancingMode { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.ProvisioningState>? ProvisioningState { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.HostingEnvironmentStatus> Status { get; set; } = null!;
