...
namespace Pulumi.AzureNative.Web.V20201201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20201201:WebAppPublicCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPublicCertificate to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20201201:WebAppPublicCertificate")]
    public partial class WebAppPublicCertificate : global::Pulumi.CustomResource
    {
        ...
        public WebAppPublicCertificate(string name, WebAppPublicCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:WebAppPublicCertificate", name, args ?? new WebAppPublicCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPublicCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:WebAppPublicCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppPublicCertificateArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20201201.PublicCertificateLocation>? PublicCertificateLocation { get; set; }
