...
namespace Pulumi.AzureNative.Web.V20201201
{
    public static class GetStaticSite
    {
        ...
        public static Task<GetStaticSiteResult> InvokeAsync(GetStaticSiteArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStaticSiteResult>("azure-native:web/v20201201:getStaticSite", args ?? new GetStaticSiteArgs(), options.WithVersion());

        /// <summary>
        /// Static Site ARM resource.
        /// </summary>
        public static Output<GetStaticSiteResult> Invoke(GetStaticSiteInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStaticSiteResult>("azure-native:web/v20201201:getStaticSite", args ?? new GetStaticSiteInvokeArgs(), options.WithVersion());
    }
