...
namespace Pulumi.AzureNative.Web.V20201201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20201201:WebAppApplicationSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppApplicationSettingsSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20201201:WebAppApplicationSettingsSlot")]
    public partial class WebAppApplicationSettingsSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppApplicationSettingsSlot(string name, WebAppApplicationSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:WebAppApplicationSettingsSlot", name, args ?? new WebAppApplicationSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppApplicationSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:WebAppApplicationSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
