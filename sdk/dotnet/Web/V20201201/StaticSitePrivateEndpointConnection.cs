...
namespace Pulumi.AzureNative.Web.V20201201
{
    ...
    /// {
    ///     var staticSitePrivateEndpointConnection = new AzureNative.Web.V20201201.StaticSitePrivateEndpointConnection("staticSitePrivateEndpointConnection", new()
    ///     {
    ///         Name = "testSite",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201201:StaticSitePrivateEndpointConnection")]
    public partial class StaticSitePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public StaticSitePrivateEndpointConnection(string name, StaticSitePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:StaticSitePrivateEndpointConnection", name, args ?? new StaticSitePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSitePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:StaticSitePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
