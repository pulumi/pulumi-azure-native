...
namespace Pulumi.AzureNative.Web.V20201201
{
    ...
    [AzureNativeResourceType("azure-native:web/v20201201:StaticSiteCustomDomain")]
    public partial class StaticSiteCustomDomain : global::Pulumi.CustomResource
    {
        ...
        public StaticSiteCustomDomain(string name, StaticSiteCustomDomainArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:StaticSiteCustomDomain", name, args ?? new StaticSiteCustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSiteCustomDomain(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:StaticSiteCustomDomain", name, null, MakeResourceOptions(options, id))
        {
        }
