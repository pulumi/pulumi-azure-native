...
namespace Pulumi.AzureNative.Web.V20201201
{
    ...
    public partial class AppServiceEnvironmentPrivateEndpointConnection : Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironmentPrivateEndpointConnection(string name, AppServiceEnvironmentPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:AppServiceEnvironmentPrivateEndpointConnection", name, args ?? new AppServiceEnvironmentPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironmentPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:AppServiceEnvironmentPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:AppServiceEnvironmentPrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:AppServiceEnvironmentPrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:AppServiceEnvironmentPrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:AppServiceEnvironmentPrivateEndpointConnection"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:AppServiceEnvironmentPrivateEndpointConnection"},
                },
            };
