...
namespace Pulumi.AzureNative.Web.V20201201
{
    ...
    /// {
    ///     var staticSite = new AzureNative.Web.V20201201.StaticSite("staticSite", new()
    ///     {
    ///         Branch = "master",
    ///         BuildProperties = new AzureNative.Web.V20201201.Inputs.StaticSiteBuildPropertiesArgs
    ///         {
    ///             ApiLocation = "api",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201201:StaticSite")]
    public partial class StaticSite : global::Pulumi.CustomResource
    {
        ...
        public StaticSite(string name, StaticSiteArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:StaticSite", name, args ?? new StaticSiteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StaticSite(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:StaticSite", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StaticSiteArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20201201.StagingEnvironmentPolicy>? StagingEnvironmentPolicy { get; set; }
