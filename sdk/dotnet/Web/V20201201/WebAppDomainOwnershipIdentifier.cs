...
namespace Pulumi.AzureNative.Web.V20201201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20201201:WebAppDomainOwnershipIdentifier")]
    public partial class WebAppDomainOwnershipIdentifier : Pulumi.CustomResource
    {
        ...
        public WebAppDomainOwnershipIdentifier(string name, WebAppDomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:WebAppDomainOwnershipIdentifier", name, args ?? new WebAppDomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20201201:WebAppDomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
