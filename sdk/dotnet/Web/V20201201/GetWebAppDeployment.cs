...
namespace Pulumi.AzureNative.Web.V20201201
{
    public static class GetWebAppDeployment
    {
        ...
        public static Task<GetWebAppDeploymentResult> InvokeAsync(GetWebAppDeploymentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppDeploymentResult>("azure-native:web/v20201201:getWebAppDeployment", args ?? new GetWebAppDeploymentArgs(), options.WithDefaults());

        /// <summary>
        /// User credentials used for publishing activity.
        /// </summary>
        public static Output<GetWebAppDeploymentResult> Invoke(GetWebAppDeploymentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebAppDeploymentResult>("azure-native:web/v20201201:getWebAppDeployment", args ?? new GetWebAppDeploymentInvokeArgs(), options.WithDefaults());
    }
