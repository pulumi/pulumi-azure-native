...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// App Service plan.
    /// </summary>
    [Obsolete(@"azure-native:web/v20210201:AppServicePlan is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:AppServicePlan to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20210201:AppServicePlan")]
    public partial class AppServicePlan : global::Pulumi.CustomResource
    {
        ...
        public AppServicePlan(string name, AppServicePlanArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:AppServicePlan", name, args ?? new AppServicePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:AppServicePlan", name, null, MakeResourceOptions(options, id))
        {
        }
