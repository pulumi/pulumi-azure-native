...
namespace Pulumi.AzureNative.Web.V20210201
{
    public static class GetStaticSite
    {
        ...
        public static Task<GetStaticSiteResult> InvokeAsync(GetStaticSiteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetStaticSiteResult>("azure-native:web/v20210201:getStaticSite", args ?? new GetStaticSiteArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a static site.
        /// </summary>
        public static Output<GetStaticSiteResult> Invoke(GetStaticSiteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetStaticSiteResult>("azure-native:web/v20210201:getStaticSite", args ?? new GetStaticSiteInvokeArgs(), options.WithDefaults());
    }
