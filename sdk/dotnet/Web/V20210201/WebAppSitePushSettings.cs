...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210201:WebAppSitePushSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSitePushSettings to guarantee forwards compatibility.")]
    ...
    public partial class WebAppSitePushSettings : global::Pulumi.CustomResource
    {
        ...
        public WebAppSitePushSettings(string name, WebAppSitePushSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppSitePushSettings", name, args ?? new WebAppSitePushSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSitePushSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppSitePushSettings", name, null, MakeResourceOptions(options, id))
        {
        }
