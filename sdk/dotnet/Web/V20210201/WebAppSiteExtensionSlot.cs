...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210201:WebAppSiteExtensionSlot")]
    public partial class WebAppSiteExtensionSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppSiteExtensionSlot(string name, WebAppSiteExtensionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppSiteExtensionSlot", name, args ?? new WebAppSiteExtensionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteExtensionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppSiteExtensionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
