...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210201:WebAppApplicationSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppApplicationSettings to guarantee forwards compatibility.")]
    ...
    public partial class WebAppApplicationSettings : global::Pulumi.CustomResource
    {
        ...
        public WebAppApplicationSettings(string name, WebAppApplicationSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppApplicationSettings", name, args ?? new WebAppApplicationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppApplicationSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppApplicationSettings", name, null, MakeResourceOptions(options, id))
        {
        }
