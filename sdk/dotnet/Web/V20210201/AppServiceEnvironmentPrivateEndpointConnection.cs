...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210201:AppServiceEnvironmentPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:AppServiceEnvironmentPrivateEndpointConnection to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20210201:AppServiceEnvironmentPrivateEndpointConnection")]
    public partial class AppServiceEnvironmentPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironmentPrivateEndpointConnection(string name, AppServiceEnvironmentPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:AppServiceEnvironmentPrivateEndpointConnection", name, args ?? new AppServiceEnvironmentPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironmentPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:AppServiceEnvironmentPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
