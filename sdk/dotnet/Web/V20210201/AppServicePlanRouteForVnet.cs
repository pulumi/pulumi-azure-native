...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210201:AppServicePlanRouteForVnet")]
    public partial class AppServicePlanRouteForVnet : Pulumi.CustomResource
    {
        ...
        public AppServicePlanRouteForVnet(string name, AppServicePlanRouteForVnetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:AppServicePlanRouteForVnet", name, args ?? new AppServicePlanRouteForVnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlanRouteForVnet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:AppServicePlanRouteForVnet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:AppServicePlanRouteForVnet"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:AppServicePlanRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:AppServicePlanRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:AppServicePlanRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:AppServicePlanRouteForVnet"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:AppServicePlanRouteForVnet"},
                },
            };
    ...
    public sealed class AppServicePlanRouteForVnetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("routeType")]
        public InputUnion<string, Pulumi.AzureNative.Web.V20210201.RouteType>? RouteType { get; set; }
