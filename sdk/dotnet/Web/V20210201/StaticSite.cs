...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// {
    ///     var staticSite = new AzureNative.Web.V20210201.StaticSite("staticSite", new()
    ///     {
    ///         Branch = "master",
    ///         BuildProperties = new AzureNative.Web.V20210201.Inputs.StaticSiteBuildPropertiesArgs
    ///         {
    ///             ApiLocation = "api",
    ...
    ///         Sku = new AzureNative.Web.V20210201.Inputs.SkuDescriptionArgs
    ///         {
    ///             Name = "Basic",
    ///             Tier = "Basic",
    ///         },
