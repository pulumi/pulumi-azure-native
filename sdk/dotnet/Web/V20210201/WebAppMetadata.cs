...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210201:WebAppMetadata is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppMetadata to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20210201:WebAppMetadata")]
    public partial class WebAppMetadata : global::Pulumi.CustomResource
    {
        ...
        public WebAppMetadata(string name, WebAppMetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppMetadata", name, args ?? new WebAppMetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppMetadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppMetadata", name, null, MakeResourceOptions(options, id))
        {
        }
