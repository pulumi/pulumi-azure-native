...
{
    [Obsolete(@"azure-native:web/v20210201:WebAppSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppSlot to guarantee forwards compatibility.")]
    public static class GetWebAppSlot
    {
        ...
        public static Task<GetWebAppSlotResult> InvokeAsync(GetWebAppSlotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppSlotResult>("azure-native:web/v20210201:getWebAppSlot", args ?? new GetWebAppSlotArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of a web, mobile, or API app.
        /// </summary>
        public static Output<GetWebAppSlotResult> Invoke(GetWebAppSlotInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebAppSlotResult>("azure-native:web/v20210201:getWebAppSlot", args ?? new GetWebAppSlotInvokeArgs(), options.WithDefaults());
    }
