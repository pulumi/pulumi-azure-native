...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210201:WebAppDiagnosticLogsConfiguration")]
    public partial class WebAppDiagnosticLogsConfiguration : global::Pulumi.CustomResource
    {
        ...
        public WebAppDiagnosticLogsConfiguration(string name, WebAppDiagnosticLogsConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppDiagnosticLogsConfiguration", name, args ?? new WebAppDiagnosticLogsConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDiagnosticLogsConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppDiagnosticLogsConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
