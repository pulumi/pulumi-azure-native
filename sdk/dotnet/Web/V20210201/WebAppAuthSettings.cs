...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    public partial class WebAppAuthSettings : Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettings(string name, WebAppAuthSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppAuthSettings", name, args ?? new WebAppAuthSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppAuthSettings", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppAuthSettings"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppAuthSettings"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:WebAppAuthSettings"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppAuthSettings"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppAuthSettings"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppAuthSettings"},
                },
            };
    ...
    public sealed class WebAppAuthSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20210201.BuiltInAuthenticationProvider>? DefaultProvider { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20210201.UnauthenticatedClientAction>? UnauthenticatedClientAction { get; set; }
