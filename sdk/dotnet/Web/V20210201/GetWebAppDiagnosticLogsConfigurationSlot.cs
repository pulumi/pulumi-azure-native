...
namespace Pulumi.AzureNative.Web.V20210201
{
    public static class GetWebAppDiagnosticLogsConfigurationSlot
    {
        ...
        public static Task<GetWebAppDiagnosticLogsConfigurationSlotResult> InvokeAsync(GetWebAppDiagnosticLogsConfigurationSlotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppDiagnosticLogsConfigurationSlotResult>("azure-native:web/v20210201:getWebAppDiagnosticLogsConfigurationSlot", args ?? new GetWebAppDiagnosticLogsConfigurationSlotArgs(), options.WithDefaults());
