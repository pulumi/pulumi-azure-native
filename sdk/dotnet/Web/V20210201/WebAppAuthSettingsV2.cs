...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210201:WebAppAuthSettingsV2")]
    public partial class WebAppAuthSettingsV2 : global::Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettingsV2(string name, WebAppAuthSettingsV2Args args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppAuthSettingsV2", name, args ?? new WebAppAuthSettingsV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettingsV2(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppAuthSettingsV2", name, null, MakeResourceOptions(options, id))
        {
        }
