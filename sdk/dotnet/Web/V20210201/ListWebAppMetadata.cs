...
namespace Pulumi.AzureNative.Web.V20210201
{
    public static class ListWebAppMetadata
    {
        ...
        public static Task<ListWebAppMetadataResult> InvokeAsync(ListWebAppMetadataArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebAppMetadataResult>("azure-native:web/v20210201:listWebAppMetadata", args ?? new ListWebAppMetadataArgs(), options.WithVersion());

        /// <summary>
        /// String dictionary resource.
        /// </summary>
        public static Output<ListWebAppMetadataResult> Invoke(ListWebAppMetadataInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListWebAppMetadataResult>("azure-native:web/v20210201:listWebAppMetadata", args ?? new ListWebAppMetadataInvokeArgs(), options.WithVersion());
    }
