...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20210201:WebAppPublicCertificateSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppPublicCertificateSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20210201:WebAppPublicCertificateSlot")]
    public partial class WebAppPublicCertificateSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppPublicCertificateSlot(string name, WebAppPublicCertificateSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppPublicCertificateSlot", name, args ?? new WebAppPublicCertificateSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPublicCertificateSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppPublicCertificateSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppPublicCertificateSlotArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20210201.PublicCertificateLocation>? PublicCertificateLocation { get; set; }
