...
namespace Pulumi.AzureNative.Web.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20210201:WebAppFunction")]
    public partial class WebAppFunction : global::Pulumi.CustomResource
    {
        ...
        public WebAppFunction(string name, WebAppFunctionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppFunction", name, args ?? new WebAppFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppFunction(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20210201:WebAppFunction", name, null, MakeResourceOptions(options, id))
        {
        }
