...
namespace Pulumi.AzureNative.Web
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web:AppServiceEnvironmentPrivateEndpointConnection")]
    public partial class AppServiceEnvironmentPrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironmentPrivateEndpointConnection(string name, AppServiceEnvironmentPrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web:AppServiceEnvironmentPrivateEndpointConnection", name, args ?? new AppServiceEnvironmentPrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceEnvironmentPrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web:AppServiceEnvironmentPrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:web/v20241101:AppServiceEnvironmentPrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native:web/v20250301:AppServiceEnvironmentPrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native:web/v20250501:AppServiceEnvironmentPrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native:web/v20260301preview:AppServiceEnvironmentPrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native:web/v20260315:AppServiceEnvironmentPrivateEndpointConnection" },
                    new global::Pulumi.Alias { Type = "azure-native:web/v20260715:AppServiceEnvironmentPrivateEndpointConnection" },
                },
            };
