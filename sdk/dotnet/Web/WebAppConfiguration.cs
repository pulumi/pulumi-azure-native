...
namespace Pulumi.AzureNative.Web
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web:WebAppConfiguration")]
    public partial class WebAppConfiguration : Pulumi.CustomResource
    {
        ...
        public WebAppConfiguration(string name, WebAppConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web:WebAppConfiguration", name, args ?? new WebAppConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web:WebAppConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("loadBalancing")]
        public Input<Pulumi.AzureNative.Web.SiteLoadBalancing>? LoadBalancing { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.ManagedPipelineMode>? ManagedPipelineMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.SupportedTlsVersions>? ScmMinTlsVersion { get; set; }

        /// <summary>
        /// SCM type.
        /// </summary>
        [Input("scmType")]
        public InputUnion<string, Pulumi.AzureNative.Web.ScmType>? ScmType { get; set; }
