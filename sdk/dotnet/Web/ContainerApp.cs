...
namespace Pulumi.AzureNative.Web
{
    ...
    public partial class ContainerApp : Pulumi.CustomResource
    {
        ...
        public ContainerApp(string name, ContainerAppArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web:ContainerApp", name, args ?? new ContainerAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web:ContainerApp", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:web:ContainerApp"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210301:ContainerApp"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210301:ContainerApp"},
                },
            };
