...
namespace Pulumi.AzureRM.Web
{
    ...
    public partial class AppServicePremieraddon : Pulumi.CustomResource
    {
        ...
        private AppServicePremieraddon(string name, Input<string> id, AppServicePremieraddonState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:web:AppServicePremieraddon", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AppServicePremieraddon Get(string name, Input<string> id, AppServicePremieraddonState? state = null, CustomResourceOptions? options = null)
        {
            return new AppServicePremieraddon(name, id, state, options);
        }
    }
    ...
    public sealed class AppServicePremieraddonState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Kind of resource.
        /// </summary>
        ...
        public Input<Inputs.PremierAddOnResponsePropertiesGetArgs> Properties { get; set; } = null!;
        ...
        public AppServicePremieraddonState()
        {
        }
    }
}
