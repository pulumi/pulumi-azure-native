...
namespace Pulumi.AzureRM.Web
{
    ...
    public partial class AppService : Pulumi.CustomResource
    {
        ...
        public AppService(string name, AppServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web:AppService", name, args ?? new AppServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web:AppService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AppService Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new AppService(name, id, options);
        }
    }
