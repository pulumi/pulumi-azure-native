...
namespace Pulumi.AzureNative.Web.V20160601
{
    ...
    /// {
    ///     var connection = new AzureNative.Web.V20160601.Connection("connection", new()
    ///     {
    ///         ConnectionName = "testManagedApi",
    ///         Properties = new AzureNative.Web.V20160601.Inputs.ApiConnectionDefinitionPropertiesArgs
    ///         {
    ///             Api = new AzureNative.Web.V20160601.Inputs.ApiReferenceArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20160601:Connection")]
    public partial class Connection : global::Pulumi.CustomResource
    {
        ...
        public Connection(string name, ConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160601:Connection", name, args ?? new ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160601:Connection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:web:Connection"},
