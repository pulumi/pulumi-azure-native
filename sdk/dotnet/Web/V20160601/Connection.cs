...
namespace Pulumi.AzureNextGen.Web.V20160601
{
    ...
    /// API connection
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20160601:Connection")]
    public partial class Connection : Pulumi.CustomResource
    {
        ...
        public Connection(string name, ConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160601:Connection", name, args ?? new ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160601:Connection", name, null, MakeResourceOptions(options, id))
        {
        }
