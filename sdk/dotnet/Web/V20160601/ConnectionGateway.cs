...
namespace Pulumi.AzureNative.Web.V20160601
{
    ...
    /// {
    ///     var connectionGateway = new AzureNative.Web.V20160601.ConnectionGateway("connectionGateway", new()
    ///     {
    ///         ConnectionGatewayName = "test123",
    ///         Properties = new AzureNative.Web.V20160601.Inputs.ConnectionGatewayDefinitionPropertiesArgs
    ///         {
    ///             BackendUri = "https://WABI-WEST-US-redirect.analysis.windows.net",
    ///             ConnectionGatewayInstallation = new AzureNative.Web.V20160601.Inputs.ConnectionGatewayReferenceArgs
    ///             {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:web/v20160601:ConnectionGateway test123 /subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/testResourceGroup/providers/Microsoft.Web/connectionGateways/test123 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20160601:ConnectionGateway")]
    public partial class ConnectionGateway : global::Pulumi.CustomResource
    {
        ...
        public ConnectionGateway(string name, ConnectionGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160601:ConnectionGateway", name, args ?? new ConnectionGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectionGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160601:ConnectionGateway", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:web:ConnectionGateway"},
                },
            };
