...
namespace Pulumi.AzureRM.Web
{
    ...
    public partial class AppServiceSlot : Pulumi.CustomResource
    {
        ...
        private AppServiceSlot(string name, Input<string> id, AppServiceSlotState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:web:AppServiceSlot", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AppServiceSlot Get(string name, Input<string> id, AppServiceSlotState? state = null, CustomResourceOptions? options = null)
        {
            return new AppServiceSlot(name, id, state, options);
        }
    }
    ...
    public sealed class AppServiceSlotState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Managed service identity.
        /// </summary>
        ...
        public Input<Inputs.SiteResponsePropertiesGetArgs> Properties { get; set; } = null!;
