...
namespace Pulumi.AzureNative.Web.V20181101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20181101:WebAppSlot")]
    public partial class WebAppSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSlot(string name, WebAppSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppSlot", name, args ?? new WebAppSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppSlot"},
                },
            };
    ...
    public sealed class WebAppSlotArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("geoDistributions")]
        private InputList<Inputs.GeoDistributionArgs>? _geoDistributions;

        /// <summary>
        /// GeoDistributions for this site
        /// </summary>
        public InputList<Inputs.GeoDistributionArgs> GeoDistributions
        {
            get => _geoDistributions ?? (_geoDistributions = new InputList<Inputs.GeoDistributionArgs>());
            set => _geoDistributions = value;
        }
        ...
        public Input<Pulumi.AzureNative.Web.V20181101.RedundancyMode>? RedundancyMode { get; set; }
