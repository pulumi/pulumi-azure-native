...
namespace Pulumi.AzureNative.Web.V20181101
{
    ...
    public partial class WebAppHostNameBindingSlot : Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBindingSlot(string name, WebAppHostNameBindingSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppHostNameBindingSlot", name, args ?? new WebAppHostNameBindingSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBindingSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppHostNameBindingSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppHostNameBindingSlotArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.Web.V20181101.AzureResourceType>? AzureResourceType { get; set; }

        /// <summary>
        /// Custom DNS record type.
        /// </summary>
        [Input("customHostNameDnsRecordType")]
        public Input<Pulumi.AzureNative.Web.V20181101.CustomHostNameDnsRecordType>? CustomHostNameDnsRecordType { get; set; }
        ...
        /// </summary>
        [Input("hostNameType")]
        public Input<Pulumi.AzureNative.Web.V20181101.HostNameType>? HostNameType { get; set; }
