...
namespace Pulumi.AzureRM.Web.V20181101
{
    public static class GetWebAppDeploymentSlot
    {
        public static Task<GetWebAppDeploymentSlotResult> InvokeAsync(GetWebAppDeploymentSlotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppDeploymentSlotResult>("azurerm:web/v20181101:getWebAppDeploymentSlot", args ?? new GetWebAppDeploymentSlotArgs(), options.WithVersion());
    }
