...
namespace Pulumi.AzureNextGen.Web.V20181101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20181101:WebAppDomainOwnershipIdentifierSlot")]
    public partial class WebAppDomainOwnershipIdentifierSlot : Pulumi.CustomResource
    {
        ...
        public WebAppDomainOwnershipIdentifierSlot(string name, WebAppDomainOwnershipIdentifierSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppDomainOwnershipIdentifierSlot", name, args ?? new WebAppDomainOwnershipIdentifierSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDomainOwnershipIdentifierSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppDomainOwnershipIdentifierSlot", name, null, MakeResourceOptions(options, id))
        {
        }
