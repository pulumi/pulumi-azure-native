...
namespace Pulumi.AzureNative.Web.V20181101
{
    ...
    /// Premier add-on.
    /// </summary>
    [Obsolete(@"azure-native:web/v20181101:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPremierAddOnSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20181101:WebAppPremierAddOnSlot")]
    public partial class WebAppPremierAddOnSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppPremierAddOnSlot(string name, WebAppPremierAddOnSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppPremierAddOnSlot", name, args ?? new WebAppPremierAddOnSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPremierAddOnSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppPremierAddOnSlot", name, null, MakeResourceOptions(options, id))
        {
        }
