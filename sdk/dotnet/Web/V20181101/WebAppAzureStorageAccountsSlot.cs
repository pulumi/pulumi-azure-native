...
namespace Pulumi.AzureNextGen.Web.V20181101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20181101:WebAppAzureStorageAccountsSlot")]
    public partial class WebAppAzureStorageAccountsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppAzureStorageAccountsSlot(string name, WebAppAzureStorageAccountsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppAzureStorageAccountsSlot", name, args ?? new WebAppAzureStorageAccountsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAzureStorageAccountsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppAzureStorageAccountsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
