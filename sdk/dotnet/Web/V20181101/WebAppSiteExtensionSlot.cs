...
namespace Pulumi.AzureRM.Web.V20181101
{
    ...
    public partial class WebAppSiteExtensionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSiteExtensionSlot(string name, WebAppSiteExtensionSlotArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/v20181101:WebAppSiteExtensionSlot", name, args ?? new WebAppSiteExtensionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteExtensionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/v20181101:WebAppSiteExtensionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:web/v20160801:WebAppSiteExtensionSlot"},
                    new Alias { Type = "azurerm:web/v20180201:WebAppSiteExtensionSlot"},
                    new Alias { Type = "azurerm:web/v20190801:WebAppSiteExtensionSlot"},
                    new Alias { Type = "azurerm:web/v20200601:WebAppSiteExtensionSlot"},
                },
            };
