...
namespace Pulumi.AzureNative.Web.V20181101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20181101:WebAppSiteExtensionSlot")]
    public partial class WebAppSiteExtensionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSiteExtensionSlot(string name, WebAppSiteExtensionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppSiteExtensionSlot", name, args ?? new WebAppSiteExtensionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteExtensionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppSiteExtensionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
