...
namespace Pulumi.AzureNative.Web.V20181101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20181101:WebAppSiteExtension")]
    public partial class WebAppSiteExtension : Pulumi.CustomResource
    {
        ...
        public WebAppSiteExtension(string name, WebAppSiteExtensionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppSiteExtension", name, args ?? new WebAppSiteExtensionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSiteExtension(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppSiteExtension", name, null, MakeResourceOptions(options, id))
        {
        }
