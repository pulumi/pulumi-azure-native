...
namespace Pulumi.AzureNextGen.Web.V20181101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20181101:WebAppHybridConnection")]
    public partial class WebAppHybridConnection : Pulumi.CustomResource
    {
        ...
        public WebAppHybridConnection(string name, WebAppHybridConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppHybridConnection", name, args ?? new WebAppHybridConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHybridConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppHybridConnection", name, null, MakeResourceOptions(options, id))
        {
        }
