...
namespace Pulumi.AzureRM.Web.V20181101
{
    ...
    public partial class WebAppPremierAddOn : Pulumi.CustomResource
    {
        ...
        public WebAppPremierAddOn(string name, WebAppPremierAddOnArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/v20181101:WebAppPremierAddOn", name, args ?? new WebAppPremierAddOnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPremierAddOn(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/v20181101:WebAppPremierAddOn", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:web/v20150801:WebAppPremierAddOn"},
                    new Alias { Type = "azurerm:web/v20160801:WebAppPremierAddOn"},
                    new Alias { Type = "azurerm:web/v20180201:WebAppPremierAddOn"},
