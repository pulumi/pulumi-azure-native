...
namespace Pulumi.AzureNative.Web.V20181101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20181101:WebAppRelayServiceConnectionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppRelayServiceConnectionSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20181101:WebAppRelayServiceConnectionSlot")]
    public partial class WebAppRelayServiceConnectionSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppRelayServiceConnectionSlot(string name, WebAppRelayServiceConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppRelayServiceConnectionSlot", name, args ?? new WebAppRelayServiceConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppRelayServiceConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppRelayServiceConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
