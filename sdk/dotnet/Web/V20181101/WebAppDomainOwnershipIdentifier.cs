...
namespace Pulumi.AzureNative.Web.V20181101
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:web/v20181101:WebAppDomainOwnershipIdentifier myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/domainOwnershipIdentifiers/{domainOwnershipIdentifierName} 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20181101:WebAppDomainOwnershipIdentifier")]
    public partial class WebAppDomainOwnershipIdentifier : global::Pulumi.CustomResource
    {
        ...
        public WebAppDomainOwnershipIdentifier(string name, WebAppDomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppDomainOwnershipIdentifier", name, args ?? new WebAppDomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppDomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
