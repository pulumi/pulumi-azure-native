...
namespace Pulumi.AzureNative.Web.V20181101
{
    public static class GetWebAppConfiguration
    {
        ...
        public static Task<GetWebAppConfigurationResult> InvokeAsync(GetWebAppConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppConfigurationResult>("azure-native:web/v20181101:getWebAppConfiguration", args ?? new GetWebAppConfigurationArgs(), options.WithVersion());
    }
