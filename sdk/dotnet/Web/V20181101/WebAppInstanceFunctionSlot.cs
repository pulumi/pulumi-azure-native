...
namespace Pulumi.AzureNextGen.Web.V20181101
{
    ...
    /// Web Job Information.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20181101:WebAppInstanceFunctionSlot")]
    public partial class WebAppInstanceFunctionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppInstanceFunctionSlot(string name, WebAppInstanceFunctionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppInstanceFunctionSlot", name, args ?? new WebAppInstanceFunctionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppInstanceFunctionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppInstanceFunctionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
