...
namespace Pulumi.AzureNextGen.Web.V20181101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20181101:WebAppApplicationSettingsSlot")]
    public partial class WebAppApplicationSettingsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppApplicationSettingsSlot(string name, WebAppApplicationSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppApplicationSettingsSlot", name, args ?? new WebAppApplicationSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppApplicationSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppApplicationSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
