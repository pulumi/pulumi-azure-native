...
namespace Pulumi.AzureNextGen.Web.V20181101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20181101:WebAppApplicationSettings")]
    public partial class WebAppApplicationSettings : Pulumi.CustomResource
    {
        ...
        public WebAppApplicationSettings(string name, WebAppApplicationSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppApplicationSettings", name, args ?? new WebAppApplicationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppApplicationSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20181101:WebAppApplicationSettings", name, null, MakeResourceOptions(options, id))
        {
        }
