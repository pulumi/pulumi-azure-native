...
namespace Pulumi.AzureNative.Web.V20181101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20181101:WebAppConfiguration")]
    public partial class WebAppConfiguration : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("azureStorageAccounts")]
        public Output<ImmutableDictionary<string, Outputs.AzureStorageInfoValueResponse>?> AzureStorageAccounts { get; private set; } = null!;
        ...
        public Output<int?> ReservedInstanceCount { get; private set; } = null!;
        ...
        public WebAppConfiguration(string name, WebAppConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppConfiguration", name, args ?? new WebAppConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20181101:WebAppConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
