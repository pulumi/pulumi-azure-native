...
namespace Pulumi.AzureRM.Web.V20181101
{
    public static class ListWebAppMetadata
    {
        public static Task<ListWebAppMetadataResult> InvokeAsync(ListWebAppMetadataArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebAppMetadataResult>("azurerm:web/v20181101:listWebAppMetadata", args ?? new ListWebAppMetadataArgs(), options.WithVersion());
    }
