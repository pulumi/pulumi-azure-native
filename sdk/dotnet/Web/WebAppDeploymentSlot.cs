...
namespace Pulumi.AzureNextGen.Web
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web:WebAppDeploymentSlot")]
    public partial class WebAppDeploymentSlot : Pulumi.CustomResource
    {
        ...
        public WebAppDeploymentSlot(string name, WebAppDeploymentSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:WebAppDeploymentSlot", name, args ?? new WebAppDeploymentSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDeploymentSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:WebAppDeploymentSlot", name, null, MakeResourceOptions(options, id))
        {
        }
