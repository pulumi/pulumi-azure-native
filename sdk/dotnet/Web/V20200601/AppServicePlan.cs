...
namespace Pulumi.AzureRM.Web.V20200601
{
    ...
    ///     public MyStack()
    ///     {
    ///         var appServicePlan = new AzureRM.Web.V20200601.AppServicePlan("appServicePlan", new AzureRM.Web.V20200601.AppServicePlanArgs
    ///         {
    ///             Kind = "app",
    ///             Location = "East US",
    ///             Name = "testsf6141",
    ...
    public partial class AppServicePlan : Pulumi.CustomResource
    {
        ...
        public AppServicePlan(string name, AppServicePlanArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/v20200601:AppServicePlan", name, args ?? new AppServicePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServicePlan(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/v20200601:AppServicePlan", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:web/latest:AppServicePlan"},
