...
namespace Pulumi.AzureNextGen.Web.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200601:WebAppAuthSettingsSlot")]
    public partial class WebAppAuthSettingsSlot : Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettingsSlot(string name, WebAppAuthSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebAppAuthSettingsSlot", name, args ?? new WebAppAuthSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebAppAuthSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
