...
namespace Pulumi.AzureNative.Web.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20200601:WebAppVnetConnectionSlot")]
    public partial class WebAppVnetConnectionSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppVnetConnectionSlot(string name, WebAppVnetConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppVnetConnectionSlot", name, args ?? new WebAppVnetConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppVnetConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppVnetConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
