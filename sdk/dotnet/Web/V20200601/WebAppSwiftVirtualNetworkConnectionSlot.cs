...
namespace Pulumi.AzureNative.Web.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20200601:WebAppSwiftVirtualNetworkConnectionSlot")]
    public partial class WebAppSwiftVirtualNetworkConnectionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppSwiftVirtualNetworkConnectionSlot(string name, WebAppSwiftVirtualNetworkConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppSwiftVirtualNetworkConnectionSlot", name, args ?? new WebAppSwiftVirtualNetworkConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSwiftVirtualNetworkConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppSwiftVirtualNetworkConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
