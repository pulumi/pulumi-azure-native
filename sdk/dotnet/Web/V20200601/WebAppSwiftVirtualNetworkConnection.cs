...
namespace Pulumi.AzureNextGen.Web.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200601:WebAppSwiftVirtualNetworkConnection")]
    public partial class WebAppSwiftVirtualNetworkConnection : Pulumi.CustomResource
    {
        ...
        public WebAppSwiftVirtualNetworkConnection(string name, WebAppSwiftVirtualNetworkConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebAppSwiftVirtualNetworkConnection", name, args ?? new WebAppSwiftVirtualNetworkConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSwiftVirtualNetworkConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebAppSwiftVirtualNetworkConnection", name, null, MakeResourceOptions(options, id))
        {
        }
