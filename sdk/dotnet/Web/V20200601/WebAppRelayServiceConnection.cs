...
namespace Pulumi.AzureNextGen.Web.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200601:WebAppRelayServiceConnection")]
    public partial class WebAppRelayServiceConnection : Pulumi.CustomResource
    {
        ...
        public WebAppRelayServiceConnection(string name, WebAppRelayServiceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebAppRelayServiceConnection", name, args ?? new WebAppRelayServiceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppRelayServiceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebAppRelayServiceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
