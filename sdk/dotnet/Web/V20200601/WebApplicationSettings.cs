...
namespace Pulumi.AzureNextGen.Web.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200601:WebApplicationSettings")]
    public partial class WebApplicationSettings : Pulumi.CustomResource
    {
        ...
        public WebApplicationSettings(string name, WebApplicationSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebApplicationSettings", name, args ?? new WebApplicationSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApplicationSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebApplicationSettings", name, null, MakeResourceOptions(options, id))
        {
        }
