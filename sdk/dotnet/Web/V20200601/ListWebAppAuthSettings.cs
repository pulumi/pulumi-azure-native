...
namespace Pulumi.AzureRM.Web.V20200601
{
    public static class ListWebAppAuthSettings
    {
        public static Task<ListWebAppAuthSettingsResult> InvokeAsync(ListWebAppAuthSettingsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebAppAuthSettingsResult>("azurerm:web/v20200601:listWebAppAuthSettings", args ?? new ListWebAppAuthSettingsArgs(), options.WithVersion());
    }
