...
namespace Pulumi.AzureNative.Web.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20200601:WebAppRelayServiceConnectionSlot")]
    public partial class WebAppRelayServiceConnectionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppRelayServiceConnectionSlot(string name, WebAppRelayServiceConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppRelayServiceConnectionSlot", name, args ?? new WebAppRelayServiceConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppRelayServiceConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppRelayServiceConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
