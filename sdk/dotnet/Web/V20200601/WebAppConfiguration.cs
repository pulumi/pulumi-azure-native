...
namespace Pulumi.AzureNative.Web.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20200601:WebAppConfiguration")]
    public partial class WebAppConfiguration : Pulumi.CustomResource
    {
        ...
        public WebAppConfiguration(string name, WebAppConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppConfiguration", name, args ?? new WebAppConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:web/v20201001:WebAppConfiguration"},
    ...
    public sealed class WebAppConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ftpsState")]
        public InputUnion<string, Pulumi.AzureNative.Web.V20200601.FtpsState>? FtpsState { get; set; }
        ...
        /// </summary>
        [Input("loadBalancing")]
        public Input<Pulumi.AzureNative.Web.V20200601.SiteLoadBalancing>? LoadBalancing { get; set; }
        ...
        public Input<Pulumi.AzureNative.Web.V20200601.ManagedPipelineMode>? ManagedPipelineMode { get; set; }
        ...
        /// </summary>
        [Input("minTlsVersion")]
        public InputUnion<string, Pulumi.AzureNative.Web.V20200601.SupportedTlsVersions>? MinTlsVersion { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.Web.V20200601.SupportedTlsVersions>? ScmMinTlsVersion { get; set; }

        /// <summary>
        /// SCM type.
        /// </summary>
        [Input("scmType")]
        public InputUnion<string, Pulumi.AzureNative.Web.V20200601.ScmType>? ScmType { get; set; }
