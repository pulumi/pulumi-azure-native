...
namespace Pulumi.AzureNative.Web.V20200601
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20200601:WebAppConnectionStrings is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppConnectionStrings to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20200601:WebAppConnectionStrings")]
    public partial class WebAppConnectionStrings : global::Pulumi.CustomResource
    {
        ...
        public WebAppConnectionStrings(string name, WebAppConnectionStringsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppConnectionStrings", name, args ?? new WebAppConnectionStringsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppConnectionStrings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppConnectionStrings", name, null, MakeResourceOptions(options, id))
        {
        }
