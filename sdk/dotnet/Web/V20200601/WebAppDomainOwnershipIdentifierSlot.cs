...
namespace Pulumi.AzureNative.Web.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20200601:WebAppDomainOwnershipIdentifierSlot")]
    public partial class WebAppDomainOwnershipIdentifierSlot : Pulumi.CustomResource
    {
        ...
        public WebAppDomainOwnershipIdentifierSlot(string name, WebAppDomainOwnershipIdentifierSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppDomainOwnershipIdentifierSlot", name, args ?? new WebAppDomainOwnershipIdentifierSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDomainOwnershipIdentifierSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20200601:WebAppDomainOwnershipIdentifierSlot", name, null, MakeResourceOptions(options, id))
        {
        }
