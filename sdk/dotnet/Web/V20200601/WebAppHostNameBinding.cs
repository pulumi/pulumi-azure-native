...
namespace Pulumi.AzureNextGen.Web.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20200601:WebAppHostNameBinding")]
    public partial class WebAppHostNameBinding : Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBinding(string name, WebAppHostNameBindingArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebAppHostNameBinding", name, args ?? new WebAppHostNameBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBinding(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20200601:WebAppHostNameBinding", name, null, MakeResourceOptions(options, id))
        {
        }
