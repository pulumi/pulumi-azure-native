...
namespace Pulumi.AzureRM.Web.V20160901
{
    public static class GetAppServicePlan
    {
        public static Task<GetAppServicePlanResult> InvokeAsync(GetAppServicePlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAppServicePlanResult>("azurerm:web/v20160901:getAppServicePlan", args ?? new GetAppServicePlanArgs(), options.WithVersion());
    }
