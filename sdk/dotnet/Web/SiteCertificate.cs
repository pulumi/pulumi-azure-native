...
namespace Pulumi.AzureNative.Web
{
    ...
    public partial class SiteCertificate : global::Pulumi.CustomResource
    {
        ...
        public SiteCertificate(string name, SiteCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web:SiteCertificate", name, args ?? new SiteCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SiteCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web:SiteCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:web/v20241101:SiteCertificate" },
                    new global::Pulumi.Alias { Type = "azure-native:web/v20250301:SiteCertificate" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SiteCertificate Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SiteCertificate(name, id, options);
        }
    }

    public sealed class SiteCertificateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// CNAME of the certificate to be issued via free certificate
        /// </summary>
        ...
        public SiteCertificateArgs()
        {
        }
        public static new SiteCertificateArgs Empty => new SiteCertificateArgs();
    }
}
