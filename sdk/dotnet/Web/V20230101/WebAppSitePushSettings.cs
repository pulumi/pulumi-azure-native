...
namespace Pulumi.AzureNative.Web.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20230101:WebAppSitePushSettings")]
    public partial class WebAppSitePushSettings : global::Pulumi.CustomResource
    {
        ...
        public WebAppSitePushSettings(string name, WebAppSitePushSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:WebAppSitePushSettings", name, args ?? new WebAppSitePushSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSitePushSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:WebAppSitePushSettings", name, null, MakeResourceOptions(options, id))
        {
        }
