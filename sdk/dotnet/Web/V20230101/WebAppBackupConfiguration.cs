...
namespace Pulumi.AzureNative.Web.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20230101:WebAppBackupConfiguration")]
    public partial class WebAppBackupConfiguration : global::Pulumi.CustomResource
    {
        ...
        public WebAppBackupConfiguration(string name, WebAppBackupConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:WebAppBackupConfiguration", name, args ?? new WebAppBackupConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppBackupConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:WebAppBackupConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
