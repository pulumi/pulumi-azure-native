...
namespace Pulumi.AzureNative.Web.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20230101:WebAppApplicationSettingsSlot")]
    public partial class WebAppApplicationSettingsSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppApplicationSettingsSlot(string name, WebAppApplicationSettingsSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:WebAppApplicationSettingsSlot", name, args ?? new WebAppApplicationSettingsSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppApplicationSettingsSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:WebAppApplicationSettingsSlot", name, null, MakeResourceOptions(options, id))
        {
        }
