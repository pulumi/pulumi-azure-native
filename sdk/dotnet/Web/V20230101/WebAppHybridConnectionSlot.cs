...
namespace Pulumi.AzureNative.Web.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20230101:WebAppHybridConnectionSlot")]
    public partial class WebAppHybridConnectionSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppHybridConnectionSlot(string name, WebAppHybridConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:WebAppHybridConnectionSlot", name, args ?? new WebAppHybridConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHybridConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:WebAppHybridConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
