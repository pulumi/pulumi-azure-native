...
namespace Pulumi.AzureNative.Web.V20230101
{
    public static class GetWebAppSlot
    {
        ...
        public static Task<GetWebAppSlotResult> InvokeAsync(GetWebAppSlotArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWebAppSlotResult>("azure-native:web/v20230101:getWebAppSlot", args ?? new GetWebAppSlotArgs(), options.WithDefaults());

        /// <summary>
        /// Description for Gets the details of a web, mobile, or API app.
        /// </summary>
        public static Output<GetWebAppSlotResult> Invoke(GetWebAppSlotInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWebAppSlotResult>("azure-native:web/v20230101:getWebAppSlot", args ?? new GetWebAppSlotInvokeArgs(), options.WithDefaults());
