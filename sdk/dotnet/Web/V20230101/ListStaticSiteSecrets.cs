...
namespace Pulumi.AzureNative.Web.V20230101
{
    public static class ListStaticSiteSecrets
    {
        ...
        public static Task<ListStaticSiteSecretsResult> InvokeAsync(ListStaticSiteSecretsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListStaticSiteSecretsResult>("azure-native:web/v20230101:listStaticSiteSecrets", args ?? new ListStaticSiteSecretsArgs(), options.WithDefaults());

        /// <summary>
        /// Description for Lists the secrets for an existing static site.
        /// </summary>
        public static Output<ListStaticSiteSecretsResult> Invoke(ListStaticSiteSecretsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListStaticSiteSecretsResult>("azure-native:web/v20230101:listStaticSiteSecrets", args ?? new ListStaticSiteSecretsInvokeArgs(), options.WithDefaults());
    }
