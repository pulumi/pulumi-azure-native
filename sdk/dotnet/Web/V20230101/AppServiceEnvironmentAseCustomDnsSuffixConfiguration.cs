...
namespace Pulumi.AzureNative.Web.V20230101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20230101:AppServiceEnvironmentAseCustomDnsSuffixConfiguration")]
    public partial class AppServiceEnvironmentAseCustomDnsSuffixConfiguration : global::Pulumi.CustomResource
    {
        ...
        public AppServiceEnvironmentAseCustomDnsSuffixConfiguration(string name, AppServiceEnvironmentAseCustomDnsSuffixConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, args ?? new AppServiceEnvironmentAseCustomDnsSuffixConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AppServiceEnvironmentAseCustomDnsSuffixConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20230101:AppServiceEnvironmentAseCustomDnsSuffixConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
