...
namespace Pulumi.AzureNative.Web.V20160801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20160801:WebAppHybridConnection")]
    public partial class WebAppHybridConnection : global::Pulumi.CustomResource
    {
        ...
        public WebAppHybridConnection(string name, WebAppHybridConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppHybridConnection", name, args ?? new WebAppHybridConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHybridConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppHybridConnection", name, null, MakeResourceOptions(options, id))
        {
        }
