...
namespace Pulumi.AzureNextGen.Web.V20160801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20160801:WebAppHostNameBindingSlot")]
    public partial class WebAppHostNameBindingSlot : Pulumi.CustomResource
    {
        ...
        public WebAppHostNameBindingSlot(string name, WebAppHostNameBindingSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppHostNameBindingSlot", name, args ?? new WebAppHostNameBindingSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHostNameBindingSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppHostNameBindingSlot", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebAppHostNameBindingSlotArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.Web.V20160801.AzureResourceType>? AzureResourceType { get; set; }

        /// <summary>
        /// Custom DNS record type.
        /// </summary>
        [Input("customHostNameDnsRecordType")]
        public Input<Pulumi.AzureNextGen.Web.V20160801.CustomHostNameDnsRecordType>? CustomHostNameDnsRecordType { get; set; }
        ...
        /// </summary>
        [Input("hostNameType")]
        public Input<Pulumi.AzureNextGen.Web.V20160801.HostNameType>? HostNameType { get; set; }
        ...
        /// </summary>
        [Input("sslState")]
        public Input<Pulumi.AzureNextGen.Web.V20160801.SslState>? SslState { get; set; }
