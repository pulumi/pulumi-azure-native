...
namespace Pulumi.AzureRM.Web.V20160801
{
    ...
    public partial class WebAppSiteExtension : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("installationArgs")]
        public Output<string?> InstallationArgs { get; private set; } = null!;
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:web/v20180201:WebAppSiteExtension"},
                    new Alias { Type = "azurerm:web/v20181101:WebAppSiteExtension"},
                    new Alias { Type = "azurerm:web/v20190801:WebAppSiteExtension"},
                    new Alias { Type = "azurerm:web/v20200601:WebAppSiteExtension"},
                },
            };
