...
namespace Pulumi.AzureNative.Web.V20160801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20160801:WebAppHybridConnectionSlot")]
    public partial class WebAppHybridConnectionSlot : Pulumi.CustomResource
    {
        ...
        public WebAppHybridConnectionSlot(string name, WebAppHybridConnectionSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppHybridConnectionSlot", name, args ?? new WebAppHybridConnectionSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppHybridConnectionSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppHybridConnectionSlot", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppHybridConnectionSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:WebAppHybridConnectionSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppHybridConnectionSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppHybridConnectionSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppHybridConnectionSlot"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppHybridConnectionSlot"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppHybridConnectionSlot"},
                },
            };
