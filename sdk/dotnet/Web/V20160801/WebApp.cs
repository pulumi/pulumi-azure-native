...
namespace Pulumi.AzureRM.Web.V20160801
{
    ...
    public partial class WebApp : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("snapshotInfo")]
        public Output<Outputs.SnapshotRecoveryRequestResponseResult?> SnapshotInfo { get; private set; } = null!;
        ...
        public WebApp(string name, WebAppArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/v20160801:WebApp", name, args ?? new WebAppArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebApp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/v20160801:WebApp", name, null, MakeResourceOptions(options, id))
        {
        }
