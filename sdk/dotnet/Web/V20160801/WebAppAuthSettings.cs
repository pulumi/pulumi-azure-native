...
namespace Pulumi.AzureNextGen.Web.V20160801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20160801:WebAppAuthSettings")]
    public partial class WebAppAuthSettings : Pulumi.CustomResource
    {
        ...
        public WebAppAuthSettings(string name, WebAppAuthSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppAuthSettings", name, args ?? new WebAppAuthSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppAuthSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppAuthSettings", name, null, MakeResourceOptions(options, id))
        {
        }
