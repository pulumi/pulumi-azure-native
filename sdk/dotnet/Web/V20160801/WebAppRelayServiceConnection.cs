...
namespace Pulumi.AzureNextGen.Web.V20160801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20160801:WebAppRelayServiceConnection")]
    public partial class WebAppRelayServiceConnection : Pulumi.CustomResource
    {
        ...
        public WebAppRelayServiceConnection(string name, WebAppRelayServiceConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppRelayServiceConnection", name, args ?? new WebAppRelayServiceConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppRelayServiceConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppRelayServiceConnection", name, null, MakeResourceOptions(options, id))
        {
        }
