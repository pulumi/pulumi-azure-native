...
namespace Pulumi.AzureNative.Web.V20160801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20160801:WebAppDomainOwnershipIdentifier")]
    public partial class WebAppDomainOwnershipIdentifier : Pulumi.CustomResource
    {
        ...
        public WebAppDomainOwnershipIdentifier(string name, WebAppDomainOwnershipIdentifierArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppDomainOwnershipIdentifier", name, args ?? new WebAppDomainOwnershipIdentifierArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppDomainOwnershipIdentifier(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppDomainOwnershipIdentifier", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20201201:WebAppDomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210101:WebAppDomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210101:WebAppDomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210115:WebAppDomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210115:WebAppDomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-native:web/v20210201:WebAppDomainOwnershipIdentifier"},
                    new Pulumi.Alias { Type = "azure-nextgen:web/v20210201:WebAppDomainOwnershipIdentifier"},
                },
            };
