...
namespace Pulumi.AzureNextGen.Web.V20160801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20160801:WebAppMetadata")]
    public partial class WebAppMetadata : Pulumi.CustomResource
    {
        ...
        public WebAppMetadata(string name, WebAppMetadataArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppMetadata", name, args ?? new WebAppMetadataArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppMetadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppMetadata", name, null, MakeResourceOptions(options, id))
        {
        }
