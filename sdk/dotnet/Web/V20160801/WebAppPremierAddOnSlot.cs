...
namespace Pulumi.AzureNextGen.Web.V20160801
{
    ...
    /// Premier add-on.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web/v20160801:WebAppPremierAddOnSlot")]
    public partial class WebAppPremierAddOnSlot : Pulumi.CustomResource
    {
        ...
        public WebAppPremierAddOnSlot(string name, WebAppPremierAddOnSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppPremierAddOnSlot", name, args ?? new WebAppPremierAddOnSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppPremierAddOnSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web/v20160801:WebAppPremierAddOnSlot", name, null, MakeResourceOptions(options, id))
        {
        }
