...
namespace Pulumi.AzureNative.Web.V20160801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20160801:WebAppSourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppSourceControl to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20160801:WebAppSourceControl")]
    public partial class WebAppSourceControl : global::Pulumi.CustomResource
    {
        ...
        public WebAppSourceControl(string name, WebAppSourceControlArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppSourceControl", name, args ?? new WebAppSourceControlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSourceControl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppSourceControl", name, null, MakeResourceOptions(options, id))
        {
        }
