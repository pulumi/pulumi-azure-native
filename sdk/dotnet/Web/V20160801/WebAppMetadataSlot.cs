...
namespace Pulumi.AzureNative.Web.V20160801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:web/v20160801:WebAppMetadataSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppMetadataSlot to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:web/v20160801:WebAppMetadataSlot")]
    public partial class WebAppMetadataSlot : global::Pulumi.CustomResource
    {
        ...
        public WebAppMetadataSlot(string name, WebAppMetadataSlotArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppMetadataSlot", name, args ?? new WebAppMetadataSlotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppMetadataSlot(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160801:WebAppMetadataSlot", name, null, MakeResourceOptions(options, id))
        {
        }
