...
namespace Pulumi.AzureRM.Web
{
    ...
    public partial class AppServiceSlotFunction : Pulumi.CustomResource
    {
        ...
        private AppServiceSlotFunction(string name, Input<string> id, AppServiceSlotFunctionState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:web:AppServiceSlotFunction", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AppServiceSlotFunction Get(string name, Input<string> id, AppServiceSlotFunctionState? state = null, CustomResourceOptions? options = null)
        {
            return new AppServiceSlotFunction(name, id, state, options);
        }
    }
    ...
    public sealed class AppServiceSlotFunctionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Kind of resource.
        /// </summary>
        ...
        public AppServiceSlotFunctionState()
        {
        }
    }
}
