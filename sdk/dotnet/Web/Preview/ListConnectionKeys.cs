...
namespace Pulumi.AzureRM.Web.Preview
{
    public static class ListConnectionKeys
    {
        public static Task<ListConnectionKeysResult> InvokeAsync(ListConnectionKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListConnectionKeysResult>("azurerm:web/preview:listConnectionKeys", args ?? new ListConnectionKeysArgs(), options.WithVersion());
    }
