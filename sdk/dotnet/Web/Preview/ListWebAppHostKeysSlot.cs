...
namespace Pulumi.AzureRM.Web.Preview
{
    public static class ListWebAppHostKeysSlot
    {
        public static Task<ListWebAppHostKeysSlotResult> InvokeAsync(ListWebAppHostKeysSlotArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebAppHostKeysSlotResult>("azurerm:web/preview:listWebAppHostKeysSlot", args ?? new ListWebAppHostKeysSlotArgs(), options.WithVersion());
    }
