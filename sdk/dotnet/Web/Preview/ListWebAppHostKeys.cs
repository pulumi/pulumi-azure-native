...
namespace Pulumi.AzureRM.Web.Preview
{
    public static class ListWebAppHostKeys
    {
        public static Task<ListWebAppHostKeysResult> InvokeAsync(ListWebAppHostKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebAppHostKeysResult>("azurerm:web/preview:listWebAppHostKeys", args ?? new ListWebAppHostKeysArgs(), options.WithVersion());
    }
