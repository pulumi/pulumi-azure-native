...
namespace Pulumi.AzureRM.Web.Preview
{
    public static class GetManagedHostingEnvironment
    {
        public static Task<GetManagedHostingEnvironmentResult> InvokeAsync(GetManagedHostingEnvironmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedHostingEnvironmentResult>("azurerm:web/preview:getManagedHostingEnvironment", args ?? new GetManagedHostingEnvironmentArgs(), options.WithVersion());
    }
