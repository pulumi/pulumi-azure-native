...
namespace Pulumi.AzureRM.Web.Preview
{
    public static class GetSiteInstanceDeployment
    {
        public static Task<GetSiteInstanceDeploymentResult> InvokeAsync(GetSiteInstanceDeploymentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSiteInstanceDeploymentResult>("azurerm:web/preview:getSiteInstanceDeployment", args ?? new GetSiteInstanceDeploymentArgs(), options.WithVersion());
    }
