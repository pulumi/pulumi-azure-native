...
namespace Pulumi.AzureRM.Web.Preview
{
    public static class GetCertificateCsr
    {
        public static Task<GetCertificateCsrResult> InvokeAsync(GetCertificateCsrArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCertificateCsrResult>("azurerm:web/preview:getCertificateCsr", args ?? new GetCertificateCsrArgs(), options.WithVersion());
    }
