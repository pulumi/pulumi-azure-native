...
namespace Pulumi.AzureRM.Web.Preview
{
    public static class ListConnectionConsentLinks
    {
        public static Task<ListConnectionConsentLinksResult> InvokeAsync(ListConnectionConsentLinksArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListConnectionConsentLinksResult>("azurerm:web/preview:listConnectionConsentLinks", args ?? new ListConnectionConsentLinksArgs(), options.WithVersion());
    }
