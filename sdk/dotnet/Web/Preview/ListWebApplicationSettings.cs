...
namespace Pulumi.AzureRM.Web.Preview
{
    public static class ListWebApplicationSettings
    {
        public static Task<ListWebApplicationSettingsResult> InvokeAsync(ListWebApplicationSettingsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebApplicationSettingsResult>("azurerm:web/preview:listWebApplicationSettings", args ?? new ListWebApplicationSettingsArgs(), options.WithVersion());
    }
