...
namespace Pulumi.AzureRM.Web.Preview
{
    public static class GetWebAppFunction
    {
        public static Task<GetWebAppFunctionResult> InvokeAsync(GetWebAppFunctionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebAppFunctionResult>("azurerm:web/preview:getWebAppFunction", args ?? new GetWebAppFunctionArgs(), options.WithVersion());
    }
