...
namespace Pulumi.AzureNextGen.Web
{
    public static class ListWebAppHostKeys
    {
        public static Task<ListWebAppHostKeysResult> InvokeAsync(ListWebAppHostKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListWebAppHostKeysResult>("azure-nextgen:web:listWebAppHostKeys", args ?? new ListWebAppHostKeysArgs(), options.WithVersion());
    }
