...
namespace Pulumi.AzureNextGen.Web
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:web:WebAppSitePushSettings")]
    public partial class WebAppSitePushSettings : Pulumi.CustomResource
    {
        ...
        public WebAppSitePushSettings(string name, WebAppSitePushSettingsArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:WebAppSitePushSettings", name, args ?? new WebAppSitePushSettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebAppSitePushSettings(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:web:WebAppSitePushSettings", name, null, MakeResourceOptions(options, id))
        {
        }
