...
namespace Pulumi.AzureNative.Web.V20160301
{
    ...
    /// {
    ///     var certificate = new AzureNative.Web.V20160301.Certificate("certificate", new()
    ///     {
    ///         HostNames = new[]
    ///         {
    ///             "ServerCert",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:web/v20160301:Certificate")]
    public partial class Certificate : global::Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160301:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:web/v20160301:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
