...
namespace Pulumi.AzureRM.Web.V20160301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var certificate = new AzureRM.Web.V20160301.Certificate("certificate", new AzureRM.Web.V20160301.CertificateArgs
    ///         {
    ///             HostNames = 
    ///             {
    ///                 "ServerCert",
    ...
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:web/v20160301:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:web/v20160301:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
