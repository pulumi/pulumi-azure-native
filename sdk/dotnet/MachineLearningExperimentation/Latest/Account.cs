...
namespace Pulumi.AzureRM.MachineLearningExperimentation.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var account = new AzureRM.MachineLearningExperimentation.Latest.Account("account", new AzureRM.MachineLearningExperimentation.Latest.AccountArgs
    ///         {
    ...
    ///             StorageAccount = new AzureRM.MachineLearningExperimentation.Latest.Inputs.StorageAccountPropertiesArgs
    ///             {
    ///                 AccessKey = "key",
    ...
    public partial class Account : Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningexperimentation/latest:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningexperimentation/latest:Account", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:machinelearningexperimentation/v20170501preview:Account"},
                },
            };
