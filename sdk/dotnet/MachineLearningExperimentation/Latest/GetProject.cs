...
namespace Pulumi.AzureRM.MachineLearningExperimentation.Latest
{
    public static class GetProject
    {
        public static Task<GetProjectResult> InvokeAsync(GetProjectArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProjectResult>("azurerm:machinelearningexperimentation/latest:getProject", args ?? new GetProjectArgs(), options.WithVersion());
    }
