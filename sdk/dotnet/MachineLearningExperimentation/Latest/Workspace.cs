...
namespace Pulumi.AzureRM.MachineLearningExperimentation.Latest
{
    /// <summary>
    ...
    ///     public MyStack()
    ///     {
    ///         var workspace = new AzureRM.MachineLearningExperimentation.Latest.Workspace("workspace", new AzureRM.MachineLearningExperimentation.Latest.WorkspaceArgs
    ///         {
    ...
    public partial class Workspace : Pulumi.CustomResource
    {
        ...
        public Workspace(string name, WorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningexperimentation/latest:Workspace", name, args ?? new WorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Workspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningexperimentation/latest:Workspace", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:machinelearningexperimentation/v20170501preview:Workspace"},
                },
            };
