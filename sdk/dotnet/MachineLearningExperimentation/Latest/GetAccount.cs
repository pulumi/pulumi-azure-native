...
namespace Pulumi.AzureRM.MachineLearningExperimentation.Latest
{
    public static class GetAccount
    {
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azurerm:machinelearningexperimentation/latest:getAccount", args ?? new GetAccountArgs(), options.WithVersion());
    }
