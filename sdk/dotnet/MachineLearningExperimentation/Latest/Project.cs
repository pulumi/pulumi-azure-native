...
namespace Pulumi.AzureRM.MachineLearningExperimentation.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var project = new AzureRM.MachineLearningExperimentation.Latest.Project("project", new AzureRM.MachineLearningExperimentation.Latest.ProjectArgs
    ///         {
    ...
    public partial class Project : Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningexperimentation/latest:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:machinelearningexperimentation/latest:Project", name, null, MakeResourceOptions(options, id))
        {
        }
