...
namespace Pulumi.AzureRM.MachineLearningExperimentation.Preview
{
    public static class GetAccount
    {
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azurerm:machinelearningexperimentation/preview:getAccount", args ?? new GetAccountArgs(), options.WithVersion());
    }
