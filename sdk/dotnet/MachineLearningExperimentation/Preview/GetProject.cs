...
namespace Pulumi.AzureRM.MachineLearningExperimentation.Preview
{
    public static class GetProject
    {
        public static Task<GetProjectResult> InvokeAsync(GetProjectArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProjectResult>("azurerm:machinelearningexperimentation/preview:getProject", args ?? new GetProjectArgs(), options.WithVersion());
    }
