...
namespace Pulumi.AzureNative.DeviceProvisioningServices.V20230301Preview
{
    /// <summary>
    /// The private endpoint connection of a provisioning service
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceprovisioningservices/v20230301preview:IotDpsResourcePrivateEndpointConnection")]
    public partial class IotDpsResourcePrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public IotDpsResourcePrivateEndpointConnection(string name, IotDpsResourcePrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceprovisioningservices/v20230301preview:IotDpsResourcePrivateEndpointConnection", name, args ?? new IotDpsResourcePrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResourcePrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceprovisioningservices/v20230301preview:IotDpsResourcePrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:deviceprovisioningservices:IotDpsResourcePrivateEndpointConnection" },
