...
namespace Pulumi.AzureNative.DeviceProvisioningServices.V20250201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceprovisioningservices/v20250201preview:IotDpsResource")]
    public partial class IotDpsResource : global::Pulumi.CustomResource
    {
        ...
        public IotDpsResource(string name, IotDpsResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceprovisioningservices/v20250201preview:IotDpsResource", name, args ?? new IotDpsResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceprovisioningservices/v20250201preview:IotDpsResource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:deviceprovisioningservices:IotDpsResource" },
