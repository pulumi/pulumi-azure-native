...
namespace Pulumi.AzureNative.DeviceProvisioningServices.V20200901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:deviceprovisioningservices/v20200901preview:IotDpsResource")]
    public partial class IotDpsResource : global::Pulumi.CustomResource
    {
        ...
        public IotDpsResource(string name, IotDpsResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:deviceprovisioningservices/v20200901preview:IotDpsResource", name, args ?? new IotDpsResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IotDpsResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:deviceprovisioningservices/v20200901preview:IotDpsResource", name, null, MakeResourceOptions(options, id))
        {
        }
