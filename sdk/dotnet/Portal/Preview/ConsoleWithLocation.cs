...
namespace Pulumi.AzureRM.Portal.Preview
{
    /// <summary>
    /// Cloud shell console
    /// </summary>
    public partial class ConsoleWithLocation : Pulumi.CustomResource
    {
        ...
        public ConsoleWithLocation(string name, ConsoleWithLocationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:portal/preview:ConsoleWithLocation", name, args ?? new ConsoleWithLocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsoleWithLocation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:portal/preview:ConsoleWithLocation", name, null, MakeResourceOptions(options, id))
        {
        }
