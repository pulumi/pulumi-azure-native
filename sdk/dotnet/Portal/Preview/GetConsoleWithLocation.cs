...
namespace Pulumi.AzureRM.Portal.Preview
{
    public static class GetConsoleWithLocation
    {
        public static Task<GetConsoleWithLocationResult> InvokeAsync(GetConsoleWithLocationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConsoleWithLocationResult>("azurerm:portal/preview:getConsoleWithLocation", args ?? new GetConsoleWithLocationArgs(), options.WithVersion());
    }
