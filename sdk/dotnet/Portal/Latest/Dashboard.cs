...
namespace Pulumi.AzureRM.Portal.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dashboard = new AzureRM.Portal.Latest.Dashboard("dashboard", new AzureRM.Portal.Latest.DashboardArgs
    ///         {
    ...
    public partial class Dashboard : Pulumi.CustomResource
    {
        ...
        public Dashboard(string name, DashboardArgs args, CustomResourceOptions? options = null)
            : base("azurerm:portal/latest:Dashboard", name, args ?? new DashboardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dashboard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:portal/latest:Dashboard", name, null, MakeResourceOptions(options, id))
        {
        }
