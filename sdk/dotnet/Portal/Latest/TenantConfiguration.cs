...
namespace Pulumi.AzureRM.Portal.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tenantConfiguration = new AzureRM.Portal.Latest.TenantConfiguration("tenantConfiguration", new AzureRM.Portal.Latest.TenantConfigurationArgs
    ///         {
    ...
    public partial class TenantConfiguration : Pulumi.CustomResource
    {
        ...
        public TenantConfiguration(string name, TenantConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:portal/latest:TenantConfiguration", name, args ?? new TenantConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TenantConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:portal/latest:TenantConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:portal/v20190101preview:TenantConfiguration"},
