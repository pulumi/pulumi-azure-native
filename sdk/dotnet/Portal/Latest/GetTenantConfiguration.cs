...
namespace Pulumi.AzureRM.Portal.Latest
{
    public static class GetTenantConfiguration
    {
        public static Task<GetTenantConfigurationResult> InvokeAsync(GetTenantConfigurationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTenantConfigurationResult>("azurerm:portal/latest:getTenantConfiguration", args ?? new GetTenantConfigurationArgs(), options.WithVersion());
    }
