...
namespace Pulumi.AzureNextGen.Portal.V20150801Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:portal/v20150801preview:Dashboard")]
    public partial class Dashboard : Pulumi.CustomResource
    {
        ...
        public Dashboard(string name, DashboardArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:portal/v20150801preview:Dashboard", name, args ?? new DashboardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dashboard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:portal/v20150801preview:Dashboard", name, null, MakeResourceOptions(options, id))
        {
        }
