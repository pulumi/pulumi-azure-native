...
namespace Pulumi.AzureRM.Portal.V20150801Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dashboard = new AzureRM.Portal.V20150801Preview.Dashboard("dashboard", new AzureRM.Portal.V20150801Preview.DashboardArgs
    ///         {
    ///             DashboardName = "testDashboard",
    ///             Lenses = 
    ///             {
    ///                 { "aLens", new AzureRM.Portal.V20150801Preview.Inputs.DashboardLensArgs
    ///                 {
    ///                     Order = 1,
    ///                     Parts = 
    ///                     {
    ///                         { "aPart", new AzureRM.Portal.V20150801Preview.Inputs.DashboardPartsArgs
    ///                         {
    ///                             Position = new AzureRM.Portal.V20150801Preview.Inputs.DashboardPartsPositionArgs
    ///                             {
    ///                                 ColSpan = 3,
    ///                                 RowSpan = 4,
    ///                                 X = 1,
    ...
    ///                             },
    ///                         } },
    ///                         { "bPart", new AzureRM.Portal.V20150801Preview.Inputs.DashboardPartsArgs
    ///                         {
    ///                             Position = new AzureRM.Portal.V20150801Preview.Inputs.DashboardPartsPositionArgs
    ///                             {
    ///                                 ColSpan = 6,
    ...
    ///                     },
    ///                 } },
    ///                 { "bLens", new AzureRM.Portal.V20150801Preview.Inputs.DashboardLensArgs
    ///                 {
    ///                     Order = 2,
    ///                     Parts = ,
    ///                 } },
    ...
    public partial class Dashboard : Pulumi.CustomResource
    {
        ...
        public Dashboard(string name, DashboardArgs args, CustomResourceOptions? options = null)
            : base("azurerm:portal/v20150801preview:Dashboard", name, args ?? new DashboardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dashboard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:portal/v20150801preview:Dashboard", name, null, MakeResourceOptions(options, id))
        {
        }
