...
namespace Pulumi.AzureRM.Portal
{
    public static class GetConsoleWithLocation
    {
        public static Task<GetConsoleWithLocationResult> InvokeAsync(GetConsoleWithLocationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetConsoleWithLocationResult>("azurerm:portal:getConsoleWithLocation", args ?? new GetConsoleWithLocationArgs(), options.WithVersion());
    }
