...
namespace Pulumi.AzureRM.Portal
{
    public static class GetUserSettingsWithLocation
    {
        public static Task<GetUserSettingsWithLocationResult> InvokeAsync(GetUserSettingsWithLocationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetUserSettingsWithLocationResult>("azurerm:portal:getUserSettingsWithLocation", args ?? new GetUserSettingsWithLocationArgs(), options.WithVersion());
    }
    ...
    public sealed class GetUserSettingsWithLocationResult
    {
        ...
        [OutputConstructor]
        private GetUserSettingsWithLocationResult(Outputs.UserPropertiesResponseResult properties)
        {
