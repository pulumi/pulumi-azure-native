...
namespace Pulumi.AzureRM.Portal.V20200901Preview
{
    ...
    public partial class Dashboard : Pulumi.CustomResource
    {
        ...
        public Dashboard(string name, DashboardArgs args, CustomResourceOptions? options = null)
            : base("azurerm:portal/v20200901preview:Dashboard", name, args ?? new DashboardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dashboard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:portal/v20200901preview:Dashboard", name, null, MakeResourceOptions(options, id))
        {
        }
