...
namespace Pulumi.AzureNative.Portal.V20200901Preview
{
    public static class GetDashboard
    {
        ...
        public static Task<GetDashboardResult> InvokeAsync(GetDashboardArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDashboardResult>("azure-native:portal/v20200901preview:getDashboard", args ?? new GetDashboardArgs(), options.WithDefaults());

        /// <summary>
        /// The shared dashboard resource definition.
        /// </summary>
        public static Output<GetDashboardResult> Invoke(GetDashboardInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDashboardResult>("azure-native:portal/v20200901preview:getDashboard", args ?? new GetDashboardInvokeArgs(), options.WithDefaults());
    }
