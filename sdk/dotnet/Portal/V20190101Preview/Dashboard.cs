...
namespace Pulumi.AzureRM.Portal.V20190101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var dashboard = new AzureRM.Portal.V20190101Preview.Dashboard("dashboard", new AzureRM.Portal.V20190101Preview.DashboardArgs
    ///         {
    ///             DashboardName = "testDashboard",
    ///             Lenses = 
    ///             {
    ///                 { "aLens", new AzureRM.Portal.V20190101Preview.Inputs.DashboardLensArgs
    ///                 {
    ///                     Order = 1,
    ///                     Parts = 
    ///                     {
    ///                         { "aPart", new AzureRM.Portal.V20190101Preview.Inputs.DashboardPartsArgs
    ///                         {
    ///                             Position = new AzureRM.Portal.V20190101Preview.Inputs.DashboardPartsPositionArgs
    ///                             {
    ///                                 ColSpan = 3,
    ///                                 RowSpan = 4,
    ///                                 X = 1,
    ...
    ///                             },
    ///                         } },
    ///                         { "bPart", new AzureRM.Portal.V20190101Preview.Inputs.DashboardPartsArgs
    ///                         {
    ///                             Position = new AzureRM.Portal.V20190101Preview.Inputs.DashboardPartsPositionArgs
    ///                             {
    ///                                 ColSpan = 6,
    ...
    ///                     },
    ///                 } },
    ///                 { "bLens", new AzureRM.Portal.V20190101Preview.Inputs.DashboardLensArgs
    ///                 {
    ///                     Order = 2,
    ///                     Parts = ,
    ///                 } },
