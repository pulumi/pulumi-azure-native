...
namespace Pulumi.AzureNative.Portal.V20190101Preview
{
    ...
    public partial class TenantConfiguration : Pulumi.CustomResource
    {
        ...
        public TenantConfiguration(string name, TenantConfigurationArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20190101preview:TenantConfiguration", name, args ?? new TenantConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TenantConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20190101preview:TenantConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
