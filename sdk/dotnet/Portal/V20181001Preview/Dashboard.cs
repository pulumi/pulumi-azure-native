...
namespace Pulumi.AzureNextGen.Portal.V20181001Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:portal/v20181001preview:Dashboard")]
    public partial class Dashboard : Pulumi.CustomResource
    {
        ...
        public Dashboard(string name, DashboardArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:portal/v20181001preview:Dashboard", name, args ?? new DashboardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dashboard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:portal/v20181001preview:Dashboard", name, null, MakeResourceOptions(options, id))
        {
        }
