...
namespace Pulumi.AzureNative.Portal.V20181001Preview
{
    /// <summary>
    /// The shared dashboard resource definition.
    /// </summary>
    [Obsolete(@"azure-native:portal/v20181001preview:Dashboard is being removed in the next major version of this provider. Upgrade to at least azure-native:portal/v20190101preview:Dashboard to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:portal/v20181001preview:Dashboard")]
    public partial class Dashboard : global::Pulumi.CustomResource
    {
        ...
        public Dashboard(string name, DashboardArgs args, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20181001preview:Dashboard", name, args ?? new DashboardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dashboard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20181001preview:Dashboard", name, null, MakeResourceOptions(options, id))
        {
        }
