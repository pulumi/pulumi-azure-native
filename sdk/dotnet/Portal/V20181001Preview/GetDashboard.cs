...
namespace Pulumi.AzureNative.Portal.V20181001Preview
{
    public static class GetDashboard
    {
        ...
        public static Task<GetDashboardResult> InvokeAsync(GetDashboardArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDashboardResult>("azure-native:portal/v20181001preview:getDashboard", args ?? new GetDashboardArgs(), options.WithVersion());

        /// <summary>
        /// The shared dashboard resource definition.
        /// </summary>
        public static Output<GetDashboardResult> Invoke(GetDashboardInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDashboardResult>("azure-native:portal/v20181001preview:getDashboard", args ?? new GetDashboardInvokeArgs(), options.WithVersion());
    }
