...
namespace Pulumi.AzureNative.Portal.V20181001.Inputs
{
    ...
    public sealed class ConsoleCreatePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Portal.V20181001.OsType> OsType { get; set; } = null!;

        /// <summary>
        /// Provisioning state of the console.
        /// </summary>
        [Input("provisioningState")]
        public InputUnion<string, Pulumi.AzureNative.Portal.V20181001.ProvisioningState>? ProvisioningState { get; set; }
