...
namespace Pulumi.AzureNative.Portal.V20250401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:portal/v20250401preview:TenantConfiguration")]
    public partial class TenantConfiguration : global::Pulumi.CustomResource
    {
        ...
        public TenantConfiguration(string name, TenantConfigurationArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20250401preview:TenantConfiguration", name, args ?? new TenantConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TenantConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20250401preview:TenantConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
