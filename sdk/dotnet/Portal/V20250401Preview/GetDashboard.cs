...
namespace Pulumi.AzureNative.Portal.V20250401Preview
{
    public static class GetDashboard
    {
        ...
        public static Task<GetDashboardResult> InvokeAsync(GetDashboardArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDashboardResult>("azure-native:portal/v20250401preview:getDashboard", args ?? new GetDashboardArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the Dashboard.
        /// </summary>
        public static Output<GetDashboardResult> Invoke(GetDashboardInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDashboardResult>("azure-native:portal/v20250401preview:getDashboard", args ?? new GetDashboardInvokeArgs(), options.WithDefaults());
