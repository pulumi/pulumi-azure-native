...
namespace Pulumi.AzureNative.Portal.V20250401Preview
{
    public static class GetTenantConfiguration
    {
        ...
        public static Task<GetTenantConfigurationResult> InvokeAsync(GetTenantConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTenantConfigurationResult>("azure-native:portal/v20250401preview:getTenantConfiguration", args ?? new GetTenantConfigurationArgs(), options.WithDefaults());
        ...
        public static Output<GetTenantConfigurationResult> Invoke(GetTenantConfigurationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTenantConfigurationResult>("azure-native:portal/v20250401preview:getTenantConfiguration", args ?? new GetTenantConfigurationInvokeArgs(), options.WithDefaults());
