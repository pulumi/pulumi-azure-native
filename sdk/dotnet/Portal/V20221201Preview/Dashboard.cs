...
namespace Pulumi.AzureNative.Portal.V20221201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:portal/v20221201preview:Dashboard")]
    public partial class Dashboard : global::Pulumi.CustomResource
    {
        ...
        public Dashboard(string name, DashboardArgs args, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20221201preview:Dashboard", name, args ?? new DashboardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dashboard(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20221201preview:Dashboard", name, null, MakeResourceOptions(options, id))
        {
        }
