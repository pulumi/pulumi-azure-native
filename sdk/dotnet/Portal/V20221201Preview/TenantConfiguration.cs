...
namespace Pulumi.AzureNative.Portal.V20221201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:portal/v20221201preview:TenantConfiguration")]
    public partial class TenantConfiguration : global::Pulumi.CustomResource
    {
        ...
        public TenantConfiguration(string name, TenantConfigurationArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20221201preview:TenantConfiguration", name, args ?? new TenantConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TenantConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:portal/v20221201preview:TenantConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
