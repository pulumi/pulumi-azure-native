...
namespace Pulumi.AzureNative.Portal.V20221201Preview
{
    public static class GetTenantConfiguration
    {
        ...
        public static Task<GetTenantConfigurationResult> InvokeAsync(GetTenantConfigurationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTenantConfigurationResult>("azure-native:portal/v20221201preview:getTenantConfiguration", args ?? new GetTenantConfigurationArgs(), options.WithDefaults());
