...
namespace Pulumi.AzureNative.Maintenance.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maintenance/v20230401:ConfigurationAssignmentsForSubscription")]
    public partial class ConfigurationAssignmentsForSubscription : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationAssignmentsForSubscription(string name, ConfigurationAssignmentsForSubscriptionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20230401:ConfigurationAssignmentsForSubscription", name, args ?? new ConfigurationAssignmentsForSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationAssignmentsForSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20230401:ConfigurationAssignmentsForSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
