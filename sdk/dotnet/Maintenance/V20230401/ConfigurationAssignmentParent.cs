...
namespace Pulumi.AzureNative.Maintenance.V20230401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maintenance/v20230401:ConfigurationAssignmentParent")]
    public partial class ConfigurationAssignmentParent : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationAssignmentParent(string name, ConfigurationAssignmentParentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20230401:ConfigurationAssignmentParent", name, args ?? new ConfigurationAssignmentParentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationAssignmentParent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20230401:ConfigurationAssignmentParent", name, null, MakeResourceOptions(options, id))
        {
        }
