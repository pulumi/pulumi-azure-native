...
namespace Pulumi.AzureNative.Maintenance.V20230401
{
    public static class GetConfigurationAssignmentsForResourceGroup
    {
        ...
        public static Task<GetConfigurationAssignmentsForResourceGroupResult> InvokeAsync(GetConfigurationAssignmentsForResourceGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationAssignmentsForResourceGroupResult>("azure-native:maintenance/v20230401:getConfigurationAssignmentsForResourceGroup", args ?? new GetConfigurationAssignmentsForResourceGroupArgs(), options.WithDefaults());
        ...
        public static Output<GetConfigurationAssignmentsForResourceGroupResult> Invoke(GetConfigurationAssignmentsForResourceGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConfigurationAssignmentsForResourceGroupResult>("azure-native:maintenance/v20230401:getConfigurationAssignmentsForResourceGroup", args ?? new GetConfigurationAssignmentsForResourceGroupInvokeArgs(), options.WithDefaults());
