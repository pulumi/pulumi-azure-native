...
namespace Pulumi.AzureNative.Maintenance.V20221101Preview
{
    ...
    public partial class ConfigurationAssignmentParent : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationAssignmentParent(string name, ConfigurationAssignmentParentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20221101preview:ConfigurationAssignmentParent", name, args ?? new ConfigurationAssignmentParentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationAssignmentParent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20221101preview:ConfigurationAssignmentParent", name, null, MakeResourceOptions(options, id))
        {
        }
