...
namespace Pulumi.AzureNative.Maintenance.V20221101Preview
{
    public static class GetConfigurationAssignment
    {
        ...
        public static Task<GetConfigurationAssignmentResult> InvokeAsync(GetConfigurationAssignmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationAssignmentResult>("azure-native:maintenance/v20221101preview:getConfigurationAssignment", args ?? new GetConfigurationAssignmentArgs(), options.WithDefaults());
        ...
        public static Output<GetConfigurationAssignmentResult> Invoke(GetConfigurationAssignmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConfigurationAssignmentResult>("azure-native:maintenance/v20221101preview:getConfigurationAssignment", args ?? new GetConfigurationAssignmentInvokeArgs(), options.WithDefaults());
    }
