...
namespace Pulumi.AzureNative.Maintenance.V20220701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maintenance/v20220701preview:ConfigurationAssignment")]
    public partial class ConfigurationAssignment : Pulumi.CustomResource
    {
        ...
        public ConfigurationAssignment(string name, ConfigurationAssignmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20220701preview:ConfigurationAssignment", name, args ?? new ConfigurationAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationAssignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20220701preview:ConfigurationAssignment", name, null, MakeResourceOptions(options, id))
        {
        }
