...
namespace Pulumi.AzureNative.Maintenance.V20220701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maintenance/v20220701preview:ConfigurationAssignmentParent")]
    public partial class ConfigurationAssignmentParent : Pulumi.CustomResource
    {
        ...
        public ConfigurationAssignmentParent(string name, ConfigurationAssignmentParentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20220701preview:ConfigurationAssignmentParent", name, args ?? new ConfigurationAssignmentParentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationAssignmentParent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20220701preview:ConfigurationAssignmentParent", name, null, MakeResourceOptions(options, id))
        {
        }
