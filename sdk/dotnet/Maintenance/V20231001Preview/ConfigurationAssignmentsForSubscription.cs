...
namespace Pulumi.AzureNative.Maintenance.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForSubscription")]
    public partial class ConfigurationAssignmentsForSubscription : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationAssignmentsForSubscription(string name, ConfigurationAssignmentsForSubscriptionArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForSubscription", name, args ?? new ConfigurationAssignmentsForSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationAssignmentsForSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:maintenance:ConfigurationAssignmentsForSubscription" },
                },
            };
