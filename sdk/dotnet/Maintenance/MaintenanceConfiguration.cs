...
namespace Pulumi.AzureNextGen.Maintenance
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:maintenance:MaintenanceConfiguration")]
    public partial class MaintenanceConfiguration : Pulumi.CustomResource
    {
        ...
        public MaintenanceConfiguration(string name, MaintenanceConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:maintenance:MaintenanceConfiguration", name, args ?? new MaintenanceConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MaintenanceConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:maintenance:MaintenanceConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MaintenanceConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.Maintenance.MaintenanceScope>? MaintenanceScope { get; set; }
