...
namespace Pulumi.AzureNative.Maintenance.V20230901Preview
{
    public static class GetConfigurationAssignmentsForResourceGroup
    {
        ...
        public static Task<GetConfigurationAssignmentsForResourceGroupResult> InvokeAsync(GetConfigurationAssignmentsForResourceGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationAssignmentsForResourceGroupResult>("azure-native:maintenance/v20230901preview:getConfigurationAssignmentsForResourceGroup", args ?? new GetConfigurationAssignmentsForResourceGroupArgs(), options.WithDefaults());
