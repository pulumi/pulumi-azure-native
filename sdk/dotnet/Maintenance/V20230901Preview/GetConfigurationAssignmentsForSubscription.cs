...
namespace Pulumi.AzureNative.Maintenance.V20230901Preview
{
    public static class GetConfigurationAssignmentsForSubscription
    {
        ...
        public static Task<GetConfigurationAssignmentsForSubscriptionResult> InvokeAsync(GetConfigurationAssignmentsForSubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConfigurationAssignmentsForSubscriptionResult>("azure-native:maintenance/v20230901preview:getConfigurationAssignmentsForSubscription", args ?? new GetConfigurationAssignmentsForSubscriptionArgs(), options.WithDefaults());
        ...
        public static Output<GetConfigurationAssignmentsForSubscriptionResult> Invoke(GetConfigurationAssignmentsForSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConfigurationAssignmentsForSubscriptionResult>("azure-native:maintenance/v20230901preview:getConfigurationAssignmentsForSubscription", args ?? new GetConfigurationAssignmentsForSubscriptionInvokeArgs(), options.WithDefaults());
    }
