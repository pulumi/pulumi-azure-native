...
namespace Pulumi.AzureNative.Maintenance.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maintenance/v20230901preview:ConfigurationAssignmentParent")]
    public partial class ConfigurationAssignmentParent : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationAssignmentParent(string name, ConfigurationAssignmentParentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20230901preview:ConfigurationAssignmentParent", name, args ?? new ConfigurationAssignmentParentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationAssignmentParent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20230901preview:ConfigurationAssignmentParent", name, null, MakeResourceOptions(options, id))
        {
        }
