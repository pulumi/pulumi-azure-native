...
namespace Pulumi.AzureNative.Maintenance.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:maintenance/v20230901preview:MaintenanceConfiguration")]
    public partial class MaintenanceConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MaintenanceConfiguration(string name, MaintenanceConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20230901preview:MaintenanceConfiguration", name, args ?? new MaintenanceConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MaintenanceConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20230901preview:MaintenanceConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MaintenanceConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Maintenance.V20230901Preview.MaintenanceScope>? MaintenanceScope { get; set; }
        ...
        /// </summary>
        [Input("visibility")]
        public InputUnion<string, Pulumi.AzureNative.Maintenance.V20230901Preview.Visibility>? Visibility { get; set; }
