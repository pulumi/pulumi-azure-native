...
namespace Pulumi.AzureNative.Maintenance.V20180601Preview
{
    ...
    public partial class MaintenanceConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MaintenanceConfiguration(string name, MaintenanceConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20180601preview:MaintenanceConfiguration", name, args ?? new MaintenanceConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MaintenanceConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20180601preview:MaintenanceConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MaintenanceConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Maintenance.V20180601Preview.MaintenanceScope>? MaintenanceScope { get; set; }
