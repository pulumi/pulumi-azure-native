...
namespace Pulumi.AzureNative.Maintenance
{
    ...
    public partial class ConfigurationAssignmentsForResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationAssignmentsForResourceGroup(string name, ConfigurationAssignmentsForResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maintenance:ConfigurationAssignmentsForResourceGroup", name, args ?? new ConfigurationAssignmentsForResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationAssignmentsForResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance:ConfigurationAssignmentsForResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:maintenance/v20251001preview:ConfigurationAssignmentsForResourceGroup" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConfigurationAssignmentsForResourceGroup Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ConfigurationAssignmentsForResourceGroup(name, id, options);
        }
    }

    public sealed class ConfigurationAssignmentsForResourceGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public ConfigurationAssignmentsForResourceGroupArgs()
        {
        }
        public static new ConfigurationAssignmentsForResourceGroupArgs Empty => new ConfigurationAssignmentsForResourceGroupArgs();
    }
}
