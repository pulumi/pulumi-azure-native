...
namespace Pulumi.AzureNative.Maintenance.V20210901Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:maintenance/v20210901preview:ConfigurationAssignmentParent is being removed in the next major version of this provider. Please upgrade to azure-native:maintenance/v20221101preview:ConfigurationAssignmentParent to guarantee forwards compatibility.")]
    ...
    public partial class ConfigurationAssignmentParent : global::Pulumi.CustomResource
    {
        ...
        public ConfigurationAssignmentParent(string name, ConfigurationAssignmentParentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20210901preview:ConfigurationAssignmentParent", name, args ?? new ConfigurationAssignmentParentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationAssignmentParent(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:maintenance/v20210901preview:ConfigurationAssignmentParent", name, null, MakeResourceOptions(options, id))
        {
        }
