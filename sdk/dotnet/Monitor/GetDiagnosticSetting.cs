...
namespace Pulumi.AzureNative.Monitor
{
    public static class GetDiagnosticSetting
    {
        ...
        public static Task<GetDiagnosticSettingResult> InvokeAsync(GetDiagnosticSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiagnosticSettingResult>("azure-native:monitor:getDiagnosticSetting", args ?? new GetDiagnosticSettingArgs(), options.WithDefaults());
        ...
        public static Output<GetDiagnosticSettingResult> Invoke(GetDiagnosticSettingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiagnosticSettingResult>("azure-native:monitor:getDiagnosticSetting", args ?? new GetDiagnosticSettingInvokeArgs(), options.WithDefaults());
