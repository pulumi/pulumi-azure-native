...
namespace Pulumi.AzureNative.Monitor.V20230311
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20230311:DataCollectionEndpoint")]
    public partial class DataCollectionEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionEndpoint(string name, DataCollectionEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230311:DataCollectionEndpoint", name, args ?? new DataCollectionEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230311:DataCollectionEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor:DataCollectionEndpoint" },
                },
            };
    ...
    public sealed class DataCollectionEndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Monitor.V20230311.KnownDataCollectionEndpointResourceKind>? Kind { get; set; }
