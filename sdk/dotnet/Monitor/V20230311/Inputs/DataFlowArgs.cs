...
namespace Pulumi.AzureNative.Monitor.V20230311.Inputs
{
    ...
    public sealed class DataFlowArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("streams")]
        private InputList<Union<string, Pulumi.AzureNative.Monitor.V20230311.KnownDataFlowStreams>>? _streams;

        /// <summary>
        /// List of streams for this data flow.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Monitor.V20230311.KnownDataFlowStreams>> Streams
        {
            get => _streams ?? (_streams = new InputList<Union<string, Pulumi.AzureNative.Monitor.V20230311.KnownDataFlowStreams>>());
            set => _streams = value;
        }
