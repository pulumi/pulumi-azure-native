...
namespace Pulumi.AzureNative.Monitor.V20230311
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20230311:DataCollectionRuleAssociation")]
    public partial class DataCollectionRuleAssociation : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionRuleAssociation(string name, DataCollectionRuleAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230311:DataCollectionRuleAssociation", name, args ?? new DataCollectionRuleAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionRuleAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230311:DataCollectionRuleAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor/v20191101preview:DataCollectionRuleAssociation" },
                    new global::Pulumi.Alias { Type = "azure-native:monitor/v20210401:DataCollectionRuleAssociation" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor:DataCollectionRuleAssociation" },
                },
            };
