...
namespace Pulumi.AzureNative.Monitor.V20180301
{
    public static class GetMetricAlert
    {
        ...
        public static Task<GetMetricAlertResult> InvokeAsync(GetMetricAlertArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMetricAlertResult>("azure-native:monitor/v20180301:getMetricAlert", args ?? new GetMetricAlertArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve an alert rule definition.
        /// </summary>
        public static Output<GetMetricAlertResult> Invoke(GetMetricAlertInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMetricAlertResult>("azure-native:monitor/v20180301:getMetricAlert", args ?? new GetMetricAlertInvokeArgs(), options.WithDefaults());
