...
namespace Pulumi.AzureNative.Monitor.V20180301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20180301:MetricAlert")]
    public partial class MetricAlert : global::Pulumi.CustomResource
    {
        ...
        public MetricAlert(string name, MetricAlertArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20180301:MetricAlert", name, args ?? new MetricAlertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MetricAlert(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20180301:MetricAlert", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor:MetricAlert" },
                },
            };
