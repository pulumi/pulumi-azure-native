...
namespace Pulumi.AzureNative.Monitor.V20160301
{
    public static class GetLogProfile
    {
        ...
        public static Task<GetLogProfileResult> InvokeAsync(GetLogProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLogProfileResult>("azure-native:monitor/v20160301:getLogProfile", args ?? new GetLogProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the log profile.
        /// </summary>
        public static Output<GetLogProfileResult> Invoke(GetLogProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLogProfileResult>("azure-native:monitor/v20160301:getLogProfile", args ?? new GetLogProfileInvokeArgs(), options.WithDefaults());
