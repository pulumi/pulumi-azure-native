...
namespace Pulumi.AzureNative.Monitor.V20160301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20160301:LogProfile")]
    public partial class LogProfile : global::Pulumi.CustomResource
    {
        ...
        public LogProfile(string name, LogProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20160301:LogProfile", name, args ?? new LogProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogProfile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20160301:LogProfile", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor:LogProfile" },
                },
            };
