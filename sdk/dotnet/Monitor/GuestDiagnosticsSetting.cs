...
namespace Pulumi.AzureNative.Monitor
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor:GuestDiagnosticsSetting")]
    public partial class GuestDiagnosticsSetting : global::Pulumi.CustomResource
    {
        ...
        public GuestDiagnosticsSetting(string name, GuestDiagnosticsSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor:GuestDiagnosticsSetting", name, args ?? new GuestDiagnosticsSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestDiagnosticsSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor:GuestDiagnosticsSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor/v20180601preview:GuestDiagnosticsSetting" },
                },
            };
