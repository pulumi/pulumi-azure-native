...
namespace Pulumi.AzureNative.Monitor.V20170501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20170501preview:SubscriptionDiagnosticSetting")]
    public partial class SubscriptionDiagnosticSetting : global::Pulumi.CustomResource
    {
        ...
        public SubscriptionDiagnosticSetting(string name, SubscriptionDiagnosticSettingArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20170501preview:SubscriptionDiagnosticSetting", name, args ?? new SubscriptionDiagnosticSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionDiagnosticSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20170501preview:SubscriptionDiagnosticSetting", name, null, MakeResourceOptions(options, id))
        {
        }
