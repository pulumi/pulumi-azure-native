...
namespace Pulumi.AzureNative.Monitor.V20170501Preview
{
    public static class ListDiagnosticSettingsCategory
    {
        ...
        public static Task<ListDiagnosticSettingsCategoryResult> InvokeAsync(ListDiagnosticSettingsCategoryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListDiagnosticSettingsCategoryResult>("azure-native:monitor/v20170501preview:listDiagnosticSettingsCategory", args ?? new ListDiagnosticSettingsCategoryArgs(), options.WithDefaults());
        ...
        public static Output<ListDiagnosticSettingsCategoryResult> Invoke(ListDiagnosticSettingsCategoryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListDiagnosticSettingsCategoryResult>("azure-native:monitor/v20170501preview:listDiagnosticSettingsCategory", args ?? new ListDiagnosticSettingsCategoryInvokeArgs(), options.WithDefaults());
