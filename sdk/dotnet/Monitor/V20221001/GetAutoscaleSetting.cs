...
namespace Pulumi.AzureNative.Monitor.V20221001
{
    public static class GetAutoscaleSetting
    {
        ...
        public static Task<GetAutoscaleSettingResult> InvokeAsync(GetAutoscaleSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAutoscaleSettingResult>("azure-native:monitor/v20221001:getAutoscaleSetting", args ?? new GetAutoscaleSettingArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an autoscale setting
        /// </summary>
        public static Output<GetAutoscaleSettingResult> Invoke(GetAutoscaleSettingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAutoscaleSettingResult>("azure-native:monitor/v20221001:getAutoscaleSetting", args ?? new GetAutoscaleSettingInvokeArgs(), options.WithDefaults());
