...
namespace Pulumi.AzureNative.Monitor.V20221001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20221001:AutoscaleSetting")]
    public partial class AutoscaleSetting : global::Pulumi.CustomResource
    {
        ...
        public AutoscaleSetting(string name, AutoscaleSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20221001:AutoscaleSetting", name, args ?? new AutoscaleSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutoscaleSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20221001:AutoscaleSetting", name, null, MakeResourceOptions(options, id))
        {
        }
