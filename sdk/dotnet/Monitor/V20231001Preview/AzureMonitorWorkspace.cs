...
namespace Pulumi.AzureNative.Monitor.V20231001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20231001preview:AzureMonitorWorkspace")]
    public partial class AzureMonitorWorkspace : global::Pulumi.CustomResource
    {
        ...
        public AzureMonitorWorkspace(string name, AzureMonitorWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20231001preview:AzureMonitorWorkspace", name, args ?? new AzureMonitorWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureMonitorWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20231001preview:AzureMonitorWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
