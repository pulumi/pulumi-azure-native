...
namespace Pulumi.AzureNative.Monitor.V20240101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20240101preview:ScheduledQueryRule")]
    public partial class ScheduledQueryRule : global::Pulumi.CustomResource
    {
        ...
        public ScheduledQueryRule(string name, ScheduledQueryRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20240101preview:ScheduledQueryRule", name, args ?? new ScheduledQueryRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledQueryRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20240101preview:ScheduledQueryRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledQueryRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Monitor.V20240101Preview.Kind>? Kind { get; set; }
