...
namespace Pulumi.AzureNative.Monitor.V20210603Preview
{
    ...
    public partial class AzureMonitorWorkspace : global::Pulumi.CustomResource
    {
        ...
        public AzureMonitorWorkspace(string name, AzureMonitorWorkspaceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20210603preview:AzureMonitorWorkspace", name, args ?? new AzureMonitorWorkspaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureMonitorWorkspace(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20210603preview:AzureMonitorWorkspace", name, null, MakeResourceOptions(options, id))
        {
        }
