...
namespace Pulumi.AzureNative.Monitor.Inputs
{
    ...
    public sealed class MetricCriteriaArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Monitor.Operator> Operator { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Monitor.AggregationTypeEnum> TimeAggregation { get; set; } = null!;
