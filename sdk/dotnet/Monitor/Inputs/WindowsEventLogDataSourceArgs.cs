...
namespace Pulumi.AzureNative.Monitor.Inputs
{
    ...
    public sealed class WindowsEventLogDataSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("streams")]
        private InputList<Union<string, Pulumi.AzureNative.Monitor.KnownWindowsEventLogDataSourceStreams>>? _streams;

        /// <summary>
        /// List of streams that this data source will be sent to.
        /// A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.Monitor.KnownWindowsEventLogDataSourceStreams>> Streams
        {
            get => _streams ?? (_streams = new InputList<Union<string, Pulumi.AzureNative.Monitor.KnownWindowsEventLogDataSourceStreams>>());
            set => _streams = value;
        }
