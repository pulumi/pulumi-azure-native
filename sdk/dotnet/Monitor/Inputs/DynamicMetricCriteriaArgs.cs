...
namespace Pulumi.AzureNative.Monitor.Inputs
{
    ...
    public sealed class DynamicMetricCriteriaArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Monitor.DynamicThresholdSensitivity> AlertSensitivity { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.Monitor.DynamicThresholdOperator> Operator { get; set; } = null!;
