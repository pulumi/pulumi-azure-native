...
namespace Pulumi.AzureNative.Monitor.V20241001Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20241001preview:PipelineGroup")]
    public partial class PipelineGroup : global::Pulumi.CustomResource
    {
        ...
        public PipelineGroup(string name, PipelineGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20241001preview:PipelineGroup", name, args ?? new PipelineGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PipelineGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20241001preview:PipelineGroup", name, null, MakeResourceOptions(options, id))
        {
        }
