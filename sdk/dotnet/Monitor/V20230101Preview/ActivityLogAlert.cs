...
namespace Pulumi.AzureNative.Monitor.V20230101Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20230101preview:ActivityLogAlert")]
    public partial class ActivityLogAlert : global::Pulumi.CustomResource
    {
        ...
        public ActivityLogAlert(string name, ActivityLogAlertArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230101preview:ActivityLogAlert", name, args ?? new ActivityLogAlertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActivityLogAlert(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230101preview:ActivityLogAlert", name, null, MakeResourceOptions(options, id))
        {
        }
