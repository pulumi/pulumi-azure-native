...
namespace Pulumi.AzureNative.Monitor.V20220801Preview
{
    public static class GetScheduledQueryRule
    {
        ...
        public static Task<GetScheduledQueryRuleResult> InvokeAsync(GetScheduledQueryRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScheduledQueryRuleResult>("azure-native:monitor/v20220801preview:getScheduledQueryRule", args ?? new GetScheduledQueryRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieve an scheduled query rule definition.
        /// </summary>
        public static Output<GetScheduledQueryRuleResult> Invoke(GetScheduledQueryRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScheduledQueryRuleResult>("azure-native:monitor/v20220801preview:getScheduledQueryRule", args ?? new GetScheduledQueryRuleInvokeArgs(), options.WithDefaults());
