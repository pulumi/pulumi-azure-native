...
namespace Pulumi.AzureNative.Monitor.V20191017Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20191017preview:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20191017preview:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20191017preview:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
