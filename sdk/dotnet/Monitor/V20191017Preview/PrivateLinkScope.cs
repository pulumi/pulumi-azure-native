...
namespace Pulumi.AzureNative.Monitor.V20191017Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20191017preview:PrivateLinkScope")]
    public partial class PrivateLinkScope : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScope(string name, PrivateLinkScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20191017preview:PrivateLinkScope", name, args ?? new PrivateLinkScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20191017preview:PrivateLinkScope", name, null, MakeResourceOptions(options, id))
        {
        }
