...
namespace Pulumi.AzureNative.Monitor.V20210501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20210501preview:DiagnosticSetting")]
    public partial class DiagnosticSetting : global::Pulumi.CustomResource
    {
        ...
        public DiagnosticSetting(string name, DiagnosticSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20210501preview:DiagnosticSetting", name, args ?? new DiagnosticSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiagnosticSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20210501preview:DiagnosticSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor:DiagnosticSetting" },
                },
            };
