...
namespace Pulumi.AzureNative.Monitor.V20210501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20210501preview:AutoscaleSetting")]
    public partial class AutoscaleSetting : global::Pulumi.CustomResource
    {
        ...
        public AutoscaleSetting(string name, AutoscaleSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20210501preview:AutoscaleSetting", name, args ?? new AutoscaleSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AutoscaleSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20210501preview:AutoscaleSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor:AutoscaleSetting" },
                },
            };
