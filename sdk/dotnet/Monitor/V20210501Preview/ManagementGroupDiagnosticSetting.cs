...
namespace Pulumi.AzureNative.Monitor.V20210501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20210501preview:ManagementGroupDiagnosticSetting")]
    public partial class ManagementGroupDiagnosticSetting : global::Pulumi.CustomResource
    {
        ...
        public ManagementGroupDiagnosticSetting(string name, ManagementGroupDiagnosticSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20210501preview:ManagementGroupDiagnosticSetting", name, args ?? new ManagementGroupDiagnosticSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementGroupDiagnosticSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20210501preview:ManagementGroupDiagnosticSetting", name, null, MakeResourceOptions(options, id))
        {
        }
