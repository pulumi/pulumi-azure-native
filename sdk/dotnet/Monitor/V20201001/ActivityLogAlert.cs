...
namespace Pulumi.AzureNative.Monitor.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20201001:ActivityLogAlert")]
    public partial class ActivityLogAlert : global::Pulumi.CustomResource
    {
        ...
        public ActivityLogAlert(string name, ActivityLogAlertArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20201001:ActivityLogAlert", name, args ?? new ActivityLogAlertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActivityLogAlert(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20201001:ActivityLogAlert", name, null, MakeResourceOptions(options, id))
        {
        }
