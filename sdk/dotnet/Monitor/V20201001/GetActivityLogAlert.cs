...
namespace Pulumi.AzureNative.Monitor.V20201001
{
    public static class GetActivityLogAlert
    {
        ...
        public static Task<GetActivityLogAlertResult> InvokeAsync(GetActivityLogAlertArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActivityLogAlertResult>("azure-native:monitor/v20201001:getActivityLogAlert", args ?? new GetActivityLogAlertArgs(), options.WithDefaults());

        /// <summary>
        /// Get an Activity Log Alert rule.
        /// </summary>
        public static Output<GetActivityLogAlertResult> Invoke(GetActivityLogAlertInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetActivityLogAlertResult>("azure-native:monitor/v20201001:getActivityLogAlert", args ?? new GetActivityLogAlertInvokeArgs(), options.WithDefaults());
