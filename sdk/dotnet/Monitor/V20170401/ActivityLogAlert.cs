...
namespace Pulumi.AzureNative.Monitor.V20170401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20170401:ActivityLogAlert")]
    public partial class ActivityLogAlert : global::Pulumi.CustomResource
    {
        ...
        public ActivityLogAlert(string name, ActivityLogAlertArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20170401:ActivityLogAlert", name, args ?? new ActivityLogAlertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActivityLogAlert(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20170401:ActivityLogAlert", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor:ActivityLogAlert" },
                },
            };
