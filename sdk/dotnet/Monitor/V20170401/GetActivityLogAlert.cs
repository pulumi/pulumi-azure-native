...
namespace Pulumi.AzureNative.Monitor.V20170401
{
    public static class GetActivityLogAlert
    {
        ...
        public static Task<GetActivityLogAlertResult> InvokeAsync(GetActivityLogAlertArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetActivityLogAlertResult>("azure-native:monitor/v20170401:getActivityLogAlert", args ?? new GetActivityLogAlertArgs(), options.WithDefaults());

        /// <summary>
        /// Get an activity log alert.
        /// </summary>
        public static Output<GetActivityLogAlertResult> Invoke(GetActivityLogAlertInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetActivityLogAlertResult>("azure-native:monitor/v20170401:getActivityLogAlert", args ?? new GetActivityLogAlertInvokeArgs(), options.WithDefaults());
