...
namespace Pulumi.AzureNative.Monitor.V20180416
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20180416:ScheduledQueryRule")]
    public partial class ScheduledQueryRule : global::Pulumi.CustomResource
    {
        ...
        public ScheduledQueryRule(string name, ScheduledQueryRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20180416:ScheduledQueryRule", name, args ?? new ScheduledQueryRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledQueryRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20180416:ScheduledQueryRule", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledQueryRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enabled")]
        public InputUnion<string, Pulumi.AzureNative.Monitor.V20180416.Enabled>? Enabled { get; set; }
