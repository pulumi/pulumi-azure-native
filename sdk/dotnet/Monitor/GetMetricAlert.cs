...
namespace Pulumi.AzureNative.Monitor
{
    public static class GetMetricAlert
    {
        ...
        public static Task<GetMetricAlertResult> InvokeAsync(GetMetricAlertArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetMetricAlertResult>("azure-native:monitor:getMetricAlert", args ?? new GetMetricAlertArgs(), options.WithDefaults());
        ...
        public static Output<GetMetricAlertResult> Invoke(GetMetricAlertInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetMetricAlertResult>("azure-native:monitor:getMetricAlert", args ?? new GetMetricAlertInvokeArgs(), options.WithDefaults());
