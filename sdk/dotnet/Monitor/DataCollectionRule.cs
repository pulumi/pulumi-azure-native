...
namespace Pulumi.AzureNative.Monitor
{
    ...
    public partial class DataCollectionRule : global::Pulumi.CustomResource
    {
        ...
        public DataCollectionRule(string name, DataCollectionRuleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor:DataCollectionRule", name, args ?? new DataCollectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataCollectionRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor:DataCollectionRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor/v20230311:DataCollectionRule" },
                    new global::Pulumi.Alias { Type = "azure-native:monitor/v20240311:DataCollectionRule" },
                },
            };
    ...
    public sealed class DataCollectionRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Monitor.KnownDataCollectionRuleResourceKind>? Kind { get; set; }
