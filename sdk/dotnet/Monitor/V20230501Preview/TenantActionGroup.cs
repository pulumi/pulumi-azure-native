...
namespace Pulumi.AzureNative.Monitor.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20230501preview:TenantActionGroup")]
    public partial class TenantActionGroup : global::Pulumi.CustomResource
    {
        ...
        public TenantActionGroup(string name, TenantActionGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230501preview:TenantActionGroup", name, args ?? new TenantActionGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TenantActionGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230501preview:TenantActionGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor:TenantActionGroup" },
                },
            };
