...
namespace Pulumi.AzureNative.Monitor.V20230501Preview
{
    public static class GetTenantActionGroup
    {
        ...
        public static Task<GetTenantActionGroupResult> InvokeAsync(GetTenantActionGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTenantActionGroupResult>("azure-native:monitor/v20230501preview:getTenantActionGroup", args ?? new GetTenantActionGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Get a tenant action group.
        /// </summary>
        public static Output<GetTenantActionGroupResult> Invoke(GetTenantActionGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTenantActionGroupResult>("azure-native:monitor/v20230501preview:getTenantActionGroup", args ?? new GetTenantActionGroupInvokeArgs(), options.WithDefaults());
