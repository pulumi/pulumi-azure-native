...
namespace Pulumi.AzureNative.Monitor.V20230601Preview.Inputs
{
    ...
    public sealed class AccessModeSettingsArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Monitor.V20230601Preview.AccessMode> IngestionAccessMode { get; set; } = null!;

        /// <summary>
        /// Specifies the default access mode of queries through associated private endpoints in scope. If not specified default value is 'Open'. You can override this default setting for a specific private endpoint connection by adding an exclusion in the 'exclusions' array.
        /// </summary>
        [Input("queryAccessMode", required: true)]
        public InputUnion<string, Pulumi.AzureNative.Monitor.V20230601Preview.AccessMode> QueryAccessMode { get; set; } = null!;
