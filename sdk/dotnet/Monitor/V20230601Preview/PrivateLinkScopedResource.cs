...
namespace Pulumi.AzureNative.Monitor.V20230601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor/v20230601preview:PrivateLinkScopedResource")]
    public partial class PrivateLinkScopedResource : global::Pulumi.CustomResource
    {
        ...
        public PrivateLinkScopedResource(string name, PrivateLinkScopedResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230601preview:PrivateLinkScopedResource", name, args ?? new PrivateLinkScopedResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateLinkScopedResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor/v20230601preview:PrivateLinkScopedResource", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:monitor:PrivateLinkScopedResource" },
                },
            };
    ...
    public sealed class PrivateLinkScopedResourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("kind")]
        public InputUnion<string, Pulumi.AzureNative.Monitor.V20230601Preview.ScopedResourceKind>? Kind { get; set; }
