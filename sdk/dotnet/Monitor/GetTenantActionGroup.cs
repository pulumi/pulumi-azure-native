...
namespace Pulumi.AzureNative.Monitor
{
    public static class GetTenantActionGroup
    {
        ...
        public static Task<GetTenantActionGroupResult> InvokeAsync(GetTenantActionGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTenantActionGroupResult>("azure-native:monitor:getTenantActionGroup", args ?? new GetTenantActionGroupArgs(), options.WithDefaults());
        ...
        public static Output<GetTenantActionGroupResult> Invoke(GetTenantActionGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTenantActionGroupResult>("azure-native:monitor:getTenantActionGroup", args ?? new GetTenantActionGroupInvokeArgs(), options.WithDefaults());
    ...
    public sealed class GetTenantActionGroupArgs : global::Pulumi.InvokeArgs
    {
        ...
        public string? TenantActionGroupName { get; set; }
