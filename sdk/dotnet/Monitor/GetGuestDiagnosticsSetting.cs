...
namespace Pulumi.AzureNative.Monitor
{
    public static class GetGuestDiagnosticsSetting
    {
        ...
        public static Task<GetGuestDiagnosticsSettingResult> InvokeAsync(GetGuestDiagnosticsSettingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGuestDiagnosticsSettingResult>("azure-native:monitor:getGuestDiagnosticsSetting", args ?? new GetGuestDiagnosticsSettingArgs(), options.WithDefaults());
        ...
        public static Output<GetGuestDiagnosticsSettingResult> Invoke(GetGuestDiagnosticsSettingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGuestDiagnosticsSettingResult>("azure-native:monitor:getGuestDiagnosticsSetting", args ?? new GetGuestDiagnosticsSettingInvokeArgs(), options.WithDefaults());
