...
namespace Pulumi.AzureNative.Monitor
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:monitor:GuestDiagnosticsSettingsAssociation")]
    public partial class GuestDiagnosticsSettingsAssociation : global::Pulumi.CustomResource
    {
        ...
        public GuestDiagnosticsSettingsAssociation(string name, GuestDiagnosticsSettingsAssociationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:monitor:GuestDiagnosticsSettingsAssociation", name, args ?? new GuestDiagnosticsSettingsAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GuestDiagnosticsSettingsAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:monitor:GuestDiagnosticsSettingsAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:insights:GuestDiagnosticsSettingsAssociation" },
                    new global::Pulumi.Alias { Type = "azure-native:monitor/v20180601preview:GuestDiagnosticsSettingsAssociation" },
                },
            };
