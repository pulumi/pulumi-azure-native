...
namespace Pulumi.AzureRM.DelegatedNetwork.Latest
{
    public static class GetControllerDetails
    {
        public static Task<GetControllerDetailsResult> InvokeAsync(GetControllerDetailsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetControllerDetailsResult>("azurerm:delegatednetwork/latest:getControllerDetails", args ?? new GetControllerDetailsArgs(), options.WithVersion());
    }
