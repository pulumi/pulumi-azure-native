...
namespace Pulumi.AzureRM.DelegatedNetwork.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var controllerDetails = new AzureRM.DelegatedNetwork.Latest.ControllerDetails("controllerDetails", new AzureRM.DelegatedNetwork.Latest.ControllerDetailsArgs
    ///         {
    ///             ControllerType = "Kubernetes",
    ///             KubernetesProperties = 
    ///             {
    ///                 new AzureRM.DelegatedNetwork.Latest.Inputs.KubernetesPropertiesArgs
    ///                 {
    ...
    public partial class ControllerDetails : Pulumi.CustomResource
    {
        ...
        public ControllerDetails(string name, ControllerDetailsArgs args, CustomResourceOptions? options = null)
            : base("azurerm:delegatednetwork/latest:ControllerDetails", name, args ?? new ControllerDetailsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ControllerDetails(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:delegatednetwork/latest:ControllerDetails", name, null, MakeResourceOptions(options, id))
        {
        }
