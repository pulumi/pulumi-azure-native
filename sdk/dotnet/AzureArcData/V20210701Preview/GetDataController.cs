...
namespace Pulumi.AzureNative.AzureArcData.V20210701Preview
{
    public static class GetDataController
    {
        ...
        public static Task<GetDataControllerResult> InvokeAsync(GetDataControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataControllerResult>("azure-native:azurearcdata/v20210701preview:getDataController", args ?? new GetDataControllerArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a dataController resource
        /// </summary>
        public static Output<GetDataControllerResult> Invoke(GetDataControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataControllerResult>("azure-native:azurearcdata/v20210701preview:getDataController", args ?? new GetDataControllerInvokeArgs(), options.WithDefaults());
    }
