...
namespace Pulumi.AzureNative.AzureArcData.V20210701Preview
{
    ...
    /// A Postgres Instance.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20210701preview:PostgresInstance")]
    public partial class PostgresInstance : Pulumi.CustomResource
    {
        ...
        public PostgresInstance(string name, PostgresInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210701preview:PostgresInstance", name, args ?? new PostgresInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostgresInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210701preview:PostgresInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:azurearcdata/v20210701preview:PostgresInstance"},
                    new Pulumi.Alias { Type = "azure-native:azurearcdata:PostgresInstance"},
                    new Pulumi.Alias { Type = "azure-nextgen:azurearcdata:PostgresInstance"},
                    new Pulumi.Alias { Type = "azure-native:azurearcdata/v20210601preview:PostgresInstance"},
                    new Pulumi.Alias { Type = "azure-nextgen:azurearcdata/v20210601preview:PostgresInstance"},
                },
            };
