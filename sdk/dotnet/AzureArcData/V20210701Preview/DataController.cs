...
namespace Pulumi.AzureNative.AzureArcData.V20210701Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:azurearcdata/v20210701preview:DataController is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20220615preview:DataController to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:azurearcdata/v20210701preview:DataController")]
    public partial class DataController : global::Pulumi.CustomResource
    {
        ...
        public DataController(string name, DataControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210701preview:DataController", name, args ?? new DataControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210701preview:DataController", name, null, MakeResourceOptions(options, id))
        {
        }
