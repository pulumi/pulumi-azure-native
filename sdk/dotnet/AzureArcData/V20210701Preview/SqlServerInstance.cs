...
namespace Pulumi.AzureNative.AzureArcData.V20210701Preview
{
    ...
    public partial class SqlServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210701preview:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210701preview:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
