...
namespace Pulumi.AzureNative.AzureArcData.V20210701Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20210701preview:SqlManagedInstance")]
    public partial class SqlManagedInstance : Pulumi.CustomResource
    {
        ...
        public SqlManagedInstance(string name, SqlManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210701preview:SqlManagedInstance", name, args ?? new SqlManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210701preview:SqlManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
