...
namespace Pulumi.AzureNative.AzureArcData.V20210601Preview.Inputs
{
    ...
    public sealed class PostgresInstanceSkuArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("tier")]
        public Input<Pulumi.AzureNative.AzureArcData.V20210601Preview.PostgresInstanceSkuTier>? Tier { get; set; }

        public PostgresInstanceSkuArgs()
        {
            Dev = true;
            Tier = Pulumi.AzureNative.AzureArcData.V20210601Preview.PostgresInstanceSkuTier.Hyperscale;
        }
    }
}
