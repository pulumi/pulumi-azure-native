...
namespace Pulumi.AzureNative.AzureArcData.V20210601Preview.Inputs
{
    ...
    public sealed class SqlManagedInstanceSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("tier")]
        public Input<Pulumi.AzureNative.AzureArcData.V20210601Preview.SqlManagedInstanceSkuTier>? Tier { get; set; }

        public SqlManagedInstanceSkuArgs()
        {
            Dev = true;
            Tier = Pulumi.AzureNative.AzureArcData.V20210601Preview.SqlManagedInstanceSkuTier.GeneralPurpose;
        }
