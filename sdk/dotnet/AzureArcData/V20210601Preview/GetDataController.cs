...
namespace Pulumi.AzureNative.AzureArcData.V20210601Preview
{
    public static class GetDataController
    {
        ...
        public static Task<GetDataControllerResult> InvokeAsync(GetDataControllerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataControllerResult>("azure-native:azurearcdata/v20210601preview:getDataController", args ?? new GetDataControllerArgs(), options.WithVersion());

        /// <summary>
        /// Data controller resource
        /// </summary>
        public static Output<GetDataControllerResult> Invoke(GetDataControllerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataControllerResult>("azure-native:azurearcdata/v20210601preview:getDataController", args ?? new GetDataControllerInvokeArgs(), options.WithVersion());
    }
