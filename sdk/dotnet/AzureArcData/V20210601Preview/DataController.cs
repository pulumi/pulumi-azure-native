...
namespace Pulumi.AzureNative.AzureArcData.V20210601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:azurearcdata/v20210601preview:DataController is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:DataController to guarantee forwards compatibility.")]
    ...
    public partial class DataController : global::Pulumi.CustomResource
    {
        ...
        public DataController(string name, DataControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210601preview:DataController", name, args ?? new DataControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210601preview:DataController", name, null, MakeResourceOptions(options, id))
        {
        }
