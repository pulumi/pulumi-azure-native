...
namespace Pulumi.AzureNative.AzureArcData.V20210601Preview
{
    ...
    /// {
    ///     var postgresInstance = new AzureNative.AzureArcData.V20210601Preview.PostgresInstance("postgresInstance", new()
    ///     {
    ...
    ///         Properties = new AzureNative.AzureArcData.V20210601Preview.Inputs.PostgresInstancePropertiesArgs
    ///         {
    ///             Admin = "admin",
    ...
    ///         Sku = new AzureNative.AzureArcData.V20210601Preview.Inputs.PostgresInstanceSkuArgs
    ///         {
    ///             Dev = true,
    ///             Name = "default",
    ///             Tier = AzureNative.AzureArcData.V20210601Preview.PostgresInstanceSkuTier.Hyperscale,
    ///         },
    ///     });
    /// 
    /// });
    ...
    public partial class PostgresInstance : global::Pulumi.CustomResource
    {
        ...
        public PostgresInstance(string name, PostgresInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210601preview:PostgresInstance", name, args ?? new PostgresInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostgresInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210601preview:PostgresInstance", name, null, MakeResourceOptions(options, id))
        {
        }
