...
namespace Pulumi.AzureNative.AzureArcData.V20210601Preview
{
    public static class GetSqlServerInstance
    {
        ...
        public static Task<GetSqlServerInstanceResult> InvokeAsync(GetSqlServerInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerInstanceResult>("azure-native:azurearcdata/v20210601preview:getSqlServerInstance", args ?? new GetSqlServerInstanceArgs(), options.WithVersion());

        /// <summary>
        /// A SqlServerInstance.
        /// </summary>
        public static Output<GetSqlServerInstanceResult> Invoke(GetSqlServerInstanceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSqlServerInstanceResult>("azure-native:azurearcdata/v20210601preview:getSqlServerInstance", args ?? new GetSqlServerInstanceInvokeArgs(), options.WithVersion());
    }
