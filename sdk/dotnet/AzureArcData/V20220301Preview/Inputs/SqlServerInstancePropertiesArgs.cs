...
namespace Pulumi.AzureNative.AzureArcData.V20220301Preview.Inputs
{
    ...
    public sealed class SqlServerInstancePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20220301Preview.DefenderStatus>? AzureDefenderStatus { get; set; }
        ...
        /// </summary>
        [Input("hostType")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20220301Preview.HostType>? HostType { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20220301Preview.ArcSqlServerLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20220301Preview.ConnectionStatus> Status { get; set; } = null!;
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20220301Preview.SqlVersion>? Version { get; set; }
