...
namespace Pulumi.AzureNative.AzureArcData.V20220301Preview
{
    public static class GetPostgresInstance
    {
        ...
        public static Task<GetPostgresInstanceResult> InvokeAsync(GetPostgresInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPostgresInstanceResult>("azure-native:azurearcdata/v20220301preview:getPostgresInstance", args ?? new GetPostgresInstanceArgs(), options.WithDefaults());

        /// <summary>
        /// A Postgres Instance.
        /// </summary>
        public static Output<GetPostgresInstanceResult> Invoke(GetPostgresInstanceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPostgresInstanceResult>("azure-native:azurearcdata/v20220301preview:getPostgresInstance", args ?? new GetPostgresInstanceInvokeArgs(), options.WithDefaults());
    }
