...
namespace Pulumi.AzureNative.AzureArcData.V20220301Preview
{
    ...
    /// A Postgres Instance.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20220301preview:PostgresInstance")]
    public partial class PostgresInstance : global::Pulumi.CustomResource
    {
        ...
        public PostgresInstance(string name, PostgresInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20220301preview:PostgresInstance", name, args ?? new PostgresInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostgresInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20220301preview:PostgresInstance", name, null, MakeResourceOptions(options, id))
        {
        }
