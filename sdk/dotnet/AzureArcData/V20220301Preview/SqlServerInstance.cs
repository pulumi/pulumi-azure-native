...
namespace Pulumi.AzureNative.AzureArcData.V20220301Preview
{
    ...
    /// A SqlServerInstance.
    /// </summary>
    [Obsolete(@"azure-native:azurearcdata/v20220301preview:SqlServerInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20220615preview:SqlServerInstance to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:azurearcdata/v20220301preview:SqlServerInstance")]
    public partial class SqlServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20220301preview:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20220301preview:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
