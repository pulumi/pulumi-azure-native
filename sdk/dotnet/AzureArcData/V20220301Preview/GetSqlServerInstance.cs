...
namespace Pulumi.AzureNative.AzureArcData.V20220301Preview
{
    public static class GetSqlServerInstance
    {
        ...
        public static Task<GetSqlServerInstanceResult> InvokeAsync(GetSqlServerInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerInstanceResult>("azure-native:azurearcdata/v20220301preview:getSqlServerInstance", args ?? new GetSqlServerInstanceArgs(), options.WithDefaults());

        /// <summary>
        /// A SqlServerInstance.
        /// </summary>
        public static Output<GetSqlServerInstanceResult> Invoke(GetSqlServerInstanceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSqlServerInstanceResult>("azure-native:azurearcdata/v20220301preview:getSqlServerInstance", args ?? new GetSqlServerInstanceInvokeArgs(), options.WithDefaults());
    }
