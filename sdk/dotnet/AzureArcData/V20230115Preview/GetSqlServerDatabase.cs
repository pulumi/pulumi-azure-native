...
namespace Pulumi.AzureNative.AzureArcData.V20230115Preview
{
    public static class GetSqlServerDatabase
    {
        ...
        public static Task<GetSqlServerDatabaseResult> InvokeAsync(GetSqlServerDatabaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerDatabaseResult>("azure-native:azurearcdata/v20230115preview:getSqlServerDatabase", args ?? new GetSqlServerDatabaseArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves an Arc Sql Server database.
        /// </summary>
        public static Output<GetSqlServerDatabaseResult> Invoke(GetSqlServerDatabaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSqlServerDatabaseResult>("azure-native:azurearcdata/v20230115preview:getSqlServerDatabase", args ?? new GetSqlServerDatabaseInvokeArgs(), options.WithDefaults());
    }
