...
namespace Pulumi.AzureNative.AzureArcData.V20230115Preview
{
    ...
    /// {
    ///     var sqlManagedInstance = new AzureNative.AzureArcData.V20230115Preview.SqlManagedInstance("sqlManagedInstance", new()
    ///     {
    ...
    ///         Properties = new AzureNative.AzureArcData.V20230115Preview.Inputs.SqlManagedInstancePropertiesArgs
    ///         {
    ///             ActiveDirectoryInformation = new AzureNative.AzureArcData.V20230115Preview.Inputs.ActiveDirectoryInformationArgs
    ///             {
    ///                 KeytabInformation = new AzureNative.AzureArcData.V20230115Preview.Inputs.KeytabInformationArgs
    ///                 {
    ///                     Keytab = "********",
    ///                 },
    ///             },
    ...
    ///             K8sRaw = new AzureNative.AzureArcData.V20230115Preview.Inputs.SqlManagedInstanceK8sRawArgs
    ///             {
    ///                 Spec = new AzureNative.AzureArcData.V20230115Preview.Inputs.SqlManagedInstanceK8sSpecArgs
    ///                 {
    ///                     Replicas = 1,
    ///                     Scheduling = new AzureNative.AzureArcData.V20230115Preview.Inputs.K8sSchedulingArgs
    ///                     {
    ///                         Default = new AzureNative.AzureArcData.V20230115Preview.Inputs.K8sSchedulingOptionsArgs
    ///                         {
    ///                             Resources = new AzureNative.AzureArcData.V20230115Preview.Inputs.K8sResourceRequirementsArgs
    ///                             {
    ///                                 Limits = 
    ///                                 {
    ...
    ///         Sku = new AzureNative.AzureArcData.V20230115Preview.Inputs.SqlManagedInstanceSkuArgs
    ///         {
    ///             Dev = true,
    ///             Name = AzureNative.AzureArcData.V20230115Preview.SqlManagedInstanceSkuName.VCore,
    ///             Tier = AzureNative.AzureArcData.V20230115Preview.SqlManagedInstanceSkuTier.GeneralPurpose,
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:azurearcdata/v20230115preview:SqlManagedInstance testsqlManagedInstance /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureArcData/sqlManagedInstances/testsqlManagedInstance 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20230115preview:SqlManagedInstance")]
    public partial class SqlManagedInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlManagedInstance(string name, SqlManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230115preview:SqlManagedInstance", name, args ?? new SqlManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230115preview:SqlManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
