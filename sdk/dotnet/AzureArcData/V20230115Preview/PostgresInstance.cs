...
namespace Pulumi.AzureNative.AzureArcData.V20230115Preview
{
    ...
    /// {
    ///     var postgresInstance = new AzureNative.AzureArcData.V20230115Preview.PostgresInstance("postgresInstance", new()
    ///     {
    ///         ExtendedLocation = new AzureNative.AzureArcData.V20230115Preview.Inputs.ExtendedLocationArgs
    ///         {
    ...
    ///         Properties = new AzureNative.AzureArcData.V20230115Preview.Inputs.PostgresInstancePropertiesArgs
    ///         {
    ///             Admin = "admin",
    ///             BasicLoginInformation = new AzureNative.AzureArcData.V20230115Preview.Inputs.BasicLoginInformationArgs
    ///             {
    ///                 Password = "********",
    ///                 Username = "username",
    ///             },
    ...
    ///         Sku = new AzureNative.AzureArcData.V20230115Preview.Inputs.PostgresInstanceSkuArgs
    ///         {
    ///             Dev = true,
    ///             Name = "default",
    ///             Tier = AzureNative.AzureArcData.V20230115Preview.PostgresInstanceSkuTier.Hyperscale,
    ///         },
    ///     });
    /// 
    /// });
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:azurearcdata/v20230115preview:PostgresInstance testpostgresInstance /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureArcData/PostgresInstance/testpostgresInstance 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20230115preview:PostgresInstance")]
    public partial class PostgresInstance : global::Pulumi.CustomResource
    {
        ...
        public PostgresInstance(string name, PostgresInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230115preview:PostgresInstance", name, args ?? new PostgresInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostgresInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230115preview:PostgresInstance", name, null, MakeResourceOptions(options, id))
        {
        }
