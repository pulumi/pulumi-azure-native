...
namespace Pulumi.AzureNative.AzureArcData.V20240101
{
    public static class GetSqlServerAvailabilityGroup
    {
        ...
        public static Task<GetSqlServerAvailabilityGroupResult> InvokeAsync(GetSqlServerAvailabilityGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerAvailabilityGroupResult>("azure-native:azurearcdata/v20240101:getSqlServerAvailabilityGroup", args ?? new GetSqlServerAvailabilityGroupArgs(), options.WithDefaults());
