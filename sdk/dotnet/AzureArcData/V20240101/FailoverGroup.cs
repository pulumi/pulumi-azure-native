...
namespace Pulumi.AzureNative.AzureArcData.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20240101:FailoverGroup")]
    public partial class FailoverGroup : global::Pulumi.CustomResource
    {
        ...
        public FailoverGroup(string name, FailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240101:FailoverGroup", name, args ?? new FailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240101:FailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
