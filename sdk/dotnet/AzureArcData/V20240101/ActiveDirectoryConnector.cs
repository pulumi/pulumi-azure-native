...
namespace Pulumi.AzureNative.AzureArcData.V20240101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20240101:ActiveDirectoryConnector")]
    public partial class ActiveDirectoryConnector : global::Pulumi.CustomResource
    {
        ...
        public ActiveDirectoryConnector(string name, ActiveDirectoryConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240101:ActiveDirectoryConnector", name, args ?? new ActiveDirectoryConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActiveDirectoryConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240101:ActiveDirectoryConnector", name, null, MakeResourceOptions(options, id))
        {
        }
