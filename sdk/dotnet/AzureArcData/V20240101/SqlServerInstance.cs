...
namespace Pulumi.AzureNative.AzureArcData.V20240101
{
    ...
    /// A SqlServerInstance.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20240101:SqlServerInstance")]
    public partial class SqlServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240101:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240101:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
