...
namespace Pulumi.AzureNative.AzureArcData
{
    ...
    public partial class SqlServerDatabase : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SqlServerDatabaseResourcePropertiesResponse> Properties { get; private set; } = null!;
        ...
        public SqlServerDatabase(string name, SqlServerDatabaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata:SqlServerDatabase", name, args ?? new SqlServerDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerDatabase(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata:SqlServerDatabase", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:azurearcdata/v20240501preview:SqlServerDatabase" },
                    new global::Pulumi.Alias { Type = "azure-native_azurearcdata_v20220615preview:azurearcdata:SqlServerDatabase" },
                    new global::Pulumi.Alias { Type = "azure-native_azurearcdata_v20230115preview:azurearcdata:SqlServerDatabase" },
                    new global::Pulumi.Alias { Type = "azure-native_azurearcdata_v20240101:azurearcdata:SqlServerDatabase" },
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SqlServerDatabase Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new SqlServerDatabase(name, id, options);
        }
    }

    public sealed class SqlServerDatabaseArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.SqlServerDatabaseResourcePropertiesArgs> Properties { get; set; } = null!;
        ...
        public SqlServerDatabaseArgs()
        {
        }
        public static new SqlServerDatabaseArgs Empty => new SqlServerDatabaseArgs();
    }
}
