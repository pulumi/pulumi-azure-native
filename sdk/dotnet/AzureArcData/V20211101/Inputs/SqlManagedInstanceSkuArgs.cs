...
namespace Pulumi.AzureNative.AzureArcData.V20211101.Inputs
{
    ...
    public sealed class SqlManagedInstanceSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("tier")]
        public Input<Pulumi.AzureNative.AzureArcData.V20211101.SqlManagedInstanceSkuTier>? Tier { get; set; }

        public SqlManagedInstanceSkuArgs()
        {
            Dev = true;
            Tier = Pulumi.AzureNative.AzureArcData.V20211101.SqlManagedInstanceSkuTier.GeneralPurpose;
        }
