...
namespace Pulumi.AzureNative.AzureArcData.V20211101.Inputs
{
    ...
    public sealed class SqlServerInstancePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20211101.DefenderStatus>? AzureDefenderStatus { get; set; }
        ...
        /// </summary>
        [Input("edition")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20211101.EditionType>? Edition { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20211101.ArcSqlServerLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20211101.ConnectionStatus> Status { get; set; } = null!;
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20211101.SqlVersion>? Version { get; set; }
