...
namespace Pulumi.AzureNative.AzureArcData.V20211101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20211101:SqlManagedInstance")]
    public partial class SqlManagedInstance : Pulumi.CustomResource
    {
        ...
        public SqlManagedInstance(string name, SqlManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20211101:SqlManagedInstance", name, args ?? new SqlManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20211101:SqlManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:azurearcdata/v20211101:SqlManagedInstance"},
                    new Pulumi.Alias { Type = "azure-native:azurearcdata:SqlManagedInstance"},
                    new Pulumi.Alias { Type = "azure-nextgen:azurearcdata:SqlManagedInstance"},
                    new Pulumi.Alias { Type = "azure-native:azurearcdata/v20210601preview:SqlManagedInstance"},
                    new Pulumi.Alias { Type = "azure-nextgen:azurearcdata/v20210601preview:SqlManagedInstance"},
                    new Pulumi.Alias { Type = "azure-native:azurearcdata/v20210701preview:SqlManagedInstance"},
                    new Pulumi.Alias { Type = "azure-nextgen:azurearcdata/v20210701preview:SqlManagedInstance"},
                    new Pulumi.Alias { Type = "azure-native:azurearcdata/v20210801:SqlManagedInstance"},
                    new Pulumi.Alias { Type = "azure-nextgen:azurearcdata/v20210801:SqlManagedInstance"},
                },
            };
