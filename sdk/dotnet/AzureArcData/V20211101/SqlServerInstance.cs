...
namespace Pulumi.AzureNative.AzureArcData.V20211101
{
    ...
    public partial class SqlServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20211101:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20211101:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
