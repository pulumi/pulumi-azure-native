...
namespace Pulumi.AzureNative.AzureArcData.V20211101
{
    public static class GetSqlServerInstance
    {
        ...
        public static Task<GetSqlServerInstanceResult> InvokeAsync(GetSqlServerInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerInstanceResult>("azure-native:azurearcdata/v20211101:getSqlServerInstance", args ?? new GetSqlServerInstanceArgs(), options.WithVersion());

        /// <summary>
        /// A SqlServerInstance.
        /// </summary>
        public static Output<GetSqlServerInstanceResult> Invoke(GetSqlServerInstanceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSqlServerInstanceResult>("azure-native:azurearcdata/v20211101:getSqlServerInstance", args ?? new GetSqlServerInstanceInvokeArgs(), options.WithVersion());
    }
