...
namespace Pulumi.AzureNative.AzureArcData.V20230315Preview.Inputs
{
    ...
    public sealed class PostgresInstanceSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("tier")]
        public Input<Pulumi.AzureNative.AzureArcData.V20230315Preview.PostgresInstanceSkuTier>? Tier { get; set; }

        public PostgresInstanceSkuArgs()
        {
            Dev = true;
            Tier = Pulumi.AzureNative.AzureArcData.V20230315Preview.PostgresInstanceSkuTier.Hyperscale;
        }
