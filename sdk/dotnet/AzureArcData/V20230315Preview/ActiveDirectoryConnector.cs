...
namespace Pulumi.AzureNative.AzureArcData.V20230315Preview
{
    ...
    /// {
    ///     var activeDirectoryConnector = new AzureNative.AzureArcData.V20230315Preview.ActiveDirectoryConnector("activeDirectoryConnector", new()
    ///     {
    ///         ActiveDirectoryConnectorName = "testADConnector",
    ///         DataControllerName = "testdataController",
    ///         Properties = new AzureNative.AzureArcData.V20230315Preview.Inputs.ActiveDirectoryConnectorPropertiesArgs
    ///         {
    ///             Spec = new AzureNative.AzureArcData.V20230315Preview.Inputs.ActiveDirectoryConnectorSpecArgs
    ///             {
    ///                 ActiveDirectory = new AzureNative.AzureArcData.V20230315Preview.Inputs.ActiveDirectoryConnectorDomainDetailsArgs
    ///                 {
    ///                     DomainControllers = new AzureNative.AzureArcData.V20230315Preview.Inputs.ActiveDirectoryDomainControllersArgs
    ///                     {
    ///                         PrimaryDomainController = new AzureNative.AzureArcData.V20230315Preview.Inputs.ActiveDirectoryDomainControllerArgs
    ///                         {
    ///                             Hostname = "dc1.contoso.local",
    ///                         },
    ///                         SecondaryDomainControllers = new[]
    ///                         {
    ///                             new AzureNative.AzureArcData.V20230315Preview.Inputs.ActiveDirectoryDomainControllerArgs
    ///                             {
    ...
    ///                 },
    ///                 Dns = new AzureNative.AzureArcData.V20230315Preview.Inputs.ActiveDirectoryConnectorDNSDetailsArgs
    ///                 {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:azurearcdata/v20230315preview:ActiveDirectoryConnector testADConnector /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureArcData/dataControllers/testdataController/activeDirectoryConnectors/testADConnector 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20230315preview:ActiveDirectoryConnector")]
    public partial class ActiveDirectoryConnector : global::Pulumi.CustomResource
    {
        ...
        public ActiveDirectoryConnector(string name, ActiveDirectoryConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:ActiveDirectoryConnector", name, args ?? new ActiveDirectoryConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ActiveDirectoryConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:ActiveDirectoryConnector", name, null, MakeResourceOptions(options, id))
        {
        }
