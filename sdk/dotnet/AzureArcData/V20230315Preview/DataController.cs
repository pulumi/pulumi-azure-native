...
namespace Pulumi.AzureNative.AzureArcData.V20230315Preview
{
    ...
    /// {
    ///     var dataController = new AzureNative.AzureArcData.V20230315Preview.DataController("dataController", new()
    ///     {
    ...
    ///         Properties = new AzureNative.AzureArcData.V20230315Preview.Inputs.DataControllerPropertiesArgs
    ///         {
    ...
    ///             Infrastructure = AzureNative.AzureArcData.V20230315Preview.Infrastructure.Onpremises,
    ///             LogAnalyticsWorkspaceConfig = new AzureNative.AzureArcData.V20230315Preview.Inputs.LogAnalyticsWorkspaceConfigArgs
    ///             {
    ///                 PrimaryKey = "********",
    ///                 WorkspaceId = "00000000-1111-2222-3333-444444444444",
    ///             },
    ///             LogsDashboardCredential = new AzureNative.AzureArcData.V20230315Preview.Inputs.BasicLoginInformationArgs
    ///             {
    ///                 Password = "********",
    ///                 Username = "username",
    ///             },
    ///             MetricsDashboardCredential = new AzureNative.AzureArcData.V20230315Preview.Inputs.BasicLoginInformationArgs
    ///             {
    ///                 Password = "********",
    ///                 Username = "username",
    ///             },
    ///             OnPremiseProperty = new AzureNative.AzureArcData.V20230315Preview.Inputs.OnPremisePropertyArgs
    ///             {
    ///                 Id = "12345678-1234-1234-ab12-1a2b3c4d5e6f",
    ///                 PublicSigningKey = "publicOnPremSigningKey",
    ///             },
    ///             UploadServicePrincipal = new AzureNative.AzureArcData.V20230315Preview.Inputs.UploadServicePrincipalArgs
    ///             {
    ...
    ///             },
    ///             UploadWatermark = new AzureNative.AzureArcData.V20230315Preview.Inputs.UploadWatermarkArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20230315preview:DataController")]
    public partial class DataController : global::Pulumi.CustomResource
    {
        ...
        public DataController(string name, DataControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:DataController", name, args ?? new DataControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:DataController", name, null, MakeResourceOptions(options, id))
        {
        }
