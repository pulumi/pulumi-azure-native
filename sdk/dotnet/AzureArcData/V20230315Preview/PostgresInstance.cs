...
namespace Pulumi.AzureNative.AzureArcData.V20230315Preview
{
    ...
    /// {
    ///     var postgresInstance = new AzureNative.AzureArcData.V20230315Preview.PostgresInstance("postgresInstance", new()
    ///     {
    ...
    ///         Properties = new AzureNative.AzureArcData.V20230315Preview.Inputs.PostgresInstancePropertiesArgs
    ///         {
    ///             Admin = "admin",
    ...
    ///         Sku = new AzureNative.AzureArcData.V20230315Preview.Inputs.PostgresInstanceSkuArgs
    ///         {
    ///             Dev = true,
    ///             Name = "default",
    ///             Tier = AzureNative.AzureArcData.V20230315Preview.PostgresInstanceSkuTier.Hyperscale,
    ///         },
    ///     });
    /// 
    /// });
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20230315preview:PostgresInstance")]
    public partial class PostgresInstance : global::Pulumi.CustomResource
    {
        ...
        public PostgresInstance(string name, PostgresInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:PostgresInstance", name, args ?? new PostgresInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostgresInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:PostgresInstance", name, null, MakeResourceOptions(options, id))
        {
        }
