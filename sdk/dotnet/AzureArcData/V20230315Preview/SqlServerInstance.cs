...
namespace Pulumi.AzureNative.AzureArcData.V20230315Preview
{
    ...
    /// {
    ///     var sqlServerInstance = new AzureNative.AzureArcData.V20230315Preview.SqlServerInstance("sqlServerInstance", new()
    ///     {
    ///         Location = "northeurope",
    ///         Properties = new AzureNative.AzureArcData.V20230315Preview.Inputs.SqlServerInstancePropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20230315preview:SqlServerInstance")]
    public partial class SqlServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
