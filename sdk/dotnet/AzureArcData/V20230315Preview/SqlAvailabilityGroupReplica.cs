...
namespace Pulumi.AzureNative.AzureArcData.V20230315Preview
{
    ...
    /// {
    ///     var sqlAvailabilityGroupReplica = new AzureNative.AzureArcData.V20230315Preview.SqlAvailabilityGroupReplica("sqlAvailabilityGroupReplica", new()
    ///     {
    ///         Location = "southeastasia",
    ///         Properties = new AzureNative.AzureArcData.V20230315Preview.Inputs.SqlAvailabilityGroupReplicaResourcePropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20230315preview:SqlAvailabilityGroupReplica")]
    public partial class SqlAvailabilityGroupReplica : global::Pulumi.CustomResource
    {
        ...
        public SqlAvailabilityGroupReplica(string name, SqlAvailabilityGroupReplicaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:SqlAvailabilityGroupReplica", name, args ?? new SqlAvailabilityGroupReplicaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlAvailabilityGroupReplica(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20230315preview:SqlAvailabilityGroupReplica", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:azurearcdata:SqlAvailabilityGroupReplica"},
                },
            };
