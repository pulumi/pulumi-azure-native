...
namespace Pulumi.AzureNative.AzureArcData.V20230315Preview
{
    public static class GetSqlServerInstance
    {
        ...
        public static Task<GetSqlServerInstanceResult> InvokeAsync(GetSqlServerInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerInstanceResult>("azure-native:azurearcdata/v20230315preview:getSqlServerInstance", args ?? new GetSqlServerInstanceArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a SQL Server Instance resource
        /// </summary>
        public static Output<GetSqlServerInstanceResult> Invoke(GetSqlServerInstanceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSqlServerInstanceResult>("azure-native:azurearcdata/v20230315preview:getSqlServerInstance", args ?? new GetSqlServerInstanceInvokeArgs(), options.WithDefaults());
    }
