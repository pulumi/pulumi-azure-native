...
namespace Pulumi.AzureNative.AzureArcData.V20240501Preview
{
    public static class GetSqlServerDatabase
    {
        ...
        public static Task<GetSqlServerDatabaseResult> InvokeAsync(GetSqlServerDatabaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerDatabaseResult>("azure-native:azurearcdata/v20240501preview:getSqlServerDatabase", args ?? new GetSqlServerDatabaseArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves an Arc Sql Server database.
        /// </summary>
        public static Output<GetSqlServerDatabaseResult> Invoke(GetSqlServerDatabaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSqlServerDatabaseResult>("azure-native:azurearcdata/v20240501preview:getSqlServerDatabase", args ?? new GetSqlServerDatabaseInvokeArgs(), options.WithDefaults());
    }
