...
namespace Pulumi.AzureNative.AzureArcData.V20240501Preview
{
    ...
    /// A Postgres Instance.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20240501preview:PostgresInstance")]
    public partial class PostgresInstance : global::Pulumi.CustomResource
    {
        ...
        public PostgresInstance(string name, PostgresInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240501preview:PostgresInstance", name, args ?? new PostgresInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostgresInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240501preview:PostgresInstance", name, null, MakeResourceOptions(options, id))
        {
        }
