...
namespace Pulumi.AzureNative.AzureArcData.V20240501Preview
{
    public static class GetSqlServerInstanceTelemetry
    {
        ...
        public static Task<GetSqlServerInstanceTelemetryResult> InvokeAsync(GetSqlServerInstanceTelemetryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerInstanceTelemetryResult>("azure-native:azurearcdata/v20240501preview:getSqlServerInstanceTelemetry", args ?? new GetSqlServerInstanceTelemetryArgs(), options.WithDefaults());
    ...
    public sealed class GetSqlServerInstanceTelemetryArgs : global::Pulumi.InvokeArgs
    {
        ...
        public Union<string, Pulumi.AzureNative.AzureArcData.V20240501Preview.AggregationType>? AggregationType { get; set; }
    ...
    public sealed class GetSqlServerInstanceTelemetryInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("aggregationType")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20240501Preview.AggregationType>? AggregationType { get; set; }
