...
namespace Pulumi.AzureNative.AzureArcData.V20240501Preview
{
    public static class GetDataController
    {
        ...
        public static Task<GetDataControllerResult> InvokeAsync(GetDataControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataControllerResult>("azure-native:azurearcdata/v20240501preview:getDataController", args ?? new GetDataControllerArgs(), options.WithDefaults());
