...
namespace Pulumi.AzureNative.AzureArcData.V20240501Preview
{
    public static class GetSqlManagedInstance
    {
        ...
        public static Task<GetSqlManagedInstanceResult> InvokeAsync(GetSqlManagedInstanceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlManagedInstanceResult>("azure-native:azurearcdata/v20240501preview:getSqlManagedInstance", args ?? new GetSqlManagedInstanceArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a SQL Managed Instance resource
        /// </summary>
        public static Output<GetSqlManagedInstanceResult> Invoke(GetSqlManagedInstanceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSqlManagedInstanceResult>("azure-native:azurearcdata/v20240501preview:getSqlManagedInstance", args ?? new GetSqlManagedInstanceInvokeArgs(), options.WithDefaults());
