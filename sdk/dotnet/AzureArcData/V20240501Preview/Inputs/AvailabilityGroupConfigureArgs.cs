...
namespace Pulumi.AzureNative.AzureArcData.V20240501Preview.Inputs
{
    ...
    public sealed class AvailabilityGroupConfigureArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20240501Preview.ArcSqlServerAvailabilityMode>? AvailabilityMode { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20240501Preview.ConnectionAuth>? EndpointAuthenticationMode { get; set; }
        ...
        /// </summary>
        [Input("failoverMode")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20240501Preview.ArcSqlServerFailoverMode>? FailoverMode { get; set; }
        ...
        public Input<Pulumi.AzureNative.AzureArcData.V20240501Preview.PrimaryAllowConnections>? PrimaryAllowConnections { get; set; }
        ...
        public Input<Pulumi.AzureNative.AzureArcData.V20240501Preview.SecondaryAllowConnections>? SecondaryAllowConnections { get; set; }
        ...
        /// </summary>
        [Input("seedingMode")]
        public Input<Pulumi.AzureNative.AzureArcData.V20240501Preview.SeedingMode>? SeedingMode { get; set; }
