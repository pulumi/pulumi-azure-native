...
namespace Pulumi.AzureNative.AzureArcData.V20240501Preview.Inputs
{
    ...
    public sealed class PostgresInstanceSkuArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("tier")]
        public Input<Pulumi.AzureNative.AzureArcData.V20240501Preview.PostgresInstanceSkuTier>? Tier { get; set; }

        public PostgresInstanceSkuArgs()
        {
            Dev = true;
            Tier = Pulumi.AzureNative.AzureArcData.V20240501Preview.PostgresInstanceSkuTier.Hyperscale;
        }
