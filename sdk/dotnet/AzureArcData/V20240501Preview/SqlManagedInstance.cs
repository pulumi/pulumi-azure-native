...
namespace Pulumi.AzureNative.AzureArcData.V20240501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20240501preview:SqlManagedInstance")]
    public partial class SqlManagedInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlManagedInstance(string name, SqlManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240501preview:SqlManagedInstance", name, args ?? new SqlManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20240501preview:SqlManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
