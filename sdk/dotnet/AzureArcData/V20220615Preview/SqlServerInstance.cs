...
namespace Pulumi.AzureNative.AzureArcData.V20220615Preview
{
    ...
    /// {
    ///     var sqlServerInstance = new AzureNative.AzureArcData.V20220615Preview.SqlServerInstance("sqlServerInstance", new()
    ///     {
    ///         Location = "northeurope",
    ///         Properties = new AzureNative.AzureArcData.V20220615Preview.Inputs.SqlServerInstancePropertiesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20220615preview:SqlServerInstance")]
    public partial class SqlServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20220615preview:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20220615preview:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
