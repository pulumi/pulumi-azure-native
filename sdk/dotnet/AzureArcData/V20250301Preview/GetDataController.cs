...
namespace Pulumi.AzureNative.AzureArcData.V20250301Preview
{
    public static class GetDataController
    {
        ...
        public static Task<GetDataControllerResult> InvokeAsync(GetDataControllerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataControllerResult>("azure-native:azurearcdata/v20250301preview:getDataController", args ?? new GetDataControllerArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves a dataController resource
        /// </summary>
        public static Output<GetDataControllerResult> Invoke(GetDataControllerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataControllerResult>("azure-native:azurearcdata/v20250301preview:getDataController", args ?? new GetDataControllerInvokeArgs(), options.WithDefaults());
