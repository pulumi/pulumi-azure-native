...
namespace Pulumi.AzureNative.AzureArcData.V20250301Preview
{
    public static class GetSqlServerInstanceTelemetry
    {
        ...
        public static Task<GetSqlServerInstanceTelemetryResult> InvokeAsync(GetSqlServerInstanceTelemetryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSqlServerInstanceTelemetryResult>("azure-native:azurearcdata/v20250301preview:getSqlServerInstanceTelemetry", args ?? new GetSqlServerInstanceTelemetryArgs(), options.WithDefaults());
        ...
        public static Output<GetSqlServerInstanceTelemetryResult> Invoke(GetSqlServerInstanceTelemetryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSqlServerInstanceTelemetryResult>("azure-native:azurearcdata/v20250301preview:getSqlServerInstanceTelemetry", args ?? new GetSqlServerInstanceTelemetryInvokeArgs(), options.WithDefaults());
    ...
    public sealed class GetSqlServerInstanceTelemetryArgs : global::Pulumi.InvokeArgs
    {
        ...
        public Union<string, Pulumi.AzureNative.AzureArcData.V20250301Preview.AggregationType>? AggregationType { get; set; }
    ...
    public sealed class GetSqlServerInstanceTelemetryInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("aggregationType")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20250301Preview.AggregationType>? AggregationType { get; set; }
