...
namespace Pulumi.AzureNative.AzureArcData.V20250301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20250301preview:FailoverGroup")]
    public partial class FailoverGroup : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FailoverGroupPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public FailoverGroup(string name, FailoverGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20250301preview:FailoverGroup", name, args ?? new FailoverGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FailoverGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20250301preview:FailoverGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FailoverGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.FailoverGroupPropertiesArgs> Properties { get; set; } = null!;
