...
namespace Pulumi.AzureNative.AzureArcData.V20250301Preview
{
    ...
    /// A Postgres Instance.
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20250301preview:PostgresInstance")]
    public partial class PostgresInstance : global::Pulumi.CustomResource
    {
        ...
        public PostgresInstance(string name, PostgresInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20250301preview:PostgresInstance", name, args ?? new PostgresInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PostgresInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20250301preview:PostgresInstance", name, null, MakeResourceOptions(options, id))
        {
        }
