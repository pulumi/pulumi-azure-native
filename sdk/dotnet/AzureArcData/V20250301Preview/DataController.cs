...
namespace Pulumi.AzureNative.AzureArcData.V20250301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:azurearcdata/v20250301preview:DataController")]
    public partial class DataController : global::Pulumi.CustomResource
    {
        ...
        public DataController(string name, DataControllerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20250301preview:DataController", name, args ?? new DataControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataController(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20250301preview:DataController", name, null, MakeResourceOptions(options, id))
        {
        }
