...
namespace Pulumi.AzureNative.AzureArcData.V20210801.Inputs
{
    ...
    public sealed class SqlServerInstancePropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20210801.DefenderStatus>? AzureDefenderStatus { get; set; }
        ...
        /// </summary>
        [Input("edition")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20210801.EditionType>? Edition { get; set; }
        ...
        /// </summary>
        [Input("licenseType")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20210801.ArcSqlServerLicenseType>? LicenseType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20210801.ConnectionStatus> Status { get; set; } = null!;
        ...
        /// </summary>
        [Input("version")]
        public InputUnion<string, Pulumi.AzureNative.AzureArcData.V20210801.SqlVersion>? Version { get; set; }
