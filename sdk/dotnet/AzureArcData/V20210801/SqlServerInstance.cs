...
namespace Pulumi.AzureNative.AzureArcData.V20210801
{
    ...
    /// A SqlServerInstance.
    /// </summary>
    [Obsolete(@"azure-native:azurearcdata/v20210801:SqlServerInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20220615preview:SqlServerInstance to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:azurearcdata/v20210801:SqlServerInstance")]
    public partial class SqlServerInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlServerInstance(string name, SqlServerInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210801:SqlServerInstance", name, args ?? new SqlServerInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlServerInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210801:SqlServerInstance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlServerInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.SqlServerInstancePropertiesArgs>? Properties { get; set; }
