...
namespace Pulumi.AzureNative.AzureArcData.V20210801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:azurearcdata/v20210801:SqlManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20220615preview:SqlManagedInstance to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:azurearcdata/v20210801:SqlManagedInstance")]
    public partial class SqlManagedInstance : global::Pulumi.CustomResource
    {
        ...
        public SqlManagedInstance(string name, SqlManagedInstanceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210801:SqlManagedInstance", name, args ?? new SqlManagedInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlManagedInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:azurearcdata/v20210801:SqlManagedInstance", name, null, MakeResourceOptions(options, id))
        {
        }
