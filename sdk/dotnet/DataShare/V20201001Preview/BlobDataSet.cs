...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20201001preview:BlobDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobDataSet to guarantee forwards compatibility.")]
    ...
    public partial class BlobDataSet : global::Pulumi.CustomResource
    {
        ...
        public BlobDataSet(string name, BlobDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:BlobDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:BlobDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
