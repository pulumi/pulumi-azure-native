...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    public static class GetADLSGen2FileSystemDataSet
    {
        ...
        public static Task<GetADLSGen2FileSystemDataSetResult> InvokeAsync(GetADLSGen2FileSystemDataSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetADLSGen2FileSystemDataSetResult>("azure-native:datashare/v20201001preview:getADLSGen2FileSystemDataSet", args ?? new GetADLSGen2FileSystemDataSetArgs(), options.WithDefaults());
        ...
        public static Output<GetADLSGen2FileSystemDataSetResult> Invoke(GetADLSGen2FileSystemDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetADLSGen2FileSystemDataSetResult>("azure-native:datashare/v20201001preview:getADLSGen2FileSystemDataSet", args ?? new GetADLSGen2FileSystemDataSetInvokeArgs(), options.WithDefaults());
    }
