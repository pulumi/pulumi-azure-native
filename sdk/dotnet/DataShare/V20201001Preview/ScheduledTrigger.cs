...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// {
    ///     var scheduledTrigger = new AzureNative.DataShare.V20201001Preview.ScheduledTrigger("scheduledTrigger", new()
    ///     {
    ...
    public partial class ScheduledTrigger : global::Pulumi.CustomResource
    {
        ...
        public ScheduledTrigger(string name, ScheduledTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ScheduledTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ScheduledTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
