...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    public static class GetKustoDatabaseDataSet
    {
        ...
        public static Task<GetKustoDatabaseDataSetResult> InvokeAsync(GetKustoDatabaseDataSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKustoDatabaseDataSetResult>("azure-native:datashare/v20201001preview:getKustoDatabaseDataSet", args ?? new GetKustoDatabaseDataSetArgs(), options.WithVersion());
        ...
        public static Output<GetKustoDatabaseDataSetResult> Invoke(GetKustoDatabaseDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKustoDatabaseDataSetResult>("azure-native:datashare/v20201001preview:getKustoDatabaseDataSet", args ?? new GetKustoDatabaseDataSetInvokeArgs(), options.WithVersion());
    }
