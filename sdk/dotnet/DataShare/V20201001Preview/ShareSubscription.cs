...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20201001preview:ShareSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ShareSubscription to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datashare/v20201001preview:ShareSubscription")]
    public partial class ShareSubscription : global::Pulumi.CustomResource
    {
        ...
        public ShareSubscription(string name, ShareSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ShareSubscription", name, args ?? new ShareSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ShareSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ShareSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
