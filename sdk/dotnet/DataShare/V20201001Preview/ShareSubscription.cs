...
namespace Pulumi.AzureNextGen.DataShare.V20201001Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datashare/v20201001preview:ShareSubscription")]
    public partial class ShareSubscription : Pulumi.CustomResource
    {
        ...
        public ShareSubscription(string name, ShareSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20201001preview:ShareSubscription", name, args ?? new ShareSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ShareSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20201001preview:ShareSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
