...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    public static class GetBlobContainerDataSetMapping
    {
        ...
        public static Output<GetBlobContainerDataSetMappingResult> Invoke(GetBlobContainerDataSetMappingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBlobContainerDataSetMappingResult>("azure-native:datashare/v20201001preview:getBlobContainerDataSetMapping", args ?? new GetBlobContainerDataSetMappingInvokeArgs(), options.WithVersion());
    }
