...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// {
    ///     var blobFolderDataSetMapping = new AzureNative.DataShare.V20201001Preview.BlobFolderDataSetMapping("blobFolderDataSetMapping", new()
    ///     {
