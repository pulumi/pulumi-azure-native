...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// {
    ///     var kustoDatabaseDataSetMapping = new AzureNative.DataShare.V20201001Preview.KustoDatabaseDataSetMapping("kustoDatabaseDataSetMapping", new()
    ///     {
    ...
    public partial class KustoDatabaseDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public KustoDatabaseDataSetMapping(string name, KustoDatabaseDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:KustoDatabaseDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoDatabaseDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:KustoDatabaseDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
