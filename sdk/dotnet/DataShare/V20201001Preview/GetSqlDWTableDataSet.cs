...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    public static class GetSqlDWTableDataSet
    {
        ...
        public static Task<GetSqlDWTableDataSetResult> InvokeAsync(GetSqlDWTableDataSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSqlDWTableDataSetResult>("azure-native:datashare/v20201001preview:getSqlDWTableDataSet", args ?? new GetSqlDWTableDataSetArgs(), options.WithVersion());

        /// <summary>
        /// A SQL DW table data set.
        /// </summary>
        public static Output<GetSqlDWTableDataSetResult> Invoke(GetSqlDWTableDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSqlDWTableDataSetResult>("azure-native:datashare/v20201001preview:getSqlDWTableDataSet", args ?? new GetSqlDWTableDataSetInvokeArgs(), options.WithVersion());
    }
