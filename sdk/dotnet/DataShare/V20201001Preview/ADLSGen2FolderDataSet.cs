...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// {
    ///     var adlsGen2FolderDataSet = new AzureNative.DataShare.V20201001Preview.ADLSGen2FolderDataSet("adlsGen2FolderDataSet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20201001preview:ADLSGen2FolderDataSet")]
    public partial class ADLSGen2FolderDataSet : global::Pulumi.CustomResource
    {
        ...
        public ADLSGen2FolderDataSet(string name, ADLSGen2FolderDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ADLSGen2FolderDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ADLSGen2FolderDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ADLSGen2FolderDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
