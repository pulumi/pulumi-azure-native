...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// {
    ///     var sqlDBTableDataSetMapping = new AzureNative.DataShare.V20201001Preview.SqlDBTableDataSetMapping("sqlDBTableDataSetMapping", new()
    ///     {
