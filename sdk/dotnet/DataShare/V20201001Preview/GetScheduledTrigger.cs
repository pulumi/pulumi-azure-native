...
{
    [Obsolete(@"azure-native:datashare/v20201001preview:ScheduledTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ScheduledTrigger to guarantee forwards compatibility.")]
    public static class GetScheduledTrigger
    {
        ...
        public static Task<GetScheduledTriggerResult> InvokeAsync(GetScheduledTriggerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScheduledTriggerResult>("azure-native:datashare/v20201001preview:getScheduledTrigger", args ?? new GetScheduledTriggerArgs(), options.WithDefaults());

        /// <summary>
        /// Get a Trigger in a shareSubscription
        /// </summary>
        public static Output<GetScheduledTriggerResult> Invoke(GetScheduledTriggerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScheduledTriggerResult>("azure-native:datashare/v20201001preview:getScheduledTrigger", args ?? new GetScheduledTriggerInvokeArgs(), options.WithDefaults());
    }
