...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    public static class GetScheduledTrigger
    {
        ...
        public static Task<GetScheduledTriggerResult> InvokeAsync(GetScheduledTriggerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScheduledTriggerResult>("azure-native:datashare/v20201001preview:getScheduledTrigger", args ?? new GetScheduledTriggerArgs(), options.WithVersion());

        /// <summary>
        /// A type of trigger based on schedule
        /// </summary>
        public static Output<GetScheduledTriggerResult> Invoke(GetScheduledTriggerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetScheduledTriggerResult>("azure-native:datashare/v20201001preview:getScheduledTrigger", args ?? new GetScheduledTriggerInvokeArgs(), options.WithVersion());
    }
