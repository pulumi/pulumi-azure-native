...
namespace Pulumi.AzureNextGen.DataShare.V20201001Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datashare/v20201001preview:Invitation")]
    public partial class Invitation : Pulumi.CustomResource
    {
        ...
        public Invitation(string name, InvitationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20201001preview:Invitation", name, args ?? new InvitationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Invitation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20201001preview:Invitation", name, null, MakeResourceOptions(options, id))
        {
        }
