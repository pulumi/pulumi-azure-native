...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    [AzureNativeResourceType("azure-native:datashare/v20201001preview:ScheduledSynchronizationSetting")]
    public partial class ScheduledSynchronizationSetting : global::Pulumi.CustomResource
    {
        ...
        public ScheduledSynchronizationSetting(string name, ScheduledSynchronizationSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ScheduledSynchronizationSetting", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledSynchronizationSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ScheduledSynchronizationSetting", name, null, MakeResourceOptions(options, id))
        {
        }
