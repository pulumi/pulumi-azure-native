...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    public static class GetSqlDBTableDataSetMapping
    {
        ...
        public static Output<GetSqlDBTableDataSetMappingResult> Invoke(GetSqlDBTableDataSetMappingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSqlDBTableDataSetMappingResult>("azure-native:datashare/v20201001preview:getSqlDBTableDataSetMapping", args ?? new GetSqlDBTableDataSetMappingInvokeArgs(), options.WithVersion());
    }
