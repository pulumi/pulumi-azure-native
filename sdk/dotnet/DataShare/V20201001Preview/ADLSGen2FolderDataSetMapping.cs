...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// {
    ///     var adlsGen2FolderDataSetMapping = new AzureNative.DataShare.V20201001Preview.ADLSGen2FolderDataSetMapping("adlsGen2FolderDataSetMapping", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20201001preview:ADLSGen2FolderDataSetMapping")]
    public partial class ADLSGen2FolderDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public ADLSGen2FolderDataSetMapping(string name, ADLSGen2FolderDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ADLSGen2FolderDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ADLSGen2FolderDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:ADLSGen2FolderDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
