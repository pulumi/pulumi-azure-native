...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// {
    ///     var synapseWorkspaceSqlPoolTableDataSetMapping = new AzureNative.DataShare.V20201001Preview.SynapseWorkspaceSqlPoolTableDataSetMapping("synapseWorkspaceSqlPoolTableDataSetMapping", new()
    ///     {
    ...
    public partial class SynapseWorkspaceSqlPoolTableDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public SynapseWorkspaceSqlPoolTableDataSetMapping(string name, SynapseWorkspaceSqlPoolTableDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SynapseWorkspaceSqlPoolTableDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
