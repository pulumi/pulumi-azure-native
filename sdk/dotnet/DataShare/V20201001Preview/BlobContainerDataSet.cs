...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    public partial class BlobContainerDataSet : Pulumi.CustomResource
    {
        ...
        public BlobContainerDataSet(string name, BlobContainerDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:BlobContainerDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:BlobContainerDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
