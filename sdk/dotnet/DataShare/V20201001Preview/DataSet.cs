...
namespace Pulumi.AzureNextGen.DataShare.V20201001Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datashare/v20201001preview:DataSet")]
    public partial class DataSet : Pulumi.CustomResource
    {
        ...
        public DataSet(string name, DataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20201001preview:DataSet", name, args ?? new DataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20201001preview:DataSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataSetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.DataShare.V20201001Preview.DataSetKind> Kind { get; set; } = null!;
