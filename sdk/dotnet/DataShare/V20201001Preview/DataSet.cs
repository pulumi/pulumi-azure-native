...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// </summary>
    [Obsolete(@"Please use one of the variants: ADLSGen1FileDataSet, ADLSGen1FolderDataSet, ADLSGen2FileDataSet, ADLSGen2FileSystemDataSet, ADLSGen2FolderDataSet, ADLSGen2StorageAccountDataSet, BlobContainerDataSet, BlobDataSet, BlobFolderDataSet, BlobStorageAccountDataSet, KustoClusterDataSet, KustoDatabaseDataSet, SqlDBTableDataSet, SqlDWTableDataSet, SynapseWorkspaceSqlPoolTableDataSet.")]
    [AzureNativeResourceType("azure-native:datashare/v20201001preview:DataSet")]
    public partial class DataSet : Pulumi.CustomResource
    {
        ...
        public DataSet(string name, DataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:DataSet", name, args ?? new DataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:DataSet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:datashare/v20210801:DataSet"},
                },
            };
    ...
    public sealed class DataSetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20201001Preview.DataSetKind> Kind { get; set; } = null!;
