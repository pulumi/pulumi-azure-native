...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    [AzureNativeResourceType("azure-native:datashare/v20201001preview:BlobDataSetMapping")]
    public partial class BlobDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public BlobDataSetMapping(string name, BlobDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:BlobDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:BlobDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
