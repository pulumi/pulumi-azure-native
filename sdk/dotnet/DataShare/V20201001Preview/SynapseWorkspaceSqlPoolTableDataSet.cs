...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// {
    ///     var synapseWorkspaceSqlPoolTableDataSet = new AzureNative.DataShare.V20201001Preview.SynapseWorkspaceSqlPoolTableDataSet("synapseWorkspaceSqlPoolTableDataSet", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSet dataset1 /subscriptions/0f3dcfc3-18f8-4099-b381-8353e19d43a7/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/sourceAccount/shares/share1/dataSets/dataset1 
    /// ```
    /// </summary>
    ...
    public partial class SynapseWorkspaceSqlPoolTableDataSet : global::Pulumi.CustomResource
    {
        ...
        public SynapseWorkspaceSqlPoolTableDataSet(string name, SynapseWorkspaceSqlPoolTableDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SynapseWorkspaceSqlPoolTableDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSet", name, null, MakeResourceOptions(options, id))
        {
        }

        private static SynapseWorkspaceSqlPoolTableDataSetArgs MakeArgs(SynapseWorkspaceSqlPoolTableDataSetArgs args)
        {
            args ??= new SynapseWorkspaceSqlPoolTableDataSetArgs();
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SynapseWorkspaceSqlPoolTableDataSet Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
