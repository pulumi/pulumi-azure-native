...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    /// {
    ///     var kustoDatabaseDataSet = new AzureNative.DataShare.V20201001Preview.KustoDatabaseDataSet("kustoDatabaseDataSet", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datashare/v20201001preview:KustoDatabaseDataSet dataset1 /subscriptions/0f3dcfc3-18f8-4099-b381-8353e19d43a7/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/sourceAccount/shares/share1/dataSets/dataset1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20201001preview:KustoDatabaseDataSet")]
    public partial class KustoDatabaseDataSet : global::Pulumi.CustomResource
    {
        ...
        public KustoDatabaseDataSet(string name, KustoDatabaseDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:KustoDatabaseDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoDatabaseDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:KustoDatabaseDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
