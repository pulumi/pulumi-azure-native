...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20181101preview:BlobDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobDataSetMapping to guarantee forwards compatibility.")]
    ...
    public partial class BlobDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public BlobDataSetMapping(string name, BlobDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:BlobDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:BlobDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
