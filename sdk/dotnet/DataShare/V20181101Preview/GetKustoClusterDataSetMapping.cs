...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    public static class GetKustoClusterDataSetMapping
    {
        ...
        public static Output<GetKustoClusterDataSetMappingResult> Invoke(GetKustoClusterDataSetMappingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKustoClusterDataSetMappingResult>("azure-native:datashare/v20181101preview:getKustoClusterDataSetMapping", args ?? new GetKustoClusterDataSetMappingInvokeArgs(), options.WithVersion());
    }
