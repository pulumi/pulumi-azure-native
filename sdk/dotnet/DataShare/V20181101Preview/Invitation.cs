...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    public partial class Invitation : global::Pulumi.CustomResource
    {
        ...
        public Invitation(string name, InvitationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:Invitation", name, args ?? new InvitationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Invitation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:Invitation", name, null, MakeResourceOptions(options, id))
        {
        }
