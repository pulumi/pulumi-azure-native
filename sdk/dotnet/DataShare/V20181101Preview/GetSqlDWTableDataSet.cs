...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    public static class GetSqlDWTableDataSet
    {
        ...
        public static Output<GetSqlDWTableDataSetResult> Invoke(GetSqlDWTableDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSqlDWTableDataSetResult>("azure-native:datashare/v20181101preview:getSqlDWTableDataSet", args ?? new GetSqlDWTableDataSetInvokeArgs(), options.WithVersion());
    }
