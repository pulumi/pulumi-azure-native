...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    /// {
    ///     var kustoDatabaseDataSet = new AzureNative.DataShare.V20181101Preview.KustoDatabaseDataSet("kustoDatabaseDataSet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20181101preview:KustoDatabaseDataSet")]
    public partial class KustoDatabaseDataSet : global::Pulumi.CustomResource
    {
        ...
        public KustoDatabaseDataSet(string name, KustoDatabaseDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:KustoDatabaseDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoDatabaseDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:KustoDatabaseDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
