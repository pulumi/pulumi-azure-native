...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    public partial class DataSet : Pulumi.CustomResource
    {
        ...
        public DataSet(string name, DataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:DataSet", name, args ?? new DataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:DataSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataSetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20181101Preview.DataSetKind> Kind { get; set; } = null!;
