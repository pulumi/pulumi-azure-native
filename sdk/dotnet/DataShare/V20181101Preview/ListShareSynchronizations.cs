...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    public static class ListShareSynchronizations
    {
        ...
        public static Task<ListShareSynchronizationsResult> InvokeAsync(ListShareSynchronizationsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListShareSynchronizationsResult>("azure-native:datashare/v20181101preview:listShareSynchronizations", args ?? new ListShareSynchronizationsArgs(), options.WithVersion());
        ...
        public static Output<ListShareSynchronizationsResult> Invoke(ListShareSynchronizationsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListShareSynchronizationsResult>("azure-native:datashare/v20181101preview:listShareSynchronizations", args ?? new ListShareSynchronizationsInvokeArgs(), options.WithVersion());
    }
