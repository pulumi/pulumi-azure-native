...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20181101preview:ADLSGen2FileDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datashare/v20181101preview:ADLSGen2FileDataSetMapping")]
    public partial class ADLSGen2FileDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public ADLSGen2FileDataSetMapping(string name, ADLSGen2FileDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:ADLSGen2FileDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ADLSGen2FileDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:ADLSGen2FileDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
