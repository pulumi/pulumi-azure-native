...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSetMapping to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping")]
    public partial class SqlDBTableDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public SqlDBTableDataSetMapping(string name, SqlDBTableDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SqlDBTableDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
