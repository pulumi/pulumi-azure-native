...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    /// {
    ///     var scheduledTrigger = new AzureNative.DataShare.V20181101Preview.ScheduledTrigger("scheduledTrigger", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datashare/v20181101preview:ScheduledTrigger Trigger1 /subscriptions/433a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/Account1/shareSubscriptions/ShareSubscription1/triggers/Trigger1 
    /// ```
    /// </summary>
