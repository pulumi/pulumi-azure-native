...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20181101preview:SqlDBTableDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSet to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datashare/v20181101preview:SqlDBTableDataSet")]
    public partial class SqlDBTableDataSet : global::Pulumi.CustomResource
    {
        ...
        public SqlDBTableDataSet(string name, SqlDBTableDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:SqlDBTableDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SqlDBTableDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:SqlDBTableDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
