...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    /// {
    ///     var blobDataSet = new AzureNative.DataShare.V20181101Preview.BlobDataSet("blobDataSet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20181101preview:BlobDataSet")]
    public partial class BlobDataSet : global::Pulumi.CustomResource
    {
        ...
        public BlobDataSet(string name, BlobDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:BlobDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20181101preview:BlobDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
