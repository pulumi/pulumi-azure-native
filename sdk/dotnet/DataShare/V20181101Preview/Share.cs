...
namespace Pulumi.AzureNextGen.DataShare.V20181101Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datashare/v20181101preview:Share")]
    public partial class Share : Pulumi.CustomResource
    {
        ...
        public Share(string name, ShareArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20181101preview:Share", name, args ?? new ShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Share(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20181101preview:Share", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ShareArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("shareKind")]
        public InputUnion<string, Pulumi.AzureNextGen.DataShare.V20181101Preview.ShareKind>? ShareKind { get; set; }
