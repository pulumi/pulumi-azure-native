...
namespace Pulumi.AzureRM.DataShare.V20181101Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var share = new AzureRM.DataShare.V20181101Preview.Share("share", new AzureRM.DataShare.V20181101Preview.ShareArgs
    ///         {
    ...
    public partial class Share : Pulumi.CustomResource
    {
        ...
        public Share(string name, ShareArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datashare/v20181101preview:Share", name, args ?? new ShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Share(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datashare/v20181101preview:Share", name, null, MakeResourceOptions(options, id))
        {
        }
