...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    ...
    public static class GetShareSubscription
    {
        ...
        public static Task<GetShareSubscriptionResult> InvokeAsync(GetShareSubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetShareSubscriptionResult>("azure-native:datashare/v20181101preview:getShareSubscription", args ?? new GetShareSubscriptionArgs(), options.WithDefaults());

        /// <summary>
        /// Get a shareSubscription in an account
        /// </summary>
        public static Output<GetShareSubscriptionResult> Invoke(GetShareSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetShareSubscriptionResult>("azure-native:datashare/v20181101preview:getShareSubscription", args ?? new GetShareSubscriptionInvokeArgs(), options.WithDefaults());
    }
