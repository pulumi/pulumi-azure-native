...
namespace Pulumi.AzureRM.DataShare.V20181101Preview
{
    public static class GetShareSubscription
    {
        public static Task<GetShareSubscriptionResult> InvokeAsync(GetShareSubscriptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetShareSubscriptionResult>("azurerm:datashare/v20181101preview:getShareSubscription", args ?? new GetShareSubscriptionArgs(), options.WithVersion());
    }
