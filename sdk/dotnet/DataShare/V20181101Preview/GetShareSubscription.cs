...
namespace Pulumi.AzureNative.DataShare.V20181101Preview
{
    public static class GetShareSubscription
    {
        ...
        public static Output<GetShareSubscriptionResult> Invoke(GetShareSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetShareSubscriptionResult>("azure-native:datashare/v20181101preview:getShareSubscription", args ?? new GetShareSubscriptionInvokeArgs(), options.WithVersion());
    }
