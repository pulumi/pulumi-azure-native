...
namespace Pulumi.AzureRM.DataShare.Preview
{
    public static class GetDataSetMapping
    {
        public static Task<GetDataSetMappingResult> InvokeAsync(GetDataSetMappingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataSetMappingResult>("azurerm:datashare/preview:getDataSetMapping", args ?? new GetDataSetMappingArgs(), options.WithVersion());
    }
