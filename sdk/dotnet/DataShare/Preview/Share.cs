...
namespace Pulumi.AzureRM.DataShare.Preview
{
    ...
    public partial class Share : Pulumi.CustomResource
    {
        ...
        public Share(string name, ShareArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datashare/preview:Share", name, args ?? new ShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Share(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datashare/preview:Share", name, null, MakeResourceOptions(options, id))
        {
        }
