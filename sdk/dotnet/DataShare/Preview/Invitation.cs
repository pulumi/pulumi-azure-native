...
namespace Pulumi.AzureRM.DataShare.Preview
{
    ...
    public partial class Invitation : Pulumi.CustomResource
    {
        ...
        public Invitation(string name, InvitationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datashare/preview:Invitation", name, args ?? new InvitationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Invitation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datashare/preview:Invitation", name, null, MakeResourceOptions(options, id))
        {
        }
