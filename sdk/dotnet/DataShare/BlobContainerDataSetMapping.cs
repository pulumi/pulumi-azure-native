...
namespace Pulumi.AzureNative.DataShare
{
    ...
    public partial class BlobContainerDataSetMapping : Pulumi.CustomResource
    {
        /// <summary>
        /// BLOB Container name.
        /// </summary>
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:datashare:BlobContainerDataSetMapping"},
                    new Pulumi.Alias { Type = "azure-native:datashare/v20181101preview:BlobContainerDataSetMapping"},
                    new Pulumi.Alias { Type = "azure-nextgen:datashare/v20181101preview:BlobContainerDataSetMapping"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:datashare/v20201001preview:BlobContainerDataSetMapping"},
                },
            };
    ...
    public sealed class BlobContainerDataSetMappingArgs : Pulumi.ResourceArgs
    {
        /// <summary>
