...
namespace Pulumi.AzureNative.DataShare
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare:KustoDatabaseDataSet")]
    public partial class KustoDatabaseDataSet : global::Pulumi.CustomResource
    {
        ...
        public KustoDatabaseDataSet(string name, KustoDatabaseDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare:KustoDatabaseDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoDatabaseDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare:KustoDatabaseDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_datashare_v20181101preview:datashare:KustoDatabaseDataSet" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_datashare_v20201001preview:datashare:KustoDatabaseDataSet" },
