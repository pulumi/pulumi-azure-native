...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    public static class GetBlobDataSetMapping
    {
        ...
        public static Task<GetBlobDataSetMappingResult> InvokeAsync(GetBlobDataSetMappingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlobDataSetMappingResult>("azure-native:datashare/v20210801:getBlobDataSetMapping", args ?? new GetBlobDataSetMappingArgs(), options.WithVersion());

        /// <summary>
        /// A Blob data set mapping.
        /// </summary>
        public static Output<GetBlobDataSetMappingResult> Invoke(GetBlobDataSetMappingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBlobDataSetMappingResult>("azure-native:datashare/v20210801:getBlobDataSetMapping", args ?? new GetBlobDataSetMappingInvokeArgs(), options.WithVersion());
    }
