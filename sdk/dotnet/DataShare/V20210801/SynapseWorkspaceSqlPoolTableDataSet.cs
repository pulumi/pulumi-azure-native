...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var synapseWorkspaceSqlPoolTableDataSet = new AzureNative.DataShare.V20210801.SynapseWorkspaceSqlPoolTableDataSet("synapseWorkspaceSqlPoolTableDataSet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSet")]
    public partial class SynapseWorkspaceSqlPoolTableDataSet : global::Pulumi.CustomResource
    {
        ...
        public SynapseWorkspaceSqlPoolTableDataSet(string name, SynapseWorkspaceSqlPoolTableDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SynapseWorkspaceSqlPoolTableDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
