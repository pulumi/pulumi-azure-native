...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var invitation = new AzureNative.DataShare.V20210801.Invitation("invitation", new()
    ///     {
    ...
    public partial class Invitation : global::Pulumi.CustomResource
    {
        ...
        public Invitation(string name, InvitationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:Invitation", name, args ?? new InvitationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Invitation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:Invitation", name, null, MakeResourceOptions(options, id))
        {
        }
