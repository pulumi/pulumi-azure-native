...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var kustoDatabaseDataSet = new AzureNative.DataShare.V20210801.KustoDatabaseDataSet("kustoDatabaseDataSet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:KustoDatabaseDataSet")]
    public partial class KustoDatabaseDataSet : global::Pulumi.CustomResource
    {
        ...
        public KustoDatabaseDataSet(string name, KustoDatabaseDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:KustoDatabaseDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoDatabaseDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:KustoDatabaseDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
