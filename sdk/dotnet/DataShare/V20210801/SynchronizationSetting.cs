...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    [AzureNativeResourceType("azure-native:datashare/v20210801:SynchronizationSetting")]
    public partial class SynchronizationSetting : Pulumi.CustomResource
    {
        ...
        public SynchronizationSetting(string name, SynchronizationSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SynchronizationSetting", name, args ?? new SynchronizationSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SynchronizationSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SynchronizationSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SynchronizationSettingArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20210801.SynchronizationSettingKind> Kind { get; set; } = null!;
