...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    [AzureNativeResourceType("azure-native:datashare/v20210801:DataSet")]
    public partial class DataSet : Pulumi.CustomResource
    {
        ...
        public DataSet(string name, DataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:DataSet", name, args ?? new DataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:DataSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataSetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20210801.DataSetKind> Kind { get; set; } = null!;
