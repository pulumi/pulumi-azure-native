...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var sqlDBTableDataSet = new AzureNative.DataShare.V20210801.SqlDBTableDataSet("sqlDBTableDataSet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:SqlDBTableDataSet")]
    public partial class SqlDBTableDataSet : global::Pulumi.CustomResource
    {
        ...
        public SqlDBTableDataSet(string name, SqlDBTableDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SqlDBTableDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SqlDBTableDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SqlDBTableDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
