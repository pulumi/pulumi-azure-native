...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    public static class GetShareSubscription
    {
        ...
        public static Task<GetShareSubscriptionResult> InvokeAsync(GetShareSubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetShareSubscriptionResult>("azure-native:datashare/v20210801:getShareSubscription", args ?? new GetShareSubscriptionArgs(), options.WithDefaults());

        /// <summary>
        /// Get a shareSubscription in an account
        /// </summary>
        public static Output<GetShareSubscriptionResult> Invoke(GetShareSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetShareSubscriptionResult>("azure-native:datashare/v20210801:getShareSubscription", args ?? new GetShareSubscriptionInvokeArgs(), options.WithDefaults());
    }
