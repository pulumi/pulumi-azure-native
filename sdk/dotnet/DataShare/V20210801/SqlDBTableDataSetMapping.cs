...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var sqlDBTableDataSetMapping = new AzureNative.DataShare.V20210801.SqlDBTableDataSetMapping("sqlDBTableDataSetMapping", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:SqlDBTableDataSetMapping")]
    public partial class SqlDBTableDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public SqlDBTableDataSetMapping(string name, SqlDBTableDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SqlDBTableDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SqlDBTableDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SqlDBTableDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
