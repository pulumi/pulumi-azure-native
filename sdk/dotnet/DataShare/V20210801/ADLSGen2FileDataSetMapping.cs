...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var adlsGen2FileDataSetMapping = new AzureNative.DataShare.V20210801.ADLSGen2FileDataSetMapping("adlsGen2FileDataSetMapping", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping")]
    public partial class ADLSGen2FileDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public ADLSGen2FileDataSetMapping(string name, ADLSGen2FileDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ADLSGen2FileDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
