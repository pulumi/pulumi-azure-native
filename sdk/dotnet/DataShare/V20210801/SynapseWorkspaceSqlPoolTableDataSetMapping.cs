...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var synapseWorkspaceSqlPoolTableDataSetMapping = new AzureNative.DataShare.V20210801.SynapseWorkspaceSqlPoolTableDataSetMapping("synapseWorkspaceSqlPoolTableDataSetMapping", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSetMapping datasetMappingName /subscriptions/4e745bb7-c420-479b-b0d6-a0f92d48a227/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/consumerAccount/shareSubscriptions/ShareSubscription1/dataSetMappings/datasetMappingName1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSetMapping")]
    public partial class SynapseWorkspaceSqlPoolTableDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public SynapseWorkspaceSqlPoolTableDataSetMapping(string name, SynapseWorkspaceSqlPoolTableDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SynapseWorkspaceSqlPoolTableDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
