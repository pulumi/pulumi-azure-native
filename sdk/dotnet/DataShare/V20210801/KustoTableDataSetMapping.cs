...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var kustoTableDataSetMapping = new AzureNative.DataShare.V20210801.KustoTableDataSetMapping("kustoTableDataSetMapping", new()
    ///     {
    ...
    public partial class KustoTableDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public KustoTableDataSetMapping(string name, KustoTableDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:KustoTableDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoTableDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:KustoTableDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
