...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var shareSubscription = new AzureNative.DataShare.V20210801.ShareSubscription("shareSubscription", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:ShareSubscription")]
    public partial class ShareSubscription : global::Pulumi.CustomResource
    {
        ...
        public ShareSubscription(string name, ShareSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:ShareSubscription", name, args ?? new ShareSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ShareSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:ShareSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
