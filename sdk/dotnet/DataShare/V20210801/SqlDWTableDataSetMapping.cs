...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var sqlDWTableDataSetMapping = new AzureNative.DataShare.V20210801.SqlDWTableDataSetMapping("sqlDWTableDataSetMapping", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:SqlDWTableDataSetMapping")]
    public partial class SqlDWTableDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public SqlDWTableDataSetMapping(string name, SqlDWTableDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SqlDWTableDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SqlDWTableDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:SqlDWTableDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
