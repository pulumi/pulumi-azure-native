...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var kustoClusterDataSetMapping = new AzureNative.DataShare.V20210801.KustoClusterDataSetMapping("kustoClusterDataSetMapping", new()
    ///     {
    ...
    public partial class KustoClusterDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public KustoClusterDataSetMapping(string name, KustoClusterDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:KustoClusterDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoClusterDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:KustoClusterDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
