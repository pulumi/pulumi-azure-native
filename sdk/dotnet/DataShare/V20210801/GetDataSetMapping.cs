...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    public static class GetDataSetMapping
    {
        ...
        public static Task<GetDataSetMappingResult> InvokeAsync(GetDataSetMappingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataSetMappingResult>("azure-native:datashare/v20210801:getDataSetMapping", args ?? new GetDataSetMappingArgs(), options.WithVersion());

        /// <summary>
        /// A data set mapping data transfer object.
        /// </summary>
        public static Output<GetDataSetMappingResult> Invoke(GetDataSetMappingInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataSetMappingResult>("azure-native:datashare/v20210801:getDataSetMapping", args ?? new GetDataSetMappingInvokeArgs(), options.WithVersion());
    }
