...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    public partial class DataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public DataSetMapping(string name, DataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:DataSetMapping", name, args ?? new DataSetMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:DataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataSetMappingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20210801.DataSetMappingKind> Kind { get; set; } = null!;
