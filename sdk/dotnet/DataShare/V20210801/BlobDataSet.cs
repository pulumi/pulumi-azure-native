...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var blobDataSet = new AzureNative.DataShare.V20210801.BlobDataSet("blobDataSet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:BlobDataSet")]
    public partial class BlobDataSet : global::Pulumi.CustomResource
    {
        ...
        public BlobDataSet(string name, BlobDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:BlobDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:BlobDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
