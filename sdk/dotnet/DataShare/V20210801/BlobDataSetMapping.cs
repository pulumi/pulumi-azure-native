...
namespace Pulumi.AzureNative.DataShare.V20210801
{
    ...
    /// {
    ///     var blobDataSetMapping = new AzureNative.DataShare.V20210801.BlobDataSetMapping("blobDataSetMapping", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datashare/v20210801:BlobDataSetMapping datasetMappingName /subscriptions/4e745bb7-c420-479b-b0d6-a0f92d48a227/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/consumerAccount/shareSubscriptions/ShareSubscription1/dataSetMappings/datasetMappingName1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20210801:BlobDataSetMapping")]
    public partial class BlobDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public BlobDataSetMapping(string name, BlobDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:BlobDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20210801:BlobDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
