...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    public partial class Share : Pulumi.CustomResource
    {
        ...
        public Share(string name, ShareArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:Share", name, args ?? new ShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Share(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:Share", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ShareArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("shareKind")]
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20191101.ShareKind>? ShareKind { get; set; }
