...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    [AzureNativeResourceType("azure-native:datashare/v20191101:SynchronizationSetting")]
    public partial class SynchronizationSetting : global::Pulumi.CustomResource
    {
        ...
        public SynchronizationSetting(string name, SynchronizationSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:SynchronizationSetting", name, args ?? new SynchronizationSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SynchronizationSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:SynchronizationSetting", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:datashare/v20181101preview:SynchronizationSetting"},
    ...
    public sealed class SynchronizationSettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20191101.SynchronizationSettingKind> Kind { get; set; } = null!;
