...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    public static class GetKustoClusterDataSet
    {
        ...
        public static Task<GetKustoClusterDataSetResult> InvokeAsync(GetKustoClusterDataSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKustoClusterDataSetResult>("azure-native:datashare/v20191101:getKustoClusterDataSet", args ?? new GetKustoClusterDataSetArgs(), options.WithVersion());
        ...
        public static Output<GetKustoClusterDataSetResult> Invoke(GetKustoClusterDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetKustoClusterDataSetResult>("azure-native:datashare/v20191101:getKustoClusterDataSet", args ?? new GetKustoClusterDataSetInvokeArgs(), options.WithVersion());
    }
