...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20191101:KustoClusterDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSetMapping to guarantee forwards compatibility.")]
    ...
    public partial class KustoClusterDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public KustoClusterDataSetMapping(string name, KustoClusterDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:KustoClusterDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoClusterDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:KustoClusterDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
