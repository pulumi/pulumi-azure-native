...
namespace Pulumi.AzureRM.DataShare.V20191101
{
    ...
    public partial class Invitation : Pulumi.CustomResource
    {
        ...
        public Invitation(string name, InvitationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:datashare/v20191101:Invitation", name, args ?? new InvitationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Invitation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:datashare/v20191101:Invitation", name, null, MakeResourceOptions(options, id))
        {
        }
