...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// {
    ///     var sqlDWTableDataSetMapping = new AzureNative.DataShare.V20191101.SqlDWTableDataSetMapping("sqlDWTableDataSetMapping", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datashare/v20191101:SqlDWTableDataSetMapping DatasetMapping1 /subscriptions/433a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/Account1/shareSubscriptions/ShareSubscription1/dataSetMappings/DatasetMapping1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20191101:SqlDWTableDataSetMapping")]
    public partial class SqlDWTableDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public SqlDWTableDataSetMapping(string name, SqlDWTableDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:SqlDWTableDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SqlDWTableDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:SqlDWTableDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
