...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// {
    ///     var kustoDatabaseDataSet = new AzureNative.DataShare.V20191101.KustoDatabaseDataSet("kustoDatabaseDataSet", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datashare/v20191101:KustoDatabaseDataSet Dataset1 /subscriptions/433a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/Account1/shares/Share1/datasets/Dataset1 
    /// ```
    /// </summary>
    ...
    public partial class KustoDatabaseDataSet : global::Pulumi.CustomResource
    {
        ...
        public KustoDatabaseDataSet(string name, KustoDatabaseDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:KustoDatabaseDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoDatabaseDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:KustoDatabaseDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
