...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// {
    ///     var adlsGen1FileDataSet = new AzureNative.DataShare.V20191101.ADLSGen1FileDataSet("adlsGen1FileDataSet", new()
    ///     {
    ...
    public partial class ADLSGen1FileDataSet : global::Pulumi.CustomResource
    {
        ...
        public ADLSGen1FileDataSet(string name, ADLSGen1FileDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:ADLSGen1FileDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ADLSGen1FileDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:ADLSGen1FileDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
