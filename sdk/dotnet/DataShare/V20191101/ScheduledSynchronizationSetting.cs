...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// {
    ///     var scheduledSynchronizationSetting = new AzureNative.DataShare.V20191101.ScheduledSynchronizationSetting("scheduledSynchronizationSetting", new()
    ///     {
    ...
    public partial class ScheduledSynchronizationSetting : global::Pulumi.CustomResource
    {
        ...
        public ScheduledSynchronizationSetting(string name, ScheduledSynchronizationSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:ScheduledSynchronizationSetting", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledSynchronizationSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:ScheduledSynchronizationSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledSynchronizationSettingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20191101.RecurrenceInterval> RecurrenceInterval { get; set; } = null!;
