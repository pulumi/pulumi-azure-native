...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    public static class GetDataSet
    {
        ...
        public static Task<GetDataSetResult> InvokeAsync(GetDataSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataSetResult>("azure-native:datashare/v20191101:getDataSet", args ?? new GetDataSetArgs(), options.WithDefaults());

        /// <summary>
        /// A DataSet data transfer object.
        /// </summary>
        public static Output<GetDataSetResult> Invoke(GetDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataSetResult>("azure-native:datashare/v20191101:getDataSet", args ?? new GetDataSetInvokeArgs(), options.WithDefaults());
    }
