...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// {
    ///     var blobDataSetMapping = new AzureNative.DataShare.V20191101.BlobDataSetMapping("blobDataSetMapping", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datashare/v20191101:BlobDataSetMapping DatasetMapping1 /subscriptions/433a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/Account1/shareSubscriptions/ShareSubscription1/dataSetMappings/DatasetMapping1 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20191101:BlobDataSetMapping")]
    public partial class BlobDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public BlobDataSetMapping(string name, BlobDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:BlobDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:BlobDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
