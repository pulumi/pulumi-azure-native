...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20191101:ADLSGen2FolderDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FolderDataSet to guarantee forwards compatibility.")]
    ...
    public partial class ADLSGen2FolderDataSet : global::Pulumi.CustomResource
    {
        ...
        public ADLSGen2FolderDataSet(string name, ADLSGen2FolderDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:ADLSGen2FolderDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ADLSGen2FolderDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:ADLSGen2FolderDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:datashare/v20181101preview:ADLSGen2FolderDataSet"},
                    new global::Pulumi.Alias { Type = "azure-native:datashare/v20200901:ADLSGen2FolderDataSet"},
                    new global::Pulumi.Alias { Type = "azure-native:datashare/v20201001preview:ADLSGen2FolderDataSet"},
    ...
    public sealed class ADLSGen2FolderDataSetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public static new ADLSGen2FolderDataSetArgs Empty => new ADLSGen2FolderDataSetArgs();
    }
}
