...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20191101:SqlDBTableDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSet to guarantee forwards compatibility.")]
    ...
    public partial class SqlDBTableDataSet : global::Pulumi.CustomResource
    {
        ...
        public SqlDBTableDataSet(string name, SqlDBTableDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:SqlDBTableDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SqlDBTableDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:SqlDBTableDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
