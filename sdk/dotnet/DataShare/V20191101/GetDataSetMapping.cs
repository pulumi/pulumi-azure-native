...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    public static class GetDataSetMapping
    {
        ...
        public static Task<GetDataSetMappingResult> InvokeAsync(GetDataSetMappingArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDataSetMappingResult>("azure-native:datashare/v20191101:getDataSetMapping", args ?? new GetDataSetMappingArgs(), options.WithDefaults());

        /// <summary>
        /// Get a DataSetMapping in a shareSubscription
        /// </summary>
        public static Output<GetDataSetMappingResult> Invoke(GetDataSetMappingInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDataSetMappingResult>("azure-native:datashare/v20191101:getDataSetMapping", args ?? new GetDataSetMappingInvokeArgs(), options.WithDefaults());
    }
