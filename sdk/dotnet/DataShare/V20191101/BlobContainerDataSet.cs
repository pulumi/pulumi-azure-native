...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// {
    ///     var blobContainerDataSet = new AzureNative.DataShare.V20191101.BlobContainerDataSet("blobContainerDataSet", new()
    ///     {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:datashare/v20191101:BlobContainerDataSet Dataset1 /subscriptions/433a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/Account1/shares/Share1/datasets/Dataset1 
    /// ```
    /// </summary>
    ...
    public partial class BlobContainerDataSet : global::Pulumi.CustomResource
    {
        ...
        public BlobContainerDataSet(string name, BlobContainerDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:BlobContainerDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:BlobContainerDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
