...
{
    [Obsolete(@"azure-native:datashare/v20200901:ADLSGen2FileSystemDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet to guarantee forwards compatibility.")]
    public static class GetADLSGen2FileSystemDataSet
    {
        ...
        public static Task<GetADLSGen2FileSystemDataSetResult> InvokeAsync(GetADLSGen2FileSystemDataSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetADLSGen2FileSystemDataSetResult>("azure-native:datashare/v20200901:getADLSGen2FileSystemDataSet", args ?? new GetADLSGen2FileSystemDataSetArgs(), options.WithDefaults());
        ...
        public static Output<GetADLSGen2FileSystemDataSetResult> Invoke(GetADLSGen2FileSystemDataSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetADLSGen2FileSystemDataSetResult>("azure-native:datashare/v20200901:getADLSGen2FileSystemDataSet", args ?? new GetADLSGen2FileSystemDataSetInvokeArgs(), options.WithDefaults());
    }
