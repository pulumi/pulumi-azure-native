...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    public static class GetDataSet
    {
        ...
        public static Task<GetDataSetResult> InvokeAsync(GetDataSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataSetResult>("azure-native:datashare/v20200901:getDataSet", args ?? new GetDataSetArgs(), options.WithDefaults());

        /// <summary>
        /// A DataSet data transfer object.
        /// </summary>
        public static Output<GetDataSetResult> Invoke(GetDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataSetResult>("azure-native:datashare/v20200901:getDataSet", args ?? new GetDataSetInvokeArgs(), options.WithDefaults());
    }
