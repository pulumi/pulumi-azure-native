...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSet")]
    public partial class SynapseWorkspaceSqlPoolTableDataSet : Pulumi.CustomResource
    {
        ...
        public SynapseWorkspaceSqlPoolTableDataSet(string name, SynapseWorkspaceSqlPoolTableDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SynapseWorkspaceSqlPoolTableDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:datashare:SynapseWorkspaceSqlPoolTableDataSet"},
                    new Pulumi.Alias { Type = "azure-native:datashare/v20181101preview:SynapseWorkspaceSqlPoolTableDataSet"},
                    new Pulumi.Alias { Type = "azure-nextgen:datashare/v20181101preview:SynapseWorkspaceSqlPoolTableDataSet"},
                    new Pulumi.Alias { Type = "azure-native:datashare/v20191101:SynapseWorkspaceSqlPoolTableDataSet"},
                    new Pulumi.Alias { Type = "azure-nextgen:datashare/v20191101:SynapseWorkspaceSqlPoolTableDataSet"},
