...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    [AzureNativeResourceType("azure-native:datashare/v20200901:DataSet")]
    public partial class DataSet : global::Pulumi.CustomResource
    {
        ...
        public DataSet(string name, DataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:DataSet", name, args ?? new DataSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:DataSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20200901.DataSetKind> Kind { get; set; } = null!;
