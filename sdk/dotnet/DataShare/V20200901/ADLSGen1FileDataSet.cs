...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20200901:ADLSGen1FileDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen1FileDataSet to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datashare/v20200901:ADLSGen1FileDataSet")]
    public partial class ADLSGen1FileDataSet : global::Pulumi.CustomResource
    {
        ...
        public ADLSGen1FileDataSet(string name, ADLSGen1FileDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:ADLSGen1FileDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ADLSGen1FileDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:ADLSGen1FileDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
