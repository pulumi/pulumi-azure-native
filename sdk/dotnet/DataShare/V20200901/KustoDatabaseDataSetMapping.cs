...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// {
    ///     var kustoDatabaseDataSetMapping = new AzureNative.DataShare.V20200901.KustoDatabaseDataSetMapping("kustoDatabaseDataSetMapping", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20200901:KustoDatabaseDataSetMapping")]
    public partial class KustoDatabaseDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public KustoDatabaseDataSetMapping(string name, KustoDatabaseDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:KustoDatabaseDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private KustoDatabaseDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:KustoDatabaseDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
