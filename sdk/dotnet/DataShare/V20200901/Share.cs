...
namespace Pulumi.AzureNextGen.DataShare.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datashare/v20200901:Share")]
    public partial class Share : Pulumi.CustomResource
    {
        ...
        public Share(string name, ShareArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20200901:Share", name, args ?? new ShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Share(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20200901:Share", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ShareArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("shareKind")]
        public InputUnion<string, Pulumi.AzureNextGen.DataShare.V20200901.ShareKind>? ShareKind { get; set; }
