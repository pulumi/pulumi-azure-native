...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// {
    ///     var blobContainerDataSet = new AzureNative.DataShare.V20200901.BlobContainerDataSet("blobContainerDataSet", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20200901:BlobContainerDataSet")]
    public partial class BlobContainerDataSet : global::Pulumi.CustomResource
    {
        ...
        public BlobContainerDataSet(string name, BlobContainerDataSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:BlobContainerDataSet", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerDataSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:BlobContainerDataSet", name, null, MakeResourceOptions(options, id))
        {
        }
