...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    public static class GetBlobContainerDataSet
    {
        ...
        public static Task<GetBlobContainerDataSetResult> InvokeAsync(GetBlobContainerDataSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlobContainerDataSetResult>("azure-native:datashare/v20200901:getBlobContainerDataSet", args ?? new GetBlobContainerDataSetArgs(), options.WithDefaults());
        ...
        public static Output<GetBlobContainerDataSetResult> Invoke(GetBlobContainerDataSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBlobContainerDataSetResult>("azure-native:datashare/v20200901:getBlobContainerDataSet", args ?? new GetBlobContainerDataSetInvokeArgs(), options.WithDefaults());
    }
