...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    public static class GetTrigger
    {
        ...
        public static Task<GetTriggerResult> InvokeAsync(GetTriggerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTriggerResult>("azure-native:datashare/v20200901:getTrigger", args ?? new GetTriggerArgs(), options.WithDefaults());

        /// <summary>
        /// A Trigger data transfer object.
        /// </summary>
        public static Output<GetTriggerResult> Invoke(GetTriggerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTriggerResult>("azure-native:datashare/v20200901:getTrigger", args ?? new GetTriggerInvokeArgs(), options.WithDefaults());
    }
