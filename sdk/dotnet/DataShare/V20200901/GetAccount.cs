...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("azure-native:datashare/v20200901:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());

        /// <summary>
        /// An account data transfer object.
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAccountResult>("azure-native:datashare/v20200901:getAccount", args ?? new GetAccountInvokeArgs(), options.WithDefaults());
    }
