...
namespace Pulumi.AzureNextGen.DataShare.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datashare/v20200901:Invitation")]
    public partial class Invitation : Pulumi.CustomResource
    {
        ...
        public Invitation(string name, InvitationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20200901:Invitation", name, args ?? new InvitationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Invitation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20200901:Invitation", name, null, MakeResourceOptions(options, id))
        {
        }
