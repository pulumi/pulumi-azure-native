...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// {
    ///     var adlsGen2FolderDataSetMapping = new AzureNative.DataShare.V20200901.ADLSGen2FolderDataSetMapping("adlsGen2FolderDataSetMapping", new()
    ///     {
    ...
    public partial class ADLSGen2FolderDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public ADLSGen2FolderDataSetMapping(string name, ADLSGen2FolderDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:ADLSGen2FolderDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ADLSGen2FolderDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:ADLSGen2FolderDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
