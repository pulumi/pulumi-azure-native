...
namespace Pulumi.AzureNextGen.DataShare.V20200901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:datashare/v20200901:Trigger")]
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20200901:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:datashare/v20200901:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
