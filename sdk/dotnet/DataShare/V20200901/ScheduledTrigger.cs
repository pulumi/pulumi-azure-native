...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20200901:ScheduledTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ScheduledTrigger to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datashare/v20200901:ScheduledTrigger")]
    public partial class ScheduledTrigger : global::Pulumi.CustomResource
    {
        ...
        public ScheduledTrigger(string name, ScheduledTriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:ScheduledTrigger", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledTrigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:ScheduledTrigger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScheduledTriggerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20200901.RecurrenceInterval> RecurrenceInterval { get; set; } = null!;
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20200901.SynchronizationMode>? SynchronizationMode { get; set; }
