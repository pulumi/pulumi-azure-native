...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// {
    ///     var scheduledSynchronizationSetting = new AzureNative.DataShare.V20200901.ScheduledSynchronizationSetting("scheduledSynchronizationSetting", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20200901:ScheduledSynchronizationSetting")]
    public partial class ScheduledSynchronizationSetting : global::Pulumi.CustomResource
    {
        ...
        public ScheduledSynchronizationSetting(string name, ScheduledSynchronizationSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:ScheduledSynchronizationSetting", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private ScheduledSynchronizationSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:ScheduledSynchronizationSetting", name, null, MakeResourceOptions(options, id))
        {
        }
