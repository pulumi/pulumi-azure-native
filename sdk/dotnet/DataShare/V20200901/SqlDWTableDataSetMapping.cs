...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// {
    ///     var sqlDWTableDataSetMapping = new AzureNative.DataShare.V20200901.SqlDWTableDataSetMapping("sqlDWTableDataSetMapping", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20200901:SqlDWTableDataSetMapping")]
    public partial class SqlDWTableDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public SqlDWTableDataSetMapping(string name, SqlDWTableDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:SqlDWTableDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SqlDWTableDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:SqlDWTableDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
