...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:datashare/v20200901:SqlDBTableDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSetMapping to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:datashare/v20200901:SqlDBTableDataSetMapping")]
    public partial class SqlDBTableDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public SqlDBTableDataSetMapping(string name, SqlDBTableDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:SqlDBTableDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private SqlDBTableDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:SqlDBTableDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
