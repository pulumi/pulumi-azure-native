...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// {
    ///     var sqlDBTableDataSetMapping = new AzureNative.DataShare.V20200901.SqlDBTableDataSetMapping("sqlDBTableDataSetMapping", new()
    ///     {
