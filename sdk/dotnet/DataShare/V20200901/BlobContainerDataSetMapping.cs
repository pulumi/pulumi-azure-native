...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    /// {
    ///     var blobContainerDataSetMapping = new AzureNative.DataShare.V20200901.BlobContainerDataSetMapping("blobContainerDataSetMapping", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:datashare/v20200901:BlobContainerDataSetMapping")]
    public partial class BlobContainerDataSetMapping : global::Pulumi.CustomResource
    {
        ...
        public BlobContainerDataSetMapping(string name, BlobContainerDataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:BlobContainerDataSetMapping", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private BlobContainerDataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:BlobContainerDataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
