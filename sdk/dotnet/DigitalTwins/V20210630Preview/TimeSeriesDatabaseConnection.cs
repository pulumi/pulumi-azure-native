...
namespace Pulumi.AzureNative.DigitalTwins.V20210630Preview
{
    ...
    /// {
    ///     var timeSeriesDatabaseConnection = new AzureNative.DigitalTwins.V20210630Preview.TimeSeriesDatabaseConnection("timeSeriesDatabaseConnection", new()
    ///     {
    ///         Properties = new AzureNative.DigitalTwins.V20210630Preview.Inputs.AzureDataExplorerConnectionPropertiesArgs
    ///         {
    ...
    public partial class TimeSeriesDatabaseConnection : global::Pulumi.CustomResource
    {
        ...
        public TimeSeriesDatabaseConnection(string name, TimeSeriesDatabaseConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20210630preview:TimeSeriesDatabaseConnection", name, args ?? new TimeSeriesDatabaseConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TimeSeriesDatabaseConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20210630preview:TimeSeriesDatabaseConnection", name, null, MakeResourceOptions(options, id))
        {
        }
