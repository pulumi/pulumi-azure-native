...
namespace Pulumi.AzureNative.DigitalTwins.V20210630Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:digitaltwins/v20210630preview:DigitalTwin is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:DigitalTwin to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:digitaltwins/v20210630preview:DigitalTwin")]
    public partial class DigitalTwin : global::Pulumi.CustomResource
    {
        ...
        public DigitalTwin(string name, DigitalTwinArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20210630preview:DigitalTwin", name, args ?? new DigitalTwinArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20210630preview:DigitalTwin", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DigitalTwinArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DigitalTwins.V20210630Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
