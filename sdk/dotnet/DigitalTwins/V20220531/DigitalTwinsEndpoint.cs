...
namespace Pulumi.AzureNative.DigitalTwins.V20220531
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint")]
    public partial class DigitalTwinsEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DigitalTwinsEndpoint(string name, DigitalTwinsEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint", name, args ?? new DigitalTwinsEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwinsEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
