...
namespace Pulumi.AzureNative.DigitalTwins.V20220531
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:digitaltwins/v20220531:DigitalTwin is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:DigitalTwin to guarantee forwards compatibility.")]
    ...
    public partial class DigitalTwin : global::Pulumi.CustomResource
    {
        ...
        public DigitalTwin(string name, DigitalTwinArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20220531:DigitalTwin", name, args ?? new DigitalTwinArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20220531:DigitalTwin", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DigitalTwinArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DigitalTwins.V20220531.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
