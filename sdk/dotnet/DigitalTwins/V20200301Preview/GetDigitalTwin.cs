...
namespace Pulumi.AzureRM.DigitalTwins.V20200301Preview
{
    public static class GetDigitalTwin
    {
        public static Task<GetDigitalTwinResult> InvokeAsync(GetDigitalTwinArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDigitalTwinResult>("azurerm:digitaltwins/v20200301preview:getDigitalTwin", args ?? new GetDigitalTwinArgs(), options.WithVersion());
    }
