...
namespace Pulumi.AzureRM.DigitalTwins.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var digitalTwinsEndpoint = new AzureRM.DigitalTwins.Latest.DigitalTwinsEndpoint("digitalTwinsEndpoint", new AzureRM.DigitalTwins.Latest.DigitalTwinsEndpointArgs
    ///         {
    ...
    public partial class DigitalTwinsEndpoint : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Union<Outputs.EventGridResponseResult, Union<Outputs.EventHubResponseResult, Outputs.ServiceBusResponseResult>>> Properties { get; private set; } = null!;
