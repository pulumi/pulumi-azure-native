...
namespace Pulumi.AzureNative.DigitalTwins.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:digitaltwins:DigitalTwin'.")]
    [AzureNativeResourceType("azure-native:digitaltwins/latest:DigitalTwin")]
    public partial class DigitalTwin : Pulumi.CustomResource
    {
        ...
        public DigitalTwin(string name, DigitalTwinArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/latest:DigitalTwin", name, args ?? new DigitalTwinArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/latest:DigitalTwin", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DigitalTwinArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DigitalTwins.Latest.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
