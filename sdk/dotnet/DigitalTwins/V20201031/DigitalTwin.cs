...
namespace Pulumi.AzureNative.DigitalTwins.V20201031
{
    ...
    [AzureNativeResourceType("azure-native:digitaltwins/v20201031:DigitalTwin")]
    public partial class DigitalTwin : global::Pulumi.CustomResource
    {
        ...
        public DigitalTwin(string name, DigitalTwinArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20201031:DigitalTwin", name, args ?? new DigitalTwinArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20201031:DigitalTwin", name, null, MakeResourceOptions(options, id))
        {
        }
