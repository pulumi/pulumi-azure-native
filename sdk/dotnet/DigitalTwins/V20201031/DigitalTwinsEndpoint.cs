...
namespace Pulumi.AzureNextGen.DigitalTwins.V20201031
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:digitaltwins/v20201031:DigitalTwinsEndpoint")]
    public partial class DigitalTwinsEndpoint : Pulumi.CustomResource
    {
        ...
        public DigitalTwinsEndpoint(string name, DigitalTwinsEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:digitaltwins/v20201031:DigitalTwinsEndpoint", name, args ?? new DigitalTwinsEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwinsEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:digitaltwins/v20201031:DigitalTwinsEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
