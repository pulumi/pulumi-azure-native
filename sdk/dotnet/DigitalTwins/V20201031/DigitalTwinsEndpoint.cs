...
namespace Pulumi.AzureNative.DigitalTwins.V20201031
{
    ...
    /// </summary>
    [Obsolete(@"Version v20201031 will be removed in the next major version of the provider. Upgrade to version v20201201 or later.")]
    [AzureNativeResourceType("azure-native:digitaltwins/v20201031:DigitalTwinsEndpoint")]
    public partial class DigitalTwinsEndpoint : Pulumi.CustomResource
    {
        ...
        public DigitalTwinsEndpoint(string name, DigitalTwinsEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20201031:DigitalTwinsEndpoint", name, args ?? new DigitalTwinsEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwinsEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20201031:DigitalTwinsEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
