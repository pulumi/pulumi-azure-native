...
namespace Pulumi.AzureNative.DigitalTwins.V20221031
{
    ...
    public partial class DigitalTwinsEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DigitalTwinsEndpoint(string name, DigitalTwinsEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20221031:DigitalTwinsEndpoint", name, args ?? new DigitalTwinsEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwinsEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20221031:DigitalTwinsEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
