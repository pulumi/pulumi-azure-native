...
namespace Pulumi.AzureNative.DigitalTwins.V20221031
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:digitaltwins/v20221031:DigitalTwin")]
    public partial class DigitalTwin : global::Pulumi.CustomResource
    {
        ...
        public DigitalTwin(string name, DigitalTwinArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20221031:DigitalTwin", name, args ?? new DigitalTwinArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20221031:DigitalTwin", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DigitalTwinArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DigitalTwins.V20221031.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
