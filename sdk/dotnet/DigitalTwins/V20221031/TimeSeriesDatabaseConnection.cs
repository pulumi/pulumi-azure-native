...
namespace Pulumi.AzureNative.DigitalTwins.V20221031
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:digitaltwins/v20221031:TimeSeriesDatabaseConnection")]
    public partial class TimeSeriesDatabaseConnection : global::Pulumi.CustomResource
    {
        ...
        public TimeSeriesDatabaseConnection(string name, TimeSeriesDatabaseConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20221031:TimeSeriesDatabaseConnection", name, args ?? new TimeSeriesDatabaseConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TimeSeriesDatabaseConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20221031:TimeSeriesDatabaseConnection", name, null, MakeResourceOptions(options, id))
        {
        }
