...
namespace Pulumi.AzureNative.DigitalTwins.V20201201
{
    public static class GetDigitalTwin
    {
        ...
        public static Output<GetDigitalTwinResult> Invoke(GetDigitalTwinInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDigitalTwinResult>("azure-native:digitaltwins/v20201201:getDigitalTwin", args ?? new GetDigitalTwinInvokeArgs(), options.WithVersion());
    }
