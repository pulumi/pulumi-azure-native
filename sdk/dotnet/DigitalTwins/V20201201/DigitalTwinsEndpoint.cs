...
namespace Pulumi.AzureNative.DigitalTwins.V20201201
{
    ...
    /// {
    ///     var digitalTwinsEndpoint = new AzureNative.DigitalTwins.V20201201.DigitalTwinsEndpoint("digitalTwinsEndpoint", new()
    ///     {
    ///         EndpointName = "myServiceBus",
    ///         Properties = new AzureNative.DigitalTwins.V20201201.Inputs.ServiceBusArgs
    ///         {
    ...
    public partial class DigitalTwinsEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DigitalTwinsEndpoint(string name, DigitalTwinsEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20201201:DigitalTwinsEndpoint", name, args ?? new DigitalTwinsEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwinsEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20201201:DigitalTwinsEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
