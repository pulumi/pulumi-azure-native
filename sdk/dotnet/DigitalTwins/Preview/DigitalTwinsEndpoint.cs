...
namespace Pulumi.AzureRM.DigitalTwins.Preview
{
    ...
    public partial class DigitalTwinsEndpoint : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DigitalTwinsEndpointResourcePropertiesResponseResult> Properties { get; private set; } = null!;
        ...
        public DigitalTwinsEndpoint(string name, DigitalTwinsEndpointArgs args, CustomResourceOptions? options = null)
            : base("azurerm:digitaltwins/preview:DigitalTwinsEndpoint", name, args ?? new DigitalTwinsEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwinsEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:digitaltwins/preview:DigitalTwinsEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DigitalTwinsEndpointArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.DigitalTwinsEndpointResourcePropertiesArgs>? Properties { get; set; }
