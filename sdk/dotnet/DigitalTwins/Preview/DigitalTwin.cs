...
namespace Pulumi.AzureRM.DigitalTwins.Preview
{
    ...
    public partial class DigitalTwin : Pulumi.CustomResource
    {
        ...
        public DigitalTwin(string name, DigitalTwinArgs args, CustomResourceOptions? options = null)
            : base("azurerm:digitaltwins/preview:DigitalTwin", name, args ?? new DigitalTwinArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwin(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:digitaltwins/preview:DigitalTwin", name, null, MakeResourceOptions(options, id))
        {
        }
