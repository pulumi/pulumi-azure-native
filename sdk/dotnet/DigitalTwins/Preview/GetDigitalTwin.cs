...
namespace Pulumi.AzureRM.DigitalTwins.Preview
{
    public static class GetDigitalTwin
    {
        public static Task<GetDigitalTwinResult> InvokeAsync(GetDigitalTwinArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDigitalTwinResult>("azurerm:digitaltwins/preview:getDigitalTwin", args ?? new GetDigitalTwinArgs(), options.WithVersion());
    }
