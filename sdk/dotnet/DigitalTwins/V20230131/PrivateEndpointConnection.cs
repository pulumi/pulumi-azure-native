...
namespace Pulumi.AzureNative.DigitalTwins.V20230131
{
    ...
    /// {
    ///     var privateEndpointConnection = new AzureNative.DigitalTwins.V20230131.PrivateEndpointConnection("privateEndpointConnection", new()
    ///     {
    ///         PrivateEndpointConnectionName = "myPrivateConnection",
    ///         Properties = new AzureNative.DigitalTwins.V20230131.Inputs.ConnectionPropertiesArgs
    ///         {
    ///             PrivateLinkServiceConnectionState = new AzureNative.DigitalTwins.V20230131.Inputs.ConnectionPropertiesPrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:digitaltwins/v20230131:PrivateEndpointConnection")]
    public partial class PrivateEndpointConnection : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnection(string name, PrivateEndpointConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20230131:PrivateEndpointConnection", name, args ?? new PrivateEndpointConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20230131:PrivateEndpointConnection", name, null, MakeResourceOptions(options, id))
        {
        }
