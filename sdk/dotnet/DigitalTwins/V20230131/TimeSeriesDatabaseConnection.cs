...
namespace Pulumi.AzureNative.DigitalTwins.V20230131
{
    ...
    public partial class TimeSeriesDatabaseConnection : global::Pulumi.CustomResource
    {
        ...
        public TimeSeriesDatabaseConnection(string name, TimeSeriesDatabaseConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection", name, args ?? new TimeSeriesDatabaseConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TimeSeriesDatabaseConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection", name, null, MakeResourceOptions(options, id))
        {
        }
