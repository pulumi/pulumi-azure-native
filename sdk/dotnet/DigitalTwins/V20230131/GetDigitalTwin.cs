...
namespace Pulumi.AzureNative.DigitalTwins.V20230131
{
    public static class GetDigitalTwin
    {
        ...
        public static Task<GetDigitalTwinResult> InvokeAsync(GetDigitalTwinArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDigitalTwinResult>("azure-native:digitaltwins/v20230131:getDigitalTwin", args ?? new GetDigitalTwinArgs(), options.WithDefaults());
