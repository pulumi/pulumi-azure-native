...
namespace Pulumi.AzureNative.DigitalTwins.V20230131
{
    /// <summary>
    ...
    /// {
    ///     var digitalTwinsEndpoint = new AzureNative.DigitalTwins.V20230131.DigitalTwinsEndpoint("digitalTwinsEndpoint", new()
    ///     {
    ///         EndpointName = "myServiceBus",
    ///         Properties = new AzureNative.DigitalTwins.V20230131.Inputs.ServiceBusArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint")]
    public partial class DigitalTwinsEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DigitalTwinsEndpoint(string name, DigitalTwinsEndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint", name, args ?? new DigitalTwinsEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DigitalTwinsEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
