...
namespace Pulumi.AzureRM.CertificateRegistration.V20150801
{
    ...
    public partial class CertificateOrder : Pulumi.CustomResource
    {
        ...
        public CertificateOrder(string name, CertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration/v20150801:CertificateOrder", name, args ?? new CertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CertificateOrder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration/v20150801:CertificateOrder", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:certificateregistration/preview:CertificateOrder"},
