...
namespace Pulumi.AzureNextGen.CertificateRegistration.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:certificateregistration/v20201001:AppServiceCertificateOrder")]
    public partial class AppServiceCertificateOrder : Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrder(string name, AppServiceCertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:certificateregistration/v20201001:AppServiceCertificateOrder", name, args ?? new AppServiceCertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:certificateregistration/v20201001:AppServiceCertificateOrder", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceCertificateOrderArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNextGen.CertificateRegistration.V20201001.CertificateProductType> ProductType { get; set; } = null!;
