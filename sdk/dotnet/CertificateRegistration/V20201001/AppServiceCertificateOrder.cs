...
namespace Pulumi.AzureNative.CertificateRegistration.V20201001
{
    ...
    public partial class AppServiceCertificateOrder : Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrder(string name, AppServiceCertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20201001:AppServiceCertificateOrder", name, args ?? new AppServiceCertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20201001:AppServiceCertificateOrder", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceCertificateOrderArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.CertificateRegistration.V20201001.CertificateProductType> ProductType { get; set; } = null!;
