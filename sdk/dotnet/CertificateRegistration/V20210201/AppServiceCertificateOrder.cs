...
namespace Pulumi.AzureNative.CertificateRegistration.V20210201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:certificateregistration/v20210201:AppServiceCertificateOrder")]
    public partial class AppServiceCertificateOrder : global::Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrder(string name, AppServiceCertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20210201:AppServiceCertificateOrder", name, args ?? new AppServiceCertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20210201:AppServiceCertificateOrder", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceCertificateOrderArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.CertificateRegistration.V20210201.CertificateProductType> ProductType { get; set; } = null!;
