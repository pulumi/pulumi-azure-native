...
namespace Pulumi.AzureRM.CertificateRegistration.Preview
{
    ...
    public partial class AppServiceCertificateOrder : Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrder(string name, AppServiceCertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration/preview:AppServiceCertificateOrder", name, args ?? new AppServiceCertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration/preview:AppServiceCertificateOrder", name, null, MakeResourceOptions(options, id))
        {
        }
