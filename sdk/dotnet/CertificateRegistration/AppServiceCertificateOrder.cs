...
namespace Pulumi.AzureRM.CertificateRegistration
{
    ...
    public partial class AppServiceCertificateOrder : Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrder(string name, AppServiceCertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration:AppServiceCertificateOrder", name, args ?? new AppServiceCertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration:AppServiceCertificateOrder", name, null, MakeResourceOptions(options, id))
        {
        }
