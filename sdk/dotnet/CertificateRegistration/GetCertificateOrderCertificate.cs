...
namespace Pulumi.AzureRM.CertificateRegistration
{
    public static class GetCertificateOrderCertificate
    {
        public static Task<GetCertificateOrderCertificateResult> InvokeAsync(GetCertificateOrderCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCertificateOrderCertificateResult>("azurerm:certificateregistration:getCertificateOrderCertificate", args ?? new GetCertificateOrderCertificateArgs(), options.WithVersion());
    }
