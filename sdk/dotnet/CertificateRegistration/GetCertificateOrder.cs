...
namespace Pulumi.AzureRM.CertificateRegistration
{
    public static class GetCertificateOrder
    {
        public static Task<GetCertificateOrderResult> InvokeAsync(GetCertificateOrderArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCertificateOrderResult>("azurerm:certificateregistration:getCertificateOrder", args ?? new GetCertificateOrderArgs(), options.WithVersion());
    }
