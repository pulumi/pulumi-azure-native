...
namespace Pulumi.AzureRM.CertificateRegistration.V20180201
{
    ...
    public partial class AppServiceCertificateOrderCertificate : Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrderCertificate(string name, AppServiceCertificateOrderCertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration/v20180201:AppServiceCertificateOrderCertificate", name, args ?? new AppServiceCertificateOrderCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrderCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration/v20180201:AppServiceCertificateOrderCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
