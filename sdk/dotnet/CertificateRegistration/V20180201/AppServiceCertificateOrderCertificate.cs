...
namespace Pulumi.AzureNative.CertificateRegistration.V20180201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:certificateregistration/v20180201:AppServiceCertificateOrderCertificate")]
    public partial class AppServiceCertificateOrderCertificate : Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrderCertificate(string name, AppServiceCertificateOrderCertificateArgs args, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20180201:AppServiceCertificateOrderCertificate", name, args ?? new AppServiceCertificateOrderCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrderCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20180201:AppServiceCertificateOrderCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
