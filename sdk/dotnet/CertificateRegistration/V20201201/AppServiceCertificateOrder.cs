...
namespace Pulumi.AzureNative.CertificateRegistration.V20201201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:certificateregistration/v20201201:AppServiceCertificateOrder is being removed in the next major version of this provider. Upgrade to at least azure-native:certificateregistration/v20220901:AppServiceCertificateOrder to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:certificateregistration/v20201201:AppServiceCertificateOrder")]
    public partial class AppServiceCertificateOrder : global::Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrder(string name, AppServiceCertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20201201:AppServiceCertificateOrder", name, args ?? new AppServiceCertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20201201:AppServiceCertificateOrder", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceCertificateOrderArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.CertificateRegistration.V20201201.CertificateProductType> ProductType { get; set; } = null!;
