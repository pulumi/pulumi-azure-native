...
namespace Pulumi.AzureRM.CertificateRegistration.V20190801
{
    ...
    public partial class AppServiceCertificateOrder : Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrder(string name, AppServiceCertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration/v20190801:AppServiceCertificateOrder", name, args ?? new AppServiceCertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration/v20190801:AppServiceCertificateOrder", name, null, MakeResourceOptions(options, id))
        {
        }
