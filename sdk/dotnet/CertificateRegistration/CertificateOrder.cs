...
namespace Pulumi.AzureRM.CertificateRegistration
{
    ...
    public partial class CertificateOrder : Pulumi.CustomResource
    {
        ...
        public CertificateOrder(string name, CertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration:CertificateOrder", name, args ?? new CertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CertificateOrder(string name, Input<string> id, CertificateOrderState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:certificateregistration:CertificateOrder", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CertificateOrderState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AppServiceCertificateOrderResponsePropertiesGetArgs> Properties { get; set; } = null!;
