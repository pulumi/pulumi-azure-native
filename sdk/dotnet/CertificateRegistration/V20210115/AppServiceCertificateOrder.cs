...
namespace Pulumi.AzureNative.CertificateRegistration.V20210115
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:certificateregistration/v20210115:AppServiceCertificateOrder")]
    public partial class AppServiceCertificateOrder : Pulumi.CustomResource
    {
        ...
        public AppServiceCertificateOrder(string name, AppServiceCertificateOrderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20210115:AppServiceCertificateOrder", name, args ?? new AppServiceCertificateOrderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppServiceCertificateOrder(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:certificateregistration/v20210115:AppServiceCertificateOrder", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppServiceCertificateOrderArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.CertificateRegistration.V20210115.CertificateProductType> ProductType { get; set; } = null!;
