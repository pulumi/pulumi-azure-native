...
{
    [Obsolete(@"azure-native:certificateregistration/v20210115:AppServiceCertificateOrder is being removed in the next major version of this provider. Upgrade to at least azure-native:certificateregistration/v20220901:AppServiceCertificateOrder to guarantee forwards compatibility.")]
    public static class GetAppServiceCertificateOrder
    {
        ...
        public static Task<GetAppServiceCertificateOrderResult> InvokeAsync(GetAppServiceCertificateOrderArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAppServiceCertificateOrderResult>("azure-native:certificateregistration/v20210115:getAppServiceCertificateOrder", args ?? new GetAppServiceCertificateOrderArgs(), options.WithDefaults());
        ...
        public static Output<GetAppServiceCertificateOrderResult> Invoke(GetAppServiceCertificateOrderInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAppServiceCertificateOrderResult>("azure-native:certificateregistration/v20210115:getAppServiceCertificateOrder", args ?? new GetAppServiceCertificateOrderInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetAppServiceCertificateOrderArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public static new GetAppServiceCertificateOrderArgs Empty => new GetAppServiceCertificateOrderArgs();
    }

    public sealed class GetAppServiceCertificateOrderInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Name of the certificate order..
        /// </summary>
        ...
        public static new GetAppServiceCertificateOrderInvokeArgs Empty => new GetAppServiceCertificateOrderInvokeArgs();
    }
