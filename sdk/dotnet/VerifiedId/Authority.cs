...
namespace Pulumi.AzureNative.VerifiedId
{
    ...
    public partial class Authority : global::Pulumi.CustomResource
    {
        ...
        public Authority(string name, AuthorityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:verifiedid:Authority", name, args ?? new AuthorityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Authority(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:verifiedid:Authority", name, null, MakeResourceOptions(options, id))
        {
        }
