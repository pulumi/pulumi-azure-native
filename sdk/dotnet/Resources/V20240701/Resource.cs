...
namespace Pulumi.AzureNative.Resources.V20240701
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20240701:Resource")]
    public partial class Resource : global::Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20240701:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20240701:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
