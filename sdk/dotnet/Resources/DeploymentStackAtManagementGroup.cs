...
namespace Pulumi.AzureNative.Resources
{
    ...
    public partial class DeploymentStackAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public DeploymentStackAtManagementGroup(string name, DeploymentStackAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources:DeploymentStackAtManagementGroup", name, args ?? new DeploymentStackAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentStackAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources:DeploymentStackAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_resources_v20220801preview:resources:DeploymentStackAtManagementGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_resources_v20240301:resources:DeploymentStackAtManagementGroup" },
                },
            };
