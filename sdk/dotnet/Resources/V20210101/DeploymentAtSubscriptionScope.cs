...
namespace Pulumi.AzureNative.Resources.V20210101
{
    ...
    /// {
    ///     var deploymentAtSubscriptionScope = new AzureNative.Resources.V20210101.DeploymentAtSubscriptionScope("deploymentAtSubscriptionScope", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20210101:DeploymentAtSubscriptionScope")]
    public partial class DeploymentAtSubscriptionScope : global::Pulumi.CustomResource
    {
        ...
        public DeploymentAtSubscriptionScope(string name, DeploymentAtSubscriptionScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210101:DeploymentAtSubscriptionScope", name, args ?? new DeploymentAtSubscriptionScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtSubscriptionScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210101:DeploymentAtSubscriptionScope", name, null, MakeResourceOptions(options, id))
        {
        }
