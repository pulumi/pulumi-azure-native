...
namespace Pulumi.AzureNative.Resources
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources:DeploymentStackAtResourceGroup")]
    public partial class DeploymentStackAtResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public DeploymentStackAtResourceGroup(string name, DeploymentStackAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources:DeploymentStackAtResourceGroup", name, args ?? new DeploymentStackAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentStackAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources:DeploymentStackAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:resources/v20220801preview:DeploymentStackAtResourceGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:resources/v20240301:DeploymentStackAtResourceGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_resources_v20220801preview:resources:DeploymentStackAtResourceGroup" },
                    new global::Pulumi.Alias { Type = "azure-native_resources_v20240301:resources:DeploymentStackAtResourceGroup" },
                },
            };
