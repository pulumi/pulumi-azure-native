...
namespace Pulumi.AzureNative.Resources.V20180201
{
    ...
    public partial class ResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20180201:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20180201:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
