...
namespace Pulumi.AzureNextGen.Resources.V20180201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20180201:Deployment")]
    public partial class Deployment : Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20180201:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20180201:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
