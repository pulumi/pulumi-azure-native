...
namespace Pulumi.AzureRM.Resources.Preview
{
    public static class GetResourceGroup
    {
        public static Task<GetResourceGroupResult> InvokeAsync(GetResourceGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourceGroupResult>("azurerm:resources/preview:getResourceGroup", args ?? new GetResourceGroupArgs(), options.WithVersion());
    }
