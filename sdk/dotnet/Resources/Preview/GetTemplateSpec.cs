...
namespace Pulumi.AzureRM.Resources.Preview
{
    public static class GetTemplateSpec
    {
        public static Task<GetTemplateSpecResult> InvokeAsync(GetTemplateSpecArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTemplateSpecResult>("azurerm:resources/preview:getTemplateSpec", args ?? new GetTemplateSpecArgs(), options.WithVersion());
    }
