...
namespace Pulumi.AzureRM.Resources.Preview
{
    public static class GetDeploymentScript
    {
        public static Task<GetDeploymentScriptResult> InvokeAsync(GetDeploymentScriptArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentScriptResult>("azurerm:resources/preview:getDeploymentScript", args ?? new GetDeploymentScriptArgs(), options.WithVersion());
    }
