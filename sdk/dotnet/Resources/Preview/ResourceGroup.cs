...
namespace Pulumi.AzureRM.Resources.Preview
{
    ...
    public partial class ResourceGroup : Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/preview:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/preview:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
