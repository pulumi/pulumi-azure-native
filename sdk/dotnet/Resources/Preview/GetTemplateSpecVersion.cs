...
namespace Pulumi.AzureRM.Resources.Preview
{
    public static class GetTemplateSpecVersion
    {
        public static Task<GetTemplateSpecVersionResult> InvokeAsync(GetTemplateSpecVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTemplateSpecVersionResult>("azurerm:resources/preview:getTemplateSpecVersion", args ?? new GetTemplateSpecVersionArgs(), options.WithVersion());
    }
