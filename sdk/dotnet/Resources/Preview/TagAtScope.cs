...
namespace Pulumi.AzureRM.Resources.Preview
{
    ...
    public partial class TagAtScope : Pulumi.CustomResource
    {
        ...
        public TagAtScope(string name, TagAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/preview:TagAtScope", name, args ?? new TagAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/preview:TagAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
