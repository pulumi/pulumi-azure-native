...
namespace Pulumi.AzureRM.Resources.Preview
{
    public static class GetDeploymentAtScope
    {
        public static Task<GetDeploymentAtScopeResult> InvokeAsync(GetDeploymentAtScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentAtScopeResult>("azurerm:resources/preview:getDeploymentAtScope", args ?? new GetDeploymentAtScopeArgs(), options.WithVersion());
    }
