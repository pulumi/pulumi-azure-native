...
namespace Pulumi.AzureRM.Resources.Preview
{
    ...
    public partial class TemplateSpec : Pulumi.CustomResource
    {
        ...
        public TemplateSpec(string name, TemplateSpecArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/preview:TemplateSpec", name, args ?? new TemplateSpecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpec(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/preview:TemplateSpec", name, null, MakeResourceOptions(options, id))
        {
        }
