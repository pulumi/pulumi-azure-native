...
namespace Pulumi.AzureNextGen.Resources
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources:ResourceGroup")]
    public partial class ResourceGroup : Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
