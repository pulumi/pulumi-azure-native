...
namespace Pulumi.AzureNative.Resources.V20160201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20160201:Deployment")]
    public partial class Deployment : Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20160201:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20160201:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
