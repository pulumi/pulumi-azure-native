...
namespace Pulumi.AzureNextGen.Resources.V20201001Preview
{
    ...
    public partial class TemplateSpecVersion : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("uiDefinition")]
        public Output<object?> UiDefinition { get; private set; } = null!;
        ...
        public TemplateSpecVersion(string name, TemplateSpecVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20201001preview:TemplateSpecVersion", name, args ?? new TemplateSpecVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpecVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20201001preview:TemplateSpecVersion", name, null, MakeResourceOptions(options, id))
        {
        }
