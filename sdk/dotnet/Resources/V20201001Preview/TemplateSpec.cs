...
namespace Pulumi.AzureNextGen.Resources.V20201001Preview
{
    ...
    public partial class TemplateSpec : Pulumi.CustomResource
    {
        ...
        public TemplateSpec(string name, TemplateSpecArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20201001preview:TemplateSpec", name, args ?? new TemplateSpecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpec(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20201001preview:TemplateSpec", name, null, MakeResourceOptions(options, id))
        {
        }
