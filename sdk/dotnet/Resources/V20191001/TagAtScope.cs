...
namespace Pulumi.AzureRM.Resources.V20191001
{
    ...
    public partial class TagAtScope : Pulumi.CustomResource
    {
        ...
        public TagAtScope(string name, TagAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20191001:TagAtScope", name, args ?? new TagAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20191001:TagAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
