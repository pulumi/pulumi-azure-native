...
namespace Pulumi.AzureNextGen.Resources.V20191001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20191001:DeploymentAtTenantScope")]
    public partial class DeploymentAtTenantScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtTenantScope(string name, DeploymentAtTenantScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20191001:DeploymentAtTenantScope", name, args ?? new DeploymentAtTenantScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtTenantScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20191001:DeploymentAtTenantScope", name, null, MakeResourceOptions(options, id))
        {
        }
