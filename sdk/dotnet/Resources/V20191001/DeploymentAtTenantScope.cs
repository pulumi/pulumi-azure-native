...
namespace Pulumi.AzureNative.Resources.V20191001
{
    ...
    public partial class DeploymentAtTenantScope : global::Pulumi.CustomResource
    {
        ...
        public DeploymentAtTenantScope(string name, DeploymentAtTenantScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20191001:DeploymentAtTenantScope", name, args ?? new DeploymentAtTenantScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtTenantScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20191001:DeploymentAtTenantScope", name, null, MakeResourceOptions(options, id))
        {
        }
