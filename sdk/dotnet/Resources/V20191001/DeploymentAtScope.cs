...
namespace Pulumi.AzureNextGen.Resources.V20191001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20191001:DeploymentAtScope")]
    public partial class DeploymentAtScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtScope(string name, DeploymentAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20191001:DeploymentAtScope", name, args ?? new DeploymentAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20191001:DeploymentAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
