...
namespace Pulumi.AzureRM.Resources.V20191001
{
    public static class GetResourceGroup
    {
        public static Task<GetResourceGroupResult> InvokeAsync(GetResourceGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourceGroupResult>("azurerm:resources/v20191001:getResourceGroup", args ?? new GetResourceGroupArgs(), options.WithVersion());
    }
