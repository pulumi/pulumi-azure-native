...
namespace Pulumi.AzureNative.Resources.V20220801Preview
{
    ...
    public partial class DeploymentStackAtResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public DeploymentStackAtResourceGroup(string name, DeploymentStackAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220801preview:DeploymentStackAtResourceGroup", name, args ?? new DeploymentStackAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentStackAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220801preview:DeploymentStackAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:resources/v20240301:DeploymentStackAtResourceGroup" },
                    new global::Pulumi.Alias { Type = "azure-native:resources:DeploymentStackAtResourceGroup" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DeploymentStackAtResourceGroup Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DeploymentStackAtResourceGroup(name, id, options);
        }
    }

    public sealed class DeploymentStackAtResourceGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Defines the behavior of resources that are not managed immediately after the stack is updated.
        /// </summary>
        ...
        public DeploymentStackAtResourceGroupArgs()
        {
        }
        public static new DeploymentStackAtResourceGroupArgs Empty => new DeploymentStackAtResourceGroupArgs();
    }
}
