...
namespace Pulumi.AzureNative.Resources.V20220801Preview
{
    ...
    public partial class DeploymentStackAtSubscription : global::Pulumi.CustomResource
    {
        ...
        public DeploymentStackAtSubscription(string name, DeploymentStackAtSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220801preview:DeploymentStackAtSubscription", name, args ?? new DeploymentStackAtSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentStackAtSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220801preview:DeploymentStackAtSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
