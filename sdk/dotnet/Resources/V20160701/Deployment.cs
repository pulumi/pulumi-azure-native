...
namespace Pulumi.AzureNative.Resources.V20160701
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:resources/v20160701:Deployment myresource1 /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Resources/deployments/{deploymentName} 
    /// ```
    /// </summary>
    [Obsolete(@"Version 2016-07-01 will be removed in v2 of the provider.")]
    [AzureNativeResourceType("azure-native:resources/v20160701:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20160701:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20160701:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
