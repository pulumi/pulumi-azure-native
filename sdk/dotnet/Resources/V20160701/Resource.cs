...
namespace Pulumi.AzureRM.Resources.V20160701
{
    /// <summary>
    ...
    public partial class Resource : Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20160701:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20160701:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
