...
namespace Pulumi.AzureNative.Resources.V20210401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20210401:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210401:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210401:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
