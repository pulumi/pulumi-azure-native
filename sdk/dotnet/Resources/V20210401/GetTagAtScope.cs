...
namespace Pulumi.AzureNative.Resources.V20210401
{
    public static class GetTagAtScope
    {
        ...
        public static Task<GetTagAtScopeResult> InvokeAsync(GetTagAtScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagAtScopeResult>("azure-native:resources/v20210401:getTagAtScope", args ?? new GetTagAtScopeArgs(), options.WithVersion());

        /// <summary>
        /// Wrapper resource for tags API requests and responses.
        /// </summary>
        public static Output<GetTagAtScopeResult> Invoke(GetTagAtScopeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTagAtScopeResult>("azure-native:resources/v20210401:getTagAtScope", args ?? new GetTagAtScopeInvokeArgs(), options.WithVersion());
    }
