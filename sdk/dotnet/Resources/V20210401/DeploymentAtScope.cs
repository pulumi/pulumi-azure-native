...
namespace Pulumi.AzureNative.Resources.V20210401
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:resources/v20210401:DeploymentAtScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtScope to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:resources/v20210401:DeploymentAtScope")]
    public partial class DeploymentAtScope : global::Pulumi.CustomResource
    {
        ...
        public DeploymentAtScope(string name, DeploymentAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210401:DeploymentAtScope", name, args ?? new DeploymentAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210401:DeploymentAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
