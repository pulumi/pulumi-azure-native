...
namespace Pulumi.AzureNative.Resources.V20210301Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:resources/v20210301preview:TemplateSpec is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220201:TemplateSpec to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:resources/v20210301preview:TemplateSpec")]
    public partial class TemplateSpec : global::Pulumi.CustomResource
    {
        ...
        public TemplateSpec(string name, TemplateSpecArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210301preview:TemplateSpec", name, args ?? new TemplateSpecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpec(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210301preview:TemplateSpec", name, null, MakeResourceOptions(options, id))
        {
        }
