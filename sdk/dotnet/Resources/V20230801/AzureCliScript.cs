...
namespace Pulumi.AzureNative.Resources.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20230801:AzureCliScript")]
    public partial class AzureCliScript : global::Pulumi.CustomResource
    {
        ...
        public AzureCliScript(string name, AzureCliScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20230801:AzureCliScript", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AzureCliScript(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20230801:AzureCliScript", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AzureCliScriptArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Resources.V20230801.CleanupOptions>? CleanupPreference { get; set; }
