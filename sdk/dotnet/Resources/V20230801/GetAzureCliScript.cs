...
namespace Pulumi.AzureNative.Resources.V20230801
{
    public static class GetAzureCliScript
    {
        ...
        public static Task<GetAzureCliScriptResult> InvokeAsync(GetAzureCliScriptArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAzureCliScriptResult>("azure-native:resources/v20230801:getAzureCliScript", args ?? new GetAzureCliScriptArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a deployment script with a given name.
        /// </summary>
        public static Output<GetAzureCliScriptResult> Invoke(GetAzureCliScriptInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAzureCliScriptResult>("azure-native:resources/v20230801:getAzureCliScript", args ?? new GetAzureCliScriptInvokeArgs(), options.WithDefaults());
    }
