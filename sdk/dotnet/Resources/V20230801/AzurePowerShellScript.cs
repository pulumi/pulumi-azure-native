...
namespace Pulumi.AzureNative.Resources.V20230801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20230801:AzurePowerShellScript")]
    public partial class AzurePowerShellScript : global::Pulumi.CustomResource
    {
        ...
        public AzurePowerShellScript(string name, AzurePowerShellScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20230801:AzurePowerShellScript", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AzurePowerShellScript(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20230801:AzurePowerShellScript", name, null, MakeResourceOptions(options, id))
        {
        }
