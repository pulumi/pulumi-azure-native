...
namespace Pulumi.AzureRM.Resources.V20170510
{
    ...
    public partial class Resource : Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20170510:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20170510:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
