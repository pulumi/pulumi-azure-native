...
namespace Pulumi.AzureNextGen.Resources.V20170510
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20170510:ResourceGroup")]
    public partial class ResourceGroup : Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20170510:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20170510:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
