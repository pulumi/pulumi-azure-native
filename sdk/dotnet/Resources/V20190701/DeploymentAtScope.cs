...
namespace Pulumi.AzureNextGen.Resources.V20190701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20190701:DeploymentAtScope")]
    public partial class DeploymentAtScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtScope(string name, DeploymentAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190701:DeploymentAtScope", name, args ?? new DeploymentAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190701:DeploymentAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
