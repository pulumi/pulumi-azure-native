...
namespace Pulumi.AzureNextGen.Resources.V20190701
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20190701:DeploymentAtTenantScope")]
    public partial class DeploymentAtTenantScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtTenantScope(string name, DeploymentAtTenantScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190701:DeploymentAtTenantScope", name, args ?? new DeploymentAtTenantScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtTenantScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190701:DeploymentAtTenantScope", name, null, MakeResourceOptions(options, id))
        {
        }
