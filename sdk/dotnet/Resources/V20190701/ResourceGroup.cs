...
namespace Pulumi.AzureRM.Resources.V20190701
{
    ...
    ///     public MyStack()
    ///     {
    ///         var resourceGroup = new AzureRM.Resources.V20190701.ResourceGroup("resourceGroup", new AzureRM.Resources.V20190701.ResourceGroupArgs
    ///         {
    ///             Location = "eastus",
    ...
    public partial class ResourceGroup : Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20190701:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20190701:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
