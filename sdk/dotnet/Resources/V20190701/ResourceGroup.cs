...
namespace Pulumi.AzureNative.Resources.V20190701
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:resources/v20190701:ResourceGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:ResourceGroup to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:resources/v20190701:ResourceGroup")]
    public partial class ResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190701:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190701:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
