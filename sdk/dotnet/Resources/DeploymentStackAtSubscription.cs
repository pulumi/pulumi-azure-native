...
namespace Pulumi.AzureNative.Resources
{
    ...
    public partial class DeploymentStackAtSubscription : global::Pulumi.CustomResource
    {
        ...
        public DeploymentStackAtSubscription(string name, DeploymentStackAtSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources:DeploymentStackAtSubscription", name, args ?? new DeploymentStackAtSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentStackAtSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources:DeploymentStackAtSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:resources/v20250701:DeploymentStackAtSubscription" },
                },
            };
