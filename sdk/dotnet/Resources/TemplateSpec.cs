...
namespace Pulumi.AzureNative.Resources
{
    ...
    public partial class TemplateSpec : global::Pulumi.CustomResource
    {
        ...
        public TemplateSpec(string name, TemplateSpecArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources:TemplateSpec", name, args ?? new TemplateSpecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpec(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources:TemplateSpec", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_resources_v20190601preview:resources:TemplateSpec" },
                    new global::Pulumi.Alias { Type = "azure-native_resources_v20210301preview:resources:TemplateSpec" },
                    new global::Pulumi.Alias { Type = "azure-native_resources_v20210501:resources:TemplateSpec" },
                    new global::Pulumi.Alias { Type = "azure-native_resources_v20220201:resources:TemplateSpec" },
                },
            };
