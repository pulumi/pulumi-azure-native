...
namespace Pulumi.AzureRM.Resources.Latest
{
    public static class GetResourceGroup
    {
        public static Task<GetResourceGroupResult> InvokeAsync(GetResourceGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourceGroupResult>("azurerm:resources/latest:getResourceGroup", args ?? new GetResourceGroupArgs(), options.WithVersion());
    }
