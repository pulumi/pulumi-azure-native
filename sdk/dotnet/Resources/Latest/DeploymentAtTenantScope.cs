...
namespace Pulumi.AzureRM.Resources.Latest
{
    ...
    public partial class DeploymentAtTenantScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtTenantScope(string name, DeploymentAtTenantScopeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/latest:DeploymentAtTenantScope", name, args ?? new DeploymentAtTenantScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtTenantScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/latest:DeploymentAtTenantScope", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:resources/preview:DeploymentAtTenantScope"},
