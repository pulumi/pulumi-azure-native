...
namespace Pulumi.AzureRM.Resources.Latest
{
    public static class GetTemplateSpec
    {
        public static Task<GetTemplateSpecResult> InvokeAsync(GetTemplateSpecArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTemplateSpecResult>("azurerm:resources/latest:getTemplateSpec", args ?? new GetTemplateSpecArgs(), options.WithVersion());
    }
