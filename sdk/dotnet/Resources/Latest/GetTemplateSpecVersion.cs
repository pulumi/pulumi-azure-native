...
namespace Pulumi.AzureRM.Resources.Latest
{
    public static class GetTemplateSpecVersion
    {
        public static Task<GetTemplateSpecVersionResult> InvokeAsync(GetTemplateSpecVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTemplateSpecVersionResult>("azurerm:resources/latest:getTemplateSpecVersion", args ?? new GetTemplateSpecVersionArgs(), options.WithVersion());
    }
