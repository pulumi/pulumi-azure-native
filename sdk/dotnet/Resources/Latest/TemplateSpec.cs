...
namespace Pulumi.AzureRM.Resources.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var templateSpec = new AzureRM.Resources.Latest.TemplateSpec("templateSpec", new AzureRM.Resources.Latest.TemplateSpecArgs
    ///         {
    ...
    public partial class TemplateSpec : Pulumi.CustomResource
    {
        ...
        public TemplateSpec(string name, TemplateSpecArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/latest:TemplateSpec", name, args ?? new TemplateSpecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpec(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/latest:TemplateSpec", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:resources/v20190601preview:TemplateSpec"},
                },
            };
