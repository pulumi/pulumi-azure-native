...
namespace Pulumi.AzureRM.Resources.Latest
{
    public static class GetDeploymentScript
    {
        public static Task<GetDeploymentScriptResult> InvokeAsync(GetDeploymentScriptArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentScriptResult>("azurerm:resources/latest:getDeploymentScript", args ?? new GetDeploymentScriptArgs(), options.WithVersion());
    }
