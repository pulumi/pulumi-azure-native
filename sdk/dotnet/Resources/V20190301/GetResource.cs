...
namespace Pulumi.AzureNative.Resources.V20190301
{
    [Obsolete(@"Version 2019-03-01 will be removed in v2 of the provider.
azure-native:resources/v20190301:Resource is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:Resource to guarantee forwards compatibility.")]
    public static class GetResource
    {
        ...
        public static Task<GetResourceResult> InvokeAsync(GetResourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResourceResult>("azure-native:resources/v20190301:getResource", args ?? new GetResourceArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a resource.
        /// </summary>
        public static Output<GetResourceResult> Invoke(GetResourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetResourceResult>("azure-native:resources/v20190301:getResource", args ?? new GetResourceInvokeArgs(), options.WithDefaults());
    }
