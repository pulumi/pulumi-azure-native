...
namespace Pulumi.AzureNextGen.Resources.V20190301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20190301:DeploymentAtSubscriptionScope")]
    public partial class DeploymentAtSubscriptionScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtSubscriptionScope(string name, DeploymentAtSubscriptionScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190301:DeploymentAtSubscriptionScope", name, args ?? new DeploymentAtSubscriptionScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtSubscriptionScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190301:DeploymentAtSubscriptionScope", name, null, MakeResourceOptions(options, id))
        {
        }
