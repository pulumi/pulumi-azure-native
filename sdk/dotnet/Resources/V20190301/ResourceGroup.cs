...
namespace Pulumi.AzureNative.Resources.V20190301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20190301:ResourceGroup")]
    public partial class ResourceGroup : Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190301:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190301:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
