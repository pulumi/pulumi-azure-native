...
namespace Pulumi.AzureNextGen.Resources.V20190301
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20190301:ResourceGroup")]
    public partial class ResourceGroup : Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190301:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190301:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
