...
namespace Pulumi.AzureNative.Resources.V20200801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20200801:DeploymentAtManagementGroupScope")]
    public partial class DeploymentAtManagementGroupScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtManagementGroupScope(string name, DeploymentAtManagementGroupScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20200801:DeploymentAtManagementGroupScope", name, args ?? new DeploymentAtManagementGroupScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtManagementGroupScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20200801:DeploymentAtManagementGroupScope", name, null, MakeResourceOptions(options, id))
        {
        }
