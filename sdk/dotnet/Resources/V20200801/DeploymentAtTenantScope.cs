...
namespace Pulumi.AzureNative.Resources.V20200801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20200801:DeploymentAtTenantScope")]
    public partial class DeploymentAtTenantScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtTenantScope(string name, DeploymentAtTenantScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20200801:DeploymentAtTenantScope", name, args ?? new DeploymentAtTenantScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtTenantScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20200801:DeploymentAtTenantScope", name, null, MakeResourceOptions(options, id))
        {
        }
