...
namespace Pulumi.AzureNextGen.Resources.V20200801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20200801:Resource")]
    public partial class Resource : Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20200801:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20200801:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
