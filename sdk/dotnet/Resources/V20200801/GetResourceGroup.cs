...
namespace Pulumi.AzureNextGen.Resources.V20200801
{
    public static class GetResourceGroup
    {
        ...
        public static Task<GetResourceGroupResult> InvokeAsync(GetResourceGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourceGroupResult>("azure-nextgen:resources/v20200801:getResourceGroup", args ?? new GetResourceGroupArgs(), options.WithVersion());
    }
