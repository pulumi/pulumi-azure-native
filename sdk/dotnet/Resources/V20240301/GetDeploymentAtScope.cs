...
namespace Pulumi.AzureNative.Resources.V20240301
{
    public static class GetDeploymentAtScope
    {
        ...
        public static Task<GetDeploymentAtScopeResult> InvokeAsync(GetDeploymentAtScopeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentAtScopeResult>("azure-native:resources/v20240301:getDeploymentAtScope", args ?? new GetDeploymentAtScopeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets a deployment.
        /// </summary>
        public static Output<GetDeploymentAtScopeResult> Invoke(GetDeploymentAtScopeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDeploymentAtScopeResult>("azure-native:resources/v20240301:getDeploymentAtScope", args ?? new GetDeploymentAtScopeInvokeArgs(), options.WithDefaults());
    }
