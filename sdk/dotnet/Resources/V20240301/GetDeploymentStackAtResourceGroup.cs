...
namespace Pulumi.AzureNative.Resources.V20240301
{
    public static class GetDeploymentStackAtResourceGroup
    {
        ...
        public static Task<GetDeploymentStackAtResourceGroupResult> InvokeAsync(GetDeploymentStackAtResourceGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentStackAtResourceGroupResult>("azure-native:resources/v20240301:getDeploymentStackAtResourceGroup", args ?? new GetDeploymentStackAtResourceGroupArgs(), options.WithDefaults());
