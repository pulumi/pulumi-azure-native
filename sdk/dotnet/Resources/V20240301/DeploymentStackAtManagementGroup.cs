...
namespace Pulumi.AzureNative.Resources.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20240301:DeploymentStackAtManagementGroup")]
    public partial class DeploymentStackAtManagementGroup : global::Pulumi.CustomResource
    {
        ...
        public DeploymentStackAtManagementGroup(string name, DeploymentStackAtManagementGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20240301:DeploymentStackAtManagementGroup", name, args ?? new DeploymentStackAtManagementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentStackAtManagementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20240301:DeploymentStackAtManagementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
