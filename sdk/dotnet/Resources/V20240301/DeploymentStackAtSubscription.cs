...
namespace Pulumi.AzureNative.Resources.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20240301:DeploymentStackAtSubscription")]
    public partial class DeploymentStackAtSubscription : global::Pulumi.CustomResource
    {
        ...
        public DeploymentStackAtSubscription(string name, DeploymentStackAtSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20240301:DeploymentStackAtSubscription", name, args ?? new DeploymentStackAtSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentStackAtSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20240301:DeploymentStackAtSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:resources:DeploymentStackAtSubscription" },
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DeploymentStackAtSubscription Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DeploymentStackAtSubscription(name, id, options);
        }
    }
    ...
    public sealed class DeploymentStackAtSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        public DeploymentStackAtSubscriptionArgs()
        {
        }
        public static new DeploymentStackAtSubscriptionArgs Empty => new DeploymentStackAtSubscriptionArgs();
    }
}
