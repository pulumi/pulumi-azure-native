...
namespace Pulumi.AzureNative.Resources.V20240301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20240301:DeploymentStackAtResourceGroup")]
    public partial class DeploymentStackAtResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public DeploymentStackAtResourceGroup(string name, DeploymentStackAtResourceGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20240301:DeploymentStackAtResourceGroup", name, args ?? new DeploymentStackAtResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentStackAtResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20240301:DeploymentStackAtResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
