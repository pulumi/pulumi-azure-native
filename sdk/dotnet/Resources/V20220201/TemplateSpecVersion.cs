...
namespace Pulumi.AzureNative.Resources.V20220201
{
    ...
    /// {
    ///     var templateSpecVersion = new AzureNative.Resources.V20220201.TemplateSpecVersion("templateSpecVersion", new()
    ///     {
    ...
    public partial class TemplateSpecVersion : global::Pulumi.CustomResource
    {
        ...
        public TemplateSpecVersion(string name, TemplateSpecVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220201:TemplateSpecVersion", name, args ?? new TemplateSpecVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpecVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220201:TemplateSpecVersion", name, null, MakeResourceOptions(options, id))
        {
        }
