...
namespace Pulumi.AzureNextGen.Resources
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources:TemplateSpecVersion")]
    public partial class TemplateSpecVersion : Pulumi.CustomResource
    {
        ...
        public TemplateSpecVersion(string name, TemplateSpecVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources:TemplateSpecVersion", name, args ?? new TemplateSpecVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpecVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources:TemplateSpecVersion", name, null, MakeResourceOptions(options, id))
        {
        }
