...
namespace Pulumi.AzureNative.Resources.V20180501
{
    ...
    public partial class Resource : Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20180501:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20180501:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
