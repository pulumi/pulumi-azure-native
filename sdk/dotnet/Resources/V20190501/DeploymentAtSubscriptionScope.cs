...
namespace Pulumi.AzureNextGen.Resources.V20190501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20190501:DeploymentAtSubscriptionScope")]
    public partial class DeploymentAtSubscriptionScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtSubscriptionScope(string name, DeploymentAtSubscriptionScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190501:DeploymentAtSubscriptionScope", name, args ?? new DeploymentAtSubscriptionScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtSubscriptionScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190501:DeploymentAtSubscriptionScope", name, null, MakeResourceOptions(options, id))
        {
        }
