...
namespace Pulumi.AzureNextGen.Resources.V20190501
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20190501:ResourceGroup")]
    public partial class ResourceGroup : Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190501:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190501:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
