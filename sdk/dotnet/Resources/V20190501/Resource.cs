...
namespace Pulumi.AzureNative.Resources.V20190501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:resources/v20190501:Resource is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:Resource to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:resources/v20190501:Resource")]
    public partial class Resource : global::Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190501:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190501:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
