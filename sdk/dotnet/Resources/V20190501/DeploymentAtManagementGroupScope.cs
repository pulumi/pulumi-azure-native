...
namespace Pulumi.AzureNative.Resources.V20190501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20190501:DeploymentAtManagementGroupScope")]
    public partial class DeploymentAtManagementGroupScope : global::Pulumi.CustomResource
    {
        ...
        public DeploymentAtManagementGroupScope(string name, DeploymentAtManagementGroupScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190501:DeploymentAtManagementGroupScope", name, args ?? new DeploymentAtManagementGroupScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtManagementGroupScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190501:DeploymentAtManagementGroupScope", name, null, MakeResourceOptions(options, id))
        {
        }
