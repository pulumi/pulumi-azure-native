...
namespace Pulumi.AzureNative.Resources.V20210501
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:resources/v20210501:TemplateSpecVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220201:TemplateSpecVersion to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:resources/v20210501:TemplateSpecVersion")]
    public partial class TemplateSpecVersion : global::Pulumi.CustomResource
    {
        ...
        public TemplateSpecVersion(string name, TemplateSpecVersionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210501:TemplateSpecVersion", name, args ?? new TemplateSpecVersionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpecVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210501:TemplateSpecVersion", name, null, MakeResourceOptions(options, id))
        {
        }
