...
namespace Pulumi.AzureNative.Resources.V20210501
{
    ...
    public partial class TemplateSpec : global::Pulumi.CustomResource
    {
        ...
        public TemplateSpec(string name, TemplateSpecArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210501:TemplateSpec", name, args ?? new TemplateSpecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateSpec(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20210501:TemplateSpec", name, null, MakeResourceOptions(options, id))
        {
        }
