...
namespace Pulumi.AzureRM.Resources.V20200601
{
    public static class GetDeploymentAtScope
    {
        public static Task<GetDeploymentAtScopeResult> InvokeAsync(GetDeploymentAtScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentAtScopeResult>("azurerm:resources/v20200601:getDeploymentAtScope", args ?? new GetDeploymentAtScopeArgs(), options.WithVersion());
    }
