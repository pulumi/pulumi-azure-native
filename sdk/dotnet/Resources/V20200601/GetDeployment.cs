...
namespace Pulumi.AzureNative.Resources.V20200601
{
    public static class GetDeployment
    {
        ...
        public static Task<GetDeploymentResult> InvokeAsync(GetDeploymentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentResult>("azure-native:resources/v20200601:getDeployment", args ?? new GetDeploymentArgs(), options.WithVersion());

        /// <summary>
        /// Deployment information.
        /// </summary>
        public static Output<GetDeploymentResult> Invoke(GetDeploymentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDeploymentResult>("azure-native:resources/v20200601:getDeployment", args ?? new GetDeploymentInvokeArgs(), options.WithVersion());
    }
