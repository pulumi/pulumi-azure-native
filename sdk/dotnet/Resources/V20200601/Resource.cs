...
namespace Pulumi.AzureNative.Resources.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20200601:Resource")]
    public partial class Resource : global::Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20200601:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20200601:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
