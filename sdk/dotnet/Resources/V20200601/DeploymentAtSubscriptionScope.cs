...
namespace Pulumi.AzureNative.Resources.V20200601
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20200601:DeploymentAtSubscriptionScope")]
    public partial class DeploymentAtSubscriptionScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtSubscriptionScope(string name, DeploymentAtSubscriptionScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20200601:DeploymentAtSubscriptionScope", name, args ?? new DeploymentAtSubscriptionScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtSubscriptionScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20200601:DeploymentAtSubscriptionScope", name, null, MakeResourceOptions(options, id))
        {
        }
