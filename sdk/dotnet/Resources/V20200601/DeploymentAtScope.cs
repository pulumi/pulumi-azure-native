...
namespace Pulumi.AzureNextGen.Resources.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20200601:DeploymentAtScope")]
    public partial class DeploymentAtScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtScope(string name, DeploymentAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20200601:DeploymentAtScope", name, args ?? new DeploymentAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20200601:DeploymentAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
