...
namespace Pulumi.AzureRM.Resources.V20200601
{
    ...
    public partial class DeploymentAtScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtScope(string name, DeploymentAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20200601:DeploymentAtScope", name, args ?? new DeploymentAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20200601:DeploymentAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:resources/latest:DeploymentAtScope"},
                    new Pulumi.Alias { Type = "azurerm:resources/preview:DeploymentAtScope"},
                    new Pulumi.Alias { Type = "azurerm:resources/v20190701:DeploymentAtScope"},
