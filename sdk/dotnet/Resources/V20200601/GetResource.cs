...
namespace Pulumi.AzureNative.Resources.V20200601
{
    public static class GetResource
    {
        ...
        public static Task<GetResourceResult> InvokeAsync(GetResourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourceResult>("azure-native:resources/v20200601:getResource", args ?? new GetResourceArgs(), options.WithVersion());

        /// <summary>
        /// Resource information.
        /// </summary>
        public static Output<GetResourceResult> Invoke(GetResourceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetResourceResult>("azure-native:resources/v20200601:getResource", args ?? new GetResourceInvokeArgs(), options.WithVersion());
    }
