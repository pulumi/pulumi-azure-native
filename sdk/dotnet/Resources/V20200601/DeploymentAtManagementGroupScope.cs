...
namespace Pulumi.AzureNextGen.Resources.V20200601
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20200601:DeploymentAtManagementGroupScope")]
    public partial class DeploymentAtManagementGroupScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtManagementGroupScope(string name, DeploymentAtManagementGroupScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20200601:DeploymentAtManagementGroupScope", name, args ?? new DeploymentAtManagementGroupScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtManagementGroupScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20200601:DeploymentAtManagementGroupScope", name, null, MakeResourceOptions(options, id))
        {
        }
