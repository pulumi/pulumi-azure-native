...
namespace Pulumi.AzureNative.Resources.V20160901
{
    /// <summary>
    /// Resource information.
    /// </summary>
    [Obsolete(@"Version 2016-09-01 will be removed in v2 of the provider.
azure-native:resources/v20160901:Resource is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:Resource to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:resources/v20160901:Resource")]
    public partial class Resource : global::Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20160901:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20160901:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
