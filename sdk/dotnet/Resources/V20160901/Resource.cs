...
namespace Pulumi.AzureNextGen.Resources.V20160901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20160901:Resource")]
    public partial class Resource : Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20160901:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20160901:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
