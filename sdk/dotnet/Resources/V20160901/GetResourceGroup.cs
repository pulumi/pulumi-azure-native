...
namespace Pulumi.AzureRM.Resources.V20160901
{
    public static class GetResourceGroup
    {
        public static Task<GetResourceGroupResult> InvokeAsync(GetResourceGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourceGroupResult>("azurerm:resources/v20160901:getResourceGroup", args ?? new GetResourceGroupArgs(), options.WithVersion());
    }
