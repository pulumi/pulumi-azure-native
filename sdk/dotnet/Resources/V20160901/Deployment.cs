...
namespace Pulumi.AzureNative.Resources.V20160901
{
    ...
    [AzureNativeResourceType("azure-native:resources/v20160901:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20160901:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20160901:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
