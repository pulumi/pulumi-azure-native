...
namespace Pulumi.AzureNextGen.Resources.V20160901
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20160901:ResourceGroup")]
    public partial class ResourceGroup : Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20160901:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20160901:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
