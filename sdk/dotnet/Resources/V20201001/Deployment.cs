...
namespace Pulumi.AzureNative.Resources.V20201001
{
    ...
    [AzureNativeResourceType("azure-native:resources/v20201001:Deployment")]
    public partial class Deployment : global::Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20201001:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20201001:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
