...
namespace Pulumi.AzureNextGen.Resources.V20201001
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20201001:TagAtScope")]
    public partial class TagAtScope : Pulumi.CustomResource
    {
        ...
        public TagAtScope(string name, TagAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20201001:TagAtScope", name, args ?? new TagAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20201001:TagAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
