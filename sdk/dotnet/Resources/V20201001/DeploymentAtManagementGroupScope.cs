...
namespace Pulumi.AzureNative.Resources.V20201001
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20201001:DeploymentAtManagementGroupScope")]
    public partial class DeploymentAtManagementGroupScope : global::Pulumi.CustomResource
    {
        ...
        public DeploymentAtManagementGroupScope(string name, DeploymentAtManagementGroupScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20201001:DeploymentAtManagementGroupScope", name, args ?? new DeploymentAtManagementGroupScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtManagementGroupScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20201001:DeploymentAtManagementGroupScope", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:resources/v20230701:DeploymentAtManagementGroupScope" },
                    new global::Pulumi.Alias { Type = "azure-native:resources/v20240301:DeploymentAtManagementGroupScope" },
                    new global::Pulumi.Alias { Type = "azure-native:resources/v20240701:DeploymentAtManagementGroupScope" },
                    new global::Pulumi.Alias { Type = "azure-native:resources/v20241101:DeploymentAtManagementGroupScope" },
                },
            };
