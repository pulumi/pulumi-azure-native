...
namespace Pulumi.AzureNative.Resources.V20201001
{
    ...
    /// {
    ///     var azureCliScript = new AzureNative.Resources.V20201001.AzureCliScript("azureCliScript", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20201001:AzureCliScript")]
    public partial class AzureCliScript : global::Pulumi.CustomResource
    {
        ...
        public AzureCliScript(string name, AzureCliScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20201001:AzureCliScript", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AzureCliScript(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20201001:AzureCliScript", name, null, MakeResourceOptions(options, id))
        {
        }
