...
namespace Pulumi.AzureNextGen.Resources.V20201001
{
    public static class GetDeployment
    {
        public static Task<GetDeploymentResult> InvokeAsync(GetDeploymentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentResult>("azure-nextgen:resources/v20201001:getDeployment", args ?? new GetDeploymentArgs(), options.WithVersion());
    }
