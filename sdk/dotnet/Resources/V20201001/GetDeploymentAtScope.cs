...
namespace Pulumi.AzureNextGen.Resources.V20201001
{
    public static class GetDeploymentAtScope
    {
        public static Task<GetDeploymentAtScopeResult> InvokeAsync(GetDeploymentAtScopeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentAtScopeResult>("azure-nextgen:resources/v20201001:getDeploymentAtScope", args ?? new GetDeploymentAtScopeArgs(), options.WithVersion());
    }
