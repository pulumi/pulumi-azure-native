...
namespace Pulumi.AzureRM.Resources.V20190510
{
    ...
    ///     public MyStack()
    ///     {
    ///         var deployment = new AzureRM.Resources.V20190510.Deployment("deployment", new AzureRM.Resources.V20190510.DeploymentArgs
    ///         {
    ...
    public partial class Deployment : Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20190510:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20190510:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:resources/v20190501:Deployment"},
