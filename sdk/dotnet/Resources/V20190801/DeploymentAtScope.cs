...
namespace Pulumi.AzureRM.Resources.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var deploymentAtScope = new AzureRM.Resources.V20190801.DeploymentAtScope("deploymentAtScope", new AzureRM.Resources.V20190801.DeploymentAtScopeArgs
    ///         {
    ...
    public partial class DeploymentAtScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtScope(string name, DeploymentAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20190801:DeploymentAtScope", name, args ?? new DeploymentAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20190801:DeploymentAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
