...
namespace Pulumi.AzureRM.Resources.V20190801
{
    ...
    ///     public MyStack()
    ///     {
    ///         var deployment = new AzureRM.Resources.V20190801.Deployment("deployment", new AzureRM.Resources.V20190801.DeploymentArgs
    ///         {
    ...
    public partial class Deployment : Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20190801:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:resources/v20190801:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
