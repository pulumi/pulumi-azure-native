...
namespace Pulumi.AzureNextGen.Resources.V20190801
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:resources/v20190801:DeploymentAtManagementGroupScope")]
    public partial class DeploymentAtManagementGroupScope : Pulumi.CustomResource
    {
        ...
        public DeploymentAtManagementGroupScope(string name, DeploymentAtManagementGroupScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190801:DeploymentAtManagementGroupScope", name, args ?? new DeploymentAtManagementGroupScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtManagementGroupScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:resources/v20190801:DeploymentAtManagementGroupScope", name, null, MakeResourceOptions(options, id))
        {
        }
