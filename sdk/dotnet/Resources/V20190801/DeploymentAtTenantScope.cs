...
namespace Pulumi.AzureNative.Resources.V20190801
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:resources/v20190801:DeploymentAtTenantScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:resources/v20190801:DeploymentAtTenantScope")]
    public partial class DeploymentAtTenantScope : global::Pulumi.CustomResource
    {
        ...
        public DeploymentAtTenantScope(string name, DeploymentAtTenantScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190801:DeploymentAtTenantScope", name, args ?? new DeploymentAtTenantScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtTenantScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20190801:DeploymentAtTenantScope", name, null, MakeResourceOptions(options, id))
        {
        }
