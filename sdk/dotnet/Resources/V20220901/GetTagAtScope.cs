...
namespace Pulumi.AzureNative.Resources.V20220901
{
    public static class GetTagAtScope
    {
        ...
        public static Task<GetTagAtScopeResult> InvokeAsync(GetTagAtScopeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagAtScopeResult>("azure-native:resources/v20220901:getTagAtScope", args ?? new GetTagAtScopeArgs(), options.WithDefaults());

        /// <summary>
        /// Wrapper resource for tags API requests and responses.
        /// </summary>
        public static Output<GetTagAtScopeResult> Invoke(GetTagAtScopeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTagAtScopeResult>("azure-native:resources/v20220901:getTagAtScope", args ?? new GetTagAtScopeInvokeArgs(), options.WithDefaults());
    }
