...
namespace Pulumi.AzureNative.Resources.V20220901
{
    ...
    /// {
    ///     var deploymentAtScope = new AzureNative.Resources.V20220901.DeploymentAtScope("deploymentAtScope", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20220901:DeploymentAtScope")]
    public partial class DeploymentAtScope : global::Pulumi.CustomResource
    {
        ...
        public DeploymentAtScope(string name, DeploymentAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220901:DeploymentAtScope", name, args ?? new DeploymentAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220901:DeploymentAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
