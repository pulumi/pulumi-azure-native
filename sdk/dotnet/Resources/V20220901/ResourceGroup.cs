...
namespace Pulumi.AzureNative.Resources.V20220901
{
    ...
    /// {
    ///     var resourceGroup = new AzureNative.Resources.V20220901.ResourceGroup("resourceGroup", new()
    ///     {
    ///         Location = "eastus",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20220901:ResourceGroup")]
    public partial class ResourceGroup : global::Pulumi.CustomResource
    {
        ...
        public ResourceGroup(string name, ResourceGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220901:ResourceGroup", name, args ?? new ResourceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220901:ResourceGroup", name, null, MakeResourceOptions(options, id))
        {
        }
