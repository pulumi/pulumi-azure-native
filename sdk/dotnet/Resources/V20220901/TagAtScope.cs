...
namespace Pulumi.AzureNative.Resources.V20220901
{
    ...
    public partial class TagAtScope : global::Pulumi.CustomResource
    {
        ...
        public TagAtScope(string name, TagAtScopeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220901:TagAtScope", name, args ?? new TagAtScopeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagAtScope(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20220901:TagAtScope", name, null, MakeResourceOptions(options, id))
        {
        }
