...
namespace Pulumi.AzureNative.Resources.V20191001Preview
{
    ...
    /// {
    ///     var azureCliScript = new AzureNative.Resources.V20191001Preview.AzureCliScript("azureCliScript", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:resources/v20191001preview:AzureCliScript")]
    public partial class AzureCliScript : global::Pulumi.CustomResource
    {
        ...
        public AzureCliScript(string name, AzureCliScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20191001preview:AzureCliScript", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private AzureCliScript(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20191001preview:AzureCliScript", name, null, MakeResourceOptions(options, id))
        {
        }
