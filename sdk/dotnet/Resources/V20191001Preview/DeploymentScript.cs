...
namespace Pulumi.AzureNative.Resources.V20191001Preview
{
    ...
    [AzureNativeResourceType("azure-native:resources/v20191001preview:DeploymentScript")]
    public partial class DeploymentScript : global::Pulumi.CustomResource
    {
        ...
        public DeploymentScript(string name, DeploymentScriptArgs args, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20191001preview:DeploymentScript", name, args ?? new DeploymentScriptArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentScript(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:resources/v20191001preview:DeploymentScript", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:resources:DeploymentScript"},
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DeploymentScript Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class DeploymentScriptArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Resources.V20191001Preview.ScriptType> Kind { get; set; } = null!;
