...
namespace Pulumi.AzureNative.TrafficManager.V20180401
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:trafficmanager/v20180401:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20180401:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20180401:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
