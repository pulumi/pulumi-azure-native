...
namespace Pulumi.AzureNative.TrafficManager.V20220401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:trafficmanager/v20220401preview:TrafficManagerUserMetricsKey")]
    public partial class TrafficManagerUserMetricsKey : global::Pulumi.CustomResource
    {
        ...
        public TrafficManagerUserMetricsKey(string name, TrafficManagerUserMetricsKeyArgs? args = null, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20220401preview:TrafficManagerUserMetricsKey", name, args ?? new TrafficManagerUserMetricsKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TrafficManagerUserMetricsKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20220401preview:TrafficManagerUserMetricsKey", name, null, MakeResourceOptions(options, id))
        {
        }
