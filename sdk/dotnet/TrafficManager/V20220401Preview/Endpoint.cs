...
namespace Pulumi.AzureNative.TrafficManager.V20220401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:trafficmanager/v20220401preview:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20220401preview:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20220401preview:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
