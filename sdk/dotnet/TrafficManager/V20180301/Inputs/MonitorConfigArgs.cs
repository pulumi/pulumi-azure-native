...
namespace Pulumi.AzureNative.TrafficManager.V20180301.Inputs
{
    ...
    public sealed class MonitorConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TrafficManager.V20180301.ProfileMonitorStatus>? ProfileMonitorStatus { get; set; }

        /// <summary>
        /// The protocol (HTTP, HTTPS or TCP) used to probe for endpoint health.
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.TrafficManager.V20180301.MonitorProtocol>? Protocol { get; set; }
