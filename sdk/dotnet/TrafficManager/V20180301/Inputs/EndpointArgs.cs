...
namespace Pulumi.AzureNative.TrafficManager.V20180301.Inputs
{
    ...
    public sealed class EndpointArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TrafficManager.V20180301.EndpointMonitorStatus>? EndpointMonitorStatus { get; set; }

        /// <summary>
        /// The status of the endpoint. If the endpoint is Enabled, it is probed for endpoint health and is included in the traffic routing method.
        /// </summary>
        [Input("endpointStatus")]
        public InputUnion<string, Pulumi.AzureNative.TrafficManager.V20180301.EndpointStatus>? EndpointStatus { get; set; }
