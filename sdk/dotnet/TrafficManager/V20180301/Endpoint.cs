...
namespace Pulumi.AzureNative.TrafficManager.V20180301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:trafficmanager/v20180301:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20180301:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20180301:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
