...
namespace Pulumi.AzureNative.TrafficManager.V20180301
{
    /// <summary>
    /// Class representing a Traffic Manager profile.
    /// </summary>
    [AzureNativeResourceType("azure-native:trafficmanager/v20180301:Profile")]
    public partial class Profile : global::Pulumi.CustomResource
    {
        ...
        public Profile(string name, ProfileArgs args, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20180301:Profile", name, args ?? new ProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Profile(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:trafficmanager/v20180301:Profile", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("profileStatus")]
        public InputUnion<string, Pulumi.AzureNative.TrafficManager.V20180301.ProfileStatus>? ProfileStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.TrafficManager.V20180301.TrafficRoutingMethod>? TrafficRoutingMethod { get; set; }

        /// <summary>
        /// Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.
        /// </summary>
        [Input("trafficViewEnrollmentStatus")]
        public InputUnion<string, Pulumi.AzureNative.TrafficManager.V20180301.TrafficViewEnrollmentStatus>? TrafficViewEnrollmentStatus { get; set; }
