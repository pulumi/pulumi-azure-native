...
namespace Pulumi.AzureNative.TrafficManager.V20220401.Inputs
{
    ...
    public sealed class MonitorConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.TrafficManager.V20220401.ProfileMonitorStatus>? ProfileMonitorStatus { get; set; }

        /// <summary>
        /// The protocol (HTTP, HTTPS or TCP) used to probe for endpoint health.
        /// </summary>
        [Input("protocol")]
        public InputUnion<string, Pulumi.AzureNative.TrafficManager.V20220401.MonitorProtocol>? Protocol { get; set; }
