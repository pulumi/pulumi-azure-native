...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    ...
    /// {
    ///     var gatewayApiEntityTag = new AzureNative.ApiManagement.V20220801.GatewayApiEntityTag("gatewayApiEntityTag", new()
    ///     {
    ///         ApiId = "echo-api",
    ///         GatewayId = "gw1",
    ///         ProvisioningState = AzureNative.ApiManagement.V20220801.ProvisioningState.Created,
    ...
    public partial class GatewayApiEntityTag : global::Pulumi.CustomResource
    {
        ...
        public GatewayApiEntityTag(string name, GatewayApiEntityTagArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:GatewayApiEntityTag", name, args ?? new GatewayApiEntityTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayApiEntityTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:GatewayApiEntityTag", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GatewayApiEntityTagArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.ApiManagement.V20220801.ProvisioningState>? ProvisioningState { get; set; }
