...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    ...
    /// {
    ///     var diagnostic = new AzureNative.ApiManagement.V20220801.Diagnostic("diagnostic", new()
    ///     {
    ///         AlwaysLog = "allErrors",
    ...
    public partial class Diagnostic : global::Pulumi.CustomResource
    {
        ...
        public Diagnostic(string name, DiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:Diagnostic", name, args ?? new DiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Diagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:Diagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
