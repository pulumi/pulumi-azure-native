...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    ...
    /// {
    ///     var backend = new AzureNative.ApiManagement.V20220801.Backend("backend", new()
    ///     {
    ///         BackendId = "proxybackend",
    ///         Credentials = new AzureNative.ApiManagement.V20220801.Inputs.BackendCredentialsContractArgs
    ///         {
    ///             Authorization = new AzureNative.ApiManagement.V20220801.Inputs.BackendAuthorizationHeaderCredentialsArgs
    ///             {
    ///                 Parameter = "opensesma",
    ///                 Scheme = "Basic",
    ///             },
    ...
    ///         Protocol = "http",
    ///         Proxy = new AzureNative.ApiManagement.V20220801.Inputs.BackendProxyContractArgs
    ///         {
    ///             Password = "&lt;password&gt;",
    ...
    ///         Tls = new AzureNative.ApiManagement.V20220801.Inputs.BackendTlsPropertiesArgs
    ///         {
    ...
    ///         Properties = new AzureNative.ApiManagement.V20220801.Inputs.BackendPropertiesArgs
    ///         {
    ///             ServiceFabricCluster = new AzureNative.ApiManagement.V20220801.Inputs.BackendServiceFabricClusterPropertiesArgs
    ///             {
    ...
    ///                 ServerX509Names = new[]
    ///                 {
    ///                     new AzureNative.ApiManagement.V20220801.Inputs.X509CertificateNameArgs
    ///                     {
    ...
    public partial class Backend : global::Pulumi.CustomResource
    {
        ...
        public Backend(string name, BackendArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:Backend", name, args ?? new BackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:Backend", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BackendArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220801.BackendProtocol> Protocol { get; set; } = null!;
