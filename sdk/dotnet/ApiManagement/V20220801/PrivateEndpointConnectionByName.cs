...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    ...
    /// {
    ///     var privateEndpointConnectionByName = new AzureNative.ApiManagement.V20220801.PrivateEndpointConnectionByName("privateEndpointConnectionByName", new()
    ///     {
    ...
    ///         Properties = new AzureNative.ApiManagement.V20220801.Inputs.PrivateEndpointConnectionRequestPropertiesArgs
    ///         {
    ///             PrivateLinkServiceConnectionState = new AzureNative.ApiManagement.V20220801.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    public partial class PrivateEndpointConnectionByName : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionByName(string name, PrivateEndpointConnectionByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:PrivateEndpointConnectionByName", name, args ?? new PrivateEndpointConnectionByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:PrivateEndpointConnectionByName", name, null, MakeResourceOptions(options, id))
        {
        }
