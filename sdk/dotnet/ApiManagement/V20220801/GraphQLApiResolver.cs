...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    ...
    /// {
    ///     var graphQLApiResolver = new AzureNative.ApiManagement.V20220801.GraphQLApiResolver("graphQLApiResolver", new()
    ///     {
    ///         ApiId = "someAPI",
    ...
    public partial class GraphQLApiResolver : global::Pulumi.CustomResource
    {
        ...
        public GraphQLApiResolver(string name, GraphQLApiResolverArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:GraphQLApiResolver", name, args ?? new GraphQLApiResolverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphQLApiResolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:GraphQLApiResolver", name, null, MakeResourceOptions(options, id))
        {
        }
