...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    public static class GetUserSharedAccessToken
    {
        ...
        public static Task<GetUserSharedAccessTokenResult> InvokeAsync(GetUserSharedAccessTokenArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserSharedAccessTokenResult>("azure-native:apimanagement/v20220801:getUserSharedAccessToken", args ?? new GetUserSharedAccessTokenArgs(), options.WithDefaults());
        ...
        public static Output<GetUserSharedAccessTokenResult> Invoke(GetUserSharedAccessTokenInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserSharedAccessTokenResult>("azure-native:apimanagement/v20220801:getUserSharedAccessToken", args ?? new GetUserSharedAccessTokenInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetUserSharedAccessTokenArgs : global::Pulumi.InvokeArgs
    {
        ...
        public Pulumi.AzureNative.ApiManagement.V20220801.KeyType KeyType { get; set; }
        ...
        {
            KeyType = Pulumi.AzureNative.ApiManagement.V20220801.KeyType.Primary;
        }
    ...
    public sealed class GetUserSharedAccessTokenInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        /// </summary>
        [Input("keyType", required: true)]
        public Input<Pulumi.AzureNative.ApiManagement.V20220801.KeyType> KeyType { get; set; } = null!;
