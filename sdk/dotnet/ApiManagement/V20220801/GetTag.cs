...
{
    [Obsolete(@"azure-native:apimanagement/v20220801:Tag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Tag to guarantee forwards compatibility.")]
    public static class GetTag
    {
        ...
        public static Task<GetTagResult> InvokeAsync(GetTagArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagResult>("azure-native:apimanagement/v20220801:getTag", args ?? new GetTagArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the tag specified by its identifier.
        /// </summary>
        public static Output<GetTagResult> Invoke(GetTagInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTagResult>("azure-native:apimanagement/v20220801:getTag", args ?? new GetTagInvokeArgs(), options.WithDefaults());
    }
