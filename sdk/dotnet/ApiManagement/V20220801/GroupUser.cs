...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    ...
    /// {
    ///     var groupUser = new AzureNative.ApiManagement.V20220801.GroupUser("groupUser", new()
    ///     {
    ///         GroupId = "tempgroup",
    ...
    public partial class GroupUser : global::Pulumi.CustomResource
    {
        ...
        public GroupUser(string name, GroupUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:GroupUser", name, args ?? new GroupUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:GroupUser", name, null, MakeResourceOptions(options, id))
        {
        }
