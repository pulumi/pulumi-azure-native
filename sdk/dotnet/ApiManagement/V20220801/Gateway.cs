...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    ...
    /// {
    ///     var gateway = new AzureNative.ApiManagement.V20220801.Gateway("gateway", new()
    ///     {
    ///         Description = "my gateway 1",
    ///         GatewayId = "gw1",
    ///         LocationData = new AzureNative.ApiManagement.V20220801.Inputs.ResourceLocationDataContractArgs
    ///         {
    ///             Name = "my location",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:apimanagement/v20220801:Gateway a1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/gateways/gw1 
    /// ```
    /// </summary>
    ...
    public partial class Gateway : global::Pulumi.CustomResource
    {
        ...
        public Gateway(string name, GatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:Gateway", name, args ?? new GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:Gateway", name, null, MakeResourceOptions(options, id))
        {
        }
