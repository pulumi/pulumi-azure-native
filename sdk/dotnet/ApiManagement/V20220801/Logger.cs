...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    ...
    /// {
    ///     var logger = new AzureNative.ApiManagement.V20220801.Logger("logger", new()
    ///     {
    ///         Credentials = 
    ///         {
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:apimanagement/v20220801:Logger eh1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/loggers/eh1 
    /// ```
    /// </summary>
    ...
    public partial class Logger : global::Pulumi.CustomResource
    {
        ...
        public Logger(string name, LoggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:Logger", name, args ?? new LoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:Logger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LoggerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220801.LoggerType> LoggerType { get; set; } = null!;
