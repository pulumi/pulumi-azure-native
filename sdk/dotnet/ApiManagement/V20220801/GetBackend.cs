...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    public static class GetBackend
    {
        ...
        public static Task<GetBackendResult> InvokeAsync(GetBackendArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackendResult>("azure-native:apimanagement/v20220801:getBackend", args ?? new GetBackendArgs(), options.WithDefaults());

        /// <summary>
        /// Backend details.
        /// </summary>
        public static Output<GetBackendResult> Invoke(GetBackendInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackendResult>("azure-native:apimanagement/v20220801:getBackend", args ?? new GetBackendInvokeArgs(), options.WithDefaults());
    }
