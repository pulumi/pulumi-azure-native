...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    ...
    /// {
    ///     var apiDiagnostic = new AzureNative.ApiManagement.V20220801.ApiDiagnostic("apiDiagnostic", new()
    ///     {
    ///         AlwaysLog = "allErrors",
    ///         ApiId = "57d1f7558aa04f15146d9d8a",
    ///         Backend = new AzureNative.ApiManagement.V20220801.Inputs.PipelineDiagnosticSettingsArgs
    ///         {
    ///             Request = new AzureNative.ApiManagement.V20220801.Inputs.HttpMessageDiagnosticArgs
    ///             {
    ///                 Body = new AzureNative.ApiManagement.V20220801.Inputs.BodyDiagnosticSettingsArgs
    ///                 {
    ///                     Bytes = 512,
    ///                 },
    ///                 Headers = new[]
    ...
    ///                 },
    ///             },
    ///             Response = new AzureNative.ApiManagement.V20220801.Inputs.HttpMessageDiagnosticArgs
    ///             {
    ///                 Body = new AzureNative.ApiManagement.V20220801.Inputs.BodyDiagnosticSettingsArgs
    ///                 {
    ///                     Bytes = 512,
    ...
    ///         Frontend = new AzureNative.ApiManagement.V20220801.Inputs.PipelineDiagnosticSettingsArgs
    ///         {
    ///             Request = new AzureNative.ApiManagement.V20220801.Inputs.HttpMessageDiagnosticArgs
    ///             {
    ///                 Body = new AzureNative.ApiManagement.V20220801.Inputs.BodyDiagnosticSettingsArgs
    ...
    ///         Sampling = new AzureNative.ApiManagement.V20220801.Inputs.SamplingSettingsArgs
    ///         {
    ///             Percentage = 50,
    ///             SamplingType = "fixed",
    ///         },
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:apimanagement/v20220801:ApiDiagnostic applicationinsights /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/apis/57d1f7558aa04f15146d9d8a/diagnostics/applicationinsights 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220801:ApiDiagnostic")]
    public partial class ApiDiagnostic : global::Pulumi.CustomResource
    {
        ...
        public ApiDiagnostic(string name, ApiDiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:ApiDiagnostic", name, args ?? new ApiDiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiDiagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220801:ApiDiagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiDiagnosticArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("alwaysLog")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220801.AlwaysLog>? AlwaysLog { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220801.HttpCorrelationProtocol>? HttpCorrelationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220801.OperationNameFormat>? OperationNameFormat { get; set; }
        ...
        /// </summary>
        [Input("verbosity")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220801.Verbosity>? Verbosity { get; set; }
