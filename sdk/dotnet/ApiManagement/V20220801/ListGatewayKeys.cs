...
namespace Pulumi.AzureNative.ApiManagement.V20220801
{
    public static class ListGatewayKeys
    {
        ...
        public static Task<ListGatewayKeysResult> InvokeAsync(ListGatewayKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListGatewayKeysResult>("azure-native:apimanagement/v20220801:listGatewayKeys", args ?? new ListGatewayKeysArgs(), options.WithDefaults());
