...
namespace Pulumi.AzureRM.ApiManagement
{
    ...
    public partial class ServiceGateway : Pulumi.CustomResource
    {
        ...
        private ServiceGateway(string name, Input<string> id, ServiceGatewayState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement:ServiceGateway", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceGatewayState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GatewayContractPropertiesResponseGetArgs> Properties { get; set; } = null!;
