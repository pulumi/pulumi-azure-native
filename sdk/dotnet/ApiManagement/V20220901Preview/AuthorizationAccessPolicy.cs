...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220901preview:AuthorizationAccessPolicy")]
    public partial class AuthorizationAccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationAccessPolicy(string name, AuthorizationAccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:AuthorizationAccessPolicy", name, args ?? new AuthorizationAccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationAccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:AuthorizationAccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
