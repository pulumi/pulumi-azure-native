...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetWorkspaceTagApiLink
    {
        ...
        public static Task<GetWorkspaceTagApiLinkResult> InvokeAsync(GetWorkspaceTagApiLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceTagApiLinkResult>("azure-native:apimanagement/v20220901preview:getWorkspaceTagApiLink", args ?? new GetWorkspaceTagApiLinkArgs(), options.WithDefaults());
