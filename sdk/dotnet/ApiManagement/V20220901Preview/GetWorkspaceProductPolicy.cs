...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetWorkspaceProductPolicy
    {
        ...
        public static Task<GetWorkspaceProductPolicyResult> InvokeAsync(GetWorkspaceProductPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceProductPolicyResult>("azure-native:apimanagement/v20220901preview:getWorkspaceProductPolicy", args ?? new GetWorkspaceProductPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkspaceProductPolicyResult> Invoke(GetWorkspaceProductPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceProductPolicyResult>("azure-native:apimanagement/v20220901preview:getWorkspaceProductPolicy", args ?? new GetWorkspaceProductPolicyInvokeArgs(), options.WithDefaults());
    }
