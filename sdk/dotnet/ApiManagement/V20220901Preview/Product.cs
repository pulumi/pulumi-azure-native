...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    ...
    /// Product details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220901preview:Product")]
    public partial class Product : global::Pulumi.CustomResource
    {
        ...
        public Product(string name, ProductArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:Product", name, args ?? new ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:Product", name, null, MakeResourceOptions(options, id))
        {
        }
