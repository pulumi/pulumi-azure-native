...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220901preview:WorkspaceApiSchema")]
    public partial class WorkspaceApiSchema : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApiSchema(string name, WorkspaceApiSchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:WorkspaceApiSchema", name, args ?? new WorkspaceApiSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApiSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:WorkspaceApiSchema", name, null, MakeResourceOptions(options, id))
        {
        }
