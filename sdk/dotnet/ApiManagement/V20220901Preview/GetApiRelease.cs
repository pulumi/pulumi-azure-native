...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetApiRelease
    {
        ...
        public static Task<GetApiReleaseResult> InvokeAsync(GetApiReleaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiReleaseResult>("azure-native:apimanagement/v20220901preview:getApiRelease", args ?? new GetApiReleaseArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the details of an API release.
        /// </summary>
        public static Output<GetApiReleaseResult> Invoke(GetApiReleaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiReleaseResult>("azure-native:apimanagement/v20220901preview:getApiRelease", args ?? new GetApiReleaseInvokeArgs(), options.WithDefaults());
