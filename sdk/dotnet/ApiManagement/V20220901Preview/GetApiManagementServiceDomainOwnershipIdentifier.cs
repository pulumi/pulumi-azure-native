...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetApiManagementServiceDomainOwnershipIdentifier
    {
        ...
        public static Task<GetApiManagementServiceDomainOwnershipIdentifierResult> InvokeAsync(GetApiManagementServiceDomainOwnershipIdentifierArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiManagementServiceDomainOwnershipIdentifierResult>("azure-native:apimanagement/v20220901preview:getApiManagementServiceDomainOwnershipIdentifier", args ?? new GetApiManagementServiceDomainOwnershipIdentifierArgs(), options.WithDefaults());

        /// <summary>
        /// Get the custom domain ownership identifier for an API Management service.
        /// </summary>
        public static Output<GetApiManagementServiceDomainOwnershipIdentifierResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiManagementServiceDomainOwnershipIdentifierResult>("azure-native:apimanagement/v20220901preview:getApiManagementServiceDomainOwnershipIdentifier", InvokeArgs.Empty, options.WithDefaults());
