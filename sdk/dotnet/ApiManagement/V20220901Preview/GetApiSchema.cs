...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetApiSchema
    {
        ...
        public static Task<GetApiSchemaResult> InvokeAsync(GetApiSchemaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiSchemaResult>("azure-native:apimanagement/v20220901preview:getApiSchema", args ?? new GetApiSchemaArgs(), options.WithDefaults());

        /// <summary>
        /// Get the schema configuration at the API level.
        /// </summary>
        public static Output<GetApiSchemaResult> Invoke(GetApiSchemaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiSchemaResult>("azure-native:apimanagement/v20220901preview:getApiSchema", args ?? new GetApiSchemaInvokeArgs(), options.WithDefaults());
    }
