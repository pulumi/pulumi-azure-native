...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220901preview:ApiIssue")]
    public partial class ApiIssue : global::Pulumi.CustomResource
    {
        ...
        public ApiIssue(string name, ApiIssueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:ApiIssue", name, args ?? new ApiIssueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:ApiIssue", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiIssueArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220901Preview.State>? State { get; set; }
