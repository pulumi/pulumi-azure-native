...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetWorkspaceApiPolicy
    {
        ...
        public static Task<GetWorkspaceApiPolicyResult> InvokeAsync(GetWorkspaceApiPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiPolicyResult>("azure-native:apimanagement/v20220901preview:getWorkspaceApiPolicy", args ?? new GetWorkspaceApiPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Get the policy configuration at the API level.
        /// </summary>
        public static Output<GetWorkspaceApiPolicyResult> Invoke(GetWorkspaceApiPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceApiPolicyResult>("azure-native:apimanagement/v20220901preview:getWorkspaceApiPolicy", args ?? new GetWorkspaceApiPolicyInvokeArgs(), options.WithDefaults());
    }
