...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetWorkspaceGroup
    {
        ...
        public static Task<GetWorkspaceGroupResult> InvokeAsync(GetWorkspaceGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceGroupResult>("azure-native:apimanagement/v20220901preview:getWorkspaceGroup", args ?? new GetWorkspaceGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the group specified by its identifier.
        /// </summary>
        public static Output<GetWorkspaceGroupResult> Invoke(GetWorkspaceGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceGroupResult>("azure-native:apimanagement/v20220901preview:getWorkspaceGroup", args ?? new GetWorkspaceGroupInvokeArgs(), options.WithDefaults());
    }
