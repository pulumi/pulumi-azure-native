...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetContentItem
    {
        ...
        public static Task<GetContentItemResult> InvokeAsync(GetContentItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContentItemResult>("azure-native:apimanagement/v20220901preview:getContentItem", args ?? new GetContentItemArgs(), options.WithDefaults());

        /// <summary>
        /// Returns the developer portal's content item specified by its identifier.
        /// </summary>
        public static Output<GetContentItemResult> Invoke(GetContentItemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContentItemResult>("azure-native:apimanagement/v20220901preview:getContentItem", args ?? new GetContentItemInvokeArgs(), options.WithDefaults());
    }
