...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    ...
    /// User details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220901preview:GroupUser")]
    public partial class GroupUser : global::Pulumi.CustomResource
    {
        ...
        public GroupUser(string name, GroupUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:GroupUser", name, args ?? new GroupUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:GroupUser", name, null, MakeResourceOptions(options, id))
        {
        }
