...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetAuthorization
    {
        ...
        public static Task<GetAuthorizationResult> InvokeAsync(GetAuthorizationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationResult>("azure-native:apimanagement/v20220901preview:getAuthorization", args ?? new GetAuthorizationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the authorization specified by its identifier.
        /// </summary>
        public static Output<GetAuthorizationResult> Invoke(GetAuthorizationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAuthorizationResult>("azure-native:apimanagement/v20220901preview:getAuthorization", args ?? new GetAuthorizationInvokeArgs(), options.WithDefaults());
    }
