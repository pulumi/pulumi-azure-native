...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220901preview:GraphQLApiResolver")]
    public partial class GraphQLApiResolver : global::Pulumi.CustomResource
    {
        ...
        public GraphQLApiResolver(string name, GraphQLApiResolverArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:GraphQLApiResolver", name, args ?? new GraphQLApiResolverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphQLApiResolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:GraphQLApiResolver", name, null, MakeResourceOptions(options, id))
        {
        }
