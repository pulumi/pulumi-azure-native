...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220901preview:WorkspaceApiOperation")]
    public partial class WorkspaceApiOperation : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApiOperation(string name, WorkspaceApiOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:WorkspaceApiOperation", name, args ?? new WorkspaceApiOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApiOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:WorkspaceApiOperation", name, null, MakeResourceOptions(options, id))
        {
        }
