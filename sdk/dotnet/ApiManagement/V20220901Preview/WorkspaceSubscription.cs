...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220901preview:WorkspaceSubscription")]
    public partial class WorkspaceSubscription : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceSubscription(string name, WorkspaceSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:WorkspaceSubscription", name, args ?? new WorkspaceSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:WorkspaceSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240601preview:WorkspaceSubscription" },
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkspaceSubscription Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new WorkspaceSubscription(name, id, options);
        }
    }

    public sealed class WorkspaceSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.ApiManagement.V20220901Preview.SubscriptionState>? State { get; set; }
        ...
        public WorkspaceSubscriptionArgs()
        {
        }
        public static new WorkspaceSubscriptionArgs Empty => new WorkspaceSubscriptionArgs();
    }
}
