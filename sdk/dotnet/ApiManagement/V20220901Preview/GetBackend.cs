...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetBackend
    {
        ...
        public static Task<GetBackendResult> InvokeAsync(GetBackendArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackendResult>("azure-native:apimanagement/v20220901preview:getBackend", args ?? new GetBackendArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the backend specified by its identifier.
        /// </summary>
        public static Output<GetBackendResult> Invoke(GetBackendInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackendResult>("azure-native:apimanagement/v20220901preview:getBackend", args ?? new GetBackendInvokeArgs(), options.WithDefaults());
    }
