...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    ...
    /// API details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20220901preview:WorkspaceApi")]
    public partial class WorkspaceApi : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApi(string name, WorkspaceApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:WorkspaceApi", name, args ?? new WorkspaceApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220901preview:WorkspaceApi", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement:WorkspaceApi" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230301preview:WorkspaceApi" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230501preview:WorkspaceApi" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230901preview:WorkspaceApi" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240501:WorkspaceApi" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240601preview:WorkspaceApi" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkspaceApi Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new WorkspaceApi(name, id, options);
        }
    }

    public sealed class WorkspaceApiArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("apiType")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220901Preview.ApiType>? ApiType { get; set; }
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220901Preview.ContentFormat>? Format { get; set; }
        ...
        [Input("protocols")]
        private InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20220901Preview.Protocol>>? _protocols;

        /// <summary>
        /// Describes on which protocols the operations in this API can be invoked.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20220901Preview.Protocol>> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20220901Preview.Protocol>>());
        ...
        /// </summary>
        [Input("soapApiType")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220901Preview.SoapApiType>? SoapApiType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220901Preview.TranslateRequiredQueryParametersConduct>? TranslateRequiredQueryParametersConduct { get; set; }
        ...
        public WorkspaceApiArgs()
        {
        }
        public static new WorkspaceApiArgs Empty => new WorkspaceApiArgs();
    }
}
