...
namespace Pulumi.AzureNative.ApiManagement.V20220901Preview
{
    public static class GetWorkspaceApiRelease
    {
        ...
        public static Task<GetWorkspaceApiReleaseResult> InvokeAsync(GetWorkspaceApiReleaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiReleaseResult>("azure-native:apimanagement/v20220901preview:getWorkspaceApiRelease", args ?? new GetWorkspaceApiReleaseArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkspaceApiReleaseResult> Invoke(GetWorkspaceApiReleaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceApiReleaseResult>("azure-native:apimanagement/v20220901preview:getWorkspaceApiRelease", args ?? new GetWorkspaceApiReleaseInvokeArgs(), options.WithDefaults());
