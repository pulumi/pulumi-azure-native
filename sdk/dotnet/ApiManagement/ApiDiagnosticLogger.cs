...
namespace Pulumi.AzureNextGen.ApiManagement
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement:ApiDiagnosticLogger")]
    public partial class ApiDiagnosticLogger : Pulumi.CustomResource
    {
        ...
        public ApiDiagnosticLogger(string name, ApiDiagnosticLoggerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement:ApiDiagnosticLogger", name, args ?? new ApiDiagnosticLoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiDiagnosticLogger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement:ApiDiagnosticLogger", name, null, MakeResourceOptions(options, id))
        {
        }
