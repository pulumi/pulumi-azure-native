...
namespace Pulumi.AzureNative.ApiManagement
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement:ApiDiagnosticLogger")]
    public partial class ApiDiagnosticLogger : global::Pulumi.CustomResource
    {
        ...
        public ApiDiagnosticLogger(string name, ApiDiagnosticLoggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement:ApiDiagnosticLogger", name, args ?? new ApiDiagnosticLoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiDiagnosticLogger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement:ApiDiagnosticLogger", name, null, MakeResourceOptions(options, id))
        {
        }
