...
namespace Pulumi.AzureNative.ApiManagement
{
    ...
    public partial class AuthorizationAccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationAccessPolicy(string name, AuthorizationAccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement:AuthorizationAccessPolicy", name, args ?? new AuthorizationAccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationAccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement:AuthorizationAccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20241001preview:AuthorizationAccessPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20250301preview:AuthorizationAccessPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20250901preview:AuthorizationAccessPolicy" },
                },
            };
