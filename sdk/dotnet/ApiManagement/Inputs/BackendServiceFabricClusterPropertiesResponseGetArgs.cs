...
namespace Pulumi.AzureRM.ApiManagement.Inputs
{
    ...
    /// </summary>
    public sealed class BackendServiceFabricClusterPropertiesResponseGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.X509CertificateNameResponseGetArgs>? _serverX509Names;

        /// <summary>
        /// Server X509 Certificate Names Collection
        /// </summary>
        public InputList<Inputs.X509CertificateNameResponseGetArgs> ServerX509Names
        {
            get => _serverX509Names ?? (_serverX509Names = new InputList<Inputs.X509CertificateNameResponseGetArgs>());
            set => _serverX509Names = value;
        }

        public BackendServiceFabricClusterPropertiesResponseGetArgs()
        {
        }
    }
}
