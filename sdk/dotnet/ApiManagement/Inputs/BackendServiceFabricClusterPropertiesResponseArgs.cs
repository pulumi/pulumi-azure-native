...
namespace Pulumi.AzureRM.ApiManagement.Inputs
{
    ...
    /// </summary>
    public sealed class BackendServiceFabricClusterPropertiesResponseArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.X509CertificateNameResponseArgs>? _serverX509Names;

        /// <summary>
        /// Server X509 Certificate Names Collection
        /// </summary>
        public InputList<Inputs.X509CertificateNameResponseArgs> ServerX509Names
        {
            get => _serverX509Names ?? (_serverX509Names = new InputList<Inputs.X509CertificateNameResponseArgs>());
            set => _serverX509Names = value;
        }

        public BackendServiceFabricClusterPropertiesResponseArgs()
        {
        }
    }
}
