...
namespace Pulumi.AzureRM.ApiManagement
{
    public static class GetProductPolicy
    {
        public static Task<GetProductPolicyResult> InvokeAsync(GetProductPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductPolicyResult>("azurerm:apimanagement:getProductPolicy", args ?? new GetProductPolicyArgs(), options.WithVersion());
    }
