...
namespace Pulumi.AzureRM.ApiManagement
{
    ...
    /// </summary>
    public partial class ServiceTemplate : Pulumi.CustomResource
    {
        /// <summary>
        /// Resource name.
        /// </summary>
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EmailTemplateContractPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public ServiceTemplate(string name, ServiceTemplateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement:ServiceTemplate", name, args ?? new ServiceTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceTemplate(string name, Input<string> id, ServiceTemplateState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement:ServiceTemplate", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceTemplateState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource name.
        /// </summary>
        ...
        public Input<Inputs.EmailTemplateContractPropertiesResponseGetArgs> Properties { get; set; } = null!;
