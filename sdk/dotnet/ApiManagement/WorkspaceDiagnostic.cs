...
namespace Pulumi.AzureNative.ApiManagement
{
    ...
    public partial class WorkspaceDiagnostic : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceDiagnostic(string name, WorkspaceDiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement:WorkspaceDiagnostic", name, args ?? new WorkspaceDiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceDiagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement:WorkspaceDiagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240601preview:WorkspaceDiagnostic" },
                    new global::Pulumi.Alias { Type = "azure-native_apimanagement_v20230901preview:apimanagement:WorkspaceDiagnostic" },
                    new global::Pulumi.Alias { Type = "azure-native_apimanagement_v20240501:apimanagement:WorkspaceDiagnostic" },
                    new global::Pulumi.Alias { Type = "azure-native_apimanagement_v20240601preview:apimanagement:WorkspaceDiagnostic" },
                },
            };
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkspaceDiagnostic Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new WorkspaceDiagnostic(name, id, options);
        }
    }

    public sealed class WorkspaceDiagnosticArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Specifies for what type of messages sampling settings should not apply.
        /// </summary>
        ...
        public WorkspaceDiagnosticArgs()
        {
        }
        public static new WorkspaceDiagnosticArgs Empty => new WorkspaceDiagnosticArgs();
    }
}
