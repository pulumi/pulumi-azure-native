...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210401preview:ApiIssue")]
    public partial class ApiIssue : global::Pulumi.CustomResource
    {
        ...
        public ApiIssue(string name, ApiIssueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:ApiIssue", name, args ?? new ApiIssueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:ApiIssue", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiIssueArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210401Preview.State>? State { get; set; }
