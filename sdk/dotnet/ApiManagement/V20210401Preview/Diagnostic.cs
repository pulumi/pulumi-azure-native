...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    ...
    /// Diagnostic details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210401preview:Diagnostic")]
    public partial class Diagnostic : Pulumi.CustomResource
    {
        ...
        public Diagnostic(string name, DiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:Diagnostic", name, args ?? new DiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Diagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:Diagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:Diagnostic"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20201201:Diagnostic"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210101preview:Diagnostic"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:Diagnostic"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:Diagnostic"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:Diagnostic"},
                },
            };
    ...
    public sealed class DiagnosticArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("alwaysLog")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210401Preview.AlwaysLog>? AlwaysLog { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210401Preview.HttpCorrelationProtocol>? HttpCorrelationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210401Preview.OperationNameFormat>? OperationNameFormat { get; set; }
        ...
        /// </summary>
        [Input("verbosity")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210401Preview.Verbosity>? Verbosity { get; set; }
