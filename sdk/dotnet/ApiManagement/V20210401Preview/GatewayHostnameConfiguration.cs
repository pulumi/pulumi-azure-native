...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20210401preview:GatewayHostnameConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayHostnameConfiguration to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20210401preview:GatewayHostnameConfiguration")]
    public partial class GatewayHostnameConfiguration : global::Pulumi.CustomResource
    {
        ...
        public GatewayHostnameConfiguration(string name, GatewayHostnameConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:GatewayHostnameConfiguration", name, args ?? new GatewayHostnameConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayHostnameConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:GatewayHostnameConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
