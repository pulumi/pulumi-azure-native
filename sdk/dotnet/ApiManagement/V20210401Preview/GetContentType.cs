...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    public static class GetContentType
    {
        ...
        public static Task<GetContentTypeResult> InvokeAsync(GetContentTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContentTypeResult>("azure-native:apimanagement/v20210401preview:getContentType", args ?? new GetContentTypeArgs(), options.WithDefaults());

        /// <summary>
        /// Content type contract details.
        /// </summary>
        public static Output<GetContentTypeResult> Invoke(GetContentTypeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetContentTypeResult>("azure-native:apimanagement/v20210401preview:getContentType", args ?? new GetContentTypeInvokeArgs(), options.WithDefaults());
    }
