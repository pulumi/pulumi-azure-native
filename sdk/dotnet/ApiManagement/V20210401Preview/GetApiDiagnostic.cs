...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    public static class GetApiDiagnostic
    {
        ...
        public static Task<GetApiDiagnosticResult> InvokeAsync(GetApiDiagnosticArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiDiagnosticResult>("azure-native:apimanagement/v20210401preview:getApiDiagnostic", args ?? new GetApiDiagnosticArgs(), options.WithVersion());

        /// <summary>
        /// Diagnostic details.
        /// </summary>
        public static Output<GetApiDiagnosticResult> Invoke(GetApiDiagnosticInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiDiagnosticResult>("azure-native:apimanagement/v20210401preview:getApiDiagnostic", args ?? new GetApiDiagnosticInvokeArgs(), options.WithVersion());
    }
