...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    public static class GetTagByApi
    {
        ...
        public static Task<GetTagByApiResult> InvokeAsync(GetTagByApiArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByApiResult>("azure-native:apimanagement/v20210401preview:getTagByApi", args ?? new GetTagByApiArgs(), options.WithVersion());

        /// <summary>
        /// Tag Contract details.
        /// </summary>
        public static Output<GetTagByApiResult> Invoke(GetTagByApiInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTagByApiResult>("azure-native:apimanagement/v20210401preview:getTagByApi", args ?? new GetTagByApiInvokeArgs(), options.WithVersion());
    }
