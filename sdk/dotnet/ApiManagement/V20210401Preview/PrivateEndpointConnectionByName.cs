...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    ...
    /// {
    ///     var privateEndpointConnectionByName = new AzureNative.ApiManagement.V20210401Preview.PrivateEndpointConnectionByName("privateEndpointConnectionByName", new()
    ///     {
    ...
    ///         Properties = new AzureNative.ApiManagement.V20210401Preview.Inputs.PrivateEndpointConnectionRequestPropertiesArgs
    ///         {
    ///             PrivateLinkServiceConnectionState = new AzureNative.ApiManagement.V20210401Preview.Inputs.PrivateLinkServiceConnectionStateArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210401preview:PrivateEndpointConnectionByName")]
    public partial class PrivateEndpointConnectionByName : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionByName(string name, PrivateEndpointConnectionByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:PrivateEndpointConnectionByName", name, args ?? new PrivateEndpointConnectionByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:PrivateEndpointConnectionByName", name, null, MakeResourceOptions(options, id))
        {
        }
