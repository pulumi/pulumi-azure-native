...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210401preview:ApiOperation")]
    public partial class ApiOperation : Pulumi.CustomResource
    {
        ...
        public ApiOperation(string name, ApiOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:ApiOperation", name, args ?? new ApiOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:ApiOperation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:ApiOperation"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20201201:ApiOperation"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210101preview:ApiOperation"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:ApiOperation"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:ApiOperation"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:ApiOperation"},
                },
            };
