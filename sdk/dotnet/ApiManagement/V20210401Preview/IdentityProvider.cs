...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    ...
    [AzureNativeResourceType("azure-native:apimanagement/v20210401preview:IdentityProvider")]
    public partial class IdentityProvider : global::Pulumi.CustomResource
    {
        ...
        public IdentityProvider(string name, IdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:IdentityProvider", name, args ?? new IdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:IdentityProvider", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IdentityProviderArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210401Preview.IdentityProviderType>? Type { get; set; }
