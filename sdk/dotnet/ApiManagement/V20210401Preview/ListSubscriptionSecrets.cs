...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    public static class ListSubscriptionSecrets
    {
        ...
        public static Task<ListSubscriptionSecretsResult> InvokeAsync(ListSubscriptionSecretsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListSubscriptionSecretsResult>("azure-native:apimanagement/v20210401preview:listSubscriptionSecrets", args ?? new ListSubscriptionSecretsArgs(), options.WithVersion());
        ...
        public static Output<ListSubscriptionSecretsResult> Invoke(ListSubscriptionSecretsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListSubscriptionSecretsResult>("azure-native:apimanagement/v20210401preview:listSubscriptionSecrets", args ?? new ListSubscriptionSecretsInvokeArgs(), options.WithVersion());
    }
