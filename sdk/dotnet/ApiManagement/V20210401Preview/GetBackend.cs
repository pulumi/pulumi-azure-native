...
{
    [Obsolete(@"azure-native:apimanagement/v20210401preview:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Backend to guarantee forwards compatibility.")]
    public static class GetBackend
    {
        ...
        public static Task<GetBackendResult> InvokeAsync(GetBackendArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackendResult>("azure-native:apimanagement/v20210401preview:getBackend", args ?? new GetBackendArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the backend specified by its identifier.
        /// </summary>
        public static Output<GetBackendResult> Invoke(GetBackendInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackendResult>("azure-native:apimanagement/v20210401preview:getBackend", args ?? new GetBackendInvokeArgs(), options.WithDefaults());
    }
