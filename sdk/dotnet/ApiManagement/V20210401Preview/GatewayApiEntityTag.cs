...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    ...
    /// API details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20210401preview:GatewayApiEntityTag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayApiEntityTag to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20210401preview:GatewayApiEntityTag")]
    public partial class GatewayApiEntityTag : global::Pulumi.CustomResource
    {
        ...
        public GatewayApiEntityTag(string name, GatewayApiEntityTagArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:GatewayApiEntityTag", name, args ?? new GatewayApiEntityTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayApiEntityTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210401preview:GatewayApiEntityTag", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GatewayApiEntityTagArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.ApiManagement.V20210401Preview.ProvisioningState>? ProvisioningState { get; set; }
