...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    public static class GetTag
    {
        ...
        public static Task<GetTagResult> InvokeAsync(GetTagArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagResult>("azure-native:apimanagement/v20210401preview:getTag", args ?? new GetTagArgs(), options.WithDefaults());

        /// <summary>
        /// Tag Contract details.
        /// </summary>
        public static Output<GetTagResult> Invoke(GetTagInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTagResult>("azure-native:apimanagement/v20210401preview:getTag", args ?? new GetTagInvokeArgs(), options.WithDefaults());
    }
