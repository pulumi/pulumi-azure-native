...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview
{
    public static class GetApiVersionSet
    {
        ...
        public static Task<GetApiVersionSetResult> InvokeAsync(GetApiVersionSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiVersionSetResult>("azure-native:apimanagement/v20210401preview:getApiVersionSet", args ?? new GetApiVersionSetArgs(), options.WithDefaults());

        /// <summary>
        /// API Version Set Contract details.
        /// </summary>
        public static Output<GetApiVersionSetResult> Invoke(GetApiVersionSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiVersionSetResult>("azure-native:apimanagement/v20210401preview:getApiVersionSet", args ?? new GetApiVersionSetInvokeArgs(), options.WithDefaults());
    }
