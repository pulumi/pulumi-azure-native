...
namespace Pulumi.AzureNative.ApiManagement.V20210401Preview.Inputs
{
    ...
    public sealed class HostnameConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210401Preview.CertificateSource>? CertificateSource { get; set; }

        /// <summary>
        /// Certificate Status.
        /// </summary>
        [Input("certificateStatus")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210401Preview.CertificateStatus>? CertificateStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210401Preview.HostnameType> Type { get; set; } = null!;
