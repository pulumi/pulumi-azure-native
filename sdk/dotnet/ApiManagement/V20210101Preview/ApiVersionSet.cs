...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20210101preview:ApiVersionSet is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiVersionSet to guarantee forwards compatibility.")]
    ...
    public partial class ApiVersionSet : global::Pulumi.CustomResource
    {
        ...
        public ApiVersionSet(string name, ApiVersionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:ApiVersionSet", name, args ?? new ApiVersionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiVersionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:ApiVersionSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiVersionSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210101Preview.VersioningScheme> VersioningScheme { get; set; } = null!;
