...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    ...
    /// NamedValue details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210101preview:NamedValue")]
    public partial class NamedValue : global::Pulumi.CustomResource
    {
        ...
        public NamedValue(string name, NamedValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:NamedValue", name, args ?? new NamedValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamedValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:NamedValue", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230501preview:NamedValue" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230901preview:NamedValue" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240501:NamedValue" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240601preview:NamedValue" },
                },
            };
