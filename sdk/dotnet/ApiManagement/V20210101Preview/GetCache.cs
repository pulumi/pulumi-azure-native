...
{
    [Obsolete(@"azure-native:apimanagement/v20210101preview:Cache is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Cache to guarantee forwards compatibility.")]
    public static class GetCache
    {
        ...
        public static Task<GetCacheResult> InvokeAsync(GetCacheArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCacheResult>("azure-native:apimanagement/v20210101preview:getCache", args ?? new GetCacheArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the Cache specified by its identifier.
        /// </summary>
        public static Output<GetCacheResult> Invoke(GetCacheInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCacheResult>("azure-native:apimanagement/v20210101preview:getCache", args ?? new GetCacheInvokeArgs(), options.WithDefaults());
    }
