...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    ...
    /// Backend details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20210101preview:Backend is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Backend to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20210101preview:Backend")]
    public partial class Backend : global::Pulumi.CustomResource
    {
        ...
        public Backend(string name, BackendArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:Backend", name, args ?? new BackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:Backend", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BackendArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210101Preview.BackendProtocol> Protocol { get; set; } = null!;
