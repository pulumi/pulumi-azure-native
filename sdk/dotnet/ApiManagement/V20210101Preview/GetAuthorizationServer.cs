...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    ...
    public static class GetAuthorizationServer
    {
        ...
        public static Task<GetAuthorizationServerResult> InvokeAsync(GetAuthorizationServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationServerResult>("azure-native:apimanagement/v20210101preview:getAuthorizationServer", args ?? new GetAuthorizationServerArgs(), options.WithDefaults());
        ...
        public static Output<GetAuthorizationServerResult> Invoke(GetAuthorizationServerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAuthorizationServerResult>("azure-native:apimanagement/v20210101preview:getAuthorizationServer", args ?? new GetAuthorizationServerInvokeArgs(), options.WithDefaults());
    }
