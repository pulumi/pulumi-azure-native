...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    public static class ListGatewayKeys
    {
        ...
        public static Task<ListGatewayKeysResult> InvokeAsync(ListGatewayKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListGatewayKeysResult>("azure-native:apimanagement/v20210101preview:listGatewayKeys", args ?? new ListGatewayKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Gateway authentication keys.
        /// </summary>
        public static Output<ListGatewayKeysResult> Invoke(ListGatewayKeysInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListGatewayKeysResult>("azure-native:apimanagement/v20210101preview:listGatewayKeys", args ?? new ListGatewayKeysInvokeArgs(), options.WithDefaults());
    }
