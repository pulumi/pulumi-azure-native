...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    public static class GetApiTagDescription
    {
        ...
        public static Task<GetApiTagDescriptionResult> InvokeAsync(GetApiTagDescriptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiTagDescriptionResult>("azure-native:apimanagement/v20210101preview:getApiTagDescription", args ?? new GetApiTagDescriptionArgs(), options.WithDefaults());

        /// <summary>
        /// Contract details.
        /// </summary>
        public static Output<GetApiTagDescriptionResult> Invoke(GetApiTagDescriptionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiTagDescriptionResult>("azure-native:apimanagement/v20210101preview:getApiTagDescription", args ?? new GetApiTagDescriptionInvokeArgs(), options.WithDefaults());
    }
