...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    ...
    public partial class ApiOperation : global::Pulumi.CustomResource
    {
        ...
        public ApiOperation(string name, ApiOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:ApiOperation", name, args ?? new ApiOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:ApiOperation", name, null, MakeResourceOptions(options, id))
        {
        }
