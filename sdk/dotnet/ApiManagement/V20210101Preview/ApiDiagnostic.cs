...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    ...
    /// Diagnostic details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210101preview:ApiDiagnostic")]
    public partial class ApiDiagnostic : global::Pulumi.CustomResource
    {
        ...
        public ApiDiagnostic(string name, ApiDiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:ApiDiagnostic", name, args ?? new ApiDiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiDiagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:ApiDiagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
