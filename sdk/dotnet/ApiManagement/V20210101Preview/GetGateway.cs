...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    public static class GetGateway
    {
        ...
        public static Task<GetGatewayResult> InvokeAsync(GetGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetGatewayResult>("azure-native:apimanagement/v20210101preview:getGateway", args ?? new GetGatewayArgs(), options.WithVersion());

        /// <summary>
        /// Gateway details.
        /// </summary>
        public static Output<GetGatewayResult> Invoke(GetGatewayInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetGatewayResult>("azure-native:apimanagement/v20210101preview:getGateway", args ?? new GetGatewayInvokeArgs(), options.WithVersion());
    }
