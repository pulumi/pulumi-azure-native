...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    ...
    public partial class ContentItem : Pulumi.CustomResource
    {
        ...
        public ContentItem(string name, ContentItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:ContentItem", name, args ?? new ContentItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:ContentItem", name, null, MakeResourceOptions(options, id))
        {
        }
