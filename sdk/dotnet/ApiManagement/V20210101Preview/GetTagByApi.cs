...
{
    [Obsolete(@"azure-native:apimanagement/v20210101preview:TagByApi is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByApi to guarantee forwards compatibility.")]
    public static class GetTagByApi
    {
        ...
        public static Task<GetTagByApiResult> InvokeAsync(GetTagByApiArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagByApiResult>("azure-native:apimanagement/v20210101preview:getTagByApi", args ?? new GetTagByApiArgs(), options.WithDefaults());

        /// <summary>
        /// Get tag associated with the API.
        /// </summary>
        public static Output<GetTagByApiResult> Invoke(GetTagByApiInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTagByApiResult>("azure-native:apimanagement/v20210101preview:getTagByApi", args ?? new GetTagByApiInvokeArgs(), options.WithDefaults());
    }
