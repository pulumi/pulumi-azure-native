...
namespace Pulumi.AzureNative.ApiManagement.V20210101Preview
{
    ...
    /// Logger details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210101preview:Logger")]
    public partial class Logger : Pulumi.CustomResource
    {
        ...
        public Logger(string name, LoggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:Logger", name, args ?? new LoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210101preview:Logger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LoggerArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210101Preview.LoggerType> LoggerType { get; set; } = null!;
