...
namespace Pulumi.AzureRM.ApiManagement
{
    public static class GetApiVersionSet
    {
        public static Task<GetApiVersionSetResult> InvokeAsync(GetApiVersionSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiVersionSetResult>("azurerm:apimanagement:getApiVersionSet", args ?? new GetApiVersionSetArgs(), options.WithVersion());
    }
