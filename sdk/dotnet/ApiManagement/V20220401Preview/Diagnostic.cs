...
namespace Pulumi.AzureNative.ApiManagement.V20220401Preview
{
    ...
    /// Diagnostic details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20220401preview:Diagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Diagnostic to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20220401preview:Diagnostic")]
    public partial class Diagnostic : global::Pulumi.CustomResource
    {
        ...
        public Diagnostic(string name, DiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:Diagnostic", name, args ?? new DiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Diagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:Diagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiagnosticArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("alwaysLog")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220401Preview.AlwaysLog>? AlwaysLog { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220401Preview.HttpCorrelationProtocol>? HttpCorrelationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220401Preview.OperationNameFormat>? OperationNameFormat { get; set; }
        ...
        /// </summary>
        [Input("verbosity")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220401Preview.Verbosity>? Verbosity { get; set; }
