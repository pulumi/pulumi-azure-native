...
namespace Pulumi.AzureNative.ApiManagement.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20220401preview:PolicyFragment is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:PolicyFragment to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20220401preview:PolicyFragment")]
    public partial class PolicyFragment : global::Pulumi.CustomResource
    {
        ...
        public PolicyFragment(string name, PolicyFragmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:PolicyFragment", name, args ?? new PolicyFragmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyFragment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:PolicyFragment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyFragmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220401Preview.PolicyFragmentContentFormat>? Format { get; set; }
