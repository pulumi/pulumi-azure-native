...
namespace Pulumi.AzureNative.ApiManagement.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20220401preview:ApiOperationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiOperationPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20220401preview:ApiOperationPolicy")]
    public partial class ApiOperationPolicy : global::Pulumi.CustomResource
    {
        ...
        public ApiOperationPolicy(string name, ApiOperationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:ApiOperationPolicy", name, args ?? new ApiOperationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:ApiOperationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiOperationPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20220401Preview.PolicyContentFormat>? Format { get; set; }
