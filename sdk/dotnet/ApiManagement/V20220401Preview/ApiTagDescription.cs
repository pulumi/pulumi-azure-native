...
namespace Pulumi.AzureNative.ApiManagement.V20220401Preview
{
    ...
    [AzureNativeResourceType("azure-native:apimanagement/v20220401preview:ApiTagDescription")]
    public partial class ApiTagDescription : global::Pulumi.CustomResource
    {
        ...
        public ApiTagDescription(string name, ApiTagDescriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:ApiTagDescription", name, args ?? new ApiTagDescriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiTagDescription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:ApiTagDescription", name, null, MakeResourceOptions(options, id))
        {
        }
