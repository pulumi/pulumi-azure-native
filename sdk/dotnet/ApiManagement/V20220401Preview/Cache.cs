...
namespace Pulumi.AzureNative.ApiManagement.V20220401Preview
{
    ...
    /// Cache details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20220401preview:Cache is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Cache to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20220401preview:Cache")]
    public partial class Cache : global::Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
