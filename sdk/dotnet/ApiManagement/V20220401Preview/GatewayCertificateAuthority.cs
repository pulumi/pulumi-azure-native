...
namespace Pulumi.AzureNative.ApiManagement.V20220401Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20220401preview:GatewayCertificateAuthority is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayCertificateAuthority to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20220401preview:GatewayCertificateAuthority")]
    public partial class GatewayCertificateAuthority : global::Pulumi.CustomResource
    {
        ...
        public GatewayCertificateAuthority(string name, GatewayCertificateAuthorityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:GatewayCertificateAuthority", name, args ?? new GatewayCertificateAuthorityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayCertificateAuthority(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20220401preview:GatewayCertificateAuthority", name, null, MakeResourceOptions(options, id))
        {
        }
