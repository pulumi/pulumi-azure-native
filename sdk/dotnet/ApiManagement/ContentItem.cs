...
namespace Pulumi.AzureNextGen.ApiManagement
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement:ContentItem")]
    public partial class ContentItem : Pulumi.CustomResource
    {
        ...
        public ContentItem(string name, ContentItemArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement:ContentItem", name, args ?? new ContentItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement:ContentItem", name, null, MakeResourceOptions(options, id))
        {
        }
