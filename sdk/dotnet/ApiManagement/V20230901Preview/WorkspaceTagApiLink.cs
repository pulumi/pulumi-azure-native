...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230901preview:WorkspaceTagApiLink")]
    public partial class WorkspaceTagApiLink : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceTagApiLink(string name, WorkspaceTagApiLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:WorkspaceTagApiLink", name, args ?? new WorkspaceTagApiLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceTagApiLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:WorkspaceTagApiLink", name, null, MakeResourceOptions(options, id))
        {
        }
