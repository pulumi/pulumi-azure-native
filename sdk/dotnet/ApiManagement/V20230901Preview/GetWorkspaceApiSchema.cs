...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetWorkspaceApiSchema
    {
        ...
        public static Task<GetWorkspaceApiSchemaResult> InvokeAsync(GetWorkspaceApiSchemaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiSchemaResult>("azure-native:apimanagement/v20230901preview:getWorkspaceApiSchema", args ?? new GetWorkspaceApiSchemaArgs(), options.WithDefaults());

        /// <summary>
        /// Get the schema configuration at the API level.
        /// </summary>
        public static Output<GetWorkspaceApiSchemaResult> Invoke(GetWorkspaceApiSchemaInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceApiSchemaResult>("azure-native:apimanagement/v20230901preview:getWorkspaceApiSchema", args ?? new GetWorkspaceApiSchemaInvokeArgs(), options.WithDefaults());
