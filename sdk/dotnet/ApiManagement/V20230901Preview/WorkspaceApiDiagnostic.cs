...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    ...
    /// Diagnostic details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230901preview:WorkspaceApiDiagnostic")]
    public partial class WorkspaceApiDiagnostic : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApiDiagnostic(string name, WorkspaceApiDiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:WorkspaceApiDiagnostic", name, args ?? new WorkspaceApiDiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApiDiagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:WorkspaceApiDiagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
