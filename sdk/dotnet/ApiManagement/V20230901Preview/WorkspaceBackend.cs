...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    ...
    /// Backend details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230901preview:WorkspaceBackend")]
    public partial class WorkspaceBackend : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceBackend(string name, WorkspaceBackendArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:WorkspaceBackend", name, args ?? new WorkspaceBackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceBackend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:WorkspaceBackend", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceBackendArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230901Preview.BackendProtocol> Protocol { get; set; } = null!;
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230901Preview.BackendType>? Type { get; set; }
