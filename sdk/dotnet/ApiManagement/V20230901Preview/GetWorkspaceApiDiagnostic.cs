...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetWorkspaceApiDiagnostic
    {
        ...
        public static Task<GetWorkspaceApiDiagnosticResult> InvokeAsync(GetWorkspaceApiDiagnosticArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiDiagnosticResult>("azure-native:apimanagement/v20230901preview:getWorkspaceApiDiagnostic", args ?? new GetWorkspaceApiDiagnosticArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkspaceApiDiagnosticResult> Invoke(GetWorkspaceApiDiagnosticInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceApiDiagnosticResult>("azure-native:apimanagement/v20230901preview:getWorkspaceApiDiagnostic", args ?? new GetWorkspaceApiDiagnosticInvokeArgs(), options.WithDefaults());
