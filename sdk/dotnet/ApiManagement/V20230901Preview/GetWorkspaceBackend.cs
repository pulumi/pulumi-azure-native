...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetWorkspaceBackend
    {
        ...
        public static Task<GetWorkspaceBackendResult> InvokeAsync(GetWorkspaceBackendArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceBackendResult>("azure-native:apimanagement/v20230901preview:getWorkspaceBackend", args ?? new GetWorkspaceBackendArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the backend specified by its identifier.
        /// </summary>
        public static Output<GetWorkspaceBackendResult> Invoke(GetWorkspaceBackendInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceBackendResult>("azure-native:apimanagement/v20230901preview:getWorkspaceBackend", args ?? new GetWorkspaceBackendInvokeArgs(), options.WithDefaults());
