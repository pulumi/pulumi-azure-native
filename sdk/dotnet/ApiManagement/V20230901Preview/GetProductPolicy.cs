...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetProductPolicy
    {
        ...
        public static Task<GetProductPolicyResult> InvokeAsync(GetProductPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProductPolicyResult>("azure-native:apimanagement/v20230901preview:getProductPolicy", args ?? new GetProductPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Get the policy configuration at the Product level.
        /// </summary>
        public static Output<GetProductPolicyResult> Invoke(GetProductPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProductPolicyResult>("azure-native:apimanagement/v20230901preview:getProductPolicy", args ?? new GetProductPolicyInvokeArgs(), options.WithDefaults());
    }
