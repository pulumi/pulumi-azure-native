...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetWorkspaceApi
    {
        ...
        public static Task<GetWorkspaceApiResult> InvokeAsync(GetWorkspaceApiArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiResult>("azure-native:apimanagement/v20230901preview:getWorkspaceApi", args ?? new GetWorkspaceApiArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the API specified by its identifier.
        /// </summary>
        public static Output<GetWorkspaceApiResult> Invoke(GetWorkspaceApiInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceApiResult>("azure-native:apimanagement/v20230901preview:getWorkspaceApi", args ?? new GetWorkspaceApiInvokeArgs(), options.WithDefaults());
