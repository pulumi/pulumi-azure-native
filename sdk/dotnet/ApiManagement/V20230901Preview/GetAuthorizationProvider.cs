...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetAuthorizationProvider
    {
        ...
        public static Task<GetAuthorizationProviderResult> InvokeAsync(GetAuthorizationProviderArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationProviderResult>("azure-native:apimanagement/v20230901preview:getAuthorizationProvider", args ?? new GetAuthorizationProviderArgs(), options.WithDefaults());
        ...
        public static Output<GetAuthorizationProviderResult> Invoke(GetAuthorizationProviderInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAuthorizationProviderResult>("azure-native:apimanagement/v20230901preview:getAuthorizationProvider", args ?? new GetAuthorizationProviderInvokeArgs(), options.WithDefaults());
