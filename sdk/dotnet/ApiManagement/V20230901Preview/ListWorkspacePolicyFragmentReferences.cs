...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class ListWorkspacePolicyFragmentReferences
    {
        ...
        public static Task<ListWorkspacePolicyFragmentReferencesResult> InvokeAsync(ListWorkspacePolicyFragmentReferencesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWorkspacePolicyFragmentReferencesResult>("azure-native:apimanagement/v20230901preview:listWorkspacePolicyFragmentReferences", args ?? new ListWorkspacePolicyFragmentReferencesArgs(), options.WithDefaults());
        ...
        public static Output<ListWorkspacePolicyFragmentReferencesResult> Invoke(ListWorkspacePolicyFragmentReferencesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListWorkspacePolicyFragmentReferencesResult>("azure-native:apimanagement/v20230901preview:listWorkspacePolicyFragmentReferences", args ?? new ListWorkspacePolicyFragmentReferencesInvokeArgs(), options.WithDefaults());
