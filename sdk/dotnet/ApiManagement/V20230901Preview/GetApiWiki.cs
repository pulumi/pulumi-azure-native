...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetApiWiki
    {
        ...
        public static Task<GetApiWikiResult> InvokeAsync(GetApiWikiArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiWikiResult>("azure-native:apimanagement/v20230901preview:getApiWiki", args ?? new GetApiWikiArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the Wiki for an API specified by its identifier.
        /// </summary>
        public static Output<GetApiWikiResult> Invoke(GetApiWikiInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiWikiResult>("azure-native:apimanagement/v20230901preview:getApiWiki", args ?? new GetApiWikiInvokeArgs(), options.WithDefaults());
