...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230901preview:TagProductLink")]
    public partial class TagProductLink : global::Pulumi.CustomResource
    {
        ...
        public TagProductLink(string name, TagProductLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:TagProductLink", name, args ?? new TagProductLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagProductLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:TagProductLink", name, null, MakeResourceOptions(options, id))
        {
        }
