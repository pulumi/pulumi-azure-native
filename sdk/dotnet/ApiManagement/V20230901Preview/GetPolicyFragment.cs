...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetPolicyFragment
    {
        ...
        public static Task<GetPolicyFragmentResult> InvokeAsync(GetPolicyFragmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicyFragmentResult>("azure-native:apimanagement/v20230901preview:getPolicyFragment", args ?? new GetPolicyFragmentArgs(), options.WithDefaults());
