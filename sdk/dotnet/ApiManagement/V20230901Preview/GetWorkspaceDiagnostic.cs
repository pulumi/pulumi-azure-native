...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetWorkspaceDiagnostic
    {
        ...
        public static Task<GetWorkspaceDiagnosticResult> InvokeAsync(GetWorkspaceDiagnosticArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceDiagnosticResult>("azure-native:apimanagement/v20230901preview:getWorkspaceDiagnostic", args ?? new GetWorkspaceDiagnosticArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkspaceDiagnosticResult> Invoke(GetWorkspaceDiagnosticInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceDiagnosticResult>("azure-native:apimanagement/v20230901preview:getWorkspaceDiagnostic", args ?? new GetWorkspaceDiagnosticInvokeArgs(), options.WithDefaults());
