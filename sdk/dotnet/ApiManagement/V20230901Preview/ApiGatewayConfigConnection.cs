...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230901preview:ApiGatewayConfigConnection")]
    public partial class ApiGatewayConfigConnection : global::Pulumi.CustomResource
    {
        ...
        public ApiGatewayConfigConnection(string name, ApiGatewayConfigConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:ApiGatewayConfigConnection", name, args ?? new ApiGatewayConfigConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiGatewayConfigConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:ApiGatewayConfigConnection", name, null, MakeResourceOptions(options, id))
        {
        }
