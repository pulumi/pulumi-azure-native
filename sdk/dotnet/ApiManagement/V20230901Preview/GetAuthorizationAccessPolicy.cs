...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetAuthorizationAccessPolicy
    {
        ...
        public static Task<GetAuthorizationAccessPolicyResult> InvokeAsync(GetAuthorizationAccessPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationAccessPolicyResult>("azure-native:apimanagement/v20230901preview:getAuthorizationAccessPolicy", args ?? new GetAuthorizationAccessPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetAuthorizationAccessPolicyResult> Invoke(GetAuthorizationAccessPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAuthorizationAccessPolicyResult>("azure-native:apimanagement/v20230901preview:getAuthorizationAccessPolicy", args ?? new GetAuthorizationAccessPolicyInvokeArgs(), options.WithDefaults());
    }
