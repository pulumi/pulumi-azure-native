...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230901preview:Documentation")]
    public partial class Documentation : global::Pulumi.CustomResource
    {
        ...
        public Documentation(string name, DocumentationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:Documentation", name, args ?? new DocumentationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Documentation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:Documentation", name, null, MakeResourceOptions(options, id))
        {
        }
