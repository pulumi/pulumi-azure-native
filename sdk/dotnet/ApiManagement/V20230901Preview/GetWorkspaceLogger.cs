...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetWorkspaceLogger
    {
        ...
        public static Task<GetWorkspaceLoggerResult> InvokeAsync(GetWorkspaceLoggerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceLoggerResult>("azure-native:apimanagement/v20230901preview:getWorkspaceLogger", args ?? new GetWorkspaceLoggerArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the logger specified by its identifier.
        /// </summary>
        public static Output<GetWorkspaceLoggerResult> Invoke(GetWorkspaceLoggerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceLoggerResult>("azure-native:apimanagement/v20230901preview:getWorkspaceLogger", args ?? new GetWorkspaceLoggerInvokeArgs(), options.WithDefaults());
    }
