...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetApiGatewayConfigConnection
    {
        ...
        public static Task<GetApiGatewayConfigConnectionResult> InvokeAsync(GetApiGatewayConfigConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiGatewayConfigConnectionResult>("azure-native:apimanagement/v20230901preview:getApiGatewayConfigConnection", args ?? new GetApiGatewayConfigConnectionArgs(), options.WithDefaults());
