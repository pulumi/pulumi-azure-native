...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetApiOperation
    {
        ...
        public static Task<GetApiOperationResult> InvokeAsync(GetApiOperationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiOperationResult>("azure-native:apimanagement/v20230901preview:getApiOperation", args ?? new GetApiOperationArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the API Operation specified by its identifier.
        /// </summary>
        public static Output<GetApiOperationResult> Invoke(GetApiOperationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiOperationResult>("azure-native:apimanagement/v20230901preview:getApiOperation", args ?? new GetApiOperationInvokeArgs(), options.WithDefaults());
