...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetTag
    {
        ...
        public static Task<GetTagResult> InvokeAsync(GetTagArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagResult>("azure-native:apimanagement/v20230901preview:getTag", args ?? new GetTagArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the tag specified by its identifier.
        /// </summary>
        public static Output<GetTagResult> Invoke(GetTagInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTagResult>("azure-native:apimanagement/v20230901preview:getTag", args ?? new GetTagInvokeArgs(), options.WithDefaults());
    }
