...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetPolicyRestriction
    {
        ...
        public static Task<GetPolicyRestrictionResult> InvokeAsync(GetPolicyRestrictionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicyRestrictionResult>("azure-native:apimanagement/v20230901preview:getPolicyRestriction", args ?? new GetPolicyRestrictionArgs(), options.WithDefaults());

        /// <summary>
        /// Get the policy restriction of the Api Management service.
        /// </summary>
        public static Output<GetPolicyRestrictionResult> Invoke(GetPolicyRestrictionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicyRestrictionResult>("azure-native:apimanagement/v20230901preview:getPolicyRestriction", args ?? new GetPolicyRestrictionInvokeArgs(), options.WithDefaults());
    }
