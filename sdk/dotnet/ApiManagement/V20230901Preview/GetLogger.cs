...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetLogger
    {
        ...
        public static Task<GetLoggerResult> InvokeAsync(GetLoggerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLoggerResult>("azure-native:apimanagement/v20230901preview:getLogger", args ?? new GetLoggerArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the logger specified by its identifier.
        /// </summary>
        public static Output<GetLoggerResult> Invoke(GetLoggerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLoggerResult>("azure-native:apimanagement/v20230901preview:getLogger", args ?? new GetLoggerInvokeArgs(), options.WithDefaults());
    }
