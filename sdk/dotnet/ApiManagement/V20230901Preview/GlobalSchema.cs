...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230901preview:GlobalSchema")]
    public partial class GlobalSchema : global::Pulumi.CustomResource
    {
        ...
        public GlobalSchema(string name, GlobalSchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:GlobalSchema", name, args ?? new GlobalSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:GlobalSchema", name, null, MakeResourceOptions(options, id))
        {
        }
