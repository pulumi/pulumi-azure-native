...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetWorkspaceApiVersionSet
    {
        ...
        public static Task<GetWorkspaceApiVersionSetResult> InvokeAsync(GetWorkspaceApiVersionSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiVersionSetResult>("azure-native:apimanagement/v20230901preview:getWorkspaceApiVersionSet", args ?? new GetWorkspaceApiVersionSetArgs(), options.WithDefaults());
