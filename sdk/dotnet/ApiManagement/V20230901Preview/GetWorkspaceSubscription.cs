...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    public static class GetWorkspaceSubscription
    {
        ...
        public static Task<GetWorkspaceSubscriptionResult> InvokeAsync(GetWorkspaceSubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceSubscriptionResult>("azure-native:apimanagement/v20230901preview:getWorkspaceSubscription", args ?? new GetWorkspaceSubscriptionArgs(), options.WithDefaults());
