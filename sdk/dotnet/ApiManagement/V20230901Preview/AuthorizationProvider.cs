...
namespace Pulumi.AzureNative.ApiManagement.V20230901Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230901preview:AuthorizationProvider")]
    public partial class AuthorizationProvider : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationProvider(string name, AuthorizationProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:AuthorizationProvider", name, args ?? new AuthorizationProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230901preview:AuthorizationProvider", name, null, MakeResourceOptions(options, id))
        {
        }
