...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    public static class GetProduct
    {
        ...
        public static Task<GetProductResult> InvokeAsync(GetProductArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProductResult>("azure-native:apimanagement/v20230501preview:getProduct", args ?? new GetProductArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the product specified by its identifier.
        /// </summary>
        public static Output<GetProductResult> Invoke(GetProductInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProductResult>("azure-native:apimanagement/v20230501preview:getProduct", args ?? new GetProductInvokeArgs(), options.WithDefaults());
    }
