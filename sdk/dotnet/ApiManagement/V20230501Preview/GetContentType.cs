...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    public static class GetContentType
    {
        ...
        public static Task<GetContentTypeResult> InvokeAsync(GetContentTypeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContentTypeResult>("azure-native:apimanagement/v20230501preview:getContentType", args ?? new GetContentTypeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the developer portal's content type. Content types describe content items' properties, validation rules, and constraints.
        /// </summary>
        public static Output<GetContentTypeResult> Invoke(GetContentTypeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContentTypeResult>("azure-native:apimanagement/v20230501preview:getContentType", args ?? new GetContentTypeInvokeArgs(), options.WithDefaults());
    }
