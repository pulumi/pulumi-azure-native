...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230501preview:ContentType")]
    public partial class ContentType : global::Pulumi.CustomResource
    {
        ...
        public ContentType(string name, ContentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:ContentType", name, args ?? new ContentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:ContentType", name, null, MakeResourceOptions(options, id))
        {
        }
