...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    public static class GetWorkspaceApiOperationPolicy
    {
        ...
        public static Task<GetWorkspaceApiOperationPolicyResult> InvokeAsync(GetWorkspaceApiOperationPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiOperationPolicyResult>("azure-native:apimanagement/v20230501preview:getWorkspaceApiOperationPolicy", args ?? new GetWorkspaceApiOperationPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkspaceApiOperationPolicyResult> Invoke(GetWorkspaceApiOperationPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceApiOperationPolicyResult>("azure-native:apimanagement/v20230501preview:getWorkspaceApiOperationPolicy", args ?? new GetWorkspaceApiOperationPolicyInvokeArgs(), options.WithDefaults());
