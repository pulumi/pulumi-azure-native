...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    public static class GetWorkspaceApi
    {
        ...
        public static Task<GetWorkspaceApiResult> InvokeAsync(GetWorkspaceApiArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiResult>("azure-native:apimanagement/v20230501preview:getWorkspaceApi", args ?? new GetWorkspaceApiArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the API specified by its identifier.
        /// </summary>
        public static Output<GetWorkspaceApiResult> Invoke(GetWorkspaceApiInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceApiResult>("azure-native:apimanagement/v20230501preview:getWorkspaceApi", args ?? new GetWorkspaceApiInvokeArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the API specified by its identifier.
        /// </summary>
        public static Output<GetWorkspaceApiResult> Invoke(GetWorkspaceApiInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceApiResult>("azure-native:apimanagement/v20230501preview:getWorkspaceApi", args ?? new GetWorkspaceApiInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetWorkspaceApiArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetWorkspaceApiArgs()
        {
        }
        public static new GetWorkspaceApiArgs Empty => new GetWorkspaceApiArgs();
    }

    public sealed class GetWorkspaceApiInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// API revision identifier. Must be unique in the current API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.
        /// </summary>
        ...
        public GetWorkspaceApiInvokeArgs()
        {
        }
        public static new GetWorkspaceApiInvokeArgs Empty => new GetWorkspaceApiInvokeArgs();
    }


    [OutputType]
    public sealed class GetWorkspaceApiResult
    {
        /// <summary>
