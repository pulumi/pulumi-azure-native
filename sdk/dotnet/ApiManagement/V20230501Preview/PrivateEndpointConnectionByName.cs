...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230501preview:PrivateEndpointConnectionByName")]
    public partial class PrivateEndpointConnectionByName : global::Pulumi.CustomResource
    {
        ...
        public PrivateEndpointConnectionByName(string name, PrivateEndpointConnectionByNameArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:PrivateEndpointConnectionByName", name, args ?? new PrivateEndpointConnectionByNameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateEndpointConnectionByName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:PrivateEndpointConnectionByName", name, null, MakeResourceOptions(options, id))
        {
        }
