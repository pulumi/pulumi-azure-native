...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230501preview:TagByProduct")]
    public partial class TagByProduct : global::Pulumi.CustomResource
    {
        ...
        public TagByProduct(string name, TagByProductArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:TagByProduct", name, args ?? new TagByProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:TagByProduct", name, null, MakeResourceOptions(options, id))
        {
        }
