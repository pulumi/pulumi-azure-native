...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    public static class ListWorkspaceNamedValue
    {
        ...
        public static Task<ListWorkspaceNamedValueResult> InvokeAsync(ListWorkspaceNamedValueArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListWorkspaceNamedValueResult>("azure-native:apimanagement/v20230501preview:listWorkspaceNamedValue", args ?? new ListWorkspaceNamedValueArgs(), options.WithDefaults());
