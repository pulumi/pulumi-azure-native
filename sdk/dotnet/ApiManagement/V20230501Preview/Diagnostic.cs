...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    ...
    /// Diagnostic details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230501preview:Diagnostic")]
    public partial class Diagnostic : global::Pulumi.CustomResource
    {
        ...
        public Diagnostic(string name, DiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:Diagnostic", name, args ?? new DiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Diagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:Diagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiagnosticArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("alwaysLog")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.AlwaysLog>? AlwaysLog { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.HttpCorrelationProtocol>? HttpCorrelationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.OperationNameFormat>? OperationNameFormat { get; set; }
        ...
        /// </summary>
        [Input("verbosity")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.Verbosity>? Verbosity { get; set; }
