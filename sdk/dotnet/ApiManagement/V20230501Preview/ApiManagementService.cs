...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230501preview:ApiManagementService")]
    public partial class ApiManagementService : global::Pulumi.CustomResource
    {
        ...
        public ApiManagementService(string name, ApiManagementServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:ApiManagementService", name, args ?? new ApiManagementServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiManagementService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:ApiManagementService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiManagementServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.DeveloperPortalStatus>? DeveloperPortalStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.LegacyPortalStatus>? LegacyPortalStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.NatGatewayState>? NatGatewayState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.VirtualNetworkType>? VirtualNetworkType { get; set; }
