...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    public static class GetWorkspaceProduct
    {
        ...
        public static Task<GetWorkspaceProductResult> InvokeAsync(GetWorkspaceProductArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceProductResult>("azure-native:apimanagement/v20230501preview:getWorkspaceProduct", args ?? new GetWorkspaceProductArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the product specified by its identifier.
        /// </summary>
        public static Output<GetWorkspaceProductResult> Invoke(GetWorkspaceProductInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceProductResult>("azure-native:apimanagement/v20230501preview:getWorkspaceProduct", args ?? new GetWorkspaceProductInvokeArgs(), options.WithDefaults());
    }
