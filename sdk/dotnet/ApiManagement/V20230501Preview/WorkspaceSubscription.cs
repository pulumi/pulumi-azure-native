...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230501preview:WorkspaceSubscription")]
    public partial class WorkspaceSubscription : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceSubscription(string name, WorkspaceSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:WorkspaceSubscription", name, args ?? new WorkspaceSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:WorkspaceSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.ApiManagement.V20230501Preview.SubscriptionState>? State { get; set; }
