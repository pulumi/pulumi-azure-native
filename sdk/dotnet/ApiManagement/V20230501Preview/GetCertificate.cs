...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    public static class GetCertificate
    {
        ...
        public static Task<GetCertificateResult> InvokeAsync(GetCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCertificateResult>("azure-native:apimanagement/v20230501preview:getCertificate", args ?? new GetCertificateArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the certificate specified by its identifier.
        /// </summary>
        public static Output<GetCertificateResult> Invoke(GetCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCertificateResult>("azure-native:apimanagement/v20230501preview:getCertificate", args ?? new GetCertificateInvokeArgs(), options.WithDefaults());
