...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230501preview:ApiVersionSet")]
    public partial class ApiVersionSet : global::Pulumi.CustomResource
    {
        ...
        public ApiVersionSet(string name, ApiVersionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:ApiVersionSet", name, args ?? new ApiVersionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiVersionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:ApiVersionSet", name, null, MakeResourceOptions(options, id))
        {
        }
