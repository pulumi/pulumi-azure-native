...
namespace Pulumi.AzureNative.ApiManagement.V20230501Preview
{
    ...
    /// Backend details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230501preview:Backend")]
    public partial class Backend : global::Pulumi.CustomResource
    {
        ...
        public Backend(string name, BackendArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:Backend", name, args ?? new BackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230501preview:Backend", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BackendArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.BackendProtocol> Protocol { get; set; } = null!;
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230501Preview.BackendType>? Type { get; set; }
