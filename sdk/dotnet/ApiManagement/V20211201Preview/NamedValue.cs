...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview
{
    ...
    /// NamedValue details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20211201preview:NamedValue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:NamedValue to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20211201preview:NamedValue")]
    public partial class NamedValue : global::Pulumi.CustomResource
    {
        ...
        public NamedValue(string name, NamedValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:NamedValue", name, args ?? new NamedValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamedValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:NamedValue", name, null, MakeResourceOptions(options, id))
        {
        }
