...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview
{
    public static class GetApi
    {
        ...
        public static Task<GetApiResult> InvokeAsync(GetApiArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiResult>("azure-native:apimanagement/v20211201preview:getApi", args ?? new GetApiArgs(), options.WithDefaults());

        /// <summary>
        /// API details.
        /// </summary>
        public static Output<GetApiResult> Invoke(GetApiInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiResult>("azure-native:apimanagement/v20211201preview:getApi", args ?? new GetApiInvokeArgs(), options.WithDefaults());
    }
