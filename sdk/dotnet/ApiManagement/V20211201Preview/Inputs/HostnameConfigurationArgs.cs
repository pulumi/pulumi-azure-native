...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview.Inputs
{
    ...
    public sealed class HostnameConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20211201Preview.CertificateSource>? CertificateSource { get; set; }

        /// <summary>
        /// Certificate Status.
        /// </summary>
        [Input("certificateStatus")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20211201Preview.CertificateStatus>? CertificateStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20211201Preview.HostnameType> Type { get; set; } = null!;
