...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview
{
    ...
    [AzureNativeResourceType("azure-native:apimanagement/v20211201preview:ContentItem")]
    public partial class ContentItem : global::Pulumi.CustomResource
    {
        ...
        public ContentItem(string name, ContentItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:ContentItem", name, args ?? new ContentItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:ContentItem", name, null, MakeResourceOptions(options, id))
        {
        }
