...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20211201preview:ApiIssueComment")]
    public partial class ApiIssueComment : global::Pulumi.CustomResource
    {
        ...
        public ApiIssueComment(string name, ApiIssueCommentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:ApiIssueComment", name, args ?? new ApiIssueCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:ApiIssueComment", name, null, MakeResourceOptions(options, id))
        {
        }
