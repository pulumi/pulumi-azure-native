...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview
{
    ...
    public partial class PolicyFragment : Pulumi.CustomResource
    {
        ...
        public PolicyFragment(string name, PolicyFragmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:PolicyFragment", name, args ?? new PolicyFragmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyFragment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:PolicyFragment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyFragmentArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20211201Preview.PolicyFragmentContentFormat>? Format { get; set; }
