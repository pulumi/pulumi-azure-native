...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20211201preview:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20211201preview:ApiPolicy")]
    public partial class ApiPolicy : global::Pulumi.CustomResource
    {
        ...
        public ApiPolicy(string name, ApiPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:ApiPolicy", name, args ?? new ApiPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:ApiPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
