...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20211201preview:ContentType is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ContentType to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20211201preview:ContentType")]
    public partial class ContentType : global::Pulumi.CustomResource
    {
        ...
        public ContentType(string name, ContentTypeArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:ContentType", name, args ?? new ContentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:ContentType", name, null, MakeResourceOptions(options, id))
        {
        }
