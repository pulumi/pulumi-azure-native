...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20211201preview:TagByOperation is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByOperation to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20211201preview:TagByOperation")]
    public partial class TagByOperation : global::Pulumi.CustomResource
    {
        ...
        public TagByOperation(string name, TagByOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:TagByOperation", name, args ?? new TagByOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20211201preview:TagByOperation", name, null, MakeResourceOptions(options, id))
        {
        }
