...
namespace Pulumi.AzureNative.ApiManagement.V20211201Preview
{
    public static class ListPolicyFragmentReferences
    {
        ...
        public static Task<ListPolicyFragmentReferencesResult> InvokeAsync(ListPolicyFragmentReferencesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListPolicyFragmentReferencesResult>("azure-native:apimanagement/v20211201preview:listPolicyFragmentReferences", args ?? new ListPolicyFragmentReferencesArgs(), options.WithDefaults());
        ...
        public static Output<ListPolicyFragmentReferencesResult> Invoke(ListPolicyFragmentReferencesInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListPolicyFragmentReferencesResult>("azure-native:apimanagement/v20211201preview:listPolicyFragmentReferences", args ?? new ListPolicyFragmentReferencesInvokeArgs(), options.WithDefaults());
    }
