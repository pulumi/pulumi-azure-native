...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:GatewayCertificateAuthority")]
    public partial class GatewayCertificateAuthority : global::Pulumi.CustomResource
    {
        ...
        public GatewayCertificateAuthority(string name, GatewayCertificateAuthorityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:GatewayCertificateAuthority", name, args ?? new GatewayCertificateAuthorityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayCertificateAuthority(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:GatewayCertificateAuthority", name, null, MakeResourceOptions(options, id))
        {
        }
