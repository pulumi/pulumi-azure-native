...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// Backend details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:WorkspaceBackend")]
    public partial class WorkspaceBackend : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceBackend(string name, WorkspaceBackendArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceBackend", name, args ?? new WorkspaceBackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceBackend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceBackend", name, null, MakeResourceOptions(options, id))
        {
        }
