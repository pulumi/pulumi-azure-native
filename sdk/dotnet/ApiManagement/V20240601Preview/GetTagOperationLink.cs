...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetTagOperationLink
    {
        ...
        public static Task<GetTagOperationLinkResult> InvokeAsync(GetTagOperationLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagOperationLinkResult>("azure-native:apimanagement/v20240601preview:getTagOperationLink", args ?? new GetTagOperationLinkArgs(), options.WithDefaults());
