...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetProductApiLink
    {
        ...
        public static Task<GetProductApiLinkResult> InvokeAsync(GetProductApiLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProductApiLinkResult>("azure-native:apimanagement/v20240601preview:getProductApiLink", args ?? new GetProductApiLinkArgs(), options.WithDefaults());
