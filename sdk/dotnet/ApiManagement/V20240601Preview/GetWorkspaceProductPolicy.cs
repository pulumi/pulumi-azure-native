...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetWorkspaceProductPolicy
    {
        ...
        public static Task<GetWorkspaceProductPolicyResult> InvokeAsync(GetWorkspaceProductPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceProductPolicyResult>("azure-native:apimanagement/v20240601preview:getWorkspaceProductPolicy", args ?? new GetWorkspaceProductPolicyArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkspaceProductPolicyResult> Invoke(GetWorkspaceProductPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceProductPolicyResult>("azure-native:apimanagement/v20240601preview:getWorkspaceProductPolicy", args ?? new GetWorkspaceProductPolicyInvokeArgs(), options.WithDefaults());
