...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:WorkspaceApiSchema")]
    public partial class WorkspaceApiSchema : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApiSchema(string name, WorkspaceApiSchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceApiSchema", name, args ?? new WorkspaceApiSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApiSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceApiSchema", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230501preview:WorkspaceApiSchema" },
