...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetDocumentation
    {
        ...
        public static Task<GetDocumentationResult> InvokeAsync(GetDocumentationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDocumentationResult>("azure-native:apimanagement/v20240601preview:getDocumentation", args ?? new GetDocumentationArgs(), options.WithDefaults());
