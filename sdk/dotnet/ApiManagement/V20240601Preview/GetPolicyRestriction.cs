...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetPolicyRestriction
    {
        ...
        public static Task<GetPolicyRestrictionResult> InvokeAsync(GetPolicyRestrictionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicyRestrictionResult>("azure-native:apimanagement/v20240601preview:getPolicyRestriction", args ?? new GetPolicyRestrictionArgs(), options.WithDefaults());
