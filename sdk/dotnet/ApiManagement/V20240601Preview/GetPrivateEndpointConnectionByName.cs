...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetPrivateEndpointConnectionByName
    {
        ...
        public static Task<GetPrivateEndpointConnectionByNameResult> InvokeAsync(GetPrivateEndpointConnectionByNameArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointConnectionByNameResult>("azure-native:apimanagement/v20240601preview:getPrivateEndpointConnectionByName", args ?? new GetPrivateEndpointConnectionByNameArgs(), options.WithDefaults());
