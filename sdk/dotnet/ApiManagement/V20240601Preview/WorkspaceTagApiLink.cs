...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:WorkspaceTagApiLink")]
    public partial class WorkspaceTagApiLink : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceTagApiLink(string name, WorkspaceTagApiLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceTagApiLink", name, args ?? new WorkspaceTagApiLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceTagApiLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceTagApiLink", name, null, MakeResourceOptions(options, id))
        {
        }
