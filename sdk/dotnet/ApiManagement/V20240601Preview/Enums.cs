...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct ReleaseChannel : IEquatable<ReleaseChannel>
    {
        private readonly string _value;

        private ReleaseChannel(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static ReleaseChannel Preview { get; } = new ReleaseChannel("Preview");
        /// <summary>
        /// Default Channel of the service.
        /// </summary>
        public static ReleaseChannel Default { get; } = new ReleaseChannel("Default");
        /// <summary>
        /// Stable Channel of the service.
        /// </summary>
        public static ReleaseChannel Stable { get; } = new ReleaseChannel("Stable");

        public static bool operator ==(ReleaseChannel left, ReleaseChannel right) => left.Equals(right);
        public static bool operator !=(ReleaseChannel left, ReleaseChannel right) => !left.Equals(right);

        public static explicit operator string(ReleaseChannel value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is ReleaseChannel other && Equals(other);
        public bool Equals(ReleaseChannel other) => string.Equals(_value, other._value, StringComparison.Ordinal);
