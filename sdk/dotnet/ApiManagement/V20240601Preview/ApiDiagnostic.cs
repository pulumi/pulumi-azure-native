...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// Diagnostic details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:ApiDiagnostic")]
    public partial class ApiDiagnostic : global::Pulumi.CustomResource
    {
        ...
        public ApiDiagnostic(string name, ApiDiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:ApiDiagnostic", name, args ?? new ApiDiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiDiagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:ApiDiagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiDiagnosticArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("alwaysLog")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240601Preview.AlwaysLog>? AlwaysLog { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240601Preview.HttpCorrelationProtocol>? HttpCorrelationProtocol { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240601Preview.OperationNameFormat>? OperationNameFormat { get; set; }
        ...
        /// </summary>
        [Input("verbosity")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240601Preview.Verbosity>? Verbosity { get; set; }
