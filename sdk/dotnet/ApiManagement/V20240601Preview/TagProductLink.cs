...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:TagProductLink")]
    public partial class TagProductLink : global::Pulumi.CustomResource
    {
        ...
        public TagProductLink(string name, TagProductLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:TagProductLink", name, args ?? new TagProductLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagProductLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:TagProductLink", name, null, MakeResourceOptions(options, id))
        {
        }
