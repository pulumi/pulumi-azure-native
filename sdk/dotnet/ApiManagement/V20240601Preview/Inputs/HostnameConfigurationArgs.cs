...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview.Inputs
{
    ...
    public sealed class HostnameConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240601Preview.CertificateSource>? CertificateSource { get; set; }

        /// <summary>
        /// Certificate Status.
        /// </summary>
        [Input("certificateStatus")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240601Preview.CertificateStatus>? CertificateStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240601Preview.HostnameType> Type { get; set; } = null!;
