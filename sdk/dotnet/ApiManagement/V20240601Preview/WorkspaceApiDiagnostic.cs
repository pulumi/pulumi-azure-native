...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// Diagnostic details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:WorkspaceApiDiagnostic")]
    public partial class WorkspaceApiDiagnostic : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApiDiagnostic(string name, WorkspaceApiDiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceApiDiagnostic", name, args ?? new WorkspaceApiDiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApiDiagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceApiDiagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240501:WorkspaceApiDiagnostic" },
