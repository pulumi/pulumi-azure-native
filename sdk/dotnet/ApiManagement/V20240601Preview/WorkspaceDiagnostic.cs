...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// Diagnostic details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:WorkspaceDiagnostic")]
    public partial class WorkspaceDiagnostic : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceDiagnostic(string name, WorkspaceDiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceDiagnostic", name, args ?? new WorkspaceDiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceDiagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceDiagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
