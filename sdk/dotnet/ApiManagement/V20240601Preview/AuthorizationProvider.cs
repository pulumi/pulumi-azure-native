...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:AuthorizationProvider")]
    public partial class AuthorizationProvider : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationProvider(string name, AuthorizationProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:AuthorizationProvider", name, args ?? new AuthorizationProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:AuthorizationProvider", name, null, MakeResourceOptions(options, id))
        {
        }
