...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:Subscription")]
    public partial class Subscription : global::Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
