...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// Logger details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:WorkspaceLogger")]
    public partial class WorkspaceLogger : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceLogger(string name, WorkspaceLoggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceLogger", name, args ?? new WorkspaceLoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceLogger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:WorkspaceLogger", name, null, MakeResourceOptions(options, id))
        {
        }
