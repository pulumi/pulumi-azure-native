...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetGraphQLApiResolver
    {
        ...
        public static Task<GetGraphQLApiResolverResult> InvokeAsync(GetGraphQLApiResolverArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGraphQLApiResolverResult>("azure-native:apimanagement/v20240601preview:getGraphQLApiResolver", args ?? new GetGraphQLApiResolverArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the GraphQL API Resolver specified by its identifier.
        /// </summary>
        public static Output<GetGraphQLApiResolverResult> Invoke(GetGraphQLApiResolverInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGraphQLApiResolverResult>("azure-native:apimanagement/v20240601preview:getGraphQLApiResolver", args ?? new GetGraphQLApiResolverInvokeArgs(), options.WithDefaults());
    }
