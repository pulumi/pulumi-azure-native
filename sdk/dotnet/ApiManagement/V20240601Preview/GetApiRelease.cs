...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetApiRelease
    {
        ...
        public static Task<GetApiReleaseResult> InvokeAsync(GetApiReleaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiReleaseResult>("azure-native:apimanagement/v20240601preview:getApiRelease", args ?? new GetApiReleaseArgs(), options.WithDefaults());
