...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    ...
    /// API details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240601preview:GatewayApiEntityTag")]
    public partial class GatewayApiEntityTag : global::Pulumi.CustomResource
    {
        ...
        public GatewayApiEntityTag(string name, GatewayApiEntityTagArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:GatewayApiEntityTag", name, args ?? new GatewayApiEntityTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayApiEntityTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240601preview:GatewayApiEntityTag", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GatewayApiEntityTagArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.ApiManagement.V20240601Preview.ProvisioningState>? ProvisioningState { get; set; }
