...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetApiGatewayConfigConnection
    {
        ...
        public static Task<GetApiGatewayConfigConnectionResult> InvokeAsync(GetApiGatewayConfigConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiGatewayConfigConnectionResult>("azure-native:apimanagement/v20240601preview:getApiGatewayConfigConnection", args ?? new GetApiGatewayConfigConnectionArgs(), options.WithDefaults());
        ...
        public static Output<GetApiGatewayConfigConnectionResult> Invoke(GetApiGatewayConfigConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiGatewayConfigConnectionResult>("azure-native:apimanagement/v20240601preview:getApiGatewayConfigConnection", args ?? new GetApiGatewayConfigConnectionInvokeArgs(), options.WithDefaults());
