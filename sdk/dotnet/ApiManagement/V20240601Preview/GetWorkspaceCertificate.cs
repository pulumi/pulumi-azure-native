...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetWorkspaceCertificate
    {
        ...
        public static Task<GetWorkspaceCertificateResult> InvokeAsync(GetWorkspaceCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceCertificateResult>("azure-native:apimanagement/v20240601preview:getWorkspaceCertificate", args ?? new GetWorkspaceCertificateArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkspaceCertificateResult> Invoke(GetWorkspaceCertificateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceCertificateResult>("azure-native:apimanagement/v20240601preview:getWorkspaceCertificate", args ?? new GetWorkspaceCertificateInvokeArgs(), options.WithDefaults());
