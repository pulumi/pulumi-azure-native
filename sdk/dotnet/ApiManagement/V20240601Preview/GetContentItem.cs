...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetContentItem
    {
        ...
        public static Task<GetContentItemResult> InvokeAsync(GetContentItemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContentItemResult>("azure-native:apimanagement/v20240601preview:getContentItem", args ?? new GetContentItemArgs(), options.WithDefaults());
