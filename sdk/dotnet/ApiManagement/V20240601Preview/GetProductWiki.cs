...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetProductWiki
    {
        ...
        public static Task<GetProductWikiResult> InvokeAsync(GetProductWikiArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProductWikiResult>("azure-native:apimanagement/v20240601preview:getProductWiki", args ?? new GetProductWikiArgs(), options.WithDefaults());
