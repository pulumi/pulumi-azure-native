...
namespace Pulumi.AzureNative.ApiManagement.V20240601Preview
{
    public static class GetGateway
    {
        ...
        public static Task<GetGatewayResult> InvokeAsync(GetGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewayResult>("azure-native:apimanagement/v20240601preview:getGateway", args ?? new GetGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the Gateway specified by its identifier.
        /// </summary>
        public static Output<GetGatewayResult> Invoke(GetGatewayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGatewayResult>("azure-native:apimanagement/v20240601preview:getGateway", args ?? new GetGatewayInvokeArgs(), options.WithDefaults());
    }
