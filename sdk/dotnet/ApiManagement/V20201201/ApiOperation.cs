...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    ...
    /// {
    ///     var apiOperation = new AzureNative.ApiManagement.V20201201.ApiOperation("apiOperation", new()
    ///     {
    ...
    ///         Request = new AzureNative.ApiManagement.V20201201.Inputs.RequestContractArgs
    ///         {
    ...
    ///             Representations = new[]
    ///             {
    ///                 new AzureNative.ApiManagement.V20201201.Inputs.RepresentationContractArgs
    ///                 {
    ...
    ///         Responses = new[]
    ///         {
    ///             new AzureNative.ApiManagement.V20201201.Inputs.ResponseContractArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20201201:ApiOperation")]
    public partial class ApiOperation : global::Pulumi.CustomResource
    {
        ...
        public ApiOperation(string name, ApiOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:ApiOperation", name, args ?? new ApiOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:ApiOperation", name, null, MakeResourceOptions(options, id))
        {
        }
