...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    ...
    /// {
    ///     var namedValue = new AzureNative.ApiManagement.V20201201.NamedValue("namedValue", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20201201:NamedValue")]
    public partial class NamedValue : global::Pulumi.CustomResource
    {
        ...
        public NamedValue(string name, NamedValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:NamedValue", name, args ?? new NamedValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamedValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:NamedValue", name, null, MakeResourceOptions(options, id))
        {
        }
