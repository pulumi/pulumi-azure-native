...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    public static class GetUser
    {
        ...
        public static Task<GetUserResult> InvokeAsync(GetUserArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserResult>("azure-native:apimanagement/v20201201:getUser", args ?? new GetUserArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the user specified by its identifier.
        /// </summary>
        public static Output<GetUserResult> Invoke(GetUserInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserResult>("azure-native:apimanagement/v20201201:getUser", args ?? new GetUserInvokeArgs(), options.WithDefaults());
