...
{
    [Obsolete(@"azure-native:apimanagement/v20201201:Product is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Product to guarantee forwards compatibility.")]
    public static class GetProduct
    {
        ...
        public static Task<GetProductResult> InvokeAsync(GetProductArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProductResult>("azure-native:apimanagement/v20201201:getProduct", args ?? new GetProductArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the product specified by its identifier.
        /// </summary>
        public static Output<GetProductResult> Invoke(GetProductInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProductResult>("azure-native:apimanagement/v20201201:getProduct", args ?? new GetProductInvokeArgs(), options.WithDefaults());
    }
