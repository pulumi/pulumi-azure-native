...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    ...
    /// {
    ///     var groupUser = new AzureNative.ApiManagement.V20201201.GroupUser("groupUser", new()
    ///     {
    ///         GroupId = "tempgroup",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:apimanagement/v20201201:GroupUser 59307d350af58404d8a26300 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/users/59307d350af58404d8a26300 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20201201:GroupUser")]
    public partial class GroupUser : global::Pulumi.CustomResource
    {
        ...
        public GroupUser(string name, GroupUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:GroupUser", name, args ?? new GroupUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:GroupUser", name, null, MakeResourceOptions(options, id))
        {
        }
