...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20201201:ApiIssue is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiIssue to guarantee forwards compatibility.")]
    ...
    public partial class ApiIssue : global::Pulumi.CustomResource
    {
        ...
        public ApiIssue(string name, ApiIssueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:ApiIssue", name, args ?? new ApiIssueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:ApiIssue", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiIssueArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20201201.State>? State { get; set; }
