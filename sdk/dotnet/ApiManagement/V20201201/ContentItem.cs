...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    ...
    /// {
    ///     var contentItem = new AzureNative.ApiManagement.V20201201.ContentItem("contentItem", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20201201:ContentItem")]
    public partial class ContentItem : global::Pulumi.CustomResource
    {
        ...
        public ContentItem(string name, ContentItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:ContentItem", name, args ?? new ContentItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:ContentItem", name, null, MakeResourceOptions(options, id))
        {
        }
