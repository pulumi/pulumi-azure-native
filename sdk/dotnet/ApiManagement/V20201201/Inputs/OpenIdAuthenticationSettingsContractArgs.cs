...
namespace Pulumi.AzureNative.ApiManagement.V20201201.Inputs
{
    ...
    public sealed class OpenIdAuthenticationSettingsContractArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20201201.BearerTokenSendingMethods>> BearerTokenSendingMethods
        {
            get => _bearerTokenSendingMethods ?? (_bearerTokenSendingMethods = new InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20201201.BearerTokenSendingMethods>>());
