...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20201201:GatewayCertificateAuthority")]
    public partial class GatewayCertificateAuthority : Pulumi.CustomResource
    {
        ...
        public GatewayCertificateAuthority(string name, GatewayCertificateAuthorityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:GatewayCertificateAuthority", name, args ?? new GatewayCertificateAuthorityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayCertificateAuthority(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:GatewayCertificateAuthority", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20201201:GatewayCertificateAuthority"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:GatewayCertificateAuthority"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210401preview:GatewayCertificateAuthority"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:GatewayCertificateAuthority"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:GatewayCertificateAuthority"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:GatewayCertificateAuthority"},
                },
            };
