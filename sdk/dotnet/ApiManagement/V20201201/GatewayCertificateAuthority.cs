...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    ...
    /// {
    ///     var gatewayCertificateAuthority = new AzureNative.ApiManagement.V20201201.GatewayCertificateAuthority("gatewayCertificateAuthority", new()
    ///     {
    ///         CertificateId = "cert1",
    ///         GatewayId = "gw1",
    ///         IsTrusted = false,
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:apimanagement/v20201201:GatewayCertificateAuthority cert1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/gateways/gw1/certificateAuthorities/cert1 
    /// ```
    /// </summary>
