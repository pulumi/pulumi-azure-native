...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    public static class GetLogger
    {
        ...
        public static Task<GetLoggerResult> InvokeAsync(GetLoggerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLoggerResult>("azure-native:apimanagement/v20201201:getLogger", args ?? new GetLoggerArgs(), options.WithDefaults());

        /// <summary>
        /// Logger details.
        /// </summary>
        public static Output<GetLoggerResult> Invoke(GetLoggerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLoggerResult>("azure-native:apimanagement/v20201201:getLogger", args ?? new GetLoggerInvokeArgs(), options.WithDefaults());
    }
