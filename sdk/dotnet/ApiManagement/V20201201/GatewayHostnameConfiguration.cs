...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    ...
    /// {
    ///     var gatewayHostnameConfiguration = new AzureNative.ApiManagement.V20201201.GatewayHostnameConfiguration("gatewayHostnameConfiguration", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20201201:GatewayHostnameConfiguration")]
    public partial class GatewayHostnameConfiguration : global::Pulumi.CustomResource
    {
        ...
        public GatewayHostnameConfiguration(string name, GatewayHostnameConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:GatewayHostnameConfiguration", name, args ?? new GatewayHostnameConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayHostnameConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:GatewayHostnameConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
