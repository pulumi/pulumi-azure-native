...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    public static class GetContentType
    {
        ...
        public static Task<GetContentTypeResult> InvokeAsync(GetContentTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContentTypeResult>("azure-native:apimanagement/v20201201:getContentType", args ?? new GetContentTypeArgs(), options.WithVersion());

        /// <summary>
        /// Content type contract details.
        /// </summary>
        public static Output<GetContentTypeResult> Invoke(GetContentTypeInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetContentTypeResult>("azure-native:apimanagement/v20201201:getContentType", args ?? new GetContentTypeInvokeArgs(), options.WithVersion());
    }
