...
namespace Pulumi.AzureNative.ApiManagement.V20201201
{
    ...
    /// {
    ///     var productApi = new AzureNative.ApiManagement.V20201201.ProductApi("productApi", new()
    ///     {
    ///         ApiId = "echo-api",
    ...
    /// 
    /// ```sh
    /// $ pulumi import azure-native:apimanagement/v20201201:ProductApi 5931a75ae4bbd512a88c680b /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/apis/5931a75ae4bbd512a88c680b 
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20201201:ProductApi")]
    public partial class ProductApi : global::Pulumi.CustomResource
    {
        ...
        public ProductApi(string name, ProductApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:ProductApi", name, args ?? new ProductApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20201201:ProductApi", name, null, MakeResourceOptions(options, id))
        {
        }
