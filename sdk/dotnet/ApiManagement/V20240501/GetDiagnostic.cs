...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetDiagnostic
    {
        ...
        public static Task<GetDiagnosticResult> InvokeAsync(GetDiagnosticArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDiagnosticResult>("azure-native:apimanagement/v20240501:getDiagnostic", args ?? new GetDiagnosticArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the Diagnostic specified by its identifier.
        /// </summary>
        public static Output<GetDiagnosticResult> Invoke(GetDiagnosticInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDiagnosticResult>("azure-native:apimanagement/v20240501:getDiagnostic", args ?? new GetDiagnosticInvokeArgs(), options.WithDefaults());
