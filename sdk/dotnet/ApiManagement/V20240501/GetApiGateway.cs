...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetApiGateway
    {
        ...
        public static Task<GetApiGatewayResult> InvokeAsync(GetApiGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiGatewayResult>("azure-native:apimanagement/v20240501:getApiGateway", args ?? new GetApiGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Gets an API Management gateway resource description.
        /// </summary>
        public static Output<GetApiGatewayResult> Invoke(GetApiGatewayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiGatewayResult>("azure-native:apimanagement/v20240501:getApiGateway", args ?? new GetApiGatewayInvokeArgs(), options.WithDefaults());
    }
