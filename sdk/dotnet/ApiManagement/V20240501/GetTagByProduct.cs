...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetTagByProduct
    {
        ...
        public static Task<GetTagByProductResult> InvokeAsync(GetTagByProductArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagByProductResult>("azure-native:apimanagement/v20240501:getTagByProduct", args ?? new GetTagByProductArgs(), options.WithDefaults());

        /// <summary>
        /// Get tag associated with the Product.
        /// </summary>
        public static Output<GetTagByProductResult> Invoke(GetTagByProductInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTagByProductResult>("azure-native:apimanagement/v20240501:getTagByProduct", args ?? new GetTagByProductInvokeArgs(), options.WithDefaults());
