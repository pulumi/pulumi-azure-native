...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:WorkspaceTagApiLink")]
    public partial class WorkspaceTagApiLink : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceTagApiLink(string name, WorkspaceTagApiLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceTagApiLink", name, args ?? new WorkspaceTagApiLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceTagApiLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceTagApiLink", name, null, MakeResourceOptions(options, id))
        {
        }
