...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetNamedValue
    {
        ...
        public static Task<GetNamedValueResult> InvokeAsync(GetNamedValueArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNamedValueResult>("azure-native:apimanagement/v20240501:getNamedValue", args ?? new GetNamedValueArgs(), options.WithDefaults());
