...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:Documentation")]
    public partial class Documentation : global::Pulumi.CustomResource
    {
        ...
        public Documentation(string name, DocumentationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:Documentation", name, args ?? new DocumentationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Documentation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:Documentation", name, null, MakeResourceOptions(options, id))
        {
        }
