...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetApiDiagnostic
    {
        ...
        public static Task<GetApiDiagnosticResult> InvokeAsync(GetApiDiagnosticArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiDiagnosticResult>("azure-native:apimanagement/v20240501:getApiDiagnostic", args ?? new GetApiDiagnosticArgs(), options.WithDefaults());
