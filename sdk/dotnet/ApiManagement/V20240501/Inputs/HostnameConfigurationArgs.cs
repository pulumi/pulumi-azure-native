...
namespace Pulumi.AzureNative.ApiManagement.V20240501.Inputs
{
    ...
    public sealed class HostnameConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240501.CertificateSource>? CertificateSource { get; set; }

        /// <summary>
        /// Certificate Status.
        /// </summary>
        [Input("certificateStatus")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240501.CertificateStatus>? CertificateStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240501.HostnameType> Type { get; set; } = null!;
