...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:WorkspaceApiOperation")]
    public partial class WorkspaceApiOperation : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApiOperation(string name, WorkspaceApiOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceApiOperation", name, args ?? new WorkspaceApiOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApiOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceApiOperation", name, null, MakeResourceOptions(options, id))
        {
        }
