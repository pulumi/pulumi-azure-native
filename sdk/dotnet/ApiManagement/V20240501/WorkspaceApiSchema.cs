...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:WorkspaceApiSchema")]
    public partial class WorkspaceApiSchema : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApiSchema(string name, WorkspaceApiSchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceApiSchema", name, args ?? new WorkspaceApiSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApiSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceApiSchema", name, null, MakeResourceOptions(options, id))
        {
        }
