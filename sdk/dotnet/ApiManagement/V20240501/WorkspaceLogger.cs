...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// Logger details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:WorkspaceLogger")]
    public partial class WorkspaceLogger : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceLogger(string name, WorkspaceLoggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceLogger", name, args ?? new WorkspaceLoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceLogger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceLogger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceLoggerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240501.LoggerType> LoggerType { get; set; } = null!;
