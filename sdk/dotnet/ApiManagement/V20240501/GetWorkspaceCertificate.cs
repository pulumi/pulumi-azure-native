...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetWorkspaceCertificate
    {
        ...
        public static Task<GetWorkspaceCertificateResult> InvokeAsync(GetWorkspaceCertificateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceCertificateResult>("azure-native:apimanagement/v20240501:getWorkspaceCertificate", args ?? new GetWorkspaceCertificateArgs(), options.WithDefaults());
