...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:TagProductLink")]
    public partial class TagProductLink : global::Pulumi.CustomResource
    {
        ...
        public TagProductLink(string name, TagProductLinkArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:TagProductLink", name, args ?? new TagProductLinkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagProductLink(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:TagProductLink", name, null, MakeResourceOptions(options, id))
        {
        }
