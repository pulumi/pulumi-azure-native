...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// User details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:GroupUser")]
    public partial class GroupUser : global::Pulumi.CustomResource
    {
        ...
        public GroupUser(string name, GroupUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:GroupUser", name, args ?? new GroupUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:GroupUser", name, null, MakeResourceOptions(options, id))
        {
        }
