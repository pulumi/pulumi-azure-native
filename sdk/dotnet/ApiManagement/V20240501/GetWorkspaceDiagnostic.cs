...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetWorkspaceDiagnostic
    {
        ...
        public static Task<GetWorkspaceDiagnosticResult> InvokeAsync(GetWorkspaceDiagnosticArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceDiagnosticResult>("azure-native:apimanagement/v20240501:getWorkspaceDiagnostic", args ?? new GetWorkspaceDiagnosticArgs(), options.WithDefaults());
