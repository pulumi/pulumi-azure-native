...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetPolicyRestriction
    {
        ...
        public static Task<GetPolicyRestrictionResult> InvokeAsync(GetPolicyRestrictionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicyRestrictionResult>("azure-native:apimanagement/v20240501:getPolicyRestriction", args ?? new GetPolicyRestrictionArgs(), options.WithDefaults());

        /// <summary>
        /// Get the policy restriction of the Api Management service.
        /// </summary>
        public static Output<GetPolicyRestrictionResult> Invoke(GetPolicyRestrictionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicyRestrictionResult>("azure-native:apimanagement/v20240501:getPolicyRestriction", args ?? new GetPolicyRestrictionInvokeArgs(), options.WithDefaults());
    }
