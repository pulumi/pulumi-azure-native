...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:Authorization")]
    public partial class Authorization : global::Pulumi.CustomResource
    {
        ...
        public Authorization(string name, AuthorizationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:Authorization", name, args ?? new AuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Authorization(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:Authorization", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AuthorizationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240501.AuthorizationType>? AuthorizationType { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240501.OAuth2GrantType>? OAuth2GrantType { get; set; }
