...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:ContentItem")]
    public partial class ContentItem : global::Pulumi.CustomResource
    {
        ...
        public ContentItem(string name, ContentItemArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:ContentItem", name, args ?? new ContentItemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentItem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:ContentItem", name, null, MakeResourceOptions(options, id))
        {
        }
