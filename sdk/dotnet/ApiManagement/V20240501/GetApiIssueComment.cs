...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetApiIssueComment
    {
        ...
        public static Task<GetApiIssueCommentResult> InvokeAsync(GetApiIssueCommentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueCommentResult>("azure-native:apimanagement/v20240501:getApiIssueComment", args ?? new GetApiIssueCommentArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the issue Comment for an API specified by its identifier.
        /// </summary>
        public static Output<GetApiIssueCommentResult> Invoke(GetApiIssueCommentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiIssueCommentResult>("azure-native:apimanagement/v20240501:getApiIssueComment", args ?? new GetApiIssueCommentInvokeArgs(), options.WithDefaults());
