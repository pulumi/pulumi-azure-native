...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:GraphQLApiResolverPolicy")]
    public partial class GraphQLApiResolverPolicy : global::Pulumi.CustomResource
    {
        ...
        public GraphQLApiResolverPolicy(string name, GraphQLApiResolverPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:GraphQLApiResolverPolicy", name, args ?? new GraphQLApiResolverPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphQLApiResolverPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:GraphQLApiResolverPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
