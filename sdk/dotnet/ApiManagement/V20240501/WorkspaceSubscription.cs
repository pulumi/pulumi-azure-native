...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:WorkspaceSubscription")]
    public partial class WorkspaceSubscription : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceSubscription(string name, WorkspaceSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceSubscription", name, args ?? new WorkspaceSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WorkspaceSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.ApiManagement.V20240501.SubscriptionState>? State { get; set; }
