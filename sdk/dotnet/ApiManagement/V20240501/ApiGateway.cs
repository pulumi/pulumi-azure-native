...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:ApiGateway")]
    public partial class ApiGateway : global::Pulumi.CustomResource
    {
        ...
        public ApiGateway(string name, ApiGatewayArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:ApiGateway", name, args ?? new ApiGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:ApiGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiGatewayArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20240501.VirtualNetworkType>? VirtualNetworkType { get; set; }
