...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class GetApiIssue
    {
        ...
        public static Task<GetApiIssueResult> InvokeAsync(GetApiIssueArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueResult>("azure-native:apimanagement/v20240501:getApiIssue", args ?? new GetApiIssueArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the Issue for an API specified by its identifier.
        /// </summary>
        public static Output<GetApiIssueResult> Invoke(GetApiIssueInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiIssueResult>("azure-native:apimanagement/v20240501:getApiIssue", args ?? new GetApiIssueInvokeArgs(), options.WithDefaults());
