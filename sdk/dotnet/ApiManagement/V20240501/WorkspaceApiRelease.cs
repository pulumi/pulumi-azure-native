...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// ApiRelease details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:WorkspaceApiRelease")]
    public partial class WorkspaceApiRelease : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApiRelease(string name, WorkspaceApiReleaseArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceApiRelease", name, args ?? new WorkspaceApiReleaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApiRelease(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:WorkspaceApiRelease", name, null, MakeResourceOptions(options, id))
        {
        }
