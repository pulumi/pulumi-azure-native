...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20240501:Group")]
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20240501:Group", name, null, MakeResourceOptions(options, id))
        {
        }
