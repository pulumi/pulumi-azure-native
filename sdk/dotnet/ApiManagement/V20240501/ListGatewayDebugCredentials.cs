...
namespace Pulumi.AzureNative.ApiManagement.V20240501
{
    public static class ListGatewayDebugCredentials
    {
        ...
        public static Task<ListGatewayDebugCredentialsResult> InvokeAsync(ListGatewayDebugCredentialsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListGatewayDebugCredentialsResult>("azure-native:apimanagement/v20240501:listGatewayDebugCredentials", args ?? new ListGatewayDebugCredentialsArgs(), options.WithDefaults());
    ...
    public sealed class ListGatewayDebugCredentialsArgs : global::Pulumi.InvokeArgs
    {
        ...
        private List<Union<string, Pulumi.AzureNative.ApiManagement.V20240501.GatewayListDebugCredentialsContractPurpose>>? _purposes;

        /// <summary>
        /// Purposes of debug credential.
        /// </summary>
        public List<Union<string, Pulumi.AzureNative.ApiManagement.V20240501.GatewayListDebugCredentialsContractPurpose>> Purposes
        {
            get => _purposes ?? (_purposes = new List<Union<string, Pulumi.AzureNative.ApiManagement.V20240501.GatewayListDebugCredentialsContractPurpose>>());
            set => _purposes = value;
        }
    ...
    public sealed class ListGatewayDebugCredentialsInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("purposes", required: true)]
        private InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20240501.GatewayListDebugCredentialsContractPurpose>>? _purposes;

        /// <summary>
        /// Purposes of debug credential.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20240501.GatewayListDebugCredentialsContractPurpose>> Purposes
        {
            get => _purposes ?? (_purposes = new InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20240501.GatewayListDebugCredentialsContractPurpose>>());
            set => _purposes = value;
        }
