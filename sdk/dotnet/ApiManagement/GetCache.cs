...
namespace Pulumi.AzureNative.ApiManagement
{
    public static class GetCache
    {
        ...
        public static Task<GetCacheResult> InvokeAsync(GetCacheArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCacheResult>("azure-native:apimanagement:getCache", args ?? new GetCacheArgs(), options.WithVersion());
        ...
        public static Output<GetCacheResult> Invoke(GetCacheInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCacheResult>("azure-native:apimanagement:getCache", args ?? new GetCacheInvokeArgs(), options.WithVersion());
    }
