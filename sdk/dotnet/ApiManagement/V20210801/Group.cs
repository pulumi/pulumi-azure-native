...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210801:Group")]
    public partial class Group : Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:Group", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GroupArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.ApiManagement.V20210801.GroupType>? Type { get; set; }
