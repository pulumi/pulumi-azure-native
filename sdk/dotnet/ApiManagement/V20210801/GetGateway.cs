...
{
    [Obsolete(@"azure-native:apimanagement/v20210801:Gateway is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Gateway to guarantee forwards compatibility.")]
    public static class GetGateway
    {
        ...
        public static Task<GetGatewayResult> InvokeAsync(GetGatewayArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewayResult>("azure-native:apimanagement/v20210801:getGateway", args ?? new GetGatewayArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the Gateway specified by its identifier.
        /// </summary>
        public static Output<GetGatewayResult> Invoke(GetGatewayInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGatewayResult>("azure-native:apimanagement/v20210801:getGateway", args ?? new GetGatewayInvokeArgs(), options.WithDefaults());
    }
