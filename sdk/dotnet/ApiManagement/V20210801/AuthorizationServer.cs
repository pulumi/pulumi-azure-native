...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210801:AuthorizationServer")]
    public partial class AuthorizationServer : Pulumi.CustomResource
    {
        ...
        public AuthorizationServer(string name, AuthorizationServerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:AuthorizationServer", name, args ?? new AuthorizationServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:AuthorizationServer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AuthorizationServerArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.AzureNative.ApiManagement.V20210801.AuthorizationMethod>? _authorizationMethods;

        /// <summary>
        /// HTTP verbs supported by the authorization endpoint. GET must be always present. POST is optional.
        /// </summary>
        public InputList<Pulumi.AzureNative.ApiManagement.V20210801.AuthorizationMethod> AuthorizationMethods
        {
            get => _authorizationMethods ?? (_authorizationMethods = new InputList<Pulumi.AzureNative.ApiManagement.V20210801.AuthorizationMethod>());
        ...
        private InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20210801.BearerTokenSendingMethod>>? _bearerTokenSendingMethods;

        /// <summary>
        /// Specifies the mechanism by which access token is passed to the API. 
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20210801.BearerTokenSendingMethod>> BearerTokenSendingMethods
        {
            get => _bearerTokenSendingMethods ?? (_bearerTokenSendingMethods = new InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20210801.BearerTokenSendingMethod>>());
            set => _bearerTokenSendingMethods = value;
        }

        [Input("clientAuthenticationMethod")]
        private InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20210801.ClientAuthenticationMethod>>? _clientAuthenticationMethod;

        /// <summary>
        /// Method of authentication supported by the token endpoint of this authorization server. Possible values are Basic and/or Body. When Body is specified, client credentials and other parameters are passed within the request body in the application/x-www-form-urlencoded format.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20210801.ClientAuthenticationMethod>> ClientAuthenticationMethod
        {
            get => _clientAuthenticationMethod ?? (_clientAuthenticationMethod = new InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20210801.ClientAuthenticationMethod>>());
        ...
        private InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20210801.GrantType>>? _grantTypes;

        /// <summary>
        /// Form of an authorization grant, which the client uses to request the access token.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20210801.GrantType>> GrantTypes
        {
            get => _grantTypes ?? (_grantTypes = new InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20210801.GrantType>>());
