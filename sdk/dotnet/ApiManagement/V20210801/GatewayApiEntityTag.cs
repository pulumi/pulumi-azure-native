...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    ...
    /// API details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210801:GatewayApiEntityTag")]
    public partial class GatewayApiEntityTag : global::Pulumi.CustomResource
    {
        ...
        public GatewayApiEntityTag(string name, GatewayApiEntityTagArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:GatewayApiEntityTag", name, args ?? new GatewayApiEntityTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayApiEntityTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:GatewayApiEntityTag", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GatewayApiEntityTagArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.ApiManagement.V20210801.ProvisioningState>? ProvisioningState { get; set; }
