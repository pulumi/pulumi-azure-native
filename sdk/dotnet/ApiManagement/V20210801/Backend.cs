...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    ...
    /// Backend details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210801:Backend")]
    public partial class Backend : Pulumi.CustomResource
    {
        ...
        public Backend(string name, BackendArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:Backend", name, args ?? new BackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:Backend", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:Backend"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20201201:Backend"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210101preview:Backend"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:Backend"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210401preview:Backend"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:Backend"},
                },
            };
    ...
    public sealed class BackendArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210801.BackendProtocol> Protocol { get; set; } = null!;
