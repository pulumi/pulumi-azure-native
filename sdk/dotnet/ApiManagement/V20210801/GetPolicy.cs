...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    public static class GetPolicy
    {
        ...
        public static Task<GetPolicyResult> InvokeAsync(GetPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPolicyResult>("azure-native:apimanagement/v20210801:getPolicy", args ?? new GetPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Get the Global policy definition of the Api Management service.
        /// </summary>
        public static Output<GetPolicyResult> Invoke(GetPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPolicyResult>("azure-native:apimanagement/v20210801:getPolicy", args ?? new GetPolicyInvokeArgs(), options.WithDefaults());
