...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    public static class GetDiagnostic
    {
        ...
        public static Task<GetDiagnosticResult> InvokeAsync(GetDiagnosticArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDiagnosticResult>("azure-native:apimanagement/v20210801:getDiagnostic", args ?? new GetDiagnosticArgs(), options.WithVersion());

        /// <summary>
        /// Diagnostic details.
        /// </summary>
        public static Output<GetDiagnosticResult> Invoke(GetDiagnosticInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDiagnosticResult>("azure-native:apimanagement/v20210801:getDiagnostic", args ?? new GetDiagnosticInvokeArgs(), options.WithVersion());
    }
