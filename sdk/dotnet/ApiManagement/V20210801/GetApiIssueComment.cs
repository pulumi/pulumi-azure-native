...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    public static class GetApiIssueComment
    {
        ...
        public static Task<GetApiIssueCommentResult> InvokeAsync(GetApiIssueCommentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueCommentResult>("azure-native:apimanagement/v20210801:getApiIssueComment", args ?? new GetApiIssueCommentArgs(), options.WithVersion());

        /// <summary>
        /// Issue Comment Contract details.
        /// </summary>
        public static Output<GetApiIssueCommentResult> Invoke(GetApiIssueCommentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiIssueCommentResult>("azure-native:apimanagement/v20210801:getApiIssueComment", args ?? new GetApiIssueCommentInvokeArgs(), options.WithVersion());
    }
