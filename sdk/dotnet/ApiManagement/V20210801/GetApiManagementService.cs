...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    public static class GetApiManagementService
    {
        ...
        public static Task<GetApiManagementServiceResult> InvokeAsync(GetApiManagementServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiManagementServiceResult>("azure-native:apimanagement/v20210801:getApiManagementService", args ?? new GetApiManagementServiceArgs(), options.WithVersion());
        ...
        public static Output<GetApiManagementServiceResult> Invoke(GetApiManagementServiceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiManagementServiceResult>("azure-native:apimanagement/v20210801:getApiManagementService", args ?? new GetApiManagementServiceInvokeArgs(), options.WithVersion());
    }
