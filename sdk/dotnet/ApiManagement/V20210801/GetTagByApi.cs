...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    public static class GetTagByApi
    {
        ...
        public static Task<GetTagByApiResult> InvokeAsync(GetTagByApiArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByApiResult>("azure-native:apimanagement/v20210801:getTagByApi", args ?? new GetTagByApiArgs(), options.WithDefaults());

        /// <summary>
        /// Tag Contract details.
        /// </summary>
        public static Output<GetTagByApiResult> Invoke(GetTagByApiInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTagByApiResult>("azure-native:apimanagement/v20210801:getTagByApi", args ?? new GetTagByApiInvokeArgs(), options.WithDefaults());
    }
