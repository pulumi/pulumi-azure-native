...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210801:NotificationRecipientEmail")]
    public partial class NotificationRecipientEmail : Pulumi.CustomResource
    {
        ...
        public NotificationRecipientEmail(string name, NotificationRecipientEmailArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:NotificationRecipientEmail", name, args ?? new NotificationRecipientEmailArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationRecipientEmail(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:NotificationRecipientEmail", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:NotificationRecipientEmail"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20190101:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20191201:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20191201:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20191201preview:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20191201preview:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20200601preview:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20200601preview:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20201201:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20201201:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210101preview:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210401preview:NotificationRecipientEmail"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:NotificationRecipientEmail"},
                },
            };
