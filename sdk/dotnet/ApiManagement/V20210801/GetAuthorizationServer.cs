...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    public static class GetAuthorizationServer
    {
        ...
        public static Task<GetAuthorizationServerResult> InvokeAsync(GetAuthorizationServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationServerResult>("azure-native:apimanagement/v20210801:getAuthorizationServer", args ?? new GetAuthorizationServerArgs(), options.WithVersion());
        ...
        public static Output<GetAuthorizationServerResult> Invoke(GetAuthorizationServerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAuthorizationServerResult>("azure-native:apimanagement/v20210801:getAuthorizationServer", args ?? new GetAuthorizationServerInvokeArgs(), options.WithVersion());
    }
