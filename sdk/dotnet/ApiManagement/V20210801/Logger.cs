...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    ...
    /// Logger details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20210801:Logger")]
    public partial class Logger : global::Pulumi.CustomResource
    {
        ...
        public Logger(string name, LoggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:Logger", name, args ?? new LoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20210801:Logger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LoggerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20210801.LoggerType> LoggerType { get; set; } = null!;
