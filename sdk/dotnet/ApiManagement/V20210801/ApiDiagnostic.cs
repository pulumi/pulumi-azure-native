    ...
    public partial class ApiDiagnostic : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:ApiDiagnostic"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20201201:ApiDiagnostic"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210101preview:ApiDiagnostic"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:ApiDiagnostic"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210401preview:ApiDiagnostic"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:ApiDiagnostic"},
                },
            };
