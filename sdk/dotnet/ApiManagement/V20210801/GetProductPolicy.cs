...
namespace Pulumi.AzureNative.ApiManagement.V20210801
{
    public static class GetProductPolicy
    {
        ...
        public static Task<GetProductPolicyResult> InvokeAsync(GetProductPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductPolicyResult>("azure-native:apimanagement/v20210801:getProductPolicy", args ?? new GetProductPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Policy Contract details.
        /// </summary>
        public static Output<GetProductPolicyResult> Invoke(GetProductPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProductPolicyResult>("azure-native:apimanagement/v20210801:getProductPolicy", args ?? new GetProductPolicyInvokeArgs(), options.WithVersion());
    }
