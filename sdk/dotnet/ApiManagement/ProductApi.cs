...
namespace Pulumi.AzureNextGen.ApiManagement
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement:ProductApi")]
    public partial class ProductApi : Pulumi.CustomResource
    {
        ...
        public ProductApi(string name, ProductApiArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement:ProductApi", name, args ?? new ProductApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement:ProductApi", name, null, MakeResourceOptions(options, id))
        {
        }
