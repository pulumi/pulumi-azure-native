...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20191201preview:OpenIdConnectProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:OpenIdConnectProvider to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20191201preview:OpenIdConnectProvider")]
    public partial class OpenIdConnectProvider : global::Pulumi.CustomResource
    {
        ...
        public OpenIdConnectProvider(string name, OpenIdConnectProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:OpenIdConnectProvider", name, args ?? new OpenIdConnectProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenIdConnectProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:OpenIdConnectProvider", name, null, MakeResourceOptions(options, id))
        {
        }
