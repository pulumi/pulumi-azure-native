...
namespace Pulumi.AzureNextGen.ApiManagement.V20191201Preview
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20191201preview:ProductGroup")]
    public partial class ProductGroup : Pulumi.CustomResource
    {
        ...
        public ProductGroup(string name, ProductGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201preview:ProductGroup", name, args ?? new ProductGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201preview:ProductGroup", name, null, MakeResourceOptions(options, id))
        {
        }
