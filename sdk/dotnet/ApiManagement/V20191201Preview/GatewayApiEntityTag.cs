...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    ...
    /// Api details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20191201preview:GatewayApiEntityTag is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:GatewayApiEntityTag to guarantee forwards compatibility.")]
    ...
    public partial class GatewayApiEntityTag : global::Pulumi.CustomResource
    {
        ...
        public GatewayApiEntityTag(string name, GatewayApiEntityTagArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:GatewayApiEntityTag", name, args ?? new GatewayApiEntityTagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayApiEntityTag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:GatewayApiEntityTag", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GatewayApiEntityTagArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.AzureNative.ApiManagement.V20191201Preview.ProvisioningState>? ProvisioningState { get; set; }
