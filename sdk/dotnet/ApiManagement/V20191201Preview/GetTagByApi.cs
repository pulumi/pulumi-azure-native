...
namespace Pulumi.AzureRM.ApiManagement.V20191201Preview
{
    public static class GetTagByApi
    {
        public static Task<GetTagByApiResult> InvokeAsync(GetTagByApiArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByApiResult>("azurerm:apimanagement/v20191201preview:getTagByApi", args ?? new GetTagByApiArgs(), options.WithVersion());
    }
