...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    public static class GetTagByApi
    {
        ...
        public static Task<GetTagByApiResult> InvokeAsync(GetTagByApiArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByApiResult>("azure-native:apimanagement/v20191201preview:getTagByApi", args ?? new GetTagByApiArgs(), options.WithDefaults());

        /// <summary>
        /// Tag Contract details.
        /// </summary>
        public static Output<GetTagByApiResult> Invoke(GetTagByApiInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTagByApiResult>("azure-native:apimanagement/v20191201preview:getTagByApi", args ?? new GetTagByApiInvokeArgs(), options.WithDefaults());
    }
