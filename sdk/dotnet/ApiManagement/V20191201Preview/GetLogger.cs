...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    public static class GetLogger
    {
        ...
        public static Task<GetLoggerResult> InvokeAsync(GetLoggerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLoggerResult>("azure-native:apimanagement/v20191201preview:getLogger", args ?? new GetLoggerArgs(), options.WithDefaults());
