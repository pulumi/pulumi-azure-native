...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    ...
    /// Contract details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20191201preview:Group is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Group to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20191201preview:Group")]
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:Group", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.ApiManagement.V20191201Preview.GroupType>? Type { get; set; }
