...
namespace Pulumi.AzureRM.ApiManagement.V20191201Preview
{
    public static class ListNamedValue
    {
        public static Task<ListNamedValueResult> InvokeAsync(ListNamedValueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamedValueResult>("azurerm:apimanagement/v20191201preview:listNamedValue", args ?? new ListNamedValueArgs(), options.WithVersion());
    }
