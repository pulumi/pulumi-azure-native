...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    public static class GetBackend
    {
        ...
        public static Task<GetBackendResult> InvokeAsync(GetBackendArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBackendResult>("azure-native:apimanagement/v20191201preview:getBackend", args ?? new GetBackendArgs(), options.WithDefaults());

        /// <summary>
        /// Backend details.
        /// </summary>
        public static Output<GetBackendResult> Invoke(GetBackendInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBackendResult>("azure-native:apimanagement/v20191201preview:getBackend", args ?? new GetBackendInvokeArgs(), options.WithDefaults());
    }
