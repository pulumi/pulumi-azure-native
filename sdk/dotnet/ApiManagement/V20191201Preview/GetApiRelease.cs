...
namespace Pulumi.AzureNextGen.ApiManagement.V20191201Preview
{
    public static class GetApiRelease
    {
        public static Task<GetApiReleaseResult> InvokeAsync(GetApiReleaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiReleaseResult>("azure-nextgen:apimanagement/v20191201preview:getApiRelease", args ?? new GetApiReleaseArgs(), options.WithVersion());
    }
