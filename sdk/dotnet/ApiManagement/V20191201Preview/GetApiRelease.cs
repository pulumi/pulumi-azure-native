...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    public static class GetApiRelease
    {
        ...
        public static Task<GetApiReleaseResult> InvokeAsync(GetApiReleaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiReleaseResult>("azure-native:apimanagement/v20191201preview:getApiRelease", args ?? new GetApiReleaseArgs(), options.WithVersion());

        /// <summary>
        /// ApiRelease details.
        /// </summary>
        public static Output<GetApiReleaseResult> Invoke(GetApiReleaseInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiReleaseResult>("azure-native:apimanagement/v20191201preview:getApiRelease", args ?? new GetApiReleaseInvokeArgs(), options.WithVersion());
    }
