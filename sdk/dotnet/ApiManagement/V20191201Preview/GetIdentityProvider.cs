...
namespace Pulumi.AzureRM.ApiManagement.V20191201Preview
{
    public static class GetIdentityProvider
    {
        public static Task<GetIdentityProviderResult> InvokeAsync(GetIdentityProviderArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIdentityProviderResult>("azurerm:apimanagement/v20191201preview:getIdentityProvider", args ?? new GetIdentityProviderArgs(), options.WithVersion());
    }
