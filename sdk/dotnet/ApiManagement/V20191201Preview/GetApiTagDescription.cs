...
namespace Pulumi.AzureRM.ApiManagement.V20191201Preview
{
    public static class GetApiTagDescription
    {
        public static Task<GetApiTagDescriptionResult> InvokeAsync(GetApiTagDescriptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiTagDescriptionResult>("azurerm:apimanagement/v20191201preview:getApiTagDescription", args ?? new GetApiTagDescriptionArgs(), options.WithVersion());
    }
