...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    public static class ListDelegationSettingSecrets
    {
        ...
        public static Task<ListDelegationSettingSecretsResult> InvokeAsync(ListDelegationSettingSecretsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListDelegationSettingSecretsResult>("azure-native:apimanagement/v20191201preview:listDelegationSettingSecrets", args ?? new ListDelegationSettingSecretsArgs(), options.WithDefaults());
        ...
        public static Output<ListDelegationSettingSecretsResult> Invoke(ListDelegationSettingSecretsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListDelegationSettingSecretsResult>("azure-native:apimanagement/v20191201preview:listDelegationSettingSecrets", args ?? new ListDelegationSettingSecretsInvokeArgs(), options.WithDefaults());
