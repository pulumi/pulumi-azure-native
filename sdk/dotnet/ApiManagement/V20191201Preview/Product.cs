...
namespace Pulumi.AzureRM.ApiManagement.V20191201Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var product = new AzureRM.ApiManagement.V20191201Preview.Product("product", new AzureRM.ApiManagement.V20191201Preview.ProductArgs
    ///         {
    ...
    public partial class Product : Pulumi.CustomResource
    {
        ...
        public Product(string name, ProductArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201preview:Product", name, args ?? new ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201preview:Product", name, null, MakeResourceOptions(options, id))
        {
        }
