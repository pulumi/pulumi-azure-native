...
namespace Pulumi.AzureRM.ApiManagement.V20191201Preview
{
    public static class GetApiSchema
    {
        public static Task<GetApiSchemaResult> InvokeAsync(GetApiSchemaArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiSchemaResult>("azurerm:apimanagement/v20191201preview:getApiSchema", args ?? new GetApiSchemaArgs(), options.WithVersion());
    }
