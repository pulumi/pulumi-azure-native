...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    ...
    /// Contract details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20191201preview:ApiTagDescription is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ApiTagDescription to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20191201preview:ApiTagDescription")]
    public partial class ApiTagDescription : global::Pulumi.CustomResource
    {
        ...
        public ApiTagDescription(string name, ApiTagDescriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:ApiTagDescription", name, args ?? new ApiTagDescriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiTagDescription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:ApiTagDescription", name, null, MakeResourceOptions(options, id))
        {
        }
