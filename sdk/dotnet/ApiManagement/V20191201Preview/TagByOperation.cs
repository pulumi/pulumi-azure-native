...
namespace Pulumi.AzureRM.ApiManagement.V20191201Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tagByOperation = new AzureRM.ApiManagement.V20191201Preview.TagByOperation("tagByOperation", new AzureRM.ApiManagement.V20191201Preview.TagByOperationArgs
    ///         {
    ...
    public partial class TagByOperation : Pulumi.CustomResource
    {
        ...
        public TagByOperation(string name, TagByOperationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201preview:TagByOperation", name, args ?? new TagByOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201preview:TagByOperation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20180601preview:TagByOperation"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20190101:TagByOperation"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201:TagByOperation"},
                },
            };
