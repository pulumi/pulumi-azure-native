...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20191201preview:TagByOperation")]
    public partial class TagByOperation : Pulumi.CustomResource
    {
        ...
        public TagByOperation(string name, TagByOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:TagByOperation", name, args ?? new TagByOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:TagByOperation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20201201:TagByOperation"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210101preview:TagByOperation"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:TagByOperation"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210401preview:TagByOperation"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:TagByOperation"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:TagByOperation"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:TagByOperation"},
                },
            };
