...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20191201preview:ApiIssueAttachment")]
    public partial class ApiIssueAttachment : global::Pulumi.CustomResource
    {
        ...
        public ApiIssueAttachment(string name, ApiIssueAttachmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:ApiIssueAttachment", name, args ?? new ApiIssueAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201preview:ApiIssueAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement:ApiIssueAttachment" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20220401preview:ApiIssueAttachment" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20220801:ApiIssueAttachment" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20220901preview:ApiIssueAttachment" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230301preview:ApiIssueAttachment" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230501preview:ApiIssueAttachment" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230901preview:ApiIssueAttachment" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240501:ApiIssueAttachment" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240601preview:ApiIssueAttachment" },
                },
            };
