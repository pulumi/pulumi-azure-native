...
namespace Pulumi.AzureNextGen.ApiManagement.V20191201Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20191201preview:GatewayHostnameConfiguration")]
    public partial class GatewayHostnameConfiguration : Pulumi.CustomResource
    {
        ...
        public GatewayHostnameConfiguration(string name, GatewayHostnameConfigurationArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201preview:GatewayHostnameConfiguration", name, args ?? new GatewayHostnameConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayHostnameConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201preview:GatewayHostnameConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
