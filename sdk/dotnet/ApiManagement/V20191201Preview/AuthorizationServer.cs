...
namespace Pulumi.AzureRM.ApiManagement.V20191201Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var authorizationServer = new AzureRM.ApiManagement.V20191201Preview.AuthorizationServer("authorizationServer", new AzureRM.ApiManagement.V20191201Preview.AuthorizationServerArgs
    ///         {
    ...
    public partial class AuthorizationServer : Pulumi.CustomResource
    {
        ...
        public AuthorizationServer(string name, AuthorizationServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201preview:AuthorizationServer", name, args ?? new AuthorizationServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201preview:AuthorizationServer", name, null, MakeResourceOptions(options, id))
        {
        }
