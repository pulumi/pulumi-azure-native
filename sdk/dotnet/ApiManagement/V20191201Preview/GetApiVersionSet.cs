...
namespace Pulumi.AzureNative.ApiManagement.V20191201Preview
{
    public static class GetApiVersionSet
    {
        ...
        public static Task<GetApiVersionSetResult> InvokeAsync(GetApiVersionSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiVersionSetResult>("azure-native:apimanagement/v20191201preview:getApiVersionSet", args ?? new GetApiVersionSetArgs(), options.WithDefaults());

        /// <summary>
        /// Api Version Set Contract details.
        /// </summary>
        public static Output<GetApiVersionSetResult> Invoke(GetApiVersionSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiVersionSetResult>("azure-native:apimanagement/v20191201preview:getApiVersionSet", args ?? new GetApiVersionSetInvokeArgs(), options.WithDefaults());
    }
