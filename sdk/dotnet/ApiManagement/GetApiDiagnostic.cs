...
namespace Pulumi.AzureRM.ApiManagement
{
    public static class GetApiDiagnostic
    {
        public static Task<GetApiDiagnosticResult> InvokeAsync(GetApiDiagnosticArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiDiagnosticResult>("azurerm:apimanagement:getApiDiagnostic", args ?? new GetApiDiagnosticArgs(), options.WithVersion());
    }
