...
namespace Pulumi.AzureRM.ApiManagement
{
    ...
    public partial class ServiceGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GroupContractPropertiesResponse> Properties { get; private set; } = null!;
        ...
        public ServiceGroup(string name, ServiceGroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement:ServiceGroup", name, args ?? new ServiceGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceGroup(string name, Input<string> id, ServiceGroupState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement:ServiceGroup", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceGroupState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GroupContractPropertiesResponseGetArgs> Properties { get; set; } = null!;
