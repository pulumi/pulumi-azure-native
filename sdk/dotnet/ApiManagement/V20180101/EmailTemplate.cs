...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var emailTemplate = new AzureRM.ApiManagement.V20180101.EmailTemplate("emailTemplate", new AzureRM.ApiManagement.V20180101.EmailTemplateArgs
    ///         {
    ...
    public partial class EmailTemplate : Pulumi.CustomResource
    {
        ...
        public EmailTemplate(string name, EmailTemplateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:EmailTemplate", name, args ?? new EmailTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:EmailTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
