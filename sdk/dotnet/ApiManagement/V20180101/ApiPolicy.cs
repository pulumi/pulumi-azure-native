...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20180101:ApiPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20180601preview:ApiPolicy to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20180101:ApiPolicy")]
    public partial class ApiPolicy : global::Pulumi.CustomResource
    {
        ...
        public ApiPolicy(string name, ApiPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:ApiPolicy", name, args ?? new ApiPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:ApiPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("contentFormat")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20180101.PolicyContentFormat>? ContentFormat { get; set; }
