...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    public static class GetSubscription
    {
        ...
        public static Task<GetSubscriptionResult> InvokeAsync(GetSubscriptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSubscriptionResult>("azure-native:apimanagement/v20180101:getSubscription", args ?? new GetSubscriptionArgs(), options.WithVersion());

        /// <summary>
        /// Subscription details.
        /// </summary>
        public static Output<GetSubscriptionResult> Invoke(GetSubscriptionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSubscriptionResult>("azure-native:apimanagement/v20180101:getSubscription", args ?? new GetSubscriptionInvokeArgs(), options.WithVersion());
    }
