...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    public static class GetTagByOperation
    {
        ...
        public static Task<GetTagByOperationResult> InvokeAsync(GetTagByOperationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByOperationResult>("azure-native:apimanagement/v20180101:getTagByOperation", args ?? new GetTagByOperationArgs(), options.WithVersion());

        /// <summary>
        /// Tag Contract details.
        /// </summary>
        public static Output<GetTagByOperationResult> Invoke(GetTagByOperationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTagByOperationResult>("azure-native:apimanagement/v20180101:getTagByOperation", args ?? new GetTagByOperationInvokeArgs(), options.WithVersion());
    }
