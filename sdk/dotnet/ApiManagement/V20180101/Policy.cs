...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policy = new AzureRM.ApiManagement.V20180101.Policy("policy", new AzureRM.ApiManagement.V20180101.PolicyArgs
    ///         {
    ///             ContentFormat = "xml",
    ...
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
