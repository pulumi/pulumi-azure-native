...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    public static class GetProduct
    {
        ...
        public static Task<GetProductResult> InvokeAsync(GetProductArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductResult>("azure-native:apimanagement/v20180101:getProduct", args ?? new GetProductArgs(), options.WithDefaults());

        /// <summary>
        /// Product details.
        /// </summary>
        public static Output<GetProductResult> Invoke(GetProductInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProductResult>("azure-native:apimanagement/v20180101:getProduct", args ?? new GetProductInvokeArgs(), options.WithDefaults());
    }
