...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var logger = new AzureRM.ApiManagement.V20180101.Logger("logger", new AzureRM.ApiManagement.V20180101.LoggerArgs
    ///         {
    ///             Credentials = 
    ///             {
    ...
    public partial class Logger : Pulumi.CustomResource
    {
        ...
        public Logger(string name, LoggerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Logger", name, args ?? new LoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Logger", name, null, MakeResourceOptions(options, id))
        {
        }
