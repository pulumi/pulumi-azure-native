...
namespace Pulumi.AzureNextGen.ApiManagement.V20180101
{
    ...
    /// Logger details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20180101:Logger")]
    public partial class Logger : Pulumi.CustomResource
    {
        ...
        public Logger(string name, LoggerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180101:Logger", name, args ?? new LoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Logger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180101:Logger", name, null, MakeResourceOptions(options, id))
        {
        }
