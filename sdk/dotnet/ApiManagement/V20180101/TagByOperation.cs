...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tagByOperation = new AzureRM.ApiManagement.V20180101.TagByOperation("tagByOperation", new AzureRM.ApiManagement.V20180101.TagByOperationArgs
    ///         {
    ...
    public partial class TagByOperation : Pulumi.CustomResource
    {
        ...
        public TagByOperation(string name, TagByOperationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:TagByOperation", name, args ?? new TagByOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:TagByOperation", name, null, MakeResourceOptions(options, id))
        {
        }
