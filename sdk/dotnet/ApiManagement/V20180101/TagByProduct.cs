    ...
    public partial class TagByProduct : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:apimanagement/v20170301:TagByProduct"},
                    new Alias { Type = "azurerm:apimanagement/v20190101:TagByProduct"},
                    new Alias { Type = "azurerm:apimanagement/v20191201:TagByProduct"},
                },
            };
