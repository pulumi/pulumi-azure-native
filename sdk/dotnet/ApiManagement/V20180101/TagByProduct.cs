...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tagByProduct = new AzureRM.ApiManagement.V20180101.TagByProduct("tagByProduct", new AzureRM.ApiManagement.V20180101.TagByProductArgs
    ///         {
    ...
    public partial class TagByProduct : Pulumi.CustomResource
    {
        ...
        public TagByProduct(string name, TagByProductArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:TagByProduct", name, args ?? new TagByProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:TagByProduct", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:apimanagement/latest:TagByProduct"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20170301:TagByProduct"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20180601preview:TagByProduct"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20190101:TagByProduct"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201:TagByProduct"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201preview:TagByProduct"},
                },
            };
