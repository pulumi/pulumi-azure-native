...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20180101:ApiSchema is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20190101:ApiSchema to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20180101:ApiSchema")]
    public partial class ApiSchema : global::Pulumi.CustomResource
    {
        ...
        public ApiSchema(string name, ApiSchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:ApiSchema", name, args ?? new ApiSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:ApiSchema", name, null, MakeResourceOptions(options, id))
        {
        }
