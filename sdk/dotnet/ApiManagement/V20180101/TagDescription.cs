...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20180101:TagDescription")]
    public partial class TagDescription : Pulumi.CustomResource
    {
        ...
        public TagDescription(string name, TagDescriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:TagDescription", name, args ?? new TagDescriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagDescription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:TagDescription", name, null, MakeResourceOptions(options, id))
        {
        }
