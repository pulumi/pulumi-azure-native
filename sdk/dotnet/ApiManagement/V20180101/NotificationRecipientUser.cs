...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    ...
    /// {
    ///     var notificationRecipientUser = new AzureNative.ApiManagement.V20180101.NotificationRecipientUser("notificationRecipientUser", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20180101:NotificationRecipientUser")]
    public partial class NotificationRecipientUser : global::Pulumi.CustomResource
    {
        ...
        public NotificationRecipientUser(string name, NotificationRecipientUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:NotificationRecipientUser", name, args ?? new NotificationRecipientUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationRecipientUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:NotificationRecipientUser", name, null, MakeResourceOptions(options, id))
        {
        }
