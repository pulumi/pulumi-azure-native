...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    public static class GetAuthorizationServer
    {
        public static Task<GetAuthorizationServerResult> InvokeAsync(GetAuthorizationServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationServerResult>("azurerm:apimanagement/v20180101:getAuthorizationServer", args ?? new GetAuthorizationServerArgs(), options.WithVersion());
    }
