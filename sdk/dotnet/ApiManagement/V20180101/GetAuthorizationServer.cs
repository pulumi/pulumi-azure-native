...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    public static class GetAuthorizationServer
    {
        ...
        public static Task<GetAuthorizationServerResult> InvokeAsync(GetAuthorizationServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationServerResult>("azure-native:apimanagement/v20180101:getAuthorizationServer", args ?? new GetAuthorizationServerArgs(), options.WithVersion());
        ...
        public static Output<GetAuthorizationServerResult> Invoke(GetAuthorizationServerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAuthorizationServerResult>("azure-native:apimanagement/v20180101:getAuthorizationServer", args ?? new GetAuthorizationServerInvokeArgs(), options.WithVersion());
    }
