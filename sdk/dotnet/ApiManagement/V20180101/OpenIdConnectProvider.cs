...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var openIdConnectProvider = new AzureRM.ApiManagement.V20180101.OpenIdConnectProvider("openIdConnectProvider", new AzureRM.ApiManagement.V20180101.OpenIdConnectProviderArgs
    ///         {
    ...
    public partial class OpenIdConnectProvider : Pulumi.CustomResource
    {
        ...
        public OpenIdConnectProvider(string name, OpenIdConnectProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:OpenIdConnectProvider", name, args ?? new OpenIdConnectProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenIdConnectProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:OpenIdConnectProvider", name, null, MakeResourceOptions(options, id))
        {
        }
