...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiManagementService = new AzureRM.ApiManagement.V20180101.ApiManagementService("apiManagementService", new AzureRM.ApiManagement.V20180101.ApiManagementServiceArgs
    ///         {
    ///             AdditionalLocations = 
    ///             {
    ///                 new AzureRM.ApiManagement.V20180101.Inputs.AdditionalLocationArgs
    ///                 {
    ///                     Location = "West US",
    ///                     Sku = new AzureRM.ApiManagement.V20180101.Inputs.ApiManagementServiceSkuPropertiesArgs
    ///                     {
    ///                         Capacity = 1,
    ///                         Name = "Premium",
    ///                     },
    ///                     VirtualNetworkConfiguration = new AzureRM.ApiManagement.V20180101.Inputs.VirtualNetworkConfigurationArgs
    ///                     {
    ...
    ///             {
    ///                 new AzureRM.ApiManagement.V20180101.Inputs.HostnameConfigurationArgs
    ///                 {
    ...
    ///         var apiManagementService = new AzureRM.ApiManagement.V20180101.ApiManagementService("apiManagementService", new AzureRM.ApiManagement.V20180101.ApiManagementServiceArgs
    ///         {
    ///             Identity = new AzureRM.ApiManagement.V20180101.Inputs.ApiManagementServiceIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "Japan East",
    ...
    ///             Certificates = 
    ///             {
    ///                 new AzureRM.ApiManagement.V20180101.Inputs.CertificateConfigurationArgs
    ///                 {
    ///                     CertificatePassword = "**************Password of the Certificate************************************************",
    ///                     EncodedCertificate = "************Base 64 Encoded Pfx Certificate************************",
    ...
    public partial class ApiManagementService : Pulumi.CustomResource
    {
        ...
        public ApiManagementService(string name, ApiManagementServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:ApiManagementService", name, args ?? new ApiManagementServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiManagementService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:ApiManagementService", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20160707:ApiManagementService"},
                    ...
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20180601preview:ApiManagementService"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20190101:ApiManagementService"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201:ApiManagementService"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201preview:ApiManagementService"},
                },
            };
