...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    ...
    /// User details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20180101:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:User", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:User" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20211201preview:User" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20220401preview:User" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20220801:User" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20220901preview:User" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230301preview:User" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230501preview:User" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230901preview:User" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240501:User" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240601preview:User" },
                },
            };
    ...
    public sealed class UserArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("confirmation")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20180101.Confirmation>? Confirmation { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20180101.UserState>? State { get; set; }
