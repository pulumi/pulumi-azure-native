...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var user = new AzureRM.ApiManagement.V20180101.User("user", new AzureRM.ApiManagement.V20180101.UserArgs
    ///         {
    ///             Confirmation = "signup",
    ...
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:User", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:apimanagement/latest:User"},
                    ...
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20180601preview:User"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20190101:User"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201:User"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201preview:User"},
                },
            };
