...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var product = new AzureRM.ApiManagement.V20180101.Product("product", new AzureRM.ApiManagement.V20180101.ProductArgs
    ///         {
    ...
    public partial class Product : Pulumi.CustomResource
    {
        ...
        public Product(string name, ProductArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Product", name, args ?? new ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Product", name, null, MakeResourceOptions(options, id))
        {
        }
