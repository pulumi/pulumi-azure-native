...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    ...
    /// Product details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20180101:Product")]
    public partial class Product : global::Pulumi.CustomResource
    {
        ...
        public Product(string name, ProductArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:Product", name, args ?? new ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180101:Product", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProductArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.ApiManagement.V20180101.ProductState>? State { get; set; }
