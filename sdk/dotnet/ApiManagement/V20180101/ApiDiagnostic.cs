...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiDiagnostic = new AzureRM.ApiManagement.V20180101.ApiDiagnostic("apiDiagnostic", new AzureRM.ApiManagement.V20180101.ApiDiagnosticArgs
    ///         {
    ...
    public partial class ApiDiagnostic : Pulumi.CustomResource
    {
        ...
        public ApiDiagnostic(string name, ApiDiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:ApiDiagnostic", name, args ?? new ApiDiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiDiagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:ApiDiagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
