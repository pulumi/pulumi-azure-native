...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var diagnostic = new AzureRM.ApiManagement.V20180101.Diagnostic("diagnostic", new AzureRM.ApiManagement.V20180101.DiagnosticArgs
    ///         {
    ...
    public partial class Diagnostic : Pulumi.CustomResource
    {
        ...
        public Diagnostic(string name, DiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Diagnostic", name, args ?? new DiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Diagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Diagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
