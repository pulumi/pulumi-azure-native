...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var @group = new AzureRM.ApiManagement.V20180101.Group("group", new AzureRM.ApiManagement.V20180101.GroupArgs
    ///         {
    ...
    public partial class Group : Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:Group", name, null, MakeResourceOptions(options, id))
        {
        }
