...
namespace Pulumi.AzureNative.ApiManagement.V20180101
{
    public static class GetProperty
    {
        ...
        public static Task<GetPropertyResult> InvokeAsync(GetPropertyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPropertyResult>("azure-native:apimanagement/v20180101:getProperty", args ?? new GetPropertyArgs(), options.WithDefaults());

        /// <summary>
        /// Property details.
        /// </summary>
        public static Output<GetPropertyResult> Invoke(GetPropertyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPropertyResult>("azure-native:apimanagement/v20180101:getProperty", args ?? new GetPropertyInvokeArgs(), options.WithDefaults());
    }
