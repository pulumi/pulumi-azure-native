...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    public static class GetEmailTemplate
    {
        public static Task<GetEmailTemplateResult> InvokeAsync(GetEmailTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEmailTemplateResult>("azurerm:apimanagement/v20180101:getEmailTemplate", args ?? new GetEmailTemplateArgs(), options.WithVersion());
    }
