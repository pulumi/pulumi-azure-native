...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    public partial class AuthorizationServer : Pulumi.CustomResource
    {
        ...
        public AuthorizationServer(string name, AuthorizationServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:AuthorizationServer", name, args ?? new AuthorizationServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:AuthorizationServer", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:apimanagement/v20160707:AuthorizationServer"},
                    new Alias { Type = "azurerm:apimanagement/v20161010:AuthorizationServer"},
                    new Alias { Type = "azurerm:apimanagement/v20170301:AuthorizationServer"},
                    new Alias { Type = "azurerm:apimanagement/v20190101:AuthorizationServer"},
                    new Alias { Type = "azurerm:apimanagement/v20191201:AuthorizationServer"},
                },
            };
