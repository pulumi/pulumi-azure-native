...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var identityProvider = new AzureRM.ApiManagement.V20180101.IdentityProvider("identityProvider", new AzureRM.ApiManagement.V20180101.IdentityProviderArgs
    ///         {
    ///             ClientId = "facebookid",
    ...
    public partial class IdentityProvider : Pulumi.CustomResource
    {
        ...
        public IdentityProvider(string name, IdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:IdentityProvider", name, args ?? new IdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:IdentityProvider", name, null, MakeResourceOptions(options, id))
        {
        }
