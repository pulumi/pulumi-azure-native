...
namespace Pulumi.AzureRM.ApiManagement.V20180101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiIssueComment = new AzureRM.ApiManagement.V20180101.ApiIssueComment("apiIssueComment", new AzureRM.ApiManagement.V20180101.ApiIssueCommentArgs
    ///         {
    ...
    public partial class ApiIssueComment : Pulumi.CustomResource
    {
        ...
        public ApiIssueComment(string name, ApiIssueCommentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:ApiIssueComment", name, args ?? new ApiIssueCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180101:ApiIssueComment", name, null, MakeResourceOptions(options, id))
        {
        }
