...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20191201:IdentityProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:IdentityProvider to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20191201:IdentityProvider")]
    public partial class IdentityProvider : global::Pulumi.CustomResource
    {
        ...
        public IdentityProvider(string name, IdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:IdentityProvider", name, args ?? new IdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:IdentityProvider", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IdentityProviderArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20191201.IdentityProviderType>? Type { get; set; }
