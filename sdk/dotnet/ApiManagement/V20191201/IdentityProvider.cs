...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    ...
    public partial class IdentityProvider : Pulumi.CustomResource
    {
        ...
        public IdentityProvider(string name, IdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:IdentityProvider", name, args ?? new IdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:IdentityProvider", name, null, MakeResourceOptions(options, id))
        {
        }
