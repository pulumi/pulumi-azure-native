...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    public static class GetApiTagDescription
    {
        ...
        public static Task<GetApiTagDescriptionResult> InvokeAsync(GetApiTagDescriptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiTagDescriptionResult>("azure-native:apimanagement/v20191201:getApiTagDescription", args ?? new GetApiTagDescriptionArgs(), options.WithDefaults());

        /// <summary>
        /// Contract details.
        /// </summary>
        public static Output<GetApiTagDescriptionResult> Invoke(GetApiTagDescriptionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiTagDescriptionResult>("azure-native:apimanagement/v20191201:getApiTagDescription", args ?? new GetApiTagDescriptionInvokeArgs(), options.WithDefaults());
    }
