...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20191201:ApiTagDescription")]
    public partial class ApiTagDescription : Pulumi.CustomResource
    {
        ...
        public ApiTagDescription(string name, ApiTagDescriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:ApiTagDescription", name, args ?? new ApiTagDescriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiTagDescription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:ApiTagDescription", name, null, MakeResourceOptions(options, id))
        {
        }
