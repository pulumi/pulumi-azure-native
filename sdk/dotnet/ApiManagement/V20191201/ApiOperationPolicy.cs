...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiOperationPolicy = new AzureRM.ApiManagement.V20191201.ApiOperationPolicy("apiOperationPolicy", new AzureRM.ApiManagement.V20191201.ApiOperationPolicyArgs
    ///         {
    ...
    public partial class ApiOperationPolicy : Pulumi.CustomResource
    {
        ...
        public ApiOperationPolicy(string name, ApiOperationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiOperationPolicy", name, args ?? new ApiOperationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiOperationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
