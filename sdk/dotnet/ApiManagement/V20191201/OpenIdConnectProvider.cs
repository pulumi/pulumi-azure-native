...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20191201:OpenIdConnectProvider")]
    public partial class OpenIdConnectProvider : Pulumi.CustomResource
    {
        ...
        public OpenIdConnectProvider(string name, OpenIdConnectProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:OpenIdConnectProvider", name, args ?? new OpenIdConnectProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenIdConnectProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:OpenIdConnectProvider", name, null, MakeResourceOptions(options, id))
        {
        }
