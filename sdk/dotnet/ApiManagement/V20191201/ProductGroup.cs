...
namespace Pulumi.AzureNextGen.ApiManagement.V20191201
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20191201:ProductGroup")]
    public partial class ProductGroup : Pulumi.CustomResource
    {
        ...
        public ProductGroup(string name, ProductGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:ProductGroup", name, args ?? new ProductGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:ProductGroup", name, null, MakeResourceOptions(options, id))
        {
        }
