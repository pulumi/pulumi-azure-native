...
namespace Pulumi.AzureNextGen.ApiManagement.V20191201
{
    ...
    /// Backend details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20191201:Backend")]
    public partial class Backend : Pulumi.CustomResource
    {
        ...
        public Backend(string name, BackendArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:Backend", name, args ?? new BackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:Backend", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BackendArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20191201.BackendProtocol> Protocol { get; set; } = null!;
