...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    public static class GetApiVersionSet
    {
        public static Task<GetApiVersionSetResult> InvokeAsync(GetApiVersionSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiVersionSetResult>("azurerm:apimanagement/v20191201:getApiVersionSet", args ?? new GetApiVersionSetArgs(), options.WithVersion());
    }
