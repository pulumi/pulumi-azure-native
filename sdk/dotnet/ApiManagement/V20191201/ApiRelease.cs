...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiRelease = new AzureRM.ApiManagement.V20191201.ApiRelease("apiRelease", new AzureRM.ApiManagement.V20191201.ApiReleaseArgs
    ///         {
    ...
    public partial class ApiRelease : Pulumi.CustomResource
    {
        ...
        public ApiRelease(string name, ApiReleaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiRelease", name, args ?? new ApiReleaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiRelease(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiRelease", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20180601preview:ApiRelease"},
