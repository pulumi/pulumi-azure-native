...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    public static class GetCache
    {
        ...
        public static Task<GetCacheResult> InvokeAsync(GetCacheArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCacheResult>("azure-native:apimanagement/v20191201:getCache", args ?? new GetCacheArgs(), options.WithDefaults());

        /// <summary>
        /// Cache details.
        /// </summary>
        public static Output<GetCacheResult> Invoke(GetCacheInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCacheResult>("azure-native:apimanagement/v20191201:getCache", args ?? new GetCacheInvokeArgs(), options.WithDefaults());
    }
