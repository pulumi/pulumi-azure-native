...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20191201:Subscription")]
    public partial class Subscription : global::Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubscriptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.ApiManagement.V20191201.SubscriptionState>? State { get; set; }
