...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    public static class GetTagByProduct
    {
        ...
        public static Task<GetTagByProductResult> InvokeAsync(GetTagByProductArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByProductResult>("azure-native:apimanagement/v20191201:getTagByProduct", args ?? new GetTagByProductArgs(), options.WithDefaults());

        /// <summary>
        /// Tag Contract details.
        /// </summary>
        public static Output<GetTagByProductResult> Invoke(GetTagByProductInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetTagByProductResult>("azure-native:apimanagement/v20191201:getTagByProduct", args ?? new GetTagByProductInvokeArgs(), options.WithDefaults());
    }
