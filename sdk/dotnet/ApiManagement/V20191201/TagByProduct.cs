...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tagByProduct = new AzureRM.ApiManagement.V20191201.TagByProduct("tagByProduct", new AzureRM.ApiManagement.V20191201.TagByProductArgs
    ///         {
    ...
    public partial class TagByProduct : Pulumi.CustomResource
    {
        ...
        public TagByProduct(string name, TagByProductArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:TagByProduct", name, args ?? new TagByProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:TagByProduct", name, null, MakeResourceOptions(options, id))
        {
        }
