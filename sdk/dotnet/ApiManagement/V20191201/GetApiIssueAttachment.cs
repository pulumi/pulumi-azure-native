...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    public static class GetApiIssueAttachment
    {
        public static Task<GetApiIssueAttachmentResult> InvokeAsync(GetApiIssueAttachmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueAttachmentResult>("azurerm:apimanagement/v20191201:getApiIssueAttachment", args ?? new GetApiIssueAttachmentArgs(), options.WithVersion());
    }
