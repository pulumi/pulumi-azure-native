...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    ...
    public partial class ContentType : Pulumi.CustomResource
    {
        ...
        public ContentType(string name, ContentTypeArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ContentType", name, args ?? new ContentTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContentType(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ContentType", name, null, MakeResourceOptions(options, id))
        {
        }
