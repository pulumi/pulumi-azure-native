...
namespace Pulumi.AzureNextGen.ApiManagement.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20191201:NotificationRecipientUser")]
    public partial class NotificationRecipientUser : Pulumi.CustomResource
    {
        ...
        public NotificationRecipientUser(string name, NotificationRecipientUserArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:NotificationRecipientUser", name, args ?? new NotificationRecipientUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationRecipientUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:NotificationRecipientUser", name, null, MakeResourceOptions(options, id))
        {
        }
