...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    ...
    public partial class ApiIssueAttachment : Pulumi.CustomResource
    {
        ...
        public ApiIssueAttachment(string name, ApiIssueAttachmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiIssueAttachment", name, args ?? new ApiIssueAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiIssueAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
