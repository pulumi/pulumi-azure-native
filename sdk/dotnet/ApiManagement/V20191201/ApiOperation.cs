...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    ...
    public partial class ApiOperation : Pulumi.CustomResource
    {
        ...
        public ApiOperation(string name, ApiOperationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiOperation", name, args ?? new ApiOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiOperation", name, null, MakeResourceOptions(options, id))
        {
        }
