...
namespace Pulumi.AzureNextGen.ApiManagement.V20191201
{
    ...
    /// Product details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20191201:Product")]
    ...
    public sealed class ProductArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNextGen.ApiManagement.V20191201.ProductState>? State { get; set; }
