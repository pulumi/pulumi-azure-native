...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    ...
    /// User details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20191201:User is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:User to guarantee forwards compatibility.")]
    ...
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:User", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("appType")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20191201.AppType>? AppType { get; set; }

        /// <summary>
        /// Determines the type of confirmation e-mail that will be sent to the newly created user.
        /// </summary>
        [Input("confirmation")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20191201.Confirmation>? Confirmation { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20191201.UserState>? State { get; set; }
