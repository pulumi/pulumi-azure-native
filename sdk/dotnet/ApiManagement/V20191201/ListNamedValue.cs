...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    public static class ListNamedValue
    {
        ...
        public static Task<ListNamedValueResult> InvokeAsync(ListNamedValueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamedValueResult>("azure-native:apimanagement/v20191201:listNamedValue", args ?? new ListNamedValueArgs(), options.WithVersion());

        /// <summary>
        /// Client or app secret used in IdentityProviders, Aad, OpenID or OAuth.
        /// </summary>
        public static Output<ListNamedValueResult> Invoke(ListNamedValueInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListNamedValueResult>("azure-native:apimanagement/v20191201:listNamedValue", args ?? new ListNamedValueInvokeArgs(), options.WithVersion());
    }
