...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    public static class GetApiRelease
    {
        ...
        public static Output<GetApiReleaseResult> Invoke(GetApiReleaseInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiReleaseResult>("azure-native:apimanagement/v20191201:getApiRelease", args ?? new GetApiReleaseInvokeArgs(), options.WithVersion());
    }
