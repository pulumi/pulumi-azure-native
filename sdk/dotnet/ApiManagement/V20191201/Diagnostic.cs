...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    ...
    /// Diagnostic details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20191201:Diagnostic is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:Diagnostic to guarantee forwards compatibility.")]
    ...
    public partial class Diagnostic : global::Pulumi.CustomResource
    {
        ...
        public Diagnostic(string name, DiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:Diagnostic", name, args ?? new DiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Diagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:Diagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiagnosticArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("alwaysLog")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20191201.AlwaysLog>? AlwaysLog { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20191201.HttpCorrelationProtocol>? HttpCorrelationProtocol { get; set; }
        ...
        /// </summary>
        [Input("verbosity")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20191201.Verbosity>? Verbosity { get; set; }
