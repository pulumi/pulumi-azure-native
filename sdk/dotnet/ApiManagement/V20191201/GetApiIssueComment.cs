...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    public static class GetApiIssueComment
    {
        ...
        public static Task<GetApiIssueCommentResult> InvokeAsync(GetApiIssueCommentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueCommentResult>("azure-native:apimanagement/v20191201:getApiIssueComment", args ?? new GetApiIssueCommentArgs(), options.WithDefaults());

        /// <summary>
        /// Issue Comment Contract details.
        /// </summary>
        public static Output<GetApiIssueCommentResult> Invoke(GetApiIssueCommentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiIssueCommentResult>("azure-native:apimanagement/v20191201:getApiIssueComment", args ?? new GetApiIssueCommentInvokeArgs(), options.WithDefaults());
    }
