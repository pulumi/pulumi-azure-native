...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    public static class GetEmailTemplate
    {
        ...
        public static Task<GetEmailTemplateResult> InvokeAsync(GetEmailTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEmailTemplateResult>("azure-native:apimanagement/v20191201:getEmailTemplate", args ?? new GetEmailTemplateArgs(), options.WithVersion());

        /// <summary>
        /// Email Template details.
        /// </summary>
        public static Output<GetEmailTemplateResult> Invoke(GetEmailTemplateInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEmailTemplateResult>("azure-native:apimanagement/v20191201:getEmailTemplate", args ?? new GetEmailTemplateInvokeArgs(), options.WithVersion());
    }
