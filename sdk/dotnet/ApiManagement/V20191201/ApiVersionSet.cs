...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    ...
    [AzureNativeResourceType("azure-native:apimanagement/v20191201:ApiVersionSet")]
    public partial class ApiVersionSet : global::Pulumi.CustomResource
    {
        ...
        public ApiVersionSet(string name, ApiVersionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:ApiVersionSet", name, args ?? new ApiVersionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiVersionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20191201:ApiVersionSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiVersionSetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20191201.VersioningScheme> VersioningScheme { get; set; } = null!;
