...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    public static class GetApiPolicy
    {
        ...
        public static Output<GetApiPolicyResult> Invoke(GetApiPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiPolicyResult>("azure-native:apimanagement/v20191201:getApiPolicy", args ?? new GetApiPolicyInvokeArgs(), options.WithVersion());
    }
