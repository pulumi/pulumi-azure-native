...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    public static class GetAuthorizationServer
    {
        public static Task<GetAuthorizationServerResult> InvokeAsync(GetAuthorizationServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationServerResult>("azurerm:apimanagement/v20191201:getAuthorizationServer", args ?? new GetAuthorizationServerArgs(), options.WithVersion());
    }
