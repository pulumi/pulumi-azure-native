    ...
    public partial class ApiPolicy : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:apimanagement/v20170301:ApiPolicy"},
                    new Alias { Type = "azurerm:apimanagement/v20180101:ApiPolicy"},
                    new Alias { Type = "azurerm:apimanagement/v20190101:ApiPolicy"},
                },
            };
