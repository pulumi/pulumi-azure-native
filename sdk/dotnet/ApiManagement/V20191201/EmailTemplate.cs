...
namespace Pulumi.AzureNextGen.ApiManagement.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20191201:EmailTemplate")]
    public partial class EmailTemplate : Pulumi.CustomResource
    {
        ...
        public EmailTemplate(string name, EmailTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:EmailTemplate", name, args ?? new EmailTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:EmailTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
