...
namespace Pulumi.AzureNextGen.ApiManagement.V20191201
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20191201:ApiManagementService")]
    public partial class ApiManagementService : Pulumi.CustomResource
    {
        ...
        public ApiManagementService(string name, ApiManagementServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:ApiManagementService", name, args ?? new ApiManagementServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiManagementService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20191201:ApiManagementService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiManagementServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20191201.VirtualNetworkType>? VirtualNetworkType { get; set; }
