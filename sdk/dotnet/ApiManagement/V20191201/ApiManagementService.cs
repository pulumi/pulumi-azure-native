...
namespace Pulumi.AzureRM.ApiManagement.V20191201
{
    ...
    public partial class ApiManagementService : Pulumi.CustomResource
    {
        ...
        public ApiManagementService(string name, ApiManagementServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiManagementService", name, args ?? new ApiManagementServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiManagementService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20191201:ApiManagementService", name, null, MakeResourceOptions(options, id))
        {
        }
