...
namespace Pulumi.AzureNative.ApiManagement.V20191201
{
    public static class ListTenantAccessGitSecrets
    {
        ...
        public static Task<ListTenantAccessGitSecretsResult> InvokeAsync(ListTenantAccessGitSecretsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTenantAccessGitSecretsResult>("azure-native:apimanagement/v20191201:listTenantAccessGitSecrets", args ?? new ListTenantAccessGitSecretsArgs(), options.WithDefaults());
        ...
        public static Output<ListTenantAccessGitSecretsResult> Invoke(ListTenantAccessGitSecretsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ListTenantAccessGitSecretsResult>("azure-native:apimanagement/v20191201:listTenantAccessGitSecrets", args ?? new ListTenantAccessGitSecretsInvokeArgs(), options.WithDefaults());
    }
