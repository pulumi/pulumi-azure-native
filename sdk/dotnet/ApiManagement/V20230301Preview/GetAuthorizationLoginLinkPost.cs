...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    public static class GetAuthorizationLoginLinkPost
    {
        ...
        public static Task<GetAuthorizationLoginLinkPostResult> InvokeAsync(GetAuthorizationLoginLinkPostArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationLoginLinkPostResult>("azure-native:apimanagement/v20230301preview:getAuthorizationLoginLinkPost", args ?? new GetAuthorizationLoginLinkPostArgs(), options.WithDefaults());
        ...
        public static Output<GetAuthorizationLoginLinkPostResult> Invoke(GetAuthorizationLoginLinkPostInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAuthorizationLoginLinkPostResult>("azure-native:apimanagement/v20230301preview:getAuthorizationLoginLinkPost", args ?? new GetAuthorizationLoginLinkPostInvokeArgs(), options.WithDefaults());
