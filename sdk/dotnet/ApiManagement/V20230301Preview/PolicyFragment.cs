...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230301preview:PolicyFragment")]
    public partial class PolicyFragment : global::Pulumi.CustomResource
    {
        ...
        public PolicyFragment(string name, PolicyFragmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:PolicyFragment", name, args ?? new PolicyFragmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyFragment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:PolicyFragment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PolicyFragmentArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.PolicyFragmentContentFormat>? Format { get; set; }
