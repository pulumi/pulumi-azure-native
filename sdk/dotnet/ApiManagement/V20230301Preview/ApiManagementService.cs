...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230301preview:ApiManagementService")]
    public partial class ApiManagementService : global::Pulumi.CustomResource
    {
        ...
        public ApiManagementService(string name, ApiManagementServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:ApiManagementService", name, args ?? new ApiManagementServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiManagementService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:ApiManagementService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiManagementServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.DeveloperPortalStatus>? DeveloperPortalStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.LegacyPortalStatus>? LegacyPortalStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.NatGatewayState>? NatGatewayState { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.PublicNetworkAccess>? PublicNetworkAccess { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.VirtualNetworkType>? VirtualNetworkType { get; set; }
