...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    public static class GetWorkspaceApiRelease
    {
        ...
        public static Task<GetWorkspaceApiReleaseResult> InvokeAsync(GetWorkspaceApiReleaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiReleaseResult>("azure-native:apimanagement/v20230301preview:getWorkspaceApiRelease", args ?? new GetWorkspaceApiReleaseArgs(), options.WithDefaults());
        ...
        public static Output<GetWorkspaceApiReleaseResult> Invoke(GetWorkspaceApiReleaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWorkspaceApiReleaseResult>("azure-native:apimanagement/v20230301preview:getWorkspaceApiRelease", args ?? new GetWorkspaceApiReleaseInvokeArgs(), options.WithDefaults());
    }
