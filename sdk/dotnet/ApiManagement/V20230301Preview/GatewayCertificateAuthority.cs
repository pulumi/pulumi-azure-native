...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230301preview:GatewayCertificateAuthority")]
    public partial class GatewayCertificateAuthority : global::Pulumi.CustomResource
    {
        ...
        public GatewayCertificateAuthority(string name, GatewayCertificateAuthorityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:GatewayCertificateAuthority", name, args ?? new GatewayCertificateAuthorityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayCertificateAuthority(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:GatewayCertificateAuthority", name, null, MakeResourceOptions(options, id))
        {
        }
