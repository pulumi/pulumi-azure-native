...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230301preview:WorkspaceSubscription")]
    public partial class WorkspaceSubscription : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceSubscription(string name, WorkspaceSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:WorkspaceSubscription", name, args ?? new WorkspaceSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceSubscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:WorkspaceSubscription", name, null, MakeResourceOptions(options, id))
        {
        }
