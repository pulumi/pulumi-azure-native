...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    ...
    /// NamedValue details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230301preview:NamedValue")]
    public partial class NamedValue : global::Pulumi.CustomResource
    {
        ...
        public NamedValue(string name, NamedValueArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:NamedValue", name, args ?? new NamedValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamedValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:NamedValue", name, null, MakeResourceOptions(options, id))
        {
        }
