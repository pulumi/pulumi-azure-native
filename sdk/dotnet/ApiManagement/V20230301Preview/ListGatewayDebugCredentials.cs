...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    public static class ListGatewayDebugCredentials
    {
        ...
        public static Task<ListGatewayDebugCredentialsResult> InvokeAsync(ListGatewayDebugCredentialsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListGatewayDebugCredentialsResult>("azure-native:apimanagement/v20230301preview:listGatewayDebugCredentials", args ?? new ListGatewayDebugCredentialsArgs(), options.WithDefaults());
        ...
        public static Output<ListGatewayDebugCredentialsResult> Invoke(ListGatewayDebugCredentialsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListGatewayDebugCredentialsResult>("azure-native:apimanagement/v20230301preview:listGatewayDebugCredentials", args ?? new ListGatewayDebugCredentialsInvokeArgs(), options.WithDefaults());
    ...
    public sealed class ListGatewayDebugCredentialsArgs : global::Pulumi.InvokeArgs
    {
        ...
        private List<Union<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.GatewayListDebugCredentialsContractPurpose>>? _purposes;

        /// <summary>
        /// Purposes of debug credential.
        /// </summary>
        public List<Union<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.GatewayListDebugCredentialsContractPurpose>> Purposes
        {
            get => _purposes ?? (_purposes = new List<Union<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.GatewayListDebugCredentialsContractPurpose>>());
            set => _purposes = value;
        }
    ...
    public sealed class ListGatewayDebugCredentialsInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("purposes", required: true)]
        private InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.GatewayListDebugCredentialsContractPurpose>>? _purposes;

        /// <summary>
        /// Purposes of debug credential.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.GatewayListDebugCredentialsContractPurpose>> Purposes
        {
            get => _purposes ?? (_purposes = new InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.GatewayListDebugCredentialsContractPurpose>>());
            set => _purposes = value;
        }
