...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    public static class GetAuthorizationAccessPolicy
    {
        ...
        public static Task<GetAuthorizationAccessPolicyResult> InvokeAsync(GetAuthorizationAccessPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationAccessPolicyResult>("azure-native:apimanagement/v20230301preview:getAuthorizationAccessPolicy", args ?? new GetAuthorizationAccessPolicyArgs(), options.WithDefaults());
