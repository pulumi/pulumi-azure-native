...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230301preview:AuthorizationAccessPolicy")]
    public partial class AuthorizationAccessPolicy : global::Pulumi.CustomResource
    {
        ...
        public AuthorizationAccessPolicy(string name, AuthorizationAccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:AuthorizationAccessPolicy", name, args ?? new AuthorizationAccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationAccessPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:AuthorizationAccessPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
