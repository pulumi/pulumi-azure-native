...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    public static class GetWorkspaceApiSchema
    {
        ...
        public static Task<GetWorkspaceApiSchemaResult> InvokeAsync(GetWorkspaceApiSchemaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWorkspaceApiSchemaResult>("azure-native:apimanagement/v20230301preview:getWorkspaceApiSchema", args ?? new GetWorkspaceApiSchemaArgs(), options.WithDefaults());
