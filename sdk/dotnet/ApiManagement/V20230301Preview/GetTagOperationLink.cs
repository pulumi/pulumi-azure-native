...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    public static class GetTagOperationLink
    {
        ...
        public static Task<GetTagOperationLinkResult> InvokeAsync(GetTagOperationLinkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagOperationLinkResult>("azure-native:apimanagement/v20230301preview:getTagOperationLink", args ?? new GetTagOperationLinkArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the operation link for the tag.
        /// </summary>
        public static Output<GetTagOperationLinkResult> Invoke(GetTagOperationLinkInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTagOperationLinkResult>("azure-native:apimanagement/v20230301preview:getTagOperationLink", args ?? new GetTagOperationLinkInvokeArgs(), options.WithDefaults());
