...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    ...
    /// API details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230301preview:ProductApi")]
    public partial class ProductApi : global::Pulumi.CustomResource
    {
        ...
        public ProductApi(string name, ProductApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:ProductApi", name, args ?? new ProductApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:ProductApi", name, null, MakeResourceOptions(options, id))
        {
        }
