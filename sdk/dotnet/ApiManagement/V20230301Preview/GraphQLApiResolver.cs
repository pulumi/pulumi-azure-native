...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230301preview:GraphQLApiResolver")]
    public partial class GraphQLApiResolver : global::Pulumi.CustomResource
    {
        ...
        public GraphQLApiResolver(string name, GraphQLApiResolverArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:GraphQLApiResolver", name, args ?? new GraphQLApiResolverArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GraphQLApiResolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:GraphQLApiResolver", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240501:GraphQLApiResolver" },
                },
            };
