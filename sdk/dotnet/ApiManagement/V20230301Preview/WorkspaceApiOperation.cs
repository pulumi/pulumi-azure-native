...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20230301preview:WorkspaceApiOperation")]
    public partial class WorkspaceApiOperation : global::Pulumi.CustomResource
    {
        ...
        public WorkspaceApiOperation(string name, WorkspaceApiOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:WorkspaceApiOperation", name, args ?? new WorkspaceApiOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkspaceApiOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20230301preview:WorkspaceApiOperation", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement:WorkspaceApiOperation" },
