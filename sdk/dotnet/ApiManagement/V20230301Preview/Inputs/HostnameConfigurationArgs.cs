...
namespace Pulumi.AzureNative.ApiManagement.V20230301Preview.Inputs
{
    ...
    public sealed class HostnameConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.CertificateSource>? CertificateSource { get; set; }

        /// <summary>
        /// Certificate Status.
        /// </summary>
        [Input("certificateStatus")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.CertificateStatus>? CertificateStatus { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20230301Preview.HostnameType> Type { get; set; } = null!;
