...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var openIdConnectProvider = new AzureRM.ApiManagement.V20170301.OpenIdConnectProvider("openIdConnectProvider", new AzureRM.ApiManagement.V20170301.OpenIdConnectProviderArgs
    ///         {
    ...
    public partial class OpenIdConnectProvider : Pulumi.CustomResource
    {
        ...
        public OpenIdConnectProvider(string name, OpenIdConnectProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:OpenIdConnectProvider", name, args ?? new OpenIdConnectProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenIdConnectProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:OpenIdConnectProvider", name, null, MakeResourceOptions(options, id))
        {
        }
