...
namespace Pulumi.AzureNative.ApiManagement.V20170301
{
    ...
    [AzureNativeResourceType("azure-native:apimanagement/v20170301:OpenIdConnectProvider")]
    public partial class OpenIdConnectProvider : global::Pulumi.CustomResource
    {
        ...
        public OpenIdConnectProvider(string name, OpenIdConnectProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:OpenIdConnectProvider", name, args ?? new OpenIdConnectProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenIdConnectProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:OpenIdConnectProvider", name, null, MakeResourceOptions(options, id))
        {
        }
