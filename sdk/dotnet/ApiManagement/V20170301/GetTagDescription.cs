...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    public static class GetTagDescription
    {
        public static Task<GetTagDescriptionResult> InvokeAsync(GetTagDescriptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagDescriptionResult>("azurerm:apimanagement/v20170301:getTagDescription", args ?? new GetTagDescriptionArgs(), options.WithVersion());
    }
