...
namespace Pulumi.AzureNative.ApiManagement.V20170301
{
    ...
    [AzureNativeResourceType("azure-native:apimanagement/v20170301:ApiIssueComment")]
    public partial class ApiIssueComment : global::Pulumi.CustomResource
    {
        ...
        public ApiIssueComment(string name, ApiIssueCommentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:ApiIssueComment", name, args ?? new ApiIssueCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:ApiIssueComment", name, null, MakeResourceOptions(options, id))
        {
        }
