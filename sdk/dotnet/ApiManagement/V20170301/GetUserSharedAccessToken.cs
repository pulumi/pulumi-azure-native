...
namespace Pulumi.AzureNative.ApiManagement.V20170301
{
    public static class GetUserSharedAccessToken
    {
        ...
        public static Task<GetUserSharedAccessTokenResult> InvokeAsync(GetUserSharedAccessTokenArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetUserSharedAccessTokenResult>("azure-native:apimanagement/v20170301:getUserSharedAccessToken", args ?? new GetUserSharedAccessTokenArgs(), options.WithVersion());
        ...
        public static Output<GetUserSharedAccessTokenResult> Invoke(GetUserSharedAccessTokenInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetUserSharedAccessTokenResult>("azure-native:apimanagement/v20170301:getUserSharedAccessToken", args ?? new GetUserSharedAccessTokenInvokeArgs(), options.WithVersion());
    }
