...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    ...
    public partial class Subscription : Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:apimanagement/v20160707:Subscription"},
                    new Alias { Type = "azurerm:apimanagement/v20161010:Subscription"},
                    new Alias { Type = "azurerm:apimanagement/v20180101:Subscription"},
                    new Alias { Type = "azurerm:apimanagement/v20190101:Subscription"},
                    new Alias { Type = "azurerm:apimanagement/v20191201:Subscription"},
                },
            };
