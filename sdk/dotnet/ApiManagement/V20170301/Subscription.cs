...
namespace Pulumi.AzureNative.ApiManagement.V20170301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20170301:Subscription")]
    public partial class Subscription : Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:Subscription"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210401preview:Subscription"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:Subscription"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:Subscription"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:Subscription"},
                },
            };
    ...
    public sealed class SubscriptionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.ApiManagement.V20170301.SubscriptionState>? State { get; set; }
