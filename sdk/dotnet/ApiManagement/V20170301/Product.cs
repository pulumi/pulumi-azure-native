...
namespace Pulumi.AzureNextGen.ApiManagement.V20170301
{
    ...
    /// Product details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20170301:Product")]
    ...
    public sealed class ProductArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNextGen.ApiManagement.V20170301.ProductState>? State { get; set; }
