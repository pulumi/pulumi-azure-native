...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    public static class GetDiagnostic
    {
        public static Task<GetDiagnosticResult> InvokeAsync(GetDiagnosticArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDiagnosticResult>("azurerm:apimanagement/v20170301:getDiagnostic", args ?? new GetDiagnosticArgs(), options.WithVersion());
    }
