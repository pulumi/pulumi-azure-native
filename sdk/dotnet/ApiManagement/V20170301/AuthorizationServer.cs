...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var authorizationServer = new AzureRM.ApiManagement.V20170301.AuthorizationServer("authorizationServer", new AzureRM.ApiManagement.V20170301.AuthorizationServerArgs
    ///         {
    ...
    public partial class AuthorizationServer : Pulumi.CustomResource
    {
        ...
        public AuthorizationServer(string name, AuthorizationServerArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:AuthorizationServer", name, args ?? new AuthorizationServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthorizationServer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:AuthorizationServer", name, null, MakeResourceOptions(options, id))
        {
        }
