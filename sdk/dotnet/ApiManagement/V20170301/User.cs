...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    ...
    public partial class User : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("groups")]
        public Output<ImmutableArray<Outputs.GroupContractResponseResult>> Groups { get; private set; } = null!;
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:User", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20180101:User"},
