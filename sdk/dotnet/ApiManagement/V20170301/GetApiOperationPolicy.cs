...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    public static class GetApiOperationPolicy
    {
        public static Task<GetApiOperationPolicyResult> InvokeAsync(GetApiOperationPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiOperationPolicyResult>("azurerm:apimanagement/v20170301:getApiOperationPolicy", args ?? new GetApiOperationPolicyArgs(), options.WithVersion());
    }
