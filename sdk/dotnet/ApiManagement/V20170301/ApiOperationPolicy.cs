...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiOperationPolicy = new AzureRM.ApiManagement.V20170301.ApiOperationPolicy("apiOperationPolicy", new AzureRM.ApiManagement.V20170301.ApiOperationPolicyArgs
    ///         {
    ...
    public partial class ApiOperationPolicy : Pulumi.CustomResource
    {
        ...
        public ApiOperationPolicy(string name, ApiOperationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:ApiOperationPolicy", name, args ?? new ApiOperationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:ApiOperationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
