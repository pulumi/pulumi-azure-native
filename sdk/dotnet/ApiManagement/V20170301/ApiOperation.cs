...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiOperation = new AzureRM.ApiManagement.V20170301.ApiOperation("apiOperation", new AzureRM.ApiManagement.V20170301.ApiOperationArgs
    ///         {
    ...
    ///             Request = new AzureRM.ApiManagement.V20170301.Inputs.RequestContractArgs
    ///             {
    ...
    ///                 Representations = 
    ///                 {
    ///                     new AzureRM.ApiManagement.V20170301.Inputs.RepresentationContractArgs
    ///                     {
    ...
    ///             Responses = 
    ///             {
    ///                 new AzureRM.ApiManagement.V20170301.Inputs.ResponseContractArgs
    ///                 {
    ...
    public partial class ApiOperation : Pulumi.CustomResource
    {
        ...
        public ApiOperation(string name, ApiOperationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:ApiOperation", name, args ?? new ApiOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:ApiOperation", name, null, MakeResourceOptions(options, id))
        {
        }
