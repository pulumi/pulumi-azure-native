...
namespace Pulumi.AzureNative.ApiManagement.V20170301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20170301:ApiIssueAttachment")]
    public partial class ApiIssueAttachment : Pulumi.CustomResource
    {
        ...
        public ApiIssueAttachment(string name, ApiIssueAttachmentArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:ApiIssueAttachment", name, args ?? new ApiIssueAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:ApiIssueAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
