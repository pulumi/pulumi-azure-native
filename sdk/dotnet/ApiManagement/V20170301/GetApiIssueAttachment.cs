...
namespace Pulumi.AzureNative.ApiManagement.V20170301
{
    public static class GetApiIssueAttachment
    {
        ...
        public static Task<GetApiIssueAttachmentResult> InvokeAsync(GetApiIssueAttachmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueAttachmentResult>("azure-native:apimanagement/v20170301:getApiIssueAttachment", args ?? new GetApiIssueAttachmentArgs(), options.WithVersion());

        /// <summary>
        /// Issue Attachment Contract details.
        /// </summary>
        public static Output<GetApiIssueAttachmentResult> Invoke(GetApiIssueAttachmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiIssueAttachmentResult>("azure-native:apimanagement/v20170301:getApiIssueAttachment", args ?? new GetApiIssueAttachmentInvokeArgs(), options.WithVersion());
    }
