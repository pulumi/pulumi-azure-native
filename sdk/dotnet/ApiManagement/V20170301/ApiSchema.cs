...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiSchema = new AzureRM.ApiManagement.V20170301.ApiSchema("apiSchema", new AzureRM.ApiManagement.V20170301.ApiSchemaArgs
    ///         {
    ...
    public partial class ApiSchema : Pulumi.CustomResource
    {
        ...
        public ApiSchema(string name, ApiSchemaArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:ApiSchema", name, args ?? new ApiSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:ApiSchema", name, null, MakeResourceOptions(options, id))
        {
        }
