...
namespace Pulumi.AzureNative.ApiManagement.V20170301
{
    ...
    [AzureNativeResourceType("azure-native:apimanagement/v20170301:ApiSchema")]
    public partial class ApiSchema : global::Pulumi.CustomResource
    {
        ...
        public ApiSchema(string name, ApiSchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:ApiSchema", name, args ?? new ApiSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20170301:ApiSchema", name, null, MakeResourceOptions(options, id))
        {
        }
