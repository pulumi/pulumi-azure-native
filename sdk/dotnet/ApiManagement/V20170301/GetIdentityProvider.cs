...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    public static class GetIdentityProvider
    {
        public static Task<GetIdentityProviderResult> InvokeAsync(GetIdentityProviderArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIdentityProviderResult>("azurerm:apimanagement/v20170301:getIdentityProvider", args ?? new GetIdentityProviderArgs(), options.WithVersion());
    }
