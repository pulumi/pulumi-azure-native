...
namespace Pulumi.AzureNextGen.ApiManagement.V20170301
{
    ...
    /// Logger details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20170301:ApiDiagnosticLogger")]
    public partial class ApiDiagnosticLogger : Pulumi.CustomResource
    {
        ...
        public ApiDiagnosticLogger(string name, ApiDiagnosticLoggerArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20170301:ApiDiagnosticLogger", name, args ?? new ApiDiagnosticLoggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiDiagnosticLogger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20170301:ApiDiagnosticLogger", name, null, MakeResourceOptions(options, id))
        {
        }
