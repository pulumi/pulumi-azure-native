...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    public static class GetProductPolicy
    {
        public static Task<GetProductPolicyResult> InvokeAsync(GetProductPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductPolicyResult>("azurerm:apimanagement/v20170301:getProductPolicy", args ?? new GetProductPolicyArgs(), options.WithVersion());
    }
