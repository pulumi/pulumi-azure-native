...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var backend = new AzureRM.ApiManagement.V20170301.Backend("backend", new AzureRM.ApiManagement.V20170301.BackendArgs
    ///         {
    ///             Backendid = "proxybackend",
    ///             Credentials = new AzureRM.ApiManagement.V20170301.Inputs.BackendCredentialsContractArgs
    ///             {
    ///                 Authorization = new AzureRM.ApiManagement.V20170301.Inputs.BackendAuthorizationHeaderCredentialsArgs
    ///                 {
    ///                     Parameter = "opensesma",
    ///                     Scheme = "Basic",
    ///                 },
    ...
    ///             Protocol = "http",
    ///             Proxy = new AzureRM.ApiManagement.V20170301.Inputs.BackendProxyContractArgs
    ///             {
    ///                 Password = "opensesame",
    ...
    ///             Tls = new AzureRM.ApiManagement.V20170301.Inputs.BackendTlsPropertiesArgs
    ///             {
    ...
    ///             Properties = new AzureRM.ApiManagement.V20170301.Inputs.BackendPropertiesArgs
    ///             {
    ///                 ServiceFabricCluster = new AzureRM.ApiManagement.V20170301.Inputs.BackendServiceFabricClusterPropertiesArgs
    ///                 {
    ...
    ///                     ServerX509Names = 
    ///                     {
    ///                         new AzureRM.ApiManagement.V20170301.Inputs.X509CertificateNameArgs
    ///                         {
    ...
    public partial class Backend : Pulumi.CustomResource
    {
        ...
        public Backend(string name, BackendArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:Backend", name, args ?? new BackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:Backend", name, null, MakeResourceOptions(options, id))
        {
        }
