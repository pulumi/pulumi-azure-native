...
namespace Pulumi.AzureNextGen.ApiManagement.V20170301
{
    ...
    /// User details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20170301:GroupUser")]
    public partial class GroupUser : Pulumi.CustomResource
    {
        ...
        public GroupUser(string name, GroupUserArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20170301:GroupUser", name, args ?? new GroupUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20170301:GroupUser", name, null, MakeResourceOptions(options, id))
        {
        }
