...
namespace Pulumi.AzureRM.ApiManagement.V20170301
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tagByProduct = new AzureRM.ApiManagement.V20170301.TagByProduct("tagByProduct", new AzureRM.ApiManagement.V20170301.TagByProductArgs
    ///         {
    ...
    public partial class TagByProduct : Pulumi.CustomResource
    {
        ...
        public TagByProduct(string name, TagByProductArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:TagByProduct", name, args ?? new TagByProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20170301:TagByProduct", name, null, MakeResourceOptions(options, id))
        {
        }
