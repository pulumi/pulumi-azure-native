...
namespace Pulumi.AzureNextGen.ApiManagement.V20170301
{
    ...
    /// API details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20170301:Api")]
    public partial class Api : Pulumi.CustomResource
    {
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20170301:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20170301:Api", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("apiType")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20170301.ApiType>? ApiType { get; set; }
        ...
        /// </summary>
        [Input("contentFormat")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20170301.ContentFormat>? ContentFormat { get; set; }
        ...
        [Input("protocols")]
        private InputList<Pulumi.AzureNextGen.ApiManagement.V20170301.Protocol>? _protocols;

        /// <summary>
        /// Describes on which protocols the operations in this API can be invoked.
        /// </summary>
        public InputList<Pulumi.AzureNextGen.ApiManagement.V20170301.Protocol> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Pulumi.AzureNextGen.ApiManagement.V20170301.Protocol>());
