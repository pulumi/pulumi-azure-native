...
namespace Pulumi.AzureRM.ApiManagement
{
    ...
    /// </summary>
    public partial class ServicePolicy : Pulumi.CustomResource
    {
        /// <summary>
        /// Resource name.
        /// </summary>
        ...
        public ServicePolicy(string name, ServicePolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement:ServicePolicy", name, args ?? new ServicePolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServicePolicy(string name, Input<string> id, ServicePolicyState? state = null, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement:ServicePolicy", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServicePolicyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Resource name.
        /// </summary>
