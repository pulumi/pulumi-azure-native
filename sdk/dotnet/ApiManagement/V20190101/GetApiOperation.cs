...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    public static class GetApiOperation
    {
        ...
        public static Task<GetApiOperationResult> InvokeAsync(GetApiOperationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiOperationResult>("azure-native:apimanagement/v20190101:getApiOperation", args ?? new GetApiOperationArgs(), options.WithDefaults());

        /// <summary>
        /// Api Operation details.
        /// </summary>
        public static Output<GetApiOperationResult> Invoke(GetApiOperationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiOperationResult>("azure-native:apimanagement/v20190101:getApiOperation", args ?? new GetApiOperationInvokeArgs(), options.WithDefaults());
    }
