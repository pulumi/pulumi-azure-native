...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    public partial class Product : Pulumi.CustomResource
    {
        ...
        public Product(string name, ProductArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Product", name, args ?? new ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Product", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:apimanagement/v20160707:Product"},
                    new Alias { Type = "azurerm:apimanagement/v20161010:Product"},
                    new Alias { Type = "azurerm:apimanagement/v20170301:Product"},
                    new Alias { Type = "azurerm:apimanagement/v20180101:Product"},
                    new Alias { Type = "azurerm:apimanagement/v20191201:Product"},
                },
            };
