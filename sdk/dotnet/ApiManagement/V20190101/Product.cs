...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    ...
    /// Product details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20190101:Product")]
    public partial class Product : Pulumi.CustomResource
    {
        ...
        public Product(string name, ProductArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:Product", name, args ?? new ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:Product", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20201201:Product"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20201201:Product"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:Product"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:Product"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:Product"},
                },
            };
    ...
    public sealed class ProductArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.ApiManagement.V20190101.ProductState>? State { get; set; }
