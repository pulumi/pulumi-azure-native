...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var property = new AzureRM.ApiManagement.V20190101.Property("property", new AzureRM.ApiManagement.V20190101.PropertyArgs
    ///         {
    ...
    public partial class Property : Pulumi.CustomResource
    {
        ...
        public Property(string name, PropertyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Property", name, args ?? new PropertyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Property(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Property", name, null, MakeResourceOptions(options, id))
        {
        }
