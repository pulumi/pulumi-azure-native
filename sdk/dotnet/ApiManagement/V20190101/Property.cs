...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    ...
    public partial class Property : global::Pulumi.CustomResource
    {
        ...
        public Property(string name, PropertyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:Property", name, args ?? new PropertyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Property(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:Property", name, null, MakeResourceOptions(options, id))
        {
        }
