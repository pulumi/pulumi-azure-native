...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var cache = new AzureRM.ApiManagement.V20190101.Cache("cache", new AzureRM.ApiManagement.V20190101.CacheArgs
    ///         {
    ///             CacheId = "westindia",
    ...
    public partial class Cache : Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
