...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    public static class GetApi
    {
        ...
        public static Task<GetApiResult> InvokeAsync(GetApiArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiResult>("azure-native:apimanagement/v20190101:getApi", args ?? new GetApiArgs(), options.WithVersion());

        /// <summary>
        /// Api details.
        /// </summary>
        public static Output<GetApiResult> Invoke(GetApiInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiResult>("azure-native:apimanagement/v20190101:getApi", args ?? new GetApiInvokeArgs(), options.WithVersion());
    }
