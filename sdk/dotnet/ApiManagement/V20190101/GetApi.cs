...
{
    [Obsolete(@"azure-native:apimanagement/v20190101:Api is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20201201:Api to guarantee forwards compatibility.")]
    public static class GetApi
    {
        ...
        public static Task<GetApiResult> InvokeAsync(GetApiArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiResult>("azure-native:apimanagement/v20190101:getApi", args ?? new GetApiArgs(), options.WithDefaults());

        /// <summary>
        /// Gets the details of the API specified by its identifier.
        /// </summary>
        public static Output<GetApiResult> Invoke(GetApiInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiResult>("azure-native:apimanagement/v20190101:getApi", args ?? new GetApiInvokeArgs(), options.WithDefaults());
    }
