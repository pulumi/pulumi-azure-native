...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var api = new AzureRM.ApiManagement.V20190101.Api("api", new AzureRM.ApiManagement.V20190101.ApiArgs
    ///         {
    ///             ApiId = "tempgroup",
    ///             AuthenticationSettings = new AzureRM.ApiManagement.V20190101.Inputs.AuthenticationSettingsContractArgs
    ///             {
    ///                 OAuth2 = new AzureRM.ApiManagement.V20190101.Inputs.OAuth2AuthenticationSettingsContractArgs
    ///                 {
    ...
    ///             SubscriptionKeyParameterNames = new AzureRM.ApiManagement.V20190101.Inputs.SubscriptionKeyParameterNamesContractArgs
    ///             {
    ///                 Header = "header4520",
    ///                 Query = "query3037",
    ///             },
    ...
    ///             AuthenticationSettings = new AzureRM.ApiManagement.V20190101.Inputs.AuthenticationSettingsContractArgs
    ///             {
    ///                 Openid = new AzureRM.ApiManagement.V20190101.Inputs.OpenIdAuthenticationSettingsContractArgs
    ///                 {
    ...
    ///             WsdlSelector = new AzureRM.ApiManagement.V20190101.Inputs.ApiCreateOrUpdatePropertiesWsdlSelectorArgs
    ///             {
    ...
    public partial class Api : Pulumi.CustomResource
    {
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Api", name, null, MakeResourceOptions(options, id))
        {
        }
