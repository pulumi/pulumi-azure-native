...
namespace Pulumi.AzureNative.ApiManagement.V20190101.Inputs
{
    ...
    public sealed class OpenIdAuthenticationSettingsContractArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20190101.BearerTokenSendingMethods>>? _bearerTokenSendingMethods;

        /// <summary>
        /// How to send token to the server.
        /// </summary>
        public InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20190101.BearerTokenSendingMethods>> BearerTokenSendingMethods
        {
            get => _bearerTokenSendingMethods ?? (_bearerTokenSendingMethods = new InputList<Union<string, Pulumi.AzureNative.ApiManagement.V20190101.BearerTokenSendingMethods>>());
