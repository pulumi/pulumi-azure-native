...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20190101:ProductGroup")]
    public partial class ProductGroup : Pulumi.CustomResource
    {
        ...
        public ProductGroup(string name, ProductGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:ProductGroup", name, args ?? new ProductGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:ProductGroup", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20201201:ProductGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20201201:ProductGroup"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210101preview:ProductGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:ProductGroup"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210401preview:ProductGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:ProductGroup"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:ProductGroup"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:ProductGroup"},
                },
            };
