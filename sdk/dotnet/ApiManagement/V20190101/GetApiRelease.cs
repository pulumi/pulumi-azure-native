...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    public static class GetApiRelease
    {
        public static Task<GetApiReleaseResult> InvokeAsync(GetApiReleaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiReleaseResult>("azurerm:apimanagement/v20190101:getApiRelease", args ?? new GetApiReleaseArgs(), options.WithVersion());
    }
