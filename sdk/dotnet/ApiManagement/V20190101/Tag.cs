...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tag = new AzureRM.ApiManagement.V20190101.Tag("tag", new AzureRM.ApiManagement.V20190101.TagArgs
    ///         {
    ///             DisplayName = "tag1",
    ...
    public partial class Tag : Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
