...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20190101:Tag")]
    public partial class Tag : global::Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
