...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20190101:NotificationRecipientUser is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:NotificationRecipientUser to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20190101:NotificationRecipientUser")]
    public partial class NotificationRecipientUser : global::Pulumi.CustomResource
    {
        ...
        public NotificationRecipientUser(string name, NotificationRecipientUserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:NotificationRecipientUser", name, args ?? new NotificationRecipientUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationRecipientUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:NotificationRecipientUser", name, null, MakeResourceOptions(options, id))
        {
        }
