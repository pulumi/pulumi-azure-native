...
namespace Pulumi.AzureNextGen.ApiManagement.V20190101
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20190101:Group")]
    public partial class Group : Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20190101:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20190101:Group", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GroupArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNextGen.ApiManagement.V20190101.GroupType>? Type { get; set; }
