...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20190101:ApiOperationPolicy")]
    public partial class ApiOperationPolicy : global::Pulumi.CustomResource
    {
        ...
        public ApiOperationPolicy(string name, ApiOperationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:ApiOperationPolicy", name, args ?? new ApiOperationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:ApiOperationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20220401preview:ApiOperationPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20220801:ApiOperationPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20220901preview:ApiOperationPolicy" },
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20230301preview:ApiOperationPolicy" },
                    ...
                    new global::Pulumi.Alias { Type = "azure-native:apimanagement/v20240601preview:ApiOperationPolicy" },
                },
            };
    ...
    public sealed class ApiOperationPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20190101.PolicyContentFormat>? Format { get; set; }
