    ...
    public partial class ApiOperationPolicy : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:apimanagement/v20170301:ApiOperationPolicy"},
                    new Alias { Type = "azurerm:apimanagement/v20180101:ApiOperationPolicy"},
                    new Alias { Type = "azurerm:apimanagement/v20191201:ApiOperationPolicy"},
                },
            };
