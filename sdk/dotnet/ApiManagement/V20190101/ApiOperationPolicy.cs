...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiOperationPolicy = new AzureRM.ApiManagement.V20190101.ApiOperationPolicy("apiOperationPolicy", new AzureRM.ApiManagement.V20190101.ApiOperationPolicyArgs
    ///         {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201:ApiOperationPolicy"},
                },
            };
