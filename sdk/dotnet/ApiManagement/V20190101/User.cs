...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var user = new AzureRM.ApiManagement.V20190101.User("user", new AzureRM.ApiManagement.V20190101.UserArgs
    ///         {
    ///             Confirmation = "signup",
    ...
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:User", name, null, MakeResourceOptions(options, id))
        {
        }
