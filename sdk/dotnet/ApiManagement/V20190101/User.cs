...
namespace Pulumi.AzureNextGen.ApiManagement.V20190101
{
    ...
    /// User details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20190101:User")]
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20190101:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20190101:User", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("appType")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20190101.AppType>? AppType { get; set; }

        /// <summary>
        /// Determines the type of confirmation e-mail that will be sent to the newly created user.
        /// </summary>
        [Input("confirmation")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20190101.Confirmation>? Confirmation { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20190101.UserState>? State { get; set; }
