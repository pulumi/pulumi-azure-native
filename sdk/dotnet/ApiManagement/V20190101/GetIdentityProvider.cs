...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    public static class GetIdentityProvider
    {
        ...
        public static Output<GetIdentityProviderResult> Invoke(GetIdentityProviderInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIdentityProviderResult>("azure-native:apimanagement/v20190101:getIdentityProvider", args ?? new GetIdentityProviderInvokeArgs(), options.WithVersion());
    }
