...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiSchema = new AzureRM.ApiManagement.V20190101.ApiSchema("apiSchema", new AzureRM.ApiManagement.V20190101.ApiSchemaArgs
    ///         {
    ...
    public partial class ApiSchema : Pulumi.CustomResource
    {
        ...
        public ApiSchema(string name, ApiSchemaArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:ApiSchema", name, args ?? new ApiSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:ApiSchema", name, null, MakeResourceOptions(options, id))
        {
        }
