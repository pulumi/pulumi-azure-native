...
namespace Pulumi.AzureNextGen.ApiManagement.V20190101
{
    public static class GetApiIssue
    {
        public static Task<GetApiIssueResult> InvokeAsync(GetApiIssueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueResult>("azure-nextgen:apimanagement/v20190101:getApiIssue", args ?? new GetApiIssueArgs(), options.WithVersion());
    }
