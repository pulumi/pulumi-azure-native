...
namespace Pulumi.AzureNextGen.ApiManagement.V20190101
{
    ...
    /// Api details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20190101:ProductApi")]
    public partial class ProductApi : Pulumi.CustomResource
    {
        ...
        public ProductApi(string name, ProductApiArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20190101:ProductApi", name, args ?? new ProductApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20190101:ProductApi", name, null, MakeResourceOptions(options, id))
        {
        }
