    ...
    public partial class ApiIssueAttachment : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azurerm:apimanagement/v20170301:ApiIssueAttachment"},
                    new Alias { Type = "azurerm:apimanagement/v20180101:ApiIssueAttachment"},
                    new Alias { Type = "azurerm:apimanagement/v20191201:ApiIssueAttachment"},
                },
            };
