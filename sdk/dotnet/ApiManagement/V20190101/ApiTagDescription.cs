...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiTagDescription = new AzureRM.ApiManagement.V20190101.ApiTagDescription("apiTagDescription", new AzureRM.ApiManagement.V20190101.ApiTagDescriptionArgs
    ///         {
    ...
    public partial class ApiTagDescription : Pulumi.CustomResource
    {
        ...
        public ApiTagDescription(string name, ApiTagDescriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:ApiTagDescription", name, args ?? new ApiTagDescriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiTagDescription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:ApiTagDescription", name, null, MakeResourceOptions(options, id))
        {
        }
