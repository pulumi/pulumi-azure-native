...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    ...
    /// {
    ///     var identityProvider = new AzureNative.ApiManagement.V20190101.IdentityProvider("identityProvider", new()
    ///     {
    ///         ClientId = "facebookid",
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20190101:IdentityProvider")]
    public partial class IdentityProvider : global::Pulumi.CustomResource
    {
        ...
        public IdentityProvider(string name, IdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:IdentityProvider", name, args ?? new IdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20190101:IdentityProvider", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IdentityProviderArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20190101.IdentityProviderType>? Type { get; set; }
