...
namespace Pulumi.AzureRM.ApiManagement.V20190101
{
    ...
    ///     public MyStack()
    ///     {
    ///         var backend = new AzureRM.ApiManagement.V20190101.Backend("backend", new AzureRM.ApiManagement.V20190101.BackendArgs
    ///         {
    ///             BackendId = "proxybackend",
    ///             Credentials = new AzureRM.ApiManagement.V20190101.Inputs.BackendCredentialsContractArgs
    ///             {
    ///                 Authorization = new AzureRM.ApiManagement.V20190101.Inputs.BackendAuthorizationHeaderCredentialsArgs
    ///                 {
    ///                     Parameter = "opensesma",
    ///                     Scheme = "Basic",
    ///                 },
    ...
    ///             Protocol = "http",
    ///             Proxy = new AzureRM.ApiManagement.V20190101.Inputs.BackendProxyContractArgs
    ///             {
    ///                 Password = "opensesame",
    ...
    ///             Tls = new AzureRM.ApiManagement.V20190101.Inputs.BackendTlsPropertiesArgs
    ///             {
    ...
    ///             Properties = new AzureRM.ApiManagement.V20190101.Inputs.BackendPropertiesArgs
    ///             {
    ///                 ServiceFabricCluster = new AzureRM.ApiManagement.V20190101.Inputs.BackendServiceFabricClusterPropertiesArgs
    ///                 {
    ...
    ///                     ServerX509Names = 
    ///                     {
    ///                         new AzureRM.ApiManagement.V20190101.Inputs.X509CertificateNameArgs
    ///                         {
    ...
    public partial class Backend : Pulumi.CustomResource
    {
        ...
        public Backend(string name, BackendArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Backend", name, args ?? new BackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20190101:Backend", name, null, MakeResourceOptions(options, id))
        {
        }
