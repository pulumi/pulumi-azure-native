...
namespace Pulumi.AzureNextGen.ApiManagement.V20190101
{
    public static class GetApiPolicy
    {
        public static Task<GetApiPolicyResult> InvokeAsync(GetApiPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiPolicyResult>("azure-nextgen:apimanagement/v20190101:getApiPolicy", args ?? new GetApiPolicyArgs(), options.WithVersion());
    }
