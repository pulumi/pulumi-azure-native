...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    public static class GetApiPolicy
    {
        ...
        public static Task<GetApiPolicyResult> InvokeAsync(GetApiPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiPolicyResult>("azure-native:apimanagement/v20190101:getApiPolicy", args ?? new GetApiPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Policy Contract details.
        /// </summary>
        public static Output<GetApiPolicyResult> Invoke(GetApiPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApiPolicyResult>("azure-native:apimanagement/v20190101:getApiPolicy", args ?? new GetApiPolicyInvokeArgs(), options.WithVersion());
    }
