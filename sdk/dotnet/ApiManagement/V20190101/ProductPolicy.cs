...
namespace Pulumi.AzureNextGen.ApiManagement.V20190101
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20190101:ProductPolicy")]
    public partial class ProductPolicy : Pulumi.CustomResource
    {
        ...
        public ProductPolicy(string name, ProductPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20190101:ProductPolicy", name, args ?? new ProductPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20190101:ProductPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
