...
namespace Pulumi.AzureNative.ApiManagement.V20190101
{
    public static class GetLogger
    {
        ...
        public static Task<GetLoggerResult> InvokeAsync(GetLoggerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLoggerResult>("azure-native:apimanagement/v20190101:getLogger", args ?? new GetLoggerArgs(), options.WithVersion());

        /// <summary>
        /// Logger details.
        /// </summary>
        public static Output<GetLoggerResult> Invoke(GetLoggerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLoggerResult>("azure-native:apimanagement/v20190101:getLogger", args ?? new GetLoggerInvokeArgs(), options.WithVersion());
    }
