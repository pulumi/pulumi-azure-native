...
namespace Pulumi.AzureNextGen.ApiManagement.V20190101
{
    public static class GetApiDiagnostic
    {
        public static Task<GetApiDiagnosticResult> InvokeAsync(GetApiDiagnosticArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiDiagnosticResult>("azure-nextgen:apimanagement/v20190101:getApiDiagnostic", args ?? new GetApiDiagnosticArgs(), options.WithVersion());
    }
