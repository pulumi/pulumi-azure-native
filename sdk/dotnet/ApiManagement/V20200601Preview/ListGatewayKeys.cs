...
namespace Pulumi.AzureNative.ApiManagement.V20200601Preview
{
    public static class ListGatewayKeys
    {
        ...
        public static Task<ListGatewayKeysResult> InvokeAsync(ListGatewayKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<ListGatewayKeysResult>("azure-native:apimanagement/v20200601preview:listGatewayKeys", args ?? new ListGatewayKeysArgs(), options.WithDefaults());

        /// <summary>
        /// Retrieves gateway keys.
        /// </summary>
        public static Output<ListGatewayKeysResult> Invoke(ListGatewayKeysInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<ListGatewayKeysResult>("azure-native:apimanagement/v20200601preview:listGatewayKeys", args ?? new ListGatewayKeysInvokeArgs(), options.WithDefaults());
    }
