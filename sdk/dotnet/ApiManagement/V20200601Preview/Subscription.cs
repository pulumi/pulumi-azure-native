...
namespace Pulumi.AzureNative.ApiManagement.V20200601Preview
{
    ...
    public partial class Subscription : Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubscriptionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.ApiManagement.V20200601Preview.SubscriptionState>? State { get; set; }
