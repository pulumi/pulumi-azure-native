...
namespace Pulumi.AzureNextGen.ApiManagement.V20200601Preview
{
    public static class GetApiIssueComment
    {
        public static Task<GetApiIssueCommentResult> InvokeAsync(GetApiIssueCommentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueCommentResult>("azure-nextgen:apimanagement/v20200601preview:getApiIssueComment", args ?? new GetApiIssueCommentArgs(), options.WithVersion());
    }
