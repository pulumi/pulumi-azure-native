...
namespace Pulumi.AzureNative.ApiManagement.V20200601Preview
{
    ...
    public static class GetApiTagDescription
    {
        ...
        public static Task<GetApiTagDescriptionResult> InvokeAsync(GetApiTagDescriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetApiTagDescriptionResult>("azure-native:apimanagement/v20200601preview:getApiTagDescription", args ?? new GetApiTagDescriptionArgs(), options.WithDefaults());

        /// <summary>
        /// Get Tag description in scope of API
        /// </summary>
        public static Output<GetApiTagDescriptionResult> Invoke(GetApiTagDescriptionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetApiTagDescriptionResult>("azure-native:apimanagement/v20200601preview:getApiTagDescription", args ?? new GetApiTagDescriptionInvokeArgs(), options.WithDefaults());
    }
