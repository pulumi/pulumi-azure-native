...
namespace Pulumi.AzureNextGen.ApiManagement.V20200601Preview
{
    public static class GetApiSchema
    {
        public static Task<GetApiSchemaResult> InvokeAsync(GetApiSchemaArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiSchemaResult>("azure-nextgen:apimanagement/v20200601preview:getApiSchema", args ?? new GetApiSchemaArgs(), options.WithVersion());
    }
