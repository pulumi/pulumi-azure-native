...
namespace Pulumi.AzureNative.ApiManagement.V20200601Preview
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20200601preview:ApiTagDescription")]
    public partial class ApiTagDescription : Pulumi.CustomResource
    {
        ...
        public ApiTagDescription(string name, ApiTagDescriptionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:ApiTagDescription", name, args ?? new ApiTagDescriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiTagDescription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:ApiTagDescription", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20201201:ApiTagDescription"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:ApiTagDescription"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210401preview:ApiTagDescription"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:ApiTagDescription"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:ApiTagDescription"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:ApiTagDescription"},
                },
            };
