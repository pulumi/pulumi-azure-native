...
namespace Pulumi.AzureNextGen.ApiManagement.V20200601Preview
{
    public static class GetTagByApi
    {
        public static Task<GetTagByApiResult> InvokeAsync(GetTagByApiArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByApiResult>("azure-nextgen:apimanagement/v20200601preview:getTagByApi", args ?? new GetTagByApiArgs(), options.WithVersion());
    }
