...
namespace Pulumi.AzureNative.ApiManagement.V20200601Preview
{
    public static class GetProductPolicy
    {
        ...
        public static Task<GetProductPolicyResult> InvokeAsync(GetProductPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductPolicyResult>("azure-native:apimanagement/v20200601preview:getProductPolicy", args ?? new GetProductPolicyArgs(), options.WithVersion());

        /// <summary>
        /// Policy Contract details.
        /// </summary>
        public static Output<GetProductPolicyResult> Invoke(GetProductPolicyInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProductPolicyResult>("azure-native:apimanagement/v20200601preview:getProductPolicy", args ?? new GetProductPolicyInvokeArgs(), options.WithVersion());
    }
