...
namespace Pulumi.AzureNextGen.ApiManagement.V20200601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20200601preview:NotificationRecipientUser")]
    public partial class NotificationRecipientUser : Pulumi.CustomResource
    {
        ...
        public NotificationRecipientUser(string name, NotificationRecipientUserArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:NotificationRecipientUser", name, args ?? new NotificationRecipientUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationRecipientUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:NotificationRecipientUser", name, null, MakeResourceOptions(options, id))
        {
        }
