...
namespace Pulumi.AzureNative.ApiManagement.V20200601Preview
{
    ...
    /// Api details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20200601preview:Api is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20201201:Api to guarantee forwards compatibility.")]
    ...
    public partial class Api : global::Pulumi.CustomResource
    {
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:Api", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("apiType")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20200601Preview.ApiType>? ApiType { get; set; }
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20200601Preview.ContentFormat>? Format { get; set; }
        ...
        [Input("protocols")]
        private InputList<Pulumi.AzureNative.ApiManagement.V20200601Preview.Protocol>? _protocols;

        /// <summary>
        /// Describes on which protocols the operations in this API can be invoked.
        /// </summary>
        public InputList<Pulumi.AzureNative.ApiManagement.V20200601Preview.Protocol> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Pulumi.AzureNative.ApiManagement.V20200601Preview.Protocol>());
        ...
        /// </summary>
        [Input("soapApiType")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20200601Preview.SoapApiType>? SoapApiType { get; set; }
