...
namespace Pulumi.AzureNextGen.ApiManagement.V20200601Preview
{
    ...
    /// User details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20200601preview:User")]
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:User", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("appType")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20200601Preview.AppType>? AppType { get; set; }

        /// <summary>
        /// Determines the type of confirmation e-mail that will be sent to the newly created user.
        /// </summary>
        [Input("confirmation")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20200601Preview.Confirmation>? Confirmation { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20200601Preview.UserState>? State { get; set; }
