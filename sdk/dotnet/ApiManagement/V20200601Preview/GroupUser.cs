...
namespace Pulumi.AzureNextGen.ApiManagement.V20200601Preview
{
    ...
    /// User details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20200601preview:GroupUser")]
    public partial class GroupUser : Pulumi.CustomResource
    {
        ...
        public GroupUser(string name, GroupUserArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:GroupUser", name, args ?? new GroupUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:GroupUser", name, null, MakeResourceOptions(options, id))
        {
        }
