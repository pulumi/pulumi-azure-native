...
namespace Pulumi.AzureNextGen.ApiManagement.V20200601Preview
{
    ...
    /// ApiRelease details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20200601preview:ApiRelease")]
    public partial class ApiRelease : Pulumi.CustomResource
    {
        ...
        public ApiRelease(string name, ApiReleaseArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:ApiRelease", name, args ?? new ApiReleaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiRelease(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:ApiRelease", name, null, MakeResourceOptions(options, id))
        {
        }
