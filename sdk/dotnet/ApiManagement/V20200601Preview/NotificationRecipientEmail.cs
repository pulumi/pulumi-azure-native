...
namespace Pulumi.AzureNative.ApiManagement.V20200601Preview
{
    ...
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20200601preview:NotificationRecipientEmail is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:NotificationRecipientEmail to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20200601preview:NotificationRecipientEmail")]
    public partial class NotificationRecipientEmail : global::Pulumi.CustomResource
    {
        ...
        public NotificationRecipientEmail(string name, NotificationRecipientEmailArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:NotificationRecipientEmail", name, args ?? new NotificationRecipientEmailArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NotificationRecipientEmail(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:NotificationRecipientEmail", name, null, MakeResourceOptions(options, id))
        {
        }
