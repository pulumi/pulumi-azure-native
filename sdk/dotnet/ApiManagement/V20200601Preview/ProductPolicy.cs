...
namespace Pulumi.AzureNextGen.ApiManagement.V20200601Preview
{
    ...
    public partial class ProductPolicy : Pulumi.CustomResource
    {
        ...
        public ProductPolicy(string name, ProductPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:ProductPolicy", name, args ?? new ProductPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20200601preview:ProductPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
