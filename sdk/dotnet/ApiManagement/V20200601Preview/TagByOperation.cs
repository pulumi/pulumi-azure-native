...
namespace Pulumi.AzureNative.ApiManagement.V20200601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20200601preview:TagByOperation")]
    public partial class TagByOperation : Pulumi.CustomResource
    {
        ...
        public TagByOperation(string name, TagByOperationArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:TagByOperation", name, args ?? new TagByOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:TagByOperation", name, null, MakeResourceOptions(options, id))
        {
        }
