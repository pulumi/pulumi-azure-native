...
namespace Pulumi.AzureNative.ApiManagement.V20200601Preview
{
    ...
    /// Api details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20200601preview:ProductApi is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:ProductApi to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20200601preview:ProductApi")]
    public partial class ProductApi : global::Pulumi.CustomResource
    {
        ...
        public ProductApi(string name, ProductApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:ProductApi", name, args ?? new ProductApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20200601preview:ProductApi", name, null, MakeResourceOptions(options, id))
        {
        }
