...
namespace Pulumi.AzureNative.ApiManagement.V20180601Preview
{
    ...
    /// Backend details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20180601preview:Backend is being removed in the next major version of this provider. Please upgrade to azure-native:apimanagement/v20220801:Backend to guarantee forwards compatibility.")]
    ...
    public partial class Backend : global::Pulumi.CustomResource
    {
        ...
        public Backend(string name, BackendArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:Backend", name, args ?? new BackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backend(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:Backend", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BackendArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20180601Preview.BackendProtocol> Protocol { get; set; } = null!;
