...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiManagementService = new AzureRM.ApiManagement.V20180601Preview.ApiManagementService("apiManagementService", new AzureRM.ApiManagement.V20180601Preview.ApiManagementServiceArgs
    ///         {
    ///             AdditionalLocations = 
    ///             {
    ///                 new AzureRM.ApiManagement.V20180601Preview.Inputs.AdditionalLocationArgs
    ///                 {
    ///                     Location = "West US",
    ///                     Sku = new AzureRM.ApiManagement.V20180601Preview.Inputs.ApiManagementServiceSkuPropertiesArgs
    ///                     {
    ///                         Capacity = 1,
    ///                         Name = "Premium",
    ///                     },
    ///                     VirtualNetworkConfiguration = new AzureRM.ApiManagement.V20180601Preview.Inputs.VirtualNetworkConfigurationArgs
    ///                     {
    ...
    ///             {
    ///                 new AzureRM.ApiManagement.V20180601Preview.Inputs.HostnameConfigurationArgs
    ///                 {
    ...
    ///         var apiManagementService = new AzureRM.ApiManagement.V20180601Preview.ApiManagementService("apiManagementService", new AzureRM.ApiManagement.V20180601Preview.ApiManagementServiceArgs
    ///         {
    ///             Identity = new AzureRM.ApiManagement.V20180601Preview.Inputs.ApiManagementServiceIdentityArgs
    ///             {
    ///                 Type = "SystemAssigned",
    ///             },
    ///             Location = "Japan East",
    ...
    ///             Certificates = 
    ///             {
    ///                 new AzureRM.ApiManagement.V20180601Preview.Inputs.CertificateConfigurationArgs
    ///                 {
    ///                     CertificatePassword = "**************Password of the Certificate************************************************",
    ///                     EncodedCertificate = "************Base 64 Encoded Pfx Certificate************************",
    ...
    public partial class ApiManagementService : Pulumi.CustomResource
    {
        ...
        public ApiManagementService(string name, ApiManagementServiceArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiManagementService", name, args ?? new ApiManagementServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiManagementService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiManagementService", name, null, MakeResourceOptions(options, id))
        {
        }
