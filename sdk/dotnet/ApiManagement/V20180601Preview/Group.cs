...
namespace Pulumi.AzureNative.ApiManagement.V20180601Preview
{
    ...
    /// Contract details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20180601preview:Group")]
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:Group", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public Input<Pulumi.AzureNative.ApiManagement.V20180601Preview.GroupType>? Type { get; set; }
