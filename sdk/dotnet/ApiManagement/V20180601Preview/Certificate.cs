...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var certificate = new AzureRM.ApiManagement.V20180601Preview.Certificate("certificate", new AzureRM.ApiManagement.V20180601Preview.CertificateArgs
    ///         {
    ...
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        public Certificate(string name, CertificateArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Certificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:Certificate", name, null, MakeResourceOptions(options, id))
        {
        }
