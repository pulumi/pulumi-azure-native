...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiIssueComment = new AzureRM.ApiManagement.V20180601Preview.ApiIssueComment("apiIssueComment", new AzureRM.ApiManagement.V20180601Preview.ApiIssueCommentArgs
    ///         {
    ...
    public partial class ApiIssueComment : Pulumi.CustomResource
    {
        ...
        public ApiIssueComment(string name, ApiIssueCommentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiIssueComment", name, args ?? new ApiIssueCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiIssueComment", name, null, MakeResourceOptions(options, id))
        {
        }
