...
namespace Pulumi.AzureNextGen.ApiManagement.V20180601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20180601preview:ApiIssueComment")]
    public partial class ApiIssueComment : Pulumi.CustomResource
    {
        ...
        public ApiIssueComment(string name, ApiIssueCommentArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180601preview:ApiIssueComment", name, args ?? new ApiIssueCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180601preview:ApiIssueComment", name, null, MakeResourceOptions(options, id))
        {
        }
