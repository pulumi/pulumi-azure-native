...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiRelease = new AzureRM.ApiManagement.V20180601Preview.ApiRelease("apiRelease", new AzureRM.ApiManagement.V20180601Preview.ApiReleaseArgs
    ///         {
    ...
    public partial class ApiRelease : Pulumi.CustomResource
    {
        ...
        public ApiRelease(string name, ApiReleaseArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiRelease", name, args ?? new ApiReleaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiRelease(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiRelease", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azurerm:apimanagement/latest:ApiRelease"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20170301:ApiRelease"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20180101:ApiRelease"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20190101:ApiRelease"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201:ApiRelease"},
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20191201preview:ApiRelease"},
                },
            };
