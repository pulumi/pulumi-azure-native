...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tagByProduct = new AzureRM.ApiManagement.V20180601Preview.TagByProduct("tagByProduct", new AzureRM.ApiManagement.V20180601Preview.TagByProductArgs
    ///         {
    ...
    public partial class TagByProduct : Pulumi.CustomResource
    {
        ...
        public TagByProduct(string name, TagByProductArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:TagByProduct", name, args ?? new TagByProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:TagByProduct", name, null, MakeResourceOptions(options, id))
        {
        }
