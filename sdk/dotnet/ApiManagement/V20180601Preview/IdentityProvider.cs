...
namespace Pulumi.AzureNextGen.ApiManagement.V20180601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20180601preview:IdentityProvider")]
    ...
    public sealed class IdentityProviderArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("type")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.V20180601Preview.IdentityProviderType>? Type { get; set; }
