...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var openIdConnectProvider = new AzureRM.ApiManagement.V20180601Preview.OpenIdConnectProvider("openIdConnectProvider", new AzureRM.ApiManagement.V20180601Preview.OpenIdConnectProviderArgs
    ///         {
    ...
    public partial class OpenIdConnectProvider : Pulumi.CustomResource
    {
        ...
        public OpenIdConnectProvider(string name, OpenIdConnectProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:OpenIdConnectProvider", name, args ?? new OpenIdConnectProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenIdConnectProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:OpenIdConnectProvider", name, null, MakeResourceOptions(options, id))
        {
        }
