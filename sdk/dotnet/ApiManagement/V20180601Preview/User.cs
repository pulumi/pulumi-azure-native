...
namespace Pulumi.AzureNative.ApiManagement.V20180601Preview
{
    ...
    /// User details.
    /// </summary>
    [Obsolete(@"azure-native:apimanagement/v20180601preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:User to guarantee forwards compatibility.")]
    [AzureNativeResourceType("azure-native:apimanagement/v20180601preview:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:User", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("confirmation")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20180601Preview.Confirmation>? Confirmation { get; set; }
        ...
        /// </summary>
        [Input("state")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20180601Preview.UserState>? State { get; set; }
