...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var policy = new AzureRM.ApiManagement.V20180601Preview.Policy("policy", new AzureRM.ApiManagement.V20180601Preview.PolicyArgs
    ///         {
    ///             ContentFormat = "xml",
    ...
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
