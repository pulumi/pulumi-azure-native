...
namespace Pulumi.AzureNative.ApiManagement.V20180601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20180601preview:ApiVersionSet")]
    public partial class ApiVersionSet : Pulumi.CustomResource
    {
        ...
        public ApiVersionSet(string name, ApiVersionSetArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:ApiVersionSet", name, args ?? new ApiVersionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiVersionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:ApiVersionSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiVersionSetArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.V20180601Preview.VersioningScheme> VersioningScheme { get; set; } = null!;
