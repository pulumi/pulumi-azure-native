...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiVersionSet = new AzureRM.ApiManagement.V20180601Preview.ApiVersionSet("apiVersionSet", new AzureRM.ApiManagement.V20180601Preview.ApiVersionSetArgs
    ///         {
    ...
    public partial class ApiVersionSet : Pulumi.CustomResource
    {
        ...
        public ApiVersionSet(string name, ApiVersionSetArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiVersionSet", name, args ?? new ApiVersionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiVersionSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiVersionSet", name, null, MakeResourceOptions(options, id))
        {
        }
