...
namespace Pulumi.AzureNative.ApiManagement.V20180601Preview
{
    ...
    /// Product details.
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20180601preview:Product")]
    public partial class Product : Pulumi.CustomResource
    {
        ...
        public Product(string name, ProductArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:Product", name, args ?? new ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:Product", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProductArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("state")]
        public Input<Pulumi.AzureNative.ApiManagement.V20180601Preview.ProductState>? State { get; set; }
