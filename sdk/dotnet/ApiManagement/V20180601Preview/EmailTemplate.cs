...
namespace Pulumi.AzureNextGen.ApiManagement.V20180601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20180601preview:EmailTemplate")]
    public partial class EmailTemplate : Pulumi.CustomResource
    {
        ...
        public EmailTemplate(string name, EmailTemplateArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180601preview:EmailTemplate", name, args ?? new EmailTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180601preview:EmailTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
