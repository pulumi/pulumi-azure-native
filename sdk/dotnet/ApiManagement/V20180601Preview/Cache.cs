...
namespace Pulumi.AzureNextGen.ApiManagement.V20180601Preview
{
    ...
    /// Cache details.
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20180601preview:Cache")]
    public partial class Cache : Pulumi.CustomResource
    {
        ...
        public Cache(string name, CacheArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180601preview:Cache", name, args ?? new CacheArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cache(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180601preview:Cache", name, null, MakeResourceOptions(options, id))
        {
        }
