...
namespace Pulumi.AzureNextGen.ApiManagement.V20180601Preview
{
    ...
    /// </summary>
    [AzureNextGenResourceType("azure-nextgen:apimanagement/v20180601preview:ApiPolicy")]
    public partial class ApiPolicy : Pulumi.CustomResource
    {
        ...
        public ApiPolicy(string name, ApiPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180601preview:ApiPolicy", name, args ?? new ApiPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/v20180601preview:ApiPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
