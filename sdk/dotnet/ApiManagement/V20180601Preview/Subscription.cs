...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var subscription = new AzureRM.ApiManagement.V20180601Preview.Subscription("subscription", new AzureRM.ApiManagement.V20180601Preview.SubscriptionArgs
    ///         {
    ///             DisplayName = "testsub",
    ...
    public partial class Subscription : Pulumi.CustomResource
    {
        ...
        public Subscription(string name, SubscriptionArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:Subscription", name, args ?? new SubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Subscription(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:Subscription", name, null, MakeResourceOptions(options, id))
        {
        }
