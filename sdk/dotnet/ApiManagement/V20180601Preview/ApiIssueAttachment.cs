...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiIssueAttachment = new AzureRM.ApiManagement.V20180601Preview.ApiIssueAttachment("apiIssueAttachment", new AzureRM.ApiManagement.V20180601Preview.ApiIssueAttachmentArgs
    ///         {
    ...
    public partial class ApiIssueAttachment : Pulumi.CustomResource
    {
        ...
        public ApiIssueAttachment(string name, ApiIssueAttachmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiIssueAttachment", name, args ?? new ApiIssueAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:ApiIssueAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
