...
namespace Pulumi.AzureNative.ApiManagement.V20180601Preview
{
    public static class GetAuthorizationServer
    {
        ...
        public static Task<GetAuthorizationServerResult> InvokeAsync(GetAuthorizationServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAuthorizationServerResult>("azure-native:apimanagement/v20180601preview:getAuthorizationServer", args ?? new GetAuthorizationServerArgs(), options.WithDefaults());
        ...
        public static Output<GetAuthorizationServerResult> Invoke(GetAuthorizationServerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAuthorizationServerResult>("azure-native:apimanagement/v20180601preview:getAuthorizationServer", args ?? new GetAuthorizationServerInvokeArgs(), options.WithDefaults());
    }
