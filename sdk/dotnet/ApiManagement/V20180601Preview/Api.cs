...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var api = new AzureRM.ApiManagement.V20180601Preview.Api("api", new AzureRM.ApiManagement.V20180601Preview.ApiArgs
    ///         {
    ///             ApiId = "tempgroup",
    ///             AuthenticationSettings = new AzureRM.ApiManagement.V20180601Preview.Inputs.AuthenticationSettingsContractArgs
    ///             {
    ///                 OAuth2 = new AzureRM.ApiManagement.V20180601Preview.Inputs.OAuth2AuthenticationSettingsContractArgs
    ///                 {
    ...
    ///             SubscriptionKeyParameterNames = new AzureRM.ApiManagement.V20180601Preview.Inputs.SubscriptionKeyParameterNamesContractArgs
    ///             {
    ///                 Header = "header4520",
    ///                 Query = "query3037",
    ///             },
    ...
    ///             AuthenticationSettings = new AzureRM.ApiManagement.V20180601Preview.Inputs.AuthenticationSettingsContractArgs
    ///             {
    ///                 Openid = new AzureRM.ApiManagement.V20180601Preview.Inputs.OpenIdAuthenticationSettingsContractArgs
    ///                 {
    ...
    ///             ServiceName = "apimService1",
    ///             SoapApiType = "soap",
    ///             WsdlSelector = new AzureRM.ApiManagement.V20180601Preview.Inputs.ApiCreateOrUpdatePropertiesWsdlSelectorArgs
    ///             {
