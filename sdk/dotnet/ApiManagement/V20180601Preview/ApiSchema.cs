...
namespace Pulumi.AzureNative.ApiManagement.V20180601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20180601preview:ApiSchema")]
    public partial class ApiSchema : Pulumi.CustomResource
    {
        ...
        public ApiSchema(string name, ApiSchemaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:ApiSchema", name, args ?? new ApiSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:ApiSchema", name, null, MakeResourceOptions(options, id))
        {
        }
