...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tagByOperation = new AzureRM.ApiManagement.V20180601Preview.TagByOperation("tagByOperation", new AzureRM.ApiManagement.V20180601Preview.TagByOperationArgs
    ///         {
    ...
    public partial class TagByOperation : Pulumi.CustomResource
    {
        ...
        public TagByOperation(string name, TagByOperationArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:TagByOperation", name, args ?? new TagByOperationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByOperation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:TagByOperation", name, null, MakeResourceOptions(options, id))
        {
        }
