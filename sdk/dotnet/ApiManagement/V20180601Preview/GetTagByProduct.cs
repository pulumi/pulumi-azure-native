...
{
    [Obsolete(@"azure-native:apimanagement/v20180601preview:TagByProduct is being removed in the next major version of this provider. Upgrade to at least azure-native:apimanagement/v20220901preview:TagByProduct to guarantee forwards compatibility.")]
    public static class GetTagByProduct
    {
        ...
        public static Task<GetTagByProductResult> InvokeAsync(GetTagByProductArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTagByProductResult>("azure-native:apimanagement/v20180601preview:getTagByProduct", args ?? new GetTagByProductArgs(), options.WithDefaults());

        /// <summary>
        /// Get tag associated with the Product.
        /// </summary>
        public static Output<GetTagByProductResult> Invoke(GetTagByProductInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTagByProductResult>("azure-native:apimanagement/v20180601preview:getTagByProduct", args ?? new GetTagByProductInvokeArgs(), options.WithDefaults());
    }
