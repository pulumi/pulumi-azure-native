...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    public static class GetApiIssue
    {
        public static Task<GetApiIssueResult> InvokeAsync(GetApiIssueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueResult>("azurerm:apimanagement/v20180601preview:getApiIssue", args ?? new GetApiIssueArgs(), options.WithVersion());
    }
