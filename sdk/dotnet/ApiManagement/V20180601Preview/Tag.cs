...
namespace Pulumi.AzureNative.ApiManagement.V20180601Preview
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:apimanagement/v20180601preview:Tag")]
    public partial class Tag : Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/v20180601preview:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement:Tag"},
                    ...
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20191201:Tag"},
                    ...
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210101preview:Tag"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210101preview:Tag"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210401preview:Tag"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210401preview:Tag"},
                    new Pulumi.Alias { Type = "azure-native:apimanagement/v20210801:Tag"},
                    new Pulumi.Alias { Type = "azure-nextgen:apimanagement/v20210801:Tag"},
                },
            };
