...
namespace Pulumi.AzureRM.ApiManagement.V20180601Preview
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tag = new AzureRM.ApiManagement.V20180601Preview.Tag("tag", new AzureRM.ApiManagement.V20180601Preview.TagArgs
    ///         {
    ///             DisplayName = "tag1",
    ...
    public partial class Tag : Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/v20180601preview:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
