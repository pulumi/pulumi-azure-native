...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class ListTenantAccessSecrets
    {
        public static Task<ListTenantAccessSecretsResult> InvokeAsync(ListTenantAccessSecretsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListTenantAccessSecretsResult>("azurerm:apimanagement/preview:listTenantAccessSecrets", args ?? new ListTenantAccessSecretsArgs(), options.WithVersion());
    }
