...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class GetContentItem
    {
        public static Task<GetContentItemResult> InvokeAsync(GetContentItemArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContentItemResult>("azurerm:apimanagement/preview:getContentItem", args ?? new GetContentItemArgs(), options.WithVersion());
    }
