...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class GetTagByProduct
    {
        public static Task<GetTagByProductResult> InvokeAsync(GetTagByProductArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByProductResult>("azurerm:apimanagement/preview:getTagByProduct", args ?? new GetTagByProductArgs(), options.WithVersion());
    }
