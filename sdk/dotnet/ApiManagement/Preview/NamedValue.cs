...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    ...
    public partial class NamedValue : Pulumi.CustomResource
    {
        ...
        public NamedValue(string name, NamedValueArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/preview:NamedValue", name, args ?? new NamedValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamedValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/preview:NamedValue", name, null, MakeResourceOptions(options, id))
        {
        }
