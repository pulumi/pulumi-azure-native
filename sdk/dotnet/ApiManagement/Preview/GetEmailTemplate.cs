...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class GetEmailTemplate
    {
        public static Task<GetEmailTemplateResult> InvokeAsync(GetEmailTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEmailTemplateResult>("azurerm:apimanagement/preview:getEmailTemplate", args ?? new GetEmailTemplateArgs(), options.WithVersion());
    }
