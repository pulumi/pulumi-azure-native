...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class ListNamedValue
    {
        public static Task<ListNamedValueResult> InvokeAsync(ListNamedValueArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListNamedValueResult>("azurerm:apimanagement/preview:listNamedValue", args ?? new ListNamedValueArgs(), options.WithVersion());
    }
