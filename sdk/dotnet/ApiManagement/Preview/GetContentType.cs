...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class GetContentType
    {
        public static Task<GetContentTypeResult> InvokeAsync(GetContentTypeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContentTypeResult>("azurerm:apimanagement/preview:getContentType", args ?? new GetContentTypeArgs(), options.WithVersion());
    }
