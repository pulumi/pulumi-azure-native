...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class ListGatewayKeys
    {
        public static Task<ListGatewayKeysResult> InvokeAsync(ListGatewayKeysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ListGatewayKeysResult>("azurerm:apimanagement/preview:listGatewayKeys", args ?? new ListGatewayKeysArgs(), options.WithVersion());
    }
