...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class GetTagByOperation
    {
        public static Task<GetTagByOperationResult> InvokeAsync(GetTagByOperationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByOperationResult>("azurerm:apimanagement/preview:getTagByOperation", args ?? new GetTagByOperationArgs(), options.WithVersion());
    }
