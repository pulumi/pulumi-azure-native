...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class GetApiVersionSet
    {
        public static Task<GetApiVersionSetResult> InvokeAsync(GetApiVersionSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiVersionSetResult>("azurerm:apimanagement/preview:getApiVersionSet", args ?? new GetApiVersionSetArgs(), options.WithVersion());
    }
