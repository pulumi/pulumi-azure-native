...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    public static class GetApiIssueComment
    {
        public static Task<GetApiIssueCommentResult> InvokeAsync(GetApiIssueCommentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiIssueCommentResult>("azurerm:apimanagement/preview:getApiIssueComment", args ?? new GetApiIssueCommentArgs(), options.WithVersion());
    }
