...
namespace Pulumi.AzureRM.ApiManagement.Preview
{
    ...
    public partial class ApiIssueAttachment : Pulumi.CustomResource
    {
        ...
        public ApiIssueAttachment(string name, ApiIssueAttachmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/preview:ApiIssueAttachment", name, args ?? new ApiIssueAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/preview:ApiIssueAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
