...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiOperationPolicy = new AzureRM.ApiManagement.Latest.ApiOperationPolicy("apiOperationPolicy", new AzureRM.ApiManagement.Latest.ApiOperationPolicyArgs
    ///         {
    ...
    public partial class ApiOperationPolicy : Pulumi.CustomResource
    {
        ...
        public ApiOperationPolicy(string name, ApiOperationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:ApiOperationPolicy", name, args ?? new ApiOperationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiOperationPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:ApiOperationPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
