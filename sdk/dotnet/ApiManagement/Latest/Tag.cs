...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var tag = new AzureRM.ApiManagement.Latest.Tag("tag", new AzureRM.ApiManagement.Latest.TagArgs
    ///         {
    ///             DisplayName = "tag1",
    ...
    public partial class Tag : Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
