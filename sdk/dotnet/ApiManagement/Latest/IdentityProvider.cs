...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var identityProvider = new AzureRM.ApiManagement.Latest.IdentityProvider("identityProvider", new AzureRM.ApiManagement.Latest.IdentityProviderArgs
    ///         {
    ///             ClientId = "facebookid",
    ...
    public partial class IdentityProvider : Pulumi.CustomResource
    {
        ...
        public IdentityProvider(string name, IdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:IdentityProvider", name, args ?? new IdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:IdentityProvider", name, null, MakeResourceOptions(options, id))
        {
        }
