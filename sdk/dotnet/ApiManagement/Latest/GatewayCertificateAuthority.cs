...
namespace Pulumi.AzureNative.ApiManagement.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:GatewayCertificateAuthority'.")]
    [AzureNativeResourceType("azure-native:apimanagement/latest:GatewayCertificateAuthority")]
    public partial class GatewayCertificateAuthority : Pulumi.CustomResource
    {
        ...
        public GatewayCertificateAuthority(string name, GatewayCertificateAuthorityArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/latest:GatewayCertificateAuthority", name, args ?? new GatewayCertificateAuthorityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayCertificateAuthority(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/latest:GatewayCertificateAuthority", name, null, MakeResourceOptions(options, id))
        {
        }
