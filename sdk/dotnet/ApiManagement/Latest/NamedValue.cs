...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    ...
    public partial class NamedValue : Pulumi.CustomResource
    {
        ...
        public NamedValue(string name, NamedValueArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:NamedValue", name, args ?? new NamedValueArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NamedValue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:NamedValue", name, null, MakeResourceOptions(options, id))
        {
        }
