...
namespace Pulumi.AzureNextGen.ApiManagement.Latest
{
    ...
    public partial class Diagnostic : Pulumi.CustomResource
    {
        ...
        public Diagnostic(string name, DiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/latest:Diagnostic", name, args ?? new DiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Diagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/latest:Diagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiagnosticArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("alwaysLog")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.Latest.AlwaysLog>? AlwaysLog { get; set; }
        ...
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.Latest.HttpCorrelationProtocol>? HttpCorrelationProtocol { get; set; }
        ...
        /// </summary>
        [Input("verbosity")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.Latest.Verbosity>? Verbosity { get; set; }
