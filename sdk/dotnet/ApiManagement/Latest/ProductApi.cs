...
namespace Pulumi.AzureNextGen.ApiManagement.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:apimanagement:ProductApi'.")]
    [AzureNextGenResourceType("azure-nextgen:apimanagement/latest:ProductApi")]
    public partial class ProductApi : Pulumi.CustomResource
    {
        ...
        public ProductApi(string name, ProductApiArgs args, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/latest:ProductApi", name, args ?? new ProductApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-nextgen:apimanagement/latest:ProductApi", name, null, MakeResourceOptions(options, id))
        {
        }
