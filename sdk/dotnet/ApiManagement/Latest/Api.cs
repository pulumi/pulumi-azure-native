...
namespace Pulumi.AzureNative.ApiManagement.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:Api'.")]
    [AzureNativeResourceType("azure-native:apimanagement/latest:Api")]
    public partial class Api : Pulumi.CustomResource
    {
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/latest:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/latest:Api", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("apiType")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.Latest.ApiType>? ApiType { get; set; }
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.Latest.ContentFormat>? Format { get; set; }
        ...
        [Input("protocols")]
        private InputList<Pulumi.AzureNative.ApiManagement.Latest.Protocol>? _protocols;

        /// <summary>
        /// Describes on which protocols the operations in this API can be invoked.
        /// </summary>
        public InputList<Pulumi.AzureNative.ApiManagement.Latest.Protocol> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Pulumi.AzureNative.ApiManagement.Latest.Protocol>());
        ...
        /// </summary>
        [Input("soapApiType")]
        public InputUnion<string, Pulumi.AzureNative.ApiManagement.Latest.SoapApiType>? SoapApiType { get; set; }
