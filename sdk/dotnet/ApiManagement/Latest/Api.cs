...
namespace Pulumi.AzureNextGen.ApiManagement.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-nextgen:apimanagement:Api'.")]
    [AzureNextGenResourceType("azure-nextgen:apimanagement/latest:Api")]
    ...
    public sealed class ApiArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("apiType")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.Latest.ApiType>? ApiType { get; set; }
        ...
        /// </summary>
        [Input("format")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.Latest.ContentFormat>? Format { get; set; }
        ...
        [Input("protocols")]
        private InputList<Pulumi.AzureNextGen.ApiManagement.Latest.Protocol>? _protocols;

        /// <summary>
        /// Describes on which protocols the operations in this API can be invoked.
        /// </summary>
        public InputList<Pulumi.AzureNextGen.ApiManagement.Latest.Protocol> Protocols
        {
            get => _protocols ?? (_protocols = new InputList<Pulumi.AzureNextGen.ApiManagement.Latest.Protocol>());
        ...
        /// </summary>
        [Input("soapApiType")]
        public InputUnion<string, Pulumi.AzureNextGen.ApiManagement.Latest.SoapApiType>? SoapApiType { get; set; }
