...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    ...
    public partial class Product : Pulumi.CustomResource
    {
        ...
        public Product(string name, ProductArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:Product", name, args ?? new ProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Product(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:Product", name, null, MakeResourceOptions(options, id))
        {
        }
