...
namespace Pulumi.AzureNative.ApiManagement.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:ProductGroup'.")]
    [AzureNativeResourceType("azure-native:apimanagement/latest:ProductGroup")]
    public partial class ProductGroup : Pulumi.CustomResource
    {
        ...
        public ProductGroup(string name, ProductGroupArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/latest:ProductGroup", name, args ?? new ProductGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/latest:ProductGroup", name, null, MakeResourceOptions(options, id))
        {
        }
