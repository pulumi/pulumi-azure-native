...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    public static class GetApiOperation
    {
        public static Task<GetApiOperationResult> InvokeAsync(GetApiOperationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApiOperationResult>("azurerm:apimanagement/latest:getApiOperation", args ?? new GetApiOperationArgs(), options.WithVersion());
    }
