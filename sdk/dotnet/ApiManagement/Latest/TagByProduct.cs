...
namespace Pulumi.AzureNative.ApiManagement.Latest
{
    ...
    /// </summary>
    [Obsolete(@"The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:TagByProduct'.")]
    [AzureNativeResourceType("azure-native:apimanagement/latest:TagByProduct")]
    public partial class TagByProduct : Pulumi.CustomResource
    {
        ...
        public TagByProduct(string name, TagByProductArgs args, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/latest:TagByProduct", name, args ?? new TagByProductArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagByProduct(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:apimanagement/latest:TagByProduct", name, null, MakeResourceOptions(options, id))
        {
        }
