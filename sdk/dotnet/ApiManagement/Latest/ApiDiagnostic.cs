...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var apiDiagnostic = new AzureRM.ApiManagement.Latest.ApiDiagnostic("apiDiagnostic", new AzureRM.ApiManagement.Latest.ApiDiagnosticArgs
    ///         {
    ///             AlwaysLog = "allErrors",
    ...
    public partial class ApiDiagnostic : Pulumi.CustomResource
    {
        ...
        public ApiDiagnostic(string name, ApiDiagnosticArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:ApiDiagnostic", name, args ?? new ApiDiagnosticArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiDiagnostic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:ApiDiagnostic", name, null, MakeResourceOptions(options, id))
        {
        }
