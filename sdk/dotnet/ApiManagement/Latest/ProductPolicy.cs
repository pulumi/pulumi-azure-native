...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var productPolicy = new AzureRM.ApiManagement.Latest.ProductPolicy("productPolicy", new AzureRM.ApiManagement.Latest.ProductPolicyArgs
    ///         {
    ///             Format = "xml",
    ///             PolicyId = "policy",
    ...
    public partial class ProductPolicy : Pulumi.CustomResource
    {
        ...
        public ProductPolicy(string name, ProductPolicyArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:ProductPolicy", name, args ?? new ProductPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProductPolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:ProductPolicy", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new Pulumi.Alias { Type = "azurerm:apimanagement/v20180601preview:ProductPolicy"},
