...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    ...
    public partial class ApiIssueComment : Pulumi.CustomResource
    {
        ...
        public ApiIssueComment(string name, ApiIssueCommentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:ApiIssueComment", name, args ?? new ApiIssueCommentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApiIssueComment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:ApiIssueComment", name, null, MakeResourceOptions(options, id))
        {
        }
