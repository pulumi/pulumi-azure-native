...
namespace Pulumi.AzureRM.ApiManagement.Latest
{
    ...
    ///     public MyStack()
    ///     {
    ///         var openIdConnectProvider = new AzureRM.ApiManagement.Latest.OpenIdConnectProvider("openIdConnectProvider", new AzureRM.ApiManagement.Latest.OpenIdConnectProviderArgs
    ///         {
    ...
    public partial class OpenIdConnectProvider : Pulumi.CustomResource
    {
        ...
        public OpenIdConnectProvider(string name, OpenIdConnectProviderArgs args, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:OpenIdConnectProvider", name, args ?? new OpenIdConnectProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpenIdConnectProvider(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement/latest:OpenIdConnectProvider", name, null, MakeResourceOptions(options, id))
        {
        }
