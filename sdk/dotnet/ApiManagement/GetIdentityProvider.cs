...
namespace Pulumi.AzureRM.ApiManagement
{
    public static class GetIdentityProvider
    {
        public static Task<GetIdentityProviderResult> InvokeAsync(GetIdentityProviderArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIdentityProviderResult>("azurerm:apimanagement:getIdentityProvider", args ?? new GetIdentityProviderArgs(), options.WithVersion());
    }
