...
namespace Pulumi.AzureRM.ApiManagement
{
    ...
    public partial class ServiceCertificate : Pulumi.CustomResource
    {
        ...
        private ServiceCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:apimanagement:ServiceCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceCertificate Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ServiceCertificate(name, id, options);
        }
    }
