...
namespace Pulumi.AzureRM.ApiManagement
{
    public static class GetTagByOperation
    {
        public static Task<GetTagByOperationResult> InvokeAsync(GetTagByOperationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagByOperationResult>("azurerm:apimanagement:getTagByOperation", args ?? new GetTagByOperationArgs(), options.WithVersion());
    }
