...
namespace Pulumi.AzureNative.Quota.V20241015Preview
{
    public static class GetGroupQuota
    {
        ...
        public static Task<GetGroupQuotaResult> InvokeAsync(GetGroupQuotaArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupQuotaResult>("azure-native:quota/v20241015preview:getGroupQuota", args ?? new GetGroupQuotaArgs(), options.WithDefaults());
