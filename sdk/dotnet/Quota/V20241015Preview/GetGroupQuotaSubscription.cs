...
namespace Pulumi.AzureNative.Quota.V20241015Preview
{
    public static class GetGroupQuotaSubscription
    {
        ...
        public static Task<GetGroupQuotaSubscriptionResult> InvokeAsync(GetGroupQuotaSubscriptionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupQuotaSubscriptionResult>("azure-native:quota/v20241015preview:getGroupQuotaSubscription", args ?? new GetGroupQuotaSubscriptionArgs(), options.WithDefaults());
