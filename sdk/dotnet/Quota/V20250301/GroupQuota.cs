...
namespace Pulumi.AzureNative.Quota.V20250301
{
    ...
    /// </summary>
    [AzureNativeResourceType("azure-native:quota/v20250301:GroupQuota")]
    public partial class GroupQuota : global::Pulumi.CustomResource
    {
        ...
        public GroupQuota(string name, GroupQuotaArgs args, CustomResourceOptions? options = null)
            : base("azure-native:quota/v20250301:GroupQuota", name, args ?? new GroupQuotaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupQuota(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:quota/v20250301:GroupQuota", name, null, MakeResourceOptions(options, id))
        {
        }
