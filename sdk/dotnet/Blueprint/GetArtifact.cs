...
namespace Pulumi.AzureNative.Blueprint
{
    ...
    public static class GetArtifact
    {
        ...
        public static Task<GetArtifactResult> InvokeAsync(GetArtifactArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetArtifactResult>("azure-native:blueprint:getArtifact", args ?? new GetArtifactArgs(), options.WithDefaults());
        ...
        public static Output<GetArtifactResult> Invoke(GetArtifactInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetArtifactResult>("azure-native:blueprint:getArtifact", args ?? new GetArtifactInvokeArgs(), options.WithDefaults());
    }
