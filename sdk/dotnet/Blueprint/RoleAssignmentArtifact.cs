...
namespace Pulumi.AzureNative.Blueprint
{
    ...
    public partial class RoleAssignmentArtifact : global::Pulumi.CustomResource
    {
        ...
        public RoleAssignmentArtifact(string name, RoleAssignmentArtifactArgs args, CustomResourceOptions? options = null)
            : base("azure-native:blueprint:RoleAssignmentArtifact", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private RoleAssignmentArtifact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:blueprint:RoleAssignmentArtifact", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_blueprint_v20181101preview:blueprint:RoleAssignmentArtifact" },
                },
            };
