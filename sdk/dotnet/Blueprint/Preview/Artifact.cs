...
namespace Pulumi.AzureRM.Blueprint.Preview
{
    ...
    public partial class Artifact : Pulumi.CustomResource
    {
        ...
        public Artifact(string name, ArtifactArgs args, CustomResourceOptions? options = null)
            : base("azurerm:blueprint/preview:Artifact", name, args ?? new ArtifactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Artifact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:blueprint/preview:Artifact", name, null, MakeResourceOptions(options, id))
        {
        }
