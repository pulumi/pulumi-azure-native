...
namespace Pulumi.AzureRM.Blueprint.Preview
{
    ...
    public partial class Assignment : Pulumi.CustomResource
    {
        ...
        public Assignment(string name, AssignmentArgs args, CustomResourceOptions? options = null)
            : base("azurerm:blueprint/preview:Assignment", name, args ?? new AssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Assignment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:blueprint/preview:Assignment", name, null, MakeResourceOptions(options, id))
        {
        }
