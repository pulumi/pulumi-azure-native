...
namespace Pulumi.AzureRM.Blueprint.Preview
{
    ...
    public partial class Blueprint : Pulumi.CustomResource
    {
        ...
        public Blueprint(string name, BlueprintArgs args, CustomResourceOptions? options = null)
            : base("azurerm:blueprint/preview:Blueprint", name, args ?? new BlueprintArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Blueprint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azurerm:blueprint/preview:Blueprint", name, null, MakeResourceOptions(options, id))
        {
        }
