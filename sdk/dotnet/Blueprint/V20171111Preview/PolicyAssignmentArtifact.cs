...
namespace Pulumi.AzureNative.Blueprint.V20171111Preview
{
    ...
    public partial class PolicyAssignmentArtifact : Pulumi.CustomResource
    {
        ...
        public PolicyAssignmentArtifact(string name, PolicyAssignmentArtifactArgs args, CustomResourceOptions? options = null)
            : base("azure-native:blueprint/v20171111preview:PolicyAssignmentArtifact", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignmentArtifact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:blueprint/v20171111preview:PolicyAssignmentArtifact", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "azure-nextgen:blueprint/v20171111preview:PolicyAssignmentArtifact"},
                },
            };
