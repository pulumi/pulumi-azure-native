...
namespace Pulumi.AzureNative.Blueprint.V20181101Preview
{
    ...
    /// {
    ///     var blueprint = new AzureNative.Blueprint.V20181101Preview.Blueprint("blueprint", new()
    ///     {
    ///         BlueprintName = "simpleBlueprint",
    ///         Description = "blueprint contains all artifact kinds {'template', 'rbac', 'policy'}",
    ///         Parameters = 
    ///         {
    ///             { "costCenter", new AzureNative.Blueprint.V20181101Preview.Inputs.ParameterDefinitionArgs
    ///             {
    ///                 DisplayName = "force cost center tag for all resources under given subscription.",
    ///                 Type = "string",
    ///             } },
    ///             { "owners", new AzureNative.Blueprint.V20181101Preview.Inputs.ParameterDefinitionArgs
    ///             {
    ///                 DisplayName = "assign owners to subscription along with blueprint assignment.",
    ///                 Type = "array",
    ///             } },
    ///             { "storageAccountType", new AzureNative.Blueprint.V20181101Preview.Inputs.ParameterDefinitionArgs
    ///             {
    ...
    ///         ResourceGroups = 
    ///         {
    ///             { "storageRG", new AzureNative.Blueprint.V20181101Preview.Inputs.ResourceGroupDefinitionArgs
    ///             {
    ...
    ///         ResourceGroups = 
    ///         {
    ///             { "myRGName", new AzureNative.Blueprint.V20181101Preview.Inputs.ResourceGroupDefinitionArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AzureNativeResourceType("azure-native:blueprint/v20181101preview:Blueprint")]
    public partial class Blueprint : global::Pulumi.CustomResource
    {
        ...
        public Blueprint(string name, BlueprintArgs args, CustomResourceOptions? options = null)
            : base("azure-native:blueprint/v20181101preview:Blueprint", name, args ?? new BlueprintArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Blueprint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:blueprint/v20181101preview:Blueprint", name, null, MakeResourceOptions(options, id))
        {
        }
