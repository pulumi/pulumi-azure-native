...
namespace Pulumi.AzureNative.Blueprint
{
    ...
    public partial class PolicyAssignmentArtifact : global::Pulumi.CustomResource
    {
        ...
        public PolicyAssignmentArtifact(string name, PolicyAssignmentArtifactArgs args, CustomResourceOptions? options = null)
            : base("azure-native:blueprint:PolicyAssignmentArtifact", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private PolicyAssignmentArtifact(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:blueprint:PolicyAssignmentArtifact", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    ...
                    new global::Pulumi.Alias { Type = "azure-native_blueprint_v20181101preview:blueprint:PolicyAssignmentArtifact" },
                },
            };
