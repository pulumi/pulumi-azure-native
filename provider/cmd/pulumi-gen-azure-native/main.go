...
func main() {
	...
	case "schema":
		...
		azureProviders := openapi.ApplyProvidersTransformations(providers, versionMetadata.V1Lock, nil, versionMetadata.Deprecated, removed)
	...
	case "docs":
		...
		azureProviders, err := openapi.ReadAndApplyProvidersTransformations(providers)
		if err != nil {
			panic(err)
		}
