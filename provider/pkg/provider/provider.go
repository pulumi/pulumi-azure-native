...
func (k *azureNativeProvider) getDefaultName(urn string, randomSeed []byte, strategy resources.AutoNameKind, key resource.PropertyKey,
...
func (k *azureNativeProvider) applyDefaults(ctx context.Context, urn string, randomSeed []byte, res resources.AzureAPIResource,
