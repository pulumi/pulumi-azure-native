...
func keyVaultAccessPolicy(client *armkeyvault.VaultsClient) *CustomResource {
	...
	return &CustomResource{
		...
		Read: c.read,
		Create: func(ctx context.Context, inputs resource.PropertyMap, rawInputs *structpb.Struct, crudClient crud.ResourceCrudClient) (map[string]interface{}, error) {
			return c.write(ctx, inputs, false /* shouldExist */)
		},
		Update: func(ctx context.Context, inputs resource.PropertyMap, rawInputs *structpb.Struct, crudClient crud.ResourceCrudClient) (map[string]interface{}, error) {
			return c.write(ctx, inputs, true /* shouldExist */)
		},
