...
func newStorageAccountStaticWebsite(env *azure.Environment, accountsClient *storage.AccountsClient) *CustomResource {
	...
	return &CustomResource{
		...
		tok:    "azure-nextgen:storage/latest:StorageAccountStaticWebsite",
...
func newBlob(env *azure.Environment, accountsClient *storage.AccountsClient) *CustomResource {
	...
	return &CustomResource{
		path:   blobPath,
		tok:    "azure-nextgen:storage/latest:Blob",
		Create: r.create,
		Update: r.update,
		Delete: r.delete,
		Read:   r.read,
		Types: map[string]schema.ComplexTypeSpec{
			"azure-nextgen:storage/latest:BlobAccessTier": {
				ObjectTypeSpec: schema.ObjectTypeSpec{
			...
			"azure-nextgen:storage/latest:BlobType": {
				ObjectTypeSpec: schema.ObjectTypeSpec{
			...
			ObjectTypeSpec: schema.ObjectTypeSpec{
				...
				Properties: map[string]schema.PropertySpec{
					accessTier: {
						...
						TypeSpec:    schema.TypeSpec{Ref: "#/types/azure-nextgen:storage/latest:BlobAccessTier"},
					},
					contentMd5: {
					...
					typeProp: {
						...
						TypeSpec:    schema.TypeSpec{Ref: "#/types/azure-nextgen:storage/latest:BlobType"},
					},
					url: {
...
func (r *blob) delete(ctx context.Context, properties resource.PropertyMap) error {
