...
func TestConvert(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			expected:     "azure-native:machinelearningservices/v20200501preview:MachineLearningDatastore",
			apiVersion:   "2020-05-01-preview",
		},
		{
			name:         "MultipleResoureTokensFirstExactHit",
			resourceType: "Microsoft.Sql/managedInstances",
			expected:     "azure-native:sql/v20180601preview:ManagedInstance",
			apiVersion:   "2018-06-01-preview",
		},
		{
			name:         "MultipleResoureTokensSecondExactHit",
			resourceType: "Microsoft.Sql/managedInstances",
			expected:     "azure-native:sql/v20200202preview:ManagedInstance",
			apiVersion:   "2020-02-02-preview",
		},
		{
		...
		},
		{
			...
			expected:     "azure-native:documentdb/v20200301:MongoDBResourceMongoDBDatabase",
			apiVersion:   "2020-03-01",
		},
		{
			name:         "PreviewAndStableMixed",
			resourceType: "Microsoft.DocumentDb/databaseAccounts/mongodbDatabases/collections",
			expected:     "azure-native:documentdb/v20200401:MongoDBResourceMongoDBCollection",
			apiVersion:   "2020-03-01",
		},
		{
			name:         "PreviewAndStableMixedPreview",
			resourceType: "Microsoft.DocumentDb/databaseAccounts/mongodbDatabases/collections",
			expected:     "azure-native:documentdb/v20200601preview:MongoDBResourceMongoDBCollection",
			apiVersion:   "2020-06-01-preview",
		},
		{
			name:         "Nested",
			resourceType: "Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/storedProcedures",
			expected:     "azure-native:documentdb/v20200301:SqlResourceSqlStoredProcedure",
			apiVersion:   "2020-03-01",
		},
	} {
