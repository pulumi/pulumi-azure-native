...
func TestAliases(t *testing.T) {
	...
	t.Run("compatible version", func(t *testing.T) {
		...
		expected := []string{
			"azure-native_insights_v20200110:insights:PrivateLinkForAzureAd",
			"azure-native_insights_v20210111:insights:PrivateLinkForAzureAd",
		}
	...
	t.Run("type alias", func(t *testing.T) {
		...
		expected := []string{
			"azure-native_insights_v20220222:insights:privateLinkForAzureAd",
		}
		assert.ElementsMatch(t, expected, actual)
	})
	...
	t.Run("previous module & compatible version", func(t *testing.T) {
		...
		expected := []string{
			"azure-native_monitor_v20200110:monitor:PrivateLinkForAzureAd", // change version
			"azure-native:insights/v20220222:PrivateLinkForAzureAd",        // previous major version
			"azure-native_monitor_v20210111:monitor:PrivateLinkForAzureAd", // change version
		}
		assert.ElementsMatch(t, expected, actual)
	})
	...
	t.Run("previous module, compatible version & type alias", func(t *testing.T) {
		...
		expected := []string{
			"azure-native_monitor_v20200110:monitor:PrivateLinkForAzureAd", // change version
			"azure-native_monitor_v20200110:monitor:privateLinkForAzureAd", // change version & case
			"azure-native_monitor_v20210111:monitor:PrivateLinkForAzureAd", // change version
			"azure-native_monitor_v20210111:monitor:privateLinkForAzureAd", // change version & case
			"azure-native_monitor_v20220222:monitor:privateLinkForAzureAd", // change case
			"azure-native:insights/v20220222:PrivateLinkForAzureAd",        // previous major version
		}
		assert.ElementsMatch(t, expected, actual)
	})
