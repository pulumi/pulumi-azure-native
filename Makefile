...
arm2pulumi_coverage_report::
	(cd provider/pkg/arm2pulumi/internal/testdata && if [ ! -d azure-quickstart-templates ]; then git clone https://github.com/Azure/azure-quickstart-templates/commit/3b2757465c2de537e333f5e2d1c3776c349b8483; fi)
...
build_go::
	...
	# TODO - enable this on feature-3.0 branch
	# cd sdk/ && \
