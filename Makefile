...
build_go::
	# Only building the top level packages and building 4 at a time to avoid OOMing
	cd sdk/ && \
		go list github.com/pulumi/pulumi-azure-native/sdk/go/azure/... | grep -v "latest\|\/v.*"$ | xargs -L 4 go build
