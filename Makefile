...
bin/schema-full.json bin/metadata-compact.json &: bin/$(CODEGEN) $(SPECS) azure-provider-versions/provider_list.json versions/config.yaml versions/v1-spec.yaml versions/v2-spec.yaml
